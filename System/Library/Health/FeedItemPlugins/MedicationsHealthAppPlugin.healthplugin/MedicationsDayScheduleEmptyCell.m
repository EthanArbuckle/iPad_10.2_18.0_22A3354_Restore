...
- (_TtC26MedicationsHealthAppPlugin31MedicationsDayScheduleEmptyCell)initWithCoder:(id)a3
{
  ...
  *((_QWORD *)v5 + 4) = 0;
  v8.receiver = self;
  v8.super_class = v6;
  return -[MedicationsDayScheduleEmptyCell initWithCoder:](&v8, sel_initWithCoder_, a3);
}

- (void).cxx_destruct
{
  sub_2317FAF6C((uint64_t)self + OBJC_IVAR____TtC26MedicationsHealthAppPlugin31MedicationsDayScheduleEmptyCell_item);
}
