...
{
  return (_TtC24MenstrualCyclesAppPlugin49StatisticsViewAllLargeTextThreeLabelTableViewCell *)sub_231B35538((uint64_t)self, (uint64_t)a2, a3, (uint64_t)a4, (uint64_t (*)(uint64_t, uint64_t, uint64_t))sub_231B35410);
}
