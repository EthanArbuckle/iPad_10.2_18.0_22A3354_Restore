...
- (_TtC24MenstrualCyclesAppPlugin34CycleFactorsNoneCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  uint64_t v8;
  id v9;
  _TtC24MenstrualCyclesAppPlugin34CycleFactorsNoneCollectionViewCell *v10;
  _TtC24MenstrualCyclesAppPlugin34CycleFactorsNoneCollectionViewCell *v11;
  objc_super v13;
...
- (_TtC24MenstrualCyclesAppPlugin34CycleFactorsNoneCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC24MenstrualCyclesAppPlugin34CycleFactorsNoneCollectionViewCell *result;

  v5 = OBJC_IVAR____TtC24MenstrualCyclesAppPlugin34CycleFactorsNoneCollectionViewCell_label;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, sel_init);
  ...
  result = (_TtC24MenstrualCyclesAppPlugin34CycleFactorsNoneCollectionViewCell *)sub_231CA2A48();
  __break(1u);
  return result;
}
