...
- (void)viewDidLoad
{
  _TtC5Heart45AFibBurdenOnboardingLifeFactorsViewController *v2;
...
- (void)hxui_primaryFooterButtonTapped
{
  ...
  uint64_t v4;
  void (*v5)(void);
  _TtC5Heart45AFibBurdenOnboardingLifeFactorsViewController *v6;

  v3 = (char *)self + OBJC_IVAR____TtC5Heart45AFibBurdenOnboardingLifeFactorsViewController_delegate;
  if (MEMORY[0x2348DE3BC]((char *)self + OBJC_IVAR____TtC5Heart45AFibBurdenOnboardingLifeFactorsViewController_delegate, a2))
  {
    v4 = *((_QWORD *)v3 + 1);
    swift_getObjectType();
    v5 = *(void (**)(void))(v4 + 8);
...
{
  _TtC5Heart45AFibBurdenOnboardingLifeFactorsViewController *result;
...
- (void).cxx_destruct
{
  sub_2312D2854((uint64_t)self + OBJC_IVAR____TtC5Heart45AFibBurdenOnboardingLifeFactorsViewController_delegate);
}
