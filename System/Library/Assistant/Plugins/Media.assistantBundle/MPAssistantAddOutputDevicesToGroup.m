...
- (void)performWithCompletion:(id)a3
{
  ...
  _QWORD v23[4];
  id v24;
  MPAssistantAddOutputDevicesToGroup *v25;
  id v26;
  char v27;
  uint8_t buf[4];
  NSString *v29;
  ...
  {
    -[MPAssistantAddOutputDevicesToGroup aceId](self, "aceId");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    sub_1CC994A10(CFSTR("Add Output Devices To Group"), v5);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v9;
    _os_log_impl(&dword_1CC97B000, v8, OS_LOG_TYPE_DEFAULT, "Add Output Devices To Group (invoke) <%{public}@>: invoked", buf, 0xCu);
  }

  v10 = self->_requestAceHash;
  -[MPAssistantAddOutputDevicesToGroup hashedRouteUIDs](self, "hashedRouteUIDs");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  sub_1CC994B48(CFSTR("Add Output Devices To Group"), v10, v11);

  objc_msgSend(MEMORY[0x1E0C99DE8], "array");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  -[MPAssistantAddOutputDevicesToGroup groupID](self, "groupID");
