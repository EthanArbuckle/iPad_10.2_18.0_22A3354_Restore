...
- (void)performWithCompletion:(id)a3
{
  ...
  {
    -[MPAssistantIncreasePlaybackSpeed aceId](self, "aceId");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    sub_1CC994A10(CFSTR("Increase Playback Speed"), v6);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    -[MPAssistantIncreasePlaybackSpeed hashedRouteUIDs](self, "hashedRouteUIDs");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    *(_DWORD *)buf = 138543618;
    v27 = v10;
    v28 = 2048;
    v29 = objc_msgSend(v11, "count");
    _os_log_impl(&dword_1CC97B000, v9, OS_LOG_TYPE_DEFAULT, "Increase Playback Speed (invoke) <%{public}@>: %lu UIDs", buf, 0x16u);

  }
  v12 = self->_requestAceHash;
  -[MPAssistantIncreasePlaybackSpeed hashedRouteUIDs](self, "hashedRouteUIDs");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  sub_1CC994B48(CFSTR("Increase Playback Speed"), v12, v13);
