...
- (void)performWithCompletion:(id)a3
{
  ...
  {
    -[MPAssistantSetRepeatMode aceId](self, "aceId");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    sub_1CC994A10(CFSTR("Set Repeat Mode"), v6);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    -[MPAssistantSetRepeatMode hashedRouteUIDs](self, "hashedRouteUIDs");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = objc_msgSend(v11, "count");
    -[MPAssistantSetRepeatMode repeatMode](self, "repeatMode");
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v39 = 2114;
    v40 = v13;
    _os_log_impl(&dword_1CC97B000, v9, OS_LOG_TYPE_DEFAULT, "Set Repeat Mode (invoke) <%{public}@>: %lu UIDs, %{public}@ mode", buf, 0x20u);

  }
  v14 = self->_requestAceHash;
  -[MPAssistantSetRepeatMode hashedRouteUIDs](self, "hashedRouteUIDs");
  v15 = objc_claimAutoreleasedReturnValue();
  sub_1CC994B48(CFSTR("Set Repeat Mode"), v14, (void *)v15);

  -[MPAssistantSetRepeatMode repeatMode](self, "repeatMode");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(v15) = objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0D88EC0]);
  ...
  else
  {
    ...
    v19 = objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0D88ED0]);
    ...
    else
    {
      ...
      v21 = objc_msgSend(v20, "isEqualToString:", *MEMORY[0x1E0D88EC8]);
