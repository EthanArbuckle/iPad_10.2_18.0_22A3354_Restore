...
{
  SASProximityInformationAction *v2;
  SASProximityInformation *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)SASProximityInformationAction;
  v2 = -[SASProximityInformationAction init](&v5, sel_init);
  if (v2)
  {
    v3 = objc_alloc_init(SASProximityInformation);
    -[SASProximityInformationAction setInformation:](v2, "setInformation:", v3);
...
- (void)setResponseFromData:(id)a3
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v23 = v11;
      _os_log_impl(&dword_1D45FD000, v12, OS_LOG_TYPE_DEFAULT, "Failed to unarchive information response payload: %@", buf, 0xCu);
    }

  }
  v13 = (void *)MEMORY[0x1E0CB3710];
  v14 = objc_opt_class();
  objc_msgSend(v10, "objectForKeyedSubscript:", CFSTR("information"));
  ...
  -[SASProximityInformationAction setInformation:](self, "setInformation:", v16);
  -[SASProximityInformationAction information](self, "information");
...
- (id)responsePayload
{
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v19 = v10;
        _os_log_impl(&dword_1D45FD000, v12, OS_LOG_TYPE_DEFAULT, "Failed to archive information response payload: %@", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v19 = v7;
      _os_log_impl(&dword_1D45FD000, v8, OS_LOG_TYPE_DEFAULT, "Failed to archive information: %@", buf, 0xCu);
    }
    v9 = 0;
    v10 = v7;
  }
