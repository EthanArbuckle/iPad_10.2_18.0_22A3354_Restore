...
{
  id v4;
  SFActivityIndicatorCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFActivityIndicatorCardSection setType:](v5, "setType:", v12);
    ...
    -[SFActivityIndicatorCardSection setText:](v5, "setText:", v14);
...
{
  _SFPBActivityIndicatorCardSection *v2;
  void *v3;

  v2 = -[_SFPBActivityIndicatorCardSection initWithFacade:]([_SFPBActivityIndicatorCardSection alloc], "initWithFacade:", self);
  -[_SFPBActivityIndicatorCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBActivityIndicatorCardSection initWithFacade:]([_SFPBActivityIndicatorCardSection alloc], "initWithFacade:", self);
  -[_SFPBActivityIndicatorCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFActivityIndicatorCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFActivityIndicatorCardSection text](self, "text");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setText:", v16);
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  SFActivityIndicatorCardSection *v5;
  SFActivityIndicatorCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (SFActivityIndicatorCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFActivityIndicatorCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            -[SFActivityIndicatorCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFActivityIndicatorCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFActivityIndicatorCardSection text](v6, "text");
...
- (SFActivityIndicatorCardSection)initWithProtobuf:(id)a3
{
  ...
  void *v24;
  void *v25;
  SFActivityIndicatorCardSection *v26;
  __int128 v28;
  __int128 v29;
  __int128 v30;
  __int128 v31;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFActivityIndicatorCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      objc_msgSend(v4, "text");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFActivityIndicatorCardSection setText:](v5, "setText:", v25);
