...
{
  id v4;
  _SFPBActivityIndicatorCardSection *v5;
  void *v6;
  id v7;
  void *v8;
  uint64_t v9;
  ...
  void *v24;
  void *v25;
  _SFPBActivityIndicatorCardSection *v26;
  __int128 v28;
  __int128 v29;
  __int128 v30;
  __int128 v31;
  ...
  v4 = a3;
  v5 = -[_SFPBActivityIndicatorCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBActivityIndicatorCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBActivityIndicatorCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBActivityIndicatorCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBActivityIndicatorCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBActivityIndicatorCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBActivityIndicatorCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBActivityIndicatorCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBActivityIndicatorCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBActivityIndicatorCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v24)
    {
      ...
      -[_SFPBActivityIndicatorCardSection setText:](v5, "setText:", v25);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBActivityIndicatorCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBActivityIndicatorCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBActivityIndicatorCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBActivityIndicatorCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBActivityIndicatorCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBActivityIndicatorCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBActivityIndicatorCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBActivityIndicatorCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBActivityIndicatorCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBActivityIndicatorCardSection text](self, "text");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
    PBDataWriterWriteStringField();
...
- (unint64_t)hash
{
  ...
  return v9 ^ v10 ^ -[NSString hash](self->_text, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBActivityIndicatorCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBActivityIndicatorCardSection hasBottomPadding](self, "hasBottomPadding"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBActivityIndicatorCardSection hasTopPadding](self, "hasTopPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v22 = -[_SFPBActivityIndicatorCardSection separatorStyle](self, "separatorStyle");
    if (v22 >= 6)
    {
  ...
  if (self->_text)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v25, CFSTR("text"));
...
- (NSData)jsonData
{
  ...
  -[_SFPBActivityIndicatorCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBActivityIndicatorCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBActivityIndicatorCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBActivityIndicatorCardSection)initWithDictionary:(id)a3
{
  ...
  void *v26;
  void *v27;
  _SFPBActivityIndicatorCardSection *v28;
  void *v30;
  void *v31;
  void *v32;
  void *v33;
  ...
  v5 = -[_SFPBActivityIndicatorCardSection init](&v38, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBActivityIndicatorCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v13);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBActivityIndicatorCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v18, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBActivityIndicatorCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBActivityIndicatorCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v20, "BOOLValue"));
    v33 = v6;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBActivityIndicatorCardSection setType:](v5, "setType:", v22);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBActivityIndicatorCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v23, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBActivityIndicatorCardSection setBackgroundColor:](v5, "setBackgroundColor:", v25);
    ...
    {
      v27 = (void *)objc_msgSend(v26, "copy");
      -[_SFPBActivityIndicatorCardSection setText:](v5, "setText:", v27);
