...
- (SFNowPlayingCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCardSection movies](v8, "movies");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFNowPlayingCardSection setMovies:](v5, "setMovies:", v16);
...
{
  _SFPBNowPlayingCardSection *v2;
  void *v3;

  v2 = -[_SFPBNowPlayingCardSection initWithFacade:]([_SFPBNowPlayingCardSection alloc], "initWithFacade:", self);
  -[_SFPBNowPlayingCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBNowPlayingCardSection initWithFacade:]([_SFPBNowPlayingCardSection alloc], "initWithFacade:", self);
  -[_SFPBNowPlayingCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFNowPlayingCardSection movies](self, "movies");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = (void *)objc_msgSend(v19, "copy");
  objc_msgSend(v4, "setMovies:", v20);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFNowPlayingCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v67.receiver = self;
...
LABEL_24:
                          ...
                          objc_msgSend(v32, "isEqual:")))
                    {
                      -[SFNowPlayingCardSection movies](self, "movies");
                      v37 = (void *)objc_claimAutoreleasedReturnValue();
                      -[SFNowPlayingCardSection movies](v5, "movies");
                      v36 = (void *)objc_claimAutoreleasedReturnValue();
                      if ((v37 == 0) == (v36 != 0))
                      {
...
- (SFNowPlayingCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    -[SFNowPlayingCardSection setMovies:](v5, "setMovies:", v29);
    v36 = v5;
