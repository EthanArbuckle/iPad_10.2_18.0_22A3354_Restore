...
- (SFWatchNowCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFWatchNowCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFWatchNowCardSection setSectionTitle:](v5, "setSectionTitle:", v25);
    ...
    if (v26)
    {
      ...
      v29 = -[SFWatchListItem initWithProtobuf:](v27, "initWithProtobuf:", v28);
      -[SFWatchNowCardSection setWatchListItem:](v5, "setWatchListItem:", v29);
...
- (SFWatchNowCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFWatchNowCardSection setType:](v5, "setType:", v12);
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFWatchNowCardSection setSectionTitle:](v5, "setSectionTitle:", v14);

    -[SFCardSection watchListItem](v8, "watchListItem");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFWatchNowCardSection setWatchListItem:](v5, "setWatchListItem:", v15);
...
{
  _SFPBWatchNowCardSection *v2;
  void *v3;

  v2 = -[_SFPBWatchNowCardSection initWithFacade:]([_SFPBWatchNowCardSection alloc], "initWithFacade:", self);
  -[_SFPBWatchNowCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBWatchNowCardSection initWithFacade:]([_SFPBWatchNowCardSection alloc], "initWithFacade:", self);
  -[_SFPBWatchNowCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFWatchNowCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFWatchNowCardSection sectionTitle](self, "sectionTitle");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setSectionTitle:", v16);

  -[SFWatchNowCardSection watchListItem](self, "watchListItem");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setWatchListItem:", v18);
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v73;
  void *v74;
  SFWatchNowCardSection *v75;
  void *v76;
  void *v77;
  objc_super v78;

  v5 = (SFWatchNowCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFWatchNowCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            -[SFWatchNowCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFWatchNowCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v63 = v32;
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                -[SFWatchNowCardSection sectionTitle](v6, "sectionTitle");
...
LABEL_65:
                      ...
                      objc_msgSend(v44, "isEqual:")))
                {
                  ...
                  -[SFWatchNowCardSection watchListItem](v6, "watchListItem");
