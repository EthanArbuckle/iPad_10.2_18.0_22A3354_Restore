...
{
  id v4;
  RFSummaryItemPlayerCardSection *v5;
  void *v6;
  RFTextProperty *v7;
  void *v8;
  RFTextProperty *v9;
  ...
  void *v28;
  SFButtonItem *v29;
  RFSummaryItemPlayerCardSection *v30;
  objc_super v32;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFSummaryItemPlayerCardSection setText_1:](v5, "setText_1:", v9);
    ...
    if (v10)
    {
      ...
      -[RFSummaryItemPlayerCardSection setText_2:](v5, "setText_2:", v13);
    ...
    if (v14)
    {
      ...
      -[RFSummaryItemPlayerCardSection setText_3:](v5, "setText_3:", v17);
    ...
    if (v18)
    {
      ...
      -[RFSummaryItemPlayerCardSection setText_4:](v5, "setText_4:", v21);
    ...
    if (v22)
    {
      ...
      -[RFSummaryItemPlayerCardSection setThumbnail:](v5, "setThumbnail:", v25);
    ...
    if (v26)
    {
      ...
      v29 = -[SFButtonItem initWithProtobuf:](v27, "initWithProtobuf:", v28);
      -[RFSummaryItemPlayerCardSection setPlayer:](v5, "setPlayer:", v29);
...
- (RFSummaryItemPlayerCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCardSection text](v8, "text");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemPlayerCardSection setText_2:](v5, "setText_2:", v10);

    -[SFCardSection text](v8, "text");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemPlayerCardSection setText_3:](v5, "setText_3:", v11);

    -[SFCardSection text](v8, "text");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemPlayerCardSection setText_4:](v5, "setText_4:", v12);

    -[SFCardSection thumbnail](v8, "thumbnail");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemPlayerCardSection setThumbnail:](v5, "setThumbnail:", v13);

    -[SFCardSection player](v8, "player");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemPlayerCardSection setPlayer:](v5, "setPlayer:", v14);
...
{
  _SFPBRFSummaryItemPlayerCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFSummaryItemPlayerCardSection initWithFacade:]([_SFPBRFSummaryItemPlayerCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSummaryItemPlayerCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFSummaryItemPlayerCardSection initWithFacade:]([_SFPBRFSummaryItemPlayerCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSummaryItemPlayerCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFSummaryItemPlayerCardSection text](self, "text");
  ...
  -[RFSummaryItemPlayerCardSection thumbnail](self, "thumbnail");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = (void *)objc_msgSend(v13, "copy");
  objc_msgSend(v4, "setThumbnail:", v14);

  -[RFSummaryItemPlayerCardSection player](self, "player");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setPlayer:", v16);
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  RFSummaryItemPlayerCardSection *v5;
  RFSummaryItemPlayerCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (RFSummaryItemPlayerCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[RFSummaryItemPlayerCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v58.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v58, sel_isEqual_, v5))
      {
        ...
        -[RFSummaryItemPlayerCardSection text](self, "text");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFSummaryItemPlayerCardSection text](v6, "text");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v7 == 0) == (v8 != 0))
        {
          v11 = 0;
...
LABEL_57:
            ...
            -[RFSummaryItemPlayerCardSection thumbnail](self, "thumbnail");
            v25 = (void *)objc_claimAutoreleasedReturnValue();
            -[RFSummaryItemPlayerCardSection thumbnail](v6, "thumbnail");
            v26 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v25 == 0) == (v26 != 0))
            {
            ...
            else
            {
              -[RFSummaryItemPlayerCardSection player](self, "player");
              v28 = (void *)objc_claimAutoreleasedReturnValue();
              -[RFSummaryItemPlayerCardSection player](v6, "player");
              v29 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v28 == 0) == (v29 != 0))
              {
