...
{
  id v4;
  RFReferenceItemLogoCardSection *v5;
  void *v6;
  RFVisualProperty *v7;
  void *v8;
  RFVisualProperty *v9;
  RFReferenceItemLogoCardSection *v10;
  objc_super v12;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFReferenceItemLogoCardSection setThumbnail:](v5, "setThumbnail:", v9);
...
{
  _SFPBRFReferenceItemLogoCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFReferenceItemLogoCardSection initWithFacade:]([_SFPBRFReferenceItemLogoCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFReferenceItemLogoCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFReferenceItemLogoCardSection initWithFacade:]([_SFPBRFReferenceItemLogoCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFReferenceItemLogoCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFReferenceItemLogoCardSection thumbnail](self, "thumbnail");
...
- (BOOL)isEqual:(id)a3
{
  RFReferenceItemLogoCardSection *v4;
  RFReferenceItemLogoCardSection *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  v4 = (RFReferenceItemLogoCardSection *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  else if (-[RFReferenceItemLogoCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCardSection isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[RFReferenceItemLogoCardSection thumbnail](self, "thumbnail");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFReferenceItemLogoCardSection thumbnail](v5, "thumbnail");
