...
{
  id v4;
  _SFPBRFSimpleItemStandardCardSection *v5;
  void *v6;
  ...
  _SFPBRFSimpleItemStandardCardSection *v38;
  __int128 v40;
  __int128 v41;
  __int128 v42;
  __int128 v43;
  ...
  v4 = a3;
  v5 = -[_SFPBRFSimpleItemStandardCardSection init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_1:](v5, "setText_1:", v9);
    ...
    if (v10)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_2:](v5, "setText_2:", v13);
    ...
    -[_SFPBRFSimpleItemStandardCardSection setText_3s:](v5, "setText_3s:", v15);
    objc_msgSend(v4, "text");
    ...
    -[_SFPBRFSimpleItemStandardCardSection setText_4s:](v5, "setText_4s:", v23);
    objc_msgSend(v4, "text");
    ...
    if (v30)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_5:](v5, "setText_5:", v33);
    ...
    if (v34)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_6:](v5, "setText_6:", v37);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBRFSimpleItemStandardCardSection text](self, "text");
  ...
  -[_SFPBRFSimpleItemStandardCardSection text_3s](self, "text_3s");
  ...
  -[_SFPBRFSimpleItemStandardCardSection text_4s](self, "text_4s");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = 0u;
  v20 = 0u;
  v21 = 0u;
...
- (unint64_t)hash
{
  ...
  return v6 ^ v7 ^ -[_SFPBRFTextProperty hash](self->_text_6, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_text_3s, "count"))
  {
    ...
    v40 = 0u;
    v11 = self->_text_3s;
    v12 = -[NSArray countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v37, v42, 16);
    if (v12)
    {
      v13 = v12;
      v14 = *(_QWORD *)v38;
      do
      {
        ...
        v13 = -[NSArray countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v37, v42, 16);
      }
      while (v13);
    }
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFSimpleItemStandardCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFSimpleItemStandardCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFSimpleItemStandardCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFSimpleItemStandardCardSection)initWithDictionary:(id)a3
{
  ...
  void *v28;
  _SFPBRFTextProperty *v29;
  _SFPBRFSimpleItemStandardCardSection *v30;
  void *v32;
  void *v33;
  void *v34;
  __int128 v35;
  ...
  v5 = -[_SFPBRFSimpleItemStandardCardSection init](&v43, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_1:](v5, "setText_1:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_2:](v5, "setText_2:", v9);
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFSimpleItemStandardCardSection addText_3:](v5, "addText_3:", v17);
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFSimpleItemStandardCardSection addText_4:](v5, "addText_4:", v25);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_5:](v5, "setText_5:", v27);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemStandardCardSection setText_6:](v5, "setText_6:", v29);
