...
{
  _SFPBTitleCardSection *v2;
  void *v3;

  v2 = -[_SFPBTitleCardSection initWithFacade:]([_SFPBTitleCardSection alloc], "initWithFacade:", self);
  -[_SFPBTitleCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBTitleCardSection initWithFacade:]([_SFPBTitleCardSection alloc], "initWithFacade:", self);
  -[_SFPBTitleCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFTitleCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v63.receiver = self;
      v63.super_class = (Class)SFTitleCardSection;
      if (-[SFCardSection isEqual:](&v63, sel_isEqual_, v4))
      {
        v5 = v4;
        -[SFCardSection punchoutOptions](self, "punchoutOptions");
        v6 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_25:
        ...
        if (v14)
        {
          ...
          v59 = v15;
          if (!objc_msgSend(v15, "isEqual:", v58))
            goto LABEL_21;
        }
        v60 = v14;
        -[SFCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
...
LABEL_24:
                    ...
                    {
                      v33 = -[SFTitleCardSection isCentered](self, "isCentered");
                      v11 = v33 ^ -[SFTitleCardSection isCentered](v5, "isCentered") ^ 1;
                      if (!v36)
                      {
LABEL_66:
...
- (unint64_t)hash
{
  ...
  v22 = v19 ^ v21 ^ -[SFTitleCardSection isCentered](self, "isCentered");
