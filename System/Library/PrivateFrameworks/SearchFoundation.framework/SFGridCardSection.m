...
- (SFGridCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFGridCardSection setType:](v5, "setType:", v12);
    ...
    -[SFGridCardSection setCardSections:](v5, "setCardSections:", v14);
...
{
  _SFPBGridCardSection *v2;
  void *v3;

  v2 = -[_SFPBGridCardSection initWithFacade:]([_SFPBGridCardSection alloc], "initWithFacade:", self);
  -[_SFPBGridCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBGridCardSection initWithFacade:]([_SFPBGridCardSection alloc], "initWithFacade:", self);
  -[_SFPBGridCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFGridCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFGridCardSection cardSections](self, "cardSections");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFGridCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            -[SFGridCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFGridCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFGridCardSection cardSections](v6, "cardSections");
...
- (SFGridCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFGridCardSection setType:](v5, "setType:", v19);
    ...
    -[SFGridCardSection setCardSections:](v5, "setCardSections:", v25);
    v32 = v5;
