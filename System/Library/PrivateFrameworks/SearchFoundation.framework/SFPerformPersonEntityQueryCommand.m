...
{
  id v4;
  SFPerformPersonEntityQueryCommand *v5;
  void *v6;
  SFPerson *v7;
  void *v8;
  SFPerson *v9;
  SFPerformPersonEntityQueryCommand *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)SFPerformPersonEntityQueryCommand;
  v5 = -[SFPerformPersonEntityQueryCommand init](&v12, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[SFPerformPersonEntityQueryCommand setPerson:](v5, "setPerson:", v9);
...
- (SFPerformPersonEntityQueryCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFPerformPersonEntityQueryCommand init](self, "init");
...
{
  _SFPBPerformPersonEntityQueryCommand *v2;
  void *v3;

  v2 = -[_SFPBPerformPersonEntityQueryCommand initWithFacade:]([_SFPBPerformPersonEntityQueryCommand alloc], "initWithFacade:", self);
  -[_SFPBPerformPersonEntityQueryCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBPerformPersonEntityQueryCommand initWithFacade:]([_SFPBPerformPersonEntityQueryCommand alloc], "initWithFacade:", self);
  -[_SFPBPerformPersonEntityQueryCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFPerformPersonEntityQueryCommand person](self, "person");
...
- (BOOL)isEqual:(id)a3
{
  SFPerformPersonEntityQueryCommand *v4;
  SFPerformPersonEntityQueryCommand *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  v4 = (SFPerformPersonEntityQueryCommand *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  else if (-[SFPerformPersonEntityQueryCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())&& (v13.receiver = self, v13.super_class = (Class)SFPerformPersonEntityQueryCommand, -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    v5 = v4;
    -[SFPerformPersonEntityQueryCommand person](self, "person");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFPerformPersonEntityQueryCommand person](v5, "person");
