...
- (SFEmailCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFEmailCommand init](self, "init");
  ...
  {
    -[SFCommand email](v8, "email");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFEmailCommand setEmail:](v5, "setEmail:", v9);
...
{
  _SFPBEmailCommand *v2;
  void *v3;

  v2 = -[_SFPBEmailCommand initWithFacade:]([_SFPBEmailCommand alloc], "initWithFacade:", self);
  -[_SFPBEmailCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBEmailCommand initWithFacade:]([_SFPBEmailCommand alloc], "initWithFacade:", self);
  -[_SFPBEmailCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFEmailCommand email](self, "email");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setEmail:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (-[SFEmailCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
...
- (SFEmailCommand)initWithProtobuf:(id)a3
{
  ...
  v5 = -[SFEmailCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      objc_msgSend(v4, "email");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFEmailCommand setEmail:](v5, "setEmail:", v7);
