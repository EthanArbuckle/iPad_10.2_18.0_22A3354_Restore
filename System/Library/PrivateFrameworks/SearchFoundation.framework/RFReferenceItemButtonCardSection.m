...
{
  id v4;
  RFReferenceItemButtonCardSection *v5;
  void *v6;
  SFButtonItem *v7;
  void *v8;
  SFButtonItem *v9;
  RFReferenceItemButtonCardSection *v10;
  objc_super v12;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFReferenceItemButtonCardSection setButton_1:](v5, "setButton_1:", v9);
...
{
  _SFPBRFReferenceItemButtonCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFReferenceItemButtonCardSection initWithFacade:]([_SFPBRFReferenceItemButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFReferenceItemButtonCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFReferenceItemButtonCardSection initWithFacade:]([_SFPBRFReferenceItemButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFReferenceItemButtonCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFReferenceItemButtonCardSection button](self, "button");
...
- (BOOL)isEqual:(id)a3
{
  RFReferenceItemButtonCardSection *v4;
  RFReferenceItemButtonCardSection *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  v4 = (RFReferenceItemButtonCardSection *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  else if (-[RFReferenceItemButtonCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCardSection isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[RFReferenceItemButtonCardSection button](self, "button");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFReferenceItemButtonCardSection button](v5, "button");
