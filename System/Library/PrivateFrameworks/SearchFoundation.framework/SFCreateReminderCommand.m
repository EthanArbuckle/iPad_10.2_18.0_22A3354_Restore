...
{
  id v4;
  SFCreateReminderCommand *v5;
  void *v6;
  SFReminder *v7;
  void *v8;
  SFReminder *v9;
  SFCreateReminderCommand *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)SFCreateReminderCommand;
  v5 = -[SFCreateReminderCommand init](&v12, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      v9 = -[SFReminder initWithProtobuf:](v7, "initWithProtobuf:", v8);
      -[SFCreateReminderCommand setReminder:](v5, "setReminder:", v9);
...
- (SFCreateReminderCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFCreateReminderCommand init](self, "init");
  ...
  {
    -[SFCommand reminder](v8, "reminder");
...
{
  _SFPBCreateReminderCommand *v2;
  void *v3;

  v2 = -[_SFPBCreateReminderCommand initWithFacade:]([_SFPBCreateReminderCommand alloc], "initWithFacade:", self);
  -[_SFPBCreateReminderCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBCreateReminderCommand initWithFacade:]([_SFPBCreateReminderCommand alloc], "initWithFacade:", self);
  -[_SFPBCreateReminderCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFCreateReminderCommand reminder](self, "reminder");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setReminder:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = (SFCreateReminderCommand *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  else if (-[SFCreateReminderCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFCreateReminderCommand reminder](self, "reminder");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCreateReminderCommand reminder](v5, "reminder");
