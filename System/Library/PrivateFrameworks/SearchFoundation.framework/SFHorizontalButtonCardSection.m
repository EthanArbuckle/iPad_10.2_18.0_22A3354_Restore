...
{
  id v4;
  SFHorizontalButtonCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFHorizontalButtonCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection buttonCardSections](v8, "buttonCardSections");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFHorizontalButtonCardSection setButtonCardSections:](v5, "setButtonCardSections:", v14);
...
{
  _SFPBHorizontalButtonCardSection *v2;
  void *v3;

  v2 = -[_SFPBHorizontalButtonCardSection initWithFacade:]([_SFPBHorizontalButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBHorizontalButtonCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBHorizontalButtonCardSection initWithFacade:]([_SFPBHorizontalButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBHorizontalButtonCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFHorizontalButtonCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFHorizontalButtonCardSection buttonCardSections](self, "buttonCardSections");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setButtonCardSections:", v16);
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  SFHorizontalButtonCardSection *v5;
  SFHorizontalButtonCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (SFHorizontalButtonCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFHorizontalButtonCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            -[SFHorizontalButtonCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFHorizontalButtonCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFHorizontalButtonCardSection buttonCardSections](v6, "buttonCardSections");
...
- (SFHorizontalButtonCardSection)initWithProtobuf:(id)a3
{
  ...
  uint64_t j;
  SFCardSection *v31;
  SFHorizontalButtonCardSection *v32;
  __int128 v34;
  __int128 v35;
  __int128 v36;
  __int128 v37;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFHorizontalButtonCardSection setType:](v5, "setType:", v19);
    ...
    -[SFHorizontalButtonCardSection setButtonCardSections:](v5, "setButtonCardSections:", v25);
    v32 = v5;
