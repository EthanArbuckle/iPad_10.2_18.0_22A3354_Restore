...
- (_SFPBImagesCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBImagesCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBImagesCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBImagesCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBImagesCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBImagesCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBImagesCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBImagesCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBImagesCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBImagesCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBImagesCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v27)
    {
      ...
      do
      {
        for (j = 0; j != v28; ++j)
        {
          ...
          v31 = -[_SFPBImage initWithFacade:]([_SFPBImage alloc], "initWithFacade:", *(_QWORD *)(*((_QWORD *)&v34 + 1) + 8 * j));
          if (v31)
    ...
    -[_SFPBImagesCardSection setImages:](v5, "setImages:", v25);
    if (objc_msgSend(v4, "hasBorderless"))
      -[_SFPBImagesCardSection setBorderless:](v5, "setBorderless:", objc_msgSend(v4, "borderless"));
    v32 = v5;
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBImagesCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBImagesCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBImagesCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBImagesCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBImagesCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBImagesCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBImagesCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBImagesCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBImagesCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBImagesCardSection images](self, "images");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = 0u;
  v20 = 0u;
  v21 = 0u;
  ...
  if (-[_SFPBImagesCardSection borderless](self, "borderless"))
    PBDataWriterWriteBOOLField();
...
LABEL_39:
    ...
    v41 = borderless == objc_msgSend(v4, "borderless");
    goto LABEL_37;
  }
  v37 = (void *)v36;
  -[_SFPBImagesCardSection images](self, "images");
...
- (unint64_t)hash
{
  ...
  v11 = -[NSArray hash](self->_images, "hash");
  if (self->_borderless)
    v12 = 2654435761;
  else
    v12 = 0;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_borderless)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBImagesCardSection borderless](self, "borderless"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("borderless"));

  }
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBImagesCardSection canBeHidden](self, "canBeHidden"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("canBeHidden"));

  }
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBImagesCardSection hasBottomPadding](self, "hasBottomPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("hasBottomPadding"));

  }
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBImagesCardSection hasTopPadding](self, "hasTopPadding"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("hasTopPadding"));
  ...
  if (-[NSArray count](self->_images, "count"))
  {
    ...
    v43 = 0u;
    v12 = self->_images;
    v13 = -[NSArray countByEnumeratingWithState:objects:count:](v12, "countByEnumeratingWithState:objects:count:", &v40, v45, 16);
    if (v13)
    {
      v14 = v13;
      v15 = *(_QWORD *)v41;
      do
      {
        ...
        v14 = -[NSArray countByEnumeratingWithState:objects:count:](v12, "countByEnumeratingWithState:objects:count:", &v40, v45, 16);
      }
      while (v14);
    }

    objc_msgSend(v3, "setObject:forKeyedSubscript:", v11, CFSTR("images"));
  }
  ...
  {
    v31 = -[_SFPBImagesCardSection separatorStyle](self, "separatorStyle");
    if (v31 >= 6)
    {
...
- (NSData)jsonData
{
  ...
  -[_SFPBImagesCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBImagesCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBImagesCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBImagesCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBImagesCardSection init](&v55, sel_init);
  if (v5)
  {
        ...
        do
        {
          for (i = 0; i != v10; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBImagesCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v14);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBImagesCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v16);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBImagesCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v18);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBImagesCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBImagesCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v20, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    v46 = v21;
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBImagesCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v21, "BOOLValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBImagesCardSection setType:](v5, "setType:", v24);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBImagesCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v25, "intValue"));
    v43 = v25;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBImagesCardSection setBackgroundColor:](v5, "setBackgroundColor:", v27);
        ...
        do
        {
          for (j = 0; j != v31; ++j)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBImagesCardSection addImages:](v5, "addImages:", v35);
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("borderless"));
    v36 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBImagesCardSection setBorderless:](v5, "setBorderless:", objc_msgSend(v36, "BOOLValue"));
    v37 = v5;
