...
- (SFInvokeSiriCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFInvokeSiriCommand init](self, "init");
  ...
  {
    -[SFCommand utteranceText](v8, "utteranceText");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFInvokeSiriCommand setUtteranceText:](v5, "setUtteranceText:", v9);
...
{
  _SFPBInvokeSiriCommand *v2;
  void *v3;

  v2 = -[_SFPBInvokeSiriCommand initWithFacade:]([_SFPBInvokeSiriCommand alloc], "initWithFacade:", self);
  -[_SFPBInvokeSiriCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBInvokeSiriCommand initWithFacade:]([_SFPBInvokeSiriCommand alloc], "initWithFacade:", self);
  -[_SFPBInvokeSiriCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFInvokeSiriCommand utteranceText](self, "utteranceText");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setUtteranceText:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (-[SFInvokeSiriCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFInvokeSiriCommand utteranceText](self, "utteranceText");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFInvokeSiriCommand utteranceText](v5, "utteranceText");
...
- (SFInvokeSiriCommand)initWithProtobuf:(id)a3
{
  ...
  void *v6;
  void *v7;
  SFInvokeSiriCommand *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SFInvokeSiriCommand;
  v5 = -[SFInvokeSiriCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      objc_msgSend(v4, "utteranceText");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFInvokeSiriCommand setUtteranceText:](v5, "setUtteranceText:", v7);
