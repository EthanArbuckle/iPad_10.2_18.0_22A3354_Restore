...
- (SFWebCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFWebCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFWebCardSection setHtmlString:](v5, "setHtmlString:", v25);
...
- (SFWebCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFWebCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection htmlString](v8, "htmlString");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFWebCardSection setHtmlString:](v5, "setHtmlString:", v14);
...
{
  _SFPBWebCardSection *v2;
  void *v3;

  v2 = -[_SFPBWebCardSection initWithFacade:]([_SFPBWebCardSection alloc], "initWithFacade:", self);
  -[_SFPBWebCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBWebCardSection initWithFacade:]([_SFPBWebCardSection alloc], "initWithFacade:", self);
  -[_SFPBWebCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFWebCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFWebCardSection htmlString](self, "htmlString");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setHtmlString:", v16);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFWebCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFWebCardSection htmlString](v6, "htmlString");
