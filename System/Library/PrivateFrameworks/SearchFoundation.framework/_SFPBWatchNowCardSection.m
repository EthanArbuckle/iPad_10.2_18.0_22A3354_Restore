...
- (_SFPBWatchNowCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBWatchNowCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBWatchNowCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBWatchNowCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBWatchNowCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBWatchNowCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBWatchNowCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBWatchNowCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBWatchNowCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBWatchNowCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBWatchNowCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v24)
    {
      ...
      -[_SFPBWatchNowCardSection setSectionTitle:](v5, "setSectionTitle:", v25);
    ...
    if (v26)
    {
      ...
      v29 = -[_SFPBWatchListItem initWithFacade:](v27, "initWithFacade:", v28);
      -[_SFPBWatchNowCardSection setWatchListItem:](v5, "setWatchListItem:", v29);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBWatchNowCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBWatchNowCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBWatchNowCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBWatchNowCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBWatchNowCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBWatchNowCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBWatchNowCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBWatchNowCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBWatchNowCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBWatchNowCardSection sectionTitle](self, "sectionTitle");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
    PBDataWriterWriteStringField();

  -[_SFPBWatchNowCardSection watchListItem](self, "watchListItem");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v15)
    PBDataWriterWriteSubmessage();
...
- (unint64_t)hash
{
  ...
  return v9 ^ v11 ^ -[_SFPBWatchListItem hash](self->_watchListItem, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWatchNowCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWatchNowCardSection hasBottomPadding](self, "hasBottomPadding"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWatchNowCardSection hasTopPadding](self, "hasTopPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[NSArray count](self->_punchoutOptions, "count"))
  {
    ...
    v12 = -[NSArray countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v32, v36, 16);
    if (v12)
    {
      v13 = v12;
      v14 = *(_QWORD *)v33;
      do
      {
        ...
        v13 = -[NSArray countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v32, v36, 16);
      }
      while (v13);
    }
  ...
  if (self->_sectionTitle)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v23, CFSTR("sectionTitle"));

  }
  if (self->_separatorStyle)
  {
    v24 = -[_SFPBWatchNowCardSection separatorStyle](self, "separatorStyle");
    if (v24 >= 6)
    {
    ...
    {
      v25 = *(&off_1E40421B0 + v24);
    }
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v25, CFSTR("separatorStyle"));
  ...
  if (self->_type)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v27, CFSTR("type"));
  ...
  if (self->_watchListItem)
  {
    ...
    if (v29)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v29, CFSTR("watchListItem"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v30, CFSTR("watchListItem"));
...
- (NSData)jsonData
{
  ...
  -[_SFPBWatchNowCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBWatchNowCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBWatchNowCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBWatchNowCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBWatchNowCardSection init](&v40, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBWatchNowCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v13);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchNowCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v18, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchNowCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchNowCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v20, "BOOLValue"));
    v35 = v6;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBWatchNowCardSection setType:](v5, "setType:", v22);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchNowCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v23, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBWatchNowCardSection setBackgroundColor:](v5, "setBackgroundColor:", v25);
    ...
    {
      v27 = (void *)objc_msgSend(v26, "copy");
      -[_SFPBWatchNowCardSection setSectionTitle:](v5, "setSectionTitle:", v27);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v29 = -[_SFPBWatchListItem initWithDictionary:]([_SFPBWatchListItem alloc], "initWithDictionary:", v28);
      -[_SFPBWatchNowCardSection setWatchListItem:](v5, "setWatchListItem:", v29);
