...
{
  id v4;
  _SFPBRFSummaryItemTextCardSection *v5;
  void *v6;
  ...
  _SFPBRFSummaryItemTextCardSection *v30;
  __int128 v32;
  __int128 v33;
  __int128 v34;
  __int128 v35;
  ...
  v4 = a3;
  v5 = -[_SFPBRFSummaryItemTextCardSection init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_2:](v5, "setText_2:", v9);
    ...
    if (v10)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_1:](v5, "setText_1:", v13);
    ...
    -[_SFPBRFSummaryItemTextCardSection setText_3s:](v5, "setText_3s:", v15);
    objc_msgSend(v4, "text");
    ...
    if (v22)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_4:](v5, "setText_4:", v25);
    ...
    if (v26)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_5:](v5, "setText_5:", v29);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBRFSummaryItemTextCardSection text](self, "text");
  ...
  -[_SFPBRFSummaryItemTextCardSection text_3s](self, "text_3s");
...
- (unint64_t)hash
{
  ...
  v3 = -[_SFPBRFTextProperty hash](self->_text_2, "hash");
  ...
  return v6 ^ -[_SFPBRFTextProperty hash](self->_text_5, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFSummaryItemTextCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFSummaryItemTextCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFSummaryItemTextCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFSummaryItemTextCardSection)initWithDictionary:(id)a3
{
  ...
  void *v20;
  _SFPBRFTextProperty *v21;
  _SFPBRFSummaryItemTextCardSection *v22;
  void *v24;
  void *v25;
  __int128 v26;
  __int128 v27;
  ...
  v5 = -[_SFPBRFSummaryItemTextCardSection init](&v30, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_2:](v5, "setText_2:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_1:](v5, "setText_1:", v9);
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFSummaryItemTextCardSection addText_3:](v5, "addText_3:", v17);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_4:](v5, "setText_4:", v19);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSummaryItemTextCardSection setText_5:](v5, "setText_5:", v21);
