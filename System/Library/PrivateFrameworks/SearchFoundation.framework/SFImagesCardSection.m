...
- (SFImagesCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFImagesCardSection setType:](v5, "setType:", v12);
    ...
    -[SFImagesCardSection setImages:](v5, "setImages:", v14);

    -[SFImagesCardSection setBorderless:](v5, "setBorderless:", -[SFCardSection borderless](v8, "borderless"));
...
{
  _SFPBImagesCardSection *v2;
  void *v3;

  v2 = -[_SFPBImagesCardSection initWithFacade:]([_SFPBImagesCardSection alloc], "initWithFacade:", self);
  -[_SFPBImagesCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBImagesCardSection initWithFacade:]([_SFPBImagesCardSection alloc], "initWithFacade:", self);
  -[_SFPBImagesCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFImagesCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFImagesCardSection images](self, "images");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setImages:", v16);
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v66;
  void *v67;
  SFImagesCardSection *v68;
  void *v69;
  void *v70;
  objc_super v71;

  v5 = (SFImagesCardSection *)a3;
  if (self == v5)
  {
    LOBYTE(v11) = 1;
  }
  ...
  {
    if (-[SFImagesCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v71.receiver = self;
...
LABEL_28:
            ...
            -[SFImagesCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFImagesCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v55 = v29;
              ...
              if ((v51 == 0) != (v32 != 0))
              {
                ...
                -[SFImagesCardSection images](v6, "images");
                ...
                {
                  v43 = -[SFImagesCardSection borderless](self, "borderless");
                  v11 = v43 ^ -[SFImagesCardSection borderless](v6, "borderless") ^ 1;
                  if (!v41)
                    goto LABEL_68;
                }
                else
...
- (unint64_t)hash
{
  ...
  v20 = v19 ^ -[SFImagesCardSection borderless](self, "borderless");
...
- (SFImagesCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFImagesCardSection setType:](v5, "setType:", v19);
    ...
    if (v27)
    {
      ...
      do
      {
        for (j = 0; j != v28; ++j)
        {
          ...
          v31 = -[SFImage initWithProtobuf:]([SFImage alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v34 + 1) + 8 * j));
          if (v31)
    ...
    -[SFImagesCardSection setImages:](v5, "setImages:", v25);
    if (objc_msgSend(v4, "borderless"))
      -[SFImagesCardSection setBorderless:](v5, "setBorderless:", objc_msgSend(v4, "borderless"));
    v32 = v5;
