...
- (SFWatchListCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFWatchListCardSection setType:](v5, "setType:", v12);
    ...
    -[SFWatchListCardSection setWatchListItem:](v5, "setWatchListItem:", v14);
...
{
  _SFPBWatchListCardSection *v2;
  void *v3;

  v2 = -[_SFPBWatchListCardSection initWithFacade:]([_SFPBWatchListCardSection alloc], "initWithFacade:", self);
  -[_SFPBWatchListCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBWatchListCardSection initWithFacade:]([_SFPBWatchListCardSection alloc], "initWithFacade:", self);
  -[_SFPBWatchListCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFWatchListCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFWatchListCardSection watchListItem](self, "watchListItem");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setWatchListItem:", v16);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFWatchListCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            -[SFWatchListCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFWatchListCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFWatchListCardSection watchListItem](v6, "watchListItem");
...
- (SFWatchListCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFWatchListCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      v25 = [SFWatchListItem alloc];
      objc_msgSend(v4, "watchListItem");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      v27 = -[SFWatchListItem initWithProtobuf:](v25, "initWithProtobuf:", v26);
      -[SFWatchListCardSection setWatchListItem:](v5, "setWatchListItem:", v27);
