...
- (SFCompactRowCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFCompactRowCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFCompactRowCardSection setTitle:](v5, "setTitle:", v27);
    ...
    if (v28)
    {
      ...
      -[SFCompactRowCardSection setSubtitle:](v5, "setSubtitle:", v31);

    }
    if (objc_msgSend(v4, "isSubtitleDetatched"))
      -[SFCompactRowCardSection setIsSubtitleDetatched:](v5, "setIsSubtitleDetatched:", objc_msgSend(v4, "isSubtitleDetatched"));
    ...
    if (v32)
    {
      ...
      -[SFCompactRowCardSection setImage:](v5, "setImage:", v35);
...
- (SFCompactRowCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCompactRowCardSection setType:](v5, "setType:", v12);
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCompactRowCardSection setTitle:](v5, "setTitle:", v14);

    -[SFCardSection subtitle](v8, "subtitle");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCompactRowCardSection setSubtitle:](v5, "setSubtitle:", v15);

    -[SFCompactRowCardSection setIsSubtitleDetatched:](v5, "setIsSubtitleDetatched:", -[SFCardSection isSubtitleDetatched](v8, "isSubtitleDetatched"));
    -[SFCardSection image](v8, "image");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCompactRowCardSection setImage:](v5, "setImage:", v16);
...
{
  _SFPBCompactRowCardSection *v2;
  void *v3;

  v2 = -[_SFPBCompactRowCardSection initWithFacade:]([_SFPBCompactRowCardSection alloc], "initWithFacade:", self);
  -[_SFPBCompactRowCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBCompactRowCardSection initWithFacade:]([_SFPBCompactRowCardSection alloc], "initWithFacade:", self);
  -[_SFPBCompactRowCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFCompactRowCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFCompactRowCardSection title](self, "title");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setTitle:", v16);

  -[SFCompactRowCardSection subtitle](self, "subtitle");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFCompactRowCardSection image](self, "image");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFCompactRowCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v68.receiver = self;
        ...
        if (v22 == -[SFCardSection canBeHidden](v5, "canBeHidden"))
        {
          ...
          if (v23 == -[SFCardSection hasTopPadding](v5, "hasTopPadding"))
          {
            ...
            if (v24 == -[SFCardSection hasBottomPadding](v5, "hasBottomPadding"))
            {
              -[SFCompactRowCardSection type](self, "type");
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              -[SFCompactRowCardSection type](v5, "type");
              v26 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v25 == 0) != (v26 != 0))
              {
                v56 = v26;
                ...
                if (v27 == -[SFCardSection separatorStyle](v5, "separatorStyle"))
                {
                  ...
                  if ((v53 == 0) != (v28 != 0))
                  {
                    ...
                    -[SFCompactRowCardSection title](v5, "title");
...
LABEL_24:
                    ...
                    -[SFCompactRowCardSection subtitle](v5, "subtitle");
                    ...
                    v33 = -[SFCompactRowCardSection isSubtitleDetatched](self, "isSubtitleDetatched");
                    if (v33 == -[SFCompactRowCardSection isSubtitleDetatched](v5, "isSubtitleDetatched"))
                    {
                      -[SFCompactRowCardSection image](self, "image");
                      v38 = (void *)objc_claimAutoreleasedReturnValue();
                      -[SFCompactRowCardSection image](v5, "image");
...
- (unint64_t)hash
{
  ...
  v22 = v21 ^ -[SFCompactRowCardSection isSubtitleDetatched](self, "isSubtitleDetatched");
  -[SFCompactRowCardSection image](self, "image");
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v24 = v19 ^ v22 ^ objc_msgSend(v23, "hash");
