...
{
  id v4;
  SFMapsDetailedRowCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFMapsDetailedRowCardSection setType:](v5, "setType:", v12);
    ...
    -[SFMapsDetailedRowCardSection setMapsData:](v5, "setMapsData:", v14);

    -[SFCardSection pinText](v8, "pinText");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFMapsDetailedRowCardSection setPinText:](v5, "setPinText:", v15);
...
{
  _SFPBMapsDetailedRowCardSection *v2;
  void *v3;

  v2 = -[_SFPBMapsDetailedRowCardSection initWithFacade:]([_SFPBMapsDetailedRowCardSection alloc], "initWithFacade:", self);
  -[_SFPBMapsDetailedRowCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBMapsDetailedRowCardSection initWithFacade:]([_SFPBMapsDetailedRowCardSection alloc], "initWithFacade:", self);
  -[_SFPBMapsDetailedRowCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFMapsDetailedRowCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFMapsDetailedRowCardSection mapsData](self, "mapsData");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setMapsData:", v16);

  -[SFMapsDetailedRowCardSection pinText](self, "pinText");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setPinText:", v18);
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  SFMapsDetailedRowCardSection *v5;
  SFMapsDetailedRowCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  void *v73;
  void *v74;
  SFMapsDetailedRowCardSection *v75;
  void *v76;
  void *v77;
  objc_super v78;

  v5 = (SFMapsDetailedRowCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFMapsDetailedRowCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            -[SFMapsDetailedRowCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFMapsDetailedRowCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v63 = v32;
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                -[SFMapsDetailedRowCardSection mapsData](v6, "mapsData");
...
LABEL_65:
                      ...
                      objc_msgSend(v44, "isEqual:")))
                {
                  ...
                  -[SFMapsDetailedRowCardSection pinText](v6, "pinText");
...
{
  objc_storeStrong((id *)&self->_internalDetailedRowCardSection, a3);
}
...
- (SFMapsDetailedRowCardSection)initWithProtobuf:(id)a3
{
  ...
  void *v26;
  void *v27;
  SFMapsDetailedRowCardSection *v28;
  __int128 v30;
  __int128 v31;
  __int128 v32;
  __int128 v33;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFMapsDetailedRowCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      objc_msgSend(v4, "mapsData");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFMapsDetailedRowCardSection setMapsData:](v5, "setMapsData:", v25);
    ...
    if (v26)
    {
      objc_msgSend(v4, "pinText");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFMapsDetailedRowCardSection setPinText:](v5, "setPinText:", v27);
