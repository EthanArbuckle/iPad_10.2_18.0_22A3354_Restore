...
{
  id v4;
  SFShowPurchaseRequestSheetCommand *v5;
  void *v6;
  void *v7;
  SFShowPurchaseRequestSheetCommand *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SFShowPurchaseRequestSheetCommand;
  v5 = -[SFShowPurchaseRequestSheetCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[SFShowPurchaseRequestSheetCommand setRequestIdentifier:](v5, "setRequestIdentifier:", v7);
...
- (SFShowPurchaseRequestSheetCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFShowPurchaseRequestSheetCommand init](self, "init");
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFShowPurchaseRequestSheetCommand setRequestIdentifier:](v5, "setRequestIdentifier:", v9);
...
{
  _SFPBShowPurchaseRequestSheetCommand *v2;
  void *v3;

  v2 = -[_SFPBShowPurchaseRequestSheetCommand initWithFacade:]([_SFPBShowPurchaseRequestSheetCommand alloc], "initWithFacade:", self);
  -[_SFPBShowPurchaseRequestSheetCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBShowPurchaseRequestSheetCommand initWithFacade:]([_SFPBShowPurchaseRequestSheetCommand alloc], "initWithFacade:", self);
  -[_SFPBShowPurchaseRequestSheetCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFShowPurchaseRequestSheetCommand requestIdentifier](self, "requestIdentifier");
...
- (BOOL)isEqual:(id)a3
{
  SFShowPurchaseRequestSheetCommand *v4;
  SFShowPurchaseRequestSheetCommand *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  v4 = (SFShowPurchaseRequestSheetCommand *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  else if (-[SFShowPurchaseRequestSheetCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())&& (v13.receiver = self, v13.super_class = (Class)SFShowPurchaseRequestSheetCommand, -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    v5 = v4;
    -[SFShowPurchaseRequestSheetCommand requestIdentifier](self, "requestIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFShowPurchaseRequestSheetCommand requestIdentifier](v5, "requestIdentifier");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    if ((v6 == 0) == (v7 != 0))
    {
      v11 = 0;
