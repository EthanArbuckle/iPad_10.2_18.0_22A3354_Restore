...
- (SFTextColumnsCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFTextColumnsCardSection setType:](v5, "setType:", v12);
    ...
    -[SFTextColumnsCardSection setTitle:](v5, "setTitle:", v14);

    -[SFTextColumnsCardSection setTitleWeight:](v5, "setTitleWeight:", -[SFCardSection titleWeight](v8, "titleWeight"));
    -[SFCardSection columns](v8, "columns");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFTextColumnsCardSection setColumns:](v5, "setColumns:", v15);
...
{
  _SFPBTextColumnsCardSection *v2;
  void *v3;

  v2 = -[_SFPBTextColumnsCardSection initWithFacade:]([_SFPBTextColumnsCardSection alloc], "initWithFacade:", self);
  -[_SFPBTextColumnsCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBTextColumnsCardSection initWithFacade:]([_SFPBTextColumnsCardSection alloc], "initWithFacade:", self);
  -[_SFPBTextColumnsCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFTextColumnsCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v75;
  void *v76;
  SFTextColumnsCardSection *v77;
  void *v78;
  void *v79;
  objc_super v80;

  v5 = (SFTextColumnsCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFTextColumnsCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v80.receiver = self;
...
LABEL_27:
            ...
            -[SFTextColumnsCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFTextColumnsCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v78 = v31;
              ...
              if ((v38 == 0) != (v39 != 0))
              {
                ...
                -[SFTextColumnsCardSection title](v6, "title");
...
LABEL_82:
                ...
                v48 = -[SFTextColumnsCardSection titleWeight](self, "titleWeight");
                if (v48 == -[SFTextColumnsCardSection titleWeight](v6, "titleWeight"))
                {
                  -[SFTextColumnsCardSection columns](self, "columns");
                  v53 = (void *)objc_claimAutoreleasedReturnValue();
                  -[SFTextColumnsCardSection columns](v6, "columns");
...
- (unint64_t)hash
{
  ...
  v20 = -[SFTextColumnsCardSection titleWeight](self, "titleWeight");
  -[SFTextColumnsCardSection columns](self, "columns");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
...
- (SFTextColumnsCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[SFPunchout initWithProtobuf:]([SFPunchout alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v40 + 1) + 8 * i));
          if (v13)
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFTextColumnsCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      objc_msgSend(v4, "title");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFTextColumnsCardSection setTitle:](v5, "setTitle:", v25);

    }
    if (objc_msgSend(v4, "titleWeight"))
      -[SFTextColumnsCardSection setTitleWeight:](v5, "setTitleWeight:", objc_msgSend(v4, "titleWeight"));
    ...
    v36 = 0u;
    v37 = 0u;
    objc_msgSend(v4, "columns", 0);
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    v29 = objc_msgSend(v28, "countByEnumeratingWithState:objects:count:", &v36, v45, 16);
    if (v29)
    {
      v30 = v29;
      v31 = *(_QWORD *)v37;
      do
      {
        for (j = 0; j != v30; ++j)
        {
          ...
          v33 = -[SFTextColumn initWithProtobuf:]([SFTextColumn alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v36 + 1) + 8 * j));
          if (v33)
            objc_msgSend(v27, "addObject:", v33);

        }
        v30 = objc_msgSend(v28, "countByEnumeratingWithState:objects:count:", &v36, v45, 16);
      }
      while (v30);
    }

    -[SFTextColumnsCardSection setColumns:](v5, "setColumns:", v27);
    v34 = v5;
