...
{
  id v4;
  RFSimpleItemPlayerCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[RFSimpleItemPlayerCardSection setText_1:](v5, "setText_1:", v9);

    -[SFCardSection text](v8, "text");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemPlayerCardSection setText_2:](v5, "setText_2:", v10);

    -[SFCardSection text](v8, "text");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemPlayerCardSection setText_3:](v5, "setText_3:", v11);

    -[SFCardSection text](v8, "text");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemPlayerCardSection setText_4:](v5, "setText_4:", v12);

    -[SFCardSection player](v8, "player");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemPlayerCardSection setPlayer:](v5, "setPlayer:", v13);
...
{
  _SFPBRFSimpleItemPlayerCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFSimpleItemPlayerCardSection initWithFacade:]([_SFPBRFSimpleItemPlayerCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSimpleItemPlayerCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFSimpleItemPlayerCardSection initWithFacade:]([_SFPBRFSimpleItemPlayerCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSimpleItemPlayerCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFSimpleItemPlayerCardSection text](self, "text");
  ...
  -[RFSimpleItemPlayerCardSection player](self, "player");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = (void *)objc_msgSend(v13, "copy");
  objc_msgSend(v4, "setPlayer:", v14);
...
- (BOOL)isEqual:(id)a3
{
  RFSimpleItemPlayerCardSection *v4;
  RFSimpleItemPlayerCardSection *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  {
    if (-[RFSimpleItemPlayerCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v50.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v50, sel_isEqual_, v4))
      {
        ...
        -[RFSimpleItemPlayerCardSection text](self, "text");
        v6 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFSimpleItemPlayerCardSection text](v5, "text");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v6 == 0) == (v7 != 0))
        {
          v10 = 0;
        ...
        if ((v49 == 0) != (v11 != 0))
        {
          ...
          if ((v15 == 0) != (v16 != 0))
          {
            ...
            if ((v21 == 0) != (v22 != 0))
            {
              ...
              -[RFSimpleItemPlayerCardSection player](self, "player");
              v24 = (void *)objc_claimAutoreleasedReturnValue();
              -[RFSimpleItemPlayerCardSection player](v5, "player");
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v24 == 0) == (v25 != 0))
              {
...
- (RFSimpleItemPlayerCardSection)initWithProtobuf:(id)a3
{
  ...
  void *v28;
  SFButtonItem *v29;
  RFSimpleItemPlayerCardSection *v30;
  __int128 v32;
  __int128 v33;
  __int128 v34;
  __int128 v35;
  ...
  if (v5)
  {
    ...
    if (v10)
    {
      ...
      -[RFSimpleItemPlayerCardSection setText_2:](v5, "setText_2:", v13);
    ...
    -[RFSimpleItemPlayerCardSection setText_3:](v5, "setText_3:", v15);
    objc_msgSend(v4, "text");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v22)
    {
      ...
      -[RFSimpleItemPlayerCardSection setText_4:](v5, "setText_4:", v25);
    ...
    if (v26)
    {
      ...
      -[RFSimpleItemPlayerCardSection setPlayer:](v5, "setPlayer:", v29);
