...
- (SFTrackListCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCardSection tracks](v8, "tracks");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFTrackListCardSection setTracks:](v5, "setTracks:", v16);
...
{
  _SFPBTrackListCardSection *v2;
  void *v3;

  v2 = -[_SFPBTrackListCardSection initWithFacade:]([_SFPBTrackListCardSection alloc], "initWithFacade:", self);
  -[_SFPBTrackListCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBTrackListCardSection initWithFacade:]([_SFPBTrackListCardSection alloc], "initWithFacade:", self);
  -[_SFPBTrackListCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFTrackListCardSection tracks](self, "tracks");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = (void *)objc_msgSend(v19, "copy");
  objc_msgSend(v4, "setTracks:", v20);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFTrackListCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v67.receiver = self;
...
LABEL_24:
                          ...
                          objc_msgSend(v32, "isEqual:")))
                    {
                      -[SFTrackListCardSection tracks](self, "tracks");
                      v37 = (void *)objc_claimAutoreleasedReturnValue();
                      -[SFTrackListCardSection tracks](v5, "tracks");
                      v36 = (void *)objc_claimAutoreleasedReturnValue();
                      if ((v37 == 0) == (v36 != 0))
                      {
...
- (SFTrackListCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v31)
    {
      ...
      do
      {
        for (j = 0; j != v32; ++j)
        {
          ...
          v35 = -[SFTrack initWithProtobuf:]([SFTrack alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v38 + 1) + 8 * j));
          if (v35)
    ...
    -[SFTrackListCardSection setTracks:](v5, "setTracks:", v29);
    v36 = v5;
