...
- (SFButtonCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFButtonCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFButtonCardSection setTitle:](v5, "setTitle:", v27);
    ...
    if (v28)
    {
      ...
      -[SFButtonCardSection setThumbnail:](v5, "setThumbnail:", v31);
...
- (SFButtonCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFButtonCardSection setType:](v5, "setType:", v12);
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFButtonCardSection setTitle:](v5, "setTitle:", v14);

    -[SFCardSection thumbnail](v8, "thumbnail");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFButtonCardSection setThumbnail:](v5, "setThumbnail:", v15);
...
{
  _SFPBButtonCardSection *v2;
  void *v3;

  v2 = -[_SFPBButtonCardSection initWithFacade:]([_SFPBButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBButtonCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBButtonCardSection initWithFacade:]([_SFPBButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBButtonCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFButtonCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFButtonCardSection title](self, "title");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setTitle:", v16);

  -[SFButtonCardSection thumbnail](self, "thumbnail");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v73;
  void *v74;
  SFButtonCardSection *v75;
  void *v76;
  void *v77;
  objc_super v78;

  v5 = (SFButtonCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFButtonCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            -[SFButtonCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFButtonCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v63 = v32;
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                -[SFButtonCardSection title](v6, "title");
...
LABEL_65:
                      ...
                      objc_msgSend(v44, "isEqual:")))
                {
                  ...
                  -[SFButtonCardSection thumbnail](v6, "thumbnail");
