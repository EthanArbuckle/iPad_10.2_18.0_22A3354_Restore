...
- (SFButtonListCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFButtonListCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFButtonListCardSection setSectionTitle:](v5, "setSectionTitle:", v25);
    ...
    if (v29)
    {
      ...
      do
      {
        for (j = 0; j != v30; ++j)
        {
          ...
          v33 = -[SFButtonItem initWithProtobuf:]([SFButtonItem alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v38 + 1) + 8 * j));
          if (v33)
    ...
    -[SFButtonListCardSection setButtons:](v5, "setButtons:", v27);
    ...
    if (v34)
    {
      ...
      -[SFButtonListCardSection setShowMoreButtonTitle:](v5, "setShowMoreButtonTitle:", v35);
...
- (SFButtonListCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFButtonListCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection SectionTitle](v8, "SectionTitle");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFButtonListCardSection setSectionTitle:](v5, "setSectionTitle:", v14);

    -[SFCardSection buttons](v8, "buttons");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFButtonListCardSection setButtons:](v5, "setButtons:", v15);

    -[SFCardSection showMoreButtonTitle](v8, "showMoreButtonTitle");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFButtonListCardSection setShowMoreButtonTitle:](v5, "setShowMoreButtonTitle:", v16);
...
{
  _SFPBButtonListCardSection *v2;
  void *v3;

  v2 = -[_SFPBButtonListCardSection initWithFacade:]([_SFPBButtonListCardSection alloc], "initWithFacade:", self);
  -[_SFPBButtonListCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBButtonListCardSection initWithFacade:]([_SFPBButtonListCardSection alloc], "initWithFacade:", self);
  -[_SFPBButtonListCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFButtonListCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFButtonListCardSection SectionTitle](self, "SectionTitle");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setSectionTitle:", v16);

  -[SFButtonListCardSection buttons](self, "buttons");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setButtons:", v18);

  -[SFButtonListCardSection showMoreButtonTitle](self, "showMoreButtonTitle");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = (void *)objc_msgSend(v19, "copy");
  objc_msgSend(v4, "setShowMoreButtonTitle:", v20);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFButtonListCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v67.receiver = self;
        ...
        if (v22 == -[SFCardSection canBeHidden](v5, "canBeHidden"))
        {
          ...
          if (v23 == -[SFCardSection hasTopPadding](v5, "hasTopPadding"))
          {
            ...
            if (v24 == -[SFCardSection hasBottomPadding](v5, "hasBottomPadding"))
            {
              -[SFButtonListCardSection type](self, "type");
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              -[SFButtonListCardSection type](v5, "type");
              v26 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v25 == 0) != (v26 != 0))
              {
                v55 = v26;
                ...
                if (v27 == -[SFCardSection separatorStyle](v5, "separatorStyle"))
                {
                  ...
                  if ((v52 == 0) != (v28 != 0))
                  {
                    ...
                    -[SFButtonListCardSection SectionTitle](v5, "SectionTitle");
...
LABEL_24:
                    ...
                    -[SFButtonListCardSection buttons](v5, "buttons");
                          ...
                          objc_msgSend(v32, "isEqual:")))
                    {
                      ...
                      -[SFButtonListCardSection showMoreButtonTitle](v5, "showMoreButtonTitle");
                      v36 = (void *)objc_claimAutoreleasedReturnValue();
                      if ((v37 == 0) == (v36 != 0))
                      {
