...
{
  id v4;
  RFSimpleItemRichSearchResultCardSection *v5;
  void *v6;
  RFTextProperty *v7;
  void *v8;
  RFTextProperty *v9;
  ...
  RFSimpleItemRichSearchResultCardSection *v50;
  __int128 v52;
  __int128 v53;
  __int128 v54;
  __int128 v55;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFSimpleItemRichSearchResultCardSection setText_1:](v5, "setText_1:", v9);
    ...
    if (v10)
    {
      ...
      -[RFSimpleItemRichSearchResultCardSection setText_2:](v5, "setText_2:", v13);
    ...
    -[RFSimpleItemRichSearchResultCardSection setText_3:](v5, "setText_3:", v15);
    objc_msgSend(v4, "text");
    ...
    if (v22)
    {
      ...
      -[RFSimpleItemRichSearchResultCardSection setText_4:](v5, "setText_4:", v25);
    ...
    -[RFSimpleItemRichSearchResultCardSection setText_5:](v5, "setText_5:", v27);
    objc_msgSend(v4, "text");
    ...
    if (v34)
    {
      ...
      -[RFSimpleItemRichSearchResultCardSection setText_6:](v5, "setText_6:", v37);
    ...
    if (v38)
    {
      ...
      -[RFSimpleItemRichSearchResultCardSection setText_7:](v5, "setText_7:", v41);
    ...
    if (v42)
    {
      ...
      -[RFSimpleItemRichSearchResultCardSection setText_8:](v5, "setText_8:", v45);
    ...
    if (v46)
    {
      ...
      -[RFSimpleItemRichSearchResultCardSection setThumbnail:](v5, "setThumbnail:", v49);
...
- (RFSimpleItemRichSearchResultCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCardSection text](v8, "text");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setText_2:](v5, "setText_2:", v10);

    -[SFCardSection text](v8, "text");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setText_3:](v5, "setText_3:", v11);

    -[SFCardSection text](v8, "text");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setText_4:](v5, "setText_4:", v12);

    -[SFCardSection text](v8, "text");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setText_5:](v5, "setText_5:", v13);

    -[SFCardSection text](v8, "text");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setText_6:](v5, "setText_6:", v14);

    -[SFCardSection text](v8, "text");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setText_7:](v5, "setText_7:", v15);

    -[SFCardSection text](v8, "text");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setText_8:](v5, "setText_8:", v16);

    -[SFCardSection thumbnail](v8, "thumbnail");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSimpleItemRichSearchResultCardSection setThumbnail:](v5, "setThumbnail:", v17);
...
{
  _SFPBRFSimpleItemRichSearchResultCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFSimpleItemRichSearchResultCardSection initWithFacade:]([_SFPBRFSimpleItemRichSearchResultCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSimpleItemRichSearchResultCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFSimpleItemRichSearchResultCardSection initWithFacade:]([_SFPBRFSimpleItemRichSearchResultCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSimpleItemRichSearchResultCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFSimpleItemRichSearchResultCardSection text](self, "text");
  ...
  -[RFSimpleItemRichSearchResultCardSection thumbnail](self, "thumbnail");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  RFSimpleItemRichSearchResultCardSection *v4;
  RFSimpleItemRichSearchResultCardSection *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  v4 = (RFSimpleItemRichSearchResultCardSection *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  ...
  {
    if (-[RFSimpleItemRichSearchResultCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v81.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v81, sel_isEqual_, v4))
      {
        ...
        -[RFSimpleItemRichSearchResultCardSection text](self, "text");
        v6 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFSimpleItemRichSearchResultCardSection text](v5, "text");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v6 == 0) == (v7 != 0))
        {
          v11 = 0;
...
LABEL_48:
              ...
              objc_msgSend(v40, "isEqual:")))
        {
          -[RFSimpleItemRichSearchResultCardSection thumbnail](self, "thumbnail");
          v46 = (void *)objc_claimAutoreleasedReturnValue();
          -[RFSimpleItemRichSearchResultCardSection thumbnail](v5, "thumbnail");
