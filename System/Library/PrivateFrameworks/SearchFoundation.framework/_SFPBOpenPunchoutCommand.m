...
{
  id v4;
  _SFPBOpenPunchoutCommand *v5;
  void *v6;
  _SFPBPunchout *v7;
  void *v8;
  _SFPBPunchout *v9;
  _SFPBOpenPunchoutCommand *v10;

  v4 = a3;
  v5 = -[_SFPBOpenPunchoutCommand init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBOpenPunchoutCommand setPunchout:](v5, "setPunchout:", v9);
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[_SFPBOpenPunchoutCommand punchout](self, "punchout");
...
- (unint64_t)hash
{
  return -[_SFPBPunchout hash](self->_punchout, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_punchout)
  {
    ...
    if (v5)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("punchout"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("punchout"));
...
- (NSData)jsonData
{
  ...
  -[_SFPBOpenPunchoutCommand dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBOpenPunchoutCommand)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBOpenPunchoutCommand initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBOpenPunchoutCommand)initWithDictionary:(id)a3
{
  ...
  void *v6;
  _SFPBPunchout *v7;
  _SFPBOpenPunchoutCommand *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBOpenPunchoutCommand;
  v5 = -[_SFPBOpenPunchoutCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBOpenPunchoutCommand setPunchout:](v5, "setPunchout:", v7);
