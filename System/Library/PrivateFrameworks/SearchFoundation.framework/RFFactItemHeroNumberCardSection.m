...
{
  id v4;
  RFFactItemHeroNumberCardSection *v5;
  void *v6;
  RFTextProperty *v7;
  void *v8;
  RFTextProperty *v9;
  ...
  void *v36;
  RFTextProperty *v37;
  RFFactItemHeroNumberCardSection *v38;
  __int128 v40;
  __int128 v41;
  __int128 v42;
  __int128 v43;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFFactItemHeroNumberCardSection setNumber:](v5, "setNumber:", v9);
    ...
    if (v10)
    {
      ...
      -[RFFactItemHeroNumberCardSection setUnit:](v5, "setUnit:", v13);
    ...
    -[RFFactItemHeroNumberCardSection setText_2:](v5, "setText_2:", v15);
    ...
    -[RFFactItemHeroNumberCardSection setText_3:](v5, "setText_3:", v23);
    ...
    if (v30)
    {
      ...
      -[RFFactItemHeroNumberCardSection setText_4:](v5, "setText_4:", v33);
    ...
    if (v34)
    {
      ...
      -[RFFactItemHeroNumberCardSection setText_5:](v5, "setText_5:", v37);
...
- (RFFactItemHeroNumberCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemHeroNumberCardSection setUnit:](v5, "setUnit:", v10);

    -[SFCardSection text](v8, "text");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemHeroNumberCardSection setText_2:](v5, "setText_2:", v11);

    -[SFCardSection text](v8, "text");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemHeroNumberCardSection setText_3:](v5, "setText_3:", v12);

    -[SFCardSection text](v8, "text");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemHeroNumberCardSection setText_4:](v5, "setText_4:", v13);

    -[SFCardSection text](v8, "text");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemHeroNumberCardSection setText_5:](v5, "setText_5:", v14);
...
{
  _SFPBRFFactItemHeroNumberCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFFactItemHeroNumberCardSection initWithFacade:]([_SFPBRFFactItemHeroNumberCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFFactItemHeroNumberCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFFactItemHeroNumberCardSection initWithFacade:]([_SFPBRFFactItemHeroNumberCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFFactItemHeroNumberCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFFactItemHeroNumberCardSection number](self, "number");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setNumber:", v6);

  -[RFFactItemHeroNumberCardSection unit](self, "unit");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v7, "copy");
  objc_msgSend(v4, "setUnit:", v8);

  -[RFFactItemHeroNumberCardSection text](self, "text");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  RFFactItemHeroNumberCardSection *v5;
  RFFactItemHeroNumberCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (RFFactItemHeroNumberCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[RFFactItemHeroNumberCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v58.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v58, sel_isEqual_, v5))
      {
        ...
        -[RFFactItemHeroNumberCardSection number](self, "number");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFFactItemHeroNumberCardSection number](v6, "number");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v7 == 0) == (v8 != 0))
        {
          v11 = 0;
LABEL_37:
        ...
        -[RFFactItemHeroNumberCardSection unit](v6, "unit");
...
LABEL_33:
        ...
        -[RFFactItemHeroNumberCardSection text](self, "text");
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFFactItemHeroNumberCardSection text](v6, "text");
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        v12 = v15;
        v8 = v53;
        if ((v16 == 0) != (v17 != 0))
