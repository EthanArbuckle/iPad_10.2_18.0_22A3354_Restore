...
{
  id v4;
  RFFactItemShortHeroNumberCardSection *v5;
  void *v6;
  RFTextProperty *v7;
  void *v8;
  RFTextProperty *v9;
  ...
  RFFactItemShortHeroNumberCardSection *v42;
  __int128 v44;
  __int128 v45;
  __int128 v46;
  __int128 v47;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFFactItemShortHeroNumberCardSection setNumber:](v5, "setNumber:", v9);
    ...
    if (v10)
    {
      ...
      -[RFFactItemShortHeroNumberCardSection setText_1:](v5, "setText_1:", v13);
    ...
    -[RFFactItemShortHeroNumberCardSection setText_2:](v5, "setText_2:", v15);
    ...
    -[RFFactItemShortHeroNumberCardSection setText_3:](v5, "setText_3:", v23);
    ...
    if (v30)
    {
      ...
      -[RFFactItemShortHeroNumberCardSection setUnit:](v5, "setUnit:", v33);
    ...
    if (v34)
    {
      ...
      -[RFFactItemShortHeroNumberCardSection setText_4:](v5, "setText_4:", v37);
    ...
    if (v38)
    {
      ...
      -[RFFactItemShortHeroNumberCardSection setThumbnail:](v5, "setThumbnail:", v41);
...
- (RFFactItemShortHeroNumberCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemShortHeroNumberCardSection setText_1:](v5, "setText_1:", v10);

    -[SFCardSection text](v8, "text");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemShortHeroNumberCardSection setText_2:](v5, "setText_2:", v11);

    -[SFCardSection text](v8, "text");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemShortHeroNumberCardSection setText_3:](v5, "setText_3:", v12);

    -[SFCardSection unit](v8, "unit");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemShortHeroNumberCardSection setUnit:](v5, "setUnit:", v13);

    -[SFCardSection text](v8, "text");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemShortHeroNumberCardSection setText_4:](v5, "setText_4:", v14);

    -[SFCardSection thumbnail](v8, "thumbnail");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemShortHeroNumberCardSection setThumbnail:](v5, "setThumbnail:", v15);
...
{
  _SFPBRFFactItemShortHeroNumberCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFFactItemShortHeroNumberCardSection initWithFacade:]([_SFPBRFFactItemShortHeroNumberCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFFactItemShortHeroNumberCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFFactItemShortHeroNumberCardSection initWithFacade:]([_SFPBRFFactItemShortHeroNumberCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFFactItemShortHeroNumberCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFFactItemShortHeroNumberCardSection number](self, "number");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setNumber:", v6);

  -[RFFactItemShortHeroNumberCardSection text](self, "text");
  ...
  -[RFFactItemShortHeroNumberCardSection unit](self, "unit");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RFFactItemShortHeroNumberCardSection thumbnail](self, "thumbnail");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  RFFactItemShortHeroNumberCardSection *v5;
  RFFactItemShortHeroNumberCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (RFFactItemShortHeroNumberCardSection *)a3;
  if (self == v5)
  {
    v12 = 1;
  }
  ...
  {
    if (-[RFFactItemShortHeroNumberCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v73.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v73, sel_isEqual_, v5))
      {
        ...
        -[RFFactItemShortHeroNumberCardSection number](self, "number");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFFactItemShortHeroNumberCardSection number](v6, "number");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v7 == 0) == (v8 != 0))
        {
          v12 = 0;
LABEL_50:
        ...
        -[RFFactItemShortHeroNumberCardSection text](self, "text");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFFactItemShortHeroNumberCardSection text](v6, "text");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v13 == 0) != (v14 != 0))
        {
          v70 = v14;
...
LABEL_46:
          ...
          if ((v19 == 0) != (v20 != 0))
          {
            ...
            if ((v26 == 0) != (v27 != 0))
            {
              ...
              -[RFFactItemShortHeroNumberCardSection unit](self, "unit");
              v29 = (void *)objc_claimAutoreleasedReturnValue();
              -[RFFactItemShortHeroNumberCardSection unit](v6, "unit");
              v30 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v29 == 0) != (v30 != 0))
              {
                v57 = v30;
...
LABEL_71:
                      ...
                      objc_msgSend(v37, "isEqual:")))
                {
                  -[RFFactItemShortHeroNumberCardSection thumbnail](self, "thumbnail");
                  v40 = (void *)objc_claimAutoreleasedReturnValue();
                  -[RFFactItemShortHeroNumberCardSection thumbnail](v6, "thumbnail");
