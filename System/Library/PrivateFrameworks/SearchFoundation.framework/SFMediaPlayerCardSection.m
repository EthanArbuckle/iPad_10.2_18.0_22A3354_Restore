...
- (SFMediaPlayerCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFMediaPlayerCardSection setType:](v5, "setType:", v12);
    ...
    -[SFMediaPlayerCardSection setTitle:](v5, "setTitle:", v14);

    -[SFCardSection subtitle](v8, "subtitle");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFMediaPlayerCardSection setSubtitle:](v5, "setSubtitle:", v15);

    -[SFCardSection mediaItems](v8, "mediaItems");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFMediaPlayerCardSection setMediaItems:](v5, "setMediaItems:", v16);
...
{
  _SFPBMediaPlayerCardSection *v2;
  void *v3;

  v2 = -[_SFPBMediaPlayerCardSection initWithFacade:]([_SFPBMediaPlayerCardSection alloc], "initWithFacade:", self);
  -[_SFPBMediaPlayerCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBMediaPlayerCardSection initWithFacade:]([_SFPBMediaPlayerCardSection alloc], "initWithFacade:", self);
  -[_SFPBMediaPlayerCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFMediaPlayerCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFMediaPlayerCardSection title](self, "title");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setTitle:", v16);

  -[SFMediaPlayerCardSection subtitle](self, "subtitle");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setSubtitle:", v18);

  -[SFMediaPlayerCardSection mediaItems](self, "mediaItems");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = (void *)objc_msgSend(v19, "copy");
  objc_msgSend(v4, "setMediaItems:", v20);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFMediaPlayerCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v67.receiver = self;
        ...
        if (v22 == -[SFCardSection canBeHidden](v5, "canBeHidden"))
        {
          ...
          if (v23 == -[SFCardSection hasTopPadding](v5, "hasTopPadding"))
          {
            ...
            if (v24 == -[SFCardSection hasBottomPadding](v5, "hasBottomPadding"))
            {
              -[SFMediaPlayerCardSection type](self, "type");
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              -[SFMediaPlayerCardSection type](v5, "type");
              v26 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v25 == 0) != (v26 != 0))
              {
                v55 = v26;
                ...
                if (v27 == -[SFCardSection separatorStyle](v5, "separatorStyle"))
                {
                  ...
                  if ((v52 == 0) != (v28 != 0))
                  {
                    ...
                    -[SFMediaPlayerCardSection title](v5, "title");
...
LABEL_24:
                    ...
                    -[SFMediaPlayerCardSection subtitle](v5, "subtitle");
                          ...
                          objc_msgSend(v32, "isEqual:")))
                    {
                      ...
                      -[SFMediaPlayerCardSection mediaItems](v5, "mediaItems");
                      v36 = (void *)objc_claimAutoreleasedReturnValue();
                      if ((v37 == 0) == (v36 != 0))
                      {
...
- (SFMediaPlayerCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFMediaPlayerCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      objc_msgSend(v4, "title");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFMediaPlayerCardSection setTitle:](v5, "setTitle:", v25);
    ...
    if (v26)
    {
      objc_msgSend(v4, "subtitle");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFMediaPlayerCardSection setSubtitle:](v5, "setSubtitle:", v27);
    ...
    if (v31)
    {
      ...
      do
      {
        for (j = 0; j != v32; ++j)
        {
          ...
          v35 = -[SFMediaItem initWithProtobuf:]([SFMediaItem alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v38 + 1) + 8 * j));
          if (v35)
    ...
    -[SFMediaPlayerCardSection setMediaItems:](v5, "setMediaItems:", v29);
    v36 = v5;
