...
- (_SFPBGridCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBGridCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBGridCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBGridCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBGridCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBGridCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBGridCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBGridCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBGridCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBGridCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBGridCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    -[_SFPBGridCardSection setCardSections:](v5, "setCardSections:", v25);
    v32 = v5;
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBGridCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBGridCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBGridCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBGridCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBGridCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBGridCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBGridCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBGridCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBGridCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBGridCardSection cardSections](self, "cardSections");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = 0u;
  v20 = 0u;
  v21 = 0u;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBGridCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBGridCardSection hasBottomPadding](self, "hasBottomPadding"));
    v16 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBGridCardSection hasTopPadding](self, "hasTopPadding"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v30 = -[_SFPBGridCardSection separatorStyle](self, "separatorStyle");
    if (v30 >= 6)
    {
...
- (NSData)jsonData
{
  ...
  -[_SFPBGridCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBGridCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBGridCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBGridCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBGridCardSection init](&v54, sel_init);
  if (v5)
  {
        ...
        do
        {
          for (i = 0; i != v10; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBGridCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v14);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBGridCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v16);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBGridCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v18);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBGridCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    v45 = v20;
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBGridCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v20, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBGridCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v21, "BOOLValue"));
    v43 = v21;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBGridCardSection setType:](v5, "setType:", v24);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBGridCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v25, "intValue"));
    v42 = v25;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBGridCardSection setBackgroundColor:](v5, "setBackgroundColor:", v27);
        ...
        do
        {
          for (j = 0; j != v31; ++j)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBGridCardSection addCardSections:](v5, "addCardSections:", v35);
