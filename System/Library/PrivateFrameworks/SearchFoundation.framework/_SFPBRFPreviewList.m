...
- (_SFPBRFPreviewList)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBRFPreviewList init](self, "init");
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[_SFPBRFPreview initWithFacade:]([_SFPBRFPreview alloc], "initWithFacade:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * i));
          if (v13)
    ...
    -[_SFPBRFPreviewList setPreviews:](v5, "setPreviews:", v7);
    v14 = v5;
...
- (void)clearPreviews
{
  -[NSArray removeAllObjects](self->_previews, "removeAllObjects");
}
...
- (void)addPreviews:(id)a3
{
  ...
  -[NSArray addObject:](previews, "addObject:", v4);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBRFPreviewList previews](self, "previews");
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_previews, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_previews, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("previews"));
  }
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFPreviewList dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFPreviewList)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFPreviewList initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFPreviewList)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBRFPreviewList init](&v21, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("previews"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[_SFPBRFPreview initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[_SFPBRFPreviewList addPreviews:](v5, "addPreviews:", v14);
