...
- (SFFlightCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFFlightCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      v27 = -[SFFlight initWithProtobuf:](v25, "initWithProtobuf:", v26);
      -[SFFlightCardSection setFlight:](v5, "setFlight:", v27);

    }
    if (objc_msgSend(v4, "selectedLegIndex"))
      -[SFFlightCardSection setSelectedLegIndex:](v5, "setSelectedLegIndex:", objc_msgSend(v4, "selectedLegIndex"));
    v28 = v5;
...
- (SFFlightCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFFlightCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection flight](v8, "flight");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFFlightCardSection setFlight:](v5, "setFlight:", v14);

    -[SFFlightCardSection setSelectedLegIndex:](v5, "setSelectedLegIndex:", -[SFCardSection selectedLegIndex](v8, "selectedLegIndex"));
...
{
  _SFPBFlightCardSection *v2;
  void *v3;

  v2 = -[_SFPBFlightCardSection initWithFacade:]([_SFPBFlightCardSection alloc], "initWithFacade:", self);
  -[_SFPBFlightCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBFlightCardSection initWithFacade:]([_SFPBFlightCardSection alloc], "initWithFacade:", self);
  -[_SFPBFlightCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFFlightCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFFlightCardSection flight](self, "flight");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setFlight:", v16);
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v66;
  void *v67;
  SFFlightCardSection *v68;
  void *v69;
  void *v70;
  objc_super v71;

  v5 = (SFFlightCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFFlightCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v71.receiver = self;
...
LABEL_28:
            ...
            -[SFFlightCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFFlightCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v55 = v29;
              ...
              if ((v51 == 0) != (v32 != 0))
              {
                ...
                -[SFFlightCardSection flight](v6, "flight");
                ...
                {
                  v43 = -[SFFlightCardSection selectedLegIndex](self, "selectedLegIndex");
                  v11 = v43 == -[SFFlightCardSection selectedLegIndex](v6, "selectedLegIndex");
                  if (!v41)
                    goto LABEL_68;
                }
                else
...
- (unint64_t)hash
{
  ...
  v20 = v19 ^ -[SFFlightCardSection selectedLegIndex](self, "selectedLegIndex");
