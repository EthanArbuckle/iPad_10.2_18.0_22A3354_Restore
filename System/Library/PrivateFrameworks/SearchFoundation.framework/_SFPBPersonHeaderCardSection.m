...
{
  id v4;
  _SFPBPersonHeaderCardSection *v5;
  void *v6;
  _SFPBPerson *v7;
  void *v8;
  _SFPBPerson *v9;
  _SFPBPersonHeaderCardSection *v10;

  v4 = a3;
  v5 = -[_SFPBPersonHeaderCardSection init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBPersonHeaderCardSection setPerson:](v5, "setPerson:", v9);
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[_SFPBPersonHeaderCardSection person](self, "person");
...
- (NSData)jsonData
{
  ...
  -[_SFPBPersonHeaderCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBPersonHeaderCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBPersonHeaderCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBPersonHeaderCardSection)initWithDictionary:(id)a3
{
  ...
  void *v6;
  _SFPBPerson *v7;
  _SFPBPersonHeaderCardSection *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBPersonHeaderCardSection;
  v5 = -[_SFPBPersonHeaderCardSection init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBPersonHeaderCardSection setPerson:](v5, "setPerson:", v7);
