...
{
  id v4;
  _SFPBImageDerivedColor *v5;
  void *v6;
  _SFPBImage *v7;
  void *v8;
  _SFPBImage *v9;
  _SFPBImageDerivedColor *v10;

  v4 = a3;
  v5 = -[_SFPBImageDerivedColor init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBImageDerivedColor setImage:](v5, "setImage:", v9);
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[_SFPBImageDerivedColor image](self, "image");
...
- (NSData)jsonData
{
  ...
  -[_SFPBImageDerivedColor dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBImageDerivedColor)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBImageDerivedColor initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBImageDerivedColor)initWithDictionary:(id)a3
{
  ...
  void *v6;
  _SFPBImage *v7;
  _SFPBImageDerivedColor *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBImageDerivedColor;
  v5 = -[_SFPBImageDerivedColor init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBImageDerivedColor setImage:](v5, "setImage:", v7);
