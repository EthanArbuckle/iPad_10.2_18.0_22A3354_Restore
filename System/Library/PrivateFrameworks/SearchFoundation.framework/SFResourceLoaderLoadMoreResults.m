@implementation SFResourceLoaderLoadMoreResults
  ...
  if (v3)
  {
    ...
    while (2)
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        {
          objc_msgSend(v7, "moreResultsLoader");
          v8 = (void *)objc_claimAutoreleasedReturnValue();
          if (objc_msgSend(v8, "canLoadMoreResults:", *(_QWORD *)(a1 + 32)))
          {
            objc_msgSend(v8, "loadMoreResults:completionHandler:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40));
            ...
            if (os_log_type_enabled((os_log_t)PARLogHandleForCategory_logHandles_1_63034, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138412546;
              ...
              v24 = 2112;
              v25 = v8;
              _os_log_debug_impl(&dword_19E535000, v14, OS_LOG_TYPE_DEBUG, "more results %@ loaded by %@", buf, 0x16u);
            }
...
LABEL_23:
            ...
            goto LABEL_24;
               ...
               && (objc_msgSend(v7, "loadMoreResults:withCompletionHandler:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40)) & 1) != 0)
        {
          goto LABEL_23;
        }
  ...
  if (os_log_type_enabled((os_log_t)PARLogHandleForCategory_logHandles_1_63034, OS_LOG_TYPE_ERROR))
  {
    *(_DWORD *)buf = 138412290;
    v23 = v12;
    _os_log_error_impl(&dword_19E535000, v13, OS_LOG_TYPE_ERROR, "SFResourceLoaderLoadMoreResults error: %@", buf, 0xCu);
  }
