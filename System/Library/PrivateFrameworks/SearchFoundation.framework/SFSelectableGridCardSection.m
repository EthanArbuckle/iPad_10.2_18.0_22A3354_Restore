...
{
  id v4;
  SFSelectableGridCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFSelectableGridCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection entries](v8, "entries");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFSelectableGridCardSection setEntries:](v5, "setEntries:", v14);

    -[SFCardSection initialSelectedIndex](v8, "initialSelectedIndex");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFSelectableGridCardSection setInitialSelectedIndex:](v5, "setInitialSelectedIndex:", v15);
...
{
  _SFPBSelectableGridCardSection *v2;
  void *v3;

  v2 = -[_SFPBSelectableGridCardSection initWithFacade:]([_SFPBSelectableGridCardSection alloc], "initWithFacade:", self);
  -[_SFPBSelectableGridCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBSelectableGridCardSection initWithFacade:]([_SFPBSelectableGridCardSection alloc], "initWithFacade:", self);
  -[_SFPBSelectableGridCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFSelectableGridCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFSelectableGridCardSection entries](self, "entries");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setEntries:", v16);

  -[SFSelectableGridCardSection initialSelectedIndex](self, "initialSelectedIndex");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setInitialSelectedIndex:", v18);
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  SFSelectableGridCardSection *v5;
  SFSelectableGridCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  void *v73;
  void *v74;
  SFSelectableGridCardSection *v75;
  void *v76;
  void *v77;
  objc_super v78;

  v5 = (SFSelectableGridCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFSelectableGridCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            -[SFSelectableGridCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFSelectableGridCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v63 = v32;
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                -[SFSelectableGridCardSection entries](v6, "entries");
...
LABEL_65:
                      ...
                      objc_msgSend(v44, "isEqual:")))
                {
                  ...
                  -[SFSelectableGridCardSection initialSelectedIndex](v6, "initialSelectedIndex");
...
- (SFSelectableGridCardSection)initWithProtobuf:(id)a3
{
  ...
  uint64_t v29;
  uint64_t j;
  SFTitleSubtitleTuple *v31;
  void *v32;
  SFSelectableGridCardSection *v33;
  __int128 v35;
  __int128 v36;
  __int128 v37;
  __int128 v38;
  ...
  v5 = -[SFCardSection init](&v43, sel_init);
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[SFPunchout initWithProtobuf:]([SFPunchout alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v39 + 1) + 8 * i));
          if (v13)
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFSelectableGridCardSection setType:](v5, "setType:", v19);
    ...
    if (v27)
    {
      ...
      do
      {
        for (j = 0; j != v28; ++j)
        {
          ...
          v31 = -[SFTitleSubtitleTuple initWithProtobuf:]([SFTitleSubtitleTuple alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v35 + 1) + 8 * j));
          if (v31)
    ...
    -[SFSelectableGridCardSection setEntries:](v5, "setEntries:", v25);
    if (objc_msgSend(v4, "initialSelectedIndex"))
    {
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", objc_msgSend(v4, "initialSelectedIndex"));
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFSelectableGridCardSection setInitialSelectedIndex:](v5, "setInitialSelectedIndex:", v32);
