...
{
  id v4;
  RFSummaryItemAlignedTextCardSection *v5;
  void *v6;
  RFTextProperty *v7;
  void *v8;
  RFTextProperty *v9;
  ...
  RFSummaryItemAlignedTextCardSection *v42;
  __int128 v44;
  __int128 v45;
  __int128 v46;
  __int128 v47;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFSummaryItemAlignedTextCardSection setText_1:](v5, "setText_1:", v9);
    ...
    if (v10)
    {
      ...
      -[RFSummaryItemAlignedTextCardSection setText_2:](v5, "setText_2:", v13);
    ...
    -[RFSummaryItemAlignedTextCardSection setText_3:](v5, "setText_3:", v15);
    objc_msgSend(v4, "text");
    ...
    if (v22)
    {
      ...
      -[RFSummaryItemAlignedTextCardSection setText_4:](v5, "setText_4:", v25);
    ...
    if (v26)
    {
      ...
      -[RFSummaryItemAlignedTextCardSection setText_5:](v5, "setText_5:", v29);
    ...
    v44 = 0u;
    v45 = 0u;
    objc_msgSend(v4, "text_6s", 0);
    v32 = (void *)objc_claimAutoreleasedReturnValue();
    v33 = objc_msgSend(v32, "countByEnumeratingWithState:objects:count:", &v44, v53, 16);
    if (v33)
    {
      v34 = v33;
      v35 = *(_QWORD *)v45;
      do
      {
        for (j = 0; j != v34; ++j)
        {
          ...
          v37 = -[RFTextProperty initWithProtobuf:]([RFTextProperty alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v44 + 1) + 8 * j));
          if (v37)
            objc_msgSend(v31, "addObject:", v37);

        }
        v34 = objc_msgSend(v32, "countByEnumeratingWithState:objects:count:", &v44, v53, 16);
      }
      while (v34);
    }

    -[RFSummaryItemAlignedTextCardSection setText_6:](v5, "setText_6:", v31);
    ...
    if (v38)
    {
      ...
      -[RFSummaryItemAlignedTextCardSection setThumbnail:](v5, "setThumbnail:", v41);
...
- (RFSummaryItemAlignedTextCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCardSection text](v8, "text");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemAlignedTextCardSection setText_2:](v5, "setText_2:", v10);

    -[SFCardSection text](v8, "text");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemAlignedTextCardSection setText_3:](v5, "setText_3:", v11);

    -[SFCardSection text](v8, "text");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemAlignedTextCardSection setText_4:](v5, "setText_4:", v12);

    -[SFCardSection text](v8, "text");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemAlignedTextCardSection setText_5:](v5, "setText_5:", v13);

    -[SFCardSection text](v8, "text");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemAlignedTextCardSection setText_6:](v5, "setText_6:", v14);

    -[SFCardSection thumbnail](v8, "thumbnail");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemAlignedTextCardSection setThumbnail:](v5, "setThumbnail:", v15);
...
{
  _SFPBRFSummaryItemAlignedTextCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFSummaryItemAlignedTextCardSection initWithFacade:]([_SFPBRFSummaryItemAlignedTextCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSummaryItemAlignedTextCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFSummaryItemAlignedTextCardSection initWithFacade:]([_SFPBRFSummaryItemAlignedTextCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSummaryItemAlignedTextCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFSummaryItemAlignedTextCardSection text](self, "text");
  ...
  -[RFSummaryItemAlignedTextCardSection thumbnail](self, "thumbnail");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  RFSummaryItemAlignedTextCardSection *v5;
  RFSummaryItemAlignedTextCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (RFSummaryItemAlignedTextCardSection *)a3;
  if (self == v5)
  {
    v12 = 1;
  }
  ...
  {
    if (-[RFSummaryItemAlignedTextCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v73.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v73, sel_isEqual_, v5))
      {
        ...
        -[RFSummaryItemAlignedTextCardSection text](self, "text");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFSummaryItemAlignedTextCardSection text](v6, "text");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v7 == 0) == (v8 != 0))
        {
          v12 = 0;
...
LABEL_71:
                      ...
                      objc_msgSend(v37, "isEqual:")))
                {
                  -[RFSummaryItemAlignedTextCardSection thumbnail](self, "thumbnail");
                  v40 = (void *)objc_claimAutoreleasedReturnValue();
                  -[RFSummaryItemAlignedTextCardSection thumbnail](v6, "thumbnail");
