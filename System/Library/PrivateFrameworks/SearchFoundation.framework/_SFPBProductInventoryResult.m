...
{
  id v4;
  _SFPBProductInventoryResult *v5;
  void *v6;
  void *v7;
  void *v8;
  id v9;
  ...
  uint64_t v13;
  uint64_t i;
  _SFPBProductInventory *v15;
  _SFPBProductInventoryResult *v16;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v4 = a3;
  v5 = -[_SFPBProductInventoryResult init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBProductInventoryResult setProductIdentifier:](v5, "setProductIdentifier:", v7);

    }
    objc_msgSend(v4, "availability");
    ...
    v18 = 0u;
    v19 = 0u;
    objc_msgSend(v4, "availability", 0);
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0; i != v12; ++i)
        {
          ...
          v15 = -[_SFPBProductInventory initWithFacade:]([_SFPBProductInventory alloc], "initWithFacade:", *(_QWORD *)(*((_QWORD *)&v18 + 1) + 8 * i));
          if (v15)
    ...
    -[_SFPBProductInventoryResult setAvailabilitys:](v5, "setAvailabilitys:", v9);
    v16 = v5;
...
{
  -[NSArray removeAllObjects](self->_availabilitys, "removeAllObjects");
}
...
- (void)addAvailability:(id)a3
{
  ...
  -[NSArray addObject:](availabilitys, "addObject:", v4);

}

- (unint64_t)availabilityCount
{
  return -[NSArray count](self->_availabilitys, "count");
}

- (id)availabilityAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_availabilitys, "objectAtIndexedSubscript:", a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBProductInventoryResult productIdentifier](self, "productIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
    PBDataWriterWriteStringField();

  -[_SFPBProductInventoryResult availabilitys](self, "availabilitys");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = 0u;
  v12 = 0u;
  v13 = 0u;
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_availabilitys, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_availabilitys, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("availability"));
  }
...
- (NSData)jsonData
{
  ...
  -[_SFPBProductInventoryResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBProductInventoryResult)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBProductInventoryResult initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBProductInventoryResult)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBProductInventoryResult init](&v23, sel_init);
  if (v5)
  {
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[_SFPBProductInventory initWithDictionary:]([_SFPBProductInventory alloc], "initWithDictionary:", v14);
              -[_SFPBProductInventoryResult addAvailability:](v5, "addAvailability:", v15);
