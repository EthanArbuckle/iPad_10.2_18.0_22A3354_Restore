...
- (_SFPBProductAvailability)initWithFacade:(id)a3
{
  ...
  uint64_t v11;
  uint64_t i;
  _SFPBProductInventoryResult *v13;
  _SFPBProductAvailability *v14;
  __int128 v16;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  ...
  v4 = a3;
  v5 = -[_SFPBProductAvailability init](self, "init");
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[_SFPBProductInventoryResult initWithFacade:]([_SFPBProductInventoryResult alloc], "initWithFacade:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * i));
          if (v13)
    ...
    -[_SFPBProductAvailability setResults:](v5, "setResults:", v7);
    v14 = v5;
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBProductAvailability results](self, "results");
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_results, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_results, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("results"));
  }
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[_SFPBProductAvailability dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBProductAvailability)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBProductAvailability initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBProductAvailability)initWithDictionary:(id)a3
{
  ...
  uint64_t v12;
  _SFPBProductInventoryResult *v13;
  _SFPBProductInventoryResult *v14;
  _SFPBProductAvailability *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[_SFPBProductAvailability init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[_SFPBProductInventoryResult initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[_SFPBProductAvailability addResults:](v5, "addResults:", v14);
