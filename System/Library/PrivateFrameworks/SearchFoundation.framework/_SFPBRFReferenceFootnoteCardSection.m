...
{
  id v4;
  _SFPBRFReferenceFootnoteCardSection *v5;
  void *v6;
  ...
  _SFPBRFReferenceFootnoteCardSection *v22;

  v4 = a3;
  v5 = -[_SFPBRFReferenceFootnoteCardSection init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_1:](v5, "setText_1:", v9);
    ...
    if (v10)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_2:](v5, "setText_2:", v13);
    ...
    if (v14)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_3:](v5, "setText_3:", v17);
    ...
    if (v18)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_4:](v5, "setText_4:", v21);

    }
    if (objc_msgSend(v4, "hasAddTint"))
      -[_SFPBRFReferenceFootnoteCardSection setAddTint:](v5, "setAddTint:", objc_msgSend(v4, "addTint"));
    v22 = v5;
  }
...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[_SFPBRFReferenceFootnoteCardSection text](self, "text");
  ...
  if (-[_SFPBRFReferenceFootnoteCardSection addTint](self, "addTint"))
...
LABEL_25:
      ...
      v27 = addTint == objc_msgSend(v4, "addTint");
      goto LABEL_23;
    }
    v23 = (void *)v22;
    -[_SFPBRFReferenceFootnoteCardSection text](self, "text");
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_addTint)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBRFReferenceFootnoteCardSection addTint](self, "addTint"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFReferenceFootnoteCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFReferenceFootnoteCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFReferenceFootnoteCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFReferenceFootnoteCardSection)initWithDictionary:(id)a3
{
  ...
  _SFPBRFTextProperty *v13;
  void *v14;
  _SFPBRFReferenceFootnoteCardSection *v15;
  objc_super v17;

  v4 = a3;
  v17.receiver = self;
  v17.super_class = (Class)_SFPBRFReferenceFootnoteCardSection;
  v5 = -[_SFPBRFReferenceFootnoteCardSection init](&v17, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_1:](v5, "setText_1:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_2:](v5, "setText_2:", v9);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_3:](v5, "setText_3:", v11);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFReferenceFootnoteCardSection setText_4:](v5, "setText_4:", v13);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBRFReferenceFootnoteCardSection setAddTint:](v5, "setAddTint:", objc_msgSend(v14, "BOOLValue"));
    v15 = v5;
