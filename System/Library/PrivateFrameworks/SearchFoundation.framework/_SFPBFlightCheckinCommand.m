...
{
  id v4;
  _SFPBFlightCheckinCommand *v5;
  _SFPBFlightCheckinCommand *v6;

  v4 = a3;
  v5 = -[_SFPBFlightCheckinCommand init](self, "init");
  if (v5)
  {
    if (objc_msgSend(v4, "hasPlaceHolderProperty"))
      -[_SFPBFlightCheckinCommand setPlaceHolderProperty:](v5, "setPlaceHolderProperty:", objc_msgSend(v4, "placeHolderProperty"));
    v6 = v5;
  }
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (-[_SFPBFlightCheckinCommand placeHolderProperty](self, "placeHolderProperty"))
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_placeHolderProperty)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBFlightCheckinCommand placeHolderProperty](self, "placeHolderProperty"));
...
- (NSData)jsonData
{
  ...
  -[_SFPBFlightCheckinCommand dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBFlightCheckinCommand)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBFlightCheckinCommand initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBFlightCheckinCommand)initWithDictionary:(id)a3
{
  ...
  _SFPBFlightCheckinCommand *v5;
  void *v6;
  _SFPBFlightCheckinCommand *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)_SFPBFlightCheckinCommand;
  v5 = -[_SFPBFlightCheckinCommand init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBFlightCheckinCommand setPlaceHolderProperty:](v5, "setPlaceHolderProperty:", objc_msgSend(v6, "BOOLValue"));
    v7 = v5;
