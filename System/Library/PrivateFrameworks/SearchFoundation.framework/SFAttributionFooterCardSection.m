...
{
  id v4;
  SFAttributionFooterCardSection *v5;
  void *v6;
  id v7;
  void *v8;
  uint64_t v9;
  ...
  void *v38;
  SFPunchout *v39;
  SFAttributionFooterCardSection *v40;
  __int128 v42;
  __int128 v43;
  __int128 v44;
  __int128 v45;
  ...
  v4 = a3;
  v46.receiver = self;
  v46.super_class = (Class)SFAttributionFooterCardSection;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFAttributionFooterCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFAttributionFooterCardSection setLeadingAttribution:](v5, "setLeadingAttribution:", v27);
    ...
    if (v28)
    {
      ...
      v31 = -[SFPunchout initWithProtobuf:](v29, "initWithProtobuf:", v30);
      -[SFAttributionFooterCardSection setLeadingAttributionPunchout:](v5, "setLeadingAttributionPunchout:", v31);
    ...
    if (v32)
    {
      ...
      -[SFAttributionFooterCardSection setTrailingAttribution:](v5, "setTrailingAttribution:", v35);
    ...
    if (v36)
    {
      ...
      v39 = -[SFPunchout initWithProtobuf:](v37, "initWithProtobuf:", v38);
      -[SFAttributionFooterCardSection setTrailingAttributionPunchout:](v5, "setTrailingAttributionPunchout:", v39);
...
- (SFAttributionFooterCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFAttributionFooterCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection leadingAttribution](v8, "leadingAttribution");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFAttributionFooterCardSection setLeadingAttribution:](v5, "setLeadingAttribution:", v14);

    -[SFCardSection leadingAttributionPunchout](v8, "leadingAttributionPunchout");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFAttributionFooterCardSection setLeadingAttributionPunchout:](v5, "setLeadingAttributionPunchout:", v15);

    -[SFCardSection trailingAttribution](v8, "trailingAttribution");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFAttributionFooterCardSection setTrailingAttribution:](v5, "setTrailingAttribution:", v16);

    -[SFCardSection trailingAttributionPunchout](v8, "trailingAttributionPunchout");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFAttributionFooterCardSection setTrailingAttributionPunchout:](v5, "setTrailingAttributionPunchout:", v17);
...
{
  _SFPBAttributionFooterCardSection *v2;
  void *v3;

  v2 = -[_SFPBAttributionFooterCardSection initWithFacade:]([_SFPBAttributionFooterCardSection alloc], "initWithFacade:", self);
  -[_SFPBAttributionFooterCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBAttributionFooterCardSection initWithFacade:]([_SFPBAttributionFooterCardSection alloc], "initWithFacade:", self);
  -[_SFPBAttributionFooterCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v24.receiver = self;
  v24.super_class = (Class)SFAttributionFooterCardSection;
  ...
  -[SFAttributionFooterCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFAttributionFooterCardSection leadingAttribution](self, "leadingAttribution");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setLeadingAttribution:", v16);

  -[SFAttributionFooterCardSection leadingAttributionPunchout](self, "leadingAttributionPunchout");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setLeadingAttributionPunchout:", v18);

  -[SFAttributionFooterCardSection trailingAttribution](self, "trailingAttribution");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = (void *)objc_msgSend(v19, "copy");
  objc_msgSend(v4, "setTrailingAttribution:", v20);

  -[SFAttributionFooterCardSection trailingAttributionPunchout](self, "trailingAttributionPunchout");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v22 = (void *)objc_msgSend(v21, "copy");
  objc_msgSend(v4, "setTrailingAttributionPunchout:", v22);
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  SFAttributionFooterCardSection *v5;
  SFAttributionFooterCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (SFAttributionFooterCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFAttributionFooterCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v77.receiver = self;
      v77.super_class = (Class)SFAttributionFooterCardSection;
        ...
        if (v23 == -[SFCardSection canBeHidden](v6, "canBeHidden"))
        {
          ...
          if (v24 == -[SFCardSection hasTopPadding](v6, "hasTopPadding"))
          {
            ...
            if (v25 == -[SFCardSection hasBottomPadding](v6, "hasBottomPadding"))
            {
              -[SFAttributionFooterCardSection type](self, "type");
              v26 = (void *)objc_claimAutoreleasedReturnValue();
              -[SFAttributionFooterCardSection type](v6, "type");
              v27 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v26 == 0) != (v27 != 0))
              {
                v65 = v27;
...
LABEL_50:
                    ...
                    -[SFAttributionFooterCardSection leadingAttribution](v6, "leadingAttribution");
                    v33 = (void *)objc_claimAutoreleasedReturnValue();
                    v34 = v33;
                    if ((v58 == 0) == (v33 != 0))
                    {
                    ...
                    -[SFAttributionFooterCardSection leadingAttributionPunchout](v6, "leadingAttributionPunchout");
...
LABEL_37:
                    ...
                    -[SFAttributionFooterCardSection trailingAttribution](v6, "trailingAttribution");
                          ...
                          objc_msgSend(v37, "isEqual:")))
                    {
                      ...
                      -[SFAttributionFooterCardSection trailingAttributionPunchout](v6, "trailingAttributionPunchout");
...
- (unint64_t)hash
{
  ...
  v27.receiver = self;
  v27.super_class = (Class)SFAttributionFooterCardSection;
