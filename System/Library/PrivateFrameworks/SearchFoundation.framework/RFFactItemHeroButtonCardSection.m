...
{
  id v4;
  RFFactItemHeroButtonCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[RFFactItemHeroButtonCardSection setNumber:](v5, "setNumber:", v9);

    -[SFCardSection text](v8, "text");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemHeroButtonCardSection setText_1:](v5, "setText_1:", v10);

    -[SFCardSection button](v8, "button");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFFactItemHeroButtonCardSection setButton:](v5, "setButton:", v11);
...
{
  _SFPBRFFactItemHeroButtonCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFFactItemHeroButtonCardSection initWithFacade:]([_SFPBRFFactItemHeroButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFFactItemHeroButtonCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFFactItemHeroButtonCardSection initWithFacade:]([_SFPBRFFactItemHeroButtonCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFFactItemHeroButtonCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFFactItemHeroButtonCardSection number](self, "number");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setNumber:", v6);

  -[RFFactItemHeroButtonCardSection text](self, "text");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v7, "copy");
  objc_msgSend(v4, "setText_1:", v8);

  -[RFFactItemHeroButtonCardSection button](self, "button");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v9, "copy");
  objc_msgSend(v4, "setButton:", v10);
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  RFFactItemHeroButtonCardSection *v5;
  RFFactItemHeroButtonCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (RFFactItemHeroButtonCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[RFFactItemHeroButtonCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v32.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v32, sel_isEqual_, v5))
      {
        ...
        -[RFFactItemHeroButtonCardSection number](self, "number");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFFactItemHeroButtonCardSection number](v6, "number");
...
LABEL_31:
        ...
        -[RFFactItemHeroButtonCardSection text](self, "text");
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFFactItemHeroButtonCardSection text](v6, "text");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        v14 = v13;
        if ((v12 == 0) == (v13 != 0))
        {
        ...
        -[RFFactItemHeroButtonCardSection button](self, "button");
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFFactItemHeroButtonCardSection button](v6, "button");
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v17 == 0) == (v18 != 0))
        {
...
- (RFFactItemHeroButtonCardSection)initWithProtobuf:(id)a3
{
  ...
  void *v16;
  SFButtonItem *v17;
  RFFactItemHeroButtonCardSection *v18;
  objc_super v20;
  ...
  if (v5)
  {
    ...
    if (v10)
    {
      ...
      -[RFFactItemHeroButtonCardSection setText_1:](v5, "setText_1:", v13);
    ...
    if (v14)
    {
      ...
      -[RFFactItemHeroButtonCardSection setButton:](v5, "setButton:", v17);
