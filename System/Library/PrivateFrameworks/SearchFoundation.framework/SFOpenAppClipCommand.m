...
- (SFOpenAppClipCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFOpenAppClipCommand init](self, "init");
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFOpenAppClipCommand setClipIdentifier:](v5, "setClipIdentifier:", v9);
...
{
  _SFPBOpenAppClipCommand *v2;
  void *v3;

  v2 = -[_SFPBOpenAppClipCommand initWithFacade:]([_SFPBOpenAppClipCommand alloc], "initWithFacade:", self);
  -[_SFPBOpenAppClipCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBOpenAppClipCommand initWithFacade:]([_SFPBOpenAppClipCommand alloc], "initWithFacade:", self);
  -[_SFPBOpenAppClipCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFOpenAppClipCommand clipIdentifier](self, "clipIdentifier");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (-[SFOpenAppClipCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFOpenAppClipCommand clipIdentifier](self, "clipIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFOpenAppClipCommand clipIdentifier](v5, "clipIdentifier");
...
- (SFOpenAppClipCommand)initWithProtobuf:(id)a3
{
  ...
  void *v6;
  void *v7;
  SFOpenAppClipCommand *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SFOpenAppClipCommand;
  v5 = -[SFOpenAppClipCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      objc_msgSend(v4, "clipIdentifier");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFOpenAppClipCommand setClipIdentifier:](v5, "setClipIdentifier:", v7);
