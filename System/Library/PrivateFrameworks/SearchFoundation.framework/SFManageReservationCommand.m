...
{
  id v4;
  SFManageReservationCommand *v5;
  SFManageReservationCommand *v6;
  objc_super v8;

  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)SFManageReservationCommand;
  v5 = -[SFManageReservationCommand init](&v8, sel_init);
  if (v5)
  {
    if (objc_msgSend(v4, "placeHolderProperty"))
      -[SFManageReservationCommand setPlaceHolderProperty:](v5, "setPlaceHolderProperty:", objc_msgSend(v4, "placeHolderProperty"));
    v6 = v5;
  }
...
- (SFManageReservationCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFManageReservationCommand init](self, "init");
  ...
  {
    -[SFManageReservationCommand setPlaceHolderProperty:](v5, "setPlaceHolderProperty:", -[SFCommand placeHolderProperty](v8, "placeHolderProperty"));
...
{
  _SFPBManageReservationCommand *v2;
  void *v3;

  v2 = -[_SFPBManageReservationCommand initWithFacade:]([_SFPBManageReservationCommand alloc], "initWithFacade:", self);
  -[_SFPBManageReservationCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBManageReservationCommand initWithFacade:]([_SFPBManageReservationCommand alloc], "initWithFacade:", self);
  -[_SFPBManageReservationCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = (SFManageReservationCommand *)a3;
  if (self == v4)
  {
    v8 = 1;
  }
  else if (-[SFManageReservationCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v10.receiver = self,
             v10.super_class = (Class)SFManageReservationCommand,
             -[SFCommand isEqual:](&v10, sel_isEqual_, v4)))
  {
    v5 = v4;
    v6 = -[SFManageReservationCommand placeHolderProperty](self, "placeHolderProperty");
    v7 = -[SFManageReservationCommand placeHolderProperty](v5, "placeHolderProperty");
...
- (unint64_t)hash
{
  ...
  return v3 ^ -[SFManageReservationCommand placeHolderProperty](self, "placeHolderProperty");
}
