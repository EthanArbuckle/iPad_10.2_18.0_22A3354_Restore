...
{
  id v4;
  _SFPBRFSimpleItemRichCardSection *v5;
  void *v6;
  ...
  _SFPBRFSimpleItemRichCardSection *v50;
  __int128 v52;
  __int128 v53;
  __int128 v54;
  __int128 v55;
  ...
  v4 = a3;
  v5 = -[_SFPBRFSimpleItemRichCardSection init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_1:](v5, "setText_1:", v9);
    ...
    if (v10)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_2:](v5, "setText_2:", v13);
    ...
    -[_SFPBRFSimpleItemRichCardSection setText_3s:](v5, "setText_3s:", v15);
    objc_msgSend(v4, "text");
    ...
    if (v22)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_4:](v5, "setText_4:", v25);
    ...
    -[_SFPBRFSimpleItemRichCardSection setText_5s:](v5, "setText_5s:", v27);
    objc_msgSend(v4, "text");
    ...
    if (v34)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_6:](v5, "setText_6:", v37);
    ...
    if (v38)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_7:](v5, "setText_7:", v41);
    ...
    if (v42)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_8:](v5, "setText_8:", v45);
    ...
    if (v46)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setThumbnail:](v5, "setThumbnail:", v49);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBRFSimpleItemRichCardSection text](self, "text");
  ...
  -[_SFPBRFSimpleItemRichCardSection text_3s](self, "text_3s");
  ...
  -[_SFPBRFSimpleItemRichCardSection text_5s](self, "text_5s");
  ...
  -[_SFPBRFSimpleItemRichCardSection thumbnail](self, "thumbnail");
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFSimpleItemRichCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFSimpleItemRichCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFSimpleItemRichCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFSimpleItemRichCardSection)initWithDictionary:(id)a3
{
  ...
  _SFPBRFSimpleItemRichCardSection *v37;
  void *v39;
  void *v40;
  void *v41;
  void *v42;
  ...
  v5 = -[_SFPBRFSimpleItemRichCardSection init](&v51, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_1:](v5, "setText_1:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_2:](v5, "setText_2:", v9);
        ...
        do
        {
          for (i = 0; i != v14; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFSimpleItemRichCardSection addText_3:](v5, "addText_3:", v18);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_4:](v5, "setText_4:", v20);
        ...
        do
        {
          for (j = 0; j != v24; ++j)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFSimpleItemRichCardSection addText_5:](v5, "addText_5:", v28);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_6:](v5, "setText_6:", v30);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_7:](v5, "setText_7:", v32);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setText_8:](v5, "setText_8:", v34);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemRichCardSection setThumbnail:](v5, "setThumbnail:", v36);
