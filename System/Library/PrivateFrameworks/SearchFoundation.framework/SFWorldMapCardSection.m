...
- (SFWorldMapCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[SFPunchout initWithProtobuf:]([SFPunchout alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v32 + 1) + 8 * i));
          if (v13)
    ...
    if (v18)
    {
      ...
      -[SFWorldMapCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFWorldMapCardSection setPinLocation:](v5, "setPinLocation:", v27);

    }
    objc_msgSend(v4, "highlightedTimeZoneName");
    ...
    if (v28)
    {
      ...
      -[SFWorldMapCardSection setHighlightedTimeZoneName:](v5, "setHighlightedTimeZoneName:", v29);
...
- (SFWorldMapCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFWorldMapCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection pinLocation](v8, "pinLocation");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFWorldMapCardSection setPinLocation:](v5, "setPinLocation:", v14);

    -[SFCardSection highlightedTimeZoneName](v8, "highlightedTimeZoneName");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFWorldMapCardSection setHighlightedTimeZoneName:](v5, "setHighlightedTimeZoneName:", v15);
...
{
  _SFPBWorldMapCardSection *v2;
  void *v3;

  v2 = -[_SFPBWorldMapCardSection initWithFacade:]([_SFPBWorldMapCardSection alloc], "initWithFacade:", self);
  -[_SFPBWorldMapCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBWorldMapCardSection initWithFacade:]([_SFPBWorldMapCardSection alloc], "initWithFacade:", self);
  -[_SFPBWorldMapCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFWorldMapCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFWorldMapCardSection pinLocation](self, "pinLocation");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setPinLocation:", v16);

  -[SFWorldMapCardSection highlightedTimeZoneName](self, "highlightedTimeZoneName");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setHighlightedTimeZoneName:", v18);
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v73;
  void *v74;
  SFWorldMapCardSection *v75;
  void *v76;
  void *v77;
  objc_super v78;

  v5 = (SFWorldMapCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFWorldMapCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            -[SFWorldMapCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFWorldMapCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v63 = v32;
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                -[SFWorldMapCardSection pinLocation](v6, "pinLocation");
...
LABEL_65:
                      ...
                      objc_msgSend(v44, "isEqual:")))
                {
                  ...
                  -[SFWorldMapCardSection highlightedTimeZoneName](v6, "highlightedTimeZoneName");
...
{
  objc_storeStrong((id *)&self->_pinLocation, a3);
}
