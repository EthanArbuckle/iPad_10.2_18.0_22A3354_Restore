...
- (SFListenToCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFListenToCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection mediaMetadata](v8, "mediaMetadata");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFListenToCardSection setMediaMetadata:](v5, "setMediaMetadata:", v14);

    -[SFCardSection fallbackCardSection](v8, "fallbackCardSection");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFListenToCardSection setFallbackCardSection:](v5, "setFallbackCardSection:", v15);
...
{
  _SFPBListenToCardSection *v2;
  void *v3;

  v2 = -[_SFPBListenToCardSection initWithFacade:]([_SFPBListenToCardSection alloc], "initWithFacade:", self);
  -[_SFPBListenToCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBListenToCardSection initWithFacade:]([_SFPBListenToCardSection alloc], "initWithFacade:", self);
  -[_SFPBListenToCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFListenToCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFListenToCardSection mediaMetadata](self, "mediaMetadata");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setMediaMetadata:", v16);

  -[SFListenToCardSection fallbackCardSection](self, "fallbackCardSection");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setFallbackCardSection:", v18);
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v73;
  void *v74;
  SFListenToCardSection *v75;
  void *v76;
  void *v77;
  objc_super v78;

  v5 = (SFListenToCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFListenToCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            -[SFListenToCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFListenToCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v63 = v32;
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                -[SFListenToCardSection mediaMetadata](v6, "mediaMetadata");
...
LABEL_65:
                      ...
                      objc_msgSend(v44, "isEqual:")))
                {
                  ...
                  -[SFListenToCardSection fallbackCardSection](v6, "fallbackCardSection");
...
- (SFListenToCardSection)initWithProtobuf:(id)a3
{
  ...
  v5 = -[SFCardSection init](&v38, sel_init);
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[SFPunchout initWithProtobuf:]([SFPunchout alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v34 + 1) + 8 * i));
          if (v13)
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFListenToCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      objc_msgSend(v4, "mediaMetadata");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      v27 = -[SFMediaMetadata initWithProtobuf:](v25, "initWithProtobuf:", v26);
      -[SFListenToCardSection setMediaMetadata:](v5, "setMediaMetadata:", v27);
    ...
    if (v28)
    {
      v29 = [SFCardSection alloc];
      objc_msgSend(v4, "fallbackCardSection");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      v31 = -[SFCardSection initWithProtobuf:](v29, "initWithProtobuf:", v30);
      -[SFListenToCardSection setFallbackCardSection:](v5, "setFallbackCardSection:", v31);
