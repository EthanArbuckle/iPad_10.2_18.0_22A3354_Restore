...
- (SFShareCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFShareCommand init](self, "init");
  ...
  {
    -[SFCommand shareItem](v8, "shareItem");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFShareCommand setShareItem:](v5, "setShareItem:", v9);
...
{
  _SFPBShareCommand *v2;
  void *v3;

  v2 = -[_SFPBShareCommand initWithFacade:]([_SFPBShareCommand alloc], "initWithFacade:", self);
  -[_SFPBShareCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBShareCommand initWithFacade:]([_SFPBShareCommand alloc], "initWithFacade:", self);
  -[_SFPBShareCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFShareCommand shareItem](self, "shareItem");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setShareItem:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (-[SFShareCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFShareCommand shareItem](self, "shareItem");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFShareCommand shareItem](v5, "shareItem");
...
- (SFShareCommand)initWithProtobuf:(id)a3
{
  ...
  v5 = -[SFShareCommand init](&v12, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      objc_msgSend(v4, "shareItem");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      v9 = -[SFShareItem initWithProtobuf:](v7, "initWithProtobuf:", v8);
      -[SFShareCommand setShareItem:](v5, "setShareItem:", v9);
