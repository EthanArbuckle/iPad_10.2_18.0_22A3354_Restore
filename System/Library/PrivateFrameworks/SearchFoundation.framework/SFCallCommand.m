...
- (SFCallCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFCallCommand init](self, "init");
  ...
  {
    -[SFCommand phoneNumber](v8, "phoneNumber");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCallCommand setPhoneNumber:](v5, "setPhoneNumber:", v9);
...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v2 = -[_SFPBCallCommand initWithFacade:]([_SFPBCallCommand alloc], "initWithFacade:", self);
  -[_SFPBCallCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBCallCommand initWithFacade:]([_SFPBCallCommand alloc], "initWithFacade:", self);
  -[_SFPBCallCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFCallCommand phoneNumber](self, "phoneNumber");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");
  objc_msgSend(v4, "setPhoneNumber:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (-[SFCallCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFCallCommand phoneNumber](self, "phoneNumber");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCallCommand phoneNumber](v5, "phoneNumber");
...
- (SFCallCommand)initWithProtobuf:(id)a3
{
  ...
  v5 = -[SFCallCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      objc_msgSend(v4, "phoneNumber");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFCallCommand setPhoneNumber:](v5, "setPhoneNumber:", v7);
