...
- (_SFPBRFImageElement)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBRFImageElement init](self, "init");
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[_SFPBRFImageSource initWithFacade:]([_SFPBRFImageSource alloc], "initWithFacade:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * i));
          if (v13)
    ...
    -[_SFPBRFImageElement setSources:](v5, "setSources:", v7);
    v14 = v5;
...
- (void)addSources:(id)a3
{
  ...
  -[NSArray addObject:](sources, "addObject:", v4);
...
{
  return -[NSArray objectAtIndexedSubscript:](self->_sources, "objectAtIndexedSubscript:", a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBRFImageElement sources](self, "sources");
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_sources, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFImageElement dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFImageElement)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFImageElement initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFImageElement)initWithDictionary:(id)a3
{
  ...
  uint64_t v12;
  _SFPBRFImageSource *v13;
  _SFPBRFImageSource *v14;
  _SFPBRFImageElement *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[_SFPBRFImageElement init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[_SFPBRFImageSource initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[_SFPBRFImageElement addSources:](v5, "addSources:", v14);
