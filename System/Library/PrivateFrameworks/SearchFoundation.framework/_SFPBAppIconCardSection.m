...
- (_SFPBAppIconCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBAppIconCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBAppIconCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBAppIconCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBAppIconCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBAppIconCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBAppIconCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBAppIconCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBAppIconCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBAppIconCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBAppIconCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v24)
    {
      ...
      -[_SFPBAppIconCardSection setTitle:](v5, "setTitle:", v25);
    ...
    if (v26)
    {
      ...
      -[_SFPBAppIconCardSection setApplicationBundleIdentifier:](v5, "setApplicationBundleIdentifier:", v27);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBAppIconCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBAppIconCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBAppIconCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBAppIconCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBAppIconCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBAppIconCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBAppIconCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBAppIconCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBAppIconCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBAppIconCardSection title](self, "title");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
    PBDataWriterWriteStringField();

  -[_SFPBAppIconCardSection applicationBundleIdentifier](self, "applicationBundleIdentifier");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v15)
    PBDataWriterWriteStringField();
...
- (unint64_t)hash
{
  ...
  return v9 ^ v11 ^ -[NSString hash](self->_applicationBundleIdentifier, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBAppIconCardSection canBeHidden](self, "canBeHidden"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBAppIconCardSection hasBottomPadding](self, "hasBottomPadding"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBAppIconCardSection hasTopPadding](self, "hasTopPadding"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[NSArray count](self->_punchoutOptions, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("punchoutOptions"));
  }
  if (self->_punchoutPickerDismissText)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v21, CFSTR("punchoutPickerDismissText"));
  ...
  if (self->_punchoutPickerTitle)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v23, CFSTR("punchoutPickerTitle"));

  }
  if (self->_separatorStyle)
  {
    v24 = -[_SFPBAppIconCardSection separatorStyle](self, "separatorStyle");
    if (v24 >= 6)
    {
...
- (NSData)jsonData
{
  ...
  -[_SFPBAppIconCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBAppIconCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBAppIconCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBAppIconCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBAppIconCardSection init](&v40, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBAppIconCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v13);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBAppIconCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v18, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBAppIconCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBAppIconCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v20, "BOOLValue"));
    v35 = v6;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBAppIconCardSection setType:](v5, "setType:", v22);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBAppIconCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v23, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBAppIconCardSection setBackgroundColor:](v5, "setBackgroundColor:", v25);
    ...
    {
      v27 = (void *)objc_msgSend(v26, "copy");
      -[_SFPBAppIconCardSection setTitle:](v5, "setTitle:", v27);
    ...
    {
      v29 = (void *)objc_msgSend(v28, "copy");
      -[_SFPBAppIconCardSection setApplicationBundleIdentifier:](v5, "setApplicationBundleIdentifier:", v29);
