...
{
  id v4;
  SFPersonHeaderCardSection *v5;
  void *v6;
  SFPerson *v7;
  void *v8;
  SFPerson *v9;
  SFPersonHeaderCardSection *v10;
  objc_super v12;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[SFPersonHeaderCardSection setPerson:](v5, "setPerson:", v9);
...
{
  _SFPBPersonHeaderCardSection *v2;
  void *v3;

  v2 = -[_SFPBPersonHeaderCardSection initWithFacade:]([_SFPBPersonHeaderCardSection alloc], "initWithFacade:", self);
  -[_SFPBPersonHeaderCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBPersonHeaderCardSection initWithFacade:]([_SFPBPersonHeaderCardSection alloc], "initWithFacade:", self);
  -[_SFPBPersonHeaderCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFPersonHeaderCardSection person](self, "person");
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = (SFPersonHeaderCardSection *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  else if (-[SFPersonHeaderCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCardSection isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFPersonHeaderCardSection person](self, "person");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFPersonHeaderCardSection person](v5, "person");
