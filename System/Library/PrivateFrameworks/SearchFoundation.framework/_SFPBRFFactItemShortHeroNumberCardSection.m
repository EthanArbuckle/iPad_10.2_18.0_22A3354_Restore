...
{
  id v4;
  _SFPBRFFactItemShortHeroNumberCardSection *v5;
  void *v6;
  ...
  _SFPBRFFactItemShortHeroNumberCardSection *v42;
  __int128 v44;
  __int128 v45;
  __int128 v46;
  __int128 v47;
  ...
  v4 = a3;
  v5 = -[_SFPBRFFactItemShortHeroNumberCardSection init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setNumber:](v5, "setNumber:", v9);
    ...
    if (v10)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setText_1:](v5, "setText_1:", v13);
    ...
    -[_SFPBRFFactItemShortHeroNumberCardSection setText_2s:](v5, "setText_2s:", v15);
    objc_msgSend(v4, "text");
    ...
    -[_SFPBRFFactItemShortHeroNumberCardSection setText_3s:](v5, "setText_3s:", v23);
    ...
    if (v30)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setUnit:](v5, "setUnit:", v33);
    ...
    if (v34)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setText_4:](v5, "setText_4:", v37);
    ...
    if (v38)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setThumbnail:](v5, "setThumbnail:", v41);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBRFFactItemShortHeroNumberCardSection number](self, "number");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
    PBDataWriterWriteSubmessage();

  -[_SFPBRFFactItemShortHeroNumberCardSection text](self, "text");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
    PBDataWriterWriteSubmessage();

  -[_SFPBRFFactItemShortHeroNumberCardSection text_2s](self, "text_2s");
  ...
  -[_SFPBRFFactItemShortHeroNumberCardSection text_3s](self, "text_3s");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = 0u;
  v21 = 0u;
  v22 = 0u;
  ...
  -[_SFPBRFFactItemShortHeroNumberCardSection unit](self, "unit");
  ...
  -[_SFPBRFFactItemShortHeroNumberCardSection thumbnail](self, "thumbnail");
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFFactItemShortHeroNumberCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFFactItemShortHeroNumberCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFFactItemShortHeroNumberCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFFactItemShortHeroNumberCardSection)initWithDictionary:(id)a3
{
  ...
  _SFPBRFFactItemShortHeroNumberCardSection *v32;
  void *v34;
  void *v35;
  void *v36;
  __int128 v37;
  ...
  v5 = -[_SFPBRFFactItemShortHeroNumberCardSection init](&v45, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setNumber:](v5, "setNumber:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setText_1:](v5, "setText_1:", v9);
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFFactItemShortHeroNumberCardSection addText_2:](v5, "addText_2:", v17);
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFFactItemShortHeroNumberCardSection addText_3:](v5, "addText_3:", v25);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setUnit:](v5, "setUnit:", v27);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setText_4:](v5, "setText_4:", v29);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFFactItemShortHeroNumberCardSection setThumbnail:](v5, "setThumbnail:", v31);
