...
- (SFCombinedCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCombinedCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCombinedCardSection setCardSections:](v5, "setCardSections:", v14);
...
{
  _SFPBCombinedCardSection *v2;
  void *v3;

  v2 = -[_SFPBCombinedCardSection initWithFacade:]([_SFPBCombinedCardSection alloc], "initWithFacade:", self);
  -[_SFPBCombinedCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBCombinedCardSection initWithFacade:]([_SFPBCombinedCardSection alloc], "initWithFacade:", self);
  -[_SFPBCombinedCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFCombinedCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFCombinedCardSection cardSections](self, "cardSections");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFCombinedCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            -[SFCombinedCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFCombinedCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFCombinedCardSection cardSections](v6, "cardSections");
...
- (SFCombinedCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFCombinedCardSection setType:](v5, "setType:", v19);
    ...
    -[SFCombinedCardSection setCardSections:](v5, "setCardSections:", v25);
    v32 = v5;
