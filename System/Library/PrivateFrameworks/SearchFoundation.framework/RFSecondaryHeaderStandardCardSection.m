...
{
  id v4;
  RFSecondaryHeaderStandardCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[RFSecondaryHeaderStandardCardSection setText_1:](v5, "setText_1:", v9);
...
{
  _SFPBRFSecondaryHeaderStandardCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFSecondaryHeaderStandardCardSection initWithFacade:]([_SFPBRFSecondaryHeaderStandardCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSecondaryHeaderStandardCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFSecondaryHeaderStandardCardSection initWithFacade:]([_SFPBRFSecondaryHeaderStandardCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSecondaryHeaderStandardCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFSecondaryHeaderStandardCardSection text](self, "text");
...
- (BOOL)isEqual:(id)a3
{
  RFSecondaryHeaderStandardCardSection *v4;
  RFSecondaryHeaderStandardCardSection *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  else if (-[RFSecondaryHeaderStandardCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())&& (v13.receiver = self, v13.super_class = (Class)RFSecondaryHeaderStandardCardSection, -[SFCardSection isEqual:](&v13, sel_isEqual_, v4)))
  {
    v5 = v4;
    -[RFSecondaryHeaderStandardCardSection text](self, "text");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSecondaryHeaderStandardCardSection text](v5, "text");
...
- (RFSecondaryHeaderStandardCardSection)initWithProtobuf:(id)a3
{
  ...
  void *v8;
  RFTextProperty *v9;
  RFSecondaryHeaderStandardCardSection *v10;
  objc_super v12;
