...
{
  id v4;
  RFSecondaryHeaderEmphasizedCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[RFSecondaryHeaderEmphasizedCardSection setText_1:](v5, "setText_1:", v9);
...
{
  _SFPBRFSecondaryHeaderEmphasizedCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFSecondaryHeaderEmphasizedCardSection initWithFacade:]([_SFPBRFSecondaryHeaderEmphasizedCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSecondaryHeaderEmphasizedCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFSecondaryHeaderEmphasizedCardSection initWithFacade:]([_SFPBRFSecondaryHeaderEmphasizedCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSecondaryHeaderEmphasizedCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFSecondaryHeaderEmphasizedCardSection text](self, "text");
...
- (BOOL)isEqual:(id)a3
{
  RFSecondaryHeaderEmphasizedCardSection *v4;
  RFSecondaryHeaderEmphasizedCardSection *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  else if (-[RFSecondaryHeaderEmphasizedCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())&& (v13.receiver = self, v13.super_class = (Class)RFSecondaryHeaderEmphasizedCardSection, -[SFCardSection isEqual:](&v13, sel_isEqual_, v4)))
  {
    v5 = v4;
    -[RFSecondaryHeaderEmphasizedCardSection text](self, "text");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSecondaryHeaderEmphasizedCardSection text](v5, "text");
...
- (RFSecondaryHeaderEmphasizedCardSection)initWithProtobuf:(id)a3
{
  ...
  void *v8;
  RFTextProperty *v9;
  RFSecondaryHeaderEmphasizedCardSection *v10;
  objc_super v12;
