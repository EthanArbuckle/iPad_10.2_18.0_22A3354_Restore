...
{
  id v4;
  RFSummaryItemTextCardSection *v5;
  void *v6;
  RFTextProperty *v7;
  void *v8;
  RFTextProperty *v9;
  ...
  void *v28;
  RFTextProperty *v29;
  RFSummaryItemTextCardSection *v30;
  __int128 v32;
  __int128 v33;
  __int128 v34;
  __int128 v35;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[RFSummaryItemTextCardSection setText_2:](v5, "setText_2:", v9);
    ...
    if (v10)
    {
      ...
      -[RFSummaryItemTextCardSection setText_1:](v5, "setText_1:", v13);
    ...
    -[RFSummaryItemTextCardSection setText_3:](v5, "setText_3:", v15);
    objc_msgSend(v4, "text");
    ...
    if (v22)
    {
      ...
      -[RFSummaryItemTextCardSection setText_4:](v5, "setText_4:", v25);
    ...
    if (v26)
    {
      ...
      -[RFSummaryItemTextCardSection setText_5:](v5, "setText_5:", v29);
...
- (RFSummaryItemTextCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCardSection text](v8, "text");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemTextCardSection setText_1:](v5, "setText_1:", v10);

    -[SFCardSection text](v8, "text");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemTextCardSection setText_3:](v5, "setText_3:", v11);

    -[SFCardSection text](v8, "text");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemTextCardSection setText_4:](v5, "setText_4:", v12);

    -[SFCardSection text](v8, "text");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFSummaryItemTextCardSection setText_5:](v5, "setText_5:", v13);
...
{
  _SFPBRFSummaryItemTextCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFSummaryItemTextCardSection initWithFacade:]([_SFPBRFSummaryItemTextCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSummaryItemTextCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFSummaryItemTextCardSection initWithFacade:]([_SFPBRFSummaryItemTextCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFSummaryItemTextCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFSummaryItemTextCardSection text](self, "text");
...
- (BOOL)isEqual:(id)a3
{
  RFSummaryItemTextCardSection *v4;
  RFSummaryItemTextCardSection *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  v4 = (RFSummaryItemTextCardSection *)a3;
  if (self == v4)
  {
    v10 = 1;
  }
  ...
  {
    if (-[RFSummaryItemTextCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v50.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v50, sel_isEqual_, v4))
      {
        ...
        -[RFSummaryItemTextCardSection text](self, "text");
        v6 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFSummaryItemTextCardSection text](v5, "text");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v6 == 0) == (v7 != 0))
        {
          v10 = 0;
