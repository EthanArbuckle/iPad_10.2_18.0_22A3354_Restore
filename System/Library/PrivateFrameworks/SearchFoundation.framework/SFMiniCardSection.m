...
- (SFMiniCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFMiniCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFMiniCardSection setTitle:](v5, "setTitle:", v27);
    ...
    if (v28)
    {
      ...
      -[SFMiniCardSection setSubtitle:](v5, "setSubtitle:", v31);
    ...
    if (v32)
    {
      ...
      -[SFMiniCardSection setImage:](v5, "setImage:", v35);
...
- (SFMiniCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFMiniCardSection setType:](v5, "setType:", v12);
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFMiniCardSection setTitle:](v5, "setTitle:", v14);

    -[SFCardSection subtitle](v8, "subtitle");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFMiniCardSection setSubtitle:](v5, "setSubtitle:", v15);

    -[SFCardSection image](v8, "image");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFMiniCardSection setImage:](v5, "setImage:", v16);
...
{
  _SFPBMiniCardSection *v2;
  void *v3;

  v2 = -[_SFPBMiniCardSection initWithFacade:]([_SFPBMiniCardSection alloc], "initWithFacade:", self);
  -[_SFPBMiniCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBMiniCardSection initWithFacade:]([_SFPBMiniCardSection alloc], "initWithFacade:", self);
  -[_SFPBMiniCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFMiniCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFMiniCardSection title](self, "title");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setTitle:", v16);

  -[SFMiniCardSection subtitle](self, "subtitle");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setSubtitle:", v18);

  -[SFMiniCardSection image](self, "image");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFMiniCardSection isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class()))
    {
      v67.receiver = self;
        ...
        if (v22 == -[SFCardSection canBeHidden](v5, "canBeHidden"))
        {
          ...
          if (v23 == -[SFCardSection hasTopPadding](v5, "hasTopPadding"))
          {
            ...
            if (v24 == -[SFCardSection hasBottomPadding](v5, "hasBottomPadding"))
            {
              -[SFMiniCardSection type](self, "type");
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              -[SFMiniCardSection type](v5, "type");
              v26 = (void *)objc_claimAutoreleasedReturnValue();
              if ((v25 == 0) != (v26 != 0))
              {
                v55 = v26;
                ...
                if (v27 == -[SFCardSection separatorStyle](v5, "separatorStyle"))
                {
                  ...
                  if ((v52 == 0) != (v28 != 0))
                  {
                    ...
                    -[SFMiniCardSection title](v5, "title");
...
LABEL_24:
                    ...
                    -[SFMiniCardSection subtitle](v5, "subtitle");
                          ...
                          objc_msgSend(v32, "isEqual:")))
                    {
                      ...
                      -[SFMiniCardSection image](v5, "image");
                      v36 = (void *)objc_claimAutoreleasedReturnValue();
                      if ((v37 == 0) == (v36 != 0))
                      {
