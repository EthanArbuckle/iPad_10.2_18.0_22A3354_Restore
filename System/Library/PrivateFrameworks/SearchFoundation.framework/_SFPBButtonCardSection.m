...
- (_SFPBButtonCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBButtonCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBButtonCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBButtonCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBButtonCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBButtonCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBButtonCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBButtonCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBButtonCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBButtonCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBButtonCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v24)
    {
      ...
      -[_SFPBButtonCardSection setTitle:](v5, "setTitle:", v27);
    ...
    if (v28)
    {
      ...
      -[_SFPBButtonCardSection setThumbnail:](v5, "setThumbnail:", v31);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBButtonCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBButtonCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBButtonCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBButtonCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBButtonCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBButtonCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBButtonCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBButtonCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBButtonCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBButtonCardSection title](self, "title");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
    PBDataWriterWriteSubmessage();

  -[_SFPBButtonCardSection thumbnail](self, "thumbnail");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v15)
    PBDataWriterWriteSubmessage();
...
- (unint64_t)hash
{
  ...
  return v9 ^ v11 ^ -[_SFPBImage hash](self->_thumbnail, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBButtonCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBButtonCardSection hasBottomPadding](self, "hasBottomPadding"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBButtonCardSection hasTopPadding](self, "hasTopPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[NSArray count](self->_punchoutOptions, "count"))
  {
    ...
    if (v12)
    {
      ...
      do
      {
        ...
        v13 = -[NSArray countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v33, v37, 16);
      }
      while (v13);
    }
  ...
  {
    v22 = -[_SFPBButtonCardSection separatorStyle](self, "separatorStyle");
    if (v22 >= 6)
    {
  ...
  if (self->_thumbnail)
  {
    ...
    if (v25)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v25, CFSTR("thumbnail"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v26, CFSTR("thumbnail"));
...
- (NSData)jsonData
{
  ...
  -[_SFPBButtonCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBButtonCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBButtonCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBButtonCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBButtonCardSection init](&v40, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBButtonCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v13);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBButtonCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v18, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBButtonCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBButtonCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v20, "BOOLValue"));
    v35 = v6;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBButtonCardSection setType:](v5, "setType:", v22);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBButtonCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v23, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBButtonCardSection setBackgroundColor:](v5, "setBackgroundColor:", v25);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBButtonCardSection setThumbnail:](v5, "setThumbnail:", v29);
