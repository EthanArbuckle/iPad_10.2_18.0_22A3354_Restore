...
- (_SFPBInfoCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBInfoCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBInfoCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBInfoCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBInfoCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBInfoCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBInfoCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBInfoCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBInfoCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBInfoCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBInfoCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);

    }
    objc_msgSend(v4, "infoTuples");
    ...
    if (v27)
    {
      ...
      do
      {
        for (j = 0; j != v28; ++j)
        {
          ...
          v31 = -[_SFPBInfoTuple initWithFacade:]([_SFPBInfoTuple alloc], "initWithFacade:", *(_QWORD *)(*((_QWORD *)&v34 + 1) + 8 * j));
          if (v31)
    ...
    -[_SFPBInfoCardSection setInfoTuples:](v5, "setInfoTuples:", v25);
    if (objc_msgSend(v4, "hasInitiallyVisibleTuples"))
      -[_SFPBInfoCardSection setInitiallyVisibleTuples:](v5, "setInitiallyVisibleTuples:", objc_msgSend(v4, "initiallyVisibleTuples"));
    v32 = v5;
...
{
  -[NSArray removeAllObjects](self->_infoTuples, "removeAllObjects");
}
...
- (void)addInfoTuples:(id)a3
{
  ...
  -[NSArray addObject:](infoTuples, "addObject:", v4);

}

- (unint64_t)infoTuplesCount
{
  return -[NSArray count](self->_infoTuples, "count");
}

- (id)infoTuplesAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_infoTuples, "objectAtIndexedSubscript:", a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBInfoCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBInfoCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBInfoCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBInfoCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBInfoCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBInfoCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBInfoCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBInfoCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBInfoCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBInfoCardSection infoTuples](self, "infoTuples");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = 0u;
  v20 = 0u;
  v21 = 0u;
  ...
  if (-[_SFPBInfoCardSection initiallyVisibleTuples](self, "initiallyVisibleTuples"))
...
LABEL_39:
    initiallyVisibleTuples = self->_initiallyVisibleTuples;
    v41 = initiallyVisibleTuples == objc_msgSend(v4, "initiallyVisibleTuples");
    goto LABEL_37;
  }
  v37 = (void *)v36;
  -[_SFPBInfoCardSection infoTuples](self, "infoTuples");
...
- (unint64_t)hash
{
  ...
  return v3 ^ v12 ^ v4 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10 ^ -[NSArray hash](self->_infoTuples, "hash") ^ (2654435761u * self->_initiallyVisibleTuples);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBInfoCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBInfoCardSection hasBottomPadding](self, "hasBottomPadding"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBInfoCardSection hasTopPadding](self, "hasTopPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("hasTopPadding"));

  }
  if (-[NSArray count](self->_infoTuples, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v40 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("infoTuples"));
  }
  if (self->_initiallyVisibleTuples)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[_SFPBInfoCardSection initiallyVisibleTuples](self, "initiallyVisibleTuples"));
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v18, CFSTR("initiallyVisibleTuples"));
  ...
  {
    v31 = -[_SFPBInfoCardSection separatorStyle](self, "separatorStyle");
    if (v31 >= 6)
    {
...
- (NSData)jsonData
{
  ...
  -[_SFPBInfoCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBInfoCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBInfoCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBInfoCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBInfoCardSection init](&v55, sel_init);
  if (v5)
  {
        ...
        do
        {
          for (i = 0; i != v10; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBInfoCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v14);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBInfoCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v16);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBInfoCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v18);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBInfoCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBInfoCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v20, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    v46 = v21;
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBInfoCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v21, "BOOLValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBInfoCardSection setType:](v5, "setType:", v24);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBInfoCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v25, "intValue"));
    v43 = v25;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBInfoCardSection setBackgroundColor:](v5, "setBackgroundColor:", v27);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("infoTuples"));
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v30)
      {
        ...
        do
        {
          for (j = 0; j != v31; ++j)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v35 = -[_SFPBInfoTuple initWithDictionary:]([_SFPBInfoTuple alloc], "initWithDictionary:", v34);
              -[_SFPBInfoCardSection addInfoTuples:](v5, "addInfoTuples:", v35);
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("initiallyVisibleTuples"));
    v36 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBInfoCardSection setInitiallyVisibleTuples:](v5, "setInitiallyVisibleTuples:", objc_msgSend(v36, "unsignedLongLongValue"));
    v37 = v5;
