...
- (SFProductCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFProductCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFProductCardSection setProductJSON:](v5, "setProductJSON:", v25);
...
- (SFProductCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFProductCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection productJSON](v8, "productJSON");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFProductCardSection setProductJSON:](v5, "setProductJSON:", v14);
...
{
  _SFPBProductCardSection *v2;
  void *v3;

  v2 = -[_SFPBProductCardSection initWithFacade:]([_SFPBProductCardSection alloc], "initWithFacade:", self);
  -[_SFPBProductCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBProductCardSection initWithFacade:]([_SFPBProductCardSection alloc], "initWithFacade:", self);
  -[_SFPBProductCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFProductCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFProductCardSection productJSON](self, "productJSON");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setProductJSON:", v16);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (-[SFProductCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            -[SFProductCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFProductCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFProductCardSection productJSON](v6, "productJSON");
