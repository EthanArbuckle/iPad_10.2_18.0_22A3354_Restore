...
{
  id v4;
  _SFPBRFSimpleItemReverseRichCardSection *v5;
  void *v6;
  ...
  _SFPBRFSimpleItemReverseRichCardSection *v30;
  __int128 v32;
  __int128 v33;
  __int128 v34;
  __int128 v35;
  ...
  v4 = a3;
  v5 = -[_SFPBRFSimpleItemReverseRichCardSection init](self, "init");
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[_SFPBRFSimpleItemReverseRichCardSection setText_1:](v5, "setText_1:", v9);
    ...
    if (v10)
    {
      ...
      -[_SFPBRFSimpleItemReverseRichCardSection setText_2:](v5, "setText_2:", v13);
    ...
    -[_SFPBRFSimpleItemReverseRichCardSection setText_3s:](v5, "setText_3s:", v15);
    objc_msgSend(v4, "text");
    ...
    if (v22)
    {
      ...
      -[_SFPBRFSimpleItemReverseRichCardSection setText_4:](v5, "setText_4:", v25);
    ...
    if (v26)
    {
      ...
      v29 = -[_SFPBRFVisualProperty initWithFacade:](v27, "initWithFacade:", v28);
      -[_SFPBRFSimpleItemReverseRichCardSection setThumbnail:](v5, "setThumbnail:", v29);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBRFSimpleItemReverseRichCardSection text](self, "text");
  ...
  -[_SFPBRFSimpleItemReverseRichCardSection text_3s](self, "text_3s");
  ...
  -[_SFPBRFSimpleItemReverseRichCardSection thumbnail](self, "thumbnail");
...
- (unint64_t)hash
{
  ...
  return v6 ^ -[_SFPBRFVisualProperty hash](self->_thumbnail, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_text_3s, "count"))
  {
    ...
    v28 = 0u;
    v11 = self->_text_3s;
    v12 = -[NSArray countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v25, v29, 16);
    if (v12)
    {
      v13 = v12;
      v14 = *(_QWORD *)v26;
      do
      {
        ...
        v13 = -[NSArray countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v25, v29, 16);
      }
      while (v13);
    }
  ...
  if (self->_thumbnail)
  {
    ...
    if (v22)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v22, CFSTR("thumbnail"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
...
- (NSData)jsonData
{
  ...
  -[_SFPBRFSimpleItemReverseRichCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBRFSimpleItemReverseRichCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBRFSimpleItemReverseRichCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBRFSimpleItemReverseRichCardSection)initWithDictionary:(id)a3
{
  ...
  _SFPBRFSimpleItemReverseRichCardSection *v22;
  void *v24;
  void *v25;
  __int128 v26;
  __int128 v27;
  ...
  v5 = -[_SFPBRFSimpleItemReverseRichCardSection init](&v30, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemReverseRichCardSection setText_1:](v5, "setText_1:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemReverseRichCardSection setText_2:](v5, "setText_2:", v9);
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBRFSimpleItemReverseRichCardSection addText_3:](v5, "addText_3:", v17);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBRFSimpleItemReverseRichCardSection setText_4:](v5, "setText_4:", v19);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v21 = -[_SFPBRFVisualProperty initWithDictionary:]([_SFPBRFVisualProperty alloc], "initWithDictionary:", v20);
      -[_SFPBRFSimpleItemReverseRichCardSection setThumbnail:](v5, "setThumbnail:", v21);
