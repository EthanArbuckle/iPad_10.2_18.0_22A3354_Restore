...
- (SFStockChartCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFStockChartCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection thirdPartyContentURL](v8, "thirdPartyContentURL");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFStockChartCardSection setThirdPartyContentURL:](v5, "setThirdPartyContentURL:", v14);

    -[SFCardSection chartData](v8, "chartData");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFStockChartCardSection setChartData:](v5, "setChartData:", v15);
...
{
  _SFPBStockChartCardSection *v2;
  void *v3;

  v2 = -[_SFPBStockChartCardSection initWithFacade:]([_SFPBStockChartCardSection alloc], "initWithFacade:", self);
  -[_SFPBStockChartCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBStockChartCardSection initWithFacade:]([_SFPBStockChartCardSection alloc], "initWithFacade:", self);
  -[_SFPBStockChartCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFStockChartCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFStockChartCardSection thirdPartyContentURL](self, "thirdPartyContentURL");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setThirdPartyContentURL:", v16);

  -[SFStockChartCardSection chartData](self, "chartData");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setChartData:", v18);
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v73;
  void *v74;
  SFStockChartCardSection *v75;
  void *v76;
  void *v77;
  objc_super v78;

  v5 = (SFStockChartCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFStockChartCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            -[SFStockChartCardSection type](self, "type");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFStockChartCardSection type](v6, "type");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v31 == 0) != (v32 != 0))
            {
              v63 = v32;
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                -[SFStockChartCardSection thirdPartyContentURL](v6, "thirdPartyContentURL");
...
LABEL_65:
                      ...
                      objc_msgSend(v44, "isEqual:")))
                {
                  ...
                  -[SFStockChartCardSection chartData](v6, "chartData");
...
- (SFStockChartCardSection)initWithProtobuf:(id)a3
{
  ...
  v5 = -[SFCardSection init](&v35, sel_init);
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[SFPunchout initWithProtobuf:]([SFPunchout alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v31 + 1) + 8 * i));
          if (v13)
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFStockChartCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFStockChartCardSection setThirdPartyContentURL:](v5, "setThirdPartyContentURL:", v26);
    ...
    if (v27)
    {
      objc_msgSend(v4, "chartData");
      v28 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFStockChartCardSection setChartData:](v5, "setChartData:", v28);
