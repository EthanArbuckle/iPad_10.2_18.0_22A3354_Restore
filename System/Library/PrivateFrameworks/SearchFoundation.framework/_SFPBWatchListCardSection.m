...
- (_SFPBWatchListCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBWatchListCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBWatchListCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBWatchListCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBWatchListCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBWatchListCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBWatchListCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBWatchListCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBWatchListCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBWatchListCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBWatchListCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v24)
    {
      ...
      v27 = -[_SFPBWatchListItem initWithFacade:](v25, "initWithFacade:", v26);
      -[_SFPBWatchListCardSection setWatchListItem:](v5, "setWatchListItem:", v27);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBWatchListCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBWatchListCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBWatchListCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBWatchListCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBWatchListCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBWatchListCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBWatchListCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBWatchListCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBWatchListCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBWatchListCardSection watchListItem](self, "watchListItem");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
    PBDataWriterWriteSubmessage();
...
- (unint64_t)hash
{
  ...
  return v9 ^ v10 ^ -[_SFPBWatchListItem hash](self->_watchListItem, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWatchListCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWatchListCardSection hasBottomPadding](self, "hasBottomPadding"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWatchListCardSection hasTopPadding](self, "hasTopPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v22 = -[_SFPBWatchListCardSection separatorStyle](self, "separatorStyle");
    if (v22 >= 6)
    {
  ...
  if (self->_watchListItem)
  {
    ...
    if (v27)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v27, CFSTR("watchListItem"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v28 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v28, CFSTR("watchListItem"));
...
- (NSData)jsonData
{
  ...
  -[_SFPBWatchListCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBWatchListCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBWatchListCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBWatchListCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBWatchListCardSection init](&v38, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBWatchListCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v13);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchListCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v18, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchListCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchListCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v20, "BOOLValue"));
    v33 = v6;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBWatchListCardSection setType:](v5, "setType:", v22);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWatchListCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v23, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBWatchListCardSection setBackgroundColor:](v5, "setBackgroundColor:", v25);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v27 = -[_SFPBWatchListItem initWithDictionary:]([_SFPBWatchListItem alloc], "initWithDictionary:", v26);
      -[_SFPBWatchListCardSection setWatchListItem:](v5, "setWatchListItem:", v27);
