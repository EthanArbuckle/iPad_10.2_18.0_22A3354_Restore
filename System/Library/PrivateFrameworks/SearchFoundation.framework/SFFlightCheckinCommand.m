...
{
  id v4;
  SFFlightCheckinCommand *v5;
  SFFlightCheckinCommand *v6;
  objc_super v8;

  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)SFFlightCheckinCommand;
  v5 = -[SFFlightCheckinCommand init](&v8, sel_init);
  if (v5)
  {
    if (objc_msgSend(v4, "placeHolderProperty"))
      -[SFFlightCheckinCommand setPlaceHolderProperty:](v5, "setPlaceHolderProperty:", objc_msgSend(v4, "placeHolderProperty"));
    v6 = v5;
  }
...
- (SFFlightCheckinCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFFlightCheckinCommand init](self, "init");
  ...
  {
    -[SFFlightCheckinCommand setPlaceHolderProperty:](v5, "setPlaceHolderProperty:", -[SFCommand placeHolderProperty](v8, "placeHolderProperty"));
...
{
  _SFPBFlightCheckinCommand *v2;
  void *v3;

  v2 = -[_SFPBFlightCheckinCommand initWithFacade:]([_SFPBFlightCheckinCommand alloc], "initWithFacade:", self);
  -[_SFPBFlightCheckinCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBFlightCheckinCommand initWithFacade:]([_SFPBFlightCheckinCommand alloc], "initWithFacade:", self);
  -[_SFPBFlightCheckinCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = (SFFlightCheckinCommand *)a3;
  if (self == v4)
  {
    v8 = 1;
  }
  else if (-[SFFlightCheckinCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v10.receiver = self,
             v10.super_class = (Class)SFFlightCheckinCommand,
             -[SFCommand isEqual:](&v10, sel_isEqual_, v4)))
  {
    v5 = v4;
    v6 = -[SFFlightCheckinCommand placeHolderProperty](self, "placeHolderProperty");
    v7 = -[SFFlightCheckinCommand placeHolderProperty](v5, "placeHolderProperty");
...
- (unint64_t)hash
{
  ...
  return v3 ^ -[SFFlightCheckinCommand placeHolderProperty](self, "placeHolderProperty");
}
