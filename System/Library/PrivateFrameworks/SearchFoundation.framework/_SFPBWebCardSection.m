...
- (_SFPBWebCardSection)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_SFPBWebCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBWebCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBWebCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBWebCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBWebCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBWebCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBWebCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBWebCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBWebCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBWebCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v24)
    {
      ...
      -[_SFPBWebCardSection setHtmlString:](v5, "setHtmlString:", v25);
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBWebCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBWebCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBWebCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBWebCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBWebCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBWebCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBWebCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBWebCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBWebCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBWebCardSection htmlString](self, "htmlString");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
    PBDataWriterWriteStringField();
...
- (unint64_t)hash
{
  ...
  return v9 ^ v10 ^ -[NSString hash](self->_htmlString, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWebCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWebCardSection hasBottomPadding](self, "hasBottomPadding"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBWebCardSection hasTopPadding](self, "hasTopPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_htmlString)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v11, CFSTR("htmlString"));
  ...
  {
    v24 = -[_SFPBWebCardSection separatorStyle](self, "separatorStyle");
    if (v24 >= 6)
    {
...
- (NSData)jsonData
{
  ...
  -[_SFPBWebCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBWebCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBWebCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBWebCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = -[_SFPBWebCardSection init](&v38, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBWebCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v13);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWebCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v18, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWebCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWebCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v20, "BOOLValue"));
    v33 = v6;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBWebCardSection setType:](v5, "setType:", v22);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBWebCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v23, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBWebCardSection setBackgroundColor:](v5, "setBackgroundColor:", v25);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("htmlString"));
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v27 = (void *)objc_msgSend(v26, "copy");
      -[_SFPBWebCardSection setHtmlString:](v5, "setHtmlString:", v27);
