...
- (SFSectionHeaderCardSection)initWithProtobuf:(id)a3
{
  ...
  void *v26;
  SFRichText *v27;
  SFSectionHeaderCardSection *v28;
  __int128 v30;
  __int128 v31;
  __int128 v32;
  __int128 v33;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFSectionHeaderCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFSectionHeaderCardSection setText:](v5, "setText:", v27);
...
- (SFSectionHeaderCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFSectionHeaderCardSection setType:](v5, "setType:", v12);
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFSectionHeaderCardSection setText:](v5, "setText:", v14);
...
{
  _SFPBSectionHeaderCardSection *v2;
  void *v3;

  v2 = -[_SFPBSectionHeaderCardSection initWithFacade:]([_SFPBSectionHeaderCardSection alloc], "initWithFacade:", self);
  -[_SFPBSectionHeaderCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBSectionHeaderCardSection initWithFacade:]([_SFPBSectionHeaderCardSection alloc], "initWithFacade:", self);
  -[_SFPBSectionHeaderCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFSectionHeaderCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFSectionHeaderCardSection text](self, "text");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = (SFSectionHeaderCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFSectionHeaderCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            -[SFSectionHeaderCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFSectionHeaderCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              ...
              if (v33 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                        ...
                        objc_msgSend(v37, "isEqual:")))
                  {
                    ...
                    -[SFSectionHeaderCardSection text](v6, "text");
