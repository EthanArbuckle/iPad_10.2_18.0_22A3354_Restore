...
{
  id v4;
  RFPrimaryHeaderMarqueeCardSection *v5;
  void *v6;
  _SFPBCardSection *v7;
  SFCardSection *v8;
  void *v9;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[RFPrimaryHeaderMarqueeCardSection setText_1:](v5, "setText_1:", v9);

    -[SFCardSection text](v8, "text");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFPrimaryHeaderMarqueeCardSection setText_2:](v5, "setText_2:", v10);

    -[SFCardSection thumbnail](v8, "thumbnail");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[RFPrimaryHeaderMarqueeCardSection setThumbnail:](v5, "setThumbnail:", v11);

    -[RFPrimaryHeaderMarqueeCardSection setAddTint:](v5, "setAddTint:", -[SFCardSection addTint](v8, "addTint"));
...
{
  _SFPBRFPrimaryHeaderMarqueeCardSection *v2;
  void *v3;

  v2 = -[_SFPBRFPrimaryHeaderMarqueeCardSection initWithFacade:]([_SFPBRFPrimaryHeaderMarqueeCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFPrimaryHeaderMarqueeCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBRFPrimaryHeaderMarqueeCardSection initWithFacade:]([_SFPBRFPrimaryHeaderMarqueeCardSection alloc], "initWithFacade:", self);
  -[_SFPBRFPrimaryHeaderMarqueeCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RFPrimaryHeaderMarqueeCardSection text](self, "text");
  ...
  -[RFPrimaryHeaderMarqueeCardSection thumbnail](self, "thumbnail");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  RFPrimaryHeaderMarqueeCardSection *v5;
  RFPrimaryHeaderMarqueeCardSection *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  v5 = (RFPrimaryHeaderMarqueeCardSection *)a3;
  if (self == v5)
  {
    LOBYTE(v11) = 1;
  }
  ...
  {
    if (-[RFPrimaryHeaderMarqueeCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v33.receiver = self;
      ...
      if (-[SFCardSection isEqual:](&v33, sel_isEqual_, v5))
      {
        ...
        -[RFPrimaryHeaderMarqueeCardSection text](self, "text");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFPrimaryHeaderMarqueeCardSection text](v6, "text");
...
LABEL_33:
        ...
        -[RFPrimaryHeaderMarqueeCardSection thumbnail](self, "thumbnail");
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        -[RFPrimaryHeaderMarqueeCardSection thumbnail](v6, "thumbnail");
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        if ((v17 == 0) == (v18 != 0))
        {
        ...
        {
          v3 = v28;
          v20 = -[RFPrimaryHeaderMarqueeCardSection addTint](self, "addTint");
          v11 = v20 ^ -[RFPrimaryHeaderMarqueeCardSection addTint](v6, "addTint") ^ 1;
          if (!v27)
            goto LABEL_27;
        }
        else
...
- (unint64_t)hash
{
  ...
  v10 = v9 ^ -[RFPrimaryHeaderMarqueeCardSection addTint](self, "addTint") ^ v3;
...
- (RFPrimaryHeaderMarqueeCardSection)initWithProtobuf:(id)a3
{
  ...
  RFPrimaryHeaderMarqueeCardSection *v18;
  objc_super v20;
  ...
  if (v5)
  {
    ...
    if (v10)
    {
      ...
      -[RFPrimaryHeaderMarqueeCardSection setText_2:](v5, "setText_2:", v13);
    ...
    if (v14)
    {
      ...
      -[RFPrimaryHeaderMarqueeCardSection setThumbnail:](v5, "setThumbnail:", v17);

    }
    if (objc_msgSend(v4, "addTint"))
      -[RFPrimaryHeaderMarqueeCardSection setAddTint:](v5, "setAddTint:", objc_msgSend(v4, "addTint"));
    v18 = v5;
  }
