...
- (SFSearchWebCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFSearchWebCommand init](self, "init");
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFSearchWebCommand setSearchString:](v5, "setSearchString:", v9);
...
{
  _SFPBSearchWebCommand *v2;
  void *v3;

  v2 = -[_SFPBSearchWebCommand initWithFacade:]([_SFPBSearchWebCommand alloc], "initWithFacade:", self);
  -[_SFPBSearchWebCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBSearchWebCommand initWithFacade:]([_SFPBSearchWebCommand alloc], "initWithFacade:", self);
  -[_SFPBSearchWebCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFSearchWebCommand searchString](self, "searchString");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (-[SFSearchWebCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFSearchWebCommand searchString](self, "searchString");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFSearchWebCommand searchString](v5, "searchString");
...
- (SFSearchWebCommand)initWithProtobuf:(id)a3
{
  ...
  void *v6;
  void *v7;
  SFSearchWebCommand *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SFSearchWebCommand;
  v5 = -[SFSearchWebCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      objc_msgSend(v4, "searchString");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFSearchWebCommand setSearchString:](v5, "setSearchString:", v7);
