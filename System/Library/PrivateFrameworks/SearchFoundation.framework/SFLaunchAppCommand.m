...
{
  id v4;
  SFLaunchAppCommand *v5;
  void *v6;
  void *v7;
  SFLaunchAppCommand *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SFLaunchAppCommand;
  v5 = -[SFLaunchAppCommand init](&v10, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      -[SFLaunchAppCommand setApplicationBundleIdentifier:](v5, "setApplicationBundleIdentifier:", v7);
...
- (SFLaunchAppCommand)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SFLaunchAppCommand init](self, "init");
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFLaunchAppCommand setApplicationBundleIdentifier:](v5, "setApplicationBundleIdentifier:", v9);
...
{
  _SFPBLaunchAppCommand *v2;
  void *v3;

  v2 = -[_SFPBLaunchAppCommand initWithFacade:]([_SFPBLaunchAppCommand alloc], "initWithFacade:", self);
  -[_SFPBLaunchAppCommand dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBLaunchAppCommand initWithFacade:]([_SFPBLaunchAppCommand alloc], "initWithFacade:", self);
  -[_SFPBLaunchAppCommand jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFLaunchAppCommand applicationBundleIdentifier](self, "applicationBundleIdentifier");
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = (SFLaunchAppCommand *)a3;
  if (self == v4)
  {
    v11 = 1;
  }
  else if (-[SFLaunchAppCommand isMemberOfClass:](v4, "isMemberOfClass:", objc_opt_class())
         && (v13.receiver = self,
             ...
             -[SFCommand isEqual:](&v13, sel_isEqual_, v4)))
  {
    ...
    -[SFLaunchAppCommand applicationBundleIdentifier](self, "applicationBundleIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFLaunchAppCommand applicationBundleIdentifier](v5, "applicationBundleIdentifier");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    if ((v6 == 0) == (v7 != 0))
    {
      v11 = 0;
