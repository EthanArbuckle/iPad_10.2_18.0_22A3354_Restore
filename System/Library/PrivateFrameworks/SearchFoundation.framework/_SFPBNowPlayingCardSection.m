...
- (_SFPBNowPlayingCardSection)initWithFacade:(id)a3
{
  ...
  uint64_t j;
  _SFPBMediaItem *v35;
  _SFPBNowPlayingCardSection *v36;
  __int128 v38;
  __int128 v39;
  __int128 v40;
  __int128 v41;
  ...
  v4 = a3;
  v5 = -[_SFPBNowPlayingCardSection init](self, "init");
  if (v5)
  {
    ...
    -[_SFPBNowPlayingCardSection setPunchoutOptions:](v5, "setPunchoutOptions:", v7);
    ...
    if (v14)
    {
      ...
      -[_SFPBNowPlayingCardSection setPunchoutPickerTitle:](v5, "setPunchoutPickerTitle:", v15);
    ...
    if (v16)
    {
      ...
      -[_SFPBNowPlayingCardSection setPunchoutPickerDismissText:](v5, "setPunchoutPickerDismissText:", v17);

    }
    if (objc_msgSend(v4, "hasCanBeHidden"))
      -[_SFPBNowPlayingCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v4, "canBeHidden"));
    if (objc_msgSend(v4, "hasHasTopPadding"))
      -[_SFPBNowPlayingCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v4, "hasTopPadding"));
    if (objc_msgSend(v4, "hasHasBottomPadding"))
      -[_SFPBNowPlayingCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v4, "hasBottomPadding"));
    ...
    if (v18)
    {
      ...
      -[_SFPBNowPlayingCardSection setType:](v5, "setType:", v19);

    }
    if (objc_msgSend(v4, "hasSeparatorStyle"))
      -[_SFPBNowPlayingCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v4, "separatorStyle"));
    ...
    if (v20)
    {
      ...
      -[_SFPBNowPlayingCardSection setBackgroundColor:](v5, "setBackgroundColor:", v23);
    ...
    if (v24)
    {
      ...
      -[_SFPBNowPlayingCardSection setTitle:](v5, "setTitle:", v25);
    ...
    if (v26)
    {
      ...
      -[_SFPBNowPlayingCardSection setSubtitle:](v5, "setSubtitle:", v27);
    ...
    -[_SFPBNowPlayingCardSection setMovies:](v5, "setMovies:", v29);
    v36 = v5;
...
- (void)clearMovies
{
  -[NSArray removeAllObjects](self->_movies, "removeAllObjects");
}
...
- (void)addMovies:(id)a3
{
  ...
  -[NSArray addObject:](movies, "addObject:", v4);

}

- (unint64_t)moviesCount
{
  return -[NSArray count](self->_movies, "count");
}

- (id)moviesAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_movies, "objectAtIndexedSubscript:", a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_SFPBNowPlayingCardSection punchoutOptions](self, "punchoutOptions");
  ...
  -[_SFPBNowPlayingCardSection punchoutPickerTitle](self, "punchoutPickerTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
    PBDataWriterWriteStringField();

  -[_SFPBNowPlayingCardSection punchoutPickerDismissText](self, "punchoutPickerDismissText");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  if (v11)
    PBDataWriterWriteStringField();

  if (-[_SFPBNowPlayingCardSection canBeHidden](self, "canBeHidden"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBNowPlayingCardSection hasTopPadding](self, "hasTopPadding"))
    PBDataWriterWriteBOOLField();
  if (-[_SFPBNowPlayingCardSection hasBottomPadding](self, "hasBottomPadding"))
    PBDataWriterWriteBOOLField();
  -[_SFPBNowPlayingCardSection type](self, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
    PBDataWriterWriteStringField();

  if (-[_SFPBNowPlayingCardSection separatorStyle](self, "separatorStyle"))
    PBDataWriterWriteInt32Field();
  -[_SFPBNowPlayingCardSection backgroundColor](self, "backgroundColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
    PBDataWriterWriteSubmessage();

  -[_SFPBNowPlayingCardSection title](self, "title");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
    PBDataWriterWriteStringField();

  -[_SFPBNowPlayingCardSection subtitle](self, "subtitle");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v15)
    PBDataWriterWriteStringField();

  -[_SFPBNowPlayingCardSection movies](self, "movies");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
...
- (unint64_t)hash
{
  ...
  return v9 ^ v12 ^ -[NSArray hash](self->_movies, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_canBeHidden)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBNowPlayingCardSection canBeHidden](self, "canBeHidden"));
  ...
  if (self->_hasBottomPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBNowPlayingCardSection hasBottomPadding](self, "hasBottomPadding"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_hasTopPadding)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_SFPBNowPlayingCardSection hasTopPadding](self, "hasTopPadding"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("hasTopPadding"));

  }
  if (-[NSArray count](self->_movies, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v43 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("movies"));
  }
  ...
  {
    v30 = -[_SFPBNowPlayingCardSection separatorStyle](self, "separatorStyle");
    if (v30 >= 6)
    {
...
- (NSData)jsonData
{
  ...
  -[_SFPBNowPlayingCardSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (_SFPBNowPlayingCardSection)initWithJSON:(id)a3
{
  ...
  {
    self = -[_SFPBNowPlayingCardSection initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (_SFPBNowPlayingCardSection)initWithDictionary:(id)a3
{
  ...
  uint64_t v40;
  _SFPBMediaItem *v41;
  _SFPBNowPlayingCardSection *v42;
  void *v44;
  void *v45;
  void *v46;
  void *v47;
  ...
  v5 = -[_SFPBNowPlayingCardSection init](&v62, sel_init);
  if (v5)
  {
        ...
        do
        {
          for (i = 0; i != v9; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBNowPlayingCardSection addPunchoutOptions:](v5, "addPunchoutOptions:", v13);
    ...
    v52 = v18;
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBNowPlayingCardSection setCanBeHidden:](v5, "setCanBeHidden:", objc_msgSend(v18, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasTopPadding"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    v51 = v19;
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBNowPlayingCardSection setHasTopPadding:](v5, "setHasTopPadding:", objc_msgSend(v19, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasBottomPadding"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    v50 = v20;
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBNowPlayingCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", objc_msgSend(v20, "BOOLValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBNowPlayingCardSection setType:](v5, "setType:", v22);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[_SFPBNowPlayingCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", objc_msgSend(v23, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_SFPBNowPlayingCardSection setBackgroundColor:](v5, "setBackgroundColor:", v25);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v30 = v16;
      v31 = (void *)v27;
      -[_SFPBNowPlayingCardSection setTitle:](v5, "setTitle:", v27);
    ...
    {
      v33 = (void *)objc_msgSend(v32, "copy");
      -[_SFPBNowPlayingCardSection setSubtitle:](v5, "setSubtitle:", v33);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("movies"));
    v34 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
        ...
        do
        {
          for (j = 0; j != v37; ++j)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[_SFPBNowPlayingCardSection addMovies:](v5, "addMovies:", v41);
