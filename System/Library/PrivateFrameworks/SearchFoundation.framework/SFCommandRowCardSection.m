...
- (SFCommandRowCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFCommandRowCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCommandRowCardSection setImage:](v5, "setImage:", v14);

    -[SFCardSection toggledImage](v8, "toggledImage");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCommandRowCardSection setToggledImage:](v5, "setToggledImage:", v15);

    -[SFCardSection title](v8, "title");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCommandRowCardSection setTitle:](v5, "setTitle:", v16);

    -[SFCardSection toggledTitle](v8, "toggledTitle");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCommandRowCardSection setToggledTitle:](v5, "setToggledTitle:", v17);

    -[SFCardSection subtitle](v8, "subtitle");
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFCommandRowCardSection setSubtitle:](v5, "setSubtitle:", v18);
...
{
  _SFPBCommandRowCardSection *v2;
  void *v3;

  v2 = -[_SFPBCommandRowCardSection initWithFacade:]([_SFPBCommandRowCardSection alloc], "initWithFacade:", self);
  -[_SFPBCommandRowCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBCommandRowCardSection initWithFacade:]([_SFPBCommandRowCardSection alloc], "initWithFacade:", self);
  -[_SFPBCommandRowCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFCommandRowCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SFCommandRowCardSection image](self, "image");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v15, "copy");
  objc_msgSend(v4, "setImage:", v16);

  -[SFCommandRowCardSection toggledImage](self, "toggledImage");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v17, "copy");
  objc_msgSend(v4, "setToggledImage:", v18);

  -[SFCommandRowCardSection title](self, "title");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = (void *)objc_msgSend(v19, "copy");
  objc_msgSend(v4, "setTitle:", v20);

  -[SFCommandRowCardSection toggledTitle](self, "toggledTitle");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v22 = (void *)objc_msgSend(v21, "copy");
  objc_msgSend(v4, "setToggledTitle:", v22);

  -[SFCommandRowCardSection subtitle](self, "subtitle");
  v23 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = (SFCommandRowCardSection *)a3;
  if (self == v5)
  {
    v16 = 1;
    goto LABEL_82;
  }
  if (!-[SFCommandRowCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class())
    || (v95.receiver = self,
          ...
          else
          {
                  ...
                  objc_msgSend(v19, "isEqual:")))
            {
                    ...
                    (_DWORD)v3 == -[SFCardSection hasBottomPadding](v6, "hasBottomPadding")))
              {
                -[SFCommandRowCardSection type](self, "type");
                v3 = objc_claimAutoreleasedReturnValue();
                -[SFCommandRowCardSection type](v6, "type");
                    ...
                    if ((_DWORD)v3 == -[SFCardSection separatorStyle](v6, "separatorStyle"))
                    {
                      ...
                      else
                      {
                              ...
                              objc_msgSend(v30, "isEqual:")))
                        {
                          ...
                          -[SFCommandRowCardSection image](v6, "image");
                          ...
                          else
                          {
                                  ...
                                  objc_msgSend(v32, "isEqual:")))
                            {
                              ...
                              -[SFCommandRowCardSection toggledImage](v6, "toggledImage");
                              ...
                              else
                              {
                                      ...
                                      objc_msgSend(v34, "isEqual:")))
                                {
                                  ...
                                  -[SFCommandRowCardSection title](v6, "title");
                                  ...
                                  else
                                  {
                                          ...
                                          objc_msgSend(v36, "isEqual:")))
                                    {
                                      ...
                                      -[SFCommandRowCardSection toggledTitle](v6, "toggledTitle");
                                      ...
                                      else
                                      {
                                              ...
                                              objc_msgSend(v38, "isEqual:")))
                                        {
                                          ...
                                          -[SFCommandRowCardSection subtitle](v6, "subtitle");
...
- (SFCommandRowCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      objc_msgSend(v4, "type");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SFCommandRowCardSection setType:](v5, "setType:", v19);
    ...
    if (v24)
    {
      ...
      -[SFCommandRowCardSection setImage:](v5, "setImage:", v27);
    ...
    if (v28)
    {
      ...
      objc_msgSend(v4, "toggledImage");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      v31 = -[SFImage initWithProtobuf:](v29, "initWithProtobuf:", v30);
      -[SFCommandRowCardSection setToggledImage:](v5, "setToggledImage:", v31);
    ...
    if (v32)
    {
      ...
      -[SFCommandRowCardSection setTitle:](v5, "setTitle:", v35);
    ...
    if (v36)
    {
      ...
      -[SFCommandRowCardSection setToggledTitle:](v5, "setToggledTitle:", v39);
    ...
    if (v40)
    {
      ...
      -[SFCommandRowCardSection setSubtitle:](v5, "setSubtitle:", v43);
