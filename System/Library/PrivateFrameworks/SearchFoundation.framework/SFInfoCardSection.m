...
- (SFInfoCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      -[SFInfoCardSection setType:](v5, "setType:", v19);
    ...
    if (v27)
    {
      ...
      do
      {
        for (j = 0; j != v28; ++j)
        {
          ...
          v31 = -[SFInfoTuple initWithProtobuf:]([SFInfoTuple alloc], "initWithProtobuf:", *(_QWORD *)(*((_QWORD *)&v34 + 1) + 8 * j));
          if (v31)
    ...
    -[SFInfoCardSection setInfoTuples:](v5, "setInfoTuples:", v25);
    if (objc_msgSend(v4, "initiallyVisibleTuples"))
      -[SFInfoCardSection setInitiallyVisibleTuples:](v5, "setInitiallyVisibleTuples:", objc_msgSend(v4, "initiallyVisibleTuples"));
    v32 = v5;
...
- (NSArray)embeddedCards
{
  ...
  -[SFInfoCardSection infoTuples](self, "infoTuples");
  ...
  -[SFCardSection embeddedCards](&v9, sel_embeddedCards);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "addObjectsFromArray:", v6);

  -[SFInfoCardSection cardsFromInfoTuple](self, "cardsFromInfoTuple");
        ...
        if (v12)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              objc_msgSend(*(id *)(*((_QWORD *)&v20 + 1) + 8 * v15), "command");
              v16 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v16, "embeddedCards");
              v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (SFInfoCardSection)initWithCoder:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SFInfoCardSection setType:](v5, "setType:", v12);
    ...
    -[SFCardSection infoTuples](v8, "infoTuples");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SFInfoCardSection setInfoTuples:](v5, "setInfoTuples:", v14);

    -[SFInfoCardSection setInitiallyVisibleTuples:](v5, "setInitiallyVisibleTuples:", -[SFCardSection initiallyVisibleTuples](v8, "initiallyVisibleTuples"));
...
{
  _SFPBInfoCardSection *v2;
  void *v3;

  v2 = -[_SFPBInfoCardSection initWithFacade:]([_SFPBInfoCardSection alloc], "initWithFacade:", self);
  -[_SFPBInfoCardSection dictionaryRepresentation](v2, "dictionaryRepresentation");
...
- (NSData)jsonData
{
  ...
  v2 = -[_SFPBInfoCardSection initWithFacade:]([_SFPBInfoCardSection alloc], "initWithFacade:", self);
  -[_SFPBInfoCardSection jsonData](v2, "jsonData");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SFInfoCardSection type](self, "type");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v4, "setInfoTuples:", v16);
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v66;
  void *v67;
  SFInfoCardSection *v68;
  void *v69;
  void *v70;
  objc_super v71;

  v5 = (SFInfoCardSection *)a3;
  if (self == v5)
  {
    v11 = 1;
  }
  ...
  {
    if (-[SFInfoCardSection isMemberOfClass:](v5, "isMemberOfClass:", objc_opt_class()))
    {
      v71.receiver = self;
...
LABEL_28:
            ...
            -[SFInfoCardSection type](self, "type");
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[SFInfoCardSection type](v6, "type");
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if ((v28 == 0) != (v29 != 0))
            {
              v55 = v29;
              ...
              if ((v51 == 0) != (v32 != 0))
              {
                ...
                -[SFInfoCardSection infoTuples](v6, "infoTuples");
                ...
                {
                  v43 = -[SFInfoCardSection initiallyVisibleTuples](self, "initiallyVisibleTuples");
                  v11 = v43 == -[SFInfoCardSection initiallyVisibleTuples](v6, "initiallyVisibleTuples");
                  if (!v41)
                    goto LABEL_68;
                }
                else
...
- (unint64_t)hash
{
  ...
  v20 = v19 ^ -[SFInfoCardSection initiallyVisibleTuples](self, "initiallyVisibleTuples");
