@implementation UIAccessibilityPathForPath

uint64_t ___UIAccessibilityPathForPath_block_invoke(uint64_t a1)
{
  return (*(uint64_t (**)(_QWORD))(a1 + 40))(*(_QWORD *)(a1 + 32));
}

void __UIAccessibilityPathForPath_block_invoke(uint64_t a1, int a2, CGFloat *a3, uint64_t a4)
{
  uint64_t v7;
  double *v8;
  uint64_t v9;
