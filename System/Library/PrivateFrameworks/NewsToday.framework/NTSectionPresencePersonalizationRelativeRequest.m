...
- (NTSectionPresencePersonalizationRelativeRequest)init
{
  ...
  return -[NTSectionPresencePersonalizationRelativeRequest init](&v3, sel_init);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@: %s"), CFSTR("Do not call method"), "-[NTSectionPresencePersonalizationRelativeRequest copyWithZone:]");
