...
{
  id v4;
  DMFFetchCertificatesResultObject *v5;
  uint64_t v6;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[DMFFetchCertificatesResultObject certificates](self, "certificates", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("certificates"));
...
- (id)description
{
  ...
  -[DMFFetchCertificatesResultObject certificates](self, "certificates");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "sortedArrayUsingComparator:", &__block_literal_global_7);
...
uint64_t __47__DMFFetchCertificatesResultObject_description__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = a3;
  objc_msgSend(a2, "commonName");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "commonName");
