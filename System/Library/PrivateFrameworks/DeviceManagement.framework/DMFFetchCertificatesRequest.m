...
{
  id v4;
  DMFFetchCertificatesRequest *v5;
  void *v6;
  objc_super v8;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[DMFFetchCertificatesRequest managedOnly](self, "managedOnly", v6.receiver, v6.super_class));
