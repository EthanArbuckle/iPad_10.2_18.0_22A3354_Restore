...
{
  id v4;
  DMFFetchProvisioningProfilesRequest *v5;
  void *v6;
  objc_super v8;
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("managedOnly"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[DMFFetchProvisioningProfilesRequest managedOnly](self, "managedOnly", v6.receiver, v6.super_class));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("managedOnly"));
