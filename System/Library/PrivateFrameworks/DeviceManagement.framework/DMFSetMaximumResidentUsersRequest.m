...
{
  id v4;
  DMFSetMaximumResidentUsersRequest *v5;
  void *v6;
  objc_super v8;
  ...
  if (v5)
  {
    ...
    v5->_count = objc_msgSend(v6, "unsignedIntegerValue");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[DMFSetMaximumResidentUsersRequest count](self, "count", v6.receiver, v6.super_class));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("count"));
