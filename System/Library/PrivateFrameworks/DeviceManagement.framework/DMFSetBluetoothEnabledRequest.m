...
{
  id v4;
  DMFSetBluetoothEnabledRequest *v5;
  void *v6;
  objc_super v8;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[DMFSetBluetoothEnabledRequest enabled](self, "enabled", v6.receiver, v6.super_class));
