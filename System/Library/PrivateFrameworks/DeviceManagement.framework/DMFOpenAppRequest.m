...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[DMFOpenAppRequest bundleIdentifier](self, "bundleIdentifier", v9.receiver, v9.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("bundleIdentifier"));

  -[DMFOpenAppRequest activityType](self, "activityType");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, CFSTR("activityType"));

  -[DMFOpenAppRequest activityData](self, "activityData");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, CFSTR("activityData"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[DMFOpenAppRequest lockInApp](self, "lockInApp"));
