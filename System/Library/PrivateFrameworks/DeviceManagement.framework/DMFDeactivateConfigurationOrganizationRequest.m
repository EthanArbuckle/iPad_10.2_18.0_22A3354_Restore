...
{
  id v4;
  DMFDeactivateConfigurationOrganizationRequest *v5;
  void *v6;
  uint64_t v7;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[DMFDeactivateConfigurationOrganizationRequest organizationIdentifier](self, "organizationIdentifier", v6.receiver, v6.super_class);
