...
{
  id v4;
  DMFRefreshStatusResultObject *v5;
  uint64_t v6;
  uint64_t v7;
  uint64_t v8;
  uint64_t v9;
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v14, CFSTR("numberOfUpdates"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[DMFRefreshStatusResultObject numberOfUpdates](self, "numberOfUpdates", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("numberOfUpdates"));
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_numberOfUpdates, 0);
}
