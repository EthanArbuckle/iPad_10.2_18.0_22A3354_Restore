...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[DMFSetAirPlayRouteRequest routeUID](self, "routeUID", v8.receiver, v8.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("routeUID"));

  -[DMFSetAirPlayRouteRequest password](self, "password");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, CFSTR("password"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[DMFSetAirPlayRouteRequest suppressPasscodePrompt](self, "suppressPasscodePrompt"));
