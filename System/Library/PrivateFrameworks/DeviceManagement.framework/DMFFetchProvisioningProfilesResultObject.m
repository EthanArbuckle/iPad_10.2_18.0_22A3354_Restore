...
{
  id v4;
  DMFFetchProvisioningProfilesResultObject *v5;
  uint64_t v6;
  NSArray *profiles;
  objc_super v9;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[DMFFetchProvisioningProfilesResultObject profiles](self, "profiles", v6.receiver, v6.super_class);
...
- (id)description
{
  ...
  -[DMFFetchProvisioningProfilesResultObject profiles](self, "profiles");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "sortedArrayUsingComparator:", &__block_literal_global_11);
