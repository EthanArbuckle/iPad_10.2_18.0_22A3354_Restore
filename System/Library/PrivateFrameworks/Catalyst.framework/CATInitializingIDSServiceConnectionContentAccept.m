...
{
  id v5;
  CATInitializingIDSServiceConnectionContentAccept *v6;
  CATInitializingIDSServiceConnectionContentAccept *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CATInitializingIDSServiceConnectionContentAccept;
  v6 = -[CATInitializingIDSServiceConnectionContentAccept init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSDictionary)dictionaryValue
{
  ...
  -[CATInitializingIDSServiceConnectionContentAccept connectionIdentifier](self, "connectionIdentifier");
