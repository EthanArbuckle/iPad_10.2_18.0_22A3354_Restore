...
- (_TtC7NewsUI225SportsManagementTitleView)initWithFrame:(CGRect)a3
{
  ...
  uint64_t v9;
  id v10;
  _TtC7NewsUI225SportsManagementTitleView *v11;
  _TtC7NewsUI225SportsManagementTitleView *v12;
  objc_super v14;
  ...
  v9 = OBJC_IVAR____TtC7NewsUI225SportsManagementTitleView_titleLabel;
  ...
  *(Class *)((char *)&self->super.super.super.isa + v9) = (Class)objc_msgSend(v10, sel_initWithFrame_, 0.0, 0.0, 0.0, 0.0);
  ...
  -[SportsManagementTitleView addSubview:](v12, sel_addSubview_, *(Class *)((char *)&v12->super.super.super.isa + OBJC_IVAR____TtC7NewsUI225SportsManagementTitleView_titleLabel));
  return v12;
}
...
- (_TtC7NewsUI225SportsManagementTitleView)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC7NewsUI225SportsManagementTitleView *result;

  v5 = OBJC_IVAR____TtC7NewsUI225SportsManagementTitleView_titleLabel;
  v6 = objc_allocWithZone(MEMORY[0x1E0DC3990]);
  v7 = a3;
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, sel_initWithFrame_, 0.0, 0.0, 0.0, 0.0);

  result = (_TtC7NewsUI225SportsManagementTitleView *)sub_1D6E28010();
  __break(1u);
  return result;
}
