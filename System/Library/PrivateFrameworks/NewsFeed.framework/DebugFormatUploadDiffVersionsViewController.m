...
- (_TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController *result;

  v5 = OBJC_IVAR____TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController_tableView;
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, sel_initWithFrame_style_, 1, 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController *)sub_1BB873EAC();
  __break(1u);
  return result;
}
...
- (void)viewDidLoad
{
  _TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController *v2;
...
- (void)viewWillLayoutSubviews
{
  ...
  -[DebugFormatUploadDiffVersionsViewController viewWillLayoutSubviews](&v14, sel_viewWillLayoutSubviews);
...
- (void)doDismiss
{
  -[DebugFormatUploadDiffVersionsViewController dismissViewControllerAnimated:completion:](self, sel_dismissViewControllerAnimated_completion_, 1, 0);
}
...
- (void).cxx_destruct
{
  ...
  sub_1BA6BF694((uint64_t)self + OBJC_IVAR____TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController_selectedRemoteVersion);
...
{
  id v6;
  _TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController *v7;
  int64_t v8;
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  char *v9;
  id v10;
  _TtC8NewsFeed43DebugFormatUploadDiffVersionsViewController *v11;
  void *v12;
  uint64_t v14;
  ...
  v10 = a3;
  v11 = self;
  v12 = (void *)sub_1BB1633A4((uint64_t)v10, (uint64_t)v9);
