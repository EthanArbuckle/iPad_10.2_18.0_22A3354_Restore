...
{
  _TtC8NewsFeed35SharingArticleURLActivityItemSource *result;
...
- (void).cxx_destruct
{
  ...
  sub_1BA502AD0((uint64_t)self + OBJC_IVAR____TtC8NewsFeed35SharingArticleURLActivityItemSource_articleURL, (unint64_t *)&qword_1ED3D2E70, (void (*)(uint64_t))MEMORY[0x1E0CAFFF8]);
...
{
  id v4;
  _TtC8NewsFeed35SharingArticleURLActivityItemSource *v5;
  void *v6;
  _QWORD v8[4];
...
- (id)activityViewController:(id)a3 itemForActivityType:(id)a4
{
  id v6;
  id v7;
  _TtC8NewsFeed35SharingArticleURLActivityItemSource *v8;
  uint64_t v9;
  _QWORD *v10;
  uint64_t v11;
  double v12;
