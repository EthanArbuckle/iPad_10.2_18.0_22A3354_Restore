...
- (id)actionForLayer:(id)a3 forKey:(id)a4
{
  id v6;
  id v7;
  _TtCC8NewsFeed21FormatProgressPieViewP33_79BFB08BC08DDFB4B12E2FC8FCA3207125NonAnimatingLayerDelegate *v8;
  id v9;
...
- (_TtCC8NewsFeed21FormatProgressPieViewP33_79BFB08BC08DDFB4B12E2FC8FCA3207125NonAnimatingLayerDelegate)init
{
  ...
  return -[FormatProgressPieView.NonAnimatingLayerDelegate init](&v3, sel_init);
}
