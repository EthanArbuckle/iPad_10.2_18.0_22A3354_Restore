...
{
  _TtC8NewsFeed31SharingTagURLActivityItemSource *result;
...
- (void).cxx_destruct
{
  sub_1BB1608AC(*(id *)((char *)&self->super.isa + OBJC_IVAR____TtC8NewsFeed31SharingTagURLActivityItemSource_model), self->model[OBJC_IVAR____TtC8NewsFeed31SharingTagURLActivityItemSource_model]);
  swift_release();
}
...
{
  id v4;
  _TtC8NewsFeed31SharingTagURLActivityItemSource *v5;
  void *v6;
  _QWORD v8[4];
...
- (id)activityViewController:(id)a3 itemForActivityType:(id)a4
{
  id v6;
  id v7;
  _TtC8NewsFeed31SharingTagURLActivityItemSource *v8;
  uint64_t v9;
  _QWORD *v10;
  uint64_t v11;
  double v12;
