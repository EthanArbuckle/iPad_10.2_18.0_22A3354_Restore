...
- (void)viewDidLoad
{
  _TtC8NewsFeed32DebugFormatBindingViewController *v2;
...
- (void)viewWillLayoutSubviews
{
  ...
  -[DebugFormatBindingViewController viewWillLayoutSubviews](&v14, sel_viewWillLayoutSubviews);
  v3 = *(void **)&v2[OBJC_IVAR____TtC8NewsFeed32DebugFormatBindingViewController_tableView];
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v4 = v5.receiver;
  -[DebugFormatBindingViewController viewDidAppear:](&v5, sel_viewDidAppear_, v3);
  sub_1BB797F60(0);
...
{
  id v4;
  _TtC8NewsFeed32DebugFormatBindingViewController *result;
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  {
    v4 = *(_QWORD *)(self + OBJC_IVAR____TtC8NewsFeed32DebugFormatBindingViewController_sections);
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  char *v9;
  id v10;
  _TtC8NewsFeed32DebugFormatBindingViewController *v11;
  void *v12;
  uint64_t v14;
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  v4 = *(_QWORD *)((char *)self + OBJC_IVAR____TtC8NewsFeed32DebugFormatBindingViewController_sections);
  if (*(_QWORD *)(v4 + 16) <= (unint64_t)a4)
  {
LABEL_8:
    __break(1u);
