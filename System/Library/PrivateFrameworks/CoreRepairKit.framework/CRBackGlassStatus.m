...
- (int64_t)copyComponentStatus
{
  ...
  if ((objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E0D18308], a2, (uint64_t)CFSTR("bCfg"), v2) & 1) != 0
    || objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E0D18308], v6, (uint64_t)CFSTR("LCfg"), v7))
  {
...
LABEL_21:
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_impl(&dword_1D1401000, v69, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
            }
