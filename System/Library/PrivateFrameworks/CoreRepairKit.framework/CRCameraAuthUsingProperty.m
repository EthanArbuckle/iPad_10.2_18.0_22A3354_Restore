...
- (int64_t)copyComponentStatus
{
  ...
  v2 = self;
  objc_sync_enter(v2);
  if ((objc_msgSend_isFDRPropertySupported_(MEMORY[0x1E0D18308], v3, (uint64_t)CFSTR("RCSn"), v4) & 1) != 0)
  {
...
LABEL_15:
      ...
      {
        *(_WORD *)v46 = 0;
        _os_log_impl(&dword_1D1401000, v44, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", v46, 2u);
      }
