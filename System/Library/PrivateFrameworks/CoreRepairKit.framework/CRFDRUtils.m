...
+ (__AMFDR)_createFDRLocal
{
  ...
  v5 = CFSTR("DataStore");
  v6[0] = CFSTR("Local");
  objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], a2, (uint64_t)v6, (uint64_t)&v5, 1);
...
+ (id)getLocalSealingManifest
{
  ...
  {
    *(_WORD *)v8 = 0;
    _os_log_impl(&dword_1D1401000, v4, OS_LOG_TYPE_DEFAULT, "Getting local sealing manifest", v8, 2u);
  }
...
+ (id)getStringFromCert:(id)a3 WithTag:(unint64_t)a4 AndOID:(id)a5
{
  ...
  while (!sub_1D140C080((unint64_t *)&v49, v44))
  {
    objc_msgSend_valueWithBytes_objCType_(MEMORY[0x1E0CB3B18], v9, (uint64_t)v44, (uint64_t)"{?=Q{?=*Q}}");
...
LABEL_15:
    ...
    {
      if (!sub_1D140C054((unint64_t *)&v46, v48))
      {
        while (!sub_1D140C080(v48, v44))
        {
          objc_msgSend_valueWithBytes_objCType_(MEMORY[0x1E0CB3B18], v28, (uint64_t)v44, (uint64_t)"{?=Q{?=*Q}}");
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = v43;
        v51 = v27;
        _os_log_error_impl(&dword_1D1401000, v32, OS_LOG_TYPE_ERROR, "Failed to parse node in cert chain data = %@", buf, 0xCu);
      }
    }
...
+ (id)getData:(id)a3 instance:(id)a4
{
  ...
  CFDictionarySetValue(Mutable, CFSTR("VerifyData"), (const void *)*MEMORY[0x1E0C9AE50]);
  if (v6)
  ...
  if (v8)
  {
    CFDictionarySetValue(Mutable, CFSTR("VerifyData"), (const void *)*MEMORY[0x1E0C9AE40]);
    if (v6)
...
+ (id)getDataPayload:(id)a3 instance:(id)a4
{
  ...
  sub_1D140BB3C(v14, v18, (uint64_t)v42);
  if ((_DWORD)v19)
  {
    v25 = v19;
    handleForCategory();
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      sub_1D140CAC4(v25, v26, v27, v28, v29, v30, v31, v32);
    goto LABEL_13;
  }
  v20 = sub_1D140BAD0((uint64_t)v42, (uint64_t)&v40);
  if ((_DWORD)v20)
  {
    v33 = v20;
    handleForCategory();
    v26 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      sub_1D140CA60(v33, v26, v34, v35, v36, v37, v38, v39);
LABEL_13:
...
LABEL_14:
  ...
  objc_msgSend_dataWithBytes_length_(MEMORY[0x1E0C99D50], v21, v40, v41);
...
+ (BOOL)isDcSignedSealingManifest:(id *)a3
{
  ...
  v6 = (void *)objc_msgSend_initWithBytes_length_(v4, v5, (uint64_t)&unk_1D140E911, 3);
  objc_msgSend_predicateWithFormat_(MEMORY[0x1E0CB3880], v7, (uint64_t)CFSTR("SELF MATCHES %@"), v8, CFSTR("FDR-SS-DC.*"));
  ...
  v24 = sub_1D140BC24(v19, v23, (uint64_t)v56);
  if ((_DWORD)v24)
  {
    objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], v25, (uint64_t)CFSTR("Failed to parse cert as img4; stat: %d"),
      v26,
      v24);
LABEL_14:
  ...
  v27 = sub_1D140C054((unint64_t *)&v56[18] + 1, (unint64_t *)&v50);
  if ((_DWORD)v27)
  {
    objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], v28, (uint64_t)CFSTR("Failed to parse cert chain; stat: %d"),
      v29,
      v27);
    goto LABEL_14;
  }
  objc_msgSend_getStringFromCert_WithTag_AndOID_(CRFDRUtils, v28, v50, v51, 6, v6);
  ...
  if (v30 && objc_msgSend_count(v30, v31, v32, v33))
  {
    ...
    if (os_log_type_enabled((os_log_t)a3, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v55 = v34;
      _os_log_impl(&dword_1D1401000, (os_log_t)a3, OS_LOG_TYPE_DEFAULT, "Parsed the following common names from cert in seal: %@", buf, 0xCu);
    }
...
LABEL_16:
  ...
  if (a3)
  {
    ...
    v47 = *MEMORY[0x1E0D182F8];
    v52 = *MEMORY[0x1E0CB2D50];
    v53 = v43;
    objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v45, (uint64_t)&v53, (uint64_t)&v52, 1);
...
+ (BOOL)isDcSignedDataClass:(id)a3 error:(id *)a4
{
  ...
  v8 = (void *)objc_msgSend_initWithBytes_length_(v6, v7, (uint64_t)&unk_1D140E911, 3);
  objc_msgSend_predicateWithFormat_(MEMORY[0x1E0CB3880], v9, (uint64_t)CFSTR("SELF MATCHES %@"), v10, CFSTR("FDR-CA\\d{1,4}-ROOT-DC.*"));
  ...
  if (!v13)
  {
    objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], v14, (uint64_t)CFSTR("Cannot copy %@ data from device"), v15, v5);
LABEL_15:
    v43 = (const __CFString *)objc_claimAutoreleasedReturnValue();
    v41 = 0;
    if (!v43)
  ...
  sub_1D140BB3C(v21, v25, (uint64_t)v61);
  if ((_DWORD)v26)
  {
...
LABEL_14:
  ...
  v29 = sub_1D140C054((unint64_t *)&v61[18] + 1, (unint64_t *)&v53);
  if ((_DWORD)v29)
  {
    v44 = (void *)MEMORY[0x1E0CB3940];
    v52 = v29;
  ...
  objc_msgSend_getStringFromCert_WithTag_AndOID_(CRFDRUtils, v27, v53, v54, 6, v8);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  v34 = v30;
  if (v30 && objc_msgSend_count(v30, v31, v32, v33))
  {
    ...
    if (os_log_type_enabled((os_log_t)a4, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v59 = 2112;
      v60 = v34;
      _os_log_impl(&dword_1D1401000, (os_log_t)a4, OS_LOG_TYPE_DEFAULT, "Parsed the following common names from cert in %@: %@", buf, 0x16u);
    }
...
LABEL_17:
  ...
  if (a4)
  {
    ...
    v49 = *MEMORY[0x1E0D182F8];
    v55 = *MEMORY[0x1E0CB2D50];
    v56 = v43;
    objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v47, (uint64_t)&v56, (uint64_t)&v55, 1);
...
+ (BOOL)isDcSignedCombinedDataClass:(id)a3 error:(id *)a4
{
  ...
  v9 = (void *)objc_msgSend_initWithBytes_length_(v7, v8, (uint64_t)&unk_1D140E911, 3);
  objc_msgSend_predicateWithFormat_(MEMORY[0x1E0CB3880], v10, (uint64_t)CFSTR("SELF MATCHES %@"), v11, CFSTR("FDR-CA\\d{1,4}-ROOT-DC.*"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v15)
  {
    objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], v16, (uint64_t)CFSTR("Cannot copy %@ manifest from device"), v17, v6);
LABEL_15:
  ...
  v28 = sub_1D140BC24(v23, v27, (uint64_t)v63);
  if ((_DWORD)v28)
  {
...
LABEL_14:
  ...
  v31 = sub_1D140C054((unint64_t *)&v63[18] + 1, (unint64_t *)&v55);
  if ((_DWORD)v31)
  {
    v46 = (void *)MEMORY[0x1E0CB3940];
    v54 = (uint64_t)v31;
  ...
  objc_msgSend_getStringFromCert_WithTag_AndOID_(CRFDRUtils, v29, v55, v56, 6, v9);
...
LABEL_17:
  ...
  if (a4)
  {
    ...
    v51 = *MEMORY[0x1E0D182F8];
    v57 = *MEMORY[0x1E0CB2D50];
    v58 = v45;
    objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v49, (uint64_t)&v58, (uint64_t)&v57, 1);
...
LABEL_15:
        ...
        {
          isDcSignedCombinedDataClass_error = objc_msgSend_isDcSignedCombinedDataClass_error_(CRFDRUtils, v16, (uint64_t)v6, (uint64_t)a4);
        }
        else
        {
          if (objc_msgSend_isEqualToString_(v6, v16, (uint64_t)CFSTR("SrvP"), v17))
          {
            objc_msgSend_isServicePartWithError_(CRFDRUtils, v19, (uint64_t)a4, v20);
            v21 = (void *)objc_claimAutoreleasedReturnValue();
            v24 = v21;
            if (v21)
              isEqual = objc_msgSend_isEqual_(v21, v22, (uint64_t)CFSTR("0"), v23);
            else
              isEqual = 0;

            goto LABEL_24;
          }
          isDcSignedCombinedDataClass_error = objc_msgSend_isDcSignedDataClass_error_(CRFDRUtils, v19, (uint64_t)v6, (uint64_t)a4);
        }
...
LABEL_10:
      ...
      v9 = *MEMORY[0x1E0D182F8];
      objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], a2, (uint64_t)CFSTR("Component %d is not supported for authorized repair for this device"), (uint64_t)a4, v5, *MEMORY[0x1E0CB2D50]);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v27[0] = v10;
      objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v11, (uint64_t)v27, (uint64_t)&v26, 1);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)isServicePartWithError:(id *)a3
{
  ...
  {
    if ((objc_msgSend_readFDRDataFromEANWithDataClass_outData_stripPadding_(v4, v8, (uint64_t)CFSTR("seal"), (uint64_t)&v49, 1) & 1) != 0)
    {
      if (v49)
      {
        handleForCategory();
        ...
        {
          *(_WORD *)v44 = 0;
          _os_log_impl(&dword_1D1401000, v14, OS_LOG_TYPE_DEFAULT, "Local Sealing manifest fetch sucessful", v44, 2u);
        }

        v15 = AMFDRSealingManifestCopyDataClassesInstancesAndProperties();
        v12 = 0;
        v9 = v45;
        if (v15 && (v19 = v48) != 0 && v47)
        {
          v11 = 0;
          v10 = 0;
          if (v46)
          {
            v11 = v46;
            v12 = v47;
            v20 = objc_msgSend_count(v47, v16, v17, v18);
        ...
        if (!v9)
        {
          ...
          v39 = *MEMORY[0x1E0D182F8];
          v50 = *MEMORY[0x1E0CB2D50];
          v51 = CFSTR("DataInstances and Classes count mismatch");
          objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v37, (uint64_t)&v51, (uint64_t)&v50, 1);
          v40 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend_errorWithDomain_code_userInfo_(v38, v41, v39, -28, v40);
          v9 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v32 = *MEMORY[0x1E0D182F8];
      v52 = *MEMORY[0x1E0CB2D50];
      v53[0] = CFSTR("Local Sealing manifest fetch failed");
      objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v33, (uint64_t)v53, (uint64_t)&v52, 1);
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend_errorWithDomain_code_userInfo_(v31, v35, v32, -28, v34);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)findUnsealedDataWithError:(id *)a3
{
  ...
  if (v21)
  {
    ...
    if (AMFDRSealingManifestCopyDataClassesInstancesAndProperties())
    {
      ...
      v36 = *MEMORY[0x1E0D182F8];
      v48 = *MEMORY[0x1E0CB2D50];
      v49 = CFSTR("Number of data classes and instances mismatches");
      objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v22, (uint64_t)&v49, (uint64_t)&v48, 1);
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend_errorWithDomain_code_userInfo_(v35, v37, v36, -42, v24);
      v38 = (id)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v28 = (void *)MEMORY[0x1E0CB35C8];
      v29 = *MEMORY[0x1E0D182F8];
      v50 = *MEMORY[0x1E0CB2D50];
      objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], v22, (uint64_t)CFSTR("Failed to decode sealing manifest: %@"), v23, 0);
      v30 = v21;
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      v51 = v31;
      objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v32, (uint64_t)&v51, (uint64_t)&v50, 1);
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend_errorWithDomain_code_userInfo_(v28, v34, v29, -28, v33);
      v38 = (id)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    v26 = *MEMORY[0x1E0D182F8];
    v52 = *MEMORY[0x1E0CB2D50];
    v53[0] = CFSTR("Failed to get local sealing manifest");
    objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v20, (uint64_t)v53, (uint64_t)&v52, 1);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_errorWithDomain_code_userInfo_(v25, v27, v26, -28, v24);
    v38 = (id)objc_claimAutoreleasedReturnValue();
  }
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v47 = v45;
    _os_log_impl(&dword_1D1401000, v42, OS_LOG_TYPE_DEFAULT, "Unsealed: %@", buf, 0xCu);
  }
...
+ (id)findUnsealedDataWithKey:(id)a3 error:(id *)a4
{
  ...
  v5 = a3;
  objc_msgSend_array(MEMORY[0x1E0C99D20], v6, v7, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__createFDRLocal(a1, v10, v11, v12);
  if (objc_msgSend_containsObject_(&unk_1E9223278, v13, (uint64_t)v5, v14))
  {
    ...
    if (v18)
    {
      ...
      if (v23)
      {
        ...
        v56[0] = v18;
        objc_msgSend_arrayWithObjects_count_(MEMORY[0x1E0C99D20], v22, (uint64_t)v56, 1);
        ...
        v55 = v23;
        objc_msgSend_arrayWithObjects_count_(MEMORY[0x1E0C99D20], v30, (uint64_t)&v55, 1);
        v31 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_23:
  ...
  objc_msgSend_setWithArray_(MEMORY[0x1E0C99E20], v35, (uint64_t)v18, v36);
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setWithArray_(MEMORY[0x1E0C99E20], v37, (uint64_t)v19, v38);
  v34 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_8:
  ...
  if (objc_msgSend_count(v28, v41, v42, v43))
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v53 = 2112;
      v54 = v28;
      _os_log_impl(&dword_1D1401000, v44, OS_LOG_TYPE_DEFAULT, "Unsealed %@: %@", buf, 0x16u);
    }
...
+ (void)fixUpPseudoMSRk:(id)a3 missingLiveData:(id)a4
{
  ...
  _os_log_impl(&dword_1D1401000, v13, OS_LOG_TYPE_DEFAULT, v14, (uint8_t *)v27, 2u);
LABEL_9:
  ...
  if (!v16 || v27[0])
  {
    ...
    v19 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      sub_1D140CF20(v27, v19, v21, v22, v23, v24, v25, v26);
  }
  else
  {
    v28[0] = v16;
    objc_msgSend_arrayWithObjects_count_(MEMORY[0x1E0C99D20], v17, (uint64_t)v28, 1);
    v19 = objc_claimAutoreleasedReturnValue();
...
+ (BOOL)queryDeviceStagedSealedFromEAN:(BOOL)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    ...
    if (objc_msgSend_readFDRDataFromEANWithDataClass_outData_stripPadding_(v10, v11, (uint64_t)CFSTR("seal"), (uint64_t)&v22, 1))v12 = v22 == 0;
    else
      v12 = 1;
    if (v12)
    {
  ...
  if (AMFDRCreateTypeWithOptions())
  {
    ...
    if ((v14 & 1) != 0)
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v26 = 0;
        _os_log_impl(&dword_1D1401000, v13, OS_LOG_TYPE_DEFAULT, "SrvT: %@", buf, 0xCu);
      }
...
LABEL_25:
  ...
  if (a4)
  {
    ...
    v18 = *MEMORY[0x1E0D182F8];
    v23 = *MEMORY[0x1E0CB2D50];
    v24 = CFSTR("Query staged state failed");
    objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x1E0C99D80], v16, (uint64_t)&v24, (uint64_t)&v23, 1);
...
+ (id)extractComponentsAndIdentifiers:(id)a3
{
  ...
  v3 = a3;
  v56 = (id)objc_opt_new();
  v4 = objc_alloc(MEMORY[0x1E0CB38E8]);
      ...
      do
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 134217984;
          v63 = v24;
          _os_log_impl(&dword_1D1401000, v20, OS_LOG_TYPE_DEFAULT, "number of ranges:%ld", buf, 0xCu);
        }
