...
- (int64_t)copyComponentStatus
{
  ...
  if (objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E0D18308], a2, (uint64_t)CFSTR("NBCl"), v2))
  {
...
LABEL_15:
        ...
        {
          *(_WORD *)v48 = 0;
          _os_log_impl(&dword_1D1401000, v46, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", v48, 2u);
        }
