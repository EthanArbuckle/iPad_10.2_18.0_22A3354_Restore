...
- (int64_t)copyComponentStatus
{
  ...
  v2 = self;
  objc_sync_enter(v2);
  if ((objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E0D18308], v3, (uint64_t)CFSTR("CmCl"), v4) & 1) != 0)
  {
...
LABEL_22:
          ...
          {
            LOWORD(v56) = 0;
            _os_log_impl(&dword_1D1401000, v47, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", (uint8_t *)&v56, 2u);
          }
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_DEFAULT))
      {
        v56 = 138412290;
        v57 = v5;
        _os_log_impl(&dword_1D1401000, v48, OS_LOG_TYPE_DEFAULT, "FDR Validation status:%@", (uint8_t *)&v56, 0xCu);
      }
...
- (id)getCmClValidationStatus
{
  ...
  isFDRDataClassSupported = objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E0D18308], a2, (uint64_t)CFSTR("CmCl"), v2);
...
LABEL_7:
  ...
  v5 = sub_1D1407960(isFDRDataClassSupported, v4);
  if (!v5)
  {
    handleForCategory();
  ...
  CFProperty = (void *)IORegistryEntryCreateCFProperty(v5, CFSTR("CmClValidationStatus"), (CFAllocatorRef)*MEMORY[0x1E0C9AE00], 0);
  return CFProperty;
}
