...
+ (BOOL)isVeridianFWUpdateRequired
{
  ...
  {
    objc_msgSend_sharedDataAccessor(MEMORY[0x1E0D46970], v7, v8, v9);
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v37 = 1024;
        v38 = updated != 0;
        _os_log_impl(&dword_1D1401000, v17, OS_LOG_TYPE_DEFAULT, "isVeridianUpdateRequired :%@:%d", buf, 0x12u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        sub_1D140D16C((uint64_t)v13, v17, v18, v19, v20, v21, v22, v23);
      v24 = 0;
      v25 = 1;
    }
...
+ (BOOL)isVeridianFWUpdateRequiredLite
{
  ...
  v32 = 0;
  objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], a2, (uint64_t)CFSTR("%s/active"), v2, "/private/preboot");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v31 = 0;
  objc_msgSend_stringWithContentsOfFile_encoding_error_(MEMORY[0x1E0CB3940], v4, (uint64_t)v3, 1, &v31);
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      sub_1D140D1D0((uint64_t)v3, (uint64_t)v8, v20);
    goto LABEL_12;
  }
  objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], v6, (uint64_t)CFSTR("/private/preboot/%@"), v7, v5);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v34 = v9;
    _os_log_impl(&dword_1D1401000, v10, OS_LOG_TYPE_DEFAULT, "completeFWPath :%@", buf, 0xCu);
  }
  ...
  if (!v9)
  {
    ...
    v20 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      sub_1D140D248(v20, v23, v24, v25, v26, v27, v28, v29);
LABEL_12:
    v17 = 0;
    v9 = 0;
    v19 = 1;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v35 = 1024;
    v36 = v21;
    _os_log_impl(&dword_1D1401000, v20, OS_LOG_TYPE_DEFAULT, "isVeridianUpdateRequired :%@:%d", buf, 0x12u);
...
{
  return (id)MEMORY[0x1E0DE7D20](CRFDRUtils, sel_getDataPayload_instance_, a3, a4);
}

+ (id)getDataPayloadForDataClass:(id)a3
{
  return (id)MEMORY[0x1E0DE7D20](CRFDRUtils, sel_getDataPayload_instance_, a3, 0);
}
...
+ (id)getSsrBootIntentWithError:(id *)a3
{
  ...
  v42 = 0;
  objc_msgSend_readNVRAMValueForKey_error_(MEMORY[0x1E0D18310], a2, (uint64_t)CFSTR("diagnostic-boot-intent"), (uint64_t)&v42);
  ...
  if (!v8)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      sub_1D140D2B0((uint64_t)v5, v7, v9);
LABEL_7:
    v10 = 0;
    v11 = 0;
    v12 = 0;
LABEL_8:
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v44 = v4;
    _os_log_impl(&dword_1D1401000, v7, OS_LOG_TYPE_DEFAULT, "readNVRAMValueForKey value: %@", buf, 0xCu);
  }
  ...
  {
    v41 = 0;
    objc_msgSend_JSONObjectWithData_options_error_(MEMORY[0x1E0CB36D8], v17, (uint64_t)v4, 0, &v41);
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
        sub_1D140D32C((uint64_t)v5, v7, v35, v36, v37, v38, v39, v40);
      goto LABEL_7;
    }
...
LABEL_10:
          ...
          objc_msgSend_decryptWiFiCredDictFromCredentialsData_(MEMORY[0x1E0D18320], v28, (uint64_t)v7, v29);
...
{
  return MEMORY[0x1E0DE7D20](CRFDRUtils, sel_queryDeviceStagedSealedFromEAN_error_, 0, 0);
}
