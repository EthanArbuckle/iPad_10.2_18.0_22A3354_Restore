...
void __39__UTType_DOCNode__doc_conformsToFolder__block_invoke()
{
  id v0;
  void *v1;

  v0 = objc_alloc_init(MEMORY[0x24BDBCE40]);
  v1 = (void *)doc_conformsToFolder__folderUTICache;
  doc_conformsToFolder__folderUTICache = (uint64_t)v0;

}

void __55__UTType_DOCAdditions__doc_contentTypesForIdentifiers___block_invoke(uint64_t a1, uint64_t a2)
{
  void *v3;
  void *v4;
