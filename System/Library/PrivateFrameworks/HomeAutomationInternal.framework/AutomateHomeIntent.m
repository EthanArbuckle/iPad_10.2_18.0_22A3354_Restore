...
{
  return (NSString *)sub_2208DB9D8(self, (uint64_t)a2, (void (*)(void))AutomateHomeIntent.description.getter);
}
...
- (AutomateHomeIntent)init
{
  ...
  return -[AutomateHomeIntent init](&v3, sel_init);
}
...
- (AutomateHomeIntent)initWithCoder:(id)a3
{
  ...
  return -[AutomateHomeIntent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
...
- (AutomateHomeIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v9 = -[AutomateHomeIntent initWithIdentifier:backingStore:](&v11, sel_initWithIdentifier_backingStore_, v7, a4);
...
- (AutomateHomeIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v10 = -[AutomateHomeIntent initWithDomain:verb:parametersByName:](&v12, sel_initWithDomain_verb_parametersByName_, v7, v8, v9);
