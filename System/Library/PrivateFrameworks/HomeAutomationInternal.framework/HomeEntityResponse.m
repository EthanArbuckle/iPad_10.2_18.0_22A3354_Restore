...
- (BOOL)isEqual:(id)a3
{
  return sub_220A00F88(self, (uint64_t)a2, (uint64_t)a3, (uint64_t (*)(_OWORD *))HomeEntityResponse.isEqual(_:));
}

- (NSString)description
{
  return (NSString *)sub_2208DB9D8(self, (uint64_t)a2, (void (*)(void))HomeEntityResponse.description.getter);
}
...
- (HomeEntityResponse)initWithCoder:(id)a3
{
  ...
  return -[HomeEntityResponse initWithCoder:](&v5, sel_initWithCoder_, a3);
}
