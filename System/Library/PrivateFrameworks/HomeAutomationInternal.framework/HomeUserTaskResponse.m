...
- (BOOL)isEqual:(id)a3
{
  return sub_220A00F88(self, (uint64_t)a2, (uint64_t)a3, (uint64_t (*)(_OWORD *))HomeUserTaskResponse.isEqual(_:));
}

- (NSString)description
{
  return (NSString *)sub_2208DB9D8(self, (uint64_t)a2, (void (*)(void))HomeUserTaskResponse.description.getter);
}
...
- (HomeUserTaskResponse)initWithCoder:(id)a3
{
  ...
  return -[HomeUserTaskResponse initWithCoder:](&v5, sel_initWithCoder_, a3);
}
