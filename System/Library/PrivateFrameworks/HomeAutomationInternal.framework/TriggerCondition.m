...
{
  return (NSString *)sub_2208DB9D8(self, (uint64_t)a2, (void (*)(void))TriggerCondition.description.getter);
}
...
- (TriggerCondition)initWithCoder:(id)a3
{
  ...
  return -[TriggerCondition initWithCoder:](&v5, sel_initWithCoder_, a3);
}
