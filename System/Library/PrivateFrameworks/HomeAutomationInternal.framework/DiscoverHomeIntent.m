...
- (DiscoverHomeIntent)init
{
  ...
  return -[DiscoverHomeIntent init](&v3, sel_init);
}
...
- (DiscoverHomeIntent)initWithCoder:(id)a3
{
  ...
  return -[DiscoverHomeIntent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
...
- (DiscoverHomeIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v9 = -[DiscoverHomeIntent initWithIdentifier:backingStore:](&v11, sel_initWithIdentifier_backingStore_, v7, a4);
...
- (DiscoverHomeIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v10 = -[DiscoverHomeIntent initWithDomain:verb:parametersByName:](&v12, sel_initWithDomain_verb_parametersByName_, v7, v8, v9);
