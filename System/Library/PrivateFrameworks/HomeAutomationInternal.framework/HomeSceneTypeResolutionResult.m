...
- (HomeSceneTypeResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  id v6;
  void *v7;
  HomeSceneTypeResolutionResult *v8;
  HomeSceneTypeResolutionResult *v9;
  objc_super v11;
  ...
  v8 = -[HomeSceneTypeResolutionResult initWithJSONDictionary:forIntent:](&v11, sel_initWithJSONDictionary_forIntent_, v7, v6);
