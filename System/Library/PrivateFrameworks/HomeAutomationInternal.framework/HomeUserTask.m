...
- (BOOL)isEqual:(id)a3
{
  return sub_220A00F88(self, (uint64_t)a2, (uint64_t)a3, (uint64_t (*)(_OWORD *))HomeUserTask.isEqual(_:));
}

- (NSString)description
{
  return (NSString *)sub_2208DB9D8(self, (uint64_t)a2, (void (*)(void))HomeUserTask.description.getter);
}
...
- (HomeUserTask)initWithCoder:(id)a3
{
  ...
  return -[HomeUserTask initWithCoder:](&v5, sel_initWithCoder_, a3);
}
