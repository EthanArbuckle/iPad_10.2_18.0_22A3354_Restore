...
- (HomeEntityTypeResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  id v6;
  void *v7;
  HomeEntityTypeResolutionResult *v8;
  HomeEntityTypeResolutionResult *v9;
  objc_super v11;
  ...
  v8 = -[HomeEntityTypeResolutionResult initWithJSONDictionary:forIntent:](&v11, sel_initWithJSONDictionary_forIntent_, v7, v6);
