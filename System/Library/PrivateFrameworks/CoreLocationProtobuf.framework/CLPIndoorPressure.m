...
- (id)description
{
  ...
  -[CLPIndoorPressure description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CLPIndoorPressure dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) == 0)
  {
    if ((*(_BYTE *)&self->_has & 2) == 0)
      goto LABEL_3;
LABEL_7:
    *(float *)&v4 = self->_pressure;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("pressure"));
...
LABEL_3:
  ...
  {
LABEL_4:
    *(float *)&v4 = self->_temperature;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("temperature"));
...
LABEL_3:
  ...
  {
LABEL_4:
    v4[5] = LODWORD(self->_temperature);
    *((_BYTE *)v4 + 24) |= 4u;
  }
LABEL_5:
...
LABEL_16:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_pressure != *((float *)v4 + 4))
      goto LABEL_16;
  }
  ...
  if ((*(_BYTE *)&self->_has & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 4) == 0 || self->_temperature != *((float *)v4 + 5))
      goto LABEL_16;
    v5 = 1;
  }
LABEL_17:
