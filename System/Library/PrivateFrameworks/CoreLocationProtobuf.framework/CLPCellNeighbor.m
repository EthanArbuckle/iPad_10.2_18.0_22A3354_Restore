...
- (id)description
{
  ...
  -[CLPCellNeighbor description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CLPCellNeighbor dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_26:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_psc != *((_DWORD *)v4 + 3))
      goto LABEL_26;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 8) == 0 || self->_rssi != *((_DWORD *)v4 + 5))
      goto LABEL_26;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_ecn0 != *((_DWORD *)v4 + 2))
      goto LABEL_26;
  }
  ...
  if ((*(_BYTE *)&self->_has & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 4) == 0 || self->_rscp != *((_DWORD *)v4 + 4))
      goto LABEL_26;
    v5 = 1;
  }
LABEL_27:
