...
- (id)description
{
  ...
  -[CLPLOGENTRYVISIONLSLLocationCoordinate description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CLPLOGENTRYVISIONLSLLocationCoordinate dictionaryRepresentation](self, "dictionaryRepresentation");
