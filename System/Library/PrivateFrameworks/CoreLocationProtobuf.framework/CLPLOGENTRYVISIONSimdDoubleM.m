...
- (void)dealloc
{
  ...
  -[CLPLOGENTRYVISIONSimdDoubleM dealloc](&v3, sel_dealloc);
}
...
{
  $A57E80F8F7F5C5FFA4899556F12E1D96 *p_values;
  unint64_t count;
  void *v6;
  uint64_t v7;
  void *v8;
...
- (id)description
{
  ...
  -[CLPLOGENTRYVISIONSimdDoubleM description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CLPLOGENTRYVISIONSimdDoubleM dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v7 = a3;
  if (-[CLPLOGENTRYVISIONSimdDoubleM valuesCount](self, "valuesCount"))
  {
    objc_msgSend(v7, "clearValues");
    v4 = -[CLPLOGENTRYVISIONSimdDoubleM valuesCount](self, "valuesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[CLPLOGENTRYVISIONSimdDoubleM valuesAtIndex:](self, "valuesAtIndex:", i);
