...
{
  -[NSMutableArray removeAllObjects](self->_appLocations, "removeAllObjects");
}
...
- (void)addAppLocation:(id)a3
{
  ...
  -[NSMutableArray addObject:](appLocations, "addObject:", v4);

}

- (unint64_t)appLocationsCount
{
  return -[NSMutableArray count](self->_appLocations, "count");
}

- (id)appLocationAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_appLocations, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[CLPAppCollectionRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CLPAppCollectionRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_appLocations, "count"))
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_appLocations, "count"));
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("appLocation"));
  }
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (!self->_meta)
    -[CLPAppCollectionRequest writeTo:].cold.1();
  v5 = v4;
...
- (void)copyTo:(id)a3
{
  ...
  if (-[CLPAppCollectionRequest appLocationsCount](self, "appLocationsCount"))
  {
    objc_msgSend(v8, "clearAppLocations");
    v4 = -[CLPAppCollectionRequest appLocationsCount](self, "appLocationsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[CLPAppCollectionRequest appLocationAtIndex:](self, "appLocationAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addAppLocation:", v7);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addAppLocation:", v13);
...
- (unint64_t)hash
{
  ...
  v4 = -[NSMutableArray hash](self->_appLocations, "hash") ^ v3;
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[CLPAppCollectionRequest addAppLocation:](self, "addAppLocation:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
...
{
  objc_storeStrong((id *)&self->_appLocations, a3);
}
