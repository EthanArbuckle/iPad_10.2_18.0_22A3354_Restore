...
- (void)dealloc
{
  ...
  -[CLPLOGENTRYVISIONVLVectorfM dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  -[CLPLOGENTRYVISIONVLVectorfM description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CLPLOGENTRYVISIONVLVectorfM dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v7 = a3;
  if (-[CLPLOGENTRYVISIONVLVectorfM valuesCount](self, "valuesCount"))
  {
    objc_msgSend(v7, "clearValues");
    v4 = -[CLPLOGENTRYVISIONVLVectorfM valuesCount](self, "valuesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[CLPLOGENTRYVISIONVLVectorfM valuesAtIndex:](self, "valuesAtIndex:", i);
