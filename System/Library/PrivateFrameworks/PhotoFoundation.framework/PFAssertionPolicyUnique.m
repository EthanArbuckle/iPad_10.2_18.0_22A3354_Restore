...
- (PFAssertionPolicyUnique)init
{
  ...
  v2 = -[PFAssertionPolicyComposite init](&v6, sel_init);
...
- (void)notifyAssertion:(id)a3
{
  ...
  objc_msgSend(v5, "stringWithFormat:", CFSTR("%@:%lu"), v6, objc_msgSend(v4, "lineNumber"));
  ...
  if ((-[NSMutableSet containsObject:](v8->_signatures, "containsObject:", v7) & 1) == 0)
  {
    ...
    -[PFAssertionPolicyComposite notifyAssertion:](&v9, sel_notifyAssertion_, v4);
  }
  objc_sync_exit(v8);
