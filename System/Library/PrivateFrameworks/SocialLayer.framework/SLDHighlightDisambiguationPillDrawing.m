...
- (SLDHighlightDisambiguationPillDrawing)initWithStyle:(id)a3 tag:(id)a4 forRemote:(BOOL)a5
{
  id v9;
  id v10;
  SLDHighlightDisambiguationPillDrawing *v11;
  SLDHighlightDisambiguationPillDrawing *v12;
  SLDHighlightDisambiguationPillSlotTag *v13;
  NSObject *p_super;
  objc_super v16;
  ...
  v11 = -[SLDHighlightDisambiguationPillDrawing init](&v16, sel_init);
  v12 = v11;
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(p_super, OS_LOG_TYPE_ERROR))
        -[SLDHighlightDisambiguationPillDrawing initWithStyle:tag:forRemote:].cold.1((uint64_t)v12, (uint64_t)v10, p_super);
    }
...
{
  SLDHighlightDisambiguationPillRenderer *v6;
  void *v7;
  void *v8;
  SLDHighlightDisambiguationPillRenderer *v9;
  SLDHighlightDisambiguationPillRenderer *v10;

  if (-[SLDHighlightDisambiguationPillDrawing forRemote](self, "forRemote", a4.x, a4.y))
  {
    v6 = [SLDHighlightDisambiguationPillRenderer alloc];
    -[SLDHighlightDisambiguationPillDrawing slotStyle](self, "slotStyle");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SLDHighlightDisambiguationPillDrawing tag](self, "tag");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = -[SLDHighlightDisambiguationPillRenderer initWithStyle:tag:](v6, "initWithStyle:tag:", v7, v8);

    v9 = v10;
    if (v10)
    {
      -[SLDHighlightDisambiguationPillRenderer renderInContext:](v10, "renderInContext:", a3);
      v9 = v10;
    }
...
- (CGSize)drawingSize
{
  SLHighlightDisambiguationPillMetrics *v3;
  void *v4;
  void *v5;
  ...
  v6 = -[SLHighlightDisambiguationPillMetrics initWithSlotStyle:tag:](v3, "initWithSlotStyle:tag:", v4, v5);

  -[SLHighlightDisambiguationPillMetrics pillSize](v6, "pillSize");
  v8 = v7;
  v10 = v9;
...
- (void)initWithStyle:(uint64_t)a1 tag:(uint64_t)a2 forRemote:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_error_impl(&dword_199EFF000, log, OS_LOG_TYPE_ERROR, "[SLDHighlightDisambiguationPillDrawing %p] Tried to initialize with a tag of the wrong type: %@", (uint8_t *)&v3, 0x16u);
}
