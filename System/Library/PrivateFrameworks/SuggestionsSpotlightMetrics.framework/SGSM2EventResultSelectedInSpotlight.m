...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("EventResultSelectedInSpotlight");
}
...
- (id)description
{
  ...
  -[SGSM2EventResultSelectedInSpotlight description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGSM2EventResultSelectedInSpotlight dictionaryRepresentation](self, "dictionaryRepresentation");
