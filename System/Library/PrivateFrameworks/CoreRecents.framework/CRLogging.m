...
+ (OS_os_log)client
{
  if (client_cn_once_token_2 != -1)
    dispatch_once(&client_cn_once_token_2, &__block_literal_global_3);
...
os_log_t __16__CRLogging_log__block_invoke()
{
  ...
  result = os_log_create("com.apple.corerecents", "sync");
...
os_log_t __19__CRLogging_client__block_invoke()
{
  ...
  result = os_log_create("com.apple.corerecents", "client");
