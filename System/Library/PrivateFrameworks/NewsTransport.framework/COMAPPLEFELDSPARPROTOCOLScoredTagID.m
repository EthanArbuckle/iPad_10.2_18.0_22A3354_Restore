...
- (id)description
{
  ...
  -[COMAPPLEFELDSPARPROTOCOLScoredTagID description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[COMAPPLEFELDSPARPROTOCOLScoredTagID dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  tagId = self->_tagId;
  v5 = (float *)a3;
  objc_msgSend(v5, "setTagId:", tagId);
  v5[2] = self->_score;
