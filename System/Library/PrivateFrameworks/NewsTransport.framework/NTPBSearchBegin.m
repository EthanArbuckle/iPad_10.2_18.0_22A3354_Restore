...
- (id)description
{
  ...
  -[NTPBSearchBegin description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBSearchBegin dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    {
      v5 = off_24CD50D40[searchLocation];
    }
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("search_location"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 36) & 1) == 0 || self->_searchLocation != *((_DWORD *)v4 + 8))
      goto LABEL_13;
  }
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    v3 = 2654435761 * self->_searchLocation;
  else
    v3 = 0;
