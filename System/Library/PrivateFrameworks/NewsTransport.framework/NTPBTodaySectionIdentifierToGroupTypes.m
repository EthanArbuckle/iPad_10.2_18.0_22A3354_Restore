...
- (void)dealloc
{
  ...
  -[NTPBTodaySectionIdentifierToGroupTypes dealloc](&v3, sel_dealloc);
}
...
{
  $27AAA0BB14FCB8642CC83DAEBE69EA4A *p_groupTypes;
  unint64_t count;
  void *v6;
  uint64_t v7;
  void *v8;
...
- (id)description
{
  ...
  -[NTPBTodaySectionIdentifierToGroupTypes description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBTodaySectionIdentifierToGroupTypes dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (personalizationSectionIdentifier)
    objc_msgSend(v3, "setObject:forKey:", personalizationSectionIdentifier, CFSTR("personalization_section_identifier"));
  p_groupTypes = &self->_groupTypes;
  if (self->_groupTypes.count)
  {
    ...
    if (p_groupTypes->count)
    {
      ...
      do
      {
        v9 = p_groupTypes->list[v8];
        if (v9 >= 0x28)
        {
          objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), p_groupTypes->list[v8]);
          v10 = (void *)objc_claimAutoreleasedReturnValue();
        }
        else
        {
          v10 = *(&off_24CD535B0 + v9);
        }
    ...
    objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("group_types"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_personalizationSectionIdentifier, "copyWithZone:", a3);
  v7 = (void *)v5[4];
  v5[4] = v6;
...
- (unint64_t)hash
{
  ...
  v2 = -[NSString hash](self->_personalizationSectionIdentifier, "hash");
...
- (void)mergeFrom:(id)a3
{
  ...
  v5 = objc_msgSend(v4, "groupTypesCount");
  if (v5)
  {
    v6 = v5;
    for (i = 0; i != v6; ++i)
      -[NTPBTodaySectionIdentifierToGroupTypes addGroupTypes:](self, "addGroupTypes:", objc_msgSend(v8, "groupTypesAtIndex:", i));
  }
...
{
  objc_storeStrong((id *)&self->_personalizationSectionIdentifier, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_personalizationSectionIdentifier, 0);
}
