...
- (id)description
{
  ...
  -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagExpiration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagExpiration dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)v4 + 1) = self->_expireUtcTime;
    *((_BYTE *)v4 + 24) |= 1u;
  }
