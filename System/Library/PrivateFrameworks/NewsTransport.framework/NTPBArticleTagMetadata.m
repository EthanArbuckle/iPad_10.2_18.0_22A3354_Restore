...
- (id)description
{
  ...
  -[NTPBArticleTagMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBArticleTagMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    -[NTPBTagMetadata dictionaryRepresentation](channelTagMetadata, "dictionaryRepresentation");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NTPBTagMetadata copyWithZone:](self->_channelTagMetadata, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NTPBTagMetadata hash](self->_channelTagMetadata, "hash");
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[NTPBArticleTagMetadata addTopicTagMetadata:](self, "addTopicTagMetadata:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
