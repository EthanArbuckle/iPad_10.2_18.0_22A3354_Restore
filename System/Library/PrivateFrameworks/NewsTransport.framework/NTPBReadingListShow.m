...
- (id)description
{
  ...
  -[NTPBReadingListShow description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBReadingListShow dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_userAction == *((_DWORD *)v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
