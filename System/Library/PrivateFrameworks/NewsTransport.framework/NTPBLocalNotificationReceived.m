...
- (id)description
{
  ...
  -[NTPBLocalNotificationReceived description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBLocalNotificationReceived dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_localNotificationNumberReceived);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("local_notification_number_received"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_localNotificationNumberReceived == *((_DWORD *)v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
