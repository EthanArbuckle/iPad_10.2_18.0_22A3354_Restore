...
{
  -[NSMutableArray removeAllObjects](self->_trendingTopics, "removeAllObjects");
}
...
- (void)addTrendingTopics:(id)a3
{
  ...
  -[NSMutableArray addObject:](trendingTopics, "addObject:", v4);

}

- (unint64_t)trendingTopicsCount
{
  return -[NSMutableArray count](self->_trendingTopics, "count");
}

- (id)trendingTopicsAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_trendingTopics, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[NTPBTrendingLanguageConfig description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBTrendingLanguageConfig dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  trendingTopics = self->_trendingTopics;
  if (trendingTopics)
    objc_msgSend(v4, "setObject:forKey:", trendingTopics, CFSTR("trending_topics"));
  return v4;
}
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addTrendingTopics:", v13);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](languageTag, "isEqual:")))
  {
    ...
    if ((unint64_t)trendingTopics | v4[2])
      v7 = -[NSMutableArray isEqual:](trendingTopics, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_trendingTopics, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[NTPBTrendingLanguageConfig addTrendingTopics:](self, "addTrendingTopics:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
{
  objc_storeStrong((id *)&self->_trendingTopics, a3);
}
