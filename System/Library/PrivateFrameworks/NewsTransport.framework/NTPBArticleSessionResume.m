...
- (id)description
{
  ...
  -[NTPBArticleSessionResume description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBArticleSessionResume dictionaryRepresentation](self, "dictionaryRepresentation");
