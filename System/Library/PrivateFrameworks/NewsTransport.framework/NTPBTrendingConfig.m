...
- (id)description
{
  ...
  -[NTPBTrendingConfig description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBTrendingConfig dictionaryRepresentation](self, "dictionaryRepresentation");
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addLanguageConfigs:", v13);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](fallbackLanguageTag, "isEqual:")))
  {
    ...
    if ((unint64_t)languageConfigs | v4[2])
      v7 = -[NSMutableArray isEqual:](languageConfigs, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_fallbackLanguageTag, "hash");
  return -[NSMutableArray hash](self->_languageConfigs, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[NTPBTrendingConfig addLanguageConfigs:](self, "addLanguageConfigs:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
