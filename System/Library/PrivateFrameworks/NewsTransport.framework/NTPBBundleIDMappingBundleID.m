...
- (id)description
{
  ...
  -[NTPBBundleIDMappingBundleID description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBBundleIDMappingBundleID dictionaryRepresentation](self, "dictionaryRepresentation");
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v29 != v8)
          objc_enumerationMutation(v5);
        -[NTPBBundleIDMappingBundleID addTopicTags:](self, "addTopicTags:", *(_QWORD *)(*((_QWORD *)&v28 + 1) + 8 * i));
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        if (*(_QWORD *)v25 != v13)
          objc_enumerationMutation(v10);
        -[NTPBBundleIDMappingBundleID addChannelTags:](self, "addChannelTags:", *(_QWORD *)(*((_QWORD *)&v24 + 1) + 8 * j));
      }
  ...
  if (v16)
  {
    ...
    do
    {
      for (k = 0; k != v17; ++k)
      {
        if (*(_QWORD *)v21 != v18)
          objc_enumerationMutation(v15);
        -[NTPBBundleIDMappingBundleID addSectionTags:](self, "addSectionTags:", *(_QWORD *)(*((_QWORD *)&v20 + 1) + 8 * k), (_QWORD)v20);
      }
