...
- (id)description
{
  ...
  -[NTPBSessionBatch description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBSessionBatch dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (session)
  {
    -[NTPBSession dictionaryRepresentation](session, "dictionaryRepresentation");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_events, "count"));
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("events"));
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NTPBSession copyWithZone:](self->_session, "copyWithZone:", a3);
  v7 = (void *)v5[3];
  v5[3] = v6;
  ...
  v14 = -[NSData copyWithZone:](self->_identifier, "copyWithZone:", a3);
  v15 = (void *)v5[2];
  v5[2] = v14;
...
- (unint64_t)hash
{
  ...
  v3 = -[NTPBSession hash](self->_session, "hash");
  v4 = -[NSMutableArray hash](self->_events, "hash") ^ v3;
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[NTPBSessionBatch addEvents:](self, "addEvents:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
