...
- (id)description
{
  ...
  -[COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector dictionaryRepresentation](self, "dictionaryRepresentation");
