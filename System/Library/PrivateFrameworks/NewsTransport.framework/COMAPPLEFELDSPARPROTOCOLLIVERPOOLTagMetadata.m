...
LABEL_6:
  v8 = -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo copyWithZone:](self->_contentAndRelevanceInfo, "copyWithZone:", a3);
  v9 = (void *)v6[1];
  v6[1] = v8;
...
- (id)description
{
  ...
  -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_6:
  ...
  {
    -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo dictionaryRepresentation](contentAndRelevanceInfo, "dictionaryRepresentation");
...
LABEL_24:
  ...
  if ((unint64_t)contentAndRelevanceInfo | *((_QWORD *)v4 + 1))
    v6 = -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo isEqual:](contentAndRelevanceInfo, "isEqual:");
  else
    v6 = 1;
LABEL_25:
...
- (unint64_t)hash
{
  ...
  if ((has & 2) != 0)
    ...
    v19 = 0;
  return v9 ^ v4 ^ v14 ^ v19 ^ -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo hash](self->_contentAndRelevanceInfo, "hash");
}
