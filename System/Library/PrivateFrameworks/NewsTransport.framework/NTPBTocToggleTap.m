...
- (id)description
{
  ...
  -[NTPBTocToggleTap description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBTocToggleTap dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (unint64_t)hash
{
  return -[NSData hash](self->_tocExposureId, "hash");
}
