...
- (id)description
{
  ...
  -[NTPBWidgetEngagement description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBWidgetEngagement dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_WORD *)&self->_has & 0x80) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_widgetEngagementType);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("widget_engagement_type"));
  ...
  if ((has & 0x200) != 0)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v15, CFSTR("widget_section_display_rank"));
...
LABEL_11:
  ...
  objc_msgSend(v3, "setObject:forKey:", v16, CFSTR("widget_article_rank_in_section"));
...
LABEL_23:
  ...
  objc_msgSend(v3, "setObject:forKey:", v17, CFSTR("widget_article_rank"));
...
LABEL_13:
    ...
    objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("widget_article_count"));
...
LABEL_14:
  ...
  if ((v12 & 0x800) != 0)
  {
    ...
    {
      v14 = off_24CD4D590[widgetVideoPresentationReason];
    }
    objc_msgSend(v3, "setObject:forKey:", v14, CFSTR("widget_video_presentation_reason"));
  ...
  if ((v12 & 4) != 0)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v18, CFSTR("widget_article_count_in_section"));
  ...
  if ((*(_WORD *)&self->_has & 0x20) != 0)
  {
    ...
    {
      v21 = off_24CD4D5A8[widgetContentType];
    }
    objc_msgSend(v3, "setObject:forKey:", v21, CFSTR("widget_content_type"));
  ...
  if ((v25 & 1) != 0)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v26, CFSTR("content_fetch_date"));
  ...
  if ((v25 & 0x40) != 0)
  {
    ...
    {
      v28 = off_24CD4D5C0[widgetDisplayMode];
    }
    objc_msgSend(v3, "setObject:forKey:", v28, CFSTR("widget_display_mode"));
  ...
  if ((v30 & 0x100) != 0)
  {
    ...
    {
      v32 = off_24CD4D600[widgetExposureStackLocation];
    }
    objc_msgSend(v3, "setObject:forKey:", v32, CFSTR("widget_exposure_stack_location"));
  ...
  if ((v30 & 0x400) != 0)
  {
    ...
    {
      v34 = off_24CD4D630[widgetType];
    }
    objc_msgSend(v3, "setObject:forKey:", v34, CFSTR("widget_type"));
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[NTPBWidgetEngagement addOtherVisibleSections:](self, "addOtherVisibleSections:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * i), (_QWORD)v15);
      }
