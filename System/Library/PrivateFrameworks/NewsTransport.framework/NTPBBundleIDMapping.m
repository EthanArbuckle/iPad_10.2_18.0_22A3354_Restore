...
- (id)description
{
  ...
  -[NTPBBundleIDMapping description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBBundleIDMapping dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_bundleIds, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("bundle_ids"));
  }
  return v3;
}
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addBundleIds:", v11);
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_bundleIds, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NTPBBundleIDMapping addBundleIds:](self, "addBundleIds:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
