...
- (id)description
{
  ...
  -[NTPBTodayPersonalizationUpdate description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBTodayPersonalizationUpdate dictionaryRepresentation](self, "dictionaryRepresentation");
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NTPBTodayPersonalizationUpdate addEvents:](self, "addEvents:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
