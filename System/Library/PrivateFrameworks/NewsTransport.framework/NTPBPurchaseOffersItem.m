...
- (id)description
{
  ...
  -[NTPBPurchaseOffersItem description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBPurchaseOffersItem dictionaryRepresentation](self, "dictionaryRepresentation");
