...
- (id)description
{
  ...
  -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposure description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposure dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x2000) != 0)
  {
    ...
    {
      v13 = off_24CD52D78[parentFeedType];
    }
...
- (void)copyTo:(id)a3
{
  ...
  if ((v6 & 0x800) == 0)
  {
    if ((*(_WORD *)&self->_has & 0x4000) == 0)
      goto LABEL_17;
LABEL_40:
    *((_BYTE *)v4 + 184) = self->_adSupportedChannel;
    *((_WORD *)v4 + 94) |= 0x4000u;
    if ((*(_WORD *)&self->_has & 0x8000) == 0)
      goto LABEL_18;
LABEL_41:
    *((_BYTE *)v4 + 185) = self->_isPaidSubscriberToSourceChannel;
    *((_WORD *)v4 + 94) |= 0x8000u;
    goto LABEL_18;
  }
...
LABEL_17:
  if (v6 < 0)
    goto LABEL_41;
LABEL_18:
  if (-[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposure fractionalCohortMembershipsCount](self, "fractionalCohortMembershipsCount"))
  {
    objc_msgSend(v13, "clearFractionalCohortMemberships");
    v7 = -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposure fractionalCohortMembershipsCount](self, "fractionalCohortMembershipsCount");
    if (v7)
    {
      v8 = v7;
      for (i = 0; i != v8; ++i)
      {
        -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposure fractionalCohortMembershipAtIndex:](self, "fractionalCohortMembershipAtIndex:", i);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "addFractionalCohortMembership:", v10);
  ...
  if ((v11 & 0x100) != 0)
  {
    *((_QWORD *)v13 + 9) = *(_QWORD *)&self->_personalizationScore;
    *((_WORD *)v13 + 94) |= 0x100u;
    v11 = (__int16)self->_has;
    if ((v11 & 0x20) == 0)
    {
LABEL_24:
  ...
  *((_QWORD *)v13 + 6) = *(_QWORD *)&self->_featureCtr;
  *((_WORD *)v13 + 94) |= 0x20u;
  v11 = (__int16)self->_has;
  if ((v11 & 0x80) == 0)
  {
...
LABEL_44:
  *((_QWORD *)v13 + 8) = *(_QWORD *)&self->_paidNonpaidSubscriptionCtr;
  *((_WORD *)v13 + 94) |= 0x80u;
  v11 = (__int16)self->_has;
  if ((v11 & 4) == 0)
  {
...
LABEL_45:
  *((_QWORD *)v13 + 3) = *(_QWORD *)&self->_autoSubscribeCtr;
  *((_WORD *)v13 + 94) |= 4u;
  v11 = (__int16)self->_has;
  if ((v11 & 8) == 0)
  {
...
LABEL_46:
  *((_QWORD *)v13 + 4) = *(_QWORD *)&self->_computedGlobalScoreCoefficient;
  *((_WORD *)v13 + 94) |= 8u;
  v11 = (__int16)self->_has;
  if ((v11 & 0x40) == 0)
  {
...
LABEL_47:
  *((_QWORD *)v13 + 7) = *(_QWORD *)&self->_globalScore;
  *((_WORD *)v13 + 94) |= 0x40u;
  v11 = (__int16)self->_has;
  if ((v11 & 0x400) == 0)
  {
...
LABEL_48:
  *((_QWORD *)v13 + 11) = *(_QWORD *)&self->_userFeedbackScore;
  *((_WORD *)v13 + 94) |= 0x400u;
  v11 = (__int16)self->_has;
  if ((v11 & 2) == 0)
  {
...
LABEL_49:
  *((_QWORD *)v13 + 2) = *(_QWORD *)&self->_agedUserFeedbackScore;
  *((_WORD *)v13 + 94) |= 2u;
  v11 = (__int16)self->_has;
  if ((v11 & 1) == 0)
  {
...
LABEL_50:
  *((_QWORD *)v13 + 1) = *(_QWORD *)&self->_agedPersonalizationScore;
  *((_WORD *)v13 + 94) |= 1u;
  v11 = (__int16)self->_has;
  if ((v11 & 0x10) == 0)
  {
...
LABEL_51:
  *((_QWORD *)v13 + 5) = *(_QWORD *)&self->_diversifiedPersonalizationScore;
  *((_WORD *)v13 + 94) |= 0x10u;
  if ((*(_WORD *)&self->_has & 0x200) != 0)
  {
LABEL_33:
    *((_QWORD *)v13 + 10) = *(_QWORD *)&self->_subscribedChannelCtr;
    *((_WORD *)v13 + 94) |= 0x200u;
  }
LABEL_34:
  if (self->_language)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData copyWithZone:](self->_issueData, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 128);
  *(_QWORD *)(v5 + 128) = v6;

  v8 = -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposureData copyWithZone:](self->_issueExposureData, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 136);
  *(_QWORD *)(v5 + 136) = v8;

  v10 = -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData copyWithZone:](self->_channelData, "copyWithZone:", a3);
  v11 = *(void **)(v5 + 96);
  *(_QWORD *)(v5 + 96) = v10;
...
- (unint64_t)hash
{
  ...
  v75 = -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData hash](self->_issueData, "hash");
  v74 = -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposureData hash](self->_issueExposureData, "hash");
  v73 = -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData hash](self->_channelData, "hash");
  ...
  if (v14)
  {
    ...
    do
    {
      for (i = 0; i != v15; ++i)
      {
        ...
        -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposure addFractionalCohortMembership:](self, "addFractionalCohortMembership:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * i), (_QWORD)v19);
      }
