...
- (id)description
{
  ...
  -[NTPBArticleContentExpiration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBArticleContentExpiration dictionaryRepresentation](self, "dictionaryRepresentation");
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        -[NTPBArticleContentExpiration addTagsExpirationList:](self, "addTagsExpirationList:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
