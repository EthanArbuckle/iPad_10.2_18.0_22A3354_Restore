...
- (id)description
{
  ...
  -[NTPBSubscriptionDetectionScreenView description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBSubscriptionDetectionScreenView dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_countOfSubscriptionsDetected);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("count_of_subscriptions_detected"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_countOfSubscriptionsDetected == *((_DWORD *)v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
