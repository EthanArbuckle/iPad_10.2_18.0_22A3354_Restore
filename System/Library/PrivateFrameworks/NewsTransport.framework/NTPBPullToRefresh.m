...
- (id)description
{
  ...
  -[NTPBPullToRefresh description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NTPBPullToRefresh dictionaryRepresentation](self, "dictionaryRepresentation");
