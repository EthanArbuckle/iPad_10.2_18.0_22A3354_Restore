...
- (id)itemInSection:(int64_t)a3 row:(int64_t)a4
{
  ...
  if ((v5 & 0xC000000000000001) != 0)
  {
    ...
    v7 = (id)MEMORY[0x1AF4129DC](a4, v5);
    swift_bridgeObjectRelease();
    goto LABEL_5;
  }
  if (a4 < 0)
...
- (unint64_t)numberOfItemsInSection:(unint64_t)a3
{
  ...
  v3 = *(_QWORD *)self->modulesMetadata;
  if (!(v3 >> 62))
  {
...
- (id)sectionAtIndex:(unint64_t)a3
{
  ...
  uint64_t (**v5)();
  char *v6;
  _TtC18PodcastsFoundation29RecommendationModulesResponse *v7;
  objc_super v9;
  ...
  *((_QWORD *)v6 + 1) = 0xE000000000000000;
  ...
  v9.super_class = v3;
  swift_retain();
  v7 = -[RecommendationModulesResponse init](&v9, sel_init);
  swift_release();
  return v7;
}
