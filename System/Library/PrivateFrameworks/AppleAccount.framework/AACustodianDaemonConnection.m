...
- (AACustodianDaemonConnection)initWithListenerEndpoint:(id)a3
{
  ...
  AACustodianDaemonConnection *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)AACustodianDaemonConnection;
  v6 = -[AACustodianDaemonConnection init](&v9, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (void)dealloc
{
  ...
  -[AACustodianDaemonConnection dealloc](&v5, sel_dealloc);
}
...
- (id)remoteObjectProxyWithErrorHandler:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("AACustodianDaemonConnection.m"), 52, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("handler"));

  }
  -[AACustodianDaemonConnection _connection](self, "_connection");
...
- (id)_connection
{
  ...
  __42__AACustodianDaemonConnection__connection__block_invoke((uint64_t)v5);
...
id __42__AACustodianDaemonConnection__connection__block_invoke(uint64_t a1)
{
  ...
  if (!v3)
  {
    ...
    if (v4)
      ...
      v6 = objc_msgSend(v5, "initWithMachServiceName:options:", CFSTR("com.apple.aa.custodian.xpc"), 0);
    v7 = v6;
    ...
    *(_QWORD *)(v8 + 16) = v7;
    ...
    +[AACustodianDaemonInterface XPCInterface](AACustodianDaemonInterface, "XPCInterface");
    ...
    v26[1] = 3221225472;
    v26[2] = __42__AACustodianDaemonConnection__connection__block_invoke_2;
    v26[3] = &unk_1E416E358;
    ...
    v24[0] = v13;
    v24[1] = 3221225472;
    v24[2] = __42__AACustodianDaemonConnection__connection__block_invoke_3;
    v24[3] = &unk_1E416E358;
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      __42__AACustodianDaemonConnection__connection__block_invoke_cold_1(v15, v16, v17, v18, v19, v20, v21, v22);
...
{
  return -[AACustodianDaemonConnection initWithListenerEndpoint:](self, "initWithListenerEndpoint:", 0);
}
...
- (id)synchronousRemoteObjectProxyWithErrorHandler:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("AACustodianDaemonConnection.m"), 57, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("handler"));
...
{
  OUTLINED_FUNCTION_0_2(&dword_19EACA000, a1, a3, "Connection to custodian service interrupted", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_1();
}

- (void)_connectionInvalidationHandler
{
  OUTLINED_FUNCTION_0_2(&dword_19EACA000, a1, a3, "Connection to custodian service invalidated", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_1();
}
...
{
  OUTLINED_FUNCTION_0_2(&dword_19EACA000, a1, a3, "Connection to custodian service initialized", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_1();
}
