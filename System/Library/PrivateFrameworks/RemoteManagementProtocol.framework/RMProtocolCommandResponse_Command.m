...
+ (id)buildWithType:(id)a3 identifier:(id)a4 payload:(id)a5
{
  ...
  objc_msgSend(v10, "setResponseType:", v9);

  objc_msgSend(v10, "setResponseIdentifier:", v8);
  objc_msgSend(v10, "setResponsePayload:", v7);
...
+ (id)buildRequiredOnlyWithType:(id)a3 identifier:(id)a4
{
  ...
  objc_msgSend(v7, "setResponseType:", v6);

  objc_msgSend(v7, "setResponseIdentifier:", v5);
  return v7;
}
...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMProtocolCommandResponse_Command allowedResponseKeys](RMProtocolCommandResponse_Command, "allowedResponseKeys");
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  -[RMProtocolCommandResponse_Command responseType](self, "responseType");
  ...
  -[RMProtocolCommandResponse_Command responseIdentifier](self, "responseIdentifier");
  ...
  -[RMProtocolCommandResponse_Command responsePayload](self, "responsePayload");
  ...
  v12 = a3;
  -[RMModelPayloadBase serializeDictionaryIntoDictionary:usingKey:value:dictSerializer:isRequired:defaultValue:](self, "serializeDictionaryIntoDictionary:usingKey:value:dictSerializer:isRequired:defaultValue:", v5, CFSTR("Payload"), v8, v11, 0, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v9 = -[RMModelAnyPayload copy](self->_responsePayload, "copy");
  v10 = (void *)v4[4];
  v4[4] = v9;
