...
+ (id)buildWithCode:(id)a3 description:(id)a4 details:(id)a5
{
  ...
  objc_msgSend(v10, "setRequestCode:", v9);

  objc_msgSend(v10, "setRequestDescription:", v8);
  objc_msgSend(v10, "setRequestDetails:", v7);
...
+ (id)buildRequiredOnlyWithCode:(id)a3
{
  ...
  objc_msgSend(v4, "setRequestCode:", v3);
...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMProtocolCommandRequest_StatusReason allowedRequestKeys](RMProtocolCommandRequest_StatusReason, "allowedRequestKeys");
  ...
  if (!-[RMModelPayloadBase loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:](self, "loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:", v8, CFSTR("Code"), CFSTR("requestCode"), 1, 0, a5))
  {
LABEL_7:
    v16 = 0;
    goto LABEL_8;
  ...
  v16 = 0;
  if (-[RMModelPayloadBase loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:](self, "loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:", v8, CFSTR("Description"), CFSTR("requestDescription"), 0, 0, a5))
  {
    LOWORD(v18) = a4;
    v16 = -[RMModelPayloadBase loadDictionaryFromDictionary:usingKey:forKeyPath:classType:isRequired:defaultValue:serializationType:error:](self, "loadDictionaryFromDictionary:usingKey:forKeyPath:classType:isRequired:defaultValue:serializationType:error:", v8, CFSTR("Details"), CFSTR("requestDetails"), objc_opt_class(), 0, 0, v18, a5);
  }
LABEL_8:
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  -[RMProtocolCommandRequest_StatusReason requestCode](self, "requestCode");
  ...
  -[RMProtocolCommandRequest_StatusReason requestDescription](self, "requestDescription");
  ...
  -[RMProtocolCommandRequest_StatusReason requestDetails](self, "requestDetails");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[NSString copy](self->_requestCode, "copy");
  v6 = (void *)v4[2];
  v4[2] = v5;

  v7 = -[NSString copy](self->_requestDescription, "copy");
  v8 = (void *)v4[3];
  v4[3] = v7;

  v9 = -[RMModelAnyPayload copy](self->_requestDetails, "copy");
  v10 = (void *)v4[4];
  v4[4] = v9;
