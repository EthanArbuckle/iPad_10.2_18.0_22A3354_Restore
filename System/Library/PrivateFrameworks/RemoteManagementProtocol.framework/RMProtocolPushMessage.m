...
+ (id)requestWithEnrollmentToken:(id)a3 syncTokens:(id)a4
{
  ...
  objc_msgSend(v7, "setMessageEnrollmentToken:", v6);

  objc_msgSend(v7, "setMessageSyncTokens:", v5);
  return v7;
}
...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  v8 = a3;
  if (-[RMModelPayloadBase loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:](self, "loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:", v8, CFSTR("EnrollmentToken"), CFSTR("messageEnrollmentToken"), 1, 0, a5))
  {
    LOWORD(v11) = a4;
    v9 = -[RMModelPayloadBase loadDictionaryFromDictionary:usingKey:forKeyPath:classType:isRequired:defaultValue:serializationType:error:](self, "loadDictionaryFromDictionary:usingKey:forKeyPath:classType:isRequired:defaultValue:serializationType:error:", v8, CFSTR("SyncTokens"), CFSTR("messageSyncTokens"), objc_opt_class(), 0, 0, v11, a5);
  }
  else
  {
    v9 = 0;
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  -[RMProtocolPushMessage messageEnrollmentToken](self, "messageEnrollmentToken");
  ...
  -[RMProtocolPushMessage messageSyncTokens](self, "messageSyncTokens");
  ...
  v11 = a3;
  -[RMModelPayloadBase serializeDictionaryIntoDictionary:usingKey:value:dictSerializer:isRequired:defaultValue:](self, "serializeDictionaryIntoDictionary:usingKey:value:dictSerializer:isRequired:defaultValue:", v5, CFSTR("SyncTokens"), v7, v10, 0, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[NSString copy](self->_messageEnrollmentToken, "copy");
  v6 = (void *)v4[2];
  v4[2] = v5;

  v7 = -[RMProtocolSynchronizationTokens copy](self->_messageSyncTokens, "copy");
  v8 = (void *)v4[3];
  v4[3] = v7;
