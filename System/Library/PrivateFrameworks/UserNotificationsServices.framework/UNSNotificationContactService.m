...
{
  UNSNotificationContactService *v0;
  uint64_t v1;
  void *v2;
  UNSCNContactResolver *v3;

  v0 = [UNSNotificationContactService alloc];
  v3 = objc_alloc_init(UNSCNContactResolver);
  v1 = -[UNSNotificationContactService initWithResolver:](v0, "initWithResolver:", v3);
...
{
  id v5;
  UNSNotificationContactService *v6;
  NSCache *v7;
  ...
  v6 = -[UNSNotificationContactService init](&v12, sel_init);
  if (v6)
  {
...
- (id)updateServiceWithContact:(id)a3 bundleIdentifier:(id)a4
{
  ...
  void *v17;
  void *v18;
  UNSNotificationContactService *v19;
  void *v20;
  void *v21;
  void *v22;
  UNSNotificationContactService *v24;
  ...
  {
    -[UNSCNContactResolver resultForContactIdentifier:emailAddress:phoneNumber:userIdentifier:username:bundleIdentifier:](resolver, "resultForContactIdentifier:emailAddress:phoneNumber:userIdentifier:username:bundleIdentifier:", v8, v11, v13, v14, 0, v7);
  ...
  else
  {
    ...
    -[UNSCNContactResolver resultForContactIdentifier:emailAddress:phoneNumber:userIdentifier:username:bundleIdentifier:](resolver, "resultForContactIdentifier:emailAddress:phoneNumber:userIdentifier:username:bundleIdentifier:", v16, v11, v13, v14, v17, v7);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v15 && (objc_msgSend(v15, "isSuggestedContact") & 1) == 0)
  {
    ...
    -[UNSNotificationContactService _setResult:forContact:bundleIdentifier:](v19, "_setResult:forContact:bundleIdentifier:", v15, v18, v7);
  }
  else
  {
    -[UNSNotificationContactService _setResult:forContact:bundleIdentifier:](self, "_setResult:forContact:bundleIdentifier:", 0, v6, v7);
    v18 = 0;
  }
...
- (id)curatedContactMatchDetailsForContact:(id)a3 bundleIdentifier:(id)a4
{
  void *v4;
  void *v5;
  UNSNotificationContactServiceMatchDetails *v6;
  UNSNotificationContactServiceMatchDetails *v7;
  void *v8;
  void *v9;

  -[UNSNotificationContactService _matchForContact:bundleIdentifier:](self, "_matchForContact:bundleIdentifier:", a3, a4);
  ...
  if (v4 && (objc_msgSend(v4, "isSuggestedContact") & 1) == 0)
  {
    ...
    v6 = -[UNSNotificationContactServiceMatchDetails initWithCnContactIdentifier:cnContactFullname:isSuggestedContact:](v7, "initWithCnContactIdentifier:cnContactFullname:isSuggestedContact:", v8, v9, objc_msgSend(v5, "isMatchTypeSuggested"));
...
- (id)curatedContactForContact:(id)a3 bundleIdentifier:(id)a4 keysToFetch:(id)a5
{
  ...
  v8 = a3;
  v9 = a5;
  -[UNSNotificationContactService _matchForContact:bundleIdentifier:](self, "_matchForContact:bundleIdentifier:", v8, a4);
  ...
  if (objc_msgSend(v13, "length"))
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        -[UNSNotificationContactService curatedContactForContact:bundleIdentifier:keysToFetch:].cold.1();
...
- (void)confirmCuratedContactSuggestion:(BOOL)a3 forContact:(id)a4 bundleIdentifier:(id)a5
{
  ...
  v8 = a4;
  v9 = a5;
  -[UNSNotificationContactService _matchForContact:bundleIdentifier:](self, "_matchForContact:bundleIdentifier:", v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = v10;
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      -[UNSNotificationContactService confirmCuratedContactSuggestion:forContact:bundleIdentifier:].cold.1();
    goto LABEL_8;
  }
  if (!objc_msgSend(v10, "isMatchTypeSuggested"))
  {
    ...
    v13 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      -[UNSNotificationContactService confirmCuratedContactSuggestion:forContact:bundleIdentifier:].cold.2();
LABEL_8:

    goto LABEL_9;
  }
  -[UNSCNContactResolver confirm:match:](self->_resolver, "confirm:match:", v6, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  -[UNSNotificationContactService _setResult:forContact:bundleIdentifier:](self, "_setResult:forContact:bundleIdentifier:", v12, v8, v9);
...
- (void)didAddToCuratedContactsForContact:(id)a3 bundleIdentifier:(id)a4 cnContactIdentifier:(id)a5
{
  ...
  if (objc_msgSend(v11, "isMatchTypeSuggested"))
    v12 = -[UNSCNContactResolver confirm:match:](self->_resolver, "confirm:match:", 0, v11);
  -[UNSCNContactResolver resultForContactIdentifier:emailAddress:phoneNumber:userIdentifier:username:bundleIdentifier:](self->_resolver, "resultForContactIdentifier:emailAddress:phoneNumber:userIdentifier:username:bundleIdentifier:", v10, 0, 0, 0, 0, v9);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v13)
  {
    UNSLogCommunicationNotifications();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      -[UNSNotificationContactService didAddToCuratedContactsForContact:bundleIdentifier:cnContactIdentifier:].cold.1();

  }
  -[UNSNotificationContactService _setResult:forContact:bundleIdentifier:](self, "_setResult:forContact:bundleIdentifier:", v13, v8, v9);
...
- (id)_matchForContact:(id)a3 bundleIdentifier:(id)a4
{
  id v6;
  id v7;
  UNSNotificationContactServiceRecord *v8;
  UNSNotificationContactService *v9;
  void *v10;

  v6 = a3;
  v7 = a4;
  v8 = objc_alloc_init(UNSNotificationContactServiceRecord);
  -[UNSNotificationContactServiceRecord setContact:](v8, "setContact:", v6);
  -[UNSNotificationContactServiceRecord setBundleIdentifier:](v8, "setBundleIdentifier:", v7);
  v9 = self;
  objc_sync_enter(v9);
...
- (void)_setResult:(id)a3 forContact:(id)a4 bundleIdentifier:(id)a5
{
  id v8;
  id v9;
  UNSNotificationContactServiceRecord *v10;
  UNSNotificationContactService *v11;
  NSCache *resultsByServiceRecord;
  id v13;
  ...
  -[UNSNotificationContactServiceRecord setContact:](v10, "setContact:", v8);
  -[UNSNotificationContactServiceRecord setBundleIdentifier:](v10, "setBundleIdentifier:", v9);
  v11 = self;
  objc_sync_enter(v11);
...
- (void)curatedContactForContact:bundleIdentifier:keysToFetch:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_249B71000, v0, v1, "Contact service unable to fetch contact for identifier", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)confirmCuratedContactSuggestion:forContact:bundleIdentifier:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_249B71000, v0, v1, "Contact service unable to confirm contact. Result not found.", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)confirmCuratedContactSuggestion:forContact:bundleIdentifier:.cold.2()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_249B71000, v0, v1, "Contact service unable to confirm an already confirmed contact", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)didAddToCuratedContactsForContact:bundleIdentifier:cnContactIdentifier:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_249B71000, v0, v1, "Contact service can't resolve newly created contact", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
