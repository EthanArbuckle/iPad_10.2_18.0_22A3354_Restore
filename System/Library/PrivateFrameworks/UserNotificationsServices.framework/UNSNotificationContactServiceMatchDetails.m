...
- (UNSNotificationContactServiceMatchDetails)initWithCnContactIdentifier:(id)a3 cnContactFullname:(id)a4 isSuggestedContact:(BOOL)a5
{
  ...
  id v8;
  id v9;
  UNSNotificationContactServiceMatchDetails *v10;
  UNSNotificationContactServiceMatchDetails *v11;
  objc_super v13;
  ...
  v10 = -[UNSNotificationContactServiceMatchDetails init](&v13, sel_init);
  v11 = v10;
  if (v10)
  {
    -[UNSNotificationContactServiceMatchDetails setCnContactIdentifier:](v10, "setCnContactIdentifier:", v8);
    -[UNSNotificationContactServiceMatchDetails setCnContactFullname:](v11, "setCnContactFullname:", v9);
    -[UNSNotificationContactServiceMatchDetails setIsSuggestedMatch:](v11, "setIsSuggestedMatch:", v5);
  }
