...
{
  id v5;
  HUAudioAnalysisDetectionSettingsItemProvider *v6;
  HUAudioAnalysisDetectionSettingsItemProvider *v7;
  uint64_t v8;
  NSMutableSet *items;
  objc_super v11;
...
- (HUAudioAnalysisDetectionSettingsItemProvider)init
{
  ...
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("HUAudioAnalysisDetectionSettingsItemProvider.m"), 71, CFSTR("%s is unavailable; use %@ instead"),
    "-[HUAudioAnalysisDetectionSettingsItemProvider init]",
    v5);
...
- (id)reloadItems
{
  ...
  v9[1] = 3221225472;
  v9[2] = __59__HUAudioAnalysisDetectionSettingsItemProvider_reloadItems__block_invoke_3;
  v9[3] = &unk_1E6F4EC68;
  objc_copyWeak(&v10, &location);
  -[HFItemProvider reloadItemsWithObjects:keyAdaptor:itemAdaptor:filter:itemMap:](self, "reloadItemsWithObjects:keyAdaptor:itemAdaptor:filter:itemMap:", &unk_1E7042D98, &__block_literal_global_257, &__block_literal_global_40_1, 0, v9);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v7[0] = v3;
  v7[1] = 3221225472;
  v7[2] = __59__HUAudioAnalysisDetectionSettingsItemProvider_reloadItems__block_invoke_5;
  v7[3] = &unk_1E6F4D2C8;
...
HUAudioAnalysisDetectionSettingsItem *__59__HUAudioAnalysisDetectionSettingsItemProvider_reloadItems__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  void *v5;
  id v6;
  HUAudioAnalysisDetectionSettingsItem *v7;
  ...
  v7 = (HUAudioAnalysisDetectionSettingsItem *)objc_claimAutoreleasedReturnValue();

  if (!v7)
  {
    v8 = [HUAudioAnalysisDetectionSettingsItem alloc];
    v9 = objc_msgSend(v6, "unsignedIntegerValue");
    objc_msgSend(WeakRetained, "accessory");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = -[HUAudioAnalysisDetectionSettingsItem initWithDetectionType:accessory:](v8, "initWithDetectionType:accessory:", v9, v10);
