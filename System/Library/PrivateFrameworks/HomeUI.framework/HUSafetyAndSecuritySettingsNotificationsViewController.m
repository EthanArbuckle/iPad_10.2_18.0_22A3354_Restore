...
- (HUSafetyAndSecuritySettingsNotificationsViewController)initWithHome:(id)a3
{
  ...
  void *v6;
  id v7;
  HUSafetyAndSecuritySettingsNotificationsViewController *v8;
  void *v9;
  void *v11;
  objc_super v12;
  _QWORD v13[4];
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v11, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("HUSafetyAndSecuritySettingsNotificationsViewController.m"), 24, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("home != nil"));
  ...
  objc_msgSend(v6, "setItemModuleCreator:", &__block_literal_global_86);
  v12.receiver = self;
  ...
  if (v8)
  {
    ...
    -[HUSafetyAndSecuritySettingsNotificationsViewController setTitle:](v8, "setTitle:", v9);
...
id __71__HUSafetyAndSecuritySettingsNotificationsViewController_initWithHome___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  id v6;
  void *v7;
  HUSafetyAndSecuritySettingsNotificationsItemModule *v8;
  ...
  v8 = -[HUSafetyAndSecuritySettingsNotificationsItemModule initWithItemUpdater:home:]([HUSafetyAndSecuritySettingsNotificationsItemModule alloc], "initWithItemUpdater:home:", v5, v6);
...
{
  id v4;
  HUSafetyAndSecuritySettingsNotificationsItemModuleController *v5;
  void *v6;
  ...
  v5 = -[HUItemModuleController initWithModule:]([HUSafetyAndSecuritySettingsNotificationsItemModuleController alloc], "initWithModule:", v4);
  -[HUSafetyAndSecuritySettingsNotificationsViewController setModuleController:](self, "setModuleController:", v5);

  -[HUSafetyAndSecuritySettingsNotificationsViewController moduleController](self, "moduleController");
