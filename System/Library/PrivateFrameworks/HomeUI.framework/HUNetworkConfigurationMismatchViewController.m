...
- (HUNetworkConfigurationMismatchViewController)initWithItemManager:(id)a3 tableViewStyle:(int64_t)a4
{
  ...
  NSStringFromSelector(sel_initWithProfiles_);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("HUNetworkConfigurationMismatchViewController.m"), 27, CFSTR("%s is unavailable; use %@ instead"),
...
{
  id v4;
  HUNetworkConfigurationMismatchItemManager *v5;
  HUNetworkConfigurationMismatchViewController *v6;
  objc_super v8;

  v4 = a3;
  v5 = -[HUNetworkConfigurationMismatchItemManager initWithProfiles:delegate:]([HUNetworkConfigurationMismatchItemManager alloc], "initWithProfiles:delegate:", v4, self);
...
- (Class)cellClassForItem:(id)a3 indexPath:(id)a4
{
  ...
  else
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("HUNetworkConfigurationMismatchViewController.m"), 43, CFSTR("Couldn't find a cell class for item: %@"), v6);
