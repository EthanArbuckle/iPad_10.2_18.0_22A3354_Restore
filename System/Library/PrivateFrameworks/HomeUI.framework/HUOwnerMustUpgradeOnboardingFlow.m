...
{
  id v7;
  HUOwnerMustUpgradeOnboardingFlow *v8;
  HUOwnerMustUpgradeOnboardingFlow *v9;
  void *v10;
  uint64_t v11;
  ...
  v8 = -[HUOwnerMustUpgradeOnboardingFlow init](&v17, sel_init);
  v9 = v8;
  if (v8)
  {
...
{
  id WeakRetained;
  HUOwnerMustUpgradeViewController *v4;
  id v5;
  ...
  {
    v4 = -[HUOwnerMustUpgradeViewController initWithUpgradeRequirements:]([HUOwnerMustUpgradeViewController alloc], "initWithUpgradeRequirements:", *(_QWORD *)(a1 + 48));
...
{
  return (NSString *)CFSTR("Owner Must Upgrade");
}
...
- (id)processUserInput:(id)a3
{
  ...
  void *v8;
  int v10;
  HUOwnerMustUpgradeOnboardingFlow *v11;
  __int16 v12;
  void *v13;
  __int16 v14;
  id v15;
  ...
  -[HUOwnerMustUpgradeOnboardingFlow onboardingFuture](self, "onboardingFuture");
