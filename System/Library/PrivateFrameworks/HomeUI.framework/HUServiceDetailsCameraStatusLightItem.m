...
- (id)_subclass_updateWithOptions:(id)a3
{
  ...
  v4 = a3;
  if (-[HUServiceDetailsCameraStatusLightItem _canReadWriteAccessModeIndicator](self, "_canReadWriteAccessModeIndicator"))
  {
    -[HUServiceDetailsCameraStatusLightItem settingsReaderWriter](self, "settingsReaderWriter");
...
- (BOOL)_canReadWriteAccessModeIndicator
{
  ...
  if (v5)
  {
    ...
    v8 = ((unint64_t)objc_msgSend(v7, "supportedFeatures") >> 4) & 1;
...
{
  return CFSTR("HUCameraStatusLight-Toggle");
}
...
{
  return (id)objc_msgSend(a3, "accessModeIndicatorEnabledCharacteristic");
}

- (id)itemTitleLocalizationKey
{
  return CFSTR("HUCameraStatusLightSwitchTitle");
}
...
- (id)itemTitle
{
  ...
  -[HUServiceDetailsCameraStatusLightItem itemTitleLocalizationKey](self, "itemTitleLocalizationKey");
