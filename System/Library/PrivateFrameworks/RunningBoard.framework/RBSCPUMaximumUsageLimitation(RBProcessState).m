...
- (void)applyToAssertionTransientState:()RBProcessState attributePath:context:
{
  ...
  v5 = a3;
  v4 = objc_msgSend(v5, "maxCPUUsageViolationPolicyForRole:", objc_msgSend(a1, "role"));
  if (v4 < objc_msgSend(a1, "violationPolicy"))
...
- (void)applyToProcessState:()RBProcessState attributePath:context:
{
  ...
  char v8;
  uint64_t v9;
  RBProcessCPUMaximumLimits *v10;
  uint64_t v11;
  double v12;
  RBProcessCPUMaximumLimits *v13;
  id v14;
  ...
  if ((v8 & 1) == 0)
  {
    ...
    v13 = -[RBProcessCPUMaximumLimits initWithPercentage:duration:violationPolicy:](v10, "initWithPercentage:duration:violationPolicy:", v11, vcvtpd_u64_f64(v12), objc_msgSend(a1, "violationPolicy"));
    objc_msgSend(v14, "setMaxCPUUsageLimits:forRole:", v13, v9);
