...
+ (id)domainRestrictionForDictionary:(id)a3 withError:(id *)a4
{
  ...
  {
    a4 = -[RBOriginatorExtensionPointRestriction _initWithExtensionPoint:]([RBOriginatorExtensionPointRestriction alloc], "_initWithExtensionPoint:", v6);
  }
  else if (a4)
  {
    v7 = (void *)MEMORY[0x24BDD1540];
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("RBOriginatorExtensionPointRestriction doesn't specify extensionPoint: %@"), v5, *MEMORY[0x24BDD0FD8]);
...
- (BOOL)allowsContext:(id)a3 withError:(id *)a4
{
  ...
  objc_msgSend(a3, "originatorProcess");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((v8 & 1) == 0)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("originator isn't extension"));
...
LABEL_8:
  ...
  if ((extensionPoint & 1) == 0)
  {
    ...
    v12 = (void *)MEMORY[0x24BDD1540];
    v13 = *MEMORY[0x24BE80E58];
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("originator doesn't have extensionPoint %@"), self->_extensionPoint, *MEMORY[0x24BDD0FD8]);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = v14;
    v15 = (void *)MEMORY[0x24BDBCE70];
    v16 = &v21;
...
- (BOOL)isEqual:(id)a3
{
  RBOriginatorExtensionPointRestriction *v4;
  uint64_t v5;
  char v6;
  NSString *extensionPoint;
  NSString *v8;
  ...
  v4 = (RBOriginatorExtensionPointRestriction *)a3;
  if (self == v4)
    goto LABEL_10;
  v5 = objc_opt_class();
