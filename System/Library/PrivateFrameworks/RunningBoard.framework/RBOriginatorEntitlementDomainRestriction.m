...
- (BOOL)allowsContext:(id)a3 withError:(id *)a4
{
  ...
  objc_msgSend(a3, "originatorEntitlements");
  ...
  if (a4 && (v7 & 1) == 0)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("originator doesn't have entitlement %@"), self->_entitlement, *MEMORY[0x24BDD0FD8]);
...
+ (id)domainRestrictionForDictionary:(id)a3 withError:(id *)a4
{
  ...
  {
    a4 = -[RBOriginatorEntitlementDomainRestriction _initWithEntitlement:]([RBOriginatorEntitlementDomainRestriction alloc], "_initWithEntitlement:", v6);
  }
  else if (a4)
  {
    v7 = (void *)MEMORY[0x24BDD1540];
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("RBOriginatorEntitlementDomainRestriction doesn't specify entitlement: %@"), v5, *MEMORY[0x24BDD0FD8]);
...
- (BOOL)isEqual:(id)a3
{
  RBOriginatorEntitlementDomainRestriction *v4;
  uint64_t v5;
  char v6;
  ...
  v4 = (RBOriginatorEntitlementDomainRestriction *)a3;
  if (self == v4)
    goto LABEL_10;
  v5 = objc_opt_class();
