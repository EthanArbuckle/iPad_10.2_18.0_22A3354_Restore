...
void __39__MOConnection_onConnectionInterrupted__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (!v17)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("XPC Connection with %@ ended prematurely"), obj[4]);
...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v5 = 136315394;
  v6 = OUTLINED_FUNCTION_0_0(a1);
  v7 = 2048;
  v8 = a2;
  _os_log_fault_impl(&dword_2422B0000, a3, OS_LOG_TYPE_FAULT, "[%s] The connection has been interrupted with %lu pending tasks", (uint8_t *)&v5, 0x16u);
...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  _os_log_error_impl(&dword_2422B0000, a2, OS_LOG_TYPE_ERROR, "[%s] The connection has been interrupted with zero pending tasks", (uint8_t *)&v3, 0xCu);
  OUTLINED_FUNCTION_1_1();
}
