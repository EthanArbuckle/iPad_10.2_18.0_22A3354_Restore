  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315394;
      ...
      v11 = 2112;
      v12 = v5;
      _os_log_impl(&dword_2422B0000, v6, OS_LOG_TYPE_INFO, "%s, deleting key, %@", buf, 0x16u);
    }
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315650;
      ...
      v16 = 2112;
      v17 = v7;
      _os_log_impl(&dword_2422B0000, v9, OS_LOG_TYPE_INFO, "%s, key, %@, value, %@", buf, 0x20u);
    }
...
{
  OUTLINED_FUNCTION_0(&dword_2422B0000, a1, a3, "%s, key cannot be nil!", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
...
- (void)objectForKey:.cold.2()
{
  ...
  OUTLINED_FUNCTION_0_1(&dword_2422B0000, v0, v1, "Invalid parameter not satisfying: key (in %s:%d)", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)objectForKey:(os_log_t)log .cold.3(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v7 = 2112;
  v8 = a2;
  _os_log_debug_impl(&dword_2422B0000, log, OS_LOG_TYPE_DEBUG, "%s, key, %@, value, %@", (uint8_t *)&v3, 0x20u);
}
