...
{
  WebLightSystemBackdropLayer *v2;
  unint64_t v3;
  CGColorRef v4;
  objc_super v6;
  objc_super v7;
  ...
  v7.receiver = self;
  v7.super_class = (Class)WebLightSystemBackdropLayer;
  v2 = -[WebLightSystemBackdropLayer init](&v7, sel_init);
  if (v2)
  {
    *(_OWORD *)components = xmmword_1968DD0F8;
    v12 = unk_1968DD108;
    {
    ...
    v6.receiver = v2;
    v6.super_class = (Class)WebLightSystemBackdropLayer;
    -[WebLightSystemBackdropLayer setBackgroundColor:](&v6, sel_setBackgroundColor_, v4);
    if (v4)
      CFRelease(v4);
  }
  return v2;
