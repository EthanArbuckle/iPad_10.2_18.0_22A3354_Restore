@implementation ZN7WebCore26SourceBufferPrivateAVFObjC21trackDidChangeEnabledERNS

unsigned __int8 *___ZN7WebCore26SourceBufferPrivateAVFObjC21trackDidChangeEnabledERNS_17AudioTrackPrivateEb_block_invoke(unsigned __int8 *result)
{
  uint64_t v1;
  unsigned __int8 *v2;
  uint64_t v3;
