...
void ___DeleteParticipantsFromLibraryScope_block_invoke(uint64_t a1, int a2, void *a3)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1A6789000, v7, OS_SIGNPOST_INTERVAL_END, v8, "DeleteParticipants", ", buf, 2u);
  }
...
LABEL_10:
  ...
  if (v16)
  {
    ...
    block[1] = 3221225472;
    block[2] = ___DeleteParticipantsFromLibraryScope_block_invoke_307;
...
uint64_t ___DeleteParticipantsFromLibraryScope_block_invoke_307(uint64_t a1)
{
