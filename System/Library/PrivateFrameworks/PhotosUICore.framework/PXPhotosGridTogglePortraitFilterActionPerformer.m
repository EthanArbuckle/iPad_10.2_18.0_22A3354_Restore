...
+ (BOOL)canPerformActionType:(id)a3 withViewModel:(id)a4
{
  ...
  if (objc_msgSendSuper2(&v9, sel_canPerformActionType_withViewModel_, a3, v6))
    v7 = !+[PXPhotosGridToggleFilterActionPerformer isContentFilterHidden:viewModel:](PXPhotosGridToggleFilterActionPerformer, "isContentFilterHidden:viewModel:", 12, v6);
  else
    LOBYTE(v7) = 0;
  ...
  if (a3 == 1)
  {
    ...
    if (v6)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXPhotosGridTogglePortraitFilterActionPerformer.m"), 38, CFSTR("%@ should be nil or an instance inheriting from %@, but it is %@"), CFSTR("self.viewModel.contentFilterState"), v12, v13);
