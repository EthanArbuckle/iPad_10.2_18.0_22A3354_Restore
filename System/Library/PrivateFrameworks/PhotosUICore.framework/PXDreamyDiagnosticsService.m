...
{
  return -[PHAsset playbackStyle](self->_asset, "playbackStyle") == 3;
}

- (id)contextualViewController
{
  PXDreamyDiagnosticsViewController *v3;

  if (-[PXDreamyDiagnosticsService canProvideContextualViewController](self, "canProvideContextualViewController"))
    v3 = -[PXVideoComparisonViewController initWithInputAsset:]([PXDreamyDiagnosticsViewController alloc], "initWithInputAsset:", self->_asset);
  else
    v3 = 0;
  return v3;
}
