...
- (id)activityType
{
  ...
  v2 = CFSTR("PXActivityTypeZoomIn");
  return CFSTR("PXActivityTypeZoomIn");
}

- (id)activitySystemImageName
{
  return CFSTR("plus.magnifyingglass");
}
...
- (id)menuElement
{
  ...
  if (v4)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXPhotosGridZoomInActionPerformer.m"), 35, CFSTR("%@ should be nil or an instance inheriting from %@, but it is %@"), CFSTR("[super menuElement]"), v8, v9);
...
{
  return PXLocalizedStringFromTable(CFSTR("PXLibraryAllPhotosZoomIn"), CFSTR("PhotosUICore"));
}
...
- (void)performUserInteractionTask
{
  ...
  if (v5 < 0 || objc_msgSend(v3, "numberOfZoomSteps") <= v5)
  {
    ...
    {
      *(_WORD *)v8 = 0;
      _os_log_impl(&dword_1A6789000, v7, OS_LOG_TYPE_DEFAULT, "Action tried to zoom in, but that's no longer possible.", v8, 2u);
    }
