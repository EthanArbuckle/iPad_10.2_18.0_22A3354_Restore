...
- (_PXFlexMusicMediaProviderRequest)initWithAsset:(id)a3 options:(id)a4 requestID:(int64_t)a5 resultHandler:(id)a6
{
  ...
  _PXFlexMusicMediaProviderRequest *v15;
  uint64_t v16;
  ...
  v14 = -[_PXFlexMusicMediaProviderRequest init](&v21, sel_init);
  v15 = v14;
  if (v14)
  {
    v14->_requestID = a5;
...
- (_PXFlexMusicMediaProviderRequest)init
{
  ...
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXFlexMusicMediaProvider.m"), 192, CFSTR("%s is not available as initializer"), "-[_PXFlexMusicMediaProviderRequest init]");
