...
- (id)performWithDataset:(id)a3 progressBlock:(id)a4
{
  ...
  if (!objc_msgSend(v8, "count"))
  {
    ...
    objc_msgSend(v19, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXStoryAutoEditMomentsProvider.m"), 150, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("dataset.count > 0"));
  ...
  PXStoryClusteringAlgorithmCutClusterWithAssetIndicesOptionsAndDistanceBlock(v8, v15, v16);
