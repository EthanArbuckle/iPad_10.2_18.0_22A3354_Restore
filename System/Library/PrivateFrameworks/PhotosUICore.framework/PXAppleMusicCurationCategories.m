@implementation PXAppleMusicCurationCategories
...
void __PXAppleMusicCurationCategories_block_invoke()
{
  ...
  v3 = (void *)PXAppleMusicCurationCategories_categories;
  PXAppleMusicCurationCategories_categories = v2;

}

uint64_t __PXAppleMusicCurationCategories_block_invoke_2(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "hasPrefix:", CFSTR("AppleMusic"));
}
