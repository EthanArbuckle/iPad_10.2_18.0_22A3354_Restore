...
{
  id v4;
  PXGViewPerspectiveDebugDiagnosticsService *v5;
  id v6;
  uint64_t v7;
  uint64_t v8;
  uint64_t v9;
...
- (id)title
{
  ...
  -[PXGViewPerspectiveDebugDiagnosticsService gridView](self, "gridView");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v2, "showPerspectiveDebug"))
    v3 = CFSTR("Disable Perspective Debug");
  else
    v3 = CFSTR("Enable Perspective Debug");
  v4 = v3;
...
- (void)performAction
{
  ...
  v3 = objc_msgSend(v5, "showPerspectiveDebug") ^ 1;
  -[PXGViewPerspectiveDebugDiagnosticsService gridView](self, "gridView");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setShowPerspectiveDebug:", v3);
