...
- (PXCuratedLibraryToggleLiveFilterActionPerformer)initWithViewModel:(id)a3
{
  ...
  return -[PXCuratedLibraryActionPerformer initWithActionType:viewModel:](&v4, sel_initWithActionType_viewModel_, CFSTR("PXCuratedLibraryActionToggleLiveFilter"), a3);
}
  ...
  if (a3 == 1)
  {
    ...
    if (v6)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXCuratedLibraryToggleLiveFilterActionPerformer.m"), 42, CFSTR("%@ should be nil or an instance inheriting from %@, but it is %@"), CFSTR("self.viewModel.allPhotosContentFilterState"), v12, v13);
