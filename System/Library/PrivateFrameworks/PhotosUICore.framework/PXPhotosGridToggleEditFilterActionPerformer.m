...
+ (BOOL)canPerformActionType:(id)a3 withViewModel:(id)a4
{
  ...
  if (objc_msgSendSuper2(&v9, sel_canPerformActionType_withViewModel_, a3, v6))
    v7 = !+[PXPhotosGridToggleFilterActionPerformer isContentFilterHidden:viewModel:](PXPhotosGridToggleFilterActionPerformer, "isContentFilterHidden:viewModel:", 9, v6);
  else
    LOBYTE(v7) = 0;
...
- (id)localizedTitleForUseCase:(unint64_t)a3
{
  ...
  if (a3 == 1)
  {
    ...
    if (objc_msgSend(v4, "edited"))
      v5 = CFSTR("DISABLE_EDITS_FILTER_SHORTCUT");
    else
      v5 = CFSTR("ENABLE_EDITS_FILTER_SHORTCUT");
