...
{
  return +[PXActivity activityWithActionTitle:actionType:activityType:systemImageName:](PXActivity, "activityWithActionTitle:actionType:activityType:systemImageName:", a3, a4, CFSTR("PXActivityTypeSuggestPeople"), a5);
}
...
+ (id)localizedTitleForUseCase:(unint64_t)a3 assetCollectionReference:(id)a4 withInputs:(id)a5
{
  ...
  if (a3 - 1 >= 2)
  {
    if (!a3)
    {
      ...
      objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("PXPhotoKitAssetCollectionSuggestPeopleActionPerformer.m"), 47, CFSTR("Code which should be unreachable has been reached"));
  ...
  {
    PXLocalizedStringFromTable(CFSTR("PXPeopleSuggestWidgetGeneric"), CFSTR("PhotosUICore"));
...
- (void)performUserInteractionTask
{
  ...
  if (v6)
  {
    ...
    -[PXPeopleSplitConfirmationViewController setModalPresentationStyle:](v4, "setModalPresentationStyle:", 0);
