...
void __get_CDInteractionAdvisorClass_block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = objc_getClass("_CDInteractionAdvisor");
  ...
  else
  {
    ...
    objc_msgSend(v2, "handleFailureInFunction:file:lineNumber:description:", v3, CFSTR("PXRecipientSoftLinks.m"), 15, CFSTR("Unable to find class %s"), "_CDInteractionAdvisor");
