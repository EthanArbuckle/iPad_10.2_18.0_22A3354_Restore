...
{
  id v1;
  PXSharedLibrarySharingSuggestionsCountsManager *v2;
  ...
  if (!v2)
    v2 = -[PXSharedLibrarySharingSuggestionsCountsManager initWithPhotoLibrary:]([PXSharedLibrarySharingSuggestionsCountsManager alloc], "initWithPhotoLibrary:", v1);
