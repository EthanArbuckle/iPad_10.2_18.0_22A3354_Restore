...
- (void)performBackgroundTask
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1A6789000, v3, OS_LOG_TYPE_DEFAULT, "Will navigate to cellular settings", buf, 2u);
  }
  ...
  v4[3] = &unk_1E5148B78;
  v4[4] = self;
  +[PXSystemNavigation navigateToDestination:completion:](PXSystemNavigation, "navigateToDestination:completion:", 9, v4);
}
