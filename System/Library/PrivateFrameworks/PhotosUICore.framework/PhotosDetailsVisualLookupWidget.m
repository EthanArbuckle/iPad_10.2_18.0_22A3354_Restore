...
{
  _TtC12PhotosUICore31PhotosDetailsVisualLookupWidget *v2;
  void *v3;
...
{
  _TtC12PhotosUICore31PhotosDetailsVisualLookupWidget *v4;
  id v5;
...
{
  uint64_t (*v2)(void);
  _TtC12PhotosUICore31PhotosDetailsVisualLookupWidget *v3;
  void *v4;
  _BOOL4 v5;
...
- (void).cxx_destruct
{
  sub_1A688D368((uint64_t)self + OBJC_IVAR____TtC12PhotosUICore31PhotosDetailsVisualLookupWidget_widgetInteractionDelegate);
