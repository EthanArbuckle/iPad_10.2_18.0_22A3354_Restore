...
+ (BOOL)canPerformWithSelectionSnapshot:(id)a3 person:(id)a4 socialGroup:(id)a5
{
  ...
  if (!v8)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("PXPhotoKitRecoverAssetActionPerformer.m"), 23, CFSTR("%@ should be an instance inheriting from %@, but it is nil"), CFSTR("selectionSnapshot.dataSource"), v14);
LABEL_9:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("PXPhotoKitRecoverAssetActionPerformer.m"), 23, CFSTR("%@ should be an instance inheriting from %@, but it is %@"), CFSTR("selectionSnapshot.dataSource"), v14, v16);
...
LABEL_4:
  ...
  v10 = objc_msgSend(v9, "px_isRecoveredSmartAlbum");

LABEL_6:
  return v10;
}

+ (BOOL)canPerformOnAsset:(id)a3 inAssetCollection:(id)a4 person:(id)a5
{
...
+ (id)localizedTitleForUseCase:(unint64_t)a3 actionManager:(id)a4
{
  ...
  if (v5)
    v6 = CFSTR("PXPhotoKitRecoverAssetActionPerformer_Title");
  else
    v6 = CFSTR("PXPhotoKitRecoverAssetActionPerformer_TitleSelection");
...
+ (id)createBarButtonItemWithTarget:(id)a3 action:(SEL)a4 actionManager:(id)a5
{
  ...
  if (v10)
    v11 = CFSTR("PXPhotoKitRecoverAssetActionPerformer_Title");
  else
    v11 = CFSTR("PXPhotoKitRecoverAssetActionPerformer_TitleSelection");
