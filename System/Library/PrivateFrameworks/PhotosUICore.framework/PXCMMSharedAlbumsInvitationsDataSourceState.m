...
- (PXCMMSharedAlbumsInvitationsDataSourceState)initWithSharedAlbums:(id)a3 invitationsBySharedAlbumObjectID:(id)a4
{
  id v7;
  id v8;
  PXCMMSharedAlbumsInvitationsDataSourceState *v9;
  PXCMMSharedAlbumsInvitationsDataSourceState *v10;
  objc_super v12;
  ...
  v9 = -[PXCMMSharedAlbumsInvitationsDataSourceState init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)stateUpdatedWithChange:(id)a3 changeDetails:(id *)a4
{
  ...
  void *v33;
  void *v34;
  PXCMMSharedAlbumsInvitationsDataSourceState *v35;
  id v36;
  void *v37;
  void *v38;
  void *v39;
  void *v40;
  PXCMMSharedAlbumsInvitationsDataSourceState *v42;
  void *v43;
  void *v44;
  void *v46;
  _QWORD v47[4];
  ...
  v5 = a3;
  -[PXCMMSharedAlbumsInvitationsDataSourceState sharedAlbums](self, "sharedAlbums");
  ...
  -[PXCMMSharedAlbumsInvitationsDataSourceState invitationsBySharedAlbumObjectID](self, "invitationsBySharedAlbumObjectID");
  v26 = (id)objc_claimAutoreleasedReturnValue();
  v47[0] = MEMORY[0x1E0C809B0];
  v47[1] = 3221225472;
  v47[2] = __84__PXCMMSharedAlbumsInvitationsDataSourceState_stateUpdatedWithChange_changeDetails___block_invoke_2;
  v47[3] = &unk_1E51295B0;
  v27 = v7;
  v48 = v27;
  v28 = v22;
  ...
  v30 = v25;
  v51 = v30;
  objc_msgSend(v26, "enumerateKeysAndObjectsUsingBlock:", v47);
...
LABEL_27:
  ...
  if (v21 == v46 && v32 == v26)
    ...
    v35 = -[PXCMMSharedAlbumsInvitationsDataSourceState initWithSharedAlbums:invitationsBySharedAlbumObjectID:]([PXCMMSharedAlbumsInvitationsDataSourceState alloc], "initWithSharedAlbums:invitationsBySharedAlbumObjectID:", v21, v32);
  v42 = v35;
...
void __84__PXCMMSharedAlbumsInvitationsDataSourceState_stateUpdatedWithChange_changeDetails___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  +[PXCMMSharedAlbumInvitation invitationWithAssetCollection:](PXCMMSharedAlbumInvitation, "invitationWithAssetCollection:", v3);
