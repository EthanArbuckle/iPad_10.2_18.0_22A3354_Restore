...
void ___UpdateRulesForLibraryScope_block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = a2;
  if (!objc_msgSend(v5, "contactType"))
  {
...
void ___UpdateRulesForLibraryScope_block_invoke_461(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
  id v5;
...
void ___UpdateRulesForLibraryScope_block_invoke_2(uint64_t a1)
{
  ...
  objc_msgSend(v7, "setAutoSharePolicy:", *(__int16 *)(a1 + 56));
  if (*(_WORD *)(a1 + 56) == 2)
  {
    ...
    if (*(_QWORD *)(a1 + 40))
    {
      ...
      PXSharedLibraryDateConditionForSelectedStartDate(*(void **)(a1 + 40));
      v4 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(*(id *)(a1 + 48), "count"))
    {
      ...
      PXSharedLibraryPersonConditionForSelectedPeople(*(void **)(a1 + 48));
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "addCondition:", v6);
      objc_msgSend(v2, "addObject:", v5);

    }
    objc_msgSend(v7, "updateWithCustomRules:", v2);
...
void ___UpdateRulesForLibraryScope_block_invoke_3(uint64_t a1, int a2, void *a3)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1A6789000, v7, OS_SIGNPOST_INTERVAL_END, v8, "UpdateRulesForLibraryScope", ", buf, 2u);
  }
...
LABEL_10:
  ...
  if (v16)
  {
    ...
    block[1] = 3221225472;
    block[2] = ___UpdateRulesForLibraryScope_block_invoke_465;
...
uint64_t ___UpdateRulesForLibraryScope_block_invoke_465(uint64_t a1)
{
  return (*(uint64_t (**)(_QWORD, _QWORD, _QWORD))(*(_QWORD *)(a1 + 40) + 16))(*(_QWORD *)(a1 + 40), *(unsigned __int8 *)(a1 + 48), *(_QWORD *)(a1 + 32));
}

uint64_t ___UpdateRulesForLibraryScope_block_invoke_462(uint64_t a1, void *a2)
{
