...
{
  id v8;
  PXCuratedLibraryCurationDebugActionPerformer *v9;
  ...
  v9 = -[PXCuratedLibraryAssetCollectionActionPerformer initWithActionType:viewModel:assetCollectionReference:](&v12, sel_initWithActionType_viewModel_assetCollectionReference_, CFSTR("PXCuratedLibraryActionCurationDebug"), a3, a4);
  v10 = v9;
  if (v9)
...
- (id)activityType
{
  ...
  v2 = CFSTR("PXActivityTypeDebugCuration");
  return CFSTR("PXActivityTypeDebugCuration");
}
...
- (BOOL)canPerformWithActivityItems:(id)a3 forActivity:(id)a4
{
  ...
  -[PXCuratedLibraryCurationDebugActionPerformer activityType](self, "activityType");
  ...
  if ((v9 & 1) == 0)
  {
    ...
    v6 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXCuratedLibraryAssetCollectionActionPerformer.m"), 541, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("PXStringEqualToString(activity.activityType, self.activityType)"));
LABEL_5:
...
- (void)performUserInteractionTask
{
  ...
  -[PXCuratedLibraryCurationDebugActionPerformer layoutForDiagnosticDescription](self, "layoutForDiagnosticDescription");
  ...
  if (v3)
  {
    ...
    -[PXCuratedAssetCollectionDiagnosticsViewController setShouldPresentTapToRadar:](v6, "setShouldPresentTapToRadar:", 0);
