...
- (PXFloatingCardSpringInfo)initWithMass:(double)a3 stiffness:(double)a4 damping:(double)a5 initialVelocity:(double)a6
{
  ...
  v11 = -[PXFloatingCardSpringInfo init](&v90, sel_init);
  if (v11)
  {
    if (a3 <= 0.0)
    {
      ...
      objc_msgSend(v80, "handleFailureInMethod:object:file:lineNumber:description:", a2, v11, CFSTR("PXFloatingCardSpringInfo.mm"), 396, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("mass > 0"));
    ...
    if (a4 <= 0.0)
    {
      ...
      objc_msgSend(v81, "handleFailureInMethod:object:file:lineNumber:description:", a2, v11, CFSTR("PXFloatingCardSpringInfo.mm"), 397, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("stiffness > 0"));
    ...
    if (a5 <= 0.0)
    {
      ...
      objc_msgSend(v82, "handleFailureInMethod:object:file:lineNumber:description:", a2, v11, CFSTR("PXFloatingCardSpringInfo.mm"), 398, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("damping > 0"));
    ...
    if (v94 < 1.0)
    {
      ...
      v29 = log(0.001 / fabs(v88 * v28.__sinval + v12 * v28.__cosval));
      v30 = v98;
      v31 = v99;
      v83 = v93;
      v32 = -v29 / (v87 * v93);
      ...
      v43 = v41 * (v88 * v42.__sinval + v12 * v42.__cosval);
      if (v43 <= 1.0)
      {
        v44 = -1.0;
        if (v43 != 1.0)
...
LABEL_82:
    ...
    if (v92 != 0.0)
    {
      ...
      do
      {
        derivative = SpringUtils::Spring::first_derivative((SpringUtils::Spring *)v91, v46);
...
LABEL_49:
    ...
    {
      v63 = exp(-(v32 * v53));
      v64 = SpringUtils::Spring::first_derivative((SpringUtils::Spring *)v91, v32);
      if (fabs(v64) <= 2.22044605e-16 || (*(_QWORD *)&v64 & 0x7FFFFFFFFFFFFFFFuLL) > 0x7FEFFFFFFFFFFFFFLL)
        break;
      v32 = v32 - ((v52 + v51 * v32) * v63 + dbl_1A7C0C900[(v52 + v51 * v32) * v63 < 0.0]) / v64;
      if (!--v62)
      {
        if (v32 >= v86)
        {
...
LABEL_68:
    ...
    else
    {
      ...
      while (--v71)
      {
        ...
        v69 = v69 + v69;
        v70 = v89 + v69;
        if (((COERCE_UNSIGNED_INT64((v52 + v51 * (v89 + v69)) * exp(-((v89 + v69) * v53)) - v67) ^ *(_QWORD *)&v68) & 0x8000000000000000) != 0)
          goto LABEL_68;
      }
      v32 = -1.0;
    }
...
- (double)valueAtTime:(double)a3
{
  ...
  -[PXFloatingCardSpringInfo mass](self, "mass");
  v6 = v5;
  -[PXFloatingCardSpringInfo stiffness](self, "stiffness");
  v8 = v7;
  -[PXFloatingCardSpringInfo damping](self, "damping");
  v10 = v9;
  -[PXFloatingCardSpringInfo initialVelocity](self, "initialVelocity");
...
- (id)description
{
  ...
  -[PXFloatingCardSpringInfo mass](self, "mass", v27);
  v13 = v12;
  -[PXFloatingCardSpringInfo stiffness](self, "stiffness");
  v15 = v14;
  -[PXFloatingCardSpringInfo damping](self, "damping");
  ...
  -[PXFloatingCardSpringInfo initialVelocity](self, "initialVelocity");
  v19 = v18;
  -[PXFloatingCardSpringInfo undershootTime](self, "undershootTime");
  v21 = v20;
  -[PXFloatingCardSpringInfo overshootTime](self, "overshootTime");
  v23 = v22;
  -[PXFloatingCardSpringInfo settlingTime](self, "settlingTime");
