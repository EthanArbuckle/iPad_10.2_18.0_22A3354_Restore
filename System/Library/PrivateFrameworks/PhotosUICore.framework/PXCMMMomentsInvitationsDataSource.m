...
{
  id v5;
  PXCMMMomentsInvitationsDataSource *v6;
  PXCMMMomentsInvitationsDataSource *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)PXCMMMomentsInvitationsDataSource;
  v6 = -[PXCMMMomentsInvitationsDataSource init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (int64_t)numberOfItemsInSection:(int64_t)a3
{
  ...
  -[PXCMMMomentsInvitationsDataSource _state](self, "_state", a3);
...
- (id)objectAtIndexPath:(PXSimpleIndexPath *)a3
{
  ...
  if (dataSourceIdentifier != -[PXCMMMomentsInvitationsDataSource identifier](self, "identifier"))
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXCMMMomentsInvitationsDataSourceManager.m"), 359, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("indexPath.dataSourceIdentifier == self.identifier"));
...
LABEL_12:
    ...
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXCMMMomentsInvitationsDataSourceManager.m"), 371, CFSTR("Code which should be unreachable has been reached"));
  ...
  {
    v8 = CFSTR("PXCMMMomentsInvitationsDataSourceSection");
    return v8;
  }
  if (a3->subitem != 0x7FFFFFFFFFFFFFFFLL)
    goto LABEL_12;
  -[PXCMMMomentsInvitationsDataSource _state](self, "_state");
  ...
  -[PXCMMMomentsInvitationsDataSource invitationForObjectID:](self, "invitationForObjectID:", v12);
...
- (id)invitationAtItemIndexPath:(PXSimpleIndexPath *)a3
{
  ...
  v5[1] = v3;
  -[PXCMMMomentsInvitationsDataSource objectAtIndexPath:](self, "objectAtIndexPath:", v5);
...
- (id)objectIDAtItemIndexPath:(PXSimpleIndexPath *)a3
{
  ...
  if (item >= v10)
  {
    ...
    objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXCMMMomentsInvitationsDataSourceManager.m"), 383, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("indexPath.item < self._state.assetCollections.fetchedObjectIDs.count"));
...
- (id)invitationForObjectID:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXCMMMomentsInvitationsDataSourceManager.m"), 389, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("assetCollectionObjectID"));

  }
  -[PXCMMMomentsInvitationsDataSource _state](self, "_state");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "invitationsByAssetCollectionObjectID");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v8)
  {
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    +[PXCMMMomentsInvitation invitationWithAssetCollection:](PXCMMMomentsInvitation, "invitationWithAssetCollection:", v14);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v6)
    {
      ...
      if (v17 != v7 && v18 != 0x7FFFFFFFFFFFFFFFLL && v19 == 0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        if ((isKindOfClass & 1) != 0)
        {
          ...
          {
            v21 = (unint64_t)-[PXCMMMomentsInvitationsDataSource identifier](self, "identifier");
            *(_QWORD *)&v22 = v14;
