...
{
  if (a3 == 2)
    return CFSTR("(Internal) Asset Details");
  else
    return CFSTR("Asset Details");
}
...
- (void)performUserInteractionTask
{
  ...
  if (v7)
  {
    +[PXGraphDiagnosticsService viewControllerForDetailsOfAsset:](PXGraphDiagnosticsService, "viewControllerForDetailsOfAsset:", v7);
