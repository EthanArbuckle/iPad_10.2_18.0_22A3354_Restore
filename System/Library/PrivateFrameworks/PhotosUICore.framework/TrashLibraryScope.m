...
void ___TrashLibraryScope_block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v1, "trashLibraryScopes:", v2);
...
void ___TrashLibraryScope_block_invoke_2(uint64_t a1, int a2, void *a3)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1A6789000, v7, OS_SIGNPOST_INTERVAL_END, v8, "TrashLibraryScope", ", buf, 2u);
  }
...
LABEL_10:
  ...
  if (v16)
  {
    ...
    block[1] = 3221225472;
    block[2] = ___TrashLibraryScope_block_invoke_479;
...
uint64_t ___TrashLibraryScope_block_invoke_479(uint64_t a1)
{
