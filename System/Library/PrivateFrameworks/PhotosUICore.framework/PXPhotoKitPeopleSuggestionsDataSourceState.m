...
- (PXPhotoKitPeopleSuggestionsDataSourceState)initWithPeople:(id)a3 personSuggestionsByPerson:(id)a4
{
  id v7;
  id v8;
  PXPhotoKitPeopleSuggestionsDataSourceState *v9;
  PXPhotoKitPeopleSuggestionsDataSourceState *v10;
  objc_super v12;
  ...
  v9 = -[PXPhotoKitPeopleSuggestionsDataSourceState init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)stateUpdatedWithChange:(id)a3 changeDetails:(id *)a4
{
  ...
  void *v32;
  void *v33;
  PXPhotoKitPeopleSuggestionsDataSourceState *v34;
  id v35;
  void *v36;
  void *v37;
  void *v38;
  void *v39;
  PXPhotoKitPeopleSuggestionsDataSourceState *v41;
  void *v42;
  void *v44;
  _QWORD v45[4];
  id v46;
  ...
  v5 = a3;
  -[PXPhotoKitPeopleSuggestionsDataSourceState people](self, "people");
  ...
  -[PXPhotoKitPeopleSuggestionsDataSourceState personSuggestionsByPerson](self, "personSuggestionsByPerson");
...
LABEL_27:
  ...
  if (v27 == v6 && v31 == v25)
    ...
    v34 = -[PXPhotoKitPeopleSuggestionsDataSourceState initWithPeople:personSuggestionsByPerson:]([PXPhotoKitPeopleSuggestionsDataSourceState alloc], "initWithPeople:personSuggestionsByPerson:", v27, v31);
  v41 = v34;
...
void __83__PXPhotoKitPeopleSuggestionsDataSourceState_stateUpdatedWithChange_changeDetails___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  +[PXPhotoKitPersonSuggestion personSuggestionWithPerson:](PXPhotoKitPersonSuggestion, "personSuggestionWithPerson:", v3);
...
void __83__PXPhotoKitPeopleSuggestionsDataSourceState_stateUpdatedWithChange_changeDetails___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
    goto LABEL_14;
  v7 = objc_msgSend(*(id *)(a1 + 40), "indexOfObject:", v18);
  if (v7 != 0x7FFFFFFFFFFFFFFFLL)
  {
    v8 = v7;
    objc_msgSend(v5, "keyFaceFetchResult");
    ...
    if (v9)
    {
      ...
      if (v13)
      {
        objc_msgSend(v13, "fetchResultAfterChanges");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v5, "personSuggestionUpdatedKeyFaceFetchResult:", v14);
    ...
    if (v6)
    {
      ...
      objc_msgSend(v16, "changeDetailsForFetchResult:", v17);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v13)
      {
        objc_msgSend(v13, "fetchResultAfterChanges");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v5, "personSuggestionUpdatedKeyAssetFetchResult:", v14);
        v15 = objc_claimAutoreleasedReturnValue();
LABEL_9:
        v6 = (void *)v15;
