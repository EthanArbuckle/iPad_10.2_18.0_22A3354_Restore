...
- (PXCuratedLibraryToggleImageFilterActionPerformer)initWithViewModel:(id)a3
{
  ...
  return -[PXCuratedLibraryActionPerformer initWithActionType:viewModel:](&v4, sel_initWithActionType_viewModel_, CFSTR("PXCuratedLibraryActionToggleImageFilter"), a3);
}
...
- (id)activityType
{
  ...
  v2 = CFSTR("PXActivityTypeToggleImagesFilter");
  return CFSTR("PXActivityTypeToggleImagesFilter");
}
...
- (int64_t)menuElementState
{
  ...
  v3 = objc_msgSend(v2, "isContentFilterActive:", 7);
...
- (id)localizedTitleForUseCase:(unint64_t)a3
{
  ...
  if (a3 == 1)
  {
    ...
    if (v6)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PXCuratedLibraryToggleImageFilterActionPerformer.m"), 42, CFSTR("%@ should be nil or an instance inheriting from %@, but it is %@"), CFSTR("self.viewModel.allPhotosContentFilterState"), v12, v13);

      }
    }
    if (objc_msgSend(v6, "image"))
      v7 = CFSTR("DISABLE_IMAGES_FILTER_SHORTCUT");
    else
      v7 = CFSTR("ENABLE_IMAGES_FILTER_SHORTCUT");
  ...
  {
    PXContentFilterTitleForItemTag(7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v8;
}
