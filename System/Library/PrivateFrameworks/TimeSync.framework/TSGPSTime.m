...
- (TSGPSTime)initWithNanosecondsSinceEpoch:(unint64_t)a3
{
  ...
  result = -[TSGPSTime init](&v5, sel_init);
  if (result)
...
- (unsigned)week
{
  return -[TSGPSTime extendedWeek](self, "extendedWeek") & 0x3FF;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()) & 1) != 0
    || -[TSGPSTime isMemberOfClass:](self, "isMemberOfClass:", objc_opt_class()))
  {
...
- (id)description
{
  ...
  v4 = -[TSGPSTime extendedWeek](self, "extendedWeek");
  -[TSGPSTime seconds](self, "seconds");
  return (id)objc_msgSend(v3, "stringWithFormat:", CFSTR("GPS Time week %u seconds %0.9f"), v4, v5);
}
