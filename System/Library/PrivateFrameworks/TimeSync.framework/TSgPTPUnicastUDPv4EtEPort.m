...
- (TSgPTPUnicastUDPv4EtEPort)initWithImplDC:(id)a3
{
  ...
  {
    v6 = v4;
    self = (TSgPTPUnicastUDPv4EtEPort *)*((_QWORD *)v5 + 8);
    *((_QWORD *)v5 + 8) = v6;
LABEL_4:
...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("_impl.destinationIPv4Address"), 0);
}

- (NSNumber)destinationIPv4Address
{
  return -[_TSF_TSDgPTPUnicastUDPv4EtEPort destinationIPv4Address](self->_impl, "destinationIPv4Address");
}
