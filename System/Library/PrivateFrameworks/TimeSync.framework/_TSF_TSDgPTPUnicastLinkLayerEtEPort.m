...
{
  _TSF_TSDgPTPUnicastLinkLayerEtEPort *v4;
  _TSF_TSDgPTPUnicastLinkLayerEtEPort *v5;
  uint64_t v6;
  ...
  if (v4)
  {
    -[_TSF_TSDgPTPUnicastLinkLayerEtEPort _destinationMACAddress](v4, "_destinationMACAddress");
