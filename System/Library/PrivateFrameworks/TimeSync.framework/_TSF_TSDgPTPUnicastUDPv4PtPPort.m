...
{
  _TSF_TSDgPTPUnicastUDPv4PtPPort *v4;
  _TSF_TSDgPTPUnicastUDPv4PtPPort *v5;
  uint64_t v6;
  ...
  if (v4)
  {
    -[_TSF_TSDgPTPUnicastUDPv4PtPPort _destinationIPv4Address](v4, "_destinationIPv4Address");
