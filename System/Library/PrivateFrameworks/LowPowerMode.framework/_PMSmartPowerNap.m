...
- (_PMSmartPowerNap)init
{
  ...
  v40.receiver = self;
  v40.super_class = (Class)_PMSmartPowerNap;
  v2 = -[_PMSmartPowerNap init](&v40, sel_init);
  v3 = os_log_create("com.apple.powerd", "smartpowernap");
  v4 = (void *)smartpowernap_log;
  smartpowernap_log = (uint64_t)v3;

  if (!v2)
    return v2;
  v5 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1988]), "initWithMachServiceName:options:", CFSTR("com.apple.powerd.smartpowernap"), 4096);
  connection = v2->_connection;
  v2->_connection = (NSXPCConnection *)v5;

  objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_254616760);
  ...
  objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_2546167D0);
...
LABEL_7:
  ...
  v16 = notify_register_dispatch("com.apple.system.powermanagement.assertionresync", (int *)&init_resync_token, v14, handler);

  if ((_DWORD)v16)
  {
    v17 = smartpowernap_log;
    if (smartpowernap_log)
    {
...
LABEL_9:
    ...
    -[NSXPCConnection remoteObjectProxyWithErrorHandler:](self->_connection, "remoteObjectProxyWithErrorHandler:", &__block_literal_global, *(_OWORD *)v15);
...
- (void)unregister
{
  OUTLINED_FUNCTION_6(&dword_20AB79000, a1, a3, "unregister called without registering", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_3();
}
...
- (void)setState:(unsigned __int8)a3
{
  ...
  if (smartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)smartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v6 = v5;
LABEL_6:
      _os_log_impl(&dword_20AB79000, v6, OS_LOG_TYPE_DEFAULT, "Updating state to %d", (uint8_t *)&v8, 8u);
    }
  }
  else if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEFAULT))
  {
...
- (void)setSPNReentryCoolOffPeriod:(unsigned int)a3
{
  ...
  if (smartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)smartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v7 = v5;
LABEL_6:
      _os_log_impl(&dword_20AB79000, v7, OS_LOG_TYPE_DEFAULT, "Updating SPN Re-entry cool off period", v6, 2u);
    }
  }
  else if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEFAULT))
  {
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setSPNReentryCoolOffPeriod:", v3);
...
- (void)setSPNReentryDelaySeconds:(unsigned int)a3
{
  ...
  if (smartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)smartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v7 = v5;
LABEL_6:
      _os_log_impl(&dword_20AB79000, v7, OS_LOG_TYPE_DEFAULT, "Updating SPN Re-entry delay", v6, 2u);
    }
  }
  else if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEFAULT))
  {
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setSPNReentryDelaySeconds:", v3);
...
- (void)setSPNRequeryDelta:(unsigned int)a3
{
  ...
  if (smartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)smartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v7 = v5;
LABEL_6:
      _os_log_impl(&dword_20AB79000, v7, OS_LOG_TYPE_DEFAULT, "Updating SPN Re-query delay", v6, 2u);
    }
  }
  else if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEFAULT))
  {
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setSPNRequeryDelta:", v3);
...
- (void)setSPNMotionAlarmThreshold:(unsigned int)a3
{
  ...
  if (smartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)smartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v7 = v5;
LABEL_6:
      _os_log_impl(&dword_20AB79000, v7, OS_LOG_TYPE_DEFAULT, "Updating SPN motion alarm threshold", v6, 2u);
    }
  }
  else if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEFAULT))
  {
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setSPNMotionAlarmThreshold:", v3);
...
- (void)setSPNMotionAlarmStartThreshold:(unsigned int)a3
{
  ...
  if (smartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)smartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v7 = v5;
LABEL_6:
      _os_log_impl(&dword_20AB79000, v7, OS_LOG_TYPE_DEFAULT, "Updating SPN motion alarm start threshold", v6, 2u);
    }
  }
  else if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEFAULT))
  {
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setSPNMotionAlarmStartThreshold:", v3);
...
- (void)init
{
  OUTLINED_FUNCTION_5(&dword_20AB79000, a2, a3, "Failed to register for reconnect with powerd 0x%x", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_3();
}

- (void)registerWithIdentifier:(uint64_t)a3 .cold.1(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  OUTLINED_FUNCTION_4(&dword_20AB79000, a1, a3, "Failed to register. Expected non-null identifier", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_3();
}
