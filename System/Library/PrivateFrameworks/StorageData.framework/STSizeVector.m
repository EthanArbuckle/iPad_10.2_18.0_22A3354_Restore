...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    objc_opt_class();
    v5 = (objc_opt_isKindOfClass() & 1) != 0 && -[STSizeVector isEqualToSizeVector:](self, "isEqualToSizeVector:", v4);
  }
...
void __20__STSizeVector_zero__block_invoke()
{
  uint64_t v0;
  void *v1;

  +[STSizeVector fixed:](STSizeVector, "fixed:", 0);
...
- (id)plus:(id)a3
{
  ...
  return -[STSizeVector initWithFixed:docsAndData:purgeable:](v5, "initWithFixed:docsAndData:purgeable:", v7, v9, v11 + purgeable);
}
...
- (STSizeVector)initWithFixed:(int64_t)a3 docsAndData:(int64_t)a4 purgeable:(int64_t)a5
{
  ...
  result = -[STSizeVector init](&v9, sel_init);
  if (result)
  {
    result->_fixed = a3;
...
{
  return (id)objc_msgSend(a1, "fixed:docsAndData:purgeable:", a3, 0, a4);
}
...
{
  return (id)objc_msgSend(a1, "fixed:docsAndData:purgeable:", 0, a3 - a4, a4);
}
...
- (STSizeVector)initWithCoder:(id)a3
{
  ...
  v5 = -[STSizeVector init](&v7, sel_init);
  if (v5)
  {
