@implementation REGetDisableAllModelPredictions
...
void __REGetDisableAllModelPredictions_block_invoke_2()
{
  ...
  v1 = objc_msgSend(v0, "_BOOLValueForKey:set:", CFSTR("DisableAllModelPredictions"), &v6);
  if (v6)
    v2 = v1;
  else
    v2 = 0;
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)&buf[4] = v4;
    _os_log_impl(&dword_2132F7000, v3, OS_LOG_TYPE_DEFAULT, "Prefs reading value for key DisableAllModelPredictions: %@", buf, 0xCu);
