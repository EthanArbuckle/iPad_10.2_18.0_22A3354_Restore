@implementation RELoadOperatorCharacterMap
...
void __RELoadOperatorCharacterMap_block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BDBCED8], "dictionaryWithCapacity:", objc_msgSend(&unk_24CFC1C58, "count"));
  v0 = (void *)objc_claimAutoreleasedReturnValue();
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
  v24 = 0u;
  v1 = objc_msgSend(&unk_24CFC1C58, "countByEnumeratingWithState:objects:count:", &v21, v26, 16);
  if (v1)
  {
    v2 = v1;
    v3 = *(_QWORD *)v22;
    do
    {
      ...
      {
        if (*(_QWORD *)v22 != v3)
          objc_enumerationMutation(&unk_24CFC1C58);
      ...
      v2 = objc_msgSend(&unk_24CFC1C58, "countByEnumeratingWithState:objects:count:", &v21, v26, 16);
    }
    while (v2);
  }
  v7 = objc_msgSend(v0, "copy");
  v8 = (void *)REOperatorTokenMap;
  ...
  v16 = (void *)REOperatorCharacterSet;
