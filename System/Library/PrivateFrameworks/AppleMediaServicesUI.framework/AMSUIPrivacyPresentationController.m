...
{
  AMSUIPrivacyPresentationController *v4;
  AMSUIPrivacyPresentationController *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)AMSUIPrivacyPresentationController;
  v4 = -[AMSUIPrivacyPresentationController initWithPresentedViewController:presentingViewController:](&v7, sel_initWithPresentedViewController_presentingViewController_, a3, a4);
  v5 = v4;
  if (v4)
    -[AMSUIPrivacyPresentationController setDelegate:](v4, "setDelegate:", v4);
  return v5;
}
...
- (void)containerViewWillLayoutSubviews
{
  ...
  -[AMSUIPrivacyPresentationController _prepareDimmingViewIfNecessary](self, "_prepareDimmingViewIfNecessary");
  -[AMSUIPrivacyPresentationController presentedViewController](self, "presentedViewController");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "view");
  v21 = (id)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v21, "_setContinuousCornerRadius:", 16.0);
  -[AMSUIPrivacyPresentationController containerView](self, "containerView");
...
- (void)containerViewDidLayoutSubviews
{
  ...
  -[AMSUIPrivacyPresentationController containerViewDidLayoutSubviews](&v14, sel_containerViewDidLayoutSubviews);
  -[AMSUIPrivacyPresentationController dimmingView](self, "dimmingView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_prepareDimmingViewIfNecessary
{
  ...
  if (!v3 && v10)
  {
    ...
    -[AMSUIPrivacyPresentationController setDimmingView:](self, "setDimmingView:", v8);
...
- (void)presentationTransitionWillBegin
{
  ...
  -[AMSUIPrivacyPresentationController presentedView](self, "presentedView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
