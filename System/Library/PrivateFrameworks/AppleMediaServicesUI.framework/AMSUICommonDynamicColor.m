...
+ (id)dynamicColorWithLightColor:(id)a3 darkColor:(id)a4 lightHighContrastColor:(id)a5 darkHighContrastColor:(id)a6
{
  ...
  v32[0] = v14;
  objc_msgSend(MEMORY[0x24BEBDAB0], "_traitCollectionWithContrast:", 1);
  ...
  objc_msgSend(MEMORY[0x24BEBDAB0], "traitCollectionWithUserInterfaceStyle:", 0);
  ...
  objc_msgSend(MEMORY[0x24BEBD4B8], "_dynamicColorWithColorsByTraitCollection:", v26);
