...
- (id)_presentedViewControllerForContext:(id)a3
{
  ...
  if (-[AMSUIPrivacyAnimatedTransitioning isPresentation](self, "isPresentation"))
    v8 = v7;
  else
    v8 = v6;
  v9 = v8;
...
- (void)animateTransition:(id)a3
{
  ...
  v7 = v4;
  v5 = v4;
  -[AMSUIPrivacyAnimatedTransitioning _animateTransition:completionBlock:](self, "_animateTransition:completionBlock:", v5, v6);
...
- (void)_animateTransition:(id)a3 completionBlock:(id)a4
{
  ...
  v9 = -[AMSUIPrivacyAnimatedTransitioning isPresentation](self, "isPresentation");
  -[AMSUIPrivacyAnimatedTransitioning _presentedViewControllerForContext:](self, "_presentedViewControllerForContext:", v7);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "view");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "layoutIfNeeded");
  -[AMSUIPrivacyAnimatedTransitioning transitionDuration:](self, "transitionDuration:", v7);
  v13 = v12;
