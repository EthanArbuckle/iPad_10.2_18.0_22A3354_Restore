...
{
  AMSUIAccountMessageAppearance *result;
  objc_super v3;
...
{
  id v4;
  AMSUIAccountMessageAppearance *v5;
  uint64_t v6;
  ...
  v5 = -[AMSUIAppearance initWithDictionary:](&v31, sel_initWithDictionary_, v4);
  if (v5)
  {
    ...
    v5->_impressionAnimationStyle = -[AMSUIAccountMessageAppearance _animationStyleWithDictionary:](v5, "_animationStyleWithDictionary:", v4);
    ...
    -[AMSUIAccountMessageAppearance _setImageStyleWithDictionary:](v5, "_setImageStyleWithDictionary:", v4);
  }
...
- (int64_t)_animationStyleWithDictionary:(id)a3
{
  ...
  +[AMSUIAppearance _impressionAnimationIdentifierWithDictionary:](AMSUIAppearance, "_impressionAnimationIdentifierWithDictionary:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  +[؋ objectForKeyedSubscript:](&unk_24CB8C690, "objectForKeyedSubscript:", v3);
