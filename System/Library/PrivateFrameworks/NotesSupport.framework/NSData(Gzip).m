  ...
  if (!inflateInit2_(&strm, 47, "1.2.12", 112))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        -[NSData(Gzip) ic_gzipInflate].cold.2(v13, v15);
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      -[NSData(Gzip) ic_gzipInflate].cold.1(v16);
...
- (void)ic_gzipInflate
{
  ...
  v2[0] = 67109120;
  v2[1] = a1;
  _os_log_error_impl(&dword_1DDAA5000, a2, OS_LOG_TYPE_ERROR, "inflate failed returned %d", (uint8_t *)v2, 8u);
}
