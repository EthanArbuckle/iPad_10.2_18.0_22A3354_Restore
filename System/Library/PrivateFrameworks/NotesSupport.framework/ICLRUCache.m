...
void __29__ICLRUCache_cacheCollection__block_invoke()
{
  uint64_t v0;
  void *v1;
  ...
  v1 = (void *)cacheCollection_sCacheCollection_0;
  cacheCollection_sCacheCollection_0 = v0;
...
- (ICLRUCache)initWithMaxSize:(unint64_t)a3
{
  ...
  v4 = -[ICLRUCache init](&v13, sel_init);
  v5 = v4;
  if (v4)
  {
    v4->mMax = a3;
    v6 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, a3);
    mData = v5->mData;
...
+ (id)cacheCollection
{
  ...
  return (id)cacheCollection_sCacheCollection_0;
}
...
- (void)setObject:(id)a3 forKey:(id)a4
{
  ...
  if (-[NSMutableArray count](self->mOrderedKeys, "count") >= self->mMax)
    -[ICLRUCache p_removeOldestObject](self, "p_removeOldestObject");
...
+ (void)purgeAllCaches
{
  ...
  v10 = 0u;
  v11 = 0u;
  +[ICLRUCache cacheCollection](ICLRUCache, "cacheCollection", 0);
...
- (void)p_removeOldestObject
{
  ...
  -[ICLRUCache delegate](self, "delegate");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (ICLRUCacheDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
