...
- (ICArchiveReader)initWithSourceURL:(id)a3 destinationURL:(id)a4
{
  ...
  v8 = -[ICArchiveReader init](&v14, sel_init);
  if (v8)
  {
...
- (BOOL)unarchiveResultURLs:(id *)a3 error:(id *)a4
{
  ...
  -[ICArchiveReader destinationPath](self, "destinationPath");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = objc_msgSend(v7, "createDirectoryAtPath:withIntermediateDirectories:attributes:error:", v8, 1, 0, a4);

  if (v9)
  {
    -[ICArchiveReader temporaryDirectoryWithError:](self, "temporaryDirectoryWithError:", a4);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if (v10
      && objc_msgSend(v7, "createDirectoryAtPath:withIntermediateDirectories:attributes:error:", v10, 1, 0, a4))
    {
      -[ICArchiveReader sourcePath](self, "sourcePath");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = -[ICArchiveReader unarchiveSourcePath:toDestinationPath:error:](self, "unarchiveSourcePath:toDestinationPath:error:", v11, v10, a4);

      if (v12)
      {
        -[ICArchiveReader destinationPath](self, "destinationPath");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        v14 = -[ICArchiveReader moveContentsOfDirectory:toDirectory:resultURLs:error:](self, "moveContentsOfDirectory:toDirectory:resultURLs:error:", v10, v13, a3, a4);
...
- (id)temporaryDirectoryWithError:(id *)a3
{
  ...
  if (-[ICArchiveReader writesTemporaryFilesInsideDestination](self, "writesTemporaryFilesInsideDestination"))
  {
    -[ICArchiveReader destinationPath](self, "destinationPath");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[ICArchiveReader destinationPath](self, "destinationPath");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "fileURLWithPath:", v8);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "URLForDirectory:inDomain:appropriateForURL:create:error:", 99, 1, v11, 1, a3);
...
- (BOOL)unarchiveSourcePath:(id)a3 toDestinationPath:(id)a4 error:(id *)a5
{
  ...
  v8 = -[ICArchiveReader skipsInvisibleHeaders](self, "skipsInvisibleHeaders");
  ...
  if (open_filename)
  {
    ...
    objc_msgSend(v12, "errorWithDomain:code:userInfo:", CFSTR("com.apple.notes"), v13, v16);
  ...
  else
  {
    ...
    while (1)
    {
      ...
      objc_msgSend(*(id *)(v19 + 2368), "stringWithUTF8String:", archive_entry_pathname());
      ...
      else
      {
        ...
        if (v24)
        {
          ...
          objc_msgSend(*(id *)(v26 + 2368), "stringWithFormat:", CFSTR("%s"), archive_error_string());
          v28 = (void *)objc_claimAutoreleasedReturnValue();
          v59[1] = v28;
          objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v59, v58, 2);
          v29 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v25, "errorWithDomain:code:userInfo:", CFSTR("com.apple.notes"), v27, v29);
        ...
        else
        {
          while (1)
          {
            ...
            if (archive_write_data_block())
            {
              ...
              objc_msgSend(*(id *)(v19 + 2368), "stringWithFormat:", CFSTR("%s"), archive_error_string());
              v32 = (void *)objc_claimAutoreleasedReturnValue();
              v65[1] = v32;
              objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v65, v64, 2);
              v33 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v46, "errorWithDomain:code:userInfo:", CFSTR("com.apple.notes"), -25, v33);
...
LABEL_17:
            ...
            v62[0] = v51;
            objc_msgSend(*(id *)(v36 + 2368), "stringWithFormat:", CFSTR("%s"), archive_error_string());
            ...
            v41 = (int)v11;
LABEL_18:
            objc_msgSend(v40, "errorWithDomain:code:userInfo:", CFSTR("com.apple.notes"), v41, v39);
    ...
    if (v36)
    {
      ...
      while (2)
      {
        for (i = 0; i != v36; ++i)
        {
          ...
          if (-[ICArchiveReader overwrite](self, "overwrite"))
          {
            v20 = (void *)v18;
...
LABEL_21:
          ...
          else
          {
            ...
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            -[ICArchiveReader incrementalPathInDirectory:withFilename:andExtension:](self, "incrementalPathInDirectory:withFilename:andExtension:", v11, v27, v28);
            v20 = (void *)v18;
            v26 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)incrementalPathInDirectory:(id)a3 withFilename:(id)a4 andExtension:(id)a5
{
  ...
  if (objc_msgSend(v12, "fileExistsAtPath:", v10))
  {
    ...
    do
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@ %lu"), v8, v13);
