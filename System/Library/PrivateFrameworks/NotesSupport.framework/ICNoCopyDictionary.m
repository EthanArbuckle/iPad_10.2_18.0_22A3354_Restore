...
{
  return -[ICNoCopyDictionary initWithCapacity:](self, "initWithCapacity:", 0);
}

- (ICNoCopyDictionary)initWithCFDictionary:(__CFDictionary *)a3
{
  ICNoCopyDictionary *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)ICNoCopyDictionary;
  v4 = -[ICNoCopyDictionary init](&v6, sel_init);
  if (v4)
...
- (ICNoCopyDictionary)initWithCapacity:(unint64_t)a3
{
  ...
  v4 = -[ICNoCopyDictionary init](&v6, sel_init);
  if (v4)
    v4->mDictionary = CFDictionaryCreateMutable(0, a3, MEMORY[0x1E0C9B390], MEMORY[0x1E0C9B3A0]);
  return v4;
}
...
- (void)dealloc
{
  ...
  -[ICNoCopyDictionary dealloc](&v4, sel_dealloc);
}
...
LABEL_3:
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99778], CFSTR("Attempt to insert nil value into %@"), objc_opt_class());
    if (a4)
      goto LABEL_3;
  }
  +[ICAssert handleFailedAssertWithCondition:functionName:simulateCrash:showAlert:format:](ICAssert, "handleFailedAssertWithCondition:functionName:simulateCrash:showAlert:format:", "aKey != ((void *)0)", "-[ICNoCopyDictionary setObject:forUncopiedKey:]", 1, 0, CFSTR("Inserting a value into no-copy dictionary with a NULL key into %p! Object is %@"), self, a3);
}
...
{
  -[ICNoCopyDictionary getObjects:andKeys:count:](self, "getObjects:andKeys:count:", a3, a4, -1);
}
...
- (id)allValues
{
  ...
  v6 = (void *)objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v5, v4);
...
- (id)objectEnumerator
{
  return (id)objc_msgSend(-[ICNoCopyDictionary allValues](self, "allValues"), "objectEnumerator");
}
...
- (id)keyEnumerator
{
  return (id)objc_msgSend(-[ICNoCopyDictionary allKeys](self, "allKeys"), "objectEnumerator");
}
