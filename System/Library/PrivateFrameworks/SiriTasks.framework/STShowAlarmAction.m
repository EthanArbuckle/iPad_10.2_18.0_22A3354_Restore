...
{
  id v6;
  STShowAlarmAction *v7;
  STShowAlarmAction *v8;
  void *v10;
  objc_super v11;
  ...
  if (!v6)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("STShowAlarmAction.m"), 19, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("alarmIds"));

  }
  v11.receiver = self;
  v11.super_class = (Class)STShowAlarmAction;
  v7 = -[STShowAlarmAction init](&v11, sel_init);
  v8 = v7;
  if (v7)
