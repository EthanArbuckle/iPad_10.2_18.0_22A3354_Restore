...
{
  id v8;
  HPSConstrainedSiriLanguageSetting *v9;
  uint64_t v10;
  NSArray *items;

  v8 = a5;
  v9 = -[HPSSiriLanguageSetting initWithKeyPath:languageValue:](self, "initWithKeyPath:languageValue:", a3, a4);
  if (v9)
  {
...
{
  id v6;
  HPSConstrainedSiriLanguageSetting *v7;
  uint64_t v8;
  NSArray *items;

  v6 = a4;
  v7 = -[HPSSiriLanguageSetting initWithKeyPath:](self, "initWithKeyPath:", a3);
  if (v7)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HPSConstrainedSiriLanguageSetting items](self, "items");
...
{
  id v4;
  HPSConstrainedSiriLanguageSetting *v5;
  uint64_t v6;
  void *v7;
  uint64_t v8;
  NSArray *items;
  HPSConstrainedSiriLanguageSetting *v10;
  NSArray *v11;
  uint64_t v12;
  uint64_t v13;
  uint64_t v14;
