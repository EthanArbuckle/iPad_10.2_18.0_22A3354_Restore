...
- (MSHistoryMarkedLocationRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryMarkedLocationRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryMarkedLocationRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistoryMarkedLocation();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryMarkedLocationRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryMarkedLocationRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryMarkedLocationRequest *v3;
  void *v4;
...
{
  id v5;
  MSHistoryMarkedLocationRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSHistoryMarkedLocationRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSHistoryMarkedLocationRequest *v16;
  uint64_t v17;
