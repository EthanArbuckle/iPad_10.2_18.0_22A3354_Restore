...
- (MSRAPRecordRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSRAPRecordRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSRAPRecordRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for RAPRecord();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSRAPRecordRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSRAPRecordRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSRAPRecordRequest *v3;
  void *v4;
