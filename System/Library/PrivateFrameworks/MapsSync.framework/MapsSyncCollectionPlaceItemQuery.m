...
{
  return -[MapsSyncCollectionPlaceItemQuery initWithOptions:delegate:](self, sel_initWithOptions_delegate_, 0, a3);
}
...
- (void)fetchContents:(id)a3
{
  ...
  uint64_t v5;
  _QWORD *v6;
  _TtC8MapsSync32MapsSyncCollectionPlaceItemQuery *v7;
  ...
  *(_QWORD *)(v5 + 16) = v4;
  ...
  v7 = self;
  swift_retain();
  sub_1A4162A48((void (*)(_QWORD, _QWORD))sub_1A419C008, v6, 0);
...
- (void)fetchContentsWithCallbackQueue:(id)a3 completion:(id)a4
{
  ...
  _QWORD *v8;
  id v9;
  _TtC8MapsSync32MapsSyncCollectionPlaceItemQuery *v10;
  ...
  *(_QWORD *)(v7 + 16) = v6;
  ...
  v10 = self;
  swift_retain();
  sub_1A4162A48((void (*)(_QWORD, _QWORD))sub_1A419C008, v8, a3);
...
- (void)fetchQueryContents:(id)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v4;
  ...
  v7 = self;
  swift_retain();
  sub_1A4162A48((void (*)(_QWORD, _QWORD))sub_1A419C00C, v6, 0);
...
- (void)fetchQueryContentsWithCallbackQueue:(id)a3 completion:(id)a4
{
  ...
  *(_QWORD *)(v7 + 16) = v6;
  ...
  v10 = self;
  swift_retain();
  sub_1A4162A48((void (*)(_QWORD, _QWORD))sub_1A419C00C, v8, a3);
...
{
  id v5;
  _TtC8MapsSync32MapsSyncCollectionPlaceItemQuery *result;
