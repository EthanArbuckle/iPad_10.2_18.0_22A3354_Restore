...
- (MSHistoryDirectionsItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryDirectionsItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryDirectionsItemRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistoryDirectionsItem();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryDirectionsItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryDirectionsItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryDirectionsItemRequest *v3;
  void *v4;
...
{
  id v5;
  MSHistoryDirectionsItemRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSHistoryDirectionsItemRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSHistoryDirectionsItemRequest *v16;
  uint64_t v17;
