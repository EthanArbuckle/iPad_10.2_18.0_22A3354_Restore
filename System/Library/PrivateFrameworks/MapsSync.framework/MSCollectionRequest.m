...
- (MSCollectionRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSCollectionRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSCollectionRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for Collection();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSCollectionRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSCollectionRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSCollectionRequest *v3;
  void *v4;
