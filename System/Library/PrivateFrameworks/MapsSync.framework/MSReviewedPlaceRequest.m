...
- (MSReviewedPlaceRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSReviewedPlaceRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSReviewedPlaceRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for ReviewedPlace();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSReviewedPlaceRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSReviewedPlaceRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSReviewedPlaceRequest *v3;
  void *v4;
