...
- (MSHistoryPlaceItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryPlaceItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryPlaceItemRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistoryPlaceItem();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryPlaceItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryPlaceItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryPlaceItemRequest *v3;
  void *v4;
