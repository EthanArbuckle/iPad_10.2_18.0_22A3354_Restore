...
- (MSHistorySearchItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistorySearchItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistorySearchItemRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistorySearchItem();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistorySearchItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistorySearchItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistorySearchItemRequest *v3;
  void *v4;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSHistorySearchItemRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSHistorySearchItemRequest *v16;
  uint64_t v17;
