...
- (MSUserRouteRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSUserRouteRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSUserRouteRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for UserRoute();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSUserRouteRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSUserRouteRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSUserRouteRequest *v3;
  void *v4;
