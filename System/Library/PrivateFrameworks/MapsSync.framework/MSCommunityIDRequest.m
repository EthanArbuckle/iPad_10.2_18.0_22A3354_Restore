...
- (MSCommunityIDRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSCommunityIDRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSCommunityIDRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for CommunityID();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSCommunityIDRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSCommunityIDRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSCommunityIDRequest *v3;
  void *v4;
