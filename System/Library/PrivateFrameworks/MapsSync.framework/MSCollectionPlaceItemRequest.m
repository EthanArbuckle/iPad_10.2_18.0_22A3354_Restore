...
- (void)fetchWithSearchTerm:(NSString *)a3 sortDescriptors:(NSArray *)a4 range:(_TtC8MapsSync13MapsSyncRange *)a5 completionHandler:(id)a6
{
  ...
  NSString *v19;
  NSArray *v20;
  _TtC8MapsSync13MapsSyncRange *v21;
  MSCollectionPlaceItemRequest *v22;
  uint64_t v23;

  v11 = __swift_instantiateConcreteTypeFromMangledName(&qword_1ED1ABA28);
  ...
  v21 = a5;
  v22 = self;
  sub_1A423B080((uint64_t)v13, (uint64_t)&unk_1EE70E4C8, (uint64_t)v18);
  swift_release();
}
...
- (MSCollectionPlaceItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSCollectionPlaceItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSCollectionPlaceItemRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for CollectionPlaceItem();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSCollectionPlaceItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSCollectionPlaceItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSCollectionPlaceItemRequest *v3;
  void *v4;
...
{
  id v5;
  MSCollectionPlaceItemRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSCollectionPlaceItemRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSCollectionPlaceItemRequest *v16;
  uint64_t v17;
