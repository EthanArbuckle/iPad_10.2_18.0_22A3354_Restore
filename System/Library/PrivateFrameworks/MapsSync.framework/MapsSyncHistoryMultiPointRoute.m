...
{
  _TtC8MapsSync30MapsSyncHistoryMultiPointRoute *v2;
  void *v3;
...
- (GEOStorageRouteRequestStorage)routeRequestStorage
{
  ...
  uint64_t v5;
  id v6;
  _TtC8MapsSync30MapsSyncHistoryMultiPointRoute *v7;
  void *v8;

  v2 = *(_QWORD *)&self->super.super.super._managedObjectID[OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__routeRequestStorage];
  if (v2 >> 60 == 15)
  {
    v3 = 0;
  }
...
- (NSData)sharedETAData
{
  ...
  v2 = (uint64_t *)((char *)self + OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__sharedETAData);
  v3 = *(_QWORD *)&self->super.super.super._managedObjectID[OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__sharedETAData];
  if (v3 >> 60 == 15)
  {
    v4 = 0;
  }
...
- (NSString)vehicleIdentifier
{
  ...
  if (*(_QWORD *)&self->super.super.super._managedObjectID[OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__vehicleIdentifier])
  {
...
- (BOOL)isEqual:(id)a3
{
  _TtC8MapsSync30MapsSyncHistoryMultiPointRoute *v4;
  _TtC8MapsSync30MapsSyncHistoryMultiPointRoute *v5;
  char v6;
  _OWORD v8[2];
...
- (void)addEditWithBlock:(id)a3
{
  ...
  uint64_t v6;
  uint64_t v7;
  _TtC8MapsSync30MapsSyncHistoryMultiPointRoute *v8;
...
- (_TtC8MapsSync30MapsSyncHistoryMultiPointRoute)initWithObject:(id)a3
{
  ...
  v4 = a3;
  return (_TtC8MapsSync30MapsSyncHistoryMultiPointRoute *)sub_1A4129DB0(a3);
}

- (void).cxx_destruct
{
  sub_1A40D7778(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__routeRequestStorage), *(_QWORD *)&self->super.super.super._managedObjectID[OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__routeRequestStorage]);
  sub_1A40D7778(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__sharedETAData), *(_QWORD *)&self->super.super.super._managedObjectID[OBJC_IVAR____TtC8MapsSync30MapsSyncHistoryMultiPointRoute__sharedETAData]);
