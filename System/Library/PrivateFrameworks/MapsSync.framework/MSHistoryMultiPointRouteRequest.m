...
- (MSHistoryMultiPointRouteRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryMultiPointRouteRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryMultiPointRouteRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistoryMultiPointRoute();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryMultiPointRouteRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryMultiPointRouteRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryMultiPointRouteRequest *v3;
  void *v4;
...
{
  id v5;
  MSHistoryMultiPointRouteRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSHistoryMultiPointRouteRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSHistoryMultiPointRouteRequest *v16;
  uint64_t v17;
