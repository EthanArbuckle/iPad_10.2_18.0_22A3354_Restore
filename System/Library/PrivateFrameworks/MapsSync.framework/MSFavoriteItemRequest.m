...
- (MSFavoriteItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSFavoriteItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSFavoriteItemRequest)initWithStore:(id)a3
{
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSFavoriteItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSFavoriteItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSFavoriteItemRequest *v3;
  void *v4;
