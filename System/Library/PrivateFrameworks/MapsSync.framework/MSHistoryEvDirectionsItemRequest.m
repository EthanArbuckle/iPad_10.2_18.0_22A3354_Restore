...
- (MSHistoryEvDirectionsItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryEvDirectionsItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryEvDirectionsItemRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistoryEvDirectionsItem();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryEvDirectionsItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryEvDirectionsItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryEvDirectionsItemRequest *v3;
  void *v4;
...
{
  id v5;
  MSHistoryEvDirectionsItemRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSHistoryEvDirectionsItemRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSHistoryEvDirectionsItemRequest *v16;
  uint64_t v17;
