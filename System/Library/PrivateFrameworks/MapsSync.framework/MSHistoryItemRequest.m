...
- (MSHistoryItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryItemRequest)initWithStore:(id)a3
{
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryItemRequest *v3;
  void *v4;
