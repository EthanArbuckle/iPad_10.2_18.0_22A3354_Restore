...
- (MSHistoryCuratedCollectionRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryCuratedCollectionRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryCuratedCollectionRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistoryCuratedCollection();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryCuratedCollectionRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryCuratedCollectionRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryCuratedCollectionRequest *v3;
  void *v4;
...
{
  id v5;
  MSHistoryCuratedCollectionRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSHistoryCuratedCollectionRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSHistoryCuratedCollectionRequest *v16;
  uint64_t v17;
