...
- (MSCollectionItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSCollectionItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSCollectionItemRequest)initWithStore:(id)a3
{
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSCollectionItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSCollectionItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSCollectionItemRequest *v3;
  void *v4;
