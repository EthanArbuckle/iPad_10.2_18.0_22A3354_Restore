...
- (MSCachedCuratedCollectionRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSCachedCuratedCollectionRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSCachedCuratedCollectionRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for CachedCuratedCollection();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSCachedCuratedCollectionRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSCachedCuratedCollectionRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSCachedCuratedCollectionRequest *v3;
  void *v4;
...
{
  id v5;
  MSCachedCuratedCollectionRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSCachedCuratedCollectionRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSCachedCuratedCollectionRequest *v16;
  uint64_t v17;
