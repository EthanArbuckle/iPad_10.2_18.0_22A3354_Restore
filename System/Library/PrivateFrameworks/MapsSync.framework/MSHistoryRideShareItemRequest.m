...
- (MSHistoryRideShareItemRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSHistoryRideShareItemRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSHistoryRideShareItemRequest)initWithStore:(id)a3
{
  ...
  v5 = type metadata accessor for HistoryRideShareItem();
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryRideShareItemRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSHistoryRideShareItemRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSHistoryRideShareItemRequest *v3;
  void *v4;
...
{
  id v5;
  MSHistoryRideShareItemRequest *v6;
  void *v7;
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  _QWORD *v11;
  _QWORD *v12;
  MSHistoryRideShareItemRequest *v13;
  uint64_t v14;
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  MSHistoryRideShareItemRequest *v16;
  uint64_t v17;
