...
- (MSIncidentReportRequest)init
{
  if (qword_1ED1AB880 != -1)
    swift_once();
  return -[MSIncidentReportRequest initWithStore:](self, sel_initWithStore_, qword_1ED1AB9F0);
}
...
- (MSIncidentReportRequest)initWithStore:(id)a3
{
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSIncidentReportRequest__request) = v6;
  ...
  v7 = a3;
  return -[MSIncidentReportRequest init](&v9, sel_init);
}

- (id)fetchSyncAndReturnError:(id *)a3
{
  MSIncidentReportRequest *v3;
  void *v4;
