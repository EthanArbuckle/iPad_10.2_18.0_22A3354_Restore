...
{
  return -[CoreDAVItem initWithNameSpace:andName:](self, "initWithNameSpace:andName:", CFSTR("DAV:"), CFSTR("deny"));
}
...
- (id)description
{
  ...
  -[CoreDAVDenyItem privileges](self, "privileges");
...
- (void)write:(id)a3
{
  ...
  v14 = 0u;
  v15 = 0u;
  -[CoreDAVDenyItem privileges](self, "privileges", 0);
...
- (void)addPrivilege:(id)a3
{
  ...
  if (!v5)
  {
    ...
    -[CoreDAVDenyItem setPrivileges:](self, "setPrivileges:", v6);
