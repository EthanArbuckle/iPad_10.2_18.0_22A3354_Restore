...
{
  return -[CoreDAVItem initWithNameSpace:andName:](self, "initWithNameSpace:andName:", CFSTR("DAV:"), CFSTR("principal-search-property-set"));
}
...
- (id)description
{
  ...
  -[CoreDAVPrincipalSearchPropertySetItem principalSearchProperties](self, "principalSearchProperties");
...
+ (id)copyParseRules
{
  ...
  if (!v5)
  {
    ...
    +[CoreDAVParseRule ruleWithMinimumNumber:maximumNumber:nameSpace:elementName:objectClass:setterMethod:](CoreDAVParseRule, "ruleWithMinimumNumber:maximumNumber:nameSpace:elementName:objectClass:setterMethod:", 0, 0x7FFFFFFFLL, CFSTR("DAV:"), CFSTR("principal-search-property"), objc_opt_class(), sel_addPrincipalSearchProperty_);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@:%@"), CFSTR("DAV:"), CFSTR("principal-search-property"));
...
- (void)addPrincipalSearchProperty:(id)a3
{
  ...
  if (!v5)
  {
    ...
    -[CoreDAVPrincipalSearchPropertySetItem setPrincipalSearchProperties:](self, "setPrincipalSearchProperties:", v6);
...
{
  objc_storeStrong((id *)&self->_principalSearchProperties, a3);
}
