...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("SuggestedContactDetailUsed");
}
...
- (id)description
{
  ...
  -[SGM2SuggestedContactDetailUsed description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2SuggestedContactDetailUsed dictionaryRepresentation](self, "dictionaryRepresentation");
