...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("ContactCreated");
}
...
- (id)description
{
  ...
  -[SGM2ContactCreated description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2ContactCreated dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    ...
    {
      v9 = off_1E7DA7C88[app];
    }
    objc_msgSend(v4, "setObject:forKey:", v9, CFSTR("app"));
