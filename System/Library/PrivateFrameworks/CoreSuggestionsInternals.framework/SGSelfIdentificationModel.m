...
+ (id)newTransformerInstanceForLanguage:(id)a3
{
  ...
  +[SGTransformerInstance defaultSessionDescriptorForModelId:featureVersion:language:windowAndNgrams:](SGTransformerInstance, "defaultSessionDescriptorForModelId:featureVersion:language:windowAndNgrams:", CFSTR("SelfIdentification"), CFSTR("1.5"), v3);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (void *)MEMORY[0x1E0D19EE0];
  +[SGEntityMatchingTransformer withTargetMapping:phoneMapping:emailMapping:addressMapping:andDateMapping:](SGEntityMatchingTransformer, "withTargetMapping:phoneMapping:emailMapping:addressMapping:andDateMapping:", CFSTR("SG_TARGET_NAME"), CFSTR("SG_FEATURE_PHONENUMBER"), CFSTR("SG_FEATURE_EMAIL"), CFSTR("SG_FEATURE_ADDRESS"), CFSTR("SG_FEATURE_DATE"));
