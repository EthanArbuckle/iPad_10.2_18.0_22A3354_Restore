...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("SqliteErrors");
}
...
- (id)description
{
  ...
  -[SGM2SqliteErrors description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2SqliteErrors dictionaryRepresentation](self, "dictionaryRepresentation");
