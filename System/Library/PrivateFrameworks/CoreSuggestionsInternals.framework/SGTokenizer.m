...
+ (id)ftsTokenize:(id)a3
{
  ...
  v3 = a3;
  ITSListForFTSQuery = _createITSListForFTSQuery(v3);
  if (ITSListForFTSQuery)
  {
    v5 = (const void *)ITSListForFTSQuery;
    v6 = CFCharacterSetCreateWithCharactersInString(0, CFSTR("()\"));
    ...
    if (Count >= 1)
    {
      for (i = 0; i != Count; ++i)
      {
        ...
        if (v11)
        {
          ...
          if ((objc_msgSend(CFSTR("##&"), "isEqualToString:", v13) & 1) == 0)
...
+ (void)enumerateTokensInString:(id)a3 withRange:(_NSRange)a4 block:(id)a5
{
  ...
  else
  {
    ...
    objc_msgSend(v17, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("SGTokenizer.m"), 33, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("str"));
  ...
  objc_msgSend(v18, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("SGTokenizer.m"), 34, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));
...
LABEL_3:
  ...
  v20[0] = v13;
  v20[1] = 3221225472;
  v20[2] = __55__SGTokenizer_enumerateTokensInString_withRange_block___block_invoke_3;
  v20[3] = &unk_1E7DAF698;
  v23 = location;
  v24 = length;
  v21 = v10;
...
+ (id)ftsPrefix:(id)a3
{
  ...
  ITSListForFTSQuery = _createITSListForFTSQuery(a3);
  if (ITSListForFTSQuery)
  {
    v6 = (const void *)ITSListForFTSQuery;
    Count = ITSTokenListGetCount();
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", Count);
    if (Count >= 1)
    {
      for (i = 0; i != Count; ++i)
      {
        ...
        if (!v10)
        {
          objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("SGTokenizer.m"), 141, CFSTR("ITSTokenListCopyEscapedTokenAtIndex failed to get token at index %ld"), i);
...
id __55__SGTokenizer_enumerateTokensInString_withRange_block___block_invoke_2(uint64_t a1)
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40), CFSTR("SGTokenizer.m"), 52, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("locale"));
...
LABEL_8:
  ...
  if (!v6)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40), CFSTR("SGTokenizer.m"), 58, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("guardedTokenizer"));

  }
  v7 = objc_alloc(MEMORY[0x1E0D81600]);
