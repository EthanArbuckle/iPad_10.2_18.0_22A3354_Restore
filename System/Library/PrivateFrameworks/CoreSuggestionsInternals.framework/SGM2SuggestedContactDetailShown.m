...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("SuggestedContactDetailShown");
}
...
- (id)description
{
  ...
  -[SGM2SuggestedContactDetailShown description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2SuggestedContactDetailShown dictionaryRepresentation](self, "dictionaryRepresentation");
