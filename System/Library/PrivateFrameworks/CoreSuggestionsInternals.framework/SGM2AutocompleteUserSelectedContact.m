...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("AutocompleteUserSelectedContact");
}
...
- (id)description
{
  ...
  -[SGM2AutocompleteUserSelectedContact description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2AutocompleteUserSelectedContact dictionaryRepresentation](self, "dictionaryRepresentation");
