...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("UnknownShown");
}
...
- (id)description
{
  ...
  -[SGM2UnknownContactInformationShown description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2UnknownContactInformationShown dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v9, CFSTR("wasSuggestedContact"));

    has = (char)self->_has;
  }
  if ((has & 4) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_didInteractionLookup);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("didInteractionLookup"));
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 1) == 0)
  {
    if ((*(_BYTE *)&self->_has & 2) == 0)
      goto LABEL_5;
LABEL_9:
    *((_BYTE *)v4 + 24) = self->_wasSuggestedContact;
    *((_BYTE *)v4 + 28) |= 2u;
    if ((*(_BYTE *)&self->_has & 4) == 0)
      goto LABEL_7;
    goto LABEL_6;
...
LABEL_5:
  ...
  {
LABEL_6:
    *((_BYTE *)v4 + 25) = self->_didInteractionLookup;
    *((_BYTE *)v4 + 28) |= 4u;
  }
LABEL_7:
  ...
  *(_QWORD *)(v5 + 16) = v6;
  ...
  if ((has & 1) == 0)
  {
    if ((*(_BYTE *)&self->_has & 2) == 0)
      goto LABEL_3;
LABEL_7:
    *(_BYTE *)(v5 + 24) = self->_wasSuggestedContact;
    *(_BYTE *)(v5 + 28) |= 2u;
    if ((*(_BYTE *)&self->_has & 4) == 0)
      return (id)v5;
    goto LABEL_4;
...
LABEL_3:
  ...
  {
LABEL_4:
    *(_BYTE *)(v5 + 25) = self->_didInteractionLookup;
    *(_BYTE *)(v5 + 28) |= 4u;
  }
  return (id)v5;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 1) == 0)
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0)
      goto LABEL_5;
LABEL_9:
    self->_wasSuggestedContact = *((_BYTE *)v4 + 24);
    *(_BYTE *)&self->_has |= 2u;
    if ((*((_BYTE *)v4 + 28) & 4) == 0)
      goto LABEL_7;
    goto LABEL_6;
...
LABEL_5:
  ...
  {
LABEL_6:
    self->_didInteractionLookup = *((_BYTE *)v4 + 25);
    *(_BYTE *)&self->_has |= 4u;
  }
LABEL_7:
