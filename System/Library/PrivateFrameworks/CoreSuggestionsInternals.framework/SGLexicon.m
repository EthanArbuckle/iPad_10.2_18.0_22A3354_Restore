...
LABEL_24:
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_1C3607000, v21, OS_LOG_TYPE_ERROR, "SGLexicon: non utf-8 token passed", buf, 2u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      v30 = v9;
      _os_log_error_impl(&dword_1C3607000, v10, OS_LOG_TYPE_ERROR, "SGLexicon: Unable to load lexicon, %@", buf, 0xCu);
    }
  }
LABEL_18:
  v20 = 0;
...
void __45__SGLexicon__lexiconTokenForToken_inLexicon___block_invoke(uint64_t a1, uint64_t a2, _BYTE *a3)
{
  const __CFString *v5;
