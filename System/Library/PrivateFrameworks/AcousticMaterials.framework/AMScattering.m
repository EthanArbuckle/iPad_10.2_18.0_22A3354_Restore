...
- (AMScattering)initWithValues:(id)a3 error:(id *)a4
{
  ...
  v7 = -[AMScattering init](&v41, sel_init);
  ...
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCE30]), "initWithObjects:", CFSTR("materialName"), CFSTR("materialDescription"), CFSTR("frequencyBands"), CFSTR("scatteringUserData"), CFSTR("scatteringReferenceData"), CFSTR("uncertaintyReferenceData"), CFSTR("numDataPointsReferenceData"), CFSTR("totalNumDataSetsReferenceData"), 0);
...
LABEL_6:
  ...
  objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("scatteringUserData"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  decimalValuesFromCSV(v22);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  clampArrayValues(v23, &unk_24DE126D0, &unk_24DE126E8);
  v24 = objc_claimAutoreleasedReturnValue();
  scatteringUserData = v7->_scatteringUserData;
  v7->_scatteringUserData = (NSArray *)v24;

  objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("scatteringReferenceData"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  decimalValuesFromCSV(v26);
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  clampArrayValues(v27, &unk_24DE126D0, &unk_24DE126E8);
  ...
  clampArrayValues(v31, &unk_24DE126D0, &unk_24DE126E8);
  ...
  if (!-[AMScattering validatedWithoutError:](v7, "validatedWithoutError:", a4))
    goto LABEL_6;
  a4 = v7;
LABEL_7:
...
- (AMScattering)initWithMaterialName:(id)a3
{
  ...
  v5 = -[AMScattering init](&v15, sel_init);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    ...
    -[AMScattering materialName](v6, "materialName");
    ...
    -[AMScattering materialDescription](v6, "materialDescription");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[AMScattering frequencyBands](v6, "frequencyBands");
    ...
    -[AMScattering scatteringUserData](v6, "scatteringUserData");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    LODWORD(scatteringUserData) = -[NSArray isEqualToArray:](scatteringUserData, "isEqualToArray:", v14);

    if (!(_DWORD)scatteringUserData)
      goto LABEL_14;
    scatteringReferenceData = self->_scatteringReferenceData;
    -[AMScattering scatteringReferenceData](v6, "scatteringReferenceData");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    LODWORD(scatteringReferenceData) = -[NSArray isEqualToArray:](scatteringReferenceData, "isEqualToArray:", v16);

    if (!(_DWORD)scatteringReferenceData)
      goto LABEL_14;
    uncertaintyReferenceData = self->_uncertaintyReferenceData;
    -[AMScattering uncertaintyReferenceData](v6, "uncertaintyReferenceData");
    ...
    -[AMScattering numDataPointsReferenceData](v6, "numDataPointsReferenceData");
    ...
    if ((_DWORD)numDataPointsReferenceData)
    {
      ...
      v22 = totalNumDataSetsReferenceData == -[AMScattering totalNumDataSetsReferenceData](v6, "totalNumDataSetsReferenceData");
    }
    else
    {
LABEL_14:
...
- (BOOL)validatedWithoutError:(id *)a3
{
  ...
  if (-[NSArray count](self->_scatteringUserData, "count") == v5
    && -[NSArray count](self->_scatteringReferenceData, "count") == v5
...
LABEL_11:
    ...
    else
    {
      ...
      while (1)
      {
        -[NSArray objectAtIndexedSubscript:](self->_scatteringUserData, "objectAtIndexedSubscript:", v12, v25);
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        if (!valueIsBetween(v15, v14, &unk_24DE126E8))
          break;
        -[NSArray objectAtIndexedSubscript:](self->_scatteringReferenceData, "objectAtIndexedSubscript:", v12);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        if (!valueIsBetween(v16, v14, &unk_24DE126E8))
          goto LABEL_27;
        -[NSArray objectAtIndexedSubscript:](self->_uncertaintyReferenceData, "objectAtIndexedSubscript:", v12);
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        if (!valueIsBetween(v17, v14, &unk_24DE126E8))
        {
