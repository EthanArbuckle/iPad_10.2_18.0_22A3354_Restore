  ...
  if (!v34)
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)((char *)&v66 + 2) = v33;
      HIWORD(v66) = 1024;
      v67 = v9 - 8;
      _os_log_error_impl(&dword_1AFABF000, v43, OS_LOG_TYPE_ERROR, "%@: Unexpected length %d != %d", buf, 0x18u);
    }
...
LABEL_76:
  ...
  if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)((char *)&v56 + 2) = v47;
    HIWORD(v56) = 1024;
    v57 = v37;
    _os_log_error_impl(&dword_1AFABF000, v45, OS_LOG_TYPE_ERROR, "%@: Unexpected length %d != %d", v55, 0x18u);
  }
...
+ (id)atlasBackingWithUuid:(id)a3 structure:(CLKUIAtlasBackingStructure *)a4 data:(id)a5
{
  ...
  if (bytesPerPixel && a4->planeLength != a4->width * bytesPerPixel * a4->height)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&buf[30] = 1024;
      LODWORD(v36) = v32;
      _os_log_error_impl(&dword_1AFABF000, v27, OS_LOG_TYPE_ERROR, "%@: Invalid art plane length (%d) [width = %d, height = %d, bytesPerPixel = %d]", buf, 0x24u);
    }
...
+ (void)atlasBackingWithBytes:(NSObject *)a3 length:mmapFile:uuid:.cold.1(unsigned __int8 a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a2;
  WORD6(v3) = 1024;
  HIWORD(v3) = a1;
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, a2, a3, "%@: Invalid art header filter %d", v3, 0);
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithBytes:length:mmapFile:uuid:.cold.2()
{
  ...
  v2 = 3;
  _os_log_error_impl(&dword_1AFABF000, v0, OS_LOG_TYPE_ERROR, "%@: Invalid art header wrap %d", v1, 0x12u);
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithBytes:length:mmapFile:uuid:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_13(&dword_1AFABF000, v0, v1, "%@: Compression error", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithBytes:length:mmapFile:uuid:.cold.6()
{
  ...
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art header format %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithBytes:length:mmapFile:uuid:.cold.7()
{
  ...
  OUTLINED_FUNCTION_3_8();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art header planes %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithBytes:length:mmapFile:uuid:.cold.8()
{
  ...
  OUTLINED_FUNCTION_3_8();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art header height %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithBytes:length:mmapFile:uuid:.cold.9()
{
  ...
  OUTLINED_FUNCTION_3_8();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art header width %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithBytes:length:mmapFile:uuid:.cold.10()
{
  ...
  OUTLINED_FUNCTION_6_8();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid length %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithUuid:structure:data:.cold.1()
{
  ...
  OUTLINED_FUNCTION_7_18(*MEMORY[0x1E0C80C00]);
  OUTLINED_FUNCTION_1_10();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art structure filter %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithUuid:structure:data:.cold.2()
{
  ...
  OUTLINED_FUNCTION_5_12();
  OUTLINED_FUNCTION_4_13(&dword_1AFABF000, v0, v1, "%@: Invalid art structure bytes/bytesLength", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithUuid:structure:data:.cold.4()
{
  ...
  OUTLINED_FUNCTION_7_18(*MEMORY[0x1E0C80C00]);
  OUTLINED_FUNCTION_1_10();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art structure wrap %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithUuid:structure:data:.cold.5()
{
  ...
  OUTLINED_FUNCTION_7_18(*MEMORY[0x1E0C80C00]);
  OUTLINED_FUNCTION_1_10();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art structure format %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithUuid:structure:data:.cold.6()
{
  ...
  OUTLINED_FUNCTION_1_10();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art structure planes %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithUuid:structure:data:.cold.7()
{
  ...
  OUTLINED_FUNCTION_1_10();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art structure height %d");
  OUTLINED_FUNCTION_2();
}
...
+ (void)atlasBackingWithUuid:structure:data:.cold.8()
{
  ...
  OUTLINED_FUNCTION_1_10();
  OUTLINED_FUNCTION_0_11(&dword_1AFABF000, v0, v1, "%@: Invalid art structure width %d");
  OUTLINED_FUNCTION_2();
}
