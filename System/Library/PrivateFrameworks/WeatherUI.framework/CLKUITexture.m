...
+ (CLKUITexture)textureWithProviderDelegate:(id)a3 uuid:(id)a4
{
  ...
  objc_msgSend(a1, "textureWithProviderDelegate:uuid:rect:nullTexture:", v7, v6, v8, 0.0);
...
+ (CLKUITexture)textureWithProviderDelegate:(id)a3 uuid:(id)a4 rect:
{
  ...
  +[CLKUITexture nullTexture2D](CLKUITexture, "nullTexture2D");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "textureWithProviderDelegate:uuid:rect:nullTexture:", v8, v7, v9, v12);
...
{
  return (CLKUITexture *)objc_msgSend(a1, "textureWithProviderDelegate:uuid:rect:nullTexture:", a3, a4, a5, 0.0);
}
...
+ (CLKUITexture)textureWithProviderDelegate:(id)a3 uuid:(id)a4 rect:(id)a5 nullTexture:
{
  ...
  objc_msgSend(v11, "textureForUuid:delegate:rect:nullTexture:", v9, v10, v8, v14);
