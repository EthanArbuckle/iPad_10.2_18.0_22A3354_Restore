...
- (EKUICalendarsIntent)init
{
  ...
  return -[EKUICalendarsIntent init](&v3, sel_init);
}
...
- (EKUICalendarsIntent)initWithCoder:(id)a3
{
  ...
  return -[EKUICalendarsIntent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
...
- (EKUICalendarsIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v9 = -[EKUICalendarsIntent initWithIdentifier:backingStore:](&v11, sel_initWithIdentifier_backingStore_, v7, a4);
...
- (EKUICalendarsIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v10 = -[EKUICalendarsIntent initWithDomain:verb:parametersByName:](&v12, sel_initWithDomain_verb_parametersByName_, v7, v8, v9);
