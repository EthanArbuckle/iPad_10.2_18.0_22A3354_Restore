...
+ (id)keyPathsForValuesAffectingHitTestBounds
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF2D0);
  return v4;
}
...
+ (id)keyPathsForValuesAffectingDrawingBounds
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF2E8);
  return v4;
}
...
- (AKCropAnnotation)init
{
  ...
  if (v2)
  {
    -[AKCropAnnotation setHidden:](v2, "setHidden:", 1);
    -[AKCropAnnotation setCropApplied:](v3, "setCropApplied:", 0);
    objc_msgSend(MEMORY[0x24BDF6950], "colorWithWhite:alpha:", 1.0, 1.0);
    v4 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    -[AKCropAnnotation setColor:](v3, "setColor:", objc_msgSend(v4, "CGColor"));
...
- (void)dealloc
{
  ...
  -[AKAnnotation dealloc](&v4, sel_dealloc);
}
...
- (id)displayName
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("Crop"), &stru_24F1A83D0, CFSTR("AnnotationStrings"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)keysForValuesToObserveForUndo
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF300);
  return v4;
}
...
- (id)keysForValuesToObserveForRedrawing
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF318);
  return v4;
}
...
- (id)keysForValuesToObserveForAdornments
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF330);
  return v4;
}
...
- (void)adjustModelToCompensateForOriginalExif
{
  ...
  -[AKCropAnnotation rectangle](self, "rectangle");
  x = v9.origin.x;
  y = v9.origin.y;
  width = v9.size.width;
...
- (void)translateBy:(CGPoint)a3
{
  ...
  {
    -[AKCropAnnotation rectangle](self, "rectangle");
    -[AKCropAnnotation setRectangle:](self, "setRectangle:", x + v7, y + v8);
  }
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[AKCropAnnotation rectangle](self, "rectangle", v6.receiver, v6.super_class);
...
- (AKCropAnnotation)initWithCoder:(id)a3
{
  ...
  v5 = -[AKAnnotation initWithCoder:](&v12, sel_initWithCoder_, v4);
  if (v5)
  {
