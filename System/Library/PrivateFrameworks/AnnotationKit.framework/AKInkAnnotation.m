...
+ (id)keyPathsForValuesAffectingHitTestBounds
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF510);
  return v4;
}
...
+ (id)keyPathsForValuesAffectingDrawingBounds
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF528);
  return v4;
}
...
+ (id)displayNameForUndoablePropertyChangeWithKey:(id)a3
{
  ...
  {
    if (!objc_msgSend(v4, "isEqualToString:", CFSTR("drawing")))
    {
LABEL_6:
      v10.receiver = a1;
...
- (id)displayName
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("Drawing_Annotation"), CFSTR("Drawing"), CFSTR("AnnotationStrings"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)keysForValuesToObserveForUndo
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF540);
  return v4;
}
...
- (id)keysForValuesToObserveForRedrawing
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF558);
  return v4;
}
...
- (CGRect)hitTestBounds
{
  ...
  -[AKInkAnnotation rectangle](self, "rectangle");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[AKAnnotation encodeWithCoder:](&v9, sel_encodeWithCoder_, v4);
  -[AKInkAnnotation rectangle](self, "rectangle", v9.receiver, v9.super_class);
  ...
  -[AKInkAnnotation drawing](self, "drawing");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "serialize");
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v4, "encodeObject:forKey:", v7, CFSTR("drawing"));
  -[AKInkAnnotation drawingSize](self, "drawingSize");
  v8 = CGSizeCreateDictionaryRepresentation(v10);

  objc_msgSend(v4, "encodeObject:forKey:", v8, CFSTR("drawingSize"));
}
...
- (AKInkAnnotation)initWithCoder:(id)a3
{
  ...
  v5 = -[AKAnnotation initWithCoder:](&v25, sel_initWithCoder_, v4);
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v13, CFSTR("drawing"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();

    v24 = 0;
    v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDE3380]), "initWithData:error:", v14, &v24);
    v16 = v24;
    if (v16)
    {
      v17 = os_log_create("com.apple.annotationkit", "Serialization");
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        sub_22907FB60((uint64_t)v16, v17);

    }
    -[AKInkAnnotation setDrawing:](v5, "setDrawing:", v15);
    if (objc_msgSend(v4, "containsValueForKey:", CFSTR("drawingSize")))
    {
      ...
      objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v21, CFSTR("drawingSize"));
