...
- (id)displayName
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("Heart"), &stru_24F1A83D0, CFSTR("AnnotationStrings"));
...
+ (id)displayNameForUndoablePropertyChangeWithKey:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isEqualToString:", CFSTR("verticallyFlipped"))
    || (+[AKController akBundle](AKController, "akBundle"),
        ...
        objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("Bounds"), &stru_24F1A83D0, CFSTR("AnnotationStrings")), v6 = (void *)objc_claimAutoreleasedReturnValue(), v5, !v6))
  {
    v8.receiver = a1;
...
- (id)keysForValuesToObserveForUndo
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF348);
  return v4;
}
...
- (id)keysForValuesToObserveForRedrawing
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF360);
  return v4;
}
...
- (id)keysForValuesToObserveForAdornments
{
  ...
  objc_msgSend(v4, "addObjectsFromArray:", &unk_24F1CF378);
  return v4;
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[AKHeartAnnotation verticallyFlipped](self, "verticallyFlipped", v5.receiver, v5.super_class), CFSTR("verticallyFlipped"));
...
- (AKHeartAnnotation)initWithCoder:(id)a3
{
  ...
  if (v5)
    -[AKHeartAnnotation setVerticallyFlipped:](v5, "setVerticallyFlipped:", objc_msgSend(v4, "decodeBoolForKey:", CFSTR("verticallyFlipped")));
