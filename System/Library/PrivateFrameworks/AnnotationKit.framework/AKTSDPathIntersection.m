...
- (AKTSDPathIntersection)initWithSegment:(int64_t)a3 atT:(double)a4 onSegmentB:(int64_t)a5 atT:(double)a6 atPoint:(CGPoint)a7
{
  ...
  result = -[AKTSDPathIntersection init](&v14, sel_init);
  if (result)
  {
    result->mPoint.x = x;
    result->mPoint.y = y;
...
- (int64_t)compareSegmentAndT:(id)a3
{
  ...
  v4 = a3;
  v5 = -[AKTSDPathIntersection segment](self, "segment");
  v6 = objc_msgSend(v4, "segment");
  if (v5 >= v6)
  {
    if (v5 <= v6)
      v7 = -[AKTSDPathIntersection compareT:](self, "compareT:", v4);
    else
      v7 = 1;
  }
  else
...
- (int64_t)compareT:(id)a3
{
  ...
  v4 = a3;
  -[AKTSDPathIntersection t](self, "t");
  v6 = v5;
  objc_msgSend(v4, "t");
  v8 = v7;
