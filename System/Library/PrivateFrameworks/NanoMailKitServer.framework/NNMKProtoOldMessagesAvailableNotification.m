...
- (id)description
{
  ...
  -[NNMKProtoOldMessagesAvailableNotification description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NNMKProtoOldMessagesAvailableNotification dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copyWithZone:](self->_mailboxId, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
LABEL_9:
  ...
  if ((unint64_t)mailboxId | *((_QWORD *)v4 + 2))
    v6 = -[NSString isEqual:](mailboxId, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSString hash](self->_mailboxId, "hash") ^ v2;
}
