...
{
  -[NSMutableArray removeAllObjects](self->_messageStatusUpdates, "removeAllObjects");
}
...
- (void)addMessageStatusUpdate:(id)a3
{
  ...
  -[NSMutableArray addObject:](messageStatusUpdates, "addObject:", v4);

}

- (unint64_t)messageStatusUpdatesCount
{
  return -[NSMutableArray count](self->_messageStatusUpdates, "count");
}

- (id)messageStatusUpdateAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_messageStatusUpdates, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[NNMKProtoMessageStatusUpdates description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NNMKProtoMessageStatusUpdates dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_messageStatusUpdates, "count"))
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_messageStatusUpdates, "count"));
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
    v19 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("messageStatusUpdate"));
  }
...
- (void)copyTo:(id)a3
{
  ...
  if (-[NNMKProtoMessageStatusUpdates messageStatusUpdatesCount](self, "messageStatusUpdatesCount"))
  {
    objc_msgSend(v9, "clearMessageStatusUpdates");
    v5 = -[NNMKProtoMessageStatusUpdates messageStatusUpdatesCount](self, "messageStatusUpdatesCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[NNMKProtoMessageStatusUpdates messageStatusUpdateAtIndex:](self, "messageStatusUpdateAtIndex:", i);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "addMessageStatusUpdate:", v8);
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend((id)v6, "addMessageStatusUpdate:", v14);
...
LABEL_17:
  ...
  if ((unint64_t)dateSynced | *((_QWORD *)v4 + 1) && !-[NSData isEqual:](dateSynced, "isEqual:"))
    goto LABEL_17;
  messageStatusUpdates = self->_messageStatusUpdates;
  if ((unint64_t)messageStatusUpdates | *((_QWORD *)v4 + 5))
  {
...
- (unint64_t)hash
{
  ...
  v5 = -[NSMutableArray hash](self->_messageStatusUpdates, "hash");
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        -[NNMKProtoMessageStatusUpdates addMessageStatusUpdate:](self, "addMessageStatusUpdate:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * i), (_QWORD)v11);
      }
...
{
  objc_storeStrong((id *)&self->_messageStatusUpdates, a3);
}
