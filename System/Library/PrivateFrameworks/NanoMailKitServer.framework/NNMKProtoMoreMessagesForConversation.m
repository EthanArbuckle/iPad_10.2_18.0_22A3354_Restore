...
- (id)description
{
  ...
  -[NNMKProtoMoreMessagesForConversation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NNMKProtoMoreMessagesForConversation dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_addedMessages, "count"));
    v17 = 0u;
    v18 = 0u;
    v19 = 0u;
    v20 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("addedMessage"));
  }
...
- (void)copyTo:(id)a3
{
  ...
  if (-[NNMKProtoMoreMessagesForConversation addedMessagesCount](self, "addedMessagesCount"))
  {
    objc_msgSend(v9, "clearAddedMessages");
    v5 = -[NNMKProtoMoreMessagesForConversation addedMessagesCount](self, "addedMessagesCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[NNMKProtoMoreMessagesForConversation addedMessageAtIndex:](self, "addedMessageAtIndex:", i);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "addAddedMessage:", v8);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v6 + 24) = v7;
  ...
  v9 = -[NSString copyWithZone:](self->_conversationId, "copyWithZone:", a3);
  v10 = *(void **)(v6 + 16);
  *(_QWORD *)(v6 + 16) = v9;
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend((id)v6, "addAddedMessage:", v16);
...
- (unint64_t)hash
{
  ...
  v6 = -[NSMutableArray hash](self->_addedMessages, "hash");
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        -[NNMKProtoMoreMessagesForConversation addAddedMessage:](self, "addAddedMessage:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * i), (_QWORD)v11);
      }
