...
+ (id)tokenWithCancelationBlock:(id)a3
{
  ...
  -[FMCancelationToken addCancelationBlock:](v4, "addCancelationBlock:", v3);
...
- (FMCancelationToken)init
{
  ...
  v2 = -[FMCancelationToken init](&v7, sel_init);
  if (v2)
  {
...
- (void)cancel
{
  ...
  v2 = self;
  objc_sync_enter(v2);
  -[FMCancelationToken nts_cancel](v2, "nts_cancel");
  v3 = (id)objc_claimAutoreleasedReturnValue();
  objc_sync_exit(v2);

  -[FMCancelationToken callCancelationBlocks:](v2, "callCancelationBlocks:", v3);
}
...
- (void)addCancelable:(id)a3
{
  ...
  v7 = v4;
  v5 = v4;
  -[FMCancelationToken addCancelationBlock:](self, "addCancelationBlock:", v6);
