...
- (BOOL)accessibilityScroll:(int64_t)a3
{
  ...
  if (a3 == 2)
  {
    -[NUPageViewControllerScrollView accessibilityDelegate](self, "accessibilityDelegate");
...
{
  return (NUPageViewControllerScrollViewAccessibilityDelegate *)objc_loadWeakRetained((id *)&self->_accessibilityDelegate);
}
