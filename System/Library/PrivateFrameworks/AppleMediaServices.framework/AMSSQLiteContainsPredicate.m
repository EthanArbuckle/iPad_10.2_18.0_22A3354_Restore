...
- (void)applyBinding:(id)a3 atIndex:(int *)a4
{
  ...
  if (query)
  {
    -[AMSSQLiteQuery applyBinding:atIndex:](query, "applyBinding:atIndex:", v6, a4);
  }
  else
  {
    v15 = 0u;
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          AMSSQLiteBindFoundationValue(v6, *a4, *(void **)(*((_QWORD *)&v13 + 1) + 8 * i));
          ++*a4;
        }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[AMSSQLitePropertyPredicate isEqual:](&v17, sel_isEqual_, v6))
  {
    v7 = -[AMSSQLiteContainsPredicate isNegative](self, "isNegative");
    if (v7 == objc_msgSend(v6, "isNegative"))
    {
      -[AMSSQLiteContainsPredicate values](self, "values");
      ...
      {
        -[AMSSQLiteContainsPredicate query](self, "query");
...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  if (query)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = -[AMSSQLiteQuery copySelectSQLWithProperties:](query, "copySelectSQLWithProperties:", v11);
