...
- (AMSCarrierLinkParams)initWithString:(id)a3
{
  ...
  v6 = -[AMSCarrierLinkParams init](&v10, sel_init);
  if (v6)
  {
...
- (NSString)adamId
{
  ...
  -[AMSCarrierLinkParams dictionary](self, "dictionary");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[AMSCarrierLinkParams linkParamsString](self, "linkParamsString");
...
- (AMSCarrierLinkParams)initWithCoder:(id)a3
{
  ...
  v5 = -[AMSCarrierLinkParams init](&v12, sel_init);
  if (v5)
  {
