...
+ (BOOL)createOrUpdateSchemaUsingConnection:(id)a3
{
  ...
  while (1)
  {
    ...
    if (!v6)
    {
      v16[0] = v7;
      v16[1] = 3221225472;
      v16[2] = __72__AMSEngagementCacheDatabaseSchema_createOrUpdateSchemaUsingConnection___block_invoke;
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v18 = v12;
        _os_log_impl(&dword_18C849000, v11, OS_LOG_TYPE_ERROR, "%{public}@: Failed to update Engagement cache database scheme. User version did not change", buf, 0xCu);
      }
      v13 = 1;
      goto LABEL_18;
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v18 = v14;
    _os_log_impl(&dword_18C849000, v11, OS_LOG_TYPE_ERROR, "%{public}@: Failed to update Engagement cache database scheme. Success = NO", buf, 0xCu);
  }
  v13 = 0;
LABEL_18:
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_migrateVersion0to1WithMigration:", a2);
}
...
+ (void)_migrateVersion0to1WithMigration:(id)a3
{
  ...
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("CREATE TABLE IF NOT EXISTS %@(  %@ BLOB,  %@ REAL,  %@ BLOB,  %@ INTEGER PRIMARY KEY);"),
                 CFSTR("responses"),
                 CFSTR("data"),
                 CFSTR("expiration"),
                 CFSTR("filter"),
                 CFSTR("identifier"));
  objc_msgSend(v3, "executeStatement:", v4);
