...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 48) = v10;
  ...
  v12 = -[AMSSQLitePredicate copyWithZone:](self->_predicate, "copyWithZone:", a3);
  v13 = *(void **)(v5 + 56);
  *(_QWORD *)(v5 + 56) = v12;
...
- (id)_newSelectSQLWithProperties:(id)a3 columns:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37A0]), "initWithString:", CFSTR("SELECT "));
  v9 = v8;
  ...
  -[AMSSQLitePredicate SQLJoinClausesForEntityClass:](self->_predicate, "SQLJoinClausesForEntityClass:", self->_entityClass);
  ...
  -[AMSSQLitePredicate SQLForEntityClass:](self->_predicate, "SQLForEntityClass:", self->_entityClass);
