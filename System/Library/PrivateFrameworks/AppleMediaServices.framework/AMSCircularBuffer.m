...
- (void)addObject:(id)a3
{
  ...
  -[AMSCircularBuffer accessQueue](self, "accessQueue");
...
void __26__AMSCircularBuffer_flush__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (id)_flush
{
  ...
  -[AMSCircularBuffer buffer](self, "buffer");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[AMSCircularBuffer currentIndex](self, "currentIndex");
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", self->_maxSize);
  -[AMSCircularBuffer setBuffer:](self, "setBuffer:", v6);

  -[AMSCircularBuffer setCurrentIndex:](self, "setCurrentIndex:", 0);
  +[AMSCircularBuffer _rearrangeObjects:forCurrentIndex:](AMSCircularBuffer, "_rearrangeObjects:forCurrentIndex:", v4, v5);
...
{
  return -[AMSCircularBuffer initWithMaxSize:](self, "initWithMaxSize:", 10);
}

- (AMSCircularBuffer)initWithMaxSize:(unint64_t)a3
{
  AMSCircularBuffer *v4;
  dispatch_queue_t v5;
  OS_dispatch_queue *accessQueue;
  uint64_t v7;
  NSMutableArray *buffer;
  ...
  v4 = -[AMSCircularBuffer init](&v10, sel_init);
  if (v4)
  {
...
- (NSArray)allObjects
{
  ...
  block[3] = &unk_1E25400A0;
  block[4] = self;
  block[5] = &v11;
  block[6] = &v7;
  dispatch_sync(v3, block);

  +[AMSCircularBuffer _rearrangeObjects:forCurrentIndex:](AMSCircularBuffer, "_rearrangeObjects:forCurrentIndex:", v12[5], v8[3]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  _Block_object_dispose(&v7, 8);
