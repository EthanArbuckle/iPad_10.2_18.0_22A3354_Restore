...
- (id)initOnConnection:(id)a3 descriptor:(id)a4
{
  ...
  AMSSQLiteQuery *v10;
  uint64_t v11;
  AMSSQLiteQueryDescriptor *descriptor;
  objc_super v14;
  ...
  v9 = -[AMSSQLiteQuery init](&v14, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (void)applyBinding:(id)a3 atIndex:(int *)a4
{
  ...
  v8 = a3;
  -[AMSSQLiteQueryDescriptor predicate](self->_descriptor, "predicate");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "applyBinding:atIndex:", v8, a4);

  v7 = -[AMSSQLiteQueryDescriptor limitCount](self->_descriptor, "limitCount");
  if (v7)
...
- (id)copyEntityIdentifiers
{
  ...
  v4 = v3;
  v7 = v4;
  -[AMSSQLiteQuery enumeratePersistentIDsUsingBlock:](self, "enumeratePersistentIDsUsingBlock:", v6);
...
- (id)copySelectSQLWithProperties:(id)a3
{
  ...
  v6 = -[AMSSQLiteQueryDescriptor entityClass](self->_descriptor, "entityClass");
  v15 = 0u;
  v16 = 0u;
  v17 = 0u;
  v18 = 0u;
  ...
  v13 = -[AMSSQLiteQueryDescriptor _newSelectSQLWithProperties:columns:](self->_descriptor, "_newSelectSQLWithProperties:columns:", v7, v5);
  return v13;
}
...
- (int64_t)countOfEntities
{
  ...
  v4[3] = &unk_1E2545C18;
  v4[4] = &v5;
  -[AMSSQLiteQuery enumeratePersistentIDsUsingBlock:](self, "enumeratePersistentIDsUsingBlock:", v4);
  v2 = v6[3];
...
- (BOOL)createTemporaryTableWithName:(id)a3 properties:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37A0]), "initWithString:", CFSTR("CREATE TEMPORARY TABLE "));
  v22 = v6;
  objc_msgSend(v8, "appendString:", v6);
  objc_msgSend(v8, "appendString:", CFSTR(" AS "));
  v9 = (void *)-[AMSSQLiteQueryDescriptor copy](self->_descriptor, "copy");
  objc_msgSend(v9, "setOrderingDirections:", 0);
  objc_msgSend(v9, "setOrderingProperties:", 0);
  v10 = objc_alloc_init(MEMORY[0x1E0C99DE8]);
  v11 = -[AMSSQLiteQueryDescriptor entityClass](self->_descriptor, "entityClass");
  v25 = 0u;
  v26 = 0u;
  v27 = 0u;
  v28 = 0u;
  ...
  v24 = v9;
  v20 = v9;
  LOBYTE(connection) = -[AMSSQLiteConnection executeStatement:error:bindings:](connection, "executeStatement:error:bindings:", v8, 0, v23);
...
- (void)enumerateMemoryEntitiesUsingBlock:(id)a3
{
  ...
  v5 = a3;
  v6 = -[AMSSQLiteQueryDescriptor memoryEntityClass](descriptor, "memoryEntityClass");
  if (!v6)
    v6 = (objc_class *)objc_opt_class();
  -[objc_class defaultProperties](v6, "defaultProperties");
  v7 = (id)objc_claimAutoreleasedReturnValue();
  -[AMSSQLiteQuery enumerateMemoryEntitiesWithProperties:usingBlock:](self, "enumerateMemoryEntitiesWithProperties:usingBlock:", v7, v5);
...
- (void)enumerateMemoryEntitiesWithProperties:(id)a3 usingBlock:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = -[AMSSQLiteQueryDescriptor memoryEntityClass](self->_descriptor, "memoryEntityClass");
  if (!v8)
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    v13[1] = v8;
    v10 = v7;
    -[AMSSQLiteQuery enumeratePersistentIDsAndProperties:usingBlock:](self, "enumeratePersistentIDsAndProperties:usingBlock:", v6, v12);
  }
  else
  {
    ...
    v15[1] = v8;
    v11 = v7;
    -[AMSSQLiteQuery enumeratePersistentIDsUsingBlock:](self, "enumeratePersistentIDsUsingBlock:", v14);
  }
...
- (void)enumeratePersistentIDsUsingBlock:(id)a3
{
  ...
  v7 = v4;
  v5 = v4;
  -[AMSSQLiteQuery enumeratePersistentIDsAndProperties:usingBlock:](self, "enumeratePersistentIDsAndProperties:usingBlock:", 0, v6);
...
- (void)enumeratePersistentIDsAndProperties:(id)a3 usingBlock:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v11 = -[AMSSQLiteQuery _newSelectSQLWithProperties:](self, "_newSelectSQLWithProperties:", v6);
  connection = self->_connection;
  v12[0] = MEMORY[0x1E0C809B0];
  v12[1] = 3221225472;
  ...
  v9 = v7;
  v10 = v6;
  -[AMSSQLiteConnection executeQuery:withResults:](connection, "executeQuery:withResults:", v11, v12);
...
void __65__AMSSQLiteQuery_enumeratePersistentIDsAndProperties_usingBlock___block_invoke_2(_QWORD *a1, void *a2, void *a3)
{
  id v5;
  void *v6;
  void *v7;
  ...
  objc_msgSend(MEMORY[0x1E0C99E08], "dictionaryWithCapacity:", a1[7]);
  ...
  if (v13)
  {
    ...
    v14[0] = MEMORY[0x1E0C809B0];
    v14[1] = 3221225472;
    v14[2] = __65__AMSSQLiteQuery_enumeratePersistentIDsAndProperties_usingBlock___block_invoke_3;
    v14[3] = &unk_1E2545A90;
    v9 = v7;
    v15 = v9;
    v10 = v13;
...
{
  return (AMSSQLiteQueryDescriptor *)(id)-[AMSSQLiteQueryDescriptor copy](self->_descriptor, "copy");
}
...
- (id)_newSelectSQLWithProperties:(id)a3
{
  ...
  v5 = objc_alloc_init(MEMORY[0x1E0C99DE8]);
  v6 = -[AMSSQLiteQueryDescriptor entityClass](self->_descriptor, "entityClass");
  -[objc_class disambiguatedSQLForProperty:](v6, "disambiguatedSQLForProperty:", 0x1E25627C0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[objc_class disambiguatedSQLForProperty:](v6, "disambiguatedSQLForProperty:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * v12), (_QWORD)v16);
  ...
  v14 = -[AMSSQLiteQueryDescriptor _newSelectSQLWithProperties:columns:](self->_descriptor, "_newSelectSQLWithProperties:columns:", v8, v5);
  return v14;
}
