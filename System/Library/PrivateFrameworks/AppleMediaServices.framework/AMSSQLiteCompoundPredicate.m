  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        +[AMSSQLiteComparisonPredicate predicateWithProperty:value:comparisonType:](AMSSQLiteComparisonPredicate, "predicateWithProperty:value:comparisonType:", v8, *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v15), a5, (_QWORD)v19);
...
- (unint64_t)hash
{
  ...
  v3 = -[AMSSQLitePredicate hash](&v8, sel_hash);
  v4 = -[NSString hash](self->_combinationOperation, "hash");
  -[AMSSQLiteCompoundPredicate predicates](self, "predicates");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[AMSSQLitePredicate isEqual:](&v12, sel_isEqual_, v4)
...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37A0], "stringWithString:", CFSTR("1"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v5;
}
