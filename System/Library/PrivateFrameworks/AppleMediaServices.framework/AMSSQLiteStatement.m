...
LABEL_9:
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99768], CFSTR("[AMSSQLiteStatement] Statement already finalized"));
  }
LABEL_11:
...
{
  if (a3)
    -[AMSSQLiteStatement bindString:atPosition:](self, "bindString:atPosition:", a3, *(_QWORD *)&a4);
  else
    -[AMSSQLiteStatement bindNullAtPosition:](self, "bindNullAtPosition:", *(_QWORD *)&a4);
}
...
{
  id v7;
  AMSSQLiteStatement *v8;
  AMSSQLiteStatement *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)AMSSQLiteStatement;
  v8 = -[AMSSQLiteStatement init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (void)bindDouble:(double)a3 atPosition:(int)a4
{
  ...
  if (statement)
    ...
    objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99768], CFSTR("[AMSSQLiteStatement] Statement already finalized"), a3);
}
...
- (void)bindArray:(id)a3 atPosition:(int)a4
{
  ...
  -[AMSSQLiteStatement bindData:atPosition:](self, "bindData:atPosition:", v6, v4);
...
- (void)bindURL:(id)a3 atPosition:(int)a4
{
  ...
  v6 = (id)objc_claimAutoreleasedReturnValue();
  -[AMSSQLiteStatement bindString:atPosition:](self, "bindString:atPosition:", v6, v4);
