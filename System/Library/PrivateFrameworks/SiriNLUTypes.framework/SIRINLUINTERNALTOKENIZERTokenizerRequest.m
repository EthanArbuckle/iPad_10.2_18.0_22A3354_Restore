...
- (id)description
{
  ...
  -[SIRINLUINTERNALTOKENIZERTokenizerRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALTOKENIZERTokenizerRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (asrId)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("asrId"));
