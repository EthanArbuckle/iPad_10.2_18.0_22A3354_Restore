...
- (id)description
{
  ...
  -[SIRINLUINTERNALCONTEXTUAL_SPAN_MATCHERContextualSpanMatcherResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALCONTEXTUAL_SPAN_MATCHERContextualSpanMatcherResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_contextualSpans, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("contextual_spans"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[SIRINLUINTERNALCONTEXTUAL_SPAN_MATCHERContextualSpanMatcherResponse contextualSpansCount](self, "contextualSpansCount"))
  {
    objc_msgSend(v8, "clearContextualSpans");
    v4 = -[SIRINLUINTERNALCONTEXTUAL_SPAN_MATCHERContextualSpanMatcherResponse contextualSpansCount](self, "contextualSpansCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALCONTEXTUAL_SPAN_MATCHERContextualSpanMatcherResponse contextualSpansAtIndex:](self, "contextualSpansAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addContextualSpans:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addContextualSpans:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)contextualSpans | v4[1])
      v6 = -[NSMutableArray isEqual:](contextualSpans, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_contextualSpans, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SIRINLUINTERNALCONTEXTUAL_SPAN_MATCHERContextualSpanMatcherResponse addContextualSpans:](self, "addContextualSpans:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
