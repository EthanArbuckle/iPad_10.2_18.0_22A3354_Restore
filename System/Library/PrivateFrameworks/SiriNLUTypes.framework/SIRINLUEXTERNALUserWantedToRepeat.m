...
- (id)description
{
  ...
  -[SIRINLUEXTERNALUserWantedToRepeat description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALUserWantedToRepeat dictionaryRepresentation](self, "dictionaryRepresentation");
