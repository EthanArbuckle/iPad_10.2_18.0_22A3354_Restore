...
- (id)description
{
  ...
  -[SIRINLUINTERNALOVERRIDESOverridesResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALOVERRIDESOverridesResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[SIRINLUINTERNALOVERRIDESOverridesResponse parsesCount](self, "parsesCount"))
  {
    objc_msgSend(v8, "clearParses");
    v4 = -[SIRINLUINTERNALOVERRIDESOverridesResponse parsesCount](self, "parsesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALOVERRIDESOverridesResponse parsesAtIndex:](self, "parsesAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SIRINLUINTERNALOVERRIDESOverridesResponse addParses:](self, "addParses:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
