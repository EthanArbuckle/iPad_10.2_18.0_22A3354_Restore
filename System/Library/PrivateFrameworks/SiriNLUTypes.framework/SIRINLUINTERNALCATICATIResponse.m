...
- (id)description
{
  ...
  -[SIRINLUINTERNALCATICATIResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALCATICATIResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[SIRINLUINTERNALCATICATIResponse hypothesesCount](self, "hypothesesCount"))
  {
    objc_msgSend(v8, "clearHypotheses");
    v4 = -[SIRINLUINTERNALCATICATIResponse hypothesesCount](self, "hypothesesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALCATICATIResponse hypothesesAtIndex:](self, "hypothesesAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SIRINLUINTERNALCATICATIResponse addHypotheses:](self, "addHypotheses:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
