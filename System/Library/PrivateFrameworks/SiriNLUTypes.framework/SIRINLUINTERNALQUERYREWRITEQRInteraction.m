...
- (id)description
{
  ...
  -[SIRINLUINTERNALQUERYREWRITEQRInteraction description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALQUERYREWRITEQRInteraction dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v13 = a3;
  if (-[SIRINLUINTERNALQUERYREWRITEQRInteraction originalUtterancesCount](self, "originalUtterancesCount"))
  {
    objc_msgSend(v13, "clearOriginalUtterances");
    v4 = -[SIRINLUINTERNALQUERYREWRITEQRInteraction originalUtterancesCount](self, "originalUtterancesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALQUERYREWRITEQRInteraction originalUtterancesAtIndex:](self, "originalUtterancesAtIndex:", i);
  ...
  if (-[SIRINLUINTERNALQUERYREWRITEQRInteraction siriResponsesCount](self, "siriResponsesCount"))
  {
    objc_msgSend(v13, "clearSiriResponses");
    v8 = -[SIRINLUINTERNALQUERYREWRITEQRInteraction siriResponsesCount](self, "siriResponsesCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[SIRINLUINTERNALQUERYREWRITEQRInteraction siriResponseAtIndex:](self, "siriResponseAtIndex:", j);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v21 != v8)
          objc_enumerationMutation(v5);
        -[SIRINLUINTERNALQUERYREWRITEQRInteraction addOriginalUtterances:](self, "addOriginalUtterances:", *(_QWORD *)(*((_QWORD *)&v20 + 1) + 8 * i));
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        if (*(_QWORD *)v17 != v13)
          objc_enumerationMutation(v10);
        -[SIRINLUINTERNALQUERYREWRITEQRInteraction addSiriResponse:](self, "addSiriResponse:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * j), (_QWORD)v16);
      }
...
+ (id)options
{
  if (options_once_14995 != -1)
    dispatch_once(&options_once_14995, &__block_literal_global_14996);
  return (id)options_sOptions_14997;
}
...
void __51__SIRINLUINTERNALQUERYREWRITEQRInteraction_options__block_invoke()
{
  ...
  v0 = (void *)options_sOptions_14997;
  options_sOptions_14997 = (uint64_t)&unk_1E7BD2C60;
