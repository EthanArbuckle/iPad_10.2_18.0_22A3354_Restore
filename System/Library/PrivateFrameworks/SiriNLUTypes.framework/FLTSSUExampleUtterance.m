...
{
  return -[FLTSSUExampleUtterance initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FLTSSUExampleUtterance initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FLTSSUExampleUtterance)initWithFlatbuffData:(id)a3 root:(const SSUExampleUtterance *)a4
{
  return -[FLTSSUExampleUtterance initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FLTSSUExampleUtterance)initWithFlatbuffData:(id)a3 root:(const SSUExampleUtterance *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FLTSSUExampleUtterance *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const SSUExampleUtterance *root;
  uint64_t v17;
  unint64_t v18;
  SSUExampleUtterance *v19;
  FLTSSUExampleUtterance *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FLTSSUExampleUtterance init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (Offset<SSUExampleUtterance>)addObjectToBuffer:(void *)a3
{
  ...
  -[FLTSSUExampleUtterance string](self, "string");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[FLTSSUExampleUtterance addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __38__FLTSSUExampleUtterance_flatbuffData__block_invoke;
