...
- (id)typeAsString:(int)a3
{
  ...
  if (!a3)
    return CFSTR("CORRECTION_TYPE_NONE");
  if (a3 == 1)
  {
    v3 = CFSTR("CORRECTION_TYPE_USER_INITIATED");
  }
  else
  {
...
- (int)StringAsType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("CORRECTION_TYPE_NONE")) & 1) != 0)
    v4 = 0;
  else
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("CORRECTION_TYPE_USER_INITIATED"));
...
- (id)description
{
  ...
  -[SIRINLUEXTERNALCorrectionOutcome description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALCorrectionOutcome dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    if (type)
    {
      if (type == 1)
      {
        v5 = CFSTR("CORRECTION_TYPE_USER_INITIATED");
      }
      else
      {
