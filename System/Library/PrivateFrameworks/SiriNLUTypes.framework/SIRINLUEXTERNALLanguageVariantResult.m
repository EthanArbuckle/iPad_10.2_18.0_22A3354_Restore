...
{
  -[NSMutableArray removeAllObjects](self->_multilingualVariants, "removeAllObjects");
}
...
- (void)addMultilingualVariant:(id)a3
{
  ...
  -[NSMutableArray addObject:](multilingualVariants, "addObject:", v4);

}

- (unint64_t)multilingualVariantsCount
{
  return -[NSMutableArray count](self->_multilingualVariants, "count");
}

- (id)multilingualVariantAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_multilingualVariants, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[SIRINLUEXTERNALLanguageVariantResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALLanguageVariantResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_multilingualVariants, "count"))
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_multilingualVariants, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("multilingual_variant"));
  }
  parser = self->_parser;
  if (parser)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v12, CFSTR("parser"));
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[SIRINLUEXTERNALLanguageVariantResult multilingualVariantsCount](self, "multilingualVariantsCount"))
  {
    objc_msgSend(v8, "clearMultilingualVariants");
    v4 = -[SIRINLUEXTERNALLanguageVariantResult multilingualVariantsCount](self, "multilingualVariantsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUEXTERNALLanguageVariantResult multilingualVariantAtIndex:](self, "multilingualVariantAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addMultilingualVariant:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addMultilingualVariant:", v11);
  ...
  v12 = -[SIRINLUEXTERNALParser copyWithZone:](self->_parser, "copyWithZone:", a3);
  v13 = (void *)v5[2];
  v5[2] = v12;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](multilingualVariants, "isEqual:")))
  {
    ...
    if ((unint64_t)parser | v4[2])
      v7 = -[SIRINLUEXTERNALParser isEqual:](parser, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_multilingualVariants, "hash");
  return -[SIRINLUEXTERNALParser hash](self->_parser, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v13 != v8)
          objc_enumerationMutation(v5);
        -[SIRINLUEXTERNALLanguageVariantResult addMultilingualVariant:](self, "addMultilingualVariant:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
...
{
  objc_storeStrong((id *)&self->_multilingualVariants, a3);
}
