...
- (FLTMutableSSUExample)init
{
  ...
  v2 = -[FLTMutableSSUExample init](&v6, sel_init);
  if (v2)
  {
...
- (int64_t)data_type
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("data_type"));
...
- (FLTSSUExampleUtterance)dataAsFLTSSUExampleUtterance
{
  ...
  if (-[FLTMutableSSUExample data_type](self, "data_type") == 1)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("data"));
...
- (void)setDataAsFLTSSUExampleUtterance:(id)a3
{
  ...
  v5 = a3;
  -[FLTMutableSSUExample setData_type:](self, "setData_type:", 1);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("data"));
...
- (FLTSSUExampleEncodedVector)dataAsFLTSSUExampleEncodedVector
{
  ...
  if (-[FLTMutableSSUExample data_type](self, "data_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("data"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setDataAsFLTSSUExampleEncodedVector:(id)a3
{
  ...
  v5 = a3;
  -[FLTMutableSSUExample setData_type:](self, "setData_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("data"));
