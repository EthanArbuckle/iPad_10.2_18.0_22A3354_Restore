...
- (id)description
{
  ...
  -[SIRINLUINTERNALUAAP_PARSERUaaPParserResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALUAAP_PARSERUaaPParserResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_hypotheses, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("hypotheses"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[SIRINLUINTERNALUAAP_PARSERUaaPParserResponse hypothesesCount](self, "hypothesesCount"))
  {
    objc_msgSend(v8, "clearHypotheses");
    v4 = -[SIRINLUINTERNALUAAP_PARSERUaaPParserResponse hypothesesCount](self, "hypothesesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALUAAP_PARSERUaaPParserResponse hypothesesAtIndex:](self, "hypothesesAtIndex:", i);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addHypotheses:", v13);
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_hypotheses, "hash") ^ v3;
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[SIRINLUINTERNALUAAP_PARSERUaaPParserResponse addHypotheses:](self, "addHypotheses:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
