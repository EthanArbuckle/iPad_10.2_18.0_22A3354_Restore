...
- (id)description
{
  ...
  -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  if (-[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse mentionsCount](self, "mentionsCount"))
  {
    objc_msgSend(v8, "clearMentions");
    v4 = -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse mentionsCount](self, "mentionsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse mentionsAtIndex:](self, "mentionsAtIndex:", i);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v14 = -[NSString copyWithZone:](self->_rewrittenUtterance, "copyWithZone:", a3);
  v15 = (void *)v5[3];
  v5[3] = v14;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](mentions, "isEqual:")))
  {
    ...
    if ((unint64_t)rewrittenUtterance | v4[3])
      v8 = -[NSString isEqual:](rewrittenUtterance, "isEqual:");
    else
      v8 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v4 = -[NSMutableArray hash](self->_mentions, "hash") ^ v3;
  return v4 ^ -[NSString hash](self->_rewrittenUtterance, "hash");
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse addMentions:](self, "addMentions:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
