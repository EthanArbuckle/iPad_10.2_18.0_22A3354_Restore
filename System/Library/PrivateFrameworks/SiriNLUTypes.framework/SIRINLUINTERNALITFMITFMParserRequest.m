...
- (id)description
{
  ...
  -[SIRINLUINTERNALITFMITFMParserRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALITFMITFMParserRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (parser)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v20, CFSTR("parser"));
...
- (void)copyTo:(id)a3
{
  ...
  if (-[SIRINLUINTERNALITFMITFMParserRequest matchingSpansCount](self, "matchingSpansCount"))
  {
    objc_msgSend(v9, "clearMatchingSpans");
    v4 = -[SIRINLUINTERNALITFMITFMParserRequest matchingSpansCount](self, "matchingSpansCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALITFMITFMParserRequest matchingSpansAtIndex:](self, "matchingSpansAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v20 = -[SIRINLUEXTERNALParser copyWithZone:](self->_parser, "copyWithZone:", a3);
  v21 = (void *)v5[4];
  v5[4] = v20;
...
- (unint64_t)hash
{
  ...
  v8 = v7 ^ -[SIRINLUEXTERNALParser hash](self->_parser, "hash");
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v13; ++i)
      {
        if (*(_QWORD *)v23 != v14)
          objc_enumerationMutation(v11);
        -[SIRINLUINTERNALITFMITFMParserRequest addMatchingSpans:](self, "addMatchingSpans:", *(_QWORD *)(*((_QWORD *)&v22 + 1) + 8 * i), (_QWORD)v22);
      }
