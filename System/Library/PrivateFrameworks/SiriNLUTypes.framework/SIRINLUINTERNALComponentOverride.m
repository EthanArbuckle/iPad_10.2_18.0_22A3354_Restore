...
- (int)StringAsOverrideNamespace:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("OVERRIDE_NAMESPACE_UNSPECIFIED")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("OVERRIDE_NAMESPACE_NLX")) & 1) != 0)
  {
    v4 = 1;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("OVERRIDE_NAMESPACE_CCQR")) & 1) != 0)
  {
    v4 = 2;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("OVERRIDE_NAMESPACE_MDS_UAAP")) & 1) != 0)
  {
    v4 = 3;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("OVERRIDE_NAMESPACE_LVC")) & 1) != 0)
  {
    v4 = 4;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("OVERRIDE_NAMESPACE_NLv4")) & 1) != 0)
  {
    v4 = 5;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("OVERRIDE_NAMESPACE_PLANNER")))
  {
    v4 = 6;
  }
  else
...
- (id)description
{
  ...
  -[SIRINLUINTERNALComponentOverride description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALComponentOverride dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_overrideNamespace);
      v8 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v8 = off_1E7BB02E0[overrideNamespace];
    }
    objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("override_namespace"));
  ...
  if ((has & 4) != 0)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v9, CFSTR("enabled"));
  ...
  if ((has & 1) != 0)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("creation_timestamp_ms_since_unix_epoch"));

  }
  value = self->_value;
  if (value)
  {
    -[SIRINLUINTERNALOverrideValue dictionaryRepresentation](value, "dictionaryRepresentation");
  ...
  if (serializedValue)
    objc_msgSend(v4, "setObject:forKey:", serializedValue, CFSTR("serialized_value"));
  return v4;
}
...
LABEL_7:
  ...
  if (-[SIRINLUINTERNALComponentOverride nluRequestRulesCount](self, "nluRequestRulesCount"))
  {
    objc_msgSend(v10, "clearNluRequestRules");
    v6 = -[SIRINLUINTERNALComponentOverride nluRequestRulesCount](self, "nluRequestRulesCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        -[SIRINLUINTERNALComponentOverride nluRequestRulesAtIndex:](self, "nluRequestRulesAtIndex:", i);
        v9 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_5:
  v9 = -[SIRINLUINTERNALOverrideValue copyWithZone:](self->_value, "copyWithZone:", a3);
  v10 = *(void **)(v5 + 48);
  *(_QWORD *)(v5 + 48) = v9;
  ...
  v17 = -[NSData copyWithZone:](self->_serializedValue, "copyWithZone:", a3);
  v18 = *(void **)(v5 + 40);
  *(_QWORD *)(v5 + 40) = v17;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 60) & 2) == 0 || self->_overrideNamespace != *((_DWORD *)v4 + 8))
      goto LABEL_28;
  }
...
LABEL_17:
  ...
  value = self->_value;
  if ((unint64_t)value | *((_QWORD *)v4 + 6) && !-[SIRINLUINTERNALOverrideValue isEqual:](value, "isEqual:"))
    goto LABEL_28;
  nluRequestRules = self->_nluRequestRules;
  ...
  serializedValue = self->_serializedValue;
  if ((unint64_t)serializedValue | *((_QWORD *)v4 + 5))
    v9 = -[NSData isEqual:](serializedValue, "isEqual:");
  else
    v9 = 1;
LABEL_29:
...
LABEL_8:
  v7 = v4 ^ v3 ^ v5 ^ v6 ^ -[SIRINLUINTERNALOverrideValue hash](self->_value, "hash");
  v8 = -[NSMutableArray hash](self->_nluRequestRules, "hash");
  return v7 ^ v8 ^ -[NSData hash](self->_serializedValue, "hash");
}
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        -[SIRINLUINTERNALComponentOverride addNluRequestRules:](self, "addNluRequestRules:", *(_QWORD *)(*((_QWORD *)&v13 + 1) + 8 * i), (_QWORD)v13);
      }
...
{
  objc_storeStrong((id *)&self->_serializedValue, a3);
}
