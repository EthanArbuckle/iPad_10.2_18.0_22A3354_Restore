...
- (id)description
{
  ...
  -[SIRICOMMONDoubleValue description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRICOMMONDoubleValue dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) != 0 && self->_value == *((double *)v4 + 1))
    {
      v5 = 1;
      goto LABEL_7;
    }
