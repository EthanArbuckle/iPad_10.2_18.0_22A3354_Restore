...
- (id)description
{
  ...
  -[SIRINLUEXTERNALRRBoundingBox description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALRRBoundingBox dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_xCoordinate);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("x_coordinate"));
...
LABEL_9:
      ...
      objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("width"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_yCoordinate);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("y_coordinate"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((_QWORD *)result + 3) = *(_QWORD *)&self->_xCoordinate;
    *((_BYTE *)result + 40) |= 4u;
    has = (char)self->_has;
    if ((has & 8) == 0)
    {
LABEL_3:
  ...
  *((_QWORD *)result + 4) = *(_QWORD *)&self->_yCoordinate;
  *((_BYTE *)result + 40) |= 8u;
  has = (char)self->_has;
  if ((has & 2) == 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 40) & 4) == 0 || self->_xCoordinate != *((double *)v4 + 3))
      goto LABEL_21;
  }
...
LABEL_21:
  ...
  {
    if ((*((_BYTE *)v4 + 40) & 8) == 0 || self->_yCoordinate != *((double *)v4 + 4))
      goto LABEL_21;
  }
