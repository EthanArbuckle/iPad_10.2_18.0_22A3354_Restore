...
{
  return -[FLTSSUIntentParameter initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FLTSSUIntentParameter initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FLTSSUIntentParameter)initWithFlatbuffData:(id)a3 root:(const SSUIntentParameter *)a4
{
  return -[FLTSSUIntentParameter initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FLTSSUIntentParameter)initWithFlatbuffData:(id)a3 root:(const SSUIntentParameter *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FLTSSUIntentParameter *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const SSUIntentParameter *root;
  uint64_t v17;
  unint64_t v18;
  SSUIntentParameter *v19;
  FLTSSUIntentParameter *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FLTSSUIntentParameter init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (Offset<SSUIntentParameter>)addObjectToBuffer:(void *)a3
{
  ...
  -[FLTSSUIntentParameter name](self, "name");
  ...
  -[FLTSSUIntentParameter example_value](self, "example_value");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[FLTSSUIntentParameter addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __37__FLTSSUIntentParameter_flatbuffData__block_invoke;
