...
- (id)description
{
  ...
  -[SIRINLUINTERNALAdjacentSpans description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALAdjacentSpans dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (captureGroupName)
    objc_msgSend(v3, "setObject:forKey:", captureGroupName, CFSTR("capture_group_name"));
  if (-[NSMutableArray count](self->_spans, "count"))
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_spans, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("spans"));
  }
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[SIRINLUINTERNALAdjacentSpans spansCount](self, "spansCount"))
  {
    objc_msgSend(v8, "clearSpans");
    v4 = -[SIRINLUINTERNALAdjacentSpans spansCount](self, "spansCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALAdjacentSpans spansAtIndex:](self, "spansAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addSpans:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_captureGroupName, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_captureGroupName, "hash");
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[SIRINLUINTERNALAdjacentSpans addSpans:](self, "addSpans:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
