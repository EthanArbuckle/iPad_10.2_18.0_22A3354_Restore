...
- (FLTMutableSSUCategoryGroup)init
{
  ...
  v2 = -[FLTMutableSSUCategoryGroup init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("positive_intents"));
}
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("negative_examples"));
}
