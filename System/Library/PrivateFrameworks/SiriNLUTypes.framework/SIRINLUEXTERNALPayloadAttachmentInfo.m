...
- (int)StringAsAttachmentType:(id)a3
{
  ...
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("FULL")) & 1) != 0)
    ...
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("PARTIAL"));
...
- (id)description
{
  ...
  -[SIRINLUEXTERNALPayloadAttachmentInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALPayloadAttachmentInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("attachment_type"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_attachmentType == *((_DWORD *)v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
