...
{
  return -[FLTSSUIntent initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FLTSSUIntent initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FLTSSUIntent)initWithFlatbuffData:(id)a3 root:(const SSUIntent *)a4
{
  return -[FLTSSUIntent initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FLTSSUIntent)initWithFlatbuffData:(id)a3 root:(const SSUIntent *)a4 verify:(BOOL)a5
{
  ...
  v10 = -[FLTSSUIntent init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (NSArray)parameters
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("parameters"));
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FLTSSUIntent parameters_enumerateObjectsUsingBlock:](self, "parameters_enumerateObjectsUsingBlock:", v6);
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_storage, "setObject:forKeyedSubscript:", v3, CFSTR("parameters"));
...
- (id)parameters_objectAtIndex:(unint64_t)a3
{
  void *v5;
  void *v6;
  FLTSSUIntentParameter *v7;
  FLTSSUIntentParameter *v8;
  const SSUIntent *root;
  const SSUIntent *v10;
  uint64_t v11;
  const SSUIntent *v12;
  ...
  if (v5)
  {
    ...
    v7 = (FLTSSUIntentParameter *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    root = self->_root;
    ...
    v7 = -[FLTSSUIntentParameter initWithFlatbuffData:root:verify:]([FLTSSUIntentParameter alloc], "initWithFlatbuffData:root:verify:", self->_data, &v12[4 * a3 + 4 + *(unsigned int *)v12[4 * a3 + 4].var0], 0);
  }
  v8 = v7;
LABEL_9:
...
{
  void (**v4)(id, FLTSSUIntentParameter *, uint64_t, unsigned __int8 *);
  void *v5;
  void *v6;
  const SSUIntent *root;
  const SSUIntent *v8;
    ...
    if (*(unsigned __int16 *)v8->var0 >= 7u)
    {
      ...
      if (v9)
      {
        ...
        if ((_DWORD)v12)
        {
          ...
          do
          {
            v16 = -[FLTSSUIntentParameter initWithFlatbuffData:root:verify:]([FLTSSUIntentParameter alloc], "initWithFlatbuffData:root:verify:", self->_data, &v13[*(unsigned int *)v13->var0], 0);
            v4[2](v4, v16, v14, &v19);
            v17 = v19;
...
- (NSArray)examples
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("examples"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    v3 = v4;
    v7 = v3;
    -[FLTSSUIntent examples_enumerateObjectsUsingBlock:](self, "examples_enumerateObjectsUsingBlock:", v6);
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_storage, "setObject:forKeyedSubscript:", v3, CFSTR("examples"));
...
- (Offset<SSUIntent>)addObjectToBuffer:(void *)a3
{
  ...
  -[FLTSSUIntent parameters](self, "parameters");
  ...
  v69 = 0;
  v70 = 0;
  -[FLTSSUIntent examples](v61, "examples");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[FLTSSUIntent addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __28__FLTSSUIntent_flatbuffData__block_invoke;
