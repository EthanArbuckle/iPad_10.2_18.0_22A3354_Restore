...
- (id)description
{
  ...
  -[SIRINLUEXTERNALSystemInformed description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALSystemInformed dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_entities, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("entities"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[SIRINLUEXTERNALSystemInformed entitiesCount](self, "entitiesCount"))
  {
    objc_msgSend(v8, "clearEntities");
    v4 = -[SIRINLUEXTERNALSystemInformed entitiesCount](self, "entitiesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUEXTERNALSystemInformed entitiesAtIndex:](self, "entitiesAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addEntities:", v7);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addEntities:", v13);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[SIRINLUEXTERNALUUID isEqual:](taskId, "isEqual:")))
  {
    ...
    if ((unint64_t)entities | v4[1])
      v7 = -[NSMutableArray isEqual:](entities, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_entities, "hash") ^ v3;
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[SIRINLUEXTERNALSystemInformed addEntities:](self, "addEntities:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
