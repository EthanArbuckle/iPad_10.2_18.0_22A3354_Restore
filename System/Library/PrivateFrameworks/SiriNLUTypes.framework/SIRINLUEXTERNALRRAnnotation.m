...
- (id)description
{
  ...
  -[SIRINLUEXTERNALRRAnnotation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALRRAnnotation dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (key)
  {
    -[SIRICOMMONStringValue dictionaryRepresentation](key, "dictionaryRepresentation");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (value)
  {
    -[SIRICOMMONStringValue dictionaryRepresentation](value, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[SIRICOMMONStringValue copyWithZone:](self->_key, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;

  v8 = -[SIRICOMMONStringValue copyWithZone:](self->_value, "copyWithZone:", a3);
  v9 = (void *)v5[2];
  v5[2] = v8;
...
- (BOOL)isEqual:(id)a3
{
    ...
    && ((key = self->_key, !((unint64_t)key | v4[1])) || -[SIRICOMMONStringValue isEqual:](key, "isEqual:")))
  {
    ...
    if ((unint64_t)value | v4[2])
      v7 = -[SIRICOMMONStringValue isEqual:](value, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[SIRICOMMONStringValue hash](self->_key, "hash");
  return -[SIRICOMMONStringValue hash](self->_value, "hash") ^ v3;
}
