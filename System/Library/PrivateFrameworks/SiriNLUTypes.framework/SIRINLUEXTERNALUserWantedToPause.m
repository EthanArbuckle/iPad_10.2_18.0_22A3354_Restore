...
- (id)description
{
  ...
  -[SIRINLUEXTERNALUserWantedToPause description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUEXTERNALUserWantedToPause dictionaryRepresentation](self, "dictionaryRepresentation");
