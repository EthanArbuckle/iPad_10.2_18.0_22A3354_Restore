...
{
  FLTMutableSSUIntentParameter *v2;
  uint64_t v3;
  ...
  v2 = -[FLTMutableSSUIntentParameter init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("example_value"));
}
