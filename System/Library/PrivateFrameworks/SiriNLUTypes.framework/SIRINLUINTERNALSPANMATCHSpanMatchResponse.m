...
- (id)description
{
  ...
  -[SIRINLUINTERNALSPANMATCHSpanMatchResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SIRINLUINTERNALSPANMATCHSpanMatchResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[SIRINLUINTERNALSPANMATCHSpanMatchResponse matchingSpansCount](self, "matchingSpansCount"))
  {
    objc_msgSend(v8, "clearMatchingSpans");
    v4 = -[SIRINLUINTERNALSPANMATCHSpanMatchResponse matchingSpansCount](self, "matchingSpansCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SIRINLUINTERNALSPANMATCHSpanMatchResponse matchingSpansAtIndex:](self, "matchingSpansAtIndex:", i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)matchingSpans | v4[1])
      v6 = -[NSMutableArray isEqual:](matchingSpans, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_matchingSpans, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SIRINLUINTERNALSPANMATCHSpanMatchResponse addMatchingSpans:](self, "addMatchingSpans:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
