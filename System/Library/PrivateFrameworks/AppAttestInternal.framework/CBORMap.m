...
- (void)write:(id)a3
{
  ...
  v11 = a3;
  -[CBORMap getSortedKeys](self, "getSortedKeys");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectEnumerator");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[CBORValue encodeStartItems:output:](self, "encodeStartItems:output:", -[NSMapTable count](self->m_data, "count"), v11);
