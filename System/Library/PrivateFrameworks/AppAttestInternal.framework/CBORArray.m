...
- (void)write:(id)a3
{
  ...
  v6 = a3;
  -[CBORValue encodeStartItems:output:](self, "encodeStartItems:output:", -[NSMutableArray count](self->m_data, "count"), v6);
  if (-[NSMutableArray count](self->m_data, "count"))
  {
    ...
    while (-[NSMutableArray count](self->m_data, "count") > v4);
  }
