...
{
  id v5;
  POPlatformSSOUIManagerListener *v6;
  POPlatformSSOUIManagerListener *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)POPlatformSSOUIManagerListener;
  v6 = -[POAgentListener initWithMachServiceName:](&v9, sel_initWithMachServiceName_, CFSTR("com.apple.PlatformSSO.settings.service-xpc"));
  v7 = v6;
  if (v6)
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  -[POPlatformSSOUIManagerListener process](self, "process");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = -[POUIAgentProcess initWithXPCConnection:authenticationProcess:](v9, "initWithXPCConnection:authenticationProcess:", v7, v10);
  ...
  -[POUIAgentProcess setInvalidationHandler:](v11, "setInvalidationHandler:", &v15);
  -[POUIAgentProcess invalidationHandler](v11, "invalidationHandler", v15, v16, v17, v18);
