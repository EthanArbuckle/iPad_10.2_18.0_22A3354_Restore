...
{
  GPURawCounterSelect *v6;
  objc_super v8;

  v8.receiver = self;
  v8.super_class = (Class)GPURawCounterSelect;
  v6 = -[GPURawCounterSelect init](&v8, sel_init);
  if (v6)
  {
...
- (void)dealloc
{
  ...
  -[GPURawCounterSelect dealloc](&v3, sel_dealloc);
}

+ (id)selectWithName:(id)a3 options:(id)a4
{
  return -[GPURawCounterSelect initWithName:options:]([GPURawCounterSelect alloc], "initWithName:options:", a3, a4);
}
