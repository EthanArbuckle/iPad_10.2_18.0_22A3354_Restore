...
- (id)entryFor:(id)a3
{
  ...
  v15 = 0u;
  v16 = 0u;
  -[TPMachineIDList entries](self, "entries", 0);
...
- (id)description
{
  ...
  -[TPMachineIDList entries](self, "entries");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("<TPMachineIDList: %@>"), v3);
