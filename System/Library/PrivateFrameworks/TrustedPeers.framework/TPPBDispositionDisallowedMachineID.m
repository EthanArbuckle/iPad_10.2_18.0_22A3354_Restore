...
- (id)description
{
  ...
  -[TPPBDispositionDisallowedMachineID description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[TPPBDispositionDisallowedMachineID dictionaryRepresentation](self, "dictionaryRepresentation");
