...
+ (id)successWithResolvedAlarmRepeatSchedule:(id)a3
{
  ...
  v4 = a3;
  v5 = static AlarmRepeatScheduleResolutionResult.success(with:)((uint64_t)v4);
...
+ (id)disambiguationWithAlarmRepeatSchedulesToDisambiguate:(id)a3
{
  ...
  v3 = sub_24738A640();
  swift_getObjCClassMetadata();
  v4 = static AlarmRepeatScheduleResolutionResult.disambiguation(with:)(v3);
...
+ (id)confirmationRequiredWithAlarmRepeatScheduleToConfirm:(id)a3
{
  ...
  swift_getObjCClassMetadata();
  v4 = a3;
  v5 = static AlarmRepeatScheduleResolutionResult.confirmationRequired(with:)((uint64_t)a3);
...
- (AlarmRepeatScheduleResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  id v6;
  void *v7;
  AlarmRepeatScheduleResolutionResult *v8;
  AlarmRepeatScheduleResolutionResult *v9;
  objc_super v11;
  ...
  v8 = -[AlarmRepeatScheduleResolutionResult initWithJSONDictionary:forIntent:](&v11, sel_initWithJSONDictionary_forIntent_, v7, v6);
