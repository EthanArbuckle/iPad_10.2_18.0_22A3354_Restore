...
- (UpdateAlarmIntent)init
{
  ...
  return -[UpdateAlarmIntent init](&v3, sel_init);
}
...
- (UpdateAlarmIntent)initWithCoder:(id)a3
{
  ...
  return -[UpdateAlarmIntent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
...
- (UpdateAlarmIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v9 = -[UpdateAlarmIntent initWithIdentifier:backingStore:](&v11, sel_initWithIdentifier_backingStore_, v7, a4);
...
- (UpdateAlarmIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v10 = -[UpdateAlarmIntent initWithDomain:verb:parametersByName:](&v12, sel_initWithDomain_verb_parametersByName_, v7, v8, v9);
