...
- (void)confirmSnoozeAlarmHal:(id)a3 completion:(id)a4
{
  void *v6;
  id v7;
  _TtC21SiriTimeAlarmInternal24SnoozeAlarmIntentHandler *v8;

  v6 = _Block_copy(a4);
  _Block_copy(v6);
  v7 = a3;
  v8 = self;
  sub_2473641FC(v7, (uint64_t)v6);
  _Block_release(v6);
  _Block_release(v6);
...
- (void)handleSnoozeAlarmHal:(SnoozeAlarmHalIntent *)a3 completion:(id)a4
{
  ...
  _QWORD *v13;
  _QWORD *v14;
  SnoozeAlarmHalIntent *v15;
  _TtC21SiriTimeAlarmInternal24SnoozeAlarmIntentHandler *v16;
  uint64_t v17;
