...
+ (id)successWithResolvedAlarmReferenceType:(int64_t)a3
{
  ...
  return static AlarmReferenceTypeResolutionResult.success(with:)(a3);
}

+ (id)confirmationRequiredWithAlarmReferenceTypeToConfirm:(int64_t)a3
{
  swift_getObjCClassMetadata();
  return static AlarmReferenceTypeResolutionResult.confirmationRequired(with:)(a3);
}
...
- (AlarmReferenceTypeResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  id v6;
  void *v7;
  AlarmReferenceTypeResolutionResult *v8;
  AlarmReferenceTypeResolutionResult *v9;
  objc_super v11;
  ...
  v8 = -[AlarmReferenceTypeResolutionResult initWithJSONDictionary:forIntent:](&v11, sel_initWithJSONDictionary_forIntent_, v7, v6);
