...
{
  id v6;
  SearchAlarmIntentResponse *v7;
  int64_t *v8;
  SearchAlarmIntentResponse *v9;

  v6 = a4;
  v7 = -[SearchAlarmIntentResponse init](self, sel_init);
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___SearchAlarmIntentResponse_code);
  swift_beginAccess();
  *v8 = a3;
  v9 = v7;
  -[SearchAlarmIntentResponse setUserActivity:](v9, sel_setUserActivity_, v6);
...
- (SearchAlarmIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___SearchAlarmIntentResponse_code) = 0;
  ...
  return -[SearchAlarmIntentResponse init](&v3, sel_init);
}

- (SearchAlarmIntentResponse)initWithCoder:(id)a3
{
  return (SearchAlarmIntentResponse *)sub_247385D8C((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (SearchAlarmIntentResponse)initWithBackingStore:(id)a3
{
  return (SearchAlarmIntentResponse *)sub_247385D8C((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
