...
- (_QWORD)_initWithCondition:(uint64_t)a3 value:
{
  id v5;
  uint64_t v6;
  void *v7;
...
- (void)encodeWithRBSXPCCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeInt64:forKey:", self->_value, CFSTR("_value"));
...
- (RBSConditionAttribute)initWithRBSXPCCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_value = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("_value"));
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)RBSConditionAttribute;
  if (!-[RBSAttribute isEqual:](&v10, sel_isEqual_, v4) || self->_value != v4[2])
    goto LABEL_9;
...
- (id)description
{
  ...
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("<%@| condition:%@ value:%lld>"), v4, self->_condition, self->_value);
