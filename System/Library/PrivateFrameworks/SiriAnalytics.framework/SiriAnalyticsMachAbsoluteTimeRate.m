  ...
  if (v0)
  {
    ...
    if (os_log_type_enabled((os_log_t)SiriAnalyticsLogContextUtility, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      v9 = 1024;
      numer = v3;
      _os_log_error_impl(&dword_1A025F000, v4, OS_LOG_TYPE_ERROR, "%s mach_timebase_info() failed with %d.", buf, 0x12u);
    }
  }
  else
  {
    ...
    *(double *)&_SiriAnalyticsMachAbsoluteTimeRate_rate = (double)v1 / (double)v2;
    ...
    if (os_log_type_enabled((os_log_t)SiriAnalyticsLogContextUtility, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315906;
      ...
      _os_log_impl(&dword_1A025F000, v5, OS_LOG_TYPE_INFO, "%s machTimebaseInfo.numer = %u, machTimebaseInfo.denom = %u, rate = %f", buf, 0x22u);
    }
  }
}
