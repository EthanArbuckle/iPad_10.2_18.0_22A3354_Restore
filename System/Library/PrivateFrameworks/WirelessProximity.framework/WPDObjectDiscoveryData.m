...
LABEL_13:
    ...
    if (os_log_type_enabled((os_log_t)WiProxLog, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218752;
      ...
      v96 = 2048;
      v97 = v13 + ~v22;
      _os_log_debug_impl(&dword_209E41000, v32, OS_LOG_TYPE_DEBUG, "ObjectDiscovery length payload:%ld state:%d data:%ld optional:%ld", buf, 0x26u);
    }
    ...
    *v58 = *v58 & 0x3F | (v55 << 6);
    ...
    v9 = v56;
    if (WPLogInitOnce != -1)
      dispatch_once(&WPLogInitOnce, &__block_literal_global_108_0);
    v73 = WiProxLog;
    if (os_log_type_enabled((os_log_t)WiProxLog, OS_LOG_TYPE_DEBUG))
...
{
  OUTLINED_FUNCTION_0(&dword_209E41000, a2, a3, "ObjectDiscovery report ScanManager source: %@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
...
{
  OUTLINED_FUNCTION_0(&dword_209E41000, a2, a3, "ObjectDiscovery report: %@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
...
{
  OUTLINED_FUNCTION_0(&dword_209E41000, a2, a3, "ObjectDiscovery payload:%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
...
{
  OUTLINED_FUNCTION_2_1(&dword_209E41000, a1, a3, "ObjectDiscovery found NearOwner payload", a5, a6, a7, a8, 0);
...
{
  OUTLINED_FUNCTION_2_1(&dword_209E41000, a1, a3, "ObjectDiscovery found Wild payload", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_1_1();
}
...
+ (void)objectDiscoveryReportFromAdvReport:(os_log_t)log .cold.6(os_log_t log)
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_209E41000, log, OS_LOG_TYPE_ERROR, "ObjectDiscovery found unexpected payload", v1, 2u);
  OUTLINED_FUNCTION_1_1();
}
...
+ (void)applyMaskToAddress:(_BYTE *)a1 .cold.1(_BYTE *a1, NSObject *a2)
{
  ...
  v3[0] = 67109120;
  v3[1] = v2;
  _os_log_debug_impl(&dword_209E41000, a2, OS_LOG_TYPE_DEBUG, "ObjectDiscovery address is valid: %d", (uint8_t *)v3, 8u);
  OUTLINED_FUNCTION_1_1();
}
