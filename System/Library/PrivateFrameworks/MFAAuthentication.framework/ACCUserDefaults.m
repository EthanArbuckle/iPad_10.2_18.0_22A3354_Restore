...
void __33__ACCUserDefaults_sharedDefaults__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCF50]), "initWithSuiteName:", CFSTR("com.apple.CoreAccessories"));
...
void __37__ACCUserDefaults_sharedDefaultsIapd__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCF50]), "initWithSuiteName:", CFSTR("com.apple.iapd"));
...
void __40__ACCUserDefaults_sharedDefaultsLogging__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCF50]), "initWithSuiteName:", CFSTR("com.apple.logging"));
