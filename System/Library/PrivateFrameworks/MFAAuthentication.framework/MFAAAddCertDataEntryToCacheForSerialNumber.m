@implementation MFAAAddCertDataEntryToCacheForSerialNumber
...
void __MFAAAddCertDataEntryToCacheForSerialNumber_block_invoke(uint64_t a1)
{
  ...
  if (CFDictionaryGetValue(*(CFDictionaryRef *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) + 40), *(const void **)(a1 + 48)))
  {
    *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 24) = IncrementCertEntryUsageCount(*(_QWORD *)(a1 + 64), *(void **)(a1 + 48));
LABEL_25:
    v31 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24);
    *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 24) = SyncCertCacheContentsToPreferencesFile(*(_QWORD *)(v31 + 32), *(const void **)(v31 + 40));
    return;
  }
  ...
  if (Mutable)
  {
    ...
    Count = CFDictionaryGetCount(*(CFDictionaryRef *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) + 40));
    if (Count >= 16)
    {
      v6 = Count;
      v7 = 8 * Count;
      ...
      CFDictionaryGetKeysAndValues(*(CFDictionaryRef *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) + 40), v8, v8);
      v11 = 0;
      v12 = 0;
      do
      {
      ...
      if (v12)
      {
        CFDictionaryRemoveValue(*(CFMutableDictionaryRef *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) + 40), v12);
      }
      else
      {
    ...
    CFDictionaryAddValue(*(CFMutableDictionaryRef *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) + 40), *(const void **)(a1 + 48), v4);
  }
  else
  {
...
{
  OUTLINED_FUNCTION_0_0(&dword_212836000, MEMORY[0x24BDACB70], a3, "CFArrayCreateMutable pValueArray:NULL\n", a5, a6, a7, a8, 0);
...
{
  OUTLINED_FUNCTION_0_0(&dword_212836000, MEMORY[0x24BDACB70], a3, "CFMutableDictionaryRef pKeyToDelete:NULL\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2_0();
}
