...
- (DEVariableNumber)init
{
  ...
  if (v2)
  {
    ...
    v3[2] = 0;
    *v3 = &off_1E793A4E0;
    *(_QWORD *)&v8 = siri::dialogengine::VariableNumber::VariableNumber((siri::dialogengine::VariableNumber *)(v3 + 3));
    *((_QWORD *)&v8 + 1) = v3;
    v9 = v8;
...
- (DEVariableNumber)initWithSharedPtr:(void *)a3
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)DEVariableNumber;
...
- (DEVariableNumber)initWithName:(id)a3 value:(double)a4
{
  ...
  v6 = a3;
  v19.receiver = self;
  v19.super_class = (Class)DEVariableNumber;
  ...
  if (v7)
  {
    ...
    v8[2] = 0;
    *v8 = &off_1E793A4E0;
    *(_QWORD *)&v17 = siri::dialogengine::VariableNumber::VariableNumber((uint64_t)(v8 + 3), &__p, a4);
    *((_QWORD *)&v17 + 1) = v8;
    v18 = v17;
    v17 = 0uLL;
