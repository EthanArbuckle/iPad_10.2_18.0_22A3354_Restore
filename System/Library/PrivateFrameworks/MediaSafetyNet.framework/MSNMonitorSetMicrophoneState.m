@implementation MSNMonitorSetMicrophoneState
...
void __MSNMonitorSetMicrophoneState_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1D416F000, v0, v1, "Microphone status should not be set when mic process is broken out.", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
