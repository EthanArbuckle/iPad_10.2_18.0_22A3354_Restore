...
- (_bmFMDatabase)initWithPath:(id)a3
{
  ...
  if (!sqlite3_threadsafe())
    -[_bmFMDatabase initWithPath:].cold.1();
  v11.receiver = self;
  v11.super_class = (Class)_bmFMDatabase;
  v5 = -[_bmFMDatabase init](&v11, sel_init);
  if (v5)
  {
...
- (void)dealloc
{
  ...
  -[_bmFMDatabase dealloc](&v3, sel_dealloc);
}
...
+ (id)sqliteLibVersion
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("%s"), sqlite3_libversion());
}
...
- (void)setMaxBusyRetryTimeInterval:(double)a3
{
  ...
  if (db)
  {
    ...
    {
      v5 = (int (__cdecl *)(void *, int))FMDBDatabaseBusyHandler;
    }
...
- (void)closeOpenResultSets
{
  ...
  v3 = (void *)-[NSMutableSet copy](self->_openResultSets, "copy");
  v11 = 0u;
  v12 = 0u;
  v13 = 0u;
  v14 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        objc_msgSend(v9, "pointerValue", (_QWORD)v11);
...
- (void)clearCachedStatements
{
  ...
  v20 = 0u;
  v21 = 0u;
  -[NSMutableDictionary objectEnumerator](self->_cachedStatements, "objectEnumerator");
        ...
        if (v10)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              objc_msgSend(*(id *)(*((_QWORD *)&v14 + 1) + 8 * v13++), "close");
            }
            while (v11 != v13);
...
- (id)cachedStatementForQuery:(id)a3
{
  ...
  -[NSMutableDictionary objectForKey:](self->_cachedStatements, "objectForKey:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "objectsPassingTest:", &__block_literal_global_0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setCachedStatement:(id)a3 forQuery:(id)a4
{
  ...
  if (v7)
  {
    ...
    -[NSMutableDictionary objectForKey:](self->_cachedStatements, "objectForKey:", v9);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v10)
    {
...
- (BOOL)rekey:(id)a3
{
  ...
  objc_msgSend(v4, "dataWithBytes:length:", v6, strlen(v8));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)goodConnection
{
  ...
  if (!self->_isOpen)
    return 0;
  -[_bmFMDatabase executeQuery:](self, "executeQuery:", CFSTR("select name from sqlite_master where type='table'"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = v2;
  v4 = v2 != 0;
  if (v2)
...
- (BOOL)databaseExists
{
  ...
  if (!self->_isOpen)
  {
    ...
    if (self->_crashOnErrors)
      -[_bmFMDatabase databaseExists].cold.1((uint64_t)a2, (uint64_t)self);
  }
  return isOpen;
}
...
- (id)lastErrorMessage
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", sqlite3_errmsg((sqlite3 *)self->_db));
}
...
- (id)errorWithMessage:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("_bmFMDatabase"), sqlite3_errcode((sqlite3 *)self->_db), v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)lastError
{
  ...
  -[_bmFMDatabase lastErrorMessage](self, "lastErrorMessage");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[_bmFMDatabase errorWithMessage:](self, "errorWithMessage:", v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v9 != v8)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v11)
          ...
          v12 = "";
        v13 = sqlite3_bind_blob(a5, a4, v12, objc_msgSend(v10, "length"), (void (__cdecl *)(void *))0xFFFFFFFFFFFFFFFFLL);
        goto LABEL_9;
      }
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        {
          -[_bmFMDatabase stringFromDate:](self, "stringFromDate:", v8);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_33:
          v32 = objc_retainAutorelease(v16);
          v14 = sqlite3_bind_text(a5, a4, (const char *)objc_msgSend(v32, "UTF8String"), -1, (void (__cdecl *)(void *))0xFFFFFFFFFFFFFFFFLL);
      ...
      if (strcmp((const char *)objc_msgSend(v17, "objCType"), "c"))
      {
        ...
        if (!strcmp((const char *)objc_msgSend(v22, "objCType"), "I"))
        {
          v34 = objc_msgSend(v22, "unsignedIntValue");
        }
        else
        {
          ...
          {
            v35 = objc_msgSend(v23, "longValue");
          }
          else
          {
            ...
            {
              v35 = objc_msgSend(v24, "unsignedLongValue");
            }
            else
            {
              v25 = objc_retainAutorelease(v24);
              if (!strcmp((const char *)objc_msgSend(v25, "objCType"), "q"))
              {
                v35 = objc_msgSend(v25, "longLongValue");
              }
              else
              {
                v26 = objc_retainAutorelease(v25);
                if (strcmp((const char *)objc_msgSend(v26, "objCType"), "Q"))
                {
                  ...
                  else
                  {
                    ...
                    if (strcmp((const char *)objc_msgSend(v28, "objCType"), "d"))
                    {
...
LABEL_39:
                      v13 = sqlite3_bind_int(a5, a4, v33);
                      goto LABEL_9;
                    }
                    objc_msgSend(v28, "doubleValue");
                  }
LABEL_30:
                  v13 = sqlite3_bind_double(a5, a4, v31);
                  goto LABEL_9;
                }
                v35 = objc_msgSend(v26, "unsignedLongLongValue");
              }
            }
          }
          v34 = v35;
        }
        v13 = sqlite3_bind_int64(a5, a4, v34);
        goto LABEL_9;
      }
      v33 = objc_msgSend(v17, "charValue");
      goto LABEL_39;
    }
  }
  v13 = sqlite3_bind_null(a5, a4);
LABEL_9:
  v14 = v13;
LABEL_10:
    ...
    if ((int)v17 > 98)
    {
      switch((int)v17)
      {
        case 'c':
          ...
          v44 += 8;
          v20 = (id)objc_msgSend(v18, "initWithFormat:", CFSTR("%c"), *v19);
          goto LABEL_31;
        case 'd':
        case 'i':
          goto LABEL_13;
        ...
        case 'h':
          ...
          if (objc_msgSend(v9, "characterAtIndex:", v15 + 1) == 105)
          {
            v27 = v44;
            v44 += 8;
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithShort:", *(__int16 *)v27);
          ...
          if (objc_msgSend(v9, "characterAtIndex:", v15 + 1) == 117)
          {
            ...
            v44 += 8;
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedShort:", *v36);
            v28 = objc_claimAutoreleasedReturnValue();
            goto LABEL_42;
          }
LABEL_36:
        ...
        case 'l':
          ...
          if (v29 == 100)
          {
            v38 = v44;
            v44 += 8;
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", *(_QWORD *)v38);
            v28 = objc_claimAutoreleasedReturnValue();
            goto LABEL_42;
          }
          if (v29 == 117)
          {
            v39 = v44;
            v44 += 8;
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLong:", *(_QWORD *)v39);
            v28 = objc_claimAutoreleasedReturnValue();
            goto LABEL_42;
          }
          if (v29 != 108)
...
LABEL_33:
          ...
          if (v15 < v13)
          {
            if (objc_msgSend(v9, "characterAtIndex:", v15) == 100)
            {
              v30 = v44;
              v44 += 8;
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *(_QWORD *)v30);
              v20 = (id)objc_claimAutoreleasedReturnValue();
              goto LABEL_31;
            }
            if (objc_msgSend(v9, "characterAtIndex:", v15) == 117)
            {
              v42 = v44;
              v44 += 8;
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", *(_QWORD *)v42);
              v20 = (id)objc_claimAutoreleasedReturnValue();
              goto LABEL_31;
            }
          }
        ...
        case 'q':
          ...
          if (objc_msgSend(v9, "characterAtIndex:", v15 + 1) == 105)
          {
            v31 = v44;
            v44 += 8;
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *(_QWORD *)v31);
            v28 = objc_claimAutoreleasedReturnValue();
          }
          else
          {
...
LABEL_42:
        ...
        case 's':
          v32 = v44;
          v44 += 8;
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", *(_QWORD *)v32);
          v20 = (id)objc_claimAutoreleasedReturnValue();
          goto LABEL_31;
        case 'u':
          goto LABEL_12;
...
- (id)executeQuery:(id)a3 withArgumentsInArray:(id)a4 orDictionary:(id)a5 orVAList:(char *)a6 shouldBind:(BOOL)a7
{
  ...
  if (!self->_isExecutingStatement)
  {
    ...
    {
      -[_bmFMDatabase cachedStatementForQuery:](self, "cachedStatementForQuery:", v13);
      v18 = (_bmFMStatement *)objc_claimAutoreleasedReturnValue();
      v19 = v18;
      if (v18)
      {
    ...
    if (sqlite3_prepare_v2(db, (const char *)objc_msgSend(v21, "UTF8String"), -1, &ppStmt, 0))
    {
      ...
      if (self->_crashOnErrors)
        -[_bmFMDatabase executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:].cold.1(self, (uint64_t)a2);
...
LABEL_20:
    ...
    else
    {
      ...
      +[_bmFMResultSet resultSetWithStatement:usingParentDatabase:shouldAutoClose:](_bmFMResultSet, "resultSetWithStatement:usingParentDatabase:shouldAutoClose:", v19, self, v7);
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v24, "setQuery:", v13);
      objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithNonretainedObject:", v24);
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      -[NSMutableSet addObject:](self->_openResultSets, "addObject:", v25);
      -[_bmFMStatement setUseCount:](v19, "setUseCount:", -[_bmFMStatement useCount](v19, "useCount") + 1);
      self->_isExecutingStatement = 0;
      v16 = v24;
...
- (BOOL)bindStatement:(sqlite3_stmt *)a3 WithArgumentsInArray:(id)a4 orDictionary:(id)a5 orVAList:(char *)a6
{
        ...
        for (i = 0; i != v13; ++i)
        {
          ...
          else
          {
            ...
            if ((_DWORD)v24)
            {
              ...
              NSLog(CFSTR("Error: unable to bind (%d, %s"), v24, v34);
              sqlite3_finalize(a3);
              self->_isExecutingStatement = 0;
  ...
  else
  {
    ...
    while (1)
    {
      ...
      if (v39 == v25)
        break;
      if (v37 && v25 < (int)objc_msgSend(v37, "count"))
      {
      ...
      v30 = -[_bmFMDatabase bindObject:toColumn:inStatement:](self, "bindObject:toColumn:inStatement:", v26, ++v25, a3);
      if ((_DWORD)v30)
      {
        v31 = v30;
        v32 = sqlite3_errmsg((sqlite3 *)self->_db);
        NSLog(CFSTR("Error: unable to bind (%d, %s"), v31, v32);
        sqlite3_finalize(a3);
        v33 = 0;
        self->_isExecutingStatement = 0;
        goto LABEL_37;
...
- (id)executeQuery:(id)a3
{
  ...
  -[_bmFMDatabase executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:](self, "executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:", a3, 0, 0, &v4, 1);
...
- (id)executeQueryWithFormat:(id)a3
{
  ...
  v5 = a3;
  objc_msgSend(v4, "stringWithCapacity:", objc_msgSend(v5, "length"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99DE8], "array");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[_bmFMDatabase extractSQL:argumentsList:intoString:arguments:](self, "extractSQL:argumentsList:intoString:arguments:", v5, &v10, v6, v7);

  -[_bmFMDatabase executeQuery:withArgumentsInArray:](self, "executeQuery:withArgumentsInArray:", v6, v7);
...
- (id)executeQuery:(id)a3 values:(id)a4 error:(id *)a5
{
  ...
  -[_bmFMDatabase executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:](self, "executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:", a3, a4, 0, 0, 1);
  v7 = objc_claimAutoreleasedReturnValue();
  v8 = (void *)v7;
  if (a5 && !v7)
  {
    -[_bmFMDatabase lastError](self, "lastError");
...
- (BOOL)executeUpdate:(id)a3 error:(id *)a4 withArgumentsInArray:(id)a5 orDictionary:(id)a6 orVAList:(char *)a7
{
  ...
  -[_bmFMDatabase executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:](self, "executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:", a3, a5, a6, a7, 1);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v9;
  if (v9)
  {
...
- (BOOL)executeUpdateWithFormat:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0C99DE8], "array");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[_bmFMDatabase extractSQL:argumentsList:intoString:arguments:](self, "extractSQL:argumentsList:intoString:arguments:", v5, &v9, v6, v7);

  LOBYTE(self) = -[_bmFMDatabase executeUpdate:withArgumentsInArray:](self, "executeUpdate:withArgumentsInArray:", v6, v7);
  return (char)self;
}
...
- (BOOL)executeStatements:(id)a3 withResultBlock:(id)a4
{
  ...
  if (v6)
    v11 = (int (__cdecl *)(void *, int, char **, char **))FMDBExecuteBulkSQLCallback;
  else
    v11 = 0;
...
- (BOOL)rollbackToSavePointWithName:(id)a3 error:(id *)a4
{
  ...
  objc_msgSend(v7, "stringByReplacingOccurrencesOfString:withString:", CFSTR("'"), CFSTR("''"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v8, "initWithFormat:", CFSTR("rollback transaction to savepoint '%@';"), v9);
...
- (id)inSavePoint:(id)a3
{
  ...
  v6 = inSavePoint__savePointIdx++;
  v7 = (void *)objc_msgSend(v5, "initWithFormat:", CFSTR("dbSavePoint%ld"), v6);
  v17 = 0;
  v16 = 0;
...
- (BOOL)checkpoint:(int)a3 name:(id)a4 logFrameCount:(int *)a5 checkpointCount:(int *)a6 error:(id *)a7
{
  ...
  if (v14)
  {
    ...
    if (-[_bmFMDatabase crashOnErrors](self, "crashOnErrors"))
      -[_bmFMDatabase checkpoint:name:logFrameCount:checkpointCount:error:].cold.1(self, (uint64_t)a2);
  }
...
- (void)makeFunctionNamed:(id)a3 arguments:(int)a4 block:(id)a5
{
  ...
  sqlite3_create_function(v13, (const char *)objc_msgSend(v14, "UTF8String"), a4, 1, v12, (void (__cdecl *)(sqlite3_context *, int, sqlite3_value **))FMDBBlockSQLiteCallBackFunction, 0, 0);
...
- (id)valueString:(void *)a3
{
  ...
  v3 = (void *)sqlite3_value_text((sqlite3_value *)a3);
  if (v3)
  {
...
- (void)executeQuery:(void *)a1 withArgumentsInArray:(uint64_t)a2 orDictionary:orVAList:shouldBind:.cold.1(void *a1, uint64_t a2)
{
  ...
  objc_msgSend(a1, "lastErrorMessage");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)stringForQuery:(id)a3
{
  ...
  -[_bmFMDatabase executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:](self, "executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:", a3, 0, 0, &v6, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = 0;
...
- (double)doubleForQuery:(id)a3
{
  ...
  -[_bmFMDatabase executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:](self, "executeQuery:withArgumentsInArray:orDictionary:orVAList:shouldBind:", a3, 0, 0, &v7, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = 0.0;
  if (objc_msgSend(v3, "next"))
  {
...
- (id)dataForQuery:(id)a3
{
  ...
  if (objc_msgSend(v3, "next"))
  {
    objc_msgSend(v3, "dataForColumnIndex:", 0);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "close");
    objc_msgSend(v3, "setParentDB:", 0);
  }
...
- (id)dateForQuery:(id)a3
{
  ...
  if (objc_msgSend(v3, "next"))
  {
    objc_msgSend(v3, "dateForColumnIndex:", 0);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "close");
    objc_msgSend(v3, "setParentDB:", 0);
  }
...
- (BOOL)tableExists:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_bmFMDatabase executeQuery:](self, "executeQuery:", CFSTR("select [sql] from sqlite_master where [type] = 'table' and lower(name) = ?"), v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)getTableSchema:(id)a3
{
  ...
  v5 = a3;
  v6 = (void *)objc_msgSend([v4 alloc], "initWithFormat:", CFSTR("pragma table_info('%@')"), v5);

  -[_bmFMDatabase executeQuery:](self, "executeQuery:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)columnExists:(id)a3 inTableWithName:(id)a4
{
  ...
  -[_bmFMDatabase getTableSchema:](self, "getTableSchema:", v7);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  do
  {
    ...
    if (!v10)
      break;
    objc_msgSend(v9, "stringForColumn:", CFSTR("name"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unsigned)applicationID
{
  ...
  -[_bmFMDatabase executeQuery:](self, "executeQuery:", CFSTR("pragma application_id"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setApplicationID:(unsigned int)a3
{
  ...
  v5 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("pragma application_id=%d"), *(_QWORD *)&a3);
  -[_bmFMDatabase executeQuery:](self, "executeQuery:", v5);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unsigned)userVersion
{
  ...
  -[_bmFMDatabase executeQuery:](self, "executeQuery:", CFSTR("pragma user_version"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v2, "next"))
    v3 = objc_msgSend(v2, "longLongIntForColumnIndex:", 0);
  else
...
- (void)setUserVersion:(unsigned int)a3
{
  ...
  v5 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("pragma user_version = %d"), *(_QWORD *)&a3);
  -[_bmFMDatabase executeQuery:](self, "executeQuery:", v5);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "next");
  objc_msgSend(v4, "close");
...
- (BOOL)validateSQL:(id)a3 error:(id *)a4
{
  ...
  if (a4 && v10)
  {
    ...
    v14 = -[_bmFMDatabase lastErrorCode](self, "lastErrorCode");
    v15 = (void *)MEMORY[0x1E0C99D80];
    -[_bmFMDatabase lastErrorMessage](self, "lastErrorMessage");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "dictionaryWithObject:forKey:", v16, *MEMORY[0x1E0CB2D50]);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "errorWithDomain:code:userInfo:", v13, v14, v17);
    *a4 = (id)objc_claimAutoreleasedReturnValue();
