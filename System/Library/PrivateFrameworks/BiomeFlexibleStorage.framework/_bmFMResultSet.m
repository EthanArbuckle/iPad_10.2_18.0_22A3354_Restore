...
- (void)dealloc
{
  ...
  -[_bmFMResultSet dealloc](&v5, sel_dealloc);
}
...
- (NSMutableDictionary)columnNameToIndexMap
{
  ...
  if (!self->_columnNameToIndexMap)
  {
    ...
    v4 = (NSMutableDictionary *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E08]), "initWithCapacity:", v3);
    columnNameToIndexMap = self->_columnNameToIndexMap;
    ...
    if (v3 >= 1)
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", sqlite3_column_name((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), v6));
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "lowercaseString");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        -[NSMutableDictionary setObject:forKey:](v7, "setObject:forKey:", v8, v10);
  ...
  if (v4 >= 1)
  {
    ...
    for (i = 0; i != v5; ++i)
    {
      ...
      if (v7)
      {
        ...
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", sqlite3_column_name((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), i));
        v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)resultDict
{
  ...
  if (v3)
  {
    ...
    -[_bmFMResultSet columnNameToIndexMap](self, "columnNameToIndexMap");
    ...
    if (v7)
    {
      ...
      do
      {
        -[_bmFMResultSet objectForColumnName:](self, "objectForColumnName:", v8);
        v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)resultDictionary
{
  ...
  if (v3)
  {
    ...
    if (v5 >= 1)
    {
      ...
      do
      {
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", sqlite3_column_name((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), v7));
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        -[_bmFMResultSet objectForColumnIndex:](self, "objectForColumnIndex:", v7);
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v4, "setObject:forKey:", v9, v8);
...
- (int)internalStepWithError:(id *)a3
{
  ...
  if ((v5 - 5) <= 1)
  {
    -[_bmFMDatabase databasePath](self->_parentDB, "databasePath");
...
LABEL_7:
  ...
  if ((_DWORD)v5 != 21)
  {
    ...
    if (a3)
    {
      -[_bmFMDatabase lastError](self->_parentDB, "lastError");
  ...
  if (a3)
  {
    ...
    {
LABEL_5:
      -[_bmFMDatabase lastError](parentDB, "lastError");
      *a3 = (id)objc_claimAutoreleasedReturnValue();
      goto LABEL_8;
    }
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObject:forKey:", CFSTR("parentDB does not exist"), *MEMORY[0x1E0CB2D50]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("_bmFMDatabase"), 21, v11);
    *a3 = (id)objc_claimAutoreleasedReturnValue();
...
- (id)stringForColumnIndex:(int)a3
{
  ...
  if ((a3 & 0x80000000) == 0 && v5 != 5)
  {
    ...
    {
      v6 = (void *)sqlite3_column_text((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), a3);
      if (v6)
      {
...
- (id)dateForColumnIndex:(int)a3
{
  ...
  if ((v3 & 0x80000000) == 0 && v5 != 5)
  {
    ...
    {
      parentDB = self->_parentDB;
      -[_bmFMResultSet stringForColumnIndex:](self, "stringForColumnIndex:", v3);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      -[_bmFMDatabase dateFromString:](parentDB, "dateFromString:", v8);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((a3 & 0x80000000) == 0 && v5 != 5)
  {
    if (sqlite3_column_count((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement")) > a3
      && (v7 = sqlite3_column_blob((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), a3),
          ...
          v7))
    {
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v7, v8);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
...
- (id)dataNoCopyForColumnIndex:(int)a3
{
  ...
  if ((a3 & 0x80000000) == 0 && v5 != 5)
  {
    ...
    {
      v7 = sqlite3_column_blob((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), a3);
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytesNoCopy:length:freeWhenDone:", v7, sqlite3_column_bytes((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), a3), 0);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
    }
  }
  return v6;
...
- (id)objectForColumnIndex:(int)a3
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        case 4:
          -[_bmFMResultSet dataForColumnIndex:](self, "dataForColumnIndex:", v3);
          v6 = (void *)objc_claimAutoreleasedReturnValue();
          if (!v6)
            goto LABEL_16;
          break;
        case 2:
          ...
          break;
        case 1:
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[_bmFMResultSet longLongIntForColumnIndex:](self, "longLongIntForColumnIndex:", v3));
          v6 = (void *)objc_claimAutoreleasedReturnValue();
          if (!v6)
            goto LABEL_16;
          break;
...
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", sqlite3_column_name((sqlite3_stmt *)-[_bmFMStatement statement](self->_statement, "statement"), a3));
}
