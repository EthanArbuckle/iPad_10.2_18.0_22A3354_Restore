...
{
  NANowPlayingIndicatorView *v3;
  NANowPlayingIndicatorView *v4;
  void *v5;
  void *v6;
  double v7;
  double v8;
  ...
  v3 = -[NANowPlayingIndicatorView initWithFrame:](&v10, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
    -[NANowPlayingIndicatorView setUserInteractionEnabled:](v3, "setUserInteractionEnabled:", 0);
    objc_msgSend(MEMORY[0x1E0DC3658], "clearColor");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[NANowPlayingIndicatorView setBackgroundColor:](v4, "setBackgroundColor:", v5);
    ...
    -[NANowPlayingIndicatorView _reloadLevelViews](v4, "_reloadLevelViews");
  }
  return v4;
}
...
- (void)tintColorDidChange
{
  ...
  -[NANowPlayingIndicatorView tintColorDidChange](&v14, sel_tintColorDidChange);
  if (self->_showsLevelGutters)
    -[NANowPlayingIndicatorView setNeedsDisplay](self, "setNeedsDisplay");
  v12 = 0u;
  v13 = 0u;
  v10 = 0u;
  v11 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        -[NANowPlayingIndicatorView tintColor](self, "tintColor", (_QWORD)v10);
    ...
    while (2)
    {
      ...
      switch(self->_playbackState)
      {
        case 0:
          ...
          objc_msgSend(v9, "setToValue:", &unk_1E71E1A18);
          goto LABEL_19;
        case 1:
          ...
          objc_msgSend(v9, "setRemovedOnCompletion:", 0);
          objc_msgSend(v9, "setFillMode:", v63);
          -[NANowPlayingIndicatorView _seedValueForBarIndex:](self, "_seedValueForBarIndex:", v4 + v6);
...
LABEL_19:
          ...
          else
          {
            ...
            objc_msgSend(v41, "setValues:", &unk_1E71E1AD8);
            objc_msgSend(v41, "setKeyTimes:", &unk_1E71E1AF0);
...
- (void)layoutSubviews
{
  ...
  -[NANowPlayingIndicatorView layoutSubviews](&v24, sel_layoutSubviews);
  -[NANowPlayingIndicatorView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
...
- (void)_reloadLevelViews
{
  ...
  else
  {
    ...
    do
    {
            ...
            (v8 = (void *)objc_claimAutoreleasedReturnValue()) == 0))
      {
        ...
        -[NANowPlayingIndicatorView tintColor](self, "tintColor");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        -[NANowPlayingIndicatorView addSubview:](self, "addSubview:", v8);
  ...
  -[NANowPlayingIndicatorView _updateLevelAnimations](self, "_updateLevelAnimations");
  -[NANowPlayingIndicatorView setNeedsLayout](self, "setNeedsLayout");
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  if (self->_showsLevelGutters)
  {
    ...
    {
      -[NANowPlayingIndicatorView tintColor](self, "tintColor", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setNumberOfLevels:(int64_t)a3
{
  if (self->_numberOfLevels != a3)
  {
    ...
    -[NANowPlayingIndicatorView _reloadLevelViews](self, "_reloadLevelViews");
  }
}
...
- (void)setPlaybackState:(int64_t)a3
{
  if (self->_playbackState != a3)
  {
    ...
    if (a3 == 3)
    {
      ...
      -[NANowPlayingIndicatorView performSelector:withObject:afterDelay:](self, "performSelector:withObject:afterDelay:", sel__bufferTimerFired, 0, 1.0);
    }
    -[NANowPlayingIndicatorView _updateLevelAnimations](self, "_updateLevelAnimations");
  }
}
...
- (double)_seedValueForBarIndex:(unint64_t)a3
{
  ...
  if (-[NANowPlayingIndicatorView bounceStyle](self, "bounceStyle") == 1)
    -[NANowPlayingIndicatorView _fixedSeedValueForBarIndex:](self, "_fixedSeedValueForBarIndex:", a3);
  else
    -[NANowPlayingIndicatorView _randomSeedValueForBar](self, "_randomSeedValueForBar");
  return result;
}
