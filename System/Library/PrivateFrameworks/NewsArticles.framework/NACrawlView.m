...
id ___NACrawlView_block_invoke_2(uint64_t a1)
{
  ...
  if (v2 == 1)
  {
    ...
    aBlock[1] = 3221225472;
    aBlock[2] = ___NACrawlView_block_invoke_3;
    aBlock[3] = &unk_1E7194C28;
    v7 = *(_OWORD *)(a1 + 32);
    v3 = (id)v7;
    v12 = v7;
    v4 = (id *)aBlock;
...
void ___NACrawlView_block_invoke_3(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  id v7;
  id v8;
  void *v9;
...
void ___NACrawlView_block_invoke_4(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  id v7;
  void *v8;
  uint64_t v9;
...
uint64_t __NACrawlView_block_invoke(uint64_t a1)
{
