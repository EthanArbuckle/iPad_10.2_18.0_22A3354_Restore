...
{
  id v4;
  HKHRCardioFitnessOnboardingStatus *v5;
  uint64_t v6;
  ...
  v5 = -[HKHRCardioFitnessOnboardingStatus init](&v9, sel_init);
  if (v5)
  {
...
{
  id v15;
  HKHRCardioFitnessOnboardingStatus *v16;
  HKHRCardioFitnessOnboardingStatus *v17;
  objc_super v19;

  v15 = a5;
  v19.receiver = self;
  v19.super_class = (Class)HKHRCardioFitnessOnboardingStatus;
  v16 = -[HKHRCardioFitnessOnboardingStatus init](&v19, sel_init);
  v17 = v16;
  if (v16)
  {
    v16->_state = a3;
...
- (BOOL)isEqual:(id)a3
{
  HKHRCardioFitnessOnboardingStatus *v4;
  HKHRCardioFitnessOnboardingStatus *v5;
  unsigned __int8 *v6;
  BOOL v7;
