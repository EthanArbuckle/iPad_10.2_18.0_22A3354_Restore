...
- (W5SummaryFaults)initWithSummaryFaults:(id)a3
{
  ...
  v5 = -[W5SummaryFaults init](&v9, sel_init);
  if (v5)
  {
    v6 = (NSArray *)v4;
...
- (id)description
{
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR("Faults in last Hour: %lu\n"), -[NSArray count](self->_lastHrFaults, "count"));
  if (-[NSArray count](self->_lastHrFaults, "count"))
  {
    v16 = 0u;
    v17 = 0u;
    v14 = 0u;
    ...
    if (v4)
    {
      ...
      do
      {
        for (i = 0; i != v5; ++i)
        {
          ...
          objc_msgSend(v3, "appendFormat:", CFSTR("Fault: %@\n"), v9);
          ...
          objc_msgSend(v3, "appendFormat:", CFSTR("\tInterface: %@\n"), v11);
...
- (BOOL)isEqualToFaults:(id)a3
{
  ...
  v4 = a3;
  v5 = -[NSArray count](self->_lastHrFaults, "count");
  objc_msgSend(v4, "lastHrFaults");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v4 == self)
    ...
    v6 = v4
      ...
      && -[W5SummaryFaults isEqualToFaults:](self, "isEqualToFaults:", v5);
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_lastHrFaults, "hash");
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[W5SummaryFaults init](+[W5SummaryFaults allocWithZone:](W5SummaryFaults, "allocWithZone:", a3), "init");
  -[W5SummaryFaults setLastHrFaults:](v4, "setLastHrFaults:", self->_lastHrFaults);
  return v4;
}
...
- (W5SummaryFaults)initWithCoder:(id)a3
{
  ...
  v5 = -[W5SummaryFaults init](&v16, sel_init);
  if (v5)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v11, CFSTR("_lastHrFaults"));
...
{
  objc_storeStrong((id *)&self->_lastHrFaults, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_lastHrFaults, 0);
}
