...
void __init_logging_modules_block_invoke(uint64_t a1)
{
    ...
    do
    {
      ...
      if (!v8)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 67109120;
          LODWORD(v13) = v4;
          _os_log_error_impl(&dword_21904D000, v6, OS_LOG_TYPE_ERROR, "Subsystem missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
          v7 = *(_QWORD *)(a1 + 32);
          v8 = "<Undefined>";
        }
      }
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 40) + 8 * v4) = v10;
      if (v10)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 136315394;
          ...
          v14 = 2080;
          v15 = v9;
          _os_log_debug_impl(&dword_21904D000, v6, OS_LOG_TYPE_DEBUG, "Created log object %s: %s", buf, 0x16u);
        }
      }
      else if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        ...
        v14 = 2080;
        v15 = v9;
        _os_log_error_impl(&dword_21904D000, v6, OS_LOG_TYPE_ERROR, "Failed to create os_log_t object %s: %s!", buf, 0x16u);
      }
      ++v4;
  ...
  if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = v2[279];
    LODWORD(v13) = v5;
    _os_log_impl(&dword_21904D000, MEMORY[0x24BDACB70], OS_LOG_TYPE_INFO, "Created %d log object(s)!", buf, 8u);
...
uint64_t accessoryServer_registerAvailabilityChangedHandlerForServiceEntry(const char *a1, const void *a2, unsigned int a3)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v12 = 2080;
    v13 = v8;
    _os_log_impl(&dword_21904D000, v7, OS_LOG_TYPE_DEFAULT, "Register AvailabilityChangedHandler (%d, %s)", (uint8_t *)v11, 0x12u);
  }
  result = 0;
  if (a2 && a1 && a3 <= 1)
  {
...
uint64_t _SetupAvailabilityChangedHandlerForServiceEntry(unsigned int a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)&buf[4] = "_SetupAvailabilityChangedHandlerForServiceEntry";
    v17 = 1024;
    v18 = a1;
    _os_log_impl(&dword_21904D000, v3, OS_LOG_TYPE_DEFAULT, "%s (%d)", buf, 0x12u);
  }
  if (a1 > 1)
    return 0;
  pthread_rwlock_wrlock(&_gServerAvailableTokenLock);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315650;
    ...
    v19 = 2080;
    v20 = v6;
    _os_log_impl(&dword_21904D000, v4, OS_LOG_TYPE_INFO, "%s (%d, %s)", buf, 0x1Cu);
  }
  ...
  if (v7 && *((_QWORD *)&_gServerAvailabilityChangedHandler + a1))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[4] = "_SetupAvailabilityChangedHandlerForServiceEntry";
      ...
      v21 = 1024;
      v22 = v12 != -1;
      _os_log_impl(&dword_21904D000, v9, OS_LOG_TYPE_INFO, "%s did not register for notification (%d, %s), token (%d)", buf, 0x22u);
    }
  }
  v10 = 0;
LABEL_38:
...
uint64_t accessoryServer_unregisterAvailabilityChangedHandlerForServiceEntry(uint64_t result)
{
  ...
  if (result <= 1)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v9 = 2080;
      v10 = v4;
      _os_log_impl(&dword_21904D000, v3, OS_LOG_TYPE_DEFAULT, "Unregister AvailabilityChangedHandler (%d, %s)", (uint8_t *)v8, 0x12u);
    }
    else
    {
      v5 = v1;
    ...
    if (!v3)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)state64 = 136315650;
        ...
        v12 = 2080;
        v13 = v7;
        _os_log_impl(&dword_21904D000, v6, OS_LOG_TYPE_INFO, "%s cannot get server state (%d, %s)", state64, 0x1Cu);
      }
      v4 = 0;
      goto LABEL_9;
    }
...
void sub_21904F6E0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_21904FD14(_Unwind_Exception *a1)
{
  void *v1;
  id *v2;
  uint64_t v3;
...
void __init_logging_modules_block_invoke_cold_1(uint8_t *buf, int a2, _DWORD *a3)
{
  *(_DWORD *)buf = 67109120;
  *a3 = a2;
  _os_log_error_impl(&dword_21904D000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "Category missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
}
...
void accessoryServer_registerAvailabilityChangedHandlerForServiceEntry_cold_1(const char **a1, int a2, os_log_t log)
{
  ...
  v5 = 2080;
  v6 = v3;
  _os_log_fault_impl(&dword_21904D000, log, OS_LOG_TYPE_FAULT, "AccessoryServerAvailabilityChangedHandler already set! (%d, %s)", (uint8_t *)v4, 0x12u);
  OUTLINED_FUNCTION_2();
}
...
void accessoryServer_registerAvailabilityChangedHandlerForServiceEntry_cold_2()
{
  ...
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_21904D000, MEMORY[0x24BDACB70], v0, "Make sure you have called init_logging()!\ngLogObjects: %p, gNumLogObjects: %d", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_2();
}
