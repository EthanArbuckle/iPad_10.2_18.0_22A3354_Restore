...
+ (id)description
{
  return +[SlowNetworkCondition descriptionWithProfileParamsForProfile:](SlowNetworkCondition, "descriptionWithProfileParamsForProfile:", CFSTR("100% Loss"));
}

+ (id)profileFriendlyName
{
  return CFSTR("100% packet loss");
}

- (SlowNetwork100PctLoss)init
{
  SlowNetwork100PctLoss *v2;
  void *v3;
  id v4;
  objc_super v6;
  uint8_t buf[4];
  ...
  v2 = -[SlowNetworkCondition initWithProfile:](&v6, sel_initWithProfile_, CFSTR("100% Loss"));
