...
+ (id)description
{
  return +[SlowNetworkCondition descriptionWithProfileParamsForProfile:](SlowNetworkCondition, "descriptionWithProfileParamsForProfile:", CFSTR("Edge"));
}

+ (id)profileFriendlyName
{
  return CFSTR("Edge Network - best");
}
...
- (SlowNetworkEdge)init
{
  ...
  v2 = -[SlowNetworkCondition initWithProfile:](&v6, sel_initWithProfile_, CFSTR("Edge"));
