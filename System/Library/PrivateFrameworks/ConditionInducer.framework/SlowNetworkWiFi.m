...
+ (id)description
{
  return +[SlowNetworkCondition descriptionWithProfileParamsForProfile:](SlowNetworkCondition, "descriptionWithProfileParamsForProfile:", CFSTR("Wi-Fi"));
}

+ (id)profileFriendlyName
{
  return CFSTR("WiFi Network");
}
...
- (SlowNetworkWiFi)init
{
  ...
  v2 = -[SlowNetworkCondition initWithProfile:](&v6, sel_initWithProfile_, CFSTR("Wi-Fi"));
