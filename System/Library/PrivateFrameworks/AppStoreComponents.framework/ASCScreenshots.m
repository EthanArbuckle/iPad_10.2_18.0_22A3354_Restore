...
- (ASCScreenshots)initWithArtwork:(id)a3 mediaPlatform:(id)a4
{
  ...
  v8 = -[ASCScreenshots init](&v14, sel_init);
  if (v8)
  {
...
- (ASCScreenshots)initWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v7, CFSTR("artwork"));
  ...
  if (v8)
  {
    ...
    {
      v33.receiver = self;
      v33.super_class = (Class)ASCScreenshots;
      v10 = -[ASCScreenshots init](&v33, sel_init);
      if (v10)
      {
    ...
    else
    {
      ...
      if (v24)
        -[ASCScreenshots initWithCoder:].cold.2(v24, v25, v26, v27, v28, v29, v30, v31);
      v15 = 0;
    }
  ...
  else
  {
    ...
    if (v16)
      -[ASCScreenshots initWithCoder:].cold.1(v16, v17, v18, v19, v20, v21, v22, v23);
    v15 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[ASCScreenshots artwork](self, "artwork");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("artwork"));

  -[ASCScreenshots mediaPlatform](self, "mediaPlatform");
...
- (id)description
{
  ...
  -[ASCScreenshots artwork](self, "artwork");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ASCDescriber addObject:withName:](v3, "addObject:withName:", v4, CFSTR("artwork"));
...
{
  OUTLINED_FUNCTION_0(&dword_1BCB7B000, MEMORY[0x1E0C81028], a3, "Could not decode ASCScreenshots because artwork was missing", a5, a6, a7, a8, 0);
}
...
{
  OUTLINED_FUNCTION_0(&dword_1BCB7B000, MEMORY[0x1E0C81028], a3, "Could not decode ASCScreenshots because mediaPlatform was missing", a5, a6, a7, a8, 0);
}
