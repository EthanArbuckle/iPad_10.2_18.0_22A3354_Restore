...
LABEL_15:
  ...
  v5 = (void *)qword_1ED013198;
  if (!qword_1ED013198)
  {
    objc_msgSend(MEMORY[0x1E0CB3690], "weakObjectsHashTable");
    v6 = objc_claimAutoreleasedReturnValue();
    v7 = (void *)qword_1ED013198;
    qword_1ED013198 = v6;
  ...
  if (!v8)
  {
    ...
    objc_msgSend((id)qword_1ED013198, "addObject:", v8);
  }
  ...
  if (v4)
  {
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        v14 = 2112;
        v15 = v4;
        _os_log_impl(&dword_19B546000, v8, OS_LOG_TYPE_ERROR, "%{public}@Expecting to be able to convert %@ into a UUID.", (uint8_t *)&v12, 0x16u);

      }
      objc_autoreleasePoolPop(v6);
    }
    objc_msgSend(a1, "hmf_cachedInstanceForNSUUID:", v5);
