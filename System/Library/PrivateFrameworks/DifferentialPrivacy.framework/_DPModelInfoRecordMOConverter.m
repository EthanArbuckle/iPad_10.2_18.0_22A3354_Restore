...
{
  return +[_DPModelInfoRecord createRecordFromManagedObject:](_DPModelInfoRecord, "createRecordFromManagedObject:", a3);
}
...
- (id)insertRecord:(id)a3 inManagedObjectContext:(id)a4
{
  ...
  -[_DPModelInfoRecordMOConverter copyRecord:intoManagedObject:](self, "copyRecord:intoManagedObject:", v8, v10);
  return v10;
}
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          -[_DPModelInfoRecordMOConverter insertRecord:inManagedObjectContext:](self, "insertRecord:inManagedObjectContext:", v14, v7, (_QWORD)v17);
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          ...
          if (v15)
          {
            -[_DPModelInfoRecordMOConverter copyRecord:intoManagedObject:](self, "copyRecord:intoManagedObject:", v13, v15);
