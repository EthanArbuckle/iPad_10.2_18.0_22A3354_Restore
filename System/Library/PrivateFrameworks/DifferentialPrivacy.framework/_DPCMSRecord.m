...
- (_DPCMSRecord)init
{
  ...
  return -[_DPCMSRecord initWithKey:creationDate:submitted:objectId:](self, "initWithKey:creationDate:submitted:objectId:", CFSTR("UNKNOWN"), 0, 0, v5);
}
...
- (_DPCMSRecord)initWithKey:(id)a3 creationDate:(double)a4 submitted:(BOOL)a5 objectId:(id)a6
{
  ...
  v13 = -[_DPCMSRecord init](&v16, sel_init);
  v14 = v13;
  if (v13)
  {
...
- (_DPCMSRecord)initWithCoder:(id)a3
{
  ...
  v11 = -[_DPCMSRecord initWithKey:creationDate:submitted:objectId:](self, "initWithKey:creationDate:submitted:objectId:", v5, v10, 0, v8);
...
- (id)description
{
  ...
  if (self->_submitted)
    ...
    v7 = "NO";
  objc_msgSend(v3, "stringWithFormat:", CFSTR("%@: { key=%@ ; creationDate=%.16g ; submitted=%s ; reportVersion=%lld ; "),
    v5,
    self->_key,
  ...
  if (self->_objectId)
    objc_msgSend(v8, "appendFormat:", CFSTR("objectId=%@ }"), self->_objectId);
  else
    objc_msgSend(v8, "appendString:", CFSTR("objectId=(nil) }"));
  return v8;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[_DPCMSRecord key](self, "key");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[_DPCMSRecord creationDate](self, "creationDate");
  v7 = v6;
  v8 = -[_DPCMSRecord submitted](self, "submitted");
  -[_DPCMSRecord objectId](self, "objectId");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqualToCMSRecord:(id)a3
{
  ...
  LODWORD(v6) = -[_DPCMSRecord submitted](self, "submitted");
  v12 = v6 ^ objc_msgSend(v4, "submitted");
  v13 = -[_DPCMSRecord reportVersion](self, "reportVersion");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == v4)
    ...
    v6 = v4
      ...
      && -[_DPCMSRecord isEqualToCMSRecord:](self, "isEqualToCMSRecord:", v5);
...
- (unint64_t)hash
{
  ...
  -[_DPCMSRecord creationDate](self, "creationDate");
  v6 = (unint64_t)v5;
  v7 = v4 ^ -[_DPCMSRecord submitted](self, "submitted");
  v8 = v7 ^ -[_DPCMSRecord reportVersion](self, "reportVersion");
  -[_DPCMSRecord objectId](self, "objectId");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)copyToManagedObject:(id)a3
{
  ...
  if ((isKindOfClass & 1) != 0)
  {
    ...
    if (v8 != v9)
    {
      ...
      -[_DPCMSRecord setObjectId:](self, "setObjectId:", v10);
...
- (BOOL)copyFromManagedObject:(id)a3
{
  ...
  if ((isKindOfClass & 1) != 0)
  {
    ...
    objc_msgSend(v6, "key");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_DPCMSRecord setKey:](self, "setKey:", v7);

    objc_msgSend(v6, "creationDate");
    -[_DPCMSRecord setCreationDate:](self, "setCreationDate:");
    -[_DPCMSRecord setSubmitted:](self, "setSubmitted:", objc_msgSend(v6, "submitted"));
    -[_DPCMSRecord setReportVersion:](self, "setReportVersion:", objc_msgSend(v6, "reportVersion"));
    objc_msgSend(v6, "objectID");
    v8 = (void *)objc_claimAutoreleasedReturnValue();

    -[_DPCMSRecord setObjectId:](self, "setObjectId:", v8);
  }
