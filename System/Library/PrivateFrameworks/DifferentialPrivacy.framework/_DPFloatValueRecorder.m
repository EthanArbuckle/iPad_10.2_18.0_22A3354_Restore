...
{
  return -[_DPFloatValueRecorder initWithKey:databaseDirectoryPath:readOnly:](self, "initWithKey:databaseDirectoryPath:readOnly:", a3, 0, 0);
}
...
- (BOOL)recordFloatVectors:(id)a3
{
  ...
  -[_DPDataRecorder recordFloatVectors:](self->_recorder, "recordFloatVectors:", v4);
...
- (BOOL)recordFloatVectors:(id)a3 metadata:(id)a4
{
  ...
  -[_DPDataRecorder recordFloatVectors:metadata:](self->_recorder, "recordFloatVectors:metadata:", v6, v7);
...
- (_DPFloatValueRecorder)initWithKey:(id)a3 databaseDirectoryPath:(id)a4 readOnly:(BOOL)a5
{
  ...
  v10 = -[_DPFloatValueRecorder init](&v16, sel_init);
  if (v10)
  {
    if (v9)
    {
