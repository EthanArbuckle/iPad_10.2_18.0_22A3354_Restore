...
{
  return -[_DPNumericDataRecorder initWithKey:databaseDirectoryPath:readOnly:](self, "initWithKey:databaseDirectoryPath:readOnly:", a3, 0, 0);
}
...
- (BOOL)record:(id)a3
{
  ...
  -[_DPDataRecorder recordNumbers:](self->_recorder, "recordNumbers:", v4);
...
- (BOOL)record:(id)a3 metadata:(id)a4
{
  ...
  -[_DPDataRecorder recordNumbers:metadata:](self->_recorder, "recordNumbers:metadata:", v6, v7);
...
- (BOOL)recordNumbersVectors:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)MEMORY[0x1D8256B78]();
  -[_DPDataRecorder recordNumbersVectors:](self->_recorder, "recordNumbersVectors:", v4);
  objc_autoreleasePoolPop(v5);
...
- (BOOL)recordNumbersVectors:(id)a3 metadata:(id)a4
{
  ...
  v7 = a4;
  v8 = (void *)MEMORY[0x1D8256B78]();
  -[_DPDataRecorder recordNumbersVectors:metadata:](self->_recorder, "recordNumbersVectors:metadata:", v6, v7);
  objc_autoreleasePoolPop(v8);
...
- (_DPNumericDataRecorder)initWithKey:(id)a3 databaseDirectoryPath:(id)a4 readOnly:(BOOL)a5
{
  ...
  v10 = -[_DPNumericDataRecorder init](&v16, sel_init);
  if (v10)
  {
    if (v9)
    {
