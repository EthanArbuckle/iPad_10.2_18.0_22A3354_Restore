...
void __44___DPDataTypeParameters_parametersFromFile___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("override.datatypeparameters"), CFSTR("plist"));
  v5 = (id)objc_claimAutoreleasedReturnValue();

  +[_DPPListHelper loadPropertyListFromPath:overridePath:usingBlock:](_DPPListHelper, "loadPropertyListFromPath:overridePath:usingBlock:", *(_QWORD *)(a1 + 32), v5, &__block_literal_global_16);
