...
{
  return (_TtC18HealthExperienceUI37SummarySharingAcceptedProfileTileCell *)sub_1A99F6A1C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC18HealthExperienceUI37SummarySharingAcceptedProfileTileCell)initWithCoder:(id)a3
{
  return (_TtC18HealthExperienceUI37SummarySharingAcceptedProfileTileCell *)sub_1A99F6CC4(a3);
}
