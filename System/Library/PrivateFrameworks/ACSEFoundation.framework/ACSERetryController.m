...
- (ACSERetryController)initWithMaxNumberOfRetries:(unint64_t)a3 block:(id)a4
{
  ...
  v5 = a4;
  v6 = -[ACSERetryController init](&v12, sel_init);
...
- (BOOL)executeBlock
{
  return -[ACSERetryController retryAfterSeconds:](self, "retryAfterSeconds:", 0);
}
