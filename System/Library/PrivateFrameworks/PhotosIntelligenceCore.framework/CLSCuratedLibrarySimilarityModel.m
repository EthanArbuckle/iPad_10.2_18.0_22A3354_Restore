...
{
  CLSCuratedLibrarySimilarityModel *v4;
  CLSCuratedLibrarySimilarityModel *v5;
  uint64_t v6;
  objc_super v8;
  uint8_t buf[4];
  int v10;
  ...
  v4 = -[CLSCuratedLibrarySimilarityModel init](&v8, sel_init);
  v5 = v4;
  if (v4)
  {
    if (a3 < 0x54)
    {
      if (a3 < 0x50)
      {
        ...
        {
          -[CLSCuratedLibrarySimilarityModel setupVersion33](v4, "setupVersion33");
        }
      }
      else
      {
        -[CLSCuratedLibrarySimilarityModel setupVersion80](v4, "setupVersion80");
      }
    }
    else
    {
      -[CLSCuratedLibrarySimilarityModel setupVersion84](v4, "setupVersion84");
    }
  }
  return v5;
}
...
- (id)initForTesting
{
  return -[CLSCuratedLibrarySimilarityModel initWithSceneAnalysisVersion:](self, "initWithSceneAnalysisVersion:", 84);
}
...
- (void)setupVersion84
{
  ...
  *(_OWORD *)&self->_identicalSimilarityDistanceThreshold = xmmword_24406CCE0;
...
+ (id)name
{
  return CFSTR("Curated Library Similarity");
}
