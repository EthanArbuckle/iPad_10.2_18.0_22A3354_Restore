...
- (NSUUID)operationID
{
  return (NSUUID *)(id)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDBytes:", self->_operationUUID);
}

- (_BRCOperation)init
{
  objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", CFSTR("UNIMPLEMENTED"), &stru_24FE4A790);
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      v54 = 2112;
      v55 = v36;
      _os_log_debug_impl(&dword_230455000, v37, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx creating operation %@%@", buf, 0x20u);
    }
...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "BRCOperation/? (subclass activity missing)", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)setGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v13 = 2112;
    v14 = v5;
    _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx now using group: %@%@", buf, 0x20u);
  }
...
- (void)dealloc
{
  ...
  v4 = v1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_3(&dword_230455000, v2, (uint64_t)v2, "[DEBUG] ┳%llx dealloc%@", (uint8_t *)&v3);
  OUTLINED_FUNCTION_0();
}
...
- (BOOL)_finishIfCancelled
{
  ...
  if (v3)
  {
    objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDB8EA8], 20, 0);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_scheduleExecutionWithPreviousError:(id)a3
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v61 = 2112;
    v62 = v16;
    _os_log_debug_impl(&dword_230455000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] throttle backoff: %03fs for hash:0x%016llx%@", buf, 0x20u);
  }
        ...
        !v20))
  {
    ...
    else if ((double)v27 / 1000000000.0 >= v5->_maxBackoff)
    {
      ...
      v52 = (void *)objc_msgSend(v51, "initWithDomain:code:userInfo:", *MEMORY[0x24BE17300], 23, 0);
      v53 = (void *)MEMORY[0x2348B9F14]();
    ...
    else if (v27)
    {
      ...
      v35 = v5;
      objc_sync_enter(v35);
      objc_msgSend(MEMORY[0x24BDBCE60], "dateWithTimeIntervalSinceNow:", (double)v27 / 1000000000.0);
      ...
      v39 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, v38);
      ...
      {
        ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v45);
...
- (void)schedule
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: there should be a group created for %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)cancel
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v39 = 2112;
    v40 = v3;
    _os_log_debug_impl(&dword_230455000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cancelling %@%@", buf, 0x20u);
  }
      ...
      for (j = 0; j != v13; ++j)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v39 = 2112;
          v40 = v17;
          _os_log_debug_impl(&dword_230455000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] Removed %@ as dependency of cancelled op %@%@", buf, 0x20u);
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v33 = 2112;
    v34 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx finishing %@%@", buf, 0x20u);
  }
...
- (void)_completedWithResult:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219522;
    ...
    v36 = 2112;
    v37 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx %@%@ %@%@%@%@", buf, 0x48u);
  }
  ...
  if (!-[_BRCOperation _finishIfCancelled](self, "_finishIfCancelled"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v26 = 2112;
      v27 = v11;
      _os_log_impl(&dword_230455000, v12, OS_LOG_TYPE_DEFAULT, "[WARNING] We are denylisted! Not notifying about finishing %@%@", buf, 0x16u);
    }
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0 && (objc_msgSend(v4, "nonDiscretionary") & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412802;
          ...
          v12 = 2112;
          v13 = v5;
          _os_log_impl(&dword_230455000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] Adding discretionary op %@ as a dependency of a non-discretionary op %@%@", buf, 0x20u);
        }
  ...
  if ((-[_BRCOperation isCancelled](self, "isCancelled") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&location[4] = v17;
      ...
      v30 = 2112;
      v31 = v5;
      _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] Blocking %@ on high priority operation %@%@", location, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 134218498;
          ...
          v31 = 2112;
          v32 = v9;
          _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Launching timeout timer of %llu seconds for operation %@%@", buf, 0x20u);

        }
        v11 = dispatch_time(0, v8);
        v12 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, 0);
        ...
        if (*MEMORY[0x24BE17840])
        {
          ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v18);
          v20 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)error
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self.finished%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_9(&dword_230455000, v0, v1, "[ERROR] throttle backoff is greater than max.  Failing the operation%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] %@ has been denylisted and won't be attempted again%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.3()
{
  ...
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v1, "[DEBUG] attempting execution again in %.03fs%@", v2);
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.4()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_9(&dword_230455000, v0, v1, "[ERROR] cancelling operation since reached to maximal allowed backoff%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.5()
{
  ...
  v3 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v1, "[DEBUG] server provided backoff: %.03fs%@", v2);
  OUTLINED_FUNCTION_0();
}
...
- (void)_completedWithResult:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, (uint64_t)v0, "[DEBUG] CloudKit account is temporarily unavailable. Invalidating account status after %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)completedWithResult:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] won't restore persona: %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)completedWithResult:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Not allowed to adopt persona - should fallback persona%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)completedWithResult:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Not allowed to adopt persona but data-separatedness matches%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)completedWithResult:error:.cold.4()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] Completed operation %@ with different persona than we started with%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)addSubOperation:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _syncContext%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)cancelAfterDelay:(uint64_t)a3 .cold.1(void *a1, uint64_t a2, uint64_t a3)
{
  ...
  OUTLINED_FUNCTION_3(&dword_230455000, v6, v4, "[DEBUG] Timeout already expired, cancelling operation %@%@", v5);
