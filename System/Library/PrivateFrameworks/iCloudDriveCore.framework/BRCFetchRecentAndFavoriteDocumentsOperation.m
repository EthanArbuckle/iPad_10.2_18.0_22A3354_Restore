...
- (BRCFetchRecentAndFavoriteDocumentsOperation)initWithServerZone:(id)a3 sessionContext:(id)a4
{
  ...
  if (v13)
  {
    ...
    objc_msgSend(MEMORY[0x24BDB9190], "br_fetchRecents");
...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync/fetch-recents", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)_performQueryOperationForBit:(unsigned int)a3 index:(id)a4 completion:(id)a5
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("%K == %@"), CFSTR("indexName"), v8);
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91B8]), "initWithRecordType:predicate:", CFSTR("SearchIndexes"), v30);
    ...
    v42 = v9;
    v29 = v14;
    v17 = (void *)MEMORY[0x2348BA0DC](v38);
    v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91C8]), "initWithQuery:", v10);
  ...
  if (v6 && (objc_msgSend(v6, "brc_isRetriable") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v23 = 2112;
      v24 = v8;
      _os_log_impl(&dword_230455000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] We seem to be unable to fetch %@. Setting the bit anyway to allow the sync engine to progress (error %@)%@", buf, 0x20u);
    }
...
void __93__BRCFetchRecentAndFavoriteDocumentsOperation__performQueryOperationForBit_index_completion___block_invoke_5(uint64_t a1)
{
  ...
  else
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: Couldn't allocate ranks when fetching query %@"), *(_QWORD *)(a1 + 48));
      v10 = (void *)objc_claimAutoreleasedReturnValue();
...
void __93__BRCFetchRecentAndFavoriteDocumentsOperation__performQueryOperationForBit_index_completion___block_invoke_5_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't allocate ranks when fetching query %@%@", (uint8_t *)&v4, 0x16u);
}
