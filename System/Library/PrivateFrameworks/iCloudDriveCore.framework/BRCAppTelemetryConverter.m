        ...
        default:
          switch((int)v7)
          {
            ...
            default:
              ...
              {
LABEL_42:
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), v7);
  ...
  else
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0
      || (v8 = (__CFString *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithData:encoding:", v5, 4)) == 0)
    {
      v9 = (__CFString *)v5;
LABEL_9:
      v8 = v9;
