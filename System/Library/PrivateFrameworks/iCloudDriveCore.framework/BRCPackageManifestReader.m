...
- (BRCPackageManifestReader)init
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", "-[BRCPackageManifestReader init]");
...
- (BRCPackageManifestReader)initWithInputStream:(id)a3
{
  ...
  if (v6)
  {
    ...
    v9 = objc_msgSend(objc_alloc(MEMORY[0x24BE7AF08]), "initWithStream:", *p_stream);
    reader = v7->_reader;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138413058;
        ...
        v25 = 2112;
        v26 = v13;
        _os_log_error_impl(&dword_230455000, v14, (os_log_type_t)0x90u, "[ERROR] unable to read package header %@ with version %d - %@%@", buf, 0x26u);
...
- (BRCPackageManifestReader)initWithURL:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDBCE90], "inputStreamWithURL:", a3);
...
- (BRCPackageManifestReader)initWithDeviceID:(int)a3 fileID:(unint64_t)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "br_pathWithDeviceID:fileID:", *(_QWORD *)&a3, a4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDBCE90], "inputStreamWithFileAtPath:", v5);
...
- (void)nextObject
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _reader%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
