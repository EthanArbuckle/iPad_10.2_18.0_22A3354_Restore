...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sharing/prepareFolderPCS", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
void __58__BRCSharingPCSChainFolderOperation__performPCSChainBatch__block_invoke(uint64_t a1, int a2, void *a3, uint64_t a4, void *a5)
{
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 32) + 536) += a4;
  ...
  {
    v13 = *(_QWORD **)(a1 + 32);
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLong:", v13[67]);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)main
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "brc_errorInvalidParameter:value:", CFSTR("serverItem"), 0);
