...
- (id)fetchOperationForTransfers:(id)a3 traceCode:(int)a4
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_FAULT))
      -[BRCTransferBatchOperation(Downloads) fetchOperationForTransfers:traceCode:].cold.1((uint64_t)v35, v36, v37, v38, v39, v40, v41, v42);

  }
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[BRCTransferBatchOperation itemsCount](self, "itemsCount"));
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", -[BRCTransferBatchOperation itemsCount](self, "itemsCount"));
  v52 = 0u;
  v53 = 0u;
  v50 = 0u;
  v51 = 0u;
      ...
      for (i = 0; i != v10; ++i)
      {
        ...
        if (v16)
        {
          ...
          if ((objc_msgSend(v13, "progressPublished") & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_WORD *)&buf[22] = 2112;
              v55 = v23;
              _os_log_debug_impl(&dword_230455000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Publishing download progress for %@%@", buf, 0x20u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v17;
            _os_log_fault_impl(&dword_230455000, v18, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: We got two downloads for the same record ID: %@%@", buf, 0x16u);
  ...
  *(_QWORD *)&buf[16] = 0x3032000000;
  ...
  kdebug_trace();
  v30 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB90E8]), "initWithRecordIDs:", v7);
  ...
  v33 = objc_msgSend(v32, "requestCKCacheAssetClone");

  if (v33)
    objc_msgSend(v30, "setShouldCloneFileInAssetCache:", 1);
  v47[0] = v29;
  v47[1] = 3221225472;
  v47[2] = __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_2;
  v47[3] = &unk_24FE46AE0;
  v47[4] = self;
  objc_msgSend(v30, "setPerRecordProgressBlock:", v47);
  v46[0] = v29;
  v46[1] = 3221225472;
  v46[2] = __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_101;
  v46[3] = &unk_24FE46480;
  v46[4] = self;
  objc_msgSend(v30, "setPerRecordCompletionBlock:", v46);
  v45[0] = v29;
  v45[1] = 3221225472;
  v45[2] = __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_105;
  v45[3] = &unk_24FE46B08;
  v45[4] = self;
  v45[5] = buf;
  objc_msgSend(v30, "setFetchRecordsCompletionBlock:", v45);
...
void __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_2(uint64_t a1, void *a2, double a3)
{
  ...
  if (a3 < 0.0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v13 = 2112;
      v14 = v6;
      _os_log_impl(&dword_230455000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ - Download: Received negative progress from CK. progress [%f]%@", (uint8_t *)&v9, 0x20u);
    }
...
void __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_105(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2112;
    v21 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Finished records: %@, Error: %@%@", (uint8_t *)&v14, 0x2Au);
  }
...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "BRCTransferBatchOperation/? (subclass activity missing)", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)mainWithTransfers:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_FAULT))
  {
    v5 = 138412290;
    v6 = v3;
    _os_log_fault_impl(&dword_230455000, v4, OS_LOG_TYPE_FAULT, "[CRIT] API MISUSE: should be subclassed%@", (uint8_t *)&v5, 0xCu);
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_debug_impl(&dword_230455000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - cancelling %@%@", buf, 0x20u);
    }
    ...
    if (!-[NSMutableDictionary count](self->_entriesByRecordID, "count"))
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 134218754;
        ...
        v18 = 2112;
        v19 = v9;
        _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ - operation is now empty, cancelling %@%@", buf, 0x2Au);
      }
...
- (void)_setProgress:(double)a3 forTransfer:(id)a4
{
  ...
  if (v7 > v8)
  {
    ...
    if ((a3 < 0.0 || os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEBUG))
      && round((double)v7 / (double)(unint64_t)objc_msgSend(v6, "totalSize") * 1000.0) != round((double)v10/ (double)(unint64_t)objc_msgSend(v6, "totalSize")* 1000.0))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
      {
        ...
        v24 = 2112;
        v25 = v16;
        _os_log_debug_impl(&dword_230455000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - %@ progress %.1f%%%@", (uint8_t *)&v18, 0x2Au);
      }
...
- (void)_finishedTransfer:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    v23 = 2112;
    v24 = v14;
    _os_log_debug_impl(&dword_230455000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - done with %@: %@%@", (uint8_t *)&v17, 0x2Au);
  }
...
- (void)finishedTransferForRecord:(id)a3 recordID:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)((char *)&v28 + 2) = v12;
    _os_log_debug_impl(&dword_230455000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Finished transfer for recordID: %@ with error: %@%@", buf, 0x2Au);
  }
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
        ...
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v55 = 2112;
            v56 = v16;
            _os_log_fault_impl(&dword_230455000, v17, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Missing transfer error for record %@%@", buf, 0x16u);
          }

          objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", v27, 15, CFSTR("unreachable: Missing transfer error for record %@"), v12);
          v15 = (void *)objc_claimAutoreleasedReturnValue();
        }
        v18 = self->_queue;
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v57 = 2112;
    v58 = v20;
    _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx %@ - waiting for callback...%@", buf, 0x20u);
  }
...
LABEL_10:
      _os_log_impl(&dword_230455000, v7, OS_LOG_TYPE_DEFAULT, v16, buf, 0x52u);
...
void __52__BRCTransferBatchOperation_finishWithResult_error___block_invoke_19(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v14 = 2112;
    v15 = v2;
    _os_log_debug_impl(&dword_230455000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx %@ - callbacks finished%@", buf, 0x20u);
  }
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] UNREACHABLE: no record and no error%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] API MISUSE: implement in subclass%@", a5, a6, a7, a8, 2u);
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: entries.count == 0 || error%@", a5, a6, a7, a8, 2u);
}
