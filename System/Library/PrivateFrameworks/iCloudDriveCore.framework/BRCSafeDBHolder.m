...
+ (id)newSafeDBHolder:(id)a3 withDatabaseURL:(id)a4
{
  ...
  if (v6 && v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v17 = 2112;
      v18 = v10;
      _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] <BRCSafeDBHolder %p> - Creating for db in path: %@%@", (uint8_t *)&v13, 0x20u);
    }
...
- (void)closeDatabaseSynchronously:(BOOL)a3 dispatchToSerialQueue:(BOOL)a4 completionHandler:(id)a5
{
  ...
  if (v10)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("<BRCSafeDBHolder %p>"), v9);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v16 = 2112;
      v17 = v7;
      _os_log_fault_impl(&dword_230455000, v8, OS_LOG_TYPE_FAULT, "[CRIT] %@ - Error closing BRCPendingChangesStream DB connection: %@%@", buf, 0x20u);
    }
  }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 136315906;
      ...
      v22 = 2112;
      v23 = v5;
      _os_log_error_impl(&dword_230455000, v6, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
    }
...
- (void)dealloc
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] <BRCSafeDBHolder %p> - dealloc called%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
void __86__BRCSafeDBHolder_closeDatabaseSynchronously_dispatchToSerialQueue_completionHandler___block_invoke_cold_1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(a1 + 32);
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] %@ - Database closed%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
void __86__BRCSafeDBHolder_closeDatabaseSynchronously_dispatchToSerialQueue_completionHandler___block_invoke_cold_2(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(a1 + 32);
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] %@ - Closing the database%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
