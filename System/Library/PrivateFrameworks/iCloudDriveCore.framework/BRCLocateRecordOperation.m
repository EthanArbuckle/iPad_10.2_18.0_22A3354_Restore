...
- (BRCLocateRecordOperation)initWithRecordID:(id)a3 serverZone:(id)a4 isUserWaiting:(BOOL)a5 maxBackoff:(double)a6 sessionContext:(id)a7
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412802;
    ...
    v33 = 2112;
    v34 = v18;
    _os_log_impl(&dword_230455000, v19, OS_LOG_TYPE_INFO, "[INFO] Request to locate record: [%@] of item [%@]%@", buf, 0x20u);
  }
  ...
  if (v23)
  {
    objc_msgSend(MEMORY[0x24BDB9190], "br_locateRecord");
...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync/locate-record", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)_performAfterLocatingRecord:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithObject:", self->_recordID);
...
LABEL_6:
  ...
  v28 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB90E8]), "initWithRecordIDs:", v6);
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 2112;
      v16 = v9;
      _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] record with id %@ encountered an error while locating - %@%@", (uint8_t *)&v11, 0x20u);
    }
    ...
    if (!v3)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v39 = 2112;
        v40 = v14;
        _os_log_debug_impl(&dword_230455000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] Failed to look up record %@ - %@%@", buf, 0x20u);
      }
...
LABEL_16:
    ...
    || (objc_msgSend((id)*v18, "share"), v19 = (void *)objc_claimAutoreleasedReturnValue(), v19, !v19))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: parent isn't a reference %@"), *v18);
    v29 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v30 = 2112;
      v31 = v7;
      _os_log_impl(&dword_230455000, v8, OS_LOG_TYPE_INFO, "[INFO] Locating recordID %@ in zone %@ --> Record not found. Error %@%@", buf, 0x2Au);
...
void __32__BRCLocateRecordOperation_main__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_230455000, v5, OS_LOG_TYPE_INFO, "[INFO] Locating recordID %@ in zone %@ --> Fetch parent chain failed with error %@%@", (uint8_t *)&v12, 0x2Au);
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  v13 = self;
  objc_sync_enter(v13);
  v13->_exists = objc_msgSend(v6, "isEqual:", MEMORY[0x24BDBD1C8]);
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Located record in shared zone. No need to fetch the parent chain.%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke_2_cold_3(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: parent isn't a reference %@%@", (uint8_t *)&v4, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke_2_cold_4()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Can't alloc ranks after fetching records%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __32__BRCLocateRecordOperation_main__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Record located. No need to fetch the parent chain.%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __32__BRCLocateRecordOperation_main__block_invoke_18_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: fetchParentChainOp%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
