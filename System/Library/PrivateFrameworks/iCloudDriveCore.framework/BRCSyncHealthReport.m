...
- (id)getRampNumberForSession:(id)a3
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%d"), v3);
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v29 = 2112;
      v30 = v19;
      _os_log_fault_impl(&dword_230455000, v20, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Failed to compute the pcs chain status and zone rowid for item row %lld - %@%@", buf, 0x20u);
      if (!v23)
      {
...
- (void)_collectAggregatedTelemetryForSession:(id)a3
{
  ...
  v5[4] = self;
  v3 = a3;
  +[BRCAnalyticsReporter _enumerateAggregatedTelemetryForSession:withBlock:](BRCAnalyticsReporter, "_enumerateAggregatedTelemetryForSession:withBlock:", v3, v5);
  objc_msgSend(v3, "clientDB");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v4, "execute:", CFSTR("DELETE FROM aggregated_daily_telemetry"));
}

uint64_t __61__BRCSyncHealthReport__collectAggregatedTelemetryForSession___block_invoke(uint64_t a1, uint64_t a2)
{
  return objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 64), "addObject:", a2);
}
...
- (void)generateReportWithSession:(id)a3
{
  ...
  v174[1] = 3221225472;
  v174[2] = __49__BRCSyncHealthReport_generateReportWithSession___block_invoke;
  v174[3] = &unk_24FE40C30;
  v174[4] = self;
  objc_msgSend(v4, "enumerateClientZones:", v174);
  ...
  v173[0] = v6;
  v173[1] = 3221225472;
  v173[2] = __49__BRCSyncHealthReport_generateReportWithSession___block_invoke_2;
  v173[3] = &unk_24FE40C58;
  v173[4] = self;
  objc_msgSend(v8, "enumerateKeysAndObjectsUsingBlock:", v173);
  ...
  v172[0] = v6;
  v172[1] = 3221225472;
  v172[2] = __49__BRCSyncHealthReport_generateReportWithSession___block_invoke_3;
  v172[3] = &unk_24FE40C58;
  v172[4] = self;
  objc_msgSend(v10, "enumerateKeysAndObjectsUsingBlock:", v172);
  ...
  {
    v159 = *MEMORY[0x24BDB8EC0];
    while (1)
    {
      v163 = (void *)MEMORY[0x2348B9F14]();
...
LABEL_32:
    ...
    if (objc_msgSend(v165, "length"))
      objc_msgSend(v161, "dateFromString:", v165);
    else
      objc_msgSend(MEMORY[0x24BDBCE60], "distantPast");
    ...
    switch((_DWORD)v18)
    {
      ...
      default:
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_WORD *)&v176[4] = 2112;
          *(_QWORD *)&v176[6] = v157;
          _os_log_fault_impl(&dword_230455000, v40, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: No service with code %d%@", buf, 0x12u);
        }
...
LABEL_31:
    v4 = v170;
    -[BRCSyncHealthReport _fillTransferFailure:withRowID:atDate:session:](self, "_fillTransferFailure:withRowID:atDate:session:", v28, v19, v162, v170);
...
LABEL_33:
  ...
  v41 = objc_msgSend(v160, "delayForStuckThrottle");
  v158 = brc_current_date_nsec();
  v42 = v158 - v41;
  objc_msgSend(v4, "clientDB");
  v43 = (void *)objc_claimAutoreleasedReturnValue();
  v166 = v42;
  v44 = (void *)objc_msgSend(v43, "fetch:", CFSTR("SELECT cd.throttle_id, cd.last_try_stamp FROM client_downloads AS cd INNER JOIN client_items AS li ON cd.throttle_id = li.rowid WHERE cd.last_try_stamp > 0 AND cd.last_try_stamp < %lld AND cd.retry_count = 0 AND cd.throttle_state = 1 AND cd.transfer_queue != '_done' AND li.item_state IN (0) AND li.item_localsyncupstate = 0"), v42);

  if (objc_msgSend(v44, "next"))
  {
    v45 = *MEMORY[0x24BE17300];
    do
    {
      v46 = (void *)MEMORY[0x2348B9F14]();
      v47 = objc_msgSend(v44, "longLongAtIndex:", 0);
      objc_msgSend(v44, "doubleAtIndex:", 1);
      objc_msgSend(MEMORY[0x24BDBCE60], "dateWithTimeIntervalSince1970:", v48 / 1000000000.0);
      v49 = (void *)objc_claimAutoreleasedReturnValue();
      v50 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1540]), "initWithDomain:code:userInfo:", v45, 47, 0);
      brc_bread_crumbs();
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&v176[8] = 2112;
        *(_QWORD *)&v176[10] = v51;
        _os_log_impl(&dword_230455000, v52, OS_LOG_TYPE_DEFAULT, "[WARNING] Item with row %llu has an item not scheduled for download%@", buf, 0x16u);
      }
      ...
      v58 = v47;
      v4 = v170;
      -[BRCSyncHealthReport _fillTransferFailure:withRowID:atDate:session:](self, "_fillTransferFailure:withRowID:atDate:session:", v57, v58, v49, v170);
  ...
  {
    v61 = *MEMORY[0x24BE17300];
    do
    {
      v62 = (void *)MEMORY[0x2348B9F14]();
      ...
      if (v64 <= 0xFFFFFFFA)
      {
        ...
        if (os_log_type_enabled(v70, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_WORD *)&v176[4] = 2112;
          *(_QWORD *)&v176[6] = v65;
          _os_log_fault_impl(&dword_230455000, v70, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Got unexpected item depth: %d%@", buf, 0x12u);
        }
      }
      else
      {
        v65 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1540]), "initWithDomain:code:userInfo:", v61, 74 - (v64 + 5), 0);
  ...
  objc_msgSend(v170, "clientDB");
  v71 = (void *)objc_claimAutoreleasedReturnValue();
  v72 = (void *)objc_msgSend(v71, "fetch:", CFSTR("SELECT cu.throttle_id, cu.last_try_stamp FROM client_uploads AS cu INNER JOIN client_items AS li ON cu.throttle_id = li.rowid WHERE cu.last_try_stamp > 0 AND cu.last_try_stamp < %lld AND cu.retry_count = 0 AND cu.throttle_state = 1 AND cu.transfer_queue != '_done' AND li.item_state IN (0) AND li.item_localsyncupstate = 3"), v166);

  if (objc_msgSend(v72, "next"))
  {
    v73 = *MEMORY[0x24BE17300];
    do
    {
      v74 = (void *)MEMORY[0x2348B9F14]();
      v75 = objc_msgSend(v72, "longLongAtIndex:", 0);
      objc_msgSend(v72, "doubleAtIndex:", 1);
      objc_msgSend(MEMORY[0x24BDBCE60], "dateWithTimeIntervalSince1970:", v76 / 1000000000.0);
      v77 = (void *)objc_claimAutoreleasedReturnValue();
      v78 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1540]), "initWithDomain:code:userInfo:", v73, 49, 0);
      brc_bread_crumbs();
      ...
      if (os_log_type_enabled(v80, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&v176[8] = 2112;
        *(_QWORD *)&v176[10] = v79;
        _os_log_impl(&dword_230455000, v80, OS_LOG_TYPE_DEFAULT, "[WARNING] Item with row %llu has an item not scheduled for upload%@", buf, 0x16u);
      }
      ...
      -[BRCSyncHealthReport _fillTransferFailure:withRowID:atDate:session:](self, "_fillTransferFailure:withRowID:atDate:session:", v85, v75, v77, v170);
  ...
  if (objc_msgSend(v88, "next"))
  {
    ...
    do
    {
      ...
      if (os_log_type_enabled(v93, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&v176[8] = 2112;
        *(_QWORD *)&v176[10] = v92;
        _os_log_impl(&dword_230455000, v93, OS_LOG_TYPE_DEFAULT, "[WARNING] Item with row %llu has an item not scheduled for sync up%@", buf, 0x16u);
      }

      objc_msgSend(v88, "numberAtIndex:", 2);
      v94 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v170, "serverZoneByRowID:", v94);
      ...
      if (objc_msgSend(v96, "isSyncBlocked"))
        ...
        v97 = 51;
      v98 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1540]), "initWithDomain:code:userInfo:", v167, v97, 0);
      if (objc_msgSend(v96, "isSyncBlockedBecauseAppNotInstalled"))
      {
        ...
        if (os_log_type_enabled(v100, (os_log_type_t)0x90u))
        {
          ...
          *(_WORD *)&v176[8] = 2112;
          *(_QWORD *)&v176[10] = v99;
          _os_log_error_impl(&dword_230455000, v100, (os_log_type_t)0x90u, "[ERROR] Zone %@ has items which need sync. Clearing app sync blocked%@", buf, 0x16u);
        }
      ...
      v106 = v89;
      v86 = v170;
      -[BRCSyncHealthReport _fillTransferFailure:withRowID:atDate:session:](self, "_fillTransferFailure:withRowID:atDate:session:", v105, v106, v91, v170);
  ...
  {
    v110 = *MEMORY[0x24BE17300];
    do
    {
      v111 = (void *)MEMORY[0x2348B9F14]();
      v112 = objc_msgSend(v108, "longLongAtIndex:", 0);
      v113 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1540]), "initWithDomain:code:userInfo:", v110, 52, 0);
      brc_bread_crumbs();
      ...
      if (os_log_type_enabled(v115, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&v176[8] = 2112;
        *(_QWORD *)&v176[10] = v114;
        _os_log_impl(&dword_230455000, v115, OS_LOG_TYPE_DEFAULT, "[WARNING] Item with row %llu has an item with a missing sync up throttle%@", buf, 0x16u);
      }

      objc_msgSend(MEMORY[0x24BDBCE60], "dateWithTimeIntervalSince1970:", v109 / 1000000000.0);
      ...
      -[BRCSyncHealthReport _fillTransferFailure:withRowID:atDate:session:](self, "_fillTransferFailure:withRowID:atDate:session:", v121, v112, v116, v170);
  ...
  v123 = (void *)objc_msgSend(v122, "fetch:", CFSTR("SELECT ci.rowid FROM client_items AS ci LEFT JOIN client_uploads AS cu ON ci.rowid = cu.throttle_id WHERE ci.item_localsyncupstate = 3 AND ci.item_type IN (1, 6) AND ci.item_state IN (0) AND IFNULL(cu.throttle_state, 0) = 0"));

  if (objc_msgSend(v123, "next"))
  {
    v124 = *MEMORY[0x24BE17300];
    do
    {
      v125 = (void *)MEMORY[0x2348B9F14]();
      v126 = objc_msgSend(v123, "longLongAtIndex:", 0);
      v127 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1540]), "initWithDomain:code:userInfo:", v124, 50, 0);
      brc_bread_crumbs();
      ...
      if (os_log_type_enabled(v129, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&v176[8] = 2112;
        *(_QWORD *)&v176[10] = v128;
        _os_log_impl(&dword_230455000, v129, OS_LOG_TYPE_DEFAULT, "[WARNING] Item with row %llu has an item with a missing upload throttle%@", buf, 0x16u);
      }
      ...
      -[BRCSyncHealthReport _fillTransferFailure:withRowID:atDate:session:](self, "_fillTransferFailure:withRowID:atDate:session:", v135, v126, v130, v170);
  ...
  v137 = (void *)objc_msgSend(v136, "numberWithSQL:", CFSTR("SELECT COUNT(*) FROM client_items WHERE item_type IN (9, 10)"));
  self->_clientTruthDirFaultCount = objc_msgSend(v137, "unsignedLongLongValue");

  objc_msgSend(v170, "clientDB");
  v138 = (void *)objc_claimAutoreleasedReturnValue();
  v139 = (void *)objc_msgSend(v138, "numberWithSQL:", CFSTR("SELECT COUNT(*) FROM server_items WHERE item_type IN (9, 10)"));
  self->_serverTruthDirFaultCount = objc_msgSend(v139, "unsignedLongLongValue");

  objc_msgSend(v170, "clientDB");
  v140 = (void *)objc_claimAutoreleasedReturnValue();
  v141 = (void *)objc_msgSend(v140, "numberWithSQL:", CFSTR("SELECT COUNT(*) FROM server_items WHERE item_type IN (0, 9, 10)"));
  self->_serverTruthDirCount = objc_msgSend(v141, "unsignedLongLongValue");

  v142 = time(0);
  objc_msgSend(v170, "clientDB");
  v143 = (void *)objc_claimAutoreleasedReturnValue();
  v144 = (void *)objc_msgSend(v143, "numberWithSQL:", CFSTR("SELECT MIN(date) FROM boot_history"));
  self->_timeSinceLogin = v142 - objc_msgSend(v144, "unsignedLongLongValue");

  self->_zonesNeverFullSync = 0;
  v171[0] = MEMORY[0x24BDAC760];
  v171[1] = 3221225472;
  v171[2] = __49__BRCSyncHealthReport_generateReportWithSession___block_invoke_424;
  v171[3] = &unk_24FE40C80;
  v171[4] = self;
  objc_msgSend(v170, "enumeratePrivateClientZones:", v171);
  objc_msgSend(v170, "clientDB");
  v145 = (void *)objc_claimAutoreleasedReturnValue();
  v146 = (void *)objc_msgSend(v145, "fetchWithSlowStatementRadar:objectOfClass:sql:", CFSTR("<rdar://problem/29182551>"), objc_opt_class(), CFSTR("SELECT COUNT(1) FROM client_items"));
  self->_clientTruthTotalItemsCount = objc_msgSend(v146, "unsignedLongLongValue");

  objc_msgSend(v170, "clientDB");
  v147 = (void *)objc_claimAutoreleasedReturnValue();
  v148 = (void *)objc_msgSend(v147, "fetchWithSlowStatementRadar:objectOfClass:sql:", CFSTR("<rdar://problem/29182551>"), objc_opt_class(), CFSTR("SELECT COUNT(1) FROM server_items"));
  self->_serverTruthTotalItemsCount = objc_msgSend(v148, "unsignedLongLongValue");

  -[BRCSyncHealthReport _collectAggregatedTelemetryForSession:](self, "_collectAggregatedTelemetryForSession:", v170);
  brc_bread_crumbs();
  ...
  objc_msgSend(v170, "accountDSID");
  v151 = (BRDSIDString *)objc_claimAutoreleasedReturnValue();
  dsid = self->_dsid;
  self->_dsid = v151;

  -[BRCSyncHealthReport getRampNumberForSession:](self, "getRampNumberForSession:", v170);
  v153 = (NSString *)objc_claimAutoreleasedReturnValue();
  rampNumber = self->_rampNumber;
  self->_rampNumber = v153;
...
uint64_t __49__BRCSyncHealthReport_generateReportWithSession___block_invoke_424(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  char v5;
...
- (void)dumpAggregatedEvents:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("none"));
...
- (void)syncErrors:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("uploadError: none"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v4[2](v4, v5);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("uploadError: %@"), *(_QWORD *)(*((_QWORD *)&v119 + 1) + 8 * i));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("syncUpError: none"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v4[2](v4, v12);
  ...
  if (v14)
  {
    ...
    do
    {
      for (j = 0; j != v15; ++j)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("syncUpError: %@"), *(_QWORD *)(*((_QWORD *)&v115 + 1) + 8 * j));
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v4[2](v4, v18);
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("downloadError: none"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v4[2](v4, v19);
  ...
  if (v21)
  {
    ...
    do
    {
      for (k = 0; k != v22; ++k)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("downloadError: %@"), *(_QWORD *)(*((_QWORD *)&v111 + 1) + 8 * k));
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        v4[2](v4, v25);
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("syncUpSharedZoneError: none"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("syncUpPrivateZoneError: none"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("syncDownSharedZoneError: none"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("syncDownPrivateZoneError: none"));
...
- (void)_injectionForAnalyticsServiceCode:(os_log_t)log .cold.1(uint64_t a1, int a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: No service with code %d%@", (uint8_t *)v3, 0x12u);
  OUTLINED_FUNCTION_0();
}
...
- (void)generateReportWithSession:.cold.1()
{
  ...
  v18 = v1;
  v19 = v6;
  _os_log_debug_impl(&dword_230455000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] Generated sync health report with upload failures:%@\ndownload failures:%@\nsync up failures:%@\nzone sync up errors:%@\nzone sync down errors:%@\naggregated events:%@%@", v8, 0x48u);
}
...
- (void)generateReportWithSession:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _totalZoneCount == 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
