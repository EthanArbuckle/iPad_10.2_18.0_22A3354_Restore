...
- (BOOL)_setupTimerRequiredForDeadline:(int64_t)a3 now:(int64_t)a4
{
  ...
  if ((v8 & 1) == 0)
  {
    ...
    {
      v16 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)self->_workloop);
      v17 = self->_delay;
      self->_delay = v16;
      ...
      {
        ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v24);
...
- (void)dealloc
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ was deallocated without being closed%@", (uint8_t *)&v3, 0x16u);
}
