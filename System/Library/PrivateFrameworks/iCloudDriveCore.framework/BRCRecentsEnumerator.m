...
+ (void)dropLegacyCoreSpotlightIndexIfNeededWithCompletionHandler:(id)a3
{
  ...
  if ((objc_msgSend(MEMORY[0x24BDC2470], "isIndexingAvailable") & 1) == 0)
  {
    brc_bread_crumbs();
  ...
  AppBooleanValue = CFPreferencesGetAppBooleanValue(CFSTR("didDropCoreSpotlightIndex"), (CFStringRef)*MEMORY[0x24BE17368], &keyExistsAndHasValidFormat);
...
LABEL_8:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v17 = v7;
    _os_log_impl(&dword_230455000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] dropping CoreSpotlight index%@", buf, 0xCu);
  }

  v9 = objc_alloc(MEMORY[0x24BDC2470]);
  v10 = (void *)objc_msgSend(v9, "initWithName:protectionClass:", CFSTR("com.apple.clouddocs-items"), *MEMORY[0x24BDD0CE0]);
  if (!v10)
  {
    brc_bread_crumbs();
...
LABEL_4:
  ...
  v8 = (CFStringRef *)MEMORY[0x24BE17368];
  CFPreferencesSetAppValue(CFSTR("didDropCoreSpotlightIndex"), MEMORY[0x24BDBD1C8], (CFStringRef)*MEMORY[0x24BE17368]);
...
- (void)_readyForIndexingWithAckedRank:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 2112;
    v15 = v5;
    _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] Learning index acked rank %llu (flushed rank %llu)%@", (uint8_t *)&v10, 0x20u);
  }
...
- (id)changeTokenForNotifRank:(unint64_t)a3
{
  ...
  -[BRCRecentsChangeToken setDatabaseID:](v5, "setDatabaseID:", -[BRCAccountSessionFPFS databaseIDHash](self->_session, "databaseIDHash"));
...
- (void)_handleResetForRowID:(int64_t)a3 notifRank:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v46 = 2112;
    v47 = v9;
    _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] handling reset for rowID %lld, notif rank: %llu%@", buf, 0x20u);
  }
  ...
  if (objc_msgSend(v15, "isPrivateZone"))
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v44 = 2112;
      v45 = (unint64_t)v26;
      _os_log_impl(&dword_230455000, v27, OS_LOG_TYPE_DEFAULT, "[WARNING] Dropping spotlight index for %@ due to a reset%@", buf, 0x16u);
    }
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v43 = (int64_t)v29;
    _os_log_impl(&dword_230455000, v30, OS_LOG_TYPE_DEFAULT, "[WARNING] reset zone is not a private zone, skipping%@", buf, 0xCu);
  }
...
void __73__BRCRecentsEnumerator__handleResetForRowID_notifRank_completionHandler___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, (os_log_type_t)0x90u))
  {
    ...
    v12 = 2112;
    v13 = v2;
    _os_log_error_impl(&dword_230455000, v3, (os_log_type_t)0x90u, "[ERROR] Failed to delete searchable items for mangledIDs %@: %@%@", (uint8_t *)&v8, 0x20u);
  }
...
- (void)maxNotifRankWasFlushed
{
  ...
  v8[4] = self;
  v8[5] = v5;
  brc_task_tracker_async_with_logs(tracker, queue, v8, &__block_literal_global_43);
}
...
- (void)_enumerateChangesFromChangeToken:(id)a3 limit:(unint64_t)a4 completion:(id)a5
{
  ...
  if (v8)
  {
    ...
    if (v9 != -[BRCAccountSessionFPFS databaseIDHash](self->_session, "databaseIDHash"))
    {
      brc_bread_crumbs();
    ...
    if (v11 > self->_flushedNotifRank)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 134218498;
        ...
        v98 = 2112;
        v99 = v13;
        _os_log_debug_impl(&dword_230455000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] incoming rank is newer than what we know about: %lld > %lld, stopping here%@", buf, 0x20u);
      }
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v98 = 2112;
    v99 = v16;
    _os_log_debug_impl(&dword_230455000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] enumerating changes from notif rank %llu (max %llu)%@", buf, 0x20u);
  }
  v59 = v11;

  v78[0] = MEMORY[0x24BDAC760];
  v78[1] = 3221225472;
  v78[2] = __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_69;
  v78[3] = &unk_24FE469F8;
  v78[4] = &v89;
  v78[5] = &v85;
  v78[6] = &v81;
  v18 = (uint64_t (**)(_QWORD, _QWORD))MEMORY[0x2348BA0DC](v78);
  -[BRCAccountSessionFPFS itemsNeedingIndexingEnumeratorFromNotifRank:batchSize:db:](self->_session, "itemsNeedingIndexingEnumeratorFromNotifRank:batchSize:db:", v59, a4, self->_indexingDB);
  ...
  block[0] = MEMORY[0x24BDAC760];
  block[1] = 3221225472;
  block[2] = __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_76;
  block[3] = &unk_24FE41740;
  block[4] = self;
  block[5] = v59;
  ...
  if (v82[3] == v59 && *((_BYTE *)v86 + 24) == 2)
  {
    ...
    v75[1] = 3221225472;
    v75[2] = __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_2_77;
    v75[3] = &unk_24FE46A20;
    v76 = v61;
  ...
  context = (void *)MEMORY[0x2348B9F14](v21);
  ...
  -[BRCRecentsChangeToken setDatabaseID:](v57, "setDatabaseID:", -[BRCAccountSessionFPFS databaseIDHash](self->_session, "databaseIDHash"));
  v73 = 0u;
  v74 = 0u;
  v71 = 0u;
  v72 = 0u;
      ...
      if (v31 == 2)
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = v54;
          ...
          v96 = 2112;
          v97 = (unint64_t)v35;
          _os_log_debug_impl(&dword_230455000, v36, OS_LOG_TYPE_DEBUG, "[DEBUG] found a tombstone entry of type client zone db rowid (%lld), sending current batch%@", buf, 0x16u);
        }
          ...
          if (v82[3] <= *p_flushedNotifRank)
          {
            ...
            if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 134218242;
              ...
              v96 = 2112;
              v97 = (unint64_t)v41;
              _os_log_debug_impl(&dword_230455000, v42, OS_LOG_TYPE_DEBUG, "[DEBUG] found a tombstone entry of type client zone db rowid (%lld), sending current batch%@", buf, 0x16u);
            }
...
LABEL_56:
  ...
  v65[1] = 3221225472;
  v65[2] = __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_80;
  v65[3] = &unk_24FE46A70;
  v70 = v59;
  v50 = v23;
  v66 = v50;
...
void __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_69(_QWORD *a1, void *a2)
{
  uint64_t v3;
  id v4;
...
id __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_2(uint64_t a1, uint64_t a2, int a3)
{
  ...
  {
    case 0:
      v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17638]), "initWithFileID:", a2);
      return v5;
    case 1:
      v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17620]), "initWithDocID:", a2);
      return v5;
    case 3:
    ...
    case 5:
      ...
      v10 = 3;
LABEL_10:
      v5 = (void *)objc_msgSend(v8, "initWithRowID:type:", v9, v10);
      break;
    default:
      brc_bread_crumbs();
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
uint64_t __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_76(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "garbageCollectRanksPreceding:", *(_QWORD *)(a1 + 40));
}

uint64_t __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_2_77(uint64_t a1, uint64_t a2, uint64_t a3)
{
  uint64_t result;
...
void __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_80(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  void *v7;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    v38 = 2112;
    v39 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] sending batch from %llu to %llu\n updatedItems = %@\n deletedItems = %@%@", buf, 0x34u);
  }
  ...
  v25[1] = 3221225472;
  v25[2] = __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_81;
  v25[3] = &unk_24FE46A48;
  v25[4] = v9;
  v26 = v10;
  v29 = *(id *)(a1 + 56);
  ...
  v20[0] = v12;
  v20[1] = 3221225472;
  v20[2] = __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_2_82;
  v20[3] = &unk_24FE46A48;
  v14 = *(void **)(a1 + 48);
  v20[4] = *(_QWORD *)(a1 + 40);
  v21 = v14;
...
void __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_81(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  uint64_t v4;
...
void __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_2_82(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  uint64_t v4;
...
- (void)_activeSetDidChange
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] active set did change, notifying fileproviderd%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (BRCRecentsEnumerator)initWithAccountSession:(id)a3
{
  ...
  if (v6)
  {
    ...
    -[BRCAccountSessionFPFS readOnlyWorkloop](v7->_session, "readOnlyWorkloop");
    v10 = objc_claimAutoreleasedReturnValue();
...
- (void)cancel
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Canceling spotlight indexer.%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)itemWasDeletedWithFileObjectID:(id)a3 notifRank:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    v16 = 2112;
    v17 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] dropping item which was deleted %@ with notif rank %llu%@", buf, 0x20u);
  }

  v10 = -[BRCRecentsEnumerator computeTombstoneEntryType:](self, "computeTombstoneEntryType:", v6);
  -[BRCAccountSessionFPFS clientDB](self->_session, "clientDB");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "execute:", CFSTR("INSERT INTO tombstones (file_object_id, file_object_id_type, notif_rank) VALUES (%lld, %d, %lld)"), objc_msgSend(v6, "rawID"), v10, a4);
...
- (BOOL)hasDeletedFileObjectID:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v4, "rawID");

  v7 = (void *)objc_msgSend(v5, "numberWithSQL:", CFSTR("SELECT 1 FROM tombstones WHERE file_object_id = %lld LIMIT 1"), v6);
...
+ (void)dropLegacyCoreSpotlightIndexIfNeededWithCompletionHandler:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] CoreSpotlight index has already been dropped%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
+ (void)dropLegacyCoreSpotlightIndexIfNeededWithCompletionHandler:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: index%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
+ (void)dropLegacyCoreSpotlightIndexIfNeededWithCompletionHandler:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] device does not support CoreSpotlight indexing, no need to drop any index%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __82__BRCRecentsEnumerator_dropLegacyCoreSpotlightIndexIfNeededWithCompletionHandler___block_invoke_cold_1(uint64_t a1, NSObject *a2, uint64_t a3)
{
  ...
  v3 = *MEMORY[0x24BE17368];
  v4 = 138412546;
  v5 = v3;
  v6 = 2112;
  v7 = a1;
  OUTLINED_FUNCTION_8_0(&dword_230455000, a2, a3, "[ERROR] failed to synchronize user defaults for %@%@", (uint8_t *)&v4);
  OUTLINED_FUNCTION_0();
}
...
void __82__BRCRecentsEnumerator_dropLegacyCoreSpotlightIndexIfNeededWithCompletionHandler___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] dropped Spotlight index successfully%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __82__BRCRecentsEnumerator_dropLegacyCoreSpotlightIndexIfNeededWithCompletionHandler___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_8_0(&dword_230455000, v0, (uint64_t)v0, "[ERROR] failed dropping Spotlight index: %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)_readyForIndexingWithAckedRank:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Finished indexing for now%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_enumerateChangesFromChangeToken:limit:completion:.cold.1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_4();
  _os_log_error_impl(&dword_230455000, v0, (os_log_type_t)0x90u, "[ERROR] change token has expired, index should be dropped%@", v1, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCRecentsEnumerator__enumerateChangesFromChangeToken_limit_completion___block_invoke_2_cold_1(uint64_t a1, int a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: bad tombstone entry type: %d%@", (uint8_t *)v3, 0x12u);
  OUTLINED_FUNCTION_0();
}
...
void __43__BRCRecentsEnumerator__activeSetDidChange__block_invoke_cold_1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_8_0(&dword_230455000, v0, (uint64_t)v0, "[ERROR] failed to signal enumerator for working set: %@%@", v1);
  OUTLINED_FUNCTION_0();
}
