...
- (BRCClientPrivilegesDescriptor)initWithAuditToken:(id *)a3
{
  ...
  if (v4)
  {
    ...
    *((_QWORD *)v5 + 4) = v8;
    ...
    v5[24] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE173C8], v14, v15);
    v5[25] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE173D0]);
    if (v5[18])
    {
      v5[17] = 1;
...
LABEL_10:
    ...
    v5[17] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE172E8]);
    if (v5[24])
    {
      v5[20] = 1;
    }
    ...
    {
      v10 = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE17330]);
      v5[20] = v10;
      if (!v10)
      {
        v5[21] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE17400]);
        v5[23] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE173F8]);
        v11 = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE173D8]);
        goto LABEL_9;
      }
    }
    v11 = 1;
...
LABEL_9:
    v5[22] = v11;
    v5[27] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x24BE17410]);
    goto LABEL_10;
  }
  return (BRCClientPrivilegesDescriptor *)v5;
}
  ...
  if ((objc_msgSend(v10, "_isNonSandboxedForAuditToken:", &v21) & 1) != 0)
  {
    ...
    if (v12)
    {
      ...
      *(_DWORD *)&v13->_isProxyEntitled = 16843009;
      objc_msgSend((id)*MEMORY[0x24BE173D0], "UTF8String");
      v15 = (void *)xpc_copy_entitlement_for_token();
      v16 = MEMORY[0x2348BA748]() == MEMORY[0x24BDACF80] && xpc_BOOL_get_value(v15);
      v13->_isBRCTL = v16;
...
- (void)pid
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: self.hasPid%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}

- (void)auditToken
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: _hasAuditToken%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
- (void)_computeCloudEnabledStatusWithoutLogOutStatus
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] %@ is restricted from sync (TCC)%@");
  OUTLINED_FUNCTION_0();
}
