...
- (BRCMigrationQueryOperation)initWithServerZone:(id)a3 migrationKey:(id)a4 continuationCursor:(id)a5 sessionContext:(id)a6
{
  ...
  if (v16)
  {
    ...
    objc_msgSend(MEMORY[0x24BDB9190], "br_osUpgradeMigration");
...
- (BOOL)_saveFetchedRecords:(id)a3 cursor:(id)a4 error:(id *)a5
{
  ...
  v41 = 0x2020000000;
  v42 = 0;
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEF0]), "initWithObjects:", self->super._serverZone, 0);
...
- (BOOL)_updatedContinuationCursor:(id)a3 fetchedRecords:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v41 = 2112;
    v42 = v13;
    _os_log_debug_impl(&dword_230455000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] share-query progressed from cursor:%@ to cursor:%@%@", buf, 0x20u);

  }
  if (-[NSMutableArray count](self->_shareIDsToFetch, "count"))
  {
    v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB90E8]), "initWithRecordIDs:", self->_shareIDsToFetch);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, (os_log_type_t)0x90u))
    {
      ...
      *(_QWORD *)&obj[4] = "-[BRCMigrationQueryOperation _updatedContinuationCursor:fetchedRecords:error:]_block_invoke_2";
      ...
      v26 = 2112;
      v27 = v9;
      _os_log_error_impl(&dword_230455000, v10, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", obj, 0x2Au);
    }
...
- (void)_performQuery:(id)a3 recordFetchedBlock:(id)a4 cursorUpdatedBlock:(id)a5 desiredKeys:(id)a6 completion:(id)a7
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)((char *)v50 + 6) = v17;
    _os_log_debug_impl(&dword_230455000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx query for %@ starting with batchSize:%u%@", buf, 0x26u);

  }
  if (self->_continuationCursor)
  {
    v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91C8]), "initWithCursor:", self->_continuationCursor);
    brc_bread_crumbs();
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v49 = 2112;
      v50[0] = v20;
      _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] created query %@ from cursor:%@%@", buf, 0x20u);

    }
  }
  else
  {
    v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91C8]), "initWithQuery:", v35);
    brc_bread_crumbs();
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    brc_default_log();
    v21 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v49 = 2112;
      v50[0] = v20;
      _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] created query %@ from query:%@%@", buf, 0x20u);
...
void __105__BRCMigrationQueryOperation__performQuery_recordFetchedBlock_cursorUpdatedBlock_desiredKeys_completion___block_invoke_2(_QWORD *a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v19 = 2112;
    v20 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx handling result of %@: %@%@", buf, 0x2Au);
  }
...
- (void)_performAfterQueryingForShareAliasesWithCompletion:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("%K == %@"), CFSTR("brPrefix"), CFSTR("shareAlias/"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91B8]), "initWithRecordType:predicate:", CFSTR("RecordPrefixList"), v5);
  v25[0] = 0;
  v25[1] = v25;
  v25[2] = 0x3032000000;
  v25[3] = __Block_byref_object_copy__30;
  v25[4] = __Block_byref_object_dispose__30;
  v26 = 0;
  ...
  v9 = v7;
  v24 = v9;
  v10 = (void *)MEMORY[0x2348BA0DC](v23);
  v20[0] = v8;
  v20[1] = 3221225472;
  ...
  v21 = v11;
  v22 = v25;
  v12 = (void *)MEMORY[0x2348BA0DC](v20);
...
void __81__BRCMigrationQueryOperation__performAfterQueryingForShareAliasesWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] fetched share alias record %@ with etag:%@ in query %@%@", (uint8_t *)&v12, 0x2Au);
...
- (void)_performAfterQueryingForShareIDsOfFolders:(BOOL)a3 completion:(id)a4
{
  ...
  v4 = a3;
  v6 = a4;
  objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("%K != NULL"), *MEMORY[0x24BDB8F20]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_alloc(MEMORY[0x24BDB91B8]);
  ...
  v13 = v11;
  v27 = v13;
  v14 = (void *)MEMORY[0x2348BA0DC](v26);
  v23[0] = v12;
  v23[1] = 3221225472;
  ...
  v24 = v15;
  v25 = v28;
  v16 = (void *)MEMORY[0x2348BA0DC](v23);
  v19[0] = v12;
  v19[1] = 3221225472;
  ...
  v18 = v6;
  v21 = v18;
  -[BRCMigrationQueryOperation _performQuery:recordFetchedBlock:cursorUpdatedBlock:desiredKeys:completion:](self, "_performQuery:recordFetchedBlock:cursorUpdatedBlock:desiredKeys:completion:", v10, v14, v16, MEMORY[0x24BDBD1A8], v19);
...
void __83__BRCMigrationQueryOperation__performAfterQueryingForShareIDsOfFolders_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v26 = 2112;
      v27 = v10;
      _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] fetched shared record %@ with etag:%@ in query %@%@", (uint8_t *)&v20, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
    {
      ...
      v24 = 2112;
      v25 = v14;
      _os_log_fault_impl(&dword_230455000, v15, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unable to parse itemID from %@ in query %@%@", (uint8_t *)&v20, 0x20u);
...
- (void)main
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(_QWORD *)(buf + 14) = a2;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unknown migration %s%@", buf, 0x16u);
}
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v25 = 2112;
    v26 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx migration-query '%@' %@ completed%@", buf, 0x2Au);
