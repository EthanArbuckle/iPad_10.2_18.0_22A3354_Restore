    ...
    if (!v10->_destinationDirectory)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 138412290;
        v18 = v13;
        _os_log_impl(&dword_230455000, v14, OS_LOG_TYPE_INFO, "[INFO] ~/Library/Application Support/CloudDocs/session does not exist. No need to back up.%@", buf, 0xCu);
      }
...
LABEL_20:
          _os_log_error_impl(&dword_230455000, v14, (os_log_type_t)0x90u, v17, buf, 0x20u);
    ...
    if ((v20 & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v43 = 2112;
        v44 = v29;
        _os_log_impl(&dword_230455000, v30, OS_LOG_TYPE_DEFAULT, "[NOTICE] Calling completion block with URL: %@, error: %@%@", buf, 0x20u);
...
- (NSArray)urlPropertiesToFetch
{
  ...
  v2 = *MEMORY[0x24BDBD210];
  v5[0] = *MEMORY[0x24BDBCBD0];
  v5[1] = v2;
  v3 = *MEMORY[0x24BDBCC50];
  v5[2] = *MEMORY[0x24BDBCBF8];
  v5[3] = v3;
  v5[4] = *MEMORY[0x24BDBCC60];
...
LABEL_25:
  ...
  if ((v16 & 1) != 0)
  {
    ...
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v53 = (void *)v18;
    objc_msgSend(v19, "enumeratorAtURL:includingPropertiesForKeys:options:errorHandler:", v10, v18, 2, &__block_literal_global_18);
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v68 = 2112;
      v69 = v21;
      _os_log_impl(&dword_230455000, v22, OS_LOG_TYPE_INFO, "[INFO] Enumarating URL: %@%@", buf, 0x16u);
    }
    v41 = v16;
    v42 = v11;
    v43 = v10;
    ...
    {
      v52 = *(_QWORD *)v60;
      v48 = *MEMORY[0x24BDBD210];
      v47 = *MEMORY[0x24BDBCBF8];
      v46 = *MEMORY[0x24BDBCC50];
      v45 = *MEMORY[0x24BDBCC60];
      do
      {
        for (i = 0; i != v54; ++i)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v30, (os_log_type_t)0x90u))
            {
              *(_DWORD *)buf = 138412802;
              ...
              v70 = 2112;
              v71 = v29;
              _os_log_error_impl(&dword_230455000, v30, (os_log_type_t)0x90u, "[ERROR] Failed to fetch resource values for %@. Error: %@%@", buf, 0x20u);
            }
          }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v40, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v70 = 2112;
      v71 = v39;
      _os_log_error_impl(&dword_230455000, v40, (os_log_type_t)0x90u, "[ERROR] Could not get the canonical path for the root URL %@. Error: %@%@", buf, 0x20u);
    }
...
uint64_t __66__BRCDatabaseBackupManager_enumerateURL_rootURL_usingBlock_error___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v7, (os_log_type_t)0x90u))
  {
    ...
    v13 = 2112;
    v14 = v6;
    _os_log_error_impl(&dword_230455000, v7, (os_log_type_t)0x90u, "[ERROR] Enumeration error: %@. Error: %@%@", (uint8_t *)&v9, 0x20u);
  }
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v15 = 2112;
      v16 = v7;
      _os_log_error_impl(&dword_230455000, v8, (os_log_type_t)0x90u, "[ERROR] Failed to remove directory %@: %@%@", buf, 0x20u);
...
void __54__BRCDatabaseBackupManager_backUpWithCompletionBlock___block_invoke_cold_1()
{
  ...
  v3 = v0;
  _os_log_debug_impl(&dword_230455000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] %@%@", v2, 0x16u);
}
...
- (void)enumerateURL:(uint64_t)a1 rootURL:(NSObject *)a2 usingBlock:error:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_230455000, a2, (os_log_type_t)0x90u, "[ERROR] rootURL is nil, nothing to enumerate.%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)enumerateURL:(NSObject *)a3 rootURL:usingBlock:error:.cold.2(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  OUTLINED_FUNCTION_0_2();
  v7 = a2;
  _os_log_error_impl(&dword_230455000, a3, (os_log_type_t)0x90u, "[ERROR] %@ does not exist, nothing to enumerate.%@", v6, 0x16u);
