...
- (_BRCDownloadInfo)init
{
  ...
  if (v2)
  {
    ...
    objc_msgSend(v4, "setUserInfoObject:forKey:", *MEMORY[0x24BDD1188], *MEMORY[0x24BDD1190]);
...
- (void)updateLocalizedDescriptionWithOptions:(char)a3
{
  ...
  v5 = CFSTR("GLOBAL_PROGRESS_DOWNLOADS_WAITING_DESCRIPTION");
  if ((a3 & 4) == 0)
    v5 = CFSTR("GLOBAL_PROGRESS_DOWNLOADING_CAPITALIZE_DESCRIPTION");
  ...
  objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x24BDD11A0]);
  ...
  if ((a3 & 2) != 0)
  {
    ...
    objc_msgSend(v14, "completedUnitCount");

    -[_BRCTransferInfo progress](self, "progress");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "totalUnitCount");
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_resumeUnitCounts, 0);
}
