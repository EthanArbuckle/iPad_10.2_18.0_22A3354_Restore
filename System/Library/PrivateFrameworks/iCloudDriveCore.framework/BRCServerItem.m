...
- (BRCServerItem)initWithServerItem:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6->_session = (BRCAccountSessionFPFS *)*((_QWORD *)v4 + 1);
...
- (id)initFromPQLResultSet:(id)a3 serverZone:(id)a4 error:(id *)a5
{
  ...
  v9 = -[BRCServerItem init](&v41, sel_init);
  if (v9)
  {
    v9->_session = (BRCAccountSessionFPFS *)(id)objc_msgSend(v8, "session");
    objc_msgSend(v7, "db");
      ...
      && -[BRCStatInfo state](v9->_st, "state") != 1)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT))
        -[BRCServerItem initFromPQLResultSet:serverZone:error:].cold.1((uint64_t)v33, v34, v35, v36, v37, v38, v39, v40);
    ...
    v28 = -[BRCBasehashSaltInfo initFromResultSet:pos:]([BRCBasehashSaltInfo alloc], "initFromResultSet:pos:", v7, 36);
    basehashSaltInfo = v9->_basehashSaltInfo;
    v9->_basehashSaltInfo = v28;

    v30 = objc_msgSend(objc_alloc(MEMORY[0x24BE17698]), "initFromResultSet:pos:", v7, 39);
...
- (id)descriptionWithContext:(id)a3
{
  ...
  if (v8 <= 3)
    objc_msgSend(v5, "appendString:", off_24FE45CB8[v8]);
...
- (id)appLibraryForRootItem
{
    ...
    || objc_msgSend((id)*p_itemID, "isDocumentsFolder"))
  {
    ...
    -[BRCAccountSessionFPFS appLibraryByRowID:](session, "appLibraryByRowID:", v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (id)aliasTargetAppLibrary
{
  ...
  -[BRCStatInfo _aliasTargetMangledID](self->_st, "_aliasTargetMangledID");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[BRCAccountSessionFPFS appLibraryByMangledID:](session, "appLibraryByMangledID:", v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)overrideCKInfoIfNecessaryForOutOfBandSyncOpWithLocalItem:(id)a3
{
  ...
  if ((objc_msgSend(v4, "localDiffs") & 0x1000000000000000) != 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v22 = 2112;
      v23 = v5;
      _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ has an out of band sync ack -- using client truth ckinfo %@ rather than server info %@%@", (uint8_t *)&v16, 0x2Au);
...
- (id)predictedAppLibrary
{
  ...
  -[BRCServerItem parentLocalItemOnFS](self, "parentLocalItemOnFS");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      v14 = 138412290;
      v15 = v8;
      _os_log_impl(&dword_230455000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't figure out the expected app library; falling back to clouddocs%@",
        (uint8_t *)&v14,
        0xCu);
    }
...
- (void)asSharedItem
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] UNREACHABLE: Called -asSharedItem on a private item%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: !_serverZone.isSharedZone || (_sharingOptions & BRCSharingItemHasCKShareMask) != 0 || _st.state == BRC_ITEM_STATE_TOMBSTONE%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}

- (void)appLibraryForRootItem
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: self.isFSRoot%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
- (void)newLocalItemWithDBRowID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_10_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: unknown item type: %d%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)newLocalItemWithDBRowID:.cold.2()
{
  ...
  OUTLINED_FUNCTION_11_2();
  OUTLINED_FUNCTION_10_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: unsupporter server item type: %d%@");
  OUTLINED_FUNCTION_0();
}
