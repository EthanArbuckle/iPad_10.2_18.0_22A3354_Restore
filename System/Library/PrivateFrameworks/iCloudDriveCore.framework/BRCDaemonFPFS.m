...
id __34__BRCDaemonFPFS__setupCacheDelete__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    v29 = 2112;
    v30 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cache delete requested us to compute purgeable space: (urgency: %d) %@%@", buf, 0x26u);
  }
  ...
  objc_msgSend(v10, "setObject:forKeyedSubscript:", &unk_24FEB32A8, CFSTR("CACHE_DELETE_AMOUNT"));
  objc_msgSend(v10, "setObject:forKeyedSubscript:", &unk_24FEB32A8, CFSTR("CACHE_DELETE_NONPURGEABLE_AMOUNT"));
  v11 = *(void **)(a1 + 32);
  v18[0] = MEMORY[0x24BDAC760];
  v18[1] = 3221225472;
  v18[2] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_31;
  v18[3] = &unk_24FE422F0;
  v21 = v9;
  v12 = v10;
  v19 = v12;
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  __brc_create_section(0, (uint64_t)"-[BRCDaemonFPFS listener:shouldAcceptNewConnection:]", 961, v41);
  brc_bread_crumbs();
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v48 = 2112;
    v49 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx received new XPC connection: %@, for uid: %u%@", buf, 0x26u);
  }

  if (!self->_shouldRejectXPCCalls)
  {
    dispatch_sync((dispatch_queue_t)self->_xpcListenersReadyQueue, &__block_literal_global_101);
    +[BRCFileProviderDaemonUtils sharedInstance](BRCFileProviderDaemonUtils, "sharedInstance");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "boostFileProvider");

    dispatch_sync((dispatch_queue_t)self->_accountReadyQueue, &__block_literal_global_103);
      ...
      if (!v19)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412290;
          ...
          _os_log_impl(&dword_230455000, v20, OS_LOG_TYPE_DEFAULT, "[WARNING] Denying xpc connection because the daemon is in the sync bubble%@", buf, 0xCu);
        }
        v13 = 0;
LABEL_25:
    ...
    {
      -[BRCDaemonFPFS waitOnAccountResumedQueue](self, "waitOnAccountResumedQueue");
    ...
    -[BRCDaemonFPFS getCurrentSessionMustFinishedLoading:](self, "getCurrentSessionMustFinishedLoading:", 1);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
      -[BRCDaemonFPFS listener:shouldAcceptNewConnection:].cold.1();

    objc_msgSend(v7, "setExportedObject:", v21);
    v26 = MEMORY[0x24BDAC760];
    v37[0] = MEMORY[0x24BDAC760];
    v37[1] = 3221225472;
    v37[2] = __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_107;
    v37[3] = &unk_24FE42540;
    v39 = v7;
    v27 = v21;
    ...
    v31 = v26;
    v32 = 3221225472;
    v33 = __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_2_112;
    v34 = &unk_24FE42568;
    v11 = v27;
    v35 = v11;
    v36 = v7;
...
LABEL_6:
    _os_log_impl(&dword_230455000, v11, OS_LOG_TYPE_DEFAULT, v12, buf, 0xCu);
  }
LABEL_7:
  v13 = 0;
LABEL_26:
...
- (id)getCurrentSessionMustFinishedLoading:(BOOL)a3
{
  ...
  v3 = a3;
  -[BRCDaemonFPFS currentAccountHandler](self, "currentAccountHandler");
...
{
  dispatch_sync((dispatch_queue_t)self->_accountResumedQueue, &__block_literal_global_100);
}
...
- (void)performWithSessionForVolume:(id)a3 action:(id)a4
{
  ...
  if (lstat((const char *)objc_msgSend(v7, "fileSystemRepresentation"), &v14) < 0)
  {
    ...
    if (os_log_type_enabled(v10, (os_log_type_t)0x90u))
      -[BRCDaemonFPFS performWithSessionForVolume:action:].cold.1((uint64_t)v7, (uint64_t)v9, v10);
...
- (void)_initSignals
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] We are running under bundle %@, not initializing signals because this is not bird daemon%@");
  OUTLINED_FUNCTION_0();
}
...
- (BOOL)shouldRejectXPCCalls
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      v6 = 138412290;
      v7 = v3;
      _os_log_impl(&dword_230455000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] We are running as Root user. We should reject all XPC connections%@", (uint8_t *)&v6, 0xCu);
    }
...
- (BRCDaemonFPFS)init
{
  ...
  v2 = -[BRCDaemonFPFS init](&v25, sel_init);
  v3 = v2;
  if (v2)
  {
    -[BRCDaemonFPFS _initSignals](v2, "_initSignals");
    -[BRCDaemonFPFS _setupVNodeRapidAging](v3, "_setupVNodeRapidAging");
    ...
    v3->_shouldRejectXPCCalls = -[BRCDaemonFPFS shouldRejectXPCCalls](v3, "shouldRejectXPCCalls");
  }
  return v3;
}
...
- (void)setUpSandbox
{
  ...
  if (!self->_shouldRejectXPCCalls)
  {
    ...
    if (v3)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("com.apple.bird.%u"), getuid());
...
- (id)currentSession
{
  return -[BRCDaemonFPFS getCurrentSessionMustFinishedLoading:](self, "getCurrentSessionMustFinishedLoading:", 0);
}
...
- (void)_setupCacheDelete
{
  ...
  if (!self->_shouldRejectXPCCalls)
  {
    ...
    v10[9] = self;
    v10[10] = MEMORY[0x24BDAC760];
    v10[11] = 3221225472;
    v10[12] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke;
    v10[13] = &unk_24FE42318;
    v10[14] = self;
    v10[5] = MEMORY[0x24BDAC760];
    v10[6] = 3221225472;
    v10[7] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_36;
    v10[8] = &unk_24FE42318;
    ...
    v10[0] = v3;
    v10[1] = 3221225472;
    v10[2] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_46;
    v10[3] = &unk_24FE42468;
    v10[4] = self;
    v6 = v5;
    v7 = v10;
    ...
    {
      ((void (*)(_QWORD *))*MEMORY[0x24BE17830])(v7);
      v9 = objc_claimAutoreleasedReturnValue();
...
void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_31(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  uint64_t v5;
  ...
  v8 = objc_msgSend(v7, "cachedNonPurgeableSpace");
...
id __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_36(uint64_t a1, int a2, void *a3)
{
  id v5;
  void *v6;
  void *v7;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    v30 = 2112;
    v31 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cache delete requested us to purge: (urgency: %d) %@%@", buf, 0x26u);
  }
  ...
  v18[0] = MEMORY[0x24BDAC760];
  v18[1] = 3221225472;
  v18[2] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_37;
  v18[3] = &unk_24FE42368;
  v22 = a2;
  v11 = v6;
  v19 = v11;
  ...
  v13 = v9;
  v21 = v13;
  objc_msgSend(v10, "performWithSessionForVolume:action:", v11, v18);
  brc_bread_crumbs();
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  brc_default_log();
  v15 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_36_cold_1();
...
void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_37(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  NSObject *v5;
  ...
  {
    v7 = *(_QWORD *)(a1 + 32);
    objc_msgSend(v6, "resetQueue");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    +[BRCAnalyticsReporter cancelSyncConsistencyReportWithMountPath:queue:](BRCAnalyticsReporter, "cancelSyncConsistencyReportWithMountPath:queue:", v7, v8);
  ...
  v12 = objc_msgSend(v11, "purgeSpace:withUrgency:", v10, *((unsigned int *)v19 + 6));

  objc_msgSend(*(id *)(a1 + 48), "setObject:forKeyedSubscript:", *(_QWORD *)(a1 + 32), CFSTR("CACHE_DELETE_VOLUME"));
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 48), "setObject:forKeyedSubscript:", v13, CFSTR("CACHE_DELETE_AMOUNT"));
...
id __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_41(uint64_t a1, uint64_t a2, uint64_t a3)
{
  void *v4;
  NSObject *v5;
  id v6;
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v18 = 2112;
    v19 = v4;
    _os_log_debug_impl(&dword_230455000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cache delete requested us to periodically purge: %@%@", buf, 0x20u);
  }
  ...
  v11[0] = MEMORY[0x24BDAC760];
  v11[1] = 3221225472;
  v11[2] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_43;
  v11[3] = &unk_24FE423F0;
  v8 = v6;
  v12 = v8;
...
void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_43(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
  uint64_t v5;
...
void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_46(uint64_t a1, void *a2)
{
  _xpc_activity_s *v3;
  void *v4;
  NSObject *v5;
  ...
  if (xpc_activity_should_defer(v3))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v4;
      _os_log_impl(&dword_230455000, v5, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to defer the state%@", (uint8_t *)&buf, 0xCu);
    }
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_46_cold_1(v13);
  ...
  if (!xpc_activity_set_state(v3, 4))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v8;
      _os_log_impl(&dword_230455000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to set the xpc state to continue%@", (uint8_t *)&buf, 0xCu);
    }
  ...
  *((_QWORD *)&buf + 1) = &buf;
  ...
  v12[1] = 3221225472;
  v12[2] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_47;
  v12[3] = &unk_24FE42440;
  v12[4] = &buf;
...
void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_47(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
  void *v5;
  ...
  if (v3)
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48;
    v6[3] = &unk_24FE42418;
    v8 = *(_QWORD *)(a1 + 32);
    v7 = v4;
...
void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48(uint64_t a1, void *a2, void *a3, void *a4)
{
  id v7;
  id v8;
  id v9;
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
      __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48_cold_3();
  ...
  else
  {
    ...
    objc_msgSend(v12, "mountPath");
    v13 = (void *)objc_claimAutoreleasedReturnValue();

    if (v13)
    {
      objc_msgSend(v7, "objectForKeyedSubscript:", &unk_24FEB32C0);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v14, "unsignedLongLongValue");

      v15 = objc_msgSend(v8, "unsignedLongLongValue");
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48_cold_2();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
        __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48_cold_1();
...
- (void)_setDoneXpcActivity:(id)a3 description:(id)a4
{
  ...
  if (!xpc_activity_set_state((xpc_activity_t)a3, 5))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 2112;
      v11 = v6;
      _os_log_impl(&dword_230455000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to set the xpc state to done for \"%@\"%@", (uint8_t *)&v8, 0x16u);
    }
...
- (void)_dbgSleepIfRequested
{
  ...
  OUTLINED_FUNCTION_11_0(&dword_230455000, v1, v2, "[DEBUG] Start date expired: %@ (%f)%@", v3, v4, v5, v6, 2u);
...
- (void)_startXPCListeners
{
  ...
  -[BRCDaemonFPFS setUpSandbox](self, "setUpSandbox");
  brc_bread_crumbs();
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  brc_default_log();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315650;
    ...
    v32 = 2112;
    *(_QWORD *)v33 = v3;
    _os_log_impl(&dword_230455000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] starting bird in %s mode%s%@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)&v33[6] = v16;
    ...
    v42 = 2112;
    v43 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Starting up, welcome, bundle:%@, pid:%d, uid:%d, os:%@, version:%@, home:\"%@\", in sync bubble:%@%@", buf, 0x54u);

  }
  -[BRCDaemonFPFS _dbgSleepIfRequested](self, "_dbgSleepIfRequested");
  if (!self->_unitTestMode)
  {
    v9 = objc_alloc(MEMORY[0x24BDD1998]);
    v10 = (NSXPCListener *)objc_msgSend(v9, "initWithMachServiceName:", *MEMORY[0x24BE178A8]);
    xpcListener = self->_xpcListener;
    self->_xpcListener = v10;

    -[NSXPCListener setDelegate:](self->_xpcListener, "setDelegate:", self);
    v12 = objc_alloc(MEMORY[0x24BDD1998]);
    v13 = (NSXPCListener *)objc_msgSend(v12, "initWithMachServiceName:", *MEMORY[0x24BE178B0]);
...
- (void)_startupAndLoadAccount
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] using Cloud Database class: %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)_finishStartup
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] ┏%llx sending token change notification%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)start
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: qos_class_self() == QOS_CLASS_DEFAULT%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __22__BRCDaemonFPFS_start__block_invoke(uint64_t a1)
{
  ...
  if (qos_class_self() != QOS_CLASS_DEFAULT)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
      -[BRCDaemonFPFS start].cold.3();

  }
  objc_msgSend(*(id *)(a1 + 32), "_startXPCListeners");
  v9[0] = MEMORY[0x24BDAC760];
  v9[1] = 3221225472;
  v9[2] = __22__BRCDaemonFPFS_start__block_invoke_77;
  v9[3] = &unk_24FE3FA18;
  v9[4] = *(_QWORD *)(a1 + 32);
  v2 = (void (**)(_QWORD))MEMORY[0x2348BA0DC](v9);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v11 = v5;
      _os_log_impl(&dword_230455000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] BYSetupAssistantNeedsToRun --> pausing daemon startup until done.%@", buf, 0xCu);
    }
...
void __22__BRCDaemonFPFS_start__block_invoke_77(uint64_t a1)
{
  uint64_t v1;
  NSObject *v2;
  dispatch_block_t v3;
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          v26 = v6;
          objc_msgSend(MEMORY[0x24BDC8310], "wrapperWithURL:readonly:error:", v5, 0, &v26);
          v18 = (void *)objc_claimAutoreleasedReturnValue();
          v19 = v26;
...
- (void)registerWaiterBlock:(id)a3 forShareURL:(id)a4
{
  ...
  v21 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)v8->_accountResumedQueue);
  ...
  {
    ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v27);
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v37 = 2112;
            v38 = v9;
            _os_log_impl(&dword_230455000, v10, OS_LOG_TYPE_DEFAULT, "[WARNING] No accept operation found for key %@%@", buf, 0x16u);
          }
          ...
          if (v13)
          {
            ...
            do
            {
              for (j = 0; j != v13; ++j)
              {
                ...
                objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", v4, 11, 0);
                v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)dumpToContext:(id)a3
{
  ...
  if (-[NSMutableDictionary count](v4->_shareAcceptOperationsByToken, "count"))
  {
    ...
    objc_msgSend(v6, "writeLineWithFormat:", &stru_24FE4A790);
...
- (void)localeDidChange
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    v4 = 138412290;
    v5 = v2;
    _os_log_impl(&dword_230455000, v3, OS_LOG_TYPE_DEFAULT, "[NOTICE] Language changed, exiting%@", (uint8_t *)&v4, 0xCu);
  }

  exit(0);
}

uint64_t __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_107(uint64_t a1)
{
  uint64_t result;
  uint64_t v3;
  void *v4;
  ...
  if ((_DWORD)result)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("our connection was invalidated"));
    v3 = objc_claimAutoreleasedReturnValue();
    brc_bread_crumbs();
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    brc_default_log();
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT))
      __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_107_cold_1(v3, (uint64_t)v4, v5);

    brc_append_system_info_to_message();
    v6 = (const char *)objc_msgSend(objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue()), "UTF8String");
    __assert_rtn("-[BRCDaemonFPFS listener:shouldAcceptNewConnection:]_block_invoke", "/Library/Caches/com.apple.xbs/Sources/CloudDocs_plugins/core/shared/daemon/BRCDaemon.m", 1009, v6);
  }
  return result;
}

void __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_2_112(uint64_t a1)
{
  void *v2;
  NSObject *v3;
  uint64_t v4;
  ...
  __brc_create_section(0, (uint64_t)"-[BRCDaemonFPFS listener:shouldAcceptNewConnection:]_block_invoke_2", 1013, v5);
  brc_bread_crumbs();
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  brc_default_log();
  v3 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v10 = 2112;
    v11 = v2;
    _os_log_debug_impl(&dword_230455000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Client %@ connection was invalidated%@", buf, 0x20u);
  }
...
- (BOOL)selfCheck:(__sFILE *)a3
{
  ...
  v22 = 0x2020000000;
  v23 = 0;
  -[BRCDaemonFPFS currentSession](self, "currentSession");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "clientDB");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "performWithFlags:action:", 17, &__block_literal_global_115);
  v19 = 0;
  ...
  if (v6)
  {
    ...
    v13 = 3221225472;
    v14 = __27__BRCDaemonFPFS_selfCheck___block_invoke_118;
    v15 = &unk_24FE425D8;
    v17 = &v20;
    v16 = v4;
    v18 = a3;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
      -[BRCDaemonFPFS selfCheck:].cold.1();
...
uint64_t __27__BRCDaemonFPFS_selfCheck___block_invoke_118(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
...
uint64_t __27__BRCDaemonFPFS_selfCheck___block_invoke_2(_QWORD *a1, void *a2)
{
  id v3;
  int v4;
  uint64_t v5;
...
- (void)networkReachabilityChanged:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    -[BRCDaemonFPFS networkReachabilityChanged:].cold.1();
  ...
  if (v3)
    dispatch_async((dispatch_queue_t)self->_startupQueue, &__block_literal_global_121);
}
...
void __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke()
{
  ...
  objc_msgSend(v0, "enumerateAccountHandlerIfFinishedLoading:", &__block_literal_global_122);
...
void __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v3 = *MEMORY[0x24BDC81B0];
  v4 = a2;
  objc_msgSend(v2, "errorWithDomain:code:userInfo:", v3, -1004, 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  brc_bread_crumbs();
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  brc_default_log();
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "signalErrorResolved:completionHandler:", v5, &__block_literal_global_126_0);
  ...
  if (v10)
  {
    ...
    block[0] = MEMORY[0x24BDAC760];
    block[1] = 3221225472;
    block[2] = __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_127;
    block[3] = &unk_24FE3FA18;
    v13 = v9;
...
void __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_124(uint64_t a1, void *a2)
{
  id v2;
  void *v3;
  NSObject *v4;
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_124_cold_1();

}

uint64_t __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_127(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "enumerateAppLibraries:", &__block_literal_global_130);
}

uint64_t __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_2_128(uint64_t a1, void *a2)
{
  id v2;
  void *v3;
  void *v4;
...
- (void)handleExitSignal:(int)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v5;
    _os_log_impl(&dword_230455000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] starting exit sequence because of received signal (%s)%@", (uint8_t *)&v11, 0x16u);
  }
  ...
  v8 = (BRCDaemonFPFS *)-[BRCDaemonFPFS exitWithCode:](self, "exitWithCode:", 0);
  -[BRCDaemonFPFS exitWithCode:](v8, v9, v10);
}
...
- (void)exitWithCode:(int)a3
{
  ...
  +[BRCAccountsManager sharedManager](BRCAccountsManager, "sharedManager");
  objc_msgSend((id)objc_claimAutoreleasedReturnValue(), "enumerateAccountHandlers:", &__block_literal_global_131);
  brc_bread_crumbs();
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  brc_default_log();
  v5 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 2112;
    v8 = v4;
    _os_log_impl(&dword_230455000, v5, OS_LOG_TYPE_DEFAULT, "[NOTICE] exiting with code %d...%@", (uint8_t *)v6, 0x12u);
  }
...
- (void)performWithSessionForVolume:(NSObject *)a3 action:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v12 = 2112;
  v13 = a2;
  _os_log_error_impl(&dword_230455000, a3, (os_log_type_t)0x90u, "[ERROR] cannot retrieve device ID for '%@': %s%@", (uint8_t *)&v8, 0x20u);
  OUTLINED_FUNCTION_5_1();
}
...
void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] purgeable space is %@%@");
  OUTLINED_FUNCTION_0();
}

void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_36_cold_1()
{
  uint64_t v0;
  os_log_t v1;

  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Purged space is %@%@");
  OUTLINED_FUNCTION_0();
}

void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_46_cold_1(_QWORD *a1)
{
  uint64_t v1;
  os_log_t v2;
  __int128 v3;
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] ┏%llx pushing purgeable update to cache delete%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}

void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48_cold_1()
{
  os_log_t v0;
  uint8_t v1[24];
  uint64_t v2;
  ...
  OUTLINED_FUNCTION_4();
  _os_log_error_impl(&dword_230455000, v0, (os_log_type_t)0x90u, "[ERROR] Failed to get volume path%@", v1, 0xCu);
  OUTLINED_FUNCTION_0();
}

void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48_cold_2()
{
  uint64_t v0;
  os_log_t v1;

  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Purgeable info: %@ (not returned)%@");
  OUTLINED_FUNCTION_0();
}

void __34__BRCDaemonFPFS__setupCacheDelete__block_invoke_2_48_cold_3()
{
  void *v0;
  os_log_t v1;
  os_log_type_t v2;
...
- (void)listener:shouldAcceptNewConnection:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] welcome %@!%@");
  OUTLINED_FUNCTION_0();
}

void __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_107_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  void *v5;
  int v6;
  void *v7;
  ...
  v8 = 2112;
  v9 = a2;
  _os_log_fault_impl(&dword_230455000, a3, OS_LOG_TYPE_FAULT, "[CRIT] %@%@", (uint8_t *)&v6, 0x16u);
...
- (void)networkReachabilityChanged:.cold.1()
{
  ...
  OUTLINED_FUNCTION_9_1();
  OUTLINED_FUNCTION_11_0(&dword_230455000, v1, v2, "[DEBUG] sending server availability: %savailable (%@)%@", v3, v4, v5, v6, 2u);
...
void __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_2_cold_1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_4();
  _os_log_debug_impl(&dword_230455000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] network is now reachable -- signalling FP to resolve the error%@", v1, 0xCu);
  OUTLINED_FUNCTION_0();
}

void __44__BRCDaemonFPFS_networkReachabilityChanged___block_invoke_124_cold_1()
{
  uint64_t v0;
  os_log_t v1;

  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Signalling FP complete with error %@%@");
  OUTLINED_FUNCTION_0();
}
