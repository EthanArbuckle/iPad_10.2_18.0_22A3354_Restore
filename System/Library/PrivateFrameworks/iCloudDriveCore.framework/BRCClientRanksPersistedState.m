...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("nextNotifRank:%llu nextPackageItemRank:%llu nextItemRowID:%llu"), self->_nextNotifRank, self->_nextPackageItemRank, self->_nextItemRowID);
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: nextNotifRank >= _nextNotifRank%@", a5, a6, a7, a8, 2u);
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: nextPackageItemRank >= _nextPackageItemRank%@", a5, a6, a7, a8, 2u);
}
