...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("gc:%ld"), self->_latestGCStartTime);
}
...
- (void)timeSinceLatestGCStartTime
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = -a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_5(&dword_230455000, v1, v2, "[ERROR] latest GC started %lld seconds in the future%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
