...
- (void)_sendDictionaryToCoreAnalytics:(uint64_t)a1 eventName:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_230455000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: ![errorString isEqualToString:@\"CKErrorDomain.2\"]%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)_sendDictionaryToCoreAnalytics:(os_log_t)log eventName:.cold.2(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: error string is not a string value %@%@", (uint8_t *)&v3, 0x16u);
}
