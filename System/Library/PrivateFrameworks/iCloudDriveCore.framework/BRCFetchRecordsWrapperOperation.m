...
- (BRCFetchRecordsWrapperOperation)initWithCKFetchRecordsOperation:(id)a3 group:(id)a4 serverZone:(id)a5 isUserWaiting:(BOOL)a6 sessionContext:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v28 = 2112;
    v29 = v16;
    _os_log_impl(&dword_230455000, v17, OS_LOG_TYPE_INFO, "[INFO] Request to wrap and run CKFetchRecordsOperation: [%@]%@", buf, 0x16u);
  }
...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync/fetch-records-wrapper", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v16 = 2112;
    v17 = v3;
    _os_log_impl(&dword_230455000, v4, OS_LOG_TYPE_INFO, "[INFO] Running CKFetchRecordsOperation: [%@]%@", buf, 0x16u);
  }
...
void __39__BRCFetchRecordsWrapperOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_impl(&dword_230455000, v9, OS_LOG_TYPE_INFO, "[INFO] finished running CKFetchRecordsOperation [%@] with error [%@]%@", (uint8_t *)&v11, 0x20u);
  }
