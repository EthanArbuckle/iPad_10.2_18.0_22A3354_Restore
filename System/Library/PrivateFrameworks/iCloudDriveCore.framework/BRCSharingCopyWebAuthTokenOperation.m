...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sharing/copy-web-auth-token", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  v3 = objc_alloc_init(MEMORY[0x24BDB9118]);
  v4 = (void *)objc_opt_new();
  objc_msgSend(v3, "setConfiguration:", v4);

  objc_msgSend(MEMORY[0x24BDB9030], "containerWithIdentifier:", self->_ckContainerID);
...
void __43__BRCSharingCopyWebAuthTokenOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      v14 = 2112;
      v15 = v7;
      _os_log_error_impl(&dword_230455000, v8, (os_log_type_t)0x90u, "[ERROR] failed fetching webauth token for %@: %@%@", (uint8_t *)&v10, 0x20u);
    }
