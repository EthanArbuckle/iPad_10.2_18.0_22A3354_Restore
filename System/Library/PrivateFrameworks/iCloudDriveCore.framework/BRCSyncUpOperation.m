...
LABEL_24:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&v170[4] = 2112;
    *(_QWORD *)&v170[6] = v19;
    _os_log_debug_impl(&dword_230455000, v20, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Sync: syncing up clientZone %@. batch size - %u%@", buf, 0x26u);
  }

  v21 = v17;
  v138 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", v17);
  ...
  v29 = (NSMutableArray *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", v21);
  ...
  v35 = (NSMutableOrderedSet *)objc_alloc_init(MEMORY[0x24BDBCEE0]);
  ...
  v41 = (NSMutableArray *)objc_alloc_init(MEMORY[0x24BDBCEB8]);
  ...
  v47 = (NSMutableDictionary *)objc_alloc_init(MEMORY[0x24BDBCED8]);
          ...
          if ((v65 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v67, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412546;
              ...
              v167 = 2112;
              v168 = (uint64_t)v66;
              _os_log_debug_impl(&dword_230455000, v67, OS_LOG_TYPE_DEBUG, "[DEBUG] ignoring item with negative cost for now %@%@", buf, 0x16u);
            }
  ...
  if (v69)
  {
    ...
    do
    {
      ...
      for (j = 0; j != v145; ++j)
      {
        ...
        v72 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initShareIDWithShareableItem:", v71);
  ...
  if (self->_itemNeedingBasehashSalting || self->_itemNeedingPCSChaining)
  {
    ...
    if (os_log_type_enabled(v87, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v169 = 2112;
      *(_QWORD *)v170 = v86;
      _os_log_debug_impl(&dword_230455000, v87, OS_LOG_TYPE_DEBUG, "[DEBUG] Dedicating this sync up operation to %@ %@%@", buf, 0x20u);
    }
    ...
    || v84->_itemNeedingBasehashSalting)
  {
    ...
    if (objc_msgSend(v141, "isPrivateZone"))
    {
      ...
      if ((v106 & 1) == 0)
      {
        ...
        if (v110)
        {
          ...
          objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", v113);
    ...
    if (os_log_type_enabled(v118, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&v170[10] = v127;
      ...
      v175 = 2112;
      v176 = v117;
      _os_log_debug_impl(&dword_230455000, v118, OS_LOG_TYPE_DEBUG, "[DEBUG] preparing to send in requestID:%lld: %lu records, delete %lu recordIDs, unshare %lu iwork shares, rename %lu shares, about %lu items%@", buf, 0x48u);
    }
    ...
    if (os_log_type_enabled(v120, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v169 = 2112;
      *(_QWORD *)v170 = v119;
      _os_log_impl(&dword_230455000, v120, OS_LOG_TYPE_DEFAULT, "[NOTICE] sending %lu items to the cloud for %@\n%@", buf, 0x20u);
...
- (BRCSyncUpOperation)initWithZone:(id)a3 sessionContext:(id)a4 syncUpCallback:(id)a5
{
  ...
  v15 = objc_msgSend(v14, "isEqualToString:", *MEMORY[0x24BDB8E88]);
...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync-up", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
void __80__BRCSyncUpOperation__performMetadataSaltingOperationIfNecessaryWithCompletion___block_invoke_2(uint64_t a1, int a2, int a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413314;
    ...
    v28 = 2112;
    v29 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished metadata salting a batch for item %@ when completed: %d validation: %d error: %@%@", buf, 0x2Cu);
  }
...
void __73__BRCSyncUpOperation__performPCSChainOperationIfNecessaryWithCompletion___block_invoke_2(uint64_t a1, int a2, void *a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 67109890;
    ...
    v32 = 2112;
    v33 = v10;
    _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished PCS chaining a batch when completed: %d listOp: %@ error: %@%@", buf, 0x26u);
  }
...
- (void)_performModifyRecordsOrBatchOperationWithCompletion:(id)a3
{
  ...
  if (!-[BRCSyncUpOperation _performMetadataSaltingOperationIfNecessaryWithCompletion:](self, "_performMetadataSaltingOperationIfNecessaryWithCompletion:", v4)&& !-[BRCSyncUpOperation _performPCSChainOperationIfNecessaryWithCompletion:](self, "_performPCSChainOperationIfNecessaryWithCompletion:", v4))
  {
    ...
    {
      v31 = v6;
      v9 = objc_alloc_init(MEMORY[0x24BDB9158]);
      ...
      objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", &self->_requestID, 8);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", -[NSMutableArray count](self->_recordsToSave, "count"));
      v42 = 0u;
      v43 = 0u;
      v44 = 0u;
      v45 = 0u;
      v15 = self->_recordsToSave;
      v16 = -[NSMutableArray countByEnumeratingWithState:objects:count:](v15, "countByEnumeratingWithState:objects:count:", &v42, v46, 16);
      if (v16)
      {
        v17 = v16;
        v18 = *(_QWORD *)v43;
        do
        {
          for (i = 0; i != v17; ++i)
          {
            ...
            objc_msgSend(v20, "recordID", v28);
            v21 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v14, "setObject:forKeyedSubscript:", v20, v21);

          }
          v17 = -[NSMutableArray countByEnumeratingWithState:objects:count:](v15, "countByEnumeratingWithState:objects:count:", &v42, v46, 16);
        }
        while (v17);
      }
      ...
      v24 = objc_msgSend(v23, "skipPerItemSyncUpThrottling");

      v25 = MEMORY[0x24BDAC760];
      v34[0] = MEMORY[0x24BDAC760];
      v34[1] = 3221225472;
      v34[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke;
      v34[3] = &unk_24FE43928;
      v35 = v5;
      v36 = self;
      v37 = v28;
      ...
      v26 = v14;
      v27 = v28;
      objc_msgSend(v29, "setPerRecordCompletionBlock:", v34);
      v32[0] = v25;
      v32[1] = 3221225472;
      v32[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_40;
      v32[3] = &unk_24FE43950;
      v33 = v4;
      objc_msgSend(v29, "setModifyRecordsCompletionBlock:", v32);
      -[_BRCOperation addSubOperation:](self, "addSubOperation:", v29);
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5 && v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&buf[4] = v30;
      ...
      v55 = 2112;
      v56 = v8;
      _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx sync-up error for record %@: %@%@", buf, 0x2Au);
    ...
    v40[1] = 3221225472;
    v40[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33;
    v40[3] = &unk_24FE43900;
    v41 = v7;
    v42 = v5;
    v11 = *(id *)(a1 + 32);
    ...
    v47 = *(id *)(a1 + 64);
    v48 = *(_BYTE *)(a1 + 80);
    objc_msgSend(v10, "groupInBatch:", v40);
  ...
  else if (v5)
  {
    ...
    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 256), "bouncingAnalyzer");
    v38 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v38, "analyzeServerBouncingOriginalRecord:savedRecord:", v37, v5);
...
LABEL_21:
    ...
    || objc_msgSend(*(id *)(a1 + 32), "brc_isReferenceValidationError"))
  {
    ...
    v14 = objc_claimAutoreleasedReturnValue();
    -[NSObject parentItemIDInZone](v14, "parentItemIDInZone");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    v16 = v15;
    ...
    if (-[NSObject isDeadOrMissingInServerTruth](v14, "isDeadOrMissingInServerTruth"))
    {
      brc_bread_crumbs();
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      brc_default_log();
      ...
      -[NSObject markForceRejected](v14, "markForceRejected");
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "brc_containsCloudKitErrorCode:", 10))
  {
    ...
    objc_msgSend(MEMORY[0x24BDB91E8], "brc_fetchShareIDWithSharedItem:", v33);
    v106 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v106, "brc_shareItemID");
    v105 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v105 && objc_msgSend(v41, "isEqualToItemID:", v105))
    {
...
LABEL_29:
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138413058;
      ...
      v123 = 2112;
      v124 = v50;
      _os_log_impl(&dword_230455000, v51, OS_LOG_TYPE_DEFAULT, "[WARNING] We changed share roots from %@ to %@ on %@ and got a permission error so behaving like an unknown item%@", buf, 0x2Au);
    }

    objc_msgSend(v33, "handleUnknownItemError");
    v52 = objc_msgSend(v33, "saveToDB");
...
LABEL_30:
  if (objc_msgSend(*(id *)(a1 + 32), "brc_isCloudKitErrorRequiringAssetRescan"))
  {
    ...
    objc_msgSend(v43, "itemByItemID:", v9);
    v10 = (id)objc_claimAutoreleasedReturnValue();

    if (objc_msgSend(v10, "isDocument")
      && objc_msgSend(v10, "syncUpState") == 4
      && (objc_msgSend(v10, "isDead") & 1) == 0)
    {
      brc_bread_crumbs();
      ...
      v55 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v55, "reIngestFromFileProvider");
...
LABEL_20:
  ...
  v46 = *(void **)(a1 + 32);
  v116 = 0;
  v47 = objc_msgSend(v46, "brc_isCloudKitErrorUnsupportedOSForItemAndGetMinimumSupported:", &v116);
  v27 = v116;
  if (v47)
  {
  ...
  v48 = *(void **)(a1 + 32);
  v115 = 0;
  v49 = objc_msgSend(v48, "brc_isCloudKitErrorReparentedToNewParent:", &v115);
  v26 = v115;
  if (v49)
  {
  ...
  v56 = *(void **)(a1 + 32);
  v114 = 0;
  v57 = objc_msgSend(v56, "brc_isCloudKitErrorRemappedToNewRecordName:", &v114);
  v25 = v114;
  if (v57)
  {
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "brc_isIndividualItemBlacklistError"))
  {
    ...
    objc_msgSend(*(id *)(a1 + 48), "itemByItemID:", v60);
    ...
    v64 = *(void **)(a1 + 48);
    v65 = *(void **)(*(_QWORD *)(a1 + 56) + 512);
    objc_msgSend(v64, "dbRowID");
    v66 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v65, "blockSyncUpCallback:inZone:", v61, v66);
    goto LABEL_55;
  }
    ...
    || !objc_msgSend(*(id *)(a1 + 32), "brc_containsCloudKitInternalErrorCode:", 2040))
  {
          ...
          v71))
    {
      v72 = *(void **)(a1 + 32);
      v107 = 0;
      v73 = objc_msgSend(v72, "brc_isCloudKitShouldBeUsingEnhancedDrivePrivacyWithFieldName:", &v107);
      v60 = v107;
      if (!v73)
      {
        ...
        else if (objc_msgSend(*(id *)(a1 + 32), "brc_isCloudKitAtomicFailure"))
        {
          ...
          if (os_log_type_enabled(v79, OS_LOG_TYPE_DEBUG))
            __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_6();
        ...
        else
        {
          if (*(_BYTE *)(a1 + 88))
          {
            ...
            if (os_log_type_enabled(v89, OS_LOG_TYPE_DEBUG))
              __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_7();
      ...
      if (os_log_type_enabled(v75, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v121 = 2112;
        v122 = v74;
        _os_log_debug_impl(&dword_230455000, v75, OS_LOG_TYPE_DEBUG, "[DEBUG] Enabling server zone %@ to use enhanced drive privacy (fieldName %@)%@", buf, 0x20u);
      }
    ...
    objc_msgSend(*(id *)(a1 + 48), "itemByItemID:", v60);
    v61 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 48), "serverItemByItemID:", v60);
    v66 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v61, "isZoneRoot") & 1) != 0)
    {
      v82 = 0;
    }
    else
    {
      ...
      objc_msgSend(v91, "parentID");
      v92 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v90, "serverItemByItemID:", v92);
      v82 = (id)objc_claimAutoreleasedReturnValue();

      if (v82 && !objc_msgSend(v82, "pcsChainState"))
      {
        brc_bread_crumbs();
        v102 = (void *)objc_claimAutoreleasedReturnValue();
        brc_default_log();
        ...
        if (os_log_type_enabled(v103, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412290;
          v118 = v102;
          _os_log_impl(&dword_230455000, v103, OS_LOG_TYPE_DEFAULT, "[WARNING] Updating parent item to be chained because it is unknown and we encountered a PCS error%@", buf, 0xCu);
        }
        ...
        v111[1] = 3221225472;
        v111[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_34;
        v111[3] = &unk_24FE3FA40;
        v112 = *(id *)(a1 + 72);
        v82 = v82;
        v113 = v82;
    ...
    if (!v66 || objc_msgSend(v66, "pcsChainState"))
    {
      brc_bread_crumbs();
      ...
      if (os_log_type_enabled(v94, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v119 = 2112;
        v120 = v93;
        _os_log_impl(&dword_230455000, v94, OS_LOG_TYPE_DEFAULT, "[WARNING] Encountered an unknown pcs error for %@%@", buf, 0x16u);
      }
    ...
    if (os_log_type_enabled(v97, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v118 = v96;
      _os_log_impl(&dword_230455000, v97, OS_LOG_TYPE_DEFAULT, "[WARNING] Updating local item to be chained because it is unknown and we encountered a PCS error%@", buf, 0xCu);
    }
...
LABEL_94:
  ...
  v68 = objc_msgSend(v67, "brc_isZoneRootRecordID");

  if (!v68)
  {
    objc_msgSend(*(id *)(a1 + 40), "recordID");
    v83 = (void *)objc_claimAutoreleasedReturnValue();
    v84 = objc_msgSend(v83, "brc_isAppLibraryRootRecordID");
    ...
    objc_msgSend(*(id *)(a1 + 40), "recordID");
    v86 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v86, "brc_appLibraryRootZoneName");
    v87 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v85, "appLibraryByID:", v87);
    v60 = (id)objc_claimAutoreleasedReturnValue();

    v76 = v60;
    v77 = 2;
LABEL_67:
    objc_msgSend(v76, "setStateBits:", v77);
    goto LABEL_94;
  }
  if (objc_msgSend(*(id *)(a1 + 48), "isPrivateZone"))
  {
    ...
    objc_msgSend(v69, "defaultAppLibrary");
    v70 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v70, "setStateBits:", 2);
    ...
    || -[NSMutableDictionary count](self->_renamedShareIDsToNames, "count"))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v29 = 2112;
      v30 = v7;
      _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetching share IDs shared by us for renames: %@ and unshare: %@%@", buf, 0x20u);
    }
    ...
    v12 = objc_alloc(MEMORY[0x24BDB90E8]);
...
void __41__BRCSyncUpOperation_performShareUpdate___block_invoke(uint64_t a1, void *a2, void *a3)
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v62 = 2112;
        v63 = v9;
        _os_log_impl(&dword_230455000, v10, OS_LOG_TYPE_DEFAULT, "[WARNING] got an error while fetching the records and shares %@, but ignoring it%@", buf, 0x16u);
      }
  ...
  if (v45)
  {
    ...
    v39 = *MEMORY[0x24BDB8F58];
    v38 = *MEMORY[0x24BE174E8];
    v40 = v5;
    v41 = a1;
    v42 = *MEMORY[0x24BDB8F28];
    v43 = *(_QWORD *)v53;
    do
    {
      for (i = 0; i != v45; ++i)
...
LABEL_28:
  ...
  if (objc_msgSend(v11, "count"))
  {
    ...
    v33 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9158]), "initWithRecordsToSave:recordIDsToDelete:", v11, 0);
...
LABEL_6:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_230455000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] Got a permanent error %@ when fetching records and shares%@", (uint8_t *)&v11, 0x16u);
  }
  ...
  if (v17)
  {
    ...
    if ((v20 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
      {
        ...
        v34 = 2112;
        v35 = v21;
        _os_log_fault_impl(&dword_230455000, v22, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Protection data mismatch between share and record being shared! (%@ vs %@)%@", (uint8_t *)&v30, 0x20u);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
  {
    ...
    v38 = 2112;
    v39 = v23;
    _os_log_debug_impl(&dword_230455000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] updated content record %@ with protectionData %@ baseToken %@ routingKey %@%@", (uint8_t *)&v30, 0x34u);
  }
...
LABEL_6:
    ...
    v34 = 0;
    v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB90E8]), "initWithRecordIDs:", v27);
    objc_msgSend(v20, "setShouldFetchAssetContent:", 0);
    v21 = *MEMORY[0x24BDB8FE0];
    v35[0] = *MEMORY[0x24BDB8FC8];
    v35[1] = v21;
    v22 = *MEMORY[0x24BDB8FD0];
    v35[2] = *MEMORY[0x24BDB8FD8];
    v35[3] = v22;
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = objc_msgSend(v11, "isEqualToString:", *MEMORY[0x24BDB8F28]);
...
LABEL_27:
    ...
    LOBYTE(v35) = 0;
    v66 = *(_QWORD *)v70;
    v36 = *MEMORY[0x24BDB8FE0];
    v60 = *MEMORY[0x24BDB8FC8];
    v59 = *MEMORY[0x24BDB8FD8];
    v58 = *MEMORY[0x24BDB8FD0];
    *(_QWORD *)&v34 = 138412802;
    v52 = v34;
    v65 = *MEMORY[0x24BDB8FE0];
    v56 = v16;
    while (1)
    {
      for (i = 0; i != v67; ++i)
            ...
            if ((objc_msgSend(v15, "isEqualToData:", v45) & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v47, OS_LOG_TYPE_FAULT))
              {
                *(_DWORD *)buf = v52;
                ...
                v78 = 2112;
                v79 = v46;
                _os_log_fault_impl(&dword_230455000, v47, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: protection data mismatch! ignoring content records version (%@ to %@)%@", buf, 0x20u);
              }
...
LABEL_52:
  ...
  if (v19)
  {
    ...
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = v20;
    v22 = (uint64_t *)MEMORY[0x24BDB8FE0];
    if (v20)
    {
      v15 = v20;
      v23 = *v22;
    ...
    if (v27)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138413058;
        ...
        v80 = 2112;
        v81 = v28;
        _os_log_fault_impl(&dword_230455000, v29, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: protection data mismatch between content public sharing identity and web sharing data (%@ vs %@) for %@%@", buf, 0x2Au);
      }
    }
    else
    {
...
LABEL_23:
    ...
    {
      objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BDB8FC8]);
    ...
    objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BDB8FD8]);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BDB8FD0]);
    v64 = (void *)objc_claimAutoreleasedReturnValue();
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_54(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40))
  {
    ...
    v37 = 0x2020000000;
    v38 = 0;
    v8 = *MEMORY[0x24BDB8FE0];
    v9 = *MEMORY[0x24BE17430];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v41 = 2112;
          v42 = v15;
          _os_log_debug_impl(&dword_230455000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] record %@ still needs web sharing protection data%@", buf, 0x16u);
        }
        ...
        if (dispatch_group_wait(v20, v21))
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v27;
            v40 = v22;
            _os_log_fault_impl(&dword_230455000, v23, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Timed out while waiting for new web-sharing identity%@", buf, 0xCu);
          }

          objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", v9, 15, CFSTR("unreachable: Timed out while waiting for new web-sharing identity"));
          v24 = objc_claimAutoreleasedReturnValue();
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_55(uint64_t a1, void *a2, void *a3)
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = *MEMORY[0x24BDB8FE0];
  objc_msgSend(v9, "setObject:forKeyedSubscript:", v5, *MEMORY[0x24BDB8FE0]);
...
void __26__BRCSyncUpOperation_main__block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5 && !v6 && (objc_msgSend(v11, "isEqualToItemID:", v14) & 1) != 0)
  {
    ...
    objc_msgSend(v7, "encryptedValues");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = *MEMORY[0x24BDB8FE0];
    objc_msgSend(v17, "setObject:forKeyedSubscript:", v5, *MEMORY[0x24BDB8FE0]);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
  {
    ...
    v30 = 2112;
    v31 = v19;
    _os_log_error_impl(&dword_230455000, v20, (os_log_type_t)0x90u, "[ERROR] Failed getting web sharing identity for %@ - %@%@", (uint8_t *)&v26, 0x20u);
...
- (void)prepareWithMaxCost:retryAfter:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Can't prepare sync for a zone that is blocked%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)prepareWithMaxCost:retryAfter:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: items.count == 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)prepareWithMaxCost:retryAfter:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] no record needs syncing at the moment.%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)prepareWithMaxCost:retryAfter:.cold.4()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Because this is our first time syncing up, adding %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)prepareWithMaxCost:retryAfter:.cold.5()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] destroying shares instead of unsharing%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)prepareWithMaxCost:retryAfter:.cold.6()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Avoid syncing up a pristine zone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)prepareWithMaxCost:retryAfter:.cold.7()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] %@ is not pristine and needs sync%@");
  OUTLINED_FUNCTION_0();
}
...
void __80__BRCSyncUpOperation__performMetadataSaltingOperationIfNecessaryWithCompletion___block_invoke_22_cold_1()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v3, "[DEBUG] Scheduling sync down for zone %@%@", v4);
...
void __80__BRCSyncUpOperation__performMetadataSaltingOperationIfNecessaryWithCompletion___block_invoke_22_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Postponing sync up for item %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Uploaded an iWork package of size 0 (itemID: %@)%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Unable to open iwork package %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Forcing item dead in the server truth to re-upload as a rejected item - %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Forcing sync up of dead parent %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] item %@ doesn't need to be re-scanned%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_4()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] item %@ needs to be re-scanned%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_5()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] Blocking %@ from sync up until it is next modified because the server failed with a permanent error%@");
  OUTLINED_FUNCTION_0();
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_6()
{
  NSObject *v0;
  id *v1;
  void *v2;
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v3, "[DEBUG] ignoring error for %@ because an other item in the batch failed%@", v4);

  OUTLINED_FUNCTION_6();
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_33_cold_7()
{
  NSObject *v0;
  id *v1;
  void *v2;
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v3, "[DEBUG] skipping throttling item %@ even though it caused the failure%@", v4);
...
- (void)performShareUpdate:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self.serverZone.isPrivateZone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __41__BRCSyncUpOperation_performShareUpdate___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] No shares need saving%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __41__BRCSyncUpOperation_performShareUpdate___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Saving shares %@ shared by us for unshare and rename%@");
  OUTLINED_FUNCTION_0();
}
...
void __82__BRCSyncUpOperation__scheduleShareUpdateAndModifyRecordsAndZoneCreationOperation__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] send metadata error: %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_setSharingFieldsOnContentRecord:withProtectionData:baseToken:routingKey:forceOverwrite:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: protectionData%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_setSharingFieldsOnContentRecord:withProtectionData:baseToken:routingKey:forceOverwrite:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: [contentRecord.recordType isEqualToString:kBRRecordTypeContent]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: share.publicSharingIdentity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: content record is missing protection data %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !fetchedRecord%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_55_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Failed to get new web sharing identity: %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __26__BRCSyncUpOperation_main__block_invoke_cold_1()
{
  ...
  v9 = 2112;
  v10 = v1;
  _os_log_debug_impl(&dword_230455000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Sync: sending requestID:%lld for container %@%@", (uint8_t *)&v5, 0x20u);
...
void __26__BRCSyncUpOperation_main__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: invalid sharing records count%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __26__BRCSyncUpOperation_main__block_invoke_2_cold_1()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v3, "[DEBUG] got web sharing identity for %@%@", v4);
...
void __26__BRCSyncUpOperation_main__block_invoke_2_cold_3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: [firstItemID isEqual:secondItemID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
