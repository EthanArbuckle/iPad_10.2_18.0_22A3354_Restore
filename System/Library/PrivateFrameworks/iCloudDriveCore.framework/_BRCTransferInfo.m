...
- (_BRCTransferInfo)init
{
  ...
  if (v2)
  {
    ...
    -[BRCProgress setUserInfoObject:forKey:](v5, "setUserInfoObject:forKey:", v6, *MEMORY[0x24BDD11A8]);

    -[BRCProgress setUserInfoObject:forKey:](v2->_progress, "setUserInfoObject:forKey:", &unk_24FEB33F8, *MEMORY[0x24BDD11A0]);
...
- (id)description
{
  ...
  objc_msgSend(v29, "objectForKeyedSubscript:", *MEMORY[0x24BDD11A0]);
...
- (void)updateUnitCount
{
  ...
  v10 = 2112;
  v11 = v1;
  _os_log_debug_impl(&dword_230455000, v0, OS_LOG_TYPE_DEBUG, "[NOTIF] sumOfCompletedUnitCountDelta = %lld, progress.completedUnitCount = %lld%@", (uint8_t *)&v6, 0x20u);
...
- (void)copyProgressInfoToProgress:(id)a3 options:(char)a4
{
  ...
  v7 = *MEMORY[0x24BDD11A0];
  objc_msgSend(v9, "objectForKeyedSubscript:", *MEMORY[0x24BDD11A0]);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)verifyFutureProgressIsNotFinished
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(_QWORD *)&v3[14] = a1;
  OUTLINED_FUNCTION_4_1(&dword_230455000, a2, a3, "[CRIT] UNREACHABLE: future progress state isn't valid (unitCount: %lld)%@", *(_QWORD *)v3, *(_QWORD *)&v3[8], *(_QWORD *)&v3[16]);
  OUTLINED_FUNCTION_0();
}
