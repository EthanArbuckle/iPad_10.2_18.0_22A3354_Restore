...
- (BRCFairScheduler)initWithWorkloop:(id)a3 name:(id)a4
{
  ...
  if (v9)
  {
    ...
    v11 = dispatch_source_create(MEMORY[0x24BDAC9D0], 0, 0, (dispatch_queue_t)v10->_workloop);
    source = v10->_source;
...
- (void)addSource:(id)a3
{
  ...
  objc_sync_enter(v4);
  sourceForBitIndex = v4->_sourceForBitIndex;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLong:", v4->_maxRegistedSourceBit);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7 >= 0x41)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("too many registered source"));
...
- (void)addSource:(uint8_t *)buf .cold.1(void *a1, uint64_t a2, uint8_t *buf, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(_QWORD *)(buf + 14) = a2;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] %@%@", buf, 0x16u);
