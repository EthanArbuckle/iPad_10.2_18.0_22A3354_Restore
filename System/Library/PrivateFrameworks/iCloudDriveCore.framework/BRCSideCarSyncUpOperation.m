...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync/side-car-sync-up", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
  ...
  if (v2)
  {
    ...
    do
    {
      for (i = 0; i != v3; ++i)
      {
        ...
        objc_msgSend(v6, "markLatestSyncRequestFailedInZone:", &unk_24FEB3290);
...
- (void)_syncUpRecordBatchWithModifiedRecords:(id)a3 deletedRecordIDs:(id)a4 recordIDToZoneMap:(id)a5 requestID:(unint64_t)a6
{
  ...
  if (v13 + objc_msgSend(v11, "count"))
  {
    ...
    v16 = objc_alloc(MEMORY[0x24BDB9158]);
    ...
    objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", &v39, 8);
  ...
  if (objc_msgSend(v9, "brc_isCloudKitErrorImplyingZoneNeedsCreation"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&location[4] = WeakRetained;
      ...
      v37 = 2112;
      v38 = v11;
      _os_log_debug_impl(&dword_230455000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] We need to create the side car zone on %@ - %@%@", location, 0x20u);
    }
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v19, (os_log_type_t)0x90u))
      {
        ...
        *(_QWORD *)&location[4] = WeakRetained;
        ...
        v37 = 2112;
        v38 = v18;
        _os_log_error_impl(&dword_230455000, v19, (os_log_type_t)0x90u, "[ERROR] Failed syncing up side cars on %@ - %@%@", location, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_QWORD *)&location[4] = v7;
        ...
        v37 = 2112;
        v38 = v20;
        _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] finished side car sync up: %@, op: %@%@", location, 0x20u);
      }
      ...
      do
      {
        ...
        if (!v11)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v16;
            v23 = v13;
            _os_log_fault_impl(&dword_230455000, v14, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: clientZone%@", buf, 0xCu);
          }
...
- (void)fakeSyncForItem:(id)a3 itemRank:(unint64_t)a4
{
  ...
  objc_msgSend(v8, "markLatestSyncRequestAcknowledgedInZone:", &unk_24FEB3290);
...
- (void)main
{
  ...
  v3 = self->_session;
  -[BRCAccountSessionFPFS clientTruthWorkloop](v3, "clientTruthWorkloop");
        ...
        || (v12 & 0x1A00) != 0 && v14 && (objc_msgSend(v11, "hasfieldsToSync") & 1) == 0)
      {
        ...
        if (!v17)
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412290;
            v92 = v28;
            _os_log_debug_impl(&dword_230455000, v29, OS_LOG_TYPE_DEBUG, "[DEBUG] Faking sync for side car info delete which isn't known to the server%@", buf, 0xCu);
          }
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v93 = 2112;
          v94 = v18;
          _os_log_debug_impl(&dword_230455000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] Deleting side-car record for %@%@", buf, 0x16u);
        }
...
LABEL_29:
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v93 = 2112;
            v94 = v40;
            _os_log_debug_impl(&dword_230455000, v41, OS_LOG_TYPE_DEBUG, "[DEBUG] Faking sync of side-car record for %@%@", buf, 0x16u);
          }
...
LABEL_34:
      ...
      objc_msgSend(MEMORY[0x24BDB91E8], "brc_fetchShareIDWithSharedItem:", v10);
      ...
      if ((v42 & 1) == 0)
      {
        ...
        if (!v45)
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412290;
            v92 = v65;
            _os_log_fault_impl(&dword_230455000, v66, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: itemID%@", buf, 0xCu);
          }
      ...
      if (v44)
      {
        v52 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9218]), "initWithRecordID:action:", v44, 0);
...
LABEL_39:
        ...
        if (os_log_type_enabled(v55, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v93 = 2112;
          v94 = v54;
          _os_log_debug_impl(&dword_230455000, v55, OS_LOG_TYPE_DEBUG, "[DEBUG] Syncing up side-car record for %@%@", buf, 0x16u);
        }
...
LABEL_42:
      ...
      if (os_log_type_enabled(v64, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v93 = 2112;
        v94 = v63;
        _os_log_fault_impl(&dword_230455000, v64, OS_LOG_TYPE_FAULT, "[CRIT] Unable to compute reference recordID for %@%@", buf, 0x16u);
      }
...
- (void)_syncUpRecordBatchWithModifiedRecords:(os_log_t)log deletedRecordIDs:recordIDToZoneMap:requestID:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a1;
  _os_log_debug_impl(&dword_230455000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Syncing up side car records with request %llu%@", (uint8_t *)&v3, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: requestID%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: state%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
