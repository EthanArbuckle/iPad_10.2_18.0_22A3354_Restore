...
- (BRCThumbnailGenerateOperation)initWithDocumentAtURL:(id)a3 targetURL:(id)a4 timeout:(id)a5 sessionContext:(id)a6
{
  ...
  if (v18)
  {
    objc_msgSend(MEMORY[0x24BDB9190], "br_operationGroupWithName:", CFSTR("ThumbnailGenerate"));
...
- (void)main
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_230455000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: _url && _targetURL%@", (uint8_t *)&v2, 0xCu);
}
...
void __37__BRCThumbnailGenerateOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_debug_impl(&dword_230455000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Saved the thumbnail of %@ to %@ with error %@%@", (uint8_t *)&v9, 0x2Au);
  }
...
- (void)cancel
{
  ...
  if (-[_BRCOperation timedOut](self, "timedOut"))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "brc_errorThumbnailGenerationOperationTimedOut");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[BRCTapToRadarManager requestTapToRadarWithTitle:description:keywords:attachments:sendFullLog:displayReason:triggerRootCause:](tapToRadarManager, "requestTapToRadarWithTitle:description:keywords:attachments:sendFullLog:displayReason:triggerRootCause:", v5, CFSTR("Possible issue in QL, Thumbnail generation operation was running for too long"), MEMORY[0x24BDBD1A8], MEMORY[0x24BDBD1A8], 0, CFSTR("thumbnail generation encountered an error"), v7);

  }
  v8 = (void (**)(_QWORD, _QWORD))MEMORY[0x2348BA0DC](self->_saveThumbnailCompletionBlock);
  if (v8)
  {
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  saveThumbnailCompletionBlock = self->_saveThumbnailCompletionBlock;
  v8 = a3;
  v9 = MEMORY[0x2348BA0DC](saveThumbnailCompletionBlock);
  v10 = (void *)v9;
  if (v9)
  {
