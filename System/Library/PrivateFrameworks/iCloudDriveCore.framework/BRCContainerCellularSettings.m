...
void __49__BRCContainerCellularSettings_isCellularEnabled__block_invoke(uint64_t a1)
{
  ...
  if (!*(_QWORD *)(*(_QWORD *)(a1 + 32) + 24))
  {
    ...
    v6 = objc_msgSend(v5, "aa_useCellularForDataclass:", *MEMORY[0x24BDB4668]);
...
void __60__BRCContainerCellularSettings__accountDidChangeForPersona___block_invoke_2_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_230455000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] forcing refresh of cellular switch%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void __60__BRCContainerCellularSettings__accountDidChangeForPersona___block_invoke_2_cold_2()
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx account properties changed%@");
  OUTLINED_FUNCTION_0();
}
...
void __60__BRCContainerCellularSettings__accountDidChangeForPersona___block_invoke_2_cold_3(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_error_impl(&dword_230455000, log, (os_log_type_t)0x90u, "[ERROR] Failed to adopt persona: %@%@", (uint8_t *)&v3, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
void __49__BRCContainerCellularSettings_isCellularEnabled__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] cellular is %@ for D&D%@");
  OUTLINED_FUNCTION_0();
}
...
void __49__BRCContainerCellularSettings_isCellularEnabled__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx checking if cellular is enabled for D&D%@");
  OUTLINED_FUNCTION_0();
}
