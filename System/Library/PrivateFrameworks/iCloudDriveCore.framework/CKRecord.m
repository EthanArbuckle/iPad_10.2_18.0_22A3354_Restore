...
void __84__CKRecord_BRCContainerMetadataAdditions__brc_containerMetadataRecordWithContainer___block_invoke(uint64_t a1, void *a2, void *a3)
{
    ...
    && (-[NSObject isFileURL](v6, "isFileURL") & 1) != 0)
  {
    ...
    if ((v7 & 1) != 0)
    {
      v9 = objc_msgSend(objc_alloc(MEMORY[0x24BDB9010]), "initWithFileURL:", v6);
      if (v9)
      {
        v10 = *(void **)(a1 + 32);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v18 = 2112;
        v19 = v9;
        _os_log_fault_impl(&dword_230455000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: icon doesn't exist anymore at %@ - %@%@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v18 = 2112;
      v19 = v8;
      _os_log_fault_impl(&dword_230455000, v9, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid key %@ and obj %@%@", buf, 0x20u);
    }
  }
