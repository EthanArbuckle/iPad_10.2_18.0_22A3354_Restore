...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync/sharedb", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
        ...
        if (!v12)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v17;
            ...
            v26 = 2112;
            v27 = v14;
            _os_log_debug_impl(&dword_230455000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] inserted new ownerKey %@ for %@%@", buf, 0x20u);
          }
...
- (void)_performAfterRegisteringForPushes:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9070]), "initWithSubscriptionID:", CFSTR("sharedZoneSubscription"));
  v6 = objc_alloc_init(MEMORY[0x24BDB9178]);
  objc_msgSend(v6, "setShouldSendContentAvailable:", 1);
  objc_msgSend(v5, "setNotificationInfo:", v6);
  v7 = objc_alloc(MEMORY[0x24BDB9160]);
  v16[0] = v5;
...
void __68__BRCSharedDatabaseSyncOperation__performAfterRegisteringForPushes___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    v27 = 2112;
    v28 = v11;
    _os_log_debug_impl(&dword_230455000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Handling result of creating %@ (operationID=%@): %@%@", buf, 0x34u);
...
- (void)_performFetchChangedZones
{
  ...
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB90A8]), "initWithPreviousServerChangeToken:", v3);
...
void __59__BRCSharedDatabaseSyncOperation__performFetchChangedZones__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v11 = 2112;
    v12 = v5;
    _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ zone %@ changed%@", (uint8_t *)&v7, 0x20u);
  }
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v29 = 2112;
      *(_QWORD *)v30 = v10;
      _os_log_error_impl(&dword_230455000, v11, (os_log_type_t)0x90u, "[ERROR] %@ failed: %@%@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)&v30[6] = v19;
      v31 = 2112;
      v32 = v12;
      _os_log_debug_impl(&dword_230455000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ done: %u zones were changed and %u deleted%@", buf, 0x2Cu);
    }
      ...
      *(_QWORD *)&v7 = 138412290;
      ...
      do
      {
        ...
        do
        {
          ...
          v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithRecordZoneID:", *(_QWORD *)(*((_QWORD *)&v26 + 1) + 8 * v10));
          objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 248), "session");
          v12 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v32 = 2112;
            v33 = v14;
            _os_log_debug_impl(&dword_230455000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] scheduling sync for %@%@", buf, 0x16u);
          }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v19, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = v23;
              v31 = v18;
              _os_log_fault_impl(&dword_230455000, v19, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: there should be a container%@", buf, 0xCu);
            }
...
- (void)main
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_debug_impl(&dword_230455000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Sync: fetching changed zones in the shared-database%@", (uint8_t *)&v4, 0x16u);
}
...
void __59__BRCSharedDatabaseSyncOperation__performFetchChangedZones__block_invoke_2_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v17 = 2112;
  v18 = a2;
  _os_log_debug_impl(&dword_230455000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] updating shared-database from %@ with token:%@ caught-up:%s%@", (uint8_t *)&v11, 0x2Au);
