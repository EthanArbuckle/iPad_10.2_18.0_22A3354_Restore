...
void ___BRCWritePackageExtensions_block_invoke_2()
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF50]), "initWithSuiteName:", CFSTR("com.apple.fileproviderd"));
...
void ___BRCWritePackageExtensions_block_invoke_4(uint64_t a1, uint64_t a2)
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "br_supportDirForPersona:dataSeparated:", v5, v6);
...
void ___BRCWritePackageExtensions_block_invoke_2_cold_1()
{
  ...
  v3 = v0;
  OUTLINED_FUNCTION_3(&dword_230455000, v1, (uint64_t)v1, "[DEBUG] Persisting %@ for FileProvider%@", v2);
  OUTLINED_FUNCTION_0();
}
...
void ___BRCWritePackageExtensions_block_invoke_4_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_230455000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't change personas while saving package extensions list%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
