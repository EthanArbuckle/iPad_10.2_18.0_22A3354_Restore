...
- (void)syncContextDidBecomeForeground:(id)a3
{
  ...
  v30 = a3;
  -[BRCAccountSessionFPFS personaIdentifier](self->_session, "personaIdentifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (syncContextDidBecomeForeground____personaOnceToken != -1)
    dispatch_once(&syncContextDidBecomeForeground____personaOnceToken, &__block_literal_global_181);
...
LABEL_11:
  ...
  if ((objc_msgSend(v12, "isShared") & 1) == 0)
  {
    ...
    -[BRCAccountSessionFPFS appLibraryByID:](self->_session, "appLibraryByID:", v13);
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v34 = v17;
        _os_log_impl(&dword_230455000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] Container became foreground that we didn't think was installed, forcing an apps list refresh%@", buf, 0xCu);
      }
...
- (void)_updatePushTopicsRegistration
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !_isInSyncBubble%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleUpdatePushTopicsRegistration
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] scheduling push topics registration%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (BRCContainerScheduler)initWithAccountSession:(id)a3 pushWorkloop:(id)a4
{
  ...
  if (v7)
  {
    ...
    -[BRCAccountSessionFPFS clientState](v7->_session, "clientState");
    ...
    objc_msgSend(MEMORY[0x24BE17640], "containerMetadataMangledID");
    ...
    objc_msgSend(MEMORY[0x24BE17640], "sharedDatabaseMangledID");
    ...
    objc_msgSend(MEMORY[0x24BE17640], "zoneHealthMangledID");
    ...
    objc_msgSend(MEMORY[0x24BE17640], "sideCarMangledID");
...
- (void)enablePushNotifications
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Enabling push topics registration%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (id)_newSyncDeadlineSourceWithName:(id)a3
{
  ...
  -[BRCAccountSessionFPFS defaultScheduler](self->_session, "defaultScheduler");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_unscheduleClientZone:(id)a3
{
  ...
  objc_msgSend(v3, "syncDeadlineSource");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "cancel");

  if (objc_msgSend(v3, "isPrivateZone"))
  {
    v17 = 0u;
    v18 = 0u;
    v15 = 0u;
    v16 = 0u;
    v14 = v3;
    objc_msgSend(v3, "asPrivateClientZone");
        ...
        do
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v21 = 2112;
            v22 = v12;
            _os_log_debug_impl(&dword_230455000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] unscheduling app library %@%@", buf, 0x16u);
          }
...
- (void)closeContainers
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx shutting down periodic metadata sync%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_33(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 72), "setEnabledTopics:ignoredTopics:opportunisticTopics:", MEMORY[0x24BDBD1A8], MEMORY[0x24BDBD1A8], MEMORY[0x24BDBD1A8]);
...
- (void)setup
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx loading containers%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)schedulePeriodicSyncInGroup:(id)a3 completion:(id)a4
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "brc_errorOperationAlreadyRunning:", CFSTR("Periodic Sync"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v7[2](v7, v9);
...
- (void)resume
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Sync: resuming sync%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)scheduleSyncUpForSideCar
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] marking side-car needs-sync-up%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_syncScheduleForContainersMetadata
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx scheduling container-metadata sync%@");
  OUTLINED_FUNCTION_0();
}
...
void __59__BRCContainerScheduler__syncScheduleForContainersMetadata__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  *(_QWORD *)(v6 + 104) = 0;
  ...
  if (v8)
  {
    ...
    v11 = (void *)objc_msgSend(v10, "initWithZoneName:ownerName:", *MEMORY[0x24BE17540], *MEMORY[0x24BDB8E88]);
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v42 = 2112;
      v43 = v17;
      _os_log_debug_impl(&dword_230455000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx resetting container-metadata: %s%@", buf, 0x20u);
    }

    if (v8 >= 2)
    {
      objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 8), "enumerateAppLibraries:", &__block_literal_global_22);
      v9 |= 1u;
    }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v42 = 2112;
    v43 = v20;
    _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] Container metadata sync state (%@) -> (%@)%@", buf, 0x20u);
...
- (void)_syncScheduleForSharedDatabase
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx scheduling shared-db sync%@");
  OUTLINED_FUNCTION_0();
}
  ...
  *(_QWORD *)(v7 + 152) = 0;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)&v16[4] = v15;
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished sharedb sync down with more coming: %s, error %@%@", v16, 0x20u);
  }
...
- (void)_syncScheduleForZoneHealth
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx scheduling zone-health sync%@");
  OUTLINED_FUNCTION_0();
}
  ...
  *(_QWORD *)(v7 + 192) = 0;
  ...
  if (objc_msgSend(v5, "brc_containerResetErrorForSharedZone:resetReason:", 0, &v32))
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v38 = v17;
      _os_log_impl(&dword_230455000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] Resetting zone health%@", buf, 0xCu);
    }

    v19 = objc_alloc(MEMORY[0x24BE17640]);
    v20 = (void *)objc_msgSend(v19, "initWithZoneName:ownerName:", *MEMORY[0x24BE175C0], *MEMORY[0x24BDB8E88]);
...
- (void)_syncScheduleForSideCar
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx scheduling side-car sync%@");
  OUTLINED_FUNCTION_0();
}
...
void __48__BRCContainerScheduler__syncScheduleForSideCar__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  *(_QWORD *)(v7 + 248) = 0;
  ...
  {
    v10 = objc_alloc(MEMORY[0x24BE17640]);
    v11 = (void *)objc_msgSend(v10, "initWithZoneName:ownerName:", *MEMORY[0x24BE17900], *MEMORY[0x24BDB8E88]);
    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 8), "clientZoneByMangledID:", v11);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v13 = objc_msgSend(v12, "enhancedDrivePrivacyEnabled");
...
uint64_t __48__BRCContainerScheduler__syncScheduleForSideCar__block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    v6 = 138412290;
    v7 = v2;
    _os_log_impl(&dword_230455000, v3, OS_LOG_TYPE_DEFAULT, "[WARNING] Resetting side car zone%@", (uint8_t *)&v6, 0xCu);
  }
...
- (void)dumpToContext:(id)a3 includeAllItems:(BOOL)a4 db:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v10, "isNetworkReachable") & 1) != 0)
  {
    v79 = CFSTR("online");
  }
  else
  ...
  if ((objc_msgSend(v10, "isPowerOK") & 1) != 0)
  {
    v78 = CFSTR("healthy");
  }
  else
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = objc_msgSend(v10, "hasEnoughSpaceForDevice:", objc_msgSend(v11, "deviceID"));
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = objc_msgSend(v14, "isCellularEnabled");
  ...
  v73 = (void *)v9;
  v80 = (void *)objc_msgSend(v8, "fetchObjectOfClass:sql:", objc_opt_class(), CFSTR("SELECT COUNT(*) from server_items"));
  v76 = (void *)objc_msgSend(v8, "fetchObjectOfClass:sql:", objc_opt_class(), CFSTR("SELECT COUNT(*) from client_items"));
  v72 = (unint64_t)objc_msgSend(v76, "unsignedLongLongValue") > 0x3E8
     || (unint64_t)objc_msgSend(v80, "unsignedLongLongValue") >= 0x3E9;
  -[BRCAccountSessionFPFS volume](self->_session, "volume");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "fsTypeName");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "uppercaseString");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "highlightedString:type:", v18, 7);
  v19 = objc_claimAutoreleasedReturnValue();

  v71 = (void *)v19;
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ (%@)"), v13, v19);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[NSData description](v21->_pushToken, "description");
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v24 = v23;
  v70 = v8;
  if (v23)
  ...
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "quotaAvailableForOwner:", *MEMORY[0x24BDB8E88]);
  ...
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ network: %@"), v79);
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ disk:    %@"), v20);
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ power:   %@"), v78);
  v29 = -[BRCAccountSessionFPFS hasOptimizeStorageEnabled](self->_session, "hasOptimizeStorageEnabled");
  v30 = "disabled";
  if (v29)
    v30 = "enabled";
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ optimize storage: %s"), v30);
  objc_msgSend(v28, "fp_obfuscatedFilename");
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ device name:   %@"), v31);

  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ cellular: %@"), v77);
  objc_msgSend(v7, "popIndentation");
  objc_msgSend(v7, "writeLineWithFormat:", &stru_24FE4A790);
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("scheduler"));
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("-----------------------------------------------------"));
  objc_msgSend(v7, "pushIndentation");
  +[BRCDumpContext stringFromCount:context:](BRCDumpContext, "stringFromCount:context:", objc_msgSend(v76, "unsignedLongLongValue"), v7);
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  +[BRCDumpContext stringFromCount:context:](BRCDumpContext, "stringFromCount:context:", objc_msgSend(v80, "unsignedLongLongValue"), v7);
  v33 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ items:                 client:%@, server: %@"), v32, v33);
  ...
  if (v72)
  {
    ...
    objc_msgSend(v7, "writeLineWithFormat:", CFSTR("                         warning: %@"), v34);

  }
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ push environment:      %@"), v75);
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ push token:            %@"), v74);
  -[BRCSyncBudgetThrottle debugDescriptionWithDefaults:](v21->_syncUpBudget, "debugDescriptionWithDefaults:", v73);
  v35 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ global sync up budget: %@"), v35);

  -[BRCOperationSubclass descriptionWithContext:](v21->_periodicSyncOperation, "descriptionWithContext:", v7);
  v36 = objc_claimAutoreleasedReturnValue();
  v37 = (void *)v36;
  v38 = CFSTR("idle");
  if (v36)
    v38 = (const __CFString *)v36;
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ periodic sync:         %@"), v38);

  if (v26)
  {
    +[BRCDumpContext stringFromByteCount:context:](BRCDumpContext, "stringFromByteCount:context:", objc_msgSend(v26, "longLongValue"), v7);
    v39 = (void *)objc_claimAutoreleasedReturnValue();
    -[BRCAccountSessionFPFS fsUploader](self->_session, "fsUploader");
    v40 = (void *)objc_claimAutoreleasedReturnValue();
    v41 = objc_msgSend(v40, "isDefaultOwnerOutOfQuota");
    v42 = CFSTR(" [pending-quota]");
    if (!v41)
      v42 = &stru_24FE4A790;
    objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ available quota:       %@%@"), v39, v42);

  }
  v43 = brc_current_date_nsec();
  v44 = v28;
  ...
  -[BRCOperationSubclass descriptionWithContext:](v21->_containerMetadataSyncOperation, "descriptionWithContext:", v7);
  ...
  if (v46)
    ...
    v48 = &stru_24FE4A790;
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ container-metadata:    %@ %@"), v45, v48);

  -[BRCContainerScheduler _printSyncErrorIfNecessaryWithThrottle:context:error:now:](v21, "_printSyncErrorIfNecessaryWithThrottle:context:error:now:", v21->_containerMetadataSyncDownThrottle, v7, v21->_lastContainerMetadataSyncDownError, v43);
  -[BRCContainerScheduler _printSyncErrorIfNecessaryWithThrottle:context:error:now:](v21, "_printSyncErrorIfNecessaryWithThrottle:context:error:now:", v21->_containerMetadataSyncUpThrottle, v7, v21->_lastContainerMetadataSyncUpError, v43);
  ...
  -[BRCOperationSubclass descriptionWithContext:](v21->_sharedDatabaseSyncOperation, "descriptionWithContext:", v7);
  ...
  if (v50)
    ...
    v52 = &stru_24FE4A790;
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ sharedb:               %@ %@"), v49, v52);

  -[BRCContainerScheduler _printSyncErrorIfNecessaryWithThrottle:context:error:now:](v21, "_printSyncErrorIfNecessaryWithThrottle:context:error:now:", v21->_sharedDatabaseSyncDownThrottle, v7, v21->_lastSharedDatabaseSyncDownError, v43);
  ...
  -[BRCOperationSubclass descriptionWithContext:](v21->_zoneHealthSyncOperation, "descriptionWithContext:", v7);
  ...
  if (v54)
    ...
    v56 = &stru_24FE4A790;
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ zone-health:           %@ %@"), v53, v56);

  -[BRCContainerScheduler _printSyncErrorIfNecessaryWithThrottle:context:error:now:](v21, "_printSyncErrorIfNecessaryWithThrottle:context:error:now:", v21->_zoneHealthSyncDownThrottle, v7, v21->_lastZoneHealthSyncDownError, v43);
  -[BRCContainerScheduler _printSyncErrorIfNecessaryWithThrottle:context:error:now:](v21, "_printSyncErrorIfNecessaryWithThrottle:context:error:now:", v21->_zoneHealthSyncUpThrottle, v7, v21->_lastZoneHealthSyncUpError, v43);
  ...
  -[BRCOperationSubclass descriptionWithContext:](v21->_sideCarSyncOperation, "descriptionWithContext:", v7);
  v58 = objc_claimAutoreleasedReturnValue();
  v59 = (void *)v58;
  if (v58)
    v60 = (const __CFString *)v58;
  else
    v60 = &stru_24FE4A790;
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ side-car:              %@ %@"), v57, v60);

  -[BRCContainerScheduler _printSyncErrorIfNecessaryWithThrottle:context:error:now:](v21, "_printSyncErrorIfNecessaryWithThrottle:context:error:now:", v21->_sideCarSyncDownThrottle, v7, v21->_lastSideCarSyncDownError, v43);
  -[BRCContainerScheduler _printSyncErrorIfNecessaryWithThrottle:context:error:now:](v21, "_printSyncErrorIfNecessaryWithThrottle:context:error:now:", v21->_sideCarSyncUpThrottle, v7, v21->_lastSideCarSyncUpError, v43);
  ...
  if (migrateZonePCSOperation)
  {
    ...
    objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ pcs-migration:         %@"), v62);

  }
  else
  {
    v63 = -[BRCAccountSessionFPFS PCSMigrationComplete](self->_session, "PCSMigrationComplete");
    v64 = CFSTR("unfinished");
    if (v63)
      v64 = CFSTR("complete");
    objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ pcs-migration:         %@"), v64);
  }
  v81 = 0;
  -[BRCAccountSessionFPFS fetchAccountWaitOperationWithAccountReady:](self->_session, "fetchAccountWaitOperationWithAccountReady:", &v81);
  v65 = (void *)objc_claimAutoreleasedReturnValue();
  v66 = v65;
  if (v65)
  {
    v67 = v71;
    if ((objc_msgSend(v65, "isFinished") & 1) == 0)
    {
      objc_msgSend(v66, "descriptionWithContext:", v7);
      v68 = objc_claimAutoreleasedReturnValue();
LABEL_67:
      v69 = (void *)v68;
      objc_msgSend(v7, "writeLineWithFormat:", CFSTR("+ account: %@"), v68);
...
- (void)receivedUpdatedZoneHealthServerChangeToken:(id)a3 requestID:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated zone health sync token:%@ requestID:%lld%@", (uint8_t *)&v10, 0x20u);
...
- (void)finishedZoneHealthSyncDownWithRequestID:(unint64_t)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v15 = 2112;
    v16 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Completed zone health sync requestID:%lld error:%@%@", buf, 0x20u);
  }
  ...
  if (!v6)
  {
    ...
    v10[4] = a3;
    -[BRCAccountSessionFPFS enumeratePrivateClientZones:](session, "enumeratePrivateClientZones:", v10);
...
- (void)receivedUpdatedSideCarServerChangeToken:(id)a3 requestID:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated side car sync token:%@ requestID:%lld%@", (uint8_t *)&v10, 0x20u);
...
- (void)_scheduleCrossZoneMovePCSPrep
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx starting cross zone move migration PCS prep%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)syncContextDidBecomeBackground:(id)a3
{
  ...
  if (syncContextDidBecomeBackground____personaOnceToken != -1)
    dispatch_once(&syncContextDidBecomeBackground____personaOnceToken, &__block_literal_global_185);
...
- (void)connection:(id)a3 didReceiveToken:(id)a4 forTopic:(id)a5 identifier:(id)a6
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v23 = 2112;
    v24 = v12;
    _os_log_debug_impl(&dword_230455000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] received %@ push token %@ for %@:%@%@", (uint8_t *)&v15, 0x34u);
  }
...
- (void)_connection:(id)a3 didReceiveIncomingMessage:(id)a4
{
  ...
  v79 = v6;
  v77 = session;
  objc_msgSend(CFSTR("com.apple.icloud-container."), "stringByAppendingString:", *MEMORY[0x24BE174D8]);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((session & 1) != 0)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        ...
        _os_log_fault_impl(&dword_230455000, v23, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid push payload[%@] %@%@", buf, 0x20u);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[BRCAccountSessionFPFS cachedCurrentUserRecordName](v77, "cachedCurrentUserRecordName");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      if (v26 && -[NSObject isEqualToString:](v22, "isEqualToString:", v26))
      {
        v27 = (id)*MEMORY[0x24BDB8E88];

        v22 = v27;
      }
      v16 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithZoneName:ownerName:", v19, v22);
      v18 = v11;
...
LABEL_34:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    ...
    _os_log_fault_impl(&dword_230455000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid push topic '%s' (expected prefix '%s')%@", buf, 0x20u);
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&v95[12] = v54;
      ...
      v98 = 2112;
      v99 = v31;
      _os_log_debug_impl(&dword_230455000, v32, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx received a push in the %@ database for topic:'%@' payload:%@ token:%@ priority:%ld%@", buf, 0x48u);

    }
    kdebug_trace();
    objc_msgSend(MEMORY[0x24BDB9190], "br_syncDownPushTriggered");
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v29, "appLibraryOrZoneName");
    v34 = (void *)objc_claimAutoreleasedReturnValue();
    v35 = objc_msgSend(v34, "isEqualToString:", *MEMORY[0x24BE17540]);
    ...
    if (v35)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        *(_QWORD *)&buf[4] = v36;
        _os_log_impl(&dword_230455000, v37, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for the container-metadata zone%@", buf, 0xCu);
      }
    ...
    objc_msgSend(v29, "appLibraryOrZoneName");
    v40 = (void *)objc_claimAutoreleasedReturnValue();
    v41 = objc_msgSend(v40, "isEqualToString:", *MEMORY[0x24BE175C0]);
    ...
    if (v41)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        *(_QWORD *)&buf[4] = v42;
        _os_log_impl(&dword_230455000, v43, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for the zone-health zone%@", buf, 0xCu);
      }
    ...
    objc_msgSend(v29, "appLibraryOrZoneName");
    v44 = (void *)objc_claimAutoreleasedReturnValue();
    v45 = objc_msgSend(v44, "isEqualToString:", *MEMORY[0x24BE17900]);
    ...
    if (v45)
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        *(_QWORD *)&buf[4] = v46;
        _os_log_impl(&dword_230455000, v47, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for the side-car zone%@", buf, 0xCu);
      }
    ...
    *(_QWORD *)v95 = __Block_byref_object_dispose__17;
    -[BRCAccountSessionFPFS clientZoneByMangledID:](v78->_session, "clientZoneByMangledID:", v29);
    *(_QWORD *)&v95[8] = objc_claimAutoreleasedReturnValue();
    -[BRCAccountSessionFPFS appLibraryByMangledID:](v78->_session, "appLibraryByMangledID:", v29);
    ...
    if (*(_QWORD *)(*(_QWORD *)&buf[8] + 40))
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)v87 = 138412546;
        ...
        v89 = 2112;
        v90 = v50;
        _os_log_impl(&dword_230455000, v51, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for client zone %@%@", v87, 0x16u);
      }
    }
    else if (v48)
    {
      ...
      *(_QWORD *)(*(_QWORD *)&buf[8] + 40) = v57;
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)v87 = 138412802;
        ...
        v91 = 2112;
        v92 = v50;
        _os_log_impl(&dword_230455000, v51, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for app library %@ -> zone %@%@", v87, 0x20u);
    ...
    else
    {
      if ((objc_msgSend(v29, "isShared") & 1) != 0)
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)v87 = 138412546;
          ...
          v89 = 2112;
          v90 = v62;
          _os_log_impl(&dword_230455000, v63, OS_LOG_TYPE_DEFAULT, "[NOTICE] receiving a push for an unknown ID shared zone %@, creating the zone%@", v87, 0x16u);
        }

        -[BRCAccountSessionFPFS getOrCreateSharedZones:](v78->_session, "getOrCreateSharedZones:", v29);
      ...
      v65 = v78->_session;
      v66 = objc_alloc(MEMORY[0x24BE17640]);
      v67 = (void *)objc_msgSend(v66, "initWithZoneName:ownerName:", *MEMORY[0x24BE17550], 0);
      -[BRCAccountSessionFPFS clientZoneByMangledID:](v65, "clientZoneByMangledID:", v67);
      v68 = objc_claimAutoreleasedReturnValue();
      ...
      *(_QWORD *)(*(_QWORD *)&buf[8] + 40) = v68;
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)v87 = 138412546;
        ...
        v89 = 2112;
        v90 = v50;
        _os_log_impl(&dword_230455000, v51, OS_LOG_TYPE_DEFAULT, "[NOTICE] receiving a push for an unknown ID %@ -> com.apple.CloudDocs%@", v87, 0x16u);
      }
    }
...
void __63__BRCContainerScheduler__connection_didReceiveIncomingMessage___block_invoke(uint64_t a1)
{
  ...
  if (*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 64) + 8) + 40))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v20 = 2112;
      v21 = v3;
      _os_log_debug_impl(&dword_230455000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx scheduling sync down for client zone %@ because of a push%@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v17 = (uint64_t)v5;
      _os_log_impl(&dword_230455000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] no zone found, dropping the push%@", buf, 0xCu);
    }
...
void __59__BRCContainerScheduler_notifyAfterNextZoneHealthSyncDown___block_invoke(uint64_t a1)
{
  ...
  v6 = (id)MEMORY[0x2348BA0DC](*(_QWORD *)(a1 + 40));
...
- (void)initWithAccountSession:pushWorkloop:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Push notification source created in a disabled state%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __61__BRCContainerScheduler_initWithAccountSession_pushWorkloop___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Sync: no global budget anymore: %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx cancelling sideCarSyncSource%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx cancelling migrateZonePCSSource%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx cancelling zoneHealthSyncSource%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_4()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx cancelling sharedDatabaseSyncSource%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_5()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx cancelling containerMetadataSyncSource...%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_30_cold_1()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx cancelling periodicSyncOperation%@");
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_31_cold_1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] unscheduling client zone %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)schedulePeriodicSyncInGroup:completion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx Considering containers needing forced sync down%@");
  OUTLINED_FUNCTION_0();
}
...
void __64__BRCContainerScheduler_schedulePeriodicSyncInGroup_completion___block_invoke_cold_1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_5(&dword_230455000, v1, v2, "[ERROR] periodic sync failed %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)didInitialSyncDownForClientZone:.cold.1()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx just synced down the default container%@");
  OUTLINED_FUNCTION_0();
}
...
void __71__BRCContainerScheduler_scheduleSyncDownForContainerMetadataWithGroup___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] marking container-metadata needs-sync-down%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __70__BRCContainerScheduler_scheduleSyncDownForSharedDatabaseImmediately___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] scheduling sync for sharedb in %llus%@");
  OUTLINED_FUNCTION_0();
}
...
void __64__BRCContainerScheduler_scheduleSyncDownForZoneHealthWithGroup___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] scheduling sync for zone-health%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __61__BRCContainerScheduler_scheduleSyncDownForSideCarWithGroup___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] scheduling sync for side-car%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __47__BRCContainerScheduler_redoZonePCSPreperation__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] scheduling sync for zone-pcs%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __70__BRCContainerScheduler_didChangeSyncStatusForZoneHealthForContainer___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] marking zone-health needs-sync-up%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __77__BRCContainerScheduler_didChangeSyncStatusForContainerMetadataForContainer___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] marking container-metadata needs-sync-up%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)syncContextDidBecomeForeground:(uint64_t)a1 .cold.1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_5(&dword_230455000, v1, v2, "[ERROR] won't restore persona: %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)connection:(uint64_t)a1 didReceivePublicToken:.cold.1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] received public push token %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)_connection:(NSObject *)a3 didReceiveIncomingMessage:.cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  v12 = 2112;
  v13 = a2;
  _os_log_error_impl(&dword_230455000, a3, (os_log_type_t)0x90u, "[ERROR] unable to parse push for topic:'%@' payload:%@%@", (uint8_t *)&v8, 0x20u);
...
- (void)_connection:didReceiveIncomingMessage:.cold.2()
{
  ...
  OUTLINED_FUNCTION_9_3(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: invalid push ZoneOwnerID at payload[%@] %@%@", v2);
...
- (void)_connection:didReceiveIncomingMessage:.cold.3()
{
  ...
  v2 = 138412802;
  OUTLINED_FUNCTION_8_4();
  OUTLINED_FUNCTION_9_3(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: invalid push DatabaseScope at payload[%@] %@%@", v2);
  OUTLINED_FUNCTION_20();
}
...
- (void)_connection:didReceiveIncomingMessage:.cold.4()
{
  ...
  v2 = 138412802;
  OUTLINED_FUNCTION_8_4();
  OUTLINED_FUNCTION_9_3(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: invalid push ZoneIdentifier at payload[%@] %@%@", v2);
  OUTLINED_FUNCTION_20();
}
...
- (void)_connection:didReceiveIncomingMessage:.cold.5()
{
  ...
  v2 = 138412802;
  OUTLINED_FUNCTION_8_4();
  OUTLINED_FUNCTION_9_3(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: invalid push payload[%@] %@%@", v2);
  OUTLINED_FUNCTION_20();
}
...
void __63__BRCContainerScheduler__connection_didReceiveIncomingMessage___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_17_0(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Also scheduling a sync down on the private zone %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __62__BRCContainerScheduler_connection_didReceiveIncomingMessage___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: dropping push notification because we can't adopt persona%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
