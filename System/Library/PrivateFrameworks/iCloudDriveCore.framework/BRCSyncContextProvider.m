...
{
  return -[BRCSyncContextProvider _syncContextForContextIdentifier:isShared:createIfNeeded:](self, "_syncContextForContextIdentifier:isShared:createIfNeeded:", *MEMORY[0x24BE17540], 0, 1);
}

- (id)sharedMetadataSyncContext
{
  return -[BRCSyncContextProvider _syncContextForContextIdentifier:isShared:createIfNeeded:](self, "_syncContextForContextIdentifier:isShared:createIfNeeded:", *MEMORY[0x24BE17590], 1, 1);
}

- (id)zoneHealthSyncContext
{
  return -[BRCSyncContextProvider _syncContextForContextIdentifier:isShared:createIfNeeded:](self, "_syncContextForContextIdentifier:isShared:createIfNeeded:", *MEMORY[0x24BE175C0], 0, 1);
}

- (id)sideCarSyncContext
{
  return -[BRCSyncContextProvider _syncContextForContextIdentifier:isShared:createIfNeeded:](self, "_syncContextForContextIdentifier:isShared:createIfNeeded:", *MEMORY[0x24BE17900], 0, 1);
}
      ...
      do
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 134218498;
          ...
          v35 = 2112;
          v36 = v10;
          _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cancelling %@...%@", buf, 0x20u);
        }
      ...
      do
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 134218498;
          ...
          v35 = 2112;
          v36 = v17;
          _os_log_debug_impl(&dword_230455000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx closing %@...%@", buf, 0x20u);
        }
