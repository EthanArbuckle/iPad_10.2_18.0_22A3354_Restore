...
void __53___BRCOperation__scheduleExecutionWithPreviousError___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_debug_impl(&dword_230455000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx retrying %@%@", buf, 0x20u);
  }
...
void __22___BRCOperation_start__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_debug_impl(&dword_230455000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx starting with throttle %@%@", buf, 0x20u);
  }
...
void __22___BRCOperation_start__block_invoke_77(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_debug_impl(&dword_230455000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx starting %@%@", buf, 0x20u);
  }
...
LABEL_14:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)&location[4] = v17;
    ...
    v27 = 2112;
    v28 = v13;
    _os_log_debug_impl(&dword_230455000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] (%@) Queuing %@%@", location, 0x20u);
...
void __25___BRCOperation_schedule__block_invoke_cold_1(uint64_t *a1)
{
  ...
  v4 = v1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_3(&dword_230455000, v2, (uint64_t)v2, "[DEBUG] scheduling %@%@", (uint8_t *)&v3);
  OUTLINED_FUNCTION_0();
}
...
void __25___BRCOperation_schedule__block_invoke_cold_2(_QWORD *a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_5(&dword_230455000, v1, v2, "[ERROR] Operation %@ is missing syncContext%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
void __22___BRCOperation_start__block_invoke_77_cold_1(void *a1, uint64_t a2, uint64_t a3)
{
  ...
  OUTLINED_FUNCTION_3(&dword_230455000, v6, v4, "[DEBUG] Operation %@ cancelled before calling main%@", v5);
...
void __70___BRCOperation_addSubOperation_overrideContext_allowsCellularAccess___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: context%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __34___BRCOperation_cancelAfterDelay___block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v9 = 2112;
  v10 = a2;
  OUTLINED_FUNCTION_3(&dword_230455000, a3, v6, "[DEBUG] Timeout expired, cancelling operation %@%@", (uint8_t *)&v7);
