...
void __86__NSFileProviderManager_BRCAdditions__br_removeDomain_options_sync_completionHandler___block_invoke_6(_QWORD *a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
    {
      ...
      v15 = 2112;
      v16 = v8;
      _os_log_error_impl(&dword_230455000, v9, (os_log_type_t)0x90u, "[ERROR] couldn't remove domain %@: %@%@", (uint8_t *)&v11, 0x20u);
    }
  }
  else
  {
...
{
  return objc_msgSend(MEMORY[0x24BDC83F0], "importDomain:forProviderIdentifier:fromDirectoryAtURL:error:", a1[4], a1[5], a1[6], a2);
}
...
{
  return objc_msgSend(MEMORY[0x24BDC83F0], "importDomain:forProviderIdentifier:fromDirectoryAtURL:knownFolders:error:", a1[4], a1[5], a1[6], a1[7], a2);
}
...
{
  return objc_msgSend(MEMORY[0x24BDC83F0], "addDomain:forProviderIdentifier:error:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40), a2);
}
...
void __90__NSFileProviderManager_BRCAdditions___br_removeDomain_options_retries_completionHandler___block_invoke_2_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_230455000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Failed to adopt persona for _br_removeDomain retry%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void __86__NSFileProviderManager_BRCAdditions__br_removeDomain_options_sync_completionHandler___block_invoke_6_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(_QWORD *)&v3[14] = a2;
  OUTLINED_FUNCTION_1_0(&dword_230455000, a2, a3, "[DEBUG] Successfully removed domain %@%@", *(_QWORD *)v3, *(_QWORD *)&v3[8], *(_QWORD *)&v3[16]);
  OUTLINED_FUNCTION_0();
}
