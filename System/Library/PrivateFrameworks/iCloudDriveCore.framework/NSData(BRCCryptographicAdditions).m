...
+ (id)brc_generateSaltingKey
{
  ...
  v1 = (const __SecRandom *)*MEMORY[0x24BDE94B8];
...
+ (void)brc_generateSaltingKey
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_error_impl(&dword_230455000, log, (os_log_type_t)0x90u, "[ERROR] Can't generate salting key %{errno}d%@", (uint8_t *)v3, 0x12u);
}
