    ...
    if ((objc_msgSend(v3, "sharingOptions") & 0x48) == 0)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v29 = v7;
        _os_log_impl(&dword_230455000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] No share options set on an item which is clearly shared%@", buf, 0xCu);
      }
...
- (id)brc_collaborationIdentifierWithCachedCurrentUserRecordName:()BRCShareIDAdditions
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDB8E88]);
  ...
  if (v4)
  {
    v11 = v4;
LABEL_5:
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@_%@_%@"), v6, v7, v11);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    goto LABEL_6;
  }
  brc_bread_crumbs();
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v18 = 2112;
    v19 = v11;
    _os_log_impl(&dword_230455000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] No collaboration identifier can be computed yet for %@%@", buf, 0x16u);
  }
...
- (void)initShareIDWithItemID:()BRCShareIDAdditions zoneID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_fault_impl(&dword_230455000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: itemID %@ has no share name%@", v1, 0x16u);
}
...
+ (void)brc_fetchShareIDWithSharedItem:()BRCShareIDAdditions .cold.1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_230455000, v0, (os_log_type_t)0x90u, "[ERROR] Couldn't find root share for %@%@", v1, 0x16u);
}
