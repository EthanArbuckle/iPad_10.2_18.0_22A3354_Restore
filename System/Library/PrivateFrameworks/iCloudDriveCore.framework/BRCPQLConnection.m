  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      ...
      *(_QWORD *)((char *)&v23 + 2) = v10;
      ...
      v14 = 42;
LABEL_15:
      _os_log_error_impl(&dword_230455000, v13, (os_log_type_t)0x90u, v12, v21, v14);
    }
  }
  else
  {
...
void __60__BRCPQLConnection__setErrorHandlerWithDBCorruptionHandler___block_invoke_1()
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Sqlite database became corrupted, abort..."));
...
uint64_t __37__BRCPQLConnection__setLockedHandler__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v9 >= 60.0)
  {
    if (v7)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(on statement %@)"), v7);
    ...
    abc_report_panic_with_signature();
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ locked for more than 1 minute %@, aborting..."), v6, v16);
    v17 = objc_claimAutoreleasedReturnValue();
    brc_bread_crumbs();
  ...
  objc_msgSend(MEMORY[0x24BDD16A8], "stringWithFormat:", CFSTR("%@ has been locked for %f seconds: %@"), v6, *(_QWORD *)&v9, v8);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_230455000, v14, OS_LOG_TYPE_DEFAULT, "[WARNING] %@%@", buf, 0x16u);
    }
  }
...
void __56__BRCPQLConnection__registerStaticDBFunctionsWithError___block_invoke_6(uint64_t a1, sqlite3_context *a2, int a3, _QWORD *a4)
{
  ...
  v6 = (void *)objc_msgSend(MEMORY[0x24BDBCE50], "newFromSqliteValue:", *a4);
...
- (void)setProfilingEnabled:(BOOL)a3
{
  ...
  if (a3)
  {
    ...
    -[BRCPQLConnection setProfilingHook:](&v4, sel_setProfilingHook_, v5, v3.receiver, v3.super_class, self, BRCPQLConnection, MEMORY[0x24BDAC760], 3221225472, __40__BRCPQLConnection_setProfilingEnabled___block_invoke, &unk_24FE3F910, self, v6);
  }
  else
  {
    ...
    if (v8)
    {
      ...
      if (*(_BYTE *)(a1 + 40) || v12 < v10)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&v33[34] = 2112;
          *(_QWORD *)&v33[36] = v26;
          _os_log_impl(&dword_230455000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] %s %@:\n  binds:    %d\n  columns:  %d\n  rows:     %ld\n  vm steps: %d (max: %lu)\n  sql:      %s\n  %@%@", buf, 0x5Au);
    ...
    else
    {
      ...
      if (*(_BYTE *)(a1 + 40) || v12 < v10)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&v33[28] = 2112;
          *(_QWORD *)&v33[30] = v27;
          _os_log_impl(&dword_230455000, v17, OS_LOG_TYPE_DEFAULT, "[WARNING] %s %@:\n  binds:    %d\n  changes:  %lld\n  vm steps: %d (max: %lu)\n  sql:      %s\n  %@%@", buf, 0x54u);
    ...
    if (10 * v12 < v10)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_QWORD *)&v29[16] = v11;
        v30 = 2112;
        *(_QWORD *)v31 = v20;
        _os_log_fault_impl(&dword_230455000, v21, OS_LOG_TYPE_FAULT, "[CRIT] Significantly too slow SQL statement(vm steps: %u  max:%lu): %s%@", buf, 0x26u);
      }
      ...
      if (v11)
        ...
        v22 = "(null)";
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", v22, v25);
...
- (void)setProfilingHook:(id)a3
{
  ...
  v3 = a3;
  abc_report_panic_with_signature();
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("setting profiling hook is not supported on %@"), objc_opt_class());
  objc_claimAutoreleasedReturnValue();
  brc_bread_crumbs();
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  brc_default_log();
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v10 = 2112;
    v11 = v4;
    _os_log_fault_impl(&dword_230455000, v5, OS_LOG_TYPE_FAULT, "[CRIT] %@%@", buf, 0x16u);
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v16 = 2112;
      v17 = v8;
      _os_log_fault_impl(&dword_230455000, v9, OS_LOG_TYPE_FAULT, "[CRIT] error closing connection %@: %@%@", buf, 0x20u);
    }
...
- (void)brc_close
{
  ...
  {
    abc_report_panic_with_signature();
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("error closing connection %@: %@"), self, v5);
...
void __60__BRCPQLConnection__setErrorHandlerWithDBCorruptionHandler___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: Got really unexpected error: %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
void __37__BRCPQLConnection__setLockedHandler__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_registerStaticDBFunctionsWithError:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] _registerStaticDBFunctions failed with %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __56__BRCPQLConnection__registerStaticDBFunctionsWithError___block_invoke_37_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !set || [set isKindOfClass:[NSIndexSet class]]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)fetchWithSlowStatementRadar:sql:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] API MISUSE: you need to provide a radar%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)executeWithExpectedIndex:sql:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] API MISUSE: you need to an index to use%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_shouldFlushWithChangeCount:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _batchingPacer%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_validateIsRunningWithCorrectPersona
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Running on the connection with the wrong persona%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
