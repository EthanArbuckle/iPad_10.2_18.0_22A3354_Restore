...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync-up/container-metadata", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
void __65__BRCContainerMetadataSyncUpOperation_performAfterSavingRecords___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 2112;
    v20 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] completed sync up for %lu records: %@%@", (uint8_t *)&v15, 0x20u);
  }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 2112;
    v18 = v10;
    _os_log_impl(&dword_230455000, v11, OS_LOG_TYPE_DEFAULT, "[NOTICE] saved %lu containers metadata in the cloud%@", (uint8_t *)&v15, 0x16u);
  }
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_3(&dword_230455000, v0, (uint64_t)v0, "[DEBUG] ┏%llx Sync: syncing up container metadata%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)performAfterSavingRecords:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_230455000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] no records to save%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
- (void)performAfterSavingRecords:(NSObject *)a3 .cold.2(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, a3, v4, "[DEBUG] preparing to send %lu records%@", v5);
}
...
void __65__BRCContainerMetadataSyncUpOperation_performAfterSavingRecords___block_invoke_2_cold_1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, (uint64_t)v0, "[DEBUG] adding sub-operation to save the records: %@%@", v1);
  OUTLINED_FUNCTION_0();
}
