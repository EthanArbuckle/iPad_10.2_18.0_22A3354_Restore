...
uint64_t __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BE17300]);
...
LABEL_6:
  ...
  v13 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x24BDB8EA8]);
  ...
  if (objc_msgSend(v3, "code") == 21)
  {
    ...
    if (objc_msgSend(v16, "isEqualToString:", *MEMORY[0x24BDB8EE0]))
    {
...
uint64_t __40__NSError_BRCAdditions__brc_isRetriable__block_invoke(uint64_t a1, void *a2)
{
  ...
  if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD0B88]) & 1) != 0
    || (objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD1308]) & 1) != 0)
  {
LABEL_3:
    v4 = 1;
    goto LABEL_4;
  }
  if (!objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDB8EA8]))
  {
    if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BE17300]) & 1) != 0)
    {
LABEL_9:
      v4 = 0;
      goto LABEL_4;
    }
    if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BE17430]) & 1) == 0)
    {
      brc_bread_crumbs();
...
uint64_t __46__NSError_BRCAdditions__brc_isOutOfSpaceError__block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v2, "domain");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD0B88]);
  ...
  v7 = objc_msgSend(v6, "isEqualToString:", *MEMORY[0x24BDD1128]);
...
void __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Server container was reset, we need to reset ourselves%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Server change token expired, we need to reset ourselves%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Server container was reset, zone not found, we need to reset ourselves%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke_cold_4()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Server container was reset, user deleted zone, we need to reset ourselves%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __40__NSError_BRCAdditions__brc_isRetriable__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] unknown error domain: %@, we should retry%@");
  OUTLINED_FUNCTION_0();
}
