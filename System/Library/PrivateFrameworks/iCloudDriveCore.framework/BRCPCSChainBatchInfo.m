...
- (void)addFullyChainedRecordInfo:(id)a3
{
  ...
  if (v8 <= 8 && ((1 << v8) & 0x106) != 0)
  {
    ...
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithRecordType:recordID:", CFSTR("content"), v11);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413570;
    ...
    v71 = 2112;
    v72 = v14;
    _os_log_debug_impl(&dword_230455000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] PCS chaining %@ (st:%@, ct:%@) to %@ for op %@%@", buf, 0x3Eu);
  ...
  if (v21 > 0xA
    ...
    || (-[NSMutableDictionary objectForKeyedSubscript:](self->_halfChainedRecordMap, "objectForKeyedSubscript:", v20),
        ...
        !v23))
  {
    v23 = (void *)objc_msgSend(objc_alloc(*(Class *)(v9 + 472)), "initWithRecordType:recordID:", CFSTR("structure"), v20);
    objc_msgSend(v4, "structuralCKInfo");
...
LABEL_23:
  ...
  if ((-[NSMutableSet containsObject:](self->_alreadyHalfChainedRecords, "containsObject:", v33) & 1) == 0)
  {
    ...
    v34 = (void *)objc_msgSend(objc_alloc(*(Class *)(v9 + 472)), "initWithRecordType:recordID:", CFSTR("structure"), v33);
          ...
          if (!v28)
          {
            ...
            if (os_log_type_enabled(v31, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              v53 = v30;
              _os_log_fault_impl(&dword_230455000, v31, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: preppedRecord.protectionData%@", buf, 0xCu);
            }
    ...
    for (; v32 < objc_msgSend(v5, "count"); ++v32)
    {
      ...
      if (!v37)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v53 = v43;
          _os_log_fault_impl(&dword_230455000, v38, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: halfChainInfo != nil%@", buf, 0xCu);
        }
...
- (void)addFullyChainedRecordInfo:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: parentCKInfo%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)addFullyChainedRecordInfo:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: No parent item?!?!%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)addFullyChainedRecordInfo:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !_fullyChainRecordInfoMap[parentRecordID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_chainPreppedRecordToParent:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: unkown record type%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)chainPreparedRecordBatch:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: preppedRecords.count == 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)chainPreparedRecordBatch:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: j + _halfChainedRecordMap.count == preppedRecords.count%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)chainPreparedRecordBatch:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Received records from first PCS step: %@%@");
  OUTLINED_FUNCTION_0();
}
