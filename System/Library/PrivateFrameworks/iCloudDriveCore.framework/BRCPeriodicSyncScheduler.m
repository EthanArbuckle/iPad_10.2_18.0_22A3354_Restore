  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      v36 = 2112;
      v37 = v10;
      _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Creating %@%@", buf, 0x20u);
    }
    ...
    -[BRCAccountSessionFPFS personaIdentifier](v9->_session, "personaIdentifier");
...
- (void)_registerToNotifications
{
  ...
  objc_msgSend((id)*MEMORY[0x24BE17288], "br_libnotifyPerPersonaNotificationName:", self->_personaIdentifier);
    ...
    *(_BYTE *)(*(_QWORD *)(a1 + 32) + 35) = *(_BYTE *)(a1 + 40);
    ...
    if (v13 >= v14)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        v22 = 2112;
        v23 = v15;
        _os_log_debug_impl(&dword_230455000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Network disconnected for %.1f mins --> Assume missing push%@", (uint8_t *)&v18, 0x20u);
      }
...
LABEL_10:
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v17 = 2112;
        v18 = v10;
        _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - User did not use iCloud Drive for %.1f mins --> trigger periodic sync%@", buf, 0x20u);
      }
    }
...
- (void)_schedulePeriodicSyncRequest
{
    ...
    && !self->_periodicSyncRequestTimer)
  {
    ...
    objc_msgSend(v19, "br_maxWithComparator:", *MEMORY[0x24BE177E0]);
    ...
    {
      v23 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)self->_syncQueue);
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138413058;
        ...
        v44 = 2112;
        v45 = v34;
        _os_log_debug_impl(&dword_230455000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - scheduled _periodicSyncRequestTimer %@ in %llu sec%@", buf, 0x2Au);
      }
...
- (void)_cancelPeriodicSyncRequestScheduler
{
  ...
  if (self->_periodicSyncRequestTimer)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_debug_impl(&dword_230455000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - cancelling periodicSyncRequestTimer %@%@", (uint8_t *)&v7, 0x20u);
    }
...
- (void)_tiggerPeriodicSync
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_fault_impl(&dword_230455000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@: Periodic sync already running%@", v1, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
void __47__BRCPeriodicSyncScheduler__tiggerPeriodicSync__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x24BDB9190], "br_syncDownPeriodic");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4[0] = MEMORY[0x24BDAC760];
  v4[1] = 3221225472;
...
- (void)_periodicSyncCompletionWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - persist last periodic sync date: %@%@", buf, 0x20u);
  }
...
void __33__BRCPeriodicSyncScheduler_close__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] Failed to adopt persona: %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __34__BRCPeriodicSyncScheduler_resume__block_invoke_cold_1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(*(_QWORD *)a1 + 40);
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] Last periodic sync date: %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
void __34__BRCPeriodicSyncScheduler_resume__block_invoke_9_cold_1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(a1 + 32);
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] %@ - try trigger periodic sync on startup%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
void __79__BRCPeriodicSyncScheduler__appLibraryDidBoostForPresenterNotificationHandler___block_invoke_cold_1(_QWORD *a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] %@ - long time since last periodic sync --> trigger periodic sync%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)_periodicSyncCompletionWithError:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] Periodic sync failed with: %@%@");
  OUTLINED_FUNCTION_0();
}
