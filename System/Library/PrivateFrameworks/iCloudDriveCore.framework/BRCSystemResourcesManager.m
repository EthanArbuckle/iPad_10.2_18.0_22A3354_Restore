...
void __60__BRCSystemResourcesManager_addProcessMonitor_forProcessID___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17668]), "initForProcessID:observer:", *(unsigned int *)(a1 + 48), *(_QWORD *)(a1 + 40));
    if (v3)
    {
      v4 = v3;
...
- (void)reset
{
  ...
  OUTLINED_FUNCTION_0_1(&dword_230455000, v2, v3, "[DEBUG] [%@] has been reset%@", v4, v5, v6, v7, v8);
...
- (void)_initScreenLockManager
{
  ...
  objc_msgSend(MEMORY[0x24BE17690], "sharedScreenLockMonitor");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_initReachability
{
  ...
  objc_msgSend(MEMORY[0x24BE17678], "sharedReachabilityMonitor");
...
- (void)_setNetworkReachable:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315394;
    ...
    v20 = 2112;
    v21 = v5;
    _os_log_impl(&dword_230455000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] Network really becomes %sreachable%@", buf, 0x16u);
  }
  ...
  if (a3)
  {
    ...
    else
    {
      if (powerLevelOKTimer)
      {
        ...
        {
          ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v13);
      ...
      {
        v17 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)self->_notificationQueue);
        ...
        if (*MEMORY[0x24BE17840])
        {
          ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v20);
...
- (void)_initLowDiskManager
{
  ...
  v7 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x24BDACA20], 0, 0x1304uLL, (dispatch_queue_t)self->_notificationQueue);
...
void __48__BRCSystemResourcesManager__initLowDiskManager__block_invoke(uint64_t a1)
{
  ...
  if (!*(_QWORD *)(v3 + 128))
  {
    v4 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, *(dispatch_queue_t *)(v3 + 8));
    ...
    if (*MEMORY[0x24BE17840])
    {
      ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v12);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (*(_BYTE *)(a1 + 40) || has_enough_space == v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v27 = 2112;
      v28 = v10;
      _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] disk %@ has %senough space now%@", buf, 0x20u);
    }
...
- (void)_initLowMemory
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _memoryNotificationEventSource == NULL%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_didReceiveMemoryWarning
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Memory warning received%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)init
{
  ...
  v0 = (void *)objc_opt_class();
  v1 = OUTLINED_FUNCTION_0_3(v0);
  OUTLINED_FUNCTION_0_1(&dword_230455000, v2, v3, "[DEBUG] [%@] has been initialized%@", v4, v5, v6, v7, v8);
...
void __34__BRCSystemResourcesManager_close__block_invoke_cold_1()
{
  ...
  v0 = (void *)objc_opt_class();
  v1 = OUTLINED_FUNCTION_0_3(v0);
  OUTLINED_FUNCTION_0_1(&dword_230455000, v2, v3, "[DEBUG] [%@] has been invalidated%@", v4, v5, v6, v7, v8);
...
- (void)_setPowerLevel:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3(&dword_230455000, v0, (uint64_t)v0, "[DEBUG] Power level really becomes %s%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)addLowDiskObserver:forDevice:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: deviceID != 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __50__BRCSystemResourcesManager__initAppListObservers__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Received an app install notification%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
