    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          if ((objc_msgSend(v13, "isEqualToString:", CFSTR("com.apple.fpfs.fileid"), v23) & 1) == 0
            && (objc_msgSend(v13, "isEqualToString:", CFSTR("com.apple.clouddocs.private.share-bookmark#B")) & 1) == 0
            && (objc_msgSend(v13, "isEqualToString:", CFSTR("com.apple.clouddocs.private.trash-parent-bookmark#B")) & 1) == 0
            && (objc_msgSend(v13, "isEqualToString:", CFSTR("com.apple.finder.copy.preserveinbackups.com.apple.clouddocs.private.share-bookmark#N")) & 1) == 0&& (objc_msgSend(v13, "isEqualToString:", CFSTR("com.apple.finder.copy.preserveinbackups.com.apple.clouddocs.private.trash-parent-bookmark#N")) & 1) == 0&& (objc_msgSend(v13, "isEqualToString:", CFSTR("com.apple.fileprovider.trash-put-back#PN")) & 1) == 0)
          {
            objc_msgSend(v27, "setName:", v13);
            objc_msgSend(v8, "objectForKeyedSubscript:", v13);
            v14 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v27, "setValue:", v14);

            v15 = objc_alloc_init(MEMORY[0x24BE7AF00]);
            objc_msgSend(v27, "writeTo:", v15);
            if ((brc_xattr_flags_from_name((char *)objc_msgSend(objc_retainAutorelease(v13), "cStringUsingEncoding:", 4)) & 2) != 0)
            {
              if (!v28)
                v28 = objc_alloc_init(MEMORY[0x24BE7AF00]);
            ...
            else
            {
              v16 = v26;
              if (!v26)
                v16 = objc_alloc_init(MEMORY[0x24BE7AF00]);
              objc_msgSend(v15, "data");
              v17 = (void *)objc_claimAutoreleasedReturnValue();
              v26 = v16;
              v18 = v16;
            }
            objc_msgSend(v18, "writeData:forTag:", v17, 1);
...
+ (BOOL)loadXattrsFromFD:(int)a3 structuralBlob:(id *)a4 contentBlob:(id *)a5 localBlob:(id *)a6 withMaximumSize:(unint64_t)a7 error:(id *)a8
{
  ...
  if (!a4 || !v16)
    goto LABEL_6;
  v17 = objc_alloc_init(MEMORY[0x24BE7AF00]);
...
LABEL_6:
  ...
  if (a5 && v21)
  {
    v22 = objc_alloc_init(MEMORY[0x24BE7AF00]);
      ...
      for (i = 0; i != v8; ++i)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 136315650;
          ...
          v34 = 2112;
          v35 = v15;
          _os_log_debug_impl(&dword_230455000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] added xattr %s (%lld bytes)%@", buf, 0x20u);
        }
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_xattrs, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
