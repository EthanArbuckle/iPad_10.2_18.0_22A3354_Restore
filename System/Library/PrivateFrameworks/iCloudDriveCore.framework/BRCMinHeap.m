...
- (BRCMinHeap)init
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", "-[BRCMinHeap init]");
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: _getIndex(self, o) == nil%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: _array[index] == o%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
