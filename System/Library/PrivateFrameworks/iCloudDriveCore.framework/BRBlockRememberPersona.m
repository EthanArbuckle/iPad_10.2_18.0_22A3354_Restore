...
void ___BRBlockRememberPersona_block_invoke(uint64_t a1)
{
    ...
    || (v2 = *(id *)(a1 + 32)) == 0)
  {
    if (_block_invoke___personaOnceToken_2 != -1)
      dispatch_once(&_block_invoke___personaOnceToken_2, &__block_literal_global_180);
...
LABEL_9:
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, (os_log_type_t)0x90u))
      -[BRCContainerScheduler syncContextDidBecomeForeground:].cold.1((uint64_t)v10);
  ...
  if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v30 = 2112;
    v31 = v15;
    _os_log_error_impl(&dword_230455000, v16, (os_log_type_t)0x90u, "[ERROR] Can't adopt persona %@: %@%@", buf, 0x20u);
  }
...
void ___BRBlockRememberPersona_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Failed to adopt persona for block adoption%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
