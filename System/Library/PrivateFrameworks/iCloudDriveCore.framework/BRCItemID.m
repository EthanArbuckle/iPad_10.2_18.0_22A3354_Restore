...
- (id)contentsRecordIDInZoneID:(id)a3
{
  ...
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithRecordName:zoneID:", v6, v4);
  return v7;
}
...
{
  return -[BRCItemID directoryReferenceInZone:action:](self, "directoryReferenceInZone:action:", a3, *MEMORY[0x24BDB8F40]);
}
...
- (id)pcsChainDocumentStructureReferenceInZoneID:(id)a3
{
  ...
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithRecordName:zoneID:", v6, v4);
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9218]), "initWithRecordID:action:", v7, 0);
...
LABEL_22:
  v20 = objc_alloc(MEMORY[0x24BDB91E8]);
...
- (id)directoryReferenceInZone:(id)a3 action:(unint64_t)a4
{
  ...
  v9 = objc_alloc(MEMORY[0x24BDB91E8]);
  objc_msgSend(v6, "zoneID");
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  v11 = (void *)objc_msgSend(v9, "initWithRecordName:zoneID:", v8, v10);
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9218]), "initWithRecordID:action:", v11, a4);
...
- (id)itemUUIDString
{
  ...
  return (id)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithBytes:length:encoding:", v3, 36, 1);
}
...
- (id)zoneUniqueItemIDStringWithSession:(id)a3
{
  ...
  switch(self->_kind)
  {
    case 0u:
      ...
      v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithBytes:length:encoding:", v22, 36, 4);
      break;
    case 1u:
      if (!v6)
      {
...
- (NSString)itemIDString
{
  ...
  switch(self->_kind)
  {
    case 0u:
      ...
      v3 = (__CFString *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithBytes:length:encoding:", v9, 36, 4);
      return (NSString *)v3;
    case 1u:
    case 5u:
...
- (id)debugItemIDStringWithVerbose:(BOOL)a3
{
  ...
  switch(self->_kind)
  {
    case 0u:
      ...
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithBytes:length:encoding:", v10, v11, 4);
      goto LABEL_23;
    case 1u:
      v12 = BRCItemIDZoneRoot;
      goto LABEL_13;
...
+ (id)documentsItemIDWithAppLibraryRowID:(id)a3
{
  ...
  if (!v3 || (v4 = v3, !objc_msgSend(v3, "unsignedLongLongValue")))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("invalid library rowid"));
    v7 = objc_claimAutoreleasedReturnValue();
    brc_bread_crumbs();
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    brc_default_log();
...
+ (id)defaultDesktopItemID
{
  ...
  v2 = [BRCItemID alloc];
  return -[BRCItemID initWithUUIDString:](v2, "initWithUUIDString:", *MEMORY[0x24BE17560]);
}
...
+ (id)defaultDocumentsItemID
{
  ...
  v2 = [BRCItemID alloc];
  return -[BRCItemID initWithUUIDString:](v2, "initWithUUIDString:", *MEMORY[0x24BE17570]);
}
...
- (BRCItemID)initWithRootObject:(RootItemObject *)a3
{
  ...
  if (v4)
  {
    v4->_kind = a3->var0;
    var0 = a3->var0;
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", *(unsigned int *)(&a3->var0 + 1));
    v7 = objc_claimAutoreleasedReturnValue();
    v8 = 8;
    if (var0 == 5)
      v8 = 16;
...
+ (id)newFromSqliteValue:(sqlite3_value *)a3
{
  ...
  *(_QWORD *)&v21[13] = *MEMORY[0x24BDAC8D0];
  ...
  if (v4 != 4)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)v21 = v5;
      v21[2] = 2112;
      *(_QWORD *)&v21[3] = v11;
      _os_log_fault_impl(&dword_230455000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unmigrated? invalid BRCItemID (%@) - %d%@", (uint8_t *)&v18, 0x1Cu);
  ...
  if (v7 != 5)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
    {
      objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", v6, v13);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      v18 = 138412546;
      v19 = v17;
      v20 = 2112;
      *(_QWORD *)v21 = v14;
      _os_log_fault_impl(&dword_230455000, v15, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid BRCItemID (%@)%@", (uint8_t *)&v18, 0x16u);
...
+ (id)newFromSqliteStatement:(sqlite3_stmt *)a3 atIndex:(int)a4
{
  ...
  *(_QWORD *)&v21[13] = *MEMORY[0x24BDAC8D0];
  ...
  if (v6 != 4)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_FAULT))
    {
      objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", v11, v12);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      v18 = 138412802;
      v19 = v17;
      v20 = 1024;
      *(_DWORD *)v21 = v7;
      v21[2] = 2112;
      *(_QWORD *)&v21[3] = v13;
      _os_log_fault_impl(&dword_230455000, v14, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unmigrated? invalid BRCItemID (%@) - %d%@", (uint8_t *)&v18, 0x1Cu);
  ...
  if (v9 != 5)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_FAULT))
    {
      objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", v8, v15);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      v18 = 138412546;
      v19 = v16;
      v20 = 2112;
      *(_QWORD *)v21 = v13;
      _os_log_fault_impl(&dword_230455000, v14, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid BRCItemID (%@)%@", (uint8_t *)&v18, 0x16u);
...
+ (id)parseMangledItemIDString:(id)a3 mangledID:(id *)a4 etag:(id *)a5 session:(id)a6
{
  ...
  if (objc_msgSend(v11, "count") == 3)
  {
    ...
    v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithMangledString:", v14);
    if (a4)
...
LABEL_14:
  ...
  if (objc_msgSend(v11, "count") == 4)
  {
    ...
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    v22 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithZoneName:ownerName:", v21, v18);
    v17 = -[BRCItemID initWithUUIDString:]([BRCItemID alloc], "initWithUUIDString:", v15);
    if (a4)
...
+ (BOOL)migrateItemIDsToVersion5WithDB:(id)a3 serverTruth:(BOOL)a4
{
  ...
  objc_msgSend(MEMORY[0x24BEDD640], "nameWithString:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BEDD640], "nameWithString:", v7);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v5, "fetch:", CFSTR("SELECT rowid FROM %@ WHERE zone_owner != %@"), v9, *MEMORY[0x24BDB8E88]);
  if (objc_msgSend(v10, "next"))
  {
    ...
    do
    {
      ...
      if (!v25)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v27 = v16;
          _os_log_fault_impl(&dword_230455000, v17, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rio.app_lib_rowid%@", buf, 0xCu);
        }
      ...
      if ((v11 & 1) != 0)
      {
        ...
        v14 = v12;
        v23 = v14;
        v15 = (void *)MEMORY[0x2348BA0DC](v22);
  ...
  if (!objc_msgSend(v5, "execute:", CFSTR("UPDATE %@ SET item_id = call_block(%@, item_id, zone_rowid) WHERE item_type = 3"), v8, &__block_literal_global_34)|| !objc_msgSend(v5, "execute:", CFSTR("UPDATE %@ SET item_parent_id = call_block(%@, zone_rowid) WHERE item_parent_id = \"root\"), v8, &__block_literal_global_46)|| !objc_msgSend(v5, "execute:", CFSTR("UPDATE %@ SET item_parent_id = call_block(%@, zone_rowid) WHERE item_parent_id = \"documents\"), v8, &__block_literal_global_48_0))
  {
LABEL_26:
    v19 = 0;
    goto LABEL_27;
...
+ (BOOL)migrateItemIDsToVersion11WithDB:(id)a3 serverTruth:(BOOL)a4
{
  ...
  objc_msgSend(MEMORY[0x24BEDD640], "nameWithString:", v7);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)objc_msgSend(v5, "fetch:", CFSTR("SELECT rowid FROM %@ WHERE zone_owner != %@"), v17, *MEMORY[0x24BDB8E88]);
  if (objc_msgSend(v9, "next"))
  {
    ...
    do
    {
      ...
      if ((v10 & 1) != 0)
      {
        ...
        v14 = v11;
        v19 = v14;
        v15 = (void *)MEMORY[0x2348BA0DC](v18);
...
- (void)appLibraryRowID
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self.isNonDesktopRoot || self.isDocumentsFolder%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)sharedZoneRowID
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self.isSharedZoneRoot%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)zoneUniqueItemIDStringWithSession:.cold.1()
{
  ...
  OUTLINED_FUNCTION_10_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: unknown itemID type %d%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)zoneUniqueItemIDStringWithSession:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: sharedZone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)debugItemIDStringWithVerbose:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: we should not have alias or share uuid types anymores%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
+ (void)documentsItemIDWithAppLibraryRowID:(NSObject *)a3 .cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, a3, v5, "[CRIT] %@%@", v6);
...
- (void)isEqualToItemID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: we should not have alias or shared uuid types anymores%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)initWithString:libraryRowID:sharedZoneRowID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: libraryRowID || sharedZoneRowID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)initWithUUIDString:(NSObject *)a3 .cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, a3, v4, "[CRIT] UNREACHABLE: invalid UUID: %s%@", v5);
...
- (void)_initAsLibraryRootWithAppLibraryRowID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: can't initialize library root with invalid library rowid %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)_initAsZoneRootWithZoneRowID:.cold.1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: can't initialize shared zone root with invalid zone rowid %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)initAsDocumentsWithAppLibraryRowID:.cold.1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: can't initialize document with invalid library rowid %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)initWithRootObject:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: object->item_code == BRCItemIDCodeDocuments || object->item_code == BRCItemIDCodeZoneRoot || object->item_code == BRCItemIDCodeSharedZoneRoot%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
+ (void)appLibraryRowIDFromRootOrDocumentsSQLiteValue:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: appLibraryRowID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)initWithCoder:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: decoding an unknown kind of itemid%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)encodeWithCoder:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: encoding an item id with an unknown kind%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)sqliteBind:index:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: unknown itemID kind%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)sqliteBind:index:.cold.4()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: rio.zone_rowid%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
+ (void)parseMangledItemIDString:(NSObject *)a3 mangledID:etag:session:.cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  objc_msgSend(objc_retainAutorelease(a1), "UTF8String");
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, a3, v4, "[CRIT] UNREACHABLE: unparsable mangled itemID: %s%@", v5);
  OUTLINED_FUNCTION_2_0();
}
...
void __56__BRCItemID_migrateItemIDsToVersion5WithDB_serverTruth___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Invalid Shared ItemID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __56__BRCItemID_migrateItemIDsToVersion5WithDB_serverTruth___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: len == sizeof(uuid_t)%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __56__BRCItemID_migrateItemIDsToVersion8WithDB_serverTruth___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Invalid Alias ItemID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __56__BRCItemID_migrateItemIDsToVersion8WithDB_serverTruth___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: len == sizeof(_UUIDItemObject_OLD)%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __57__BRCItemID_migrateItemIDsToVersion11WithDB_serverTruth___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: p->item_code == _UNUSED_BRCItemIDCodeSharedUUID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __57__BRCItemID_migrateItemIDsToVersion11WithDB_serverTruth___block_invoke_61_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: len == sizeof(_UUIDItemObject_OLD) && ((_UUIDItemObject_OLD*)blob)->item_code == BRCItemIDCodeSharedZoneRoot%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
