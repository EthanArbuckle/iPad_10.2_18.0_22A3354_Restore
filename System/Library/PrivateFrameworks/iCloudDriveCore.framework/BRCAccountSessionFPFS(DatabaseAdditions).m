...
- (void)_getFPFSMigrationStatus:()DatabaseAdditions withError:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_230455000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: _clientState%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
- (void)dumpFPFSMigrationStatusToFileHandle:()DatabaseAdditions tracker:includeNonMigratedItems:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx dumping FPFS migration status%@");
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_9(&dword_230455000, a2, a3, "[ERROR] Command is not supported for FPFS databases%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
- (void)dumpDatabaseToFileHandle:()DatabaseAdditions zoneName:includeAllItems:verbose:tracker:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx dumping database%@");
  OUTLINED_FUNCTION_0();
}
