...
- (NSSet)effectedRecordNames
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[BRCProblemReport _effectiveProblemType](self, "_effectiveProblemType"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_addProblem:(id)a3
{
  ...
  problems = self->_problems;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", objc_msgSend(v10, "type"));
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] UNREACHABLE: unknown effective problem type%@", a5, a6, a7, a8, 2u);
}
