...
void __68__BRCSaltingBatchOperation__createCKOperationForRecords_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6 && (objc_msgSend(v6, "brc_isCloudKitAtomicFailure") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
    {
      ...
      v14 = 2112;
      v15 = v8;
      _os_log_error_impl(&dword_230455000, v9, (os_log_type_t)0x90u, "[ERROR] Salting operation for recordID %@ with error %@%@", (uint8_t *)&v10, 0x20u);
    }
...
- (id)_createStructureRecordWithRecordID:(id)a3 serverItem:(id)a4
{
  ...
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithRecordType:recordID:", CFSTR("structure"), v5);
    objc_msgSend(v6, "st");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_createStructureRecordForParentItem
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_parentSaltingState);
  ...
  if (self->_parentPluginFields)
  {
    ...
    {
      v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", -[NSDictionary count](self->_parentPluginFields, "count"));
    }
...
void __56__BRCSaltingBatchOperation__buildRecordsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)(v7 + 560) = v6;
  ...
  if (v9 >= 3)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v48 = 2112;
      v49 = v10;
      _os_log_fault_impl(&dword_230455000, v11, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: operation %@ is trying to salt record %@ while it is in %@ state%@", buf, 0x2Au);
  ...
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", *(_QWORD *)(*(_QWORD *)(a1 + 32) + 504));
...
LABEL_14:
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v48 = 2112;
    v49 = v26;
    _os_log_debug_impl(&dword_230455000, v27, OS_LOG_TYPE_DEBUG, "[DEBUG] Moving salting parent record ID %@ from %@ to %@%@", buf, 0x2Au);
  }
...
- (void)initWithParentItem:sessionContext:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_debug_impl(&dword_230455000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Salting batch operation is not allowed on %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
- (void)_createStructureRecordWithRecordID:serverItem:.cold.1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  _os_log_fault_impl(&dword_230455000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: We can't salt alias items %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
- (void)_saltChildRecordFields:serverItem:basehashSalt:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: basehashSalt%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_createStructureRecordForParentItem
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _appLibraryRootRecord != nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __32__BRCSaltingBatchOperation_main__block_invoke_2_cold_1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_230455000, v0, (os_log_type_t)0x90u, "[ERROR] failed sending salted records - %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_0();
}
