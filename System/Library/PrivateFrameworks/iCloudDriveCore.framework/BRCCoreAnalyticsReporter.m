...
+ (void)uploadMetricsReport:(id)a3
{
  ...
  if (+[BRCAnalyticsReporter isTelemetryReportingEnabled](BRCAnalyticsReporter, "isTelemetryReportingEnabled"))
  {
      ...
      && (v42 & 1) == 0)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", objc_msgSend(v4, "clientTruthTotalItemsCount"));
  ...
  if (+[BRCAnalyticsReporter isTelemetryReportingEnabled](BRCAnalyticsReporter, "isTelemetryReportingEnabled"))
  {
    ...
    switch(objc_msgSend(v19, "telemetrySchema"))
    {
      case 2u:
        ...
        {
          objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%d"), objc_msgSend(v19, "magnitudeInt"));
          v5 = (void *)objc_claimAutoreleasedReturnValue();
