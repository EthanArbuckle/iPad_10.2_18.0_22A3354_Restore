...
- (BRCTransferStream)initWithSyncContext:(id)a3 name:(id)a4 scheduler:(id)a5 maxCountOfBatchesInFlight:(unint64_t)a6
{
  ...
  if (v14)
  {
    ...
    v15->_session = (BRCAccountSessionFPFS *)(id)objc_msgSend(v11, "session");
    if (!v13)
    {
      abc_report_panic_with_signature();
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("scheduler is nil"));
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_FAULT))
        __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_107_cold_1(v26, (uint64_t)v27, v28);
...
- (void)endSchedulingMultipleItemsInteractively
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _multipleItemsInteractiveSchedulingCount >= 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)forceSchedulingPendingInteractiveTransfers
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] ┏%llx force scheduling interactive transfers%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
  ...
  if (v7 >= v10)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v43 = v26;
      _os_log_impl(&dword_230455000, v27, OS_LOG_TYPE_DEFAULT, "[WARNING] We have way too many operations in flight.  Waiting for cancelled operations to finish cancelling%@", buf, 0xCu);
    }
    goto LABEL_41;
  }
...
- (void)cancelTransferID:(id)a3 operationID:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v25 = 2112;
    v26 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cancelling entry %@ in %@%@", buf, 0x2Au);
...
void __63__BRCTransferStream_forceSchedulingPendingInteractiveTransfers__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Force scheduling a new high priority batch%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __63__BRCTransferStream_forceSchedulingPendingInteractiveTransfers__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] waiting for the next scheduling to finish%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __63__BRCTransferStream_forceSchedulingPendingInteractiveTransfers__block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: oldestBatchOperation%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __63__BRCTransferStream_forceSchedulingPendingInteractiveTransfers__block_invoke_cold_4(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] cancelling oldest batch (%@)%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)_addBatchOperation:(uint64_t)a1 .cold.1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] adding operation %@ to the transfer stream%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)_addBatchOperation:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: operation%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __40__BRCTransferStream__addBatchOperation___block_invoke_3_cold_1(uint64_t a1, NSObject *a2, double a3)
{
  ...
  v5 = 2112;
  v6 = a1;
  _os_log_debug_impl(&dword_230455000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] Transfer stream backing off %.03fs%@", (uint8_t *)&v3, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
- (void)addBatchOperation:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _isWaitingForTransferBatch%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
