...
- (id)description
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("<%p>: %@:%@ %@:%lld %@:%@"), self, CFSTR("serverChangeToken"), self->_serverChangeToken, CFSTR("requestID"), self->_requestID, CFSTR("lastSyncDate"), v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
