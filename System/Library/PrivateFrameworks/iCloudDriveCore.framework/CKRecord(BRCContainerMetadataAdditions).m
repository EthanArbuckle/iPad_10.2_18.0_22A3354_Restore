...
+ (id)brc_containerMetadataRecordWithContainer:()BRCContainerMetadataAdditions
{
  ...
  if (v4)
  {
    ...
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithRecordType:recordID:", CFSTR("AppContainer"), v8);
...
+ (void)brc_containerMetadataRecordWithContainer:()BRCContainerMetadataAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: dataRepresentation != nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
