...
{
  -[BRCFSSchedulerBase rescheduleSuspendedJobsMatching:inState:](self, "rescheduleSuspendedJobsMatching:inState:", 0, 15);
}
...
- (void)monitorFaultingForZone:(id)a3
{
  ...
  if ((-[NSMutableSet containsObject:](self->_clientZonesWatchingFaults, "containsObject:", v4) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
      -[BRCApplyScheduler(FPFSAdditions) monitorFaultingForZone:].cold.1();
...
- (void)stopMonitoringFaultingForZone:(id)a3
{
  ...
  v7 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    -[BRCApplyScheduler(FPFSAdditions) stopMonitoringFaultingForZone:].cold.1();
...
- (BRCApplyScheduler)initWithAccountSession:(id)a3
{
  ...
  v3 = -[BRCFSSchedulerBase initWithSession:name:tableName:](&v7, sel_initWithSession_name_tableName_, a3, CFSTR("Apply Changes"), CFSTR("client_unapplied_table"));
  if (v3)
  {
...
- (void)describeInBuffer:(id)a3 aggregateOfJobsMatching:(id)a4 context:(id)a5
{
  ...
  LODWORD(clientZonesWatchingFaults) = -[NSMutableSet containsObject:](clientZonesWatchingFaults, "containsObject:", v24);
...
- (void)_setState:(int)a3 andApplyKind:(unsigned int)a4 forJobID:(id)a5
{
  ...
  if (a5)
  {
    ...
    v14 = a3;
    v15 = v5;
    v11 = (void *)MEMORY[0x2348BA0DC](v13);
    objc_msgSend(v9, "matchingJobsWhereSQLClause");
...
- (void)createApplyJobFromServerItem:(id)a3 localItem:(id)a4 state:(int)a5 kind:(unsigned int)a6
{
  ...
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BEDD648], "rawInjection:length:", "apply_kind, zone_rowid", 22);
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  v26 = (void *)MEMORY[0x24BEDD638];
  objc_msgSend(v19, "dbRowID");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v26, "formatInjection:", CFSTR("%u, %@"), v6, v27);
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  v29 = (void *)MEMORY[0x24BEDD638];
  v48 = v19;
  objc_msgSend(v19, "dbRowID");
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_debug_impl(&dword_230455000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] Apply Changes: retrying %lld suspended throttles (missing parent found: %@)%@", buf, 0x20u);
    }
...
LABEL_9:
      _os_log_debug_impl(&dword_230455000, v18, OS_LOG_TYPE_DEBUG, v19, buf, 0x2Au);
      goto LABEL_6;
    }
    goto LABEL_6;
  }
...
- (void)didCompleteCrossZoneMigrationForAppLibrary:(id)a3
{
  ...
  -[BRCAccountSessionFPFS clientDB](self->super._session, "clientDB");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BRCAccountSessionFPFS cloudDocsClientZone](self->super._session, "cloudDocsClientZone");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v18 = 2112;
      v19 = v11;
      _os_log_debug_impl(&dword_230455000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] Apply Changes: retrying %lld suspended throttles (appLibrary completed migration: %@)%@", buf, 0x20u);
  ...
  if ((objc_msgSend(v4, "isSharedToMeTopLevelItem") & 1) == 0)
  {
    ...
    if (v10)
    {
      if (objc_msgSend(v5, "isSharedZone"))
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        v12 = (void *)*MEMORY[0x24BE17550];
        if ((objc_msgSend(v11, "isEqualToString:", *MEMORY[0x24BE17550]) & 1) != 0)
        {
...
LABEL_16:
      ...
      if (objc_msgSend(v5, "isSharedZone"))
      {
        objc_msgSend(v5, "zoneName");
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        v17 = objc_msgSend(v16, "isEqualToString:", *MEMORY[0x24BE17550]);
    ...
    -[BRCAccountSessionFPFS clientDB](self->super._session, "clientDB");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = (void *)objc_msgSend(v20, "fetch:", CFSTR("SELECT item_rank, zone_rowid FROM server_items WHERE item_alias_target = %@ AND item_type = 3"), v6);

    if (objc_msgSend(v21, "next"))
    {
      do
      {
        v22 = objc_msgSend(v21, "longLongAtIndex:", 0);
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", objc_msgSend(v21, "longLongAtIndex:", 1));
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        -[BRCAccountSessionFPFS serverZoneByRowID:](self->super._session, "serverZoneByRowID:", v23);
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        -[BRCApplyScheduler _rescheduleRank:inState:forZone:](self, "_rescheduleRank:inState:forZone:", v22, 24, v24);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v19 = 2112;
    v20 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Apply Changes: Rescheduled %lld items which were blocked for greediness when listing folder %@%@", buf, 0x20u);
    ...
    while (1)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v27 = 2112;
        v28 = v14;
        _os_log_debug_impl(&dword_230455000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] Rescheduling items at a flat level under %@%@", buf, 0x16u);
      }
...
uint64_t __29__BRCApplyScheduler_schedule__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x24BEDD648], "rawInjection:length:", "throttle_id, zone_rowid, apply_kind, retry_count", 48);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
void __29__BRCApplyScheduler_schedule__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (objc_msgSend(v11, "longLongValue") >= *(unsigned int *)(a1 + 40))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
    {
      ...
      v22 = 2112;
      v23 = v12;
      _os_log_fault_impl(&dword_230455000, v13, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Apply Changes for rank %lld in table %@ seems to keep failing. retry_count: %lld%@", (uint8_t *)&v16, 0x2Au);
...
- (void)_scheduleApplyJobWithID:(id)a3 zone:(id)a4 applyKind:(unsigned int)a5
{
  ...
  v14 = _os_activity_create(&dword_230455000, "apply-changes", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
  state.opaque[0] = 0;
  state.opaque[1] = 0;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    v61 = 2112;
    v62 = v15;
    _os_log_impl(&dword_230455000, v16, OS_LOG_TYPE_INFO, "[INFO] ┏%llx Apply Changes[%@]: attempting to apply %s\n  server item: %@\n  local item:  %@%@", buf, 0x3Eu);
    v14 = v19;
    v10 = v18;
    self = v17;
    v9 = v38;
  ...
  if (!a5)
  {
    ...
    if (v12)
    {
      if ((objc_msgSend((id)v12, "isRejected") & 1) != 0)
      {
        v11 = 0;
LABEL_21:
        -[BRCAccountSessionFPFS clientDB](self->super._session, "clientDB", v38);
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        v44 = (id)v12;
        v45 = v39;
        objc_msgSend(v24, "groupInBatch:", v40);
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 134218498;
        ...
        v55 = 2112;
        v56 = (uint64_t)v25;
        _os_log_debug_impl(&dword_230455000, v26, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Apply Changes[%@]: deleting rejected action with a non-rejected local item%@", buf, 0x20u);
      }
LABEL_27:
...
LABEL_22:
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      v55 = 2112;
      v56 = (uint64_t)v25;
      _os_log_debug_impl(&dword_230455000, v26, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Apply Changes[%@]: deleting action without local and server item%@", buf, 0x20u);
    }
    goto LABEL_27;
  }
  if (!(v12 | v11))
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    v59 = 2112;
    v60 = (uint64_t)v22;
    _os_log_debug_impl(&dword_230455000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Apply Changes[%@]: deleting useless action %lld vs %lld%@", buf, 0x34u);
    v14 = v31;
    v10 = v30;
    self = v29;
    v9 = v28;
...
void __60__BRCApplyScheduler__scheduleApplyJobWithID_zone_applyKind___block_invoke(uint64_t a1)
{
  ...
  v2 = *(void **)(a1 + 32);
  v3 = *(_QWORD *)(a1 + 40);
  objc_msgSend(*(id *)(a1 + 48), "metadataSyncContext");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "applyThrottle");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "postponeJobID:withThrottle:", v3, v5);

  objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 8), "serverChangesApplier");
  v6 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "applyChanges:localItem:rank:zone:", *(_QWORD *)(a1 + 56), *(_QWORD *)(a1 + 64), *(_QWORD *)(a1 + 72), *(_QWORD *)(a1 + 48));
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        ...
        if ((objc_msgSend(v20, "BOOLValue") & 1) == 0)
        {
          ...
          {
            objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", v37, 41, CFSTR("apply is failing"));
            v23 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v15, "mangledID");
            v24 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v26)
  {
    ...
    do
    {
      for (k = 0; k != v27; ++k)
      {
        ...
        {
          objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", v29, 12, CFSTR("sync is blocked for client zone: %@"), v31);
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v55 = 2112;
          v56 = v34;
          _os_log_debug_impl(&dword_230455000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] Signalled faulting-barrier waiters for %@%@", buf, 0x16u);
        }
...
- (void)deleteExpiredJobs
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Apply Changes: Cleaned up %lld stale throttles%@");
  OUTLINED_FUNCTION_0();
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134219010;
      ...
      v29 = 2112;
      v30 = v14;
      _os_log_debug_impl(&dword_230455000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] Apply Changes [%lld .. %lld]: in %@, %llu ranks inserted%@", buf, 0x34u);
...
- (void)didSyncDownZone:(id)a3 requestID:(unint64_t)a4 upToRank:(int64_t)a5 caughtUpWithServer:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    v29 = 2112;
    v30 = v11;
    _os_log_debug_impl(&dword_230455000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx did sync down requestID:%llu, applying server truth on %@. maxRank [%lld] caughtUp [%s]%@", buf, 0x3Eu);
  }
  ...
  if (v14 || -[NSMutableSet containsObject:](self->_clientZonesWatchingFaults, "containsObject:", v13))
    -[BRCFSSchedulerBase signal](self, "signal");
...
- (void)_close
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v10, "signalFaultingWatchersWithError:", v11);
  ...
  -[BRCFSSchedulerBase _close](&v12, sel__close);
        ...
        if ((objc_msgSend(v10, "isRejected") & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412290;
            v59 = v19;
            _os_log_fault_impl(&dword_230455000, v20, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: li.isRejected%@", buf, 0xCu);
          }
        ...
        if (objc_msgSend(v14, "isLive"))
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)buf = 138412802;
            ...
            v62 = 2112;
            v63 = v15;
            _os_log_impl(&dword_230455000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] Rejected item %@ was remotely revived by %@.  Updating as such%@", buf, 0x20u);
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v60 = 2112;
            v61 = v17;
            _os_log_impl(&dword_230455000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] Rejected item %@ doesn't have an apply job.  Re-creating the apply job%@", buf, 0x16u);
          }
    ...
    do
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v60 = 2112;
        v61 = v37;
        _os_log_impl(&dword_230455000, v38, OS_LOG_TYPE_DEFAULT, "[WARNING] Item %@ is missing an apply throttle%@", buf, 0x16u);
      }
...
uint64_t __49__BRCApplyScheduler_recoverMissingJobsAndReport___block_invoke_108(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  void *v5;
...
- (void)describeInBuffer:aggregateOfJobsMatching:context:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: [matchingQuery isKindOfClass:[BRCServerZone class]]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)setState:forServerItem:localItem:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !si.isLive || !li.isRejected%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)createApplyJobFromServerItem:localItem:state:kind:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: serverItem || localItem%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)didCreateMissingParentID:zone:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Apply Changes: (missing parent found: %@)%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_rescheduleRank:inState:forZone:.cold.1()
{
  ...
  OUTLINED_FUNCTION_6_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Apply Changes: retrying suspended rank %lld%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)rescheduleMissingTargetAliasesWithTarget:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !shouldFixup || !serverZone.isSharedZone || ![serverZone.zoneName isEqualToString:BRUbiquitousDefaultContainerID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __66__BRCApplyScheduler__rescheduleItemsParentedToItemGlobalID_flags___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v3, "[DEBUG] Apply Changes: No unscheduled items parented to %@%@", v4);
...
void __66__BRCApplyScheduler__rescheduleItemsParentedToItemGlobalID_flags___block_invoke_cold_2()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v3, "[DEBUG] No point in rescheduling items under %@ because we can't make it a non-fault%@", v4);
...
void __66__BRCApplyScheduler__rescheduleItemsParentedToItemGlobalID_flags___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v4, "[DEBUG] Updated %@ to be a non-fault%@", v5);
...
void __59__BRCApplyScheduler_rescheduleItemsRecursivelyUnderFolder___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: Couldn't reschedule flat items under %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)repopulateJobsForZone:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Apply Changes: repopulating throttles for zone:%@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleApplyJobWithID:zone:applyKind:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: si == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_scheduleApplyJobWithID:zone:applyKind:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: zone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_addRanksUpToRank:inZone:.cold.1()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, v3, "[CRIT] UNREACHABLE: failed to insert into client_unapplied_commands: %@%@", v4);
...
- (void)_addRanksUpToRank:inZone:.cold.2()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, v0, v3, "[DEBUG] Apply Changes [] in %@, 0 ranks inserted%@", v4);
...
- (void)recoverMissingJobsAndReport:(os_log_t)log .cold.1(uint64_t a1, int a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_debug_impl(&dword_230455000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Apply Changes: Rescheduled %u throttles missing from the apply table%@", (uint8_t *)v3, 0x12u);
  OUTLINED_FUNCTION_0();
}
...
- (void)deleteNonRejectionJobsForZone:.cold.1()
{
  ...
  OUTLINED_FUNCTION_6_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Apply Changes: Deleted %llu non-rejection jobs%@");
  OUTLINED_FUNCTION_0();
}
