...
- (BRMangledID)_aliasTargetMangledID
{
  ...
  if (aliasTarget)
  {
    ...
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithAliasTargetContainerString:", v3);
...
- (id)descriptionWithContext:(id)a3 origName:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16A8]), "initWithCapacity:", 64);
  ...
  if (ckInfo)
  {
    ...
    {
      v24 = objc_alloc(MEMORY[0x24BDB9228]);
...
- (void)_aliasTargetItemID
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _type == BRC_ITEM_TYPE_ALIAS%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_updateAliasTarget:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: containerID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)diffAgainst:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Stat shouldn't be nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)setCreatorRowID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: creatorRowIDLongLongValue >= 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
