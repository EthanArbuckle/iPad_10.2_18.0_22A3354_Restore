...
LABEL_14:
          _os_log_fault_impl(&dword_230455000, p_super, OS_LOG_TYPE_FAULT, v20, buf, 0x16u);
          goto LABEL_19;
        }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v31;
            ...
            v44 = 2112;
            v45 = v18;
            _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] We don't have a container for %@%@", buf, 0x16u);
          }
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┣%llx starting a fetch-record-changes operation for health zone%@");
  OUTLINED_FUNCTION_0();
}
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v34 = 2112;
    v35 = v5;
    _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got a changed record %@ in operation %@%@", buf, 0x2Au);
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v32 = 2112;
        v33 = v15;
        _os_log_debug_impl(&dword_230455000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ignoring zone details record %@ in operation %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v32 = 2112;
        v33 = v15;
        _os_log_impl(&dword_230455000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] ignoring record of unexpected type %@ in operation %@%@", buf, 0x20u);
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_17(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v25 = 2112;
    v26 = v8;
    _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx recordID was deleted %@ in operation %@%@", buf, 0x2Au);
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_19(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v23 = 2112;
    v24 = v12;
    _os_log_debug_impl(&dword_230455000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx Received token update %@, requestID %llu%@", buf, 0x2Au);
  ...
  *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 24) = 1;
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    v33 = 2112;
    v34 = v18;
    _os_log_debug_impl(&dword_230455000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx finished sync down of zone-health %@ with requestID %llu changeToken %@%@", buf, 0x34u);
  ...
  if (objc_msgSend(v13, "brc_isCloudKitErrorImplyingZoneNeedsCreation"))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v29 = 2112;
      v30 = v20;
      _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] No zone-health zone %@: %@%@", buf, 0x20u);
    }
LABEL_12:
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v29 = 2112;
      v30 = v20;
      _os_log_error_impl(&dword_230455000, v21, (os_log_type_t)0x90u, "[ERROR] Failed syncing down zone-health op %@: %@%@", buf, 0x20u);
    }
    goto LABEL_12;
  }
LABEL_13:
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self->_recordsByID[record.recordID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: ![self->_deletedRecordIds containsObject:record.recordID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_17_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self->_recordsByID[recordID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_17_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: ![self->_deletedRecordIds containsObject:recordID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_23_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┳%llx sync down of zone-health-check was cancelled?%@");
  OUTLINED_FUNCTION_0();
}
