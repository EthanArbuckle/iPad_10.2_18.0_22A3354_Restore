...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync/side-car-fetch", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)_createZone
{
  ...
  objc_msgSend(MEMORY[0x24BDB91F8], "brc_sideCarZoneID");
...
- (void)_saveChangedRecords:(id)a3 deletedRecords:(id)a4 serverChangeToken:(id)a5 clientChangeToken:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138413314;
    ...
    v51 = 2112;
    v52 = v16;
    _os_log_debug_impl(&dword_230455000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] Saving side car changed records %@\ndeleted record %@\nserver change token %@\nrequestID %llu%@", buf, 0x34u);
  }
    ...
    do
    {
      ...
      do
      {
        ...
        if ((v8 & 1) != 0)
        {
          ...
          {
            objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", objc_msgSend(v61, "favoriteRank"));
          ...
          {
            objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", objc_msgSend(v61, "lastUsedTime"));
...
LABEL_19:
          ...
          else
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412546;
              ...
              v70 = 2112;
              v71 = v20;
              _os_log_fault_impl(&dword_230455000, v21, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't parse alias record name for %@%@", buf, 0x16u);
            }
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v70 = 2112;
          v71 = v11;
          _os_log_fault_impl(&dword_230455000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't deserialize side car info on %@%@", buf, 0x16u);
        }
LABEL_25:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v70 = 2112;
            v71 = v31;
            _os_log_debug_impl(&dword_230455000, v32, OS_LOG_TYPE_DEBUG, "[DEBUG] Ignoring deleted recordID where we couldn't locate the server zone %@%@", buf, 0x16u);
          }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v37 = 2112;
      v38 = v6;
      _os_log_impl(&dword_230455000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] Marking sync request in side care zone as failed because requestIDs differ %lld vs %lld%@", buf, 0x20u);
    }
  }
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        if (v4 == v5)
          objc_msgSend(v14, "markLatestSyncRequestAcknowledgedInZone:", &unk_24FEB31D0);
        else
          objc_msgSend(v14, "markLatestSyncRequestFailedInZone:", &unk_24FEB31D0);
...
- (void)_createSyncDownOperation
{
  ...
  objc_msgSend(MEMORY[0x24BDB91F8], "brc_sideCarZoneID");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_alloc(MEMORY[0x24BDB90C8]);
  v37[0] = v6;
...
void __102__BRCSideCarSyncDownOperation__saveChangedRecords_deletedRecords_serverChangeToken_clientChangeToken___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_fault_impl(&dword_230455000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: failed to alloc ranks when syncing down side cars for %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
void __102__BRCSideCarSyncDownOperation__saveChangedRecords_deletedRecords_serverChangeToken_clientChangeToken___block_invoke_14_cold_1(_QWORD *a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(_QWORD *)&v3[14] = a2;
  OUTLINED_FUNCTION_1_0(&dword_230455000, a2, a3, "[DEBUG] Succeeded in syncing up the side car zone with requestID %lld%@", *(_QWORD *)v3, *(_QWORD *)&v3[8], *(_QWORD *)&v3[16]);
  OUTLINED_FUNCTION_0();
}
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: sideCarRecordsByRecordID[record.recordID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: ![deletedRecordIDs containsObject:record.recordID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_cold_3(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  v8 = 2112;
  v9 = a2;
  _os_log_debug_impl(&dword_230455000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Ignoring record of unknown type %@%@", (uint8_t *)&v6, 0x16u);
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_24_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: sideCarRecordsByRecordID[recordID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_24_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: ![deletedRecordIDs containsObject:recordID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_24_cold_3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Ignoring record of unknown type %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_3_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Finished syncing down side cars - %@%@");
  OUTLINED_FUNCTION_0();
}
