...
- (void)_createCloudKitZoneWithGroup:(id)a3 completion:(id)a4
{
  ...
  if (!self->_createZoneOperation)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v29 = 2112;
      v30 = v8;
      _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx scheduling zone creation operation for %@%@", buf, 0x20u);
  ...
  v13 = (void *)MEMORY[0x2348BA0DC](v7);
...
void __64__BRCPrivateClientZone__createCloudKitZoneWithGroup_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_debug_impl(&dword_230455000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx finished zone creation with error: %@%@", buf, 0x20u);
  }
...
void __64__BRCPrivateClientZone__createCloudKitZoneWithGroup_completion___block_invoke_5(uint64_t a1)
{
  ...
  v2 = (void *)objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 520), "copy");
...
- (void)resume
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Activation done%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)close
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] zoneCreationOp finished%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}

uint64_t __29__BRCPrivateClientZone_close__block_invoke(uint64_t a1)
{
  objc_storeStrong((id *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 40), *(id *)(*(_QWORD *)(a1 + 32) + 504));
...
uint64_t __57__BRCPrivateClientZone_reportProblemWithType_recordName___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 544), "addProblemWithType:recordName:", *(unsigned int *)(a1 + 48), *(_QWORD *)(a1 + 40));
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v14 = 2112;
        v15 = v8;
        _os_log_impl(&dword_230455000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] problem report for %@ wasn't acked%@", (uint8_t *)&v12, 0x16u);
      }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v28 = 2112;
    v29 = v14;
    _os_log_impl(&dword_230455000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] Zone has resetted more than %lu times during the last %f seconds%@", (uint8_t *)&v24, 0x20u);
...
- (void)syncedDownZoneHealthState:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v23 = 2112;
    v24 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] zone-health changed for %@ previous %@ new %@%@", (uint8_t *)&v17, 0x2Au);
  }
      ...
      || (self->super._state & 0x10000) != 0)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          v17 = 138412290;
          v18 = v14;
          _os_log_impl(&dword_230455000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] We had a problem and the zone is healthy again, resetting the zone%@", (uint8_t *)&v17, 0xCu);
        }
...
LABEL_20:
        _os_log_impl(&dword_230455000, v12, OS_LOG_TYPE_DEFAULT, v13, (uint8_t *)&v17, 0xCu);
      }
    }
...
- (BOOL)recomputeAppSyncBlockState
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v33 = 2112;
    v34 = v9;
    _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx recomputing app sync block state for %@%@", buf, 0x20u);
  }
  ...
  if (((v6 ^ v8) & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 136315650;
      ...
      v33 = 2112;
      v34 = v16;
      _os_log_debug_impl(&dword_230455000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] sync remaining %s for %@%@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 136315650;
      ...
      v33 = 2112;
      v34 = v18;
      _os_log_debug_impl(&dword_230455000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] updating sync state to be %s for %@%@", buf, 0x20u);
    }
...
- (unsigned)pcsChainStateForItem:(id)a3
{
  ...
  if (objc_msgSend(v4, "isNonDesktopRoot"))
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[BRCAccountSessionFPFS appLibraryByRowID:](session, "appLibraryByRowID:", v6);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)unchainedItemInfoInServerTruthEnumeratorParentedTo:(id)a3
{
  ...
  if (v7)
    ...
    objc_msgSend(MEMORY[0x24BEDD638], "formatInjection:", CFSTR("AND NOT (item_type = 3 AND item_alias_target like '%%:\\_%%' ESCAPE '\\')"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[BRCClientZone db](self, "db");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[BRCClientZone dbRowID](self, "dbRowID");
    ...
    if ((v8 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v33 = 2112;
        v34 = v10;
        _os_log_impl(&dword_230455000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't parse unsalted bookmark data %@ - %@%@", buf, 0x20u);
      }
  ...
  if (objc_msgSend(v16, "next"))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138413314;
      ...
      v37 = 2112;
      v38 = v19;
      _os_log_debug_impl(&dword_230455000, v20, OS_LOG_TYPE_DEBUG, "[DEBUG] Overriding structural and content info from (%@, %@) -> (%@, %@) because the item is OOB sync%@", buf, 0x34u);
    }
...
- (void)privateServerZone
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _serverZone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)defaultAppLibrary
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _defaultAppLibrary%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)setServerZone:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: [serverZone isKindOfClass:[BRCPrivateServerZone class]]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)syncedDownZoneHealthRequestID:.cold.1()
{
  ...
  v3 = 2112;
  v4 = v0;
  _os_log_debug_impl(&dword_230455000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] problem report for %@ completed%@", v2, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
- (void)serverAliasByUnsaltedBookmarkData:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: unsaltedBookmarkData%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __97__BRCPrivateClientZone_BRCPCSChainAdditions__unchainedItemInfoInServerTruthEnumeratorParentedTo___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_fault_impl(&dword_230455000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Can't locate target server zone from bookmark data %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_0();
}
