...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sharing/save-share", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v27 = 2112;
      v28 = v14;
      _os_log_impl(&dword_230455000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] Unsharing turd folder share %@%@", buf, 0x16u);
    }
    ...
    v19 = objc_alloc(MEMORY[0x24BDB9158]);
    v24 = v18;
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: no share record%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __36__BRCSharingSaveShareOperation_main__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (!v4)
  {
    ...
    {
      v20 = *(void **)(a1 + 32);
      objc_msgSend(MEMORY[0x24BDD1540], "brc_errorItemNotShareable");
    ...
    {
      v18 = *(void **)(a1 + 32);
      objc_msgSend(MEMORY[0x24BDD1540], "brc_errorItemAlreadyPartOfAShare");
...
LABEL_77:
    ...
    if (v25)
    {
      if (objc_msgSend(v12, "isDirectory"))
      {
        if ((objc_msgSend(v12, "isShared") & 1) == 0)
        {
          ...
          {
            v28 = *(void **)(a1 + 32);
            objc_msgSend(MEMORY[0x24BDD1540], "brc_errorNotInCloud:", 0);
    ...
    {
      v31 = *(void **)(a1 + 32);
      objc_msgSend(MEMORY[0x24BDD1540], "brc_errorItemInTrash");
        ...
        if (!v42)
        {
          ...
          if (os_log_type_enabled(v69, (os_log_type_t)0x90u))
          {
            *(_DWORD *)buf = 138412802;
            ...
            v97 = 2112;
            v98 = v68;
            _os_log_error_impl(&dword_230455000, v69, (os_log_type_t)0x90u, "[ERROR] Couldn't get base record for %@, %@%@", buf, 0x20u);
          }
          ...
          objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: couldn't get base record"));
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_123(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v28 = 2112;
      v29 = v7;
      _os_log_impl(&dword_230455000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to unshare turd - %@%@", buf, 0x16u);
    }
  ...
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9158]), "initWithRecordsToSave:recordIDsToDelete:", *(_QWORD *)(a1 + 40), 0);
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_128(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (!v9)
  {
    ...
    if (v10 != v11)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: got an unexpected number of shares saved"));
      v12 = (void *)objc_claimAutoreleasedReturnValue();
    }
  }
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v67 = 2112;
      v68 = v15;
      _os_log_error_impl(&dword_230455000, v16, (os_log_type_t)0x90u, "[ERROR] failed saving share %@: %@%@", buf, 0x20u);
    }
  ...
  if (*(_BYTE *)(a1 + 72))
  {
    ...
    if ((-[NSObject isEqualToString:](v28, "isEqualToString:", CFSTR("content")) & 1) == 0)
    {
      objc_msgSend(v6, "objectAtIndexedSubscript:", 1);
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v29, "recordType");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      v31 = objc_msgSend(v30, "isEqualToString:", CFSTR("structure"));
...
LABEL_23:
        ...
        v59[1] = *((_QWORD *)v26 + 356);
        v59[2] = __36__BRCSharingSaveShareOperation_main__block_invoke_131;
        v59[3] = &unk_24FE47718;
        v60 = *(id *)(a1 + 56);
        v61 = v6;
        objc_msgSend(v32, "groupInBatch:", v59);
...
LABEL_24:
  ...
  v34 = (void *)objc_claimAutoreleasedReturnValue();
  v35 = objc_msgSend(v34, "isEqualToString:", *MEMORY[0x24BDB8F28]);
  ...
  *(_QWORD *)(v37 + 528) = v36;
  ...
  {
    v53 = *(void **)(*(_QWORD *)(a1 + 40) + 528);
    *(_DWORD *)buf = 138412546;
    v64 = v53;
    v65 = 2112;
    v66 = v39;
    _os_log_debug_impl(&dword_230455000, v40, OS_LOG_TYPE_DEBUG, "[DEBUG] Saved share %@%@", buf, 0x16u);
  }
  ...
  if (*(_BYTE *)(a1 + 72))
  {
    ...
    v48 = v26;
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v41, "_updateDBAndSyncDownIfNeededWithShare:recordsToLearnCKInfo:", v42, v49);
  ...
  {
    objc_msgSend(*(id *)(a1 + 40), "_updateDBAndSyncDownIfNeededWithShare:recordsToLearnCKInfo:", v41[66], 0);
  }
  objc_msgSend(*(id *)(a1 + 48), "fileObjectID");
  v50 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v50, "asString");
  v51 = (void *)objc_claimAutoreleasedReturnValue();
  v56[0] = v25;
  v56[1] = *((_QWORD *)v26 + 356);
  v56[2] = __36__BRCSharingSaveShareOperation_main__block_invoke_133;
  v56[3] = &unk_24FE408B8;
  v52 = *(_QWORD *)(a1 + 40);
  v57 = v50;
  v58 = v52;
  v21 = v50;
  +[BRCImportUtil forceIngestionForItemID:completionHandler:](BRCImportUtil, "forceIngestionForItemID:completionHandler:", v51, v56);
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_133(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  NSObject *v5;
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_debug_impl(&dword_230455000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Done forceIngestionForItemID %@ with error - %@%@", (uint8_t *)&v7, 0x20u);
  }
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: couldn't get base record%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_cold_2(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  v8 = 2112;
  v9 = a2;
  _os_log_fault_impl(&dword_230455000, a3, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: directory %@ isn't pcs chained%@", (uint8_t *)&v6, 0x16u);
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] Failed with baseTokenError=%@%@");
  OUTLINED_FUNCTION_0();
}
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_123_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_DWORD *)buf = 138413058;
  ...
  v18 = 2112;
  v19 = a2;
  _os_log_debug_impl(&dword_230455000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Saving %@%@ for share op %@%@", buf, 0x2Au);
  if (v8)
  {
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_128_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: [save[0].recordType isEqualToString:CKRecordTypeShare]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_128_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: [save[1].recordType isEqualToString:kBRRecordTypeContent] || [save[1].recordType isEqualToString:kBRRecordTypeStructure]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_128_cold_3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] finished saving share %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __36__BRCSharingSaveShareOperation_main__block_invoke_128_cold_4()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: got an unexpected number of shares saved%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
