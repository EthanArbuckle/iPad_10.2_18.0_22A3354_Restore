...
- (id)descriptionWithContext:()BRCAddition
{
  ...
  if (objc_msgSend(v5, "length") == 33)
  {
    ...
    if ((_DWORD)v8 == 1)
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", bswap64(v10));
...
LABEL_14:
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", bswap64(v13));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", bswap64(v14));
...
+ (uint64_t)newFromSqliteValue:()BRCAddition
{
  ...
  v0 = (void *)objc_msgSend(MEMORY[0x24BDBCE50], "newFromSqliteValue:");
  if (v0)
    v1 = objc_msgSend(objc_alloc(MEMORY[0x24BDB9228]), "initWithData:", v0);
  else
    v1 = 0;
...
+ (uint64_t)newFromSqliteStatement:()BRCAddition atIndex:
{
  ...
  v0 = (void *)objc_msgSend(MEMORY[0x24BDBCE50], "newFromSqliteStatement:atIndex:");
  if (v0)
    v1 = objc_msgSend(objc_alloc(MEMORY[0x24BDB9228]), "initWithData:", v0);
  else
    v1 = 0;
