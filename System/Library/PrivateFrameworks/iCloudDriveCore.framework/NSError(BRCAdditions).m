...
- (double)br_suggestedRetryTimeInterval
{
  ...
  objc_msgSend(v2, "objectForKeyedSubscript:", *MEMORY[0x24BDB8EB8]);
  ...
  if (objc_msgSend(a1, "_brc_isCloudKitErrorCode:", 2))
  {
    ...
    objc_msgSend(v6, "objectForKeyedSubscript:", *MEMORY[0x24BDB8EE8]);
...
- (id)_brc_cloudKitInternalWithErrorCode:()BRCAdditions
{
  ...
  objc_msgSend(v4, "domain");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = *MEMORY[0x24BDB8EE0];
  v11 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDB8EE0]);
  ...
  if (objc_msgSend(v4, "code") != a3)
  {
    if (objc_msgSend(v4, "code") == 2055)
    {
      ...
      objc_msgSend(v13, "objectForKeyedSubscript:", *MEMORY[0x24BDD1398]);
...
- (id)br_cloudKitErrorForIdentifier:()BRCAdditions
{
  ...
  objc_msgSend(a1, "userInfo");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BDB8EE8]);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    while (2)
    {
      for (i = 0; i != v3; ++i)
      {
        ...
        if ((objc_msgSend(v6, "br_isNSURLErrorCode:", -1009) & 1) != 0)
        {
          ...
          v7 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BDD1330]);
          v8 = (void *)objc_claimAutoreleasedReturnValue();
          v3 = v8 == 0;
      ...
      if (v12)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithRecordName:zoneID:", *(_QWORD *)(*((_QWORD *)&v21 + 1) + 8 * v15), v6);
...
- (BOOL)brc_isCloudKitRequestRejectedError
{
  ...
  objc_msgSend(a1, "domain");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v2, "isEqualToString:", *MEMORY[0x24BDB8EA8]))
...
- (BOOL)brc_isCloudKitMMCSErrorChunksCouldNotBeRegisteredError
{
  ...
  if (objc_msgSend(a1, "_brc_isCloudKitErrorCode:", 4))
  {
    ...
    objc_msgSend(v4, "domain");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDB8FB8]))
    {
...
LABEL_12:
      ...
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v8, "isEqualToString:", *MEMORY[0x24BE633E0]))
        v9 = objc_msgSend(v5, "code") == 29;
      else
        v9 = 0;
...
- (uint64_t)brc_isCloudKitErrorRequiringAssetRescan
{
  ...
  objc_msgSend(v4, "domain");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDB8EE0]);
...
- (uint64_t)brc_isCloudKitErrorRequiringAssetReupload
{
  ...
  objc_msgSend(a1, "domain");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDB8EA8]);
...
- (id)_brc_cloudKitPluginErrorPayload
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKey:", *MEMORY[0x24BDB8ED0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)brc_isIndividualItemBlacklistError
{
  ...
  objc_msgSend(v5, "domain");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_msgSend(v6, "isEqualToString:", *MEMORY[0x24BDB8EE0]);
...
- (uint64_t)_brc_isCloudKitInternalErrorSafeToSyncUpWithoutSyncDown
{
  ...
  objc_msgSend(a1, "domain");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = *MEMORY[0x24BDB8EE0];
  v4 = objc_msgSend(v2, "isEqualToString:", *MEMORY[0x24BDB8EE0]);
        ...
        if (v5 > 2021)
        {
          switch(v5)
          {
            ...
            case 2055:
              ...
              objc_msgSend(v16, "objectForKeyedSubscript:", *MEMORY[0x24BDD1398]);
  ...
  if (v9)
  {
    ...
    switch(objc_msgSend(a1, "code"))
    {
      ...
      case 2:
        ...
        objc_msgSend(a1, "userInfo", 0);
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v15, "objectForKeyedSubscript:", *MEMORY[0x24BDB8EE8]);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      case 15:
        ...
        objc_msgSend(v25, "objectForKeyedSubscript:", *MEMORY[0x24BDD1398]);
        v17 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_51:
      ...
      case 22:
        ...
        objc_msgSend(v26, "objectForKeyedSubscript:", *MEMORY[0x24BDD1398]);
...
LABEL_80:
  ...
  objc_msgSend(a1, "domain");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = objc_msgSend(v13, "isEqualToString:", *MEMORY[0x24BDB8EE0]);
...
- (BOOL)brc_isFrontBoardOpenApplicationRequestDenied
{
  ...
  objc_msgSend(a1, "domain");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v2, "isEqualToString:", *MEMORY[0x24BE38330]))
...
- (id)brc_strippedError
{
  ...
  else
  {
    objc_msgSend(a1, "domain");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDB8EE0]);
  ...
  if (v8)
  {
    ...
    if (v10 == 2)
    {
      objc_msgSend(a1, "userInfo");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = (id)*MEMORY[0x24BDB8EE8];
      objc_msgSend(v11, "objectForKeyedSubscript:", *MEMORY[0x24BDB8EE8]);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)brc_wrappedError
{
  ...
  objc_msgSend(a1, "domain");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = (void *)*MEMORY[0x24BE17300];
  if (objc_msgSend(v2, "isEqualToString:", *MEMORY[0x24BE17300]))
  {
  ...
  objc_msgSend(a1, "domain");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)*MEMORY[0x24BDD0B88];
  v6 = objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD0B88]);

  if (v6)
    goto LABEL_4;
  objc_msgSend(a1, "domain");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v10, "isEqualToString:", *MEMORY[0x24BDB8EA8]))
  {
...
LABEL_10:
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "brc_errorWithDomain:code:underlyingError:", v14, v15, v13);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(a1, "domain");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = objc_msgSend(v11, "isEqualToString:", *MEMORY[0x24BDB8EE0]);

  if (v12)
    goto LABEL_10;
  objc_msgSend(a1, "domain");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v17 = objc_msgSend(v16, "isEqualToString:", *MEMORY[0x24BDD1128]);

  if (v17)
  {
    objc_msgSend(MEMORY[0x24BDD1540], "brc_errorWithDomain:code:underlyingError:", v5, 512, a1);
    v7 = (id)objc_claimAutoreleasedReturnValue();
    goto LABEL_5;
  }
  objc_msgSend(a1, "domain");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = objc_msgSend(v18, "isEqualToString:", *MEMORY[0x24BE3AE68]);
...
LABEL_5:
  ...
  objc_msgSend(MEMORY[0x24BDD1540], "brc_errorWithDomain:code:underlyingError:", v20, v23, a1);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17300], 16, CFSTR("Sync is restricted for this client"));
}
...
- (id)brc_cloudKitErrorMessage
{
  ...
  objc_msgSend(a1, "userInfo");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKeyedSubscript:", *MEMORY[0x24BDB8EC0]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  {
  ...
  else
  {
    objc_msgSend(a1, "userInfo");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "objectForKeyedSubscript:", *MEMORY[0x24BDB8EA0]);
    v5 = (id)objc_claimAutoreleasedReturnValue();
...
- (BOOL)brc_isXPCConnectionError
{
  ...
  objc_msgSend(a1, "domain");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "isEqualToString:", *MEMORY[0x24BDD0B88]);
...
- (void)brc_logUnderlineErrorsChain
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Printing Underline Errors Chain for %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_brc_isCloudKitErrorCode:()BRCAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: code < CKErrorInternalGenericError%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_brc_isCloudKitInternalErrorCode:()BRCAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: code == CKErrorInternalSuccess || code == CKErrorInternalCancelled || code >= CKErrorInternalGenericError%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)br_cloudKitErrorForIdentifier:()BRCAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: there should be a recordID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)brc_isCloudKitErrorReparentedToNewParent:()BRCAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: errorPayload.hasRecordId%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_brc_isCloudKitInternalErrorSafeToSyncUpWithoutSyncDown
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] we should sync-down again after %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)brc_isCloudKitErrorSafeToSyncUpWithoutSyncDown
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] Cloudd crashed, our sync up could have been received by the server%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
