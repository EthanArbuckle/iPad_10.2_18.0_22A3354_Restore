...
- (void)perform
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_9(&dword_230455000, v0, v1, "[ERROR] No ACAccount found%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __37__BRCAccountMigrationChecker_perform__block_invoke_102(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    v24 = 2112;
    v25 = v10;
    _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Request for CloudKit migration status done. response: %@, error: %@%@", buf, 0x2Au);
  }
  ...
  if (v8 && !v9 && (objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (v12)
      objc_msgSend(v12, "isEqualToString:", *MEMORY[0x24BE04808]);
...
void __37__BRCAccountMigrationChecker_perform__block_invoke_cold_2(char a1, uint64_t a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a2;
  _os_log_debug_impl(&dword_230455000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] migration status: %d%@", (uint8_t *)v3, 0x12u);
  OUTLINED_FUNCTION_0();
}
...
void __37__BRCAccountMigrationChecker_perform__block_invoke_102_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] migration state: %@%@");
  OUTLINED_FUNCTION_0();
}
