...
{
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("remote:%p"), self->_remoteClientProxy);
}
...
- (void)start
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _remoteClientProxy || _ignoreMissingRemoteClientProxy%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
