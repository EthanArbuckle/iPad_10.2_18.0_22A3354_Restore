...
- (BRCPackageManifestWriter)initWithZone:(id)a3 stageID:(id)a4 url:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_msgSend(MEMORY[0x24BDBCF08], "outputStreamWithURL:append:", v11, 0);
    v14 = objc_claimAutoreleasedReturnValue();
    stream = v13->_stream;
    v13->_stream = (NSOutputStream *)v14;

    -[NSOutputStream open](v13->_stream, "open");
    v16 = objc_msgSend(objc_alloc(MEMORY[0x24BE7AF10]), "initWithOutputStream:", v13->_stream);
    writer = v13->_writer;
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v17 = 2112;
      v18 = v10;
      _os_log_error_impl(&dword_230455000, v11, (os_log_type_t)0x90u, "[ERROR] Failed setting quarantine info for item %@: %@%@", buf, 0x20u);
    }
...
- (void)_applyDirectoryMetadataWithManifestItem:(id)a3 packageRootFD:(int)a4
{
  ...
  if ((v14 & 0x80000000) != 0)
  {
    ...
    if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
    {
      ...
      v23 = 2112;
      v24 = v17;
      _os_log_error_impl(&dword_230455000, v18, (os_log_type_t)0x90u, "[ERROR] Failed to open pkg item at %@ %{errno}d%@", (uint8_t *)&v19, 0x1Cu);
    }
  ...
  {
    v15 = v14;
    BRCSetMtime(v14, objc_msgSend(v6, "mtime"));
    -[BRCPackageManifestWriter _applyQuarantineMetadataWithManifestItem:isDocumentModifiedByOtherUser:fd:](self, "_applyQuarantineMetadataWithManifestItem:isDocumentModifiedByOtherUser:fd:", v6, 0, v15);
    close(v15);
  }
...
- (void)_applyFileMetadataWithManifestItem:(id)a3 isDocumentModifiedByOtherUser:(BOOL)a4 packageRootFD:(int)a5
{
  ...
  if (v9 && (objc_msgSend(v8, "hasMtime") & 1) != 0)
  {
    ...
    if ((v17 & 0x80000000) != 0)
    {
      ...
      if (os_log_type_enabled(v26, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v35 = 2112;
        v36 = v25;
        _os_log_error_impl(&dword_230455000, v26, (os_log_type_t)0x90u, "[ERROR] openat failed to apply metadata for manifest item %@ %{errno}d%@", buf, 0x1Cu);
      }
    ...
    {
      v18 = v17;
      BRCSetMtime(v17, objc_msgSend(v8, "mtime"));
      ...
      if (BRCFSetAttrList(v18, &v29, &v28, 4uLL))
      {
        ...
        if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
        {
          *(_DWORD *)buf = 138412802;
          ...
          v35 = 2112;
          v36 = v20;
          _os_log_error_impl(&dword_230455000, v21, (os_log_type_t)0x90u, "[ERROR] fsetattrlist failed for pkg item %@ %{errno}d%@", buf, 0x1Cu);
        }
...
- (BOOL)_stageExistingPackageItem:(id)a3 withLiveFd:(int)a4 stageFd:(int)a5 isDocumentModifiedByOtherUser:(BOOL)a6
{
  ...
  {
    v18 = v12;
    v19 = BRCOpenAt(v8, v12, 33028, v13, v14, v15, v16, v17, v37);
    if (v19 < 0)
    {
      v22 = *__error();
      brc_bread_crumbs();
    ...
    if (v21)
    {
      ...
      if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
      {
        ...
        *(_QWORD *)&v38[16] = v23;
        ...
        v26 = (stat *)&v37;
LABEL_20:
        _os_log_error_impl(&dword_230455000, v24, (os_log_type_t)0x90u, v25, (uint8_t *)v26, 0x1Cu);
        goto LABEL_10;
      }
      goto LABEL_10;
    }
    if (clonefileat(v8, v18, v7, v18, 0))
    {
      ...
      if (os_log_type_enabled(v33, (os_log_type_t)0x90u))
      {
        ...
        *(_QWORD *)&v38[22] = v11;
        ...
        v41 = 2112;
        v42 = v32;
        _os_log_error_impl(&dword_230455000, v33, (os_log_type_t)0x90u, "[ERROR] clonefileat(%d, %@, %d, %@) %{errno}d%@", (uint8_t *)&v37, 0x32u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_QWORD *)v38 = v11;
        *(_WORD *)&v38[8] = 2112;
        *(_QWORD *)&v38[10] = stageID;
        *(_WORD *)&v38[18] = 2112;
        *(_QWORD *)&v38[20] = v34;
        _os_log_debug_impl(&dword_230455000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] cloned at %@ for package staged in %@%@", (uint8_t *)&v37, 0x20u);
      }

      -[BRCPackageManifestWriter _applyFileMetadataWithManifestItem:isDocumentModifiedByOtherUser:packageRootFD:](self, "_applyFileMetadataWithManifestItem:isDocumentModifiedByOtherUser:packageRootFD:", v10, v6, v7);
      v29 = 1;
    }
  }
LABEL_11:
              ...
              if (objc_msgSend(v45, "type") == 4)
              {
                if (v166 >= v167)
                {
                  ...
                  if (os_log_type_enabled(v102, OS_LOG_TYPE_FAULT))
                  {
                    ...
                    *(_WORD *)&v192[18] = 2112;
                    *(_QWORD *)&v192[20] = v101;
                    _os_log_fault_impl(&dword_230455000, v102, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Package has been corrupted on the serverAsking for asset index out of bounds %lu vs %lu in package: %@%@", buf, 0x2Au);
                  }

                  objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: Package has been corrupted on the serverAsking for asset index out of bounds %lu vs %lu in package: %@"), v166, v167, v16);
              ...
              else
              {
                ...
                if (!getattrlistat(v43, v47, &v180, &v177, 0x18uLL, 0x21uLL))
                {
                  ...
                  if (os_log_type_enabled(v108, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_WORD *)&v192[8] = 2112;
                    *(_QWORD *)&v192[10] = v107;
                    _os_log_debug_impl(&dword_230455000, v108, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ already exists in stage for package %@%@", buf, 0x20u);
                  }
                    ...
                    if (v52 < 0)
                    {
                      ...
                      if (*__error() != 17)
                      {
                        ...
                        if (os_log_type_enabled(v139, (os_log_type_t)0x90u))
                        {
                          ...
                          *(_WORD *)&v192[18] = 2112;
                          *(_QWORD *)&v192[20] = v138;
                          _os_log_error_impl(&dword_230455000, v139, (os_log_type_t)0x90u, "[ERROR] Failed to create symlink %@ -> %@ for package %@%@", buf, 0x2Au);
                  ...
                  case 2:
                    if (v166 >= v167)
                    {
                      ...
                      if (os_log_type_enabled(v127, OS_LOG_TYPE_FAULT))
                      {
                        ...
                        *(_WORD *)&v192[18] = 2112;
                        *(_QWORD *)&v192[20] = v126;
                        _os_log_fault_impl(&dword_230455000, v127, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Package has been corrupted in the cloudAsking for asset index out of bounds %lu vs %lu in package: %@%@", buf, 0x2Au);
                      }

                      objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: Package has been corrupted in the cloudAsking for asset index out of bounds %lu vs %lu in package: %@"), v166, v167, v16);
                    ...
                    if (!v53)
                    {
                      ...
                      objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: Can't find item at index %ld"), v166, v151);
LABEL_104:
                    ...
                    if (v55)
                    {
                      if (BRCRenameAt(-1, v55, v170, v161, 0))
                      {
                        ...
                        if (os_log_type_enabled(v135, (os_log_type_t)0x90u))
                        {
                          ...
                          *(_WORD *)&v192[20] = 2112;
                          *(_QWORD *)&v192[22] = v134;
                          _os_log_error_impl(&dword_230455000, v135, (os_log_type_t)0x90u, "[ERROR] renameat(-1, %@, %d, %@) %{errno}d%@", buf, 0x2Cu);
                        }
...
LABEL_146:
                      ...
                      if (os_log_type_enabled(v57, OS_LOG_TYPE_DEBUG))
                      {
                        ...
                        *(_WORD *)&v192[18] = 2112;
                        *(_QWORD *)&v192[20] = v56;
                        _os_log_debug_impl(&dword_230455000, v57, OS_LOG_TYPE_DEBUG, "[DEBUG] staged from %@ to %@ in %@%@", buf, 0x2Au);
                      }
                  ...
                  case 1:
                    if (mkdirat(v43, v165, v152) && *__error() != 17)
                    {
                      ...
                      if (os_log_type_enabled(v132, (os_log_type_t)0x90u))
                      {
                        ...
                        *(_WORD *)&v192[8] = 2112;
                        *(_QWORD *)&v192[10] = v138;
                        _os_log_error_impl(&dword_230455000, v132, (os_log_type_t)0x90u, "[ERROR] Failed to mkdir %@ for package %@%@", buf, 0x20u);
                      }
                ...
                if (objc_msgSend(v48, "hasXattrIndex"))
                {
                    ...
                    || (v58 = objc_msgSend(v48, "xattrIndex"), v58 >= objc_msgSend(v172, "itemCount")))
                  {
                    ...
                    if (os_log_type_enabled(v110, OS_LOG_TYPE_FAULT))
                    {
                      ...
                      *(_WORD *)&v192[8] = 2112;
                      *(_QWORD *)&v192[10] = v109;
                      _os_log_fault_impl(&dword_230455000, v110, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: xattr index is out of bounds %ld of total %ld%@", buf, 0x20u);
                    }

                    objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: xattr index is out of bounds %ld of total %ld"), objc_msgSend(v164, "xattrIndex"), objc_msgSend(v172, "itemCount"));
                    goto LABEL_104;
                  }
                  ...
                  if (!v59)
                  {
                    ...
                    objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: Can't find xattr at index %ld"), objc_msgSend(v164, "xattrIndex"), v151);
                    goto LABEL_104;
                  }
                  v60 = v59;
                  v61 = (void *)MEMORY[0x24BDBCE50];
                  ...
                  if (!v157 || v63)
                  {
                    ...
                    if (!v63)
                    {
                      objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17300], 15, CFSTR("Can't load xattr"));
                  ...
                  if (!v75)
                  {
                    ...
                    if (os_log_type_enabled(v124, (os_log_type_t)0x90u))
                    {
                      *(_DWORD *)buf = 138412546;
                      ...
                      v191 = 2112;
                      *(_QWORD *)v192 = v123;
                      _os_log_error_impl(&dword_230455000, v124, (os_log_type_t)0x90u, "[ERROR] Failed to apply xattrs to file descriptor: %@%@", buf, 0x16u);
                    }
...
LABEL_65:
                    if (!*p_error)
                    {
                      ...
                      {
                        objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithPOSIXCode:description:", 22, CFSTR("unknown error"));
                  ...
                  if (os_log_type_enabled(v76, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_WORD *)&v192[8] = 2112;
                    *(_QWORD *)&v192[10] = v154;
                    _os_log_debug_impl(&dword_230455000, v76, OS_LOG_TYPE_DEBUG, "[DEBUG] Successfully applied xattrs %@ to package item %@%@", buf, 0x20u);
                ...
                if (getattrlistat(v43, v165, &v180, &v177, 0x18uLL, 0x21uLL))
                {
                  ...
                  if (os_log_type_enabled(v113, (os_log_type_t)0x90u))
                  {
                    ...
                    *(_WORD *)&v192[14] = 2112;
                    *(_QWORD *)&v192[16] = v112;
                    _os_log_error_impl(&dword_230455000, v113, (os_log_type_t)0x90u, "[ERROR] unable to stat %@ for package %@ %{errno}d%@", buf, 0x26u);
                  }
...
LABEL_78:
          ...
          if (os_log_type_enabled(v98, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_WORD *)&v192[18] = 2112;
            *(_QWORD *)&v192[20] = v97;
            _os_log_debug_impl(&dword_230455000, v98, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished staging package for %@. Item count:%lu.  Asset index:%lu%@", buf, 0x2Au);
...
- (void)addItem:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Adding %@ to the manifest%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_applyFileMetadataWithManifestItem:isDocumentModifiedByOtherUser:packageRootFD:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Invalid args in %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_stageExistingPackageItem:withLiveFd:stageFd:isDocumentModifiedByOtherUser:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: we should have downloaded this file if there is nothing live%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.1()
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, v3, "[CRIT] UNREACHABLE: No reader to stage package at %s%@", v4);
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: relpath should always exist%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.3()
{
  ...
  v4 = 2112;
  v5 = v1;
  _os_log_fault_impl(&dword_230455000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid item type: %d%@", (uint8_t *)v3, 0x12u);
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.4()
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, v2, "[CRIT] UNREACHABLE: Can't find xattr at index %ld%@", v3);
  OUTLINED_FUNCTION_2_0();
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.5()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] Failed to read xattrs blob: %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.6()
{
  ...
  OUTLINED_FUNCTION_5(&dword_230455000, v0, v1, "[ERROR] Unable to add item to manifest: %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)stagePackageWithReader:(NSObject *)a3 package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.7(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(_QWORD *)&v3[14] = a1;
  OUTLINED_FUNCTION_4_1(&dword_230455000, a2, a3, "[CRIT] UNREACHABLE: Can't find item at index %ld%@", *(_QWORD *)v3, *(_QWORD *)&v3[8], *(_QWORD *)&v3[16]);
  OUTLINED_FUNCTION_0();
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.8()
{
  ...
  objc_msgSend(v2, "UTF8String");
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, v3, "[CRIT] UNREACHABLE: We didn't fetch the corresponding pkg item from the server, but we were also not given a path to hardlink it from! (item: %s)%@", v4);
