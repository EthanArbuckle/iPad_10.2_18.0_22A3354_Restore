...
LABEL_40:
  ...
  if (-[BRCChecksummingOutputStream write:maxLength:](self->_stream, "write:maxLength:", (char *)&addItem_error__tags + (int)objc_msgSend(v6, "type"), 1) != -1&& -[BRCChecksummingOutputStream write:maxLength:](self->_stream, "write:maxLength:", &addItem_error__nul, 1) != -1)
  {
    ...
    if (!v8)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithPOSIXCode:description:", 22, CFSTR("NULL path for item: %@"), v6);
    ...
    if (-[BRCChecksummingOutputStream write:maxLength:](self->_stream, "write:maxLength:", v8, strlen(v8) + 1) != -1)
    {
        ...
        && -[BRCChecksummingOutputStream write:maxLength:](self->_stream, "write:maxLength:", &addItem_error__nul, 1) != -1)
      {
        if (objc_msgSend(v6, "type") == 3)
        {
          ...
          objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithPOSIXCode:description:", 22, CFSTR("NULL path for item symlink: %@"), v6);
          v16 = (id)objc_claimAutoreleasedReturnValue();
          if (!v16)
          {
LABEL_17:
...
- (void)addItem:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: _stream%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)addItem:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: NULL path for item: %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)addItem:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: NULL path for item symlink content: %@%@");
  OUTLINED_FUNCTION_0();
}
