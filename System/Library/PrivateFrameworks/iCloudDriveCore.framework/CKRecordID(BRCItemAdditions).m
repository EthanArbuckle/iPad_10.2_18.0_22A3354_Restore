...
+ (uint64_t)newFromSqliteValue:()BRCItemAdditions
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", sqlite3_value_text(a3));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithSqliteRepresentation:", v4);
...
+ (uint64_t)newFromSqliteStatement:()BRCItemAdditions atIndex:
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", sqlite3_column_text(a3, iCol));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithSqliteRepresentation:", v6);
...
LABEL_26:
  ...
  if (objc_msgSend(v8, "hasPrefix:", CFSTR("directory/")))
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithRecordZoneID:", v13);
...
- (id)brc_itemIDWithSession:()BRCItemAdditions
{
  ...
  if (!v5 && v10)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("brc_itemIDWithSession: are not supposed to trigger an error: %@"), v10);
...
- (void)brc_itemIDWithSession:()BRCItemAdditions error:
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v8, "isEqualToString:", *MEMORY[0x24BE17900]) & 1) != 0)
  {
    v9 = 0;
  }
  else
  {
    ...
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithRecordZoneID:", v7);
    ...
    if (!v12)
    {
      if (v9)
      {
        if (!a4)
          goto LABEL_8;
        objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 1004, CFSTR("Found appLibrary %@ with invalid dbRowID for zoneID %@"), v9, v7);
      }
      else
      {
        if (!a4)
          goto LABEL_8;
        objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 1004, CFSTR("Can't find appLibrary corresponding to zoneID %@"), v7, v16);
      }
...
+ (void)newFromSqliteValue:()BRCItemAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: sqlite3_value_type(value) == SQLITE_NULL%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
+ (void)newFromSqliteStatement:()BRCItemAdditions atIndex:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: sqlite3_column_type(stmt, index) == SQLITE_NULL%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)brc_appLibraryRootZoneName
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self.brc_isAppLibraryRootRecordID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)brc_appLibraryDocumentsZoneName
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: self.brc_isAppLibraryDocumentsRecordID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: libraryRowID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: libraryRowID || sharedZoneRowID || !([identifier isEqualToString:BRCItemIDZoneRoot] || [identifier isEqualToString:BRCItemIDDocuments])%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.5()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Corrupt side car file%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.6()
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, v2, "[CRIT] UNREACHABLE: attempt to extract an itemID from '%s'%@", v3);
...
- (void)brc_itemIDWithSession:()BRCItemAdditions .cold.1()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, v2, "[CRIT] %@%@", v3);
...
- (void)brc_itemType
{
  ...
  objc_msgSend(OUTLINED_FUNCTION_11_1(v1), "UTF8String");
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, v2, "[CRIT] UNREACHABLE: attempt to extract an itemType from '%s'%@", v3);
  OUTLINED_FUNCTION_2_0();
}
