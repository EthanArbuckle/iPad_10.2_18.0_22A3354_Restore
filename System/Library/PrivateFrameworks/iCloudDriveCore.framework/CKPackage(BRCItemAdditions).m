...
+ (void)destroyAnchorAndPackageAnchoredAtURL:()BRCItemAdditions
{
  ...
  if (objc_msgSend(v3, "checkResourceIsReachableAndReturnError:", 0))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 2112;
      v19 = v9;
      _os_log_debug_impl(&dword_230455000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Destroying anchor %@, databaseBasePath: %@, UUID: %@%@", (uint8_t *)&v12, 0x2Au);
    }

    if (v7)
      objc_msgSend(MEMORY[0x24BDB9198], "destroyClientPackageWithDatabaseBasePath:UUID:", v7, v8);
...
- (uint64_t)anchorAtURL:()BRCItemAdditions error:
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v29 = 2112;
    v30 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Anchoring %@ at %@ (db at %@)%@", buf, 0x2Au);
  ...
  objc_msgSend(MEMORY[0x24BDD1770], "dataWithPropertyList:format:options:error:", v11, 100, 0, a4);
...
+ (void)destroyAnchorAndPackageAnchoredAtURL:()BRCItemAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_debug_impl(&dword_230455000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Destroying anchor %@%@", v1, 0x16u);
}
...
- (void)anchorAtURL:()BRCItemAdditions error:.cold.1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_230455000, v0, (os_log_type_t)0x90u, "[ERROR] Unable to serialize property list - %@%@", v1, 0x16u);
}
