...
- (void)captureLogsForOperationType:(id)a3 ofSubtype:(id)a4 withContext:(id)a5 waitForCompletion:(BOOL)a6
{
    ...
    if (v17 + v16 < brc_current_date_nsec())
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138413314;
        ...
        v36 = 2112;
        v37 = v18;
        _os_log_debug_impl(&dword_230455000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] Not sending recently rejected ABC report with signature: type = %@, subtype = %@, subtype context = %@, rejected time = %@%@", buf, 0x34u);
      }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138413058;
    ...
    v34 = 2112;
    v35 = v20;
    _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] Sending ABC report with signature: type = %@, subtype = %@, subtype context = %@%@", buf, 0x2Au);
  }

  v13 = objc_alloc_init(MEMORY[0x24BEB3478]);
...
void __97__BRCAutoBugCaptureReporter_captureLogsForOperationType_ofSubtype_withContext_waitForCompletion___block_invoke_11(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BEB3558]);
  ...
  else
  {
    ...
    {
      objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BEB3528]);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BEB3530]);
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ABC report got rejected - error code = %@, description = %@ adding throttle (%@, %@)%@", (uint8_t *)&v13, 0x34u);
...
- (BOOL)_shouldIgnoreReportForOperationType:(id)a3 ofSubtype:(id)a4 forError:(id)a5
{
  ...
  if (!objc_msgSend(v7, "isEqualToString:", CFSTR("SyncHealth"))
    ...
    || (objc_msgSend(v9, "domain"),
        v10 = (void *)objc_claimAutoreleasedReturnValue(),
        v11 = objc_msgSend(v10, "isEqualToString:", *MEMORY[0x24BDB8EA8]),
        v10,
        !v11))
  {
LABEL_9:
...
void __97__BRCAutoBugCaptureReporter_captureLogsForOperationType_ofSubtype_withContext_waitForCompletion___block_invoke_11_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_230455000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] Sent ABC report successfully%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)_shouldIgnoreReportForOperationType:(void *)a1 ofSubtype:(const char *)a2 forError:.cold.1(void *a1, const char *a2)
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_0_1(&dword_230455000, v2, v3, "[DEBUG] Ignoring expected CK error %ld%@", v4, v5, v6, v7, v8);
...
- (void)_shouldIgnoreReportForOperationType:(void *)a1 ofSubtype:(const char *)a2 forError:.cold.2(void *a1, const char *a2)
{
  ...
  OUTLINED_FUNCTION_3_1(a1, a2);
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_0_1(&dword_230455000, v2, v3, "[DEBUG] Ignoring expected CK 'cross-zone migration already done' error %ld%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_2_0();
}
...
- (void)_shouldIgnoreReportForOperationType:(void *)a1 ofSubtype:(const char *)a2 forError:.cold.3(void *a1, const char *a2)
{
  ...
  OUTLINED_FUNCTION_3_1(a1, a2);
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_0_1(&dword_230455000, v2, v3, "[DEBUG] Ignoring CloudKit open error (Operation not permitted) protected class error %ld%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_2_0();
}
