...
- (void)perform
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v25 = 2112;
    v26 = v3;
    _os_log_debug_impl(&dword_230455000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx performing migration for %@%@", buf, 0x20u);
  }
  ...
  v18 = v8;
  v19 = self;
  v9 = (void *)MEMORY[0x2348BA0DC](v17);
  if (v8)
  {
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE04920]), "initWithAccount:", v8);
...
void __29__BRCAccountMigrator_perform__block_invoke_90(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    v26 = 2112;
    v27 = v10;
    _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Setting migration state. response: %@, error: %@%@", buf, 0x2Au);
  }
...
void __29__BRCAccountMigrator_perform__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: handler%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __29__BRCAccountMigrator_perform__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_8(&dword_230455000, v0, v1, "[DEBUG] migration completed%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __29__BRCAccountMigrator_perform__block_invoke_90_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] status: %@%@");
  OUTLINED_FUNCTION_0();
}
