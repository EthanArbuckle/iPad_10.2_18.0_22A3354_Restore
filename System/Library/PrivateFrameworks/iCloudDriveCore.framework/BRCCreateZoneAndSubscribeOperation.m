...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "create-zone", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !_optimisticSubscribe%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_createZoneWithZoneID:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91F0]), "initWithZoneID:", v4);
  v6 = objc_alloc(MEMORY[0x24BDB9150]);
  v18[0] = v5;
...
- (void)_registerSubscriptionForZoneID:(id)a3 isOptimisticSubscribe:(BOOL)a4
{
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9210]), "initWithZoneID:subscriptionID:", v6, v8);
  v10 = objc_alloc_init(MEMORY[0x24BDB9178]);
  objc_msgSend(v10, "setShouldSendContentAvailable:", 1);
  objc_msgSend(v9, "setNotificationInfo:", v10);
  v11 = objc_alloc(MEMORY[0x24BDB9160]);
  v27[0] = v9;
...
void __91__BRCCreateZoneAndSubscribeOperation__registerSubscriptionForZoneID_isOptimisticSubscribe___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    v30 = 2112;
    v31 = v12;
    _os_log_debug_impl(&dword_230455000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Handling result of creating %@ (operationID=%@): %@%@", buf, 0x34u);
...
void __60__BRCCreateZoneAndSubscribeOperation__createZoneWithZoneID___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: savedZones.count == 1%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_registerSubscriptionForZoneID:isOptimisticSubscribe:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: !self->_syncContext.isShared%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
void __91__BRCCreateZoneAndSubscribeOperation__registerSubscriptionForZoneID_isOptimisticSubscribe___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  _os_log_debug_impl(&dword_230455000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] optimistic subscribe failed with Zone Not Found, try to create the zone first%@", v1, 0xCu);
  OUTLINED_FUNCTION_0();
}
