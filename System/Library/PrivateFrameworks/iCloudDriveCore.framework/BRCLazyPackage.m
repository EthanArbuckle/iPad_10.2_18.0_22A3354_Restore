...
- (BOOL)addItem:(id)a3 error:(id *)a4
{
  ...
  v32 = 0;
  objc_msgSend(MEMORY[0x24BDB9198], "br_packageWithBoundaryKey:error:", boundaryKey, &v32);
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v39 = 2112;
      v40 = v22;
      _os_log_impl(&dword_230455000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to anchor package %@ at %@: %@%@", buf, 0x2Au);
  ...
  if ((v18 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v39 = 2112;
      v40 = v26;
      _os_log_impl(&dword_230455000, v27, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to open package %@ at %@: %@%@", buf, 0x2Au);
...
- (void)addItem:(os_log_t)log error:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_error_impl(&dword_230455000, log, (os_log_type_t)0x90u, "[ERROR] Failed to create package: %@%@", (uint8_t *)&v3, 0x16u);
}
