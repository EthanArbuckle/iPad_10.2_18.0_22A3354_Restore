...
LABEL_6:
    ...
    if ((objc_msgSend(v41, "isNonDesktopRoot") & 1) != 0)
    {
      ...
      if ((objc_msgSend(v42, "isCloudDocsZone") & 1) != 0)
      {
        ...
        if ((objc_msgSend(v44, "isEqualToString:", *MEMORY[0x24BE17568]) & 1) == 0)
        {
          objc_msgSend(v10, "st");
          ...
          v48 = objc_msgSend(v45, "isEqualToString:", *MEMORY[0x24BE17578]);
...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sharing/clean-subitems", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
void __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke(uint64_t a1)
{
    ...
    do
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v51 = 2112;
        v52 = v8;
        _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Removing shareID %@%@", buf, 0x16u);
      ...
      do
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v51 = 2112;
          v52 = v27;
          _os_log_debug_impl(&dword_230455000, v28, OS_LOG_TYPE_DEBUG, "[DEBUG] Removing alias record %@%@", buf, 0x16u);
        }
  ...
  {
    v31 = objc_alloc(MEMORY[0x24BDB9158]);
    ...
    v40[1] = 3221225472;
    v40[2] = __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_311;
    v40[3] = &unk_24FE481F8;
    v40[4] = *(_QWORD *)(v19 + 32);
    v35 = v37;
    v41 = v37;
...
void __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_311(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  id v6;
  id v7;
  void *v8;
  ...
  v9 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_311_cold_1();
  ...
  else
  {
    ...
    if (v7)
    {
      ...
      block[1] = 3221225472;
      block[2] = __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_312;
...
uint64_t __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_312(uint64_t a1)
{
...
- (BOOL)_completeAfterProcessingClientTruthIfNecessaryWithError:(id)a3
{
  ...
  if (!a3)
  {
    ...
    if (v5)
    {
      ...
      v28[1] = 3221225472;
      v28[2] = __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingClientTruthIfNecessaryWithError___block_invoke;
      v28[3] = &unk_24FE48220;
      v29 = v5;
      v11 = v6;
      v30 = v11;
      v12 = v7;
      v31 = v12;
      v13 = (void *)MEMORY[0x2348BA0DC](v28);
    ...
    {
      objc_msgSend(MEMORY[0x24BDD1540], "brc_errorInvalidParameter:value:", CFSTR("zoneRowID"), 0);
      v20 = (id)objc_claimAutoreleasedReturnValue();
      -[_BRCOperation completedWithResult:error:](self, "completedWithResult:error:", 0, v20);
    }
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingClientTruthIfNecessaryWithError___block_invoke_2(uint64_t a1)
{
    ...
    do
    {
      ...
      do
      {
        ...
        if (v9)
        {
          ...
          v24 = *(id *)(a1 + 72);
          v23 = *(id *)(a1 + 48);
          objc_msgSend(v10, "getUserVisibleURLForItemIdentifier:completionHandler:", v12, v21);
  ...
  v17[1] = 3221225472;
  v17[2] = __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingClientTruthIfNecessaryWithError___block_invoke_318;
  v17[3] = &unk_24FE3FA88;
  v18 = *(id *)(a1 + 56);
  v15 = *(id *)(a1 + 64);
  v16 = *(_QWORD *)(a1 + 32);
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingClientTruthIfNecessaryWithError___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v14 = 2112;
      v15 = v7;
      _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Got an error while computing the URL of %@ - %@%@", (uint8_t *)&v10, 0x20u);
    }
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingClientTruthIfNecessaryWithError___block_invoke_318(uint64_t a1)
{
  id v2;

  objc_msgSend(MEMORY[0x24BDD1540], "brc_errorFolderHasSharedSubitemsWithSharedByMeURLs:sharedToMeURLs:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40));
  v2 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 48), "completedWithResult:error:", 0, v2);
      ...
      if ((v16 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412802;
          ...
          v41 = 2112;
          v42 = v19;
          _os_log_impl(&dword_230455000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't parse unsalted bookmark data %@ - %@%@", buf, 0x20u);
        }
        goto LABEL_18;
      }
...
LABEL_16:
        _os_log_impl(&dword_230455000, v25, OS_LOG_TYPE_DEFAULT, v26, buf, 0x16u);
      }
LABEL_17:
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke(uint64_t a1)
{
  ...
  v16[1] = v16;
  v16[2] = 0x3032000000;
  v16[3] = __Block_byref_object_copy__44;
  v16[4] = __Block_byref_object_dispose__44;
  v17 = (id)objc_opt_new();
  v2 = MEMORY[0x24BDAC760];
  v15[0] = MEMORY[0x24BDAC760];
  v15[1] = 3221225472;
  v15[2] = __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke_327;
  v15[3] = &unk_24FE48298;
  v15[4] = *(_QWORD *)(a1 + 32);
  v15[5] = v18;
  v15[6] = v16;
  v3 = (void *)MEMORY[0x2348BA0DC](v15);
  objc_msgSend(*(id *)(a1 + 40), "appLibraryByRowID:", *(_QWORD *)(*(_QWORD *)(a1 + 32) + 608));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDC83F0], "br_sharedProviderManager");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "rootFileObjectID");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "asString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = v2;
  v11[1] = 3221225472;
  v11[2] = __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke_2;
  v11[3] = &unk_24FE42730;
  v8 = *(id *)(a1 + 40);
  v9 = *(_QWORD *)(a1 + 32);
  v12 = v8;
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke_327(uint64_t a1, void *a2)
{
  id v3;
  id v4;
  uint64_t v5;
  ...
  objc_msgSend(MEMORY[0x24BDD1540], "brc_errorFolderHasSharedSubitemsWithSharedByMeURLs:sharedToMeURLs:", *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 40), *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 40));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  v5 = a2;
  v6 = a3;
  objc_msgSend(*(id *)(a1 + 32), "serverTruthWorkloop");
...
void __85__BRCSharingProcessFolderSubitemsOperation_processServerItemsUnderItemID_completion___block_invoke(uint64_t a1)
{
  ...
  while (objc_msgSend(v7, "next"))
  {
    ...
    v53 = v14;
    v54 = v55;
    v15 = (void (**)(_QWORD))MEMORY[0x2348BA0DC](v50);
    v16 = v11;
    if ((v11 & 4) != 0)
    {
      v24 = *(_QWORD *)(a1 + 32);
      if ((v11 & 0x48) != 0 && *(_QWORD *)(v24 + 544) != 2)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v61 = 2112;
          v62 = v34;
          _os_log_impl(&dword_230455000, v35, OS_LOG_TYPE_DEFAULT, "[WARNING] subitem %@ is already shared inside %@%@", buf, 0x20u);
        }
        ...
        if ((objc_msgSend(*(id *)(v17 + 568), "containsObject:", v14) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            v61 = 2112;
            v62 = v22;
            _os_log_debug_impl(&dword_230455000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] Found shared-to-me alias to delete %@ in %@%@", buf, 0x20u);
          }
      ...
      if (v10 - 9 > 1)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v59 = 2112;
          v60 = v32;
          _os_log_fault_impl(&dword_230455000, v37, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Huh?  We shouldn't be processing this item if it's not shared and not a directory fault %@%@", buf, 0x16u);
        }
...
LABEL_31:
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v59 = 2112;
        v60 = v30;
        _os_log_debug_impl(&dword_230455000, v31, OS_LOG_TYPE_DEBUG, "[DEBUG] We need to fetch %@ before we can continue%@", buf, 0x16u);
      }
      ...
      if ((objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 584), "containsObject:", v32) & 1) == 0)
      {
        ...
        v45[1] = 3221225472;
        v45[2] = __85__BRCSharingProcessFolderSubitemsOperation_processServerItemsUnderItemID_completion___block_invoke_334;
        v45[3] = &unk_24FE482C0;
        v45[4] = *(_QWORD *)(a1 + 32);
...
LABEL_32:
  ...
  block[0] = MEMORY[0x24BDAC760];
  block[1] = 3221225472;
  block[2] = __85__BRCSharingProcessFolderSubitemsOperation_processServerItemsUnderItemID_completion___block_invoke_336;
  block[3] = &unk_24FE482E8;
...
void __85__BRCSharingProcessFolderSubitemsOperation_processServerItemsUnderItemID_completion___block_invoke_334(uint64_t a1, void *a2)
{
  id v4;
  void *v5;
  id WeakRetained;
...
void __85__BRCSharingProcessFolderSubitemsOperation_processServerItemsUnderItemID_completion___block_invoke_336(uint64_t a1)
{
  id obj;
...
- (BOOL)deleteShareInfoFromZone:(id)a3 zoneRowID:(id)a4 itemID:(id)a5 sharingOptions:(unint64_t)a6 itemsTable:(id)a7
{
  ...
  objc_msgSend(MEMORY[0x24BEDD640], "nameWithString:", v15);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  if (((1 << v24) & 0x611) == 0)
  {
    if (((1 << v24) & 0x106) != 0)
    {
      v32 = objc_alloc(MEMORY[0x24BDB91D8]);
      objc_msgSend(v12, "zoneID");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v26 = objc_alloc(MEMORY[0x24BDB91D8]);
...
LABEL_10:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 136315650;
    ...
    v46 = 2112;
    v47 = v36;
    _os_log_debug_impl(&dword_230455000, v37, OS_LOG_TYPE_DEBUG, "[DEBUG] deleting %s shareID %@%@", buf, 0x20u);
  }
...
void __77__BRCSharingProcessFolderSubitemsOperation_processClientTruthWithCompletion___block_invoke(_QWORD *a1)
{
  void *v2;
  void *v3;
  void *v4;
  ...
  objc_msgSend(*(id *)(a1[4] + 248), "session");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "itemByRowID:db:", *(_QWORD *)(a1[4] + 520), a1[5]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v11 = v4;
  v6 = v4;
  objc_msgSend(v5, "enumerateItemsWithShareIDUnderParent:block:", v6, v10);
  (*(void (**)(_QWORD, _QWORD, uint64_t, uint64_t, uint64_t))(a1[7] + 16))(a1[7], 0, v7, v8, v9);

}

void __77__BRCSharingProcessFolderSubitemsOperation_processClientTruthWithCompletion___block_invoke_2(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  id v7;
  void *v8;
  void *v9;
  ...
  if ((a3 & 0x48) != 0 && *(_QWORD *)(*(_QWORD *)(a1 + 32) + 544) != 2)
  {
    brc_bread_crumbs();
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    brc_default_log();
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v29 = 2112;
      v30 = v18;
      _os_log_impl(&dword_230455000, v19, OS_LOG_TYPE_DEFAULT, "[WARNING] subitem %@ is already shared inside %@%@", (uint8_t *)&v25, 0x20u);
    }

    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 552), "addObject:", v7);
    v21 = *(_QWORD *)(a1 + 32);
    v22 = *(_QWORD *)(v21 + 536);
  ...
  else
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 592), "dbRowID");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 592), "itemMovedIntoShareInThisZone:associatedItemID:", v17, 0);
    }
  }
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Not processing child items on %@ because it already has a shareID%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)removeSharedSubitemsWithCompletion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Removing shared subitems in op %@%@");
  OUTLINED_FUNCTION_0();
}

void __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_311_cold_1()
{
  uint64_t v0;
  os_log_t v1;

  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Remove share subitems batch completed with error - %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)computeURLForItemID:rootURL:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Can't find alias target for %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)computeURLForItemID:rootURL:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  _os_log_debug_impl(&dword_230455000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] an item in the path has a nil filename%@", v1, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
- (void)processServerItemsUnderItemID:completion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Processing server truth in op %@%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)deleteShareInfoFromZone:(os_log_t)log zoneRowID:itemID:sharingOptions:itemsTable:.cold.1(char a1, uint64_t a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a2;
  _os_log_fault_impl(&dword_230455000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Don't know how to unshare item of type %d%@", (uint8_t *)v3, 0x12u);
  OUTLINED_FUNCTION_0();
}
...
- (void)deleteShareInfoFromZone:zoneRowID:itemID:sharingOptions:itemsTable:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Can't locate the item type we are deleting?%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)processClientTruthWithCompletion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Processing client truth in op %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __77__BRCSharingProcessFolderSubitemsOperation_processClientTruthWithCompletion___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: (options & BRCSharingItemHasShareID) != 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
