...
- (void)_registerForBYSetupAssistantFinishedNotification
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    v6 = 138412290;
    v7 = v3;
    _os_log_impl(&dword_230455000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] Register for BYSetupAssistantFinishedDarwinNotification%@", (uint8_t *)&v6, 0xCu);
  }

  DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
  CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)_buddyHasFinished, (CFStringRef)*MEMORY[0x24BE85850], 0, CFNotificationSuspensionBehaviorDrop);
}
...
- (void)_unregisterForBYSetupAssistantFinishedNotification
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    v6 = 138412290;
    v7 = v3;
    _os_log_impl(&dword_230455000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] Unregister for BYSetupAssistantFinishedDarwinNotification%@", (uint8_t *)&v6, 0xCu);
  }

  DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
  CFNotificationCenterRemoveObserver(DarwinNotifyCenter, self, (CFNotificationName)*MEMORY[0x24BE85850], 0);
}
  ...
  if (-[BRCBuddyFlowObserver doesBuddyFlowNeedsToRun](self, "doesBuddyFlowNeedsToRun"))
  {
    ...
    if (-[BRCBuddyFlowObserver doesBuddyFlowNeedsToRun](v11, "doesBuddyFlowNeedsToRun"))
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v45 = v12;
        _os_log_impl(&dword_230455000, v13, OS_LOG_TYPE_DEFAULT, "[NOTICE] We are in Buddy. Register block [%@] with key [%@]%@", buf, 0x20u);
      }
        ...
        if (*(_QWORD *)(*(_QWORD *)&buf[8] + 40))
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)v40 = 138412546;
            ...
            v42 = 2112;
            v43 = v18;
            _os_log_impl(&dword_230455000, v19, OS_LOG_TYPE_DEFAULT, "[NOTICE] Key %@ already registered%@", v40, 0x16u);
          }
...
uint64_t __73__BRCBuddyFlowObserver_observeBuddyIfNecessaryWithKey_block_description___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 2112;
    v9 = v2;
    _os_log_impl(&dword_230455000, v3, OS_LOG_TYPE_DEFAULT, "[NOTICE] Buddy has finished. Execute block [%@]%@", (uint8_t *)&v6, 0x16u);
  }
...
uint64_t __73__BRCBuddyFlowObserver_observeBuddyIfNecessaryWithKey_block_description___block_invoke_6(_QWORD *a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 2112;
    v10 = v2;
    _os_log_impl(&dword_230455000, v3, OS_LOG_TYPE_DEFAULT, "[NOTICE] Buddy has finished. Execute block [%@]%@", (uint8_t *)&v7, 0x16u);
  }
    ...
    if (self->_waitingForBuddy)
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v10 = v3;
        _os_log_impl(&dword_230455000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] Unregister for BYSetupAssistantFinishedDarwinNotification%@", buf, 0xCu);
      }
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v11 = 2112;
        v12 = v5;
        _os_log_impl(&dword_230455000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] Trigger %@%@", buf, 0x16u);
      }
