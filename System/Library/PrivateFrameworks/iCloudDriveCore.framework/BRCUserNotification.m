...
- (id)_logWrapUserReplyBlock:(id)a3
{
  ...
  v10 = v3;
  v11 = v7;
  v12 = (void *)MEMORY[0x2348BA0DC](v14);
...
void __74__BRCUserNotification__displayDialogWithType_dict_options_userReplyBlock___block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)(v10 + 48) = v9;
  ...
  {
    ((void (*)(_QWORD *))*MEMORY[0x24BE17840])(v23);
  ...
  if (v4)
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 32) + 16) = CFUserNotificationCreateRunLoopSource(0, v3, (CFUserNotificationCallBack)_notificationCallback, 0);
    if (*(_QWORD *)(*(_QWORD *)(a1 + 32) + 16))
    {
      ...
      if (!v8)
        v8 = (const __CFString *)CFRetain((CFTypeRef)*MEMORY[0x24BDBD598]);
      userNotificationRefToCompletionBlock();
      v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!*(_QWORD *)(v1 + 40))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v16 = v6;
      _os_log_impl(&dword_230455000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] ignore user notification udate: no KVO observer registered%@", buf, 0xCu);
    }
...
- (id)_localizationKey:(id)a3 forTypeOfShare:(id)a4
{
  ...
  else
  {
    ...
    else
    {
      ...
      else if (objc_msgSend(v6, "isEqualToString:", *MEMORY[0x24BE177B0]))
      {
        v9 = CFSTR("_FOLDER");
      }
      else
...
LABEL_16:
        ...
        v30 = *MEMORY[0x24BDBD6E0];
        v44[0] = *MEMORY[0x24BDBD6D8];
        v44[1] = v30;
        v45[0] = v24;
        v45[1] = v29;
        v44[2] = *MEMORY[0x24BDBD6F0];
        objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class(), v15, v37);
        v31 = (void *)objc_claimAutoreleasedReturnValue();
        _BRLocalizedStringWithFormat();
        v32 = (void *)objc_claimAutoreleasedReturnValue();
        v45[2] = v32;
        v44[3] = *MEMORY[0x24BDBD6F8];
        objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
...
- (void)showErrorSignInToiCloudForShareMetadata:(id)a3 reply:(id)a4
{
  ...
  v23 = v9;
  v32[0] = *MEMORY[0x24BDBD6D8];
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  _BRLocalizedStringWithFormat();
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v33[0] = v26;
  v32[1] = *MEMORY[0x24BDBD6E0];
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v33[1] = v13;
  v32[2] = *MEMORY[0x24BDBD6F0];
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  _BRLocalizedStringWithFormat();
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v33[2] = v15;
  v32[3] = *MEMORY[0x24BDBD718];
...
- (void)showErrorTurnOniCloudDriveForShareMetadata:(id)a3 reply:(id)a4
{
  ...
  v37[0] = *MEMORY[0x24BDBD6D8];
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  _BRLocalizedStringWithFormat();
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  v38[0] = v30;
  v37[1] = *MEMORY[0x24BDBD6E0];
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v38[1] = v16;
  v37[2] = *MEMORY[0x24BDBD6F0];
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class(), v32);
  v17 = v9;
  v29 = v9;
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  _BRLocalizedStringWithFormat();
...
- (void)showErrorInstallNativeAppForShareMetadata:(id)a3 reply:(id)a4
{
  ...
  if (v12)
  {
    ...
    v35 = (void *)objc_claimAutoreleasedReturnValue();
    v47[1] = v35;
    v46[2] = *MEMORY[0x24BDBD6F0];
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class(), v36);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    _BRLocalizedStringWithFormat();
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "brc_errorInvalidParameter:value:", CFSTR("shareMetadata"), v6);
    v26 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)showErrorDocumentsAppNotVisibleForShareURL:(id)a3 reply:(id)a4
{
  ...
  v5 = a4;
  v6 = *MEMORY[0x24BEB0E00];
  v17[0] = MEMORY[0x24BDBD1C8];
  v7 = *MEMORY[0x24BDBD6D8];
  v16[0] = v6;
  v16[1] = v7;
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)showErrorVolumeNotSupportedWithReason:(unint64_t)a3
{
  ...
  v4 = CFSTR("ICLOUD_DRIVE_VOLUME_NOT_SUPPORTED_NON_LOCAL_ALERT_MESSAGE");
  if (a3 == 2)
    v4 = CFSTR("ICLOUD_DRIVE_VOLUME_NOT_SUPPORTED_NON_APFS_ALERT_MESSAGE");
  ...
  -[BRCUserNotification _displayDialogWithType:dict:userReplyBlock:](self, "_displayDialogWithType:dict:userReplyBlock:", 3, v13, &__block_literal_global_146);
}
...
- (void)_logWrapUserReplyBlock:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] User notification completion block should run with %@ persona%@");
  OUTLINED_FUNCTION_0();
}
...
- (void)_logWrapUserReplyBlock:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┣%llx updating dialog...%@");
  OUTLINED_FUNCTION_0();
}
...
void __46__BRCUserNotification__logWrapUserReplyBlock___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┳%llx sending user reply%@");
  OUTLINED_FUNCTION_0();
}
...
void __74__BRCUserNotification__displayDialogWithType_dict_options_userReplyBlock___block_invoke_2_cold_1(_DWORD *a1, uint64_t a2, NSObject *a3)
{
  ...
  LOWORD(v4) = 2112;
  *(_QWORD *)((char *)&v4 + 2) = a2;
  OUTLINED_FUNCTION_13(&dword_230455000, a2, a3, "[ERROR] can't create user notification: %d%@", v3, (_QWORD)v4, WORD4(v4));
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: self->_source == NULL%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
...
void __65__BRCUserNotification__updateDialogWithType_dict_userReplyBlock___block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  LOWORD(v4) = 2112;
  *(_QWORD *)((char *)&v4 + 2) = a1;
  OUTLINED_FUNCTION_13(&dword_230455000, a2, a3, "[ERROR] can't update user notification: %d%@", v3, (_QWORD)v4, WORD4(v4));
  OUTLINED_FUNCTION_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_230455000, a2, a3, "[CRIT] Assertion failed: !shareMetadata.share.isFolderShare%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_0();
}
