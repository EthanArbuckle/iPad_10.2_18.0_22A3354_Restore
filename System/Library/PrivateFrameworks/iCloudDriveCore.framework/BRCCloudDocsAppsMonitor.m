...
- (void)_refetchApps
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx refetching installed apps list%@");
  OUTLINED_FUNCTION_0();
}
      ...
      if (v10)
      {
        ...
        do
        {
          for (i = 0; i != v11; ++i)
          {
            ...
            if (!v15)
            {
              v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEF0]), "initWithCapacity:", 1);
...
- (void)forceRefetchAppList
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_230455000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] forced a refetch of the list of apps%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
- (void)_start
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx start monitoring cloud apps%@");
  OUTLINED_FUNCTION_0();
}
...
- (id)applicationIdentifiersForContainerID:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v18 = v5;
    _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx asked appIDs for %@%@", buf, 0x20u);
  }
...
- (id)containerIDsForApplicationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v18 = v5;
    _os_log_debug_impl(&dword_230455000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx asked containerIDs for %@%@", buf, 0x20u);
  }
...
- (BRCCloudDocsAppsMonitor)init
{
  ...
  if (v2)
  {
    ...
    br_pacer_resume();
    -[BRCCloudDocsAppsMonitor _start](v2, "_start", v21, 3221225472, __31__BRCCloudDocsAppsMonitor_init__block_invoke, &unk_24FE3F9C8);
...
- (void)applicationIdentifiersForContainerID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3_2(*MEMORY[0x24BDAC8D0]);
  OUTLINED_FUNCTION_3_0();
...
- (void)allApplicationIdentifiers
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx asked appIDs%@");
  OUTLINED_FUNCTION_0();
}
