...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sharing/destroy-share", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
void __39__BRCSharingDestroyShareOperation_main__block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(*(id *)(*(_QWORD *)v2 + 520), "isPrivateZone") & 1) != 0)
  {
    ...
    v12 = objc_alloc(MEMORY[0x24BDB9158]);
    if (v8)
    {
      v27[0] = v8;
...
LABEL_9:
  ...
  v19 = v6;
  v23 = v19;
  objc_msgSend(v18, "setModifyRecordsCompletionBlock:", v22);
...
void __39__BRCSharingDestroyShareOperation_main__block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v8 && !v11)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "br_errorWithDomain:code:description:", *MEMORY[0x24BE17430], 15, CFSTR("unreachable: got an unexpected number of shares deleted"));
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v15, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v39 = 2112;
      v40 = v14;
      _os_log_error_impl(&dword_230455000, v15, (os_log_type_t)0x90u, "[ERROR] failed to destroy share %@: %@ in %@%@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v37 = 2112;
      v38 = v19;
      _os_log_debug_impl(&dword_230455000, v20, OS_LOG_TYPE_DEBUG, "[DEBUG] destroyed share %@ in %@%@", buf, 0x20u);
    ...
    *(_QWORD *)(v21 + 528) = 0;
    ...
    if (v23)
    {
      objc_msgSend(v23, "fileObjectID");
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v24, "asString");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      v30[0] = MEMORY[0x24BDAC760];
      v30[1] = 3221225472;
      v30[2] = __39__BRCSharingDestroyShareOperation_main__block_invoke_146;
      v30[3] = &unk_24FE408B8;
      v26 = *(_QWORD *)(a1 + 32);
      v31 = v24;
      v32 = v26;
      v27 = v24;
      +[BRCImportUtil forceIngestionForItemID:completionHandler:](BRCImportUtil, "forceIngestionForItemID:completionHandler:", v25, v30);

    }
    else
    {
      objc_msgSend(*(id *)(a1 + 32), "completedWithResult:error:", MEMORY[0x24BDBD1C8], 0);
    }
  }

}

void __39__BRCSharingDestroyShareOperation_main__block_invoke_146(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  NSObject *v5;
  ...
  objc_msgSend(*(id *)(a1 + 40), "completedWithResult:error:", MEMORY[0x24BDBD1C8], 0);
}
...
void __39__BRCSharingDestroyShareOperation_main__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: got an unexpected number of shares deleted%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
