...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_knownToServer);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_wasCached);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)newFromSqliteValue:(sqlite3_value *)a3
{
  ...
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCE50]), "initWithBytesNoCopy:length:freeWhenDone:", v5, sqlite3_value_bytes(a3), 0);
...
+ (id)newFromSqliteStatement:(sqlite3_stmt *)a3 atIndex:(int)a4
{
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCE50]), "initWithBytesNoCopy:length:freeWhenDone:", v7, sqlite3_column_bytes(a3, a4), 0);
