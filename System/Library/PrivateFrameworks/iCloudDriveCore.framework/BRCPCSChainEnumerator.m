...
LABEL_19:
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = v24;
      ...
      v27 = 2112;
      v28 = v7;
      _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Enumerating pcs under new directory %@%@", buf, 0x16u);
  ...
  objc_msgSend(MEMORY[0x24BDD1540], "brc_errorFolderHierarchyTooDeep");
  v17 = (objc_class *)objc_claimAutoreleasedReturnValue();
  v18 = 32;
LABEL_21:
...
- (void)initWithPCSChainInfo:(NSObject *)a3 clientZone:.cold.1(_QWORD *a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(_QWORD *)&v3[14] = a2;
  OUTLINED_FUNCTION_1_0(&dword_230455000, a2, a3, "[DEBUG] We need to list the root item %@%@", *(_QWORD *)v3, *(_QWORD *)&v3[8], *(_QWORD *)&v3[16]);
  OUTLINED_FUNCTION_0();
}
...
- (void)nextObject
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_3(&dword_230455000, a3, v5, "[DEBUG] We need to list %@%@", v6);
