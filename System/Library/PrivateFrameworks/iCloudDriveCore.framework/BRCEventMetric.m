...
- (void)associateWithCompletedOperation:(id)a3
{
  ...
  if (self->_isCKMetric)
  {
    ...
    {
      v6 = (CKEventMetric *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9098]), "initWithEventName:", self->_eventName);
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v14 = 2112;
      v15 = v8;
      _os_log_debug_impl(&dword_230455000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] associated %@ to event metric %@%@", (uint8_t *)&v10, 0x20u);
    }
