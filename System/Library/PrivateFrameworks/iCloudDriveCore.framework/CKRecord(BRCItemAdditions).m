...
- (uint64_t)brc_isInterestingRecordForSyncDown
{
  ...
  if (!objc_msgSend(v2, "isEqualToString:", CFSTR("structure")))
  {
    ...
    {
      v9 = objc_msgSend(v2, "isEqualToString:", *MEMORY[0x24BDB8F28]);
      goto LABEL_16;
    }
...
- (id)brc_lastModifiedUserRecordNameWithCurrentUserRecordName:()BRCItemAdditions personNameComponents:
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v32 = 0;
  objc_msgSend(MEMORY[0x24BDD1608], "JSONObjectWithData:options:error:", v8, 0, &v32);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v37 = 2112;
        v38 = v16;
        _os_log_fault_impl(&dword_230455000, v17, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid lastEditorDeviceName on %@: %@%@", buf, 0x20u);
...
- (uint64_t)brc_currentUserOwnsLastEditorDeviceWithSessionContext:()BRCItemAdditions
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDB8E88]);
...
- (id)brc_lastEditorDeviceName
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = 0;
  objc_msgSend(MEMORY[0x24BDD1608], "JSONObjectWithData:options:error:", v3, 0, &v15);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = v15;
  objc_opt_class();
  v6 = 0;
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v20 = 2112;
      v21 = v11;
      _os_log_fault_impl(&dword_230455000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid lastEditorDeviceName on %@: %@%@", buf, 0x20u);
...
+ (id)rootDirectoryRecordForZoneID:()BRCItemAdditions
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithRecordName:zoneID:", v4, v3);

  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithRecordType:recordID:", CFSTR("structure"), v5);
...
+ (id)rootAppLibraryRecordForAppLibraryID:()BRCItemAdditions zoneID:
{
  ...
  else
  {
    ...
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithRecordName:zoneID:", v24, v6);
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithRecordType:recordID:", CFSTR("structure"), v16);
    objc_msgSend(CFSTR("directory/"), "stringByAppendingString:", CFSTR("root"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91E8]), "initWithRecordName:zoneID:", v17, v6);
    v19 = objc_alloc(MEMORY[0x24BDB9218]);
    v20 = (void *)objc_msgSend(v19, "initWithRecordID:action:", v18, *MEMORY[0x24BDB8F40]);
...
+ (id)desiredKeysWithMask:()BRCItemAdditions
{
  ...
  if ((a3 & 1) != 0)
  {
    ...
    v26[23] = v7;
    v26[24] = *MEMORY[0x24BDB8F50];
    v26[25] = CFSTR("childBasehashSalt");
    v26[26] = CFSTR("childBasehashSaltValidationKey");
    v26[27] = CFSTR("saltingState");
    v26[28] = CFSTR("basehashSaltValidationKey");
    objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v26, 29);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((a3 & 0xC) != 0)
  {
    ...
    v25[3] = CFSTR("boundaryKey");
    v25[4] = CFSTR("boundaryKeyValidationKey");
...
LABEL_11:
  ...
  {
LABEL_12:
    v10 = *MEMORY[0x24BDB8FD0];
    v21[0] = *MEMORY[0x24BDB8FD8];
    v21[1] = v10;
...
- (uint64_t)validateEnhancedDrivePrivacyFieldsWithSession:()BRCItemAdditions error:
{
  ...
  v76[7] = *MEMORY[0x24BDAC8D0];
  v5 = a3;
  v6 = objc_alloc(MEMORY[0x24BE17640]);
  objc_msgSend(a1, "recordID");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v76, 7);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_3:
              ...
              if (objc_msgSend(v55, "count"))
              {
                ...
                if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
                {
                  *(_DWORD *)buf = v51;
                  ...
                  v69 = 2112;
                  v70 = v24;
                  _os_log_fault_impl(&dword_230455000, v25, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ has different boundary key then other assets in the record!%@", buf, 0x16u);
                }
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v73 = 2112;
      v74 = v34;
      _os_log_impl(&dword_230455000, v35, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ is%s in mmcsV2 when it should%s be%@", buf, 0x2Au);
    }
...
- (void)brc_fillWithChildBasehashSalt:()BRCItemAdditions
{
  ...
  if (v13 && v5)
  {
    ...
    if (v7)
    {
      ...
      {
        v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", 1);
      }

      objc_msgSend(v10, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("br_bougusSaltingKey"));
...
+ (void)rootAppLibraryRecordForAppLibraryID:()BRCItemAdditions zoneID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: rootAppLibraryRecordForAppLibraryID: should not be called with a bogus app library id %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
+ (void)_validateCKObject:()BRCItemAdditions enhancedDrivePrivacyEnabled:.cold.1()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: CKObject of unexpected type - %@%@", v1);
  OUTLINED_FUNCTION_0();
}
...
- (void)validateEnhancedDrivePrivacyFieldsWithSession:()BRCItemAdditions error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: Rounding amount should be at least 1 minute%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)validateEnhancedDrivePrivacyFieldsWithSession:()BRCItemAdditions error:.cold.2()
{
  ...
  v2 = *MEMORY[0x24BDAC8D0];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: %@ is not rounded the correct amount%@", v1);
  OUTLINED_FUNCTION_0();
}
