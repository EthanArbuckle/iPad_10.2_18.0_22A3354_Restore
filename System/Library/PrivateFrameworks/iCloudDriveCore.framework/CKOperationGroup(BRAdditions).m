...
+ (id)br_syncDownAppLaunch
{
  ...
  v0 = objc_alloc_init(MEMORY[0x24BDB9190]);
  v1 = (void *)MEMORY[0x24BDD17C8];
  v2 = objc_msgSend(MEMORY[0x24BEBF268], "br_isInSyncBubble");
  v3 = "";
  if (v2)
    v3 = " (SB)";
...
+ (id)br_operationGroupWithName:()BRAdditions
{
  ...
  v3 = (objc_class *)MEMORY[0x24BDB9190];
  v4 = a3;
  v5 = objc_alloc_init(v3);
  v6 = (void *)MEMORY[0x24BDD17C8];
  v7 = objc_msgSend(MEMORY[0x24BEBF268], "br_isInSyncBubble");
  v8 = "";
  if (v7)
    v8 = " (SB)";
