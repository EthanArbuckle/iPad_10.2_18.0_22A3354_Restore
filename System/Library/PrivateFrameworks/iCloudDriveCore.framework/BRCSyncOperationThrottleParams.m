...
LABEL_18:
      _os_log_error_impl(&dword_230455000, v11, (os_log_type_t)0x90u, v12, buf, 0x20u);
    }
LABEL_13:
...
- (id)paramsToDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->minWait);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v13[0] = v3;
  v12[1] = CFSTR("wait-at-most");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->maxWait);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v13[1] = v4;
  v12[2] = CFSTR("success-ratio");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->ratioOnSuccess);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13[2] = v5;
  v12[3] = CFSTR("quota-clear-ratio");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->ratioOnQuotaErrorClear);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v13[3] = v6;
  v12[4] = CFSTR("error-ratio");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->ratioOnFailure);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v13[4] = v7;
  v12[5] = CFSTR("kickback-delay");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->inactivityKickbackDelay);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v13[5] = v8;
  v12[6] = CFSTR("kickback-ratio");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->inactivityKickbackRatio);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v13[6] = v9;
