...
- (id)itemIDString
{
  ...
  switch(kind)
  {
    ...
    case 4:
      ...
      return (id)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithBytes:length:encoding:", v11, 36, 4);
    case 1:
    case 5:
      return v5;
    case 2:
...
LABEL_8:
    ...
    if (!v7 || !objc_msgSend(v7, "unsignedLongLongValue"))
    {
      ...
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("can't initialize library root with invalid library rowid %@"), v7);
...
- (void)itemIDString
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] UNREACHABLE: we should not have alias uuid types anymores%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)initWithRootObject:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: object->item_code == 1 || object->item_code == 2%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)initWithUUIDObject:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: object->item_code == 4 || object->item_code == 5%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)sqliteBind:index:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: rio.app_lib_rowid%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)sqliteBind:index:.cold.4()
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_230455000, v0, v1, "[CRIT] Assertion failed: uio.app_lib_rowid%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_0();
}
...
- (void)_initAsLibraryRootWithAppLibraryRowID:enclosureUUID:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: invalid enclosure uuid - %@%@", v1);
  OUTLINED_FUNCTION_0();
}
