...
- (void)_addThumbnailGenerationJobAtURL:(id)a3 targetURL:(id)a4 thumbnailID:(id)a5 timeout:(id)a6 syncContext:(id)a7 completionHandler:(id)a8
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v54 = v21;
    _os_log_debug_impl(&dword_230455000, v22, OS_LOG_TYPE_DEBUG, "[DEBUG] Generating thumbnail for ID %@ (shouldTransferThumbnail:yes) %@%@", block, 0x20u);
  }
  ...
  if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v54 = v31;
    _os_log_debug_impl(&dword_230455000, v32, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx dispatching to %s%@", block, 0x20u);
  }
...
void __125__BRCThumbnailGenerationManager__addThumbnailGenerationJobAtURL_targetURL_thumbnailID_timeout_syncContext_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      v13 = 2112;
      v14 = v5;
      _os_log_error_impl(&dword_230455000, v6, (os_log_type_t)0x90u, "[ERROR] Thumbnail creation of %@ failed with error: %@%@", (uint8_t *)&v9, 0x20u);
    }
...
void __68__BRCThumbnailGenerationManager__addThumbnailOperation_thumbnailID___block_invoke_cold_1(uint64_t a1)
{
  ...
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_0_1(&dword_230455000, v1, v2, "[DEBUG] Thumbnail manager: reached maximum allowed number of thumbnails retrieval (%ld)%@", v3, v4, v5, v6, v7);
...
void __73__BRCThumbnailGenerationManager__removeThumbnailOperationForThumbnailID___block_invoke_cold_1(uint64_t a1)
{
  ...
  OUTLINED_FUNCTION_1_3(a1);
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_0_1(&dword_230455000, v1, v2, "[DEBUG] Thumbnail manager: below maximum allowed number of thumbnails retrieval (%ld)%@", v3, v4, v5, v6, v7);
  OUTLINED_FUNCTION_2_0();
}
