...
- (int64_t)resolveRecordType
{
  ...
  else
  {
    ...
    v6 = objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDB8F28]);
...
- (void)initWithRecordIDNeedingFetch:(_QWORD *)a1 recordType:.cold.1(_QWORD *a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v1, v2, "[DEBUG] initWithRecordIDNeedingFetch: %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_0();
}
...
- (void)resolveRecordType
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_0(&dword_230455000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: Unsuported record type %@%@", v1);
  OUTLINED_FUNCTION_0();
}
