...
- (id)createActivity
{
  return _os_activity_create(&dword_230455000, "sync-down/container-metadata", MEMORY[0x24BDACB08], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)performAfterCreatingZoneIfNeeded:(id)a3
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x24BDB91F8], "brc_containerMetadataZoneID");
...
- (void)performAfterFetchingRecordChanges:(id)a3
{
  ...
  v12 = objc_alloc(MEMORY[0x24BDB90C8]);
  v60[0] = v5;
  ...
  objc_msgSend(v17, "setSourceApplicationBundleIdentifier:", *MEMORY[0x24BE17540]);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v57 = v18;
    _os_log_debug_impl(&dword_230455000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx starting fetch container-metadata changes operation %@%@", buf, 0x20u);
  }
  ...
  *(_QWORD *)&buf[16] = 0x2020000000;
  ...
  objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithObjects:", CFSTR("infoPlist"), 0, v32, v33, v34, v35);
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingRecordChanges___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    v68 = 2112;
    v69 = v4;
    _os_log_debug_impl(&dword_230455000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got container-metadata changes for %@ keys:%@ changeTag:%@ modified:%@%@", buf, 0x3Eu);
  ...
  v7 = (void *)v46;
  if ((objc_msgSend(MEMORY[0x24BE17640], "validateContainerID:", v46) & 1) != 0)
  {
    v54 = 0;
    v45 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE17640]), "initWithAppLibraryName:", v46);
...
LABEL_19:
    ...
    {
      v53 = 0;
      objc_msgSend(MEMORY[0x24BDD1770], "propertyListWithData:options:format:error:", v12, 0, 0, &v53, v12);
      ...
      if (!v13)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412802;
          ...
          v62 = 2112;
          v63 = (uint64_t)v20;
          _os_log_debug_impl(&dword_230455000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] received container-metadata properties plist %@ for %@%@", buf, 0x20u);
        }

        if (!objc_msgSend(MEMORY[0x24BE175F8], "isDocumentScopePublicWithProperties:mangledID:", v44, v45))
        {
          v17 = 1;
          goto LABEL_15;
        }
              ...
              if ((v27 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
                {
                  ...
                  *(_DWORD *)buf = 138412802;
                  ...
                  v62 = 2112;
                  v63 = v17;
                  _os_log_debug_impl(&dword_230455000, v28, OS_LOG_TYPE_DEBUG, "[DEBUG] we'll download icon %@ for container %@%@", buf, 0x20u);
...
LABEL_15:
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            v62 = 2112;
            v63 = (uint64_t)v18;
            _os_log_debug_impl(&dword_230455000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] updating container-metadata %@ at etag:%@ (no asset downloaded)%@", buf, 0x20u);
...
LABEL_14:
      ...
      if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v62 = 2112;
        v63 = (uint64_t)v15;
        _os_log_error_impl(&dword_230455000, v16, (os_log_type_t)0x90u, "[ERROR] failed parsing container-metadata plist for container %@: %@%@", buf, 0x20u);
      }
  ...
  *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 24) = 1;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134219266;
    ...
    v42 = 2112;
    v43 = v15;
    _os_log_debug_impl(&dword_230455000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx container-metadata receieved server change token %@, caught-up:%s client change token %@ error:%@%@", buf, 0x3Eu);
  }
...
- (void)performAfterFetchingAssetContents:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB90E8]), "initWithRecordIDs:", self->_recordIDsForDesiredAssets);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    ...
    v31 = 2112;
    v32 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx adding sub-operation to fetch asset contents: %@ for records: %@%@", buf, 0x2Au);
  }
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    v39 = 2112;
    v40 = v10;
    _os_log_debug_impl(&dword_230455000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx per record callback: %@ - %@%@", buf, 0x2Au);
  }

  if (objc_msgSend(v9, "brc_isCloudKitUnknownItemError"))
  {
    v12 = *(void **)(*(_QWORD *)(a1 + 32) + 504);
    v13 = objc_alloc(MEMORY[0x24BE17640]);
    ...
    if (v24)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v37 = 2112;
        v38 = v25;
        _os_log_debug_impl(&dword_230455000, v26, OS_LOG_TYPE_DEBUG, "[DEBUG] updating container metadata %@ at etag:%@ (after asset download)%@", buf, 0x20u);
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke_29(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v19 = 2112;
    v20 = v7;
    _os_log_debug_impl(&dword_230455000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx finished %@%@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_230455000, v10, OS_LOG_TYPE_DEFAULT, "[NOTICE] fetched %lu containers metadata from the cloud - %@%@", buf, 0x20u);
  }
...
uint64_t __83__BRCContainerMetadataSyncDownOperation__completedWithServerChangeToken_requestID___block_invoke(_QWORD *a1)
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v27 = 2112;
    v28 = v13;
    _os_log_debug_impl(&dword_230455000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] remembering container-metadata server change token %@ requestID %llu%@", buf, 0x20u);
  }
...
LABEL_9:
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 2112;
      v19 = v8;
      _os_log_impl(&dword_230455000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Sync up of app library container metdata failed for %@ because requestIDs differ %lld vs %lld%@", (uint8_t *)&v12, 0x2Au);
    }
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┏%llx Sync: syncing down container metadata%@");
  OUTLINED_FUNCTION_0();
}
...
LABEL_5:
  ...
  v5 = objc_msgSend(v7, "brc_checkErrorsFromCloudKit:", &__block_literal_global_23);
  v6 = v7;
  if ((v5 & 1) != 0)
    goto LABEL_5;
LABEL_3:
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingRecordChanges___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] containerID %@ had no properties plist%@");
  OUTLINED_FUNCTION_0();
}
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingRecordChanges___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] ┳%llx finished operation%@");
  OUTLINED_FUNCTION_0();
}
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_230455000, v0, (os_log_type_t)0x90u, "[ERROR] unknown container %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_0();
}
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] got asset contents for %@%@");
  OUTLINED_FUNCTION_0();
}
...
void __83__BRCContainerMetadataSyncDownOperation__completedWithServerChangeToken_requestID___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&dword_230455000, v0, v1, "[DEBUG] Sync up of app library container metdata succeeded for %@%@");
  OUTLINED_FUNCTION_0();
}
