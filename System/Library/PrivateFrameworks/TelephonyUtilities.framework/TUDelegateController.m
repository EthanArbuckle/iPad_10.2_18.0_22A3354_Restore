...
{
  TUDelegateController *v2;
  TUDelegateController *v3;
  uint64_t v4;
  ...
  v2 = -[TUDelegateController init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (void)addDelegate:(id)a3 queue:(id)a4
{
  ...
  -[TUDelegateController delegateToQueue](self, "delegateToQueue");
...
- (void)enumerateDelegatesUsingBlock:(id)a3
{
  ...
  v14 = 0u;
  v15 = 0u;
  -[TUDelegateController delegateToQueue](self, "delegateToQueue", 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
