...
+ (id)sampleWithStruct:(rc2Coex *)a3 andTimestamp:(id)a4
{
  id v5;
  uint64_t var0;
  WiFiUsageLQMKernelSampleRC2Coex *v7;

  v5 = a4;
  var0 = a3->var0;
  if ((_DWORD)var0)
  {
    NSLog(CFSTR("%s - Unknown version: %u"), "+[WiFiUsageLQMKernelSampleRC2Coex sampleWithStruct:andTimestamp:]", var0);
    v7 = 0;
  }
  else
  {
    v7 = -[WiFiUsageLQMKernelSampleRC2Coex initWithStruct:andTimestamp:]([WiFiUsageLQMKernelSampleRC2Coex alloc], "initWithStruct:andTimestamp:", a3, v5);
  }
...
- (WiFiUsageLQMKernelSampleRC2Coex)initWithStruct:(rc2Coex *)a3 andTimestamp:(id)a4
{
  ...
  v7 = -[WiFiUsageLQMKernelSampleRC2Coex init](&v12, sel_init);
