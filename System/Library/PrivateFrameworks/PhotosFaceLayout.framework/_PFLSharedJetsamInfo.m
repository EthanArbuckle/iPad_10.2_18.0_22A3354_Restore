...
- (_PFLSharedJetsamInfo)init
{
  ...
  v2 = -[_PFLSharedJetsamInfo init](&v8, sel_init);
  if (v2)
  {
    v3 = objc_opt_new();
...
- (BOOL)resetIntervalFor:(id)a3
{
  ...
  *(_OWORD *)buffer = 0u;
  ...
  else
  {
    ...
    {
      v7 = v6 >> 10;
      objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithCapacity:", -[NSMapTable count](self->_fetchers, "count"));
      ...
      if (v17)
      {
        ...
        do
        {
          for (j = 0; j != v18; ++j)
          {
            ...
            objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", v7, v25);
      ...
      v4 = v25;
      -[NSMapTable setObject:forKey:](self->_fetchers, "setObject:forKey:", &unk_251459368, v25);
      -[NSLock unlock](self->_fetchersLock, "unlock");
