...
+ (id)searchMusicRequestInApp:(id)a3
{
  ...
  v3 = a3;
  v4 = -[SKIDirectInvocationPayload initWithIdentifier:]([SKIDirectInvocationPayload alloc], "initWithIdentifier:", CFSTR("com.apple.siri.directInvocation.music.search"));
