...
{
  FullLocationHistoryDevicesList *v5;
  ...
  if (v5)
  {
    v6 = -[CKSettingsCheckInDevicesList initWithFullDataSharing:]([_TtC21CommunicationsSetupUI28CKSettingsCheckInDevicesList alloc], "initWithFullDataSharing:", 1);
    devicesList = v5->_devicesList;
    v5->_devicesList = v6;

    -[FullLocationHistoryDevicesList setUpConstraints](v5, "setUpConstraints");
  }
  return v5;
}
...
- (void)setUpConstraints
{
  ...
  -[FullLocationHistoryDevicesList devicesList](self, "devicesList");
  ...
  -[FullLocationHistoryDevicesList inputViewController](self, "inputViewController");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "addChildViewController:", v4);

  -[FullLocationHistoryDevicesList contentView](self, "contentView");
