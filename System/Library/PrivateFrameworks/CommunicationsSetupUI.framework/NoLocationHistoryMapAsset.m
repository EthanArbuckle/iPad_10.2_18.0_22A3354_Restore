...
- (NoLocationHistoryMapAsset)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v6, "imageNamed:inBundle:withConfiguration:", CFSTR("noLocationHistoryMap"), v7, 0);
    ...
    -[NoLocationHistoryMapAsset setUpConstraints](v5, "setUpConstraints");
  }
  return v5;
}
...
- (void)setUpConstraints
{
  ...
  -[NoLocationHistoryMapAsset assetView](self, "assetView");
  ...
  -[NoLocationHistoryMapAsset contentView](self, "contentView");
