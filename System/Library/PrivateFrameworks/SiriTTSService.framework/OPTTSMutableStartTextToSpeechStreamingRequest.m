...
{
  OPTTSMutableStartTextToSpeechStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[OPTTSMutableStartTextToSpeechStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (OPTTSTextToSpeechRequestDebug *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("debug"));
}
...
{
  return (OPTTSTextToSpeechUserProfile *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("profile"));
}
...
{
  return (OPTTSTextToSpeechRequestDevConfig *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("dev_config"));
}
...
{
  return (OPTTSTextToSpeechRequestProsodyTransferConfig *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("prosody_config"));
}
...
{
  return (OPTTSTextToSpeechRequestProsodyControlConfig *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("prosody_control_config"));
}
