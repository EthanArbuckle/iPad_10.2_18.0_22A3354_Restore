...
{
  OPTTSMutableTextToSpeechSpeechFeatureInputWave *v2;
  uint64_t v3;
  ...
  v2 = -[OPTTSMutableTextToSpeechSpeechFeatureInputWave init](&v6, sel_init);
  if (v2)
  {
...
- (NSData)pcm_data
{
  return (NSData *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("pcm_data"));
}
...
- (void)pcm_data:(id)a3
{
  ...
  -[OPTTSMutableTextToSpeechSpeechFeatureInputWave pcm_data](self, "pcm_data");
