...
{
  return -[OPTTSTextToSpeechUserProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[OPTTSTextToSpeechUserProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (OPTTSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4
{
  return -[OPTTSTextToSpeechUserProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (OPTTSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  OPTTSTextToSpeechUserProfile *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  OPTTSTextToSpeechUserProfile *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[OPTTSTextToSpeechUserProfile init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (NSArray)resources
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[OPTTSTextToSpeechUserProfile resources_enumerateObjectsUsingBlock:](self, "resources_enumerateObjectsUsingBlock:", v6);
...
- (id)resources_objectAtIndex:(unint64_t)a3
{
  void *v5;
  void *v6;
  OPTTSTextToSpeechVoiceResource *v7;
  OPTTSTextToSpeechVoiceResource *v8;
  const TextToSpeechUserProfile *root;
  const TextToSpeechUserProfile *v10;
  uint64_t v11;
  const TextToSpeechUserProfile *v12;
  ...
  if (v5)
  {
    ...
    v7 = (OPTTSTextToSpeechVoiceResource *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    root = self->_root;
    ...
    v7 = -[OPTTSTextToSpeechVoiceResource initWithFlatbuffData:root:verify:]([OPTTSTextToSpeechVoiceResource alloc], "initWithFlatbuffData:root:verify:", self->_data, &v12[4 * a3 + 4 + *(unsigned int *)v12[4 * a3 + 4].var0], 0);
  }
  v8 = v7;
LABEL_9:
...
{
  void (**v4)(id, OPTTSTextToSpeechVoiceResource *, uint64_t, unsigned __int8 *);
  void *v5;
  void *v6;
  const TextToSpeechUserProfile *root;
  ...
  uint64_t v11;
  uint64_t v12;
  const TextToSpeechUserProfile *v13;
  uint64_t v14;
  uint64_t v15;
  OPTTSTextToSpeechVoiceResource *v16;
  int v17;
  uint64_t v18;
  unsigned __int8 v19;
    ...
    if (*(unsigned __int16 *)v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if ((_DWORD)v12)
        {
          ...
          do
          {
            v16 = -[OPTTSTextToSpeechVoiceResource initWithFlatbuffData:root:verify:]([OPTTSTextToSpeechVoiceResource alloc], "initWithFlatbuffData:root:verify:", self->_data, &v13[*(unsigned int *)v13->var0], 0);
            v4[2](v4, v16, v14, &v19);
            v17 = v19;
...
- (Offset<siri::speech::schema_fb::TextToSpeechUserProfile>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v33;
  int v34;
  Offset<siri::speech::schema_fb::TextToSpeechUserProfile> v35;
  void *v37;
  __int128 v38;
  __int128 v39;
  __int128 v40;
  ...
  -[OPTTSTextToSpeechUserProfile resources](self, "resources");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::TextToSpeechUserProfile> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[OPTTSTextToSpeechUserProfile addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __44__OPTTSTextToSpeechUserProfile_flatbuffData__block_invoke;
