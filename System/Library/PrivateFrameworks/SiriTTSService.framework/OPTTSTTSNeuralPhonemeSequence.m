...
{
  return -[OPTTSTTSNeuralPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[OPTTSTTSNeuralPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (OPTTSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4
{
  return -[OPTTSTTSNeuralPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (OPTTSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  OPTTSTTSNeuralPhonemeSequence *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  OPTTSTTSNeuralPhonemeSequence *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[OPTTSTTSNeuralPhonemeSequence init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (NSArray)phonemes
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[OPTTSTTSNeuralPhonemeSequence phonemes_enumerateObjectsUsingBlock:](self, "phonemes_enumerateObjectsUsingBlock:", v6);
...
- (id)phonemes_objectAtIndex:(unint64_t)a3
{
  ...
  uint64_t v11;
  const TTSNeuralPhonemeSequence *v12;
  unsigned int *var0;
...
- (void)phonemes_enumerateObjectsUsingBlock:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  const TTSNeuralPhonemeSequence *v13;
  uint64_t v14;
  uint64_t v15;
  void *v16;
  int v17;
...
- (Offset<siri::speech::schema_fb::TTSNeuralPhonemeSequence>)addObjectToBuffer:(void *)a3
{
  ...
  v37 = 0;
  v38 = 0;
  -[OPTTSTTSNeuralPhonemeSequence phonemes](self, "phonemes");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::TTSNeuralPhonemeSequence> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[OPTTSTTSNeuralPhonemeSequence addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __45__OPTTSTTSNeuralPhonemeSequence_flatbuffData__block_invoke;
