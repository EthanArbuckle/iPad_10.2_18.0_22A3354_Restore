...
{
  return -[OPTTSTTSReplacement initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[OPTTSTTSReplacement initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3 root:(const TTSReplacement *)a4
{
  return -[OPTTSTTSReplacement initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3 root:(const TTSReplacement *)a4 verify:(BOOL)a5
{
  ...
  v10 = -[OPTTSTTSReplacement init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (Offset<siri::speech::schema_fb::TTSReplacement>)addObjectToBuffer:(void *)a3
{
  ...
  -[OPTTSTTSReplacement original](self, "original");
  ...
  -[OPTTSTTSReplacement replacement](self, "replacement");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[OPTTSTTSReplacement addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __35__OPTTSTTSReplacement_flatbuffData__block_invoke;
