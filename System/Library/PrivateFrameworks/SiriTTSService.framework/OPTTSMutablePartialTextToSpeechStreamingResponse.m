...
{
  OPTTSMutablePartialTextToSpeechStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[OPTTSMutablePartialTextToSpeechStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (void)audio:(id)a3
{
  ...
  -[OPTTSMutablePartialTextToSpeechStreamingResponse audio](self, "audio");
...
{
  return (OPTTSTextToSpeechFeature *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("feature"));
}
