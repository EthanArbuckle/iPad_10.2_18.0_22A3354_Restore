...
{
  return -[OPTTSTextToSpeechRequestProsodyTransferConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[OPTTSTextToSpeechRequestProsodyTransferConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[OPTTSTextToSpeechRequestProsodyTransferConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (OPTTSTextToSpeechRequestProsodyTransferConfig)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestProsodyTransferConfig *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  OPTTSTextToSpeechRequestProsodyTransferConfig *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  uint64_t v17;
  unint64_t v18;
  siri::speech::schema_fb::TextToSpeechRequestProsodyTransferConfig *v19;
  OPTTSTextToSpeechRequestProsodyTransferConfig *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[OPTTSTextToSpeechRequestProsodyTransferConfig init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
{
  OPTTSTextToSpeechSpeechFeatureInputWave *v3;
  ...
  v3 = (OPTTSTextToSpeechSpeechFeatureInputWave *)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    ...
    if (*(unsigned __int16 *)v6->var0 >= 5u && (v7 = *(unsigned __int16 *)v6[4].var0) != 0)
      ...
      v8 = 0;
    v3 = -[OPTTSTextToSpeechSpeechFeatureInputWave initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
{
  OPTTSTextToSpeechUserVoiceProfile *v3;
  ...
  v3 = (OPTTSTextToSpeechUserVoiceProfile *)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    ...
    if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
      ...
      v8 = 0;
    v3 = -[OPTTSTextToSpeechUserVoiceProfile initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestProsodyTransferConfig>)addObjectToBuffer:(void *)a3
{
  ...
  -[OPTTSTextToSpeechRequestProsodyTransferConfig wave_data](self, "wave_data");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "addObjectToBuffer:", a3);

  -[OPTTSTextToSpeechRequestProsodyTransferConfig user_voice_profile](self, "user_voice_profile");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_msgSend(v7, "addObjectToBuffer:", a3);

  -[OPTTSTextToSpeechRequestProsodyTransferConfig user_voice_profile_url](self, "user_voice_profile_url");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  if (v6)
  {
    v17 = apple::aiml::flatbuffers2::FlatBufferBuilder::ReferTo((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v6);
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((unint64_t)a3, 4, v17);
  }
  if (v8)
  {
    v18 = apple::aiml::flatbuffers2::FlatBufferBuilder::ReferTo((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v8);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[OPTTSTextToSpeechRequestProsodyTransferConfig addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __61__OPTTSTextToSpeechRequestProsodyTransferConfig_flatbuffData__block_invoke;
