...
{
  return -[OPTTSTextToSpeechRequestProsodyControlConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[OPTTSTextToSpeechRequestProsodyControlConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[OPTTSTextToSpeechRequestProsodyControlConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (OPTTSTextToSpeechRequestProsodyControlConfig)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestProsodyControlConfig *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  OPTTSTextToSpeechRequestProsodyControlConfig *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  OPTTSTextToSpeechRequestProsodyControlConfig *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[OPTTSTextToSpeechRequestProsodyControlConfig init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestProsodyControlConfig>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = self;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_rate](self, "global_rate");
  v6 = v5;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_pitch](v4, "global_pitch");
  v8 = v7;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_energy](v4, "global_energy");
  v10 = v9;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_sent_pitch](v4, "global_sent_pitch");
  v12 = v11;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_sent_pitchrange](v4, "global_sent_pitchrange");
  v14 = v13;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_sent_duration](v4, "global_sent_duration");
  v16 = v15;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_sent_energy](v4, "global_sent_energy");
  v18 = v17;
  -[OPTTSTextToSpeechRequestProsodyControlConfig global_sent_tilt](v4, "global_sent_tilt");
  v20 = v19;
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::TextToSpeechRequestProsodyControlConfig>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (int)v4);
}
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[OPTTSTextToSpeechRequestProsodyControlConfig addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __60__OPTTSTextToSpeechRequestProsodyControlConfig_flatbuffData__block_invoke;
