...
{
  return -[OPTTSTTSNormalizedText initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[OPTTSTTSNormalizedText initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (OPTTSTTSNormalizedText)initWithFlatbuffData:(id)a3 root:(const TTSNormalizedText *)a4
{
  return -[OPTTSTTSNormalizedText initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (OPTTSTTSNormalizedText)initWithFlatbuffData:(id)a3 root:(const TTSNormalizedText *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  OPTTSTTSNormalizedText *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const TTSNormalizedText *root;
  uint64_t v17;
  unint64_t v18;
  siri::speech::schema_fb::TextToSpeechRequestExperiment *v19;
  OPTTSTTSNormalizedText *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[OPTTSTTSNormalizedText init](&v26, sel_init);
  if (!v10)
    goto LABEL_14;
...
- (Offset<siri::speech::schema_fb::TTSNormalizedText>)addObjectToBuffer:(void *)a3
{
  ...
  -[OPTTSTTSNormalizedText text](self, "text");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::TTSNormalizedText> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[OPTTSTTSNormalizedText addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __38__OPTTSTTSNormalizedText_flatbuffData__block_invoke;
