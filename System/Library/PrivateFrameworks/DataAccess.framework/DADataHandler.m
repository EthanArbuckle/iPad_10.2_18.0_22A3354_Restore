...
- (int)getIdFromLocalObject:(void *)a3
{
  ...
  if (os_log_type_enabled(v4, v5))
  {
    v7 = 136315138;
    Name = sel_getName(a2);
    _os_log_impl(&dword_1B51E4000, v4, v5, "%s to be implemented by subclass", (uint8_t *)&v7, 0xCu);
  }
...
- (void)drainContainer
{
  ...
  if (os_log_type_enabled(v3, v4))
  {
    v5 = 136315138;
    Name = sel_getName(a2);
    _os_log_impl(&dword_1B51E4000, v3, v4, "%s to be implemented by subclass", (uint8_t *)&v5, 0xCu);
  }
...
+ (id)newDataHandlerForDataclass:(int64_t)a3 container:(void *)a4 changeTrackingID:(id)a5
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    v9 = 136315138;
    Name = sel_getName(a2);
    _os_log_impl(&dword_1B51E4000, v6, v7, "%s to be implemented by subclass", (uint8_t *)&v9, 0xCu);
  }
