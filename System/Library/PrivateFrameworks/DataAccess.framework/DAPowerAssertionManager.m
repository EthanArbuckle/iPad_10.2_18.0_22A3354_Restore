...
- (unint64_t)powerAssertionRetainCount:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAPowerAssertionManager.m"), 62, CFSTR("%s must have a non-nil context"), sel_getName(a2));
...
- (void)retainPowerAssertion:(id)a3 withGroupIdentifier:(id)a4
{
  ...
  else
  {
    ...
    objc_msgSend(v27, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAPowerAssertionManager.m"), 72, CFSTR("%s must have a non-nil context"), sel_getName(a2));
  ...
  objc_msgSend(v28, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAPowerAssertionManager.m"), 73, CFSTR("%s must have a non-nil group identifier"), sel_getName(a2));
...
LABEL_3:
  ...
  if (os_log_type_enabled(v10, v12))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v31 = 2112;
    v32 = v9;
    _os_log_impl(&dword_1B51E4000, v10, v12, "Context %@ retaining power assertion with group identifier %@", buf, 0x16u);
  }
        ...
        v15))
  {
    ...
    if (os_log_type_enabled(v16, v17))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v31 = 2112;
      v32 = v9;
      _os_log_impl(&dword_1B51E4000, v16, v17, "Context %@ getting added to our held aside contexts, as group %@ is currently dropped", buf, 0x16u);
    }
...
- (void)releasePowerAssertion:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAPowerAssertionManager.m"), 102, CFSTR("%s must have a non-nil context"), sel_getName(a2));
  ...
  if (os_log_type_enabled(v6, v7))
  {
    *(_DWORD *)buf = 138412290;
    v26 = v5;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Context %@ releasing power assertion", buf, 0xCu);
  }
...
LABEL_7:
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v11, v7))
    {
      *(_DWORD *)buf = 138412290;
      v26 = v5;
      _os_log_impl(&dword_1B51E4000, v11, v7, "Context object %@ attempting to release power assertion without first retaining it", buf, 0xCu);
    }
    goto LABEL_7;
  }
  -[DAPowerAssertionManager contexts](v8, "contexts");
...
- (void)dropPowerAssertionsForGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    *(_DWORD *)buf = 138412290;
    v38 = v4;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Dropping power assertion for group identifier %@", buf, 0xCu);
  }
...
- (void)reattainPowerAssertionsForGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    *(_DWORD *)buf = 138412290;
    v38 = v4;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Reattaining power assertion for group identifier %@", buf, 0xCu);
  }
...
- (BOOL)_retainAssertionForContext:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0D1C3E8], "isAppleInternalInstall");
...
LABEL_8:
      _os_log_impl(&dword_1B51E4000, v11, v12, v14, buf, 0x20u);
...
- (BOOL)_releaseAssertionForContext:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    _os_log_impl(&dword_1B51E4000, v5, v6, "DAPowerAssertionManager releasing power assertion for context %p, outstanding assertion count %u ontext", (uint8_t *)&v12, 0x12u);
