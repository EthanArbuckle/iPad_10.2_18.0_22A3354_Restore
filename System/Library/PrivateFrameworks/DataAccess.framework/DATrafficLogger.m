...
void __39__DATrafficLogger__ensureCustomLogFile__block_invoke()
{
  ...
  v2 = dispatch_queue_create("com.apple.dataaccess.DATrafficQueue", 0);
...
void __39__DATrafficLogger__ensureCustomLogFile__block_invoke_2(uint64_t a1)
{
  ...
  if ((v2 & 1) == 0)
  {
    ...
    v19[0] = *MEMORY[0x1E0D1C458];
    v20[0] = DACustomLogDirectory();
    v19[1] = *MEMORY[0x1E0D1C468];
    objc_msgSend(*(id *)(a1 + 32), "filename");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = *MEMORY[0x1E0D1C470];
    v20[1] = v5;
    v20[2] = &unk_1E68DA1C8;
    v7 = *MEMORY[0x1E0D1C460];
    v19[2] = v6;
    v19[3] = v7;
    v8 = *MEMORY[0x1E0D1C480];
    v9 = *MEMORY[0x1E0C9AE40];
    v20[3] = CFSTR("DALogLevel");
    v20[4] = v9;
    v10 = *MEMORY[0x1E0D1C450];
    v19[4] = v8;
    v19[5] = v10;
    v11 = (void *)MEMORY[0x1B5E48C2C](v4);
    v20[5] = v11;
    ...
    if (!v13)
    {
      if (objc_msgSend(MEMORY[0x1E0D1C3E8], "isAppleInternalInstall"))
      {
        v14 = (void *)objc_msgSend(v12, "mutableCopy");
        objc_msgSend(v14, "setObject:forKeyedSubscript:", &unk_1E68DA1E0, *MEMORY[0x1E0D1C478]);
    ...
    v18 = v15;
    MEMORY[0x1B5E48710](objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", &v18, 1), v12);
