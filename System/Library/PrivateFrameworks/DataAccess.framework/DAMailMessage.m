...
- (DAMailMessage)initWithCoder:(id)a3
{
  ...
  {
    *(_WORD *)v7 = 0;
    _os_log_impl(&dword_1B51E4000, v4, v5, "DAMailMessage initWithCoder: should be called on a subclass only", v7, 2u);
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  {
    *(_WORD *)v5 = 0;
    _os_log_impl(&dword_1B51E4000, v3, v4, "DAMailMessage encodeWithCoder: should be called on a subclass only", v5, 2u);
  }
