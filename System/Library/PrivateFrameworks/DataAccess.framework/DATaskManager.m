...
- (void)dealloc
{
  ...
  if (-[NSMutableArray count](v3->_queuedExclusiveTasks, "count"))
  {
    ...
    objc_msgSend(v11, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 118, CFSTR("There are queued exclusive tasks remaining during dealloc"));
  ...
  if (v3->_activeExclusiveTask)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 119, CFSTR("There is an active exclusive task remaining during dealloc"));
  ...
  if (-[NSMutableSet count](v3->_independentTasks, "count"))
  {
    ...
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 120, CFSTR("There are independent tasks remaining during dealloc"));
  ...
  if (-[NSMutableSet count](v3->_heldIndependentTasks, "count"))
  {
    ...
    objc_msgSend(v14, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 121, CFSTR("There are held independent tasks remaining during dealloc"));
  ...
  if (-[NSMutableSet count](v3->_modalHeldIndependentTasks, "count"))
  {
    ...
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 122, CFSTR("There are modal-held independent tasks remaining during dealloc"));
  ...
  if (-[NSMutableArray count](v3->_mQueuedTasks, "count"))
  {
    ...
    objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 123, CFSTR("There are queued tasks remaining during dealloc"));
  ...
  if (v3->_activeQueuedTask)
  {
    ...
    objc_msgSend(v17, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 124, CFSTR("There is an active queued task remaining during dealloc"));
  ...
  if (v3->_modalHeldActiveQueuedTask)
  {
    ...
    objc_msgSend(v18, "handleFailureInMethod:object:file:lineNumber:description:", a2, v3, CFSTR("DATaskManager.m"), 125, CFSTR("There is a modal-held active queued task remaining during dealloc"));

  }
  -[NSTimer invalidate](v3->_powerLogIdleTimer, "invalidate");
  if (v3->_didLogSyncStart)
    -[DATaskManager _logSyncEnd](v3, "_logSyncEnd");
  ...
  if (v3->_transaction)
  {
    ...
    if (os_log_type_enabled(v5, v6))
    {
      *(_DWORD *)buf = 138412290;
      v21 = v3;
      _os_log_impl(&dword_1B51E4000, v5, v6, "Task manager %@ is being deallocated. Ending XPC transaction", buf, 0xCu);
    }
  ...
  if (v3->_daActivity)
  {
    ...
    if (os_log_type_enabled(v8, v9))
    {
      *(_DWORD *)buf = 138412290;
      v21 = v3;
      _os_log_impl(&dword_1B51E4000, v8, v9, "Task manager %@ is being deallocated. Ending XPC activity", buf, 0xCu);
    }
...
- (void)submitExclusiveTask:(id)a3 toFrontOfQueue:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v8, v10))
  {
    ...
    v38 = 1024;
    v39 = v4;
    _os_log_impl(&dword_1B51E4000, v8, v10, "Exclusive task %@ submitted, to front: %d", (uint8_t *)&v36, 0x12u);
  }
  ...
  if (!v11->_transaction)
  {
    ...
    {
      LOWORD(v36) = 0;
      _os_log_impl(&dword_1B51E4000, v14, v10, "Begin an xpc transaction due to exclusive task", (uint8_t *)&v36, 2u);
    }
    ...
    if (os_log_type_enabled(v17, v18))
    {
      ...
      v36 = 138543362;
      v37 = v19;
      _os_log_impl(&dword_1B51E4000, v17, v18, "DATransaction starting, ID: %{public}@", (uint8_t *)&v36, 0xCu);
  ...
  if (!v11->_daActivity)
  {
    ...
    if (v21)
    {
      ...
      if (os_log_type_enabled(v22, v10))
      {
        -[DATaskManager account](v11, "account");
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v23, "accountID");
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        v36 = 138543362;
        v37 = v24;
        _os_log_impl(&dword_1B51E4000, v22, v10, "Retain an xpc activity due to exclusive task for account %{public}@", (uint8_t *)&v36, 0xCu);

      }
      v25 = [DAActivity alloc];
      -[DATaskManager account](v11, "account");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      v27 = -[DAActivity initWithAccount:](v25, "initWithAccount:", v26);
      daActivity = v11->_daActivity;
      v11->_daActivity = (DAActivity *)v27;

    }
  }
  v29 = -[DATaskManager state](v11, "state");
  if ((v29 - 1) < 4)
  {
    v30 = 0;
    if (v4)
...
LABEL_22:
      ...
      objc_msgSend(v31, "insertObject:atIndex:", v7, 0);
LABEL_31:
...
LABEL_30:
  ...
  if (v29)
  {
    ...
    objc_msgSend(v33, "handleFailureInMethod:object:file:lineNumber:description:", a2, v11, CFSTR("DATaskManager.m"), 318, CFSTR("Out of bounds state"));
...
- (void)submitIndependentTask:(id)a3
{
  ...
  v7 = MEMORY[0x1E0D1C448];
  v8 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 7);
  if (os_log_type_enabled(v6, v8))
  {
    v30 = 138412290;
    v31 = v5;
    _os_log_impl(&dword_1B51E4000, v6, v8, "Independent task %@ submitted", (uint8_t *)&v30, 0xCu);
  }
  ...
  if (-[DATaskManager state](v9, "state") != 5)
  {
    ...
    if (!v9->_transaction)
    {
      ...
      {
        LOWORD(v30) = 0;
        _os_log_impl(&dword_1B51E4000, v12, v8, "Begin an xpc transaction due to independent task", (uint8_t *)&v30, 2u);
      }
      ...
      if (os_log_type_enabled(v15, v16))
      {
        ...
        v30 = 138543362;
        v31 = v17;
        _os_log_impl(&dword_1B51E4000, v15, v16, "DATransaction starting, ID: %{public}@", (uint8_t *)&v30, 0xCu);
    ...
    if (!v9->_daActivity)
    {
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v20, v8))
        {
          ...
          v30 = 138543362;
          v31 = v22;
          _os_log_impl(&dword_1B51E4000, v20, v8, "Retain an xpc activity due to independent task for account %{public}@", (uint8_t *)&v30, 0xCu);

        }
        v23 = [DAActivity alloc];
        -[DATaskManager account](v9, "account");
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        v25 = -[DAActivity initWithAccount:](v23, "initWithAccount:", v24);
        daActivity = v9->_daActivity;
        v9->_daActivity = (DAActivity *)v25;

      }
    }
    v27 = -[DATaskManager state](v9, "state");
    if ((v27 - 1) >= 4)
    {
      if (!v27)
      {
      ...
      objc_msgSend(v28, "handleFailureInMethod:object:file:lineNumber:description:", a2, v9, CFSTR("DATaskManager.m"), 385, CFSTR("Out of bounds state"));
    }
    else
    {
...
- (void)submitQueuedTask:(id)a3
{
  ...
  if (os_log_type_enabled(v6, v8))
  {
    v31 = 138412290;
    v32 = v5;
    _os_log_impl(&dword_1B51E4000, v6, v8, "Queued task %@ submitted", (uint8_t *)&v31, 0xCu);
  }
  ...
  if (-[DATaskManager state](v9, "state") != 5)
  {
    ...
    if (!v9->_transaction)
    {
      ...
      {
        LOWORD(v31) = 0;
        _os_log_impl(&dword_1B51E4000, v12, v8, "Begin an xpc transaction due to queued task", (uint8_t *)&v31, 2u);
      }
      ...
      if (os_log_type_enabled(v15, v16))
      {
        ...
        v31 = 138543362;
        v32 = v17;
        _os_log_impl(&dword_1B51E4000, v15, v16, "DATransaction starting, ID: %{public}@", (uint8_t *)&v31, 0xCu);
    ...
    if (!v9->_daActivity)
    {
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v20, v8))
        {
          ...
          v31 = 138543362;
          v32 = v22;
          _os_log_impl(&dword_1B51E4000, v20, v8, "Retain an xpc activity due to queued task for account %{public}@", (uint8_t *)&v31, 0xCu);
    ...
    if ((v27 - 1) >= 4)
    {
      if (v27)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v28, "handleFailureInMethod:object:file:lineNumber:description:", a2, v9, CFSTR("DATaskManager.m"), 441, CFSTR("Out of bounds state"));
        goto LABEL_22;
      }
...
- (void)cancelTask:(id)a3 withUnderlyingError:(id)a4
{
  ...
  if (os_log_type_enabled(v7, v8))
  {
    v9 = 138412290;
    v10 = v5;
    _os_log_impl(&dword_1B51E4000, v7, v8, "Task %@ aborted", (uint8_t *)&v9, 0xCu);
  }
...
- (void)shutdown
{
  ...
  if (os_log_type_enabled(v3, v5))
  {
    ...
    v25 = 2048;
    v26 = v6;
    _os_log_impl(&dword_1B51E4000, v3, v5, "Task Manager %p shutting down with account at %p", (uint8_t *)&v23, 0x16u);
  ...
  if (os_log_type_enabled(v7, v5))
  {
    ...
    v25 = 2112;
    v26 = v8;
    _os_log_impl(&dword_1B51E4000, v7, v5, "Task Manager %p shutting down with state %@", (uint8_t *)&v23, 0x16u);
  ...
  if (-[DATaskManager state](self, "state") != 5)
  {
    ...
    if (v9->_transaction)
    {
      ...
      if (os_log_type_enabled(v16, v17))
      {
        v23 = 138412290;
        v24 = v9;
        _os_log_impl(&dword_1B51E4000, v16, v17, "Task manager %@ is being shut down. Ending XPC transaction", (uint8_t *)&v23, 0xCu);
      }
    ...
    if (v9->_daActivity)
    {
      ...
      if (os_log_type_enabled(v19, v5))
      {
        v23 = 138412290;
        v24 = v9;
        _os_log_impl(&dword_1B51E4000, v19, v5, "Task manager %@ is being shut down. Releasing XPC activity", (uint8_t *)&v23, 0xCu);
      }
    ...
    if (v9->_didLogSyncStart)
      -[DATaskManager _logSyncEnd](v9, "_logSyncEnd");
    objc_sync_exit(v9);
...
- (void)_useOpportunisticSocketsAgain
{
  ...
  if (-[DATaskManager state](self, "state") != 5)
  {
    ...
    if (os_log_type_enabled(v3, v4))
    {
      v6 = 138412290;
      v7 = self;
      _os_log_impl(&dword_1B51E4000, v3, v4, "Task manager %@ has finally drained its queue. Turning opportunistic socket support back on", (uint8_t *)&v6, 0xCu);
    }
...
- (void)_clearUserInitiatedSyncTimer
{
  ...
  if (-[DATaskManager state](self, "state") != 5)
  {
    ...
    if (os_log_type_enabled(v3, v4))
    {
      v6 = 138412290;
      v7 = self;
      _os_log_impl(&dword_1B51E4000, v3, v4, "Task manager %@ has finally drained its queue. Clearing its user initiated sync state", (uint8_t *)&v6, 0xCu);
    }
...
- (void)_endXpcTransaction
{
  ...
  if (os_log_type_enabled(v3, v4))
  {
    v10 = 138412290;
    v11 = self;
    _os_log_impl(&dword_1B51E4000, v3, v4, "Task manager %@ has finally drained its queue. Ending XPC transaction", (uint8_t *)&v10, 0xCu);
  }
  ...
  if (os_log_type_enabled(v6, v4))
  {
    v10 = 138412290;
    v11 = self;
    _os_log_impl(&dword_1B51E4000, v6, v4, "Task manager %@ has finally drained its queue. Releasing XPC activity", (uint8_t *)&v10, 0xCu);
  }
  ...
  if (os_log_type_enabled(v8, v4))
  {
    v10 = 138412290;
    v11 = self;
    _os_log_impl(&dword_1B51E4000, v8, v4, "Task manager %@ has finally drained its queue. Reset automatic fetching state", (uint8_t *)&v10, 0xCu);
  }

  -[DATaskManager account](self, "account");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "saveFetchingAutomaticallyState:", 0);
...
- (void)taskDidFinish:(id)a3
{
  ...
  if (os_log_type_enabled(v6, type))
  {
    *(_DWORD *)buf = 138412290;
    v148 = v5;
    _os_log_impl(&dword_1B51E4000, v6, type, "Task %@ finished.", buf, 0xCu);
  }

  v8 = self;
  objc_sync_enter(v8);
  if (-[DATaskManager state](v8, "state") == 5)
  {
              ...
              else
              {
                ...
                if (!v24)
                {
                  ...
                  if (v122)
                  {
                    ...
                    objc_msgSend(v126, "handleFailureInMethod:object:file:lineNumber:description:", a2, v8, CFSTR("DATaskManager.m"), 684, CFSTR("Finished task is not being managed, so cannot be active modal task."));

                  }
                  -[DATaskManager queuedModalTasks](v8, "queuedModalTasks");
                  v123 = (void *)objc_claimAutoreleasedReturnValue();
                  v124 = objc_msgSend(v123, "containsObject:", v5);

                  if (v124)
                  {
                    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
                    v127 = (void *)objc_claimAutoreleasedReturnValue();
                    objc_msgSend(v127, "handleFailureInMethod:object:file:lineNumber:description:", a2, v8, CFSTR("DATaskManager.m"), 686, CFSTR("Finished task is not being managed, so cannot be in modal queue."));

                  }
                  DALoggingwithCategory();
                  v113 = objc_claimAutoreleasedReturnValue();
                  v125 = *(_BYTE *)(v7 + 6);
                  if (os_log_type_enabled(v113, v125))
                  {
                    *(_DWORD *)buf = 138412290;
                    v148 = v5;
                    _os_log_impl(&dword_1B51E4000, v113, v125, "Early return because task %@ isn't in our collection", buf, 0xCu);
                  }
                  goto LABEL_110;
                }
                -[DATaskManager mQueuedTasks](v8, "mQueuedTasks");
...
LABEL_60:
      ...
      if (!v68)
      {
        ...
        v67 = (void *)objc_claimAutoreleasedReturnValue();
        v72 = objc_msgSend(v67, "countByEnumeratingWithState:objects:count:", &v141, v152, 16);
        if (v72)
        {
          v73 = *(_QWORD *)v142;
          do
...
LABEL_71:
      ...
      if (!v81)
      {
        ...
        runLoopModesToPerformDelayedSelectorsIn();
        v80 = (void *)objc_claimAutoreleasedReturnValue();
        v85 = objc_msgSend(v80, "countByEnumeratingWithState:objects:count:", &v137, v151, 16);
        if (v85)
        {
          v86 = *(_QWORD *)v138;
          do
...
LABEL_83:
      ...
      if (!-[DATaskManager _hasTasksIndicatingARunningSync](v8, "_hasTasksIndicatingARunningSync"))
      {
        ...
        if (os_log_type_enabled(v93, type))
        {
          ...
          objc_msgSend(v96, "publicDescription");
          v97 = (void *)objc_claimAutoreleasedReturnValue();
          *(_DWORD *)buf = 138412546;
          v148 = v95;
          v149 = 2114;
          v150 = v97;
          _os_log_impl(&dword_1B51E4000, v93, type, "Pending tasks are finished for account \"%@\" (%{public}@)", buf, 0x16u);

        }
        v98 = objc_alloc(MEMORY[0x1E0C99E88]);
        objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeIntervalSinceNow:", 5.0);
        v99 = (void *)objc_claimAutoreleasedReturnValue();
        v100 = (void *)objc_msgSend(v98, "initWithFireDate:interval:target:selector:userInfo:repeats:", v99, v8, sel__endXpcTransaction, 0, 0, 0.0);
        -[DATaskManager setXpcTransactionTimer:](v8, "setXpcTransactionTimer:", v100);
        ...
        v102 = objc_msgSend(v101, "countByEnumeratingWithState:objects:count:", &v133, v146, 16);
        if (v102)
        {
          v103 = *(_QWORD *)v134;
          do
          {
            for (k = 0; k != v102; ++k)
            {
              ...
              v105 = *(_QWORD *)(*((_QWORD *)&v133 + 1) + 8 * k);
              objc_msgSend(MEMORY[0x1E0C99E58], "currentRunLoop");
              v106 = (void *)objc_claimAutoreleasedReturnValue();
              -[DATaskManager xpcTransactionTimer](v8, "xpcTransactionTimer");
              v107 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v106, "addTimer:forMode:", v107, v105);
      ...
      {
        v110 = objc_alloc(MEMORY[0x1E0C99E88]);
        objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeIntervalSinceNow:", 1.0);
        v111 = (void *)objc_claimAutoreleasedReturnValue();
        v112 = (void *)objc_msgSend(v110, "initWithFireDate:interval:target:selector:userInfo:repeats:", v111, v8, sel__logSyncEnd, 0, 0, 0.0);
        -[DATaskManager setPowerLogIdleTimer:](v8, "setPowerLogIdleTimer:", v112);
        ...
        runLoopModesToPerformDelayedSelectorsIn();
        v113 = objc_claimAutoreleasedReturnValue();
        v114 = -[NSObject countByEnumeratingWithState:objects:count:](v113, "countByEnumeratingWithState:objects:count:", &v129, v145, 16);
        if (v114)
        {
          v115 = *(_QWORD *)v130;
          do
          {
            for (m = 0; m != v114; ++m)
            {
              ...
              if (v118)
              {
                ...
                objc_msgSend(v119, "addTimer:forMode:", v120, v117);
...
LABEL_53:
    ...
    default:
      objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v30, "handleFailureInMethod:object:file:lineNumber:description:", a2, v8, CFSTR("DATaskManager.m"), 779, CFSTR("Out of bounds state"));
      goto LABEL_59;
  }
}
...
- (void)taskRequestModal:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v36, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 838, CFSTR("A nil task requested modal?"));

  }
  DALoggingwithCategory();
  v6 = objc_claimAutoreleasedReturnValue();
  v7 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 7);
  if (os_log_type_enabled(v6, v7))
  {
    v38 = 138412290;
    v39 = v5;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Task %@ requesting modal", (uint8_t *)&v38, 0xCu);
  }
  ...
  if (-[DATaskManager state](self, "state") == 5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 844, CFSTR("Cannot request modal behavior during shutdown"));
  ...
  switch(-[DATaskManager state](v9, "state"))
  {
    ...
    case 2:
      ...
      if (!v15)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v37 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v37, "handleFailureInMethod:object:file:lineNumber:description:", a2, v9, CFSTR("DATaskManager.m"), 871, CFSTR("Only the active exclusive task can go modal immediately"));
    ...
    default:
      objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, v9, CFSTR("DATaskManager.m"), 881, CFSTR("Out of bounds state."));
...
- (void)taskEndModal:(id)a3
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    *(_DWORD *)buf = 138412290;
    v18 = v5;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Task %@ ending modal", buf, 0xCu);
  }
  ...
  if (-[DATaskManager state](self, "state") != 5)
  {
    if (-[DATaskManager state](self, "state") == 4)
    {
      ...
      if (!v10)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, v8, CFSTR("DATaskManager.m"), 931, CFSTR("Only the active modal task can end modal behavior."));
    ...
    else
    {
      ...
      -[DATaskManager handleFailureInMethod:object:file:lineNumber:description:](v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 926, CFSTR("taskEndModal can only be called in Run Modal state, not %d"), -[DATaskManager state](self, "state"));
    }
...
- (void)_performTask:(id)a3
{
  ...
  if (-[DATaskManager isShutdown](self, "isShutdown"))
  {
    ...
    if (os_log_type_enabled(v5, v6))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_1B51E4000, v5, v6, "The _performTask is invoked after taskManager has been shutdown. Canceling %{public}@ %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v10, v12))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v21 = 2112;
        v22 = v4;
        _os_log_impl(&dword_1B51E4000, v11, v12, "The device is in on-power fetch mode, but is no longer on power or on wifi. Canceling %{public}@ %@", buf, 0x16u);
    ...
    {
      v15 = *(unsigned __int8 *)(MEMORY[0x1E0D1C448] + 7);
      if (os_log_type_enabled(v10, *(os_log_type_t *)(MEMORY[0x1E0D1C448] + 7)))
      {
        *(_DWORD *)buf = 138412290;
        v20 = v4;
        _os_log_impl(&dword_1B51E4000, v11, (os_log_type_t)v15, "performTask called on task %@", buf, 0xCu);
      }
        ...
        && -[DATaskManager _hasTasksIndicatingARunningSync](self, "_hasTasksIndicatingARunningSync"))
      {
        ...
        {
          -[DATaskManager powerLogIdleTimer](self, "powerLogIdleTimer");
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          if (v16)
          {
            ...
            -[DATaskManager setPowerLogIdleTimer:](self, "setPowerLogIdleTimer:", 0);
          }
        }
        else
        {
          -[DATaskManager _powerLogInfoDictionary](self, "_powerLogInfoDictionary");
          v18[0] = CFSTR("AccountName");
          v18[1] = CFSTR("AccountClass");
          v18[2] = CFSTR("AccountID");
...
- (void)_startModal:(id)a3
{
  ...
  if (-[DATaskManager isShutdown](self, "isShutdown"))
  {
    ...
    if (os_log_type_enabled(v6, v7))
    {
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_1B51E4000, v6, v7, "The _startModal is invoked after taskManager has been shutdown. Canceling %{public}@ %@", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    if (-[DATaskManager state](self, "state") == 5)
    {
      objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1020, CFSTR("Cannot handle _startModal: in Shutdown state"));
    ...
    if (os_log_type_enabled(v10, v11))
    {
      v13 = 138412290;
      v14 = v5;
      _os_log_impl(&dword_1B51E4000, v10, v11, "startModal called on task %@", (uint8_t *)&v13, 0xCu);
    }
...
- (void)_makeStateTransition
{
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      ...
      objc_msgSend(v69, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1051, CFSTR("Cannot have active queued task and active exclusive task at the same time."));
    ...
    if (v7)
    {
      objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
      v70 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v70, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1053, CFSTR("Cannot have running independent tasks and an active exclusive task at the same time."));
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      objc_msgSend(v71, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1056, CFSTR("Cannot have active queued task and a modal task at the same time."));
    ...
    if (v11)
    {
      ...
      objc_msgSend(v72, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1058, CFSTR("Cannot have running independent tasks and a modal task at the same time."));
  ...
  if (os_log_type_enabled(v12, v13))
  {
    ...
    v85 = 2112;
    v86 = v14;
    _os_log_impl(&dword_1B51E4000, v12, v13, "Task Manager %@ transitioning from state: %@", (uint8_t *)&v83, 0x16u);
...
LABEL_37:
    ...
    default:
      objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1116, CFSTR("Out of bounds state."));
  ...
  if (os_log_type_enabled(v35, v13))
  {
    ...
    v85 = 2112;
    v86 = v36;
    _os_log_impl(&dword_1B51E4000, v35, v13, "Task Manager %@ transitioning to state: %@", (uint8_t *)&v83, 0x16u);
  ...
  switch(-[DATaskManager state](self, "state"))
  {
    case 0:
      ...
      if (v37)
      {
        ...
        objc_msgSend(v73, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1124, CFSTR("Cannot have active exclusive task in Nominal state."));
      ...
      if (v38)
      {
        ...
        objc_msgSend(v74, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1125, CFSTR("Cannot have modal task in Nominal state."));
      ...
      if (v40)
      {
        ...
        objc_msgSend(v75, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1126, CFSTR("We shouldn't be holding independent tasks in Nominal state"));
      ...
      if (v42)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v76 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v76, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1127, CFSTR("We shouldn't have queued exclusive tasks in Nominal state"));
    ...
    case 1:
      ...
      if (v51)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v77 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v77, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1132, CFSTR("Cannot have active exclusive task in Hold for Exclusive state."));
      ...
      if (v52)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v78 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v78, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1133, CFSTR("Should not have any modal task active in Hold for Exclusive state"));
    ...
    case 2:
      ...
      if (v56)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v79 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v79, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1138, CFSTR("Cannot have running independent tasks in Run Exclusive state."));
    ...
    case 3:
      ...
      if (v58)
      {
        objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
        v80 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v80, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1142, CFSTR("Cannot have active modal task in Hold for Modal state."));
    ...
    case 4:
      ...
      if (v62)
      {
        ...
        objc_msgSend(v81, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1146, CFSTR("Should not be running other independent tasks in Run Modal state."));
      ...
      if (v63)
      {
        ...
        objc_msgSend(v82, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DATaskManager.m"), 1147, CFSTR("Should not be running other queued task in Run Modal state."));
...
- (void)_scheduleSelector:(SEL)a3 withArgument:(id)a4
{
  ...
  if (os_log_type_enabled(v8, v9))
  {
    ...
    v17 = 2112;
    v18 = v12;
    _os_log_impl(&dword_1B51E4000, v8, v9, "Scheduling selector: %s with argument: %@ in modes %@", (uint8_t *)&v13, 0x20u);
    if (v11 == 1)
...
- (void)_scheduleStartModal:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    v7 = 138412290;
    v8 = v4;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Scheduling modal task: %@", (uint8_t *)&v7, 0xCu);
  }
      ...
      for (i = 0; i != v6; ++i)
      {
        ...
        if (os_log_type_enabled(v11, v8))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v25 = 1024;
          v26 = v3;
          _os_log_impl(&dword_1B51E4000, v11, v8, "Cancelling task %@ with reason %d", buf, 0x12u);
        }
...
- (void)_retainPowerAssertionForTask:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      if ((objc_opt_respondsToSelector() & 1) == 0
        || (v6 = objc_msgSend(v12, "shouldHoldPowerAssertion"), v4 = v12, v6))
      {
        -[DATaskManager powerAssertionGroupID](self, "powerAssertionGroupID", v4);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        v8 = v7;
        if (v7)
        {
