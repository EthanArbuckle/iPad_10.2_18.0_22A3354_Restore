...
- (DAResponse)initWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v5, "allowsKeyedCoding") & 1) == 0)
  {
    ...
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAction.m"), 216, CFSTR("Who does non-keyed coding nowadays?"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v5, "allowsKeyedCoding") & 1) == 0)
  {
    ...
    objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAction.m"), 225, CFSTR("Who does non-keyed coding nowadays?"));
