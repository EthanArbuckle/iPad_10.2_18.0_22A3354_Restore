...
LABEL_17:
    ...
    objc_msgSend(v30, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("DAUserNotificationUtilities.m"), 74, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("completionBlock != nil"));
  ...
  objc_msgSend(v29, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("DAUserNotificationUtilities.m"), 73, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("notification != nil"));
...
LABEL_18:
  ...
  objc_msgSend(v31, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("DAUserNotificationUtilities.m"), 75, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("runLoop != nil"));
...
LABEL_4:
  ...
  if (v18)
  {
    ...
    objc_msgSend(v32, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("DAUserNotificationUtilities.m"), 76, CFSTR("Already waiting on this notification %p"), a3);
  ...
  else
  {
    ...
    v28 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 3);
    if (os_log_type_enabled(v27, v28))
    {
      *(_DWORD *)buf = 138412290;
      v34 = a3;
      _os_log_impl(&dword_1B51E4000, v27, v28, "Couldn't schedule response for notification %@", buf, 0xCu);
    }
