...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v3, v4))
  {
    *(_DWORD *)buf = 134217984;
    v9 = self;
    _os_log_impl(&dword_1B51E4000, v3, v4, "DAAccount %p is going away...", buf, 0xCu);
  }
...
- (int)daAccountVersion
{
  ...
  v3 = -[DAAccount accountIntPropertyForKey:](self, "accountIntPropertyForKey:", CFSTR("DAAccountVersion2"));
  if (!v3)
  {
    ...
    if (v8)
    {
      v9 = -[NSObject intValue](v8, "intValue");
      if (v9)
      {
        v10 = v9;
        DALoggingwithCategory();
        ...
        if (v10 > 14)
        {
          if (v13)
          {
            ...
            v24 = 2114;
            v25 = v5;
            _os_log_impl(&dword_1B51E4000, v11, v12, "Account %{public}@ has no DAAccountVersion, and the previous build version string (%{public}@) appears new enough not to force migration. Assuming DAAccountVersion 1.", (uint8_t *)&v22, 0x16u);
...
LABEL_13:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, v16))
      {
        ...
        v19 = 12;
LABEL_14:
        _os_log_impl(&dword_1B51E4000, v17, v18, v15, (uint8_t *)&v22, v19);
...
LABEL_16:
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v24 = 1024;
    LODWORD(v25) = v4;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Account %{public}@ has DAAccountVersion %d", (uint8_t *)&v22, 0x12u);
...
- (DAAccount)initWithBackingAccountInfo:(id)a3
{
  ...
  if (v6)
  {
    ...
    -[DAAccount _refreshCredential](v7, "_refreshCredential");
...
- (void)_refreshCredential
{
  ...
  if (-[ACAccount isPropertyDirty:](self->_backingAccountInfo, "isPropertyDirty:", *MEMORY[0x1E0C8F240]))
  {
    DALoggingwithCategory();
    v3 = objc_claimAutoreleasedReturnValue();
    v4 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 6);
    if (os_log_type_enabled(v3, v4))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v8 = v5;
      _os_log_impl(&dword_1B51E4000, v3, v4, "Not clearing/refreshing account credentials for account %{public}@ because the credentials have yet to be saved.", buf, 0xCu);
  ...
  else
  {
    ...
    v6[3] = &unk_1E68CB298;
    v6[4] = self;
    -[DAAccount performUsingAccountPersona:](self, "performUsingAccountPersona:", v6);
  }
}

_QWORD *__31__DAAccount__refreshCredential__block_invoke(_QWORD *result, uint64_t a2)
{
  _QWORD *v2;
  ...
  {
    v2 = result;
    objc_msgSend(*(id *)(result[4] + 8), "_clearCachedCredentials");
    return (id)objc_msgSend(*(id *)(v2[4] + 8), "credential");
  }
  return result;
}
...
+ (id)daAccountSubclassWithBackingAccountInfo:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v5, "isEqualToString:", *MEMORY[0x1E0C8F080]))
  {
  ...
  else
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0C8F0B8]);

    if (!v8)
    {
      +[DAAccountLoader sharedInstance](DAAccountLoader, "sharedInstance");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = (objc_class *)objc_msgSend(v11, "daemonAppropriateAccountClassForACAccount:", v3);

      v9 = objc_msgSend([v12 alloc], "initWithBackingAccountInfo:", v3);
      goto LABEL_10;
    }
  }
  ...
  if (ExchangeSyncLibraryCore_frameworkLibrary)
  {
    objc_msgSend(getESAccountClass(), "esAccountSubclassWithBackingAccountInfo:", v3);
...
- (id)accountsProviderWithDBHelper:(id)a3
{
  ...
  v3 = (void *)MEMORY[0x1E0D1C3E8];
  v4 = a3;
  if (objc_msgSend(v3, "useContactsFramework"))
  {
    objc_msgSend(v4, "contactStore");
    v5 = (void *)objc_claimAutoreleasedReturnValue();

    +[DAContactsAccountProvider providerWithContactStore:](DAContactsAccountProvider, "providerWithContactStore:", v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();

  }
  else
  {
    v7 = objc_msgSend(v4, "abDB");

    +[DAContactsAccountProvider providerWithAddressBook:](DAContactsAccountProvider, "providerWithAddressBook:", v7);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v6;
}
...
- (id)containerProviderWithDBHelper:(id)a3
{
  ...
  if (objc_msgSend(v3, "useContactsFramework"))
  {
    ...
    +[DAContainerProvider providerWithContactStore:](DAContainerProvider, "providerWithContactStore:", v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    +[DAContainerProvider providerWithAddressBook:](DAContainerProvider, "providerWithAddressBook:", v7);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v6;
}
...
- (BOOL)upgradeAccount
{
  ...
  v3 = -[DAAccount daAccountVersion](self, "daAccountVersion");
  if (v3 <= 0)
  {
    ...
    -[DAAccount setDAAccountVersion:](self, "setDAAccountVersion:", 1);
  }
  return v3 < 1;
}
...
- (void)resetAccountID
{
  ...
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAccount.m"), 324, CFSTR("We shouldn't be resetting our account id, ever"));
...
- (NSString)changeTrackingID
{
  ...
  -[DAAccount persistentUUID](self, "persistentUUID");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("com.apple.dataaccessd-%@"), v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)enabledForAnyDADataclasses:(int64_t)a3
{
  ...
  v3 = a3;
  if ((a3 & 1) == 0)
    return (v3 & 2) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 2)
        || (v3 & 4) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 4)
        || (v3 & 8) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 8)
        || (v3 & 0x10) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 16)
        || (v3 & 0x20) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 32);
  v5 = 1;
  if (!-[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 1))
    return (v3 & 2) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 2)
        || (v3 & 4) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 4)
        || (v3 & 8) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 8)
        || (v3 & 0x10) != 0 && -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 16)
...
- (void)setEnabled:(BOOL)a3 forDADataclass:(int64_t)a4
{
  ...
  if (os_log_type_enabled(v7, v8))
  {
    ...
    v17 = 2114;
    v18 = v10;
    _os_log_impl(&dword_1B51E4000, v7, v8, "Account \"%@\" (%{public}@) was toggled for a dataclass. Giving it another chance with the babysitter.", (uint8_t *)&v15, 0x16u);
...
- (id)spinnerIdentifiers
{
  ...
  DALoggingwithCategory();
  v3 = objc_claimAutoreleasedReturnValue();
  v4 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 3);
  if (os_log_type_enabled(v3, v4))
  {
    v6 = 136315138;
    Name = sel_getName(a2);
    _os_log_impl(&dword_1B51E4000, v3, v4, "%s to be implemented by subclass", (uint8_t *)&v6, 0xCu);
  }
...
- (void)resumeMonitoringFoldersWithIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v4, v5))
  {
    v6 = 136315138;
    Name = sel_getName(a2);
    _os_log_impl(&dword_1B51E4000, v4, v5, "%s to be implemented by subclass", (uint8_t *)&v6, 0xCu);
  }
...
- (void)suspendMonitoringFoldersWithIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v4, v5))
  {
    ...
    v6 = v10;
    _os_log_impl(&dword_1B51E4000, v4, v5, "%s being ignored by %@", (uint8_t *)&v7, 0x16u);
...
- (void)setConsumer:(id)a3 forTask:(id)a4
{
  ...
  if (os_log_type_enabled(v11, v12))
  {
    ...
    v20 = 2048;
    v21 = v13;
    _os_log_impl(&dword_1B51E4000, v11, v12, "Added consumer %p for task %p to DAAccount %p, count: %lu", (uint8_t *)&v14, 0x2Au);
  }
...
- (void)removeConsumerForTask:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v12 = 2048;
    v13 = v7;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Removed consumer for task %p from DAAccount %p, count: %lu", (uint8_t *)&v8, 0x20u);
  }
...
- (NSString)clientToken
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v10 = 2112;
    v11 = v4;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Account %p clientToken: %@", (uint8_t *)&v8, 0x16u);
  }
...
- (void)clientTokenRequestedByServer
{
  ...
  if (!v4)
  {
    ...
    -[DAAccount backingAccountInfo](self, "backingAccountInfo");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "addClientToken:", v5);

    DALoggingwithCategory();
    v7 = objc_claimAutoreleasedReturnValue();
    v8 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 7);
    if (os_log_type_enabled(v7, v8))
    {
      v9 = 134218242;
      v10 = self;
      v11 = 2112;
      v12 = v5;
      _os_log_impl(&dword_1B51E4000, v7, v8, "Account %p clientTokenRequestedByServer, new token: %@", (uint8_t *)&v9, 0x16u);
    }
...
- (void)setPassword:(id)a3
{
  ...
  if (v5)
  {
    ...
    DALoggingwithCategory();
    v9 = objc_claimAutoreleasedReturnValue();
    v10 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 4);
    if (os_log_type_enabled(v9, v10))
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_1B51E4000, v9, v10, "Calling _backingAccountInfo.authenticated = YES for Account identifier %@ and username %@", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    ...
    DALoggingwithCategory();
    v7 = objc_claimAutoreleasedReturnValue();
    v8 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 4);
    if (os_log_type_enabled(v7, v8))
    {
      LOWORD(v13) = 0;
      _os_log_impl(&dword_1B51E4000, v7, v8, "Someone wanted to set a nil password, we're editing the live ACAccountCredential", (uint8_t *)&v13, 2u);
    }
  }
...
- (void)performUsingAccountPersona:(id)a3
{
  ...
  v4 = (void (**)(id, void *))a3;
  -[ACAccount cal_personaIdentifier](self->_backingAccountInfo, "cal_personaIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5 && objc_msgSend(v5, "length"))
  {
    ...
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v15, v17))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v23 = 2112;
        v24 = v10;
        _os_log_impl(&dword_1B51E4000, v15, v17, "Could not get current persona context for account %{public}@, with error %@", buf, 0x16u);
    ...
    objc_msgSend(v8, "createPersonaContextForBackgroundProcessingWithPersonaUniqueString:", v6);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v11)
    {
      ...
      v13 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 3);
      if (os_log_type_enabled(v12, v13))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v25 = 2112;
        v26 = v11;
        _os_log_impl(&dword_1B51E4000, v12, v13, "Could not convert account %{public}@ to persona %@, with error %@", buf, 0x20u);

      }
    }
    objc_msgSend(v11, "domain");
    v15 = objc_claimAutoreleasedReturnValue();
    if (!-[NSObject isEqualToString:](v15, "isEqualToString:", CFSTR("NSPOSIXErrorDomain")))
    {
LABEL_16:
    ...
    if (v16 == 1)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
        -[DAAccount performUsingAccountPersona:].cold.1(v15);
      goto LABEL_16;
    }
  }
  else
...
LABEL_17:
  v4[2](v4, v6);
  if (v8 && v9 && !v11)
    v19 = (id)objc_msgSend(v8, "restorePersonaWithSavedPersonaContext:", v9);
...
- (id)urlFromDataclassPropertiesForDataclass:(id)a3
{
  ...
  -[DAAccount backingAccountInfo](self, "backingAccountInfo");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "calTopLevelAccount");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v7, "count"))
  {
    ...
    if (!v13)
    {
      ...
      -[DAAccount dataclassPropertyURLsByDataclass](self, "dataclassPropertyURLsByDataclass");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v16, "setObject:forKeyedSubscript:", v13, v4);
...
- (void)setHost:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v10 = 2112;
    v11 = v4;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Changing Host From %@ to %@", (uint8_t *)&v8, 0x16u);
...
- (NSString)principalPath
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[DAAccount objectForKeyedSubscript:](self, "objectForKeyedSubscript:", v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "da_appendSlashIfNeeded");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setPrincipalPath:(id)a3
{
  ...
  v5 = a3;
  objc_msgSend(v4, "DAAccountPrincipalPath");
  v6 = (id)objc_claimAutoreleasedReturnValue();
  -[DAAccount setObject:forKeyedSubscript:](self, "setObject:forKeyedSubscript:", v5, v6);
...
- (id)onBehalfOfBundleIdentifier
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  Name = sel_getName(a2);
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAccount.m"), 878, CFSTR("%s MUST be implemented in ALL DAAccount subclasses.  Looks like it's missing in %@"), Name, objc_opt_class());
...
- (void)removeDBSyncDataForAccountChange:(id)a3
{
  ...
  if (!-[DAAccount shouldRemoveDBSyncDataOnAccountChange](self, "shouldRemoveDBSyncDataOnAccountChange", a3))
    return;
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 2);
  ...
  if (os_log_type_enabled(v7, v8))
  {
    *(_DWORD *)buf = 138412290;
    v65 = self;
    _os_log_impl(&dword_1B51E4000, v7, v8, "Removing contacts data for account %@, because it has a significant change", buf, 0xCu);
  }

  -[DAAccount changeTrackingID](self, "changeTrackingID");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "abOpenDBWithClientIdentifier:", v9);

  -[DAAccount accountsProviderWithDBHelper:](self, "accountsProviderWithDBHelper:", v4);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[DAAccount accountID](self, "accountID");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "fetchedAccountWithExternalIdentifier:", v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();

  v13 = objc_alloc_init(MEMORY[0x1E0C973D0]);
  if (v12)
  {
    -[DAAccount containerProviderWithDBHelper:](self, "containerProviderWithDBHelper:", v4);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "externalIdentifier");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "allContainersForAccountWithExternalIdentifier:", v15);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v17, v8))
    {
      ...
      *(_DWORD *)buf = 134217984;
      v65 = (DAAccount *)v18;
      _os_log_impl(&dword_1B51E4000, v17, v8, "Found %ld contacts sources to remove", buf, 0xCu);
    }
      ...
      do
      {
        for (i = 0; i != v23; ++i)
        {
          ...
          if (objc_msgSend(MEMORY[0x1E0D1C3E8], "useContactsFramework"))
            objc_msgSend(v25, "updateSaveRequest:", v13);
        }
        v23 = objc_msgSend(v19, "countByEnumeratingWithState:objects:count:", &v59, v63, 16);
      }
      while (v23);
      v26 = 1;
      v4 = v57;
    ...
    v29 = objc_msgSend(MEMORY[0x1E0D1C3E8], "useContactsFramework");
    v6 = MEMORY[0x1E0D1C448];
    if ((v29 & 1) != 0)
    {
      if (v21)
      {
        objc_msgSend(v4, "addSaveRequest:", v13);
        objc_msgSend(v4, "executeAllSaveRequests");
        v28 = 1;
      }
      else
      {
  ...
  objc_msgSend(v4, "abCloseDBAndSave:", v26);
  v28 = v26;
LABEL_26:

  v27 = v28 != 0;
LABEL_27:
  if (-[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 4)
    || -[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 16))
  {
    DALoggingwithCategory();
    ...
    if (os_log_type_enabled(v30, v31))
    {
      *(_DWORD *)buf = 138412290;
      v65 = self;
      _os_log_impl(&dword_1B51E4000, v30, v31, "Removing event / todo data for account %@, because it has a significant change", buf, 0xCu);
    }
    ...
    objc_msgSend(v4, "calOpenDatabaseForAccountID:clientID:", v32, v33);

    -[DAAccount accountID](self, "accountID");
    v34 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "calDatabaseForAccountID:", v34);
    ...
    if (v35)
    {
      ...
      if (objc_msgSend(v37, "count"))
      {
        ...
        if (os_log_type_enabled(v38, v31))
        {
          ...
          *(_DWORD *)buf = 134217984;
          v65 = (DAAccount *)v39;
          _os_log_impl(&dword_1B51E4000, v38, v31, "Found %ld calendars to remove", buf, 0xCu);
        }
        ...
        if (objc_msgSend(v37, "count"))
        {
          ...
          do
          {
            objc_msgSend(v37, "objectAtIndexedSubscript:", v40);

            CalRemoveCalendar();
            ++v40;
          }
          while (v40 < objc_msgSend(v37, "count"));
          v27 = 1;
        }
      }
    ...
    objc_msgSend(v4, "calCloseDatabaseForAccountID:save:", v42, v27);

  }
  if (-[DAAccount enabledForDADataclass:](self, "enabledForDADataclass:", 32))
  {
    v43 = objc_msgSend(MEMORY[0x1E0D1C3E8], "completelyIgnoreNotes");
    DALoggingwithCategory();
    ...
    if (v43)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1B51E4000, v45, v46, "Ignoring Notes orphan check.  You asked for it.", buf, 2u);
      }
    }
    else
    {
      v47 = *(unsigned __int8 *)(v6 + 6);
      if (os_log_type_enabled(v44, *(os_log_type_t *)(v6 + 6)))
      {
        *(_DWORD *)buf = 138412290;
        v65 = self;
        _os_log_impl(&dword_1B51E4000, v45, (os_log_type_t)v47, "Removing notes data for account %@, because it has a significant change", buf, 0xCu);
      }

      v45 = objc_opt_new();
      -[NSObject enableChangeLogging:](v45, "enableChangeLogging:", 0);
      -[DAAccount accountID](self, "accountID");
      v48 = (void *)objc_claimAutoreleasedReturnValue();
      -[NSObject accountForAccountId:](v45, "accountForAccountId:", v48);
      ...
      if (v49)
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_1B51E4000, v50, (os_log_type_t)v47, "Found a note account to remove", buf, 2u);
        }

        -[NSObject deleteAccount:](v45, "deleteAccount:", v49);
        v58 = 0;
        v51 = -[NSObject save:](v45, "save:", &v58);
        v52 = v58;
        if ((v51 & 1) == 0)
        {
          DALoggingwithCategory();
          ...
          {
            objc_msgSend(v52, "DAExtendedDescription");
            v55 = (DAAccount *)objc_claimAutoreleasedReturnValue();
            *(_DWORD *)buf = 138412290;
            v65 = v55;
            _os_log_impl(&dword_1B51E4000, v53, v54, "Failed to save: %@", buf, 0xCu);

          }
          if (objc_msgSend(MEMORY[0x1E0D629F0], "databaseIsCorrupt:", v52))
          {
            DALoggingwithCategory();
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_impl(&dword_1B51E4000, v56, v54, "Notes database was corrupted! Non-fatal at this point, but just barely", buf, 2u);
            }
...
- (void)accountDidChangeWithChangeInfo:(id)a3
{
  ...
  v12 = *MEMORY[0x1E0C80C00];
  v4 = a3;
  if (-[DAAccount accountHasSignificantPropertyChangesWithChangeInfo:](self, "accountHasSignificantPropertyChangesWithChangeInfo:", v4))
  {
    DALoggingwithCategory();
    v5 = objc_claimAutoreleasedReturnValue();
    v6 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 4);
    if (os_log_type_enabled(v5, v6))
    {
      backingAccountInfo = self->_backingAccountInfo;
      v8 = 138412546;
      ...
      _os_log_impl(&dword_1B51E4000, v5, v6, "Account had significant property change, going to flush local data.\n\nChangeInfo %@\n\nNewProperties %@", (uint8_t *)&v8, 0x16u);
    }

    -[DAAccount _handleSignificantPropertyChanges:](self, "_handleSignificantPropertyChanges:", v4);
  }
...
{
  -[DAAccount removeDBSyncDataForAccountChange:](self, "removeDBSyncDataForAccountChange:", a3);
...
- (id)additionalHeaderValues
{
  ...
  if (v5)
  {
    ...
    else
    {
      DALoggingwithCategory();
      v9 = objc_claimAutoreleasedReturnValue();
      v11 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 4);
      if (os_log_type_enabled(v9, v11))
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1B51E4000, v9, v11, "Couldn't get a Yahoo cookie. Not setting authentication headers", buf, 2u);
      }
      v10 = 0;
    }
...
- (id)oauth2Token
{
  ...
  if (os_log_type_enabled(v3, v4))
  {
    ...
    v18 = 138412290;
    v19 = v6;
    _os_log_impl(&dword_1B51E4000, v3, v4, "Fetching OAuth Credential for Backing Account %@", (uint8_t *)&v18, 0xCu);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v13, v4))
  {
    ...
    v22 = 2114;
    v23 = v16;
    _os_log_impl(&dword_1B51E4000, v13, v4, "Account Store Returned A %@ OAuth-token From Credential Object %@ AccountID: %{public}@", (uint8_t *)&v18, 0x20u);
...
- (void)tearDown
{
  ...
  if (os_log_type_enabled(v3, v4))
  {
    ...
    v5 = v9;
    _os_log_impl(&dword_1B51E4000, v3, v4, "%s being ignored by %@", (uint8_t *)&v6, 0x16u);
...
- (BOOL)saveAccountPropertiesWithError:(id *)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAAccount publicDescription](self, "publicDescription");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    *(_DWORD *)buf = 138412546;
    *(_QWORD *)&buf[4] = v7;
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v8;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Saving account \"%@\" (%{public}@)", buf, 0x16u);
  ...
  if (os_log_type_enabled(v9, v6))
  {
    ...
    *(_WORD *)&buf[18] = 2112;
    *(_QWORD *)&buf[20] = v15;
    _os_log_impl(&dword_1B51E4000, v9, v6, " _backingAccountInfo.authenticated is %d for Account identifier %@ and username %@", buf, 0x1Cu);
  ...
  *(_QWORD *)&buf[24] = __Block_byref_object_copy_;
  ...
  v22[5] = &v23;
  v22[6] = buf;
  -[DAAccount performUsingAccountPersona:](self, "performUsingAccountPersona:", v22);
  if (*(_QWORD *)(*(_QWORD *)&buf[8] + 40))
  {
    ...
    if (os_log_type_enabled(v16, v17))
    {
      ...
      *(_DWORD *)v27 = 138412546;
      ...
      v29 = 2112;
      v30 = v19;
      _os_log_impl(&dword_1B51E4000, v16, v17, "Error saving account %@: %@", v27, 0x16u);
    }
...
void __44__DAAccount_saveAccountPropertiesWithError___block_invoke(_QWORD *a1)
{
  void *v2;
  uint64_t v3;
  char v4;
  ...
  v3 = *(_QWORD *)(a1[4] + 8);
  v8 = 0;
  v4 = objc_msgSend(v2, "saveVerifiedAccount:error:", v3, &v8);
  v5 = v8;
...
{
  return -[DAAccount saveAccountPropertiesWithError:](self, "saveAccountPropertiesWithError:", 0);
}
...
- (void)updateExistingAccountProperties
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, v8))
    {
      ...
      v10 = 138412290;
      v11 = backingAccountInfo;
      _os_log_impl(&dword_1B51E4000, v7, v8, "Not updating non-existing account: %@", (uint8_t *)&v10, 0xCu);
    }
...
- (BOOL)preflightSaveWithAccountProvider:(id)a3
{
  ...
  if (-[DAAccount canSaveWithAccountProvider:](self, "canSaveWithAccountProvider:", a3))
  {
    -[DAAccount backingAccountInfo](self, "backingAccountInfo");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0D1C438], "DAAccountSavePreflighted");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)canSaveWithAccountProvider:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0D1C438], "leafAccountTypesToCheckForEquality");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v8)
  {
    ...
    v45 = 0u;
    v11 = v9;
    v12 = -[NSObject countByEnumeratingWithState:objects:count:](v11, "countByEnumeratingWithState:objects:count:", &v42, v48, 16);
    if (v12)
    {
      v13 = v12;
      v14 = *(_QWORD *)v43;
      ...
      while (2)
      {
        for (i = 0; i != v13; ++i)
        {
          ...
          objc_msgSend(v16, "backingAccountInfo");
          ...
          if ((objc_msgSend(v18, "isEqualToString:", v10) & 1) == 0)
          {
            ...
            v21 = objc_msgSend(v20, "isEqualToString:", v40);

            if (v21)
            {
              if (-[DAAccount isEqualToAccount:](v39, "isEqualToAccount:", v16))
              {
                objc_msgSend(v38, "accountProperties");
                v22 = (void *)objc_claimAutoreleasedReturnValue();
                v23 = objc_msgSend(v22, "count");

                if (v23)
                {
                  objc_msgSend(MEMORY[0x1E0D1C438], "DAAccountIdentifiersToIgnoreForUniquenessCheck");
                  v24 = (void *)objc_claimAutoreleasedReturnValue();
                  objc_msgSend(v38, "objectForKeyedSubscript:", v24);
                  v25 = (void *)objc_claimAutoreleasedReturnValue();
                  v26 = objc_msgSend(v25, "containsObject:", v18);
        ...
        v11 = obj;
        v13 = -[NSObject countByEnumeratingWithState:objects:count:](obj, "countByEnumeratingWithState:objects:count:", &v42, v48, 16);
        if (v13)
          continue;
        break;
      }
  ...
  if (v28
    && (objc_msgSend(MEMORY[0x1E0D1C438], "DAAccountDoNotSaveReason"),
        ...
        v30))
  {
    ...
    if (os_log_type_enabled(v31, v32))
    {
      objc_msgSend(MEMORY[0x1E0D1C438], "DAAccountDoNotSaveReason");
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v38, "objectForKeyedSubscript:", v33);
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138412290;
      v47 = v34;
      _os_log_impl(&dword_1B51E4000, v31, v32, "Refusing to save account because DAAccountDoNotSave is set to \"%@\", buf, 0xCu);
...
- (void)setIdentityCertificatePersistentID:(id)a3 managedByProfile:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v7, v8))
  {
    ...
    v11 = 138412290;
    v12 = v9;
    _os_log_impl(&dword_1B51E4000, v7, v8, "Setting identity certificate. Managed by profile? %@", (uint8_t *)&v11, 0xCu);
  }
...
- (BOOL)shouldFailAllTasks
{
  ...
  -[DAAccount backingAccountInfo](self, "backingAccountInfo");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v3, "supportsAuthentication") & 1) == 0)
  {
  ...
  if (os_log_type_enabled(v6, v7))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v9;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Account %@ (%{public}@) says it is not authenticated. Refreshing to be sure.", buf, 0x16u);
  ...
  if ((v12 & 1) != 0)
  {
    if (v14)
    {
      ...
      *(_WORD *)&buf[12] = 2114;
      *(_QWORD *)&buf[14] = v16;
      _os_log_impl(&dword_1B51E4000, v13, v7, "Good news! Account %@ (%{public}@) is now authenticated after refreshing.", buf, 0x16u);
  ...
  if (v14)
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v33;
    _os_log_impl(&dword_1B51E4000, v13, v7, "Account %@ (%{public}@) is still not authenticated after refreshing.", buf, 0x16u);

  }
  -[DAAccount backingAccountInfo](self, "backingAccountInfo");
  v34 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v34, "accountProperties");
  v35 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v35, "objectForKeyedSubscript:", *MEMORY[0x1E0D0C4F8]);
  ...
  if (v37)
  {
    ...
    *(_QWORD *)&buf[16] = 0x2020000000;
    ...
    v43[4] = self;
    v43[5] = buf;
    -[DAAccount performUsingAccountPersona:](self, "performUsingAccountPersona:", v43);
    if (*(_BYTE *)(*(_QWORD *)&buf[8] + 24))
    {
      ...
      if (os_log_type_enabled(v38, v7))
      {
        ...
        *(_DWORD *)v44 = 138412546;
        ...
        v46 = 2114;
        v47 = v40;
        _os_log_impl(&dword_1B51E4000, v38, v7, "The account %@ (%{public}@) is not marked as authenticated, but it supports authentication, appears to have credentials, and is marked to ignore the isAuthenticated property. We will try to sync this account.", v44, 0x16u);
  ...
  if (!-[DAAccount isValidating](self, "isValidating")
    && (!-[DAAccount wasUserInitiated](self, "wasUserInitiated")
     || -[DAAccount isDelegateAccount](self, "isDelegateAccount")))
  {
    DALoggingwithCategory();
    ...
    if (os_log_type_enabled(v19, v7))
    {
      ...
      *(_WORD *)&buf[12] = 2114;
      *(_QWORD *)&buf[14] = v42;
      _os_log_impl(&dword_1B51E4000, v19, v7, "Not attempting request for account %@ because the backing account credential isn't authed %{public}@", buf, 0x16u);
...
LABEL_10:
  -[DAAccount backingAccountInfo](self, "backingAccountInfo");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = objc_msgSend(v17, "aa_isSuspended");
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v19, v20))
    {
      ...
      *(_WORD *)&buf[12] = 2114;
      *(_QWORD *)&buf[14] = v24;
      _os_log_impl(&dword_1B51E4000, v19, v20, "Not attempting request for account %{public}@ because the backing account needs to verify terms or is suspended. %{public}@", buf, 0x16u);
  ...
  else
  {
    +[DAKeychain sharedKeychain](DAKeychain, "sharedKeychain");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    v26 = objc_msgSend(v25, "canAccessCredentialsWithAccessibility:", -[DAAccount keychainAccessibilityType](self, "keychainAccessibilityType"));

    if ((v26 & 1) != 0)
      return 0;
    DALoggingwithCategory();
    v19 = objc_claimAutoreleasedReturnValue();
    v28 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 4);
    if (os_log_type_enabled(v19, v28))
    {
      v29 = (objc_class *)objc_opt_class();
      NSStringFromClass(v29);
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      v31 = -[DAAccount keychainAccessibilityType](self, "keychainAccessibilityType");
      *(_DWORD *)buf = 138543618;
      *(_QWORD *)&buf[4] = v30;
      *(_WORD *)&buf[12] = 1024;
      *(_DWORD *)&buf[14] = v31;
      _os_log_impl(&dword_1B51E4000, v19, v28, "Not attempting request for account %{public}@ because we don't have access to keychain items with accessibility %d right now", buf, 0x12u);
...
- (BOOL)isEqualToAccount:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  Name = sel_getName(a2);
  objc_msgSend(v5, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAccount.m"), 1333, CFSTR("%s MUST be implemented in ALL DAAccount subclasses.  Looks like it's missing in %@"), Name, objc_opt_class());
...
- (BOOL)accountHasSignificantPropertyChangesWithChangeInfo:(id)a3
{
  ...
  v35 = a3;
  objc_msgSend(v35, "oldAccountProperties");
  v39 = (void *)objc_claimAutoreleasedReturnValue();
  v40 = 0u;
  v41 = 0u;
  v42 = 0u;
  v43 = 0u;
  v44[0] = CFSTR("DAAccountHost");
  v44[1] = CFSTR("DAAccountEmailAddress");
  objc_msgSend(MEMORY[0x1E0D1C438], "DAAccountPrincipalPath");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v44[2] = v5;
  ...
  v38 = objc_msgSend(v6, "countByEnumeratingWithState:objects:count:", &v40, v45, 16);
  if (v38)
  {
    obj = v6;
    v37 = *(_QWORD *)v41;
    while (2)
    {
      for (i = 0; i != v38; ++i)
      {
        ...
        if (v11
          || (objc_msgSend(v39, "objectForKeyedSubscript:", v8),
              v3 = (void *)objc_claimAutoreleasedReturnValue(),
...
LABEL_25:
  ...
  if (!v25)
    goto LABEL_25;
LABEL_27:
  v28 = -[DAAccount useSSL](v21, "useSSL");
  objc_msgSend(v39, "objectForKeyedSubscript:", CFSTR("DAAccountUseSSL"));
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  v30 = v29;
  if (v29)
  ...
  if (v31 == v28)
  {
    -[DAAccount objectForKeyedSubscript:](v21, "objectForKeyedSubscript:", CFSTR("DAAccountPort"));
    v32 = (void *)objc_claimAutoreleasedReturnValue();
    v33 = objc_msgSend(v32, "intValue");
    objc_msgSend(v39, "objectForKeyedSubscript:", CFSTR("DAAccountPort"));
    v34 = (void *)objc_claimAutoreleasedReturnValue();
    v26 = v33 != objc_msgSend(v34, "intValue");
...
void __31__DAAccount_copyStorageSession__block_invoke()
{
  ...
  v0 = dispatch_queue_create("com.apple.dataaccess.StorageSessionSetup", 0);
...
- (void)shutdown
{
  ...
  {
    *(_WORD *)v5 = 0;
    _os_log_impl(&dword_1B51E4000, v3, v4, "Shutting down the task manager", v5, 2u);
  }
...
- (BOOL)shouldCancelTaskDueToOnPowerFetchMode
{
  ...
  if (xpcActivity)
  {
    ...
    if ((_DWORD)xpcActivity)
    {
      ...
      {
        *(_WORD *)v6 = 0;
        _os_log_impl(&dword_1B51E4000, v3, v4, "Canceling task because conditions for on-power mode no longer exist (xpc_activity)", v6, 2u);
      }
...
- (void)saveXpcActivity:(id)a3
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1B51E4000, v6, v7, "XPC: Saved XPC activity for account %{public}@", (uint8_t *)&v9, 0xCu);
...
- (void)incrementXpcActivityContinueCount
{
  ...
  if (self->_xpcActivity)
  {
    ...
    if (os_log_type_enabled(v3, v4))
    {
      ...
      v8 = 2114;
      v9 = v6;
      _os_log_impl(&dword_1B51E4000, v3, v4, "XPC: Increment XPC activity continue count to %d for account %{public}@", (uint8_t *)v7, 0x12u);
...
- (void)decrementXpcActivityContinueCount
{
  ...
  if (self->_xpcActivity)
  {
    ...
    if (os_log_type_enabled(v3, v4))
    {
      ...
      v8 = 2114;
      v9 = v6;
      _os_log_impl(&dword_1B51E4000, v3, v4, "XPC: Decrement XPC activity continue count to %d for account %{public}@", (uint8_t *)v7, 0x12u);
...
- (void)removeXpcActivity
{
  ...
  if (xpcActivity)
  {
    ...
    if (v4)
    {
      LOBYTE(v7) = *(_BYTE *)(MEMORY[0x1E0D1C448] + 6);
...
LABEL_7:
        _os_log_impl(&dword_1B51E4000, v6, (os_log_type_t)v7, v9, (uint8_t *)&v11, 0xCu);

      }
    }
    else
    {
      v7 = *(unsigned __int8 *)(MEMORY[0x1E0D1C448] + 3);
      if (os_log_type_enabled(v5, *(os_log_type_t *)(MEMORY[0x1E0D1C448] + 3)))
      {
        -[DAAccount accountID](self, "accountID");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        v11 = 138543362;
...
- (id)localizedIdenticalAccountFailureMessage
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = objc_opt_class();
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAccount.m"), 1544, CFSTR("Account class %@ MUST implement %s"), v5, sel_getName(a2));
...
- (id)localizedInvalidPasswordMessage
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = objc_opt_class();
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAccount.m"), 1549, CFSTR("Account class %@ MUST implement %s"), v5, sel_getName(a2));
...
- (void)dropAssertionsAndRenewCredentialsInQueue:(id)a3 withHandler:(id)a4
{
  ...
  DALoggingwithCategory();
  v8 = objc_claimAutoreleasedReturnValue();
  v9 = MEMORY[0x1E0D1C448];
  v10 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 5);
  if (os_log_type_enabled(v8, v10))
  {
    v11 = (objc_class *)objc_opt_class();
    NSStringFromClass(v11);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v13 = -[DAAccount wasUserInitiated](self, "wasUserInitiated");
    v14 = CFSTR("NO");
    if (v13)
      v14 = CFSTR("YES");
    *(_DWORD *)buf = 138543618;
    ...
    v45 = 2114;
    v46 = v14;
    _os_log_impl(&dword_1B51E4000, v8, v10, "DataAccess is renewing credentials for account %{public}@ by forcing-prompt: %{public}@", buf, 0x16u);
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v17 = *MEMORY[0x1E0D0C4F8];
  objc_msgSend(v16, "objectForKeyedSubscript:", *MEMORY[0x1E0D0C4F8]);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v18)
  {
    -[DAAccount backingAccountInfo](self, "backingAccountInfo");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "setAccountProperty:forKey:", 0, v17);
    ...
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    v40 = 0;
    v22 = objc_msgSend(v20, "saveVerifiedAccount:error:", v21, &v40);
    v23 = v40;
    ...
    if ((v22 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v24, v25))
      {
        *(_DWORD *)buf = 138412290;
        v44 = v23;
        _os_log_impl(&dword_1B51E4000, v24, v25, "Failed to save account when attempting to remove kDAAccountIgnoreAuthenticatedProperty flag: %@", buf, 0xCu);
      }
  ...
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v27, "dropPowerAssertionsForGroupIdentifier:", v26);

  v41[0] = *MEMORY[0x1E0C8F330];
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[DAAccount wasUserInitiated](self, "wasUserInitiated"));
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  v42[0] = v28;
  v41[1] = *MEMORY[0x1E0C8F320];
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[DAAccount wasUserInitiated](self, "wasUserInitiated") ^ 1);
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  v42[1] = v29;
  ...
  v34 = v26;
  v35 = v6;
  objc_msgSend(v31, "renewCredentialsForAccount:options:completion:", v32, v30, v36);
...
uint64_t __92__DAAccount_AuthenticationExtensions__dropAssertionsAndRenewCredentialsInQueue_withHandler___block_invoke_2(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v6)
    {
      ...
      v22 = 2048;
      v23 = v11;
      _os_log_impl(&dword_1B51E4000, v4, v5, "DataAccess failed to renew credentials for account %{public}@ by forcing-prompt: %{public}@ - renewalResult = %ld", (uint8_t *)&v18, 0x20u);
  ...
  else
  {
    if (v6)
    {
      ...
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = objc_msgSend(*(id *)(a1 + 40), "wasUserInitiated");
      v15 = CFSTR("NO");
      if (v14)
        v15 = CFSTR("YES");
      v18 = 138543618;
      ...
      v20 = 2114;
      v21 = v15;
      _os_log_impl(&dword_1B51E4000, v4, v5, "DataAccess successfully renewed credentials for account %{public}@ by forcing-prompt: %{public}@", (uint8_t *)&v18, 0x16u);

    }
    +[DAKeychain sharedKeychain](DAKeychain, "sharedKeychain");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "removePersistentCredentials");

    objc_msgSend(*(id *)(a1 + 40), "backingAccountInfo");
    v4 = objc_claimAutoreleasedReturnValue();
    -[NSObject reload](v4, "reload");
  }
...
void __56__DAAccount_AuthenticationExtensions___leafAccountTypes__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", *MEMORY[0x1E0C8F140], *MEMORY[0x1E0C8F058], *MEMORY[0x1E0C8F060], *MEMORY[0x1E0C8F0E0], *MEMORY[0x1E0C8F100], *MEMORY[0x1E0C8F0B0], 0);
...
+ (id)oneshotListOfAccountIDs
{
  ...
  if (ExchangeSyncLibraryCore_frameworkLibrary)
  {
    objc_msgSend(getESAccountClass(), "oneshotListOfAccountIDs");
    v2 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
+ (void)reacquireClientRestrictions:(id)a3
{
  ...
  if (!ExchangeSyncLibraryCore_frameworkLibrary)
    ExchangeSyncLibraryCore_frameworkLibrary = _sl_dlopen();
  if (ExchangeSyncLibraryCore_frameworkLibrary)
    objc_msgSend(getESAccountClass(), "reacquireClientRestrictions:", v3);

}

+ (id)_leafAccountTypes
{
  return (id)objc_msgSend(MEMORY[0x1E0D1C438], "leafAccountTypes");
}
...
- (BOOL)accountHasSignificantPropertyChangesFromOldAccountInfo:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0D1C3E0];
  v5 = a3;
  v6 = [v4 alloc];
  -[DAAccount backingAccountInfo](self, "backingAccountInfo");
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[DAAccount backingAccountInfo](v8, "backingAccountInfo");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "credential");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v6, "initWithChangeType:accountIdentifier:accountTypeIdentifier:oldAccountProperties:username:password:oldUsername:oldPassword:modifiedDataClasses:clientName:", 1, v7, v9, v18, v10, v12, v13, v15, 0, 0);

  LOBYTE(v10) = -[DAAccount accountHasSignificantPropertyChangesWithChangeInfo:](v20, "accountHasSignificantPropertyChangesWithChangeInfo:", v16);
  return (char)v10;
}
...
- (void)accountDidChangeFromOldAccountInfo:(id)a3
{
  ...
  if (-[DAAccount accountHasSignificantPropertyChangesFromOldAccountInfo:](self, "accountHasSignificantPropertyChangesFromOldAccountInfo:", v4))
  {
    ...
    -[DAAccount _handleSignificantPropertyChanges:](self, "_handleSignificantPropertyChanges:", 0);
  }
...
- (id)beginDownloadingAttachmentWithUUID:(id)a3 consumer:(id)a4
{
  ...
  if (os_log_type_enabled(v8, v9))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1B51E4000, v8, v9, "Downloading attachments is not supported on account ID %@. AttachmentUUID: %@", (uint8_t *)&v13, 0x16u);

  }
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 70, 0);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)requestCalendarAvailabilityForStartDate:(id)a3 endDate:(id)a4 ignoredEventID:(id)a5 addresses:(id)a6 consumer:(id)a7
{
  ...
  if (os_log_type_enabled(v9, v10))
  {
    ...
    v14 = 138543362;
    v15 = v11;
    _os_log_impl(&dword_1B51E4000, v9, v10, "Requesting calendar availability is not supported on account with ID [%{public}@].", (uint8_t *)&v14, 0xCu);

  }
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 81, 0);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)cancelCalendarAvailabilityRequestWithID:(id)a3
{
  ...
  if (os_log_type_enabled(v4, v5))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1B51E4000, v4, v5, "Cancelling calendar availability requests is not supported on account with ID [%{public}@].", (uint8_t *)&v7, 0xCu);
...
- (id)requestGrantedDelegatesListWithConsumer:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Requesting granted delegates list is not supported on account with ID [%{public}@].", (uint8_t *)&v10, 0xCu);

  }
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 83, 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "grantedDelegatesListRequestFinishedWithResults:error:", 0, v8);
...
- (void)cancelGrantedDelegatesListRequestWithID:(id)a3
{
  ...
  if (os_log_type_enabled(v4, v5))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1B51E4000, v4, v5, "Cancelling granted delegates list requests is not supported on account with ID [%{public}@].", (uint8_t *)&v7, 0xCu);
...
- (id)updateGrantedDelegatePermission:(id)a3 consumer:(id)a4
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Update granted delegate permission is not supported on account with ID [%{public}@].", (uint8_t *)&v11, 0xCu);

  }
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 84, 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "updateGrantedDelegatePermissionFinishedWithError:", v9);
...
- (void)cancelUpdateGrantedDelegatePermissionRequestWithID:(id)a3
{
  ...
  if (os_log_type_enabled(v4, v5))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1B51E4000, v4, v5, "Cancelling update granted delegate permission requests is not supported on account with ID [%{public}@].", (uint8_t *)&v7, 0xCu);
...
- (id)performCalendarDirectorySearchForTerms:(id)a3 recordTypes:(id)a4 resultLimit:(unint64_t)a5 consumer:(id)a6
{
  ...
  if (os_log_type_enabled(v8, v9))
  {
    ...
    v13 = 138543362;
    v14 = v10;
    _os_log_impl(&dword_1B51E4000, v8, v9, "Performing a calendar directory search is not supported on account with ID [%{public}@].", (uint8_t *)&v13, 0xCu);

  }
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 85, 0);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)performGroupExpansionForPrincipalPath:(id)a3 consumer:(id)a4
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Performing a calendar directory search is not supported on account with ID [%{public}@].", (uint8_t *)&v10, 0xCu);

  }
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 85, 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "groupExpansionFinishedWithResults:error:", 0, v9);
...
- (void)cancelCalendarDirectorySearchWithID:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v10 = 2112;
    v11 = v4;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Cancelling calendar directory searches is not supported on account with ID [%{public}@].  searchID: [%@]", (uint8_t *)&v8, 0x16u);
...
- (id)respondToShareRequestForCalendar:(id)a3 withResponse:(int64_t)a4 consumer:(id)a5
{
  ...
  if (os_log_type_enabled(v9, v10))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1B51E4000, v9, v10, "Responding to calendar shares is not supported on account ID %@. calendar ID: %@", (uint8_t *)&v14, 0x16u);

  }
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 76, 0);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)reportShareRequestAsJunkForCalendar:(id)a3 consumer:(id)a4
{
  ...
  if (os_log_type_enabled(v8, v9))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1B51E4000, v8, v9, "Reporting calendar shares as junk is not supported on account ID %@. calendar ID: %@", (uint8_t *)&v13, 0x16u);
...
- (id)fetchOfficeHoursWithConsumer:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Fetching office hours is not supported on account ID %{public}@", (uint8_t *)&v10, 0xCu);

  }
  if (a4)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 88, 0);
...
- (id)setOfficeHours:(id)a3 withConsumer:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v7, v8))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_1B51E4000, v7, v8, "Setting office hours is not supported on account ID %{public}@", (uint8_t *)&v11, 0xCu);
...
- (void)updateOofSettingsWithParams:(id)a3 consumer:(id)a4
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    v9 = 138412290;
    v10 = self;
    _os_log_impl(&dword_1B51E4000, v6, v7, "Updating oof settings requested on account %@, which does not support it", (uint8_t *)&v9, 0xCu);
  }

  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D1C3B8], 10, 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)retrieveOofSettingsForConsumer:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    v8 = 138412290;
    v9 = self;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Retrieving oof settings requested on account %@, which does not support it", (uint8_t *)&v8, 0xCu);
  }
...
- (BOOL)isOofSupported
{
  ...
  if (os_log_type_enabled(v3, v4))
  {
    v6 = 138412290;
    v7 = self;
    _os_log_impl(&dword_1B51E4000, v3, v4, "Checking if oof settings are supported on account %@, which does not support it", (uint8_t *)&v6, 0xCu);
  }
...
- (id)getPendingQueryQueue
{
  ...
  if (!v3)
  {
    ...
    -[DAAccount setPendingQueryQueue:](v2, "setPendingQueryQueue:", v5);

    objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeIntervalSinceNow:", -2.0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAAccount setLastQueryStartedTime:](v2, "setLastQueryStartedTime:", v6);
  ...
  if (*((_BYTE *)v9 + 24))
  {
    ...
    if (os_log_type_enabled(v5, v6))
    {
      *(_DWORD *)buf = 134217984;
      ...
      _os_log_impl(&dword_1B51E4000, v5, v6, "Delay pending search for %f seconds", buf, 0xCu);
    }
...
- (void)performSearchQuery:(id)a3
{
  ...
  if (*((_BYTE *)v19 + 24))
  {
    ...
    DALoggingwithCategory();
    v13 = objc_claimAutoreleasedReturnValue();
    v14 = *(_BYTE *)(MEMORY[0x1E0D1C448] + 7);
    if (os_log_type_enabled(v13, v14))
    {
      *(_DWORD *)buf = 134217984;
      v23 = v12;
      _os_log_impl(&dword_1B51E4000, v13, v14, "Delay new search for %f seconds", buf, 0xCu);
    }
...
- (void)_reallyPerformSearchQuery:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    v9 = 138412290;
    v10 = self;
    _os_log_impl(&dword_1B51E4000, v5, v6, "Search requested on account %@, which does not support it", (uint8_t *)&v9, 0xCu);
  }
...
- (void)performUsingAccountPersona:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_1B51E4000, log, OS_LOG_TYPE_FAULT, "This process needs entitlement com.apple.usermanagerd.persona.background", v1, 2u);
}
