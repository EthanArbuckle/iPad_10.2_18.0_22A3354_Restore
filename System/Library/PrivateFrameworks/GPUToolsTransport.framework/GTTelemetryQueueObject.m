...
- (GTTelemetryQueueObject)initWithCoder:(id)a3
{
  ...
  v5 = -[GTTelemetryQueueObject init](&v9, sel_init);
  if (v5)
  {
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)GTTelemetryQueueObject;
  -[GTTelemetryQueueObject description](&v3, sel_description);
