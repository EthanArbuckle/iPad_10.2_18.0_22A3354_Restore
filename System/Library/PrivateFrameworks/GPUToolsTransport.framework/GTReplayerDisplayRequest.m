...
{
  id v4;
  GTReplayerDisplayRequest *v5;
  GTReplayerDisplayRequest *v6;
  objc_super v8;
  ...
  if (v5)
  {
    ...
    v5->_filters = objc_msgSend(v4, "decodeInt32ForKey:", CFSTR("filters"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeInt32:forKey:", self->_filters, CFSTR("filters"));
