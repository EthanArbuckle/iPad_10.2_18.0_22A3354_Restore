...
- (DYGTMTLDeviceProfile)initWithCoder:(id)a3
{
  ...
  v5 = -[DYGTMTLDeviceProfile init](&v20, sel_init);
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeArrayOfObjectsOfClass:forKey:", objc_opt_class(), CFSTR("supportedFeatureSets"));
    v8 = objc_claimAutoreleasedReturnValue();
    supportedFeatureSets = v5->_supportedFeatureSets;
    v5->_supportedFeatureSets = (NSArray *)v8;

    objc_msgSend(v4, "decodeArrayOfObjectsOfClass:forKey:", objc_opt_class(), CFSTR("supportedGPUFamilies"));
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v16, CFSTR("defaultSamplePositions"));
