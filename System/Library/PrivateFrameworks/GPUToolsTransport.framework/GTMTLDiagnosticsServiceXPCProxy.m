...
- (GTMTLDiagnosticsServiceXPCProxy)initWithConnection:(id)a3 remoteProperties:(id)a4
{
  id v6;
  id v7;
  GTMTLDiagnosticsServiceXPCProxy *v8;
  void *v9;
  ...
  v8 = -[GTMTLDiagnosticsServiceXPCProxy init](&v21, sel_init);
  if (v8)
  {
    v9 = &unk_255D64478;
...
- (BOOL)respondsToSelector:(SEL)a3
{
  ...
  else
  {
    ...
    v7 = -[GTMTLDiagnosticsServiceXPCProxy respondsToSelector:](&v9, sel_respondsToSelector_, a3);
  }
...
- (unint64_t)registerObserver:(id)a3
{
  ...
  xpc_object_t empty;
  const char *Name;
  GTMTLDiagnosticsServiceReplyStream *v8;
  unint64_t v9;
  void *v10;
  void *v11;
  uint64_t uint64;
  ...
  v8 = -[GTMTLDiagnosticsServiceReplyStream initWithObserver:]([GTMTLDiagnosticsServiceReplyStream alloc], "initWithObserver:", v5);
...
- (void)raiseRuntimeIssue:(id)a3
{
  ...
  xpc_dictionary_set_string(empty, "_cmd", Name);
  if (v7)
    xpc_dictionary_set_string(empty, "messagePrefix", (const char *)objc_msgSend(objc_retainAutorelease(v7), "UTF8String"));
  -[GTServiceConnection sendMessage:](self->_connection, "sendMessage:", empty);
