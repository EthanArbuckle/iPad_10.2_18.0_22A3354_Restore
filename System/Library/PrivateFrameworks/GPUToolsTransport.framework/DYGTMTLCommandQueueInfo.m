...
- (DYGTMTLCommandQueueInfo)initWithCoder:(id)a3
{
  ...
  NSString *label;
  char v8;
  DYGTMTLCommandQueueInfo *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)DYGTMTLCommandQueueInfo;
  v5 = -[DYGTMTLCommandQueueInfo init](&v11, sel_init);
  if (v5)
  {
    ...
    v5->_toolsDeviceAddress = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("toolsDeviceAddress"));
    ...
    if (objc_msgSend(v4, "containsValueForKey:", CFSTR("canBeCaptured")))
      v8 = objc_msgSend(v4, "decodeBoolForKey:", CFSTR("canBeCaptured"));
    else
      v8 = 1;
...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("0x%llx -> %@"), self->_queueAddress, self->_label);
}
