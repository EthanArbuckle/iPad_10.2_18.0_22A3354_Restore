...
{
  GTBulkDataTransferOptions *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)GTBulkDataTransferOptions;
  result = -[GTBulkDataTransferOptions init](&v3, sel_init);
  if (result)
    *(_OWORD *)&result->_chunkSize = xmmword_22D0CE0C0;
  return result;
}
...
{
  id v4;
  GTBulkDataTransferOptions *v5;
  objc_super v7;

  v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)GTBulkDataTransferOptions;
  v5 = -[GTBulkDataTransferOptions init](&v7, sel_init);
  if (v5)
  {
