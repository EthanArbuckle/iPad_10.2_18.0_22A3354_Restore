...
+ (id)attributionImageFromAppPunchOut:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend((id)objc_opt_class(), "attributionImageFromKey:pressedKey:punchOut:", 0, 0, v3);
...
+ (id)attributionImageFromImageResource:(id)a3
{
  ...
  -[SiriUIAttributionImage setRemoteURL:](v11, "setRemoteURL:", v4);
  -[SiriUIAttributionImage setRemoteScale:](v11, "setRemoteScale:", v6);
...
+ (id)attributionImageWithLocalResourceName:(id)a3 pressedResourceName:(id)a4 localPunchOut:(id)a5 bundle:(id)a6
{
  ...
  -[SiriUIAttributionImage setLocalResourceBundle:](v13, "setLocalResourceBundle:", v9);

  -[SiriUIAttributionImage setLocalResourceName:](v13, "setLocalResourceName:", v12);
  -[SiriUIAttributionImage setLocalPressedResourceName:](v13, "setLocalPressedResourceName:", v11);

  -[SiriUIAttributionImage setLocalPunchOut:](v13, "setLocalPunchOut:", v10);
  return v13;
}
...
+ (id)attributionImageFromKey:(id)a3 pressedKey:(id)a4 punchOut:(id)a5
{
  ...
  -[SiriUIAttributionImage setRemoteURL:](v24, "setRemoteURL:", v14);
  -[SiriUIAttributionImage setRemoteScale:](v24, "setRemoteScale:", v16);
  -[SiriUIAttributionImage setRemotePressedURL:](v24, "setRemotePressedURL:", v17);
  -[SiriUIAttributionImage setRemotePressedScale:](v24, "setRemotePressedScale:", v19);
  -[SiriUIAttributionImage setLogoSize:](v24, "setLogoSize:", v21, v23);
  -[SiriUIAttributionImage setRemotePunchOut:](v24, "setRemotePunchOut:", v9);
...
- (void)getLogoWithCompletion:(id)a3
{
  ...
  if (v4)
  {
    -[SiriUIAttributionImage localResourceName](self, "localResourceName");
    ...
    if (v5)
    {
      ...
      v7[4] = self;
      v8 = v4;
      -[SiriUIAttributionImage _fetchLocalResourcesWithCompletion:](self, "_fetchLocalResourcesWithCompletion:", v7);

    }
    else
    {
      -[SiriUIAttributionImage remoteURL](self, "remoteURL");
      v6 = (void *)objc_claimAutoreleasedReturnValue();

      if (v6)
        -[SiriUIAttributionImage _fetchRemoteResourcesWithCompletion:](self, "_fetchRemoteResourcesWithCompletion:", v4);
      else
...
- (CGSize)logoSize
{
  ...
  {
    -[SiriUIAttributionImage _imageInLocalResourceBundleNamed:](self, "_imageInLocalResourceBundleNamed:", v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = v6;
    if (v6)
    {
...
- (void)_fetchLocalResourcesWithCompletion:(id)a3
{
  ...
  -[SiriUIAttributionImage localResourceName](self, "localResourceName");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SiriUIAttributionImage localPressedResourceName](self, "localPressedResourceName");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SiriUIAttributionImage localPunchOut](self, "localPunchOut");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v4)
  {
    v7 = 0;
...
LABEL_5:
  ...
  -[SiriUIAttributionImage _imageInLocalResourceBundleNamed:](self, "_imageInLocalResourceBundleNamed:", v4);
...
- (id)_imageInLocalResourceBundleNamed:(id)a3
{
  ...
  v5 = a3;
  -[SiriUIAttributionImage localResourceBundle](self, "localResourceBundle");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_fetchRemoteResourcesWithCompletion:(id)a3
{
  ...
  -[SiriUIAttributionImage remotePressedURL](self, "remotePressedURL");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  -[SiriUIAttributionImage remotePunchOut](self, "remotePunchOut");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v32[0] = 0;
  v32[1] = v32;
  v32[2] = 0x3032000000;
  ...
  v27[1] = 3221225472;
  v27[2] = __62__SiriUIAttributionImage__fetchRemoteResourcesWithCompletion___block_invoke;
  v27[3] = &unk_24D7D9790;
  v29 = v32;
  v10 = v6;
  v28 = v10;
  ...
  v24[0] = v9;
  v24[1] = 3221225472;
  v24[2] = __62__SiriUIAttributionImage__fetchRemoteResourcesWithCompletion___block_invoke_2;
  v24[3] = &unk_24D7D9790;
  v26 = v30;
  v13 = v10;
  v25 = v13;
...
uint64_t __62__SiriUIAttributionImage__fetchRemoteResourcesWithCompletion___block_invoke_3(_QWORD *a1)
{
