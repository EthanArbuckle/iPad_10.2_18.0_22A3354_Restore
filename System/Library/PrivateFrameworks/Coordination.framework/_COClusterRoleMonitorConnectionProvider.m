...
{
  _COClusterRoleMonitorConnectionProvider *v2;
  NSXPCConnection *v3;
  uint64_t v4;
  NSXPCConnection *clusterRoleMonitorServiceConnection;
  void *v6;
  ...
  if (!v3)
  {
    v4 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1988]), "initWithMachServiceName:options:", CFSTR("com.apple.coordination.role"), 4096);
    ...
    -[NSXPCConnection setInvalidationHandler:](v2->_clusterRoleMonitorServiceConnection, "setInvalidationHandler:", v6);
    v3 = v2->_clusterRoleMonitorServiceConnection;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_clusterRoleMonitorServiceConnection, 0);
}
