...
- (COMessageSessionConsumer)initWithChannel:(id)a3 subTopic:(id)a4 delegate:(id)a5 dispatchQueue:(id)a6
{
  ...
  id v12;
  id v13;
  COMessageSessionConsumer *v14;
  COMessageSessionConsumer *v15;
  uint64_t v16;
  ...
  v14 = -[COMessageSessionConsumer init](&v19, sel_init);
  v15 = v14;
  if (v14)
  {
...
{
  return (COMessageSessionConsumerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
