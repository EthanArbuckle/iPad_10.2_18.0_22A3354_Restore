...
- (BMMLSELabeledDataStoreFeature)initWithFeatureName:(int)a3 featureValue:(id)a4 featureItselfVersion:(id)a5 featureFreshnessInHours:(id)a6 eventVolumeToComputeFeature:(id)a7 timeSpentToComputeFeature:(id)a8
{
  ...
  id v18;
  id v19;
  BMMLSELabeledDataStoreFeature *v20;
  unsigned int v21;
  unsigned int v22;
  unsigned int v23;
  unsigned int v24;
...
- (NSString)description
{
  ...
  BMMLSEVirtualFeatureStoreFeaturefeatureNameAsString(-[BMMLSELabeledDataStoreFeature featureName](self, "featureName"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMMLSELabeledDataStoreFeature featureValue](self, "featureValue");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMMLSELabeledDataStoreFeature featureItselfVersion](self, "featureItselfVersion"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMMLSELabeledDataStoreFeature featureFreshnessInHours](self, "featureFreshnessInHours"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMMLSELabeledDataStoreFeature eventVolumeToComputeFeature](self, "eventVolumeToComputeFeature"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMMLSELabeledDataStoreFeature timeSpentToComputeFeature](self, "timeSpentToComputeFeature"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMMLSELabeledDataStoreFeature with featureName: %@, featureValue: %@, featureItselfVersion: %@, featureFreshnessInHours: %@, eventVolumeToComputeFeature: %@, timeSpentToComputeFeature: %@"), v4, v5, v6, v7, v8, v9);
...
{
  _BYTE *v4;
  BMMLSELabeledDataStoreFeature *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  unint64_t v25;
  char v26;
  BMMLSELabeledDataStoreFeatureFeatureValue *v27;
  ...
  char v53;
  uint64_t v54;
  BMMLSELabeledDataStoreFeature *v55;
  objc_super v57;
  uint64_t v58;
  uint64_t v59;
...
LABEL_63:
        ...
        case 2u:
          ...
          if ((PBReaderPlaceMark() & 1) == 0)
            goto LABEL_85;
          v27 = -[BMMLSELabeledDataStoreFeatureFeatureValue initByReadFrom:]([BMMLSELabeledDataStoreFeatureFeatureValue alloc], "initByReadFrom:", v4);
          if (!v27)
            goto LABEL_85;
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_featureValue)
  {
    ...
    -[BMMLSELabeledDataStoreFeatureFeatureValue writeTo:](self->_featureValue, "writeTo:", v4);
...
- (id)serialize
{
  ...
  -[BMMLSELabeledDataStoreFeature writeTo:](self, "writeTo:", v3);
...
- (BMMLSELabeledDataStoreFeature)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  BMMLSELabeledDataStoreFeatureFeatureValue *v10;
  void *v11;
  void *v12;
  id *v13;
  void *v14;
  ...
  void *v58;
  void *v59;
  BMMLSELabeledDataStoreFeatureFeatureValue *v60;
  id v61;
  id v62;
  id *v63;
  id v64;
  BMMLSELabeledDataStoreFeature *v65;
  id v66;
  uint64_t v67;
  void *v68;
  uint64_t v69;
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        *v23 = (id)objc_msgSend(v45, "initWithDomain:code:userInfo:", v46, 2, v47);
        v10 = (BMMLSELabeledDataStoreFeatureFeatureValue *)v47;
        goto LABEL_56;
      }
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      v10 = (BMMLSELabeledDataStoreFeatureFeatureValue *)v76;
    ...
    v20 = v9;
    v66 = 0;
    v10 = -[BMMLSELabeledDataStoreFeatureFeatureValue initWithJSONDictionary:error:]([BMMLSELabeledDataStoreFeatureFeatureValue alloc], "initWithJSONDictionary:error:", v20, &v66);
    v21 = v66;
    if (v21)
    {
      v22 = v21;
...
- (id)jsonDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMMLSELabeledDataStoreFeature featureName](self, "featureName"));
  ...
  if (-[BMMLSELabeledDataStoreFeature hasFeatureFreshnessInHours](self, "hasFeatureFreshnessInHours"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMMLSELabeledDataStoreFeature featureFreshnessInHours](self, "featureFreshnessInHours"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if (-[BMMLSELabeledDataStoreFeature hasEventVolumeToComputeFeature](self, "hasEventVolumeToComputeFeature"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMMLSELabeledDataStoreFeature eventVolumeToComputeFeature](self, "eventVolumeToComputeFeature"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if (-[BMMLSELabeledDataStoreFeature hasTimeSpentToComputeFeature](self, "hasTimeSpentToComputeFeature"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMMLSELabeledDataStoreFeature timeSpentToComputeFeature](self, "timeSpentToComputeFeature"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = -[BMMLSELabeledDataStoreFeature featureName](self, "featureName");
    if (v6 == objc_msgSend(v5, "featureName"))
    {
      ...
      if (!-[BMMLSELabeledDataStoreFeature hasFeatureItselfVersion](self, "hasFeatureItselfVersion")
        ...
        || -[BMMLSELabeledDataStoreFeature hasFeatureItselfVersion](self, "hasFeatureItselfVersion")
        && objc_msgSend(v5, "hasFeatureItselfVersion")
        && (v14 = -[BMMLSELabeledDataStoreFeature featureItselfVersion](self, "featureItselfVersion"),
            v14 == objc_msgSend(v5, "featureItselfVersion")))
      {
        if (!-[BMMLSELabeledDataStoreFeature hasFeatureFreshnessInHours](self, "hasFeatureFreshnessInHours")
          && !objc_msgSend(v5, "hasFeatureFreshnessInHours")
          || -[BMMLSELabeledDataStoreFeature hasFeatureFreshnessInHours](self, "hasFeatureFreshnessInHours")
          && objc_msgSend(v5, "hasFeatureFreshnessInHours")
          && (v15 = -[BMMLSELabeledDataStoreFeature featureFreshnessInHours](self, "featureFreshnessInHours"),
              v15 == objc_msgSend(v5, "featureFreshnessInHours")))
        {
          if (!-[BMMLSELabeledDataStoreFeature hasEventVolumeToComputeFeature](self, "hasEventVolumeToComputeFeature")
            && !objc_msgSend(v5, "hasEventVolumeToComputeFeature")
            || -[BMMLSELabeledDataStoreFeature hasEventVolumeToComputeFeature](self, "hasEventVolumeToComputeFeature")
            && objc_msgSend(v5, "hasEventVolumeToComputeFeature")
            && (v16 = -[BMMLSELabeledDataStoreFeature eventVolumeToComputeFeature](self, "eventVolumeToComputeFeature"),
                v16 == objc_msgSend(v5, "eventVolumeToComputeFeature")))
          {
            if (!-[BMMLSELabeledDataStoreFeature hasTimeSpentToComputeFeature](self, "hasTimeSpentToComputeFeature")
            ...
            if (-[BMMLSELabeledDataStoreFeature hasTimeSpentToComputeFeature](self, "hasTimeSpentToComputeFeature")
              && objc_msgSend(v5, "hasTimeSpentToComputeFeature"))
            {
              v17 = -[BMMLSELabeledDataStoreFeature timeSpentToComputeFeature](self, "timeSpentToComputeFeature");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMMLSELabeledDataStoreFeature initByReadFrom:]([BMMLSELabeledDataStoreFeature alloc], "initByReadFrom:", v7);
    v4[5] = 0;
...
+ (id)columns
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("featureValue_json"), 5, 1, &__block_literal_global_212);
