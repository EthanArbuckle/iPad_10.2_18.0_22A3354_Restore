...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMScreenRecording starting](self, "starting"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMScreenRecording with starting: %@"), v4);
...
- (id)serialize
{
  ...
  -[BMScreenRecording writeTo:](self, "writeTo:", v3);
...
- (BMScreenRecording)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = -[BMScreenRecording initWithStarting:](self, "initWithStarting:", a4);
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)jsonDictionary
{
  ...
  if (-[BMScreenRecording hasStarting](self, "hasStarting"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMScreenRecording starting](self, "starting"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    if (-[BMScreenRecording hasStarting](self, "hasStarting") || objc_msgSend(v5, "hasStarting"))
    {
      if (-[BMScreenRecording hasStarting](self, "hasStarting") && objc_msgSend(v5, "hasStarting"))
      {
        v6 = -[BMScreenRecording starting](self, "starting");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 1)
  {
    ...
    v7 = -[BMScreenRecording initByReadFrom:]([BMScreenRecording alloc], "initByReadFrom:", v6);
    v7[5] = 1;
