...
{
  id v6;
  BMUserFocusDoNotDisturbWhileDriving *v7;
  objc_super v9;
...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMUserFocusDoNotDisturbWhileDriving starting](self, "starting"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  BMUserFocusDoNotDisturbWhileDrivingReasonAsString(-[BMUserFocusDoNotDisturbWhileDriving reason](self, "reason"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMUserFocusDoNotDisturbWhileDriving with starting: %@, reason: %@"), v4, v5);
...
{
  _BYTE *v4;
  BMUserFocusDoNotDisturbWhileDriving *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  unint64_t v29;
  char v30;
  BMUserFocusDoNotDisturbWhileDriving *v31;
  objc_super v33;
...
- (id)serialize
{
  ...
  -[BMUserFocusDoNotDisturbWhileDriving writeTo:](self, "writeTo:", v3);
...
- (BMUserFocusDoNotDisturbWhileDriving)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  uint64_t v13;
  id v14;
  BMUserFocusDoNotDisturbWhileDriving *v15;
  id v17;
  uint64_t v18;
  void *v19;
  void *v20;
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMUserFocusDoNotDisturbWhileDrivingReasonFromString(v9));
  ...
  self = -[BMUserFocusDoNotDisturbWhileDriving initWithStarting:reason:](self, "initWithStarting:reason:", v8, objc_msgSend(v10, "intValue"));
  v15 = self;
LABEL_17:
...
- (id)jsonDictionary
{
  ...
  if (-[BMUserFocusDoNotDisturbWhileDriving hasStarting](self, "hasStarting"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMUserFocusDoNotDisturbWhileDriving starting](self, "starting"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMUserFocusDoNotDisturbWhileDriving reason](self, "reason"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = CFSTR("starting");
  v5 = v3;
  if (!v3)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (!-[BMUserFocusDoNotDisturbWhileDriving hasStarting](self, "hasStarting")
      ...
      || -[BMUserFocusDoNotDisturbWhileDriving hasStarting](self, "hasStarting")
      && objc_msgSend(v5, "hasStarting")
      && (v6 = -[BMUserFocusDoNotDisturbWhileDriving starting](self, "starting"),
          v6 == objc_msgSend(v5, "starting")))
    {
      v8 = -[BMUserFocusDoNotDisturbWhileDriving reason](self, "reason");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 1)
  {
    ...
    v7 = -[BMUserFocusDoNotDisturbWhileDriving initByReadFrom:]([BMUserFocusDoNotDisturbWhileDriving alloc], "initByReadFrom:", v6);
    v7[5] = 1;
