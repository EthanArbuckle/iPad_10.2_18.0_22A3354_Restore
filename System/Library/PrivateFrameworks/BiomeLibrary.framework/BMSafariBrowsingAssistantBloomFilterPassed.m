...
{
  id v5;
  BMSafariBrowsingAssistantBloomFilterPassed *v6;
  objc_super v8;
...
- (NSString)description
{
  ...
  -[BMSafariBrowsingAssistantBloomFilterPassed webpageViewIdentifier](self, "webpageViewIdentifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSafariBrowsingAssistantBloomFilterPassed with webpageViewIdentifier: %@"), v4);
...
{
  _BYTE *v4;
  BMSafariBrowsingAssistantBloomFilterPassed *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  BMSafariBrowsingAssistantBloomFilterPassed *v21;
  objc_super v23;
...
- (id)serialize
{
  ...
  -[BMSafariBrowsingAssistantBloomFilterPassed writeTo:](self, "writeTo:", v3);
...
{
  void *v6;
  BMSafariBrowsingAssistantBloomFilterPassed *v7;
  id v9;
  uint64_t v10;
  void *v11;
  void *v12;
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = -[BMSafariBrowsingAssistantBloomFilterPassed initWithWebpageViewIdentifier:](self, "initWithWebpageViewIdentifier:", a4);
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSafariBrowsingAssistantBloomFilterPassed initByReadFrom:]([BMSafariBrowsingAssistantBloomFilterPassed alloc], "initByReadFrom:", v7);
    v4[4] = 0;
