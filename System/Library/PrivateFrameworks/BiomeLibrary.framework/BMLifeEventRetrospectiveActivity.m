...
{
  id v5;
  BMLifeEventRetrospectiveActivity *v6;
  objc_super v8;
...
- (NSString)description
{
  ...
  -[BMLifeEventRetrospectiveActivity activity](self, "activity");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMLifeEventRetrospectiveActivity with activity: %@"), v4);
...
{
  _BYTE *v4;
  BMLifeEventRetrospectiveActivity *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  BMLifeEventRetrospectiveActivity *v21;
  objc_super v23;
  uint64_t v24;
  uint64_t v25;
...
- (id)serialize
{
  ...
  -[BMLifeEventRetrospectiveActivity writeTo:](self, "writeTo:", v3);
...
- (BMLifeEventRetrospectiveActivity)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v7 = 0;
LABEL_4:
    self = -[BMLifeEventRetrospectiveActivity initWithActivity:](self, "initWithActivity:", v7);
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 1)
  {
    ...
    v7 = -[BMLifeEventRetrospectiveActivity initByReadFrom:]([BMLifeEventRetrospectiveActivity alloc], "initByReadFrom:", v6);
    v7[4] = 1;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("activity_json"), 5, 1, &__block_literal_global_1445);
  v5[0] = v2;
