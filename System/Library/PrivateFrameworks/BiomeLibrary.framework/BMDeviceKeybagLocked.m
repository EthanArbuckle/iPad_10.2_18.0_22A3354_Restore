...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMDeviceKeybagLocked starting](self, "starting"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMDeviceKeybagLocked with starting: %@"), v4);
...
- (id)serialize
{
  ...
  -[BMDeviceKeybagLocked writeTo:](self, "writeTo:", v3);
...
- (BMDeviceKeybagLocked)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = -[BMDeviceKeybagLocked initWithStarting:](self, "initWithStarting:", a4);
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)jsonDictionary
{
  ...
  if (-[BMDeviceKeybagLocked hasStarting](self, "hasStarting"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMDeviceKeybagLocked starting](self, "starting"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    if (-[BMDeviceKeybagLocked hasStarting](self, "hasStarting") || objc_msgSend(v5, "hasStarting"))
    {
      if (-[BMDeviceKeybagLocked hasStarting](self, "hasStarting") && objc_msgSend(v5, "hasStarting"))
      {
        v6 = -[BMDeviceKeybagLocked starting](self, "starting");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMDeviceKeybagLocked initByReadFrom:]([BMDeviceKeybagLocked alloc], "initByReadFrom:", v7);
    v4[5] = 0;
