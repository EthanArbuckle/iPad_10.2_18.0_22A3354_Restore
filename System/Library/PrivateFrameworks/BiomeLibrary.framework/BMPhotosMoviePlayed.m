...
- (NSString)description
{
  ...
  -[BMPhotosMoviePlayed identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPhotosMoviePlayed subset](self, "subset");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMPhotosMoviePlayed with identifier: %@, subset: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMPhotosMoviePlayed writeTo:](self, "writeTo:", v3);
...
- (BMPhotosMoviePlayed)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  self = -[BMPhotosMoviePlayed initWithIdentifier:subset:](self, "initWithIdentifier:subset:", v8, v10);
  v11 = self;
LABEL_8:
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMPhotosMoviePlayed initByReadFrom:]([BMPhotosMoviePlayed alloc], "initByReadFrom:", v7);
    v4[4] = 0;
