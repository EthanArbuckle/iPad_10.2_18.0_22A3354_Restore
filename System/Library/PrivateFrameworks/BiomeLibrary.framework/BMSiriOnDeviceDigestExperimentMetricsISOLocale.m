...
- (BMSiriOnDeviceDigestExperimentMetricsISOLocale)initWithLanguageCode:(id)a3 countryCode:(id)a4
{
  id v6;
  id v7;
  BMSiriOnDeviceDigestExperimentMetricsISOLocale *v8;
  int v9;
  int v10;
  objc_super v12;
...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMSiriOnDeviceDigestExperimentMetricsISOLocale languageCode](self, "languageCode"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMSiriOnDeviceDigestExperimentMetricsISOLocale countryCode](self, "countryCode"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriOnDeviceDigestExperimentMetricsISOLocale with languageCode: %@, countryCode: %@"), v4, v5);
...
{
  _BYTE *v4;
  BMSiriOnDeviceDigestExperimentMetricsISOLocale *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  unint64_t v33;
  char v34;
  BMSiriOnDeviceDigestExperimentMetricsISOLocale *v35;
  objc_super v37;
...
- (id)serialize
{
  ...
  -[BMSiriOnDeviceDigestExperimentMetricsISOLocale writeTo:](self, "writeTo:", v3);
...
- (BMSiriOnDeviceDigestExperimentMetricsISOLocale)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  id v10;
  BMSiriOnDeviceDigestExperimentMetricsISOLocale *v11;
  id v13;
  uint64_t v14;
  id v15;
  id v16;
  ...
  self = -[BMSiriOnDeviceDigestExperimentMetricsISOLocale initWithLanguageCode:countryCode:](self, "initWithLanguageCode:countryCode:", v8, v10);
  v11 = self;
LABEL_8:
...
- (id)jsonDictionary
{
  ...
  if (-[BMSiriOnDeviceDigestExperimentMetricsISOLocale hasLanguageCode](self, "hasLanguageCode"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMSiriOnDeviceDigestExperimentMetricsISOLocale languageCode](self, "languageCode"));
  ...
  if (-[BMSiriOnDeviceDigestExperimentMetricsISOLocale hasCountryCode](self, "hasCountryCode"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMSiriOnDeviceDigestExperimentMetricsISOLocale countryCode](self, "countryCode"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
      ...
      || objc_msgSend(v5, "hasLanguageCode"))
    {
      ...
      if (!objc_msgSend(v5, "hasLanguageCode"))
        goto LABEL_13;
      v6 = -[BMSiriOnDeviceDigestExperimentMetricsISOLocale languageCode](self, "languageCode");
    ...
    if (-[BMSiriOnDeviceDigestExperimentMetricsISOLocale hasCountryCode](self, "hasCountryCode")
      && objc_msgSend(v5, "hasCountryCode"))
    {
      v7 = -[BMSiriOnDeviceDigestExperimentMetricsISOLocale countryCode](self, "countryCode");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriOnDeviceDigestExperimentMetricsISOLocale initByReadFrom:]([BMSiriOnDeviceDigestExperimentMetricsISOLocale alloc], "initByReadFrom:", v7);
    v4[5] = 0;
