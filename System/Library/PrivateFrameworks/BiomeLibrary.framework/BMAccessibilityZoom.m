...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMAccessibilityZoom starting](self, "starting"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMAccessibilityZoom with starting: %@"), v4);
...
- (id)serialize
{
  ...
  -[BMAccessibilityZoom writeTo:](self, "writeTo:", v3);
...
- (BMAccessibilityZoom)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = -[BMAccessibilityZoom initWithStarting:](self, "initWithStarting:", a4);
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)jsonDictionary
{
  ...
  if (-[BMAccessibilityZoom hasStarting](self, "hasStarting"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMAccessibilityZoom starting](self, "starting"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    if (-[BMAccessibilityZoom hasStarting](self, "hasStarting") || objc_msgSend(v5, "hasStarting"))
    {
      if (-[BMAccessibilityZoom hasStarting](self, "hasStarting") && objc_msgSend(v5, "hasStarting"))
      {
        v6 = -[BMAccessibilityZoom starting](self, "starting");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMAccessibilityZoom initByReadFrom:]([BMAccessibilityZoom alloc], "initByReadFrom:", v7);
    v4[5] = 0;
