...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMCarPlayConnected starting](self, "starting"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  BMCarPlayConnectedReasonAsString(-[BMCarPlayConnected reason](self, "reason"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMCarPlayConnected with starting: %@, reason: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMCarPlayConnected writeTo:](self, "writeTo:", v3);
...
- (BMCarPlayConnected)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMCarPlayConnectedReasonFromString(v9));
  ...
  self = -[BMCarPlayConnected initWithStarting:reason:](self, "initWithStarting:reason:", v8, objc_msgSend(v10, "intValue"));
  v15 = self;
LABEL_17:
...
- (id)jsonDictionary
{
  ...
  if (-[BMCarPlayConnected hasStarting](self, "hasStarting"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMCarPlayConnected starting](self, "starting"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMCarPlayConnected reason](self, "reason"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = CFSTR("starting");
  v5 = v3;
  if (!v3)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    if (!-[BMCarPlayConnected hasStarting](self, "hasStarting") && !objc_msgSend(v5, "hasStarting")
      || -[BMCarPlayConnected hasStarting](self, "hasStarting")
      && objc_msgSend(v5, "hasStarting")
      && (v6 = -[BMCarPlayConnected starting](self, "starting"), v6 == objc_msgSend(v5, "starting")))
    {
      v8 = -[BMCarPlayConnected reason](self, "reason");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 1)
  {
    ...
    v7 = -[BMCarPlayConnected initByReadFrom:]([BMCarPlayConnected alloc], "initByReadFrom:", v6);
    v7[5] = 1;
