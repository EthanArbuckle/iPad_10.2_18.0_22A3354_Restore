...
- (BMProactiveHarvestingNamedHandle)initWithName:(id)a3 handle:(id)a4 contactIdentifier:(id)a5 handleType:(id)a6
{
  ...
  id v13;
  id v14;
  BMProactiveHarvestingNamedHandle *v15;
  objc_super v17;
...
- (NSString)description
{
  ...
  -[BMProactiveHarvestingNamedHandle name](self, "name");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMProactiveHarvestingNamedHandle handle](self, "handle");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMProactiveHarvestingNamedHandle contactIdentifier](self, "contactIdentifier");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMProactiveHarvestingNamedHandle handleType](self, "handleType");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMProactiveHarvestingNamedHandle with name: %@, handle: %@, contactIdentifier: %@, handleType: %@"), v4, v5, v6, v7);
...
{
  _BYTE *v4;
  BMProactiveHarvestingNamedHandle *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  uint64_t v20;
  void *v21;
  BMProactiveHarvestingNamedHandle *v22;
  objc_super v24;
...
- (id)serialize
{
  ...
  -[BMProactiveHarvestingNamedHandle writeTo:](self, "writeTo:", v3);
...
- (BMProactiveHarvestingNamedHandle)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  void *v10;
  BMProactiveHarvestingNamedHandle *v11;
  id v12;
  void *v13;
  id v14;
  BMProactiveHarvestingNamedHandle *v15;
...
LABEL_4:
    ...
    if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        v14 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("contactIdentifier"));
        v35 = v14;
    ...
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("handleType"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if (v13 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v25 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("handleType"));
          v33 = v25;
    ...
    a4 = v30;
    v15 = -[BMProactiveHarvestingNamedHandle initWithName:handle:contactIdentifier:handleType:](v11, "initWithName:handle:contactIdentifier:handleType:", v8, v30, v12, v14);
    v11 = v15;
LABEL_14:
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 1)
  {
    ...
    v7 = -[BMProactiveHarvestingNamedHandle initByReadFrom:]([BMProactiveHarvestingNamedHandle alloc], "initByReadFrom:", v6);
    v7[4] = 1;
...
+ (id)columns
{
  ...
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02720]), "initWithName:dataType:requestOnly:fieldNumber:protoDataType:convertedType:", CFSTR("contactIdentifier"), 2, 0, 3, 13, 0);
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02720]), "initWithName:dataType:requestOnly:fieldNumber:protoDataType:convertedType:", CFSTR("handleType"), 2, 0, 4, 13, 0);
  v8[0] = v2;
  v8[1] = v3;
  v8[2] = v4;
  v8[3] = v5;
...
+ (id)protoFields
{
  ...
  v8[0] = v2;
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("handle"), 2, 13, 0);
  v8[1] = v3;
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("contactIdentifier"), 3, 13, 0);
  v8[2] = v4;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("handleType"), 4, 13, 0);
  v8[3] = v5;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v8, 4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
