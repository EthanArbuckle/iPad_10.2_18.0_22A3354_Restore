...
- (BMContextSyncDeviceActivityLevel)initWithID:(id)a3 deviceUUID:(id)a4 deviceActivityState:(id)a5
{
  ...
  id v10;
  id v11;
  BMContextSyncDeviceActivityLevel *v12;
  objc_super v14;
...
- (NSString)description
{
  ...
  -[BMContextSyncDeviceActivityLevel ID](self, "ID");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMContextSyncDeviceActivityLevel deviceUUID](self, "deviceUUID");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMContextSyncDeviceActivityLevel deviceActivityState](self, "deviceActivityState");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMContextSyncDeviceActivityLevel with ID: %@, deviceUUID: %@, deviceActivityState: %@"), v4, v5, v6);
...
{
  _BYTE *v4;
  BMContextSyncDeviceActivityLevel *v5;
  void *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  int v28;
  BMContextSyncDeviceActivityLevel *v29;
  objc_super v31;
  uint64_t v32;
  uint64_t v33;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 3)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0
          || (v23 = -[BMContextSyncDeviceActivityLevelDeviceActivityState initByReadFrom:]([BMContextSyncDeviceActivityLevelDeviceActivityState alloc], "initByReadFrom:", v4)) == 0)
        {
LABEL_34:
...
- (id)serialize
{
  ...
  -[BMContextSyncDeviceActivityLevel writeTo:](self, "writeTo:", v3);
...
- (BMContextSyncDeviceActivityLevel)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  unint64_t v20;
  id v21;
  BMContextSyncDeviceActivityLevelDeviceActivityState *v22;
  BMContextSyncDeviceActivityLevelDeviceActivityState *v23;
  id v24;
  void *v25;
  BMContextSyncDeviceActivityLevel *v26;
  id v27;
  uint64_t v28;
  id *v29;
  id v30;
  id v31;
  uint64_t v32;
  BMContextSyncDeviceActivityLevel *v33;
  id v34;
  void *v35;
  id v36;
  id *v37;
  ...
  void *v47;
  uint64_t v48;
  BMContextSyncDeviceActivityLevel *v49;
  id *v50;
  id v51;
  id v52;
  id *v53;
  ...
  if (!v9 || (v10 = (void *)v9, objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v52 = 0;
LABEL_7:
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("deviceActivityState"));
...
LABEL_14:
      ...
      while (1)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          v21 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSDictionary"), objc_opt_class(), CFSTR("deviceActivityState"));
          v62 = v21;
        ...
        v56 = 0;
        v23 = -[BMContextSyncDeviceActivityLevelDeviceActivityState initWithJSONDictionary:error:](v22, "initWithJSONDictionary:error:", v21, &v56);
        v24 = v56;
        if (v24)
        {
          v43 = v24;
...
LABEL_22:
          ...
          a4 = v50;
          v25 = v52;
          self = -[BMContextSyncDeviceActivityLevel initWithID:deviceUUID:deviceActivityState:](self, "initWithID:deviceUUID:deviceActivityState:", v50, v52, v14);
          v26 = self;
          v6 = v51;
LABEL_42:
      ...
      v21 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type null for element of %@, must not be null"), CFSTR("deviceActivityState"));
      v64 = v21;
      v40 = (void *)MEMORY[0x1E0C99D80];
      v41 = &v64;
      v42 = &v63;
LABEL_35:
    ...
    if (v53)
    {
      ...
      v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Expecting %@ as an array"), CFSTR("deviceActivityState"));
      v67 = v14;
...
LABEL_43:
  ...
  if (v53)
  {
    ...
    v35 = v34;
    self = v33;
    v11 = (id)objc_msgSend(v35, "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), v48, CFSTR("deviceUUID"));
    v69 = v11;
...
- (id)_deviceActivityStateJSONArray
{
  ...
  v13 = 0u;
  v14 = 0u;
  -[BMContextSyncDeviceActivityLevel deviceActivityState](self, "deviceActivityState", 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)jsonDictionary
{
  ...
  -[BMContextSyncDeviceActivityLevel deviceUUID](self, "deviceUUID");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMContextSyncDeviceActivityLevel _deviceActivityStateJSONArray](self, "_deviceActivityStateJSONArray");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = CFSTR("ID");
  v6 = v3;
  if (!v3)
  ...
  v12[1] = v7;
  v11[2] = CFSTR("deviceActivityState");
  v8 = v5;
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0C99E38], "null");
...
LABEL_15:
    ...
    objc_msgSend(v5, "deviceActivityState");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMContextSyncDeviceActivityLevel initByReadFrom:]([BMContextSyncDeviceActivityLevel alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("deviceActivityState_json"), 5, 1, &__block_literal_global_133);
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
...
+ (id)protoFields
{
  ...
  v7[1] = v3;
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("deviceActivityState"), 3, 14, objc_opt_class());
  v7[2] = v4;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v7, 3);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
id __43__BMContextSyncDeviceActivityLevel_columns__block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v2, "_deviceActivityStateJSONArray");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
