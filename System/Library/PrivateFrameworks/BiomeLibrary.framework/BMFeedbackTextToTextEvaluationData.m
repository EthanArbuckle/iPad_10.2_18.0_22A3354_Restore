...
- (BMFeedbackTextToTextEvaluationData)initWithCommonMetadata:(id)a3 originalContent:(id)a4 generatedContent:(id)a5
{
  ...
  id v10;
  id v11;
  BMFeedbackTextToTextEvaluationData *v12;
  objc_super v14;
...
- (NSString)description
{
  ...
  -[BMFeedbackTextToTextEvaluationData commonMetadata](self, "commonMetadata");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMFeedbackTextToTextEvaluationData originalContent](self, "originalContent");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMFeedbackTextToTextEvaluationData generatedContent](self, "generatedContent");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMFeedbackTextToTextEvaluationData with commonMetadata: %@, originalContent: %@, generatedContent: %@"), v4, v5, v6);
...
{
  _BYTE *v4;
  BMFeedbackTextToTextEvaluationData *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  uint64_t v22;
  void *v23;
  BMFeedbackTextToTextEvaluationData *v24;
  objc_super v26;
  uint64_t v27;
  uint64_t v28;
...
LABEL_15:
      ...
      if ((v12 >> 3) == 3)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0)
          goto LABEL_35;
        v21 = -[BMTextContent initByReadFrom:]([BMTextContent alloc], "initByReadFrom:", v4);
        if (!v21)
          goto LABEL_35;
        v22 = 40;
      }
      ...
      else
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0)
          goto LABEL_35;
        v21 = -[BMEvaluationCommonMetadata initByReadFrom:]([BMEvaluationCommonMetadata alloc], "initByReadFrom:", v4);
        if (!v21)
          goto LABEL_35;
        v22 = 24;
      }
...
- (void)writeTo:(id)a3
{
  ...
  {
    PBDataWriterPlaceMark();
    -[BMTextContent writeTo:](self->_generatedContent, "writeTo:", v4);
    PBDataWriterRecallMark();
  }
...
- (id)serialize
{
  ...
  -[BMFeedbackTextToTextEvaluationData writeTo:](self, "writeTo:", v3);
...
- (BMFeedbackTextToTextEvaluationData)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v11;
  BMTextContent *v12;
  BMFeedbackTextToTextEvaluationData *v13;
  id v15;
  void *v16;
  id v17;
  void *v18;
...
LABEL_7:
      ...
      if (!v11 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
      {
        v12 = 0;
LABEL_10:
        self = -[BMFeedbackTextToTextEvaluationData initWithCommonMetadata:originalContent:generatedContent:](self, "initWithCommonMetadata:originalContent:generatedContent:", v8, v10, v12);
        v13 = self;
LABEL_11:
...
LABEL_12:
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        v19 = v11;
        v31 = 0;
        v12 = -[BMTextContent initWithJSONDictionary:error:]([BMTextContent alloc], "initWithJSONDictionary:error:", v19, &v31);
        v20 = v31;
        if (v20)
        {
          v21 = v20;
      ...
      if (a4)
      {
        ...
        v12 = (BMTextContent *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSDictionary"), objc_opt_class(), CFSTR("generatedContent"));
        v35 = v12;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMFeedbackTextToTextEvaluationData initByReadFrom:]([BMFeedbackTextToTextEvaluationData alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("commonMetadata_json"), 5, 1, &__block_literal_global_367);
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("originalContent_json"), 5, 1, &__block_literal_global_368);
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("generatedContent_json"), 5, 1, &__block_literal_global_369);
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
