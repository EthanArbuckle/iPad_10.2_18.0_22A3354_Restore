...
- (NSString)description
{
  ...
  -[BMTextContent text](self, "text");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMTextContent metadata](self, "metadata");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMTextContent with text: %@, metadata: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMTextContent writeTo:](self, "writeTo:", v3);
...
- (BMTextContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("text"));
      v26[0] = v9;
  ...
  if (!v9 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v10 = 0;
LABEL_7:
    self = -[BMTextContent initWithText:metadata:](self, "initWithText:metadata:", v8, v10);
    v11 = self;
    goto LABEL_8;
  }
  objc_opt_class();
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMTextContent initByReadFrom:]([BMTextContent alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("metadata_json"), 5, 1, &__block_literal_global_200);
  v6[0] = v2;
  v6[1] = v3;
