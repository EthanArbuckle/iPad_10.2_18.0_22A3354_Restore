...
{
  id v4;
  BMAccessibilityReduceMotion *v5;
  objc_super v7;
...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMAccessibilityReduceMotion starting](self, "starting"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMAccessibilityReduceMotion with starting: %@"), v4);
...
- (id)initByReadFrom:(id)a3
{
  ...
  unint64_t v23;
  char v24;
  BMAccessibilityReduceMotion *v25;
  objc_super v27;
...
- (id)serialize
{
  ...
  -[BMAccessibilityReduceMotion writeTo:](self, "writeTo:", v3);
...
{
  void *v6;
  BMAccessibilityReduceMotion *v7;
  id v9;
  uint64_t v10;
  void *v11;
  void *v12;
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = -[BMAccessibilityReduceMotion initWithStarting:](self, "initWithStarting:", a4);
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)jsonDictionary
{
  ...
  if (-[BMAccessibilityReduceMotion hasStarting](self, "hasStarting"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMAccessibilityReduceMotion starting](self, "starting"));
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
      ...
      || objc_msgSend(v5, "hasStarting"))
    {
      if (-[BMAccessibilityReduceMotion hasStarting](self, "hasStarting")
        && objc_msgSend(v5, "hasStarting"))
      {
        v6 = -[BMAccessibilityReduceMotion starting](self, "starting");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMAccessibilityReduceMotion initByReadFrom:]([BMAccessibilityReduceMotion alloc], "initByReadFrom:", v7);
    v4[5] = 0;
