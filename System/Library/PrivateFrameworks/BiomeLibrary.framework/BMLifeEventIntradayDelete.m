...
- (NSString)description
{
  ...
  -[BMLifeEventIntradayDelete identifiers](self, "identifiers");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMLifeEventIntradayDelete with identifiers: %@"), v4);
...
- (id)serialize
{
  ...
  -[BMLifeEventIntradayDelete writeTo:](self, "writeTo:", v3);
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (p_isa)
        {
          ...
          v17 = (void *)objc_msgSend(v23, "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("identifiers"), (_QWORD)v28);
          v33 = v17;
...
LABEL_14:
        ...
        self = -[BMLifeEventIntradayDelete initWithIdentifiers:](self, "initWithIdentifiers:", v9);
...
LABEL_22:
    ...
    if (p_isa)
    {
      ...
      v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type null for element of %@, must not be null"), CFSTR("identifiers"));
      v35 = v17;
...
LABEL_20:
  ...
  if (p_isa)
  {
    ...
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Expecting %@ as an array"), CFSTR("identifiers"));
    v38[0] = v9;
...
- (id)_identifiersJSONArray
{
  ...
  v12 = 0u;
  v13 = 0u;
  -[BMLifeEventIntradayDelete identifiers](self, "identifiers", 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)jsonDictionary
{
  ...
  -[BMLifeEventIntradayDelete _identifiersJSONArray](self, "_identifiersJSONArray");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = CFSTR("identifiers");
  v3 = v2;
  if (!v2)
  {
    objc_msgSend(MEMORY[0x1E0C99E38], "null");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMLifeEventIntradayDelete initByReadFrom:]([BMLifeEventIntradayDelete alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("identifiers_json"), 5, 1, &__block_literal_global_65279);
  v5[0] = v2;
...
+ (id)protoFields
{
  ...
  v5[1] = *MEMORY[0x1E0C80C00];
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("identifiers"), 1, 13, 0);
  v5[0] = v2;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v5, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
id __36__BMLifeEventIntradayDelete_columns__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "_identifiersJSONArray");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
