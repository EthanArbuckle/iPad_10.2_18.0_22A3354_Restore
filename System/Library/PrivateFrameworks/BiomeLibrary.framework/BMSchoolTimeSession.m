...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMSchoolTimeSession starting](self, "starting"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  BMSchoolTimeSessionReasonAsString(-[BMSchoolTimeSession reason](self, "reason"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSchoolTimeSession with starting: %@, reason: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMSchoolTimeSession writeTo:](self, "writeTo:", v3);
...
- (BMSchoolTimeSession)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMSchoolTimeSessionReasonFromString(v9));
  ...
  self = -[BMSchoolTimeSession initWithStarting:reason:](self, "initWithStarting:reason:", v8, objc_msgSend(v10, "intValue"));
  v15 = self;
LABEL_17:
...
- (id)jsonDictionary
{
  ...
  if (-[BMSchoolTimeSession hasStarting](self, "hasStarting"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMSchoolTimeSession starting](self, "starting"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMSchoolTimeSession reason](self, "reason"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = CFSTR("starting");
  v5 = v3;
  if (!v3)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    if (!-[BMSchoolTimeSession hasStarting](self, "hasStarting") && !objc_msgSend(v5, "hasStarting")
      || -[BMSchoolTimeSession hasStarting](self, "hasStarting")
      && objc_msgSend(v5, "hasStarting")
      && (v6 = -[BMSchoolTimeSession starting](self, "starting"), v6 == objc_msgSend(v5, "starting")))
    {
      v8 = -[BMSchoolTimeSession reason](self, "reason");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSchoolTimeSession initByReadFrom:]([BMSchoolTimeSession alloc], "initByReadFrom:", v7);
    v4[5] = 0;
