...
- (BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic)initWithIdentifier:(id)a3 score:(id)a4
{
  id v7;
  id v8;
  BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *v9;
  double v10;
  objc_super v12;
...
- (NSString)description
{
  ...
  -[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)MEMORY[0x1E0CB37E8];
  -[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic score](self, "score");
  objc_msgSend(v5, "numberWithDouble:");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic with identifier: %@, score: %@"), v4, v6);
...
{
  _BYTE *v4;
  BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
...
- (id)serialize
{
  ...
  -[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic writeTo:](self, "writeTo:", v3);
...
- (BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  id v10;
  BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *v11;
  id v13;
  uint64_t v14;
  id v15;
  id v16;
  ...
  self = -[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic initWithIdentifier:score:](self, "initWithIdentifier:score:", v8, v10);
  v11 = self;
LABEL_8:
...
- (id)jsonDictionary
{
  ...
  if (!-[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic hasScore](self, "hasScore")
    || (-[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic score](self, "score"), fabs(v4) == INFINITY))
  {
    v6 = 0;
  }
  else
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 2)
  {
    ...
    v7 = -[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic initByReadFrom:]([BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic alloc], "initByReadFrom:", v6);
    v7[5] = 2;
