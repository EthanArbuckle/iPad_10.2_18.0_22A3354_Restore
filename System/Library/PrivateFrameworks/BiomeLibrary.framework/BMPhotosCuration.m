...
- (NSString)description
{
  ...
  -[BMPhotosCuration identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPhotosCuration subset](self, "subset");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  BMPhotosCurationTypeAsString(-[BMPhotosCuration type](self, "type"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMPhotosCuration with identifier: %@, subset: %@, type: %@"), v4, v5, v6);
...
- (id)serialize
{
  ...
  -[BMPhotosCuration writeTo:](self, "writeTo:", v3);
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMPhotosCurationTypeFromString(v11));
    ...
    self = -[BMPhotosCuration initWithIdentifier:subset:type:](self, "initWithIdentifier:subset:type:", v8, v10, objc_msgSend(v12, "intValue"));
    v16 = self;
LABEL_24:
...
- (id)jsonDictionary
{
  ...
  -[BMPhotosCuration subset](self, "subset");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMPhotosCuration type](self, "type"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_12:
    ...
    v19 = -[BMPhotosCuration type](self, "type");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMPhotosCuration initByReadFrom:]([BMPhotosCuration alloc], "initByReadFrom:", v7);
    v4[4] = 0;
