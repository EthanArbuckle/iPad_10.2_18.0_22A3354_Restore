@implementation BMMapItem

- (BMMapItem)initWithIdentifier:(id)a3 name:(id)a4 address:(id)a5 category:(id)a6
{
  id v10;
  id v11;
  id v12;
  ...
  v13 = a6;
  v18.receiver = self;
  v18.super_class = (Class)BMMapItem;
...
- (NSString)description
{
  ...
  -[BMMapItem identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMMapItem name](self, "name");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMMapItem address](self, "address");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMMapItem category](self, "category");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMMapItem with identifier: %@, name: %@, address: %@, category: %@"), v4, v5, v6, v7);
...
- (id)initByReadFrom:(id)a3
{
  ...
  v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)BMMapItem;
...
- (id)serialize
{
  ...
  -[BMMapItem writeTo:](self, "writeTo:", v3);
...
- (BMMapItem)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  id v5;
  void *v6;
  id v7;
...
LABEL_13:
      a4 = v36;
      v14 = -[BMMapItem initWithIdentifier:name:address:category:](v14, "initWithIdentifier:name:address:category:", v10, v36, v11, v13);
      v15 = v14;
LABEL_33:
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMMapItem initByReadFrom:]([BMMapItem alloc], "initByReadFrom:", v7);
    v4[6] = 0;
