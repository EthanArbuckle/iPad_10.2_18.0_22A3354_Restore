...
- (BMAccessibilitySoundDetection)initWithAbsoluteTimestamp:(id)a3 soundDetectionType:(id)a4 name:(id)a5
{
  ...
  id v9;
  id v10;
  BMAccessibilitySoundDetection *v11;
  double v12;
  objc_super v14;
...
- (NSString)description
{
  ...
  -[BMAccessibilitySoundDetection absoluteTimestamp](self, "absoluteTimestamp");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMAccessibilitySoundDetection soundDetectionType](self, "soundDetectionType");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMAccessibilitySoundDetection name](self, "name");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMAccessibilitySoundDetection with absoluteTimestamp: %@, soundDetectionType: %@, name: %@"), v4, v5, v6);
...
{
  _BYTE *v4;
  BMAccessibilitySoundDetection *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  uint64_t v25;
  void *v26;
  BMAccessibilitySoundDetection *v27;
  objc_super v29;
...
- (id)serialize
{
  ...
  -[BMAccessibilitySoundDetection writeTo:](self, "writeTo:", v3);
...
- (BMAccessibilitySoundDetection)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v18;
  id v19;
  BMAccessibilitySoundDetection *v20;
  uint64_t v22;
  id v23;
  void *v24;
  void *v25;
  ...
  if (!v7 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v8 = 0;
LABEL_9:
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("soundDetectionType"));
    ...
    if (v16 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("soundDetectionType"));
        v35 = v19;
    ...
    if (v18 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("name"));
          v33 = v24;
    ...
    self = -[BMAccessibilitySoundDetection initWithAbsoluteTimestamp:soundDetectionType:name:](self, "initWithAbsoluteTimestamp:soundDetectionType:name:", v8, v17, v19);
    v20 = self;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  v15[0] = v9;
  v14[1] = CFSTR("soundDetectionType");
  v10 = v7;
  if (!v7)
  {
    objc_msgSend(MEMORY[0x1E0C99E38], "null");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 1)
  {
    ...
    v7 = -[BMAccessibilitySoundDetection initByReadFrom:]([BMAccessibilitySoundDetection alloc], "initByReadFrom:", v6);
    v7[8] = 1;
...
+ (id)columns
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02720]), "initWithName:dataType:requestOnly:fieldNumber:protoDataType:convertedType:", CFSTR("soundDetectionType"), 2, 0, 2, 13, 0);
...
+ (id)protoFields
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("soundDetectionType"), 2, 13, 0, v2);
  v7[1] = v3;
