...
- (BMSiriUserAggregationId)initWithAggregationId:(id)a3 effectiveFrom:(id)a4 validityDays:(id)a5 createdOn:(id)a6 adoptedOn:(id)a7 switchedCount:(id)a8
{
  ...
  id v18;
  id v19;
  BMSiriUserAggregationId *v20;
  uint64_t v21;
  NSData *raw_aggregationId;
  double v23;
  unsigned int v24;
  double v25;
  double v26;
...
- (NSString)description
{
  ...
  -[BMSiriUserAggregationId aggregationId](self, "aggregationId");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriUserAggregationId effectiveFrom](self, "effectiveFrom");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserAggregationId validityDays](self, "validityDays"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriUserAggregationId createdOn](self, "createdOn");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriUserAggregationId adoptedOn](self, "adoptedOn");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserAggregationId switchedCount](self, "switchedCount"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriUserAggregationId with aggregationId: %@, effectiveFrom: %@, validityDays: %@, createdOn: %@, adoptedOn: %@, switchedCount: %@"), v4, v5, v6, v7, v8, v9);
...
- (id)serialize
{
  ...
  -[BMSiriUserAggregationId writeTo:](self, "writeTo:", v3);
...
- (BMSiriUserAggregationId)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("aggregationId"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (!v11)
    {
      if (a4)
      {
        ...
        v72 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("-initWithUUIDString: for %@ returned nil"), CFSTR("aggregationId"));
        v86[0] = v72;
...
LABEL_40:
    ...
    v22 = -[BMSiriUserAggregationId initWithAggregationId:effectiveFrom:validityDays:createdOn:adoptedOn:switchedCount:](v37, "initWithAggregationId:effectiveFrom:validityDays:createdOn:adoptedOn:switchedCount:", v68, v70, v69, v26, v38, v47);
    v37 = v22;
LABEL_44:
  ...
  v8 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("aggregationId"));
  v84 = v8;
...
- (id)jsonDictionary
{
  ...
  if (-[BMSiriUserAggregationId hasValidityDays](self, "hasValidityDays"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserAggregationId validityDays](self, "validityDays"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if (-[BMSiriUserAggregationId hasSwitchedCount](self, "hasSwitchedCount"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserAggregationId switchedCount](self, "switchedCount"));
...
- (NSUUID)aggregationId
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0D02620], "convertValue:toType:", raw_aggregationId, 3);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (-[BMSiriUserAggregationId hasValidityDays](self, "hasValidityDays")
      || objc_msgSend(v5, "hasValidityDays"))
    {
      if (!-[BMSiriUserAggregationId hasValidityDays](self, "hasValidityDays"))
        goto LABEL_29;
      if (!objc_msgSend(v5, "hasValidityDays"))
        goto LABEL_29;
      v19 = -[BMSiriUserAggregationId validityDays](self, "validityDays");
    ...
    if (-[BMSiriUserAggregationId hasSwitchedCount](self, "hasSwitchedCount")
      && objc_msgSend(v5, "hasSwitchedCount"))
    {
      v32 = -[BMSiriUserAggregationId switchedCount](self, "switchedCount");
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_raw_aggregationId, 0);
}
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriUserAggregationId initByReadFrom:]([BMSiriUserAggregationId alloc], "initByReadFrom:", v7);
    v4[19] = 0;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02720]), "initWithName:dataType:requestOnly:fieldNumber:protoDataType:convertedType:", CFSTR("aggregationId"), 6, 0, 1, 14, 3);
...
+ (id)protoFields
{
  ...
  v10[6] = *MEMORY[0x1E0C80C00];
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("aggregationId"), 1, 14, 0);
  v10[0] = v2;
