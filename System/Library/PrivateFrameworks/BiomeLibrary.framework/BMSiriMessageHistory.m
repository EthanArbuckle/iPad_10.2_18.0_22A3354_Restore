...
- (NSString)identifier
{
  ...
  -[BMSiriMessageHistory interaction](self, "interaction");
...
- (NSString)description
{
  ...
  -[BMSiriMessageHistory interaction](self, "interaction");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriMessageHistory entities](self, "entities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriMessageHistory with interaction: %@, entities: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMSiriMessageHistory writeTo:](self, "writeTo:", v3);
...
LABEL_19:
  ...
  v8 = v41;
  self = -[BMSiriMessageHistory initWithInteraction:entities:](self, "initWithInteraction:entities:", v41, v12);
  v22 = self;
  v7 = v39;
  v6 = v40;
LABEL_36:
...
- (id)_entitiesJSONArray
{
  ...
  v13 = 0u;
  v14 = 0u;
  -[BMSiriMessageHistory entities](self, "entities", 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)jsonDictionary
{
  ...
  -[BMSiriMessageHistory _entitiesJSONArray](self, "_entitiesJSONArray");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriMessageHistory initByReadFrom:]([BMSiriMessageHistory alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("interaction_json"), 5, 1, &__block_literal_global_15177);
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("entities_json"), 5, 1, &__block_literal_global_27_15178);
  v6[0] = v2;
  v6[1] = v3;
