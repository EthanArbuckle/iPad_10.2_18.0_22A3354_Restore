...
- (BMSiriOnDeviceDigestUsageMetricsEventMetadata)initWithOddIdUUID:(id)a3 deviceAggregationId:(id)a4 userAggregationId:(id)a5 eventTimestampInMSSince1970:(id)a6 timeInterval:(id)a7 userAggregationIdRotationTimestampInMs:(id)a8 userAggregationIdExpirationTimestampInMs:(id)a9
{
  ...
  id v18;
  id v19;
  BMSiriOnDeviceDigestUsageMetricsEventMetadata *v20;
  uint64_t v21;
  uint64_t v22;
  uint64_t v23;
  id v25;
...
- (NSString)description
{
  ...
  -[BMSiriOnDeviceDigestUsageMetricsEventMetadata oddIdUUID](self, "oddIdUUID");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriOnDeviceDigestUsageMetricsEventMetadata deviceAggregationId](self, "deviceAggregationId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationId](self, "userAggregationId");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriOnDeviceDigestUsageMetricsEventMetadata timeInterval](self, "timeInterval");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriOnDeviceDigestUsageMetricsEventMetadata with oddIdUUID: %@, deviceAggregationId: %@, userAggregationId: %@, eventTimestampInMSSince1970: %@, timeInterval: %@, userAggregationIdRotationTimestampInMs: %@, userAggregationIdExpirationTimestampInMs: %@"), v4, v5, v6, v7, v8, v9, v10);
...
{
  _BYTE *v4;
  BMSiriOnDeviceDigestUsageMetricsEventMetadata *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  unint64_t v26;
  char v27;
  BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *v28;
  ...
  char v39;
  uint64_t v40;
  BMSiriOnDeviceDigestUsageMetricsEventMetadata *v41;
  objc_super v43;
  uint64_t v44;
  uint64_t v45;
...
LABEL_53:
        ...
        case 5u:
          ...
          if ((PBReaderPlaceMark() & 1) == 0)
            goto LABEL_65;
          v28 = -[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval initByReadFrom:]([BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval alloc], "initByReadFrom:", v4);
          if (!v28)
            goto LABEL_65;
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_timeInterval)
  {
    ...
    -[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval writeTo:](self->_timeInterval, "writeTo:", v4);
...
- (id)serialize
{
  ...
  -[BMSiriOnDeviceDigestUsageMetricsEventMetadata writeTo:](self, "writeTo:", v3);
...
- (BMSiriOnDeviceDigestUsageMetricsEventMetadata)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v17;
  id v18;
  BMSiriOnDeviceDigestUsageMetricsEventMetadata *v19;
  id v20;
  id v22;
  void *v23;
  id v24;
  ...
  id v58;
  id v59;
  BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *v60;
  void *v61;
  id v62;
  id *v63;
  BMSiriOnDeviceDigestUsageMetricsEventMetadata *v64;
  id v65;
  id v66;
  id v67;
  uint64_t v68;
  ...
  id v71;
  uint64_t v72;
  BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *v73;
  uint64_t v74;
  id v75;
  uint64_t v76;
  id v77;
...
LABEL_28:
    ...
    if (v14 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        v60 = (BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSDictionary"), objc_opt_class(), CFSTR("timeInterval"));
        v73 = v60;
...
LABEL_26:
      ...
      v20 = v14;
      v67 = 0;
      v60 = -[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval initWithJSONDictionary:error:]([BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval alloc], "initWithJSONDictionary:error:", v20, &v67);
      v22 = v67;
      if (v22)
      {
        v23 = v22;
...
- (id)jsonDictionary
{
  ...
  -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationId](self, "userAggregationId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970"));
  ...
  if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970")|| objc_msgSend(v5, "hasEventTimestampInMSSince1970"))
    {
      if (!-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970"))goto LABEL_34;
      if (!objc_msgSend(v5, "hasEventTimestampInMSSince1970"))
        goto LABEL_34;
      v25 = -[BMSiriOnDeviceDigestUsageMetricsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970");
    ...
    if (!-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs")&& !objc_msgSend(v5, "hasUserAggregationIdRotationTimestampInMs")|| -[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs")&& objc_msgSend(v5, "hasUserAggregationIdRotationTimestampInMs")&& (v32 = -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"), v32 == objc_msgSend(v5, "userAggregationIdRotationTimestampInMs")))
    {
      if (!-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs")&& !objc_msgSend(v5, "hasUserAggregationIdExpirationTimestampInMs"))
      {
        v12 = 1;
        goto LABEL_35;
      }
      if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs")&& objc_msgSend(v5, "hasUserAggregationIdExpirationTimestampInMs"))
      {
        v33 = -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriOnDeviceDigestUsageMetricsEventMetadata initByReadFrom:]([BMSiriOnDeviceDigestUsageMetricsEventMetadata alloc], "initByReadFrom:", v7);
    v4[5] = 0;
...
+ (id)columns
{
  ...
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("timeInterval_json"), 5, 1, &__block_literal_global_41038);
