...
- (BMIntelligenceEngineInteractionCandidateID)initWithIdentifier:(id)a3 bundleId:(id)a4
{
  id v7;
  id v8;
  BMIntelligenceEngineInteractionCandidateID *v9;
  objc_super v11;
...
- (NSString)description
{
  ...
  -[BMIntelligenceEngineInteractionCandidateID identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMIntelligenceEngineInteractionCandidateID bundleId](self, "bundleId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMIntelligenceEngineInteractionCandidateID with identifier: %@, bundleId: %@"), v4, v5);
...
{
  _BYTE *v4;
  BMIntelligenceEngineInteractionCandidateID *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  uint64_t v21;
  void *v22;
  BMIntelligenceEngineInteractionCandidateID *v23;
  objc_super v25;
...
- (id)serialize
{
  ...
  -[BMIntelligenceEngineInteractionCandidateID writeTo:](self, "writeTo:", v3);
...
- (BMIntelligenceEngineInteractionCandidateID)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  id v10;
  BMIntelligenceEngineInteractionCandidateID *v11;
  id v13;
  uint64_t v14;
  id v15;
  id v16;
  ...
  self = -[BMIntelligenceEngineInteractionCandidateID initWithIdentifier:bundleId:](self, "initWithIdentifier:bundleId:", v8, v10);
  v11 = self;
LABEL_8:
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMIntelligenceEngineInteractionCandidateID initByReadFrom:]([BMIntelligenceEngineInteractionCandidateID alloc], "initByReadFrom:", v7);
    v4[4] = 0;
