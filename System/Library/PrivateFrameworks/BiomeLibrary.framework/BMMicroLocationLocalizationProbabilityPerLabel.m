...
- (BMMicroLocationLocalizationProbabilityPerLabel)initWithLabel:(id)a3 probability:(id)a4
{
  id v7;
  id v8;
  BMMicroLocationLocalizationProbabilityPerLabel *v9;
  double v10;
  objc_super v12;
...
- (NSString)description
{
  ...
  -[BMMicroLocationLocalizationProbabilityPerLabel label](self, "label");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)MEMORY[0x1E0CB37E8];
  -[BMMicroLocationLocalizationProbabilityPerLabel probability](self, "probability");
  objc_msgSend(v5, "numberWithDouble:");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMMicroLocationLocalizationProbabilityPerLabel with label: %@, probability: %@"), v4, v6);
...
{
  _BYTE *v4;
  BMMicroLocationLocalizationProbabilityPerLabel *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  unint64_t v23;
  double v24;
  BMMicroLocationLocalizationProbabilityPerLabel *v25;
  objc_super v27;
...
- (id)serialize
{
  ...
  -[BMMicroLocationLocalizationProbabilityPerLabel writeTo:](self, "writeTo:", v3);
...
- (BMMicroLocationLocalizationProbabilityPerLabel)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  id v10;
  BMMicroLocationLocalizationProbabilityPerLabel *v11;
  id v13;
  uint64_t v14;
  id v15;
  id v16;
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      v10 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("label"));
      v23[0] = v10;
  ...
  self = -[BMMicroLocationLocalizationProbabilityPerLabel initWithLabel:probability:](self, "initWithLabel:probability:", v8, v10);
  v11 = self;
LABEL_8:
...
- (id)jsonDictionary
{
  ...
  if (!-[BMMicroLocationLocalizationProbabilityPerLabel hasProbability](self, "hasProbability")
    || (-[BMMicroLocationLocalizationProbabilityPerLabel probability](self, "probability"), fabs(v4) == INFINITY))
  {
    v6 = 0;
  }
  else
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (a4 == 1)
  {
    ...
    v7 = -[BMMicroLocationLocalizationProbabilityPerLabel initByReadFrom:]([BMMicroLocationLocalizationProbabilityPerLabel alloc], "initByReadFrom:", v6);
    v7[5] = 1;
