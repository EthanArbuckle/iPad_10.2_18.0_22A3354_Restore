...
- (NSString)description
{
  ...
  BMSleepScheduleStateStateAsString(-[BMSleepScheduleState state](self, "state"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  BMSleepScheduleStateChangeReasonAsString(-[BMSleepScheduleState changeReason](self, "changeReason"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSleepScheduleState with state: %@, changeReason: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMSleepScheduleState writeTo:](self, "writeTo:", v3);
...
- (BMSleepScheduleState)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMSleepScheduleStateStateFromString(v7));
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSNumber (corresponding to enum value), or NSString (string version of enum)"), objc_opt_class(), CFSTR("changeReason"));
          v23 = v20;
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMSleepScheduleStateChangeReasonFromString(v10));
  ...
  self = -[BMSleepScheduleState initWithState:changeReason:](self, "initWithState:changeReason:", objc_msgSend(v8, "intValue"), objc_msgSend(v11, "intValue"));
  v13 = self;
LABEL_18:
...
- (id)jsonDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMSleepScheduleState state](self, "state"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMSleepScheduleState changeReason](self, "changeReason"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = CFSTR("state");
  v5 = v3;
  if (!v3)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = -[BMSleepScheduleState state](self, "state");
    if (v6 == objc_msgSend(v5, "state"))
    {
      v7 = -[BMSleepScheduleState changeReason](self, "changeReason");
      v8 = v7 == objc_msgSend(v5, "changeReason");
    }
    else
    {
      v8 = 0;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSleepScheduleState initByReadFrom:]([BMSleepScheduleState alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)protoFields
{
  ...
  v6[0] = v2;
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("changeReason"), 2, 4, 0);
  v6[1] = v3;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v6, 2);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
