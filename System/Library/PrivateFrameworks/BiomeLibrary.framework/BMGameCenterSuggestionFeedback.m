...
{
  id v5;
  BMGameCenterSuggestionFeedback *v6;
  objc_super v8;
...
- (NSString)description
{
  ...
  -[BMGameCenterSuggestionFeedback identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMGameCenterSuggestionFeedback with identifier: %@"), v4);
...
{
  _BYTE *v4;
  BMGameCenterSuggestionFeedback *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  uint64_t v19;
  NSString *identifier;
  BMGameCenterSuggestionFeedback *v21;
  objc_super v23;
...
- (id)serialize
{
  ...
  -[BMGameCenterSuggestionFeedback writeTo:](self, "writeTo:", v3);
...
{
  void *v6;
  BMGameCenterSuggestionFeedback *v7;
  id v9;
  uint64_t v10;
  void *v11;
  void *v12;
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = -[BMGameCenterSuggestionFeedback initWithIdentifier:](self, "initWithIdentifier:", a4);
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMGameCenterSuggestionFeedback initByReadFrom:]([BMGameCenterSuggestionFeedback alloc], "initByReadFrom:", v7);
    v4[4] = 0;
