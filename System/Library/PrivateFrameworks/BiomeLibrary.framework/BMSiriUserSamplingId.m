...
- (BMSiriUserSamplingId)initWithSamplingId:(id)a3 effectiveFrom:(id)a4 validityDays:(id)a5 createdOn:(id)a6 adoptedOn:(id)a7 switchedCount:(id)a8
{
  ...
  id v18;
  id v19;
  BMSiriUserSamplingId *v20;
  uint64_t v21;
  NSData *raw_samplingId;
  double v23;
  unsigned int v24;
  double v25;
  double v26;
...
- (NSString)description
{
  ...
  -[BMSiriUserSamplingId samplingId](self, "samplingId");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriUserSamplingId effectiveFrom](self, "effectiveFrom");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserSamplingId validityDays](self, "validityDays"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriUserSamplingId createdOn](self, "createdOn");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriUserSamplingId adoptedOn](self, "adoptedOn");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserSamplingId switchedCount](self, "switchedCount"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriUserSamplingId with samplingId: %@, effectiveFrom: %@, validityDays: %@, createdOn: %@, adoptedOn: %@, switchedCount: %@"), v4, v5, v6, v7, v8, v9);
...
- (id)serialize
{
  ...
  -[BMSiriUserSamplingId writeTo:](self, "writeTo:", v3);
...
- (BMSiriUserSamplingId)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("samplingId"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (!v11)
    {
      if (a4)
      {
        ...
        v72 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("-initWithUUIDString: for %@ returned nil"), CFSTR("samplingId"));
        v86[0] = v72;
...
LABEL_40:
    ...
    v22 = -[BMSiriUserSamplingId initWithSamplingId:effectiveFrom:validityDays:createdOn:adoptedOn:switchedCount:](v37, "initWithSamplingId:effectiveFrom:validityDays:createdOn:adoptedOn:switchedCount:", v68, v70, v69, v26, v38, v47);
    v37 = v22;
LABEL_44:
  ...
  v8 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("samplingId"));
  v84 = v8;
...
- (id)jsonDictionary
{
  ...
  if (-[BMSiriUserSamplingId hasValidityDays](self, "hasValidityDays"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserSamplingId validityDays](self, "validityDays"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if (-[BMSiriUserSamplingId hasSwitchedCount](self, "hasSwitchedCount"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriUserSamplingId switchedCount](self, "switchedCount"));
...
- (NSUUID)samplingId
{
  ...
  if (raw_samplingId)
  {
    objc_msgSend(MEMORY[0x1E0D02620], "convertValue:toType:", raw_samplingId, 3);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
      ...
      || objc_msgSend(v5, "hasValidityDays"))
    {
      ...
      if (!objc_msgSend(v5, "hasValidityDays"))
        goto LABEL_29;
      v19 = -[BMSiriUserSamplingId validityDays](self, "validityDays");
    ...
    if (-[BMSiriUserSamplingId hasSwitchedCount](self, "hasSwitchedCount")
      && objc_msgSend(v5, "hasSwitchedCount"))
    {
      v32 = -[BMSiriUserSamplingId switchedCount](self, "switchedCount");
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_raw_samplingId, 0);
}
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriUserSamplingId initByReadFrom:]([BMSiriUserSamplingId alloc], "initByReadFrom:", v7);
    v4[19] = 0;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02720]), "initWithName:dataType:requestOnly:fieldNumber:protoDataType:convertedType:", CFSTR("samplingId"), 6, 0, 1, 14, 3);
...
+ (id)protoFields
{
  ...
  v10[6] = *MEMORY[0x1E0C80C00];
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("samplingId"), 1, 14, 0);
  v10[0] = v2;
