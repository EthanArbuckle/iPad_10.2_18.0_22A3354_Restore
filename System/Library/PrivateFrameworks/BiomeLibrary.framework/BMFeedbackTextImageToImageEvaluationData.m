...
- (BMFeedbackTextImageToImageEvaluationData)initWithCommonMetadata:(id)a3 originalContent:(id)a4 generatedContent:(id)a5
{
  ...
  id v10;
  id v11;
  BMFeedbackTextImageToImageEvaluationData *v12;
  objc_super v14;
...
- (NSString)description
{
  ...
  -[BMFeedbackTextImageToImageEvaluationData commonMetadata](self, "commonMetadata");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMFeedbackTextImageToImageEvaluationData originalContent](self, "originalContent");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMFeedbackTextImageToImageEvaluationData generatedContent](self, "generatedContent");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMFeedbackTextImageToImageEvaluationData with commonMetadata: %@, originalContent: %@, generatedContent: %@"), v4, v5, v6);
...
{
  _BYTE *v4;
  BMFeedbackTextImageToImageEvaluationData *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  uint64_t v21;
  void *v22;
  BMFeedbackTextImageToImageEvaluationData *v23;
  objc_super v25;
  uint64_t v26;
  uint64_t v27;
...
LABEL_15:
      ...
      else if ((_DWORD)v19 == 2)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0)
          goto LABEL_35;
        v20 = -[BMTextImageContent initByReadFrom:]([BMTextImageContent alloc], "initByReadFrom:", v4);
        if (!v20)
          goto LABEL_35;
        v21 = 32;
      }
...
- (void)writeTo:(id)a3
{
  ...
  {
    PBDataWriterPlaceMark();
    -[BMTextImageContent writeTo:](self->_originalContent, "writeTo:", v4);
    PBDataWriterRecallMark();
  }
...
- (id)serialize
{
  ...
  -[BMFeedbackTextImageToImageEvaluationData writeTo:](self, "writeTo:", v3);
...
- (BMFeedbackTextImageToImageEvaluationData)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v9;
  BMTextImageContent *v10;
  id v11;
  BMImageContent *v12;
  BMFeedbackTextImageToImageEvaluationData *v13;
  id v15;
  void *v16;
  id v17;
  void *v18;
...
LABEL_4:
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v11 = v9;
      v32 = 0;
      v10 = -[BMTextImageContent initWithJSONDictionary:error:]([BMTextImageContent alloc], "initWithJSONDictionary:error:", v11, &v32);
      v17 = v32;
      if (v17)
      {
        v18 = v17;
...
LABEL_7:
      ...
      if (!v11 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
      {
        v12 = 0;
LABEL_10:
        self = -[BMFeedbackTextImageToImageEvaluationData initWithCommonMetadata:originalContent:generatedContent:](self, "initWithCommonMetadata:originalContent:generatedContent:", v8, v10, v12);
        v13 = self;
LABEL_11:
...
LABEL_37:
    ...
    if (a4)
    {
      ...
      v10 = (BMTextImageContent *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSDictionary"), objc_opt_class(), CFSTR("originalContent"));
      v37 = v10;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMFeedbackTextImageToImageEvaluationData initByReadFrom:]([BMFeedbackTextImageToImageEvaluationData alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("commonMetadata_json"), 5, 1, &__block_literal_global_9167);
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("originalContent_json"), 5, 1, &__block_literal_global_26_9168);
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("generatedContent_json"), 5, 1, &__block_literal_global_27_9169);
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
