...
- (NSString)description
{
  ...
  -[BMDeviceBacklight absoluteTimestamp](self, "absoluteTimestamp");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMDeviceBacklight backlightLevel](self, "backlightLevel"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMDeviceBacklight with absoluteTimestamp: %@, backlightLevel: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMDeviceBacklight writeTo:](self, "writeTo:", v3);
...
LABEL_9:
  objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("backlightLevel"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (v16 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v22 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSNumber"), objc_opt_class(), CFSTR("backlightLevel"));
        v28 = v22;
  ...
  self = -[BMDeviceBacklight initWithAbsoluteTimestamp:backlightLevel:](self, "initWithAbsoluteTimestamp:backlightLevel:", v8, v17);
  v18 = self;
LABEL_13:
...
- (id)jsonDictionary
{
  ...
  if (-[BMDeviceBacklight hasBacklightLevel](self, "hasBacklightLevel"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMDeviceBacklight backlightLevel](self, "backlightLevel"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (!-[BMDeviceBacklight hasBacklightLevel](self, "hasBacklightLevel")
      && !objc_msgSend(v5, "hasBacklightLevel"))
    {
      v12 = 1;
      goto LABEL_13;
    }
    if (-[BMDeviceBacklight hasBacklightLevel](self, "hasBacklightLevel")
      && objc_msgSend(v5, "hasBacklightLevel"))
    {
      v13 = -[BMDeviceBacklight backlightLevel](self, "backlightLevel");
      v12 = v13 == objc_msgSend(v5, "backlightLevel");
LABEL_13:
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMDeviceBacklight initByReadFrom:]([BMDeviceBacklight alloc], "initByReadFrom:", v7);
    v4[9] = 0;
...
+ (id)columns
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02720]), "initWithName:dataType:requestOnly:fieldNumber:protoDataType:convertedType:", CFSTR("backlightLevel"), 0, 0, 2, 5, 0);
  v6[0] = v2;
  v6[1] = v3;
...
+ (id)protoFields
{
  ...
  v6[0] = v2;
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("backlightLevel"), 2, 5, 0);
  v6[1] = v3;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v6, 2);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
