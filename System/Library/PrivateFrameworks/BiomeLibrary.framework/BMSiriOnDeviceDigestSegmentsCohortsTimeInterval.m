...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval numberOfSeconds](self, "numberOfSeconds"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriOnDeviceDigestSegmentsCohortsTimeInterval with startTimestampInSecondsSince1970: %@, numberOfSeconds: %@"), v4, v5);
...
{
  _BYTE *v4;
  BMSiriOnDeviceDigestSegmentsCohortsTimeInterval *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  unint64_t v29;
  char v30;
  BMSiriOnDeviceDigestSegmentsCohortsTimeInterval *v31;
  objc_super v33;
...
- (id)serialize
{
  ...
  -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval writeTo:](self, "writeTo:", v3);
...
- (BMSiriOnDeviceDigestSegmentsCohortsTimeInterval)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  id v10;
  BMSiriOnDeviceDigestSegmentsCohortsTimeInterval *v11;
  id v13;
  uint64_t v14;
  id v15;
  id v16;
  ...
  self = -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval initWithStartTimestampInSecondsSince1970:numberOfSeconds:](self, "initWithStartTimestampInSecondsSince1970:numberOfSeconds:", v8, v10);
  v11 = self;
LABEL_8:
...
- (id)jsonDictionary
{
  ...
  if (-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970"));
  ...
  if (-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasNumberOfSeconds](self, "hasNumberOfSeconds"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval numberOfSeconds](self, "numberOfSeconds"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    if (-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970")|| objc_msgSend(v5, "hasStartTimestampInSecondsSince1970"))
    {
      if (!-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970"))goto LABEL_13;
      if (!objc_msgSend(v5, "hasStartTimestampInSecondsSince1970"))
        goto LABEL_13;
      v6 = -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970");
    ...
    if (-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasNumberOfSeconds](self, "hasNumberOfSeconds")
      && objc_msgSend(v5, "hasNumberOfSeconds"))
    {
      v7 = -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval numberOfSeconds](self, "numberOfSeconds");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval initByReadFrom:]([BMSiriOnDeviceDigestSegmentsCohortsTimeInterval alloc], "initByReadFrom:", v7);
    v4[5] = 0;
