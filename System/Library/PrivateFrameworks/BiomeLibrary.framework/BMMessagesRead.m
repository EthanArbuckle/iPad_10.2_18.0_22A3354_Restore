...
- (BMMessagesRead)initWithIdsHandle:(id)a3 markedUnread:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v8)
    {
      ...
      v9->_markedUnread = objc_msgSend(v8, "BOOLValue");
    }
    else
    {
...
- (NSString)description
{
  ...
  -[BMMessagesRead idsHandle](self, "idsHandle");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMMessagesRead markedUnread](self, "markedUnread"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMMessagesRead with idsHandle: %@, markedUnread: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMMessagesRead writeTo:](self, "writeTo:", v3);
...
- (BMMessagesRead)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("markedUnread"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSNumber"), objc_opt_class(), CFSTR("markedUnread"));
        v21 = v18;
  ...
  self = -[BMMessagesRead initWithIdsHandle:markedUnread:](self, "initWithIdsHandle:markedUnread:", v8, v10);
  v11 = self;
LABEL_8:
...
- (id)jsonDictionary
{
  ...
  if (-[BMMessagesRead hasMarkedUnread](self, "hasMarkedUnread"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMMessagesRead markedUnread](self, "markedUnread"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (!-[BMMessagesRead hasMarkedUnread](self, "hasMarkedUnread")
      && !objc_msgSend(v5, "hasMarkedUnread"))
    {
      LOBYTE(v12) = 1;
      goto LABEL_13;
    }
    if (-[BMMessagesRead hasMarkedUnread](self, "hasMarkedUnread") && objc_msgSend(v5, "hasMarkedUnread"))
    {
      v13 = -[BMMessagesRead markedUnread](self, "markedUnread");
      v12 = v13 ^ objc_msgSend(v5, "markedUnread") ^ 1;
LABEL_13:
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMMessagesRead initByReadFrom:]([BMMessagesRead alloc], "initByReadFrom:", v7);
    v4[5] = 0;
...
+ (id)columns
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02720]), "initWithName:dataType:requestOnly:fieldNumber:protoDataType:convertedType:", CFSTR("markedUnread"), 0, 0, 2, 12, 0);
  v6[0] = v2;
  v6[1] = v3;
...
+ (id)protoFields
{
  ...
  v6[0] = v2;
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("markedUnread"), 2, 12, 0);
  v6[1] = v3;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v6, 2);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
