...
- (BMCustomAttributesBasicValue)initWithBoolValue:(id)a3 int64Value:(id)a4 doubleValue:(id)a5 stringValue:(id)a6
{
  ...
  id v12;
  id v13;
  BMCustomAttributesBasicValue *v14;
  uint64_t v15;
  double v16;
  objc_super v18;
...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMCustomAttributesBasicValue BOOLValue](self, "BOOLValue"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[BMCustomAttributesBasicValue int64Value](self, "int64Value"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)MEMORY[0x1E0CB37E8];
  -[BMCustomAttributesBasicValue doubleValue](self, "doubleValue");
  objc_msgSend(v6, "numberWithDouble:");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMCustomAttributesBasicValue stringValue](self, "stringValue");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMCustomAttributesBasicValue with BOOLValue: %@, int64Value: %@, doubleValue: %@, stringValue: %@"), v4, v5, v7, v8);
...
{
  _BYTE *v4;
  BMCustomAttributesBasicValue *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  BMCustomAttributesBasicValue *v39;
  objc_super v41;
...
- (id)serialize
{
  ...
  -[BMCustomAttributesBasicValue writeTo:](self, "writeTo:", v3);
...
- (BMCustomAttributesBasicValue)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  void *v10;
  BMCustomAttributesBasicValue *v11;
  id v12;
  void *v13;
  id v14;
  BMCustomAttributesBasicValue *v15;
  id v16;
  uint64_t v17;
  id *v18;
  id v19;
...
LABEL_13:
      a4 = v31;
      v15 = -[BMCustomAttributesBasicValue initWithBoolValue:int64Value:doubleValue:stringValue:](v11, "initWithBoolValue:int64Value:doubleValue:stringValue:", v8, v31, v12, v14);
      v11 = v15;
LABEL_32:
...
- (id)jsonDictionary
{
  ...
  if (-[BMCustomAttributesBasicValue hasBoolValue](self, "hasBoolValue"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMCustomAttributesBasicValue BOOLValue](self, "BOOLValue"));
  ...
  if (-[BMCustomAttributesBasicValue hasInt64Value](self, "hasInt64Value"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[BMCustomAttributesBasicValue int64Value](self, "int64Value"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if (!-[BMCustomAttributesBasicValue hasDoubleValue](self, "hasDoubleValue")
    || (-[BMCustomAttributesBasicValue doubleValue](self, "doubleValue"), fabs(v5) == INFINITY))
  {
    v7 = 0;
  }
  else
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if ((!-[BMCustomAttributesBasicValue hasBoolValue](self, "hasBoolValue")
       ...
       || -[BMCustomAttributesBasicValue hasBoolValue](self, "hasBoolValue")
       && objc_msgSend(v5, "hasBoolValue")
       && (v6 = -[BMCustomAttributesBasicValue BOOLValue](self, "BOOLValue"),
           v6 == objc_msgSend(v5, "BOOLValue")))
      && (!-[BMCustomAttributesBasicValue hasInt64Value](self, "hasInt64Value")
       && !objc_msgSend(v5, "hasInt64Value")
       || -[BMCustomAttributesBasicValue hasInt64Value](self, "hasInt64Value")
       && objc_msgSend(v5, "hasInt64Value")
       && (v7 = -[BMCustomAttributesBasicValue int64Value](self, "int64Value"), v7 == objc_msgSend(v5, "int64Value")))
      && (!-[BMCustomAttributesBasicValue hasDoubleValue](self, "hasDoubleValue")
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMCustomAttributesBasicValue initByReadFrom:]([BMCustomAttributesBasicValue alloc], "initByReadFrom:", v7);
    v4[5] = 0;
