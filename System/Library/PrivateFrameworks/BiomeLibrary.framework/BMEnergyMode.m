...
- (NSString)description
{
  ...
  BMEnergyModeModeAsString(-[BMEnergyMode mode](self, "mode"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  BMEnergyModeReasonAsString(-[BMEnergyMode reason](self, "reason"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMEnergyMode with mode: %@, reason: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMEnergyMode writeTo:](self, "writeTo:", v3);
...
- (BMEnergyMode)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSNumber (corresponding to enum value), or NSString (string version of enum)"), objc_opt_class(), CFSTR("mode"));
        v25[0] = v11;
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMEnergyModeModeFromString(v7));
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", BMEnergyModeReasonFromString(v10));
  ...
  self = -[BMEnergyMode initWithMode:reason:](self, "initWithMode:reason:", objc_msgSend(v8, "intValue"), objc_msgSend(v11, "intValue"));
  v13 = self;
LABEL_18:
...
- (id)jsonDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMEnergyMode mode](self, "mode"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMEnergyMode reason](self, "reason"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = CFSTR("mode");
  v5 = v3;
  if (!v3)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = -[BMEnergyMode mode](self, "mode");
    if (v6 == objc_msgSend(v5, "mode"))
    {
      v7 = -[BMEnergyMode reason](self, "reason");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMEnergyMode initByReadFrom:]([BMEnergyMode alloc], "initByReadFrom:", v7);
    v4[4] = 0;
