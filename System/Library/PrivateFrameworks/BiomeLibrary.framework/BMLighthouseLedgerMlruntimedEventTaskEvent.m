...
- (BMLighthouseLedgerMlruntimedEventTaskEvent)initWithSucceeded:(id)a3 errorDomain:(id)a4 errorCode:(id)a5
{
  ...
  id v9;
  id v10;
  BMLighthouseLedgerMlruntimedEventTaskEvent *v11;
  int v12;
  objc_super v14;
...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMLighthouseLedgerMlruntimedEventTaskEvent succeeded](self, "succeeded"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMLighthouseLedgerMlruntimedEventTaskEvent errorDomain](self, "errorDomain");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMLighthouseLedgerMlruntimedEventTaskEvent errorCode](self, "errorCode"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMLighthouseLedgerMlruntimedEventTaskEvent with succeeded: %@, errorDomain: %@, errorCode: %@"), v4, v5, v6);
...
{
  _BYTE *v4;
  BMLighthouseLedgerMlruntimedEventTaskEvent *v5;
  int *v6;
  int *v7;
  int *v8;
  int *v9;
  ...
  BMLighthouseLedgerMlruntimedEventTaskEvent *v37;
  objc_super v39;
...
- (id)serialize
{
  ...
  -[BMLighthouseLedgerMlruntimedEventTaskEvent writeTo:](self, "writeTo:", v3);
...
- (BMLighthouseLedgerMlruntimedEventTaskEvent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v11;
  id v12;
  BMLighthouseLedgerMlruntimedEventTaskEvent *v13;
  id v15;
  uint64_t v16;
  id v17;
  uint64_t v18;
...
LABEL_4:
    ...
    self = -[BMLighthouseLedgerMlruntimedEventTaskEvent initWithSucceeded:errorDomain:errorCode:](self, "initWithSucceeded:errorDomain:errorCode:", v8, v10, v12);
    v13 = self;
LABEL_11:
...
- (id)jsonDictionary
{
  ...
  if (-[BMLighthouseLedgerMlruntimedEventTaskEvent hasSucceeded](self, "hasSucceeded"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[BMLighthouseLedgerMlruntimedEventTaskEvent succeeded](self, "succeeded"));
  ...
  -[BMLighthouseLedgerMlruntimedEventTaskEvent errorDomain](self, "errorDomain");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (-[BMLighthouseLedgerMlruntimedEventTaskEvent hasErrorCode](self, "hasErrorCode"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[BMLighthouseLedgerMlruntimedEventTaskEvent errorCode](self, "errorCode"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
      ...
      || objc_msgSend(v5, "hasSucceeded"))
    {
      ...
      if (!objc_msgSend(v5, "hasSucceeded"))
        goto LABEL_17;
      v6 = -[BMLighthouseLedgerMlruntimedEventTaskEvent succeeded](self, "succeeded");
    ...
    if (-[BMLighthouseLedgerMlruntimedEventTaskEvent hasErrorCode](self, "hasErrorCode")
      && objc_msgSend(v5, "hasErrorCode"))
    {
      v14 = -[BMLighthouseLedgerMlruntimedEventTaskEvent errorCode](self, "errorCode");
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMLighthouseLedgerMlruntimedEventTaskEvent initByReadFrom:]([BMLighthouseLedgerMlruntimedEventTaskEvent alloc], "initByReadFrom:", v7);
    v4[5] = 0;
