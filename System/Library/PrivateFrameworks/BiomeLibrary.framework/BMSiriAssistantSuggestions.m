...
- (NSString)description
{
  ...
  -[BMSiriAssistantSuggestions interaction](self, "interaction");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriAssistantSuggestions entities](self, "entities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriAssistantSuggestions with interaction: %@, entities: %@"), v4, v5);
...
- (id)initByReadFrom:(id)a3
{
  ...
  NSArray *entities;
  int v26;
  BMSiriAssistantSuggestions *v27;
  objc_super v29;
  uint64_t v30;
  uint64_t v31;
...
- (id)serialize
{
  ...
  -[BMSiriAssistantSuggestions writeTo:](self, "writeTo:", v3);
...
- (BMSiriAssistantSuggestions)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v21;
  BMSiriAssistantSuggestions *v22;
  id v23;
  void *v24;
  id v25;
  uint64_t v26;
  ...
  uint64_t v35;
  void *v36;
  BMSiriAssistantSuggestions *v37;
  id *v38;
  void *v39;
  id v40;
...
LABEL_19:
  ...
  v8 = v41;
  self = -[BMSiriAssistantSuggestions initWithInteraction:entities:](self, "initWithInteraction:entities:", v41, v12);
  v22 = self;
  v7 = v39;
  v6 = v40;
LABEL_36:
...
- (id)_entitiesJSONArray
{
  ...
  v13 = 0u;
  v14 = 0u;
  -[BMSiriAssistantSuggestions entities](self, "entities", 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)jsonDictionary
{
  ...
  -[BMSiriAssistantSuggestions _entitiesJSONArray](self, "_entitiesJSONArray");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriAssistantSuggestions initByReadFrom:]([BMSiriAssistantSuggestions alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("interaction_json"), 5, 1, &__block_literal_global_48602);
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("entities_json"), 5, 1, &__block_literal_global_27_48603);
  v6[0] = v2;
  v6[1] = v3;
