...
- (NSString)description
{
  ...
  -[BMSiriRemembersEntities key](self, "key");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMSiriRemembersEntities entities](self, "entities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMSiriRemembersEntities with key: %@, entities: %@"), v4, v5);
...
LABEL_15:
      ...
      if ((v13 >> 3) == 2)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0
          || (v22 = -[BMSiriRemembersEntitiesSiriRemembersEntity initByReadFrom:]([BMSiriRemembersEntitiesSiriRemembersEntity alloc], "initByReadFrom:", v4)) == 0)
        {
LABEL_31:
...
- (id)serialize
{
  ...
  -[BMSiriRemembersEntities writeTo:](self, "writeTo:", v3);
...
- (BMSiriRemembersEntities)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  void *v17;
  id v18;
  BMSiriRemembersEntitiesSiriRemembersEntity *v19;
  BMSiriRemembersEntitiesSiriRemembersEntity *v20;
  id v21;
  id v22;
  id *v23;
  uint64_t v24;
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (p_isa)
      {
        ...
        v9 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("key"));
        v57[0] = v9;
...
LABEL_11:
    ...
    while (1)
    {
      ...
      v44 = 0;
      v20 = -[BMSiriRemembersEntitiesSiriRemembersEntity initWithJSONDictionary:error:](v19, "initWithJSONDictionary:error:", v18, &v44);
      v21 = v44;
      if (v21)
      {
        v32 = v21;
...
LABEL_19:
        ...
        v8 = v42;
        self = -[BMSiriRemembersEntities initWithKey:entities:](v41, "initWithKey:entities:", v42, v12);
...
- (id)_entitiesJSONArray
{
  ...
  v13 = 0u;
  v14 = 0u;
  -[BMSiriRemembersEntities entities](self, "entities", 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)jsonDictionary
{
  ...
  -[BMSiriRemembersEntities _entitiesJSONArray](self, "_entitiesJSONArray");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = CFSTR("key");
  v5 = v3;
  if (!v3)
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMSiriRemembersEntities initByReadFrom:]([BMSiriRemembersEntities alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)columns
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D02710]), "initWithName:dataType:requestOnly:extractBlock:", CFSTR("entities_json"), 5, 1, &__block_literal_global_142);
  v6[0] = v2;
  v6[1] = v3;
