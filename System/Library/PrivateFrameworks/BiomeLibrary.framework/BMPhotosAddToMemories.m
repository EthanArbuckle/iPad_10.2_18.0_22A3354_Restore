...
- (NSString)description
{
  ...
  -[BMPhotosAddToMemories identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPhotosAddToMemories subset](self, "subset");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("BMPhotosAddToMemories with identifier: %@, subset: %@"), v4, v5);
...
- (id)serialize
{
  ...
  -[BMPhotosAddToMemories writeTo:](self, "writeTo:", v3);
...
- (BMPhotosAddToMemories)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("Unexpected type %@ for element of %@, expecting NSString"), objc_opt_class(), CFSTR("subset"));
        v21 = v18;
  ...
  self = -[BMPhotosAddToMemories initWithIdentifier:subset:](self, "initWithIdentifier:subset:", v8, v10);
  v11 = self;
LABEL_8:
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v4 = -[BMPhotosAddToMemories initByReadFrom:]([BMPhotosAddToMemories alloc], "initByReadFrom:", v7);
    v4[4] = 0;
...
+ (id)protoFields
{
  ...
  v6[0] = v2;
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D026E8]), "initWithName:number:type:subMessageClass:", CFSTR("subset"), 2, 13, 0);
  v6[1] = v3;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v6, 2);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
