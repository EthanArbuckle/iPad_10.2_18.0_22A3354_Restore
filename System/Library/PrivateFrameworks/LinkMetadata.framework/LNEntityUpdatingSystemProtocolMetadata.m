...
{
  id v5;
  LNEntityUpdatingSystemProtocolMetadata *v6;
  LNEntityUpdatingSystemProtocolMetadata *v7;
  LNEntityUpdatingSystemProtocolMetadata *v8;
  objc_super v10;

  v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)LNEntityUpdatingSystemProtocolMetadata;
  v6 = -[LNEntityUpdatingSystemProtocolMetadata init](&v10, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[LNEntityUpdatingSystemProtocolMetadata entityIdentifier](self, "entityIdentifier");
...
- (LNEntityUpdatingSystemProtocolMetadata)initWithCoder:(id)a3
{
  ...
  v6 = -[LNEntityUpdatingSystemProtocolMetadata initWithEntityIdentifier:](self, "initWithEntityIdentifier:", v5);
  return v6;
}
...
- (BOOL)isEqual:(id)a3
{
  LNEntityUpdatingSystemProtocolMetadata *v4;
  LNEntityUpdatingSystemProtocolMetadata *v5;
  LNEntityUpdatingSystemProtocolMetadata *v6;
  void *v7;
  void *v8;
  char v9;
  ...
  else
  {
    ...
    if (v6 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      -[LNEntityUpdatingSystemProtocolMetadata entityIdentifier](self, "entityIdentifier");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[LNEntityUpdatingSystemProtocolMetadata entityIdentifier](v6, "entityIdentifier");
