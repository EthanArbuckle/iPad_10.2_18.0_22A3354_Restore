...
- (id)description
{
  ...
  -[ASCodableCloudKitAchievement description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ASCodableCloudKitAchievement dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (unint64_t)hash
{
  ...
  v3 = -[ASCodableCloudKitSample hash](self->_sample, "hash");
  has = (char)self->_has;
  if ((has & 1) != 0)
  {
