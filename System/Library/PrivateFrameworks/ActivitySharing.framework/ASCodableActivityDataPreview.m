...
- (id)description
{
  ...
  -[ASCodableActivityDataPreview description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ASCodableActivityDataPreview dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (activitySnapshot)
  {
    -[ASCodableCloudKitActivitySnapshot dictionaryRepresentation](activitySnapshot, "dictionaryRepresentation");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_workouts, "count"));
    v26 = 0u;
    v27 = 0u;
    v28 = 0u;
    v29 = 0u;
  ...
  {
    v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_achievements, "count"));
    v22 = 0u;
    v23 = 0u;
    v24 = 0u;
    v25 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if (-[ASCodableActivityDataPreview workoutsCount](self, "workoutsCount"))
  {
    objc_msgSend(v12, "clearWorkouts");
    v4 = -[ASCodableActivityDataPreview workoutsCount](self, "workoutsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[ASCodableActivityDataPreview workoutsAtIndex:](self, "workoutsAtIndex:", i);
  ...
  if (-[ASCodableActivityDataPreview achievementsCount](self, "achievementsCount"))
  {
    objc_msgSend(v12, "clearAchievements");
    v8 = -[ASCodableActivityDataPreview achievementsCount](self, "achievementsCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[ASCodableActivityDataPreview achievementsAtIndex:](self, "achievementsAtIndex:", j);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[ASCodableCloudKitActivitySnapshot copyWithZone:](self->_activitySnapshot, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[ASCodableCloudKitActivitySnapshot hash](self->_activitySnapshot, "hash");
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v22 != v10)
          objc_enumerationMutation(v7);
        -[ASCodableActivityDataPreview addWorkouts:](self, "addWorkouts:", *(_QWORD *)(*((_QWORD *)&v21 + 1) + 8 * i));
      }
  ...
  if (v13)
  {
    ...
    do
    {
      for (j = 0; j != v14; ++j)
      {
        ...
        -[ASCodableActivityDataPreview addAchievements:](self, "addAchievements:", *(_QWORD *)(*((_QWORD *)&v17 + 1) + 8 * j), (_QWORD)v17);
      }
