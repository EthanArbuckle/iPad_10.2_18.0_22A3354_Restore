...
- (id)description
{
  ...
  -[ASCodableWithdrawInviteRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ASCodableWithdrawInviteRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  handshakeToken = self->_handshakeToken;
  if (handshakeToken)
    objc_msgSend(a3, "setHandshakeToken:", handshakeToken);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)handshakeToken | v4[1])
      v6 = -[NSString isEqual:](handshakeToken, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSString hash](self->_handshakeToken, "hash");
}
