...
+ (id)heuristicResultToHomeWithLocation:(id)a3 validStartDate:(id)a4 validEndDate:(id)a5 heuristicDevice:(id)a6
{
  ...
  if (objc_msgSend(v10, "compare:", v11) == 1)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      +[ATXHeuristicCommuteHomeUtilities heuristicResultToHomeWithLocation:validStartDate:validEndDate:heuristicDevice:].cold.1();
...
+ (void)heuristicResultToHomeWithLocation:validStartDate:validEndDate:heuristicDevice:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1_3(&dword_1C99DF000, v0, v1, "ATXHeuristicCommuteHomeUtilities: validStartDate %@ is after validEndDate %@. Skipping event");
  OUTLINED_FUNCTION_2();
}
