...
- (void)initializeWithModel:(id)a3
{
  ...
  -[GCGenericDeviceDataMultiplyExpressionModelBuilder setLeftExpression:](self, "setLeftExpression:", v5);

  objc_msgSend(v4, "rightExpression");
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  -[GCGenericDeviceDataMultiplyExpressionModelBuilder setRightExpression:](self, "setRightExpression:", v6);
}
...
- (void)reset
{
  ...
  -[GCGenericDeviceDataMultiplyExpressionModelBuilder setLeftExpression:](self, "setLeftExpression:", 0);
  -[GCGenericDeviceDataMultiplyExpressionModelBuilder setRightExpression:](self, "setRightExpression:", 0);
}
...
- (id)build
{
  ...
  -[GCGenericDeviceDataMultiplyExpressionModelBuilder leftExpression](self, "leftExpression");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v5)
  {
    unk_1F03A9A20(&off_1F03A9B88, "currentHandler");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GCGenericDeviceDataMultiplyExpressionModel.m"), 103, CFSTR("'leftExpression' can not be nil"));
  ...
  -[GCGenericDeviceDataMultiplyExpressionModelBuilder rightExpression](self, "rightExpression");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v8)
  {
    unk_1F03A9A20(&off_1F03A9B88, "currentHandler");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GCGenericDeviceDataMultiplyExpressionModel.m"), 107, CFSTR("'rightExpression' can not be nil"));
...
{
  id v6;
  GCGenericDeviceDataMultiplyExpressionModelBuilder *v7;
  void *v8;
  id v9;
  void *v10;
  id v11;
  void *v12;
  GCGenericDeviceDataMultiplyExpressionModelBuilder *v13;
  void *v15;
  void *v16;
  _QWORD *v17;
  _QWORD *v18;
...
LABEL_39:
  ...
  -[GCGenericDeviceDataMultiplyExpressionModelBuilder setLeftExpression:](v7, "setLeftExpression:", v10);
...
LABEL_34:
  ...
  -[GCGenericDeviceDataMultiplyExpressionModelBuilder setRightExpression:](v7, "setRightExpression:", v12);
