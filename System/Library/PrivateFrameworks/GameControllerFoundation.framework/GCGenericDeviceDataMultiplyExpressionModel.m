...
{
  id v3;
  GCGenericDeviceDataMultiplyExpressionModel *v4;
  uint64_t v5;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[GCGenericDeviceDataMultiplyExpressionModel leftExpression](self, "leftExpression", v7.receiver, v7.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("leftExpression"));

  -[GCGenericDeviceDataMultiplyExpressionModel rightExpression](self, "rightExpression");
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[GCGenericDeviceDataMultiplyExpressionModel leftExpression](self, "leftExpression");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)description
{
  return CFSTR("Multiply Expression");
}
...
- (id)description
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  +[NSString stringWithFormat:](NSString_0, "stringWithFormat:", CFSTR("(multiply\n\t%@\n\t%@\n)"), v5, v8);
