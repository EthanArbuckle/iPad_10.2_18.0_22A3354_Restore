...
{
  id v4;
  BCMutableSecureUserDatum *v5;
  const char *v6;
  uint64_t v7;
  uint64_t v8;
  uint64_t v9;
  BCMutableSecureUserDatum *v10;
  uint64_t v11;
  NSString *key;
  uint64_t v13;
  const char *v14;
  ...
  v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)BCMutableSecureUserDatum;
  v5 = -[BCMutableCloudData initWithCoder:](&v19, sel_initWithCoder_, v4);
  v10 = v5;
  if (v5)
  {
    ...
    v13 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v14, v13, (uint64_t)CFSTR("value"), v15);
    v16 = objc_claimAutoreleasedReturnValue();
    value = v10->_value;
    v10->_value = (NSString *)v16;
...
- (BCMutableSecureUserDatum)initWithKey:(id)a3
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)BCMutableSecureUserDatum;
  v9 = -[BCMutableCloudData init](&v13, sel_init);
  if (v9)
  {
    v10 = objc_msgSend_copy(v4, v5, v6, v7, v8);
    self = (BCMutableSecureUserDatum *)*((_QWORD *)v9 + 8);
    *((_QWORD *)v9 + 8) = v10;
LABEL_7:

  }
  return (BCMutableSecureUserDatum *)v9;
}
...
- (BCMutableSecureUserDatum)initWithCloudData:(id)a3
{
  ...
  v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BCMutableSecureUserDatum;
...
- (BCMutableSecureUserDatum)initWithRecord:(id)a3
{
  ...
  v21.receiver = self;
  v21.super_class = (Class)BCMutableSecureUserDatum;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_value(self, v5, v6, v7, v8, v12.receiver, v12.super_class);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v4, v10, (uint64_t)v9, (uint64_t)CFSTR("value"), v11);
