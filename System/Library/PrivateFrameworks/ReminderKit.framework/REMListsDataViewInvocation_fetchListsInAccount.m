...
{
  id v5;
  REMListsDataViewInvocation_fetchListsInAccount *v6;
...
- (REMListsDataViewInvocation_fetchListsInAccount)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    self = -[REMListsDataViewInvocation_fetchListsInAccount initWithParentAccountObjectID:](self, "initWithParentAccountObjectID:", v5);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMListsDataViewInvocation_fetchListsInAccount accountObjectID](self, "accountObjectID");
