...
{
  return +[CRRegister registerWithType:contents:document:](CRRegister, "registerWithType:contents:document:", a3, a4, 0);
}
...
+ (id)registerWithType:(unint64_t)a3 contents:(id)a4 document:(id)a5
{
  ...
  if (a3 > 4)
    ...
    v9 = (void *)objc_msgSend(objc_alloc(*off_1E67FADC8[a3]), "initWithContents:document:", v7, v8);
...
- (CRRegister)initWithDocument:(id)a3
{
  ...
  v5 = -[CRRegister init](&v8, sel_init);
  v6 = v5;
  if (v5)
