...
- (REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate)initWithListIDs:(id)a3 startDate:(id)a4 endDate:(id)a5
{
  ...
  id v10;
  id v11;
  REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate *v12;
...
- (REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate)initWithCoder:(id)a3
{
  ...
  void *v9;
  void *v10;
  REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate *v11;
  ...
  v11 = -[REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate initWithListIDs:startDate:endDate:](self, "initWithListIDs:startDate:endDate:", v8, v9, v10);
  return v11;
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate listIDs](self, "listIDs");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("listIDs"));

  -[REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate startDate](self, "startDate");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, CFSTR("startDate"));

  -[REMEventKitBridgingDataViewInvocation_fetchIncompleteRemindersWithDueDate endDate](self, "endDate");
