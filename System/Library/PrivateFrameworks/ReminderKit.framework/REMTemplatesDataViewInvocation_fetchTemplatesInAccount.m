...
{
  id v5;
  REMTemplatesDataViewInvocation_fetchTemplatesInAccount *v6;
...
- (REMTemplatesDataViewInvocation_fetchTemplatesInAccount)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    self = -[REMTemplatesDataViewInvocation_fetchTemplatesInAccount initWithParentAccountObjectID:](self, "initWithParentAccountObjectID:", v5);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMTemplatesDataViewInvocation_fetchTemplatesInAccount accountObjectID](self, "accountObjectID");
