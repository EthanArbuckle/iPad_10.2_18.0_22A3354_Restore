...
{
  id v5;
  REMListsDataViewInvocation_fetchByTemplateObjectID *v6;
...
- (REMListsDataViewInvocation_fetchByTemplateObjectID)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    self = -[REMListsDataViewInvocation_fetchByTemplateObjectID initWithTemplateObjectID:](self, "initWithTemplateObjectID:", v5);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMListsDataViewInvocation_fetchByTemplateObjectID templateObjectID](self, "templateObjectID");
