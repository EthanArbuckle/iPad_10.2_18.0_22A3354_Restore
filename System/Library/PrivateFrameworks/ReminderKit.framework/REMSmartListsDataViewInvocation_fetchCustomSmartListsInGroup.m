...
{
  id v5;
  REMSmartListsDataViewInvocation_fetchCustomSmartListsInGroup *v6;
  REMSmartListsDataViewInvocation_fetchCustomSmartListsInGroup *v7;
  objc_super v9;
...
- (REMSmartListsDataViewInvocation_fetchCustomSmartListsInGroup)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    self = -[REMSmartListsDataViewInvocation_fetchCustomSmartListsInGroup initWithParentGroupObjectID:](self, "initWithParentGroupObjectID:", v5);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMSmartListsDataViewInvocation_fetchCustomSmartListsInGroup groupObjectID](self, "groupObjectID");
