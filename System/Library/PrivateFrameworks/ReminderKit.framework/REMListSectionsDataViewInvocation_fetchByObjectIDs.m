...
{
  id v5;
  REMListSectionsDataViewInvocation_fetchByObjectIDs *v6;
  REMListSectionsDataViewInvocation_fetchByObjectIDs *v7;
  objc_super v9;
...
- (REMListSectionsDataViewInvocation_fetchByObjectIDs)initWithCoder:(id)a3
{
  ...
  void *v7;
  void *v8;
  REMListSectionsDataViewInvocation_fetchByObjectIDs *v9;
  ...
  if (v8)
  {
    self = -[REMListSectionsDataViewInvocation_fetchByObjectIDs initWithObjectIDs:](self, "initWithObjectIDs:", v8);
    v9 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMListSectionsDataViewInvocation_fetchByObjectIDs objectIDs](self, "objectIDs");
