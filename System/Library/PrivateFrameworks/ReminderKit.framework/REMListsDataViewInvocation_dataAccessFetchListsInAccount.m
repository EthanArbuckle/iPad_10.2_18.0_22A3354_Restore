...
{
  id v5;
  REMListsDataViewInvocation_dataAccessFetchListsInAccount *v6;
...
- (REMListsDataViewInvocation_dataAccessFetchListsInAccount)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    self = -[REMListsDataViewInvocation_dataAccessFetchListsInAccount initWithParentAccountObjectID:](self, "initWithParentAccountObjectID:", v5);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMListsDataViewInvocation_dataAccessFetchListsInAccount accountObjectID](self, "accountObjectID");
