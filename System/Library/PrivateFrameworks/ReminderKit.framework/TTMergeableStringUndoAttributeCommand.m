...
{
  TTMergeableStringUndoAttributeCommand *v2;
  _QWORD *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TTMergeableStringUndoAttributeCommand;
  v2 = -[TTMergeableStringUndoAttributeCommand init](&v5, sel_init);
  if (v2)
  {
...
- (void)dealloc
{
  ...
  if (attributeRanges)
  {
    ...
    MEMORY[0x1B5E3DB94](attributeRanges, 0x20C40960023A9);
  }
  v4.receiver = self;
  v4.super_class = (Class)TTMergeableStringUndoAttributeCommand;
  -[TTMergeableStringUndoAttributeCommand dealloc](&v4, sel_dealloc);
}
...
- (void)updateTopoIDRange:(TopoIDRange *)a3 toNewRangeID:(TopoIDRange *)a4
{
  ...
  int v14;
  void **v15;
  TTMergeableStringUndoAttributeCommand *v16;
  void **v17;
  int v18;
  int v19;
  id v20;
...
- (BOOL)addToGroup:(id)a3
{
  ...
  v4 = a3;
  v5 = -[TTMergeableStringUndoAttributeCommand attributeRanges](self, "attributeRanges");
  v6 = *v5;
  v7 = v5[1];
  if (*v5 == v7)
  {
...
- (NSString)description
{
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR("<TTMergeableStringUndoAttributeCommand %p "), self);
  attributeRanges = (uint64_t *)self->_attributeRanges;
  v5 = *attributeRanges;
