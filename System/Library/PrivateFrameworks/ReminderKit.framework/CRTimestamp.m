...
- (CRTimestamp)initWithCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 7)
  {
    self = -[CRTimestamp initWithProtobufTimestamp:decoder:](self, "initWithProtobufTimestamp:decoder:", *(_QWORD *)(v5 + 40), v4);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  -[CRTimestamp encodeIntoProtobufTimestamp:coder:](self, "encodeIntoProtobufTimestamp:coder:", v6, v7);
...
- (void)encodeIntoProtobufTimestamp:(void *)a3 coder:(id)a4
{
  ...
  v10 = a4;
  -[CRTimestamp replica](self, "replica");
  ...
  v9 = -[CRTimestamp counter](self, "counter");
  *((_DWORD *)a3 + 8) |= 2u;
  *((_QWORD *)a3 + 6) = v9;
...
- (CRTimestamp)initWithReplica:(id)a3 andCounter:(int64_t)a4
{
  ...
  v8 = -[CRTimestamp init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (void)mergeWith:(id)a3
{
  ...
  if (objc_msgSend(v5, "compare:", self) == 1)
  {
    ...
    -[CRTimestamp setReplica:](self, "setReplica:", v4);

    -[CRTimestamp setCounter:](self, "setCounter:", objc_msgSend(v5, "counter"));
  }
...
- (id)nextTimestampForReplica:(id)a3
{
  ...
  if (v6 == -1)
    v8 = -[CRTimestamp counter](self, "counter");
  else
    v8 = -[CRTimestamp counter](self, "counter") + 1;
  v9 = -[CRTimestamp initWithReplica:andCounter:](v7, "initWithReplica:andCounter:", v4, v8);
...
- (id)nextTimestamp
{
  ...
  -[CRTimestamp replica](self, "replica");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[CRTimestamp initWithReplica:andCounter:](v3, "initWithReplica:andCounter:", v4, -[CRTimestamp counter](self, "counter") + 1);
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = a3;
  objc_opt_class();
  v5 = (objc_opt_isKindOfClass() & 1) != 0 && -[CRTimestamp isEqualToTimestamp:](self, "isEqualToTimestamp:", v4);
...
- (BOOL)isEqualToTimestamp:(id)a3
{
  ...
  v4 = a3;
  v5 = -[CRTimestamp counter](self, "counter");
...
- (unint64_t)hash
{
  ...
  v5 = -[CRTimestamp counter](self, "counter") ^ v4;
...
- (id)earlierTimestamp:(id)a3
{
  ...
  v4 = (CRTimestamp *)a3;
  if (-[CRTimestamp compare:](self, "compare:", v4) == 1)
    v5 = v4;
  else
    v5 = self;
  v6 = v5;
...
- (NSString)description
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[CRTimestamp counter](self, "counter");
  -[CRTimestamp replica](self, "replica");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)shortDescription
{
  ...
  v3 = (void *)MEMORY[0x1E0CB3940];
  v4 = -[CRTimestamp counter](self, "counter");
  -[CRTimestamp replica](self, "replica");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
