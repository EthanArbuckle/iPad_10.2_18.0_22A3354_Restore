...
- (CRSet)init
{
  return -[CRSet initWithDocument:](self, "initWithDocument:", 0);
}
...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  -[CRSet dictionary](self, "dictionary");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "encodeWithCRCoder:dictionary:elementValueCoder:", v8, v6, &__block_literal_global_45);
...
- (void)encodeWithCRCoder:(id)a3 set:(void *)a4
{
  ...
  objc_msgSend(v6, "encodeWithCRCoder:dictionary:", v7, a4);
...
- (void)encodeWithCRCoder:(id)a3 set:(void *)a4 elementValueCoder:(id)a5
{
  ...
  v11 = v9;
  v13 = v11;
  objc_msgSend(v10, "encodeWithCRCoder:dictionary:elementValueCoder:", v8, a4, v12);
...
- (CRSet)initWithCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 4)
  {
    v6 = -[CRSet initWithCRCoder:set:](self, "initWithCRCoder:set:", v4, *(_QWORD *)(v5 + 40));
  }
  else
  {
    objc_msgSend(v4, "document");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = -[CRSet initWithDocument:](self, "initWithDocument:", v7);
...
- (CRSet)initWithCRCoder:(id)a3 set:(const void *)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = -[CRSet initWithDocument:](self, "initWithDocument:", v7);

  if (v8)
  {
    v9 = -[CRDictionary initWithCRCoder:dictionary:elementValueDecoder:]([CRDictionary alloc], "initWithCRCoder:dictionary:elementValueDecoder:", v6, a4, &__block_literal_global_63);
    -[CRSet setDictionary:](v8, "setDictionary:", v9);

  }
  return v8;
}

id __29__CRSet_initWithCRCoder_set___block_invoke(uint64_t a1, uint64_t a2, _QWORD *a3, void *a4)
{
...
- (CRSet)initWithCRCoder:(id)a3 set:(const void *)a4 elementValueDecoder:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = -[CRSet initWithDocument:](self, "initWithDocument:", v10);
  ...
  if (v11)
  {
    ...
    v15[3] = &unk_1E67FAC20;
    v16 = v9;
    v13 = -[CRDictionary initWithCRCoder:dictionary:elementValueDecoder:](v12, "initWithCRCoder:dictionary:elementValueDecoder:", v8, a4, v15);
    -[CRSet setDictionary:](v11, "setDictionary:", v13);

  }
  return v11;
}

id __49__CRSet_initWithCRCoder_set_elementValueDecoder___block_invoke(uint64_t a1, uint64_t a2, _QWORD *a3)
{
  id v4;
...
- (NSArray)allObjects
{
  ...
  objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithCapacity:", -[CRSet count](self, "count"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = 0u;
  v12 = 0u;
  v9 = 0u;
  v10 = 0u;
  -[CRSet dictionary](self, "dictionary", 0);
...
- (void)addObserver:(id)a3
{
  ...
  v5 = a3;
  -[CRSet observers](self, "observers");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)addObject:(id)a3
{
  ...
  v10 = 0u;
  v11 = 0u;
  -[CRSet observers](self, "observers", 0);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setObject:(id)a3
{
  ...
  v4 = a3;
  -[CRSet removeAllObjects](self, "removeAllObjects");
  if (v4)
    -[CRSet addObject:](self, "addObject:", v4);
...
- (id)deltaSince:(id)a3 in:(id)a4
{
  ...
  if (v9)
  {
    v10 = -[CRSet initWithDocument:]([CRSet alloc], "initWithDocument:", v7);
    -[CRSet setDictionary:](v10, "setDictionary:", v9);
  }
  else
  {
    v10 = 0;
