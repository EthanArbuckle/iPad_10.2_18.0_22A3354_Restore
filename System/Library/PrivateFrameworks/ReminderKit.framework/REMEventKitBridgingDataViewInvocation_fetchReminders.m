...
{
  id v5;
  REMEventKitBridgingDataViewInvocation_fetchReminders *v6;
...
- (REMEventKitBridgingDataViewInvocation_fetchReminders)initWithCoder:(id)a3
{
  ...
  void *v7;
  void *v8;
  REMEventKitBridgingDataViewInvocation_fetchReminders *v9;
  ...
  v9 = -[REMEventKitBridgingDataViewInvocation_fetchReminders initWithListIDs:](self, "initWithListIDs:", v8);
  return v9;
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMEventKitBridgingDataViewInvocation_fetchReminders listIDs](self, "listIDs");
