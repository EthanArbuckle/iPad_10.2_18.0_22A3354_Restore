...
{
  TTCRVectorTimestamp *v2;
  CRVectorTimestamp *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TTCRVectorTimestamp;
  v2 = -[TTVectorTimestamp init](&v5, sel_init);
  if (v2)
  {
    v3 = objc_alloc_init(CRVectorTimestamp);
    -[TTCRVectorTimestamp setCrTimestamp:](v2, "setCrTimestamp:", v3);
...
- (id)clockElementForUUID:(id)a3
{
  ...
  void *v5;
  void *v6;
  TTVectorTimestampElement *v7;

  v4 = a3;
  -[TTCRVectorTimestamp crTimestamp](self, "crTimestamp");
  ...
  if (v6)
  {
    ...
    -[TTVectorTimestampElement setClock:](v7, "setClock:", objc_msgSend(v6, "clock"));
    -[TTVectorTimestampElement setSubclock:](v7, "setSubclock:", objc_msgSend(v6, "subclock"));
  }
  else
  {
    v7 = 0;
...
- (unint64_t)clockForUUID:(id)a3
{
  ...
  -[TTCRVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", a3);
