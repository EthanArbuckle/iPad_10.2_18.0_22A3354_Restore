...
- (CRVectorTimestamp)init
{
  ...
  v2 = -[CRVectorTimestamp init](&v6, sel_init);
  if (v2)
  {
...
- (CRVectorTimestamp)initWithCRCoder:(id)a3
{
  id v4;
  uint64_t v5;
  CRVectorTimestamp *v6;
  CRVectorTimestamp *v7;

  v4 = a3;
  v5 = objc_msgSend(v4, "currentDocumentObjectForDecoding");
  if (*(_DWORD *)(v5 + 48) == 8)
    v6 = -[CRVectorTimestamp initWithProtobufTimestamp:decoder:](self, "initWithProtobufTimestamp:decoder:", *(_QWORD *)(v5 + 40), v4);
  else
    v6 = -[CRVectorTimestamp init](self, "init");
  v7 = v6;
...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  -[CRVectorTimestamp encodeIntoProtobufTimestamp:coder:](self, "encodeIntoProtobufTimestamp:coder:", v6, v7);
...
- (CRVectorTimestamp)initWithProtobufTimestamp:(const void *)a3 decoder:(id)a4
{
  ...
  uint64_t v11;
  void *v12;
  CRVectorTimestampElement *v13;
  CRVectorTimestampElement *v14;
  int v15;

  v6 = a4;
  v7 = -[CRVectorTimestamp init](self, "init");
  if (v7)
  {
    v8 = *((_DWORD *)a3 + 12);
    if (v8)
    {
      ...
      do
      {
        ...
        if ((*(_BYTE *)(*v10 + 32) & 1) != 0)
        {
          ...
          if ((v15 & 2) != 0)
          {
            -[CRVectorTimestampElement setClock:](v13, "setClock:", *(_QWORD *)(v11 + 48));
            v15 = *(_DWORD *)(v11 + 32);
          }
          if ((v15 & 4) != 0)
            -[CRVectorTimestampElement setSubclock:](v14, "setSubclock:", *(_QWORD *)(v11 + 56));
...
{
  CRVectorTimestamp *v4;

  v4 = objc_alloc_init(CRVectorTimestamp);
  -[CRVectorTimestamp mergeWith:](v4, "mergeWith:", self);
  return v4;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = a3;
  objc_opt_class();
  v5 = (objc_opt_isKindOfClass() & 1) != 0 && -[CRVectorTimestamp compare:](self, "compare:", v4) == 0;
...
- (id)timestampForReplica:(id)a3
{
  ...
  v4 = a3;
  v5 = -[CRTimestamp initWithReplica:andCounter:]([CRTimestamp alloc], "initWithReplica:andCounter:", v4, -[CRVectorTimestamp clockForUUID:](self, "clockForUUID:", v4));
...
{
  CRVectorTimestampElement *v6;
  id v7;

  v7 = a4;
  -[NSMutableDictionary objectForKeyedSubscript:](self->_clock, "objectForKeyedSubscript:");
  v6 = (CRVectorTimestampElement *)objc_claimAutoreleasedReturnValue();
  if (!v6)
    v6 = objc_alloc_init(CRVectorTimestampElement);
  -[CRVectorTimestampElement setClock:](v6, "setClock:", a3);
...
{
  CRVectorTimestampElement *v8;
  id v9;

  v9 = a5;
  v8 = objc_alloc_init(CRVectorTimestampElement);
  -[CRVectorTimestampElement setClock:](v8, "setClock:", a3);
  -[CRVectorTimestampElement setSubclock:](v8, "setSubclock:", a4);
...
- (void)maxClock:(unint64_t)a3 forUUID:(id)a4
{
  ...
  if (!v6)
    v6 = objc_alloc_init(CRVectorTimestampElement);
  v7 = -[CRVectorTimestampElement clock](v6, "clock");
  if (v7 <= a3)
    v8 = a3;
  else
    v8 = v7;
  -[CRVectorTimestampElement setClock:](v6, "setClock:", v8);
...
- (unint64_t)compare:(id)a3
{
  ...
  -[CRVectorTimestamp allUUIDs](self, "allUUIDs");
  ...
  while (2)
  {
    for (i = 0; i != v9; ++i)
    {
      ...
      -[CRVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", v14);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        -[CRVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", v9);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        -[CRVectorTimestamp setClock:subclock:forUUID:](self, "setClock:subclock:forUUID:", v13, v14, v9);
...
- (id)shortDescription
{
  ...
  if (-[CRVectorTimestamp count](self, "count"))
  {
    ...
    v12 = 0u;
    v13 = 0u;
    -[CRVectorTimestamp sortedUUIDs](self, "sortedUUIDs");
    ...
    if (v5)
    {
      ...
      do
      {
        for (i = 0; i != v5; ++i)
        {
          ...
          -[CRVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", v8);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[CRVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", v10);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
