...
- (void)addUndoCommand:(id)a3
{
  ...
  objc_msgSend(v6, "postNotificationName:object:", TTMergeableUndoStringDidAddUndoNotification, self);
...
- (void)deleteSubstrings:(void *)a3 withCharacterRanges:(void *)a4
{
  ...
  void *v9;
  int v10;
  TTMergeableStringUndoEditCommand *v11;
  uint64_t *v12;
  uint64_t *v13;
  uint64_t v14;
  uint64_t *v15;
  ...
  if (v7)
  {
    ...
    if (v10)
    {
      ...
      while (v12 != v13)
      {
        ...
        if (!*(_BYTE *)(*v12 + 44))
        {
          v15 = -[TTMergeableStringUndoEditCommand insertStrings](v11, "insertStrings");
      ...
      -[TTMergeableUndoString addUndoCommand:](self, "addUndoCommand:", v11);

    }
  }
  v21.receiver = self;
  v21.super_class = (Class)TTMergeableUndoString;
  -[TTMergeableString deleteSubstrings:withCharacterRanges:](&v21, sel_deleteSubstrings_withCharacterRanges_, a3, a4);
}
...
- (void)undeleteSubstrings:(void *)a3
{
  ...
  void *v7;
  int v8;
  TTMergeableStringUndoEditCommand *v9;
  uint64_t v10;
  uint64_t v11;
  uint64_t *v12;
  uint64_t *v13;
    ...
    if (v8)
    {
      ...
      while (v10 != v11)
      {
        ...
        *((_QWORD *)&v50 + 1) = *(id *)(v10 + 24);
        if (*((_QWORD *)&v50 + 1))
        {
          v12 = -[TTMergeableStringUndoEditCommand deleteRanges](v9, "deleteRanges");
          v13 = v12;
          v14 = v12[1];
          if (v14 >= v12[2])
          {
      ...
      v17 = -[TTMergeableStringUndoEditCommand deleteRanges](v9, "deleteRanges");
      if (v17[1] == *v17)
      {

        return;
      }
      -[TTMergeableUndoString addUndoCommand:](self, "addUndoCommand:", v9);
  ...
  if (*(_QWORD *)a3 != v41)
  {
    do
    {
      ...
      if (v22)
      {
        ...
        v45 = v21;
        if (self)
          -[TTMergeableString getSubstrings:forTopoIDRange:](self, "getSubstrings:forTopoIDRange:", &__p, &v43);
        else
  ...
  if (v33)
  {
    v34 = -[TTMergeableString orderedSubstrings](self, "orderedSubstrings");
    v35 = *v34;
    v36 = v34[1];
    if (*v34 != v36)
    {
...
- (TopoIDRange)insertAttributedString:(SEL)a3 after:(id)a4 before:(void *)a5
{
  ...
  void *v10;
  int v11;
  TTMergeableStringUndoEditCommand *v12;
  uint64_t *v13;
  uint64_t *v14;
  unint64_t v15;
  uint64_t v16;
  ...
  if (retstr->var1)
  {
    ...
    if (result)
    {
      ...
      if (v11)
      {
        ...
        v13 = -[TTMergeableStringUndoEditCommand deleteRanges](v12, "deleteRanges");
        v14 = v13;
        v15 = v13[1];
        if (v15 >= v13[2])
        {
        ...
        {
          *(_QWORD *)v15 = retstr->var0.var0;
          *(_DWORD *)(v15 + 8) = retstr->var0.var1;
          *(_DWORD *)(v15 + 16) = retstr->var1;
          v16 = v15 + 24;
        }
        v14[1] = v16;
        -[TTMergeableUndoString addUndoCommand:](self, "addUndoCommand:", v12);
