...
{
  id v5;
  REMListSectionsDataViewInvocation_fetchListSectionsInList *v6;
...
- (REMListSectionsDataViewInvocation_fetchListSectionsInList)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    self = -[REMListSectionsDataViewInvocation_fetchListSectionsInList initWithParentListObjectID:](self, "initWithParentListObjectID:", v5);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[REMListSectionsDataViewInvocation_fetchListSectionsInList listObjectID](self, "listObjectID");
