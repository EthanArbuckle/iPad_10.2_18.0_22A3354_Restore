...
- (id)description
{
  ...
  -[OTEscrowRecordMetadataPasscodeGeneration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[OTEscrowRecordMetadataPasscodeGeneration dictionaryRepresentation](self, "dictionaryRepresentation");
