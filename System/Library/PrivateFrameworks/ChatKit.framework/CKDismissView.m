...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  if (v8 == self)
  {
    ...
    v17 = 0u;
    v18 = 0u;
    -[CKDismissView passthroughViews](self, "passthroughViews", 0);
...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  -[CKDismissView touchesBegan:withEvent:](&v6, sel_touchesBegan_withEvent_, a3, a4);
  -[CKDismissView delegate](self, "delegate");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "dismissViewWasTapped:", self);

}

- (CKDismissViewDelegate)delegate
{
  return (CKDismissViewDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
