...
{
  id v5;
  CKMeCardSharingNicknameAvatarProvider *v6;
  ...
  v6 = -[CKMeCardSharingNicknameAvatarProvider init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (void)generateAvatarImageOfSize:(CGSize)a3 imageHandler:(id)a4
{
  ...
  -[CKMeCardSharingNicknameAvatarProvider imageData](self, "imageData");
