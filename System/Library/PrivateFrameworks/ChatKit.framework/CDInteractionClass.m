...
Class __get_CDInteractionClass_block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = result;
  ...
  get_CDInteractionClass_softClass = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24);
  return result;
}
...
void __get_CDInteractionClass_block_invoke_cold_1()
{
  ...
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", v1, CFSTR("CKSMSComposeViewServiceController.m"), 93, CFSTR("Unable to find class %s"), "_CDInteraction");
