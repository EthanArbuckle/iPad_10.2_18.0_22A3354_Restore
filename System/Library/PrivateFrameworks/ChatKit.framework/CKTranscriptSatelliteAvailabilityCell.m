...
- (void)configureForChatItem:(id)a3 context:(id)a4 animated:(BOOL)a5 animationDuration:(double)a6 animationCurve:(int64_t)a7
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    objc_msgSend(v12, "satelliteAvailabilityTitleLabelAttributedText");
    v14 = objc_claimAutoreleasedReturnValue();
    -[CKTranscriptSatelliteAvailabilityCell setSatelliteAvailabilityTitleLabelAttributedText:](self, "setSatelliteAvailabilityTitleLabelAttributedText:", v14);
  }
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      -[CKTranscriptSatelliteAvailabilityCell(CKChatItem) configureForChatItem:context:animated:animationDuration:animationCurve:].cold.1();
  }
...
{
  CKTranscriptSatelliteAvailabilityCell *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  if (v3)
  {
    objc_msgSend((id)objc_opt_class(), "satelliteAvailabilityTitleLabel");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    -[CKEditableCollectionViewCell contentView](v3, "contentView");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "addSubview:", v4);

    -[CKTranscriptSatelliteAvailabilityCell setSatelliteAvailabilityTitleLabel:](v3, "setSatelliteAvailabilityTitleLabel:", v4);
...
+ (id)reuseIdentifier
{
  return CFSTR("CKTranscriptSatelliteAvailabilityCell");
}
...
- (void)layoutSubviewsForAlignmentContents
{
  ...
  v8 = v7;
  v10 = v9;
  -[CKTranscriptSatelliteAvailabilityCell satelliteAvailabilityTitleLabel](self, "satelliteAvailabilityTitleLabel");
...
- (void)performInsertion:(id)a3
{
  ...
  -[CKTranscriptSatelliteAvailabilityCell _fadeInLabelAtStartTime:completion:](self, "_fadeInLabelAtStartTime:completion:", v4, v5 + v7);
LABEL_11:
...
- (void)setSatelliteAvailabilityTitleLabelAttributedText:(id)a3
{
  ...
  if (self->_satelliteAvailabilityTitleLabelAttributedText != v5)
  {
    ...
    -[CKTranscriptSatelliteAvailabilityCell _updateSatelliteAvailabilityTitleLabelAttributedTextAnimated:](self, "_updateSatelliteAvailabilityTitleLabelAttributedTextAnimated:", 0);
    v5 = v6;
  }
...
- (void)_fadeInLabelAtStartTime:(double)a3 completion:(id)a4
{
  ...
  -[CKTranscriptSatelliteAvailabilityCell animationWithKeyPath:beginTime:duration:fromValue:toValue:](self, "animationWithKeyPath:beginTime:duration:fromValue:toValue:", CFSTR("opacity"), &unk_1E28719F0, &unk_1E2871A00, v11 + a3, v7);
...
{
  objc_storeStrong((id *)&self->_satelliteAvailabilityTitleLabel, a3);
}
