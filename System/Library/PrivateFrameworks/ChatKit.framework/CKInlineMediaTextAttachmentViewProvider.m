...
{
  id v9;
  _TtC7ChatKit39CKInlineMediaTextAttachmentViewProvider *v10;
  double v11;
  double v12;
  double v13;
  double v14;
...
- (void)loadView
{
  -[NSTextAttachmentViewProvider setView:](self, sel_setView_, *(Class *)((char *)&self->super.super.isa+ OBJC_IVAR____TtC7ChatKit39CKInlineMediaTextAttachmentViewProvider_providedView));
}
...
- (_TtC7ChatKit39CKInlineMediaTextAttachmentViewProvider)initWithTextAttachment:(id)a3 parentView:(id)a4 textLayoutManager:(id)a5 location:(id)a6
{
  ...
  id v9;
  id v10;
  _TtC7ChatKit39CKInlineMediaTextAttachmentViewProvider *result;

  v8 = a3;
  v9 = a4;
  v10 = a5;
  swift_unknownObjectRetain();
  result = (_TtC7ChatKit39CKInlineMediaTextAttachmentViewProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
