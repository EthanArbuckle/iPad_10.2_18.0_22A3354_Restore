...
{
  CKTranscriptSatelliteSMSFallbackStatusCell *v3;
  void *v4;
  void *v5;
  objc_super v7;
  ...
  if (v3)
  {
    ...
    -[CKTranscriptSatelliteSMSFallbackStatusCell setSatelliteNoNotificationTitleLabel:](v3, "setSatelliteNoNotificationTitleLabel:", v4);
  }
  return v3;
}
...
- (void)layoutSubviewsForAlignmentContents
{
  ...
  v8 = v7;
  v10 = v9;
  -[CKTranscriptSatelliteSMSFallbackStatusCell satelliteNoNotificationTitleLabel](self, "satelliteNoNotificationTitleLabel");
...
- (void)performInsertion:(id)a3
{
  ...
  -[CKTranscriptSatelliteSMSFallbackStatusCell _fadeInLabelAtStartTime:completion:](self, "_fadeInLabelAtStartTime:completion:", v4, v5 + v7);
LABEL_11:
...
- (void)setSMSFallbackStatusTitleLabelAttributedText:(id)a3
{
  ...
  if (self->_SMSFallbackStatusTitleLabelAttributedText != v5)
  {
    ...
    -[CKTranscriptSatelliteSMSFallbackStatusCell _updateSMSFallbackStatusTitleLabelAttributedTextAnimated:](self, "_updateSMSFallbackStatusTitleLabelAttributedTextAnimated:", 0);
    v5 = v6;
  }
...
- (void)_fadeInLabelAtStartTime:(double)a3 completion:(id)a4
{
  ...
  -[CKTranscriptSatelliteSMSFallbackStatusCell animationWithKeyPath:beginTime:duration:fromValue:toValue:](self, "animationWithKeyPath:beginTime:duration:fromValue:toValue:", CFSTR("opacity"), &unk_1E2871190, &unk_1E28711A0, v11 + a3, v7);
...
- (void)configureForChatItem:(id)a3 context:(id)a4 animated:(BOOL)a5 animationDuration:(double)a6 animationCurve:(int64_t)a7
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    objc_msgSend(v12, "smsFallbackStatusTitleLabelAttributedText");
    v14 = objc_claimAutoreleasedReturnValue();
    -[CKTranscriptSatelliteSMSFallbackStatusCell setSMSFallbackStatusTitleLabelAttributedText:](self, "setSMSFallbackStatusTitleLabelAttributedText:", v14);
  }
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      -[CKTranscriptSatelliteSMSFallbackStatusCell(CKChatItem) configureForChatItem:context:animated:animationDuration:animationCurve:].cold.1();
  }
