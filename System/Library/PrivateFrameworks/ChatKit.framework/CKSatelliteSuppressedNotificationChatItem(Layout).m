...
- (void)layoutItemSpacingWithEnvironment:()Layout datasourceItemIndex:allDatasourceItems:supplementryItems:sizeOverride:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v5 = 138543362;
  v6 = v4;
  _os_log_error_impl(&dword_18DFCD000, a2, OS_LOG_TYPE_ERROR, "CKSatelliteSuppressedNotificationChatItem should not follow %{public}@", (uint8_t *)&v5, 0xCu);
...
- (void)layoutItemSpacingWithEnvironment:()Layout datasourceItemIndex:allDatasourceItems:supplementryItems:sizeOverride:.cold.2(os_log_t log)
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_18DFCD000, log, OS_LOG_TYPE_ERROR, "Satellite availability indicator should not follow satellite suppressed notification", v1, 2u);
}
