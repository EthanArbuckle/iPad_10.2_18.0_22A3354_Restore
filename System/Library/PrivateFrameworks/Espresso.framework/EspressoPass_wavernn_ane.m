...
- (BOOL)runOnNetwork:(void *)a3
{
  ...
  v4 = (unint64_t *)operator new(0x38uLL);
  v4[1] = 0;
  v5 = v4 + 1;
  v4[2] = 0;
  v4[3] = (unint64_t)&off_1E2D732C8;
  v6 = (Espresso::pass_wavernn_ane *)(v4 + 3);
  *v4 = (unint64_t)&off_1E2DB9BB8;
  v4[4] = 0;
  v4[5] = 0;
  v4[6] = 0x52000001C0;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315138;
    v17 = (unint64_t)"N8Espresso16pass_wavernn_aneE" & 0x7FFFFFFFFFFFFFFFLL;
    _os_log_debug_impl(&dword_190DAF000, v8, OS_LOG_TYPE_DEBUG, "run_pass_on_network %s", buf, 0xCu);
  }

  Espresso::pass_wavernn_ane::run_on_network(v6, (Espresso::net *)a3, (Espresso::pass_wavernn_ane *)buf);
  v15 = 0;
  (*(void (**)(Espresso::pass_wavernn_ane *, char *))(*(_QWORD *)v6 + 16))(v6, &v15);
  v9 = buf[0];
  if (v15)
  {
    if (buf[0])
