...
- (BOOL)runOnNetwork:(void *)a3
{
  unint64_t *v4;
  unint64_t *v5;
  Espresso::pass_lstm_atomizer *v6;
  const char *v7;
  NSObject *v8;
  int v9;
  ...
  v5 = v4 + 1;
  v4[2] = 0;
  *v4 = (unint64_t)&off_1E2DBBAC8;
  v4[3] = (unint64_t)&off_1E2D83DB0;
  v6 = (Espresso::pass_lstm_atomizer *)(v4 + 3);
  v4[4] = 0;
  v4[5] = 0;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315138;
    v17 = (unint64_t)"N8Espresso18pass_lstm_atomizerE" & 0x7FFFFFFFFFFFFFFFLL;
    _os_log_debug_impl(&dword_190DAF000, v8, OS_LOG_TYPE_DEBUG, "run_pass_on_network %s", buf, 0xCu);
  }

  Espresso::pass_lstm_atomizer::run_on_network(v6, (Espresso::net *)a3, (uint64_t)buf);
  v15 = 0;
  (*(void (**)(Espresso::pass_lstm_atomizer *, char *))(*(_QWORD *)v6 + 16))(v6, &v15);
  v9 = buf[0];
  if (v15)
  {
    if (buf[0])
