...
- (BOOL)runOnNetwork:(void *)a3
{
  ...
  v5 = v4 + 1;
  v4[2] = 0;
  *v4 = (unint64_t)&off_1E2DBEA08;
  v4[3] = (unint64_t)&off_1E2DA1050;
  v4[4] = 0;
  v4[5] = 0;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315138;
    v16 = (unint64_t)"N8Espresso43pass_style_transfer_parameterize_transplantE" & 0x7FFFFFFFFFFFFFFFLL;
    _os_log_debug_impl(&dword_190DAF000, v7, OS_LOG_TYPE_DEBUG, "run_pass_on_network %s", buf, 0xCu);
  }

  Espresso::pass_style_transfer_parameterize_transplant::run_on_network((Espresso::net *)a3, (uint64_t)buf);
  v14 = 0;
