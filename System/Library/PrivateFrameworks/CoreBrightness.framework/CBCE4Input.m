...
- (CBCE4Input)initWithInput:(id)a3
{
  ...
  v8 = -[CBCE4Input init](&v6, sel_init);
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E69175E8, a2, self);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if ((objc_msgSend(location[0], "isEqualToString:", CFSTR("input")) & 1) != 0)
  {
    ...
    v5 = -[CBCE4Input input](v7, "input");
    v8 = (id)objc_msgSend(MLFeatureValueClass_3, "featureValueWithMultiArray:");
