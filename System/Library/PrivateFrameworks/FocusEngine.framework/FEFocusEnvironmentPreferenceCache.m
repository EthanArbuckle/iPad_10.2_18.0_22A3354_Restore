...
_FEFocusEnvironmentPreferenceCacheNode *__78___FEFocusEnvironmentPreferenceCache_setPreferredEnvironments_forEnvironment___block_invoke(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  _FEFocusEnvironmentPreferenceCacheNode *v5;
  void *v6;
  ...
  else
  {
    ...
    v5 = (_FEFocusEnvironmentPreferenceCacheNode *)objc_claimAutoreleasedReturnValue();

    if (!v5)
    {
      v5 = -[_FEFocusEnvironmentPreferenceCacheNode initWithEnvironment:]([_FEFocusEnvironmentPreferenceCacheNode alloc], "initWithEnvironment:", v3);
      objc_msgSend(*(id *)(a1 + 40), "environmentsMap");
