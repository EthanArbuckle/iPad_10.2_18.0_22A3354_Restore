...
- (_FEWeakHelper)initWithDeallocationBlock:(id)a3
{
  ...
  v5 = -[_FEWeakHelper init](&v8, sel_init);
  v6 = v5;
  if (v5)
    -[_FEWeakHelper setDeallocationBlock:](v5, "setDeallocationBlock:", v4);
...
- (void)dealloc
{
  ...
  if (self->_deallocationBlock)
  {
    ...
    if (v3 == 1)
      ...
      dispatch_async(MEMORY[0x24BDAC9B8], deallocationBlock);
  }
  v5.receiver = self;
  v5.super_class = (Class)_FEWeakHelper;
  -[_FEWeakHelper dealloc](&v5, sel_dealloc);
}
