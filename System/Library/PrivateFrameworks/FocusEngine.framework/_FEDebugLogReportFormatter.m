...
- (id)_componentsFromReport:(id)a3
{
  ...
  -[_FEDebugReportComponents setBody:](v10, "setBody:", v8);
...
- (id)stringFromReport:(id)a3
{
  ...
  -[_FEDebugLogReportFormatter _componentsFromReport:](self, "_componentsFromReport:", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
