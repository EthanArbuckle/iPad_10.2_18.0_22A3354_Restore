...
{
  id v4;
  _FEFocusLinearMovementCache *v5;
  double v6;
  objc_super v8;
  ...
  v5 = -[_FEFocusLinearMovementCache init](&v8, sel_init);
  if (v5)
  {
...
- (void)_invalidateOnTimeout
{
  if (self->_cooldownThreshold <= 0.0)
    -[_FEFocusLinearMovementCache _invalidate](self, "_invalidate");
  else
...
LABEL_8:
  ...
  _FEFocusGetNextItemFromList(v7, v8, v10, objc_msgSend(v11, "_isLooping"));
...
- (void)environmentWillDisappear:(id)a3
{
  ...
  v4 = a3;
  -[_FEFocusLinearMovementCache _updateParentEnvironmentIfNecessary](self, "_updateParentEnvironmentIfNecessary");
...
- (void)environmentDidAppear:(id)a3
{
  ...
  {
    _FEFocusItemSafeCast(v4);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = v6;
    if (v6 && _FEFocusItemIsFocusedOrFocusable(v6))
    {
      -[_FEFocusLinearMovementCache _invalidateOnTimeout](self, "_invalidateOnTimeout");
LABEL_29:
    ...
    if (v8)
    {
      ...
      do
      {
        _FEFocusItemSafeCast(v9);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        v11 = v10;
        if (v10)
          IsFocusedOrFocusable = _FEFocusItemIsFocusedOrFocusable(v10);
        else
          IsFocusedOrFocusable = 0;
        objc_msgSend(v9, "_parentFocusEnvironment");
        ...
        if (v24)
        {
          ...
          while (2)
          {
            for (i = 0; i != v25; ++i)
            {
              ...
              v34.origin.x = _FEFocusItemFrameInCoordinateSpace(*(void **)(*((_QWORD *)&v28 + 1) + 8 * i), v14);
              v35.origin.x = v16;
              v35.origin.y = v18;
              v35.size.width = v20;
              v35.size.height = v22;
              if (CGRectContainsRect(v34, v35))
              {
                ...
                -[_FEFocusLinearMovementCache _invalidateOnTimeout](self, "_invalidateOnTimeout", (_QWORD)v28);
                goto LABEL_27;
              }
            }
