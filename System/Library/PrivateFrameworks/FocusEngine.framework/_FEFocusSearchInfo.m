...
+ (id)defaultInfo
{
  return -[_FEFocusSearchInfo initWithFocusEvaluator:]([_FEFocusSearchInfo alloc], "initWithFocusEvaluator:", 0);
}
...
- (_FEFocusSearchInfo)initWithFocusEvaluator:(id)a3
{
  ...
  _FEFocusSearchInfo *v6;
  objc_super v8;

  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)_FEFocusSearchInfo;
  v5 = -[_FEFocusSearchInfo init](&v8, sel_init);
  v6 = v5;
  if (v5)
  {
    v5->_treatFocusableItemAsLeaf = 1;
    -[_FEFocusSearchInfo setEvaluator:](v5, "setEvaluator:", v4);
  }
...
- (BOOL)shouldIncludeFocusItem:(id)a3
{
  ...
  v4 = a3;
  -[_FEFocusSearchInfo evaluator](self, "evaluator");
