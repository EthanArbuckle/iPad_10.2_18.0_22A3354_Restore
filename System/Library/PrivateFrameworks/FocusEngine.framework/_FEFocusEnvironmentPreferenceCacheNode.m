...
{
  id v5;
  _FEFocusEnvironmentPreferenceCacheNode *v6;
  _FEFocusEnvironmentPreferenceCacheNode *v7;
  uint64_t v8;
  ...
  v6 = -[_FEFocusEnvironmentPreferenceCacheNode init](&v11, sel_init);
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_environment, a3);
    objc_msgSend(MEMORY[0x24BDD15C0], "hashTableWithOptions:", 514);
...
- (void)_reevaluateResolution
{
  ...
  {
    -[_FEFocusEnvironmentPreferenceCacheNode childNodes](self, "childNodes");
          ...
          v6))
    {
      ...
      v15 = 0u;
      v16 = 0u;
      -[_FEFocusEnvironmentPreferenceCacheNode childNodes](self, "childNodes", 0);
      ...
      if (v8)
      {
        ...
        while (2)
        {
          for (i = 0; i != v9; ++i)
          {
            ...
            {
              -[_FEFocusEnvironmentPreferenceCacheNode _unresolve](self, "_unresolve");
              goto LABEL_18;
            }
...
LABEL_17:
      ...
      -[_FEFocusEnvironmentPreferenceCacheNode _resolve:explicitly:](self, "_resolve:explicitly:", v14, 0);
      v7 = v14;
LABEL_18:
...
- (void)resolve:(id)a3
{
  -[_FEFocusEnvironmentPreferenceCacheNode _resolve:explicitly:](self, "_resolve:explicitly:", a3, 1);
}
...
- (void)setChildNodes:(id)a3
{
  ...
  -[_FEFocusEnvironmentPreferenceCacheNode _reevaluateResolution](self, "_reevaluateResolution");
}
