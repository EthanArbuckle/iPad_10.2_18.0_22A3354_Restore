...
void ___FEFocusItemIsLegacyTransparentFocusRegionInSearchContext_block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
  void *v5;
  void *v6;
  ...
  _FEFocusItemSafeCast(a2);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
    v9 = v5;
    IsViewOrRespondsToSelector = _FEFocusItemIsViewOrRespondsToSelector(v5);
    v6 = v9;
