...
+ (id)subregionFromRegion:(id)a3 withSnapshotFrame:(CGRect)a4 inSnapshot:(id)a5
{
  ...
  if (!v12)
  {
    ...
    objc_msgSend(v18, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 22, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("region"));
...
LABEL_5:
    ...
    objc_msgSend(v19, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 23, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("snapshot"));
...
+ (CGRect)frameForRegion:(id)a3 inCoordinateSpace:(id)a4
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v27, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 32, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("region"));
...
LABEL_8:
    ...
    objc_msgSend(v28, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 33, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("coordinateSpace"));
...
+ (id)_visibleSubregionsWhenRegion:(id)a3 occludedByRegion:(id)a4 inSnapshot:(id)a5
{
  ...
  else
  {
    ...
    objc_msgSend(v58, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 50, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("occludedRegion"));
  ...
  objc_msgSend(v59, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 51, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("occludingRegion"));
...
LABEL_3:
  if (v9 == v10)
  {
    ...
    objc_msgSend(v60, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 52, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("occludedRegion != occludingRegion"));
  ...
  objc_msgSend(v61, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 53, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("snapshot"));
...
+ (id)__regionsByEvaluatingOcclusionsForBaseRegions:(id)a3 occludingRegions:(id)a4 baseRegionsCanOccludeEachOther:(BOOL)a5 inSnapshot:(id)a6
{
  ...
  if (!v11)
  {
    ...
    objc_msgSend(v46, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 147, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("occludingRegions"));
...
+ (id)regionsByEvaluatingOcclusionsForRegions:(id)a3 inSnapshot:(id)a4
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 214, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("regions"));
...
LABEL_5:
    ...
    objc_msgSend(v14, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 215, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("snapshot"));
...
LABEL_6:
    objc_msgSend(MEMORY[0x24BDD1448], "currentHandler");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 224, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("occludingRegions"));
...
LABEL_7:
    ...
    objc_msgSend(v17, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 225, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("snapshot"));

    goto LABEL_4;
  }
  objc_msgSend(MEMORY[0x24BDD1448], "currentHandler");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_FEFocusRegionEvaluator.m"), 223, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("regions"));
