...
- (id)description
{
  ...
  -[HKCodableDateInterval description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableDateInterval dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_startDate != *((double *)v4 + 2))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_endDate != *((double *)v4 + 1))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
