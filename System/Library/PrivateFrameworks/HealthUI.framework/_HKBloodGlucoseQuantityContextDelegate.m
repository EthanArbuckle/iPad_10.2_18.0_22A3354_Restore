...
- (_HKBloodGlucoseQuantityContextDelegate)initWithCustomDataSource:(id)a3 primaryDisplayType:(id)a4
{
  id v7;
  id v8;
  _HKBloodGlucoseQuantityContextDelegate *v9;
  _HKBloodGlucoseQuantityContextDelegate *v10;
  objc_super v12;
  ...
  v9 = -[_HKBloodGlucoseQuantityContextDelegate init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)formatterForTimescope:(int64_t)a3
{
  ...
  {
    v6 = v5;
    -[_HKBloodGlucoseQuantityContextDelegate _statItemForTimeScope:](self, "_statItemForTimeScope:", a3);
...
{
  if ((unint64_t)a3 > 8)
    return &unk_1E9CEAF40;
  else
    return (id)qword_1E9C40590[a3];
}
