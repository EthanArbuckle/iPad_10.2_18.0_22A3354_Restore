...
- (id)description
{
  ...
  -[HKCodableSleepPeriod description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableSleepPeriod dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_segments, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("segment"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[HKCodableSleepPeriod segmentsCount](self, "segmentsCount"))
  {
    objc_msgSend(v8, "clearSegments");
    v4 = -[HKCodableSleepPeriod segmentsCount](self, "segmentsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HKCodableSleepPeriod segmentAtIndex:](self, "segmentAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addSegment:", v7);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addSegment:", v13);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[HKCodableDateInterval isEqual:](dateInterval, "isEqual:")))
  {
    ...
    if ((unint64_t)segments | v4[2])
      v7 = -[NSMutableArray isEqual:](segments, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_segments, "hash") ^ v3;
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[HKCodableSleepPeriod addSegment:](self, "addSegment:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
