...
- (id)description
{
  ...
  -[HKCodableChartHandwashingEventDataSourceData description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableChartHandwashingEventDataSourceData dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HKCodableChartHandwashingEventDataSourceData eventsCount](self, "eventsCount"))
  {
    objc_msgSend(v8, "clearEvents");
    v4 = -[HKCodableChartHandwashingEventDataSourceData eventsCount](self, "eventsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HKCodableChartHandwashingEventDataSourceData eventsAtIndex:](self, "eventsAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HKCodableChartHandwashingEventDataSourceData addEvents:](self, "addEvents:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
