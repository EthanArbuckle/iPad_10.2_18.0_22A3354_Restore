...
- (NSString)description
{
  ...
  -[HKHorizontalSingleLineChartPoint description](&v7, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("%@ { %@ %@ %d}"), v4, self->_xValue, self->_yValue, self->_groupToPrevious);
...
{
  objc_storeStrong((id *)&self->_xValue, a3);
}
