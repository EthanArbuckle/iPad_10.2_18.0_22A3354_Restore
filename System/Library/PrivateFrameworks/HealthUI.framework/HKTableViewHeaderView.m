...
- (HKTableViewHeaderView)init
{
  ...
  v2 = -[HKTableViewHeaderView init](&v7, sel_init);
  if (v2)
  {
    ...
    -[HKTableViewHeaderView updateFont](v2, "updateFont");
    -[HKTableViewHeaderView addSubview:](v2, "addSubview:", v2->_label);
  }
  return v2;
}
...
- (void)setContentInsets:(UIEdgeInsets)a3
{
  ...
  -[HKTableViewHeaderView setNeedsLayout](self, "setNeedsLayout");
}
...
- (void)layoutSubviews
{
  ...
  -[HKTableViewHeaderView bounds](self, "bounds");
