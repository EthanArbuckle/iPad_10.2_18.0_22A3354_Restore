...
- (id)description
{
  ...
  -[HKCodableHealthRecordsEduContent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableHealthRecordsEduContent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HKCodableHealthRecordsEduContent sectionsCount](self, "sectionsCount"))
  {
    objc_msgSend(v8, "clearSections");
    v4 = -[HKCodableHealthRecordsEduContent sectionsCount](self, "sectionsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HKCodableHealthRecordsEduContent sectionsAtIndex:](self, "sectionsAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HKCodableHealthRecordsEduContent addSections:](self, "addSections:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
