...
- (id)sortDateTitle
{
  ...
  if (v4)
  {
    ...
    v6 = v5;
    v7 = CFSTR("MEDICATION_ORDER_SORT_DATE_TITLE_MODIFIED_DATE");
  }
  else
  {
    objc_msgSend(a1, "sortDate");
    ...
    v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0CB5420]);
    ...
    if (v10)
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v6 = v5;
      v7 = CFSTR("MEDICATION_ORDER_SORT_DATE_TITLE_EARLIEST_DOSAGE_DATE");
    }
    else
    {
      objc_msgSend(a1, "sortDate");
      ...
      v13 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CB5430]);
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v6 = v5;
      v7 = CFSTR("MEDICATION_ORDER_SORT_DATE_TITLE_WRITTEN_DATE");
    }
  }
