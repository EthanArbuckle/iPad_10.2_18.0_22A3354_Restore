...
- (id)sortDateTitle
{
  ...
  if (v4)
  {
    ...
    v6 = v5;
    v7 = CFSTR("CONDITION_RECORD_SORT_DATE_TITLE_MODIFIED_DATE");
  }
  else
  {
    objc_msgSend(a1, "sortDate");
    ...
    v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0CB4A68]);
    ...
    if (v10)
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v6 = v5;
      v7 = CFSTR("CONDITION_RECORD_SORT_DATE_TITLE_ONSET");
    }
    else
    {
      objc_msgSend(a1, "sortDate");
      ...
      v13 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CB4A70]);
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v6 = v5;
      v7 = CFSTR("CONDITION_RECORD_SORT_DATE_TITLE_RECORDED_DATE");
    }
  }
