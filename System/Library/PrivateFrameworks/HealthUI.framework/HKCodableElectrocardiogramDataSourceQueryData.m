...
- (id)description
{
  ...
  -[HKCodableElectrocardiogramDataSourceQueryData description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableElectrocardiogramDataSourceQueryData dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_samples, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("samples"));
  }
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_activeAlgorithmVersionRawValue);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v12, CFSTR("activeAlgorithmVersionRawValue"));
...
- (void)copyTo:(id)a3
{
  ...
  v9 = v4;
  if (-[HKCodableElectrocardiogramDataSourceQueryData samplesCount](self, "samplesCount"))
  {
    objc_msgSend(v9, "clearSamples");
    v5 = -[HKCodableElectrocardiogramDataSourceQueryData samplesCount](self, "samplesCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[HKCodableElectrocardiogramDataSourceQueryData samplesAtIndex:](self, "samplesAtIndex:", i);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "addSamples:", v8);
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)v9 + 1) = self->_activeAlgorithmVersionRawValue;
    *((_BYTE *)v9 + 32) |= 1u;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend((id)v6, "addSamples:", v12);
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *(_QWORD *)(v6 + 8) = self->_activeAlgorithmVersionRawValue;
    *(_BYTE *)(v6 + 32) |= 1u;
  }
  return (id)v6;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 2) == 0 || self->_count != *((_QWORD *)v4 + 2))
      goto LABEL_14;
  }
  ...
  samples = self->_samples;
  if ((unint64_t)samples | *((_QWORD *)v4 + 3))
  {
...
LABEL_14:
  ...
  if ((has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_activeAlgorithmVersionRawValue != *((_QWORD *)v4 + 1))
      goto LABEL_14;
    v7 = 1;
  }
LABEL_15:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
    ...
    v3 = 0;
  v4 = -[NSMutableArray hash](self->_samples, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        -[HKCodableElectrocardiogramDataSourceQueryData addSamples:](self, "addSamples:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
