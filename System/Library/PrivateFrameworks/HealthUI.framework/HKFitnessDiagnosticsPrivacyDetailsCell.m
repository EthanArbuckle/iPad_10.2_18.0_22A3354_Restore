...
{
  HKFitnessDiagnosticsPrivacyDetailsCell *v4;
  HKFitnessDiagnosticsPrivacyDetailsCell *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)HKFitnessDiagnosticsPrivacyDetailsCell;
  v4 = -[HKFitnessDiagnosticsPrivacyDetailsCell initWithStyle:reuseIdentifier:](&v7, sel_initWithStyle_reuseIdentifier_, a3, a4);
  v5 = v4;
  if (v4)
  {
    -[HKFitnessDiagnosticsPrivacyDetailsCell setPreservesSuperviewLayoutMargins:](v4, "setPreservesSuperviewLayoutMargins:", 1);
    -[HKFitnessDiagnosticsPrivacyDetailsCell setSelectionStyle:](v5, "setSelectionStyle:", 0);
    -[HKFitnessDiagnosticsPrivacyDetailsCell _setUpSubviews](v5, "_setUpSubviews");
    -[HKFitnessDiagnosticsPrivacyDetailsCell _setUpConstraints](v5, "_setUpConstraints");
    -[HKFitnessDiagnosticsPrivacyDetailsCell _updateForCurrentContentSizeCategory](v5, "_updateForCurrentContentSizeCategory");
  }
  return v5;
}
...
- (void)_setUpSubviews
{
  _HKFitnessDiagnosticsPrivacyBulletedListLayoutManager *v3;
  _HKFitnessDiagnosticsPrivacyBulletedListLayoutManager *bulletLayoutManager;
  _HKFitnessDiagnosticsPrivacyBulletedListLayoutManager *v5;
  UITextView *v6;
  UITextView *contentsTextView;
  id v8;

  -[HKFitnessDiagnosticsPrivacyDetailsCell contentView](self, "contentView");
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _createContentsTextViewWithLayoutManager:](self, "_createContentsTextViewWithLayoutManager:", v5);
...
- (void)_setUpConstraints
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell contentsTextView](self, "contentsTextView");
...
- (id)_attributedContentsTextViewStringForCurrentContentSizeCategory
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _attributedTitleString](self, "_attributedTitleString");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithAttributedString:", v4);

  v6 = -[HKFitnessDiagnosticsPrivacyDetailsCell _newLineAttributedString](self, "_newLineAttributedString");
  objc_msgSend(v5, "appendAttributedString:", v6);

  for (i = 0; i != 7; ++i)
  {
    -[HKFitnessDiagnosticsPrivacyDetailsCell _attributedStringForBulletAtIndex:](self, "_attributedStringForBulletAtIndex:", i);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "appendAttributedString:", v8);

    v9 = -[HKFitnessDiagnosticsPrivacyDetailsCell _newLineAttributedString](self, "_newLineAttributedString");
...
- (id)_localizedTitleString
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("DATA_COLLECTION_BODY_TITLE"), &stru_1E9C4C428, CFSTR("HealthUI-Localizable"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_attributedTitleString
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _bodyEmph](self, "_bodyEmph");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = v3;
  v10[1] = *MEMORY[0x1E0DC1178];
  -[HKFitnessDiagnosticsPrivacyDetailsCell _titleParagraphStyle](self, "_titleParagraphStyle");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v11[1] = v4;
  v10[2] = *MEMORY[0x1E0DC1140];
  objc_msgSend(MEMORY[0x1E0DC3658], "labelColor");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v11[2] = v5;
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _localizedTitleString](self, "_localizedTitleString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_titleParagraphStyle
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _bulletContentFont](self, "_bulletContentFont");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_localizedBulletContentStringForBulletAtIndex:(int64_t)a3
{
  ...
  if ((unint64_t)a3 >= 7)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("HKFitnessDiagnosticsPrivacyDetailsCell.m"), 153, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("index >= 0 && index < _BulletCount"));

  }
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("DATA_COLLECTION_BODY_BULLET_%ld"), a3 + 1);
  objc_msgSend(MEMORY[0x1E0CB34D0], "bundleWithIdentifier:", CFSTR("com.apple.HealthUI"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_attributedStringForBulletAtIndex:(int64_t)a3
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _bulletContentParagraphStyle](self, "_bulletContentParagraphStyle");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v14[2] = v7;
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _localizedBulletContentStringForBulletAtIndex:](self, "_localizedBulletContentStringForBulletAtIndex:", a3);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_bulletContentParagraphStyle
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _bulletContentFont](self, "_bulletContentFont");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKFitnessDiagnosticsPrivacyDetailsCell _attributedStringForBullet](self, "_attributedStringForBullet");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_attributedStringForBullet
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell _bulletFont](self, "_bulletFont");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v8[0] = v2;
...
- (void)_updateForCurrentContentSizeCategory
{
  ...
  v5 = v4;
  -[HKFitnessDiagnosticsPrivacyDetailsCell superviewTopToContentsTextViewFirstBaselineConstraint](self, "superviewTopToContentsTextViewFirstBaselineConstraint");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v9 = v8;
  -[HKFitnessDiagnosticsPrivacyDetailsCell contentsTextViewLastBaselineToSuperviewBottomConstraint](self, "contentsTextViewLastBaselineToSuperviewBottomConstraint");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "setConstant:", v9);

  -[HKFitnessDiagnosticsPrivacyDetailsCell _attributedStringForBullet](self, "_attributedStringForBullet");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKFitnessDiagnosticsPrivacyDetailsCell bulletLayoutManager](self, "bulletLayoutManager");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "setBullet:", v11);

  -[HKFitnessDiagnosticsPrivacyDetailsCell _attributedContentsTextViewStringForCurrentContentSizeCategory](self, "_attributedContentsTextViewStringForCurrentContentSizeCategory");
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  -[HKFitnessDiagnosticsPrivacyDetailsCell traitCollectionDidChange:](&v9, sel_traitCollectionDidChange_, v4);
  if (v4)
  {
    -[HKFitnessDiagnosticsPrivacyDetailsCell traitCollection](self, "traitCollection");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if ((v8 & 1) == 0)
      -[HKFitnessDiagnosticsPrivacyDetailsCell _updateForCurrentContentSizeCategory](self, "_updateForCurrentContentSizeCategory");
  }
