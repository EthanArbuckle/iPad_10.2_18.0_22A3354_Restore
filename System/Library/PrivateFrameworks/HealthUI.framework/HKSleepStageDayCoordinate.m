...
{
  id v11;
  HKSleepStageDayCoordinate *v12;
  HKSleepStageDayCoordinate *v13;
  objc_super v15;

  v11 = a6;
  v15.receiver = self;
  v15.super_class = (Class)HKSleepStageDayCoordinate;
  v12 = -[HKSleepStageDayCoordinate init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
    v12->_xValueStart = a3;
...
- (id)copyWithTransform:(CGAffineTransform *)a3 roundToViewScale:(BOOL)a4
{
  ...
  return -[HKSleepStageDayCoordinate initWithXValueStart:xValueEnd:sleepStage:userInfo:]([HKSleepStageDayCoordinate alloc], "initWithXValueStart:xValueEnd:sleepStage:userInfo:", self->_sleepStage, self->_userInfo, v9, v10);
}
