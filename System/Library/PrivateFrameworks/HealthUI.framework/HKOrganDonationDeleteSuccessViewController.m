...
- (void)viewDidLoad
{
  ...
  -[HKOrganDonationDeleteSuccessViewController navigationItem](self, "navigationItem");
...
- (id)titleString
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("OD_DELETE_SUCCESS_TITLE"), &stru_1E9C4C428, CFSTR("HealthUI-Localizable"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)bodyString
{
  ...
  objc_msgSend(MEMORY[0x1E0CB34D0], "bundleWithIdentifier:", CFSTR("com.apple.HealthUI"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("OD_DELETE_SUCCESS_BODY"), &stru_1E9C4C428, CFSTR("HealthUI-Localizable"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)buttonAtIndexTapped:(int64_t)a3
{
  ...
  {
    -[HKOrganDonationDeleteSuccessViewController navigationController](self, "navigationController");
    v5 = (void (**)(id, _QWORD))objc_claimAutoreleasedReturnValue();
