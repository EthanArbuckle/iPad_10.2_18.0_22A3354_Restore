...
- (id)sortDateTitle
{
  ...
  if (v4)
  {
    ...
    v6 = v5;
    v7 = CFSTR("COVERAGE_RECORD_SORT_DATE_TITLE_MODIFIED_DATE");
  }
  else
  {
    objc_msgSend(a1, "sortDate");
    ...
    v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0CB4AF0]);
    ...
    if (v10)
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v6 = v5;
      v7 = CFSTR("COVERAGE_RECORD_SORT_DATE_TITLE_PERIOD_START_DATE");
    }
    else
    {
      objc_msgSend(a1, "sortDate");
      ...
      v13 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CB4AE8]);
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v6 = v5;
      v7 = CFSTR("COVERAGE_RECORD_SORT_DATE_TITLE_PERIOD_END_DATE");
    }
  }
