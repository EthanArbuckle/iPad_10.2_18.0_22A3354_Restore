...
- (id)description
{
  ...
  -[HKCodableSummaryCorrelatedTrendResults description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableSummaryCorrelatedTrendResults dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v9 = a3;
  if (-[HKCodableSummaryCorrelatedTrendResults trendValuesCount](self, "trendValuesCount"))
  {
    objc_msgSend(v9, "clearTrendValues");
    v4 = -[HKCodableSummaryCorrelatedTrendResults trendValuesCount](self, "trendValuesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HKCodableSummaryCorrelatedTrendResults trendValuesAtIndex:](self, "trendValuesAtIndex:", i);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v12 != v8)
          objc_enumerationMutation(v5);
        -[HKCodableSummaryCorrelatedTrendResults addTrendValues:](self, "addTrendValues:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * i), (_QWORD)v11);
      }
