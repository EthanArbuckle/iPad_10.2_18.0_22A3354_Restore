...
- (id)title
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("height"), &stru_1E9C4C428, CFSTR("HealthUI-Localizable"));
...
{
  -[HKMedicalIDEditorHeightCell _localeDidChange:](self->_editableCell, "_localeDidChange:", a3);
}

- (id)_createEditableCell
{
  HKMedicalIDEditorHeightCell *v3;
  void *v4;

  v3 = -[HKMedicalIDEditorHeightCell initWithStyle:reuseIdentifier:]([HKMedicalIDEditorHeightCell alloc], "initWithStyle:reuseIdentifier:", 0, CFSTR("kHeightTableItemCellIdentifier"));
  -[HKEmergencyCardHeightTableItem title](self, "title");
...
- (id)tableView:(id)a3 cellForRowAtIndex:(int64_t)a4
{
  ...
  double v13;
  void *v14;
  HKMedicalIDEditorHeightCell *v15;
  void *editableCell;
  void *v17;
  void *v18;
  void *v19;
  ...
  if (-[HKEmergencyCardTableItem isInEditMode](self, "isInEditMode"))
  {
    ...
    if (v7)
    {
      objc_msgSend(v5, "dequeueReusableCellWithIdentifier:", CFSTR("kHeightTableItemCellIdentifier"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      if (!v8)
      {
        -[HKEmergencyCardHeightTableItem _createEditableCell](self, "_createEditableCell");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
      }
      -[HKEmergencyCardTableItem data](self, "data");
      ...
      objc_msgSend(v8, "setCentimeterValue:", v14);
    ...
    else
    {
      ...
      objc_msgSend(editableCell, "localizedStringForKey:value:table:", CFSTR("add_height"), &stru_1E9C4C428, CFSTR("HealthUI-Localizable"));
      ...
      v15 = (HKMedicalIDEditorHeightCell *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[HKMedicalIDEditorHeightCell titleLabel](v15, "titleLabel");
    ...
    objc_msgSend(v21, "doubleValueForUnit:", editableCell);
    v23 = v22;
    ...
    objc_msgSend(v24, "localizedStringFromHeightInCentimeters:", v25);
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    -[HKMedicalIDEditorHeightCell detailLabel](v15, "detailLabel");
...
- (BOOL)shouldHighlightRowAtIndex:(int64_t)a3
{
  if (-[HKEmergencyCardTableItem isInEditMode](self, "isInEditMode", a3))
    -[HKMedicalIDEditorHeightCell beginEditing](self->_editableCell, "beginEditing");
  return 0;
}
...
- (void)medicalIDEditorCellDidChangeValue:(id)a3
{
  ...
  -[HKMedicalIDEditorHeightCell centimeterValue](self->_editableCell, "centimeterValue", a3);
...
- (int64_t)commitEditingStyle:(int64_t)a3 forRowAtIndex:(int64_t)a4
{
  ...
  if (a3 == 1)
  {
    ...
    objc_msgSend(v5, "setHeight:", 0);
  }
  else
  {
    objc_msgSend(MEMORY[0x1E0CB6CD0], "meterUnitWithMetricPrefix:", 5, a4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  if (a3 == 2)
    -[HKMedicalIDEditorHeightCell beginEditing](self->_editableCell, "beginEditing", 2, a4);
}

- (void)commitEditing
{
  -[HKMedicalIDEditorHeightCell commitEditing](self->_editableCell, "commitEditing");
}
