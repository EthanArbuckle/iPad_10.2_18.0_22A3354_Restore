...
- (id)description
{
  ...
  -[HKCodableSummaryGAD7AssessmentValue description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableSummaryGAD7AssessmentValue dictionaryRepresentation](self, "dictionaryRepresentation");
