...
void __39__AVURLAsset_HKAdditions__hk_assetSize__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_0_4(&dword_1D7813000, v0, v1, "[%{public}@ Failed to asynchronously get asset size for HealthKit with error: %@");
}
...
void __44__AVURLAsset_HKAdditions__hk_thumbnailImage__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1_10();
  OUTLINED_FUNCTION_0_4(&dword_1D7813000, v0, v1, "[%{public}@ Failed to asynchronously generate CG image for HealthKit with error: %@");
}
