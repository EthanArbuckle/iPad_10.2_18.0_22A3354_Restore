...
{
  _TtC9CoreIDVUI56IdentityProofingWatchPendingLivenessStepUpViewController *result;

  result = (_TtC9CoreIDVUI56IdentityProofingWatchPendingLivenessStepUpViewController *)sub_213FF9878();
  __break(1u);
  return result;
}
...
- (void)viewDidLoad
{
  ...
  v2 = v3.receiver;
  -[IdentityProofingWatchPendingStateBaseViewController viewDidLoad](&v3, sel_viewDidLoad);
  sub_213F456B4();
...
{
  id v5;
  _TtC9CoreIDVUI56IdentityProofingWatchPendingLivenessStepUpViewController *v6;

  v5 = a3;
  v6 = self;
  sub_213F4546C((uint64_t)a3);
