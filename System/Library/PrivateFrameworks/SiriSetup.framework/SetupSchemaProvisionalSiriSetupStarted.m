...
- (void)deleteExists
{
  -[SetupSchemaProvisionalSiriSetupStarted setExists:](self, "setExists:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[SetupSchemaProvisionalSiriSetupStarted exists](self, "exists"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("exists"));

  }
  -[SetupSchemaProvisionalSiriSetupStarted willProduceDictionaryRepresentation:](self, "willProduceDictionaryRepresentation:", v3);
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[SetupSchemaProvisionalSiriSetupStarted dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SetupSchemaProvisionalSiriSetupStarted *v5;
  uint64_t v7;
  ...
  {
    self = -[SetupSchemaProvisionalSiriSetupStarted initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SetupSchemaProvisionalSiriSetupStarted)initWithDictionary:(id)a3
{
  ...
  v5 = -[SetupSchemaProvisionalSiriSetupStarted init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SetupSchemaProvisionalSiriSetupStarted setExists:](v5, "setExists:", objc_msgSend(v6, "BOOLValue"));
    v7 = v5;
