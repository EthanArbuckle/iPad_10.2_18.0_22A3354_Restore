...
LABEL_10:
  ...
  v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D00270]), "initWithDuration:", v4);
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D00268]), "initWithRawState:data:", v7, v16);
...
+ (unint64_t)armingMethodFromRatchetResult:(id)a3
{
  ...
  v3 = a3;
  objc_opt_class();
  objc_msgSend(v3, "objectForKeyedSubscript:", &unk_1E769A950);
  ...
  objc_opt_class();
  objc_msgSend(v3, "objectForKeyedSubscript:", &unk_1E769A968);
...
+ (id)resultForSuccessfulArmingFromResponse:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "objectForKeyedSubscript:", &unk_1E769A980);
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D001A8]), "initWithRatchetState:armingMethod:", v7, v6);
...
+ (id)resultForNonArmingFromError:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0CC1290]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D001A8]), "initWithRatchetState:armingMethod:", v7, 1);
...
+ (void)setRatchetIdentifier:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  v3 = 1024;
  v4 = 107;
  _os_log_debug_impl(&dword_1BD795000, log, OS_LOG_TYPE_DEBUG, "%s (%d) called", (uint8_t *)&v1, 0x12u);
  OUTLINED_FUNCTION_5();
}
...
+ (void)resultForSuccessfulArmingFromResponse:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_1BD795000, a2, OS_LOG_TYPE_DEBUG, "Ratchet is armed with state: %@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_5();
}
...
+ (void)resultForNonArmingFromError:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_debug_impl(&dword_1BD795000, log, OS_LOG_TYPE_DEBUG, "User selected Quick Exit, calling exit(0) on purpose", v1, 2u);
}
...
+ (void)resultForNonArmingFromError:(os_log_t)log .cold.2(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_debug_impl(&dword_1BD795000, log, OS_LOG_TYPE_DEBUG, "Ratchet is not armed - error: %@, ratchet state: %@", (uint8_t *)&v3, 0x16u);
  OUTLINED_FUNCTION_5();
}
