...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.springboard.focus-modes-home-screen-settings-service");
}
...
+ (BSServiceInterface)interface
{
  ...
  return (BSServiceInterface *)(id)interface___interface_7;
}
...
void __73__SBSFocusModesHomeScreenSettingsServiceInterfaceSpecification_interface__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE149E20);
