...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.springboard.capture-intent");
}
...
void __49__SBSCaptureIntentServiceSpecification_interface__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE149B80);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "setServer:", v3);

  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE149BE0);
