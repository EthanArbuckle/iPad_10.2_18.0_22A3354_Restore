...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.springboard.widget-metrics-service");
}
...
+ (BSServiceInterface)interface
{
  ...
  return (BSServiceInterface *)(id)interface___interface_10;
}
...
void __58__SBSWidgetMetricsServiceInterfaceSpecification_interface__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE149F40);
