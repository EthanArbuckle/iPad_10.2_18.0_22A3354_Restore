...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.springboard.in-call-presentation-service");
}
...
void __63__SBSInCallPresentationServiceInterfaceSpecification_interface__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE149AC0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE149B20);
