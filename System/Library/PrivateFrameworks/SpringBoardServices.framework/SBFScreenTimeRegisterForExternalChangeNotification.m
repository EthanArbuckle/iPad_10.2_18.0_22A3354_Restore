...
void ___SBFScreenTimeRegisterForExternalChangeNotification_block_invoke_2(int a1, int token)
{
  ...
  v6 = CFSTR("SBScreenTimeCategory");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", v5);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v7[0] = v3;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v7, &v6, 1);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "postNotificationName:object:userInfo:", CFSTR("SBScreenTimeTrackingChanged"), 0, v4);

}

uint64_t ___SBFScreenTimeRegisterForExternalChangeNotification_block_invoke()
{
  return notify_register_dispatch("com.apple.springboard.screenchanged", &_SBFScreenTimeRegisterForExternalChangeNotification___token, MEMORY[0x1E0C80D38], &__block_literal_global_5);
}
