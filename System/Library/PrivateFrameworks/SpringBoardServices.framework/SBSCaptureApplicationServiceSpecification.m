...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.springboard.capture-application");
}
...
+ (BSServiceInterface)interface
{
  ...
  return (BSServiceInterface *)(id)interface___interface_14;
}
...
void __54__SBSCaptureApplicationServiceSpecification_interface__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE14A120);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "setServer:", v3);

  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EE14A180);
