...
void __46__SBSCaptureApplicationService_sharedInstance__block_invoke()
{
  SBSCaptureApplicationService *v0;
  void *v1;
...
{
  SBSCaptureApplicationService *v2;
  SBSCaptureApplicationService *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  _QWORD v12[4];
  SBSCaptureApplicationService *v13;
  objc_super v14;

  v14.receiver = self;
  v14.super_class = (Class)SBSCaptureApplicationService;
  v2 = -[SBSCaptureApplicationService init](&v14, sel_init);
  v3 = v2;
  if (v2)
  {
    ...
    +[SBSCaptureApplicationServiceSpecification identifier](SBSCaptureApplicationServiceSpecification, "identifier");
...
void __36__SBSCaptureApplicationService_init__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  +[SBSCaptureApplicationServiceSpecification interface](SBSCaptureApplicationServiceSpecification, "interface");
  ...
  v6[1] = 3221225472;
  v6[2] = __36__SBSCaptureApplicationService_init__block_invoke_7;
  v6[3] = &unk_1E288CF08;
...
void __36__SBSCaptureApplicationService_init__block_invoke_2()
{
  ...
  {
    *(_WORD *)v1 = 0;
    _os_log_impl(&dword_18EB52000, v0, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: interrupted", v1, 2u);
  }

}

void __36__SBSCaptureApplicationService_init__block_invoke_7(uint64_t a1)
{
  id WeakRetained;
  NSObject *v2;
  void *v3;
  ...
  {
    *(_WORD *)v4 = 0;
    _os_log_impl(&dword_18EB52000, v2, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: remotely invalidated", v4, 2u);
  }
...
- (void)dealloc
{
  ...
  v13 = a2;
  v14 = 2114;
  v15 = CFSTR("SBSCaptureApplicationService.m");
  v16 = 1024;
  v17 = 67;
  v18 = 2114;
  v19 = a3;
...
- (void)applicationDidCompleteTransition
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl(&dword_18EB52000, v4, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: Sending applicationDidCompleteTransition signal", v6, 2u);
  }

  -[BSServiceConnection remoteTarget](self->_lock_connection, "remoteTarget");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "applicationDidCompleteTransition");
