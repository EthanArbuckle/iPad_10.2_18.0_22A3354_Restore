void sub_20D88BEC4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, id location)
{
  id *v15;
...
id getASCSignpostSpanClass()
{
  ...
  v7 = getASCSignpostSpanClass_softClass;
...
void sub_20D88E6E8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
id ASOViewRenderOverlayRequested()
{
  ...
  v0 = objc_alloc_init((Class)getASCSignpostSpanClass());
  v5 = 0;
  v6 = &v5;
  v7 = 0x2050000000;
  v1 = (void *)getASCViewRenderClass_softClass;
  v8 = getASCViewRenderClass_softClass;
  ...
  objc_msgSend(v0, "beginEmitting");
  objc_msgSend(v2, "overlayRequestedWithTag:", objc_msgSend(v0, "primaryTag"));
  objc_msgSend(v0, "endEmitting");
  return v0;
}

void sub_20D88E7D0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
Class __getASCSignpostSpanClass_block_invoke(uint64_t a1)
{
  ...
  result = objc_getClass("ASCSignpostSpan");
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = result;
  if (!*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24))
    __getASCSignpostSpanClass_block_invoke_cold_1();
  getASCSignpostSpanClass_softClass = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24);
  return result;
}
...
Class __getASCViewRenderClass_block_invoke(uint64_t a1)
{
  ...
  AppStoreComponentsLibrary();
  result = objc_getClass("ASCViewRender");
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = result;
  if (!*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24))
    __getASCViewRenderClass_block_invoke_cold_1();
  getASCViewRenderClass_softClass = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24);
  return result;
}
