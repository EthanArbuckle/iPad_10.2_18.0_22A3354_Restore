...
{
  return CAMLocalizedFrameworkString(CFSTR("SEMANTIC_STYLES_DESCRIPTION_OVERLAY_TITLE"), &stru_1EA3325A0);
}

- (id)detailTextUsingNarrowWidth:(BOOL)a3
{
  return CAMLocalizedFrameworkString(CFSTR("SEMANTIC_STYLES_DESCRIPTION_OVERLAY_SET_UP"), &stru_1EA3325A0);
}

- (id)acknowledgmentTextUsingNarrowWidth:(BOOL)a3
{
  return CAMLocalizedFrameworkString(CFSTR("SEMANTIC_STYLES_DESCRIPTION_OVERLAY_CONTINUE"), &stru_1EA3325A0);
}
...
{
  return CAMLocalizedFrameworkString(CFSTR("SEMANTIC_STYLES_DESCRIPTION_OVERLAY_DESCRIPTION"), &stru_1EA3325A0);
}
