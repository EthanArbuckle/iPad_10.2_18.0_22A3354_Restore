...
{
  id v5;
  CAMSalientObjectResult *v6;
  CAMSalientObjectResult *v7;
  void *v8;
  void *v9;
  uint64_t v10;
  NSString *uniqueIdentifier;
  CAMSalientObjectResult *v12;
  objc_super v14;

  v5 = a3;
  v14.receiver = self;
  v14.super_class = (Class)CAMSalientObjectResult;
  v6 = -[CAMSalientObjectResult init](&v14, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    objc_msgSend(v8, "stringWithFormat:", CFSTR("%@ %ld"), v9, objc_msgSend(v5, "objectID"));
...
- (NSString)description
{
  ...
  -[CAMSalientObjectResult _salientObject](self, "_salientObject");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "type");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[CAMSalientObjectResult _salientObject](self, "_salientObject");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<%@: %p type: %@ identifier: %ld>"), v5, self, v7, objc_msgSend(v8, "objectID"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)syntheticFocusMode
{
  ...
  -[CAMSalientObjectResult underlyingMetadataObject](self, "underlyingMetadataObject");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  objc_storeStrong((id *)&self->__salientObject, a3);
}
