...
- (SKUINearMeViewElement)initWithDOMElement:(id)a3 parent:(id)a4 elementFactory:(id)a5
{
  ...
  id v9;
  id v10;
  SKUINearMeViewElement *v11;
  SKUINearMeViewElement *v12;
  _QWORD block[4];
  SKUINearMeViewElement *v15;
  objc_super v16;
  ...
  {
    -[SKUINearMeViewElement initWithDOMElement:parent:elementFactory:].cold.1();
  }
  v16.receiver = self;
...
void __66__SKUINearMeViewElement_initWithDOMElement_parent_elementFactory___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v2, "addObserver:selector:name:object:", *(_QWORD *)(a1 + 32), sel__itemsDidChange_, CFSTR("SKUINearMeItemsDidChangeNotification"), v3);
...
- (void)dealloc
{
  ...
  -[SKUIViewElement dealloc](&v4, sel_dealloc);
}
...
- (void)enumerateChildrenUsingBlock:(id)a3
{
  ...
  v6 = objc_msgSend(SKUIWeakLinkedClassForString(CFSTR("CLLocationManager"), v5), "authorizationStatus");
  if (SKUINearMeIsEnabledForAuthorizationStatus(v6))
  {
    v7.receiver = self;
    v7.super_class = (Class)SKUINearMeViewElement;
    -[SKUIViewElement enumerateChildrenUsingBlock:](&v7, sel_enumerateChildrenUsingBlock_, v4);
  }
...
- (void)_itemsDidChange:(id)a3
{
  ...
  +[SKUINearMeController sharedController](SKUINearMeController, "sharedController", a3);
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(*(id *)(*((_QWORD *)&v20 + 1) + 8 * v11), "itemIdentifier"));
  ...
  if (v14)
  {
    objc_msgSend(MEMORY[0x1E0CB36D8], "dataWithJSONObject:options:error:", v14, 0, 0);
