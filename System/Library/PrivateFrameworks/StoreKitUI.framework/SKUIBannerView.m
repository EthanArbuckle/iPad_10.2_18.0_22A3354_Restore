...
- (SKUIBannerView)initWithFrame:(CGRect)a3
{
  ...
  {
    -[SKUIBannerView initWithFrame:].cold.1();
  }
  v24.receiver = self;
  ...
  if (v8)
  {
    ...
    -[UIButton setAdjustsImageWhenHighlighted:](v8->_closeButton, "setAdjustsImageWhenHighlighted:", 0);
    v11 = v8->_closeButton;
    objc_msgSend(MEMORY[0x1E0DC3870], "symbolImageNamed:", CFSTR("xmark"));
    ...
    -[SKUIBannerView addSubview:](v8, "addSubview:", v8->_closeButton);
    objc_msgSend(MEMORY[0x1E0DC3658], "_separatorColor");
    ...
    if (v17 == 1)
    {
      ...
      -[UIView setBackgroundColor:](v8->_separatorView, "setBackgroundColor:", v15);
      -[SKUIBannerView addSubview:](v8, "addSubview:", v8->_separatorView);
    }
    v20 = (UIView *)objc_alloc_init(MEMORY[0x1E0DC3F10]);
    bottomBorderView = v8->_bottomBorderView;
    v8->_bottomBorderView = v20;

    -[UIView setBackgroundColor:](v8->_bottomBorderView, "setBackgroundColor:", v15);
    -[SKUIBannerView addSubview:](v8, "addSubview:", v8->_bottomBorderView);
    objc_msgSend(MEMORY[0x1E0DC3658], "_secondarySystemBackgroundColor");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIBannerView setBackgroundColor:](v8, "setBackgroundColor:", v22);
...
- (UIControl)itemOfferButton
{
  ...
  if (!itemOfferButton)
  {
    ...
    -[SKUIBannerView addSubview:](self, "addSubview:", self->_itemOfferButton);
    itemOfferButton = self->_itemOfferButton;
  }
...
- (void)setArtistName:(id)a3
{
  ...
  v9 = a3;
  -[SKUIBannerView artistName](self, "artistName");
  ...
  if (v4 != v9 && (objc_msgSend(v9, "isEqualToString:", v4) & 1) == 0)
  {
    ...
    if (v9)
    {
      if (!artistNameLabel)
      {
        v6 = -[SKUIBannerView _newDefaultLabel](self, "_newDefaultLabel");
        v7 = self->_artistNameLabel;
        self->_artistNameLabel = v6;

        -[SKUIBannerView addSubview:](self, "addSubview:", self->_artistNameLabel);
        artistNameLabel = self->_artistNameLabel;
      }
    ...
    -[SKUIBannerView setNeedsLayout](self, "setNeedsLayout");
  }
...
- (void)setClientContext:(id)a3
{
  ...
  if (self->_clientContext != v5)
  {
    ...
    if (*p_clientContext)
      -[SKUIClientContext localizedStringForKey:](*p_clientContext, "localizedStringForKey:", CFSTR("BANNER_CLOSE_BUTTON"));
    else
      +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("BANNER_CLOSE_BUTTON"), 0);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[UIButton setAccessibilityLabel:](closeButton, "setAccessibilityLabel:", v8);

    -[SKUIBannerView _reloadItemState](self, "_reloadItemState");
    v5 = v9;
  }
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIBannerView addSubview:](self, "addSubview:", v19);
  ...
  if (v4 != v10)
  {
    ...
    if (v10)
    {
      if (!iconImageView)
      {
        ...
        -[SKUIBannerView addSubview:](self, "addSubview:", self->_iconImageView);
        iconImageView = self->_iconImageView;
      }
...
- (void)setTitle:(id)a3
{
  ...
  v15 = a3;
  -[SKUIBannerView title](self, "title");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  if (v4 != v15 && (objc_msgSend(v15, "isEqualToString:", v4) & 1) == 0)
  {
    ...
    if (v15)
    {
      if (!titleLabel)
      {
        ...
        -[SKUIBannerView addSubview:](self, "addSubview:", self->_titleLabel);
        titleLabel = self->_titleLabel;
      }
...
LABEL_5:
    ...
    -[SKUIBannerView addSubview:](self, "addSubview:", self->_userRatingStarImageView);
  }
  self->_userRating = a3;
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  v7 = (SKUIBannerView *)objc_claimAutoreleasedReturnValue();
  if (v7 == self)
  {
...
- (void)layoutSubviews
{
  ...
  -[SKUIBannerView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  -[SKUIBannerView layoutMargins](self, "layoutMargins");
  v12 = v11;
  -[SKUIBannerView layoutMargins](self, "layoutMargins");
  v13 = v4 + v12;
  v14 = v6 + 0.0;
  v16 = v8 - (v12 + v15);
  v17 = -[SKUIBannerView _shouldReverseLayoutDirection](self, "_shouldReverseLayoutDirection");
  -[UIButton frame](self->_closeButton, "frame");
  v19 = v18;
  v21 = v20;
  if ((v17 & 1) != 0)
  ...
  *(double *)&v181[2] = v69;
  ...
  v176 = v84;
  if ((-[SKUIItemState state](self->_itemState, "state") & 4) != 0)
  {
...
LABEL_55:
  ...
  -[SKUIBannerView bounds](self, "bounds", v134);
  v167 = v166;
  objc_msgSend(MEMORY[0x1E0DC3BF8], "mainScreen");
...
- (id)_newDefaultLabel
{
  ...
  -[SKUIBannerView backgroundColor](self, "backgroundColor");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadItemState
{
  ...
  if (!self->_clientContext)
    return;
  v3 = -[SKUIItemState state](self->_itemState, "state");
  if ((v3 & 4) == 0)
  {
    ...
    {
      -[SSLookupItemOffer actionTextForType:](v9, "actionTextForType:", *MEMORY[0x1E0DAFA88]);
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    v17 = objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0DAFA80]);
...
LABEL_24:
        -[SKUIClientContext localizedStringForKey:](clientContext, "localizedStringForKey:", v19);
        v20 = objc_claimAutoreleasedReturnValue();
LABEL_28:
        v22 = (void *)v20;
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithValidatedFormat:validFormatSpecifiers:error:", v20, CFSTR("%@"), 0, v11);
        v29 = (id)objc_claimAutoreleasedReturnValue();

LABEL_29:
        v23 = self->_clientContext;
        if (v23)
          -[SKUIClientContext localizedStringForKey:](v23, "localizedStringForKey:", CFSTR("BANNER_VIEW_BUTTON"));
        else
          +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("BANNER_VIEW_BUTTON"), 0);
        v14 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_33:
    ...
    +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", v21, 0);
    v20 = objc_claimAutoreleasedReturnValue();
    goto LABEL_28;
  }
  v4 = self->_clientContext;
  if (v4)
    -[SKUIClientContext localizedStringForKey:](v4, "localizedStringForKey:", CFSTR("BANNER_ITEM_STATE_INSTALLED"));
  else
    +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("BANNER_ITEM_STATE_INSTALLED"), 0);
  v12 = objc_claimAutoreleasedReturnValue();
  v13 = self->_clientContext;
  v29 = (id)v12;
  if (v13)
    -[SKUIClientContext localizedStringForKey:](v13, "localizedStringForKey:", CFSTR("BANNER_OPEN_BUTTON"));
  else
    +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("BANNER_OPEN_BUTTON"), 0);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v14)
    goto LABEL_33;
LABEL_15:
  -[SKUIBannerView itemOfferButton](self, "itemOfferButton");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_34:
  ...
  if (v29)
  {
    if (!itemStateLabel)
    {
      v26 = -[SKUIBannerView _newDefaultLabel](self, "_newDefaultLabel");
      v27 = self->_itemStateLabel;
      self->_itemStateLabel = v26;

      -[SKUIBannerView addSubview:](self, "addSubview:", self->_itemStateLabel);
      v24 = v29;
      itemStateLabel = self->_itemStateLabel;
    }
