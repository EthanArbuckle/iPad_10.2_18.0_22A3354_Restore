...
- (SKUIJSApplication)initWithAppContext:(id)a3 applicationController:(id)a4
{
  ...
  {
    -[SKUIJSApplication initWithAppContext:applicationController:].cold.1();
  }
  v11.receiver = self;
...
- (void)launchFailed
{
  ...
  -[SKUIJSApplication applicationController](self, "applicationController");
...
void __43__SKUIJSApplication_sendDocumentMessage_::__block_invoke(_QWORD *a1)
{
  void *v2;
  uint64_t v3;
  uint64_t v4;
  ...
  v4 = a1[4];
  v3 = a1[5];
  v7[0] = CFSTR("SKUIDocumentMessageNameKey");
  v7[1] = CFSTR("SKUIDocumentMessagePayloadKey");
  v5 = a1[6];
  v8[0] = v3;
  v8[1] = v5;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v8, v7, 2);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "postNotificationName:object:userInfo:", CFSTR("SKUIAppDocumentDidSendMessageNotification"), v4, v6);
