...
{
  id v4;
  SKUISizingEntityValueProvider *v5;
  NSMutableDictionary *v6;
  NSMutableDictionary *tallestValues;
  _QWORD v9[4];
  SKUISizingEntityValueProvider *v10;
  objc_super v11;
  ...
  {
    -[SKUISizingEntityValueProvider initForViewElement:].cold.1();
  }
  v11.receiver = self;
  v11.super_class = (Class)SKUISizingEntityValueProvider;
  v5 = -[SKUISizingEntityValueProvider init](&v11, sel_init);
  if (v5)
  {
...
- (void)_insertTallestValueForViewElement:(id)a3
{
  ...
  __CFString *v12;
  uint64_t v13;
  SKUISizingEntityValueProvider *v14;
  id v15;
