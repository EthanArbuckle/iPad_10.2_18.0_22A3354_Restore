...
- (SKUIFacebookLikeStatus)initWithURL:(id)a3 likeStatusDictionary:(id)a4
{
  ...
  {
    -[SKUIFacebookLikeStatus initWithURL:likeStatusDictionary:].cold.1();
  }
  v30.receiver = self;
  v30.super_class = (Class)SKUIFacebookLikeStatus;
  v8 = -[SKUIFacebookLikeStatus init](&v30, sel_init);
  if (v8)
  {
    v9 = (void *)SKUISocialFramework();
    objc_msgSend(v7, "objectForKey:", *(_QWORD *)SKUIWeakLinkedSymbolForString("SLFacebookLikeInfoMeKey", v9));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_opt_respondsToSelector() & 1) != 0)
      v8->_userLiked = objc_msgSend(v10, "BOOLValue");
    v11 = (void *)SKUISocialFramework();
    objc_msgSend(v7, "objectForKey:", *(_QWORD *)SKUIWeakLinkedSymbolForString("SLFacebookLikeInfoFriendsKey", v11));
