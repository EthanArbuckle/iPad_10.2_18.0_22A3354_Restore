...
- (SKUIViewReuseView)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  SKUIViewReuseView *v8;
  SKUIViewReusePool *v9;
  SKUIViewReusePool *viewReusePool;
  objc_super v12;
  ...
  {
    -[SKUIViewReuseView initWithFrame:].cold.1();
  }
  v12.receiver = self;
...
- (void)dealloc
{
  ...
  -[SKUIViewReuseView dealloc](&v9, sel_dealloc);
}
...
- (void)modifyUsingBlock:(id)a3
{
  ...
  v6 = -[SKUIViewModification initWithViewReusePool:]([SKUIViewModification alloc], "initWithViewReusePool:", self->_viewReusePool);
  v4[2](v4, v6);
  -[SKUIViewReuseView backgroundColor](self, "backgroundColor");
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        -[SKUIViewReuseView addSubview:](self, "addSubview:", v15);
      }
  ...
  -[SKUIViewReusePool hideUnusedViews](self->_viewReusePool, "hideUnusedViews");
  -[SKUIViewReuseView setNeedsLayout](self, "setNeedsLayout");

}

- (void)registerClass:(Class)a3 forViewWithReuseIdentifier:(id)a4
{
  -[SKUIViewReusePool registerClass:forViewWithReuseIdentifier:](self->_viewReusePool, "registerClass:forViewWithReuseIdentifier:", a3, a4);
}
...
- (void)setBackgroundColor:(id)a3
{
    ...
    if (v16 < 1.0)
    {
      ...
      if (v19 != 0.0)
      {
        ...
        if (v18 != 0.0)
        {
          ...
          if (v17 != 0.0)
          {
            objc_msgSend(MEMORY[0x1E0DC3658], "clearColor", v17);
  ...
  -[SKUIViewReuseView setBackgroundColor:](&v11, sel_setBackgroundColor_, v4);
