...
- (SKUIScalingFlipView)initWithFrontView:(id)a3 backView:(id)a4
{
  ...
  CGFloat v11;
  CGFloat v12;
  SKUIScalingFlipView *v13;
  SKUIScalingFlipView *v14;
  id *p_backView;
  CGFloat v16;
  CGFloat v17;
  CGFloat v18;
  ...
  {
    -[SKUIScalingFlipView initWithFrontView:backView:].cold.1();
  }
  ...
  if (v13)
  {
    ...
    -[SKUIScalingFlipView addSubview:](v14, "addSubview:", *p_backView);
    -[SKUIScalingFlipView addSubview:](v14, "addSubview:", v14->_frontView);
    frontView = v14->_frontView;
    -[SKUIScalingFlipView center](v14, "center");
    ...
    -[SKUIScalingFlipView layer](v14, "layer");
...
- (void)performFlipWithCompletionBlock:(id)a3
{
  ...
  -[SKUIScalingFlipView _frontLayerAnimation](self, "_frontLayerAnimation");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "addAnimation:forKey:", v8, CFSTR("flipAnimation"));

  -[UIView layer](self->_backView, "layer");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIScalingFlipView _backLayerAnimation](self, "_backLayerAnimation");
  ...
  -[SKUIScalingFlipView _inputColorAnimation](self, "_inputColorAnimation");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIScalingFlipView _positionAnimation](self, "_positionAnimation");
  ...
  -[SKUIScalingFlipView _timingFunction](self, "_timingFunction");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "setTimingFunction:", v18);

  -[SKUIScalingFlipView layer](self, "layer");
...
- (void)animationDidStop:(id)a3 finished:(BOOL)a4
{
  ...
  double v20;
  double v21;
  void (**completionBlock)(id, SKUIScalingFlipView *);
  void *v23;
  CATransform3D v24;
  _OWORD v25[8];

  -[SKUIScalingFlipView layer](self, "layer", a3, a4);
  ...
  -[SKUIScalingFlipView bounds](self, "bounds");
  v15 = v14;
  v17 = v16;
  v19 = v18;
  v21 = v20;
  ...
  completionBlock = (void (**)(id, SKUIScalingFlipView *))self->_completionBlock;
  if (completionBlock)
...
- (id)_backLayerAnimation
{
  ...
  if ((direction & 0xFFFFFFFFFFFFFFFELL) == 2)
    ...
    v7 = 0.0;
  v8 = dbl_1BBED2390[(direction & 0xFFFFFFFFFFFFFFFDLL) == 0];
  ...
  *(_OWORD *)&v41.m31 = *(_OWORD *)(MEMORY[0x1E0CD2610] + 64);
  v38 = *(_OWORD *)&v41.m31;
  v13 = v10 / height;
  v41.m33 = *(CGFloat *)(MEMORY[0x1E0CD2610] + 80);
  m33 = v41.m33;
  ...
  *(_OWORD *)&v42.m41 = v53;
  *(_OWORD *)&v42.m43 = v54;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithCATransform3D:", &v42);
...
- (id)_frontLayerAnimation
{
  ...
  if ((direction & 0xFFFFFFFFFFFFFFFELL) == 2)
    ...
    v7 = 0.0;
  v8 = dbl_1BBED23A0[(direction & 0xFFFFFFFFFFFFFFFDLL) == 0];
  v9 = 1.0 / ((width + height) * 0.5 * 3.0);
  ...
  *(_OWORD *)&v39.m31 = *(_OWORD *)(MEMORY[0x1E0CD2610] + 64);
  v36 = *(_OWORD *)&v39.m31;
  v39.m33 = *(CGFloat *)(MEMORY[0x1E0CD2610] + 80);
  m33 = v39.m33;
  ...
  *(_OWORD *)&v40.m41 = v32;
  *(_OWORD *)&v40.m43 = v33;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithCATransform3D:", &v40);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v57[0] = v24;
  *(_OWORD *)&v40.m21 = v53;
  *(_OWORD *)&v40.m23 = v54;
...
- (id)_inputColorAnimation
{
  ...
  objc_msgSend(MEMORY[0x1E0CD2798], "animationWithKeyPath:", CFSTR("filters.multiply.inputColor"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 1.0, 1.0);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.330000013, 1.0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
