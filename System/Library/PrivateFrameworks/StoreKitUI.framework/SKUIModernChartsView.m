...
- (SKUIModernChartsView)initWithFrame:(CGRect)a3
{
  ...
  {
    -[SKUIModernChartsView initWithFrame:].cold.1();
  }
  v19.receiver = self;
  ...
  if (v8)
  {
    ...
    -[UIScrollView setAutoresizingMask:](v8->_scrollView, "setAutoresizingMask:", 18);
    -[UIScrollView setAlwaysBounceHorizontal:](v8->_scrollView, "setAlwaysBounceHorizontal:", 1);
    -[UIScrollView setBouncesHorizontally:](v8->_scrollView, "setBouncesHorizontally:", 1);
    -[UIScrollView setBouncesVertically:](v8->_scrollView, "setBouncesVertically:", 0);
    -[UIScrollView setCanCancelContentTouches:](v8->_scrollView, "setCanCancelContentTouches:", 0);
    -[UIScrollView setDelaysContentTouches:](v8->_scrollView, "setDelaysContentTouches:", 0);
    -[UIScrollView setDelegate:](v8->_scrollView, "setDelegate:", v8);
    -[SKUIModernChartsView addSubview:](v8, "addSubview:", v8->_scrollView);
    v11 = objc_msgSend(objc_alloc(MEMORY[0x1E0DC4028]), "initWithPrivateStyle:", 2010);
    backdropView = v8->_backdropView;
    v8->_backdropView = (_UIBackdropView *)v11;

    -[_UIBackdropView setAutoresizingMask:](v8->_backdropView, "setAutoresizingMask:", 2);
    -[SKUIModernChartsView addSubview:](v8, "addSubview:", v8->_backdropView);
    v13 = (UIView *)objc_alloc_init(MEMORY[0x1E0DC3F10]);
    headerView = v8->_headerView;
    v8->_headerView = v13;

    -[UIView setAutoresizingMask:](v8->_headerView, "setAutoresizingMask:", 2);
    v15 = v8->_headerView;
    objc_msgSend(MEMORY[0x1E0DC3658], "clearColor");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[UIView setBackgroundColor:](v15, "setBackgroundColor:", v16);

    -[SKUIModernChartsView addSubview:](v8, "addSubview:", v8->_headerView);
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "addObserver:selector:name:object:", v8, sel__contentSizeCategoryDidChange_, *MEMORY[0x1E0DC48E8], 0);
...
- (void)dealloc
{
  ...
  -[SKUIModernChartsView dealloc](&v4, sel_dealloc);
}
...
- (void)setColumnViewControllers:(id)a3
{
  ...
  -[UIScrollView setContentOffset:](self->_scrollView, "setContentOffset:", *MEMORY[0x1E0C9D538], *(double *)(MEMORY[0x1E0C9D538] + 8));
  -[SKUIModernChartsView _updateHeader](self, "_updateHeader");
  -[SKUIModernChartsView setNeedsLayout](self, "setNeedsLayout");
...
- (void)layoutSubviews
{
  ...
  v19.receiver = self;
  v19.super_class = (Class)SKUIModernChartsView;
  -[SKUIModernChartsView layoutSubviews](&v19, sel_layoutSubviews);
  -[SKUIModernChartsView bounds](self, "bounds");
  x = v20.origin.x;
  y = v20.origin.y;
  ...
  {
    -[UIScrollView setContentSize:](self->_scrollView, "setContentSize:", *MEMORY[0x1E0C9D820], *(double *)(MEMORY[0x1E0C9D820] + 8));
  }
}

- (void)_contentSizeCategoryDidChange:(id)a3
{
  -[SKUIModernChartsView _updateHeader](self, "_updateHeader", a3);
  -[SKUIModernChartsView setNeedsLayout](self, "setNeedsLayout");
}
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIModernChartHeaderView setTitle:](v17, "setTitle:", v18);
