...
{
  id v5;
  SKUIMenuBarViewElementConfiguration *v6;
  SKUIMenuBarViewElementConfiguration *v7;
  uint64_t v8;
  ...
  {
    -[SKUIMenuBarViewElementConfiguration _initWithMenuBarDocument:].cold.1();
  }
  v11.receiver = self;
  v11.super_class = (Class)SKUIMenuBarViewElementConfiguration;
  v6 = -[SKUIMenuBarViewElementConfiguration init](&v11, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (void)menuBarDocument:(id)a3 didReplaceDocumentForEntityWithUniqueIdentifier:(id)a4
{
  ...
  v6 = a4;
  -[SKUIMenuBarViewElementConfiguration _ensureDataLoaded](self, "_ensureDataLoaded");
  -[SKUIMenuBarViewElementConfiguration delegate](self, "delegate");
...
- (void)contentWillAppearForMenuItemAtIndex:(unint64_t)a3 withEntityValueProvider:(id)a4 clientContext:(id)a5
{
  ...
  if (v8)
  {
    ...
    if (!v13)
    {
      v14 = objc_alloc(MEMORY[0x1E0D3A6A8]);
...
{
  return (SKUIMenuBarViewElementConfigurationDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
...
{
  return (_SKUIMenuBarViewElementConfigurationReloadDelegate *)objc_loadWeakRetained((id *)&self->_reloadDelegate);
}
