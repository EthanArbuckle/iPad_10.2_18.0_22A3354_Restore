...
- (float)starSpacing
{
  ...
  {
    -[SKUIStarRatingControl starSpacing].cold.1();
  }
...
- (void)setEmptyStarsImage:(id)a3
{
  ...
  if (v4 != v11)
  {
    ...
    if (!emptyStarsImageView)
    {
      ...
      -[SKUIStarRatingControl backgroundColor](self, "backgroundColor");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      -[UIImageView setBackgroundColor:](v9, "setBackgroundColor:", v10);

      -[SKUIStarRatingControl addSubview:](self, "addSubview:", self->_emptyStarsImageView);
      emptyStarsImageView = self->_emptyStarsImageView;
    }
...
- (void)setFilledStarsImage:(id)a3
{
  ...
  if (v4 != v11)
  {
    ...
    if (!filledStarsImageView)
    {
      ...
      -[SKUIStarRatingControl addSubview:](self, "addSubview:", self->_filledStarsImageView);
      filledStarsImageView = self->_filledStarsImageView;
    }
...
- (void)setUserRating:(int64_t)a3
{
  ...
  {
    self->_userRating = a3;
    -[SKUIStarRatingControl setNeedsLayout](self, "setNeedsLayout");
  }
}
...
{
  -[SKUIStarRatingControl _updateUserRatingWithTouch:](self, "_updateUserRatingWithTouch:", a3, a4);
  -[SKUIStarRatingControl sendActionsForControlEvents:](self, "sendActionsForControlEvents:", 4096);
}
...
- (void)layoutSubviews
{
  ...
  -[SKUIStarRatingControl bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  -[UIImageView setFrame:](self->_emptyStarsImageView, "setFrame:");
  -[SKUIStarRatingControl _unfilledStarsMinX](self, "_unfilledStarsMinX");
  v12 = v11;
  userRating = (float)self->_userRating;
  -[SKUIStarRatingControl starWidth](self, "starWidth");
  ...
  {
    v19 = (float)v18;
    -[SKUIStarRatingControl starSpacing](self, "starSpacing");
    v15 = v15 + (float)(v20 * v19);
  }
  if (-[SKUIStarRatingControl _isRTL](self, "_isRTL"))
  {
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  y = a3.y;
  x = a3.x;
  -[SKUIStarRatingControl bounds](self, "bounds", a4);
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUIStarRatingControl setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
...
- (BOOL)_isRTL
{
  return -[SKUIStarRatingControl effectiveUserInterfaceLayoutDirection](self, "effectiveUserInterfaceLayoutDirection") == 1;
}

- (unint64_t)_lastStar
{
  return -[SKUIStarRatingControl _ratingForUIDirection:](self, "_ratingForUIDirection:", 5);
}

- (unint64_t)_firstStar
{
  return -[SKUIStarRatingControl _ratingForUIDirection:](self, "_ratingForUIDirection:", 1);
}
...
- (double)_unfilledStarsMinX
{
  ...
  -[SKUIStarRatingControl bounds](self, "bounds");
  v4 = v3;
  -[SKUIStarRatingControl _unfilledStarsWidth](self, "_unfilledStarsWidth");
  return (v4 - v5) * 0.5;
}
...
- (void)_updateUserRatingWithTouch:(id)a3
{
  ...
  if (v6 >= v8 - v9)
  {
    ...
    if (v6 >= v12 + v13)
    {
      v10 = -[SKUIStarRatingControl _lastStar](self, "_lastStar");
    }
    else
    {
      -[SKUIStarRatingControl _unfilledStarsMinX](self, "_unfilledStarsMinX");
      ...
      v10 = -[SKUIStarRatingControl _ratingForUIDirection:](self, "_ratingForUIDirection:", v18);
    }
  }
  else
  {
    v10 = -[SKUIStarRatingControl _firstStar](self, "_firstStar");
  }
  userRating = v10;
LABEL_11:
  -[SKUIStarRatingControl setUserRating:](self, "setUserRating:", userRating);
}
