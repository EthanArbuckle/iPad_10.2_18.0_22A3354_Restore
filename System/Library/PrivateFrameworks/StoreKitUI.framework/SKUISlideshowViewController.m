...
- (SKUISlideshowViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  id v6;
  id v7;
  SKUISlideshowViewController *v8;
  SKUISlideshowViewController *v9;
  ...
  {
    -[SKUISlideshowViewController initWithNibName:bundle:].cold.1();
  }
  v19.receiver = self;
  v19.super_class = (Class)SKUISlideshowViewController;
  v8 = -[SKUISlideshowViewController initWithNibName:bundle:](&v19, sel_initWithNibName_bundle_, v6, v7);
  v9 = v8;
  if (v8)
  {
    v8->_currentIndex = 0;
    ...
    v14 = objc_msgSend(objc_alloc(MEMORY[0x1E0DC3A98]), "initWithTransitionStyle:navigationOrientation:options:", 1, 0, 0);
    pageViewController = v9->_pageViewController;
    v9->_pageViewController = (UIPageViewController *)v14;

    -[UIPageViewController setDataSource:](v9->_pageViewController, "setDataSource:", v9);
    -[UIPageViewController setDelegate:](v9->_pageViewController, "setDelegate:", v9);
    -[SKUISlideshowViewController addChildViewController:](v9, "addChildViewController:", v9->_pageViewController);
    ...
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC34F0]), "initWithBarButtonSystemItem:target:action:", 0, v9, sel__doneButtonTapped_);
    -[SKUISlideshowViewController navigationItem](v9, "navigationItem");
...
- (id)animatorForPresentedController:(id)a3 presentingController:(id)a4 sourceController:(id)a5
{
  ...
  if ((v8 & 1) != 0)
  {
    ...
    -[SKUISlideshowAnimator setImageView:](v6, "setImageView:", v10);
  }
  return v6;
}
...
{
  SKUISlideshowDismissalAnimator *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  -[SKUISlideshowViewController currentItemViewController](self, "currentItemViewController");
  ...
  -[SKUISlideshowViewController view](self, "view");
  ...
  if ((v24 & 1) != 0)
  {
    ...
    -[SKUISlideshowDismissalAnimator setImageView:](v4, "setImageView:", v26);
  }
...
- (void)setCurrentIndex:(int64_t)a3
{
  ...
  -[SKUISlideshowViewController _itemViewControllerForIndex:](self, "_itemViewControllerForIndex:");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUISlideshowViewController _updateCurrentIndex](self, "_updateCurrentIndex");

}

- (void)reloadData
{
  -[SKUISlideshowViewController setCurrentIndex:](self, "setCurrentIndex:", self->_currentIndex);
}
...
- (void)loadView
{
  ...
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC4028]), "initWithPrivateStyle:", 2020);
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3D80]), "initWithTarget:action:", self, sel__contentViewTapped_);
  objc_msgSend(v8, "setNumberOfTapsRequired:", 2);
  objc_msgSend(v7, "addGestureRecognizer:", v8);
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3D80]), "initWithTarget:action:", self, sel__contentViewTapped_);
  objc_msgSend(v9, "requireGestureRecognizerToFail:", v8);
  objc_msgSend(v7, "addGestureRecognizer:", v9);
  -[SKUISlideshowViewController setView:](self, "setView:", v10);
...
- (void)viewDidLoad
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKUISlideshowViewController;
  -[SKUISlideshowViewController viewDidLoad](&v3, sel_viewDidLoad);
  -[SKUISlideshowViewController setCurrentIndex:](self, "setCurrentIndex:", self->_currentIndex);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[SKUISlideshowViewController viewWillAppear:](&v4, sel_viewWillAppear_, a3);
  -[SKUISlideshowViewController _saveStatusBarAppearanceState](self, "_saveStatusBarAppearanceState");
}
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SKUISlideshowViewController;
  -[SKUISlideshowViewController viewWillDisappear:](&v4, sel_viewWillDisappear_, a3);
  -[SKUISlideshowViewController _restoreStatusBarAppearanceState](self, "_restoreStatusBarAppearanceState");
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SKUISlideshowViewController;
  -[SKUISlideshowViewController viewDidAppear:](&v4, sel_viewDidAppear_, a3);
  -[SKUISlideshowViewController _setOverlayVisible:animated:](self, "_setOverlayVisible:animated:", 1, 1);
  -[SKUISlideshowViewController _fadeOutOverlayAfterDelay:](self, "_fadeOutOverlayAfterDelay:", 2);
}
...
- (void)willRotateToInterfaceOrientation:(int64_t)a3 duration:(double)a4
{
  ...
  -[SKUISlideshowViewController willRotateToInterfaceOrientation:duration:](&v8, sel_willRotateToInterfaceOrientation_duration_, a3, a4);
}
...
- (void)willAnimateRotationToInterfaceOrientation:(int64_t)a3 duration:(double)a4
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SKUISlideshowViewController;
  -[SKUISlideshowViewController willAnimateRotationToInterfaceOrientation:duration:](&v8, sel_willAnimateRotationToInterfaceOrientation_duration_, a3, a4);
}

- (id)pageViewController:(id)a3 viewControllerAfterViewController:(id)a4
{
  return -[SKUISlideshowViewController _itemViewControllerForIndex:](self, "_itemViewControllerForIndex:", objc_msgSend(a4, "indexInCollection", a3) + 1);
}
...
{
  -[SKUISlideshowViewController _setOverlayVisible:animated:](self, "_setOverlayVisible:animated:", 0, 1);
  self->_shouldCancelDelayedOverlayVisibilityChange = 1;
}
...
- (void)slideshowItemViewControllerDidDismissWithPinchGesture:(id)a3 ratio:(double)a4
{
  ...
  if (a4 > 0.0)
  {
    -[SKUISlideshowViewController delegate](self, "delegate", a3);
    v5 = (id)objc_claimAutoreleasedReturnValue();
    -[SKUISlideshowViewController _restoreStatusBarAppearanceState](self, "_restoreStatusBarAppearanceState");
    if ((objc_opt_respondsToSelector() & 1) != 0)
      objc_msgSend(v5, "slideshowViewControllerDidFinish:", self);
    else
      -[SKUISlideshowViewController dismissViewControllerAnimated:completion:](self, "dismissViewControllerAnimated:completion:", 1, 0);
...
- (id)_itemViewControllerForIndex:(int64_t)a3
{
  ...
  NSMutableDictionary *itemViewControllersCache;
  void *v11;
  SKUISlideshowItemViewController *v12;
  id v13;
  void *v14;
  id v15;
  void *v16;
  ...
  void *v21;
  _QWORD v23[4];
  SKUISlideshowItemViewController *v24;
...
LABEL_11:
  ...
  v12 = (SKUISlideshowItemViewController *)objc_claimAutoreleasedReturnValue();

  if (!v12)
  {
    v12 = objc_alloc_init(SKUISlideshowItemViewController);
    -[SKUISlideshowItemViewController setClientContext:](v12, "setClientContext:", self->_clientContext);
    -[SKUISlideshowItemViewController setIndexInCollection:](v12, "setIndexInCollection:", a3);
    -[SKUISlideshowItemViewController setDelegate:](v12, "setDelegate:", self);
    ...
    if (v14)
      -[SKUISlideshowItemViewController setItemImage:](v12, "setItemImage:", v14);
    ...
    if (v18)
    {
      v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF698]), "initWithURL:", v18);
...
{
  -[SKUISlideshowViewController _updateTitleWithIndex:](self, "_updateTitleWithIndex:", self->_currentIndex);
}
...
- (void)_updateTitleWithIndex:(int64_t)a3
{
  ...
  if (WeakRetained)
  {
    ...
    if (clientContext)
      -[SKUIClientContext localizedStringForKey:](clientContext, "localizedStringForKey:", CFSTR("SCREENSHOTS_INDEX_STRING"));
    else
      +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("SCREENSHOTS_INDEX_STRING"), 0);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithValidatedFormat:validFormatSpecifiers:error:", v14, CFSTR("%@%@"), 0, v12, v10);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUISlideshowViewController setTitle:](self, "setTitle:", v15);

  }
  else
  {
    -[SKUISlideshowViewController setTitle:](self, "setTitle:", 0);
  }
}
...
- (void)_contentViewTapped:(id)a3
{
  ...
  if (objc_msgSend(v7, "numberOfTapsRequired") == 1)
  {
    if (objc_msgSend(v7, "numberOfTouches") == 1)
    {
      ...
      {
        -[SKUISlideshowViewController _fadeOutOverlayAfterDelay:](self, "_fadeOutOverlayAfterDelay:", 4);
      }
      -[SKUISlideshowViewController _toggleFadeOverlay](self, "_toggleFadeOverlay");
    }
  }
...
- (void)_toggleFadeOverlay
{
  ...
  -[SKUISlideshowViewController navigationController](self, "navigationController");
  v3 = (void *)objc_claimAutoreleasedReturnValue();

  if (v3)
    -[SKUISlideshowViewController _setOverlayVisible:animated:](self, "_setOverlayVisible:animated:", !self->_overlayVisible, 1);
}
...
- (void)_saveStatusBarAppearanceState
{
  ...
  self = (SKUISlideshowViewController *)((char *)self + 1008);
