...
{
  id v4;
  SKUIGallerySwooshPageSection *v5;
  uint64_t v6;
  ...
  {
    -[SKUIGallerySwooshPageSection initWithPageComponent:].cold.1();
  }
  v9.receiver = self;
...
- (void)dealloc
{
  ...
  -[SKUIGallerySwooshViewController setDelegate:](self->_swooshViewController, "setDelegate:", 0);
  v3.receiver = self;
...
- (void)addImpressionsForIndexPath:(id)a3 toSession:(id)a4
{
  ...
  -[SKUIGallerySwooshViewController indexPathsForVisibleItems](self->_swooshViewController, "indexPathsForVisibleItems");
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIGallerySwooshPageSection _addImpressionForIndex:toSession:](self, "_addImpressionForIndex:toSession:", objc_msgSend(*(id *)(*((_QWORD *)&v13 + 1) + 8 * v12++), "item"), v5);
      }
      while (v10 != v12);
...
- (void)willAppearInContext:(id)a3
{
  ...
  objc_msgSend(v3, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), CFSTR("SKUIGallerySwooshPageSectionReuseIdentifier"));
...
- (id)cellForIndexPath:(id)a3
{
  ...
  objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", CFSTR("SKUIGallerySwooshPageSectionReuseIdentifier"), v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[SKUIGallerySwooshPageSection _swooshViewController](self, "_swooshViewController");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6 >= 1)
  {
    ...
    do
    {
      ...
      if (!v11)
      {
        ...
        v13 = -[SKUIGallerySwooshPageSection _newArtworkRequestWithArtwork:](self, "_newArtworkRequestWithArtwork:", v12);
        v14 = v13;
        if (v13)
        {
          componentArtworkRequests = self->_componentArtworkRequests;
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v13, "requestIdentifier"));
...
- (void)swoosh:(id)a3 didChangePlaybackState:(int64_t)a4 forItemAtIndex:(int64_t)a5
{
  ...
  if (objc_msgSend(v9, "canRecordEventWithType:", *MEMORY[0x1E0DAFC48]))
  {
    v10 = objc_alloc_init(MEMORY[0x1E0DAF5A0]);
...
- (void)swoosh:(id)a3 didSelectCellAtIndex:(int64_t)a4
{
  ...
  -[SKUIStorePageSection clickEventWithMedia:elementName:index:](self, "clickEventWithMedia:elementName:index:", v8, *MEMORY[0x1E0DAFCA0], a4);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9)
  {
    -[SKUIStorePageSection context](self, "context");
...
LABEL_4:
    ...
    v16 = -[SKUIGallerySwooshPageSection _newArtworkRequestWithArtwork:](self, "_newArtworkRequestWithArtwork:", v15);
    v17 = v16;
    if (v16)
    {
      componentArtworkRequests = self->_componentArtworkRequests;
...
- (void)swoosh:(id)a3 willDisplayCellAtIndex:(int64_t)a4
{
  ...
  if (v9)
  {
    -[SKUIGallerySwooshPageSection _addImpressionForIndex:toSession:](self, "_addImpressionForIndex:toSession:", a4, v9);
    v8 = v9;
  }
...
- (id)_newArtworkRequestWithArtwork:(id)a3
{
  ...
  if (v5)
  {
    ...
    +[SKUISizeToFitImageDataConsumer consumerWithConstraintSize:](SKUISizeToFitImageDataConsumer, "consumerWithConstraintSize:", (double)objc_msgSend(v4, "width"), (double)objc_msgSend(v4, "height"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  SKUIGallerySwooshViewController *swooshViewController;
  void *v4;
  void *v5;
  SKUIGallerySwooshViewController *v6;
  void *v7;
  SKUIGallerySwooshViewController *v8;
  SKUIGallerySwooshViewController *v9;
  SKUIGallerySwooshViewController *v10;
  void *v11;
  SKUIGallerySwooshViewController *v12;
  void *v13;
  ...
  if (!swooshViewController)
  {
    ...
    -[SKUIStorePageSection pageComponent](self, "pageComponent");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = -[SKUIGallerySwooshViewController initWithGallerySwoosh:](v6, "initWithGallerySwoosh:", v7);
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUISwooshViewController setClientContext:](v10, "setClientContext:", v11);

    v12 = self->_swooshViewController;
    objc_msgSend(v4, "colorScheme");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIGallerySwooshViewController setColorScheme:](v12, "setColorScheme:", v13);

    -[SKUIGallerySwooshViewController setDelegate:](self->_swooshViewController, "setDelegate:", self);
