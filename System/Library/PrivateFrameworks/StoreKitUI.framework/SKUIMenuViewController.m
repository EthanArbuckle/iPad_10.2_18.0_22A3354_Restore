...
- (SKUIMenuViewController)initWithMenuTitles:(id)a3 images:(id)a4
{
  ...
  {
    -[SKUIMenuViewController initWithMenuTitles:images:].cold.1();
  }
  v15.receiver = self;
  v15.super_class = (Class)SKUIMenuViewController;
  v8 = -[SKUIMenuViewController init](&v15, sel_init);
  v9 = v8;
  if (v8)
  {
...
{
  return -[SKUIMenuViewController initWithMenuTitles:images:](self, "initWithMenuTitles:images:", a3, 0);
}
...
- (void)setIndexOfCheckedTitle:(int64_t)a3
{
  ...
  if (self->_indexOfCheckedTitle != a3)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForRow:inSection:", indexOfCheckedTitle, 0);
    ...
    if (-[SKUIMenuViewController isViewLoaded](self, "isViewLoaded"))
    {
      -[SKUIMenuViewController tableView](self, "tableView");
...
- (void)setMenuStyle:(int64_t)a3
{
  ...
  {
    self->_menuStyle = a3;
    -[SKUIMenuViewController view](self, "view");
...
- (void)loadView
{
  ...
  -[SKUIMenuViewController loadView](&v7, sel_loadView);
  -[SKUIMenuViewController tableView](self, "tableView");
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  if (!v7)
    v7 = -[SKUITableViewCell initWithStyle:reuseIdentifier:]([SKUITableViewCell alloc], "initWithStyle:reuseIdentifier:", 0, CFSTR("a"));
  v8 = objc_msgSend(v6, "row");
  if (v8 == self->_indexOfCheckedTitle)
    v9 = 3;
  else
    v9 = 0;
  -[SKUITableViewCell setAccessoryType:](v7, "setAccessoryType:", v9);
  ...
  if (menuImages)
  {
    ...
    -[SKUITableViewCell imageView](v7, "imageView");
  ...
  {
    -[SKUITableViewCell setBottomBorderColor:](v7, "setBottomBorderColor:", 0);
  }
  else
  {
    objc_msgSend(MEMORY[0x1E0DC3658], "tableSeparatorColor");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUITableViewCell setBottomBorderColor:](v7, "setBottomBorderColor:", v17);
...
{
  return (SKUIMenuViewControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
