...
{
  id v6;
  SKUIGiftTextTableViewCell *v7;
  SKUIGiftTextTableViewCell *v8;
  void *v9;
  UIView *v10;
  ...
  {
    -[SKUIGiftTextTableViewCell initWithStyle:reuseIdentifier:].cold.1();
  }
  v20.receiver = self;
  v20.super_class = (Class)SKUIGiftTextTableViewCell;
  v7 = -[SKUIGiftTextTableViewCell initWithStyle:reuseIdentifier:](&v20, sel_initWithStyle_reuseIdentifier_, a3, v6);
  v8 = v7;
  if (v7)
  {
    -[SKUIGiftTextTableViewCell contentView](v7, "contentView");
    ...
    objc_msgSend(v9, "addSubview:", v8->_bottomBorderView);
    ...
    v8->_leftToRight = objc_msgSend(v18, "userInterfaceLayoutDirection") == 0;
...
- (void)dealloc
{
  ...
  -[SKUIGiftTextTableViewCell dealloc](&v3, sel_dealloc);
}
...
- (void)setLabel:(id)a3
{
  ...
  v15 = a3;
  -[SKUIGiftTextTableViewCell label](self, "label");
  ...
  if (v4 != v15 && (objc_msgSend(v15, "isEqualToString:", v4) & 1) == 0)
  {
    ...
    if (v15)
    {
      ...
      -[SKUIGiftTextTableViewCell contentView](self, "contentView");
    ...
    -[SKUIGiftTextTableViewCell setNeedsLayout](self, "setNeedsLayout");
  }
...
- (void)setPlaceholder:(id)a3
{
  ...
  v15 = a3;
  -[SKUIGiftTextTableViewCell placeholder](self, "placeholder");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  if (v4 != v15 && (objc_msgSend(v15, "isEqualToString:", v4) & 1) == 0)
  {
...
- (void)setTextView:(id)a3
{
  ...
  v11 = (SKUIGiftTextTableViewCell *)objc_claimAutoreleasedReturnValue();
...
- (void)layoutSubviews
{
  ...
  -[SKUIGiftTextTableViewCell layoutSubviews](&v56, sel_layoutSubviews);
  -[SKUIGiftTextTableViewCell contentView](self, "contentView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v13 = v12;
  v15 = v14;
  v16 = -[SKUIGiftTextTableViewCell leftToRight](self, "leftToRight");
  label = self->_label;
  v55 = v11;
  v52 = v7;
  if (v16)
  ...
  v54 = v9 + -15.0;
  v28 = v9 + -15.0 - v26;
  v29 = -[SKUIGiftTextTableViewCell leftToRight](self, "leftToRight");
  placeholderLabel = self->_placeholderLabel;
  v31 = 12.0;
  if (!v29)
  {
  ...
  objc_msgSend(MEMORY[0x1E0DC3508], "bezierPathWithRect:", v39, v41, v43, v45);
