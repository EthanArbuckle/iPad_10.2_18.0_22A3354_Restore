...
- (SKUICountdown)initWithCountdownDictionary:(id)a3
{
  ...
  {
    -[SKUICountdown initWithCountdownDictionary:].cold.1();
  }
  v43.receiver = self;
  v43.super_class = (Class)SKUICountdown;
  v5 = -[SKUICountdown init](&v43, sel_init);
  v6 = v5;
  if (v5)
  {
    -[SKUICountdown setType:](v5, "setType:", 1);
    objc_msgSend(MEMORY[0x1E0C99D68], "date");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICountdown setEndDate:](v6, "setEndDate:", v7);

    objc_msgSend(MEMORY[0x1E0C99D68], "date");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICountdown setStartDate:](v6, "setStartDate:", v8);

    -[SKUICountdown setFlapped:](v6, "setFlapped:", 1);
    -[SKUICountdown setRate:](v6, "setRate:", 1);
    ...
    -[SKUICountdown setType:](v6, "setType:", v10);
LABEL_12:
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      if ((objc_msgSend(v11, "isEqualToString:", CFSTR("number")) & 1) != 0)
      {
        v12 = 0;
LABEL_17:
        -[SKUICountdown setType:](v6, "setType:", v12);
        goto LABEL_18;
      }
...
LABEL_18:
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v16)
        -[SKUICountdown setEndDate:](v6, "setEndDate:", v16);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v17, "isEqualToString:", CFSTR("hm")) | v20 | v19 | v18)
        ...
        v21 = 0;
      -[SKUICountdown setDateFormat:](v6, "setDateFormat:", v21);
    }
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SKUICountdown setNumberFormat:](v6, "setNumberFormat:", v22);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      -[SKUICountdown numberFormat](v6, "numberFormat");
      ...
      if (v24)
      {
        ...
        v28 = v27;
        if (v27)
          -[SKUICountdown setFinalValue:](v6, "setFinalValue:", objc_msgSend(v27, "longLongValue"));

      }
    }
    if (!-[SKUICountdown finalValue](v6, "finalValue") && (objc_opt_respondsToSelector() & 1) != 0)
      -[SKUICountdown setFinalValue:](v6, "setFinalValue:", objc_msgSend(v23, "longLongValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[SKUICountdown setURL:](v6, "setURL:", v30);

    }
    -[SKUICountdown updateWithDictionary:](v6, "updateWithDictionary:", v4);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      SKUIColorWithHTMLCode(v31);
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUICountdown setFontColor:](v6, "setFontColor:", v32);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      SKUIColorWithHTMLCode(v33);
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUICountdown setFlapTopColor:](v6, "setFlapTopColor:", v34);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      SKUIColorWithHTMLCode(v35);
      v36 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUICountdown setFlapBottomColor:](v6, "setFlapBottomColor:", v36);
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0)
      -[SKUICountdown setFlapped:](v6, "setFlapped:", objc_msgSend(v37, "BOOLValue"));
    objc_msgSend(v4, "objectForKey:", CFSTR("artwork"));
    v38 = (void *)objc_claimAutoreleasedReturnValue();

    +[SKUIArtworkProvidingFactory artworkProviderForStoreResponse:](SKUIArtworkProvidingFactory, "artworkProviderForStoreResponse:", v38);
    v39 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICountdown setArtworkProvider:](v6, "setArtworkProvider:", v39);

    objc_msgSend(v4, "objectForKey:", CFSTR("endArtwork"));
    v40 = (void *)objc_claimAutoreleasedReturnValue();

    +[SKUIArtworkProvidingFactory artworkProviderForStoreResponse:](SKUIArtworkProvidingFactory, "artworkProviderForStoreResponse:", v40);
    v41 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICountdown setEndArtworkProvider:](v6, "setEndArtworkProvider:", v41);
...
- (void)updateWithDictionary:(id)a3
{
  ...
  if ((v5 & 1) != 0)
    -[SKUICountdown setInitialValue:](self, "setInitialValue:", objc_msgSend(v4, "longLongValue"));
  objc_msgSend(v11, "objectForKey:", CFSTR("rate"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  if ((objc_opt_respondsToSelector() & 1) != 0)
    -[SKUICountdown setRate:](self, "setRate:", objc_msgSend(v6, "integerValue"));
  else
    v5 = 0;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (v10)
      -[SKUICountdown setStartDate:](self, "setStartDate:", v10);
    else
      v5 = 0;
...
- (BOOL)isLoaded
{
  return -[SKUICountdown type](self, "type") || self->_isLoaded;
}
