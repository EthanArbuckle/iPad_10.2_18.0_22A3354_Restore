...
- (BOOL)activeStateIsPreview
{
  ...
  {
    -[SKUIItemState activeStateIsPreview].cold.1();
  }
  if ((-[SKUIItemState state](self, "state") & 3) != 0)
  {
    v3 = -[SKUIItemState downloadContentFlags](self, "downloadContentFlags");
  }
  else
  {
    if ((-[SKUIItemState state](self, "state") & 0x40) == 0)
      return 0;
    v3 = -[SKUIItemState libraryContentFlags](self, "libraryContentFlags");
  }
  return v3 & 1;
}
...
- (unint64_t)allContentFlags
{
  ...
  v3 = -[SKUIItemState downloadContentFlags](self, "downloadContentFlags");
  return -[SKUIItemState libraryContentFlags](self, "libraryContentFlags") | v3;
}
...
- (id)description
{
  ...
  -[SKUIItemState description](&v7, sel_description);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 32) = v8;
  ...
  v10 = -[SKUIStoreIdentifier copyWithZone:](self->_storeIdentifier, "copyWithZone:", a3);
  v11 = *(void **)(v5 + 48);
  *(_QWORD *)(v5 + 48) = v10;
