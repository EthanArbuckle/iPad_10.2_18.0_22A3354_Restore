...
{
  id v4;
  SKUILockupSwooshPageSection *v5;
  SKUILockupSwooshPageSection *v6;
  objc_super v8;
  ...
  {
    -[SKUILockupSwooshPageSection initWithPageComponent:].cold.1();
  }
  v8.receiver = self;
...
- (void)addImpressionsForIndexPath:(id)a3 toSession:(id)a4
{
  ...
  -[SKUILockupSwooshViewController indexPathsForVisibleItems](self->_swooshViewController, "indexPathsForVisibleItems");
  v17 = 0u;
  v18 = 0u;
  v19 = 0u;
  v20 = 0u;
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUILockupSwooshPageSection _addImpressionForItemIndex:toSession:](self, "_addImpressionForItemIndex:toSession:", objc_msgSend(v15, "item", (_QWORD)v17), v7);
...
- (id)cellForIndexPath:(id)a3
{
  ...
  objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", CFSTR("SKUILockupSwooshPageSectionReuseIdentifier"), v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[SKUILockupSwooshPageSection _swooshViewController](self, "_swooshViewController");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  -[SKUILockupSwooshPageSection _artworkLoader](self, "_artworkLoader");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "loadImagesForNextPageWithReason:", a3);

  -[SKUILockupSwooshPageSection _loadMissingItemsFromIndex:withReason:](self, "_loadMissingItemsFromIndex:withReason:", 0, a3);
}

- (void)setImage:(id)a3 forRequest:(id)a4
{
  -[SKUILockupSwooshArtworkLoader setImage:forRequest:](self->_artworkLoader, "setImage:forRequest:", a3, a4);
}
...
- (void)willAppearInContext:(id)a3
{
  ...
  objc_msgSend(v4, "collectionView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), CFSTR("SKUILockupSwooshPageSectionReuseIdentifier"));
  v6.receiver = self;
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if (objc_msgSend(v19, "count"))
  {
    -[SKUIStorePageSection pageComponent](self, "pageComponent");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUILockupSwooshViewController view](self->_swooshViewController, "view");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "frame");
    v9 = v8;
    v11 = v10;
    ...
    -[SKUILockupSwooshViewController setLockups:](swooshViewController, "setLockups:", v14);
...
void __85__SKUILockupSwooshPageSection_missingItemLoader_didLoadItems_invalidItemIdentifiers___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForItem:inSection:", 0, objc_msgSend(*(id *)(a1 + 32), "sectionIndex"));
...
- (void)swoosh:(id)a3 didSelectCellAtIndex:(int64_t)a4
{
  ...
  if (v8)
  {
    -[SKUIStorePageSection clickEventWithItem:elementName:index:](self, "clickEventWithItem:elementName:index:", v8, *MEMORY[0x1E0DAFCA0], a4);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if (v9)
    {
    ...
    -[SKUILockupSwooshPageSection _showProductPageForItem:index:animated:](self, "_showProductPageForItem:index:animated:", v8, a4, 1);
...
- (void)swoosh:(id)a3 willDisplayCellAtIndex:(int64_t)a4
{
  ...
  if (v8)
    -[SKUILockupSwooshPageSection _addImpressionForItemIndex:toSession:](self, "_addImpressionForItemIndex:toSession:", a4, v8);
  -[SKUILockupSwooshPageSection _loadMissingItemsFromIndex:withReason:](self, "_loadMissingItemsFromIndex:withReason:", a4, 1);
...
- (void)swooshDidSelectSeeAll:(id)a3
{
  ...
  void *v11;
  void *v12;
  SKUIStorePageViewController *v13;
  void *v14;
  void *v15;
  void *v16;
  id v17;
  ...
  if (v4)
  {
    v5 = -[SKUILink initWithURL:]([SKUILink alloc], "initWithURL:", v4);
    -[SKUIStorePageSection clickEventWithLink:elementName:index:](self, "clickEventWithLink:elementName:index:", v5, *MEMORY[0x1E0DAFC90], 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (v6)
    {
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageViewController setClientContext:](v13, "setClientContext:", v14);

    objc_msgSend(v17, "title");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageViewController setTitle:](v13, "setTitle:", v15);

    -[SKUIStorePageViewController loadURL:withCompletionBlock:](v13, "loadURL:withCompletionBlock:", v4, 0);
...
- (void)productPageOverlayDidDismiss:(id)a3
{
  ...
  -[SKUILockupSwooshViewController unhideImages](self->_swooshViewController, "unhideImages");
...
- (void)_addImpressionForItemIndex:(int64_t)a3 toSession:(id)a4
{
  ...
  swooshViewController = self->_swooshViewController;
  v6 = a4;
  -[SKUILockupSwooshViewController lockups](swooshViewController, "lockups");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_artworkLoader
{
  ...
  void *v4;
  SKUILockupSwooshArtworkLoader *v5;
  void *v6;
  void *v7;
  SKUILockupSwooshArtworkLoader *v8;
  SKUILockupSwooshArtworkLoader *v9;
  SKUILockupSwooshArtworkLoader *v10;
  void *v11;
  ...
  if (!artworkLoader)
  {
    ...
    -[SKUILockupSwooshPageSection _swooshViewController](self, "_swooshViewController");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = -[SKUILockupSwooshArtworkLoader initWithArtworkLoader:swoosh:](v5, "initWithArtworkLoader:swoosh:", v6, v7);
...
- (void)_loadMissingItemsFromIndex:(int64_t)a3 withReason:(int64_t)a4
{
  ...
  {
    -[SKUILockupSwooshPageSection _missingItemLoader](self, "_missingItemLoader");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_missingItemLoader
{
  ...
  if (!missingItemLoader)
  {
    ...
    if (v10)
      -[SKUIMissingItemLoader setKeyProfile:](self->_missingItemLoader, "setKeyProfile:", v10);
...
- (void)_showProductPageForItem:(id)a3 index:(int64_t)a4 animated:(BOOL)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (SKUIUserInterfaceIdiom(v10) == 1 && SKUIItemKindIsSoftwareKind(objc_msgSend(v7, "itemKind")))
  {
    if (!self->_overlayController)
    {
      ...
      v16 = a4;
      v15 = v7;
      -[SKUIStorePageSection sendXEventWithItem:completionBlock:](self, "sendXEventWithItem:completionBlock:", v15, v12);
...
{
  SKUIProductPageOverlayController *v3;
  uint64_t v4;
  void *v5;
  id v6;
  ...
  if ((a2 & 1) == 0)
  {
    v3 = -[SKUIProductPageOverlayController initWithParentViewController:]([SKUIProductPageOverlayController alloc], "initWithParentViewController:", *(_QWORD *)(a1 + 40));
    v4 = *(_QWORD *)(a1 + 32);
    v5 = *(void **)(v4 + 104);
    *(_QWORD *)(v4 + 104) = v3;
...
- (id)_swooshViewController
{
  ...
  SKUILockupSwooshViewController *v9;
  SKUILockupSwooshViewController *v10;
  void *v11;
  SKUILockupSwooshViewController *v12;
  void *v13;
  ...
  if (!swooshViewController)
  {
    ...
    -[SKUIStorePageSection pageComponent](self, "pageComponent");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = -[SKUILockupSwooshViewController initWithSwoosh:](v6, "initWithSwoosh:", v7);
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUILockupSwooshViewController setClientContext:](v10, "setClientContext:", v11);

    -[SKUILockupSwooshViewController setDelegate:](self->_swooshViewController, "setDelegate:", self);
    v12 = self->_swooshViewController;
    objc_msgSend(v4, "colorScheme");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUILockupSwooshViewController setColorScheme:](v12, "setColorScheme:", v13);
