...
- (void)setChildContentInsets:(UIEdgeInsets)a3
{
  ...
  -[SKUIRedeemResultSimpleTableViewCell setNeedsLayout](self, "setNeedsLayout");
}
...
- (void)setChildContentView:(id)a3
{
  ...
  if (childContentView == v5)
  {
    ...
    if (v8)
      goto LABEL_9;
LABEL_8:
    -[SKUIRedeemResultSimpleTableViewCell contentView](self, "contentView");
...
- (void)layoutSubviews
{
  ...
  -[SKUIRedeemResultSimpleTableViewCell layoutSubviews](&v10, sel_layoutSubviews);
