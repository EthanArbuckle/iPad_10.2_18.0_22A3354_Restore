...
+ (void)requestLayoutWithMenus:(id)a3 width:(int64_t)a4 context:(id)a5
{
  ...
  {
    +[SKUINavigationBarMenusView requestLayoutWithMenus:width:context:].cold.1();
  }
...
- (void)reloadWithMenus:(id)a3 width:(int64_t)a4 context:(id)a5
{
  ...
  id v15;
  id v16;
  SKUINavigationBarMenusView *v17;
  int64_t v18;
...
- (void)setContentInset:(UIEdgeInsets)a3
{
    ...
    || self->_contentInset.bottom != a3.bottom)
  {
    ...
    -[SKUINavigationBarMenusView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SKUINavigationBarMenusView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  ...
  else
  {
    ...
    if (v8 > v4)
    {
      ...
      if (v8 > v4)
      {
        objc_msgSend(v9, "sortedArrayWithOptions:usingComparator:", 0, &__block_literal_global_20);
