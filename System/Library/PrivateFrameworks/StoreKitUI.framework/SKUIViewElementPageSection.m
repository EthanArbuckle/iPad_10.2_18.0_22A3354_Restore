...
{
  id v4;
  SKUIViewElementPageSection *v5;
  SKUIViewElementPageSection *v6;
  objc_super v8;
  ...
  {
    -[SKUIViewElementPageSection initWithPageComponent:].cold.1();
  }
  v8.receiver = self;
  ...
  v6 = v5;
  if (v5)
    -[SKUIViewElementPageSection _reloadViewElementProperties](v5, "_reloadViewElementProperties");
...
- (int64_t)applyUpdateType:(int64_t)a3
{
  ...
  if (a3 != 2)
    -[SKUIViewElementPageSection _reloadViewElementProperties](self, "_reloadViewElementProperties");
  v6.receiver = self;
...
- (id)cellForIndexPath:(id)a3
{
  ...
  if (self->_rendersWithPerspective && objc_msgSend(v7, "conformsToProtocol:", &unk_1EF42F8D8))
  {
    v16 = v7;
    -[SKUIStorePageSection context](self, "context");
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  if (-[SKUIViewElementPageSection _showsImageReflection](self, "_showsImageReflection"))
    v10 = v10 + v10;
...
- (void)collectionViewWillApplyLayoutAttributes:(id)a3
{
  ...
  v4 = a3;
  if (-[SKUIViewElementPageSection _stretchesToFitCollectionViewBounds](self, "_stretchesToFitCollectionViewBounds"))
  {
    -[SKUIStorePageSection context](self, "context");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "collectionView");
  ...
  -[SKUIStorePageSection collectionViewWillApplyLayoutAttributes:](&v31, sel_collectionViewWillApplyLayoutAttributes_, v4);
...
- (int64_t)defaultItemPinningStyle
{
  ...
  {
    v5 = -[SKUIStorePageSection isTopSection](self, "isTopSection");
  ...
  return -[SKUIStorePageSection defaultItemPinningStyle](&v7, sel_defaultItemPinningStyle);
}
...
- (void)entityProvider:(id)a3 didInvalidateWithContext:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SKUIViewElementPageSection _requestCellLayout](self, "_requestCellLayout");
  v8.receiver = self;
  v8.super_class = (Class)SKUIViewElementPageSection;
...
- (void)getModalSourceViewForViewElement:(id)a3 completionBlock:(id)a4
{
  ...
  void *v14;
  void *v15;
  SKUIModalSourceViewProvider *v16;
  SKUIModalSourceViewProvider *v17;
  void *v18;
  id v19;
  ...
  if (v9)
  {
    ...
    if (v15)
      ...
      v18 = v13;
    -[SKUIModalSourceViewProvider setOriginalSourceView:](v16, "setOriginalSourceView:", v18);
...
- (UIEdgeInsets)pinningContentInsetForItemAtIndexPath:(id)a3
{
  ...
  {
    v14 = 0.0;
    if (-[SKUIStorePageSection pinningStyleForItemAtIndexPath:](self, "pinningStyleForItemAtIndexPath:", v4) != 3
...
- (id)previewingContext:(id)a3 viewControllerForLocation:(CGPoint)a4
{
  ...
  -[SKUIStorePageSection pageComponent](self, "pageComponent", a3, a4.x, a4.y);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "viewElement");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  _BOOL8 v5;
  SKUIViewElementView **p_lastCell;
  id v8;
  id WeakRetained;
  int v10;
...
- (void)_reloadViewElementProperties
{
  ...
  -[SKUIViewElementPageSection defaultVerticalInset](self, "defaultVerticalInset");
  ...
  if (v11 > 49)
  {
    if (v11 > 108)
    {
      if (v11 <= 133)
      {
        if (v11 == 109)
        {
          ...
          objc_storeStrong((id *)&self->_reuseIdentifier, CFSTR("SKUISegmentedControlReuseIdentifier"));
        ...
        {
          self->_cellClass = (Class)objc_opt_class();
          v12 = CFSTR("SKUIStackListReuseIdentifier");
          goto LABEL_40;
        }
        goto LABEL_41;
      }
      ...
      {
        self->_cellClass = (Class)objc_opt_class();
        v12 = CFSTR("SKUIStarHistogramCellReuseIdentifier");
        goto LABEL_40;
      }
      if (v11 != 141)
        goto LABEL_41;
    ...
    else
    {
      if (v11 > 65)
      {
        if (v11 == 66)
        {
          switch(objc_msgSend(v21, "lockupViewType"))
          {
            ...
            case 8:
              self->_cellClass = (Class)objc_opt_class();
              v12 = CFSTR("SKUIHorizontalLockupReuseID");
              goto LABEL_40;
            case 3:
              self->_cellClass = (Class)objc_opt_class();
            ...
            case 5:
              ...
              self->_cellClass = (Class)objc_opt_class();
              objc_storeStrong((id *)&self->_reuseIdentifier, CFSTR("SKUIHorizontalLockupReuseID"));
              v19 = 1.0;
        ...
        {
          self->_cellClass = (Class)objc_opt_class();
          v12 = CFSTR("SKUIOfferReuseIdentifier");
          goto LABEL_40;
        }
        goto LABEL_41;
      }
      if (v11 != 50)
      {
        ...
        {
          self->_cellClass = (Class)objc_opt_class();
          v12 = CFSTR("SKUIHorizontalListReuseIdentifier");
LABEL_40:
  ...
  if (v11 <= 26)
  {
    ...
    {
      self->_cellClass = (Class)objc_opt_class();
      v12 = CFSTR("SKUIActivityIndicatorReuseIdentifier");
      goto LABEL_40;
    }
    if (v11 != 12)
    {
      ...
      {
        self->_cellClass = (Class)objc_opt_class();
        objc_storeStrong((id *)&self->_reuseIdentifier, CFSTR("SKUICardViewElementReuseIdentifier"));
        self->_firstSectionTopInset = 0.0;
      }
      goto LABEL_41;
    }
LABEL_30:
    self->_cellClass = (Class)objc_opt_class();
    objc_storeStrong((id *)&self->_reuseIdentifier, CFSTR("SKUIButtonReuseIdentifier"));
    v19 = 12.0;
    goto LABEL_37;
  }
  if (v11 > 47)
  {
    if (v11 != 48)
    {
      ...
      p_cellContentInset->left = 0.0;
      self->_firstSectionTopInset = 0.0;
      objc_storeStrong((id *)&self->_reuseIdentifier, CFSTR("SKUIImageReuseIdentifier"));
...
LABEL_27:
    ...
    self->_cellClass = (Class)objc_opt_class();
    objc_storeStrong((id *)&self->_reuseIdentifier, CFSTR("SKUISectionHeaderReuseIdentifier"));
    v19 = 10.0;
LABEL_37:
  ...
  {
    self->_cellClass = (Class)objc_opt_class();
    v12 = CFSTR("SKUIContentUnavailableReuseIdentifier");
    goto LABEL_40;
  }
  if (v11 == 40)
  {
    *(_OWORD *)&p_cellContentInset->top = xmmword_1BBED2AB0;
    *(_OWORD *)&p_cellContentInset->bottom = xmmword_1BBED2AB0;
    self->_cellClass = (Class)objc_opt_class();
    self->_firstSectionTopInset = 0.0;
    v12 = CFSTR("SKUIFilterBarReuseIdentifier");
    goto LABEL_40;
  }
LABEL_41:
...
- (BOOL)_stretchesToFitCollectionViewBounds
{
  ...
  v3 = -[SKUIStorePageSection isBottomSection](self, "isBottomSection");
  if (v3)
  {
    -[SKUIStorePageSection pageComponent](self, "pageComponent");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
