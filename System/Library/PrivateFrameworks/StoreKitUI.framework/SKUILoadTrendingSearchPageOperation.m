...
- (SKUILoadTrendingSearchPageOperation)initWithClientContext:(id)a3 pageURL:(id)a4 outputBlock:(id)a5
{
  ...
  id v10;
  id v11;
  SKUILoadTrendingSearchPageOperation *v12;
  SKUILoadTrendingSearchPageOperation *v13;
  uint64_t v14;
  id outputBlock;
  objc_super v17;
  ...
  {
    -[SKUILoadTrendingSearchPageOperation initWithClientContext:pageURL:outputBlock:].cold.1();
  }
  v17.receiver = self;
  v17.super_class = (Class)SKUILoadTrendingSearchPageOperation;
  v12 = -[SKUILoadTrendingSearchPageOperation init](&v17, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (void)main
{
  ...
  -[SKUILoadTrendingSearchPageOperation pageURL](self, "pageURL");
  ...
  if (v19[5])
  {
    v7 = objc_alloc(MEMORY[0x1E0DAF698]);
    v8 = (void *)objc_msgSend(v7, "initWithURL:", v19[5]);
    +[SSVURLDataConsumer consumer](SKUITrendingSearchPageConsumer, "consumer");
