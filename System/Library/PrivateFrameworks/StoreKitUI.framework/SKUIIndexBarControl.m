...
{
  SKUIIndexBarControl *v3;
  SKUIIndexBarControl *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)SKUIIndexBarControl;
  v3 = -[SKUIIndexBarControl initWithCoder:](&v6, sel_initWithCoder_, a3);
  v4 = v3;
  if (v3)
...
- (void)drawRect:(CGRect)a3
{
  ...
  -[SKUIIndexBarControl _displayEntries](self, "_displayEntries", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIIndexBarControl _visibleBounds](self, "_visibleBounds");
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        CGRectGetMinX(v36);
        -[SKUIIndexBarControl traitCollection](self, "traitCollection");
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  y = a3.y;
  x = a3.x;
  -[SKUIIndexBarControl bounds](self, "bounds", a4);
...
- (void)setBounds:(CGRect)a3
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  -[SKUIIndexBarControl bounds](self, "bounds");
  v9 = v8;
  v11 = v10;
  v15.receiver = self;
  ...
  -[SKUIIndexBarControl bounds](self, "bounds");
  if (v9 != v13 || v11 != v12)
    -[SKUIIndexBarControl _invalidateForChangedLayoutProperties](self, "_invalidateForChangedLayoutProperties");
}
...
- (void)setFrame:(CGRect)a3
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  -[SKUIIndexBarControl frame](self, "frame");
  v9 = v8;
  v11 = v10;
  v15.receiver = self;
  v15.super_class = (Class)SKUIIndexBarControl;
...
- (void)setTransform:(CGAffineTransform *)a3
{
  ...
  -[SKUIIndexBarControl transform](self, "transform");
  v8.receiver = self;
  ...
  *(_OWORD *)&t1.tx = *(_OWORD *)&a3->tx;
  -[SKUIIndexBarControl setTransform:](&v8, sel_setTransform_, &t1);
  -[SKUIIndexBarControl transform](self, "transform");
  t1 = v9;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  height = a3.height;
  width = a3.width;
  -[SKUIIndexBarControl _totalSize](self, "_totalSize");
  if (width < v5)
    v5 = width;
  v7 = round(v5);
  if (height < v6)
...
- (void)tintColorDidChange
{
  ...
  -[SKUIIndexBarControl tintColorDidChange](&v13, sel_tintColorDidChange);
  -[SKUIIndexBarControl tintColor](self, "tintColor");
  ...
  -[SKUIIndexBarControl setNeedsDisplay](self, "setNeedsDisplay");
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  v4 = a3;
  -[SKUIIndexBarControl traitCollectionDidChange:](&v10, sel_traitCollectionDidChange_, v4);
  -[SKUIIndexBarControl traitCollection](self, "traitCollection", v10.receiver, v10.super_class);
...
- (BOOL)beginTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SKUIIndexBarControl beginTrackingWithTouch:withEvent:](&v9, sel_beginTrackingWithTouch_withEvent_, v7, v6);
...
- (BOOL)continueTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SKUIIndexBarControl continueTrackingWithTouch:withEvent:](&v9, sel_continueTrackingWithTouch_withEvent_, v7, v6);
  -[SKUIIndexBarControl _sendSelectionForTouch:withEvent:](self, "_sendSelectionForTouch:withEvent:", v7, v6, v9.receiver, v9.super_class);
...
- (void)endTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SKUIIndexBarControl endTrackingWithTouch:withEvent:](&v9, sel_endTrackingWithTouch_withEvent_, v7, v6);
  -[SKUIIndexBarControl _sendSelectionForTouch:withEvent:](self, "_sendSelectionForTouch:withEvent:", v7, v6, v9.receiver, v9.super_class);
...
- (void)cancelTrackingWithEvent:(id)a3
{
  ...
  -[SKUIIndexBarControl cancelTrackingWithEvent:](&v5, sel_cancelTrackingWithEvent_, a3);
  lastSelectedIndexPath = self->_lastSelectedIndexPath;
  self->_lastSelectedIndexPath = 0;
...
- (void)setContentEdgeInsets:(UIEdgeInsets)a3
{
    ...
    || self->_contentEdgeInsets.bottom != a3.bottom)
  {
    ...
    -[SKUIIndexBarControl _invalidateDisplayEntries](self, "_invalidateDisplayEntries");
  }
}
...
- (void)setDataSource:(id)a3
{
  ...
  if (WeakRetained != obj)
  {
    ...
    *(_BYTE *)&self->_dataSourceDelegateFlags = *(_BYTE *)&self->_dataSourceDelegateFlags & 0xFD | v7;
    ...
    -[SKUIIndexBarControl reloadData](self, "reloadData");
  }
...
{
  SKUIIndexBarEntry *combinedEntry;
...
- (id)_allEntries
{
  ...
  v4[4] = self;
  v4[5] = &v5;
  -[SKUIIndexBarControl _enumerateEntryIndexPathsUsingBlock:](self, "_enumerateEntryIndexPathsUsingBlock:", v4);
  v2 = (id)v6[5];
...
- (void)_enumerateEntryIndexPathsUsingBlock:(id)a3
{
  ...
  if (v4)
  {
    v5 = -[SKUIIndexBarControl _numberOfSections](self, "_numberOfSections");
    v13 = 0;
    if (v5 >= 1)
    {
      v6 = v5;
      ...
      do
      {
        v8 = -[SKUIIndexBarControl _numberOfEntriesInSection:](self, "_numberOfEntriesInSection:", v7);
        v9 = v13;
        if (v8 >= 1 && !v13)
        {
          v10 = v8;
...
- (int64_t)_numberOfEntriesInSection:(int64_t)a3
{
    ...
    || (v7 = NSMapGet(sectionIndexToNumberOfEntriesMapTable, (const void *)(a3 + 1))) == 0)
  {
    ...
    {
      v10 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 1282, 0, -[SKUIIndexBarControl _numberOfSections](self, "_numberOfSections"));
...
- (id)_combinedEntry
{
  SKUIIndexBarEntry *v3;
  void *WeakRetained;
  SKUIIndexBarEntry *v5;
  SKUIIndexBarEntry *combinedEntry;
  ...
  if (!self->_hasValidCombinedEntry)
  {
    if ((*(_BYTE *)&self->_dataSourceDelegateFlags & 1) != 0)
    {
      ...
      v5 = (SKUIIndexBarEntry *)objc_claimAutoreleasedReturnValue();
      combinedEntry = self->_combinedEntry;
    ...
    {
      +[SKUIIndexBarEntry systemCombinedEntry](SKUIIndexBarEntry, "systemCombinedEntry");
      v3 = (SKUIIndexBarEntry *)objc_claimAutoreleasedReturnValue();
...
- (void)_configureNewEntry:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    -[SKUIIndexBarControl defaultTextAttributes](self, "defaultTextAttributes");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_displayEntries
{
  ...
  else
  {
    ...
    v50 = self;
    -[SKUIIndexBarControl _allEntries](self, "_allEntries");
    ...
    if (objc_msgSend(v45, "count"))
    {
      ...
      v20 = v10 - (left + right);
      v21 = v12 - (top + bottom);
      -[SKUIIndexBarControl _sizeForEntries:](v50, "_sizeForEntries:", v45);
      v23 = v22;
      v66.origin.x = v18;
      v66.origin.y = v19;
      v66.size.width = v20;
      ...
      else
      {
        ...
        v25 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", 0);
        if (v61[3])
        {
          v26 = 1;
          v46 = 2;
              ...
              do
              {
                ...
                for (i = 0; i != v49; ++i)
                {
                  ...
                  else
                  {
                    ...
                    do
                    {
                      -[SKUIIndexBarControl _combinedEntry](v50, "_combinedEntry");
...
LABEL_20:
            ...
            -[SKUIIndexBarControl _sizeForEntries:](v50, "_sizeForEntries:", v25);
            v38 = v37;
            v67.origin.x = v18;
            v67.origin.y = v19;
            v67.size.width = v20;
        ...
        {
          -[SKUIIndexBarControl _displayEntriesThatFitInViewForGroupedEntries](v50, "_displayEntriesThatFitInViewForGroupedEntries");
...
- (id)_displayEntriesThatFitInViewForGroupedEntries
{
  ...
  -[SKUIIndexBarControl _allRequiredEntries](self, "_allRequiredEntries");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v4 >= 2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIIndexBarControl _combinedEntry](self, "_combinedEntry");
      ...
      while (v18 < v4);
      -[SKUIIndexBarControl _sizeForEntries:](self, "_sizeForEntries:", v5);
      v23 = v22;
      v27.origin.x = v15;
      v27.origin.y = v14;
      v27.size.width = v13;
...
- (id)_entryAtIndexPath:(id)a3
{
  ...
  v4 = a3;
  -[NSMapTable objectForKey:](self->_indexPathToEntryMapTable, "objectForKey:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v5)
  {
    WeakRetained = objc_loadWeakRetained((id *)&self->_dataSource);
    objc_msgSend(WeakRetained, "indexBarControl:entryAtIndexPath:", self, v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();

    -[SKUIIndexBarControl _configureNewEntry:](self, "_configureNewEntry:", v5);
    indexPathToEntryMapTable = self->_indexPathToEntryMapTable;
    ...
    -[NSMapTable setObject:forKey:](indexPathToEntryMapTable, "setObject:forKey:", v5, v4);
  }
...
{
  -[SKUIIndexBarControl _invalidateDisplayEntries](self, "_invalidateDisplayEntries");
  -[SKUIIndexBarControl _reloadLineSpacing](self, "_reloadLineSpacing");
}
...
- (void)_sendSelectionForTouch:(id)a3 withEvent:(id)a4
{
  ...
  v15 = v14;
  v17 = v16;
  v18 = -[SKUIIndexBarControl _totalEntryCount](self, "_totalEntryCount");
  v39.origin.x = v11;
  v39.origin.y = v13;
  v39.size.width = v15;
  v39.size.height = v17;
...
LABEL_11:
  ...
  v37 = __Block_byref_object_dispose__46;
  v33 = 0;
  v34 = &v33;
  v26 = v25 & ~(v25 >> 63);
  v35 = 0x3032000000;
  ...
  if (v26 < v18)
  {
    ...
    v31[1] = 3221225472;
    v31[2] = __56__SKUIIndexBarControl__sendSelectionForTouch_withEvent___block_invoke;
    v31[3] = &unk_1E73A5690;
    v31[5] = &v33;
    v31[6] = v26;
    v31[4] = v32;
    -[SKUIIndexBarControl _enumerateEntryIndexPathsUsingBlock:](self, "_enumerateEntryIndexPathsUsingBlock:", v31);
...
void __56__SKUIIndexBarControl__sendSelectionForTouch_withEvent___block_invoke(_QWORD *a1, void *a2, _BYTE *a3)
{
  id v6;
  uint64_t v7;
  uint64_t v8;
...
double __39__SKUIIndexBarControl__sizeForEntries___block_invoke(_QWORD *a1, void *a2, unint64_t a3)
{
  double v5;
  double v6;
  uint64_t v7;
...
- (CGSize)_sizeForEntryAtIndexPath:(id)a3
{
  ...
  -[SKUIIndexBarControl _entryAtIndexPath:](self, "_entryAtIndexPath:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CGSize)_totalSize
{
  ...
  if (!self->_hasValidTotalSize)
  {
    ...
    v8[5] = &v13;
    v8[6] = &v9;
    -[SKUIIndexBarControl _enumerateEntryIndexPathsUsingBlock:](self, "_enumerateEntryIndexPathsUsingBlock:", v8);
    v3 = v14;
    if (*((_BYTE *)v10 + 24))
    {
...
- (CGRect)_visibleBounds
{
  ...
  -[SKUIIndexBarControl _displayEntries](self, "_displayEntries");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIIndexBarControl bounds](self, "bounds");
  v5 = v4;
  v7 = v6;
...
void __37__SKUIIndexBarControl__visibleBounds__block_invoke(_QWORD *a1, void *a2, unint64_t a3)
{
  double v5;
  double v6;
  double v7;
...
{
  return (SKUIIndexBarControlDataSource *)objc_loadWeakRetained((id *)&self->_dataSource);
}
...
{
  return (SKUIIndexBarControlDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
