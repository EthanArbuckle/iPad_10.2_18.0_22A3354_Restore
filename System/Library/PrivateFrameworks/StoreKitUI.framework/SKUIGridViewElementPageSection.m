...
{
  id v4;
  SKUIGridViewElementPageSection *v5;
  SKUIGridViewElementPageSectionConfiguration *v6;
  ...
  {
    -[SKUIGridViewElementPageSection initWithPageComponent:].cold.1();
  }
  v9.receiver = self;
  ...
  if (v5)
  {
    ...
    -[SKUIGridViewElementPageSection _reloadViewElementProperties](v5, "_reloadViewElementProperties");
  }
...
- (int64_t)applyUpdateType:(int64_t)a3
{
  ...
  -[SKUIGridViewElementPageSection _reloadViewElementProperties](self, "_reloadViewElementProperties");
  ...
  -[SKUIGridViewElementPageSection _resetLayoutProperties](self, "_resetLayoutProperties");
  -[SKUIGridViewElementPageSection _requestLayoutForCells](self, "_requestLayoutForCells");
  return 1;
}
...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  -[SKUIGridViewElementPageSectionConfiguration backgroundColorForViewElement:](self->_configuration, "backgroundColorForViewElement:", v5);
  ...
  else
  {
    if (!v6)
    {
      ...
      -[SKUIStorePageSection backgroundColorForIndexPath:](&v17, sel_backgroundColorForIndexPath_, v4);
      v6 = (id)objc_claimAutoreleasedReturnValue();
    }
    v6 = v6;
    v15 = v6;
...
- (id)cellForIndexPath:(id)a3
{
  ...
  -[SKUIGridViewElementPageSectionConfiguration cellForViewElement:indexPath:](self->_configuration, "cellForViewElement:indexPath:", v6, v5);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  -[NSArray objectAtIndex:](viewElements, "objectAtIndex:", objc_msgSend(v5, "item"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIGridViewElementPageSectionConfiguration cellSizeForViewElement:indexPath:](self->_configuration, "cellSizeForViewElement:indexPath:", v6, v5);
  v8 = v7;
  v10 = v9;
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  _QWORD v7[4];
  id v8;
  SKUIGridViewElementPageSection *v9;
  id v10;
  id location;
  ...
  if (v5)
  {
    ...
    {
      objc_msgSend(v6, "dispatchEvent:eventAttribute:canBubble:isCancelable:extraInfo:completionBlock:", 0x1E73B7150, 0x1E73B7170, 1, 0, 0, 0);
    }
  }
...
- (void)collectionViewWillScrollToOffset:(CGPoint)a3 visibleRange:(SKUIIndexPathRange *)a4
{
  ...
  y = a3.y;
  x = a3.x;
  v8 = -[SKUIGridViewElementPageSection numberOfCells](self, "numberOfCells");
...
- (void)expandEditorialForLabelElement:(id)a3 indexPath:(id)a4
{
  ...
  v7 = a4;
  -[SKUIViewElementLayoutContext expandEditorialForLabelElement:](cellLayoutContext, "expandEditorialForLabelElement:", a3);
  -[SKUIStorePageSection context](self, "context");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)getModalSourceViewForViewElement:(id)a3 completionBlock:(id)a4
{
  ...
  _QWORD v16[4];
  id v17;
  SKUIGridViewElementPageSection *v18;
  uint64_t *v19;
  uint64_t v20;
  uint64_t *v21;
  uint64_t v22;
  ...
  if (v21[5])
  {
    ...
    if (v15)
      -[SKUIModalSourceViewProvider setOriginalSourceView:](v10, "setOriginalSourceView:", v15);
    else
      -[SKUIModalSourceViewProvider setOriginalSourceView:](v10, "setOriginalSourceView:", v13);
...
void __83__SKUIGridViewElementPageSection_getModalSourceViewForViewElement_completionBlock___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, _BYTE *a4)
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForItem:inSection:", a3, objc_msgSend(*(id *)(a1 + 40), "sectionIndex"));
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  if (v11 < v17)
  {
    ...
    do
    {
      ...
      if (-[objc_class prefetchResourcesForViewElement:reason:context:](-[SKUIGridViewElementPageSectionConfiguration cellClassForViewElement:](self->_configuration, "cellClassForViewElement:", v19), "prefetchResourcesForViewElement:reason:context:", v19, a3, self->_cellLayoutContext))
      {
        if (-[SKUIGridViewElementPageSectionConfiguration viewElementIsStandardCard:](self->_configuration, "viewElementIsStandardCard:", v19))
        {
          v20 = 10
              / -[SKUIGridViewElementPageSectionConfiguration numberOfColumns](self->_configuration, "numberOfColumns");
          if (v20 <= 1)
            v20 = 1;
        }
        else
...
- (void)reloadCellWithIndexPath:(id)a3 reason:(int64_t)a4
{
  ...
  -[SKUIGridViewElementPageSectionConfiguration reloadCellWithIndexPath:forViewElement:reason:](self->_configuration, "reloadCellWithIndexPath:forViewElement:reason:", v7, v8, a4);
...
- (UIEdgeInsets)sectionContentInset
{
  ...
  -[SKUIStorePageSection sectionContentInset](&v26, sel_sectionContentInset);
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v11 = v10;
...
- (id)targetScrollingIndexPathForElementWithIndexBarEntryID:(id)a3 relativeSectionIndex:(int64_t)a4
{
  ...
  if (v8)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForItem:inSection:", v12, -[SKUIStorePageSection sectionIndex](self, "sectionIndex"));
      v13 = (void *)objc_claimAutoreleasedReturnValue();
    }
...
- (void)willAppearInContext:(id)a3
{
  ...
  SKUIViewElementLayoutContext *cellLayoutContext;
  SKUIViewElementLayoutContext *v9;
  void *v10;
  void *v11;
  void *v12;
  void *v13;
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[SKUIGridViewElementPageSectionConfiguration showsEditMode](self->_configuration, "showsEditMode"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewElementLayoutContext setAggregateValue:forKey:](v9, "setAggregateValue:forKey:", v10, 0x1E73B7AB0);
  ...
  -[SKUIViewElementLayoutContext setAggregateValue:forKey:](self->_cellLayoutContext, "setAggregateValue:forKey:", &unk_1E749B7B0, 0x1E73AEF10);
  -[SKUIStorePageSection pageComponent](self, "pageComponent");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "viewElement");
  v12 = (void *)objc_claimAutoreleasedReturnValue();

  -[SKUIViewElementLayoutContext setContainerViewElementType:](self->_cellLayoutContext, "setContainerViewElementType:", objc_msgSend(v12, "elementType"));
  if (-[SKUIGridViewElementPageSection _containsOnlyShelfElements](self, "_containsOnlyShelfElements"))
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  id v15;
  id v16;
  SKUIGridViewElementPageSection *v17;
  ...
  v11 = v7;
  v12 = v9;
  -[SKUIGridViewElementPageSection _enumerateVisibleViewElementsUsingBlock:](self, "_enumerateVisibleViewElementsUsingBlock:", v13);
...
void __74__SKUIGridViewElementPageSection__enumerateVisibleViewElementsUsingBlock___block_invoke(_QWORD *a1, void *a2, uint64_t a3, uint64_t a4)
{
  uint64_t v6;
  void *v7;
  id v8;
...
- (void)_reloadViewElementProperties
{
  ...
  -[SKUIGridViewElementPageSectionConfiguration setRendersWithPerspective:](self->_configuration, "setRendersWithPerspective:", objc_msgSend(v7, "rendersWithPerspective"));
  objc_msgSend(v7, "flattenedChildren");
  v4 = (NSArray *)objc_claimAutoreleasedReturnValue();
  viewElements = self->_viewElements;
  self->_viewElements = v4;

  -[SKUIGridViewElementPageSectionConfiguration updateStylePropertiesForGridViewElement:gridItemViewElements:numberOfGridItems:](self->_configuration, "updateStylePropertiesForGridViewElement:gridItemViewElements:numberOfGridItems:", v7, self->_viewElements, -[NSArray count](self->_viewElements, "count"));
  objc_opt_class();
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIGridViewElementPageSectionConfiguration requestCellLayoutForViewElement:](self->_configuration, "requestCellLayoutForViewElement:", *(_QWORD *)(*((_QWORD *)&v8 + 1) + 8 * v7++), (_QWORD)v8);
      }
      while (v5 != v7);
