...
{
  SKUIRedeemPreflightOperation *v3;
  dispatch_queue_t v4;
  ...
  {
    -[SKUIRedeemPreflightOperation _initSKUIRedeemPreflightOperation].cold.1();
  }
  v9.receiver = self;
  v9.super_class = (Class)SKUIRedeemPreflightOperation;
  v3 = -[SKUIRedeemPreflightOperation init](&v9, sel_init);
  if (v3)
  {
...
- (SKUIRedeemPreflightOperation)initWithClientContext:(id)a3 redeemCode:(id)a4 forcesAuthentication:(BOOL)a5
{
  ...
  id v10;
  id *v11;
  SKUIRedeemPreflightOperation *v12;
  uint64_t v13;
  NSString *redeemCode;

  v9 = a3;
  v10 = a4;
  v11 = -[SKUIRedeemPreflightOperation _initSKUIRedeemPreflightOperation](self, "_initSKUIRedeemPreflightOperation");
...
void __43__SKUIRedeemPreflightOperation_outputBlock__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (void)main
{
  ...
  void *v11;
  NSObject *v12;
  SKUIReloadConfigurationOperation *v13;
  void *v14;
  void *v15;
  void *v16;
  SKUIRedeemConfiguration *v17;
  void *v18;
  uint64_t v19;
  void *v20;
  SKUIRedeemConfiguration *v21;
  dispatch_semaphore_t v22;
  NSObject *v23;
  SKUIRedeemConfiguration *v24;
  uint64_t v25;
  void *v26;
  uint64_t v27;
  uint64_t v28;
  ...
  void *v30;
  SKUIRedeemPreflightResult *v31;
  SKUIRedeemConfiguration *v32;
  dispatch_semaphore_t v33;
  _QWORD v34[4];
  SKUIRedeemPreflightResult *v35;
  _QWORD v36[4];
  SKUIRedeemPreflightResult *v37;
  dispatch_semaphore_t v38;

  v3 = objc_alloc_init(SKUIRedeemPreflightResult);
  -[SKUIRedeemPreflightResult setClientContext:](v3, "setClientContext:", self->_clientContext);
  if (-[SKUIRedeemPreflightOperation forcesAuthentication](self, "forcesAuthentication"))
  {
    v4 = objc_alloc_init(MEMORY[0x1E0DDC140]);
    -[SKUIRedeemPreflightOperation _authenticationContext](self, "_authenticationContext");
    ...
    if ((objc_msgSend(v4, "canPerformExtendedBiometricActionsForAccountIdentifier:", v6) & 1) == 0)
    {
      ...
      v8 = objc_alloc(MEMORY[0x1E0DAF488]);
      -[SKUIRedeemPreflightOperation _authenticationContext](self, "_authenticationContext");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = (void *)objc_msgSend(v8, "initWithAuthenticationContext:", v9);

      -[SKUIRedeemPreflightOperation redeemViewController](self, "redeemViewController");
  ...
  if (!self->_clientContext && !-[SKUIRedeemPreflightResult resultType](v3, "resultType"))
  {
    ...
    v34[3] = &unk_1E73A5C50;
    v35 = v3;
    -[SKUIReloadConfigurationOperation setOutputBlock:](v13, "setOutputBlock:", v34);
    -[SKUIReloadConfigurationOperation main](v13, "main");

  }
  if (!-[SKUIRedeemPreflightResult resultType](v3, "resultType")
    && -[SKUIRedeemPreflightOperation loadsRedeemCodeMetadata](self, "loadsRedeemCodeMetadata")
    && self->_redeemCode)
  {
    -[SKUIRedeemPreflightResult clientContext](v3, "clientContext");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIRedeemPreflightOperation _redeemCodeMetadataWithClientContext:](self, "_redeemCodeMetadataWithClientContext:", v14);
    v15 = (void *)objc_claimAutoreleasedReturnValue();

    -[SKUIRedeemPreflightResult setCodeMetadata:](v3, "setCodeMetadata:", v15);
  }
  -[SKUIRedeemPreflightOperation redeemConfiguration](self, "redeemConfiguration");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (v16 && !-[SKUIRedeemPreflightResult resultType](v3, "resultType"))
  {
    ...
    v21 = -[SKUIRedeemConfiguration initWithOperationQueue:category:clientContext:](v17, "initWithOperationQueue:category:clientContext:", v18, v19, v20);
    ...
    v23 = v22;
    v24 = v21;
    -[SKUIRedeemConfiguration loadConfigurationWithCompletionBlock:](v24, "loadConfigurationWithCompletionBlock:", &v27);
    dispatch_semaphore_wait(v23, 0xFFFFFFFFFFFFFFFFLL);

  }
  -[SKUIRedeemPreflightOperation outputBlock](self, "outputBlock", v27, v28, v29, v30);
...
void __36__SKUIRedeemPreflightOperation_main__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v6)
  {
    v5 = -[SKUIClientContext initWithConfigurationDictionary:]([SKUIClientContext alloc], "initWithConfigurationDictionary:", v6);
...
- (id)_authenticationContext
{
  ...
  if (v3)
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF5C0]), "initWithAccount:", v3);
...
intptr_t __69__SKUIRedeemPreflightOperation__redeemCodeMetadataWithClientContext___block_invoke(uint64_t a1, void *a2)
{
  objc_class *v3;
  id v4;
  void *v5;
  ...
  if (a2)
  {
    ...
    v9 = (void *)objc_msgSend(v8, "initWithName:value:", *MEMORY[0x1E0DAFD70], *(_QWORD *)(*(_QWORD *)(a1 + 32) + 280));
...
{
  return (SKUIRedeemViewControllerLegacy *)objc_loadWeakRetained((id *)&self->_redeemViewController);
}
