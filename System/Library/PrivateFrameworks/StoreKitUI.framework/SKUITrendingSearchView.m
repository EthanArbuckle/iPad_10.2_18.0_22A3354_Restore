...
- (SKUITrendingSearchView)initWithCoder:(id)a3
{
  ...
  SKUITrendingSearchView *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)SKUITrendingSearchView;
  v3 = -[SKUITrendingSearchView initWithCoder:](&v6, sel_initWithCoder_, a3);
  v4 = v3;
  if (v3)
  {
    -[SKUITrendingSearchView frame](v3, "frame");
...
- (void)commonInitWithFrame:(CGRect)a3
{
  ...
  {
    -[SKUITrendingSearchView commonInitWithFrame:].cold.1();
  }
  -[SKUITrendingSearchView setPreservesSuperviewLayoutMargins:](self, "setPreservesSuperviewLayoutMargins:", 1);
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3CA8]), "initWithFrame:", x, y, width, height);
  ...
  -[SKUITrendingSearchView addSubview:](self, "addSubview:", v8);
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3CA8]), "initWithFrame:", x, y, width, height);
  ...
  if (v12)
  {
    ...
    -[SKUITrendingSearchView titleStackView](self, "titleStackView");
    ...
    -[SKUITrendingSearchView addConstraints:](self, "addConstraints:", v16);

LABEL_8:
  }
  _NSDictionaryOfVariableBindings(CFSTR("titleStackView"), v8, 0);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3718], "constraintsWithVisualFormat:options:metrics:views:", CFSTR("V:|-(>=TITLE_MINIMUM_ORIGIN_Y)-[titleStackView]"), 0, &unk_1E749BBF0, v17);
  ...
  -[SKUITrendingSearchView addConstraints:](self, "addConstraints:", self->_verticalMarginRelatedConstraints);
  objc_msgSend(v8, "leadingAnchor");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUITrendingSearchView leadingAnchor](self, "leadingAnchor");
  ...
  -[SKUITrendingSearchView trailingAnchor](self, "trailingAnchor");
  ...
  -[SKUITrendingSearchView widthAnchor](self, "widthAnchor");
...
- (void)setTrendingSearchViews:(id)a3
{
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUITrendingSearchView trendingSearchesStackView](self, "trendingSearchesStackView", (_QWORD)v19);
  ...
  -[SKUITrendingSearchView setNeedsLayout](self, "setNeedsLayout");
}
...
- (void)layoutSubviews
{
  ...
  -[SKUITrendingSearchView layoutSubviews](&v11, sel_layoutSubviews);
  objc_msgSend(MEMORY[0x1E0DC3708], "currentDevice");
  ...
  {
LABEL_5:
    -[SKUITrendingSearchView bounds](self, "bounds");
    v7 = v6;
    -[SKUITrendingSearchView titleStackView](self, "titleStackView");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "bounds");
    MaxY = CGRectGetMaxY(v12);
    -[SKUITrendingSearchView safeAreaInsets](self, "safeAreaInsets");
...
- (void)updateConstraints
{
  ...
  v12 = 0u;
  v13 = 0u;
  -[SKUITrendingSearchView verticalMarginRelatedConstraints](self, "verticalMarginRelatedConstraints");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUITrendingSearchView updateConstraints](&v9, sel_updateConstraints);
}
