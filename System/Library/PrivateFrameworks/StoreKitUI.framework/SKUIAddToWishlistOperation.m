...
- (SKUIAddToWishlistOperation)initWithItem:(id)a3 reason:(int64_t)a4
{
  ...
  {
    -[SKUIAddToWishlistOperation initWithItem:reason:].cold.1();
  }
  v19.receiver = self;
  v19.super_class = (Class)SKUIAddToWishlistOperation;
  v7 = -[SKUIAddToWishlistOperation init](&v19, sel_init);
  if (v7)
  {
    ...
    if (v9)
    {
      v10 = objc_msgSend(MEMORY[0x1E0C99E98], "copyDictionaryForQueryString:unescapedValues:", v9, 1);
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), v7->_itemIdentifier);
...
- (void)main
{
  ...
  v5 = -[SSURLConnectionRequest initWithRequestProperties:]([SKUIURLConnectionRequest alloc], "initWithRequestProperties:", v3);
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF490]), "initWithAccount:", v7);
  ...
  v10 = v9;
  v30 = v10;
  -[SKUIURLConnectionRequest startWithConnectionResponseBlock:](v5, "startWithConnectionResponseBlock:", v29);
...
LABEL_13:
        ...
        v22 = objc_alloc(MEMORY[0x1E0DAF6F8]);
        ...
        v28[1] = 3221225472;
        v28[2] = __34__SKUIAddToWishlistOperation_main__block_invoke_35;
        v28[3] = &unk_1E73A8D58;
        v28[4] = self;
        v28[5] = v21;
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v20, 4, &v38, v25);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      free(v20);
      SSFileLog();
    }
...
uint64_t __34__SKUIAddToWishlistOperation_main__block_invoke_35(uint64_t a1, void *a2)
{
  void *v3;
  uint64_t v4;
  uint64_t v5;
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setValue:forProperty:", v9, *MEMORY[0x1E0DAFDD8]);
