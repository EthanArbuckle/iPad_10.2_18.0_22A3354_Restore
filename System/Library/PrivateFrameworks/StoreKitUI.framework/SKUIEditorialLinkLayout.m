...
- (SKUIEditorialLinkLayout)initWithLayoutRequest:(id)a3
{
  ...
  {
    -[SKUIEditorialLinkLayout initWithLayoutRequest:].cold.1();
  }
  v43.receiver = self;
  v43.super_class = (Class)SKUIEditorialLinkLayout;
  v5 = -[SKUIEditorialLinkLayout init](&v43, sel_init);
  if (v5)
  {
    ...
    if (v10 >= 1)
    {
      ...
      if (v12)
      {
        ...
        v38[3] = &unk_1E73A2E40;
        v38[4] = &v39;
        -[SKUIEditorialLinkLayout enumerateLinesUsingBlock:](v5, "enumerateLinesUsingBlock:", v38);
        v35 = v40[3];
        v36 = v24 * (double)v35;
        if (v35 >= 2)
...
- (void)dealloc
{
  ...
  -[SKUIEditorialLinkLayout dealloc](&v4, sel_dealloc);
}
...
- (CGSize)sizeForLinkAtIndex:(int64_t)a3
{
  ...
  if (!self->_sizes || -[NSArray count](self->_links, "count") <= a3)
    objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99778], CFSTR("Invalid index: %ld"), a3);
  v5 = &self->_sizes[a3];
  width = v5->width;
  height = v5->height;
