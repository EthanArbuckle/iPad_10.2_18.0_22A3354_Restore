...
- (id)artworkURLForSize:(int64_t)a3
{
  ...
  -[SKUIRedeemItem artworks](self, "artworks");
...
- (SKUIRedeemItem)initWithCoder:(id)a3
{
  ...
  v5 = -[SKUIRedeemItem init](&v9, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectForKey:", CFSTR("title"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIItem setTitle:](v5, "setTitle:", v6);

    -[SKUIItem setItemIdentifier:](v5, "setItemIdentifier:", objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("itemIdentifier")));
    objc_msgSend(v4, "decodeObjectForKey:", CFSTR("artworks"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIRedeemItem setArtworks:](v5, "setArtworks:", v7);

    -[SKUIItem setItemKind:](v5, "setItemKind:", objc_msgSend(v4, "decodeIntegerForKey:", CFSTR("itemKind")));
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v6, "encodeInt64:forKey:", -[SKUIItem itemIdentifier](self, "itemIdentifier"), CFSTR("itemIdentifier"));
  -[SKUIRedeemItem artworks](self, "artworks");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "encodeObject:forKey:", v5, CFSTR("artworks"));

  objc_msgSend(v6, "encodeInteger:forKey:", -[SKUIItem itemKind](self, "itemKind"), CFSTR("itemKind"));
}
