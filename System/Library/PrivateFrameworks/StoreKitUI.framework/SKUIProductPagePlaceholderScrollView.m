...
- (void)setPlaceholderView:(id)a3
{
  ...
  if (placeholderView != v5)
  {
    ...
    -[SKUIProductPagePlaceholderScrollView setNeedsLayout](self, "setNeedsLayout");
    v5 = v7;
  }
...
- (void)layoutSubviews
{
  ...
  -[SKUIProductPagePlaceholderScrollView bounds](self, "bounds");
  placeholderView = self->_placeholderView;
  if (placeholderView)
  {
    v6 = v3;
    ...
    if (!self->_isPad)
    {
      -[SKUIProductPagePlaceholderScrollView contentInset](self, "contentInset");
      v9 = v7 - v8;
      -[SKUIProductPagePlaceholderScrollView contentInset](self, "contentInset");
      v7 = v9 - v10;
    }
  ...
  -[SKUIProductPagePlaceholderScrollView layoutSubviews](&v16, sel_layoutSubviews);
}
