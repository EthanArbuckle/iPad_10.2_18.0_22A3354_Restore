...
- (SKUIArtworkItemProvider)initWithURL:(id)a3 usingResourceLoader:(id)a4
{
  id v7;
  id v8;
  SKUIArtworkItemProvider *v9;
  SKUIArtworkItemProvider *v10;
  uint64_t v11;
  NSProgress *progress;
  uint64_t v13;
  ...
  {
    -[SKUIArtworkItemProvider initWithURL:usingResourceLoader:].cold.1();
  }
  v18.receiver = self;
  v18.super_class = (Class)SKUIArtworkItemProvider;
  v9 = -[SKUIArtworkItemProvider init](&v18, sel_init);
  v10 = v9;
  if (v9)
  {
    ...
    -[SKUIArtworkItemProvider registerDataRepresentationForTypeIdentifier:visibility:loadHandler:](v10, "registerDataRepresentationForTypeIdentifier:visibility:loadHandler:", *MEMORY[0x1E0CA5BA8], 3, &__block_literal_global_4);
    v15 = objc_alloc_init(SKUIArtworkRequest);
    -[SKUIArtworkRequest setURL:](v15, "setURL:", v10->_url);
    +[SSVURLDataConsumer consumer](SKUIImageDataConsumer, "consumer");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIArtworkRequest setDataConsumer:](v15, "setDataConsumer:", v16);

    -[SKUIArtworkRequest setDelegate:](v15, "setDelegate:", v10);
    -[SKUIResourceLoader loadResourceWithRequest:reason:](v10->_resourceLoader, "loadResourceWithRequest:reason:", v15, 1);
...
- (id)loadDataRepresentationForTypeIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  if ((objc_msgSend(v6, "isEqualToString:", *MEMORY[0x1E0CA5BA8]) & 1) != 0)
  {
  ...
  else
  {
    ...
    -[SKUIArtworkItemProvider loadDataRepresentationForTypeIdentifier:completionHandler:](&v13, sel_loadDataRepresentationForTypeIdentifier_completionHandler_, v6, v7);
