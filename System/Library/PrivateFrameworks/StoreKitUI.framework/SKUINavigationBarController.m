...
{
  id v5;
  SKUINavigationBarController *v6;
  NSMutableArray *v7;
  ...
  {
    -[SKUINavigationBarController initWithNavigationBarViewElement:].cold.1();
  }
  v11.receiver = self;
  v11.super_class = (Class)SKUINavigationBarController;
  v6 = -[SKUINavigationBarController init](&v11, sel_init);
  if (v6)
  {
    ...
    objc_msgSend(v9, "addObserver:selector:name:object:", v6, sel__viewElementEventNotification_, 0x1E73AEE10, 0);
...
- (void)dealloc
{
  ...
  objc_msgSend(v3, "removeObserver:name:object:", self, 0x1E73AEE10, 0);
  -[SKUINavigationBarButtonsController disconnectAllButtons](self->_buttonsController, "disconnectAllButtons");
  ...
  -[SKUINavigationBarController dealloc](&v5, sel_dealloc);
}
...
- (void)attachToNavigationItem:(id)a3
{
  ...
  id v6;
  id v7;
  SKUINavigationBarViewElement *viewElement;
  id v9;
  id v10;
  uint64_t v11;
  void *v12;
  ...
  void *v15;
  void *v16;
  SKUINavigationBarSegmentsController *v17;
  SKUINavigationBarSegmentsController *v18;
  uint64_t v19;
  void *v20;
  SKUINavigationBarMenusController *v21;
  uint64_t v22;
  void *v23;
  NSMutableArray *v24;
  uint64_t v25;
  ...
  v49 = v37;
  v53 = &v54;
  -[SKUIViewElement enumerateChildrenUsingBlock:](viewElement, "enumerateChildrenUsingBlock:", v46);
  if (!v55[5])
  {
    -[SKUINavigationBarController fallbackTitleView](self, "fallbackTitleView");
  ...
  -[SKUINavigationBarController _navigationBarContext](self, "_navigationBarContext");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (v67[5])
  {
    v17 = [SKUINavigationBarSegmentsController alloc];
    v18 = -[SKUINavigationBarSegmentsController initWithViewElement:](v17, "initWithViewElement:", v67[5]);
    -[SKUINavigationBarSectionController setContext:](v18, "setContext:", v16);
    -[NSMutableArray addObject:](self->_sections, "addObject:", v18);
    -[SKUINavigationBarSegmentsController view](v18, "view");
  ...
  {
    v21 = -[SKUINavigationBarMenusController initWithMenuViewElements:]([SKUINavigationBarMenusController alloc], "initWithMenuViewElements:", v37);
    -[SKUINavigationBarSectionController setContext:](v21, "setContext:", v16);
    -[NSMutableArray addObject:](self->_sections, "addObject:", v21);
    -[SKUINavigationBarMenusController view](v21, "view");
  ...
  -[SKUINavigationPaletteController reloadSectionViews](self->_paletteController, "reloadSectionViews");
...
- (void)detachFromNavigationItem:(id)a3
{
  ...
  v4 = a3;
  -[SKUINavigationBarController detachNavigationItemControllers](self, "detachNavigationItemControllers");
...
{
  SKUINavigationBarButtonsController *buttonsController;
  SKUINavigationPaletteController *paletteController;
  NSMapTable *v5;
  uint64_t v6;
  uint64_t v7;
  uint64_t v8;
...
- (UIView)navigationPaletteView
{
  ...
  uint64_t v7;
  void *v8;
  SKUINavigationPaletteController *v9;
  SKUINavigationPaletteController *v10;
  void *v11;

  paletteController = self->_paletteController;
  if (!paletteController)
  {
    -[SKUINavigationBarViewElement navigationPalettes](self->_viewElement, "navigationPalettes");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        v9 = -[SKUINavigationPaletteController initWithPaletteViewElement:]([SKUINavigationPaletteController alloc], "initWithPaletteViewElement:", v5);
        v10 = self->_paletteController;
        self->_paletteController = v9;

        -[SKUINavigationBarSectionController setContext:](self->_paletteController, "setContext:", v8);
        -[SKUINavigationPaletteController willAppearInNavigationBar](self->_paletteController, "willAppearInNavigationBar");
  ...
  return (UIView *)-[SKUINavigationPaletteController view](paletteController, "view");
}
...
- (id)titleViewWithViewElement:(id)a3
{
  ...
  v5 = a3;
  -[SKUINavigationBarController _availableWidth](self, "_availableWidth");
  v7 = v6;
  ...
  {
    -[SKUINavigationBarController _addSearchBarControllerWithViewElement:](self, "_addSearchBarControllerWithViewElement:", v5);
    ...
    if (v16)
    {
      ...
      v25 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3F10]), "initWithFrame:", v21, v22, v20, v24);
  ...
  if (objc_msgSend(v5, "elementType") == 12)
  {
    ...
    -[SKUINavigationBarController _buttonWithElement:width:](self, "_buttonWithElement:width:", self->_titleButtonViewElement, v7);
...
- (void)updateNavigationItem:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SKUINavigationBarViewElement updateType](self->_viewElement, "updateType");
  switch(v5)
  {
    case 1:
      v52 = 0u;
      ...
      -[SKUINavigationBarController _fullyReloadSections:withNavigationItem:](self, "_fullyReloadSections:withNavigationItem:", v6, v4);
      if (self->_titleButtonViewElement)
      {
        ...
        if (SKUIUserInterfaceIdiom(self->_clientContext) == 1)
        {
          ...
          v23 = v22 > SKUICompactThreshold();

          if (v23 && v19 > 314.0)
            v19 = 314.0;
        }
        -[SKUINavigationBarController _buttonWithElement:width:](self, "_buttonWithElement:width:", self->_titleButtonViewElement, v19);
      ...
      goto LABEL_44;
    case 4:
      -[SKUINavigationBarController detachFromNavigationItem:](self, "detachFromNavigationItem:", v4);
      -[SKUINavigationBarController parentViewController](self, "parentViewController");
      ...
      -[SKUINavigationBarController attachToNavigationItem:](self, "attachToNavigationItem:", v4);
      break;
    case 3:
      -[SKUIViewElement firstChildForElementType:](self->_viewElement, "firstChildForElementType:", 106);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIViewElement firstChildForElementType:](self->_viewElement, "firstChildForElementType:", 75);
      v7 = objc_claimAutoreleasedReturnValue();
      -[SKUIViewElement firstChildForElementType:](self->_viewElement, "firstChildForElementType:", 138);
...
LABEL_44:
      ...
      -[SKUIViewElement flattenedChildren](self->_viewElement, "flattenedChildren");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_52:
        ...
        paletteController = (SKUINavigationPaletteController *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99D20]), "initWithObjects:", self->_paletteController, 0);
        -[SKUINavigationBarController _fullyReloadSections:withNavigationItem:](self, "_fullyReloadSections:withNavigationItem:", paletteController, v4);
      }
      else
      {
        self->_paletteController = 0;
...
- (id)viewForElementIdentifier:(id)a3
{
  ...
  paletteController = self->_paletteController;
  if (!paletteController
    || (-[SKUINavigationPaletteController viewForElementIdentifier:](paletteController, "viewForElementIdentifier:", v4),
...
- (void)_viewElementEventNotification:(id)a3
{
  ...
  v4 = a3;
  -[SKUINavigationBarController navigationPaletteView](self, "navigationPaletteView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_addSearchBarControllerWithViewElement:(id)a3
{
  ...
  if (!-[NSMutableArray count](self->_reusableSearchBarControllers, "count")
    || (-[NSMutableArray firstObject](self->_reusableSearchBarControllers, "firstObject"),
        v5 = (SKUISearchBarController *)objc_claimAutoreleasedReturnValue(),
        -[SKUISearchBarController setSearchBarViewElement:](v5, "setSearchBarViewElement:", v4),
        -[NSMutableArray removeObjectAtIndex:](self->_reusableSearchBarControllers, "removeObjectAtIndex:", 0),
        !v5))
  {
    v5 = -[SKUISearchBarController initWithSearchBarViewElement:]([SKUISearchBarController alloc], "initWithSearchBarViewElement:", v4);
  }
  -[SKUISearchBarController setClientContext:](v5, "setClientContext:", self->_clientContext);
  WeakRetained = objc_loadWeakRetained((id *)&self->_parentViewController);
  -[SKUISearchBarController setParentViewController:](v5, "setParentViewController:", WeakRetained);
  ...
  if (SKUIUserInterfaceIdiom(self->_clientContext) == 1)
  {
    ...
    {
      v10 = -[SKUIClientContext shouldForceTransientSearchControllerBahavior](self->_clientContext, "shouldForceTransientSearchControllerBahavior");

      if (!v10)
      {
        -[SKUISearchBarController setShowsResultsForEmptyField:](v5, "setShowsResultsForEmptyField:", 1);
        goto LABEL_10;
      }
    }
  }
  -[SKUISearchBarController setDisplaysSearchBarInNavigationBar:](v5, "setDisplaysSearchBarInNavigationBar:", 1);
LABEL_10:
  searchBarControllers = self->_searchBarControllers;
  if (!searchBarControllers)
  {
    v12 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 512, 512, 0);
...
- (id)_attributedStringForButton:(id)a3
{
  ...
  if (v7)
  {
    -[SKUINavigationBarController _attributedStringForButtonText:type:style:](self, "_attributedStringForButtonText:type:style:", v5, v6, v7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUINavigationBarController _attributedStringForButtonText:type:style:](self, "_attributedStringForButtonText:type:style:", v5, v6, v9);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_attributedStringForButtonText:(id)a3 type:(int64_t)a4 style:(id)a5
{
  ...
  if (!v10)
  {
    if (a4)
      ...
      v11 = 1;
    SKUIFontPreferredFontForTextStyle(v11);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  }
  -[SKUINavigationBarViewElement tintColor](self->_viewElement, "tintColor");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  SKUIViewElementPlainColorWithStyle(v8, v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_barButtonItemWithButtonViewElement:(id)a3
{
  id v4;
  SKUINavigationBarButtonsController *buttonsController;
  SKUINavigationBarButtonsController *v6;
  SKUINavigationBarButtonsController *v7;
  SKUINavigationBarButtonsController *v8;
  void *v9;
  void *v10;
  ...
  {
    v6 = -[SKUINavigationBarButtonsController initWithNavigationBarViewElement:]([SKUINavigationBarButtonsController alloc], "initWithNavigationBarViewElement:", self->_viewElement);
    ...
    -[SKUINavigationBarController _navigationBarContext](self, "_navigationBarContext");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUINavigationBarSectionController setContext:](v8, "setContext:", v9);

    buttonsController = self->_buttonsController;
  }
  -[SKUINavigationBarButtonsController addButtonItemWithButtonViewElement:](buttonsController, "addButtonItemWithButtonViewElement:", v4);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_barButtonItemWithViewElement:(id)a3
{
  ...
  {
    -[SKUINavigationBarController _barButtonItemWithButtonViewElement:](self, "_barButtonItemWithButtonViewElement:", v4);
  ...
  else
  {
    ...
    -[SKUINavigationBarController _barButtonItemWithSearchBarViewElement:](self, "_barButtonItemWithSearchBarViewElement:", v4);
    v6 = objc_claimAutoreleasedReturnValue();
  }
  v7 = (void *)v6;
LABEL_7:
...
- (id)_buttonWithElement:(id)a3 width:(double)a4
{
  ...
  uint64_t v18;
  void *v19;
  SKUIAttributedStringLayoutRequest *v20;
  SKUIAttributedStringLayout *v21;
  void *v22;
  void *v23;
  void *v24;
  void *v25;
  ...
  uint64_t v27;
  void *v28;
  SKUIAttributedStringLayoutRequest *v29;
  SKUIAttributedStringLayout *v30;
  uint64_t v31;
  double v32;
  void *v33;
  void *v34;
  ...
  double v41;
  double v42;
  SKUIAttributedStringLayout *v43;
  uint64_t v44;
  SKUIButtonBorderStyle *v45;
  void *v46;
  SKUIButtonBorderStyle *v47;
  uint64_t v48;
  double v49;
  SKUIStyledButton *v50;
  void *v51;
  void *v52;
  void *v53;
  void *v55;
  ...
  if (v7 == 9)
  {
    ...
    -[SKUIStyledButton setAlpha:](v9, "setAlpha:", 1.0);
    -[SKUIStyledButton setBorderStyle:](v9, "setBorderStyle:", 0);
    v18 = 1;
    -[SKUIStyledButton setButtonType:](v9, "setButtonType:", 1);
    -[SKUINavigationBarController _attributedStringForButton:](self, "_attributedStringForButton:", v6);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v20 = -[SKUIAttributedStringLayoutRequest initWithAttributedString:]([SKUIAttributedStringLayoutRequest alloc], "initWithAttributedString:", v19);
    -[SKUIAttributedStringLayoutRequest setWidth:](v20, "setWidth:", a4);
    v21 = -[SKUIAttributedStringLayout initWithLayoutRequest:]([SKUIAttributedStringLayout alloc], "initWithLayoutRequest:", v20);
    -[SKUIStyledButton setTitleLayout:](v9, "setTitleLayout:", v21);
    if (!-[SKUIStyledButton isUsingItemOfferAppearance](v9, "isUsingItemOfferAppearance"))
      v18 = objc_msgSend(v6, "isEnabled");
    -[SKUIStyledButton setEnabled:](v9, "setEnabled:", v18);
    objc_msgSend(v6, "style");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    SKUIViewElementPlainColorWithStyle(v22, 0);
    v23 = (void *)objc_claimAutoreleasedReturnValue();

    -[SKUIStyledButton setTintColor:](v9, "setTintColor:", v23);
    goto LABEL_29;
  }
  v8 = v7;
  if (v7 != 6)
  {
    if (v7 == 5)
    {
      ...
      -[SKUIStyledButton imageView](v9, "imageView");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "buttonImage");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUINavigationBarController _resourceImageForImageElement:](self, "_resourceImageForImageElement:", v11);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      -[SKUIStyledButton setAccessibilityLabel:](v9, "setAccessibilityLabel:", v13);
      v14 = objc_msgSend(v6, "isEnabled");
      v15 = 0.4;
      if ((_DWORD)v14)
        v15 = 1.0;
      -[SKUIStyledButton setAlpha:](v9, "setAlpha:", v15);
      -[SKUIStyledButton setEnabled:](v9, "setEnabled:", v14);
      objc_msgSend(v6, "style");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      SKUIViewElementPlainColorWithStyle(v16, 0);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIStyledButton setTintColor:](v9, "setTintColor:", v17);
    ...
    v20 = -[SKUIAttributedStringLayoutRequest initWithAttributedString:]([SKUIAttributedStringLayoutRequest alloc], "initWithAttributedString:", v19);
    -[SKUIAttributedStringLayoutRequest setWidth:](v20, "setWidth:", a4);
    v43 = -[SKUIAttributedStringLayout initWithLayoutRequest:]([SKUIAttributedStringLayout alloc], "initWithLayoutRequest:", v20);
    -[SKUIStyledButton setTitleLayout:](v9, "setTitleLayout:", v43);
    if (v8 == 13)
      v44 = 7;
    else
      v44 = 0;
    -[SKUIStyledButton setButtonType:](v9, "setButtonType:", v44);
    v45 = [SKUIButtonBorderStyle alloc];
    objc_msgSend(v6, "style");
    v46 = (void *)objc_claimAutoreleasedReturnValue();
    v47 = -[SKUIButtonBorderStyle initWithElementStyle:](v45, "initWithElementStyle:", v46);

    -[SKUIStyledButton setBorderStyle:](v9, "setBorderStyle:", v47);
    v48 = objc_msgSend(v6, "isEnabled");
    -[SKUIStyledButton setEnabled:](v9, "setEnabled:", v48);
    v49 = 0.4;
    if ((_DWORD)v48)
      v49 = 1.0;
    -[SKUIStyledButton setAlpha:](v9, "setAlpha:", v49);
...
LABEL_29:
  ...
  if (v26 == 138)
    ...
    v27 = 6;
  -[SKUIStyledButton setButtonType:](v9, "setButtonType:", v27);
  -[SKUINavigationBarController _attributedStringForButton:](self, "_attributedStringForButton:", v6);
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  v29 = -[SKUIAttributedStringLayoutRequest initWithAttributedString:]([SKUIAttributedStringLayoutRequest alloc], "initWithAttributedString:", v28);
  -[SKUIAttributedStringLayoutRequest setWidth:](v29, "setWidth:", a4);
  v30 = -[SKUIAttributedStringLayout initWithLayoutRequest:]([SKUIAttributedStringLayout alloc], "initWithLayoutRequest:", v29);
  -[SKUIStyledButton setTitleLayout:](v9, "setTitleLayout:", v30);
  v31 = objc_msgSend(v6, "isEnabled");
  -[SKUIStyledButton setEnabled:](v9, "setEnabled:", v31);
  v32 = 0.4;
  if ((_DWORD)v31)
    v32 = 1.0;
  -[SKUIStyledButton setAlpha:](v9, "setAlpha:", v32);
  -[SKUIStyledButton imageView](v9, "imageView");
  v33 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "buttonImage");
  v34 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUINavigationBarController _resourceImageForImageElement:](self, "_resourceImageForImageElement:", v34);
  v35 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v36 = (void *)objc_claimAutoreleasedReturnValue();
  v37 = SKUIViewElementMarginForStyle(v36, &v56);
  v39 = v38;
  v41 = v40;
  ...
  if (v56)
  {
    if (v26 == 138)
      ...
      v42 = v41;
    -[SKUIStyledButton setImageTextPaddingInterior:](v9, "setImageTextPaddingInterior:", v42);
    -[SKUIStyledButton setImageYAdjustment:](v9, "setImageYAdjustment:", v37);
  }
...
LABEL_30:
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[SKUIStyledButton setUsesTintColor:](v50, "setUsesTintColor:", objc_msgSend(v53, "colorType") == 1);
...
{
  SKUINavigationBarContext *navigationBarContext;
  SKUINavigationBarContext *v4;
  SKUINavigationBarContext *v5;
  SKUINavigationBarContext *v6;
  void *v7;
  double v8;
  SKUINavigationBarContext *v9;
  id WeakRetained;
  id v11;
  ...
  if (!navigationBarContext)
  {
    ...
    -[SKUINavigationBarContext setClientContext:](self->_navigationBarContext, "setClientContext:", self->_clientContext);
    v6 = self->_navigationBarContext;
    objc_msgSend(MEMORY[0x1E0DC3BF8], "mainScreen");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "bounds");
    -[SKUINavigationBarContext setMaximumNavigationBarWidth:](v6, "setMaximumNavigationBarWidth:", v8);

    v9 = self->_navigationBarContext;
    WeakRetained = objc_loadWeakRetained((id *)&self->_parentViewController);
    -[SKUINavigationBarContext setParentViewController:](v9, "setParentViewController:", WeakRetained);

    v11 = objc_alloc_init(MEMORY[0x1E0CB3828]);
    -[SKUINavigationBarContext setOperationQueue:](self->_navigationBarContext, "setOperationQueue:", v11);
    v12 = -[SKUIResourceLoader initWithClientContext:]([SKUIResourceLoader alloc], "initWithClientContext:", self->_clientContext);
    -[SKUINavigationBarContext setResourceLoader:](self->_navigationBarContext, "setResourceLoader:", v12);
    v13 = objc_alloc_init(SKUILayoutCache);
    -[SKUILayoutCache setDelegate:](v13, "setDelegate:", self);
    -[SKUINavigationBarContext setTextLayoutCache:](self->_navigationBarContext, "setTextLayoutCache:", v13);
...
- (void)_titleButtonAction:(id)a3
{
  ...
  objc_msgSend(v4, "postNotificationName:object:", 0x1E73AEE10, self);
  -[SKUIButtonViewElement dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:](self->_titleButtonViewElement, "dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:", 2, 1, 1, 0, 0);
...
{
  return (SKUINavigationBarControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
