...
- (SKUIBrickSwooshArtworkLoader)initWithArtworkLoader:(id)a3 swoosh:(id)a4
{
  ...
  {
    -[SKUIBrickSwooshArtworkLoader initWithArtworkLoader:swoosh:].cold.1();
  }
  v17.receiver = self;
  v17.super_class = (Class)SKUIBrickSwooshArtworkLoader;
  v8 = -[SKUISwooshArtworkLoader initWithArtworkLoader:swoosh:](&v17, sel_initWithArtworkLoader_swoosh_, v6, v7);
  if (v8)
  {
    ...
    -[SKUISwooshArtworkLoader setImageDataConsumer:](v8, "setImageDataConsumer:", v9);
...
- (BOOL)loadImageForBrick:(id)a3 reason:(int64_t)a4
{
  ...
  if (v8)
    v9 = -[SKUISwooshArtworkLoader loadImageForObject:URL:reason:](self, "loadImageForObject:URL:reason:", v6, v8, a4);
  else
    v9 = 0;
...
- (void)loadImagesForNextPageWithReason:(int64_t)a3
{
  ...
  if (v6 >= 1)
  {
    ...
    do
    {
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = -[SKUIBrickSwooshArtworkLoader loadImageForBrick:reason:](self, "loadImageForBrick:reason:", v10, a3);
  ...
  if (v11)
  {
    ...
    while (2)
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (-[SKUISwooshArtworkLoader artworkRequestIdentifierForObject:](self, "artworkRequestIdentifierForObject:", v16) == v7)
        {
...
LABEL_11:
  ...
  -[SKUISwooshArtworkLoader setImage:forRequest:](&v20, sel_setImage_forRequest_, v6, v19);
