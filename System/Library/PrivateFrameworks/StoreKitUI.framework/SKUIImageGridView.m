...
- (void)setColumnCount:(int64_t)a3
{
  if (self->_columnCount != a3)
  {
    ...
    -[SKUIImageGridView setNeedsLayout](self, "setNeedsLayout");
  }
}
    ...
    if (v12)
    {
      ...
      do
      {
        for (j = 0; j != v13; ++j)
        {
          ...
          -[SKUIImageGridView addSubview:](self, "addSubview:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * j), (_QWORD)v16);
        }
...
{
  return +[SKUIImageGridViewReuseView prefetchResourcesForViewElement:reason:context:](SKUIImageGridViewReuseView, "prefetchResourcesForViewElement:reason:context:", a3, a4, a5);
}
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  +[SKUIImageGridViewReuseView preferredSizeForViewElement:context:](SKUIImageGridViewReuseView, "preferredSizeForViewElement:context:", a3, a4);
  result.height = v5;
  result.width = v4;
  return result;
}
...
{
  +[SKUIImageGridViewReuseView requestLayoutForViewElement:width:context:](SKUIImageGridViewReuseView, "requestLayoutForViewElement:width:context:", a3, a5, a4);
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  +[SKUIImageGridViewReuseView sizeThatFitsWidth:viewElement:context:](SKUIImageGridViewReuseView, "sizeThatFitsWidth:viewElement:context:", a4, a5, a3);
  result.height = v6;
  result.width = v5;
  return result;
}
...
{
  id v8;
  SKUIImageGridViewReuseView *reuseView;
  SKUIImageGridViewReuseView *v10;
  SKUIImageGridViewReuseView *v11;
  void *v12;
  id v13;
  ...
  -[SKUIImageGridViewReuseView reloadWithViewElement:width:context:](reuseView, "reloadWithViewElement:width:context:", v13, v8, a4);
  -[SKUIImageGridView setColumnCount:](self, "setColumnCount:", objc_msgSend(v13, "columnCount"));
  objc_msgSend(v13, "contentInset");
  -[SKUIImageGridView setContentInset:](self, "setContentInset:");
  -[SKUIImageGridViewReuseView imageViews](self->_reuseView, "imageViews");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIImageGridView setImageViews:](self, "setImageViews:", v12);
...
{
  return -[SKUIImageGridViewReuseView setImage:forArtworkRequest:context:](self->_reuseView, "setImage:forArtworkRequest:context:", a3, a4, a5);
}

- (BOOL)updateWithItemState:(id)a3 context:(id)a4 animated:(BOOL)a5
{
  return -[SKUIImageGridViewReuseView updateWithItemState:context:animated:](self->_reuseView, "updateWithItemState:context:animated:", a3, a4, a5);
}

- (id)viewForElementIdentifier:(id)a3
{
  return -[SKUIImageGridViewReuseView viewForElementIdentifier:](self->_reuseView, "viewForElementIdentifier:", a3);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v4 = -[SKUIImageGridView columnCount](self, "columnCount", a3.width, a3.height);
  if (v4 <= 1)
    v5 = 1;
  else
    v5 = v4;
  -[SKUIImageGridView imageViews](self, "imageViews");
...
- (void)layoutSubviews
{
  ...
  -[SKUIImageGridView layoutSubviews](&v69, sel_layoutSubviews);
  v3 = -[SKUIImageGridView columnCount](self, "columnCount");
  if (v3 <= 1)
    v4 = 1;
  else
    v4 = v3;
  ...
  v65 = 0u;
  v66 = 0u;
  -[SKUIImageGridView imageViews](v60, "imageViews");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIImageGridView bounds](v60, "bounds");
  v24 = v23;
  -[SKUIImageGridView bounds](v60, "bounds");
  v26 = v25;
  for (j = 0; j != v4; ++j)
  ...
  -[SKUIImageGridView contentInset](v60, "contentInset");
  v32 = v26 - v31;
  -[SKUIImageGridView contentInset](v60, "contentInset");
  v34 = v32 - v33;
  -[SKUIImageGridView contentInset](v60, "contentInset");
