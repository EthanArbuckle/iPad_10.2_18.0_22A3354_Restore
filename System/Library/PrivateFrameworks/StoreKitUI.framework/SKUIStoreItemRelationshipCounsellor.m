...
{
  SKUIStoreItemRelationshipCounsellor *v3;
  uint64_t v4;
  ...
  {
    -[SKUIStoreItemRelationshipCounsellor init].cold.1();
  }
  v9.receiver = self;
  v9.super_class = (Class)SKUIStoreItemRelationshipCounsellor;
  v3 = -[SKUIStoreItemRelationshipCounsellor init](&v9, sel_init);
  if (v3)
  {
    ...
    -[NSRecursiveLock setName:](v3->_lock, "setName:", CFSTR("com.apple.StoreKitUI.SKUIStoreItemRelationshipCounsellor"));
  }
  return v3;
}
...
- (BOOL)itemHasParent:(id)a3
{
  ...
  v4 = a3;
  -[SKUIStoreItemRelationshipCounsellor lock](self, "lock");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "lock");

  -[SKUIStoreItemRelationshipCounsellor relationshipsDictionary](self, "relationshipsDictionary");
...
- (void)setChildren:(id)a3 forParent:(id)a4
{
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    if (v10)
      -[SKUIStoreItemRelationshipCounsellor removeAllRelationshipsForItem:](self, "removeAllRelationshipsForItem:", v7);
    v35 = 0u;
    v36 = 0u;
    v33 = 0u;
    v34 = 0u;
    ...
    if (v12)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if (v18)
            -[SKUIStoreItemRelationshipCounsellor removeAllRelationshipsForItem:](self, "removeAllRelationshipsForItem:", v16);
          ++v15;
        }
        while (v13 != v15);
    ...
    v19 = -[SKUIStoreItemRelationship initWithParent:andChildren:]([SKUIStoreItemRelationship alloc], "initWithParent:andChildren:", v7, v11);
    -[SKUIStoreItemRelationshipCounsellor relationshipsDictionary](self, "relationshipsDictionary");
    ...
    if (v22)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[SKUIStoreItemRelationshipCounsellor relationshipsDictionary](self, "relationshipsDictionary", (_QWORD)v29);
...
- (void)addChildren:(id)a3 forParent:(id)a4
{
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    if (v10)
    {
      ...
      v13 = -[SKUIStoreItemRelationship initWithParent:andChildren:]([SKUIStoreItemRelationship alloc], "initWithParent:andChildren:", v7, v12);
      -[SKUIStoreItemRelationshipCounsellor relationshipsDictionary](self, "relationshipsDictionary");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v16)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            -[SKUIStoreItemRelationshipCounsellor relationshipsDictionary](self, "relationshipsDictionary", (_QWORD)v23);
    ...
    {
      -[SKUIStoreItemRelationshipCounsellor setChildren:forParent:](self, "setChildren:forParent:", v6, v7);
    }
    -[SKUIStoreItemRelationshipCounsellor lock](self, "lock", (_QWORD)v23);
