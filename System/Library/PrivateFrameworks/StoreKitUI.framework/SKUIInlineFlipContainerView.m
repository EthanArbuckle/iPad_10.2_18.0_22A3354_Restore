...
- (SKUIInlineFlipContainerView)initWithFrontView:(id)a3 backView:(id)a4
{
  ...
  double width;
  double height;
  SKUIInlineFlipContainerView *v24;
  UIView *v25;
  void *v26;
  double v27;
  float v28;
  ...
  {
    -[SKUIInlineFlipContainerView initWithFrontView:backView:].cold.1();
  }
  ...
  if (v24)
  {
    v25 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3F10]), "initWithFrame:", x, y, width, height);
    ...
    -[SKUIInlineFlipContainerView addSubview:](v24, "addSubview:", v25);
...
- (void)flipToBackViewWithDuration:(double)a3 options:(unint64_t)a4 completionBlock:(id)a5
{
  ...
  v8 = a5;
  -[SKUIInlineFlipContainerView bounds](self, "bounds");
  v10 = v9;
  v12 = v11;
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3F10]), "initWithFrame:", v13, v14, v9, v11);
