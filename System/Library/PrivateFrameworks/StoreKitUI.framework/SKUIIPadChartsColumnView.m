...
- (void)setContentViewControllers:(id)a3
{
  ...
  {
    v8 = v5;
    -[SKUIIPadChartsColumnView selectedViewController](self, "selectedViewController");
    ...
    -[SKUIIPadChartsColumnView _addSelectedViewController](self, "_addSelectedViewController");
...
- (void)layoutSubviews
{
  ...
  -[SKUIIPadChartsColumnView layoutSubviews](&v5, sel_layoutSubviews);
  -[SKUIIPadChartsColumnView selectedViewController](self, "selectedViewController");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "view");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIIPadChartsColumnView bounds](self, "bounds");
...
- (void)_addSelectedViewController
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(v3, "view");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIIPadChartsColumnView addSubview:](self, "addSubview:", v4);
