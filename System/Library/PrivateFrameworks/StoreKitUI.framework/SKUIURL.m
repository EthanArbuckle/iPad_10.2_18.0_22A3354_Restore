...
- (SKUIURL)initWithURL:(id)a3
{
  ...
  {
    -[SKUIURL initWithURL:].cold.1();
  }
  v14.receiver = self;
  v14.super_class = (Class)SKUIURL;
  v5 = -[SKUIURL init](&v14, sel_init);
  if (v5)
  {
    ...
    else
    {
      ...
      v11 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99E98]), "initWithString:", url);
      v12 = v5->_url;
      v5->_url = (NSURL *)v11;
...
- (SKUIURL)initWithURL:(id)a3 sourceApplication:(id)a4 annotation:(id)a5
{
  ...
  v8 = a4;
  v9 = a5;
  v10 = -[SKUIURL initWithURL:](self, "initWithURL:", a3);
  if (v10)
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v11 = (void *)SKUIMobileCoreServicesFramework();
      v12 = *(id *)SKUIWeakLinkedSymbolForString("LSReferrerURLKey", v11);
      if (v12)
      {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        -[SKUIURL setReferrerURLString:](v10, "setReferrerURLString:", v13);
      }
      else
      {
        objc_opt_class();
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          ...
          -[SKUIURL setReferrerURLString:](v10, "setReferrerURLString:", v14);

        }
      }

    }
    -[SKUIURL setReferrerApplicationName:](v10, "setReferrerApplicationName:", v8);
  }
...
- (SKUIURL)initWithURLBagKey:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB39D8], "queryItemWithName:value:", CFSTR("action"), CFSTR("bagurl"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "addObject:", v8);

  objc_msgSend(MEMORY[0x1E0CB39D8], "queryItemWithName:value:", CFSTR("bagkey"), v5);
  ...
  objc_msgSend(v6, "URL");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = -[SKUIURL initWithURL:](self, "initWithURL:", v10);
...
- (NSString)actionString
{
  ...
  -[SKUIURL valueForQueryParameter:](self, "valueForQueryParameter:", CFSTR("action"));
...
- (id)newURLRequest
{
  return -[SKUIURL newURLRequestWithBaseURL:](self, "newURLRequestWithBaseURL:", self->_url);
}
...
- (id)newURLRequestWithBaseURL:(id)a3
{
  ...
  v4 = (NSURL *)a3;
  v5 = objc_alloc_init(MEMORY[0x1E0C92C28]);
  -[SKUIURL _queryDictionary](self, "_queryDictionary");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v8)
  {
    if (v7 || self->_url != v4)
    {
      ...
      v34 = 0;
      v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithObjects:", CFSTR("action"), CFSTR("bagKey"), CFSTR("x-apple-serial-number"), 0);
      v13 = v12;
      if (v11)
      ...
      if (v30[5])
      {
        -[SKUIURL _searchGroupForSearchKind:](self, "_searchGroupForSearchKind:");
  ...
  -[SKUIURL referrerApplicationName](self, "referrerApplicationName");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  if (v20)
    objc_msgSend(v5, "setValue:forHTTPHeaderField:", v20, CFSTR("ref-user-agent"));
  -[SKUIURL referrerURLString](self, "referrerURLString");
...
- (NSString)searchTerm
{
  ...
  -[SKUIURL _decodedQueryParameter:](self, "_decodedQueryParameter:", v10[5]);
...
- (NSString)URLBagKey
{
  ...
  if (!v4)
  {
    -[SKUIURL actionString](self, "actionString");
    ...
    if ((objc_msgSend(v5, "isEqualToString:", CFSTR("library-link")) & 1) == 0)
    {
      ...
      {
        -[SKUIURL _searchURLBagKey](self, "_searchURLBagKey");
        v4 = (__CFString *)objc_claimAutoreleasedReturnValue();
      }
      else
      {
...
- (id)_searchURLBagKey
{
  ...
  else
  {
    ...
    {
      -[SKUIURL _appStoreSearchURLBagKey](self, "_appStoreSearchURLBagKey");
...
- (id)description
{
  ...
  -[SKUIURL description](&v7, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  ...
  -[SKUIURL underlyingURL](self, "underlyingURL");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
