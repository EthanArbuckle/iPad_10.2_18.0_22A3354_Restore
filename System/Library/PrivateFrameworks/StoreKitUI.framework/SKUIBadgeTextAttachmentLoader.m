...
{
  id v5;
  SKUIBadgeTextAttachmentLoader *v6;
  SKUIBadgeTextAttachmentLoader *v7;
  uint64_t v8;
  ...
  {
    -[SKUIBadgeTextAttachmentLoader initWithResourceLoader:].cold.1();
  }
  v13.receiver = self;
  v13.super_class = (Class)SKUIBadgeTextAttachmentLoader;
  v6 = -[SKUIBadgeTextAttachmentLoader init](&v13, sel_init);
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_resourceLoader, a3);
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
...
- (BOOL)loadImageForBadge:(id)a3 layout:(id)a4 reason:(int64_t)a5
{
  ...
  if (v10 && (objc_msgSend(v8, "image"), v11 = (void *)objc_claimAutoreleasedReturnValue(), v11, !v11))
  {
    ...
    if (p_isa
      && -[SKUIResourceLoader trySetReason:forRequestWithIdentifier:](self->_resourceLoader, "trySetReason:forRequestWithIdentifier:", a5, p_isa[1]))
    {
      v12 = 0;
    }
    else
    {
      ...
      -[SKUIArtworkRequest setDataConsumer:](v14, "setDataConsumer:", v15);

      -[SKUIArtworkRequest setDelegate:](v14, "setDelegate:", self);
      -[SKUIArtworkRequest setURL:](v14, "setURL:", v10);
      v16 = objc_alloc_init(SKUIBadgeImageRequest);

      v16->_requestIdentifier = -[SKUIResourceRequest requestIdentifier](v14, "requestIdentifier");
      objc_storeStrong((id *)&v16->_stringLayout, a4);
      -[NSMapTable setObject:forKey:](self->_imageRequests, "setObject:forKey:", v16, v8);
      v12 = -[SKUIResourceLoader loadResourceWithRequest:reason:](self->_resourceLoader, "loadResourceWithRequest:reason:", v14, a5);
