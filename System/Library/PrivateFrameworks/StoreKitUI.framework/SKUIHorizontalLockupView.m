...
- (SKUIHorizontalLockupView)initWithFrame:(CGRect)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        -[SKUIHorizontalLockupView initWithFrame:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  v20.receiver = self;
...
- (void)dealloc
{
  ...
  -[SKUIPreviewProgressIndicator removeTarget:action:forControlEvents:](self->_previewProgressIndicator, "removeTarget:action:forControlEvents:", self, 0, 0xFFFFFFFFLL);
...
- (id)preferredBackgroundColor
{
  ...
  -[SKUILockupViewElement style](self->_lockupElement, "style");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v5)
  {
    if (-[SKUILockupViewElement lockupViewType](self->_lockupElement, "lockupViewType") == 7)
    {
      objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.109803922, 0.72);
      v5 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
...
{
  -[SKUIViewReuseView enumerateExistingViewsForReuseIdentifier:usingBlock:](self, "enumerateExistingViewsForReuseIdentifier:usingBlock:", 0x1E73B6DD0, &__block_literal_global_26);
}
...
- (void)hidePreviewProgressAnimated:(BOOL)a3
{
  ...
  if (previewState)
  {
    ...
    if (previewState == 2)
    {
      -[SKUIHorizontalLockupView _previewFrontView](self, "_previewFrontView");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      if (a3)
      {
        -[SKUIHorizontalLockupView _addFlipContainerViewWithFrontView:backView:](self, "_addFlipContainerViewWithFrontView:backView:", v6, v9);
      ...
      else
      {
        ...
        -[SKUIHorizontalLockupView addSubview:](self, "addSubview:", v9);
        -[SKUIHorizontalLockupView setNeedsLayout](self, "setNeedsLayout");
      }
...
- (void)showPreviewProgressWithStatus:(id)a3 animated:(BOOL)a4
{
  ...
  if (previewState)
  {
    if (previewState == 2)
    {
      -[SKUIPreviewProgressIndicator setHidden:](self->_previewProgressIndicator, "setHidden:", 0);
  ...
  else
  {
    ...
    if (v9)
    {
      -[SKUIHorizontalLockupView _previewProgressIndicator](self, "_previewProgressIndicator");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = v10;
      if (v4)
      {
        -[SKUIHorizontalLockupView _addFlipContainerViewWithFrontView:backView:](self, "_addFlipContainerViewWithFrontView:backView:", v9, v10);
      ...
      else
      {
        ...
        -[SKUIHorizontalLockupView addSubview:](self, "addSubview:", v11);
        -[SKUIHorizontalLockupView setNeedsLayout](self, "setNeedsLayout");
        objc_msgSend(MEMORY[0x1E0DC3470], "sharedApplication");
...
- (void)togglePreviewPlaybackAnimated:(BOOL)a3
{
  ...
  -[SKUIHorizontalLockupView _previewMediaURL](self, "_previewMediaURL", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4)
  {
    v12 = v4;
    ...
    if (v7)
    {
      ...
      -[SKUIHorizontalLockupView hidePreviewProgressAnimated:](self, "hidePreviewProgressAnimated:", 1);
    }
    else
    {
      ...
      -[SKUIViewElement firstChildForElementType:](self->_lockupElement, "firstChildForElementType:", 90);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v9, "setStoreItemIdentifier:", objc_msgSend(v10, "itemIdentifier"));
      objc_msgSend(v9, "playerStatus");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIHorizontalLockupView showPreviewProgressWithStatus:animated:](self, "showPreviewProgressWithStatus:animated:", v11, 1);
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  uint64_t v16;
  uint64_t v17;
  SKUIHorizontalLockupLayout *v18;
  void *v19;
  id v20;
  void *v21;
  void *v22;
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v10)
        +[SKUIHorizontalLockupView requestLayoutForViewElement:width:context:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    }
  }
  v18 = -[SKUIHorizontalLockupLayout initWithLockup:context:]([SKUIHorizontalLockupLayout alloc], "initWithLockup:context:", v8, v9);
  v31 = 0;
  v32 = &v31;
  v33 = 0x3032000000;
  ...
  v36 = 0;
  -[SKUIHorizontalLockupLayout columns](v18, "columns");
  ...
  if (v21)
  {
    objc_msgSend(v21, "childViewElements");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)v32[5], "size");
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  uint64_t v15;
  uint64_t v16;
  SKUIHorizontalLockupLayout *v17;
  void *v18;
  double v19;
  double v20;
  double v21;
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9)
        +[SKUIHorizontalLockupView sizeThatFitsWidth:viewElement:context:].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  }
  v28 = 0;
  v29 = (double *)&v28;
  ...
  v32 = a3;
  v33 = 0;
  v17 = -[SKUIHorizontalLockupLayout initWithLockup:context:]([SKUIHorizontalLockupLayout alloc], "initWithLockup:context:", v7, v8);
  -[SKUIHorizontalLockupLayout sizeColumnsToFitWidth:context:](v17, "sizeColumnsToFitWidth:context:", v8, a3);
  v24 = 0;
  v25 = (double *)&v24;
  v26 = 0x2020000000;
  v27 = 0;
  -[SKUIHorizontalLockupLayout columns](v17, "columns");
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v16 = -[SKUIHorizontalLockupLayout initWithLockup:context:]([SKUIHorizontalLockupLayout alloc], "initWithLockup:context:", v9, v10);
  layout = self->_layout;
  self->_layout = v16;

  -[SKUIHorizontalLockupLayout sizeColumnsToFitWidth:context:](self->_layout, "sizeColumnsToFitWidth:context:", v10, a4);
  self->_useClearBackground = -[SKUIHorizontalLockupView _usesBackgroundWithAlpha](self, "_usesBackgroundWithAlpha");
  v52 = 0;
  v53 = &v52;
  v54 = 0x3032000000;
  ...
  if (objc_msgSend(v9, "lockupViewType") == 7 || objc_msgSend(v9, "lockupViewType") == 6)
  {
    if (!self->_metadataBackgroundView)
    {
      ...
      -[SKUIHorizontalLockupView addSubview:](self, "addSubview:", self->_metadataBackgroundView);
    }
  ...
  v49 = v23;
  v50 = &v52;
  -[SKUIViewReuseView modifyUsingBlock:](self, "modifyUsingBlock:", v48);
  if (-[NSMutableArray count](self->_tappableViews, "count")
    || -[SKUILockupViewElement isSelectable](self->_lockupElement, "isSelectable"))
  {
    tapGestureRecognizer = self->_tapGestureRecognizer;
    if (!tapGestureRecognizer)
    {
      v25 = (UITapGestureRecognizer *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3D80]), "initWithTarget:action:", self, sel__tapGestureAction_);
      ...
      -[SKUIHorizontalLockupView addGestureRecognizer:](self, "addGestureRecognizer:", self->_tapGestureRecognizer);
      tapGestureRecognizer = self->_tapGestureRecognizer;
    }
  ...
  -[SKUIHorizontalLockupView sendSubviewToBack:](self, "sendSubviewToBack:", v53[5]);
  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v28 = *MEMORY[0x1E0DDC278];
  objc_msgSend(v27, "removeObserver:name:object:", self, *MEMORY[0x1E0DDC278], 0);
  -[SKUIHorizontalLockupView _previewMediaURL](self, "_previewMediaURL");
        ...
        v31))
  {
    ...
    -[SKUIHorizontalLockupView showPreviewProgressWithStatus:animated:](self, "showPreviewProgressWithStatus:animated:", v32, 0);

  }
  else
  {
    -[SKUIHorizontalLockupView hidePreviewProgressAnimated:](self, "hidePreviewProgressAnimated:", 0);
    v31 = 0;
  }
  +[SKUIMediaPlayerInterface sharedInstance](SKUIMediaPlayerInterface, "sharedInstance");
  ...
  if (v34)
  {
    -[SKUIPlayButton playItemIdentifier](v34, "playItemIdentifier");
    ...
    if (v35)
    {
      ...
      -[SKUIPlayButton playItemIdentifier](self->_playButton, "playItemIdentifier");
      ...
      {
        v40 = -[SKUIPlayButtonControl isIndeterminate](self->_playButton, "isIndeterminate");

        if (!v40)
        {
          -[SKUIPlayButtonControl beginIndeterminateAnimation](self->_playButton, "beginIndeterminateAnimation");
          -[SKUIPlayButtonControl showPlayIndicator:](self->_playButton, "showPlayIndicator:", 0);
LABEL_36:
          +[SKUIMediaPlayerInterface sharedInstance](SKUIMediaPlayerInterface, "sharedInstance");
      ...
      if (v38)
      {
        ...
        if (-[SKUIPlayButton showOnDemand](self->_playButton, "showOnDemand"))
          -[SKUIPlayButton setHidden:](self->_playButton, "setHidden:", 0);
        if (v42 <= 5 && ((1 << v42) & 0x31) != 0)
        {
          -[SKUIPlayButtonControl hideProgressAnimated:](self->_playButton, "hideProgressAnimated:", 1);
        }
        else
        {
          ...
          -[SKUIPlayButtonControl showPlayIndicator:](self->_playButton, "showPlayIndicator:", v42 == 3);
        }
      }
      else
      {
        -[SKUIPlayButtonControl hideProgressAnimated:](self->_playButton, "hideProgressAnimated:", 1);
        if (-[SKUIPlayButton showOnDemand](self->_playButton, "showOnDemand"))
          -[SKUIPlayButton setHidden:](self->_playButton, "setHidden:", 1);
      }
      goto LABEL_36;
    }
  }
...
void __64__SKUIHorizontalLockupView_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  v12 = 3221225472;
  v13 = __64__SKUIHorizontalLockupView_reloadWithViewElement_width_context___block_invoke_2;
  v14 = &unk_1E73A50E8;
  v19 = *(_QWORD *)(a1 + 56);
  v10 = v3;
  v15 = v10;
  ...
  if (v7 == 5 || v8[584])
  {
    objc_msgSend(MEMORY[0x1E0DC3658], "clearColor", v10, v11, v12, v13, v14, v15);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_63:
                ...
                objc_msgSend(v13, "ancestorElementMatchingPredicate:", &__block_literal_global_40);
                v35 = (void *)objc_claimAutoreleasedReturnValue();
                v38 = v69;
                if (!v35)
                {
...
LABEL_32:
                ...
                objc_msgSend(v29, "addTarget:action:forControlEvents:", 0, sel_skuiadvertising_advertSelectionEventShouldBeForwarded_, 64);
...
LABEL_17:
                ...
                objc_msgSend(v20, "addTarget:action:forControlEvents:", 0, sel_skuiadvertising_advertSelectionEventShouldBeForwarded_, 64);
                LODWORD(v21) = -1.0;
...
LABEL_99:
        if (v18)
        {
          ...
          if (v51)
          {
            ...
            if (!v52)
            {
              v53 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 0, 517, 1);
              v54 = *(_QWORD *)(a1 + 48);
              v55 = *(void **)(v54 + 448);
              *(_QWORD *)(v54 + 448) = v53;
        ...
        if (v16)
        {
          ...
          if (v56)
          {
            ...
            if (!v57)
            {
              v58 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 5, 0, 1);
              v59 = *(_QWORD *)(a1 + 48);
              v60 = *(void **)(v59 + 488);
              *(_QWORD *)(v59 + 488) = v58;
        ...
        if (v22)
        {
          ...
          if (!v61)
          {
            v62 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3690]), "initWithOptions:capacity:", 517, 1);
            v63 = *(_QWORD *)(a1 + 48);
            v64 = *(void **)(v63 + 432);
            *(_QWORD *)(v63 + 432) = v62;
...
- (void)setContainerBackgroundImageForPlayButton:(id)a3
{
  ...
  if (playButton)
  {
    LODWORD(v3) = 15.0;
    LODWORD(v4) = 15.0;
    -[SKUIPlayButtonControl setBackgroundImageForBlurring:withOffsetRight:withOffsetBottom:](playButton, "setBackgroundImageForBlurring:withOffsetRight:withOffsetBottom:", a3, v3, v4);
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SKUIHorizontalLockupView layoutSubviews](&v62, sel_layoutSubviews);
  if ((-[SKUIGradientView isDescendantOfView:](self->_offerConfirmationGradientView, "isDescendantOfView:", self) & 1) == 0)
  {
    -[SKUIHorizontalLockupView bounds](self, "bounds");
    v4 = v3;
    v6 = v5;
    v8 = v7;
    v10 = v9;
    ...
    if (!v12)
      v12 = 2 * (-[SKUILockupViewElement lockupViewType](self->_lockupElement, "lockupViewType") == 6);
    v34 = v12;
    -[SKUIHorizontalLockupView _previewFrontView](self, "_previewFrontView");
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIHorizontalLockupLayout columns](self->_layout, "columns");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    *(double *)&v47[11] = v8;
    ...
    if (v56[3] != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIHorizontalLockupView _sizeViewsForColumn:toFitWidth:](self, "_sizeViewsForColumn:toFitWidth:", v21, v52[3]);
      v23 = v22;
    ...
    *(double *)&v46[3] = left;
    ...
    if (self->_metadataBackgroundView)
    {
      ...
      -[SKUIHorizontalLockupView sendSubviewToBack:](self, "sendSubviewToBack:", self->_metadataBackgroundView);
    }
  ...
  switch(*(_QWORD *)(a1 + 88))
  {
    ...
    case 3:
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        v7 = v7 + CGRectGetWidth(v80) + 5.0;
        objc_msgSend(v24, "frame");
        v25 = CGRectGetWidth(v81) + 5.0;
        v82.origin.x = v7;
        v82.origin.y = v9;
        v82.size.width = v11;
        v82.size.height = v13;
        v26 = v25 + CGRectGetWidth(v82);
        v27 = *(double *)(a1 + 96);
        v28 = v26 - v27;
        v29 = v26 <= v27;
        v30 = 0.0;
...
LABEL_19:
      ...
      {
LABEL_20:
        objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 504), "topPaddingForViewElement:", v78);
        v33 = 0;
...
LABEL_32:
        ...
        v83.size.width = v11;
        v83.size.height = v13;
        *(double *)(*(_QWORD *)(*(_QWORD *)(a1 + 80) + 8) + 24) = v43 - CGRectGetHeight(v83);
      }
LABEL_33:
      objc_msgSend(v78, "style");
      v44 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (((1 << v45) & 0x308) != 0 && a3 + 1 == *(_QWORD *)(a1 + 144))
      {
        ...
        v84.size.width = v11;
        v84.size.height = v13;
        v53 = v52 - CGRectGetHeight(v84) - v51;
LABEL_45:
...
LABEL_47:
      ...
      if (*(_QWORD *)(a1 + 88) != 3 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
      {
        ...
        objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 504), "bottomPaddingForViewElement:", v78);
      ...
      if ((objc_opt_respondsToSelector() & 1) != 0)
      {
        ...
        if (Width < 44.0)
        {
          ...
          v90.size.width = v11;
          v90.size.height = v13;
          v67 = (CGRectGetWidth(v90) + -44.0) * 0.5;
        }
...
- (void)setSemanticContentAttribute:(int64_t)a3
{
  ...
  v10 = 0u;
  v11 = 0u;
  -[SKUIHorizontalLockupView subviews](self, "subviews", 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v4 = a3;
  if (-[SKUILockupViewElement lockupViewType](self->_lockupElement, "lockupViewType") == 5 || self->_useClearBackground)
  {
    objc_msgSend(MEMORY[0x1E0DC3658], "clearColor");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v10.receiver = self;
    v10.super_class = (Class)SKUIHorizontalLockupView;
    -[SKUIViewReuseView setBackgroundColor:](&v10, sel_setBackgroundColor_, v5);
LABEL_4:
  ...
  -[SKUIViewReuseView setBackgroundColor:](&v9, sel_setBackgroundColor_, v4);
  playButton = self->_playButton;
  if (playButton && -[SKUIPlayButtonControl backgroundType](playButton, "backgroundType") == 2)
  {
    +[SKUIPlayButtonControl blurColorForColor:](SKUIPlayButton, "blurColorForColor:", v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (v5)
      -[SKUIPlayButtonControl setControlColor:](self->_playButton, "setControlColor:", v5);
    goto LABEL_4;
  }
LABEL_5:
  if (self->_badge)
...
- (void)itemOfferButtonWillAnimateTransition:(id)a3
{
  ...
  if (-[SKUIHorizontalLockupView updateLayoutOnButtonConfirmation](self, "updateLayoutOnButtonConfirmation"))
    -[SKUIHorizontalLockupView _resizeMetadataRelativeToItemOfferView:](self, "_resizeMetadataRelativeToItemOfferView:", v4);
  else
    -[SKUIHorizontalLockupView _layoutConfirmationGradientRelativeToItemOfferView:alpha:](self, "_layoutConfirmationGradientRelativeToItemOfferView:alpha:", v4, (double)objc_msgSend(v4, "isShowingConfirmation"));
...
- (BOOL)offerViewAnimateTransition:(id)a3
{
  ...
  if (self->_offerConfirmationGradientView)
  {
    ...
    -[SKUIHorizontalLockupView _layoutConfirmationGradientRelativeToItemOfferView:alpha:](self, "_layoutConfirmationGradientRelativeToItemOfferView:alpha:", v4, 1.0);
...
- (void)offerViewWillAnimateTransition:(id)a3
{
  ...
  {
    -[SKUIHorizontalLockupView _addConfirmationGradientForView:](self, "_addConfirmationGradientForView:", v4);
  }
...
- (void)mediaPlayer:(id)a3 itemStateChanged:(id)a4
{
  ...
  if (playButton)
  {
    -[SKUIPlayButton playItemIdentifier](playButton, "playItemIdentifier");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = +[SKUIMediaPlayerInterface identifierMatches:item:](SKUIMediaPlayerInterface, "identifierMatches:item:", v9, v7);
...
LABEL_7:
    ...
    if (-[SKUIPlayButtonControl isIndeterminate](self->_playButton, "isIndeterminate")
      || -[SKUIPlayButtonControl showingProgress](self->_playButton, "showingProgress"))
    {
      v13[0] = MEMORY[0x1E0C809B0];
      v13[1] = 3221225472;
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  ...
  if (-[SKUILockupViewElement isSelectable](self->_lockupElement, "isSelectable"))
  {
    v11 = 1;
    *((_BYTE *)v15 + 24) = 1;
  }
...
- (void)_buttonAction:(id)a3
{
  ...
  v4 = (SKUIPlayButton *)a3;
  -[SKUIHorizontalLockupView _viewElementForView:](self, "_viewElementForView:", v4);
  v5 = objc_claimAutoreleasedReturnValue();
  v6 = (void *)v5;
  if (self->_playButton == v4)
  {
    -[SKUIHorizontalLockupView _handlePlayButtonTap:element:](self, "_handlePlayButtonTap:element:", v4, v5);
  }
  else if (v5)
  {
    SKUICollectionViewCellForView(self);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    SKUICollectionViewForView(v7);
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        v19[0] = CFSTR("toggled");
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[SKUIPlayButton isToggled](v10, "isToggled"));
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        v20[0] = v12;
        v20[1] = v6;
        v19[1] = CFSTR("target");
        v19[2] = CFSTR("count");
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[SKUIPlayButton count](v10, "count"));
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        v20[2] = v13;
        ...
        -[SKUIPlayButton toggleItemIdentifier](v10, "toggleItemIdentifier");
        v16 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_cancelConfirmationAction:(id)a3
{
  ...
  v4 = a3;
  -[SKUIHorizontalLockupView bringSubviewToFront:](self, "bringSubviewToFront:", v4);
...
{
  -[SKUIHorizontalLockupView togglePreviewPlaybackAnimated:](self, "togglePreviewPlaybackAnimated:", 1);
}
...
- (void)_tapGestureAction:(id)a3
{
  ...
  if (v12[5])
  {
    -[SKUIHorizontalLockupView _viewElementForView:](self, "_viewElementForView:");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v9 > 49)
    {
      ...
      {
        if (v9 == 138)
          -[SKUIHorizontalLockupView _expandEditorialForLabel:](self, "_expandEditorialForLabel:", v8);
        goto LABEL_14;
      }
    }
    else if (v9 != 12)
    {
      if (v9 == 49)
        -[SKUIHorizontalLockupView _performDefaultActionForImage:](self, "_performDefaultActionForImage:", v8);
      goto LABEL_14;
    }
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SKUIHorizontalLockupView _handlePlayButtonTap:element:](self, "_handlePlayButtonTap:element:", v12[5], v8);
    else
...
LABEL_14:
  ...
  if (-[SKUILockupViewElement isSelectable](self->_lockupElement, "isSelectable"))
    -[SKUILockupViewElement dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:](self->_lockupElement, "dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:", 2, 1, 1, 0, 0);
LABEL_15:
...
- (void)_audioPlayerStatusChangeNotification:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      objc_msgSend(v5, "playerStatus");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIHorizontalLockupView showPreviewProgressWithStatus:animated:](self, "showPreviewProgressWithStatus:animated:", v10, 1);
    }
...
+ (id)_attributedStringForButton:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v7)
        +[SKUIHorizontalLockupView _attributedStringForButton:context:].cold.1(v7, v8, v9, v10, v11, v12, v13, v14);
    }
  }
  +[SKUIHorizontalLockupLayout fontForButtonViewElement:context:](SKUIHorizontalLockupLayout, "fontForButtonViewElement:context:", v5, v6);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v19)
  {
    v20 = objc_msgSend(v6, "containerViewElementType") == 118;
    objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.0, dbl_1BBED1D60[v20]);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
  }
  ...
  objc_msgSend(v5, "style");
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v21, "attributedStringWithDefaultFont:foregroundColor:style:", v15, v19, v22);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v7)
        +[SKUIHorizontalLockupView _attributedStringForLabel:context:].cold.1(v7, v8, v9, v10, v11, v12, v13, v14);
    }
  }
  +[SKUIHorizontalLockupLayout fontForLabelViewElement:context:](SKUIHorizontalLockupLayout, "fontForLabelViewElement:context:", v5, v6);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "style");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "tintColor");
  ...
  if (!v18)
  {
    objc_msgSend(v6, "aggregateValueForKey:", CFSTR("SKUIPreviewOverlayBackgroundStyleKey"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v20 = v19;
    if (v19)
      v21 = objc_msgSend(v19, "integerValue") == 0;
    else
      v21 = 1;
    v22 = objc_msgSend(v5, "labelViewStyle");
    if (v22 > 5)
    {
      v18 = 0;
LABEL_23:
...
LABEL_13:
        v24 = 0.0;
LABEL_19:
        objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", v24, v23);
        v25 = objc_claimAutoreleasedReturnValue();
LABEL_22:
        v18 = (void *)v25;
        goto LABEL_23;
...
LABEL_24:
  ...
  objc_msgSend(v5, "style");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v26, "attributedStringWithDefaultFont:foregroundColor:style:", v15, v18, v27);
...
+ (id)_attributedStringForOrdinal:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v7 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v7)
        +[SKUIHorizontalLockupView _attributedStringForOrdinal:context:].cold.1(v7, v8, v9, v10, v11, v12, v13, v14);
    }
  }
  +[SKUIHorizontalLockupLayout fontForOrdinalViewElement:context:](SKUIHorizontalLockupLayout, "fontForOrdinalViewElement:context:", v5, v6);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "style");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "tintColor");
  ...
  objc_msgSend(v5, "text");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "attributedStringWithDefaultFont:foregroundColor:", v15, v18);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (void)_requestLayoutForViewElements:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v10 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_DEBUG);
      if (v10)
        +[SKUIHorizontalLockupView _requestLayoutForViewElements:width:context:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    }
  }
  ...
  if (v20)
  {
    ...
    do
    {
      for (i = 0; i != v21; ++i)
      {
        ...
        v25 = objc_msgSend(v24, "elementType");
        if (v25 > 79)
        {
          switch(v25)
          {
            ...
            case 138:
              v28 = v24;
              v29 = objc_msgSend(v9, "maxWidthForElement:withDefaultWidth:", v28, (uint64_t)a4);
              if (objc_msgSend(a1, "_usesEditorialLayoutForLabelViewElement:", v28))
              {
                objc_msgSend(v9, "editorialLayoutForLabelElement:width:", v28, (double)v29);
                v30 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v30, "enqueueLayoutRequests");
              }
              else
              {
                objc_msgSend(a1, "_attributedStringForLabel:context:", v28, v9);
                v30 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v18, "requestLayoutForLabel:attributedString:width:", v28, v30, v29);
              }
            ...
            default:
              if (v25 == 80)
              {
                objc_msgSend(a1, "_attributedStringForOrdinal:context:", v24, v9);
                v27 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v18, "requestLayoutForOrdinal:attributedString:width:", v24, v27, (uint64_t)a4);
                goto LABEL_38;
              }
              if (v25 != 154)
                continue;
...
LABEL_38:
        ...
        else
        {
          ...
          if (v25 == 49)
          {
            +[SKUIAdornedImageView requestLayoutForViewElement:width:context:](SKUIAdornedImageView, "requestLayoutForViewElement:width:context:", v24, v9, a4);
LABEL_33:
...
+ (BOOL)_usesEditorialLayoutForLabelViewElement:(id)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4)
        +[SKUIHorizontalLockupView _usesEditorialLayoutForLabelViewElement:].cold.1(v4, v5, v6, v7, v8, v9, v10, v11);
    }
  }
...
- (void)_addConfirmationGradientForView:(id)a3
{
  ...
  void *v9;
  SKUIGradientView *offerConfirmationGradientView;
  SKUIGradientView *v11;
  SKUIGradientView *v12;
  SKUIGradientView *v13;
  void *v14;
  id v15;
  id v16;
  void *v17;
  ...
  v26 = 0;
  -[SKUIHorizontalLockupView _columnForView:](self, "_columnForView:", v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIHorizontalLockupView gradientColor](self, "gradientColor");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v9)
  {
    -[UIView skui_apparentBackgroundColor](self, "skui_apparentBackgroundColor");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v9)
    {
      objc_msgSend(MEMORY[0x1E0DC3658], "whiteColor");
  ...
  if (!offerConfirmationGradientView)
  {
    ...
    v12 = -[SKUIGradientView initWithFrame:](v11, "initWithFrame:", *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
  ...
  -[SKUIHorizontalLockupView _layoutConfirmationGradientRelativeToItemOfferView:alpha:](self, "_layoutConfirmationGradientRelativeToItemOfferView:alpha:", v4, 0.0);
...
- (id)_addFlipContainerViewWithFrontView:(id)a3 backView:(id)a4
{
  ...
  -[SKUIHorizontalLockupView addSubview:](self, "addSubview:", v12);
  return v12;
}
...
- (void)_layoutConfirmationGradientRelativeToItemOfferView:(id)a3 alpha:(double)a4
{
  ...
  if (self->_offerConfirmationGradientView)
  {
    ...
    -[SKUIGradientView layer](self->_offerConfirmationGradientView, "layer");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", 30.0 / v15, &unk_1E749B5E8);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v19[1] = v17;
    v19[2] = &unk_1E749B600;
...
{
  id v4;
  SKUILockupViewElement *v5;
  id v6;
  SKUILockupViewElement *v7;
  _QWORD v8[4];
  SKUILockupViewElement *v9;
  SKUIHorizontalLockupView *v10;
  id v11;
...
{
  SKUIPreviewProgressIndicator *v3;
  SKUIPreviewProgressIndicator *previewProgressIndicator;
  SKUIPreviewProgressIndicator *v5;
  void *v6;
  void *v7;
  SKUIPreviewProgressIndicator *v8;
  void *v9;
  void *v10;
  SKUIPreviewProgressIndicator *v11;

  if (!self->_previewProgressIndicator)
  {
    v3 = -[SKUIPreviewProgressIndicator initWithFrame:]([SKUIPreviewProgressIndicator alloc], "initWithFrame:", 0.0, 0.0, 29.0, 29.0);
    previewProgressIndicator = self->_previewProgressIndicator;
    self->_previewProgressIndicator = v3;

    -[SKUIPreviewProgressIndicator addTarget:action:forControlEvents:](self->_previewProgressIndicator, "addTarget:action:forControlEvents:", self, sel__previewIndicatorAction_, 64);
    v5 = self->_previewProgressIndicator;
    objc_msgSend(MEMORY[0x1E0DC3658], "clearColor");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIPreviewProgressIndicator setBackgroundColor:](v5, "setBackgroundColor:", v6);
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  SKUIViewElementPlainColorWithStyle(v9, 0);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIPreviewProgressIndicator setTintColor:](v8, "setTintColor:", v10);
...
- (void)_resolvePreviewStateAfterTransitionForFlipView:(id)a3
{
  ...
  if (previewState == 3)
  {
    ...
    -[SKUIHorizontalLockupView _previewFrontView](self, "_previewFrontView");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIHorizontalLockupView addSubview:](self, "addSubview:", v23);
    -[SKUIHorizontalLockupView setNeedsLayout](self, "setNeedsLayout");
    self->_previewState = 0;
  ...
  else if (previewState == 1)
  {
    ...
    -[SKUIHorizontalLockupView addSubview:](self, "addSubview:", self->_previewProgressIndicator);
    ...
    -[SKUIPreviewProgressIndicator setEnabled:](self->_previewProgressIndicator, "setEnabled:", 1);
    v4 = v24;
    self->_previewState = 2;
  }
...
void __59__SKUIHorizontalLockupView__sizeViewsForColumn_toFitWidth___block_invoke(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  v7 = *(_QWORD *)(MEMORY[0x1E0C9D648] + 8);
...
- (BOOL)_usesBackgroundWithAlpha
{
  ...
  v5 = 0.0;
  v6 = 0;
  -[SKUIHorizontalLockupView backgroundColor](self, "backgroundColor");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (void)_attributedStringForOrdinal:(uint64_t)a3 context:(uint64_t)a4 .cold.1(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  OUTLINED_FUNCTION_1();
}
