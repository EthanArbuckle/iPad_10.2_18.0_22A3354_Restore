...
- (SKUILockupMetadataView)initWithFrame:(CGRect)a3
{
  ...
  uint64_t v14;
  uint64_t v15;
  SKUILockupMetadataView *v16;
  SKUILockupMetadataView *v17;
  objc_super v19;
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        -[SKUILockupMetadataView initWithFrame:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  v19.receiver = self;
  v19.super_class = (Class)SKUILockupMetadataView;
  v16 = -[SKUILockupMetadataView initWithFrame:](&v19, sel_initWithFrame_, x, y, width, height);
  v17 = v16;
  if (v16)
    -[SKUILockupMetadataView setContentMode:](v16, "setContentMode:", 7);
  return v17;
}
...
+ (double)maximumHeightWithVisibleFields:(unint64_t)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4)
        +[SKUILockupMetadataView maximumHeightWithVisibleFields:].cold.1(v4, v5, v6, v7, v8, v9, v10, v11);
    }
  }
  v12 = 37.0;
  if ((v3 & 0x10) == 0)
...
- (void)setArtistName:(id)a3
{
  ...
  if (v4 != v8 && (objc_msgSend(v4, "isEqualToString:", v8) & 1) == 0)
  {
    ...
    if (v8)
    {
      if (!artistNameLabel)
      {
        v6 = -[SKUILockupMetadataView _newDefaultLabel](self, "_newDefaultLabel");
    ...
    -[SKUILockupMetadataView setNeedsDisplay](self, "setNeedsDisplay");
  }
  ...
  if (v4 != v13 && (objc_msgSend(v4, "isEqualToString:", v13) & 1) == 0)
  {
    ...
    if (v13)
    {
      if (!editorialBadgeLabel)
      {
        ...
        -[SKUILockupMetadataView backgroundColor](self, "backgroundColor");
        ...
        else
        {
          ...
          -[SKUIBadgeLabel setTextColor:](v8, "setTextColor:", v10);
        ...
        else
        {
          ...
          -[SKUIBadgeLabel setBackgroundColor:](v11, "setBackgroundColor:", v12);

        }
      }
      -[SKUIBadgeLabel setText:](self->_editorialBadgeLabel, "setText:");
      -[SKUIBadgeLabel sizeToFit](self->_editorialBadgeLabel, "sizeToFit");
    }
    else
    {
...
- (void)setColoringWithColorScheme:(id)a3
{
  ...
  if (textColor != v4 && (-[UIColor isEqual:](textColor, "isEqual:", v4) & 1) == 0)
  {
    ...
    else
    {
      ...
      -[SKUIBadgeLabel setBackgroundColor:](editorialBadgeLabel, "setBackgroundColor:", v14);
...
- (void)setNumberOfUserRatings:(int64_t)a3
{
  if (self->_numberOfUserRatings != a3 || !self->_userRatingLabel)
  {
    ...
    -[SKUILockupMetadataView _reloadUserRatingViews](self, "_reloadUserRatingViews");
  }
}
...
- (void)setVisibleFields:(unint64_t)a3
{
  if (self->_visibleFields != a3)
  {
    ...
    -[SKUILockupMetadataView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  -[SKUILockupMetadataView bounds](self, "bounds", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v5 = v4;
...
LABEL_43:
  ...
  if ((self->_visibleFields & 0x800) != 0)
  {
    if (editorialBadgeLabel)
    {
      -[SKUIBadgeLabel frame](editorialBadgeLabel, "frame");
      v39 = floor(v11);
      ...
      -[SKUIBadgeLabel setHidden:](self->_editorialBadgeLabel, "setHidden:", 0);
      v59.origin.x = 0.0;
      v59.origin.y = v39;
      v59.size.width = v5;
      v59.size.height = v42;
  ...
  {
    -[SKUIBadgeLabel setHidden:](editorialBadgeLabel, "setHidden:", 1);
  }
...
- (void)setBackgroundColor:(id)a3
{
  ...
  if (a3)
  {
    -[SKUIBadgeLabel setTextColor:](editorialBadgeLabel, "setTextColor:", a3);
  }
  else
  {
    v6 = 0;
    ...
    -[SKUIBadgeLabel setTextColor:](editorialBadgeLabel, "setTextColor:", v7);
  ...
  -[SKUILockupMetadataView setBackgroundColor:](&v8, sel_setBackgroundColor_, a3);
...
- (void)_reloadUserRatingViews
{
  ...
  {
    -[SKUILockupMetadataView _decimalNumberFormatter](self, "_decimalNumberFormatter");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[SKUILockupMetadataView clientContext](self, "clientContext");
...
+ (void)maximumHeightWithVisibleFields:(uint64_t)a3 .cold.1(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
