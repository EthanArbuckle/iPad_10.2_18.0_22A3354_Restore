...
- (SKUIProductLockupLayout)initWithLockup:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  {
    -[SKUIProductLockupLayout initWithLockup:width:context:].cold.1();
  }
  v83.receiver = self;
  v83.super_class = (Class)SKUIProductLockupLayout;
  v55 = -[SKUIProductLockupLayout init](&v83, sel_init);
  if (v55)
  {
    ...
    v78 = (id *)&v77;
    v79 = 0x3032000000;
    v80 = __Block_byref_object_copy__63;
    v81 = __Block_byref_object_dispose__63;
    v82 = v55->_bottomRightViewElements;
    v71 = 0;
    v72 = (id *)&v71;
    v73 = 0x3032000000;
    v74 = __Block_byref_object_copy__63;
    v75 = __Block_byref_object_dispose__63;
    ...
    *v21 = v22;
    ...
    v65[1] = 3221225472;
    v65[2] = __56__SKUIProductLockupLayout_initWithLockup_width_context___block_invoke;
    v65[3] = &unk_1E73A6890;
    v25 = v55;
    v70 = a4 < 512.0;
    v66 = v25;
    ...
    v27 = (SKUIViewElement *)*p_topLeftViewElements;
    v61 = 0u;
    v62 = 0u;
    v63 = 0u;
    v64 = 0u;
...
LABEL_52:
                  if ((v59 & 1) == 0)
                  {
                    v44 = (SKUIViewElement *)v72[5];

                    v27 = v44;
                  }
LABEL_54:
                  -[SKUIViewElement addObject:](v27, "addObject:", v32);
                  goto LABEL_55;
                }
                if (v38 > 12)
                {
...
{
  void (**v6)(id, SKUIViewElement *, uint64_t, uint64_t);
  uint64_t v7;
  NSMutableArray *v8;
  uint64_t v9;
  NSMutableArray *v10;
  ...
  void *v18;
  uint64_t v19;
  void (**v20)(id, SKUIViewElement *, uint64_t, uint64_t);
  _QWORD v21[4];
  void (**v22)(id, SKUIViewElement *, uint64_t, uint64_t);
  uint64_t *v23;
  uint64_t v24;
  uint64_t v25;
  uint64_t v26;
  ...
  {
    -[SKUIProductLockupLayout layoutWidthsForWidth:](self, "layoutWidthsForWidth:", a3);
    v11 = v30[0];
    v10 = v31;
    v7 = v33;
  ...
  {
    -[SKUIViewElementLayoutContext sizeForViewElement:width:](self->_layoutContext, "sizeForViewElement:width:", self->_productImageElement, a3);
  ...
  do
  {
    ...
    v21[0] = v16;
    v21[1] = 3221225472;
    v21[2] = __68__SKUIProductLockupLayout_enumerateViewElementsForWidth_usingBlock___block_invoke;
    v21[3] = &unk_1E73A68B8;
    v20 = v6;
    v23 = &v26;
    v24 = v19;
...
- (SKUIProductLockupLayoutSizing)layoutWidthsForWidth:(SEL)a3
{
  ...
  double v14;
  double v15;
  SKUIProductLockupLayoutSizing *result;
  double v17;
  ...
  retstr->var2 = 0u;
  retstr->var0 = 0u;
  -[SKUIProductLockupLayout metadataWidthForWidth:](self, "metadataWidthForWidth:", a4);
  v7 = v6;
  ...
  -[SKUIProductLockupLayout _sizeForVerticalViewElements:width:](self, "_sizeForVerticalViewElements:width:", self->_topRightViewElements, v7);
  ...
  result = (SKUIProductLockupLayoutSizing *)-[SKUIProductLockupLayout hasBottomRightElementWithRightAlignment](self, "hasBottomRightElementWithRightAlignment");
  if ((_DWORD)result)
  {
    if (v15 >= v14)
      v17 = v15;
...
- (BOOL)hasBottomRightElementWithRightAlignment
{
  ...
  -[SKUIProductLockupLayout viewElementsForSection:](self, "viewElementsForSection:", 1);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "indexOfObjectPassingTest:", &__block_literal_global_38) != 0x7FFFFFFFFFFFFFFFLL;
...
- (SKUIProductLockupLayoutSizing)sizingToFitWidth:(SEL)a3
{
  ...
  if (v12 <= 0.00000011920929)
    v14 = v7;
  -[SKUIProductLockupLayout _sizeForVerticalViewElements:width:](self, "_sizeForVerticalViewElements:width:", self->_topLeftViewElements, v14);
  ...
  if (v17 <= 0.00000011920929)
    ...
    v18 = v7 - v17 + -5.0;
  -[SKUIProductLockupLayout _sizeForVerticalViewElements:width:](self, "_sizeForVerticalViewElements:width:", self->_middleLeftViewElements, v18);
    ...
    if (v22)
    {
      ...
      do
      {
        for (i = 0; i != v23; ++i)
        {
          ...
          -[SKUIProductLockupLayout _sizeForViewElement:width:](self, "_sizeForViewElement:width:", *(_QWORD *)(*((_QWORD *)&v31 + 1) + 8 * i), v7, (_QWORD)v31);
          if (v25 < v27)
            v25 = v27;
  ...
  {
    result = (SKUIProductLockupLayoutSizing *)-[SKUIProductLockupLayout _sizeForVerticalViewElements:width:](self, "_sizeForVerticalViewElements:width:", self->_bottomLeftViewElements, v7);
...
- (double)topPaddingForViewElement:(id)a3
{
  ...
  if (v5 == 8)
  {
    ...
    else
    {
      ...
      {
        SKUIFontForTextStyle(2);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v10, "_bodyLeading");
        v9 = v11;

      }
      -[SKUIViewElementLayoutContext sizeForBadgeElement:](self->_layoutContext, "sizeForBadgeElement:", v4);
      v17[3] = v9 - v12;
...
- (id)viewElementsForSection:(int64_t)a3
{
  ...
  switch(a3)
  {
    ...
    case 3:
      ...
      self = (SKUIProductLockupLayout *)objc_claimAutoreleasedReturnValue();
      return self;
    case 4:
...
- (CGSize)_sizeForSegmentedControl:(id)a3 width:(double)a4
{
  ...
  v5 = a3;
  v6 = -[SKUISegmentedControlViewElementController initWithViewElement:]([SKUISegmentedControlViewElementController alloc], "initWithViewElement:", v5);

  -[SKUISegmentedControlViewElementController setDesiredSegmentWidth:](v6, "setDesiredSegmentWidth:", 40.0);
  -[SKUISegmentedControlViewElementController segmentedControlView](v6, "segmentedControlView");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CGSize)_sizeForViewElement:(id)a3 width:(double)a4
{
  ...
  if (objc_msgSend(v6, "elementType") == 109)
    -[SKUIProductLockupLayout _sizeForSegmentedControl:width:](self, "_sizeForSegmentedControl:width:", v6, a4);
  else
