...
- (SKUICategoryController)initWithContentsController:(id)a3
{
  ...
  {
    -[SKUICategoryController initWithContentsController:].cold.1();
  }
  v8.receiver = self;
  v8.super_class = (Class)SKUICategoryController;
  v5 = -[SKUICategoryController init](&v8, sel_init);
  v6 = v5;
  if (v5)
...
- (UIBarButtonItem)categoryButton
{
  ...
  if (!button)
  {
    ...
    if (clientContext)
      -[SKUIClientContext localizedStringForKey:](clientContext, "localizedStringForKey:", CFSTR("CATEGORIES_BUTTON"));
    else
      +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("CATEGORIES_BUTTON"), 0);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = (UIBarButtonItem *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC34F0]), "initWithTitle:style:target:action:", v5, 0, self, sel_buttonAction_);
    v7 = self->_button;
    self->_button = v6;
...
- (void)dismiss
{
  ...
  SKUICategoryTableViewController *tableViewController;
  ...
  -[SKUICategoryTableViewController dismissViewControllerAnimated:completion:](self->_tableViewController, "dismissViewControllerAnimated:completion:", 1, 0);
  -[SKUICategoryTableViewController setDelegate:](self->_tableViewController, "setDelegate:", 0);
...
- (void)loadFromURL:(id)a3 withCompletionBlock:(id)a4
{
  ...
  v8 = (SSVLoadURLOperation *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF698]), "initWithURL:", v6);
  ...
  -[SKUICategoryController operationQueue](self, "operationQueue");
...
- (UISegmentedControl)segmentedControl
{
  ...
  SKUISegmentedControl *v4;
  SKUISegmentedControl *v5;
  SKUISegmentedControl *v6;

  segmentedControl = self->_segmentedControl;
  if (!segmentedControl)
  {
    v4 = [SKUISegmentedControl alloc];
    v5 = -[SKUISegmentedControl initWithItems:](v4, "initWithItems:", MEMORY[0x1E0C9AA60]);
    v6 = self->_segmentedControl;
    self->_segmentedControl = v5;

    -[SKUISegmentedControl setSelectedSegmentIndex:](self->_segmentedControl, "setSelectedSegmentIndex:", 0);
    -[SKUISegmentedControl addTarget:action:forControlEvents:](self->_segmentedControl, "addTarget:action:forControlEvents:", self, sel_segmentedControlAction_, 4096);
    -[SKUISegmentedControl _setAutosizeText:](self->_segmentedControl, "_setAutosizeText:", 1);
    -[SKUICategoryController _reloadSegmentedControl](self, "_reloadSegmentedControl");
    segmentedControl = self->_segmentedControl;
  }
...
- (void)setCategory:(id)a3
{
  ...
  if (self->_rootCategory != v5)
  {
    ...
    -[SKUICategoryController _precacheArtworkForCategory:](self, "_precacheArtworkForCategory:", self->_rootCategory);
    -[SKUICategoryController _reloadSegmentedControl](self, "_reloadSegmentedControl");
    v5 = v6;
  }
...
- (void)setSelectedURL:(id)a3
{
  ...
  if ((objc_msgSend(v5, "isEqual:", self->_selectedURL) & 1) == 0)
  {
    ...
    -[SKUICategoryController _reloadSelectedSegment](self, "_reloadSelectedSegment");
  }
...
{
  SKUICategoryTableViewController *v4;
  SKUICategoryTableViewController *tableViewController;
  void *v6;
  uint64_t v7;
  id v8;
  ...
  id v22;
  SKUICategory *v23;
  SKUIBackdropContentViewController *v24;
  id WeakRetained;
  id v26;

  -[SKUICategoryController dismiss](self, "dismiss", a3);
  -[SKUICategoryController _rootMetricsLocations](self, "_rootMetricsLocations");
  v26 = (id)objc_claimAutoreleasedReturnValue();
  -[SKUICategoryController _tableViewControllerWithCategory:](self, "_tableViewControllerWithCategory:", self->_rootCategory);
  v4 = (SKUICategoryTableViewController *)objc_claimAutoreleasedReturnValue();
  tableViewController = self->_tableViewController;
  self->_tableViewController = v4;

  -[SKUICategoryTableViewController setMetricsLocations:](self->_tableViewController, "setMetricsLocations:", v26);
  ...
  if (v7 == 1)
  {
    ...
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3A40]), "initWithRootViewController:", self->_tableViewController);
  ...
  {
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3A40]), "initWithRootViewController:", self->_tableViewController);
    objc_msgSend(v12, "_setClipUnderlapWhileTransitioning:", 1);
    v13 = self->_rootCategory;
    -[SKUICategory subcategoryContainingURL:](v13, "subcategoryContainingURL:", self->_selectedURL);
    v14 = objc_claimAutoreleasedReturnValue();
    if (v14)
    {
      v15 = (void *)v14;
      v16 = *MEMORY[0x1E0DAFCA8];
      while (1)
      {
        ...
        if (!v18)
          break;
        -[SKUICategoryController _tableViewControllerWithCategory:](self, "_tableViewControllerWithCategory:", v15);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        -[SKUICategory children](v13, "children");
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        v21 = objc_msgSend(v20, "indexOfObjectIdenticalTo:", v15);

        if (v21 != 0x7FFFFFFFFFFFFFFFLL)
        {
          v22 = objc_alloc_init(MEMORY[0x1E0DAF588]);
        ...
        -[SKUICategory subcategoryContainingURL:](v23, "subcategoryContainingURL:", self->_selectedURL);
    ...
    v24 = -[SKUIBackdropContentViewController initWithContentViewController:]([SKUIBackdropContentViewController alloc], "initWithContentViewController:", v12);
...
- (void)segmentedControlAction:(id)a3
{
  uint64_t v4;
  char isKindOfClass;
  SKUICategory *rootCategory;
  SKUICategoryTableViewController *v7;
  SKUICategoryTableViewController *tableViewController;
  SKUICategoryTableViewController *v9;
  void *v10;
  void *v11;
  uint64_t v12;
  SKUICategoryTableViewController *v13;
  SKUICategoryTableViewController *v14;
  SKUICategoryTableViewController *v15;
  void *v16;
  id v17;
  void *v18;
  ...
  -[SKUICategoryController dismiss](self, "dismiss", a3);
  v4 = -[SKUISegmentedControl selectedSegmentIndex](self->_segmentedControl, "selectedSegmentIndex");
  -[NSArray objectAtIndex:](self->_segmentedControlSegments, "objectAtIndex:", v4);
  v27 = (SKUICategory *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  isKindOfClass = objc_opt_isKindOfClass();
  rootCategory = self->_rootCategory;
  if ((isKindOfClass & 1) != 0)
  {
    -[SKUICategoryController _tableViewControllerWithCategory:](self, "_tableViewControllerWithCategory:", rootCategory);
    v7 = (SKUICategoryTableViewController *)objc_claimAutoreleasedReturnValue();
    tableViewController = self->_tableViewController;
    self->_tableViewController = v7;

    v9 = self->_tableViewController;
    -[SKUICategoryController _metricsLocationsWithIndex:](self, "_metricsLocationsWithIndex:", v4);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICategoryTableViewController setMetricsLocations:](v9, "setMetricsLocations:", v10);

    -[SKUICategoryTableViewController setNumberOfHiddenRows:](self->_tableViewController, "setNumberOfHiddenRows:", -[NSArray count](self->_segmentedControlSegments, "count") - 1);
LABEL_6:
    v17 = objc_alloc(MEMORY[0x1E0DC3B48]);
    v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3A40]), "initWithRootViewController:", self->_tableViewController);
    ...
    -[UIPopoverController setDelegate:](self->_popover, "setDelegate:", self);
    v21 = self->_popover;
    -[SKUISegmentedControl frameForSegmentAtIndex:](self->_segmentedControl, "frameForSegmentAtIndex:", v4);
  ...
  {
    -[SKUICategory children](v27, "children");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = objc_msgSend(v11, "count");

    if (v12)
    {
      -[SKUICategoryController _tableViewControllerWithCategory:](self, "_tableViewControllerWithCategory:", v27);
      v13 = (SKUICategoryTableViewController *)objc_claimAutoreleasedReturnValue();
      ...
      -[SKUICategoryController _metricsLocationsWithIndex:](self, "_metricsLocationsWithIndex:", v4);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUICategoryTableViewController setMetricsLocations:](v15, "setMetricsLocations:", v16);
  ...
  if ((v26 & 1) != 0)
    goto LABEL_8;
  -[SKUICategoryController _recordClickEventWithCategory:index:](self, "_recordClickEventWithCategory:index:", v27, v4);
  -[SKUICategoryController categoryTableView:didSelectCategory:](self, "categoryTableView:didSelectCategory:", 0, v27);
LABEL_7:
  v22 = v27;
LABEL_8:
...
- (id)metricsPageContextForCategoryTableView:(id)a3
{
  ...
  if (WeakRetained)
  {
    -[SKUIClientContext metricsPageContextForViewController:](self->_clientContext, "metricsPageContextForViewController:", WeakRetained);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (id)_artworkLoader
{
  ...
  SKUICategoryArtworkLoader *v5;
  SKUICategoryArtworkLoader *v6;
  SKUICategoryArtworkLoader *v7;
  void *v8;
  ...
  if (!artworkLoader)
  {
    ...
    v5 = -[SKUICategoryArtworkLoader initWithArtworkLoader:]([SKUICategoryArtworkLoader alloc], "initWithArtworkLoader:", v4);
    v6 = self->_artworkLoader;
    self->_artworkLoader = v5;

    v7 = self->_artworkLoader;
    +[SKUIStyledImageDataConsumer categoryIconConsumer](SKUIStyledImageDataConsumer, "categoryIconConsumer");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICategoryArtworkLoader setImageDataConsumer:](v7, "setImageDataConsumer:", v8);
...
- (id)_metricsLocationsWithIndex:(int64_t)a3
{
  ...
  v4 = objc_alloc_init(MEMORY[0x1E0DAF588]);
  objc_msgSend(v4, "setLocationPosition:", a3);
  objc_msgSend(v4, "setLocationType:", *MEMORY[0x1E0DAFCA8]);
  v5 = objc_alloc_init(MEMORY[0x1E0DAF588]);
...
- (void)_reloadSegmentedControl
{
  ...
  if (self->_segmentedControl)
  {
    ...
    -[SKUICategory children](self->_rootCategory, "children");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "objectEnumerator");
    v13 = (id)objc_claimAutoreleasedReturnValue();

    -[SKUICategory parentLabel](self->_rootCategory, "parentLabel");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
    ...
    v11 = -[SKUISegmentedControl selectedSegmentIndex](self->_segmentedControl, "selectedSegmentIndex");
    -[SKUISegmentedControl removeAllSegments](self->_segmentedControl, "removeAllSegments");
    v12 = self->_segmentedControlSegments;
    v15[0] = MEMORY[0x1E0C809B0];
    v15[1] = 3221225472;
    v15[2] = __49__SKUICategoryController__reloadSegmentedControl__block_invoke;
    v15[3] = &unk_1E73A8118;
    v15[4] = self;
    -[NSArray enumerateObjectsUsingBlock:](v12, "enumerateObjectsUsingBlock:", v15);
    -[SKUISegmentedControl setSelectedSegmentIndex:](self->_segmentedControl, "setSelectedSegmentIndex:", v11);
    -[SKUICategoryController _reloadSelectedSegment](self, "_reloadSelectedSegment");
  ...
  else
  {
    ...
    else
    {
      ...
      if (v7)
        ...
        +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("CATEGORIES_MORE_SEGMENT"), 0);
      v6 = objc_claimAutoreleasedReturnValue();
    }
  }
  v8 = (void *)v6;
...
- (void)_precacheArtworkForCategory:(id)a3
{
  ...
  v4 = a3;
  -[SKUICategoryController _artworkLoader](self, "_artworkLoader");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUICategoryController _precacheArtworkForCategory:](self, "_precacheArtworkForCategory:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++));
      }
      while (v8 != v10);
...
- (void)_recordClickEventWithCategory:(id)a3 index:(int64_t)a4
{
  ...
  v10 = v6;
  v11 = v8;
  -[SKUIClientContext getDefaultMetricsControllerWithCompletionBlock:](clientContext, "getDefaultMetricsControllerWithCompletionBlock:", v12);
...
void __62__SKUICategoryController__recordClickEventWithCategory_index___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  if (objc_msgSend(v3, "canRecordEventWithType:", *MEMORY[0x1E0DAFC38]))
  {
    v4 = objc_alloc_init(MEMORY[0x1E0DAF560]);
    objc_msgSend(v4, "setActionType:", *MEMORY[0x1E0DAFC28]);
    objc_msgSend(v4, "setPageContext:", *(_QWORD *)(a1 + 32));
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), objc_msgSend(*(id *)(a1 + 40), "categoryIdentifier"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setTargetIdentifier:", v5);

    v6 = *MEMORY[0x1E0DAFCA8];
    objc_msgSend(v4, "setTargetType:", *MEMORY[0x1E0DAFCA8]);
...
- (void)_reloadSelectedSegment
{
  ...
  if (!self->_segmentedControl || self->_popover)
    return;
  selectedURL = self->_selectedURL;
  -[SKUICategory URL](self->_rootCategory, "URL");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_rootMetricsLocations
{
  ...
  v2 = objc_alloc_init(MEMORY[0x1E0DAF588]);
  objc_msgSend(v2, "setLocationPosition:", 0);
  objc_msgSend(v2, "setLocationType:", CFSTR("topNav"));
  objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithObject:", v2);
...
- (void)_setResponse:(id)a3 error:(id)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    v6 = -[SKUICategory initWithCategoryDictionary:]([SKUICategory alloc], "initWithCategoryDictionary:", v8);
    rootCategory = self->_rootCategory;
...
{
  SKUICategory *v4;
  SKUICategoryTableViewController *v5;
  void *v6;
  _BOOL8 v7;
  ...
  -[SKUICategoryController _artworkLoader](self, "_artworkLoader");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUICategoryTableViewController setArtworkLoader:](v5, "setArtworkLoader:", v6);

  -[SKUICategoryTableViewController setClientContext:](v5, "setClientContext:", self->_clientContext);
  -[SKUICategoryTableViewController setCategory:](v5, "setCategory:", v4);
  -[SKUICategoryTableViewController setPreferredContentSize:](v5, "setPreferredContentSize:", 320.0, 472.0);
  -[SKUICategoryTableViewController setSelectedURL:](v5, "setSelectedURL:", self->_selectedURL);
  -[SKUICategoryTableViewController setDefaultURL:](v5, "setDefaultURL:", self->_defaultURL);
  v7 = self->_rootCategory == v4;

  -[SKUICategoryTableViewController setRoot:](v5, "setRoot:", v7);
  -[SKUICategoryTableViewController setDelegate:](v5, "setDelegate:", self);
  return v5;
}
...
{
  return (SKUICategoryControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
