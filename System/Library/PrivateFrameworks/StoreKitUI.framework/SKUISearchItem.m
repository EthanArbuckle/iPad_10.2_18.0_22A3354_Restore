...
- (SKUISearchItem)initWithLookupDictionary:(id)a3
{
  ...
  {
    -[SKUISearchItem initWithLookupDictionary:].cold.1();
  }
  v41.receiver = self;
  v41.super_class = (Class)SKUISearchItem;
  v5 = -[SKUIItem initWithLookupDictionary:](&v41, sel_initWithLookupDictionary_, v4);
  if (v5)
  {
        ...
        if (v21)
        {
          ...
          do
          {
            for (j = 0; j != v22; ++j)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                v28 = -[SKUIItem initWithLookupDictionary:]([SKUIItem alloc], "initWithLookupDictionary:", v27);
                if (v28)
