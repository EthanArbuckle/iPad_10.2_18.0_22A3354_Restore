...
- (SKUISignInTemplateView)initWithFrame:(CGRect)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        -[SKUISignInTemplateView initWithFrame:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  v22.receiver = self;
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9)
        +[SKUISignInTemplateView prefetchResourcesForViewElement:reason:context:].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  }
  v24 = 0;
  v25 = &v24;
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4)
        +[SKUISignInTemplateView preferredSizeForViewElement:context:].cold.1(v4, v5, v6, v7, v8, v9, v10, v11);
    }
  }
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v10)
        +[SKUISignInTemplateView requestLayoutForViewElement:width:context:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    }
  }
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v10 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v10)
        +[SKUISignInTemplateView sizeThatFitsWidth:viewElement:context:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    }
  }
  v28 = 0;
  v29 = (double *)&v28;
...
void __62__SKUISignInTemplateView_reloadWithViewElement_width_context___block_invoke_2(uint64_t a1, void *a2, uint64_t a3, uint64_t a4)
{
  ...
  if (v6 <= 49)
  {
    ...
    if (v6 == 32)
    {
      ...
      v7 = (SKUISignInView *)objc_claimAutoreleasedReturnValue();
      -[SKUISignInView setDividerOrientation:](v7, "setDividerOrientation:", 0);
      if (!v7)
        goto LABEL_28;
    }
    else
...
LABEL_27:
    ...
    objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithUIEdgeInsets:", v18, v20, v22, v24);
  ...
  if (v6 <= 137)
  {
    if (v6 != 50)
    {
      if (v6 == 120)
      {
        ...
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        -[SKUISignInView setDelegate:](v7, "setDelegate:", v8);

        v9 = *(double *)(a1 + 56);
        v10 = *(_QWORD *)(a1 + 32);
        v11 = (SKUIActivityIndicatorView *)v7;
LABEL_19:
        -[SKUIActivityIndicatorView reloadWithViewElement:width:context:](v11, "reloadWithViewElement:width:context:", v27, v10, v9);
...
LABEL_16:
    ...
    v7 = (SKUISignInView *)objc_claimAutoreleasedReturnValue();
    -[SKUISignInView addTarget:action:forControlEvents:](v7, "addTarget:action:forControlEvents:", *(_QWORD *)(a1 + 48), sel__buttonAction_, 64);
    if (!v7)
      goto LABEL_28;
    goto LABEL_27;
  }
...
- (void)layoutSubviews
{
  ...
  -[SKUISignInTemplateView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  -[SKUISignInTemplateView layoutMargins](self, "layoutMargins");
  v12 = v11;
  v14 = v13;
  v16 = v15;
  v18 = v17;
...
void __69__SKUISignInTemplateView__enumerateChildrenOfViewElement_usingBlock___block_invoke(_QWORD *a1, void *a2)
{
  void *v3;
  unint64_t v4;
  uint64_t v5;
...
+ (CGSize)_sizeForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (v9 == 120)
  {
    +[SKUISignInView sizeThatFitsWidth:viewElement:context:](SKUISignInView, "sizeThatFitsWidth:viewElement:context:", v7, v8, a4);
LABEL_9:
    v15 = v13;
    v16 = v14;
    goto LABEL_10;
