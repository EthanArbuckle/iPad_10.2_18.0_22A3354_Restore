...
- (SKUIItemStateCenter)init
{
  ...
  NSObject *v10;
  NSObject *v11;
  SKUIMediaLibraryInterface *v12;
  id v13;
  void *v14;
  id v15;
  void *v16;
  SKUIStoreItemRelationshipCounsellor *v17;
  void *v18;
  id v19;
  void *v20;
  void *v21;
  ...
  {
    -[SKUIItemStateCenter init].cold.1();
  }
  v33.receiver = self;
  v33.super_class = (Class)SKUIItemStateCenter;
  v3 = -[SKUIItemStateCenter init](&v33, sel_init);
  if (v3)
  {
    ...
    *((_QWORD *)v3 + 12) = v8;
    ...
    v14 = (void *)*((_QWORD *)v3 + 13);
    *((_QWORD *)v3 + 13) = v13;

    objc_msgSend(*((id *)v3 + 13), "addObject:", v12);
    *((_BYTE *)v3 + 16) = -1;
    *((_WORD *)v3 + 20) = -1;
    v15 = objc_alloc_init(MEMORY[0x1E0C99E08]);
    v16 = (void *)*((_QWORD *)v3 + 11);
    *((_QWORD *)v3 + 11) = v15;

    *((_QWORD *)v3 + 17) = -1;
    *((_BYTE *)v3 + 160) = -1;
    v17 = objc_alloc_init(SKUIStoreItemRelationshipCounsellor);
    v18 = (void *)*((_QWORD *)v3 + 19);
    *((_QWORD *)v3 + 19) = v17;

    v19 = objc_alloc_init(MEMORY[0x1E0DAF4E0]);
    objc_msgSend(MEMORY[0x1E0DAF4C8], "allStoreDownloadKinds");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "setDownloadKinds:", v20);

    v35[0] = *MEMORY[0x1E0DAF7F0];
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v35, 1);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "setPrefetchedDownloadExternalProperties:", v21);

    v22 = *MEMORY[0x1E0DAF928];
    v34[0] = *MEMORY[0x1E0DAF9D0];
    v34[1] = v22;
    v23 = *MEMORY[0x1E0DAF968];
    v34[2] = *MEMORY[0x1E0DAF950];
    v34[3] = v23;
    v34[4] = *MEMORY[0x1E0DAF978];
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v34, 5);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "setPrefetchedDownloadProperties:", v24);

    v25 = objc_msgSend(objc_alloc(MEMORY[0x1E0DAF4C8]), "initWithManagerOptions:", v19);
    v26 = (void *)*((_QWORD *)v3 + 6);
    *((_QWORD *)v3 + 6) = v25;

    objc_msgSend(*((id *)v3 + 6), "addObserver:", v3);
    objc_msgSend(v3, "_jobManager");
    v27 = objc_claimAutoreleasedReturnValue();
    v28 = (void *)*((_QWORD *)v3 + 4);
    *((_QWORD *)v3 + 4) = v27;

    objc_msgSend(MEMORY[0x1E0D03530], "sharedInstance");
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v29, "addObserver:", v3);

    objc_msgSend(v3, "_reloadAppUpdatesStore");
    objc_msgSend(v3, "_reloadDownloadManager");
    objc_msgSend(v3, "_reloadJobManager");
    objc_msgSend(v3, "_reloadPurchaseHistory");
    objc_msgSend(v3, "_reloadSoftwareLibrary");
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v30, "addObserver:selector:name:object:", v3, sel__restrictionsChangedNotification_, *MEMORY[0x1E0D46EC8], 0);
    objc_msgSend(v30, "addObserver:selector:name:object:", v3, sel__storefrontDidChangeNotification_, *MEMORY[0x1E0DAF718], 0);
    DistributedCenter = CFNotificationCenterGetDistributedCenter();
    CFNotificationCenterAddObserver(DistributedCenter, v3, (CFNotificationCallback)__SoftwareLibraryChangeNotification, CFSTR("com.apple.LaunchServices.applicationRegistered"), 0, CFNotificationSuspensionBehaviorCoalesce);
    CFNotificationCenterAddObserver(DistributedCenter, v3, (CFNotificationCallback)__SoftwareLibraryChangeNotification, CFSTR("com.apple.LaunchServices.applicationUnregistered"), 0, CFNotificationSuspensionBehaviorCoalesce);
...
- (id)_jobManager
{
  ...
  if (!jobManager)
  {
    ...
    v5 = (ASDJobManager *)objc_msgSend(objc_alloc(MEMORY[0x1E0CF9D08]), "initWithOptions:", v4);
    v6 = self->_jobManager;
    self->_jobManager = v5;
...
- (void)dealloc
{
  ...
  objc_msgSend(v3, "removeObserver:name:object:", self, *MEMORY[0x1E0CF9C68], 0);
  v4 = (void *)SKUIMediaPlayerFramework();
  v5 = *(id *)SKUIWeakLinkedSymbolForString("MPMediaLibraryDidChangeNotification", v4);
  objc_msgSend(v3, "removeObserver:name:object:", self, v5, 0);
  DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
  CFNotificationCenterRemoveObserver(DarwinNotifyCenter, self, (CFNotificationName)*MEMORY[0x1E0DAF720], 0);
  DistributedCenter = CFNotificationCenterGetDistributedCenter();
  ...
  -[SKUIItemStateCenter dealloc](&v8, sel_dealloc);
}
...
+ (id)defaultCenter
{
  ...
  return (id)defaultCenter_sCenter;
}

void __36__SKUIItemStateCenter_defaultCenter__block_invoke(uint64_t a1)
{
  id v1;
  void *v2;
...
- (void)cancelDownloadForItemWithIdentifier:(int64_t)a3
{
  ...
  v7 = -[SKUIStoreIdentifier initWithNumber:](v5, "initWithNumber:", v6);
  ...
  if (objc_msgSend(v8, "mediaCategory") == 1)
  {
    ...
    v18[1] = 3221225472;
    v18[2] = __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke;
    v18[3] = &unk_1E73A1528;
    v21[1] = (id)a3;
  ...
  else
  {
    ...
    v15[1] = 3221225472;
    v15[2] = __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_41;
    v15[3] = &unk_1E73A1550;
    v17[1] = (id)a3;
    v16 = v8;
    ...
    v13[0] = v10;
    v13[1] = 3221225472;
    v13[2] = __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_2_42;
    v13[3] = &unk_1E739FD10;
    v13[4] = self;
    v14 = v7;
    ...
    while (2)
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        if (objc_msgSend(v8, "storeItemID") == *(_QWORD *)(a1 + 64))
        {
          ...
          objc_msgSend(WeakRetained, "cancelJobsWithIDs:completionBlock:", v16, &__block_literal_global_0);
...
void __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_3(uint64_t a1)
{
  ...
  *(_QWORD *)&v12[14] = v7;
  ...
  if (v9)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v9, 4, v12, v11, *(_OWORD *)v12, *(_QWORD *)&v12[16]);
    v5 = objc_claimAutoreleasedReturnValue();
    free(v9);
    SSFileLog();
LABEL_9:
...
void __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_41(uint64_t a1, void *a2)
{
  uint64_t v3;
  uint64_t v4;
  uint64_t v5;
...
void __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_2_42(uint64_t a1)
{
  void *v2;
  void *v3;
  void *v4;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        SKUILibraryItemForStoreIdentifier(*(void **)(*((_QWORD *)&v15 + 1) + 8 * v9));
  ...
  if (objc_msgSend(v4, "count"))
  {
    ...
    v12[1] = 3221225472;
    v12[2] = __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_3_43;
    v12[3] = &unk_1E739FD10;
    v13 = v2;
    v14 = v4;
...
void __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_3_43(uint64_t a1)
{
  id v2;
  uint64_t v3;
  uint64_t v4;
...
uint64_t __39__SKUIItemStateCenter_isGratisEligible__block_invoke(uint64_t a1)
{
  ...
  v4[1] = 3221225472;
  v4[2] = __39__SKUIItemStateCenter_isGratisEligible__block_invoke_2;
  v4[3] = &unk_1E73A15C8;
  v4[4] = v1;
...
{
  return -[SKUIItemStateCenter isRunningInStoreDemoMode](self, "isRunningInStoreDemoMode")
      || -[SKUIItemStateCenter isApplicationInstallRestricted](self, "isApplicationInstallRestricted")
      || -[SKUIItemStateCenter parentalControlsRank](self, "parentalControlsRank") < a3;
}
...
- (id)metricsActionTypeForItem:(id)a3
{
  ...
  v4 = a3;
  -[SKUIItemStateCenter stateForItemWithIdentifier:](self, "stateForItemWithIdentifier:", objc_msgSend(v4, "itemIdentifier"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "state");
  if ((v6 & 2) != 0)
  {
    v9 = (id *)MEMORY[0x1E0DAFC10];
LABEL_6:
    v8 = *v9;
    goto LABEL_13;
  }
  if ((v6 & 0x24) != 4)
  {
    ...
    if ((v6 & 8) != 0)
      v9 = (id *)MEMORY[0x1E0DAFC18];
    else
      v9 = (id *)MEMORY[0x1E0DAFC08];
    goto LABEL_6;
  }
  objc_msgSend(v4, "bundleIdentifier");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
    v8 = (id)*MEMORY[0x1E0DAFC20];
  else
    v8 = 0;
...
void __43__SKUIItemStateCenter_parentalControlsRank__block_invoke(uint64_t a1)
{
  ...
  if (v2 == -1)
  {
    objc_msgSend(MEMORY[0x1E0D47230], "sharedConnection");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "effectiveValueForSetting:", *MEMORY[0x1E0D470B0]);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return -[SKUIItemStateCenter performActionForItem:clientContext:completionBlock:](self, "performActionForItem:clientContext:completionBlock:", a3, 0, a4);
}
...
- (id)performActionForItem:(id)a3 clientContext:(id)a4 completionBlock:(id)a5
{
  ...
  -[SKUIItemStateCenter performActionForItem:offer:clientContext:completionBlock:](self, "performActionForItem:offer:clientContext:completionBlock:", v10, v11, v9, v8);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)performActionForItem:(id)a3 clientContext:(id)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
    -[SKUIItemStateCenter performActionForSoftwareItem:offer:clientContext:completionBlock:](self, "performActionForSoftwareItem:offer:clientContext:completionBlock:", v7, v9, v6, 0);
  else
    -[SKUIItemStateCenter performActionForItem:offer:clientContext:completionBlock:](self, "performActionForItem:offer:clientContext:completionBlock:", v7, v9, v6, 0);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)performActionForItem:(id)a3 offer:(id)a4 clientContext:(id)a5 completionBlock:(id)a6
{
  ...
  v12 = a5;
  v13 = a6;
  -[SKUIItemStateCenter metricsActionTypeForItem:](self, "metricsActionTypeForItem:", v10);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0DAFC08]) & 1) != 0
    || objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0DAFC18]))
  {
    ...
    v15 = &v23;
    v23 = v13;
    -[SKUIItemStateCenter purchaseItem:offer:clientContext:completionBlock:](self, "purchaseItem:offer:clientContext:completionBlock:", v10, v11, v12, v22);
    -[SKUIItemStateCenter stateForItemWithIdentifier:](self, "stateForItemWithIdentifier:", objc_msgSend(v10, "itemIdentifier"));
    v16 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    if (objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0DAFC20]))
    {
    ...
    else if (objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0DAFC10]))
    {
      -[SKUIItemStateCenter cancelDownloadForItemWithIdentifier:](self, "cancelDownloadForItemWithIdentifier:", objc_msgSend(v10, "itemIdentifier"));
    }
    if (!v13)
    {
      v16 = 0;
...
- (id)performActionForSoftwareItem:(id)a3 offer:(id)a4 clientContext:(id)a5 completionBlock:(id)a6
{
    ...
    || objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0DAFC18]))
  {
    if (SKUIItemStateCenterUseAppstoredPurchases(v10))
    {
      ...
      v15 = __88__SKUIItemStateCenter_performActionForSoftwareItem_offer_clientContext_completionBlock___block_invoke;
      v16 = &v24;
    }
    else
    {
      v23 = MEMORY[0x1E0C809B0];
      v15 = __88__SKUIItemStateCenter_performActionForSoftwareItem_offer_clientContext_completionBlock___block_invoke_2;
      v16 = &v23;
    }
    v16[1] = 3221225472;
    v16[2] = (uint64_t)v15;
    v16[3] = (uint64_t)&unk_1E73A1640;
    v16[4] = (uint64_t)v13;
    -[SKUIItemStateCenter purchaseSoftwareItem:offer:clientContext:completionBlock:](self, "purchaseSoftwareItem:offer:clientContext:completionBlock:", v10, v11, v12, v16);
...
{
  -[SKUIItemStateCenter purchaseItems:withClientContext:completionBlock:](self, "purchaseItems:withClientContext:completionBlock:", a3, 0, a4);
}
...
{
  SKUILoadGratisEligibilityOperation *v2;
  uint64_t v3;
  NSObject *v4;
  SKUILoadGratisEligibilityOperation *v5;
  _QWORD v6[4];
  SKUILoadGratisEligibilityOperation *v7;
  _QWORD v8[5];
  id v9;
  id location;
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "_gratisStateIsValid") & 1) == 0)
  {
    *(_QWORD *)(*(_QWORD *)(a1 + 32) + 64) = 1;
    ...
    v2 = -[SKUILoadGratisEligibilityOperation initWithBundleIdentifiers:clientContext:]([SKUILoadGratisEligibilityOperation alloc], "initWithBundleIdentifiers:clientContext:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
    objc_initWeak(&location, *(id *)(a1 + 32));
    v3 = MEMORY[0x1E0C809B0];
    v8[0] = MEMORY[0x1E0C809B0];
    v8[1] = 3221225472;
    v8[2] = __82__SKUIItemStateCenter_reloadGratisEligibilityWithBundleIdentifiers_clientContext___block_invoke_2;
    v8[3] = &unk_1E73A1708;
    objc_copyWeak(&v9, &location);
    v8[4] = *(_QWORD *)(a1 + 32);
    -[SKUILoadGratisEligibilityOperation setOutputBlock:](v2, "setOutputBlock:", v8);
    dispatch_get_global_queue(0, 0);
    v4 = objc_claimAutoreleasedReturnValue();
    v6[0] = v3;
    v6[1] = 3221225472;
    v6[2] = __82__SKUIItemStateCenter_reloadGratisEligibilityWithBundleIdentifiers_clientContext___block_invoke_3;
    v6[3] = &unk_1E739FD38;
    v7 = v2;
    v5 = v2;
...
- (void)removeObserver:(id)a3
{
  ...
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __38__SKUIItemStateCenter_removeObserver___block_invoke;
...
void __50__SKUIItemStateCenter_stateForItemWithIdentifier___block_invoke(_QWORD *a1)
{
  void *v2;
  uint64_t v3;
  uint64_t v4;
  ...
  v6 = -[SKUIStoreIdentifier initWithLongLong:]([SKUIStoreIdentifier alloc], "initWithLongLong:", a1[6]);
...
void __55__SKUIItemStateCenter_stateForItemWithStoreIdentifier___block_invoke(_QWORD *a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (void)addManifestDownloadWithURL:(id)a3 placeholderMetadata:(id)a4
{
  ...
  void *v10;
  void *v11;
  SKUIStoreIdentifier *v12;
  uint64_t v13;
  NSObject *accessQueue;
  SKUIStoreIdentifier *v15;
  id v16;
  SKUIStoreIdentifier *v17;
  _QWORD v18[5];
  SKUIStoreIdentifier *v19;
  _QWORD block[5];
  SKUIStoreIdentifier *v21;
  id v22;

  v6 = a4;
  v7 = (objc_class *)MEMORY[0x1E0DAF4E8];
  v8 = a3;
  v9 = [v7 alloc];
  ...
  v12 = -[SKUIStoreIdentifier initWithLongLong:]([SKUIStoreIdentifier alloc], "initWithLongLong:", objc_msgSend(v6, "itemIdentifier"));
  ...
  v18[0] = v13;
  v18[1] = 3221225472;
  v18[2] = __70__SKUIItemStateCenter_addManifestDownloadWithURL_placeholderMetadata___block_invoke_2;
  v18[3] = &unk_1E73A1730;
  v18[4] = self;
  v19 = v15;
  v17 = v15;
...
void __44__SKUIItemStateCenter_appstoredUpdatesStore__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
void __50__SKUIItemStateCenter_beginObservingLibraryItems___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    v11 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3550]), "initWithSet:", *(_QWORD *)(a1 + 40));
    v12 = *(_QWORD *)(a1 + 32);
    v13 = *(void **)(v12 + 112);
    *(_QWORD *)(v12 + 112) = v11;
...
void __50__SKUIItemStateCenter_beginObservingLibraryItems___block_invoke_2(uint64_t a1)
{
  ...
  v3 = SKUIWeakLinkedClassForString(CFSTR("MPMediaLibrary"), v2);
  ...
  v6 = (id *)SKUIWeakLinkedSymbolForString("MPMediaLibraryDidChangeNotification", v5);
  v7 = *(_QWORD *)(a1 + 32);
  v8 = *v6;
  objc_msgSend(v3, "defaultMediaLibrary");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)evaluatePurchaseResponseForRentals:(id)a3
{
  ...
  if (v4)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "valueForDownloadProperty:", *MEMORY[0x1E0DAF9D0]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (!v10 || !objc_msgSend(v10, "unsignedLongLongValue"))
    {
      ...
      if ((objc_opt_respondsToSelector() & 1) != 0)
      {
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v11, "longLongValue"));
    ...
    v13 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v10);
    objc_msgSend(v23, "purchase");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "valueForDownloadProperty:", *MEMORY[0x1E0DAF968]);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else if (v16 | v18)
    {
      ...
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      v22 = -[SKUIItemStateCenter _setStateFlag:forItemsWithIdentifiers:sendNotification:](self, "_setStateFlag:forItemsWithIdentifiers:sendNotification:", 2048, v20, 1);
LABEL_12:

      v4 = v23;
      goto LABEL_13;
    }
    -[SKUIItemStateCenter stateForItemWithStoreIdentifier:](self, "stateForItemWithStoreIdentifier:", v13);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v20, "state") & 0x800) != 0)
      v21 = -[SKUIItemStateCenter _removeState:forItemIdentifier:](self, "_removeState:forItemIdentifier:", 2048, v13);
    goto LABEL_12;
  }
LABEL_13:
...
void __48__SKUIItemStateCenter_endObservingLibraryItems___block_invoke(uint64_t a1)
{
  ...
  void *v7;
  uint64_t v8;
  SKUIStoreIdentifier *v9;
  void *v10;
  SKUIStoreIdentifier *v11;
  id v12;
  __int128 v13;
  __int128 v14;
  __int128 v15;
    ...
    do
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        if (v8 == 1)
        {
          ...
          v10 = (void *)objc_claimAutoreleasedReturnValue();
          v11 = -[SKUIStoreIdentifier initWithNumber:](v9, "initWithNumber:", v10);
...
- (void)getSoftwareUpdatesWithCompletionBlock:(id)a3
{
  ...
  v4 = a3;
  -[SKUIItemStateCenter appstoredUpdatesStore](self, "appstoredUpdatesStore");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v7[0] = MEMORY[0x1E0C809B0];
  v7[1] = 3221225472;
...
void __85__SKUIItemStateCenter_findLibraryItemsForContentIdentifiers_options_completionBlock___block_invoke(uint64_t a1)
{
  ...
  uint64_t v11;
  void *v12;
  SKUISoftwareLibraryInterface *v13;
  SKUISoftwareLibraryInterface *v14;
  void *v15;
  int v16;
  void *v17;
  NSObject *v18;
  ...
  v14 = v13;
  if (!v3
    || (-[SKUISoftwareLibraryInterface exposedPlatformItemKinds](v13, "exposedPlatformItemKinds"),
        v15 = (void *)objc_claimAutoreleasedReturnValue(),
    ...
    do
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
          ...
          v9 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithLongLong:", objc_msgSend(v7, "longLongValue"));
        v10 = v9;
        v11 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v9);
        -[SKUILibraryItem setStoreIdentifier:](v8, "setStoreIdentifier:", v11);
  ...
  if (v13)
  {
    ...
    do
    {
      for (j = 0; j != v15; ++j)
      {
        ...
        v29[0] = v14;
        v29[1] = 3221225472;
        v29[2] = __85__SKUIItemStateCenter_findLibraryItemsForContentIdentifiers_options_completionBlock___block_invoke_3;
        v29[3] = &unk_1E73A17A8;
        v30 = *(id *)(v25 + 48);
        v31 = v24;
...
void __85__SKUIItemStateCenter_findLibraryItemsForContentIdentifiers_options_completionBlock___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (objc_msgSend(v5, "availability") == 2)
  {
    ...
    if (!v6 || (v7 = *(void **)(a1 + 32)) == 0 || objc_msgSend(v7, "containsObject:", v6))
    {
      ...
      objc_msgSend(v8, "setObject:forKey:", v10, 0x1E73ADB50);
...
uint64_t __52__SKUIItemStateCenter_gratisEligibleItemIdentifiers__block_invoke(uint64_t a1)
{
  ...
  v4[0] = MEMORY[0x1E0C809B0];
  v4[1] = 3221225472;
  v4[2] = __52__SKUIItemStateCenter_gratisEligibleItemIdentifiers__block_invoke_2;
  v4[3] = &unk_1E73A15C8;
  v4[4] = v1;
  return objc_msgSend(v2, "enumerateKeysAndObjectsUsingBlock:", v4);
}
...
void __71__SKUIItemStateCenter_addRelationshipForParentAdamId_withChildAdamIds___block_invoke(uint64_t a1)
{
  ...
  v2 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", *(_QWORD *)(a1 + 32));
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = -[SKUIStoreIdentifier initWithNumber:](v10, "initWithNumber:", v9, (_QWORD)v12);
...
void __48__SKUIItemStateCenter_jobManager_completedJobs___block_invoke(uint64_t a1)
{
  ...
  uint64_t v57;
  uint64_t v58;
  SKUIStoreIdentifier *v59;
  SKUIStoreIdentifier *v60;
  SKUIStoreIdentifier *v61;
  id v62;
  __int128 v63;
  __int128 v64;
  __int128 v65;
  ...
  if (v58)
  {
    ...
    do
    {
      for (i = 0; i != v58; ++i)
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v3, "storeItemID", v47));
        v4 = (void *)objc_claimAutoreleasedReturnValue();
        v5 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v4);
...
LABEL_27:
            ...
            if (v28)
            {
              objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v28, 4, &v67, v48);
              v21 = objc_claimAutoreleasedReturnValue();
              free(v28);
              v47 = (int *)v21;
              SSFileLog();
...
LABEL_30:
        ...
        if (!v8)
        {
          ...
          if (v30)
          {
            ...
            if (v36)
            {
              objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v36, 4, &v67, v48);
              v31 = objc_claimAutoreleasedReturnValue();
              free(v36);
              v47 = (int *)v31;
              SSFileLog();
...
LABEL_39:
        ...
        if (v17)
        {
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v17, 4, &v67, v48);
          v14 = objc_claimAutoreleasedReturnValue();
          free(v17);
          v47 = (int *)v14;
          SSFileLog();
LABEL_42:
        ...
        if ((v18 & 4) == 0)
        {
          ...
          if (v43)
          {
            ...
            if (v46)
            {
              objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v46, 4, &v67, v48);
              v42 = objc_claimAutoreleasedReturnValue();
              free(v46);
              v47 = (int *)v42;
              SSFileLog();
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(v6 + 2024), "numberWithLongLong:", objc_msgSend(v9, "storeItemID", v24));
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        if (!v10)
        {
          v11 = 0;
LABEL_20:
        ...
        v11 = (void *)objc_msgSend(objc_alloc((Class)v7[191]), "initWithNumber:", v10);
        if (!v11)
          goto LABEL_20;
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(v6 + 2024), "numberWithLongLong:", objc_msgSend(v8, "storeItemID", v26));
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        if (!v9)
        {
          v10 = 0;
        ...
        v10 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v9);
        if (v10)
        {
          ...
          if (v11)
          {
            ...
            if (v18)
            {
              ...
              if (v23)
              {
                objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v23, 4, &v39, v27);
                v17 = objc_claimAutoreleasedReturnValue();
                free(v23);
                v26 = (int *)v17;
                SSFileLog();
...
void __63__SKUIItemStateCenter_downloadManager_downloadStatesDidChange___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    v35 = 0;
    v5 = *(_QWORD *)v46;
    v6 = *MEMORY[0x1E0DAF980];
    v7 = *MEMORY[0x1E0DAF808];
    v40 = v2;
    v41 = *MEMORY[0x1E0DAF9D0];
    v34 = *MEMORY[0x1E0DAF890];
    v42 = *MEMORY[0x1E0DAF808];
    v43 = a1;
    while (1)
    {
      v8 = 0;
      ...
      do
      {
        ...
        if ((v11 & 1) == 0)
        {
          ...
          if (v13)
          {
            v14 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v13);
            if (v14)
            {
              ...
              *(float *)&v20 = v20;
              ...
              if (objc_msgSend(*(id *)(*(_QWORD *)(v15 + 40) + 152), "itemHasParent:", v14))
              {
                ...
                v22 = (SKUIItemState *)objc_claimAutoreleasedReturnValue();
                if (!v22)
                {
                  ...
                  -[SKUIItemState setItemIdentifier:](v22, "setItemIdentifier:", v23);

                  -[SKUIItemState setStoreIdentifier:](v22, "setStoreIdentifier:", v37);
                  objc_msgSend(v16, "downloadPhase");
                  v24 = (void *)objc_claimAutoreleasedReturnValue();
                  -[SKUIItemState setDownloadPhase:](v22, "setDownloadPhase:", v24);

                  v21 = v37;
                  -[SKUIItemState setDownloadContentFlags:](v22, "setDownloadContentFlags:", objc_msgSend(v16, "downloadContentFlags"));
                ...
                -[SKUIItemState downloadProgress](v22, "downloadProgress");
                v27 = v26;
                v36 = v25;
                ...
                *(float *)&v31 = (float)(*(float *)&v31 / v28) + v30;
                if (*(float *)&v31 > 1.0)
                  *(float *)&v31 = 1.0;
                -[SKUIItemState setDownloadProgress:](v22, "setDownloadProgress:", v31);
                if ((objc_msgSend(v35, "isEqual:", v34) & 1) == 0)
                {
                  objc_msgSend(v9, "downloadPhaseIdentifier");
                  v38 = v21;
                  v32 = (void *)objc_claimAutoreleasedReturnValue();
                  -[SKUIItemState setDownloadPhase:](v22, "setDownloadPhase:", v32);
...
void __61__SKUIItemStateCenter_downloadQueue_downloadStatesDidChange___block_invoke(uint64_t a1)
{
  ...
  {
    v29 = *(_QWORD *)v32;
    v27 = *MEMORY[0x1E0DAF890];
    v26 = *MEMORY[0x1E0DAF8A8];
    v25 = v3;
    do
    {
      for (i = 0; i != v30; ++i)
...
LABEL_13:
        ...
        if (!v6)
          goto LABEL_31;
LABEL_15:
        v12 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v6);
        if (v12)
        {
        ...
        if (v21)
        {
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v21, 4, &v35, v24);
          v16 = objc_claimAutoreleasedReturnValue();
          free(v21);
          v23 = (int *)v16;
          SSFileLog();
...
LABEL_8:
          v44 = v6;
          v9 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v7);
          if (!v9
            ...
            do
            {
              for (i = 0; i != v14; ++i)
              {
                ...
                if ((objc_opt_respondsToSelector() & 1) != 0)
                {
                  ...
                  v21 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v15);
                  -[SKUILibraryItem setStoreIdentifier:](v20, "setStoreIdentifier:", v21);
...
LABEL_38:
        ...
        if (v32)
        {
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v32, 4, &v56, v35);
          v10 = objc_claimAutoreleasedReturnValue();
          free(v32);
          v34 = (int *)v10;
          SSFileLog();
...
- (void)_reloadStateForObservedMediaLibraryItems
{
  ...
  uint64_t v7;
  uint64_t v8;
  SKUIStoreItemRelationshipCounsellor *relationshipCouncellor;
  void *v10;
  void *v11;
  id v12;
  uint64_t v13;
    ...
    if (v5)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v10 = (void *)objc_claimAutoreleasedReturnValue();
          -[SKUIStoreItemRelationshipCounsellor childItemsForItem:](relationshipCouncellor, "childItemsForItem:", v10);
          v11 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          if (v13)
          {
            ...
            do
            {
              ...
              do
              {
                if (*(_QWORD *)v24 != v15)
                  objc_enumerationMutation(v12);
                SKUILibraryItemForStoreIdentifier(*(void **)(*((_QWORD *)&v23 + 1) + 8 * v16));
                v17 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    do
    {
      ...
      do
      {
        ...
        else
        {
          ...
          v15 = v14;
          v8 = v13;
          v12 = -[SKUIStoreIdentifier initWithNumber:](v15, "initWithNumber:", v11);
        }
        v16 = (void *)v12;
          ...
          if (objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 152), "itemHasParent:", v16))
          {
            ...
            if ((objc_msgSend(v64, "containsObject:", v30) & 1) == 0)
            {
              ...
              if (!v61)
              {
                ...
                v35 = (void *)objc_claimAutoreleasedReturnValue();
                -[SKUIItemState setItemIdentifier:](v34, "setItemIdentifier:", v35);

                -[SKUIItemState setStoreIdentifier:](v34, "setStoreIdentifier:", v62);
                -[SKUIItemState setState:](v34, "setState:", 0);
                v61 = v34;
                v36 = v34;
                v33 = v57;
              ...
              if (v38)
              {
                ...
                do
                {
                  for (i = 0; i != v39; ++i)
                  {
                    ...
                    SKUILibraryItemForStoreIdentifier(v43);
...
- (id)_addState:(unint64_t)a3 forItemIdentifier:(id)a4
{
  ...
  v7 = (SKUIItemState *)objc_claimAutoreleasedReturnValue();
  if (!v7)
  {
    if (v6)
    {
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIItemState setItemIdentifier:](v8, "setItemIdentifier:", v10);

      -[SKUIItemState setStoreIdentifier:](v8, "setStoreIdentifier:", v6);
      -[SKUIItemState setState:](v8, "setState:", a3);
      -[NSMutableDictionary setObject:forKey:](self->_itemStates, "setObject:forKey:", v8, v6);
      goto LABEL_16;
    }
    objc_msgSend(MEMORY[0x1E0DAF538], "sharedConfig");
    v8 = (SKUIItemState *)objc_claimAutoreleasedReturnValue();
    v11 = -[SKUIItemState shouldLog](v8, "shouldLog");
    if (-[SKUIItemState shouldLogToDisk](v8, "shouldLogToDisk"))
      v12 = v11 | 2;
    else
      v12 = v11;
    -[SKUIItemState OSLogObject](v8, "OSLogObject");
    ...
    if (v12)
    {
      ...
      *(_QWORD *)((char *)&v18 + 4) = objc_opt_class();
      ...
      if (!v15)
        goto LABEL_15;
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v15, 4, &v18, v17, v18);
      v13 = objc_claimAutoreleasedReturnValue();
      free(v15);
      SSFileLog();
    }
  ...
  v8 = v7;
  v9 = -[SKUIItemState state](v7, "state");
  if ((v9 & a3) != 0)
  {
LABEL_15:
  ...
  -[SKUIItemState setState:](v8, "setState:", v9 | a3);
LABEL_16:
...
- (id)_appstoredUpdatesStore
{
  ...
  {
    v3 = (ASDSoftwareUpdatesStore *)objc_alloc_init(MEMORY[0x1E0CF9DB8]);
    ...
    if (-[ASDSoftwareUpdatesStore hasEntitlement](self->_appstoredUpdatesStore, "hasEntitlement"))
    {
      objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "addObserver:selector:name:object:", self, sel__appstoredUpdatesStoreChangeNotification_, *MEMORY[0x1E0CF9C68], self->_appstoredUpdatesStore);
...
- (id)_copyItemsStatesForLibraryItems:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0CB3748];
  v5 = a3;
  ...
  v7 = v6;
  v10 = v7;
  -[SKUIItemStateCenter _enumerateAvailableItemsForLibraryItems:usingBlock:](self, "_enumerateAvailableItemsForLibraryItems:usingBlock:", v5, v9);
...
void __55__SKUIItemStateCenter__copyItemsStatesForLibraryItems___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIItemState setItemIdentifier:](v6, "setItemIdentifier:", v7);

  objc_msgSend(v18, "storeIdentifier");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIItemState setStoreIdentifier:](v6, "setStoreIdentifier:", v8);
  ...
  if (v10 == 3)
    ...
    v14 = v9;
  -[SKUIItemState setLibraryContentFlags:](v6, "setLibraryContentFlags:", v14);
  -[SKUIItemState setState:](v6, "setState:", v13);
  objc_msgSend(v5, "itemStateVariantIdentifier");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIItemState setVariantIdentifier:](v6, "setVariantIdentifier:", v15);
  ...
  if ((v16 & 8) != 0)
  {
    v17 = 5;
LABEL_19:
    -[SKUIItemState setMediaCategory:](v6, "setMediaCategory:", v17);
  }
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v20[0] = v13;
        v20[1] = 3221225472;
        v20[2] = __74__SKUIItemStateCenter__enumerateAvailableItemsForLibraryItems_usingBlock___block_invoke;
        v20[3] = &unk_1E73A1870;
        v17 = v9;
        v21 = v17;
        v22 = v7;
...
- (id)_downloadPhaseForJobPhase:(int64_t)a3
{
  ...
  if ((unint64_t)a3 > 6)
    v3 = (id *)MEMORY[0x1E0DAF8D0];
  else
    v3 = (id *)qword_1E73A1A70[a3];
  return *v3;
}
...
- (id)_newPurchaseWithItem:(id)a3 offer:(id)a4
{
  ...
  if (SKUIItemKindIsToneKind(objc_msgSend(v6, "itemKind")))
    v9 = (objc_class *)objc_opt_class();
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "setValue:forDownloadProperty:", v12, *MEMORY[0x1E0DAF8E8]);
  v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithLongLong:", objc_msgSend(v6, "itemIdentifier"));
  objc_msgSend(v10, "setValue:forDownloadProperty:", v13, *MEMORY[0x1E0DAF9D0]);
  objc_msgSend(v6, "artistName");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "setValue:forDownloadProperty:", v14, *MEMORY[0x1E0DAF8D8]);

  objc_msgSend(v6, "_downloadKind");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "setValue:forDownloadProperty:", v15, *MEMORY[0x1E0DAF980]);

  objc_msgSend(v6, "title");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "setValue:forDownloadProperty:", v16, *MEMORY[0x1E0DAF9F8]);

  if (objc_msgSend(v6, "isNewsstandApp"))
    objc_msgSend(v10, "setValue:forDownloadProperty:", *MEMORY[0x1E0DAFA10], *MEMORY[0x1E0DAF9B8]);
  if (objc_msgSend(v6, "hasPrerenderedArtwork"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", 1);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "setValue:forDownloadProperty:", v17, *MEMORY[0x1E0DAF8E0]);
  ...
  if (v19)
    objc_msgSend(v10, "setValue:forDownloadProperty:", MEMORY[0x1E0C9AAB0], *MEMORY[0x1E0DAF950]);
  if (objc_msgSend(v6, "itemKind") == 18)
    objc_msgSend(v10, "setEnabledServiceType:", &unk_1E749B480);
  if (-[SKUIItemStateCenter _isPurchaseForOffDeviceContent:](self, "_isPurchaseForOffDeviceContent:", v6))
  {
  ...
  if (v20 == 2)
  {
    v21 = *MEMORY[0x1E0DAF9D8];
    v22 = v10;
    v23 = v13;
LABEL_19:
    objc_msgSend(v22, "setValue:forDownloadProperty:", v23, v21);
  }
  v24 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v13);
  ...
  if (v25)
  {
    ...
    if ((v27 & 8) != 0)
    {
      objc_msgSend(v10, "setValue:forDownloadProperty:", MEMORY[0x1E0C9AAB0], *MEMORY[0x1E0DAF960]);
    }
    else if ((v27 & 0x10) != 0)
    {
      if (v12)
    ...
    if ((~v28 & 0x24) == 0)
    {
      ...
      if (!v33)
        v33 = objc_alloc_init(MEMORY[0x1E0DAF5C8]);
  ...
  {
    objc_msgSend(v10, "setValue:forDownloadProperty:", &unk_1E749B498, *MEMORY[0x1E0DAF938]);
  }
  ...
  objc_msgSend(v10, "setValue:forDownloadProperty:", v38, *MEMORY[0x1E0DAF9F0]);
...
- (id)_newSoftwarePurchaseWithItem:(id)a3 offer:(id)a4
{
  ...
  if (v8)
  {
    v9 = objc_alloc_init(MEMORY[0x1E0CF9D30]);
    ...
    v16 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v13);
      ...
      else if ((v19 & 0x10) != 0)
      {
        ...
        else
        {
          ...
          if (v26)
          {
            ...
            if (v31)
            {
              objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v31, 4, &v36, v28);
...
- (id)_newPurchasesWithBundleItem:(id)a3 bundleOffer:(id)a4
{
        ...
        for (i = 0; i != v15; ++i)
        {
          ...
          if ((v23 & 1) == 0)
          {
            ...
            else if ((v23 & 8) != 0)
            {
              ...
              v24 = (void *)objc_claimAutoreleasedReturnValue();
              v25 = -[SKUIItemStateCenter _newPurchaseWithItem:offer:](self, "_newPurchaseWithItem:offer:", v19, v24);
  ...
  {
    v26 = -[SKUIItemStateCenter _newPurchaseWithItem:offer:](self, "_newPurchaseWithItem:offer:", v6, v7);
    v27 = v26;
    if (v26)
    {
      objc_msgSend(v26, "setValue:forDownloadProperty:", MEMORY[0x1E0C9AAB0], *MEMORY[0x1E0DAF9B0]);
...
- (id)_newPurchasesForSoftwareWithBundleItem:(id)a3 bundleOffer:(id)a4
{
        ...
        for (i = 0; i != v15; ++i)
        {
          ...
          if ((v23 & 1) == 0)
          {
            ...
            else if ((v23 & 8) != 0)
            {
              objc_msgSend(v19, "primaryItemOffer");
              v24 = (void *)objc_claimAutoreleasedReturnValue();
              v25 = -[SKUIItemStateCenter _newSoftwarePurchaseWithItem:offer:](self, "_newSoftwarePurchaseWithItem:offer:", v19, v24);
  ...
  {
    v26 = -[SKUIItemStateCenter _newSoftwarePurchaseWithItem:offer:](self, "_newSoftwarePurchaseWithItem:offer:", v6, v7);
    v27 = v26;
    if (v26)
    {
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v12 = (void *)MEMORY[0x1BCCE6C7C](v7);
        v13 = objc_msgSend(v11, "itemKind", (_QWORD)v17);
        objc_msgSend(v11, "primaryItemOffer");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        if (v13 == 17)
        {
          v15 = -[SKUIItemStateCenter _newPurchasesWithBundleItem:bundleOffer:](self, "_newPurchasesWithBundleItem:bundleOffer:", v11, v14);
        ...
        {
          v15 = -[SKUIItemStateCenter _newPurchaseWithItem:offer:](self, "_newPurchaseWithItem:offer:", v11, v14);
...
- (void)_notifyObserversOfStateChange:(id)a3
{
  ...
  -[SKUIItemStateCenter _notifyObserversOfStateChanges:](self, "_notifyObserversOfStateChanges:", v6);
}
...
- (void)_performPurchases:(id)a3 hasBundlePurchase:(BOOL)a4 withClientContext:(id)a5 completionBlock:(id)a6
{
  ...
  {
    v49 = *(_QWORD *)v72;
    v10 = *MEMORY[0x1E0DAF9D0];
    v45 = *MEMORY[0x1E0DAF950];
    v44 = *MEMORY[0x1E0DAF968];
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        {
          v14 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v13);
          -[SKUIItemStateCenter _addState:forItemIdentifier:](self, "_addState:forItemIdentifier:", 1, v14);
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          if (v15)
          {
            v16 = v12;
  ...
  if (objc_msgSend(v46, "count"))
    -[SKUIItemStateCenter _notifyObserversOfStateChanges:](self, "_notifyObserversOfStateChanges:", v46);
  if (objc_msgSend(obj, "count") == 1)
  {
    objc_msgSend(obj, "lastObject");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "valueForDownloadProperty:", *MEMORY[0x1E0DAF968]);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(obj, "count") == 1)
  {
    objc_msgSend(obj, "lastObject");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v26, "valueForDownloadProperty:", *MEMORY[0x1E0DAF980]);
    v27 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      objc_msgSend(v26, "valueForDownloadProperty:", *MEMORY[0x1E0DAF9D8]);
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      v30 = v31 == 0;
  ...
  v34 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF5D8]), "initWithPurchases:", obj);
  v35 = v34;
  if (IsSoftwareKind)
  ...
  v61[1] = 3221225472;
  v61[2] = __93__SKUIItemStateCenter__performPurchases_hasBundlePurchase_withClientContext_completionBlock___block_invoke;
  v61[3] = &unk_1E73A1898;
  v62 = v33;
  v64 = v69;
  v65 = IsSoftwareKind;
  ...
  v51[0] = v36;
  v51[1] = 3221225472;
  v51[2] = __93__SKUIItemStateCenter__performPurchases_hasBundlePurchase_withClientContext_completionBlock___block_invoke_2;
  v51[3] = &unk_1E73A18C0;
  v37 = v62;
  v52 = v37;
  v38 = obj;
...
void __93__SKUIItemStateCenter__performPurchases_hasBundlePurchase_withClientContext_completionBlock___block_invoke(uint64_t a1, void *a2)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "valueForDownloadProperty:", *MEMORY[0x1E0DAF9D0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  if (v5)
  {
    v6 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v5);
...
void __93__SKUIItemStateCenter__performPurchases_hasBundlePurchase_withClientContext_completionBlock___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  {
    v4 = objc_alloc_init(MEMORY[0x1E0DAF5E0]);
...
- (void)_performSoftwarePurchases:(id)a3 withClientContext:(id)a4 completionBlock:(id)a5
{
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        if (v14)
        {
          v15 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v14);
          -[SKUIItemStateCenter _addState:forItemIdentifier:](self, "_addState:forItemIdentifier:", 1, v15);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          if (v16)
  ...
  if (objc_msgSend(v22, "count"))
    -[SKUIItemStateCenter _notifyObserversOfStateChanges:](self, "_notifyObserversOfStateChanges:", v22);
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CF9D68]), "initWithPurchases:", obj);
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CF9D60]), "initWithOptions:", v17);
...
void __83__SKUIItemStateCenter__performSoftwarePurchases_withClientContext_completionBlock___block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (!v11)
  {
    v13 = objc_alloc(MEMORY[0x1E0CF9D70]);
    v12 = (void *)objc_msgSend(v13, "initWithPurchaseResponseItems:", MEMORY[0x1E0C9AA60]);
...
- (id)_purchaseHistoryDatabase
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0DAF470], "databasePath");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v6 = (SSAppPurchaseHistoryDatabase *)objc_msgSend(MEMORY[0x1E0DAF468], "newDefaultInstance");
    purchaseHistoryDatabase = self->_purchaseHistoryDatabase;
    self->_purchaseHistoryDatabase = v6;

    DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)__PurchaseHistoryChangeNotification, (CFStringRef)*MEMORY[0x1E0DAF720], 0, CFNotificationSuspensionBehaviorCoalesce);
  }
...
- (void)_reloadDownloadManager
{
  ...
  v6[0] = v3;
  v6[1] = 3221225472;
  v6[2] = __45__SKUIItemStateCenter__reloadDownloadManager__block_invoke_2;
  v6[3] = &unk_1E73A1910;
...
- (void)_reloadJobManager
{
  ...
  v6[0] = v3;
  v6[1] = 3221225472;
  v6[2] = __40__SKUIItemStateCenter__reloadJobManager__block_invoke_2;
  v6[3] = &unk_1E73A1910;
  objc_copyWeak(&v7, &location);
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              SKUILibraryItemForStoreIdentifier(*(void **)(*((_QWORD *)&v22 + 1) + 8 * v14));
              v15 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      do
      {
        ...
        if (objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 112), "containsObject:", v6))
        {
          ...
          else
          {
            ...
            v8 = (void *)objc_claimAutoreleasedReturnValue();
            v9 = -[SKUIStoreIdentifier initWithNumber:](v10, "initWithNumber:", v8);
          }
          v11 = (void *)v9;
            ...
            if (v16)
            {
              ...
              do
              {
                for (i = 0; i != v17; ++i)
                {
                  ...
                  SKUILibraryItemForStoreIdentifier(*(void **)(*((_QWORD *)&v35 + 1) + 8 * i));
                  v21 = (void *)objc_claimAutoreleasedReturnValue();
...
void __45__SKUIItemStateCenter__reloadPurchaseHistory__block_invoke(uint64_t a1)
{
  ...
  objc_initWeak(&location, *(id *)(a1 + 32));
  v2 = objc_alloc_init(MEMORY[0x1E0DAF640]);
  v3[0] = MEMORY[0x1E0C809B0];
  v3[1] = 3221225472;
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v6; ++i)
        {
          ...
          if (v12)
          {
            v13 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v12);
            objc_msgSend(v11, "valueForProperty:", v9);
            v14 = (void *)objc_claimAutoreleasedReturnValue();
            -[SKUIStoreIdentifier setBundleIdentifier:](v13, "setBundleIdentifier:", v14);
...
uint64_t __45__SKUIItemStateCenter__reloadPurchaseHistory__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  objc_msgSend(MEMORY[0x1E0DAF618], "predicateWithProperty:equalToValue:", *MEMORY[0x1E0DAF728], *(_QWORD *)(a1 + 32));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)MEMORY[0x1E0DAF478];
  objc_msgSend(v3, "database");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "queryWithDatabase:predicate:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  v21[0] = (id)*MEMORY[0x1E0DAF738];
  v21[1] = (id)*MEMORY[0x1E0DAF730];
  v21[2] = (id)*MEMORY[0x1E0DAF740];
...
void __45__SKUIItemStateCenter__reloadPurchaseHistory__block_invoke_4(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  v8 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v10);
  -[SKUIStoreIdentifier setBundleIdentifier:](v8, "setBundleIdentifier:", v7);
  v9 = 40;
  if ((_DWORD)v6)
    v9 = 32;
...
- (void)_reloadSoftwareLibrary
{
  ...
  dispatch_async(accessQueue, block);
  objc_initWeak(&location, self);
  v5 = objc_alloc_init(MEMORY[0x1E0DAF640]);
  v6[0] = v3;
  v6[1] = 3221225472;
  v6[2] = __45__SKUIItemStateCenter__reloadSoftwareLibrary__block_invoke_2;
  v6[3] = &unk_1E73A19B0;
  objc_copyWeak(&v7, &location);
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (v8)
        {
          v9 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v8);
  ...
  if (v27)
  {
    ...
    do
    {
      for (i = 0; i != v27; ++i)
      {
        ...
        v6 = -[SKUIStoreIdentifier initWithLongLong:]([SKUIStoreIdentifier alloc], "initWithLongLong:", objc_msgSend(v5, "storeItemIdentifier"));
        objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 88), "objectForKey:", v6);
        v7 = (SKUIItemState *)objc_claimAutoreleasedReturnValue();
        v8 = -[SKUIItemState state](v7, "state");
...
LABEL_19:
              ...
              -[SKUIStoreIdentifier numberValue](v6, "numberValue");
              v10 = (void *)objc_claimAutoreleasedReturnValue();
              -[SKUIItemState setItemIdentifier:](v7, "setItemIdentifier:", v10);

              -[SKUIItemState setStoreIdentifier:](v7, "setStoreIdentifier:", v6);
              -[SKUIItemState setState:](v7, "setState:", v9);
        ...
        if (v8 != v9)
        {
          ...
          if (v15)
          {
            ...
            if (v19)
            {
              objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v19, 4, &v32, v21);
              v14 = objc_claimAutoreleasedReturnValue();
              free(v19);
              v20 = (int *)v14;
              SSFileLog();
...
void __37__SKUIItemStateCenter__setDownloads___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    v5 = v4;
    v6 = *(_QWORD *)v89;
    v7 = *MEMORY[0x1E0DAF980];
    v8 = *MEMORY[0x1E0DAF808];
    v70 = *MEMORY[0x1E0DAF9D0];
    v65 = *MEMORY[0x1E0DAF978];
    v63 = *MEMORY[0x1E0DAF968];
    v64 = *MEMORY[0x1E0DAF950];
    v62 = v2;
    v67 = *MEMORY[0x1E0DAF980];
    v68 = *(_QWORD *)v89;
    v66 = *MEMORY[0x1E0DAF808];
    v58 = v3;
    v59 = v1;
    do
    {
      ...
      do
      {
        ...
        if ((v12 & 1) == 0)
        {
          ...
          if (v13)
          {
            ...
            v15 = (SKUIItemState *)objc_claimAutoreleasedReturnValue();
            if (!v15)
            {
              v15 = objc_alloc_init(SKUIItemState);
              -[SKUIItemState setItemIdentifier:](v15, "setItemIdentifier:", v13);
              -[SKUIItemState setStoreIdentifier:](v15, "setStoreIdentifier:", v14);
              objc_msgSend(*(id *)(*(_QWORD *)(v1 + 32) + 88), "setObject:forKey:", v15, v14);
            }
            v16 = -[SKUIItemState state](v15, "state");
            if ((v16 & 2) == 0)
            {
              -[SKUIItemState setState:](v15, "setState:", v16 | 2);
              objc_msgSend(v3, "addObject:", v15);
            }
            v17 = -[SKUIItemState downloadContentFlags](v15, "downloadContentFlags");
            ...
            if ((v17 & 2) != v19)
            {
              -[SKUIItemState setDownloadContentFlags:](v15, "setDownloadContentFlags:", v17 | v19);
              objc_msgSend(v3, "addObject:", v15);
            }
            v20 = v10;
            ...
            if (v22)
              v25 = (__CFString *)v26;
            v27 = v25;
            -[SKUIItemState variantIdentifier](v15, "variantIdentifier");
            ...
            if ((v29 & 1) == 0)
            {
              -[SKUIItemState setVariantIdentifier:](v15, "setVariantIdentifier:", v27);
              objc_msgSend(v3, "addObject:", v15);
            }
            ...
            if (objc_msgSend(*(id *)(*(_QWORD *)(v1 + 32) + 152), "itemHasParent:", v14))
            {
              ...
              v31 = (SKUIItemState *)objc_claimAutoreleasedReturnValue();
              if (!v31)
              {
                v31 = objc_alloc_init(SKUIItemState);
                objc_msgSend(v30, "itemIdentifier");
                v32 = (void *)objc_claimAutoreleasedReturnValue();
                -[SKUIItemState setItemIdentifier:](v31, "setItemIdentifier:", v32);

                -[SKUIItemState setStoreIdentifier:](v31, "setStoreIdentifier:", v30);
                -[SKUIItemState downloadPhase](v15, "downloadPhase");
                v33 = (void *)objc_claimAutoreleasedReturnValue();
                -[SKUIItemState setDownloadPhase:](v31, "setDownloadPhase:", v33);

                objc_msgSend(*(id *)(*(_QWORD *)(v1 + 32) + 88), "setObject:forKey:", v31, v30);
              }
              v34 = -[SKUIItemState state](v31, "state");
              if ((v34 & 2) == 0)
              {
                -[SKUIItemState setState:](v31, "setState:", v34 | 2);
              ...
              if (v36)
              {
                ...
                while (2)
                {
                  for (i = 0; i != v37; ++i)
                  {
                    ...
                    v31 = (SKUIItemState *)objc_claimAutoreleasedReturnValue();
                    -[SKUIItemState downloadIdentifiers](v31, "downloadIdentifiers");
                    v40 = (void *)objc_claimAutoreleasedReturnValue();
                    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v20, "persistentIdentifier"));
                    v41 = (void *)objc_claimAutoreleasedReturnValue();
                    v42 = objc_msgSend(v40, "containsObject:", v41);

                    if (v42)
                    {
                      v43 = -[SKUIItemState state](v31, "state");
                      v3 = v58;
                      if ((v43 & 2) == 0)
                      {
                        -[SKUIItemState setState:](v31, "setState:", v43 | 2);
                        objc_msgSend(v58, "addObject:", v31);
                      }
                      v1 = v59;
                      v44 = *(void **)(*(_QWORD *)(v59 + 32) + 152);
                      objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", v73);
                      v45 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v31)
  {
    ...
    do
    {
      for (i = 0; i != v31; ++i)
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v4, "storeItemID", v23, v24));
        v5 = (void *)objc_claimAutoreleasedReturnValue();
        if (v5)
        {
          v6 = -[SKUIStoreIdentifier initWithNumber:]([SKUIStoreIdentifier alloc], "initWithNumber:", v5);
          ...
          {
            v7 = objc_alloc_init(SKUIItemState);
            -[SKUIItemState setItemIdentifier:](v7, "setItemIdentifier:", v5);
            -[SKUIItemState setStoreIdentifier:](v7, "setStoreIdentifier:", v6);
            objc_msgSend(*(id *)(*(_QWORD *)(v1 + 32) + 88), "setObject:forKey:", v7, v6);
          }
          v32 = v6;
          -[SKUIItemState setMediaCategory:](v7, "setMediaCategory:", 1);
          v8 = -[SKUIItemState state](v7, "state");
          v9 = v8;
          if ((v8 & 1) != 0)
            v10 = 0;
          ...
          *(float *)&v12 = v12;
          -[SKUIItemState setDownloadProgress:](v7, "setDownloadProgress:", v12);
          -[SKUIItemState setState:](v7, "setState:", v11);
          v13 = -[SKUIItemState downloadContentFlags](v7, "downloadContentFlags");
          if ((v13 & v11) != 0)
            -[SKUIItemState setDownloadContentFlags:](v7, "setDownloadContentFlags:", v13);
          if (v9 != v11 || v13 != 0)
          ...
          if (v16)
          {
            ...
            if (v21)
            {
              objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v21, 4, &v37, v24);
              v17 = objc_claimAutoreleasedReturnValue();
              free(v21);
              v23 = (int *)v17;
              SSFileLog();
...
void __42__SKUIItemStateCenter__setInstalledItems___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    v4 = v3;
    v5 = *(_QWORD *)v29;
    v6 = *MEMORY[0x1E0DAFD08];
    v24 = *MEMORY[0x1E0DAFCF8];
    v21 = *MEMORY[0x1E0DAFCE8];
    v7 = &off_1E739E000;
    do
    {
      for (i = 0; i != v4; ++i)
...
void __42__SKUIItemStateCenter__setInstalledItems___block_invoke_3(uint64_t a1)
{
  ...
  v15[0] = v3;
  v15[1] = 3221225472;
  v15[2] = __42__SKUIItemStateCenter__setInstalledItems___block_invoke_5;
  v15[3] = &unk_1E73A1A00;
  v7 = *(id *)(a1 + 40);
  v8 = *(_QWORD *)(a1 + 32);
  v16 = v7;
  ...
  v13[0] = v3;
  v13[1] = 3221225472;
  v13[2] = __42__SKUIItemStateCenter__setInstalledItems___block_invoke_6;
  v13[3] = &unk_1E73A1A28;
  v12 = v10;
  v14 = v12;
...
- (id)_setStateFlag:(unint64_t)a3 forItemsWithIdentifiers:(id)a4 sendNotification:(BOOL)a5
{
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        -[SKUIItemStateCenter _addState:forItemIdentifier:](self, "_addState:forItemIdentifier:", a3, v15);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        if (v16)
  ...
  if (v18)
  {
    ...
    do
    {
      for (j = 0; j != v19; ++j)
      {
        ...
        -[SKUIItemStateCenter _removeState:forItemIdentifier:](self, "_removeState:forItemIdentifier:", a3, *(_QWORD *)(*((_QWORD *)&v25 + 1) + 8 * j));
        v22 = (void *)objc_claimAutoreleasedReturnValue();
        if (v22)
  ...
  if (v24 && objc_msgSend(v8, "count"))
    -[SKUIItemStateCenter _notifyObserversOfStateChanges:](self, "_notifyObserversOfStateChanges:", v8);
...
- (id)_setStateFlag:(unint64_t)a3 forOnlyItemsWithIdentifiers:(id)a4 sendNotification:(BOOL)a5
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v17 = -[SKUIStoreIdentifier initWithNumber:](v16, "initWithNumber:", v15, (_QWORD)v20);
  ...
  -[SKUIItemStateCenter _setStateFlag:forItemsWithIdentifiers:sendNotification:](self, "_setStateFlag:forItemsWithIdentifiers:sendNotification:", a3, v9, v5);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return SKUIItemDeviceFamilyIsTVOnly(objc_msgSend(a3, "deviceFamilies"));
}
