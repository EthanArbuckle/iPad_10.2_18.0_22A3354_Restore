...
- (SKUICountdownFlapView)initWithPosition:(int64_t)a3 flapTopColor:(id)a4 flapBottomColor:(id)a5
{
  id v9;
  id v10;
  SKUICountdownFlapView *v11;
  SKUICountdownFlapView *v12;
  uint64_t v13;
  UILabel *labelTop;
  UIView *v15;
  ...
  {
    -[SKUICountdownFlapView initWithPosition:flapTopColor:flapBottomColor:].cold.1();
  }
  v32.receiver = self;
  v32.super_class = (Class)SKUICountdownFlapView;
  v11 = -[SKUICountdownFlapView init](&v32, sel_init);
  v12 = v11;
  if (v11)
  {
    v11->_factor = 0.0;
    ...
    v13 = -[SKUICountdownFlapView _newLabel](v12, "_newLabel");
    ...
    -[SKUICountdownFlapView addSubview:](v12, "addSubview:", v12->_backgroundViewTop);
    ...
    v17 = -[SKUICountdownFlapView _newLabel](v12, "_newLabel");
    ...
    -[SKUICountdownFlapView addSubview:](v12, "addSubview:", v12->_backgroundViewBot);
    ...
    v21 = -[SKUICountdownFlapView _newLabel](v12, "_newLabel");
    ...
    -[SKUICountdownFlapView addSubview:](v12, "addSubview:", v12->_backgroundViewTransitionTop);
    v26 = -[SKUICountdownFlapView _newLabel](v12, "_newLabel");
    ...
    -[SKUICountdownFlapView addSubview:](v12, "addSubview:", v12->_backgroundViewTransitionBot);
  }
...
- (void)layoutSubviews
{
  ...
  -[SKUICountdownFlapView bounds](self, "bounds");
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v10 = v3;
...
LABEL_4:
  ...
  if (width / 14.0 != factor && width / 14.0 != 0.0)
  {
    ...
    v8 = -[SKUICountdownFlapView _newBackgroundImageForTop:](self, "_newBackgroundImageForTop:", 1);
    ...
    v10 = -[SKUICountdownFlapView _newBackgroundImageForTop:](self, "_newBackgroundImageForTop:", 0);
    -[UIImageView setImage:](backgroundViewTransitionBot, "setImage:", v10);

    v11 = -[SKUICountdownFlapView _newBackgroundImageForTop:](self, "_newBackgroundImageForTop:", 0xFFFFFFFFLL);
    -[SKUICountdownFlapView setImage:](self, "setImage:", v11);

    v12 = self->_factor * 24.0;
    objc_msgSend(MEMORY[0x1E0DC1350], "fontWithName:size:", CFSTR("HelveticaNeue-CondensedBold"), roundf(v12));
    ...
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v26, 4, 0);
    ...
    -[SKUICountdownFlapView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)setString:(id)a3
{
  ...
  if ((objc_msgSend(v5, "isEqualToString:", string) & 1) == 0)
  {
    ...
    for (i = 0; i != 11; ++i)
    {
      ...
      -[SKUICountdownFlapView _transformForAngle:isTop:](self, "_transformForAngle:isTop:", 1, (float)((float)i / 10.0) * 3.14159265 * 0.5);
...
- (void)animationDidStop:(id)a3 finished:(BOOL)a4
{
  ...
  if (v7 == v5)
  {
    ...
    for (i = 0; i != 11; ++i)
    {
      ...
      -[SKUICountdownFlapView _transformForAngle:isTop:](self, "_transformForAngle:isTop:", 0, (float)(1.0 - (float)((float)i / 10.0)) * 3.14159265 * 0.5);
    ...
    v15 = objc_alloc_init(MEMORY[0x1E0CD2798]);
...
- (id)_newBackgroundImageForTop:(int)a3
{
  ...
  -[SKUICountdownFlapView frame](self, "frame");
  v7 = v6;
  v8 = v5;
  if (a3 == 1)
  {
...
LABEL_7:
  ...
  *(_OWORD *)locations = xmmword_1BBED1340;
  ...
  v55[0] = v47;
  v55[1] = v50;
  v51 = CFArrayCreate(0, v55, 2, MEMORY[0x1E0C9B378]);
...
- (CATransform3D)_transformForAngle:(SEL)a3 isTop:(double)a4
{
  ...
  v25 = (__int128 *)MEMORY[0x1E0CD2610];
  v26 = v20 * 0.25;
  v27 = v12 * 0.5;
