...
- (SKUIReviewsHistogramView)initWithClientContext:(id)a3
{
  ...
  SKUIReviewsHistogramView *v7;
  id *p_clientContext;
  SKUIStarRatingControl *v9;
  SKUIStarRatingControl *starRatingControl;
  SKUIStarRatingControl *v11;
  void *v12;
  void *v13;
  void *v14;
  SKUIStarRatingControl *v15;
  void *v16;
  void *v17;
  void *v18;
  UILabel *v19;
  ...
  {
    -[SKUIReviewsHistogramView initWithClientContext:].cold.1();
  }
  v74.receiver = self;
  v74.super_class = (Class)SKUIReviewsHistogramView;
  v6 = -[SKUIReviewsHistogramView init](&v74, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    if (SKUIUserInterfaceIdiom(*p_clientContext) == 1)
    {
      ...
      -[SKUIStarRatingControl setEmptyStarsImage:](v11, "setEmptyStarsImage:", v14);
      ...
      -[SKUIStarRatingControl setFilledStarsImage:](v15, "setFilledStarsImage:", v18);

      -[SKUIStarRatingControl sizeToFit](v7->_starRatingControl, "sizeToFit");
      -[SKUIReviewsHistogramView addSubview:](v7, "addSubview:", v7->_starRatingControl);
      ...
      -[SKUIReviewsHistogramView backgroundColor](v7, "backgroundColor");
      ...
      v33 = *p_starRatingControlLabel;
      if (*p_clientContext)
        objc_msgSend(*p_clientContext, "localizedStringForKey:inTable:", CFSTR("REVIEWS_TAP_TO_RATE"), CFSTR("ProductPage"));
      else
        +[SKUIClientContext localizedStringForKey:inBundles:inTable:](SKUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEWS_TAP_TO_RATE"), 0, CFSTR("ProductPage"));
    ...
    else
    {
      ...
      v32 = 0x1E0DC1000uLL;
      -[UIButton setTitle:forState:](v30, "setTitle:forState:", v34, 0);
      ...
      objc_msgSend(v38, "setMinimumScaleFactor:", 0.833333333);

      -[UIButton sizeToFit](v7->_appSupportButton, "sizeToFit");
      v39 = v7->_appSupportButton;
      -[SKUIColorScheme secondaryTextColor](v7->_colorScheme, "secondaryTextColor");
      v40 = (void *)objc_claimAutoreleasedReturnValue();
      -[UIButton setTintColor:](v39, "setTintColor:", v40);

      -[SKUIReviewsHistogramView addSubview:](v7, "addSubview:", v7->_appSupportButton);
      objc_msgSend(MEMORY[0x1E0DC3518], "buttonWithType:", 1);
      ...
      if (*p_clientContext)
        ...
        +[SKUIClientContext localizedStringForKey:inBundles:inTable:](SKUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEWS_HEADER_BUTTON_WRITE_A_REVIEW_IPHONE"), 0, CFSTR("ProductPage"));
      v45 = (void *)objc_claimAutoreleasedReturnValue();
      -[UIButton setTitle:forState:](v43, "setTitle:forState:", v45, 0);
      ...
      objc_msgSend(v48, "setAdjustsFontSizeToFitWidth:", 1);

      objc_msgSend(*p_starRatingControlLabel, "titleLabel");
      v49 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v49, "setMinimumScaleFactor:", 0.833333333);

      objc_msgSend(*p_starRatingControlLabel, "sizeToFit");
      v50 = *p_starRatingControlLabel;
      -[SKUIColorScheme secondaryTextColor](v7->_colorScheme, "secondaryTextColor");
      v51 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v50, "setTintColor:", v51);

    }
    -[SKUIReviewsHistogramView addSubview:](v7, "addSubview:", *p_starRatingControlLabel);
    v52 = objc_alloc(MEMORY[0x1E0DC3890]);
    -[SKUIReviewsHistogramView _histogramImageForValues:](v7, "_histogramImageForValues:", &unk_1E749BB00);
    v53 = (void *)objc_claimAutoreleasedReturnValue();
    v54 = objc_msgSend(v52, "initWithImage:", v53);
    ...
    -[SKUIReviewsHistogramView addSubview:](v7, "addSubview:", v7->_histogramImageView);
    v56 = objc_alloc(MEMORY[0x1E0DC3890]);
    +[SKUIRatingStarsCache cacheWithProperties:](SKUIRatingStarsCache, "cacheWithProperties:", 1);
    v57 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v57, "ratingStarsImageForRating:", 0.0);
    v58 = (void *)objc_claimAutoreleasedReturnValue();
    v59 = objc_msgSend(v56, "initWithImage:", v58);
    userRatingStarsView = v7->_userRatingStarsView;
    v7->_userRatingStarsView = (UIImageView *)v59;

    -[SKUIReviewsHistogramView addSubview:](v7, "addSubview:", v7->_userRatingStarsView);
    v61 = (UILabel *)objc_alloc_init(MEMORY[0x1E0DC3990]);
    ...
    if (v64)
    {
      -[UILabel setTextColor:](v63, "setTextColor:", v64);
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.0, 0.8);
    ...
    v66 = v7->_countLabel;
    objc_msgSend(*(id *)(v32 + 848), "systemFontOfSize:", 14.0);
    v67 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setFont:](v66, "setFont:", v67);

    -[SKUIReviewsHistogramView addSubview:](v7, "addSubview:", v7->_countLabel);
    -[SKUIReviewsHistogramView setNumberOfUserRatings:](v7, "setNumberOfUserRatings:", 0);
    v68 = (UIView *)objc_alloc_init(MEMORY[0x1E0DC3F10]);
    ...
    else
    {
      ...
      -[UIView setBackgroundColor:](v70, "setBackgroundColor:", v72);

    }
    -[SKUIReviewsHistogramView addSubview:](v7, "addSubview:", v7->_bottomSeparatorView);
  }
...
{
  return -[SKUIStarRatingControl userRating](self->_starRatingControl, "userRating");
}
...
- (UIControl)segmentedControl
{
  ...
  if (!segmentedControl)
  {
    ...
    v5 = (UISegmentedControl *)objc_msgSend(v4, "initWithItems:", MEMORY[0x1E0C9AA60]);
...
- (int64_t)selectedSegmentIndex
{
  ...
  -[SKUIReviewsHistogramView segmentedControl](self, "segmentedControl");
...
- (void)setColorScheme:(id)a3
{
  ...
  if (self->_colorScheme != v5)
  {
    ...
    -[SKUIReviewsHistogramView _histogramImageForValues:](self, "_histogramImageForValues:", self->_histogramValues);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setHistogramValues:(id)a3
{
  ...
  if (!-[NSArray isEqualToArray:](*p_histogramValues, "isEqualToArray:") && objc_msgSend(v8, "count") == 5)
  {
    ...
    histogramImageView = self->_histogramImageView;
    -[SKUIReviewsHistogramView _histogramImageForValues:](self, "_histogramImageForValues:", *p_histogramValues);
...
- (void)setNumberOfUserRatings:(int64_t)a3
{
  ...
  countLabel = self->_countLabel;
  -[SKUIReviewsHistogramView _countLabelString](self, "_countLabelString");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[UILabel setText:](countLabel, "setText:", v5);

  -[SKUIReviewsHistogramView setNeedsLayout](self, "setNeedsLayout");
}

- (void)setPersonalStarRating:(int64_t)a3
{
  -[SKUIStarRatingControl setUserRating:](self->_starRatingControl, "setUserRating:", a3);
}
...
- (void)setSegmentedControlTitles:(id)a3
{
  ...
  if (v6)
  {
    ...
    -[SKUIReviewsHistogramView addSubview:](self, "addSubview:", v7);
  }
  else
  {
  ...
  if (v4 != v16 && (objc_msgSend(v4, "isEqualToString:", v16) & 1) == 0)
  {
    ...
    if (v16)
    {
      if (!titleLabel)
      {
        ...
        v8 = self->_titleLabel;
        -[SKUIReviewsHistogramView backgroundColor](self, "backgroundColor");
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        -[SKUIReviewsHistogramView addSubview:](self, "addSubview:", self->_titleLabel);
        titleLabel = self->_titleLabel;
      }
...
- (void)layoutSubviews
{
  ...
  -[SKUIReviewsHistogramView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  titleLabel = self->_titleLabel;
  if (titleLabel)
  ...
  if (self->_starRatingControl)
  {
    ...
    v36 = v4 * 0.5;
    v37 = floorf(v36);
    -[SKUIStarRatingControl frame](self->_starRatingControl, "frame");
    v59 = v38;
    v40 = v39;
    ...
    *(float *)&v49 = v49 * 0.5;
    ...
    v12 = v60;
    -[SKUIStarRatingControl setFrame:](self->_starRatingControl, "setFrame:", MaxX + 8.0, v50, v59, v40);
    v51 = height;
    v4 = v61;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUIStarRatingControl setBackgroundColor:](self->_starRatingControl, "setBackgroundColor:", v5);
  ...
  -[SKUIReviewsHistogramView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
...
- (id)_histogramImageForValues:(id)a3
{
  ...
  -[SKUIColorScheme primaryTextColor](v63->_colorScheme, "primaryTextColor");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  if (v19)
  {
    -[SKUIColorScheme primaryTextColor](v63->_colorScheme, "primaryTextColor");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    SKUIColorWithAlpha(v20, 0.1);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    SKUITintedImage(v18, 0, v21);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v5, "count"))
  {
    ...
    do
    {
      ...
      objc_msgSend(MEMORY[0x1E0DC3508], "bezierPathWithRoundedRect:cornerRadius:", v48, (float)((float)v47 * 14.0) + 6.0, v49, 2.0, 2.0);
      v65 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_22:
          v15 = (void *)v11;
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithValidatedFormat:validFormatSpecifiers:error:", v11, CFSTR("%@%@"), 0, v5, self->_versionString);
          v12 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_26:
        v17 = (void *)v13;
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithValidatedFormat:validFormatSpecifiers:error:", v13, CFSTR("%@"), 0, v5);
        v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    +[SKUIClientContext localizedStringForKey:inBundles:inTable:](SKUIClientContext, "localizedStringForKey:inBundles:inTable:", v16, 0, CFSTR("ProductPage"));
    v13 = objc_claimAutoreleasedReturnValue();
    goto LABEL_26;
  }
  v9 = self->_clientContext;
  if (v9)
    -[SKUIClientContext localizedStringForKey:inTable:](v9, "localizedStringForKey:inTable:", CFSTR("REVIEWS_COUNT_NONE"), CFSTR("ProductPage"));
  else
    +[SKUIClientContext localizedStringForKey:inBundles:inTable:](SKUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEWS_COUNT_NONE"), 0, CFSTR("ProductPage"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_27:
