...
- (SKUICountdownView)initWithCountdown:(id)a3 clientContext:(id)a4
{
  id v7;
  id v8;
  SKUICountdownView *v9;
  SKUICountdownView *v10;
  id *p_clientContext;
  id *p_countdown;
  ...
  {
    -[SKUICountdownView initWithCountdown:clientContext:].cold.1();
  }
  v33.receiver = self;
  v33.super_class = (Class)SKUICountdownView;
  v9 = -[SKUICountdownView init](&v33, sel_init);
  v10 = v9;
  if (v9)
  {
    ...
    -[SKUICountdown numberFormat](v10->_countdown, "numberFormat");
    ...
    else
    {
      if (*p_clientContext)
        ...
        +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("COUNTDOWN_NUMBER_FORMAT"), 0);
    ...
    if ((objc_msgSend(*p_countdown, "isLoaded") & 1) == 0)
    {
      ...
      if (v18)
      {
        ...
        v19 = objc_alloc(MEMORY[0x1E0DAF698]);
        objc_msgSend(*p_countdown, "URL");
    ...
    -[SKUICountdownView _reload](v10, "_reload");
    -[SKUICountdownView start](v10, "start");
  }
...
- (void)dealloc
{
  ...
  -[SKUICountdownView dealloc](&v3, sel_dealloc);
}
  ...
  if (v4 != v12)
  {
    ...
    if (v12)
    {
      if (!imageView)
      {
        ...
        v9 = self->_imageView;
        -[SKUICountdownView backgroundColor](self, "backgroundColor");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        -[UIImageView setBackgroundColor:](v9, "setBackgroundColor:", v10);

        -[SKUICountdownView addSubview:](self, "addSubview:", self->_imageView);
        imageView = self->_imageView;
      }
    ...
    -[SKUICountdownView setNeedsLayout](self, "setNeedsLayout");
    v5 = v12;
  }
...
- (void)start
{
  double v3;
  uint64_t v4;
  SKUICountdownViewTimerTarget *timerTarget;
  SKUICountdownViewTimerTarget *v6;
  SKUICountdownViewTimerTarget *v7;
  SKUICountdownViewTimerTarget *v8;
  NSTimer *v9;
  NSTimer *timer;
  void *v11;
  uint64_t v12;
  ...
  if (-[SKUICountdown isLoaded](self->_countdown, "isLoaded"))
  {
    -[NSTimer invalidate](self->_timer, "invalidate");
    v3 = 1.0;
    if (!-[SKUICountdown type](self->_countdown, "type"))
    {
      v4 = -[SKUICountdown rate](self->_countdown, "rate");
    ...
    if (!timerTarget)
    {
      ...
      -[SKUICountdownViewTimerTarget setActionBlock:](v8, "setActionBlock:", &v12);
      objc_destroyWeak(&v16);
      objc_destroyWeak(&location);
      timerTarget = self->_timerTarget;
    }
    objc_msgSend(MEMORY[0x1E0C99E88], "timerWithTimeInterval:target:selector:userInfo:repeats:", timerTarget, sel_action, 0, 1, v3, v12, v13, v14, v15);
    ...
    objc_msgSend(v11, "addTimer:forMode:", self->_timer, *MEMORY[0x1E0C99860]);
...
- (void)setFrame:(CGRect)a3
{
  ...
  -[SKUICountdownView frame](self, "frame");
  self->_factor = v4 / 212.0;
  -[SKUICountdownView _reloadFontSizes](self, "_reloadFontSizes");
}
...
- (void)layoutSubviews
{
  ...
  -[SKUICountdownView layoutSubviews](&v181, sel_layoutSubviews);
  -[SKUICountdownView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  ...
  if (-[SKUICountdown isLoaded](self->_countdown, "isLoaded"))
  {
    -[SKUICountdown artworkProvider](self->_countdown, "artworkProvider");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v18 = -[SKUICountdown type](self->_countdown, "type");
    countdown = self->_countdown;
    if (v18)
    {
      if (-[SKUICountdown type](countdown, "type") != 1)
        return;
      v20 = -[SKUICountdown isFlapped](self->_countdown, "isFlapped");
        ...
        if (v24)
        {
          ...
          do
          {
            for (i = 0; i != v25; ++i)
            {
              ...
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v27 + v34 * 0.5);
...
LABEL_116:
      ...
      v183[3] = v58;
      objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v183, 4);
      ...
      v182[3] = v67;
      objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v182, 4);
          ...
          if (objc_msgSend(v59, "count"))
          {
            ...
            do
            {
              ...
              else
              {
                ...
                if (v76 < v77 + -5.0)
                  v76 = v77 + -5.0;
                objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v71 + v76 * 0.5);
...
LABEL_107:
    ...
    if (-[SKUICountdown isFlapped](countdown, "isFlapped"))
    {
...
- (id)_newDateLabel
{
  ...
  -[SKUICountdown fontColor](self->_countdown, "fontColor");
...
- (id)_newFlapLabelWithPosition:(int64_t)a3
{
  void *v5;
  void *v6;
  SKUICountdownFlapView *v7;
  void *v8;
  void *v9;

  -[SKUICountdown flapTopColor](self->_countdown, "flapTopColor");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUICountdown flapBottomColor](self->_countdown, "flapBottomColor");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[SKUICountdownFlapView initWithPosition:flapTopColor:flapBottomColor:]([SKUICountdownFlapView alloc], "initWithPosition:flapTopColor:flapBottomColor:", a3, v5, v6);
  objc_msgSend(MEMORY[0x1E0DC3658], "clearColor");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUICountdownFlapView setBackgroundColor:](v7, "setBackgroundColor:", v8);

  -[SKUICountdown fontColor](self->_countdown, "fontColor");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUICountdownFlapView setTextColor:](v7, "setTextColor:", v9);
...
- (void)_reload
{
  ...
  if (-[SKUICountdown isLoaded](self->_countdown, "isLoaded"))
  {
    v3 = -[SKUICountdown type](self->_countdown, "type");
    countdown = self->_countdown;
    if (v3)
    {
      if (-[SKUICountdown type](countdown, "type") == 1)
      {
        if (-[SKUICountdown isFlapped](self->_countdown, "isFlapped"))
        {
          -[SKUICountdownView _reloadTimeFlapped](self, "_reloadTimeFlapped");
          v5 = self;
          v6 = 0;
        }
        else
        {
          -[SKUICountdownView _reloadTime](self, "_reloadTime");
          v5 = self;
          v6 = 1;
        }
        -[SKUICountdownView _reloadDateDescriptions:](v5, "_reloadDateDescriptions:", v6);
      }
    }
    else if (-[SKUICountdown isFlapped](countdown, "isFlapped"))
    {
      -[SKUICountdownView _reloadNumberFlapped](self, "_reloadNumberFlapped");
    }
    else
    {
      -[SKUICountdownView _reloadNumber](self, "_reloadNumber");
    }
  }
}
...
- (void)_reloadNumber
{
  ...
  if (!self->_numberLabel)
  {
    ...
    -[SKUICountdownView addSubview:](self, "addSubview:", self->_numberLabel);
    -[SKUICountdownView setNeedsLayout](self, "setNeedsLayout");
  }
  numberFormatter = self->_numberFormatter;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[SKUICountdownView _currentValue](self, "_currentValue"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadNumberFlapped
{
  ...
  if (!self->_numberFlapLabels)
  {
    ...
    objc_msgSend(v7, "removeObject:", &stru_1E73A9FB0);
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    if (v10)
    {
      ...
      do
      {
        for (i = 0; i != v11; ++i)
        {
          ...
          v15 = -[SKUICountdownView _newNumberSeparatorLabel](self, "_newNumberSeparatorLabel");
          objc_msgSend(v15, "setText:", v14);
          objc_msgSend(v15, "sizeToFit");
          -[SKUICountdownView addSubview:](self, "addSubview:", v15);
        ...
        for (j = 0; j != v23; ++j)
        {
          ...
          if (objc_msgSend(v26, "length"))
          {
            ...
            do
            {
              ...
              v30 = -[SKUICountdownView _newFlapLabelWithPosition:](self, "_newFlapLabelWithPosition:", v29);
              -[SKUICountdownView addSubview:](self, "addSubview:", v30);
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), -[SKUICountdownView _currentValue](self, "_currentValue"));
...
- (void)_reloadDateDescriptions:(BOOL)a3
{
  ...
  v38 = 0;
  v39 = 0;
  -[SKUICountdownView _currentRemainingDays:hours:minutes:seconds:](self, "_currentRemainingDays:hours:minutes:seconds:", (char *)&v40 + 8, &v40, &v39, &v38);
  v5 = !v3;
  dateDescriptionLabelDay = self->_dateDescriptionLabelDay;
  if (*((_QWORD *)&v40 + 1))
    v7 = 1;
  ...
  if (v7)
  {
    if (dateDescriptionLabelDay)
      goto LABEL_14;
    v8 = -[SKUICountdownView _newDateDescriptionLabel](self, "_newDateDescriptionLabel");
    ...
    if (clientContext)
      -[SKUIClientContext localizedStringForKey:](clientContext, "localizedStringForKey:", CFSTR("COUNTDOWN_DAYS"));
    else
      +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("COUNTDOWN_DAYS"), 0);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setText:](v10, "setText:", v13);

    -[UILabel sizeToFit](self->_dateDescriptionLabelDay, "sizeToFit");
    -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateDescriptionLabelDay);
  }
  else
  {
    if (!dateDescriptionLabelDay)
...
LABEL_14:
  ...
  if ((v14 & 1) != 0)
  {
    if (dateDescriptionLabelHour)
      goto LABEL_26;
    v16 = -[SKUICountdownView _newDateDescriptionLabel](self, "_newDateDescriptionLabel");
    ...
    if (v19)
      -[SKUIClientContext localizedStringForKey:](v19, "localizedStringForKey:", CFSTR("COUNTDOWN_HOURS"));
    else
      +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("COUNTDOWN_HOURS"), 0);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setText:](v18, "setText:", v21);

    -[UILabel sizeToFit](self->_dateDescriptionLabelHour, "sizeToFit");
    -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateDescriptionLabelHour);
  }
  else
  {
    if (!dateDescriptionLabelHour)
...
LABEL_26:
  ...
  if ((v22 & 1) != 0)
  {
    if (dateDescriptionLabelMinute)
      goto LABEL_38;
    v24 = -[SKUICountdownView _newDateDescriptionLabel](self, "_newDateDescriptionLabel");
    ...
    if (v27)
      -[SKUIClientContext localizedStringForKey:](v27, "localizedStringForKey:", CFSTR("COUNTDOWN_MINUTES"));
    else
      +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("COUNTDOWN_MINUTES"), 0);
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setText:](v26, "setText:", v29);

    -[UILabel sizeToFit](self->_dateDescriptionLabelMinute, "sizeToFit");
    -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateDescriptionLabelMinute);
  }
  else
  {
    if (!dateDescriptionLabelMinute)
...
LABEL_38:
  ...
  if ((v30 & 1) != 0)
  {
    if (dateDescriptionLabelSecond)
      return;
    v32 = -[SKUICountdownView _newDateDescriptionLabel](self, "_newDateDescriptionLabel");
    ...
    if (v35)
      -[SKUIClientContext localizedStringForKey:](v35, "localizedStringForKey:", CFSTR("COUNTDOWN_SECONDS"));
    else
      +[SKUIClientContext localizedStringForKey:inBundles:](SKUIClientContext, "localizedStringForKey:inBundles:", CFSTR("COUNTDOWN_SECONDS"), 0);
    v37 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setText:](v34, "setText:", v37);

    -[UILabel sizeToFit](self->_dateDescriptionLabelSecond, "sizeToFit");
    -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateDescriptionLabelSecond);
  }
  else
  {
    if (!dateDescriptionLabelSecond)
...
- (void)_reloadTime
{
  ...
  v27 = 0;
  v28 = 0;
  -[SKUICountdownView _currentRemainingDays:hours:minutes:seconds:](self, "_currentRemainingDays:hours:minutes:seconds:", (char *)&v29 + 8, &v29, &v28, &v27);
  v3 = *((_QWORD *)&v29 + 1);
  dateLabelDay = self->_dateLabelDay;
  if (*((_QWORD *)&v29 + 1))
  {
    if (!dateLabelDay)
    {
      v5 = -[SKUICountdownView _newDateLabel](self, "_newDateLabel");
      v6 = self->_dateLabelDay;
      self->_dateLabelDay = v5;

      -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateLabelDay);
      -[SKUICountdownView setNeedsLayout](self, "setNeedsLayout");
      dateLabelDay = self->_dateLabelDay;
      v3 = *((_QWORD *)&v29 + 1);
    }
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%02ld"), v3);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (!dateLabelHour)
    {
      v11 = -[SKUICountdownView _newDateLabel](self, "_newDateLabel");
      v12 = self->_dateLabelHour;
      self->_dateLabelHour = v11;

      -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateLabelHour);
      -[SKUICountdownView setNeedsLayout](self, "setNeedsLayout");
      dateLabelHour = self->_dateLabelHour;
      v9 = v29;
    }
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%02ld"), v9);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v29 != 0 || v28)
  {
    if (!dateLabelMinute)
    {
      v18 = -[SKUICountdownView _newDateLabel](self, "_newDateLabel");
      v19 = self->_dateLabelMinute;
      self->_dateLabelMinute = v18;

      -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateLabelMinute);
      -[SKUICountdownView setNeedsLayout](self, "setNeedsLayout");
      dateLabelMinute = self->_dateLabelMinute;
      v15 = v28;
    }
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%02ld"), v15);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v29 != 0 || v28 || v27)
  {
    if (!dateLabelSecond)
    {
      v24 = -[SKUICountdownView _newDateLabel](self, "_newDateLabel");
      v25 = self->_dateLabelSecond;
      self->_dateLabelSecond = v24;

      -[SKUICountdownView addSubview:](self, "addSubview:", self->_dateLabelSecond);
      -[SKUICountdownView setNeedsLayout](self, "setNeedsLayout");
      dateLabelSecond = self->_dateLabelSecond;
      v21 = v27;
    }
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%02ld"), v21);
...
- (void)_reloadTimeFlapped
{
  ...
  v34 = 0;
  v35 = 0;
  -[SKUICountdownView _currentRemainingDays:hours:minutes:seconds:](self, "_currentRemainingDays:hours:minutes:seconds:", &v37, &v36, &v35, &v34);
  ...
  if (!dateFlapLabels)
  {
    ...
    do
    {
      objc_msgSend(MEMORY[0x1E0C99DE8], "array");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = -[SKUICountdownView _newFlapLabelWithPosition:](self, "_newFlapLabelWithPosition:", 0);
      -[SKUICountdownView addSubview:](self, "addSubview:", v8);
      objc_msgSend(v7, "addObject:", v8);

      v9 = -[SKUICountdownView _newFlapLabelWithPosition:](self, "_newFlapLabelWithPosition:", 2);
      -[SKUICountdownView addSubview:](self, "addSubview:", v9);
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v37 % 10);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v37 / 10 % 10);
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v36 % 10);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v36 / 10 % 10);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v35 % 10);
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v35 / 10 % 10);
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v34 % 10);
  ...
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%ld"), v34 / 10 % 10);
...
- (void)_reloadFontSizes
{
  ...
  if (self->_factor == 0.0 || !-[SKUICountdown isLoaded](self->_countdown, "isLoaded"))
    return;
  v108 = 0u;
  v109 = 0u;
  v106 = 0u;
  ...
  if (v28)
  {
    ...
    do
    {
      for (n = 0; n != v29; ++n)
      {
        ...
        objc_msgSend(MEMORY[0x1E0DC1350], "fontWithName:size:", CFSTR("HelveticaNeue-CondensedBold"), roundf(v33));
        v34 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_50:
    ...
    do
    {
      for (ii = 0; ii != v45; ++ii)
      {
        ...
        if (v48 != v49)
        {
          ...
          objc_msgSend(MEMORY[0x1E0DC1350], "fontWithName:size:", CFSTR("HelveticaNeue-CondensedBold"), roundf(v51));
          v52 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!dateDescriptionLabelHour)
  {
    objc_msgSend(MEMORY[0x1E0C99E38], "null", v54);
    v56 = (void *)objc_claimAutoreleasedReturnValue();
  }
  v111[1] = v56;
  dateDescriptionLabelMinute = self->_dateDescriptionLabelMinute;
  ...
  v111[3] = v60;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v111, 4, objb);
...
LABEL_70:
    ...
    do
    {
      for (jj = 0; jj != v64; ++jj)
      {
        ...
        if (v67 != v68)
        {
          ...
          objc_msgSend(MEMORY[0x1E0DC1350], "fontWithName:size:", CFSTR("HelveticaNeue-CondensedBold"), roundf(v69));
  ...
  objc_msgSend(MEMORY[0x1E0DC1350], "fontWithName:size:", CFSTR("HelveticaNeue-CondensedBold"), roundf(v72));
  v73 = (void *)objc_claimAutoreleasedReturnValue();
...
- (int64_t)_currentValue
{
  ...
  v3 = (double)-[SKUICountdown initialValue](self->_countdown, "initialValue");
  -[SKUICountdown startDate](self->_countdown, "startDate");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "timeIntervalSinceNow");
  v6 = v5;
  v7 = (double)-[SKUICountdown rate](self->_countdown, "rate");
  v8 = -[SKUICountdown initialValue](self->_countdown, "initialValue");
  v9 = -[SKUICountdown finalValue](self->_countdown, "finalValue");
  v10 = -1.0;
  if (v8 < v9)
    v10 = 1.0;
  ...
  if (v11 < 0)
    return 0;
  if (-[SKUICountdown finalValue](self->_countdown, "finalValue") < v11)
    return -[SKUICountdown finalValue](self->_countdown, "finalValue");
  return v11;
}
...
- (void)_currentRemainingDays:(int64_t *)a3 hours:(int64_t *)a4 minutes:(int64_t *)a5 seconds:(int64_t *)a6
{
  ...
  -[SKUICountdown endDate](self->_countdown, "endDate");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_setCountdownWithResponse:(id)a3 error:(id)a4
{
  ...
  {
    -[SKUICountdown updateWithDictionary:](self->_countdown, "updateWithDictionary:", v5);
    -[SKUICountdownView _reload](self, "_reload");
    -[SKUICountdownView _reloadFontSizes](self, "_reloadFontSizes");
    -[SKUICountdownView start](self, "start");
  }
