...
- (SKUILibraryItemState)initWithApplication:(id)a3
{
  ...
  {
    -[SKUILibraryItemState initWithApplication:].cold.1();
  }
  v17.receiver = self;
  v17.super_class = (Class)SKUILibraryItemState;
  v5 = -[SKUILibraryItemState init](&v17, sel_init);
  v6 = v5;
  if (v5)
  {
    v5->_availability = 2;
    objc_msgSend(v4, "valueForProperty:", *MEMORY[0x1E0DAFCE8]);
    v7 = objc_claimAutoreleasedReturnValue();
    bundleIdentifier = v6->_bundleIdentifier;
    v6->_bundleIdentifier = (NSString *)v7;

    objc_msgSend(v4, "valueForProperty:", *MEMORY[0x1E0DAFCF0]);
    v9 = objc_claimAutoreleasedReturnValue();
    bundleVersion = v6->_bundleVersion;
    v6->_bundleVersion = (NSString *)v9;

    objc_msgSend(v4, "valueForProperty:", *MEMORY[0x1E0DAFD00]);
    ...
    objc_msgSend(v4, "valueForProperty:", *MEMORY[0x1E0DAFD10]);
...
- (id)newJavaScriptRepresentation
{
  ...
  if (self->_highDefinition)
    objc_msgSend(v4, "setObject:forKey:", MEMORY[0x1E0C9AAB0], CFSTR("isHD"));
  if (self->_preview)
    objc_msgSend(v4, "setObject:forKey:", MEMORY[0x1E0C9AAB0], CFSTR("preview"));
  if (self->_rental)
    objc_msgSend(v4, "setObject:forKey:", MEMORY[0x1E0C9AAB0], CFSTR("rental"));
