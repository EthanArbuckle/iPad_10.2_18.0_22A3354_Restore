...
{
  return -[SKUIScrollingSegmentedControllerItemContext initWithViewController:](self, "initWithViewController:", 0);
}

- (SKUIScrollingSegmentedControllerItemContext)initWithViewController:(id)a3
{
  id v5;
  SKUIScrollingSegmentedControllerItemContext *v6;
  SKUIScrollingSegmentedControllerItemContext *v7;
  objc_super v9;
  ...
  {
    -[SKUIScrollingSegmentedControllerItemContext initWithViewController:].cold.1();
  }
  v9.receiver = self;
  v9.super_class = (Class)SKUIScrollingSegmentedControllerItemContext;
  v6 = -[SKUIScrollingSegmentedControllerItemContext init](&v9, sel_init);
  v7 = v6;
  if (v6)
  {
    if (v5)
...
- (void)applyNewContentInset:(UIEdgeInsets)a3
{
    ...
    || self->_desiredContentInsetsAdjustment.bottom != a3.bottom)
  {
    ...
    -[SKUIScrollingSegmentedControllerItemContext updateAppliedContentInsetsAdjustment](self, "updateAppliedContentInsetsAdjustment");
  }
}
...
- (void)updateAppliedContentInsetsAdjustment
{
  ...
  {
    v6 = (_OWORD *)MEMORY[0x1E0DC49E8];
    if (insetAdjustedContentScrollView)
      -[SKUIScrollingSegmentedControllerItemContext _applyNewContentInset:withOldContentInset:toContentScrollView:](self, "_applyNewContentInset:withOldContentInset:toContentScrollView:", insetAdjustedContentScrollView, *MEMORY[0x1E0DC49E8], *(double *)(MEMORY[0x1E0DC49E8] + 8), *(double *)(MEMORY[0x1E0DC49E8] + 16), *(double *)(MEMORY[0x1E0DC49E8] + 24), self->_appliedContentInsetsAdjustment.top, self->_appliedContentInsetsAdjustment.left, self->_appliedContentInsetsAdjustment.bottom, self->_appliedContentInsetsAdjustment.right);
    v7 = v6[1];
...
{
  return (SKUIScrollingSegmentedControllerItemContextDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
