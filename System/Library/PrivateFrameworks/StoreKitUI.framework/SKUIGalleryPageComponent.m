...
- (SKUIGalleryPageComponent)initWithCustomPageContext:(id)a3
{
  ...
  {
    -[SKUIGalleryPageComponent initWithCustomPageContext:].cold.1();
  }
  v31.receiver = self;
  v31.super_class = (Class)SKUIGalleryPageComponent;
  v5 = -[SKUIPageComponent initWithCustomPageContext:](&v31, sel_initWithCustomPageContext_, v4);
  if (v5)
  {
          ...
          for (i = 0; i != v14; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0 && SKUIPageComponentTypeForBlockType(v18) == 10)
              {
                ...
                v19 = (void *)objc_msgSend(objc_alloc((Class)SKUIPageComponentClassForComponentType(10)), "initWithCustomPageContext:", v11);
                if (v19)
