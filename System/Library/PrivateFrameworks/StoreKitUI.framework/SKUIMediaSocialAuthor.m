...
- (SKUIMediaSocialAuthor)initWithAuthorDictionary:(id)a3
{
  ...
  {
    -[SKUIMediaSocialAuthor initWithAuthorDictionary:].cold.1();
  }
  v31.receiver = self;
  v31.super_class = (Class)SKUIMediaSocialAuthor;
  v5 = -[SKUIMediaSocialAuthor init](&v31, sel_init);
  if (v5)
  {
...
- (unint64_t)hash
{
  ...
  if (!v4)
  {
    ...
    return -[SKUIMediaSocialAuthor hash](&v7, sel_hash);
  }
  return v4;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[SKUIMediaSocialAuthor identifier](self, "identifier");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "identifier");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v7, "isEqualToString:", v8))
    {
      -[SKUIMediaSocialAuthor authorType](self, "authorType");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
