...
{
  SKUIItemCollectionController *v3;
  ...
  {
    -[SKUIItemCollectionController _initSKUIItemCollectionController].cold.1();
  }
  v12.receiver = self;
  v12.super_class = (Class)SKUIItemCollectionController;
  v3 = -[SKUIItemCollectionController init](&v12, sel_init);
  v4 = v3;
  if (v3)
  {
    ...
    objc_msgSend(v9, "addObserver:selector:name:object:", v4, sel__memoryWarningNotification_, *MEMORY[0x1E0DC4778], 0);
    +[SKUIItemStateCenter defaultCenter](SKUIItemStateCenter, "defaultCenter");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "addObserver:", v4);
...
- (SKUIItemCollectionController)initWithClientContext:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SKUIItemCollectionController _initSKUIItemCollectionController](self, "_initSKUIItemCollectionController");
  v6 = v5;
  if (v5)
    -[SKUIItemCollectionController setClientContext:](v5, "setClientContext:", v4);
...
- (void)dealloc
{
  ...
  -[SKUIItemCollectionController dealloc](&v5, sel_dealloc);
}
...
- (void)cancelArtworkLoadForItemIndex:(int64_t)a3
{
  ...
  if (-[NSArray count](self->_items, "count") > a3)
  {
    ...
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithLongLong:", objc_msgSend(v14, "itemIdentifier"));
    -[NSMutableDictionary objectForKey:](self->_itemIDsToArtworkRequestIDs, "objectForKey:", v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (v6)
    {
      -[SKUIItemCollectionController _artworkLoader](self, "_artworkLoader");
...
- (void)didEndDisplayingItemAtIndex:(int64_t)a3
{
  ...
  if (-[NSArray count](self->_items, "count") > a3)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v12, "itemIdentifier"));
...
- (void)configureCellLayout:(id)a3 forIndex:(int64_t)a4
{
  ...
  {
    v12 = (void *)v11;
    -[SKUIItemCollectionController artworkContext](self, "artworkContext");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v6, "itemIdentifier"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIItemCollectionController _artworkLoader](self, "_artworkLoader");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_8:
    -[SKUIItemCollectionController _iconArtworkRequestWithItem:](self, "_iconArtworkRequestWithItem:", v6);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = v18;
    if (v18)
    {
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v18, "requestIdentifier"));
...
LABEL_13:
  if (!v15)
  {
    -[SKUIItemCollectionController _placeholderImageForItem:](self, "_placeholderImageForItem:", v6);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
  }
  objc_msgSend(v21, "setIconImage:", v15);
  -[SKUIItemCollectionController _reloadScreenshotForCellLayout:item:isRestricted:](self, "_reloadScreenshotForCellLayout:item:isRestricted:", v21, v6, v8);
...
- (void)loadNextPageOfArtworkWithReason:(int64_t)a3
{
  ...
  if (v5 >= 1)
  {
    ...
    do
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = -[SKUIItemCollectionController _loadArtworkForItem:reason:](self, "_loadArtworkForItem:reason:", v9, a3);
...
- (void)precacheNextPageArtworkForOffset:(CGPoint)a3 direction:(double)a4
{
  ...
  if (v11)
  {
    -[SKUIItemCollectionController numberOfPagesToCacheAhead](self, "numberOfPagesToCacheAhead");
    ...
    if (a4 <= 0.0)
    {
      ...
      if (v20 >= v22)
      {
        do
        {
          ...
          -[SKUIItemCollectionController _loadArtworkForItem:reason:](self, "_loadArtworkForItem:reason:", v23, -1);
    ...
    else
    {
      ...
      if (v18 < v17)
      {
        do
        {
          ...
          -[SKUIItemCollectionController _loadArtworkForItem:reason:](self, "_loadArtworkForItem:reason:", v19, -1);
...
{
  -[SKUIResourceLoader removeAllCachedResources](self->_artworkLoader, "removeAllCachedResources");
...
{
  -[SKUIResourceLoader enterBackground](self->_artworkLoader, "enterBackground");
}

- (void)enterForeground
{
  -[SKUIResourceLoader enterForeground](self->_artworkLoader, "enterForeground");
}
...
- (void)scrollViewWillEndDragging:(id)a3 withVelocity:(CGPoint)a4 targetContentOffset:(CGPoint *)a5
{
  ...
  double v9;
  double v10;
  SKUIItemCollectionController *v11;
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  v10 = v8;
  v11 = v6;
  -[SKUIItemCollectionController _enumerateVisibleCellLayoutsWithBlock:](self, "_enumerateVisibleCellLayoutsWithBlock:", v12);
...
{
  -[SKUIResourceLoader removeAllCachedResources](self->_artworkLoader, "removeAllCachedResources", a3);
  -[NSMutableDictionary removeAllObjects](self->_itemIDsToArtworkRequestIDs, "removeAllObjects");
  -[NSMutableDictionary removeAllObjects](self->_itemIDsToScreenshotRequestIDs, "removeAllObjects");
}
...
- (void)_enumerateVisibleCellLayoutsWithBlock:(id)a3
{
  ...
  v5 = -[NSArray count](self->_items, "count");
  v6 = -[SKUIItemCollectionController _visibleItemRange](self, "_visibleItemRange");
  v8 = v6 + v7;
  if (v6 < v6 + v7)
  {
    v9 = v6;
...
- (id)_iconArtworkRequestWithItem:(id)a3
{
  ...
  -[SKUIItemArtworkContext URLForItem:](self->_artworkContext, "URLForItem:", v4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8
        ...
        (v8 = (void *)objc_claimAutoreleasedReturnValue()) != 0))
  {
    ...
    -[SKUIItemArtworkContext dataConsumerForItem:](self->_artworkContext, "dataConsumerForItem:", v4);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    if (v11)
    {
    ...
    {
      -[SKUIItemCollectionController iconDataConsumer](self, "iconDataConsumer");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIArtworkRequest setDataConsumer:](v10, "setDataConsumer:", v12);
...
- (BOOL)_loadArtworkForItem:(id)a3 reason:(int64_t)a4
{
  ...
  -[SKUIItemCollectionController _artworkLoader](self, "_artworkLoader");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithLongLong:", objc_msgSend(v6, "itemIdentifier"));
  ...
  else
  {
    ...
    if (v11)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v11, "requestIdentifier"));
      v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v15)
  {
    -[SKUIItemCollectionController _screenshotArtworkRequestWithItem:](self, "_screenshotArtworkRequestWithItem:", v6);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    v17 = v16;
    if (v16)
    {
      itemIDsToScreenshotRequestIDs = self->_itemIDsToScreenshotRequestIDs;
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v16, "requestIdentifier"));
      v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_placeholderImageForItem:(id)a3
{
  ...
  if (artworkContext)
  {
    -[SKUIItemArtworkContext placeholderImageForItem:](artworkContext, "placeholderImageForItem:", v4);
...
- (id)_placeholderImageForScreenshot:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      -[SKUIItemCollectionController landscapeScreenshotDataConsumer](self, "landscapeScreenshotDataConsumer");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_6:
  ...
  else
  {
    ...
    if (!landscapeScreenshotPlaceholderImage)
    {
      -[SKUIItemCollectionController portraitScreenshotDataConsumer](self, "portraitScreenshotDataConsumer");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "sizeForVariant:", CFSTR("low-dpi"));
      v18 = v17;
      v20 = v19;
...
- (void)_reloadForItemStateChange:(id)a3
{
  ...
  v15 = v5;
  v13 = v5;
  -[SKUIItemCollectionController _enumerateVisibleCellLayoutsWithBlock:](self, "_enumerateVisibleCellLayoutsWithBlock:", v14);
...
- (void)_reloadForRestrictionsChange
{
  ...
  v6 = v3;
  v4 = v3;
  -[SKUIItemCollectionController _enumerateVisibleCellLayoutsWithBlock:](self, "_enumerateVisibleCellLayoutsWithBlock:", v5);
...
- (void)_reloadScreenshotForCellLayout:(id)a3 item:(id)a4 isRestricted:(BOOL)a5
{
  ...
  v22 = a3;
  v8 = a4;
  -[SKUIItemCollectionController _screenshotForItem:](self, "_screenshotForItem:", v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9)
  {
    if (v5)
    {
      -[SKUIItemCollectionController _placeholderImageForScreenshot:](self, "_placeholderImageForScreenshot:", v9);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_16:
      WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
    ...
    -[SKUIItemCollectionController _artworkLoader](self, "_artworkLoader");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v8, "itemIdentifier"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v13)
    {
      ...
      {
        -[SKUIItemCollectionController _screenshotArtworkRequestWithItem:](self, "_screenshotArtworkRequestWithItem:", v8);
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        v16 = v15;
        if (v15)
        {
...
- (id)_screenshotArtworkRequestWithItem:(id)a3
{
  ...
  -[SKUIItemCollectionController _screenshotForItem:](self, "_screenshotForItem:", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v5)
  {
    ...
    if (v8)
      ...
      -[SKUIItemCollectionController portraitScreenshotDataConsumer](self, "portraitScreenshotDataConsumer");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIArtworkRequest setDataConsumer:](v6, "setDataConsumer:", v9);

    -[SKUIArtworkRequest setURL:](v6, "setURL:", v5);
  }
  else
  {
    v6 = 0;
...
{
  SKUIItemCollectionDelegate **p_delegate;
  id v5;
  id WeakRetained;
  void *v7;
...
{
  return (SKUIItemCollectionDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
