...
{
  SKUIComposeTextFieldListView *result;
  objc_super v6;
...
- (void)dealloc
{
  ...
  -[SKUIComposeTextFieldListView dealloc](&v3, sel_dealloc);
}
...
- (void)layoutSubviews
{
  ...
  -[SKUIComposeTextFieldListView bounds](self, "bounds");
  -[SKUIComposeTextFieldListView safeAreaInsets](self, "safeAreaInsets");
...
- (void)reloadData
{
  ...
  if (v10 >= 1)
  {
    ...
    do
    {
      ...
      v19 = -[SKUIComposeTextField initWithConfiguration:style:]([SKUIComposeTextField alloc], "initWithConfiguration:style:", v16, self->_style);
      -[SKUIComposeTextField setHoverStyle:](v19, "setHoverStyle:", 0);
      -[SKUIComposeTextField setDelegate:](v19, "setDelegate:", self);
      -[NSMutableArray addObject:](self->_fields, "addObject:", v19);
      -[SKUIComposeTextFieldListView addSubview:](self, "addSubview:", v19);

      ++v13;
    }
    while (v10 != v13);
  }
  -[SKUIComposeTextFieldListView _updateValidity](self, "_updateValidity");
  -[SKUIComposeTextFieldListView layoutSubviews](self, "layoutSubviews");
  -[SKUIComposeTextFieldListView frame](self, "frame");
  v21 = v20;
  v23 = v22;
  v25 = v24;
  -[SKUIComposeTextFieldListView height](self, "height");
  -[SKUIComposeTextFieldListView setFrame:](self, "setFrame:", v21, v23, v25, v26);
  -[SKUIComposeTextFieldListView setNeedsLayout](self, "setNeedsLayout");
}
...
- (void)composeTextFieldValidityChanged:(id)a3
{
  ...
  -[SKUIComposeTextFieldListView _updateValidity](self, "_updateValidity", a3);
...
{
  return (SKUIComposeTextFieldListViewDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
