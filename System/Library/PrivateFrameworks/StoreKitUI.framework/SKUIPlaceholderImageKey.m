...
- (SKUIPlaceholderImageKey)initWithSize:(CGSize)a3 imageTreatment:(int64_t)a4 placeholderBackgroundColor:(id)a5
{
  ...
  double width;
  id v10;
  SKUIPlaceholderImageKey *v11;
  SKUIPlaceholderImageKey *v12;
  objc_super v14;
  ...
  v11 = -[SKUIPlaceholderImageKey init](&v14, sel_init);
  v12 = v11;
  if (v11)
  {
...
- (id)description
{
  ...
  -[SKUIPlaceholderImageKey description](&v7, sel_description);
