...
- (SKUIPhysicalCirclesView)initWithFrame:(CGRect)a3
{
  ...
  {
    -[SKUIPhysicalCirclesView initWithFrame:].cold.1();
  }
  v21.receiver = self;
  v21.super_class = (Class)SKUIPhysicalCirclesView;
  v8 = -[SKUIPhysicalCirclesView initWithFrame:](&v21, sel_initWithFrame_, x, y, width, height);
  if (v8)
  {
    v9 = SKUIPhysicsKitFramework();
    *((_QWORD *)v8 + 71) = v9;
    v10 = objc_alloc_init((Class)SKUIWeakLinkedClassForString(CFSTR("PKPhysicsWorld"), v9));
    v11 = (void *)*((_QWORD *)v8 + 72);
    *((_QWORD *)v8 + 72) = v10;

    objc_msgSend(*((id *)v8 + 72), "setContactDelegate:", v8);
    objc_msgSend(*((id *)v8 + 72), "setGravity:", 0.0, 0.0);
    v12 = objc_alloc_init((Class)SKUIWeakLinkedClassForString(CFSTR("PKPhysicsBody"), *((_QWORD *)v8 + 71)));
    v13 = (void *)*((_QWORD *)v8 + 65);
    *((_QWORD *)v8 + 65) = v12;

    objc_msgSend(*((id *)v8 + 65), "setPosition:", 0.0, 0.0);
    objc_msgSend(*((id *)v8 + 72), "addBody:", *((_QWORD *)v8 + 65));
    objc_msgSend(*((id *)v8 + 65), "setDynamic:", 0);
    *((_QWORD *)v8 + 66) = 0x7FFFFFFFFFFFFFFFLL;
    v14 = objc_msgSend(objc_alloc(MEMORY[0x1E0DC39C8]), "initWithTarget:action:", v8, sel__longPressAction_);
    v15 = (void *)*((_QWORD *)v8 + 67);
    *((_QWORD *)v8 + 67) = v14;

    objc_msgSend(v8, "addGestureRecognizer:", *((_QWORD *)v8 + 67));
    v16 = objc_msgSend(objc_alloc(MEMORY[0x1E0DC3AA0]), "initWithTarget:action:", v8, sel__panGestureAction_);
    v17 = (void *)*((_QWORD *)v8 + 70);
    *((_QWORD *)v8 + 70) = v16;

    objc_msgSend(v8, "addGestureRecognizer:", *((_QWORD *)v8 + 70));
    v18 = objc_msgSend(objc_alloc(MEMORY[0x1E0DC3D80]), "initWithTarget:action:", v8, sel__tapGestureAction_);
    v19 = (void *)*((_QWORD *)v8 + 74);
    *((_QWORD *)v8 + 74) = v18;

    objc_msgSend(v8, "addGestureRecognizer:", *((_QWORD *)v8 + 74));
...
- (void)dealloc
{
  ...
  -[SKUIPhysicalCirclesView removeGestureRecognizer:](self, "removeGestureRecognizer:", self->_longPressRecognizer);
  -[UIPanGestureRecognizer removeTarget:action:](self->_panRecognizer, "removeTarget:action:", self, 0);
  -[SKUIPhysicalCirclesView removeGestureRecognizer:](self, "removeGestureRecognizer:", self->_panRecognizer);
  -[UITapGestureRecognizer removeTarget:action:](self->_tapRecognizer, "removeTarget:action:", self, 0);
  -[SKUIPhysicalCirclesView removeGestureRecognizer:](self, "removeGestureRecognizer:", self->_tapRecognizer);
  v4.receiver = self;
  v4.super_class = (Class)SKUIPhysicalCirclesView;
  -[SKUIPhysicalCirclesView dealloc](&v4, sel_dealloc);
}
...
- (void)addCirclesWithCount:(int64_t)a3
{
  ...
  {
    -[SKUIPhysicalCirclesView reloadData](self, "reloadData", a3);
  }
  else
  {
    ...
    -[SKUIPhysicalCirclesView _loadCirclesWithStartIndex:totalCount:](self, "_loadCirclesWithStartIndex:totalCount:", v5, v5 + a3);
  }
}
...
- (id)addRepellorWithCenter:(CGPoint)a3 radius:(double)a4 bufferSize:(double)a5
{
  ...
  -[SKUICircleRepellor setBufferSize:](v10, "setBufferSize:", a5);
  -[SKUICircleRepellor setCenter:](v10, "setCenter:", x, y);
  -[SKUICircleRepellor setRadius:](v10, "setRadius:", a4);
  objc_msgSend(SKUIWeakLinkedClassForString(CFSTR("PKPhysicsBody"), (uint64_t)self->_physicsKitFramework), "bodyWithCircleOfRadius:", a4);
  ...
  -[SKUIPhysicalCirclesView bounds](self, "bounds");
  ...
  -[SKUICircleRepellor setPhysicsBody:](v10, "setPhysicsBody:", v11);
...
- (void)reloadData
{
  ...
  -[SKUIPhysicalCirclesView traitCollection](self, "traitCollection");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "horizontalSizeClass") == 2;

  v5 = dbl_1BBED2370[v4];
  *(_QWORD *)&self->_maximumFrequencyDistance = qword_1BBED2360[v4];
  self->_minimumFrequencyDistance = v5;
  -[SKUIPhysicalCirclesView _cancelStepTimers](self, "_cancelStepTimers");
  v22 = 0u;
  v23 = 0u;
  v20 = 0u;
  v21 = 0u;
  ...
  {
    -[SKUIPhysicalCirclesView _loadCirclesWithStartIndex:totalCount:](self, "_loadCirclesWithStartIndex:totalCount:", 0, v16);
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIPhysicalCirclesView removeRepellor:](self, "removeRepellor:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
...
- (void)removeCircleAtIndex:(int64_t)a3 animated:(BOOL)a4 completionBlock:(id)a5
{
  ...
  v5 = a4;
  v8 = (objc_class *)MEMORY[0x1E0CB36B8];
  v9 = a5;
  v10 = (id)objc_msgSend([v8 alloc], "initWithIndex:", a3);
  -[SKUIPhysicalCirclesView removeCirclesInIndexSet:animated:completionBlock:](self, "removeCirclesInIndexSet:animated:completionBlock:", v10, v5, v9);
...
- (void)removeCirclesInIndexSet:(id)a3 animated:(BOOL)a4 completionBlock:(id)a5
{
  ...
  v20[1] = 3221225472;
  v20[2] = __76__SKUIPhysicalCirclesView_removeCirclesInIndexSet_animated_completionBlock___block_invoke;
  v20[3] = &unk_1E73A25B8;
  v13 = v11;
  v21 = v13;
  v22 = self;
  ...
  if (a4)
  {
    ...
    v18[0] = v12;
    v18[1] = 3221225472;
    v18[2] = __76__SKUIPhysicalCirclesView_removeCirclesInIndexSet_animated_completionBlock___block_invoke_2;
    v18[3] = &unk_1E739FD38;
    v19 = v13;
    v15[0] = v12;
    v15[1] = 3221225472;
    v15[2] = __76__SKUIPhysicalCirclesView_removeCirclesInIndexSet_animated_completionBlock___block_invoke_3;
    v15[3] = &unk_1E73A6BD8;
    v15[4] = self;
    v16 = v19;
    v17 = v8;
  ...
  {
    -[SKUIPhysicalCirclesView _removeCircleBodies:](self, "_removeCircleBodies:", v13);
    if (v8)
...
- (void)removeCirclesInIndexSet:(id)a3 byAnimatingToPoint:(CGPoint)a4 delay:(double)a5 completionBlock:(id)a6
{
  ...
  v48[1] = 3221225472;
  v48[2] = __92__SKUIPhysicalCirclesView_removeCirclesInIndexSet_byAnimatingToPoint_delay_completionBlock___block_invoke;
  v48[3] = &unk_1E73A25B8;
  v48[4] = self;
  v15 = v13;
  v49 = v15;
  ...
  v45[0] = v14;
  v45[1] = 3221225472;
  v45[2] = __92__SKUIPhysicalCirclesView_removeCirclesInIndexSet_byAnimatingToPoint_delay_completionBlock___block_invoke_2;
  v45[3] = &unk_1E73A1578;
  v17 = v15;
  v46 = v17;
  v35 = v12;
  ...
  if (v40)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        +[SKUISimpleAnimationFactory easeQuadOutTimingFunction](SKUISimpleAnimationFactory, "easeQuadOutTimingFunction");
        ...
        +[SKUISimpleAnimationFactory easeQuadInTimingFunction](SKUISimpleAnimationFactory, "easeQuadInTimingFunction");
        v26 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        +[SKUISimpleAnimationFactory easeQuadInOutTimingFunction](SKUISimpleAnimationFactory, "easeQuadInOutTimingFunction");
        v32 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v31, "setTimingFunction:", v32);

        objc_msgSend(v31, "setFromValue:", &unk_1E749B768);
        objc_msgSend(v31, "setToValue:", &unk_1E749BBB0);
...
- (void)setSize:(CGSize)a3 forCircleAtIndex:(int64_t)a4
{
  ...
  v6 = (float (*)(void))SKUIWeakLinkedSymbolForString("PKGet_INV_PTM_RATIO", self->_physicsKitFramework);
  if (v6)
    objc_msgSend(v7, "setRadius:", width * 0.5 * v6());
  -[SKUIPhysicalCirclesView _calculateFrequencyScaling](self, "_calculateFrequencyScaling");
...
- (void)_longPressAction:(id)a3
{
  ...
  v12 = a3;
  -[SKUIPhysicalCirclesView delegate](self, "delegate");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((unint64_t)(v5 - 3) >= 2)
  {
    if (v5 == 1)
    {
      ...
      v9 = -[SKUIPhysicalCirclesView _circleIndexForPoint:](self, "_circleIndexForPoint:");
      if (v9 != 0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        -[SKUIPhysicalCirclesView _startFluctuationForCircleView:](self, "_startFluctuationForCircleView:", v11);
  ...
  else
  {
    ...
    if (longPressCircleIndex != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      -[SKUIPhysicalCirclesView _stopFluctuationForCircleView:](self, "_stopFluctuationForCircleView:", v8);
...
- (void)_panGestureAction:(id)a3
{
  ...
  if (objc_msgSend(v4, "state") == 2)
  {
    ...
    objc_msgSend(v4, "setTranslation:inView:", self, *MEMORY[0x1E0C9D538], *(double *)(MEMORY[0x1E0C9D538] + 8));
  }
...
- (void)_tapGestureAction:(id)a3
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0 && objc_msgSend(v6, "state") == 3)
  {
    ...
    v5 = -[SKUIPhysicalCirclesView _circleIndexForPoint:](self, "_circleIndexForPoint:");
    ...
    do
    {
      for (i = 0; i != v37; ++i)
      {
        ...
        if (v14)
        {
          ...
          -[SKUIPhysicalCirclesView _calculateFrequencyScaling](self, "_calculateFrequencyScaling");
          -[SKUIPhysicalCirclesView _addSpringForCircleBody:](self, "_addSpringForCircleBody:", v5);
        }
        v38 = (void *)v14;
        v41 = 0u;
        v42 = 0u;
  ...
  if (v4)
  {
    ...
    while (2)
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        {
          -[SKUIPhysicalCirclesView _calculateFrequencyScaling](self, "_calculateFrequencyScaling");
          -[SKUIPhysicalCirclesView _addSpringForCircleBody:](self, "_addSpringForCircleBody:", v8);
          v11 = 1;
          goto LABEL_11;
        }
      }
...
- (void)_addSpringForCircleBody:(id)a3
{
  ...
  v10 = v9;
  v12 = v11;
  objc_msgSend(SKUIWeakLinkedClassForString(CFSTR("PKPhysicsJointDistance"), (uint64_t)self->_physicsKitFramework), "jointWithBodyA:bodyB:localAnchorA:localAnchorB:", self->_groundBody, v4, v6, v8, *MEMORY[0x1E0C9D538], *(double *)(MEMORY[0x1E0C9D538] + 8));
...
- (id)_circleBodyWithView:(id)a3
{
  ...
  v8 = v7;
  v10 = v9;
  v11 = SKUIWeakLinkedClassForString(CFSTR("PKPhysicsBody"), (uint64_t)self->_physicsKitFramework);
  v12 = v6 * 0.5;
...
- (CGPoint)_initialPositionForCircleIndex:(int64_t)a3 view:(id)a4
{
  ...
  int64_t v15;
  unint64_t v16;
  SKUIPhysicalCircleConstants *p_constants;
...
- (void)_loadCirclesWithStartIndex:(int64_t)a3 totalCount:(int64_t)a4
{
  ...
  if (a3 < a4)
  {
    ...
    do
    {
      ...
      -[SKUIPhysicalCirclesView _initialPositionForCircleIndex:view:](self, "_initialPositionForCircleIndex:view:", v6, v8);
      objc_msgSend(v8, "setCenter:");
      objc_msgSend(v8, "setUserInteractionEnabled:", 0);
      -[SKUIPhysicalCirclesView _circleBodyWithView:](self, "_circleBodyWithView:", v8);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[NSMutableArray addObject:](self->_circleBodies, "addObject:", v9);
      -[PKPhysicsWorld addBody:](self->_physicsWorld, "addBody:", v9);
      -[SKUIPhysicalCirclesView addSubview:](self, "addSubview:", v8);
...
void __65__SKUIPhysicalCirclesView__loadCirclesWithStartIndex_totalCount___block_invoke(uint64_t a1)
{
  id WeakRetained;
  void *v2;
  char v3;
...
void __58__SKUIPhysicalCirclesView__startFluctuationForCircleView___block_invoke(uint64_t a1)
{
  ...
  v10[1] = 3221225472;
  v10[2] = __58__SKUIPhysicalCirclesView__startFluctuationForCircleView___block_invoke_2;
  v10[3] = &unk_1E739FD38;
  v11 = *(id *)(a1 + 32);
  ...
  v8[0] = v2;
  v8[1] = 3221225472;
  v8[2] = __58__SKUIPhysicalCirclesView__startFluctuationForCircleView___block_invoke_3;
  v8[3] = &unk_1E739FD38;
  v9 = *(id *)(a1 + 32);
  ...
  v6[0] = v2;
  v6[1] = 3221225472;
  v6[2] = __58__SKUIPhysicalCirclesView__startFluctuationForCircleView___block_invoke_4;
  v6[3] = &unk_1E739FD38;
  v7 = *(id *)(a1 + 32);
...
{
  return (SKUIPhysicalCirclesDataSource *)objc_loadWeakRetained((id *)&self->_dataSource);
}
...
{
  return (SKUIPhysicalCirclesDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
