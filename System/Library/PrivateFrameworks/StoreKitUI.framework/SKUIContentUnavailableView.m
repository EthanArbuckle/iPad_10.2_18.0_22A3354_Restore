...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9)
        +[SKUIContentUnavailableView prefetchResourcesForViewElement:reason:context:].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  }
  v24 = 0;
  v25 = &v24;
  ...
  v20[1] = 3221225472;
  v20[2] = __77__SKUIContentUnavailableView_prefetchResourcesForViewElement_reason_context___block_invoke;
  v20[3] = &unk_1E73A1208;
  v17 = v8;
  v22 = &v24;
  v23 = a4;
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4)
        +[SKUIContentUnavailableView preferredSizeForViewElement:context:].cold.1(v4, v5, v6, v7, v8, v9, v10, v11);
    }
  }
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v10)
        +[SKUIContentUnavailableView requestLayoutForViewElement:width:context:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    }
  }
  ...
  if (v19)
  {
    objc_msgSend(a1, "_attributedStringWithTitleLabel:context:", v19, v9);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "requestLayoutForLabel:attributedString:width:", v19, v20, (uint64_t)a4);

  }
  objc_msgSend(v8, "messageLabel");
  v21 = (void *)objc_claimAutoreleasedReturnValue();

  if (v21)
  {
    objc_msgSend(a1, "_attributedStringWithMessageLabel:context:", v21, v9);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "requestLayoutForLabel:attributedString:width:", v21, v22, (uint64_t)a4);
  ...
  if (v23)
  {
    objc_msgSend(a1, "_attributedStringWithButton:context:", v23, v9);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "requestLayoutForButton:attributedString:width:", v23, v24, (uint64_t)a4);
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9)
        +[SKUIContentUnavailableView sizeThatFitsWidth:viewElement:context:].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  }
  v35 = 0;
  v36 = (double *)&v35;
  ...
  v26[1] = 3221225472;
  v26[2] = __68__SKUIContentUnavailableView_sizeThatFitsWidth_viewElement_context___block_invoke;
  v26[3] = &unk_1E73A2810;
  v17 = v8;
  v30 = a3;
  v27 = v17;
  v28 = &v31;
  v29 = &v35;
  objc_msgSend(v7, "enumerateChildrenUsingBlock:", v26);
  v18 = v32[3];
  v19 = v36;
  v20 = v18 <= 1;
  v21 = v18 - 1;
  ...
  {
    v22 = v36[5] + (float)((float)v21 * 35.0);
    v36[5] = v22;
  }
  v23 = v19[4];
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  SKUIAttributedStringView *messageView;
...
- (void)setContentInset:(UIEdgeInsets)a3
{
    ...
    || self->_contentInset.bottom != a3.bottom)
  {
    ...
    -[SKUIContentUnavailableView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SKUIContentUnavailableView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  ...
  if (objc_msgSend(v11, "count"))
  {
    ...
    *(double *)&v24[9] = v8;
    ...
    CGRectGetHeight(v31);
    -[SKUIContentUnavailableView _baselineOffsetForView:](self, "_baselineOffsetForView:", v13);
    if (v14)
    {
      objc_msgSend(v14, "frame");
      CGRectGetHeight(v32);
      -[SKUIContentUnavailableView _baselineOffsetForView:](self, "_baselineOffsetForView:", v14);
    }
    objc_msgSend(v14, "frame");
    CGRectGetMaxY(v33);
    v20 = 0u;
...
- (void)_buttonAction:(id)a3
{
  ...
  {
    -[SKUIButtonViewElement dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:](buttonElement, "dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:", 2, 1, 1, 0, 0);
  }
...
{
  SKUIAttributedStringView *button;
  SKUIAttributedStringView *v5;
  double v6;
  double v7;
...
LABEL_6:
      -[SKUIAttributedStringView baselineOffset](button, "baselineOffset");
      v6 = v7;
    }
  }
...
- (double)_firstBaselineOffsetForView:(id)a3
{
  ...
  if ((SKUIAttributedStringView *)self->_button == button)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      button = (SKUIAttributedStringView *)self->_button;
LABEL_6:
      -[SKUIAttributedStringView firstBaselineOffset](button, "firstBaselineOffset");
      v6 = v7;
    }
  }
