...
{
  id v5;
  SKUIDonationAmountView *v6;
  SKUIDonationAmountView *v7;
  id *p_charity;
  uint64_t v9;
  UIScrollView *v10;
  ...
  {
    -[SKUIDonationAmountView initWithCharity:].cold.1();
  }
  v60.receiver = self;
  v60.super_class = (Class)SKUIDonationAmountView;
  v6 = -[SKUIDonationAmountView init](&v60, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    v10 = (UIScrollView *)objc_alloc_init(MEMORY[0x1E0DC3C28]);
    ...
    -[SKUIDonationAmountView addSubview:](v7, "addSubview:", v7->_scrollView);
    ...
    SKUIGiftAmountButtonsWithAmounts(v40);
...
- (void)dealloc
{
  ...
  -[SKUIDonationAmountView dealloc](&v8, sel_dealloc);
}
...
- (SKUIGiftAmount)selectedAmount
{
  ...
  -[SKUIGiftCharity donationAmounts](self->_charity, "donationAmounts");
...
- (void)setLogoImage:(id)a3
{
  ...
  v14 = a3;
  -[SKUIDonationAmountView logoImage](self, "logoImage");
  ...
  if (v4 != v14)
  {
    ...
    if (v14)
    {
      if (!logoImageView)
      {
        ...
        -[SKUIGiftCharity name](self->_charity, "name");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        -[UIImageView setAccessibilityLabel:](v9, "setAccessibilityLabel:", v10);

        v11 = self->_logoImageView;
        -[SKUIDonationAmountView backgroundColor](self, "backgroundColor");
        v12 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      -[SKUIDonationAmountView setNeedsLayout](self, "setNeedsLayout");
    }
    else
    {
...
- (void)layoutSubviews
{
  ...
  -[SKUIDonationAmountView bounds](self, "bounds");
  v4 = v3;
  ...
  if ((v9 & 0xFFFFFFFFFFFFFFFBLL) == 1)
    ...
    v10 = 15.0;
  v11 = v4 - v10;
  -[SKUIGiftCharity logoArtwork](self->_charity, "logoArtwork");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v12;
  if (v12)
  {
...
- (void)_amountButtonUpInside:(id)a3
{
  ...
  objc_msgSend(v6, "postNotificationName:object:", CFSTR("SKUIDonationAmountViewChangedNotification"), self);
...
- (void)_amountButtonUpOutside:(id)a3
{
  ...
  if (self->_selectedAmountIndex == -[NSArray indexOfObjectIdenticalTo:](self->_amountButtons, "indexOfObjectIdenticalTo:"))
  {
    ...
    objc_msgSend(v4, "postNotificationName:object:", CFSTR("SKUIDonationAmountViewChangedNotification"), self);
