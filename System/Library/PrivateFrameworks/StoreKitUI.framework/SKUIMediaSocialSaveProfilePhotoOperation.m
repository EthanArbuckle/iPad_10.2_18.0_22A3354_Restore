...
{
  id v5;
  SKUIMediaSocialSaveProfilePhotoOperation *v6;
  SKUIMediaSocialSaveProfilePhotoOperation *v7;
  NSLock *v8;
  NSLock *lock;
  objc_super v11;
  ...
  {
    -[SKUIMediaSocialSaveProfilePhotoOperation initWithClientContext:].cold.1();
  }
  v11.receiver = self;
...
- (void)main
{
  ...
  v25 = 0;
  obj = 0;
  -[SKUIMediaSocialSaveProfilePhotoOperation _requestWithError:](self, "_requestWithError:", &obj);
  ...
  if (v3)
  {
    ...
    else
    {
      ...
      {
        -[SKUIMediaSocialSaveProfilePhotoOperation _photoUploadWithResponseDictionary:](self, "_photoUploadWithResponseDictionary:", v14[5]);
  ...
  -[SKUIMediaSocialSaveProfilePhotoOperation outputBlock](self, "outputBlock");
...
{
  id v3;
  SKUIMediaSocialPhotoUpload *v4;

  v3 = a3;
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
    v4 = -[SKUIMediaSocialPhotoUpload initWithUploadDictionary:]([SKUIMediaSocialPhotoUpload alloc], "initWithUploadDictionary:", v3);
  else
    v4 = 0;
...
LABEL_9:
  ...
  if (!self->_photo)
  {
    if (a3)
    {
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB35C8]), "initWithDomain:code:userInfo:", CFSTR("SKUIErrorDomain"), 4, 0);
      goto LABEL_8;
    }
    goto LABEL_9;
  }
