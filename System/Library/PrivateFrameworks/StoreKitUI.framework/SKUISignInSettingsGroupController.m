...
- (BOOL)isAuthenticating
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3)
        -[SKUISignInSettingsGroupController isAuthenticating].cold.1(v3, v4, v5, v6, v7, v8, v9, v10);
    }
  }
...
- (void)returnInSettingDescription:(id)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v5)
        -[SKUISignInSettingsGroupController returnInSettingDescription:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  -[SKUISignInSettingsGroupController _keyForSettingDescription:](self, "_keyForSettingDescription:", v4);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v13, "isEqualToString:", CFSTR("accountName")))
  {
    -[SKUISignInSettingsGroupController _becomeFirstResponderWithKey:](self, "_becomeFirstResponderWithKey:", CFSTR("password"));
  }
  else
  {
    -[SKUISignInSettingsGroupController _resignFirstResponder](self, "_resignFirstResponder");
    if (self->_valid)
      -[SKUISignInSettingsGroupController _attemptSignInWithAccountName:password:](self, "_attemptSignInWithAccountName:password:", self->_accountName, self->_password);
  }
...
- (void)setValue:(id)a3 forSettingDescription:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        -[SKUISignInSettingsGroupController setValue:forSettingDescription:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  -[SKUISignInSettingsGroupController _keyForSettingDescription:](self, "_keyForSettingDescription:", v7);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (v16)
    -[SKUISignInSettingsGroupController setValue:forKey:](self, "setValue:forKey:", v6, v16);
  -[SKUISignInSettingsGroupController _updateValidation](self, "_updateValidation");
...
- (void)submitSettingDescription:(id)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v5)
        -[SKUISignInSettingsGroupController submitSettingDescription:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  -[SKUISignInSettingsGroupController _resignFirstResponder](self, "_resignFirstResponder");
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    v13 = v4;
    v14 = v13;
    if (self->_valid && objc_msgSend(v13, "fieldType") == 1)
      -[SKUISignInSettingsGroupController _attemptSignInWithAccountName:password:](self, "_attemptSignInWithAccountName:password:", self->_accountName, self->_password);
...
- (id)valueForSettingDescription:(id)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v5)
        -[SKUISignInSettingsGroupController valueForSettingDescription:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  -[SKUISignInSettingsGroupController _keyForSettingDescription:](self, "_keyForSettingDescription:", v4);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
  {
    -[SKUISignInSettingsGroupController valueForKey:](self, "valueForKey:", v13);
...
- (void)_attemptSignInWithAccountName:(id)a3 password:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[SKUISignInSettingsGroupController _updateFieldsAuthenticating:](self, "_updateFieldsAuthenticating:", 1);
  v8 = objc_alloc_init(MEMORY[0x1E0D00130]);
  v9 = objc_alloc_init(MEMORY[0x1E0D002F8]);
  ...
  -[SKUISettingsGroupController delegate](self, "delegate");
...
- (void)_updateFieldsAuthenticating:(BOOL)a3
{
  ...
  if (self->_authenticating != a3)
  {
    ...
    v14 = 0u;
    v15 = 0u;
    -[SKUISettingsGroupController settingDescriptions](self, "settingDescriptions", 0);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          -[SKUISettingsGroupController _viewForSettingDescription:](self, "_viewForSettingDescription:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i));
          v11 = (void *)objc_claimAutoreleasedReturnValue();
          objc_opt_class();
...
- (void)_becomeFirstResponderWithKey:(id)a3
{
  ...
  -[SKUISignInSettingsGroupController _settingDescriptionForKey:](self, "_settingDescriptionForKey:", a3);
  v5 = (id)objc_claimAutoreleasedReturnValue();
  -[SKUISettingsGroupController _viewForSettingDescription:](self, "_viewForSettingDescription:");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUISettingsGroupController _viewForSettingDescription:](self, "_viewForSettingDescription:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v7));
  ...
  if (v13)
  {
    ...
    while (2)
    {
      for (i = 0; i != v13; i = (char *)i + 1)
      {
        ...
        -[SKUISignInSettingsGroupController _keyForSettingDescription:](self, "_keyForSettingDescription:", 0);
...
- (void)_signInFailed:(id)a3 error:(id)a4
{
  ...
  -[SKUISettingsGroupController settingsGroupDescription](self, "settingsGroupDescription");
  ...
  if (v19)
  {
    ...
    v22 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99D80]), "initWithObjectsAndKeys:", CFSTR("failed"), CFSTR("result"), v23, CFSTR("accountName"), v20, CFSTR("reason"), 0);
...
- (void)_updateValidation
{
  ...
  if (-[NSString length](self->_accountName, "length"))
    ...
    v3 = 0;
  self->_valid = v3;
  -[SKUISignInSettingsGroupController _submitSettingDescription](self, "_submitSettingDescription");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  -[SKUISettingsGroupController _reloadSettingDescription:](self, "_reloadSettingDescription:", v4);
