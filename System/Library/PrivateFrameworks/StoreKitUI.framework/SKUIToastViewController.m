...
- (SKUIToastViewController)initWithTitle:(id)a3 description:(id)a4 image:(id)a5
{
  ...
  {
    -[SKUIToastViewController initWithTitle:description:image:].cold.1();
  }
  v29.receiver = self;
  v29.super_class = (Class)SKUIToastViewController;
  v12 = -[SKUIToastViewController initWithNibName:bundle:](&v29, sel_initWithNibName_bundle_, 0, 0);
  if (v12)
  {
    ...
    v20 = objc_msgSend(objc_alloc(MEMORY[0x1E0DC3990]), "initWithFrame:", v14, v15, v16, v17);
    secondaryLabel = v12->_secondaryLabel;
    v12->_secondaryLabel = (UILabel *)v20;

    v22 = objc_msgSend(objc_alloc(MEMORY[0x1E0DC3890]), "initWithFrame:", v14, v15, v16, v17);
    ...
    -[SKUIToastViewController setModalPresentationStyle:](v12, "setModalPresentationStyle:", 6);
  }
...
- (SKUIToastViewController)initWithDialogTemplate:(id)a3
{
  ...
  v16 = -[SKUIToastViewController initWithTitle:description:image:](self, "initWithTitle:description:image:", v8, v12, v15);
...
- (void)viewDidLoad
{
  ...
  -[SKUIToastViewController viewDidLoad](&v41, sel_viewDidLoad);
  -[SKUIToastViewController presentationController](self, "presentationController");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "_setContainerIgnoresDirectTouchEvents:", 1);

  -[SKUIToastViewController view](self, "view");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setUserInteractionEnabled:", 1);

  -[SKUIToastViewController imageView](self, "imageView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIToastViewController titleText](self, "titleText");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIToastViewController primaryLabel](self, "primaryLabel");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.0, 0.64);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIToastViewController primaryLabel](self, "primaryLabel");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIToastViewController descriptionText](self, "descriptionText");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v15)
  {
    ...
    objc_msgSend(v18, "addAttribute:value:range:", *MEMORY[0x1E0DC1178], v19, 0, objc_msgSend(v18, "length"));
    -[SKUIToastViewController secondaryLabel](self, "secondaryLabel");
  ...
  -[SKUIToastViewController toastView](self, "toastView");
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[SKUIToastViewController viewWillAppear:](&v6, sel_viewWillAppear_, a3);
  v4[4] = self;
  ...
  v4[3] = &unk_1E73A0108;
  objc_msgSend(MEMORY[0x1E0DC3F10], "animateWithDuration:delay:options:animations:completion:", 2, v5, v4, 0.2, 0.0);
}
...
- (void)viewDidLayoutSubviews
{
  ...
  -[SKUIToastViewController viewDidLayoutSubviews](&v75, sel_viewDidLayoutSubviews);
  -[SKUIToastViewController view](self, "view");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "bounds");

  -[SKUIToastViewController traitCollection](self, "traitCollection");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  *((double *)&v74 + 1) = v12 + -57.0;
  ...
  -[SKUIToastViewController imageView](self, "imageView", v6);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v49 = v48;
  v51 = v50;
  -[SKUIToastViewController toastView](self, "toastView", v6);
...
void __48__SKUIToastViewController_viewDidLayoutSubviews__block_invoke(_QWORD *a1, void *a2, double a3)
{
  uint64_t v5;
  double v6;
  double v7;
...
- (void)present
{
  ...
  -[SKUIToastViewController setPresentationWindow:](self, "setPresentationWindow:", v3);
  -[SKUIToastPresentationWindow setHidden:](v3, "setHidden:", 0);
  -[SKUIToastPresentationWindow setUserInteractionEnabled:](v3, "setUserInteractionEnabled:", 0);
  -[SKUIToastPresentationWindow presentViewController:animated:completion:](v3, "presentViewController:animated:completion:", self, 1, 0);
...
- (void)presentFromViewController:(id)a3 completion:(id)a4
{
  ...
  v6 = a3;
  -[SKUIToastViewController setCompletion:](self, "setCompletion:", a4);
...
+ (id)_primaryLabelFont
{
  ...
  {
    objc_msgSend(a1, "_fontWithSize:textStyleAttribute:", *MEMORY[0x1E0CA82A8], 22.0);
...
+ (id)_secondaryLabelFont
{
  ...
  {
    objc_msgSend(a1, "_fontWithSize:textStyleAttribute:", *MEMORY[0x1E0CA82A0], 16.0);
    v3 = objc_claimAutoreleasedReturnValue();
...
- (void)_dismissWithDelay:(double)a3
{
  ...
  v3[3] = &unk_1E73A0108;
  objc_msgSend(MEMORY[0x1E0DC3F10], "animateWithDuration:delay:options:animations:completion:", 2, v4, v3, 0.2, a3);
}
