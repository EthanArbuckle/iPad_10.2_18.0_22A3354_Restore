...
- (SKUISwooshArtworkLoader)initWithArtworkLoader:(id)a3 swoosh:(id)a4
{
  id v7;
  id v8;
  SKUISwooshArtworkLoader *v9;
  SKUISwooshArtworkLoader *v10;
  uint64_t v11;
  ...
  {
    -[SKUISwooshArtworkLoader initWithArtworkLoader:swoosh:].cold.1();
  }
  v16.receiver = self;
  v16.super_class = (Class)SKUISwooshArtworkLoader;
  v9 = -[SKUISwooshArtworkLoader init](&v16, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)cachedImageForObject:(id)a3
{
  ...
  if (v4)
  {
    -[SKUIResourceLoader cachedResourceForRequestIdentifier:](self->_artworkLoader, "cachedResourceForRequestIdentifier:", objc_msgSend(v4, "unsignedIntegerValue"));
...
- (BOOL)loadImageForObject:(id)a3 URL:(id)a4 reason:(int64_t)a5
{
  ...
  v11 = v10;
  if (v10
    && -[SKUIResourceLoader trySetReason:forRequestWithIdentifier:](self->_artworkLoader, "trySetReason:forRequestWithIdentifier:", a5, objc_msgSend(v10, "unsignedIntegerValue")))
  {
    LOBYTE(v12) = 0;
  }
  else
  {
    ...
    -[SKUIArtworkRequest setDataConsumer:](v13, "setDataConsumer:", self->_imageDataConsumer);
    -[SKUIArtworkRequest setDelegate:](v13, "setDelegate:", self);
    -[SKUIArtworkRequest setURL:](v13, "setURL:", v9);
    v12 = -[SKUIResourceLoader loadResourceWithRequest:reason:](self->_artworkLoader, "loadResourceWithRequest:reason:", v13, 1);
    if (v12)
    {
      v14 = -[SKUIResourceRequest requestIdentifier](v13, "requestIdentifier");
...
- (BOOL)loadImageForObject:(id)a3 artworkRequest:(id)a4 reason:(int64_t)a5
{
  ...
  v11 = v10;
  if (v10
    && -[SKUIResourceLoader trySetReason:forRequestWithIdentifier:](self->_artworkLoader, "trySetReason:forRequestWithIdentifier:", a5, objc_msgSend(v10, "unsignedIntegerValue"))|| (objc_msgSend(v9, "setDelegate:", self), !-[SKUIResourceLoader loadResourceWithRequest:reason:](self->_artworkLoader, "loadResourceWithRequest:reason:", v9, 1)))
  {
    v15 = 0;
  }
  else
...
- (UIImage)placeholderImage
{
  ...
  if (!placeholderImage)
  {
    -[SKUISwooshArtworkLoader imageDataConsumer](self, "imageDataConsumer");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  SKUIImageDataConsumer *v5;
  UIImage *placeholderImage;
  SKUIImageDataConsumer *v7;

  v5 = (SKUIImageDataConsumer *)a3;
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  -[SKUISwooshArtworkLoader setImage:forRequest:](self, "setImage:forRequest:", v7, v8);
