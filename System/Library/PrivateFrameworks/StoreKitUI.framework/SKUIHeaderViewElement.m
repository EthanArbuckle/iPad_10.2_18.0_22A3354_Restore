...
- (SKUIHeaderViewElement)initWithDOMElement:(id)a3 parent:(id)a4 elementFactory:(id)a5
{
  ...
  void *v16;
  uint64_t v17;
  SKUIBrowseHeaderViewElement *v18;
  SKUIHeaderViewElement *p_super;
  objc_super v21;
  ...
  {
    -[SKUIHeaderViewElement initWithDOMElement:parent:elementFactory:].cold.1();
  }
  v11 = objc_opt_class();
        ...
        v13))
  {
    ...
    v18 = -[SKUIHeaderViewElement initWithDOMElement:parent:elementFactory:]([SKUIBrowseHeaderViewElement alloc], "initWithDOMElement:parent:elementFactory:", v8, v15, v10);
  }
  else
  {
    v21.receiver = self;
    v21.super_class = (Class)SKUIHeaderViewElement;
    v18 = -[SKUIViewElement initWithDOMElement:parent:elementFactory:](&v21, sel_initWithDOMElement_parent_elementFactory_, v8, v9, v10);
    self = &v18->super;
  }
  p_super = &v18->super;
