...
{
  id v7;
  SKUIStackDocumentViewController *v8;
  SKUIStackDocumentViewController *v9;
  void *v10;
  objc_super v12;
  ...
  {
    -[SKUIStackDocumentViewController initWithTemplateElement:layoutStyle:].cold.1();
  }
  v12.receiver = self;
  v12.super_class = (Class)SKUIStackDocumentViewController;
  v8 = -[SKUIStackDocumentViewController init](&v12, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_layoutStyle = a4;
    objc_storeStrong((id *)&v8->_templateElement, a3);
    -[SKUIStackDocumentViewController _updateEntryListControllersWithReload:](v9, "_updateEntryListControllersWithReload:", 0);
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "addObserver:selector:name:object:", v9, sel__resetStateForDocumentNotification_, CFSTR("SKUIStoreDialogControllerPurchaseRequestDidSucceedNotification"), 0);
...
- (void)dealloc
{
  ...
  -[SKUIIndexBarControlController setDataSource:](self->_indexBarControlController, "setDataSource:", 0);
  -[SKUIIndexBarControlController setDelegate:](self->_indexBarControlController, "setDelegate:", 0);
  v12 = 0u;
  v13 = 0u;
  v10 = 0u;
  v11 = 0u;
  ...
  objc_msgSend(v8, "removeObserver:name:object:", self, CFSTR("SKUIStoreDialogControllerPurchaseRequestDidSucceedNotification"), 0);

  v9.receiver = self;
  v9.super_class = (Class)SKUIStackDocumentViewController;
  -[SKUIViewController dealloc](&v9, sel_dealloc);
}
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  -[SKUIStackDocumentViewController viewDidAppear:](&v4, sel_viewDidAppear_, a3);
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SKUIStackDocumentViewController;
  -[SKUIStackDocumentViewController viewDidDisappear:](&v4, sel_viewDidDisappear_, a3);
  -[SKUIResourceLoader enterBackground](self->_resourceLoader, "enterBackground");
}

- (void)documentDidUpdate:(id)a3 withTemplate:(id)a4
{
  SKUIStackTemplateElement *v7;
  SKUIStackTemplateElement **p_templateElement;
  SKUIStackTemplateElement *templateElement;
  _BOOL4 v10;
  void *v11;
  void *v12;
  void *v13;
  ...
  v50 = a3;
  v7 = (SKUIStackTemplateElement *)a4;
  objc_storeStrong((id *)&self->_document, a3);
  p_templateElement = &self->_templateElement;
  templateElement = self->_templateElement;
  v10 = -[SKUIStackTemplateElement needsStateReset](v7, "needsStateReset");
  ...
  else
  {
    ...
    {
LABEL_3:
      -[SKUIStackDocumentViewController _resetState](self, "_resetState");
...
LABEL_9:
  ...
  -[SKUIStackDocumentViewController view](self, "view");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStackDocumentViewController _colorScheme](self, "_colorScheme");
  ...
  -[SKUIStackDocumentViewController _indexBarViewElement](self, "_indexBarViewElement");
  ...
  if (v15)
  {
    ...
    -[SKUIIndexBarControlController indexBarControl](self->_indexBarControlController, "indexBarControl");
    ...
    -[SKUIStackDocumentViewController _configureIndexBarControl:](self, "_configureIndexBarControl:", v36);
  ...
  -[SKUIStackDocumentViewController _updateEntryListControllersWithReload:](self, "_updateEntryListControllersWithReload:", 1);
  -[SKUIStackDocumentViewController _updateIndexBarVisibility](self, "_updateIndexBarVisibility");
  -[SKUIStorePageSectionsViewController setColorScheme:](self->_sectionsViewController, "setColorScheme:", v12);
  -[SKUIStorePageSectionsViewController setPinningTransitionStyle:](self->_sectionsViewController, "setPinningTransitionStyle:", -[SKUIStackDocumentViewController _pinningTransitionStyle](self, "_pinningTransitionStyle"));
  -[SKUIStorePageSectionsViewController _setRendersWithPerspective:](self->_sectionsViewController, "_setRendersWithPerspective:", -[SKUIViewElement rendersWithPerspective](*p_templateElement, "rendersWithPerspective"));
  -[SKUIStorePageSectionsViewController _setRendersWithParallax:](self->_sectionsViewController, "_setRendersWithParallax:", -[SKUIViewElement rendersWithParallax](*p_templateElement, "rendersWithParallax"));
  sectionsViewController = self->_sectionsViewController;
  -[SKUIStackDocumentViewController _pageSplitsDescription](self, "_pageSplitsDescription");
  v43 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionsViewController setSectionsWithSplitsDescription:](sectionsViewController, "setSectionsWithSplitsDescription:", v43);
  ...
  -[SKUIStorePageSectionsViewController sections](self->_sectionsViewController, "sections");
...
- (void)loadView
{
  ...
  void *v13;
  SKUIStorePageSectionsViewController *v14;
  SKUIStorePageSectionsViewController *v15;
  void *v16;
  SKUIStorePageSectionsViewController *v17;
  SKUIMetricsImpressionSession *v18;
  void *v19;
  void *v20;
  void *v21;
  void *v22;
  ...
  {
    v6 = -[SKUIStorePageSectionsViewController initWithLayoutStyle:]([SKUIStorePageSectionsViewController alloc], "initWithLayoutStyle:", self->_layoutStyle);
    sectionsViewController = self->_sectionsViewController;
    ...
    -[SKUIStackDocumentViewController _resourceLoader](self, "_resourceLoader");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageSectionsViewController setResourceLoader:](v10, "setResourceLoader:", v11);

    -[SKUIStorePageSectionsViewController setColorScheme:](self->_sectionsViewController, "setColorScheme:", v3);
    v12 = self->_sectionsViewController;
    -[SKUIViewController operationQueue](self, "operationQueue");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIViewController setOperationQueue:](v12, "setOperationQueue:", v13);

    -[SKUIStorePageSectionsViewController setPinningTransitionStyle:](self->_sectionsViewController, "setPinningTransitionStyle:", -[SKUIStackDocumentViewController _pinningTransitionStyle](self, "_pinningTransitionStyle"));
    v14 = self->_sectionsViewController;
    -[SKUIStackDocumentViewController preferredContentSize](self, "preferredContentSize");
    -[SKUIStorePageSectionsViewController setPreferredContentSize:](v14, "setPreferredContentSize:");
    -[SKUIStorePageSectionsViewController _setRendersWithPerspective:](self->_sectionsViewController, "_setRendersWithPerspective:", -[SKUIViewElement rendersWithPerspective](self->_templateElement, "rendersWithPerspective"));
    -[SKUIStorePageSectionsViewController _setRendersWithParallax:](self->_sectionsViewController, "_setRendersWithParallax:", -[SKUIViewElement rendersWithParallax](self->_templateElement, "rendersWithParallax"));
    v15 = self->_sectionsViewController;
    -[SKUIStackDocumentViewController _pageSplitsDescription](self, "_pageSplitsDescription");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageSectionsViewController setSectionsWithSplitsDescription:](v15, "setSectionsWithSplitsDescription:", v16);

    v17 = self->_sectionsViewController;
    v18 = objc_alloc_init(SKUIMetricsImpressionSession);
    -[SKUIStorePageSectionsViewController setActiveMetricsImpressionSession:](v17, "setActiveMetricsImpressionSession:", v18);

    -[SKUIStorePageSectionsViewController setDelegate:](self->_sectionsViewController, "setDelegate:", self);
    -[SKUIStackDocumentViewController addChildViewController:](self, "addChildViewController:", self->_sectionsViewController);
  }
  -[SKUIStackDocumentViewController _indexBarViewElement](self, "_indexBarViewElement");
  ...
  if (v19)
  {
    ...
    -[SKUIStackDocumentViewController _configureIndexBarControl:](self, "_configureIndexBarControl:", v20);

  }
  -[SKUIStackDocumentViewController _pullToRefreshElement](self, "_pullToRefreshElement");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  if (v21)
  {
    -[SKUIStorePageSectionsViewController setUsePullToRefresh:](self->_sectionsViewController, "setUsePullToRefresh:", 1);
    -[SKUIStorePageSectionsViewController setPullToRefreshDelegate:](self->_sectionsViewController, "setPullToRefreshDelegate:", self);
  }
  -[SKUIStorePageSectionsViewController view](self->_sectionsViewController, "view");
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v22, "setAutoresizingMask:", 18);
  objc_msgSend(v23, "bounds");
  objc_msgSend(v22, "setFrame:");
  objc_msgSend(v23, "addSubview:", v22);
  -[SKUIStackDocumentViewController setView:](self, "setView:", v23);
...
- (void)documentDidUpdate:(id)a3
{
  ...
  if (-[SKUIResourceLoader isIdleForReason:](self->_resourceLoader, "isIdleForReason:", 1))
    -[SKUIStackDocumentViewController resourceLoader:didLoadAllForReason:](self, "resourceLoader:didLoadAllForReason:", self->_resourceLoader, 1);

}

- (void)documentMediaQueriesDidUpdate:(id)a3
{
  -[SKUIStorePageSectionsViewController invalidateAndReload](self->_sectionsViewController, "invalidateAndReload", a3);
}

- (id)impressionableViewElements
{
  return -[SKUIStorePageSectionsViewController _impressionableViewElements](self->_sectionsViewController, "_impressionableViewElements");
}
...
- (void)indexBarControlController:(id)a3 didSelectEntryDescriptorAtIndexPath:(id)a4
{
  ...
  v16 = a3;
  v6 = a4;
  if (!-[SKUIStackDocumentViewController _tryToScrollToSectionAtIndexPath:](self, "_tryToScrollToSectionAtIndexPath:", v6))
  {
    v7 = -[SKUIStackDocumentViewController _globalIndexFromIndexPath:](self, "_globalIndexFromIndexPath:", v6);
    v8 = -[SKUIStackDocumentViewController _maxGlobalIndex](self, "_maxGlobalIndex");
    if ((v8 & 0x8000000000000000) == 0)
    {
      ...
      for (i = -1; ; --i)
      {
        if (v7 + i >= 0)
        {
          -[SKUIStackDocumentViewController _indexPathFromGlobalIndex:](self, "_indexPathFromGlobalIndex:", v7 + i);
          v12 = (void *)objc_claimAutoreleasedReturnValue();
          v13 = -[SKUIStackDocumentViewController _tryToScrollToSectionAtIndexPath:](self, "_tryToScrollToSectionAtIndexPath:", v12);
        ...
        if (v7 + v10 + 1 <= v9)
        {
          -[SKUIStackDocumentViewController _indexPathFromGlobalIndex:](self, "_indexPathFromGlobalIndex:");
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          v15 = -[SKUIStackDocumentViewController _tryToScrollToSectionAtIndexPath:](self, "_tryToScrollToSectionAtIndexPath:", v14);
...
- (void)indexBarControlControllerDidSelectBeyondBottom:(id)a3
{
  ...
  -[SKUIStorePageSectionsViewController sections](self->_sectionsViewController, "sections", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)indexBarControlControllerDidSelectBeyondTop:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v6, "scrollRectToVisible:animated:", 0, *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
...
- (void)indexBarEntryListControllerDidInvalidate:(id)a3
{
  NSArray *entryListControllers;
  uint64_t v5;
  SKUIIndexBarControlController *indexBarControlController;
  id v7;
  ...
  if (a3)
  {
    ...
    if (entryListControllers)
    {
      ...
      if (v5 != 0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        v7 = (id)objc_claimAutoreleasedReturnValue();
        -[SKUIIndexBarControlController reloadSections:](indexBarControlController, "reloadSections:", v7);
...
- (BOOL)performTestWithName:(id)a3 options:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  if (-[SKUIStorePageSectionsViewController conformsToProtocol:](self->_sectionsViewController, "conformsToProtocol:", &unk_1EF433FF8))v8 = -[SKUIStorePageSectionsViewController performTestWithName:options:](self->_sectionsViewController, "performTestWithName:options:", v6, v7);
  else
    v8 = 0;
...
- (void)sectionsViewController:(id)a3 willScrollToOffset:(CGPoint)a4 visibleRange:(SKUIIndexPathRange *)a5
{
  ...
  if (self->_lastNeedsMoreCount < v9 && a5->var2 + 2 >= v9)
  {
    ...
    -[SKUIStackTemplateElement dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:](self->_templateElement, "dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:", 16, 1, 1, 0, 0);
  }
...
- (void)resourceLoaderDidBeginLoading:(id)a3
{
  ...
  v5 = a3;
  -[SKUIStackDocumentViewController parentViewController](self, "parentViewController");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)resourceLoader:(id)a3 didLoadAllForReason:(int64_t)a4
{
  ...
  v7 = a3;
  if (a4 == 1)
    -[SKUIStackTemplateElement dispatchEvent:eventAttribute:canBubble:isCancelable:extraInfo:completionBlock:](self->_templateElement, "dispatchEvent:eventAttribute:canBubble:isCancelable:extraInfo:completionBlock:", CFSTR("visibleimagesloaded"), CFSTR("onvisibleimagesloaded"), 1, 1, 0, 0);
  -[SKUIStackDocumentViewController parentViewController](self, "parentViewController");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_colorScheme
{
  ...
  -[SKUIStackTemplateElement style](self->_templateElement, "style");
...
- (void)_configureIndexBarControl:(id)a3
{
  ...
  if (v6)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    SKUIViewElementPlainColorWithIKColor(v8, 0);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    SKUIViewElementPlainColorWithStyle(v6, 0);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = v11;
    if (v11)
      v13 = v11;
...
- (id)_indexBarControlController
{
  ...
  SKUIIndexBarControlController *v6;
  SKUIIndexBarControlController *v7;
  SKUIIndexBarControlController *v8;
  void *v9;
  ...
  if (!indexBarControlController)
  {
    ...
    v5 = -[SKUIIndexBarControl initWithFrame:](v4, "initWithFrame:", *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
    -[SKUIIndexBarControl contentEdgeInsets](v5, "contentEdgeInsets");
    -[SKUIIndexBarControl setContentEdgeInsets:](v5, "setContentEdgeInsets:", 16.0);
    -[SKUIStackDocumentViewController _configureIndexBarControl:](self, "_configureIndexBarControl:", v5);
    v6 = -[SKUIIndexBarControlController initWithIndexBarControl:]([SKUIIndexBarControlController alloc], "initWithIndexBarControl:", v5);
    v7 = self->_indexBarControlController;
    self->_indexBarControlController = v6;

    -[SKUIIndexBarControlController setDataSource:](self->_indexBarControlController, "setDataSource:", self);
    -[SKUIIndexBarControlController setDelegate:](self->_indexBarControlController, "setDelegate:", self);
    v8 = self->_indexBarControlController;
    -[SKUIStackDocumentViewController _resourceLoader](self, "_resourceLoader");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIIndexBarControlController setResourceLoader:](v8, "setResourceLoader:", v9);
...
{
  return -[SKUIStackTemplateElement indexBarViewElement](self->_templateElement, "indexBarViewElement");
}
...
- (id)_indexPathFromGlobalIndex:(int64_t)a3
{
  ...
  if (-[NSArray count](self->_entryListControllers, "count"))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForItem:inSection:", a3, v5);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v11 = (objc_class *)SKUIPageComponentClassForComponentType(objc_msgSend(v10, "pageComponentType", (_QWORD)v14));
        if (v11)
        {
...
- (id)_pageSplitsDescription
{
  ...
  SKUIStackTemplateElement *templateElement;
  id v7;
  SKUIStorePageSplit *v8;
  void *v9;
  SKUIStorePageSplit *v10;
  void *v11;
  double v12;
  double v13;
  SKUIStorePageSplit *v14;
  void *v15;
  void *v16;
  void *v17;
  void *v18;
  ...
  if (-[SKUIStackTemplateElement numberOfSplits](self->_templateElement, "numberOfSplits") == 2)
  {
    ...
    v7 = v4;
    v21 = v7;
    -[SKUIViewElement enumerateChildrenUsingBlock:](templateElement, "enumerateChildrenUsingBlock:", v20);
    if (objc_msgSend(v5, "count"))
    {
      v8 = objc_alloc_init(SKUIStorePageSplit);
      -[SKUIStackDocumentViewController _pageComponentsWithViewElements:](self, "_pageComponentsWithViewElements:", v5);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIStorePageSplit setPageComponents:](v8, "setPageComponents:", v9);

      -[SKUIStorePageSplitsDescription setTopSplit:](v3, "setTopSplit:", v8);
    }
    if (objc_msgSend(v7, "count"))
    {
      v10 = objc_alloc_init(SKUIStorePageSplit);
      -[SKUIStackDocumentViewController _pageComponentsWithViewElements:](self, "_pageComponentsWithViewElements:", v7);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIStorePageSplit setPageComponents:](v10, "setPageComponents:", v11);

      -[SKUIStorePageSplitsDescription setBottomSplit:](v3, "setBottomSplit:", v10);
    }
    ...
    -[SKUIStorePageSplitsDescription setLeftSplit:](v3, "setLeftSplit:", v32[5]);
    -[SKUIStorePageSplitsDescription setRightSplit:](v3, "setRightSplit:", v26[5]);
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStackTemplateElement collectionHeaderViewElement](self->_templateElement, "collectionHeaderViewElement");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    if (v16)
      objc_msgSend(v15, "addObject:", v16);
    -[SKUIStackTemplateElement collectionElements](self->_templateElement, "collectionElements");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "addObjectsFromArray:", v17);

    -[SKUIStackDocumentViewController _pageComponentsWithViewElements:](self, "_pageComponentsWithViewElements:", v15);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageSplit setPageComponents:](v14, "setPageComponents:", v18);

    -[SKUIStorePageSplitsDescription setTopSplit:](v3, "setTopSplit:", v14);
  }
  return v3;
}
...
LABEL_14:
      ...
      v11 = objc_alloc_init(SKUIStorePageSplit);
    ...
    {
      v19 = objc_alloc_init(SKUIStorePageSplit);
    ...
    && !*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40))
  {
    ...
    SKUIViewElementPlainColorWithStyle(v26, 0);
...
- (int64_t)_pinningTransitionStyle
{
  ...
  -[SKUIStackTemplateElement navigationBarElement](self->_templateElement, "navigationBarElement");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return -[SKUIViewElement firstChildForElementType:](self->_templateElement, "firstChildForElementType:", 99);
}
      ...
      while (2)
      {
        for (i = 0; i != v7; i = (char *)i + 1)
        {
          ...
          if (objc_msgSend(v11, "containsElementWithIndexBarEntryID:", v6))
          {
            ...
            objc_msgSend(v37, "sortedArrayUsingComparator:", &__block_literal_global_9);
            v38 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_updateEntryListControllersWithReload:(BOOL)a3
{
  ...
  _QWORD v28[4];
  id v29;
  SKUIStackDocumentViewController *v30;
  id v31;
  NSArray *v32;
  _BYTE v33[128];
  uint64_t v34;
  ...
  if (entryListControllers == v12 || -[NSArray isEqualToArray:](entryListControllers, "isEqualToArray:", v12))
  {
    if (objc_msgSend(v11, "count") && v22)
      -[SKUIIndexBarControlController reloadSections:](self->_indexBarControlController, "reloadSections:", v11);
  }
  else
  {
    objc_storeStrong((id *)&self->_entryListControllers, v12);
    if (v22)
      -[SKUIIndexBarControlController reloadData](self->_indexBarControlController, "reloadData");
  }
...
void __73__SKUIStackDocumentViewController__updateEntryListControllersWithReload___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (v11 == 54)
    {
      +[SKUIIndexBarEntryListController entryListControllerForEntryViewElement:](SKUIIndexBarEntryListController, "entryListControllerForEntryViewElement:", v13);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      ...
      +[SKUIIndexBarEntryListController entryListControllerForEntryListViewElement:](SKUIIndexBarEntryListController, "entryListControllerForEntryListViewElement:", v13);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
    }
    v4 = v12;
  ...
  if (!v7)
  {
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 1);
    v9 = *(_QWORD *)(a1 + 40);
    v10 = *(void **)(v9 + 1104);
    *(_QWORD *)(v9 + 1104) = v8;
...
- (void)_updateIndexBarVisibility
{
  ...
  v3 = -[SKUIStackDocumentViewController _shouldShowIndexBar](self, "_shouldShowIndexBar");
  -[SKUIStorePageSectionsViewController indexBarControl](self->_sectionsViewController, "indexBarControl");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v3)
  {
    ...
    {
      sectionsViewController = self->_sectionsViewController;
      -[SKUIStackDocumentViewController _indexBarControlController](self, "_indexBarControlController");
      v7 = (id)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v7, "indexBarControl");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIStorePageSectionsViewController setIndexBarControl:](sectionsViewController, "setIndexBarControl:", v6);

    }
  }
  else if (v4)
  {
    -[SKUIStorePageSectionsViewController setIndexBarControl:](self->_sectionsViewController, "setIndexBarControl:", 0);
  }
}
