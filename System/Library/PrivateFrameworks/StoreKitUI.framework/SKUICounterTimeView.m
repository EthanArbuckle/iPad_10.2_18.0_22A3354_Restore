...
{
  id v5;
  SKUICounterTimeView *v6;
  SKUICounterTimeView *v7;
  _SKUICounterTimeFieldView *v8;
  _SKUICounterTimeFieldView *daysFieldView;
  void *v10;
  void *v11;
  _SKUICounterTimeFieldView *v12;
  _SKUICounterTimeFieldView *hoursFieldView;
  void *v14;
  void *v15;
  _SKUICounterTimeFieldView *v16;
  _SKUICounterTimeFieldView *minutesFieldView;
  void *v18;
  void *v19;
  _SKUICounterTimeFieldView *v20;
  _SKUICounterTimeFieldView *secondsFieldView;
  void *v22;
  void *v23;
  objc_super v25;
  ...
  {
    -[SKUICounterTimeView initWithClientContext:].cold.1();
  }
  v25.receiver = self;
  v25.super_class = (Class)SKUICounterTimeView;
  v6 = -[SKUICounterTimeView init](&v25, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    -[_SKUICounterTimeFieldView labelLabel](v7->_daysFieldView, "labelLabel");
    ...
    -[_SKUICounterTimeFieldView setVisibilityField:](v7->_daysFieldView, "setVisibilityField:", 1);
    -[SKUICounterTimeView addSubview:](v7, "addSubview:", v7->_daysFieldView);
    v12 = objc_alloc_init(_SKUICounterTimeFieldView);
    hoursFieldView = v7->_hoursFieldView;
    v7->_hoursFieldView = v12;

    -[_SKUICounterTimeFieldView labelLabel](v7->_hoursFieldView, "labelLabel");
    ...
    -[_SKUICounterTimeFieldView setVisibilityField:](v7->_hoursFieldView, "setVisibilityField:", 2);
    -[SKUICounterTimeView addSubview:](v7, "addSubview:", v7->_hoursFieldView);
    v16 = objc_alloc_init(_SKUICounterTimeFieldView);
    minutesFieldView = v7->_minutesFieldView;
    v7->_minutesFieldView = v16;

    -[_SKUICounterTimeFieldView labelLabel](v7->_minutesFieldView, "labelLabel");
    ...
    -[_SKUICounterTimeFieldView setVisibilityField:](v7->_minutesFieldView, "setVisibilityField:", 4);
    -[SKUICounterTimeView addSubview:](v7, "addSubview:", v7->_minutesFieldView);
    v20 = objc_alloc_init(_SKUICounterTimeFieldView);
    secondsFieldView = v7->_secondsFieldView;
    v7->_secondsFieldView = v20;

    -[_SKUICounterTimeFieldView labelLabel](v7->_secondsFieldView, "labelLabel");
    ...
    -[_SKUICounterTimeFieldView setVisibilityField:](v7->_secondsFieldView, "setVisibilityField:", 8);
    -[SKUICounterTimeView addSubview:](v7, "addSubview:", v7->_secondsFieldView);
  }
...
- (void)setTextColor:(id)a3
{
  ...
  if (self->_textColor != a3)
  {
    ...
    -[SKUICounterTimeView _allFieldViews](self, "_allFieldViews");
...
- (void)setValueFont:(id)a3
{
  ...
  if (self->_valueFont != a3)
  {
    ...
    -[SKUICounterTimeView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SKUICounterTimeView _visibleFieldViews](self, "_visibleFieldViews");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUICounterTimeView bounds](self, "bounds");
  v6 = v5;
  v8 = v7;
  ...
  -[SKUICounterTimeView _fieldSpacingForFieldCount:fieldWidth:totalWidth:](self, "_fieldSpacingForFieldCount:fieldWidth:totalWidth:", v24, v9, v6);
  v26 = v25;
  v42 = 0u;
  v43 = 0u;
  v44 = 0u;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUICounterTimeView setBackgroundColor:](&v10, sel_setBackgroundColor_, v4);
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v16 = (double)(v15 + 1);
  -[SKUICounterTimeView _fieldSpacingForFieldCount:fieldWidth:totalWidth:](self, "_fieldSpacingForFieldCount:fieldWidth:totalWidth:", v15, v7, width);
  v18 = v7 + v16 * v17;
  if (v18 < width)
    width = v18;
...
- (void)_setValuesUsingTimestamp:(int64_t)a3
{
  ...
  -[_SKUICounterTimeFieldView valueLabel](self->_daysFieldView, "valueLabel");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", a3 / 86400);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[_SKUICounterTimeFieldView valueLabel](self->_hoursFieldView, "valueLabel");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", a3 / 3600 % 24);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[_SKUICounterTimeFieldView valueLabel](self->_minutesFieldView, "valueLabel");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", a3 / 60 % 60);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v24, "stringFromNumber:", v18);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "setText:", v19);

  -[_SKUICounterTimeFieldView valueLabel](self->_secondsFieldView, "valueLabel");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v21 = (void *)_setValuesUsingTimestamp__sPaddedValueFormatter;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", a3 % 60);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
