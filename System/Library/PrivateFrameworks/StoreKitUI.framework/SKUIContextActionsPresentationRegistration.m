...
- (SKUIContextActionsPresentationRegistration)initWithViewController:(id)a3 handler:(id)a4
{
  id v7;
  id v8;
  SKUIContextActionsPresentationRegistration *v9;
  SKUIContextActionsPresentationRegistration *v10;
  void *v11;
  id handler;
  objc_super v14;
  ...
  {
    -[SKUIContextActionsPresentationRegistration initWithViewController:handler:].cold.1();
  }
  v14.receiver = self;
  v14.super_class = (Class)SKUIContextActionsPresentationRegistration;
  v9 = -[SKUIContextActionsPresentationRegistration init](&v14, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (void)dealloc
{
  ...
  -[SKUIContextActionsPresentationRegistration dealloc](&v5, sel_dealloc);
}
...
- (BOOL)previewInteractionShouldBegin:(id)a3
{
  ...
  double v25;
  double v26;
  SKUIContextActionsPresentationSource *v27;
  void *v28;
  double v29;
  double v30;
  void *v31;
  SKUIContextActionsViewController *v32;
  void *v33;
  void *v34;
  void *v35;
  void *v36;
  SKUIContextActionsViewController *v37;
  void *v38;
  void *v39;
  void *v40;
  void *v41;
  ...
  void *v70;
  void *v71;
  SKUIContextActionsViewController *v72;
  void *v73;
  id v74;
  id v75;
  _QWORD v76[5];
  ...
  _QWORD v95[4];
  id v96;
  SKUIContextActionsViewController *v97;
  __int128 v98;
  __int128 v99;
  __int128 v100;
  __int128 v101;
  ...
  {
    -[SKUIContextActionsPresentationRegistration viewController](self, "viewController");
    ...
    if (v9)
    {
      ...
      -[SKUIContextActionsPresentationRegistration handler](self, "handler");
      v22 = (void (**)(_QWORD, _QWORD))objc_claimAutoreleasedReturnValue();
      ((void (**)(_QWORD, SKUIContextActionsPresentationRegistration *))v22)[2](v22, self);
      ...
      if (v12)
      {
        ...
        v26 = v25;
        v9 = v73;
        v27 = -[SKUIContextActionsPresentationSource initWithViewController:]([SKUIContextActionsPresentationSource alloc], "initWithViewController:", v73);
        ...
        v32 = -[SKUIContextActionsViewController initWithConfiguration:]([SKUIContextActionsViewController alloc], "initWithConfiguration:", v12);
        -[SKUIContextActionsViewController setOrbPresentation:](v32, "setOrbPresentation:", 1);
        -[SKUIContextActionsPresentationRegistration longPressGestureRecognizer](self, "longPressGestureRecognizer");
        v33 = (void *)objc_claimAutoreleasedReturnValue();
        -[SKUIContextActionsViewController setSystemProvidedGestureRecognzier:](v32, "setSystemProvidedGestureRecognzier:", v33);
        ...
        v36 = (void *)MEMORY[0x1E0DC3F20];
        v95[0] = MEMORY[0x1E0C809B0];
        v95[1] = 3221225472;
        v95[2] = __76__SKUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke;
        v95[3] = &unk_1E739FD10;
        v12 = v12;
        v96 = v12;
        v37 = v32;
        ...
        -[SKUIContextActionsPresentationRegistration setOrbContextActionsViewController:](self, "setOrbContextActionsViewController:", v37);
        -[SKUIContextActionsViewController transitionPresentationController](v37, "transitionPresentationController");
        ...
        if (v38)
        {
          ...
          +[SKUIContextActionsBlurEffect effectWithStyle:](SKUIContextActionsBlurEffect, "effectWithStyle:", 1);
          v45 = (void *)objc_claimAutoreleasedReturnValue();
          v69 = v43;
          v46 = objc_alloc(MEMORY[0x1E0DC3F38]);
          v91[0] = MEMORY[0x1E0C809B0];
          v91[1] = 3221225472;
          v91[2] = __76__SKUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_2;
          v91[3] = &unk_1E73A02E8;
          v66 = v40;
          v92 = v66;
          v93 = v45;
          ...
          -[SKUIContextActionsPresentationRegistration setPreviewPhasePropertyAnimator:](self, "setPreviewPhasePropertyAnimator:", v48);

          -[SKUIContextActionsViewController view](v72, "view");
          ...
          v58 = objc_alloc(MEMORY[0x1E0DC3F38]);
          v81[0] = MEMORY[0x1E0C809B0];
          v81[1] = 3221225472;
          v81[2] = __76__SKUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_3;
          v81[3] = &unk_1E73A02E8;
          v82 = v47;
          v83 = v66;
          v59 = v49;
          ...
          -[SKUIContextActionsPresentationRegistration setCommitPhasePropertyAnimator:](self, "setCommitPhasePropertyAnimator:", v60);

          v61 = MEMORY[0x1E0C809B0];
          v78[0] = MEMORY[0x1E0C809B0];
          v78[1] = 3221225472;
          v78[2] = __76__SKUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_4;
          v78[3] = &unk_1E73A36B0;
          v79 = v59;
          v80 = v90;
          v62 = v59;
          objc_msgSend(v70, "setDismissalAnimations:", v78);
          v63 = (void *)MEMORY[0x1E0C99E88];
          v76[0] = v61;
          v76[1] = 3221225472;
          v76[2] = __76__SKUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_5;
          v76[3] = &unk_1E73A36D8;
          v76[4] = self;
          v77 = v4;
          objc_msgSend(v63, "scheduledTimerWithTimeInterval:repeats:block:", 0, v76, 1.0);
          v64 = (void *)objc_claimAutoreleasedReturnValue();
          -[SKUIContextActionsPresentationRegistration setPreviewInteractionTimeout:](self, "setPreviewInteractionTimeout:", v64);

          -[SKUIContextActionsPresentationRegistration setPreviewInteractionDidEnd:](self, "setPreviewInteractionDidEnd:", 0);
          v37 = v72;
        ...
        else
        {
          ...
          -[SKUIContextActionsPresentationRegistration cleanupPreviewInteraction:](self, "cleanupPreviewInteraction:", v4);
        }
...
- (void)previewInteraction:(id)a3 didUpdatePreviewTransition:(double)a4 ended:(BOOL)a5
{
  ...
  v8 = a4 * a4;
  -[SKUIContextActionsPresentationRegistration previewPhasePropertyAnimator](self, "previewPhasePropertyAnimator");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v5)
  {
    -[SKUIContextActionsPresentationRegistration setPreviewInteractionDidEnd:](self, "setPreviewInteractionDidEnd:", 1);
    -[SKUIContextActionsPresentationRegistration orbContextActionsViewController](self, "orbContextActionsViewController");
    ...
    -[SKUIContextActionsPresentationRegistration commitPhasePropertyAnimator](self, "commitPhasePropertyAnimator");
    ...
    v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3CA0]), "initWithDampingRatio:", 1.0);
    -[SKUIContextActionsPresentationRegistration previewPhasePropertyAnimator](self, "previewPhasePropertyAnimator");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "continueAnimationWithTimingParameters:durationFactor:", v19, 0.400000006);

    -[SKUIContextActionsPresentationRegistration setOrbContextActionsViewController:](self, "setOrbContextActionsViewController:", 0);
    -[SKUIContextActionsPresentationRegistration cleanupPreviewInteraction:](self, "cleanupPreviewInteraction:", v21);
...
- (void)previewInteractionDidCancel:(id)a3
{
  ...
  v4 = a3;
  if (-[SKUIContextActionsPresentationRegistration previewInteractionDidEnd](self, "previewInteractionDidEnd"))
  {
  ...
  else
  {
    ...
    -[SKUIContextActionsPresentationRegistration cleanupPreviewInteraction:](self, "cleanupPreviewInteraction:", v4);
    -[SKUIContextActionsPresentationRegistration setOrbContextActionsViewController:](self, "setOrbContextActionsViewController:", 0);
    -[SKUIContextActionsPresentationRegistration setCommitPhasePropertyAnimator:](self, "setCommitPhasePropertyAnimator:", 0);
    -[SKUIContextActionsPresentationRegistration setPreviewPhasePropertyAnimator:](self, "setPreviewPhasePropertyAnimator:", 0);
  }
...
- (void)cleanupPreviewInteraction:(id)a3
{
  ...
  v8 = a3;
  -[SKUIContextActionsPresentationRegistration previewInteractionTimeout](self, "previewInteractionTimeout");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "invalidate");

  -[SKUIContextActionsPresentationRegistration setPreviewInteractionTimeout:](self, "setPreviewInteractionTimeout:", 0);
...
- (void)longPressGestureRecognizerTriggered:(id)a3
{
  ...
  if (objc_msgSend(v7, "state") == 1)
  {
    ...
    if (v6 != 2)
      -[SKUIContextActionsPresentationRegistration _presentFromGestureRecognizer:](self, "_presentFromGestureRecognizer:", v7);
  }
...
- (void)_presentFromGestureRecognizer:(id)a3
{
  ...
  void *v7;
  SKUIContextActionsPresentationSource *v8;
  void *v9;
  void *v10;
  SKUIContextActionsViewController *v11;
  void *v12;
  id v13;
  ...
  ((void (**)(_QWORD, SKUIContextActionsPresentationRegistration *))v4)[2](v4, self);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v5)
  {
    ...
    -[SKUIContextActionsPresentationRegistration viewController](self, "viewController");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = -[SKUIContextActionsPresentationSource initWithViewController:](v6, "initWithViewController:", v7);

    objc_msgSend(v13, "view");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIContextActionsPresentationSource setSourceView:](v8, "setSourceView:", v9);
    ...
    v11 = -[SKUIContextActionsViewController initWithConfiguration:]([SKUIContextActionsViewController alloc], "initWithConfiguration:", v5);
    -[SKUIContextActionsViewController setSystemProvidedGestureRecognzier:](v11, "setSystemProvidedGestureRecognzier:", v13);
