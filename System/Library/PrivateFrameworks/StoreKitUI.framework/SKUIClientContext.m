...
- (SKUIClientContext)initWithConfigurationDictionary:(id)a3
{
  ...
  SKUIClientContextViewControllerFactory *v12;
  NSCache *v13;
  ...
  {
    -[SKUIClientContext initWithConfigurationDictionary:].cold.1();
  }
  v16.receiver = self;
  v16.super_class = (Class)SKUIClientContext;
  v5 = -[SKUIClientContext init](&v16, sel_init);
  if (v5)
  {
    ...
    v8 = (SUClientInterface *)objc_alloc_init(MEMORY[0x1E0DDC1F8]);
    ...
    -[NSCache setName:](v5->_placeholderImageCache, "setName:", CFSTR("com.apple.StoreKitUI.SKUIClientContext.placeholderImageCache"));
  }
...
- (void)dealloc
{
  ...
  -[SKUIClientContext dealloc](&v3, sel_dealloc);
}
...
+ (id)defaultContext
{
  ...
  if (v5)
  {
          ...
          (v7 = (id)objc_claimAutoreleasedReturnValue()) == 0))
    {
      ...
      objc_msgSend(v8, "pathForResource:ofType:", CFSTR("SKUIStoreConfigurations"), CFSTR("plist"));
...
- (void)getDefaultMetricsControllerWithCompletionBlock:(id)a3
{
  ...
  v4 = a3;
  -[SKUIClientContext URLBag](self, "URLBag");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = *MEMORY[0x1E0DAFCB8];
...
void __68__SKUIClientContext_getDefaultMetricsControllerWithCompletionBlock___block_invoke_2(uint64_t a1)
{
  ...
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF568]), "initWithGlobalConfiguration:", v8);
  if (v5)
  {
    v6 = -[SKUIMetricsController initWithGlobalConfiguration:]([SKUIMetricsController alloc], "initWithGlobalConfiguration:", v5);
    -[SKUIMetricsController setTopic:](v6, "setTopic:", CFSTR("xp_its_main"));
    SSVDefaultUserAgent();
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIMetricsController setUserAgent:](v6, "setUserAgent:", v7);
...
{
  return -[SKUIClientContext localizedStringForKey:inTable:](self, "localizedStringForKey:inTable:", a3, 0);
}
...
- (id)localizedStringForKey:(id)a3 inTable:(id)a4
{
  id v6;
  id v7;
  SKUILocalizedStringDictionary *localizedStrings;
  void *v9;
  SKUILocalizedStringDictionary *v10;
  void *v11;
  SKUILocalizedStringDictionary *v12;
  SKUILocalizedStringDictionary *v13;
  void *v14;
  _QWORD v16[2];
  ...
  if (!localizedStrings)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = -[SKUILocalizedStringDictionary initWithLocaleName:bundles:](v10, "initWithLocaleName:bundles:", v9, v11);
  ...
  -[SKUILocalizedStringDictionary localizedStringForKey:inTable:](localizedStrings, "localizedStringForKey:inTable:", v6, v7);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)localizedStringForKey:(id)a3 inBundles:(id)a4 inTable:(id)a5
{
  ...
  v13 = -[SKUILocalizedStringDictionary initWithLocaleName:bundles:]([SKUILocalizedStringDictionary alloc], "initWithLocaleName:bundles:", v12, v8);
  -[SKUILocalizedStringDictionary localizedStringForKey:inTable:](v13, "localizedStringForKey:inTable:", v7, v9);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSArray)navigationHistory
{
  ...
  -[SKUIClientContext _navigationHistory](self, "_navigationHistory");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)newLegacyStorePageViewControllerForURLResponse:(id)a3
{
  ...
  v4 = objc_alloc_init(MEMORY[0x1E0DDC258]);
...
- (id)previewViewControllerForViewElement:(id)a3
{
  ...
  void *v7;
  int v8;
  SKUIPreviewContainerViewController *v9;
  SKUIClientContextPreviewContainer *v10;
  void *v11;
        ...
        v8))
  {
    ...
    v10 = -[SKUIClientContextPreviewContainer initWithAppContext:clientContext:previewContainerViewController:]([SKUIClientContextPreviewContainer alloc], "initWithAppContext:clientContext:previewContainerViewController:", self->_scriptAppContext, self, v9);
...
- (id)tabBarItemsForStyle:(int64_t)a3
{
  ...
  -[SKUIClientContext valueForConfigurationKey:](self, "valueForConfigurationKey:", CFSTR("tabs"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          for (i = 0; i != v9; ++i)
          {
            ...
            if (v13)
            {
              v14 = -[SKUITabBarItem initWithTabIdentifier:]([SKUITabBarItem alloc], "initWithTabIdentifier:", v13);
              objc_msgSend(v12, "objectForKey:", CFSTR("url"));
              v15 = (void *)objc_claimAutoreleasedReturnValue();
              if (v15)
              {
                v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E98]), "initWithString:", v15);
                -[SKUITabBarItem setRootURL:](v14, "setRootURL:", v16);
...
- (SSURLBag)URLBag
{
  ...
  if (!urlBag)
  {
    ...
    v6 = -[SSURLBag initWithURLBagContext:]([SKUIURLBag alloc], "initWithURLBagContext:", v4);
    v7 = self->_urlBag;
    self->_urlBag = v6;
...
- (SKUITrendingSearchProvider)trendingSearchProvider
{
  ...
  {
    v4 = -[SKUITrendingSearchProvider initWithClientContext:]([SKUITrendingSearchProvider alloc], "initWithClientContext:", self);
...
- (NSOperationQueue)resourceLoadQueue
{
  ...
  if (!resourceLoadQueue)
  {
    ...
    -[NSOperationQueue setName:](self->_resourceLoadQueue, "setName:", CFSTR("com.apple.StoreKitUI.SKUIClientContext.resourceLoadQueue"));
...
{
  -[SKUIClientContext sendOnPageResponseWithDocument:data:URLResponse:performanceMetrics:](self, "sendOnPageResponseWithDocument:data:URLResponse:performanceMetrics:", 0, a4, a5, 0);
}

- (void)clientInterface:(id)a3 dispatchXEvent:(id)a4 completionBlock:(id)a5
{
  -[SKUIClientContext sendOnXEventWithDictionary:completionBlock:](self, "sendOnXEventWithDictionary:completionBlock:", a4, a5);
}
...
- (void)clientInterface:(id)a3 presentDialog:(id)a4
{
  ...
  SKUIStoreDialogController *v8;
  SKUIStoreDialogController *v9;
  id v10;
  ...
  if (v6)
  {
    ...
    -[SKUIStoreDialogController presentDialog:](dialogController, "presentDialog:", v6);
  }
...
- (id)scriptInterfaceForClientInterface:(id)a3
{
  ...
  -[SKUIClientContext _applicationController](self, "_applicationController", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)customizePurchase:(id)a3
{
  ...
  if (-[NSString length](self->_additionalPurchaseParameters, "length"))
  {
    ...
    if (v5)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@&%@"), v5, self->_additionalPurchaseParameters);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    -[SKUIURL referrerApplicationName](purchaseReferrerURL, "referrerApplicationName");
    v8 = objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setValue:forDownloadProperty:", v8, *MEMORY[0x1E0DAF9A0]);
    -[SKUIURL referrerURLString](self->_purchaseReferrerURL, "referrerURLString");
    v9 = objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setValue:forDownloadProperty:", v9, *MEMORY[0x1E0DAF9A8]);
    objc_msgSend(v4, "buyParameters");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = v10;
    if (v10 && v8 | v9)
  ...
  if (!v18)
    v18 = objc_alloc_init(MEMORY[0x1E0DAF5C8]);
  if (self->_purchaseURLBagType)
    objc_msgSend(v18, "setURLBagType:");
  objc_msgSend(MEMORY[0x1E0DDC148], "currentClient");
...
- (void)customizeSoftwarePurchase:(id)a3
{
  ...
  if (purchaseReferrerURL)
  {
    -[SKUIURL referrerApplicationName](purchaseReferrerURL, "referrerApplicationName");
    v8 = objc_claimAutoreleasedReturnValue();
    -[SKUIURL referrerApplicationName](self->_purchaseReferrerURL, "referrerApplicationName");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)loadValueForConfigurationKey:(id)a3 completionBlock:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[SKUIClientContext valueForConfigurationKey:](self, "valueForConfigurationKey:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
    if (v7)
...
- (Class)moviePlayerViewControllerClass
{
  ...
  return (Class)SKUIWeakLinkedClassForString(CFSTR("MPMoviePlayerViewController"), v2);
}
...
- (SSVPlatformContext)platformContext
{
  ...
  -[SKUIURLBag existingBagDictionary](self->_urlBag, "existingBagDictionary");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (v3)
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF6A8]), "initWithBagDictionary:", v3);
  }
  else
  {
    -[SKUIClientContext URLBag](self, "URLBag");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "loadWithCompletionBlock:", &__block_literal_global_62);
...
- (BOOL)isBootstrapScriptFallbackDisabled
{
  ...
  -[SKUIClientContext existingBagValueForKey:](self, "existingBagValueForKey:", CFSTR("bootstrap-script-fallback-disabled"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_opt_respondsToSelector() & 1) != 0)
...
- (id)existingBagValueForKey:(id)a3
{
  ...
  urlBag = self->_urlBag;
  v4 = a3;
  -[SKUIURLBag existingBagDictionary](urlBag, "existingBagDictionary");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)newLoadStoreURLOperationWithURL:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0C92C80];
  v5 = a3;
  v6 = (void *)objc_msgSend([v4 alloc], "initWithURL:", v5);

  v7 = -[SKUIClientContext newLoadStoreURLOperationWithURLRequest:](self, "newLoadStoreURLOperationWithURLRequest:", v6);
  return v7;
}
...
- (id)newLoadStoreURLOperationWithURLRequest:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0DAF698];
  v5 = a3;
  ...
  -[SKUIClientContext SAPSessionForVersion:](self, "SAPSessionForVersion:", 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setSAPSession:", v8);

  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF6C0]), "initWithPolicyType:", 1);
...
- (id)SAPSessionForVersion:(int64_t)a3
{
  if (a3 == 1)
    ...
    objc_msgSend(MEMORY[0x1E0DAF688], "sharedDefaultSession");
  return (id)objc_claimAutoreleasedReturnValue();
}

- (void)sendApplicationDidEnterBackground
{
  -[IKAppContext evaluate:completionBlock:](self->_scriptAppContext, "evaluate:completionBlock:", &__block_literal_global_120, 0);
}
...
{
  -[IKAppContext evaluate:completionBlock:](self->_scriptAppContext, "evaluate:completionBlock:", &__block_literal_global_124, 0);
}
...
void __88__SKUIClientContext_sendOnPageResponseWithDocument_data_URLResponse_performanceMetrics___block_invoke(_QWORD *a1, void *a2)
{
  void *v3;
  id v4;
...
- (void)sendOnXEventWithDictionary:(id)a3 completionBlock:(id)a4
{
  ...
  if (v8)
  {
    ...
    v13[0] = MEMORY[0x1E0C809B0];
    v13[1] = 3221225472;
    v13[2] = __64__SKUIClientContext_sendOnXEventWithDictionary_completionBlock___block_invoke;
    v13[3] = &unk_1E73A9448;
    v15 = v16;
    v14 = v6;
    v10[0] = v9;
    v10[1] = 3221225472;
    v10[2] = __64__SKUIClientContext_sendOnXEventWithDictionary_completionBlock___block_invoke_2;
    v10[3] = &unk_1E73A9470;
    v11 = v7;
    v12 = v16;
...
+ (NSString)_cachePath
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(v6, "stringByAppendingPathComponent:", CFSTR("SKUIClientContext"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)_configurationDictionaryWithBagDictionary:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0 && (objc_msgSend(v6, "BOOLValue") & 1) == 0)
      objc_msgSend(v5, "setObject:forKey:", MEMORY[0x1E0C9AAA0], CFSTR("cgift"));
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0 && (objc_msgSend(v7, "BOOLValue") & 1) == 0)
      objc_msgSend(v5, "setObject:forKey:", MEMORY[0x1E0C9AAA0], CFSTR("mgift"));
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    if (v14)
      objc_msgSend(v5, "setObject:forKey:", v14, CFSTR("isSponsoredAdsEnabled"));
...
- (void)_setValue:(id)a3 forConfigurationKey:(id)a4
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "postNotificationName:object:", CFSTR("SKUIClientContextConfigurationDidChangeNotification"), self);
...
- (NSString)description
{
  ...
  -[SKUIClientContext description](&v7, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (SKUIApplicationController *)objc_loadWeakRetained((id *)&self->_applicationController);
}
