...
- (SKUIViewElement)cellTemplateViewElement
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3)
        -[SKUIDynamicShelfMenuBarViewElement cellTemplateViewElement].cold.1(v3, v4, v5, v6, v7, v8, v9, v10);
    }
  }
  ...
  if (!cellTemplateViewElement)
  {
    ...
    v13[3] = &unk_1E73A12A8;
    v13[4] = self;
    -[SKUIShelfMenuBarViewElement enumerateChildrenUsingBlock:](self, "enumerateChildrenUsingBlock:", v13);
    cellTemplateViewElement = self->_cellTemplateViewElement;
  }
  return cellTemplateViewElement;
}

void __61__SKUIDynamicShelfMenuBarViewElement_cellTemplateViewElement__block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
...
{
  SKUIDynamicShelfMenuBarViewElement *v4;
  _BOOL8 v5;
  uint64_t v6;
  uint64_t v7;
  uint64_t v8;
  ...
  v4 = (SKUIDynamicShelfMenuBarViewElement *)a3;
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v5)
        -[SKUIDynamicShelfMenuBarViewElement applyUpdatesWithElement:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  v18.receiver = self;
  v18.super_class = (Class)SKUIDynamicShelfMenuBarViewElement;
  -[SKUIShelfMenuBarViewElement applyUpdatesWithElement:](&v18, sel_applyUpdatesWithElement_, v4);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = v13;
  if (v4 != self || objc_msgSend(v13, "updateType"))
  {
    -[SKUIDynamicShelfMenuBarViewElement cellTemplateViewElement](v4, "cellTemplateViewElement");
...
- (BOOL)isDynamicContainer
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v2)
        -[SKUIDynamicShelfMenuBarViewElement isDynamicContainer].cold.1(v2, v3, v4, v5, v6, v7, v8, v9);
    }
  }
  return 1;
}
...
- (void)setShelfItemViewElementValidator:(id)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v5)
        -[SKUIDynamicShelfMenuBarViewElement setShelfItemViewElementValidator:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  v14.receiver = self;
