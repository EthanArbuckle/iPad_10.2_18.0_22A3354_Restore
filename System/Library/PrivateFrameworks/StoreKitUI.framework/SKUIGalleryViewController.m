...
- (SKUIGalleryViewController)initWithGalleryComponent:(id)a3 artworkLoader:(id)a4
{
  id v7;
  id v8;
  SKUIGalleryViewController *v9;
  SKUIGalleryViewController *v10;
  uint64_t v11;
  ...
  {
    -[SKUIGalleryViewController initWithGalleryComponent:artworkLoader:].cold.1();
  }
  v14.receiver = self;
  v14.super_class = (Class)SKUIGalleryViewController;
  v9 = -[SKUIGalleryViewController init](&v14, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (void)dealloc
{
  ...
  -[SKUIGalleryViewController dealloc](&v4, sel_dealloc);
}
...
- (void)loadArtworkForChildComponent:(id)a3 reason:(int64_t)a4 constraintWidth:(double)a5
{
  ...
  v9 = v8;
  if (!v8
    || !-[SKUIResourceLoader trySetReason:forRequestWithIdentifier:](self->_artworkLoader, "trySetReason:forRequestWithIdentifier:", a4, objc_msgSend(v8, "unsignedIntegerValue")))
  {
    ...
    if (v11)
    {
      ...
      +[SKUISizeToFitImageDataConsumer consumerWithConstraintSize:](SKUISizeToFitImageDataConsumer, "consumerWithConstraintSize:", a5, 0.0);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIArtworkRequest setDataConsumer:](v12, "setDataConsumer:", v13);

      -[SKUIArtworkRequest setDelegate:](v12, "setDelegate:", self);
      -[SKUIArtworkRequest setURL:](v12, "setURL:", v11);
      componentArtworkRequests = self->_componentArtworkRequests;
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[SKUIResourceRequest requestIdentifier](v12, "requestIdentifier"));
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      -[NSMapTable setObject:forKey:](componentArtworkRequests, "setObject:forKey:", v15, v16);

      -[SKUIResourceLoader loadResourceWithRequest:reason:](self->_artworkLoader, "loadResourceWithRequest:reason:", v12, a4);
    }
...
- (void)performActionForSelectedComponentAnimated:(BOOL)a3
{
  ...
  v3 = a3;
  -[SKUIGalleryViewController _selectedViewController](self, "_selectedViewController");
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v4 = a3;
  -[SKUIGalleryViewController view](self, "view");
...
- (void)loadView
{
  ...
  -[SKUIGalleryViewController setView:](self, "setView:", v3);
  -[SKUIGalleryPageComponent childComponents](self->_galleryComponent, "childComponents");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (pageIndicator)
    goto LABEL_6;
  if (!-[SKUIGalleryPageComponent hidesPageIndicator](self->_galleryComponent, "hidesPageIndicator") && v5 >= 2)
  {
    v7 = (UIPageControl *)objc_alloc_init(MEMORY[0x1E0DC3A88]);
...
LABEL_6:
  ...
  {
    v10 = (UIPageViewController *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3A98]), "initWithTransitionStyle:navigationOrientation:options:", 1, 0, 0);
    ...
    if (v5 >= 1)
    {
      v12 = -[SKUIGalleryViewController _newViewControllerWithIndex:](self, "_newViewControllerWithIndex:", 0);
      v40[0] = v12;
    ...
    -[SKUIGalleryViewController addChildViewController:](self, "addChildViewController:", self->_pageViewController);
    pageViewController = self->_pageViewController;
  }
...
LABEL_21:
  ...
  {
    v21 = (UITapGestureRecognizer *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3D80]), "initWithTarget:action:", self, sel__tapAction_);
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SKUIGalleryViewController _startCycleTimer](self, "_startCycleTimer");
  v5.receiver = self;
  v5.super_class = (Class)SKUIGalleryViewController;
  -[SKUIGalleryViewController viewDidAppear:](&v5, sel_viewDidAppear_, v3);
}
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SKUIGalleryViewController _stopCycleTimer](self, "_stopCycleTimer");
  v5.receiver = self;
  v5.super_class = (Class)SKUIGalleryViewController;
  -[SKUIGalleryViewController viewWillDisappear:](&v5, sel_viewWillDisappear_, v3);
}
...
{
  return -[SKUIGalleryViewController _newViewControllerWithIndex:](self, "_newViewControllerWithIndex:", objc_msgSend(a4, "galleryIndex", a3) - 1);
}
...
- (void)pageViewController:(id)a3 didFinishAnimating:(BOOL)a4 previousViewControllers:(id)a5 transitionCompleted:(BOOL)a6
{
  ...
  -[SKUIGalleryViewController _selectedViewController](self, "_selectedViewController", a3, a4, a5, a6);
  v7 = (id)objc_claimAutoreleasedReturnValue();
...
- (void)_tapAction:(id)a3
{
  if (objc_msgSend(a3, "state") == 3)
    -[SKUIGalleryViewController performActionForSelectedComponentAnimated:](self, "performActionForSelectedComponentAnimated:", 1);
}
...
- (id)_newViewControllerWithIndex:(int64_t)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = -[SKUIGalleryPaneViewController initWithMediaComponent:galleryIndex:]([SKUIGalleryPaneViewController alloc], "initWithMediaComponent:galleryIndex:", v7, v6);
  -[NSMapTable objectForKey:](self->_componentArtworkRequests, "objectForKey:", v7);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v9;
  if (v9)
  {
    -[SKUIResourceLoader cachedResourceForRequestIdentifier:](self->_artworkLoader, "cachedResourceForRequestIdentifier:", objc_msgSend(v9, "unsignedIntegerValue"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
  ...
  v12 = -[SKUIGalleryViewController _newViewWithMediaComponent:](self, "_newViewWithMediaComponent:", v7);
  ...
  -[SKUIGalleryPaneViewController setView:](v8, "setView:", v12);
...
- (id)_newViewWithMediaComponent:(id)a3
{
  ...
  -[SKUIEmbeddedMediaView setDelegate:](v5, "setDelegate:", WeakRetained);

  -[SKUIEmbeddedMediaView setMediaType:](v5, "setMediaType:", objc_msgSend(v4, "mediaType"));
  objc_msgSend(v4, "mediaURLString");
  v8 = (void *)objc_claimAutoreleasedReturnValue();

  -[SKUIEmbeddedMediaView setMediaURLString:](v5, "setMediaURLString:", v8);
  return v5;
}
...
- (void)_showNextPaneAnimated:(BOOL)a3
{
  ...
  -[SKUIGalleryViewController view](self, "view", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIGalleryViewController _selectedViewController](self, "_selectedViewController");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[SKUIGalleryViewController _newViewControllerWithIndex:](self, "_newViewControllerWithIndex:", objc_msgSend(v6, "galleryIndex") + 1);
...
- (void)_startCycleTimer
{
  ...
  -[SKUIGalleryPageComponent cycleInterval](self->_galleryComponent, "cycleInterval");
  if (v3 > 0.0)
  {
    v4 = v3;
    cycleTimer = self->_cycleTimer;
...
{
  return (SKUIEmbeddedMediaViewDelegate *)objc_loadWeakRetained((id *)&self->_embeddedMediaDelegate);
}
