...
- (SKUIAttributedStringView)initWithFrame:(CGRect)a3
{
  ...
  {
    -[SKUIAttributedStringView initWithFrame:].cold.1();
  }
  v11.receiver = self;
  ...
  v9 = v8;
  if (v8)
    -[SKUIAttributedStringView setContentMode:](v8, "setContentMode:", 3);
  return v9;
}
...
+ (CGSize)sizeWithLayout:(id)a3 treatment:(int64_t)a4
{
  ...
  {
    +[SKUIAttributedStringView sizeWithLayout:treatment:].cold.1();
  }
  ...
  if (a4 == 1)
  {
    ...
    objc_msgSend(v12, "attribute:atIndex:effectiveRange:", *MEMORY[0x1E0DC1138], 0, 0);
...
- (double)baselineOffset
{
  ...
  -[SKUIAttributedStringLayout baselineOffset](self->_layout, "baselineOffset");
  return result;
}
...
- (double)firstBaselineOffset
{
  ...
  -[SKUIAttributedStringLayout firstBaselineOffset](self->_layout, "firstBaselineOffset");
  return result;
}
...
- (void)setBadgePlacement:(int64_t)a3
{
  if (self->_badgePlacement != a3)
  {
    ...
    -[SKUIAttributedStringView setNeedsDisplay](self, "setNeedsDisplay");
  }
}
...
- (void)setFirstLineTopInset:(int64_t)a3
{
  if (self->_firstLineTopInset != a3)
  {
    ...
    -[SKUIAttributedStringView _reloadTopInset](self, "_reloadTopInset");
    -[SKUIAttributedStringView setNeedsDisplay](self, "setNeedsDisplay");
  }
}
...
- (void)setLayout:(id)a3
{
  ...
  v5 = (SKUIAttributedStringLayout *)a3;
  if (self->_layout != v5)
  {
    v8 = v5;
    ...
    if (textStorage)
    {
      if (v8)
      {
        -[SKUIAttributedStringLayout attributedString](v8, "attributedString");
...
{
  return -[SKUIAttributedStringLayout usesTallCharacterSet](self->_layout, "usesTallCharacterSet");
}
...
- (NSString)description
{
  ...
  -[SKUIAttributedStringLayout attributedString](self->_layout, "attributedString");
  ...
  if (v5 > 0x13)
  {
    v11.receiver = self;
    v11.super_class = (Class)SKUIAttributedStringView;
    -[SKUIAttributedStringView description](&v11, sel_description);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[SKUIAttributedStringView description](&v12, sel_description);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  {
    -[SKUIAttributedStringView _setTrackingTouch:](self, "_setTrackingTouch:", 1);
    -[SKUIAttributedStringView _setTouchInside:](self, "_setTouchInside:", 1);
  }
  else
  {
    v9.receiver = self;
    v9.super_class = (Class)SKUIAttributedStringView;
    -[SKUIAttributedStringView touchesBegan:withEvent:](&v9, sel_touchesBegan_withEvent_, v6, v7);
  }
...
- (void)touchesMoved:(id)a3 withEvent:(id)a4
{
  ...
  else
  {
    ...
    -[SKUIAttributedStringView touchesMoved:withEvent:](&v6, sel_touchesMoved_withEvent_, a3, a4);
  }
}
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  if (self->_trackingTouch)
  {
    ...
    if (-[SKUIAttributedStringView _touchInsideLinkText:linkTextRange:](self, "_touchInsideLinkText:linkTextRange:", &self->_trackingRange))
    {
      ...
      v6 = objc_msgSend(WeakRetained, "conformsToProtocol:", &unk_1EF4B0CC8);
    ...
    -[SKUIAttributedStringView _setTrackingTouch:](self, "_setTrackingTouch:", 0);
    -[SKUIAttributedStringView _setTouchInside:](self, "_setTouchInside:", 0);
  ...
  else
  {
    v9.receiver = self;
    v9.super_class = (Class)SKUIAttributedStringView;
    -[SKUIAttributedStringView touchesEnded:withEvent:](&v9, sel_touchesEnded_withEvent_, a3, a4);
  }
}
...
- (void)touchesCancelled:(id)a3 withEvent:(id)a4
{
  ...
  else
  {
    ...
    -[SKUIAttributedStringView touchesCancelled:withEvent:](&v5, sel_touchesCancelled_withEvent_, a3, a4);
  }
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  UIColor *treatmentColor;
  void *v31;
  SKUIAttributedStringLayout *v32;
  void *v33;
  void *v34;
  double v35;
  double v36;
  ...
  -[SKUIAttributedStringView bounds](self, "bounds", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v11 = v10;
  ...
  -[SKUIAttributedStringLayout topInset](self->_layout, "topInset");
  v176 = v14 + v15;
  -[SKUIAttributedStringLayout edgeInsetsForShadow](self->_layout, "edgeInsetsForShadow");
  if (v19 != *(double *)(MEMORY[0x1E0DC49E8] + 8)
  ...
  -[SKUIAttributedStringLayout boundingSize](self->_layout, "boundingSize");
  ...
  if (self->_stringTreatment == 1)
  {
    ...
    if (treatmentColor)
    {
      ...
      objc_msgSend(MEMORY[0x1E0DC3508], "bezierPathWithRoundedRect:cornerRadius:", v5, v7, v9, v11, 6.0);
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v31, "fill");

      v32 = self->_layout;
      -[SKUIAttributedStringLayout attributedString](v32, "attributedString");
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v33, "attribute:atIndex:effectiveRange:", *MEMORY[0x1E0DC1138], 0, 0);
      v34 = (void *)objc_claimAutoreleasedReturnValue();

      -[SKUIAttributedStringLayout baselineOffset](v32, "baselineOffset");
      v35 = v29;
      v37 = v36;
      objc_msgSend(v34, "capHeight");
      v39 = v37 - v38;
      objc_msgSend(v34, "_bodyLeading");
      v41 = v39 - v40 * (double)(-[SKUIAttributedStringLayout numberOfLines](v32, "numberOfLines") - 1);
      -[SKUIAttributedStringLayout topInset](v32, "topInset");
      v43 = v42;
...
LABEL_49:
    ...
    {
      -[SKUIAttributedStringView tintColor](self, "tintColor");
    ...
    if (v70)
    {
      ...
      objc_msgSend(v72, "addAttribute:value:range:", *MEMORY[0x1E0DC1140], v71, 0, objc_msgSend(v72, "length"));
    ...
    -[SKUIAttributedStringLayout shadow](self->_layout, "shadow");
    v78 = (void *)objc_claimAutoreleasedReturnValue();
    if (v78)
    {
      v79 = (void *)objc_msgSend(v76, "mutableCopy");
      objc_msgSend(v79, "removeAttribute:range:", *MEMORY[0x1E0DC1198], 0, objc_msgSend(v79, "length"));
    ...
    if (self->_badgePlacement == 1)
    {
      ...
      objc_msgSend(v93, "attribute:atIndex:effectiveRange:", *MEMORY[0x1E0DC1138], v94, &v188);
      ...
      if (v95)
        ...
        v96 = 0.0;
      v178 = v96;
      v99 = *MEMORY[0x1E0DC1178];
      objc_msgSend(v93, "attribute:atIndex:effectiveRange:", *MEMORY[0x1E0DC1178], 0, &v188);
      ...
      v105 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC1320]), "initWithAttributedString:", v93);
      v106 = objc_alloc_init(MEMORY[0x1E0DC1280]);
      v166 = v105;
      objc_msgSend(v105, "addLayoutManager:", v106);
      rect = v29;
      v107 = v61;
      v108 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC12C0]), "initWithSize:", v29, v61);
      ...
      if (v52 > CGRectGetMaxX(v205) - v121)
      {
        ...
        objc_msgSend(MEMORY[0x1E0DC3508], "bezierPathWithRect:", v162, v122, CGRectGetMaxX(v208) - v162, v57);
      ...
      v98 = v121;
      objc_msgSend(v106, "drawGlyphsForGlyphRange:atPoint:", v109, v111, *MEMORY[0x1E0C9D538], *(double *)(MEMORY[0x1E0C9D538] + 8));
    ...
    {
      v98 = *MEMORY[0x1E0C9D538];
      MaxY = *(double *)(MEMORY[0x1E0C9D538] + 8);
      -[SKUIAttributedStringLayout stringDrawingContext](self->_layout, "stringDrawingContext");
...
void __37__SKUIAttributedStringView_drawRect___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4)
{
  ...
  v14 = a2;
  objc_msgSend(v14, "objectForKey:", CFSTR("SKUILinkAttributeName"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    ...
    {
      objc_msgSend(v14, "objectForKey:", CFSTR("SKUILinkColorAttributeName"));
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      if (!v13)
      {
      ...
      objc_msgSend(*(id *)(a1 + 40), "addAttribute:value:range:", *MEMORY[0x1E0DC1140], v13, a3, a4);
...
- (void)_setupTapLocatorContainer
{
  ...
  {
    v3 = (NSTextContainer *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC12C0]), "initWithSize:", self->_textBounds.size.width, self->_textBounds.size.height);
    textContainer = self->_textContainer;
    self->_textContainer = v3;

    v5 = (NSLayoutManager *)objc_alloc_init(MEMORY[0x1E0DC1280]);
    layoutManager = self->_layoutManager;
    self->_layoutManager = v5;

    -[NSLayoutManager addTextContainer:](self->_layoutManager, "addTextContainer:", self->_textContainer);
    v7 = (NSTextStorage *)objc_alloc_init(MEMORY[0x1E0DC1320]);
    textStorage = self->_textStorage;
    ...
    objc_msgSend(v13, "addAttribute:value:range:", *MEMORY[0x1E0DC1178], v11, 0, v12);
...
- (BOOL)_touchInsideLinkText:(CGPoint)a3 linkTextRange:(_NSRange *)a4
{
  ...
  y = a3.y;
  x = a3.x;
  -[SKUIAttributedStringView bounds](self, "bounds");
  v15.x = x;
  v15.y = y;
  ...
  {
    v10 = v9;
    -[SKUIAttributedStringView _setupTapLocatorContainer](self, "_setupTapLocatorContainer");
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  if (layout)
  {
    -[SKUIAttributedStringLayout boundingSize](layout, "boundingSize", a3.width, a3.height);
    v7 = v6;
  }
  else
  {
  ...
  if (self->_stringTreatment == 1)
  {
    ...
    v9 = v8 + 6.0;
    v10 = self->_layout;
    -[SKUIAttributedStringLayout attributedString](v10, "attributedString");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "attribute:atIndex:effectiveRange:", *MEMORY[0x1E0DC1138], 0, 0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();

    -[SKUIAttributedStringLayout baselineOffset](v10, "baselineOffset");
    v14 = v13;
    objc_msgSend(v12, "capHeight");
    v16 = v14 - v15;
    objc_msgSend(v12, "_bodyLeading");
    v18 = v16 - v17 * (double)(-[SKUIAttributedStringLayout numberOfLines](v10, "numberOfLines") - 1);
    -[SKUIAttributedStringLayout topInset](v10, "topInset");
    v20 = v19;
...
- (void)tintColorDidChange
{
  ...
  -[SKUIAttributedStringView tintColorDidChange](&v3, sel_tintColorDidChange);
  if (self->_textColorFollowsTintColor)
    -[SKUIAttributedStringView setNeedsDisplay](self, "setNeedsDisplay");
}
...
- (void)_reloadTopInset
{
  ...
  if (layout)
  {
    ...
    {
      v4 = layout;
      -[SKUIAttributedStringLayout attributedString](v4, "attributedString");
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "attribute:atIndex:effectiveRange:", *MEMORY[0x1E0DC1138], 0, 0);
      v6 = (void *)objc_claimAutoreleasedReturnValue();

      -[SKUIAttributedStringLayout baselineOffset](v4, "baselineOffset");
      v8 = v7;
      objc_msgSend(v6, "capHeight");
      v10 = v8 - v9;
      objc_msgSend(v6, "_bodyLeading");
      v12 = v10 - v11 * (double)(-[SKUIAttributedStringLayout numberOfLines](v4, "numberOfLines") - 1);
      -[SKUIAttributedStringLayout topInset](v4, "topInset");
      v14 = v13;
