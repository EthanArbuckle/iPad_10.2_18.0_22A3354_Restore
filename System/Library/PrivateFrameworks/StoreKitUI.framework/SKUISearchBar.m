...
- (SKUISearchBar)init
{
  ...
  v2 = -[SKUISearchBar init](&v8, sel_init);
  if (v2)
  {
    ...
    if (storeShouldReverseLayoutDirection())
      ...
      v4 = 0;
    -[SKUISearchBar setSemanticContentAttribute:](v2, "setSemanticContentAttribute:", v3);
    -[SKUISearchBar searchField](v2, "searchField");
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = v4;
  v7 = v6;
  -[SKUISearchBar intrinsicWidth](self, "intrinsicWidth");
  if (v8 > 0.0)
  {
    -[SKUISearchBar intrinsicWidth](self, "intrinsicWidth");
    if (v9 < v5)
