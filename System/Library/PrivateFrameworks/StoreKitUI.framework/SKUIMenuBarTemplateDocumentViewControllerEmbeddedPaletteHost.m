...
- (void)setTitleView:(id)a3
{
  ...
  if (v5)
  {
    -[SKUIMenuBarTemplateDocumentViewControllerEmbeddedPaletteHost addSubview:](self, "addSubview:", v9);
...
- (void)layoutSubviews
{
  ...
  *(_QWORD *)&rect.size.width = SKUIMenuBarTemplateDocumentViewControllerEmbeddedPaletteHost;
  -[CGFloat layoutSubviews]((objc_super *)&rect.origin.y, sel_layoutSubviews);
  -[SKUIMenuBarTemplateDocumentViewControllerEmbeddedPaletteHost bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  ...
  -[SKUIMenuBarTemplateDocumentViewControllerEmbeddedPaletteHost traitCollection](self, "traitCollection", v16);
