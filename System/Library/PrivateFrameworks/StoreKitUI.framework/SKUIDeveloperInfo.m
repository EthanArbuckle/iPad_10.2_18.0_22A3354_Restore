...
- (SKUIDeveloperInfo)initWithDeveloperDictionary:(id)a3
{
  ...
  {
    -[SKUIDeveloperInfo initWithDeveloperDictionary:].cold.1();
  }
  v49.receiver = self;
  v49.super_class = (Class)SKUIDeveloperInfo;
  v5 = -[SKUIDeveloperInfo init](&v49, sel_init);
  if (v5)
  {
...
- (id)formattedAddressString
{
  ...
  v4 = objc_alloc_init((Class)SKUIWeakLinkedClassForString(CFSTR("CNMutablePostalAddress"), v3));
  v5 = v4;
  ...
  objc_msgSend(SKUIWeakLinkedClassForString(CFSTR("CNPostalAddressFormatter"), v7), "singleLineStringFromPostalAddress:addCountryName:", v5, 1);
