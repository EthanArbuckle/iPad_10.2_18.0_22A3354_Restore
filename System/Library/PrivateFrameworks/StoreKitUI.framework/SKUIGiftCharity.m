...
- (SKUIGiftCharity)initWithCharityDictionary:(id)a3
{
  ...
  {
    -[SKUIGiftCharity initWithCharityDictionary:].cold.1();
  }
  v54.receiver = self;
  v54.super_class = (Class)SKUIGiftCharity;
  v5 = -[SKUIGiftCharity init](&v54, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v36 = -[SKUIArtwork initWithArtworkDictionary:]([SKUIArtwork alloc], "initWithArtworkDictionary:", v35);
      ...
      if (v41)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v46 = -[SKUIGiftAmount initWithAmountDictionary:]([SKUIGiftAmount alloc], "initWithAmountDictionary:", v45);
