...
- (SKUIViewReuseCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  SKUIViewReuseCollectionViewCell *v8;
  SKUIViewReusePool *v9;
  SKUIViewReusePool *viewPool;
  objc_super v12;
  ...
  {
    -[SKUIViewReuseCollectionViewCell initWithFrame:].cold.1();
  }
  v12.receiver = self;
  ...
  if (v8)
  {
    v9 = -[SKUIViewReusePool initWithParentView:]([SKUIViewReusePool alloc], "initWithParentView:", v8);
...
- (void)dealloc
{
  ...
  -[SKUIViewReuseCollectionViewCell dealloc](&v9, sel_dealloc);
}
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        SKUIReuseIdentifierForView(v14);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        SKUIReuseIdentifierForView(v11);
...
{
  void (**v4)(id, SKUIViewModification *);
  ...
  v4 = (void (**)(id, SKUIViewModification *))a3;
  ...
  v6 = -[SKUIViewModification initWithViewReusePool:]([SKUIViewModification alloc], "initWithViewReusePool:", self->_viewPool);
  v4[2](v4, v6);
  -[SKUIViewReuseCollectionViewCell backgroundColor](self, "backgroundColor");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewReuseCollectionViewCell contentView](self, "contentView");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewModification allViewTextProperties](v6, "allViewTextProperties");
  ...
  -[SKUIViewModification views](v6, "views");
  ...
  -[SKUIViewReusePool hideUnusedViews](self->_viewPool, "hideUnusedViews");
  -[SKUIViewReuseCollectionViewCell setNeedsLayout](self, "setNeedsLayout");

}

- (void)registerClass:(Class)a3 forViewWithReuseIdentifier:(id)a4
{
  -[SKUIViewReusePool registerClass:forViewWithReuseIdentifier:](self->_viewPool, "registerClass:forViewWithReuseIdentifier:", a3, a4);
}
...
- (void)applyLayoutAttributes:(id)a3
{
  ...
  -[SKUICollectionViewCell applyLayoutAttributes:](&v11, sel_applyLayoutAttributes_, v4);
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUICollectionViewCell setBackgroundColor:](&v10, sel_setBackgroundColor_, v4);
