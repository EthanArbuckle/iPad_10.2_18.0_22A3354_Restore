...
- (SKUIHorizontalListView)initWithFrame:(CGRect)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        -[SKUIHorizontalListView initWithFrame:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  v18.receiver = self;
  ...
  if (v16)
    -[SKUIViewReuseView registerClass:forViewWithReuseIdentifier:](v16, "registerClass:forViewWithReuseIdentifier:", objc_opt_class(), CFSTR("vlockup"));
  return v16;
}
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9)
        +[SKUIHorizontalListView prefetchResourcesForViewElement:reason:context:].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  }
  v24 = 0;
  v25 = &v24;
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  {
    +[SKUIHorizontalListView preferredSizeForViewElement:context:].cold.1();
  }
  v29 = 0;
  v30 = (double *)&v29;
  v31 = 0x3010000000;
...
void __62__SKUIHorizontalListView_preferredSizeForViewElement_context___block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
  ...
  else
  {
    if (v5 != 49)
    {
      *(_OWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 32) = *MEMORY[0x1E0C9D820];
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v10)
        +[SKUIHorizontalListView requestLayoutForViewElement:width:context:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    }
  }
...
void __68__SKUIHorizontalListView_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  uint64_t v3;
  void *v4;
  double v5;
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  uint64_t v33;
  uint64_t v34;
  void (*v35)(uint64_t, void *, unint64_t);
  void *v36;
  id v37;
  uint64_t *v38;
  uint64_t *v39;
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v10 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_DEBUG);
      if (v10)
        +[SKUIHorizontalListView sizeThatFitsWidth:viewElement:context:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    }
  }
  v57 = 0;
  v58 = (double *)&v57;
  ...
  {
    objc_msgSend(v18, "objectAtIndex:", v33, v34, v35, v36);
  ...
  if (*((_BYTE *)v46 + 24) && v58[4] < a3)
    v58[4] = a3;
  objc_msgSend(v8, "style", v33, v34, v35, v36);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v23, "elementPadding");
  v25 = v24;
  v27 = v26;
...
{
  SKUIListViewElement *v8;
  id v9;
  NSArray *v10;
  NSArray *lines;
  SKUIListViewElement *listElement;
  id v13;
  UIEdgeInsets *p_bigHitInsets;
  __int128 v20;
  SKUIListViewElement *v21;
  _QWORD v22[5];
  id v23;
  double v24;

  v8 = (SKUIListViewElement *)a3;
  v9 = a5;
  ...
  v23 = v9;
  v13 = v9;
  -[SKUIViewReuseView modifyUsingBlock:](self, "modifyUsingBlock:", v22);
  ...
  {
    v20 = *(_OWORD *)(MEMORY[0x1E0DC49E8] + 16);
    *(_OWORD *)&p_bigHitInsets->top = *MEMORY[0x1E0DC49E8];
...
LABEL_37:
                ...
                if (v29)
                {
                  ...
                  if (!v30)
                  {
                    v31 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 1);
                    v32 = *(_QWORD *)(a1 + 32);
                    v33 = *(void **)(v32 + 520);
                    *(_QWORD *)(v32 + 520) = v31;
...
LABEL_51:
              ...
              *(double *)(*(_QWORD *)(a1 + 32) + 504) = v36;
              if (v18)
              {
                ...
                if (!v37)
                {
                  v38 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", 1);
                  v39 = *(_QWORD *)(a1 + 32);
                  v40 = *(void **)(v39 + 432);
                  *(_QWORD *)(v39 + 432) = v38;
...
- (void)setContentInset:(UIEdgeInsets)a3
{
    ...
    || self->_contentInset.bottom != a3.bottom)
  {
    ...
    -[SKUIHorizontalListView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (id)viewForElementIdentifier:(id)a3
{
  ...
  v4 = a3;
  -[SKUIViewElement flattenedChildren](self->_listElement, "flattenedChildren");
...
- (CGRect)hitRect
{
  ...
  if (self->_useBigHitTarget)
  {
    ...
    -[SKUIHorizontalListView hitRect](&v14, sel_hitRect);
  ...
  else
  {
    ...
    -[SKUIHorizontalListView hitRect](&v13, sel_hitRect);
  }
...
- (void)layoutSubviews
{
  ...
  -[SKUIHorizontalListView layoutSubviews](&v84, sel_layoutSubviews);
  -[SKUIViewReuseView allExistingViews](self, "allExistingViews");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIListViewElement style](self->_listElement, "style");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v62 = objc_msgSend(v4, "elementAlignment");

  -[SKUIHorizontalListView bounds](self, "bounds");
  v69 = v6;
  v70 = v5;
  v71 = v7;
  v68 = v8;
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  if (self->_useBigHitTarget)
  {
    -[SKUIHorizontalListView hitRect](self, "hitRect", a4);
    v8.x = x;
    v8.y = y;
  ...
  {
    v7.receiver = self;
    v7.super_class = (Class)SKUIHorizontalListView;
    return -[SKUIHorizontalListView pointInside:withEvent:](&v7, sel_pointInside_withEvent_, a4, a3.x, a3.y);
  }
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  if (width >= v32)
    width = v32;
  -[SKUIListViewElement style](v40->_listElement, "style", v40);
...
- (void)menuPopover:(id)a3 didSelectMenuItemAtIndex:(int64_t)a4
{
  ...
  if (self->_focusedMenuButton)
  {
    ...
    -[SKUIHorizontalListView _destroyMenuPopover](self, "_destroyMenuPopover");
...
- (void)_buttonAction:(id)a3
{
  ...
  if (v7 < objc_msgSend(v5, "count"))
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (SKUIIKViewElementTypeIsButton(objc_msgSend(v8, "elementType")))
    {
      SKUICollectionViewCellForView(self);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      SKUICollectionViewForView(v9);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          ...
          v22[0] = CFSTR("toggled");
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v12, "isToggled"));
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          v23[0] = v14;
          v23[1] = v8;
          v22[1] = CFSTR("target");
...
- (void)_imageTapAction:(id)a3
{
  ...
  listElement = self->_listElement;
  v5 = a3;
  -[SKUIViewElement flattenedChildren](listElement, "flattenedChildren");
...
- (void)_menuButtonAction:(id)a3
{
  ...
  -[SKUIHorizontalListView _viewElementForView:](self, "_viewElementForView:", v24);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
...
+ (id)_attributedStringForButtonText:(id)a3 type:(int64_t)a4 style:(id)a5 context:(id)a6
{
  ...
  if (!v12)
  {
    if (a4)
      ...
      v13 = 1;
    SKUIFontPreferredFontForTextStyle(v13);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  }
  objc_msgSend(v11, "tintColor");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  SKUIViewElementPlainColorWithStyle(v10, v14);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)_linesWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v8;
  id v9;
  SKUIViewElementHorizontalLayout *v10;
  void *v11;
  id v12;
  uint64_t v13;
  id v14;
  ...
  -[SKUIViewElementHorizontalLayout setLayoutWidth:](v10, "setLayoutWidth:", a4);
  objc_msgSend(v8, "style");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewElementHorizontalLayout setMaximumElementsPerLine:](v10, "setMaximumElementsPerLine:", objc_msgSend(v11, "columnCount"));
  -[SKUIViewElementHorizontalLayout setMaximumLines:](v10, "setMaximumLines:", objc_msgSend(v11, "maxTextLines"));
  ...
  v22[0] = MEMORY[0x1E0C809B0];
  v22[1] = 3221225472;
  v22[2] = __62__SKUIHorizontalListView__linesWithViewElement_width_context___block_invoke;
  v22[3] = &unk_1E73A40C0;
  v24 = &v26;
  v25 = a1;
  v14 = v12;
  ...
  -[SKUIViewElementHorizontalLayout setElementSpacing:](v10, "setElementSpacing:", v27[3]);
  v18[0] = v13;
  v18[1] = 3221225472;
  v18[2] = __62__SKUIHorizontalListView__linesWithViewElement_width_context___block_invoke_2;
  v18[3] = &unk_1E73A2228;
  v20 = a1;
  v21 = a4;
  v15 = v9;
  v19 = v15;
  -[SKUIViewElementHorizontalLayout layoutViewElements:usingSizingBlock:](v10, "layoutViewElements:usingSizingBlock:", v14, v18);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (CGSize)_sizeForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  {
    +[SKUIVerticalLockupView sizeThatFitsWidth:viewElement:context:](SKUIVerticalLockupView, "sizeThatFitsWidth:viewElement:context:", v7, v8, a4);
    v10 = v9;
    v12 = v11;
