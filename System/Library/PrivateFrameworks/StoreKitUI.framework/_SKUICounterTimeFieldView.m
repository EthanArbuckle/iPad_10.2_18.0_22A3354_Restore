...
- (_SKUICounterTimeFieldView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    v6 = v3->_labelLabel;
    objc_msgSend(MEMORY[0x1E0DC1350], "fontWithName:size:", CFSTR("HelveticaNeue-CondensedBold"), 14.0);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setFont:](v6, "setFont:", v7);

    -[UILabel setTextAlignment:](v3->_labelLabel, "setTextAlignment:", 1);
    -[_SKUICounterTimeFieldView addSubview:](v3, "addSubview:", v3->_labelLabel);
    v8 = (UILabel *)objc_alloc_init(MEMORY[0x1E0DC3990]);
    valueLabel = v3->_valueLabel;
    v3->_valueLabel = v8;

    v10 = v3->_valueLabel;
    objc_msgSend(MEMORY[0x1E0DC1350], "fontWithName:size:", CFSTR("HelveticaNeue-CondensedBold"), 28.0);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setFont:](v10, "setFont:", v11);

    -[UILabel setTextAlignment:](v3->_valueLabel, "setTextAlignment:", 1);
    -[_SKUICounterTimeFieldView addSubview:](v3, "addSubview:", v3->_valueLabel);
  }
  return v3;
}
...
- (void)layoutSubviews
{
  ...
  -[_SKUICounterTimeFieldView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[_SKUICounterTimeFieldView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
