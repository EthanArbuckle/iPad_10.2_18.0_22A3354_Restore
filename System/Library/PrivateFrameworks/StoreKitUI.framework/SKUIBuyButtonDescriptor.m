...
- (void)setStoreIdentifier:(id)a3
{
  ...
  {
    v4 = (SKUIStoreIdentifier *)objc_msgSend(a3, "copy");
...
- (BOOL)canPersonalizeUsingItemState:(id)a3
{
  ...
  if (!storeIdentifier
    || (objc_msgSend(v5, "storeIdentifier"),
        ...
        v11 = -[SKUIStoreIdentifier isEqual:](storeIdentifier, "isEqual:", v10),
        v10,
        v11))
  {
    objc_msgSend(v5, "variantIdentifier");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIBuyButtonDescriptor variantIdentifier](self, "variantIdentifier");
...
- (BOOL)canPerformLocalActionWithItemState:(id)a3
{
  ...
  v4 = a3;
  if (-[SKUIBuyButtonDescriptor canPersonalizeUsingItemState:](self, "canPersonalizeUsingItemState:", v4))
  {
