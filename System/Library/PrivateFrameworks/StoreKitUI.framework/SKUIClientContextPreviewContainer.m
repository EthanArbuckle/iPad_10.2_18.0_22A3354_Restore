...
- (SKUIClientContextPreviewContainer)initWithAppContext:(id)a3 clientContext:(id)a4 previewContainerViewController:(id)a5
{
  ...
  SKUIClientContextPreviewContainer *v11;
  objc_super v13;
...
- (void)previewDocument:(id)a3 :(id)a4
{
  ...
  if (v6 && self->_previewContainerViewController)
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D3A5E8], "instancesRespondToSelector:", sel_initWithAppContext_document_owner_))v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D3A5E8]), "initWithAppContext:document:owner:", v8, v6, self);
    else
      v9 = 0;
    -[IKJSObject appContext](self, "appContext");
...
void __54__SKUIClientContextPreviewContainer_previewDocument::__block_invoke(_QWORD *a1)
{
  SKUIDocumentContainerViewController *v2;
  uint64_t v3;
  uint64_t v4;
  id WeakRetained;
  SKUIDocumentContainerViewController *v6;
  ...
  if (*(_QWORD *)(a1[4] + 32))
  {
    ...
    v6 = -[SKUIDocumentContainerViewController initWithDocument:options:clientContext:](v2, "initWithDocument:options:clientContext:", v4, v3, WeakRetained);
