...
- (SKUIFilledStarsView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[SKUIFilledStarsView _setupStars](v3, "_setupStars");
  }
  return v3;
}
...
- (void)dealloc
{
  ...
  -[SKUIFilledStarsView dealloc](&v2, sel_dealloc);
}
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        -[SKUIFilledStarsView addSubview:](self, "addSubview:", v9, (_QWORD)v24);
        ...
        -[SKUIFilledStarsView bounds](self, "bounds");
        UIRectCenteredYInRect();
        v14 = v13;
        v16 = v15;
        v18 = v17;
        v20 = v19;
        if (-[SKUIFilledStarsView _shouldReverseLayoutDirection](self, "_shouldReverseLayoutDirection"))
        {
          -[SKUIFilledStarsView bounds](self, "bounds");
          v22 = v21 - v18;
          -[SKUIFilledStarsView bounds](self, "bounds");
...
- (void)_setupStars
{
  ...
  objc_msgSend(MEMORY[0x1E0CD8028], "PPMConfirmedValueWithValue:newValue:", 10.0, 14.0);
  ...
  objc_msgSend(v4, "imageWithSymbolConfiguration:", v9);
  ...
  do
  {
    ...
    -[SKUIFilledStarsView _starImageViewWithImage:](self, "_starImageViewWithImage:", v5);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSMutableArray addObject:](starViews, "addObject:", v8);
