...
- (SKUIVerticalInfoListCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  SKUIVerticalInfoListCollectionViewCell *v8;
  uint64_t v9;
  ...
  {
    -[SKUIVerticalInfoListCollectionViewCell initWithFrame:].cold.1();
  }
  v14.receiver = self;
...
- (void)reloadWithViewElements:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  id v13;
  id v14;
  SKUIVerticalInfoListCollectionViewCell *v15;
  double v16;
...
LABEL_43:
              if (v16)
              {
                ...
                if (v23)
                {
                  ...
                  if (!v24)
                  {
                    v25 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 1);
                    v26 = *(_QWORD *)(a1 + 48);
                    v27 = *(void **)(v26 + 824);
                    *(_QWORD *)(v26 + 824) = v25;
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  -[SKUIVerticalInfoListCollectionViewCell reloadWithViewElements:width:context:](self, "reloadWithViewElements:width:context:", v11, v9, a4);
}
...
- (void)layoutSubviews
{
  ...
  -[SKUIVerticalInfoListCollectionViewCell contentView](self, "contentView");
