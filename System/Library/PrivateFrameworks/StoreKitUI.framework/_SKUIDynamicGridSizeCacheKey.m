...
- (unint64_t)hash
{
  ...
  return -[SKUIViewElement elementType](self->_viewElement, "elementType") + 155 * position;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (a3 == self)
    goto LABEL_6;
  v5 = objc_msgSend(a3, "__isSKUIDynamicGridSizeCacheKey");
  if (v5)
  {
    ...
    v6 = (SKUIViewElement *)*((_QWORD *)a3 + 2);
