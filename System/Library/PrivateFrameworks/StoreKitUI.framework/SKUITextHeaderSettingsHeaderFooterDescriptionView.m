...
+ (CGSize)preferredSizeForSettingsHeaderFooterDescription:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4)
        +[SKUITextHeaderSettingsHeaderFooterDescriptionView preferredSizeForSettingsHeaderFooterDescription:context:].cold.1(v4, v5, v6, v7, v8, v9, v10, v11);
    }
  }
...
+ (BOOL)prefetchResourcesForSettingsHeaderFooterDescription:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v5)
        +[SKUITextHeaderSettingsHeaderFooterDescriptionView prefetchResourcesForSettingsHeaderFooterDescription:reason:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  return 0;
}
...
+ (void)requestLayoutForSettingsHeaderFooterDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content() && _os_feature_enabled_impl())
  {
    v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
    if (v5)
      +[SKUITextHeaderSettingsHeaderFooterDescriptionView requestLayoutForSettingsHeaderFooterDescription:width:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
  }
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 settingsHeaderFooterDescription:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        +[SKUITextHeaderSettingsHeaderFooterDescriptionView sizeThatFitsWidth:settingsHeaderFooterDescription:context:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  ...
  v25 = v24;
  objc_msgSend(v18, "_lastLineBaselineFrameOriginY");
  v27 = v23 + v25 - (v23 - v26);
...
- (void)reloadWithSettingsHeaderFooterDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v7)
        -[SKUITextHeaderSettingsHeaderFooterDescriptionView reloadWithSettingsHeaderFooterDescription:width:context:].cold.1(v7, v8, v9, v10, v11, v12, v13, v14);
    }
  }
  ...
  -[SKUITextHeaderSettingsHeaderFooterDescriptionView addSubview:](self, "addSubview:", self->_label);
  -[SKUITextHeaderSettingsHeaderFooterDescriptionView setNeedsLayout](self, "setNeedsLayout");
...
- (BOOL)setImage:(id)a3 forArtworkRequest:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v5)
        -[SKUITextHeaderSettingsHeaderFooterDescriptionView setImage:forArtworkRequest:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  return 0;
}
