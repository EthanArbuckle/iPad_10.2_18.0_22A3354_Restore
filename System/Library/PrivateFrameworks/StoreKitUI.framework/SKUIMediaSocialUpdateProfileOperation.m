...
{
  id v5;
  SKUIMediaSocialUpdateProfileOperation *v6;
  SKUIMediaSocialUpdateProfileOperation *v7;
  NSLock *v8;
  NSLock *lock;
  objc_super v11;
  ...
  {
    -[SKUIMediaSocialUpdateProfileOperation initWithClientContext:].cold.1();
  }
  v11.receiver = self;
...
- (void)setValue:(id)a3 forProfileField:(id)a4
{
  ...
  {
    -[SKUIMediaSocialUpdateProfileOperation _imageDictionaryFromPhotoUpload:](self, "_imageDictionaryFromPhotoUpload:", v12);
...
- (void)main
{
  ...
  v31 = 0;
  obj = 0;
  -[SKUIMediaSocialUpdateProfileOperation _requestWithError:](self, "_requestWithError:", &obj);
  ...
  v4 = -[SKUIClientContext newLoadStoreURLOperationWithURLRequest:](self->_clientContext, "newLoadStoreURLOperationWithURLRequest:", v3);
  ...
  if (v7)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("SKUIErrorDomain"), 5, 0);
...
LABEL_13:
  ...
  v10 = v9 != 0;
LABEL_19:
  -[SKUIMediaSocialUpdateProfileOperation outputBlock](self, "outputBlock");
...
- (id)_requestWithError:(id *)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "valueForKey:error:", *MEMORY[0x1E0DAFDA8], a3);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    -[SKUIMediaSocialUpdateProfileOperation _requestBodyWithError:](self, "_requestBodyWithError:", a3);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (v8)
    {
      v9 = objc_alloc(MEMORY[0x1E0C92C28]);
...
- (id)_requestBodyWithError:(id *)a3
{
  ...
  if (self->_entityType && self->_identifier && (parameters = self->_parameters) != 0)
  {
    ...
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99D80]), "initWithObjectsAndKeys:", self->_entityType, CFSTR("type"), self->_identifier, CFSTR("id"), 0);
    objc_msgSend(v6, "setObject:forKey:", v7, CFSTR("owner"));
    objc_msgSend(MEMORY[0x1E0CB36D8], "dataWithJSONObject:options:error:", v6, 0, a3);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    v8 = 0;
    if (a3)
      *a3 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB35C8]), "initWithDomain:code:userInfo:", CFSTR("SKUIErrorDomain"), 4, 0);
  }
  return v8;
}
