...
- (SKUIInteractiveSegmentedControl)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  SKUIInteractiveSegmentedControl *result;
  objc_super v9;
  ...
  {
    -[SKUIInteractiveSegmentedControl initWithFrame:].cold.1();
  }
  v9.receiver = self;
...
- (void)dealloc
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIInteractiveSegmentedControl _unregisterForObservationOfSegment:](self, "_unregisterForObservationOfSegment:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v7++));
      }
      while (v5 != v7);
  ...
  -[SKUIInteractiveSegmentedControl dealloc](&v8, sel_dealloc);
}
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  double x;
  id v7;
  SKUIInteractiveSegmentedControl *v8;
  int v9;
  NSArray *v11;
  uint64_t v12;
  uint64_t v13;
  SKUIInteractiveSegmentedControl *v14;
  uint64_t v15;
  double v16;
  uint64_t v17;
  void *v18;
  double v19;
  double v20;
  SKUIInteractiveSegmentedControl *v21;
  SKUIInteractiveSegmentedControl *v22;
  SKUIInteractiveSegmentedControl *v23;
  __int128 v25;
  __int128 v26;
  __int128 v27;
  __int128 v28;
  ...
  v8 = (SKUIInteractiveSegmentedControl *)objc_claimAutoreleasedReturnValue();
...
- (void)layoutSubviews
{
  ...
  v60.receiver = self;
  v60.super_class = (Class)SKUIInteractiveSegmentedControl;
  -[SKUIInteractiveSegmentedControl layoutSubviews](&v60, sel_layoutSubviews);
  -[SKUIInteractiveSegmentedControl bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  -[SKUIInteractiveSegmentedControl traitCollection](self, "traitCollection");
  ...
  v48[1] = 3221225472;
  v48[2] = __49__SKUIInteractiveSegmentedControl_layoutSubviews__block_invoke;
  v48[3] = &unk_1E73A4DD8;
  *(double *)&v48[7] = v17;
  *(CGFloat *)&v48[8] = v4;
  *(CGFloat *)&v48[9] = v6;
  ...
  *(double *)&v48[12] = v18;
  ...
  v34[0] = v21;
  v34[1] = 3221225472;
  v34[2] = __49__SKUIInteractiveSegmentedControl_layoutSubviews__block_invoke_2;
  v34[3] = &unk_1E73A4E00;
  v40 = v17;
  v41 = v4;
  v42 = v6;
  ...
  *(CGFloat *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24) = Width
  ...
  if ((unint64_t)(v3 - 1) <= 1)
  {
    ...
    else
    {
      ...
      if (!v25)
      {
        v26 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", 1);
        v27 = *(_QWORD *)(a1 + 32);
        v28 = *(void **)(v27 + 464);
        *(_QWORD *)(v27 + 464) = v26;
...
- (void)setDividerCreationBlock:(id)a3
{
  ...
  if (self->_dividerCreationBlock != a3)
  {
    ...
    -[SKUIInteractiveSegmentedControl setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)setSegments:(id)a3
{
  ...
  {
    v6 = -[SKUIInteractiveSegmentedControl selectedSegmentIndexForSelectionProgress:](self, "selectedSegmentIndexForSelectionProgress:", self->_selectionProgress);
    ...
    else
    {
      ...
      -[SKUIInteractiveSegmentedControl relativeSelectionProgressForSelectionProgress:segmentIndex:](self, "relativeSelectionProgressForSelectionProgress:segmentIndex:", v8, self->_selectionProgress);
      v7 = v9;
    }
    v10 = self->_segments;
    ...
    if (v15)
    {
      ...
      do
      {
        for (i = 0; i != v16; ++i)
        {
          ...
          {
            -[SKUIInteractiveSegmentedControl _registerForObservationOfSegment:](self, "_registerForObservationOfSegment:", v19);
            -[SKUIInteractiveSegmentedControl addSubview:](self, "addSubview:", v19);
          }
        }
    ...
    if (v34)
    {
      ...
      if (v29)
      {
        ...
        {
          -[SKUIInteractiveSegmentedControl selectionProgressForRelativeSectionProgress:segmentIndex:](self, "selectionProgressForRelativeSectionProgress:segmentIndex:", v31, v7);
          v30 = v32;
        }
      }
      v33 = -[SKUIInteractiveSegmentedControl _setSelectionProgress:](self, "_setSelectionProgress:", v30, v34);
      -[SKUIInteractiveSegmentedControl _applySelectionProgressToSegments](self, "_applySelectionProgressToSegments");
      if (v33)
        -[SKUIInteractiveSegmentedControl _notifyClientsOfSelectionProgressChange](self, "_notifyClientsOfSelectionProgressChange");
    }
    -[SKUIInteractiveSegmentedControl setNeedsLayout](self, "setNeedsLayout", v34);
...
- (double)relativeSelectionProgressForSelectionProgress:(double)a3 segmentIndex:(int64_t)a4
{
  ...
  if (!v7)
    return 0.0;
  v8 = v7;
  -[SKUIInteractiveSegmentedControl selectionProgressForSelectedSegmentAtIndex:](self, "selectionProgressForSelectedSegmentAtIndex:", a4);
...
- (void)_segmentControlTouchUpInsideAction:(id)a3
{
  ...
  if (segments)
  {
    ...
    if (v6 != 0x7FFFFFFFFFFFFFFFLL)
    {
      -[SKUIInteractiveSegmentedControl selectionProgressForSelectedSegmentAtIndex:](self, "selectionProgressForSelectedSegmentAtIndex:", v6);
      v7 = -[SKUIInteractiveSegmentedControl _setSelectionProgress:](self, "_setSelectionProgress:");
      v4 = v8;
      if (v7)
      {
        -[SKUIInteractiveSegmentedControl _notifyClientsOfSelectionProgressChange](self, "_notifyClientsOfSelectionProgressChange");
...
- (id)_createDividerViewWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  void (**dividerCreationBlock)(id, SKUIInteractiveSegmentedControl *, __n128, __n128, __n128, __n128);
  void *v9;
  void *v10;
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  dividerCreationBlock = (void (**)(id, SKUIInteractiveSegmentedControl *, __n128, __n128, __n128, __n128))self->_dividerCreationBlock;
  ...
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3F10]), "initWithFrame:", x, y, width, height);
...
{
  -[SKUIInteractiveSegmentedControl sendActionsForControlEvents:](self, "sendActionsForControlEvents:", 4096);
}
