...
- (_Badge)initWithText:(id)a3
{
  ...
  v5 = -[_Badge initWithFrame:](&v9, sel_initWithFrame_, *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
  if (v5)
  {
...
- (void)setText:(id)a3
{
  ...
  v5 = v4;
  v7 = v6;
  -[_Badge sizeThatFits:](self, "sizeThatFits:", *MEMORY[0x1E0C9D820], *(double *)(MEMORY[0x1E0C9D820] + 8));
...
- (void)drawTextInRect:(CGRect)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0DC3658], "colorWithRed:green:blue:alpha:", 1.0, 0.231372549, 0.188235294, 1.0);
  ...
  objc_msgSend(MEMORY[0x1E0DC3508], "bezierPathWithRoundedRect:cornerRadius:", x, y, width, height, CGRectGetHeight(v12) * 0.5);
