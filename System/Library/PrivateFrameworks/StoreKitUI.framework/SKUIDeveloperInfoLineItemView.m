...
- (SKUIDeveloperInfoLineItemView)initWithLabel:(id)a3 value:(id)a4
{
  id v6;
  id v7;
  SKUIDeveloperInfoLineItemView *v8;
  UILabel *v9;
  UILabel *labelLabel;
  UILabel *v11;
  void *v12;
  ...
  {
    -[SKUIDeveloperInfoLineItemView initWithLabel:value:].cold.1();
  }
  v26.receiver = self;
  v26.super_class = (Class)SKUIDeveloperInfoLineItemView;
  v8 = -[SKUIDeveloperInfoLineItemView init](&v26, sel_init);
  if (v8)
  {
    ...
    -[SKUIDeveloperInfoLineItemView addSubview:](v8, "addSubview:", v8->_labelLabel);
    ...
    -[SKUIDeveloperInfoLineItemView addSubview:](v8, "addSubview:", v8->_valueLabel);
    ...
    -[SKUIDeveloperInfoLineItemView addSubview:](v8, "addSubview:", v8->_separatorView);
  }
...
- (void)layoutSubviews
{
  ...
  -[SKUIDeveloperInfoLineItemView bounds](self, "bounds");
  v4 = v3;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUIDeveloperInfoLineItemView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
