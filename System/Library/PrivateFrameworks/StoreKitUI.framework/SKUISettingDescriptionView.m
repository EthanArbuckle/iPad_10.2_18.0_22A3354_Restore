...
+ (BOOL)prefetchResourcesForSettingDescription:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v5)
        +[SKUISettingDescriptionView prefetchResourcesForSettingDescription:reason:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  return 0;
}
...
+ (CGSize)preferredSizeForSettingDescription:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4)
        +[SKUISettingDescriptionView preferredSizeForSettingDescription:context:].cold.1(v4, v5, v6, v7, v8, v9, v10, v11);
    }
  }
...
+ (void)requestLayoutForSettingDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content() && _os_feature_enabled_impl())
  {
    v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
    if (v5)
      +[SKUISettingDescriptionView requestLayoutForSettingDescription:width:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
  }
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 settingDescription:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v5)
        +[SKUISettingDescriptionView sizeThatFitsWidth:settingDescription:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
...
- (BOOL)hasDisclosureChevron
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v2)
        -[SKUISettingDescriptionView hasDisclosureChevron].cold.1(v2, v3, v4, v5, v6, v7, v8, v9);
    }
  }
  return 0;
}
...
- (void)reloadWithSettingDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content() && _os_feature_enabled_impl())
  {
    v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
    if (v5)
      -[SKUISettingDescriptionView reloadWithSettingDescription:width:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
  }
}
...
- (BOOL)setImage:(id)a3 forArtworkRequest:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v5)
        -[SKUISettingDescriptionView setImage:forArtworkRequest:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  return 0;
}
...
- (UIEdgeInsets)layoutMargins
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3)
        -[SKUISettingDescriptionView layoutMargins].cold.1(v3, v4, v5, v6, v7, v8, v9, v10);
    }
  }
  v25.receiver = self;
  v25.super_class = (Class)SKUISettingDescriptionView;
  -[SKUISettingDescriptionView layoutMargins](&v25, sel_layoutMargins);
  v12 = v11;
  v14 = v13;
  v16 = v15;
  v18 = v17;
  v19 = -[SKUISettingDescriptionView hasDisclosureChevron](self, "hasDisclosureChevron");
  v20 = fmax(v18, 36.0);
  if (v19)
    v21 = v20;
  else
