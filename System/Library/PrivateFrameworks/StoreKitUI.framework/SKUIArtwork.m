...
- (SKUIArtwork)initWithArtworkDictionary:(id)a3
{
  ...
  {
    -[SKUIArtwork initWithArtworkDictionary:].cold.1();
  }
  v10.receiver = self;
  v10.super_class = (Class)SKUIArtwork;
  v5 = -[SKUIArtwork init](&v10, sel_init);
  if (v5)
  {
...
- (SKUIArtwork)initWithURL:(id)a3 size:(CGSize)a4
{
  ...
  {
    -[SKUIArtwork initWithURL:size:].cold.1();
  }
  v13.receiver = self;
  v13.super_class = (Class)SKUIArtwork;
  v8 = -[SKUIArtwork init](&v13, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (NSURL)URL
{
  ...
  if (!url)
  {
    if (self->_urlString)
    {
      v4 = (NSURL *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E98]), "initWithString:", self->_urlString);
      v5 = self->_url;
      self->_url = v4;
...
- (id)_lookupDictionary
{
  ...
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithInteger:", self->_height);
  objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("height"));
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithInteger:", self->_width);
...
- (NSString)description
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)SKUIArtwork;
  -[SKUIArtwork description](&v10, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  width = self->_width;
  height = self->_height;
  -[SKUIArtwork URL](self, "URL");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (SKUIArtwork)initWithCacheRepresentation:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v5 = -[SKUIArtwork init](&v12, sel_init);
    if (v5)
    {
      objc_msgSend(v4, "objectForKey:", CFSTR("height"));
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (SKUIArtwork)initWithCoder:(id)a3
{
  ...
  v5 = -[SKUIArtwork init](&v9, sel_init);
  if (v5)
  {
