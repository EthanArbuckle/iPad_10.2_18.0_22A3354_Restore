...
- (BOOL)_performAuthentication
{
  ...
  v3 = objc_alloc_init(MEMORY[0x1E0DDC140]);
  -[SKUIRedeemIdRequiresValidationOperation _authenticationContext](self, "_authenticationContext");
  ...
  if ((objc_msgSend(v3, "canPerformExtendedBiometricActionsForAccountIdentifier:", v5) & 1) == 0)
  {
    ...
    v7 = objc_alloc(MEMORY[0x1E0DAF488]);
    -[SKUIRedeemIdRequiresValidationOperation _authenticationContext](self, "_authenticationContext");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = (void *)objc_msgSend(v7, "initWithAuthenticationContext:", v8);

    -[SKUIRedeemIdRequiresValidationOperation redeemViewController](self, "redeemViewController");
...
- (id)_subOperationWithBagKey:(id)a3
{
  ...
  v3 = (objc_class *)MEMORY[0x1E0DDC1B0];
  v4 = a3;
  v5 = objc_alloc_init(v3);
  v6 = objc_alloc_init(MEMORY[0x1E0DAF5C8]);
