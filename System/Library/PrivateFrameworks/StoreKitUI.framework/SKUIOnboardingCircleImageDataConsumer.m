...
- (id)imageForImage:(id)a3
{
  ...
  {
    -[SKUIOnboardingCircleImageDataConsumer imageForImage:].cold.1();
  }
  if (-[SKUIOnboardingCircleImageDataConsumer usesSaturationFilter](self, "usesSaturationFilter"))
  {
    v5 = (void *)SKUICoreImageFramework();
    v6 = SKUIWeakLinkedClassForString(CFSTR("CIContext"), (uint64_t)v5);
    v7 = SKUIWeakLinkedClassForString(CFSTR("CIImage"), (uint64_t)v5);
    v8 = SKUIWeakLinkedClassForString(CFSTR("CIFilter"), (uint64_t)v5);
    v9 = *(id *)SKUIWeakLinkedSymbolForString("kCIInputBackgroundImageKey", v5);
    v10 = *(id *)SKUIWeakLinkedSymbolForString("kCIInputImageKey", v5);
    v11 = *(id *)SKUIWeakLinkedSymbolForString("kCIOutputImageKey", v5);
    objc_msgSend(v8, "filterWithName:keysAndValues:", CFSTR("CIColorControls"), CFSTR("inputSaturation"), &unk_1E749BB90, 0);
...
- (id)_saturationBackgroundImageWithSize:(CGSize)a3
{
  ...
  -[SKUIOnboardingCircleImageDataConsumer tintColor](self, "tintColor");
