...
- (SKUIMetricsController)initWithGlobalConfiguration:(id)a3
{
  ...
  {
    -[SKUIMetricsController initWithGlobalConfiguration:].cold.1();
  }
  v17.receiver = self;
  v17.super_class = (Class)SKUIMetricsController;
  v6 = -[SKUIMetricsController init](&v17, sel_init);
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_globalConfiguration, a3);
    objc_msgSend(MEMORY[0x1E0DAF590], "databasePath");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    IsLocalWritable = SSFileIsLocalWritable();

    v10 = (Class *)0x1E0DAF580;
    if (!IsLocalWritable)
      v10 = (Class *)0x1E0DAF570;
    ...
    v7->_impressionsEnabled = -[SKUIMetricsController canRecordEventWithType:](v7, "canRecordEventWithType:", *MEMORY[0x1E0DAFC40]);
    objc_msgSend(MEMORY[0x1E0DAF538], "sharedConfig");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v7->_loggingEnabled = objc_msgSend(v14, "shouldLog");

    +[SKUIMetricsFlushTimer sharedTimer](SKUIMetricsFlushTimer, "sharedTimer");
...
- (void)dealloc
{
  ...
  -[SKUIMetricsController dealloc](&v5, sel_dealloc);
}
        ...
        self->_activeImpressionsSession))
  {
    ...
    if (!v4)
    {
      ...
      else
      {
        ...
        v15[1] = 3221225472;
        v15[2] = __49__SKUIMetricsController_activeImpressionsSession__block_invoke;
        v15[3] = &unk_1E739FF68;
...
- (id)clickEventWithItem:(id)a3 locationPosition:(int64_t)a4
{
  ...
  v6 = (objc_class *)MEMORY[0x1E0DAF560];
  v7 = a3;
  v8 = objc_alloc_init(v6);
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), objc_msgSend(v7, "itemIdentifier"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setTargetIdentifier:", v9);

  v10 = *MEMORY[0x1E0DAFCA0];
  objc_msgSend(v8, "setTargetType:", *MEMORY[0x1E0DAFCA0]);
  objc_msgSend(v7, "productPageURLString");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setTargetURL:", v11);

  -[SKUIMetricsController locationWithPosition:type:fieldData:](self, "locationWithPosition:type:fieldData:", a4, v10, v7);
...
{
  -[SKUIMetricsController _recordActiveImpressions](self, "_recordActiveImpressions");
  if (self->_flushesImmediately)
    -[SKUIMetricsController flushImmediately](self, "flushImmediately");
}
...
- (void)flushImmediately
{
  ...
  v13[1] = 3221225472;
  v13[2] = __41__SKUIMetricsController_flushImmediately__block_invoke;
  v13[3] = &unk_1E73A4960;
  v6 = v3;
  v14 = v6;
  v15 = v4;
  v7 = objc_msgSend(v6, "beginBackgroundTaskWithName:expirationHandler:", CFSTR("SKUIMetricsController.flushImmediately"), v13);
  -[SKUIMetricsController _recordActiveImpressions](self, "_recordActiveImpressions");
  controller = self->_controller;
  v10[0] = v5;
  v10[1] = 3221225472;
  v10[2] = __41__SKUIMetricsController_flushImmediately__block_invoke_2;
  v10[3] = &unk_1E73A7020;
  v11 = v6;
  v12 = v7;
  v9 = v6;
...
- (id)itemOfferClickEventWithItem:(id)a3 locationPosition:(int64_t)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), objc_msgSend(v6, "itemIdentifier"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "setTargetIdentifier:", v8);

  v9 = *MEMORY[0x1E0DAFC90];
  ...
  if (objc_msgSend(v11, "isEqualToString:", *MEMORY[0x1E0DAFC20]))
  {
...
LABEL_6:
  ...
  if (objc_msgSend(v11, "isEqualToString:", *MEMORY[0x1E0DAFC08]))
  {
    ...
    if (v12)
    {
      v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99D80]), "initWithObjectsAndKeys:", v12, CFSTR("buyParams"), 0);
...
LABEL_7:
  -[SKUIMetricsController locationWithPosition:type:fieldData:](self, "locationWithPosition:type:fieldData:", 0, v9, 0);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIMetricsController locationWithPosition:type:fieldData:](self, "locationWithPosition:type:fieldData:", a4, *MEMORY[0x1E0DAFCA0], v6);
...
- (id)performActionForItem:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
    -[SKUIMetricsController performActionForSoftwareItem:offer:clientContext:completionBlock:](self, "performActionForSoftwareItem:offer:clientContext:completionBlock:", v4, v6, 0, 0);
  else
    -[SKUIMetricsController performActionForItem:offer:clientContext:completionBlock:](self, "performActionForItem:offer:clientContext:completionBlock:", v4, v6, 0, 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)performActionForItem:(id)a3 clientContext:(id)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
    -[SKUIMetricsController performActionForSoftwareItem:offer:clientContext:completionBlock:](self, "performActionForSoftwareItem:offer:clientContext:completionBlock:", v7, v9, v6, 0);
  else
    -[SKUIMetricsController performActionForItem:offer:clientContext:completionBlock:](self, "performActionForItem:offer:clientContext:completionBlock:", v7, v9, v6, 0);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)performActionForItem:(id)a3 offer:(id)a4 clientContext:(id)a5
{
  ...
  if (SKUIItemStateCenterUseAppstoredPurchases(v10))
    -[SKUIMetricsController performActionForSoftwareItem:offer:clientContext:completionBlock:](self, "performActionForSoftwareItem:offer:clientContext:completionBlock:", v10, v9, v8, 0);
  else
    -[SKUIMetricsController performActionForItem:offer:clientContext:completionBlock:](self, "performActionForItem:offer:clientContext:completionBlock:", v10, v9, v8, 0);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)performActionForItem:(id)a3 offer:(id)a4 clientContext:(id)a5 completionBlock:(id)a6
{
  ...
  v10 = a6;
  v11 = (objc_class *)MEMORY[0x1E0DAF5B0];
  v12 = a5;
  v13 = a4;
  v14 = a3;
...
- (void)pingURLs:(id)a3
{
  -[SKUIMetricsController pingURLs:withClientContext:](self, "pingURLs:withClientContext:", a3, 0);
}
...
- (void)pingURLs:(id)a3 withClientContext:(id)a4
{
  ...
  if (objc_msgSend(v5, "count"))
  {
    if (!pingURLs_withClientContext__sPingQueue)
    {
      ...
      objc_msgSend((id)pingURLs_withClientContext__sPingQueue, "setName:", CFSTR("com.apple.StoreServices.SKUIMetricsController.ping"));
    }
    v19 = 0u;
    v20 = 0u;
    v17 = 0u;
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C92C28]), "initWithURL:cachePolicy:timeoutInterval:", *(_QWORD *)(*((_QWORD *)&v17 + 1) + 8 * i), 1, 20.0);
          v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DAF698]), "initWithURLRequest:", v13);
...
{
  -[SKUIMetricsController _insertEvent:](self, "_insertEvent:", a3);
  if (self->_flushesImmediately)
    -[SKUIMetricsController flushImmediately](self, "flushImmediately");
}
...
- (void)setPageConfiguration:(id)a3
{
  ...
  if (self->_pageConfiguration != v7)
  {
    ...
    self->_impressionsEnabled = -[SKUIMetricsController canRecordEventWithType:](self, "canRecordEventWithType:", *MEMORY[0x1E0DAFC40]);
    +[SKUIMetricsFlushTimer sharedTimer](SKUIMetricsFlushTimer, "sharedTimer");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_13:
  -[SKUIMetricsController accountIdentifier](self, "accountIdentifier", v16);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_recordActiveImpressions
{
  ...
  void *v4;
  id v5;
  SKUIMetricsImpressionSession *v6;
  NSObject *impressionsTimer;
  ...
  {
    -[SKUIMetricsImpressionSession impressionIdentifiers](activeImpressionsSession, "impressionIdentifiers");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v4, "count"))
    {
      v5 = objc_alloc_init(MEMORY[0x1E0DAF598]);
      objc_msgSend(v5, "setImpressionIdentifiers:", v4);
      -[SKUIMetricsController _insertEvent:](self, "_insertEvent:", v5);
