...
- (SKUISignInView)initWithFrame:(CGRect)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        -[SKUISignInView initWithFrame:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  v26.receiver = self;
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v5)
        +[SKUISignInView prefetchResourcesForViewElement:reason:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    }
  }
  return 0;
}
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4)
        +[SKUISignInView preferredSizeForViewElement:context:].cold.1(v4, v5, v6, v7, v8, v9, v10, v11);
    }
  }
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content() && _os_feature_enabled_impl())
  {
    v5 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
    if (v5)
      +[SKUISignInView requestLayoutForViewElement:width:context:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
  }
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v8 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v8)
        +[SKUISignInView sizeThatFitsWidth:viewElement:context:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
  ...
  if (v16)
  {
    objc_msgSend(a1, "_fontDescriptorWithViewElement:defaultTextStyle:bold:", v16, *MEMORY[0x1E0DC4A98], 1);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0DC1350], "fontWithDescriptor:size:", v17, 0.0);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "_scaledValueForValue:", 50.0);
    v20 = v19 + v19;

  }
  else
  {
    a3 = *MEMORY[0x1E0C9D820];
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  -[SKUISignInView _clearFieldsAndLabels](self, "_clearFieldsAndLabels");
  v17[0] = MEMORY[0x1E0C809B0];
  v17[1] = 3221225472;
  v17[2] = __54__SKUISignInView_reloadWithViewElement_width_context___block_invoke;
  v17[3] = &unk_1E73A12A8;
  v17[4] = self;
  -[SKUIViewElement enumerateChildrenUsingBlock:](v6, "enumerateChildrenUsingBlock:", v17);
  ...
  -[SKUISignInView setBackgroundColor:](self, "setBackgroundColor:", v9);
  ...
  -[SKUISignInView setNeedsLayout](self, "setNeedsLayout");
}
...
- (BOOL)becomeFirstResponder
{
  ...
  return -[SKUISignInView becomeFirstResponder](&v3, sel_becomeFirstResponder);
}
...
- (BOOL)resignFirstResponder
{
  ...
  return -[SKUISignInView resignFirstResponder](&v11, sel_resignFirstResponder);
}
...
- (void)layoutSubviews
{
  ...
  -[SKUISignInView layoutSubviews](&v18, sel_layoutSubviews);
  if (!self->_borderView)
  {
    v3 = [SKUIShapeView alloc];
    v4 = -[SKUIShapeView initWithFrame:](v3, "initWithFrame:", *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
    borderView = self->_borderView;
    self->_borderView = v4;

    -[SKUIShapeView setUserInteractionEnabled:](self->_borderView, "setUserInteractionEnabled:", 0);
    -[SKUISignInView addSubview:](self, "addSubview:", self->_borderView);
  }
  -[SKUISignInView _layoutLabels](self, "_layoutLabels");
  -[SKUISignInView _layoutTextFieldsOffsetX:](self, "_layoutTextFieldsOffsetX:");
  ...
  -[SKUISignInView bounds](self, "bounds");
  x = v19.origin.x;
  y = v19.origin.y;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  if (v5)
  {
    ...
    v9 = v8 + v8;
    v19 = 0;
    -[SKUIViewElement style](self->_viewElement, "style");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)textField:(id)a3 shouldChangeCharactersInRange:(_NSRange)a4 replacementString:(id)a5
{
  ...
  if (v6)
  {
    -[SKUISignInView _accountNameText](self, "_accountNameText");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUISignInView _applePasswordText](self, "_applePasswordText");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v7, "length"))
    {
      if (objc_msgSend(v8, "length"))
      {
        -[SKUISignInView delegate](self, "delegate");
        ...
        if (v9)
        {
          ...
          v12 = objc_msgSend(v11, "conformsToProtocol:", &unk_1EF493F20);
    ...
    -[SKUISignInView resignFirstResponder](self, "resignFirstResponder");
...
+ (id)_fontDescriptorWithViewElement:(id)a3 defaultTextStyle:(id)a4 bold:(BOOL)a5
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  SKUIViewElementFontWithStyle(v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
LABEL_3:
    objc_msgSend(MEMORY[0x1E0DC1358], "preferredFontDescriptorWithTextStyle:", v8);
...
{
  id v3;
  SKUISignInTextView *v4;
  SKUISignInTextView *v5;
  uint64_t v6;
  void *v7;
  void *v8;
  void *v9;
  ...
  v5 = -[SKUISignInTextView initWithFrame:](v4, "initWithFrame:", *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
  v6 = objc_msgSend(v3, "keyboardType");
  if (objc_msgSend(v3, "isSecure"))
    -[SKUISignInTextView setSecureTextEntry:](v5, "setSecureTextEntry:", 1);
  -[SKUISignInTextView setKeyboardType:](v5, "setKeyboardType:", v6);
  ...
  -[SKUISignInTextView setTextColor:](v5, "setTextColor:", v9);
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = (void *)objc_msgSend(v12, "initWithObjectsAndKeys:", v13, *MEMORY[0x1E0DC1140], 0);

  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3498]), "initWithString:attributes:", v11, v14);
  -[SKUISignInTextView setAttributedPlaceholder:](v5, "setAttributedPlaceholder:", v15);
...
{
  return (SKUISignInViewDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
