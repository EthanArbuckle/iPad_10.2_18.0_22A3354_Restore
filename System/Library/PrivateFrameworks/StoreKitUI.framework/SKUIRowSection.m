...
- (SKUIRowSection)initWithPageComponent:(id)a3
{
  ...
  {
    -[SKUIRowSection initWithPageComponent:].cold.1();
  }
  v10.receiver = self;
  v10.super_class = (Class)SKUIRowSection;
  v5 = -[SKUIStorePageSection initWithPageComponent:](&v10, sel_initWithPageComponent_, v4);
  if (v5)
  {
    ...
    v5->_isPad = objc_msgSend(v8, "userInterfaceIdiom") == 1;
...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  else
  {
    v10.receiver = self;
    v10.super_class = (Class)SKUIRowSection;
    -[SKUIStorePageSection backgroundColorForIndexPath:](&v10, sel_backgroundColorForIndexPath_, v4);
...
- (id)cellForIndexPath:(id)a3
{
  ...
  if (v11 == 5)
  {
    ...
    -[SKUIRowSection _reloadEditorialCell:forComponent:columnIndex:](self, "_reloadEditorialCell:forComponent:columnIndex:", v13, v10, v7);
  }
  else if (v11 == 9)
  {
    ...
    if (v12)
    {
      objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x1E73BC8D0, v4);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIRowSection _reloadEditorialLockupCell:forComponent:columnIndex:](self, "_reloadEditorialLockupCell:forComponent:columnIndex:", v13, v10, v7);
    }
    else
    {
      objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x1E73B2890, v4);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIRowSection _reloadLockupCell:forComponent:columnIndex:](self, "_reloadLockupCell:forComponent:columnIndex:", v13, v10, v7);
    }
  }
  else
  {
    objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", CFSTR("SKUIRowSectionMiscReuseIdentifer"), v4);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if (v10)
    {
      -[SKUIRowSection _columnViews](self, "_columnViews");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[SKUIRowSection _edgeInsetsForColumnIndex:](self, "_edgeInsetsForColumnIndex:", v7);
    objc_msgSend(v13, "setContentInsets:");
    v16 = objc_msgSend(v10, "componentType");
    if (v16 == 10)
    {
      -[SKUIRowSection _reloadView:forMediaComponent:columnIndex:](self, "_reloadView:forMediaComponent:columnIndex:", v15, v10, v7);
    }
    else if (v16 == 7)
    {
      -[SKUIRowSection _loadImagesForGalleryComponent:columnIndex:](self, "_loadImagesForGalleryComponent:columnIndex:", v10, v7);
    }
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  if (self->_isPad || !objc_msgSend(v11, "shouldAutoFlow"))
  {
    ...
    {
      -[SKUIRowSection _cellContentHeightForRowWidth:](self, "_cellContentHeightForRowWidth:", v8);
      v17 = *(double *)&v19;
  ...
  else
  {
    ...
    -[SKUIRowSection _heightForComponent:columnIndex:rowWidth:](self, "_heightForComponent:columnIndex:rowWidth:", v15, (double)v13, v8);
    v17 = v16;

  }
  v20 = objc_msgSend(v4, "item");
  -[SKUIRowSection _columnWidthForColumnIndex:rowWidth:](self, "_columnWidthForColumnIndex:rowWidth:", v20, v8);
  v22 = v21;
  -[SKUIRowSection _edgeInsetsForColumnIndex:](self, "_edgeInsetsForColumnIndex:", v20);
  v25 = v17 + v24 + v23;
  v28 = v22 + v26 + v27;
...
- (id)clickEventWithItem:(id)a3 elementName:(id)a4 index:(int64_t)a5
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIRowSection _setPositionForClickEvent:elementIndex:](self, "_setPositionForClickEvent:elementIndex:", v7, a5);
  return v7;
}
...
- (void)collectionViewDidConfirmItemOfferAtIndexPath:(id)a3
{
  ...
  if (objc_msgSend(v7, "componentType") == 9)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIRowSection itemOfferClickEventWithItem:elementName:index:](self, "itemOfferClickEventWithItem:elementName:index:", v9, CFSTR("Column"), v4);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if (v10)
    {
    ...
    -[SKUIStorePageSection performItemOfferActionForItem:](self, "performItemOfferActionForItem:", v9);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  {
    case 5:
      -[SKUIRowSection _expandEditorialComponent:columnIndex:](self, "_expandEditorialComponent:columnIndex:", v8, v5);
      break;
    case 7:
      -[SKUIRowSection _selectGalleryComponent:columnIndex:](self, "_selectGalleryComponent:columnIndex:", v8, v5);
      break;
    case 9:
      -[SKUIRowSection _selectLockupComponent:columnIndex:](self, "_selectLockupComponent:columnIndex:", v8, v5);
      break;
    case 10:
      -[SKUIRowSection _selectMediaComponent:columnIndex:](self, "_selectMediaComponent:columnIndex:", v8, v5);
      break;
    default:
      break;
  }
  v9.receiver = self;
  v9.super_class = (Class)SKUIRowSection;
  -[SKUIStorePageSection collectionViewDidSelectItemAtIndexPath:](&v9, sel_collectionViewDidSelectItemAtIndexPath_, v4);
...
- (void)collectionViewWillApplyLayoutAttributes:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIRowSection backgroundColorForIndexPath:](self, "backgroundColorForIndexPath:", v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setBackgroundColor:", v6);

  v7.receiver = self;
  v7.super_class = (Class)SKUIRowSection;
  -[SKUIStorePageSection collectionViewWillApplyLayoutAttributes:](&v7, sel_collectionViewWillApplyLayoutAttributes_, v4);
...
- (void)invalidateCachedLayoutInformation
{
  ...
  -[SKUIStorePageSection invalidateCachedLayoutInformation](&v2, sel_invalidateCachedLayoutInformation);
}
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  {
    -[SKUIRowSection _missingItemLoader](self, "_missingItemLoader");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)willAppearInContext:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), CFSTR("SKUIRowSectionMiscReuseIdentifer"));
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x1E73B32F0);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x1E73B2890);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x1E73BC8D0);
  -[SKUIStorePageSection pageComponent](self, "pageComponent");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "childComponents");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v9 = (SKUIClientContext *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIStorePageSection willAppearInContext:](&v12, sel_willAppearInContext_, v4);
...
LABEL_23:
    ...
    if (objc_msgSend(v13, "canRecordEventWithType:", *MEMORY[0x1E0DAFC48]))
    {
      v21 = objc_alloc_init(MEMORY[0x1E0DAF5A0]);
...
void __52__SKUIRowSection_itemStateCenter_itemStatesChanged___block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (!v8)
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithLongLong:", objc_msgSend(v7, "itemIdentifier"));
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if (objc_msgSend(v14, "count"))
  {
    ...
    if (objc_msgSend(v7, "count"))
    {
      ...
      v11 = -[SKUIStorePageSection sectionIndex](self, "sectionIndex");
      v15[0] = MEMORY[0x1E0C809B0];
      v15[1] = 3221225472;
...
{
  void *v4;
  SKUILockupComponent *overlaySourceComponent;
  void *v6;
  void *v7;
  SKUIProductPageOverlayController *overlayController;
  id v9;

  -[SKUIRowSection _overlaySourceCell](self, "_overlaySourceCell", a3);
  v9 = (id)objc_claimAutoreleasedReturnValue();
...
- (id)_columnViews
{
  ...
  if (!columnViews)
  {
    v4 = (NSMapTable *)objc_alloc_init(MEMORY[0x1E0CB3748]);
...
- (double)_columnWidthForColumnIndex:(int64_t)a3 rowWidth:(double)a4
{
  ...
  if (self->_isPad || !objc_msgSend(v7, "shouldAutoFlow"))
  {
    ...
    -[SKUIRowSection _interColumnSpacing](self, "_interColumnSpacing");
    v13 = v12;
...
- (id)_editorialLayoutForEditorial:(id)a3 columnIndex:(int64_t)a4
{
  ...
  if (!editorialLayouts)
  {
    v8 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
  ...
  v10 = (SKUIEditorialLayout *)objc_claimAutoreleasedReturnValue();
  if (!v10)
  {
    -[SKUIStorePageSection context](self, "context");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = -[SKUIEditorialLayout initWithEditorial:layoutCache:](v12, "initWithEditorial:layoutCache:", v6, v14);
...
- (id)_editorialLayoutForLockup:(id)a3 columnIndex:(int64_t)a4
{
  ...
  if (v7)
  {
    ...
    if (!editorialLayouts)
    {
      v9 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
    ...
    v11 = (SKUIEditorialLayout *)objc_claimAutoreleasedReturnValue();
    if (!v11)
    {
      -[SKUIStorePageSection context](self, "context");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = -[SKUIEditorialLayout initWithEditorial:layoutCache:](v13, "initWithEditorial:layoutCache:", v7, v15);

      v19 = 0uLL;
      v20 = 0;
      -[SKUIRowSection _lockupStyleForComponent:columnIndex:](self, "_lockupStyleForComponent:columnIndex:", v6, a4);
...
- (void)_expandEditorialComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  -[SKUIRowSection _editorialLayoutForEditorial:columnIndex:](self, "_editorialLayoutForEditorial:columnIndex:", v6, a4);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)_heightForArtwork:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  v8 = a3;
  -[SKUIRowSection _columnWidthForColumnIndex:rowWidth:](self, "_columnWidthForColumnIndex:rowWidth:", a4, a5);
  v10 = v9;
...
- (double)_heightForComponent:(id)a3 columnIndex:(double)a4 rowWidth:(double)a5
{
  ...
  {
    case 2:
      -[SKUIRowSection _heightForCountdownComponent:columnIndex:rowWidth:](self, "_heightForCountdownComponent:columnIndex:rowWidth:", v8, (uint64_t)a4, a5);
      goto LABEL_8;
    case 5:
      -[SKUIRowSection _heightForEditorialComponent:columnIndex:rowWidth:](self, "_heightForEditorialComponent:columnIndex:rowWidth:", v8, (uint64_t)a4, a5);
      goto LABEL_8;
    case 7:
      -[SKUIRowSection _heightForGalleryComponent:columnIndex:rowWidth:](self, "_heightForGalleryComponent:columnIndex:rowWidth:", v8, (uint64_t)a4, a5);
      goto LABEL_8;
    case 9:
      -[SKUIRowSection _heightForLockupComponent:columnIndex:rowWidth:](self, "_heightForLockupComponent:columnIndex:rowWidth:", v8, (uint64_t)a4, a5);
      goto LABEL_8;
    case 10:
      -[SKUIRowSection _heightForMediaComponent:columnIndex:rowWidth:](self, "_heightForMediaComponent:columnIndex:rowWidth:", v8, (uint64_t)a4, a5);
      goto LABEL_8;
    case 14:
...
- (double)_heightForCountdownComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  if (v10)
  {
    -[SKUIRowSection _heightForArtwork:columnIndex:rowWidth:](self, "_heightForArtwork:columnIndex:rowWidth:", v10, a4, a5);
    v12 = v11;
  }
  else
  {
...
- (double)_heightForEditorialComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  -[SKUIRowSection _editorialLayoutForEditorial:columnIndex:](self, "_editorialLayoutForEditorial:columnIndex:", a3, a5);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSection context](self, "context");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "collectionView");
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        -[SKUIRowSection _heightForMediaComponent:columnIndex:rowWidth:](self, "_heightForMediaComponent:columnIndex:rowWidth:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * i), a4, a5);
        if (v12 < v14)
          v12 = v14;
      }
...
- (double)_heightForLockupComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  v24 = 0uLL;
  v25 = 0;
  -[SKUIRowSection _lockupStyleForComponent:columnIndex:](self, "_lockupStyleForComponent:columnIndex:", v7, a4);
  objc_msgSend(v7, "item");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v22 = v24;
  v23 = v25;
  +[SKUILockupItemCellLayout heightForLockupStyle:item:editorial:clientContext:](SKUILockupItemCellLayout, "heightForLockupStyle:item:editorial:clientContext:", &v22, v10, v9, v12);
  v14 = v13;

  if (v9)
  {
    -[SKUIRowSection _editorialLayoutForLockup:columnIndex:](self, "_editorialLayoutForLockup:columnIndex:", v7, a4);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "collectionView");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)_heightForMediaComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  if (v8)
  {
    -[SKUIRowSection _heightForArtwork:columnIndex:rowWidth:](self, "_heightForArtwork:columnIndex:rowWidth:", v8, a4, a5);
    v10 = v9;
  }
  else
  {
...
- (id)_imageConsumerWithItem:(id)a3 lockupSize:(int64_t)a4
{
  ...
  {
    +[SKUIStyledImageDataConsumer lockupIconConsumerWithSize:](SKUIStyledImageDataConsumer, "lockupIconConsumerWithSize:", a4, v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    +[SKUIProductImageDataConsumer lockupConsumerWithSize:itemKind:](SKUIProductImageDataConsumer, "lockupConsumerWithSize:itemKind:", a4, v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v6;
}
...
- (void)_loadImagesForGalleryComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  v14 = a3;
  -[SKUIRowSection _viewControllerForGalleryComponent:](self, "_viewControllerForGalleryComponent:");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    -[SKUIStorePageSection context](self, "context");
    ...
    if (v9 >= v10)
      v10 = v9;
    -[SKUIRowSection _columnWidthForColumnIndex:rowWidth:](self, "_columnWidthForColumnIndex:rowWidth:", a4, v10);
    v12 = v11;
    objc_msgSend(v14, "childComponents");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v15[0] = MEMORY[0x1E0C809B0];
...
LABEL_6:
    ...
    {
      -[SKUIRowSection _lockupPlaceholderForComponent:](self, "_lockupPlaceholderForComponent:", v4);
  ...
  v13 = SKUILockupImageSizeForLockupSize(0, objc_msgSend(v10, "itemKind"));
  ...
  if (v17)
  {
    ...
    -[SKUIRowSection _imageConsumerWithItem:lockupSize:](self, "_imageConsumerWithItem:lockupSize:", v10, 0);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIArtworkRequest setDataConsumer:](v18, "setDataConsumer:", v19);

    -[SKUIArtworkRequest setDelegate:](v18, "setDelegate:", self);
    -[SKUIArtworkRequest setURL:](v18, "setURL:", v17);
    componentArtworkRequestIDs = self->_componentArtworkRequestIDs;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[SKUIResourceRequest requestIdentifier](v18, "requestIdentifier"));
...
- (id)_lockupPlaceholderForComponent:(id)a3
{
  ...
  -[SKUIRowSection _imageConsumerWithItem:lockupSize:](self, "_imageConsumerWithItem:lockupSize:", v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_newSizeToFitArtworkRequestWithArtwork:(id)a3 columnIndex:(int64_t)a4
{
  ...
  if (v11 >= v12)
    v12 = v11;
  -[SKUIRowSection _columnWidthForColumnIndex:rowWidth:](self, "_columnWidthForColumnIndex:rowWidth:", a4, v12);
  +[SKUISizeToFitImageDataConsumer consumerWithConstraintSize:](SKUISizeToFitImageDataConsumer, "consumerWithConstraintSize:");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  SKUIEmbeddedMediaView *v4;

  v4 = objc_alloc_init(SKUIEmbeddedMediaView);
  -[SKUIEmbeddedMediaView setDelegate:](v4, "setDelegate:", self);
  return v4;
}
...
- (id)_overlaySourceCell
{
  ...
  if (self->_overlaySourceComponent)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForItem:inSection:", v7, -[SKUIStorePageSection sectionIndex](self, "sectionIndex"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_popSourceViewForOverlayController:(id)a3
{
  ...
  {
    -[SKUIRowSection _overlaySourceCell](self, "_overlaySourceCell");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadEditorialCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  v20 = a3;
  v8 = a4;
  -[SKUIRowSection _editorialLayoutForEditorial:columnIndex:](self, "_editorialLayoutForEditorial:columnIndex:", v8, a5);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSection context](self, "context");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIRowSection _edgeInsetsForColumnIndex:](self, "_edgeInsetsForColumnIndex:", a5);
...
- (void)_reloadEditorialLockupCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  v24 = 0;
  v25 = 0;
  -[SKUIRowSection _lockupStyleForComponent:columnIndex:](self, "_lockupStyleForComponent:columnIndex:", v8, a5);
  objc_msgSend(v11, "setLayoutStyle:", v24);
  objc_msgSend(v11, "setVisibleFields:", v25);
  -[SKUILockupComponent item](v8, "item");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "configureForItem:clientContext:", v12, self->_clientContext);
  objc_msgSend(v9, "setSeparatorStyle:", 0);

  -[SKUIRowSection _lockupImageForComponent:](self, "_lockupImageForComponent:", v8);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIRowSection _editorialLayoutForLockup:columnIndex:](self, "_editorialLayoutForLockup:columnIndex:", v8, a5);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadView:(id)a3 forMediaComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  if (v11)
  {
      ...
      && (objc_msgSend(v10, "trySetReason:forRequestWithIdentifier:", 1, objc_msgSend(v12, "unsignedIntegerValue")) & 1) == 0)
    {
      ...
      if (v14)
      {
        v15 = -[SKUIRowSection _newSizeToFitArtworkRequestWithArtwork:columnIndex:](self, "_newSizeToFitArtworkRequestWithArtwork:columnIndex:", v14, a5);
        componentArtworkRequestIDs = self->_componentArtworkRequestIDs;
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v15, "requestIdentifier"));
        v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (v13)
    {
      v14 = -[SKUIRowSection _newSizeToFitArtworkRequestWithArtwork:columnIndex:](self, "_newSizeToFitArtworkRequestWithArtwork:columnIndex:", v13, a5);
      v18 = self->_componentArtworkRequestIDs;
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v14, "requestIdentifier"));
      v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_selectGalleryComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSection clickEventWithMedia:elementName:index:](self, "clickEventWithMedia:elementName:index:", v6, CFSTR("Column"), a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    -[SKUIStorePageSection context](self, "context");
...
- (void)_selectLockupComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  objc_msgSend(v6, "item");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIRowSection clickEventWithItem:elementName:index:](self, "clickEventWithItem:elementName:index:", v7, CFSTR("Column"), a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
    -[SKUIStorePageSection context](self, "context");
  ...
  {
    if (SKUIItemKindIsSoftwareKind(objc_msgSend(v7, "itemKind"))
      && (objc_msgSend(MEMORY[0x1E0DC3708], "currentDevice"),
          v14 = (void *)objc_claimAutoreleasedReturnValue(),
          ...
          v15))
    {
      ...
      v18 = v6;
      v19 = v7;
      -[SKUIStorePageSection sendXEventWithItem:completionBlock:](self, "sendXEventWithItem:completionBlock:", v19, v16);

    }
    else
    {
      -[SKUIStorePageSection showProductViewControllerWithItem:](self, "showProductViewControllerWithItem:", v7);
    }
  }
...
uint64_t __53__SKUIRowSection__selectLockupComponent_columnIndex___block_invoke(uint64_t result, char a2)
{
  uint64_t v2;
  uint64_t v3;
  SKUIProductPageOverlayController *v4;
  uint64_t v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  if ((a2 & 1) == 0)
  {
    ...
    if (!*(_QWORD *)(v3 + 168))
    {
      v4 = -[SKUIProductPageOverlayController initWithParentViewController:]([SKUIProductPageOverlayController alloc], "initWithParentViewController:", *(_QWORD *)(result + 40));
      v5 = *(_QWORD *)(v2 + 32);
      v6 = *(void **)(v5 + 168);
      *(_QWORD *)(v5 + 168) = v4;
...
{
  id v4;
  SKUICountdownViewController *v5;
  void *v6;
  SKUICountdownViewController *v7;
  void *v8;
  void *v9;
  void *v10;
  uint64_t v11;
  ...
  v5 = (SKUICountdownViewController *)objc_claimAutoreleasedReturnValue();
  if (!v5)
  {
    -[SKUIStorePageSection context](self, "context");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = -[SKUICountdownViewController initWithCountdownComponent:artworkLoader:](v7, "initWithCountdownComponent:artworkLoader:", v4, v8);

    -[SKUICountdownViewController setClientContext:](v5, "setClientContext:", self->_clientContext);
    -[SKUIStorePageSection pageComponent](self, "pageComponent");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "childComponents");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForItem:inSection:", v11, -[SKUIStorePageSection sectionIndex](self, "sectionIndex"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICountdownViewController view](v5, "view");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIRowSection backgroundColorForIndexPath:](self, "backgroundColorForIndexPath:", v12);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      v16 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
...
{
  id v4;
  SKUIGalleryViewController *v5;
  void *v6;
  SKUIGalleryViewController *v7;
  void *v8;
  void *v9;
  void *v10;
  uint64_t v11;
  ...
  v5 = (SKUIGalleryViewController *)objc_claimAutoreleasedReturnValue();
  if (!v5)
  {
    -[SKUIStorePageSection context](self, "context");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v6, "resourceLoader");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = -[SKUIGalleryViewController initWithGalleryComponent:artworkLoader:](v7, "initWithGalleryComponent:artworkLoader:", v4, v8);

    -[SKUIGalleryViewController setEmbeddedMediaDelegate:](v5, "setEmbeddedMediaDelegate:", self);
    -[SKUIStorePageSection pageComponent](self, "pageComponent");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "childComponents");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[SKUIRowSection backgroundColorForIndexPath:](self, "backgroundColorForIndexPath:", v12);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIGalleryViewController setBackgroundColor:](v5, "setBackgroundColor:", v13);

    galleryViewControllers = self->_galleryViewControllers;
    if (!galleryViewControllers)
    {
      v15 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
