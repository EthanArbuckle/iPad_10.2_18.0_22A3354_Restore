...
- (SKUIFocusedTouchGestureRecognizer)initWithFocusedView:(id)a3 touchAllowance:(UIEdgeInsets)a4
{
  ...
  CGFloat top;
  id v10;
  SKUIFocusedTouchGestureRecognizer *v11;
  SKUIFocusedTouchGestureRecognizer *v12;
  SKUIFocusedTouchGestureRecognizer *v13;
  objc_super v15;
  ...
  {
    -[SKUIFocusedTouchGestureRecognizer initWithFocusedView:touchAllowance:].cold.1();
    if (v10)
      goto LABEL_5;
LABEL_9:
    v13 = 0;
...
LABEL_5:
  ...
  v11 = -[SKUIFocusedTouchGestureRecognizer initWithTarget:action:](&v15, sel_initWithTarget_action_, 0, 0);
  v12 = v11;
  if (v11)
  {
...
- (void)reset
{
  ...
  -[SKUIFocusedTouchGestureRecognizer reset](&v4, sel_reset);
}
...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  if (self->_didTouchOutside)
  {
    -[SKUIFocusedTouchGestureRecognizer setState:](self, "setState:", 1);
    v8 = v32;
  }
  else
  {
    ...
    if (v25)
    {
      ...
      do
      {
        for (j = 0; j != v26; ++j)
        {
          ...
          -[SKUIFocusedTouchGestureRecognizer ignoreTouch:forEvent:](self, "ignoreTouch:forEvent:", *(_QWORD *)(*((_QWORD *)&v34 + 1) + 8 * j), v32);
        }
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  if (!-[NSMutableSet count](self->_activeTouches, "count"))
  {
    if (self->_didTouchOutside)
      ...
      v5 = 5;
    -[SKUIFocusedTouchGestureRecognizer setState:](self, "setState:", v5);
    activeTouches = self->_activeTouches;
    self->_activeTouches = 0;
