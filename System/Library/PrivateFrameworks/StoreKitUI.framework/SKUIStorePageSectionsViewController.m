...
- (SKUIStorePageSectionsViewController)initWithLayoutStyle:(int64_t)a3
{
  ...
  {
    -[SKUIStorePageSectionsViewController initWithLayoutStyle:].cold.1();
  }
  ...
  v5 = -[SKUIStorePageSectionsViewController initWithNibName:bundle:](&v12, sel_initWithNibName_bundle_, 0, 0);
  v6 = v5;
  if (v5)
  {
    v5->_layoutStyle = a3;
    v5->_itemsChangedStateWhileDisappeared = 0;
    -[SKUIStorePageSectionsViewController setRestorationClass:](v5, "setRestorationClass:", objc_opt_class());
    v7 = (objc_class *)objc_opt_class();
    NSStringFromClass(v7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageSectionsViewController setRestorationIdentifier:](v6, "setRestorationIdentifier:", v8);
    ...
    objc_msgSend(v10, "addObserver:selector:name:object:", v6, sel__contentSizeChangeNotification_, *MEMORY[0x1E0DC48E8], 0);
...
{
  return -[SKUIStorePageSectionsViewController initWithLayoutStyle:](self, "initWithLayoutStyle:", 0);
}
...
- (void)dealloc
{
  ...
  -[SKUIStorePageSplitsDescription enumerateSplitsUsingBlock:](self->_splitsDescription, "enumerateSplitsUsingBlock:", &__block_literal_global_10);
  +[SKUIItemStateCenter defaultCenter](SKUIItemStateCenter, "defaultCenter");
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIStorePageSectionsViewController _unregisterForNotificationsForEntityProvider:](self, "_unregisterForNotificationsForEntityProvider:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * v9++));
      }
      while (v7 != v9);
  ...
  -[SKUICollectionView setDataSource:](self->_collectionView, "setDataSource:", 0);
  -[SKUICollectionView setDelegate:](self->_collectionView, "setDelegate:", 0);
  ...
  -[SKUIViewController dealloc](&v11, sel_dealloc);
}
...
{
  SKUICollectionView *collectionView;
  id v4;
  SKUICollectionView *v5;
  void *v6;
  SKUICollectionView *v7;
  SKUICollectionView *v8;
  void *v9;
  void *v10;
  id v11;
  void *v12;
  ...
  if (!collectionView)
  {
    v4 = -[SKUIStorePageSectionsViewController _newStorePageCollectionViewLayout](self, "_newStorePageCollectionViewLayout");
    v5 = [SKUICollectionView alloc];
    objc_msgSend(MEMORY[0x1E0DC3BF8], "mainScreen");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "bounds");
    v7 = -[SKUICollectionView initWithFrame:collectionViewLayout:](v5, "initWithFrame:collectionViewLayout:", v4);
    v8 = self->_collectionView;
    self->_collectionView = v7;

    -[SKUICollectionView setSemanticContentAttribute:](self->_collectionView, "setSemanticContentAttribute:", storeSemanticContentAttribute());
    -[SKUICollectionView registerClass:forCellWithReuseIdentifier:](self->_collectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), CFSTR("UICollectionViewCell"));
    -[SKUICollectionView setClipsToBounds:](self->_collectionView, "setClipsToBounds:", !self->_rendersWithPerspective);
    -[SKUICollectionView setIndexBarControl:](self->_collectionView, "setIndexBarControl:", self->_indexBarControl);
    ...
    -[SKUICollectionView setBackgroundColor:](self->_collectionView, "setBackgroundColor:", v12);
    -[SKUICollectionView setDataSource:](self->_collectionView, "setDataSource:", self);
    -[SKUICollectionView setDelegate:](self->_collectionView, "setDelegate:", self);
    v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC39C8]), "initWithTarget:action:", self, sel__longPressAction_);
    -[SKUICollectionView addGestureRecognizer:](self->_collectionView, "addGestureRecognizer:", v13);
    objc_msgSend(v13, "setCancelsTouchesInView:", 1);
    objc_msgSend(v13, "setDelaysTouchesBegan:", 0);
    v14 = (UITapGestureRecognizer *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3D80]), "initWithTarget:action:", self, sel__handleTap_);
    collectionViewTapGestureRecognizer = self->_collectionViewTapGestureRecognizer;
    self->_collectionViewTapGestureRecognizer = v14;

    -[SKUICollectionView addGestureRecognizer:](self->_collectionView, "addGestureRecognizer:", self->_collectionViewTapGestureRecognizer);
    ...
    v17[3] = &unk_1E73A2540;
    v17[4] = self;
    -[SKUIStorePageSectionsViewController _enumerateSectionContextsUsingBlock:](self, "_enumerateSectionContextsUsingBlock:", v17);
...
- (id)defaultSectionForComponent:(id)a3
{
  ...
  switch(objc_msgSend(v4, "componentType"))
  {
    ...
    case 18:
      ...
      goto LABEL_27;
    case 8:
      -[SKUIStorePageSectionsViewController _defaultSectionForGridComponent:](self, "_defaultSectionForGridComponent:", v4);
    ...
    case 14:
      ...
      goto LABEL_27;
    case 15:
      -[SKUIStorePageSectionsViewController _defaultSectionForSwooshComponent:](self, "_defaultSectionForSwooshComponent:", v4);
      v8 = objc_claimAutoreleasedReturnValue();
      goto LABEL_28;
    case 16:
...
- (void)dismissOverlays
{
  ...
  -[SKUIProductPageOverlayController setDelegate:](self->_overlayController, "setDelegate:", 0);
  -[SKUIProductPageOverlayController dismiss](self->_overlayController, "dismiss");
...
- (void)invalidateAndReload
{
  ...
  -[SKUIStorePageSectionsViewController _collectionViewSublayouts](self, "_collectionViewSublayouts");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v22 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  -[SKUICollectionView collectionViewLayout](self->_collectionView, "collectionViewLayout");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "invalidateLayout");

  -[SKUIStorePageSectionsViewController _textLayoutCache](self, "_textLayoutCache");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = 0u;
  v19 = 0u;
  v20 = 0u;
  ...
  -[SKUICollectionView reloadData](self->_collectionView, "reloadData");
...
- (SKUIResourceLoader)resourceLoader
{
  ...
  if (!resourceLoader)
  {
    ...
    -[SKUIStorePageSectionsViewController setResourceLoader:](self, "setResourceLoader:", v6);
    resourceLoader = self->_resourceLoader;
  }
...
- (void)setColorScheme:(id)a3
{
  ...
  if (self->_colorScheme != a3)
  {
    ...
    v11[3] = &unk_1E73A2540;
    v11[4] = self;
    -[SKUIStorePageSectionsViewController _enumerateSectionContextsUsingBlock:](self, "_enumerateSectionContextsUsingBlock:", v11);
    -[SKUIColorScheme backgroundColor](self->_colorScheme, "backgroundColor");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = v6;
    if (v6)
    ...
    -[SKUICollectionView setBackgroundColor:](self->_collectionView, "setBackgroundColor:", v9);
    if (-[SKUIStorePageSectionsViewController isViewLoaded](self, "isViewLoaded"))
    {
      -[SKUIStorePageSectionsViewController view](self, "view");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  SKUIStorePageSectionsDelegate **p_delegate;
  id v5;
  char v6;
  id WeakRetained;
  id v8;
...
- (void)setActiveMetricsImpressionSession:(id)a3
{
  ...
  _QWORD v6[4];
  SKUIMetricsImpressionSession *v7;

  v5 = (SKUIMetricsImpressionSession *)a3;
  if (self->_activeMetricsImpressionSession != v5)
  {
    ...
    v6[3] = &unk_1E73A2540;
    v7 = v5;
    -[SKUIStorePageSectionsViewController _enumerateSectionContextsUsingBlock:](self, "_enumerateSectionContextsUsingBlock:", v6);
...
- (void)setPinningTransitionStyle:(int64_t)a3
{
  ...
  if (self->_pinningTransitionStyle != a3)
  {
    ...
    v5[3] = &unk_1E73A2540;
    v5[4] = self;
    -[SKUIStorePageSectionsViewController _enumerateSectionContextsUsingBlock:](self, "_enumerateSectionContextsUsingBlock:", v5);
    -[SKUICollectionView collectionViewLayout](self->_collectionView, "collectionViewLayout");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  SKUIStorePageSplitsDescription *v4;
  SKUIStorePageSplit *v5;
  id v6;
  ...
  if (v6)
  {
    ...
    -[SKUIStorePageSplit setPageComponents:](v5, "setPageComponents:", v6);
    -[SKUIStorePageSplitsDescription setTopSplit:](v4, "setTopSplit:", v5);
    -[SKUIStorePageSectionsViewController setSectionsWithSplitsDescription:](self, "setSectionsWithSplitsDescription:", v4);

  }
  else
  {
    -[SKUIStorePageSectionsViewController setSectionsWithSplitsDescription:](self, "setSectionsWithSplitsDescription:", 0);
  }
...
{
  SKUIStorePageSplitsDescription *v5;
  SKUIStorePageSplitsDescription *v6;
  NSMutableArray *v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t i;
  ...
  objc_class *v18;
  void *v19;
  SKUIStorePageSplitsDescription *v20;
  SKUIStorePageSplitsDescription *splitsDescription;
  int64_t v22;
  uint64_t v23;
  void *v24;
  ...
  v5 = (SKUIStorePageSplitsDescription *)a3;
  v6 = v5;
  if (self->_ignoreSectionsChangeCount < 1)
  {
    if (self->_splitsDescription != v5)
    {
      ...
      v56 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 0);
      v47 = 0u;
      v48 = 0u;
      v49 = 0u;
      v50 = 0u;
      ...
      v15 = -[SKUIStorePageSplitsDescription numberOfSplits](self->_splitsDescription, "numberOfSplits");
      ...
      v18 = (objc_class *)objc_alloc_init(MEMORY[0x1E0C99DE8]);
      v19 = *(Class *)((char *)&self->super.super.super.super.isa + v31);
      *(Class *)((char *)&self->super.super.super.super.isa + v31) = v18;

      v20 = (SKUIStorePageSplitsDescription *)-[SKUIStorePageSplitsDescription copy](v6, "copy");
      splitsDescription = self->_splitsDescription;
      self->_splitsDescription = v20;

      v22 = -[SKUIStorePageSplitsDescription numberOfSplits](self->_splitsDescription, "numberOfSplits");
      v43 = 0;
      v44 = &v43;
      v45 = 0x2020000000;
      v46 = 0;
      ...
      v36[6] = &v51;
      v36[7] = &v43;
      -[SKUIStorePageSectionsViewController _updateCollectionViewWithUpdates:](self, "_updateCollectionViewWithUpdates:", v36);
      if (!v44[3])
        goto LABEL_31;
      v34 = 0u;
      v35 = 0u;
      ...
      if (v44[3] != 3)
LABEL_31:
        -[SKUIStorePageSectionsViewController _reloadRelevantEntityProviders](self, "_reloadRelevantEntityProviders", v31);
...
void __72__SKUIStorePageSectionsViewController_setSectionsWithSplitsDescription___block_invoke_2(uint64_t a1, void *a2, double a3)
{
  ...
  v9 = &OBJC_IVAR___SKUIItemOffer__fileSize;
  if (v8)
  {
    v10 = v8;
    v50 = 0;
...
LABEL_27:
  ...
  v50 = 0;
LABEL_31:
  objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + v9[343]), "lastObject");
...
{
  SKUIStackedBar *v5;
  SKUIStackedBar **p_stackedBar;
  SKUIStackedBar *v7;

  v5 = (SKUIStackedBar *)a3;
  p_stackedBar = &self->_stackedBar;
  if (*p_stackedBar != v5)
  {
    v7 = v5;
    -[SKUIStackedBar removeFromSuperview](*p_stackedBar, "removeFromSuperview");
...
{
  id v6;
  SKUIProductPageOverlayController *v7;
  SKUIProductPageOverlayController *overlayController;
  SKUIProductPageOverlayController *v9;
  void *v10;
  id v11;
  ...
  if (self->_overlayController)
    -[SKUIStorePageSectionsViewController dismissOverlays](self, "dismissOverlays");
  v7 = -[SKUIProductPageOverlayController initWithParentViewController:]([SKUIProductPageOverlayController alloc], "initWithParentViewController:", self);
  overlayController = self->_overlayController;
  ...
  -[SKUIViewController clientContext](self, "clientContext");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIProductPageOverlayController setClientContext:](v9, "setClientContext:", v10);

  -[SKUIProductPageOverlayController setDelegate:](self->_overlayController, "setDelegate:", self);
  -[SKUIProductPageOverlayController showWithInitialProductPage:metricsPageEvent:](self->_overlayController, "showWithInitialProductPage:metricsPageEvent:", v11, v6);
  -[SKUIStorePageSectionsViewController _setActiveProductPageOverlayController:](self, "_setActiveProductPageOverlayController:", self->_overlayController);
...
- (void)setUsePullToRefresh:(BOOL)a3
{
  ...
  if (a3)
  {
    if (!refreshControl)
    {
      ...
      collectionView = self->_collectionView;
      if (collectionView)
        -[SKUICollectionView setRefreshControl:](collectionView, "setRefreshControl:", self->_refreshControl);
      return;
    }
  }
...
{
  SKUICollectionViewPullToRefreshDelegate **p_pullToRefreshDelegate;
  id WeakRetained;
  void *v6;
  id v7;
  char v8;
...
- (void)_longPressAction:(id)a3
{
  ...
  if (v4)
  {
    ...
    -[SKUICollectionView indexPathForItemAtPoint:](self->_collectionView, "indexPathForItemAtPoint:");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = v6;
    if (v6)
    {
...
- (void)decodeRestorableStateWithCoder:(id)a3
{
  ...
  -[SKUIStorePageSectionsViewController decodeRestorableStateWithCoder:](&v15, sel_decodeRestorableStateWithCoder_, v4);
...
- (void)encodeRestorableStateWithCoder:(id)a3
{
  ...
  -[SKUIStorePageSectionsViewController encodeRestorableStateWithCoder:](&v7, sel_encodeRestorableStateWithCoder_, v4);
...
- (void)loadView
{
  ...
  -[SKUIStorePageSectionsViewController setView:](self, "setView:", v19);
  -[SKUIStorePageSectionsViewController collectionView](self, "collectionView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_stackedBar)
  {
    ...
    v10 = v9;
    v11 = 0.0;
    if (-[SKUIStackedBar splitViewStyle](self->_stackedBar, "splitViewStyle"))
    {
      -[SKUIStorePageSectionsViewController navigationController](self, "navigationController");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[SKUIStackedBar setAutoresizingMask:](self->_stackedBar, "setAutoresizingMask:", 2);
    -[SKUIStackedBar setFrame:](self->_stackedBar, "setFrame:", v8, v11, v10, 0.0);
    objc_msgSend(v19, "addSubview:", self->_stackedBar);
  }
  if (__orbSupported)
  {
    -[SKUIStorePageSectionsViewController registerForPreviewingWithDelegate:sourceView:](self, "registerForPreviewingWithDelegate:sourceView:", self, v5);
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  SKUIProductPageOverlayController *overlayController;
  SKUIProductPageOverlayController *v8;
  void *v9;
  objc_super v10;
  ...
  if (initialOverlayURLs)
  {
    if (!self->_overlayController)
    {
      v6 = -[SKUIProductPageOverlayController initWithParentViewController:]([SKUIProductPageOverlayController alloc], "initWithParentViewController:", self);
      overlayController = self->_overlayController;
      ...
      -[SKUIViewController clientContext](self, "clientContext");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIProductPageOverlayController setClientContext:](v8, "setClientContext:", v9);

      -[SKUIProductPageOverlayController setDelegate:](self->_overlayController, "setDelegate:", self);
      -[SKUIProductPageOverlayController showWithInitialURLs:](self->_overlayController, "showWithInitialURLs:", self->_initialOverlayURLs);
      -[SKUIStorePageSectionsViewController _setActiveProductPageOverlayController:](self, "_setActiveProductPageOverlayController:", self->_overlayController);
      initialOverlayURLs = self->_initialOverlayURLs;
    }
  ...
  -[SKUIStorePageSectionsViewController viewDidAppear:](&v10, sel_viewDidAppear_, v3);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[SKUIStorePageSectionsViewController _invalidateIfLastKnownWidthChanged](self, "_invalidateIfLastKnownWidthChanged");
  -[SKUICollectionView collectionViewLayout](self->_collectionView, "collectionViewLayout");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionsViewController _currentBackdropGroupName](self, "_currentBackdropGroupName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setBackdropGroupName:", v6);

  -[SKUIStorePageSectionsViewController _deselectCellsForAppearance:](self, "_deselectCellsForAppearance:", v3);
  -[SKUIStorePageSectionsViewController _beginActiveImpressionsForImpressionableViewElements](self, "_beginActiveImpressionsForImpressionableViewElements");
  ...
  -[SKUIViewController viewWillAppear:](&v13, sel_viewWillAppear_, v3);
}
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  *(float *)&v8 = v7;
  ...
  -[SKUICollectionView setClipsToBounds:](self->_collectionView, "setClipsToBounds:", 1);
  -[SKUIStorePageSectionsViewController _endAllPendingActiveImpression](self, "_endAllPendingActiveImpression");
  v11.receiver = self;
  v11.super_class = (Class)SKUIStorePageSectionsViewController;
  -[SKUIStorePageSectionsViewController viewWillDisappear:](&v11, sel_viewWillDisappear_, v3);
}
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  -[SKUIStorePageSectionsViewController viewDidDisappear:](&v4, sel_viewDidDisappear_, a3);
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  v12.super_class = (Class)SKUIStorePageSectionsViewController;
  v4 = a3;
  -[SKUIStorePageSectionsViewController traitCollectionDidChange:](&v12, sel_traitCollectionDidChange_, v4);
  v5 = objc_msgSend(v4, "userInterfaceStyle", v12.receiver, v12.super_class);

  -[SKUIStorePageSectionsViewController traitCollection](self, "traitCollection");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v5 != v7)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v10, "count"))
      {
        ...
        objc_msgSend(v11, "invalidateDecorationElementsOfKind:atIndexPaths:", 0x1E73B7DF0, v10);
...
void __73__SKUIStorePageSectionsViewController_itemStateCenter_itemStatesChanged___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(v24, "count"))
  {
    ...
    v28[1] = 3221225472;
    v28[2] = __73__SKUIStorePageSectionsViewController_itemStateCenter_itemStatesChanged___block_invoke_2;
    v28[3] = &unk_1E73A25B8;
    v28[4] = *(_QWORD *)(a1 + 32);
    v16 = v14;
    v29 = v16;
    ...
    v26[0] = v15;
    v26[1] = 3221225472;
    v26[2] = __73__SKUIStorePageSectionsViewController_itemStateCenter_itemStatesChanged___block_invoke_3;
    v26[3] = &unk_1E73A25E0;
    v26[4] = *(_QWORD *)(a1 + 32);
    v27 = v16;
    v18 = v16;
...
- (void)productPageOverlayDidDismiss:(id)a3
{
  ...
  {
    -[SKUIStorePageSectionsViewController _setActiveProductPageOverlayController:](self, "_setActiveProductPageOverlayController:", 0);
    -[SKUIProductPageOverlayController setDelegate:](self->_overlayController, "setDelegate:", 0);
    overlayController = self->_overlayController;
    self->_overlayController = 0;
    ...
    if (!-[NSMutableArray count](self->_sections, "count"))
    {
      ...
      if (v5)
      {
        if (SKUIViewControllerIsDescendent(self, v5))
...
LABEL_10:
  ...
  -[SKUICollectionView cellForItemAtIndexPath:](self->_collectionView, "cellForItemAtIndexPath:", indexPathOfEditedCell);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)collectionView:(id)a3 willBeginEditingItemAtIndexPath:(id)a4
{
  ...
  -[SKUICollectionView indexPathsForSelectedItems](self->_collectionView, "indexPathsForSelectedItems");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (v6 && objc_msgSend(v6, "count"))
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICollectionView deselectItemAtIndexPath:animated:](collectionView, "deselectItemAtIndexPath:animated:", v9, 0);
...
- (id)indexPathsForPinningItemsInCollectionView:(id)a3 layout:(id)a4
{
  ...
  if ((unint64_t)objc_msgSend(v8, "count") > 1)
  {
    ...
    v19 = v8;
    v20 = &v21;
    -[SKUIStorePageSplitsDescription enumerateSplitsUsingBlock:](splitsDescription, "enumerateSplitsUsingBlock:", v17);
  ...
  else
  {
    ...
    do
    {
      ...
      {
        if (!v13)
          v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", objc_msgSend(v15, "count"));
...
- (BOOL)performTestWithName:(id)a3 options:(id)a4
{
  ...
  if (objc_msgSend(v6, "hasPrefix:", CFSTR("Scroll")))
  {
    ...
    -[SKUICollectionView contentSize](self->_collectionView, "contentSize");
    -[SKUICollectionView _performScrollTest:iterations:delta:length:](collectionView, "_performScrollTest:iterations:delta:length:", v6, v14, v15, (int)v16);
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionsViewController metricsController](self, "metricsController");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)skuiCollectionViewWillLayoutSubviews:(id)a3
{
  ...
  *(float *)&v16 = v15;
  ...
  -[SKUICollectionView reloadData](self->_collectionView, "reloadData");
  -[SKUIStorePageSectionsViewController _reloadCollectionView](self, "_reloadCollectionView");
  -[SKUIStorePageSectionsViewController _scrollFirstAppearanceSectionToView](self, "_scrollFirstAppearanceSectionToView");
LABEL_6:
  if (skuiCollectionViewWillLayoutSubviews__sLayoutRespondsToFrame == 255)
    skuiCollectionViewWillLayoutSubviews__sLayoutRespondsToFrame = objc_msgSend(MEMORY[0x1E0DC3620], "instancesRespondToSelector:", sel__frame);
  -[SKUIStorePageSplitsDescription leftSplit](self->_splitsDescription, "leftSplit");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  if (v19
    && (-[SKUIStorePageSplitsDescription rightSplit](self->_splitsDescription, "rightSplit"),
        v20 = (void *)objc_claimAutoreleasedReturnValue(),
        v20,
        v20)
    && (objc_msgSend(v19, "dividerColor"), (v21 = objc_claimAutoreleasedReturnValue()) != 0))
  {
    ...
    if (skuiCollectionViewWillLayoutSubviews__sLayoutRespondsToFrame)
    {
      ...
      v58 = 0x4010000000;
      v59 = &unk_1BBF15257;
      v26 = *(_OWORD *)(MEMORY[0x1E0C9D648] + 16);
      ...
      v54 = v29;
      v55 = &v56;
      -[SKUIStorePageSplitsDescription enumerateSplitsUsingBlock:](splitsDescription, "enumerateSplitsUsingBlock:", &v49);
...
- (void)scrollViewDidEndDecelerating:(id)a3
{
  ...
  v4 = a3;
  if (-[SKUIResourceLoader isIdle](self->_resourceLoader, "isIdle"))
    -[SKUIStorePageSectionsViewController _prefetchArtworkForVisibleSections](self, "_prefetchArtworkForVisibleSections");
  if ((objc_msgSend(v4, "isDragging") & 1) == 0
    && (objc_msgSend(v4, "isTracking") & 1) == 0
    && (objc_msgSend(v4, "isDecelerating") & 1) == 0)
  {
    -[SKUIStackedBar animateToFullSizeIfNecessary](self->_stackedBar, "animateToFullSizeIfNecessary");
  }
...
- (void)scrollViewDidEndDragging:(id)a3 willDecelerate:(BOOL)a4
{
  if (!a4)
  {
    if (-[SKUIResourceLoader isIdle](self->_resourceLoader, "isIdle", a3))
      -[SKUIStorePageSectionsViewController _prefetchArtworkForVisibleSections](self, "_prefetchArtworkForVisibleSections");
    -[SKUIStackedBar animateToFullSizeIfNecessary](self->_stackedBar, "animateToFullSizeIfNecessary");
  }
  self->_scrollOffsetHasChanged = 1;
...
- (void)scrollViewDidScroll:(id)a3
{
  ...
  -[SKUIStackedBar setOffset:](stackedBar, "setOffset:", v7);
...
- (void)scrollViewWillEndDragging:(id)a3 withVelocity:(CGPoint)a4 targetContentOffset:(CGPoint *)a5
{
  ...
  x = a5->x;
  y = a5->y;
  -[SKUICollectionView indexPathForItemAtPoint:](self->_collectionView, "indexPathForItemAtPoint:", a3, a5->x, y);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = objc_msgSend(v8, "item");
  v10 = objc_msgSend(v8, "section");
  -[SKUICollectionView contentInset](self->_collectionView, "contentInset");
  v12 = v11;
  -[SKUICollectionView bounds](self->_collectionView, "bounds");
  v14 = y + v13;
  -[SKUICollectionView contentSize](self->_collectionView, "contentSize");
  if (v14 >= v15 - v12)
    v16 = v15 - v12;
    ...
    v16 = v14;
  -[SKUICollectionView indexPathForItemAtPoint:](self->_collectionView, "indexPathForItemAtPoint:", x, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)previewingContext:(id)a3 commitViewController:(id)a4
{
  ...
  -[SKUIStorePageSectionsViewController navigationController](self, "navigationController");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionsViewController parentViewController](self, "parentViewController");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
    while (1)
    {
      ...
      if (v9)
        break;
      if (objc_msgSend(v8, "conformsToProtocol:", &unk_1EF4C5DC0))
      {
...
LABEL_11:
  v17 = v6;
  v18 = v17;
  if (objc_msgSend(v17, "conformsToProtocol:", &unk_1EF4ADAD0))
  {
  ...
  if (!v4)
  {
    ...
    if (v3)
    {
      if (self->_deferredSplitsDescription)
      {
        ...
        -[SKUIStorePageSectionsViewController setSectionsWithSplitsDescription:](self, "setSectionsWithSplitsDescription:", v8);
      }
    }
  }
}
...
- (void)_insertSectionsWithComponents:(id)a3 afterSection:(id)a4
{
  ...
  {
    v8 = v7;
    -[SKUIStorePageSectionsViewController _splitForSectionIndex:](self, "_splitForSectionIndex:", v7);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0; i != v12; ++i)
        {
          ...
          -[SKUIStorePageSectionsViewController defaultSectionForComponent:](self, "defaultSectionForComponent:", *(_QWORD *)(*((_QWORD *)&v22 + 1) + 8 * i));
          v17 = (void *)objc_claimAutoreleasedReturnValue();
          v18 = v17;
          if (v17)
          {
    ...
    -[SKUIStorePageSectionsViewController _updateSectionsAfterMenuChange](self, "_updateSectionsAfterMenuChange");
    v6 = v21;
  }
...
{
  SKUIProductPageOverlayController **p_activeOverlayController;
  id WeakRetained;
  id v7;
  id v8;
  char v9;
...
- (void)_setSelectedIndex:(int64_t)a3 forMenuSection:(id)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionsViewController _menuContextForMenuComponent:](self, "_menuContextForMenuComponent:", v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9 != a3)
  {
    ...
    -[SKUIStorePageSectionsViewController _splitForSectionIndex:](self, "_splitForSectionIndex:");
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v21, "sectionContext");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageSectionsViewController _childSectionsForMenuComponent:selectedIndex:](self, "_childSectionsForMenuComponent:selectedIndex:", v7, a3);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v23 = 0u;
    v24 = 0u;
    v25 = 0u;
...
- (void)_updateSectionsForIndex:(int64_t)a3 menuSection:(id)a4
{
  ...
  if (objc_msgSend(v8, "selectedIndex") == a3)
  {
    ...
    if (!v10)
    {
      -[SKUIStorePageSectionsViewController _splitForSectionIndex:](self, "_splitForSectionIndex:", objc_msgSend(v6, "sectionIndex"));
      v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_visibleMetricsImpressionsString
{
  ...
  -[SKUICollectionView indexPathsForVisibleItems](self->_collectionView, "indexPathsForVisibleItems");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
...
- (id)_impressionableViewElements
{
  ...
  -[SKUIMetricsImpressionSession impressionableViewElements](v3, "impressionableViewElements");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_entityProviderDidInvalidateNotification:(id)a3
{
  ...
  void *v10;
  id v11;
  SKUIStorePageSectionsViewController *v12;
...
void __80__SKUIStorePageSectionsViewController__entityProviderDidInvalidateNotification___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(v3, "count"))
  {
    ...
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "objectForKey:", *MEMORY[0x1E0D3A548]);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v10[1] = 3221225472;
    v10[2] = __80__SKUIStorePageSectionsViewController__entityProviderDidInvalidateNotification___block_invoke_2;
    v10[3] = &unk_1E73A1350;
    v11 = v3;
    v12 = v9;
    v13 = v5;
...
- (void)_beginActiveImpressionsForImpressionableViewElements
{
  ...
  -[SKUIStorePageSectionsViewController _impressionableViewElements](self, "_impressionableViewElements");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = 0u;
  v11 = 0u;
  v12 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIStorePageSectionsViewController activeMetricsImpressionSession](self, "activeMetricsImpressionSession");
        v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_childSectionsForMenuComponent:(id)a3 selectedIndex:(int64_t)a4
{
  ...
  v6 = a3;
  -[SKUIStorePageSectionsViewController _menuContextForMenuComponent:](self, "_menuContextForMenuComponent:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v11)
    {
      ...
      do
      {
        ...
        do
        {
          if (*(_QWORD *)v18 != v13)
            objc_enumerationMutation(v10);
          -[SKUIStorePageSectionsViewController defaultSectionForComponent:](self, "defaultSectionForComponent:", *(_QWORD *)(*((_QWORD *)&v17 + 1) + 8 * v14));
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          if (v15)
...
- (id)_createSectionsForExpandPageComponent:(id)a3 context:(id)a4 newSections:(id)a5 sectionCount:(int64_t)a6 sectionsByViewElement:(id)a7 updateStyle:(int64_t)a8
{
  ...
  int v47;
  SKUIStorePageSectionsViewController *v48;
  uint64_t v49;
  ...
  id v65;
  id v66;
  SKUIStorePageSectionsViewController *v68;
  __int128 v70;
  __int128 v71;
  __int128 v72;
  __int128 v73;
        ...
        if (v25)
        {
          ...
          if (v26)
          {
            ...
            if (v30 == 2)
            {
              ...
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v31, "integerValue") + 1);
              v32 = (void *)objc_claimAutoreleasedReturnValue();
              v33 = v60;
              v34 = 1;
LABEL_35:
...
LABEL_38:
        ...
        if ((objc_msgSend(v20, "isOpen") & 1) != 0)
        {
          ...
          v37 = -[SKUIStorePageSectionsViewController _newSectionsWithPageComponent:](self, "_newSectionsWithPageComponent:", v36);
        ...
        if (a8 == 1 && v47)
        {
          ...
          {
            v51 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x1E0CB3788]);
...
- (id)_defaultSectionForSwooshComponent:(id)a3
{
  ...
  if (v4 > 2)
    ...
    v5 = (void *)objc_msgSend(objc_alloc(*off_1E73A2780[v4]), "initWithPageComponent:", v3);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v20 != v8)
          objc_enumerationMutation(v5);
        -[SKUICollectionView deselectItemAtIndexPath:animated:](self->_collectionView, "deselectItemAtIndexPath:animated:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v9++), v3);
      }
      while (v7 != v9);
...
- (void)_enumerateSectionContextsUsingBlock:(id)a3
{
  ...
  v8 = v4;
  v6 = v4;
  -[SKUIStorePageSplitsDescription enumerateSplitsUsingBlock:](splitsDescription, "enumerateSplitsUsingBlock:", v7);
...
{
  id v4;
  SKUIExpandPageSectionContext *v5;
  NSMapTable *v6;
  NSMapTable *expandSectionContexts;

  v4 = a3;
  -[NSMapTable objectForKey:](self->_expandSectionContexts, "objectForKey:", v4);
  v5 = (SKUIExpandPageSectionContext *)objc_claimAutoreleasedReturnValue();
  if (!v5)
  {
    if (!self->_expandSectionContexts)
    {
      v6 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
      expandSectionContexts = self->_expandSectionContexts;
...
{
  id v4;
  SKUIMenuPageSectionContext *v5;
  NSMapTable *v6;
  NSMapTable *menuSectionContexts;

  v4 = a3;
  -[NSMapTable objectForKey:](self->_menuSectionContexts, "objectForKey:", v4);
  v5 = (SKUIMenuPageSectionContext *)objc_claimAutoreleasedReturnValue();
  if (!v5)
  {
    ...
    -[SKUIMenuPageSectionContext setSelectedIndex:](v5, "setSelectedIndex:", objc_msgSend(v4, "defaultSelectedIndex"));
...
- (id)_newSectionContext
{
  ...
  -[SKUIStorePageSectionContext _setCollectionView:](v3, "_setCollectionView:", self->_collectionView);
  -[SKUIStorePageSectionContext _setColorScheme:](v3, "_setColorScheme:", self->_colorScheme);
  -[SKUIStorePageSectionContext _setDefaultPinningTransitionStyle:](v3, "_setDefaultPinningTransitionStyle:", self->_pinningTransitionStyle);
  -[SKUIStorePageSectionContext _setLayoutStyle:](v3, "_setLayoutStyle:", self->_layoutStyle);
  -[SKUIStorePageSectionContext _setMetricsController:](v3, "_setMetricsController:", self->_metricsController);
  -[SKUIStorePageSectionContext _setParentViewController:](v3, "_setParentViewController:", self);
  -[SKUIStorePageSectionsViewController resourceLoader](self, "resourceLoader");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionContext _setResourceLoader:](v3, "_setResourceLoader:", v4);

  -[SKUIStorePageSectionsViewController _textLayoutCache](self, "_textLayoutCache");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionContext _setTextLayoutCache:](v3, "_setTextLayoutCache:", v5);

  -[SKUIStorePageSectionContext _setActiveMetricsImpressionSession:](v3, "_setActiveMetricsImpressionSession:", self->_activeMetricsImpressionSession);
  if (-[SKUIStorePageSectionsViewController isViewLoaded](self, "isViewLoaded"))
  {
    -[SKUIStorePageSectionsViewController view](self, "view");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[SKUICollectionView indexBarControl](self->_collectionView, "indexBarControl");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[SKUIStorePageSectionContext _setActivePageWidth:](v3, "_setActivePageWidth:", v8);
    -[SKUIStorePageSectionContext _setLandscapePageWidth:](v3, "_setLandscapePageWidth:", v10);
    -[SKUIStorePageSectionContext _setPortraitPageWidth:](v3, "_setPortraitPageWidth:", v8);
  }
  return v3;
}
...
- (id)_newSectionsWithPageComponent:(id)a3
{
  ...
  {
    v6 = v4;
    v7 = -[SKUIMenuPageSection initWithPageComponent:]([SKUIMenuPageSection alloc], "initWithPageComponent:", v6);
    objc_msgSend(v5, "addObject:", v7);
    -[SKUIStorePageSectionsViewController _childSectionsForMenuComponent:selectedIndex:](self, "_childSectionsForMenuComponent:selectedIndex:", v6, objc_msgSend(v6, "defaultSelectedIndex"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (v8)
  ...
  {
    -[SKUIStorePageSectionsViewController defaultSectionForComponent:](self, "defaultSectionForComponent:", v4);
    v6 = (id)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = -[SKUIStorePageSectionsViewController _newSectionsWithPageComponent:](self, "_newSectionsWithPageComponent:", *(_QWORD *)(*((_QWORD *)&v13 + 1) + 8 * v10), (_QWORD)v13);
...
- (id)_newStorePageCollectionViewLayout
{
  ...
  -[SKUIStorePageSectionsViewController _currentBackdropGroupName](self, "_currentBackdropGroupName");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageCollectionViewLayout setBackdropGroupName:](v3, "setBackdropGroupName:", v4);
...
{
  -[SKUIStorePageSectionsViewController _enumerateVisibleSectionsUsingBlock:](self, "_enumerateVisibleSectionsUsingBlock:", &__block_literal_global_177);
}
...
- (id)_prepareLayoutForSections
{
  ...
  uint64_t i;
  void *v9;
  SKUIStorePageSplitCollectionViewLayout *v10;
  SKUIStorePageSplitsDescription *splitsDescription;
  void *v12;
  _QWORD v14[6];
  _QWORD v15[4];
  ...
  v21 = *MEMORY[0x1E0C80C00];
  if (-[SKUIStorePageSplitsDescription numberOfSplits](self->_splitsDescription, "numberOfSplits") > 1)
  {
    v4 = -[SKUIStorePageSectionsViewController _newSectionContext](self, "_newSectionContext");
    v15[0] = 0;
    v15[1] = v15;
    v15[2] = 0x2020000000;
    v15[3] = 0;
    ...
    -[SKUIStorePageSectionsViewController _currentBackdropGroupName](self, "_currentBackdropGroupName");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIStorePageSplitCollectionViewLayout setBackdropGroupName:](v10, "setBackdropGroupName:", v12);

    -[SKUIStorePageSplitCollectionViewLayout setRendersWithPerspective:](v10, "setRendersWithPerspective:", self->_rendersWithPerspective);
    -[SKUIStorePageSplitCollectionViewLayout addSublayoutsUsingSplitsDescription:](v10, "addSublayoutsUsingSplitsDescription:", self->_splitsDescription);
    _Block_object_dispose(v15, 8);
  }
  else
  {
    -[SKUIStorePageSplitsDescription firstSplit](self->_splitsDescription, "firstSplit");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v10 = -[SKUIStorePageSectionsViewController _newStorePageCollectionViewLayout](self, "_newStorePageCollectionViewLayout");
  }
...
- (void)_reloadCollectionView
{
  ...
  void *v15;
  CGFloat v16;
  SKUIStorePageSectionsViewController *v17;
  void *v18;
  uint64_t v19;
  char v20;
  void *v21;
  ...
  -[SKUIStorePageSectionsViewController _prepareLayoutForSections](self, "_prepareLayoutForSections");
  v32 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
  ...
  -[SKUICollectionView setAlwaysBounceVertical:](self->_collectionView, "setAlwaysBounceVertical:", v8);
  -[SKUICollectionView setScrollEnabled:](self->_collectionView, "setScrollEnabled:", v8);
  -[SKUIColorScheme backgroundColor](self->_colorScheme, "backgroundColor");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v9;
  if (v9)
  ...
  if (-[NSMutableArray count](self->_sections, "count"))
  {
    ...
    v17 = self;
    v18 = v17;
    while (!objc_msgSend(v18, "conformsToProtocol:", &unk_1EF451A38))
    {
    ...
    if ((v20 & 1) != 0)
    {
      -[SKUIStorePageSectionsViewController navigationController](v17, "navigationController");
      v21 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_21:
    ...
    -[SKUICollectionView contentInset](self->_collectionView, "contentInset");
    -[SKUICollectionView setContentInset:](self->_collectionView, "setContentInset:", v25 + p_contentInsetAdjustments->top - top);
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        if (!v6)
          v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E20]), "initWithCapacity:", -[NSMapTable count](self->_entityProviderToRelevantSections, "count"));
    ...
    do
    {
      for (j = 0; j != v32; ++j)
      {
        ...
        if (objc_msgSend(v12, "count"))
        {
          ...
          {
            v13 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 0);
          ...
          if (v16)
          {
            ...
            do
            {
              for (k = 0; k != v17; ++k)
              {
                ...
                if (!v21)
                {
                  v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", 0);
                  -[NSMapTable setObject:forKey:](self->_entityProviderToRelevantSections, "setObject:forKey:", v21, v20);
                  -[SKUIStorePageSectionsViewController _registerForNotificationsForEntityProvider:](self, "_registerForNotificationsForEntityProvider:", v20);
                }
  ...
  if (v23)
  {
    ...
    do
    {
      for (m = 0; m != v24; ++m)
      {
        ...
        -[SKUIStorePageSectionsViewController _unregisterForNotificationsForEntityProvider:](self, "_unregisterForNotificationsForEntityProvider:", v27);
      ...
      while (2)
      {
        for (i = 0; i != v5; ++i)
        {
          ...
          if (v8)
          {
            ...
            -[SKUICollectionView scrollToItemAtIndexPath:atScrollPosition:animated:](self->_collectionView, "scrollToItemAtIndexPath:atScrollPosition:animated:", v9, 2, 0);
            self->_scrollOffsetHasChanged = 1;
            v3 = v9;
            goto LABEL_12;
          }
...
- (void)_setPageSize:(CGSize)a3
{
  ...
  v14 = v6;
  v12 = v6;
  -[SKUIStorePageSplitsDescription sizeSplitsToFitWidth:usingBlock:](splitsDescription, "sizeSplitsToFitWidth:usingBlock:", v13, width);
...
- (id)_splitForSectionIndex:(int64_t)a3
{
  ...
  v6[4] = v13;
  v6[5] = &v7;
  -[SKUIStorePageSplitsDescription enumerateSplitsUsingBlock:](splitsDescription, "enumerateSplitsUsingBlock:", v6);
  v4 = (id)v8[5];
...
- (void)_updateCollectionViewWithUpdates:(id)a3
{
  ...
  void *v19;
  SKUIStorePageSectionsViewController *v20;
  id v21;
  _QWORD v22[5];
  id v23;
  _QWORD aBlock[5];
  ...
  if (v4)
  {
    ...
    {
      -[SKUIStorePageSectionsViewController _beginIgnoringSectionChanges](self, "_beginIgnoringSectionChanges");
      collectionView = self->_collectionView;
      v22[0] = v8;
      v22[1] = 3221225472;
      v22[2] = __72__SKUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke_4;
      v22[3] = &unk_1E739FD10;
      v22[4] = self;
      v23 = v9;
      v16 = v8;
      v17 = 3221225472;
      v18 = __72__SKUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke_5;
      v19 = &unk_1E73A2760;
      v20 = self;
      v21 = v10;
      -[SKUICollectionView performBatchUpdates:completion:](collectionView, "performBatchUpdates:completion:", v22, &v16);
  ...
  else if (self->_didInitialReload && self->_collectionView)
  {
    ...
    v27[1] = 3221225472;
    v27[2] = __72__SKUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke;
    v27[3] = &unk_1E739FD38;
    v27[4] = self;
    objc_msgSend(MEMORY[0x1E0DC3F10], "performWithoutAnimation:", v27);
  }
  if (-[SKUIStorePageSectionsViewController isViewLoaded](self, "isViewLoaded", v16, v17, v18, v19))
  {
    overlayController = self->_overlayController;
    if (overlayController)
    {
      -[SKUIProductPageOverlayController view](overlayController, "view");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
...
void __72__SKUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke_2(_QWORD *a1)
{
  uint64_t v1;
  id v2;
  uint64_t v3;
...
- (void)_updateSectionsAfterMenuChange
{
  ...
  -[SKUICollectionView setAlwaysBounceVertical:](self->_collectionView, "setAlwaysBounceVertical:", v6);
  -[SKUICollectionView setScrollEnabled:](self->_collectionView, "setScrollEnabled:", v6);
  -[SKUICollectionView setScrollsToTop:](self->_collectionView, "setScrollsToTop:", v6);
  -[SKUICollectionView reloadData](self->_collectionView, "reloadData");
}
...
{
  return (SKUIStorePageSectionsDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
...
{
  return (SKUICollectionViewPullToRefreshDelegate *)objc_loadWeakRetained((id *)&self->_pullToRefreshDelegate);
}
