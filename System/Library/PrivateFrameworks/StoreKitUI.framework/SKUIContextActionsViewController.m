...
{
  id v5;
  SKUIContextActionsViewController *v6;
  SKUIContextActionsViewController *v7;
  objc_super v9;
  ...
  {
    -[SKUIContextActionsViewController initWithConfiguration:].cold.1();
  }
  v9.receiver = self;
  v9.super_class = (Class)SKUIContextActionsViewController;
  v6 = -[SKUIContextActionsViewController initWithNibName:bundle:](&v9, sel_initWithNibName_bundle_, 0, 0);
  v7 = v6;
  if (v6)
  {
    ...
    -[SKUIContextActionsViewController setTransitioningDelegate:](v7, "setTransitioningDelegate:", v7);
    -[SKUIContextActionsViewController setModalPresentationStyle:](v7, "setModalPresentationStyle:", 4);
  }
...
- (void)viewDidLoad
{
  ...
  -[SKUIContextActionsViewController viewDidLoad](&v16, sel_viewDidLoad);
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3D80]), "initWithTarget:action:", self, sel_viewTapped_);
  -[SKUIContextActionsViewController view](self, "view");
  ...
  v12 = (UIStackView *)objc_msgSend(v11, "initWithArrangedSubviews:", MEMORY[0x1E0C9AA60]);
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[SKUIContextActionsViewController viewWillAppear:](&v4, sel_viewWillAppear_, a3);
  -[SKUIContextActionsViewController _reloadViewsConfiguration](self, "_reloadViewsConfiguration");
}
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  -[SKUIContextActionsViewController viewDidAppear:](&v7, sel_viewDidAppear_, a3);
  -[SKUIContextActionsViewController systemProvidedGestureRecognzier](self, "systemProvidedGestureRecognzier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4)
  {
    -[SKUIContextActionsViewController view](self, "view");
...
- (void)viewDidLayoutSubviews
{
  ...
  -[SKUIContextActionsViewController viewDidLayoutSubviews](&v13, sel_viewDidLayoutSubviews);
  -[SKUIContextActionsViewController scrollableActionGroupView](self, "scrollableActionGroupView");
  ...
  if (v8 > Height)
    objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.0, 0.0399999991);
  else
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUIContextActionsViewController;
  -[SKUIContextActionsViewController traitCollectionDidChange:](&v9, sel_traitCollectionDidChange_, v4);
  if (v4)
  {
    v5 = objc_msgSend(v4, "horizontalSizeClass");
    -[SKUIContextActionsViewController traitCollection](self, "traitCollection");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v5 != v7)
    {
      ...
      v8[3] = &unk_1E739FD38;
      v8[4] = self;
      -[SKUIContextActionsViewController dismissViewControllerAnimated:completion:](self, "dismissViewControllerAnimated:completion:", 0, v8);
    }
  }
...
{
  -[SKUIContextActionsViewController dismissViewControllerAnimated:completion:](self, "dismissViewControllerAnimated:completion:", 1, 0);
}
...
- (void)systemProvidedGestureRecognzierTriggered:(id)a3
{
  ...
  v17 = a3;
  -[SKUIContextActionsViewController gestureRecognizerInitialLocation](self, "gestureRecognizerInitialLocation");
  v6 = v5;
  v7 = v4;
  ...
  if (!v8 && objc_msgSend(v17, "state") == 2)
  {
    ...
    if (v16 > 25.0)
LABEL_12:
      -[SKUIContextActionsViewController _applySystemRecognizer](self, "_applySystemRecognizer");
  }
...
- (void)_applySystemRecognizer
{
  ...
  -[SKUIContextActionsViewController contextActionView](self, "contextActionView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIContextActionsViewController systemProvidedGestureRecognzier](self, "systemProvidedGestureRecognzier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIContextActionsViewController setAppliedSystemRecognizer:](self, "setAppliedSystemRecognizer:", 1);
}
...
- (void)_reloadViewsConfiguration
{
  ...
  -[SKUIContextActionsViewController constraints](self, "constraints");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v153 = 0u;
  v154 = 0u;
  -[SKUIContextActionsViewController stackView](self, "stackView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIContextActionsViewController setConstraints:](self, "setConstraints:", v14);

  v15 = *MEMORY[0x1E0DC4B60];
  __61__SKUIContextActionsViewController__reloadViewsConfiguration__block_invoke(v16, *MEMORY[0x1E0DC4B60], 0, 0x8000);
  v17 = objc_claimAutoreleasedReturnValue();
  v161 = *MEMORY[0x1E0DC13B8];
  v162 = *MEMORY[0x1E0CA82A8];
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v162, &v161, 1);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  __61__SKUIContextActionsViewController__reloadViewsConfiguration__block_invoke((uint64_t)v18, v15, v18, 0);
  v19 = objc_claimAutoreleasedReturnValue();

  -[SKUIContextActionsViewController configuration](self, "configuration");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "contextActions");
  v21 = objc_claimAutoreleasedReturnValue();

  v22 = objc_alloc(MEMORY[0x1E0DC38C8]);
  v145 = (void *)v21;
  objc_msgSend(MEMORY[0x1E0DC38C0], "actionGroupWithActions:", v21);
  ...
  v144 = v24;
  -[SKUIContextActionsViewController setContextActionView:](self, "setContextActionView:", v24);
  v26 = 0;
  if (!-[SKUIContextActionsViewController isOrbPresentation](self, "isOrbPresentation"))
  {
    if ((-[SKUIContextActionsViewController _isInPopoverPresentation](self, "_isInPopoverPresentation") & 1) != 0)
    {
      v26 = 0;
    }
    else
    {
      v27 = (void *)MEMORY[0x1E0DC38B8];
      objc_msgSend(MEMORY[0x1E0CB34D0], "bundleForClass:", objc_opt_class());
      v28 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v28, "localizedStringForKey:value:table:", CFSTR("CANCEL"), &stru_1E73A9FB0, 0);
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v27, "actionWithTitle:type:handler:", v29, 1, &__block_literal_global_43);
      ...
      v35 = objc_alloc(MEMORY[0x1E0DC38C8]);
      v36 = (void *)MEMORY[0x1E0DC38C0];
      v160 = v30;
  ...
  v43 = objc_alloc(MEMORY[0x1E0DC3CA8]);
  ...
  v46 = -[SKUIContextActionsViewController _isInPopoverPresentation](self, "_isInPopoverPresentation");
  if ((v46 & 1) == 0)
  {
    -[SKUIContextActionsViewController contextActionView](self, "contextActionView");
  ...
  if (-[SKUIContextActionsViewController hasAppliedSystemRecognizer](self, "hasAppliedSystemRecognizer"))
  {
    -[SKUIContextActionsViewController contextActionView](self, "contextActionView");
  ...
  if ((v46 | -[SKUIContextActionsViewController isOrbPresentation](self, "isOrbPresentation")) == 1)
  {
    -[SKUIContextActionsViewController stackView](self, "stackView");
  ...
  if ((v46 & 1) == 0)
  {
    ...
    -[SKUIContextActionsViewController backgroundView](self, "backgroundView");
  ...
  v157[7] = v112;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v157, 8);
  v113 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v151, "addObjectsFromArray:", v113);

  v114 = (void *)MEMORY[0x1E0CB3718];
  -[SKUIContextActionsViewController constraints](self, "constraints");
...
id __61__SKUIContextActionsViewController__reloadViewsConfiguration__block_invoke(uint64_t a1, uint64_t a2, void *a3, uint64_t a4)
{
  ...
  v6 = a3;
  objc_msgSend(MEMORY[0x1E0DC1358], "defaultFontDescriptorWithTextStyle:", a2);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = v7;
  if (v6)
  {
...
void __61__SKUIContextActionsViewController__reloadViewsConfiguration__block_invoke_2(uint64_t a1, uint64_t a2, _BYTE *a3)
{
  *a3 = 1;
}
...
- (void)interfaceAction:(id)a3 invokeActionHandler:(id)a4 completion:(id)a5
{
  ...
  if (a4)
  {
    ...
    if (v11)
    {
      ...
      v9[3] = &unk_1E73A1618;
      v10 = v8;
      -[SKUIContextActionsViewController dismissViewControllerAnimated:completion:](self, "dismissViewControllerAnimated:completion:", 1, v9);
  ...
  {
    -[SKUIContextActionsViewController dismissViewControllerAnimated:completion:](self, "dismissViewControllerAnimated:completion:", 1, v8);
  }
...
- (id)_transitionPresentationControllerForPresentedViewController:(id)a3 presentingViewController:(id)a4
{
  ...
  id v7;
  void *v8;
  SKUIContextActionsPresentationController *v9;
  void *v10;

  v6 = a3;
  v7 = a4;
  -[SKUIContextActionsViewController transitionPresentationController](self, "transitionPresentationController");
  v8 = (void *)objc_claimAutoreleasedReturnValue();

  if (!v8)
  {
    v9 = -[SKUIContextActionsPresentationController initWithPresentedViewController:presentingViewController:]([SKUIContextActionsPresentationController alloc], "initWithPresentedViewController:presentingViewController:", v6, v7);
    -[SKUIContextActionsViewController setTransitionPresentationController:](self, "setTransitionPresentationController:", v9);
...
{
  SKUIContextActionsViewController *v4;

  if (-[SKUIContextActionsViewController isOrbPresentation](self, "isOrbPresentation", a3))
    v4 = self;
  else
    v4 = 0;
  return v4;
...
- (void)animateTransition:(id)a3
{
  ...
  -[SKUIContextActionsViewController transitionDuration:](self, "transitionDuration:", v4);
  v7 = v6;
  v10 = v4;
