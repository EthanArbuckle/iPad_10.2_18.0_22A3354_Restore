...
- (SKUILoadSortDataOperation)initWithResourceRequest:(id)a3
{
  ...
  {
    -[SKUILoadSortDataOperation initWithResourceRequest:].cold.1();
  }
  v7.receiver = self;
...
- (void)main
{
  ...
  v3 = objc_alloc(MEMORY[0x1E0DAF698]);
  ...
  -[SKUILoadSortDataOperation setUnderlyingOperation:](self, "setUnderlyingOperation:", v6);
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
        ...
        v9 = 0;
      v11 = objc_opt_class();
      SKUIStorePageItemsWithStorePlatformDictionary(v7, v9, v11);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          for (i = 0; i != v15; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              if (v19)
              {
                v30 = v36;
                v31 = v37;
                v22 = -[SKUILockupComponent initWithItem:style:](v20, "initWithItem:style:", v19, &v30);
              }
              else
              {
                ...
                v30 = v36;
                v31 = v37;
                v22 = -[SKUILockupComponent initWithItemIdentifier:style:](v21, "initWithItemIdentifier:style:", v23, &v30);
              }
              v24 = (void *)v22;
...
- (void)cancel
{
  ...
  -[SKUILoadSortDataOperation underlyingOperation](self, "underlyingOperation");
