...
- (SKUIOnboardingInstructionsView)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  SKUIOnboardingInstructionsView *v8;
  SKUIOnboardingInstructionsView *v9;
  uint64_t v10;
  ...
  {
    -[SKUIOnboardingInstructionsView initWithFrame:].cold.1();
  }
  v15.receiver = self;
  ...
  if (v8)
  {
    v10 = -[SKUIOnboardingInstructionsView _newExplanationLabel](v8, "_newExplanationLabel");
    explanationLabel = v9->_explanationLabel;
    v9->_explanationLabel = (UILabel *)v10;

    -[SKUIOnboardingInstructionsView addSubview:](v9, "addSubview:", v9->_explanationLabel);
    v12 = -[SKUIOnboardingInstructionsView _newTitleLabel](v9, "_newTitleLabel");
    titleLabel = v9->_titleLabel;
    v9->_titleLabel = (UILabel *)v12;

    -[SKUIOnboardingInstructionsView addSubview:](v9, "addSubview:", v9->_titleLabel);
  }
  return v9;
}
...
+ (id)explanationAttributedStringWithString:(id)a3
{
  ...
  objc_msgSend(v5, "setObject:forKey:", v6, *MEMORY[0x1E0DC1138]);

  objc_msgSend(MEMORY[0x1E0DC3658], "grayColor");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setObject:forKey:", v7, *MEMORY[0x1E0DC1140]);

  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3778]), "initWithString:attributes:", v4, v5);
  return v8;
}
...
+ (id)titleAttributedStringWithString:(id)a3
{
  ...
  v4 = a3;
  v5 = objc_alloc_init(v3);
  objc_msgSend(MEMORY[0x1E0DC1350], "_ultraLightSystemFontOfSize:", 28.0);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setObject:forKey:", v6, *MEMORY[0x1E0DC1138]);
...
- (void)popLabelState
{
  ...
  if ((unint64_t)-[NSMutableArray count](self->_labelsStack, "count") >= 2)
  {
    ...
    v5 = self->_titleLabel;
    -[SKUIOnboardingInstructionsView backgroundColor](self, "backgroundColor");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setBackgroundColor:](v5, "setBackgroundColor:", v6);

    -[NSMutableArray removeLastObject](self->_labelsStack, "removeLastObject");
    -[SKUIOnboardingInstructionsView addSubview:](self, "addSubview:", self->_titleLabel);
    -[NSMutableArray lastObject](self->_labelsStack, "lastObject");
    ...
    -[NSMutableArray removeLastObject](self->_labelsStack, "removeLastObject");
    -[SKUIOnboardingInstructionsView addSubview:](self, "addSubview:", self->_explanationLabel);
    -[SKUIOnboardingInstructionsView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)pushLabelState
{
  ...
  -[UILabel removeFromSuperview](self->_explanationLabel, "removeFromSuperview");
  -[UILabel removeFromSuperview](self->_titleLabel, "removeFromSuperview");
  v6 = -[SKUIOnboardingInstructionsView _newExplanationLabel](self, "_newExplanationLabel");
  explanationLabel = self->_explanationLabel;
  ...
  -[SKUIOnboardingInstructionsView addSubview:](self, "addSubview:", self->_explanationLabel);
  v10 = -[SKUIOnboardingInstructionsView _newTitleLabel](self, "_newTitleLabel");
  titleLabel = self->_titleLabel;
...
{
  -[SKUIOnboardingInstructionsView setContentPosition:animated:completionBlock:](self, "setContentPosition:animated:completionBlock:", a3, 0, 0);
}
...
- (void)setContentPosition:(int64_t)a3 animated:(BOOL)a4 completionBlock:(id)a5
{
  ...
  else
  {
    ...
    if (a4)
    {
      ...
      v19 = v18;
      v21 = v20;
      -[SKUIOnboardingInstructionsView layoutSubviews](self, "layoutSubviews");
      -[UILabel frame](self->_explanationLabel, "frame");
      v42 = v23;
      v43 = v22;
      v40 = v25;
      ...
      v47[1] = 3221225472;
      v47[2] = __78__SKUIOnboardingInstructionsView_setContentPosition_animated_completionBlock___block_invoke;
      v47[3] = &unk_1E73A2F30;
      v47[4] = self;
      v47[5] = v27;
      v47[6] = v29;
      v47[7] = v31;
      v47[8] = v33;
      objc_msgSend(MEMORY[0x1E0DC3F10], "animateWithDuration:delay:options:animations:completion:", 0, v47, 0, 1.0, 0.0);
      v35 = (void *)MEMORY[0x1E0DC3F10];
      v46[0] = v34;
      v46[1] = 3221225472;
      v46[2] = __78__SKUIOnboardingInstructionsView_setContentPosition_animated_completionBlock___block_invoke_2;
      v46[3] = &unk_1E73A2F30;
      v46[4] = self;
      v46[5] = v43;
      v46[6] = v42;
      ...
      v44[0] = v34;
      v44[1] = 3221225472;
      v44[2] = __78__SKUIOnboardingInstructionsView_setContentPosition_animated_completionBlock___block_invoke_3;
      v44[3] = &unk_1E73A0220;
      v45 = v9;
...
- (void)layoutSubviews
{
  ...
  -[SKUIOnboardingInstructionsView bounds](self, "bounds");
  v4 = v3;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUIOnboardingInstructionsView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
