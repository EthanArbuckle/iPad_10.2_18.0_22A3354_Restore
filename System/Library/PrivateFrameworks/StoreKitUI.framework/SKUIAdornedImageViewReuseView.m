...
- (SKUIAdornedImageViewReuseView)init
{
  ...
  uint64_t v9;
  uint64_t v10;
  SKUIAdornedImageViewReuseView *v11;
  uint64_t v12;
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3)
        -[SKUIAdornedImageViewReuseView init].cold.1(v3, v4, v5, v6, v7, v8, v9, v10);
    }
  }
  v15.receiver = self;
  v15.super_class = (Class)SKUIAdornedImageViewReuseView;
  v11 = -[SKUIAdornedImageViewReuseView init](&v15, sel_init);
  if (v11)
  {
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9)
        +[SKUIAdornedImageViewReuseView prefetchResourcesForViewElement:reason:context:].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  }
  v24 = 0;
  v25 = &v24;
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8)
        +[SKUIAdornedImageViewReuseView preferredSizeForViewElement:context:].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
    }
  }
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  {
    +[SKUIAdornedImageViewReuseView requestLayoutForViewElement:width:context:].cold.1();
  }
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      v9 = os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT);
      if (v9)
        +[SKUIAdornedImageViewReuseView sizeThatFitsWidth:viewElement:context:].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  }
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  id v30;
  id v31;
  SKUIAdornedImageViewReuseView *v32;
  double v33;
  ...
  v29[1] = 3221225472;
  v29[2] = __69__SKUIAdornedImageViewReuseView_reloadWithViewElement_width_context___block_invoke;
  v29[3] = &unk_1E73A1230;
  v28 = v9;
  v30 = v28;
  v33 = a4;
  ...
  v31 = v12;
  v32 = self;
  -[SKUIViewReuseView modifyUsingBlock:](self, "modifyUsingBlock:", v29);
  ...
  if (v14)
  {
    -[SKUIPlayButton playItemIdentifier](v14, "playItemIdentifier");
    ...
    if (v15)
    {
      ...
      {
        v20 = -[SKUIPlayButtonControl isIndeterminate](self->_playButton, "isIndeterminate");
...
LABEL_17:
      ...
      -[SKUIPlayButton reloadWithItemStatus:animated:](v25, "reloadWithItemStatus:animated:", v26, 0);

      v21 = self->_playButton;
      v22 = v24 == 3;
LABEL_16:
      -[SKUIPlayButtonControl showPlayIndicator:](v21, "showPlayIndicator:", v22);
      goto LABEL_17;
    }
  }
LABEL_18:
...
LABEL_29:
        ...
        if (v26)
        {
          ...
          if (!v27)
          {
            v28 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 1);
            v29 = *(_QWORD *)(a1 + 56);
            v30 = *(void **)(v29 + 432);
            *(_QWORD *)(v29 + 432) = v28;
...
- (id)viewForElementIdentifier:(id)a3
{
  ...
  v4 = a3;
  -[SKUIViewElement flattenedChildren](self->_imageViewElement, "flattenedChildren");
...
- (CGRect)frameForView:(id)a3
{
  ...
  if (v38)
    ...
    v15 = 8.0;
  -[SKUIAdornedImageViewReuseView frame](self, "frame");
  ...
  {
    -[SKUIAdornedImageViewReuseView bounds](self, "bounds");
...
- (void)layoutSubviews
{
  ...
  -[SKUIAdornedImageViewReuseView layoutSubviews](&v13, sel_layoutSubviews);
  -[SKUIViewReuseView allExistingViews](self, "allExistingViews");
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        -[SKUIAdornedImageViewReuseView frameForView:](self, "frameForView:", v8);
...
- (void)_buttonAction:(id)a3
{
  ...
  if (self->_playButton == a3)
  {
    ...
    else
    {
      ...
      if (v7)
      {
        if (-[SKUIPlayButtonControl isDisabledButSelectable](self->_playButton, "isDisabledButSelectable"))
        {
          objc_msgSend(v7, "dispatchEvent:eventAttribute:canBubble:isCancelable:extraInfo:completionBlock:", 0x1E73B7150, 0x1E73B7170, 1, 0, 0, 0);
        }
        else
        {
          -[SKUIPlayButton playItemIdentifier](self->_playButton, "playItemIdentifier");
...
- (void)mediaPlayer:(id)a3 itemStateChanged:(id)a4
{
  ...
  _QWORD v13[4];
  id v14;
  SKUIAdornedImageViewReuseView *v15;
  _QWORD block[5];
  id v17;
