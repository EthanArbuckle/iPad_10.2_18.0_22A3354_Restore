...
- (SKUINavigationBarButtonsController)initWithNavigationBarViewElement:(id)a3
{
  ...
  {
    -[SKUINavigationBarButtonsController initWithNavigationBarViewElement:].cold.1();
  }
  v9.receiver = self;
  v9.super_class = (Class)SKUINavigationBarButtonsController;
  v6 = -[SKUINavigationBarButtonsController init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (void)dealloc
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUINavigationBarButtonsController;
  -[SKUINavigationBarSectionController dealloc](&v9, sel_dealloc);
}
...
- (id)addButtonItemWithButtonViewElement:(id)a3
{
  ...
  {
    v6 = objc_alloc_init(SKUIItemOfferButton);
    -[SKUIItemOfferButton addTarget:action:forControlEvents:](v6, "addTarget:action:forControlEvents:", self, sel__cancelConfirmationAction_, 0x10000);
    -[SKUIItemOfferButton addTarget:action:forControlEvents:](v6, "addTarget:action:forControlEvents:", self, sel__itemOfferAction_, 0x20000);
    -[SKUIItemOfferButton addTarget:action:forControlEvents:](v6, "addTarget:action:forControlEvents:", self, sel__showConfirmationAction_, 0x40000);
    objc_msgSend(MEMORY[0x1E0DC3658], "clearColor");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIItemOfferButton setBackgroundColor:](v6, "setBackgroundColor:", v7);

    -[SKUIItemOfferButton setDelegate:](v6, "setDelegate:", self);
    -[SKUINavigationBarButtonsController _updateItemOfferButton:withButtonViewElement:](self, "_updateItemOfferButton:withButtonViewElement:", v6, v4);
  ...
  else
  {
    ...
    -[SKUINavigationBarButtonsController _updateButtonItem:withButtonViewElement:](self, "_updateButtonItem:withButtonViewElement:", v5, v4);
  }
  buttonItemElements = self->_buttonItemElements;
  if (!buttonItemElements)
  {
    v9 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 512, 512, 0);
  ...
  if (v12)
  {
    ...
    {
      v14 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 517, 512, 1);
...
- (void)reloadAfterDocumentUpdateWithNavigationItem:(id)a3
{
  ...
  v11 = v8;
  v38 = v11;
  -[SKUIViewElement enumerateChildrenUsingBlock:](navigationBarElement, "enumerateChildrenUsingBlock:", v36);
  v12 = 0;
  v26 = (void *)v6;
  v27 = (void *)v5;
  v40[0] = v5;
...
LABEL_4:
      ...
      while (1)
      {
        ...
        if (v21)
        {
          ...
          -[SKUINavigationBarButtonsController _reloadButtonItem:withButtonViewElement:](self, "_reloadButtonItem:withButtonViewElement:", v20, v23);
  ...
  -[SKUINavigationBarSectionController reloadAfterDocumentUpdateWithNavigationItem:](&v31, sel_reloadAfterDocumentUpdateWithNavigationItem_, v28);

}

void __82__SKUINavigationBarButtonsController_reloadAfterDocumentUpdateWithNavigationItem___block_invoke(uint64_t a1, void *a2)
{
  _BOOL4 IsButton;
  void *v4;
  void *v5;
  ...
  v7 = a2;
  IsButton = SKUIIKViewElementTypeIsButton(objc_msgSend(v7, "elementType"));
  v4 = v7;
  if (IsButton)
  {
...
- (UIEdgeInsets)_imageInsetsForImageViewElement:(id)a3
{
  ...
  v12 = v7;
  v13 = v8;
  if (v10 == *(double *)(MEMORY[0x1E0DC49E8] + 8)
    ...
    && v7 == *(double *)(MEMORY[0x1E0DC49E8] + 16))
  {
    ...
    if (v18)
    {
      ...
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      v21 = SKUIUserInterfaceIdiom(v20);
...
- (void)_reloadButtonItem:(id)a3 withButtonViewElement:(id)a4
{
  ...
  if (objc_msgSend(v6, "updateType"))
  {
    if (objc_msgSend(v6, "buttonViewType") == 2)
    {
      ...
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUINavigationBarButtonsController _updateItemOfferButton:withButtonViewElement:](self, "_updateItemOfferButton:withButtonViewElement:", v7, v6);

    }
    else
    {
      -[SKUINavigationBarButtonsController _updateButtonItem:withButtonViewElement:](self, "_updateButtonItem:withButtonViewElement:", v8, v6);
    }
  }
...
- (void)_updateButtonItem:(id)a3 withButtonViewElement:(id)a4
{
  ...
  if (v7)
  {
    ...
    -[SKUINavigationBarButtonsController _imageForImageViewElement:](self, "_imageForImageViewElement:", v7);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "setImage:", v9);

    -[SKUINavigationBarButtonsController _imageInsetsForImageViewElement:](self, "_imageInsetsForImageViewElement:", v7);
