...
{
  id v5;
  SKUIRedeemIdValidateOperation *v6;
  SKUIRedeemIdValidateOperation *v7;
  objc_super v9;
  ...
  {
    -[SKUIRedeemIdValidateOperation initWithDictionary:].cold.1();
  }
  v9.receiver = self;
  v9.super_class = (Class)SKUIRedeemIdValidateOperation;
  v6 = -[SKUIRedeemIdValidateOperation init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (void)main
{
  ...
  -[SKUIRedeemIdValidateOperation _subOperation](self, "_subOperation");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = 0;
  v4 = -[SKUIRedeemIdValidateOperation runSubOperation:returningError:](self, "runSubOperation:returningError:", v3, &v16);
  v5 = (unint64_t)v16;
  if (!v4)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Underlying sub-operation for '%@' failed."), CFSTR("redeemValidateIdUrl"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIRedeemIdValidateOperation _logResultsForSuccess:failureReason:failureMessage:error:](self, "_logResultsForSuccess:failureReason:failureMessage:error:", 0, v9, 0, v5);
    v10 = 0;
    goto LABEL_14;
  }
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unuccessful operation. We did not have a valid %@ flag in the response."), CFSTR("validNationalId"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = 0;
  }
  v11 = 0;
LABEL_12:
  ...
  -[SKUIRedeemIdValidateOperation _logResultsForSuccess:failureReason:failureMessage:error:](self, "_logResultsForSuccess:failureReason:failureMessage:error:", v11, v9, v10, v5);
  if ((v11 & 1) != 0)
  {
    v13 = 1;
LABEL_17:
...
LABEL_14:
  ...
  -[SKUIRedeemIdValidateOperation _handleFailure:serverDialogDictionary:](self, "_handleFailure:serverDialogDictionary:", v5, v10);
LABEL_18:
...
- (void)_handleFailure:(id)a3 serverDialogDictionary:(id)a4
{
  ...
  if (v8)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DDC160]), "initWithDialogDictionary:", v8);
    objc_msgSend(MEMORY[0x1E0DDC168], "operationWithDialog:", v6);
    v7 = (void *)objc_claimAutoreleasedReturnValue();

  }
  else
  {
    objc_msgSend(MEMORY[0x1E0DDC168], "operationWithError:", a3);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  }
  objc_msgSend(v7, "setDelegate:", self);
  -[SKUIRedeemIdValidateOperation runSubOperation:returningError:](self, "runSubOperation:returningError:", v7, 0);
...
- (id)_subOperation
{
  ...
  v4 = objc_alloc_init(MEMORY[0x1E0DAF5C8]);
  ...
  -[SKUIRedeemIdValidateOperation dictionary](self, "dictionary");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0DDC1A8], "provider");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
