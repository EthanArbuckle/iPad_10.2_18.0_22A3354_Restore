...
- (SKUIExploreDocumentViewController)initWithTemplateElement:(id)a3
{
  ...
  uint64_t v12;
  uint64_t v13;
  SKUIExploreDocumentViewController *v14;
  SKUIExploreDocumentViewController *v15;
  SKUIMetricsImpressionSession *v16;
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v6)
        -[SKUIExploreDocumentViewController initWithTemplateElement:].cold.1(v6, v7, v8, v9, v10, v11, v12, v13);
    }
  }
  v19.receiver = self;
  v19.super_class = (Class)SKUIExploreDocumentViewController;
  v14 = -[SKUIExploreDocumentViewController init](&v19, sel_init);
  v15 = v14;
  if (v14)
  {
    objc_storeStrong((id *)&v14->_exploreTemplate, a3);
    v16 = objc_alloc_init(SKUIMetricsImpressionSession);
    activeMetricsImpressionSession = v15->_activeMetricsImpressionSession;
    v15->_activeMetricsImpressionSession = v16;
...
{
  return !-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits");
}
...
- (void)setClientContext:(id)a3
{
  ...
  v4 = a3;
  -[SKUIViewController setClientContext:](&v5, sel_setClientContext_, v4);
...
+ (BOOL)_shouldForwardViewWillTransitionToSize
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v2)
        +[SKUIExploreDocumentViewController _shouldForwardViewWillTransitionToSize].cold.1(v2, v3, v4, v5, v6, v7, v8, v9);
    }
  }
  return 1;
}
...
- (void)loadView
{
  SKUIContentInsetScrollView *v3;
  SKUIContentInsetScrollView *contentScrollView;
  void *v5;
  id v6;

  v6 = objc_alloc_init(MEMORY[0x1E0DC3F10]);
  -[SKUIExploreDocumentViewController setView:](self, "setView:", v6);
  -[SKUIExploreDocumentViewController _updateChildViewControllers](self, "_updateChildViewControllers");
  ...
  objc_msgSend(v5, "addObserver:selector:name:object:", self, sel__contentInsetDidChange_, 0x1E73B46D0, self->_contentScrollView);

  if (-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits"))
  {
    -[SKUIExploreDocumentViewController _reloadLeftViewControllers](self, "_reloadLeftViewControllers");
    -[SKUIExploreDocumentViewController _reloadRightViewController](self, "_reloadRightViewController");
  }
  else
  {
    -[SKUIExploreDocumentViewController _reloadData](self, "_reloadData");
  }
...
- (CGSize)sizeForChildContentContainer:(id)a3 withParentContainerSize:(CGSize)a4
{
  ...
  else
  {
    ...
    -[SKUIExploreDocumentViewController sizeForChildContentContainer:withParentContainerSize:](&v13, sel_sizeForChildContentContainer_withParentContainerSize_, a4.width, a4.height);
    height = v8;
  }
  v12 = height;
  result.height = v12;
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SKUIExploreDocumentViewController navigationController](self, "navigationController");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setNavigationBarHidden:animated:", 0, v3);

  -[SKUIExploreDocumentViewController _endAllPendingActiveImpression](self, "_endAllPendingActiveImpression");
  v6.receiver = self;
  v6.super_class = (Class)SKUIExploreDocumentViewController;
  -[SKUIExploreDocumentViewController viewWillDisappear:](&v6, sel_viewWillDisappear_, v3);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[SKUIExploreDocumentViewController _beginActiveImpressionsForImpressionableViewElements](self, "_beginActiveImpressionsForImpressionableViewElements");
  v6.receiver = self;
  v6.super_class = (Class)SKUIExploreDocumentViewController;
  -[SKUIViewController viewWillAppear:](&v6, sel_viewWillAppear_, v3);
}
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "postNotificationName:object:", CFSTR("SKUIApplicationPageDidDisplayNotification"), self);

  v6.receiver = self;
  v6.super_class = (Class)SKUIExploreDocumentViewController;
  -[SKUIExploreDocumentViewController viewDidAppear:](&v6, sel_viewDidAppear_, v3);
}
...
- (void)documentDidUpdate:(id)a3
{
  id v4;
  void *v5;
  SKUIExploreTemplateElement *v6;
  SKUIExploreTemplateElement *exploreTemplate;
  _BOOL8 v8;
  NSArray *v9;
  void *v10;
  uint64_t v11;
  ...
  NSArray *v22;
  SKUIExploreTemplateElement *v23;
  SKUIExploreTemplateElement *v24;
  void *v25;
  void *v26;
  void *v27;
  _BOOL4 IsDescendent;
  ...
  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "postNotificationName:object:", CFSTR("SKUIApplicationPageDidUpdateNotification"), self);

  objc_msgSend(v4, "templateElement");
  v6 = (SKUIExploreTemplateElement *)objc_claimAutoreleasedReturnValue();
  exploreTemplate = self->_exploreTemplate;
  self->_exploreTemplate = v6;

  -[SKUIExploreDocumentViewController _updateChildViewControllers](self, "_updateChildViewControllers");
  v8 = -[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits");
  if (v8)
  {
    v32 = v4;
    ...
    v23 = (SKUIExploreTemplateElement *)objc_claimAutoreleasedReturnValue();
    ...
    -[SKUIExploreDocumentViewController _reloadSelectionForViewController:](self, "_reloadSelectionForViewController:", v25);
  }
  else
  {
    -[SKUIExploreDocumentViewController _reloadData](self, "_reloadData");
  ...
  if (IsDescendent)
  {
    if (v8)
    {
      +[SKUINavigationControllerAssistant existingAssistantForNavigationController:](SKUINavigationControllerAssistant, "existingAssistantForNavigationController:", v26);
...
- (void)documentMediaQueriesDidUpdate:(id)a3
{
  ...
  objc_msgSend(v4, "enumerateObjectsUsingBlock:", &__block_literal_global_12);

  -[SKUIStorePageSectionsViewController invalidateAndReload](self->_rightVC, "invalidateAndReload");
}
...
- (void)_updateChildViewControllers
{
  ...
  SKUIStorePageSectionsViewController *rightVC;
  SKUIStorePageSectionsViewController *v7;
  void *v8;
  SKUIStorePageSectionsViewController *v9;
  void *v10;
  ...
  SKUIStorePageSectionsViewController *v16;
  void *v17;
  void *v18;
  void *v19;
  void *v20;
  ...
  SKUIStorePageSectionsViewController *v33;
  _QWORD v34[3];
  ...
  if (-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits"))
  {
    if (!self->_splitVC)
    {
      v3 = (UINavigationController *)objc_alloc_init(MEMORY[0x1E0DC3A40]);
      leftVC = self->_leftVC;
      self->_leftVC = v3;
      ...
      v5 = -[SKUIStorePageSectionsViewController initWithLayoutStyle:]([SKUIStorePageSectionsViewController alloc], "initWithLayoutStyle:", 2);
      ...
      -[SKUIViewController setClientContext:](v7, "setClientContext:", v8);

      v9 = self->_rightVC;
      -[SKUIViewController operationQueue](self, "operationQueue");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      -[SKUIViewController setOperationQueue:](v9, "setOperationQueue:", v10);

      -[SKUIStorePageSectionsViewController setActiveMetricsImpressionSession:](self->_rightVC, "setActiveMetricsImpressionSession:", self->_activeMetricsImpressionSession);
      v11 = (UISplitViewController *)objc_alloc_init(MEMORY[0x1E0DC3C90]);
      splitVC = self->_splitVC;
      self->_splitVC = v11;

      v13 = self->_splitVC;
      -[SKUIExploreDocumentViewController _leftColumnWidth](self, "_leftColumnWidth");
      ...
      -[SKUIExploreDocumentViewController addChildViewController:](self, "addChildViewController:", self->_splitVC);
      -[UISplitViewController view](self->_splitVC, "view");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "setAutoresizingMask:", 18);
      -[SKUIExploreDocumentViewController view](self, "view");
    ...
    if (navigationController)
    {
      ...
      -[SKUIExploreDocumentViewController removeChildViewController:](self, "removeChildViewController:", self->_navigationController);
  ...
  else
  {
    ...
    {
      v24 = (UINavigationController *)objc_alloc_init(MEMORY[0x1E0DC3A40]);
      ...
      -[SKUIExploreDocumentViewController addChildViewController:](self, "addChildViewController:", self->_navigationController);
      -[UINavigationController view](self->_navigationController, "view");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v29)
    {
      ...
      -[SKUIExploreDocumentViewController removeChildViewController:](self, "removeChildViewController:", self->_splitVC);
...
- (id)impressionableViewElements
{
  ...
  if (-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits"))
  {
    ...
    -[SKUIStorePageSectionsViewController _impressionableViewElements](self->_rightVC, "_impressionableViewElements");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = v5;
    if (v5)
    {
...
- (void)navigationController:(id)a3 didShowViewController:(id)a4 animated:(BOOL)a5
{
  ...
  if (self->_leftVC == v20)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUIContentInsetScrollView scrollIndicatorInsets](self->_contentScrollView, "scrollIndicatorInsets");
  ...
  if (self->_leftVC != v10)
  {
    ...
    if (a4 == 1)
    {
      ...
      if (v19 != v12)
        goto LABEL_13;
      v21 = 0;
      -[SKUIExploreDocumentViewController _getPageComponents:title:forViewControllerAtIndex:](self, "_getPageComponents:title:forViewControllerAtIndex:", 0, &v21, 0);
      v16 = v21;
      v17 = v11;
    }
    else
    {
      ...
      if (v15 != v12)
        goto LABEL_13;
      -[SKUIExploreDocumentViewController _rootNavigationTitle](self, "_rootNavigationTitle");
...
LABEL_13:
        SKUIStackedBarNavAnimationController(v10, a4, v11, v12);
        v18 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)stackedBar:(id)a3 didSelectItemAtIndex:(int64_t)a4
{
  ...
  {
    -[SKUIExploreTemplateElement childViewElements](self->_exploreTemplate, "childViewElements", a3);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = objc_msgSend(v6, "count");

    if (v7 > a4)
    {
      -[SKUIExploreTemplateElement childViewElements](self->_exploreTemplate, "childViewElements");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)navigationController:(id)a3 willShowViewController:(id)a4 animated:(BOOL)a5
{
  ...
  if (self->_leftVC == v20)
  {
    ...
    -[SKUIExploreDocumentViewController _reloadSelectionForViewController:](self, "_reloadSelectionForViewController:", v7);
    -[UINavigationController viewControllers](v20, "viewControllers");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = objc_msgSend(v13, "indexOfObject:", v7);
...
- (void)_contentInsetDidChange:(id)a3
{
  ...
  if (-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits", a3))
  {
    -[UINavigationController viewControllers](self->_leftVC, "viewControllers");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v7 = (id)-[SKUIStorePageSectionsViewController view](self->_rightVC, "view");
    -[SKUIContentInsetScrollView scrollIndicatorInsets](self->_contentScrollView, "scrollIndicatorInsets");
    v9 = v8;
    v11 = v10;
    v13 = v12;
    v15 = v14;
    -[SKUIStorePageSectionsViewController contentScrollView](self->_rightVC, "contentScrollView");
...
- (id)_rootNavigationTitle
{
  ...
  v11 = 0;
  -[SKUIExploreTemplateElement navigationBarElement](self->_exploreTemplate, "navigationBarElement");
...
void __57__SKUIExploreDocumentViewController__rootNavigationTitle__block_invoke(uint64_t a1, void *a2)
{
  char isKindOfClass;
  void *v4;
  id v5;
...
- (void)_getPageComponents:(id *)a3 title:(id *)a4 forViewControllerAtIndex:(int64_t)a5
{
  ...
  -[SKUIExploreDocumentViewController _pageComponentsAtIndex:](self, "_pageComponentsAtIndex:", a5);
...
- (id)_newSectionsViewControllerAtIndex:(int64_t)a3
{
  ...
  v13 = 0;
  v14 = 0;
  -[SKUIExploreDocumentViewController _getPageComponents:title:forViewControllerAtIndex:](self, "_getPageComponents:title:forViewControllerAtIndex:", &v14, &v13, a3);
  v5 = v14;
  v6 = v13;
  v7 = objc_alloc_init(SKUIStackedBar);
  -[SKUIStackedBar setDelegate:](v7, "setDelegate:", self);
  -[SKUIStackedBar setSplitViewStyle:](v7, "setSplitViewStyle:", -[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits"));
  if (-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits"))
    -[SKUIStackedBar setZeroHeightWhenFirstChildExpanded:](v7, "setZeroHeightWhenFirstChildExpanded:", a3 == 0);
  if (-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits"))
    v8 = 2;
  else
    v8 = 0;
  v9 = -[SKUIStorePageSectionsViewController initWithLayoutStyle:]([SKUIStorePageSectionsViewController alloc], "initWithLayoutStyle:", v8);
  -[SKUIViewController clientContext](self, "clientContext");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewController setClientContext:](v9, "setClientContext:", v10);

  -[SKUIViewController operationQueue](self, "operationQueue");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewController setOperationQueue:](v9, "setOperationQueue:", v11);

  -[SKUIStorePageSectionsViewController setSectionsWithPageComponents:](v9, "setSectionsWithPageComponents:", v5);
  -[SKUIStorePageSectionsViewController setSKUIStackedBar:](v9, "setSKUIStackedBar:", v7);
  if (-[SKUIExploreTemplateElement usesSplits](self->_exploreTemplate, "usesSplits"))
    -[SKUIStorePageSectionsViewController setAutomaticallyAdjustsScrollViewInsets:](v9, "setAutomaticallyAdjustsScrollViewInsets:", 0);
  -[SKUIStorePageSectionsViewController setTitle:](v9, "setTitle:", v6);
  -[SKUIStorePageSectionsViewController setActiveMetricsImpressionSession:](v9, "setActiveMetricsImpressionSession:", self->_activeMetricsImpressionSession);
...
void __60__SKUIExploreDocumentViewController__pageComponentsAtIndex___block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = a2;
  v3 = (objc_class *)SKUIPageComponentClassForComponentType(objc_msgSend(v5, "pageComponentType"));
  if (v3)
  {
...
- (void)_reloadData
{
  ...
  if (!self->_locationManager)
  {
    ...
    objc_opt_class();
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    self->_nearMeEnabled = SKUINearMeIsEnabledForAuthorizationStatus(objc_msgSend(v6, "authorizationStatus"));
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      {
        v14 = -[SKUIExploreDocumentViewController _newSectionsViewControllerAtIndex:](self, "_newSectionsViewControllerAtIndex:", v11);
      }
      else
      {
        v23 = 0;
        v24 = 0;
        -[SKUIExploreDocumentViewController _getPageComponents:title:forViewControllerAtIndex:](self, "_getPageComponents:title:forViewControllerAtIndex:", &v24, &v23, v11);
        v12 = v24;
        v13 = v23;
...
- (void)_reloadLeftViewControllers
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      {
        v10 = -[SKUIExploreDocumentViewController _newSectionsViewControllerAtIndex:](self, "_newSectionsViewControllerAtIndex:", v7);
      }
      else
      {
        v16 = 0;
        v17 = 0;
        -[SKUIExploreDocumentViewController _getPageComponents:title:forViewControllerAtIndex:](self, "_getPageComponents:title:forViewControllerAtIndex:", &v17, &v16, v7);
        v8 = v17;
        v9 = v16;
...
- (void)_reloadRightViewController
{
  ...
  rightVC = self->_rightVC;
  -[SKUIExploreDocumentViewController _rightPageComponents](self, "_rightPageComponents");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionsViewController setSectionsWithPageComponents:](rightVC, "setSectionsWithPageComponents:", v8);

  -[SKUIExploreDocumentViewController _rightVCColorScheme](self, "_rightVCColorScheme");
  v9 = (id)objc_claimAutoreleasedReturnValue();
  -[SKUIStorePageSectionsViewController setColorScheme:](self->_rightVC, "setColorScheme:", v9);
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        v15 = (objc_class *)SKUIPageComponentClassForComponentType(objc_msgSend(v14, "pageComponentType"));
        if (v15)
        {
...
- (id)_rightPageComponents
{
  ...
  -[SKUIExploreTemplateElement rightSplit](self->_exploreTemplate, "rightSplit");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_rightVCColorScheme
{
  ...
  if (v5)
  {
    ...
    -[SKUIColorScheme setBackgroundColor:](v6, "setBackgroundColor:", v5);
  }
  else
  {
    v6 = 0;
...
- (void)_beginActiveImpressionsForImpressionableViewElements
{
  ...
  -[SKUIExploreDocumentViewController impressionableViewElements](self, "impressionableViewElements");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = 0u;
  v9 = 0u;
  v10 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIMetricsImpressionSession beginActiveImpressionForViewElement:](self->_activeMetricsImpressionSession, "beginActiveImpressionForViewElement:", *(_QWORD *)(*((_QWORD *)&v8 + 1) + 8 * v7++));
      }
      while (v5 != v7);
...
{
  -[SKUIMetricsImpressionSession endAllPendingActiveImpression](self->_activeMetricsImpressionSession, "endAllPendingActiveImpression");
}
