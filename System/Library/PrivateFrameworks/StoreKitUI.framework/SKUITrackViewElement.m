...
- (SKUITrackViewElement)initWithDOMElement:(id)a3 parent:(id)a4 elementFactory:(id)a5
{
  ...
  {
    -[SKUITrackViewElement initWithDOMElement:parent:elementFactory:].cold.1();
  }
  v16.receiver = self;
...
- (SKUIActionsViewElement)swipeActions
{
  ...
  v11 = 0;
  -[SKUITrackViewElement children](self, "children");
...
- (void)enumerateChildrenUsingBlock:(id)a3
{
  ...
  v6[1] = 3221225472;
  v6[2] = __52__SKUITrackViewElement_enumerateChildrenUsingBlock___block_invoke;
  v6[3] = &unk_1E73A1F80;
  v7 = a3;
  v5.receiver = self;
  v5.super_class = (Class)SKUITrackViewElement;
