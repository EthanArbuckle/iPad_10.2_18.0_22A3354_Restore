...
- (SKUICrossFadingTabBarButton)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  SKUICrossFadingTabBarButton *v8;
  UILabel *v9;
  ...
  {
    -[SKUICrossFadingTabBarButton initWithFrame:].cold.1();
  }
  v27.receiver = self;
  ...
  if (v8)
  {
    ...
    -[UILabel setOpaque:](v8->_standardTitleLabel, "setOpaque:", 0);
    v13 = v8->_standardTitleLabel;
    objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.57254902, 1.0);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setTextColor:](v13, "setTextColor:", v14);

    -[UILabel setBackgroundColor:](v8->_standardTitleLabel, "setBackgroundColor:", 0);
    -[SKUICrossFadingTabBarButton addSubview:](v8, "addSubview:", v8->_standardTitleLabel);
    v15 = (UILabel *)objc_alloc_init(MEMORY[0x1E0DC3990]);
    selectedTitleLabel = v8->_selectedTitleLabel;
    v8->_selectedTitleLabel = v15;

    -[UILabel setAlpha:](v8->_selectedTitleLabel, "setAlpha:", 0.0);
    v17 = v8->_selectedTitleLabel;
    objc_msgSend(MEMORY[0x1E0DC1350], "systemFontOfSize:", 10.0);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setFont:](v17, "setFont:", v18);

    -[UILabel setOpaque:](v8->_selectedTitleLabel, "setOpaque:", 0);
    v19 = v8->_selectedTitleLabel;
    -[SKUICrossFadingTabBarButton tintColor](v8, "tintColor");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setTextColor:](v19, "setTextColor:", v20);

    -[UILabel setBackgroundColor:](v8->_selectedTitleLabel, "setBackgroundColor:", 0);
    -[SKUICrossFadingTabBarButton addSubview:](v8, "addSubview:", v8->_selectedTitleLabel);
    -[UILabel setAdjustsLetterSpacingToFitWidth:](v8->_standardTitleLabel, "setAdjustsLetterSpacingToFitWidth:", 1);
    -[UILabel setAdjustsLetterSpacingToFitWidth:](v8->_selectedTitleLabel, "setAdjustsLetterSpacingToFitWidth:", 1);
    v21 = (UIImageView *)objc_alloc_init(MEMORY[0x1E0DC3890]);
    standardImageView = v8->_standardImageView;
    v8->_standardImageView = v21;

    -[SKUICrossFadingTabBarButton addSubview:](v8, "addSubview:", v8->_standardImageView);
    v23 = (UIImageView *)objc_alloc_init(MEMORY[0x1E0DC3890]);
    selectedImageView = v8->_selectedImageView;
    v8->_selectedImageView = v23;

    -[UIImageView setAlpha:](v8->_selectedImageView, "setAlpha:", 0.0);
    -[SKUICrossFadingTabBarButton addSubview:](v8, "addSubview:", v8->_selectedImageView);
    -[UILabel _setDrawsAsBackdropOverlayWithBlendMode:](v8->_standardTitleLabel, "_setDrawsAsBackdropOverlayWithBlendMode:", 1);
    -[UIImageView _setDrawsAsBackdropOverlayWithBlendMode:](v8->_standardImageView, "_setDrawsAsBackdropOverlayWithBlendMode:", 1);
    -[SKUICrossFadingTabBarButton layer](v8, "layer");
...
- (void)layoutSubviews
{
  ...
  -[SKUICrossFadingTabBarButton layoutSubviews](&v41, sel_layoutSubviews);
  -[SKUICrossFadingTabBarButton bounds](self, "bounds");
...
- (void)tintColorDidChange
{
  ...
  -[SKUICrossFadingTabBarButton tintColorDidChange](&v6, sel_tintColorDidChange);
  -[SKUICrossFadingTabBarButton tintColor](self, "tintColor");
...
- (void)setTitle:(id)a3
{
  ...
  if (self->_title != a3)
  {
    ...
    -[SKUICrossFadingTabBarButton setNeedsLayout](self, "setNeedsLayout");
  }
}
...
LABEL_10:
  ...
  else
  {
    ...
    -[SKUICrossFadingTabBarButton addSubview:](self, "addSubview:", self->_badge);
  }
  -[SKUICrossFadingTabBarButton _positionBadge](self, "_positionBadge");
LABEL_11:
...
- (void)_positionBadge
{
  ...
  -[SKUICrossFadingTabBarButton superview](self, "superview");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  badge = self->_badge;
  if (badge)
    v5 = v3 == 0;
  ...
  if (!v5)
  {
    ...
    -[SKUICrossFadingTabBarButton superview](self, "superview");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKUICrossFadingTabBarButton convertPoint:fromView:](self, "convertPoint:fromView:", v12, *MEMORY[0x1E0C9D538], *(double *)(MEMORY[0x1E0C9D538] + 8));
    v14 = v13 + 3.0;
    ...
    -[SKUICrossFadingTabBarButton convertPoint:fromView:](self, "convertPoint:fromView:", v19, CGRectGetMaxX(v21) + -0.5, 0.0);
    UIRoundToViewScale();
    v18 = v17;
    v22.origin.x = v7;
    v22.origin.y = v14;
