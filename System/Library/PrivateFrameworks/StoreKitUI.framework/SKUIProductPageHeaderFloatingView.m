...
- (SKUIProductPageHeaderFloatingView)initWithSectionTitles:(id)a3 isPad:(BOOL)a4
{
  ...
  {
    -[SKUIProductPageHeaderFloatingView initWithSectionTitles:isPad:].cold.1();
  }
  v19.receiver = self;
  v19.super_class = (Class)SKUIProductPageHeaderFloatingView;
  v7 = -[SKUIProductPageHeaderFloatingView initWithFrame:](&v19, sel_initWithFrame_, *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
  if (v7)
  {
    v8 = -[SKUIProductPageSegmentedControl initWithItems:]([SKUIProductPageSegmentedControl alloc], "initWithItems:", v6);
    ...
    -[SKUIProductPageHeaderFloatingView addSubview:](v7, "addSubview:", v7->_sectionControl);
    ...
    {
      objc_msgSend(MEMORY[0x1E0DC3658], "colorWithWhite:alpha:", 0.70588237, 1.0);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      -[UIView setBackgroundColor:](v15, "setBackgroundColor:", v17);

    }
    -[SKUIProductPageHeaderFloatingView addSubview:](v7, "addSubview:", v7->_separatorView);
    v7->_isPad = a4;
    -[SKUIProductPageHeaderFloatingView _reloadBackdropView](v7, "_reloadBackdropView");
  }
...
- (void)setBackdropAlpha:(double)a3
{
  ...
  -[SKUIProductPageHeaderFloatingView backdropAlpha](self, "backdropAlpha");
  if (v5 != a3)
...
- (void)setColorScheme:(id)a3
{
  ...
  if (self->_colorScheme != v5)
  {
    ...
    -[SKUIProductPageHeaderFloatingView _reloadBackdropView](self, "_reloadBackdropView");
    v5 = v13;
  }
...
- (void)layoutSubviews
{
  ...
  -[SKUIProductPageHeaderFloatingView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
...
- (void)_reloadBackdropView
{
  ...
  if (!self->_colorScheme && !self->_isPad)
  {
    ...
    {
      v7 = (_UIBackdropView *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC4028]), "initWithPrivateStyle:", 10060);
      backdropView = self->_backdropView;
      self->_backdropView = v7;

      -[SKUIProductPageHeaderFloatingView insertSubview:atIndex:](self, "insertSubview:atIndex:", self->_backdropView, 0);
    }
    if (!self->_backdropAlphaView)
    {
      ...
      -[SKUIProductPageHeaderFloatingView insertSubview:atIndex:](self, "insertSubview:atIndex:", self->_backdropAlphaView, 1);
    }
  ...
  {
LABEL_13:
    -[SKUIProductPageHeaderFloatingView setBackgroundColor:](self, "setBackgroundColor:", v5);
    goto LABEL_14;
  }
  objc_msgSend(MEMORY[0x1E0DC3658], "whiteColor");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIProductPageHeaderFloatingView setBackgroundColor:](self, "setBackgroundColor:", v6);

LABEL_14:
  -[SKUIProductPageHeaderFloatingView setNeedsLayout](self, "setNeedsLayout");
}
