...
{
  id v4;
  SKUIDynamicGridViewElementPageSection *v5;
  SKUIMutableIntegerValue *v6;
  SKUIMutableIntegerValue *reusableGlobalIndexIntegerValue;
  SKUIGridViewElementPageSectionConfiguration *v8;
  SKUIGridViewElementPageSectionConfiguration *configuration;
  objc_super v11;
  ...
  {
    -[SKUIDynamicGridViewElementPageSection initWithPageComponent:].cold.1();
  }
  v11.receiver = self;
  ...
  if (v5)
  {
    ...
    -[SKUIGridViewElementPageSectionConfiguration setDataSource:](v5->_configuration, "setDataSource:", v5);
    -[SKUIDynamicGridViewElementPageSection _reloadViewElementProperties](v5, "_reloadViewElementProperties");
  }
...
- (int64_t)applyUpdateType:(int64_t)a3
{
  ...
  result = -[SKUIStorePageSection applyUpdateType:](&v9, sel_applyUpdateType_, a3);
  if (result != 2)
  {
    v5 = result;
    v6 = -[SKUIGridViewElementPageSectionConfiguration showsEditMode](self->_configuration, "showsEditMode");
    v7 = -[SKUIDynamicPageSectionIndexMapper totalNumberOfEntities](self->_dynamicPageSectionIndexMapper, "totalNumberOfEntities");
    -[SKUIDynamicGridViewElementPageSection _reloadViewElementProperties](self, "_reloadViewElementProperties");
    -[SKUIDynamicGridViewElementPageSection _invalidateCellSizeCache](self, "_invalidateCellSizeCache");
    if (v6 == -[SKUIGridViewElementPageSectionConfiguration showsEditMode](self->_configuration, "showsEditMode")
      || v7 != -[SKUIDynamicPageSectionIndexMapper totalNumberOfEntities](self->_dynamicPageSectionIndexMapper, "totalNumberOfEntities"))
    {
      v8.receiver = self;
      v8.super_class = (Class)SKUIDynamicGridViewElementPageSection;
      return -[SKUIStorePageSection applyUpdateType:](&v8, sel_applyUpdateType_, v5);
    }
    else
    {
      -[SKUIDynamicGridViewElementPageSection _resetLayoutProperties](self, "_resetLayoutProperties");
      return 1;
    }
  }
  return result;
...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  v4 = a3;
  -[SKUIDynamicGridViewElementPageSection _viewElementAtGlobalIndex:](self, "_viewElementAtGlobalIndex:", objc_msgSend(v4, "item"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v5
    || (-[SKUIGridViewElementPageSectionConfiguration backgroundColorForViewElement:](self->_configuration, "backgroundColorForViewElement:", v5), (v6 = (void *)objc_claimAutoreleasedReturnValue()) == 0))
  {
    v8.receiver = self;
    v8.super_class = (Class)SKUIDynamicGridViewElementPageSection;
    -[SKUIStorePageSection backgroundColorForIndexPath:](&v8, sel_backgroundColorForIndexPath_, v4);
...
- (id)cellForIndexPath:(id)a3
{
  ...
  if (v5)
  {
    -[SKUIGridViewElementPageSectionConfiguration requestCellLayoutForViewElement:](self->_configuration, "requestCellLayoutForViewElement:", v5);
    -[SKUIViewElementLayoutContext labelLayoutCache](self->_cellLayoutContext, "labelLayoutCache");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "layoutCache");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "commitLayoutRequests");

    -[SKUIGridViewElementPageSectionConfiguration cellForViewElement:indexPath:](self->_configuration, "cellForViewElement:indexPath:", v5, v4);
...
- (id)_templateViewElementsForType:(id)a3 mode:(id)a4
{
  ...
  if (!v9)
  {
    objc_msgSend(-[SKUIDynamicGridViewElementPageSection _dynamicGridViewElement](self, "_dynamicGridViewElement"), "templateDefinitionViewElementsForType:mode:", a3, a4);
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  _SKUIDynamicGridSizeCacheKey *reusableSizeCacheKey;
  _SKUIDynamicGridSizeCacheKey *v7;
  _SKUIDynamicGridSizeCacheKey *v8;
  double v9;
  double v10;
  uint64_t *v11;
  uint64_t v12;
  ...
  double v28;
  double v29;
  SKUIViewElement *independentlySizedViewElement;
  void *v32;
  void *v33;
  double v34;
  double v35;
  ...
  v9 = *v4;
  v10 = v4[1];
  -[_SKUIDynamicGridSizeCacheKey setPosition:](reusableSizeCacheKey, "setPosition:", 0);
  if (-[SKUIGridViewElementPageSectionConfiguration numberOfColumns](self->_configuration, "numberOfColumns") == 1)
  {
    v68 = 0x7FFFFFFFFFFFFFFFLL;
    -[SKUIDynamicGridViewElementPageSection _entityGlobalIndexForGlobalIndex:returningSection:](self, "_entityGlobalIndexForGlobalIndex:returningSection:", v56, &v68);
    ...
    v66 = 0u;
    v67 = 0u;
    v14 = -[SKUIDynamicGridViewElementPageSection _templateViewElementsForType:mode:](self, "_templateViewElementsForType:mode:", v12, v13);
    ...
    if (v15)
    {
      ...
      v17 = 0;
      v59 = 1;
      v18 = &OBJC_IVAR___SKUIRedeemCameraViewController__successfulRedeem;
      v19 = *(_QWORD *)v65;
      v20 = v10;
      v21 = v9;
      v57 = *(_QWORD *)v65;
      ...
      while (1)
      {
        ...
        do
        {
          ...
          -[_SKUIDynamicGridSizeCacheKey setViewElement:](self->_reusableSizeCacheKey, "setViewElement:", v23);
          v24 = v18[748];
          ...
          {
            v63 = -[SKUISizingEntityValueProvider initForViewElement:]([SKUISizingEntityValueProvider alloc], "initForViewElement:", v23);
            ...
            -[SKUIGridViewElementPageSectionConfiguration requestCellLayoutForViewElement:](self->_configuration, "requestCellLayoutForViewElement:", v23);
            -[SKUIViewElementLayoutContext labelLayoutCache](self->_cellLayoutContext, "labelLayoutCache");
            ...
            -[SKUIGridViewElementPageSectionConfiguration cellSizeForViewElement:indexPath:](self->_configuration, "cellSizeForViewElement:indexPath:", v23, a3);
            v27 = v34;
            v29 = v35;
            ...
            if (!v36)
            {
              v37 = (objc_class *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E08]), "initWithCapacity:", 1);
              v38 = *(Class *)((char *)&self->super.super.isa + v24);
              *(Class *)((char *)&self->super.super.isa + v24) = v37;

              v36 = *(Class *)((char *)&self->super.super.isa + v24);
            }
            objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithCGSize:", v27, v29);
...
LABEL_30:
  -[SKUIDynamicGridViewElementPageSection _viewElementAtGlobalIndex:](self, "_viewElementAtGlobalIndex:", v56);
  v40 = (void *)objc_claimAutoreleasedReturnValue();
  if (v40)
  {
    -[_SKUIDynamicGridSizeCacheKey setViewElement:](self->_reusableSizeCacheKey, "setViewElement:", v40);
    ...
    {
      -[SKUIGridViewElementPageSectionConfiguration requestCellLayoutForViewElement:](self->_configuration, "requestCellLayoutForViewElement:", v40);
      -[SKUIViewElementLayoutContext labelLayoutCache](self->_cellLayoutContext, "labelLayoutCache");
      ...
      -[SKUIGridViewElementPageSectionConfiguration cellSizeForViewElement:indexPath:](self->_configuration, "cellSizeForViewElement:indexPath:", v40, a3);
      v9 = v47;
      v10 = v48;
      sizeCacheKeyToCachedCellSize = self->_sizeCacheKeyToCachedCellSize;
      if (!sizeCacheKeyToCachedCellSize)
      {
        v50 = (NSMutableDictionary *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E08]), "initWithCapacity:", 1);
        v51 = self->_sizeCacheKeyToCachedCellSize;
        self->_sizeCacheKeyToCachedCellSize = v50;

        sizeCacheKeyToCachedCellSize = self->_sizeCacheKeyToCachedCellSize;
      }
      objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithCGSize:", v9, v10);
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  if (v6)
  {
    v7 = objc_alloc(MEMORY[0x1E0D3A6A8]);
  ...
  -[SKUIStorePageSection collectionViewDidSelectItemAtIndexPath:](&v13, sel_collectionViewDidSelectItemAtIndexPath_, v4);
...
- (void)collectionViewDidConfirmButtonElement:(id)a3 withClickInfo:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  if (v13)
  {
    -[SKUIDynamicGridViewElementPageSection _viewElementAtGlobalIndex:](self, "_viewElementAtGlobalIndex:", objc_msgSend(v10, "item"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "entityValueProvider");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    if (v15)
    {
      v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D3A6A8]), "initWithAppContext:", v13);
      v17 = v16;
      if (v16)
      {
  ...
  -[SKUIStorePageSection collectionViewDidConfirmButtonElement:withClickInfo:forItemAtIndexPath:](&v20, sel_collectionViewDidConfirmButtonElement_withClickInfo_forItemAtIndexPath_, v8, v9, v10);
...
- (void)collectionViewWillApplyLayoutAttributes:(id)a3
{
  ...
  v5 = a3;
  -[SKUIGridViewElementPageSectionConfiguration collectionViewWillApplyLayoutAttributes:](configuration, "collectionViewWillApplyLayoutAttributes:", v5);
  v6.receiver = self;
  v6.super_class = (Class)SKUIDynamicGridViewElementPageSection;
  -[SKUIStorePageSection collectionViewWillApplyLayoutAttributes:](&v6, sel_collectionViewWillApplyLayoutAttributes_, v5);
...
- (void)deselectItemsAnimated:(BOOL)a3
{
  ...
  -[SKUIStorePageSection deselectItemsAnimated:](&v15, sel_deselectItemsAnimated_, v3);
...
- (void)entityProvider:(id)a3 didInvalidateWithContext:(id)a4
{
  ...
  if (self->_entityProvider == a3)
  {
    ...
    {
      -[SKUIDynamicGridViewElementPageSection _reloadEntityProperties](self, "_reloadEntityProperties");
      -[SKUIDynamicGridViewElementPageSection _updateStyleProperties](self, "_updateStyleProperties");
      -[SKUIStorePageSection context](self, "context");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      -[SKUIDynamicGridViewElementPageSection _reloadVisibleCellsAnimated:](self, "_reloadVisibleCellsAnimated:", 0);
    }
    v6 = v10;
  }
...
- (id)indexPathsForPinningItems
{
  ...
  v3 = -[SKUIStorePageSection sectionIndex](self, "sectionIndex");
  if (self->_numberOfSections)
  {
    ...
    if (self->_numberOfSections)
    {
      ...
      do
      {
        objc_msgSend(MEMORY[0x1E0CB36B0], "indexPathForItem:inSection:", self->_sectionHeaderGlobalIndices[v6], v4);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)invalidateCachedLayoutInformation
{
  ...
  -[SKUIStorePageSection invalidateCachedLayoutInformation](&v3, sel_invalidateCachedLayoutInformation);
}
...
- (int64_t)numberOfCells
{
  ...
  v3 = -[SKUIDynamicPageSectionIndexMapper totalNumberOfEntities](self->_dynamicPageSectionIndexMapper, "totalNumberOfEntities");
  if (self->_showsSectionHeaders)
    v3 += -[SKUIDynamicPageSectionIndexMapper numberOfSections](self->_dynamicPageSectionIndexMapper, "numberOfSections");
  return v3;
}
...
- (int64_t)pinningStyleForItemAtIndexPath:(id)a3
{
  ...
  -[SKUIDynamicGridViewElementPageSection _entityValueProviderForGlobalIndex:sectionIndex:](self, "_entityValueProviderForGlobalIndex:sectionIndex:", objc_msgSend(a3, "item"), 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIDynamicGridViewElementPageSection _sectionTemplateViewElementForEntityValueProvider:](self, "_sectionTemplateViewElementForEntityValueProvider:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
  ...
  {
LABEL_3:
    v7 = -[SKUIStorePageSection defaultItemPinningStyle](self, "defaultItemPinningStyle");
  }
...
- (void)reloadCellWithIndexPath:(id)a3 reason:(int64_t)a4
{
  ...
  v7 = a3;
  -[SKUIDynamicGridViewElementPageSection _viewElementAtGlobalIndex:](self, "_viewElementAtGlobalIndex:", objc_msgSend(v7, "item"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
    -[SKUIGridViewElementPageSectionConfiguration reloadCellWithIndexPath:forViewElement:reason:](self->_configuration, "reloadCellWithIndexPath:forViewElement:reason:", v7, v6, a4);
...
- (void)reloadVisibleCellsWithReason:(int64_t)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SKUIDynamicGridViewElementPageSection;
  -[SKUIStorePageSection reloadVisibleCellsWithReason:](&v6, sel_reloadVisibleCellsWithReason_, a3);
  cellLayoutContext = self->_cellLayoutContext;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[SKUIGridViewElementPageSectionConfiguration showsEditMode](self->_configuration, "showsEditMode"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewElementLayoutContext setAggregateValue:forKey:](cellLayoutContext, "setAggregateValue:forKey:", v5, 0x1E73B7AB0);
...
- (UIEdgeInsets)sectionContentInset
{
  ...
  -[SKUIStorePageSection sectionContentInset](&v25, sel_sectionContentInset);
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v11 = v10;
  -[SKUIDynamicGridViewElementPageSection _dynamicGridViewElement](self, "_dynamicGridViewElement");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)targetScrollingIndexPathForElementWithIndexBarEntryID:(id)a3 relativeSectionIndex:(int64_t)a4
{
  ...
  if (!self->_showsSectionHeaders)
  {
    if (-[SKUIDynamicPageSectionIndexMapper numberOfSections](self->_dynamicPageSectionIndexMapper, "numberOfSections") > a4)
    {
      v16 = -[SKUIDynamicPageSectionIndexMapper rangeForSectionAtIndex:](self->_dynamicPageSectionIndexMapper, "rangeForSectionAtIndex:", a4);
      v17 = (void *)MEMORY[0x1E0CB36B0];
      v18 = -[SKUIDynamicGridViewElementPageSection _globalIndexForEntityGlobalIndex:](self, "_globalIndexForEntityGlobalIndex:", v16);
...
- (BOOL)updateCellWithIndexPath:(id)a3 itemState:(id)a4 animated:(BOOL)a5
{
  ...
  if (v13)
  {
    -[SKUIDynamicGridViewElementPageSection _viewElementAtGlobalIndex:](self, "_viewElementAtGlobalIndex:", objc_msgSend(v8, "item"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    if (v14)
      -[SKUIGridViewElementPageSectionConfiguration requestCellLayoutForViewElement:](self->_configuration, "requestCellLayoutForViewElement:", v14);
...
- (void)willAppearInContext:(id)a3
{
  ...
  void *v7;
  SKUIViewElementTextLayoutCache *v8;
  ...
  void *v14;
  void *v15;
  SKUIViewElementLayoutContext *v16;
  void *v17;
  SKUIViewElementLayoutContext *v18;
  void *v19;
  SKUIViewElementLayoutContext *v20;
  void *v21;
  void *v22;
  void *v23;
  objc_super v24;
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIGridViewElementPageSectionConfiguration registerReusableClassesForCollectionView:](self->_configuration, "registerReusableClassesForCollectionView:", v5);
  v6 = [SKUIViewElementTextLayoutCache alloc];
  objc_msgSend(v4, "textLayoutCache");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = -[SKUIViewElementTextLayoutCache initWithLayoutCache:](v6, "initWithLayoutCache:", v7);
  labelLayoutCache = self->_labelLayoutCache;
  self->_labelLayoutCache = v8;

  cellLayoutContext = self->_cellLayoutContext;
  if (cellLayoutContext)
    -[SKUIViewElementLayoutContext setArtworkRequestDelegate:](cellLayoutContext, "setArtworkRequestDelegate:", 0);
  v11 = -[SKUIViewElementLayoutContext initWithStorePageSectionContext:]([SKUIViewElementLayoutContext alloc], "initWithStorePageSectionContext:", v4);
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewElementLayoutContext setClientContext:](v13, "setClientContext:", v15);

  -[SKUIViewElementLayoutContext setLabelLayoutCache:](self->_cellLayoutContext, "setLabelLayoutCache:", self->_labelLayoutCache);
  -[SKUIViewElementLayoutContext setAggregateValue:forKey:](self->_cellLayoutContext, "setAggregateValue:forKey:", MEMORY[0x1E0C9AAB0], 0x1E73B4C10);
  -[SKUIViewElementLayoutContext setAggregateValue:forKey:](self->_cellLayoutContext, "setAggregateValue:forKey:", &unk_1E749B618, 0x1E73AEF10);
  v16 = self->_cellLayoutContext;
  objc_msgSend(v4, "parentViewController");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewElementLayoutContext setParentViewController:](v16, "setParentViewController:", v17);

  v18 = self->_cellLayoutContext;
  objc_msgSend(v4, "resourceLoader");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewElementLayoutContext setResourceLoader:](v18, "setResourceLoader:", v19);

  v20 = self->_cellLayoutContext;
  objc_msgSend(v5, "tintColor");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIViewElementLayoutContext setTintColor:](v20, "setTintColor:", v21);
  ...
  -[SKUIViewElementLayoutContext setContainerViewElementType:](self->_cellLayoutContext, "setContainerViewElementType:", objc_msgSend(v23, "elementType"));
  -[SKUIGridViewElementPageSectionConfiguration setCellLayoutContext:](self->_configuration, "setCellLayoutContext:", self->_cellLayoutContext);
  -[SKUIDynamicGridViewElementPageSection _resetLayoutProperties](self, "_resetLayoutProperties");
  -[SKUIDynamicGridViewElementPageSection _invalidateCellSizeCache](self, "_invalidateCellSizeCache");
  v24.receiver = self;
  v24.super_class = (Class)SKUIDynamicGridViewElementPageSection;
  -[SKUIStorePageSection willAppearInContext:](&v24, sel_willAppearInContext_, v4);
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  v8 = v6;
  v9 = v7;
  -[SKUIDynamicGridViewElementPageSection _enumerateVisibleCellsUsingBlock:](self, "_enumerateVisibleCellsUsingBlock:", v10);
...
void __69__SKUIDynamicGridViewElementPageSection_artworkRequest_didLoadImage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v7 || v6 == 152)
  {
    if (objc_msgSend(v8, "conformsToProtocol:", &unk_1EF4000F8))
...
- (void)setEditing:(BOOL)a3 animated:(BOOL)a4
{
  ...
  {
    self->_editing = a3;
    -[SKUIDynamicGridViewElementPageSection _reloadVisibleCellsAnimated:](self, "_reloadVisibleCellsAnimated:", a4);
  }
}
...
- (id)gridViewElementPageSectionConfiguration:(id)a3 viewElementForIndexPath:(id)a4
{
  ...
  else
  {
    ...
    v5 = (SKUIViewElement *)objc_claimAutoreleasedReturnValue();
  }
  return v5;
}
...
- (void)gridViewElementPageSectionConfiguration:(id)a3 configurePosition:(int64_t *)a4 forItemAtIndexPath:(id)a5
{
  ...
  if (self->_showsSectionHeaders)
  {
    ...
    v7 = -[SKUIDynamicGridViewElementPageSection _entityGlobalIndexForGlobalIndex:returningSection:](self, "_entityGlobalIndexForGlobalIndex:returningSection:", objc_msgSend(a5, "item", a3), &v14);
    if (v14 == 0x7FFFFFFFFFFFFFFFLL)
    {
      v12 = 0;
      v13 = 0;
      if (!-[SKUIDynamicPageSectionIndexMapper getItem:section:forGlobalIndex:](self->_dynamicPageSectionIndexMapper, "getItem:section:forGlobalIndex:", &v13, &v12, v7))return;
      if (v13)
      {
        v8 = -[SKUIDynamicPageSectionIndexMapper rangeForSectionAtIndex:](self->_dynamicPageSectionIndexMapper, "rangeForSectionAtIndex:", v12);
        if (v13 != v9 + v8 - 1)
          return;
        v10 = 32;
      }
...
{
  int64_t v7;
  _SKUIDynamicGridEntityValueProviderValue *v8;
  _SKUIDynamicGridEntityValueProviderValue *v9;
  void *v10;
  int64_t v12;
  void *v13;
  ...
  v7 = -[SKUIMutableIntegerValue integerValue](self->_reusableGlobalIndexIntegerValue, "integerValue");
  -[SKUIMutableIntegerValue setIntegerValue:](self->_reusableGlobalIndexIntegerValue, "setIntegerValue:", a3);
  ...
  v8 = (_SKUIDynamicGridEntityValueProviderValue *)objc_claimAutoreleasedReturnValue();
  v17 = 0;
  if (v8)
  {
    v9 = v8;
    v17 = -[_SKUIDynamicGridEntityValueProviderValue sectionIndex](v8, "sectionIndex");
    -[_SKUIDynamicGridEntityValueProviderValue entityValueProvider](v9, "entityValueProvider");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if (a4)
LABEL_3:
      *a4 = v17;
  ...
  {
    v12 = -[SKUIDynamicGridViewElementPageSection _entityGlobalIndexForGlobalIndex:returningSection:](self, "_entityGlobalIndexForGlobalIndex:returningSection:", a3, &v17);
    if (v17 == 0x7FFFFFFFFFFFFFFFLL)
    {
      -[SKUIDynamicPageSectionIndexMapper entityIndexPathForGlobalIndex:](self->_dynamicPageSectionIndexMapper, "entityIndexPathForGlobalIndex:", v12);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      if (v13)
      {
        -[SKUIEntityProviding entityValueProviderAtIndexPath:](self->_entityProvider, "entityValueProviderAtIndexPath:", v13);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
      }
      else
      {
    ...
    {
      -[SKUIEntityProviding sectionEntityValueProviderAtIndex:](self->_entityProvider, "sectionEntityValueProviderAtIndex:");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
    ...
    -[_SKUIDynamicGridEntityValueProviderValue setSectionIndex:](v9, "setSectionIndex:", v17);
    -[_SKUIDynamicGridEntityValueProviderValue setEntityValueProvider:](v9, "setEntityValueProvider:", v10);
    ...
    {
      v15 = (CPLRUDictionary *)objc_msgSend(objc_alloc(MEMORY[0x1E0CFA998]), "initWithMaximumCapacity:", 50);
  ...
  -[SKUIMutableIntegerValue setIntegerValue:](self->_reusableGlobalIndexIntegerValue, "setIntegerValue:", v7);
...
- (id)_itemTemplateViewElementForEntityValueProvider:(id)a3
{
  ...
  if (self->_editing)
    ...
    v7 = 0;
  objc_msgSend(v5, "templateDefinitionViewElementsForType:mode:", 0x1E73ACC70, v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadEntityProperties
{
  ...
  -[CPLRUDictionary removeAllObjects](self->_globalIndexToTemplateViewElementCache, "removeAllObjects");
  -[SKUIDynamicPageSectionIndexMapper reloadData](self->_dynamicPageSectionIndexMapper, "reloadData");
  -[SKUIDynamicGridViewElementPageSection _updateShowsSectionHeaders](self, "_updateShowsSectionHeaders");
  sectionHeaderGlobalIndices = self->_sectionHeaderGlobalIndices;
  if (sectionHeaderGlobalIndices)
  {
    free(sectionHeaderGlobalIndices);
  ...
  if (self->_showsSectionHeaders)
  {
    v4 = -[SKUIDynamicPageSectionIndexMapper numberOfSections](self->_dynamicPageSectionIndexMapper, "numberOfSections");
    ...
    if (v4 >= 1)
    {
      ...
      do
      {
        ...
        -[SKUIDynamicPageSectionIndexMapper rangeForSectionAtIndex:](self->_dynamicPageSectionIndexMapper, "rangeForSectionAtIndex:", v5);
        v6 += v7 + 1;
        ++v5;
      }
      while (v4 != v5);
...
- (void)_reloadViewElementProperties
{
  ...
  v3 = (SKUIEntityProviding *)objc_claimAutoreleasedReturnValue();
  entityProvider = self->_entityProvider;
  if (entityProvider == v3 || (-[SKUIEntityProviding isEqual:](entityProvider, "isEqual:", v3) & 1) != 0)
  {
    v5 = 0;
  }
  else
  ...
  {
    -[SKUIGridViewElementPageSectionConfiguration setRendersWithPerspective:](self->_configuration, "setRendersWithPerspective:", objc_msgSend(v11, "rendersWithPerspective"));
    if (!v5)
      goto LABEL_12;
  }
  else
...
- (void)_reloadVisibleCellsAnimated:(BOOL)a3
{
  ...
  -[SKUIViewElementLayoutContext labelLayoutCache](self->_cellLayoutContext, "labelLayoutCache", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v8 = v5;
  v6 = v5;
  -[SKUIDynamicGridViewElementPageSection _enumerateVisibleCellsUsingBlock:](self, "_enumerateVisibleCellsUsingBlock:", v7);
...
void __69__SKUIDynamicGridViewElementPageSection__reloadVisibleCellsAnimated___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v5 = a3;
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0 && objc_msgSend(v7, "conformsToProtocol:", &unk_1EF4000F8))
  {
...
- (void)_resetLayoutProperties
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIGridViewElementPageSectionConfiguration updateLayoutPropertiesForGridViewElement:](configuration, "updateLayoutPropertiesForGridViewElement:", v3);
...
- (id)_sectionTemplateViewElementForEntityValueProvider:(id)a3
{
  ...
  if (self->_editing)
    ...
    v7 = 0;
  objc_msgSend(v5, "templateDefinitionViewElementsForType:mode:", 0x1E73ACC90, v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "bestTemplateDefinitionViewElementFromTemplateDefinitionViewElements:entityValueProvider:", v8, v4);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)_updateShowsSectionHeaders
{
  ...
  if (objc_msgSend(v3, "hasSectionHeaders"))
    v4 = -[SKUIDynamicPageSectionIndexMapper totalNumberOfEntities](self->_dynamicPageSectionIndexMapper, "totalNumberOfEntities") >= self->_minimumEntityCountForSections;
  else
    v4 = 0;
...
- (void)_updateStyleProperties
{
  ...
  if (self->_editing)
    ...
    v5 = 0;
  objc_msgSend(v3, "templateDefinitionViewElementsForType:mode:", 0x1E73ACC70, v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
  ...
  -[SKUIGridViewElementPageSectionConfiguration updateStylePropertiesForGridViewElement:gridItemViewElements:numberOfGridItems:](self->_configuration, "updateStylePropertiesForGridViewElement:gridItemViewElements:numberOfGridItems:", v4, v9, -[SKUIDynamicGridViewElementPageSection numberOfCells](self, "numberOfCells"));
...
- (id)_viewElementAtGlobalIndex:(int64_t)a3
{
  ...
  v5 = -[SKUIMutableIntegerValue integerValue](self->_reusableGlobalIndexIntegerValue, "integerValue");
  -[SKUIMutableIntegerValue setIntegerValue:](self->_reusableGlobalIndexIntegerValue, "setIntegerValue:", a3);
  ...
  -[SKUIDynamicGridViewElementPageSection _entityValueProviderForGlobalIndex:sectionIndex:](self, "_entityValueProviderForGlobalIndex:sectionIndex:", a3, &v15);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    if (!self->_usesSizingEntityValueProvider)
      goto LABEL_13;
LABEL_11:
    v11 = -[SKUISizingEntityValueProvider initForViewElement:]([SKUISizingEntityValueProvider alloc], "initForViewElement:", v6);
    objc_msgSend(v6, "setEntityValueProvider:", v11);

    goto LABEL_14;
  }
  if (v15 == 0x7FFFFFFFFFFFFFFFLL)
    -[SKUIDynamicGridViewElementPageSection _itemTemplateViewElementForEntityValueProvider:](self, "_itemTemplateViewElementForEntityValueProvider:", v7);
  else
    -[SKUIDynamicGridViewElementPageSection _sectionTemplateViewElementForEntityValueProvider:](self, "_sectionTemplateViewElementForEntityValueProvider:", v7);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    ...
    {
      v9 = (CPLRUDictionary *)objc_msgSend(objc_alloc(MEMORY[0x1E0CFA998]), "initWithMaximumCapacity:", 50);
...
LABEL_14:
  -[SKUIMutableIntegerValue setIntegerValue:](self->_reusableGlobalIndexIntegerValue, "setIntegerValue:", v5);
