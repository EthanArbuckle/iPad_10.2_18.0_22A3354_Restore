...
- (SKUIReviewList)initWithReviewListDictionary:(id)a3
{
  ...
  {
    -[SKUIReviewList initWithReviewListDictionary:].cold.1();
  }
  v25.receiver = self;
  v25.super_class = (Class)SKUIReviewList;
  v5 = -[SKUIReviewList init](&v25, sel_init);
  if (v5)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v16 = -[SKUIReview initWithReviewDictionary:]([SKUIReview alloc], "initWithReviewDictionary:", v15);
              if (v16)
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              v17 = -[SKUIReview initWithCacheRepresentation:](v16, "initWithCacheRepresentation:", v15, (_QWORD)v21);
              if (v17)
