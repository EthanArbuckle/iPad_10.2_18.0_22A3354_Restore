...
{
  _SKUIItemBrowseCellContentView *v3;
  void *v4;
  objc_super v6;
  ...
  if (v3)
  {
    ...
    -[_SKUIItemBrowseCellContentView setBackgroundColor:](v3, "setBackgroundColor:", v4);

    -[_SKUIItemBrowseCellContentView setContentMode:](v3, "setContentMode:", 7);
  }
  return v3;
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  if ((-[SKUICellImageView isHidden](self->_userRatingImageView, "isHidden") & 1) == 0)
  {
    -[SKUICellImageView image](self->_userRatingImageView, "image");
    v8 = (id)objc_claimAutoreleasedReturnValue();
    -[SKUICellImageView frame](self->_userRatingImageView, "frame");
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUICellImageView setBackgroundColor:](self->_userRatingImageView, "setBackgroundColor:", v5);
  -[UILabel setBackgroundColor:](self->_userRatingLabel, "setBackgroundColor:", v5);
  v6.receiver = self;
  v6.super_class = (Class)_SKUIItemBrowseCellContentView;
  -[_SKUIItemBrowseCellContentView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
