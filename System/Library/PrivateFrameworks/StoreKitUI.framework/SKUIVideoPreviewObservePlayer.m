@implementation SKUIVideoPreviewObservePlayer
...
void __SKUIVideoPreviewObservePlayer_block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_getAssociatedObject(v3, "com.apple.StoreKitUI.MoviePlayerItemID");
  ...
  objc_getAssociatedObject(v3, "com.apple.StoreKitUI.MoviePlayerTrackingKey");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9)
  {
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "postNotificationName:object:", CFSTR("SKUIVideoPreviewDidEndNotification"), 0);
