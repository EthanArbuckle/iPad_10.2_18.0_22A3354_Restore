...
- (SKUIProductInformationView)initWithFrame:(CGRect)a3
{
  ...
  {
    -[SKUIProductInformationView initWithFrame:].cold.1();
  }
  v21.receiver = self;
  ...
  v9 = (SKUIProductInformationView *)v8;
  if (v8)
  {
    ...
    *(_OWORD *)(v8 + 440) = _Q0;
    ...
    -[SKUIColorScheme primaryTextColor](v9->_colorScheme, "primaryTextColor");
    ...
    else
    {
      ...
      -[UIView setBackgroundColor:](v17, "setBackgroundColor:", v19);

    }
    -[SKUIProductInformationView addSubview:](v9, "addSubview:", v9->_separatorView);
  }
  return v9;
}
    ...
    if (v54)
    {
      ...
      do
      {
        for (m = 0; m != v54; ++m)
        {
          ...
          -[SKUIProductInformationView backgroundColor](self, "backgroundColor");
          ...
          -[SKUIProductInformationView addSubview:](self, "addSubview:", v29);
          ...
          v39 = objc_alloc_init(MEMORY[0x1E0DC3990]);
          objc_msgSend(MEMORY[0x1E0DC1350], "systemFontOfSize:", 12.0);
          ...
          -[SKUIProductInformationView addSubview:](self, "addSubview:", v39);
          ...
          if ((unint64_t)objc_msgSend(v28, "count") >= 3)
          {
            ...
            {
              v46 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3890]), "initWithImage:", v45);
              -[SKUIProductInformationView addSubview:](self, "addSubview:", v46);
...
LABEL_43:
    ...
    -[SKUIProductInformationView setNeedsLayout](self, "setNeedsLayout");
    v6 = v49;
  }
  ...
  if (v4 != v16 && (objc_msgSend(v4, "isEqualToString:", v16) & 1) == 0)
  {
    ...
    if (v16)
    {
      if (!titleLabel)
      {
        ...
        -[SKUIProductInformationView addSubview:](self, "addSubview:", self->_titleLabel);
        titleLabel = self->_titleLabel;
      }
...
- (void)layoutSubviews
{
  ...
  -[SKUIProductInformationView bounds](self, "bounds");
  v46 = v4;
  v47 = v3;
  ...
  -[SKUIProductInformationView _keyWidth](self, "_keyWidth");
  v51 = v12;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SKUIProductInformationView setBackgroundColor:](&v15, sel_setBackgroundColor_, v4);
