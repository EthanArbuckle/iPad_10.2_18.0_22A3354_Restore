...
- (SKUIMetricsImpressionSession)init
{
  ...
  {
    -[SKUIMetricsImpressionSession init].cold.1();
  }
  v13.receiver = self;
  v13.super_class = (Class)SKUIMetricsImpressionSession;
  v3 = -[SKUIMetricsImpressionSession init](&v13, sel_init);
  if (v3)
  {
...
- (void)addItemIdentifier:(int64_t)a3
{
  ...
  if (a3)
  {
    ...
    v6 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithLongLong:", a3);
...
- (void)beginActiveImpressionForViewElement:(id)a3
{
  ...
  id v13;
  id v14;
  SKUIMetricsImpressionSession *v15;
  ...
  {
    -[SKUIMetricsImpressionSession _getTimerForViewElement:](self, "_getTimerForViewElement:", v4);
    ...
    else
    {
      ...
      handler[3] = &unk_1E73A02E8;
      v13 = v5;
      v11 = v4;
      v14 = v11;
      v15 = self;
      dispatch_source_set_event_handler(v8, handler);
      -[SKUIMetricsImpressionSession _setTimer:forViewElement:](self, "_setTimer:forViewElement:", v8, v11);
      dispatch_resume(v8);
...
uint64_t __68__SKUIMetricsImpressionSession_beginActiveImpressionForViewElement___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v4, "postNotificationName:object:", CFSTR("SKUIMetricsImpressionNotification"), *(_QWORD *)(a1 + 40));
...
- (void)endActiveImpressionForViewElement:(id)a3
{
  ...
  -[SKUIMetricsImpressionSession _clearTimerForViewElement:](self, "_clearTimerForViewElement:", v4);
...
- (void)endAllPendingActiveImpression
{
  ...
  -[SKUIMetricsImpressionSession _allViewElementsInTimerMap](self, "_allViewElementsInTimerMap");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = 0u;
  v9 = 0u;
  v10 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIMetricsImpressionSession endActiveImpressionForViewElement:](self, "endActiveImpressionForViewElement:", *(_QWORD *)(*((_QWORD *)&v8 + 1) + 8 * v7++));
      }
      while (v5 != v7);
