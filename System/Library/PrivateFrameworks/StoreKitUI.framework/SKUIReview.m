...
- (SKUIReview)initWithReviewDictionary:(id)a3
{
  ...
  {
    -[SKUIReview initWithReviewDictionary:].cold.1();
  }
  v21.receiver = self;
  v21.super_class = (Class)SKUIReview;
  v5 = -[SKUIReview init](&v21, sel_init);
  if (v5)
  {
  ...
  if (v13)
  {
    if (self->_reviewer)
    {
      if (v4)
        ...
        +[SKUIClientContext localizedStringForKey:inBundles:inTable:](SKUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEW_BYLINE_WITH_DATE"), 0, CFSTR("ProductPage"));
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithValidatedFormat:validFormatSpecifiers:error:", v17, CFSTR("%@%@"), 0, self->_reviewer, v13, v19);
...
LABEL_26:
    if (self->_reviewer)
    {
      if (v4)
        ...
        +[SKUIClientContext localizedStringForKey:inBundles:inTable:](SKUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEW_BYLINE_NO_DATE"), 0, CFSTR("ProductPage"));
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithValidatedFormat:validFormatSpecifiers:error:", v16, CFSTR("%@"), 0, self->_reviewer);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
