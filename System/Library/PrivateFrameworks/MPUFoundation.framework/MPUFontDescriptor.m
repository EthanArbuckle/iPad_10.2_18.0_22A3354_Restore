...
{
  MPUFontDescriptor *v2;
  MPUFontDescriptor *v3;
  void *v4;
  void *v5;
  objc_super v7;
  ...
  v2 = -[MPUFontDescriptor init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    -[MPUFontDescriptor _resetToDefaultValues](v2, "_resetToDefaultValues");
...
- (void)dealloc
{
  ...
  -[MPUFontDescriptor dealloc](&v5, sel_dealloc);
}
...
- (id)description
{
  ...
  v12 = 0;
  _MPUFontTextStyleGetDescriptionAndCustomStyleStatus(self->_textStyle, &v12);
  ...
  v8 = self->_weight - 1;
  if (v8 <= 7)
    objc_msgSend(v6, "appendFormat:", CFSTR("; weight = %@"), off_24DD6E398[v8]);
...
- (BOOL)isEqual:(id)a3
{
  MPUFontDescriptor *v4;
  MPUFontDescriptor *v5;
  double *v6;
  BOOL v7;

  v4 = (MPUFontDescriptor *)a3;
  if (self == v4)
  {
    v7 = 1;
  }
...
{
  MPUMutableFontDescriptor *v4;
  MPUMutableFontDescriptor *v5;
  __int128 v6;
  __int128 v7;
  __int128 v8;
  __int128 v9;
...
- (UIFont)preferredFont
{
  ...
  if (!preferredFont)
  {
    ...
    v7[3] = &unk_24DD6E2D8;
    v7[4] = self;
    -[MPUFontDescriptor _fontWithBaseNativeFontDescriptorProvider:](self, "_fontWithBaseNativeFontDescriptorProvider:", v7);
...
- (double)preferredFontAscender
{
  ...
  {
    -[MPUFontDescriptor preferredFont](self, "preferredFont");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)defaultFontAscender
{
  ...
  {
    -[MPUFontDescriptor defaultFont](self, "defaultFont");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "ascender");
...
- (double)scaledValueForValue:(double)a3
{
  ...
  -[MPUFontDescriptor preferredFontBodyLeading](self, "preferredFontBodyLeading");
  v6 = v5;
  -[MPUFontDescriptor defaultFontBodyLeading](self, "defaultFontBodyLeading");
  v8 = v7;
...
{
  return +[MPUFontDescriptorCache sharedFontDescriptorCache](MPUFontDescriptorCache, "sharedFontDescriptorCache");
}
...
+ (id)_adjustedNativeFontDescriptorWithBaseNativeFontDescriptor:(id)a3 forCustomTextStyle:(int64_t)a4
{
  ...
  if (a4 == 18)
  {
    v16 = *MEMORY[0x24BDF7758];
    objc_msgSend(v5, "objectForKey:", *MEMORY[0x24BDF7758]);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "floatValue");
    v19 = v18;

    v22 = v16;
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", round(v19 * 1.88235294));
  ...
  if (a4 == 17)
  {
    ...
    v24 = v8;
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", round(v11 * 0.933333333));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v25[0] = v12;
    v13 = (void *)MEMORY[0x24BDBCE70];
    v14 = (void **)v25;
...
+ (id)_baseNativeTextStyleForTextStyle:(int64_t)a3
{
  ...
  switch(a3)
  {
    ...
    case 27:
      goto LABEL_21;
    case 1:
      v3 = (id *)MEMORY[0x24BDF77E8];
      goto LABEL_21;
    case 2:
    case 17:
      v3 = (id *)MEMORY[0x24BDF7810];
      goto LABEL_21;
    case 3:
      v3 = (id *)MEMORY[0x24BDF77D0];
      goto LABEL_21;
    case 4:
      v3 = (id *)MEMORY[0x24BDF77C0];
      goto LABEL_21;
    case 5:
      v3 = (id *)MEMORY[0x24BDF77C8];
      goto LABEL_21;
    case 6:
      v3 = (id *)MEMORY[0x24BDF7840];
      goto LABEL_21;
    case 7:
    case 18:
      v3 = (id *)MEMORY[0x24BDF7848];
      goto LABEL_21;
    case 8:
    case 19:
    case 20:
      v3 = (id *)MEMORY[0x24BDF7850];
      goto LABEL_21;
    case 9:
      v3 = (id *)MEMORY[0x24BDF7858];
      goto LABEL_21;
    case 10:
      v3 = (id *)MEMORY[0x24BDF77F0];
      goto LABEL_21;
    case 11:
      v3 = (id *)MEMORY[0x24BDF77F8];
      goto LABEL_21;
    case 12:
      v3 = (id *)MEMORY[0x24BDF7818];
      goto LABEL_21;
    case 13:
      v3 = (id *)MEMORY[0x24BDF7820];
      goto LABEL_21;
    case 14:
      v3 = (id *)MEMORY[0x24BDF77B8];
      goto LABEL_21;
    case 15:
      v3 = (id *)MEMORY[0x24BDF77D8];
      goto LABEL_21;
    case 16:
      v3 = (id *)MEMORY[0x24BDF77E0];
      goto LABEL_21;
    default:
      if (a3 == 1000)
LABEL_21:
...
+ (id)_fontPointSizeLayoutInterpolatorForTextStyle:(int64_t)a3
{
  ...
  if (a3 == 20)
  {
    v3 = objc_alloc_init(MPULayoutInterpolator);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7690]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 17.0, v18);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF76B8]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 18.0, v19);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF76A8]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 19.0, v20);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF76A0]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 20.0, v21);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7688]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 22.0, v22);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7680]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 24.0, v23);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7678]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 26.0, v24);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7660]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 32.0, v25);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7658]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 39.0, v26);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7650]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 46.0, v27);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7648]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 55.0, v28);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7640]);
    v16 = v29;
    v17 = 63.0;
  }
  else
  {
    ...
    v3 = objc_alloc_init(MPULayoutInterpolator);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7690]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 19.0, v4);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF76B8]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 20.0, v5);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF76A8]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 21.0, v6);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF76A0]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 22.0, v7);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7688]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 24.0, v8);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7680]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 26.0, v9);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7678]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 28.0, v10);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7660]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 34.0, v11);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7658]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 41.0, v12);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7650]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 48.0, v13);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7648]);
    -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", 57.0, v14);
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", *MEMORY[0x24BDF7640]);
    v16 = v15;
    v17 = 65.0;
  }
  -[MPULayoutInterpolator addValue:forReferenceMetric:](v3, "addValue:forReferenceMetric:", v17, v16);
  return v3;
}
...
+ (double)_layoutInterpolatorReferenceMetricForContentSizeCategory:(id)a3
{
  ...
  {
    v4 = 2.0;
    if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF76B8]) & 1) == 0)
    {
      v4 = 3.0;
      if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF76A8]) & 1) == 0)
      {
        v4 = 5.0;
        if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF7688]) & 1) == 0)
        {
          ...
          {
            v4 = 7.0;
            if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF7678]) & 1) == 0)
            {
              v4 = 8.0;
              if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF7660]) & 1) == 0)
              {
                v4 = 9.0;
                if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF7658]) & 1) == 0)
                {
                  v4 = 10.0;
                  if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF7650]) & 1) == 0)
                  {
                    v4 = 11.0;
                    if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF7648]) & 1) == 0)
                    {
                      v4 = 12.0;
                      if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF7640]) & 1) == 0)
                      {
                        v4 = 4.0;
                        if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDF76A0]) & 1) == 0)
                        {
                          block[0] = MEMORY[0x24BDAC760];
                          block[1] = 3221225472;
                          block[2] = __78__MPUFontDescriptor__layoutInterpolatorReferenceMetricForContentSizeCategory___block_invoke;
                          block[3] = &unk_24DD6E300;
                          v7 = v3;
...
LABEL_13:
      ...
      else
      {
        ...
        v6 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x24BDF6A78], "defaultFontDescriptorWithTextStyle:", v6);
        v7 = objc_claimAutoreleasedReturnValue();
      }
      v8 = (void *)v7;
...
- (id)_fontWithBaseNativeFontDescriptorProvider:(id)a3
{
  ...
  if (self->_wantsMonospaceNumbers)
  {
    v48 = *MEMORY[0x24BDF7748];
    v10 = *MEMORY[0x24BDF7778];
    v45[0] = *MEMORY[0x24BDF7780];
    v45[1] = v10;
    v46[0] = &unk_24DD76E88;
    v46[1] = &unk_24DD76EA0;
  ...
  if (!MPUFloatEqualToFloat(self->_defaultPointSizeAdjustment, 0.0))
  {
    -[MPUFontDescriptor _defaultFontDescriptorForTextStyle:](self, "_defaultFontDescriptorForTextStyle:", self->_textStyle);
    ...
    if (v9)
    {
      ...
      objc_msgSend(v28, "setObject:forKey:", v29, *MEMORY[0x24BDF7758]);

    }
    else
    {
      v43 = *MEMORY[0x24BDF7758];
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", v27);
      v9 = (id)objc_claimAutoreleasedReturnValue();
      v44 = v9;
  ...
  objc_msgSend(MEMORY[0x24BDF6A70], "fontWithDescriptor:size:", v35, 0.0);
...
- (void)_invalidateCachedFontsAndMetrics
{
  UIFont *preferredFont;
  UIFont *defaultFont;
  MPULayoutInterpolator *customFontPointSizeLayoutInterpolator;
...
- (id)_fontPointSizeLayoutInterpolator
{
  ...
  if (!customFontPointSizeLayoutInterpolator)
  {
    ...
    v4 = (MPULayoutInterpolator *)objc_claimAutoreleasedReturnValue();
...
- (id)_preferredFontDescriptorForTextStyle:(int64_t)a3
{
  ...
  {
    -[MPUFontDescriptor _fontPointSizeLayoutInterpolator](self, "_fontPointSizeLayoutInterpolator");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend((id)objc_opt_class(), "_layoutInterpolatorReferenceMetricForContentSizeCategory:", v6);
    objc_msgSend(v4, "valueForReferenceMetric:");
    objc_msgSend(MEMORY[0x24BDF6A70], "systemFontOfSize:");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  if (a3 != 1000)
  {
    objc_msgSend((id)objc_opt_class(), "_baseNativeTextStyleForTextStyle:", a3);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDF6A78], "preferredFontDescriptorWithTextStyle:", v4);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    goto LABEL_7;
  }
LABEL_2:
  -[MPUFontDescriptor _defaultFontDescriptorForTextStyle:](self, "_defaultFontDescriptorForTextStyle:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  return v3;
}
