...
{
  return (id)objc_msgSend(MEMORY[0x24BDF6950], "darkGrayColor");
}

+ (id)defaultSelectedColor
{
  return (id)objc_msgSend(MEMORY[0x24BDF6950], "systemPinkColor");
}

- (MPUTransportButton)initWithFrame:(CGRect)a3
{
  MPUTransportButton *v3;
...
- (void)layoutSubviews
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)MPUTransportButton;
  -[MPUTransportButton layoutSubviews](&v3, sel_layoutSubviews);
  if (self->_selectionIndicatorLayer)
  {
    -[MPUTransportButton bounds](self, "bounds");
...
- (BOOL)isEnabled
{
  ...
  return -[MPUTransportButton isEnabled](&v4, sel_isEnabled)
...
- (void)setEnabled:(BOOL)a3
{
  ...
  if (-[MPUTransportButton isSelected](self, "isSelected")
    && -[MPUTransportButton shouldShowBackgroundForSelectedState](self, "shouldShowBackgroundForSelectedState"))
  {
...
- (BOOL)beginTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  LOBYTE(v5) = -[MPUTransportButton beginTrackingWithTouch:withEvent:](&v10, sel_beginTrackingWithTouch_withEvent_, v8, v7);
...
- (void)cancelTrackingWithEvent:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)MPUTransportButton;
  -[MPUTransportButton cancelTrackingWithEvent:](&v6, sel_cancelTrackingWithEvent_, v5);
...
- (void)endTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  -[MPUTransportButton endTrackingWithTouch:withEvent:](&v9, sel_endTrackingWithTouch_withEvent_, v8, v7);
...
- (void)setSelected:(BOOL)a3
{
  ...
  v3 = a3;
  v13.receiver = self;
  v13.super_class = (Class)MPUTransportButton;
  -[MPUTransportButton setSelected:](&v13, sel_setSelected_);
  if (-[MPUTransportButton shouldShowBackgroundForSelectedState](self, "shouldShowBackgroundForSelectedState"))
  {
    ...
    if (v3)
    {
      if (!selectionIndicatorLayer)
      {
        ...
        -[MPUTransportButton layer](self, "layer");
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v11, "insertSublayer:atIndex:", self->_selectionIndicatorLayer, 0);

      }
      -[MPUTransportButton setNeedsLayout](self, "setNeedsLayout");
      v12 = -[MPUTransportButton isEnabled](self, "isEnabled");
      selectionIndicatorLayer = self->_selectionIndicatorLayer;
      if (v12)
        LODWORD(v5) = 1.0;
      else
...
- (BOOL)shouldTrack
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)MPUTransportButton;
  return -[MPUTransportButton shouldTrack](&v4, sel_shouldTrack)
...
- (void)applyTransportButtonLayoutAttributes:(id *)a3
{
  ...
  -[MPUTransportButton setImageEdgeInsets:](self, "setImageEdgeInsets:", MPUEdgeInsetsRectInsets(x, y, width, height, a3->var0.origin.x, a3->var0.origin.y, a3->var0.size.width, a3->var0.size.height));
  -[MPUTransportButton setFrame:](self, "setFrame:", x, y, width, height);
}

- (void)prepareForReuse
{
  -[MPUTransportButton setTransportButtonImage:](self, "setTransportButtonImage:", 0);
}
...
- (int64_t)transportButtonImageViewContentMode
{
  ...
  -[MPUTransportButton imageView](self, "imageView");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setDisabledColor:(id)a3
{
  ...
  if (self->_disabledColor != v5)
  {
    ...
    {
      -[MPUTransportButton _updateDisabledTransportButtonImage](self, "_updateDisabledTransportButtonImage");
      v5 = v6;
    }
  }
...
- (void)setHighlightedColor:(id)a3
{
  ...
  if (self->_highlightedColor != v5)
  {
    ...
    if (!self->_shouldInferColorsFromTintColor)
    {
      -[MPUTransportButton _updateHighlightedTransportButtonImage](self, "_updateHighlightedTransportButtonImage");
      v5 = v6;
    }
  }
...
- (void)setRegularColor:(id)a3
{
  ...
  if (self->_regularColor != v5)
  {
    ...
    if (!self->_shouldInferColorsFromTintColor)
    {
      -[MPUTransportButton _updateRegularTransportButtonImage](self, "_updateRegularTransportButtonImage");
      v5 = v6;
    }
  }
...
- (void)setSelectedColor:(id)a3
{
  ...
  if (self->_selectedColor != v5)
  {
    ...
    if (!self->_shouldInferColorsFromTintColor)
    {
      -[MPUTransportButton _updateSelectedTransportButtonImage](self, "_updateSelectedTransportButtonImage");
      v5 = v6;
    }
  }
...
- (void)setShouldInferColorsFromTintColor:(BOOL)a3
{
  ...
  if (self->_shouldInferColorsFromTintColor != a3)
  {
    ...
    if (a3)
    {
      -[MPUTransportButton setImage:forState:](self, "setImage:forState:", 0, 1);
      -[MPUTransportButton setImage:forState:](self, "setImage:forState:", 0, 4);
      -[UIImage imageWithRenderingMode:](self->_transportButtonImage, "imageWithRenderingMode:", 2);
      v4 = (id)objc_claimAutoreleasedReturnValue();
      -[MPUTransportButton setImage:forState:](self, "setImage:forState:", v4, 0);
  ...
  if (transportButtonImage != v5)
  {
    ...
    if ((v7 & 1) == 0)
    {
      ...
      if (self->_shouldInferColorsFromTintColor)
      {
        ...
        -[MPUTransportButton setImage:forState:](self, "setImage:forState:", v8, 0);
...
- (void)_updateDisabledTransportButtonImage
{
  ...
  -[MPUTransportButton setImage:forState:](self, "setImage:forState:", v3, 2);
...
- (void)_updateHighlightedTransportButtonImage
{
  ...
  v3 = (id)objc_claimAutoreleasedReturnValue();
  -[MPUTransportButton setImage:forState:](self, "setImage:forState:", v3, 1);
...
- (void)_updateRegularTransportButtonImage
{
  ...
  v3 = (id)objc_claimAutoreleasedReturnValue();
  -[MPUTransportButton setImage:forState:](self, "setImage:forState:", v3, 0);
...
- (void)_updateSelectedTransportButtonImage
{
  ...
  v3 = (id)objc_claimAutoreleasedReturnValue();
  -[MPUTransportButton setImage:forState:](self, "setImage:forState:", v3, 4);
...
+ (id)skipIntervalImageForInterval:(double)a3 baseImage:(id)a4 font:(id)a5 scale:(double)a6
{
  ...
  objc_msgSend(v11, "drawAtPoint:", *MEMORY[0x24BDBEFB0], *(double *)(MEMORY[0x24BDBEFB0] + 8));
...
+ (id)_stringForDisplayedSkipInterval:(double)a3
{
  ...
  if (v3 > 99)
  {
    MPULocalizedString(CFSTR("SKIP_INTERVAL_OVER_99_SECONDS"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "localizedStringWithFormat:", v6, 99);
