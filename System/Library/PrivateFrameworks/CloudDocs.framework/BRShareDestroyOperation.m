...
{
  id v4;
  BRShareDestroyOperation *v5;
  BRShareDestroyOperation *v6;
  objc_super v8;
  ...
  v6 = v5;
  if (v5)
    -[BRShareDestroyOperation setShare:](v5, "setShare:", v4);
...
{
  id v6;
  BRShareDestroyOperation *v7;
  BRShareDestroyOperation *v8;
  objc_super v10;
  ...
  v8 = v7;
  if (v7)
    -[BRShareDestroyOperation setShare:](v7, "setShare:", v6);
...
- (void)main
{
  ...
  v5[3] = &unk_1E3DA47F0;
  v5[4] = self;
  objc_msgSend(v3, "startOperation:toUnshareShare:forceDelete:reply:", self, v4, 1, v5);
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[BRShareDestroyOperation shareDestroyCompletionBlock](self, "shareDestroyCompletionBlock");
  v8 = objc_claimAutoreleasedReturnValue();
  v9 = (void *)v8;
  if (v8)
  {
    (*(void (**)(uint64_t, id))(v8 + 16))(v8, v6);
    -[BRShareDestroyOperation setShareDestroyCompletionBlock:](self, "setShareDestroyCompletionBlock:", 0);
  }
