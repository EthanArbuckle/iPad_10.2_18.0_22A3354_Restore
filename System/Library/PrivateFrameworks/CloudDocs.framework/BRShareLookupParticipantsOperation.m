...
{
  id v5;
  BRShareLookupParticipantsOperation *v6;
  BRShareLookupParticipantsOperation *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)BRShareLookupParticipantsOperation;
  v6 = -[BRShareOperation initWithDirectConnection](&v9, sel_initWithDirectConnection);
  v7 = v6;
  if (v6)
...
- (void)main
{
  ...
  v5[3] = &unk_1E3DA4960;
  v5[4] = self;
  objc_msgSend(v3, "startOperation:toLookupShareParticipants:reply:", self, userIdentities, v5);
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[BRShareLookupParticipantsOperation lookupParticipantsCompletionBlock](self, "lookupParticipantsCompletionBlock");
  v8 = objc_claimAutoreleasedReturnValue();
  v9 = (void *)v8;
  if (v8)
  {
    (*(void (**)(uint64_t, id, id))(v8 + 16))(v8, v6, v7);
    -[BRShareLookupParticipantsOperation setLookupParticipantsCompletionBlock:](self, "setLookupParticipantsCompletionBlock:", 0);
  }
