...
- (void)main
{
  ...
  -[ICAttachmentPreviewGeneratorOCROperation setManagedObjectContext:](self, "setManagedObjectContext:", v5);

  -[ICAttachmentPreviewGeneratorOCROperation managedObjectContext](self, "managedObjectContext");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setIc_debugName:", CFSTR("ocrGenerator"));
  ...
  v12[1] = 3221225472;
  v12[2] = __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke;
  v12[3] = &unk_1E5C1EE78;
  v12[4] = self;
  v12[5] = v17;
  v12[6] = &v13;
  ...
  if (*((_BYTE *)v14 + 24))
  {
    -[ICAttachmentPreviewGeneratorOCROperation attachmentModel](self, "attachmentModel");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "generateOCRInOperation:", self);
  }
  else
  {
    -[ICAttachmentPreviewGeneratorOCROperation managedObjectContext](self, "managedObjectContext");
    ...
    v11[0] = v8;
    v11[1] = 3221225472;
    v11[2] = __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke_10;
    v11[3] = &unk_1E5C1DE18;
    v11[4] = v17;
...
LABEL_11:
  ...
  v13 = objc_msgSend(v12, "supportsOCR");
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v27 = 1024;
    v28 = v19;
    _os_log_debug_impl(&dword_1AC7A1000, v14, OS_LOG_TYPE_DEBUG, "%@ %@ %@ OCR generate %d", buf, 0x26u);

  }
}

void __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke_10(uint64_t a1)
{
  NSObject *v2;
  void *v3;
  int v4;
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v4 = 138412290;
    v5 = v3;
    _os_log_impl(&dword_1AC7A1000, v2, OS_LOG_TYPE_INFO, "Skipping generation for attachment because it is either cancelled or not needed: %@", (uint8_t *)&v4, 0xCu);
...
void __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke_cold_1(id *a1, uint64_t a2, NSObject *a3)
{
  ...
  v8 = 2112;
  v9 = a2;
  _os_log_error_impl(&dword_1AC7A1000, a3, OS_LOG_TYPE_ERROR, "Error getting object from ID %@ for OCR generation %@", (uint8_t *)&v6, 0x16u);
