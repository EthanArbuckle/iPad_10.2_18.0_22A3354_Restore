...
LABEL_6:
  ...
  return (ICThumbnailKey *)sub_1AC7C51B8(a3, v20, v22, v18, v24, a8, v25, v27, width, height, a7, a11, a13, a14);
}
...
- (NSString)accountId
{
  return (NSString *)sub_1AC9AB744((uint64_t)self, (uint64_t)a2, &OBJC_IVAR___ICThumbnailKey_accountId);
}

- (NSString)objectId
{
  return (NSString *)sub_1AC9AB744((uint64_t)self, (uint64_t)a2, &OBJC_IVAR___ICThumbnailKey_objectId);
}
...
- (NSURL)containerUrl
{
  ...
  v7 = self;
  sub_1AC9AB22C((uint64_t)v6);

  v8 = (void *)sub_1ACA3F7D4();
...
{
  return (NSURL *)sub_1AC9AC24C(self, (uint64_t)a2, MEMORY[0x1E0DF02A0]);
}

- (NSURL)imageUrl
{
  return (NSURL *)sub_1AC9AC24C(self, (uint64_t)a2, MEMORY[0x1E0DF0248]);
}
