...
{
  PUIStyleFontWeightSlider *v2;
  void *v3;
  void *v4;
  uint64_t v5;
  UIColor *contentBackgroundColor;
  _PUIFontWeightSliderTrackView *v7;
  _PUIFontWeightSliderTrackView *trackView;
  void *v9;
  void *v10;
  uint64_t v11;
  ...
  v2 = -[PUIStyleFontWeightSlider init](&v17, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x24BDF6950], "clearColor");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    -[PUIStyleFontWeightSlider setMinimumTrackTintColor:](v2, "setMinimumTrackTintColor:", v3);

    objc_msgSend(MEMORY[0x24BDF6950], "clearColor");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    -[PUIStyleFontWeightSlider setMaximumTrackTintColor:](v2, "setMaximumTrackTintColor:", v4);

    v5 = objc_msgSend(objc_alloc(MEMORY[0x24BDF6950]), "initWithDynamicProvider:", &__block_literal_global_5);
    contentBackgroundColor = v2->_contentBackgroundColor;
    v2->_contentBackgroundColor = (UIColor *)v5;

    v7 = -[_PUIFontWeightSliderTrackView initWithTrackBackgroundColor:]([_PUIFontWeightSliderTrackView alloc], "initWithTrackBackgroundColor:", v2->_contentBackgroundColor);
    trackView = v2->_trackView;
    v2->_trackView = v7;

    -[PUIStyleFontWeightSlider addSubview:](v2, "addSubview:", v2->_trackView);
    -[PUIStyleFontWeightSlider sendSubviewToBack:](v2, "sendSubviewToBack:", v2->_trackView);
    ...
    -[PUIStyleFontWeightSlider registerForTraitChanges:withHandler:](v2, "registerForTraitChanges:withHandler:", v10, v14);
...
id __32__PUIStyleFontWeightSlider_init__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDF6F30], "traitCollectionWithUserInterfaceStyle:", v2);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)dealloc
{
  ...
  -[PUIStyleFontWeightSlider unregisterForTraitChanges:](self, "unregisterForTraitChanges:", self->_userInterfaceStyleTraitChangeRegistration);
  v3.receiver = self;
  v3.super_class = (Class)PUIStyleFontWeightSlider;
  -[PUIStyleFontWeightSlider dealloc](&v3, sel_dealloc);
}
...
- (void)layoutSubviews
{
  ...
  -[PUIStyleFontWeightSlider layoutSubviews](&v49, sel_layoutSubviews);
  ...
  -[PUIStyleFontWeightSlider bounds](self, "bounds");
...
- (id)_createCustomThumbView
{
  ...
  if (!thumbView)
  {
    ...
    v18 = (CAShapeLayer *)objc_alloc_init(MEMORY[0x24BDE5758]);
    thumbBorderLayer = self->_thumbBorderLayer;
    ...
    v25 = (CAShapeLayer *)objc_alloc_init(MEMORY[0x24BDE5758]);
    thumbClippingLayer = self->_thumbClippingLayer;
...
- (id)createThumbView
{
  -[PUIStyleFontWeightSlider _createCustomThumbView](self, "_createCustomThumbView");
