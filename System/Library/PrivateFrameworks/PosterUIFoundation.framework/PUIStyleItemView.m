...
- (PUIStyleItemView)initWithStyleCoordinator:(id)a3
{
  ...
  double v8;
  double v9;
  PUIStyleItemView *v10;
  PUIStyleItemView *v11;
  UIView *v12;
  void *v13;
  void *v14;
  id v15;
  ...
  v10 = -[PUIStyleSelectableItemView initWithFrame:](&v51, sel_initWithFrame_, *MEMORY[0x24BDBF090], v7, v8, v9);
  v11 = v10;
  if (v10)
  {
    objc_storeStrong((id *)&v10->_styleCoordinator, a3);
    v12 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6F90]), "initWithFrame:", v6, v7, v8, v9);
    ...
    -[PUIStyleSelectableItemView selectionView](v11, "selectionView");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[PUIStyleItemView insertSubview:aboveSubview:](v11, "insertSubview:aboveSubview:", v12, v17);
    ...
    -[PUIStyleItemView topAnchor](v11, "topAnchor");
    ...
    -[PUIStyleItemView leadingAnchor](v11, "leadingAnchor");
    ...
    -[PUIStyleItemView trailingAnchor](v11, "trailingAnchor");
    ...
    -[PUIStyleItemView bottomAnchor](v11, "bottomAnchor");
...
- (id)localizedName
{
  ...
  -[PUIStyleUICoordinator style](self->_styleCoordinator, "style");
