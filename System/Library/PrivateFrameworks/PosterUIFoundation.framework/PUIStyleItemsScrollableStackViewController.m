...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[PUIStyleItemsScrollableStackViewController viewWillAppear:](&v4, sel_viewWillAppear_, a3);
  -[PUIStyleItemsScrollableStackViewController setNeedsScrollToSelectedItem:](self, "setNeedsScrollToSelectedItem:", 1);
}
...
- (void)viewDidLayoutSubviews
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)PUIStyleItemsScrollableStackViewController;
  -[PUIStyleItemsViewController viewDidLayoutSubviews](&v4, sel_viewDidLayoutSubviews);
  -[PUIStyleItemsScrollableStackViewController updateInteritemSpacingIfNeeded](self, "updateInteritemSpacingIfNeeded");
  if (-[PUIStyleItemsScrollableStackViewController needsScrollToSelectedItem](self, "needsScrollToSelectedItem"))
  {
    -[PUIStyleItemsScrollableStackViewController stackView](self, "stackView");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "layoutIfNeeded");

    -[PUIStyleItemsScrollableStackViewController scrollToSelectedItemAnimated:](self, "scrollToSelectedItemAnimated:", 0);
    -[PUIStyleItemsScrollableStackViewController setNeedsScrollToSelectedItem:](self, "setNeedsScrollToSelectedItem:", 0);
  }
}
...
- (void)layoutWithItemViews:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x24BDF6DD0];
  v5 = a3;
  ...
  v9 = objc_alloc(MEMORY[0x24BDF6D50]);
  v10 = (UIScrollView *)objc_msgSend(v9, "initWithFrame:", *MEMORY[0x24BDBF090], *(double *)(MEMORY[0x24BDBF090] + 8), *(double *)(MEMORY[0x24BDBF090] + 16), *(double *)(MEMORY[0x24BDBF090] + 24));
  ...
  -[PUIStyleItemsScrollableStackViewController view](self, "view");
  ...
  -[PUIStyleItemsScrollableStackViewController estimatedHeight](self, "estimatedHeight");
...
- (void)scrollToSelectedItemAnimated:(BOOL)a3
{
  ...
  -[PUIStyleItemsScrollableStackViewController scrollView](self, "scrollView");
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  -[PUIStyleItemsViewController uiKitColorPickerStyleCoordinator](self, "uiKitColorPickerStyleCoordinator");
