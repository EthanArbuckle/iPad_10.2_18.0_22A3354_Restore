...
+ (id)defaultFontIdentifiersForRole:(id)a3 titleString:(id)a4
{
  ...
  {
    v14[0] = CFSTR("PRTimeFontIdentifierSFPro");
    v14[1] = CFSTR("PRTimeFontIdentifierSFRounded");
    v14[2] = CFSTR("PRTimeFontIdentifierNewYorkAlpha");
    v14[3] = CFSTR("PRTimeFontIdentifierSFCondensed");
    objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v14, 4);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v5, "length"))
    {
      objc_msgSend(getPRIncomingCallFontsProviderClass(), "timeFontIdentifiersForText:availableFonts:", v5, v6);
  ...
  else
  {
    if (_os_feature_enabled_impl())
    {
      ...
      v13[1] = CFSTR("PRTimeFontIdentifierRounded");
      v13[2] = CFSTR("PRTimeFontIdentifierStencil");
      v13[3] = CFSTR("PRTimeFontIdentifierNewYork");
      v13[4] = CFSTR("PRTimeFontIdentifierSlab");
      v13[5] = CFSTR("PRTimeFontIdentifierRail");
      v8 = (void *)MEMORY[0x24BDBCE30];
      v9 = v13;
    }
    else
    {
      v12[0] = CFSTR("PRTimeFontIdentifierSoft");
      v12[1] = CFSTR("PRTimeFontIdentifierRounded");
      v12[2] = CFSTR("PRTimeFontIdentifierStencil");
      v12[3] = CFSTR("PRTimeFontIdentifierNewYork");
      v12[4] = CFSTR("PRTimeFontIdentifierSlab");
      v12[5] = CFSTR("PRTimeFontIdentifierRail");
      v8 = (void *)MEMORY[0x24BDBCE30];
      v9 = v12;
    }
    objc_msgSend(v8, "arrayWithObjects:count:", v9, 6);
...
+ (id)defaultItemsForRole:(id)a3 text:(id)a4
{
  ...
  objc_msgSend(v4, "bs_map:", &__block_literal_global_19);
...
PUIFontPickerItem *__65__PUIFontPickerComponentViewController_defaultItemsForRole_text___block_invoke(uint64_t a1, void *a2)
{
  id v2;
  PUIFont *v3;
  PUIFontPickerItem *v4;

  v2 = a2;
  v3 = -[PUIFont initWithFontIdentifier:]([PUIFont alloc], "initWithFontIdentifier:", v2);

  v4 = -[PUIFontPickerItem initWithFont:systemItem:]([PUIFontPickerItem alloc], "initWithFont:systemItem:", v3, 1);
  return v4;
}
...
- (PUIFontPickerComponentViewController)initWithItems:(id)a3 selectedItem:(id)a4 role:(id)a5 titleString:(id)a6
{
  ...
  id v12;
  id v13;
  PUIFontPickerComponentViewController *v14;
  uint64_t v15;
  NSArray *items;
  void *v17;
  uint64_t v18;
  ...
  v14 = -[PUIFontPickerComponentViewController init](&v21, sel_init);
  if (v14)
  {
...
- (id)contentStringNumberFormatter
{
  ...
  if (contentStringNumberFormatter___once != -1)
    dispatch_once(&contentStringNumberFormatter___once, &__block_literal_global_7_1);
  v3 = (void *)contentStringNumberFormatter_numberFormatter;
  -[PUIFontPickerComponentViewController locale](self, "locale");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)contentStringForFont:(id)a3 locale:(id)a4
{
  ...
  v7 = a4;
  v8 = v6;
  -[PUIFontPickerComponentViewController role](self, "role");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BE74D58]);

  if (v10)
  {
    v11 = (void *)objc_msgSend(getPRIncomingCallFontsProviderClass(), "sampleStringForFont:displayingText:", v8, self->_titleString);
    v13 = v12;
  ...
  {
    -[PUIFontPickerComponentViewController contentStringNumberFormatter](self, "contentStringNumberFormatter");
    v13 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "stringFromNumber:", &unk_25156AE70);
  ...
  {
    PUINumberingTypeSystemLanguageTag(v22);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "setObject:forKeyedSubscript:", v23, *MEMORY[0x24BDD0E98]);

  }
  v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1458]), "initWithString:attributes:", v11, v18);
...
- (void)loadView
{
  ...
  -[PUIFontPickerComponentViewController configureFontPickerViewIfNecessary](self, "configureFontPickerViewIfNecessary");
  ...
  -[UISlider setHidden:](self->_fontWeightSlider, "setHidden:", -[PUIFontPickerComponentViewController _shouldShowWeightSlider](self, "_shouldShowWeightSlider") ^ 1);
  v7 = self->_fontWeightSlider;
  v8 = -[PUIFontPickerComponentViewController _shouldShowWeightSlider](self, "_shouldShowWeightSlider");
  v9 = 0.0;
  if (v8)
    v9 = 1.0;
  -[UISlider setAlpha:](v7, "setAlpha:", v9);
  v10 = self->_fontWeightSlider;
  -[PUIFontPickerComponentViewController fontWeight](self, "fontWeight");
  *(float *)&v11 = v11;
  ...
  v41 = v14;
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6DD0]), "initWithArrangedSubviews:", v14);
  ...
  -[PUIFontPickerComponentViewController updateLayoutForCurrentSize](self, "updateLayoutForCurrentSize");
  -[PUIFontPickerComponentViewController filterFontViewsByLocale](self, "filterFontViewsByLocale");
  -[PUIFontPickerComponentViewController setView:](self, "setView:", v42);
...
- (id)configureFontPickerViewIfNecessary
{
  ...
  -[PUIFontPickerComponentViewController items](self, "items");
  ...
  if (v4 > 1)
  {
    ...
    if (v7)
    {
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          -[PUIFontPickerComponentViewController locale](self, "locale");
          v13 = (void *)objc_claimAutoreleasedReturnValue();
          -[PUIFontPickerComponentViewController contentStringForFont:locale:](self, "contentStringForFont:locale:", v12, v13);
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          -[PUIFontPickerComponentViewController role](self, "role");
          v18 = (void *)objc_claimAutoreleasedReturnValue();
          v19 = objc_alloc_init(+[PUIStyleFontPickerButton fontPickerButtonClassForRole:](PUIStyleFontPickerButton, "fontPickerButtonClassForRole:", v18));

          objc_msgSend(v19, "configureWithAttributedString:", v14);
          objc_initWeak(&from, v19);
          v20 = (void *)MEMORY[0x24BDF67B8];
          ...
          if (BSEqualObjects())
          {
            ...
            -[PUIFontPickerComponentViewController setSelectedCellView:](self, "setSelectedCellView:", v19);
          }
    ...
    -[PUIFontPickerComponentViewController setCellViews:](self, "setCellViews:", v45);
    objc_msgSend(MEMORY[0x24BDBCEB8], "array");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v22, "addObjectsFromArray:", v45);
    v23 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6DD0]), "initWithArrangedSubviews:", v22);
...
void __74__PUIFontPickerComponentViewController_configureFontPickerViewIfNecessary__block_invoke(id *a1)
{
  ...
  if (v3 == v4)
  {
    ...
    v8 = objc_msgSend(v7, "pui_variantWeightRange");
    v10 = v9;
    objc_msgSend(a1[4], "font");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)_shouldShowWeightSlider
{
  ...
  -[PUIFontPickerComponentViewController delegate](self, "delegate");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_updateWeightSliderVisibility
{
  ...
  v3 = -[PUIFontPickerComponentViewController _shouldShowWeightSlider](self, "_shouldShowWeightSlider");
  v4 = MEMORY[0x24BDAC760];
  v12[0] = MEMORY[0x24BDAC760];
  v12[1] = 3221225472;
  v12[2] = __69__PUIFontPickerComponentViewController__updateWeightSliderVisibility__block_invoke;
  v12[3] = &unk_25154C5D8;
  v12[4] = self;
  v13 = v3;
  v5 = (void (**)(_QWORD))MEMORY[0x2495151FC](v12);
  v10[0] = v4;
  v10[1] = 3221225472;
  v10[2] = __69__PUIFontPickerComponentViewController__updateWeightSliderVisibility__block_invoke_2;
  v10[3] = &unk_25154C5D8;
  v10[4] = self;
  v11 = v3;
  v6 = (void *)MEMORY[0x2495151FC](v10);
  if (v3)
  {
    v5[2](v5);
    objc_msgSend(MEMORY[0x24BDF6F90], "animateWithDuration:delay:options:animations:completion:", 0, v6, 0, 0.15, 0.3);
  }
  else
  {
    ...
    v8[0] = v4;
    v8[1] = 3221225472;
    v8[2] = __69__PUIFontPickerComponentViewController__updateWeightSliderVisibility__block_invoke_3;
    v8[3] = &unk_25154C600;
    v9 = v5;
...
- (void)updateLayoutForCurrentSize
{
  ...
  v3 = -[PUIFontPickerComponentViewController isUsingSmallerSizing](self, "isUsingSmallerSizing");
  v4 = (void *)MEMORY[0x24BDD1628];
  -[PUIFontPickerComponentViewController widthCellConstraints](self, "widthCellConstraints");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "deactivateConstraints:", v5);

  v6 = (void *)MEMORY[0x24BDD1628];
  -[PUIFontPickerComponentViewController heightCellConstraints](self, "heightCellConstraints");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v46 = 0u;
  v47 = 0u;
  -[PUIFontPickerComponentViewController cellViews](self, "cellViews");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        -[PUIFontPickerComponentViewController locale](self, "locale");
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        -[PUIFontPickerComponentViewController contentStringForFont:locale:](self, "contentStringForFont:locale:", v15, v16);
        v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[PUIFontPickerComponentViewController isViewLoaded](self, "isViewLoaded"))
  {
    -[PUIFontPickerComponentViewController view](self, "view");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (self->_configuredViewWidth != v26)
    {
      -[PUIFontPickerComponentViewController role](self, "role");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      v28 = +[PUIStyleFontPickerButton fontPickerButtonClassForRole:](PUIStyleFontPickerButton, "fontPickerButtonClassForRole:", v27);

      -[objc_class defaultFontPickerButtonSizeUsingSmallerSizing:](v28, "defaultFontPickerButtonSizeUsingSmallerSizing:", v3);
      v30 = v26 - v29;
      -[PUIFontPickerComponentViewController stackViewLeadingConstraint](self, "stackViewLeadingConstraint");
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v31, "constant");
      v33 = v32;
      -[PUIFontPickerComponentViewController stackViewTrailingConstraint](self, "stackViewTrailingConstraint");
      v34 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)viewDidLayoutSubviews
{
  ...
  -[PUIFontPickerComponentViewController viewDidLayoutSubviews](&v8, sel_viewDidLayoutSubviews);
  -[PUIFontPickerComponentViewController view](self, "view");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    LOBYTE(v6) = 0;
    if (-[PUIFontPickerComponentViewController isUsingSmallerSizing](self, "isUsingSmallerSizing"))
      goto LABEL_6;
LABEL_5:
  ...
  if (((v6 ^ -[PUIFontPickerComponentViewController isUsingSmallerSizing](self, "isUsingSmallerSizing")) & 1) == 0)
    goto LABEL_5;
LABEL_6:
...
- (void)setLocale:(id)a3
{
  ...
  if (self->_locale != v5)
  {
    ...
    v15 = 0u;
    v16 = 0u;
    -[PUIFontPickerComponentViewController cellViews](self, "cellViews", 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)filterFontViewsByLocale
{
  ...
  if (!-[NSString isEqualToString:](self->_role, "isEqualToString:", *MEMORY[0x24BE74D58]))
  {
    v22 = 0u;
    v23 = 0u;
    v20 = 0u;
    ...
    if (v3)
    {
      ...
      do
      {
        for (i = 0; i != v4; ++i)
        {
          ...
          -[PUIFontPickerComponentViewController locale](self, "locale");
          v10 = (void *)objc_claimAutoreleasedReturnValue();
          -[PUIFontPickerComponentViewController contentStringForFont:locale:](self, "contentStringForFont:locale:", v9, v10);
          v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)estimatedHeight
{
  ...
  if ((-[PUIFontPickerComponentViewController isViewLoaded](self, "isViewLoaded") & 1) == 0
  ...
  largestItemHeight = self->_largestItemHeight;
  if (-[PUIFontPickerComponentViewController isViewLoaded](self, "isViewLoaded")
    && -[PUIFontPickerComponentViewController _shouldShowWeightSlider](self, "_shouldShowWeightSlider"))
  {
...
{
  return (PUIFontPickerComponentViewControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
