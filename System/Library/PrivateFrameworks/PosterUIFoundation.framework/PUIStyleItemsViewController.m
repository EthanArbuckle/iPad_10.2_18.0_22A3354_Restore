...
- (PUIStyleItemsViewController)initWithDataSource:(id)a3 configuration:(id)a4
{
  id v7;
  id v8;
  PUIStyleItemsViewController *v9;
  PUIStyleItemsViewController *v10;
  void *v11;
  char v12;
  id v13;
  ...
  v9 = -[PUIStyleItemsViewController initWithNibName:bundle:](&v34, sel_initWithNibName_bundle_, 0, 0);
  v10 = v9;
  if (!v9)
    goto LABEL_20;
  ...
  v12 = __64__PUIStyleItemsViewController_initWithDataSource_configuration___block_invoke((uint64_t)v11, v11);
  ...
  v33 = v12;
  v31 = v13;
  v32 = &__block_literal_global_21;
  objc_msgSend(v7, "firstCoordinatorPassingTest:", v30);
  v14 = (PUIStyleUICoordinator *)objc_claimAutoreleasedReturnValue();
  v15 = v14;
  if (v14)
  {
    -[PUIStyleUICoordinator style](v14, "style");
  ...
  if (objc_msgSend(v8, "colorWellDisplayMode"))
  {
    ...
    v19 = -[PUIColorWellView initWithFrame:](v18, "initWithFrame:", *MEMORY[0x24BDBF090], *(double *)(MEMORY[0x24BDBF090] + 8), *(double *)(MEMORY[0x24BDBF090] + 16), *(double *)(MEMORY[0x24BDBF090] + 24));
    ...
    if (v23)
    {
      -[PUIStyleConfiguration stylePalette](v10->_configuration, "stylePalette");
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      v25 = objc_msgSend(v24, "context") == 2;

      +[PUIStyleUICoordinator coordinatorForColorWellView:vibrant:](PUIStyleUICoordinator, "coordinatorForColorWellView:vibrant:", v10->_colorWellView, v25);
    ...
    -[PUIStyleItemsViewController _deselectColorWell](v10, "_deselectColorWell");
LABEL_16:
...
- (void)viewDidLoad
{
  ...
  -[PUIStyleItemsViewController viewDidLoad](&v3, sel_viewDidLoad);
  -[PUIStyleItemsViewController _setupItemViews](self, "_setupItemViews");
}
...
- (void)viewDidLayoutSubviews
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)PUIStyleItemsViewController;
  -[PUIStyleItemsViewController viewDidLayoutSubviews](&v3, sel_viewDidLayoutSubviews);
  -[PUIStyleItemsViewController _updateLayoutForCurrentSize](self, "_updateLayoutForCurrentSize");
}
...
- (void)_setupItemViews
{
  ...
  -[PUIStyleItemsViewController selectedStyleCoordinator](self, "selectedStyleCoordinator");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "style");
  v16 = (id)objc_claimAutoreleasedReturnValue();

  v4 = -[PUIStyleItemsDataSource numberOfCoordinators](self->_dataSource, "numberOfCoordinators");
  ...
  if (v4 >= 1)
  {
    ...
    do
    {
      -[PUIStyleItemsDataSource coordinatorForIndex:](self->_dataSource, "coordinatorForIndex:", v5, v16);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      v7 = -[PUIStyleItemView initWithStyleCoordinator:]([PUIStyleItemView alloc], "initWithStyleCoordinator:", v6);
      v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6E80]), "initWithTarget:action:", self, sel_didTapContentStyleItem_);
      -[PUIStyleItemView addGestureRecognizer:](v7, "addGestureRecognizer:", v8);
      ...
      if (v10)
      {
        -[PUIStyleSelectableItemView setSelected:](v7, "setSelected:", 1);
        -[PUIStyleItemsViewController setSelectedStyleItemView:](self, "setSelectedStyleItemView:", v7);
      }
      -[PUIStyleItemView setTranslatesAutoresizingMaskIntoConstraints:](v7, "setTranslatesAutoresizingMaskIntoConstraints:", 0);
  ...
  -[PUIStyleItemsDataSource setContentsLuminance:](self->_dataSource, "setContentsLuminance:", self->_contentsLuminance);
  objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithArray:", v18);
  v13 = (NSArray *)objc_claimAutoreleasedReturnValue();
  if (-[PUIStyleConfiguration colorWellDisplayMode](self->_configuration, "colorWellDisplayMode") == 1)
    -[NSArray addObject:](v13, "addObject:", self->_colorWellView);
  allViews = self->_allViews;
  self->_allViews = v13;
  v15 = v13;

  -[PUIStyleItemsViewController layoutWithItemViews:](self, "layoutWithItemViews:", v15);
}
...
- (void)didTapContentStyleItem:(id)a3
{
  ...
  objc_msgSend(v8, "styleCoordinator");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PUIStyleItemsViewController setSelectedStyleCoordinator:](self, "setSelectedStyleCoordinator:", v4);
  -[PUIStyleItemsViewController _didSelectStyleCoordinator:](self, "_didSelectStyleCoordinator:", v4);
  -[PUIStyleItemsViewController dataSource](self, "dataSource");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "indexForCoordinator:", v4);

  if (v6 == 0x7FFFFFFFFFFFFFFFLL)
  {
    -[PUIStyleItemsViewController _deselectSelectedStyle](self, "_deselectSelectedStyle");
  }
  else
  {
    -[PUIStyleItemsViewController _deselectColorWell](self, "_deselectColorWell");
    -[PUIStyleItemsViewController selectedStyleItemView](self, "selectedStyleItemView");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setSelected:", 0);

    -[PUIStyleItemsViewController setSelectedStyleItemView:](self, "setSelectedStyleItemView:", v8);
...
- (void)layoutWithItemViews:(id)a3
{
  ...
  if (v6)
  {
    ...
    for (i = 0; i != v6; ++i)
    {
      ...
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6DD0]), "initWithArrangedSubviews:", v10);
  ...
  v43 = v7;
  v14 = (UIStackView *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6DD0]), "initWithArrangedSubviews:", v7);
  ...
  -[PUIStyleItemsViewController view](self, "view");
  ...
  objc_msgSend(MEMORY[0x24BDD1628], "activateConstraints:", v37);
  -[PUIStyleItemsViewController _updateLayoutForCurrentSize](self, "_updateLayoutForCurrentSize");
...
- (void)_updateLayoutForCurrentSize
{
  ...
  if (v6 != self->_interitemSpacing)
  {
    ...
    -[PUIStyleItemsViewController delegate](self, "delegate");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "styleItemsViewControllerDidUpdateEstimatedSize:", self);

  }
  if (v5 != self->_configuredViewWidth)
  {
    -[PUIStyleItemsViewController stackViewLeadingConstraint](self, "stackViewLeadingConstraint");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "constant");
    v16 = v15;
    -[PUIStyleItemsViewController stackViewTrailingConstraint](self, "stackViewTrailingConstraint");
    ...
    if (v5 + -264.0 >= v19)
      ...
      v20 = (v5 + -264.0) * 0.5;
    -[PUIStyleItemsViewController stackViewLeadingConstraint](self, "stackViewLeadingConstraint", (_QWORD)v25);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    v22 = v21;
    if (v20 >= 0.0)
      v23 = v20;
...
- (double)estimatedHeight
{
  ...
  v3 = -[PUIStyleItemsDataSource numberOfCoordinators](self->_dataSource, "numberOfCoordinators");
  if (-[PUIStyleConfiguration colorWellDisplayMode](self->_configuration, "colorWellDisplayMode") == 1)
    v4 = v3 + 1;
  else
    v4 = v3;
...
- (void)setContentsLuminance:(double)a3
{
  ...
  if (-[PUIStyleItemsViewController isViewLoaded](self, "isViewLoaded"))
    -[PUIStyleItemsDataSource setContentsLuminance:](self->_dataSource, "setContentsLuminance:", a3);
}
...
- (void)_didSelectStyleCoordinator:(id)a3
{
  ...
  objc_msgSend(v5, "styleItemsViewController:didSelectContentStyleCoordinator:", self, v4);
...
- (void)_deselectSelectedStyle
{
  ...
  -[PUIStyleSelectableItemView setSelected:](self->_selectedStyleItemView, "setSelected:", 0);
  ...
  -[UIColorWell setSelectedColor:](self->_colorWell, "setSelectedColor:", 0);
...
- (void)setSelectedStyle:(id)a3 fromUIKitPicker:(BOOL)a4
{
  ...
  void *v10;
  unint64_t v11;
  PUIStyleSelectableItemView *v12;
  PUIStyleSelectableItemView *v13;
  PUIStyleSelectableItemView *v14;
  _QWORD v15[4];
  PUIStyleSelectableItemView *v16;
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      v15[3] = &unk_25154C880;
      v16 = (PUIStyleSelectableItemView *)v6;
      -[PUIStyleItemsDataSource firstCoordinatorPassingTest:](dataSource, "firstCoordinatorPassingTest:", v15);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = -[PUIStyleItemsDataSource indexForCoordinator:](self->_dataSource, "indexForCoordinator:", v10);
      ...
      else
      {
        ...
        v12 = (PUIStyleSelectableItemView *)objc_claimAutoreleasedReturnValue();
        ...
        -[PUIStyleSelectableItemView setSelected:](v14, "setSelected:", 1);
      }
...
- (void)colorWellDidUpdateColor:(id)a3
{
  ...
  -[PUIStyleItemsViewController colorWellView](self, "colorWellView");
  v10 = (id)objc_claimAutoreleasedReturnValue();
  -[PUIStyleItemsViewController colorWell](self, "colorWell");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "invalidateIntrinsicContentSize");

  objc_msgSend(v10, "setNeedsLayout");
  -[PUIStyleConfiguration stylePalette](self->_configuration, "stylePalette");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_msgSend(v6, "context") == 2;

  +[PUIStyleUICoordinator coordinatorForColorWellView:vibrant:](PUIStyleUICoordinator, "coordinatorForColorWellView:vibrant:", self->_colorWellView, v7);
  v8 = (PUIStyleUICoordinator *)objc_claimAutoreleasedReturnValue();
  ...
  -[PUIStyleItemsViewController setSelectedStyleCoordinator:](self, "setSelectedStyleCoordinator:", self->_selectedStyleCoordinator);
  -[PUIStyleItemsViewController _didSelectStyleCoordinator:](self, "_didSelectStyleCoordinator:", self->_uiKitColorPickerStyleCoordinator);

}

- (PUIStyleItemsViewControllerDelegate)delegate
{
  return (PUIStyleItemsViewControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
...
{
  objc_storeStrong((id *)&self->_selectedStyleCoordinator, a3);
}
...
{
  objc_storeStrong((id *)&self->_selectedStyleItemView, a3);
}
