...
- (PUIStyleItemsDataSource)initWithConfiguration:(id)a3 includesSuggestedStyle:(BOOL)a4 delegate:(id)a5
{
  id v9;
  id v10;
  PUIStyleItemsDataSource *v11;
  PUIStyleItemsDataSource *v12;
  objc_super v14;
  ...
  v11 = -[PUIStyleItemsDataSource init](&v14, sel_init);
  v12 = v11;
  if (v11)
  {
    ...
    -[PUIStyleItemsDataSource buildCoordinators](v12, "buildCoordinators");
  }
...
- (void)buildCoordinators
{
  ...
  if (!self->_coordinators)
  {
    ...
    -[PUIStyleConfiguration suggestedStyle](self->_configuration, "suggestedStyle");
    v4 = objc_claimAutoreleasedReturnValue();
    -[PUIStyleConfiguration stylePalette](self->_configuration, "stylePalette");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v24 = (void *)v4;
    if (self->_includeSuggestedStyle
      && -[PUIStyleConfiguration showsSuggestedContentStyleItem](self->_configuration, "showsSuggestedContentStyleItem")
      && v4)
    {
      WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
      objc_msgSend(WeakRetained, "coordinatorForStyle:isSuggestedStyle:fromDataSource:", v4, 1, self);
      v7 = (PUIStyleUICoordinator *)objc_claimAutoreleasedReturnValue();

      if (!v7)
        v7 = -[PUIStyleUICoordinator initWithInitialStyle:suggested:]([PUIStyleUICoordinator alloc], "initWithInitialStyle:suggested:", v4, 1);
      ...
      if (objc_msgSend(v5, "isDefaultPalette") && objc_msgSend(v5, "context") == 1)
      {
        ...
        v12 = -[PUIStylePalette initWithStyles:localizedName:](v10, "initWithStyles:localizedName:", v9, v11);
    ...
    if (v14)
    {
      ...
      do
      {
        for (i = 0; i != v15; ++i)
        {
          ...
          v20 = (PUIStyleUICoordinator *)objc_claimAutoreleasedReturnValue();

          if (!v20)
            v20 = -[PUIStyleUICoordinator initWithInitialStyle:suggested:]([PUIStyleUICoordinator alloc], "initWithInitialStyle:suggested:", v18, 0);
...
{
  return (PUIStyleItemsDataSourceDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
