...
- (void)setContentsLuminance:(double)a3
{
  ...
  v5 = -[PUIStyleVibrantMonochrome initWithBackgroundType:]([PUIStyleVibrantMonochrome alloc], "initWithBackgroundType:", a3 <= 0.9);
  -[PUIStyleUICoordinatorImpl setStyle:](self, "setStyle:", v5);
  itemView = self->_itemView;
  -[PUIStyleVibrantMonochrome effectiveColor](v5, "effectiveColor");
...
- (id)itemView
{
  ...
  if (!itemView)
  {
    ...
    v5 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6F90]), "initWithFrame:", 0.0, 0.0, 50.0, 50.0);
