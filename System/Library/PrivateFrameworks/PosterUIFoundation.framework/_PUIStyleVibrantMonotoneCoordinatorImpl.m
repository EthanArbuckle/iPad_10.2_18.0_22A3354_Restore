...
- (id)transparancyBackgroundImageForHeight:(double)a3
{
  ...
  {
    v10 = fmax(a3 / 3.0, 0.5);
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6A98]), "initWithSize:", v10 + v10, v10 + v10);
    ...
    *(double *)&v16[4] = v10;
    ...
    objc_msgSend(v12, "resizableImageWithCapInsets:resizingMode:", 0, *MEMORY[0x24BDF7718], *(double *)(MEMORY[0x24BDF7718] + 8), *(double *)(MEMORY[0x24BDF7718] + 16), *(double *)(MEMORY[0x24BDF7718] + 24));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_minDisplayColor
{
  ...
  if (v4)
  {
    ...
    v8 = -[PUIStyleDiscreteColors initWithOpaqueColors:variation:](v5, "initWithOpaqueColors:variation:", v7, -1.0);

    -[PUIStyleDiscreteColors variationAppliedColors](v8, "variationAppliedColors");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_maxDisplayColor
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(v6, "colors");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = -[PUIStyleDiscreteColors initWithOpaqueColors:variation:](v5, "initWithOpaqueColors:variation:", v7, 0.0);
...
- (id)_sliderThumbDisplayColor
{
  ...
  if (v4)
  {
    -[PUIStyleUICoordinatorImpl variation](self, "variation");
    v6 = (v5 + 1.0) * 0.5 + -1.0;
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = -[PUIStyleDiscreteColors initWithOpaqueColors:variation:](v7, "initWithOpaqueColors:variation:", v9, v6);

    -[PUIStyleDiscreteColors variationAppliedColors](v10, "variationAppliedColors");
...
- (id)_itemDisplayColor
{
  ...
  {
    -[_PUIStyleVibrantMonotoneCoordinatorImpl _effectiveColor](self, "_effectiveColor");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v12;
}
...
- (void)setVariation:(double)a3
{
  ...
  if (v6)
  {
    ...
    -[PUIStyleUICoordinatorImpl setVariation:](&v11, sel_setVariation_, a3);
    itemViewContentView = self->_itemViewContentView;
    -[_PUIStyleVibrantMonotoneCoordinatorImpl _itemDisplayColor](self, "_itemDisplayColor");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[_PUIStyleVibrantMonotoneCoordinatorImpl _sliderThumbDisplayColor](self, "_sliderThumbDisplayColor");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)variationSliderTrackView
{
  ...
  {
    v4 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6F90]), "initWithFrame:", 0.0, 0.0, 100.0, 50.0);
    objc_msgSend(MEMORY[0x24BDF6950], "whiteColor");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[UIView setBackgroundColor:](v4, "setBackgroundColor:", v5);
    ...
    -[UIView bounds](v4, "bounds");
    v7 = -[PUIGradientView initWithFrame:usesBlur:](v6, "initWithFrame:usesBlur:", 0);
    -[_PUIStyleVibrantMonotoneCoordinatorImpl _minDisplayColor](self, "_minDisplayColor");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_PUIStyleVibrantMonotoneCoordinatorImpl _maxDisplayColor](self, "_maxDisplayColor");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
