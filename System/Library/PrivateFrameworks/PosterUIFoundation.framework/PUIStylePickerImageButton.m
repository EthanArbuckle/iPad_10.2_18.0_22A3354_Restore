...
- (PUIStylePickerImageButton)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[PUIStylePickerImageButton addSubview:](v3, "addSubview:", v3->_contentImageView);
    v19 = (void *)MEMORY[0x24BDD1628];
    -[UIImageView topAnchor](v3->_contentImageView, "topAnchor");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    -[PUIStylePickerImageButton topAnchor](v3, "topAnchor");
    ...
    -[PUIStylePickerImageButton bottomAnchor](v3, "bottomAnchor");
    ...
    -[PUIStylePickerImageButton centerXAnchor](v3, "centerXAnchor");
    ...
    -[PUIStylePickerImageButton leadingAnchor](v3, "leadingAnchor");
    ...
    -[PUIStylePickerImageButton trailingAnchor](v3, "trailingAnchor");
...
- (void)configureWithSystemImageNamed:(id)a3
{
  ...
  -[PUIStylePickerImageButton _configureWithSystemImage:](self, "_configureWithSystemImage:", v4);
...
- (void)configureWithSystemImageNamed:(id)a3 configuration:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDF6AC8], "_systemImageNamed:withConfiguration:", a3, a4);
  v5 = (id)objc_claimAutoreleasedReturnValue();
  -[PUIStylePickerImageButton _configureWithSystemImage:](self, "_configureWithSystemImage:", v5);
