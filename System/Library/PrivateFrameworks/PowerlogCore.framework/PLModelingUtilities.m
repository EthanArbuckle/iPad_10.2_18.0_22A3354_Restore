...
void __29__PLModelingUtilities_isiPad__block_invoke()
{
  ...
  isiPad_isiPad_0 = objc_msgSend(v0, "isEqualToString:", CFSTR("iPad"));
...
{
  if (isiPhone_once != -1)
    dispatch_once(&isiPhone_once, &__block_literal_global_23_1);
...
void __31__PLModelingUtilities_isiPhone__block_invoke()
{
  ...
  +[PLModelingUtilities valueForMobileGestaltCapability:](PLModelingUtilities, "valueForMobileGestaltCapability:", CFSTR("DeviceClass"));
  v0 = (id)objc_claimAutoreleasedReturnValue();
  isiPhone_isiPhone_0 = objc_msgSend(v0, "isEqualToString:", CFSTR("iPhone"));
...
{
  if (isiPod_once != -1)
    dispatch_once(&isiPod_once, &__block_literal_global_26);
...
void __29__PLModelingUtilities_isiPod__block_invoke()
{
  ...
  +[PLModelingUtilities valueForMobileGestaltCapability:](PLModelingUtilities, "valueForMobileGestaltCapability:", CFSTR("DeviceClass"));
  v0 = (id)objc_claimAutoreleasedReturnValue();
  isiPod_isiPod_0 = objc_msgSend(v0, "isEqualToString:", CFSTR("iPod"));
...
{
  if (isWatch_once != -1)
    dispatch_once(&isWatch_once, &__block_literal_global_29_0);
...
void __30__PLModelingUtilities_isWatch__block_invoke()
{
  ...
  +[PLModelingUtilities valueForMobileGestaltCapability:](PLModelingUtilities, "valueForMobileGestaltCapability:", CFSTR("DeviceClass"));
  v0 = (id)objc_claimAutoreleasedReturnValue();
  isWatch_isWatch_0 = objc_msgSend(v0, "isEqualToString:", CFSTR("Watch"));
...
void __32__PLModelingUtilities_isAppleTV__block_invoke()
{
  ...
  +[PLModelingUtilities valueForMobileGestaltCapability:](PLModelingUtilities, "valueForMobileGestaltCapability:", CFSTR("DeviceClass"));
  v0 = (id)objc_claimAutoreleasedReturnValue();
  isAppleTV_isAppleTV_0 = objc_msgSend(v0, "isEqualToString:", CFSTR("AppleTV"));
...
+ (BOOL)internalBuild
{
  if (internalBuild_onceToken_0 != -1)
    dispatch_once(&internalBuild_onceToken_0, &__block_literal_global_146);
...
+ (BOOL)isLowPowerModeSupported
{
  if (isLowPowerModeSupported_onceToken != -1)
    dispatch_once(&isLowPowerModeSupported_onceToken, &__block_literal_global_180_0);
...
+ (BOOL)isHeySiriAlwaysOn
{
  if (isHeySiriAlwaysOn_onceToken != -1)
    dispatch_once(&isHeySiriAlwaysOn_onceToken, &__block_literal_global_194_0);
...
+ (BOOL)hasAOD
{
  if (hasAOD_onceToken_0 != -1)
    dispatch_once(&hasAOD_onceToken_0, &__block_literal_global_197_0);
