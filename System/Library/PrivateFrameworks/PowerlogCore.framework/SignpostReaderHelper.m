...
- (id)generateRapidMSSWithStartDate:(id)a3 endDate:(id)a4 atPath:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v11;
      _os_log_error_impl(&dword_1B6AB6000, v14, OS_LOG_TYPE_ERROR, "Invalid arguments: startDate=%@ endDate=%@ path=%@", (uint8_t *)&v16, 0x20u);
    }
...
- (id)processSignpostWithConfig:(id)a3 withServiceType:(int)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)((char *)&v32 + 2) = v6;
    _os_log_impl(&dword_1B6AB6000, v7, OS_LOG_TYPE_INFO, "processSignpost for service type (%d) with config %@", buf, 0x12u);
  }
  ...
  *((_QWORD *)&v32 + 1) = 0x3032000000;
  ...
  switch(a4)
  {
    ...
    default:
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)v25 = 67109120;
        LODWORD(v26) = a4;
        _os_log_impl(&dword_1B6AB6000, v10, OS_LOG_TYPE_INFO, "Unknown service type specified: %d", v25, 8u);
      }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v25 = 138412290;
    v26 = v12;
    _os_log_impl(&dword_1B6AB6000, v11, OS_LOG_TYPE_INFO, "The successful reply happened: %@", v25, 0xCu);
  }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)v25 = 134218498;
    ...
    v29 = 2112;
    v30 = v13;
    _os_log_impl(&dword_1B6AB6000, v16, OS_LOG_TYPE_INFO, "Time for signpost reading to run: %f, %@, %@", v25, 0x20u);
  }
...
- (id)createXPCConnection
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3B50], "interfaceWithProtocol:", &unk_1EF15EEB8);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[NSXPCConnection setRemoteObjectInterface:](self->_connectionToServer, "setRemoteObjectInterface:", v6);

  -[NSXPCConnection setInterruptionHandler:](self->_connectionToServer, "setInterruptionHandler:", &__block_literal_global_41_0);
  -[NSXPCConnection setInvalidationHandler:](self->_connectionToServer, "setInvalidationHandler:", &__block_literal_global_43_0);
...
- (void)generateRapidSignpostSummaryWithStartDate:endDate:.cold.1()
{
  ...
  v3 = 2112;
  v4 = v0;
  _os_log_error_impl(&dword_1B6AB6000, v1, OS_LOG_TYPE_ERROR, "Invalid arguments: startDate=%@ endDate=%@", v2, 0x16u);
...
void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_1B6AB6000, v0, v1, "submitSignpostDataWithConfig: %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_0();
}
...
void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_26_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_1B6AB6000, v0, v1, "summarizeSignpostMetrics: %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_0();
}
...
void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_27_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_1B6AB6000, v0, v1, "aggregateSignpostData : %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_0();
}
...
void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_28_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_1B6AB6000, v0, v1, "readRawSignpostData : %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_0();
}
...
void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_29_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_1B6AB6000, v0, v1, "generateMSSReportForRAPID : %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_0();
}
...
void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_30_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_1B6AB6000, v0, v1, "generateMSSReportForTasking : %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_0();
}
...
void __43__SignpostReaderHelper_createXPCConnection__block_invoke_44_cold_1(void *a1, NSObject *a2)
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2();
  _os_log_error_impl(&dword_1B6AB6000, a2, OS_LOG_TYPE_ERROR, "Connection error happened %@", v4, 0xCu);
