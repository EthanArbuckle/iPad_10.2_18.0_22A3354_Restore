...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  CGFloat x;
  id v8;
  _TtC8PaperKit26CanvasElementContainerView *v9;
  UIView_optional *v10;
  void *v11;
  void *v12;
  ...
  CanvasElementContainerView.hitTest(_:with:)(v10, (CGPoint)__PAIR128__(*(unint64_t *)&y, *(unint64_t *)&x), v14);
  v12 = v11;
...
- (_TtC8PaperKit26CanvasElementContainerView)initWithCoder:(id)a3
{
  ...
  return -[CanvasElementContainerView initWithCoder:](&v5, sel_initWithCoder_, a3);
}
