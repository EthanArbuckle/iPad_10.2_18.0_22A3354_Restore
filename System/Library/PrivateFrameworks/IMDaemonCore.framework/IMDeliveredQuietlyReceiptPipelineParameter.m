...
- (IMDeliveredQuietlyReceiptPipelineParameter)initWithDefusedMessage:(id)a3 idsTrustedData:(id)a4
{
  ...
  void *v17;
  uint64_t v18;
  IMDeliveredQuietlyReceiptPipelineParameter *v19;
  ...
  v19 = -[IMDeliveredQuietlyReceiptPipelineParameter initWithIdsTrustedData:GUID:timestamp:isFromStorage:isLastFromStorage:](self, "initWithIdsTrustedData:GUID:timestamp:isFromStorage:isLastFromStorage:", v6, v10, v13, v16, v18);
  return v19;
}
...
- (IMDeliveredQuietlyReceiptPipelineParameter)initWithIdsTrustedData:(id)a3 GUID:(id)a4 timestamp:(id)a5 isFromStorage:(BOOL)a6 isLastFromStorage:(BOOL)a7
{
  ...
  id v13;
  id v14;
  IMDeliveredQuietlyReceiptPipelineParameter *v15;
  uint64_t v16;
  ...
  v15 = -[IMDeliveredQuietlyReceiptPipelineParameter init](&v27, sel_init);
  if (v15)
  {
...
- (id)description
{
  ...
  -[IMDeliveredQuietlyReceiptPipelineParameter GUID](self, "GUID");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[IMDeliveredQuietlyReceiptPipelineParameter timestamp](self, "timestamp");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (-[IMDeliveredQuietlyReceiptPipelineParameter isFromStorage](self, "isFromStorage"))
    v6 = CFSTR("YES");
  else
    v6 = CFSTR("NO");
  if (-[IMDeliveredQuietlyReceiptPipelineParameter isLastFromStorage](self, "isLastFromStorage"))
    v7 = CFSTR("YES");
  else
    v7 = CFSTR("NO");
  -[IMDeliveredQuietlyReceiptPipelineParameter idsTrustedData](self, "idsTrustedData");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[IMDeliveredQuietlyReceiptPipelineParameter chat](self, "chat");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[IMDeliveredQuietlyReceiptPipelineParameter messageItems](self, "messageItems");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<IMDeliveredQuietlyReceiptPipelineParameter %p; GUID = %@; timestamp = %@; isFromStorage = %@; isLastFromStorage = %@; idsTrustedData = %@; OUTPUT chat = %@; numMessageItems = %lu}"),
    self,
    v4,
    v5,
    v6,
