...
+ (id)JSONStringFromNSDictionary:()RTExtensions error:
{
  ...
  if ((objc_msgSend(MEMORY[0x1E0CB36D8], "isValidJSONObject:", v5) & 1) != 0)
  {
    ...
    if (v7)
    {
      ...
      objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("NSJSONSerialization failed"), &stru_1E4FB1A18, 0);
  ...
  else
  {
    ...
    objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("Invalid dictionary for JSON serialization"), &stru_1E4FB1A18, 0);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v21[0] = v13;
    v20[1] = *MEMORY[0x1E0CB2D80];
    objc_msgSend(MEMORY[0x1E0CB34D0], "mainBundle");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("Refer to NSJSONSerialization spec for valid dictionaries"), &stru_1E4FB1A18, 0);
