...
- (RTTripSegmentRoadClass)initWithDateInterval:(id)a3 distanceInterval:(id)a4 geoRoadClass:(int64_t)a5
{
  ...
  id v10;
  void *v11;
  RTTripSegmentRoadClass *v12;
  RTTripSegmentRoadClass *v13;
  NSObject *v14;
  RTTripSegmentRoadClass *v15;
  NSObject *v16;
  const char *v17;
  objc_super v19;
  uint8_t buf[4];
  RTTripSegmentRoadClass *v21;
  uint64_t v22;
...
LABEL_14:
  ...
  v12 = -[RTTripSegmentRoadClass init](&v19, sel_init);
  v13 = v12;
  if (v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      v21 = v13;
      _os_log_debug_impl(&dword_1A5E26000, v14, OS_LOG_TYPE_DEBUG, "tripSegmentRoadClass, %@", buf, 0xCu);
    }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v5, "encodeInt64:forKey:", self->_geoRoadClass, CFSTR("geoRoadClass"));
...
- (RTTripSegmentRoadClass)initWithCoder:(id)a3
{
  ...
  v7 = objc_msgSend(v4, "decodeIntForKey:", CFSTR("geoRoadClass"));

  v8 = -[RTTripSegmentRoadClass initWithDateInterval:distanceInterval:geoRoadClass:](self, "initWithDateInterval:distanceInterval:geoRoadClass:", v5, v6, v7);
  return v8;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v13 = objc_msgSend(v4, "geoRoadClass");
...
- (id)description
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("dateInterval,%@,distanceInterval,%@,geoRoadClass,%ld"), v4, v5, self->_geoRoadClass);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
