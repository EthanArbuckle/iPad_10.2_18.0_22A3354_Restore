...
{
  void *v3;
  RTStoredElevationEnumerationContext *v4;

  v3 = (void *)objc_opt_new();
  v4 = -[RTStoredElevationEnumerationContext initWithEnumerationOptions:offset:](self, "initWithEnumerationOptions:offset:", v3, 0);
...
{
  return -[RTStoredElevationEnumerationContext initWithEnumerationOptions:offset:](self, "initWithEnumerationOptions:offset:", a3, 0);
}

- (RTStoredElevationEnumerationContext)initWithEnumerationOptions:(id)a3 offset:(unint64_t)a4
{
  id v6;
  RTStoredElevationEnumerationContext *v7;
  uint64_t v8;
  ...
  v7 = -[RTStoredElevationEnumerationContext init](&v11, sel_init);
  if (v7)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RTStoredElevationEnumerationContext options](self, "options");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v4, "initWithEnumerationOptions:offset:", v5, -[RTStoredElevationEnumerationContext offset](self, "offset"));
...
- (RTStoredElevationEnumerationContext)initWithCoder:(id)a3
{
  ...
  v7 = -[RTStoredElevationEnumerationContext initWithEnumerationOptions:offset:](self, "initWithEnumerationOptions:offset:", v5, v6);
  return v7;
}
...
{
  RTStoredElevationEnumerationContext *v4;
  RTStoredElevationEnumerationContext *v5;
  BOOL v6;

  v4 = (RTStoredElevationEnumerationContext *)a3;
  v5 = v4;
  if (v4 == self)
    v6 = 1;
  else
    v6 = v4
      ...
      && -[RTStoredElevationEnumerationContext isEqualToContext:](self, "isEqualToContext:", v5);
...
LABEL_4:
    ...
    v10 = -[RTStoredElevationEnumerationOptions isEqual:](v8, "isEqual:", v9);
...
- (unint64_t)hash
{
  ...
  v3 = -[RTStoredElevationEnumerationOptions hash](self->_options, "hash");
