...
- (RTTripSegmentInertialDataEnumerationOptions)init
{
  ...
  void *v5;
  void *v6;
  RTTripSegmentInertialDataEnumerationOptions *v7;
  ...
  v7 = -[RTTripSegmentInertialDataEnumerationOptions initWithDateInterval:](self, "initWithDateInterval:", v6);
  return v7;
}
...
- (RTTripSegmentInertialDataEnumerationOptions)initWithDateInterval:(id)a3
{
  ...
  v7 = -[RTTripSegmentInertialDataEnumerationOptions init](&v11, sel_init);
  if (v7)
  {
    if (v6)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RTTripSegmentInertialDataEnumerationOptions dateInterval](self, "dateInterval");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (RTTripSegmentInertialDataEnumerationOptions)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  RTTripSegmentInertialDataEnumerationOptions *v6;

  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("dateInterval"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  v6 = -[RTTripSegmentInertialDataEnumerationOptions initWithDateInterval:](self, "initWithDateInterval:", v5);
  return v6;
}

- (BOOL)isEqual:(id)a3
{
  RTTripSegmentInertialDataEnumerationOptions *v4;
  RTTripSegmentInertialDataEnumerationOptions *v5;
  BOOL v6;

  v4 = (RTTripSegmentInertialDataEnumerationOptions *)a3;
  v5 = v4;
  if (v4 == self)
    v6 = 1;
  else
    v6 = v4
      ...
      && -[RTTripSegmentInertialDataEnumerationOptions isEqualToOptions:](self, "isEqualToOptions:", v5);
