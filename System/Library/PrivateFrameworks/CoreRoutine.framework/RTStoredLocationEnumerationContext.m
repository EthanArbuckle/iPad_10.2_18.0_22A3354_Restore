...
{
  void *v3;
  RTStoredLocationEnumerationContext *v4;

  v3 = (void *)objc_opt_new();
  v4 = -[RTStoredLocationEnumerationContext initWithEnumerationOptions:offset:](self, "initWithEnumerationOptions:offset:", v3, 0);
...
{
  return -[RTStoredLocationEnumerationContext initWithEnumerationOptions:offset:](self, "initWithEnumerationOptions:offset:", a3, 0);
}

- (RTStoredLocationEnumerationContext)initWithEnumerationOptions:(id)a3 offset:(unint64_t)a4
{
  id v6;
  RTStoredLocationEnumerationContext *v7;
  uint64_t v8;
  ...
  v7 = -[RTStoredLocationEnumerationContext init](&v11, sel_init);
  if (v7)
  {
    if (v6)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[RTStoredLocationEnumerationContext options](self, "options");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v4, "initWithEnumerationOptions:offset:", v5, -[RTStoredLocationEnumerationContext offset](self, "offset"));
...
- (RTStoredLocationEnumerationContext)initWithCoder:(id)a3
{
  ...
  v7 = -[RTStoredLocationEnumerationContext initWithEnumerationOptions:offset:](self, "initWithEnumerationOptions:offset:", v5, v6);
  return v7;
}
...
{
  RTStoredLocationEnumerationContext *v4;
  RTStoredLocationEnumerationContext *v5;
  BOOL v6;

  v4 = (RTStoredLocationEnumerationContext *)a3;
  v5 = v4;
  if (v4 == self)
    v6 = 1;
  else
    v6 = v4
      ...
      && -[RTStoredLocationEnumerationContext isEqualToContext:](self, "isEqualToContext:", v5);
...
- (BOOL)isEqualToContext:(id)a3
{
  ...
  void *v6;
  RTStoredLocationEnumerationOptions *options;
  RTStoredLocationEnumerationOptions *v8;
  void *v9;
  char v10;
  unint64_t offset;
  BOOL v12;
...
LABEL_4:
    ...
    v10 = -[RTStoredLocationEnumerationOptions isEqual:](v8, "isEqual:", v9);
...
- (unint64_t)hash
{
  ...
  v3 = -[RTStoredLocationEnumerationOptions hash](self->_options, "hash");
