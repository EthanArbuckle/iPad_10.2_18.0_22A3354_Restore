...
- (id)description
{
  ...
  -[AWDDEDBugSessionCreated description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDDEDBugSessionCreated dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (hostapp)
    objc_msgSend(v3, "setObject:forKey:", hostapp, CFSTR("hostapp"));
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copyWithZone:](self->_hostapp, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
LABEL_9:
  ...
  hostapp = self->_hostapp;
  if ((unint64_t)hostapp | *((_QWORD *)v4 + 2))
    v6 = -[NSString isEqual:](hostapp, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSString hash](self->_hostapp, "hash") ^ v2;
}
...
{
  objc_storeStrong((id *)&self->_hostapp, a3);
}
