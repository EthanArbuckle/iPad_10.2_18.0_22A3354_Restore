...
- (BOOL)_shouldAnimatePropertyWithKey:(id)a3
{
  ...
  v4 = a3;
  -[SBPropertyAnimatingView animatedLayerProperties](self, "animatedLayerProperties");
  ...
  else
  {
    ...
    v7 = -[SBPropertyAnimatingView _shouldAnimatePropertyWithKey:](&v9, sel__shouldAnimatePropertyWithKey_, v4);
  }
