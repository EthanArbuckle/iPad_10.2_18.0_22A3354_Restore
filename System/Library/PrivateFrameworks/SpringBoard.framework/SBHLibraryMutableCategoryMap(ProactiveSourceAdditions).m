...
- (uint64_t)sb_hasAppsPopulatedForCategoriesOtherThanProactive
{
  ...
  v16 = 0u;
  v17 = 0u;
  objc_msgSend(a1, "categoryIdentifiers", 0);
  ...
  if (v3)
  {
    ...
    while (2)
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        if (v8 > 7 || ((1 << v8) & 0x98) == 0)
        {
          objc_msgSend(a1, "sortedApplicationIdentifiersForCategoryIdentifier:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        if (objc_msgSend(v11, "predictionCategoryID") == a3)
          objc_msgSend(a1, "removeCategoryIdentifier:", v11);
      }
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        v9 = objc_msgSend(v8, "predictionCategoryID");
        if (v9 > 7 || ((1 << v9) & 0x98) == 0)
          objc_msgSend(a1, "removeCategoryIdentifier:", v8);
      }
