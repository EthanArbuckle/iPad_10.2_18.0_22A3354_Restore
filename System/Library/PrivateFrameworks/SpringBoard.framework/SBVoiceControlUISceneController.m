...
+ (id)_setupInfo
{
  ...
  v5[2] = CFSTR("isDaemon");
  v5[3] = CFSTR("jobLabel");
  v6[3] = CFSTR("com.apple.commandandcontrol");
  v6[4] = &unk_1E91CF5F8;
  v5[4] = CFSTR("hostLevel");
  v5[5] = CFSTR("traitsRole");
  v5[6] = CFSTR("workspaceID");
  v6[5] = CFSTR("SBTraitsParticipantRoleAXVoiceControlUI");
  v6[6] = CFSTR("com.apple.SpringBoard.SceneWorkspace.VoiceControlUI");
