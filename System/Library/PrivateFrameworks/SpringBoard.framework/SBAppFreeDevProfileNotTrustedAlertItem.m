...
{
  id v5;
  SBAppFreeDevProfileNotTrustedAlertItem *v6;
  SBAppFreeDevProfileNotTrustedAlertItem *v7;
...
- (void)configure:(BOOL)a3 requirePasscodeForActions:(BOOL)a4
{
  ...
  objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_TITLE"), &stru_1E8EC7EC0, CFSTR("SpringBoard"));
  ...
  objc_msgSend(MEMORY[0x1E0CEA508], "modelSpecificLocalizedStringKeyForKey:", CFSTR("APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_BODY"));
  ...
  objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_CANCEL"), &stru_1E8EC7EC0, CFSTR("SpringBoard"));
