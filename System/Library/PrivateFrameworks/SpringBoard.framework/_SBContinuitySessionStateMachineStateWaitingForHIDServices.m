...
- (_SBContinuitySessionStateMachineStateWaitingForHIDServices)initWithSystemEventMonitor:(id)a3 continuityDisplayAuthenticationCoordinator:(id)a4
{
  id v7;
  id v8;
  _SBContinuitySessionStateMachineStateWaitingForHIDServices *v9;
  _SBContinuitySessionStateMachineStateWaitingForHIDServices *v10;
  objc_super v12;
  ...
  v9 = -[_SBContinuitySessionStateMachineStateWaitingForHIDServices init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (void)noteClientConfiguredHIDServices
{
  ...
  -[_SBContinuitySessionStateMachineStateWaitingForHIDServices _reevaluateStateForReason:](self, "_reevaluateStateForReason:", CFSTR("scene connected"));
}
...
- (void)enteredStateFrom:(unint64_t)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1D0540000, v5, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "SB_ONENESS_STATE_MACHINE_WAITING_FOR_HID_SERVICES", (const char *)&unk_1D0E9B6CB, buf, 2u);
  }

  -[_SBContinuitySessionStateMachineStateWaitingForHIDServices _evaluateClientExternallyBlockedReasons](self, "_evaluateClientExternallyBlockedReasons");
  -[_SBContinuitySessionStateMachineStateWaitingForHIDServices _evaluateLockState](self, "_evaluateLockState");
  -[_SBContinuitySessionStateMachineStateWaitingForHIDServices _evaluateSystemEvents](self, "_evaluateSystemEvents");
  v6 = (void *)MEMORY[0x1E0CB3940];
  NSStringFromSBContinuitySessionState(a3);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "stringWithFormat:", CFSTR("entered state from: %@"), v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[_SBContinuitySessionStateMachineStateWaitingForHIDServices _reevaluateStateForReason:](self, "_reevaluateStateForReason:", v8);
...
- (void)exitedStateTo:(unint64_t)a3
{
  ...
  {
    *(_WORD *)v4 = 0;
    _os_signpost_emit_with_name_impl(&dword_1D0540000, v3, OS_SIGNPOST_INTERVAL_END, 0xEEEEB0B5B2B2EEEELL, "SB_ONENESS_STATE_MACHINE_WAITING_FOR_HID_SERVICES", (const char *)&unk_1D0E9B6CB, v4, 2u);
  }
...
- (void)continuityDisplayAuthenticationCoordinatorDidUpdateLockState:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    -[_SBContinuitySessionStateMachineStateFlushing continuityDisplayAuthenticationCoordinatorDidUpdateLockState:].cold.1(v4, v5);

  -[_SBContinuitySessionStateMachineStateWaitingForHIDServices _evaluateLockState](self, "_evaluateLockState");
  -[_SBContinuitySessionStateMachineStateWaitingForHIDServices _reevaluateStateForReason:](self, "_reevaluateStateForReason:", CFSTR("lock state change"));
...
- (void)_evaluateClientExternallyBlockedReasons
{
  ...
  if (!WeakRetained)
  {
    ...
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_SBContinuitySessionStateMachineStateWaitingForHIDServices.m"), 118, CFSTR("Must have _SBContinuitySessionStateMachineExternallyBlockedReasonsProvider"));
  ...
  if (self->_isCurrentState && objc_msgSend(v5, "count"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_1D0540000, v7, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because client blocked reasons are unexpected: %{public}@", (uint8_t *)&v10, 0xCu);
...
- (void)_evaluateSystemEvents
{
  ...
  if (self->_isCurrentState)
  {
    if (-[SBContinuitySessionSystemEventMonitor isUIBlocked](self->_systemEventMonitor, "isUIBlocked"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v3, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because UI blocked ", v15, 2u);
      }
...
LABEL_14:
    ...
    if (!-[SBContinuitySessionSystemEventMonitor isUILocked](self->_systemEventMonitor, "isUILocked"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v8, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because UI unlocked", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isInCall](self->_systemEventMonitor, "isInCall"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v7, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because in call", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isSOSActive](self->_systemEventMonitor, "isSOSActive"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v10, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because SOS active", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isLockScreenSearchPresented](self->_systemEventMonitor, "isLockScreenSearchPresented"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v11, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because lock screen search presented", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isUsingSecureApp](self->_systemEventMonitor, "isUsingSecureApp"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v12, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because using secure app", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isAirplayMirroring](self->_systemEventMonitor, "isAirplayMirroring"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v13, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because airplay mirroring", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isUserInitiatedRemoteTransientOverlayPresented](self->_systemEventMonitor, "isUserInitiatedRemoteTransientOverlayPresented"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v14, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because user-initiated remote transient overlay is presented", v15, 2u);
      }
...
- (void)_evaluateLockState
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (v3 == 2)
    {
      ...
      {
        *(_WORD *)v10 = 0;
        _os_log_impl(&dword_1D0540000, v8, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid keybag has been unexpectedly unlocked", v10, 2u);
      }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1D0540000, v4, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid keybag has been unexpectedly locked", buf, 2u);
      }
...
- (void)_reevaluateStateForReason:(id)a3
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      v13 = 138543362;
      v14 = v4;
      _os_log_impl(&dword_1D0540000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] Re-evaluating state for reason: %{public}@", (uint8_t *)&v13, 0xCu);
    }
    ...
    if (!self->_configuredHIDServices)
      objc_msgSend(v6, "addObject:", CFSTR("checkpoint.waiting-for-configured-HIDServices"));
    ...
    if (v8)
    {
      if (v10)
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_1D0540000, v9, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] still blocked by %{public}@", (uint8_t *)&v13, 0xCu);
    ...
    else
    {
      ...
      {
        LOWORD(v13) = 0;
        _os_log_impl(&dword_1D0540000, v9, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .Activating", (uint8_t *)&v13, 2u);
      }
