...
- (SBHideFolderContentsAlertItem)initWithIcon:(id)a3 location:(id)a4
{
  id v8;
  id v9;
  SBHideFolderContentsAlertItem *v10;
  SBHideFolderContentsAlertItem *v11;
  uint64_t v12;
  ...
  v8 = a3;
  v9 = a4;
  if ((objc_msgSend(v8, "isFolderIcon") & 1) == 0)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SBHideFolderContentsAlertItem.m"), 19, CFSTR("icon must be a folder icon : icon=%@"), v8);
...
- (void)configure:(BOOL)a3 requirePasscodeForActions:(BOOL)a4
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SBHideFolderContentsAlertItem icon](self, "icon");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)MEMORY[0x1E0CB3940];
  objc_msgSend(MEMORY[0x1E0CB34D0], "mainBundle");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("ADD_FOLDER_TO_LIBRARY_ALERT_TITLE"), &stru_1E8EC7EC0, CFSTR("SpringBoard"));
  ...
  objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("ADD_FOLDER_TO_LIBRARY_ALERT_MESSAGE"), &stru_1E8EC7EC0, CFSTR("SpringBoard"));
  ...
  v24[1] = 3221225472;
  v24[2] = __69__SBHideFolderContentsAlertItem_configure_requirePasscodeForActions___block_invoke;
  v24[3] = &unk_1E8E9DC88;
  v24[4] = self;
  v25 = v6;
  v18 = v6;
  ...
  v23[0] = v17;
  v23[1] = 3221225472;
  v23[2] = __69__SBHideFolderContentsAlertItem_configure_requirePasscodeForActions___block_invoke_25;
  v23[3] = &unk_1E8E9DCB0;
  v23[4] = self;
...
void __69__SBHideFolderContentsAlertItem_configure_requirePasscodeForActions___block_invoke_25(uint64_t a1)
{
  void *v1;
  void *v2;
  id v3;
