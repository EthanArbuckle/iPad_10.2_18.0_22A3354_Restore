...
- (id)_iconDragPreviewContainerView
{
  ...
  -[SBIconDragPlatterWindow rootViewController](self, "rootViewController");
...
- (void)beginTrackingPlatterView:(id)a3
{
  ...
  -[SBIconDragPlatterWindow _iconDragPreviewContainerView](self, "_iconDragPreviewContainerView");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "addSubview:", v9);

  -[SBWindow setHidden:](self, "setHidden:", 0);
}
...
- (void)stopTrackingPlatterView:(id)a3
{
  ...
  -[SBWindow setHidden:](self, "setHidden:", -[NSHashTable count](self->_platterViews, "count") == 0);
}
