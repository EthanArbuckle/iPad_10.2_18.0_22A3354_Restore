...
{
  id v4;
  SBTraitsUserInterfaceStyleStageComponent *v5;
  uint64_t v6;
  ...
  v5 = -[SBTraitsUserInterfaceStyleStageComponent init](&v9, sel_init);
  if (v5)
  {
...
{
  return -[SBTraitsUserInterfaceStyleStageComponent initWithComponentOrder:](self, "initWithComponentOrder:", &unk_1E91D0710);
}
...
- (NSString)description
{
  ...
  -[SBTraitsUserInterfaceStyleStageComponent description](&v8, sel_description);
