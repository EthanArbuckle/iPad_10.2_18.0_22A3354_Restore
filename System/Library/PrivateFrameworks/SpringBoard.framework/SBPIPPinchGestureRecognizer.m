...
{
  SBPIPPinchGestureRecognizer *v4;
  SBPIPPinchGestureRecognizer *v5;
  CGFloat v6;
  NSMutableSet *v7;
  ...
  v4 = -[SBPIPPinchGestureRecognizer initWithTarget:action:](&v10, sel_initWithTarget_action_, a3, a4);
  v5 = v4;
  if (v4)
  {
...
- (void)setDelegate:(id)a3
{
  ...
  -[SBPIPPinchGestureRecognizer setDelegate:](&v3, sel_setDelegate_, a3);
}
...
- (SBPIPSystemGestureRecognizerDelegate)delegate
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SBPIPPinchGestureRecognizer;
  -[SBPIPPinchGestureRecognizer delegate](&v3, sel_delegate);
...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  -[SBPIPPinchGestureRecognizer touchesBegan:withEvent:](&v17, sel_touchesBegan_withEvent_, v6, a4);
      ...
      while (2)
      {
        for (i = 0; i != v9; ++i)
        {
          ...
          if (-[NSMutableSet count](self->_touches, "count", (_QWORD)v13) >= self->_maximumNumberOfTouches)
          {
            ...
            -[SBPIPPinchGestureRecognizer setState:](self, "setState:", 5);
            goto LABEL_12;
          }
...
- (void)touchesCancelled:(id)a3 withEvent:(id)a4
{
  ...
  -[SBPIPPinchGestureRecognizer touchesCancelled:withEvent:](&v16, sel_touchesCancelled_withEvent_, v6, a4);
  v14 = 0u;
  v15 = 0u;
  v12 = 0u;
  v13 = 0u;
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)SBPIPPinchGestureRecognizer;
  -[SBPIPPinchGestureRecognizer touchesEnded:withEvent:](&v16, sel_touchesEnded_withEvent_, v6, a4);
  v14 = 0u;
  v15 = 0u;
  v12 = 0u;
  v13 = 0u;
...
- (void)touchesMoved:(id)a3 withEvent:(id)a4
{
  ...
  -[SBPIPPinchGestureRecognizer touchesMoved:withEvent:](&v18, sel_touchesMoved_withEvent_, v6, a4);
  if (self->_failsPastHysteresis)
  {
    v7 = -[SBPIPPinchGestureRecognizer state](self, "state");
    ...
    -[SBPIPPinchGestureRecognizer delegate](self, "delegate");
...
- (void)reset
{
  ...
  -[SBPIPPinchGestureRecognizer reset](&v5, sel_reset);
