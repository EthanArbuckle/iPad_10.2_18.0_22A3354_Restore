...
- (void)beginTrackingPlatterView:(id)a3
{
  ...
  -[SBOldIconDragPlatterWindow _iconDragPreviewContainerView](self, "_iconDragPreviewContainerView");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "addSubview:", v9);

  -[SBMainScreenActiveInterfaceOrientationWindow setHidden:](self, "setHidden:", 0);
}
...
- (void)stopTrackingPlatterView:(id)a3
{
  ...
  -[SBMainScreenActiveInterfaceOrientationWindow setHidden:](self, "setHidden:", -[NSHashTable count](self->_platterViews, "count") == 0);
}
