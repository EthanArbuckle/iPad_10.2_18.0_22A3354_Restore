...
void ___SBXXSetShowsOverridesForRecording_block_invoke(uint64_t a1)
{
  ...
  if (*(_BYTE *)(a1 + 52))
  {
    ...
    v16[1] = 3221225472;
    v16[2] = ___SBXXSetShowsOverridesForRecording_block_invoke_2;
    v16[3] = &unk_1E8E9E820;
    v17 = *(id *)(a1 + 32);
    v18 = *(id *)(a1 + 40);
    v10 = v2;
    v11 = 3221225472;
    v12 = ___SBXXSetShowsOverridesForRecording_block_invoke_76;
    v13 = &unk_1E8E9E820;
    v14 = *(id *)(a1 + 32);
    v15 = *(id *)(a1 + 40);
    ...
    +[SBDaemonHandler addRequest:forKey:forDaemonPid:](SBDaemonHandler, "addRequest:forKey:forDaemonPid:", v3, *(_QWORD *)(a1 + 32), *(unsigned int *)(a1 + 48), v10, v11, v12, v13);
  }
  else
  {
    SBLogStatusBarish();
    ...
    +[SBDaemonHandler removeRequestForKey:forDaemonPid:](SBDaemonHandler, "removeRequestForKey:forDaemonPid:", *(_QWORD *)(a1 + 32), *(unsigned int *)(a1 + 48));
  }
}
...
void ___SBXXSetShowsOverridesForRecording_block_invoke_2(uint64_t a1)
{
  ...
  objc_msgSend(v5, "setShowsOverridesForRecording:", 1);

}

void ___SBXXSetShowsOverridesForRecording_block_invoke_76(uint64_t a1)
{
  NSObject *v2;
  uint64_t v3;
  uint64_t v4;
  ...
  objc_msgSend((id)SBApp, "statusBarStateAggregator");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setShowsOverridesForRecording:", 0);
