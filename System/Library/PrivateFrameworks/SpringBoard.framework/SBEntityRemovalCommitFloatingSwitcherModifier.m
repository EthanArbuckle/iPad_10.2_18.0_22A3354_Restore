...
- (SBEntityRemovalCommitFloatingSwitcherModifier)initWithTransitionID:(id)a3 fromAppLayout:(id)a4 toAppLayout:(id)a5 floatingConfiguration:(int64_t)a6
{
  ...
  id v12;
  id v13;
  SBEntityRemovalCommitFloatingSwitcherModifier *v14;
  SBEntityRemovalCommitFloatingSwitcherModifier *v15;
  void *v17;
  objc_super v18;
  ...
  if (!v12)
  {
    ...
    objc_msgSend(v17, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SBEntityRemovalCommitFloatingSwitcherModifier.m"), 34, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("fromAppLayout"));
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  ...
  _QWORD v9[4];
  id v10;
  SBEntityRemovalCommitFloatingSwitcherModifier *v11;
...
- (CGRect)containerViewBounds
{
  ...
  -[SBEntityRemovalCommitFloatingSwitcherModifier floatingApplicationFrameInInterfaceOrientation:floatingConfiguration:](self, "floatingApplicationFrameInInterfaceOrientation:floatingConfiguration:", -[SBEntityRemovalCommitFloatingSwitcherModifier switcherInterfaceOrientation](self, "switcherInterfaceOrientation"), self->_floatingConfiguration);
...
- (CGRect)frameForIndex:(unint64_t)a3
{
  ...
  if (-[SBEntityRemovalCommitFloatingSwitcherModifier _isIndexFromAppLayout:](self, "_isIndexFromAppLayout:"))
  {
    -[SBEntityRemovalCommitFloatingSwitcherModifier containerViewBounds](self, "containerViewBounds");
    v6 = v5;
    v8 = v7;
    v10 = v9;
    v12 = v11;
    -[SBEntityRemovalCommitFloatingSwitcherModifier entityRemovalSettings](self, "entityRemovalSettings");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "floatingCommitIntentAnimationSettings");
  ...
  else
  {
    ...
    -[SBEntityRemovalCommitFloatingSwitcherModifier frameForIndex:](&v24, sel_frameForIndex_, a3);
    v6 = v18;
    v10 = v19;
    v12 = v20;
  }
...
- (double)scaleForIndex:(unint64_t)a3
{
  ...
  if (-[SBEntityRemovalCommitFloatingSwitcherModifier _isIndexFromAppLayout:](self, "_isIndexFromAppLayout:"))
  {
    -[SBEntityRemovalCommitFloatingSwitcherModifier entityRemovalSettings](self, "entityRemovalSettings");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "floatingCommitIntentAnimationSettings");
  ...
  else if (-[SBEntityRemovalCommitFloatingSwitcherModifier _isIndexToAppLayout:](self, "_isIndexToAppLayout:", a3)
...
- (id)visibleAppLayouts
{
  ...
  -[SBEntityRemovalCommitFloatingSwitcherModifier visibleAppLayouts](&v7, sel_visibleAppLayouts);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)animationAttributesForLayoutElement:(id)a3
{
  ...
  -[SBEntityRemovalCommitFloatingSwitcherModifier _layoutSettings](self, "_layoutSettings");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)topMostLayoutElements
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SBEntityRemovalCommitFloatingSwitcherModifier;
  -[SBEntityRemovalCommitFloatingSwitcherModifier topMostLayoutElements](&v8, sel_topMostLayoutElements);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)opacityForLayoutRole:(int64_t)a3 inAppLayout:(id)a4 atIndex:(unint64_t)a5
{
  ...
  v8 = a4;
  v9 = 1.0;
  if (!-[SBEntityRemovalCommitFloatingSwitcherModifier _isIndexFromAppLayout:](self, "_isIndexFromAppLayout:", a5)
    && !-[SBEntityRemovalCommitFloatingSwitcherModifier _isIndexToAppLayout:](self, "_isIndexToAppLayout:", a5))
  {
    v12.receiver = self;
    v12.super_class = (Class)SBEntityRemovalCommitFloatingSwitcherModifier;
    -[SBEntityRemovalCommitFloatingSwitcherModifier opacityForLayoutRole:inAppLayout:atIndex:](&v12, sel_opacityForLayoutRole_inAppLayout_atIndex_, a3, v8, a5);
    v9 = v10;
  }
...
- (double)dimmingAlphaForLayoutRole:(int64_t)a3 inAppLayout:(id)a4
{
  ...
  v6 = (SBAppLayout *)a4;
  -[SBEntityRemovalCommitFloatingSwitcherModifier dimmingAlphaForLayoutRole:inAppLayout:](&v14, sel_dimmingAlphaForLayoutRole_inAppLayout_, a3, v6);
  v8 = v7;
  toAppLayout = self->_toAppLayout;
  ...
  {
    -[SBEntityRemovalCommitFloatingSwitcherModifier switcherSettings](self, "switcherSettings");
...
- (double)shadowOpacityForLayoutRole:(int64_t)a3 atIndex:(unint64_t)a4
{
  ...
  v7 = -[SBEntityRemovalCommitFloatingSwitcherModifier _isIndexFromAppLayout:](self, "_isIndexFromAppLayout:", a4);
  result = 1.0;
  if (!v7)
  {
      ...
      || (v9 = -[SBTransitionSwitcherModifier transitionPhase](self, "transitionPhase"), result = 0.0, v9 != 1))
    {
      ...
      -[SBEntityRemovalCommitFloatingSwitcherModifier shadowOpacityForLayoutRole:atIndex:](&v10, sel_shadowOpacityForLayoutRole_atIndex_, a3, a4);
    }
  }
  return result;
}
...
{
  SBEntityRemovalCommitFloatingSwitcherModifier *v4;
  void *v5;
  void *v6;

  v4 = self;
  -[SBEntityRemovalCommitFloatingSwitcherModifier appLayouts](self, "appLayouts");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)_toBeRemovedFinalScale
{
  ...
  -[SBEntityRemovalCommitFloatingSwitcherModifier entityRemovalSettings](self, "entityRemovalSettings");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "floatingCommitIntentAnimationSettings");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "defaultAnimationSettings");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "toBeRemovedFinalScale");
  v6 = v5;
