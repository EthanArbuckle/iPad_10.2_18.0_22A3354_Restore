@implementation SBPPTEventActionsToSwipeUpInMiddleOfInterface
...
void __SBPPTEventActionsToSwipeUpInMiddleOfInterface_block_invoke(uint64_t a1, void *a2)
{
  ...
  v13 = CGRectGetMidY(v24) + -200.0;
  objc_msgSend(v20, "convertPoint:toView:", 0, MidX, MidY);
  objc_msgSend(v20, "_convertPointToSceneReferenceSpace:");
  v15 = v14;
  v17 = v16;
  objc_msgSend(v20, "convertPoint:toView:", 0, v12, v13);
  objc_msgSend(v20, "_convertPointToSceneReferenceSpace:");
