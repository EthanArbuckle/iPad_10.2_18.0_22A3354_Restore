...
- (void)handleEvent:(id)a3
{
  ...
  if (!objc_msgSend(a3, "type"))
  {
    ...
    objc_msgSend(WeakRetained, "eventSnifferHandledQualifyingContinuityTouch:", self);
...
{
  return (_SBContinuityTouchEventSnifferDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
