...
- (_SBContinuitySessionStateMachineStateFlushing)initWithSystemEventMonitor:(id)a3 continuityDisplayAuthenticationCoordinator:(id)a4
{
  id v7;
  id v8;
  _SBContinuitySessionStateMachineStateFlushing *v9;
  _SBContinuitySessionStateMachineStateFlushing *v10;
  objc_super v12;
  ...
  v9 = -[_SBContinuitySessionStateMachineStateFlushing init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
{
  self->_uiFlushed = 1;
  -[_SBContinuitySessionStateMachineStateFlushing _reevaluateStateForReason:](self, "_reevaluateStateForReason:", CFSTR("UI flushed"));
}
...
- (void)enteredStateFrom:(unint64_t)a3
{
  ...
  -[_SBContinuitySessionStateMachineStateFlushing _evaluateClientExternallyBlockedReasons](self, "_evaluateClientExternallyBlockedReasons");
  -[_SBContinuitySessionStateMachineStateFlushing _evaluateLockState](self, "_evaluateLockState");
  -[_SBContinuitySessionStateMachineStateFlushing _evaluateSystemEvents](self, "_evaluateSystemEvents");
  v5 = (void *)MEMORY[0x1E0CB3940];
  NSStringFromSBContinuitySessionState(a3);
  v7 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "stringWithFormat:", CFSTR("entered state from: %@"), v7);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[_SBContinuitySessionStateMachineStateFlushing _reevaluateStateForReason:](self, "_reevaluateStateForReason:", v6);
...
- (void)continuityDisplayAuthenticationCoordinatorDidUpdateLockState:(id)a3
{
  ...
  -[_SBContinuitySessionStateMachineStateFlushing _evaluateLockState](self, "_evaluateLockState");
  -[_SBContinuitySessionStateMachineStateFlushing _reevaluateStateForReason:](self, "_reevaluateStateForReason:", CFSTR("lock state change"));
...
- (void)_evaluateClientExternallyBlockedReasons
{
  ...
  if (!WeakRetained)
  {
    ...
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_SBContinuitySessionStateMachineStateFlushing.m"), 114, CFSTR("Must have _SBContinuitySessionStateMachineExternallyBlockedReasonsProvider"));
  ...
  if (self->_isCurrentState && objc_msgSend(v5, "count"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_1D0540000, v7, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because client blocked reasons are unexpected: %{public}@", (uint8_t *)&v10, 0xCu);
...
- (void)_evaluateSystemEvents
{
  ...
  if (self->_isCurrentState)
  {
    if (-[SBContinuitySessionSystemEventMonitor isUIBlocked](self->_systemEventMonitor, "isUIBlocked"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v3, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because UI blocked ", v15, 2u);
      }
...
LABEL_14:
    ...
    if (!-[SBContinuitySessionSystemEventMonitor isUILocked](self->_systemEventMonitor, "isUILocked"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v8, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because UI unlocked", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isInCall](self->_systemEventMonitor, "isInCall"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v7, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because in call", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isSOSActive](self->_systemEventMonitor, "isSOSActive"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v10, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because SOS active", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isLockScreenSearchPresented](self->_systemEventMonitor, "isLockScreenSearchPresented"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v11, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because lock screen search presented", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isUsingSecureApp](self->_systemEventMonitor, "isUsingSecureApp"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v12, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because using secure app", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isAirplayMirroring](self->_systemEventMonitor, "isAirplayMirroring"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v13, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because airplay mirroring", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isUserInitiatedRemoteTransientOverlayPresented](self->_systemEventMonitor, "isUserInitiatedRemoteTransientOverlayPresented"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v14, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because user-initiated remote transient overlay is presented", v15, 2u);
      }
...
- (void)_evaluateLockState
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (v3 == 2)
    {
      ...
      {
        *(_WORD *)v10 = 0;
        _os_log_impl(&dword_1D0540000, v8, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid keybag has been unexpectedly unlocked", v10, 2u);
      }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1D0540000, v4, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid keybag has been unexpectedly locked", buf, 2u);
      }
...
- (void)_reevaluateStateForReason:(id)a3
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      v13 = 138543362;
      v14 = v4;
      _os_log_impl(&dword_1D0540000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] Re-evaluating state for reason: %{public}@", (uint8_t *)&v13, 0xCu);
    }
    ...
    v7 = v6;
    if (!self->_uiFlushed)
      objc_msgSend(v6, "addObject:", CFSTR("checkpoint.waiting-for-ui-flush"));
    ...
    if (v8)
    {
      if (v10)
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_1D0540000, v9, OS_LOG_TYPE_DEFAULT, "[State.Flushing] still blocked by %{public}@", (uint8_t *)&v13, 0xCu);
    ...
    else
    {
      ...
      {
        LOWORD(v13) = 0;
        _os_log_impl(&dword_1D0540000, v9, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .active", (uint8_t *)&v13, 2u);
      }
...
- (void)continuityDisplayAuthenticationCoordinatorDidUpdateLockState:(void *)a1 .cold.1(void *a1, NSObject *a2)
{
  ...
  _os_log_debug_impl(&dword_1D0540000, a2, OS_LOG_TYPE_DEBUG, "[State.WaitingForHIDServices] lock state changed %ld", (uint8_t *)&v3, 0xCu);
}
