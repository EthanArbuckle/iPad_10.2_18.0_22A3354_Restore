...
- (void)_setPresentationValue:(id)a3 forKey:(id)a4
{
  ...
  if (objc_msgSend(v7, "isEqualToString:", CFSTR("position")))
  {
    ...
    v11 = v10;
    v13 = v12;
    -[SBCoverSheetParallaxContainerView bounds](self, "bounds");
    if (v13 >= v14 * 0.5)
      v15 = v13;
    else
      v15 = v14 * 0.5;
  ...
  -[SBCoverSheetParallaxContainerView _setPresentationValue:forKey:](&v16, sel__setPresentationValue_forKey_, v9, v7);
