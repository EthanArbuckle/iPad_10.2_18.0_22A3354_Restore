...
{
  id v9;
  SBWindowCommitSwitcherModifier *v10;
  SBWindowCommitSwitcherModifier *v11;
  uint64_t v12;
  SBAppLayout *centerWindowAppLayout;
  SBWindowCommitSwitcherModifier *v14;
  uint64_t v15;
  SBAppLayout *fullScreenAppLayout;
  _QWORD v18[4];
  SBWindowCommitSwitcherModifier *v19;
  objc_super v20;
...
- (id)transitionWillBegin
{
  ...
  -[SBWindowCommitSwitcherModifier appLayouts](self, "appLayouts");
...
- (id)appLayoutContainingAppLayout:(id)a3
{
  ...
  v4 = a3;
  if (-[SBWindowCommitSwitcherModifier isChamoisWindowingUIEnabled](self, "isChamoisWindowingUIEnabled")
  ...
  else
  {
    ...
    -[SBWindowCommitSwitcherModifier appLayoutContainingAppLayout:](&v9, sel_appLayoutContainingAppLayout_, v4);
...
- (id)adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip:(id)a3
{
  ...
  _QWORD v13[4];
  id v14;
  SBWindowCommitSwitcherModifier *v15;
  uint64_t *v16;
  _QWORD v17[5];
  objc_super v18;
  uint64_t v19;
  ...
  if (-[SBWindowCommitSwitcherModifier isChamoisWindowingUIEnabled](self, "isChamoisWindowingUIEnabled")
    ...
    && (-[SBWindowCommitSwitcherModifier appLayoutOnStage](self, "appLayoutOnStage"),
        v7 = (void *)objc_claimAutoreleasedReturnValue(),
        v7,
        v7))
  {
    ...
    v24 = 0;
    v18.receiver = self;
    v18.super_class = (Class)SBWindowCommitSwitcherModifier;
    -[SBWindowCommitSwitcherModifier appLayouts](&v18, sel_appLayouts);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[SBWindowCommitSwitcherModifier adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip:](&v12, sel_adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip_, v4);
...
- (id)appLayoutsToEnsureExistForMainTransitionEvent:(id)a3
{
  ...
  -[SBWindowCommitSwitcherModifier appLayoutsToEnsureExistForMainTransitionEvent:](&v7, sel_appLayoutsToEnsureExistForMainTransitionEvent_, a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)animationAttributesForLayoutElement:(id)a3
{
  ...
  {
    -[SBWindowCommitSwitcherModifier entityRemovalSettings](self, "entityRemovalSettings");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)dimmingAlphaForLayoutRole:(int64_t)a3 inAppLayout:(id)a4
{
  ...
  {
    -[SBWindowCommitSwitcherModifier medusaSettings](self, "medusaSettings");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    v12.receiver = self;
    v12.super_class = (Class)SBWindowCommitSwitcherModifier;
    -[SBWindowCommitSwitcherModifier dimmingAlphaForLayoutRole:inAppLayout:](&v12, sel_dimmingAlphaForLayoutRole_inAppLayout_, a3, v6);
    v9 = v10;
  }
...
- (CGRect)frameForIndex:(unint64_t)a3
{
  ...
  if (v6 == self->_centerWindowAppLayout)
  {
    ...
    if (-[SBTransitionSwitcherModifier isUpdatingLayout](self, "isUpdatingLayout"))
    {
      ...
      objc_msgSend(v16, "dosidoDeclineIntentAnimationSettings");
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v17, "fromViewSlideOutHeightOffsetMultiplier");
      v19 = v15 * v18;
  ...
  else
  {
    ...
    -[SBWindowCommitSwitcherModifier frameForIndex:](&v24, sel_frameForIndex_, a3);
    x = v7;
    y = v9;
    width = v11;
    height = v13;
...
- (CGPoint)anchorPointForIndex:(unint64_t)a3
{
  ...
  else
  {
    ...
    -[SBWindowCommitSwitcherModifier anchorPointForIndex:](&v13, sel_anchorPointForIndex_, a3);
    v8 = v7;
    v10 = v9;
  }
...
- (double)opacityForLayoutRole:(int64_t)a3 inAppLayout:(id)a4 atIndex:(unint64_t)a5
{
    ...
    || (v9 = 1.0, !-[SBTransitionSwitcherModifier isUpdatingLayout](self, "isUpdatingLayout")))
  {
    ...
    else
    {
      v12.receiver = self;
      v12.super_class = (Class)SBWindowCommitSwitcherModifier;
      -[SBWindowCommitSwitcherModifier opacityForLayoutRole:inAppLayout:atIndex:](&v12, sel_opacityForLayoutRole_inAppLayout_atIndex_, a3, v8, a5);
      v9 = v10;
    }
  }
...
- (double)titleAndIconOpacityForIndex:(unint64_t)a3
{
  ...
  if ((objc_msgSend(v6, "isEqual:", self->_centerWindowAppLayout) & 1) == 0)
  {
    ...
    -[SBWindowCommitSwitcherModifier titleAndIconOpacityForIndex:](&v10, sel_titleAndIconOpacityForIndex_, a3);
    v7 = v8;
  }
...
- (UIRectCornerRadii)cornerRadiiForIndex:(unint64_t)a3
{
  ...
  else
  {
    ...
    -[SBWindowCommitSwitcherModifier cornerRadiiForIndex:](&v19, sel_cornerRadiiForIndex_, a3);
    topLeft = v11;
    bottomLeft = v12;
    bottomRight = v13;
    topRight = v14;
...
- (double)scaleForIndex:(unint64_t)a3
{
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = (Class)SBWindowCommitSwitcherModifier;
    -[SBWindowCommitSwitcherModifier scaleForIndex:](&v13, sel_scaleForIndex_, a3);
    v10 = v11;
  }
...
- (id)topMostLayoutElements
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SBWindowCommitSwitcherModifier;
  -[SBWindowCommitSwitcherModifier topMostLayoutElements](&v9, sel_topMostLayoutElements);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)visibleAppLayouts
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SBWindowCommitSwitcherModifier;
  -[SBWindowCommitSwitcherModifier visibleAppLayouts](&v6, sel_visibleAppLayouts);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (void *)objc_msgSend(v3, "mutableCopy");
...
- (double)perspectiveAngleForAppLayout:(id)a3
{
  ...
  if ((objc_msgSend(v4, "isEqual:", self->_centerWindowAppLayout) & 1) == 0)
  {
    ...
    -[SBWindowCommitSwitcherModifier perspectiveAngleForAppLayout:](&v8, sel_perspectiveAngleForAppLayout_, v4);
    v5 = v6;
  }
...
- (SBSwitcherWallpaperGradientAttributes)wallpaperGradientAttributesForIndex:(unint64_t)a3
{
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = (Class)SBWindowCommitSwitcherModifier;
    -[SBWindowCommitSwitcherModifier wallpaperGradientAttributesForIndex:](&v13, sel_wallpaperGradientAttributesForIndex_, a3);
  }
  v9 = Empty;
  v10 = v8;
