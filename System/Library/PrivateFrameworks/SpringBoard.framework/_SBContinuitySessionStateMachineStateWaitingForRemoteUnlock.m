...
- (_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock)initWithSystemEventMonitor:(id)a3 continuityDisplayAuthenticationCoordinator:(id)a4
{
  id v7;
  id v8;
  _SBContinuitySessionStateMachineStateWaitingForRemoteUnlock *v9;
  _SBContinuitySessionStateMachineStateWaitingForRemoteUnlock *v10;
  objc_super v12;
  ...
  v9 = -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
{
  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _evaluateClientExternallyBlockedReasons](self, "_evaluateClientExternallyBlockedReasons");
  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _reevaluateStateForReason:](self, "_reevaluateStateForReason:", CFSTR("client updated externally blocked reasons"));
}
...
- (void)enteredStateFrom:(unint64_t)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1D0540000, v5, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "SB_ONENESS_STATE_MACHINE_WAITING_FOR_REMOTE_UNLOCK", (const char *)&unk_1D0E9B6CB, buf, 2u);
  }

  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _evaluateClientExternallyBlockedReasons](self, "_evaluateClientExternallyBlockedReasons");
  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _evaluateLockState](self, "_evaluateLockState");
  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _evaluateSystemEvents](self, "_evaluateSystemEvents");
  v6 = (void *)MEMORY[0x1E0CB3940];
  NSStringFromSBContinuitySessionState(a3);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "stringWithFormat:", CFSTR("entered state from: %@"), v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _reevaluateStateForReason:](self, "_reevaluateStateForReason:", v8);
...
- (void)exitedStateTo:(unint64_t)a3
{
  ...
  if (os_signpost_enabled(v4))
  {
    ...
    v6[0] = 67109120;
    v6[1] = remoteUnlocked;
    _os_signpost_emit_with_name_impl(&dword_1D0540000, v4, OS_SIGNPOST_INTERVAL_END, 0xEEEEB0B5B2B2EEEELL, "SB_ONENESS_STATE_MACHINE_WAITING_FOR_REMOTE_UNLOCK", "remoteUnlocked: %{BOOL}u", (uint8_t *)v6, 8u);
  }
...
- (void)continuityDisplayAuthenticationCoordinatorDidUpdateLockState:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock continuityDisplayAuthenticationCoordinatorDidUpdateLockState:].cold.1(v4, v5);

  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _evaluateLockState](self, "_evaluateLockState");
  -[_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock _reevaluateStateForReason:](self, "_reevaluateStateForReason:", CFSTR("lock state change"));
...
- (void)_evaluateClientExternallyBlockedReasons
{
  ...
  if (!WeakRetained)
  {
    ...
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_SBContinuitySessionStateMachineStateWaitingForRemoteUnlock.m"), 113, CFSTR("Must have _SBContinuitySessionStateMachineExternallyBlockedReasonsProvider"));
...
- (void)_evaluateSystemEvents
{
  ...
  if (self->_isCurrentState)
  {
    if (-[SBContinuitySessionSystemEventMonitor isUIBlocked](self->_systemEventMonitor, "isUIBlocked"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v3, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because UI blocked", v15, 2u);
      }
...
LABEL_14:
    ...
    if (!-[SBContinuitySessionSystemEventMonitor isUILocked](self->_systemEventMonitor, "isUILocked"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v8, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because UI unlocked", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isInCall](self->_systemEventMonitor, "isInCall"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v7, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because in call", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isSOSActive](self->_systemEventMonitor, "isSOSActive"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v10, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because SOS active", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isLockScreenSearchPresented](self->_systemEventMonitor, "isLockScreenSearchPresented"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v11, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because lock screen search presented", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isUsingSecureApp](self->_systemEventMonitor, "isUsingSecureApp"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v12, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because using secure app", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isAirplayMirroring](self->_systemEventMonitor, "isAirplayMirroring"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v13, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because airplay mirroring", v15, 2u);
      }
    ...
    if (-[SBContinuitySessionSystemEventMonitor isUserInitiatedRemoteTransientOverlayPresented](self->_systemEventMonitor, "isUserInitiatedRemoteTransientOverlayPresented"))
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D0540000, v14, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .invalid because user-initiated remote transient overlay is presented", v15, 2u);
      }
...
{
  OUTLINED_FUNCTION_0(&dword_1D0540000, a1, a3, "[State.WaitingForRemoteUnlock] Lock state is .remoteUnlocked", a5, a6, a7, a8, 0);
}
...
- (void)_reevaluateStateForReason:(id)a3
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      v13 = 138543362;
      v14 = v4;
      _os_log_impl(&dword_1D0540000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] Re-evaluating state for reason: %{public}@", (uint8_t *)&v13, 0xCu);
    }
    ...
    if (!self->_remoteUnlocked)
      objc_msgSend(v6, "addObject:", CFSTR("checkpoint.waiting-for-assertDelay"));
    ...
    if (v8)
    {
      if (v10)
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_1D0540000, v9, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] still blocked by %{public}@", (uint8_t *)&v13, 0xCu);
    ...
    else
    {
      ...
      {
        LOWORD(v13) = 0;
        _os_log_impl(&dword_1D0540000, v9, OS_LOG_TYPE_DEFAULT, "[State.WaitingForRemoteUnlock] --> moving to .waitingForScenes", (uint8_t *)&v13, 2u);
      }
...
- (void)continuityDisplayAuthenticationCoordinatorDidUpdateLockState:(void *)a1 .cold.1(void *a1, NSObject *a2)
{
  ...
  _os_log_debug_impl(&dword_1D0540000, a2, OS_LOG_TYPE_DEBUG, "[State.WaitingForRemoteUnlock] lock state changed %ld", (uint8_t *)&v3, 0xCu);
}
