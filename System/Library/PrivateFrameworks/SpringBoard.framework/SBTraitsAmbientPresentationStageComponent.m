...
{
  id v4;
  SBTraitsAmbientPresentationStageComponent *v5;
  uint64_t v6;
  ...
  v5 = -[SBTraitsAmbientPresentationStageComponent init](&v9, sel_init);
  if (v5)
  {
...
{
  return -[SBTraitsAmbientPresentationStageComponent initWithComponentOrder:](self, "initWithComponentOrder:", &unk_1E91D0818);
}
...
- (NSString)description
{
  ...
  -[SBTraitsAmbientPresentationStageComponent description](&v8, sel_description);
