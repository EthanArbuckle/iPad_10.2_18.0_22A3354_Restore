...
- (id)description
{
  ...
  -[MUAmpArtworkArgument description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[MUAmpArtworkArgument dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (appAdamId)
    objc_msgSend(v3, "setObject:forKey:", appAdamId, CFSTR("appAdamId"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  appAdamId = self->_appAdamId;
  if (appAdamId)
    objc_msgSend(a3, "setAppAdamId:", appAdamId);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_appAdamId, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)appAdamId | v4[1])
      v6 = -[NSString isEqual:](appAdamId, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSString hash](self->_appAdamId, "hash");
}
