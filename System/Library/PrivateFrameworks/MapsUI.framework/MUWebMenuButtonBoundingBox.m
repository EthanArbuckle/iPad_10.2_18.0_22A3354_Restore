...
- (id)description
{
  ...
  -[MUWebMenuButtonBoundingBox description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[MUWebMenuButtonBoundingBox dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    *(float *)&v4 = self->_xCoordinate;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("xCoordinate"));
...
LABEL_9:
      *(float *)&v4 = self->_height;
      ...
      objc_msgSend(v3, "setObject:forKey:", v10, CFSTR("height"));
  ...
  *(float *)&v4 = self->_yCoordinate;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("yCoordinate"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 4) == 0 || self->_xCoordinate != *((float *)v4 + 4))
      goto LABEL_21;
  }
...
LABEL_21:
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 8) == 0 || self->_yCoordinate != *((float *)v4 + 5))
      goto LABEL_21;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_height != *((float *)v4 + 2))
      goto LABEL_21;
  }
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_width != *((float *)v4 + 3))
      goto LABEL_21;
    v5 = 1;
  }
LABEL_22:
