@implementation MapsSuggestionsLocalizedETAToHomeString
...
void __MapsSuggestionsLocalizedETAToHomeString_block_invoke()
{
  ...
  objc_msgSend(v1, "localizedStringForKey:value:table:", CFSTR("MAPS_ETA_TO_HOME"), CFSTR("%@ to get home<unlocalized>"), 0);
  ...
  v7[0] = v0;
  v7[1] = 3221225472;
  v7[2] = __MapsSuggestionsLocalizedETAToHomeString_block_invoke_2;
  v7[3] = &unk_1E4BD1610;
  v8 = v3;
  v4 = v3;
  v5 = _Block_copy(v7);
  v6 = (void *)qword_1ED22F1D8;
  qword_1ED22F1D8 = (uint64_t)v5;
