@implementation MapsSuggestionsLocalizedSnoozeInMapsString
...
void __MapsSuggestionsLocalizedSnoozeInMapsString_block_invoke()
{
  ...
  objc_msgSend(v0, "localizedStringForKey:value:table:", CFSTR("MSG_DELETE_OPTION:SNOOZE_IN_MAPS"), CFSTR("Hide for Today<unlocalized>"), 0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  MapsSuggestionsNonNilString(v3, &stru_1E4BDFC28);
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)qword_1ED22F330;
  qword_1ED22F330 = v1;
