@implementation MapsSuggestionsLocalizedRecentlyViewedString
...
void __MapsSuggestionsLocalizedRecentlyViewedString_block_invoke()
{
  ...
  objc_msgSend(v0, "localizedStringForKey:value:table:", CFSTR("[Proactive Tray] Recently viewed"), CFSTR("Recently viewed<unlocalized>"), 0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  MapsSuggestionsNonNilString(v3, &stru_1E4BDFC28);
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)qword_1ED22F2C0;
  qword_1ED22F2C0 = v1;
