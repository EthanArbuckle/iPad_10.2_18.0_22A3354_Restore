@implementation MapsSuggestionsLocalizedFrequentLocationNearTitleString
...
void __MapsSuggestionsLocalizedFrequentLocationNearTitleString_block_invoke()
{
  ...
  objc_msgSend(v1, "localizedStringForKey:value:table:", CFSTR("MAPS_ETA_TO_NEAR"), CFSTR("%@ to near %@<unlocalized>"), 0);
  ...
  v7[0] = v0;
  v7[1] = 3221225472;
  v7[2] = __MapsSuggestionsLocalizedFrequentLocationNearTitleString_block_invoke_2;
  v7[3] = &unk_1E4BCF248;
  v8 = v3;
  v4 = v3;
  v5 = _Block_copy(v7);
  v6 = (void *)qword_1ED22F520;
  qword_1ED22F520 = (uint64_t)v5;
...
id __MapsSuggestionsLocalizedFrequentLocationNearTitleString_block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = a3;
  v7 = a2;
  v8 = (void *)objc_msgSend([v5 alloc], "initWithFormat:", *(_QWORD *)(a1 + 32), v6, v7);
