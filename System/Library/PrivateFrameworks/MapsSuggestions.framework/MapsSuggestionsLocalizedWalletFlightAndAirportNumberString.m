@implementation MapsSuggestionsLocalizedWalletFlightAndAirportNumberString
...
void __MapsSuggestionsLocalizedWalletFlightAndAirportNumberString_block_invoke()
{
  ...
  objc_msgSend(v1, "localizedStringForKey:value:table:", CFSTR("MAPS_WALLET_FLIGHT_AIRPORT_AND_NUMBER"), CFSTR("%@ Flight %@<unlocalized>"), 0);
  ...
  v6[0] = v0;
  v6[1] = 3221225472;
  v6[2] = __MapsSuggestionsLocalizedWalletFlightAndAirportNumberString_block_invoke_2;
  v6[3] = &unk_1E4BCF248;
  v6[4] = v3;
  v4 = _Block_copy(v6);
  v5 = (void *)qword_1ED22F210;
  qword_1ED22F210 = (uint64_t)v4;
