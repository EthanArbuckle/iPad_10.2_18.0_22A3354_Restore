@implementation MapsSuggestionsLocalizedTitleFormatForStandardResumeRouteEntry
...
void __MapsSuggestionsLocalizedTitleFormatForStandardResumeRouteEntry_block_invoke()
{
  ...
  objc_msgSend(v1, "localizedStringForKey:value:table:", CFSTR("Resume Route to %@ [Widget/Proactive Tray Resume Route row title]"), CFSTR("Resume Route to %@<unlocalized>"), 0);
  ...
  v7[0] = v0;
  v7[1] = 3221225472;
  v7[2] = __MapsSuggestionsLocalizedTitleFormatForStandardResumeRouteEntry_block_invoke_2;
  v7[3] = &unk_1E4BD1610;
  v8 = v3;
  v4 = v3;
  v5 = _Block_copy(v7);
  v6 = (void *)qword_1ED22F418;
  qword_1ED22F418 = (uint64_t)v5;
