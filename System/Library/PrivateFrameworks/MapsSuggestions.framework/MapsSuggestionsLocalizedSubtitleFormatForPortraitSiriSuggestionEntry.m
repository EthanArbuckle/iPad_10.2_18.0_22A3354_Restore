@implementation MapsSuggestionsLocalizedSubtitleFormatForPortraitSiriSuggestionEntry
...
void __MapsSuggestionsLocalizedSubtitleFormatForPortraitSiriSuggestionEntry_block_invoke()
{
  ...
  objc_msgSend(v0, "localizedStringForKey:value:table:", CFSTR("Siri Suggestion"), CFSTR("Siri Suggestion<unlocalized>"), 0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  MapsSuggestionsNonNilString(v3, &stru_1E4BDFC28);
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)qword_1ED22F450;
  qword_1ED22F450 = v1;
