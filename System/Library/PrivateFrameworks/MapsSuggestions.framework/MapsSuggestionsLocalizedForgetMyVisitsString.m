@implementation MapsSuggestionsLocalizedForgetMyVisitsString
...
void __MapsSuggestionsLocalizedForgetMyVisitsString_block_invoke()
{
  ...
  objc_msgSend(v0, "localizedStringForKey:value:table:", CFSTR("MSG_DELETE_OPTION:FORGET_MY_VISITS"), CFSTR("Forget my visits<unlocalized>"), 0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  MapsSuggestionsNonNilString(v3, &stru_1E4BDFC28);
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)qword_1ED22F370;
  qword_1ED22F370 = v1;
