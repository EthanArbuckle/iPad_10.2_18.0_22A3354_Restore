@implementation MapsSuggestionsLocalizedDeclineCalendarEventString
...
void __MapsSuggestionsLocalizedDeclineCalendarEventString_block_invoke()
{
  ...
  objc_msgSend(v0, "localizedStringForKey:value:table:", CFSTR("MSG_DELETE_OPTION:DECLINE_CALENDAR_EVENT"), CFSTR("Decline in Calendar<unlocalized>"), 0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  MapsSuggestionsNonNilString(v3, &stru_1E4BDFC28);
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)qword_1ED22F360;
  qword_1ED22F360 = v1;
