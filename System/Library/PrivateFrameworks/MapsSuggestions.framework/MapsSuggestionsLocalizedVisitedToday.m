@implementation MapsSuggestionsLocalizedVisitedToday
...
void __MapsSuggestionsLocalizedVisitedToday_block_invoke()
{
  ...
  objc_msgSend(v0, "localizedStringForKey:value:table:", CFSTR("Visited today"), CFSTR("Visited today<unlocalized>"), 0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  MapsSuggestionsNonNilString(v3, &stru_1E4BDFC28);
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)qword_1ED22F3D0;
  qword_1ED22F3D0 = v1;
