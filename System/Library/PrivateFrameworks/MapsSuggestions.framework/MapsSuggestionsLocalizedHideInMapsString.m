@implementation MapsSuggestionsLocalizedHideInMapsString
...
void __MapsSuggestionsLocalizedHideInMapsString_block_invoke()
{
  ...
  objc_msgSend(v0, "localizedStringForKey:value:table:", CFSTR("MSG_DELETE_OPTION:HIDE_IN_MAPS"), CFSTR("Always Hide in Maps<unlocalized>"), 0);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  MapsSuggestionsNonNilString(v3, &stru_1E4BDFC28);
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)qword_1ED22F340;
  qword_1ED22F340 = v1;
