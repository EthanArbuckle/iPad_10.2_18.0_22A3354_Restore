@implementation MapsSuggestionsLocalizedTitleFormatForVehicleSetup
...
void __MapsSuggestionsLocalizedTitleFormatForVehicleSetup_block_invoke()
{
  ...
  objc_msgSend(v1, "localizedStringForKey:value:table:", CFSTR("Plan EV trips with your %@"), CFSTR("Plan EV trips with your %@<unlocalized>"), 0);
  ...
  v6[0] = v0;
  v6[1] = 3221225472;
  v6[2] = __MapsSuggestionsLocalizedTitleFormatForVehicleSetup_block_invoke_2;
  v6[3] = &unk_1E4BD1610;
  v6[4] = v3;
  v4 = _Block_copy(v6);
  v5 = (void *)qword_1ED22F380;
  qword_1ED22F380 = (uint64_t)v4;
