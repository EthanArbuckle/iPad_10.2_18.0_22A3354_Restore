@implementation MapsSuggestionsLocalizedTicketedEventWithTimeAndNameFormatString
...
void __MapsSuggestionsLocalizedTicketedEventWithTimeAndNameFormatString_block_invoke()
{
  ...
  objc_msgSend(v1, "localizedStringForKey:value:table:", CFSTR("MAPS_SUGGESTIONS_TICKETED_EVENT_SHOW"), CFSTR("%@, %@<unlocalized>"), 0);
  ...
  v6[0] = v0;
  v6[1] = 3221225472;
  v6[2] = __MapsSuggestionsLocalizedTicketedEventWithTimeAndNameFormatString_block_invoke_2;
  v6[3] = &unk_1E4BCF248;
  v6[4] = v3;
  v4 = _Block_copy(v6);
  v5 = (void *)qword_1ED22F4F0;
  qword_1ED22F4F0 = (uint64_t)v4;
