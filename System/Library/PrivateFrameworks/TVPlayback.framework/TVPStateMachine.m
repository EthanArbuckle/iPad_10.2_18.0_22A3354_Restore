...
void __50__TVPStateMachine_initWithName_initialState_mode___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, void *a6, void *a7)
{
  ...
  v17 = a6;
  v11 = a7;
  objc_msgSend(MEMORY[0x24BDBCED8], "dictionaryWithObjectsAndKeys:", a3, CFSTR("TVPStateMachineOldStateKey"), a4, CFSTR("TVPStateMachineNewStateKey"), 0);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v17)
    objc_msgSend(v12, "setObject:forKey:", v17, CFSTR("TVPStateMachineContextKey"));
  if (v11)
    objc_msgSend(v12, "setObject:forKey:", v11, CFSTR("TVPStateMachineUserInfoKey"));
  v13 = (void *)MEMORY[0x24BDD16C8];
  WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  objc_msgSend(v13, "notificationWithName:object:userInfo:", CFSTR("TVPStateMachineStateChangedNotification"), WeakRetained, v12);
...
- (void)registerDefaultHandlerForEvent:(id)a3 withBlock:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  if (-[TVPStateMachine shouldAcceptEvents](self, "shouldAcceptEvents"))
  {
    -[TVPStateMachine logObject](self, "logObject");
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v14 = 138412290;
        v15 = name;
        _os_log_impl(&dword_228A4E000, v9, OS_LOG_TYPE_DEFAULT, "State machine [%@] can not register default handlers when it is accepting events", (uint8_t *)&v14, 0xCu);
      }
...
- (TVPStateMachine)initWithName:(id)a3 initialState:(id)a4 mode:(int64_t)a5
{
  ...
  v10 = (void *)MEMORY[0x22E2BA4B0](&v13);
  v11 = -[TVPStateMachine initWithName:initialState:mode:stateChangeHandler:](self, "initWithName:initialState:mode:stateChangeHandler:", v8, v9, a5, v10, v13, v14, v15, v16);
...
- (void)postEvent:(id)a3 withContext:(id)a4 userInfo:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  if (v8 && -[TVPStateMachine shouldAcceptEvents](self, "shouldAcceptEvents"))
  {
    -[TVPStateMachine ignorableEvents](self, "ignorableEvents");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = objc_msgSend(v11, "containsObject:", v8);

    if (!v12)
    {
      objc_msgSend(MEMORY[0x24BDBCED8], "dictionaryWithObject:forKey:", v8, CFSTR("TVPStateMachineEventKey"));
      v16 = objc_claimAutoreleasedReturnValue();
      v14 = v16;
      if (v9)
        -[NSObject setObject:forKey:](v16, "setObject:forKey:", v9, CFSTR("TVPStateMachineContextKey"));
      if (v10)
        -[NSObject setObject:forKey:](v14, "setObject:forKey:", v10, CFSTR("TVPStateMachineUserInfoKey"));
      v17 = self->_events;
      objc_sync_enter(v17);
      -[NSMutableArray addObject:](self->_events, "addObject:", v14);
      v18 = -[NSMutableArray count](self->_events, "count") == 1;
      objc_sync_exit(v17);
      ...
      if (v18)
      {
        ...
        if (v20)
        {
          ...
          {
            -[TVPStateMachine name](self, "name");
            v22 = (void *)objc_claimAutoreleasedReturnValue();
            v24 = 138412546;
            v25 = v22;
            v26 = 2112;
            v27 = v8;
            _os_log_impl(&dword_228A4E000, v21, OS_LOG_TYPE_DEFAULT, "State machine [%@] received event [%@], initiating event processing", (uint8_t *)&v24, 0x16u);

          }
        }
        -[TVPStateMachine _processNextEvent](self, "_processNextEvent");
      }
      else
      {
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v26 = 2112;
          v27 = v8;
          _os_log_impl(&dword_228A4E000, v20, OS_LOG_TYPE_DEFAULT, "State machine [%@] received event [%@], but existing events are pending.  Adding to queue.", (uint8_t *)&v24, 0x16u);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v26 = 2112;
        v27 = v8;
        _os_log_impl(&dword_228A4E000, v14, OS_LOG_TYPE_DEFAULT, "State machine named [%@] received ignorable event [%@]", (uint8_t *)&v24, 0x16u);
...
- (void)_processNextEvent
{
  ...
  {
    if (self->_mode)
      -[TVPStateMachine _dispatchEvent:](self, "_dispatchEvent:", v5);
    else
      -[TVPStateMachine _processEvent:](self, "_processEvent:", v5);
    v4 = v5;
  }
...
- (void)_processEvent:(id)a3
{
  ...
  if (v20)
  {
    ...
    do
    {
      objc_msgSend(v4, "objectForKey:", CFSTR("TVPStateMachineEventKey"));
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "objectForKey:", CFSTR("TVPStateMachineUserInfoKey"));
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "objectForKey:", CFSTR("TVPStateMachineContextKey"));
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[TVPStateMachine _eventHandlerForEvent:](self, "_eventHandlerForEvent:", v5);
      ...
      if (!v10)
      {
        ...
        {
          name = self->_name;
          -[TVPStateMachine currentState](self, "currentState");
          v13 = (void *)objc_claimAutoreleasedReturnValue();
          *(_DWORD *)buf = 138412802;
          ...
          v25 = 2112;
          v26 = v13;
          _os_log_impl(&dword_228A4E000, v11, OS_LOG_TYPE_DEFAULT, "State machine [%@] processing event [%@] in state [%@]", buf, 0x20u);
      ...
      ((void (**)(_QWORD, TVPStateMachine *, void *, void *, void *))v8)[2](v8, v14, v5, v7, v6);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v16 = v14;
      objc_sync_enter(v16);
      ...
      -[TVPStateMachine _transitionToState:withEvent:context:userInfo:](v16, "_transitionToState:withEvent:context:userInfo:", v15, v5, v7, v6);
      v17 = self->_events;
      objc_sync_enter(v17);
...
- (void)_transitionToState:(id)a3 withEvent:(id)a4 context:(id)a5 userInfo:(id)a6
{
  ...
  NSObject *v20;
  NSString *v21;
  void (**stateChangeHandler)(id, TVPStateMachine *, void *, id, id, id, id);
  uint64_t v23;
  uint64_t v24;
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v37 = 2112;
        v38 = v11;
        _os_log_impl(&dword_228A4E000, v17, OS_LOG_TYPE_DEFAULT, "State machine [%@] remaining at state [%@] on event [%@]", buf, 0x20u);
      }
  ...
  {
    -[TVPStateMachine setCurrentState:](self, "setCurrentState:", v10);
    -[TVPStateMachine logObject](self, "logObject");
    ...
    if (v19)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v37 = 2112;
        v38 = v10;
        _os_log_impl(&dword_228A4E000, v20, OS_LOG_TYPE_DEFAULT, "State machine [%@] transitioning from state [%@] to [%@]", buf, 0x20u);
      }
  ...
  -[TVPStateMachine _executePostTransitionBlocks](self, "_executePostTransitionBlocks", v23, v24, v25, v26, v27);
...
- (id)_eventHandlerForEvent:(id)a3
{
  ...
  v11 = (void *)MEMORY[0x22E2BA4B0](v10);
...
- (TVPStateMachine)initWithName:(id)a3 initialState:(id)a4 mode:(int64_t)a5 stateChangeHandler:(id)a6
{
  ...
  v13 = -[TVPStateMachine init](&v31, sel_init);
  if (!v13)
  {
LABEL_10:
    v27 = v13;
  ...
  if (objc_msgSend(v10, "length") && objc_msgSend(v11, "length"))
  {
    ...
    -[TVPStateMachine setCurrentState:](v13, "setCurrentState:", v11);
    v13->_mode = a5;
    v16 = objc_opt_new();
    events = v13->_events;
    ...
    objc_storeStrong((id *)&v13->_logObject, MEMORY[0x24BDACB70]);
    if (a5 == 1)
    {
          ...
          if (v16)
          {
            ...
            do
            {
              ...
              do
              {
                ...
                -[TVPStateMachine registerHandlerForEvent:onState:withBlock:](self, "registerHandlerForEvent:onState:withBlock:", v14, *(_QWORD *)(*((_QWORD *)&v23 + 1) + 8 * v19++), v9);
              }
              while (v17 != v19);
    ...
    if (v12)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[TVPStateMachine registerHandlerForEvent:onState:withBlock:](self, "registerHandlerForEvent:onState:withBlock:", v8, *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * v15++), v10, (_QWORD)v16);
        }
        while (v13 != v15);
...
LABEL_15:
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 138412290;
      v19 = name;
      _os_log_impl(&dword_228A4E000, v12, OS_LOG_TYPE_DEFAULT, "State machine [%@] can not register event handlers when it is accepting events", (uint8_t *)&v18, 0xCu);
    }
...
{
  -[TVPStateMachine postEvent:withContext:userInfo:](self, "postEvent:withContext:userInfo:", a3, 0, 0);
}
...
{
  -[TVPStateMachine postEvent:withContext:userInfo:](self, "postEvent:withContext:userInfo:", a3, a4, 0);
}
...
- (void)setLoggingComponent:(id)a3
{
  ...
  if (-[NSString length](self->_loggingComponent, "length"))
    v5 = os_log_create("com.apple.AppleTV.playback", -[NSString UTF8String](self->_loggingComponent, "UTF8String"));
  else
    v5 = 0;
  -[TVPStateMachine setLogObject:](self, "setLogObject:", v5);
...
- (unint64_t)eventCount
{
  ...
  v3 = self->_events;
  objc_sync_enter(v3);
  v4 = -[NSMutableArray count](self->_events, "count");
  objc_sync_exit(v3);
...
- (void)registerStateTransitionFromState:(id)a3 onEvent:(id)a4 toState:(id)a5
{
  ...
  if (!-[TVPStateMachine shouldAcceptEvents](self, "shouldAcceptEvents"))
  {
    ...
    v14[3] = &unk_24F15BC38;
    v15 = v10;
    -[TVPStateMachine registerHandlerForEvent:onState:withBlock:](self, "registerHandlerForEvent:onState:withBlock:", v9, v8, v14);
    v12 = v15;
LABEL_6:
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v17 = name;
      _os_log_impl(&dword_228A4E000, v12, OS_LOG_TYPE_DEFAULT, "State machine [%@] can not register state transitions when it is accepting events", buf, 0xCu);
    }
    goto LABEL_6;
  }
LABEL_7:
...
- (void)deregisterHandlers
{
  ...
  obj = self->_handlers;
  objc_sync_enter(obj);
  -[TVPStateMachine setShouldAcceptEvents:](self, "setShouldAcceptEvents:", 0);
  -[TVPStateMachine purgeEventQueue](self, "purgeEventQueue");
                  ...
                  if (v33)
                  {
                    ...
                    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
                    {
                      *(_DWORD *)buf = 138412546;
                      ...
                      v63 = 2112;
                      v64 = v29;
                      _os_log_impl(&dword_228A4E000, v34, OS_LOG_TYPE_INFO, "[%@] is unhandled for [%@]", buf, 0x16u);
                    }
...
void __43__TVPStateMachine_Private___dispatchEvent___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "objectForKey:", CFSTR("TVPStateMachineEventKey"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 32), "objectForKey:", CFSTR("TVPStateMachineUserInfoKey"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 32), "objectForKey:", CFSTR("TVPStateMachineContextKey"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v14 = 3221225472;
  v15 = __43__TVPStateMachine_Private___dispatchEvent___block_invoke_2;
  v16 = &unk_24F15BC88;
  v17 = *(_QWORD *)(a1 + 40);
  v7 = v6;
  v18 = v7;
