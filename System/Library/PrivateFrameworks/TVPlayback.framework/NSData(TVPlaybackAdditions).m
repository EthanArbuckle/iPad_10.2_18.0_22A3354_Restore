...
- (uint64_t)tvp_lowercaseHexString
{
  ...
  return objc_msgSend(v1, "tvp_lowercaseHexStringWithBytes:length:", objc_msgSend(v2, "bytes"), objc_msgSend(v2, "length"));
}
...
- (uint64_t)tvp_uppercaseHexString
{
  ...
  v1 = (void *)MEMORY[0x24BDD17C8];
  v2 = objc_retainAutorelease(a1);
  return objc_msgSend(v1, "tvp_uppercaseHexStringWithBytes:length:", objc_msgSend(v2, "bytes"), objc_msgSend(v2, "length"));
}
