...
{
  CVNLPTextDecodingBeamSearchConfiguration *result;
  objc_super v15;

  v15.receiver = self;
  v15.super_class = (Class)CVNLPTextDecodingBeamSearchConfiguration;
  result = -[CVNLPTextDecodingConfiguration initWithCommitActionBehavior:](&v15, sel_initWithCommitActionBehavior_, a3);
  if (result)
  {
...
{
  return (CVNLPTextDecodingBeamSearchConfiguration *)MEMORY[0x1E0DE7D20](self, sel_initWithCommitActionBehavior_scoringFunction_beamWidth_pathCount_shouldOptimizeAlignment_pruneProblematicMixedScriptWordPaths_, a3, a4);
}
...
{
  return (CVNLPTextDecodingBeamSearchConfiguration *)MEMORY[0x1E0DE7D20](self, sel_initWithCommitActionBehavior_scoringFunction_beamWidth_pathCount_shouldOptimizeAlignment_pruneProblematicMixedScriptWordPaths_, a3, 0);
}
