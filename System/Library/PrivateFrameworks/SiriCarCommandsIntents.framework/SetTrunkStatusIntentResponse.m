...
{
  id v6;
  SetTrunkStatusIntentResponse *v7;
  int64_t *v8;
  SetTrunkStatusIntentResponse *v9;

  v6 = a4;
  v7 = -[SetTrunkStatusIntentResponse init](self, sel_init);
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___SetTrunkStatusIntentResponse_code);
  swift_beginAccess();
  *v8 = a3;
  v9 = v7;
  -[SetTrunkStatusIntentResponse setUserActivity:](v9, sel_setUserActivity_, v6);
...
- (SetTrunkStatusIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___SetTrunkStatusIntentResponse_code) = 0;
  ...
  return -[SetTrunkStatusIntentResponse init](&v3, sel_init);
}
...
- (SetTrunkStatusIntentResponse)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___SetTrunkStatusIntentResponse_code) = 0;
  ...
  return -[SetTrunkStatusIntentResponse initWithCoder:](&v5, sel_initWithCoder_, a3);
}
