...
{
  id v6;
  SetCarRadioStationIntentResponse *v7;
  int64_t *v8;
  SetCarRadioStationIntentResponse *v9;

  v6 = a4;
  v7 = -[SetCarRadioStationIntentResponse init](self, sel_init);
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___SetCarRadioStationIntentResponse_code);
  swift_beginAccess();
  *v8 = a3;
  v9 = v7;
  -[SetCarRadioStationIntentResponse setUserActivity:](v9, sel_setUserActivity_, v6);
...
- (SetCarRadioStationIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___SetCarRadioStationIntentResponse_code) = 0;
  ...
  return -[SetCarRadioStationIntentResponse init](&v3, sel_init);
}
...
- (SetCarRadioStationIntentResponse)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___SetCarRadioStationIntentResponse_code) = 0;
  ...
  return -[SetCarRadioStationIntentResponse initWithCoder:](&v5, sel_initWithCoder_, a3);
}
