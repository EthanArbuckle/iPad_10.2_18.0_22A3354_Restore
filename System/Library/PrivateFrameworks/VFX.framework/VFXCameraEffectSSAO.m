...
- (void)setFalloff:(float)a3
{
  ...
  if (self->super._isPresentationObject || self->_radius != a3)
  {
    ...
    v9[4] = self;
    v10 = a3;
    objc_msgSend_postCommandWithContext_object_key_applyBlock_(VFXTransaction, v8, v7, (uint64_t)self, CFSTR("falloff"), v9);
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[VFXCameraEffect copyWithZone:](&v18, sel_copyWithZone_, a3);
...
- (void)_syncObjCModel
{
  ...
  *((float *)&self->super._enabled + 1) = sub_1B18E8CD4((uint64_t)self->super._cameraEffect, v3, v4, v5, v6, v7, v8, v9);
  ...
  self->_radius = sub_1B18E9308((uint64_t)self->super._cameraEffect, v17, v18, v19, v20, v21, v22, v23);
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  *(float *)&v8 = self->_intensity;
  objc_msgSend_encodeFloat_forKey_(a3, v9, (uint64_t)CFSTR("radius"), v10, v8);
  *(float *)&v11 = self->_radius;
  objc_msgSend_encodeFloat_forKey_(a3, v12, (uint64_t)CFSTR("falloff"), v13, v11);
}
...
- (VFXCameraEffectSSAO)initWithCoder:(id)a3
{
  ...
  if (v7)
  {
    ...
    objc_msgSend_decodeFloatForKey_(a3, v16, (uint64_t)CFSTR("radius"), v17);
    objc_msgSend_setRadius_(v7, v18, v19, v20);
    objc_msgSend_decodeFloatForKey_(a3, v21, (uint64_t)CFSTR("falloff"), v22);
...
- (double)createCFXObject
{
  ...
  v0 = sub_1B179CB90(qword_1EEF66180, 0x48uLL);
  *(_BYTE *)(v0 + 64) = 1;
