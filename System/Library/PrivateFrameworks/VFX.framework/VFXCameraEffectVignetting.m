...
- (void)setAnamorphic:(float)a3
{
  ...
  if (self->super._isPresentationObject || self->_intensity != a3)
  {
    ...
    v9[4] = self;
    v10 = a3;
    objc_msgSend_postCommandWithContext_object_key_applyBlock_(VFXTransaction, v8, v7, (uint64_t)self, CFSTR("anamorphic"), v9);
  }
}
...
- (void)setSoftness:(float)a3
{
  ...
  if (self->super._isPresentationObject || self->_anamorphic != a3)
  {
    ...
    v9[4] = self;
    v10 = a3;
    objc_msgSend_postCommandWithContext_object_key_applyBlock_(VFXTransaction, v8, v7, (uint64_t)self, CFSTR("softness"), v9);
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[VFXCameraEffect copyWithZone:](&v22, sel_copyWithZone_, a3);
  ...
  *(float *)&v13 = self->_anamorphic;
  objc_msgSend_setSoftness_(v4, v14, v15, v16, v13);
  *(float *)&v17 = self->_softness;
...
- (void)_syncObjCModel
{
  ...
  *((float *)&self->super._enabled + 1) = sub_1B18E8CD4((uint64_t)self->super._cameraEffect, v3, v4, v5, v6, v7, v8, v9);
  ...
  self->_anamorphic = sub_1B18E9308((uint64_t)self->super._cameraEffect, v17, v18, v19, v20, v21, v22, v23);
  self->_softness = sub_1B18E95E4((uint64_t)self->super._cameraEffect, v24, v25, v26, v27, v28, v29, v30);
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  *(float *)&v8 = self->_intensity;
  objc_msgSend_encodeFloat_forKey_(a3, v9, (uint64_t)CFSTR("anamorphic"), v10, v8);
  *(float *)&v11 = self->_anamorphic;
  objc_msgSend_encodeFloat_forKey_(a3, v12, (uint64_t)CFSTR("softness"), v13, v11);
  *(float *)&v14 = self->_softness;
  objc_msgSend_encodeFloat_forKey_(a3, v15, (uint64_t)CFSTR("radius"), v16, v14);
}
...
- (VFXCameraEffectVignetting)initWithCoder:(id)a3
{
  ...
  v7 = -[VFXCameraEffect initWithCoder:](&v34, sel_initWithCoder_);
  if (v7)
  {
    ...
    objc_msgSend_decodeFloatForKey_(a3, v16, (uint64_t)CFSTR("anamorphic"), v17);
    objc_msgSend_setAnamorphic_(v7, v18, v19, v20);
    objc_msgSend_decodeFloatForKey_(a3, v21, (uint64_t)CFSTR("softness"), v22);
    objc_msgSend_setSoftness_(v7, v23, v24, v25);
    objc_msgSend_decodeFloatForKey_(a3, v26, (uint64_t)CFSTR("radius"), v27);
...
- (double)createCFXObject
{
  ...
  v0 = sub_1B179CB90(qword_1ED4CEB88, 0x48uLL);
  *(_BYTE *)(v0 + 64) = 1;
  result = 0.00781250185;
  *(_OWORD *)(v0 + 72) = xmmword_1B2247F00;
  return result;
}
