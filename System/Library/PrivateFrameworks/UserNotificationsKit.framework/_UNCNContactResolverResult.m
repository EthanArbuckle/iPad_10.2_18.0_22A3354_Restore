...
+ (id)resultWithCNContactIdentifier:(id)a3 cnContactFullname:(id)a4 suggestedContact:(BOOL)a5 matchType:(unint64_t)a6 matchTypeSuggested:(BOOL)a7 identifierOfMatchLabel:(id)a8
{
  ...
  v14 = a4;
  v15 = a3;
  v16 = -[_UNCNContactResolverResult _initWithCNContactIdentifier:cnContactFullname:suggestedContact:matchType:matchTypeSuggested:identifierOfMatchLabel:]([_UNCNContactResolverResult alloc], "_initWithCNContactIdentifier:cnContactFullname:suggestedContact:matchType:matchTypeSuggested:identifierOfMatchLabel:", v15, v14, v10, a6, v8, v13);
...
- (id)_initWithCNContactIdentifier:(id)a3 cnContactFullname:(id)a4 suggestedContact:(BOOL)a5 matchType:(unint64_t)a6 matchTypeSuggested:(BOOL)a7 identifierOfMatchLabel:(id)a8
{
  ...
  id v16;
  id v17;
  _UNCNContactResolverResult *v18;
  _UNCNContactResolverResult *v19;
  objc_super v21;
  ...
  v18 = -[_UNCNContactResolverResult init](&v21, sel_init);
  v19 = v18;
  if (v18)
  {
...
- (BOOL)isStrongerMatchThanOtherMatch:(id)a3
{
  ...
  if (v4)
  {
    if (-[_UNCNContactResolverResult isSuggestedContact](self, "isSuggestedContact")
...
LABEL_10:
    ...
    else if (!-[_UNCNContactResolverResult isMatchTypeSuggested](self, "isMatchTypeSuggested"))
    {
...
- (BOOL)isStrongestMatch
{
  if (-[_UNCNContactResolverResult isSuggestedContact](self, "isSuggestedContact"))
    ...
    return !-[_UNCNContactResolverResult isMatchTypeSuggested](self, "isMatchTypeSuggested");
}

- (NSString)debugDescription
{
  return (NSString *)-[_UNCNContactResolverResult descriptionWithMultilinePrefix:](self, "descriptionWithMultilinePrefix:", 0);
}
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  ...
  -[_UNCNContactResolverResult descriptionBuilderWithMultilinePrefix:](self, "descriptionBuilderWithMultilinePrefix:", a3);
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  ...
  _QWORD v10[4];
  id v11;
  _UNCNContactResolverResult *v12;
...
- (id)succinctDescription
{
  ...
  -[_UNCNContactResolverResult succinctDescriptionBuilder](self, "succinctDescriptionBuilder");
...
- (id)succinctDescriptionBuilder
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[_UNCNContactResolverResult cnContactIdentifier](self, "cnContactIdentifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (id)objc_msgSend(v3, "appendObject:withName:", v4, CFSTR("cnContactIdentifier"));

  -[_UNCNContactResolverResult cnContactFullname](self, "cnContactFullname");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "un_logDigest");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (id)objc_msgSend(v3, "appendObject:withName:", v7, CFSTR("cnContactFullname"));

  v9 = (id)objc_msgSend(v3, "appendBool:withName:", -[_UNCNContactResolverResult isSuggestedContact](self, "isSuggestedContact"), CFSTR("isSuggestedContact"));
  -[_UNCNContactResolverResult _stringForMatchType:](self, "_stringForMatchType:", -[_UNCNContactResolverResult matchType](self, "matchType"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendString:withName:", v10, CFSTR("matchType"));

  v11 = (id)objc_msgSend(v3, "appendBool:withName:", -[_UNCNContactResolverResult isMatchTypeSuggested](self, "isMatchTypeSuggested"), CFSTR("matchTypeSuggested"));
  -[_UNCNContactResolverResult identifierOfMatchLabel](self, "identifierOfMatchLabel");
