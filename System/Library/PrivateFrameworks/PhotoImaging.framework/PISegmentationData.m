...
- (PISegmentationData)initWithSegmentationItem:(id)a3
{
  ...
  v5 = -[PISegmentationData init](&v8, sel_init);
  item = v5->_item;
  v5->_item = v4;
...
- (__CVBuffer)segmentationBuffer
{
  ...
  -[PISegmentationData item](self, "item");
...
- (PFPosterLayout)originalLayout
{
  ...
  -[PISegmentationData item](self, "item");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "originalLayout");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)classification
{
  ...
  -[PISegmentationData item](self, "item");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "classification");
