@implementation PIPhotoEffectBlackAndWhiteHDR

+ (id)kernelBlackAndWhite
{
  if (kernelBlackAndWhite_onceToken != -1)
    dispatch_once(&kernelBlackAndWhite_onceToken, &__block_literal_global_40);
  return (id)kernelBlackAndWhite_kernel;
}

void __52__PIPhotoEffectBlackAndWhiteHDR_kernelBlackAndWhite__block_invoke()
{
  uint64_t v0;
  void *v1;
  NSObject *v2;
  ...
  v1 = (void *)kernelBlackAndWhite_kernel;
  kernelBlackAndWhite_kernel = v0;

  if (!kernelBlackAndWhite_kernel)
  {
    NUAssertLogger_248();
...
- (id)outputImage
{
  ...
  -[PIPhotoEffectBlackAndWhiteHDR photoEffectName](self, "photoEffectName");
