...
- (PIParallaxGreenScreenGraphicStyle)initWithColor:(id)a3 clockColor:(id)a4 colorSuggestions:(id)a5
{
  ...
  id v10;
  void *v11;
  PIParallaxGreenScreenGraphicStyle *v12;
...
- (id)parameters
{
  ...
  -[PIParallaxGreenScreenGraphicStyle color](self, "color");
...
- (id)kind
{
  return (id)*MEMORY[0x1E0D755F0];
}

- (id)recipeIdentifier
{
  return CFSTR("GreenScreenMono");
}
...
- (BOOL)configureForCategory:(id)a3
{
  ...
  if (v4)
  {
    ...
    -[PIParallaxGreenScreenGraphicStyle setColor:](self, "setColor:", v6);
...
+ (id)styleWithColorAnalysis:(id)a3
{
  ...
  v12 = objc_alloc(MEMORY[0x1E0D75170]);
  objc_msgSend(v11, "hue");
  v14 = v13;
  objc_msgSend(v11, "chroma");
  v16 = (void *)objc_msgSend(v12, "initWithLuma:hue:chroma:", 0.75, v14, v15);
  v17 = objc_alloc((Class)a1);
  objc_msgSend(MEMORY[0x1E0D75170], "blackColor");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = (void *)objc_msgSend(v17, "initWithColor:clockColor:colorSuggestions:", v16, v18, MEMORY[0x1E0C9AA60]);
