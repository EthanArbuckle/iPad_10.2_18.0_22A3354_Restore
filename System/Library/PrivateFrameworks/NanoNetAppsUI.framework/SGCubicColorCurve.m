...
- (SGCubicColorCurve)initWithCubicColorCurveElements:(id)a3
{
  ...
  double v15;
  __int128 v16;
  SGCubicColorCurve *v17;
  objc_super v19;

  v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)SGCubicColorCurve;
  v5 = -[SGCubicColorCurve init](&v19, sel_init);
  if (v5)
  {
    ...
    *(_QWORD *)v5->_colors = malloc_type_malloc(16 * v5->_count, 0x1000040451B5BE8uLL);
    v8 = -[SGCubicSpline initWithNumberOfControlPoints:isClosed:]([SGCubicSpline alloc], "initWithNumberOfControlPoints:isClosed:", LODWORD(v5->_count), 0);
    spline = v5->_spline;
    v5->_spline = v8;

    v10 = -[SGCubicSpline controlPointsBuffer](v5->_spline, "controlPointsBuffer");
    if (v5->_count)
    {
      v11 = (_QWORD *)v10;
      v12 = 0;
    ...
    -[SGCubicSpline process](v5->_spline, "process");
    v17 = v5;
...
- (SGCubicColorCurve)initWithColorCurveElements:(id)a3
{
  ...
  void *v16;
  __int128 v17;
  SGCubicColorCurve *v18;
  objc_super v20;

  v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)SGCubicColorCurve;
  v5 = -[SGCubicColorCurve init](&v20, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "sortedArrayUsingComparator:", &__block_literal_global_17);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = objc_msgSend(v4, "count");
    v5->_count = v7;
    v5->_fractions = (float *)malloc_type_malloc(4 * v7, 0x100004052888210uLL);
...
- (void)dealloc
{
  ...
  -[SGCubicColorCurve dealloc](&v3, sel_dealloc);
}

- (id)colorForFraction:(float)a3
{
  -[SGCubicColorCurve rgbfColorForFraction:](self, "rgbfColorForFraction:", a3);
