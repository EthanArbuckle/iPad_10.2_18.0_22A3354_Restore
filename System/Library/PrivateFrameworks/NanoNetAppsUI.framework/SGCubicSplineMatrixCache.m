...
- (SGCubicSplineMatrixCache)init
{
  ...
  v2 = -[SGCubicSplineMatrixCache init](&v10, sel_init);
  if (v2)
  {
    v3 = objc_opt_new();
...
void __42__SGCubicSplineMatrixCache_sharedInstance__block_invoke()
{
  SGCubicSplineMatrixCache *v0;
  void *v1;

  v0 = objc_alloc_init(SGCubicSplineMatrixCache);
...
void __76__SGCubicSplineMatrixCache_splineMatrixWithDimension_cache_matrixGenerator___block_invoke(uint64_t a1)
{
  ...
  else
  {
    *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24) = (*(uint64_t (**)(void))(*(_QWORD *)(a1 + 40) + 16))();
    ...
    SGSplineMatrix_invert(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24), (uint64_t)v4);
    SGSplineMatrixInversionWorkspace_destroy(v4);
    SGSplineMatrix_convert_to_single_precision(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24));
    SGSplineMatrix_discard_double_precision(*(void ***)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24));
    objc_msgSend(MEMORY[0x24BDD1968], "valueWithPointer:", *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24));
    v7 = (id)objc_claimAutoreleasedReturnValue();
    v5 = *(void **)(a1 + 32);
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", *(unsigned int *)(a1 + 56));
...
- ($6F5639B62F6C861EB4A71773F5DCFA27)openSplineMatrixWithDimension:(int)a3
{
  ...
  v6 = a3;
  return -[SGCubicSplineMatrixCache splineMatrixWithDimension:cache:matrixGenerator:](self, "splineMatrixWithDimension:cache:matrixGenerator:", *(_QWORD *)&a3, openMatrixCache, v5);
}

_QWORD *__58__SGCubicSplineMatrixCache_openSplineMatrixWithDimension___block_invoke(uint64_t a1)
{
...
- ($6F5639B62F6C861EB4A71773F5DCFA27)closedSplineMatrixWithDimension:(int)a3
{
  ...
  v5[3] = &__block_descriptor_36_e14______d_fi_8__0l;
  v6 = a3;
  return -[SGCubicSplineMatrixCache splineMatrixWithDimension:cache:matrixGenerator:](self, "splineMatrixWithDimension:cache:matrixGenerator:", *(_QWORD *)&a3, closedMatrixCache, v5);
}

_QWORD *__60__SGCubicSplineMatrixCache_closedSplineMatrixWithDimension___block_invoke(uint64_t a1)
{
