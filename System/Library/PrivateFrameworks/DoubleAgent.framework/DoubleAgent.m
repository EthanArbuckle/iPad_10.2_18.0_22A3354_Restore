...
id doubleagent_std_log()
{
  if (doubleagent_std_log_once != -1)
    dispatch_once(&doubleagent_std_log_once, &__block_literal_global);
  return (id)doubleagent_std_log_logger;
}

void __doubleagent_std_log_block_invoke()
{
  os_log_t v0;
  void *v1;

  v0 = os_log_create("com.apple.DoubleAgent", "default");
  v1 = (void *)doubleagent_std_log_logger;
  doubleagent_std_log_logger = (uint64_t)v0;
