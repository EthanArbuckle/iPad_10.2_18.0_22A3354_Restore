...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 linkId](self, "linkId");
  ...
  if (v8)
    -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 deleteLinkId](self, "deleteLinkId");
  -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 confusionPairs](self, "confusionPairs");
  ...
  -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 setConfusionPairs:](self, "setConfusionPairs:", v10);
...
- (void)deleteLinkId
{
  -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 setLinkId:](self, "setLinkId:", 0);
}
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_confusionPairs, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_confusionPairs, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("confusionPairs"));
  }
  if (self->_linkId)
  {
    -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 linkId](self, "linkId");
...
- (NSData)jsonData
{
  ...
  -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  DODMLASRSchemaDODMLASRConfusionPairTier1 *v15;
  DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 setLinkId:](v5, "setLinkId:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[DODMLASRSchemaDODMLASRConfusionPairTier1 initWithDictionary:]([DODMLASRSchemaDODMLASRConfusionPairTier1 alloc], "initWithDictionary:", v14);
              -[DODMLASRSchemaDODMLASRUserEditExperimentEndedTier1 addConfusionPairs:](v5, "addConfusionPairs:", v15);
