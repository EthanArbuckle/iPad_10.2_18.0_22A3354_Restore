...
- (void)deleteSynthesizedAudioDurationInSecond
{
  ...
  LODWORD(v2) = 0;
  -[TTSSchemaTTSSpeechEnded setSynthesizedAudioDurationInSecond:](self, "setSynthesizedAudioDurationInSecond:", v2);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)deleteSynthesisLatencyInSecond
{
  ...
  LODWORD(v2) = 0;
  -[TTSSchemaTTSSpeechEnded setSynthesisLatencyInSecond:](self, "setSynthesisLatencyInSecond:", v2);
  *(_BYTE *)&self->_has &= ~2u;
}
...
- (void)deleteSynthesisRealTimeFactor
{
  ...
  LODWORD(v2) = 0;
  -[TTSSchemaTTSSpeechEnded setSynthesisRealTimeFactor:](self, "setSynthesisRealTimeFactor:", v2);
  *(_BYTE *)&self->_has &= ~4u;
}
...
{
  -[TTSSchemaTTSSpeechEnded setPromptCount:](self, "setPromptCount:", 0);
  *(_BYTE *)&self->_has &= ~8u;
}
  ...
  if (v9 == ((v6 >> 1) & 1))
  {
    ...
    if (v12 == ((v6 >> 2) & 1))
    {
      ...
      if (v15 == ((v6 >> 3) & 1))
      {
        ...
        {
          -[TTSSchemaTTSSpeechEnded errorCodes](self, "errorCodes");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 8) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[TTSSchemaTTSSpeechEnded promptCount](self, "promptCount"));
...
LABEL_11:
      ...
      -[TTSSchemaTTSSpeechEnded synthesisRealTimeFactor](self, "synthesisRealTimeFactor");
  ...
  -[TTSSchemaTTSSpeechEnded synthesisLatencyInSecond](self, "synthesisLatencyInSecond");
...
LABEL_7:
    ...
    -[TTSSchemaTTSSpeechEnded synthesizedAudioDurationInSecond](self, "synthesizedAudioDurationInSecond");
...
- (NSData)jsonData
{
  ...
  -[TTSSchemaTTSSpeechEnded dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (TTSSchemaTTSSpeechEnded)initWithJSON:(id)a3
{
  ...
  {
    self = -[TTSSchemaTTSSpeechEnded initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (TTSSchemaTTSSpeechEnded)initWithDictionary:(id)a3
{
  ...
  v5 = -[TTSSchemaTTSSpeechEnded init](&v26, sel_init);
  if (v5)
  {
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[TTSSchemaTTSSpeechEnded setPromptCount:](v5, "setPromptCount:", objc_msgSend(v9, "unsignedIntValue"));
      ...
      if (v12)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if ((objc_opt_isKindOfClass() & 1) != 0)
              -[TTSSchemaTTSSpeechEnded addErrorCodes:](v5, "addErrorCodes:", objc_msgSend(v16, "intValue"));
            ++v15;
          }
          while (v13 != v15);
