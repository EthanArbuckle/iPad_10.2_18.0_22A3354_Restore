...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 2))
    -[MTSchemaMTAppTextBoxDismissedTier1 deleteTranslationPayload](self, "deleteTranslationPayload");
  ...
  if (objc_msgSend(v4, "isConditionSet:", 7))
    -[MTSchemaMTAppTextBoxDismissedTier1 deleteTranslationPayload](self, "deleteTranslationPayload");
  -[MTSchemaMTAppTextBoxDismissedTier1 localePair](self, "localePair");
  ...
  if (v8)
    -[MTSchemaMTAppTextBoxDismissedTier1 deleteLocalePair](self, "deleteLocalePair");
...
{
  -[MTSchemaMTAppTextBoxDismissedTier1 setTranslationPayload:](self, "setTranslationPayload:", 0);
}
...
{
  -[MTSchemaMTAppTextBoxDismissedTier1 setLocalePair:](self, "setLocalePair:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[MTSchemaMTAppTextBoxDismissedTier1 translationPayload](self, "translationPayload");
...
- (NSData)jsonData
{
  ...
  -[MTSchemaMTAppTextBoxDismissedTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  MTSchemaMTAppTextBoxDismissedTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[MTSchemaMTAppTextBoxDismissedTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MTSchemaMTAppTextBoxDismissedTier1)initWithDictionary:(id)a3
{
  ...
  MTSchemaMTAppTextBoxDismissedTier1 *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)MTSchemaMTAppTextBoxDismissedTier1;
  v5 = -[MTSchemaMTAppTextBoxDismissedTier1 init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTAppTextBoxDismissedTier1 setTranslationPayload:](v5, "setTranslationPayload:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTAppTextBoxDismissedTier1 setLocalePair:](v5, "setLocalePair:", v9);
