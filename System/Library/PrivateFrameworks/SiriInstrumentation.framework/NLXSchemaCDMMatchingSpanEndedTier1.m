...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[NLXSchemaCDMMatchingSpanEndedTier1 linkId](self, "linkId");
  ...
  if (v8)
    -[NLXSchemaCDMMatchingSpanEndedTier1 deleteLinkId](self, "deleteLinkId");
  -[NLXSchemaCDMMatchingSpanEndedTier1 matchingSpans](self, "matchingSpans");
  ...
  -[NLXSchemaCDMMatchingSpanEndedTier1 setMatchingSpans:](self, "setMatchingSpans:", v10);
...
- (void)deleteLinkId
{
  -[NLXSchemaCDMMatchingSpanEndedTier1 setLinkId:](self, "setLinkId:", 0);
}
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_matchingSpans, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_matchingSpans, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("matchingSpans"));
  }
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaCDMMatchingSpanEndedTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  NLXSchemaCDMMatchingSpanEndedTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[NLXSchemaCDMMatchingSpanEndedTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaCDMMatchingSpanEndedTier1)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  NLXSchemaCDMMatchingSpanTier1 *v15;
  NLXSchemaCDMMatchingSpanEndedTier1 *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[NLXSchemaCDMMatchingSpanEndedTier1 init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[NLXSchemaCDMMatchingSpanEndedTier1 setLinkId:](v5, "setLinkId:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[NLXSchemaCDMMatchingSpanTier1 initWithDictionary:]([NLXSchemaCDMMatchingSpanTier1 alloc], "initWithDictionary:", v14);
              -[NLXSchemaCDMMatchingSpanEndedTier1 addMatchingSpans:](v5, "addMatchingSpans:", v15);
