...
- (void)deleteScore
{
  -[NLXSchemaMentionDetectorSpanData setScore:](self, "setScore:", 0.0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    -[NLXSchemaMentionDetectorSpanData score](self, "score");
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaMentionDetectorSpanData dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  NLXSchemaMentionDetectorSpanData *v5;
  uint64_t v7;
  ...
  {
    self = -[NLXSchemaMentionDetectorSpanData initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaMentionDetectorSpanData)initWithDictionary:(id)a3
{
  ...
  NLXSchemaMentionDetectorSpanData *v5;
  void *v6;
  NLXSchemaMentionDetectorSpanData *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)NLXSchemaMentionDetectorSpanData;
  v5 = -[NLXSchemaMentionDetectorSpanData init](&v9, sel_init);
  if (v5)
  {
