...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[IFTSchemaIFTQueryResults candidates](self, "candidates", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[IFTSchemaIFTQueryResults setCandidates:](self, "setCandidates:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[IFTSchemaIFTQueryResults candidates](self, "candidates");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_candidates, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[IFTSchemaIFTQueryResults dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (IFTSchemaIFTQueryResults)initWithJSON:(id)a3
{
  ...
  {
    self = -[IFTSchemaIFTQueryResults initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFTSchemaIFTQueryResults)initWithDictionary:(id)a3
{
  ...
  IFTSchemaIFTCandidate *v14;
  IFTSchemaIFTQueryResults *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[IFTSchemaIFTQueryResults init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[IFTSchemaIFTCandidate initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[IFTSchemaIFTQueryResults addCandidates:](v5, "addCandidates:", v14);
