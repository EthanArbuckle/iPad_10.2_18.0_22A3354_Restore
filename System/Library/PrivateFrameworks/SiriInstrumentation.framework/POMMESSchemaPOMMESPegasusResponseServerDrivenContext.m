...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (v6)
    -[POMMESSchemaPOMMESPegasusResponseServerDrivenContext deleteCatId](self, "deleteCatId");
  return v5;
}

- (void)clearCatId
{
  -[NSArray removeAllObjects](self->_catIds, "removeAllObjects");
}
...
- (void)addCatId:(id)a3
{
  ...
  -[NSArray addObject:](catIds, "addObject:", v4);

}

- (unint64_t)catIdCount
{
  return -[NSArray count](self->_catIds, "count");
}

- (id)catIdAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_catIds, "objectAtIndexedSubscript:", a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[POMMESSchemaPOMMESPegasusResponseServerDrivenContext catIds](self, "catIds");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "catIds");
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_catIds, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[POMMESSchemaPOMMESPegasusResponseServerDrivenContext dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  POMMESSchemaPOMMESPegasusResponseServerDrivenContext *v5;
  uint64_t v7;
  ...
  {
    self = -[POMMESSchemaPOMMESPegasusResponseServerDrivenContext initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (POMMESSchemaPOMMESPegasusResponseServerDrivenContext)initWithDictionary:(id)a3
{
  ...
  void *v12;
  void *v13;
  POMMESSchemaPOMMESPegasusResponseServerDrivenContext *v14;
  __int128 v16;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  ...
  v5 = -[POMMESSchemaPOMMESPegasusResponseServerDrivenContext init](&v20, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[POMMESSchemaPOMMESPegasusResponseServerDrivenContext addCatId:](v5, "addCatId:", v13);
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_catIds, 0);
}
