...
{
  -[PEGASUSSchemaPEGASUSKGQAExecution setKgQAUsecase:](self, "setKgQAUsecase:", 0);
  *(&self->_isWebExtractedFact + 1) &= ~1u;
}
...
{
  -[PEGASUSSchemaPEGASUSKGQAExecution setIsDisputedResponse:](self, "setIsDisputedResponse:", 0);
  *(&self->_isWebExtractedFact + 1) &= ~2u;
}
...
- (void)deleteNlgKey
{
  -[PEGASUSSchemaPEGASUSKGQAExecution setNlgKey:](self, "setNlgKey:", 0);
}
...
{
  -[PEGASUSSchemaPEGASUSKGQAExecution setIsWebExtractedFact:](self, "setIsWebExtractedFact:", 0);
  *(&self->_isWebExtractedFact + 1) &= ~4u;
}
...
- (void)writeTo:(id)a3
{
  ...
  -[PEGASUSSchemaPEGASUSKGQAExecution nlgKey](self, "nlgKey", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[PEGASUSSchemaPEGASUSKGQAExecution attributes](self, "attributes");
  ...
  -[PEGASUSSchemaPEGASUSKGQAExecution nlgKey](self, "nlgKey");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if ((v6 & 2) == 0)
  {
    if ((*(&self->_isWebExtractedFact + 1) & 4) == 0)
      goto LABEL_5;
LABEL_8:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSKGQAExecution isWebExtractedFact](self, "isWebExtractedFact"));
    ...
    if (!*(&self->_isWebExtractedFact + 1))
      goto LABEL_13;
LABEL_9:
    v9 = -[PEGASUSSchemaPEGASUSKGQAExecution kgQAUsecase](self, "kgQAUsecase") - 1;
    if (v9 > 6)
      v10 = CFSTR("PEGASUSKGQAUSECASE_UNKNOWN");
    else
      v10 = off_1E563B0F0[v9];
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("kgQAUsecase"));
    goto LABEL_13;
  }
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSKGQAExecution isDisputedResponse](self, "isDisputedResponse"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[PEGASUSSchemaPEGASUSKGQAExecution dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PEGASUSSchemaPEGASUSKGQAExecution *v5;
  uint64_t v7;
  ...
  {
    self = -[PEGASUSSchemaPEGASUSKGQAExecution initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PEGASUSSchemaPEGASUSKGQAExecution)initWithDictionary:(id)a3
{
  ...
  void *v17;
  void *v18;
  PEGASUSSchemaPEGASUSKGQAExecution *v19;
  __int128 v21;
  __int128 v22;
  __int128 v23;
  __int128 v24;
  ...
  v5 = -[PEGASUSSchemaPEGASUSKGQAExecution init](&v25, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSKGQAExecution setKgQAUsecase:](v5, "setKgQAUsecase:", objc_msgSend(v6, "intValue"));
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[PEGASUSSchemaPEGASUSKGQAExecution addAttributes:](v5, "addAttributes:", v14);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSKGQAExecution setIsDisputedResponse:](v5, "setIsDisputedResponse:", objc_msgSend(v15, "BOOLValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PEGASUSSchemaPEGASUSKGQAExecution setNlgKey:](v5, "setNlgKey:", v17);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSKGQAExecution setIsWebExtractedFact:](v5, "setIsWebExtractedFact:", objc_msgSend(v18, "BOOLValue"));
    v19 = v5;
