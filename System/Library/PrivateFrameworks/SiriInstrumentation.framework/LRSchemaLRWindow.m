...
{
  -[LRSchemaLRWindow setStartTimeInNs:](self, "setStartTimeInNs:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[LRSchemaLRWindow setEndTimeInNs:](self, "setEndTimeInNs:", 0);
  *(_BYTE *)&self->_has &= ~2u;
}

- (void)clearActiveRedactionPolicies
{
  -[NSArray removeAllObjects](self->_activeRedactionPolicies, "removeAllObjects");
}
...
- (void)addActiveRedactionPolicies:(int)a3
{
  ...
  -[NSArray addObject:](activeRedactionPolicies, "addObject:", v8);

}

- (unint64_t)activeRedactionPoliciesCount
{
  return -[NSArray count](self->_activeRedactionPolicies, "count");
}
...
- (int)activeRedactionPoliciesAtIndex:(unint64_t)a3
{
  ...
  -[NSArray objectAtIndexedSubscript:](self->_activeRedactionPolicies, "objectAtIndexedSubscript:", a3);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v8 == ((v6 >> 1) & 1))
  {
    ...
    {
      -[LRSchemaLRWindow activeRedactionPolicies](self, "activeRedactionPolicies");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "activeRedactionPolicies");
...
LABEL_5:
    v3 = 0;
    return v3 ^ v2 ^ -[NSArray hash](self->_activeRedactionPolicies, "hash");
  }
  v2 = 0;
  if ((*(_BYTE *)&self->_has & 2) == 0)
    goto LABEL_5;
...
- (id)dictionaryRepresentation
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (-[NSArray count](self->_activeRedactionPolicies, "count"))
  {
    -[LRSchemaLRWindow activeRedactionPolicies](self, "activeRedactionPolicies");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = (void *)objc_msgSend(v4, "copy");
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("activeRedactionPolicies"));

  }
  has = (char)self->_has;
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[LRSchemaLRWindow endTimeInNs](self, "endTimeInNs"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("endTimeInNs"));

    has = (char)self->_has;
  }
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[LRSchemaLRWindow startTimeInNs](self, "startTimeInNs"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("startTimeInNs"));
...
- (NSData)jsonData
{
  ...
  -[LRSchemaLRWindow dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (LRSchemaLRWindow)initWithJSON:(id)a3
{
  ...
  {
    self = -[LRSchemaLRWindow initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (LRSchemaLRWindow)initWithDictionary:(id)a3
{
  ...
  v5 = -[LRSchemaLRWindow init](&v22, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[LRSchemaLRWindow setStartTimeInNs:](v5, "setStartTimeInNs:", objc_msgSend(v6, "unsignedLongLongValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("endTimeInNs"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[LRSchemaLRWindow setEndTimeInNs:](v5, "setEndTimeInNs:", objc_msgSend(v7, "unsignedLongLongValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("activeRedactionPolicies"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if ((objc_opt_isKindOfClass() & 1) != 0)
              -[LRSchemaLRWindow addActiveRedactionPolicies:](v5, "addActiveRedactionPolicies:", objc_msgSend(v14, "intValue"));
            ++v13;
          }
          while (v11 != v13);
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_activeRedactionPolicies, 0);
}
