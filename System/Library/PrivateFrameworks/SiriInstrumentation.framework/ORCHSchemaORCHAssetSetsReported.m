...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ORCHSchemaORCHAssetSetsReported uafAssetSets](self, "uafAssetSets", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[ORCHSchemaORCHAssetSetsReported setUafAssetSets:](self, "setUafAssetSets:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[ORCHSchemaORCHAssetSetsReported uafAssetSets](self, "uafAssetSets");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_uafAssetSets, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_uafAssetSets, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("uafAssetSets"));
  }
...
- (NSData)jsonData
{
  ...
  -[ORCHSchemaORCHAssetSetsReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ORCHSchemaORCHAssetSetsReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ORCHSchemaORCHAssetSetsReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ORCHSchemaORCHAssetSetsReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  UAFSchemaUAFAssetSet *v13;
  UAFSchemaUAFAssetSet *v14;
  ORCHSchemaORCHAssetSetsReported *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[ORCHSchemaORCHAssetSetsReported init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[UAFSchemaUAFAssetSet initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[ORCHSchemaORCHAssetSetsReported addUafAssetSets:](v5, "addUafAssetSets:", v14);
