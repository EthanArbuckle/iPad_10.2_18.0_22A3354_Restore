...
- (void)deleteGroupId
{
  -[RRSchemaRRGroupIdentifier setGroupId:](self, "setGroupId:", 0);
}
...
- (void)deleteSeq
{
  -[RRSchemaRRGroupIdentifier setSeq:](self, "setSeq:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[RRSchemaRRGroupIdentifier groupId](self, "groupId");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[RRSchemaRRGroupIdentifier seq](self, "seq"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[RRSchemaRRGroupIdentifier dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (RRSchemaRRGroupIdentifier)initWithJSON:(id)a3
{
  ...
  {
    self = -[RRSchemaRRGroupIdentifier initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RRSchemaRRGroupIdentifier)initWithDictionary:(id)a3
{
  ...
  void *v7;
  void *v8;
  RRSchemaRRGroupIdentifier *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RRSchemaRRGroupIdentifier;
  v5 = -[RRSchemaRRGroupIdentifier init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[RRSchemaRRGroupIdentifier setGroupId:](v5, "setGroupId:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RRSchemaRRGroupIdentifier setSeq:](v5, "setSeq:", objc_msgSend(v8, "unsignedIntValue"));
    v9 = v5;
