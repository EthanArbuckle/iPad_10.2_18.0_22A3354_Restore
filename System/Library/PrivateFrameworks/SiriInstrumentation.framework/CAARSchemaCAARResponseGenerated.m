...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[CAARSchemaCAARResponseGenerated actionCandidateIds](self, "actionCandidateIds", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[CAARSchemaCAARResponseGenerated setActionCandidateIds:](self, "setActionCandidateIds:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[CAARSchemaCAARResponseGenerated actionCandidateIds](self, "actionCandidateIds");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_actionCandidateIds, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[CAARSchemaCAARResponseGenerated dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  CAARSchemaCAARResponseGenerated *v5;
  uint64_t v7;
  ...
  {
    self = -[CAARSchemaCAARResponseGenerated initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (CAARSchemaCAARResponseGenerated)initWithDictionary:(id)a3
{
  ...
  SISchemaUUID *v13;
  SISchemaUUID *v14;
  CAARSchemaCAARResponseGenerated *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[CAARSchemaCAARResponseGenerated init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[SISchemaUUID initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[CAARSchemaCAARResponseGenerated addActionCandidateIds:](v5, "addActionCandidateIds:", v14);
