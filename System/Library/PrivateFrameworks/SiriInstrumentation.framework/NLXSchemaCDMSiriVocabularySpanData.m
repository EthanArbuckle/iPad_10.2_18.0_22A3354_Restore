...
{
  -[NLXSchemaCDMSiriVocabularySpanData setMatchScore:](self, "setMatchScore:", 0.0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    {
      if ((*(_BYTE *)&self->_has & 1) == 0
        || (matchScore = self->_matchScore, objc_msgSend(v4, "matchScore"), matchScore == v6))
      {
        v7 = 1;
      }
    }
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    -[NLXSchemaCDMSiriVocabularySpanData matchScore](self, "matchScore");
    objc_msgSend(v4, "numberWithDouble:");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("matchScore"));
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaCDMSiriVocabularySpanData dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  NLXSchemaCDMSiriVocabularySpanData *v5;
  uint64_t v7;
  ...
  {
    self = -[NLXSchemaCDMSiriVocabularySpanData initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaCDMSiriVocabularySpanData)initWithDictionary:(id)a3
{
  ...
  v5 = -[NLXSchemaCDMSiriVocabularySpanData init](&v9, sel_init);
  if (v5)
  {
