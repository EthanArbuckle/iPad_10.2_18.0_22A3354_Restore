...
{
  -[ANCSchemaANCAudioDevice setVendorIdentifier:](self, "setVendorIdentifier:", 0);
}
...
{
  -[ANCSchemaANCAudioDevice setProductIdentifier:](self, "setProductIdentifier:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[ANCSchemaANCAudioDevice vendorIdentifier](self, "vendorIdentifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[ANCSchemaANCAudioDevice productIdentifier](self, "productIdentifier");
...
- (NSData)jsonData
{
  ...
  -[ANCSchemaANCAudioDevice dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (ANCSchemaANCAudioDevice)initWithJSON:(id)a3
{
  ...
  {
    self = -[ANCSchemaANCAudioDevice initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ANCSchemaANCAudioDevice)initWithDictionary:(id)a3
{
  ...
  void *v8;
  void *v9;
  ANCSchemaANCAudioDevice *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)ANCSchemaANCAudioDevice;
  v5 = -[ANCSchemaANCAudioDevice init](&v12, sel_init);
  if (v5)
  {
    ...
    {
      v7 = (void *)objc_msgSend(v6, "copy");
      -[ANCSchemaANCAudioDevice setVendorIdentifier:](v5, "setVendorIdentifier:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ANCSchemaANCAudioDevice setProductIdentifier:](v5, "setProductIdentifier:", v9);
