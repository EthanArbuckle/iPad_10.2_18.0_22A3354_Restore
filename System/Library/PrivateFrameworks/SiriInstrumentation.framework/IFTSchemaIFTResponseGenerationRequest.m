...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[IFTSchemaIFTResponseGenerationRequest actionStepResultEventIds](self, "actionStepResultEventIds", v11.receiver, v11.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[IFTSchemaIFTResponseGenerationRequest setActionStepResultEventIds:](self, "setActionStepResultEventIds:", v7);

  -[IFTSchemaIFTResponseGenerationRequest statementResults](self, "statementResults");
  ...
  -[IFTSchemaIFTResponseGenerationRequest setStatementResults:](self, "setStatementResults:", v9);
  return v5;
}

- (void)clearActionStepResultEventIds
{
  -[NSArray removeAllObjects](self->_actionStepResultEventIds, "removeAllObjects");
}
...
- (void)addActionStepResultEventIds:(id)a3
{
  ...
  if (!actionStepResultEventIds)
  {
    ...
    v7 = self->_actionStepResultEventIds;
    self->_actionStepResultEventIds = v6;

    v4 = v8;
    actionStepResultEventIds = self->_actionStepResultEventIds;
  }
  -[NSArray addObject:](actionStepResultEventIds, "addObject:", v4);

}

- (unint64_t)actionStepResultEventIdsCount
{
  return -[NSArray count](self->_actionStepResultEventIds, "count");
}

- (id)actionStepResultEventIdsAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_actionStepResultEventIds, "objectAtIndexedSubscript:", a3);
}

- (void)clearStatementResults
{
  -[NSArray removeAllObjects](self->_statementResults, "removeAllObjects");
}
...
- (void)addStatementResults:(id)a3
{
  ...
  if (!statementResults)
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    v6 = (NSArray *)objc_claimAutoreleasedReturnValue();
    v7 = self->_statementResults;
    self->_statementResults = v6;

    v4 = v8;
    statementResults = self->_statementResults;
  }
  -[NSArray addObject:](statementResults, "addObject:", v4);

}

- (unint64_t)statementResultsCount
{
  return -[NSArray count](self->_statementResults, "count");
}

- (id)statementResultsAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_statementResults, "objectAtIndexedSubscript:", a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[IFTSchemaIFTResponseGenerationRequest actionStepResultEventIds](self, "actionStepResultEventIds");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "actionStepResultEventIds");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) == (v6 != 0))
    goto LABEL_11;
  -[IFTSchemaIFTResponseGenerationRequest actionStepResultEventIds](self, "actionStepResultEventIds");
  ...
  -[IFTSchemaIFTResponseGenerationRequest statementResults](self, "statementResults");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "statementResults");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) != (v6 != 0))
  {
    -[IFTSchemaIFTResponseGenerationRequest statementResults](self, "statementResults");
...
- (unint64_t)hash
{
  ...
  v3 = -[NSArray hash](self->_actionStepResultEventIds, "hash");
  return -[NSArray hash](self->_statementResults, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_actionStepResultEventIds, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("actionStepResultEventIds"));
  }
  if (-[NSArray count](self->_statementResults, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("statementResults"));
  }
...
- (NSData)jsonData
{
  ...
  -[IFTSchemaIFTResponseGenerationRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  IFTSchemaIFTResponseGenerationRequest *v5;
  uint64_t v7;
  ...
  {
    self = -[IFTSchemaIFTResponseGenerationRequest initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFTSchemaIFTResponseGenerationRequest)initWithDictionary:(id)a3
{
  ...
  uint64_t v19;
  uint64_t v20;
  IFTSchemaIFTStatementResult *v21;
  IFTSchemaIFTResponseGenerationRequest *v22;
  void *v24;
  __int128 v25;
  __int128 v26;
  __int128 v27;
  ...
  v5 = -[IFTSchemaIFTResponseGenerationRequest init](&v33, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("actionStepResultEventIds"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[IFTSchemaIFTResponseGenerationRequest addActionStepResultEventIds:](v5, "addActionStepResultEventIds:", v13);
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("statementResults"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v16)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v21 = -[IFTSchemaIFTStatementResult initWithDictionary:]([IFTSchemaIFTStatementResult alloc], "initWithDictionary:", v20);
              -[IFTSchemaIFTResponseGenerationRequest addStatementResults:](v5, "addStatementResults:", v21);
