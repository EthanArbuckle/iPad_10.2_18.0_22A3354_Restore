...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[PLUSSchemaPLUSContactGroundTruthGenerated originalPlusId](self, "originalPlusId");
  ...
  if (v8)
    -[PLUSSchemaPLUSContactGroundTruthGenerated deleteOriginalPlusId](self, "deleteOriginalPlusId");
  -[PLUSSchemaPLUSContactGroundTruthGenerated groundTruth](self, "groundTruth");
  ...
  if (v11)
    -[PLUSSchemaPLUSContactGroundTruthGenerated deleteGroundTruth](self, "deleteGroundTruth");
...
{
  -[PLUSSchemaPLUSContactGroundTruthGenerated setOriginalPlusId:](self, "setOriginalPlusId:", 0);
}
...
{
  -[PLUSSchemaPLUSContactGroundTruthGenerated setGroundTruth:](self, "setGroundTruth:", 0);
}
...
- (unint64_t)hash
{
  ...
  return -[PLUSSchemaPLUSContactGroundTruth hash](self->_groundTruth, "hash") ^ v3;
}
...
- (NSData)jsonData
{
  ...
  -[PLUSSchemaPLUSContactGroundTruthGenerated dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PLUSSchemaPLUSContactGroundTruthGenerated *v5;
  uint64_t v7;
  ...
  {
    self = -[PLUSSchemaPLUSContactGroundTruthGenerated initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PLUSSchemaPLUSContactGroundTruthGenerated)initWithDictionary:(id)a3
{
  ...
  SISchemaUUID *v7;
  void *v8;
  PLUSSchemaPLUSContactGroundTruth *v9;
  PLUSSchemaPLUSContactGroundTruthGenerated *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)PLUSSchemaPLUSContactGroundTruthGenerated;
  v5 = -[PLUSSchemaPLUSContactGroundTruthGenerated init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PLUSSchemaPLUSContactGroundTruthGenerated setOriginalPlusId:](v5, "setOriginalPlusId:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v9 = -[PLUSSchemaPLUSContactGroundTruth initWithDictionary:]([PLUSSchemaPLUSContactGroundTruth alloc], "initWithDictionary:", v8);
      -[PLUSSchemaPLUSContactGroundTruthGenerated setGroundTruth:](v5, "setGroundTruth:", v9);
