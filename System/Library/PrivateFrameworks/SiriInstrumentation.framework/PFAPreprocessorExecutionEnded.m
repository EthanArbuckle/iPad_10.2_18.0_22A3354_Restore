...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[PFAPreprocessorExecutionEnded preprocessorExecutionMetrics](self, "preprocessorExecutionMetrics", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[PFAPreprocessorExecutionEnded deletePreprocessorExecutionMetrics](self, "deletePreprocessorExecutionMetrics");
  return v5;
}
...
{
  -[PFAPreprocessorExecutionEnded setPreprocessorExecutionMetrics:](self, "setPreprocessorExecutionMetrics:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[PFAPreprocessorExecutionEnded preprocessorExecutionMetrics](self, "preprocessorExecutionMetrics");
...
- (unint64_t)hash
{
  return -[PFAPreprocessorExecutionMetrics hash](self->_preprocessorExecutionMetrics, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_preprocessorExecutionMetrics)
  {
    ...
    if (v5)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("preprocessorExecutionMetrics"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("preprocessorExecutionMetrics"));
...
- (NSData)jsonData
{
  ...
  -[PFAPreprocessorExecutionEnded dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PFAPreprocessorExecutionEnded *v5;
  uint64_t v7;
  ...
  {
    self = -[PFAPreprocessorExecutionEnded initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PFAPreprocessorExecutionEnded)initWithDictionary:(id)a3
{
  ...
  PFAPreprocessorExecutionEnded *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PFAPreprocessorExecutionEnded;
  v5 = -[PFAPreprocessorExecutionEnded init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PFAPreprocessorExecutionEnded setPreprocessorExecutionMetrics:](v5, "setPreprocessorExecutionMetrics:", v7);
