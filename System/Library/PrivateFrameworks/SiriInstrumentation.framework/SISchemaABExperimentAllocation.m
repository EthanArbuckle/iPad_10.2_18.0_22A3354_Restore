...
{
  -[SISchemaABExperimentAllocation setExperimentId:](self, "setExperimentId:", 0);
}
...
{
  -[SISchemaABExperimentAllocation setTreatmentId:](self, "setTreatmentId:", 0);
}
...
{
  -[SISchemaABExperimentAllocation setDeploymentId:](self, "setDeploymentId:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[SISchemaABExperimentAllocation experimentId](self, "experimentId");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[SISchemaABExperimentAllocation treatmentId](self, "treatmentId");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[SISchemaABExperimentAllocation deploymentId](self, "deploymentId"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[SISchemaABExperimentAllocation dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SISchemaABExperimentAllocation *v5;
  uint64_t v7;
  ...
  {
    self = -[SISchemaABExperimentAllocation initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SISchemaABExperimentAllocation)initWithDictionary:(id)a3
{
  ...
  void *v9;
  void *v10;
  SISchemaABExperimentAllocation *v11;
  objc_super v13;

  v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)SISchemaABExperimentAllocation;
  v5 = -[SISchemaABExperimentAllocation init](&v13, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[SISchemaABExperimentAllocation setExperimentId:](v5, "setExperimentId:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[SISchemaABExperimentAllocation setTreatmentId:](v5, "setTreatmentId:", v9);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SISchemaABExperimentAllocation setDeploymentId:](v5, "setDeploymentId:", objc_msgSend(v10, "longLongValue"));
    v11 = v5;
