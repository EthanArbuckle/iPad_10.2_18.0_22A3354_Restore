...
{
  -[LRSchemaLRTimespanRedactionSignal setStartTimeInNs:](self, "setStartTimeInNs:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[LRSchemaLRTimespanRedactionSignal setEndTimeInNs:](self, "setEndTimeInNs:", 0);
  *(_BYTE *)&self->_has &= ~2u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[LRSchemaLRTimespanRedactionSignal endTimeInNs](self, "endTimeInNs"));
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[LRSchemaLRTimespanRedactionSignal startTimeInNs](self, "startTimeInNs"));
...
- (NSData)jsonData
{
  ...
  -[LRSchemaLRTimespanRedactionSignal dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  LRSchemaLRTimespanRedactionSignal *v5;
  uint64_t v7;
  ...
  {
    self = -[LRSchemaLRTimespanRedactionSignal initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (LRSchemaLRTimespanRedactionSignal)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  LRSchemaLRTimespanRedactionSignal *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)LRSchemaLRTimespanRedactionSignal;
  v5 = -[LRSchemaLRTimespanRedactionSignal init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[LRSchemaLRTimespanRedactionSignal setStartTimeInNs:](v5, "setStartTimeInNs:", objc_msgSend(v6, "unsignedLongLongValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("endTimeInNs"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[LRSchemaLRTimespanRedactionSignal setEndTimeInNs:](v5, "setEndTimeInNs:", objc_msgSend(v7, "unsignedLongLongValue"));
    v8 = v5;
