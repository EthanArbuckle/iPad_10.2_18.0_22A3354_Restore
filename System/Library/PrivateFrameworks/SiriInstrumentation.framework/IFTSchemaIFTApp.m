...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (v6)
    -[IFTSchemaIFTApp deleteBundleId](self, "deleteBundleId");
  return v5;
}
...
- (void)deleteBundleId
{
  -[IFTSchemaIFTApp setBundleId:](self, "setBundleId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[IFTSchemaIFTApp bundleId](self, "bundleId");
...
- (NSData)jsonData
{
  ...
  -[IFTSchemaIFTApp dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (IFTSchemaIFTApp)initWithJSON:(id)a3
{
  ...
  {
    self = -[IFTSchemaIFTApp initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFTSchemaIFTApp)initWithDictionary:(id)a3
{
  ...
  v5 = -[IFTSchemaIFTApp init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[IFTSchemaIFTApp setBundleId:](v5, "setBundleId:", v7);
