...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODDSiriSchemaODDAssistantDeviceDigestsReported fixedDimensions](self, "fixedDimensions");
  ...
  if (v8)
    -[ODDSiriSchemaODDAssistantDeviceDigestsReported deleteFixedDimensions](self, "deleteFixedDimensions");
  -[ODDSiriSchemaODDAssistantDeviceDigestsReported digests](self, "digests");
  ...
  -[ODDSiriSchemaODDAssistantDeviceDigestsReported setDigests:](self, "setDigests:", v10);
...
{
  -[ODDSiriSchemaODDAssistantDeviceDigestsReported setFixedDimensions:](self, "setFixedDimensions:", 0);
}
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDAssistantDeviceDigestsReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDAssistantDeviceDigestsReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDAssistantDeviceDigestsReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDAssistantDeviceDigestsReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ODDSiriSchemaODDAssistantDigest *v15;
  ODDSiriSchemaODDAssistantDeviceDigestsReported *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ODDSiriSchemaODDAssistantDeviceDigestsReported init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDAssistantDeviceDigestsReported setFixedDimensions:](v5, "setFixedDimensions:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ODDSiriSchemaODDAssistantDigest initWithDictionary:]([ODDSiriSchemaODDAssistantDigest alloc], "initWithDictionary:", v14);
              -[ODDSiriSchemaODDAssistantDeviceDigestsReported addDigests:](v5, "addDigests:", v15);
