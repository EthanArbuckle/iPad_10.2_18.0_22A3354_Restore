...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[CAMSchemaCAMModelId modelVersion](self, "modelVersion", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[CAMSchemaCAMModelId deleteModelVersion](self, "deleteModelVersion");
  return v5;
}
...
{
  -[CAMSchemaCAMModelId setModelName:](self, "setModelName:", 0);
}
...
{
  -[CAMSchemaCAMModelId setModelVersion:](self, "setModelVersion:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[CAMSchemaCAMModelId modelName](self, "modelName");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[CAMSchemaCAMModelId modelVersion](self, "modelVersion");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  ...
  return -[SISchemaVersion hash](self->_modelVersion, "hash") ^ v3;
}
...
- (NSData)jsonData
{
  ...
  -[CAMSchemaCAMModelId dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (CAMSchemaCAMModelId)initWithJSON:(id)a3
{
  ...
  {
    self = -[CAMSchemaCAMModelId initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (CAMSchemaCAMModelId)initWithDictionary:(id)a3
{
  ...
  void *v8;
  SISchemaVersion *v9;
  CAMSchemaCAMModelId *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)CAMSchemaCAMModelId;
  v5 = -[CAMSchemaCAMModelId init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CAMSchemaCAMModelId setModelName:](v5, "setModelName:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CAMSchemaCAMModelId setModelVersion:](v5, "setModelVersion:", v9);
