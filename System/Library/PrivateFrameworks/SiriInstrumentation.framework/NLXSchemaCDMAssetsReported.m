...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[NLXSchemaCDMAssetsReported assets](self, "assets", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[NLXSchemaCDMAssetsReported setAssets:](self, "setAssets:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[NLXSchemaCDMAssetsReported assets](self, "assets");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaCDMAssetsReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (NLXSchemaCDMAssetsReported)initWithJSON:(id)a3
{
  ...
  {
    self = -[NLXSchemaCDMAssetsReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaCDMAssetsReported)initWithDictionary:(id)a3
{
  ...
  SISchemaAsset *v13;
  SISchemaAsset *v14;
  NLXSchemaCDMAssetsReported *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[NLXSchemaCDMAssetsReported init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[NLXSchemaCDMAssetsReported addAssets:](v5, "addAssets:", v14);
