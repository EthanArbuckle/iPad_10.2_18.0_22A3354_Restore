...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (v6)
    -[QDSchemaQDEntityType deleteBundleId](self, "deleteBundleId");
  return v5;
}
...
- (void)deleteBundleId
{
  -[QDSchemaQDEntityType setBundleId:](self, "setBundleId:", 0);
}
...
{
  -[QDSchemaQDEntityType setNameOfTypedValue:](self, "setNameOfTypedValue:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[QDSchemaQDEntityType bundleId](self, "bundleId");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[QDSchemaQDEntityType nameOfTypedValue](self, "nameOfTypedValue");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[QDSchemaQDEntityType nameOfTypedValue](self, "nameOfTypedValue");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "nameOfTypedValue");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) != (v6 != 0))
  {
    -[QDSchemaQDEntityType nameOfTypedValue](self, "nameOfTypedValue");
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_nameOfTypedValue, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_nameOfTypedValue)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("nameOfTypedValue"));
...
- (NSData)jsonData
{
  ...
  -[QDSchemaQDEntityType dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (QDSchemaQDEntityType)initWithJSON:(id)a3
{
  ...
  {
    self = -[QDSchemaQDEntityType initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (QDSchemaQDEntityType)initWithDictionary:(id)a3
{
  ...
  v5 = -[QDSchemaQDEntityType init](&v12, sel_init);
  if (v5)
  {
    ...
    {
      v7 = (void *)objc_msgSend(v6, "copy");
      -[QDSchemaQDEntityType setBundleId:](v5, "setBundleId:", v7);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("nameOfTypedValue"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v9 = (void *)objc_msgSend(v8, "copy");
      -[QDSchemaQDEntityType setNameOfTypedValue:](v5, "setNameOfTypedValue:", v9);
