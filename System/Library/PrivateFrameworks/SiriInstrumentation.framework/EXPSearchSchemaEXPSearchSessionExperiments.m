...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[EXPSearchSchemaEXPSearchSessionExperiments searchSessionId](self, "searchSessionId");
  ...
  if (v8)
    -[EXPSearchSchemaEXPSearchSessionExperiments deleteSearchSessionId](self, "deleteSearchSessionId");
  -[EXPSearchSchemaEXPSearchSessionExperiments activeExperiments](self, "activeExperiments");
  ...
  -[EXPSearchSchemaEXPSearchSessionExperiments setActiveExperiments:](self, "setActiveExperiments:", v10);
...
{
  -[EXPSearchSchemaEXPSearchSessionExperiments setSearchSessionId:](self, "setSearchSessionId:", 0);
}

- (void)clearActiveExperiments
{
  -[NSArray removeAllObjects](self->_activeExperiments, "removeAllObjects");
}
...
- (void)addActiveExperiments:(id)a3
{
  ...
  -[NSArray addObject:](activeExperiments, "addObject:", v4);

}

- (unint64_t)activeExperimentsCount
{
  return -[NSArray count](self->_activeExperiments, "count");
}

- (id)activeExperimentsAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_activeExperiments, "objectAtIndexedSubscript:", a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[EXPSearchSchemaEXPSearchSessionExperiments searchSessionId](self, "searchSessionId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "searchSessionId");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) == (v6 != 0))
    goto LABEL_11;
  -[EXPSearchSchemaEXPSearchSessionExperiments searchSessionId](self, "searchSessionId");
  ...
  -[EXPSearchSchemaEXPSearchSessionExperiments activeExperiments](self, "activeExperiments");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "activeExperiments");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) != (v6 != 0))
  {
    -[EXPSearchSchemaEXPSearchSessionExperiments activeExperiments](self, "activeExperiments");
...
- (unint64_t)hash
{
  ...
  v3 = -[SISchemaUUID hash](self->_searchSessionId, "hash");
  return -[NSArray hash](self->_activeExperiments, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_activeExperiments, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("activeExperiments"));
  }
  if (self->_searchSessionId)
  {
    ...
    if (v13)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v13, CFSTR("searchSessionId"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("searchSessionId"));
...
- (NSData)jsonData
{
  ...
  -[EXPSearchSchemaEXPSearchSessionExperiments dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  EXPSearchSchemaEXPSearchSessionExperiments *v5;
  uint64_t v7;
  ...
  {
    self = -[EXPSearchSchemaEXPSearchSessionExperiments initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (EXPSearchSchemaEXPSearchSessionExperiments)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  EXPSchemaEXPTrialExperiment *v15;
  EXPSearchSchemaEXPSearchSessionExperiments *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[EXPSearchSchemaEXPSearchSessionExperiments init](&v23, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("searchSessionId"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v7 = -[SISchemaUUID initWithDictionary:]([SISchemaUUID alloc], "initWithDictionary:", v6);
      -[EXPSearchSchemaEXPSearchSessionExperiments setSearchSessionId:](v5, "setSearchSessionId:", v7);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("activeExperiments"));
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[EXPSchemaEXPTrialExperiment initWithDictionary:]([EXPSchemaEXPTrialExperiment alloc], "initWithDictionary:", v14);
              -[EXPSearchSchemaEXPSearchSessionExperiments addActiveExperiments:](v5, "addActiveExperiments:", v15);
