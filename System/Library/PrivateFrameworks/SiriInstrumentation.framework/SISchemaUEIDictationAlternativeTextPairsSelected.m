...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 2))
    -[SISchemaUEIDictationAlternativeTextPairsSelected deleteAlternativeSelections](self, "deleteAlternativeSelections");
  ...
  if (objc_msgSend(v4, "isConditionSet:", 7))
    -[SISchemaUEIDictationAlternativeTextPairsSelected deleteAlternativeSelections](self, "deleteAlternativeSelections");
  -[SISchemaUEIDictationAlternativeTextPairsSelected alternativeSelections](self, "alternativeSelections");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaUEIDictationAlternativeTextPairsSelected setAlternativeSelections:](self, "setAlternativeSelections:", v7);
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_alternativeSelections, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[SISchemaUEIDictationAlternativeTextPairsSelected dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SISchemaUEIDictationAlternativeTextPairsSelected *v5;
  uint64_t v7;
  ...
  {
    self = -[SISchemaUEIDictationAlternativeTextPairsSelected initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SISchemaUEIDictationAlternativeTextPairsSelected)initWithDictionary:(id)a3
{
  ...
  SISchemaUEIDictationAlternativeTextPairsSelected *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[SISchemaUEIDictationAlternativeTextPairsSelected init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[ASRSchemaASRConfusionPairToken initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[SISchemaUEIDictationAlternativeTextPairsSelected addAlternativeSelections:](v5, "addAlternativeSelections:", v14);
