...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[SCSchemaSCCheckCorrectionResponse results](self, "results", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[SCSchemaSCCheckCorrectionResponse setResults:](self, "setResults:", v7);
  return v5;
}
...
{
  -[SCSchemaSCCheckCorrectionResponse setCandidateCount:](self, "setCandidateCount:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[SCSchemaSCCheckCorrectionResponse results](self, "results");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_12:
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    if (candidateCount != objc_msgSend(v4, "candidateCount"))
      goto LABEL_12;
  }
  v14 = 1;
LABEL_13:
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[SCSchemaSCCheckCorrectionResponse candidateCount](self, "candidateCount"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("candidateCount"));
...
- (NSData)jsonData
{
  ...
  -[SCSchemaSCCheckCorrectionResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SCSchemaSCCheckCorrectionResponse *v5;
  uint64_t v7;
  ...
  {
    self = -[SCSchemaSCCheckCorrectionResponse initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SCSchemaSCCheckCorrectionResponse)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  SCSchemaSCCheckCorrectionResult *v13;
  SCSchemaSCCheckCorrectionResult *v14;
  void *v15;
  SCSchemaSCCheckCorrectionResponse *v16;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[SCSchemaSCCheckCorrectionResponse init](&v22, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[SCSchemaSCCheckCorrectionResult initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v18);
              -[SCSchemaSCCheckCorrectionResponse addResults:](v5, "addResults:", v14);
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("candidateCount"), (_QWORD)v18);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SCSchemaSCCheckCorrectionResponse setCandidateCount:](v5, "setCandidateCount:", objc_msgSend(v15, "unsignedIntValue"));
    v16 = v5;
