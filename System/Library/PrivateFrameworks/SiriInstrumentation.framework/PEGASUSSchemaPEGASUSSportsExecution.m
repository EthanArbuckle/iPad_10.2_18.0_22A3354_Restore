...
{
  -[PEGASUSSchemaPEGASUSSportsExecution setSportsUsecase:](self, "setSportsUsecase:", 0);
  *(&self->_isLiveScoreRequest + 1) &= ~1u;
}
...
{
  -[PEGASUSSchemaPEGASUSSportsExecution setIsSportsWatchFaceRequest:](self, "setIsSportsWatchFaceRequest:", 0);
  *(&self->_isLiveScoreRequest + 1) &= ~2u;
}
...
{
  -[PEGASUSSchemaPEGASUSSportsExecution setIsSnippetNextCardRequest:](self, "setIsSnippetNextCardRequest:", 0);
  *(&self->_isLiveScoreRequest + 1) &= ~4u;
}
...
{
  -[PEGASUSSchemaPEGASUSSportsExecution setIsMachineUtterance:](self, "setIsMachineUtterance:", 0);
  *(&self->_isLiveScoreRequest + 1) &= ~8u;
}
...
{
  -[PEGASUSSchemaPEGASUSSportsExecution setIsDisambiguation:](self, "setIsDisambiguation:", 0);
  *(&self->_isLiveScoreRequest + 1) &= ~0x10u;
}
...
{
  -[PEGASUSSchemaPEGASUSSportsExecution setIsLiveScoreRequest:](self, "setIsLiveScoreRequest:", 0);
  *(&self->_isLiveScoreRequest + 1) &= ~0x20u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 0x10) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isDisambiguation](self, "isDisambiguation"));
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isLiveScoreRequest](self, "isLiveScoreRequest"));
...
LABEL_10:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isMachineUtterance](self, "isMachineUtterance"));
...
LABEL_5:
    if ((v4 & 2) == 0)
      goto LABEL_6;
LABEL_12:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isSportsWatchFaceRequest](self, "isSportsWatchFaceRequest"));
...
LABEL_11:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isSnippetNextCardRequest](self, "isSnippetNextCardRequest"));
...
LABEL_6:
  if ((v4 & 1) == 0)
    goto LABEL_17;
LABEL_13:
  v10 = -[PEGASUSSchemaPEGASUSSportsExecution sportsUsecase](self, "sportsUsecase") - 1;
  if (v10 > 0x1E)
    v11 = CFSTR("PEGASUSSPORTSUSECASE_UNKNOWN");
  else
    v11 = off_1E563B1E0[v10];
...
- (NSData)jsonData
{
  ...
  -[PEGASUSSchemaPEGASUSSportsExecution dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PEGASUSSchemaPEGASUSSportsExecution *v5;
  uint64_t v7;
  ...
  {
    self = -[PEGASUSSchemaPEGASUSSportsExecution initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PEGASUSSchemaPEGASUSSportsExecution)initWithDictionary:(id)a3
{
  ...
  void *v10;
  void *v11;
  PEGASUSSchemaPEGASUSSportsExecution *v12;
  objc_super v14;

  v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)PEGASUSSchemaPEGASUSSportsExecution;
  v5 = -[PEGASUSSchemaPEGASUSSportsExecution init](&v14, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSSportsExecution setSportsUsecase:](v5, "setSportsUsecase:", objc_msgSend(v6, "intValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isSportsWatchFaceRequest"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSSportsExecution setIsSportsWatchFaceRequest:](v5, "setIsSportsWatchFaceRequest:", objc_msgSend(v7, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isSnippetNextCardRequest"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSSportsExecution setIsSnippetNextCardRequest:](v5, "setIsSnippetNextCardRequest:", objc_msgSend(v8, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isMachineUtterance"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSSportsExecution setIsMachineUtterance:](v5, "setIsMachineUtterance:", objc_msgSend(v9, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isDisambiguation"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSSportsExecution setIsDisambiguation:](v5, "setIsDisambiguation:", objc_msgSend(v10, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isLiveScoreRequest"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSSportsExecution setIsLiveScoreRequest:](v5, "setIsLiveScoreRequest:", objc_msgSend(v11, "BOOLValue"));
    v12 = v5;
