...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 2))
    -[FLOWSchemaFLOWEntityTier1 deleteEntityId](self, "deleteEntityId");
...
- (void)deleteEntityId
{
  -[FLOWSchemaFLOWEntityTier1 setEntityId:](self, "setEntityId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[FLOWSchemaFLOWEntityTier1 entityId](self, "entityId");
...
- (unint64_t)hash
{
  return -[NSString hash](self->_entityId, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[FLOWSchemaFLOWEntityTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (FLOWSchemaFLOWEntityTier1)initWithJSON:(id)a3
{
  ...
  {
    self = -[FLOWSchemaFLOWEntityTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (FLOWSchemaFLOWEntityTier1)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  FLOWSchemaFLOWEntityTier1 *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)FLOWSchemaFLOWEntityTier1;
  v5 = -[FLOWSchemaFLOWEntityTier1 init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[FLOWSchemaFLOWEntityTier1 setEntityId:](v5, "setEntityId:", v7);
