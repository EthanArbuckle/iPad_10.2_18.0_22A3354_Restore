...
- (void)deleteDomain
{
  -[LTSchemaError setDomain:](self, "setDomain:", 0);
}
...
- (void)deleteCode
{
  -[LTSchemaError setCode:](self, "setCode:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[LTSchemaError domain](self, "domain");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[LTSchemaError code](self, "code"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[LTSchemaError dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (LTSchemaError)initWithJSON:(id)a3
{
  ...
  {
    self = -[LTSchemaError initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (LTSchemaError)initWithDictionary:(id)a3
{
  ...
  v5 = -[LTSchemaError init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[LTSchemaError setDomain:](v5, "setDomain:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[LTSchemaError setCode:](v5, "setCode:", objc_msgSend(v8, "unsignedIntValue"));
    v9 = v5;
