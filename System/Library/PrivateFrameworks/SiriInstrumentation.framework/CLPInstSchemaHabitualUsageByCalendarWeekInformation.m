...
{
  -[CLPInstSchemaHabitualUsageByCalendarWeekInformation setCalendarWeekNumber:](self, "setCalendarWeekNumber:", 0);
  *(&self->_wasHabitualUserDuringCalendarWeek + 1) &= ~1u;
}
...
{
  -[CLPInstSchemaHabitualUsageByCalendarWeekInformation setWasHabitualUserDuringCalendarWeek:](self, "setWasHabitualUserDuringCalendarWeek:", 0);
  *(&self->_wasHabitualUserDuringCalendarWeek + 1) &= ~2u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_10;
  v5 = *((unsigned __int8 *)&self->_wasHabitualUserDuringCalendarWeek + 1);
  v6 = v4[13];
  if ((v5 & 1) != (v6 & 1))
    goto LABEL_10;
  if ((v5 & 1) != 0)
  {
    ...
    if (calendarWeekNumber != objc_msgSend(v4, "calendarWeekNumber"))
    {
LABEL_10:
      v10 = 0;
      goto LABEL_11;
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[CLPInstSchemaHabitualUsageByCalendarWeekInformation calendarWeekNumber](self, "calendarWeekNumber"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("calendarWeekNumber"));

    v4 = *(&self->_wasHabitualUserDuringCalendarWeek + 1);
  }
  if ((v4 & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[CLPInstSchemaHabitualUsageByCalendarWeekInformation wasHabitualUserDuringCalendarWeek](self, "wasHabitualUserDuringCalendarWeek"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("wasHabitualUserDuringCalendarWeek"));
...
- (NSData)jsonData
{
  ...
  -[CLPInstSchemaHabitualUsageByCalendarWeekInformation dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  CLPInstSchemaHabitualUsageByCalendarWeekInformation *v5;
  uint64_t v7;
  ...
  {
    self = -[CLPInstSchemaHabitualUsageByCalendarWeekInformation initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (CLPInstSchemaHabitualUsageByCalendarWeekInformation)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  CLPInstSchemaHabitualUsageByCalendarWeekInformation *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)CLPInstSchemaHabitualUsageByCalendarWeekInformation;
  v5 = -[CLPInstSchemaHabitualUsageByCalendarWeekInformation init](&v10, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("calendarWeekNumber"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[CLPInstSchemaHabitualUsageByCalendarWeekInformation setCalendarWeekNumber:](v5, "setCalendarWeekNumber:", objc_msgSend(v6, "unsignedIntValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("wasHabitualUserDuringCalendarWeek"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[CLPInstSchemaHabitualUsageByCalendarWeekInformation setWasHabitualUserDuringCalendarWeek:](v5, "setWasHabitualUserDuringCalendarWeek:", objc_msgSend(v7, "BOOLValue"));
    v8 = v5;
