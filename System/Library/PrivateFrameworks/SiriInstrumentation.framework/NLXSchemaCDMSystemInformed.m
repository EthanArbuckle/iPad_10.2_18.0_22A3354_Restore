...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[NLXSchemaCDMSystemInformed taskId](self, "taskId");
  ...
  if (v8)
    -[NLXSchemaCDMSystemInformed deleteTaskId](self, "deleteTaskId");
  -[NLXSchemaCDMSystemInformed entities](self, "entities");
  ...
  -[NLXSchemaCDMSystemInformed setEntities:](self, "setEntities:", v10);
...
- (void)deleteTaskId
{
  -[NLXSchemaCDMSystemInformed setTaskId:](self, "setTaskId:", 0);
}
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_entities, "hash") ^ v3;
}
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaCDMSystemInformed dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (NLXSchemaCDMSystemInformed)initWithJSON:(id)a3
{
  ...
  {
    self = -[NLXSchemaCDMSystemInformed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaCDMSystemInformed)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  USOSchemaUSOGraph *v15;
  NLXSchemaCDMSystemInformed *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[NLXSchemaCDMSystemInformed init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[NLXSchemaCDMSystemInformed setTaskId:](v5, "setTaskId:", v7);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("entities"));
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[USOSchemaUSOGraph initWithDictionary:]([USOSchemaUSOGraph alloc], "initWithDictionary:", v14);
              -[NLXSchemaCDMSystemInformed addEntities:](v5, "addEntities:", v15);
