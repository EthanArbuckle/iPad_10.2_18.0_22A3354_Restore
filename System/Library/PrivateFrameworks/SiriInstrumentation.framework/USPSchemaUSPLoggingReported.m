...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[USPSchemaUSPLoggingReported metrics](self, "metrics", v11.receiver, v11.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[USPSchemaUSPLoggingReported setMetrics:](self, "setMetrics:", v7);

  -[USPSchemaUSPLoggingReported sessionInfoItems](self, "sessionInfoItems");
  ...
  -[USPSchemaUSPLoggingReported setSessionInfoItems:](self, "setSessionInfoItems:", v9);
  return v5;
}

- (void)clearMetrics
{
  -[NSArray removeAllObjects](self->_metrics, "removeAllObjects");
}
...
- (void)addMetrics:(id)a3
{
  ...
  -[NSArray addObject:](metrics, "addObject:", v4);

}

- (unint64_t)metricsCount
{
  return -[NSArray count](self->_metrics, "count");
}

- (id)metricsAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_metrics, "objectAtIndexedSubscript:", a3);
}

- (void)clearSessionInfoItems
{
  -[NSArray removeAllObjects](self->_sessionInfoItems, "removeAllObjects");
}
...
- (void)addSessionInfoItems:(id)a3
{
  ...
  -[NSArray addObject:](sessionInfoItems, "addObject:", v4);

}

- (unint64_t)sessionInfoItemsCount
{
  return -[NSArray count](self->_sessionInfoItems, "count");
}

- (id)sessionInfoItemsAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_sessionInfoItems, "objectAtIndexedSubscript:", a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[USPSchemaUSPLoggingReported metrics](self, "metrics");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[USPSchemaUSPLoggingReported sessionInfoItems](self, "sessionInfoItems");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "sessionInfoItems");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) != (v6 != 0))
  {
    -[USPSchemaUSPLoggingReported sessionInfoItems](self, "sessionInfoItems");
...
- (unint64_t)hash
{
  ...
  v3 = -[NSArray hash](self->_metrics, "hash");
  return -[NSArray hash](self->_sessionInfoItems, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_metrics, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("metrics"));
  }
  if (-[NSArray count](self->_sessionInfoItems, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("sessionInfoItems"));
  }
...
- (NSData)jsonData
{
  ...
  -[USPSchemaUSPLoggingReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  USPSchemaUSPLoggingReported *v5;
  uint64_t v7;
  ...
  {
    self = -[USPSchemaUSPLoggingReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (USPSchemaUSPLoggingReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v19;
  uint64_t v20;
  USPSchemaUSPSessionInfoItem *v21;
  USPSchemaUSPLoggingReported *v22;
  void *v24;
  __int128 v25;
  __int128 v26;
  __int128 v27;
  ...
  v5 = -[USPSchemaUSPLoggingReported init](&v33, sel_init);
  if (v5)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v13 = -[USPSchemaUSPMetric initWithDictionary:]([USPSchemaUSPMetric alloc], "initWithDictionary:", v12);
              -[USPSchemaUSPLoggingReported addMetrics:](v5, "addMetrics:", v13);
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("sessionInfoItems"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v16)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v21 = -[USPSchemaUSPSessionInfoItem initWithDictionary:]([USPSchemaUSPSessionInfoItem alloc], "initWithDictionary:", v20);
              -[USPSchemaUSPLoggingReported addSessionInfoItems:](v5, "addSessionInfoItems:", v21);
