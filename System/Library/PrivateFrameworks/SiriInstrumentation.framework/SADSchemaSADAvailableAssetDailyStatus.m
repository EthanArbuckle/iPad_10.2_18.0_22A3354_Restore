...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[SADSchemaSADAvailableAssetDailyStatus namespaceStatus](self, "namespaceStatus", v11.receiver, v11.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SADSchemaSADAvailableAssetDailyStatus setNamespaceStatus:](self, "setNamespaceStatus:", v7);

  -[SADSchemaSADAvailableAssetDailyStatus assetSetStatus](self, "assetSetStatus");
  ...
  -[SADSchemaSADAvailableAssetDailyStatus setAssetSetStatus:](self, "setAssetSetStatus:", v9);
  return v5;
}

- (void)clearNamespaceStatus
{
  -[NSArray removeAllObjects](self->_namespaceStatus, "removeAllObjects");
}
...
- (void)addNamespaceStatus:(id)a3
{
  ...
  -[NSArray addObject:](namespaceStatus, "addObject:", v4);

}

- (unint64_t)namespaceStatusCount
{
  return -[NSArray count](self->_namespaceStatus, "count");
}

- (id)namespaceStatusAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_namespaceStatus, "objectAtIndexedSubscript:", a3);
}

- (void)clearAssetSetStatus
{
  -[NSArray removeAllObjects](self->_assetSetStatus, "removeAllObjects");
}
...
- (void)addAssetSetStatus:(id)a3
{
  ...
  -[NSArray addObject:](assetSetStatus, "addObject:", v4);

}

- (unint64_t)assetSetStatusCount
{
  return -[NSArray count](self->_assetSetStatus, "count");
}

- (id)assetSetStatusAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_assetSetStatus, "objectAtIndexedSubscript:", a3);
}
...
{
  -[SADSchemaSADAvailableAssetDailyStatus setStatusReason:](self, "setStatusReason:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[SADSchemaSADAvailableAssetDailyStatus namespaceStatus](self, "namespaceStatus");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "namespaceStatus");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) == (v6 != 0))
    goto LABEL_11;
  -[SADSchemaSADAvailableAssetDailyStatus namespaceStatus](self, "namespaceStatus");
...
- (unint64_t)hash
{
  ...
  v3 = -[NSArray hash](self->_namespaceStatus, "hash");
  v4 = -[NSArray hash](self->_assetSetStatus, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_assetSetStatus, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("assetSetStatus"));
  }
  if (-[NSArray count](self->_namespaceStatus, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("namespaceStatus"));
  }
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v20 = -[SADSchemaSADAvailableAssetDailyStatus statusReason](self, "statusReason") - 1;
    if (v20 > 3)
      v21 = CFSTR("SADAVAILABLEASSETSTATUSREASON_UNKNOWN");
    else
      v21 = off_1E5633920[v20];
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v21, CFSTR("statusReason"), (_QWORD)v23);
  }
...
- (NSData)jsonData
{
  ...
  -[SADSchemaSADAvailableAssetDailyStatus dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SADSchemaSADAvailableAssetDailyStatus *v5;
  uint64_t v7;
  ...
  {
    self = -[SADSchemaSADAvailableAssetDailyStatus initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SADSchemaSADAvailableAssetDailyStatus)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  SADSchemaSADTrialNamespaceStatus *v13;
  void *v14;
  id v15;
  uint64_t v16;
  uint64_t v17;
  ...
  uint64_t v19;
  uint64_t v20;
  UAFSchemaUAFAssetSetStatus *v21;
  void *v22;
  SADSchemaSADAvailableAssetDailyStatus *v23;
  void *v25;
  __int128 v26;
  __int128 v27;
  __int128 v28;
  ...
  v5 = -[SADSchemaSADAvailableAssetDailyStatus init](&v34, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("namespaceStatus"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v13 = -[SADSchemaSADTrialNamespaceStatus initWithDictionary:]([SADSchemaSADTrialNamespaceStatus alloc], "initWithDictionary:", v12);
              -[SADSchemaSADAvailableAssetDailyStatus addNamespaceStatus:](v5, "addNamespaceStatus:", v13);
      ...
      if (v16)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v21 = -[UAFSchemaUAFAssetSetStatus initWithDictionary:]([UAFSchemaUAFAssetSetStatus alloc], "initWithDictionary:", v20);
              -[SADSchemaSADAvailableAssetDailyStatus addAssetSetStatus:](v5, "addAssetSetStatus:", v21);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SADSchemaSADAvailableAssetDailyStatus setStatusReason:](v5, "setStatusReason:", objc_msgSend(v22, "intValue"));
    v23 = v5;
