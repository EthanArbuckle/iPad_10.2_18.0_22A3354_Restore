...
- (void)deleteExists
{
  -[SISchemaUEIUIRenderingStarted setExists:](self, "setExists:", 0);
  *(&self->_exists + 1) &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[SISchemaUEIUIRenderingStarted exists](self, "exists"));
...
- (NSData)jsonData
{
  ...
  -[SISchemaUEIUIRenderingStarted dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SISchemaUEIUIRenderingStarted *v5;
  uint64_t v7;
  ...
  {
    self = -[SISchemaUEIUIRenderingStarted initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SISchemaUEIUIRenderingStarted)initWithDictionary:(id)a3
{
  ...
  v5 = -[SISchemaUEIUIRenderingStarted init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SISchemaUEIUIRenderingStarted setExists:](v5, "setExists:", objc_msgSend(v6, "BOOLValue"));
    v7 = v5;
