...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[SISchemaMultiUserState enrolledUsers](self, "enrolledUsers", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[SISchemaMultiUserState setEnrolledUsers:](self, "setEnrolledUsers:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[SISchemaMultiUserState enrolledUsers](self, "enrolledUsers");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_enrolledUsers, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[SISchemaMultiUserState dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (SISchemaMultiUserState)initWithJSON:(id)a3
{
  ...
  {
    self = -[SISchemaMultiUserState initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SISchemaMultiUserState)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  SISchemaEnrolledUserState *v13;
  SISchemaEnrolledUserState *v14;
  SISchemaMultiUserState *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[SISchemaMultiUserState init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[SISchemaEnrolledUserState initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[SISchemaMultiUserState addEnrolledUsers:](v5, "addEnrolledUsers:", v14);
