...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[JRSchemaRankingMatrix tuples](self, "tuples", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[JRSchemaRankingMatrix setTuples:](self, "setTuples:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[JRSchemaRankingMatrix tuples](self, "tuples");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[JRSchemaRankingMatrix dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (JRSchemaRankingMatrix)initWithJSON:(id)a3
{
  ...
  {
    self = -[JRSchemaRankingMatrix initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (JRSchemaRankingMatrix)initWithDictionary:(id)a3
{
  ...
  JRSchemaRankingTuple *v14;
  JRSchemaRankingMatrix *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[JRSchemaRankingMatrix init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[JRSchemaRankingTuple initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[JRSchemaRankingMatrix addTuples:](v5, "addTuples:", v14);
