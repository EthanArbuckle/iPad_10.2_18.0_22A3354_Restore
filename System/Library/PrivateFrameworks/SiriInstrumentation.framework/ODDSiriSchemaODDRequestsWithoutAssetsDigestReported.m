...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported fixedDimensions](self, "fixedDimensions");
  ...
  if (v8)
    -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported deleteFixedDimensions](self, "deleteFixedDimensions");
  -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported digests](self, "digests");
  ...
  -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported setDigests:](self, "setDigests:", v10);
...
{
  -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported setFixedDimensions:](self, "setFixedDimensions:", 0);
}
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDRequestsWithoutAssetsDigestReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDRequestsWithoutAssetsDigestReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ODDSiriSchemaODDRequestsWithoutAssetsDigest *v15;
  ODDSiriSchemaODDRequestsWithoutAssetsDigestReported *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported setFixedDimensions:](v5, "setFixedDimensions:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ODDSiriSchemaODDRequestsWithoutAssetsDigest initWithDictionary:]([ODDSiriSchemaODDRequestsWithoutAssetsDigest alloc], "initWithDictionary:", v14);
              -[ODDSiriSchemaODDRequestsWithoutAssetsDigestReported addDigests:](v5, "addDigests:", v15);
