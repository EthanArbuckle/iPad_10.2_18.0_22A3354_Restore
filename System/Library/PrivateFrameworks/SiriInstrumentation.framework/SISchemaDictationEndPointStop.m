...
{
  -[SISchemaDictationEndPointStop setDictationEndPointType:](self, "setDictationEndPointType:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[SISchemaDictationEndPointStop dictationEndPointType](self, "dictationEndPointType") - 1;
    if (v4 > 0x16)
...
- (NSData)jsonData
{
  ...
  -[SISchemaDictationEndPointStop dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SISchemaDictationEndPointStop *v5;
  uint64_t v7;
  ...
  {
    self = -[SISchemaDictationEndPointStop initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SISchemaDictationEndPointStop)initWithDictionary:(id)a3
{
  ...
  SISchemaDictationEndPointStop *v5;
  void *v6;
  SISchemaDictationEndPointStop *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SISchemaDictationEndPointStop;
  v5 = -[SISchemaDictationEndPointStop init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[SISchemaDictationEndPointStop setDictationEndPointType:](v5, "setDictationEndPointType:", objc_msgSend(v6, "intValue"));
    v7 = v5;
