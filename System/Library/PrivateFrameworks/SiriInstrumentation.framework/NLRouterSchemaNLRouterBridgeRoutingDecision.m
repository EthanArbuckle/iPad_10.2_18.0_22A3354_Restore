...
{
  -[NLRouterSchemaNLRouterBridgeRoutingDecision setRoutingDecisionSource:](self, "setRoutingDecisionSource:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[NLRouterSchemaNLRouterBridgeRoutingDecision setRouterDecisionType:](self, "setRouterDecisionType:", 0);
  *(_BYTE *)&self->_has &= ~2u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = -[NLRouterSchemaNLRouterBridgeRoutingDecision routerDecisionType](self, "routerDecisionType") - 1;
    if (v5 > 4)
  ...
  if ((has & 1) != 0)
  {
    v7 = -[NLRouterSchemaNLRouterBridgeRoutingDecision routingDecisionSource](self, "routingDecisionSource") - 1;
    if (v7 > 2)
      v8 = CFSTR("NLROUTERBRIDGEROUTINGDECISIONSOURCE_UNKNOWN");
    else
      v8 = off_1E563C7F8[v7];
...
- (NSData)jsonData
{
  ...
  -[NLRouterSchemaNLRouterBridgeRoutingDecision dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  NLRouterSchemaNLRouterBridgeRoutingDecision *v5;
  uint64_t v7;
  ...
  {
    self = -[NLRouterSchemaNLRouterBridgeRoutingDecision initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLRouterSchemaNLRouterBridgeRoutingDecision)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  NLRouterSchemaNLRouterBridgeRoutingDecision *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)NLRouterSchemaNLRouterBridgeRoutingDecision;
  v5 = -[NLRouterSchemaNLRouterBridgeRoutingDecision init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[NLRouterSchemaNLRouterBridgeRoutingDecision setRoutingDecisionSource:](v5, "setRoutingDecisionSource:", objc_msgSend(v6, "intValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("routerDecisionType"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[NLRouterSchemaNLRouterBridgeRoutingDecision setRouterDecisionType:](v5, "setRouterDecisionType:", objc_msgSend(v7, "intValue"));
    v8 = v5;
