...
- (void)deleteState
{
  -[CDASchemaCDAElectionAdvertisingStartEnded setState:](self, "setState:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[CDASchemaCDAElectionAdvertisingStartEnded state](self, "state") - 1;
    if (v4 > 0x11)
...
- (NSData)jsonData
{
  ...
  -[CDASchemaCDAElectionAdvertisingStartEnded dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  CDASchemaCDAElectionAdvertisingStartEnded *v5;
  uint64_t v7;
  ...
  {
    self = -[CDASchemaCDAElectionAdvertisingStartEnded initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (CDASchemaCDAElectionAdvertisingStartEnded)initWithDictionary:(id)a3
{
  ...
  CDASchemaCDAElectionAdvertisingStartEnded *v5;
  void *v6;
  CDASchemaCDAElectionAdvertisingStartEnded *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CDASchemaCDAElectionAdvertisingStartEnded;
  v5 = -[CDASchemaCDAElectionAdvertisingStartEnded init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[CDASchemaCDAElectionAdvertisingStartEnded setState:](v5, "setState:", objc_msgSend(v6, "intValue"));
    v7 = v5;
