...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 8))
    -[ODDSiriSchemaODDAssistantDigest deleteTurnIds](self, "deleteTurnIds");
  -[ODDSiriSchemaODDAssistantDigest dimensions](self, "dimensions");
  ...
  if (v8)
    -[ODDSiriSchemaODDAssistantDigest deleteDimensions](self, "deleteDimensions");
  -[ODDSiriSchemaODDAssistantDigest counts](self, "counts");
  ...
  if (v11)
    -[ODDSiriSchemaODDAssistantDigest deleteCounts](self, "deleteCounts");
  -[ODDSiriSchemaODDAssistantDigest turnIds](self, "turnIds");
  ...
  -[ODDSiriSchemaODDAssistantDigest setTurnIds:](self, "setTurnIds:", v13);
...
{
  -[ODDSiriSchemaODDAssistantDigest setDimensions:](self, "setDimensions:", 0);
}
...
- (void)deleteCounts
{
  -[ODDSiriSchemaODDAssistantDigest setCounts:](self, "setCounts:", 0);
}
...
- (unint64_t)hash
{
  ...
  v3 = -[ODDSiriSchemaODDAssistantDimensions hash](self->_dimensions, "hash");
  v4 = -[ODDSiriSchemaODDAssistantCounts hash](self->_counts, "hash") ^ v3;
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDAssistantDigest dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDAssistantDigest *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDAssistantDigest initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDAssistantDigest)initWithDictionary:(id)a3
{
  ...
  void *v8;
  ODDSiriSchemaODDAssistantCounts *v9;
  void *v10;
  id v11;
  uint64_t v12;
  uint64_t v13;
  ...
  uint64_t v16;
  SISchemaUUID *v17;
  ODDSiriSchemaODDAssistantDigest *v18;
  void *v20;
  __int128 v21;
  __int128 v22;
  __int128 v23;
  ...
  v5 = -[ODDSiriSchemaODDAssistantDigest init](&v25, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDAssistantDigest setDimensions:](v5, "setDimensions:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v9 = -[ODDSiriSchemaODDAssistantCounts initWithDictionary:]([ODDSiriSchemaODDAssistantCounts alloc], "initWithDictionary:", v8);
      -[ODDSiriSchemaODDAssistantDigest setCounts:](v5, "setCounts:", v9);
        ...
        do
        {
          for (i = 0; i != v13; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[ODDSiriSchemaODDAssistantDigest addTurnIds:](v5, "addTurnIds:", v17);
