...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[IFPlatformSchemaIFPlatformTargetFailed criticalError](self, "criticalError", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[IFPlatformSchemaIFPlatformTargetFailed deleteCriticalError](self, "deleteCriticalError");
  return v5;
}
...
{
  -[IFPlatformSchemaIFPlatformTargetFailed setCriticalError:](self, "setCriticalError:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[IFPlatformSchemaIFPlatformTargetFailed criticalError](self, "criticalError");
...
- (NSData)jsonData
{
  ...
  -[IFPlatformSchemaIFPlatformTargetFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  IFPlatformSchemaIFPlatformTargetFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[IFPlatformSchemaIFPlatformTargetFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFPlatformSchemaIFPlatformTargetFailed)initWithDictionary:(id)a3
{
  ...
  IFPlatformSchemaIFPlatformTargetFailed *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFPlatformSchemaIFPlatformTargetFailed;
  v5 = -[IFPlatformSchemaIFPlatformTargetFailed init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[IFPlatformSchemaIFPlatformTargetFailed setCriticalError:](v5, "setCriticalError:", v7);
