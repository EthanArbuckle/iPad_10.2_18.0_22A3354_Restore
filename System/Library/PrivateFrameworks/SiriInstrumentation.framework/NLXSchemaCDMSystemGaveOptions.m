...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[NLXSchemaCDMSystemGaveOptions choices](self, "choices", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[NLXSchemaCDMSystemGaveOptions setChoices:](self, "setChoices:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[NLXSchemaCDMSystemGaveOptions choices](self, "choices");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_choices, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaCDMSystemGaveOptions dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  NLXSchemaCDMSystemGaveOptions *v5;
  uint64_t v7;
  ...
  {
    self = -[NLXSchemaCDMSystemGaveOptions initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaCDMSystemGaveOptions)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  NLXSchemaCDMUserDialogAct *v13;
  NLXSchemaCDMUserDialogAct *v14;
  ...
  v5 = -[NLXSchemaCDMSystemGaveOptions init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[NLXSchemaCDMUserDialogAct initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[NLXSchemaCDMSystemGaveOptions addChoices:](v5, "addChoices:", v14);
