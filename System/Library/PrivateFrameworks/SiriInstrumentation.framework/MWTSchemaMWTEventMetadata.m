...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[MWTSchemaMWTEventMetadata mwtId](self, "mwtId");
  ...
  if (v8)
    -[MWTSchemaMWTEventMetadata deleteMwtId](self, "deleteMwtId");
  -[MWTSchemaMWTEventMetadata requestId](self, "requestId");
  ...
  if (v11)
    -[MWTSchemaMWTEventMetadata deleteRequestId](self, "deleteRequestId");
  -[MWTSchemaMWTEventMetadata subRequestId](self, "subRequestId");
  ...
  if (v14)
    -[MWTSchemaMWTEventMetadata deleteSubRequestId](self, "deleteSubRequestId");
...
- (void)deleteMwtId
{
  -[MWTSchemaMWTEventMetadata setMwtId:](self, "setMwtId:", 0);
}
...
{
  -[MWTSchemaMWTEventMetadata setRequestId:](self, "setRequestId:", 0);
}
...
{
  -[MWTSchemaMWTEventMetadata setSubRequestId:](self, "setSubRequestId:", 0);
}
...
- (unint64_t)hash
{
  ...
  v3 = -[SISchemaUUID hash](self->_mwtId, "hash");
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_mwtId)
  {
    ...
    if (v5)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("mwtId"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("mwtId"));
...
- (NSData)jsonData
{
  ...
  -[MWTSchemaMWTEventMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (MWTSchemaMWTEventMetadata)initWithJSON:(id)a3
{
  ...
  {
    self = -[MWTSchemaMWTEventMetadata initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MWTSchemaMWTEventMetadata)initWithDictionary:(id)a3
{
  ...
  void *v10;
  SISchemaUUID *v11;
  MWTSchemaMWTEventMetadata *v12;
  objc_super v14;

  v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)MWTSchemaMWTEventMetadata;
  v5 = -[MWTSchemaMWTEventMetadata init](&v14, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("mwtId"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v7 = -[SISchemaUUID initWithDictionary:]([SISchemaUUID alloc], "initWithDictionary:", v6);
      -[MWTSchemaMWTEventMetadata setMwtId:](v5, "setMwtId:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MWTSchemaMWTEventMetadata setRequestId:](v5, "setRequestId:", v9);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MWTSchemaMWTEventMetadata setSubRequestId:](v5, "setSubRequestId:", v11);
...
- (void)setMwtId:(id)a3
{
  objc_storeStrong((id *)&self->_mwtId, a3);
}
