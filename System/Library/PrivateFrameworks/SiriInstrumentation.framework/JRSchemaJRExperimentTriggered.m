...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[JRSchemaJRExperimentTriggered allocations](self, "allocations", v11.receiver, v11.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[JRSchemaJRExperimentTriggered setAllocations:](self, "setAllocations:", v7);

  -[JRSchemaJRExperimentTriggered codepathId](self, "codepathId");
  ...
  if ((_DWORD)v4)
    -[JRSchemaJRExperimentTriggered deleteCodepathId](self, "deleteCodepathId");
  return v5;
}
...
{
  -[JRSchemaJRExperimentTriggered setCodepathId:](self, "setCodepathId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[JRSchemaJRExperimentTriggered codepathId](self, "codepathId", v12);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[JRSchemaJRExperimentTriggered allocations](self, "allocations");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[JRSchemaJRExperimentTriggered dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  JRSchemaJRExperimentTriggered *v5;
  uint64_t v7;
  ...
  {
    self = -[JRSchemaJRExperimentTriggered initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (JRSchemaJRExperimentTriggered)initWithDictionary:(id)a3
{
  ...
  void *v15;
  SISchemaUUID *v16;
  JRSchemaJRExperimentTriggered *v17;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  __int128 v22;
  ...
  v5 = -[JRSchemaJRExperimentTriggered init](&v23, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[JRSchemaJRExperimentTriggered addAllocation:](v5, "addAllocation:", v14);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[JRSchemaJRExperimentTriggered setCodepathId:](v5, "setCodepathId:", v16);
