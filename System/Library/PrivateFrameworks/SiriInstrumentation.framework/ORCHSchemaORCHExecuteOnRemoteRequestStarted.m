...
{
  -[ORCHSchemaORCHExecuteOnRemoteRequestStarted setAceCommandName:](self, "setAceCommandName:", 0);
}
...
{
  -[ORCHSchemaORCHExecuteOnRemoteRequestStarted setAceCommandType:](self, "setAceCommandType:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[ORCHSchemaORCHExecuteOnRemoteRequestStarted aceCommandName](self, "aceCommandName");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v6 = -[ORCHSchemaORCHExecuteOnRemoteRequestStarted aceCommandType](self, "aceCommandType") - 1;
    if (v6 > 4)
...
- (NSData)jsonData
{
  ...
  -[ORCHSchemaORCHExecuteOnRemoteRequestStarted dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ORCHSchemaORCHExecuteOnRemoteRequestStarted *v5;
  uint64_t v7;
  ...
  {
    self = -[ORCHSchemaORCHExecuteOnRemoteRequestStarted initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ORCHSchemaORCHExecuteOnRemoteRequestStarted)initWithDictionary:(id)a3
{
  ...
  v5 = -[ORCHSchemaORCHExecuteOnRemoteRequestStarted init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ORCHSchemaORCHExecuteOnRemoteRequestStarted setAceCommandName:](v5, "setAceCommandName:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ORCHSchemaORCHExecuteOnRemoteRequestStarted setAceCommandType:](v5, "setAceCommandType:", objc_msgSend(v8, "intValue"));
    v9 = v5;
