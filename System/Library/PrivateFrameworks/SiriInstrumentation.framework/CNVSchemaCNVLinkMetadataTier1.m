...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 4))
    -[CNVSchemaCNVLinkMetadataTier1 deleteAppBundleId](self, "deleteAppBundleId");
  -[CNVSchemaCNVLinkMetadataTier1 linkId](self, "linkId");
  ...
  if (v8)
    -[CNVSchemaCNVLinkMetadataTier1 deleteLinkId](self, "deleteLinkId");
...
- (void)deleteLinkId
{
  -[CNVSchemaCNVLinkMetadataTier1 setLinkId:](self, "setLinkId:", 0);
}
...
{
  -[CNVSchemaCNVLinkMetadataTier1 setAppBundleId:](self, "setAppBundleId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[CNVSchemaCNVLinkMetadataTier1 appBundleId](self, "appBundleId");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[CNVSchemaCNVLinkMetadataTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  CNVSchemaCNVLinkMetadataTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[CNVSchemaCNVLinkMetadataTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (CNVSchemaCNVLinkMetadataTier1)initWithDictionary:(id)a3
{
  ...
  void *v8;
  void *v9;
  CNVSchemaCNVLinkMetadataTier1 *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)CNVSchemaCNVLinkMetadataTier1;
  v5 = -[CNVSchemaCNVLinkMetadataTier1 init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CNVSchemaCNVLinkMetadataTier1 setLinkId:](v5, "setLinkId:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CNVSchemaCNVLinkMetadataTier1 setAppBundleId:](v5, "setAppBundleId:", v9);
