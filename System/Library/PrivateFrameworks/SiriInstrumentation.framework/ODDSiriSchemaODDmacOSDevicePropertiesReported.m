...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported general](self, "general");
  ...
  if (v8)
    -[ODDSiriSchemaODDmacOSDevicePropertiesReported deleteGeneral](self, "deleteGeneral");
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported assistant](self, "assistant");
  ...
  if (v11)
    -[ODDSiriSchemaODDmacOSDevicePropertiesReported deleteAssistant](self, "deleteAssistant");
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported dictation](self, "dictation");
  ...
  if (v14)
    -[ODDSiriSchemaODDmacOSDevicePropertiesReported deleteDictation](self, "deleteDictation");
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported macOSAssistant](self, "macOSAssistant");
  ...
  if (v17)
    -[ODDSiriSchemaODDmacOSDevicePropertiesReported deleteMacOSAssistant](self, "deleteMacOSAssistant");
...
- (void)deleteGeneral
{
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported setGeneral:](self, "setGeneral:", 0);
}
...
{
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported setAssistant:](self, "setAssistant:", 0);
}
...
{
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported setDictation:](self, "setDictation:", 0);
}
...
{
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported setMacOSAssistant:](self, "setMacOSAssistant:", 0);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported macOSAssistant](self, "macOSAssistant");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "macOSAssistant");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) != (v6 != 0))
  {
    -[ODDSiriSchemaODDmacOSDevicePropertiesReported macOSAssistant](self, "macOSAssistant");
...
- (unint64_t)hash
{
  ...
  return v4 ^ v5 ^ -[ODDSiriSchemaODDmacOSAssistantProperties hash](self->_macOSAssistant, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_macOSAssistant)
  {
    ...
    if (v14)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("macOSAssistant"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v15, CFSTR("macOSAssistant"));
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDmacOSDevicePropertiesReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDmacOSDevicePropertiesReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDmacOSDevicePropertiesReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDmacOSDevicePropertiesReported)initWithDictionary:(id)a3
{
  ...
  void *v12;
  ODDSiriSchemaODDmacOSAssistantProperties *v13;
  ODDSiriSchemaODDmacOSDevicePropertiesReported *v14;
  objc_super v16;

  v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)ODDSiriSchemaODDmacOSDevicePropertiesReported;
  v5 = -[ODDSiriSchemaODDmacOSDevicePropertiesReported init](&v16, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDmacOSDevicePropertiesReported setGeneral:](v5, "setGeneral:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDmacOSDevicePropertiesReported setAssistant:](v5, "setAssistant:", v9);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDmacOSDevicePropertiesReported setDictation:](v5, "setDictation:", v11);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("macOSAssistant"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v13 = -[ODDSiriSchemaODDmacOSAssistantProperties initWithDictionary:]([ODDSiriSchemaODDmacOSAssistantProperties alloc], "initWithDictionary:", v12);
      -[ODDSiriSchemaODDmacOSDevicePropertiesReported setMacOSAssistant:](v5, "setMacOSAssistant:", v13);
...
{
  objc_storeStrong((id *)&self->_macOSAssistant, a3);
}
