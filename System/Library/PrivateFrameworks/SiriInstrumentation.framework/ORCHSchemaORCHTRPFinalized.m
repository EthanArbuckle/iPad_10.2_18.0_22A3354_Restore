...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ORCHSchemaORCHTRPFinalized trpId](self, "trpId", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[ORCHSchemaORCHTRPFinalized deleteTrpId](self, "deleteTrpId");
  return v5;
}
...
- (void)deleteTrpId
{
  -[ORCHSchemaORCHTRPFinalized setTrpId:](self, "setTrpId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[ORCHSchemaORCHTRPFinalized trpId](self, "trpId");
...
- (NSData)jsonData
{
  ...
  -[ORCHSchemaORCHTRPFinalized dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (ORCHSchemaORCHTRPFinalized)initWithJSON:(id)a3
{
  ...
  {
    self = -[ORCHSchemaORCHTRPFinalized initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ORCHSchemaORCHTRPFinalized)initWithDictionary:(id)a3
{
  ...
  void *v6;
  SISchemaUUID *v7;
  ORCHSchemaORCHTRPFinalized *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ORCHSchemaORCHTRPFinalized;
  v5 = -[ORCHSchemaORCHTRPFinalized init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ORCHSchemaORCHTRPFinalized setTrpId:](v5, "setTrpId:", v7);
