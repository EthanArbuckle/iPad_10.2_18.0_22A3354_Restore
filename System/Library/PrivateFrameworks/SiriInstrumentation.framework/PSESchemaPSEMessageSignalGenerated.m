...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[PSESchemaPSEMessageSignalGenerated commonSignal](self, "commonSignal");
  ...
  if (v8)
    -[PSESchemaPSEMessageSignalGenerated deleteCommonSignal](self, "deleteCommonSignal");
  -[PSESchemaPSEMessageSignalGenerated messageSignal](self, "messageSignal");
  ...
  if (v11)
    -[PSESchemaPSEMessageSignalGenerated deleteMessageSignal](self, "deleteMessageSignal");
...
{
  -[PSESchemaPSEMessageSignalGenerated setCommonSignal:](self, "setCommonSignal:", 0);
}
...
{
  -[PSESchemaPSEMessageSignalGenerated setMessageSignal:](self, "setMessageSignal:", 0);
}
...
- (unint64_t)hash
{
  ...
  return -[PSESchemaPSEMessage hash](self->_messageSignal, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_messageSignal)
  {
    ...
    if (v8)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("messageSignal"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("messageSignal"));
...
- (NSData)jsonData
{
  ...
  -[PSESchemaPSEMessageSignalGenerated dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PSESchemaPSEMessageSignalGenerated *v5;
  uint64_t v7;
  ...
  {
    self = -[PSESchemaPSEMessageSignalGenerated initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PSESchemaPSEMessageSignalGenerated)initWithDictionary:(id)a3
{
  ...
  void *v8;
  PSESchemaPSEMessage *v9;
  PSESchemaPSEMessageSignalGenerated *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)PSESchemaPSEMessageSignalGenerated;
  v5 = -[PSESchemaPSEMessageSignalGenerated init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PSESchemaPSEMessageSignalGenerated setCommonSignal:](v5, "setCommonSignal:", v7);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("messageSignal"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v9 = -[PSESchemaPSEMessage initWithDictionary:]([PSESchemaPSEMessage alloc], "initWithDictionary:", v8);
      -[PSESchemaPSEMessageSignalGenerated setMessageSignal:](v5, "setMessageSignal:", v9);
...
{
  objc_storeStrong((id *)&self->_messageSignal, a3);
}
