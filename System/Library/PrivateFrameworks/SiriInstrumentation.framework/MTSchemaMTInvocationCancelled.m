...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[MTSchemaMTInvocationCancelled qssSessionId](self, "qssSessionId");
  ...
  if (v8)
    -[MTSchemaMTInvocationCancelled deleteQssSessionId](self, "deleteQssSessionId");
  -[MTSchemaMTInvocationCancelled localePair](self, "localePair");
  ...
  if (v11)
    -[MTSchemaMTInvocationCancelled deleteLocalePair](self, "deleteLocalePair");
...
- (void)deleteExists
{
  -[MTSchemaMTInvocationCancelled setExists:](self, "setExists:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[MTSchemaMTInvocationCancelled setQssSessionId:](self, "setQssSessionId:", 0);
}
...
{
  -[MTSchemaMTInvocationCancelled setLocalePair:](self, "setLocalePair:", 0);
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[MTSchemaMTInvocationCancelled exists](self, "exists"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[MTSchemaMTInvocationCancelled dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  MTSchemaMTInvocationCancelled *v5;
  uint64_t v7;
  ...
  {
    self = -[MTSchemaMTInvocationCancelled initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MTSchemaMTInvocationCancelled)initWithDictionary:(id)a3
{
  ...
  MTSchemaMTInvocationCancelled *v11;
  objc_super v13;

  v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)MTSchemaMTInvocationCancelled;
  v5 = -[MTSchemaMTInvocationCancelled init](&v13, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[MTSchemaMTInvocationCancelled setExists:](v5, "setExists:", objc_msgSend(v6, "BOOLValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTInvocationCancelled setQssSessionId:](v5, "setQssSessionId:", v8);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTInvocationCancelled setLocalePair:](v5, "setLocalePair:", v10);
