...
{
  -[DIMSchemaDIMOnDeviceDigest setDaysWithTwoValidAssistantTurnsPerWeek:](self, "setDaysWithTwoValidAssistantTurnsPerWeek:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[DIMSchemaDIMOnDeviceDigest setDaysWithTwoAssistantSpeechRequestsPerWeek:](self, "setDaysWithTwoAssistantSpeechRequestsPerWeek:", 0);
  *(_BYTE *)&self->_has &= ~2u;
}
...
LABEL_10:
  ...
  if (v8)
  {
    ...
    if (daysWithTwoAssistantSpeechRequestsPerWeek != objc_msgSend(v4, "daysWithTwoAssistantSpeechRequestsPerWeek"))goto LABEL_10;
  }
  v10 = 1;
LABEL_11:
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[DIMSchemaDIMOnDeviceDigest daysWithTwoAssistantSpeechRequestsPerWeek](self, "daysWithTwoAssistantSpeechRequestsPerWeek"));
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[DIMSchemaDIMOnDeviceDigest daysWithTwoValidAssistantTurnsPerWeek](self, "daysWithTwoValidAssistantTurnsPerWeek"));
...
- (NSData)jsonData
{
  ...
  -[DIMSchemaDIMOnDeviceDigest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (DIMSchemaDIMOnDeviceDigest)initWithJSON:(id)a3
{
  ...
  {
    self = -[DIMSchemaDIMOnDeviceDigest initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (DIMSchemaDIMOnDeviceDigest)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  DIMSchemaDIMOnDeviceDigest *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)DIMSchemaDIMOnDeviceDigest;
  v5 = -[DIMSchemaDIMOnDeviceDigest init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[DIMSchemaDIMOnDeviceDigest setDaysWithTwoValidAssistantTurnsPerWeek:](v5, "setDaysWithTwoValidAssistantTurnsPerWeek:", objc_msgSend(v6, "unsignedIntValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("daysWithTwoAssistantSpeechRequestsPerWeek"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[DIMSchemaDIMOnDeviceDigest setDaysWithTwoAssistantSpeechRequestsPerWeek:](v5, "setDaysWithTwoAssistantSpeechRequestsPerWeek:", objc_msgSend(v7, "unsignedIntValue"));
    v8 = v5;
