...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[SessionSchemaSession sessionId](self, "sessionId");
  ...
  if (v8)
    -[SessionSchemaSession deleteSessionId](self, "deleteSessionId");
  -[SessionSchemaSession events](self, "events");
  ...
  -[SessionSchemaSession setEvents:](self, "setEvents:", v10);
...
{
  return CFSTR("com.apple.aiml.platform.Session");
}
...
{
  -[SessionSchemaSession setSessionId:](self, "setSessionId:", 0);
}
...
- (unint64_t)hash
{
  ...
  v3 = -[SessionSchemaSessionId hash](self->_sessionId, "hash");
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_sessionId)
  {
    ...
    if (v13)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v13, CFSTR("sessionId"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("sessionId"));
...
- (NSData)jsonData
{
  ...
  -[SessionSchemaSession dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (SessionSchemaSession)initWithJSON:(id)a3
{
  ...
  {
    self = -[SessionSchemaSession initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SessionSchemaSession)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  SessionSchemaOrderedSessionEvent *v15;
  SessionSchemaSession *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[SessionSchemaSession init](&v23, sel_init);
  if (v5)
  {
    ...
    {
      v7 = -[SessionSchemaSessionId initWithDictionary:]([SessionSchemaSessionId alloc], "initWithDictionary:", v6);
      -[SessionSchemaSession setSessionId:](v5, "setSessionId:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[SessionSchemaOrderedSessionEvent initWithDictionary:]([SessionSchemaOrderedSessionEvent alloc], "initWithDictionary:", v14);
              -[SessionSchemaSession addEvent:](v5, "addEvent:", v15);
