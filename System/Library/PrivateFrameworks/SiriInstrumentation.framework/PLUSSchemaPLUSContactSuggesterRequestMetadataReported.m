...
{
  -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported setIsPlusContactSuggesterEnabled:](self, "setIsPlusContactSuggesterEnabled:", 0);
  *(&self->_isForcePromptUsed + 1) &= ~1u;
}
...
{
  -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported setIsForcePromptUsed:](self, "setIsForcePromptUsed:", 0);
  *(&self->_isForcePromptUsed + 1) &= ~2u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  int v8;
  int isForcePromptUsed;
  BOOL v10;

  v4 = (unsigned __int8 *)a3;
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_10;
  v5 = *((unsigned __int8 *)&self->_isForcePromptUsed + 1);
  v6 = v4[10];
  if ((v5 & 1) != (v6 & 1))
    goto LABEL_10;
  if ((v5 & 1) != 0)
...
LABEL_10:
  ...
  if (v8)
  {
    ...
    if (isForcePromptUsed != objc_msgSend(v4, "isForcePromptUsed"))
      goto LABEL_10;
  }
  v10 = 1;
LABEL_11:
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported isForcePromptUsed](self, "isForcePromptUsed"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("isForcePromptUsed"));

    v4 = *(&self->_isForcePromptUsed + 1);
  }
  if ((v4 & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported isPlusContactSuggesterEnabled](self, "isPlusContactSuggesterEnabled"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("isPlusContactSuggesterEnabled"));
...
- (NSData)jsonData
{
  ...
  -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PLUSSchemaPLUSContactSuggesterRequestMetadataReported *v5;
  uint64_t v7;
  ...
  {
    self = -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PLUSSchemaPLUSContactSuggesterRequestMetadataReported)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  PLUSSchemaPLUSContactSuggesterRequestMetadataReported *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PLUSSchemaPLUSContactSuggesterRequestMetadataReported;
  v5 = -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported setIsPlusContactSuggesterEnabled:](v5, "setIsPlusContactSuggesterEnabled:", objc_msgSend(v6, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isForcePromptUsed"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PLUSSchemaPLUSContactSuggesterRequestMetadataReported setIsForcePromptUsed:](v5, "setIsForcePromptUsed:", objc_msgSend(v7, "BOOLValue"));
    v8 = v5;
