...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[EXPSiriSchemaEXPAllocationSnapshot allocations](self, "allocations", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[EXPSiriSchemaEXPAllocationSnapshot setAllocations:](self, "setAllocations:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[EXPSiriSchemaEXPAllocationSnapshot allocations](self, "allocations");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[EXPSiriSchemaEXPAllocationSnapshot dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  EXPSiriSchemaEXPAllocationSnapshot *v5;
  uint64_t v7;
  ...
  {
    self = -[EXPSiriSchemaEXPAllocationSnapshot initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (EXPSiriSchemaEXPAllocationSnapshot)initWithDictionary:(id)a3
{
  ...
  EXPSiriSchemaEXPAllocationSnapshot *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[EXPSiriSchemaEXPAllocationSnapshot init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[EXPSiriSchemaEXPAllocationSnapshot addAllocations:](v5, "addAllocations:", v14);
