...
- (void)deleteReason
{
  -[CNVSchemaCNVIntentFinalExecutionFailed setReason:](self, "setReason:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[CNVSchemaCNVIntentFinalExecutionFailed reason](self, "reason");
...
- (NSData)jsonData
{
  ...
  -[CNVSchemaCNVIntentFinalExecutionFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  CNVSchemaCNVIntentFinalExecutionFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[CNVSchemaCNVIntentFinalExecutionFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (CNVSchemaCNVIntentFinalExecutionFailed)initWithDictionary:(id)a3
{
  ...
  CNVSchemaCNVIntentFinalExecutionFailed *v5;
  void *v6;
  CNVSchemaCNVIntentFinalExecutionFailed *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CNVSchemaCNVIntentFinalExecutionFailed;
  v5 = -[CNVSchemaCNVIntentFinalExecutionFailed init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[CNVSchemaCNVIntentFinalExecutionFailed setReason:](v5, "setReason:", objc_msgSend(v6, "intValue"));
    v7 = v5;
