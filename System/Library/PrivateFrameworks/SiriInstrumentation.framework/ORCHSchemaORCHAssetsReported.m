...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ORCHSchemaORCHAssetsReported assets](self, "assets", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[ORCHSchemaORCHAssetsReported setAssets:](self, "setAssets:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[ORCHSchemaORCHAssetsReported assets](self, "assets");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_assets, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[ORCHSchemaORCHAssetsReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ORCHSchemaORCHAssetsReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ORCHSchemaORCHAssetsReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ORCHSchemaORCHAssetsReported)initWithDictionary:(id)a3
{
  ...
  SISchemaAsset *v13;
  SISchemaAsset *v14;
  ORCHSchemaORCHAssetsReported *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[ORCHSchemaORCHAssetsReported init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[SISchemaAsset initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[ORCHSchemaORCHAssetsReported addAssets:](v5, "addAssets:", v14);
