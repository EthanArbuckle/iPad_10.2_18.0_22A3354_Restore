...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ASRSchemaASRRecognitionResultTier1 linkId](self, "linkId");
  ...
  if (v8)
    -[ASRSchemaASRRecognitionResultTier1 deleteLinkId](self, "deleteLinkId");
  -[ASRSchemaASRRecognitionResultTier1 tokens](self, "tokens");
  ...
  -[ASRSchemaASRRecognitionResultTier1 setTokens:](self, "setTokens:", v10);
...
- (void)deleteLinkId
{
  -[ASRSchemaASRRecognitionResultTier1 setLinkId:](self, "setLinkId:", 0);
}
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_tokens, "hash") ^ v3;
}
...
- (NSData)jsonData
{
  ...
  -[ASRSchemaASRRecognitionResultTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ASRSchemaASRRecognitionResultTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[ASRSchemaASRRecognitionResultTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ASRSchemaASRRecognitionResultTier1)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ASRSchemaASRTokenTier1 *v15;
  ASRSchemaASRRecognitionResultTier1 *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ASRSchemaASRRecognitionResultTier1 init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ASRSchemaASRRecognitionResultTier1 setLinkId:](v5, "setLinkId:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ASRSchemaASRTokenTier1 initWithDictionary:]([ASRSchemaASRTokenTier1 alloc], "initWithDictionary:", v14);
              -[ASRSchemaASRRecognitionResultTier1 addTokens:](v5, "addTokens:", v15);
