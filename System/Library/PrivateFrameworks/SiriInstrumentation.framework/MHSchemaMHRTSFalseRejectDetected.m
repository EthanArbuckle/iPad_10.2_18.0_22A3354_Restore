...
{
  -[MHSchemaMHRTSFalseRejectDetected setAssetVersion:](self, "setAssetVersion:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[MHSchemaMHRTSFalseRejectDetected setGestureModelVersion:](self, "setGestureModelVersion:", 0);
}
...
{
  -[MHSchemaMHRTSFalseRejectDetected setAudioModelVersion:](self, "setAudioModelVersion:", 0);
}
...
{
  -[MHSchemaMHRTSFalseRejectDetected setPolicyModelVersion:](self, "setPolicyModelVersion:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[MHSchemaMHRTSFalseRejectDetected gestureModelVersion](self, "gestureModelVersion");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[MHSchemaMHRTSFalseRejectDetected audioModelVersion](self, "audioModelVersion");
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  if (v5)
    PBDataWriterWriteStringField();
  -[MHSchemaMHRTSFalseRejectDetected policyModelVersion](self, "policyModelVersion");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[MHSchemaMHRTSFalseRejectDetected assetVersion](self, "assetVersion"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[MHSchemaMHRTSFalseRejectDetected dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  MHSchemaMHRTSFalseRejectDetected *v5;
  uint64_t v7;
  ...
  {
    self = -[MHSchemaMHRTSFalseRejectDetected initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MHSchemaMHRTSFalseRejectDetected)initWithDictionary:(id)a3
{
  ...
  void *v11;
  void *v12;
  MHSchemaMHRTSFalseRejectDetected *v13;
  objc_super v15;

  v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)MHSchemaMHRTSFalseRejectDetected;
  v5 = -[MHSchemaMHRTSFalseRejectDetected init](&v15, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[MHSchemaMHRTSFalseRejectDetected setAssetVersion:](v5, "setAssetVersion:", objc_msgSend(v6, "unsignedIntValue"));
    ...
    {
      v8 = (void *)objc_msgSend(v7, "copy");
      -[MHSchemaMHRTSFalseRejectDetected setGestureModelVersion:](v5, "setGestureModelVersion:", v8);
    ...
    {
      v10 = (void *)objc_msgSend(v9, "copy");
      -[MHSchemaMHRTSFalseRejectDetected setAudioModelVersion:](v5, "setAudioModelVersion:", v10);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MHSchemaMHRTSFalseRejectDetected setPolicyModelVersion:](v5, "setPolicyModelVersion:", v12);
