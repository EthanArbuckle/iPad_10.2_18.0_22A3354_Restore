...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[MHSchemaMHUserSpeakingContext startedOrChanged](self, "startedOrChanged");
  ...
  if (v8)
    -[MHSchemaMHUserSpeakingContext deleteStartedOrChanged](self, "deleteStartedOrChanged");
  -[MHSchemaMHUserSpeakingContext ended](self, "ended");
  ...
  if (v11)
    -[MHSchemaMHUserSpeakingContext deleteEnded](self, "deleteEnded");
  -[MHSchemaMHUserSpeakingContext trpId](self, "trpId");
  ...
  if (v14)
    -[MHSchemaMHUserSpeakingContext deleteTrpId](self, "deleteTrpId");
...
- (MHSchemaMHUserSpeakingStarted)startedOrChanged
{
  if (self->_whichContextevent == 1)
    ...
    return (MHSchemaMHUserSpeakingStarted *)0;
}
...
- (void)setEnded:(id)a3
{
  MHSchemaMHUserSpeakingEnded *v4;
  MHSchemaMHUserSpeakingStarted *startedOrChanged;
  MHSchemaMHUserSpeakingEnded *ended;

  v4 = (MHSchemaMHUserSpeakingEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (MHSchemaMHUserSpeakingEnded)ended
{
  if (self->_whichContextevent == 2)
    ...
    return (MHSchemaMHUserSpeakingEnded *)0;
}
...
- (void)deleteTrpId
{
  -[MHSchemaMHUserSpeakingContext setTrpId:](self, "setTrpId:", 0);
}
...
- (unint64_t)hash
{
  ...
  v3 = -[MHSchemaMHUserSpeakingStarted hash](self->_startedOrChanged, "hash");
  v4 = -[MHSchemaMHUserSpeakingEnded hash](self->_ended, "hash") ^ v3;
...
- (NSData)jsonData
{
  ...
  -[MHSchemaMHUserSpeakingContext dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  MHSchemaMHUserSpeakingContext *v5;
  uint64_t v7;
  ...
  {
    self = -[MHSchemaMHUserSpeakingContext initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MHSchemaMHUserSpeakingContext)initWithDictionary:(id)a3
{
  ...
  MHSchemaMHUserSpeakingContext *v5;
  void *v6;
  MHSchemaMHUserSpeakingStarted *v7;
  void *v8;
  MHSchemaMHUserSpeakingEnded *v9;
  void *v10;
  SISchemaUUID *v11;
  MHSchemaMHUserSpeakingContext *v12;
  objc_super v14;

  v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)MHSchemaMHUserSpeakingContext;
  v5 = -[MHSchemaMHUserSpeakingContext init](&v14, sel_init);
  if (v5)
  {
    ...
    {
      v7 = -[MHSchemaMHUserSpeakingStarted initWithDictionary:]([MHSchemaMHUserSpeakingStarted alloc], "initWithDictionary:", v6);
      -[MHSchemaMHUserSpeakingContext setStartedOrChanged:](v5, "setStartedOrChanged:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v9 = -[MHSchemaMHUserSpeakingEnded initWithDictionary:]([MHSchemaMHUserSpeakingEnded alloc], "initWithDictionary:", v8);
      -[MHSchemaMHUserSpeakingContext setEnded:](v5, "setEnded:", v9);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MHSchemaMHUserSpeakingContext setTrpId:](v5, "setTrpId:", v11);
