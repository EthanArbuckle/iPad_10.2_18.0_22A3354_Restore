...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported fixedDimensions](self, "fixedDimensions");
  ...
  if (v8)
    -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported deleteFixedDimensions](self, "deleteFixedDimensions");
  -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported digests](self, "digests");
  ...
  -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported setDigests:](self, "setDigests:", v10);
...
{
  -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported setFixedDimensions:](self, "setFixedDimensions:", 0);
}
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ODDSiriSchemaODDAssetAvailabilityFromBootDigest *v15;
  ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported setFixedDimensions:](v5, "setFixedDimensions:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ODDSiriSchemaODDAssetAvailabilityFromBootDigest initWithDictionary:]([ODDSiriSchemaODDAssetAvailabilityFromBootDigest alloc], "initWithDictionary:", v14);
              -[ODDSiriSchemaODDAssetAvailabilityFromBootDigestReported addDigests:](v5, "addDigests:", v15);
