...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[PLUSSchemaPLUSContactSuggestionGenerated generatedSuggestion](self, "generatedSuggestion", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[PLUSSchemaPLUSContactSuggestionGenerated deleteGeneratedSuggestion](self, "deleteGeneratedSuggestion");
  return v5;
}
...
{
  -[PLUSSchemaPLUSContactSuggestionGenerated setGeneratedSuggestion:](self, "setGeneratedSuggestion:", 0);
}

- (void)setIsSuggestionUpdated:(BOOL)a3
{
  *(&self->_isSuggestionUpdated + 1) |= 1u;
  self->_isSuggestionUpdated = a3;
}
...
{
  -[PLUSSchemaPLUSContactSuggestionGenerated setIsSuggestionUpdated:](self, "setIsSuggestionUpdated:", 0);
  *(&self->_isSuggestionUpdated + 1) &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[PLUSSchemaPLUSContactSuggestionGenerated generatedSuggestion](self, "generatedSuggestion");
...
LABEL_12:
  ...
  if (*(&self->_isSuggestionUpdated + 1))
  {
    ...
    if (isSuggestionUpdated != objc_msgSend(v4, "isSuggestionUpdated"))
      goto LABEL_12;
  }
  v14 = 1;
LABEL_13:
...
- (unint64_t)hash
{
  ...
  v3 = -[PLUSSchemaPLUSContactSuggestion hash](self->_generatedSuggestion, "hash");
  if (*(&self->_isSuggestionUpdated + 1))
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_isSuggestionUpdated + 1))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PLUSSchemaPLUSContactSuggestionGenerated isSuggestionUpdated](self, "isSuggestionUpdated"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("isSuggestionUpdated"));
...
- (NSData)jsonData
{
  ...
  -[PLUSSchemaPLUSContactSuggestionGenerated dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PLUSSchemaPLUSContactSuggestionGenerated *v5;
  uint64_t v7;
  ...
  {
    self = -[PLUSSchemaPLUSContactSuggestionGenerated initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PLUSSchemaPLUSContactSuggestionGenerated)initWithDictionary:(id)a3
{
  ...
  void *v8;
  PLUSSchemaPLUSContactSuggestionGenerated *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)PLUSSchemaPLUSContactSuggestionGenerated;
  v5 = -[PLUSSchemaPLUSContactSuggestionGenerated init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PLUSSchemaPLUSContactSuggestionGenerated setGeneratedSuggestion:](v5, "setGeneratedSuggestion:", v7);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isSuggestionUpdated"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PLUSSchemaPLUSContactSuggestionGenerated setIsSuggestionUpdated:](v5, "setIsSuggestionUpdated:", objc_msgSend(v8, "BOOLValue"));
    v9 = v5;
