...
{
  -[ANCSchemaANCServerUserResponseEvaluated setUserResponseCategory:](self, "setUserResponseCategory:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[ANCSchemaANCServerUserResponseEvaluated userResponseCategory](self, "userResponseCategory") - 1;
    if (v4 > 2)
...
- (NSData)jsonData
{
  ...
  -[ANCSchemaANCServerUserResponseEvaluated dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ANCSchemaANCServerUserResponseEvaluated *v5;
  uint64_t v7;
  ...
  {
    self = -[ANCSchemaANCServerUserResponseEvaluated initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ANCSchemaANCServerUserResponseEvaluated)initWithDictionary:(id)a3
{
  ...
  ANCSchemaANCServerUserResponseEvaluated *v5;
  void *v6;
  ANCSchemaANCServerUserResponseEvaluated *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ANCSchemaANCServerUserResponseEvaluated;
  v5 = -[ANCSchemaANCServerUserResponseEvaluated init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ANCSchemaANCServerUserResponseEvaluated setUserResponseCategory:](v5, "setUserResponseCategory:", objc_msgSend(v6, "intValue"));
    v7 = v5;
