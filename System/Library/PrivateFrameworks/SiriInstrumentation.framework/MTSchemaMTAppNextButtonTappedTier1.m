...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 2))
    -[MTSchemaMTAppNextButtonTappedTier1 deleteTranslationPayload](self, "deleteTranslationPayload");
  ...
  if (objc_msgSend(v4, "isConditionSet:", 7))
    -[MTSchemaMTAppNextButtonTappedTier1 deleteTranslationPayload](self, "deleteTranslationPayload");
  -[MTSchemaMTAppNextButtonTappedTier1 localePair](self, "localePair");
  ...
  if (v8)
    -[MTSchemaMTAppNextButtonTappedTier1 deleteLocalePair](self, "deleteLocalePair");
...
{
  -[MTSchemaMTAppNextButtonTappedTier1 setTranslationPayload:](self, "setTranslationPayload:", 0);
}
...
{
  -[MTSchemaMTAppNextButtonTappedTier1 setLocalePair:](self, "setLocalePair:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[MTSchemaMTAppNextButtonTappedTier1 translationPayload](self, "translationPayload");
...
- (NSData)jsonData
{
  ...
  -[MTSchemaMTAppNextButtonTappedTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  MTSchemaMTAppNextButtonTappedTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[MTSchemaMTAppNextButtonTappedTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MTSchemaMTAppNextButtonTappedTier1)initWithDictionary:(id)a3
{
  ...
  MTSchemaMTAppNextButtonTappedTier1 *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)MTSchemaMTAppNextButtonTappedTier1;
  v5 = -[MTSchemaMTAppNextButtonTappedTier1 init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTAppNextButtonTappedTier1 setTranslationPayload:](v5, "setTranslationPayload:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTAppNextButtonTappedTier1 setLocalePair:](v5, "setLocalePair:", v9);
