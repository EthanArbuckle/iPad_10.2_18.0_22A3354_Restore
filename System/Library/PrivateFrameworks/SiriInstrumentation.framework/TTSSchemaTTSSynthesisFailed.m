...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[TTSSchemaTTSSynthesisFailed errorCodes](self, "errorCodes");
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_errorCodes, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[TTSSchemaTTSSynthesisFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  TTSSchemaTTSSynthesisFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[TTSSchemaTTSSynthesisFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (TTSSchemaTTSSynthesisFailed)initWithDictionary:(id)a3
{
  ...
  v5 = -[TTSSchemaTTSSynthesisFailed init](&v19, sel_init);
  if (v5)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if ((objc_opt_isKindOfClass() & 1) != 0)
              -[TTSSchemaTTSSynthesisFailed addErrorCodes:](v5, "addErrorCodes:", objc_msgSend(v12, "intValue", (_QWORD)v15));
            ++v11;
          }
          while (v9 != v11);
