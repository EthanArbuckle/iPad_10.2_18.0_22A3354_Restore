...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODDSiriSchemaODDAssistantCarPlayDigestReported fixedDimensions](self, "fixedDimensions");
  ...
  if (v8)
    -[ODDSiriSchemaODDAssistantCarPlayDigestReported deleteFixedDimensions](self, "deleteFixedDimensions");
  -[ODDSiriSchemaODDAssistantCarPlayDigestReported digests](self, "digests");
  ...
  -[ODDSiriSchemaODDAssistantCarPlayDigestReported setDigests:](self, "setDigests:", v10);
...
{
  -[ODDSiriSchemaODDAssistantCarPlayDigestReported setFixedDimensions:](self, "setFixedDimensions:", 0);
}
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDAssistantCarPlayDigestReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDAssistantCarPlayDigestReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDAssistantCarPlayDigestReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDAssistantCarPlayDigestReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ODDSiriSchemaODDAssistantCarPlayDigest *v15;
  ODDSiriSchemaODDAssistantCarPlayDigestReported *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ODDSiriSchemaODDAssistantCarPlayDigestReported init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDAssistantCarPlayDigestReported setFixedDimensions:](v5, "setFixedDimensions:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ODDSiriSchemaODDAssistantCarPlayDigest initWithDictionary:]([ODDSiriSchemaODDAssistantCarPlayDigest alloc], "initWithDictionary:", v14);
              -[ODDSiriSchemaODDAssistantCarPlayDigestReported addDigests:](v5, "addDigests:", v15);
