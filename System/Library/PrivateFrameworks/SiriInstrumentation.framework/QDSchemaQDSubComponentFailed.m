...
{
  -[QDSchemaQDSubComponentFailed setErrorDomain:](self, "setErrorDomain:", 0);
}
...
{
  -[QDSchemaQDSubComponentFailed setErrorCode:](self, "setErrorCode:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[QDSchemaQDSubComponentFailed errorDomain](self, "errorDomain");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[QDSchemaQDSubComponentFailed errorCode](self, "errorCode"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[QDSchemaQDSubComponentFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  QDSchemaQDSubComponentFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[QDSchemaQDSubComponentFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (QDSchemaQDSubComponentFailed)initWithDictionary:(id)a3
{
  ...
  void *v7;
  void *v8;
  QDSchemaQDSubComponentFailed *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)QDSchemaQDSubComponentFailed;
  v5 = -[QDSchemaQDSubComponentFailed init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[QDSchemaQDSubComponentFailed setErrorDomain:](v5, "setErrorDomain:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[QDSchemaQDSubComponentFailed setErrorCode:](v5, "setErrorCode:", objc_msgSend(v8, "intValue"));
    v9 = v5;
