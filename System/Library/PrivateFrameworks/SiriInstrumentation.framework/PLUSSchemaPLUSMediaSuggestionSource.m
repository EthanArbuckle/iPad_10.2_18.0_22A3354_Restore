...
{
  -[PLUSSchemaPLUSMediaSuggestionSource setSourceType:](self, "setSourceType:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if (-[PLUSSchemaPLUSMediaSuggestionSource sourceType](self, "sourceType") == 1)
      v4 = CFSTR("PLUSMEDIASUGGESTIONSOURCE_PLUS_INFERRED_MEDIA_SUGGESTER");
    else
      v4 = CFSTR("PLUSMEDIASUGGESTIONSOURCE_UNKNOWN");
...
- (NSData)jsonData
{
  ...
  -[PLUSSchemaPLUSMediaSuggestionSource dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PLUSSchemaPLUSMediaSuggestionSource *v5;
  uint64_t v7;
  ...
  {
    self = -[PLUSSchemaPLUSMediaSuggestionSource initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PLUSSchemaPLUSMediaSuggestionSource)initWithDictionary:(id)a3
{
  ...
  v5 = -[PLUSSchemaPLUSMediaSuggestionSource init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PLUSSchemaPLUSMediaSuggestionSource setSourceType:](v5, "setSourceType:", objc_msgSend(v6, "intValue"));
    v7 = v5;
