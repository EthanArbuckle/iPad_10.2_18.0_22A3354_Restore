...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[IFTSchemaIFTParameterSet parameters](self, "parameters", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[IFTSchemaIFTParameterSet setParameters:](self, "setParameters:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[IFTSchemaIFTParameterSet parameters](self, "parameters");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[IFTSchemaIFTParameterSet dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (IFTSchemaIFTParameterSet)initWithJSON:(id)a3
{
  ...
  {
    self = -[IFTSchemaIFTParameterSet initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFTSchemaIFTParameterSet)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  IFTSchemaIFTParameter *v13;
  IFTSchemaIFTParameter *v14;
  ...
  v5 = -[IFTSchemaIFTParameterSet init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[IFTSchemaIFTParameter initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[IFTSchemaIFTParameterSet addParameters:](v5, "addParameters:", v14);
