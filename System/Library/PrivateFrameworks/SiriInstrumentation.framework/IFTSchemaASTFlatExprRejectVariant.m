...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[IFTSchemaASTFlatExprRejectVariant rawEventId](self, "rawEventId", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[IFTSchemaASTFlatExprRejectVariant deleteRawEventId](self, "deleteRawEventId");
  return v5;
}
...
- (void)deleteExists
{
  -[IFTSchemaASTFlatExprRejectVariant setExists:](self, "setExists:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[IFTSchemaASTFlatExprRejectVariant setRawEventId:](self, "setRawEventId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[IFTSchemaASTFlatExprRejectVariant rawEventId](self, "rawEventId");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[IFTSchemaASTFlatExprRejectVariant exists](self, "exists"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[IFTSchemaASTFlatExprRejectVariant dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  IFTSchemaASTFlatExprRejectVariant *v5;
  uint64_t v7;
  ...
  {
    self = -[IFTSchemaASTFlatExprRejectVariant initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFTSchemaASTFlatExprRejectVariant)initWithDictionary:(id)a3
{
  ...
  void *v7;
  SISchemaUUID *v8;
  IFTSchemaASTFlatExprRejectVariant *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)IFTSchemaASTFlatExprRejectVariant;
  v5 = -[IFTSchemaASTFlatExprRejectVariant init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[IFTSchemaASTFlatExprRejectVariant setExists:](v5, "setExists:", objc_msgSend(v6, "BOOLValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[IFTSchemaASTFlatExprRejectVariant setRawEventId:](v5, "setRawEventId:", v8);
