...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  {
    -[FLOWSchemaFLOWSportsExecutionTier1 deleteSportName](self, "deleteSportName");
    -[FLOWSchemaFLOWSportsExecutionTier1 deleteLeague](self, "deleteLeague");
    -[FLOWSchemaFLOWSportsExecutionTier1 deleteAthleteEntities](self, "deleteAthleteEntities");
    -[FLOWSchemaFLOWSportsExecutionTier1 deleteTeamEntities](self, "deleteTeamEntities");
    -[FLOWSchemaFLOWSportsExecutionTier1 deleteEventEntities](self, "deleteEventEntities");
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_27;
  -[FLOWSchemaFLOWSportsExecutionTier1 sportNames](self, "sportNames");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[FLOWSchemaFLOWSportsExecutionTier1 leagues](self, "leagues");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[FLOWSchemaFLOWSportsExecutionTier1 athleteEntities](self, "athleteEntities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[FLOWSchemaFLOWSportsExecutionTier1 teamEntities](self, "teamEntities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[FLOWSchemaFLOWSportsExecutionTier1 eventEntities](self, "eventEntities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[FLOWSchemaFLOWSportsExecutionTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  FLOWSchemaFLOWSportsExecutionTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[FLOWSchemaFLOWSportsExecutionTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (FLOWSchemaFLOWSportsExecutionTier1)initWithDictionary:(id)a3
{
  ...
  void *v43;
  void *v44;
  FLOWSchemaFLOWSportsExecutionTier1 *v45;
  void *v47;
  void *v48;
  void *v49;
  __int128 v50;
  ...
  v5 = -[FLOWSchemaFLOWSportsExecutionTier1 init](&v70, sel_init);
  if (v5)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          for (i = 0; i != v9; ++i)
          {
            ...
            objc_opt_class();
            if ((objc_opt_isKindOfClass() & 1) != 0)
              -[FLOWSchemaFLOWSportsExecutionTier1 addSportName:](v5, "addSportName:", objc_msgSend(v12, "intValue"));
          }
        ...
        do
        {
          for (j = 0; j != v16; ++j)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[FLOWSchemaFLOWSportsExecutionTier1 addLeague:](v5, "addLeague:", v20);
        ...
        do
        {
          for (k = 0; k != v24; ++k)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[FLOWSchemaFLOWSportsExecutionTier1 addAthleteEntities:](v5, "addAthleteEntities:", v28);
        ...
        do
        {
          for (m = 0; m != v32; ++m)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[FLOWSchemaFLOWSportsExecutionTier1 addTeamEntities:](v5, "addTeamEntities:", v36);
        ...
        do
        {
          for (n = 0; n != v40; ++n)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[FLOWSchemaFLOWSportsExecutionTier1 addEventEntities:](v5, "addEventEntities:", v44);
