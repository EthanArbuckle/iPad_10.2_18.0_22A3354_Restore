...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[NLXSchemaCDMUsoGraphTier1 usoGraphTier1](self, "usoGraphTier1", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[NLXSchemaCDMUsoGraphTier1 deleteUsoGraphTier1](self, "deleteUsoGraphTier1");
  return v5;
}
...
{
  -[NLXSchemaCDMUsoGraphTier1 setUsoGraphTier1:](self, "setUsoGraphTier1:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[NLXSchemaCDMUsoGraphTier1 usoGraphTier1](self, "usoGraphTier1");
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaCDMUsoGraphTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (NLXSchemaCDMUsoGraphTier1)initWithJSON:(id)a3
{
  ...
  {
    self = -[NLXSchemaCDMUsoGraphTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaCDMUsoGraphTier1)initWithDictionary:(id)a3
{
  ...
  NLXSchemaCDMUsoGraphTier1 *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)NLXSchemaCDMUsoGraphTier1;
  v5 = -[NLXSchemaCDMUsoGraphTier1 init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[NLXSchemaCDMUsoGraphTier1 setUsoGraphTier1:](v5, "setUsoGraphTier1:", v7);
