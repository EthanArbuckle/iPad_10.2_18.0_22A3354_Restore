...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[JRSchemaRankingScoreTuple scores](self, "scores");
...
- (NSData)jsonData
{
  ...
  -[JRSchemaRankingScoreTuple dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (JRSchemaRankingScoreTuple)initWithJSON:(id)a3
{
  ...
  {
    self = -[JRSchemaRankingScoreTuple initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (JRSchemaRankingScoreTuple)initWithDictionary:(id)a3
{
  ...
  v5 = -[JRSchemaRankingScoreTuple init](&v19, sel_init);
  if (v5)
  {
