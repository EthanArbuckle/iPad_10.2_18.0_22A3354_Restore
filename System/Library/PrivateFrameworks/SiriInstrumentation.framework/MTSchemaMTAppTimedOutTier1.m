...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 2))
    -[MTSchemaMTAppTimedOutTier1 deleteTranslationPayload](self, "deleteTranslationPayload");
  ...
  if (objc_msgSend(v4, "isConditionSet:", 7))
    -[MTSchemaMTAppTimedOutTier1 deleteTranslationPayload](self, "deleteTranslationPayload");
  -[MTSchemaMTAppTimedOutTier1 localePair](self, "localePair");
  ...
  if (v8)
    -[MTSchemaMTAppTimedOutTier1 deleteLocalePair](self, "deleteLocalePair");
...
{
  -[MTSchemaMTAppTimedOutTier1 setTranslationPayload:](self, "setTranslationPayload:", 0);
}
...
{
  -[MTSchemaMTAppTimedOutTier1 setLocalePair:](self, "setLocalePair:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[MTSchemaMTAppTimedOutTier1 translationPayload](self, "translationPayload");
...
- (NSData)jsonData
{
  ...
  -[MTSchemaMTAppTimedOutTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (MTSchemaMTAppTimedOutTier1)initWithJSON:(id)a3
{
  ...
  {
    self = -[MTSchemaMTAppTimedOutTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MTSchemaMTAppTimedOutTier1)initWithDictionary:(id)a3
{
  ...
  MTSchemaMTAppTimedOutTier1 *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)MTSchemaMTAppTimedOutTier1;
  v5 = -[MTSchemaMTAppTimedOutTier1 init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTAppTimedOutTier1 setTranslationPayload:](v5, "setTranslationPayload:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTAppTimedOutTier1 setLocalePair:](v5, "setLocalePair:", v9);
