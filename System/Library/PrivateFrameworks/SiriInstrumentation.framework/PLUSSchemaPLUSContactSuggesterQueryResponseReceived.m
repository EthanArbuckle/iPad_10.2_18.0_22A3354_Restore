...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived results](self, "results", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived setResults:](self, "setResults:", v7);
  return v5;
}
...
{
  -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived setHasMatchingResults:](self, "setHasMatchingResults:", 0);
  *(&self->_hasMatchingResults + 1) &= ~1u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v11;
  int v12;
  int hasMatchingResults;
  BOOL v14;

  v4 = a3;
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived results](self, "results");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_12:
  ...
  if (*(&self->_hasMatchingResults + 1))
  {
    ...
    if (hasMatchingResults != objc_msgSend(v4, "hasMatchingResults"))
      goto LABEL_12;
  }
  v14 = 1;
LABEL_13:
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_hasMatchingResults + 1))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived hasMatchingResults](self, "hasMatchingResults"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("hasMatchingResults"));
...
- (NSData)jsonData
{
  ...
  -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PLUSSchemaPLUSContactSuggesterQueryResponseReceived *v5;
  uint64_t v7;
  ...
  {
    self = -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PLUSSchemaPLUSContactSuggesterQueryResponseReceived)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  PLUSSchemaPLUSContactSuggestion *v13;
  PLUSSchemaPLUSContactSuggestion *v14;
  void *v15;
  PLUSSchemaPLUSContactSuggesterQueryResponseReceived *v16;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived init](&v22, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[PLUSSchemaPLUSContactSuggestion initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v18);
              -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived addResults:](v5, "addResults:", v14);
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("hasMatchingResults"), (_QWORD)v18);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PLUSSchemaPLUSContactSuggesterQueryResponseReceived setHasMatchingResults:](v5, "setHasMatchingResults:", objc_msgSend(v15, "BOOLValue"));
    v16 = v5;
