...
{
  -[FLOWSchemaFLOWLocationAccessPermissionPromptFailed setFailureReason:](self, "setFailureReason:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[FLOWSchemaFLOWLocationAccessPermissionPromptFailed failureReason](self, "failureReason") - 1;
    if (v4 > 4)
      v5 = CFSTR("FLOWLOCATIONACCESSPERMISSIONFAILUREREASON_UNKNOWN");
    else
      v5 = *(&off_1E563E938 + v4);
...
- (NSData)jsonData
{
  ...
  -[FLOWSchemaFLOWLocationAccessPermissionPromptFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  FLOWSchemaFLOWLocationAccessPermissionPromptFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[FLOWSchemaFLOWLocationAccessPermissionPromptFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (FLOWSchemaFLOWLocationAccessPermissionPromptFailed)initWithDictionary:(id)a3
{
  ...
  FLOWSchemaFLOWLocationAccessPermissionPromptFailed *v5;
  void *v6;
  FLOWSchemaFLOWLocationAccessPermissionPromptFailed *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)FLOWSchemaFLOWLocationAccessPermissionPromptFailed;
  v5 = -[FLOWSchemaFLOWLocationAccessPermissionPromptFailed init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[FLOWSchemaFLOWLocationAccessPermissionPromptFailed setFailureReason:](v5, "setFailureReason:", objc_msgSend(v6, "intValue"));
    v7 = v5;
