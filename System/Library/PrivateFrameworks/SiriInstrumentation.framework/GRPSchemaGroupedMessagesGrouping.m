...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[GRPSchemaGroupedMessagesGrouping clockIdentifier](self, "clockIdentifier", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[GRPSchemaGroupedMessagesGrouping deleteClockIdentifier](self, "deleteClockIdentifier");
  return v5;
}

- (id)qualifiedMessageName
{
  return CFSTR("com.apple.aiml.platform.GroupedMessagesGrouping");
}
...
{
  -[GRPSchemaGroupedMessagesGrouping setClockIdentifier:](self, "setClockIdentifier:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[GRPSchemaGroupedMessagesGrouping clockIdentifier](self, "clockIdentifier");
...
- (unint64_t)hash
{
  return -[SISchemaUUID hash](self->_clockIdentifier, "hash");
}
...
- (NSData)jsonData
{
  ...
  -[GRPSchemaGroupedMessagesGrouping dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  GRPSchemaGroupedMessagesGrouping *v5;
  uint64_t v7;
  ...
  {
    self = -[GRPSchemaGroupedMessagesGrouping initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (GRPSchemaGroupedMessagesGrouping)initWithDictionary:(id)a3
{
  ...
  void *v6;
  SISchemaUUID *v7;
  GRPSchemaGroupedMessagesGrouping *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)GRPSchemaGroupedMessagesGrouping;
  v5 = -[GRPSchemaGroupedMessagesGrouping init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[GRPSchemaGroupedMessagesGrouping setClockIdentifier:](v5, "setClockIdentifier:", v7);
