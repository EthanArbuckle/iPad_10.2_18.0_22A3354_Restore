...
{
  -[ORCHSchemaORCHNLV3ServerFallbackDeprecated setFallbackReason:](self, "setFallbackReason:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[ORCHSchemaORCHNLV3ServerFallbackDeprecated fallbackReason](self, "fallbackReason") - 1;
    if (v4 > 5)
...
- (NSData)jsonData
{
  ...
  -[ORCHSchemaORCHNLV3ServerFallbackDeprecated dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ORCHSchemaORCHNLV3ServerFallbackDeprecated *v5;
  uint64_t v7;
  ...
  {
    self = -[ORCHSchemaORCHNLV3ServerFallbackDeprecated initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ORCHSchemaORCHNLV3ServerFallbackDeprecated)initWithDictionary:(id)a3
{
  ...
  ORCHSchemaORCHNLV3ServerFallbackDeprecated *v5;
  void *v6;
  ORCHSchemaORCHNLV3ServerFallbackDeprecated *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ORCHSchemaORCHNLV3ServerFallbackDeprecated;
  v5 = -[ORCHSchemaORCHNLV3ServerFallbackDeprecated init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ORCHSchemaORCHNLV3ServerFallbackDeprecated setFallbackReason:](v5, "setFallbackReason:", objc_msgSend(v6, "intValue"));
    v7 = v5;
