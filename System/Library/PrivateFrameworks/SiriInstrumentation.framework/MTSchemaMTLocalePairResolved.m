...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[MTSchemaMTLocalePairResolved localePair](self, "localePair", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[MTSchemaMTLocalePairResolved deleteLocalePair](self, "deleteLocalePair");
  return v5;
}
...
{
  -[MTSchemaMTLocalePairResolved setLocalePair:](self, "setLocalePair:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[MTSchemaMTLocalePairResolved localePair](self, "localePair");
...
- (NSData)jsonData
{
  ...
  -[MTSchemaMTLocalePairResolved dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  MTSchemaMTLocalePairResolved *v5;
  uint64_t v7;
  ...
  {
    self = -[MTSchemaMTLocalePairResolved initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MTSchemaMTLocalePairResolved)initWithDictionary:(id)a3
{
  ...
  MTSchemaMTLocalePairResolved *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)MTSchemaMTLocalePairResolved;
  v5 = -[MTSchemaMTLocalePairResolved init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTLocalePairResolved setLocalePair:](v5, "setLocalePair:", v7);
