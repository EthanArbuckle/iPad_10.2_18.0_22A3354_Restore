...
{
  -[PEGASUSSchemaPEGASUSMapsExecution setMapsFeature:](self, "setMapsFeature:", 0);
  *(&self->_isSpellCorrected + 1) &= ~1u;
}
...
{
  -[PEGASUSSchemaPEGASUSMapsExecution setMapsQueryLabel:](self, "setMapsQueryLabel:", 0);
  *(&self->_isSpellCorrected + 1) &= ~2u;
}
...
{
  -[PEGASUSSchemaPEGASUSMapsExecution setIsSearchAlongRouteRequest:](self, "setIsSearchAlongRouteRequest:", 0);
  *(&self->_isSpellCorrected + 1) &= ~4u;
}
...
{
  -[PEGASUSSchemaPEGASUSMapsExecution setIsProxySearchResult:](self, "setIsProxySearchResult:", 0);
  *(&self->_isSpellCorrected + 1) &= ~8u;
}
...
{
  -[PEGASUSSchemaPEGASUSMapsExecution setIsSpellCorrected:](self, "setIsSpellCorrected:", 0);
  *(&self->_isSpellCorrected + 1) &= ~0x10u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 8) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSMapsExecution isProxySearchResult](self, "isProxySearchResult"));
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSMapsExecution isSearchAlongRouteRequest](self, "isSearchAlongRouteRequest"));
...
LABEL_9:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PEGASUSSchemaPEGASUSMapsExecution isSpellCorrected](self, "isSpellCorrected"));
...
LABEL_10:
  v8 = -[PEGASUSSchemaPEGASUSMapsExecution mapsFeature](self, "mapsFeature") - 1;
  if (v8 > 0xB)
    v9 = CFSTR("PEGASUSMAPSFEATURE_UNKNOWN");
  else
    v9 = off_1E563B128[v8];
  ...
  {
LABEL_14:
    v10 = -[PEGASUSSchemaPEGASUSMapsExecution mapsQueryLabel](self, "mapsQueryLabel") - 1;
    if (v10 > 0xA)
      v11 = CFSTR("PEGASUSMAPSQUERYLABEL_UNKNOWN");
    else
      v11 = off_1E563B188[v10];
...
- (NSData)jsonData
{
  ...
  -[PEGASUSSchemaPEGASUSMapsExecution dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PEGASUSSchemaPEGASUSMapsExecution *v5;
  uint64_t v7;
  ...
  {
    self = -[PEGASUSSchemaPEGASUSMapsExecution initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PEGASUSSchemaPEGASUSMapsExecution)initWithDictionary:(id)a3
{
  ...
  void *v9;
  void *v10;
  PEGASUSSchemaPEGASUSMapsExecution *v11;
  objc_super v13;

  v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)PEGASUSSchemaPEGASUSMapsExecution;
  v5 = -[PEGASUSSchemaPEGASUSMapsExecution init](&v13, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSMapsExecution setMapsFeature:](v5, "setMapsFeature:", objc_msgSend(v6, "intValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("mapsQueryLabel"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSMapsExecution setMapsQueryLabel:](v5, "setMapsQueryLabel:", objc_msgSend(v7, "intValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isSearchAlongRouteRequest"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSMapsExecution setIsSearchAlongRouteRequest:](v5, "setIsSearchAlongRouteRequest:", objc_msgSend(v8, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isProxySearchResult"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSMapsExecution setIsProxySearchResult:](v5, "setIsProxySearchResult:", objc_msgSend(v9, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isSpellCorrected"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSMapsExecution setIsSpellCorrected:](v5, "setIsSpellCorrected:", objc_msgSend(v10, "BOOLValue"));
    v11 = v5;
