...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumGuestsAccepted:](self, "setNumGuestsAccepted:", 0);
  *(_WORD *)&self->_has &= ~1u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumParticipantsWithTrust:](self, "setNumParticipantsWithTrust:", 0);
  *(_WORD *)&self->_has &= ~2u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWhoSyncedRecognizeMyVoice:](self, "setNumUsersWhoSyncedRecognizeMyVoice:", 0);
  *(_WORD *)&self->_has &= ~4u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithRecognizeMyVoiceEnabled:](self, "setNumUsersWithRecognizeMyVoiceEnabled:", 0);
  *(_WORD *)&self->_has &= ~8u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumVoiceProfilesAvailable:](self, "setNumVoiceProfilesAvailable:", 0);
  *(_WORD *)&self->_has &= ~0x10u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithPersonalRequestsEnabled:](self, "setNumUsersWithPersonalRequestsEnabled:", 0);
  *(_WORD *)&self->_has &= ~0x20u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithMatchingSiriLanguage:](self, "setNumUsersWithMatchingSiriLanguage:", 0);
  *(_WORD *)&self->_has &= ~0x40u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithSiriCloudSyncEnabled:](self, "setNumUsersWithSiriCloudSyncEnabled:", 0);
  *(_WORD *)&self->_has &= ~0x80u;
}
...
{
  -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithLocationServicesEnabled:](self, "setNumUsersWithLocationServicesEnabled:", 0);
  *(_WORD *)&self->_has &= ~0x100u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numGuestsAccepted](self, "numGuestsAccepted"));
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numParticipantsWithTrust](self, "numParticipantsWithTrust"));
...
LABEL_14:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWhoSyncedRecognizeMyVoice](self, "numUsersWhoSyncedRecognizeMyVoice"));
...
LABEL_15:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithLocationServicesEnabled](self, "numUsersWithLocationServicesEnabled"));
...
LABEL_16:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithMatchingSiriLanguage](self, "numUsersWithMatchingSiriLanguage"));
...
LABEL_17:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithPersonalRequestsEnabled](self, "numUsersWithPersonalRequestsEnabled"));
...
LABEL_8:
    if ((has & 0x80) == 0)
      goto LABEL_9;
LABEL_19:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithSiriCloudSyncEnabled](self, "numUsersWithSiriCloudSyncEnabled"));
...
LABEL_18:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithRecognizeMyVoiceEnabled](self, "numUsersWithRecognizeMyVoiceEnabled"));
...
LABEL_9:
  ...
  {
LABEL_10:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numVoiceProfilesAvailable](self, "numVoiceProfilesAvailable"));
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDMultiUserSetupStatus dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDMultiUserSetupStatus *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDMultiUserSetupStatus initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDMultiUserSetupStatus)initWithDictionary:(id)a3
{
  ...
  v5 = -[ODDSiriSchemaODDMultiUserSetupStatus init](&v20, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumGuestsAccepted:](v5, "setNumGuestsAccepted:", objc_msgSend(v6, "unsignedIntValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numParticipantsWithTrust"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumParticipantsWithTrust:](v5, "setNumParticipantsWithTrust:", objc_msgSend(v7, "unsignedIntValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numUsersWhoSyncedRecognizeMyVoice"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWhoSyncedRecognizeMyVoice:](v5, "setNumUsersWhoSyncedRecognizeMyVoice:", objc_msgSend(v8, "unsignedIntValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numUsersWithRecognizeMyVoiceEnabled"), v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithRecognizeMyVoiceEnabled:](v5, "setNumUsersWithRecognizeMyVoiceEnabled:", objc_msgSend(v9, "unsignedIntValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numVoiceProfilesAvailable"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumVoiceProfilesAvailable:](v5, "setNumVoiceProfilesAvailable:", objc_msgSend(v10, "unsignedIntValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numUsersWithPersonalRequestsEnabled"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithPersonalRequestsEnabled:](v5, "setNumUsersWithPersonalRequestsEnabled:", objc_msgSend(v11, "intValue"));
    v19 = v7;
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numUsersWithMatchingSiriLanguage"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithMatchingSiriLanguage:](v5, "setNumUsersWithMatchingSiriLanguage:", objc_msgSend(v12, "intValue"));
    v13 = v6;
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numUsersWithSiriCloudSyncEnabled"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithSiriCloudSyncEnabled:](v5, "setNumUsersWithSiriCloudSyncEnabled:", objc_msgSend(v14, "intValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("numUsersWithLocationServicesEnabled"));
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ODDSiriSchemaODDMultiUserSetupStatus setNumUsersWithLocationServicesEnabled:](v5, "setNumUsersWithLocationServicesEnabled:", objc_msgSend(v15, "intValue"));
    v16 = v5;
