...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[IDENTITYSchemaIDENTITYVoiceScoreCard identityScores](self, "identityScores", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[IDENTITYSchemaIDENTITYVoiceScoreCard setIdentityScores:](self, "setIdentityScores:", v7);
  return v5;
}
...
{
  -[IDENTITYSchemaIDENTITYVoiceScoreCard setClassification:](self, "setClassification:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[IDENTITYSchemaIDENTITYVoiceScoreCard identityScores](self, "identityScores");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[IDENTITYSchemaIDENTITYVoiceScoreCard classification](self, "classification") - 1;
    if (v4 > 3)
...
- (NSData)jsonData
{
  ...
  -[IDENTITYSchemaIDENTITYVoiceScoreCard dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  IDENTITYSchemaIDENTITYVoiceScoreCard *v5;
  uint64_t v7;
  ...
  {
    self = -[IDENTITYSchemaIDENTITYVoiceScoreCard initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IDENTITYSchemaIDENTITYVoiceScoreCard)initWithDictionary:(id)a3
{
  ...
  void *v15;
  IDENTITYSchemaIDENTITYVoiceScoreCard *v16;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[IDENTITYSchemaIDENTITYVoiceScoreCard init](&v22, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[IDENTITYSchemaIDENTITYVoiceScoreCard addIdentityScores:](v5, "addIdentityScores:", v14);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[IDENTITYSchemaIDENTITYVoiceScoreCard setClassification:](v5, "setClassification:", objc_msgSend(v15, "intValue"));
    v16 = v5;
