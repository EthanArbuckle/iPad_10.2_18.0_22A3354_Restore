...
{
  -[INFERENCESchemaINFERENCETrialEnrollment setExperimentId:](self, "setExperimentId:", 0);
}
...
{
  -[INFERENCESchemaINFERENCETrialEnrollment setTreatmentId:](self, "setTreatmentId:", 0);
}
...
{
  -[INFERENCESchemaINFERENCETrialEnrollment setDeploymentId:](self, "setDeploymentId:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[INFERENCESchemaINFERENCETrialEnrollment setRolloutId:](self, "setRolloutId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[INFERENCESchemaINFERENCETrialEnrollment experimentId](self, "experimentId");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[INFERENCESchemaINFERENCETrialEnrollment treatmentId](self, "treatmentId");
  ...
  -[INFERENCESchemaINFERENCETrialEnrollment rolloutId](self, "rolloutId");
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v5 = 0;
  return v4 ^ v3 ^ v5 ^ -[NSString hash](self->_rolloutId, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[INFERENCESchemaINFERENCETrialEnrollment deploymentId](self, "deploymentId"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_treatmentId)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("treatmentId"));
...
- (NSData)jsonData
{
  ...
  -[INFERENCESchemaINFERENCETrialEnrollment dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  INFERENCESchemaINFERENCETrialEnrollment *v5;
  uint64_t v7;
  ...
  {
    self = -[INFERENCESchemaINFERENCETrialEnrollment initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (INFERENCESchemaINFERENCETrialEnrollment)initWithDictionary:(id)a3
{
  ...
  void *v11;
  void *v12;
  INFERENCESchemaINFERENCETrialEnrollment *v13;
  objc_super v15;

  v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)INFERENCESchemaINFERENCETrialEnrollment;
  v5 = -[INFERENCESchemaINFERENCETrialEnrollment init](&v15, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[INFERENCESchemaINFERENCETrialEnrollment setExperimentId:](v5, "setExperimentId:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[INFERENCESchemaINFERENCETrialEnrollment setTreatmentId:](v5, "setTreatmentId:", v9);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[INFERENCESchemaINFERENCETrialEnrollment setDeploymentId:](v5, "setDeploymentId:", objc_msgSend(v10, "longLongValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[INFERENCESchemaINFERENCETrialEnrollment setRolloutId:](v5, "setRolloutId:", v12);
