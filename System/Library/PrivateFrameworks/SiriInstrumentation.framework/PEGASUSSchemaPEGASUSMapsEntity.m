...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  {
    -[PEGASUSSchemaPEGASUSMapsEntity deleteMuid](self, "deleteMuid");
    -[PEGASUSSchemaPEGASUSMapsEntity deleteMapsFeatureId](self, "deleteMapsFeatureId");
    -[PEGASUSSchemaPEGASUSMapsEntity deleteAddressId](self, "deleteAddressId");
  }
...
- (void)writeTo:(id)a3
{
  ...
  if (whichEntityid == 2)
    PBDataWriterWriteUint64Field();
  -[PEGASUSSchemaPEGASUSMapsEntity addressId](self, "addressId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if (whichEntityid == 2)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[PEGASUSSchemaPEGASUSMapsEntity mapsFeatureId](self, "mapsFeatureId"));
  ...
  if (whichEntityid == 1)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[PEGASUSSchemaPEGASUSMapsEntity muid](self, "muid"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[PEGASUSSchemaPEGASUSMapsEntity dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PEGASUSSchemaPEGASUSMapsEntity *v5;
  uint64_t v7;
  ...
  {
    self = -[PEGASUSSchemaPEGASUSMapsEntity initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PEGASUSSchemaPEGASUSMapsEntity)initWithDictionary:(id)a3
{
  ...
  void *v8;
  void *v9;
  PEGASUSSchemaPEGASUSMapsEntity *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)PEGASUSSchemaPEGASUSMapsEntity;
  v5 = -[PEGASUSSchemaPEGASUSMapsEntity init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSMapsEntity setMuid:](v5, "setMuid:", objc_msgSend(v6, "unsignedLongLongValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("mapsFeatureId"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PEGASUSSchemaPEGASUSMapsEntity setMapsFeatureId:](v5, "setMapsFeatureId:", objc_msgSend(v7, "unsignedLongLongValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PEGASUSSchemaPEGASUSMapsEntity setAddressId:](v5, "setAddressId:", v9);
