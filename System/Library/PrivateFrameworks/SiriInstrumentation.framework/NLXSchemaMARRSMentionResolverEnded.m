...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[NLXSchemaMARRSMentionResolverEnded mentionResolverSpans](self, "mentionResolverSpans", v11.receiver, v11.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[NLXSchemaMARRSMentionResolverEnded setMentionResolverSpans:](self, "setMentionResolverSpans:", v7);

  -[NLXSchemaMARRSMentionResolverEnded linkId](self, "linkId");
  ...
  if ((_DWORD)v4)
    -[NLXSchemaMARRSMentionResolverEnded deleteLinkId](self, "deleteLinkId");
  return v5;
}

- (void)clearMentionResolverSpans
{
  -[NSArray removeAllObjects](self->_mentionResolverSpans, "removeAllObjects");
}
...
- (void)addMentionResolverSpans:(id)a3
{
  ...
  if (!mentionResolverSpans)
  {
    ...
    v7 = self->_mentionResolverSpans;
    self->_mentionResolverSpans = v6;

    v4 = v8;
    mentionResolverSpans = self->_mentionResolverSpans;
  }
  -[NSArray addObject:](mentionResolverSpans, "addObject:", v4);

}

- (unint64_t)mentionResolverSpansCount
{
  return -[NSArray count](self->_mentionResolverSpans, "count");
}

- (id)mentionResolverSpansAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_mentionResolverSpans, "objectAtIndexedSubscript:", a3);
}
...
- (void)deleteLinkId
{
  -[NLXSchemaMARRSMentionResolverEnded setLinkId:](self, "setLinkId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[NLXSchemaMARRSMentionResolverEnded linkId](self, "linkId", v12);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[NLXSchemaMARRSMentionResolverEnded mentionResolverSpans](self, "mentionResolverSpans");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "mentionResolverSpans");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) == (v6 != 0))
    goto LABEL_11;
  -[NLXSchemaMARRSMentionResolverEnded mentionResolverSpans](self, "mentionResolverSpans");
...
- (unint64_t)hash
{
  ...
  v3 = -[NSArray hash](self->_mentionResolverSpans, "hash");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_mentionResolverSpans, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v16 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("mentionResolverSpans"));
  }
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaMARRSMentionResolverEnded dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  NLXSchemaMARRSMentionResolverEnded *v5;
  uint64_t v7;
  ...
  {
    self = -[NLXSchemaMARRSMentionResolverEnded initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaMARRSMentionResolverEnded)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  NLXSchemaCDMMatchingSpan *v13;
  NLXSchemaCDMMatchingSpan *v14;
  void *v15;
  SISchemaUUID *v16;
  NLXSchemaMARRSMentionResolverEnded *v17;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  __int128 v22;
  ...
  v5 = -[NLXSchemaMARRSMentionResolverEnded init](&v23, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("mentionResolverSpans"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[NLXSchemaCDMMatchingSpan initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v19);
              -[NLXSchemaMARRSMentionResolverEnded addMentionResolverSpans:](v5, "addMentionResolverSpans:", v14);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[NLXSchemaMARRSMentionResolverEnded setLinkId:](v5, "setLinkId:", v16);
