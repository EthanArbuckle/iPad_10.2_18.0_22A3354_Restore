...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODMSiriSchemaODMSiriCountsReported aggregationInterval](self, "aggregationInterval");
  ...
  if (v8)
    -[ODMSiriSchemaODMSiriCountsReported deleteAggregationInterval](self, "deleteAggregationInterval");
  -[ODMSiriSchemaODMSiriCountsReported siriCounts](self, "siriCounts");
  ...
  -[ODMSiriSchemaODMSiriCountsReported setSiriCounts:](self, "setSiriCounts:", v10);
...
{
  -[ODMSiriSchemaODMSiriCountsReported setAggregationInterval:](self, "setAggregationInterval:", 0);
}

- (void)clearSiriCounts
{
  -[NSArray removeAllObjects](self->_siriCounts, "removeAllObjects");
}
...
- (void)addSiriCounts:(id)a3
{
  ...
  -[NSArray addObject:](siriCounts, "addObject:", v4);

}

- (unint64_t)siriCountsCount
{
  return -[NSArray count](self->_siriCounts, "count");
}

- (id)siriCountsAtIndex:(unint64_t)a3
{
  return -[NSArray objectAtIndexedSubscript:](self->_siriCounts, "objectAtIndexedSubscript:", a3);
}
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_siriCounts, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_siriCounts, "count"))
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v16 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("siriCounts"));
  }
...
- (NSData)jsonData
{
  ...
  -[ODMSiriSchemaODMSiriCountsReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODMSiriSchemaODMSiriCountsReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODMSiriSchemaODMSiriCountsReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODMSiriSchemaODMSiriCountsReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ODMSiriSchemaODMSiriCounts *v15;
  ODMSiriSchemaODMSiriCountsReported *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ODMSiriSchemaODMSiriCountsReported init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODMSiriSchemaODMSiriCountsReported setAggregationInterval:](v5, "setAggregationInterval:", v7);

    }
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("siriCounts"));
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ODMSiriSchemaODMSiriCounts initWithDictionary:]([ODMSiriSchemaODMSiriCounts alloc], "initWithDictionary:", v14);
              -[ODMSiriSchemaODMSiriCountsReported addSiriCounts:](v5, "addSiriCounts:", v15);
