...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[TTMSchemaTTMRequestEnded results](self, "results", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[TTMSchemaTTMRequestEnded setResults:](self, "setResults:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[TTMSchemaTTMRequestEnded results](self, "results");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[TTMSchemaTTMRequestEnded dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (TTMSchemaTTMRequestEnded)initWithJSON:(id)a3
{
  ...
  {
    self = -[TTMSchemaTTMRequestEnded initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (TTMSchemaTTMRequestEnded)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  TTMSchemaTTMTCUResult *v13;
  TTMSchemaTTMTCUResult *v14;
  TTMSchemaTTMRequestEnded *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[TTMSchemaTTMRequestEnded init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[TTMSchemaTTMTCUResult initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v17);
              -[TTMSchemaTTMRequestEnded addResults:](v5, "addResults:", v14);
