...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[CNVSchemaCNVExecutionCommitContext contextId](self, "contextId");
  ...
  if (v8)
    -[CNVSchemaCNVExecutionCommitContext deleteContextId](self, "deleteContextId");
  -[CNVSchemaCNVExecutionCommitContext startedOrChanged](self, "startedOrChanged");
  ...
  if (v11)
    -[CNVSchemaCNVExecutionCommitContext deleteStartedOrChanged](self, "deleteStartedOrChanged");
  -[CNVSchemaCNVExecutionCommitContext ended](self, "ended");
  ...
  if (v14)
    -[CNVSchemaCNVExecutionCommitContext deleteEnded](self, "deleteEnded");
  -[CNVSchemaCNVExecutionCommitContext hypothesisId](self, "hypothesisId");
  ...
  if (v17)
    -[CNVSchemaCNVExecutionCommitContext deleteHypothesisId](self, "deleteHypothesisId");
...
{
  -[CNVSchemaCNVExecutionCommitContext setContextId:](self, "setContextId:", 0);
}

- (void)setStartedOrChanged:(id)a3
{
  CNVSchemaCNVExecutionCommitStarted *v4;
  CNVSchemaCNVExecutionCommitEnded *ended;
  CNVSchemaCNVExecutionCommitStarted *startedOrChanged;

  v4 = (CNVSchemaCNVExecutionCommitStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
...
- (CNVSchemaCNVExecutionCommitStarted)startedOrChanged
{
  if (self->_whichContextevent == 2)
    ...
    return (CNVSchemaCNVExecutionCommitStarted *)0;
}
...
- (void)setEnded:(id)a3
{
  CNVSchemaCNVExecutionCommitEnded *v4;
  CNVSchemaCNVExecutionCommitStarted *startedOrChanged;
  unint64_t v6;
  CNVSchemaCNVExecutionCommitEnded *ended;

  v4 = (CNVSchemaCNVExecutionCommitEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (CNVSchemaCNVExecutionCommitEnded)ended
{
  if (self->_whichContextevent == 3)
    ...
    return (CNVSchemaCNVExecutionCommitEnded *)0;
}
...
{
  -[CNVSchemaCNVExecutionCommitContext setHypothesisId:](self, "setHypothesisId:", 0);
}
...
- (unint64_t)hash
{
  ...
  v4 = -[CNVSchemaCNVExecutionCommitStarted hash](self->_startedOrChanged, "hash") ^ v3;
  v5 = -[CNVSchemaCNVExecutionCommitEnded hash](self->_ended, "hash");
...
- (NSData)jsonData
{
  ...
  -[CNVSchemaCNVExecutionCommitContext dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  CNVSchemaCNVExecutionCommitContext *v5;
  uint64_t v7;
  ...
  {
    self = -[CNVSchemaCNVExecutionCommitContext initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (CNVSchemaCNVExecutionCommitContext)initWithDictionary:(id)a3
{
  ...
  SISchemaUUID *v7;
  void *v8;
  CNVSchemaCNVExecutionCommitStarted *v9;
  void *v10;
  CNVSchemaCNVExecutionCommitEnded *v11;
  void *v12;
  SISchemaUUID *v13;
  CNVSchemaCNVExecutionCommitContext *v14;
  objc_super v16;

  v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)CNVSchemaCNVExecutionCommitContext;
  v5 = -[CNVSchemaCNVExecutionCommitContext init](&v16, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CNVSchemaCNVExecutionCommitContext setContextId:](v5, "setContextId:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v9 = -[CNVSchemaCNVExecutionCommitStarted initWithDictionary:]([CNVSchemaCNVExecutionCommitStarted alloc], "initWithDictionary:", v8);
      -[CNVSchemaCNVExecutionCommitContext setStartedOrChanged:](v5, "setStartedOrChanged:", v9);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v11 = -[CNVSchemaCNVExecutionCommitEnded initWithDictionary:]([CNVSchemaCNVExecutionCommitEnded alloc], "initWithDictionary:", v10);
      -[CNVSchemaCNVExecutionCommitContext setEnded:](v5, "setEnded:", v11);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CNVSchemaCNVExecutionCommitContext setHypothesisId:](v5, "setHypothesisId:", v13);
