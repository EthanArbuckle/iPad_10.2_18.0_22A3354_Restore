...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ASRSchemaASRSampledAudioFileEnqueueFailed originalAsrId](self, "originalAsrId", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[ASRSchemaASRSampledAudioFileEnqueueFailed deleteOriginalAsrId](self, "deleteOriginalAsrId");
  return v5;
}
...
{
  -[ASRSchemaASRSampledAudioFileEnqueueFailed setOriginalAsrId:](self, "setOriginalAsrId:", 0);
}
...
{
  -[ASRSchemaASRSampledAudioFileEnqueueFailed setErrorCode:](self, "setErrorCode:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[ASRSchemaASRSampledAudioFileEnqueueFailed setErrorDomain:](self, "setErrorDomain:", 0);
}
...
{
  -[ASRSchemaASRSampledAudioFileEnqueueFailed setUnderlyingErrorCode:](self, "setUnderlyingErrorCode:", 0);
  *(_BYTE *)&self->_has &= ~2u;
}
...
{
  -[ASRSchemaASRSampledAudioFileEnqueueFailed setUnderlyingErrorDomain:](self, "setUnderlyingErrorDomain:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  v9 = a3;
  -[ASRSchemaASRSampledAudioFileEnqueueFailed originalAsrId](self, "originalAsrId");
  ...
  -[ASRSchemaASRSampledAudioFileEnqueueFailed errorDomain](self, "errorDomain");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
    PBDataWriterWriteInt32Field();
  -[ASRSchemaASRSampledAudioFileEnqueueFailed underlyingErrorDomain](self, "underlyingErrorDomain");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[ASRSchemaASRSampledAudioFileEnqueueFailed errorCode](self, "errorCode"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[ASRSchemaASRSampledAudioFileEnqueueFailed underlyingErrorCode](self, "underlyingErrorCode"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[ASRSchemaASRSampledAudioFileEnqueueFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ASRSchemaASRSampledAudioFileEnqueueFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[ASRSchemaASRSampledAudioFileEnqueueFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ASRSchemaASRSampledAudioFileEnqueueFailed)initWithDictionary:(id)a3
{
  ...
  void *v12;
  void *v13;
  ASRSchemaASRSampledAudioFileEnqueueFailed *v14;
  objc_super v16;

  v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)ASRSchemaASRSampledAudioFileEnqueueFailed;
  v5 = -[ASRSchemaASRSampledAudioFileEnqueueFailed init](&v16, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ASRSchemaASRSampledAudioFileEnqueueFailed setOriginalAsrId:](v5, "setOriginalAsrId:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ASRSchemaASRSampledAudioFileEnqueueFailed setErrorCode:](v5, "setErrorCode:", objc_msgSend(v8, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ASRSchemaASRSampledAudioFileEnqueueFailed setErrorDomain:](v5, "setErrorDomain:", v10);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[ASRSchemaASRSampledAudioFileEnqueueFailed setUnderlyingErrorCode:](v5, "setUnderlyingErrorCode:", objc_msgSend(v11, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ASRSchemaASRSampledAudioFileEnqueueFailed setUnderlyingErrorDomain:](v5, "setUnderlyingErrorDomain:", v13);
