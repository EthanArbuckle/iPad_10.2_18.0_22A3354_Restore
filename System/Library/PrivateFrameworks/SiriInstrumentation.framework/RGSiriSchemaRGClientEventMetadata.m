...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)RGSiriSchemaRGClientEventMetadata;
  v4 = a3;
  -[SISchemaInstrumentationMessage applySensitiveConditionsPolicy:](&v9, sel_applySensitiveConditionsPolicy_, v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[RGSiriSchemaRGClientEventMetadata ifRequestId](self, "ifRequestId", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[RGSiriSchemaRGClientEventMetadata deleteIfRequestId](self, "deleteIfRequestId");
  return v5;
}
...
{
  -[RGSiriSchemaRGClientEventMetadata setIfRequestId:](self, "setIfRequestId:", 0);
}
...
{
  -[RGSiriSchemaRGClientEventMetadata setPostingSpanId:](self, "setPostingSpanId:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[RGSiriSchemaRGClientEventMetadata ifRequestId](self, "ifRequestId");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[RGSiriSchemaRGClientEventMetadata postingSpanId](self, "postingSpanId"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[RGSiriSchemaRGClientEventMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RGSiriSchemaRGClientEventMetadata *v5;
  uint64_t v7;
  ...
  {
    self = -[RGSiriSchemaRGClientEventMetadata initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RGSiriSchemaRGClientEventMetadata)initWithDictionary:(id)a3
{
  ...
  SISchemaUUID *v7;
  void *v8;
  RGSiriSchemaRGClientEventMetadata *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RGSiriSchemaRGClientEventMetadata;
  v5 = -[RGSiriSchemaRGClientEventMetadata init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[RGSiriSchemaRGClientEventMetadata setIfRequestId:](v5, "setIfRequestId:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RGSiriSchemaRGClientEventMetadata setPostingSpanId:](v5, "setPostingSpanId:", objc_msgSend(v8, "unsignedLongLongValue"));
    v9 = v5;
