...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported fixedDimensions](self, "fixedDimensions");
  ...
  if (v8)
    -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported deleteFixedDimensions](self, "deleteFixedDimensions");
  -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported digests](self, "digests");
  ...
  -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported setDigests:](self, "setDigests:", v10);
...
{
  -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported setFixedDimensions:](self, "setFixedDimensions:", 0);
}
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigest *v15;
  ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported setFixedDimensions:](v5, "setFixedDimensions:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigest initWithDictionary:]([ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigest alloc], "initWithDictionary:", v14);
              -[ODDSiriSchemaODDAssistantDiagnosticAndUsageOptInDigestsReported addDigests:](v5, "addDigests:", v15);
