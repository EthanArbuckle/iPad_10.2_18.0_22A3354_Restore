...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ODDSiriSchemaODDDictationDeviceDigestsReported fixedDimensions](self, "fixedDimensions");
  ...
  if (v8)
    -[ODDSiriSchemaODDDictationDeviceDigestsReported deleteFixedDimensions](self, "deleteFixedDimensions");
  -[ODDSiriSchemaODDDictationDeviceDigestsReported digests](self, "digests");
  ...
  -[ODDSiriSchemaODDDictationDeviceDigestsReported setDigests:](self, "setDigests:", v10);
...
{
  -[ODDSiriSchemaODDDictationDeviceDigestsReported setFixedDimensions:](self, "setFixedDimensions:", 0);
}
...
- (NSData)jsonData
{
  ...
  -[ODDSiriSchemaODDDictationDeviceDigestsReported dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ODDSiriSchemaODDDictationDeviceDigestsReported *v5;
  uint64_t v7;
  ...
  {
    self = -[ODDSiriSchemaODDDictationDeviceDigestsReported initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ODDSiriSchemaODDDictationDeviceDigestsReported)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  ODDSiriSchemaODDDictationDigest *v15;
  ODDSiriSchemaODDDictationDeviceDigestsReported *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[ODDSiriSchemaODDDictationDeviceDigestsReported init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ODDSiriSchemaODDDictationDeviceDigestsReported setFixedDimensions:](v5, "setFixedDimensions:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[ODDSiriSchemaODDDictationDigest initWithDictionary:]([ODDSiriSchemaODDDictationDigest alloc], "initWithDictionary:", v14);
              -[ODDSiriSchemaODDDictationDeviceDigestsReported addDigests:](v5, "addDigests:", v15);
