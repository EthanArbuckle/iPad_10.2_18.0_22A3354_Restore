...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (objc_msgSend(v4, "isConditionSet:", 2))
    -[SUGSchemaSUGSuggestionsUIActivityTier1 deleteSuggestions](self, "deleteSuggestions");
  ...
  if (objc_msgSend(v4, "isConditionSet:", 7))
    -[SUGSchemaSUGSuggestionsUIActivityTier1 deleteSuggestions](self, "deleteSuggestions");
  -[SUGSchemaSUGSuggestionsUIActivityTier1 linkId](self, "linkId");
  ...
  if (v8)
    -[SUGSchemaSUGSuggestionsUIActivityTier1 deleteLinkId](self, "deleteLinkId");
  -[SUGSchemaSUGSuggestionsUIActivityTier1 suggestions](self, "suggestions");
  ...
  -[SUGSchemaSUGSuggestionsUIActivityTier1 setSuggestions:](self, "setSuggestions:", v10);
...
- (void)deleteLinkId
{
  -[SUGSchemaSUGSuggestionsUIActivityTier1 setLinkId:](self, "setLinkId:", 0);
}
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_suggestions, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_suggestions, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("suggestions"));
  }
...
- (NSData)jsonData
{
  ...
  -[SUGSchemaSUGSuggestionsUIActivityTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  SUGSchemaSUGSuggestionsUIActivityTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[SUGSchemaSUGSuggestionsUIActivityTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (SUGSchemaSUGSuggestionsUIActivityTier1)initWithDictionary:(id)a3
{
  ...
  uint64_t v13;
  uint64_t v14;
  SUGSchemaSUGSuggestionTier1 *v15;
  SUGSchemaSUGSuggestionsUIActivityTier1 *v16;
  void *v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[SUGSchemaSUGSuggestionsUIActivityTier1 init](&v23, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[SUGSchemaSUGSuggestionsUIActivityTier1 setLinkId:](v5, "setLinkId:", v7);
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v15 = -[SUGSchemaSUGSuggestionTier1 initWithDictionary:]([SUGSchemaSUGSuggestionTier1 alloc], "initWithDictionary:", v14);
              -[SUGSchemaSUGSuggestionsUIActivityTier1 addSuggestions:](v5, "addSuggestions:", v15);
