...
{
  -[RGSiriSchemaRGOverrideFailed setFatalError:](self, "setFatalError:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    -[RGSiriSchemaRGOverrideFailed fatalError](self, "fatalError");
...
- (NSData)jsonData
{
  ...
  -[RGSiriSchemaRGOverrideFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RGSiriSchemaRGOverrideFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[RGSiriSchemaRGOverrideFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RGSiriSchemaRGOverrideFailed)initWithDictionary:(id)a3
{
  ...
  RGSiriSchemaRGOverrideFailed *v5;
  void *v6;
  RGSiriSchemaRGOverrideFailed *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)RGSiriSchemaRGOverrideFailed;
  v5 = -[RGSiriSchemaRGOverrideFailed init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RGSiriSchemaRGOverrideFailed setFatalError:](v5, "setFatalError:", objc_msgSend(v6, "intValue"));
    v7 = v5;
