...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata ifRequestId](self, "ifRequestId", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata deleteIfRequestId](self, "deleteIfRequestId");
  return v5;
}
...
{
  -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata setIfRequestId:](self, "setIfRequestId:", 0);
}
...
{
  -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata setPostingSpanId:](self, "setPostingSpanId:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata ifRequestId](self, "ifRequestId");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata postingSpanId](self, "postingSpanId"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata *v5;
  uint64_t v7;
  ...
  {
    self = -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata)initWithDictionary:(id)a3
{
  ...
  SISchemaUUID *v7;
  void *v8;
  IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata;
  v5 = -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata setIfRequestId:](v5, "setIfRequestId:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata setPostingSpanId:](v5, "setPostingSpanId:", objc_msgSend(v8, "unsignedLongLongValue"));
    v9 = v5;
