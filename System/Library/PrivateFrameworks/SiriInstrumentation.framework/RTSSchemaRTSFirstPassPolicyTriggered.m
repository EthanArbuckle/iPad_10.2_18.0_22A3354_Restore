...
{
  -[RTSSchemaRTSFirstPassPolicyTriggered setIsReplayModeEnabled:](self, "setIsReplayModeEnabled:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[RTSSchemaRTSFirstPassPolicyTriggered setFirstPassTriggerScore:](self, "setFirstPassTriggerScore:", 0.0);
  *(_BYTE *)&self->_has &= ~2u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    -[RTSSchemaRTSFirstPassPolicyTriggered firstPassTriggerScore](self, "firstPassTriggerScore");
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[RTSSchemaRTSFirstPassPolicyTriggered isReplayModeEnabled](self, "isReplayModeEnabled"));
...
- (NSData)jsonData
{
  ...
  -[RTSSchemaRTSFirstPassPolicyTriggered dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RTSSchemaRTSFirstPassPolicyTriggered *v5;
  uint64_t v7;
  ...
  {
    self = -[RTSSchemaRTSFirstPassPolicyTriggered initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RTSSchemaRTSFirstPassPolicyTriggered)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  RTSSchemaRTSFirstPassPolicyTriggered *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)RTSSchemaRTSFirstPassPolicyTriggered;
  v5 = -[RTSSchemaRTSFirstPassPolicyTriggered init](&v10, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RTSSchemaRTSFirstPassPolicyTriggered setIsReplayModeEnabled:](v5, "setIsReplayModeEnabled:", objc_msgSend(v6, "BOOLValue"));
