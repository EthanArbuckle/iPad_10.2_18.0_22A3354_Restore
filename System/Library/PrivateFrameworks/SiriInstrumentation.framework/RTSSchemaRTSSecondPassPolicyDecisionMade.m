...
{
  -[RTSSchemaRTSSecondPassPolicyDecisionMade setIsSecondPassTriggered:](self, "setIsSecondPassTriggered:", 0);
  *(&self->_isReplayModeEnabled + 1) &= ~1u;
}
...
{
  -[RTSSchemaRTSSecondPassPolicyDecisionMade setSpeakingProbability:](self, "setSpeakingProbability:", 0.0);
  *(&self->_isReplayModeEnabled + 1) &= ~2u;
}
...
{
  -[RTSSchemaRTSSecondPassPolicyDecisionMade setProcessedAudioDurationInMs:](self, "setProcessedAudioDurationInMs:", 0.0);
  *(&self->_isReplayModeEnabled + 1) &= ~4u;
}
...
{
  -[RTSSchemaRTSSecondPassPolicyDecisionMade setIsReplayModeEnabled:](self, "setIsReplayModeEnabled:", 0);
  *(&self->_isReplayModeEnabled + 1) &= ~8u;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 8) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[RTSSchemaRTSSecondPassPolicyDecisionMade isReplayModeEnabled](self, "isReplayModeEnabled"));
...
LABEL_9:
      ...
      -[RTSSchemaRTSSecondPassPolicyDecisionMade processedAudioDurationInMs](self, "processedAudioDurationInMs");
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[RTSSchemaRTSSecondPassPolicyDecisionMade isSecondPassTriggered](self, "isSecondPassTriggered"));
...
LABEL_5:
    ...
    -[RTSSchemaRTSSecondPassPolicyDecisionMade speakingProbability](self, "speakingProbability");
...
- (NSData)jsonData
{
  ...
  -[RTSSchemaRTSSecondPassPolicyDecisionMade dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RTSSchemaRTSSecondPassPolicyDecisionMade *v5;
  uint64_t v7;
  ...
  {
    self = -[RTSSchemaRTSSecondPassPolicyDecisionMade initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RTSSchemaRTSSecondPassPolicyDecisionMade)initWithDictionary:(id)a3
{
  ...
  void *v8;
  void *v9;
  RTSSchemaRTSSecondPassPolicyDecisionMade *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)RTSSchemaRTSSecondPassPolicyDecisionMade;
  v5 = -[RTSSchemaRTSSecondPassPolicyDecisionMade init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RTSSchemaRTSSecondPassPolicyDecisionMade setIsSecondPassTriggered:](v5, "setIsSecondPassTriggered:", objc_msgSend(v6, "BOOLValue"));
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RTSSchemaRTSSecondPassPolicyDecisionMade setIsReplayModeEnabled:](v5, "setIsReplayModeEnabled:", objc_msgSend(v9, "BOOLValue"));
    v10 = v5;
