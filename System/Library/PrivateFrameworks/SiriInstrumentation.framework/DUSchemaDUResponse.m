...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[DUSchemaDUResponse assetIdentifier](self, "assetIdentifier", v9.receiver, v9.super_class);
  ...
  if ((_DWORD)v4)
    -[DUSchemaDUResponse deleteAssetIdentifier](self, "deleteAssetIdentifier");
  return v5;
}
...
- (void)deleteStatus
{
  -[DUSchemaDUResponse setStatus:](self, "setStatus:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[DUSchemaDUResponse setAssetIdentifier:](self, "setAssetIdentifier:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[DUSchemaDUResponse assetIdentifier](self, "assetIdentifier");
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[SISchemaUUID hash](self->_assetIdentifier, "hash") ^ v2;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_assetIdentifier)
  {
    ...
    if (v5)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("assetIdentifier"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("assetIdentifier"));

    }
  }
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if (-[DUSchemaDUResponse status](self, "status") == 1)
      v7 = CFSTR("FAILED");
    else
      v7 = CFSTR("SUCCESS");
...
- (NSData)jsonData
{
  ...
  -[DUSchemaDUResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (DUSchemaDUResponse)initWithJSON:(id)a3
{
  ...
  {
    self = -[DUSchemaDUResponse initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (DUSchemaDUResponse)initWithDictionary:(id)a3
{
  ...
  void *v7;
  SISchemaUUID *v8;
  DUSchemaDUResponse *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)DUSchemaDUResponse;
  v5 = -[DUSchemaDUResponse init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[DUSchemaDUResponse setStatus:](v5, "setStatus:", objc_msgSend(v6, "intValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[DUSchemaDUResponse setAssetIdentifier:](v5, "setAssetIdentifier:", v8);
