...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[JRSchemaRankingCandidateTuple candidateIds](self, "candidateIds", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[JRSchemaRankingCandidateTuple setCandidateIds:](self, "setCandidateIds:", v7);
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[JRSchemaRankingCandidateTuple candidateIds](self, "candidateIds");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[JRSchemaRankingCandidateTuple dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  JRSchemaRankingCandidateTuple *v5;
  uint64_t v7;
  ...
  {
    self = -[JRSchemaRankingCandidateTuple initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (JRSchemaRankingCandidateTuple)initWithDictionary:(id)a3
{
  ...
  SISchemaUUID *v13;
  SISchemaUUID *v14;
  JRSchemaRankingCandidateTuple *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v5 = -[JRSchemaRankingCandidateTuple init](&v21, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[JRSchemaRankingCandidateTuple addCandidateIds:](v5, "addCandidateIds:", v14);
