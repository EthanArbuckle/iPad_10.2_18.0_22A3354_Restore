...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[RRSchemaRREntityPoolReturned candidateEntities](self, "candidateEntities", v9.receiver, v9.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[RRSchemaRREntityPoolReturned setCandidateEntities:](self, "setCandidateEntities:", v7);
  return v5;
}
...
{
  -[RRSchemaRREntityPoolReturned setEntityCount:](self, "setEntityCount:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[RRSchemaRREntityPoolReturned candidateEntities](self, "candidateEntities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[RRSchemaRREntityPoolReturned entityCount](self, "entityCount"));
...
- (NSData)jsonData
{
  ...
  -[RRSchemaRREntityPoolReturned dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RRSchemaRREntityPoolReturned *v5;
  uint64_t v7;
  ...
  {
    self = -[RRSchemaRREntityPoolReturned initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RRSchemaRREntityPoolReturned)initWithDictionary:(id)a3
{
  ...
  void *v15;
  RRSchemaRREntityPoolReturned *v16;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[RRSchemaRREntityPoolReturned init](&v22, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[RRSchemaRREntityPoolReturned addCandidateEntities:](v5, "addCandidateEntities:", v14);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RRSchemaRREntityPoolReturned setEntityCount:](v5, "setEntityCount:", objc_msgSend(v15, "unsignedIntValue"));
    v16 = v5;
