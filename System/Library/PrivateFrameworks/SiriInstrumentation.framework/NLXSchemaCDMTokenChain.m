...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[NLXSchemaCDMTokenChain tokens](self, "tokens", v11.receiver, v11.super_class);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[NLXSchemaCDMTokenChain setTokens:](self, "setTokens:", v7);

  -[NLXSchemaCDMTokenChain asrHypothesisId](self, "asrHypothesisId");
  ...
  if ((_DWORD)v4)
    -[NLXSchemaCDMTokenChain deleteAsrHypothesisId](self, "deleteAsrHypothesisId");
  return v5;
}
...
{
  -[NLXSchemaCDMTokenChain setAsrHypothesisId:](self, "setAsrHypothesisId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[NLXSchemaCDMTokenChain asrHypothesisId](self, "asrHypothesisId", v12);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[NLXSchemaCDMTokenChain tokens](self, "tokens");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[NLXSchemaCDMTokenChain asrHypothesisId](self, "asrHypothesisId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "asrHypothesisId");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((v5 == 0) != (v6 != 0))
  {
    -[NLXSchemaCDMTokenChain asrHypothesisId](self, "asrHypothesisId");
...
- (unint64_t)hash
{
  ...
  return -[SISchemaUUID hash](self->_asrHypothesisId, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_asrHypothesisId)
  {
    ...
    if (v5)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("asrHypothesisId"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("asrHypothesisId"));
  ...
  if (-[NSArray count](self->_tokens, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("tokens"));
  }
...
- (NSData)jsonData
{
  ...
  -[NLXSchemaCDMTokenChain dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (NLXSchemaCDMTokenChain)initWithJSON:(id)a3
{
  ...
  {
    self = -[NLXSchemaCDMTokenChain initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (NLXSchemaCDMTokenChain)initWithDictionary:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  NLXSchemaCDMToken *v13;
  NLXSchemaCDMToken *v14;
  void *v15;
  SISchemaUUID *v16;
  NLXSchemaCDMTokenChain *v17;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  __int128 v22;
  ...
  v5 = -[NLXSchemaCDMTokenChain init](&v23, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v14 = -[NLXSchemaCDMToken initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v19);
              -[NLXSchemaCDMTokenChain addTokens:](v5, "addTokens:", v14);
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("asrHypothesisId"), (_QWORD)v19);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v16 = -[SISchemaUUID initWithDictionary:]([SISchemaUUID alloc], "initWithDictionary:", v15);
      -[NLXSchemaCDMTokenChain setAsrHypothesisId:](v5, "setAsrHypothesisId:", v16);
...
{
  objc_storeStrong((id *)&self->_asrHypothesisId, a3);
}
