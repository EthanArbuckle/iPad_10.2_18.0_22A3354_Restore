...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[ASRSchemaASRClientEventMetadata asrId](self, "asrId");
  ...
  if (v8)
    -[ASRSchemaASRClientEventMetadata deleteAsrId](self, "deleteAsrId");
  -[ASRSchemaASRClientEventMetadata requestId](self, "requestId");
  ...
  if (v11)
    -[ASRSchemaASRClientEventMetadata deleteRequestId](self, "deleteRequestId");
...
- (void)deleteAsrId
{
  -[ASRSchemaASRClientEventMetadata setAsrId:](self, "setAsrId:", 0);
}
...
{
  -[ASRSchemaASRClientEventMetadata setRequestId:](self, "setRequestId:", 0);
}
...
- (NSData)jsonData
{
  ...
  -[ASRSchemaASRClientEventMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  ASRSchemaASRClientEventMetadata *v5;
  uint64_t v7;
  ...
  {
    self = -[ASRSchemaASRClientEventMetadata initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (ASRSchemaASRClientEventMetadata)initWithDictionary:(id)a3
{
  ...
  void *v8;
  SISchemaUUID *v9;
  ASRSchemaASRClientEventMetadata *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)ASRSchemaASRClientEventMetadata;
  v5 = -[ASRSchemaASRClientEventMetadata init](&v12, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ASRSchemaASRClientEventMetadata setAsrId:](v5, "setAsrId:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[ASRSchemaASRClientEventMetadata setRequestId:](v5, "setRequestId:", v9);
