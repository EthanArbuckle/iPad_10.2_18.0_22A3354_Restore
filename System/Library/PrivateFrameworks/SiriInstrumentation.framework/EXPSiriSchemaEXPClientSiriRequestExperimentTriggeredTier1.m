...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 allocations](self, "allocations");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SISchemaInstrumentationMessage _pruneSuppressedMessagesFromArray:underConditions:](self, "_pruneSuppressedMessagesFromArray:underConditions:", v6, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 setAllocations:](self, "setAllocations:", v7);

  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 codepathId](self, "codepathId");
  ...
  if (v10)
    -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 deleteCodepathId](self, "deleteCodepathId");
  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 requestId](self, "requestId");
  ...
  if (v13)
    -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 deleteRequestId](self, "deleteRequestId");
...
{
  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 setCodepathId:](self, "setCodepathId:", 0);
}
...
{
  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 setRequestId:](self, "setRequestId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 codepathId](self, "codepathId", v14);
...
- (unint64_t)hash
{
  ...
  return v4 ^ -[SISchemaUUID hash](self->_requestId, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_requestId)
  {
    ...
    if (v16)
    {
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v16, CFSTR("requestId"));
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99E38], "null");
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKeyedSubscript:", v17, CFSTR("requestId"));
...
- (NSData)jsonData
{
  ...
  -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1)initWithDictionary:(id)a3
{
  ...
  void *v17;
  SISchemaUUID *v18;
  EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *v19;
  __int128 v21;
  __int128 v22;
  __int128 v23;
  __int128 v24;
  ...
  v5 = -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 init](&v25, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 addAllocation:](v5, "addAllocation:", v14);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 setCodepathId:](v5, "setCodepathId:", v16);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 setRequestId:](v5, "setRequestId:", v18);
