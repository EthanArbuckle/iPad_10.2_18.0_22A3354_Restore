...
{
  -[MTSchemaMTError setErrorDomain:](self, "setErrorDomain:", 0);
}
...
{
  -[MTSchemaMTError setErrorMessage:](self, "setErrorMessage:", 0);
}
...
{
  -[MTSchemaMTError setErrorCode:](self, "setErrorCode:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[MTSchemaMTError errorDomain](self, "errorDomain");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[MTSchemaMTError errorMessage](self, "errorMessage");
...
- (unint64_t)hash
{
  ...
  v4 = -[NSString hash](self->_errorMessage, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[MTSchemaMTError errorCode](self, "errorCode"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSData)jsonData
{
  ...
  -[MTSchemaMTError dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (MTSchemaMTError)initWithJSON:(id)a3
{
  ...
  {
    self = -[MTSchemaMTError initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (MTSchemaMTError)initWithDictionary:(id)a3
{
  ...
  v5 = -[MTSchemaMTError init](&v13, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTError setErrorDomain:](v5, "setErrorDomain:", v7);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[MTSchemaMTError setErrorMessage:](v5, "setErrorMessage:", v9);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[MTSchemaMTError setErrorCode:](v5, "setErrorCode:", objc_msgSend(v10, "intValue"));
    v11 = v5;
