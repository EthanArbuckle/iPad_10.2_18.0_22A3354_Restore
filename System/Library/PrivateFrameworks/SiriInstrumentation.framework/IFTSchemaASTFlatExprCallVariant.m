...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  if (v6)
    -[IFTSchemaASTFlatExprCallVariant deleteToolId](self, "deleteToolId");
  return v5;
}
...
- (void)deleteExists
{
  -[IFTSchemaASTFlatExprCallVariant setExists:](self, "setExists:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)deleteToolId
{
  -[IFTSchemaASTFlatExprCallVariant setToolId:](self, "setToolId:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[IFTSchemaASTFlatExprCallVariant toolId](self, "toolId");
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSString hash](self->_toolId, "hash") ^ v2;
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[IFTSchemaASTFlatExprCallVariant exists](self, "exists"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (self->_toolId)
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("toolId"));
...
- (NSData)jsonData
{
  ...
  -[IFTSchemaASTFlatExprCallVariant dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  IFTSchemaASTFlatExprCallVariant *v5;
  uint64_t v7;
  ...
  {
    self = -[IFTSchemaASTFlatExprCallVariant initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (IFTSchemaASTFlatExprCallVariant)initWithDictionary:(id)a3
{
  ...
  void *v7;
  void *v8;
  IFTSchemaASTFlatExprCallVariant *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)IFTSchemaASTFlatExprCallVariant;
  v5 = -[IFTSchemaASTFlatExprCallVariant init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[IFTSchemaASTFlatExprCallVariant setExists:](v5, "setExists:", objc_msgSend(v6, "BOOLValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[IFTSchemaASTFlatExprCallVariant setToolId:](v5, "setToolId:", v8);
