...
- (FAUpdateFamilyMemberFlagsRequest)initWithFamilyMemberDSID:(id)a3 flags:(id)a4
{
  id v7;
  id v8;
  FAUpdateFamilyMemberFlagsRequest *v9;
  FAUpdateFamilyMemberFlagsRequest *v10;
  objc_super v12;
...
- (void)startRequestWithCompletionHandler:(id)a3
{
  ...
  v13[1] = 3221225472;
  v13[2] = __70__FAUpdateFamilyMemberFlagsRequest_startRequestWithCompletionHandler___block_invoke;
  v13[3] = &unk_1E8561870;
  v6 = v4;
  v14 = v6;
  ...
  v11[0] = v5;
  v11[1] = 3221225472;
  v11[2] = __70__FAUpdateFamilyMemberFlagsRequest_startRequestWithCompletionHandler___block_invoke_24;
  v11[3] = &unk_1E8561988;
  v12 = v6;
  v10 = v6;
  objc_msgSend(v7, "updateFamilyMemberFlagsWithDSID:flags:replyBlock:", dsid, flags, v11);
...
void __70__FAUpdateFamilyMemberFlagsRequest_startRequestWithCompletionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    v5 = 138412290;
    v6 = v3;
    _os_log_impl(&dword_1CAEBA000, v4, OS_LOG_TYPE_DEFAULT, "FAUpdateFamilyMemberFlagsRequest: Error from service - %@", (uint8_t *)&v5, 0xCu);
  }

  (*(void (**)(void))(*(_QWORD *)(a1 + 32) + 16))();
}

uint64_t __70__FAUpdateFamilyMemberFlagsRequest_startRequestWithCompletionHandler___block_invoke_24(uint64_t a1)
{
