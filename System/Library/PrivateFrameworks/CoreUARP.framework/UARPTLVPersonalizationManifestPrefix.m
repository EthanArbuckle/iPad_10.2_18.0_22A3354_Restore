...
{
  UARPTLVPersonalizationManifestPrefix *v4;
  uint64_t v5;
...
- (id)description
{
  ...
  objc_msgSend(v4, "stringWithFormat:", CFSTR("<%@: %@>"), v5, self->_ticketPrefix);
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationManifestPrefix tlvType](UARPTLVPersonalizationManifestPrefix, "tlvType");
  ticketPrefix = self->_ticketPrefix;
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationManifestPrefix;
...
- (id)tlvValue
{
  ...
  ticketPrefix = self->_ticketPrefix;
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationManifestPrefix;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationManifestPrefix tlvType](UARPTLVPersonalizationManifestPrefix, "tlvType"));
