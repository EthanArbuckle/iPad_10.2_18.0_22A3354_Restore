...
{
  UARPTLVPersonalizationSuperBinaryAssetID *obj;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationSuperBinaryAssetID tlvType](UARPTLVPersonalizationSuperBinaryAssetID, "tlvType");
  v4 = *((unsigned __int16 *)&self->super.super._tlvLength + 2);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationSuperBinaryAssetID;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationSuperBinaryAssetID;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationSuperBinaryAssetID tlvType](UARPTLVPersonalizationSuperBinaryAssetID, "tlvType"));
