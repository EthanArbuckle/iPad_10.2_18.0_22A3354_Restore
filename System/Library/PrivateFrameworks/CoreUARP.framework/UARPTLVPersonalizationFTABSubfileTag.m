...
- (void)setTag:(id)a3
{
  UARPTLVPersonalizationFTABSubfileTag *v4;
  uint64_t v5;
  UARPAssetTag *tag;
  id v7;
...
- (id)generateTLV
{
  ...
  v8 = uarpHtonl(+[UARPTLVPersonalizationFTABSubfileTag tlvType](UARPTLVPersonalizationFTABSubfileTag, "tlvType"));
  objc_msgSend(v3, "appendBytes:length:", &v8, 4);
  v7 = uarpHtonl(4u);
  objc_msgSend(v3, "appendBytes:length:", &v7, 4);
  -[UARPTLVPersonalizationFTABSubfileTag tlvValue](self, "tlvValue");
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationFTABSubfileTag tlvType](UARPTLVPersonalizationFTABSubfileTag, "tlvType"));
