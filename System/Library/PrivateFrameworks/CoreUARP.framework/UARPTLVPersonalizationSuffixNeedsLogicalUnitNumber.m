...
{
  UARPTLVPersonalizationSuffixNeedsLogicalUnitNumber *obj;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumber tlvType](UARPTLVPersonalizationSuffixNeedsLogicalUnitNumber, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationSuffixNeedsLogicalUnitNumber;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationSuffixNeedsLogicalUnitNumber;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumber tlvType](UARPTLVPersonalizationSuffixNeedsLogicalUnitNumber, "tlvType"));
