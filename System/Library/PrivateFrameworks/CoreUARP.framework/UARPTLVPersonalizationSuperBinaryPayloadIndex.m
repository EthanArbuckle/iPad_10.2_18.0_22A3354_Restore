...
{
  UARPTLVPersonalizationSuperBinaryPayloadIndex *obj;
...
- (id)description
{
  ...
  objc_msgSend(v4, "stringWithFormat:", CFSTR("<%@: %u>"), v5, *(&self->super.super._tlvLength + 1));
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationSuperBinaryPayloadIndex tlvType](UARPTLVPersonalizationSuperBinaryPayloadIndex, "tlvType");
  v4 = *(&self->super.super._tlvLength + 1);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationSuperBinaryPayloadIndex;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationSuperBinaryPayloadIndex;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationSuperBinaryPayloadIndex tlvType](UARPTLVPersonalizationSuperBinaryPayloadIndex, "tlvType"));
