...
{
  UARPSupportedAccessoryA2049Simulated *v2;
  void *v3;
  void *v4;
  void *v5;
  ...
  if (v2)
  {
    +[UARPSupportedAccessoryA2049Simulated appleModelNumber](UARPSupportedAccessoryA2049Simulated, "appleModelNumber");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    -[UARPSupportedAccessory setAppleModelNumber:](v2, "setAppleModelNumber:", v3);

    +[UARPSupportedAccessoryA2049Simulated modelName](UARPSupportedAccessoryA2049Simulated, "modelName");
    ...
    v6 = -[UARPAccessoryHardwareUSB initWithVendorID:productID:]([UARPAccessoryHardwareUSB alloc], "initWithVendorID:productID:", +[UARPSupportedAccessoryA2049Simulated vendorID](UARPSupportedAccessoryA2049Simulated, "vendorID"), +[UARPSupportedAccessoryA2049Simulated productID](UARPSupportedAccessoryA2049Simulated, "productID"));
    hwID = v2->hwID;
    v2->hwID = v6;
...
+ (unsigned)productID
{
  return +[UARPSupportedAccessoryA2049 productID](UARPSupportedAccessoryA2049, "productID");
}
