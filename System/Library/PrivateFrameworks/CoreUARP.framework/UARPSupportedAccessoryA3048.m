...
{
  UARPSupportedAccessoryA3048 *v2;
  void *v3;
  void *v4;
  uint64_t v5;
  uint64_t v6;
  ...
  if (v2)
  {
    +[UARPSupportedAccessoryA3048 appleModelNumber](UARPSupportedAccessoryA3048, "appleModelNumber");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    -[UARPSupportedAccessory setAppleModelNumber:](v2, "setAppleModelNumber:", v3);

    -[UARPSupportedAccessory setModelName:](v2, "setModelName:", CFSTR("AirPods Pro 2 (USB-C)"));
    v14 = 0u;
    v15 = 0u;
    v12 = 0u;
    v13 = 0u;
    +[UARPSupportedAccessoryA3048 alternativeAppleModelNumbers](UARPSupportedAccessoryA3048, "alternativeAppleModelNumbers", 0);
...
{
  return (id)objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", CFSTR("A3047"), CFSTR("A3049"), 0);
}
