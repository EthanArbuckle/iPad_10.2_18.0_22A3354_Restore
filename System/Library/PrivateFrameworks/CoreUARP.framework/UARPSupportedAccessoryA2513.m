...
{
  UARPSupportedAccessoryA2513 *v2;
  void *v3;
  void *v4;
  uint64_t v5;
  uint64_t v6;
  ...
  if (v2)
  {
    +[UARPSupportedAccessoryA2513 appleModelNumber](UARPSupportedAccessoryA2513, "appleModelNumber");
    ...
    -[UARPSupportedAccessory setSupportsVoiceAssist:](v2, "setSupportsVoiceAssist:", 1);
    -[UARPSupportedAccessory addSupplementalAssetName:](v2, "addSupplementalAssetName:", CFSTR("VoiceAssist"));
    v14 = 0u;
    v15 = 0u;
    v12 = 0u;
    v13 = 0u;
    +[UARPSupportedAccessoryA2513 alternativeAppleModelNumbers](UARPSupportedAccessoryA2513, "alternativeAppleModelNumbers", 0);
...
{
  return (id)objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", CFSTR("A2512"), 0);
}
