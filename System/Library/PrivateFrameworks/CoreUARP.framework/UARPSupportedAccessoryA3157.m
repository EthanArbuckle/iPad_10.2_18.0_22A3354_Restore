...
{
  UARPSupportedAccessoryA3157 *v2;
  void *v3;
  void *v4;
  uint64_t v5;
  uint64_t v6;
  ...
  if (v2)
  {
    +[UARPSupportedAccessoryA3157 appleModelNumber](UARPSupportedAccessoryA3157, "appleModelNumber");
    ...
    v12 = 0u;
    v13 = 0u;
    +[UARPSupportedAccessoryA3157 alternativeAppleModelNumbers](UARPSupportedAccessoryA3157, "alternativeAppleModelNumbers", 0);
...
{
  return (id)objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", CFSTR("A3158"), CFSTR("A3159"), 0);
}
