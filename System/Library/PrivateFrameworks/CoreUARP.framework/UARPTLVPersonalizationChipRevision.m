...
{
  UARPTLVPersonalizationChipRevision *obj;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationChipRevision tlvType](UARPTLVPersonalizationChipRevision, "tlvType");
  v4 = *(&self->super.super._tlvLength + 1);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationChipRevision;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationChipRevision;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationChipRevision tlvType](UARPTLVPersonalizationChipRevision, "tlvType"));
