...
- (void)initWithContentsOfURL:.cold.1()
{
  ...
  v2 = 136315650;
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_1_2(&dword_212D08000, v0, v1, "%s: Unable to open file at %@ (%@)", v2);
...
- (void)createFileHandleForWritingToURL:(void *)a1 .cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_2(&dword_212D08000, v2, v3, "Unable to create file at %@", v4, v5, v6, v7, v8);
...
- (void)createFileHandleForWritingToURL:(void *)a1 .cold.3(void *a1)
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_2(&dword_212D08000, v2, v3, "Unable to delete file at %@", v4, v5, v6, v7, v8);
...
{
  OUTLINED_FUNCTION_0_0(&dword_212D08000, a1, a3, "Failed to write FTAB header", a5, a6, a7, a8, 0);
}
...
- (void)writeToURL:(void *)a1 .cold.1(void *a1)
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_2(&dword_212D08000, v2, v3, "Failed to open file handle for writing to '%@'", v4, v5, v6, v7, v8);
...
- (void)writeSubfileToURL:tag:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_1(&dword_212D08000, v0, v1, "Unable to locate subfile with tag '%@'", v2);
  OUTLINED_FUNCTION_1();
}
