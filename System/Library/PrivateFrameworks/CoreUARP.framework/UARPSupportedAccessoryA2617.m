...
{
  UARPSupportedAccessoryA2617 *v2;
  void *v3;
  void *v4;
  void *v5;
  uint64_t v6;
  ...
  v2 = -[UARPSupportedAccessoryAirPodsCase init](&v17, sel_init);
  if (v2)
  {
    +[UARPSupportedAccessoryA2617 appleModelNumber](UARPSupportedAccessoryA2617, "appleModelNumber");
    ...
    v13 = 0u;
    v14 = 0u;
    +[UARPSupportedAccessoryA2617 alternativeAppleModelNumbers](UARPSupportedAccessoryA2617, "alternativeAppleModelNumbers", 0);
...
{
  return (id)objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", CFSTR("A2617"), 0);
}
