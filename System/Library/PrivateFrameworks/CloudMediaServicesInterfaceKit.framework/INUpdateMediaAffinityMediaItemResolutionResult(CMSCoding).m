...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BDDA2B0], "unsupported");
        v16 = objc_claimAutoreleasedReturnValue();
      }
      goto LABEL_32;
    }
    ...
    if (v14)
    {
      objc_msgSend(MEMORY[0x24BDDA2B0], "needsValue");
    ...
    else
    {
      ...
      {
        v19.receiver = a1;
        v19.super_class = (Class)&off_2553BA780;
...
LABEL_33:
        ...
        v16 = objc_msgSend(objc_alloc(MEMORY[0x24BDDA2B0]), "initWithMediaItemResolutionResult:", v9);
LABEL_32:
        v13 = (void *)v16;
        goto LABEL_33;
      }
      objc_msgSend(MEMORY[0x24BDDA2B0], "notRequired");
      v15 = objc_claimAutoreleasedReturnValue();
    }
    v13 = (void *)v15;
LABEL_34:
