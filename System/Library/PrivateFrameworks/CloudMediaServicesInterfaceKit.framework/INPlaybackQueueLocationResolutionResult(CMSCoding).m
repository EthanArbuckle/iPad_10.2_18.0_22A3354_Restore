...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      objc_msgSend(v5, "cmsOptionalStringForKey:", CFSTR("resolvedQueueLocation"));
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = INPlaybackQueueLocationFromString(v7);

      objc_msgSend(MEMORY[0x24BDD9F88], "successWithResolvedPlaybackQueueLocation:", v8);
...
LABEL_15:
    ...
    if (v10)
    {
      objc_msgSend(v10, "cmsOptionalStringForKey:", CFSTR("playbackQueueLocationToConfirm"));
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      v13 = INPlaybackQueueLocationFromString(v12);

      objc_msgSend(MEMORY[0x24BDD9F88], "confirmationRequiredWithPlaybackQueueLocationToConfirm:", v13);
    ...
    else
    {
      ...
      if (v15)
      {
        objc_msgSend(MEMORY[0x24BDD9F88], "unsupported");
        v14 = objc_claimAutoreleasedReturnValue();
      }
      else
      {
        ...
        if (v16)
        {
          objc_msgSend(MEMORY[0x24BDD9F88], "needsValue");
          v14 = objc_claimAutoreleasedReturnValue();
        }
        else
        {
...
LABEL_14:
          ...
          objc_msgSend(MEMORY[0x24BDD9F88], "notRequired");
          v14 = objc_claimAutoreleasedReturnValue();
        }
      }
    }
