...
- (void)validateWithCompletion:(id)a3
{
  ...
  v15 = getHKHealthChecklistUtilitiesClass_softClass;
  ...
  v8 = objc_msgSend(v7, "isHealthChecklistAvailable");

  v9 = v8 ^ -[TPSTargetingValidation BOOLValue](self, "BOOLValue") ^ 1;
  objc_msgSend(MEMORY[0x1E0DBF3D0], "targeting");
  v10 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    -[TPSHealthChecklistAvailableValidation validateWithCompletion:].cold.1(self, v9, v10);
