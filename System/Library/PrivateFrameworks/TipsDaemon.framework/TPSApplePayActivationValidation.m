...
- (void)validateWithCompletion:(id)a3
{
  ...
  v5 = -[TPSApplePayActivationValidation getCurrentState](self, "getCurrentState");
...
- (BOOL)getCurrentState
{
  ...
  v11 = getPKPassLibraryClass_softClass_0;
  ...
  v5 = objc_msgSend(v4, "isPaymentPassActivationAvailable");
