...
{
  TPSAppEntityCondition *v2;
  TPSAppEntityCondition *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TPSAppEntityCondition;
  v2 = -[TPSAppEntityCondition init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[TPSCondition setType:](v2, "setType:", 13);
  return v3;
}
...
void __48__TPSAppEntityCondition__valuesFromValuesArray___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    v4 = -[TPSAppEntity initWithDictionary:]([TPSAppEntity alloc], "initWithDictionary:", v3);
...
{
  id v3;
  TPSAppEntityValidation *v4;

  v3 = a2;
  v4 = -[TPSAppEntityValidation initWithAppEntity:]([TPSAppEntityValidation alloc], "initWithAppEntity:", v3);
...
void __48__TPSAppEntityCondition__valuesFromValuesArray___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_1DAC2F000, a2, OS_LOG_TYPE_ERROR, "Unexpected value for app entity condition: %@", (uint8_t *)&v2, 0xCu);
}
