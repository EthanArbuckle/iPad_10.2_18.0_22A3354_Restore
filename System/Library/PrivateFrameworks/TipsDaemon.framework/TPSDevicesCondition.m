...
{
  TPSDevicesCondition *v2;
  TPSDevicesCondition *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TPSDevicesCondition;
  v2 = -[TPSDevicesCondition init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[TPSCondition setType:](v2, "setType:", 5);
  return v3;
}
...
{
  id v3;
  TPSDeviceValidation *v4;
  void *v5;
  void *v6;
  TPSDeviceValidation *v7;
  ...
  v7 = -[TPSDeviceValidation initWithTargetDevices:excludeDevices:](v4, "initWithTargetDevices:excludeDevices:", v5, v6);
