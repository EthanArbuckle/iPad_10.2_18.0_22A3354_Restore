...
{
  id v3;
  TPSSiriLanguageValidation *v4;
  void *v5;
  void *v6;
  TPSSiriLanguageValidation *v7;
  ...
  v7 = -[TPSSiriLanguageValidation initWithTargetLanguages:excludeLanguages:](v4, "initWithTargetLanguages:excludeLanguages:", v5, v6);
...
{
  TPSSiriLanguagesCondition *v2;
  TPSSiriLanguagesCondition *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TPSSiriLanguagesCondition;
  v2 = -[TPSSiriLanguagesCondition init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[TPSCondition setType:](v2, "setType:", 10);
  return v3;
}
