    ...
    if (v7)
    {
      ...
      while (2)
      {
        for (i = 0; i != v7; i = ((char *)i + 1))
        {
          ...
          if (+[TPSKeyboardUtilities isHandwritingEnabledForInputMode:](TPSKeyboardUtilities, "isHandwritingEnabledForInputMode:", v10, (_QWORD)v13))
          {
            ...
            if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412290;
              v18 = v10;
              _os_log_impl(&dword_1DAC2F000, v7, OS_LOG_TYPE_DEFAULT, "Handwriting keyboard enabled: %@", buf, 0xCu);
            }
