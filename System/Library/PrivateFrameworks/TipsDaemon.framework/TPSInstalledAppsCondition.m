...
{
  TPSInstalledAppsCondition *v2;
  TPSInstalledAppsCondition *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TPSInstalledAppsCondition;
  v2 = -[TPSInstalledAppsCondition init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[TPSCondition setType:](v2, "setType:", 4);
  return v3;
}
...
{
  id v3;
  TPSInstalledAppsValidation *v4;

  v3 = a2;
  v4 = -[TPSInstalledAppsValidation initWithInstalledAppInfo:]([TPSInstalledAppsValidation alloc], "initWithInstalledAppInfo:", v3);
...
void __52__TPSInstalledAppsCondition__valuesFromValuesArray___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_1DAC2F000, a2, OS_LOG_TYPE_ERROR, "Unexpected value for installedapp condition: %@", (uint8_t *)&v2, 0xCu);
}
