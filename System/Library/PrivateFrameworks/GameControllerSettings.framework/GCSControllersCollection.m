...
- (GCSControllersCollection)initWithSettingsStore:(id)a3 userDefaults:(id)a4
{
  id v6;
  id v7;
  GCSControllersCollection *v8;
  GCSControllersCollection *v9;
  id WeakRetained;
  char isKindOfClass;
  id v12;
  objc_super v14;
  ...
  v8 = -[GCSControllersCollection init](&v14, sel_init);
  v9 = v8;
  if (v8)
  {
    objc_storeWeak((id *)&v8->_settingsStore, v6);
    objc_storeStrong((id *)&v9->_userDefaults, a4);
    -[GCUserDefaults addObserver:forKeyPath:options:context:](v9->_userDefaults, "addObserver:forKeyPath:options:context:", v9, CFSTR("controllers"), 5, 0);
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        objc_msgSend(v9, "persistentIdentifier", (_QWORD)v13);
...
- (void)updateControllers:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0
    && -[GCSControllersCollection storeVersionIsCompatible](self, "storeVersionIsCompatible"))
  {
    ...
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v13 = -[GCSController initWithJSONObject:](v12, "initWithJSONObject:", v11, (_QWORD)v17);
      ...
      -[GCSControllersCollection setValues:](self, "setValues:", v6);
      getGCSLogger();
      v14 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        -[GCSControllersCollection values](self, "values");
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        *(_DWORD *)buf = 138412290;
        v23 = v15;
        _os_log_impl(&dword_2159AA000, v14, OS_LOG_TYPE_INFO, "GCSControllersCollection.values = %@", buf, 0xCu);
  ...
  {
    -[GCSControllersCollection setValues:](self, "setValues:", MEMORY[0x24BDBD1A8]);
    getGCSLogger();
    v5 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v23 = v16;
      _os_log_impl(&dword_2159AA000, v5, OS_LOG_TYPE_INFO, "GCSControllersCollection.values = %@", buf, 0xCu);
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  v11 = a4;
  v12 = a5;
  if (objc_msgSend(v10, "isEqualToString:", CFSTR("controllers")))
  {
  ...
  else
  {
    if (!objc_msgSend(v10, "isEqualToString:", CFSTR("settingsVersion")))
    {
      ...
      -[GCSControllersCollection observeValueForKeyPath:ofObject:change:context:](&v15, sel_observeValueForKeyPath_ofObject_change_context_, v10, v11, v12, a6);
      goto LABEL_7;
    }
    -[GCUserDefaults objectForKey:](self->_userDefaults, "objectForKey:", CFSTR("controllers"));
    v13 = objc_claimAutoreleasedReturnValue();
  }
  v14 = (void *)v13;
  -[GCSControllersCollection updateControllers:](self, "updateControllers:", v13);
...
- (void)dealloc
{
  ...
  -[GCUserDefaults removeObserver:forKeyPath:context:](self->_userDefaults, "removeObserver:forKeyPath:context:", self, CFSTR("controllers"), 0);
  WeakRetained = objc_loadWeakRetained((id *)&self->_settingsStore);
  objc_opt_class();
  isKindOfClass = objc_opt_isKindOfClass();
  ...
  -[GCSControllersCollection dealloc](&v6, sel_dealloc);
}
