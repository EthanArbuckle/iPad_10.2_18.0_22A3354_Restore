...
- (void)addNetworks:(id)a3
{
  ...
  -[NSMutableArray addObject:](networks, "addObject:", v4);

}

- (unint64_t)networksCount
{
  return -[NSMutableArray count](self->_networks, "count");
}

- (id)networksAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_networks, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[VGChargingNetworksStorage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VGChargingNetworksStorage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_networks, "count"))
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_networks, "count"));
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("networks"));
  }
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_usesPreferredNetworksForRouting);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v11, CFSTR("usesPreferredNetworksForRouting"));
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[VGChargingNetworksStorage networksCount](self, "networksCount"))
  {
    objc_msgSend(v8, "clearNetworks");
    v4 = -[VGChargingNetworksStorage networksCount](self, "networksCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[VGChargingNetworksStorage networksAtIndex:](self, "networksAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addNetworks:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addNetworks:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_6;
  networks = self->_networks;
  if ((unint64_t)networks | *((_QWORD *)v4 + 1))
  {
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_networks, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[VGChargingNetworksStorage addNetworks:](self, "addNetworks:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
  ...
  if ((*((_BYTE *)v4 + 20) & 1) != 0)
  {
    self->_usesPreferredNetworksForRouting = *((_BYTE *)v4 + 16);
    *(_BYTE *)&self->_has |= 1u;
  }
