...
- (id)description
{
  ...
  -[_MRSetVolumeMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRSetVolumeMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (unint64_t)hash
{
  ...
  v8 = -[NSString hash](self->_outputDeviceUID, "hash") ^ v3;
  return v8 ^ -[_MRRequestDetailsProtobuf hash](self->_details, "hash");
}
