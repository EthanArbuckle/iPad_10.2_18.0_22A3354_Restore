...
- (id)description
{
  ...
  -[_MRUpdateContentItemMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRUpdateContentItemMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[_MRUpdateContentItemMessageProtobuf contentItemsCount](self, "contentItemsCount"))
  {
    objc_msgSend(v8, "clearContentItems");
    v4 = -[_MRUpdateContentItemMessageProtobuf contentItemsCount](self, "contentItemsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[_MRUpdateContentItemMessageProtobuf contentItemsAtIndex:](self, "contentItemsAtIndex:", i);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v13 != v8)
          objc_enumerationMutation(v5);
        -[_MRUpdateContentItemMessageProtobuf addContentItems:](self, "addContentItems:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
