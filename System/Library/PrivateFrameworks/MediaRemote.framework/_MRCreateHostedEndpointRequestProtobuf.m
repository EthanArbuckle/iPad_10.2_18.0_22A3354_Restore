...
- (id)description
{
  ...
  -[_MRCreateHostedEndpointRequestProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRCreateHostedEndpointRequestProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[_MRCreateHostedEndpointRequestProtobuf outputDeviceUIDsCount](self, "outputDeviceUIDsCount"))
  {
    objc_msgSend(v8, "clearOutputDeviceUIDs");
    v4 = -[_MRCreateHostedEndpointRequestProtobuf outputDeviceUIDsCount](self, "outputDeviceUIDsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[_MRCreateHostedEndpointRequestProtobuf outputDeviceUIDsAtIndex:](self, "outputDeviceUIDsAtIndex:", i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)outputDeviceUIDs | v4[1])
      v6 = -[NSMutableArray isEqual:](outputDeviceUIDs, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_outputDeviceUIDs, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[_MRCreateHostedEndpointRequestProtobuf addOutputDeviceUIDs:](self, "addOutputDeviceUIDs:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
