@implementation MRMediaRemoteSetClientProperties

uint64_t __MRMediaRemoteSetClientProperties_block_invoke(_QWORD *a1, uint64_t a2)
{
  uint64_t v4;
  NSObject *v5;
  NSObject *v6;
