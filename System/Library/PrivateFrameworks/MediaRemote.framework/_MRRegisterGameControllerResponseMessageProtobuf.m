...
- (id)description
{
  ...
  -[_MRRegisterGameControllerResponseMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRRegisterGameControllerResponseMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)a3 + 1) = self->_controllerID;
    *((_BYTE *)a3 + 16) |= 1u;
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)result + 1) = self->_controllerID;
    *((_BYTE *)result + 16) |= 1u;
  }
  return result;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) != 0 && self->_controllerID == *((_QWORD *)v4 + 1))
    {
      v5 = 1;
      goto LABEL_7;
    }
...
- (void)mergeFrom:(id)a3
{
  if ((*((_BYTE *)a3 + 16) & 1) != 0)
  {
    self->_controllerID = *((_QWORD *)a3 + 1);
    *(_BYTE *)&self->_has |= 1u;
  }
}
