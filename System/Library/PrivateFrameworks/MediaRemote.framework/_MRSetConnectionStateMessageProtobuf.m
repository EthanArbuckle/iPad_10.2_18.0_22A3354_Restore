...
- (id)description
{
  ...
  -[_MRSetConnectionStateMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRSetConnectionStateMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
