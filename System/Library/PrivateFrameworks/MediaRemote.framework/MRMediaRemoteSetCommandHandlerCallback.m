@implementation MRMediaRemoteSetCommandHandlerCallback
...
void __MRMediaRemoteSetCommandHandlerCallback_block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  v4 = -[MRCommandResult initWithHandlerStatuses:sendError:]([MRCommandResult alloc], "initWithHandlerStatuses:sendError:", a3, a2);
