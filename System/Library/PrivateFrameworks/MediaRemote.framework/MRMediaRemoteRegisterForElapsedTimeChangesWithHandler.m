@implementation MRMediaRemoteRegisterForElapsedTimeChangesWithHandler
...
void __MRMediaRemoteRegisterForElapsedTimeChangesWithHandler_block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    {
      *(_WORD *)v4 = 0;
      _os_log_impl(&dword_193827000, v3, OS_LOG_TYPE_DEFAULT, "Registered for elapsed time changes.", v4, 2u);
    }
...
void __MRMediaRemoteRegisterForElapsedTimeChangesWithHandler_block_invoke_2(uint64_t a1, int a2)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_193827000, v4, OS_LOG_TYPE_DEFAULT, "Got elapsed time change.", buf, 2u);
  }
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    (*(void (**)(double))(*(_QWORD *)(a1 + 32) + 16))(*(double *)&state64);
  }
}
