@implementation MRMediaRemoteGetAppsSupportingBrowsableContentAPIs

uint64_t __MRMediaRemoteGetAppsSupportingBrowsableContentAPIs_block_invoke(_QWORD *a1, uint64_t a2, uint64_t a3)
{
  uint64_t v6;
  NSObject *v7;
  NSObject *v8;
