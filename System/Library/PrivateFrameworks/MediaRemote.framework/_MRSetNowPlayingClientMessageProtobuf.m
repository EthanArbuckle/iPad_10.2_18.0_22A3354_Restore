...
- (id)description
{
  ...
  -[_MRSetNowPlayingClientMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRSetNowPlayingClientMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
