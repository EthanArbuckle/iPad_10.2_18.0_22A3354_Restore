...
- (id)description
{
  ...
  -[_MRSetRecordingStateMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRSetRecordingStateMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
