...
- (id)description
{
  ...
  -[_MRSetNowPlayingPlayerMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRSetNowPlayingPlayerMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
