@implementation MRMediaRemoteRegisterForRepeatModeChangesWithHandler
...
void __MRMediaRemoteRegisterForRepeatModeChangesWithHandler_block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    {
      *(_WORD *)v4 = 0;
      _os_log_impl(&dword_193827000, v3, OS_LOG_TYPE_DEFAULT, "Registered for repeat mode changes.", v4, 2u);
    }
...
void __MRMediaRemoteRegisterForRepeatModeChangesWithHandler_block_invoke_2(uint64_t a1, int a2)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_193827000, v4, OS_LOG_TYPE_DEFAULT, "Got repeat mode change.", buf, 2u);
  }
