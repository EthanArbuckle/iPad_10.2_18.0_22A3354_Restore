...
- (id)description
{
  ...
  -[_MRPlayerClientParticipantsUpdateMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRPlayerClientParticipantsUpdateMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_participants, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("participants"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[_MRPlayerClientParticipantsUpdateMessageProtobuf participantsCount](self, "participantsCount"))
  {
    objc_msgSend(v8, "clearParticipants");
    v4 = -[_MRPlayerClientParticipantsUpdateMessageProtobuf participantsCount](self, "participantsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[_MRPlayerClientParticipantsUpdateMessageProtobuf participantsAtIndex:](self, "participantsAtIndex:", i);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addParticipants:", v13);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[_MRNowPlayingPlayerPathProtobuf isEqual:](playerPath, "isEqual:")))
  {
    ...
    if ((unint64_t)participants | v4[1])
      v7 = -[NSMutableArray isEqual:](participants, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_participants, "hash") ^ v3;
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[_MRPlayerClientParticipantsUpdateMessageProtobuf addParticipants:](self, "addParticipants:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
