...
+ (id)rowWithType:(id)a3 titleOverride:(id)a4 identifier:(id)a5
{
  ...
  id v8;
  id v9;
  MRMediaControlsCustomRow *v10;

  v7 = a5;
  v8 = a4;
  v9 = a3;
  v10 = objc_alloc_init(MRMediaControlsCustomRow);
  -[MRMediaControlsCustomRow setType:](v10, "setType:", v9);

  -[MRMediaControlsCustomRow setTitleOverride:](v10, "setTitleOverride:", v8);
  -[MRMediaControlsCustomRow setIdentifier:](v10, "setIdentifier:", v7);
...
- (MRMediaControlsCustomRow)initWithCoder:(id)a3
{
  ...
  uint64_t v11;
  NSString *identifier;
  MRMediaControlsCustomRow *v13;
  objc_super v15;

  v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)MRMediaControlsCustomRow;
  v5 = -[MRMediaControlsCustomRow init](&v15, sel_init);
  if (v5)
  {
...
{
  +[MRMediaControlsCustomRow rowWithType:titleOverride:identifier:](MRMediaControlsCustomRow, "rowWithType:titleOverride:identifier:", self->_type, self->_titleOverride, self->_identifier);
  return (id)objc_claimAutoreleasedReturnValue();
}

- (BOOL)isEqual:(id)a3
{
  MRMediaControlsCustomRow *v4;
  MRMediaControlsCustomRow *v5;
  void *v6;
  int v7;
  void *v8;
  ...
  v4 = (MRMediaControlsCustomRow *)a3;
  if (self == v4)
  {
    LOBYTE(v11) = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      -[MRMediaControlsCustomRow type](v5, "type");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      v7 = objc_msgSend(v6, "isEqual:", self->_type);

      -[MRMediaControlsCustomRow titleOverride](v5, "titleOverride");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      v9 = v7 & objc_msgSend(v8, "isEqualToString:", self->_titleOverride);

      -[MRMediaControlsCustomRow identifier](v5, "identifier");
