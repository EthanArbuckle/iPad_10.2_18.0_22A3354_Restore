@implementation MRMediaRemoteBrowsableContentSupportsPlaybackProgress

uint64_t __MRMediaRemoteBrowsableContentSupportsPlaybackProgress_block_invoke(_QWORD *a1, uint64_t a2)
{
  void *v4;
  uint64_t v5;
  NSObject *v6;
