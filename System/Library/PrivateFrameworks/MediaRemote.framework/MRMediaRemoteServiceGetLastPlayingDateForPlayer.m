@implementation MRMediaRemoteServiceGetLastPlayingDateForPlayer
...
void __MRMediaRemoteServiceGetLastPlayingDateForPlayer_block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeIntervalSinceReferenceDate:", xpc_dictionary_get_double(v3, "MRXPC_TIMESTAMP"));
