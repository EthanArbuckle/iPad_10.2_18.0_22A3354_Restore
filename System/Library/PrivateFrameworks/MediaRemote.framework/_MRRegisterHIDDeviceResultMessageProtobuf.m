...
- (id)description
{
  ...
  -[_MRRegisterHIDDeviceResultMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRRegisterHIDDeviceResultMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_deviceIdentifier);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("deviceIdentifier"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_errorCode != *((_DWORD *)v4 + 3))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_deviceIdentifier != *((_DWORD *)v4 + 2))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
