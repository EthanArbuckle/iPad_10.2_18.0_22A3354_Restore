...
- (id)description
{
  ...
  -[_MRSendPackedVirtualTouchEventMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRSendPackedVirtualTouchEventMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
