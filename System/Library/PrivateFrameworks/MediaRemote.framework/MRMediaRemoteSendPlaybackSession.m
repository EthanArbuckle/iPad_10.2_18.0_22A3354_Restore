@implementation MRMediaRemoteSendPlaybackSession
...
void __MRMediaRemoteSendPlaybackSession_block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    ...
    v33 = 2048;
    v34 = v14;
    _os_log_error_impl(&dword_193827000, v9, OS_LOG_TYPE_ERROR, "Response: %{public}@<%{public}@> returned with error <%{public}@> for %{public}@ in %.4lf seconds", (uint8_t *)&v25, 0x34u);
LABEL_13:
...
LABEL_14:
  ...
  if (v22)
  {
    if (v6)
    {
      (*(void (**)(_QWORD, _QWORD, id))(v22 + 16))(*(_QWORD *)(a1 + 56), *(_QWORD *)(a1 + 40), v6);
    }
    else
    {
...
void __MRMediaRemoteSendPlaybackSession_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4();
  objc_msgSend(*(id *)(v1 + 40), "requestID");
