...
{
  -[NSMutableArray removeAllObjects](self->_supportedFormats, "removeAllObjects");
}
...
- (void)addSupportedFormats:(id)a3
{
  ...
  -[NSMutableArray addObject:](supportedFormats, "addObject:", v4);

}

- (unint64_t)supportedFormatsCount
{
  return -[NSMutableArray count](self->_supportedFormats, "count");
}

- (id)supportedFormatsAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_supportedFormats, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[_MRVoiceInputDeviceDescriptorProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRVoiceInputDeviceDescriptorProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_supportedFormats, "count"))
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_supportedFormats, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("supportedFormats"));
  }
  defaultFormat = self->_defaultFormat;
  if (defaultFormat)
  {
    -[_MRAudioFormatSettingsProtobuf dictionaryRepresentation](defaultFormat, "dictionaryRepresentation");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v12, CFSTR("defaultFormat"));
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[_MRVoiceInputDeviceDescriptorProtobuf supportedFormatsCount](self, "supportedFormatsCount"))
  {
    objc_msgSend(v8, "clearSupportedFormats");
    v4 = -[_MRVoiceInputDeviceDescriptorProtobuf supportedFormatsCount](self, "supportedFormatsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[_MRVoiceInputDeviceDescriptorProtobuf supportedFormatsAtIndex:](self, "supportedFormatsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addSupportedFormats:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addSupportedFormats:", v11);
  ...
  v12 = -[_MRAudioFormatSettingsProtobuf copyWithZone:](self->_defaultFormat, "copyWithZone:", a3);
  v13 = (void *)v5[1];
  v5[1] = v12;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](supportedFormats, "isEqual:")))
  {
    ...
    if ((unint64_t)defaultFormat | v4[1])
      v7 = -[_MRAudioFormatSettingsProtobuf isEqual:](defaultFormat, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_supportedFormats, "hash");
  return -[_MRAudioFormatSettingsProtobuf hash](self->_defaultFormat, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v13 != v8)
          objc_enumerationMutation(v5);
        -[_MRVoiceInputDeviceDescriptorProtobuf addSupportedFormats:](self, "addSupportedFormats:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
...
{
  objc_storeStrong((id *)&self->_supportedFormats, a3);
}
...
{
  objc_storeStrong((id *)&self->_defaultFormat, a3);
}
