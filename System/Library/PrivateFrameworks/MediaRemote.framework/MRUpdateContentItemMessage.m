...
- (MRUpdateContentItemMessage)initWithContentItems:(id)a3 forPlayerPath:(id)a4 encoding:(int64_t)a5
{
  id v8;
  id v9;
  MRUpdateContentItemMessage *v10;
  _MRUpdateContentItemMessageProtobuf *v11;
  void *v12;
  void *v13;
  id v14;
  uint64_t v15;
  ...
  if (v10)
  {
    ...
    -[_MRUpdateContentItemMessageProtobuf setPlayerPath:](v11, "setPlayerPath:", v13);
    ...
    if (v15)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[_MRUpdateContentItemMessageProtobuf addContentItems:](v11, "addContentItems:", v19);
...
- (NSArray)contentItems
{
  ...
  objc_msgSend(v3, "mr_map:", &__block_literal_global_7);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
