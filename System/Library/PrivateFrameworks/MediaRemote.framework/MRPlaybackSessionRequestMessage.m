...
- (MRPlaybackSessionRequestMessage)initWithRequest:(id)a3 forPlayerPath:(id)a4
{
  id v6;
  id v7;
  MRPlaybackSessionRequestMessage *v8;
  _MRPlaybackSessionRequestMessageProtobuf *v9;
  void *v10;
  void *v11;
  objc_super v13;
  ...
  if (v8)
  {
    ...
    -[_MRPlaybackSessionRequestMessageProtobuf setRequest:](v9, "setRequest:", v10);

    objc_msgSend(v7, "protobuf");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[_MRPlaybackSessionRequestMessageProtobuf setPlayerPath:](v9, "setPlayerPath:", v11);
