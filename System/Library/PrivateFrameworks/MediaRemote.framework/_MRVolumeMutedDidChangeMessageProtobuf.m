...
- (id)description
{
  ...
  -[_MRVolumeMutedDidChangeMessageProtobuf description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MRVolumeMutedDidChangeMessageProtobuf dictionaryRepresentation](self, "dictionaryRepresentation");
