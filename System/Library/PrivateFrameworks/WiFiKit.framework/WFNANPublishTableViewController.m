...
- (void)viewDidLoad
{
  ...
  objc_msgSend(v3, "localizedStringForKey:value:table:", CFSTR("kWFLocNANPublish"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
...
id __55__WFNANPublishTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v10 == 1)
  {
    ...
    else
    {
      ...
      objc_msgSend(v46, "localizedStringForKey:value:table:", CFSTR("kWFLocNANNoPublishers"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
  ...
  else
  {
    ...
    if (!objc_msgSend(v7, "row"))
    {
      ...
      objc_msgSend(v41, "localizedStringForKey:value:table:", CFSTR("kWFLocNANServiceName"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
...
LABEL_18:
    ...
    if (objc_msgSend(v7, "row") == 1)
    {
      ...
      objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("kWFLocNANServiceTypeAdaptive"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "localizedStringForKey:value:table:", CFSTR("kWFLocNANServiceTypeRealtime"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v21, "localizedStringForKey:value:table:", CFSTR("kWFLocNANServiceTypeLowLatency"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v22 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_6:
    ...
    if (objc_msgSend(v7, "row") == 2)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v41 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v41, "localizedStringForKey:value:table:", CFSTR("kWFLocNANInstanceName"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v42 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v7, "row") == 3)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v41 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v41, "localizedStringForKey:value:table:", CFSTR("kWFLocNANServiceSpecificInfo"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v42 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v7, "row") == 5)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v41 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v41, "localizedStringForKey:value:table:", CFSTR("kWFLocNANPortNumber"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v42 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v7, "row") == 6)
    {
      ...
      objc_msgSend(v67, "localizedStringForKey:value:table:", CFSTR("kWFLocNANProtocolTypeTCP"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      objc_msgSend(v70, "localizedStringForKey:value:table:", CFSTR("kWFLocNANProtocolTypeUDP"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
    ...
    if (objc_msgSend(v7, "row") == 7)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v41 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v41, "localizedStringForKey:value:table:", CFSTR("kWFLocNANPassphrase"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v42 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)clearInputFields
{
  ...
  self->_instanceName = (NSString *)&stru_24DC36C30;

  serviceSpecificInfo = self->_serviceSpecificInfo;
  self->_serviceSpecificInfo = (NSString *)&stru_24DC36C30;

  self->_isServiceSpecificInfoHex = 1;
  self->_portNumber = (NSString *)&stru_24DC36C30;
  self->_protocolType = 0;
  self->_passphrase = (NSString *)&stru_24DC36C30;
}
