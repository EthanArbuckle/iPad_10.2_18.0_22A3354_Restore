...
id __60__WFNANDataSessionsTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v10)
  {
    ...
    else
    {
      ...
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("kWFLocNANNoActiveDataSessions"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v11, "textLabel");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
