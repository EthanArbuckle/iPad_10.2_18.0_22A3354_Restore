...
+ (id)misDisablePromptOperation
{
  ...
  objc_msgSend(v3, "localizedStringForKey:value:table:", CFSTR("kWFLocDisableMISAlertTitle"), &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  v6 = v5;
  if ((_DWORD)v3)
    v7 = CFSTR("kWFLocDisableMISAlertMessageCH");
  else
    v7 = CFSTR("kWFLocDisableMISAlertMessage");
  ...
  objc_msgSend(v9, "localizedStringForKey:value:table:", CFSTR("kWFLocDisableMISAlertCancelButton"), &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "setObject:forKey:", v10, *MEMORY[0x24BDBD6F0]);

  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "localizedStringForKey:value:table:", CFSTR("kWFLocDisableMISAlertEnableButton"), &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
