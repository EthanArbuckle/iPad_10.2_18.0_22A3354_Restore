...
- (void)viewDidLoad
{
  ...
  -[WFNANTableViewController viewDidLoad](&v8, sel_viewDidLoad);
  ...
  v5 = v4;
  if (IsChinaDevice)
    v6 = CFSTR("kWFLocNAN_CH");
  else
    v6 = CFSTR("kWFLocNAN");
  objc_msgSend(v4, "localizedStringForKey:value:table:", v6, &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFNANTableViewController setTitle:](self, "setTitle:", v7);
...
- (void)_configureDataSource
{
  ...
  v7 = objc_alloc_init(MEMORY[0x24BDF6720]);
...
id __48__WFNANTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v11)
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6E60]), "initWithStyle:reuseIdentifier:", 1, CFSTR("WFNANTableViewTextCellIdentifier"));
  if (v10 == 2)
  {
...
LABEL_15:
    ...
    objc_msgSend(v29, "localizedStringForKey:value:table:", CFSTR("kWFLocNANSubscribers"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
...
LABEL_19:
  ...
  if (v10 == 1)
  {
    ...
    objc_msgSend(v34, "localizedStringForKey:value:table:", CFSTR("kWFLocNANPublishers"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
  ...
  if (!v10 && !objc_msgSend(v5, "row"))
  {
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("kWFLocNANState"), &stru_24DC36C30, CFSTR("WiFiKitUILocalizableStrings"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "textLabel");
