  ...
  if (!v9)
  {
    ...
    if (WFCurrentLogLevel() && v30 && os_log_type_enabled(v30, v31))
    {
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_impl(&dword_219FC8000, v30, v31, "%s: nil network", buf, 0xCu);
    }
...
LABEL_17:
  objc_msgSend(v18, "localizedStringForKey:value:table:", v20, &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  if (v102)
  {
    ...
    objc_msgSend(v28, "localizedStringForKey:value:table:", v30, &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
    ...
    objc_msgSend(v36, "localizedStringForKey:value:table:", v38, &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  if (v43)
  {
    ...
    else
    {
      ...
      objc_msgSend(gateway, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsProbeNoConnection"), &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  if (v51)
  {
    ...
    else
    {
      ...
      objc_msgSend(internet, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsProbeNoConnection"), &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  if (v59)
  {
    ...
    objc_msgSend(v63, "localizedStringForKey:value:table:", v65, &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  if (v68)
  {
    ...
    objc_msgSend(v70, "localizedStringForKey:value:table:", v72, &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  objc_msgSend(v77, "localizedStringForKey:value:table:", v79, &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
  ...
  if (v82)
  {
    ...
    if (v85 && v86)
    {
      ...
      objc_msgSend(v88, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsLastScan"), &stru_24DC36C30, CFSTR("WiFiKitLocalizableStrings"));
      v97 = v17;
      v89 = v11;
