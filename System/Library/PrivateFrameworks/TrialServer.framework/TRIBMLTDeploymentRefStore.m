...
- (TRIBMLTDeploymentRefStore)initWithServerContext:(id)a3
{
  ...
  v6 = -[TRIBMLTDeploymentRefStore init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (BOOL)hasReferenceToPath:(id)a3
{
  ...
  -[TRINamespaceResolverStorage parentDirForBMLTDeployments](v7, "parentDirForBMLTDeployments");
  ...
  if (v12)
  {
    ...
    if ((unint64_t)objc_msgSend(v13, "count") >= 2)
    {
      ...
      if (objc_msgSend(MEMORY[0x1E0DC0AD0], "convertFromString:usingBase:toI64:", v16, 10, &v23)
        ...
        && v23 <= 0x7FFFFFFF)
      {
        v17 = objc_alloc(MEMORY[0x1E0DC09A8]);
        v18 = (void *)objc_msgSend(v17, "initWithBackgroundMLTaskId:deploymentId:", v15, v23);
        -[TRIServerContext bmltDatabase](self->_context, "bmltDatabase");
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "taskRecordWithTaskDeployment:", v18);
