...
{
  id v5;
  TRIBMLTTaskSupport *v6;
  TRIBMLTTaskSupport *v7;
  _QWORD *v8;
  void *v9;
  void *v10;
  void *v11;
  ...
  v6 = -[TRIBMLTTaskSupport init](&v15, sel_init);
  v7 = v6;
  if (v6)
  {
...
uint64_t __32__TRIBMLTTaskSupport_addMetric___block_invoke(uint64_t a1, _QWORD *a2)
{
  void *v3;
  _QWORD *v5;
  uint64_t v6;
...
uint64_t __35__TRIBMLTTaskSupport_addDimension___block_invoke(uint64_t a1, _QWORD *a2)
{
  void *v3;
  _QWORD *v5;
  uint64_t v6;
...
void __42__TRIBMLTTaskSupport_trialSystemTelemetry__block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 16), "backgroundMLTaskId");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 40), "ensureBMLTFields");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setClientBmltId:", v3);
