...
- (id)description
{
  ...
  -[BLTPBSetNotificationsCriticalAlertRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BLTPBSetNotificationsCriticalAlertRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_criticalAlertSetting);
      v5 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v5 = off_24D762118[criticalAlertSetting];
    }
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("criticalAlertSetting"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_criticalAlertSetting != *((_DWORD *)v4 + 2))
      goto LABEL_9;
  }
