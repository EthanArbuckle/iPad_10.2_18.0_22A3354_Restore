...
- (id)description
{
  ...
  -[BLTPBSetRemoteGlobalSpokenSettingEnabledRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BLTPBSetRemoteGlobalSpokenSettingEnabledRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_settingEnabled);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("settingEnabled"));
  ...
  if ((has & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("settingDate"));
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 1) != 0)
  {
    *((_QWORD *)v4 + 1) = *(_QWORD *)&self->_settingDate;
    v4[20] |= 1u;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((_BYTE *)result + 16) = self->_settingEnabled;
    *((_BYTE *)result + 20) |= 2u;
    has = (char)self->_has;
  }
  if ((has & 1) != 0)
  {
    *((_QWORD *)result + 1) = *(_QWORD *)&self->_settingDate;
    *((_BYTE *)result + 20) |= 1u;
  }
  return result;
}
...
LABEL_10:
  ...
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_settingDate != *((double *)v4 + 1))
      goto LABEL_14;
    v5 = 1;
  }
LABEL_15:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    v2 = 2654435761 * self->_settingEnabled;
    if ((*(_BYTE *)&self->_has & 1) != 0)
      goto LABEL_3;
LABEL_8:
    v7 = 0;
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_settingEnabled = *((_BYTE *)v4 + 16);
    *(_BYTE *)&self->_has |= 2u;
    v5 = *((_BYTE *)v4 + 20);
  }
  if ((v5 & 1) != 0)
  {
    self->_settingDate = *((double *)v4 + 1);
    *(_BYTE *)&self->_has |= 1u;
  }
