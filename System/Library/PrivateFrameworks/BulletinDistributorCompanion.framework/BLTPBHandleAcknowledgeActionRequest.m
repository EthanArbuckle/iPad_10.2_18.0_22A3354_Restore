...
- (id)description
{
  ...
  -[BLTPBHandleAcknowledgeActionRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BLTPBHandleAcknowledgeActionRequest dictionaryRepresentation](self, "dictionaryRepresentation");
