...
- (id)description
{
  ...
  -[CPLSocialGroupPerson description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CPLSocialGroupPerson dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  personIdentifier = self->_personIdentifier;
  if (personIdentifier)
    objc_msgSend(a3, "setPersonIdentifier:", personIdentifier);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)personIdentifier | v4[1])
      v6 = -[NSString isEqual:](personIdentifier, "isEqual:");
    else
      v6 = 1;
  }
  else
