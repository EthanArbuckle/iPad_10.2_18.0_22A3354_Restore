...
- (id)description
{
  ...
  -[CPLMemoryAssetList description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CPLMemoryAssetList dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[CPLMemoryAssetList assetsCount](self, "assetsCount"))
  {
    objc_msgSend(v8, "clearAssets");
    v4 = -[CPLMemoryAssetList assetsCount](self, "assetsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[CPLMemoryAssetList assetAtIndex:](self, "assetAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addAsset:", v7);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[CPLMemoryAssetList addAsset:](self, "addAsset:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
