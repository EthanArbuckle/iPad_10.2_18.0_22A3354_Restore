...
- (id)description
{
  ...
  -[CPLRampingRequestResource description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CPLRampingRequestResource dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_numRequested);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("numRequested"));
...
- (void)copyTo:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)v4 + 1) = self->_numRequested;
    *((_BYTE *)v4 + 24) |= 1u;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v6;
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *(_QWORD *)(v5 + 8) = self->_numRequested;
    *(_BYTE *)(v5 + 24) |= 1u;
  }
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) != 0 && self->_numRequested == *((_QWORD *)v4 + 1))
    {
      v6 = 1;
      goto LABEL_9;
    }
