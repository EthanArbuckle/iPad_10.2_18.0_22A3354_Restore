...
- (id)description
{
  ...
  -[CPLSuggestionPerson description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CPLSuggestionPerson dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_16;
  personIdentifier = self->_personIdentifier;
  if ((unint64_t)personIdentifier | *((_QWORD *)v4 + 3))
  {
