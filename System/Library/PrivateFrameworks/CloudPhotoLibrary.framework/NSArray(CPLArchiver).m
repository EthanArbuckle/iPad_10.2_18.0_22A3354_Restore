    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(*(id *)(*((_QWORD *)&v15 + 1) + 8 * v11), "plistArchiveWithCPLArchiver:", v4, (_QWORD)v15);
...
- (id)initWithCPLArchiver:()CPLArchiver
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    v17 = objc_opt_class();
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, v6, v16, 1023, CFSTR("Invalid %@. Found %@ in archive: '%@'"), v17, objc_opt_class(), v5[2]);
