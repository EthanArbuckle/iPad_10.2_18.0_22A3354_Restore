...
- (id)description
{
  ...
  -[CPLRampingResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CPLRampingResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_responses, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("response"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[CPLRampingResponse responsesCount](self, "responsesCount"))
  {
    objc_msgSend(v8, "clearResponses");
    v4 = -[CPLRampingResponse responsesCount](self, "responsesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[CPLRampingResponse responseAtIndex:](self, "responseAtIndex:", i);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addResponse:", v11);
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_responses, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[CPLRampingResponse addResponse:](self, "addResponse:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
