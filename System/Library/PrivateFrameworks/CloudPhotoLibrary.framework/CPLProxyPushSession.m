...
{
  objc_msgSend(a3, "beginPushSessionWithKnownLibraryVersion:context:completionHandler:", a4, a5, a6);
}
...
- (void)commitChangeBatch:(id)a3 withCompletionHandler:(id)a4
{
  ...
  {
    __CPLProxyPushSessionOSLogDomain();
    v8 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      v16 = v6;
      _os_log_impl(&dword_1B03C2000, v8, OS_LOG_TYPE_DEBUG, "Comitting %@", buf, 0xCu);
    }
    ...
    if (!_CPLSilentLogging)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1B03C2000, v9, OS_LOG_TYPE_DEBUG, "Sending commit message to connection", buf, 2u);
      }
...
void __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  v15[1] = 3221225472;
  v15[2] = __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_2;
  v15[3] = &unk_1E60D7268;
  v16 = *(id *)(a1 + 48);
  ...
  if (v4)
  {
    v13[0] = v2;
    v13[1] = 3221225472;
    v13[2] = __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_1;
    v13[3] = &unk_1E60D7308;
    v5 = *(_QWORD *)(a1 + 40);
    v13[4] = *(_QWORD *)(a1 + 32);
    v14 = *(id *)(a1 + 48);
    objc_msgSend(v4, "commitChangeBatch:withCompletionHandler:", v5, v13);
    v6 = v14;
  }
  else
  {
    ...
    v11[0] = v2;
    v11[1] = 3221225472;
    v11[2] = __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_8;
    v11[3] = &unk_1E60D71F8;
    v12 = *(id *)(a1 + 48);
    v9 = v11;
    block[0] = v2;
...
void __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (!_CPLSilentLogging)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      v5 = 138412290;
      v6 = v3;
      _os_log_impl(&dword_1B03C2000, v4, OS_LOG_TYPE_DEBUG, "Commiting failed with error %@", (uint8_t *)&v5, 0xCu);
    }
...
void __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_1(uint64_t a1, void *a2, uint64_t a3, void *a4, void *a5)
{
  ...
  v21[1] = 3221225472;
  v21[2] = __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_2_2;
  v21[3] = &unk_1E60D72E0;
  v22 = v9;
  v15 = *(id *)(a1 + 40);
  v23 = v10;
...
uint64_t __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_2_2(_QWORD *a1)
{
  NSObject *v2;
  uint64_t v3;
  uint64_t (*v4)(void);
  ...
  if (a1[4])
  {
    if (!_CPLSilentLogging)
    {
      ...
      if (os_log_type_enabled(v2, OS_LOG_TYPE_DEBUG))
      {
        ...
        v8 = 138412290;
        v9 = v3;
        _os_log_impl(&dword_1B03C2000, v2, OS_LOG_TYPE_DEBUG, "Commiting failed with error %@", (uint8_t *)&v8, 0xCu);
      }

    }
    v4 = *(uint64_t (**)(void))(a1[7] + 16);
  }
  else
  {
    if (!_CPLSilentLogging)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
      {
        ...
        v8 = 138412290;
        v9 = v6;
        _os_log_impl(&dword_1B03C2000, v5, OS_LOG_TYPE_DEBUG, "Committing succeeded with new library version: %@", (uint8_t *)&v8, 0xCu);
      }
...
void __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_5(uint64_t a1)
{
  ...
  if (!_CPLSilentLogging)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      v9 = v2;
      _os_log_impl(&dword_1B03C2000, v3, OS_LOG_TYPE_DEBUG, "Commiting failed with error %@", buf, 0xCu);
    }
    ...
    if (!_CPLSilentLogging)
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v12 = 2112;
        v13 = v7;
        _os_log_impl(&dword_1B03C2000, v4, OS_LOG_TYPE_ERROR, "Unable to send batch to daemon for commit: %@\nBatch (estimated size: %@): %@", buf, 0x20u);
...
void __63__CPLProxyPushSession_commitChangeBatch_withCompletionHandler___block_invoke_8(uint64_t a1)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  (*(void (**)(uint64_t, void *, _QWORD, _QWORD, _QWORD))(v3 + 16))(v3, v4, 0, 0, 0);
