uint64_t _sl_dlopen(_QWORD *a1, char **a2)
{
  _QWORD *v3;
  _QWORD *v4;
  uint64_t v5;
        ...
        *v13 = v17;
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 136446210;
          v32 = v17;
          _os_log_impl(&dword_22E157000, v11, OS_LOG_TYPE_INFO, "SoftLinking client failed to load dependency: %{public}s", buf, 0xCu);
        }
        v9 += v18 + 1;
        ++v13;
        ++v12;
...
uint64_t _sl_dlopen_audited(_QWORD *a1)
{
...
{
  __assert_rtn("_sl_dlopen", "SoftLinking.c", 63, "errorMessage");
}
