...
{
  id v10;
  NCNotificationManagementQuietingSuggestionContentProvider *v11;
  void *v12;
  void *v13;
  void *v14;
  void *v15;
...
- (id)auxiliaryOptionActions
{
  ...
  v18[1] = 3221225472;
  v18[2] = __83__NCNotificationManagementQuietingSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v18[3] = &unk_1E8D1B1C8;
  objc_copyWeak(&v19, &location);
  objc_msgSend(v2, "actionWithTitle:image:identifier:handler:", v4, 0, CFSTR("notification-management-quieting-suggestion-keep"), v18);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  v7 = (void *)MEMORY[0x1E0DC3428];
  NCUserNotificationsUIKitFrameworkBundle();
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("NOTIFICATION_MANAGEMENT_SUGGESTION_MANAGE"), &stru_1E8D21F60, 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v5;
  v14 = 3221225472;
  v15 = __83__NCNotificationManagementQuietingSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v16 = &unk_1E8D1B1C8;
  objc_copyWeak(&v17, &location);
  objc_msgSend(v7, "actionWithTitle:image:identifier:handler:", v9, 0, CFSTR("notification-management-quieting-suggestion-manage"), &v13);
...
- (void)handleKeepAction:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "notificationManagementContentProvider:keepNotificationsForSectionIdentifierForNotificationRequest:", self, v4);
