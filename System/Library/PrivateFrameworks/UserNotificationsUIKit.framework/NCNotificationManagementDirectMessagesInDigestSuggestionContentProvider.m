...
{
  id v10;
  NCNotificationManagementDirectMessagesInDigestSuggestionContentProvider *v11;
  void *v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  if (v11)
  {
    ...
    objc_msgSend(v13, "localizedStringForKey:value:table:", CFSTR("NOTIFICATION_MANAGEMENT_MESSAGES_IN_DIGEST_SUGGESTION"), &stru_1E8D21F60, 0);
...
- (id)auxiliaryOptionActions
{
  ...
  v18[1] = 3221225472;
  v18[2] = __97__NCNotificationManagementDirectMessagesInDigestSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v18[3] = &unk_1E8D1B1C8;
  objc_copyWeak(&v19, &location);
  objc_msgSend(v2, "actionWithTitle:image:identifier:handler:", v4, 0, CFSTR("notification-management-direct-message-in-digest-turn-off"), v18);
  ...
  v13 = v5;
  v14 = 3221225472;
  v15 = __97__NCNotificationManagementDirectMessagesInDigestSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v16 = &unk_1E8D1B1C8;
  objc_copyWeak(&v17, &location);
  objc_msgSend(v7, "actionWithTitle:image:identifier:handler:", v9, 0, CFSTR("notification-management-suggestion-direct-message-in-digest-leave-on"), &v13);
...
- (void)handleOffAction:(id)a3
{
  ...
  objc_msgSend(v7, "notificationManagementContentProvider:setAllowsDirectMessages:forSectionIdentifier:", self, 0, v5);
...
- (void)handleLeaveOnAction:(id)a3
{
  ...
  objc_msgSend(v4, "sectionIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "notificationManagementContentProvider:setAllowsDirectMessages:forSectionIdentifier:", self, 1, v5);
