...
- (NCTurnOffNotificationsForAppRemoteSuggestionContentProvider)initWithNotificationRequest:(id)a3 bundleDisplayName:(id)a4 managementDelegate:(id)a5 suggestionDelegate:(id)a6 uuid:(id)a7
{
  ...
  if (v13)
  {
    ...
    objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("NOTIFICATION_MANAGEMENT_SUGGESTION_EXPLANATION"), &stru_1E8D21F60, 0);
...
- (id)auxiliaryOptionActions
{
  ...
  objc_msgSend(v3, "localizedStringForKey:value:table:", CFSTR("NOTIFICATION_MANAGEMENT_SUGGESTION_KEEP"), &stru_1E8D21F60, 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = MEMORY[0x1E0C809B0];
  v18[0] = MEMORY[0x1E0C809B0];
  v18[1] = 3221225472;
  v18[2] = __85__NCTurnOffNotificationsForAppRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v18[3] = &unk_1E8D1B1C8;
  objc_copyWeak(&v19, &location);
  objc_msgSend(v2, "actionWithTitle:image:identifier:handler:", v4, 0, CFSTR("notification-management-turn-off-notifications-suggestion-keep"), v18);
  ...
  v13 = v5;
  v14 = 3221225472;
  v15 = __85__NCTurnOffNotificationsForAppRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v16 = &unk_1E8D1B1C8;
  objc_copyWeak(&v17, &location);
  objc_msgSend(v7, "actionWithTitle:image:identifier:handler:", v9, 0, CFSTR("notification-management-turn-off-notifications-suggestion-off"), &v13);
...
- (void)handleKeepAction:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "logSuggestionEvent:suggestionType:suggestionIdentifier:timestamp:", 1, 9, v5, v6);
...
- (void)logSuggestionEvent:(int64_t)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0C99D68], "now");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "logSuggestionEvent:suggestionType:suggestionIdentifier:timestamp:", a3, 9, v5, v6);
