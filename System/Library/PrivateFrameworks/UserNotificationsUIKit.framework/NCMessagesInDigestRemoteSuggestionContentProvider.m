...
- (NCMessagesInDigestRemoteSuggestionContentProvider)initWithNotificationRequest:(id)a3 bundleDisplayName:(id)a4 managementDelegate:(id)a5 suggestionDelegate:(id)a6 uuid:(id)a7
{
  ...
  if (v13)
  {
    ...
    objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("NOTIFICATION_REMOTE_MANAGEMENT_MESSAGES_IN_DIGEST_SUGGESTION"), &stru_1E8D21F60, 0);
...
- (id)auxiliaryOptionActions
{
  ...
  v18[1] = 3221225472;
  v18[2] = __75__NCMessagesInDigestRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v18[3] = &unk_1E8D1B1C8;
  objc_copyWeak(&v19, &location);
  objc_msgSend(v2, "actionWithTitle:image:identifier:handler:", v4, 0, CFSTR("notification-management-remote-suggestion-in-digest-turn-off"), v18);
  ...
  v13 = v5;
  v14 = 3221225472;
  v15 = __75__NCMessagesInDigestRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v16 = &unk_1E8D1B1C8;
  objc_copyWeak(&v17, &location);
  objc_msgSend(v7, "actionWithTitle:image:identifier:handler:", v9, 0, CFSTR("notification-management-remote-in-digest-leave-on"), &v13);
...
- (void)handleTurnOffMenuButtonAction:(id)a3
{
  ...
  objc_msgSend(v10, "notificationManagementContentProvider:setAllowsDirectMessages:forSectionIdentifier:", self, 0, v5);
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "logSuggestionEvent:suggestionType:suggestionIdentifier:timestamp:", 2, 8, v7, v8);
...
- (void)handleLeaveOnButtonAction:(id)a3
{
  ...
  objc_msgSend(v4, "sectionIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "notificationManagementContentProvider:setAllowsDirectMessages:forSectionIdentifier:", self, 1, v5);
  ...
  objc_msgSend(MEMORY[0x1E0C99D68], "now");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "logSuggestionEvent:suggestionType:suggestionIdentifier:timestamp:", 1, 8, v7, v8);
