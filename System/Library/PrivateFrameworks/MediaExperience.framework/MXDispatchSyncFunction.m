@implementation MXDispatchSyncFunction
...
void __MXDispatchSyncFunction_block_invoke_2(uint64_t a1)
{
    ...
    || CMSMDeviceState_IsAudiomxd() && MX_FeatureFlags_IsAudiomxdEnabled())
  {
    ...
    if (gSerialQueue == v3)
      MEMORY[0x1940347A0](a1 + 48, 1, "MXDispatchSyncFunction_block_invoke_2", v4, v5, v6, v7, v8);
  }
    ...
    || CMSMDeviceState_IsAudiomxd() && MX_FeatureFlags_IsAudiomxdEnabled())
  {
    if (MXGetSerialQueue_onceToken != -1)
      dispatch_once(&MXGetSerialQueue_onceToken, &__block_literal_global_59);
    if (gSerialQueue == v9)
      MEMORY[0x1940347A0](a1 + 48, 2, "MXDispatchSyncFunction_block_invoke_2", v10, v11, v12, v13, v14);
  }
