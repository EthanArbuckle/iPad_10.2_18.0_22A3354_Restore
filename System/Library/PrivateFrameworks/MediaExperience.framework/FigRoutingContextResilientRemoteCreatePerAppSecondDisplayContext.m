@implementation FigRoutingContextResilientRemoteCreatePerAppSecondDisplayContext

uint64_t __FigRoutingContextResilientRemoteCreatePerAppSecondDisplayContext_block_invoke(uint64_t a1, uint64_t a2)
{
  return objc_msgSend(*(id *)(a1 + 32), "createPerAppSecondDisplayContextWithAllocator:options:context:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48), a2);
}
