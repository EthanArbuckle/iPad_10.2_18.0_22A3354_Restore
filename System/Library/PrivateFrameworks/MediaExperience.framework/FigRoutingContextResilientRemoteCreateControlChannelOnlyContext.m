@implementation FigRoutingContextResilientRemoteCreateControlChannelOnlyContext

uint64_t __FigRoutingContextResilientRemoteCreateControlChannelOnlyContext_block_invoke(uint64_t a1, uint64_t a2)
{
  return objc_msgSend(*(id *)(a1 + 32), "createControlChannelOnlyContextWithAllocator:options:context:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48), a2);
}
