@implementation MXDispatchAsyncAndWait
...
void __MXDispatchAsyncAndWait_block_invoke(uint64_t a1)
{
    ...
    || CMSMDeviceState_IsAudiomxd() && MX_FeatureFlags_IsAudiomxdEnabled())
  {
    ...
    if (gSerialQueue == v4)
      MEMORY[0x1940347A0](a1 + 48, 1, "MXDispatchAsyncAndWait_block_invoke", v5, v6, v7, v8, v9);
  }
    ...
    || CMSMDeviceState_IsAudiomxd() && MX_FeatureFlags_IsAudiomxdEnabled())
  {
    if (MXGetSerialQueue_onceToken != -1)
      dispatch_once(&MXGetSerialQueue_onceToken, &__block_literal_global_59);
    if (gSerialQueue == v10)
      MEMORY[0x1940347A0](v3, 2, "MXDispatchAsyncAndWait_block_invoke", v11, v12, v13, v15, v14);
  }
