...
+ (id)entryEventForwardDefinitions
{
  ...
  v5 = CFSTR("State");
  +[PLARKitAgent entryEventForwardDefinitionState](PLARKitAgent, "entryEventForwardDefinitionState");
...
- (void)initOperatorDependancies
{
  ...
  if ((objc_msgSend(MEMORY[0x1E0D80020], "isHomePod") & 1) == 0)
  {
    ...
    CFNotificationCenterAddObserver(v4, self, (CFNotificationCallback)logPauseStateNotificationReceived, (CFStringRef)ARSessionDidPauseDarwinNotification, 0, CFNotificationSuspensionBehaviorDeliverImmediately);
  }
}
