...
- (id)description
{
  ...
  -[KCellularLteRrcState description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularLteRrcState dictionaryRepresentation](self, "dictionaryRepresentation");
