    ...
    *(_OWORD *)host_info64_out = 0u;
    ...
    else
    {
      ...
      else
      {
        ...
        objc_msgSend((id)_sumMemoryAtEachPriority, "setObject:forKeyedSubscript:", v14, &unk_1E86338A0);

        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", _wiredBytes);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend((id)_sumMemoryAtEachPriority, "setObject:forKeyedSubscript:", v11, &unk_1E86338B8);
      }
