...
- (id)description
{
  ...
  -[KCellularProtocolStackPowerState description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularProtocolStackPowerState dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_10:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_prevState);
...
LABEL_26:
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 2) == 0 || self->_prevState != *((_DWORD *)v4 + 4))
      goto LABEL_26;
  }
