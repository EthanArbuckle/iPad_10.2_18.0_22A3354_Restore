...
+ (id)entryEventNoneDefinitionsDASPoliciesBlockingCriteria
{
  ...
  objc_msgSend(v2, "setObject:forKeyedSubscript:", &unk_1E8652DE0, *MEMORY[0x1E0D80318]);
...
+ (id)entryEventNoneDefinitionsDASActivityLifecycle
{
  ...
  objc_msgSend(v75, "setObject:forKeyedSubscript:", &unk_1E8652DF0, *MEMORY[0x1E0D80318]);
...
- (void)initOperatorDependanciesDAS:(id)a3
{
  ...
  if (v4)
  {
    if ((objc_msgSend(MEMORY[0x1E0D80078], "isPowerlogHelperd") & 1) == 0)
    {
      ...
      v27[3] = &unk_1E8578610;
      v27[4] = self;
      v7 = (void *)objc_msgSend(v5, "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BDB0, v27);
      ...
      v26[3] = &unk_1E8578610;
      v26[4] = self;
      v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BDD8, v26);
      ...
      v25[3] = &unk_1E8578610;
      v25[4] = self;
      v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BE00, v25);
      ...
      v24[3] = &unk_1E8578610;
      v24[4] = self;
      v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BE28, v24);
      ...
      v23[3] = &unk_1E8578610;
      v23[4] = self;
      v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BE50, v23);
      ...
      v22[3] = &unk_1E8578610;
      v22[4] = self;
      v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BE78, v22);
      ...
      v21[3] = &unk_1E8578610;
      v21[4] = self;
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BEA0, v21);
      ...
      v20[3] = &unk_1E8578610;
      v20[4] = self;
      v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BEC8, v20);
      ...
      v19[3] = &unk_1E8578610;
      v19[4] = self;
      v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1E864BEF0, v19);
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "taskMode"))
      {
        ...
        {
          *(_WORD *)v18 = 0;
          _os_log_impl(&dword_1CAF47000, v16, OS_LOG_TYPE_DEFAULT, "PerfPowerServices is ready to receive Background Processing Payload", v18, 2u);
        }
...
void __48__PLDuetServiceDAS_initOperatorDependanciesDAS___block_invoke_245()
{
  ...
  if (v0)
  {
    if (os_log_type_enabled(v1, OS_LOG_TYPE_ERROR))
    {
      ...
      v5 = 1024;
      v6 = v0;
      _os_log_error_impl(&dword_1CAF47000, v2, OS_LOG_TYPE_ERROR, "Failed to post %s : %d", (uint8_t *)&v3, 0x12u);
    }
  }
  else if (os_log_type_enabled(v1, OS_LOG_TYPE_INFO))
  {
    v3 = 136315138;
    v4 = "com.apple.perfpowerservices.reportfeaturestatus";
    _os_log_impl(&dword_1CAF47000, v2, OS_LOG_TYPE_INFO, "Posted %s", (uint8_t *)&v3, 0xCu);
  }
...
- (void)didReceiveDASActivityEventWithPayload:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[4] = v5;
    if (qword_1ED8868E0 != -1)
      dispatch_once(&qword_1ED8868E0, block);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    v75 = v4;
    _os_log_debug_impl(&dword_1CAF47000, v12, OS_LOG_TYPE_DEBUG, "didReceiveDASActivityEvent: payload=%@", buf, 0xCu);
  }
...
- (void)didReceiveDASActivityLifecycleEventWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    v14 = 138412290;
    v15 = v4;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "didReceiveDASActivityLifecycle payload=%@", (uint8_t *)&v14, 0xCu);
  }
...
- (void)didReceiveDASInfoEventWithPayload:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v24 = v5;
    if (qword_1ED8868E8 != -1)
      dispatch_once(&qword_1ED8868E8, &block);
    if (byte_1ED8868C9)
    {
...
- (void)didReceiveDASBudgetEventWithPayload:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v23 = &__block_descriptor_40_e5_v8__0lu32l8;
    v24 = v5;
    if (qword_1ED8868F0 != -1)
      dispatch_once(&qword_1ED8868F0, &block);
    if (byte_1ED8868CA)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("payload=%@"), v4, block, v21, v22, v23, v24);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    v26 = v4;
    _os_log_debug_impl(&dword_1CAF47000, v12, OS_LOG_TYPE_DEBUG, "energyBudget payload=%@", buf, 0xCu);
  }
...
- (void)didReceiveDASDataBudgetEventWithPayload:(id)a3
{
        ...
        v5))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      v12 = 138412290;
      v13 = v4;
      _os_log_debug_impl(&dword_1CAF47000, v6, OS_LOG_TYPE_DEBUG, "Received dataBudget payload: %@", (uint8_t *)&v12, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      v12 = 138412290;
      v13 = v4;
      _os_log_error_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_ERROR, "Empty Payload for dataBudget %@", (uint8_t *)&v12, 0xCu);
    }
  }
...
- (void)didReceiveDASReportEventWithPayload:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v23 = v5;
    if (qword_1ED8868F8 != -1)
      dispatch_once(&qword_1ED8868F8, &block);
    if (byte_1ED8868CB)
    {
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    v25 = v4;
    _os_log_debug_impl(&dword_1CAF47000, v12, OS_LOG_TYPE_DEBUG, "energyReport payload=%@", buf, 0xCu);
  }
...
- (void)didReceiveDASPredictionEventWithPayload:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v5;
    if (qword_1ED886900 != -1)
      dispatch_once(&qword_1ED886900, block);
    if (byte_1ED8868CC)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("payload=%@"), v4);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)didReceiveDASPoliciesBlockingCriteriaEventWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    v25 = v4;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "DASPoliciesBlockingCriteria payload=%@", buf, 0xCu);
  }
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        objc_msgSend(v11, "objectForKeyedSubscript:", &unk_1E8633288);
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "setObject:forKeyedSubscript:", v14, CFSTR("Utility"));

        objc_msgSend(v11, "objectForKeyedSubscript:", &unk_1E86332A0);
        v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)didReceiveDASTrialEventWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    v11 = 138412290;
    v12 = v4;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "DASTrial payload=%@", (uint8_t *)&v11, 0xCu);
  }
