...
void __26__PLSpringBoardAgent_init__block_invoke(uint64_t a1, void *a2)
{
  ...
  else if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[4] = v6;
    if (qword_1ED883330 != -1)
      dispatch_once(&qword_1ED883330, block);
...
- (void)addAccountingEvent:(id)a3
{
  ...
  if (!v14 || v12 != v13)
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v55 = v19;
      if (qword_1ED883440 != -1)
        dispatch_once(&qword_1ED883440, &block);
      if (byte_1ED88332E)
      {
        v20 = (void *)MEMORY[0x1E0CB3940];
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v7);
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v20, "stringWithFormat:", CFSTR("screenNumber unfiltered : %@"), v21, block, v52, v53, v54, v55);
...
- (void)computeAutolockEnergyWithNow:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v5;
    if (qword_1ED8833C8 != -1)
      dispatch_once(&qword_1ED8833C8, block);
    if (byte_1ED88331F)
    {
  ...
  if (v14 != -1.0)
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v45[4] = v18;
      if (qword_1ED8833D0 != -1)
        dispatch_once(&qword_1ED8833D0, v45);
      if (byte_1ED883320)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v44[4] = v27;
      if (qword_1ED8833D8 != -1)
        dispatch_once(&qword_1ED8833D8, v44);
      if (byte_1ED883321)
      {
    ...
    if (v34 > 60.0)
    {
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        v43[4] = v35;
        if (qword_1ED8833E0 != -1)
          dispatch_once(&qword_1ED8833E0, v43);
        if (byte_1ED883322)
        {
      ...
      objc_msgSend(MEMORY[0x1E0D7FED8], "sharedInstance");
      v42 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v42, "createQualificationEventForwardWithQualificationID:withChildNodeNames:withStartDate:", 9, &unk_1E8650150, v26);
  ...
  else
  {
    ...
    if (v4)
    {
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        if (qword_1ED883340 != -1)
          dispatch_once(&qword_1ED883340, block);
        if (byte_1ED883312)
        {
...
void __26__PLSpringBoardAgent_init__block_invoke_114(uint64_t a1, void *a2, void *a3)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v7;
    if (qword_1ED883338 != -1)
      dispatch_once(&qword_1ED883338, block);
    if (byte_1ED883311)
    {
...
void __26__PLSpringBoardAgent_init__block_invoke_125(uint64_t a1)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v2;
    if (qword_1ED883348 != -1)
      dispatch_once(&qword_1ED883348, block);
    if (byte_1ED883313)
    {
...
void __26__PLSpringBoardAgent_init__block_invoke_131(uint64_t a1, void *a2)
{
  ...
  else if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v7;
    if (qword_1ED883350 != -1)
      dispatch_once(&qword_1ED883350, block);
    if (byte_1ED883314)
    {
...
void __26__PLSpringBoardAgent_init__block_invoke_135(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (objc_msgSend(v3, "longLongValue"))
    {
      ...
      dispatch_after(v6, v7, &__block_literal_global_25);
  ...
  else if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v8;
    if (qword_1ED883358 != -1)
      dispatch_once(&qword_1ED883358, block);
    if (byte_1ED883315)
    {
...
- (void)initOperatorDependancies
{
  ...
  if (v5)
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = objc_opt_class();
    if (qword_1ED883360 != -1)
      dispatch_once(&qword_1ED883360, block);
    if (byte_1ED883316)
    {
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    if (qword_1ED883368 != -1)
      dispatch_once(&qword_1ED883368, v50);
    if (byte_1ED883317)
    {
...
LABEL_28:
  ...
  v44[3] = &unk_1E8578610;
  v44[4] = self;
  v36 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864BFB8, v44);
  ...
  v43[3] = &unk_1E8578610;
  v43[4] = self;
  v38 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864BFE0, v43);
  ...
  v42[3] = &unk_1E8578610;
  v42[4] = self;
  v40 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864C008, v42);
...
void __46__PLSpringBoardAgent_initOperatorDependancies__block_invoke_180(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "PLSpringBoardAgent:Request payload =%@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLSpringBoardAgent_initOperatorDependancies__block_invoke_187(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v18 = v7;
    if (qword_1ED883370 != -1)
      dispatch_once(&qword_1ED883370, &block);
    if (byte_1ED883318)
    {
...
void __46__PLSpringBoardAgent_initOperatorDependancies__block_invoke_197(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v17 = &__block_descriptor_40_e5_v8__0lu32l8;
    v18 = v7;
    if (qword_1ED883378 != -1)
      dispatch_once(&qword_1ED883378, &block);
    if (byte_1ED883319)
    {
...
- (void)handleChargingStateChange:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v7;
    if (qword_1ED883380 != -1)
      dispatch_once(&qword_1ED883380, block);
    if (byte_1ED88331A)
    {
  ...
  if (-[PLSpringBoardAgent autoLockIsNil](self, "autoLockIsNil"))
  {
    ...
    if (!v3)
    {
      ...
      if (v4)
      {
        ...
        if (qword_1ED883388 != -1)
          dispatch_once(&qword_1ED883388, v28);
        if (byte_1ED88331B)
        {
      ...
      block[4] = self;
      if (qword_1ED883390 != -1)
        dispatch_once(&qword_1ED883390, block);
      objc_msgSend(v12, "dateByAddingTimeInterval:", *(double *)&qword_1ED883398);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v26[0] = v5;
      v26[1] = 3221225472;
      ...
      v26[3] = &unk_1E85780C8;
      v26[4] = self;
      if (qword_1ED8833A0 != -1)
        dispatch_once(&qword_1ED8833A0, v26);
      v15 = *(double *)&qword_1ED8833A8;
      ...
      v25[3] = &unk_1E85793E0;
      v25[4] = self;
      objc_msgSend(v13, "scheduledTimerWithMonotonicFireDate:withInterval:withQueue:withBlock:", v14, v16, v25, v15);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        if (qword_1ED8833B0 != -1)
          dispatch_once(&qword_1ED8833B0, v24);
        if (byte_1ED88331C)
        {
...
- (void)stopAutolockEnergyPeriodicTimer
{
  ...
  if (v3)
  {
    ...
    if (v4)
    {
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = objc_opt_class();
      if (qword_1ED8833B8 != -1)
        dispatch_once(&qword_1ED8833B8, block);
      if (byte_1ED88331D)
      {
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("begin"));
        v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v24 = objc_opt_class();
      if (qword_1ED8833C0 != -1)
        dispatch_once(&qword_1ED8833C0, &v20);
      if (byte_1ED88331E)
      {
...
- (void)resetAutoLockIsNil
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v17 = &__block_descriptor_40_e5_v8__0lu32l8;
    v18 = v5;
    if (qword_1ED8833E8 != -1)
      dispatch_once(&qword_1ED8833E8, &block);
    if (byte_1ED883323)
    {
      v6 = (void *)MEMORY[0x1E0CB3940];
...
- (id)addCountsAndDurationsFor:(id)a3 toEntry:(id)a4
{
  ...
  if (v11)
  {
    if (v13)
    {
      if (v19)
      {
        objc_msgSend(v6, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("FgWakingPluggedInCount"));
        ...
        if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        {
          ...
          v86[4] = v21;
          if (qword_1ED8833F0 != -1)
            dispatch_once(&qword_1ED8833F0, v86);
          if (byte_1ED883324)
          {
...
LABEL_47:
      ...
      {
        objc_msgSend(v6, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("FgWakingCount"));
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v14);
        ...
        if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        {
          ...
          v85[4] = v59;
          if (qword_1ED8833F8 != -1)
            dispatch_once(&qword_1ED8833F8, v85);
          if (byte_1ED883325)
          {
    ...
    {
      objc_msgSend(v6, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("BgWakingPluggedInCount"));
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v14);
      v40 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        v84[4] = v41;
        if (qword_1ED883400 != -1)
          dispatch_once(&qword_1ED883400, v84);
        if (byte_1ED883326)
        {
    ...
    {
      objc_msgSend(v6, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("BgWakingCount"));
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v14);
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        v83[4] = v68;
        if (qword_1ED883408 != -1)
          dispatch_once(&qword_1ED883408, v83);
        if (byte_1ED883327)
        {
  ...
  {
    objc_msgSend(v6, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("NonWakingPluggedInCount"));
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v14);
    v31 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = v32;
      if (qword_1ED883410 != -1)
        dispatch_once(&qword_1ED883410, block);
      if (byte_1ED883328)
      {
...
LABEL_48:
  ...
  {
    objc_msgSend(v6, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("NonWakingCount"));
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v14);
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v81 = v50;
      if (qword_1ED883418 != -1)
        dispatch_once(&qword_1ED883418, &v77);
      if (byte_1ED883329)
      {
...
- (void)logNotification:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v5;
    if (qword_1ED883420 != -1)
      dispatch_once(&qword_1ED883420, block);
    if (byte_1ED88332A)
    {
  ...
  objc_msgSend(v30, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("Count"));
  if (objc_msgSend(v31, "intValue") == 3 || !objc_msgSend(v31, "intValue"))
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v41[4] = v34;
      if (qword_1ED883428 != -1)
        dispatch_once(&qword_1ED883428, v41);
      if (byte_1ED88332B)
      {
...
- (void)logMailNotification:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1E86334B0, CFSTR("NotificationType"));
    objc_msgSend(v7, "setObject:forKeyedSubscript:", CFSTR("com.apple.mobilemail"), CFSTR("NotificationBundleID"));
    objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("Count"));
    if (-[PLSpringBoardAgent deviceIsCharging](self, "deviceIsCharging"))
    {
      objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("NonWakingPluggedInCount"));
      if (!objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        goto LABEL_15;
      v8 = objc_opt_class();
      block[0] = MEMORY[0x1E0C809B0];
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = v8;
      if (qword_1ED883430 != -1)
        dispatch_once(&qword_1ED883430, block);
      if (!byte_1ED88332C)
        goto LABEL_15;
...
LABEL_15:
    ...
    {
      objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1E8633498, CFSTR("NonWakingCount"));
      if (!objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        goto LABEL_15;
      v17 = objc_opt_class();
      ...
      v24[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      v24[4] = v17;
      if (qword_1ED883438 != -1)
        dispatch_once(&qword_1ED883438, v24);
      if (!byte_1ED88332D)
        goto LABEL_15;
...
- (void)logBulletinPerEvent:(id)a3
{
  ...
  {
    *(_WORD *)v10 = 0;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "PLSpringBoardAgent:Request logging in Event Point table", v10, 2u);
  }
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "setObject:forKeyedSubscript:", v8, CFSTR("PostType"));

  objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("BundleIdentifier"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v7, "setObject:forKeyedSubscript:", v9, CFSTR("BulletinBundleID"));
  -[PLOperator logEntry:](self, "logEntry:", v7);
...
- (void)logBulletinAggregate:(id)a3
{
  ...
  {
    *(_WORD *)v10 = 0;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "PLSpringBoardAgent:Request logging in Aggregate table", v10, 2u);
  }
