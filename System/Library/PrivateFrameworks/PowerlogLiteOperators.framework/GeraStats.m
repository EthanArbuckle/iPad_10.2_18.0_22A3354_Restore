...
- (id)description
{
  ...
  -[GeraStats description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GeraStats dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_3:
      if ((has & 4) == 0)
        goto LABEL_4;
LABEL_9:
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_sleepCycleCount);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("sleep_cycle_count"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_sleepDuration);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("sleep_duration"));
...
LABEL_21:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 8) == 0 || self->_sleepDuration != *((_DWORD *)v4 + 6))
      goto LABEL_21;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 4) == 0 || self->_sleepCycleCount != *((_DWORD *)v4 + 5))
      goto LABEL_21;
  }
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_startTime != *((_QWORD *)v4 + 1))
      goto LABEL_21;
    v5 = 1;
  }
LABEL_22:
