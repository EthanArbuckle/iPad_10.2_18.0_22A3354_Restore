...
LABEL_3:
  ...
  if (deployment >= 3)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_deployment);
    v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v7 = off_1E8577BD0[deployment];
  }
...
LABEL_22:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_fr1MeasDisabled);
...
LABEL_23:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_fr2MeasDisabled);
...
LABEL_24:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_triggerCause);
    v11 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v11 = off_1E8577BE8[triggerCause];
  }
...
LABEL_28:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_prevTriggerCause);
    v13 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v13 = off_1E8577BE8[prevTriggerCause];
  }
...
LABEL_32:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_apNrRecomm);
...
LABEL_33:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_apNrRecommConfFactor);
...
LABEL_34:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_durationInPrevState);
...
LABEL_40:
  ...
  if (prevRat >= 0xE)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_prevRat);
    v21 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v21 = off_1E8577D00[prevRat];
  }
...
LABEL_44:
  ...
  if (currentRat >= 0xE)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_currentRat);
    v23 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v23 = off_1E8577D00[currentRat];
  }
...
LABEL_48:
  ...
  if (newState >= 8)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_newState);
    v25 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v25 = off_1E8577D70[newState];
  }
...
LABEL_52:
    ...
    if (saVerdict >= 7)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_saVerdict);
      v27 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v27 = off_1E8577DB0[saVerdict];
    }
