...
{
  -[NSMutableArray removeAllObjects](self->_pcellBandDurations, "removeAllObjects");
}
...
- (void)addPcellBandDuration:(id)a3
{
  ...
  -[NSMutableArray addObject:](pcellBandDurations, "addObject:", v4);

}

- (unint64_t)pcellBandDurationsCount
{
  return -[NSMutableArray count](self->_pcellBandDurations, "count");
}

- (id)pcellBandDurationAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_pcellBandDurations, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[KCellularServingCellRfBandHist description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularServingCellRfBandHist dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_pcellBandDurations, "count"))
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_pcellBandDurations, "count"));
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
    v19 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("pcell_band_duration"));
  }
...
- (void)copyTo:(id)a3
{
  ...
  v10 = v4;
  if (-[KCellularServingCellRfBandHist pcellBandDurationsCount](self, "pcellBandDurationsCount"))
  {
    objc_msgSend(v10, "clearPcellBandDurations");
    v6 = -[KCellularServingCellRfBandHist pcellBandDurationsCount](self, "pcellBandDurationsCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        -[KCellularServingCellRfBandHist pcellBandDurationAtIndex:](self, "pcellBandDurationAtIndex:", i);
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v10, "addPcellBandDuration:", v9);
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        objc_msgSend((id)v6, "addPcellBandDuration:", v13);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 36) & 2) == 0 || self->_durationMs != *((_DWORD *)v4 + 4))
      goto LABEL_19;
  }
  ...
  pcellBandDurations = self->_pcellBandDurations;
  if ((unint64_t)pcellBandDurations | *((_QWORD *)v4 + 3))
  {
...
LABEL_3:
  ...
  v4 = 0;
LABEL_6:
  v5 = -[NSMutableArray hash](self->_pcellBandDurations, "hash");
  if ((*(_BYTE *)&self->_has & 4) != 0)
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[KCellularServingCellRfBandHist addPcellBandDuration:](self, "addPcellBandDuration:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
...
{
  objc_storeStrong((id *)&self->_pcellBandDurations, a3);
}
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_pcellBandDurations, 0);
}
