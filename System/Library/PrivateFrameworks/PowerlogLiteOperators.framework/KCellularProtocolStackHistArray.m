...
- (id)description
{
  ...
  -[KCellularProtocolStackHistArray description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularProtocolStackHistArray dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_6:
  v10 = v4;
  if (-[KCellularProtocolStackHistArray histsCount](self, "histsCount"))
  {
    objc_msgSend(v10, "clearHists");
    v6 = -[KCellularProtocolStackHistArray histsCount](self, "histsCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        -[KCellularProtocolStackHistArray histAtIndex:](self, "histAtIndex:", i);
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[KCellularProtocolStackHistArray addHist:](self, "addHist:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
