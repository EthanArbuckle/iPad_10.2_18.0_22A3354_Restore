...
- (void)stopMonitoring
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v16 = v5;
    if (qword_1ED886D80 != -1)
      dispatch_once(&qword_1ED886D80, &block);
    if (_MergedGlobals_96)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Stopped monitoring paths %@"), &unk_1E8650840, block, v13, v14, v15, v16);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
void __33__PLFSEventAgent_startMonitoring__block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[4] = v2;
    if (qword_1ED886D88 != -1)
      dispatch_once(&qword_1ED886D88, block);
    if (byte_1ED886D79)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("StartMonitoring paths: %@"), &unk_1E8650858);
      v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "stream"))
  {
    ...
    if (!FSEventStreamStart((FSEventStreamRef)objc_msgSend(*(id *)(a1 + 32), "stream")))
    {
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        v18[4] = v11;
        if (qword_1ED886D90 != -1)
          dispatch_once(&qword_1ED886D90, v18);
        if (byte_1ED886D7A)
        {
...
- (void)registerforFSEventNotification
{
  ...
  v3 = FSEventStreamCreate((CFAllocatorRef)*MEMORY[0x1E0C9AE00], (FSEventStreamCallback)fsEventsHandler, &context, (CFArrayRef)&unk_1E8650870, 0xFFFFFFFFFFFFFFFFLL, 1.0, 0x11u);
  self->_stream = v3;
  if (v3)
  {
...
- (void)initOperatorDependancies
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v3, "initWithWorkQueue:withRegistration:withBlock:", v4, &unk_1E864C670, &__block_literal_global_29);
...
- (void)logLogFileName:(id)a3 withName:(id)a4
{
  ...
  if (v6 && v7)
  {
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = v9;
      if (qword_1ED886D98 != -1)
        dispatch_once(&qword_1ED886D98, block);
      if (byte_1ED886D7B)
      {
