...
- (void)initOperatorDependanciesLpmSource:(id)a3
{
  ...
  v4 = a3;
  if (v4 && (objc_msgSend(MEMORY[0x1E0D80078], "isPowerlogHelperd") & 1) == 0)
  {
    ...
    v13[3] = &unk_1E8578610;
    v13[4] = self;
    v8 = (void *)objc_msgSend(v5, "initWithOperator:withRegistration:withBlock:", v6, &unk_1E864BF18, v13);
    ...
    v12[3] = &unk_1E8578610;
    v12[4] = self;
    v11 = (void *)objc_msgSend(v9, "initWithOperator:withRegistration:withBlock:", v10, &unk_1E864BF40, v12);
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412290;
        v23 = v6;
        _os_log_debug_impl(&dword_1CAF47000, v8, OS_LOG_TYPE_DEBUG, "didReceiveLpmSourceInfoWithPayload payload=%@", buf, 0xCu);
      }
      ...
      MEMORY[0x1D179B7DC](objc_msgSend(v19, "stringByAppendingString:", v12), 1);
