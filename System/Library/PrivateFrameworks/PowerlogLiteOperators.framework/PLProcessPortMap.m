...
+ (id)sharedInstance
{
  ...
  block[4] = a1;
  if (qword_1ED8867D0 != -1)
    dispatch_once(&qword_1ED8867D0, block);
  return (id)qword_1ED8867C8;
}
...
void __111__PLProcessPortMap_pidAndProcessNameForDestAddress_withDestPort_withSourceAddress_withSourcePort_withProtocol___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v133[4] = v3;
      if (qword_1ED8867D8 != -1)
        dispatch_once(&qword_1ED8867D8, v133);
  ...
  if (v10)
  {
    ...
    *(_QWORD *)(v16 + 40) = v15;
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v132[4] = v18;
      if (qword_1ED8867E0 != -1)
        dispatch_once(&qword_1ED8867E0, v132);
      if (byte_1ED8867B1)
      {
...
LABEL_99:
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v131[4] = v25;
    if (qword_1ED8867E8 != -1)
      dispatch_once(&qword_1ED8867E8, v131);
    if (byte_1ED8867B2)
    {
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v130[4] = v32;
    if (qword_1ED8867F0 != -1)
      dispatch_once(&qword_1ED8867F0, v130);
    if (byte_1ED8867B3)
    {
  ...
  *(_QWORD *)(v43 + 40) = v42;
  ...
  if (!*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 80) + 8) + 40))
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v129[4] = v53;
      if (qword_1ED8867F8 != -1)
        dispatch_once(&qword_1ED8867F8, v129);
      if (byte_1ED8867B4)
      {
    ...
    *(_QWORD *)(v62 + 40) = v61;
    ...
    if (v69)
    {
      ...
      v125[4] = v71;
      if (qword_1ED886818 != -1)
        dispatch_once(&qword_1ED886818, v125);
      if (!byte_1ED8867B8)
        goto LABEL_82;
    ...
    else
    {
      if (v70)
      {
        ...
        v128[4] = v77;
        if (qword_1ED886800 != -1)
          dispatch_once(&qword_1ED886800, v128);
        if (byte_1ED8867B5)
        {
      ...
      *(_QWORD *)(v88 + 40) = v87;
      ...
      if (v90)
      {
        ...
        v126[4] = v92;
        if (qword_1ED886810 != -1)
          dispatch_once(&qword_1ED886810, v126);
        if (!byte_1ED8867B7)
          goto LABEL_81;
      ...
      else
      {
        if (v91)
        {
          ...
          v127[4] = v98;
          if (qword_1ED886808 != -1)
            dispatch_once(&qword_1ED886808, v127);
          if (byte_1ED8867B6)
          {
...
LABEL_82:
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v124[4] = v45;
    if (qword_1ED886820 != -1)
      dispatch_once(&qword_1ED886820, v124);
    if (byte_1ED8867B9)
    {
...
LABEL_83:
    ...
    && objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v123[4] = v110;
    if (qword_1ED886828 != -1)
      dispatch_once(&qword_1ED886828, v123);
    if (byte_1ED8867BA)
    {
...
LABEL_90:
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[4] = v115;
    if (qword_1ED886830 != -1)
      dispatch_once(&qword_1ED886830, block);
    if (byte_1ED8867BB)
    {
...
- (void)clearPortMapInternal
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v18 = v3;
    if (qword_1ED886838 != -1)
      dispatch_once(&qword_1ED886838, &block);
    if (byte_1ED8867BC)
    {
...
- (void)reconstructPortMapInternal
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v3;
    if (qword_1ED886840 != -1)
      dispatch_once(&qword_1ED886840, block);
    if (byte_1ED8867BD)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_QWORD *)&out[4] = v4;
        _os_log_debug_impl(&dword_1CAF47000, v9, OS_LOG_TYPE_DEBUG, "%@", out, 0xCu);
      }
  ...
  if (sysctlbyname("net.link.generic.system.port_used.list", 0, &v71, 0, 0))
  {
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v70[4] = v10;
      if (qword_1ED886848 != -1)
        dispatch_once(&qword_1ED886848, v70);
      if (byte_1ED8867BE)
      {
...
LABEL_14:
        ...
        *(_QWORD *)&out[4] = v11;
LABEL_55:
        _os_log_debug_impl(&dword_1CAF47000, v16, OS_LOG_TYPE_DEBUG, "%@", out, 0xCu);
        goto LABEL_14;
      }
    }
    return;
  ...
  if (v17)
  {
    ...
    if (sysctlbyname("net.link.generic.system.port_used.list", v17, &v72, 0, 0))
    {
      ...
      v68[4] = v19;
      if (qword_1ED886858 != -1)
        dispatch_once(&qword_1ED886858, v68);
      if (!byte_1ED8867C0)
        goto LABEL_52;
    ...
    else
    {
      ...
      if (*((_DWORD *)v18 + 2))
      {
        ...
        if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        {
          ...
          v66[4] = v56;
          if (qword_1ED886868 != -1)
            dispatch_once(&qword_1ED886868, v66);
          if (byte_1ED8867C2)
          {
      ...
      v67[4] = v61;
      if (qword_1ED886860 != -1)
        dispatch_once(&qword_1ED886860, v67);
      if (!byte_1ED8867C1)
      {
LABEL_52:
        free(v18);
...
LABEL_22:
    ...
    _os_log_debug_impl(&dword_1CAF47000, v25, OS_LOG_TYPE_DEBUG, "%@", out, 0xCu);
    goto LABEL_22;
  }
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v69[4] = v26;
    if (qword_1ED886850 != -1)
      dispatch_once(&qword_1ED886850, v69);
    if (byte_1ED8867BF)
    {
