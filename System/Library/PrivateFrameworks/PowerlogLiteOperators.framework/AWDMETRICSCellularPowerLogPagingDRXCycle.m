...
- (id)description
{
  ...
  -[AWDMETRICSCellularPowerLogPagingDRXCycle description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDMETRICSCellularPowerLogPagingDRXCycle dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_8:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_pagingDrxCycle);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("paging_drx_cycle"));
...
LABEL_9:
  ...
  objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("fr"));
...
LABEL_21:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 4) == 0 || self->_pagingDrxCycle != *((_DWORD *)v4 + 5))
      goto LABEL_21;
  }
