...
- (id)description
{
  ...
  -[KCellularWcdmaRrcConfiguration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularWcdmaRrcConfiguration dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_drxCycleLengthMs);
...
LABEL_4:
    if ((has & 8) == 0)
      goto LABEL_5;
LABEL_11:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isDcConfigured);
...
LABEL_10:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isMimoConfigured);
