...
- (void)logEventPointApplicationForDisplayID:(id)a3 withPid:(int)a4 withState:(id)a5 withReasons:(id)a6
{
  ...
  else
  {
    ...
    if (v12)
    {
      ...
      v50 = v12;
      v17 = v12;
      v18 = objc_msgSend(v17, "countByEnumeratingWithState:objects:count:", &v58, v64, 16);
      if (v18)
      {
        v19 = v18;
        v20 = *(_QWORD *)v59;
        ...
        do
        {
          for (i = 0; i != v19; ++i)
          {
            ...
            if (-[PLOperator isDebugEnabledForKey:](self, "isDebugEnabledForKey:", CFSTR("Aggregate")))
            {
              ...
              objc_msgSend(v26, "setObject:forKeyedSubscript:", &unk_1E8634E60, CFSTR("Count"));
              -[PLOperator logEntry:](self, "logEntry:", v26);

            }
          }
          v19 = objc_msgSend(v17, "countByEnumeratingWithState:objects:count:", &v58, v64, 16);
        }
        while (v19);
      }
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      block[4] = v41;
      if (qword_1ED8854E0 != -1)
        dispatch_once(&qword_1ED8854E0, block);
      if (byte_1ED885478)
      {
...
+ (void)addAppVersion:(id)a3 withVersion:(id)a4
{
  ...
  v7 = a3;
  v5 = a4;
  if (qword_1ED885490 != -1)
    dispatch_once(&qword_1ED885490, &__block_literal_global_62);
  if (v7 && v5)
  {
    v6 = (id)qword_1ED885498;
    objc_sync_enter(v6);
    objc_msgSend((id)qword_1ED885498, "setObject:forKey:", v5, v7);
    objc_sync_exit(v6);
...
+ (void)removeAppVersion:(id)a3 forVersion:(id)a4
{
  ...
  v9 = a3;
  v5 = a4;
  if (v5 && v9 && qword_1ED885498)
  {
    v6 = (id)qword_1ED885498;
    objc_sync_enter(v6);
    objc_msgSend((id)qword_1ED885498, "objectForKeyedSubscript:", v9);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = objc_msgSend(v7, "isEqualToString:", v5);

    if (v8)
      objc_msgSend((id)qword_1ED885498, "removeObjectForKey:", v9);
    objc_sync_exit(v6);
...
+ (id)appVersionForBundle:(id)a3
{
  ...
  if (qword_1ED885498)
  {
    v4 = (id)qword_1ED885498;
    objc_sync_enter(v4);
    objc_msgSend((id)qword_1ED885498, "objectForKeyedSubscript:", v3);
...
- (void)sendApplicationMetadataToCA
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_debug_impl(&dword_1CAF47000, v2, OS_LOG_TYPE_DEBUG, "Logging all Installed Applications' BundleID/DistributorID to CA", buf, 2u);
  }
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        objc_msgSend(v11, "objectForKeyedSubscript:", CFSTR("AppBundleId"));
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v11, "objectForKeyedSubscript:", CFSTR("AppDistributorID"));
        v17 = v12;
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v13 = v18;
        v14 = v12;
...
- (void)initOperatorDependancies
{
  ...
  BKSApplicationStateMonitor *v23;
  uint64_t v24;
  void *v25;
  void *v26;
  uint64_t v27;
  ...
  if (objc_msgSend(MEMORY[0x1E0D80078], "isPowerlogHelperd"))
  {
    ...
    {
      LOWORD(location[0]) = 0;
      _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "Not invoking initOperatorDependancies for powerlogHelperd", (uint8_t *)location, 2u);
    }

  }
  else
  {
    v4 = objc_alloc(MEMORY[0x1E0D80010]);
    objc_msgSend(MEMORY[0x1E0D80078], "workQueueForClass:", objc_opt_class());
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = MEMORY[0x1E0C809B0];
    v7 = *MEMORY[0x1E0C99690];
    v88[0] = MEMORY[0x1E0C809B0];
    v88[1] = 3221225472;
    v88[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke;
    v88[3] = &unk_1E8577F48;
    v88[4] = self;
    v8 = (void *)objc_msgSend(v4, "initWithWorkQueue:forNotification:withBlock:", v5, v7, v88);

    -[PLApplicationAgent setDailyTaskNotification:](self, "setDailyTaskNotification:", v8);
    v9 = (NSSet *)SBSCopyDisplayIdentifiers();
    currentDisplayIdentifiers = self->_currentDisplayIdentifiers;
    self->_currentDisplayIdentifiers = v9;

    v87[5] = v6;
    v87[6] = 3221225472;
    v87[7] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_255;
    v87[8] = &unk_1E8580F20;
    v87[9] = self;
    ...
    v87[0] = v6;
    v87[1] = 3221225472;
    v87[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_3;
    v87[3] = &unk_1E85780C8;
    v87[4] = self;
    objc_msgSend(v11, "registerForArchivingNotificationUsingBlock:", v87);
    ...
    if (v12)
    {
      ...
      if (v12 != v13)
      {
        ...
        objc_msgSend(v12, "_LSClearSchemaCaches");
      }
    }
    -[PLApplicationAgent resetScheduledAppCleanup](self, "resetScheduledAppCleanup");
    if (self->_scheduledAppCleanup)
      objc_msgSend(MEMORY[0x1E0D7FF70], "registerFilePermissionActivity");
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "addObserver:selector:name:object:", self, sel_resetScheduledAppCleanup, CFSTR("PLAppDeletionActivityComplete"), 0);
    ...
    if ((objc_msgSend(MEMORY[0x1E0D7FFA0], "BOOLForKey:ifNotSet:", CFSTR("EnableRunningBoardServices"), 0) & 1) != 0)
    {
      ...
      aBlock[0] = v6;
      aBlock[1] = 3221225472;
      aBlock[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_4_285;
      aBlock[3] = &unk_1E8580F98;
      v15 = &v83;
      ...
      v80[0] = v6;
      v80[1] = 3221225472;
      v80[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_3_290;
      v80[3] = &unk_1E8580FC0;
      v18 = v16;
      v81 = v18;
      objc_msgSend(v17, "monitorWithConfiguration:", v80);
      v19 = (RBSProcessMonitor *)objc_claimAutoreleasedReturnValue();
      RBSAppStateMonitor = self->_RBSAppStateMonitor;
      self->_RBSAppStateMonitor = v19;

    }
    else
    {
      v21 = (BKSApplicationStateMonitor *)objc_alloc_init(MEMORY[0x1E0CFE2F0]);
      appStateMonitor = self->_appStateMonitor;
      self->_appStateMonitor = v21;

      objc_initWeak(location, self);
      v23 = self->_appStateMonitor;
      v84[0] = v6;
      v84[1] = 3221225472;
      v84[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_274;
      v84[3] = &unk_1E8580F70;
      v15 = &v85;
      objc_copyWeak(&v85, location);
      -[BKSApplicationStateMonitor setHandler:](v23, "setHandler:", v84);
    }
    objc_destroyWeak(v15);
    objc_destroyWeak(location);
    v24 = *MEMORY[0x1E0D80388];
    +[PLOperator entryKeyForType:andName:](PLApplicationAgent, "entryKeyForType:andName:", *MEMORY[0x1E0D80388], CFSTR("AllPlugins"));
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    -[PLOperator storage](self, "storage");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    v27 = objc_msgSend(v26, "countOfEntriesForKey:", v25);

    if (!v27)
      -[PLApplicationAgent logAllPlugins](self, "logAllPlugins");
    +[PLOperator entryKeyForType:andName:](PLApplicationAgent, "entryKeyForType:andName:", v24, CFSTR("AllApps"));
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    -[PLOperator storage](self, "storage");
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    v30 = objc_msgSend(v29, "countOfEntriesForKey:", v28);

    if (v30)
      -[PLApplicationAgent buildAppVersionDictionary:](self, "buildAppVersionDictionary:", v28);
    else
      -[PLApplicationAgent logAllApps](self, "logAllApps");
    if (-[PLOperator isDebugEnabled](self, "isDebugEnabled"))
    {
      DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
      CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)TestRefreshAllAppsAndPlugins, CFSTR("com.apple.powerlogd.refreshAllAppsAndPlugins"), 0, CFNotificationSuspensionBehaviorDeliverImmediately);
    }
    v79[0] = v6;
    v79[1] = 3221225472;
    v79[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_309;
    v79[3] = &unk_1E8578610;
    v79[4] = self;
    v32 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864DF98, v79);
    widgetStatsListener = self->_widgetStatsListener;
    self->_widgetStatsListener = v32;

    v78[0] = v6;
    v78[1] = 3221225472;
    v78[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_314;
    v78[3] = &unk_1E8578610;
    v78[4] = self;
    v34 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864DFC0, v78);
    widgetUpdatesListener = self->_widgetUpdatesListener;
    self->_widgetUpdatesListener = v34;

    v77[0] = v6;
    v77[1] = 3221225472;
    v77[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_318;
    v77[3] = &unk_1E8578610;
    v77[4] = self;
    v36 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864DFE8, v77);
    suggestedWidgetReloadListener = self->_suggestedWidgetReloadListener;
    self->_suggestedWidgetReloadListener = v36;

    v76[0] = v6;
    v76[1] = 3221225472;
    v76[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_323;
    v76[3] = &unk_1E8578610;
    v76[4] = self;
    v38 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E010, v76);
    posterUpdatesListener = self->_posterUpdatesListener;
    self->_posterUpdatesListener = v38;

    v75[0] = v6;
    v75[1] = 3221225472;
    v75[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_330;
    v75[3] = &unk_1E8578610;
    v75[4] = self;
    v40 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E038, v75);
    systemApertureListener = self->_systemApertureListener;
    self->_systemApertureListener = v40;

    v74[0] = v6;
    v74[1] = 3221225472;
    v74[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_335;
    v74[3] = &unk_1E8578610;
    v74[4] = self;
    v42 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E060, v74);
    ambientModeListener = self->_ambientModeListener;
    self->_ambientModeListener = v42;

    v73[0] = v6;
    v73[1] = 3221225472;
    v73[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_340;
    v73[3] = &unk_1E8578610;
    v73[4] = self;
    v44 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E088, v73);
    liveActivityUpdatesListener = self->_liveActivityUpdatesListener;
    self->_liveActivityUpdatesListener = v44;

    v72[0] = v6;
    v72[1] = 3221225472;
    v72[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_344;
    v72[3] = &unk_1E8578610;
    v72[4] = self;
    v46 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E0B0, v72);
    liveActivityStatsListener = self->_liveActivityStatsListener;
    self->_liveActivityStatsListener = v46;

    v71[0] = v6;
    v71[1] = 3221225472;
    v71[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_348;
    v71[3] = &unk_1E8578610;
    v71[4] = self;
    v48 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E0D8, v71);
    ambientModeActiveFaceListener = self->_ambientModeActiveFaceListener;
    self->_ambientModeActiveFaceListener = v48;

    v70[0] = v6;
    v70[1] = 3221225472;
    v70[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_354;
    v70[3] = &unk_1E8578610;
    v70[4] = self;
    v50 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E100, v70);
    ambientModeLifetimeCounterListener = self->_ambientModeLifetimeCounterListener;
    self->_ambientModeLifetimeCounterListener = v50;

    v69[0] = v6;
    v69[1] = 3221225472;
    v69[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_360;
    v69[3] = &unk_1E8578610;
    v69[4] = self;
    v52 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E128, v69);
    motionToWakeListener = self->_motionToWakeListener;
    self->_motionToWakeListener = v52;

    v68[0] = v6;
    v68[1] = 3221225472;
    v68[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_364;
    v68[3] = &unk_1E8578610;
    v68[4] = self;
    v54 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E150, v68);
    controlCenterUpdatesListener = self->_controlCenterUpdatesListener;
    self->_controlCenterUpdatesListener = v54;

    v67[0] = v6;
    v67[1] = 3221225472;
    v67[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_368;
    v67[3] = &unk_1E8578610;
    v67[4] = self;
    v56 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E178, v67);
    controlCenterStatsListener = self->_controlCenterStatsListener;
    self->_controlCenterStatsListener = v56;

    v66[0] = v6;
    v66[1] = 3221225472;
    v66[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_369;
    v66[3] = &unk_1E8581010;
    v66[4] = self;
    objc_msgSend(MEMORY[0x1E0D87D90], "monitorWithConfiguration:", v66);
    v58 = (RBSProcessMonitor *)objc_claimAutoreleasedReturnValue();
    appStateMonitorRBS = self->_appStateMonitorRBS;
    self->_appStateMonitorRBS = v58;

    v65[0] = v6;
    v65[1] = 3221225472;
    v65[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_387;
    v65[3] = &unk_1E8578610;
    v65[4] = self;
    v60 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E1A0, v65);
    appDockingListener = self->_appDockingListener;
    self->_appDockingListener = v60;

    v64[0] = v6;
    v64[1] = 3221225472;
    v64[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_396;
    v64[3] = &unk_1E8578610;
    v64[4] = self;
    v62 = (PLXPCListenerOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864E1C8, v64);
    appPrewarmListener = self->_appPrewarmListener;
    self->_appPrewarmListener = v62;
...
uint64_t __46__PLApplicationAgent_initOperatorDependancies__block_invoke(uint64_t a1)
{
  ...
  {
    *(_WORD *)v4 = 0;
    _os_log_debug_impl(&dword_1CAF47000, v2, OS_LOG_TYPE_DEBUG, "Application metadata being sent to CA", v4, 2u);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_3(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (qword_1ED8854A0 != -1)
      dispatch_once(&qword_1ED8854A0, block);
...
uint64_t __46__PLApplicationAgent_initOperatorDependancies__block_invoke_264(uint64_t a1)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v2;
    if (qword_1ED8854A8 != -1)
      dispatch_once(&qword_1ED8854A8, block);
    if (byte_1ED885471)
    {
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_2_276(uint64_t a1)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D80078], "isAppAnalyticsEnabled")
  ...
  if (v9 != (_DWORD)v11 || v13 != v15)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 67109890;
      ...
      v41 = 2112;
      v42 = v21;
      _os_log_debug_impl(&dword_1CAF47000, v22, OS_LOG_TYPE_DEBUG, "pid: %d, name: %@, state: %d, reasons: %@", buf, 0x22u);
    }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_3_290(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v7, "setEndowmentNamespaces:", &unk_1E8652670);
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_309(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "WidgetStats payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_314(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "WidgetUpdates payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_318(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "SuggestedWidgetReload payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_323(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "PosterUpdates payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_330(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "System Aperture payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_335(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "AmbientMode payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_340(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "LiveActivityUpdates payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_344(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "LiveActivityStats payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_348(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "AmbientModeActiveFace payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_354(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "AmbientModeLifetimePresentationCounter payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_360(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "AmbientModeMotionToWake payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_364(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "ControlCenterUpdates payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_368(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "ControlCenterStats payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_2_370(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v12;
    if (qword_1ED8854B0 != -1)
      dispatch_once(&qword_1ED8854B0, block);
    if (byte_1ED885472)
    {
      v33 = v6;
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "isApplication:", v11))
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v35[4] = v26;
      if (qword_1ED8854B8 != -1)
        dispatch_once(&qword_1ED8854B8, v35);
      if (byte_1ED885473)
      {
        v34 = v6;
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_387(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v18 = v7;
    if (qword_1ED8854C0 != -1)
      dispatch_once(&qword_1ED8854C0, &block);
    if (byte_1ED885474)
    {
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_396(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v17 = &__block_descriptor_40_e5_v8__0lu32l8;
    v18 = v7;
    if (qword_1ED8854C8 != -1)
      dispatch_once(&qword_1ED8854C8, &block);
    if (byte_1ED885475)
    {
...
- (BOOL)isApplication:(int)a3
{
  ...
  if (v6 && os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
  {
    *(_DWORD *)buf = 138412290;
    v12 = v6;
    _os_log_error_impl(&dword_1CAF47000, MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR, "Error to identify isApplication %@", buf, 0xCu);
  }
...
- (BOOL)checkAppReferenceCleanupNeeded
{
  ...
  if (!objc_msgSend(MEMORY[0x1E0D80078], "AppDeletionEnabled"))
    return 0;
  objc_msgSend(MEMORY[0x1E0D800B8], "sharedCore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_15:
          ...
          {
            *(_WORD *)v17 = 0;
            _os_log_impl(&dword_1CAF47000, v15, OS_LOG_TYPE_DEFAULT, "AppDeletion : Cleanup pending", v17, 2u);
          }
...
- (void)refreshAllAppsAndPlugins
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    if (qword_1ED8854D0 != -1)
      dispatch_once(&qword_1ED8854D0, v37);
    if (byte_1ED885476)
    {
  ...
  objc_msgSend(MEMORY[0x1E0D80078], "transactionWorkQueue");
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    if (qword_1ED8854D8 != -1)
      dispatch_once(&qword_1ED8854D8, v34);
    if (byte_1ED885477)
    {
...
- (void)createWidgetStatsAccountingEvents:(id)a3
{
  ...
  if (v18[3] > 0.0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      v22 = v3;
      _os_log_debug_impl(&dword_1CAF47000, v6, OS_LOG_TYPE_DEBUG, "WidgetStats Accounting: entries=%@", buf, 0xCu);
    }

    v13[0] = v5;
    v13[1] = 3221225472;
    v13[2] = __56__PLApplicationAgent_createWidgetStatsAccountingEvents___block_invoke_429;
    v13[3] = &unk_1E8581088;
    v15 = &v17;
    v7 = v4;
    v14 = v7;
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      v12 = (void *)*((_QWORD *)v18 + 3);
      *(_DWORD *)buf = 134218242;
      v22 = v12;
      v23 = 2112;
      v24 = v7;
      _os_log_debug_impl(&dword_1CAF47000, v8, OS_LOG_TYPE_DEBUG, "WidgetStats Accounting: totalFramesRendered=%f, identifierToWeight=%@", buf, 0x16u);
    }
...
- (void)logEventForwardAmbientModeLifetimeCounter:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", objc_msgSend(MEMORY[0x1E0D80078], "roundToSigFig:withSigFig:", v9, 2));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v7, "objectForKeyedSubscript:", CFSTR("LifetimePresentationCounter"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v13[0] = 67109378;
    v13[1] = v9;
    v14 = 2112;
    v15 = v12;
    _os_log_debug_impl(&dword_1CAF47000, v11, OS_LOG_TYPE_DEBUG, "AmbientModeLifetimePresentationCounter value from payload: %d, value after rounding: %@", (uint8_t *)v13, 0x12u);
...
void __49__PLApplicationAgent_logEventPointWidgetUpdates___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1E8634E60, CFSTR("Count"));
...
LABEL_10:
          ...
          objc_msgSend(v6, "setObject:forKeyedSubscript:", &unk_1E8634E78, CFSTR("PluginDeletedDate"));
          goto LABEL_12;
        }
      }
      objc_msgSend(v4, "extensionPointRecord");
...
- (void)logInstalledAppWithRecord:(id)a3 withBundleID:(id)a4 shouldMaskTimestamp:(BOOL)a5
{
  ...
  if ((v12 & 1) == 0)
  {
    ...
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    v24 = v91;
    objc_msgSend(v23, "lastEntryForKey:withSubEntryKey:", v22, v91);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v25)
    {
      ...
      if (v41 == 0.0)
      {
        ...
        if (v49 == 0.0)
        {
          ...
          v95 = v8;
          v96 = v91;
          -[PLOperator updateEntry:withBlock:](self, "updateEntry:withBlock:", v54, v92);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v50, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412290;
            v112 = v91;
            _os_log_debug_impl(&dword_1CAF47000, v50, OS_LOG_TYPE_DEBUG, "%@ was updated, modify version", buf, 0xCu);
          }

          v97[0] = MEMORY[0x1E0C809B0];
          v97[1] = 3221225472;
          v97[2] = __81__PLApplicationAgent_logInstalledAppWithRecord_withBundleID_shouldMaskTimestamp___block_invoke_454;
          v97[3] = &unk_1E8578598;
          v43 = &v98;
          v51 = v25;
          v98 = v51;
          ...
          v100 = v8;
          v101 = v91;
          -[PLOperator updateEntry:withBlock:](self, "updateEntry:withBlock:", v51, v97);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v112 = v91;
          _os_log_debug_impl(&dword_1CAF47000, v42, OS_LOG_TYPE_DEBUG, "AllApps entry %@ was deleted and reinstalled", buf, 0xCu);
        }

        v102[0] = MEMORY[0x1E0C809B0];
        v102[1] = 3221225472;
        v102[2] = __81__PLApplicationAgent_logInstalledAppWithRecord_withBundleID_shouldMaskTimestamp___block_invoke;
        v102[3] = &unk_1E8580398;
        v43 = &v103;
        v44 = v25;
        v103 = v44;
        v106 = v38;
        ...
        v46 = &v105;
        v105 = v8;
        -[PLOperator updateEntry:withBlock:](self, "updateEntry:withBlock:", v44, v102);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412290;
        v112 = v91;
        _os_log_debug_impl(&dword_1CAF47000, v27, OS_LOG_TYPE_DEBUG, "AllApps logInstalledAppWithRecord bundleID doesnt exist for %@", buf, 0xCu);
      }
      ...
      if ((objc_msgSend(MEMORY[0x1E0D7FFA0], "fullMode") & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 67109120;
          LODWORD(v112) = v5;
          _os_log_debug_impl(&dword_1CAF47000, v29, OS_LOG_TYPE_DEBUG, "AllApps shouldMaskTimestamp: %d", buf, 8u);
        }
        ...
        if (v5)
        {
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_debug_impl(&dword_1CAF47000, v30, OS_LOG_TYPE_DEBUG, "AllApps masking Timestamp", buf, 2u);
          }
          ...
          else
          {
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_debug_impl(&dword_1CAF47000, v56, OS_LOG_TYPE_DEBUG, "AllApps table is empty, using fuzzed timestamp", buf, 2u);
            }
      ...
      if (os_log_type_enabled(v59, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412290;
        v112 = v28;
        _os_log_debug_impl(&dword_1CAF47000, v59, OS_LOG_TYPE_DEBUG, "AllApps lastRow Timestamp: %@", buf, 0xCu);
      }
      ...
      if (os_log_type_enabled(v63, OS_LOG_TYPE_DEBUG))
      {
        ...
        objc_msgSend(v90, "distributorInfo");
        v88 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v88, "distributorID");
        v89 = (void *)objc_claimAutoreleasedReturnValue();
        *(_DWORD *)buf = 138412546;
        v112 = v89;
        v113 = 2112;
        v114 = v91;
        _os_log_debug_impl(&dword_1CAF47000, v63, OS_LOG_TYPE_DEBUG, "AllApps logging DistributorID: %@ for BundleID: %@", buf, 0x16u);
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[PLApplicationAgent isAppClipWithBundleID:](self, "isAppClipWithBundleID:", v91));
      v70 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v55, "setObject:forKeyedSubscript:", v70, CFSTR("AppIsClip"));

      objc_msgSend(v55, "setObject:forKeyedSubscript:", &unk_1E8634E78, CFSTR("AppDeletedDate"));
      v71 = &unk_1E8634EA8;
      ...
      if (v73)
        objc_msgSend(v55, "setObject:forKeyedSubscript:", &unk_1E8634E90, CFSTR("AppType"));
      objc_msgSend(v55, "setObject:forKeyedSubscript:", &unk_1E8634E78, CFSTR("AppUpdatedDate"));
      if (objc_msgSend(MEMORY[0x1E0D80078], "isAppAnalyticsEnabled"))
      {
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412290;
        v112 = v91;
        _os_log_debug_impl(&dword_1CAF47000, v86, OS_LOG_TYPE_DEBUG, "log new AppVersions entry %@\n", buf, 0xCu);
      }

      objc_msgSend(v55, "objectForKeyedSubscript:", CFSTR("AppBundleVersion"));
      v87 = (void *)objc_claimAutoreleasedReturnValue();
      +[PLApplicationAgent addAppVersion:withVersion:](PLApplicationAgent, "addAppVersion:withVersion:", v91, v87);
...
void __81__PLApplicationAgent_logInstalledAppWithRecord_withBundleID_shouldMaskTimestamp___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "setObject:forKeyedSubscript:", &unk_1E8634E78, CFSTR("AppDeletedDate"));
  if (*(_BYTE *)(a1 + 56))
  {
...
- (void)buildAppVersionDictionary:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "AllApps Building app verion dictionary from the db", buf, 2u);
  }
    ...
    if (v9 && objc_msgSend(v9, "length"))
    {
      ...
      if (v12)
      {
        ...
        if (v15)
        {
          if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
          {
            ...
            block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
            block[4] = v16;
            if (qword_1ED8854F0 != -1)
              dispatch_once(&qword_1ED8854F0, block);
            if (byte_1ED88547A)
            {
        ...
        else if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        {
          ...
          v38[4] = v31;
          if (qword_1ED8854F8 != -1)
            dispatch_once(&qword_1ED8854F8, v38);
          if (byte_1ED88547B)
          {
      ...
      else
      {
        if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        {
          ...
          v41[4] = v24;
          if (qword_1ED8854E8 != -1)
            dispatch_once(&qword_1ED8854E8, v41);
          if (byte_1ED885479)
          {
...
void __41__PLApplicationAgent_logInstalledPlugin___block_invoke_462(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 40), "setObject:forKeyedSubscript:", &unk_1E8634E78, CFSTR("PluginDeletedDate"));
...
- (void)logUninstalledApp:(id)a3
{
  ...
  v37[1] = v37;
  v37[2] = 0x3032000000;
  v37[3] = __Block_byref_object_copy__17;
  v37[4] = __Block_byref_object_dispose__17;
  objc_msgSend(MEMORY[0x1E0C99D68], "monotonicDate");
...
void __43__PLApplicationAgent_logUpdatedAppVersion___block_invoke(_QWORD *a1)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v22 = v9;
    if (qword_1ED885500 != -1)
      dispatch_once(&qword_1ED885500, &block);
    if (byte_1ED88547C)
    {
...
- (void)logAllApps
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "logAllApps was called", buf, 2u);
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v10 = (void *)MEMORY[0x1D179C2E0](v5);
        objc_msgSend(v9, "bundleIdentifier", (_QWORD)v13);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        -[PLApplicationAgent logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:](self, "logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:", v9, v11, 0);
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_debug_impl(&dword_1CAF47000, v12, OS_LOG_TYPE_DEBUG, "AllApps logAllApps end", buf, 2u);
  }
...
- (void)appReferenceCleanup
{
  ...
  if (self->_scheduledAppCleanup)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_debug_impl(&dword_1CAF47000, v2, OS_LOG_TYPE_DEBUG, "AppDeletion : Activity is scheduled.", buf, 2u);
    }
  ...
  else
  {
    ...
    v3 = objc_msgSend(MEMORY[0x1E0D7FF70], "changeClassProtection:", 1);
    PLLogCommon();
    v4 = objc_claimAutoreleasedReturnValue();
    ...
    if (v3)
    {
      ...
      {
        *(_WORD *)v7 = 0;
        _os_log_debug_impl(&dword_1CAF47000, v4, OS_LOG_TYPE_DEBUG, "AppDeletion : Changed class protection successfully", v7, 2u);
      }

      objc_msgSend(MEMORY[0x1E0D7FF70], "registerAppDeletionActivity");
    }
    else
    {
      if (v5)
      {
        *(_WORD *)v6 = 0;
        _os_log_debug_impl(&dword_1CAF47000, v4, OS_LOG_TYPE_DEBUG, "AppDeletion : Could not change class protection", v6, 2u);
      }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v25 = 2112;
            v26 = v14;
            _os_log_error_impl(&dword_1CAF47000, v15, OS_LOG_TYPE_ERROR, "could not refresh application record for %@: %@", buf, 0x16u);
          }
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if (objc_msgSend(v10, "isPlaceholder", v15))
        {
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_debug_impl(&dword_1CAF47000, v11, OS_LOG_TYPE_DEBUG, "app Record is placeHolder", buf, 2u);
          }
        }
        else
        {
          ...
          if (v12)
          {
            if (v14)
            {
              *(_DWORD *)buf = v15;
              v21 = v11;
              _os_log_debug_impl(&dword_1CAF47000, v13, OS_LOG_TYPE_DEBUG, "applicationsDidInstall: Update %@\n", buf, 0xCu);
            }
          ...
          else
          {
            if (v14)
            {
              *(_DWORD *)buf = v15;
              v21 = v11;
              _os_log_debug_impl(&dword_1CAF47000, v13, OS_LOG_TYPE_DEBUG, "applicationsDidInstall: Install %@", buf, 0xCu);
            }
...
- (void)applicationsDidUninstall:(id)a3
{
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if (objc_msgSend(v10, "isPlaceholder", v16))
        {
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_debug_impl(&dword_1CAF47000, v11, OS_LOG_TYPE_DEBUG, "app Proxy is placeHolder", buf, 2u);
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v16;
            ...
            v23 = 2112;
            v24 = v11;
            _os_log_debug_impl(&dword_1CAF47000, v13, OS_LOG_TYPE_DEBUG, "AppDeletion : Application Name %@ and bundle ID %@", buf, 0x16u);
          }
  ...
  if (objc_msgSend(v4, "count"))
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_debug_impl(&dword_1CAF47000, v14, OS_LOG_TYPE_DEBUG, "AppResume : Updating salt value", buf, 2u);
    }

    v15 = (id)objc_msgSend(MEMORY[0x1E0D80078], "generateAndUpdateSaltValue:", CFSTR("PLSaltBundleID"));
  }
