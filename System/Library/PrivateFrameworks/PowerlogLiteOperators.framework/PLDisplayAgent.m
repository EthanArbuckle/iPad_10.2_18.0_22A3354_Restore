...
LABEL_41:
    ...
    {
      -[PLDisplayAPLStats setAvgPower:](v13, "setAvgPower:", &unk_1E8652EE0);
    }
    else
    {
...
- (void)logDisplayAPL
{
  ...
  {
    v3 = objc_alloc(MEMORY[0x1E0D7FFB0]);
    +[PLOperator entryKeyForType:andName:](PLDisplayAgent, "entryKeyForType:andName:", *MEMORY[0x1E0D80370], CFSTR("APLStats"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = (void *)objc_msgSend(v3, "initWithEntryKey:", v4);

    -[PLDisplayAgent displayIOReportStats](self, "displayIOReportStats");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = -[PLDisplayAgent updateDisplayIOReportStats:logZeroFramesOnlyOnce:](self, "updateDisplayIOReportStats:logZeroFramesOnlyOnce:", v6, objc_msgSend(MEMORY[0x1E0D80078], "isPowerlogHelperd") ^ 1);

    if (v7
      && (-[PLDisplayAgent displayIOReportStats](self, "displayIOReportStats"),
          v8 = (void *)objc_claimAutoreleasedReturnValue(),
          objc_msgSend(v8, "displayAPLStats"),
          v9 = (void *)objc_claimAutoreleasedReturnValue(),
          v9,
          v8,
          v9))
    {
      objc_msgSend(v5, "setObject:forKey:", self->_lastForegroundAppAPL, CFSTR("bundleID"));
      -[PLDisplayIOReportStats displayAPLStats](self->_displayIOReportStats, "displayAPLStats");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "avgRed");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKey:", v11, CFSTR("AvgRed"));

      -[PLDisplayIOReportStats displayAPLStats](self->_displayIOReportStats, "displayAPLStats");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "avgGreen");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKey:", v13, CFSTR("AvgGreen"));

      -[PLDisplayIOReportStats displayAPLStats](self->_displayIOReportStats, "displayAPLStats");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v14, "avgBlue");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKey:", v15, CFSTR("AvgBlue"));

      -[PLDisplayIOReportStats displayAPLStats](self->_displayIOReportStats, "displayAPLStats");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v16, "frames");
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKey:", v17, CFSTR("Frames"));

      -[PLDisplayIOReportStats displayAPLStats](self->_displayIOReportStats, "displayAPLStats");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "avgPower");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKey:", v19, CFSTR("AvgPower"));

      -[PLDisplayIOReportStats displayAPLStats](self->_displayIOReportStats, "displayAPLStats");
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v20, "avgAPL");
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKey:", v21, CFSTR("AvgAPL"));
        ...
        && +[PLDisplayAgent shouldModelPowerFromAPL](PLDisplayAgent, "shouldModelPowerFromAPL"))
      {
        ...
        if (v22)
        {
          ...
          objc_msgSend(v23, "propertiesForKey:", CFSTR("IODisplayParameters"));
          v24 = objc_claimAutoreleasedReturnValue();

          -[NSObject objectForKeyedSubscript:](v24, "objectForKeyedSubscript:", CFSTR("brightness"));
          v25 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v25, "objectForKeyedSubscript:", CFSTR("value"));
          v26 = (void *)objc_claimAutoreleasedReturnValue();

          if ((int)objc_msgSend(v26, "intValue") < 1)
          {
            objc_msgSend(v5, "setObject:forKeyedSubscript:", &unk_1E8633378, CFSTR("AvgPower"));
          }
          else
          {
            -[NSObject objectForKeyedSubscript:](v24, "objectForKeyedSubscript:", CFSTR("BrightnessMilliNits"));
            v27 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            -[PLDisplayAgent displayIOReportStats](self, "displayIOReportStats");
            v47 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v47, "displayAPLStats");
            v46 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v46, "avgRed");
            v45 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v45, "doubleValue");
            v31 = v30;
            -[PLDisplayAgent displayIOReportStats](self, "displayIOReportStats");
            v44 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v44, "displayAPLStats");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v32, "avgGreen");
            v33 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v33, "doubleValue");
            v35 = v34;
            -[PLDisplayAgent displayIOReportStats](self, "displayIOReportStats");
            v36 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v36, "displayAPLStats");
            v37 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v37, "avgBlue");
            v49 = v24;
            v38 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v38, "doubleValue");
            -[PLDisplayAgent calculatePowerFromAPL:withAvgRed:withAvgGreen:withAvgBlue:](self, "calculatePowerFromAPL:withAvgRed:withAvgGreen:withAvgBlue:", v29, v31, v35, v39);
            v41 = v40;

            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v41);
            v42 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v5, "setObject:forKeyedSubscript:", v42, CFSTR("AvgPower"));
        ...
        else
        {
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_debug_impl(&dword_1CAF47000, v24, OS_LOG_TYPE_DEBUG, "iokitBacklight is nil; skipping power modeling",
              buf,
              2u);
          }
        }
      ...
      if (+[PLDisplayAgent shouldModelPowerFromAPL](PLDisplayAgent, "shouldModelPowerFromAPL"))
      {
        -[PLDisplayAgent modelDynamicDisplayPowerFromAPL:](self, "modelDynamicDisplayPowerFromAPL:", self->_displayIOReportStats);
      }
      else if (+[PLDisplayAgent shouldModelPowerFromIOMFB](PLDisplayAgent, "shouldModelPowerFromIOMFB"))
      {
        -[PLDisplayAgent modelDisplayPowerFromIOMFB:](self, "modelDisplayPowerFromIOMFB:", self->_displayIOReportStats);
      }
    }
    else if (objc_msgSend(MEMORY[0x1E0D80078], "isPowerlogHelperd"))
    {
      v51[0] = v5;
...
- (void)modelDisplayPowerFromIOMFB:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (qword_1ED883298 != -1)
      dispatch_once(&qword_1ED883298, block);
    if (byte_1ED883129)
    {
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v32 = objc_opt_class();
    if (qword_1ED8832A0 != -1)
      dispatch_once(&qword_1ED8832A0, &v28);
    if (byte_1ED88312A)
    {
...
{
  if (qword_1ED883260 != -1)
    dispatch_once(&qword_1ED883260, &__block_literal_global_1334);
  return byte_1ED883124;
}

+ (BOOL)shouldModelPowerFromAPL
{
  if (qword_1ED883258 != -1)
    dispatch_once(&qword_1ED883258, &__block_literal_global_1333);
  return byte_1ED883123;
}

+ (BOOL)shouldLogAPL
{
  if (qword_1ED883250 != -1)
    dispatch_once(&qword_1ED883250, &__block_literal_global_1332);
  return byte_1ED883122;
}
...
LABEL_36:
    ...
    && objc_msgSend(v6, "isEqual:", CFSTR("ColorAdaptationEnabled")))
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v43[4] = v19;
      if (qword_1ED8831D0 != -1)
        dispatch_once(&qword_1ED8831D0, v43);
      if (byte_1ED883112)
      {
  ...
  else
  {
    ...
    if (objc_msgSend(v6, "isEqual:", CFSTR("CBBlueReductionStatus")))
    {
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        v38[4] = v27;
        if (qword_1ED8831E0 != -1)
          dispatch_once(&qword_1ED8831E0, v38);
        if (byte_1ED883114)
        {
...
- (void)updateLastForegroundAppAPL:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      ...
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = objc_msgSend(v7, "isEqualToValue:", &unk_1E86333C0);

      objc_msgSend(v20, "objectForKey:", CFSTR("entry"));
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v9, "objectForKey:", CFSTR("ScreenWeight"));
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = objc_msgSend(v10, "isEqualToValue:", &unk_1E8652E30);
...
- (void)logEventForwardDisplayWithRawData:(id)a3 withDate:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        objc_msgSend(v9, "objectForKeyedSubscript:", CFSTR("lux"));
        v31 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v31, "doubleValue");
        LODWORD(location[0]) = 134217984;
        *(id *)((char *)location + 4) = v32;
        _os_log_debug_impl(&dword_1CAF47000, v15, OS_LOG_TYPE_DEBUG, "Value for Lux: %f", (uint8_t *)location, 0xCu);
    ...
    if (-[PLDisplayAgent isMIEActive](self, "isMIEActive"))
    {
      ...
      if (v24)
      {
        ...
        v25 = objc_alloc(MEMORY[0x1E0D80070]);
        ...
        v28 = (void *)objc_msgSend(v25, "initWithFireDate:withInterval:withTolerance:repeats:withUserInfo:withQueue:withBlock:", v26, 0, 0, v27, v33, 0.0, 0.0);
        -[PLDisplayAgent setUAmpsFilterTimer:](self, "setUAmpsFilterTimer:", v28);

        -[PLDisplayAgent uAmpsFilterTimer](self, "uAmpsFilterTimer");
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v29, "arm");
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(id *)((char *)location + 4) = v9;
        _os_log_debug_impl(&dword_1CAF47000, v30, OS_LOG_TYPE_DEBUG, "Event Forward display entry: %@", (uint8_t *)location, 0xCu);
      }
...
{
  if (qword_1ED883220 != -1)
    dispatch_once(&qword_1ED883220, &__block_literal_global_1296);
  return byte_1ED88311C;
}
...
- (void)qualifyDisplayPower:(id)a3
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_debug_impl(&dword_1CAF47000, v14, OS_LOG_TYPE_DEBUG, "brightness=%f, entry=%@, isHighBrightnessNow=%d, isHighBrightnessPrevious=%d", (uint8_t *)&v19, 0x22u);
  }
    ...
    || v7 > 80.0 != -[PLDisplayAgent isDisplayHighBrightness](self, "isDisplayHighBrightness"))
  {
    ...
    {
      LOWORD(v19) = 0;
      _os_log_debug_impl(&dword_1CAF47000, v15, OS_LOG_TYPE_DEBUG, "creating high brightness qualification event", (uint8_t *)&v19, 2u);
    }
...
- (void)modelDisplayPower:(id)a3
{
  ...
  if ((objc_msgSend(MEMORY[0x1E0D80020], "hasCapability:", 0) & 1) == 0)
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = v14;
      if (qword_1ED883268 != -1)
        dispatch_once(&qword_1ED883268, block);
      if (byte_1ED883125)
      {
...
{
  if (qword_1ED883228 != -1)
    dispatch_once(&qword_1ED883228, &__block_literal_global_1297);
  return byte_1ED88311D;
}
...
void __54__PLDisplayAgent_handleAFKInterfaceIOServiceCallback___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, NSObject *a4, const char *a5, size_t a6)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134217984;
    v23 = a4;
    _os_log_debug_impl(&dword_1CAF47000, v10, OS_LOG_TYPE_DEBUG, "Received msg at timestamp: %llu", buf, 0xCu);
  }

  if (a5 && a6)
  {
    errorString = 0;
    v11 = IOCFUnserializeWithSize(a5, a6, (CFAllocatorRef)*MEMORY[0x1E0C9AE00], 0, &errorString);
    v12 = errorString;
    v13 = (id)errorString;
    v14 = v13;
    if (v12)
    ...
    else if (v11)
    {
      ...
      if (v15 == TypeID)
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v23 = v11;
          _os_log_debug_impl(&dword_1CAF47000, v18, OS_LOG_TYPE_DEBUG, "Data: %@", buf, 0xCu);
        }

        objc_msgSend(MEMORY[0x1E0C99E08], "dictionaryWithDictionary:", v11);
        v19 = objc_claimAutoreleasedReturnValue();
        objc_msgSend(*(id *)(a1 + 32), "fillInBuiltinDisplayBrightnessParameters:", v19);
        PLLogDisplay();
        v20 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v23 = v19;
          _os_log_debug_impl(&dword_1CAF47000, v20, OS_LOG_TYPE_DEBUG, "Final data to be logged: %@", buf, 0xCu);
        }

        objc_msgSend(*(id *)(a1 + 32), "handleAFKInterfaceMsg:", v19);
      }
      else
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_error_impl(&dword_1CAF47000, v18, OS_LOG_TYPE_ERROR, "Msg is not a dictionary", buf, 2u);
        }
        v11 = v18;
      }
      goto LABEL_9;
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      v23 = v14;
      _os_log_error_impl(&dword_1CAF47000, v11, OS_LOG_TYPE_ERROR, "Error unserializing buffer: %@", buf, 0xCu);
    }
LABEL_9:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl(&dword_1CAF47000, v14, OS_LOG_TYPE_ERROR, "Input buffer is empty", buf, 2u);
  }
LABEL_12:
...
LABEL_9:
  ...
  if ((v25 & 1) == 0)
  {
    v31 = 0;
    v32 = 0;
    objc_msgSend(MEMORY[0x1E0D80078], "getCurrentMonotonicAndMachAbsTime:machAbsTime:machContTime:", &v31, 0, &v32);
    v26 = v31;
...
LABEL_15:
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
      {
        v44 = 138412290;
        v45 = v30;
        _os_log_impl(&dword_1CAF47000, v35, OS_LOG_TYPE_DEFAULT, "Not logging brightness value: %@", (uint8_t *)&v44, 0xCu);
      }
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "alsOn") & 1) == 0)
  {
    ...
    if (v16)
    {
      ...
      v69 = CFSTR("ALS");
      v70 = objc_opt_class();
      if (qword_1ED8831A0 == -1)
      {
        v18 = CFSTR("ALS");
      }
      else
      {
        dispatch_once(&qword_1ED8831A0, block);
        v18 = (__CFString *)v69;
      }
      v19 = byte_1ED88310C;
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      v65[0] = v17;
      v65[1] = 3221225472;
      v65[2] = __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1213;
      v65[3] = &unk_1E8578738;
      v66 = CFSTR("ALS");
      v67 = objc_opt_class();
      if (qword_1ED8831A8 == -1)
      {
        v32 = CFSTR("ALS");
      }
      else
      {
        dispatch_once(&qword_1ED8831A8, v65);
        v32 = (__CFString *)v66;
      }
      v33 = byte_1ED88310D;
      ...
      if (v33)
      {
        ...
        v40 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v37, "logMessage:fromFile:fromFunction:fromLineNumber:", v36, v39, v40, 3304);
    ...
    if (v42 == 1)
    {
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        v62[0] = v17;
        v62[1] = 3221225472;
        v62[2] = __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1219;
        v62[3] = &unk_1E8578738;
        v63 = CFSTR("ALS");
        v64 = objc_opt_class();
        if (qword_1ED8831B0 == -1)
        {
          v43 = CFSTR("ALS");
        }
        else
        {
          dispatch_once(&qword_1ED8831B0, v62);
          v43 = (__CFString *)v63;
        }
        v44 = byte_1ED88310E;
        ...
        if (v44)
        {
          ...
          objc_msgSend(*(id *)(a1 + 32), "lastALSPowerSaved");
          objc_msgSend(v47, "stringWithFormat:", CFSTR("Setting lastALSPowerSaved=%f"), v48);
          ...
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "-[PLDisplayAgent handleBrightnessClientNotification:withValue:]_block_invoke_2");
          v53 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v50, "logMessage:fromFile:fromFunction:fromLineNumber:", v49, v52, v53, 3308);
      ...
      v61[0] = v17;
      v61[1] = 3221225472;
      v61[2] = __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1223;
      v61[3] = &unk_1E85793E0;
      v61[4] = *(_QWORD *)(a1 + 32);
      objc_msgSend(v55, "scheduledTimerWithMonotonicFireDate:withInterval:withQueue:withBlock:", v56, v57, v61, 0.0);
      v58 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(*(id *)(a1 + 32), "setLogLastALSPowerSavedTimer:", v58);
...
+ (id)entryEventForwardDefinitionALSUserPreferences
{
  ...
  v101[1] = v3;
  v102[0] = &unk_1E8652E70;
  v102[1] = &unk_1E8633318;
  v101[2] = *MEMORY[0x1E0D80338];
  v102[2] = &unk_1E8633330;
...
- (PLDisplayAgent)init
{
  ...
  uint64_t v63;
  uint64_t v64;
  PLIOKitOperatorComposition *v65;
  ...
  __CFRunLoop *Main;
  PLIOKitOperatorComposition *v73;
  ...
  if ((objc_msgSend(MEMORY[0x1E0D80020], "isHomePod") & 1) != 0)
    goto LABEL_2;
  v101.receiver = self;
  v101.super_class = (Class)PLDisplayAgent;
  v4 = -[PLAgent init](&v101, sel_init);
  if (!v4)
  {
LABEL_61:
    self = v4;
  ...
  {
    objc_msgSend(v9, "addObject:", CFSTR("BacklightPowerMilliWatts"));
    objc_msgSend(v9, "addObject:", CFSTR("BacklightPowerNits"));
    objc_msgSend(v9, "addObject:", CFSTR("DisplayBrightness"));
    objc_msgSend(v9, "addObject:", CFSTR("CBSupportsFinalCommit"));
    objc_msgSend(v9, "addObject:", CFSTR("CBFinalBrightnessCommit"));
    objc_msgSend(v9, "addObject:", CFSTR("DisplayBrightnessAuto"));
    objc_msgSend(v9, "addObject:", CFSTR("PowerLogReport"));
    objc_msgSend(v9, "addObject:", CFSTR("CBBlueReductionStatus"));
    if (objc_msgSend(MEMORY[0x1E0D80020], "hasAOD"))
    {
      objc_msgSend(v9, "addObject:", CFSTR("AODRampTelemetry"));
      objc_msgSend(v9, "addObject:", CFSTR("AODCurveUpdate"));
      objc_msgSend(v9, "addObject:", CFSTR("AODWakeFromALSThreshold"));
      objc_msgSend(v9, "addObject:", CFSTR("CBAmbientLightTelemetry"));
    }
    if (+[PLDisplayAgent shouldLogLuxStats](PLDisplayAgent, "shouldLogLuxStats"))
    {
      v10 = CFSTR("RLuxStats");
LABEL_15:
  ...
  {
    v10 = CFSTR("InactiveScreenHistory");
    goto LABEL_15;
  }
  if (objc_msgSend(MEMORY[0x1E0D15718], "supportsAdaptation"))
  {
    v11 = (CBAdaptationClient *)objc_alloc_init(MEMORY[0x1E0D15718]);
    colorAdaptationClient = v4->_colorAdaptationClient;
    v4->_colorAdaptationClient = v11;

    if (v4->_colorAdaptationClient)
    {
      objc_msgSend(v9, "addObject:", CFSTR("ColorAdaptationEnabled"));
    }
    else if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      v98[0] = v6;
      v98[1] = 3221225472;
      v98[2] = __22__PLDisplayAgent_init__block_invoke_2;
      v98[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      v98[4] = objc_opt_class();
      if (qword_1ED883140 != -1)
        dispatch_once(&qword_1ED883140, v98);
      if (_MergedGlobals_1_28)
      {
        ...
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v15, "logMessage:fromFile:fromFunction:fromLineNumber:", v14, v17, v18, 1461);
  ...
  v23 = objc_alloc(MEMORY[0x1E0D80070]);
  -[PLOperator workQueue](v4, "workQueue");
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v96[0] = v6;
  v96[1] = 3221225472;
  v96[2] = __22__PLDisplayAgent_init__block_invoke_989;
  v96[3] = &unk_1E8578078;
  v25 = v4;
  v97 = v25;
  v26 = objc_msgSend(v23, "initWithFireDate:withInterval:withTolerance:repeats:withUserInfo:withQueue:withBlock:", 0, 1, 0, v24, v96, 1.0, 0.0);
  v27 = v25[18];
  v25[18] = (id)v26;

  objc_msgSend(v25[18], "arm");
  v28 = objc_alloc_init(MEMORY[0x1E0D15710]);
  v29 = v25[16];
  v25[16] = v28;

  if (!v25[16] && objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    v95[0] = v6;
    v95[1] = 3221225472;
    v95[2] = __22__PLDisplayAgent_init__block_invoke_999;
    v95[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    v95[4] = objc_opt_class();
    if (qword_1ED883150 != -1)
      dispatch_once(&qword_1ED883150, v95);
    if (byte_1ED883102)
    {
      v30 = v6;
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "-[PLDisplayAgent init]");
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "logMessage:fromFile:fromFunction:fromLineNumber:", v31, v34, v35, 1489);
  ...
  {
    objc_msgSend(v25, "brightnessSystemClient");
    v37 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v37)
    {
      ...
      v93[0] = v6;
      v93[1] = 3221225472;
      v93[2] = __22__PLDisplayAgent_init__block_invoke_1002;
      v93[3] = &unk_1E857BA78;
      v94 = v25;
      objc_msgSend(v38, "registerNotificationBlock:forProperties:", v93, v9);

    }
  }
  objc_msgSend(v25, "brightnessSystemClient");
  v39 = (void *)objc_claimAutoreleasedReturnValue();
  v40 = (void *)objc_msgSend(v39, "copyPropertyForKey:", CFSTR("CBSupportsFinalCommit"));
  objc_msgSend(v25, "setSupportsFinalBrightnessCommit:", objc_msgSend(v40, "BOOLValue"));

  PLLogDisplay();
  v41 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
  {
    v81 = objc_msgSend(v25, "supportsFinalBrightnessCommit");
    *(_DWORD *)buf = 67109120;
    *(_DWORD *)&buf[4] = v81;
    _os_log_debug_impl(&dword_1CAF47000, v41, OS_LOG_TYPE_DEBUG, "Copied kCBSupportsFinalBrightnessCommit value: %d", buf, 8u);
  }
    ...
    && (objc_msgSend(MEMORY[0x1E0D80078], "isPowerlogHelperd") & 1) == 0)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_1CAF47000, v42, OS_LOG_TYPE_DEFAULT, "IO object: seting up notification", buf, 2u);
    }

    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    v43 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v25, "setAfkEndpoints:", v43);

    v44 = objc_alloc(MEMORY[0x1E0D7FFE8]);
    v45 = *MEMORY[0x1E0D803B0];
    v91[0] = v6;
    v91[1] = 3221225472;
    v91[2] = __22__PLDisplayAgent_init__block_invoke_1006;
    v91[3] = &unk_1E857BAA0;
    v46 = v25;
    v92 = v46;
    v47 = objc_msgSend(v44, "initWithOperator:forDynamicServiceClass:forNotificationType:withMatchBlock:", v46, v45, "IOServiceMatched", v91);
    v48 = v46[10];
    v46[10] = (id)v47;

    v49 = objc_alloc(MEMORY[0x1E0D80070]);
    objc_msgSend(v46, "workQueue");
    v50 = (void *)objc_claimAutoreleasedReturnValue();
    v89[0] = v6;
    v89[1] = 3221225472;
    v89[2] = __22__PLDisplayAgent_init__block_invoke_2_1008;
    v89[3] = &unk_1E8578078;
    v51 = v46;
    v90 = v51;
    v52 = (void *)objc_msgSend(v49, "initWithFireDate:withInterval:withTolerance:repeats:withUserInfo:withQueue:withBlock:", 0, 1, 0, v50, v89, 10.0, 10.0);
    objc_msgSend(v51, "setDcpTimeoffsetCalibTimer:", v52);

    objc_msgSend(v51, "dcpTimeoffsetCalibTimer");
    v53 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v53, "arm");

  }
  v54 = objc_alloc(MEMORY[0x1E0D7FFE8]);
  v87[0] = v6;
  v87[1] = 3221225472;
  v87[2] = __22__PLDisplayAgent_init__block_invoke_1011;
  v87[3] = &unk_1E857B1E0;
  v55 = v25;
  v88 = v55;
  v56 = objc_msgSend(v54, "initWithOperator:forService:withBlock:", v55, CFSTR("AppleARMBacklight"), v87);
  v57 = v55[9];
  v55[9] = (id)v56;

  if (+[PLDisplayAgent shouldLogBacklightControl](PLDisplayAgent, "shouldLogBacklightControl"))
  {
    v58 = objc_alloc(MEMORY[0x1E0D7FFE8]);
    v85[0] = v6;
    v85[1] = 3221225472;
    v85[2] = __22__PLDisplayAgent_init__block_invoke_1031;
    v85[3] = &unk_1E857B1E0;
    v59 = v55;
    v86 = v59;
    v60 = objc_msgSend(v58, "initWithOperator:forService:withBlock:", v59, CFSTR("backlight-control"), v85);
    v61 = v59[11];
    v59[11] = (id)v60;

  }
  v62 = objc_alloc(MEMORY[0x1E0D7FFE8]);
  v63 = v6;
  v64 = *MEMORY[0x1E0D803B8];
  v83[0] = v63;
  v83[1] = 3221225472;
  v83[2] = __22__PLDisplayAgent_init__block_invoke_2_1034;
  v83[3] = &unk_1E857B1E0;
  self = v55;
  v84 = self;
  v65 = (PLIOKitOperatorComposition *)objc_msgSend(v62, "initWithOperator:forService:withBlock:", self, v64, v83);
  iokitDisplay = self->_iokitDisplay;
  self->_iokitDisplay = v65;
    ...
    && (objc_msgSend(MEMORY[0x1E0D80078], "isPowerlogHelperd") & 1) == 0)
  {
    *(_QWORD *)buf = 0;
    ...
    if (MainDisplay || !v68)
    {
      ...
      {
        *(_WORD *)v82 = 0;
        _os_log_error_impl(&dword_1CAF47000, v70, OS_LOG_TYPE_ERROR, "Error initializing IOMFB", v82, 2u);
      }
    ...
    else
    {
      ...
      {
        *(_WORD *)v82 = 0;
        _os_log_debug_impl(&dword_1CAF47000, v70, OS_LOG_TYPE_DEBUG, "IOMFB initializing", v82, 2u);
      }
  ...
  v73 = (PLIOKitOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D7FFE8]), "initWithOperator:forService:", self, CFSTR("AppleMultitouchSPI"));
  iokitTouch = self->_iokitTouch;
  self->_iokitTouch = v73;

  if (self->_iokitDisplay || v55[9] || self->_iokitTouch || v25[16])
  {
    self->_userTouch = 0;
...
void __22__PLDisplayAgent_init__block_invoke_989(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    if (objc_msgSend(*(id *)(a1 + 32), "isDebugEnabled"))
    {
      ...
      objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      v7 = -[PLEventForwardDisplayEntry initEntryWithRawData:](v5, "initEntryWithRawData:", v6);
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
        block[4] = v8;
        if (qword_1ED883148 != -1)
          dispatch_once(&qword_1ED883148, block);
        if (byte_1ED883101)
        {
          v9 = (void *)MEMORY[0x1E0CB3940];
          objc_msgSend(v7, "objectForKeyedSubscript:", CFSTR("Brightness"));
          v10 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          v13 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v9, "stringWithFormat:", CFSTR("Writing backlight entry:%@ with date: %@"), v10, v13);
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          v18 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v15, "logMessage:fromFile:fromFunction:fromLineNumber:", v14, v17, v18, 1474);
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
    {
      objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      v28 = (void *)MEMORY[0x1E0D80088];
      objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntryDate");
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v28, "formattedStringForDate:", v29);
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138412546;
      v38 = v27;
      v39 = 2112;
      v40 = v30;
      _os_log_debug_impl(&dword_1CAF47000, v20, OS_LOG_TYPE_DEBUG, "BackLight entry not nill. Writing backlight entry:%@ with date: %@", buf, 0x16u);

    }
    v21 = *(void **)(a1 + 32);
    objc_msgSend(v21, "pendingBacklightEntry");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntryDate");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v21, "logEventForwardDisplayWithRawData:withDate:", v22, v23);
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_debug_impl(&dword_1CAF47000, v24, OS_LOG_TYPE_DEBUG, "Setting pending backlight entry and date as nil", buf, 2u);
    }

    objc_msgSend(*(id *)(a1 + 32), "setPendingBacklightEntry:", 0);
    objc_msgSend(*(id *)(a1 + 32), "setPendingBacklightEntryDate:", 0);
  }
  else
  {
    PLLogDisplay();
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
    {
      v31 = (void *)MEMORY[0x1E0D80088];
      objc_msgSend(*(id *)(a1 + 32), "backlightFilterTimer");
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "fireDate");
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v31, "formattedStringForDate:", v33);
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0D80088], "formattedStringForDate:", v3);
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138412546;
      v38 = v34;
      v39 = 2112;
      v40 = v35;
      _os_log_debug_impl(&dword_1CAF47000, v25, OS_LOG_TYPE_DEBUG, "Stop backlight entry filter timer timer.fireDate=%@ fireDate=%@", buf, 0x16u);

    }
    objc_msgSend(*(id *)(a1 + 32), "backlightFilterTimer");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v26, "setTimerActive:", 0);
...
void __22__PLDisplayAgent_init__block_invoke_2_1008(uint64_t a1)
{
  ...
  v3 = v2;
  objc_msgSend(*(id *)(a1 + 32), "currAFKSystemTimestamp");
  v5 = v4;
  objc_msgSend(*(id *)(a1 + 32), "currMonoTimestamp");
  if (v6 <= 0.0
    || (objc_msgSend(*(id *)(a1 + 32), "currAFKSystemTimestamp"), v7 <= 0.0)
    || (v8 = v3 - v5, objc_msgSend(*(id *)(a1 + 32), "currAFKSystemTimeOffset"), v8 == v9))
  {
    objc_msgSend(*(id *)(a1 + 32), "dcpTimeoffsetCalibTimer");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      LOWORD(v16) = 0;
      _os_log_debug_impl(&dword_1CAF47000, v12, OS_LOG_TYPE_DEBUG, "Canceling AFK time calibration timer", (uint8_t *)&v16, 2u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v20 = 2048;
      v21 = v15;
      _os_log_debug_impl(&dword_1CAF47000, v10, OS_LOG_TYPE_DEBUG, "New AFK time offset: %f, from mono timestamp: %f, afk time: %f", (uint8_t *)&v16, 0x20u);
    }

    objc_msgSend(*(id *)(a1 + 32), "setCurrAFKSystemTimeOffset:", v8);
  }
}
...
void __22__PLDisplayAgent_init__block_invoke_1011(uint64_t a1, uint64_t a2, int a3)
{
  ...
  void *v21;
  id v22;
  PLEventForwardDisplayEntry *v23;
  void *v24;
  id v25;
  uint64_t v26;
  void *v27;
  ...
  if (a3 == -536870608)
  {
    ...
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = +[PLDisplayAgent shouldLogFromDCP](PLDisplayAgent, "shouldLogFromDCP");
    v6 = *(void **)(a1 + 32);
    if (v5)
    {
      objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
...
LABEL_26:
      ...
      objc_msgSend(v8, "objectForKey:", CFSTR("min"));
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = objc_msgSend(v11, "longValue");

      objc_msgSend(v8, "objectForKey:", CFSTR("max"));
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = objc_msgSend(v13, "longValue");

      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", (double)(v10 - v12) * 100.0 / (double)(v14 - v12));
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v16, "setObject:forKeyedSubscript:", v15, CFSTR("Brightness"));

      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", v10);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "setObject:forKeyedSubscript:", v17, CFSTR("SliderValue"));
    ...
    else
    {
      ...
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "setPendingBacklightEntry:", v19);
      ...
      if (!v20)
      {
        objc_msgSend(MEMORY[0x1E0C99D68], "monotonicDate");
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(*(id *)(a1 + 32), "setPendingBacklightEntryDate:", v21);

      }
      if (objc_msgSend(*(id *)(a1 + 32), "isDebugEnabled"))
      {
        v22 = -[PLEventForwardDisplayEntry initEntryWithRawData:]([PLEventForwardDisplayEntry alloc], "initEntryWithRawData:", v4);
        v23 = [PLEventForwardDisplayEntry alloc];
        objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        v25 = -[PLEventForwardDisplayEntry initEntryWithRawData:](v23, "initEntryWithRawData:", v24);
        ...
        if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        {
          ...
          block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
          block[4] = v26;
          if (qword_1ED883158 != -1)
            dispatch_once(&qword_1ED883158, block);
          if (byte_1ED883103)
          {
            v27 = (void *)MEMORY[0x1E0CB3940];
            objc_msgSend(v22, "objectForKeyedSubscript:", CFSTR("Brightness"));
            v28 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v25, "objectForKeyedSubscript:", CFSTR("Brightness"));
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            v30 = (void *)MEMORY[0x1E0D80088];
            objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntryDate");
            v31 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v30, "formattedStringForDate:", v31);
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v27, "stringWithFormat:", CFSTR("rawData.brightness=%@ self.pendingBacklightEntry.brightness=%@ self.pendingBacklightEntryDate=%@"), v28, v29, v32);
            v33 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "-[PLDisplayAgent init]_block_invoke");
            v37 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v34, "logMessage:fromFile:fromFunction:fromLineNumber:", v33, v36, v37, 1556);
      ...
      objc_msgSend(*(id *)(a1 + 32), "backlightFilterTimer");
      v39 = (void *)objc_claimAutoreleasedReturnValue();
      v40 = objc_msgSend(v39, "timerActive");
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        v51[0] = MEMORY[0x1E0C809B0];
        v51[1] = 3221225472;
        v51[2] = __22__PLDisplayAgent_init__block_invoke_1025;
        v51[3] = &__block_descriptor_40_e5_v8__0lu32l8;
        v51[4] = v41;
        if (qword_1ED883160 != -1)
          dispatch_once(&qword_1ED883160, v51);
        if (byte_1ED883104)
        {
          v42 = (void *)MEMORY[0x1E0CB3940];
          objc_msgSend(MEMORY[0x1E0D80088], "formattedStringForDate:", v8);
          v43 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v42, "stringWithFormat:", CFSTR("Start backlight entry filter timer fireDate=%@"), v43);
          v44 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          v48 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v45, "logMessage:fromFile:fromFunction:fromLineNumber:", v44, v47, v48, 1561);
      ...
      objc_msgSend(*(id *)(a1 + 32), "backlightFilterTimer");
      v50 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v50, "setFireDate:", v8);
...
uint64_t __46__PLDisplayAgent_initTaskOperatorDependancies__block_invoke(uint64_t a1)
{
    ...
    || (result = objc_msgSend(MEMORY[0x1E0D7FFA0], "BOOLForKey:", CFSTR("AZLFullMode")), (_DWORD)result))
  {
      ...
      && objc_msgSend(*(id *)(a1 + 32), "AZLSnapshotsEntries") >= 21600)
    {
      ...
      {
        *(_WORD *)v4 = 0;
        _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "AZLSnapShot table is full", v4, 2u);
      }
...
- (void)initOperatorDependancies
{
  ...
  _QWORD *v4;
  uint64_t v5;
  PLDisplayIOReportStats *v6;
  PLDisplayIOReportStats *displayIOReportStats;
  void *v8;
  id v9;
  void *v10;
  PLDisplayIOReportStats *v11;
  ...
  void *v48;
  NSObject *v49;
  PLNSNotificationOperatorComposition *v50;
  ...
  -[PLDisplayAgent initializeScreenOnAccumulation](self, "initializeScreenOnAccumulation");
  -[PLDisplayAgent setIsMultitouchLoggingEnabled:](self, "setIsMultitouchLoggingEnabled:", objc_msgSend(MEMORY[0x1E0D7FFA0], "BOOLForKey:ifNotSet:", CFSTR("MultitouchLoggingEnabled"), 0));
  -[PLDisplayAgent setLastForegroundAppAPL:](self, "setLastForegroundAppAPL:", 0);
  v3 = +[PLDisplayAgent shouldLogAPL](PLDisplayAgent, "shouldLogAPL");
  v4 = (_QWORD *)MEMORY[0x1E0D80378];
  v5 = MEMORY[0x1E0C809B0];
  if (v3)
  {
    v6 = objc_alloc_init(PLDisplayIOReportStats);
    displayIOReportStats = self->_displayIOReportStats;
    self->_displayIOReportStats = v6;

    +[PLOperator entryKeyForType:andName:](PLScreenStateAgent, "entryKeyForType:andName:", *v4, CFSTR("ScreenState"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = objc_alloc(MEMORY[0x1E0D7FFC8]);
    v61[0] = v5;
    v61[1] = 3221225472;
    v61[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke;
    v61[3] = &unk_1E8577F48;
    v61[4] = self;
    v10 = (void *)objc_msgSend(v9, "initWithOperator:forEntryKey:withFilter:withBlock:", self, v8, MEMORY[0x1E0C9AA70], v61);
    -[PLDisplayAgent setApplicationNotification:](self, "setApplicationNotification:", v10);

  }
  if ((objc_msgSend(MEMORY[0x1E0D80020], "hasCapability:", 8) & 1) != 0
    || objc_msgSend(MEMORY[0x1E0D80020], "hasAOT"))
  {
    if (objc_msgSend(MEMORY[0x1E0D80020], "hasCapability:", 8))
    {
      v11 = objc_alloc_init(PLDisplayIOReportStats);
      displayIOReportAZLStats = self->_displayIOReportAZLStats;
      self->_displayIOReportAZLStats = v11;
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_debug_impl(&dword_1CAF47000, v13, OS_LOG_TYPE_DEBUG, "Initializing AZL Stats", buf, 2u);
      }

    }
    v60[0] = v5;
    v60[1] = 3221225472;
    v60[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_1048;
    v60[3] = &unk_1E8577F48;
    v60[4] = self;
    objc_msgSend(MEMORY[0x1E0D7FFC8], "significantBatteryChangeNotificationWithOperator:withBlock:", self, v60);
    v14 = (PLEntryNotificationOperatorComposition *)objc_claimAutoreleasedReturnValue();
    batteryLevelChanged = self->_batteryLevelChanged;
    self->_batteryLevelChanged = v14;
    ...
    v59[0] = v5;
    v59[1] = 3221225472;
    v59[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_2;
    v59[3] = &unk_1E8577F48;
    v59[4] = self;
    v18 = (void *)objc_msgSend(v17, "initWithOperator:forEntryKey:withFilter:withBlock:", self, v16, MEMORY[0x1E0C9AA70], v59);
    -[PLDisplayAgent setApplicationNotification:](self, "setApplicationNotification:", v18);
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "hasCapability:", 3))
  {
    ...
    self->_displayStateChanges = v19;

    v21 = objc_alloc(MEMORY[0x1E0D7FFC8]);
    v58[0] = v5;
    v58[1] = 3221225472;
    v58[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_3;
    v58[3] = &unk_1E8577F48;
    v58[4] = self;
    v22 = (void *)objc_msgSend(v21, "initWithOperator:forEntryKey:withFilter:withBlock:", self, CFSTR("PLIOReportAgent_EventBackward_IOMFBScanoutHistogram"), MEMORY[0x1E0C9AA70], v58);
    -[PLDisplayAgent setIOMFBScanoutNotification:](self, "setIOMFBScanoutNotification:", v22);

  }
  if (objc_msgSend(MEMORY[0x1E0D80020], "hasAOD"))
  {
    v23 = objc_alloc_init(PLDisplayIOReportAODStats);
    displayIOReportAODStats = self->_displayIOReportAODStats;
    self->_displayIOReportAODStats = v23;
    ...
    v57[0] = v5;
    v57[1] = 3221225472;
    v57[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_4;
    v57[3] = &unk_1E8577F48;
    v57[4] = self;
    v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D7FFC8]), "initWithOperator:forEntryKey:withBlock:", self, v25, v57);
    -[PLDisplayAgent setAodstateChangedNotification:](self, "setAodstateChangedNotification:", v26);

  }
  objc_msgSend(MEMORY[0x1E0D80078], "powerModelForOperatorName:", CFSTR("display"));
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", objc_msgSend(MEMORY[0x1E0D80020], "kPLDisplayClassOfDevice"));
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "internalBuild")
    && -[PLDisplayAgent isMultitouchLoggingEnabled](self, "isMultitouchLoggingEnabled"))
  {
    v56[0] = v5;
    v56[1] = 3221225472;
    v56[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_1060;
    v56[3] = &unk_1E8578610;
    v56[4] = self;
    v32 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864BF68, v56);
    -[PLDisplayAgent setMultitouchXPCListener:](self, "setMultitouchXPCListener:", v32);

  }
  -[PLDisplayAgent logEventNonePanelStats](self, "logEventNonePanelStats");
  self->_ambientLightSensorHIDClientRef = -[PLDisplayAgent setUpIOHIDAmbientLightSensorSystemClient](self, "setUpIOHIDAmbientLightSensorSystemClient");
  if (+[PLDisplayAgent shouldLogKeyboardBrightness](PLDisplayAgent, "shouldLogKeyboardBrightness"))
  {
    v33 = (KeyboardBrightnessClient *)objc_alloc_init(MEMORY[0x1E0D15730]);
    kbClient = self->_kbClient;
    self->_kbClient = v33;

    if (self->_kbClient)
    {
      v35 = objc_msgSend(MEMORY[0x1E0D80020], "isiPad");
      v36 = (uint64_t *)MEMORY[0x1E0D15740];
      if (!v35)
        v36 = (uint64_t *)MEMORY[0x1E0D15738];
      v37 = *v36;
      -[PLDisplayAgent kbClient](self, "kbClient");
      v38 = (void *)objc_claimAutoreleasedReturnValue();
      v54[0] = v5;
      v54[1] = 3221225472;
      v54[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_1070;
      v54[3] = &unk_1E857BAC8;
      v54[4] = self;
      objc_msgSend(v38, "registerNotificationForKeys:keyboardID:block:", &unk_1E86500D8, v37, v54);

      v39 = objc_alloc(MEMORY[0x1E0D80070]);
      -[PLOperator workQueue](self, "workQueue");
      v40 = (void *)objc_claimAutoreleasedReturnValue();
      v53[0] = v5;
      v53[1] = 3221225472;
      v53[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_1081;
      v53[3] = &unk_1E8578078;
      v53[4] = self;
      v41 = (void *)objc_msgSend(v39, "initWithFireDate:withInterval:withTolerance:repeats:withUserInfo:withQueue:withBlock:", 0, 1, 0, v40, v53, 0.5, 0.0);
      -[PLDisplayAgent setKeyboardBrightnessFilterTimer:](self, "setKeyboardBrightnessFilterTimer:", v41);

      -[PLDisplayAgent keyboardBrightnessFilterTimer](self, "keyboardBrightnessFilterTimer");
      v42 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v42, "arm");
    ...
    else if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      block[0] = v5;
      block[1] = 3221225472;
      block[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_2_1063;
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = objc_opt_class();
      if (qword_1ED883168 != -1)
        dispatch_once(&qword_1ED883168, block);
      if (byte_1ED883105)
      {
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("KeyboardBrightnessClient init fail!"));
        ...
        v46 = (void *)objc_claimAutoreleasedReturnValue();
        v47 = (void *)v43;
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "-[PLDisplayAgent initOperatorDependancies]");
        v48 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v44, "logMessage:fromFile:fromFunction:fromLineNumber:", v47, v46, v48, 1912);
  ...
  v52[0] = v5;
  v52[1] = 3221225472;
  v52[2] = __42__PLDisplayAgent_initOperatorDependancies__block_invoke_2_1085;
  v52[3] = &unk_1E8577F48;
  v52[4] = self;
  v50 = (PLNSNotificationOperatorComposition *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80010]), "initWithOperator:forNotification:withBlock:", self, CFSTR("PLThermalMonitorNotification"), v52);
  thermalMonitorListener = self->_thermalMonitorListener;
  self->_thermalMonitorListener = v50;
...
void __42__PLDisplayAgent_initOperatorDependancies__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    v5 = 138412290;
    v6 = v3;
    _os_log_debug_impl(&dword_1CAF47000, v4, OS_LOG_TYPE_DEBUG, "Got callback for logAODChange: %@", (uint8_t *)&v5, 0xCu);
  }
...
void __42__PLDisplayAgent_initOperatorDependancies__block_invoke_1070(uint64_t a1, void *a2, void *a3)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v7;
    if (qword_1ED883170 != -1)
      dispatch_once(&qword_1ED883170, block);
    if (byte_1ED883106)
    {
  ...
  if ((v20 & 1) == 0)
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v32[4] = v22;
      if (qword_1ED883178 != -1)
        dispatch_once(&qword_1ED883178, v32);
      if (byte_1ED883107)
      {
...
void __42__PLDisplayAgent_initOperatorDependancies__block_invoke_2_1085(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    v5 = 138412290;
    v6 = v3;
    _os_log_debug_impl(&dword_1CAF47000, v4, OS_LOG_TYPE_DEBUG, "Notification from ThermalMonitor: %@", (uint8_t *)&v5, 0xCu);
  }
...
- (void)handleAFKInterfaceIOServiceCallback:(unsigned int)a3
{
  ...
  CFTypeID v9;
  NSObject *v10;
  AFKEndpointInterfacePowerlogDisplay *v11;
  void *v12;
  AFKEndpointInterfacePowerlogDisplay *v13;
  void *v14;
  void *v15;
  NSObject *v16;
  void *v17;
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 134217984;
    v24 = entryID;
    _os_log_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEFAULT, "Registry ID: %llu", buf, 0xCu);
  }
...
LABEL_20:
    _os_log_error_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_ERROR, v8, buf, 2u);
    goto LABEL_25;
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v24 = (uint64_t)v7;
    _os_log_impl(&dword_1CAF47000, v10, OS_LOG_TYPE_DEFAULT, "IO object property: %@", buf, 0xCu);
  }

  v11 = [AFKEndpointInterfacePowerlogDisplay alloc];
  -[PLDisplayAgent iokitBacklightDCP](self, "iokitBacklightDCP");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = -[AFKEndpointInterfacePowerlogDisplay initWithService:andIOKitComposition:](v11, "initWithService:andIOKitComposition:", v3, v12);
  ...
  if (v13)
  {
    ...
    -[PLOperator workQueue](self, "workQueue");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[AFKEndpointInterface setDispatchQueue:](v13, "setDispatchQueue:", v15);
    ...
    v20[3] = &unk_1E857BAF0;
    v20[4] = self;
    -[AFKEndpointInterface setReportHandler:](v13, "setReportHandler:", v20);
    -[AFKEndpointInterface activate](v13, "activate");
    PLLogDisplay();
    v16 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_1CAF47000, v16, OS_LOG_TYPE_DEFAULT, "AFKInterface activated", buf, 2u);
    }
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1CAF47000, v19, OS_LOG_TYPE_ERROR, "Error getting AFK interface", buf, 2u);
    }
...
- (void)logEventPointDisplayBacklightWithState:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    v6 = 134217984;
    v7 = a3;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "IOMFB received power state: %llu", (uint8_t *)&v6, 0xCu);
  }
    ...
    || +[PLDisplayAgent shouldLogLCD](PLDisplayAgent, "shouldLogLCD"))
  {
    ...
    if (objc_msgSend(v10, "intValue") == (_DWORD)v4)
    {
      ...
      if (!v11)
      {
        ...
        v27 = v12;
        if (qword_1ED883180 != -1)
          dispatch_once(&qword_1ED883180, &block);
        if (!byte_1ED883108)
          goto LABEL_17;
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("filtering block %@ isActive %d due to lastEntry %@"), v6, v4, v9, block, v24, v25, v26, v27);
        v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)initAODState:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    v6 = 134217984;
    v7 = a3;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "initial screen state received by AOD is %ld", (uint8_t *)&v6, 0xCu);
  }

  if ((unint64_t)a3 <= 3)
    -[PLDisplayAgent logAODState:](self, "logAODState:", dword_1CB388B10[a3]);
}
...
- (void)logAODState:(int)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "hasAOD"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      v10 = 67109120;
      LODWORD(v11) = v3;
      _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "AOD state received is %d", (uint8_t *)&v10, 8u);
    }
      ...
      || -[PLDisplayAgent lastScreenState](self, "lastScreenState") != (_DWORD)v3)
    {
      ...
      objc_msgSend(v7, "setObject:forKeyedSubscript:", CFSTR("Backlight"), CFSTR("Block"));
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        v10 = 138412290;
        v11 = v7;
        _os_log_debug_impl(&dword_1CAF47000, v9, OS_LOG_TYPE_DEBUG, "AOD state we log is %@", (uint8_t *)&v10, 0xCu);
      }

      -[PLOperator logEntry:](self, "logEntry:", v7);
      -[PLDisplayAgent logDisplayEntry:](self, "logDisplayEntry:", v7);
...
void __62__PLDisplayAgent_backlight_didCompleteUpdateToState_forEvent___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_DEBUG))
  {
    ...
    v6 = 134217984;
    v7 = v5;
    _os_log_debug_impl(&dword_1CAF47000, v2, OS_LOG_TYPE_DEBUG, "screen state received by AOD is %ld", (uint8_t *)&v6, 0xCu);
  }
  ...
  switch(*(_QWORD *)(a1 + 40))
  {
    ...
    case 3:
      ...
      v4 = 1;
LABEL_8:
      objc_msgSend(v3, "logAODState:", v4);
      break;
    default:
      return;
  }
...
- (void)logEventForwardALSLux:(unint64_t)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v5;
    if (qword_1ED883188 != -1)
      dispatch_once(&qword_1ED883188, block);
    if (byte_1ED883109)
    {
  ...
  if (v15)
  {
    ...
    if ((v18 & 1) == 0)
    {
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        v30[4] = v20;
        if (qword_1ED883190 != -1)
          dispatch_once(&qword_1ED883190, v30);
        if (byte_1ED88310A)
        {
      ...
      if ((int)objc_msgSend(MEMORY[0x1E0D80020], "kPLSoCClassOfDevice") >= 1001021)
      {
        ...
        if (v9)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
          {
            v17 = 134217984;
            v18 = v7;
            _os_log_debug_impl(&dword_1CAF47000, v10, OS_LOG_TYPE_DEBUG, "LuxStats gain changed, using last valid RearLux value %ld", (uint8_t *)&v17, 0xCu);
          }
...
LABEL_20:
  ...
  else
  {
    ...
    {
      LOWORD(v17) = 0;
      _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "empty payload for LuxStats", (uint8_t *)&v17, 2u);
    }
  }
...
LABEL_6:
    ...
    if (v5)
    {
      ...
      objc_msgSend(v19, "setObject:forKeyedSubscript:", &unk_1E8633390, CFSTR("UserTouchCount"));
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = v12;
      if (qword_1ED883198 != -1)
        dispatch_once(&qword_1ED883198, block);
      if (byte_1ED88310B)
      {
...
- (void)logEventBackwardRampInfo:(id)a3
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v61 = 0;
      _os_log_debug_impl(&dword_1CAF47000, v60, OS_LOG_TYPE_DEBUG, "empty payload for RampInfo", v61, 2u);
    }
...
- (void)logEventBackwardCurveUpdate:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      *(_DWORD *)buf = 138412290;
      v60 = v4;
      _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "CurveUpdate is %@", buf, 0xCu);
    }
    ...
    if (v11)
    {
      ...
      if (objc_msgSend(v13, "count"))
      {
        ...
        do
        {
          ...
          v9 = v56;
          objc_msgSend(v18, "setObject:forKeyedSubscript:", &unk_1E8633378, CFSTR("level"));
    ...
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("CurveLevelMed"));
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v25)
    {
      ...
      if (objc_msgSend(v27, "count"))
      {
        ...
        do
        {
          ...
          v9 = v56;
          objc_msgSend(v31, "setObject:forKeyedSubscript:", &unk_1E8633390, CFSTR("level"));
    ...
    if (v38)
    {
      ...
      if (objc_msgSend(v40, "count"))
      {
        ...
        do
        {
          ...
          objc_msgSend(v7[367], "entryKeyForType:andName:", v8, CFSTR("CurveUpdate"));
          v43 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          v9 = v56;
          objc_msgSend(v44, "setObject:forKeyedSubscript:", &unk_1E86333A8, CFSTR("level"));
    ...
    if (objc_msgSend(v9, "count"))
    {
      ...
      v51 = (void *)objc_claimAutoreleasedReturnValue();
      -[PLOperator logEntries:withGroupID:](v52, "logEntries:withGroupID:", v51, v5);
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "empty payload for CurveUpdate", buf, 2u);
  }
...
- (void)logEventBackwardALSSamplesBeforeWake:(id)a3
{
      ...
      do
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 67109634;
          ...
          v36 = 2112;
          v37 = v19;
          _os_log_debug_impl(&dword_1CAF47000, v23, OS_LOG_TYPE_DEBUG, "ALSSamplesBeforeWake for the count=%d at the time=%@ is %@", buf, 0x1Cu);
        }
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_debug_impl(&dword_1CAF47000, v24, OS_LOG_TYPE_DEBUG, "empty payload for ALSSamplesBeforeWake", buf, 2u);
    }
  }
...
- (void)logEventBackwardAmbientLight:(id)a3
{
    ...
    && self->_ShouldLogAmbient)
  {
        ...
        do
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 67109634;
            ...
            v36 = 2112;
            v37 = v18;
            _os_log_debug_impl(&dword_1CAF47000, v22, OS_LOG_TYPE_DEBUG, "AmbientLight for the count=%d at the time=%@ is %@", buf, 0x1Cu);
          }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_debug_impl(&dword_1CAF47000, v23, OS_LOG_TYPE_DEBUG, "empty payload for AmbientLight", buf, 2u);
      }
    }
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1223(uint64_t a1, void *a2)
{
  ...
  if (+[PLDisplayAgent shouldLogALSPowerSaved](PLDisplayAgent, "shouldLogALSPowerSaved"))
  {
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v20 = CFSTR("ALS");
      v21 = v4;
      if (qword_1ED8831B8 == -1)
      {
        v5 = CFSTR("ALS");
      }
      else
      {
        dispatch_once(&qword_1ED8831B8, block);
        v5 = (__CFString *)v20;
      }
      v6 = byte_1ED88310F;
      ...
      if (v6)
      {
        ...
        objc_msgSend(*(id *)(a1 + 32), "lastALSPowerSaved");
        objc_msgSend(v7, "stringWithFormat:", CFSTR("Logging lastALSPowerSaved=%f"), v8);
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "-[PLDisplayAgent handleBrightnessClientNotification:withValue:]_block_invoke");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v10, "logMessage:fromFile:fromFunction:fromLineNumber:", v9, v12, v13, 3315);
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D7FFB0]), "initWithEntryKey:withDate:", v15, v3);
    v17 = (void *)MEMORY[0x1E0CB37E8];
    objc_msgSend(*(id *)(a1 + 32), "lastALSPowerSaved");
    objc_msgSend(v17, "numberWithDouble:");
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "setObject:forKeyedSubscript:", v18, CFSTR("Power"));
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "alsOn") & 1) == 0)
  {
    ...
    *(float *)&v8 = v7 * 1000.0;
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = v9;
      if (qword_1ED8831C0 != -1)
        dispatch_once(&qword_1ED8831C0, block);
      if (byte_1ED883110)
      {
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1236(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    v4 = 138412290;
    v5 = v2;
    _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "We Recieved notification for AODRampTelemetry: %@", (uint8_t *)&v4, 0xCu);
  }
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1237(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    v4 = 138412290;
    v5 = v2;
    _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "We Recieved notification for AODCurveUpdate: %@", (uint8_t *)&v4, 0xCu);
  }
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1238(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    v7 = 138412290;
    v8 = v2;
    _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "We Recieved notification for AODWakeFromALSThreshold: %@", (uint8_t *)&v7, 0xCu);
  }
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1239(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    v4 = 138412290;
    v5 = v2;
    _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "We Recieved notification for CBAmbientLight: %@", (uint8_t *)&v4, 0xCu);
  }
...
uint64_t __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1240(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_DEBUG))
  {
    ...
    v8 = 138412290;
    v9 = v7;
    _os_log_debug_impl(&dword_1CAF47000, v2, OS_LOG_TYPE_DEBUG, "@kCBFinalBrightnessCommit: %@", (uint8_t *)&v8, 0xCu);
  }
  ...
  objc_msgSend(*(id *)(a1 + 40), "logEventPointUserBrightnessCommitted:", v5);
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1241(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "setObject:forKeyedSubscript:", v10, CFSTR("EDRHeadroom"));
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "hasCapability:", 8))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v51 = 138412290;
      v52 = v13;
      _os_log_impl(&dword_1CAF47000, v12, OS_LOG_TYPE_DEFAULT, "Received Brightness Notification: %@", (uint8_t *)&v51, 0xCu);
    }
    ...
    if (!v14)
    {
      ...
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v15, "setPendingBacklightEntry:", v16);
    ...
    objc_msgSend(*(id *)(a1 + 32), "brightnessSystemClient");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = (void *)objc_msgSend(v20, "copyPropertyForKey:", CFSTR("DisplayBrightnessMin"));
    objc_msgSend(v21, "doubleValue");
    v23 = v22;

    objc_msgSend(*(id *)(a1 + 32), "brightnessSystemClient");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    v25 = (void *)objc_msgSend(v24, "copyPropertyForKey:", CFSTR("DisplayBrightnessMax"));
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
    {
      ...
      v60 = v30;
      v61 = 2048;
      v62 = (v30 - v23) * 100.0 / (v27 - v23);
      _os_log_debug_impl(&dword_1CAF47000, v31, OS_LOG_TYPE_DEBUG, "Reported mNits:%f ,brightnessMin:%f ,brightnessMax:%f ,brightnessDiff:%f ,brightness:%f ,brightnessPercentage:%f ", (uint8_t *)&v51, 0x3Eu);
    }

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", (v30 - v23) * 100.0 / (v27 - v23));
    v32 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v33, "setObject:forKeyedSubscript:", v32, CFSTR("Brightness"));

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v30);
    v34 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
    v35 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v35, "setObject:forKeyedSubscript:", v34, CFSTR("SliderValue"));

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v19 * 1000.0);
    v36 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntry");
    v37 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v37, "setObject:forKeyedSubscript:", v36, CFSTR("mNits"));
    ...
    if (!v38)
    {
      objc_msgSend(MEMORY[0x1E0C99D68], "monotonicDate");
      v39 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(*(id *)(a1 + 32), "setPendingBacklightEntryDate:", v39);
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEBUG))
    {
      ...
      v47 = (void *)MEMORY[0x1E0D80088];
      objc_msgSend(*(id *)(a1 + 32), "pendingBacklightEntryDate");
      v48 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v47, "formattedStringForDate:", v48);
      v49 = COERCE_DOUBLE(objc_claimAutoreleasedReturnValue());
      v51 = 138412546;
      v52 = v46;
      v53 = 2112;
      v54 = v49;
      _os_log_debug_impl(&dword_1CAF47000, v40, OS_LOG_TYPE_DEBUG, "Pending Backlight entry: %@, %@", (uint8_t *)&v51, 0x16u);
    ...
    if ((v42 & 1) == 0)
    {
      ...
      {
        objc_msgSend(MEMORY[0x1E0D80088], "formattedStringForDate:", v43);
        v50 = COERCE_DOUBLE(objc_claimAutoreleasedReturnValue());
        v51 = 138412290;
        v52 = v50;
        _os_log_debug_impl(&dword_1CAF47000, v44, OS_LOG_TYPE_DEBUG, "Start backlight entry filter timer fireDate=%@", (uint8_t *)&v51, 0xCu);

      }
      objc_msgSend(*(id *)(a1 + 32), "backlightFilterTimer");
      v45 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v45, "setFireDate:", v43);
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1246(uint64_t a1)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v14 = CFSTR("ALS");
    v15 = v2;
    if (qword_1ED8831C8 == -1)
    {
      v3 = CFSTR("ALS");
    }
    else
    {
      dispatch_once(&qword_1ED8831C8, block);
      v3 = (__CFString *)v14;
    }
    v4 = byte_1ED883111;
    ...
    if (v4)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "-[PLDisplayAgent handleBrightnessClientNotification:withValue:]_block_invoke");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "logMessage:fromFile:fromFunction:fromLineNumber:", v5, v8, v9, 3453);
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "alsOn"))
  {
    if (+[PLDisplayAgent shouldLogALSPowerSaved](PLDisplayAgent, "shouldLogALSPowerSaved"))
    {
      ...
      objc_msgSend(v12, "setObject:forKeyedSubscript:", &unk_1E8633378, CFSTR("Power"));
      objc_msgSend(*(id *)(a1 + 32), "logEntry:", v12);
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1253(uint64_t a1)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v37 = v26;
    if (qword_1ED8831D8 != -1)
      dispatch_once(&qword_1ED8831D8, &block);
    if (byte_1ED883113)
    {
...
void __63__PLDisplayAgent_handleBrightnessClientNotification_withValue___block_invoke_1272(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    v4 = 138412290;
    v5 = v2;
    _os_log_debug_impl(&dword_1CAF47000, v3, OS_LOG_TYPE_DEBUG, "Received notification for CBrLuxStats: %@", (uint8_t *)&v4, 0xCu);
  }
...
- (void)extractDataWithEntry:(id)a3 withColName:(id)a4 withDataArray:(id)a5
{
  ...
  if (v9)
  {
    ...
    {
      v12 = CFSTR("ACBins");
      if ((-[__CFString isEqualToString:](v7, "isEqualToString:", CFSTR("AmbientColorBins")) & 1) != 0
        || (v12 = CFSTR("DCBins"),
            (-[__CFString isEqualToString:](v7, "isEqualToString:", CFSTR("DisplayColorBins")) & 1) != 0)
        || (v12 = CFSTR("ASBins"),
            (-[__CFString isEqualToString:](v7, "isEqualToString:", CFSTR("AdaptationStrengthBins")) & 1) != 0)
        || (v12 = CFSTR("ACABins"),
            (-[__CFString isEqualToString:](v7, "isEqualToString:", CFSTR("AmbientColorBinsAnsi")) & 1) != 0)
        || (v12 = CFSTR("ACTBins"),
            (-[__CFString isEqualToString:](v7, "isEqualToString:", CFSTR("AmbientColorTransitionBins")) & 1) != 0)
        || (v12 = CFSTR("DCTBins"),
            -[__CFString isEqualToString:](v7, "isEqualToString:", CFSTR("DisplayColorTransitionBins"))))
      {
      ...
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@_%lu"), v7, i);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v22, "setObject:forKeyedSubscript:", v13, v14);
  ...
  if ((objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled") & 1) != 0)
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v15;
    if (qword_1ED8831E8 != -1)
      dispatch_once(&qword_1ED8831E8, block);
    if (byte_1ED883115)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%s-%d: col=%@, data=%@, entry=%@"), "-[PLDisplayAgent extractDataWithEntry:withColName:withDataArray:]", 3573, v7, v8, v22);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v17, "logMessage:fromFile:fromFunction:fromLineNumber:", v16, v19, v20, 3573);
...
- (void)logBrightnessDataWithEntryKey:(id)a3 withColName:(id)a4 withValue:(id)a5
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v23 = v12;
    if (qword_1ED8831F0 != -1)
      dispatch_once(&qword_1ED8831F0, &block);
    if (byte_1ED883116)
    {
...
uint64_t __70__PLDisplayAgent_logBrightnessDataWithEntryKey_withColName_withValue___block_invoke(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  byte_1ED883116 = result;
  return result;
}

+ (BOOL)shouldLogBLR
{
  if (qword_1ED8831F8 != -1)
    dispatch_once(&qword_1ED8831F8, &__block_literal_global_1291);
  return byte_1ED883117;
}
...
uint64_t __30__PLDisplayAgent_shouldLogBLR__block_invoke()
{
  ...
  byte_1ED883117 = result;
  return result;
}

+ (BOOL)shouldLogALSPowerSaved
{
  if (qword_1ED883200 != -1)
    dispatch_once(&qword_1ED883200, &__block_literal_global_1292);
  return byte_1ED883118;
}
...
{
  if (qword_1ED883208 != -1)
    dispatch_once(&qword_1ED883208, &__block_literal_global_1293);
  return byte_1ED883119;
}
...
uint64_t __43__PLDisplayAgent_shouldLogBacklightControl__block_invoke()
{
  ...
  byte_1ED883119 = result;
  return result;
}

+ (BOOL)shouldLogDisplay
{
  if (qword_1ED883210 != -1)
    dispatch_once(&qword_1ED883210, &__block_literal_global_1294);
  return byte_1ED88311A;
}
...
uint64_t __34__PLDisplayAgent_shouldLogDisplay__block_invoke()
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D80020], "isArchARM");
  byte_1ED88311A = result;
  return result;
}

+ (BOOL)shouldLogLCD
{
  if (qword_1ED883218 != -1)
    dispatch_once(&qword_1ED883218, &__block_literal_global_1295);
  return byte_1ED88311B;
}
...
uint64_t __41__PLDisplayAgent_shouldLogUserBrightness__block_invoke()
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D80020], "isMac");
  byte_1ED88311D = result ^ 1;
  return result;
}

+ (BOOL)shouldLogKeyboardBrightness
{
  if (qword_1ED883230 != -1)
    dispatch_once(&qword_1ED883230, &__block_literal_global_1298);
  return byte_1ED88311E;
}
...
uint64_t __45__PLDisplayAgent_shouldLogKeyboardBrightness__block_invoke()
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D80020], "isMac");
  byte_1ED88311E = result | v0;
  return result;
}

+ (BOOL)shouldLogLuxStats
{
  if (qword_1ED883238 != -1)
    dispatch_once(&qword_1ED883238, &__block_literal_global_1299);
  return byte_1ED88311F;
}
...
- (void)logBlueLightDataWithDictionary:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v19;
    if (qword_1ED883240 != -1)
      dispatch_once(&qword_1ED883240, block);
    if (byte_1ED883120)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(id *)((char *)location + 4) = v20;
        _os_log_debug_impl(&dword_1CAF47000, v25, OS_LOG_TYPE_DEBUG, "%@", (uint8_t *)location, 0xCu);
      }
...
+ (BOOL)shouldLogTouch
{
  if (qword_1ED883248 != -1)
    dispatch_once(&qword_1ED883248, &__block_literal_global_1304);
  return byte_1ED883121;
}
...
- (void)__FrameBufferEventCallback:(__IOMobileFramebuffer *)a3
{
  ...
  v4 = (unsigned int *)malloc_type_aligned_alloc(0x4000uLL, 0x4000uLL, 0xF1D51391uLL);
  v5 = v4;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 67109120;
      v46 = v34;
      _os_log_debug_impl(&dword_1CAF47000, v6, OS_LOG_TYPE_DEBUG, "Number of data entries retrieved %d \n", buf, 8u);
    }
    ...
    if (*v5)
    {
      ...
      *(_QWORD *)&v8 = 67110656;
      ...
      do
      {
        ...
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        v13 = (void *)objc_msgSend(v11, "initWithEntryKey:withDate:", v12, v40);
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = v35;
          ...
          v57 = 1024;
          v58 = v32;
          _os_log_debug_impl(&dword_1CAF47000, v14, OS_LOG_TYPE_DEBUG, "packet_id[%d]: current_ma(u14.18): 0x%x, voltage_v(u4.10): 0x%x, system_nits(u0.20): 0x%x, azl(u0.20): 0x%x, max_zone_current(0.14): 0x%x, max_row_step_to_step_current(10.14): 0x%x \n", buf, 0x2Cu);
        }
        else
        {
          v15 = v10 - 6;
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v5[v15]);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "setObject:forKeyedSubscript:", v19, CFSTR("AverageCurrent"));

        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v5[v16]);
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "setObject:forKeyedSubscript:", v20, CFSTR("VLED"));

        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v5[v17]);
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "setObject:forKeyedSubscript:", v21, CFSTR("SystemNits"));

        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v5[v18]);
        v22 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "setObject:forKeyedSubscript:", v22, CFSTR("AZL"));

        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v5[v41]);
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "setObject:forKeyedSubscript:", v23, CFSTR("MaxRowCurrent"));

        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v5[v42]);
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "setObject:forKeyedSubscript:", v24, CFSTR("NitsAccum"));

        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v5[v10]);
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "setObject:forKeyedSubscript:", v25, CFSTR("PacketID"));
    ...
    if (objc_msgSend(v7, "count", v35))
    {
      ...
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      -[PLOperator logEntries:withGroupID:](v37, "logEntries:withGroupID:", v33, v36);
...
BOOL __30__PLDisplayAgent_shouldLogAPL__block_invoke()
{
  ...
  byte_1ED883122 = objc_msgSend(MEMORY[0x1E0D80020], "kPLDisplayClassIsOneOf:", 1002019, 1002020, 1002017, 1002018, 1002023, 1002022, 1002026, 1002027, 1002028, 1002031, 1002032, 1002041, 1002034, 1002035, 1002037, 1002038, 1002039,
                     0);
  result = (byte_1ED883122 & 1) != 0
...
- (void)logDisplayAZL
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "hasCapability:", 8)
    ...
    && (-[PLDisplayIOReportStats displayAZLStats](self->_displayIOReportAZLStats, "displayAZLStats"),
        v3 = (void *)objc_claimAutoreleasedReturnValue(),
        v3,
        v3))
  {
    v4 = objc_alloc(MEMORY[0x1E0D7FFB0]);
    +[PLOperator entryKeyForType:andName:](PLDisplayAgent, "entryKeyForType:andName:", *MEMORY[0x1E0D80370], CFSTR("AZLStats"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = objc_msgSend(v4, "initWithEntryKey:", v5);

    v7 = (void *)MEMORY[0x1E0CB37E8];
    -[PLDisplayIOReportStats displayAZLStats](self->_displayIOReportAZLStats, "displayAZLStats");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "AvgPower");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "numberWithUnsignedLongLong:", objc_msgSend(v9, "unsignedLongLongValue"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSObject setObject:forKeyedSubscript:](v6, "setObject:forKeyedSubscript:", v10, CFSTR("AvgPower"));

    v11 = (void *)MEMORY[0x1E0CB37E8];
    -[PLDisplayIOReportStats displayAZLStats](self->_displayIOReportAZLStats, "displayAZLStats");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "azlAccum");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "numberWithUnsignedLongLong:", objc_msgSend(v13, "unsignedLongLongValue"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSObject setObject:forKeyedSubscript:](v6, "setObject:forKeyedSubscript:", v14, CFSTR("AZLAccum"));

    v15 = (void *)MEMORY[0x1E0CB37E8];
    -[PLDisplayIOReportStats displayAZLStats](self->_displayIOReportAZLStats, "displayAZLStats");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "nitsAccum");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "numberWithUnsignedLongLong:", objc_msgSend(v17, "unsignedLongLongValue"));
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSObject setObject:forKeyedSubscript:](v6, "setObject:forKeyedSubscript:", v18, CFSTR("NitsAccum"));

    v19 = (void *)MEMORY[0x1E0CB37E8];
    -[PLDisplayIOReportStats displayAZLStats](self->_displayIOReportAZLStats, "displayAZLStats");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "blUpdateCount");
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "numberWithUnsignedLongLong:", objc_msgSend(v21, "unsignedLongLongValue"));
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSObject setObject:forKeyedSubscript:](v6, "setObject:forKeyedSubscript:", v22, CFSTR("BLUpdateCount"));

    v23 = (void *)MEMORY[0x1E0CB37E8];
    -[PLDisplayIOReportStats displayAZLStats](self->_displayIOReportAZLStats, "displayAZLStats");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "blFrameCount");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v23, "numberWithUnsignedLongLong:", objc_msgSend(v25, "unsignedLongLongValue"));
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSObject setObject:forKeyedSubscript:](v6, "setObject:forKeyedSubscript:", v26, CFSTR("BLFrameCount"));
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
    {
      v28 = 138412290;
      v29 = v6;
      _os_log_debug_impl(&dword_1CAF47000, v27, OS_LOG_TYPE_DEBUG, "LogDisplayAZL  for entries %@", (uint8_t *)&v28, 0xCu);
    }
  ...
  else
  {
    ...
    {
      LOWORD(v28) = 0;
      _os_log_debug_impl(&dword_1CAF47000, v6, OS_LOG_TYPE_DEBUG, "LogDisplayAZL Error", (uint8_t *)&v28, 2u);
    }
  }
...
- (void)logAODChange
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "hasAOD"))
  {
    ...
    {
      -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
      v3 = (void *)objc_claimAutoreleasedReturnValue();

      if (v3)
      {
        v4 = objc_alloc(MEMORY[0x1E0D7FFB0]);
        +[PLOperator entryKeyForType:andName:](PLDisplayAgent, "entryKeyForType:andName:", *MEMORY[0x1E0D80370], CFSTR("DCPAODstats"));
        v5 = (void *)objc_claimAutoreleasedReturnValue();
        v6 = (void *)objc_msgSend(v4, "initWithEntryKey:", v5);

        v7 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "awakeCount");
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v7, "numberWithUnsignedLongLong:", objc_msgSend(v9, "unsignedLongLongValue"));
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v10, CFSTR("awake_count"));

        v11 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "mediaCount");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v11, "numberWithUnsignedLongLong:", objc_msgSend(v13, "unsignedLongLongValue"));
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v14, CFSTR("media_count"));

        v15 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v16, "flipbookCount");
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v15, "numberWithUnsignedLongLong:", objc_msgSend(v17, "unsignedLongLongValue"));
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v18, CFSTR("flipbook_count"));

        v19 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v20, "flipbookDelay");
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "numberWithUnsignedLongLong:", objc_msgSend(v21, "unsignedLongLongValue"));
        v22 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v22, CFSTR("flipbook_delay"));

        v23 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v24, "mediaScanout");
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v23, "numberWithUnsignedLongLong:", objc_msgSend(v25, "unsignedLongLongValue"));
        v26 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v26, CFSTR("media_scanout"));

        v27 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v28, "ambientCount");
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v27, "numberWithUnsignedLongLong:", objc_msgSend(v29, "unsignedLongLongValue"));
        v30 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v30, CFSTR("ambient_count"));

        v31 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v32 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v32, "prcRepeatCoun");
        v33 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v31, "numberWithUnsignedLongLong:", objc_msgSend(v33, "unsignedLongLongValue"));
        v34 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v34, CFSTR("prc_repeat_coun"));

        v35 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v36 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v36, "pdcRepeatCoun");
        v37 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v35, "numberWithUnsignedLongLong:", objc_msgSend(v37, "unsignedLongLongValue"));
        v38 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v38, CFSTR("pdc_repeat_coun"));

        v39 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v40 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v40, "llmCount");
        v41 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v39, "numberWithUnsignedLongLong:", objc_msgSend(v41, "unsignedLongLongValue"));
        v42 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v42, CFSTR("llm_count"));

        v43 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v44 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v44, "aplSum");
        v45 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v43, "numberWithUnsignedLongLong:", objc_msgSend(v45, "unsignedLongLongValue"));
        v46 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v46, CFSTR("apl_sum"));

        v47 = (void *)MEMORY[0x1E0CB37E8];
        -[PLDisplayIOReportAODStats displayAODStats](self->_displayIOReportAODStats, "displayAODStats");
        v48 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v48, "aplCount");
        v49 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v47, "numberWithUnsignedLongLong:", objc_msgSend(v49, "unsignedLongLongValue"));
        v50 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "setObject:forKeyedSubscript:", v50, CFSTR("apl_count"));
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_DEBUG))
        {
          v52 = 138412290;
          v53 = v6;
          _os_log_debug_impl(&dword_1CAF47000, v51, OS_LOG_TYPE_DEBUG, "LogAODChange  for entries %@", (uint8_t *)&v52, 0xCu);
        }
...
{
  if (qword_1ED883278 != -1)
    dispatch_once(&qword_1ED883278, &__block_literal_global_1361);
  return (id)qword_1ED883270;
}
...
uint64_t __37__PLDisplayAgent_getIOMFBSubFrameMap__block_invoke()
{
  ...
  v0 = objc_opt_new();
  v1 = (void *)qword_1ED883270;
  qword_1ED883270 = v0;

  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652EF0, CFSTR("subframes_0"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F00, CFSTR("subframes_1"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F10, CFSTR("subframes_2"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F20, CFSTR("subframes_3"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F30, CFSTR("subframes_4"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F40, CFSTR("subframes_5"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F50, CFSTR("subframes_6"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F60, CFSTR("subframes_7"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F70, CFSTR("subframes_8"));
  objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F80, CFSTR("subframes_9"));
  return objc_msgSend((id)qword_1ED883270, "setObject:forKeyedSubscript:", &unk_1E8652F90, CFSTR("subframes_10"));
}
...
LABEL_31:
      ...
      v64[4] = v57;
      if (qword_1ED883288 != -1)
        dispatch_once(&qword_1ED883288, v64);
      if (!byte_1ED883127)
      {
LABEL_49:
...
LABEL_47:
    ...
    else
    {
      ...
      block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      block[4] = v50;
      if (qword_1ED883280 != -1)
        dispatch_once(&qword_1ED883280, block);
      if (!byte_1ED883126)
        goto LABEL_49;
...
- (double)calculatePowerFromAPL:(double)a3 withAvgRed:(double)a4 withAvgGreen:(double)a5 withAvgBlue:(double)a6
{
  ...
  if (v45)
  {
    ...
    {
      v50 = (void *)MEMORY[0x1E0D80078];
      -[NSDictionary objectForKeyedSubscript:](self->_displayPowerModel, "objectForKeyedSubscript:", CFSTR("mnit_scale_values"));
      v51 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v50, "scaledPowerBasedOnPoint:withPowerModel:", v51, a3);
      v46 = v52;
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v56;
    if (qword_1ED883290 != -1)
      dispatch_once(&qword_1ED883290, block);
    if (byte_1ED883128)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("mNits: %f\tavgRed: %f\tavgGreen: %f\tavgBlue: %f\tnormalizedColorSum: %.2f\tPower: %.2f"), *(_QWORD *)&a3, *(_QWORD *)&a4, *(_QWORD *)&a5, *(_QWORD *)&a6, *(_QWORD *)&v44, *(_QWORD *)&v55);
      v57 = (void *)objc_claimAutoreleasedReturnValue();
      v58 = (void *)MEMORY[0x1E0D7FF98];
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Agents/Hardware/PLDisplayAgent.m");
      v59 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v61 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v58, "logMessage:fromFile:fromFunction:fromLineNumber:", v57, v60, v61, 4809);
    ...
    if (v6)
    {
      ...
      if (-[PLDisplayAgent isDisplayOnNow](self, "isDisplayOnNow"))
      {
        ...
        if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
        {
          ...
          v67[4] = v41;
          if (qword_1ED8832A8 != -1)
            dispatch_once(&qword_1ED8832A8, v67);
          if (byte_1ED88312B)
          {
      ...
      if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      {
        ...
        block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
        block[4] = v48;
        if (qword_1ED8832B0 != -1)
          dispatch_once(&qword_1ED8832B0, block);
        if (byte_1ED88312C)
        {
...
+ (id)dcpSubFrameMap
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "hasDCP"))
  {
    ...
    v7 = v3;
    v8 = v2;
    if (qword_1ED8832C0 != -1)
      dispatch_once(&qword_1ED8832C0, block);
    v4 = (id)qword_1ED8832B8;
  }
  else
  {
    v4 = 0;
...
void __32__PLDisplayAgent_dcpSubFrameMap__block_invoke(uint64_t a1)
{
  ...
  for (i = 1; i != 26; ++i)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ED8832B8, "setObject:forKeyedSubscript:", v9, v5);
