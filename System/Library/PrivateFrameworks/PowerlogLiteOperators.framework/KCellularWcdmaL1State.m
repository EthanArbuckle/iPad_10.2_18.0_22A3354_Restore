...
- (int)StringAsL1State:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_NULL")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_CELL_SEARCH")) & 1) != 0)
  {
    v4 = 1;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_CAMPED")) & 1) != 0)
  {
    v4 = 2;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_FACH_CONNECTED")) & 1) != 0)
  {
    v4 = 3;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_FACH_DISCONNECTED")) & 1) != 0)
  {
    v4 = 4;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_DCH_CONNECTED")) & 1) != 0)
  {
    v4 = 5;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_DCH_DISCONNECTED")) & 1) != 0)
  {
    v4 = 6;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_PTST")) & 1) != 0)
  {
    v4 = 7;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("KWCDMA_L1_STATE_DEACTIVATE_RAT")))
  {
    v4 = 8;
  }
  else
...
- (id)description
{
  ...
  -[KCellularWcdmaL1State description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularWcdmaL1State dictionaryRepresentation](self, "dictionaryRepresentation");
