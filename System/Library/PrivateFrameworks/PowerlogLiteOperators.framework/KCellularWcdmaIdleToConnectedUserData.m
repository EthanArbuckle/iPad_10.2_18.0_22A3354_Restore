...
- (id)description
{
  ...
  -[KCellularWcdmaIdleToConnectedUserData description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularWcdmaIdleToConnectedUserData dictionaryRepresentation](self, "dictionaryRepresentation");
