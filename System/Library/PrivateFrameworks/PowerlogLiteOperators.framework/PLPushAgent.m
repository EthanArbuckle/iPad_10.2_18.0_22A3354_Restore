...
void __39__PLPushAgent_initOperatorDependancies__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v27 = 138412290;
    v28 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "PLPushAgent:: receivedPushListener with payload=%@", (uint8_t *)&v27, 0xCu);
  }
  ...
  objc_msgSend(v17, "numberWithInt:", objc_msgSend(v18, "roundToSigFig:withSigFig:", objc_msgSend(v19, "intValue"), 2));
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "setObject:forKeyedSubscript:", v20, CFSTR("Size"));
  ...
  if ((objc_msgSend(MEMORY[0x1E0D7FFA0], "fullMode") & 1) == 0)
  {
    ...
    objc_msgSend(v21, "dateWithTimeIntervalSince1970:", round(v23 / 60.0) * 60.0);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "setEntryDate:", v24);
  ...
  if (objc_msgSend(MEMORY[0x1E0D80020], "internalBuild"))
  {
    ...
    objc_msgSend(v25, "checkPushUsage:withPLEntry:", v26, v9);
...
- (void)accountReceivedPushWithEntry:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    v32 = v3;
    _os_log_debug_impl(&dword_1CAF47000, v4, OS_LOG_TYPE_DEBUG, "accounting entry %@", buf, 0xCu);
  }
...
LABEL_15:
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 67109120;
          LODWORD(v32) = v16;
          _os_log_debug_impl(&dword_1CAF47000, v17, OS_LOG_TYPE_DEBUG, "didWake = %d", buf, 8u);
        }
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            v33 = 2112;
            v34 = v19;
            _os_log_impl(&dword_1CAF47000, v18, OS_LOG_TYPE_INFO, "Waking push with entry=%@, entry.entryDate=%@", buf, 0x16u);
...
+ (id)bundleIdFromTopic:(id)a3
{
  ...
  if (v3)
  {
    if (objc_msgSend(v3, "length"))
    {
      ...
      v23[5] = &__block_literal_global_211_0;
...
- (void)initOperatorDependancies
{
  ...
  v30[3] = &unk_1E8578610;
  v30[4] = self;
  v5 = (void *)objc_msgSend(v3, "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D1B0, v30);
  ...
  v29[3] = &unk_1E8578610;
  v29[4] = self;
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D1D8, v29);
  ...
  v28[3] = &unk_1E8578610;
  v28[4] = self;
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D200, v28);
  ...
  v27[3] = &unk_1E8578610;
  v27[4] = self;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D228, v27);
  ...
  v26[3] = &unk_1E8578610;
  v26[4] = self;
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D250, v26);
  ...
  v24[3] = &unk_1E8578610;
  v24[4] = self;
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D278, v24);
  ...
  v23[3] = &unk_1E8578610;
  v23[4] = self;
  v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D2A0, v23);
  ...
  v22[3] = &unk_1E8578610;
  v22[4] = self;
  v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", self, &unk_1E864D2C8, v22);
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_124(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v35 = v7;
    if (qword_1ED884C88 != -1)
      dispatch_once(&qword_1ED884C88, &block);
    if (_MergedGlobals_1_50)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("PLPushAgent:: sentPushListener with payload=%@"), v6, block, v32, v33, v34, v35);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "fullMode"))
  {
    ...
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "setObject:forKeyedSubscript:", v24, CFSTR("Size"));
  ...
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D7FFB0]), "initWithEntryKey:withRawData:", v25, v14);
  v27 = *(void **)(v18 + 2024);
  v28 = (void *)MEMORY[0x1E0D80078];
  objc_msgSend(v26, "objectForKeyedSubscript:", CFSTR("Size"));
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v27, "numberWithInt:", objc_msgSend(v28, "roundToSigFig:withSigFig:", objc_msgSend(v29, "intValue"), 2));
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v26, "setObject:forKeyedSubscript:", v30, CFSTR("Size"));

  objc_msgSend(v26, "setObject:forKeyedSubscript:", &unk_1E8634680, CFSTR("Count"));
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_135(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "SuppressedPushes payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_141(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v16 = 138412290;
    v17 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "PLPushAgent:: apsdConnectedListener with payload=%@", (uint8_t *)&v16, 0xCu);
  }
  ...
  objc_msgSend(v15, "setObject:forKeyedSubscript:", &unk_1E8634680, CFSTR("Count"));
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_147(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v27 = v7;
    if (qword_1ED884C90 != -1)
      dispatch_once(&qword_1ED884C90, &block);
    if (byte_1ED884C71)
    {
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_2_159(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "PLPushAgent:: receivedKeepAliveListener with payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_167(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "iMessageSent payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_173(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    v8 = 138412290;
    v9 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "iMessageReceived payload: %@", (uint8_t *)&v8, 0xCu);
  }
...
- (void)sendEnergyIssueSignatureNotification:(id)a3 withThreshold:(double)a4
{
  ...
  if (v7)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "signatureWithDomain:type:subType:subtypeContext:detectedProcess:triggerThresholdValues:", CFSTR("Energy"), CFSTR("Push"), CFSTR("PushStorm"), &stru_1E8587D00, v6, v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
void __66__PLPushAgent_sendEnergyIssueSignatureNotification_withThreshold___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    block[4] = v6;
    if (qword_1ED884C98 != -1)
      dispatch_once(&qword_1ED884C98, block);
    if (!byte_1ED884C72)
      goto LABEL_16;
...
LABEL_16:
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v18[4] = v13;
    if (qword_1ED884CA0 != -1)
      dispatch_once(&qword_1ED884CA0, v18);
    if (byte_1ED884C73)
    {
...
- (void)checkPushUsage:(id)a3 withPLEntry:(id)a4
{
  ...
  if (self->_detectionStartTime)
  {
    ...
    if (v9 <= 86400.0)
    {
      ...
      {
        -[NSMutableDictionary setObject:forKeyedSubscript:](self->_pushUsageDict, "setObject:forKeyedSubscript:", &unk_1E8634680, v10);
      }
      -[NSMutableDictionary objectForKeyedSubscript:](self->_pushUsageDict, "objectForKeyedSubscript:", v10);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v17;
    if (qword_1ED884CA8 != -1)
      dispatch_once(&qword_1ED884CA8, block);
    if (byte_1ED884C74)
    {
...
- (unint64_t)convertMessageProtocol:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      v7 = 138412290;
      v8 = v3;
      _os_log_debug_impl(&dword_1CAF47000, v5, OS_LOG_TYPE_DEBUG, "Other Message Protocol logged: %@", (uint8_t *)&v7, 0xCu);
    }
...
- (void)handleMessageEvent:(id)a3 isSentEvent:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v31 = 2112;
    v32 = v6;
    _os_log_debug_impl(&dword_1CAF47000, v7, OS_LOG_TYPE_DEBUG, "Received messages update, isSentEvent: %@, payload: %@", (uint8_t *)&v29, 0x16u);
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "fullMode"))
  {
    ...
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "hashString:", v19);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "numberWithUnsignedInteger:", objc_msgSend(v20, "hash"));
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "setObject:forKeyedSubscript:", v21, CFSTR("Target"));

    v22 = (void *)MEMORY[0x1E0CB37E8];
    v23 = (void *)MEMORY[0x1E0D80078];
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("Source"));
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v23, "hashString:", v24);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v22, "numberWithUnsignedInteger:", objc_msgSend(v25, "hash"));
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "setObject:forKeyedSubscript:", v26, CFSTR("Source"));

    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("MessageGUID"));
    v27 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "setObject:forKeyedSubscript:", v27, CFSTR("MessageGUID"));
