...
- (id)description
{
  ...
  -[PStat description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PStat dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_3:
  ...
  objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("active_dur_ms"));
...
LABEL_4:
    if ((has & 0x10) == 0)
      goto LABEL_5;
LABEL_11:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_toActiveCount);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v10, CFSTR("to_active_count"));
...
LABEL_10:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_inactiveDurMs);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("inactive_dur_ms"));
...
LABEL_5:
  ...
  {
LABEL_6:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_sleepBlockCount);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("sleep_block_count"));
...
LABEL_26:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 4) == 0 || self->_inactiveDurMs != *((_DWORD *)v4 + 4))
      goto LABEL_26;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 0x10) == 0 || self->_toActiveCount != *((_DWORD *)v4 + 6))
      goto LABEL_26;
  }
  ...
  if ((*(_BYTE *)&self->_has & 8) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 8) == 0 || self->_sleepBlockCount != *((_DWORD *)v4 + 5))
      goto LABEL_26;
    v5 = 1;
  }
LABEL_27:
