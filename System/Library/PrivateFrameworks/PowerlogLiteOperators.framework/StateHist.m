...
- (id)description
{
  ...
  -[StateHist description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[StateHist dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v9 = v4;
  if (-[StateHist binsCount](self, "binsCount"))
  {
    objc_msgSend(v9, "clearBins");
    v5 = -[StateHist binsCount](self, "binsCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[StateHist binAtIndex:](self, "binAtIndex:", i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_state != *((_DWORD *)v4 + 4))
      goto LABEL_9;
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        -[StateHist addBin:](self, "addBin:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
