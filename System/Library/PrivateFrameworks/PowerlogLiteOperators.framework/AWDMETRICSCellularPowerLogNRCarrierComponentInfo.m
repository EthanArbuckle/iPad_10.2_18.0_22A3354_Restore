...
- (id)description
{
  ...
  -[AWDMETRICSCellularPowerLogNRCarrierComponentInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDMETRICSCellularPowerLogNRCarrierComponentInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v10 = v4;
  if (-[AWDMETRICSCellularPowerLogNRCarrierComponentInfo carrierInfosCount](self, "carrierInfosCount"))
  {
    objc_msgSend(v10, "clearCarrierInfos");
    v6 = -[AWDMETRICSCellularPowerLogNRCarrierComponentInfo carrierInfosCount](self, "carrierInfosCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        -[AWDMETRICSCellularPowerLogNRCarrierComponentInfo carrierInfoAtIndex:](self, "carrierInfoAtIndex:", i);
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[AWDMETRICSCellularPowerLogNRCarrierComponentInfo addCarrierInfo:](self, "addCarrierInfo:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
