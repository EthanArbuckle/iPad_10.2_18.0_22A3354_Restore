...
- (int)StringAsL1State:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KTDS_STATE_INIT")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KTDS_STATE_CS")) & 1) != 0)
  {
    v4 = 1;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KTDS_STATE_IDLE")) & 1) != 0)
  {
    v4 = 2;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KTDS_STATE_RA")) & 1) != 0)
  {
    v4 = 3;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KTDS_STATE_FACH")) & 1) != 0)
  {
    v4 = 4;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("KTDS_STATE_CNNT")))
  {
    v4 = 5;
  }
  else
...
- (id)description
{
  ...
  -[KCellularTdsL1State description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularTdsL1State dictionaryRepresentation](self, "dictionaryRepresentation");
