...
- (id)description
{
  ...
  -[KCellularLteCdrxConfig description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularLteCdrxConfig dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_cellStatus);
...
LABEL_17:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_onDurationMs);
...
LABEL_18:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_drxInactivityMs);
...
LABEL_19:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_drxRetxTimerMs);
...
LABEL_20:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_longDrxCycleMs);
...
LABEL_21:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_shortDrxCycleMs);
...
LABEL_11:
    if ((has & 0x800) == 0)
      goto LABEL_12;
LABEL_28:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_transmissionMode);
...
LABEL_27:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_cdrxConfigStatus);
