...
- (int)StringAsFailCause:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KLTE_RLF_CAUSE_T310_EXP")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KLTE_RLF_CAUSE_RND_ACC")) & 1) != 0)
  {
    v4 = 1;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KLTE_RLF_CAUSE_MAX_RLC_RETX")) & 1) != 0)
  {
    v4 = 2;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KLTE_RLF_CAUSE_REEST_T310_EXP")) & 1) != 0)
  {
    v4 = 3;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KLTE_RLF_CAUSE_REEST_RND_ACC")) & 1) != 0)
  {
    v4 = 4;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("KLTE_RLF_CAUSE_REEST_MAX_RLC_RETX")))
  {
    v4 = 5;
  }
  else
...
- (id)description
{
  ...
  -[KCellularLteRadioLinkFailure description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[KCellularLteRadioLinkFailure dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_3:
  ...
  if (failCause >= 6)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_failCause);
    v9 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v9 = off_1E8581D18[failCause];
  }
  objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("fail_cause"));
...
LABEL_15:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_band);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v10, CFSTR("band"));
...
LABEL_16:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_coexPolicy);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v11, CFSTR("coex_policy"));
...
LABEL_6:
    if ((has & 0x10) == 0)
      goto LABEL_7;
LABEL_21:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hstState);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v14, CFSTR("hst_state"));
...
LABEL_17:
  ...
  {
    v13 = off_1E8581D48[rrcState];
  }
  objc_msgSend(v3, "setObject:forKey:", v13, CFSTR("rrc_state"));
...
LABEL_36:
  ...
  if ((*(_BYTE *)&self->_has & 8) != 0)
  {
    if ((*((_BYTE *)v4 + 40) & 8) == 0 || self->_failCause != *((_DWORD *)v4 + 6))
      goto LABEL_36;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 40) & 2) == 0 || self->_band != *((_DWORD *)v4 + 4))
      goto LABEL_36;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 40) & 4) == 0 || self->_coexPolicy != *((_DWORD *)v4 + 5))
      goto LABEL_36;
  }
  ...
  if ((*(_BYTE *)&self->_has & 0x20) != 0)
  {
    if ((*((_BYTE *)v4 + 40) & 0x20) == 0 || self->_rrcState != *((_DWORD *)v4 + 8))
      goto LABEL_36;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 40) & 0x10) == 0 || self->_hstState != *((_DWORD *)v4 + 7))
      goto LABEL_36;
  }
