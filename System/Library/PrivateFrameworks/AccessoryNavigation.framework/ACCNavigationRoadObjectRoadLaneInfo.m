...
{
  ACCNavigationRoadObjectRoadLaneInfo *v2;
  ...
  v2 = -[ACCNavigationRoadObjectRoadLaneInfo init](&v6, sel_init);
  if (v2)
  {
...
- (id)description
{
  ...
  v14 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 0);
  v3 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 1);
  v4 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 2);
  v5 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 3);
  v6 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 4);
  v7 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 5);
  v8 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 6);
  v9 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 7);
  v10 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 8);
  v11 = -[ACCNavigationRoadObjectRoadLaneInfo copyInfo:](self, "copyInfo:", 9);
  objc_msgSend(v15, "stringWithFormat:", CFSTR("<ACCNavigationRoadObjectRoadLaneInfo: ID %@, state %@, type[left %@, right %@], color[left %@, right %@], width %@, curvature[center %@, left %@, right %@]>"), v14, v3, v4, v5, v6, v7, v8, v9, v10, v11);
...
- (BOOL)_checkDataClassForType:(unsigned __int16)a3 data:(id)a4
{
  ...
  if (v4 > 9)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      v11[0] = 67109120;
      v11[1] = v4;
      _os_log_impl(&dword_219FB5000, v9, OS_LOG_TYPE_DEFAULT, "[#Navigation] ERROR: Unknown RoadObjectDetection:RoadLane InfoType %d", (uint8_t *)v11, 8u);
    }
...
- (id)copyInfo:(unsigned __int16)a3
{
  ...
  +[ACCNavigationRoadObjectRoadLaneInfo keyForType:](ACCNavigationRoadObjectRoadLaneInfo, "keyForType:", a3);
...
- (BOOL)setInfo:(unsigned __int16)a3 data:(id)a4
{
  ...
  v4 = a3;
  v6 = a4;
  +[ACCNavigationRoadObjectRoadLaneInfo keyForType:](ACCNavigationRoadObjectRoadLaneInfo, "keyForType:", v4);
