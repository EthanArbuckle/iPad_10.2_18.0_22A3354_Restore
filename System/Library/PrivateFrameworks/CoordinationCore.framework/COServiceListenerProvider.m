...
- (COServiceListenerProvider)initWithServiceName:(id)a3 entitlement:(id)a4
{
  id v7;
  id v8;
  COServiceListenerProvider *v9;
  COServiceListenerProvider *v10;
  objc_super v12;
  ...
  v9 = -[COServiceListenerProvider init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (OS_dispatch_queue)dispatchQueue
{
  ...
  if (!dispatchQueue)
  {
    -[COServiceListenerProvider serviceName](self, "serviceName");
...
- (BOOL)serviceShouldAcceptNewConnection:(id)a3
{
  ...
  v4 = a3;
  -[COServiceListenerProvider entitlement](self, "entitlement");
