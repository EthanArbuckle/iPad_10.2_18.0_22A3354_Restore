...
- (COMTTimerUpdateAction)initWithCoder:(id)a3
{
  id v4;
  COMTTimerUpdateAction *v5;
  COMTTimerUpdateAction *v6;
  COMTTimerUpdateAction *v7;
  uint64_t v8;
  MTTimer *timer;
  objc_super v11;
  ...
  if (!v5)
    goto LABEL_4;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("UT"));
  v6 = (COMTTimerUpdateAction *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (v6)
  {
    v8 = -[COMTTimerUpdateAction copy](v6, "copy");
    timer = v5->_timer;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[COMTTimerUpdateAction timer](self, "timer", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("UT"));
