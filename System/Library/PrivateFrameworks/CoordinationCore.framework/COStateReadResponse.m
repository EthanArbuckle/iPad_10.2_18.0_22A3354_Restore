...
{
  id v5;
  COStateReadResponse *v6;
  COStateReadResponse *v7;
  objc_super v9;
...
- (COStateReadResponse)initWithCoder:(id)a3
{
  ...
  v5 = -[COMeshResponse initWithCoder:](&v38, sel_initWithCoder_, v4);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[COStateReadResponse state](self, "state", v6.receiver, v6.super_class);
