...
- (COStateUpdateRequest)initWithUpdates:(id)a3 removals:(id)a4
{
  id v7;
  id v8;
  COStateUpdateRequest *v9;
  COStateUpdateRequest *v10;
  objc_super v12;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[COStateUpdateRequest updates](self, "updates", v7.receiver, v7.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("updates"));

  -[COStateUpdateRequest removals](self, "removals");
