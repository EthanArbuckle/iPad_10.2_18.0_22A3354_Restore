...
- (COAlarmDeleteEvent)initWithIdentifier:(id)a3 date:(id)a4
{
  id v7;
  id v8;
  COAlarmDeleteEvent *v9;
  COAlarmDeleteEvent *v10;
  objc_super v12;
  ...
  v9 = -[COAlarmDeleteEvent init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (COAlarmDeleteEvent)initWithCoder:(id)a3
{
  ...
  v5 = -[COAlarmDeleteEvent init](&v11, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[COAlarmDeleteEvent identifier](self, "identifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("identifier"));

  -[COAlarmDeleteEvent date](self, "date");
