...
{
  id v4;
  CSBackgroundContentActionManager *v5;
  CSBackgroundContentActionManager *v6;
  uint64_t v7;
  ...
  v5 = -[CSBackgroundContentActionManager init](&v10, sel_init);
  v6 = v5;
  if (v5)
  {
...
- (BOOL)handleAction:(id)a3 forProvider:(id)a4
{
  ...
  if (objc_msgSend(v5, "isValid"))
  {
    ...
    v12 = objc_msgSend(v11, "isEqualToString:", *MEMORY[0x1E0DAB7B8]);

    if (v12)
      v9 = -[CSBackgroundContentActionManager _addAction:](self, "_addAction:", v10);
    else
      v9 = 0;
...
- (BOOL)_addAction:(id)a3
{
  ...
  -[CSBackgroundContentActionManager delegate](self, "delegate");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "backgroundContentActionManager:addedAction:", self, v4);
...
- (void)_removeAction:(id)a3
{
  ...
  if (-[NSMutableSet containsObject:](self->_activeActions, "containsObject:", v5))
  {
    ...
    objc_msgSend(WeakRetained, "backgroundContentActionManager:removedAction:", self, v5);
...
{
  return (CSBackgroundContentActionManagerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
