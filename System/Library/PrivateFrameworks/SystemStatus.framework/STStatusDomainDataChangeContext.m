...
- (id)mutableCopyWithZone:(_NSZone *)a3
{
  ...
  result = +[STMutableStatusDomainDataChangeContext allocWithZone:](STMutableStatusDomainDataChangeContext, "allocWithZone:", a3);
  if (result)
  {
    v5 = result;
...
{
  STStatusDomainDataChangeContext *v2;
  char v3;
  objc_super v4;
  ...
  if (self)
  {
    ...
    self = -[STStatusDomainDataChangeContext init](&v4, sel_init);
    if (self)
...
- (STStatusDomainDataChangeContext)initWithCoder:(id)a3
{
  char v4;
  BOOL v5;
  STStatusDomainDataChangeContext *result;
  objc_super v7;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "encodeBool:forKey:", -[STStatusDomainDataChangeContext isUserInitiated](self, "isUserInitiated"), CFSTR("userInitiated"));
...
- (unint64_t)hash
{
  ...
  v4 = (id)objc_msgSend(v3, "appendBool:", -[STStatusDomainDataChangeContext isUserInitiated](self, "isUserInitiated"));
...
{
  return (NSString *)-[STStatusDomainDataChangeContext descriptionWithMultilinePrefix:](self, "descriptionWithMultilinePrefix:", 0);
}
...
- (id)succinctDescription
{
  ...
  -[STStatusDomainDataChangeContext succinctDescriptionBuilder](self, "succinctDescriptionBuilder");
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  ...
  -[STStatusDomainDataChangeContext descriptionBuilderWithMultilinePrefix:](self, "descriptionBuilderWithMultilinePrefix:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  ...
  -[STStatusDomainDataChangeContext _descriptionBuilderWithMultilinePrefix:forDebug:](self, a3, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "build");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
