...
- (id)_equalsBuilderWithObject:(id)a3
{
  ...
  v6 = v4;
  v7 = -[STStatusBarDataLocationEntry type](self, "type");
...
{
  id v3;
  STStatusBarDataLocationEntry *v4;
  uint64_t v5;
  objc_super v7;
...
- (id)succinctDescriptionBuilder
{
  ...
  v4 = -[STStatusBarDataLocationEntry type](self, "type");
  if (v4 > 2)
    v5 = CFSTR("(unknown)");
  else
    v5 = off_1E91E5A38[v4];
...
- (id)_hashBuilder
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (id)objc_msgSend(v3, "appendInteger:", -[STStatusBarDataLocationEntry type](self, "type"));
  return v3;
}
