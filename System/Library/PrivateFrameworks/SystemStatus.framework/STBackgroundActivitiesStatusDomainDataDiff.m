...
+ (id)diffFromData:(id)a3 toData:(id)a4
{
  ...
  void *v13;
  void *v14;
  STBackgroundActivitiesStatusDomainDataDiff *v15;

  v5 = (objc_class *)MEMORY[0x1E0D017D0];
  v6 = a4;
  v7 = a3;
  v8 = objc_alloc_init(v5);
  objc_msgSend(v7, "backgroundActivitiesAttributionListData");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "backgroundActivitiesAttributionListData");
  ...
  v15 = -[STBackgroundActivitiesStatusDomainDataDiff initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:]([STBackgroundActivitiesStatusDomainDataDiff alloc], "initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:", v8, v11, v14);
  return v15;
}
...
- (STBackgroundActivitiesStatusDomainDataDiff)init
{
  ...
  STBackgroundActivitiesStatusDomainDataDiff *v6;

  v3 = objc_alloc_init(MEMORY[0x1E0D01850]);
  v4 = objc_alloc_init(STListDataDiff);
  v5 = objc_alloc_init(STDictionaryDataDiff);
  v6 = -[STBackgroundActivitiesStatusDomainDataDiff initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:](self, "initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:", v3, v4, v5);
...
- (STBackgroundActivitiesStatusDomainDataDiff)initWithChanges:(id)a3 backgroundActivitiesAttributionListDataDiff:(id)a4 visualDescriptorsByIdentifierDictionaryDataDiff:(id)a5
{
  ...
  id v9;
  id v10;
  STBackgroundActivitiesStatusDomainDataDiff *v11;
  uint64_t v12;
  BSSettings *changes;
  uint64_t v14;
  STListDataDiff *backgroundActivitiesAttributionListDataDiff;
  uint64_t v16;
  ...
  v11 = -[STBackgroundActivitiesStatusDomainDataDiff init](&v19, sel_init);
  if (v11)
  {
...
- (id)dataByApplyingToData:(id)a3
{
  ...
  -[STBackgroundActivitiesStatusDomainDataDiff applyToMutableData:](self, "applyToMutableData:", v4);
  return v4;
}
...
- (void)applyToMutableData:(id)a3
{
  ...
  v13 = changes;
  v6 = a3;
  -[BSSettings enumerateObjectsWithBlock:](v13, "enumerateObjectsWithBlock:", &__block_literal_global_1);
  if (self)
  {
...
- (BOOL)isEmpty
{
  ...
  if (-[BSSettings isEmpty](v4, "isEmpty"))
  {
    ...
    v6 = -[STListDataDiff isEmpty](backgroundActivitiesAttributionListDataDiff, "isEmpty");
  }
  else
  {
    v6 = 0;
...
- (id)diffByApplyingDiff:(id)a3
{
  ...
  void *v18;
  STBackgroundActivitiesStatusDomainDataDiff *v19;
...
LABEL_12:
  ...
  v19 = -[STBackgroundActivitiesStatusDomainDataDiff initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:]([STBackgroundActivitiesStatusDomainDataDiff alloc], "initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:", v8, v14, v18);
LABEL_14:
...
- (BOOL)isOrthogonalToDiff:(id)a3
{
  ...
  v4 = a3;
  if (-[STBackgroundActivitiesStatusDomainDataDiff isEmpty](self, "isEmpty"))
    v5 = 1;
  else
...
- (BOOL)isEqual:(id)a3
{
  ...
  v22[1] = 3221225472;
  v22[2] = __54__STBackgroundActivitiesStatusDomainDataDiff_isEqual___block_invoke;
  v22[3] = &unk_1E91E4AB0;
  v9 = v6;
  v23 = v9;
  ...
  v20[0] = v8;
  v20[1] = 3221225472;
  v20[2] = __54__STBackgroundActivitiesStatusDomainDataDiff_isEqual___block_invoke_2;
  v20[3] = &unk_1E91E4AB0;
  v12 = v9;
  v21 = v12;
  v13 = (id)objc_msgSend(v5, "appendObject:counterpart:", backgroundActivitiesAttributionListDataDiff, v20);
  if (self)
    self = (STBackgroundActivitiesStatusDomainDataDiff *)self->_visualDescriptorsByIdentifierDictionaryDataDiff;
  v18[0] = v8;
  v18[1] = 3221225472;
  v18[2] = __54__STBackgroundActivitiesStatusDomainDataDiff_isEqual___block_invoke_3;
  v18[3] = &unk_1E91E4AB0;
  v19 = v12;
  v14 = v12;
...
- (unint64_t)hash
{
  ...
  v7 = (id)objc_msgSend(v4, "appendObject:", backgroundActivitiesAttributionListDataDiff);
  if (self)
    visualDescriptorsByIdentifierDictionaryDataDiff = self->_visualDescriptorsByIdentifierDictionaryDataDiff;
  else
    visualDescriptorsByIdentifierDictionaryDataDiff = 0;
...
{
  return (NSString *)-[STBackgroundActivitiesStatusDomainDataDiff descriptionWithMultilinePrefix:](self, "descriptionWithMultilinePrefix:", 0);
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (self)
  {
    ...
    objc_msgSend(v5, "encodeObject:forKey:", self->_backgroundActivitiesAttributionListDataDiff, CFSTR("backgroundActivitiesAttributionListDataDiff"));
    visualDescriptorsByIdentifierDictionaryDataDiff = self->_visualDescriptorsByIdentifierDictionaryDataDiff;
  }
  else
  {
    objc_msgSend(v5, "encodeObject:forKey:", 0, CFSTR("changes"));
    objc_msgSend(v5, "encodeObject:forKey:", 0, CFSTR("backgroundActivitiesAttributionListDataDiff"));
    visualDescriptorsByIdentifierDictionaryDataDiff = 0;
  }
...
- (STBackgroundActivitiesStatusDomainDataDiff)initWithCoder:(id)a3
{
  ...
  void *v7;
  BOOL v8;
  STBackgroundActivitiesStatusDomainDataDiff *v10;

  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("changes"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("backgroundActivitiesAttributionListDataDiff"));
  ...
  {
    self = -[STBackgroundActivitiesStatusDomainDataDiff initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:](self, "initWithChanges:backgroundActivitiesAttributionListDataDiff:visualDescriptorsByIdentifierDictionaryDataDiff:", v5, v6, v7);
    v10 = self;
  }
...
- (id)succinctDescription
{
  ...
  -[STBackgroundActivitiesStatusDomainDataDiff succinctDescriptionBuilder](self, "succinctDescriptionBuilder");
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  ...
  -[STBackgroundActivitiesStatusDomainDataDiff descriptionBuilderWithMultilinePrefix:](self, "descriptionBuilderWithMultilinePrefix:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  ...
  -[STBackgroundActivitiesStatusDomainDataDiff _descriptionBuilderWithMultilinePrefix:forDebug:](self, a3, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "build");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_descriptionBuilderWithMultilinePrefix:(uint64_t)a3 forDebug:
{
  ...
  if (a1)
  {
    ...
    v16[1] = 3221225472;
    v16[2] = __94__STBackgroundActivitiesStatusDomainDataDiff__descriptionBuilderWithMultilinePrefix_forDebug___block_invoke;
    v16[3] = &unk_1E91E4AD8;
    v9 = v6;
    v17 = v9;
    v18 = v3;
    objc_msgSend(v9, "appendBodySectionWithName:multilinePrefix:block:", CFSTR("backgroundActivityAttributions"), v7, v16);

    objc_msgSend(v9, "activeMultilinePrefix");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v13[0] = v8;
    v13[1] = 3221225472;
    v13[2] = __94__STBackgroundActivitiesStatusDomainDataDiff__descriptionBuilderWithMultilinePrefix_forDebug___block_invoke_2;
    v13[3] = &unk_1E91E4AD8;
    v11 = v9;
    v14 = v11;
    v15 = v3;
