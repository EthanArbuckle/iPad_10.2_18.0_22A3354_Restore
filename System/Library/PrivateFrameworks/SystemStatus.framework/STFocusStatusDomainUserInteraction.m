...
{
  return (NSString *)-[STFocusStatusDomainUserInteraction descriptionWithMultilinePrefix:](self, "descriptionWithMultilinePrefix:", 0);
}
...
- (id)succinctDescription
{
  ...
  -[STFocusStatusDomainUserInteraction succinctDescriptionBuilder](self, "succinctDescriptionBuilder");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  ...
  -[STFocusStatusDomainUserInteraction descriptionBuilderWithMultilinePrefix:](self, "descriptionBuilderWithMultilinePrefix:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
