...
{
  id v3;
  STStatusBarDataTetheringEntry *v4;
  uint64_t v5;
  objc_super v7;
...
- (id)succinctDescriptionBuilder
{
  ...
  v4 = (id)objc_msgSend(v3, "appendInteger:withName:", -[STStatusBarDataTetheringEntry connectionCount](self, "connectionCount"), CFSTR("connectionCount"));
  return v3;
}
...
- (id)_equalsBuilderWithObject:(id)a3
{
  ...
  v6 = v4;
  v7 = -[STStatusBarDataTetheringEntry connectionCount](self, "connectionCount");
...
{
  return objc_msgSend(*(id *)(a1 + 32), "connectionCount");
}
...
- (id)_hashBuilder
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (id)objc_msgSend(v3, "appendInteger:", -[STStatusBarDataTetheringEntry connectionCount](self, "connectionCount"));
  return v3;
}
...
- (void)encodeWithBSXPCCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeInt64:forKey:", self->_connectionCount, CFSTR("connectionCount"), v5.receiver, v5.super_class);
...
- (STStatusBarDataTetheringEntry)initWithBSXPCCoder:(id)a3
{
  ...
  if (v5)
    v5->_connectionCount = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("connectionCount"));
