...
- (STBackgroundActivitiesBundleRecord)initWithBundleInfoDictionary:(id)a3 bundleRecordIdentifier:(id)a4 bundleURL:(id)a5
{
  ...
  void *v17;
  void *v18;
  STBackgroundActivityVisualDescriptor *v19;
  STBackgroundActivityVisualDescriptor *v20;
  BOOL v21;
  NSObject *v22;
  uint64_t v23;
  NSDictionary *backgroundActivitiesToVisualDescriptors;
  uint64_t v25;
  NSSet *backgroundActivityIdentifiers;
  STBackgroundActivitiesBundleRecord *v28;
  void *v29;
  void *v30;
  __int128 v31;
  __int128 v32;
  ...
  if (v9)
  {
    ...
    objc_msgSend(v8, "bs_safeArrayForKey:", CFSTR("STBackgroundActivities"));
      ...
      do
      {
        ...
        do
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            ...
            v19 = -[STBackgroundActivityVisualDescriptor initWithPlistRepresentation:]([STBackgroundActivityVisualDescriptor alloc], "initWithPlistRepresentation:", v18);
            v20 = v19;
            if (v17)
              v21 = v19 == 0;
            else
            ...
            if (v21)
            {
              ...
              if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
              {
                *(_DWORD *)buf = 138477827;
                v37 = v17;
                _os_log_error_impl(&dword_1D12C7000, v22, OS_LOG_TYPE_ERROR, "No valid visual descriptor for background activity '%{private}@'", buf, 0xCu);
              }
...
{
  return -[NSDictionary objectForKeyedSubscript:](self->_backgroundActivitiesToVisualDescriptors, "objectForKeyedSubscript:", a3);
}
