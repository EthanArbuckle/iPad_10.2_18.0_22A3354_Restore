...
- (IStvOSAppRecipe)init
{
  ...
  v2 = -[IStvOSAppRecipe init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[IStvOSAppRecipe setShouldApplyMask:](v2, "setShouldApplyMask:", 1);
  return v3;
}
...
- (id)layerTreeForSize:(CGSize)a3 scale:(double)a4
{
  ...
  -[ISLayer setName:](v7, "setName:", CFSTR("root"));
  ...
  if (-[IStvOSAppRecipe shouldApplyMask](self, "shouldApplyMask"))
  {
    ...
    +[ISShapeCompositorResource tvOSRoundedRectShape](ISShapeCompositorResource, "tvOSRoundedRectShape");
...
{
  return (IFIconSpecification *)objc_msgSend(MEMORY[0x1E0D3A7B8], "tvAppIconSpecification");
}
