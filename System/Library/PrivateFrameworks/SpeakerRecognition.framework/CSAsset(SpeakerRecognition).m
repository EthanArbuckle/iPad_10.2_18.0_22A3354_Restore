...
- (id)getPhraseConfig:()SpeakerRecognition
{
  ...
  if (v4 && objc_msgSend(v4, "count") <= a3)
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x24BE28368], OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 1024;
      v12 = a3;
      _os_log_error_impl(&dword_2117D4000, v7, OS_LOG_TYPE_ERROR, "%s Config for ph: %d doesn't exist, use default", (uint8_t *)&v9, 0x12u);
    }
    v6 = 0;
  }
  else
...
- (float)satScoreThreshold
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("satThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A1F0);
...
- (uint64_t)multiUserLowScoreThreshold
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("multiUserLowScoreThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A160);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
...
- (uint64_t)multiUserHighScoreThreshold
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("multiUserHighScoreThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A178);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v2 = objc_msgSend(v1, "integerValue");
...
- (uint64_t)multiUserConfidentScoreThreshold
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("multiUserConfidentScoreThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A190);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v2 = objc_msgSend(v1, "integerValue");
...
- (uint64_t)multiUserDeltaScoreThreshold
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("multiUserDeltaScoreThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A1A8);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v2 = objc_msgSend(v1, "integerValue");
...
- (float)psrCombinationWeight
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("combinationWeight"), CFSTR("speakerRecognition"), &unk_24CC9A210);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "floatValue");
  v3 = v2;
...
- (float)satImplicitProfileDeltaThreshold
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("implicitProfileDeltaThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A220);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "floatValue");
  v3 = v2;
...
- (float)satVTImplicitThreshold
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("implicitVTThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A200);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "floatValue");
  v3 = v2;
...
- (float)pruningExplicitUttThresholdSAT
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("pruningExplicitSATThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A200);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "floatValue");
  v3 = v2;
...
- (float)pruningExplicitUttThresholdPSR
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("pruningExplicitPSRThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A200);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "floatValue");
  v3 = v2;
...
- (float)pruningThresholdSAT
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("pruningSATThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A200);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "floatValue");
  v3 = v2;
...
- (float)pruningThresholdPSR
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("pruningPSRThreshold"), CFSTR("speakerRecognition"), &unk_24CC9A200);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "floatValue");
  v3 = v2;
...
- (uint64_t)pruningNumRetentionUtterance
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("numPruningRetentionUtt"), CFSTR("speakerRecognition"), &unk_24CC9A1C0);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
...
- (uint64_t)maxAllowedEnrollmentUtterances
{
  ...
  objc_msgSend(a1, "getNumberForKey:category:default:", CFSTR("maxEnrollmentUtterances"), CFSTR("speakerRecognition"), &unk_24CC9A1D8);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v2 = objc_msgSend(v1, "unsignedIntegerValue");
...
- (id)keywordDetectorQuasarConfigFilePath
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(MEMORY[0x24BE28488], "horsemanDeviceType") != 1
    || (objc_msgSend(MEMORY[0x24BE284B0], "getDefaultRecognizerForB238"),
        v3 = (void *)objc_claimAutoreleasedReturnValue(),
    ...
    if (!v4)
    {
      ...
      if (os_log_type_enabled((os_log_t)*MEMORY[0x24BE28368], OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 136315394;
        ...
        v18 = 2114;
        v19 = v1;
        _os_log_impl(&dword_2117D4000, v10, OS_LOG_TYPE_DEFAULT, "%s Could not read: %{public}@", buf, 0x16u);
        v8 = 0;
      }
      goto LABEL_17;
    }
    v15 = 0;
    objc_msgSend(MEMORY[0x24BDD1608], "JSONObjectWithData:options:error:", v4, 0, &v15);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = v15;
    if (v6)
    {
...
LABEL_17:
      ...
      *(_DWORD *)buf = 136315650;
      ...
      v20 = 2114;
      v21 = v6;
      _os_log_impl(&dword_2117D4000, v7, OS_LOG_TYPE_DEFAULT, "%s Could not decode contents of: %{public}@: err: %{public}@", buf, 0x20u);
    }
    else if (v5)
    {
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x24BE28368], OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315394;
    ...
    v18 = 2114;
    v19 = v1;
    _os_log_impl(&dword_2117D4000, v9, OS_LOG_TYPE_DEFAULT, "%s %{public}@ doesnt exist", buf, 0x16u);
    v8 = 0;
  }
LABEL_18:
