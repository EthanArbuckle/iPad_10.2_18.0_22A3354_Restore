...
{
  -[NSMutableArray removeAllObjects](self->_metricHistorys, "removeAllObjects");
}
...
- (id)description
{
  ...
  -[PPSPBMetricStream dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_metricHistorys, "count"));
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("metricHistory"));
  }
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->_protoVersion);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v11, CFSTR("protoVersion"));
...
- (void)copyTo:(id)a3
{
  ...
  {
    objc_msgSend(v8, "clearMetricHistorys");
    v4 = -[PPSPBMetricStream metricHistorysCount](self, "metricHistorysCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        ...
        objc_msgSend(v8, "addMetricHistory:", v7);
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)v8 + 1) = *(_QWORD *)&self->_protoVersion;
    *((_BYTE *)v8 + 24) |= 1u;
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend((id)v5, "addMetricHistory:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_8;
  metricHistorys = self->_metricHistorys;
  if ((unint64_t)metricHistorys | *((_QWORD *)v4 + 2))
  {
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_metricHistorys, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    protoVersion = self->_protoVersion;
    v6 = -protoVersion;
    if (protoVersion >= 0.0)
      v6 = self->_protoVersion;
    v7 = floor(v6 + 0.5);
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[PPSPBMetricStream addMetricHistory:](self, "addMetricHistory:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
  ...
  if ((*((_BYTE *)v4 + 24) & 1) != 0)
  {
    self->_protoVersion = *((double *)v4 + 1);
    *(_BYTE *)&self->_has |= 1u;
  }
...
{
  objc_storeStrong((id *)&self->_metricHistorys, a3);
}
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_metricHistorys, 0);
}
