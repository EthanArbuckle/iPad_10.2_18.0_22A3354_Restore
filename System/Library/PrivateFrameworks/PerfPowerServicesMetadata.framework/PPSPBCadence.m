...
- (void)clearCadences
{
  -[NSMutableArray removeAllObjects](self->_cadences, "removeAllObjects");
}
...
- (id)description
{
  ...
  -[PPSPBCadence dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_cadences, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("cadences"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    objc_msgSend(v8, "clearCadences");
    v4 = -[PPSPBCadence cadencesCount](self, "cadencesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        ...
        objc_msgSend(v8, "addCadences:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addCadences:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)cadences | v4[1])
      v6 = -[NSMutableArray isEqual:](cadences, "isEqual:");
    else
      v6 = 1;
  }
  else
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PPSPBCadence addCadences:](self, "addCadences:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
...
{
  objc_storeStrong((id *)&self->_cadences, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_cadences, 0);
}
