...
- (void)clearGroupBys
{
  -[NSMutableArray removeAllObjects](self->_groupBys, "removeAllObjects");
}
...
- (id)description
{
  ...
  -[PPSPBGroupingDimensions dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  groupBys = self->_groupBys;
  if (groupBys)
    objc_msgSend(v3, "setObject:forKey:", groupBys, CFSTR("groupBy"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    objc_msgSend(v8, "clearGroupBys");
    v4 = -[PPSPBGroupingDimensions groupBysCount](self, "groupBysCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addGroupBy:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)groupBys | v4[1])
      v6 = -[NSMutableArray isEqual:](groupBys, "isEqual:");
    else
      v6 = 1;
  }
  else
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PPSPBGroupingDimensions addGroupBy:](self, "addGroupBy:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
...
{
  objc_storeStrong((id *)&self->_groupBys, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_groupBys, 0);
}
