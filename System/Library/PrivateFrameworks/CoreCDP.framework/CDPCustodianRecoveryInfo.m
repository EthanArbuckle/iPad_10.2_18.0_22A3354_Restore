...
- (CDPCustodianRecoveryInfo)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[CDPCustodianRecoveryInfo init](self, "init");
  if (v5)
  {
...
{
  return -[CDPCustodianRecoveryInfo initWithWrappedRKC:wrappingKey:custodianUUID:recordBuildVersion:](self, "initWithWrappedRKC:wrappingKey:custodianUUID:recordBuildVersion:", a3, a4, a5, 0);
}
...
- (CDPCustodianRecoveryInfo)initWithWrappedRKC:(id)a3 wrappingKey:(id)a4 custodianUUID:(id)a5 recordBuildVersion:(id)a6
{
  ...
  v15 = -[CDPCustodianRecoveryInfo init](&v18, sel_init);
  v16 = v15;
  if (v15)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[CDPCustodianRecoveryInfo init](+[CDPCustodianRecoveryInfo allocWithZone:](CDPCustodianRecoveryInfo, "allocWithZone:", a3), "init");
