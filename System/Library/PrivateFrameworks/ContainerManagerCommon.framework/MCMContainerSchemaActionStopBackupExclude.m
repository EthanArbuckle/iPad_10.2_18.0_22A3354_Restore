...
{
  id v6;
  MCMContainerSchemaActionStopBackupExclude *v7;
  uint64_t v8;
  NSURL *url;
  objc_super v11;
  uint64_t v12;
...
- (BOOL)performWithError:(id *)a3
{
  ...
  url = self->_url;
  v11[0] = 0;
  v5 = -[MCMContainerSchemaActionBase fixAndRetryIfPermissionsErrorWithURL:error:duringBlock:](self, "fixAndRetryIfPermissionsErrorWithURL:error:duringBlock:", url, v11, &__block_literal_global_4768);
  v6 = v11[0];
...
uint64_t __62__MCMContainerSchemaActionStopBackupExclude_performWithError___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "removeExclusionFromBackupFromURL:error:", v4, a3);
...
+ (id)actionIdentifier
{
  ...
  v2 = CFSTR("stop-backup-exclude");
  return CFSTR("stop-backup-exclude");
}
