...
+ (id)twoDecimalLocation:(id)a3
{
  ...
  return (id)objc_msgSend(objc_alloc(MEMORY[0x24BE3CC08]), "initWithCoordinate:", v3, v4);
}
...
+ (double)dayResolution:(double)a3
{
  ...
  +[GEOAPFuzzers fuzzTime:bySeconds:](GEOAPFuzzers, "fuzzTime:bySeconds:", 86400, a3);
  return result;
}
...
+ (unsigned)fuzzDailyCount:(unsigned int)a3 forDailyUsageType:(unsigned int)a4
{
  ...
  switch(a4)
  {
    ...
    case 0xE1u:
    case 0xE3u:
      result = +[GEOAPFuzzers max1:](GEOAPFuzzers, "max1:", *(_QWORD *)&a3);
      break;
    case 0x16u:
    case 0x58u:
    case 0x59u:
    ...
    case 0x7Cu:
    case 0x7Fu:
      result = +[GEOAPFuzzers max11:](GEOAPFuzzers, "max11:", *(_QWORD *)&a3);
      break;
    case 0x19u:
    case 0x1Au:
    case 0x1Cu:
    ...
    case 0xE0u:
    case 0xE2u:
      result = +[GEOAPFuzzers max6:](GEOAPFuzzers, "max6:", *(_QWORD *)&a3);
      break;
    case 0x7Du:
    case 0x7Eu:
    case 0xC6u:
      result = +[GEOAPFuzzers bucket21:](GEOAPFuzzers, "bucket21:", *(_QWORD *)&a3);
      break;
    case 0x97u:
    case 0xA6u:
      result = +[GEOAPFuzzers bucket1800:](GEOAPFuzzers, "bucket1800:", *(_QWORD *)&a3);
      break;
    default:
      result = a3;
      break;
...
+ (unsigned)fuzzMonthlyCount:(unsigned int)a3 forDailyUsageType:(unsigned int)a4
{
  ...
  {
    if (a4 == 83)
      return +[GEOAPFuzzers max2:](GEOAPFuzzers, "max2:", *(_QWORD *)&a3);
    return a3;
  }
  else
  {
    if (((1 << (a4 + 65)) & 0x79) != 0)
      return +[GEOAPFuzzers max2:](GEOAPFuzzers, "max2:", *(_QWORD *)&a3);
    return +[GEOAPFuzzers max1:](GEOAPFuzzers, "max1:", *(_QWORD *)&a3);
  }
}
