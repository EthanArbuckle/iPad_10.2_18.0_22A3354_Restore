...
{
  SCKZoneMemoryStore *v2;
  SCKZoneMemoryStore *v3;
  ...
  v2 = -[SCKZoneMemoryStore init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    serverRecords = v2->_serverRecords;
    v5 = (NSArray *)MEMORY[0x24BDBD1A8];
    v2->_serverRecords = (NSArray *)MEMORY[0x24BDBD1A8];
...
- (void)applyServerRecordsDiff:(id)a3
{
  ...
  v4 = a3;
  -[SCKZoneMemoryStore serverRecords](self, "serverRecords");
...
- (void)addPendingCommands:(id)a3
{
  ...
  v4 = a3;
  -[SCKZoneMemoryStore pendingCommands](self, "pendingCommands");
  v7 = (id)objc_claimAutoreleasedReturnValue();
