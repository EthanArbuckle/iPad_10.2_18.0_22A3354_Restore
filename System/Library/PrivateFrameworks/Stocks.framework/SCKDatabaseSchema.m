...
- (SCKDatabaseSchema)initWithName:(id)a3 environment:(int64_t)a4 security:(int64_t)a5 zoneSchemas:(id)a6
{
  ...
  v12 = -[SCKDatabaseSchema init](&v18, sel_init);
  if (v12)
  {
...
- (CKContainerID)containerID
{
  ...
  if (-[SCKDatabaseSchema environment](self, "environment") == 1)
    v3 = 1;
  else
    v3 = 2;
  v4 = objc_alloc(MEMORY[0x24BDB9038]);
  -[SCKDatabaseSchema name](self, "name");
...
- (NSArray)zoneIDs
{
  ...
  v13 = 0u;
  v14 = 0u;
  -[SCKDatabaseSchema zoneSchemas](self, "zoneSchemas", 0);
...
{
  return -[SCKDatabaseSchema security](self, "security") != 0;
}
