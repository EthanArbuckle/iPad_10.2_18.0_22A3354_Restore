...
{
  id v5;
  SCKFauxDatabaseStoreCoordinator *v6;
  SCKFauxDatabaseStoreCoordinator *v7;
  NSObject *v8;
  dispatch_queue_t v9;
  ...
  v6 = -[SCKFauxDatabaseStoreCoordinator init](&v12, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (void)readWithAccessor:(id)a3
{
  ...
  v4 = a3;
  -[SCKFauxDatabaseStoreCoordinator queue](self, "queue");
  v5 = objc_claimAutoreleasedReturnValue();
  block[0] = MEMORY[0x24BDAC760];
  block[1] = 3221225472;
  block[2] = __52__SCKFauxDatabaseStoreCoordinator_readWithAccessor___block_invoke;
  block[3] = &unk_24D74BB48;
  block[4] = self;
  v8 = v4;
  v6 = v4;
...
- (void)writeWithAccessor:(id)a3
{
  ...
  block[0] = MEMORY[0x24BDAC760];
  block[1] = 3221225472;
  block[2] = __53__SCKFauxDatabaseStoreCoordinator_writeWithAccessor___block_invoke;
  block[3] = &unk_24D74BB48;
  block[4] = self;
  v8 = v4;
  v6 = v4;
...
- (void)reloadWithAccessor:(id)a3
{
  ...
  block[0] = MEMORY[0x24BDAC760];
  block[1] = 3221225472;
  block[2] = __54__SCKFauxDatabaseStoreCoordinator_reloadWithAccessor___block_invoke;
  block[3] = &unk_24D74BB48;
  block[4] = self;
  v8 = v4;
  v6 = v4;
