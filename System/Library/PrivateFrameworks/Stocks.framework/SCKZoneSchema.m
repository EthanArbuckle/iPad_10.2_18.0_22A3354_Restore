...
- (SCKZoneSchema)initWithName:(id)a3 atomic:(BOOL)a4 recordSchemas:(id)a5
{
  ...
  v11 = -[SCKZoneSchema init](&v16, sel_init);
  if (v11)
  {
    v12 = objc_alloc(MEMORY[0x24BDB91F8]);
    v13 = objc_msgSend(v12, "initWithZoneName:ownerName:", v9, *MEMORY[0x24BDB8E88]);
    zoneID = v11->_zoneID;
...
- (NSArray)allRecordFieldNames
{
  ...
  v13 = 0u;
  v14 = 0u;
  -[SCKZoneSchema recordSchemas](self, "recordSchemas", 0);
...
- (BOOL)isValidRecord:(id)a3
{
  ...
  -[SCKZoneSchema zoneName](self, "zoneName");
