...
- (id)URLWithUsername:()DAKeychainAddition withPassword:
{
  ...
  v6 = a3;
  v7 = a4;
  if (!v6 || -[__CFString isEqualToString:](v6, "isEqualToString:", &stru_1E7B93480))
  {
...
LABEL_4:
  ...
  {
    v16 = (__CFString *)CFURLCreateStringByAddingPercentEscapes(0, v6, &stru_1E7B93480, CFSTR("?@/|:"), 0x8000100u);
    v17 = (__CFString *)CFURLCreateStringByAddingPercentEscapes(0, v7, &stru_1E7B93480, CFSTR("?@/|:"), 0x8000100u);
...
- (id)URLWithUsername:()DAKeychainAddition
{
  ...
  v4 = a3;
  v5 = v4;
  if (v4 && !-[__CFString isEqualToString:](v4, "isEqualToString:", &stru_1E7B93480))
  {
    objc_msgSend(a1, "scheme");
    ...
    {
      v11 = (__CFString *)CFURLCreateStringByAddingPercentEscapes(0, v5, &stru_1E7B93480, CFSTR("?@/|:"), 0x8000100u);
