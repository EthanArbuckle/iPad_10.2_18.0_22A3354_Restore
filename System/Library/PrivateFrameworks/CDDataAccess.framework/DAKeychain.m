...
- (id)passwordForAccountWithPersistentUUID:(id)a3 expectedAccessibility:(int)a4 shouldSetAccessibility:(BOOL)a5 passwordExpected:(BOOL)a6
{
  ...
  v12 = MEMORY[0x1E0D03918];
  v13 = *(_BYTE *)(MEMORY[0x1E0D03918] + 7);
  if (os_log_type_enabled(v11, v13))
  {
    *(_DWORD *)buf = 138412290;
    v38 = v10;
    _os_log_impl(&dword_1C1CD1000, v11, v13, "Loading password for %@", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v18, v21))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v39 = 1024;
        v40 = v17;
        _os_log_impl(&dword_1C1CD1000, v19, v21, "Could not find a password in the keychain for %@, error %d", buf, 0x12u);
      }
      v22 = 0;
      v23 = 0;
    }
    else
    {
      ...
      if ((_DWORD)v26 != (_DWORD)v8 && v7)
      {
        ...
        v28 = *(_BYTE *)(MEMORY[0x1E0D03918] + 6);
        if (os_log_type_enabled(v27, v28))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v39 = 1024;
          v40 = v8;
          _os_log_impl(&dword_1C1CD1000, v27, v28, "Securing ur sekretz: moving credential for account %@ to accessibility %d", buf, 0x12u);
        }
        ...
        if (v31)
        {
          ...
          v33 = *(_BYTE *)(MEMORY[0x1E0D03918] + 3);
          if (os_log_type_enabled(v32, v33))
          {
            *(_DWORD *)buf = 67109120;
            LODWORD(v38) = v31;
            _os_log_impl(&dword_1C1CD1000, v32, v33, "Couldn't change password accessibility, error %d", buf, 8u);
          }
...
- (BOOL)setPassword:(id)a3 forAccount:(id)a4 withPersistentUUID:(id)a5 withAccessibility:(int)a6
{
  ...
  *(_QWORD *)&v30[5] = *MEMORY[0x1E0C80C00];
  ...
  if (objc_msgSend(v10, "length"))
  {
    ...
    v14 = MEMORY[0x1E0D03918];
    v15 = *(_BYTE *)(MEMORY[0x1E0D03918] + 6);
    if (os_log_type_enabled(v13, v15))
    {
      *(_DWORD *)buf = 138412290;
      *(_QWORD *)v30 = v12;
      _os_log_impl(&dword_1C1CD1000, v13, v15, "Setting password for account with UUID %@", buf, 0xCu);
    }
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v24, v25))
      {
        ...
        *(_QWORD *)((char *)&v30[1] + 2) = v12;
        _os_log_impl(&dword_1C1CD1000, v24, v25, "Error %d, Can't update password for account %@", buf, 0x12u);
      }
...
- (BOOL)removePasswordForAccount:(id)a3 withPersistentUUID:(id)a4
{
  ...
  *(_QWORD *)&v18[5] = *MEMORY[0x1E0C80C00];
  ...
  v8 = MEMORY[0x1E0D03918];
  v9 = *(_BYTE *)(MEMORY[0x1E0D03918] + 6);
  if (os_log_type_enabled(v7, v9))
  {
    v17 = 138412290;
    *(_QWORD *)v18 = v5;
    _os_log_impl(&dword_1C1CD1000, v7, v9, "Removing password for account with UUID %@", (uint8_t *)&v17, 0xCu);
  }
  ...
  if (v10 != -25300 && v10)
  {
    ...
    if (os_log_type_enabled(v12, v13))
    {
      ...
      *(_QWORD *)((char *)&v18[1] + 2) = v5;
      _os_log_impl(&dword_1C1CD1000, v12, v13, "Error %d, Couldn't delete password from keychain for account %@", (uint8_t *)&v17, 0x12u);
    }
...
- (void)migratePasswordForAccount:(id)a3
{
  ...
  if (v5)
  {
    ...
    DALoggingwithCategory();
    v19 = objc_claimAutoreleasedReturnValue();
    v20 = *(_BYTE *)(MEMORY[0x1E0D03918] + 4);
    if (os_log_type_enabled(v19, v20))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v46 = 2112;
      v47 = v25;
      _os_log_impl(&dword_1C1CD1000, v19, v20, "During Migration, password present. Setting _backingAccountInfo.authenticated = YES for Account identifier %@ and username %@", buf, 0x16u);
...
- (BOOL)saveKeychainInformationsForURL:(id)a3 andPassword:(id)a4 withAccessibility:(int)a5
{
  ...
  if (os_log_type_enabled(v10, v12))
  {
    *(_DWORD *)buf = 138412290;
    *(_QWORD *)&buf[4] = v8;
    _os_log_impl(&dword_1C1CD1000, v10, v12, "Saving password for %@", buf, 0xCu);
  }
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9
    && (objc_msgSend(v9, "isEqualToString:", &stru_1E7B93480) & 1) == 0
    && v13
    && (objc_msgSend(v13, "isEqualToString:", &stru_1E7B93480) & 1) == 0
    && v14
    && (objc_msgSend(v14, "isEqualToString:", &stru_1E7B93480) & 1) == 0
    && v15
    && !objc_msgSend(v15, "isEqualToString:", &stru_1E7B93480))
  {
...
LABEL_40:
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_1C1CD1000, v39, v12, "Setting password for account", buf, 2u);
        }
        ...
        *(_QWORD *)buf = 0;
        ...
        if (v40 == -25299)
        {
          ...
          if (v41)
          {
            ...
            if (os_log_type_enabled(v46, valueb))
            {
              *(_DWORD *)v62 = 67109120;
              v63 = v41;
              _os_log_impl(&dword_1C1CD1000, v46, valueb, "Couldn't set password, error %d", v62, 8u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v47, v48))
          {
            *(_DWORD *)v62 = 67109120;
            v63 = v41;
            _os_log_impl(&dword_1C1CD1000, v47, v48, "Couldn't add password, error %d", v62, 8u);
          }
...
LABEL_70:
        ...
        if (os_log_type_enabled(v49, v50))
        {
          ...
          *(_WORD *)&buf[8] = 2112;
          *(_QWORD *)&buf[10] = v30;
          _os_log_impl(&dword_1C1CD1000, v49, v50, "Error %d while trying to add a password: %@", buf, 0x12u);
        }
...
LABEL_68:
  ...
  if (os_log_type_enabled(v16, v17))
  {
    v18 = CFSTR("Password ");
    log = v16;
    if (v9 && !objc_msgSend(v9, "isEqualToString:", &stru_1E7B93480))
      v18 = &stru_1E7B93480;
    value = v8;
    v19 = CFSTR("Login ");
    v20 = v15;
    v21 = v9;
    if (v13 && !objc_msgSend(v13, "isEqualToString:", &stru_1E7B93480))
      v19 = &stru_1E7B93480;
    v22 = v13;
    v23 = CFSTR("Host ");
    if (v14)
    {
      v24 = v14;
      if (!objc_msgSend(v14, "isEqualToString:", &stru_1E7B93480))
        v23 = &stru_1E7B93480;
    }
    else
    {
    ...
    v26 = CFSTR("Scheme ");
    if (v20 && !objc_msgSend(v20, "isEqualToString:", &stru_1E7B93480))
      v26 = &stru_1E7B93480;
    ...
    *(_QWORD *)&buf[14] = v19;
    ...
    v61 = v26;
    v16 = log;
    _os_log_impl(&dword_1C1CD1000, log, v17, "Refusing to save password in keychain because one or more of the necessary fields are null: %@%@%@%@", buf, 0x2Au);
    v25 = 0;
    v14 = v24;
    v13 = v22;
    v9 = v21;
...
- (id)loadKeychainInformationsForURL:(id)a3
{
  ...
  v5 = MEMORY[0x1E0D03918];
  v6 = *(_BYTE *)(MEMORY[0x1E0D03918] + 7);
  if (os_log_type_enabled(v4, v6))
  {
    *(_DWORD *)buf = 138412290;
    v31 = v3;
    _os_log_impl(&dword_1C1CD1000, v4, v6, "Loading password for %@", buf, 0xCu);
  }
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v7
    || (objc_msgSend(v7, "isEqualToString:", &stru_1E7B93480) & 1) != 0
    || !v8
    || (objc_msgSend(v8, "isEqualToString:", &stru_1E7B93480) & 1) != 0
    || !v9
    || objc_msgSend(v9, "isEqualToString:", &stru_1E7B93480))
  {
    DALoggingwithCategory();
    v10 = objc_claimAutoreleasedReturnValue();
    v11 = *(_BYTE *)(v5 + 3);
    ...
    {
      v12 = CFSTR("Login ");
      if (v7 && !objc_msgSend(v7, "isEqualToString:", &stru_1E7B93480))
        v12 = &stru_1E7B93480;
      v13 = CFSTR("Host ");
      if (v8 && !objc_msgSend(v8, "isEqualToString:", &stru_1E7B93480))
        v13 = &stru_1E7B93480;
      v14 = CFSTR("Scheme ");
      if (v9 && !objc_msgSend(v9, "isEqualToString:", &stru_1E7B93480))
        v14 = &stru_1E7B93480;
      *(_DWORD *)buf = 138412802;
      ...
      v34 = 2112;
      v35 = v14;
      _os_log_impl(&dword_1C1CD1000, v10, v11, "Refusing to retreive password from keychain because one or more of the necessary fields are null: %@%@%@", buf, 0x20u);
    }
...
LABEL_32:
  ...
  if (SecItemCopyMatching(Mutable, &result))
  {
    ...
    if (os_log_type_enabled(v26, v27))
    {
      *(_DWORD *)buf = 138412290;
      v31 = v3;
      _os_log_impl(&dword_1C1CD1000, v26, v27, "Could not find a password in the keychain for %@", buf, 0xCu);
    }
...
- (void)removeKeychainInformationsForURL:(id)a3
{
  ...
  if (os_log_type_enabled(v4, v6))
  {
    v28 = 138412290;
    *(_QWORD *)v29 = v3;
    _os_log_impl(&dword_1C1CD1000, v4, v6, "Removing password for %@", (uint8_t *)&v28, 0xCu);
  }
    ...
    || objc_msgSend(v9, "isEqualToString:", &stru_1E7B93480))
  {
    ...
    if (os_log_type_enabled(v10, v11))
    {
      ...
      *(_QWORD *)&v29[10] = v13;
      v30 = 2112;
      v31 = v14;
      _os_log_impl(&dword_1C1CD1000, v10, v11, "Refusing to delete password from keychain because one or more of the necessary fields are null: %@%@%@", (uint8_t *)&v28, 0x20u);
    }
...
LABEL_31:
  ...
  if (v24)
  {
    ...
    if (os_log_type_enabled(v26, v27))
    {
      ...
      *(_WORD *)&v29[4] = 2112;
      *(_QWORD *)&v29[6] = v3;
      _os_log_impl(&dword_1C1CD1000, v26, v27, "error %d: Could not delete password for %@", (uint8_t *)&v28, 0x12u);
    }
