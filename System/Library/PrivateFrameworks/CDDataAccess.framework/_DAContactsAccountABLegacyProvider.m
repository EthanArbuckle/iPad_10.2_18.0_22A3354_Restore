...
- (void)dealloc
{
  ...
  -[_DAContactsAccountABLegacyProvider dealloc](&v3, sel_dealloc);
}
...
- (id)accountWithExternalIdentifier:(id)a3 createIfNecessary:(BOOL)a4
{
  ...
  else
  {
    ...
    ABAddressBookAddRecord(-[_DAContactsAccountABLegacyProvider addressBook](self, "addressBook"), v9, 0);
    -[_DAContactsAccountABLegacyProvider addressBook](self, "addressBook");
  ...
  v12 = -[DAABLegacyAccount initWithABAccout:](v10, "initWithABAccout:", CFAutorelease(v11));
LABEL_8:
