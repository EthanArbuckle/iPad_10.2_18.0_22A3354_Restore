...
- (void)handleTrust:(__SecTrust *)a3 forHost:(id)a4 forAccount:(id)a5 withCompletionBlock:(id)a6
{
  ...
  v13 = *(_BYTE *)(MEMORY[0x1E0D03918] + 6);
  if (os_log_type_enabled(v11, v13))
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1C1CD1000, v11, v13, "Checking to see if we should trust the server certificate", buf, 2u);
  }
  ...
  if (!a3)
  {
    ...
    if (os_log_type_enabled(v15, *(os_log_type_t *)(v12 + 3)))
    {
      ...
      *(_QWORD *)&buf[4] = v9;
      _os_log_impl(&dword_1C1CD1000, v15, (os_log_type_t)v21, "Terminating connection because server does not have an SSL certificate. Host: %@", buf, 0xCu);
    }
    v20 = 0;
    goto LABEL_26;
  }
  ...
  if (v17 != 5)
  {
    if (v17 != 4)
    {
      ...
      if (os_log_type_enabled(v19, v13))
      {
        *(_DWORD *)buf = 67109120;
        *(_DWORD *)&buf[4] = v17;
        _os_log_impl(&dword_1C1CD1000, v19, v13, "Got SecTrustEvaluate result %u. Denying.", buf, 8u);
      }
      v20 = 0;
      goto LABEL_25;
    }
    if ((-[NSObject BOOLValue](v15, "BOOLValue") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v18, v13))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v44;
        _os_log_impl(&dword_1C1CD1000, v18, v13, "Account now requires trusted certificate. Setting %@ to YES for account: %@", buf, 0x16u);
      }
...
LABEL_11:
    ...
    if (os_log_type_enabled(v19, v13))
    {
      *(_DWORD *)buf = 67109120;
      *(_DWORD *)&buf[4] = v17;
      _os_log_impl(&dword_1C1CD1000, v19, v13, "Got SecTrustEvaluate result %u. Allowing.", buf, 8u);
    }
    v20 = 1;
LABEL_25:
...
LABEL_27:
  ...
  if (os_log_type_enabled(v22, v13))
  {
    *(_DWORD *)buf = 67109120;
    *(_DWORD *)&buf[4] = 5;
    _os_log_impl(&dword_1C1CD1000, v22, v13, "Got SecTrustEvaluate result %u. Checking if needing to prompt.", buf, 8u);
  }
  ...
  if (v42)
  {
    ...
    if (os_log_type_enabled(v23, v25))
    {
      ...
      *(_QWORD *)&buf[4] = v44;
      ...
      v28 = v25;
LABEL_31:
      _os_log_impl(&dword_1C1CD1000, v27, v28, v26, buf, 0xCu);
    }
  }
...
LABEL_49:
  ...
  if ((objc_msgSend(MEMORY[0x1E0D03908], "promptForAllCerts") & 1) == 0)
  {
  ...
  if (!*(_BYTE *)(*(_QWORD *)&buf[8] + 24))
  {
    ...
    if (os_log_type_enabled(v35, v36))
    {
      *(_DWORD *)v55 = 138412290;
      v56 = v9;
      _os_log_impl(&dword_1C1CD1000, v35, v36, "IT'S A TARP!!! We received an untrusted cert for %@. You really think we're going to fall for that?", v55, 0xCu);
    }
  ...
  if (os_log_type_enabled(v37, v13))
  {
    *(_DWORD *)v55 = 138412290;
    v56 = v9;
    _os_log_impl(&dword_1C1CD1000, v37, v13, "prompting certificate for host: %@", v55, 0xCu);
  }
...
uint64_t __69__DATrustHandler_handleTrust_forHost_forAccount_withCompletionBlock___block_invoke_2(uint64_t a1)
{
  ...
  v3 = *(_BYTE *)(MEMORY[0x1E0D03918] + 6);
  if (os_log_type_enabled(v2, v3))
  {
    v4 = *(_DWORD *)(a1 + 80);
    v9[0] = 67109120;
    v9[1] = v4;
    _os_log_impl(&dword_1C1CD1000, v2, v3, "got prompt response %d", (uint8_t *)v9, 8u);
  }
...
void __68__DATrustHandler_handleTrustChallenge_forAccount_completionHandler___block_invoke()
{
  ...
  v4 = (void *)handleTrustChallenge_forAccount_completionHandler__outstandingTrustChallengeLock;
  handleTrustChallenge_forAccount_completionHandler__outstandingTrustChallengeLock = (uint64_t)v3;
...
void __68__DATrustHandler_handleTrustChallenge_forAccount_completionHandler___block_invoke_2(uint64_t a1)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1C1CD1000, v2, v3, "Grabbing trust challenge lock...", buf, 2u);
  }
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1C1CD1000, v4, v3, "Lock acquired. Checking trust.", buf, 2u);
  }
...
void __68__DATrustHandler_handleTrustChallenge_forAccount_completionHandler___block_invoke_15(uint64_t a1, int a2)
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    v14 = 138412290;
    v15 = v7;
    _os_log_impl(&dword_1C1CD1000, v5, v6, "%@Continuing connection", (uint8_t *)&v14, 0xCu);
  }
