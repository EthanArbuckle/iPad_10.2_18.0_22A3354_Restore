...
- (id)description
{
  ...
  {
    objc_msgSend(v3, "stringWithFormat:", CFSTR("<%@: %p> { Change type: %@, ChangedItem: %@ serverId: %@%@}"), v4, self, v5, v6, v7, &stru_1E7B93480);
...
- (DAAction)initWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v5, "allowsKeyedCoding") & 1) == 0)
  {
    ...
    objc_msgSend(v17, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAction.m"), 73, CFSTR("Who does non-keyed coding nowadays?"));

  }
  v18.receiver = self;
  v18.super_class = (Class)DAAction;
  v6 = -[DAAction init](&v18, sel_init);
  if (v6)
  {
    v7 = objc_msgSend(v5, "decodeIntForKey:", CFSTR("DAAItemChangeType"));
    v8 = (int)v7;
    if (v7 >= 0xA)
    {
      DALoggingwithCategory();
      v9 = objc_claimAutoreleasedReturnValue();
      v10 = *(_BYTE *)(MEMORY[0x1E0D03918] + 2);
      if (os_log_type_enabled(v9, v10))
      {
        *(_DWORD *)buf = 134217984;
        v20 = v8;
        _os_log_impl(&dword_1C1CD1000, v9, v10, "Unknown DAItemChangeType %ld", buf, 0xCu);
      }

      v8 = 1;
    }
    -[DAAction setItemChangeType:](v6, "setItemChangeType:", v8);
    v11 = NSClassFromString(CFSTR("ASChangedCollectionLeaf"));
    objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", objc_opt_class(), v11, 0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "decodeObjectOfClasses:forKey:", v12, CFSTR("DAAChangedItem"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAAction _setChangedItem:](v6, "_setChangedItem:", v13);

    objc_msgSend(v5, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("DAAServerId"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAAction setServerId:](v6, "setServerId:", v14);

    objc_msgSend(v5, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("DAAInstanceId"));
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAAction setInstanceId:](v6, "setInstanceId:", v15);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v9, "allowsKeyedCoding") & 1) == 0)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAction.m"), 107, CFSTR("Who does non-keyed coding nowadays?"));
