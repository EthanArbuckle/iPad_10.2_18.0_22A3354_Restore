...
- (DAMoveAction)initWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v5, "allowsKeyedCoding") & 1) == 0)
  {
    ...
    objc_msgSend(v11, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAction.m"), 157, CFSTR("Who does non-keyed coding nowadays?"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v5, "allowsKeyedCoding") & 1) == 0)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAAction.m"), 168, CFSTR("Who does non-keyed coding nowadays?"));
