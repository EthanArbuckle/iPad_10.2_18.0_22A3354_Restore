...
- (RPStatusProvider)init
{
  ...
  v2 = -[RPStatusProvider init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (RPStatusProvider)initWithCoder:(id)a3
{
  ...
  v3 = -[RPStatusProvider init](&v7, sel_init, a3);
  v4 = v3;
  if (v3)
  {
...
void __62__RPStatusProvider_provideStatusUpdate_statusInfo_completion___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    objc_msgSend(v4, "xpcStatusUpdatableProvideStatus:statusInfo:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
...
LABEL_9:
  ...
  {
    if (gLogCategory_StatusProvider != -1 || (v5 = _LogCategory_Initialize(), v3 = v7, v5))
    {
      LogPrintF();
      v3 = v7;
    }
...
void __50__RPStatusProvider_cancelStatusUpdate_completion___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 24), "remoteObjectProxy");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "xpcStatusUpdatableCancelProvideStatus:", *(_QWORD *)(a1 + 40));
...
- (void)_activateWithCompletion:(id)a3 reactivate:(BOOL)a4
{
  ...
  LogPrintF();
LABEL_14:
  -[RPStatusProvider _ensureXPCStarted](self, "_ensureXPCStarted", v14);
  ...
  else
  {
    ...
    v18[1] = 3221225472;
    v18[2] = __55__RPStatusProvider__activateWithCompletion_reactivate___block_invoke;
    v18[3] = &unk_1E5F4EED8;
    v20 = v4;
    v11 = v6;
    v19 = v11;
    ...
    v15[0] = v9;
    v15[1] = 3221225472;
    v15[2] = __55__RPStatusProvider__activateWithCompletion_reactivate___block_invoke_2;
    v15[3] = &unk_1E5F4F4A0;
    v17 = v4;
    v15[4] = self;
    v13 = v11;
    v16 = v13;
    objc_msgSend(v12, "xpcStatusProviderActivate:completion:", self, v15);
...
- (id)_ensureXPCStarted
{
  ...
  if (!self->_xpcCnx)
  {
    ...
    v14[1] = 3221225472;
    v14[2] = __37__RPStatusProvider__ensureXPCStarted__block_invoke;
    v14[3] = &unk_1E5F4EC60;
    v14[4] = self;
    v5 = (void *)MEMORY[0x1AF45BE48](v14, a2);
    v13[0] = v4;
    v13[1] = 3221225472;
    v13[2] = __37__RPStatusProvider__ensureXPCStarted__block_invoke_2;
    v13[3] = &unk_1E5F4EC60;
    v13[4] = self;
    ...
    -[RPStatusProvider _connectionWithClient:queue:userProvider:interruptionHandler:invalidationHandler:](self, "_connectionWithClient:queue:userProvider:interruptionHandler:invalidationHandler:", self, self->_dispatchQueue, self->_userProvider, v5, v6, v12);
...
- (id)_connectionWithClient:(id)a3 queue:(id)a4 userProvider:(id)a5 interruptionHandler:(id)a6 invalidationHandler:(id)a7
{
  ...
  objc_msgSend(v24, "setClasses:forSelector:argumentIndex:ofReply:", v27, sel_xpcStatusProviderActivate_completion_, 0, 1);

  objc_msgSend(v24, "setClasses:forSelector:argumentIndex:ofReply:", v22, sel_xpcStatusUpdatableProvideStatus_statusInfo_, 0, 0);
  v28 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E60]), "initWithObjects:", objc_opt_class(), 0);
  objc_msgSend(v24, "setClasses:forSelector:argumentIndex:ofReply:", v28, sel_xpcStatusUpdatableCancelProvideStatus_, 0, 0);
...
- (void)_interrupted
{
  ...
  if (self->_activateCalled)
    -[RPStatusProvider _activateWithCompletion:reactivate:](self, "_activateWithCompletion:reactivate:", 0, 1);
...
{
  objc_storeStrong((id *)&self->_currentlyProviding, a3);
}
