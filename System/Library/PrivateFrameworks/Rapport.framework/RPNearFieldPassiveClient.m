...
- (void)startDiscoveryWithApplicationLabels:(id)a3 completion:(id)a4
{
  ...
  v18[1] = 3221225472;
  v18[2] = __75__RPNearFieldPassiveClient_startDiscoveryWithApplicationLabels_completion___block_invoke;
  v18[3] = &unk_1E5F4ED20;
  v11 = v7;
  v19 = v11;
  ...
  v15[0] = v10;
  v15[1] = 3221225472;
  v15[2] = __75__RPNearFieldPassiveClient_startDiscoveryWithApplicationLabels_completion___block_invoke_2;
  v15[3] = &unk_1E5F4F3E8;
  v16 = v6;
  v17 = v11;
  v13 = v11;
  v14 = v6;
  objc_msgSend(v12, "startPassiveDiscoveryWithApplicationLabels:completion:", v14, v15);
...
- (void)receivedAlwaysOnEventWithSuggestedRole:(unsigned int)a3
{
  ...
  v3 = *(_QWORD *)&a3;
  v4 = (void (**)(_QWORD, _QWORD))MEMORY[0x1AF45BE48](self->_alwaysOnHandler, a2);
  if (v4)
  {
    v5 = v4;
    v4[2](v4, v3);
...
- (void).cxx_destruct
{
  objc_storeStrong(&self->_alwaysOnHandler, 0);
}
