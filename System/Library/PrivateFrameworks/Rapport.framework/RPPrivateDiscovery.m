...
- (RPPrivateDiscovery)init
{
  ...
  if (v3)
  {
    do
    {
      v5 = __ldaxr((unsigned int *)&gRPPrivateDiscoveryClientIDNext);
      v6 = v5 + 1;
    }
...
uint64_t __26__RPPrivateDiscovery_init__block_invoke()
{
  ...
  result = RandomBytes();
  gRPPrivateDiscoveryClientIDNext = (unsigned __int16)word_1EEE3A2E2 << 16;
  return result;
}
...
- (RPPrivateDiscovery)initWithCoder:(id)a3
{
  ...
  RPPrivateDiscovery *v6;
  id v7;
  RPPrivateDiscovery *v8;
  objc_super v10;
  uint64_t v11;
  ...
  v5 = -[RPPrivateDiscovery init](&v10, sel_init);
  v6 = v5;
  if (v5)
  {
...
void __37__RPPrivateDiscovery__activateDirect__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    v7 = MEMORY[0x1AF45BE48](*(_QWORD *)(v4 + 72));
    v8 = (void *)v7;
    if (v7)
...
LABEL_8:
  ...
  v12 = a3;
  v11[4] = self;
  objc_msgSend(v8, "xpcPrivateDiscoveryActivate:completion:", self, v11);
...
LABEL_7:
  ...
  v4 = MEMORY[0x1AF45BE48](*(_QWORD *)(*(_QWORD *)(a1 + 32) + 72));
  v5 = (void *)v4;
  if (v4)
...
void __35__RPPrivateDiscovery__activateXPC___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  LogPrintF();
LABEL_21:
  v5 = MEMORY[0x1AF45BE48](*(_QWORD *)(*(_QWORD *)(a1 + 32) + 72));
  v6 = (void *)v5;
  if (v5)
...
- (void)_interrupted
{
  ...
  if (var0 <= 30 && (var0 != -1 || _LogCategory_Initialize()))
    LogPrintF();
  -[RPPrivateDiscovery _activateXPC:](self, "_activateXPC:", 1);
}
...
{
  objc_msgSend((id)gRPPrivateDaemon, "removeDiscovery:completion:");
}
...
- (void)_update
{
  ...
  if (!self->_invalidateCalled)
  {
    ...
    if (changesPending)
    {
      ...
      v9[3] = &unk_1E5F4ECD0;
      v9[4] = v2;
      objc_msgSend(v7, "xpcPrivateDiscoveryUpdate:completion:", v2, v9);
