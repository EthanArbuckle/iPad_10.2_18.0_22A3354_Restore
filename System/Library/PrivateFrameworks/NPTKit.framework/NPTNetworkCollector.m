...
- (void)startCollectingWithCompletion:(id)a3
{
  ...
  -[NPTNetworkCollector setClient:](self, "setClient:", v6);

  v7 = objc_alloc_init(MEMORY[0x24BDBCEB8]);
  v8 = objc_alloc_init(MEMORY[0x24BDBCED8]);
  -[NPTNetworkCollector setCachedMetadata:](self, "setCachedMetadata:", v8);

  v9 = objc_alloc_init(MEMORY[0x24BDBCED8]);
  -[NPTNetworkCollector cachedMetadata](self, "cachedMetadata");
  ...
  -[NPTNetworkCollector client](self, "client");
  ...
  -[NPTNetworkCollector setEventsToMonitor:](self, "setEventsToMonitor:", &unk_24C9A7D38);
  -[NPTNetworkCollector client](self, "client");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPTNetworkCollector eventsToMonitor](self, "eventsToMonitor");
...
void __53__NPTNetworkCollector_startCollectingWithCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  -[NPTMetadataEvent setEventType:](v5, "setEventType:", 26);
...
- (void)stopCollecting
{
  ...
  -[NPTNetworkCollector setClient:](self, "setClient:", 0);
}
