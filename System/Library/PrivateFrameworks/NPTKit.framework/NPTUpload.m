...
- (NPTUpload)initWithNetworkActivityParent:(id)a3 testConfiguration:(id)a4
{
  ...
  v9 = -[NPTUpload init](&v25, sel_init);
  if (v9)
  {
    v10 = objc_alloc_init(NPTMetricResult);
    -[NPTUpload setResults:](v9, "setResults:", v10);
    ...
    v9->timedUploadLength = objc_msgSend(v8, "testDuration");
    v9->smartUpload = objc_msgSend(v8, "endWhenStable");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[NPTUpload results](self, "results");
  v5 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("uploadResult"));
...
- (NPTUpload)initWithCoder:(id)a3
{
  ...
  v3 = a3;
  v4 = -[NPTUpload init](&v7, sel_init);
  objc_msgSend(v3, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("uploadResult"), v7.receiver, v7.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  -[NPTUpload setResults:](v4, "setResults:", v5);
  return v4;
}
...
- (void)startNQUploadWithCompletion:(id)a3
{
  ...
  v4 = a3;
  -[NPTUpload setCompletion:](self, "setCompletion:", v4);
  -[NPTPerformanceTestConfiguration NQUploadConfiguration](self->testConfig, "NQUploadConfiguration");
  ...
  -[NPTUpload checkInterfaceSpecified](self, "checkInterfaceSpecified");
  ...
  if (v9)
  {
    -[NPTUpload delegate](self, "delegate");
    ...
    if (v11)
    {
      ...
      objc_msgSend(v12, "upload:didFinishWithError:", self, v9);

    }
    -[NPTUpload completion](self, "completion");
  ...
  else
  {
    ...
    if (self->nqTest)
    {
      ...
      if (v21)
      {
        ...
        objc_msgSend(v22, "uploadWillStart");
...
void __41__NPTUpload_startNQUploadWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v11 = (id *)(WeakRetained + 136);
  if (*((_QWORD *)WeakRetained + 17))
    v12 = (void *)*((_QWORD *)WeakRetained + 17);
  else
    v12 = v6;
  ...
  *((_QWORD *)WeakRetained + 12) = v13;
  ...
  if (v17)
  {
    if (v6)
    {
      ...
      objc_msgSend(v19, "upload:didFinishWithError:", WeakRetained, v6);
    }
    else
    {
      objc_msgSend(WeakRetained, "delegate");
      ...
      objc_msgSend(v19, "upload:didFinishWithResults:", WeakRetained, v20);
...
{
  if (self->legacy)
    -[NPTUpload startLegacyUploadWithCompletion:](self, "startLegacyUploadWithCompletion:", a3);
  else
    -[NPTUpload startNQUploadWithCompletion:](self, "startNQUploadWithCompletion:", a3);
}
...
- (void)startLegacyUploadWithCompletion:(id)a3
{
  ...
  -[NPTUpload setCompletion:](self, "setCompletion:", a3);
  nw_activity_activate();
  -[NPTUpload checkInterfaceSpecified](self, "checkInterfaceSpecified");
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      -[NPTUpload delegate](self, "delegate");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v7, "upload:didFinishWithError:", self, v4);
  ...
  else
  {
    ...
    -[NPTPerformanceTestConfiguration uploadURL](self->testConfig, "uploadURL");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[NSMutableURLRequest setHTTPMethod:](self->request, "setHTTPMethod:", CFSTR("POST"));
    timedUploadLength = self->timedUploadLength;
    v20 = (double)timedUploadLength * 0.9;
    ...
    if (v22)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412290;
        v51 = (unint64_t)v24;
        _os_log_impl(&dword_20E71B000, v23, OS_LOG_TYPE_DEFAULT, "Force the upload over the following interface: %@", buf, 0xCu);
    ...
    v31 = -[NPTPerformanceTestConfiguration uploadSize](self->testConfig, "uploadSize");
    if (-[NPTUpload inTimedMode](self, "inTimedMode"))
    {
      if (-[NPTPerformanceTestConfiguration uploadSize](self->testConfig, "uploadSize") == 1001)
        v31 = 50;
      else
        v31 = v31;
    }
    ...
    v34 = +[NPTFileSizeConverter getFileSizeInBytes:](NPTFileSizeConverter, "getFileSizeInBytes:", v31);
    self->uploadFileSize = v34;
    v35 = (int)v34;
    -[NPTUpload results](self, "results");
    v36 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v36, "setFileSize:", v35);

    v37 = self->request;
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("multipart/form-data; boundary=%@"), v33);
    v38 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSMutableURLRequest setValue:forHTTPHeaderField:](v37, "setValue:forHTTPHeaderField:", v38, CFSTR("Content-Type"));
    ...
    if (self->uploadSession)
    {
      ...
      if (v39)
      {
        ...
        objc_msgSend(v40, "uploadWillStart");
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 134217984;
        ...
        _os_log_impl(&dword_20E71B000, v41, OS_LOG_TYPE_DEFAULT, "Will start upload task to test upload speed with %lu number of streams", buf, 0xCu);
      }
      ...
      if (self->maxConcurrentStreams)
      {
        ...
        do
        {
          ...
          v47 = -[NPTUpload setupNewUploadTask:suspensionThresholdEnum:](v44, "setupNewUploadTask:suspensionThresholdEnum:", uploadFileSize, v46);
          ++v43;
        }
        while (v43 < self->maxConcurrentStreams);
      }
      if (self->timedUploadLength)
        -[NPTUpload setupTimer](self, "setupTimer");
      if (!self->initialTime)
      {
        v48 = (NSDate *)objc_alloc_init(MEMORY[0x24BDBCE60]);
        initialTime = self->initialTime;
        self->initialTime = v48;

      }
      -[NPTUpload startTasks](self, "startTasks");
    }
...
- (void)cancel
{
  ...
  -[NPTUpload cancelDispatchTimerAndSession](self, "cancelDispatchTimerAndSession");
...
- (id)createRandomDataOfSize:(unint64_t)a3
{
  ...
  if (SecRandomCopyBytes(v5, a3, (void *)objc_msgSend(v6, "mutableBytes")))
  {
    ...
    {
      *(_WORD *)v11 = 0;
      _os_log_impl(&dword_20E71B000, v7, OS_LOG_TYPE_DEFAULT, "Failed to generate random bytes to upload ", v11, 2u);
    }
...
- (id)createTempFileWithData:(id)a3 named:(id)a4
{
  ...
  objc_msgSend(v10, "URLByAppendingPathComponent:isDirectory:", v7, 0);
  v11 = (void *)objc_claimAutoreleasedReturnValue();

  v17 = 0;
  v12 = objc_msgSend(v8, "writeToURL:options:error:", v11, 1, &v17);

  v13 = v17;
  if (v13)
  {
    -[NSURLSession invalidateAndCancel](self->uploadSession, "invalidateAndCancel");
    +[NPTLogger fileSystem](NPTLogger, "fileSystem");
    v14 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      -[NPTUpload createTempFileWithData:named:].cold.1(v13);
...
- (void)removeTempFileNamed:(id)a3
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = 0;
  objc_msgSend(v9, "removeItemAtURL:error:", v8, &v14);
  v10 = v14;
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      -[NPTUpload removeTempFileNamed:].cold.1(v10);
    ...
    if (v12)
    {
      -[NPTUpload delegate](self, "delegate");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v13, "upload:didFinishWithError:", self, v10);
...
uint64_t __23__NPTUpload_setupTimer__block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)(v7 + 72) = 0;
  ...
  {
    *(_WORD *)v11 = 0;
    _os_log_impl(&dword_20E71B000, v9, OS_LOG_TYPE_DEFAULT, "Timed Upload timer ended", v11, 2u);
  }
...
- (void)kickOffNewUpload:(int64_t)a3 suspensionThresholdEnum:(int)a4
{
  ...
  -[NPTUpload setupNewUploadTask:suspensionThresholdEnum:](self, "setupNewUploadTask:suspensionThresholdEnum:", a3, *(_QWORD *)&a4);
...
- (id)setupNewUploadTask:(unint64_t)a3 suspensionThresholdEnum:(int)a4
{
  ...
  -[NPTMetricResult setFileSize:](v8, "setFileSize:", a3);
  -[NSURLSession uploadTaskWithStreamedRequest:](self->uploadSession, "uploadTaskWithStreamedRequest:", self->request);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = *MEMORY[0x24BDB7840];
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", v4);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v15[0] = v10;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v15, &v14, 1);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "_setSocketProperties:connectionProperties:", 0, v11);

  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%lu"), objc_msgSend(v9, "taskIdentifier"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPTTaskMetrics setTask:](v7, "setTask:", v9);
  -[NPTTaskMetrics setResults:](v7, "setResults:", v8);
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->taskDict, "setObject:forKeyedSubscript:", v7, v12);
...
- (void)URLSession:(id)a3 task:(id)a4 needNewBodyStream:(id)a5
{
  ...
  void *v11;
  uint64_t v12;
  NPTUploadDataStream *v13;
  void (**v14)(id, NPTUploadDataStream *);

  v14 = (void (**)(id, NPTUploadDataStream *))a5;
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%lu"), objc_msgSend(a4, "taskIdentifier"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[NSMutableDictionary objectForKeyedSubscript:](self->taskDict, "objectForKeyedSubscript:", v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9)
  {
    ...
    v13 = -[NPTUploadDataStream initWithLength:]([NPTUploadDataStream alloc], "initWithLength:", v12);
    v14[2](v14, v13);
...
- (void)cancelDispatchTimerAndSession
{
  ...
  -[NPTUpload cancelDispatchTimer](self, "cancelDispatchTimer");
  -[NSURLSession invalidateAndCancel](self->uploadSession, "invalidateAndCancel");
}
...
- (double)checkAndReturnSpeedStablized:(id)a3
{
  ...
  if (v5 < v7)
  {
    ...
    if ((unint64_t)-[NSMutableArray count](self->buffer, "count") >= 6)
      -[NSMutableArray removeObjectAtIndex:](self->buffer, "removeObjectAtIndex:", 0);
    if (-[NSMutableArray count](self->buffer, "count") == 5)
    {
      ...
      -[NSMutableArray objectAtIndexedSubscript:](self->buffer, "objectAtIndexedSubscript:", 4);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)createHTTPBodyWithBoundary:(id)a3 usingData:(id)a4 withMimeType:(id)a5 withFileName:(id)a6
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Content-Disposition: form-data; name=\"%@\"; filename=\"upload\"\r\n"),
    v10);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Content-Type: %@\r\n\r\n"), v11);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v14, "appendData:", v23);
...
- (void)URLSession:(id)a3 task:(id)a4 didFinishCollectingMetrics:(id)a5
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%lu"), objc_msgSend(v22, "taskIdentifier"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v10)
  {
    ...
    -[NPTMetricResult setFileSize:](v11, "setFileSize:", objc_msgSend(v22, "countOfBytesSent"));
    if (!self->timedUploadLength)
    {
      -[NPTUpload results](self, "results");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[NPTMetricResult setFileSize:](v11, "setFileSize:", objc_msgSend(v13, "fileSize"));

    }
    v14 = (double)-[NPTMetricResult fileSize](v11, "fileSize") * 8.0;
    -[NPTMetricResult requestTime](v11, "requestTime");
    -[NPTMetricResult setSpeed:](v11, "setSpeed:", v14 / v15 / 1000000.0);
    v16 = self->taskDict;
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%lu"), objc_msgSend(v22, "taskIdentifier"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSMutableDictionary objectForKeyedSubscript:](v16, "objectForKeyedSubscript:", v17);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "setTaskMetrics:", v7);
    ...
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v21, "setResults:", v11);
...
- (void)URLSession:(id)a3 task:(id)a4 didSendBodyData:(int64_t)a5 totalBytesSent:(int64_t)a6 totalBytesExpectedToSend:(int64_t)a7
{
  ...
  -[NPTUpload realTimeSpeedMetricOverall](self, "realTimeSpeedMetricOverall", a3, a4, a5, a6, a7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPTUpload delegate](self, "delegate");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9)
  {
    -[NPTUpload delegate](self, "delegate");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "upload:didReceiveSpeedMetric:", self, v8);
  ...
  {
    -[NPTUpload checkAndReturnSpeedStablized:](self, "checkAndReturnSpeedStablized:", v8);
    if (v13 > 0.0)
    {
      v14 = v13;
      ...
      {
        v16 = objc_msgSend(v8, "bytesTransferred");
        objc_msgSend(v8, "timeSinceStart");
        v18 = 134218496;
        v19 = v14;
        v20 = 2048;
        v21 = v16;
        v22 = 2048;
        v23 = v17;
        _os_log_impl(&dword_20E71B000, v15, OS_LOG_TYPE_DEFAULT, "Upload task has stabilized at %f Mbps after uploading %lld bytes over %f seconds", (uint8_t *)&v18, 0x20u);
      }
...
- (int)determineSuspensionThreshold
{
  ...
  -[NPTUpload realTimeSpeedMetricOverall](self, "realTimeSpeedMetricOverall");
...
- (void)URLSession:(id)a3 task:(id)a4 didCompleteWithError:(id)a5
{
  ...
  if (v11 && !-[NPTUpload isTimerCancelledError:](self, "isTimerCancelledError:", v11))
    goto LABEL_6;
  ...
  if (v12)
  {
    ...
    {
      v15 = v14;
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Upload task: %@ failed to Upload payload due to: %ld"), v9, v14);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x24BDBCED8], "dictionary");
      v17 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_6:
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          -[NPTUpload URLSession:task:didCompleteWithError:].cold.2((uint64_t)v9, v11, v19);
        ...
        if (!uploadError)
        {
          ...
          if (!self->timedUploadLength)
          {
            uploadSession = self->uploadSession;
            if (uploadSession)
              -[NSURLSession invalidateAndCancel](uploadSession, "invalidateAndCancel");
          }
        }
        goto LABEL_24;
      }
LABEL_23:
      ...
      ++self->processedStreamEndCount;
LABEL_24:
      if (-[NPTUpload isLastTask](self, "isLastTask"))
      {
        v25 = self->uploadError;
        if (v25)
        {
          if (-[NSError code](v25, "code") == -999)
            v26 = 4;
          else
            v26 = 3;
        }
        else
        {
          if (!self->endTimeAggregate && self->timedUploadLength)
            -[NPTUpload cancelDispatchTimer](self, "cancelDispatchTimer");
          -[NSURLSession finishTasksAndInvalidate](self->uploadSession, "finishTasksAndInvalidate");
          v26 = 2;
        }
        -[NPTUpload completeActivityWithReason:](self, "completeActivityWithReason:", v26);
        -[NPTUpload aggregateResults](self, "aggregateResults");
        v27 = objc_claimAutoreleasedReturnValue();
        -[NPTUpload setResults:](self, "setResults:", v27);
        ...
        if ((v27 & 1) == 0)
        {
          ...
          if (v29)
          {
            -[NPTUpload results](self, "results");
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v31, "upload:didFinishWithResults:", self, v32);

          }
          else
          {
            objc_msgSend(v30, "upload:didFinishWithError:", self, self->uploadError);
          }
        ...
        if (!v34)
        {
          ...
          ((void (**)(_QWORD, void *, NSError *))v35)[2](v35, v37, self->uploadError);
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    v39 = v9;
    v40 = 2048;
    v41 = objc_msgSend(v9, "countOfBytesSent");
    _os_log_impl(&dword_20E71B000, v22, OS_LOG_TYPE_DEFAULT, "Upload task: %@ Upload: %lld bytes", buf, 0x16u);
  }

  if (self->endTimeAggregate || !-[NPTUpload inTimedMode](self, "inTimedMode"))
  {

    goto LABEL_23;
  }
  v23 = -[NPTUpload determineSuspensionThreshold](self, "determineSuspensionThreshold");
  +[NPTLogger network](NPTLogger, "network");
  v24 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    -[NPTUpload URLSession:task:didCompleteWithError:].cold.1((uint64_t)v9, v23, v24);

  -[NPTUpload kickOffNewUpload:suspensionThresholdEnum:](self, "kickOffNewUpload:suspensionThresholdEnum:", self->uploadFileSize, v23);
  v11 = 0;
LABEL_40:
...
- (void)URLSession:(id)a3 didBecomeInvalidWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      -[NPTUpload URLSession:didBecomeInvalidWithError:].cold.1((uint64_t)v7, v8);

    -[NSURLSession finishTasksAndInvalidate](self->uploadSession, "finishTasksAndInvalidate");
    -[NPTUpload completeActivityWithReason:](self, "completeActivityWithReason:", 3);
    -[NPTUpload delegate](self, "delegate");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v9)
    {
      -[NPTUpload delegate](self, "delegate");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "upload:didFinishWithError:", self, v7);
    ...
    if (v11)
    {
      ...
      ((void (**)(_QWORD, _QWORD, id))v12)[2](v12, 0, v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[NPTUpload init](+[NPTUpload allocWithZone:](NPTUpload, "allocWithZone:", a3), "init");
  -[NPTUpload results](self, "results");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPTUpload setResults:](v4, "setResults:", v5);
...
- (void)progress:(id)a3
{
  ...
  v7 = v6;
  objc_msgSend(v4, "uplinkCapacity");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    v29 = 134217984;
    v30 = v11;
    _os_log_impl(&dword_20E71B000, v12, OS_LOG_TYPE_DEFAULT, "Upload progress speed: %f mbps", (uint8_t *)&v29, 0xCu);
  }

  v13 = [NPTSpeedMetric alloc];
  objc_msgSend(v4, "uplinkBytesTransferred");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = (int)objc_msgSend(v14, "intValue");
  v16 = -[NetworkQualityConfiguration maxUplinkData](self->nqConfig, "maxUplinkData");
  objc_msgSend(v4, "uplinkResponsiveness");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v20)
  {
    -[NPTUpload delegate](self, "delegate");
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v21, "upload:didReceiveSpeedMetric:", self, v19);
  ...
  if (self->stableSpeedToLog == 0.0)
  {
    -[NPTUpload checkAndReturnSpeedStablized:](self, "checkAndReturnSpeedStablized:", v19);
    if (v24 > 0.0)
    {
      v25 = v24;
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v33 = 2048;
        v34 = v28;
        _os_log_impl(&dword_20E71B000, v26, OS_LOG_TYPE_DEFAULT, "Upload task has stabilized at %f Mbps after uploading %lld bytes over %f seconds", (uint8_t *)&v29, 0x20u);
      }
...
{
  return objc_msgSend(a3, "code") == -999 && self->uploadSession != 0;
}
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        v7 += objc_msgSend(v11, "countOfBytesSent");

        objc_msgSend(v10, "task");
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        v6 += objc_msgSend(v12, "countOfBytesExpectedToSend");
...
- (void)completeActivityWithReason:(int)a3
{
  ...
  if (self->uploadActivity && nw_activity_is_activated())
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_impl(&dword_20E71B000, v4, OS_LOG_TYPE_DEFAULT, "Completing uploadActivity", v6, 2u);
    }
...
- (id)aggregateResults
{
  ...
  if (-[NSMutableDictionary count](self->taskDict, "count"))
  {
    ...
    if (endTimeAggregate)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_20E71B000, v18, OS_LOG_TYPE_DEFAULT, "Upload using synthesized end time", buf, 2u);
      }
    ...
    objc_msgSend(v22, "setError:", v116->uploadError);
    v120 = 0u;
    v121 = 0u;
    v118 = 0u;
    v119 = 0u;
    ...
    if (v113)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(v31, "requestStartDate");
          v32 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          v36 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v36, "requestEndDate");
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138413314;
            ...
            v130 = 2048;
            v131 = v53;
            _os_log_impl(&dword_20E71B000, v41, OS_LOG_TYPE_DEFAULT, "Upload Task: %@ DomainLookupTime: %f, connectionTime: %f, requestTime: %f, responseTime: %f", buf, 0x34u);
          ...
          -[NPTUpload minNonZeroValue:comparisonValue:](v116, "minNonZeroValue:comparisonValue:", v56, v58);
          ...
          -[NPTUpload minNonZeroValue:comparisonValue:](v116, "minNonZeroValue:comparisonValue:", v60, v62);
          ...
          -[NPTUpload minNonZeroValue:comparisonValue:](v116, "minNonZeroValue:comparisonValue:", v64, v66);
          objc_msgSend(v111, "setSecureConnectionTime:");

          objc_msgSend(v111, "responseTime");
          v68 = v67;
          objc_msgSend(v27, "results");
          v69 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v69, "responseTime");
          -[NPTUpload minNonZeroValue:comparisonValue:](v116, "minNonZeroValue:comparisonValue:", v68, v70);
          ...
          -[NPTUpload minNonZeroValue:comparisonValue:](v116, "minNonZeroValue:comparisonValue:", v72, v74);
    ...
    if (!v24)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_20E71B000, v99, OS_LOG_TYPE_DEFAULT, "Upload using synthesized start time", buf, 2u);
      }
    ...
    if (os_log_type_enabled(v103, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134217984;
      v123 = v104;
      _os_log_impl(&dword_20E71B000, v103, OS_LOG_TYPE_DEFAULT, "Upload performance test has finished at %f Mbps", buf, 0xCu);
    }
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v6)
          objc_enumerationMutation(v3);
        -[NSMutableDictionary objectForKey:](self->taskDict, "objectForKey:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v7), (_QWORD)v11);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "setTask:", 0);
...
- (id)processNQResult:(id)a3
{
  ...
  objc_msgSend(v50, "uplinkBytesTransferred");
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v23, "setFileSize:", objc_msgSend(v24, "unsignedIntValue"));

  objc_msgSend(v50, "uplinkCapacity");
  ...
  objc_msgSend(v50, "uplinkResponsiveness");
  v34 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)createTempFileWithData:(void *)a1 named:.cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_0_0(&dword_20E71B000, v2, v3, "Failed to create temporary file with error: %{public}@", v4, v5, v6, v7, 2u);
...
- (void)removeTempFileNamed:(void *)a1 .cold.1(void *a1)
{
  ...
  objc_msgSend(a1, "localizedDescription");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_0_0(&dword_20E71B000, v2, v3, "Failed to delete temporary file with error: %{public}@", v4, v5, v6, v7, 2u);
...
- (void)URLSession:(uint64_t)a1 task:(int)a2 didCompleteWithError:(os_log_t)log .cold.1(uint64_t a1, int a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_error_impl(&dword_20E71B000, log, OS_LOG_TYPE_ERROR, "Set threshold to %u on rollover for task: %@", (uint8_t *)v3, 0x12u);
}
...
- (void)URLSession:(uint64_t)a1 task:(void *)a2 didCompleteWithError:(NSObject *)a3 .cold.2(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  v8 = 2114;
  v9 = v5;
  _os_log_error_impl(&dword_20E71B000, a3, OS_LOG_TYPE_ERROR, "Upload task: %@ Errored with: %{public}@", (uint8_t *)&v6, 0x16u);
...
- (void)URLSession:(uint64_t)a1 didBecomeInvalidWithError:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138543362;
  v3 = a1;
  _os_log_error_impl(&dword_20E71B000, a2, OS_LOG_TYPE_ERROR, "Upload task became invalidated with error: %{public}@", (uint8_t *)&v2, 0xCu);
}
