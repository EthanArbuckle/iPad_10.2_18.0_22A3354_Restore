...
{
  id v5;
  WFSiriOpenAppRequest *v6;
  WFSiriOpenAppRequest *v7;
  WFSiriOpenAppRequest *v8;
  objc_super v10;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[WFSiriOpenAppRequest bundleIdentifier](self, "bundleIdentifier", v6.receiver, v6.super_class);
