...
- (id)serializedRepresentation
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&off_1EEE75370;
  objc_msgSendSuper2(&v6, sel_serializedRepresentation);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = (void *)objc_msgSend(v2, "mutableCopy");

  objc_msgSend(a1, "userActivityType");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setValue:forKey:", v4, CFSTR("UserActivityType"));
...
- (uint64_t)initWithSerializedRepresentation:()Shortcuts
{
  ...
  objc_msgSend(v4, "objectForKey:", CFSTR("UserActivityType"));
  ...
  v20 = objc_msgSend(a1, "initWithUserActivityType:localizedName:bundleIdentifier:extensionBundleIdentifier:counterpartIdentifiers:teamIdentifier:supportedIntents:bundleURL:", v19, v7, v10, v13, 0, v16, 0, 0);
  return v20;
}
...
- (uint64_t)isEqualForSmartPromptPurposes:()Shortcuts
{
  ...
  else
  {
    ...
    {
      v16.receiver = a1;
      v16.super_class = (Class)&off_1EEE75370;
      ...
      if (v5)
      {
        ...
        objc_msgSend(v9, "userActivityType");
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        v12 = v10;
        v13 = v11;
        v14 = v13;
