...
- (id)mediaItem
{
  ...
  -[WFPlayPodcastEpisodeContextualAction intent](self, "intent");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "mediaItems");
  ...
  else
  {
    ...
    objc_msgSend(v8, "mediaContainer");
...
- (id)uniqueIdentifier
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPlayPodcastEpisodeContextualAction mediaItem](self, "mediaItem");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)displayString
{
  ...
  else
  {
    ...
    {
      WFLocalizedString(CFSTR("Podcast"));
...
- (WFPlayPodcastEpisodeContextualAction)initWithIntent:(id)a3 artwork:(id)a4 namedQueryInfo:(id)a5
{
  ...
  void *v17;
  void *v18;
  WFPlayPodcastEpisodeContextualAction *v19;
  void *v21;
  void *v22;
  objc_super v23;
...
LABEL_3:
  ...
  else
  {
    ...
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("WFPlayPodcastEpisodeContextualAction.m"), 45, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("intent"));
...
LABEL_6:
  ...
  WFLocalizedString(CFSTR("Play Podcast"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[WFPlayPodcastEpisodeContextualAction intent](self, "intent", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  id v4;
  WFPlayPodcastEpisodeContextualAction *v5;
  uint64_t v6;
  INPlayMediaIntent *intent;
  WFPlayPodcastEpisodeContextualAction *v8;
  objc_super v10;
...
{
  WFPlayPodcastEpisodeContextualAction *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;
  WFContextualActionIcon *v8;
  WFPlayPodcastEpisodeContextualAction *v9;
  _QWORD v11[2];
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  WFLocalizedStringWithKey(CFSTR("Play Suggested Podcast (Display Format String)"), CFSTR("Play %@"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  WFLocalizedStringWithKey(CFSTR("Play Suggested Podcast (Title)"), CFSTR("Play Suggested Podcast"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = -[WFContextualActionIcon initWithSystemName:]([WFContextualActionIcon alloc], "initWithSystemName:", CFSTR("music.mic"));
  v9 = -[WFTopHitItemContextualAction initWithItem:identifier:wfActionIdentifier:associatedAppBundleIdentifier:parameters:displayFormatString:title:subtitleFormatString:primaryColor:icon:accessoryIcon:namedQueryInfo:](v3, "initWithItem:identifier:wfActionIdentifier:associatedAppBundleIdentifier:parameters:displayFormatString:title:subtitleFormatString:primaryColor:icon:accessoryIcon:namedQueryInfo:", 0, CFSTR("is.workflow.actions.playpodcast"), CFSTR("is.workflow.actions.playpodcast"), CFSTR("com.apple.podcasts"), v5, v6, v7, 0, 10, v8, 0, 0);
...
{
  return -[WFContextualActionParameter initWithType:displayString:wfParameterKey:askEachTime:]([WFContextualActionParameter alloc], "initWithType:displayString:wfParameterKey:askEachTime:", CFSTR("WFPodcastEpisodeContentItem"), &stru_1E5FC92C0, CFSTR("WFPodcastShow"), 1);
}
...
+ (void)disambiguationEntriesForCollection:(id)a3 limit:(int64_t)a4 completionHandler:(id)a5
{
        ...
        (v12 & 1) != 0))
  {
    ...
    v14[3] = &unk_1E5FC8248;
    v15 = v8;
    objc_msgSend(v9, "getUpcomingMediaForBundleIdentifier:limit:completion:", CFSTR("com.apple.podcasts"), a4, v14);
...
+ (id)disambiguationSummaryStringForCollection:(id)a3
{
  ...
  {
    WFLocalizedStringWithKey(CFSTR("Play Suggested Podcasts (Disambiguation Action Title)"), CFSTR("Play Suggestions"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
+ (id)disambiguationSummaryStringWithParameterDefined:(BOOL)a3
{
  ...
  if (a3)
  {
    v3 = CFSTR("Populated Play Specific Podcast (Title)");
    v4 = CFSTR("Play ${WFPodcastShow}");
  }
  else
  {
    v3 = CFSTR("Unpopulated Play Specific Podcast (Title)");
    v4 = CFSTR("Play Podcast…");
  }
...
void __99__WFPlayPodcastEpisodeContextualAction_disambiguationEntriesForCollection_limit_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (a2)
  {
    objc_msgSend(a2, "if_map:", &__block_literal_global_5280);
...
WFPlayPodcastEpisodeContextualAction *__99__WFPlayPodcastEpisodeContextualAction_disambiguationEntriesForCollection_limit_completionHandler___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  WFPlayPodcastEpisodeContextualAction *v6;
  void *v7;
  void *v8;
  WFPlayPodcastEpisodeContextualAction *v9;
  ...
  WFLocalizedString(CFSTR("Up Next"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[WFAppShortcutNamedQueryInfo initWithName:symbolName:](v3, "initWithName:symbolName:", v4, CFSTR("apple.podcasts"));
  ...
  v9 = -[WFPlayPodcastEpisodeContextualAction initWithIntent:artwork:namedQueryInfo:](v6, "initWithIntent:artwork:namedQueryInfo:", v7, v8, v5);
  return v9;
}
