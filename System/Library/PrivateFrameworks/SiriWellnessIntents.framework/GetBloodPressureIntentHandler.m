...
{
  GetBloodPressureIntent *v4;
  _TtC19SiriWellnessIntents29GetBloodPressureIntentHandler *v5;
  _QWORD *v6;
  void *v9;
...
- (void).cxx_destruct
{
  ...
  v3 = OBJC_IVAR____TtC19SiriWellnessIntents29GetBloodPressureIntentHandler_signposter;
