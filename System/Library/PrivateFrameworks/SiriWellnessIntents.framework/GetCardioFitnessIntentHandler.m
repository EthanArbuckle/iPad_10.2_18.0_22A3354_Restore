...
{
  GetCardioFitnessIntent *v4;
  _TtC19SiriWellnessIntents29GetCardioFitnessIntentHandler *v5;
  _QWORD *v6;
  void *v9;
...
- (void).cxx_destruct
{
  __swift_destroy_boxed_opaque_existential_1((uint64_t)self + OBJC_IVAR____TtC19SiriWellnessIntents29GetCardioFitnessIntentHandler_store);
}
