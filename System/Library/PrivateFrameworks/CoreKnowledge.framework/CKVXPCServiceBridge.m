...
- (CKVXPCServiceBridge)initWithServiceProtocol:(id)a3 machServiceName:(id)a4
{
  id v7;
  id v8;
  CKVXPCServiceBridge *v9;
  CKVXPCServiceBridge *v10;
  uint64_t v11;
  ...
  v9 = -[CKVXPCServiceBridge init](&v21, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)_getOrCreateXPCServiceConnection
{
  ...
  if (!serviceConnection)
  {
    ...
    v4 = (id)CKLogContextVocabulary;
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      NSStringFromProtocol(self->_serviceProtocol);
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 136315394;
      v20 = "-[CKVXPCServiceBridge _getOrCreateXPCServiceConnection]";
      v21 = 2112;
      v22 = v5;
      _os_log_impl(&dword_1A48B3000, v4, OS_LOG_TYPE_INFO, "%s Connecting to XPC service with interface: %@", buf, 0x16u);
    ...
    v15[1] = 3221225472;
    v15[2] = __55__CKVXPCServiceBridge__getOrCreateXPCServiceConnection__block_invoke;
    v15[3] = &unk_1E4D291F8;
    ...
    v12[0] = v9;
    v12[1] = 3221225472;
    v12[2] = __55__CKVXPCServiceBridge__getOrCreateXPCServiceConnection__block_invoke_5;
    v12[3] = &unk_1E4D291F8;
...
- (void)dealloc
{
  ...
  -[CKVXPCServiceBridge _clearXPCServiceConnection](self, "_clearXPCServiceConnection");
  v3.receiver = self;
  v3.super_class = (Class)CKVXPCServiceBridge;
  -[CKVXPCServiceBridge dealloc](&v3, sel_dealloc);
}
...
void __55__CKVXPCServiceBridge__getOrCreateXPCServiceConnection__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)CKLogContextVocabulary, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 2112;
    v10 = WeakRetained;
    _os_log_impl(&dword_1A48B3000, v4, OS_LOG_TYPE_INFO, "%s service connection %@ by %@ was interrupted", (uint8_t *)&v5, 0x20u);
  }
...
void __55__CKVXPCServiceBridge__getOrCreateXPCServiceConnection__block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)CKLogContextVocabulary, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 2112;
    v10 = WeakRetained;
    _os_log_impl(&dword_1A48B3000, v4, OS_LOG_TYPE_INFO, "%s service connection %@ by %@ was invalidated", (uint8_t *)&v5, 0x20u);
  }
