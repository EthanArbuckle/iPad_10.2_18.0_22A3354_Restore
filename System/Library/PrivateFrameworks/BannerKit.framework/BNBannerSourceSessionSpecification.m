...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.bannerkit.banner-source-service");
}
...
void __47__BNBannerSourceSessionSpecification_interface__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EF2436C8);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setServer:", v4);

  objc_msgSend(MEMORY[0x1E0D017E0], "protocolForProtocol:", &unk_1EF22FC60);
