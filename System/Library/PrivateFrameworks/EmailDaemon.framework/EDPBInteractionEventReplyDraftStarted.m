...
- (id)description
{
  ...
  -[EDPBInteractionEventReplyDraftStarted description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventReplyDraftStarted dictionaryRepresentation](self, "dictionaryRepresentation");
