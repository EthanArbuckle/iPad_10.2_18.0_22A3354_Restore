...
uint64_t __EFGetElapsedTimeSinceAbsoluteTime_block_invoke_1()
{
  return mach_timebase_info((mach_timebase_info_t)&EFGetElapsedTimeSinceAbsoluteTime_sTimebaseInfo_1);
}
