...
+ (int)runWithConnection:(id)a3
{
  ...
  v3 = a3;
  v4 = sqlite3_exec((sqlite3 *)objc_msgSend(v3, "sqlDB"), "ALTER TABLE mailboxes ADD COLUMN frecency BLOB;",
         0,
         0,
         0);
  if (!v4)
    v4 = sqlite3_exec((sqlite3 *)objc_msgSend(v3, "sqlDB"), "ALTER TABLE mailboxes ADD COLUMN server_metadata BLOB;",
           0,
           0,
           0);
