...
- (void)withHasher:(id)a3 setMessage:(id)a4 mailbox:(id)a5
{
  ...
  -[EDPBInteractionEventMessageMoved setAccountId:](self, "setAccountId:", objc_msgSend(v19, "hashedAccountID:", v10));
  ...
  -[EDPBInteractionEventMessageMoved setMessageId:](self, "setMessageId:", objc_msgSend(v19, "hashedString:", v12));

  objc_msgSend(v8, "mailbox");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventMessageMoved setFromMailboxId:](self, "setFromMailboxId:", objc_msgSend(v19, "hashedMailboxID:", v13));
  ...
  -[EDPBInteractionEventMessageMoved setFromMailboxType:](self, "setFromMailboxType:", v16);

  -[EDPBInteractionEventMessageMoved setToMailboxId:](self, "setToMailboxId:", objc_msgSend(v19, "hashedMailboxID:", v9));
  v17 = objc_msgSend(v9, "type") - 1;
  if (v17 > 6)
    v18 = 1;
  else
    v18 = dword_1D317A638[v17];
  -[EDPBInteractionEventMessageMoved setToMailboxType:](self, "setToMailboxType:", v18);
...
- (id)description
{
  ...
  -[EDPBInteractionEventMessageMoved description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventMessageMoved dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x20) != 0)
  {
    ...
    {
      v10 = off_1E949F560[fromMailboxType];
    }
  ...
  if ((has & 0x40) != 0)
  {
    ...
    {
      v13 = off_1E949F560[toMailboxType];
    }
