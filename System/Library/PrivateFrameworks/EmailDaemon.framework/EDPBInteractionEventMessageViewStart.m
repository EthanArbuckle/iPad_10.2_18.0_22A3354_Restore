...
- (id)description
{
  ...
  -[EDPBInteractionEventMessageViewStart description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventMessageViewStart dictionaryRepresentation](self, "dictionaryRepresentation");
