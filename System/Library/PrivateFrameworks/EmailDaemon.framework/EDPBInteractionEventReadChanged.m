...
- (void)withHasher:(id)a3 setMessage:(id)a4 data:(id)a5
{
  ...
  -[EDPBInteractionEventReadChanged setValue:](self, "setValue:", objc_msgSend(v10, "BOOLValue"));
...
- (id)description
{
  ...
  -[EDPBInteractionEventReadChanged description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventReadChanged dictionaryRepresentation](self, "dictionaryRepresentation");
