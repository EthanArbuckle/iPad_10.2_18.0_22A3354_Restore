...
+ (int)runWithConnection:(id)a3
{
  ...
  v3 = a3;
  v4 = sqlite3_exec((sqlite3 *)objc_msgSend(v3, "sqlDB"), "UPDATE message_global_data SET category_model_version = null, user_category = null, model_category = null, model_subcategory = null, model_analytics = null, model_high_impact = 0;",
         0,
         0,
         0);
