...
{
  -[EDPBMessageData withHasher:setDataFromMessage:account:](self, "withHasher:setDataFromMessage:account:", a3, a4, 0);
}
...
- (void)withHasher:(id)a3 setDataFromMessage:(id)a4 account:(id)a5
{
  ...
  if (v9)
    -[EDPBMessageData setAccountId:](self, "setAccountId:", objc_msgSend(v11, "hashedAccountID:", v9));
  objc_msgSend(v11, "hashedMessageHeadersForMessage:", v8);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBMessageData setHeaders:](self, "setHeaders:", v10);
...
- (id)description
{
  ...
  -[EDPBMessageData description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBMessageData dictionaryRepresentation](self, "dictionaryRepresentation");
