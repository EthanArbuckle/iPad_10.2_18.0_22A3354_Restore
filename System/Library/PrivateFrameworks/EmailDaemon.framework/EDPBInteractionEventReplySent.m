...
- (id)description
{
  ...
  -[EDPBInteractionEventReplySent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventReplySent dictionaryRepresentation](self, "dictionaryRepresentation");
