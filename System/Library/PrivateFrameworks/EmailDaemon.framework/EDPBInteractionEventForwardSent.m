...
- (id)description
{
  ...
  -[EDPBInteractionEventForwardSent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventForwardSent dictionaryRepresentation](self, "dictionaryRepresentation");
