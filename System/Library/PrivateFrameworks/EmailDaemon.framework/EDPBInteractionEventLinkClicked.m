...
- (id)description
{
  ...
  -[EDPBInteractionEventLinkClicked description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[EDPBInteractionEventLinkClicked dictionaryRepresentation](self, "dictionaryRepresentation");
