...
+ (id)counterInCollection:(void *)a3 withEventName:
{
  ...
  v5 = a2;
  v6 = objc_opt_self();
  +[_DKEventStatsCollection counterWithClass:collectionName:eventName:eventType:eventTypePossibleValues:hasResult:scalar:]((uint64_t)_DKEventStatsCollection, v6, v5, v4, 0, 0, 0, 1);
...
- (void)incrementCountByNumber:(uint64_t)a1
{
  ...
  if (a1)
  {
    -[_DKEventStatsCounterInternal incrementCountByNumber:typeValue:success:](*(_QWORD *)(a1 + 8), a2, 0, 0);
