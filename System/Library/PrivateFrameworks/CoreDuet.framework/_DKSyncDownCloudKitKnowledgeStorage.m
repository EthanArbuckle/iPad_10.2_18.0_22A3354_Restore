...
+ (id)sharedInstance
{
  if (sharedInstance_initialized_352 != -1)
    dispatch_once(&sharedInstance_initialized_352, &__block_literal_global_354);
  return (id)sharedInstance_sharedInstance_353;
}
...
- (_DKSyncDownCloudKitKnowledgeStorage)init
{
  ...
  return -[_DKSyncDownCloudKitKnowledgeStorage init](&v3, sel_init);
}
