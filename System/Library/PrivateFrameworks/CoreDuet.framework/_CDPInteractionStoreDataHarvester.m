...
- (void)loadWithLimit:(unint64_t)a3 dataPointReader:(id)a4 completion:(id)a5
{
  ...
  v17[1] = 3221225472;
  v17[2] = __78___CDPInteractionStoreDataHarvester_loadWithLimit_dataPointReader_completion___block_invoke;
  v17[3] = &unk_1E26E6680;
  v17[4] = self;
  v18 = v8;
  v19 = v9;
...
{
  return (id)-[NSMutableDictionary objectForKeyedSubscript:](self->_identifierToContactMap, "objectForKeyedSubscript:", a3);
}
