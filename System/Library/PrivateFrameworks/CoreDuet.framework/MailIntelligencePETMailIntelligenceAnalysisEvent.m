...
- (id)description
{
  ...
  -[MailIntelligencePETMailIntelligenceAnalysisEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[MailIntelligencePETMailIntelligenceAnalysisEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (contactEvents)
  {
    -[MailIntelligencePETContactEvents dictionaryRepresentation](contactEvents, "dictionaryRepresentation");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v9, CFSTR("contactEvents"));

  }
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_mailIntelligenceUserId);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("mailIntelligenceUserId"));
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_collectionId)
    -[MailIntelligencePETMailIntelligenceAnalysisEvent writeTo:].cold.1();
  PBDataWriterWriteStringField();
  if (!self->_sessionId)
    -[MailIntelligencePETMailIntelligenceAnalysisEvent writeTo:].cold.2();
  PBDataWriterWriteStringField();
  PBDataWriterWriteInt32Field();
  if (!self->_contactEvents)
    -[MailIntelligencePETMailIntelligenceAnalysisEvent writeTo:].cold.3();
...
- (void)copyTo:(id)a3
{
  ...
  *((_QWORD *)v5 + 1) = self->_mailIntelligenceUserId;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_DWORD *)(v5 + 16) = self->_batch;
  v10 = -[MailIntelligencePETContactEvents copyWithZone:](self->_contactEvents, "copyWithZone:", a3);
  v11 = *(void **)(v5 + 32);
  *(_QWORD *)(v5 + 32) = v10;

  *(_QWORD *)(v5 + 8) = self->_mailIntelligenceUserId;
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((collectionId = self->_collectionId, !((unint64_t)collectionId | *((_QWORD *)v4 + 3)))
     || -[NSString isEqual:](collectionId, "isEqual:"))
    && ((sessionId = self->_sessionId, !((unint64_t)sessionId | *((_QWORD *)v4 + 5)))
     || -[NSString isEqual:](sessionId, "isEqual:"))
    && self->_batch == *((_DWORD *)v4 + 4)
    && ((contactEvents = self->_contactEvents, !((unint64_t)contactEvents | *((_QWORD *)v4 + 4)))
     || -[MailIntelligencePETContactEvents isEqual:](contactEvents, "isEqual:"))
    && self->_mailIntelligenceUserId == *((_QWORD *)v4 + 1);
...
- (unint64_t)hash
{
  ...
  return v4 ^ -[MailIntelligencePETContactEvents hash](self->_contactEvents, "hash") ^ v5 ^ (2654435761u
...
- (void)mergeFrom:(id)a3
{
  ...
  if (contactEvents)
  {
    if (v6)
    {
      -[MailIntelligencePETContactEvents mergeFrom:](contactEvents, "mergeFrom:");
LABEL_10:
      v4 = v7;
    }
  }
  ...
  {
    -[MailIntelligencePETMailIntelligenceAnalysisEvent setContactEvents:](self, "setContactEvents:");
    goto LABEL_10;
  }
  self->_mailIntelligenceUserId = *((_QWORD *)v4 + 1);
