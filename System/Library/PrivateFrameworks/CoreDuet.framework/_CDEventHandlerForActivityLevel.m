...
{
  _CDEventHandlerForActivityLevel *v2;
  void *v3;
  id *v4;
  ...
  v2 = -[_CDEventHandlerForActivityLevel init](&v10, sel_init);
  if (v2)
  {
...
- (void)eventHandler:(id)a3 withFileHandle:(id)a4
{
  ...
  -[_CDEventHandlerForActivityLevel anonymizer](self, "anonymizer");
  v9 = (_QWORD *)objc_claimAutoreleasedReturnValue();
  -[_CDDataCollectionAnonymizer anonymizeDictionary:](v9, v14);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  -[_CDEventHandlerForActivityLevel utility](self, "utility");
