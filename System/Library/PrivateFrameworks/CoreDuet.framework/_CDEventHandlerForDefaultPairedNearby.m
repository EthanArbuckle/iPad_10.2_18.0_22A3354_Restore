...
{
  _CDEventHandlerForDefaultPairedNearby *v2;
  void *v3;
  id *v4;
  ...
  v2 = -[_CDEventHandlerForDefaultPairedNearby init](&v10, sel_init);
  if (v2)
  {
...
- (void)eventHandler:(id)a3 withFileHandle:(id)a4
{
  ...
  -[_CDEventHandlerForDefaultPairedNearby anonymizer](self, "anonymizer");
  v9 = (_QWORD *)objc_claimAutoreleasedReturnValue();
  -[_CDDataCollectionAnonymizer anonymizeDictionary:](v9, v14);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  -[_CDEventHandlerForDefaultPairedNearby utility](self, "utility");
