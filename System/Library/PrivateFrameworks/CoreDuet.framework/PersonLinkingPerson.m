...
- (id)description
{
  ...
  -[PersonLinkingPerson description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PersonLinkingPerson dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  emails = self->_emails;
  if (emails)
    objc_msgSend(v4, "setObject:forKey:", emails, CFSTR("emails"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[PersonLinkingPerson emailsCount](self, "emailsCount"))
  {
    objc_msgSend(v8, "clearEmails");
    v4 = -[PersonLinkingPerson emailsCount](self, "emailsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[PersonLinkingPerson emailsAtIndex:](self, "emailsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addEmails:", v7);
...
- (BOOL)isEqual:(id)a3
{
    ...
    && ((name = self->_name, !((unint64_t)name | v4[2])) || -[NSString isEqual:](name, "isEqual:")))
  {
    ...
    if ((unint64_t)emails | v4[1])
      v7 = -[NSMutableArray isEqual:](emails, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_emails, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[PersonLinkingPerson addEmails:](self, "addEmails:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
