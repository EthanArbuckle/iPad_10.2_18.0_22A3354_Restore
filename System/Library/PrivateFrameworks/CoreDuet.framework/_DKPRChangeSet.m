...
- (void)addDeleteEventID:(uint64_t)a1
{
  id v3;
  void *v4;
  id v5;
...
- (id)description
{
  ...
  -[_DKPRChangeSet description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_DKPRChangeSet dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (deleteEventIDs)
    objc_msgSend(v3, "setObject:forKey:", deleteEventIDs, CFSTR("deleteEventID"));
  return v3;
}
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](events, "isEqual:")))
  {
    ...
    if ((unint64_t)deleteEventIDs | v4[1])
      v7 = -[NSMutableArray isEqual:](deleteEventIDs, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_deleteEventIDs, "hash") ^ v3;
}
