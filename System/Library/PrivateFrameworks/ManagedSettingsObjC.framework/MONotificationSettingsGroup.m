...
{
  return (NSNumber *)-[MOSettingsGroup valueForSetting:](self, "valueForSetting:", CFSTR("lockDriverDoNotDisturb"));
}

- (void)setLockDriverDoNotDisturb:(id)a3
{
  -[MOSettingsGroup setValue:forSetting:](self, "setValue:forSetting:", a3, CFSTR("lockDriverDoNotDisturb"));
}
...
+ (MOBoolSettingMetadata)lockDriverDoNotDisturbMetadata
{
  ...
  return (MOBoolSettingMetadata *)(id)lockDriverDoNotDisturbMetadata_metadata;
}
...
void __61__MONotificationSettingsGroup_lockDriverDoNotDisturbMetadata__block_invoke()
{
  ...
  objc_msgSend(v0, "stringWithFormat:", CFSTR("%@.%@"), v1, CFSTR("lockDriverDoNotDisturb"));
