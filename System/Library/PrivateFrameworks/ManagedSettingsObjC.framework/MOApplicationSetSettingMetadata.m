...
- (NSSet)defaultValue
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)MOApplicationSetSettingMetadata;
    ...
    if (v7)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          +[MOApplication initializeWithPersistableValue:](MOApplication, "initializeWithPersistableValue:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * v10), (_QWORD)v14);
    ...
    if (v7)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            objc_msgSend(v11, "persistableValue", (_QWORD)v15);
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          if (+[MOApplication isValidPersistableRepresentation:](MOApplication, "isValidPersistableRepresentation:", v10, (_QWORD)v13))
          {
