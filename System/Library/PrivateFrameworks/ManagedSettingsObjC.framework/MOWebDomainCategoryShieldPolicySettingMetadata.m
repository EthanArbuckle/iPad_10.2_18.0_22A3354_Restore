...
{
  return +[MOWebDomainCategoryShieldPolicy initializeWithPersistableValue:](MOWebDomainCategoryShieldPolicy, "initializeWithPersistableValue:", a3);
}
...
- (MOWebDomainCategoryShieldPolicy)defaultValue
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)MOWebDomainCategoryShieldPolicySettingMetadata;
  -[MOSettingMetadata defaultValue](&v3, sel_defaultValue);
  return (MOWebDomainCategoryShieldPolicy *)(id)objc_claimAutoreleasedReturnValue();
}
...
{
  MOWebDomainCategoryShieldPolicySettingMetadata *result;
  objc_super v12;
...
- (id)sanitizePersistableValue:(id)a3
{
  ...
  v4 = a3;
  if (+[MOWebDomainCategoryShieldPolicy isValidPersistableRepresentation:](MOWebDomainCategoryShieldPolicy, "isValidPersistableRepresentation:", v4))
  {
    +[MOWebDomainCategoryShieldPolicy initializeWithPersistableValue:](MOWebDomainCategoryShieldPolicy, "initializeWithPersistableValue:", v4);
    ...
    if (objc_msgSend(v6, "count") <= self->_maximumCategoryCount)
    {
      ...
      if (v9 <= maximumActivityCount)
      {
        ...
        if (v14)
        {
          ...
          +[MOCategoryShieldPolicy allPolicyWithExcludedContent:](MOWebDomainCategoryShieldPolicy, "allPolicyWithExcludedContent:", v15);
...
- (id)combinePersistableValue:(id)a3 with:(id)a4
{
  ...
  v6 = a4;
  -[MOWebDomainCategoryShieldPolicySettingMetadata sanitizePersistableValue:](self, "sanitizePersistableValue:", a3);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[MOWebDomainCategoryShieldPolicySettingMetadata sanitizePersistableValue:](self, "sanitizePersistableValue:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  +[MOWebDomainCategoryShieldPolicy initializeWithPersistableValue:](MOWebDomainCategoryShieldPolicy, "initializeWithPersistableValue:", v7);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  +[MOWebDomainCategoryShieldPolicy initializeWithPersistableValue:](MOWebDomainCategoryShieldPolicy, "initializeWithPersistableValue:", v8);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[MOWebDomainCategoryShieldPolicySettingMetadata _combine:with:](self, "_combine:with:", v9, v10);
...
- (id)_combine:(id)a3 with:(id)a4
{
  ...
  id v6;
  uint64_t v7;
  MOWebDomainCategoryShieldPolicy *v8;
  uint64_t v9;
  MOWebDomainCategoryShieldPolicy *v10;
  void *v11;
  void *v12;
  void *v13;
  void *v14;
  void *v15;
  void *v16;
  MOWebDomainCategoryShieldPolicy *v17;
  void *v18;
  void *v19;
  void *v20;
  void *v21;
  ...
  void *v25;
  void *v26;
  MOWebDomainCategoryShieldPolicy *v27;
  void *v28;
  void *v29;
