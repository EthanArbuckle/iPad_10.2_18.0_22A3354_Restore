...
{
  return (NSNumber *)-[MOSettingsGroup valueForSetting:](self, "valueForSetting:", CFSTR("denyAirDrop"));
}

- (void)setDenyAirDrop:(id)a3
{
  -[MOSettingsGroup setValue:forSetting:](self, "setValue:forSetting:", a3, CFSTR("denyAirDrop"));
}
...
+ (MOBoolSettingMetadata)denyAirDropMetadata
{
  ...
  return (MOBoolSettingMetadata *)(id)denyAirDropMetadata_metadata;
}
...
void __45__MOAirDropSettingsGroup_denyAirDropMetadata__block_invoke()
{
  ...
  objc_msgSend(v0, "stringWithFormat:", CFSTR("%@.%@"), v1, CFSTR("denyAirDrop"));
