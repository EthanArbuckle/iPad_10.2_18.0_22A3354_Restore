...
+ (id)initializeWithPersistableValue:(id)a3
{
  ...
  void *v13;
  uint64_t v14;
  MOWebDomainCategoryShieldPolicy *v15;
  void *v16;
  void *v17;
  id v18;
  uint64_t v19;
        ...
        if (v9)
        {
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              +[MOCategory initializeWithPersistableValue:](MOCategory, "initializeWithPersistableValue:", *(_QWORD *)(*((_QWORD *)&v31 + 1) + 8 * i));
...
LABEL_15:
        ...
        if (v16)
        {
          v17 = (void *)objc_msgSend(objc_alloc(*(Class *)(v6 + 3560)), "initWithCapacity:", objc_msgSend(v16, "count"));
          if (v17)
          {
            v25 = v5;
            v26 = v4;
            ...
            if (v19)
            {
              ...
              do
              {
                for (j = 0; j != v20; ++j)
                {
                  ...
                  +[MOWebDomain initializeWithPersistableValue:](MOWebDomain, "initializeWithPersistableValue:", *(_QWORD *)(*((_QWORD *)&v27 + 1) + 8 * j));
        ...
        v14 = 0;
LABEL_27:
        v15 = -[MOCategoryShieldPolicy initWithPolicy:specificCategories:excludedContent:]([MOWebDomainCategoryShieldPolicy alloc], "initWithPolicy:specificCategories:excludedContent:", v14, v7, v17);
      ...
      if (v12)
      {
        ...
        while (2)
        {
          for (i = 0; i != v13; ++i)
          {
            ...
            if (!+[MOWebDomain isValidPersistableRepresentation:](MOWebDomain, "isValidPersistableRepresentation:", *(_QWORD *)(*((_QWORD *)&v18 + 1) + 8 * i), (_QWORD)v18))
            {
              v16 = 0;
              goto LABEL_29;
            }
