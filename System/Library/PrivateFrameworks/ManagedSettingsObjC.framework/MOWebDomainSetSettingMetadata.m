...
- (NSSet)defaultValue
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)MOWebDomainSetSettingMetadata;
    ...
    if (v7)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          +[MOWebDomain initializeWithPersistableValue:](MOWebDomain, "initializeWithPersistableValue:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * v10), (_QWORD)v14);
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          if (+[MOWebDomain isValidPersistableRepresentation:](MOWebDomain, "isValidPersistableRepresentation:", v10, (_QWORD)v13))
          {
