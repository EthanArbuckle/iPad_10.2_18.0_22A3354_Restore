...
id LogCategory_ViewControllerLifecyle()
{
  if (LogCategory_ViewControllerLifecyle_onceToken != -1)
    dispatch_once(&LogCategory_ViewControllerLifecyle_onceToken, &__block_literal_global_3);
  return (id)LogCategory_ViewControllerLifecyle_log;
}

id LogCategory_FMSlidingPaneViewController()
{
  if (LogCategory_FMSlidingPaneViewController_onceToken != -1)
    dispatch_once(&LogCategory_FMSlidingPaneViewController_onceToken, &__block_literal_global_5);
  return (id)LogCategory_FMSlidingPaneViewController_log;
}
...
void sub_20DBE485C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,id location)
{
  id *v24;
...
void sub_20DBE4FA0(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_20DBE6BD0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,uint64_t a27,id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}

void sub_20DBE7274(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}
...
MKMapRect MKMapRectInset(MKMapRect rect, double dx, double dy)
{
  ...
  MEMORY[0x24BDDAFC0]((__n128)rect.origin, *(__n128 *)&rect.origin.y, (__n128)rect.size, *(__n128 *)&rect.size.height, dx, dy);
  result.size.height = v6;
  result.size.width = v5;
  result.origin.y = v4;
  result.origin.x = v3;
