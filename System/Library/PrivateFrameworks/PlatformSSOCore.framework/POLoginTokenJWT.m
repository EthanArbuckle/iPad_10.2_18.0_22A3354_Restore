...
- (POLoginTokenJWT)initWithString:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (v6)
    {
      v7 = -[POLoginJWTBody initWithJWTData:]([POLoginJWTBody alloc], "initWithJWTData:", v6);
      -[POLoginTokenJWT setDecodedBody:](v3, "setDecodedBody:", v7);
...
- (id)description
{
  ...
  -[POLoginTokenJWT decodedBody](self, "decodedBody");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)updateDecodedBody
{
  ...
  if (v3)
  {
    ...
    if (!v6)
    {
      ...
      if (v12)
      {
        v11 = -[POLoginJWTBody initWithJWTData:]([POLoginJWTBody alloc], "initWithJWTData:", v12);
        -[POLoginTokenJWT setDecodedBody:](self, "setDecodedBody:", v11);
...
- (id)mutableCopy
{
  POMutableLoginTokenJWT *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;

  v3 = objc_alloc_init(POMutableLoginTokenJWT);
  -[POLoginTokenJWT decodedBody](self, "decodedBody");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (void *)objc_msgSend(v4, "mutableCopy");
  -[POMutableLoginTokenJWT setBody:](v3, "setBody:", v5);
