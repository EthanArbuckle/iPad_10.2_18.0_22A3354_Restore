...
- (POKeyResponseJWT)initWithString:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (v6)
    {
      v7 = -[_POJWTBodyBase initWithJWTData:]([POKeyResponseJWTBody alloc], "initWithJWTData:", v6);
      -[POKeyResponseJWT setDecodedBody:](v3, "setDecodedBody:", v7);
...
- (id)description
{
  ...
  -[POKeyResponseJWT decodedBody](self, "decodedBody");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)updateDecodedBody
{
  ...
  if (v3)
  {
    ...
    if (!v6)
    {
      ...
      if (v12)
      {
        v11 = -[_POJWTBodyBase initWithJWTData:]([POKeyResponseJWTBody alloc], "initWithJWTData:", v12);
        -[POKeyResponseJWT setDecodedBody:](self, "setDecodedBody:", v11);
...
- (id)mutableCopy
{
  ...
  -[POMutableKeyResponseJWT setBody:](v3, "setBody:", v5);
