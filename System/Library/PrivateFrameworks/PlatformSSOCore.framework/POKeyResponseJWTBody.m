...
- (id)mutableCopy
{
  POMutableKeyResponseJWTBody *v3;
  void *v4;
  void *v5;
...
- (NSDate)iat
{
  ...
  v11[1] = 3221225472;
  v11[2] = __27__POKeyResponseJWTBody_iat__block_invoke;
  v11[3] = &unk_2514FFB08;
  v11[4] = self;
  __27__POKeyResponseJWTBody_iat__block_invoke((uint64_t)v11);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v10[0] = v3;
  v10[1] = 3221225472;
  v10[2] = __27__POKeyResponseJWTBody_iat__block_invoke_2;
  v10[3] = &unk_2514FFB30;
  v10[4] = self;
  __27__POKeyResponseJWTBody_iat__block_invoke_2((uint64_t)v10);
...
- (NSDate)exp
{
  ...
  v11[0] = MEMORY[0x24BDAC760];
  v11[1] = 3221225472;
  v11[2] = __27__POKeyResponseJWTBody_exp__block_invoke;
  v11[3] = &unk_2514FFB08;
  v11[4] = self;
  __27__POKeyResponseJWTBody_exp__block_invoke((uint64_t)v11);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v10[0] = v3;
  v10[1] = 3221225472;
  v10[2] = __27__POKeyResponseJWTBody_exp__block_invoke_2;
  v10[3] = &unk_2514FFB30;
  v10[4] = self;
  __27__POKeyResponseJWTBody_exp__block_invoke_2((uint64_t)v10);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)MEMORY[0x24BDBCE60];
  v7 = objc_msgSend(v4, "intValue");
  if (!v7)
...
- (NSString)certificate
{
  ...
  v3[1] = 3221225472;
  v3[2] = __35__POKeyResponseJWTBody_certificate__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __35__POKeyResponseJWTBody_certificate__block_invoke((uint64_t)v3);
...
id __35__POKeyResponseJWTBody_certificate__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "data");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKeyedSubscript:", CFSTR("certificate"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  isKindOfClass = objc_opt_isKindOfClass();
  ...
  if ((isKindOfClass & 1) != 0)
  {
    objc_msgSend(*(id *)(a1 + 32), "data");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("certificate"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSString)key_context
{
  ...
  v3[0] = MEMORY[0x24BDAC760];
  v3[1] = 3221225472;
  v3[2] = __35__POKeyResponseJWTBody_key_context__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __35__POKeyResponseJWTBody_key_context__block_invoke((uint64_t)v3);
  return (NSString *)(id)objc_claimAutoreleasedReturnValue();
}
