...
- (POIDTokenJWT)initWithString:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (v6)
    {
      v7 = -[_POJWTBodyBase initWithJWTData:]([POIDTokenJWTBody alloc], "initWithJWTData:", v6);
      -[POIDTokenJWT setDecodedBody:](v3, "setDecodedBody:", v7);
...
- (id)description
{
  ...
  -[POIDTokenJWT decodedBody](self, "decodedBody");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)updateDecodedBody
{
  ...
  if (v3)
  {
    ...
    if (!v6)
    {
      ...
      if (v12)
      {
        v11 = -[_POJWTBodyBase initWithJWTData:]([POIDTokenJWTBody alloc], "initWithJWTData:", v12);
        -[POIDTokenJWT setDecodedBody:](self, "setDecodedBody:", v11);
...
- (id)mutableCopy
{
  ...
  -[POMutableIDTokenJWT setBody:](v3, "setBody:", v5);
