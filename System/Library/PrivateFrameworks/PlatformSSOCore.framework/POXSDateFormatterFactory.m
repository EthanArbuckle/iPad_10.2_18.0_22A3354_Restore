...
+ (id)newDateTimeFormatterWithTimeZoneStyle:(int64_t)a3
{
  ...
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF38]), "initWithName:", CFSTR("UTC"));
...
+ (id)newDateTimeFormatters
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEA0]), "initWithLocaleIdentifier:", CFSTR("en_US_POSIX"));
  objc_msgSend(v2, "setLocale:", v3);
  objc_msgSend(v2, "setDateFormat:", CFSTR("y'-'M'-'d'T'HH':'mm':'ssXXX"));
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF38]), "initWithName:", CFSTR("UTC"));
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF38]), "initWithName:", CFSTR("UTC"));
  ...
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF38]), "initWithName:", CFSTR("UTC"));
  ...
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEA0]), "initWithLocaleIdentifier:", CFSTR("en_US_POSIX"));
  objc_msgSend(v14, "setLocale:", v15);
  objc_msgSend(v14, "setDateFormat:", CFSTR("y'-'M'-'d'T'HH':'mm':'ss'.'S"));
  v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF38]), "initWithName:", CFSTR("UTC"));
