...
+ (id)definition
{
  ...
  objc_msgSend(v2, "addNamespaceWithURI:", CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"));
  objc_msgSend(v2, "addElementWithName:namespaceURI:type:", CFSTR("Lifetime"), CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"), objc_opt_class());
  ...
  objc_msgSend(v2, "addElementWithName:namespaceURI:type:maxOccurs:minOccurs:", CFSTR("RequestedSecurityToken"), CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"), objc_opt_class(), 1, 1);
  objc_msgSend(v2, "addElementWithName:namespaceURI:type:", CFSTR("RequestedAttachedReference"), CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"), objc_opt_class());
  objc_msgSend(v2, "addElementWithName:namespaceURI:type:", CFSTR("RequestedUnattachedReference"), CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"), objc_opt_class());
  objc_msgSend(v2, "addElementWithName:namespaceURI:type:", CFSTR("TokenType"), CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"), objc_opt_class());
  objc_msgSend(v2, "addElementWithName:namespaceURI:type:", CFSTR("RequestType"), CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"), objc_opt_class());
  objc_msgSend(v2, "addElementWithName:namespaceURI:type:", CFSTR("KeyType"), CFSTR("http://schemas.xmlsoap.org/ws/2005/02/trust"), objc_opt_class());
  return v2;
}
