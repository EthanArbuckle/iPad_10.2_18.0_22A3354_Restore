...
- (_TtC15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256)init
{
  ...
  *(Class *)((char *)&self->super.super.isa
           + OBJC_IVAR____TtC15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256_encryptionAlgorithm) = (Class)&unk_251520F78;
  v6 = &unk_251520F78;
  sub_24449C26C();
...
{
  id v6;
  _TtC15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256 *v7;

  v6 = a3;
  v7 = self;
  _s15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256C9addValues2to3psk4authySo18POMutableJWTHeaderC_S2btF_0(v6);
...
- (id)encValueForPsk:(BOOL)a3 auth:(BOOL)a4
{
  ...
  _s15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256C8encValue6forPsk4authSSSb_SbtF_0();
...
- (BOOL)decodeAndDecryptJWT:(id)a3 privateKey:(__SecKey *)a4 otherInfo:(id)a5 psk:(id)a6 psk_id:(id)a7 authPublicKey:(__SecKey *)a8 error:(id *)a9
{
  ...
  id v20;
  __SecKey *v21;
  _TtC15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256 *v22;
  unint64_t v23;
  unint64_t v24;
  uint64_t v25;
  unint64_t v26;
  ...
  id v28;
  __SecKey *v29;
  _TtC15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256 *v30;
  uint64_t v32;
...
- (id)encodeAndEncryptJWT:(id)a3 publicKey:(__SecKey *)a4 otherInfo:(id)a5 psk:(id)a6 psk_id:(id)a7 authPrivateKey:(__SecKey *)a8 auth_kid:(id)a9 error:(id *)a10
{
  ...
  __SecKey *v31;
  id v32;
  _TtC15PlatformSSOCore39POCryptoKitHPKE_P384_SHA384_AES_GCM_256 *v33;
  void *v34;
  uint64_t v36;
  uint64_t v37;
  __SecKey *v38;
