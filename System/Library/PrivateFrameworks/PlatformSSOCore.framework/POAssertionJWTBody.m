...
{
  POAssertionJWTBody *v3;
  POAssertionJWTBody *v4;
  void *v5;
  void *v6;
  id v7;
  void *v8;
...
- (void)dealloc
{
  ...
  -[POAssertionJWTBody zeroPassword](self, "zeroPassword");
  v3.receiver = self;
  v3.super_class = (Class)POAssertionJWTBody;
  -[POAssertionJWTBody dealloc](&v3, sel_dealloc);
}
...
- (id)mutableCopy
{
  ...
  -[POAssertionJWTBody setPasswordData:](v3, "setPasswordData:", v6);
...
- (NSString)aud
{
  ...
  v3[1] = 3221225472;
  v3[2] = __25__POAssertionJWTBody_aud__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __25__POAssertionJWTBody_aud__block_invoke((uint64_t)v3);
...
- (NSString)iss
{
  ...
  v3[0] = MEMORY[0x24BDAC760];
  v3[1] = 3221225472;
  v3[2] = __25__POAssertionJWTBody_iss__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __25__POAssertionJWTBody_iss__block_invoke((uint64_t)v3);
  return (NSString *)(id)objc_claimAutoreleasedReturnValue();
}
...
- (NSString)sub
{
  ...
  v3[0] = MEMORY[0x24BDAC760];
  v3[1] = 3221225472;
  v3[2] = __25__POAssertionJWTBody_sub__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __25__POAssertionJWTBody_sub__block_invoke((uint64_t)v3);
  return (NSString *)(id)objc_claimAutoreleasedReturnValue();
}
...
- (NSDate)iat
{
  ...
  v11[1] = 3221225472;
  v11[2] = __25__POAssertionJWTBody_iat__block_invoke;
  v11[3] = &unk_2514FFB08;
  v11[4] = self;
  __25__POAssertionJWTBody_iat__block_invoke((uint64_t)v11);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v10[0] = v3;
  v10[1] = 3221225472;
  v10[2] = __25__POAssertionJWTBody_iat__block_invoke_2;
  v10[3] = &unk_2514FFB30;
  v10[4] = self;
  __25__POAssertionJWTBody_iat__block_invoke_2((uint64_t)v10);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDate)exp
{
  ...
  v11[0] = MEMORY[0x24BDAC760];
  v11[1] = 3221225472;
  v11[2] = __25__POAssertionJWTBody_exp__block_invoke;
  v11[3] = &unk_2514FFB08;
  v11[4] = self;
  __25__POAssertionJWTBody_exp__block_invoke((uint64_t)v11);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v10[0] = v3;
  v10[1] = 3221225472;
  v10[2] = __25__POAssertionJWTBody_exp__block_invoke_2;
  v10[3] = &unk_2514FFB30;
  v10[4] = self;
  __25__POAssertionJWTBody_exp__block_invoke_2((uint64_t)v10);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)MEMORY[0x24BDBCE60];
  v7 = objc_msgSend(v4, "intValue");
  if (!v7)
...
- (NSString)scope
{
  ...
  v3[0] = MEMORY[0x24BDAC760];
  v3[1] = 3221225472;
  v3[2] = __27__POAssertionJWTBody_scope__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __27__POAssertionJWTBody_scope__block_invoke((uint64_t)v3);
  return (NSString *)(id)objc_claimAutoreleasedReturnValue();
}
...
- (NSString)nonce
{
  ...
  v3[0] = MEMORY[0x24BDAC760];
  v3[1] = 3221225472;
  v3[2] = __27__POAssertionJWTBody_nonce__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __27__POAssertionJWTBody_nonce__block_invoke((uint64_t)v3);
  return (NSString *)(id)objc_claimAutoreleasedReturnValue();
}
...
- (NSString)request_nonce
{
  ...
  v3[0] = MEMORY[0x24BDAC760];
  v3[1] = 3221225472;
  v3[2] = __35__POAssertionJWTBody_request_nonce__block_invoke;
  v3[3] = &unk_2514FFB30;
  v3[4] = self;
  __35__POAssertionJWTBody_request_nonce__block_invoke((uint64_t)v3);
  return (NSString *)(id)objc_claimAutoreleasedReturnValue();
}
