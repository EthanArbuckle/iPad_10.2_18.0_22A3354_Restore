...
- (id)valueFromString:(id)a3
{
  ...
  v13 = 0u;
  v14 = 0u;
  v4 = (id)valueFromString__dateTimeFormatters;
...
void __42__POXSDateTimeDefinition_valueFromString___block_invoke()
{
  id v0;
  void *v1;

  v0 = +[POXSDateFormatterFactory newDateTimeFormatters](POXSDateFormatterFactory, "newDateTimeFormatters");
  v1 = (void *)valueFromString__dateTimeFormatters;
  valueFromString__dateTimeFormatters = (uint64_t)v0;
...
- (id)stringFromValue:(id)a3
{
  ...
  if (objc_msgSend(v4, "isEqualToTimeZone:", v5))
  {
    v6 = 2;
LABEL_6:
    v7 = +[POXSDateFormatterFactory newDateTimeFormatterWithTimeZoneStyle:](POXSDateFormatterFactory, "newDateTimeFormatterWithTimeZoneStyle:", v6);
    goto LABEL_7;
  }
  if (!v4)
  {
  ...
  v7 = +[POXSDateFormatterFactory newDateTimeFormatterWithTimeZoneStyle:](POXSDateFormatterFactory, "newDateTimeFormatterWithTimeZoneStyle:", 1);
