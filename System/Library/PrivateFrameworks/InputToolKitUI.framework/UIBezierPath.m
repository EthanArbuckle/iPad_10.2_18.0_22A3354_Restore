...
__n128 __54__UIBezierPath_ITKUtilities__itk_lengthIgnoringCurves__block_invoke(_QWORD *a1, int *a2)
{
  int v3;
  double *v4;
  uint64_t v5;
  ...
  v3 = *a2;
  v4 = (double *)MEMORY[0x24BE51E38];
  *(_OWORD *)(*(_QWORD *)(a1[4] + 8) + 48) = *MEMORY[0x24BE51E38];
  if ((v3 - 2) >= 2)
  {
    if (v3 != 1)
    {
      if (v3)
        goto LABEL_7;
      *(_OWORD *)(*(_QWORD *)(a1[5] + 8) + 48) = *(_OWORD *)v4;
    }
...
LABEL_7:
  ...
  v10 = *(double *)(v8 + 48) == v6;
  v11 = v9 == v7 && v10;
  v12 = *(double *)(v5 + 56) == v7 && *(double *)(v5 + 48) == v6;
  if (!v12 && !v11)
  {
    ITKDistance();
    *(double *)(*(_QWORD *)(a1[6] + 8) + 24) = v13 + *(double *)(*(_QWORD *)(a1[6] + 8) + 24);
  }
  if (v11)
    v14 = (__n128 *)MEMORY[0x24BE51E38];
  else
    v14 = (__n128 *)(*(_QWORD *)(a1[4] + 8) + 48);
  result = *v14;
  *(__n128 *)(*(_QWORD *)(a1[5] + 8) + 48) = *v14;
  return result;
}
...
void __54__UIBezierPath_ITKUtilities__itk_allPointsFromCGPath___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  switch(*(_DWORD *)a2)
  {
    ...
    case 1:
      v3 = *(void **)(a1 + 32);
      objc_msgSend(MEMORY[0x24BDD1968], "itk_valueWithPoint:", **(double **)(a2 + 8), *(double *)(*(_QWORD *)(a2 + 8) + 8));
    ...
    case 3:
      v2 = *(void **)(a1 + 32);
      objc_msgSend(MEMORY[0x24BDD1968], "itk_valueWithPoint:", *(double *)(*(_QWORD *)(a2 + 8) + 32), *(double *)(*(_QWORD *)(a2 + 8) + 40));
      v4 = (id)objc_claimAutoreleasedReturnValue();
...
uint64_t __57__UIBezierPath_ITKUtilities__itk_pathFromFlippingInRect___block_invoke(uint64_t result, _DWORD *a2)
{
  ...
  switch(*a2)
  {
    ...
    case 1:
      goto LABEL_4;
    case 2:
      objc_msgSend(MEMORY[0x24BE51EB8], "handleFailedAssertWithCondition:functionName:simulateCrash:showAlert:format:", "__objc_no", "-[UIBezierPath(ITKUtilities) itk_pathFromFlippingInRect:]_block_invoke", 0, 0, CFSTR("kCGPathElementAddQuadCurveToPoint not supported."));
LABEL_4:
      v4 = *(void **)(v2 + 32);
      ITKFlipPoint();
      result = objc_msgSend(v4, "itk_addLineToPoint:");
      break;
    case 3:
      v5 = *(void **)(result + 32);
      ITKFlipPoint();
      ...
      v9 = v8;
      ITKFlipPoint();
      result = objc_msgSend(v5, "itk_addCurveToPoint:controlPoint1:controlPoint2:", v7, v9, v10, v11, v10, v11);
      break;
    case 4:
...
void __57__UIBezierPath_ITKUtilities__itk_subpathArrayFromCGPath___block_invoke(uint64_t a1, uint64_t a2)
{
  double *v4;
  id v5;
  uint64_t v6;
  ...
  switch(*(_DWORD *)a2)
  {
    ...
    case 1:
      goto LABEL_4;
    case 2:
      objc_msgSend(MEMORY[0x24BE51EB8], "handleFailedAssertWithCondition:functionName:simulateCrash:showAlert:format:", "__objc_no", "+[UIBezierPath(ITKUtilities) itk_subpathArrayFromCGPath:]_block_invoke", 0, 0, CFSTR("kCGPathElementAddQuadCurveToPoint not supported."));
LABEL_4:
      objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 40), "itk_addLineToPoint:", **(double **)(a2 + 8), *(double *)(*(_QWORD *)(a2 + 8) + 8));
      break;
    case 3:
      v4 = *(double **)(a2 + 8);
      objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 40), "itk_addCurveToPoint:controlPoint1:controlPoint2:", v4[4], v4[5], *v4, v4[1], v4[2], v4[3]);
      break;
    case 4:
      objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 40), "closePath");
      objc_msgSend(*(id *)(a1 + 32), "addObject:", *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 40));
      v5 = objc_alloc_init(MEMORY[0x24BEBD420]);
...
uint64_t __67__UIBezierPath_ITKUtilities__itk_groupAndRoundPaths_radius_offset___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  v4 = objc_msgSend(*(id *)(a1 + 32), "itk_cgPathcontainsAnyCurveToPoints:", objc_msgSend(v3, "itk_CGPath"));

  return v4;
}

void __67__UIBezierPath_ITKUtilities__itk_groupAndRoundPaths_radius_offset___block_invoke_18(uint64_t a1, void *a2, uint64_t a3)
{
  id v5;
  uint64_t *v6;
  void **v7;
  ...
  v5 = a2;
  v6 = ITKClipperPathsFromCGPath((const CGPath *)objc_msgSend(v5, "itk_CGPath"), 1.0);
...
void __67__UIBezierPath_ITKUtilities__itk_groupAndRoundPaths_radius_offset___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v10 = a2;
  objc_msgSend(*(id *)(a1 + 40), "itk_allPointsFromCGPath:", objc_msgSend(v10, "itk_CGPath"));
  ...
  v7 = (const CGPath *)objc_msgSend(*(id *)(a1 + 40), "itk_newRoundedPathWithRadius:points:", v3, *(double *)(a1 + 48));
  v8 = *(void **)(a1 + 32);
...
void __67__UIBezierPath_ITKUtilities___processPointsForRounding_withRadius___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v7 = a1 + 32;
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 40), "itk_pointValue");
...
void __125__UIBezierPath_ITKUtilities__itk_roundAndGroupNormalizedQuadsForHighlight_aspectRatio_expansionScale_radiusToAvgHeightRatio___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v9 = ITKClipperPathsFromCGPath((const CGPath *)objc_msgSend(v8, "itk_CGPath"), 1.0);
  ...
  MEMORY[0x242665874](v9, 0x20C40960023A9);
...
void __125__UIBezierPath_ITKUtilities__itk_roundAndGroupNormalizedQuadsForHighlight_aspectRatio_expansionScale_radiusToAvgHeightRatio___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v11 = a2;
  objc_msgSend(*(id *)(a1 + 48), "itk_allPointsFromCGPath:", objc_msgSend(v11, "itk_CGPath"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "lastObject");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "firstObject");
  ...
  v8 = (const CGPath *)objc_msgSend(*(id *)(a1 + 48), "itk_newRoundedPathWithRadius:points:", v3);
  v9 = *(void **)(a1 + 40);
  objc_msgSend(MEMORY[0x24BEBD420], "itk_pathFromCGPath:", v8);
