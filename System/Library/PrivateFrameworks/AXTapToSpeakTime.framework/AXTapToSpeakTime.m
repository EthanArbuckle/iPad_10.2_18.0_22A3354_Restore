...
void sub_22701CA8C(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_22701CDB0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_22701DD6C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, id location)
{
  id *v15;
...
uint64_t ___ntkDefaultsChanged_block_invoke(uint64_t a1)
{
  ...
  {
    *(_WORD *)v4 = 0;
    _os_log_impl(&dword_22701A000, v2, OS_LOG_TYPE_INFO, "NTK defaults changed", v4, 2u);
  }

  return objc_msgSend(*(id *)(a1 + 32), "_scheduleChimeTimer");
}
...
void sub_22701F460(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
const __CFString *AXStringFromTapToSpeakTimeVoice(uint64_t a1)
{
  if ((unint64_t)(a1 - 1) > 3)
    return CFSTR("Default");
  else
    return *(&off_24EF4E988 + a1 - 1);
}

const __CFString *AXStringFromTapToSpeakTimeGesture(uint64_t a1)
{
  if (a1)
    return CFSTR("One Finger Tap");
  else
    return CFSTR("Two Finger Hold");
}
