...
- (id)processRecipe:(id *)a3 errorDomain:(id)a4
{
  ...
  v15 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
LABEL_9:
  objc_storeStrong(&location, 0);
  return v15;
}
...
- (id)processForLoopHelper:(id)a3 withNumber:(id)a4 withDictionary:(id)a5
{
  ...
  if (v25)
  {
    ...
    while (1)
    {
      ...
      v15 = location[0];
      v14 = v30;
      v17 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v7 + v13 * v12);
...
- (id)processForLoop:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v84 && v83 && v82)
  {
    v7 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v84, "count") * objc_msgSend(v83, "longValue")+ objc_msgSend(v82, "longValue"));
    v8 = v88;
    v88 = v7;
...
LABEL_73:
    ...
    if (v80 && v79 && v78)
    {
      v11 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v80, "count") * objc_msgSend(v79, "longValue")+ objc_msgSend(v78, "longValue"));
      v12 = v87;
      v87 = v11;
...
LABEL_15:
      ...
      for (i = (int)objc_msgSend(v88, "intValue"); ; ++i)
      {
        ...
        if (v46 >= (int)objc_msgSend(v87, "intValue"))
          break;
        v75 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", i);
        for (j = 0; ; ++j)
        {
          v45 = j;
                ...
                if (v38)
                {
                  ...
                  while (1)
                  {
                    ...
                    if ((objc_msgSend(v63, "isEqual:", v69) & 1) != 0)
                    {
                      ...
                      v58 = v19 + v32 * v31;
                      v20 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v58);
                      v21 = v64;
                      v64 = v20;
...
LABEL_66:
      ...
      v93 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v81 = 1;
LABEL_69:
  ...
  if (v28 && v27 && v26)
  {
    ...
    if (v24)
    {
      ...
      if ((objc_msgSend(v26, "isEqual:", AggregateSum) & 1) != 0)
      {
        ...
        v14 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v22);
      ...
      else if ((objc_msgSend(v26, "isEqual:", AggregateAverage) & 1) != 0)
      {
        ...
        v12 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v20);
        objc_msgSend(v23, "addObject:");

      }
      -[NSMutableDictionary setObject:forKey:](v32->_coreDictionary, "setObject:forKey:", v23, v27);
      v33 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v25 = 1;
  ...
  if (v29 && v28 && v27)
  {
    ...
    if (v25)
    {
      ...
      if (v15 >= objc_msgSend(v27, "longValue"))
      {
        ...
        v14 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", v21);
        ...
        v34 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v26 = 1;
        objc_storeStrong(&v24, 0);
      }
      else
...
- (id)checkIfArrayEmptyAndThrowError:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v16)
  {
    ...
    if (v14)
    {
      ...
      {
        v21 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      }
      else
      {
        v9 = objc_alloc(MEMORY[0x1E0CB35C8]);
...
- (id)combineArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v22 && v20 && v21)
  {
    ...
    if (v18 && v17)
    {
      ...
      v27 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v19 = 1;
      objc_storeStrong(&v16, 0);
    }
    else
...
- (id)destroyArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v14)
  {
    ...
    if (v12)
    {
      ...
      v19 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
    }
    else
    {
      v7 = objc_alloc(MEMORY[0x1E0CB35C8]);
...
- (id)downSampleData:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  *(_QWORD *)&v99 = (id)objc_msgSend(location[0], "objectForKey:", OtherAffectedVectors);
  if (v99 == 0)
  {
    *((_QWORD *)&v99 + 1) = objc_alloc_init(MEMORY[0x1E0C99D80]);

    *(_QWORD *)&v99 = objc_alloc_init(MEMORY[0x1E0C99D80]);
LABEL_31:
...
LABEL_70:
          ...
          v108 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
          v98 = 1;
LABEL_80:
          objc_storeStrong(&v86, 0);
...
- (id)constantValueMathFunction:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  for (i = 0; ; ++i)
  {
    ...
    if ((objc_msgSend(v46, "isEqual:", Modulo) & 1) != 0)
    {
      ...
      v10 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", v39);
      v11 = v40;
      v40 = v10;
    ...
    else if ((objc_msgSend(v46, "isEqual:", Division) & 1) != 0)
    {
      ...
      v14 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v34 / v13);
      v15 = v40;
      v40 = v14;
    ...
    else if ((objc_msgSend(v46, "isEqual:", Multiplication) & 1) != 0)
    {
      ...
      v33 = v16;
      objc_msgSend(v47, "doubleValue");
      v18 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v33 * v17);
      v19 = v40;
      v40 = v18;
    ...
    else if ((objc_msgSend(v46, "isEqual:", Addition) & 1) != 0)
    {
      ...
      v32 = v20;
      objc_msgSend(v47, "doubleValue");
      v22 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v32 + v21);
      v23 = v40;
      v40 = v22;
    ...
    else
    {
      ...
      v31 = v24;
      objc_msgSend(v47, "doubleValue");
      v26 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v31 - v25);
      v27 = v40;
      v40 = v26;
...
LABEL_26:
  ...
  v54 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
  v45 = 1;
LABEL_29:
...
- (id)filterArrayOnNumber:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  *(_QWORD *)&v112 = (id)objc_msgSend(location[0], "objectForKey:", OtherAffectedVectors);
  if (v112 == 0)
  {
    *((_QWORD *)&v112 + 1) = objc_alloc_init(MEMORY[0x1E0C99D80]);

    *(_QWORD *)&v112 = objc_alloc_init(MEMORY[0x1E0C99D80]);
  }
  else
  {
...
LABEL_84:
  ...
  v121 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
  v111 = 1;
LABEL_93:
  objc_storeStrong(&v100, 0);
  objc_storeStrong(&v104, 0);
...
- (id)getCurrentTime:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  v11 = v14;
  v12 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v15);
  objc_msgSend(v11, "addObject:");

  -[NSMutableDictionary setObject:forKey:](v20->_coreDictionary, "setObject:forKey:", v14, v17);
  v13 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
  objc_storeStrong(&v14, 0);
  objc_storeStrong(&v17, 0);
  objc_storeStrong(v18, 0);
  objc_storeStrong(location, 0);
  ...
  if (v32 && v31 && v30 && v29)
  {
    ...
    if (v26 && v25 && v24)
    {
      ...
      if (v15 == objc_msgSend(v24, "count"))
      {
        ...
        v37 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v27 = 1;
        objc_storeStrong(&v21, 0);
        objc_storeStrong(&v23, 0);
      }
  ...
  if (v25 && v24 && v23)
  {
    ...
    if (v20)
    {
      ...
      if (v19)
      {
        ...
        v30 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v21 = 1;
        objc_storeStrong(&v18, 0);
      }
      else
...
- (id)ifStatement:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v106)
  {
    v106 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 10000);
  ...
  while (1)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v49 = v103;
        v50 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v88 & 1);
        ...
        objc_msgSend(v105, "removeLastObject");
        v53 = v105;
        v54 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v86);
...
LABEL_30:
      ...
      if ((objc_msgSend(v85, "isEqual:", NAKey) & 1) == 0)
      {
        ...
        {
          objc_msgSend(v103, "addObject:", &unk_1EA4CEB90);
        }
        else if ((objc_msgSend(v85, "isEqual:", orKey) & 1) != 0)
        {
          objc_msgSend(v103, "addObject:", &unk_1EA4CEBA8);
        }
        objc_msgSend(v104, "addObject:", v85);
        objc_msgSend(v105, "addObject:", &unk_1EA4CEBA8);
        goto LABEL_67;
      }
      ...
      if ((objc_msgSend(v81, "isEqual:", HasLengthEqualTo) & 1) != 0)
      {
        ...
        if (v48 == (int)objc_msgSend(v80, "intValue"))
          objc_storeStrong(&v79, &unk_1EA4CEB90);
        else
          objc_storeStrong(&v79, &unk_1EA4CEBA8);
LABEL_50:
        if (objc_msgSend(v103, "count"))
        {
          ...
          v34 = v103;
          v35 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v77 & 1);
          ...
          objc_msgSend(v105, "removeLastObject");
          v38 = v105;
          v39 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v37);
...
LABEL_98:
      ...
      v114 = v101;
      v21 = (id)objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", &v114, 1);
      -[NSMutableDictionary setObject:forKey:](coreDictionary, "setObject:forKey:");

      v113 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v102 = 1;
    }
  }
  objc_storeStrong(&v73, 0);
    ...
    if (v21 <= objc_msgSend(v33, "longValue"))
    {
      ...
      if (v20)
      {
        ...
        while (1)
        {
          ...
          v13 = v26;
          v14 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", v27);
      ...
      v40 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v32 = 1;
      objc_storeStrong(&v26, 0);
    }
    else
...
- (id)insertArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v19 && v18 && v17)
  {
    v7 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v19, "count") * objc_msgSend(v18, "longValue")+ objc_msgSend(v17, "longValue"));
    v8 = v22;
    v22 = v7;
...
LABEL_10:
    if (v21 && v22 && v23)
    {
      ...
      v28 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v16 = 1;
      objc_storeStrong(&v15, 0);
    }
    else
...
- (id)insertRawArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v10 && v11)
  {
    ...
    v16 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
  }
  else
  {
    v5 = objc_alloc(MEMORY[0x1E0CB35C8]);
...
- (id)padArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v27 && v26 && v25)
  {
    v7 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v27, "count") * objc_msgSend(v26, "longValue")+ objc_msgSend(v25, "longValue"));
    v8 = v29;
    v29 = v7;
...
LABEL_15:
    if (v33
      ...
      && v30
      && v29
      && ((objc_msgSend(v30, "isEqual:", &unk_1EA4CEBA8) & 1) != 0
       || (objc_msgSend(v30, "isEqual:", &unk_1EA4CEB90) & 1) != 0))
    {
      ...
      if (v23)
      {
        ...
        if ((objc_msgSend(v30, "isEqual:", &unk_1EA4CEBA8) & 1) != 0)
        {
          for (i = 0; i < v15; ++i)
        ...
        if ((objc_msgSend(v30, "isEqual:", &unk_1EA4CEB90) & 1) != 0)
        {
          for (k = 0; k < v15; ++k)
            objc_msgSend(v22, "addObject:", v31);
        }
        -[NSMutableDictionary setObject:forKey:](v37->_coreDictionary, "setObject:forKey:", v22, v32);
        v38 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v24 = 1;
        objc_storeStrong(&v22, 0);
      }
      else
...
- (id)randomizeArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  *(_QWORD *)&v103 = (id)objc_msgSend(location[0], "objectForKey:", OtherAffectedVectors);
  if (v103 == 0)
  {
    *((_QWORD *)&v103 + 1) = objc_alloc_init(MEMORY[0x1E0C99D80]);

    *(_QWORD *)&v103 = objc_alloc_init(MEMORY[0x1E0C99D80]);
LABEL_31:
    if (v105 && v104)
    {
      ...
      if (v96)
      {
        ...
        {
          v45 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", i);
...
LABEL_65:
        ...
        v110 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v102 = 1;
LABEL_75:
        objc_storeStrong(&v85, 0);
        objc_storeStrong(&v91, 0);
...
- (id)replicateArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v20 && v18 && v19)
  {
    ...
    if (v16)
    {
      ...
      v25 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v17 = 1;
      objc_storeStrong(&v15, 0);
    }
    else
...
- (id)requestData:(id)a3 withUseStubs:(int64_t)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v120 && v119 && v118)
  {
    ...
    v110 = -[AMDClientRequestEvent initWithFeatureName:withAccountDSID:andAccountStoreFrontId:inDomain:withCustomDescriptor:andSchemaVersion:](v8, "initWithFeatureName:withAccountDSID:andAccountStoreFrontId:inDomain:withCustomDescriptor:andSchemaVersion:", v120, 0, 0, v118, v117, v116);
    if (!v110)
    {
      v9 = objc_alloc(MEMORY[0x1E0CB35C8]);
...
LABEL_119:
    ...
    if (v123)
    {
      v11 = -[AMDClient getFeatureStub:](v125->_myAMDClient, "getFeatureStub:", v110);
      v12 = v109;
      v109 = v11;
    ...
    else
    {
      for (i = 0; i < 3; ++i)
      {
        v13 = -[AMDClient getFeature:](v125->_myAMDClient, "getFeature:", v110);
        v14 = v109;
        v109 = v13;
        ...
        if (v109)
        {
          v107 = (id)objc_msgSend(v109, "objectForKey:", CFSTR("status"));
          v106 = 1;
          v72 = objc_msgSend(v107, "isEqual:", CFSTR("OK"));
        }
        if ((v106 & 1) != 0)
...
LABEL_118:
    ...
    v105 = (id)objc_msgSend(v109, "objectForKey:", CFSTR("status"));
    if ((objc_msgSend(v105, "isEqual:", CFSTR("OK")) & 1) == 0)
    {
      v17 = objc_alloc(MEMORY[0x1E0CB35C8]);
...
LABEL_117:
    ...
    v104 = (id)objc_msgSend(v109, "objectForKey:", CFSTR("data"));
    if (!v104)
    {
      v19 = objc_alloc(MEMORY[0x1E0CB35C8]);
...
LABEL_116:
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v126 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
      v111 = 1;
      objc_storeStrong(&v103, 0);
      goto LABEL_116;
    }
      ...
      else
      {
        ...
        if (v59)
        {
          ...
          while (1)
          {
            ...
            v92 = *(id *)(v91[1] + 8 * v56);
            v52 = v97;
            v53 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v92, "longLongValue"));
...
- (id)sampleFromDistribution:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v38 && v37 && v36)
  {
    v7 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v38, "count") * objc_msgSend(v37, "longValue")+ objc_msgSend(v36, "longValue"));
    v8 = v40;
    v40 = v7;
    ...
    if (v42 && v41 && v40)
    {
      ...
      if (v34)
      {
        ...
        for (i = 0; i < objc_msgSend(v40, "longValue"); ++i)
        {
          ...
          v22 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v31);
          objc_msgSend(v33, "addObject:");

        }
        v30 = (id)objc_msgSend(MEMORY[0x1E0CB3928], "sortDescriptorWithKey:ascending:", CFSTR("self"), 1);
        v48[0] = v30;
        v21 = (id)objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v48, 1);
        ...
        while (v27 < v26)
        {
          ...
          {
            v16 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", v28);
        ...
        v47 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v35 = 1;
        objc_storeStrong(&v25, 0);
        objc_storeStrong(&v29, 0);
        objc_storeStrong(&v30, 0);
...
- (id)sortArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  *(_QWORD *)&v109 = (id)objc_msgSend(location[0], "objectForKey:", OtherAffectedVectors);
  if (v109 == 0)
  {
    *((_QWORD *)&v109 + 1) = objc_alloc_init(MEMORY[0x1E0C99D80]);

    *(_QWORD *)&v109 = objc_alloc_init(MEMORY[0x1E0C99D80]);
LABEL_31:
    if (v111 && v110)
    {
      ...
      if (v102)
      {
        ...
        for (i = 0; ; ++i)
        {
          ...
          v119[0] = v49;
          v48 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", i);
          v119[1] = v48;
          v95 = (id)objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v119, 2);
...
LABEL_65:
        ...
        v116 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v108 = 1;
LABEL_75:
        objc_storeStrong(&v90, 0);
        objc_storeStrong(&v93, 0);
...
- (id)spliceArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (v30 && v29 && v28)
  {
    v7 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v30, "count") * objc_msgSend(v29, "longValue")+ objc_msgSend(v28, "longValue"));
    v8 = v36;
    v36 = v7;
...
LABEL_34:
    ...
    if (v26 && v25 && v24)
    {
      v11 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v26, "count") * objc_msgSend(v25, "longValue")+ objc_msgSend(v24, "longValue"));
      v12 = v35;
      v35 = v11;
...
LABEL_18:
      if (v34 && v33 && v36 && v35)
      {
        ...
        if (v23)
        {
          ...
          v41 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
          v27 = 1;
          objc_storeStrong(&v22, 0);
        }
        else
...
- (id)strideCopyArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v22)
    objc_storeStrong(&v22, &unk_1EA4CEBA8);
  if (v24 && v23 && v25 && v26)
  {
...
- (id)strideCopyAndSplitArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v59)
    objc_storeStrong(&v59, &unk_1EA4CEBA8);
  ...
  if (v58 && v60 && v61 && v62)
  {
    ...
    if (v32 == objc_msgSend(v61, "longValue"))
    {
      ...
      if (v52)
      {
        ...
        v67 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
        v57 = 1;
        objc_storeStrong(&v51, 0);
      }
      else
...
- (id)twoArrayMathFunction:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  for (i = 0; ; ++i)
  {
    ...
    if ((objc_msgSend(v53, "isEqual:", Modulo) & 1) != 0)
    {
      ...
      v14 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", v44);
      v15 = v45;
      v45 = v14;
...
LABEL_28:
    ...
    if ((objc_msgSend(v53, "isEqual:", Division) & 1) != 0)
    {
      ...
      v38 = v16;
      objc_msgSend(v46, "doubleValue");
      v18 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v38 / v17);
      v19 = v45;
      v45 = v18;
    ...
    if ((objc_msgSend(v53, "isEqual:", Multiplication) & 1) != 0)
    {
      ...
      v37 = v20;
      objc_msgSend(v46, "doubleValue");
      v22 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v37 * v21);
      v23 = v45;
      v45 = v22;
    ...
    if ((objc_msgSend(v53, "isEqual:", Addition) & 1) != 0)
    {
      ...
      v36 = v24;
      objc_msgSend(v46, "doubleValue");
      v26 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v36 + v25);
      v27 = v45;
      v45 = v26;
    ...
    if ((objc_msgSend(v53, "isEqual:", Subtraction) & 1) != 0)
    {
      ...
      v35 = v28;
      objc_msgSend(v46, "doubleValue");
      v30 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v35 - v29);
      v31 = v45;
      v45 = v30;
...
LABEL_30:
  ...
  v61 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", 1);
  v52 = 1;
LABEL_33:
  objc_storeStrong(&v49, 0);
LABEL_34:
      ...
      for (j = 1; ; ++j)
      {
        ...
        if ((uint64_t)(i - j) >= 0)
        {
          ...
          if (v46 == 1)
          {
            ...
            v29 = v51;
            v30 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", 1);
        ...
        if (v28 < objc_msgSend(v54, "count"))
        {
          ...
          if (v41 == 1)
          {
            ...
            v25 = v51;
            v26 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", 1);
            objc_msgSend(v25, "addObject:");
