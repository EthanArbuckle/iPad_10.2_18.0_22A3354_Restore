...
- (id)callAMDClient:(id)a3 error:(id *)a4
{
  ...
  v24 = objc_alloc_init(AMDClient);

  v4 = [AMDClientRequestEvent alloc];
  v23 = -[AMDClientRequestEvent initWithFeatureName:withAccountDSID:andAccountStoreFrontId:inDomain:withCustomDescriptor:andSchemaVersion:](v4, "initWithFeatureName:withAccountDSID:andAccountStoreFrontId:inDomain:withCustomDescriptor:andSchemaVersion:", v27, 0, 0, v26, 0, v25);
  v22 = 0;
  for (i = 0; i < 3; ++i)
  {
    ...
    if (v22)
    {
      v20 = (id)objc_msgSend(v22, "objectForKey:", CFSTR("status"));
      v19 = 1;
      v14 = objc_msgSend(v20, "isEqual:", CFSTR("OK"));
    }
    if ((v19 & 1) != 0)
  ...
  if (v22)
  {
    v17 = (id)objc_msgSend(v22, "objectForKey:", CFSTR("status"));
    if ((objc_msgSend(v17, "isEqual:", CFSTR("OK")) & 1) != 0)
    {
      v16 = (id)objc_msgSend(v22, "objectForKey:", CFSTR("data"));
      if (v16)
      {
        v30 = v16;
      }
...
- (id)getOperationsArray
{
  ...
  v4[0] = (id)objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v5, 12);
  v3 = v4[0];
...
- (id)performOperation:(id)a3 onArray:(id)a4 error:(id *)a5
{
    ...
    || (objc_msgSend(location[0], "isEqual:", CustomTargetingSumEmp) & 1) != 0)
  {
    if (objc_msgSend(v67, "count"))
    {
      ...
      v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v64);
      v65 = 1;
    }
    else
    {
      ...
      {
        v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", 0);
      }
      v65 = 1;
    }
  }
    ...
    if (objc_msgSend(v62, "count") == 2 || objc_msgSend(v62, "count") == 3)
    {
      ...
      for (j = 0; ; ++j)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          ...
          {
            v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v38);
            v65 = 1;
          }
  ...
  else if ((objc_msgSend(location[0], "containsString:", CustomTargetingConStr) & 1) != 0)
  {
    ...
    for (k = 0; ; ++k)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        {
          v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:");
          v65 = 1;
        }
        else
        {
...
LABEL_46:
         ...
         || (objc_msgSend(location[0], "isEqual:", CustomTargetingMeanEmp) & 1) != 0)
  {
    if (objc_msgSend(v67, "count"))
    {
      ...
      v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v49 / (double)v18);
      v65 = 1;
    }
    else
    {
  ...
  {
    v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", objc_msgSend(v67, "count"));
    v65 = 1;
  }
         ...
         || (objc_msgSend(location[0], "isEqual:", CustomTargetingMaxEmp) & 1) != 0)
  {
    if (objc_msgSend(v67, "count"))
    {
      ...
      v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v47);
      v65 = 1;
    }
    else
    {
         ...
         || (objc_msgSend(location[0], "isEqual:", CustomTargetingMinEmp) & 1) != 0)
  {
    if (objc_msgSend(v67, "count"))
    {
      ...
      v69 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v45);
      v65 = 1;
    }
    else
    {
