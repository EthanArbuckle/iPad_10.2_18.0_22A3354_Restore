...
- (id)description
{
  ...
  -[_HRWDActivityNode responder](self, "responder");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_HRWDActivityNode nextResponder](self, "nextResponder");
...
- (_HRWDActivityNode)initWithResponder:(id)a3
{
  ...
  v5 = -[_HRWDActivityNode init](&v13, sel_init);
  v6 = v5;
  if (v5)
  {
    -[_HRWDActivityNode setResponder:](v5, "setResponder:", v4);
    -[_HRWDActivityNode setNextResponder:](v6, "setNextResponder:", 0);
    ...
    v10 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyOptions:valueOptions:capacity:", 5, 0, 4);
...
- (id)changeActivityForResponder:(id)a3 activityDictionary:(id)a4
{
  ...
  {
    -[_HRWDActivityNode _nextNode](self, "_nextNode");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v9;
    if (v9)
    {
      objc_msgSend(v9, "changeActivityForResponder:activityDictionary:", v6, v7);
      v11 = (_HRWDActivityNode *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v11 = 0;
...
- (id)transitionActivityForResponder:(id)a3 newResponder:(id)a4 transitionDictionary:(id)a5
{
  ...
  if (v11 == v8)
  {
    ...
    v14 = (_HRWDActivityNode *)objc_claimAutoreleasedReturnValue();
    if (!v14)
    {
      v14 = -[_HRWDActivityNode initWithResponder:]([_HRWDActivityNode alloc], "initWithResponder:", v9);
    ...
    -[_HRWDActivityNode setNextResponder:](self, "setNextResponder:", v9);
  }
  else
  {
    -[_HRWDActivityNode _nextNode](self, "_nextNode");
...
{
  return (HRWDUserActivityResponder *)objc_loadWeakRetained((id *)&self->_responder);
}
...
{
  return (HRWDUserActivityResponder *)objc_loadWeakRetained((id *)&self->_nextResponder);
}
