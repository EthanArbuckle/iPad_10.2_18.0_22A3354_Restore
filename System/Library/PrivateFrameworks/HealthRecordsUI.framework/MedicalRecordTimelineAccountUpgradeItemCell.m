...
- (_TtC15HealthRecordsUI43MedicalRecordTimelineAccountUpgradeItemCell)initWithCoder:(id)a3
{
  ...
  *((_QWORD *)v5 + 4) = 0;
  v8.receiver = self;
  v8.super_class = v6;
  return -[MedicalRecordTimelineAccountUpgradeItemCell initWithCoder:](&v8, sel_initWithCoder_, a3);
}

- (void).cxx_destruct
{
  sub_1BC37AE60((uint64_t)self + OBJC_IVAR____TtC15HealthRecordsUI43MedicalRecordTimelineAccountUpgradeItemCell_item);
}
