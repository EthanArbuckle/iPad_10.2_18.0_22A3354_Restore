...
{
  return -[OPTTSTTSRequestFeatureFlags initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[OPTTSTTSRequestFeatureFlags initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (OPTTSTTSRequestFeatureFlags)initWithFlatbuffData:(id)a3 root:(const TTSRequestFeatureFlags *)a4
{
  return -[OPTTSTTSRequestFeatureFlags initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (OPTTSTTSRequestFeatureFlags)initWithFlatbuffData:(id)a3 root:(const TTSRequestFeatureFlags *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  OPTTSTTSRequestFeatureFlags *v10;
  OPTTSTTSRequestFeatureFlags *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  OPTTSTTSRequestFeatureFlags *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[OPTTSTTSRequestFeatureFlags init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::TTSRequestFeatureFlags>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = self;
  v5 = -[OPTTSTTSRequestFeatureFlags fe_feature](self, "fe_feature");
  LODWORD(v4) = -[OPTTSTTSRequestFeatureFlags fe_feature_only](v4, "fe_feature_only");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[OPTTSTTSRequestFeatureFlags addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __43__OPTTSTTSRequestFeatureFlags_flatbuffData__block_invoke;
