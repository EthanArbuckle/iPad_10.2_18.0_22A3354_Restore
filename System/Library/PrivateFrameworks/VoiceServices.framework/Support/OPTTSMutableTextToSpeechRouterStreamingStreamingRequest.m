...
{
  OPTTSMutableTextToSpeechRouterStreamingStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[OPTTSMutableTextToSpeechRouterStreamingStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (OPTTSStartTextToSpeechStreamingRequest)contentAsOPTTSStartTextToSpeechStreamingRequest
{
  ...
  if (-[OPTTSMutableTextToSpeechRouterStreamingStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsOPTTSStartTextToSpeechStreamingRequest:(id)a3
{
  ...
  v5 = a3;
  -[OPTTSMutableTextToSpeechRouterStreamingStreamingRequest setContent_type:](self, "setContent_type:", 1);
