...
- (OPTTSFinalTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const FinalTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  OPTTSFinalTextToSpeechStreamingResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::FinalTextToSpeechStreamingResponse *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  OPTTSFinalTextToSpeechStreamingResponse *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[OPTTSFinalTextToSpeechStreamingResponse init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
