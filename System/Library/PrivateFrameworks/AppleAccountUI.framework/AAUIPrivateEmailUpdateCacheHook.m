...
- (void)processElement:(id)a3 attributes:(id)a4 objectModel:(id)a5 completion:(id)a6
{
  ...
  -[AAUIPrivateEmailUpdateCacheHook _removePrivateEmailKey:withCompletion:](self, "_removePrivateEmailKey:withCompletion:", v9, v8);
...
- (void)processObjectModel:(id)a3 completion:(id)a4
{
  ...
  -[AAUIPrivateEmailUpdateCacheHook _removePrivateEmailKey:withCompletion:](self, "_removePrivateEmailKey:withCompletion:", v8, v6);
}
...
- (void)_removePrivateEmailKey:(id)a3 withCompletion:(id)a4
{
  ...
  v5 = a3;
  v6 = a4;
  v7 = objc_alloc_init(MEMORY[0x1E0D00258]);
...
LABEL_10:
  ...
  else
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 138412290;
      v11 = v8;
      _os_log_impl(&dword_1DB4ED000, v5, OS_LOG_TYPE_DEFAULT, "private email remove for key %@ is success", (uint8_t *)&v10, 0xCu);
    }
...
void __73__AAUIPrivateEmailUpdateCacheHook__removePrivateEmailKey_withCompletion___block_invoke_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_error_impl(&dword_1DB4ED000, log, OS_LOG_TYPE_ERROR, "private email remove for key %@ failed with error %@", (uint8_t *)&v4, 0x16u);
}
