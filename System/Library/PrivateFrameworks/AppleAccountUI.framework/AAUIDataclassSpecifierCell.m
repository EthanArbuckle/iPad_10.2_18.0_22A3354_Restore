...
{
  AAUIDataclassSpecifierCell *v4;
  AAUIDataclassSpecifierCell *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)AAUIDataclassSpecifierCell;
  v4 = -[AAUIDataclassSpecifierCell initWithStyle:reuseIdentifier:](&v7, sel_initWithStyle_reuseIdentifier_, a3, a4);
  v5 = v4;
  if (v4)
  {
    -[AAUIDataclassSpecifierCell setSelectionStyle:](v4, "setSelectionStyle:", 0);
    -[AAUIDataclassSpecifierCell _setupViews](v5, "_setupViews");
  }
  return v5;
}
...
- (void)_setupViews
{
  ...
  v98[12] = *MEMORY[0x1E0C80C00];
  v3 = objc_alloc_init(MEMORY[0x1E0DC3890]);
  -[AAUIDataclassSpecifierCell setHeaderImageView:](self, "setHeaderImageView:", v3);

  -[AAUIDataclassSpecifierCell headerImageView](self, "headerImageView");
  ...
  -[AAUIDataclassSpecifierCell setHeaderTitleLabel:](self, "setHeaderTitleLabel:", v8);

  -[AAUIDataclassSpecifierCell headerTitleLabel](self, "headerTitleLabel");
  ...
  v18 = objc_alloc_init(MEMORY[0x1E0DC3E50]);
  -[AAUIDataclassSpecifierCell setHeaderSubTitleTextView:](self, "setHeaderSubTitleTextView:", v18);

  -[AAUIDataclassSpecifierCell headerSubTitleTextView](self, "headerSubTitleTextView");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "setTranslatesAutoresizingMaskIntoConstraints:", 0);

  +[AAUIDataclassSpecifierCell _subTitleFont](AAUIDataclassSpecifierCell, "_subTitleFont");
  ...
  -[AAUIDataclassSpecifierCell contentView](self, "contentView");
  ...
  v98[11] = v48;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v98, 12);
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setText:", &stru_1EA2E2A18);

  -[AAUIDataclassSpecifierCell imageView](self, "imageView");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setImage:", 0);

  -[AAUIDataclassSpecifierCell headerImageView](self, "headerImageView");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "propertyForKey:", *MEMORY[0x1E0D80870]);
  ...
  +[AAUIDataclassSpecifierCell _attributedStringFromSpecifier:](AAUIDataclassSpecifierCell, "_attributedStringFromSpecifier:", v4);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[AAUIDataclassSpecifierCell headerSubTitleTextView](self, "headerSubTitleTextView");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v12;
  ...
  -[AAUIDataclassSpecifierCell setNeedsLayout](self, "setNeedsLayout");

}

+ (id)_subTitleFont
{
  return (id)objc_msgSend(MEMORY[0x1E0DC1350], "_preferredFontForTextStyle:weight:", *MEMORY[0x1E0DC4B10], *MEMORY[0x1E0DC1440]);
}
...
+ (id)_attributedStringFromSpecifier:(id)a3
{
  ...
  else
  {
    ...
    if (objc_msgSend(v12, "count") == 2)
    {
      ...
      v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3778]), "initWithString:attributes:", v25, v24);
      v26[0] = v13;
      objc_msgSend(MEMORY[0x1E0DC3658], "systemBlueColor");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      v27[0] = v16;
      v26[1] = *MEMORY[0x1E0DC1160];
      ...
      v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3498]), "initWithString:attributes:", v7, v18);
      objc_msgSend(v15, "appendAttributedString:", v19);
      v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3498]), "initWithString:", v23);
