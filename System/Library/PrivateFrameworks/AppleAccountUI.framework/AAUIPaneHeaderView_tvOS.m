...
- (AAUIPaneHeaderView_tvOS)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[AAUIPaneHeaderView_tvOS addSubview:](v3, "addSubview:", v3->_header);
  }
  return v3;
}
...
- (void)layoutSubviews
{
  ...
  -[AAUIPaneHeaderView_tvOS layoutSubviews](&v7, sel_layoutSubviews);
  header = self->_header;
  -[AAUIPaneHeaderView_tvOS bounds](self, "bounds");
...
- (double)innerHeaderMaxY
{
  ...
  -[AAUIPaneHeaderView_tvOS superview](self, "superview");
...
- (void)makeAllTheTextFits
{
  ...
  -[AAUIPaneHeaderView_tvOS textLabel](self, "textLabel");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v18 = &v17;
  v19 = 0x2050000000;
  v6 = (void *)getBFFStyleClass_softClass;
  ...
  -[AAUIPaneHeaderView_tvOS detailTextLabel](self, "detailTextLabel");
