...
{
  id v5;
  AAUITableViewDecorator *v6;
  AAUITableViewDecorator *v7;
  void *v8;
  void *v9;
  objc_super v11;
  ...
  v6 = -[AAUITableViewDecorator init](&v11, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    -[AAUITableViewDecoratorProtocol setDelegate:](v7->_tableView, "setDelegate:", v7);
    -[AAUITableViewDecoratorProtocol setDataSource:](v7->_tableView, "setDataSource:", v7);
  }
...
- (void)reloadData
{
  -[AAUITableViewDecoratorProtocol reloadData](self->_tableView, "reloadData");
}

- (void)reloadRowsAtIndexPaths:(id)a3 withRowAnimation:(int64_t)a4
{
  -[AAUITableViewDecoratorProtocol reloadRowsAtIndexPaths:withRowAnimation:](self->_tableView, "reloadRowsAtIndexPaths:withRowAnimation:", a3, a4);
}
