...
- (AAUIMicaPlayer)initWithFileName:(id)a3 retinaScale:(double)a4
{
  ...
  if (v8)
  {
    ...
    v9 = (AAUIMicaPlayer *)objc_claimAutoreleasedReturnValue();
    v10 = -[AAUIMicaPlayer initWithPath:retinaScale:](self, "initWithPath:retinaScale:", v9, a4);
    self = v9;
  }
  else
  {
...
- (AAUIMicaPlayer)initWithPath:(id)a3 retinaScale:(double)a4
{
  ...
  v6 = a3;
  +[AAUIMicaPlayer rootDictForPath:](AAUIMicaPlayer, "rootDictForPath:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = v7;
  if (!v7
...
LABEL_6:
  ...
  v10 = v9;
  objc_msgSend(v9, "setGeometryFlipped:", +[AAUIMicaPlayer BOOLFromDictionary:key:defaultValue:](AAUIMicaPlayer, "BOOLFromDictionary:key:defaultValue:", v8, CFSTR("geometryFlipped"), 0) ^ 1);
  ...
  v13 = -[AAUIMicaPlayer initWithPath:retinaScale:rootLayer:publishedObjects:](self, "initWithPath:retinaScale:rootLayer:publishedObjects:", v6, v10, v12, a4);
...
- (AAUIMicaPlayer)initWithPath:(id)a3 retinaScale:(double)a4 rootLayer:(id)a5 publishedObjects:(id)a6
{
  ...
  v13 = -[AAUIMicaPlayer init](&v17, sel_init);
  v14 = v13;
  if (v13)
  {
    -[AAUIMicaPlayer setPath:](v13, "setPath:", v10);
    -[AAUIMicaPlayer setRootLayer:](v14, "setRootLayer:", v11);
    -[AAUIMicaPlayer setPublishedObjects:](v14, "setPublishedObjects:", v12);
    LODWORD(v15) = 1.0;
    -[AAUIMicaPlayer setPreferredPlaybackSpeed:](v14, "setPreferredPlaybackSpeed:", v15);
    -[AAUIMicaPlayer setRetinaScale:](v14, "setRetinaScale:", a4);
...
- (void)dealloc
{
  ...
  -[AAUIMicaPlayer stopPlayTimer](self, "stopPlayTimer");
  v3.receiver = self;
  v3.super_class = (Class)AAUIMicaPlayer;
  -[AAUIMicaPlayer dealloc](&v3, sel_dealloc);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[AAUIMicaPlayer path](self, "path");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");

  -[AAUIMicaPlayer rootLayer](self, "rootLayer");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v7, "mp_deepCopyLayer");

  -[AAUIMicaPlayer publishedObjects](self, "publishedObjects");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[AAUIMicaPlayer rootLayer](self, "rootLayer");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  +[AAUIMicaPlayer updatePublishedObjects:toReferenceLayersInTree:ratherThanLayersInTree:](AAUIMicaPlayer, "updatePublishedObjects:toReferenceLayersInTree:ratherThanLayersInTree:", v9, v8, v10);
  v11 = (void *)objc_claimAutoreleasedReturnValue();

  v12 = (void *)objc_msgSend((id)objc_opt_class(), "allocWithZone:", a3);
  -[AAUIMicaPlayer retinaScale](self, "retinaScale");
...
- (void)addToLayer:(id)a3 onTop:(BOOL)a4 gravity:(id)a5
{
  ...
  if (!v9)
  {
    -[AAUIMicaPlayer pause](self, "pause");
    -[AAUIMicaPlayer setPlaybackTime:](self, "setPlaybackTime:", 0.0);
    -[AAUIMicaPlayer moveAndResizeWithinParentLayer:usingGravity:animate:](self, "moveAndResizeWithinParentLayer:usingGravity:animate:", v11, v8, 0);
...
- (id)publishedLayerWithKey:(id)a3 required:(BOOL)a4
{
  ...
  -[AAUIMicaPlayer publishedObjectWithKey:required:](self, "publishedObjectWithKey:required:", a3, a4);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4)
  {
    objc_opt_class();
...
- (void)play
{
  ...
  if (!-[AAUIMicaPlayer isPlaying](self, "isPlaying"))
  {
    v3 = CACurrentMediaTime();
    -[AAUIMicaPlayer playbackTime](self, "playbackTime");
    ...
    *(float *)&v5 = self->_preferredPlaybackSpeed;
    ...
    -[AAUIMicaPlayer startPlayTimerIfNeeded](self, "startPlayTimerIfNeeded");
    -[AAUIMicaPlayer notifyDelegateDidStartPlaying](self, "notifyDelegateDidStartPlaying");
  }
}
...
- (void)pause
{
  ...
  if (-[AAUIMicaPlayer isPlaying](self, "isPlaying"))
  {
    ...
    -[AAUIMicaPlayer stopPlayTimer](self, "stopPlayTimer");
    -[AAUIMicaPlayer notifyDelegateDidStopPlaying](self, "notifyDelegateDidStopPlaying");
  }
}
...
- (void)setPlaybackTime:(double)a3
{
  ...
  v5 = -[AAUIMicaPlayer isPlaying](self, "isPlaying");
  v6 = 0.0;
  if (v5)
  {
  ...
  -[AAUIMicaPlayer notifyDelegateDidChangePlaybackTime](self, "notifyDelegateDidChangePlaybackTime");
}
...
- (BOOL)isPlaybackAtEnd
{
  ...
  -[AAUIMicaPlayer playbackTime](self, "playbackTime");
  v4 = v3;
  -[AAUIMicaPlayer documentDuration](self, "documentDuration");
  return v4 >= v5 + -0.001;
}
...
- (void)setDelegate:(id)a3
{
  ...
  if (-[AAUIMicaPlayer isTimerNeeded](self, "isTimerNeeded"))
    -[AAUIMicaPlayer startPlayTimerIfNeeded](self, "startPlayTimerIfNeeded");
  else
    -[AAUIMicaPlayer stopPlayTimer](self, "stopPlayTimer");
}
...
{
  AAUIMicaPlayerDelegate **p_delegate;
  id WeakRetained;
  void *v5;
  id v6;
  char v7;
  ...
  if (WeakRetained)
  {
    ...
    if ((v7 & 1) != 0)
    {
      ...
      objc_msgSend(v8, "AAUIMicaPlayerDidStartPlaying:", self);
...
- (void)notifyDelegateDidStopPlaying
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v8 = objc_loadWeakRetained((id *)p_delegate);
      objc_msgSend(v8, "AAUIMicaPlayerDidStopPlaying:", self);
...
- (void)notifyDelegateDidChangePlaybackTime
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v8 = objc_loadWeakRetained((id *)p_delegate);
      objc_msgSend(v8, "AAUIMicaPlayerDidChangePlaybackTime:", self);
...
- (BOOL)isTimerNeeded
{
  ...
  if (-[AAUIMicaPlayer isPlaying](self, "isPlaying"))
  {
    ...
    if (v3 == INFINITY)
    {
      -[AAUIMicaPlayer delegate](self, "delegate");
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      if (v5)
      {
        -[AAUIMicaPlayer delegate](self, "delegate");
...
{
  if (-[AAUIMicaPlayer isPlaybackAtEnd](self, "isPlaybackAtEnd", a3))
  {
...
{
  return (AAUIMicaPlayerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
