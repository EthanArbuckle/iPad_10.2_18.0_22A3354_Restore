...
+ (id)contentType
{
  return CFSTR("files/photo");
}

- (id)contentType
{
  return +[WLPhotosMigrator contentType](WLPhotosMigrator, "contentType");
}
...
- (id)importWillBegin
{
  ...
  v4 = -[WLPhotoLibrary initWithContentType:]([WLPhotoLibrary alloc], "initWithContentType:", 0);
