...
+ (id)errorForCode:(int64_t)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:localizedDescription:", CFSTR("MAErrorDomain"), a3, v7);
...
{
  return (id)objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:localizedDescription:", CFSTR("MAErrorDomain"), a3, a4);
}
