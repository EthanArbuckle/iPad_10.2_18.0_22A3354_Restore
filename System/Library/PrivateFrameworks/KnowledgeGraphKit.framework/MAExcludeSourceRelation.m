...
- (void)unionAdjacencySetFromSourceNodeIdentifiers:(id)a3 toTargetNodeIdentifiers:(id)a4 graph:(id)a5
{
  ...
  -[MARelation unionAdjacencySetFromSourceNodeIdentifiers:toTargetNodeIdentifiers:graph:](self->_base, "unionAdjacencySetFromSourceNodeIdentifiers:toTargetNodeIdentifiers:graph:", v10, v11, v8);

  -[KGMutableElementIdentifierSet subtractIdentifierSet:](v11, "subtractIdentifierSet:", v10);
...
- (id)adjacencyWithStartNodeIdentifiers:(id)a3 graph:(id)a4
{
  ...
  objc_msgSend(v7, "differenceWith:", v8);
...
- (id)adjacencyByJoiningWithAdjacency:(id)a3 graph:(id)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "differenceWith:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      base = self->_base;
      -[MAExcludeSourceRelation base](v4, "base");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)scanRelationWithScanner:(id)a3
{
  ...
  if ((objc_msgSend(v3, "scanString:intoString:", CFSTR("-{"), 0) & 1) != 0)
  {
    ...
    {
      v6 = -[MAExcludeSourceRelation initWithBase:]([MAExcludeSourceRelation alloc], "initWithBase:", v5);
    }
    else
    {
