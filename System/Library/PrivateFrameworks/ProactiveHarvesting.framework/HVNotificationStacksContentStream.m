...
- (HVNotificationStacksContentStream)init
{
  ...
  void *v5;
  void *v6;
  HVNotificationStacksContentStream *v7;

  BiomeLibrary();
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "ProactiveHarvesting");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "NotificationStacks");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "identifier");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[HVNotificationStacksContentStream initWithStreamIdentifier:eventClass:](self, "initWithStreamIdentifier:eventClass:", v6, objc_opt_class());
...
{
  id v4;
  HVNotificationStacksContentStream *v5;

  v4 = a3;
  v5 = -[HVNotificationStacksContentStream initWithStreamIdentifier:eventClass:](self, "initWithStreamIdentifier:eventClass:", v4, objc_opt_class());
...
{
  HVNotificationStacksContentStream *v4;
  void *v5;
  void *v6;
  uint64_t v7;
  BMStream *stream;
  ...
  if (v4)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "NotificationStacks");
