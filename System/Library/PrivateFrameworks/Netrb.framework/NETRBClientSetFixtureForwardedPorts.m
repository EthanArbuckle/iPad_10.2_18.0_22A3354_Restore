...
void ___NETRBClientSetFixtureForwardedPorts_block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    uint64 = xpc_dictionary_get_uint64(*(xpc_object_t *)(a1 + 56), (const char *)netrbClientForwardedLowPort);
    xpc_dictionary_set_uint64(v3, v4, uint64);
    v6 = netrbXPCForwardedHighPort;
    v7 = xpc_dictionary_get_uint64(*(xpc_object_t *)(a1 + 56), (const char *)netrbClientForwardedHighPort);
