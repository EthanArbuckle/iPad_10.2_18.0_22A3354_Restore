...
- (id)description
{
  ...
  -[HDCodableStartWorkoutAppResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableStartWorkoutAppResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (launchError)
  {
    -[HDCodableError dictionaryRepresentation](launchError, "dictionaryRepresentation");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("launchError"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v6;
  ...
  v8 = -[HDCodableError copyWithZone:](self->_launchError, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 8);
  *(_QWORD *)(v5 + 8) = v8;
...
LABEL_14:
  launchError = self->_launchError;
  if ((unint64_t)launchError | *((_QWORD *)v4 + 1))
    v6 = -[HDCodableError isEqual:](launchError, "isEqual:");
  else
    v6 = 1;
LABEL_9:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v4 = 0;
  return v4 ^ v3 ^ -[HDCodableError hash](self->_launchError, "hash");
}
...
{
  objc_storeStrong((id *)&self->_launchError, a3);
}
