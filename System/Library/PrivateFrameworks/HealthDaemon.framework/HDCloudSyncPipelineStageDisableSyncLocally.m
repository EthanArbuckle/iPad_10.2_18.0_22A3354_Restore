...
void __50__HDCloudSyncPipelineStageDisableSyncLocally_main__block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if ((a2 & 1) != 0)
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "ownerIdentifierManager");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v10[0] = MEMORY[0x1E0C809B0];
    v10[1] = 3221225472;
    v10[2] = __50__HDCloudSyncPipelineStageDisableSyncLocally_main__block_invoke_183;
    v10[3] = &unk_1E6CE77C8;
    v10[4] = *(_QWORD *)(a1 + 32);
    objc_msgSend(v8, "rollOwnerDifferentiatorAfterCloudSyncDisableWithCompletion:", v10);
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0CB5370], OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543362;
      v12 = v5;
      _os_log_error_impl(&dword_1B7802000, v9, OS_LOG_TYPE_ERROR, "Failed to disable cloud sync: %{public}@", buf, 0xCu);
    }
...
void __50__HDCloudSyncPipelineStageDisableSyncLocally_main__block_invoke_183(uint64_t a1, int a2, void *a3)
{
  id v5;
  NSObject *v6;
  NSObject *v7;
