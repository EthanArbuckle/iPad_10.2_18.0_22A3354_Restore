...
- (id)description
{
  ...
  -[HDCodableUserDomainConceptTypeIdentifier description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableUserDomainConceptTypeIdentifier dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) != 0 && self->_code == *((_QWORD *)v4 + 1))
    {
      v6 = 1;
      goto LABEL_9;
    }
