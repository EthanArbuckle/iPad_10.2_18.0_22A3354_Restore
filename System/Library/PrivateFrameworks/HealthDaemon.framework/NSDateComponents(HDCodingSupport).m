...
- (HDCodableDateComponents)hk_codableDateComponentsForCalendarUnits:()HDCodingSupport
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if ((a3 & 2) != 0 && objc_msgSend(a1, "era") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setEra:](v5, "setEra:", objc_msgSend(a1, "era"));
    if ((a3 & 4) != 0 && objc_msgSend(a1, "year") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setYear:](v5, "setYear:", objc_msgSend(a1, "year"));
    if ((a3 & 8) != 0 && objc_msgSend(a1, "month") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setMonth:](v5, "setMonth:", objc_msgSend(a1, "month"));
    if ((a3 & 0x10) != 0 && objc_msgSend(a1, "day") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setDay:](v5, "setDay:", objc_msgSend(a1, "day"));
    if ((a3 & 0x20) != 0 && objc_msgSend(a1, "hour") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setHour:](v5, "setHour:", objc_msgSend(a1, "hour"));
    if ((a3 & 0x40) != 0 && objc_msgSend(a1, "minute") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setMinute:](v5, "setMinute:", objc_msgSend(a1, "minute"));
    if ((a3 & 0x80) != 0 && objc_msgSend(a1, "second") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setSecond:](v5, "setSecond:", objc_msgSend(a1, "second"));
    if ((a3 & 0x200) != 0 && objc_msgSend(a1, "weekday") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setWeekday:](v5, "setWeekday:", objc_msgSend(a1, "weekday"));
    if ((a3 & 0x400) != 0 && objc_msgSend(a1, "weekdayOrdinal") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setWeekdayOrdinal:](v5, "setWeekdayOrdinal:", objc_msgSend(a1, "weekdayOrdinal"));
    if ((a3 & 0x800) != 0 && objc_msgSend(a1, "quarter") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setQuarter:](v5, "setQuarter:", objc_msgSend(a1, "quarter"));
    if ((a3 & 0x1000) != 0 && objc_msgSend(a1, "weekOfMonth") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setWeekOfMonth:](v5, "setWeekOfMonth:", objc_msgSend(a1, "weekOfMonth"));
    if ((a3 & 0x2000) != 0 && objc_msgSend(a1, "weekOfYear") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setWeekOfYear:](v5, "setWeekOfYear:", objc_msgSend(a1, "weekOfYear"));
    if ((a3 & 0x4000) != 0 && objc_msgSend(a1, "yearForWeekOfYear") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setYearForWeekOfYear:](v5, "setYearForWeekOfYear:", objc_msgSend(a1, "yearForWeekOfYear"));
    if (a3 < 0 && objc_msgSend(a1, "nanosecond") != 0x7FFFFFFFFFFFFFFFLL)
      -[HDCodableDateComponents setNanosecond:](v5, "setNanosecond:", objc_msgSend(a1, "nanosecond"));
    objc_msgSend(a1, "calendar");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "calendarIdentifier");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[HDCodableDateComponents setCalendar:](v5, "setCalendar:", v7);

    objc_msgSend(a1, "timeZone");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "name");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[HDCodableDateComponents setTimeZone:](v5, "setTimeZone:", v9);
...
{
  return objc_msgSend(MEMORY[0x1E0C99D78], "hk_dateComponentsWithCodableDateComponents:calendarUnits:", a3, 65278);
}
