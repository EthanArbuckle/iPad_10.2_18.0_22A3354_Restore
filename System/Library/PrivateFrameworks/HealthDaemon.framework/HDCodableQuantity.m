...
- (id)description
{
  ...
  -[HDCodableQuantity description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableQuantity dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copyWithZone:](self->_unitString, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_value != *((double *)v4 + 1))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  unitString = self->_unitString;
  if ((unint64_t)unitString | *((_QWORD *)v4 + 2))
    v6 = -[NSString isEqual:](unitString, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_unitString, "hash") ^ v3;
}
