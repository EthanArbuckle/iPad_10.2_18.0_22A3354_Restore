...
{
  id v4;
  HDCodableStaticSyncChangeSet *v5;
  uint64_t v6;
  id v7;
  uint64_t v8;
  uint64_t v9;
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("HDStaticSyncTask.m"), 769, CFSTR("%@ must be an instance of %@"), v12, v6);

        }
        if ((objc_opt_isKindOfClass() & 1) != 0)
          -[HDCodableStaticSyncChangeSet addChanges:](v5, "addChanges:", v12);
        ++v11;
      }
      while (v9 != v11);
...
- (id)description
{
  ...
  -[HDCodableStaticSyncChangeSet description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableStaticSyncChangeSet dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HDCodableStaticSyncChangeSet changesCount](self, "changesCount"))
  {
    objc_msgSend(v8, "clearChanges");
    v4 = -[HDCodableStaticSyncChangeSet changesCount](self, "changesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HDCodableStaticSyncChangeSet changesAtIndex:](self, "changesAtIndex:", i);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addChanges:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)changes | v4[1])
      v6 = -[NSMutableArray isEqual:](changes, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_changes, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HDCodableStaticSyncChangeSet addChanges:](self, "addChanges:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
