...
{
  -[NSMutableArray removeAllObjects](self->_contributors, "removeAllObjects");
}
...
- (void)addContributor:(id)a3
{
  ...
  -[NSMutableArray addObject:](contributors, "addObject:", v4);

}

- (unint64_t)contributorsCount
{
  return -[NSMutableArray count](self->_contributors, "count");
}

- (id)contributorAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_contributors, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[HDCodableSampleOriginCollection description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableSampleOriginCollection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_devices, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("device"));
  }
  if (-[NSMutableArray count](self->_contributors, "count"))
  {
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_contributors, "count"));
    v19 = 0u;
    v20 = 0u;
    v21 = 0u;
    v22 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v11, CFSTR("contributor"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v12 = a3;
  if (-[HDCodableSampleOriginCollection devicesCount](self, "devicesCount"))
  {
    objc_msgSend(v12, "clearDevices");
    v4 = -[HDCodableSampleOriginCollection devicesCount](self, "devicesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HDCodableSampleOriginCollection deviceAtIndex:](self, "deviceAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "addDevice:", v7);

      }
    }
  }
  if (-[HDCodableSampleOriginCollection contributorsCount](self, "contributorsCount"))
  {
    objc_msgSend(v12, "clearContributors");
    v8 = -[HDCodableSampleOriginCollection contributorsCount](self, "contributorsCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[HDCodableSampleOriginCollection contributorAtIndex:](self, "contributorAtIndex:", j);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "addContributor:", v11);
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addContributor:", v17);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](devices, "isEqual:")))
  {
    ...
    if ((unint64_t)contributors | v4[1])
      v7 = -[NSMutableArray isEqual:](contributors, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_contributors, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v20 != v8)
          objc_enumerationMutation(v5);
        -[HDCodableSampleOriginCollection addDevice:](self, "addDevice:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v9++));
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v16 != v13)
          objc_enumerationMutation(v10);
        -[HDCodableSampleOriginCollection addContributor:](self, "addContributor:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * v14++), (_QWORD)v15);
      }
      while (v12 != v14);
...
{
  objc_storeStrong((id *)&self->_contributors, a3);
}
