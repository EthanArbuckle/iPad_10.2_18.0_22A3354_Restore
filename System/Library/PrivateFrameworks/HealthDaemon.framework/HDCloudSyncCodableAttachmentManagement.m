...
- (id)description
{
  ...
  -[HDCloudSyncCodableAttachmentManagement description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCloudSyncCodableAttachmentManagement dictionaryRepresentation](self, "dictionaryRepresentation");
