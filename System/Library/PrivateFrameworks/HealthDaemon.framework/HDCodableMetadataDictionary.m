...
- (id)description
{
  ...
  -[HDCodableMetadataDictionary description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableMetadataDictionary dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_keyValuePairs, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("keyValuePairs"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HDCodableMetadataDictionary keyValuePairsCount](self, "keyValuePairsCount"))
  {
    objc_msgSend(v8, "clearKeyValuePairs");
    v4 = -[HDCodableMetadataDictionary keyValuePairsCount](self, "keyValuePairsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HDCodableMetadataDictionary keyValuePairsAtIndex:](self, "keyValuePairsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addKeyValuePairs:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addKeyValuePairs:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)keyValuePairs | v4[1])
      v6 = -[NSMutableArray isEqual:](keyValuePairs, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_keyValuePairs, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HDCodableMetadataDictionary addKeyValuePairs:](self, "addKeyValuePairs:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
...
{
  id v3;
  HDCodableMetadataDictionary *v4;
  void *v5;

  v3 = a3;
  v4 = -[HDCodableMetadataDictionary initWithData:]([HDCodableMetadataDictionary alloc], "initWithData:", v3);

  if (v4)
  {
    objc_msgSend(MEMORY[0x1E0C99D80], "hk_dictionaryOrNilWithCodableMetadata:", v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
