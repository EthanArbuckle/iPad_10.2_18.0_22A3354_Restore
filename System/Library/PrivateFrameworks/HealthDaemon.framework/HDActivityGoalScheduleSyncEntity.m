...
{
  return +[HDSyncEntityIdentifier identifierWithSchema:entity:](HDSyncEntityIdentifier, "identifierWithSchema:entity:", 0, 69);
}
...
{
  return (id)objc_msgSend(MEMORY[0x1E0CB6270], "createWithCodable:", a3, a4);
}
...
+ (BOOL)supportsSyncStore:(id)a3
{
  ...
  v5 = objc_msgSend(v4, "scheduledGoals");
