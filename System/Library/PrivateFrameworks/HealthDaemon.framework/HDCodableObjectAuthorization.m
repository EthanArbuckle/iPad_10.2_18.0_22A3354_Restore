...
- (id)description
{
  ...
  -[HDCodableObjectAuthorization description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableObjectAuthorization dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (objectUUID)
    objc_msgSend(v3, "setObject:forKey:", objectUUID, CFSTR("objectUUID"));
...
- (void)copyTo:(id)a3
{
  ...
  if (-[HDCodableObjectAuthorization authorizationsCount](self, "authorizationsCount"))
  {
    objc_msgSend(v8, "clearAuthorizations");
    v4 = -[HDCodableObjectAuthorization authorizationsCount](self, "authorizationsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HDCodableObjectAuthorization authorizationsAtIndex:](self, "authorizationsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addAuthorizations:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_objectUUID, "copyWithZone:", a3);
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSData isEqual:](objectUUID, "isEqual:")))
  {
    ...
    if ((unint64_t)authorizations | v4[1])
      v7 = -[NSMutableArray isEqual:](authorizations, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_objectUUID, "hash");
  return -[NSMutableArray hash](self->_authorizations, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[HDCodableObjectAuthorization addAuthorizations:](self, "addAuthorizations:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
{
  objc_storeStrong((id *)&self->_objectUUID, a3);
}
