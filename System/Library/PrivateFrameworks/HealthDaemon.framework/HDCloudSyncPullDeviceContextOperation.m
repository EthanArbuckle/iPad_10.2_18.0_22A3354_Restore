...
{
  id v7;
  HDCloudSyncPullDeviceContextOperation *v8;
  HDCloudSyncPullDeviceContextOperation *v9;
  objc_super v11;
...
- (BOOL)performWithError:(id *)a3
{
  ...
  void *v12;
  void *v13;
  HDIngestDeviceContextsOperation *v14;
  void *v15;
  _BOOL4 v16;
  void *v17;
  NSObject *v18;
  ...
  NSObject *v24;
  HDCloudSyncPullDeviceContextOperation *v25;
  id v26;
  uint8_t buf[4];
  HDCloudSyncPullDeviceContextOperation *v28;
  __int16 v29;
  void *v30;
  __int16 v31;
  void *v32;
  ...
  if (v8)
  {
    ...
    v14 = -[HDIngestDeviceContextsOperation initWithAccessibilityAssertion:containerIdentifier:](v10, "initWithAccessibilityAssertion:containerIdentifier:", v12, v13);
      ...
      if (-[HDJournalableOperation didJournal](v14, "didJournal"))
      {
        ...
        if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0CB5370], OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v31 = 2114;
          v32 = v20;
          _os_log_impl(&dword_1B7802000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@: Journaled key value entries for profile: %{public}@, container identifier: %{public}@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0CB5370], OS_LOG_TYPE_DEFAULT))
    {
      ...
      v25 = (HDCloudSyncPullDeviceContextOperation *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138412290;
      v28 = v25;
      _os_log_impl(&dword_1B7802000, v24, OS_LOG_TYPE_DEFAULT, "Context sync zone not present for container identifier: %@", buf, 0xCu);
