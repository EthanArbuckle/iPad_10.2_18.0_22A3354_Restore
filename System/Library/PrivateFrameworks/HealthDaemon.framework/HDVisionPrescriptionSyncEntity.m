...
{
  return +[HDSyncEntityIdentifier identifierWithSchema:entity:](HDSyncEntityIdentifier, "identifierWithSchema:entity:", 0, 62);
}
...
{
  return (id)objc_msgSend(MEMORY[0x1E0CB6DB8], "createWithCodable:", a3, a4);
}
...
+ (id)_basePruningPredicateForDate:(id)a3 profile:(id)a4
{
  ...
  if (v8)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB69F0], "visionPrescriptionType");
...
{
  return _HDIsUnitTesting || objc_msgSend(a3, "syncStoreType") == 2;
}
