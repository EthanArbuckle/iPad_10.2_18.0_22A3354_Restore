...
+ (id)databaseTable
{
  return CFSTR("shared_summary_authorization_categories");
}
...
+ (id)authorizationIdentifiersForSummaryID:(int64_t)a3 databaseTransaction:(id)a4 error:(id *)a5
{
  ...
  v16[3] = &unk_1E6CE8CF8;
  v12 = v10;
  LODWORD(a5) = objc_msgSend(v11, "executeCachedStatementForKey:error:SQLGenerator:bindingHandler:enumerationHandler:", &authorizationIdentifiersForSummaryID_databaseTransaction_error__key, a5, v19, v18, v16);
...
id __111__HDSharedSummaryAuthorizationIdentifierEntity_authorizationIdentifiersForSummaryID_databaseTransaction_error___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "stringWithFormat:", CFSTR("SELECT %@ FROM %@ WHERE %@ = ?"), CFSTR("category"), v2, CFSTR("summary_id"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
