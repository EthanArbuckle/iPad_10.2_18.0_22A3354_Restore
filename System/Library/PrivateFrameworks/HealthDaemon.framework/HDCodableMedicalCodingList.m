...
- (id)description
{
  ...
  -[HDCodableMedicalCodingList description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableMedicalCodingList dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HDCodableMedicalCodingList itemsCount](self, "itemsCount"))
  {
    objc_msgSend(v8, "clearItems");
    v4 = -[HDCodableMedicalCodingList itemsCount](self, "itemsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HDCodableMedicalCodingList itemsAtIndex:](self, "itemsAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HDCodableMedicalCodingList addItems:](self, "addItems:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
