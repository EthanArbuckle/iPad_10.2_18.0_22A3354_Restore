...
- (id)codableRepresentationForPersistentID:(int64_t)a3 row:(HDSQLiteRow *)a4 error:(id *)a5
{
  ...
  if (v9)
  {
    ...
    -[HDCodableSample setObject:](v10, "setObject:", v9);
...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB6AD8]), "_init");
}
...
- (BOOL)applyPropertiesToObject:(id)a3 persistentID:(int64_t)a4 row:(HDSQLiteRow *)a5 error:(id *)a6
{
  ...
  if (v12)
  {
    ...
    if ((MEMORY[0x1BCCAB204](a5, v13) & 1) != 0)
    {
      v14 = 0;
    }
    else
    ...
    objc_msgSend(v10, "_setSampleType:", v14);
