...
- (id)description
{
  ...
  -[HDCloudSyncCodableState description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCloudSyncCodableState dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (stateData)
    objc_msgSend(v3, "setObject:forKey:", stateData, CFSTR("stateData"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  stateData = self->_stateData;
  if (stateData)
    objc_msgSend(a3, "setStateData:", stateData);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_stateData, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)stateData | v4[1])
      v6 = -[NSData isEqual:](stateData, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSData hash](self->_stateData, "hash");
}
