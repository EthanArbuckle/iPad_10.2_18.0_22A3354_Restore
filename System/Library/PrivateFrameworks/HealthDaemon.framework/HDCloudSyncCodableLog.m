...
- (id)description
{
  ...
  -[HDCloudSyncCodableLog description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCloudSyncCodableLog dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copyWithZone:](self->_event, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
LABEL_9:
  ...
  if ((unint64_t)event | *((_QWORD *)v4 + 2))
    v6 = -[NSString isEqual:](event, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_event, "hash") ^ v3;
}
