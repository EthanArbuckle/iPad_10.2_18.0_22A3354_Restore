...
- (id)_categoryType
{
  return (id)objc_msgSend(MEMORY[0x1E0CB6380], "tachycardiaType");
}
...
- (BOOL)didPersistObjects:(id)a3 lastDatum:(id)a4 collector:(id)a5 error:(id *)a6
{
  ...
  v11 = a4;
  v12 = a3;
  -[HDHeartEventDataAggregator triggerImmediateCloudSyncWithReason:](self, CFSTR("New High Heart Rate Notification sample added"));
  v14.receiver = self;
