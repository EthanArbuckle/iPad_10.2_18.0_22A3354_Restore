...
{
  return CFSTR("HDNotificationInstructionObjectNotInDatabaseCriteria");
}
...
- (int64_t)isValidWithDatabaseTransaction:(id)a3 error:(id *)a4
{
  ...
  v11[3] = &unk_1E6CE8540;
  v11[4] = &v13;
  if (!objc_msgSend(v7, "executeCachedStatementForKey:error:SQLGenerator:bindingHandler:enumerationHandler:", &isValidWithDatabaseTransaction_error__lookupKey_0, a4, &__block_literal_global_194, v12, v11))
  {
LABEL_5:
    v9 = 0;
    goto LABEL_6;
...
id __93__HDNotificationInstructionObjectNotInDatabaseCriteria_isValidWithDatabaseTransaction_error___block_invoke()
{
  ...
  objc_msgSend(v0, "stringWithFormat:", CFSTR("SELECT 1 FROM %@ WHERE %@ = ? LIMIT 1"), v1, CFSTR("uuid"));
