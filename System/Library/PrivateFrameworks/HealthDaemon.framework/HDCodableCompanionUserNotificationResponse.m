...
- (id)description
{
  ...
  -[HDCodableCompanionUserNotificationResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableCompanionUserNotificationResponse dictionaryRepresentation](self, "dictionaryRepresentation");
