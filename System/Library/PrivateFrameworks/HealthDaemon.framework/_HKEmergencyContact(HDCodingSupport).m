...
- (HDCodableEmergencyContact)codableRepresentationForSync
{
  ...
  -[HDCodableEmergencyContact setName:](v2, "setName:", v3);

  objc_msgSend(a1, "nameContactIdentifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableEmergencyContact setNameContactIdentifier:](v2, "setNameContactIdentifier:", v4);

  objc_msgSend(a1, "phoneNumber");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableEmergencyContact setPhoneNumber:](v2, "setPhoneNumber:", v5);

  objc_msgSend(a1, "phoneNumberContactIdentifier");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableEmergencyContact setPhoneNumberContactIdentifier:](v2, "setPhoneNumberContactIdentifier:", v6);

  objc_msgSend(a1, "phoneNumberLabel");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableEmergencyContact setPhoneNumberLabel:](v2, "setPhoneNumberLabel:", v7);

  objc_msgSend(a1, "relationship");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableEmergencyContact setRelationship:](v2, "setRelationship:", v8);
...
+ (id)createWithCodable:()HDCodingSupport
{
  ...
  {
    v4 = (objc_class *)MEMORY[0x1E0CB6F88];
    v5 = v3;
