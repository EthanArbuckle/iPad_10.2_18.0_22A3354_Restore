...
{
  return +[HDSyncEntityIdentifier identifierWithSchema:entity:](HDSyncEntityIdentifier, "identifierWithSchema:entity:", 0, 51);
}
...
+ (id)_basePruningPredicateForDate:(id)a3 profile:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB6B00], "fitnessFriendWorkoutType");
