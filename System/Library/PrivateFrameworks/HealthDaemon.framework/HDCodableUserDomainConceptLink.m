...
- (id)description
{
  ...
  -[HDCodableUserDomainConceptLink description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HDCodableUserDomainConceptLink dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (targetUUID)
    objc_msgSend(v3, "setObject:forKey:", targetUUID, CFSTR("targetUUID"));
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSData copyWithZone:](self->_targetUUID, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
LABEL_9:
  ...
  targetUUID = self->_targetUUID;
  if ((unint64_t)targetUUID | *((_QWORD *)v4 + 2))
    v6 = -[NSData isEqual:](targetUUID, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSData hash](self->_targetUUID, "hash") ^ v2;
}
...
{
  objc_storeStrong((id *)&self->_targetUUID, a3);
}
