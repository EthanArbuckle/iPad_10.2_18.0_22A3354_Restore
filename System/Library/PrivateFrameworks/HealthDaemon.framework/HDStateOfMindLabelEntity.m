...
+ (id)databaseTable
{
  return CFSTR("state_of_mind_labels");
}
...
+ (id)labelsForObjectID:(int64_t)a3 transaction:(id)a4 error:(id *)a5
{
  ...
  v12 = v10;
  v16 = v12;
  LODWORD(a5) = objc_msgSend(v11, "executeCachedStatementForKey:error:SQLGenerator:bindingHandler:enumerationHandler:", &labelsForObjectID_transaction_error__selectKey, a5, v18, v17, v15);
...
id __64__HDStateOfMindLabelEntity_labelsForObjectID_transaction_error___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "stringWithFormat:", CFSTR("SELECT %@ FROM %@ WHERE %@ = ?"), CFSTR("label"), v2, CFSTR("data_id"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        v27[4] = a3;
        LODWORD(v14) = objc_msgSend(v17, "executeCachedStatementForKey:error:SQLGenerator:bindingHandler:enumerationHandler:", &_insertLabelForObjectID_label_transaction_error__insertKey, a6, v28, v27, 0);
...
id __76__HDStateOfMindLabelEntity__insertLabelForObjectID_label_transaction_error___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "disambiguatedDatabaseTable");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "stringWithFormat:", CFSTR("INSERT OR REPLACE INTO %@ (%@, %@) VALUES (?, ?)"), v2, CFSTR("data_id"), CFSTR("label"), 0);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
