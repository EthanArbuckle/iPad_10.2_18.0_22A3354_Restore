...
{
  SUCorePolicyPreflightWakeup *v2;
  SUCorePolicyPreflightWakeup *v3;
...
{
  id v4;
  SUCorePolicyPreflightWakeup *v5;
  NSDictionary *additionalOptions;
  NSDictionary *basePreflightOptions;
  objc_super v9;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "encodeBool:forKey:", -[SUCorePolicyPreflightWakeup performPhase](self, "performPhase"), CFSTR("PerformPhase"));
...
- (BOOL)isEqual:(id)a3
{
  SUCorePolicyPreflightWakeup *v4;
  _BOOL4 v5;
  int v6;

  v4 = (SUCorePolicyPreflightWakeup *)a3;
  if (v4 == self)
  {
    LOBYTE(v6) = 1;
  }
  else
  {
    ...
    {
      v5 = -[SUCorePolicyPreflightWakeup performPhase](v4, "performPhase");
      v6 = v5 ^ -[SUCorePolicyPreflightWakeup performPhase](self, "performPhase") ^ 1;
    }
    else
    {
      LOBYTE(v6) = 0;
...
- (id)description
{
  ...
  if (v7)
  {
    -[SUCorePolicyPreflightWakeup additionalOptions](self, "additionalOptions");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "stringWithFormat:", CFSTR("SUCorePolicyPreflightWakeup(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)"), v4, v6, v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();

  }
  else
  {
    objc_msgSend(v3, "stringWithFormat:", CFSTR("SUCorePolicyPreflightWakeup(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)"), v4, v6, CFSTR("none"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
