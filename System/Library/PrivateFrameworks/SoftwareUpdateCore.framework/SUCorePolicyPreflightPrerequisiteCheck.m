...
{
  SUCorePolicyPreflightPrerequisiteCheck *v2;
  SUCorePolicyPreflightPrerequisiteCheck *v3;
  ...
  v2 = -[SUCorePolicyPreflightPrerequisiteCheck init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    v2->_performPhase = 0;
...
{
  id v4;
  SUCorePolicyPreflightPrerequisiteCheck *v5;
  NSDictionary *additionalOptions;
  NSDictionary *basePreflightOptions;
  objc_super v9;
  ...
  v5 = -[SUCorePolicyPreflightPrerequisiteCheck init](&v9, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "encodeBool:forKey:", -[SUCorePolicyPreflightPrerequisiteCheck performPhase](self, "performPhase"), CFSTR("PerformPhase"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SUCorePolicyPreflightPrerequisiteCheck basePreflightOptions](self, "basePreflightOptions");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v6, "copyWithZone:", a3);
  objc_msgSend(v5, "setBasePreflightOptions:", v7);

  -[SUCorePolicyPreflightPrerequisiteCheck additionalOptions](self, "additionalOptions");
...
- (BOOL)isEqual:(id)a3
{
  SUCorePolicyPreflightPrerequisiteCheck *v4;
  _BOOL4 v5;
  int v6;

  v4 = (SUCorePolicyPreflightPrerequisiteCheck *)a3;
  if (v4 == self)
  {
    LOBYTE(v6) = 1;
  }
  else
  {
    ...
    {
      v5 = -[SUCorePolicyPreflightPrerequisiteCheck performPhase](v4, "performPhase");
      v6 = v5 ^ -[SUCorePolicyPreflightPrerequisiteCheck performPhase](self, "performPhase") ^ 1;
    }
    else
    {
      LOBYTE(v6) = 0;
...
- (id)description
{
  ...
  if (-[SUCorePolicyPreflightPrerequisiteCheck performPhase](self, "performPhase"))
    v4 = CFSTR("YES");
  else
    v4 = CFSTR("NO");
  -[SUCorePolicyPreflightPrerequisiteCheck basePreflightOptions](self, "basePreflightOptions");
  ...
  if (v7)
  {
    -[SUCorePolicyPreflightPrerequisiteCheck additionalOptions](self, "additionalOptions");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "stringWithFormat:", CFSTR("SUCorePolicyPreflightPrerequisiteCheck(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)"), v4, v6, v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();

  }
  else
  {
    objc_msgSend(v3, "stringWithFormat:", CFSTR("SUCorePolicyPreflightPrerequisiteCheck(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)"), v4, v6, CFSTR("none"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
