...
{
  SUCorePolicyPreflightFDRRecovery *v2;
  SUCorePolicyPreflightFDRRecovery *v3;
  ...
  v2 = -[SUCorePolicyPreflightFDRRecovery init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    v2->_performPhase = 0;
...
{
  id v4;
  SUCorePolicyPreflightFDRRecovery *v5;
  NSDictionary *additionalOptions;
  NSDictionary *basePreflightOptions;
  objc_super v9;
  ...
  v5 = -[SUCorePolicyPreflightFDRRecovery init](&v9, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "encodeBool:forKey:", -[SUCorePolicyPreflightFDRRecovery performPhase](self, "performPhase"), CFSTR("PerformPhase"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SUCorePolicyPreflightFDRRecovery basePreflightOptions](self, "basePreflightOptions");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v6, "copyWithZone:", a3);
  objc_msgSend(v5, "setBasePreflightOptions:", v7);

  -[SUCorePolicyPreflightFDRRecovery additionalOptions](self, "additionalOptions");
...
- (BOOL)isEqual:(id)a3
{
  SUCorePolicyPreflightFDRRecovery *v4;
  _BOOL4 v5;
  int v6;

  v4 = (SUCorePolicyPreflightFDRRecovery *)a3;
  if (v4 == self)
  {
    LOBYTE(v6) = 1;
  }
  else
  {
    ...
    {
      v5 = -[SUCorePolicyPreflightFDRRecovery performPhase](v4, "performPhase");
      v6 = v5 ^ -[SUCorePolicyPreflightFDRRecovery performPhase](self, "performPhase") ^ 1;
    }
    else
    {
      LOBYTE(v6) = 0;
...
- (id)description
{
  ...
  if (-[SUCorePolicyPreflightFDRRecovery performPhase](self, "performPhase"))
    v4 = CFSTR("YES");
  else
    v4 = CFSTR("NO");
  -[SUCorePolicyPreflightFDRRecovery basePreflightOptions](self, "basePreflightOptions");
  ...
  if (v7)
  {
    -[SUCorePolicyPreflightFDRRecovery additionalOptions](self, "additionalOptions");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "stringWithFormat:", CFSTR("SUCorePolicyPreflightFDRRecovery(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)"), v4, v6, v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();

  }
  else
  {
    objc_msgSend(v3, "stringWithFormat:", CFSTR("SUCorePolicyPreflightFDRRecovery(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)"), v4, v6, CFSTR("none"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
