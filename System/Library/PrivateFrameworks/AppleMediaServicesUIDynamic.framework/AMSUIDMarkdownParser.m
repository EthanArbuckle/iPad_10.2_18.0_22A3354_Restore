...
- (AMSUIDMarkdownParser)initWithString:(id)a3
{
  ...
  v5 = -[AMSUIDMarkdownParser init](&v9, sel_init);
  if (v5)
  {
...
{
  -[AMSUIDMarkdownParser doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
...
- (void)reportErrorWithCode:(unint64_t)a3 userInfo:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("AppleMediaServicesUIDynamic.MarkdownParser.errorDomain"), a3, a4);
  v6 = (id)objc_claimAutoreleasedReturnValue();
  -[AMSUIDMarkdownParser delegate](self, "delegate");
...
- (void)reportParseError:(_xmlError *)a3
{
  ...
  if (a3->level == XML_ERR_FATAL)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "setObject:forKeyedSubscript:", v5, CFSTR("AppleMediaServicesUIDynamic.MarkdownParser.errorLineNumber"));

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", a3->int2);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "setObject:forKeyedSubscript:", v6, CFSTR("AppleMediaServicesUIDynamic.MarkdownParser.errorColumn"));
    ...
    -[AMSUIDMarkdownParser reportErrorWithCode:userInfo:](self, "reportErrorWithCode:userInfo:", a3->code, v8);
...
- (void)parse
{
  ...
  if (v3)
  {
    -[AMSUIDMarkdownParser string](self, "string");
          ...
          v7 >> 31))
    {
      ...
      v9 = -101;
LABEL_5:
      -[AMSUIDMarkdownParser reportErrorWithCode:userInfo:](v8, "reportErrorWithCode:userInfo:", v9, 0);
      return;
    }
    ...
    v34 = xmmword_1E71835B8;
    v35 = unk_1E71835C8;
    v36 = xmmword_1E71835D8;
    v37 = unk_1E71835E8;
    v30 = xmmword_1E7183578;
    v31 = unk_1E7183588;
    v32 = xmmword_1E7183598;
    v33 = *(_OWORD *)&off_1E71835A8;
    v26 = xmmword_1E7183538;
    v27 = unk_1E7183548;
    v28 = xmmword_1E7183558;
    v29 = *(_OWORD *)&off_1E7183568;
    v22 = xmmword_1E71834F8;
    v23 = unk_1E7183508;
    v24 = xmmword_1E7183518;
    v25 = unk_1E7183528;
    ...
    -[AMSUIDMarkdownParser set_parserContext:](self, "set_parserContext:", v18);
    if (htmlParseDocument(v18))
    {
      LastError = xmlCtxtGetLastError(-[AMSUIDMarkdownParser _parserContext](self, "_parserContext"));
      if (LastError)
        -[AMSUIDMarkdownParser reportParseError:](self, "reportParseError:", LastError);
    }
    myDoc = v18->myDoc;
    if (myDoc)
      xmlFreeDoc(myDoc);
    ...
    -[AMSUIDMarkdownParser set_parserContext:](self, "set_parserContext:", 0);
  }
}
...
{
  return (AMSUIDMarkdownParser *)objc_loadWeakRetained((id *)&self->_delegate);
}
