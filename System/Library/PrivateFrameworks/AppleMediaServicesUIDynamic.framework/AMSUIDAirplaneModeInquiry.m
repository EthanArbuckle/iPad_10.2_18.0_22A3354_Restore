...
- (AMSUIDAirplaneModeInquiry)init
{
  ...
  v2 = -[AMSUIDAirplaneModeInquiry init](&v6, sel_init);
  if (v2)
  {
    v3 = (RadiosPreferences *)objc_alloc_init(MEMORY[0x1E0CFA9B8]);
...
+ (NSURL)settingsURL
{
  return (NSURL *)objc_msgSend(MEMORY[0x1E0D80468], "preferencesURL");
}
...
- (BOOL)isEnabled
{
  ...
  -[AMSUIDAirplaneModeInquiry radiosPreferences](self, "radiosPreferences");
...
- (void)airplaneModeChanged
{
  ...
  -[AMSUIDAirplaneModeInquiry delegate](self, "delegate");
