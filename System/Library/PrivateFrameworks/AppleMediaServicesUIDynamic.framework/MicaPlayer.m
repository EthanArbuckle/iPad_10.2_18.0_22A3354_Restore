...
- (MicaPlayer)initWithData:(id)a3 url:(id)a4 retinaScale:(double)a5
{
  ...
  v27 = 0;
  objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClasses:fromData:error:", v15, v10, &v27);
...
+ (id)rootDictForPath:(id)a3
{
  ...
  {
    v21 = 0;
    objc_msgSend(MEMORY[0x1E0C99D50], "dataWithContentsOfURL:options:error:", v4, 1, &v21);
    ...
    if (v5)
    {
      ...
      v20 = v6;
      objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClasses:fromData:error:", v14, v5, &v20);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v16 = v20;
