...
- (id)readInputBlock
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)ASDTIOA2OffsetStream;
  -[ASDTExclavesStream readInputBlock](&v8, sel_readInputBlock);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (double)-[ASDTIOA2OffsetStream sampleTimeOffset](self, "sampleTimeOffset");
  if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_DEBUG))
    -[ASDTIOA2LegacyOffsetStream readInputBlock].cold.1(v4);
  v7[0] = MEMORY[0x24BDAC760];
  v7[1] = 3221225472;
  v7[2] = __38__ASDTIOA2OffsetStream_readInputBlock__block_invoke;
  v7[3] = &unk_25084BCC0;
  *(double *)&v7[5] = v4;
  v7[4] = v3;
