...
{
  void *v4;
  BLSBacklightSceneUpdateAnimationCompleteAction *v5;
  objc_super v7;
  ...
  v5 = -[BLSBacklightSceneUpdateAnimationCompleteAction initWithInfo:responder:](&v7, sel_initWithInfo_responder_, 0, v4);
