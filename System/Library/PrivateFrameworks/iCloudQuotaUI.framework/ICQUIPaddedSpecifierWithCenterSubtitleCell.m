...
{
  ICQUIPaddedSpecifierWithCenterSubtitleCell *v4;
  ICQUIPaddedSpecifierWithCenterSubtitleCell *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)ICQUIPaddedSpecifierWithCenterSubtitleCell;
  v4 = -[ICQUIPaddedSpecifierWithCenterSubtitleCell initWithStyle:reuseIdentifier:](&v7, sel_initWithStyle_reuseIdentifier_, a3, a4);
  v5 = v4;
  if (v4)
  {
    -[ICQUIPaddedSpecifierWithCenterSubtitleCell setSelectionStyle:](v4, "setSelectionStyle:", 0);
    -[ICQUIPaddedSpecifierWithCenterSubtitleCell _setupViews](v5, "_setupViews");
  }
  return v5;
}
...
- (void)_setupViews
{
  ...
  -[ICQUIPaddedSpecifierWithCenterSubtitleCell setHeaderImageView:](self, "setHeaderImageView:", v3);

  -[ICQUIPaddedSpecifierWithCenterSubtitleCell headerImageView](self, "headerImageView");
  ...
  -[ICQUIPaddedSpecifierWithCenterSubtitleCell setHeaderTitleLabel:](self, "setHeaderTitleLabel:", v8);

  -[ICQUIPaddedSpecifierWithCenterSubtitleCell headerTitleLabel](self, "headerTitleLabel");
  ...
  -[ICQUIPaddedSpecifierWithCenterSubtitleCell setHeaderSubTitleTextView:](self, "setHeaderSubTitleTextView:", v18);

  -[ICQUIPaddedSpecifierWithCenterSubtitleCell headerSubTitleTextView](self, "headerSubTitleTextView");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "setTranslatesAutoresizingMaskIntoConstraints:", 0);

  +[ICQUIPaddedSpecifierWithCenterSubtitleCell _subTitleFont](ICQUIPaddedSpecifierWithCenterSubtitleCell, "_subTitleFont");
  ...
  -[ICQUIPaddedSpecifierWithCenterSubtitleCell contentView](self, "contentView");
  ...
  objc_msgSend(v89, "constraintEqualToAnchor:constant:", v88, 24.0);
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  -[ICQUIPaddedSpecifierWithCenterSubtitleCell imageView](self, "imageView");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  +[ICQUIPaddedSpecifierWithCenterSubtitleCell _attributedStringFromSpecifier:](ICQUIPaddedSpecifierWithCenterSubtitleCell, "_attributedStringFromSpecifier:", v4);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[ICQUIPaddedSpecifierWithCenterSubtitleCell headerSubTitleTextView](self, "headerSubTitleTextView");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v12;
  ...
  -[ICQUIPaddedSpecifierWithCenterSubtitleCell setNeedsLayout](self, "setNeedsLayout");
...
+ (_NSRange)_rangeForLinkFromSpecifier:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", ICQUILearnMoreTextKey);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", ICQUILearnMoreLinkKey);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)_attributedStringFromSpecifier:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "objectForKeyedSubscript:", ICQUILearnMoreTextKey);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "objectForKeyedSubscript:", ICQUILearnMoreLinkKey);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
