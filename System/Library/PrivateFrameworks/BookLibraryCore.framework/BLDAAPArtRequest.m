...
- (BLDAAPArtRequest)initWithDSID:(id)a3 databaseID:(id)a4 body:(id)a5
{
  id v8;
  id v9;
  BLDAAPArtRequest *v10;
  BLDAAPArtRequest *v11;
  void *v12;
  objc_super v14;
  ...
  v9 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BLDAAPArtRequest;
  v10 = -[BLDAAPURLRequest initWithDSID:reason:](&v14, sel_initWithDSID_reason_, a3, 5);
  v11 = v10;
  if (v10)
  {
    -[BLDAAPURLRequest setContentType:](v10, "setContentType:", 0);
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("databases/%@/extra_data/cloud-artwork-info"), v8);
