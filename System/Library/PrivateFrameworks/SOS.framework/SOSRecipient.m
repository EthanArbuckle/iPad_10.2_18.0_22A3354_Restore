...
+ (id)handlesFromRecipients:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v13 + 1) + 8 * v9), "handle", (_QWORD)v13);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v18 = v4;
    _os_log_impl(&dword_1AF4DC000, v11, OS_LOG_TYPE_DEFAULT, "sosRecipient handles: %@", buf, 0xCu);
  }
...
+ (id)reasonsDictionaryFromRecipients:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v10, "reasons", (_QWORD)v15));
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v20 = v4;
    _os_log_impl(&dword_1AF4DC000, v13, OS_LOG_TYPE_DEFAULT, "sosRecipient reasonsDict: %@", buf, 0xCu);
  }
...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("SOSRecipient: handle %@ reasons %tu"), self->_handle, self->_reasons);
}
