...
{
  id v4;
  ADRansacLine2DSolver *v5;
  RansacLine2DModel *v6;
  RansacLine2DModel *value;
  uint64_t v8;
  RansacLine2DModel *v9;
  int v10;
  int v11;
  int v12;
  int v13;
  ...
  v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)ADRansacLine2DSolver;
  v5 = -[ADRansacLine2DSolver init](&v22, sel_init);
  if (v5)
  {
    v6 = (RansacLine2DModel *)operator new();
    *(_QWORD *)v6 = &off_24C421488;
    *((_QWORD *)v6 + 1) = 0;
    value = v5->_model2D.__ptr_.__value_;
    v5->_model2D.__ptr_.__value_ = v6;
    if (value)
      (*(void (**)(RansacLine2DModel *))(*(_QWORD *)value + 8))(value);
    v8 = operator new();
    v9 = v5->_model2D.__ptr_.__value_;
...
LABEL_66:
  ...
  v46 = (*(float (**)(RansacLine2DModel *))(*(_QWORD *)self->_model2D.__ptr_.__value_ + 48))(self->_model2D.__ptr_.__value_);
  v47 = (*(double (**)(RansacLine2DModel *))(*(_QWORD *)self->_model2D.__ptr_.__value_ + 56))(self->_model2D.__ptr_.__value_);
...
- (void).cxx_destruct
{
  ...
  if (value)
    (*(void (**)(RansacLine2DModel *, SEL))(*(_QWORD *)value + 8))(value, a2);
