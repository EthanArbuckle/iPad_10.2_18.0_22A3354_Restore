...
- (id)description
{
  ...
  -[WFREPBRunRequestStop description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFREPBRunRequestStop dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  objc_msgSend(a3, "setRunRequestIdentifier:", self->_runRequestIdentifier);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)runRequestIdentifier | v4[1])
      v6 = -[NSString isEqual:](runRequestIdentifier, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSString hash](self->_runRequestIdentifier, "hash");
}
