...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("GallerySessionBrowseCategory");
}
...
- (id)description
{
  ...
  -[WFPBGallerySessionBrowseCategoryEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBGallerySessionBrowseCategoryEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v10 = -[NSString copyWithZone:](self->_galleryCategoryIdentifier, "copyWithZone:", a3);
  v11 = (void *)v5[1];
  v5[1] = v10;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](sessionIdentifier, "isEqual:")))
  {
    ...
    if ((unint64_t)galleryCategoryIdentifier | v4[1])
      v8 = -[NSString isEqual:](galleryCategoryIdentifier, "isEqual:");
    else
      v8 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return v4 ^ -[NSString hash](self->_galleryCategoryIdentifier, "hash");
}
