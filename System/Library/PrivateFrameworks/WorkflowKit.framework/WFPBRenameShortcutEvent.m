...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("RenameShortcutEvent");
}
...
- (id)description
{
  ...
  -[WFPBRenameShortcutEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBRenameShortcutEvent dictionaryRepresentation](self, "dictionaryRepresentation");
