...
- (id)description
{
  ...
  -[WFREPBStopRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFREPBStopRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  objc_msgSend(a3, "setRequestIdentifier:", self->_requestIdentifier);
}
