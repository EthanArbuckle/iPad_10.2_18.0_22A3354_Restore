...
void __94__WFByteCountUnitSubstitutableState_processWithContext_userInputRequiredHandler_valueHandler___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  v19 = 0u;
  v8 = &unk_1E7B8DA00;
  v9 = objc_msgSend(&unk_1E7B8DA00, "countByEnumeratingWithState:objects:count:", &v16, v20, 16);
  if (v9)
  {
    v10 = v9;
    v11 = *(_QWORD *)v17;
    while (2)
    {
      ...
      {
        if (*(_QWORD *)v17 != v11)
          objc_enumerationMutation(&unk_1E7B8DA00);
        WFLabelForByteCountUnit(objc_msgSend(*(id *)(*((_QWORD *)&v16 + 1) + 8 * v12), "unsignedIntegerValue"));
        v13 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      while (v10 != v12);
      v10 = objc_msgSend(&unk_1E7B8DA00, "countByEnumeratingWithState:objects:count:", &v16, v20, 16);
      if (v10)
        continue;
      break;
    }
