...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("GallerySessionSearch");
}
...
- (id)description
{
  ...
  -[WFPBGallerySessionSearchEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBGallerySessionSearchEvent dictionaryRepresentation](self, "dictionaryRepresentation");
