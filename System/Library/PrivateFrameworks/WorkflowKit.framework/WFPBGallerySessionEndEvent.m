...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("GallerySessionEnd");
}
...
- (id)description
{
  ...
  -[WFPBGallerySessionEndEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBGallerySessionEndEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 1) != 0 && self->_duration == *((_DWORD *)v4 + 2))
    {
      v7 = 1;
      goto LABEL_11;
    }
