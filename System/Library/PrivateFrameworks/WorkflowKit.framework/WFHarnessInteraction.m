...
- (WFHarnessInteraction)initWithSelector:(id)a3 dialogRequestClass:(Class)a4 interaction:(id)a5
{
  id v10;
  id v11;
  WFHarnessInteraction *v12;
  WFHarnessInteraction *v13;
  uint64_t v14;
  id interaction;
  WFHarnessInteraction *v16;
  void *v18;
  objc_super v19;
  ...
  if (!v11)
  {
    ...
    objc_msgSend(v18, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("WFHarnessInteraction.m"), 16, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("interaction"));

  }
  v19.receiver = self;
  v19.super_class = (Class)WFHarnessInteraction;
  v12 = -[WFHarnessInteraction init](&v19, sel_init);
  v13 = v12;
  if (v12)
  {
