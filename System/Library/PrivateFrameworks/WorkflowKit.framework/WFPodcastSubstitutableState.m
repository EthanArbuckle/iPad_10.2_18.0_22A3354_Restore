...
+ (id)serializedRepresentationFromValue:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    objc_msgSend(v7, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("WFPodcastSubstitutableState.m"), 21, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("[value isKindOfClass:[WFiTunesPodcastObject class]]"));
