...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("SuspendShortcutEvent");
}
...
- (id)description
{
  ...
  -[WFPBSuspendShortcutEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBSuspendShortcutEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = -[NSString copyWithZone:](self->_presentationStyle, "copyWithZone:", a3);
  v9 = (void *)v5[3];
  v5[3] = v8;

  v10 = -[NSString copyWithZone:](self->_dismissalType, "copyWithZone:", a3);
  v11 = (void *)v5[1];
  v5[1] = v10;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](presentationStyle, "isEqual:")))
  {
    ...
    if ((unint64_t)dismissalType | v4[1])
      v8 = -[NSString isEqual:](dismissalType, "isEqual:");
    else
      v8 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v4 = -[NSString hash](self->_presentationStyle, "hash") ^ v3;
  return v4 ^ -[NSString hash](self->_dismissalType, "hash");
}
