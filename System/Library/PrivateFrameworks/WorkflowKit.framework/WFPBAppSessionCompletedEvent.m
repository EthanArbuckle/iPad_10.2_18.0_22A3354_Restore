...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("AppSessionCompleted");
}
...
- (id)description
{
  ...
  -[WFPBAppSessionCompletedEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBAppSessionCompletedEvent dictionaryRepresentation](self, "dictionaryRepresentation");
