...
{
  return WFLocalizedString(CFSTR("Leave"));
}

+ (id)localizedDisplayExplanation
{
  return WFLocalizedString(CFSTR("Ex. “When I leave work”"));
}
...
- (id)localizedDescriptionWithConfigurationSummary
{
        ...
        v5))
  {
    ...
    WFLocalizedString(CFSTR("When I leave %1$@ between %2$@ and %3$@"));
  ...
  else
  {
    ...
    WFLocalizedString(CFSTR("When I leave %@"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[WFLocationTrigger region](self, "region");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
