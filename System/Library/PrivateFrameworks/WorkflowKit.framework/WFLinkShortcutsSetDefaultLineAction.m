...
- (void)getContentDestinationWithCompletionHandler:(id)a3
{
  ...
  v5 = a3;
  objc_msgSend(v4, "defaultLineLocation");
...
- (id)smartPromptWithContentDescription:(id)a3 contentDestination:(id)a4 workflowName:(id)a5
{
  ...
  v6 = a5;
  WFLocalizedString(CFSTR("Allow “%1$@” to change the default cellular line?"));
...
{
  return WFLocalizedString(CFSTR("Changing the default line for Voice or Data may lead to unexpected cellular plan charges."));
}
