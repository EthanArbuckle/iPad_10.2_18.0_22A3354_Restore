...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("AddShortcut");
}
...
- (id)description
{
  ...
  -[WFPBAddShortcutEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBAddShortcutEvent dictionaryRepresentation](self, "dictionaryRepresentation");
