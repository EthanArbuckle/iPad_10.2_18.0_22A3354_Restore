...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("OpenShortcut");
}
...
- (id)description
{
  ...
  -[WFPBOpenShortcutEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFPBOpenShortcutEvent dictionaryRepresentation](self, "dictionaryRepresentation");
