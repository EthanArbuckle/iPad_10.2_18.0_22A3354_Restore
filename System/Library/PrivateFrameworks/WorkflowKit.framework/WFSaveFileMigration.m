...
+ (BOOL)workflowNeedsMigration:(id)a3 fromClientVersion:(id)a4
{
  ...
  if ((WFCompareBundleVersions(a4, CFSTR("1106")) & 1) != 0)
    HasActionsWithIdentifier = WFWorkflowHasActionsWithIdentifier(CFSTR("is.workflow.actions.documentpicker.save"), v5);
  else
  ...
  if (v3)
  {
    ...
    do
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        if (objc_msgSend(v9, "isEqualToString:", CFSTR("is.workflow.actions.documentpicker.save")))
        {
          ...
          if (v15)
          {
            ...
            objc_msgSend(v7, "setObject:forKey:", CFSTR("is.workflow.actions.dropbox.savefile"), v16);
