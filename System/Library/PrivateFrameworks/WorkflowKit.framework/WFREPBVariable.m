...
- (id)description
{
  ...
  -[WFREPBVariable description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFREPBVariable dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_items, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if (-[WFREPBVariable itemsCount](self, "itemsCount"))
  {
    objc_msgSend(v8, "clearItems");
    v4 = -[WFREPBVariable itemsCount](self, "itemsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[WFREPBVariable itemsAtIndex:](self, "itemsAtIndex:", i);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[WFREPBVariable addItems:](self, "addItems:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
