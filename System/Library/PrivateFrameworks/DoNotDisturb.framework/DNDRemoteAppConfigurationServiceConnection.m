...
void __129__DNDRemoteAppConfigurationServiceConnection_getCurrentAppConfigurationForActionIdentifier_withRequestDetails_completionHandler___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v2, "getCurrentAppConfigurationForActionIdentifier:withRequestDetails:completionHandler:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 56));
...
- (void)getCurrentAppConfigurationForActionIdentifier:(id)a3 withRequestDetails:(id)a4 completionHandler:(id)a5
{
  ...
  block[1] = 3221225472;
  block[2] = __129__DNDRemoteAppConfigurationServiceConnection_getCurrentAppConfigurationForActionIdentifier_withRequestDetails_completionHandler___block_invoke;
  block[3] = &unk_1E39B5C68;
  block[4] = self;
  v16 = v8;
  v17 = v9;
  v18 = v10;
...
- (id)_queue_remoteTarget
{
  ...
  if (!v3)
  {
    -[DNDRemoteAppConfigurationServiceConnection _queue_invalidateConnection](self, "_queue_invalidateConnection");
    -[DNDRemoteAppConfigurationServiceConnection _queue_createConnection](self, "_queue_createConnection");
    -[BSServiceConnection remoteTarget](self->_queue_connection, "remoteTarget");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v3;
...
- (void)_queue_createConnection
{
  ...
  objc_msgSend(v4, "endpointForMachName:service:instance:", CFSTR("com.apple.donotdisturb.appconfiguration.service"), v5, 0);
  ...
  if (v6)
  {
    ...
    v11[1] = 3221225472;
    v11[2] = __69__DNDRemoteAppConfigurationServiceConnection__queue_createConnection__block_invoke;
    v11[3] = &unk_1E39B5F40;
    v11[4] = self;
    v12 = v10;
...
void __60__DNDRemoteAppConfigurationServiceConnection_sharedInstance__block_invoke(uint64_t a1)
{
  id v1;
  void *v2;
...
void __69__DNDRemoteAppConfigurationServiceConnection__queue_createConnection__block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v4, "setActivationHandler:", &__block_literal_global_57_0);
  objc_msgSend(v4, "setInterruptionHandler:", &__block_literal_global_59_0);
  objc_msgSend(v4, "setInvalidationHandler:", &__block_literal_global_61);

}

- (DNDRemoteAppConfigurationServiceConnection)init
{
  DNDRemoteAppConfigurationServiceConnection *v2;
  DNDRemoteAppConfigurationServiceConnection *v3;
  uint64_t v4;
  ...
  v2 = -[DNDRemoteAppConfigurationServiceConnection init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
...
void __69__DNDRemoteAppConfigurationServiceConnection__queue_createConnection__block_invoke_58(uint64_t a1, void *a2)
{
  id v2;
  NSObject *v3;
  int v4;
...
- (void)invalidateAppContextForActionIdentifier:(id)a3 withRequestDetails:(id)a4 completionHandler:(id)a5
{
  ...
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __123__DNDRemoteAppConfigurationServiceConnection_invalidateAppContextForActionIdentifier_withRequestDetails_completionHandler___block_invoke;
  block[3] = &unk_1E39B5C68;
  block[4] = self;
  v16 = v8;
  v17 = v9;
...
void __123__DNDRemoteAppConfigurationServiceConnection_invalidateAppContextForActionIdentifier_withRequestDetails_completionHandler___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "_queue_remoteTarget");
  v2 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "invalidateAppContextForActionIdentifier:withRequestDetails:completionHandler:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 56));
