...
- (SHSheetScrollingTestAction)initWithTest:(id)a3
{
  ...
  id v5;
  id v6;
  SHSheetScrollingTestAction *v7;

  v4 = (objc_class *)MEMORY[0x1E0D22FF0];
  v5 = a3;
  v6 = objc_alloc_init(v4);
  objc_msgSend(v6, "setObject:forSetting:", v5, 4);

  v7 = -[SHSheetScrollingTestAction initWithInfo:responder:](self, "initWithInfo:responder:", v6, 0);
  return v7;
}
...
- (SHSheetScrollingTest)test
{
  ...
  -[SHSheetScrollingTestAction info](self, "info");
