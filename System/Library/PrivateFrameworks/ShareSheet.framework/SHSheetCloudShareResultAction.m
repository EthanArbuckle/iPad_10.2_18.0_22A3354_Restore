...
- (SHSheetCloudShareResultAction)initWithResult:(id)a3
{
  ...
  SHSheetCloudShareResultAction *v8;
  ...
  objc_msgSend(v6, "setObject:forSetting:", v7, 6);
  v8 = -[SHSheetCloudShareResultAction initWithInfo:responder:](self, "initWithInfo:responder:", v6, 0);
...
- (SFCollaborationCloudSharingResult)result
{
  ...
  -[SHSheetCloudShareResultAction info](self, "info");
