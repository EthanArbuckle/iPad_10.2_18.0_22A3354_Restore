...
- (HMIStoreFaceprintOperation)initWithDataSource:(id)a3 faceprint:(id)a4
{
  ...
  HMIStoreFaceprintOperation *v10;
  objc_super v12;
  ...
  v9 = -[HMFOperation initWithTimeout:](&v12, sel_initWithTimeout_, 10.0);
  v10 = v9;
  if (v9)
  {
...
- (void)main
{
  ...
  -[HMIStoreFaceprintOperation dataSource](self, "dataSource");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (void *)MEMORY[0x24BDBCF20];
  -[HMIStoreFaceprintOperation faceprint](self, "faceprint");
  ...
  objc_msgSend(v3, "addFaceprints:completion:", v6, v7);
...
void __34__HMIStoreFaceprintOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v3;
      _os_log_impl(&dword_219D45000, v8, OS_LOG_TYPE_ERROR, "%{public}@Storing faceprint:%@ failed with error:%@", (uint8_t *)&v13, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_219D45000, v8, OS_LOG_TYPE_INFO, "%{public}@Storing faceprint:%@ completed successfully", (uint8_t *)&v13, 0x16u);
