...
{
  id v5;
  HMIFetchUnassociatedFaceCropsOperation *v6;
  HMIFetchUnassociatedFaceCropsOperation *v7;
  uint64_t v8;
...
- (void)main
{
  ...
  -[HMIFetchUnassociatedFaceCropsOperation mainInsideAutoreleasePool](self, "mainInsideAutoreleasePool");
...
- (void)mainInsideAutoreleasePool
{
  ...
  -[HMIFetchUnassociatedFaceCropsOperation dataSource](self, "dataSource");
  ...
  objc_msgSend(v3, "fetchAllUnassociatedFaceCropsWithCompletion:", v4);
  ...
  if (WeakRetained)
  {
    if (v7)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 2112;
        v17 = v7;
        _os_log_impl(&dword_219D45000, v12, OS_LOG_TYPE_ERROR, "%{public}@Error fetching unassociated face crops:%@", (uint8_t *)&v14, 0x16u);
