...
- (HMIRemoveFaceprintsOperation)initWithDataSource:(id)a3 faceprintUUIDs:(id)a4
{
  id v7;
  id v8;
  HMIRemoveFaceprintsOperation *v9;
  HMIRemoveFaceprintsOperation *v10;
  objc_super v12;
...
- (void)main
{
  ...
  -[HMIRemoveFaceprintsOperation mainInsideAutoreleasePool](self, "mainInsideAutoreleasePool");
...
- (void)mainInsideAutoreleasePool
{
  ...
  -[HMIRemoveFaceprintsOperation dataSource](self, "dataSource");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMIRemoveFaceprintsOperation faceprintUUIDs](self, "faceprintUUIDs");
  ...
  objc_msgSend(v3, "removeFaceprintsWithUUIDs:completion:", v4, v5);
  ...
  if (WeakRetained)
  {
    ...
    if (v3)
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        objc_msgSend(v6, "faceprintUUIDs");
        ...
        v17 = 2112;
        v18 = v3;
        _os_log_impl(&dword_219D45000, v8, OS_LOG_TYPE_ERROR, "%{public}@Removing faceprints:%@ failed with error:%@", (uint8_t *)&v13, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v15 = 2112;
        v16 = v12;
        _os_log_impl(&dword_219D45000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing faceprints:%@ completed successfully", (uint8_t *)&v13, 0x16u);
