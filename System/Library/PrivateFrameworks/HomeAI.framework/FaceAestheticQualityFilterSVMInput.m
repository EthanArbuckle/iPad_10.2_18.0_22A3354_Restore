...
{
  id v5;
  FaceAestheticQualityFilterSVMInput *v6;
  ...
  v6 = -[FaceAestheticQualityFilterSVMInput init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24DC15380);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("input")))
  {
    ...
    -[FaceAestheticQualityFilterSVMInput input](self, "input");
