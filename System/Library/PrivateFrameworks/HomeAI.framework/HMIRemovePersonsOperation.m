...
- (void)main
{
  ...
  -[HMIRemovePersonsOperation mainInsideAutoreleasePool](self, "mainInsideAutoreleasePool");
...
- (void)mainInsideAutoreleasePool
{
  ...
  -[HMIRemovePersonsOperation dataSource](self, "dataSource");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMIRemovePersonsOperation personUUIDs](self, "personUUIDs");
  ...
  objc_msgSend(v3, "removePersonsWithUUIDs:completion:", v4, v5);
  ...
  if (WeakRetained)
  {
    ...
    if (v3)
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        v17 = 2112;
        v18 = v3;
        _os_log_impl(&dword_219D45000, v8, OS_LOG_TYPE_ERROR, "%{public}@Error removing persons with UUIDs:%@, error:%@", (uint8_t *)&v13, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v15 = 2112;
        v16 = v12;
        _os_log_impl(&dword_219D45000, v8, OS_LOG_TYPE_INFO, "%{public}@Succesfully removed persons %@", (uint8_t *)&v13, 0x16u);
