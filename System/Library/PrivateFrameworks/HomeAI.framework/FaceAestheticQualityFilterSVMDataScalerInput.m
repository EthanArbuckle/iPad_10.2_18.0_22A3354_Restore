...
{
  id v5;
  FaceAestheticQualityFilterSVMDataScalerInput *v6;
  ...
  v6 = -[FaceAestheticQualityFilterSVMDataScalerInput init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24DC15350);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("input")))
  {
    ...
    -[FaceAestheticQualityFilterSVMDataScalerInput input](self, "input");
