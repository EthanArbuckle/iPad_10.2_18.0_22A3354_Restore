...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("FaceAestheticQualityFilterSVMDataScaler"), CFSTR("mlmodelc"));
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
      +[FaceAestheticQualityFilterSVMDataScaler URLOfModelInThisBundle].cold.1();
    v4 = 0;
  }
...
{
  id v5;
  FaceAestheticQualityFilterSVMDataScaler *v6;
  FaceAestheticQualityFilterSVMDataScaler *v7;
  FaceAestheticQualityFilterSVMDataScaler *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[FaceAestheticQualityFilterSVMDataScaler init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
{
  void *v3;
  FaceAestheticQualityFilterSVMDataScaler *v4;

  objc_msgSend((id)objc_opt_class(), "URLOfModelInThisBundle");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[FaceAestheticQualityFilterSVMDataScaler initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (FaceAestheticQualityFilterSVMDataScaler)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[FaceAestheticQualityFilterSVMDataScaler initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (FaceAestheticQualityFilterSVMDataScaler)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[FaceAestheticQualityFilterSVMDataScaler initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (FaceAestheticQualityFilterSVMDataScaler)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[FaceAestheticQualityFilterSVMDataScaler initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
{
  FaceAestheticQualityFilterSVMDataScaler *v3;
  id v4;

  v4 = a2;
  if (v4)
  {
    v3 = -[FaceAestheticQualityFilterSVMDataScaler initWithMLModel:]([FaceAestheticQualityFilterSVMDataScaler alloc], "initWithMLModel:", v4);
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[FaceAestheticQualityFilterSVMDataScaler predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  FaceAestheticQualityFilterSVMDataScalerOutput *v12;
  void *v13;
  void *v14;
  FaceAestheticQualityFilterSVMDataScalerOutput *v15;

  v8 = a4;
  v9 = a3;
  -[FaceAestheticQualityFilterSVMDataScaler model](self, "model");
  ...
  if (v11)
  {
    ...
    objc_msgSend(v11, "featureValueForName:", CFSTR("transformed_features"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "multiArrayValue");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = -[FaceAestheticQualityFilterSVMDataScalerOutput initWithTransformed_features:](v12, "initWithTransformed_features:", v14);
...
void __84__FaceAestheticQualityFilterSVMDataScaler_predictionFromFeatures_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  void *v7;
  void *v8;
  FaceAestheticQualityFilterSVMDataScalerOutput *v9;
  uint64_t v10;
  void (*v11)(uint64_t, _QWORD, FaceAestheticQualityFilterSVMDataScalerOutput *);
  id v12;
  ...
  if (v12)
  {
    ...
    objc_msgSend(v12, "featureValueForName:", CFSTR("transformed_features"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "multiArrayValue");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = -[FaceAestheticQualityFilterSVMDataScalerOutput initWithTransformed_features:](v6, "initWithTransformed_features:", v8);
  ...
  {
    v10 = *(_QWORD *)(a1 + 32);
    v11 = *(void (**)(uint64_t, _QWORD, FaceAestheticQualityFilterSVMDataScalerOutput *))(v10 + 16);
    v9 = a3;
    v11(v10, 0, v9);
  }
...
{
  id v6;
  FaceAestheticQualityFilterSVMDataScalerInput *v7;
  void *v8;

  v6 = a3;
  v7 = -[FaceAestheticQualityFilterSVMDataScalerInput initWithInput:]([FaceAestheticQualityFilterSVMDataScalerInput alloc], "initWithInput:", v6);

  -[FaceAestheticQualityFilterSVMDataScaler predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  FaceAestheticQualityFilterSVMDataScalerOutput *v16;
  void *v17;
  void *v18;
  FaceAestheticQualityFilterSVMDataScalerOutput *v19;
  id v21;
  id v22;
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        objc_msgSend(v15, "featureValueForName:", CFSTR("transformed_features"));
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "multiArrayValue");
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v19 = -[FaceAestheticQualityFilterSVMDataScalerOutput initWithTransformed_features:](v16, "initWithTransformed_features:", v18);
...
+ (void)URLOfModelInThisBundle
{
  ...
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_219D45000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "Could not load FaceAestheticQualityFilterSVMDataScaler.mlmodelc in the bundle resource", v0, 2u);
}
