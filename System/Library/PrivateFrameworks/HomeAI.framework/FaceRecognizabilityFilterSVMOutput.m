...
{
  id v7;
  FaceRecognizabilityFilterSVMOutput *v8;
  FaceRecognizabilityFilterSVMOutput *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)FaceRecognizabilityFilterSVMOutput;
  v8 = -[FaceRecognizabilityFilterSVMOutput init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_classLabel = a3;
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24DC15308);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDBFF98], "featureValueWithInt64:", -[FaceRecognizabilityFilterSVMOutput classLabel](self, "classLabel"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)MEMORY[0x24BDBFF98];
    -[FaceRecognizabilityFilterSVMOutput classProbability](self, "classProbability");
