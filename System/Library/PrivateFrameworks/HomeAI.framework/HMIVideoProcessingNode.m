...
- (void)handleSampleBuffer:(opaqueCMSampleBuffer *)a3
{
  ...
  {
    -[HMIVideoProcessingNode handleAudioSampleBuffer:](self, "handleAudioSampleBuffer:", a3);
  }
  else if (MediaType == 1986618469)
  {
    -[HMIVideoProcessingNode handleVideoSampleBuffer:](self, "handleVideoSampleBuffer:", a3);
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v10;
      _os_log_impl(&dword_219D45000, v8, OS_LOG_TYPE_ERROR, "%{public}@Ignoring %@", (uint8_t *)&v11, 0x16u);
