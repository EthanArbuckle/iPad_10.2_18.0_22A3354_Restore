...
- (VTNovDetectorResult)initWithResult:(id)a3
{
  ...
  v5 = -[VTNovDetectorResult init](&v8, sel_init);
  if (v5)
  {
...
- (NSDictionary)dictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", self->_sampleFed);
  ...
  *(float *)&v7 = self->_bestScore;
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_earlyWarning);
