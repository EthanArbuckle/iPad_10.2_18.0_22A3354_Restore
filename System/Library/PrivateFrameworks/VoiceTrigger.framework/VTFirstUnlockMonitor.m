...
LABEL_6:
  ...
  self->_firstUnlocked = -[VTFirstUnlockMonitor _checkFirstUnlocked](self, "_checkFirstUnlocked", v7);
...
- (void)_stopMonitoring
{
  ...
  if (notifyToken != -1)
  {
    ...
    {
      *(_WORD *)v5 = 0;
      _os_log_impl(&dword_20D965000, v4, OS_LOG_TYPE_DEFAULT, "Stop monitoring : First unlock", v5, 2u);
    }
  }
}
...
- (void)_notifyObserver:(id)a3 withUnlocked:(BOOL)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
    objc_msgSend(v6, "VTFirstUnlockMonitor:didReceiveFirstUnlock:", self, v4);
...
- (BOOL)_checkFirstUnlocked
{
  ...
  if (os_log_type_enabled((os_log_t)VTLogContextFacilityVoiceTrigger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v6 = 138543362;
    v7 = v4;
    _os_log_impl(&dword_20D965000, v3, OS_LOG_TYPE_DEFAULT, "Unlocked since boot = %{public}@", (uint8_t *)&v6, 0xCu);
  }
  return v2 == 1;
}
...
{
  *(_BYTE *)(*(_QWORD *)(a1 + 32) + 28) = objc_msgSend(*(id *)(a1 + 32), "_checkFirstUnlocked");
  return objc_msgSend(*(id *)(a1 + 32), "_didReceiveFirstUnlock:", *(unsigned __int8 *)(*(_QWORD *)(a1 + 32) + 28));
}

+ (id)sharedInstance
{
  if (sharedInstance_onceToken_5485 != -1)
    dispatch_once(&sharedInstance_onceToken_5485, &__block_literal_global_5486);
  return (id)sharedInstance__sharedInstance_5487;
}

void __38__VTFirstUnlockMonitor_sharedInstance__block_invoke()
{
  VTFirstUnlockMonitor *v0;
  void *v1;

  v0 = objc_alloc_init(VTFirstUnlockMonitor);
  v1 = (void *)sharedInstance__sharedInstance_5487;
  sharedInstance__sharedInstance_5487 = (uint64_t)v0;
