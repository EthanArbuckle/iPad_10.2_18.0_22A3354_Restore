...
- (id)_buildTitle
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("PHS Reject : %@"), v3);
...
- (id)_buildContent
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)VTEventPHSReject;
...
- (id)_buildDetail
{
  ...
  -[VTEvent _packStringContent:value:](self, "_packStringContent:value:", CFSTR("Type"), CFSTR("PHS Rejected"));
