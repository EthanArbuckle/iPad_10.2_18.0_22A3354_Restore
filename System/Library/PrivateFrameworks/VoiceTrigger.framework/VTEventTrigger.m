...
- (id)_buildTitle
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("True Trigger : %@"), v3);
...
- (id)_buildContent
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)VTEventTrigger;
...
- (id)_buildDetail
{
  ...
  -[VTEvent _packStringContent:value:](self, "_packStringContent:value:", CFSTR("Type"), CFSTR("True Triggered"));
