...
uint64_t __63__BLSH1HzFlipbookAttributeHandler_activateForSceneEnvironment___block_invoke(uint64_t a1)
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
    return objc_msgSend(*(id *)(a1 + 32), "set1HzFlipbook:", 1);
  ...
  objc_msgSend(v3, "stringWithFormat:", CFSTR("class %@ must respond to selector set1HzFlipbook: in order to acquire assertion with BLS1HzFlipbookAttribute : %@"), v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
    __63__BLSH1HzFlipbookAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(a1, (uint64_t)v7);
...
{
  return objc_msgSend(*(id *)(a1 + 32), "set1HzFlipbook:", 0);
}
...
void __63__BLSH1HzFlipbookAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(uint64_t a1, uint64_t a2)
{
  ...
  v13 = v7;
  v14 = 2114;
  v15 = CFSTR("BLSH1HzFlipbookAttributeHandler.m");
  v16 = 1024;
  v17 = 33;
  v18 = 2114;
  v19 = a2;
