...
{
  -[BLSHTransparentFlipbookProvider setFlipbookTransparent:](self->_provider, "setFlipbookTransparent:", 1);
}

- (void)deactivateWithFinalEntry:(id)a3
{
  -[BLSHTransparentFlipbookProvider setFlipbookTransparent:](self->_provider, "setFlipbookTransparent:", 0);
}
