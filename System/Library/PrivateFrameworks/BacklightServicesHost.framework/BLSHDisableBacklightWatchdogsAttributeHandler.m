...
{
  -[BLSHWatchdogProvider setWatchdogEnabled:](self->_provider, "setWatchdogEnabled:", 0);
}

- (void)deactivateWithFinalEntry:(id)a3
{
  -[BLSHWatchdogProvider setWatchdogEnabled:](self->_provider, "setWatchdogEnabled:", 1);
}
