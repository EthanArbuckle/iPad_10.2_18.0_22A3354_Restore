...
{
  -[BLSHAlwaysFillFlipbookProvider setAlwaysFillFlipbook:](self->_provider, "setAlwaysFillFlipbook:", 1);
}

- (void)deactivateWithFinalEntry:(id)a3
{
  -[BLSHAlwaysFillFlipbookProvider setAlwaysFillFlipbook:](self->_provider, "setAlwaysFillFlipbook:", 0);
}
