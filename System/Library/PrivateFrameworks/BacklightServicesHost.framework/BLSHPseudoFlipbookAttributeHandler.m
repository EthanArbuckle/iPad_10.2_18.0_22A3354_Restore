...
{
  -[BLSHPseudoFlipbookProvider setUsePseudoFlipbook:](self->_provider, "setUsePseudoFlipbook:", 1);
}

- (void)deactivateWithFinalEntry:(id)a3
{
  -[BLSHPseudoFlipbookProvider setUsePseudoFlipbook:](self->_provider, "setUsePseudoFlipbook:", 0);
}
