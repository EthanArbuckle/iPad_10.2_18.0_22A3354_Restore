...
{
  -[BLSHGlobalHighLuminanceAlwaysOnProvider setGlobalHighLuminanceAlwaysOn:](self->_provider, "setGlobalHighLuminanceAlwaysOn:", 1);
}

- (void)deactivateWithFinalEntry:(id)a3
{
  -[BLSHGlobalHighLuminanceAlwaysOnProvider setGlobalHighLuminanceAlwaysOn:](self->_provider, "setGlobalHighLuminanceAlwaysOn:", 0);
}
