...
+ (id)registerHandlerForService:(id)a3 provider:(id)a4
{
  ...
  v5 = a4;
  v6 = a3;
  v7 = -[BLSHGlobalCacheFlipbookOnDisplayWakeAttributeHandler initForService:provider:]([BLSHGlobalCacheFlipbookOnDisplayWakeAttributeHandler alloc], "initForService:provider:", v6, v5);
...
{
  -[BLSHGlobalCacheFlipbookOnDisplayWakeProvider setGlobalCacheFlipbookOnDisplayWake:](self->_provider, "setGlobalCacheFlipbookOnDisplayWake:", 1);
}

- (void)deactivateWithFinalEntry:(id)a3
{
  -[BLSHGlobalCacheFlipbookOnDisplayWakeProvider setGlobalCacheFlipbookOnDisplayWake:](self->_provider, "setGlobalCacheFlipbookOnDisplayWake:", 0);
}
