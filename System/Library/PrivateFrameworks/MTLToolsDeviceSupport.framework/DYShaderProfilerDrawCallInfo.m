...
{
  DYShaderProfilerDrawCallInfo *v2;
  DYShaderProfilerDrawCallInfo *v3;
  DYShaderProfilerDrawCallInfo *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)DYShaderProfilerDrawCallInfo;
  v2 = -[DYShaderProfilerDrawCallInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
    v4 = v2;
...
{
  objc_storeStrong((id *)&self->_allShaderKeys, a3);
}
...
{
  objc_storeStrong((id *)&self->_programInfo, a3);
}
