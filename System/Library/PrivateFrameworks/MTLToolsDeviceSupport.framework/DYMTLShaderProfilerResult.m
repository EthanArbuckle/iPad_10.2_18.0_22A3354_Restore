...
- (DYMTLShaderProfilerResult)init
{
  ...
  v2 = -[DYShaderProfilerResult init](&v7, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithCapacity:", 1024);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    -[DYShaderProfilerResult setShaderProfilingFrameTimes:](v2, "setShaderProfilingFrameTimes:", v3);

    objc_msgSend(MEMORY[0x24BDBCED8], "dictionaryWithCapacity:", 1024);
