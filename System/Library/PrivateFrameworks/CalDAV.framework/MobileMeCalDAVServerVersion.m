...
{
  MobileMeCalDAVServerVersion *v2;
  void *v3;
  uint64_t v5;
  objc_super v6;
  ...
  {
    v5 = 0;
    objc_msgSend(MEMORY[0x24BDD1798], "regularExpressionWithPattern:options:error:", CFSTR("MobileMeCalendarServer"), 1, &v5);
