...
{
  _CPVisibleSuggestionsFeedback *v2;
  _CPVisibleSuggestionsFeedback *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)_CPVisibleSuggestionsFeedback;
  v2 = -[_CPVisibleSuggestionsFeedback init](&v5, sel_init);
  if (v2)
  {
    -[_CPVisibleSuggestionsFeedback setTimestamp:](v2, "setTimestamp:", mach_absolute_time());
    v3 = v2;
  }
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (-[_CPVisibleSuggestionsFeedback timestamp](self, "timestamp"))
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    {
      -[_CPVisibleSuggestionsFeedback suggestions](self, "suggestions");
...
{
  id v4;
  _CPVisibleSuggestionsFeedback *v5;
  void *v6;
  id v7;
  void *v8;
  uint64_t v9;
  ...
  uint64_t v11;
  uint64_t i;
  _CPSearchSuggestionForFeedback *v13;
  _CPVisibleSuggestionsFeedback *v14;
  __int128 v16;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  ...
  v5 = -[_CPVisibleSuggestionsFeedback init](&v20, sel_init);
  if (v5)
  {
    -[_CPVisibleSuggestionsFeedback setTimestamp:](v5, "setTimestamp:", objc_msgSend(v4, "timestamp"));
    objc_msgSend(v4, "suggestions");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (v6)
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = -[_CPSearchSuggestionForFeedback initWithFacade:]([_CPSearchSuggestionForFeedback alloc], "initWithFacade:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * i));
    ...
    -[_CPVisibleSuggestionsFeedback setSuggestions:](v5, "setSuggestions:", v7);
    v14 = v5;
