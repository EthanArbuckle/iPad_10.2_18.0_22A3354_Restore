...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_CPListValue values](self, "values");
...
- (_CPListValue)initWithFacade:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_CPListValue init](self, "init");
  if (v5)
  {
    v18 = 0u;
    v19 = 0u;
    ...
    if (v7)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v12 = [_CPValue alloc];
          v13 = -[_CPValue initWithFacade:](v12, "initWithFacade:", v11, (_QWORD)v16);
          -[_CPListValue addValues:](v5, "addValues:", v13);
