...
- (RMDARC4RandomSource)init
{
  ...
  v5 = -[RMDARC4RandomSource initWithSeed:](self, "initWithSeed:", v4);
...
- (RMDARC4RandomSource)initWithSeed:(id)a3
{
  ...
  v5 = -[RMDRandomSource init](&v11, sel_init);
  if (v5)
  {
    ...
    -[RMDARC4RandomSource setSeed:](v5, "setSeed:", v4);
  }
...
- (RMDARC4RandomSource)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[RMDARC4RandomSource init](self, "init");
  if (v5)
  {
    v6 = (Arc4State *)malloc_type_malloc(0x10uLL, 0x1010040466105CCuLL);
    v5->_state = v6;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[RMDRandomSource encodeWithCoder:](&v5, sel_encodeWithCoder_, v4);
...
- (void)dealloc
{
  ...
  -[RMDARC4RandomSource dealloc](&v4, sel_dealloc);
}
