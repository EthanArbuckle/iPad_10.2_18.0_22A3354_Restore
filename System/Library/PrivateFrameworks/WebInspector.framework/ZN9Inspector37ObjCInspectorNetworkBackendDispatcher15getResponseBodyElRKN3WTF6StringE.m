@implementation ZN9Inspector37ObjCInspectorNetworkBackendDispatcher15getResponseBodyElRKN3WTF6StringE
...
WTF::JSONImpl::ObjectBase *___ZN9Inspector37ObjCInspectorNetworkBackendDispatcher15getResponseBodyElRKN3WTF6StringE_block_invoke_2(WTF::JSONImpl::Object *a1, uint64_t a2, WTF::JSONImpl::Value *a3)
{
  ...
  if (!a2)
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB8], CFSTR("required parameter '%@' cannot be nil"), CFSTR("body"));
  ...
  WTF::StringImpl::createWithoutCopyingNonEmpty();
  v10 = v12;
  WTF::JSONImpl::ObjectBase::setBoolean(v7, &v10, a3);
  v8 = v10;
  v10 = 0;
  if (v8)
  {
