...
- (RWIProtocolCSSProperty)initWithName:(id)a3 value:(id)a4
{
  ...
  if (v8)
  {
    ...
    -[RWIProtocolCSSProperty setName:](v8, "setName:", v6);
    -[RWIProtocolCSSProperty setValue:](v8, "setValue:", v7);
    v9 = v8;
  }
...
- (void)setPriority:(id)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolCSSProperty;
  -[RWIProtocolJSONObject setString:forKey:](&v3, sel_setString_forKey_, a3, CFSTR("priority"));
}
...
- (NSString)priority
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolCSSProperty;
  -[RWIProtocolJSONObject stringForKey:](&v3, sel_stringForKey_, CFSTR("priority"));
  return (NSString *)(id)objc_claimAutoreleasedReturnValue();
}
...
- (void)setImplicit:(BOOL)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolCSSProperty;
  -[RWIProtocolJSONObject setBool:forKey:](&v3, sel_setBool_forKey_, a3, CFSTR("implicit"));
}
...
- (BOOL)implicit
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolCSSProperty;
  return -[RWIProtocolJSONObject BOOLForKey:](&v3, sel_BOOLForKey_, CFSTR("implicit"));
}
...
- (void)setParsedOk:(BOOL)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolCSSProperty;
  -[RWIProtocolJSONObject setBool:forKey:](&v3, sel_setBool_forKey_, a3, CFSTR("parsedOk"));
}
...
- (BOOL)parsedOk
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolCSSProperty;
  return -[RWIProtocolJSONObject BOOLForKey:](&v3, sel_BOOLForKey_, CFSTR("parsedOk"));
}
...
- (int64_t)status
{
  ...
  v2 = -[RWIProtocolJSONObject stringForKey:](&v9, sel_stringForKey_, CFSTR("status"));
...
LABEL_8:
  ...
  while (i == 12);
  v6 = (&Inspector::fromProtocolString<RWIProtocolCSSPropertyStatus>(WTF::String const&)::mappings)[i + 2];
  v7 = (_DWORD *)v10;
  v10 = 0;
  if (v7)
  {
