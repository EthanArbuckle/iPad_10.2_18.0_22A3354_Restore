...
- (RWIProtocolCSSComputedStyleProperty)initWithName:(id)a3 value:(id)a4
{
  id v6;
  id v7;
  RWIProtocolCSSComputedStyleProperty *v8;
  RWIProtocolCSSComputedStyleProperty *v9;
  objc_super v11;
  ...
  if (v8)
  {
    ...
    -[RWIProtocolCSSComputedStyleProperty setName:](v8, "setName:", v6);
    -[RWIProtocolCSSComputedStyleProperty setValue:](v8, "setValue:", v7);
    v9 = v8;
  }
