@implementation ZN9Inspector33ObjCInspectorCSSBackendDispatcher23getComputedStyleForNodeEli

uint64_t *___ZN9Inspector33ObjCInspectorCSSBackendDispatcher23getComputedStyleForNodeEli_block_invoke_2(WTF::JSONImpl::Object *a1, void *a2)
{
  uint64_t v3;
  uint64_t v4;
  uint64_t v5;
  ...
  if (!a2)
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB8], CFSTR("required parameter '%@' cannot be nil"), CFSTR("computedStyle"));
  v25 = 0u;
  v26 = 0u;
  v23 = 0u;
  v24 = 0u;
