...
- (RWIProtocolConsoleStackTrace)initWithCallFrames:(id)a3
{
  ...
  objc_class *v12;
  void *v13;
  RWIProtocolConsoleStackTrace *v14;
  id v16;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  ...
  {
    if (!v16)
      objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB8], CFSTR("required property '%@' cannot be nil"), CFSTR("callFrames"));
    v19 = 0u;
    v20 = 0u;
    v17 = 0u;
    v18 = 0u;
    ...
    -[RWIProtocolConsoleStackTrace setCallFrames:](v4, "setCallFrames:", v5);
    v14 = v4;
  }
...
- (void)setCallFrames:(id)a3
{
  ...
  -[RWIProtocolJSONObject setJSONArray:forKey:](&v14, sel_setJSONArray_forKey_, &v15, CFSTR("callFrames"));
  v12 = v15;
  v15 = 0;
  if (v12)
  {
...
- (NSArray)callFrames
{
  ...
  -[RWIProtocolJSONObject JSONArrayForKey:](&v5, sel_JSONArrayForKey_, CFSTR("callFrames"));
  Inspector::toObjCArray<RWIProtocolConsoleCallFrame>(&v6);
...
- (void)setTopCallFrameIsBoundary:(BOOL)a3
{
  ...
  -[RWIProtocolJSONObject setBool:forKey:](&v3, sel_setBool_forKey_, a3, CFSTR("topCallFrameIsBoundary"));
}
...
- (BOOL)topCallFrameIsBoundary
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolConsoleStackTrace;
  return -[RWIProtocolJSONObject BOOLForKey:](&v3, sel_BOOLForKey_, CFSTR("topCallFrameIsBoundary"));
}
...
- (void)setTruncated:(BOOL)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolConsoleStackTrace;
  -[RWIProtocolJSONObject setBool:forKey:](&v3, sel_setBool_forKey_, a3, CFSTR("truncated"));
}
...
- (BOOL)truncated
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolConsoleStackTrace;
  return -[RWIProtocolJSONObject BOOLForKey:](&v3, sel_BOOLForKey_, CFSTR("truncated"));
}
...
- (void)setParentStackTrace:(id)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolConsoleStackTrace;
  -[RWIProtocolJSONObject setObject:forKey:](&v3, sel_setObject_forKey_, a3, CFSTR("parentStackTrace"));
}
...
- (RWIProtocolConsoleStackTrace)parentStackTrace
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolConsoleStackTrace;
  -[RWIProtocolJSONObject objectForKey:](&v14, sel_objectForKey_, CFSTR("parentStackTrace"));
  ...
  if (v3)
  {
    ...
    -[RWIProtocolJSONObject objectForKey:](&v11, sel_objectForKey_, CFSTR("parentStackTrace"));
