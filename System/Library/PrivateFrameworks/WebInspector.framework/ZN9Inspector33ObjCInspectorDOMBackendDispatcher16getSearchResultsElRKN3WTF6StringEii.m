@implementation ZN9Inspector33ObjCInspectorDOMBackendDispatcher16getSearchResultsElRKN3WTF6StringEii

uint64_t *___ZN9Inspector33ObjCInspectorDOMBackendDispatcher16getSearchResultsElRKN3WTF6StringEii_block_invoke_2(WTF::JSONImpl::Object *a1, Inspector *a2)
{
  uint64_t *v3;
  uint64_t v4;
  uint64_t *v5;
  ...
  if (!a2)
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB8], CFSTR("required parameter '%@' cannot be nil"), CFSTR("nodeIds"));
  v3 = v16;
