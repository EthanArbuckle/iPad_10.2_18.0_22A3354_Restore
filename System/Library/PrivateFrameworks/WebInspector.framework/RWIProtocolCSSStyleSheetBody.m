...
{
  RWIProtocolCSSStyleSheetBody *v6;
  id v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t v10;
  ...
  objc_class *v14;
  void *v15;
  RWIProtocolCSSStyleSheetBody *v16;
  RWIProtocolCSSStyleSheetBody *v18;
  id v19;
  id v20;
  __int128 v21;
  __int128 v22;
  ...
  if (v6)
  {
    ...
    if (!v20)
      objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB8], CFSTR("required property '%@' cannot be nil"), CFSTR("rules"));
    v18 = v6;
    v23 = 0u;
    v24 = 0u;
    v21 = 0u;
    ...
    v6 = v18;
    -[RWIProtocolCSSStyleSheetBody setStyleSheetId:](v18, "setStyleSheetId:", v19);
    -[RWIProtocolCSSStyleSheetBody setRules:](v18, "setRules:", v7);
    v16 = v18;
  }
...
- (void)setRules:(id)a3
{
  ...
  -[RWIProtocolJSONObject setJSONArray:forKey:](&v14, sel_setJSONArray_forKey_, &v15, CFSTR("rules"));
  v12 = v15;
  v15 = 0;
  if (v12)
  {
...
- (NSArray)rules
{
  ...
  -[RWIProtocolJSONObject JSONArrayForKey:](&v5, sel_JSONArrayForKey_, CFSTR("rules"));
  Inspector::toObjCArray<RWIProtocolCSSRule>(&v6);
