@implementation ZN9Inspector33ObjCInspectorDOMBackendDispatcher12getOuterHTMLEli
...
WTF::JSONImpl::ObjectBase *___ZN9Inspector33ObjCInspectorDOMBackendDispatcher12getOuterHTMLEli_block_invoke_2(WTF::JSONImpl::Object *a1, uint64_t a2)
{
  ...
  if (!a2)
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB8], CFSTR("required parameter '%@' cannot be nil"), CFSTR("outerHTML"));
