@implementation ZN9Inspector34ObjCInspectorPageBackendDispatcher15getResourceTreeEl
...
_DWORD *___ZN9Inspector34ObjCInspectorPageBackendDispatcher15getResourceTreeEl_block_invoke_2(WTF::JSONImpl::Object *a1, void *a2)
{
  ...
  if (!a2)
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB8], CFSTR("required parameter '%@' cannot be nil"), CFSTR("frameTree"));
  v3 = v15;
