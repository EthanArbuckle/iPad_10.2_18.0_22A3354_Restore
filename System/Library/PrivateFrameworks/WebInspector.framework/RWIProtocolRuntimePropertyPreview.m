...
{
  id v6;
  RWIProtocolRuntimePropertyPreview *v7;
  RWIProtocolRuntimePropertyPreview *v8;
  objc_super v10;
  ...
  if (v7)
  {
    ...
    -[RWIProtocolRuntimePropertyPreview setName:](v7, "setName:", v6);
    -[RWIProtocolRuntimePropertyPreview setType:](v7, "setType:", a4);
    v8 = v7;
  }
...
LABEL_8:
  ...
  while (i == 27);
  v6 = (&Inspector::fromProtocolString<RWIProtocolRuntimePropertyPreviewType>(WTF::String const&)::mappings)[i + 2];
  v7 = (_DWORD *)v10;
  v10 = 0;
  if (v7)
  {
...
LABEL_8:
  ...
  while (i == 42);
  v6 = (&Inspector::fromProtocolString<RWIProtocolRuntimePropertyPreviewSubtype>(WTF::String const&)::mappings)[i + 2];
  v7 = (_DWORD *)v10;
  v10 = 0;
  if (v7)
  {
...
- (void)setValuePreview:(id)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolRuntimePropertyPreview;
  -[RWIProtocolJSONObject setObject:forKey:](&v3, sel_setObject_forKey_, a3, CFSTR("valuePreview"));
}
...
- (RWIProtocolRuntimeObjectPreview)valuePreview
{
  ...
  -[RWIProtocolJSONObject objectForKey:](&v14, sel_objectForKey_, CFSTR("valuePreview"));
  ...
  if (v3)
  {
    ...
    -[RWIProtocolJSONObject objectForKey:](&v11, sel_objectForKey_, CFSTR("valuePreview"));
...
- (void)setInternal:(BOOL)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolRuntimePropertyPreview;
  -[RWIProtocolJSONObject setBool:forKey:](&v3, sel_setBool_forKey_, a3, CFSTR("internal"));
}
...
- (BOOL)internal
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolRuntimePropertyPreview;
  return -[RWIProtocolJSONObject BOOLForKey:](&v3, sel_BOOLForKey_, CFSTR("internal"));
}
