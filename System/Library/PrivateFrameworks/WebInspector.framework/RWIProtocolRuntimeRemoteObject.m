...
- (RWIProtocolRuntimeRemoteObject)initWithType:(int64_t)a3
{
  ...
  RWIProtocolRuntimeRemoteObject *v5;
  RWIProtocolRuntimeRemoteObject *v6;
  objc_super v8;
  ...
  if (v4)
  {
    -[RWIProtocolRuntimeRemoteObject setType:](v4, "setType:", a3);
    v6 = v5;
  }
...
LABEL_8:
  ...
  while (i == 24);
  v6 = (&Inspector::fromProtocolString<RWIProtocolRuntimeRemoteObjectType>(WTF::String const&)::mappings)[i + 2];
  v7 = (_DWORD *)v10;
  v10 = 0;
  if (v7)
  {
...
LABEL_8:
  ...
  while (i == 42);
  v6 = (&Inspector::fromProtocolString<RWIProtocolRuntimeRemoteObjectSubtype>(WTF::String const&)::mappings)[i + 2];
  v7 = (_DWORD *)v10;
  v10 = 0;
  if (v7)
  {
...
- (void)setClassName:(id)a3
{
  ...
  -[RWIProtocolJSONObject setString:forKey:](&v3, sel_setString_forKey_, a3, CFSTR("className"));
}
...
- (NSString)className
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolRuntimeRemoteObject;
  -[RWIProtocolJSONObject stringForKey:](&v3, sel_stringForKey_, CFSTR("className"));
...
- (void)setClassPrototype:(id)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolRuntimeRemoteObject;
  -[RWIProtocolJSONObject setObject:forKey:](&v3, sel_setObject_forKey_, a3, CFSTR("classPrototype"));
}
...
- (RWIProtocolRuntimeRemoteObject)classPrototype
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolRuntimeRemoteObject;
  -[RWIProtocolJSONObject objectForKey:](&v14, sel_objectForKey_, CFSTR("classPrototype"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (v3)
  {
    ...
    v11.receiver = self;
    v11.super_class = (Class)RWIProtocolRuntimeRemoteObject;
    -[RWIProtocolJSONObject objectForKey:](&v11, sel_objectForKey_, CFSTR("classPrototype"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "toJSONObject");
    v6 = v12;
    ++*v12;
...
- (void)setPreview:(id)a3
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolRuntimeRemoteObject;
  -[RWIProtocolJSONObject setObject:forKey:](&v3, sel_setObject_forKey_, a3, CFSTR("preview"));
}

- (RWIProtocolRuntimeObjectPreview)preview
{
  void *v3;
  RWIProtocolRuntimeObjectPreview *v4;
  void *v5;
  _DWORD *v6;
  ...
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolRuntimeRemoteObject;
  -[RWIProtocolJSONObject objectForKey:](&v14, sel_objectForKey_, CFSTR("preview"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (v3)
  {
    ...
    v11.receiver = self;
    v11.super_class = (Class)RWIProtocolRuntimeRemoteObject;
    -[RWIProtocolJSONObject objectForKey:](&v11, sel_objectForKey_, CFSTR("preview"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "toJSONObject");
    v6 = v12;
    ++*v12;
