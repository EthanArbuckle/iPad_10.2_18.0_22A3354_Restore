...
{
  id v5;
  SUUIBrowseItemPageSection *v6;
  SUUIBrowseItemPageSection *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUUIBrowseItemPageSection;
  v6 = -[SUUIStorePageSection initWithPageComponent:](&v9, sel_initWithPageComponent_, v5);
  v7 = v6;
  if (v6)
...
- (void)addImpressionsForIndexPath:(id)a3 toSession:(id)a4
{
  ...
  v5 = a4;
  -[SUUIBrowseItemPageSection pageComponent](self, "pageComponent");
...
- (void)willAppearInContext:(id)a3
{
  ...
  objc_msgSend(v8, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), CFSTR("SUUIBrowseItemPageSectionReuseIdentifier"));
  v5 = self->_layoutContext;
  v6 = -[SUUIViewElementLayoutContext initWithStorePageSectionContext:previousLayoutContext:]([SUUIViewElementLayoutContext alloc], "initWithStorePageSectionContext:previousLayoutContext:", v4, v5);
...
- (id)cellForIndexPath:(id)a3
{
  ...
  objc_msgSend(v7, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", CFSTR("SUUIBrowseItemPageSectionReuseIdentifier"), v4);
  ...
  -[SUUIBrowseItemPageSection _imageForImageViewElement:styleColor:](self, "_imageForImageViewElement:styleColor:", v11, v14);
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  if (v6)
  {
    ...
    v24.size.width = v19;
    v24.size.height = v21;
    objc_msgSend(v7, "setSUUIStackedBarSplit:", CGRectGetMaxY(v24));
    -[SUUIBrowseItemPageSection pageComponent](self, "pageComponent");
