...
{
  SUUIStorePageCollectionViewLayout *v2;
  ...
  v2 = -[UICollectionViewFlowLayout init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    v2->_allowsPinningTransitions = 1;
    -[UICollectionViewFlowLayout setMinimumInteritemSpacing:](v2, "setMinimumInteritemSpacing:", 0.0);
    -[UICollectionViewFlowLayout setMinimumLineSpacing:](v3, "setMinimumLineSpacing:", 0.0);
    v4 = *MEMORY[0x24BEBE180];
    v8[0] = *MEMORY[0x24BEBE170];
    v8[1] = v4;
    v9[0] = &unk_2512EEAC0;
    v9[1] = &unk_2512EEAC0;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v9, v8, 2);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[UICollectionViewFlowLayout _setRowAlignmentsOptions:](v3, "_setRowAlignmentsOptions:", v5);

    -[SUUIStorePageCollectionViewLayout registerClass:forDecorationViewOfKind:](v3, "registerClass:forDecorationViewOfKind:", objc_opt_class(), 0x2511FF4C8);
    -[SUUIStorePageCollectionViewLayout registerClass:forDecorationViewOfKind:](v3, "registerClass:forDecorationViewOfKind:", objc_opt_class(), 0x25120DD68);
  }
  return v3;
}
...
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)a3
{
  ...
  -[SUUIStorePageCollectionViewLayout initialLayoutAttributesForAppearingItemAtIndexPath:](&v29, sel_initialLayoutAttributesForAppearingItemAtIndexPath_, v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
  if (expandChildPageSectionsIndexSet
    ...
    && self->_updateItems)
  {
    -[SUUIStorePageCollectionViewLayout _getCollectionViewUpdateItemForItemFromIndex:initalLayout:](self, "_getCollectionViewUpdateItemForItemFromIndex:initalLayout:", objc_msgSend(v4, "section"), 1);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = objc_msgSend(v7, "updateAction");
    if (!v7 || v8)
      goto LABEL_13;
    -[SUUIStorePageCollectionViewLayout collectionView](self, "collectionView");
...
- (id)finalLayoutAttributesForDisappearingItemAtIndexPath:(id)a3
{
  ...
  -[SUUIStorePageCollectionViewLayout finalLayoutAttributesForDisappearingItemAtIndexPath:](&v28, sel_finalLayoutAttributesForDisappearingItemAtIndexPath_, v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
  if (expandChildPageSectionsIndexSet
    && -[NSIndexSet containsIndex:](expandChildPageSectionsIndexSet, "containsIndex:", objc_msgSend(v4, "section"))
    && self->_updateItems)
  {
    -[SUUIStorePageCollectionViewLayout _getCollectionViewUpdateItemForItemFromIndex:initalLayout:](self, "_getCollectionViewUpdateItemForItemFromIndex:initalLayout:", objc_msgSend(v4, "section"), 0);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = objc_msgSend(v7, "updateAction");
    if (!v7 || v8 != 1)
      goto LABEL_13;
...
- (id)invalidationContextForBoundsChange:(CGRect)a3
{
  ...
  {
    -[SUUIStorePageCollectionViewLayout _indexPathsForPinningItems](self, "_indexPathsForPinningItems");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v25, "count"))
    {
      objc_msgSend(v8, "invalidateItemsAtIndexPaths:", v25);
      objc_msgSend(v8, "invalidateDecorationElementsOfKind:atIndexPaths:", 0x2511FF4C8, v25);
    }
...
- (void)invalidateLayoutWithContext:(id)a3
{
    ...
    || objc_msgSend(v4, "invalidateEverything"))
  {
    ...
    -[SUUIStorePageCollectionViewLayout _invalidatePinningLayoutInformation](self, "_invalidatePinningLayoutInformation");
  }
...
- (id)layoutAttributesForDecorationViewOfKind:(id)a3 atIndexPath:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  if (objc_msgSend(v6, "isEqualToString:", 0x2511FF4C8))
  {
    -[SUUIStorePageCollectionViewLayout _itemPinningConfigurationForItemAtIndexPath:](self, "_itemPinningConfigurationForItemAtIndexPath:", v7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIStorePageCollectionViewLayout _itemPinningLayoutInformationForItemAtIndexPath:](self, "_itemPinningLayoutInformationForItemAtIndexPath:", v7);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIStorePageCollectionViewLayout _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:pinningConfiguration:layoutInformation:](self, "_layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:pinningConfiguration:layoutInformation:", v7, v8, v9);
...
LABEL_6:
      ...
      -[SUUIStorePageCollectionViewLayout layoutAttributesForDecorationViewOfKind:atIndexPath:](&v12, sel_layoutAttributesForDecorationViewOfKind_atIndexPath_, v6, v7);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
    }
  }
  else
  {
    if (!objc_msgSend(v6, "isEqualToString:", 0x25120DD68))
      goto LABEL_6;
    +[UICollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:withIndexPath:](SUUIGridViewGradientLayoutAttributes, "layoutAttributesForDecorationViewOfKind:withIndexPath:", 0x25120DD68, v7);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v10)
      goto LABEL_6;
  }
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (!objc_msgSend(v15, "representedElementCategory"))
        {
          ...
          if ((_DWORD)v18)
          {
            -[SUUIStorePageCollectionViewLayout _itemPinningLayoutInformationForItemAtIndexPath:](self, "_itemPinningLayoutInformationForItemAtIndexPath:", v16);
            v19 = (void *)objc_claimAutoreleasedReturnValue();
            -[SUUIStorePageCollectionViewLayout _itemPinningConfigurationForItemAtIndexPath:](self, "_itemPinningConfigurationForItemAtIndexPath:", v16);
          ...
          v30 = 0;
          -[SUUIStorePageCollectionViewLayout _configureCellLayoutAttributes:forItemWithPinningConfiguration:layoutInformation:atIndexPath:allowPinning:returningIsPinning:](self, "_configureCellLayoutAttributes:forItemWithPinningConfiguration:layoutInformation:atIndexPath:allowPinning:returningIsPinning:", v15, v20, v19, v16, v18, &v30);
          if (v30
            && -[SUUIStorePageCollectionViewLayout _allowsBackdropDecorationForItemPinningConfiguration:atIndexPath:](self, "_allowsBackdropDecorationForItemPinningConfiguration:atIndexPath:", v20, v16))
          {
            -[SUUIStorePageCollectionViewLayout _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:pinningConfiguration:layoutInformation:](self, "_layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:pinningConfiguration:layoutInformation:", v16, v20, v19);
            v21 = (void *)objc_claimAutoreleasedReturnValue();
            if (v21)
            {
              v22 = v29;
              if (!v29)
                v22 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", 1);
              objc_msgSend(v22, "addObject:", v21, v22);
            }

          }
        }
        -[SUUIStorePageCollectionViewLayout _indexPathsForBackgroundGradients](self, "_indexPathsForBackgroundGradients");
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        v24 = objc_msgSend(v23, "containsObject:", v16);

        if (v24)
        {
          -[SUUIStorePageCollectionViewLayout _layoutAttributesForGradientDecorationViewAtIndexPath:currentAttributes:](self, "_layoutAttributesForGradientDecorationViewAtIndexPath:currentAttributes:", v16, v15);
          v25 = (void *)objc_claimAutoreleasedReturnValue();
          if (v25)
          {
            v26 = v29;
            if (!v29)
              v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", 1);
      ...
      for (i = 0; i != v10; ++i)
      {
        ...
        if ((v15 & 1) == 0 && !objc_msgSend(v13, "representedElementCategory"))
        {
          ...
          if (objc_msgSend(v6, "count"))
          {
            ...
            objc_msgSend(MEMORY[0x24BDD1968], "valueWithCGRect:", v65.origin.x, v65.origin.y, v65.size.width, v65.size.height);
          ...
          {
LABEL_13:
            v36 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithObjects:", v13, 0);
            objc_msgSend(v5, "addObject:", v36);

            objc_msgSend(MEMORY[0x24BDD1968], "valueWithCGRect:", v17, v19, v21, v23);
            v25 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)layoutAttributesForItemAtIndexPath:(id)a3
{
  ...
  if (!self->_inLayoutAttributesForElementsCount && !objc_msgSend(v5, "representedElementCategory"))
  {
    ...
    if ((_DWORD)v8)
    {
      -[SUUIStorePageCollectionViewLayout _itemPinningLayoutInformationForItemAtIndexPath:](self, "_itemPinningLayoutInformationForItemAtIndexPath:", v4);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIStorePageCollectionViewLayout _itemPinningConfigurationForItemAtIndexPath:](self, "_itemPinningConfigurationForItemAtIndexPath:", v4);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
...
- (void)prepareForCollectionViewUpdates:(id)a3
{
  ...
  -[SUUIStorePageCollectionViewLayout prepareForCollectionViewUpdates:](&v15, sel_prepareForCollectionViewUpdates_, v14);
...
- (void)prepareLayout
{
  ...
  *(_BYTE *)&self->_collectionViewDelegateFlags = *(_BYTE *)&self->_collectionViewDelegateFlags & 0xDF | v9;
  ...
  v12 = -[SUUIStorePageCollectionViewLayout _indexPathsForPinningItems](self, "_indexPathsForPinningItems");
  v13 = -[SUUIStorePageCollectionViewLayout _indexPathsForBackgroundGradients](self, "_indexPathsForBackgroundGradients");
...
- (void)setAllowsPinningTransitions:(BOOL)a3
{
  ...
  if (self->_allowsPinningTransitions != a3)
  {
    ...
    -[SUUIStorePageCollectionViewLayout invalidateLayoutWithContext:](self, "invalidateLayoutWithContext:", v4);
  ...
  if (backdropGroupName != v4)
  {
    ...
    if (!v6)
    {
      ...
      if (objc_msgSend(v9, "count"))
      {
        ...
        objc_msgSend(v10, "invalidateDecorationElementsOfKind:atIndexPaths:", 0x2511FF4C8, v9);
        -[SUUIStorePageCollectionViewLayout invalidateLayoutWithContext:](self, "invalidateLayoutWithContext:", v10);
...
- (BOOL)_allowsBackdropDecorationForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  ...
  v4 = -[SUUIStorePageCollectionViewLayout _pinningStyleForItemPinningConfiguration:atIndexPath:](self, "_pinningStyleForItemPinningConfiguration:atIndexPath:", a3, a4);
  if (v4)
    v5 = v4 == 3;
  else
    v5 = 1;
...
- (void)_appendAdditionalLayoutAttributesForPinningItemsInRect:(CGRect)a3 toArray:(id)a4
{
  ...
  double v21;
  CGFloat v22;
  SUUIStorePageCollectionViewLayout *v23;
  id v24;
  uint64_t v25;
  uint64_t v26;
  uint64_t v27;
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SUUIStorePageCollectionViewLayout _itemPinningLayoutInformationForItemAtIndexPath:](self, "_itemPinningLayoutInformationForItemAtIndexPath:", v13, v32);
        v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_calculatePinningLayoutInformation
{
  ...
  v34[2] = 0x4010000000;
  v34[3] = "";
  v13 = *(_OWORD *)(MEMORY[0x24BEBE158] + 16);
...
void __71__SUUIStorePageCollectionViewLayout__calculatePinningLayoutInformation__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  double v54;
  double v55;
  SUUIStorePageItemPinningLayoutInformation *v56;
  void *v57;
  uint64_t v58;
  uint64_t v59;
  void *v60;
...
LABEL_47:
  ...
  -[SUUIStorePageItemPinningLayoutInformation setAfterPinningLocationYAdditions:](v56, "setAfterPinningLocationYAdditions:", v73);
  -[SUUIStorePageItemPinningLayoutInformation setBeforePinningLocationYAdditions:](v56, "setBeforePinningLocationYAdditions:", *(double *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 24));
  v57 = *(void **)(*(_QWORD *)(a1 + 32) + 592);
  if (!v57)
  {
    v58 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, objc_msgSend(*(id *)(a1 + 40), "count"));
    v59 = *(_QWORD *)(a1 + 32);
    v60 = *(void **)(v59 + 592);
    *(_QWORD *)(v59 + 592) = v58;
...
- (void)_configureCellLayoutAttributes:(id)a3 forItemWithPinningConfiguration:(id)a4 layoutInformation:(id)a5 atIndexPath:(id)a6 allowPinning:(BOOL)a7 returningIsPinning:(BOOL *)a8
{
  ...
  if (v9)
  {
    ...
    if (v39)
    {
      ...
      if (-[SUUIStorePageCollectionViewLayout _allowsBackdropDecorationForItemPinningConfiguration:atIndexPath:](self, "_allowsBackdropDecorationForItemPinningConfiguration:atIndexPath:", v15, v17))
      {
...
{
  id v4;
  SUUIStorePageItemPinningConfiguration *v5;
  NSMapTable *indexPathToItemPinningConfiguration;
  NSMapTable *v7;
  NSMapTable *v8;
  ...
  if (v4)
  {
    ...
    v5 = (SUUIStorePageItemPinningConfiguration *)objc_claimAutoreleasedReturnValue();
    if (!v5)
    {
      ...
      {
        v7 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 1);
...
- (id)_itemPinningLayoutInformationForItemAtIndexPath:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      -[SUUIStorePageCollectionViewLayout _calculatePinningLayoutInformation](self, "_calculatePinningLayoutInformation");
...
- (id)_layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:(id)a3 pinningConfiguration:(id)a4 layoutInformation:(id)a5
{
  ...
  -[SUUIStorePageCollectionViewLayout collectionView](self, "collectionView");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  +[UICollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:withIndexPath:](SUUIStorePagePinnedBackdropLayoutAttributes, "layoutAttributesForDecorationViewOfKind:withIndexPath:", 0x2511FF4C8, v8);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "setBackdropGroupName:", self->_backdropGroupName);
  if (!-[SUUIStorePageCollectionViewLayout _allowsBackdropDecorationForItemPinningConfiguration:atIndexPath:](self, "_allowsBackdropDecorationForItemPinningConfiguration:atIndexPath:", v9, v8))
  {
    v13 = 1;
    v14 = 0.0;
    goto LABEL_9;
  ...
  if (v40)
  {
    ...
    v15 = -[SUUIStorePageCollectionViewLayout _pinningTransitionStyleForItemPinningConfiguration:atIndexPath:](self, "_pinningTransitionStyleForItemPinningConfiguration:atIndexPath:", v9, v8);
    if (v15)
    {
      v16 = v15;
      v17 = -[SUUIStorePageCollectionViewLayout _pinnedBackdropViewStyle](self, "_pinnedBackdropViewStyle");
      v18 = v17;
      if (v17)
      {
        if (v17 == 2)
...
- (id)_layoutAttributesForGradientDecorationViewAtIndexPath:(id)a3 currentAttributes:(id)a4
{
  ...
  -[SUUIStorePageCollectionViewLayout layoutAttributesForDecorationViewOfKind:atIndexPath:](self, "layoutAttributesForDecorationViewOfKind:atIndexPath:", 0x25120DD68, v6);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9 >= 2)
  {
    ...
    for (i = 1; i != v9; ++i)
    {
      objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", i, objc_msgSend(v6, "section"));
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIStorePageCollectionViewLayout layoutAttributesForItemAtIndexPath:](self, "layoutAttributesForItemAtIndexPath:", v22);
      v23 = (void *)objc_claimAutoreleasedReturnValue();
...
- (UIEdgeInsets)_pinningContentInsetForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  ...
  if ((objc_msgSend(v6, "hasValidPinningContentInset") & 1) == 0)
  {
    ...
    else
    {
      ...
      v11 = *(double *)(MEMORY[0x24BEBE158] + 24);
    }
...
- (CGRect)_pinningFrameForStartingFrame:(CGRect)a3 itemPinningConfiguration:(id)a4 atIndexPath:(id)a5
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  -[SUUIStorePageCollectionViewLayout _pinningContentInsetForItemPinningConfiguration:atIndexPath:](self, "_pinningContentInsetForItemPinningConfiguration:atIndexPath:", a4, a5);
  v10 = -v9;
  v13 = y - v12;
  v15 = width - (-v11 - v14);
  v16 = height - (v10 - v12);
...
- (CGRect)_targetFrameForStartingFrame:(CGRect)a3 itemPinningConfiguration:(id)a4 layoutInformation:(id)a5 atIndexPath:(id)a6 returningIsPinning:(BOOL *)a7
{
  ...
  double v54;
  CGFloat v55;
  SUUIStorePageCollectionViewLayout *v56;
  double v57;
  double v58;
  double MaxY;
  double v60;
  ...
  v14 = a5;
  v15 = a6;
  -[SUUIStorePageCollectionViewLayout _pinningContentInsetForItemPinningConfiguration:atIndexPath:](self, "_pinningContentInsetForItemPinningConfiguration:atIndexPath:", v13, v15);
  v17 = v16;
  v19 = v18;
  v21 = v20;
  v23 = v22;
  ...
  v28 = v27;
  v29 = -[SUUIStorePageCollectionViewLayout _pinningStyleForItemPinningConfiguration:atIndexPath:](self, "_pinningStyleForItemPinningConfiguration:atIndexPath:", v13, v15);
  v88 = x;
  v30 = -v21;
  v31 = -v23;
  v32 = x - v19;
    ...
    case 1:
      ...
      else
      {
        ...
        else
        {
          ...
          -[SUUIStorePageCollectionViewLayout _itemPinningLayoutInformationForItemAtIndexPath:](self, "_itemPinningLayoutInformationForItemAtIndexPath:", v72);
          v86 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIStorePageCollectionViewLayout _itemPinningConfigurationForItemAtIndexPath:](self, "_itemPinningConfigurationForItemAtIndexPath:", v72);
          v73 = (void *)objc_claimAutoreleasedReturnValue();
          v74 = -[SUUIStorePageCollectionViewLayout _pinningStyleForItemPinningConfiguration:atIndexPath:](self, "_pinningStyleForItemPinningConfiguration:atIndexPath:", v73, v72);
          v43 = 0;
          if (v74 && v74 != 3)
          {
