...
- (SUUITextLayout)initWithLayoutRequest:(id)a3
{
  ...
  v5 = -[SUUITextLayout init](&v22, sel_init);
  if (v5)
  {
      ...
      || (v6 = (const __CFAttributedString *)objc_msgSend((id)objc_opt_class(), "_newAttributedStringWithRequest:", v4)) != 0)
    {
      ...
      if (v19 && v19 < Count)
      {
        ...
        v5->_truncatedSize.width = SUUITextLayoutSizeForCTFrame(v5->_textFrame, v19);
...
- (void)dealloc
{
  ...
  -[SUUITextLayout dealloc](&v5, sel_dealloc);
}
...
+ (__CFAttributedString)_newAttributedStringWithRequest:(id)a3
{
  ...
  v14 = (const __CFDictionary *)objc_msgSend(v13, "initWithObjectsAndKeys:", v12, *MEMORY[0x24BDC4C28], *MEMORY[0x24BDBD270], *MEMORY[0x24BDC4EE8], v4, *MEMORY[0x24BEBB3A8], 0);
