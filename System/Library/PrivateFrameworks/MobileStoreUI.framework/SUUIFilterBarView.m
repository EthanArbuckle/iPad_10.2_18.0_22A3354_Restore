...
void __63__SUUIFilterBarView_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  uint64_t v3;
  void *v4;
  void *v5;
...
void __57__SUUIFilterBarView_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  do
  {
    objc_msgSend(*(id *)(a1 + 40), "childViewElementsForAlignment:", qword_241EFD1A0[v4]);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v36 = 0u;
    v37 = 0u;
    v38 = 0u;
      ...
      for (i = 0; i != v7; ++i)
      {
        ...
        if (v11 <= 68)
        {
          if (v11 > 12)
          {
            ...
            v23 = (SUUISearchBarController *)objc_claimAutoreleasedReturnValue();
            -[SUUISearchBarController addTarget:action:](v23, "addTarget:action:", *(_QWORD *)(a1 + 32), sel__imageTapAction_);
            goto LABEL_37;
          }
          if (v11 != 8)
          {
...
LABEL_29:
        ...
        switch(v11)
        {
          case 'E':
            ...
            goto LABEL_37;
          case 'j':
            v23 = -[SUUISearchBarController initWithSearchBarViewElement:]([SUUISearchBarController alloc], "initWithSearchBarViewElement:", v10);
            objc_msgSend(*(id *)(a1 + 48), "clientContext");
            v24 = (void *)objc_claimAutoreleasedReturnValue();
            -[SUUISearchBarController setClientContext:](v23, "setClientContext:", v24);

            objc_msgSend(*(id *)(a1 + 48), "parentViewController");
            v25 = (void *)objc_claimAutoreleasedReturnValue();
            -[SUUISearchBarController setParentViewController:](v23, "setParentViewController:", v25);
            ...
            -[SUUISearchBarController searchBar](v23, "searchBar");
            v13 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_37:
          ...
          case 'm':
            v12 = v4;
            objc_msgSend(v3, "addReusableViewWithReuseIdentifier:", 0x25120BCA8);
            v13 = (void *)objc_claimAutoreleasedReturnValue();
            v14 = -[SUUISegmentedControlViewElementController initWithViewElement:segmentedControl:]([SUUISegmentedControlViewElementController alloc], "initWithViewElement:segmentedControl:", v10, v13);
            objc_msgSend(*(id *)(a1 + 48), "clientContext");
            v15 = (void *)objc_claimAutoreleasedReturnValue();
            -[SUUISegmentedControlViewElementController setClientContext:](v14, "setClientContext:", v15);

            objc_msgSend(*(id *)(a1 + 48), "parentViewController");
            v16 = (void *)objc_claimAutoreleasedReturnValue();
            -[SUUISegmentedControlViewElementController setParentViewController:](v14, "setParentViewController:", v16);
...
- (void)setContentInset:(UIEdgeInsets)a3
{
    ...
    || a3.bottom != self->_contentInset.bottom)
  {
    ...
    -[SUUIFilterBarView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIFilterBarView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
...
- (void)menuPopover:(id)a3 didSelectMenuItemAtIndex:(int64_t)a4
{
  ...
  if (self->_focusedMenuButton)
  {
    ...
    -[SUUIFilterBarView _destroyMenuPopover](self, "_destroyMenuPopover");
...
- (void)_cancelConfirmationAction:(id)a3
{
  ...
  v4 = a3;
  -[SUUIFilterBarView bringSubviewToFront:](self, "bringSubviewToFront:", v4);
