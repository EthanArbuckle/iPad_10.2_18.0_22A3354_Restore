...
+ (void)createPendingLaunchEvent
{
  ...
  if ((objc_msgSend(MEMORY[0x24BDD17F0], "isMainThread") & 1) == 0)
  {
    ...
    objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("SUUIMetricsAppLaunchEvent.m"), 45, CFSTR("Called off main thread."));

  }
  if ((_HasConsumedPendingLaunchEvent & 1) == 0 && !_PendingLaunchEvent)
  {
    v4 = objc_alloc_init(SUUIMetricsAppLaunchEvent);
    v5 = (void *)_PendingLaunchEvent;
    _PendingLaunchEvent = (uint64_t)v4;
...
{
  SUUIMetricsAppLaunchEvent *v2;
  SUUIMetricsAppLaunchEvent *v3;
  ...
  if (v2)
  {
    -[SSMetricsMutableEvent setEventType:](v2, "setEventType:", CFSTR("appLaunch"));
    ...
    -[SUUIMetricsAppLaunchEvent setLaunchCorrelationKey:](v3, "setLaunchCorrelationKey:", v7);
...
+ (void)withPendingLaunchEvent:(id)a3
{
  ...
  if ((objc_msgSend(MEMORY[0x24BDD17F0], "isMainThread") & 1) == 0)
  {
    objc_msgSend(MEMORY[0x24BDD1448], "currentHandler");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("SUUIMetricsAppLaunchEvent.m"), 53, CFSTR("Called off main thread."));
...
+ (id)consumePendingLaunchEvent
{
  ...
  if ((objc_msgSend(MEMORY[0x24BDD17F0], "isMainThread") & 1) == 0)
  {
    objc_msgSend(MEMORY[0x24BDD1448], "currentHandler");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("SUUIMetricsAppLaunchEvent.m"), 61, CFSTR("Called off main thread."));

  }
  v4 = (id)_PendingLaunchEvent;
...
- (NSString)description
{
  ...
  -[SUUIMetricsAppLaunchEvent launchCorrelationKey](self, "launchCorrelationKey");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR("\nlaunchCorrelationKey = %@"), v5);

  objc_msgSend((id)objc_opt_class(), "processStartTime");
  objc_msgSend(v3, "appendFormat:", CFSTR("\nprocessStartTime = %f"), v6);
  -[SUUIMetricsAppLaunchEvent mainTime](self, "mainTime");
  objc_msgSend(v3, "appendFormat:", CFSTR("\nmainTime = %f"), v7);
  -[SUUIMetricsAppLaunchEvent clientConfigurationLoadTime](self, "clientConfigurationLoadTime");
  ...
  -[SUUIMetricsAppLaunchEvent bootstrapStartTime](self, "bootstrapStartTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\nbootstrapStartTime = %f"), v11, v23, v24, v25, v26);
  -[SUUIMetricsAppLaunchEvent bootstrapEndTime](self, "bootstrapEndTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\nbootstrapEndTime = %f"), v12);
  -[SUUIMetricsAppLaunchEvent jsResourcesStartTime](self, "jsResourcesStartTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\njsResourcesStartTime = %f"), v13);
  -[SUUIMetricsAppLaunchEvent jsResourcesEndTime](self, "jsResourcesEndTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\njsResourcesEndTime = %f"), v14);
  -[SUUIMetricsAppLaunchEvent initialTabRequestStartTime](self, "initialTabRequestStartTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\ninitialTabRequestStartTime = %f"), v15);
  -[SUUIMetricsAppLaunchEvent initialTabResponseStartTime](self, "initialTabResponseStartTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\ninitialTabResponseStartTime = %f"), v16);
  -[SUUIMetricsAppLaunchEvent initialTabResponseEndTime](self, "initialTabResponseEndTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\ninitialTabResponseEndTime = %f"), v17);
  -[SUUIMetricsAppLaunchEvent launchFailureTime](self, "launchFailureTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\nlaunchFailureTime = %f"), v18);
  -[SUUIMetricsAppLaunchEvent launchEndTime](self, "launchEndTime");
  objc_msgSend(v10, "appendFormat:", CFSTR("\nlaunchEndTime = %f"), v19);
  if (-[SUUIMetricsAppLaunchEvent requiredBlockingBagLoad](self, "requiredBlockingBagLoad"))
    v20 = CFSTR("YES");
  else
    v20 = CFSTR("NO");
  objc_msgSend(v10, "appendFormat:", CFSTR("\nrequiredBlockingBagLoad = %@"), v20);
  if (-[SUUIMetricsAppLaunchEvent usedBootstrapFallback](self, "usedBootstrapFallback"))
    v21 = CFSTR("YES");
  else
    v21 = CFSTR("NO");
...
- (void)populateObjectInspector:(id)a3
{
  ...
  *(double *)&aBlock[4] = v5;
  ...
  objc_msgSend(v4, "endSection");
  -[SUUIMetricsAppLaunchEvent templateMetrics](self, "templateMetrics");
  ...
  v29 = v4;
  v30 = v8;
  v31 = &__block_literal_global_117;
  v26 = v4;
  v27 = v8;
...
uint64_t __53__SUUIMetricsAppLaunchEvent_populateObjectInspector___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  void *v5;
  id v6;
  void *v7;
