...
{
  SUUIMediaSocialProfileCoordinator *v2;
  dispatch_queue_t v3;
  ...
  v2 = -[SUUIMediaSocialProfileCoordinator init](&v11, sel_init);
  if (v2)
  {
    ...
    v8 = *MEMORY[0x24BEB20F0];
    objc_msgSend(MEMORY[0x24BEB1D88], "defaultStore");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "addObserver:selector:name:object:", v2, sel__accountStoreChangeNotification_, v8, v9);
...
- (void)dealloc
{
  ...
  -[SUUIMediaSocialProfileCoordinator dealloc](&v6, sel_dealloc);
}
...
void __54__SUUIMediaSocialProfileCoordinator_sharedCoordinator__block_invoke(uint64_t a1)
{
  id v1;
  void *v2;
...
id *__72__SUUIMediaSocialProfileCoordinator_getProfileWithOptions_profileBlock___block_invoke(uint64_t a1)
{
  ...
  if (*(_BYTE *)(v2 + 64))
    return (id *)objc_msgSend((id)v2, "_queueProfileBlock:", *(_QWORD *)(a1 + 48));
  objc_msgSend(*(id *)(a1 + 40), "objectForKey:", CFSTR("SUUIMediaSocialProfileOptionIgnoreCache"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_accountStoreChangeNotification:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BEB1D88], "defaultStore", a3);
  ...
  if (v9)
  {
    if (!self->_waitingForAuthentication)
    {
        ...
        || (-[NSDate timeIntervalSinceNow](lastAuthenticationAttempt, "timeIntervalSinceNow"), v6 > 10.0))
      {
        ...
        v8 = (void *)objc_msgSend(v7, "initWithObjectsAndKeys:", MEMORY[0x24BDBD1C8], CFSTR("SUUIMediaSocialProfileOptionIgnoreCache"), 0);
        -[SUUIMediaSocialProfileCoordinator getProfileWithOptions:profileBlock:](self, "getProfileWithOptions:profileBlock:", v8, 0);
  ...
  {
    -[SUUIMediaSocialProfileCoordinator reset](self, "reset");
  }
...
- (void)_authenticateOnCompletion:(id)a3
{
  ...
  if (v8)
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB1F28]), "initWithAccount:", v8);
  ...
  v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB1DB8]), "initWithAuthenticationContext:", v9);
...
void __63__SUUIMediaSocialProfileCoordinator__authenticateOnCompletion___block_invoke_2(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  uint64_t v4;
...
- (void)_requestProfile
{
  ...
  void *v6;
  SUUIURLBag *v7;
  SUUIMediaSocialProfileOperation *v8;
  uint64_t v9;
  uint64_t v10;
  ...
  if (!self->_operationQueue)
  {
    ...
    -[NSOperationQueue setName:](self->_operationQueue, "setName:", CFSTR("com.apple.iTunesStoreUI.SUUIMediaSocialProfileCoordinator.operationQueue"));
  ...
  objc_msgSend(v5, "setValue:forHTTPHeaderField:", v6, *MEMORY[0x24BEB2518]);

  v7 = -[SSURLBag initWithURLBagContext:]([SUUIURLBag alloc], "initWithURLBagContext:", v5);
  ...
  -[SUUIMediaSocialProfileOperation setOutputBlock:](v8, "setOutputBlock:", &v9);
...
- (void)_fireProfileBlocksWithProfile:(id)a3 isFinal:(BOOL)a4 error:(id)a5
{
  id v8;
  id v9;
  SUUIMediaSocialProfile *v10;
  SUUIMediaSocialProfile *lastKnownProfile;
  NSDate *v12;
  ...
  if (v8)
  {
    v10 = (SUUIMediaSocialProfile *)objc_msgSend(v8, "copy");
...
- (void)_handleOperationResponseWithProfile:(id)a3 error:(id)a4
{
  ...
  _QWORD block[4];
  id v12;
  SUUIMediaSocialProfileCoordinator *v13;
  id v14;
...
void __79__SUUIMediaSocialProfileCoordinator__handleOperationResponseWithProfile_error___block_invoke(id *a1)
{
  ...
  if (objc_msgSend(v2, "isEqualToString:", CFSTR("SUUIErrorDomain")))
  {
    ...
    if (v3 == 3)
    {
      ...
      v5[1] = 3221225472;
      v5[2] = __79__SUUIMediaSocialProfileCoordinator__handleOperationResponseWithProfile_error___block_invoke_2;
      v5[3] = &unk_2511F5590;
