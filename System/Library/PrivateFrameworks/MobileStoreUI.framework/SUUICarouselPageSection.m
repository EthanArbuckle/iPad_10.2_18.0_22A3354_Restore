...
{
  SUUICarouselPageSection *v3;
  SUUICarouselPageSection *v4;
  objc_super v6;
  ...
  v4 = v3;
  if (v3)
    -[SUUICarouselPageSection _reloadViewElementProperties](v3, "_reloadViewElementProperties");
  return v4;
}
...
- (void)addImpressionsForIndexPath:(id)a3 toSession:(id)a4
{
  ...
  v6 = a4;
  if (!-[SUUICarouselPageSection _indexPathIsProgressIndicator:](self, "_indexPathIsProgressIndicator:", a3))
  {
...
- (int64_t)applyUpdateType:(int64_t)a3
{
  ...
  -[SUUICarouselPageSection _reloadViewElementProperties](self, "_reloadViewElementProperties");
...
LABEL_13:
  ...
  return -[SUUIStorePageSection applyUpdateType:](&v19, sel_applyUpdateType_, a3);
}
...
- (id)cellForIndexPath:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[SUUICarouselPageSection _indexPathIsProgressIndicator:](self, "_indexPathIsProgressIndicator:", v4);
  objc_msgSend(v5, "collectionView");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = v7;
  if (v6)
  {
    objc_msgSend(v7, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x2512112E8, v4);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v9, "setContentInset:", *MEMORY[0x24BEBE158], *(double *)(MEMORY[0x24BEBE158] + 8), *(double *)(MEMORY[0x24BEBE158] + 16), *(double *)(MEMORY[0x24BEBE158] + 24));
  ...
  {
    objc_msgSend(v7, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x25120BEC8, v4);
    v9 = (void *)objc_claimAutoreleasedReturnValue();

    -[SUUICarouselPageSection _carouselCollectionView](self, "_carouselCollectionView");
    ...
    if (self->_needsReload)
    {
      ...
      if (reloadIndexPath)
      {
        -[SUUICarouselPageSection _scrollToItemAtIndexPath:animated:](self, "_scrollToItemAtIndexPath:animated:", reloadIndexPath, 0);
    ...
    -[SUUICarouselPageSection _actualContentWidth](self, "_actualContentWidth");
    v19 = v18;
    -[SUUIStorePageSection context](self, "context");
    ...
    -[SUUICarouselPageSection _startCycleTimerIfNecessary](self, "_startCycleTimerIfNecessary");
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  if (-[SUUICarouselPageSection _indexPathIsProgressIndicator:](self, "_indexPathIsProgressIndicator:", v4))
  {
    +[SUUIPageControlCollectionViewCell sizeThatFitsWidth:viewElement:context:](SUUIPageControlCollectionViewCell, "sizeThatFitsWidth:viewElement:context:", self->_progressIndicatorElement, self->_cellLayoutContext, v7);
    height = v8;
  }
  else
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (i = 0; i != v12; ++i)
          {
            ...
            -[objc_class sizeThatFitsWidth:viewElement:context:](-[SUUICarouselPageSection _cellClassForViewElement:](self, "_cellClassForViewElement:", *(_QWORD *)(*((_QWORD *)&v21 + 1) + 8 * i), (_QWORD)v21), "sizeThatFitsWidth:viewElement:context:", *(_QWORD *)(*((_QWORD *)&v21 + 1) + 8 * i), self->_cellLayoutContext, self->_itemSize.width);
            if (v14 < v16)
              v14 = v16;
          }
...
- (void)collectionViewDidEndDisplayingCellForItemAtIndexPath:(id)a3
{
  ...
  if (!-[SUUICarouselPageSection _indexPathIsProgressIndicator:](self, "_indexPathIsProgressIndicator:", v4))
  {
    -[SUUICarouselPageSection _cancelCycleTimer](self, "_cancelCycleTimer");
    -[SUUIStorePageSection pageComponent](self, "pageComponent");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "viewElement");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (int64_t)defaultItemPinningStyle
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SUUICarouselPageSection;
  return -[SUUIStorePageSection defaultItemPinningStyle](&v4, sel_defaultItemPinningStyle);
}
...
- (void)entityProvider:(id)a3 didInvalidateWithContext:(id)a4
{
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[objc_class requestLayoutForViewElement:width:context:](-[SUUICarouselPageSection _cellClassForViewElement:](self, "_cellClassForViewElement:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * v12)), "requestLayoutForViewElement:width:context:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * v12), self->_cellLayoutContext, self->_itemSize.width);
        ++v12;
      }
      while (v10 != v12);
  ...
  v13.receiver = self;
  v13.super_class = (Class)SUUICarouselPageSection;
  -[SUUIStorePageSection entityProvider:didInvalidateWithContext:](&v13, sel_entityProvider_didInvalidateWithContext_, v6, v7);
...
- (void)invalidateCachedLayoutInformation
{
  ...
  -[SUUIStorePageSection invalidateCachedLayoutInformation](&v5, sel_invalidateCachedLayoutInformation);
}
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        if (v6)
        {
          -[objc_class prefetchResourcesForViewElement:reason:context:](-[SUUICarouselPageSection _cellClassForViewElement:](self, "_cellClassForViewElement:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * i)), "prefetchResourcesForViewElement:reason:context:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * i), a3, self->_cellLayoutContext);
        }
        else
        {
          objc_msgSend(*(id *)(*((_QWORD *)&v14 + 1) + 8 * i), "artworkForSize:", self->_itemSize.width, self->_itemSize.height);
          v12 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIViewElementLayoutContext loadImageForArtwork:reason:](self->_cellLayoutContext, "loadImageForArtwork:reason:", v12, a3);
  ...
  if (!v6)
    -[SUUICarouselPageSection _loadMissingItemsFromIndex:withReason:](self, "_loadMissingItemsFromIndex:withReason:", 0, a3);
  v13.receiver = self;
  v13.super_class = (Class)SUUICarouselPageSection;
  -[SUUIStorePageSection prefetchResourcesWithReason:](&v13, sel_prefetchResourcesWithReason_, a3);
...
- (UIEdgeInsets)sectionContentInset
{
  ...
  if (!self->_progressIndicatorElement || self->_progressIndicatorCellIndex != 1)
  {
    ...
    objc_msgSend(v9, "valueForStyle:", *MEMORY[0x24BE518F0]);
    ...
    else
    {
      ...
      if (!v11)
      {
        ...
        -[SUUIStorePageSection sectionContentInset](&v20, sel_sectionContentInset);
        goto LABEL_8;
      }
    }
...
- (void)willAppearInContext:(id)a3
{
  ...
  void *v51;
  void *v52;
  SUUIViewElementLayoutContext *v53;
  objc_super v54;
  __int128 v55;
  __int128 v56;
  __int128 v57;
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x2512112E8);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120BEC8);
  v53 = self->_cellLayoutContext;
  v6 = -[SUUIViewElementLayoutContext initWithStorePageSectionContext:previousLayoutContext:]([SUUIViewElementLayoutContext alloc], "initWithStorePageSectionContext:previousLayoutContext:", v4, v53);
  ...
  -[SUUIViewElementLayoutContext setContainerViewElementType:](self->_cellLayoutContext, "setContainerViewElementType:", objc_msgSend(v9, "elementType"));
  v10 = &OBJC_IVAR___SUUIIPhoneProductPageViewController__banner;
  v11 = &OBJC_IVAR___SUUIIPhoneProductPageViewController__banner;
  v52 = v9;
  if (v9)
  {
    v51 = v5;
    p_itemSize = (float64x2_t *)&self->_itemSize;
    self->_itemSize = (CGSize)*MEMORY[0x24BDBF148];
    ...
    if (v21)
    {
      ...
      do
      {
        for (i = 0; i != v22; ++i)
        {
          ...
          -[objc_class preferredSizeForViewElement:context:](-[SUUICarouselPageSection _cellClassForViewElement:](self, "_cellClassForViewElement:", *(_QWORD *)(*((_QWORD *)&v59 + 1) + 8 * i)), "preferredSizeForViewElement:context:", *(_QWORD *)(*((_QWORD *)&v59 + 1) + 8 * i), self->_cellLayoutContext);
          v26.f64[1] = v25;
    ...
    if (v28)
    {
      ...
      do
      {
        for (j = 0; j != v29; ++j)
        {
          ...
          -[objc_class requestLayoutForViewElement:width:context:](-[SUUICarouselPageSection _cellClassForViewElement:](self, "_cellClassForViewElement:", *(_QWORD *)(*((_QWORD *)&v55 + 1) + 8 * j)), "requestLayoutForViewElement:width:context:", *(_QWORD *)(*((_QWORD *)&v55 + 1) + 8 * j), self->_cellLayoutContext, p_itemSize->f64[0]);
        }
  ...
  {
    -[SUUICarouselPageSection _reloadLegacySizing](self, "_reloadLegacySizing");
  }
  ...
  if (v38)
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", 20000 / v39 * v39, 0);
    ...
    if (v46)
    {
      ...
      {
        -[SUUICarouselPageSection _scrollToItemAtIndexPath:animated:](self, "_scrollToItemAtIndexPath:animated:", v46, 0);
      }
    }
  ...
  -[SUUIStorePageSection willAppearInContext:](&v54, sel_willAppearInContext_, v4);
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  if (v8 >= 1)
  {
    ...
    {
      -[SUUICarouselPageSection _reloadLegacySizing](self, "_reloadLegacySizing");
      -[SUUICarouselPageSection prefetchResourcesWithReason:](self, "prefetchResourcesWithReason:", 0);
    }
    v24 = v21 % (uint64_t)v9;
    -[SUUIStorePageSection context](self, "context");
    ...
    v39[1] = 3221225472;
    v39[2] = __74__SUUICarouselPageSection_willTransitionToSize_withTransitionCoordinator___block_invoke;
    v39[3] = &unk_2511F6FA8;
    v42 = v27;
    v40 = v10;
    v41 = self;
    ...
    v38[0] = v34;
    v38[1] = 3221225472;
    v38[2] = __74__SUUICarouselPageSection_willTransitionToSize_withTransitionCoordinator___block_invoke_2;
    v38[3] = &unk_2511F4640;
    v38[4] = self;
  ...
  v37.receiver = self;
  v37.super_class = (Class)SUUICarouselPageSection;
  -[SUUIStorePageSection willTransitionToSize:withTransitionCoordinator:](&v37, sel_willTransitionToSize_withTransitionCoordinator_, v7, width, height);
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  if (v12)
  {
    -[SUUICarouselPageSection _dequeueCellForViewElement:collectionView:indexPath:](self, "_dequeueCellForViewElement:collectionView:indexPath:", v10, v7, v6);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v7, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x251205968, v6);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v16)
      -[SUUICarouselPageSection _addImpressionForIndex:toSession:](self, "_addImpressionForIndex:toSession:", v9, v16);
    -[SUUICarouselPageSection _loadMissingItemsFromIndex:withReason:](self, "_loadMissingItemsFromIndex:withReason:", v9, 1);
...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  else
  {
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIStorePageSection clickEventWithLink:elementName:index:](self, "clickEventWithLink:elementName:index:", v12, *MEMORY[0x24BEB2970], v9);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if (v13)
    {
      -[SUUIStorePageSection context](self, "context");
...
{
  return -[SUUICarouselPageSection _isItemEnabledAtIndexPath:](self, "_isItemEnabledAtIndexPath:", a4);
}
...
- (void)scrollViewDidEndDecelerating:(id)a3
{
  ...
  if (self->_progressIndicatorElement)
  {
    ...
    objc_msgSend(v4, "collectionView");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", self->_progressIndicatorCellIndex, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUICarouselPageSection _startCycleTimerIfNecessary](self, "_startCycleTimerIfNecessary", a3);
}
...
{
  UICollectionView *carouselCollectionView;
  SUUICarouselCollectionViewLayout *v4;
  id v5;
  UICollectionView *v6;
  UICollectionView *v7;
  void *v8;
  ...
  if (!carouselCollectionView)
  {
    ...
    -[UICollectionView registerClass:forCellWithReuseIdentifier:](self->_carouselCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251211FE8);
    -[UICollectionView registerClass:forCellWithReuseIdentifier:](self->_carouselCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251209A48);
    -[UICollectionView registerClass:forCellWithReuseIdentifier:](self->_carouselCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251210428);
    -[UICollectionView registerClass:forCellWithReuseIdentifier:](self->_carouselCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251205968);
    -[UICollectionView registerClass:forCellWithReuseIdentifier:](self->_carouselCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251211F68);
    -[UICollectionView registerClass:forCellWithReuseIdentifier:](self->_carouselCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120A268);
    ...
    -[SUUICarouselPageSection backgroundColorForIndexPath:](self, "backgroundColorForIndexPath:", v8);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (Class)_cellClassForViewElement:(id)a3
{
  ...
  if (v5 > 65)
  {
    if (v5 == 66)
    {
      -[SUUICarouselPageSection _cellClassForLockup:](self, "_cellClassForLockup:", v4);
...
- (id)_dequeueCellForLockup:(id)a3 collectionView:(id)a4 indexPath:(id)a5
{
  ...
  {
    objc_msgSend(v7, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", *off_2511F8630[v9], v8);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (id)_dequeueCellForViewElement:(id)a3 collectionView:(id)a4 indexPath:(id)a5
{
  ...
  if (v11 <= 48)
  {
    if (v11 == 14)
    {
      objc_msgSend(v9, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x251211FE8, v10);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v11 == 28)
    {
      v13 = CFSTR("SUUICounterReuseIdentifier");
      goto LABEL_9;
    }
  }
  else
  {
    switch(v11)
    {
      case 49:
        goto LABEL_5;
      case 66:
        -[SUUICarouselPageSection _dequeueCellForLockup:collectionView:indexPath:](self, "_dequeueCellForLockup:collectionView:indexPath:", v8, v9, v10);
        v14 = objc_claimAutoreleasedReturnValue();
        goto LABEL_11;
      case 152:
LABEL_5:
        v13 = CFSTR("SUUIImageReuseIdentifier");
LABEL_9:
...
- (void)_fireCycleTimer
{
  ...
  objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", v9 + 1, 0);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUICarouselPageSection _scrollToItemAtIndexPath:animated:](self, "_scrollToItemAtIndexPath:animated:", v10, 1);
...
- (void)_loadMissingItemsFromIndex:(int64_t)a3 withReason:(int64_t)a4
{
  ...
  {
    -[SUUICarouselPageSection _missingItemLoader](self, "_missingItemLoader");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadLegacySizing
{
  ...
  -[SUUICarouselPageSection _legacyItemSize](self, "_legacyItemSize");
  p_itemSize->width = v4;
  p_itemSize->height = v5;
  -[SUUICarouselPageSection _legacyItemSpacing](self, "_legacyItemSpacing");
  self->_itemSpacing = v6;
  v7 = 1.0;
  if (v6 <= 0.00000011920929)
    v7 = 0.0;
  cellLayoutContext = self->_cellLayoutContext;
  objc_msgSend(MEMORY[0x24BDD1968], "valueWithUIEdgeInsets:", 0.0, v7, 1.0, v7);
  v9 = (id)objc_claimAutoreleasedReturnValue();
  -[SUUIViewElementLayoutContext setAggregateValue:forKey:](cellLayoutContext, "setAggregateValue:forKey:", v9, 0x251205948);
...
- (void)_reloadViewElementProperties
{
  ...
  NSArray *v8;
  NSArray *modelObjects;
  SUUIProgressIndicatorViewElement *v10;
  SUUIProgressIndicatorViewElement *progressIndicatorElement;
  NSArray *v12;
  NSArray *v13;
  void *v14;
  ...
  if (v3)
  {
    ...
    v10 = (SUUIProgressIndicatorViewElement *)objc_claimAutoreleasedReturnValue();
    progressIndicatorElement = self->_progressIndicatorElement;
  ...
  -[SUUIProgressIndicatorViewElement style](self->_progressIndicatorElement, "style");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_startCycleTimerIfNecessary
{
  ...
  if (!self->_cycleTimer)
  {
    ...
    if (v5 > 2.22044605e-16)
    {
      ...
      if (v7 > v10)
      {
        v11 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, MEMORY[0x24BDAC9B8]);
        cycleTimer = self->_cycleTimer;
