...
- (SUUIBadgeTextAttachment)initWithViewElement:(id)a3
{
  ...
  v5 = -[SUUIBadgeTextAttachment init](&v24, sel_init);
  if (v5)
  {
    ...
    else
    {
      ...
      if (v7 && !objc_msgSend(MEMORY[0x24BDD17F0], "isMainThread"))
      {
        ...
        -[SUUIBadgeTextAttachment setImageLoadingSemaphore:](v5, "setImageLoadingSemaphore:", v17);
      ...
      {
        -[SUUIBadgeTextAttachment _loadImageWithResourceName:fallbackImage:styleColor:](v5, "_loadImageWithResourceName:fallbackImage:styleColor:", v7, v6, v10);
      }
...
- (unint64_t)hash
{
  ...
  -[SUUIBadgeTextAttachment _ensureImageIsLoaded](self, "_ensureImageIsLoaded");
  v3 = -[NSURL hash](self->_imageURL, "hash");
  -[SUUIBadgeTextAttachment bounds](self, "bounds");
  v8 = (unint64_t)((double)(unint64_t)((double)(unint64_t)((double)(unint64_t)((double)v3 + v4 * 10.0)
                                                                              + v5 * 100.0)
                                                   + v6 * 1000.0)
                        + v7 * 10000.0);
  -[SUUIBadgeTextAttachment image](self, "image");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v12 = v11;
      v14 = v13;
      -[SUUIBadgeTextAttachment bounds](v5, "bounds");
      v24.origin.x = v15;
      v24.origin.y = v16;
      v24.size.width = v17;
      v24.size.height = v18;
      ...
      {
        -[SUUIBadgeTextAttachment _ensureImageIsLoaded](self, "_ensureImageIsLoaded");
        -[SUUIBadgeTextAttachment _ensureImageIsLoaded](v5, "_ensureImageIsLoaded");
        -[SUUIBadgeTextAttachment image](self, "image");
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        -[SUUIBadgeTextAttachment image](v5, "image");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SUUIBadgeTextAttachment _ensureImageIsLoaded](self, "_ensureImageIsLoaded", a3);
  ...
  -[SUUIBadgeTextAttachment setImage:](v4, "setImage:", v5);
...
- (void)_ensureImageIsLoaded
{
  ...
  -[SUUIBadgeTextAttachment imageLoadingSemaphore](self, "imageLoadingSemaphore");
...
LABEL_14:
  ...
  -[SUUIBadgeTextAttachment setImage:](self, "setImage:", v11);
  -[SUUIBadgeTextAttachment imageLoadingSemaphore](self, "imageLoadingSemaphore");
  ...
  if (v13)
  {
    ...
    -[SUUIBadgeTextAttachment setImageLoadingSemaphore:](self, "setImageLoadingSemaphore:", 0);
  }
