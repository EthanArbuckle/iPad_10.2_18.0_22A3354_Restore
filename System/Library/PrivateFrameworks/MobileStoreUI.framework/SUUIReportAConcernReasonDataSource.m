...
{
  id v3;
  SUUIReportAConcernReasonDataSource *v4;

  v3 = objc_alloc_init(MEMORY[0x24BEBD9F0]);
  v4 = -[SUUIReportAConcernReasonDataSource initWithTableView:](self, "initWithTableView:", v3);
...
{
  id v5;
  SUUIReportAConcernReasonDataSource *v6;
  SUUIReportAConcernReasonDataSource *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUUIReportAConcernReasonDataSource;
  v6 = -[SUUIReportAConcernReasonDataSource init](&v9, sel_init);
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_tableView, a3);
    objc_msgSend(v5, "registerClass:forCellReuseIdentifier:", objc_opt_class(), CFSTR("SUUIConcernReasonCell"));
  }
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  -[SUUIReportAConcernReasonDataSource reasons](self, "reasons", a3, a4);
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SUUIReportAConcernReasonDataSource reasons](self, "reasons");
  ...
  objc_msgSend(v7, "dequeueReusableCellWithIdentifier:", CFSTR("SUUIConcernReasonCell"));
