...
- (SUUISuggestedHandlesSettingsHeaderFooterDescription)initWithSuggestedHandles:(id)a3 clientContext:(id)a4 delegate:(id)a5
{
  ...
  id v9;
  id v10;
  SUUISuggestedHandlesSettingsHeaderFooterDescription *v11;
  SUUISuggestedHandlesSettingsHeaderFooterDescription *v12;
  uint64_t v13;
  ...
  v9 = a4;
  v10 = a5;
  v11 = -[SUUISuggestedHandlesSettingsHeaderFooterDescription init](self, "init");
  v12 = v11;
  if (v11)
  {
...
LABEL_9:
    +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", v7, 0, CFSTR("Settings"));
...
LABEL_6:
  -[SUUIClientContext localizedStringForKey:inTable:](clientContext, "localizedStringForKey:inTable:", v5, CFSTR("Settings"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  return v6;
}
...
{
  return (SUUISuggestedHandlesSettingsHeaderFooterDescriptionDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
