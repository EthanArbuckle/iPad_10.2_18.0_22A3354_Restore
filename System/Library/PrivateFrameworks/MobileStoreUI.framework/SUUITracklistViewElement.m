...
- (SUUIHeaderViewElement)header
{
  ...
  v11 = 0;
  -[SUUITracklistViewElement children](self, "children");
...
- (NSArray)sections
{
  ...
  v7 = (NSMutableArray *)-[NSMutableArray count](sections, "count");
  if (v7)
    v7 = self->_sections;
  return (NSArray *)v7;
}
...
- (NSArray)tracks
{
  ...
  v7 = (NSMutableArray *)-[NSMutableArray count](tracks, "count");
  if (v7)
    v7 = self->_tracks;
  return (NSArray *)v7;
}
...
- (id)applyUpdatesWithElement:(id)a3
{
  ...
  v4 = (SUUITracklistViewElement *)a3;
