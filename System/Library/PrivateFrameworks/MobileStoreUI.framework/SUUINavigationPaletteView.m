...
- (void)setVerticalAlignment:(int64_t)a3
{
  if (self->_verticalAlignment != a3)
  {
    ...
    -[SUUINavigationPaletteView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
void __76__SUUINavigationPaletteView_prefetchResourcesForViewElement_reason_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_msgSend(v3, "elementType") == 62)
    v4 = +[SUUIHorizontalListScrollView prefetchResourcesForViewElement:reason:context:](SUUIHorizontalListScrollView, "prefetchResourcesForViewElement:reason:context:", v3, *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 32));
  else
...
LABEL_13:
    ...
    v5 = SUUIHorizontalListScrollView;
LABEL_11:
...
void __65__SUUINavigationPaletteView_reloadWithViewElement_width_context___block_invoke_2(uint64_t a1, void *a2)
{
  uint64_t v3;
  id v4;
  SUUISegmentedControlViewElementController *v5;
  void *v6;
  void *v7;
  id v8;
  void *v9;
...
LABEL_15:
    ...
    if (v3 == 62)
    {
      objc_msgSend(*(id *)(a1 + 32), "addReusableViewWithReuseIdentifier:", 0x25120BB88);
    ...
    else
    {
      if (v3 != 109)
        goto LABEL_12;
      v5 = -[SUUISegmentedControlViewElementController initWithViewElement:]([SUUISegmentedControlViewElementController alloc], "initWithViewElement:", v28);
      objc_msgSend(*(id *)(a1 + 40), "clientContext");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUISegmentedControlViewElementController setClientContext:](v5, "setClientContext:", v6);

      objc_msgSend(*(id *)(a1 + 40), "parentViewController");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUISegmentedControlViewElementController setParentViewController:](v5, "setParentViewController:", v7);

      -[SUUISegmentedControlViewElementController segmentedControlView](v5, "segmentedControlView");
      v4 = (id)objc_claimAutoreleasedReturnValue();
...
LABEL_22:
    ...
    objc_msgSend(*(id *)(a1 + 32), "addReusableViewWithReuseIdentifier:", 0x25120AA68);
...
LABEL_23:
  ...
  if (v8)
  {
    ...
    if (v19)
    {
      ...
      if (!v20)
      {
        v21 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 1);
        v22 = *(_QWORD *)(a1 + 48);
        v23 = *(void **)(v22 + 472);
        *(_QWORD *)(v22 + 472) = v21;
...
LABEL_13:
        ...
        if (objc_msgSend(v9, "conformsToProtocol:", &unk_2571AB4A8))
        {
...
- (void)layoutSubviews
{
  ...
  -[SUUINavigationPaletteView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
...
+ (CGSize)_sizeForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (v9 == 109)
  {
    ...
    v10 = objc_alloc_init(MEMORY[0x24BEBD938]);
    objc_msgSend(v10, "sizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
    v11 = v14;
    goto LABEL_6;
  }
  if (v9 == 62)
  {
    +[SUUIHorizontalListScrollView sizeThatFitsWidth:viewElement:context:](SUUIHorizontalListScrollView, "sizeThatFitsWidth:viewElement:context:", v7, v8, a4);
LABEL_9:
    v13 = v15;
    v11 = v16;
    goto LABEL_10;
