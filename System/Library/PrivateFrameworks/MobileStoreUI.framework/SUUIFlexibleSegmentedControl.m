...
{
  SUUIFlexibleSegmentedControl *v3;
  ...
  if (v3)
  {
    ...
    v5 = (UISegmentedControl *)objc_alloc_init(MEMORY[0x24BEBD938]);
    segmentedControl = v4->_segmentedControl;
    v4->_segmentedControl = v5;

    -[UISegmentedControl addTarget:action:forControlEvents:](v4->_segmentedControl, "addTarget:action:forControlEvents:", v4, sel__valueChangeAction_, 4096);
    -[UISegmentedControl setSemanticContentAttribute:](v4->_segmentedControl, "setSemanticContentAttribute:", storeSemanticContentAttribute());
    -[SUUIFlexibleSegmentedControl addSubview:](v4, "addSubview:", v4->_segmentedControl);
  }
  return v4;
}
...
- (void)dealloc
{
  ...
  -[SUUIFlexibleSegmentedControl dealloc](&v3, sel_dealloc);
}
...
- (void)cancelMoreList
{
  if (self->_isMoreListSelected)
  {
    ...
    -[SUUIFlexibleSegmentedControl setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIFlexibleSegmentedControl bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  ...
  *(double *)&v18[8] = v5;
  ...
  v13 = -[SUUIFlexibleSegmentedControl moreListIndex](self, "moreListIndex");
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  height = a3.height;
  width = a3.width;
  v6 = objc_alloc_init(MEMORY[0x24BEBD938]);
...
- (void)_valueChangeAction:(id)a3
{
  ...
  v4 = -[SUUIFlexibleSegmentedControl moreListIndex](self, "moreListIndex");
  selectedSegmentIndex = self->_selectedSegmentIndex;
...
- (void)_configureSegmentedControl:(id)a3 withTitles:(id)a4 boundingSize:(CGSize)a5
{
  ...
  v18 = *(double *)(MEMORY[0x24BDBF028] + 16);
  v19 = *(double *)(MEMORY[0x24BDBF028] + 24);
  while (1)
  {
    -[SUUIFlexibleSegmentedControl _setTitles:forSegmentedControl:](self, "_setTitles:forSegmentedControl:", v9, v35);
  ...
  if (v21 >= width)
    ...
    v30 = v21;
  objc_msgSend(v35, "setFrame:", *MEMORY[0x24BDBF090], *(double *)(MEMORY[0x24BDBF090] + 8), v30, v23);
  objc_msgSend(v9, "lastObject");
...
{
  return (SUUIFlexibleSegmentedControlDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
