...
- (SUUIViewReusePool)initWithParentView:(id)a3
{
  ...
  v4 = -[SUUIViewReusePool init](&v9, sel_init);
  if (v4)
  {
...
- (id)dequeueReusableViewWithReuseIdentifier:(id)a3
{
  ...
  {
    v8 = -[SUUIViewReusePool viewClassWithReuseIdentifier:](self, "viewClassWithReuseIdentifier:", v6);
    if (v8)
    {
...
uint64_t __60__SUUIViewReusePool_dequeueReusableViewWithReuseIdentifier___block_invoke(uint64_t a1, id object)
{
  ...
  objc_getAssociatedObject(object, "com.apple.iTunesStoreUI.viewReuse.ID");
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        objc_getAssociatedObject(v10, "com.apple.iTunesStoreUI.viewReuse.ID");
        ...
        if (objc_msgSend(v10, "conformsToProtocol:", &unk_2571B9960))
...
- (Class)viewClassWithReuseIdentifier:(id)a3
{
  ...
  v5 = (void *)objc_msgSend((id)_SUUIViewReusePoolGetCommonReuseClasses_commonReuseClasses, "objectForKeyedSubscript:", v4);
  if (!v5)
