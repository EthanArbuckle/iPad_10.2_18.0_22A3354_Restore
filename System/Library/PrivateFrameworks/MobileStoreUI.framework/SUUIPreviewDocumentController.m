...
{
  id v5;
  SUUIPreviewDocumentController *v6;
  SUUIPreviewDocumentController *v7;
  void *v8;
  objc_super v10;
  ...
  v6 = -[SUUIPreviewDocumentController init](&v10, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    objc_msgSend(v8, "addObserver:selector:name:object:", v7, sel__playerSessionsDidChangeNotification_, *MEMORY[0x24BEC8E40], 0);
    -[SUUIPreviewDocumentController _connectToAudioPlayer](v7, "_connectToAudioPlayer");
...
- (void)dealloc
{
  ...
  objc_msgSend(v3, "removeObserver:name:object:", self, *MEMORY[0x24BEC8E40], 0);
  ...
  -[SUUIPreviewDocumentController dealloc](&v4, sel_dealloc);
}
...
{
  SUUIPreviewOverlayViewController *v5;
  void *v6;
  void *v7;
  ...
  v5 = -[SUUIPreviewOverlayViewController initWithDocument:]([SUUIPreviewOverlayViewController alloc], "initWithDocument:", self->_document);
  -[SUUIPreviewOverlayViewController setBackgroundStyle:](v5, "setBackgroundStyle:", a3);
  -[SUUIViewController setClientContext:](v5, "setClientContext:", self->_clientContext);
  -[SUUIPreviewDocumentController _operationQueue](self, "_operationQueue");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIViewController setOperationQueue:](v5, "setOperationQueue:", v6);

  -[SUUIPreviewOverlayViewController prepareOverlayView](v5, "prepareOverlayView");
  -[SUAudioPlayer playerStatus](self->_audioPlayer, "playerStatus");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIPreviewOverlayViewController showPreviewProgressWithStatus:animated:](v5, "showPreviewProgressWithStatus:animated:", v7, 0);

  viewControllers = self->_viewControllers;
  if (!viewControllers)
  {
    v9 = (NSHashTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD15C0]), "initWithOptions:capacity:", 517, 0);
...
- (void)_audioPlayerStatusChangeNotification:(id)a3
{
  ...
  if (v4 == audioPlayer)
  {
    ...
    -[SUUIPreviewDocumentController _reloadViewControllersWithPreviewStatus:animated:](self, "_reloadViewControllersWithPreviewStatus:animated:", v6, 1);
...
- (void)_playerSessionsDidChangeNotification:(id)a3
{
  ...
  v4 = -[SUUIPreviewDocumentController isPreviewActive](self, "isPreviewActive", a3);
  -[SUUIPreviewDocumentController _connectToAudioPlayer](self, "_connectToAudioPlayer");
  if (v4 != -[SUUIPreviewDocumentController isPreviewActive](self, "isPreviewActive"))
  {
    objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
    v5 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "postNotificationName:object:userInfo:", CFSTR("SUUIPreviewDocumentIsActiveDidChangeNotification"), self, 0);
...
- (void)_connectToAudioPlayer
{
  ...
  if (v4 != self->_audioPlayer)
  {
    ...
    v10 = v9;
    v11 = (_QWORD *)MEMORY[0x24BEC8E48];
    if (*p_audioPlayer)
      objc_msgSend(v9, "removeObserver:name:object:", self, *MEMORY[0x24BEC8E48]);
    ...
    -[SUUIPreviewDocumentController _reloadViewControllersWithPreviewStatus:animated:](self, "_reloadViewControllersWithPreviewStatus:animated:", v13, 0);
