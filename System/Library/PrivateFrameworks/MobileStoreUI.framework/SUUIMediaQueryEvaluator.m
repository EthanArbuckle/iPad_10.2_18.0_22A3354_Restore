...
- (SUUIMediaQueryEvaluator)init
{
  ...
  v2 = -[SUUIMediaQueryEvaluator init](&v8, sel_init);
  if (v2)
  {
...
- (void)dealloc
{
  ...
  -[SUUIMediaQueryEvaluator dealloc](&v10, sel_dealloc);
}
...
- (BOOL)evaluateMediaQuery:(id)a3
{
  ...
  if (objc_msgSend(v9, "count"))
  {
    ...
    {
      -[SUUIMediaQueryEvaluator _delegateValuesForKeys:](v11, "_delegateValuesForKeys:", v10);
...
- (void)reloadData
{
  ...
  {
    -[SUUIMediaQueryEvaluator _delegateValuesForKeys:](self, "_delegateValuesForKeys:", v6);
...
void __57__SUUIMediaQueryEvaluator__featureDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  {
    v2 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, *(dispatch_queue_t *)(a1 + 40));
    v3 = *(_QWORD *)(a1 + 32);
    v4 = *(void **)(v3 + 32);
    *(_QWORD *)(v3 + 32) = v2;
...
{
  return (SUUIMediaQueryDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
