...
- (SUUIProductPagePlaceholderView)initWithPlaceholderString:(id)a3 isPad:(BOOL)a4
{
  _BOOL4 v4;
  id v6;
  SUUIProductPagePlaceholderView *v7;
  void *v8;
  id v9;
  void *v10;
  uint64_t v11;
  ...
  v7 = -[SUUIProductPagePlaceholderView init](&v21, sel_init);
  if (v7)
  {
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = objc_alloc(MEMORY[0x24BEBD668]);
    objc_msgSend(MEMORY[0x24BEBD640], "imageNamed:inBundle:", CFSTR("RelatedProxyGraphicApp"), v8);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = objc_msgSend(v9, "initWithImage:", v10);
    imageView = v7->_imageView;
    v7->_imageView = (UIImageView *)v11;

    -[SUUIProductPagePlaceholderView addSubview:](v7, "addSubview:", v7->_imageView);
    ...
    v15 = v7->_label;
    objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithWhite:alpha:", 0.384313732, 1.0);
    ...
    if (v4)
      v18 = 18.0;
    objc_msgSend(MEMORY[0x24BEBB520], "systemFontOfSize:", v18);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setFont:](v17, "setFont:", v19);

    -[UILabel sizeToFit](v7->_label, "sizeToFit");
    -[SUUIProductPagePlaceholderView addSubview:](v7, "addSubview:", v7->_label);
...
- (void)layoutSubviews
{
  ...
  -[SUUIProductPagePlaceholderView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIProductPagePlaceholderView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
