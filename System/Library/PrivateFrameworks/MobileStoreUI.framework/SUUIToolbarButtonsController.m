...
- (SUUIToolbarButtonsController)initWithToolbarViewElement:(id)a3
{
  ...
  v6 = -[SUUIToolbarButtonsController init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (id)addButtonItemWithButtonViewElement:(id)a3
{
  ...
  -[SUUIToolbarButtonsController _updateButtonItem:withButtonViewElement:](self, "_updateButtonItem:withButtonViewElement:", v5, v4);
  buttonItemElements = self->_buttonItemElements;
  if (!buttonItemElements)
  {
    v7 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 512, 512, 0);
