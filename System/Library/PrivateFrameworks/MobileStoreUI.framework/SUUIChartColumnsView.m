...
- (SUUIChartColumnsView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    v4 = objc_msgSend(objc_alloc(MEMORY[0x24BEBDB00]), "initWithFrame:", 0.0, 0.0, 0.0, 44.0);
    headerBackgroundView = v3->_headerBackgroundView;
    v3->_headerBackgroundView = (UIView *)v4;

    -[SUUIChartColumnsView addSubview:](v3, "addSubview:", v3->_headerBackgroundView);
    ...
    -[UIView addSubview:](v3->_headerBackgroundView, "addSubview:", v3->_effectView);
    ...
    -[SUUIChartColumnsView addSubview:](v3, "addSubview:", v3->_borderView0);
    ...
    -[SUUIChartColumnsView addSubview:](v3, "addSubview:", v3->_borderView1);
    ...
    -[UIView addSubview:](v3->_headerBackgroundView, "addSubview:", v3->_headerBackgroundBottomBorder);
  }
  return v3;
}
...
- (void)dealloc
{
  ...
  -[SUUIChartColumnsView dealloc](&v3, sel_dealloc);
}
...
- (void)beginColumnChangeAnimationToNumberOfVisibleColumns:(int64_t)a3
{
  ...
  if (!columnChangeAnimationCount)
  {
    ...
    if (self->_numberOfVisibleColumns >= a3)
    {
      ...
      -[SUUIChartColumnsView setNeedsLayout](self, "setNeedsLayout");
    }
    else
    {
      -[SUUIChartColumnsView _reloadColumnViews](self, "_reloadColumnViews");
      -[SUUIChartColumnsView layoutIfNeeded](self, "layoutIfNeeded");
    }
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIChartColumnsView layoutSubviews](&v39, sel_layoutSubviews);
  -[SUUIChartColumnsView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  ...
  v15 = -[SUUIChartColumnsView numberOfVisibleColumns](self, "numberOfVisibleColumns");
  if (v14 >= v15)
    v16 = v15;
  else
    v16 = v14;
  ...
  -[SUUIFlexibleSegmentedControl setHidden:](self->_segmentedControl, "setHidden:", v16 > 1);
  v19 = 1.0 / v13;
  if (v16 > 1)
    goto LABEL_13;
  ...
  if (segmentedControl)
  {
    -[SUUIFlexibleSegmentedControl frame](segmentedControl, "frame");
    -[SUUIFlexibleSegmentedControl sizeThatFits:](self->_segmentedControl, "sizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
    if (v22 >= v8 + -30.0)
      v24 = v8 + -30.0;
    else
      v24 = v22;
...
- (id)_headerViewWithViewControllers:(id)a3
{
  ...
  -[SUUIChartColumnHeaderView addTarget:action:forControlEvents:](v5, "addTarget:action:forControlEvents:", self, sel__headerViewAction_, 4096);
  objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIChartColumnHeaderView setBackgroundColor:](v5, "setBackgroundColor:", v6);

  -[SUUIChartColumnHeaderView sizeToFit](v5, "sizeToFit");
  ...
  -[SUUIChartColumnHeaderView setTitles:](v5, "setTitles:", v7);
  return v5;
}
...
- (void)_reloadColumnViews
{
  ...
  void *v17;
  void *v18;
  SUUIFlexibleSegmentedControl *v19;
  SUUIChartColumnsView *v20;
  SUUIFlexibleSegmentedControl *segmentedControl;
  uint64_t v22;
  void *v23;
  SUUIChartColumnsView *v24;
  uint64_t k;
  void *v26;
  SUUIIPadChartsColumnView *v27;
  id v28;
  uint64_t v29;
  uint64_t v30;
  uint64_t v31;
  ...
  v49 = (NSArray *)objc_alloc_init(MEMORY[0x24BDBCEB8]);
  ...
  if (v56->_columnChangeAnimationCount <= 0)
    v11 = &OBJC_IVAR___SUUIChartColumnsView__numberOfVisibleColumns;
  else
    v11 = &OBJC_IVAR___SUUIChartColumnsView__animatingToNumberOfVisibleColumns;
  ...
  if (v12 >= 1)
  {
    ...
    for (j = 0; j != v13; ++j)
    {
      ...
      {
        v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithObjects:", v15, 0);
        v16 = v4;
        v18 = v17;
      }
      else
  ...
  {
    v19 = objc_alloc_init(SUUIFlexibleSegmentedControl);
    v20 = v56;
    segmentedControl = v56->_segmentedControl;
    v56->_segmentedControl = v19;

    -[SUUIFlexibleSegmentedControl setDelegate:](v20->_segmentedControl, "setDelegate:", v20);
  ...
  if (v54)
  {
    ...
    do
    {
      for (k = 0; k != v54; ++k)
      {
        ...
        v27 = objc_alloc_init(SUUIIPadChartsColumnView);
        ...
        -[SUUIIPadChartsColumnView setContentViewControllers:](v27, "setContentViewControllers:", v26);
        v68 = 0u;
        v69 = 0u;
        v66 = 0u;
        v67 = 0u;
        ...
        if (v29)
        {
          ...
          while (2)
          {
            for (m = 0; m != v30; ++m)
            {
              ...
              {
                v22 = v33;
                -[SUUIIPadChartsColumnView setSelectedViewControllerIndex:](v27, "setSelectedViewControllerIndex:", v33);
                goto LABEL_37;
              }
            }
...
LABEL_37:
        ...
        {
          -[SUUIChartColumnsView _headerViewWithViewControllers:](v24, "_headerViewWithViewControllers:", v26);
        ...
        -[SUUIChartColumnsView insertSubview:belowSubview:](v24, "insertSubview:belowSubview:", v27, v24->_headerBackgroundView);
  ...
  -[SUUIFlexibleSegmentedControl setItemTitles:](v24->_segmentedControl, "setItemTitles:", v51);
  if (v22 != 0x7FFFFFFFFFFFFFFFLL)
    -[SUUIFlexibleSegmentedControl setSelectedSegmentIndex:](v24->_segmentedControl, "setSelectedSegmentIndex:", v22);
