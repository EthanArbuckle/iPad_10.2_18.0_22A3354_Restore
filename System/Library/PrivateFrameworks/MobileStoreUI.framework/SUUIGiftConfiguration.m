...
- (SUUIGiftConfiguration)initWithOperationQueue:(id)a3 clientContext:(id)a4
{
  id v7;
  id v8;
  SUUIGiftConfiguration *v9;
  SUUIGiftConfiguration *v10;
  objc_super v12;
  ...
  v9 = -[SUUIGiftConfiguration init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (void)loadConfigurationWithCompletionBlock:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SUUIGiftConfiguration.m"), 99, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block != nil"));
  ...
  v9 = v6;
  v12 = v9;
  objc_msgSend(v7, "loadValueForKey:completionBlock:", CFSTR("giftPageData"), v11);
...
- (void)loadLogoForCharity:(id)a3
{
  ...
  if (!v7)
  {
    ...
    if (v9)
    {
      v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2040]), "initWithURL:", v9);
...
- (void)_finishLoadWithResponse:(id)a3 error:(id)a4 block:(id)a5
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
      ...
      if (v12)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v16 = -[SUUIGiftCharity initWithCharityDictionary:]([SUUIGiftCharity alloc], "initWithCharityDictionary:", v15);
              ...
              do
              {
                ...
                if ((objc_opt_isKindOfClass() & 1) != 0)
                {
                  ...
                  if ((objc_opt_isKindOfClass() & 1) != 0 && (objc_opt_respondsToSelector() & 1) != 0)
                  {
                    ...
                    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v35, "integerValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v42 = (NSURL *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v41);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v44 = (NSURL *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v78);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v53)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v57 = -[SUUIGiftTheme initWithThemeDictionary:]([SUUIGiftTheme alloc], "initWithThemeDictionary:", v56);
              if (v57)
      ...
      -[SUUIGiftConfiguration _loadThemeImages](self, "_loadThemeImages");
    }
    objc_msgSend(v79, "objectForKey:", CFSTR("giftAccountInfoUrl"));
    v60 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0
      && (v61 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v60)) != 0)
    {
      objc_initWeak(&location, self);
      v62 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2040]), "initWithURL:", v61);
      +[SSVURLDataConsumer consumer](SUUIJSONDataConsumer, "consumer");
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        if (v11)
        {
          v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2040]), "initWithURL:", v8);
          +[SSVURLDataConsumer consumer](SUUIImageDataConsumer, "consumer");
          v13 = (void *)objc_claimAutoreleasedReturnValue();
