...
{
  SUUITracklistLockupCollectionViewCell *v3;
  ...
  if (v3)
  {
    ...
    -[SUUITracklistLockupCollectionViewCell contentView](v3, "contentView");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "addSubview:", v3->_separatorView);
...
- (void)dealloc
{
  ...
  -[SUUIViewReuseCollectionViewCell dealloc](&v4, sel_dealloc);
}
...
- (void)hidePreviewProgressAnimated:(BOOL)a3
{
  ...
  if (previewState)
  {
    ...
    if (previewState == 2)
    {
      -[SUUITracklistLockupCollectionViewCell _previewColumnView](self, "_previewColumnView");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      if (a3)
      {
        -[SUUITracklistLockupCollectionViewCell _addFlipContainerViewWithFrontView:backView:](self, "_addFlipContainerViewWithFrontView:backView:", v6, v9);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        -[SUUITracklistLockupCollectionViewCell contentView](self, "contentView");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "addSubview:", v9);

        -[SUUITracklistLockupCollectionViewCell setNeedsLayout](self, "setNeedsLayout");
      }
...
- (void)showPreviewProgressWithStatus:(id)a3 animated:(BOOL)a4
{
  ...
  int64_t previewState;
  void *v9;
  SUUIPreviewProgressIndicator *v10;
  SUUIPreviewProgressIndicator *previewProgressIndicator;
  SUUIPreviewProgressIndicator *v12;
  void *v13;
  void *v14;
  void *v15;
  void *v16;
  ...
  else
  {
    ...
    if (v9)
    {
      ...
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIPreviewProgressIndicator setBackgroundColor:](v12, "setBackgroundColor:", v13);

      -[SUUIPreviewProgressIndicator setEnabled:](self->_previewProgressIndicator, "setEnabled:", 0);
      -[SUUITracklistLockupCollectionViewCell _previewControlViewElement](self, "_previewControlViewElement");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v14, "style");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      SUUIViewElementPlainColorWithStyle(v15, 0);
      v16 = (void *)objc_claimAutoreleasedReturnValue();

      -[SUUIPreviewProgressIndicator setTintColor:](self->_previewProgressIndicator, "setTintColor:", v16);
      if (v4)
      {
        -[SUUITracklistLockupCollectionViewCell _addFlipContainerViewWithFrontView:backView:](self, "_addFlipContainerViewWithFrontView:backView:", v9, self->_previewProgressIndicator);
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        self->_previewState = 1;
        -[SUUIPreviewProgressIndicator reloadWithPlayerStatus:animated:](self->_previewProgressIndicator, "reloadWithPlayerStatus:animated:", v7, 1);
        objc_initWeak(&location, self);
        objc_msgSend(MEMORY[0x24BEBD3C8], "sharedApplication");
...
- (void)togglePreviewPlaybackAnimated:(BOOL)a3
{
  ...
  -[SUUITracklistLockupCollectionViewCell _previewMediaURL](self, "_previewMediaURL", a3);
  ...
  if (v4)
  {
    ...
    if (v7)
    {
      ...
      -[SUUITracklistLockupCollectionViewCell hidePreviewProgressAnimated:](self, "hidePreviewProgressAnimated:", 1);
    }
    else
    {
      ...
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUITracklistLockupCollectionViewCell showPreviewProgressWithStatus:animated:](self, "showPreviewProgressWithStatus:animated:", v11, 1);
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v13 = v8;
  v14 = v11;
  objc_msgSend(v10, "enumerateColumnsForTrack:usingBlock:", v13, v15);
        ...
        if (v14 <= 79)
        {
          if (v14 != 8)
          {
            if (v14 != 12)
              goto LABEL_17;
LABEL_13:
            SUUITracklistAttributedStringForButton(v14, v13, *(void **)(a1 + 48));
            v15 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        else
        {
          switch(v14)
          {
            case 80:
              ...
              goto LABEL_16;
            case 138:
              SUUITracklistAttributedStringForLabel(*(void **)(a1 + 40), v13, *(void **)(a1 + 48));
              v15 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  v18 = v11;
  v19 = &v20;
  objc_msgSend(v9, "enumerateColumnsForTrack:usingBlock:", v7, v17);
  v13 = v21[4];
  v12 = v21[5];
  if (v12 <= 32.0)
    v14 = 44.0;
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  objc_msgSend(v9, "aggregateValueForKey:", 0x251203C28);
  v10 = (SUUITracklistColumnData *)objc_claimAutoreleasedReturnValue();
  ...
  v21 = v9;
  v30 = v21;
  -[SUUIViewReuseCollectionViewCell modifyUsingBlock:](self, "modifyUsingBlock:", v28);
  objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v23 = *MEMORY[0x24BEC8E48];
  objc_msgSend(v22, "removeObserver:name:object:", self, *MEMORY[0x24BEC8E48], 0);
  -[SUUITracklistLockupCollectionViewCell _previewMediaURL](self, "_previewMediaURL");
        ...
        v26))
  {
    ...
    -[SUUITracklistLockupCollectionViewCell showPreviewProgressWithStatus:animated:](self, "showPreviewProgressWithStatus:animated:", v27, 0);

  }
  else
  {
    -[SUUITracklistLockupCollectionViewCell hidePreviewProgressAnimated:](self, "hidePreviewProgressAnimated:", 0);
  }
...
LABEL_18:
            ...
            if (v21)
            {
              ...
              if (v24)
              {
                ...
                if (!v25)
                {
                  v26 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 0, 517, 1);
                  v27 = *(_QWORD *)(a1 + 48);
                  v28 = *(void **)(v27 + 824);
                  *(_QWORD *)(v27 + 824) = v26;
...
LABEL_29:
            ...
            if (v30)
            {
              ...
              if (!v31)
              {
                v32 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 1);
                v33 = *(_QWORD *)(a1 + 48);
                v34 = *(void **)(v33 + 848);
                *(_QWORD *)(v33 + 848) = v32;
...
LABEL_38:
  ...
  v35 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithUnsignedInteger:", a4);
  ...
  if (v11)
  {
    ...
    while (2)
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (SUUIIKViewElementTypeIsButton(objc_msgSend(v15, "elementType", (_QWORD)v20))
...
- (id)viewForElementIdentifier:(id)a3
{
  ...
  v9 = v5;
  v10 = &v11;
  -[SUUITracklistLockupCollectionViewCell _enumerateViewElementViewsUsingBlock:](self, "_enumerateViewElementViewsUsingBlock:", v8);
  v6 = (id)v12[5];
...
- (void)layoutSubviews
{
  ...
  v3 = objc_msgSend(MEMORY[0x24BEBDB00], "userInterfaceLayoutDirectionForSemanticContentAttribute:", -[SUUITracklistLockupCollectionViewCell semanticContentAttribute](self, "semanticContentAttribute"));
  -[SUUITracklistLockupCollectionViewCell contentView](self, "contentView");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
void __55__SUUITracklistLockupCollectionViewCell_layoutSubviews__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v5 = a2;
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithInteger:", a3);
  ...
  if (objc_msgSend(v7, "count"))
  {
    ...
    if (v10)
    {
      ...
      v44[1] = 3221225472;
      v44[2] = __55__SUUITracklistLockupCollectionViewCell_layoutSubviews__block_invoke_2;
      v44[3] = &unk_2511FBF88;
      *(double *)&v44[6] = v9;
      ...
      v30 = v12;
      v31 = 3221225472;
      v32 = __55__SUUITracklistLockupCollectionViewCell_layoutSubviews__block_invoke_3;
      v33 = &unk_2511FBFB0;
      v37 = v11;
      v35 = v42;
      v14 = v5;
...
- (void)itemOfferButtonWillAnimateTransition:(id)a3
{
  ...
  -[SUUITracklistLockupCollectionViewCell _layoutConfirmationGradientRelativeToView:alpha:](self, "_layoutConfirmationGradientRelativeToView:alpha:", v4, (double)v15);
  _Block_object_dispose(&v20, 8);

}

void __78__SUUITracklistLockupCollectionViewCell_itemOfferButtonWillAnimateTransition___block_invoke(_QWORD *a1, void *a2, uint64_t a3, _BYTE *a4)
{
  void *v7;
  void *v8;
  void *v9;
...
- (void)_buttonAction:(id)a3
{
  ...
  _QWORD v7[4];
  id v8;
  SUUITracklistLockupCollectionViewCell *v9;
...
void __55__SUUITracklistLockupCollectionViewCell__buttonAction___block_invoke(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  ...
  if (v7 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    SUUICollectionViewForView(*(void **)(a1 + 40));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_showConfirmationAction:(id)a3
{
  ...
  if (!offerConfirmationGradientView)
  {
    ...
    v8 = -[SUUIGradientView initWithFrame:](v7, "initWithFrame:", *MEMORY[0x24BDBF090], *(double *)(MEMORY[0x24BDBF090] + 8), *(double *)(MEMORY[0x24BDBF090] + 16), *(double *)(MEMORY[0x24BDBF090] + 24));
    v9 = self->_offerConfirmationGradientView;
    self->_offerConfirmationGradientView = v8;

    -[SUUITracklistLockupCollectionViewCell backgroundColor](self, "backgroundColor");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUITracklistLockupCollectionViewCell _layoutConfirmationGradientRelativeToView:alpha:](self, "_layoutConfirmationGradientRelativeToView:alpha:", v4, 0.0);
...
- (void)_audioPlayerStatusChangeNotification:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      objc_msgSend(v5, "playerStatus");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUITracklistLockupCollectionViewCell showPreviewProgressWithStatus:animated:](self, "showPreviewProgressWithStatus:animated:", v10, 1);
    }
...
- (void)_enumerateViewElementViewsUsingBlock:(id)a3
{
  ...
  v9 = v4;
  v7 = v4;
  -[SUUITracklistColumnData enumerateColumnsForTrack:usingBlock:](columnData, "enumerateColumnsForTrack:usingBlock:", track, v8);
...
- (void)_layoutConfirmationGradientRelativeToView:(id)a3 alpha:(double)a4
{
  ...
  if (self->_offerConfirmationGradientView)
  {
    ...
    -[SUUIGradientView layer](self->_offerConfirmationGradientView, "layer");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", 30.0 / v13, &unk_2512EED18);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v22[1] = v20;
    v22[2] = &unk_2512EED30;
...
void __59__SUUITracklistLockupCollectionViewCell__previewColumnView__block_invoke(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  {
    v11 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithUnsignedInteger:", a3);
...
{
  return -[SUUIViewElement firstChildForElementType:](self->_track, "firstChildForElementType:", 90);
}
