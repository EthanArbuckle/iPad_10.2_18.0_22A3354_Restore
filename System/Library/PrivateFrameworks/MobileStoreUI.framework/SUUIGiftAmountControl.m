...
- (SUUIGiftAmountControl)initWithGiftConfiguration:(id)a3
{
  ...
  v6 = -[SUUIGiftAmountControl init](&v51, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    if (v11 >= 1)
    {
      ...
      do
      {
        ...
        -[SUUIGiftAmountButton setTag:](v19, "setTag:", objc_msgSend(v20, "integerValue"));

        objc_msgSend(v9, "objectAtIndex:", v16);
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        -[SUUIGiftAmountButton setTitle:forState:](v19, "setTitle:forState:", v21, 0);

        -[SUUIGiftAmountButton sizeToFit](v19, "sizeToFit");
        -[SUUIGiftAmountControl addSubview:](v7, "addSubview:", v19);
    ...
    v22 = objc_alloc(MEMORY[0x24BEBDB00]);
    objc_msgSend(MEMORY[0x24BEBD538], "currentDevice");
    ...
    -[SUUIGiftAmountControl addSubview:](v7, "addSubview:", v7->_customAmountBackgroundView);
    v34 = (UITextField *)objc_alloc_init(MEMORY[0x24BEBDA48]);
    ...
    v41 = objc_alloc(MEMORY[0x24BDD1688]);
    if (v40)
      objc_msgSend(v40, "localizedStringForKey:inTable:", CFSTR("GIFTING_AMOUNT_OTHER"), CFSTR("Gifting"));
    else
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("GIFTING_AMOUNT_OTHER"), 0, CFSTR("Gifting"));
    ...
    -[SUUIGiftAmountControl addSubview:](v7, "addSubview:", v7->_customAmountField);
    objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v49, "addObserver:selector:name:object:", v7, sel__textFieldDidBeginEditing_, *MEMORY[0x24BEBE860], v7->_customAmountField);
    objc_msgSend(v49, "addObserver:selector:name:object:", v7, sel__textFieldDidChange_, *MEMORY[0x24BEBE868], v7->_customAmountField);
    objc_msgSend(v49, "addObserver:selector:name:object:", v7, sel__textFieldDidEndEditing_, *MEMORY[0x24BEBE870], v7->_customAmountField);
...
- (void)dealloc
{
  ...
  -[SUUIGiftAmountControl dealloc](&v9, sel_dealloc);
}
...
- (NSString)selectedAmountString
{
  ...
  {
    -[SUUIGiftAmountControl viewWithTag:](self, "viewWithTag:");
...
- (BOOL)beginTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  v5 = a3;
  -[SUUIGiftAmountControl firstResponder](self, "firstResponder");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "resignFirstResponder");

  -[SUUIGiftAmountControl _updateButtonsWithTouch:](self, "_updateButtonsWithTouch:", v5);
  return 1;
}
...
- (void)endTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  -[SUUIGiftAmountControl _reloadSelectedButton](self, "_reloadSelectedButton");
  if (self->_selectedAmount)
  {
  ...
  -[SUUIGiftAmountControl sendActionsForControlEvents:](self, "sendActionsForControlEvents:", 4096);
}
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  v7 = (SUUIGiftAmountControl *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
...
- (void)layoutSubviews
{
  ...
  if ((v4 & 0xFFFFFFFFFFFFFFFBLL) == 1)
    -[SUUIGiftAmountControl _layoutForPad](self, "_layoutForPad");
  else
    -[SUUIGiftAmountControl _layoutForPhone](self, "_layoutForPhone");
}
...
- (void)_layoutForPad
{
  ...
  -[SUUIGiftAmountControl bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  v11 = -[SUUIGiftAmountControl effectiveUserInterfaceLayoutDirection](self, "effectiveUserInterfaceLayoutDirection");
  ...
  if (v11)
    +[SUUICGRectHelpers rect:withFlippedOriginXRelativeTo:](SUUICGRectHelpers, "rect:withFlippedOriginXRelativeTo:", v24, v27, v28);
  ...
  if (v30 >= 1)
  {
    ...
    v33[2] = __38__SUUIGiftAmountControl__layoutForPad__block_invoke;
    v33[3] = &unk_2511FB508;
    v33[4] = v35;
    *(double *)&v33[5] = v4;
    *(double *)&v33[6] = v6;
...
void __38__SUUIGiftAmountControl__layoutForPad__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  {
    v14 = v10;
    +[SUUICGRectHelpers rect:withFlippedOriginXRelativeTo:](SUUICGRectHelpers, "rect:withFlippedOriginXRelativeTo:", *(double *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24), v11);
  }
...
void __40__SUUIGiftAmountControl__layoutForPhone__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  {
    v11 = v8;
    +[SUUICGRectHelpers rect:withFlippedOriginXRelativeTo:](SUUICGRectHelpers, "rect:withFlippedOriginXRelativeTo:", *(double *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24), 0.0);
  }
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)SUUIGiftAmountControl;
  -[SUUIGiftAmountControl setBackgroundColor:](&v10, sel_setBackgroundColor_, v4);
...
- (BOOL)textField:(id)a3 shouldChangeCharactersInRange:(_NSRange)a4 replacementString:(id)a5
{
  ...
  if (objc_msgSend(v12, "length"))
  {
    ...
    if (v14)
    {
      v16 = -[SUUIGiftConfiguration currencySymbolPosition](self->_giftConfiguration, "currencySymbolPosition");
      if (v16 == 1)
      {
...
- (BOOL)textFieldShouldBeginEditing:(id)a3
{
  ...
  -[SUUIGiftAmountControl _reloadSelectedButton](self, "_reloadSelectedButton", a3);
  return 1;
}
...
- (void)_textFieldDidBeginEditing:(id)a3
{
  ...
  -[SUUIGiftAmountControl tintColor](self, "tintColor", a3);
...
- (void)_dynamicUserInterfaceTraitDidChange
{
  ...
  -[SUUIGiftAmountControl _dynamicUserInterfaceTraitDidChange](&v8, sel__dynamicUserInterfaceTraitDidChange);
  objc_msgSend(MEMORY[0x24BEBD4B8], "separatorColor");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (-[UITextField isFirstResponder](self->_customAmountField, "isFirstResponder"))
  {
    -[SUUIGiftAmountControl tintColor](self, "tintColor");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "colorWithAlphaComponent:", 0.3);
