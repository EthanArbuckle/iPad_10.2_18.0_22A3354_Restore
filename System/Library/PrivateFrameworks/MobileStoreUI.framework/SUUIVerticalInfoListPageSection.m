...
{
  id v4;
  SUUIVerticalInfoListPageSection *v5;
  NSMutableArray *v6;
  NSMutableArray *columns;
  uint64_t v8;
  SUUIInfoListViewElement *infoList;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)SUUIVerticalInfoListPageSection;
  v5 = -[SUUIStorePageSection initWithPageComponent:](&v11, sel_initWithPageComponent_, v4);
  if (v5)
  {
...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  v4 = a3;
  -[SUUIInfoListViewElement style](self->_infoList, "style");
  ...
  else
  {
    v11.receiver = self;
    v11.super_class = (Class)SUUIVerticalInfoListPageSection;
    -[SUUIStorePageSection backgroundColorForIndexPath:](&v11, sel_backgroundColorForIndexPath_, v4);
...
- (id)cellForIndexPath:(id)a3
{
  ...
  objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x25120BAA8, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIVerticalInfoListPageSection _contentInsetForIndexPath:](self, "_contentInsetForIndexPath:", v4);
  objc_msgSend(v7, "setContentInset:");
  -[SUUIVerticalInfoListPageSection _reloadColumnDataIfNecessary](self, "_reloadColumnDataIfNecessary");
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SUUIVerticalInfoListPageSection _reloadColumnDataIfNecessary](self, "_reloadColumnDataIfNecessary");
...
- (void)entityProvider:(id)a3 didInvalidateWithContext:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SUUIVerticalInfoListPageSection _requestCellLayout](self, "_requestCellLayout");
  v8.receiver = self;
...
- (UIEdgeInsets)sectionContentInset
{
  ...
  -[SUUIStorePageSection sectionContentInset](&v16, sel_sectionContentInset);
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  v11 = -[SUUIStorePageSection isTopSection](self, "isTopSection");
  v12 = 12.0;
  if (!v11)
    v12 = v4;
  v13 = v6;
...
- (void)willAppearInContext:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120BAA8);
  ...
  -[SUUIViewElementLayoutContext setContainerViewElementType:](self->_cellLayoutContext, "setContainerViewElementType:", -[SUUIInfoListViewElement elementType](self->_infoList, "elementType"));
  -[SUUIVerticalInfoListPageSection _requestCellLayout](self, "_requestCellLayout");
  v9.receiver = self;
  v9.super_class = (Class)SUUIVerticalInfoListPageSection;
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  id v15;
  id v16;
  SUUIVerticalInfoListPageSection *v17;
  ...
  v11 = v7;
  v12 = v9;
  -[SUUIVerticalInfoListPageSection _enumerateVisibleIndexPathsUsingBlock:](self, "_enumerateVisibleIndexPathsUsingBlock:", v13);
...
- (int64_t)_numberOfColumnsForWidth:(double)a3
{
  ...
  if (v3 > 3.0)
    v3 = 3.0;
  v4 = (uint64_t)v3;
  -[SUUIViewElement flattenedChildren](self->_infoList, "flattenedChildren");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          do
          {
            ...
            if (v10 >= v8 && v24 >= v11)
            {
              while (v3[v9] < v3[v11 - 2])
              {
                ...
                +[SUUIVerticalInfoListCollectionViewCell sizeThatFitsWidth:viewElement:context:](SUUIVerticalInfoListCollectionViewCell, "sizeThatFitsWidth:viewElement:context:", v12, self->_cellLayoutContext, self->_columnWidth);
                v3[v9] = v3[v9] + v14;
                v7 = v10 - 1;
...
LABEL_17:
        ...
        if (v7 >= v8)
        {
          ...
          +[SUUIVerticalInfoListCollectionViewCell sizeThatFitsWidth:viewElement:context:](SUUIVerticalInfoListCollectionViewCell, "sizeThatFitsWidth:viewElement:context:", v16, self->_cellLayoutContext, self->_columnWidth);
          *v3 = *v3 + v18;
...
- (void)_requestCellLayout
{
  ...
  v6 = -[SUUIVerticalInfoListPageSection _numberOfColumnsForWidth:](self, "_numberOfColumnsForWidth:", v5);
  ...
  v9[3] = &unk_2511F46F8;
  v9[4] = self;
  -[SUUIInfoListViewElement enumerateChildrenUsingBlock:](infoList, "enumerateChildrenUsingBlock:", v9);
...
{
  return +[SUUIVerticalInfoListCollectionViewCell requestLayoutForViewElement:width:context:](SUUIVerticalInfoListCollectionViewCell, "requestLayoutForViewElement:width:context:", a2, *(_QWORD *)(*(_QWORD *)(a1 + 32) + 88), *(double *)(*(_QWORD *)(a1 + 32) + 112));
}
