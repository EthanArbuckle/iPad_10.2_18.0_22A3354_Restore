...
{
  SUUITransientAppDataStorage *v2;
  dispatch_queue_t v3;
  id v4;
  objc_super v6;
  ...
  v2 = -[SUUITransientAppDataStorage init](&v6, sel_init);
  if (v2)
  {
    v3 = dispatch_queue_create("SUUITransientAppDataStorage.accessQueue", MEMORY[0x24BDAC9C0]);
    -[SUUITransientAppDataStorage setAccessQueue:](v2, "setAccessQueue:", v3);

    v4 = objc_alloc_init(MEMORY[0x24BDBCED8]);
    -[SUUITransientAppDataStorage setStorage:](v2, "setStorage:", v4);
...
- (unint64_t)count
{
  ...
  v9 = 0x2020000000;
  v10 = 0;
  -[SUUITransientAppDataStorage accessQueue](self, "accessQueue");
...
- (unint64_t)setData:(id)a3 forKey:(id)a4
{
  ...
  _QWORD block[4];
  id v13;
  SUUITransientAppDataStorage *v14;
  id v15;
...
- (void)removeDataForKey:(id)a3
{
  ...
  block[0] = MEMORY[0x24BDAC760];
  block[1] = 3221225472;
  block[2] = __48__SUUITransientAppDataStorage_removeDataForKey___block_invoke;
