...
- (SUUILocalizedStringTable)initWithBundle:(id)a3 localeName:(id)a4 tableName:(id)a5
{
  ...
  id v10;
  id v11;
  SUUILocalizedStringTable *v12;
  SUUILocalizedStringTable *v13;
  uint64_t v14;
  NSString *tableName;
  void *v16;
  ...
  v12 = -[SUUILocalizedStringTable init](&v38, sel_init);
  v13 = v12;
  if (v12)
  {
...
LABEL_32:
        ...
        {
          v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEA0]), "initWithLocaleIdentifier:", v16);
          ...
          if (!v19)
          {
            -[SUUILocalizedStringTable _legacyLanguageNameForLanguageCode:](v13, "_legacyLanguageNameForLanguageCode:", v10);
...
LABEL_25:
        ...
        v30 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCE50]), "initWithContentsOfFile:", v19);
        objc_msgSend(MEMORY[0x24BDD1770], "propertyListWithData:options:format:error:", v30, 0, 0, 0);
