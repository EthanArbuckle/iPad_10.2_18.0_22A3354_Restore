...
- (SUUIArtworkList)initWithArtworkListArray:(id)a3
{
  ...
  v5 = -[SUUIArtworkList init](&v23, sel_init);
  if (v5)
  {
      ...
      do
      {
        ...
        do
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            ...
            v17 = -[SUUIArtwork initWithArtworkDictionary:](v16, "initWithArtworkDictionary:", v15, (_QWORD)v19);
            if (v17)
    ...
    -[NSMutableArray sortUsingComparator:](v5->_artworks, "sortUsingComparator:", &__block_literal_global_52);
  }
...
- (SUUIArtworkList)initWithLookupArray:(id)a3
{
  ...
  v5 = -[SUUIArtworkList init](&v21, sel_init);
  if (v5)
  {
    v6 = (NSMutableArray *)objc_alloc_init(MEMORY[0x24BDBCEB8]);
    artworks = v5->_artworks;
      ...
      do
      {
        ...
        do
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            ...
            v15 = -[SUUIArtwork initWithArtworkDictionary:](v14, "initWithArtworkDictionary:", v13, (_QWORD)v17);
            if (v15)
    ...
    -[NSMutableArray sortUsingComparator:](v5->_artworks, "sortUsingComparator:", &__block_literal_global_4_1);
  }
...
- (id)artworkURLForSize:(int64_t)a3
{
  ...
  -[SUUIArtworkList artworkForSize:](self, "artworkForSize:", a3);
...
- (id)bestArtworkForScaledSize:(CGSize)a3
{
  ...
  return -[SUUIArtworkList bestArtworkForSize:](self, "bestArtworkForSize:", ceil(width * v8), ceil(height * v8));
}
...
- (id)preferredExactArtworkForSize:(CGSize)a3
{
  ...
  -[SUUIArtworkList artworks](self, "artworks");
  v23 = 0u;
  v24 = 0u;
  v25 = 0u;
  v26 = 0u;
  ...
  while (2)
  {
    ...
    do
    {
      ...
      v14 = (void *)MEMORY[0x2426A2860](v6);
  ...
  if (v6)
  {
    ...
    while (1)
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          v13 = -[SUUIArtwork initWithArtworkDictionary:]([SUUIArtwork alloc], "initWithArtworkDictionary:", v12);
          v14 = -[SUUIArtwork width](v13, "width");
          if (!v10)
            goto LABEL_15;
          v15 = v14 - a3;
...
- (NSString)description
{
  ...
  -[SUUIArtworkList description](&v7, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (SUUIArtworkList)initWithCoder:(id)a3
{
  ...
  v5 = -[SUUIArtworkList init](&v9, sel_init);
  if (v5)
  {
...
- (SUUIArtworkList)initWithCacheRepresentation:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v5 = -[SUUIArtworkList init](&v11, sel_init);
    if (v5)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        SUUICacheCodingDecodeArray(v6, v7);
...
- (NSMutableDictionary)cacheRepresentation
{
  ...
  SUUICacheCodingEncodeArray(self->_artworks);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
