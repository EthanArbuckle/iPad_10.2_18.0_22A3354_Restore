...
void __44__SUUITrendingSearchTemplateElement_buttons__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  if (SUUIIKViewElementTypeIsButton(objc_msgSend(v3, "elementType")))
...
- (SUUILabelViewElement)titleLabel
{
  ...
  if (!v3)
  {
    -[SUUIViewElement firstChildForElementType:](self, "firstChildForElementType:", 48);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "titleLabels");
