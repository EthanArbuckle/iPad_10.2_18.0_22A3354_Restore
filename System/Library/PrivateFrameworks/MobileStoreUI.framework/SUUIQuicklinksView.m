...
- (SUUIQuicklinksView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[SUUIQuicklinksView addSubview:](v3, "addSubview:", v3->_borderView);
  }
  return v3;
}
...
- (void)setColoringWithColorScheme:(id)a3
{
  ...
  -[SUUIQuicklinksView setBackgroundColor:](self, "setBackgroundColor:", v7);
  ...
  if (v4 != v15 && (objc_msgSend(v4, "isEqualToString:", v15) & 1) == 0)
  {
    ...
    if (v15)
    {
      if (!titleLabel)
      {
        ...
        v8 = self->_titleLabel;
        -[SUUIQuicklinksView backgroundColor](self, "backgroundColor");
        ...
        -[SUUIQuicklinksView addSubview:](self, "addSubview:", self->_titleLabel);
        titleLabel = self->_titleLabel;
      }
    ...
    -[SUUIQuicklinksView setNeedsLayout](self, "setNeedsLayout");
  }
...
- (void)layoutSubviews
{
  ...
  -[SUUIQuicklinksView bounds](self, "bounds");
  v4 = v3;
  titleLabel = self->_titleLabel;
  if (titleLabel)
  {
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIQuicklinksView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
