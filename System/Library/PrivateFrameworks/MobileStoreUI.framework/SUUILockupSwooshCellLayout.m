...
- (SUUILockupSwooshCellLayout)initWithCollectionViewCell:(id)a3
{
  ...
  v3 = -[SUUICellLayout initWithCollectionViewCell:](&v7, sel_initWithCollectionViewCell_, a3);
  if (v3)
  {
...
- (void)setArtistName:(id)a3
{
  ...
  if (v4 != v10 && (objc_msgSend(v4, "isEqualToString:", v10) & 1) == 0)
  {
    ...
    if (v10)
    {
      if (!artistNameLabel)
      {
        v6 = -[SUUILockupSwooshCellLayout _newDefaultLabel](self, "_newDefaultLabel");
...
- (void)setVideoThumbnailImage:(id)a3
{
  ...
  v17 = a3;
  -[SUUILockupSwooshCellLayout videoThumbnailImage](self, "videoThumbnailImage");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  ...
  if (v4 != v17)
  {
    if (v17)
    {
      ...
      if (!self->_videoPlayButtonImageView)
      {
        ...
        v15 = (UIImageView *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD668]), "initWithImage:", v14);
...
- (void)layoutSubviews
{
  ...
  if ((self->_visibleFields & 2) != 0)
  {
    ...
    v13 = -[SUUIItemCellLayout isIconImageHidden](self, "isIconImageHidden");
    v12 = v18;
  }
  else
  {
  ...
  if ((visibleFields & 0x400) != 0)
    -[SUUILockupSwooshCellLayout _layoutFieldsHorizontal](self, "_layoutFieldsHorizontal");
  else
    -[SUUILockupSwooshCellLayout _layoutFieldsVertical](self, "_layoutFieldsVertical");
...
- (void)setItemOffer:(id)a3
{
  ...
  -[SUUIItemCellLayout setItemOffer:](&v4, sel_setItemOffer_, a3);
  -[SUUILockupSwooshCellLayout _reloadPriceLabel](self, "_reloadPriceLabel");
}
...
- (void)setItemState:(id)a3 animated:(BOOL)a4
{
  ...
  -[SUUIItemCellLayout setItemState:animated:](&v5, sel_setItemState_animated_, a3, a4);
  -[SUUILockupSwooshCellLayout _reloadPriceLabel](self, "_reloadPriceLabel");
}
...
- (void)setHighlighted:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SUUILockupSwooshCellLayout;
  -[SUUIItemCellLayout setHighlighted:](&v4, sel_setHighlighted_, a3);
  -[SUUILockupSwooshCellLayout _reloadHighlight](self, "_reloadHighlight");
}
...
- (void)setSelected:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SUUILockupSwooshCellLayout;
  -[SUUIItemCellLayout setSelected:](&v4, sel_setSelected_, a3);
  -[SUUILockupSwooshCellLayout _reloadHighlight](self, "_reloadHighlight");
}
...
LABEL_21:
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUILockupSwooshCellLayout setPrice:](self, "setPrice:", v9);
  ...
  +[SUUIClientContext localizedStringForKey:inBundles:](SUUIClientContext, "localizedStringForKey:inBundles:", v7, 0);
  v8 = objc_claimAutoreleasedReturnValue();
LABEL_19:
  v10 = (id)v8;
  ...
  if (!v10)
    goto LABEL_21;
  -[SUUILockupSwooshCellLayout setPrice:](self, "setPrice:", v10);
LABEL_22:
...
- (void)_reloadHighlight
{
  ...
  if (-[SUUIItemCellLayout isHighlighted](self, "isHighlighted")
    || -[SUUIItemCellLayout isSelected](self, "isSelected"))
  {
    iconHighlightImageView = self->_iconHighlightImageView;
    if (!iconHighlightImageView)
    {
    ...
    -[SUUIItemCellLayout iconImage](self, "iconImage");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BEBD4B8], "blackColor");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (videoImageView && (-[UIImageView isHidden](videoImageView, "isHidden") & 1) == 0)
    {
      ...
      if (!videoHighlightImageView)
      {
        v15 = (UIImageView *)objc_alloc_init(MEMORY[0x24BEBD668]);
  ...
  else
  {
    ...
    v24[1] = 3221225472;
    v24[2] = __46__SUUILockupSwooshCellLayout__reloadHighlight__block_invoke;
    v24[3] = &unk_2511F47C0;
    v24[4] = self;
    objc_msgSend(MEMORY[0x24BDE57D8], "setCompletionBlock:", v24);
