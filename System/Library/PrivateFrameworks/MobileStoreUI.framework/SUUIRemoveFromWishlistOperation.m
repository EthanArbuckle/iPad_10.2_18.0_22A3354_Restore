...
{
  SUUIRemoveFromWishlistOperation *result;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)SUUIRemoveFromWishlistOperation;
  result = -[SUUIRemoveFromWishlistOperation init](&v9, sel_init);
  if (result)
  {
    result->_entityID = a4;
    result->_itemID = a3;
...
- (void)main
{
  ...
  v6 = -[SSURLConnectionRequest initWithRequestProperties:]([SUUIURLConnectionRequest alloc], "initWithRequestProperties:", v3);
  ...
  v35 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB1DC0]), "initWithAccount:", v36);
  ...
  if (v11)
  {
    ...
    *(_QWORD *)((char *)&v45 + 4) = itemID;
    ...
    if (v13)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithCString:encoding:", v13, 4, &v45, v32);
  ...
  *((_QWORD *)&v45 + 1) = &v45;
  ...
  v16 = v15;
  v39 = v16;
  -[SUUIURLConnectionRequest startWithConnectionResponseBlock:](v6, "startWithConnectionResponseBlock:", v38);
  dispatch_semaphore_wait(v16, 0xFFFFFFFFFFFFFFFFLL);
  v17 = *(_QWORD *)(*((_QWORD *)&v45 + 1) + 40);
  if (v17)
  {
    objc_msgSend(MEMORY[0x24BDD1770], "propertyListWithData:options:format:error:", v17, 0, 0, 0);
...
LABEL_26:
    ...
    if (v25)
    {
      ...
      if (!v28)
        goto LABEL_24;
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithCString:encoding:", v28, 4, &v41, v32);
...
LABEL_24:
    if (v27 <= 1)
    {
      v29 = objc_alloc(MEMORY[0x24BEB20C8]);
      ...
      v37[1] = 3221225472;
      v37[2] = __39__SUUIRemoveFromWishlistOperation_main__block_invoke_24;
      v37[3] = &unk_2511F70E0;
      v37[4] = self;
...
uint64_t __39__SUUIRemoveFromWishlistOperation_main__block_invoke_24(uint64_t a1, void *a2)
{
  objc_class *v3;
  id v4;
  void *v5;
  ...
  v3 = (objc_class *)MEMORY[0x24BEB20D0];
  v4 = a2;
