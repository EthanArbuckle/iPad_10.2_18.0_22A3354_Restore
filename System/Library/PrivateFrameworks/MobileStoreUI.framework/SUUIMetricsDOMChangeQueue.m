...
- (SUUIMetricsDOMChangeQueue)init
{
  ...
  v2 = -[SUUIMetricsDOMChangeQueue init](&v6, sel_init);
  if (v2)
  {
    v3 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", 3);
    storage = v2->_storage;
...
- (void)addPendingChange:(id)a3
{
  ...
  v26 = a3;
  if (-[SUUIMetricsDOMChangeQueue isEmpty](self, "isEmpty"))
    goto LABEL_34;
