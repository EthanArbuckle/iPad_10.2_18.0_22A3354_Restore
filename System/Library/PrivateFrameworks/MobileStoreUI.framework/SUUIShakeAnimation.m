...
- (SUUIShakeAnimation)initWithOptions:(id)a3
{
  ...
  v5 = -[SUUIShakeAnimation init](&v10, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKey:", 0x25120FCA8);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_opt_respondsToSelector() & 1) != 0)
      v5->_shouldErase = objc_msgSend(v6, "BOOLValue");
    objc_msgSend(v4, "objectForKey:", 0x25120FCC8);
...
- (void)animatePINInputControl:(id)a3
{
  ...
  -[SUUIShakeAnimation animateView:](self, "animateView:", v5);
...
- (void)animateView:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDE5760], "animationWithKeyPath:", CFSTR("position.x"));
  ...
  *(float *)&v13 = v13;
  ...
  LODWORD(v18) = 0.25;
  LODWORD(v19) = 1.0;
  objc_msgSend(MEMORY[0x24BDE56F0], "functionWithControlPoints::::", v17, v16, v18, v19);
