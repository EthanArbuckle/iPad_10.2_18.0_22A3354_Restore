...
- (SUUIGiftComposeViewController)initWithGift:(id)a3 configuration:(id)a4
{
  ...
  v8 = -[SUUIGiftStepViewController initWithGift:configuration:](&v20, sel_initWithGift_configuration_, v6, v7);
  if (v8)
  {
    ...
    if (v9)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("GIFTING_FLOW_TITLE"), 0, CFSTR("Gifting"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftComposeViewController setTitle:](v8, "setTitle:", v12);

    -[SUUIGiftStepViewController gift](v8, "gift");
    ...
    objc_msgSend(v17, "addObserver:selector:name:object:", v8, sel__keyboardChangeNotification_, *MEMORY[0x24BEBE440], 0);
    objc_msgSend(v17, "addObserver:selector:name:object:", v8, sel__keyboardChangeNotification_, *MEMORY[0x24BEBE448], 0);
    ...
    objc_msgSend(v17, "addObserver:selector:name:object:", v8, sel__textFieldChangeNotification_, *MEMORY[0x24BEBE868], 0);
    objc_msgSend(v17, "addObserver:selector:name:object:", v8, sel__textFieldChangeNotification_, *MEMORY[0x24BEBE870], 0);
    objc_msgSend(v17, "addObserver:selector:name:object:", v8, sel__textViewChangeNotification_, *MEMORY[0x24BEBE988], 0);
    objc_msgSend(v17, "addObserver:selector:name:object:", v8, sel__textViewDidEndEditingNotification_, *MEMORY[0x24BEBE990], 0);
...
- (void)dealloc
{
  ...
  objc_msgSend(v3, "removeObserver:name:object:", self, *MEMORY[0x24BEBE870], 0);
  objc_msgSend(v3, "removeObserver:name:object:", self, *MEMORY[0x24BEBE988], 0);
  objc_msgSend(v3, "removeObserver:name:object:", self, *MEMORY[0x24BEBE990], 0);
  validationTimer = self->_validationTimer;
  if (validationTimer)
    dispatch_source_cancel(validationTimer);
  -[SUUIGiftAddressingSection setTextFieldDelegate:](self->_addressingSection, "setTextFieldDelegate:", 0);
  -[SUUIGiftAmountSection amountControl](self->_amountSection, "amountControl");
  ...
  -[SUUIGiftComposeViewController dealloc](&v7, sel_dealloc);
}
...
- (void)loadView
{
  ...
  if (!self->_sections)
    -[SUUIGiftComposeViewController _reloadSections](self, "_reloadSections");
  ...
  if (!tableView)
  {
    ...
    v10 = (UITableView *)objc_alloc_init(MEMORY[0x24BEBD9F0]);
    v11 = self->_tableView;
    self->_tableView = v10;
    ...
    -[SUUIGiftComposeViewController _headerView](self, "_headerView");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIGiftComposeViewController navigationItem](self, "navigationItem");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v14)
  ...
  if (v14)
    ...
    +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("GIFTING_CANCEL_BUTTON"), 0, CFSTR("Gifting"));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "setTitle:", v18);

  objc_msgSend(v15, "setLeftBarButtonItem:", v17);
  v19 = (UIBarButtonItem *)objc_alloc_init(MEMORY[0x24BEBD410]);
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SUUIGiftComposeViewController _itemView](self, "_itemView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v7)
  {
    ...
    -[SUUIGiftStepViewController loadItemArtworkWithArtworkContext:completionBlock:](self, "loadItemArtworkWithArtworkContext:completionBlock:", v6, v9);
    objc_destroyWeak(&v10);
    objc_destroyWeak(&location);
  }
  v8.receiver = self;
  v8.super_class = (Class)SUUIGiftComposeViewController;
  -[SUUIGiftComposeViewController viewWillAppear:](&v8, sel_viewWillAppear_, v3);
    ...
    do
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (-[UITableView numberOfRowsInSection:](self->_tableView, "numberOfRowsInSection:", v7))
        {
          ...
          {
            tableView = self->_tableView;
            objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForRow:inSection:", v10, v7);
            v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)tableView:(id)a3 giftRecipientCellDidChangeRecipients:(id)a4
{
  ...
  -[SUUIGiftComposeViewController _validateGiftThrottled:](self, "_validateGiftThrottled:", 0);
}
...
- (void)tableView:(id)a3 giftRecipientCell:(id)a4 didUpdateSearchController:(id)a5
{
  ...
  if (objc_msgSend(v7, "numberOfResults"))
  {
    ...
    if (v9 == 1)
    {
      ...
      {
        v10 = objc_alloc(MEMORY[0x24BEBD858]);
    ...
    else if (!self->_searchResultsView)
    {
      ...
      -[SUUIGiftComposeViewController view](self, "view");
...
- (void)tableView:(id)a3 giftRecipientCell:(id)a4 presentContactPicker:(id)a5
{
  ...
  if (v9)
  {
    ...
    {
      v10 = (UIPopoverController *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD858]), "initWithContentViewController:", v7);
      peoplePickerPopover = self->_peoplePickerPopover;
  ...
  {
    -[SUUIGiftComposeViewController presentViewController:animated:completion:](self, "presentViewController:animated:completion:", v7, 1, 0);
  }
...
- (void)giftSendDateSection:(id)a3 didChangeDate:(id)a4
{
  ...
  -[SUUIGiftComposeViewController _validateGiftThrottled:](self, "_validateGiftThrottled:", 1);
}
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  if (v5 == -[SUUITableViewSection sectionIndex](self->_addressingSection, "sectionIndex")
    && objc_msgSend(v6, "row") == 2)
  {
    -[SUUIGiftAddressingSection beginEditingMessageForTableView:indexPath:](self->_addressingSection, "beginEditingMessageForTableView:indexPath:", self->_tableView, v6);
  }
...
- (void)_amountControlAction:(id)a3
{
  ...
  -[SUUIGiftAmountSection selectedAmountString](self->_amountSection, "selectedAmountString");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  -[SUUIGiftStepViewController finishGiftingWithResult:](self, "finishGiftingWithResult:", 0);
}
...
- (void)_nextAction:(id)a3
{
  ...
  if (self->_validationTimer || -[SUUIGiftValidator isValidating](self->_validator, "isValidating"))
  {
    ...
    if (self->_validationTimer)
      -[SUUIGiftComposeViewController _validateGift](self, "_validateGift");
  }
  else
  {
    -[SUUIGiftComposeViewController _pushThemePickerOrShowInvalidAlert](self, "_pushThemePickerOrShowInvalidAlert");
  }
...
- (void)_recipientsDidChangeNotification:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v21)
    {
      ...
      if (v23 == -[SUUITableViewSection sectionIndex](self->_addressingSection, "sectionIndex"))
      {
  ...
  if (v6)
  {
    ...
    if (v21)
    {
      ...
      if (v23 == -[SUUITableViewSection sectionIndex](self->_addressingSection, "sectionIndex"))
      {
        ...
        v26 = (void *)objc_claimAutoreleasedReturnValue();
        -[SUUIGiftComposeViewController _validateGiftThrottled:](self, "_validateGiftThrottled:", objc_msgSend(v26, "isEqualToString:", *MEMORY[0x24BEBE868]));
...
- (void)_textViewChangeNotification:(id)a3
{
  ...
  -[SUUIGiftAddressingSection messagingTextView](self->_addressingSection, "messagingTextView");
...
- (void)_textViewDidEndEditingNotification:(id)a3
{
  ...
  if (v20 == v4)
  {
    ...
    -[SUUIGiftAddressingSection endEditingMessageForTableView:indexPath:](self->_addressingSection, "endEditingMessageForTableView:indexPath:", self->_tableView, v19);
    v5 = v20;
  }
...
- (void)_finishValidationWithResponse:(id)a3 error:(id)a4
{
  ...
  -[SUUIGiftStepViewController gift](self, "gift");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIGiftValidationResponse totalGiftAmountString](self->_lastValidationResponse, "totalGiftAmountString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_headerView
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x24BEBD640], "imageNamed:inBundle:", CFSTR("GiftCardGraphic"), v6);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_itemView
{
  ...
  if (!v6)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = -[SUUIGiftItemView initWithStyle:item:clientContext:](v7, "initWithStyle:item:clientContext:", 0, v4, v9);
    v11 = self->_itemView;
    self->_itemView = v10;

    -[SUUIGiftItemView setAutoresizingMask:](self->_itemView, "setAutoresizingMask:", 2);
    v12 = self->_itemView;
    objc_msgSend(v4, "artistName");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftItemView setArtistName:](v12, "setArtistName:", v13);

    v14 = self->_itemView;
    objc_msgSend(v4, "categoryName");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftItemView setCategoryName:](v14, "setCategoryName:", v15);

    v16 = self->_itemView;
    -[SUUIGiftComposeViewController _itemImage](self, "_itemImage");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftItemView setItemImage:](v16, "setItemImage:", v17);
    ...
    -[SUUIGiftItemView setPrice:](v18, "setPrice:", v20);

    v21 = self->_itemView;
    objc_msgSend(v4, "title");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftItemView setTitle:](v21, "setTitle:", v22);

    v23 = self->_itemView;
    objc_msgSend(v4, "userRating");
    *(float *)&v25 = v24 / 5.0;
    -[SUUIGiftItemView setUserRating:](v23, "setUserRating:", v25);
...
{
  SUUIGiftThemePickerViewController *v3;
  void *v4;
  SUUIGiftThemePickerViewController *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  ...
  if (-[SUUIGiftValidationResponse isValid](self->_lastValidationResponse, "isValid"))
  {
    ...
    -[SUUIGiftStepViewController giftConfiguration](self, "giftConfiguration");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = -[SUUIGiftThemePickerViewController initWithGift:configuration:](v3, "initWithGift:configuration:", v15, v4);

    -[SUUIGiftStepViewController operationQueue](self, "operationQueue");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftStepViewController setOperationQueue:](v5, "setOperationQueue:", v6);

    -[SUUIGiftComposeViewController navigationController](self, "navigationController");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (v15)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("GIFTING_INVALID_GIFT"), 0, CFSTR("Gifting"));
    ...
    v5 = (SUUIGiftThemePickerViewController *)objc_claimAutoreleasedReturnValue();
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftThemePickerViewController addAction:](v5, "addAction:", v14);

    -[SUUIGiftComposeViewController presentViewController:animated:completion:](self, "presentViewController:animated:completion:", v5, 1, 0);
  }
...
- (void)_reloadSections
{
  ...
  NSMutableArray *v4;
  NSMutableArray *sections;
  SUUIGiftAddressingSection *addressingSection;
  SUUIGiftAddressingSection *v7;
  SUUIGiftAddressingSection *v8;
  void *v9;
  SUUIGiftAmountSection *amountSection;
  SUUIGiftAmountSection *v11;
  SUUIGiftAmountSection *v12;
  void *v13;
  SUUIGiftSendDateSection *sendDateSection;
  SUUIGiftSendDateSection *v15;
  SUUIGiftSendDateSection *v16;
  SUUIGiftSendDateSection *v17;
  void *v18;
  SUUIGiftSendDateSection *v19;
  void *v20;
  SUUIGiftTermsAndConditionsSection *termsSection;
  SUUIGiftTermsAndConditionsSection *v22;
  SUUIGiftTermsAndConditionsSection *v23;
  id v24;
  ...
  {
    v7 = -[SUUIGiftAddressingSection initWithGiftConfiguration:]([SUUIGiftAddressingSection alloc], "initWithGiftConfiguration:", v3);
    v8 = self->_addressingSection;
    self->_addressingSection = v7;

    -[SUUIGiftAddressingSection setGift:](self->_addressingSection, "setGift:", v24);
    -[SUUIGiftAddressingSection setTextFieldDelegate:](self->_addressingSection, "setTextFieldDelegate:", self);
    addressingSection = self->_addressingSection;
  }
  -[SUUITableViewSection setSectionIndex:](addressingSection, "setSectionIndex:", -[NSMutableArray count](self->_sections, "count"));
  ...
  if (!v9)
  {
    ...
    if (!amountSection)
    {
      v11 = -[SUUIGiftTableViewSection initWithGiftConfiguration:]([SUUIGiftAmountSection alloc], "initWithGiftConfiguration:", v3);
    ...
    -[SUUITableViewSection setSectionIndex:](amountSection, "setSectionIndex:", -[NSMutableArray count](self->_sections, "count"));
    -[NSMutableArray addObject:](self->_sections, "addObject:", self->_amountSection);
  }
  sendDateSection = self->_sendDateSection;
  if (!sendDateSection)
  {
    v15 = -[SUUIGiftTableViewSection initWithGiftConfiguration:]([SUUIGiftSendDateSection alloc], "initWithGiftConfiguration:", v3);
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftSendDateSection setSendDate:](v17, "setSendDate:", v18);

    v19 = self->_sendDateSection;
    objc_msgSend(v24, "item");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftSendDateSection setGiftItem:](v19, "setGiftItem:", v20);

    -[SUUIGiftSendDateSection setDelegate:](self->_sendDateSection, "setDelegate:", self);
    sendDateSection = self->_sendDateSection;
  }
  -[SUUITableViewSection setSectionIndex:](sendDateSection, "setSectionIndex:", -[NSMutableArray count](self->_sections, "count"));
  -[NSMutableArray addObject:](self->_sections, "addObject:", self->_sendDateSection);
  termsSection = self->_termsSection;
  if (!termsSection)
  {
    v22 = -[SUUIGiftTableViewSection initWithGiftConfiguration:]([SUUIGiftTermsAndConditionsSection alloc], "initWithGiftConfiguration:", v3);
...
- (void)_validateGift
{
  ...
  if (!self->_validator)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = -[SUUIGiftValidator initWithValidationURL:clientContext:](v6, "initWithValidationURL:clientContext:", v7, v8);
    ...
    -[SUUIGiftStepViewController operationQueue](self, "operationQueue");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGiftValidator setOperationQueue:](v11, "setOperationQueue:", v12);
  ...
  -[SUUIGiftValidator validateGift:withCompletionBlock:](v13, "validateGift:withCompletionBlock:", v14, v15);
...
- (void)_validateGiftThrottled:(BOOL)a3
{
  ...
  -[SUUIGiftComposeViewController nextButton](self, "nextButton");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v10)
  {
    if (a3)
    {
      ...
      {
        v16 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, MEMORY[0x24BDAC9B8]);
