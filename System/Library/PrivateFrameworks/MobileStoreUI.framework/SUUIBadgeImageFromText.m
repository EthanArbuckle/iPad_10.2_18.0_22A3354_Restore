@implementation SUUIBadgeImageFromText
...
uint64_t __SUUIBadgeImageFromText_block_invoke()
{
  ...
  v1 = (void *)SUUIBadgeImageFromText_sBadgeImageQueue;
  ...
  v5 = (void *)SUUIBadgeImageFromText_sBadgeImageCache;
  SUUIBadgeImageFromText_sBadgeImageCache = (uint64_t)v4;

  return objc_msgSend((id)SUUIBadgeImageFromText_sBadgeImageCache, "setCountLimit:", 10);
}
...
void __SUUIBadgeImageFromText_block_invoke_2(uint64_t a1)
{
  ...
  objc_msgSend((id)SUUIBadgeImageFromText_sBadgeImageCache, "objectForKey:", v5);
  ...
  *(_QWORD *)(v7 + 40) = v6;
  ...
  if (!*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 40))
  {
    ...
    objc_msgSend(MEMORY[0x24BEBD420], "bezierPathWithRoundedRect:cornerRadius:", 0.0, 0.0, v14 + 6.0, v16, 1.0);
    ...
    *(_QWORD *)(v22 + 40) = v21;
    ...
    if (*(_BYTE *)(a1 + 56))
      objc_msgSend((id)SUUIBadgeImageFromText_sBadgeImageCache, "setObject:forKey:", *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 40), v5);
