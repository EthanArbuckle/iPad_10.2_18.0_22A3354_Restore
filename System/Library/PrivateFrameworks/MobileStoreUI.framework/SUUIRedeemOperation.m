...
- (SUUIRedeemOperation)initWithCode:(id)a3
{
  ...
  v6 = -[SUUIRedeemOperation init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (void)main
{
  ...
  *(_QWORD *)&v70[14] = code;
  ...
  if (v11)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithCString:encoding:", v11, 4, v70, v52);
...
LABEL_8:
  ...
  *(_QWORD *)&v70[16] = 0x3032000000;
  ...
  if (v18)
  {
    ...
    if (v19)
    {
      -[SUUIRedeemOperation _redeemForSuccessDictionary:](self, "_redeemForSuccessDictionary:", v19);
  ...
  if (v23)
  {
    ...
    -[SUUIRedeemOperation _requestPropertiesForThankYouWithURL:](self, "_requestPropertiesForThankYouWithURL:", v24);
    v25 = (void *)objc_claimAutoreleasedReturnValue();

    -[SUUIRedeemOperation _performRequestWithProperties:error:](self, "_performRequestWithProperties:error:", v25, 0);
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "setThankYouDictionary:", v26);
    if (v26)
      -[SUUIRedeemOperation _applyThankYouDictionary:toRedeem:](self, "_applyThankYouDictionary:toRedeem:", v26, v20);
...
LABEL_46:
    if (!v62[5])
    {
      ...
      v29 = CFSTR("Redeem");
      if (v28)
        -[SUUIClientContext localizedStringForKey:inTable:](v28, "localizedStringForKey:inTable:", CFSTR("REDEEM_UNAVAILABLE"), v29);
      else
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REDEEM_UNAVAILABLE"), 0, v29);
      v30 = (void *)objc_claimAutoreleasedReturnValue();

      v68 = v30;
      objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v68, &v67, 1);
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v27, "errorWithDomain:code:userInfo:", *MEMORY[0x24BDEA758], 0, v31);
  ...
  if (v62[5])
  {
    ...
    *(_WORD *)&v70[22] = 2114;
    ...
    {
LABEL_41:
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithCString:encoding:", v43, 4, v70, v52);
...
LABEL_42:
  ...
  block[1] = 3221225472;
  block[2] = __27__SUUIRedeemOperation_main__block_invoke_9;
  block[3] = &unk_2511FA7F8;
  v54 = v20;
  v55 = self;
  v56 = &v61;
  v50 = v20;
...
uint64_t __27__SUUIRedeemOperation_main__block_invoke_9(uint64_t a1)
{
  void *v2;
  void *v3;
  void *v4;
...
- (id)_authenticationContext
{
  ...
  if (v3
    && (objc_msgSend(v3, "uniqueIdentifier"),
        ...
        v6))
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB1F28]), "initWithAccount:", v3);
  ...
  do
  {
    for (i = 0; i != v7; ++i)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        {
          objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", objc_msgSend(v14, "longLongValue"));
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          v110 = v15;
          objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", &v110, 1);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIRedeemOperation _itemsForItemIdentifiers:](self, "_itemsForItemIdentifiers:", v16);
          v17 = (SUUIRedeemItem *)objc_claimAutoreleasedReturnValue();

          if (-[SUUIRedeemItem count](v17, "count"))
          {
...
LABEL_39:
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          objc_msgSend(&unk_2512EEEC8, "objectForKey:", CFSTR("productType"));
          v19 = (void *)objc_claimAutoreleasedReturnValue();
          v20 = v19;
          if (!v19)
            v19 = &unk_2512EECD0;
          ...
          -[SUUIItem setItemKind:](v17, "setItemKind:", v21);
        }
        ...
        objc_opt_class();
        if ((objc_opt_isKindOfClass() & 1) != 0)
          -[SUUIItem setTitle:](v17, "setTitle:", v25);
        objc_msgSend(v10, "objectForKey:", CFSTR("parentSalableAdamId"));
        v26 = (void *)objc_claimAutoreleasedReturnValue();
        v27 = v26;
        if (v26)
        ...
        if ((objc_opt_respondsToSelector() & 1) != 0)
          -[SUUIItem setItemIdentifier:](v17, "setItemIdentifier:", objc_msgSend(v29, "longLongValue"));
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          ...
          if (v33)
          {
            ...
            -[SUUIArtworkList setArtworks:](v35, "setArtworks:", v36);

            -[SUUIRedeemItem setArtworks:](v17, "setArtworks:", v35);
            v4 = v90;
...
LABEL_52:
      ...
      do
      {
        for (j = 0; j != v44; ++j)
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            ...
            if ((objc_opt_respondsToSelector() & 1) != 0)
            {
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", objc_msgSend(v48, "longLongValue"));
              v49 = (void *)objc_claimAutoreleasedReturnValue();
              v107 = v49;
              objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", &v107, 1);
              v50 = (void *)objc_claimAutoreleasedReturnValue();
              -[SUUIRedeemOperation _itemsForItemIdentifiers:](self, "_itemsForItemIdentifiers:", v50);
  ...
  if (objc_msgSend(v4, "count"))
  {
    if (objc_msgSend(v4, "count") == 1)
    {
      ...
      v53 = (void *)v52;
      v54 = (void *)MEMORY[0x24BDBD1A8];
      if (v52)
        v54 = (void *)v52;
      v55 = v54;

      objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", v55);
  ...
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
    v76 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v75);
  else
    v76 = 0;
  ...
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
    v78 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v77);
  else
    v78 = 0;
  ...
  if (objc_msgSend(v67, "length") || objc_msgSend(v4, "count"))
  {
    ...
    -[SUUIRedeem setBalance:](v39, "setBalance:", v71);
    -[SUUIRedeem setCredit:](v39, "setCredit:", v67);
    -[SUUIRedeem setCreditDisplay:](v39, "setCreditDisplay:", v74);
    v81 = v89;
    -[SUUIRedeem setInAppPurchase:](v39, "setInAppPurchase:", v89);
    if (objc_msgSend(v4, "count"))
      v82 = v4;
    else
      v82 = 0;
    -[SUUIRedeem setItems:](v39, "setItems:", v82);
    if (objc_msgSend(v58, "count"))
      v83 = v58;
    else
      v83 = 0;
    -[SUUIRedeem setDownloads:](v39, "setDownloads:", v83);
    -[SUUIRedeem setITunesPassLearnMoreAlertInterval:](v39, "setITunesPassLearnMoreAlertInterval:", v79);
    -[SUUIRedeem setRedirectURL:](v39, "setRedirectURL:", v76);
    -[SUUIRedeem setCustomizedThankyouURL:](v39, "setCustomizedThankyouURL:", v78);
  }
  else
  {
    v39 = 0;
...
- (id)_itemsForItemIdentifiers:(id)a3
{
  ...
  v26 = objc_alloc_init(MEMORY[0x24BEB1EB0]);
  objc_msgSend(v26, "setKeyProfile:", *MEMORY[0x24BEB2770]);
  objc_msgSend(v26, "setValue:forRequestParameter:", v4, *MEMORY[0x24BEB2788]);
  v34 = 0;
  v35 = &v34;
  v36 = 0x3032000000;
  ...
  if (v15)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        v21 = -[SUUIItem initWithLookupDictionary:](v19, "initWithLookupDictionary:", v20);
...
LABEL_14:
    ...
    if (v22)
    {
      ...
      do
      {
        for (j = 0; j != v23; ++j)
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            v27 = -[SUUILink initWithLinkDictionary:]([SUUILink alloc], "initWithLinkDictionary:", v26);
            if (v27)
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDBCED8], "dictionaryWithDictionary:", v28);
    ...
    if (v30)
    {
      ...
      if ((objc_opt_respondsToSelector() & 1) != 0 && objc_msgSend(v31, "BOOLValue"))
      {
        ...
        v45 = v29;
        objc_msgSend(*(id *)(v8 + 3632), "arrayWithObjects:count:", &v45, 1);
        v33 = (void *)objc_claimAutoreleasedReturnValue();
        v34 = -[SUUIArtworkList initWithArtworkListArray:](v32, "initWithArtworkListArray:", v33);
...
- (id)_performRequestWithProperties:(id)a3 error:(id *)a4
{
  ...
  v24 = 0;
  v6 = -[SSURLConnectionRequest initWithRequestProperties:]([SUUIURLConnectionRequest alloc], "initWithRequestProperties:", v4);
  ...
  v7 = v5;
  v17 = v7;
  -[SUUIURLConnectionRequest startWithConnectionResponseBlock:](v6, "startWithConnectionResponseBlock:", &v13);
