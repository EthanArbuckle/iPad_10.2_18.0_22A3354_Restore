...
{
  SUUISwooshCollectionViewLayout *v2;
...
- (CGPoint)targetContentOffsetForProposedContentOffset:(CGPoint)a3 withScrollingVelocity:(CGPoint)a4
{
  ...
  {
    -[SUUISwooshCollectionViewLayout collectionView](self, "collectionView");
      ...
      if (objc_msgSend(v10, "numberOfSections") >= 1)
      {
        ...
        do
        {
          ...
          if (v19 >= 1)
          {
            ...
            while (1)
            {
              objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", v21, v17);
