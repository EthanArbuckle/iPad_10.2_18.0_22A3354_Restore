...
{
  SUUIApplicationControllerOptions *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)SUUIApplicationControllerOptions;
  result = -[SUUIApplicationControllerOptions init](&v3, sel_init);
  if (result)
  {
...
- (BOOL)isEqual:(id)a3
{
  SUUIApplicationControllerOptions *v4;
  SUUIApplicationControllerOptions *v5;
  BOOL v6;

  v4 = (SUUIApplicationControllerOptions *)a3;
  if (self == v4)
  {
    v6 = 1;
  }
...
{
  SUUIMutableApplicationControllerOptions *v4;

  v4 = objc_alloc_init(SUUIMutableApplicationControllerOptions);
  -[SUUIMutableApplicationControllerOptions setSupportsFullApplicationReload:](v4, "setSupportsFullApplicationReload:", self->_supportsFullApplicationReload);
  -[SUUIMutableApplicationControllerOptions setTabBarControllerStyle:](v4, "setTabBarControllerStyle:", self->_tabBarControllerStyle);
  -[SUUIMutableApplicationControllerOptions setPageRenderMetricsEnabled:](v4, "setPageRenderMetricsEnabled:", self->_pageRenderMetricsEnabled);
  -[SUUIMutableApplicationControllerOptions setRequiresLocalBootstrapScript:](v4, "setRequiresLocalBootstrapScript:", self->_requiresLocalBootstrapScript);
  -[SUUIMutableApplicationControllerOptions setBootstrapScriptFallbackEnabled:](v4, "setBootstrapScriptFallbackEnabled:", self->_bootstrapScriptFallbackEnabled);
  -[SUUIMutableApplicationControllerOptions setBootstrapScriptFallbackMaximumAge:](v4, "setBootstrapScriptFallbackMaximumAge:", self->_bootstrapScriptFallbackMaximumAge);
  -[SUUIMutableApplicationControllerOptions setBootstrapScriptTimeoutInterval:](v4, "setBootstrapScriptTimeoutInterval:", self->_bootstrapScriptTimeoutInterval);
  -[SUUIMutableApplicationControllerOptions setUseTransientStorageForTests:](v4, "setUseTransientStorageForTests:", self->_useTransientStorageForTests);
  return v4;
}
