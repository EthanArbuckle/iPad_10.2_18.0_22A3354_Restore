...
- (void)setChildViewController:(id)a3
{
  ...
  if (childViewController)
  {
    ...
    -[SUUIPreviewContainerViewController _setExistingNavigationItem:](self, "_setExistingNavigationItem:", 0);
  }
  objc_storeStrong((id *)&self->_childViewController, a3);
  v7 = v12;
  if (v12)
  {
    -[SUUIPreviewContainerViewController addChildViewController:](self, "addChildViewController:", v12);
    objc_msgSend(v12, "view");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "setAutoresizingMask:", 18);

    -[SUUIPreviewContainerViewController view](self, "view");
    ...
    -[SUUIPreviewContainerViewController _setExistingNavigationItem:](self, "_setExistingNavigationItem:", v11);
