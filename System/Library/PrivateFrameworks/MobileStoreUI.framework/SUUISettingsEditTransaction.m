...
{
  id v4;
  SUUISettingsEditTransaction *v5;
  uint64_t v6;
  NSSet *all;
  NSLock *v8;
  NSLock *lock;
  ...
  v5 = -[SUUISettingsEditTransaction init](&v11, sel_init);
  if (v5)
  {
...
- (void)beginTransaction
{
  ...
  -[SUUISettingsEditTransaction _delegateWillBeginTransaction](self, "_delegateWillBeginTransaction");
}
...
- (void)cancelTransaction
{
  ...
  -[SUUISettingsEditTransaction _delegateDidFailTransaction](self, "_delegateDidFailTransaction");
}
...
- (void)commitTransaction
{
  ...
  -[SUUISettingsEditTransaction _delegateWillCommitTransaction](self, "_delegateWillCommitTransaction");
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11[0] = v8;
        v11[1] = 3221225472;
        v11[2] = __48__SUUISettingsEditTransaction_commitTransaction__block_invoke;
        v11[3] = &unk_2511FC828;
...
- (void)rollbackTransaction
{
  ...
  -[NSLock unlock](self->_lock, "unlock");
  -[SUUISettingsEditTransaction _delegateDidCompleteTransaction](self, "_delegateDidCompleteTransaction");
}

- (void)_delegateDidCompleteTransaction
{
  SUUISettingsEditTransactionDelegate **p_delegate;
  id WeakRetained;
  void *v5;
  id v6;
  char v7;
...
- (void)_settingDescription:(id)a3 completedWithSuccess:(BOOL)a4
{
  ...
  -[NSLock unlock](self->_lock, "unlock");
  if (!v9)
    -[SUUISettingsEditTransaction _finalizeCommit](self, "_finalizeCommit");
}

- (SUUISettingsEditTransactionDelegate)delegate
{
  return (SUUISettingsEditTransactionDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
