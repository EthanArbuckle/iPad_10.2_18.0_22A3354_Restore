...
{
  SUUIEditorialCardCollectionViewCell *v3;
  NSMutableArray *v4;
  ...
  if (v3)
  {
    ...
    -[SUUIViewReuseCollectionViewCell registerClass:forViewWithReuseIdentifier:](v3, "registerClass:forViewWithReuseIdentifier:", objc_opt_class(), CFSTR("editorialCardLockup"));
  }
  return v3;
}
...
{
  SUUIVerticalLockupView *primaryLockupView;
  id v4;

  primaryLockupView = self->_primaryLockupView;
  v4 = a3;
  -[SUUIVerticalLockupView setPerspectiveTargetView:](primaryLockupView, "setPerspectiveTargetView:", v4);

}

- (void)setVanishingPoint:(CGPoint)a3
{
  -[SUUIVerticalLockupView setVanishingPoint:](self->_primaryLockupView, "setVanishingPoint:", a3.x, a3.y);
}

- (void)updateForChangedDistanceFromVanishingPoint
{
  -[SUUIVerticalLockupView updateForChangedDistanceFromVanishingPoint](self->_primaryLockupView, "updateForChangedDistanceFromVanishingPoint");
}
...
void __86__SUUIEditorialCardCollectionViewCell_prefetchResourcesForViewElement_reason_context___block_invoke(_QWORD *a1, void *a2)
{
  BOOL v3;
  uint64_t v4;
  char v5;
  ...
  {
    v3 = +[SUUIVerticalLockupView prefetchResourcesForViewElement:reason:context:](SUUIVerticalLockupView, "prefetchResourcesForViewElement:reason:context:", v6, a1[6], a1[4]);
    v4 = *(_QWORD *)(a1[5] + 8);
    if (*(_BYTE *)(v4 + 24))
      v5 = 1;
    else
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v7 = a5;
  v8 = a3;
  v15 = -[SUUIEditorialCardLayout initWithCard:width:context:]([SUUIEditorialCardLayout alloc], "initWithCard:width:context:", v8, v7, a4);

  -[SUUIEditorialCardLayout primaryLockup](v15, "primaryLockup");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9)
  {
    -[SUUIEditorialCardLayout primaryLockupSize](v15, "primaryLockupSize");
    +[SUUIVerticalLockupView requestLayoutForViewElement:width:context:](SUUIVerticalLockupView, "requestLayoutForViewElement:width:context:", v9, v7);
  }
  -[SUUIEditorialCardLayout secondaryLockupWidth](v15, "secondaryLockupWidth", v15);
  v11 = v10;
  objc_msgSend(v16, "allLockups");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v17[0] = MEMORY[0x24BDAC760];
  v17[1] = 3221225472;
  v17[2] = __81__SUUIEditorialCardCollectionViewCell_requestLayoutForViewElement_width_context___block_invoke;
  v17[3] = &unk_2511FC710;
  v20 = v11;
  v18 = v9;
  v19 = v7;
...
uint64_t __81__SUUIEditorialCardCollectionViewCell_requestLayoutForViewElement_width_context___block_invoke(uint64_t result, uint64_t a2)
{
  if (*(_QWORD *)(result + 32) != a2)
    return +[SUUIVerticalLockupView requestLayoutForViewElement:width:context:](SUUIVerticalLockupView, "requestLayoutForViewElement:width:context:", a2, *(_QWORD *)(result + 40), *(double *)(result + 48));
  return result;
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  v30 = a3;
  v31 = 0;
  v9 = -[SUUIEditorialCardLayout initWithCard:width:context:]([SUUIEditorialCardLayout alloc], "initWithCard:width:context:", v7, v8, a3);
  -[SUUIEditorialCardLayout primaryLockup](v9, "primaryLockup");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
  {
    -[SUUIEditorialCardLayout primaryLockupSize](v9, "primaryLockupSize");
    *((_QWORD *)v27 + 5) = v11;
  }
  -[SUUIEditorialCardLayout secondaryLockupWidth](v9, "secondaryLockupWidth");
  v13 = v12;
  -[SUUIEditorialCardLayout allLockups](v9, "allLockups");
...
uint64_t __77__SUUIEditorialCardCollectionViewCell_sizeThatFitsWidth_viewElement_context___block_invoke(uint64_t result, uint64_t a2)
{
  ...
  {
    v2 = result;
    result = +[SUUIVerticalLockupView sizeThatFitsWidth:viewElement:context:](SUUIVerticalLockupView, "sizeThatFitsWidth:viewElement:context:", a2, *(_QWORD *)(v2 + 40), *(double *)(v2 + 56));
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  void *v21;
  SUUIEditorialCardLayout *v22;
  id v23;
  SUUIEditorialCardCollectionViewCell *v24;
  uint64_t *v25;
  uint64_t v26;
  uint64_t *v27;
  uint64_t v28;
  ...
  v8 = a3;
  v9 = a5;
  v10 = -[SUUIEditorialCardLayout initWithCard:width:context:]([SUUIEditorialCardLayout alloc], "initWithCard:width:context:", v8, v9, a4);
  v26 = 0;
  v27 = &v26;
  v28 = 0x3032000000;
  ...
  -[SUUIEditorialCardLayout primaryLockupSize](v10, "primaryLockupSize");
...
- (void)layoutSubviews
{
  ...
  -[SUUICollectionViewCell layoutSubviews](&v49, sel_layoutSubviews);
  v3 = -[NSMutableArray count](self->_allLockupViews, "count");
  v4 = v3 - 1;
  if (v3 >= 1)
  {
    v5 = v3;
    -[SUUIEditorialCardCollectionViewCell contentView](self, "contentView");
    ...
    if (v28)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v37 = *(SUUIVerticalLockupView **)(*((_QWORD *)&v45 + 1) + 8 * v36);
          width = v34;
          height = v32;
          ...
          -[SUUIEditorialCardCollectionViewCell contentView](self, "contentView", (_QWORD)v45);
          v40 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v40, "bounds");
          -[SUUIVerticalLockupView setFrame:](v37, "setFrame:", SUUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v30, v31, width, height, v41, v42, v43, v44));
