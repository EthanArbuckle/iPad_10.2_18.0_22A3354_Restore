...
- (SUUIMessageBanner)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[SUUIMessageBanner addSubview:](v3, "addSubview:", v3->_label);
    objc_msgSend(MEMORY[0x24BEBD430], "buttonWithType:", 1);
    v6 = objc_claimAutoreleasedReturnValue();
    button = v3->_button;
    v3->_button = (UIButton *)v6;

    -[UIButton addTarget:action:forControlEvents:](v3->_button, "addTarget:action:forControlEvents:", v3, sel__buttonAction_, 64);
    -[SUUIMessageBanner addSubview:](v3, "addSubview:", v3->_button);
    ...
    -[SUUIMessageBanner addSubview:](v3, "addSubview:", v3->_borderView);
    objc_msgSend(MEMORY[0x24BEBD4B8], "whiteColor");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIMessageBanner setBackgroundColor:](v3, "setBackgroundColor:", v12);
...
{
  SUUIMessageBannerCloseButton *v5;
  ...
  if (-[SUUIMessageBanner showsClearButton](self, "showsClearButton") != a3)
  {
    if (a3)
    {
      ...
      -[SUUIMessageBanner addSubview:](self, "addSubview:", self->_clearButton);
      -[SUUIMessageBanner setNeedsLayout](self, "setNeedsLayout");
    }
    else
    {
...
- (void)setMessage:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x24BEBB490];
  v5 = a3;
  ...
  label = self->_label;
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1458]), "initWithString:attributes:", v5, v9);
...
- (void)layoutSubviews
{
  ...
  -[SUUIMessageBanner layoutSubviews](&v33, sel_layoutSubviews);
  -[SUUIMessageBanner bounds](self, "bounds");
  MaxX = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  ...
  if (clearButton)
  {
    ...
    -[SUUIMessageBanner bringSubviewToFront:](self, "bringSubviewToFront:", self->_clearButton);
...
{
  SUUIMessageBannerDelegate **p_delegate;
  id WeakRetained;
  char v6;
  id v7;
...
{
  return (SUUIMessageBannerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
