...
- (SUUIRedeemITunesPassLockup)initWithITunesPassConfiguration:(id)a3 clientContext:(id)a4
{
  id v7;
  id v8;
  SUUIRedeemITunesPassLockup *v9;
  SUUIRedeemITunesPassLockup *v10;
  UILabel *v11;
  ...
  v9 = -[SUUIRedeemITunesPassLockup init](&v33, sel_init);
  v10 = v9;
  if (v9)
  {
    ...
    -[SUUIRedeemITunesPassLockup _attributedDescriptionString](v10, "_attributedDescriptionString");
    ...
    -[SUUIRedeemITunesPassLockup addSubview:](v10, "addSubview:", v10->_descriptionLabel);
    ...
    -[SUUIRedeemITunesPassLockup addSubview:](v10, "addSubview:", v10->_horizontalSeparatorView);
    ...
    if (v21)
    {
      v22 = objc_msgSend(objc_alloc(MEMORY[0x24BEBD668]), "initWithImage:", v21);
      iconImageView = v10->_iconImageView;
      v10->_iconImageView = (UIImageView *)v22;

      -[SUUIRedeemITunesPassLockup addSubview:](v10, "addSubview:", v10->_iconImageView);
    }
    ...
    -[SUUIRedeemITunesPassLockup addSubview:](v10, "addSubview:", v10->_titleLabel);
  }
...
- (void)layoutSubviews
{
  ...
  -[SUUIRedeemITunesPassLockup bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
...
- (void)setHighlighted:(BOOL)a3
{
  ...
  -[SUUIRedeemITunesPassLockup setHighlighted:](&v6, sel_setHighlighted_, a3);
  descriptionLabel = self->_descriptionLabel;
  -[SUUIRedeemITunesPassLockup _attributedDescriptionString](self, "_attributedDescriptionString");
...
- (id)_attributedDescriptionString
{
  ...
  -[SUUIITunesPassConfiguration lockupDescription](self->_configuration, "lockupDescription");
  v3 = objc_claimAutoreleasedReturnValue();
  -[SUUIITunesPassConfiguration lockupLearnMoreLinkTitle](self->_configuration, "lockupLearnMoreLinkTitle");
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  clientContext = self->_clientContext;
  if (clientContext)
    -[SUUIClientContext localizedStringForKey:inTable:](clientContext, "localizedStringForKey:inTable:", CFSTR("ITUNES_PASS_EXPLANATION_LEARN_MORE_FORMAT"), CFSTR("Redeem"));
  else
    +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("ITUNES_PASS_EXPLANATION_LEARN_MORE_FORMAT"), 0, CFSTR("Redeem"));
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithValidatedFormat:validFormatSpecifiers:error:", v23, CFSTR("%@%@"), 0, v3, v24);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v6, "addAttribute:value:range:", *MEMORY[0x24BEBB3A8], v9, 0, objc_msgSend(v5, "length"));
  v22 = (void *)v3;
  v10 = objc_msgSend(v5, "rangeOfString:", v3);
  v12 = v11;
  v13 = *MEMORY[0x24BEBB360];
  objc_msgSend(v6, "addAttribute:value:range:", *MEMORY[0x24BEBB360], v7, v10, v11);
  ...
  -[SUUIRedeemITunesPassLockup tintColor](self, "tintColor");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  if (-[SUUIRedeemITunesPassLockup isHighlighted](self, "isHighlighted"))
  {
