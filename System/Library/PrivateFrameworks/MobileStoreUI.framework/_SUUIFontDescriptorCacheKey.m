...
{
  id v7;
  _SUUIFontDescriptorCacheKey *v8;
  _SUUIFontDescriptorCacheKey *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)_SUUIFontDescriptorCacheKey;
  v8 = -[_SUUIFontDescriptorCacheKey init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_textStyle = a3;
...
{
  id v4;
  _SUUIFontDescriptorCacheKey *v5;
  void *v6;
  void *v7;
  char v8;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    else if (CFEqual(-[_SUUIFontDescriptorCacheKey textStyle](self, "textStyle"), -[_SUUIFontDescriptorCacheKey textStyle](v5, "textStyle")))
    {
      -[_SUUIFontDescriptorCacheKey sizeCategory](self, "sizeCategory");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      -[_SUUIFontDescriptorCacheKey sizeCategory](v5, "sizeCategory");
