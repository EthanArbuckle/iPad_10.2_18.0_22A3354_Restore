...
- (void)setIcon:(id)a3
{
  ...
  if (v4)
  {
    if (!iconView)
    {
      ...
      v8 = self->_iconView;
      -[SUUIProductPageFeatureView backgroundColor](self, "backgroundColor");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[UIImageView setBackgroundColor:](v8, "setBackgroundColor:", v9);

      -[SUUIProductPageFeatureView addSubview:](self, "addSubview:", self->_iconView);
      v4 = v11;
      iconView = self->_iconView;
    }
  ...
  -[SUUIProductPageFeatureView setNeedsLayout](self, "setNeedsLayout");
...
- (void)setSubtitle:(id)a3
{
  ...
  v4 = a3;
  -[SUUIProductPageFeatureView subtitle](self, "subtitle");
  ...
  if (v5 != v4 && (objc_msgSend(v5, "isEqualToString:", v4) & 1) == 0)
  {
    ...
    if (v7)
    {
      if (!subtitleLabel)
      {
        ...
        -[SUUIProductPageFeatureView addSubview:](self, "addSubview:", self->_subtitleLabel);
      }
      ...
      v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1458]), "initWithString:attributes:", v4, v24);
...
- (void)setTitle:(id)a3
{
  ...
  v18 = a3;
  -[SUUIProductPageFeatureView title](self, "title");
  ...
  if (v4 != v18 && (objc_msgSend(v4, "isEqualToString:", v18) & 1) == 0)
  {
    ...
    if (v5)
    {
      if (!titleLabel)
      {
        ...
        -[SUUIProductPageFeatureView addSubview:](self, "addSubview:", self->_titleLabel);
        titleLabel = self->_titleLabel;
      }
...
- (void)layoutSubviews
{
  ...
  -[SUUIProductPageFeatureView bounds](self, "bounds");
  v4 = v3;
  iconView = self->_iconView;
  v6 = 0.0;
  v7 = 0.0;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIProductPageFeatureView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
