...
- (void)dealloc
{
  ...
  -[SUUIPhysicalCirclesView setDataSource:](self->_circlesView, "setDataSource:", 0);
  -[SUUIPhysicalCirclesView setDelegate:](self->_circlesView, "setDelegate:", 0);
  v4.receiver = self;
  v4.super_class = (Class)SUUIOnboardingAffiliationCirclesViewController;
  -[SUUIOnboardingAffiliationCirclesViewController dealloc](&v4, sel_dealloc);
}
...
- (void)addAffiliationItems:(id)a3
{
  ...
  id v5;
  SUUIPhysicalCirclesView *circlesView;
  uint64_t v7;
  ...
  -[SUUIPhysicalCirclesView addCirclesWithCount:](circlesView, "addCirclesWithCount:", v7);
}
...
- (SUUIOnboardingInstructionsView)instructionsView
{
  ...
  SUUIOnboardingInstructionsView *v5;
  SUUIOnboardingInstructionsView *v6;
  SUUIOnboardingInstructionsView *v7;
  void *v8;
  ...
  if (!instructionsView)
  {
    ...
    -[SUUIPhysicalCirclesView bounds](self->_circlesView, "bounds");
    v5 = -[SUUIOnboardingInstructionsView initWithFrame:](v4, "initWithFrame:");
    v6 = self->_instructionsView;
    self->_instructionsView = v5;

    -[SUUIOnboardingInstructionsView setAutoresizingMask:](self->_instructionsView, "setAutoresizingMask:", 18);
    v7 = self->_instructionsView;
    objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIOnboardingInstructionsView setBackgroundColor:](v7, "setBackgroundColor:", v8);

    -[SUUIOnboardingInstructionsView setContentPosition:](self->_instructionsView, "setContentPosition:", 1);
    -[SUUIOnboardingInstructionsView setUserInteractionEnabled:](self->_instructionsView, "setUserInteractionEnabled:", 0);
    instructionsView = self->_instructionsView;
  }
...
- (double)maximumCircleDiameter
{
  ...
  -[SUUIOnboardingAffiliationCirclesViewController traitCollection](self, "traitCollection");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "userInterfaceIdiom") == 1;

  return dbl_241EFB7A0[v3];
}
...
- (void)performFinishAnimationWithCompletionBlock:(id)a3
{
  ...
  double v24;
  double v25;
  SUUIPhysicalCirclesView *v26;
  SUUIPhysicalCirclesView *v27;
  NSObject *v28;
  _QWORD block[4];
  id v30;
  void (**v31)(id, id);
  ...
  v39[1] = 3221225472;
  v39[2] = __92__SUUIOnboardingAffiliationCirclesViewController_performFinishAnimationWithCompletionBlock___block_invoke;
  v39[3] = &unk_2511F48E0;
  v9 = v5;
  v40 = v9;
  v10 = v6;
  ...
  else
  {
    ...
    v38[0] = v8;
    v38[1] = 3221225472;
    v38[2] = __92__SUUIOnboardingAffiliationCirclesViewController_performFinishAnimationWithCompletionBlock___block_invoke_2;
    v38[3] = &unk_2511F47C0;
    v38[4] = self;
    v36[0] = v8;
    v36[1] = 3221225472;
    v36[2] = __92__SUUIOnboardingAffiliationCirclesViewController_performFinishAnimationWithCompletionBlock___block_invoke_3;
    v36[3] = &unk_2511F4908;
    v13 = v11;
    v37 = v13;
    ...
    if (objc_msgSend(v10, "count"))
    {
      ...
      *(float *)&v15 = v18 + v17 * 0.5;
      ...
      -[SUUIPhysicalCirclesView convertPoint:fromView:](circlesView, "convertPoint:fromView:", v21, v16, v19);
      v23 = v22;
      v25 = v24;
      ...
      v34[0] = v8;
      v34[1] = 3221225472;
      v34[2] = __92__SUUIOnboardingAffiliationCirclesViewController_performFinishAnimationWithCompletionBlock___block_invoke_4;
      v34[3] = &unk_2511F4908;
      v35 = v13;
      -[SUUIPhysicalCirclesView removeCirclesInIndexSet:byAnimatingToPoint:delay:completionBlock:](v26, "removeCirclesInIndexSet:byAnimatingToPoint:delay:completionBlock:", v9, v34, v23, v25, 0.25);
    ...
    v32[0] = v8;
    v32[1] = 3221225472;
    v32[2] = __92__SUUIOnboardingAffiliationCirclesViewController_performFinishAnimationWithCompletionBlock___block_invoke_5;
    v32[3] = &unk_2511F4908;
    v33 = v13;
    v28 = v13;
    -[SUUIPhysicalCirclesView removeAllCirclesAnimated:completionBlock:](v27, "removeAllCirclesAnimated:completionBlock:", 1, v32);
    block[0] = v8;
    block[1] = 3221225472;
...
- (void)removeAffiliationItemsInIndexSet:(id)a3 animated:(BOOL)a4 completionBlock:(id)a5
{
  ...
  -[SUUIPhysicalCirclesView removeCirclesInIndexSet:animated:completionBlock:](self->_circlesView, "removeCirclesInIndexSet:animated:completionBlock:", v10, v5, v9);
...
- (void)resetWithAffiliationItems:(id)a3 animated:(BOOL)a4 completionBlock:(id)a5
{
  ...
  else
  {
    ...
    v13 = v8;
    v14 = v10;
    -[SUUIPhysicalCirclesView removeAllCirclesAnimated:completionBlock:](circlesView, "removeAllCirclesAnimated:completionBlock:", v6, v12);
    self->_didPerformFinishAnimation = 1;
...
uint64_t __101__SUUIOnboardingAffiliationCirclesViewController_resetWithAffiliationItems_animated_completionBlock___block_invoke(uint64_t a1, uint64_t a2)
{
  id WeakRetained;
  void *v5;
  uint64_t v6;
...
- (void)setAffiliationItems:(id)a3
{
  ...
  if (affiliationItems != v4)
  {
    ...
    if (v4)
    {
      v4 = (NSMutableArray *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithArray:copyItems:", v4, 1);
      affiliationItems = self->_affiliationItems;
    }
    self->_affiliationItems = v4;

    -[SUUIPhysicalCirclesView reloadData](self->_circlesView, "reloadData");
...
{
  -[SUUIOnboardingAffiliationCirclesViewController setFooterView:animated:](self, "setFooterView:animated:", a3, 0);
}
...
- (void)setFooterView:(id)a3 animated:(BOOL)a4
{
  ...
  if (footerView != v6)
  {
    ...
    if (*p_footerView)
    {
      -[SUUIOnboardingAffiliationCirclesViewController view](self, "view");
...
- (void)setImage:(id)a3 forAffiliationItem:(id)a4
{
  ...
  {
    -[SUUIPhysicalCirclesView circleViewAtIndex:](self->_circlesView, "circleViewAtIndex:", v7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v12)
    {
      if (!images)
      {
        v10 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 0);
        v11 = self->_images;
        self->_images = v10;
...
- (void)setUserAffinityCount:(int64_t)a3 forAffiliationItemAtIndex:(int64_t)a4 animated:(BOOL)a5 completionBlock:(id)a6
{
  ...
  -[SUUIOnboardingAffiliationCirclesViewController _circleSizeForAffinityCount:](self, "_circleSizeForAffinityCount:", a3);
  v13 = v12;
  v15 = v14;
  ...
  if (a5)
  {
    +[SUUISimpleAnimationFactory backOutTimingFunction](SUUISimpleAnimationFactory, "backOutTimingFunction");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    +[SUUISimpleAnimationFactory factoryWithTimingFunction:](SUUISimpleAnimationFactory, "factoryWithTimingFunction:", v19);
    v20 = (void *)objc_claimAutoreleasedReturnValue();

    v21 = (void *)MEMORY[0x24BEBDB00];
    v22[0] = v16;
    v22[1] = 3221225472;
    v22[2] = __122__SUUIOnboardingAffiliationCirclesViewController_setUserAffinityCount_forAffiliationItemAtIndex_animated_completionBlock___block_invoke_2;
    v22[3] = &unk_2511F49A8;
    v23 = v10;
...
- (void)loadView
{
  id v3;
  void *v4;
  SUUIPhysicalCirclesView *v5;
  SUUIPhysicalCirclesView *circlesView;
  SUUIPhysicalCirclesView *v7;
  void *v8;
  void *v9;
  uint64_t v10;
  uint64_t v11;
  SUUIPhysicalCirclesView *v12;
  SUUIPhysicalCirclesView *v13;
  void *v14;
  _OWORD v15[4];
  __int128 v16;
  __int128 v17;
  ...
  if (!self->_circlesView)
  {
    ...
    -[SUUIPhysicalCirclesView setAutoresizingMask:](self->_circlesView, "setAutoresizingMask:", 18);
    v7 = self->_circlesView;
    objc_msgSend(MEMORY[0x24BEBD4B8], "whiteColor");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIPhysicalCirclesView setBackgroundColor:](v7, "setBackgroundColor:", v8);

    -[SUUIPhysicalCirclesView setDataSource:](self->_circlesView, "setDataSource:", self);
    -[SUUIPhysicalCirclesView setDelegate:](self->_circlesView, "setDelegate:", self);
  ...
  -[SUUIOnboardingAffiliationCirclesViewController _circleSizeForAffinityCount:](self, "_circleSizeForAffinityCount:", 0);
  *((_QWORD *)&v17 + 1) = v10;
  -[SUUIOnboardingAffiliationCirclesViewController _circleSizeForAffinityCount:](self, "_circleSizeForAffinityCount:", 2);
  *(_QWORD *)&v17 = v11;
  ...
  v15[2] = v18;
  v15[3] = v19;
  -[SUUIPhysicalCirclesView setConstants:](v12, "setConstants:", v15);
  v13 = self->_circlesView;
  objc_msgSend(v3, "bounds");
  -[SUUIPhysicalCirclesView setFrame:](v13, "setFrame:");
  objc_msgSend(v3, "addSubview:", self->_circlesView);
  -[SUUIOnboardingAffiliationCirclesViewController instructionsView](self, "instructionsView");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "bounds");
  objc_msgSend(v14, "setFrame:");
  objc_msgSend(v3, "addSubview:", v14);
  -[SUUIOnboardingAffiliationCirclesViewController setView:](self, "setView:", v3);
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SUUIOnboardingAffiliationCirclesViewController _reloadRepellors](self, "_reloadRepellors");
  -[SUUIPhysicalCirclesView startPhysics](self->_circlesView, "startPhysics");
  self->_didPerformFinishAnimation = 0;
  ...
  -[SUUIOnboardingAffiliationCirclesViewController viewDidAppear:](&v5, sel_viewDidAppear_, v3);
}
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SUUIPhysicalCirclesView stopPhysics](self->_circlesView, "stopPhysics");
  v5.receiver = self;
  v5.super_class = (Class)SUUIOnboardingAffiliationCirclesViewController;
  -[SUUIOnboardingAffiliationCirclesViewController viewDidDisappear:](&v5, sel_viewDidDisappear_, v3);
}
...
- (void)viewDidLayoutSubviews
{
  ...
  -[SUUIOnboardingAffiliationCirclesViewController _topLayoutMargin](self, "_topLayoutMargin");
  v9 = v8;
  footerView = self->_footerView;
  if (footerView)
  {
  ...
  -[SUUIOnboardingAffiliationCirclesViewController viewDidLayoutSubviews](&v20, sel_viewDidLayoutSubviews);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SUUIOnboardingInstructionsView setAlpha:](self->_instructionsView, "setAlpha:", 1.0);
  v5.receiver = self;
  v5.super_class = (Class)SUUIOnboardingAffiliationCirclesViewController;
  -[SUUIOnboardingAffiliationCirclesViewController viewWillAppear:](&v5, sel_viewWillAppear_, v3);
}
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SUUIOnboardingAffiliationCirclesViewController transitionCoordinator](self, "transitionCoordinator");
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  self->_needsReloadOnDidAppear = v5 != 0;
  v6.receiver = self;
  v6.super_class = (Class)SUUIOnboardingAffiliationCirclesViewController;
  -[SUUIOnboardingAffiliationCirclesViewController viewWillDisappear:](&v6, sel_viewWillDisappear_, v3);
}
...
- (id)circlesView:(id)a3 circleForIndex:(int64_t)a4
{
  ...
  -[SUUIOnboardingAffiliationCirclesViewController _circleSizeForAffinityCount:](self, "_circleSizeForAffinityCount:", v8);
  v11 = -[SUUIOnboardingCircleView initWithFrame:]([SUUIOnboardingCircleView alloc], "initWithFrame:", 0.0, 0.0, v9, v10);
  objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIOnboardingCircleView setBackgroundColor:](v11, "setBackgroundColor:", v12);
  ...
  -[SUUIOnboardingCircleView setTitlePosition:](v11, "setTitlePosition:", -[SUUIOnboardingAffiliationCirclesViewController _titlePositionForAffinityCount:](self, "_titlePositionForAffinityCount:", v8));
  objc_msgSend(v7, "fillColor");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (v13)
  {
    -[SUUIOnboardingCircleView setFillColor:](v11, "setFillColor:", v13);
  }
  else
  {
    objc_msgSend(v6, "tintColor");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIOnboardingCircleView setFillColor:](v11, "setFillColor:", v14);

  }
  -[SUUIOnboardingAffiliationCirclesViewController _circleImageAlphaForAffinityCount:](self, "_circleImageAlphaForAffinityCount:", v8);
  ...
  -[SUUIOnboardingCircleView setBackgroundImage:](v11, "setBackgroundImage:", v15);

  -[SUUIOnboardingCircleView titleLabel](v11, "titleLabel");
...
- (void)circleView:(id)a3 didBeginLongPressForCircleAtIndex:(int64_t)a4
{
  ...
  NSObject *v9;
  SUUIOnboardingInstructionsView *v10;
  _QWORD v11[5];
  SUUIOnboardingInstructionsView *v12;
  _QWORD *v13;
  id v14[2];
  id location;
  _QWORD v16[4];

  -[SUUIOnboardingAffiliationCirclesViewController _cancelDeletionTimer](self, "_cancelDeletionTimer", a3);
  v6 = self->_instructionsView;
  -[SUUIOnboardingInstructionsView pushLabelState](v6, "pushLabelState");
...
void __95__SUUIOnboardingAffiliationCirclesViewController_circleView_didBeginLongPressForCircleAtIndex___block_invoke(uint64_t a1)
{
  ...
  {
    WeakRetained = objc_alloc_init(MEMORY[0x24BDD16F0]);
    ...
    if (v2)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REMOVE_ITEM_%@"), 0, CFSTR("Onboarding"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    v4 = (void *)MEMORY[0x24BDD17C8];
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)circleView:(id)a3 didEndLongPressForCircleAtIndex:(int64_t)a4
{
  ...
  -[SUUIOnboardingInstructionsView popLabelState](self->_instructionsView, "popLabelState", a3, a4);
  -[SUUIOnboardingAffiliationCirclesViewController view](self, "view");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setNeedsLayout");

  -[SUUIOnboardingAffiliationCirclesViewController _cancelDeletionTimer](self, "_cancelDeletionTimer");
}
...
- (void)circleView:(id)a3 didTapCircleAtIndex:(int64_t)a4
{
  ...
  -[SUUIOnboardingAffiliationCirclesViewController delegate](self, "delegate", a3);
  ...
  {
    -[SUUIOnboardingAffiliationCirclesViewController setUserAffinityCount:forAffiliationItemAtIndex:animated:completionBlock:](self, "setUserAffinityCount:forAffiliationItemAtIndex:animated:completionBlock:", (objc_msgSend(v7, "userAffinityCount") + 1) % 3, a4, 1, 0);
    -[SUUIOnboardingAffiliationCirclesViewController _reloadRepellors](self, "_reloadRepellors");
    -[SUUIOnboardingAffiliationCirclesViewController _sendAffilationItemsDidChange](self, "_sendAffilationItemsDidChange");
  }
...
- (void)_completeDeletionForCircleAtIndex:(int64_t)a3
{
  ...
  -[SUUIPhysicalCirclesView removeCircleAtIndex:animated:completionBlock:](self->_circlesView, "removeCircleAtIndex:animated:completionBlock:", a3, 1, 0);
  -[SUUIOnboardingInstructionsView popLabelState](self->_instructionsView, "popLabelState");
  -[SUUIOnboardingAffiliationCirclesViewController view](self, "view");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setNeedsLayout");

  -[SUUIOnboardingAffiliationCirclesViewController _cancelDeletionTimer](self, "_cancelDeletionTimer");
  -[SUUIOnboardingAffiliationCirclesViewController delegate](self, "delegate");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadRepellors
{
  ...
  v8 = v7;
  v10 = v9;
  -[SUUIPhysicalCirclesView removeAllRepellors](self->_circlesView, "removeAllRepellors");
  footerView = self->_footerView;
  if (footerView)
  {
    -[UIView frame](footerView, "frame");
    if (v12 > 0.00000011920929)
    {
      ...
      -[SUUIOnboardingAffiliationCirclesViewController bottomLayoutGuide](self, "bottomLayoutGuide");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v16, "length");
      v18 = Height - v17 + 90.0;

      v19 = -[SUUIPhysicalCirclesView addRepellorWithCenter:radius:bufferSize:](self->_circlesView, "addRepellorWithCenter:radius:bufferSize:", v14, v18, ceil(v13 * 0.600000024), 20.0);
    }
  }
  v39.origin.x = v4;
  v39.origin.y = v6;
  ...
  -[SUUIOnboardingInstructionsView explanationLabel](self->_instructionsView, "explanationLabel");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  *(float *)&Width = v35 * v35 - Width * 0.5 * (Width * 0.5);
  ...
  v34 = -[SUUIPhysicalCirclesView addRepellorWithCenter:radius:bufferSize:](self->_circlesView, "addRepellorWithCenter:radius:bufferSize:", floor(CGRectGetWidth(v42) * 0.5), v33, v35, 20.0);
}
...
- (double)_topLayoutMargin
{
  ...
  -[SUUIOnboardingAffiliationCirclesViewController navigationController](self, "navigationController");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = 13.0;
  if (v2)
  {
    +[SUUINavigationControllerAssistant existingAssistantForNavigationController:](SUUINavigationControllerAssistant, "existingAssistantForNavigationController:", v2);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    if (v4)
    {
      v5 = v4;
...
{
  return (SUUIOnboardingAffiliationCirclesDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
