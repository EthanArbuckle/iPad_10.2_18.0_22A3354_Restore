...
- (void)beginEdits
{
  ...
  if (textField)
    -[UITextField becomeFirstResponder](textField, "becomeFirstResponder");
}
...
- (void)commitEdits
{
  ...
  textField = self->_textField;
  if (textField)
    -[UITextField resignFirstResponder](textField, "resignFirstResponder");
}
...
- (void)setEnabled:(BOOL)a3
{
  ...
  if (textField)
  {
    ...
    if (v3)
      v6 = 1.0;
    -[UITextField setAlpha:](self->_textField, "setAlpha:", v6);
  }
}
...
+ (void)requestLayoutForSettingDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (v27[5] && v21[5])
  {
    ...
    v14 = v13;
    objc_msgSend(v7, "aggregateValueForKey:", CFSTR("SUUITextFieldSettingDescriptionFieldLabelWidthKey"));
    ...
    v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithDouble:", v14);
    objc_msgSend(v7, "setAggregateValue:forKey:", v18, CFSTR("SUUITextFieldSettingDescriptionFieldLabelWidthKey"));
...
- (void)reloadWithSettingDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  objc_msgSend(v9, "aggregateValueForKey:", CFSTR("SUUITextFieldSettingDescriptionFieldLabelWidthKey"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v10, "doubleValue");
  self->_aggregateLabelWidth = v11;
  -[SUUITextFieldSettingDescriptionView setNeedsLayout](self, "setNeedsLayout");
...
- (void)textFieldDidEndEditing:(id)a3
{
  ...
  -[SUUITextFieldSettingDescriptionView _updateTextFieldValue:](self, "_updateTextFieldValue:", v4);
...
- (BOOL)textField:(id)a3 shouldChangeCharactersInRange:(_NSRange)a4 replacementString:(id)a5
{
  ...
  -[SUUITextFieldSettingDescriptionView _updateTextFieldValue:](self, "_updateTextFieldValue:", v11);
  return 1;
}
...
- (BOOL)textFieldShouldReturn:(id)a3
{
  ...
  -[SUUIFieldSettingDescription controller](self->_settingDescription, "controller", a3);
...
- (void)tintColorDidChange
{
  ...
  -[SUUITextFieldSettingDescriptionView tintColorDidChange](&v3, sel_tintColorDidChange);
  -[SUUITextFieldSettingDescriptionView setNeedsLayout](self, "setNeedsLayout");
}
...
- (void)layoutSubviews
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)SUUITextFieldSettingDescriptionView;
  -[SUUITextFieldSettingDescriptionView layoutSubviews](&v7, sel_layoutSubviews);
  objc_msgSend(MEMORY[0x24BEBB520], "preferredFontForTextStyle:", *MEMORY[0x24BEBE1D0]);
  ...
  else
  {
    ...
    -[SUUITextFieldSettingDescriptionView _fillLayoutWithView:labelForBaselinePosition:](self, "_fillLayoutWithView:labelForBaselinePosition:", v5, v6);
...
- (void)_addInputWithElement:(id)a3
{
  ...
  if (objc_msgSend(v5, "isMemberOfClass:", objc_opt_class()))
    -[SUUITextFieldSettingDescriptionView _addTextInputWithElement:](self, "_addTextInputWithElement:", v5);
...
- (void)_addLabelWithElement:(id)a3
{
  ...
  -[SUUITextFieldSettingDescriptionView addSubview:](self, "addSubview:", self->_label);
}
...
- (void)_addTextInputWithElement:(id)a3
{
  ...
  -[SUUITextFieldSettingDescriptionView _currentControllerValue](self, "_currentControllerValue");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = (void *)objc_msgSend(v9, "initWithObjectsAndKeys:", v10, *MEMORY[0x24BEBB368], 0);
  ...
  -[SUUITextFieldSettingDescriptionView addSubview:](self, "addSubview:", self->_textField);
...
- (void)_alignView:(id)a3 withBaselineLabel:(id)a4 font:(id)a5 offsetX:(double)a6 fitWidth:(double)a7
{
  ...
  v13 = a4;
  v27 = a3;
  -[SUUITextFieldSettingDescriptionView bounds](self, "bounds");
  v15 = v14;
  v17 = v16;
  v19 = v18;
  v21 = v20;
...
- (void)_arrangeTextField:(id)a3 andLabel:(id)a4
{
  ...
  v19 = v18;
  v21 = v20;
  -[SUUITextFieldSettingDescriptionView _alignView:withBaselineLabel:font:offsetX:fitWidth:](self, "_alignView:withBaselineLabel:font:offsetX:fitWidth:", v8, v8, v22, v11, self->_aggregateLabelWidth);
  v23.origin.x = v15;
  v23.origin.y = v17;
  v23.size.width = v19;
  v23.size.height = v21;
  -[SUUITextFieldSettingDescriptionView _alignView:withBaselineLabel:font:offsetX:fitWidth:](self, "_alignView:withBaselineLabel:font:offsetX:fitWidth:", v9, v8, v22, v11 + self->_aggregateLabelWidth + 16.0, CGRectGetWidth(v23) - (v11 + self->_aggregateLabelWidth + 16.0) - v13);
...
- (void)_updateTextFieldValue:(id)a3
{
  ...
  if (!v4)
    v4 = &stru_2511FF0C8;
  v7 = (__CFString *)v4;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCE70]), "initWithObjectsAndKeys:", v4, CFSTR("value"), 0);
  -[SUUIInputViewElement dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:](self->_inputViewElement, "dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:", 15, 1, 1, v5, 0);
  -[SUUIFieldSettingDescription controller](self->_settingDescription, "controller");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_fillLayoutWithView:(id)a3 labelForBaselinePosition:(id)a4
{
  ...
  v13 = v12;
  -[SUUITextFieldSettingDescriptionView bounds](self, "bounds");
  -[SUUITextFieldSettingDescriptionView _alignView:withBaselineLabel:font:offsetX:fitWidth:](self, "_alignView:withBaselineLabel:font:offsetX:fitWidth:", v9, v8, v14, v11, CGRectGetWidth(v15) - v11 - v13);
