...
- (SUUIScreenshotsViewController)initWithTrailers:(id)a3 screenshots:(id)a4 clientContext:(id)a5
{
  ...
  id v9;
  id v10;
  SUUIScreenshotsViewController *v11;
  SUUIScreenshotsViewController *v12;
  ...
  double height;
  uint64_t v42;
  SUUIScreenshotDataConsumer *dataConsumer;
  uint64_t v44;
  uint64_t v45;
  SUUIVideoImageDataConsumer *trailerConsumer;
  uint64_t v47;
  SUUIVideoImageDataConsumer *v48;
  id v50;
  __int128 v51;
  __int128 v52;
  __int128 v53;
  ...
  v11 = -[SUUIScreenshotsViewController init](&v55, sel_init);
  v12 = v11;
  if (v11)
  {
    v50 = v10;
    ...
    v34 = SUUIUserInterfaceIdiom(*p_clientContext);
    if (v34)
    {
      if (v27 == 1.0)
        v35 = v26;
    ...
    +[SUUIScreenshotDataConsumer consumerWithScreenshotSize:](SUUIScreenshotDataConsumer, "consumerWithScreenshotSize:", width, v12->_screenshotMaxSize.height);
    v42 = objc_claimAutoreleasedReturnValue();
    dataConsumer = v12->_dataConsumer;
    v12->_dataConsumer = (SUUIScreenshotDataConsumer *)v42;

    -[SUUIScreenshotDataConsumer setForcesPortrait:](v12->_dataConsumer, "setForcesPortrait:", v34 == 0);
    v10 = v50;
    if (-[NSArray count](v12->_trailers, "count"))
    {
      if (v34)
        ...
        v44 = 1;
      +[SSVURLDataConsumer consumer](SUUIVideoImageDataConsumer, "consumer");
      v45 = objc_claimAutoreleasedReturnValue();
      trailerConsumer = v12->_trailerConsumer;
      v12->_trailerConsumer = (SUUIVideoImageDataConsumer *)v45;

      -[SUUIVideoImageDataConsumer setAllowedOrientations:](v12->_trailerConsumer, "setAllowedOrientations:", v44);
      v47 = SUUIUserInterfaceIdiom(*p_clientContext);
      ...
      else
      {
        ...
        v12->_screenshotMaxSize = (CGSize)xmmword_241EFC250;
      }
    }
  }
...
- (void)reloadData
{
  ...
  if (-[NSArray count](self->_screenshots, "count"))
  {
    ...
    do
    {
      ...
      if (v11)
      {
        v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2040]), "initWithURL:", v11);
      ...
      -[SUUIScreenshotDataConsumer imageForColor:size:](dataConsumer, "imageForColor:size:", v19, v15, v17);
      v20 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[NSArray count](self->_trailers, "count"))
  {
    ...
    do
    {
      ...
      if (v27)
      {
        v28 = objc_alloc(MEMORY[0x24BEB2040]);
        objc_msgSend(v26, "URL");
      ...
      if (v26
        && (-[SUUIVideoImageDataConsumer allowedOrientations](self->_trailerConsumer, "allowedOrientations") & 2) != 0)
      {
      ...
      -[SUUIVideoImageDataConsumer imageForColor:orientation:](trailerConsumer, "imageForColor:orientation:", v35, v31);
...
- (void)loadView
{
  SUUISwooshCollectionViewLayout *v3;
  id v4;
  UICollectionView *v5;
  ...
  -[SUUIScreenshotsViewController setView:](self, "setView:", v11);
  v3 = objc_alloc_init(SUUISwooshCollectionViewLayout);
  -[SUUISwooshCollectionViewLayout setSnapsToItemBoundaries:](v3, "setSnapsToItemBoundaries:", 1);
  ...
  -[SUUIScreenshotsView bounds](v11, "bounds");
  ...
  -[SUUIScreenshotsView setPrimaryView:](v11, "setPrimaryView:", self->_collectionView);
...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  if (!objc_msgSend(v12, "section"))
  {
    ...
    v7 = (SUUISlideshowViewController *)objc_claimAutoreleasedReturnValue();
    if (!v7)
    {
LABEL_10:
    ...
    v8 = -[SUUIPlayableAsset initWithVideo:]([SUUIPlayableAsset alloc], "initWithVideo:", v7);
    -[SUUIScreenshotsViewController clientContext](self, "clientContext");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    SUUIVideoPreviewPlayPlayableAsset(v8, v10);
    v11 = (void *)objc_claimAutoreleasedReturnValue();

    -[SUUIScreenshotsViewController presentViewController:animated:completion:](self, "presentViewController:animated:completion:", v11, 1, 0);
LABEL_9:
  ...
  if (objc_msgSend(v12, "section") == 1)
  {
    ...
    if ((v6 & 0xFFFFFFFFFFFFFFFBLL) == 1)
    {
      ...
      -[SUUISlideshowViewController setClientContext:](v7, "setClientContext:", self->_clientContext);
      -[SUUISlideshowViewController setDataSource:](v7, "setDataSource:", self);
      -[SUUISlideshowViewController setDelegate:](v7, "setDelegate:", self);
      -[SUUISlideshowViewController setCurrentIndex:](v7, "setCurrentIndex:", objc_msgSend(v12, "item"));
      v8 = (SUUIPlayableAsset *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD7A0]), "initWithRootViewController:", v7);
      -[SUUIPlayableAsset setTransitioningDelegate:](v8, "setTransitioningDelegate:", v7);
      v9 = v8;
    }
    else
    {
      ...
      -[SUUISlideshowViewController setDataSource:](v7, "setDataSource:", self);
      -[SUUISlideshowViewController setCurrentIndex:](v7, "setCurrentIndex:", objc_msgSend(v12, "item"));
      v9 = (SUUIPlayableAsset *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD7A0]), "initWithRootViewController:", v7);
      v8 = v9;
    }
    -[SUUIPlayableAsset setModalPresentationStyle:](v9, "setModalPresentationStyle:", 17);
    -[SUUIScreenshotsViewController presentViewController:animated:completion:](self, "presentViewController:animated:completion:", v8, 1, 0);
    goto LABEL_9;
  }
LABEL_11:
...
- (id)slideshowViewController:(id)a3 dataConsumerAtIndex:(int64_t)a4
{
  ...
  +[SUUIScreenshotDataConsumer consumerWithScreenshotSize:](SUUIScreenshotDataConsumer, "consumerWithScreenshotSize:");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BEBD538], "currentDevice");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)slideshowViewController:(id)a3 scrollToImageAtIndex:(int64_t)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", a4, 1);
...
- (id)slideshowViewController:(id)a3 poppedImageViewAtIndex:(int64_t)a4
{
  ...
  if (v7)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIIPhoneSlideshowCell setImage:](v8, "setImage:", v9);

    -[SUUIIPhoneSlideshowCell layoutSubviews](v8, "layoutSubviews");
    -[UICollectionView addSubview:](self->_collectionView, "addSubview:", v8);
    -[SUUIScreenshotsViewController view](self, "view");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIIPhoneSlideshowCell imageFrame](v8, "imageFrame");
    ...
    -[SUUIIPhoneSlideshowCell removeFromSuperview](v8, "removeFromSuperview");
    -[NSMutableArray objectAtIndex:](self->_screenshotImages, "objectAtIndex:", objc_msgSend(v5, "item"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDBCEF8], "null");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v19 == v20)
      v21 = objc_alloc_init(MEMORY[0x24BEBD668]);
    else
      v21 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BEBD668]), "initWithImage:", v19);
    v22 = v21;
    objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
...
{
  SUUIScreenshotsDelegate **p_delegate;
  id WeakRetained;
  void *v6;
  id v7;
  char v8;
...
- (void)_setImage:(id)a3 forIndex:(int64_t)a4
{
  ...
  if (a3)
  {
    dataConsumer = self->_dataConsumer;
    v7 = a3;
    -[SUUIScreenshotDataConsumer imageForImage:](dataConsumer, "imageForImage:", v7);
...
{
  return (SUUIScreenshotsDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
