...
{
  id v4;
  SUUIBrickSwooshViewController *v5;
  void *v6;
  uint64_t v7;
  NSArray *bricks;
  uint64_t v9;
  ...
  v5 = -[SUUIBrickSwooshViewController init](&v12, sel_init);
  if (v5)
  {
...
- (void)dealloc
{
  ...
  -[SUUIBrickSwooshViewController dealloc](&v3, sel_dealloc);
}
...
- (id)popImageViewForItemAtIndex:(int64_t)a3
{
  ...
  if (v7)
  {
    ...
    -[SUUIBrickSwooshViewController view](self, "view");
    ...
    {
      v22 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x24BDD1698]);
...
- (void)setClientContext:(id)a3
{
  ...
  -[SUUISwooshViewController setClientContext:](&v7, sel_setClientContext_, a3);
  -[SUUIBrickSwooshViewController _brickSwooshMetrics](self, "_brickSwooshMetrics");
...
- (void)loadView
{
  ...
  UICollectionView *collectionView;
  double cellHeight;
  SUUISwooshCollectionViewLayout *v19;
  ...
  if (!self->_swooshView)
  {
    ...
    -[SUUISwooshView setTitle:](self->_swooshView, "setTitle:", self->_swooshTitle);
    -[SUUISwooshView contentInsets](self->_swooshView, "contentInsets");
    v8 = v7;
    v10 = v9;
    v12 = v11;
    -[SUUISwooshView collectionViewInsets](self->_swooshView, "collectionViewInsets");
  ...
  if (!collectionView)
  {
    ...
    -[SUUISwooshCollectionViewLayout setSnapsToItemBoundaries:](v19, "setSnapsToItemBoundaries:", 1);
    v20 = (UICollectionView *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD450]), "initWithFrame:collectionViewLayout:", v19, 0.0, 0.0, 0.0, cellHeight);
  ...
  -[SUUIBrickSwooshViewController setView:](self, "setView:", self->_swooshView);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[SUUIBrickSwooshViewController viewWillAppear:](&v13, sel_viewWillAppear_, 1);
