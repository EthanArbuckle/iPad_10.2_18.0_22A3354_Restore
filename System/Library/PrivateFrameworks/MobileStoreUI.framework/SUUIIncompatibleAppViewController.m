...
- (SUUIIncompatibleAppViewController)initWithIncompatibleItem:(id)a3
{
  ...
  v6 = -[SUUIIncompatibleAppViewController init](&v10, sel_init);
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_incompatibleItem, a3);
    -[SUUIItem title](v7->_incompatibleItem, "title");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIIncompatibleAppViewController setTitle:](v7, "setTitle:", v8);
...
- (void)dealloc
{
  ...
  -[SUUIIncompatibleAppView removeButtonTarget:action:forControlEvents:](self->_incompatibleView, "removeButtonTarget:action:forControlEvents:", self, 0, 0xFFFFFFFFLL);
  v3.receiver = self;
...
- (void)reloadData
{
  ...
  {
    -[SUUIIncompatibleAppViewController _artworkContext](self, "_artworkContext");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "URLForItem:", self->_incompatibleItem);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    if (v4)
    {
      v5 = (SSVLoadURLOperation *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2040]), "initWithURL:", v4);
      ...
      -[SUUIIncompatibleAppViewController operationQueue](self, "operationQueue", v11, v12, v13, v14);
...
- (void)loadView
{
  SUUIIncompatibleAppView *incompatibleView;
  void *v4;
  SUUIIncompatibleAppView *v5;
  SUUIIncompatibleAppView *v6;
  SUUIIncompatibleAppView *v7;
  void *v8;
  ...
  void *v15;
  SUUIIncompatibleAppView *v16;
  void *v17;
  void *v18;
  void *v19;
  SUUIIncompatibleAppView *v20;
  void *v21;
  void *v22;
  void *v23;
  SUUIIncompatibleAppView *v24;
  void *v25;
  void *v26;
  void *v27;
  SUUIIncompatibleAppView *v28;
  void *v29;
  void *v30;
  void *v31;
  SUUIIncompatibleAppView *v32;
  void *v33;
  void *v34;
  uint64_t v35;
  void *v36;
  ...
  if (!incompatibleView)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIIncompatibleAppView setBackgroundColor:](v7, "setBackgroundColor:", v8);
...
LABEL_29:
    ...
    v35 = -[SUUIItem itemKind](incompatibleItem, "itemKind");
    v36 = v4;
    if (v35 == 5)
    {
      if (v4)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("INCOMPATIBLE_MAC_APP_TITLE"), 0, CFSTR("ProductPage"));
...
LABEL_18:
        ...
        -[SUUIIncompatibleAppView setMessage:](v20, "setMessage:", v23);
        ...
        -[SUUIIncompatibleAppView setIconImage:](v24, "setIconImage:", v26);
        ...
        if (v35 != 5)
        {
          ...
          if (v36)
            ...
            +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("INCOMPATIBLE_LEARN_MORE_ABOUT_IPAD"), 0, CFSTR("ProductPage"));
          v29 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIIncompatibleAppView addButtonWithTitle:](v28, "addButtonWithTitle:", v29);
          v30 = (void *)objc_claimAutoreleasedReturnValue();

          objc_msgSend(v30, "addTarget:action:forControlEvents:", self, sel__learnMoreAboutIPad_, 64);
        }
        -[SUUIProductPageItem supportURLString](self->_incompatibleItem, "supportURLString");
        ...
        if (v31)
        {
          ...
          if (v36)
            ...
            +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("INCOMPATIBLE_LEARN_MORE_ABOUT_APP"), 0, CFSTR("ProductPage"));
          v33 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIIncompatibleAppView addButtonWithTitle:](v32, "addButtonWithTitle:", v33);
    ...
    else
    {
      ...
      if (v10)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("INCOMPATIBLE_IPAD_APP_TITLE"), 0, CFSTR("ProductPage"));
      v37 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_30:
  -[SUUIIncompatibleAppViewController setView:](self, "setView:", incompatibleView);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v3 = a3;
  -[SUUIIncompatibleAppViewController reloadData](self, "reloadData");
  v5.receiver = self;
...
- (void)_learnMoreAboutApp:(id)a3
{
  ...
  -[SUUIProductPageItem supportURLString](self->_incompatibleItem, "supportURLString", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (v3)
  {
    v6 = v3;
...
- (void)_learnMoreAboutIPad:(id)a3
{
  ...
  v3 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", CFSTR("http://apple.com/ipad"));
...
- (id)_artworkContext
{
  ...
  if (!artworkContext)
  {
    +[SUUIItemArtworkContext lockupContextWithSize:](SUUIItemArtworkContext, "lockupContextWithSize:", 3);
    v4 = (SUUIItemArtworkContext *)objc_claimAutoreleasedReturnValue();
...
- (void)_setArtworkWithImage:(id)a3 error:(id)a4
{
  ...
  if (v7)
  {
    ...
    -[SUUIIncompatibleAppView setIconImage:](self->_incompatibleView, "setIconImage:", self->_iconImage);
  }
  loadIconOperation = self->_loadIconOperation;
