...
- (SUUIGridPageSection)initWithPageComponent:(id)a3
{
  ...
  v5 = -[SUUIStorePageSection initWithPageComponent:](&v34, sel_initWithPageComponent_, v4);
  if (v5)
  {
    v6 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 5, 0, 0);
        ...
        if (v14)
        {
          ...
          do
          {
            for (i = 0; i != v15; ++i)
            {
              ...
              v21 = SUUILockupImageSizeForLockupSize(v19, objc_msgSend(v20, "itemKind"));
              v27 = v22;
              v28 = v21;
...
- (id)cellForIndexPath:(id)a3
{
  ...
  switch(objc_msgSend(v5, "gridType"))
  {
    ...
    case 5:
      ...
      -[SUUIGridPageSection _itemCellWithLockups:indexPath:](self, "_itemCellWithLockups:indexPath:", v7, v4);
      v8 = objc_claimAutoreleasedReturnValue();
      goto LABEL_6;
    case 1:
      objc_msgSend(v5, "children");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIGridPageSection _editorialLockupCellWithLockups:indexPath:](self, "_editorialLockupCellWithLockups:indexPath:", v7, v4);
      v8 = objc_claimAutoreleasedReturnValue();
      goto LABEL_6;
    case 3:
      objc_msgSend(v5, "children");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIGridPageSection _editorialCellWithEditorials:indexPath:](self, "_editorialCellWithEditorials:indexPath:", v7, v4);
      v8 = objc_claimAutoreleasedReturnValue();
      goto LABEL_6;
    case 4:
      objc_msgSend(v5, "children");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIGridPageSection _mediaCellWithMedia:indexPath:](self, "_mediaCellWithMedia:indexPath:", v7, v4);
      v8 = objc_claimAutoreleasedReturnValue();
LABEL_6:
      v6 = (void *)v8;
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  switch(v7)
  {
    case 0:
    case 5:
      -[SUUIGridPageSection _heightForLockupAtIndexPath:gridType:](self, "_heightForLockupAtIndexPath:gridType:", v4, v7);
      goto LABEL_9;
    case 1:
      -[SUUIGridPageSection _heightForEditorialLockupAtIndexPath:](self, "_heightForEditorialLockupAtIndexPath:", v4);
      goto LABEL_9;
    case 3:
      -[SUUIGridPageSection _heightForEditorialAtIndexPath:](self, "_heightForEditorialAtIndexPath:", v4);
      goto LABEL_9;
    case 4:
      -[SUUIGridPageSection _heightForMediaAtIndexPath:](self, "_heightForMediaAtIndexPath:", v4);
LABEL_9:
      v5 = v8;
      break;
    default:
  ...
  if (numberOfColumns != 1)
  {
    if (v7 == 5)
    {
      -[SUUIGridPageSection _contentInsetForVideoLockupIndex:](self, "_contentInsetForVideoLockupIndex:", objc_msgSend(v4, "item"));
      v12 = v15 + v14 + 221.0;
    }
    else
    {
...
- (id)clickEventWithItem:(id)a3 elementName:(id)a4 index:(int64_t)a5
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIGridPageSection _setPositionForClickEvent:withElementIndex:](self, "_setPositionForClickEvent:withElementIndex:", v7, a5);
  return v7;
}
...
- (void)collectionViewDidConfirmItemOfferAtIndexPath:(id)a3
{
  ...
  -[SUUIGridPageSection _itemForIndex:](self, "_itemForIndex:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    -[SUUIStorePageSection context](self, "context");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection itemOfferClickEventWithItem:elementName:index:](self, "itemOfferClickEventWithItem:elementName:index:", v5, *MEMORY[0x24BEB2978], v4);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    if (v7)
    {
    ...
    -[SUUIStorePageSection performItemOfferActionForItem:](self, "performItemOfferActionForItem:", v5);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)collectionViewDidEndDisplayingCellForItemAtIndexPath:(id)a3
{
  ...
  -[SUUIGridPageSection _itemForIndex:](self, "_itemForIndex:", objc_msgSend(a3, "item"));
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  -[SUUIGridPageSection _itemForIndex:](self, "_itemForIndex:", v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    -[SUUIGridPageSection _selectItem:withIndex:](self, "_selectItem:withIndex:", v6, v5);
  }
  else if (objc_msgSend(v4, "gridType") == 4)
  {
    ...
    if (v5 < objc_msgSend(v7, "count"))
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIStorePageSection clickEventWithMedia:elementName:index:](self, "clickEventWithMedia:elementName:index:", v9, *MEMORY[0x24BEB2978], v5);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      if (v10)
      {
      ...
      else
      {
        ...
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        -[SUUIStorePageSection showPageWithLink:](self, "showPageWithLink:", v13);
      }
...
- (void)collectionViewDidTapVideoAtIndexPath:(id)a3
{
  ...
  v4 = a3;
  -[SUUIGridPageSection _itemForIndex:](self, "_itemForIndex:", objc_msgSend(v4, "item"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v8)
  {
    ...
    v12 = v11;
    v13 = v10;
    -[SUUIGridPageSection _enumerateVisibleIndexPathsWithBlock:](self, "_enumerateVisibleIndexPathsWithBlock:", &v15);
...
- (void)collectionViewWillApplyLayoutAttributes:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", v5 / self->_numberOfColumns, objc_msgSend(v8, "section"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIStorePageSection backgroundColorForIndexPath:](self, "backgroundColorForIndexPath:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  if (self->_containsLockups)
  {
    ...
    v25 = v29;
    v28 = v18;
    -[SUUIGridPageSection _enumerateItemsFromStartIndex:withBlock:](self, "_enumerateItemsFromStartIndex:withBlock:", v10, v23);
    -[SUUIGridPageSection _loadMissingItemsFromIndex:withReason:](self, "_loadMissingItemsFromIndex:withReason:", 0, a3);
...
void __51__SUUIGridPageSection_prefetchResourcesWithReason___block_invoke(uint64_t a1, void *a2, BOOL *a3)
{
  ...
  if (*(_QWORD *)(a1 + 72) == 5)
  {
    ...
    if (v9)
    {
      ...
      {
        +[SUUILockupItemCellLayout videoThumbnailSizeForVideo:clientContext:](SUUILockupItemCellLayout, "videoThumbnailSizeForVideo:clientContext:", v9, *(_QWORD *)(*(_QWORD *)(a1 + 32) + 96));
...
- (void)willAppearInContext:(id)a3
{
  ...
  SUUIVideoImageDataConsumer *v27;
  SUUIVideoImageDataConsumer *videoImageDataConsumer;
  SUUIVideoImageDataConsumer *v29;
  void *v30;
  uint64_t v31;
  SUUIVideoImageDataConsumer *v32;
  objc_super v33;
  __int128 v34;
  __int128 v35;
  __int128 v36;
  ...
  if ((v8 & 0xFFFFFFFFFFFFFFFDLL) == 1)
  {
    ...
    while (1)
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        if (v15 == 5)
        {
          -[SUUIGridPageSection _editorialLayoutForEditorial:](self, "_editorialLayoutForEditorial:", v14);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
        }
        else
        {
          if (v15 != 9)
            continue;
          -[SUUIGridPageSection _editorialLayoutForLockup:](self, "_editorialLayoutForLockup:", v14);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
        }
        v17 = v16;
...
LABEL_14:
  ...
  if (self->_isPad)
  {
    ...
    {
      self->_isLandscape = 0;
      v20 = -[SUUIGridPageSection _numberOfPortraitColumnsWithGridType:](self, "_numberOfPortraitColumnsWithGridType:", v8);
    }
    else
    {
      self->_isLandscape = 1;
      v20 = -[SUUIGridPageSection _numberOfLandscapeColumnsWithGridType:](self, "_numberOfLandscapeColumnsWithGridType:", v8);
    }
  ...
  v25 = (SUUIClientContext *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIVideoImageDataConsumer setColorScheme:](v29, "setColorScheme:", v30);

  v31 = SUUIUserInterfaceIdiom(self->_clientContext);
  v32 = self->_videoImageDataConsumer;
  if (v31 == 1)
  {
    -[SUUIVideoImageDataConsumer setAllowedOrientations:](v32, "setAllowedOrientations:", 2);
    -[SUUIVideoImageDataConsumer setLandscapeSize:](self->_videoImageDataConsumer, "setLandscapeSize:", 221.0, 166.0);
  }
  else
  {
    -[SUUIVideoImageDataConsumer setAllowedOrientations:](v32, "setAllowedOrientations:", 3);
  ...
  -[SUUIStorePageSection willAppearInContext:](&v33, sel_willAppearInContext_, v4);
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
        ...
        v10 > 375.0))
  {
    ...
    if ((v12 & 0xFFFFFFFFFFFFFFFDLL) == 1)
      -[SUUIGridPageSection _updateVisibileEditorialWithEditorialOrientation:](self, "_updateVisibileEditorialWithEditorialOrientation:", self->_isLandscape);
    if (self->_isPad)
    {
      if (self->_isLandscape)
        v13 = -[SUUIGridPageSection _numberOfLandscapeColumnsWithGridType:](self, "_numberOfLandscapeColumnsWithGridType:", v12);
      else
        v13 = -[SUUIGridPageSection _numberOfPortraitColumnsWithGridType:](self, "_numberOfPortraitColumnsWithGridType:", v12);
    }
    ...
    if (v12 == 5)
    {
      ...
      v20 = self;
      v16 = v15;
      -[SUUIGridPageSection _enumerateVisibleIndexPathsWithBlock:](self, "_enumerateVisibleIndexPathsWithBlock:", v18);
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  if (containsLockups)
  {
    ...
    v15 = v6;
    v16 = v9;
    -[SUUIGridPageSection _enumerateVisibleItemsWithBlock:](self, "_enumerateVisibleItemsWithBlock:", v25);
  ...
  else
  {
    ...
    v15 = v9;
    v16 = v17;
    -[SUUIGridPageSection _enumerateVisibleIndexPathsWithBlock:](self, "_enumerateVisibleIndexPathsWithBlock:", v19);
...
- (void)mediaView:(id)a3 playbackStateDidChange:(int64_t)a4
{
  ...
  if (v22)
  {
    ...
    if (v24 == -[SUUIStorePageSection sectionIndex](self, "sectionIndex"))
    {
      -[SUUIStorePageSection context](self, "context");
      ...
      if (objc_msgSend(v26, "canRecordEventWithType:", *MEMORY[0x24BEB2920]))
      {
        v27 = objc_alloc_init(MEMORY[0x24BEB1F08]);
        ...
        if (v36)
        {
          objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", v36);
...
void __57__SUUIGridPageSection_itemStateCenter_itemStatesChanged___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  v13 = a3;
  v5 = (objc_class *)MEMORY[0x24BDD16E0];
  v6 = a2;
  v7 = [v5 alloc];
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if (objc_msgSend(v7, "count"))
  {
    ...
    if (objc_msgSend(v10, "count"))
    {
      ...
      v15 = v14;
      v16 = v12;
      -[SUUIGridPageSection _enumerateVisibleItemsWithBlock:](self, "_enumerateVisibleItemsWithBlock:", v19);
...
void __77__SUUIGridPageSection_missingItemLoader_didLoadItems_invalidItemIdentifiers___block_invoke_2(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x24BDD15E0], "indexSetWithIndex:", objc_msgSend(*(id *)(a1 + 32), "sectionIndex"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)productPageOverlayDidDismiss:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", self->_overlaySourceItemIndex, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_artworkContextForLockupSize:(int64_t)a3
{
  ...
  {
    v6 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 1282, 0, 0);
  ...
  v8 = (SUUIItemArtworkContext *)objc_claimAutoreleasedReturnValue();
  if (!v8)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemArtworkContext setColorScheme:](v8, "setColorScheme:", v10);

    +[SUUIProductImageDataConsumer lockupConsumerWithSize:itemKind:](SUUIProductImageDataConsumer, "lockupConsumerWithSize:itemKind:", a3, 7);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemArtworkContext setGeneralConsumer:](v8, "setGeneralConsumer:", v11);

    +[SUUIStyledImageDataConsumer lockupIconConsumerWithSize:](SUUIStyledImageDataConsumer, "lockupIconConsumerWithSize:", a3);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemArtworkContext setIconConsumer:](v8, "setIconConsumer:", v12);

    +[SUUIProductImageDataConsumer lockupConsumerWithSize:itemKind:](SUUIProductImageDataConsumer, "lockupConsumerWithSize:itemKind:", a3, 8);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemArtworkContext setLetterboxConsumer:](v8, "setLetterboxConsumer:", v13);
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemArtworkContext setNewsstandConsumer:](v8, "setNewsstandConsumer:", v14);

    +[SUUIProductImageDataConsumer lockupConsumerWithSize:itemKind:](SUUIProductImageDataConsumer, "lockupConsumerWithSize:itemKind:", a3, 6);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemArtworkContext setPosterConsumer:](v8, "setPosterConsumer:", v15);
...
- (id)_cellImageForItem:(id)a3 lockupSize:(int64_t)a4
{
  ...
  if (!v11)
  {
    ...
    {
LABEL_5:
      -[SUUIGridPageSection _artworkContextForLockupSize:](self, "_artworkContextForLockupSize:", a4);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_4:
    -[SUUIGridPageSection _loadImageForItem:lockupSize:loader:reason:](self, "_loadImageForItem:lockupSize:loader:reason:", v6, a4, v8, 1);
    goto LABEL_5;
  }
LABEL_6:
...
- (id)_editorialCellWithEditorials:(id)a3 indexPath:(id)a4
{
  ...
  objc_msgSend(v8, "collectionView");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x251211FC8, v7);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "layout");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_editorialLayoutForEditorial:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = -[SUUIEditorialLayout initWithEditorial:layoutCache:](v6, "initWithEditorial:layoutCache:", v4, v8);
    ...
    {
      v15 = v14 * 0.5 + -30.0;
      -[SUUIEditorialLayout setLayoutWidth:forOrientation:](v5, "setLayoutWidth:forOrientation:", 1, floorf(v15));
      v16 = v12 * 0.5 + -30.0;
      v17 = floorf(v16);
    }
    else
    {
      -[SUUIEditorialLayout setLayoutWidth:forOrientation:](v5, "setLayoutWidth:forOrientation:", 1, v14 + -30.0);
      v17 = v12 + -30.0;
    }
    -[SUUIEditorialLayout setLayoutWidth:forOrientation:](v5, "setLayoutWidth:forOrientation:", 0, v17);
    editorialLayouts = self->_editorialLayouts;
    if (!editorialLayouts)
    {
      v19 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
...
- (id)_editorialLayoutForLockup:(id)a3
{
  ...
  if (!v5)
  {
    ...
    -[SUUIEditorialLayout setLayoutWidth:forOrientation:](v5, "setLayoutWidth:forOrientation:", 0, v12);
    editorialLayouts = self->_editorialLayouts;
    if (!editorialLayouts)
    {
      v14 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 517, 0, 0);
...
- (id)_editorialLockupCellWithLockups:(id)a3 indexPath:(id)a4
{
  ...
  objc_msgSend(v8, "collectionView");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x251200848, v7);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "layout");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    objc_msgSend(v6, "objectAtIndex:", v13);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection _reloadEditorialLockupCell:withLockup:index:](self, "_reloadEditorialLockupCell:withLockup:index:", v10, v17, v13);
...
- (void)_enumerateVisibleItemsWithBlock:(id)a3
{
  ...
  v7 = v4;
  v5 = v4;
  -[SUUIGridPageSection _enumerateVisibleIndexPathsWithBlock:](self, "_enumerateVisibleIndexPathsWithBlock:", v6);
...
- (double)_heightForEditorialAtIndexPath:(id)a3
{
  ...
  if (self->_numberOfColumns == 1)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection _editorialLayoutForEditorial:](self, "_editorialLayoutForEditorial:", v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection _editorialLayoutForEditorial:](self, "_editorialLayoutForEditorial:", v13);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v15 < objc_msgSend(v6, "count"))
    {
      ...
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIGridPageSection _editorialLayoutForEditorial:](self, "_editorialLayoutForEditorial:", v16);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)_heightForEditorialLockup:(id)a3
{
  ...
  v4 = a3;
  +[SUUILockupItemCellLayout heightForLockupComponent:clientContext:](SUUILockupItemCellLayout, "heightForLockupComponent:clientContext:", v4, self->_clientContext);
  v6 = v5;
  -[SUUIGridPageSection _editorialLayoutForLockup:](self, "_editorialLayoutForLockup:", v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)_heightForEditorialLockupAtIndexPath:(id)a3
{
  ...
  if (self->_numberOfColumns == 1)
  {
    objc_msgSend(v6, "objectAtIndex:", v4);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection _heightForEditorialLockup:](self, "_heightForEditorialLockup:", v7);
    v9 = v8;
  }
  else
  {
    ...
    if (v12 < objc_msgSend(v6, "count"))
    {
      objc_msgSend(v6, "objectAtIndex:", v12);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIGridPageSection _heightForEditorialLockup:](self, "_heightForEditorialLockup:", v13);
      if (v9 < v14)
        v9 = v14;
...
- (double)_heightForLockupAtIndexPath:(id)a3 gridType:(int64_t)a4
{
  ...
  if (numberOfColumns == 1)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    +[SUUILockupItemCellLayout heightForLockupComponent:clientContext:](SUUILockupItemCellLayout, "heightForLockupComponent:clientContext:", v11, self->_clientContext);
    i = v12;
  ...
  else
  {
    ...
    for (i = 0.0; v14 < objc_msgSend(v8, "count"); ++v14)
    {
      ...
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      +[SUUILockupItemCellLayout heightForLockupComponent:clientContext:](SUUILockupItemCellLayout, "heightForLockupComponent:clientContext:", v15, self->_clientContext);
      v17 = v16;
  ...
  if (a4 == 5)
  {
    -[SUUIGridPageSection _contentInsetForVideoLockupIndex:](self, "_contentInsetForVideoLockupIndex:", objc_msgSend(v6, "item"));
    i = i + v18 + v19;
  }
  else if (!a4)
  {
...
- (double)_heightForMediaAtIndexPath:(id)a3
{
  ...
  -[SUUIGridPageSection _mediaWidthForMediaIndex:gridWidth:](self, "_mediaWidthForMediaIndex:gridWidth:", v11, v8);
  v13 = v12;
  if (self->_numberOfColumns == 1)
  {
    objc_msgSend(v10, "objectAtIndex:", v11);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection _heightForMedia:width:](self, "_heightForMedia:width:", v14, v13);
    v16 = v15;
  ...
  else
  {
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection _heightForMedia:width:](self, "_heightForMedia:width:", v18, v13);
    v16 = v19;
    ...
    if (v11 < objc_msgSend(v10, "count"))
    {
      objc_msgSend(v10, "objectAtIndex:", v11);
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIGridPageSection _heightForMedia:width:](self, "_heightForMedia:width:", v20, v13);
      v22 = v21;
  ...
  -[SUUIGridPageSection _contentInsetForMediaIndex:](self, "_contentInsetForMediaIndex:", v11);
  v25 = v16 + v23 + v24;
...
- (id)_itemCellWithLockups:(id)a3 indexPath:(id)a4
{
  ...
  objc_msgSend(v8, "collectionView");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x25120D368, v7);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v16 >= objc_msgSend(v6, "count"))
  {
    ...
    objc_msgSend(v14, "setVideoThumbnailSize:", *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
  ...
  else
  {
    ...
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIGridPageSection _reloadItemCell:withLockup:index:](self, "_reloadItemCell:withLockup:index:", v10, v17, v16);
...
- (void)_loadImageForItem:(id)a3 lockupSize:(int64_t)a4 loader:(id)a5 reason:(int64_t)a6
{
  ...
  if (v12)
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIArtworkRequest setDataConsumer:](v13, "setDataConsumer:", v15);

    -[SUUIArtworkRequest setURL:](v13, "setURL:", v12);
    artworkRequests = self->_artworkRequests;
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[SUUIResourceRequest requestIdentifier](v13, "requestIdentifier"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_loadImageForVideo:(id)a3 thumbnailSize:(CGSize)a4 loader:(id)a5 reason:(int64_t)a6
{
  ...
  if (v14)
  {
    ...
    -[SUUIArtworkRequest setDataConsumer:](v15, "setDataConsumer:", self->_videoImageDataConsumer);
    -[SUUIArtworkRequest setDelegate:](v15, "setDelegate:", self);
    -[SUUIArtworkRequest setURL:](v15, "setURL:", v14);
    artworkRequests = self->_artworkRequests;
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[SUUIResourceRequest requestIdentifier](v15, "requestIdentifier"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSMapTable setObject:forKey:](artworkRequests, "setObject:forKey:", v17, v18);
...
- (void)_loadMissingItemsFromIndex:(int64_t)a3 withReason:(int64_t)a4
{
  ...
  {
    -[SUUIGridPageSection _missingItemLoader](self, "_missingItemLoader");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_mediaCellWithMedia:(id)a3 indexPath:(id)a4
{
  ...
  objc_msgSend(v9, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x251201BC8, v7);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_6:
    ...
    if (v18)
    {
      v19 = -[SUUIGridPageSection _newSizeToFitArtworkRequestWithArtwork:mediaIndex:](self, "_newSizeToFitArtworkRequestWithArtwork:mediaIndex:", v18, v11);
      artworkRequests = self->_artworkRequests;
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v19, "requestIdentifier"));
      v20 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)_mediaWidthForMediaIndex:(int64_t)a3 gridWidth:(double)a4
{
  ...
  -[SUUIGridPageSection _contentInsetForMediaIndex:](self, "_contentInsetForMediaIndex:", a3);
  v8 = a4 * 0.5 - v6 - v7;
  result = floorf(v8);
  v10 = a4 - v6 - v7;
  if (self->_numberOfColumns == 1)
...
- (id)_newSizeToFitArtworkRequestWithArtwork:(id)a3 mediaIndex:(int64_t)a4
{
  ...
  +[SUUISizeToFitImageDataConsumer consumerWithConstraintSize:](SUUISizeToFitImageDataConsumer, "consumerWithConstraintSize:", v12, v9);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v14)
    {
      if (v13)
      {
        ...
        if ((v38 & 2) != 0)
        {
          ...
          {
            v35 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x24BDD1698]);
...
- (void)_reloadEditorialLockupCell:(id)a3 withLockup:(id)a4 index:(int64_t)a5
{
  ...
  objc_msgSend(v11, "lockupCellLayout");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIGridPageSection _cellImageForItem:lockupSize:](self, "_cellImageForItem:lockupSize:", v12, 0);
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIGridPageSection _editorialLayoutForLockup:](self, "_editorialLayoutForLockup:", v9);
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "applyEditorialLayout:withOrientation:", v31, SUUIEditorialLayoutOrientationForView(v10));
...
- (void)_reloadItemCell:(id)a3 withLockup:(id)a4 index:(int64_t)a5
{
  ...
  if (v10)
  {
    -[SUUIGridPageSection _cellImageForItem:lockupSize:](self, "_cellImageForItem:lockupSize:", v10, 0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v11, "setVideoThumbnailSize:", *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
...
- (void)_selectItem:(id)a3 withIndex:(int64_t)a4
{
  ...
  -[SUUIStorePageSection context](self, "context");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIGridPageSection clickEventWithItem:elementName:index:](self, "clickEventWithItem:elementName:index:", v6, *MEMORY[0x24BEB2978], a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
    ...
    || (objc_msgSend(v11, "sectionsViewController:showProductPageForItem:", v10, v6) & 1) == 0)
  {
    ...
    {
      v25 = -[SUUIPlayableAsset initWithVideo:]([SUUIPlayableAsset alloc], "initWithVideo:", v15);
      v26 = a4;
      -[SUUIStorePageSection context](self, "context");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      -[SUUIGridPageSection _showProductPageWithItem:index:animated:](self, "_showProductPageWithItem:index:animated:", v6, a4, 1);
    }
...
- (void)_showProductPageWithItem:(id)a3 index:(int64_t)a4 animated:(BOOL)a5
{
  ...
  v7 = a3;
  v8 = v7;
  if (self->_isPad && SUUIItemKindIsSoftwareKind(objc_msgSend(v7, "itemKind")))
  {
    ...
    v11 = a4;
    v10 = v8;
    -[SUUIStorePageSection sendXEventWithItem:completionBlock:](self, "sendXEventWithItem:completionBlock:", v10, v9);

  }
  else
  {
    -[SUUIStorePageSection showProductViewControllerWithItem:](self, "showProductViewControllerWithItem:", v8);
  }
...
void __63__SUUIGridPageSection__showProductPageWithItem_index_animated___block_invoke(uint64_t a1, char a2)
{
  ...
  if ((a2 & 1) == 0)
  {
    ...
    if (!*(_QWORD *)(v4 + 176))
    {
      v5 = -[SUUIProductPageOverlayController initWithParentViewController:]([SUUIProductPageOverlayController alloc], "initWithParentViewController:", v8);
      v6 = *(_QWORD *)(a1 + 32);
      v7 = *(void **)(v6 + 176);
      *(_QWORD *)(v6 + 176) = v5;
        ...
        if (objc_msgSend(v16, "section") == v7)
        {
          ...
          if (v17 < v10)
          {
            ...
            if (v9 == 1)
            {
              ...
              v23 = (void *)objc_claimAutoreleasedReturnValue();
              -[SUUIGridPageSection _editorialLayoutForLockup:](v25, "_editorialLayoutForLockup:", v23);
              v21 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            else
            {
              ...
              objc_msgSend(v27, "objectAtIndex:", v18);
              v20 = (void *)objc_claimAutoreleasedReturnValue();
              -[SUUIGridPageSection _editorialLayoutForEditorial:](v25, "_editorialLayoutForEditorial:", v20);
              v21 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_4:
  ...
  v13 = -[SUUISizeValue initWithSize:]([SUUISizeValue alloc], "initWithSize:", width, height);
  ...
  if (!v12)
  {
    if (width <= height)
      ...
      v14 = 2;
    -[SUUIVideoImageDataConsumer imageForColor:orientation:](self->_videoImageDataConsumer, "imageForColor:orientation:", 0, v14);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if (v12)
