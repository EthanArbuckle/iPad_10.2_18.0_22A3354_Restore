...
- (SUUIIPadCustomerReviewsHeaderView)initWithClientContext:(id)a3
{
  ...
  SUUIIPadCustomerReviewsHeaderView *v7;
  uint64_t v8;
  ...
  v6 = -[SUUIIPadCustomerReviewsHeaderView init](&v39, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    -[SUUIIPadCustomerReviewsHeaderView addSubview:](v7, "addSubview:", v7->_appSupportButton);
    objc_msgSend(MEMORY[0x24BEBD430], "buttonWithType:", 1);
    ...
    if (v5)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEWS_HEADER_BUTTON_WRITE_A_REVIEW_IPAD"), 0, CFSTR("ProductPage"));
    ...
    -[SUUIIPadCustomerReviewsHeaderView addSubview:](v7, "addSubview:", v7->_writeAReviewButton);
    ...
    if (v5)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEWS_HEADER_TITLE"), 0, CFSTR("ProductPage"));
    v32 = (void *)objc_claimAutoreleasedReturnValue();
    -[UILabel setText:](v31, "setText:", v32);

    -[UILabel sizeToFit](v7->_titleLabel, "sizeToFit");
    -[SUUIIPadCustomerReviewsHeaderView addSubview:](v7, "addSubview:", v7->_titleLabel);
    v33 = (UIView *)objc_alloc_init(MEMORY[0x24BEBDB00]);
    ...
    -[SUUIIPadCustomerReviewsHeaderView addSubview:](v7, "addSubview:", v7->_separatorView);
  }
...
- (void)dealloc
{
  ...
  -[SUUIIPadCustomerReviewsHeaderView dealloc](&v4, sel_dealloc);
}
...
- (void)setSelectedSortIndex:(int64_t)a3
{
  if (self->_selectedSortIndex != a3)
  {
    ...
    -[SUUIIPadCustomerReviewsHeaderView _reloadSortButton](self, "_reloadSortButton");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIIPadCustomerReviewsHeaderView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  titleLabel = self->_titleLabel;
  if (titleLabel)
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIIPadCustomerReviewsHeaderView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
...
- (void)menuViewController:(id)a3 didSelectItemAtIndex:(int64_t)a4
{
  if (self->_selectedSortIndex != a4)
  {
    ...
    -[SUUIIPadCustomerReviewsHeaderView _reloadSortButton](self, "_reloadSortButton", a3);
    -[SUUIIPadCustomerReviewsHeaderView sendActionsForControlEvents:](self, "sendActionsForControlEvents:", 4096);
  }
  -[UIPopoverController dismissPopoverAnimated:](self->_sortPopoverController, "dismissPopoverAnimated:", 1);
  -[SUUIIPadCustomerReviewsHeaderView _destroySortPopoverController](self, "_destroySortPopoverController");
}
...
- (void)_sortButtonAction:(id)a3
{
  ...
  double v15;
  void *v16;
  SUUIMenuViewController *v17;

  if (!self->_sortPopoverController)
  {
    v4 = a3;
    v17 = -[SUUIMenuViewController initWithMenuTitles:]([SUUIMenuViewController alloc], "initWithMenuTitles:", self->_sortTitles);
    -[SUUIMenuViewController setDelegate:](v17, "setDelegate:", self);
    -[SUUIMenuViewController setIndexOfCheckedTitle:](v17, "setIndexOfCheckedTitle:", self->_selectedSortIndex);
    v5 = (UIPopoverController *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD858]), "initWithContentViewController:", v17);
...
- (void)_reloadSortButton
{
  ...
  if (-[NSArray count](self->_sortTitles, "count"))
  {
    if (!self->_sortButton)
    {
      ...
      v5 = self->_sortButton;
      -[SUUIIPadCustomerReviewsHeaderView backgroundColor](self, "backgroundColor");
      ...
      -[SUUIIPadCustomerReviewsHeaderView addSubview:](self, "addSubview:", self->_sortButton);
    }
    if (!self->_sortLabel)
    {
      ...
      if (clientContext)
        -[SUUIClientContext localizedStringForKey:inTable:](clientContext, "localizedStringForKey:inTable:", CFSTR("REVIEWS_HEADER_SORT_BY"), CFSTR("ProductPage"));
      else
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REVIEWS_HEADER_SORT_BY"), 0, CFSTR("ProductPage"));
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      -[UILabel setText:](v23, "setText:", v25);

      -[UILabel sizeToFit](self->_sortLabel, "sizeToFit");
      -[SUUIIPadCustomerReviewsHeaderView addSubview:](self, "addSubview:", self->_sortLabel);
    }
    ...
    -[SUUIIPadCustomerReviewsHeaderView setNeedsLayout](self, "setNeedsLayout");
  }
  else
  {
