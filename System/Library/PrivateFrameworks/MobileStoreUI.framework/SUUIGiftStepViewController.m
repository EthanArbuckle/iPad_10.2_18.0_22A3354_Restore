...
- (SUUIGiftStepViewController)initWithGift:(id)a3 configuration:(id)a4
{
  ...
  v8 = -[SUUIGiftStepViewController init](&v12, sel_init);
  if (v8)
  {
...
- (void)finishGiftingWithResult:(BOOL)a3
{
  ...
  v3 = a3;
  -[SUUIGiftStepViewController navigationController](self, "navigationController");
  ...
  {
    -[SUUIGiftStepViewController parentViewController](self, "parentViewController");
