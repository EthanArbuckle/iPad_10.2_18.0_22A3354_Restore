...
- (SUUIEditorialLinkView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    v6 = -[SUUIEditorialLinkView _newButton](v3, "_newButton");
    -[SUUIEditorialLinkView addSubview:](v3, "addSubview:", v6);
    -[NSMutableArray addObject:](v3->_buttons, "addObject:", v6);

    v7 = -[SUUIEditorialLinkView _newButton](v3, "_newButton");
    -[SUUIEditorialLinkView addSubview:](v3, "addSubview:", v7);
    -[NSMutableArray addObject:](v3->_buttons, "addObject:", v7);
...
- (void)dealloc
{
  ...
  -[SUUIEditorialLinkView dealloc](&v8, sel_dealloc);
}
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        {
          -[SUUIEditorialLinkView tintColor](self, "tintColor", (_QWORD)v18);
        ...
        {
          -[SUUIEditorialLinkView tintColor](self, "tintColor");
...
- (void)setLinkLayout:(id)a3
{
  ...
  SUUIEditorialLinkLayout *v6;

  v5 = (SUUIEditorialLinkLayout *)a3;
  if (self->_layout != v5)
  {
    v6 = v5;
    objc_storeStrong((id *)&self->_layout, a3);
    -[SUUIEditorialLinkView setNeedsLayout](self, "setNeedsLayout");
    v5 = v6;
  }
...
- (void)layoutSubviews
{
  ...
  uint64_t v10;
  void *v11;
  SUUIEditorialLinkLayout *layout;
  id v13;
  uint64_t v14;
  uint64_t v15;
  void *v16;
  ...
  if (self->_layout)
  {
    -[SUUIEditorialLinkView bounds](self, "bounds");
    v4 = v3;
    v6 = v5;
    v8 = v7;
    v10 = v9;
    -[SUUIEditorialLinkLayout links](self->_layout, "links");
    ...
    v13 = v11;
    v18 = v13;
    -[SUUIEditorialLinkLayout enumerateLinesUsingBlock:](layout, "enumerateLinesUsingBlock:", v17);
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIEditorialLinkView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
...
- (CGSize)sizeThatFits:(CGSize)result
{
  ...
  layout = self->_layout;
  if (layout)
    -[SUUIEditorialLinkLayout totalSize](layout, "totalSize", result.width, result.height);
  return result;
}
...
- (void)tintColorDidChange
{
  ...
  -[SUUIEditorialLinkView tintColorDidChange](&v17, sel_tintColorDidChange);
  v15 = 0u;
  v16 = 0u;
  v13 = 0u;
  v14 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        {
          -[SUUIEditorialLinkView tintColor](self, "tintColor", (_QWORD)v13);
...
- (id)_newButton
{
  ...
  v3 = -[SUUILinkButton initWithArrowStyle:]([SUUILinkButton alloc], "initWithArrowStyle:", 1);
  -[SUUILinkButton addTarget:action:forControlEvents:](v3, "addTarget:action:forControlEvents:", self, sel__linkButtonAction_, 64);
  LODWORD(v4) = -1.0;
  -[SUUILinkButton setCharge:](v3, "setCharge:", v4);
  textColor = self->_textColor;
  if (textColor)
  {
    -[SUUILinkButton setTitleColor:forState:](v3, "setTitleColor:forState:", textColor, 0);
  }
  else
  {
    -[SUUIEditorialLinkView tintColor](self, "tintColor");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUILinkButton setTitleColor:forState:](v3, "setTitleColor:forState:", v6, 0);

  }
  highlightedTextColor = self->_highlightedTextColor;
  if (highlightedTextColor)
  {
    -[SUUILinkButton setTitleColor:forState:](v3, "setTitleColor:forState:", highlightedTextColor, 1);
  }
  else
  {
    -[SUUIEditorialLinkView tintColor](self, "tintColor");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUILinkButton setTitleColor:forState:](v3, "setTitleColor:forState:", v8, 1);

  }
  -[SUUILinkButton titleLabel](v3, "titleLabel");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (SUUIEditorialLinkViewDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
