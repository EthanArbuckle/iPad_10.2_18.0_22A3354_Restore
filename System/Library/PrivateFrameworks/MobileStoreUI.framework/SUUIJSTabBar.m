...
- (SUUIJSTabBar)initWithAppContext:(id)a3 controller:(id)a4
{
  ...
  if (v7)
  {
    ...
    -[SUUIJSTabBar _reloadTabBarItemsWithPreludeMainThreadWork:](v7, "_reloadTabBarItemsWithPreludeMainThreadWork:", 0);
  }
...
- (SUUIJSTabBarItem)selectedTab
{
  ...
  -[SUUIJSTabBar _selectedTabBarItemForIndex:](self, "_selectedTabBarItemForIndex:", v8[3]);
...
- (void)_reloadTabBarItemsWithPreludeMainThreadWork:(id)a3
{
  ...
  NSArray *tabs;
  SUUITabBarItem *v15;
  SUUIJSTabBarItem *v16;
  SUUIJSTabBarItem *v17;
  ...
  v40[1] = v40;
  v40[2] = 0x3032000000;
  v40[3] = __Block_byref_object_copy__59;
  v40[4] = __Block_byref_object_dispose__59;
  v41 = 0;
  v34 = 0;
  v35 = &v34;
  v36 = 0x3032000000;
  ...
  v29 = &v28;
  v30 = 0x3032000000;
  v31 = __Block_byref_object_copy__59;
  v32 = __Block_byref_object_dispose__59;
  v33 = 0;
  v6 = MEMORY[0x24BDAC760];
  v23[0] = MEMORY[0x24BDAC760];
  v23[1] = 3221225472;
  v23[2] = __60__SUUIJSTabBar__reloadTabBarItemsWithPreludeMainThreadWork___block_invoke;
  v23[3] = &unk_2511FAC88;
  v7 = v4;
  v23[4] = self;
  v24 = v7;
  ...
  v19[0] = v6;
  v19[1] = 3221225472;
  v19[2] = __60__SUUIJSTabBar__reloadTabBarItemsWithPreludeMainThreadWork___block_invoke_2;
  v19[3] = &unk_2511FACB0;
  v22 = v40;
  v19[4] = self;
  v11 = v5;
  ...
  v15 = -[SUUITabBarItem initWithTabIdentifier:]([SUUITabBarItem alloc], "initWithTabIdentifier:", CFSTR("transient"));
  v16 = [SUUIJSTabBarItem alloc];
  v17 = -[SUUIJSTabBarItem initWithAppContext:navigationController:tabBarItem:owner:](v16, "initWithAppContext:navigationController:tabBarItem:owner:", v11, v29[5], v15, self);
...
void __60__SUUIJSTabBar__reloadTabBarItemsWithPreludeMainThreadWork___block_invoke(_QWORD *a1)
{
  uint64_t v2;
  id WeakRetained;
  void *v4;
...
void __60__SUUIJSTabBar__reloadTabBarItemsWithPreludeMainThreadWork___block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (!v5)
  {
    if (objc_msgSend(v7, "conformsToProtocol:", &unk_257264D88))
    {
  ...
  v12 = -[SUUIJSTabBarItem initWithAppContext:navigationController:tabBarItem:owner:]([SUUIJSTabBarItem alloc], "initWithAppContext:navigationController:tabBarItem:owner:", *(_QWORD *)(a1 + 40), v5, v13, *(_QWORD *)(a1 + 32));
...
- (id)_selectedTabBarItemForIndex:(int64_t)a3
{
  ...
  else
  {
    ...
    v4 = (SUUIJSTabBarItem *)objc_claimAutoreleasedReturnValue();
  }
  return v4;
}
