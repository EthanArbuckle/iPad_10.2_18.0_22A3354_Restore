...
- (SUUIStackedBar)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[SUUIStackedBar addSubview:](v3, "addSubview:", v3->_backdropView);
    ...
    -[SUUIStackedBar addSubview:](v3, "addSubview:", v3->_wrapperView);
...
- (void)setItems:(id)a3
{
  ...
  if (self->_items != v5)
  {
    ...
    -[SUUIStackedBar _reload](self, "_reload");
    v5 = v6;
  }
...
{
  -[SUUIStackedBar setLastItemExpanded:animated:](self, "setLastItemExpanded:animated:", a3, 0);
}
...
- (void)setLastItemExpanded:(BOOL)a3 animated:(BOOL)a4
{
  ...
  if (self->_lastItemExpanded != a3)
  {
    if (a4)
    {
      -[SUUIStackedBar layoutIfNeeded](self, "layoutIfNeeded");
      v6[4] = self;
...
- (void)setOffset:(double)a3
{
  ...
  {
    self->_offset = a3;
    -[SUUIStackedBar sizeThatFits:](self, "sizeThatFits:", *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
    offset = self->_offset;
    if (offset < self->_newOffset && offset > -v4)
      self->_newOffset = offset;
    -[SUUIStackedBar frame](self, "frame");
    -[SUUIStackedBar setFrame:](self, "setFrame:");
    -[SUUIStackedBar setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIStackedBar layoutSubviews](&v22, sel_layoutSubviews);
  backdropView = self->_backdropView;
  -[SUUIStackedBar bounds](self, "bounds");
  ...
  if (!self->_splitViewStyle)
  {
    ...
    if (v4 > 64.0 && v4 < v5)
    {
      ...
      *(double *)&v25[12] = v7;
      ...
      v24[4] = self;
      *(double *)&v24[5] = offset;
      objc_msgSend(MEMORY[0x24BEBDB00], "animateWithDuration:animations:completion:", v25, v24, 0.3);
    }
  }
}
...
{
  -[SUUIStackedBar _selectItemAtIndex:](self, "_selectItemAtIndex:", -[NSArray indexOfObject:](self->_cells, "indexOfObject:", a3));
}

- (void)_backAction:(id)a3
{
  -[SUUIStackedBar _selectItemAtIndex:](self, "_selectItemAtIndex:", -[NSArray count](self->_items, "count", a3) - 2);
}
...
- (void)_reload
{
  ...
  objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithArray:", self->_cells);
  ...
  if (-[NSArray count](self->_items, "count"))
  {
    ...
    do
    {
      ...
      {
        v6 = objc_alloc_init(SUUIStackedBarCell);
        -[SUUIStackedBarCell addTarget:action:forControlEvents:](v6, "addTarget:action:forControlEvents:", self, sel__buttonAction_, 64);
      ...
      else
      {
        ...
        v6 = (SUUIStackedBarCell *)objc_claimAutoreleasedReturnValue();
      }
      objc_msgSend(v5, "title");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIStackedBarCell setTitle:forState:](v6, "setTitle:forState:", v7, 0);

      v8 = !self->_alwaysShowsBackButton && -[NSArray count](self->_items, "count") < 2
        || -[SUUIStackedBar splitViewStyle](self, "splitViewStyle");
      -[SUUIStackedBarCell backButton](v6, "backButton");
      ...
      -[SUUIStackedBarCell setExpanded:](v6, "setExpanded:", v11);
...
- (void)_selectItemAtIndex:(int64_t)a3
{
  ...
  -[SUUIStackedBar delegate](self, "delegate");
...
{
  return (SUUIStackedBarDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
