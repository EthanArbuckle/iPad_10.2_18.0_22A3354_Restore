...
- (void)_setSuffix:(id)a3
{
  ...
  if (!self->_suffixLabel)
  {
    ...
    -[UILabel setHidden:](self->_suffixLabel, "setHidden:", -[SUUISearchController isActive](self, "isActive"));
    ...
    if (objc_msgSend(v13, "userInterfaceIdiom") == 1)
    {
      ...
      {
        -[SUUISearchController delegate](self, "delegate");
        v17 = v4;
        ...
        if ((v20 & 1) == 0)
        {
          -[SUUISearchController searchBar](self, "searchBar");
...
LABEL_17:
  ...
  v41 = (NSMutableString *)objc_alloc_init(MEMORY[0x24BDD16A8]);
  ...
  -[SUUISearchController searchBar](self, "searchBar", v59);
  ...
  if ((v54 & 1) == 0)
  {
    ...
    if ((-[SUUISearchController isActive](self, "isActive") & 1) != 0)
      v57 = 0;
    else
...
- (void)setActive:(BOOL)a3
{
  ...
  -[SUUISearchController setActive:](&v15, sel_setActive_, v3);
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  -[SUUISearchController delegate](self, "delegate", v9.receiver, v9.super_class);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
