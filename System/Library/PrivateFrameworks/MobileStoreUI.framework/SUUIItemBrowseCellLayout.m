...
{
  SUUIItemBrowseCellLayout *v3;
  SUUIItemBrowseCellLayout *v4;
  objc_super v6;
  ...
  v4 = v3;
  if (v3)
    -[SUUIItemBrowseCellLayout _initSUUIItemBrowseCellLayout](v3, "_initSUUIItemBrowseCellLayout");
  return v4;
}
...
- (NSString)indexNumberString
{
  ...
  -[_SUUIItemBrowseCellContentView indexNumberLabel](self->_cellContentView, "indexNumberLabel");
...
- (void)setColoringWithColorScheme:(id)a3
{
  ...
  -[_SUUIItemBrowseCellContentView subtitleLabel](self->_cellContentView, "subtitleLabel");
  ...
  -[_SUUIItemBrowseCellContentView userRatingLabel](self->_cellContentView, "userRatingLabel");
  ...
  -[_SUUIItemBrowseCellContentView titleLabel](self->_cellContentView, "titleLabel");
...
{
  id v4;
  _SUUIItemBrowseCellContentView *cellContentView;
  void *v6;
  _SUUIItemBrowseCellContentView *v7;
  id v8;
  void *v9;
  void *v10;
  void *v11;
  ...
  v22 = a3;
  -[SUUIItemBrowseCellLayout indexNumberString](self, "indexNumberString");
  ...
  if (v4 != v22 && (objc_msgSend(v4, "isEqualToString:", v22) & 1) == 0)
  {
    ...
    if (v22)
    {
      -[_SUUIItemBrowseCellContentView indexNumberLabel](cellContentView, "indexNumberLabel");
      ...
      if (!v6)
      {
        ...
        -[_SUUIItemBrowseCellContentView setIndexNumberLabel:](v7, "setIndexNumberLabel:", v8);
    ...
    {
      -[_SUUIItemBrowseCellContentView setIndexNumberLabel:](cellContentView, "setIndexNumberLabel:", 0);
    }
    -[SUUICellLayout setNeedsLayout](self, "setNeedsLayout");
  }
...
- (void)setNumberOfUserRatings:(int64_t)a3
{
        ...
        !v5))
  {
    ...
    -[SUUIItemBrowseCellLayout _reloadUserRatingViews](self, "_reloadUserRatingViews");
  }
}
...
- (void)setSubtitle:(id)a3
{
  ...
  v18 = a3;
  -[SUUIItemBrowseCellLayout subtitle](self, "subtitle");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  if (v4 != v18 && (objc_msgSend(v4, "isEqualToString:", v18) & 1) == 0)
  {
    ...
    if (v18)
    {
      -[_SUUIItemBrowseCellContentView subtitleLabel](cellContentView, "subtitleLabel");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (!v6)
      {
        v7 = self->_cellContentView;
        v8 = objc_alloc_init(MEMORY[0x24BEBD708]);
        -[_SUUIItemBrowseCellContentView setSubtitleLabel:](v7, "setSubtitleLabel:", v8);
    ...
    {
      -[_SUUIItemBrowseCellContentView setSubtitleLabel:](cellContentView, "setSubtitleLabel:", 0);
    }
    -[SUUICellLayout setNeedsLayout](self, "setNeedsLayout");
    -[_SUUIItemBrowseCellContentView setNeedsDisplay](self->_cellContentView, "setNeedsDisplay");
  }
...
- (void)setTitle:(id)a3
{
  ...
  v19 = a3;
  -[SUUIItemBrowseCellLayout title](self, "title");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  if (v4 != v19 && (objc_msgSend(v4, "isEqualToString:", v19) & 1) == 0)
  {
    ...
    if (v19)
    {
      -[_SUUIItemBrowseCellContentView titleLabel](cellContentView, "titleLabel");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (!v6)
      {
        v7 = self->_cellContentView;
        v8 = objc_alloc_init(MEMORY[0x24BEBD708]);
        -[_SUUIItemBrowseCellContentView setTitleLabel:](v7, "setTitleLabel:", v8);
    ...
    {
      -[_SUUIItemBrowseCellContentView setTitleLabel:](cellContentView, "setTitleLabel:", 0);
    }
    -[SUUICellLayout setNeedsLayout](self, "setNeedsLayout");
  }
...
- (void)setUserRating:(double)a3
{
  ...
  if (self->_userRating != a3
    || (-[_SUUIItemBrowseCellContentView userRatingImageView](self->_cellContentView, "userRatingImageView"),
        v5 = (void *)objc_claimAutoreleasedReturnValue(),
        v5,
        !v5))
  {
...
- (void)layoutForItemOfferChange
{
  ...
  objc_msgSend(v24, "sizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
  v9 = v8;
  v11 = v10;
...
- (void)layoutSubviews
{
  ...
  -[SUUICellLayout layoutSubviews](&v83, sel_layoutSubviews);
  -[SUUICellLayout contentView](self, "contentView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "bounds");
  v5 = v4;
  ...
  if (v31 && (objc_msgSend(v31, "isHidden") & 1) == 0)
  {
    ...
    v34 = v33;
    v36 = v35;
    objc_msgSend(v32, "layoutSizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
    v81 = v19;
    v82 = v37;
    if (v28)
    {
    ...
    {
      v39 = *(double *)(MEMORY[0x24BDBF090] + 16);
      v80 = *(double *)(MEMORY[0x24BDBF090] + 24);
      v41 = v36;
    }
    v42 = v30;
    v43 = v30 - v34;
  ...
  -[SUUIItemCellLayout removeControlView](self, "removeControlView");
...
- (void)setBackgroundColor:(id)a3
{
  ...
  cellContentView = self->_cellContentView;
  v5 = a3;
  -[_SUUIItemBrowseCellContentView setBackgroundColor:](cellContentView, "setBackgroundColor:", v5);
  v6.receiver = self;
  v6.super_class = (Class)SUUIItemBrowseCellLayout;
...
- (void)setIconImage:(id)a3
{
  ...
  -[SUUIItemCellLayout setIconImage:](&v7, sel_setIconImage_, a3);
  -[SUUIItemCellLayout iconImageView](self, "iconImageView");
...
{
  void *v3;
  _SUUIItemBrowseCellContentView *v4;
  _SUUIItemBrowseCellContentView *cellContentView;
  id v6;
...
- (void)_reloadUserRatingViews
{
  ...
  void *v12;
  void *v13;
  SUUICellImageView *v14;
  void *v15;
  void *v16;
  void *v17;
  void *v18;
  SUUICellImageView *v19;
  id v20;
  ...
  if (!v3)
  {
    ...
    -[_SUUIItemBrowseCellContentView setUserRatingLabel:](self->_cellContentView, "setUserRatingLabel:", v4);

  }
  if (self->_numberOfUserRatings)
  {
    -[SUUIItemBrowseCellLayout _decimalNumberFormatter](self, "_decimalNumberFormatter");
    ...
    -[_SUUIItemBrowseCellContentView userRatingImageView](self->_cellContentView, "userRatingImageView");
    v14 = (SUUICellImageView *)objc_claimAutoreleasedReturnValue();
    if (!v14)
    {
      v14 = objc_alloc_init(SUUICellImageView);
      -[_SUUIItemBrowseCellContentView setUserRatingImageView:](self->_cellContentView, "setUserRatingImageView:", v14);
      objc_msgSend(v20, "backgroundColor");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUICellImageView setBackgroundColor:](v14, "setBackgroundColor:", v15);

    }
    +[SUUIRatingStarsCache cacheWithProperties:](SUUIRatingStarsCache, "cacheWithProperties:", 1);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUICellImageView setHidden:](v14, "setHidden:", 0);
    objc_msgSend(v16, "ratingStarsImageForRating:", self->_userRating);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUICellImageView setImage:](v14, "setImage:", v17);

    -[SUUICellImageView sizeToFit](v14, "sizeToFit");
  }
  else
  {
    -[_SUUIItemBrowseCellContentView userRatingImageView](self->_cellContentView, "userRatingImageView");
    ...
    v19 = (SUUICellImageView *)objc_claimAutoreleasedReturnValue();
    v14 = v19;
    if (v19)
      -[SUUICellImageView localizedStringForKey:](v19, "localizedStringForKey:", CFSTR("NO_RATINGS"));
    else
