...
- (id)_initSUUITracklistColumnData
{
  ...
  result = -[SUUITracklistColumnData init](&v3, sel_init);
  if (result)
  {
    *((_QWORD *)result + 4) = 0x402E000000000000;
    *((_OWORD *)result + 1) = xmmword_241EFB850;
  }
  return result;
}
...
- (SUUITracklistColumnData)initWithRepresentativeTrack:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SUUITracklistColumnData _initSUUITracklistColumnData](self, "_initSUUITracklistColumnData");
  if (v5)
  {
...
void __55__SUUITracklistColumnData_initWithRepresentativeTrack___block_invoke(uint64_t a1, void *a2)
{
  ...
  v17 = a2;
  v3 = SUUITrackListColumnIdentifierForViewElement(v17);
  v4 = v3;
  v5 = *(_QWORD *)(a1 + 40);
  v6 = *(_QWORD *)(v5 + 8);
  v7 = *(_QWORD *)(v6 + 40);
...
void __64__SUUITracklistColumnData_enumerateColumnsForHeader_usingBlock___block_invoke(_QWORD *a1, void *a2, unint64_t a3)
{
  id v5;
  void *v6;
  void *v7;
...
- (id)viewElementsForTrack:(id)a3 columnIndex:(int64_t)a4
{
  ...
  v9[4] = &v10;
  v9[5] = a4;
  -[SUUITracklistColumnData enumerateColumnsForTrack:usingBlock:](self, "enumerateColumnsForTrack:usingBlock:", v6, v9);
  v7 = (id)v11[5];
