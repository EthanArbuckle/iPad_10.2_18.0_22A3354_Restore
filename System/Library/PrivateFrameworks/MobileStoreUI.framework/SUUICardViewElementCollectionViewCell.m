...
{
  SUUICardViewElementCollectionViewCell *v3;
  uint64_t v4;
...
void __90__SUUICardViewElementCollectionViewCell_artworkBoundingSizeWithViewElement_width_context___block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
  ...
  switch(v5)
  {
    case 152:
      goto LABEL_4;
    case 62:
      +[SUUIHorizontalListView preferredSizeForViewElement:context:](SUUIHorizontalListView, "preferredSizeForViewElement:context:", v10, *(_QWORD *)(a1 + 32));
      if (v6 != *MEMORY[0x24BDBF148] || v7 != *(double *)(MEMORY[0x24BDBF148] + 8))
        goto LABEL_9;
      break;
    case 49:
LABEL_4:
...
- (void)setArtworkBoundingSize:(id)a3
{
  ...
  {
    v9 = v4;
    v6 = -[SUUISizeValue isEqual:](artworkBoundingSize, "isEqual:", v4);
    v4 = v9;
    if (!v6)
    {
      v7 = (SUUISizeValue *)-[SUUISizeValue copy](v9, "copy");
      v8 = self->_artworkBoundingSize;
      self->_artworkBoundingSize = v7;

      -[SUUICardViewElementCollectionViewCell setNeedsLayout](self, "setNeedsLayout");
      v4 = v9;
    }
  }
...
- (UIView)adCardBackgroundView
{
  ...
  if (!adCardBackgroundView)
  {
    ...
    objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithHue:saturation:brightness:alpha:", 0.57292, 0.06531, 0.96078, 1.0);
...
void __88__SUUICardViewElementCollectionViewCell_prefetchResourcesForViewElement_reason_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3 == 49)
  {
    if (*(_BYTE *)(a1 + 56))
    {
      ...
      objc_msgSend(v8, "setLayerShadowOffset:", *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
  ...
  {
    v4 = +[SUUIHorizontalLockupView prefetchResourcesForViewElement:reason:context:](SUUIHorizontalLockupView, "prefetchResourcesForViewElement:reason:context:", v13, *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 32));
    if (*(_BYTE *)(a1 + 56))
    {
      ...
      if (v5)
      {
        ...
        objc_msgSend(v7, "setLayerShadowOffset:", *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
      }
...
LABEL_22:
    ...
    if (v3 == 62)
    {
      +[SUUIHorizontalListView preferredSizeForViewElement:context:](SUUIHorizontalListView, "preferredSizeForViewElement:context:", v12, *(_QWORD *)(a1 + 32));
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v7 = a5;
  v8 = a3;
  +[SUUICardLayout layoutWithCardViewElement:context:](SUUICardLayout, "layoutWithCardViewElement:context:", v8, v7);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
void __83__SUUICardViewElementCollectionViewCell_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3 > 61)
  {
    if (v3 > 130)
    {
      ...
      v7 = SUUIStackListCollectionViewCell;
    }
    else if (v3 == 62)
    {
      v7 = SUUIHorizontalListView;
    }
    else
    {
      v4 = v3 == 66;
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  v54 = a3;
  v55 = 0;
  +[SUUICardLayout layoutWithCardViewElement:context:](SUUICardLayout, "layoutWithCardViewElement:context:", v7, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "horizontalContentInset");
  v11 = v10;
  v45 = 0;
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  double v28;
  double v29;
  SUUIBackgroundImageWrapperForHorizontalLockup *backgroundWrapper;
  SUUIPerspectiveView *backgroundViewWithParallax;
  id v32;
  id v33;
  void *v34;
  uint64_t v35;
  ...
  id v57;
  id v58;
  SUUICardViewElementCollectionViewCell *v59;
  uint64_t *v60;
  double v61;
  BOOL v62;
  uint64_t v63;
  ...
  +[SUUICardLayout layoutWithCardViewElement:context:](SUUICardLayout, "layoutWithCardViewElement:context:", v9, v10);
  v11 = (SUUICardLayout *)objc_claimAutoreleasedReturnValue();
  layout = self->_layout;
  self->_layout = v11;
  ...
  v14 = -[SUUICardLayout layoutStyle](self->_layout, "layoutStyle");
  ...
  if (v14 == 1)
  {
    if (!programmedCardBackgroundView)
    {
      ...
      -[SUUICardViewElementCollectionViewCell contentView](self, "contentView");
  ...
  -[SUUICardViewElementCollectionViewCell adCardBackgroundView](self, "adCardBackgroundView");
  ...
  if (v22)
  {
    ...
    -[SUUICardViewElementCollectionViewCell compactAdCardHairlineLayer](self, "compactAdCardHairlineLayer");
  ...
  -[SUUICardLayout horizontalContentInset](self->_layout, "horizontalContentInset");
  v29 = a4 + v28 * -2.0;
  ...
  v54 = 3221225472;
  v55 = __77__SUUICardViewElementCollectionViewCell_reloadWithViewElement_width_context___block_invoke;
  v56 = &unk_2511FD440;
  v32 = v9;
  v57 = v32;
  v61 = v29;
  ...
  v62 = v16;
  v60 = &v63;
  -[SUUIViewReuseCollectionViewCell modifyUsingBlock:](self, "modifyUsingBlock:", &v53);
  ...
  if (self->_isActivityCard)
  {
    ...
    v35 = SUUIUserInterfaceIdiom(v34);

    if (v35 == 1)
    {
      -[SUUICardViewElement style](self->_cardElement, "style");
      ...
      if (v37)
      {
        v38 = objc_alloc_init(MEMORY[0x24BDE5758]);
        objc_msgSend(v37, "cornerRadiiValue");
        v40 = v39;
        v42 = v41;
        v44 = v43;
        v46 = v45;
        v47 = (void *)MEMORY[0x24BEBD420];
        -[SUUICardViewElementCollectionViewCell bounds](self, "bounds");
        v48 = 4 * (v40 > 0.0);
        if (v42 > 0.0)
          v48 = (4 * (v40 > 0.0)) | 8;
        if (v46 == 0.0)
        ...
        -[SUUICardViewElementCollectionViewCell layer](self, "layer");
...
void __77__SUUICardViewElementCollectionViewCell_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  void *v15;
  void *v16;
  SUUIBackgroundImageWrapperForHorizontalLockup *v17;
  uint64_t v18;
  void *v19;
  id v20;
  uint64_t v21;
        ...
        if (v10 > 61)
        {
          if (v10 <= 137)
          {
            if (v10 == 62)
            {
              ...
              {
                +[SUUIHorizontalListView preferredSizeForViewElement:context:](SUUIHorizontalListView, "preferredSizeForViewElement:context:", v9, *(_QWORD *)(a1 + 40));
                if (v23 != v6 || v22 != v7)
...
LABEL_68:
        ...
        else
        {
          ...
          if (v10 == 7)
          {
            ...
            v17 = -[SUUIBackgroundImageWrapperForHorizontalLockup initWithImage:]([SUUIBackgroundImageWrapperForHorizontalLockup alloc], "initWithImage:", v16);
            v18 = *(_QWORD *)(a1 + 48);
            v19 = *(void **)(v18 + 840);
            *(_QWORD *)(v18 + 840) = v17;
            ...
            v13 = v16;
            if (objc_msgSend(v13, "conformsToProtocol:", &unk_2571FE3F0))
...
LABEL_45:
        ...
        if (v12)
        {
          ...
          if (!v32)
          {
            v33 = objc_msgSend(objc_alloc(MEMORY[0x24BDD15C0]), "initWithOptions:capacity:", 517, 1);
            v34 = *(_QWORD *)(a1 + 48);
            v35 = *(void **)(v34 + 824);
            *(_QWORD *)(v34 + 824) = v33;
...
- (BOOL)updateWithItemState:(id)a3 context:(id)a4 animated:(BOOL)a5
{
  ...
  v25 = 0x2020000000;
  v26 = 0;
  -[SUUIViewElement flattenedChildren](self->_cardElement, "flattenedChildren");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setPerspectiveTargetView:(id)a3
{
  ...
  backgroundViewWithParallax = self->_backgroundViewWithParallax;
  v4 = a3;
  -[SUUIPerspectiveView setPerspectiveTargetView:](backgroundViewWithParallax, "setPerspectiveTargetView:", v4);

}

- (void)setVanishingPoint:(CGPoint)a3
{
  -[SUUIPerspectiveView setVanishingPoint:](self->_backgroundViewWithParallax, "setVanishingPoint:", a3.x, a3.y);
}

- (void)updateForChangedDistanceFromVanishingPoint
{
  -[SUUIPerspectiveView updateForChangedDistanceFromVanishingPoint](self->_backgroundViewWithParallax, "updateForChangedDistanceFromVanishingPoint");
}
...
- (void)applyLayoutAttributes:(id)a3
{
  ...
  -[SUUIViewReuseCollectionViewCell applyLayoutAttributes:](&v9, sel_applyLayoutAttributes_, a3);
  if (-[SUUICardViewElement isAdCard](self->_cardElement, "isAdCard"))
  {
    -[SUUICardViewElementCollectionViewCell adCardBackgroundView](self, "adCardBackgroundView");
...
- (void)setSelected:(BOOL)a3
{
  ...
  if (v3)
  {
    if (-[SUUICardViewElement isAdCard](self->_cardElement, "isAdCard"))
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "sendAction:to:from:forEvent:", sel_suuiadvertising_advertWasSelected_, 0, self, 0);
...
- (void)setBackgroundColor:(id)a3
{
  ...
  if (self->_isActivityCard)
  {
    ...
    v6.receiver = self;
    v6.super_class = (Class)SUUICardViewElementCollectionViewCell;
    -[SUUIViewReuseCollectionViewCell setBackgroundColor:](&v6, sel_setBackgroundColor_, v4);
  ...
  else
  {
    ...
    -[SUUIViewReuseCollectionViewCell setBackgroundColor:](&v5, sel_setBackgroundColor_, a3);
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SUUICollectionViewCell layoutSubviews](&v124, sel_layoutSubviews);
  -[SUUICardViewElementCollectionViewCell backgroundColor](self, "backgroundColor");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIViewElement firstChildForElementType:](self->_cardElement, "firstChildForElementType:", 7);
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  v94 = -[SUUICardViewElement cardType](self->_cardElement, "cardType");
  v95 = v4;
  if (v4)
  {
  ...
  if (programmedCardBackgroundView && !-[UIView isHidden](programmedCardBackgroundView, "isHidden"))
  {
    ...
    if (v24 <= 3)
    {
      SUUIColorByAdjustingBrightness(v3, flt_241EFCC20[v24]);
  ...
  -[SUUICardLayout horizontalContentInset](self->_layout, "horizontalContentInset", 880);
  v27 = v26;
  v122[0] = 0;
  v122[1] = v122;
  v122[2] = 0x3032000000;
  ...
  *(double *)&v121[3] = v18;
  ...
  if (-[SUUICardViewElement isAdCard](self->_cardElement, "isAdCard"))
  {
    -[SUUICardViewElementCollectionViewCell traitCollection](self, "traitCollection");
    v34 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v35 == 1)
    {
      ...
      v127.origin.x = *(CGFloat *)MEMORY[0x24BDBF090];
      v127.origin.y = *(CGFloat *)(MEMORY[0x24BDBF090] + 8);
      v53 = 1.0 / v49;
...
- (BOOL)canPerformAction:(SEL)a3 withSender:(id)a4
{
  ...
  else
  {
    v9.receiver = self;
    v9.super_class = (Class)SUUICardViewElementCollectionViewCell;
    v7 = -[SUUICardViewElementCollectionViewCell canPerformAction:withSender:](&v9, sel_canPerformAction_withSender_, a3, v6);
  }
...
- (void)suuiadvertising_advertSelectionEventShouldBeForwarded:(id)a3
{
  ...
  objc_msgSend(v4, "sendAction:to:from:forEvent:", sel_suuiadvertising_advertWasSelected_, 0, self, 0);
...
- (NSString)lineItem
{
  ...
  if (-[SUUICardViewElement isAdCard](self->_cardElement, "isAdCard"))
  {
    -[SUUICardViewElement attributes](self->_cardElement, "attributes");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
