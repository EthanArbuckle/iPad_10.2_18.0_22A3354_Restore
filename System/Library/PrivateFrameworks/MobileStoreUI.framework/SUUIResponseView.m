...
- (SUUIResponseView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(v4, "imageNamed:inBundle:", CFSTR("Reply"), v5);
    ...
    -[SUUIResponseView addSubview:](v3, "addSubview:", v3->_replyImageView);
  }
  return v3;
}
...
void __62__SUUIResponseView_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (!v4)
      goto LABEL_11;
    +[SUUIReviewListTitleView requestLayoutForViewElement:width:context:](SUUIReviewListTitleView, "requestLayoutForViewElement:width:context:", v10, *(_QWORD *)(a1 + 32), *(double *)(a1 + 40));
  }
  v5 = v10;
LABEL_11:
...
void __58__SUUIResponseView_sizeThatFitsWidth_viewElement_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    +[SUUIReviewListTitleView sizeThatFitsWidth:viewElement:context:](SUUIReviewListTitleView, "sizeThatFitsWidth:viewElement:context:", v9, *(_QWORD *)(a1 + 32), *(double *)(a1 + 64));
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  width = a3.width;
  -[SUUIResponseView contentInset](self, "contentInset", a3.width, a3.height);
  v6 = v5;
  v9 = width - (v7 + 17.5) - v8;
...
- (void)layoutSubviews
{
  ...
  -[SUUIResponseView layoutSubviews](&v29, sel_layoutSubviews);
  v3 = storeShouldReverseLayoutDirection() ^ 1;
  -[SUUIResponseView bounds](self, "bounds");
  v24 = v4;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  -[SUUIResponseView contentInset](self, "contentInset");
  v12 = v11;
  v14 = v13;
  v16 = v15;
  v18 = v17 + 17.5;
  ...
  *(double *)&v25[14] = v8;
  ...
  -[SUUIResponseView replyImageView](self, "replyImageView");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v21, "sizeThatFits:", *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
