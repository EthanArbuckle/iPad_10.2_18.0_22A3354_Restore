...
{
  SUUIRedeemResultsView *v2;
  SUUIRedeemResultsView *v3;
  void *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)SUUIRedeemResultsView;
  v2 = -[SUUIRedeemResultsView initWithFrame:style:](&v6, sel_initWithFrame_style_, 0, *MEMORY[0x24BDBF090], *(double *)(MEMORY[0x24BDBF090] + 8), *(double *)(MEMORY[0x24BDBF090] + 16), *(double *)(MEMORY[0x24BDBF090] + 24));
  v3 = v2;
  if (v2)
  {
    -[SUUIRedeemResultsView setDelegate:](v2, "setDelegate:", v2);
    -[SUUIRedeemResultsView setDataSource:](v3, "setDataSource:", v3);
    -[SUUIRedeemResultsView setAlwaysBounceVertical:](v3, "setAlwaysBounceVertical:", 0);
    objc_msgSend(MEMORY[0x24BEBD4B8], "whiteColor");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIRedeemResultsView setBackgroundColor:](v3, "setBackgroundColor:", v4);

    -[SUUIRedeemResultsView setSeparatorStyle:](v3, "setSeparatorStyle:", 0);
  }
  return v3;
}
...
- (void)setSections:(id)a3
{
  ...
  if (self->_sections != v5)
  {
    ...
    -[SUUIRedeemResultsView reloadData](self, "reloadData");
    v5 = v6;
  }
...
- (void)layoutSubviews
{
  ...
  -[SUUIRedeemResultsView contentInset](self, "contentInset");
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v11 = v10;
  -[SUUIRedeemResultsView bounds](self, "bounds");
  v13 = v12;
  ...
  -[SUUIRedeemResultsView layoutSubviews](&v21, sel_layoutSubviews);
...
void __39__SUUIRedeemResultsView_layoutSubviews__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v5 >= 1)
  {
    ...
    {
      v8 = *(_QWORD *)(a1 + 32);
      objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForRow:inSection:", i, a3);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (SUUIRedeemResultsViewDelegate *)objc_loadWeakRetained((id *)&self->_resultsDelegate);
}
