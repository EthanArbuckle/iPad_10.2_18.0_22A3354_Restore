...
{
  id v6;
  SUUINavigationControllerAssistant *v7;
  SUUINavigationControllerAssistant *v8;
  id v9;
  id WeakRetained;
  uint64_t v11;
  ...
  id v13;
  uint64_t v14;
  _UINavigationControllerPalette *v15;
  void *v16;
  objc_super v18;
  id location;
  ...
  v7 = -[SUUINavigationControllerAssistant init](&v18, sel_init);
  v8 = v7;
  if (v7)
  {
    ...
    WeakRetained = objc_loadWeakRetained((id *)&v8->_navigationController);
    ...
    {
      v13 = objc_loadWeakRetained((id *)&v8->_navigationController);
      objc_msgSend(v13, "paletteForEdge:size:", 2, *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
    ...
    objc_msgSend(v16, "addObserver:selector:name:object:", v8, sel__previewDocumentChangeNotification_, CFSTR("SUUIApplicationControllerPreviewOverlayDidChangeNotification"), 0);
...
- (void)dealloc
{
  ...
  objc_msgSend(v3, "removeObserver:name:object:", self, CFSTR("SUUIApplicationControllerPreviewOverlayDidChangeNotification"), 0);
  objc_msgSend(v3, "removeObserver:name:object:", self, 0x2511FF088, 0);

  v4.receiver = self;
  v4.super_class = (Class)SUUINavigationControllerAssistant;
  -[SUUINavigationControllerAssistant dealloc](&v4, sel_dealloc);
}
...
+ (id)assistantForNavigationController:(id)a3 clientContext:(id)a4
{
  ...
  if (!v8)
  {
    v8 = -[SUUINavigationControllerAssistant _initWithNavigationController:clientContext:]([SUUINavigationControllerAssistant alloc], "_initWithNavigationController:clientContext:", v5, v6);
...
+ (id)existingAssistantForNavigationController:(id)a3
{
  ...
  objc_getAssociatedObject(v3, "com.apple.iTunesStoreUI.SUUINavigationControllerAssistant");
...
- (void)setHidesShadow:(BOOL)a3
{
  ...
  if (self->_hidesShadow != a3)
  {
    ...
    -[SUUINavigationControllerAssistant paletteBackgroundView](self, "paletteBackgroundView");
...
{
  -[SUUINavigationControllerAssistant _transitionToPaletteView:animated:operation:](self, "_transitionToPaletteView:animated:operation:", a3, a4, 0);
}
...
- (void)setStatusOverlayProvider:(id)a3
{
  ...
  v5 = a3;
  -[SUUINavigationControllerAssistant setStatusOverlayProvider:animated:](self, "setStatusOverlayProvider:animated:", v5, objc_msgSend(v4, "_isInAnimationBlock"));
...
- (void)willShowViewController:(id)a3 animated:(BOOL)a4
{
  ...
  v4 = a4;
  v6 = a3;
  -[SUUINavigationControllerAssistant childPaletteView](self, "childPaletteView");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v6, "conformsToProtocol:", &unk_25724F490))
  {
...
LABEL_6:
  -[SUUINavigationControllerAssistant navigationController](self, "navigationController");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUINavigationControllerAssistant _transitionToPaletteView:animated:operation:](self, "_transitionToPaletteView:animated:operation:", v8, v4, objc_msgSend(v12, "lastOperation"));
...
- (void)_previewDocumentChangeNotification:(id)a3
{
  ...
  v11 = a3;
  -[SUUINavigationControllerAssistant statusOverlayProvider](self, "statusOverlayProvider");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  ...
  if ((isKindOfClass & 1) != 0)
  {
    ...
    -[SUUINavigationControllerAssistant _setStatusOverlayProvider:animated:](self, "_setStatusOverlayProvider:animated:", v8, IsVisible);
    v6 = v11;
  }
...
- (void)_hideChildPaletteView:(id)a3 animated:(BOOL)a4
{
  ...
  id v30;
  id v31;
  SUUINavigationControllerAssistant *v32;
  uint64_t v33;
  uint64_t v34;
  double v35;
  double v36;
  ...
  -[SUUINavigationControllerAssistant statusOverlayViewController](self, "statusOverlayViewController");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v21 = *(_QWORD *)(MEMORY[0x24BDBEFB0] + 8);
  if (a4)
  {
    ...
    v29[1] = 3221225472;
    v29[2] = __68__SUUINavigationControllerAssistant__hideChildPaletteView_animated___block_invoke;
    v29[3] = &unk_2511FB0D0;
    v30 = v6;
    v33 = v22;
    v34 = v21;
    ...
    v27[0] = v24;
    v27[1] = 3221225472;
    v27[2] = __68__SUUINavigationControllerAssistant__hideChildPaletteView_animated___block_invoke_2;
    v27[3] = &unk_2511FB0F8;
    v27[4] = self;
    v28 = v30;
  ...
  {
    objc_msgSend(v15, "setFrame:", *MEMORY[0x24BDBEFB0], *(double *)(MEMORY[0x24BDBEFB0] + 8), v17, v19);
    -[SUUINavigationControllerAssistant paletteBackgroundView](self, "paletteBackgroundView");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v25, "setFrame:isAnimating:", objc_msgSend(MEMORY[0x24BEBDB00], "_isInAnimationBlockWithAnimationsEnabled"), v9, v11, v13, v20);

    -[SUUINavigationControllerAssistant paletteBackgroundView](self, "paletteBackgroundView");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v26, "setPinningBarShadowIsHidden:", objc_msgSend(MEMORY[0x24BEBDB00], "_isInAnimationBlockWithAnimationsEnabled"));
...
- (void)_hideOverlayView:(id)a3 animated:(BOOL)a4
{
  ...
  _QWORD v32[4];
  id v33;
  SUUINavigationControllerAssistant *v34;
  double v35;
  double v36;
  double v37;
  double v38;
  ...
  if (a4)
  {
    ...
    if (v18)
    {
      v19 = objc_alloc(MEMORY[0x24BEBDB00]);
    ...
    v32[1] = 3221225472;
    v32[2] = __63__SUUINavigationControllerAssistant__hideOverlayView_animated___block_invoke;
    v32[3] = &unk_2511F7C70;
    v33 = v6;
    v34 = self;
    v35 = v9;
    ...
    v29[0] = v24;
    v29[1] = 3221225472;
    v29[2] = __63__SUUINavigationControllerAssistant__hideOverlayView_animated___block_invoke_2;
    v29[3] = &unk_2511FA080;
    v29[4] = self;
    v30 = v33;
    v31 = v18;
...
uint64_t __63__SUUINavigationControllerAssistant__hideOverlayView_animated___block_invoke_2(id *a1)
{
  void *v2;
  void *v3;
...
- (void)_setStatusOverlayProvider:(id)a3 animated:(BOOL)a4
{
  ...
  if (self->_statusOverlayProvider != v7)
  {
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0)
    {
      -[SUUIStatusOverlayProvider overlayViewControllerWithBackgroundStyle:](self->_statusOverlayProvider, "overlayViewControllerWithBackgroundStyle:", v12 != 1);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUINavigationControllerAssistant setStatusOverlayViewController:](self, "setStatusOverlayViewController:", v13);

    }
    else
    {
      -[SUUINavigationControllerAssistant setStatusOverlayViewController:](self, "setStatusOverlayViewController:", 0);
    }
    -[SUUINavigationControllerAssistant statusOverlayViewController](self, "statusOverlayViewController");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "view");
    ...
    if (v15)
    {
      -[SUUINavigationControllerAssistant _showOverlayView:previousOverlayView:animated:](self, "_showOverlayView:previousOverlayView:animated:", v15, v9, v4);
    }
    else if (v9)
    {
      -[SUUINavigationControllerAssistant _hideOverlayView:animated:](self, "_hideOverlayView:animated:", v9, v4);
    }
...
- (void)_showOverlayView:(id)a3 previousOverlayView:(id)a4 animated:(BOOL)a5
{
  ...
  id v51;
  id v52;
  SUUINavigationControllerAssistant *v53;
  uint64_t *v54;
  _QWORD v55[4];
  id v56;
  SUUINavigationControllerAssistant *v57;
  uint64_t *v58;
  double v59;
  double v60;
  double v61;
  ...
  *(_QWORD *)&v68 = v12;
  *((_QWORD *)&v68 + 1) = v13;
  *((_OWORD *)v64 + 2) = *MEMORY[0x24BDBEFB0];
  -[SUUINavigationControllerAssistant paletteBackgroundView](self, "paletteBackgroundView");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (a5)
  {
    ...
    if (v37)
    {
      v38 = objc_alloc(MEMORY[0x24BEBDB00]);
    ...
    *((_QWORD *)v42 + 4) = v46;
    v42[5] = v45 - v44;
    objc_msgSend(v8, "setFrame:");
    v47 = (void *)MEMORY[0x24BEBDB00];
    v48 = MEMORY[0x24BDAC760];
    v55[0] = MEMORY[0x24BDAC760];
    v55[1] = 3221225472;
    v55[2] = __83__SUUINavigationControllerAssistant__showOverlayView_previousOverlayView_animated___block_invoke;
    v55[3] = &unk_2511FB120;
    v58 = &v63;
    v56 = v8;
    v57 = self;
    ...
    v50[0] = v48;
    v50[1] = 3221225472;
    v50[2] = __83__SUUINavigationControllerAssistant__showOverlayView_previousOverlayView_animated___block_invoke_2;
    v50[3] = &unk_2511FB148;
    v49 = v37;
    v51 = v49;
    v52 = v56;
...
- (void)_transitionToPaletteView:(id)a3 animated:(BOOL)a4 operation:(int64_t)a5
{
  ...
  if (v9 != v8)
  {
    -[SUUINavigationControllerAssistant setChildPaletteView:](self, "setChildPaletteView:", v8);
    -[SUUINavigationControllerAssistant childPaletteView](self, "childPaletteView");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_14:
          ...
          v59[1] = 3221225472;
          v59[2] = __81__SUUINavigationControllerAssistant__transitionToPaletteView_animated_operation___block_invoke;
          v59[3] = &unk_2511FB170;
          v62 = &v76;
          v59[4] = self;
          v60 = v11;
          ...
          v57[0] = v48;
          v57[1] = 3221225472;
          v57[2] = __81__SUUINavigationControllerAssistant__transitionToPaletteView_animated_operation___block_invoke_2;
          v57[3] = &unk_2511F4908;
          v58 = v60;
...
LABEL_17:
      ...
      *((_OWORD *)v77 + 2) = *MEMORY[0x24BDBEFB0];
      -[SUUINavigationControllerAssistant childPaletteView](self, "childPaletteView");
      ...
      objc_msgSend(v50, "setFrame:isAnimating:", objc_msgSend(MEMORY[0x24BEBDB00], "_isInAnimationBlockWithAnimationsEnabled"), v37, v39, v41, MaxY);
    ...
    -[SUUINavigationControllerAssistant _hideChildPaletteView:animated:](self, "_hideChildPaletteView:animated:", v11, v6);
LABEL_18:
...
void __81__SUUINavigationControllerAssistant__transitionToPaletteView_animated_operation___block_invoke(uint64_t a1)
{
  ...
  *(_OWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 32) = *MEMORY[0x24BDBEFB0];
  ...
  objc_msgSend(v10, "setFrame:isAnimating:", objc_msgSend(MEMORY[0x24BEBDB00], "_isInAnimationBlockWithAnimationsEnabled"), *(double *)(a1 + 104), *(double *)(a1 + 112), *(double *)(a1 + 120), *(double *)(a1 + 128));
