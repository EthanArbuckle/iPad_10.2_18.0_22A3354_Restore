...
- (SUUIEditorialComponent)initWithBrickRoomText:(id)a3
{
  ...
  v5 = -[SUUIEditorialComponent init](&v9, sel_init);
  if (v5)
  {
...
- (SUUIEditorialComponent)initWithCustomPageContext:(id)a3
{
  ...
  v5 = -[SUUIPageComponent initWithCustomPageContext:](&v38, sel_initWithCustomPageContext_, v4);
  if (v5)
  {
        ...
        do
        {
          for (i = 0; i != v21; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              v25 = -[SUUILink initWithComponentContext:]([SUUILink alloc], "initWithComponentContext:", v18);
              if (v25)
...
- (SUUIEditorialComponent)initWithViewElement:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SUUIEditorialComponent;
  v5 = -[SUUIPageComponent initWithViewElement:](&v9, sel_initWithViewElement_, v4);
  if (v5)
  {
...
- (NSAttributedString)bodyAttributedText
{
  ...
  -[SUUIPageComponent viewElement](self, "viewElement");
...
void __44__SUUIEditorialComponent_bodyAttributedText__block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "addAttribute:value:range:", *MEMORY[0x24BEBB3A8], v7, a3, a4);
