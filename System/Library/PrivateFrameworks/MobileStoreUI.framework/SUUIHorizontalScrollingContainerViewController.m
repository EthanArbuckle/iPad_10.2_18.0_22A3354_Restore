...
- (void)viewDidLayoutSubviews
{
  ...
  -[SUUIHorizontalScrollingContainerViewController viewDidLayoutSubviews](&v22, sel_viewDidLayoutSubviews);
  -[SUUIHorizontalScrollingContainerViewController view](self, "view");
...
- (void)viewDidLoad
{
  ...
  -[SUUIHorizontalScrollingContainerViewController viewDidLoad](&v25, sel_viewDidLoad);
  -[SUUIHorizontalScrollingContainerViewController view](self, "view");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (Height >= 2.0)
    ...
    v20 = 2.0;
  v21 = (UICollectionView *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD450]), "initWithFrame:collectionViewLayout:", v15, v6, v8, v18, v20);
  ...
  -[UICollectionView setBackgroundColor:](v23, "setBackgroundColor:", v24);

  -[UICollectionView setDataSource:](self->_contentCollectionView, "setDataSource:", self);
  -[UICollectionView setDelegate:](self->_contentCollectionView, "setDelegate:", self);
  -[UICollectionView registerClass:forCellWithReuseIdentifier:](self->_contentCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251202068);
  -[UICollectionView setScrollsToTop:](self->_contentCollectionView, "setScrollsToTop:", 0);
  -[UICollectionView setShowsHorizontalScrollIndicator:](self->_contentCollectionView, "setShowsHorizontalScrollIndicator:", 0);
  -[UICollectionView setShowsVerticalScrollIndicator:](self->_contentCollectionView, "setShowsVerticalScrollIndicator:", 0);
  -[UICollectionView setPrefetchingEnabled:](self->_contentCollectionView, "setPrefetchingEnabled:", 0);
  -[UICollectionView setPagingEnabled:](self->_contentCollectionView, "setPagingEnabled:", 1);
...
- (id)contentScrollView
{
  ...
  if (!self->_proxyScrollView
    && -[SUUIHorizontalScrollingContainerViewController isViewLoaded](self, "isViewLoaded"))
  {
...
- (void)scrollViewDidChangeContentInset:(id)a3
{
  ...
  if (self->_proxyScrollView == a3)
  {
      ...
      || self->_proxyScrollViewContentInsetAdjustment.bottom != v6)
    {
      ...
      self->_proxyScrollViewContentInsetAdjustment.bottom = v6;
      self->_proxyScrollViewContentInsetAdjustment.right = v7;
      -[SUUIHorizontalScrollingContainerViewController viewControllerContentScrollViewContentInset](self, "viewControllerContentScrollViewContentInset");
      v12 = v11;
      v14 = v13;
      v16 = v15;
      v18 = v17;
      -[SUUIHorizontalScrollingContainerViewController viewControllers](self, "viewControllers");
...
- (void)collectionView:(id)a3 willDisplayCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  {
    v9 = v7;
    -[SUUIHorizontalScrollingContainerViewController delegate](self, "delegate");
...
{
  return (NSIndexPath *)-[SUUIHorizontalScrollingContainerViewController _indexPathOfFocusedContentItemWithDistanceToFocusedPosition:layoutAttributes:](self, "_indexPathOfFocusedContentItemWithDistanceToFocusedPosition:layoutAttributes:", 0, 0);
}
...
- (void)setMenuBarCollectionView:(id)a3
{
  ...
  if (menuBarCollectionView != v5)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v8, "conformsToProtocol:", &unk_25721AD88))
    ...
    if (objc_msgSend(v9, "conformsToProtocol:", &unk_25721AD88))
...
{
  SUUIHorizontalScrollingContainerViewController *v4;
  SUUIHorizontalScrollingContainerViewController *v5;
  _QWORD v6[4];
  SUUIHorizontalScrollingContainerViewController *v7;
  ...
  v7 = v4;
  v5 = v4;
  -[SUUIHorizontalScrollingContainerViewController _setViewControllers:collectionViewsUpdateHandler:](v5, "_setViewControllers:collectionViewsUpdateHandler:", a3, v6);
...
- (void)replaceViewControllerAtIndex:(unint64_t)a3 withViewController:(id)a4
{
  ...
  int v11;
  NSUInteger v12;
  SUUIHorizontalScrollingContainerViewController *v13;
  SUUIHorizontalScrollingContainerViewController *v14;
  _QWORD v15[4];
  SUUIHorizontalScrollingContainerViewController *v16;
  id v17;
  NSUInteger v18;
  unint64_t v19;
  ...
  if (v11)
  {
    ...
    v17 = v6;
    v14 = v13;
    -[SUUIHorizontalScrollingContainerViewController _setViewControllers:collectionViewsUpdateHandler:](v14, "_setViewControllers:collectionViewsUpdateHandler:", v7, v15);

  }
  else
  {
    -[SUUIHorizontalScrollingContainerViewController setViewControllers:](self, "setViewControllers:", v7);
  }
  ...
  if (v9)
  {
    ...
    if (!v20 || bottom != v16)
    {
      ...
      if (v22)
      {
        ...
        {
          v24 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 1);
          v25 = self->_viewControllerToExistingContentInsetAdjustment;
          self->_viewControllerToExistingContentInsetAdjustment = v24;

          viewControllerToExistingContentInsetAdjustment = self->_viewControllerToExistingContentInsetAdjustment;
        }
        objc_msgSend(MEMORY[0x24BDD1968], "valueWithUIEdgeInsets:", top, left, bottom, right);
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SUUIHorizontalScrollingContainerViewController _applyNewContentInset:toViewController:](self, "_applyNewContentInset:toViewController:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * v13++), top, left, bottom, right);
      }
      while (v11 != v13);
...
- (void)_scrollViewDidScroll:(id)a3
{
  ...
  if ((UICollectionView *)self->_proxyScrollView != v4 && !self->_isHandlingScrollViewDidScroll)
  {
    ...
    {
      v5 = v4;
      -[SUUIHorizontalScrollingContainerViewController _synchronizeContentCollectionViewWithMenuBarCollectionView](self, "_synchronizeContentCollectionViewWithMenuBarCollectionView");
    }
    else
    {
...
LABEL_8:
      ...
      v5 = v4;
      -[SUUIHorizontalScrollingContainerViewController _synchronizeMenuBarCollectionViewWithContentCollectionView](self, "_synchronizeMenuBarCollectionViewWithContentCollectionView");
    }
    v4 = v5;
    goto LABEL_8;
  }
...
- (void)_setViewControllers:(id)a3 collectionViewsUpdateHandler:(id)a4
{
  ...
  uint64_t i;
  void *v18;
  SUUIHorizontalScrollingContainerViewController *v19;
  void *v20;
  NSArray *v21;
  uint64_t v22;
  char **v23;
  ...
  void *v27;
  uint64_t v28;
  SUUIHorizontalScrollingContainerViewController *v29;
  NSArray *v30;
  void *v31;
  id v32;
  char **v33;
  ...
  if (viewControllers != v6 && !-[NSArray isEqualToArray:](viewControllers, "isEqualToArray:", v6))
  {
    ...
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", objc_msgSend(v9, "count"));
    v62 = 0u;
    v63 = 0u;
    v64 = 0u;
    v65 = 0u;
      ...
      do
      {
        for (i = 0; i != v15; ++i)
        {
          ...
          if (!-[NSArray containsObject:](self->_viewControllers, "containsObject:", v18))
          {
            ...
            v19 = (SUUIHorizontalScrollingContainerViewController *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v12, "count"))
      -[SUUIHorizontalScrollingContainerViewController _applyNewContentInset:toViewControllers:](self, "_applyNewContentInset:toViewControllers:", v12, *MEMORY[0x24BEBE158], *(double *)(MEMORY[0x24BEBE158] + 8), *(double *)(MEMORY[0x24BEBE158] + 16), *(double *)(MEMORY[0x24BEBE158] + 24));
    v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSArray count](self->_viewControllers, "count"));
    v58 = 0u;
    v59 = 0u;
    v60 = 0u;
    v61 = 0u;
    ...
    v23 = &selRef_setCompactAdCardHairlineLayer_;
    if (v22)
    {
      v24 = v22;
      v25 = *(_QWORD *)v59;
      do
      {
        ...
        do
        {
          ...
          if ((objc_msgSend(v13, "containsObject:", v27) & 1) == 0)
          {
            ...
            if (objc_msgSend(v27, "conformsToProtocol:", v23[427]))
            {
            ...
            -[SUUIHorizontalScrollingContainerViewController addChildViewController:](self, "addChildViewController:", v27);
          }
          ++v26;
        }
        while (v24 != v26);
    ...
    if (v42)
    {
      ...
      do
      {
        for (k = 0; k != v43; ++k)
        {
          ...
          if (objc_msgSend(v46, "conformsToProtocol:", v23[427]))
...
- (void)_synchronizeContentCollectionViewWithMenuBarCollectionView
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v3, "conformsToProtocol:", &unk_2571C0380))
  {
    v10 = 0.0;
...
- (void)_synchronizeMenuBarCollectionViewWithContentCollectionView
{
  ...
  v10 = 0;
  v11 = 0.0;
  -[SUUIHorizontalScrollingContainerViewController _indexPathOfFocusedContentItemWithDistanceToFocusedPosition:layoutAttributes:](self, "_indexPathOfFocusedContentItemWithDistanceToFocusedPosition:layoutAttributes:", &v11, &v10);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v10;
  v5 = v4;
  if (v3 && v4)
  {
    ...
    -[UICollectionView collectionViewLayout](self->_menuBarCollectionView, "collectionViewLayout");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v8, "conformsToProtocol:", &unk_2571C0380))
    {
      v9 = v7 / Width;
      if (v7 / Width < -1.0)
        v9 = -1.0;
...
{
  return (SUUIHorizontalScrollingContainerViewControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
