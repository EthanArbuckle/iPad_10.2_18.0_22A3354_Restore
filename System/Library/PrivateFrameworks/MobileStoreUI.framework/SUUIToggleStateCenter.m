...
- (SUUIToggleStateCenter)init
{
  ...
  v2 = -[SUUIToggleStateCenter init](&v13, sel_init);
  if (v2)
  {
    ...
    v10 = *MEMORY[0x24BEB20F0];
    objc_msgSend(MEMORY[0x24BEB1D88], "defaultStore");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "addObserver:selector:name:object:", v2, sel__accountStoreChangeNotification_, v10, v11);
...
- (void)dealloc
{
  ...
  -[SUUIToggleStateCenter dealloc](&v6, sel_dealloc);
}
...
void __38__SUUIToggleStateCenter_defaultCenter__block_invoke(uint64_t a1)
{
  id v1;
  void *v2;
...
void __43__SUUIToggleStateCenter_itemForIdentifier___block_invoke(_QWORD *a1)
{
  void *v2;
  uint64_t v3;
  uint64_t v4;
  ...
  {
    v7 = objc_alloc_init(SUUIToggleStateItem);
    v8 = *(_QWORD *)(a1[6] + 8);
    v9 = *(void **)(v8 + 40);
    *(_QWORD *)(v8 + 40) = v7;
...
- (void)removeObserver:(id)a3
{
  ...
  block[0] = MEMORY[0x24BDAC760];
  block[1] = 3221225472;
  block[2] = __40__SUUIToggleStateCenter_removeObserver___block_invoke;
