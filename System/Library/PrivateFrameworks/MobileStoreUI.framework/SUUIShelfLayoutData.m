...
- (SUUIShelfLayoutData)initWithNumberOfRows:(int64_t)a3 columnSpacing:(double)a4
{
  ...
  v6 = -[SUUIShelfLayoutData init](&v11, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (void)dealloc
{
  ...
  -[SUUIShelfLayoutData dealloc](&v4, sel_dealloc);
}
...
- (void)reloadWithItemCount:(int64_t)a3 sizeBlock:(id)a4
{
  ...
  if (a3 >= 1)
  {
    ...
    do
    {
      ...
      v17 = objc_alloc(MEMORY[0x24BDD16E0]);
      *(float *)&v18 = v11;
...
- (double)rowHeightForIndex:(int64_t)a3
{
  ...
  if (self->_numberOfRows <= a3)
  {
    ...
    objc_msgSend(v7, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SUUIShelfLayoutData.m"), 85, CFSTR("Invalid row index: %ld"), a3);
