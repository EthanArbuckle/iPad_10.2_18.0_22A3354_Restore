...
{
  return -[SUUIStarRatingQueue initWithClientContext:reviewConfiguration:](self, "initWithClientContext:reviewConfiguration:", 0, 0);
}
...
- (SUUIStarRatingQueue)initWithClientContext:(id)a3 reviewConfiguration:(id)a4
{
  ...
  v9 = -[SUUIStarRatingQueue init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (void)setRating:(int64_t)a3 forItemID:(id)a4 completionBlock:(id)a5
{
  ...
  if (v11)
  {
    -[SUUIStarRatingQueue _setRating:forItemID:account:completionBlock:](self, "_setRating:forItemID:account:completionBlock:", a3, v8, v11, v9);
  }
  else
  {
    v12 = objc_alloc_init(MEMORY[0x24BEB1DB8]);
...
void __59__SUUIStarRatingQueue_setRating_forItemID_completionBlock___block_invoke(_QWORD *a1, void *a2)
{
  uint64_t v3;
  void *v4;
  uint64_t v5;
...
- (void)_setRating:(int64_t)a3 forItemID:(id)a4 account:(id)a5 completionBlock:(id)a6
{
  ...
  v26[1] = 3221225472;
  v26[2] = __68__SUUIStarRatingQueue__setRating_forItemID_account_completionBlock___block_invoke;
  v26[3] = &__block_descriptor_40_e5_v8__0l;
  v26[4] = v13;
  v18 = (void *)objc_msgSend(v14, "beginBackgroundTaskWithName:expirationHandler:", v16, v26);

  v19 = -[SUUIPostRatingOperation initWithRating:forItemID:reviewConfiguration:]([SUUIPostRatingOperation alloc], "initWithRating:forItemID:reviewConfiguration:", a3, v10, self->_reviewConfiguration);
  objc_initWeak(&location, v19);
  v22[0] = v17;
  v22[1] = 3221225472;
  v22[2] = __68__SUUIStarRatingQueue__setRating_forItemID_account_completionBlock___block_invoke_2;
  v22[3] = &unk_2511FC698;
  objc_copyWeak(v24, &location);
  v20 = v12;
  v23 = v20;
  v24[1] = v18;
  -[SUUIPostRatingOperation setCompletionBlock:](v19, "setCompletionBlock:", v22);
...
void __68__SUUIStarRatingQueue__setRating_forItemID_account_completionBlock___block_invoke_3(uint64_t a1)
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB1DF0]), "initWithResponseDictionary:", v2);
    v17 = 0u;
    v18 = 0u;
    v19 = 0u;
    v20 = 0u;
