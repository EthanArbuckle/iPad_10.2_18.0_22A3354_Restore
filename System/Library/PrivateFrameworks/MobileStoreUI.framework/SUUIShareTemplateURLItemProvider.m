...
- (SUUIShareTemplateURLItemProvider)initWithTemplateElement:(id)a3
{
  ...
  void *v6;
  uint64_t v7;
  SUUIShareTemplateURLItemProvider *v8;
...
- (id)activityViewController:(id)a3 thumbnailImageForActivityType:(id)a4 suggestedSize:(CGSize)a5
{
  ...
  void *v15;
  void *v16;
  SUUIStyledImageDataConsumer *v17;
  id v18;
  _QWORD v20[5];
  uint64_t v21;
  uint64_t *v22;
  ...
  -[SUUIShareTemplateViewElement activityForUIActivityType:](templateElement, "activityForUIActivityType:", v12);
  ...
  if (v15)
  {
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2040]), "initWithURL:", v15);
    objc_msgSend(v16, "setITunesStoreRequest:", 0);
    v17 = -[SUUIStyledImageDataConsumer initWithViewElement:]([SUUIStyledImageDataConsumer alloc], "initWithViewElement:", v14);
...
- (id)item
{
  ...
  -[SUUIShareTemplateViewElement activityForUIActivityType:](templateElement, "activityForUIActivityType:", v3);
