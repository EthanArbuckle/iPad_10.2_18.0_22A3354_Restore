...
- (SUUILabelViewElement)initWithDOMElement:(id)a3 parent:(id)a4 elementFactory:(id)a5
{
  ...
  v12 = -[SUUIViewElement initWithDOMElement:parent:elementFactory:](&v24, sel_initWithDOMElement_parent_elementFactory_, v9, v10, v11);
  if (v12)
  {
    ...
    v19 = objc_msgSend(v18, "isEqualToString:", CFSTR("firstBaseline"));
    v20 = 0;
    if ((v19 & 1) == 0)
    {
      if (!objc_msgSend(v18, "isEqualToString:", CFSTR("trailing")))
      {
LABEL_9:
        ...
        -[SUUILabelViewElement _walkDOM:parent:elementFactory:](v12, "_walkDOM:parent:elementFactory:", v9, v10, v11);
        objc_storeStrong((id *)&v12->_xml, a3);
        -[SUUILabelViewElement _createText:](v12, "_createText:", v12->_xml);
...
- (void)dealloc
{
  ...
  if (xml)
  {
    -[SUUILabelViewElement appDocument](self, "appDocument");
...
{
  SUUILabelViewElement *v4;
  SUUILabelViewElement *v5;
  NSString *v8;
  NSString *moreButtonTitle;
  SUUIViewElementText *v10;
  ...
  -[SUUIViewElement applyUpdatesWithElement:](&v13, sel_applyUpdatesWithElement_, v4);
  v5 = (SUUILabelViewElement *)objc_claimAutoreleasedReturnValue();
  if (v5 == self && v4 != self && v4 != 0)
  {
    self->_labelViewStyle = -[SUUILabelViewElement labelViewStyle](v4, "labelViewStyle");
    -[SUUILabelViewElement moreButtonTitle](v4, "moreButtonTitle");
    v8 = (NSString *)objc_claimAutoreleasedReturnValue();
    moreButtonTitle = self->_moreButtonTitle;
    self->_moreButtonTitle = v8;

    self->_numberOfLines = -[SUUILabelViewElement numberOfLines](v4, "numberOfLines");
    -[SUUILabelViewElement text](v4, "text");
    v10 = (SUUIViewElementText *)objc_claimAutoreleasedReturnValue();
    text = self->_text;
    self->_text = v10;
...
- (id)uniquingMapKey
{
  ...
  if (text)
    return text;
  v4.receiver = self;
  v4.super_class = (Class)SUUILabelViewElement;
  -[SUUIViewElement uniquingMapKey](&v4, sel_uniquingMapKey);
...
- (void)linkTapped:(id)a3 range:(_NSRange)a4
{
  ...
  objc_msgSend(v6, "attribute:atIndex:effectiveRange:", 0x2512007C8, location, &v9);
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
        objc_msgSend(v8, "dispatchEventOfType:canBubble:isCancelable:extraInfo:completionBlock:", 2, 1, 1, 0, &__block_literal_global_41);
    }
...
- (void)_createText:(id)a3
{
  ...
  v17 = v8;
  v18 = v19;
  +[IKTextParser textWithDOMElement:usingParseBlock:](SUUIViewElementText, "textWithDOMElement:usingParseBlock:", v4, &v11);
...
__CFString *__36__SUUILabelViewElement__createText___block_invoke(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  ...
  SUUILabelStringAttributesWithSpanElement(v10);
  ...
  if (objc_msgSend(v12, "isEqualToString:", CFSTR("badge")))
  {
    ...
    *a4 = 1;
    v14 = v10;
    v15 = -[SUUIBadgeTextAttachment initWithViewElement:]([SUUIBadgeTextAttachment alloc], "initWithViewElement:", v14);
    if (v15)
    {
  ...
  if (objc_msgSend(v12, "isEqualToString:", CFSTR("button")))
  {
    ...
    *(_QWORD *)(v19 + 304) = v20 + 1;
    ...
    {
      v59 = CFSTR("SUUILinkAttributeName");
      v60 = v21;
      v30 = (void *)MEMORY[0x24BDBCE70];
      v31 = &v60;
      v32 = &v59;
    ...
    v17 = (__CFString *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1458]), "initWithString:attributes:", v26, v35);
...
LABEL_18:
  ...
  else
  {
    ...
    if (v11 | v37)
    {
      ...
      v17 = (__CFString *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1458]), "initWithString:attributes:", v16, v11);
    }
    else
    {
      v16 = 0;
...
- (id)_stringFromDateElement:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  SUUIViewElementDateWithString(v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
...
- (id)_stringFromDurationElement:(id)a3
{
  ...
  else
  {
    ...
    if (!_stringFromDurationElement__sHourOutputFormatter)
    {
      v16 = 224;
LABEL_10:
      v18 = objc_alloc_init(MEMORY[0x24BDD14F8]);
      v19 = (id)*v14;
      *v14 = (uint64_t)v18;
  ...
  if (v15)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SUUILabelViewElement _walkDOM:parent:elementFactory:](self, "_walkDOM:parent:elementFactory:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v18++), v9, v10);
      }
      while (v16 != v18);
