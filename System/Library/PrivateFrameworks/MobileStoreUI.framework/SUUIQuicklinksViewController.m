...
- (void)dealloc
{
  ...
  -[SUUIQuicklinksViewController dealloc](&v3, sel_dealloc);
}
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  width = a3.width;
  v6 = (id)-[SUUIQuicklinksViewController view](self, "view", a4, a3.width, a3.height);
  if (width <= 682.0)
    v7 = 1;
  else
    v7 = 3;
  ...
  -[UICollectionView setFrame:](self->_collectionView, "setFrame:", v8, v9, v10, ceilf((float)-[SUUIQuicklinksViewController _numberOfRows](self, "_numberOfRows") * 44.0));
  -[SUUIQuicklinksView sizeToFit](self->_quicklinksView, "sizeToFit");

}

- (void)loadView
{
  SUUIQuicklinksView *v3;
  SUUIQuicklinksView *quicklinksView;
  SUUIQuicklinksView *v5;
  void *v6;
  void *v7;
  uint64_t v8;
  uint64_t v9;
  ...
  UICollectionView *collectionView;
  void *v15;
  SUUIItemGridCollectionViewLayout *v16;
  ...
  -[SUUIQuicklinksViewController title](self, "title");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIQuicklinksView setTitle:](v5, "setTitle:", v6);

  -[SUUIQuicklinksViewController setView:](self, "setView:", self->_quicklinksView);
  ...
  if ((v8 & 0xFFFFFFFFFFFFFFFBLL) == 1)
    ...
    v9 = 1;
  -[SUUIItemGridCollectionViewLayout setNumberOfColumns:](v16, "setNumberOfColumns:", v9);
  -[UICollectionViewFlowLayout setMinimumLineSpacing:](v16, "setMinimumLineSpacing:", 0.0);
  ...
  v12 = -[SUUIQuicklinksViewController _numberOfRows](self, "_numberOfRows");
  v13 = (UICollectionView *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD450]), "initWithFrame:collectionViewLayout:", v16, 0.0, 0.0, 0.0, ceilf((float)v12 * 44.0));
  collectionView = self->_collectionView;
  ...
  -[UICollectionView setBackgroundColor:](self->_collectionView, "setBackgroundColor:", v15);
  ...
  -[SUUIQuicklinksView setCollectionView:](self->_quicklinksView, "setCollectionView:", self->_collectionView);
  -[SUUIQuicklinksView setColoringWithColorScheme:](self->_quicklinksView, "setColoringWithColorScheme:", self->_colorScheme);
  -[SUUIQuicklinksView sizeToFit](self->_quicklinksView, "sizeToFit");
...
- (void)setTitle:(id)a3
{
  ...
  quicklinksView = self->_quicklinksView;
  v5 = a3;
  -[SUUIQuicklinksView setTitle:](quicklinksView, "setTitle:", v5);
  v6.receiver = self;
  v6.super_class = (Class)SUUIQuicklinksViewController;
  -[SUUIQuicklinksViewController setTitle:](&v6, sel_setTitle_, v5);
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[SUUIQuicklinksViewController viewWillAppear:](&v13, sel_viewWillAppear_, a3);
  v11 = 0u;
  v12 = 0u;
  v9 = 0u;
  v10 = 0u;
...
{
  return (SUUIQuicklinksViewControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
