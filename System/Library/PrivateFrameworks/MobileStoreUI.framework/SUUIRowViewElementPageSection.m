...
- (UIEdgeInsets)sectionContentInset
{
  ...
  objc_msgSend(v9, "valueForStyle:", *MEMORY[0x24BE518E8]);
...
LABEL_4:
    ...
    -[SUUIStorePageSection sectionContentInset](&v23, sel_sectionContentInset);
  }
  result.right = v22;
  result.bottom = v21;
  result.left = v20;
...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  -[SUUIRowViewElementPageSection _firstChildForColumn:](self, "_firstChildForColumn:", v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)cellForIndexPath:(id)a3
{
  ...
  -[SUUIRowViewElementPageSection _firstChildForColumn:](self, "_firstChildForColumn:", v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIRowViewElementPageSection _reuseIdentifierForViewElement:](self, "_reuseIdentifierForViewElement:", v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIRowViewElementPageSection _contentInsetForIndexPath:](self, "_contentInsetForIndexPath:", v4);
  v15 = v14;
  v17 = v16;
  v19 = v18;
  v21 = v20;
  ...
  -[SUUIRowViewElementPageSection _interiorColumnSpacing](self, "_interiorColumnSpacing");
  v23 = v22;
  -[SUUIRowViewElementPageSection _singleColumnWidth](self, "_singleColumnWidth");
  v25 = v24;
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  v12[6] = v5;
  v12[4] = self;
  -[SUUIRowViewElementPageSection _enumerateViewElementsUsingBlock:](self, "_enumerateViewElementsUsingBlock:", v12);
  -[SUUIRowViewElementPageSection _contentInsetForIndexPath:](self, "_contentInsetForIndexPath:", v4);
  v8 = v14[5];
  v9 = v6 + v7 + v14[4];
  v14[4] = v9;
...
- (void)entityProvider:(id)a3 didInvalidateWithContext:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SUUIRowViewElementPageSection _requestLayoutForCells](self, "_requestLayoutForCells");
  v8.receiver = self;
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  v6[4] = self;
  v6[5] = a3;
  -[SUUIRowViewElementPageSection _enumerateViewElementsUsingBlock:](self, "_enumerateViewElementsUsingBlock:", v6);
  v5.receiver = self;
  v5.super_class = (Class)SUUIRowViewElementPageSection;
  -[SUUIStorePageSection prefetchResourcesWithReason:](&v5, sel_prefetchResourcesWithReason_, a3);
}
...
- (void)willAppearInContext:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120A6C8);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120A6E8);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251211FE8);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251209A48);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120FE88);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120CA48);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251210428);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251205968);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251211F68);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120DEC8);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x2512057E8);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x25120A268);
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  id v16;
  id v17;
  SUUIRowViewElementPageSection *v18;
  int64_t v19;
  ...
  v12 = v7;
  v13 = v9;
  -[SUUIRowViewElementPageSection _enumerateViewElementsUsingBlock:](self, "_enumerateViewElementsUsingBlock:", v14);
...
void __61__SUUIRowViewElementPageSection_artworkRequest_didLoadImage___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", a3, *(_QWORD *)(a1 + 64));
...
LABEL_10:
    ...
    v6 = -[SUUIRowViewElementPageSection _cellClassForLockupViewElement:](self, "_cellClassForLockupViewElement:", v4);
  }
  else
  {
    if (v5 <= 13 || v5 != 14)
      goto LABEL_10;
    v6 = -[SUUIRowViewElementPageSection _cellClassForCardViewElement:](self, "_cellClassForCardViewElement:", v4);
  }
LABEL_11:
  v7 = v6;
...
void __54__SUUIRowViewElementPageSection__firstChildForColumn___block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
...
- (void)_requestLayoutForCells
{
  ...
  v2[3] = &unk_2511F71F8;
  v2[4] = self;
  -[SUUIRowViewElementPageSection _enumerateViewElementsUsingBlock:](self, "_enumerateViewElementsUsingBlock:", v2);
}
...
- (id)_reuseIdentifierForViewElement:(id)a3
{
  ...
  if (v5 > 49)
  {
    if (v5 > 133)
    {
      if (v5 == 134)
      {
        v6 = CFSTR("SUUIStarHistogramCellReuseIdentifier");
        goto LABEL_24;
      }
      if (v5 == 141)
        goto LABEL_19;
      if (v5 != 152)
        goto LABEL_14;
LABEL_18:
      v6 = CFSTR("SUUIImageReuseIdentifier");
      goto LABEL_24;
    }
    if (v5 == 50)
      goto LABEL_19;
    if (v5 == 62)
    {
      v6 = CFSTR("SUUIHorizontalListReuseIdentifier");
      goto LABEL_24;
    }
    if (v5 != 66)
      goto LABEL_14;
    -[SUUIRowViewElementPageSection _reuseIdentifierForLockupViewElement:](self, "_reuseIdentifierForLockupViewElement:", v4);
  ...
  else
  {
    if (v5 <= 13)
    {
      if ((unint64_t)(v5 - 12) >= 2)
      {
        if (v5 == 4)
        {
          v6 = CFSTR("SUUIActivityIndicatorReuseIdentifier");
LABEL_24:
          v7 = v6;
          goto LABEL_25;
        }
LABEL_14:
        v6 = CFSTR("SUUISpacerReuseIdentifier");
        goto LABEL_24;
      }
LABEL_19:
      v6 = CFSTR("SUUIButtonReuseIdentifier");
      goto LABEL_24;
    }
    if (v5 != 14)
    {
      if (v5 == 28)
      {
        v6 = CFSTR("SUUICounterReuseIdentifier");
        goto LABEL_24;
      }
      if (v5 != 49)
        goto LABEL_14;
    ...
    -[SUUIRowViewElementPageSection _reuseIdentifierForCardViewElement:](self, "_reuseIdentifierForCardViewElement:", v4);
    v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
LABEL_25:
  v8 = v7;
