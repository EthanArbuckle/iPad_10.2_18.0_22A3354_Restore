...
- (SUUIMediaPageSection)initWithPageComponent:(id)a3
{
  ...
  double v16;
  float v17;
  SUUIEmbeddedMediaView *v18;
  SUUIEmbeddedMediaView *mediaView;
  SUUIEmbeddedMediaView *v20;
  void *v21;
  objc_super v23;
  ...
  v5 = -[SUUIStorePageSection initWithPageComponent:](&v23, sel_initWithPageComponent_, v4);
  if (v5)
  {
    ...
    v16 = (double)-[SUUIArtwork height](v5->_artwork, "height");
    v17 = v8 / (double)-[SUUIArtwork width](v5->_artwork, "width") * v16;
    ...
    -[SUUIEmbeddedMediaView setAccessibilityLabel:](v20, "setAccessibilityLabel:", v21);

    -[SUUIEmbeddedMediaView setDelegate:](v5->_mediaView, "setDelegate:", v5);
    -[SUUIEmbeddedMediaView setThumbnailContentMode:](v5->_mediaView, "setThumbnailContentMode:", 5);
  }
...
- (void)dealloc
{
  ...
  -[SUUIEmbeddedMediaView setDelegate:](self->_mediaView, "setDelegate:", 0);
  v3.receiver = self;
...
- (id)cellForIndexPath:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", CFSTR("SUUIMediaPageSectionReuseIdentifier"), v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_4:
    -[SUUIMediaPageSection _loadImageWithReason:](self, "_loadImageWithReason:", 1);
    goto LABEL_5;
  }
LABEL_6:
  -[SUUIEmbeddedMediaView setThumbnailImage:](self->_mediaView, "setThumbnailImage:", v10);
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  if (-[SUUIEmbeddedMediaView showsThumbnailReflection](self->_mediaView, "showsThumbnailReflection"))
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  {
    -[SUUIEmbeddedMediaView beginPlaybackAnimated:](self->_mediaView, "beginPlaybackAnimated:", 1);
  }
  else
  {
    objc_msgSend(v8, "link");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIStorePageSection showPageWithLink:](self, "showPageWithLink:", v7);
...
- (double)contentInsetAdjustmentForCollectionView:(id)a3
{
  ...
  v4 = -[SUUIEmbeddedMediaView showsThumbnailReflection](self->_mediaView, "showsThumbnailReflection", a3);
  result = 0.0;
  if (v4)
...
{
  if (!self->_artworkRequestID)
    -[SUUIMediaPageSection _loadImageWithReason:](self, "_loadImageWithReason:", a3);
}
...
- (void)setSectionIndex:(int64_t)a3
{
  ...
  -[SUUIEmbeddedMediaView setShowsThumbnailReflection:](self->_mediaView, "setShowsThumbnailReflection:", a3 == 0);
  v5.receiver = self;
  v5.super_class = (Class)SUUIMediaPageSection;
  -[SUUIStorePageSection setSectionIndex:](&v5, sel_setSectionIndex_, a3);
}
...
- (void)willAppearInContext:(id)a3
{
  ...
  objc_msgSend(v3, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), CFSTR("SUUIMediaPageSectionReuseIdentifier"));

}

- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  -[SUUIEmbeddedMediaView setThumbnailImage:](self->_mediaView, "setThumbnailImage:", a4);
}
...
- (void)mediaView:(id)a3 playbackStateDidChange:(int64_t)a4
{
  ...
  if (objc_msgSend(v7, "canRecordEventWithType:", *MEMORY[0x24BEB2920]))
  {
    v8 = objc_alloc_init(MEMORY[0x24BEB1F08]);
...
- (void)_loadImageWithReason:(int64_t)a3
{
  ...
  -[SUUIArtwork URL](self->_artwork, "URL");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIArtworkRequest setURL:](v13, "setURL:", v4);

  +[SUUISizeToFitImageDataConsumer consumerWithConstraintSize:](SUUISizeToFitImageDataConsumer, "consumerWithConstraintSize:", self->_imageSize.width, self->_imageSize.height);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIStorePageSection pageComponent](self, "pageComponent");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIArtworkRequest setDataConsumer:](v13, "setDataConsumer:", v5);
  self->_artworkRequestID = -[SUUIResourceRequest requestIdentifier](v13, "requestIdentifier");
  -[SUUIStorePageSection context](self, "context");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
