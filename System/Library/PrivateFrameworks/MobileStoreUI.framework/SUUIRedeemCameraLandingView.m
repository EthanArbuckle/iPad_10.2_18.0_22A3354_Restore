...
{
  id v4;
  SUUIRedeemCameraLandingView *v5;
  void *v6;
  void *v7;
  uint64_t v8;
  uint64_t v9;
  ...
  v5 = -[SUUIRedeemCameraLandingView init](&v51, sel_init);
  if (!v5)
    goto LABEL_27;
  ...
  -[SUUIRedeemCameraLandingView addSubview:](v5, "addSubview:", v5->_imageView);
  ...
  v20 = +[SUUIRedeemViewControllerLegacy redeemRequiresNationalId:](SUUIRedeemViewControllerLegacy, "redeemRequiresNationalId:", v4);
...
LABEL_8:
      ...
      if (v4)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", v25, 0, CFSTR("Redeem"));
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      -[UILabel setText:](v22, "setText:", v26);

      break;
  }
  -[SUUIRedeemCameraLandingView addSubview:](v5, "addSubview:", v5->_headerLabel);
  ...
  if (v4)
    ...
    +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", v30, 0, CFSTR("Redeem"));
  ...
  -[SUUIRedeemCameraLandingView addSubview:](v5, "addSubview:", v5->_bodyLabel);
  ...
  if (v4)
    ...
    +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("CAMERA_REDEEM_USE_CAMERA_BUTTON"), 0, CFSTR("Redeem"));
  ...
  -[SUUIRedeemCameraLandingView addSubview:](v5, "addSubview:", v5->_button);
  objc_msgSend(MEMORY[0x24BEBD4B8], "whiteColor");
  v48 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIRedeemCameraLandingView setBackgroundColor:](v5, "setBackgroundColor:", v48);

  -[SUUIRedeemCameraLandingView setClipsToBounds:](v5, "setClipsToBounds:", 1);
LABEL_27:
...
- (void)setSpacingStyle:(int64_t)a3
{
  if (self->_spacingStyle != a3)
  {
    ...
    -[SUUIRedeemCameraLandingView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIRedeemCameraLandingView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v7 = v3 + -30.0;
