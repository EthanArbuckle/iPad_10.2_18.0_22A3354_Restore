...
{
  SUUISearchCollectionViewFlowLayout *v2;
  objc_super v4;

  v4.receiver = self;
  v4.super_class = (Class)SUUISearchCollectionViewFlowLayout;
  v2 = -[SUUIItemGridCollectionViewLayout init](&v4, sel_init);
  if (v2)
  {
    -[SUUISearchCollectionViewFlowLayout registerClass:forDecorationViewOfKind:](v2, "registerClass:forDecorationViewOfKind:", objc_opt_class(), CFSTR("a"));
    -[SUUISearchCollectionViewFlowLayout registerClass:forDecorationViewOfKind:](v2, "registerClass:forDecorationViewOfKind:", objc_opt_class(), CFSTR("b"));
  }
  return v2;
}
...
- (id)layoutAttributesForElementsInRect:(CGRect)a3
{
  ...
  -[SUUIItemGridCollectionViewLayout layoutAttributesForElementsInRect:](&v30, sel_layoutAttributesForElementsInRect_);
  ...
  if (v15 < v19 - 1)
  {
    do
    {
      objc_msgSend(MEMORY[0x24BDD15D8], "indexPathWithIndex:", v15);
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUISearchCollectionViewFlowLayout layoutAttributesForDecorationViewOfKind:atIndexPath:](self, "layoutAttributesForDecorationViewOfKind:atIndexPath:", CFSTR("b"), v24);
  ...
  if ((uint64_t)(v22 - 1) > v21)
  {
    ...
    do
    {
      objc_msgSend(MEMORY[0x24BDD15D8], "indexPathWithIndex:", v26);
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUISearchCollectionViewFlowLayout layoutAttributesForDecorationViewOfKind:atIndexPath:](self, "layoutAttributesForDecorationViewOfKind:atIndexPath:", CFSTR("a"), v27);
...
- (void)prepareLayout
{
  ...
  -[SUUISearchCollectionViewFlowLayout collectionView](self, "collectionView");
