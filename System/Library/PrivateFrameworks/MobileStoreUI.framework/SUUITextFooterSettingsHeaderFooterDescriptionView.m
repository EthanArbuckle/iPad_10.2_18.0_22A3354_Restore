...
+ (CGSize)sizeThatFitsWidth:(double)a3 settingsHeaderFooterDescription:(id)a4 context:(id)a5
{
  ...
  objc_msgSend(v10, "_scaledValueForValue:", 16.0);
  v16 = v15;
  objc_msgSend(v9, "_firstLineBaselineFrameOriginY");
  v18 = v14 + v16 - v17;
...
- (void)reloadWithSettingsHeaderFooterDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  -[SUUITextFooterSettingsHeaderFooterDescriptionView addSubview:](self, "addSubview:", self->_label);
  -[SUUITextFooterSettingsHeaderFooterDescriptionView setNeedsLayout](self, "setNeedsLayout");
...
- (void)layoutSubviews
{
  ...
  -[SUUITextFooterSettingsHeaderFooterDescriptionView layoutSubviews](&v22, sel_layoutSubviews);
  objc_msgSend(MEMORY[0x24BEBB520], "preferredFontForTextStyle:", *MEMORY[0x24BEBE1E0]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[UILabel setFont:](self->_label, "setFont:", v3);
  -[SUUITextFooterSettingsHeaderFooterDescriptionView bounds](self, "bounds");
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v11 = v10;
  -[SUUITextFooterSettingsHeaderFooterDescriptionView layoutMargins](self, "layoutMargins");
  v13 = v12;
  v15 = v14;
  v23.origin.x = v5;
  v23.origin.y = v7;
