...
{
  void *v3;
  SUUISyncWishlistOperation *v4;

  +[SUUIClientContext defaultContext](SUUIClientContext, "defaultContext");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[SUUISyncWishlistOperation initWithClientContext:](self, "initWithClientContext:", v3);
...
- (SUUISyncWishlistOperation)initWithClientContext:(id)a3
{
  ...
  v6 = -[SUUISyncWishlistOperation init](&v11, sel_init);
  v7 = v6;
  if (v6)
  {
...
void __40__SUUISyncWishlistOperation_resultBlock__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (void)main
{
  ...
  if (v4)
  {
    v5 = objc_alloc(MEMORY[0x24BEB20C8]);
    objc_msgSend(v4, "uniqueIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = (void *)objc_msgSend(v5, "initWithAccountIdentifier:", objc_msgSend(v6, "longLongValue"));

    -[SUUISyncWishlistOperation _sendLocalChangesForWishlist:](self, "_sendLocalChangesForWishlist:", v7);
    v12 = 0;
    v8 = -[SUUISyncWishlistOperation _loadRemoteItemsForWishlist:didChange:error:](self, "_loadRemoteItemsForWishlist:didChange:error:", v7, &v13, &v12);
    v9 = v12;
  ...
  -[SUUISyncWishlistOperation resultBlock](self, "resultBlock");
...
LABEL_15:
      ...
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithCString:encoding:", v25, 4, &v37, v32);
  ...
  v9 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v8);
  v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB7458]), "initWithURL:", v9);
  objc_msgSend(v10, "setCachePolicy:", 1);
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2040]), "initWithURL:", v9);
  +[SSVURLDataConsumer consumer](SUUIWishlistDataConsumer, "consumer");
  ...
  v36[1] = 3221225472;
  v36[2] = __73__SUUISyncWishlistOperation__loadRemoteItemsForWishlist_didChange_error___block_invoke;
  v36[3] = &unk_2511F8500;
  v36[4] = &v47;
  v36[5] = &v37;
  v36[6] = &v43;
  ...
  if (*((_BYTE *)v44 + 24))
  {
    ...
    v16 = v48;
    obj = v48[5];
    v17 = -[SUUISyncWishlistOperation _mergeItems:wishlist:didChange:error:](self, "_mergeItems:wishlist:didChange:error:", v15, v34, v53, &obj);
...
void __73__SUUISyncWishlistOperation__loadRemoteItemsForWishlist_didChange_error___block_invoke(_QWORD *a1, void *a2, void *a3)
{
  id v5;
  uint64_t v6;
  void *v7;
...
BOOL __66__SUUISyncWishlistOperation__mergeItems_wishlist_didChange_error___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(MEMORY[0x24BEB1FA8], "predicateWithProperty:equalToLongLong:", *MEMORY[0x24BEB2BF0], 0);
  ...
  v35[1] = 3221225472;
  v35[2] = __66__SUUISyncWishlistOperation__mergeItems_wishlist_didChange_error___block_invoke_2;
  v35[3] = &unk_2511F8528;
  v8 = v4;
  v36 = v8;
  v26 = v6;
  ...
  v31[0] = v7;
  v31[1] = 3221225472;
  v31[2] = __66__SUUISyncWishlistOperation__mergeItems_wishlist_didChange_error___block_invoke_3;
  v31[3] = &unk_2511F8550;
  v10 = v3;
  v32 = v10;
  v11 = v8;
...
LABEL_4:
      ...
      while (1)
      {
        ...
        v18 = (void *)MEMORY[0x2426A2860]();
        v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB20D0]), "initWithPersistentID:inDatabase:", objc_msgSend(v17, "longLongValue"), v10);
...
void __66__SUUISyncWishlistOperation__mergeItems_wishlist_didChange_error___block_invoke_3(_QWORD *a1, void *a2, uint64_t a3, _BYTE *a4)
{
  void *v7;
  void *v8;
  void *v9;
  ...
  v15 = a2;
  v7 = (void *)MEMORY[0x2426A2860]();
  SUUIWishlistItemPropertiesWithItem(v15);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", a3 + 1);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "setObject:forKey:", v9, *MEMORY[0x24BEB2BE8]);

    objc_msgSend(MEMORY[0x24BEB1FA8], "predicateWithProperty:equalToLongLong:", *MEMORY[0x24BEB2BD8], objc_msgSend(v15, "itemIdentifier"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BEB20D0], "anyInDatabase:predicate:", a1[4], v10);
    ...
    {
      objc_msgSend(v8, "setObject:forKey:", &unk_2512EEB80, *MEMORY[0x24BEB2BF0]);
      v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB20D0]), "initWithPropertyValues:inDatabase:", v8, a1[4]);
...
- (void)_sendLocalChangesForWishlist:(id)a3
{
  ...
  if (v11)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithCString:encoding:", v11, 4, &v26, v18);
    v9 = objc_claimAutoreleasedReturnValue();
    free(v11);
    v17 = (int *)v9;
    SSFileLog();
...
uint64_t __58__SUUISyncWishlistOperation__sendLocalChangesForWishlist___block_invoke(uint64_t a1, void *a2)
{
  ...
  location[1] = *(id *)MEMORY[0x24BDAC8D0];
  v3 = a2;
  v4 = *MEMORY[0x24BEB2BF0];
  objc_msgSend(MEMORY[0x24BEB1FA8], "predicateWithProperty:equalToLongLong:", *MEMORY[0x24BEB2BF0], 1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BEB20D0], "queryWithDatabase:predicate:", v3, v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (id)*MEMORY[0x24BEB2BD0];
  v8 = MEMORY[0x24BDAC760];
  location[0] = v7;
  v16[0] = MEMORY[0x24BDAC760];
  v16[1] = 3221225472;
  v16[2] = __58__SUUISyncWishlistOperation__sendLocalChangesForWishlist___block_invoke_2;
  v16[3] = &unk_2511F85A0;
  v17 = *(id *)(a1 + 32);
  objc_msgSend(v6, "enumeratePersistentIDsAndProperties:count:usingBlock:", location, 1, v16);
  objc_msgSend(MEMORY[0x24BEB1FA8], "predicateWithProperty:equalToLongLong:", v4, 2);
  v9 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(MEMORY[0x24BEB20D0], "queryWithDatabase:predicate:", v3, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  objc_storeStrong(location, (id)*MEMORY[0x24BEB2BD8]);
  v13[0] = v8;
  v13[1] = 3221225472;
  v13[2] = __58__SUUISyncWishlistOperation__sendLocalChangesForWishlist___block_invoke_3;
  v13[3] = &unk_2511F85C8;
  v14 = v3;
  v15 = *(id *)(a1 + 32);
  v11 = v3;
...
void __58__SUUISyncWishlistOperation__sendLocalChangesForWishlist___block_invoke_2(uint64_t a1, uint64_t a2, _QWORD *a3)
{
  void *v5;
  void *v6;
  SUUIItem *v7;
  SUUIAddToWishlistOperation *v8;
  ...
  if (*a3)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v7)
      {
        v8 = -[SUUIAddToWishlistOperation initWithItem:reason:]([SUUIAddToWishlistOperation alloc], "initWithItem:reason:", v7, 1);
...
{
  void *v6;
  SUUIRemoveFromWishlistOperation *v7;

  v6 = (void *)MEMORY[0x2426A2860]();
  if (*a3)
  {
    v7 = -[SUUIRemoveFromWishlistOperation initWithItemIdentifier:entityIdentifier:reason:]([SUUIRemoveFromWishlistOperation alloc], "initWithItemIdentifier:entityIdentifier:reason:", objc_msgSend(*a3, "longLongValue"), a2, 1);
    objc_msgSend(*(id *)(a1 + 40), "addObject:", v7);
  }
  else
  {
    v7 = (SUUIRemoveFromWishlistOperation *)objc_msgSend(objc_alloc(MEMORY[0x24BEB20D0]), "initWithPersistentID:inDatabase:", a2, *(_QWORD *)(a1 + 32));
    -[SUUIRemoveFromWishlistOperation deleteFromDatabase](v7, "deleteFromDatabase");
  }
