...
{
  id v6;
  SUUIJSPhysicalCirclesTemplate *v7;
  id v8;
  objc_super v10;
  id location;
...
{
  -[SUUIJSPhysicalCirclesTemplate _performAnimationWithType:callback:](self, "_performAnimationWithType:callback:", 0, a3);
}

- (void)performResetAnimation:(id)a3
{
  -[SUUIJSPhysicalCirclesTemplate _performAnimationWithType:callback:](self, "_performAnimationWithType:callback:", 1, a3);
}
...
- (void)_performAnimationWithType:(int64_t)a3 callback:(id)a4
{
  id v6;
  void *v7;
  SUUIPhysicalCirclesAnimationRequest *v8;
  uint64_t v9;
  void *v10;
  void *v11;
  void *v12;
  id v13;
  id v14;
  SUUIPhysicalCirclesAnimationRequest *v15;
  _QWORD v16[5];
  SUUIPhysicalCirclesAnimationRequest *v17;
  _QWORD v18[4];
  id v19;
  id v20;
  id v21;
  SUUIJSPhysicalCirclesTemplate *v22;

  v6 = a4;
  -[IKJSObject appContext](self, "appContext");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_alloc_init(SUUIPhysicalCirclesAnimationRequest);
  -[SUUIPhysicalCirclesAnimationRequest setAnimationType:](v8, "setAnimationType:", a3);
  ...
  if (v6)
  {
    ...
    v18[0] = v9;
    v18[1] = 3221225472;
    v18[2] = __68__SUUIJSPhysicalCirclesTemplate__performAnimationWithType_callback___block_invoke;
    v18[3] = &unk_2511F5D20;
    v19 = v7;
    v20 = v10;
    v21 = v12;
    ...
    v13 = v12;
    v14 = v10;
    -[SUUIPhysicalCirclesAnimationRequest _setCompletionBlock:](v8, "_setCompletionBlock:", v18);

  }
  v16[0] = v9;
  v16[1] = 3221225472;
  v16[2] = __68__SUUIJSPhysicalCirclesTemplate__performAnimationWithType_callback___block_invoke_3;
  v16[3] = &unk_2511FAC60;
  v16[4] = self;
  v17 = v8;
  v15 = v8;
...
void *__68__SUUIJSPhysicalCirclesTemplate__performAnimationWithType_callback___block_invoke_2(uint64_t a1)
{
  void *result;
  void *v3;
  id v4;
