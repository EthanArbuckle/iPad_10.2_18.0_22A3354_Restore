...
{
  SUUIStorePageSplitCollectionViewLayout *v2;
  NSMutableArray *v3;
  ...
  v2 = -[_UICollectionViewCompositionLayout init](&v6, sel_init);
  if (v2)
  {
    ...
    -[SUUIStorePageSplitCollectionViewLayout registerClass:forDecorationViewOfKind:](v2, "registerClass:forDecorationViewOfKind:", objc_opt_class(), 0x2511FF4C8);
    -[SUUIStorePageSplitCollectionViewLayout registerClass:forDecorationViewOfKind:](v2, "registerClass:forDecorationViewOfKind:", objc_opt_class(), 0x25120DD68);
  }
  return v2;
}
...
- (void)addSublayoutsUsingSplitsDescription:(id)a3
{
  ...
  v4 = a3;
  -[SUUIStorePageSplitCollectionViewLayout sublayouts](self, "sublayouts");
  ...
  {
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 512, 512, 0);
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        -[SUUIStorePageSplitCollectionViewLayout removeSublayout:](self, "removeSublayout:", *(_QWORD *)(*((_QWORD *)&v44 + 1) + 8 * i));
      }
  ...
  if (v15)
  {
    ...
    if (!v18)
      v18 = -[SUUIStorePageSplitCollectionViewLayout _newStorePageCollectionViewLayout](self, "_newStorePageCollectionViewLayout");
    v19 = objc_msgSend(v17, "numberOfPageSections");
    objc_msgSend(MEMORY[0x24BDD15E0], "indexSetWithIndexesInRange:", 0, v19);
  ...
  if (v22)
  {
    ...
    if (!v24)
      v24 = -[SUUIStorePageSplitCollectionViewLayout _newStorePageCollectionViewLayout](self, "_newStorePageCollectionViewLayout");
    ...
    objc_msgSend(MEMORY[0x24BDD15E0], "indexSetWithIndexesInRange:", v19, v25);
  ...
  if (v29)
  {
    ...
    if (!v30)
      v30 = -[SUUIStorePageSplitCollectionViewLayout _newStorePageCollectionViewLayout](self, "_newStorePageCollectionViewLayout");
    ...
    objc_msgSend(MEMORY[0x24BDD15E0], "indexSetWithIndexesInRange:", v19, v31);
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIStorePageSplitCollectionViewLayout addSublayout:forSections:offset:relativeToEdges:fromSiblingLayout:](self, "addSublayout:forSections:offset:relativeToEdges:fromSiblingLayout:", v30, v33, v21, v28, *MEMORY[0x24BDBEFB0], *(double *)(MEMORY[0x24BDBEFB0] + 8));
  ...
  if (v35)
  {
    ...
    if (!v36)
      v36 = -[SUUIStorePageSplitCollectionViewLayout _newStorePageCollectionViewLayout](self, "_newStorePageCollectionViewLayout");
    v37 = objc_msgSend(v35, "numberOfPageSections");
    objc_msgSend(MEMORY[0x24BDD15E0], "indexSetWithIndexesInRange:", v19, v37);
    v38 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIStorePageSplitCollectionViewLayout addSublayout:forSections:offset:relativeToEdges:fromSiblingLayout:](self, "addSublayout:forSections:offset:relativeToEdges:fromSiblingLayout:", v36, v38, 4, v28, *MEMORY[0x24BDBEFB0], *(double *)(MEMORY[0x24BDBEFB0] + 8));
...
- (NSArray)indexPathsForPinningItems
{
  ...
  v12 = 0u;
  v13 = 0u;
  -[SUUIStorePageSplitCollectionViewLayout sublayouts](self, "sublayouts", 0);
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        -[SUUIStorePageSplitCollectionViewLayout convertRect:toLayout:](self, "convertRect:toLayout:", v14, x, y, width, height, (_QWORD)v17);
...
- (void)addSublayout:(id)a3 forItems:(id)a4 inSection:(int64_t)a5 offset:(CGPoint)a6 relativeToEdges:(unint64_t)a7 fromSiblingLayout:(id)a8
{
  ...
  -[SUUIStorePageSplitCollectionViewLayout _createSectionsToIndexRangesMapTableIfNeededForSublayout:](self, "_createSectionsToIndexRangesMapTableIfNeededForSublayout:", v15);
...
- (void)addSublayout:(id)a3 forSections:(id)a4 offset:(CGPoint)a5 relativeToEdges:(unint64_t)a6 fromSiblingLayout:(id)a7
{
  ...
  -[SUUIStorePageSplitCollectionViewLayout _createSectionsToIndexRangesMapTableIfNeededForSublayout:](self, "_createSectionsToIndexRangesMapTableIfNeededForSublayout:", v16);
...
void __108__SUUIStorePageSplitCollectionViewLayout_addSublayout_forSections_offset_relativeToEdges_fromSiblingLayout___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v3 = *(void **)(a1 + 32);
  objc_msgSend(MEMORY[0x24BDD1698], "indexSetWithIndexesInRange:", 0, 0x7FFFFFFFFFFFFFFFLL);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)a3
{
  ...
  v13 = -[SUUIStorePageSplitCollectionViewLayout shouldInvalidateLayoutForBoundsChange:](&v15, sel_shouldInvalidateLayoutForBoundsChange_, x, y, width, height);
LABEL_11:
...
- (void)_createSectionsToIndexRangesMapTableIfNeededForSublayout:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      v6 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 0);
    ...
    if (!v9)
    {
      v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1650]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, 0);
...
- (id)_newStorePageCollectionViewLayout
{
  ...
  -[SUUIStorePageCollectionViewLayout setBackdropGroupName:](v3, "setBackdropGroupName:", self->_backdropGroupName);
