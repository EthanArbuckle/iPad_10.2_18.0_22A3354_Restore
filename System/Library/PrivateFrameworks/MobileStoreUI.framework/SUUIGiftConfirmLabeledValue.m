...
{
  SUUIGiftConfirmLabeledValue *v4;
  SUUIGiftDashView *v5;
  SUUIGiftDashView *dashView;
  SUUIGiftDashView *v7;
  void *v8;
  SUUIGiftDashView *v9;
  void *v10;
  ...
  v4 = -[SUUIGiftConfirmLabeledValue init](&v13, sel_init);
  if (v4)
  {
    if (a3 == 2)
    {
      ...
      -[SUUIGiftDashView setBackgroundColor:](v7, "setBackgroundColor:", v8);
      ...
      -[SUUIGiftDashView setDashColor:](v9, "setDashColor:", v11);

      -[SUUIGiftDashView setDashSize:](v4->_dashView, "setDashSize:", 1.0, 1.0);
      -[SUUIGiftDashView setDashSpacing:](v4->_dashView, "setDashSpacing:", 4.0);
      -[SUUIGiftConfirmLabeledValue addSubview:](v4, "addSubview:", v4->_dashView);
    }
    v4->_style = a3;
  }
  return v4;
...
- (void)setLabel:(id)a3
{
  ...
  v15 = a3;
  -[SUUIGiftConfirmLabeledValue label](self, "label");
  ...
  if (v4 != v15 && (objc_msgSend(v15, "isEqualToString:", v4) & 1) == 0)
  {
    ...
    if (v15)
    {
      if (!labelLabel)
      {
        ...
        -[SUUIGiftConfirmLabeledValue addSubview:](self, "addSubview:", self->_labelLabel);
        labelLabel = self->_labelLabel;
      }
    ...
    -[SUUIGiftConfirmLabeledValue setNeedsLayout](self, "setNeedsLayout");
  }
...
- (void)setSubtitleLabel:(id)a3
{
  ...
  v15 = a3;
  -[SUUIGiftConfirmLabeledValue subtitleLabel](self, "subtitleLabel");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  if (v4 != v15 && (objc_msgSend(v15, "isEqualToString:", v4) & 1) == 0)
  {
    ...
    if (v15)
    {
      if (!subtitleLabel)
      {
        ...
        -[SUUIGiftConfirmLabeledValue addSubview:](self, "addSubview:", self->_subtitleLabel);
        subtitleLabel = self->_subtitleLabel;
      }
...
LABEL_16:
    ...
    if (style)
    {
      ...
      else
      {
        ...
        {
LABEL_15:
          -[SUUIGiftConfirmLabeledValue addSubview:](self, "addSubview:", self->_valueLabel);
          valueLabel = self->_valueLabel;
          goto LABEL_16;
        }
        v15 = self->_valueLabel;
...
- (void)layoutSubviews
{
  ...
  -[SUUIGiftConfirmLabeledValue bounds](self, "bounds");
  v6 = v5;
  v8 = v7;
  v10 = v9;
  v12 = v11;
  ...
  if (dashView)
  {
    -[SUUIGiftDashView frame](dashView, "frame");
    v62 = v12 + -1.0;
    if (v4)
    {
    ...
    -[SUUIGiftDashView setFrame:](self->_dashView, "setFrame:", v6, v62, v10, 1.0);
  }
}
