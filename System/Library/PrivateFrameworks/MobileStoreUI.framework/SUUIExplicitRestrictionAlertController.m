...
- (SUUIExplicitRestrictionAlertController)initWithClientContext:(id)a3 presentingViewController:(id)a4
{
  id v7;
  id v8;
  SUUIExplicitRestrictionAlertController *v9;
  SUUIExplicitRestrictionAlertController *v10;
  objc_super v12;
  ...
  v9 = -[SUUIExplicitRestrictionAlertController init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
void __104__SUUIExplicitRestrictionAlertController_presentExplicitRestrictionAlertIfNeededOfType_completionBlock___block_invoke(_QWORD *a1, int a2, void *a3)
{
  id v5;
  void *v6;
  void *v7;
  ...
  if (a2)
  {
    if ((objc_msgSend(MEMORY[0x24BEB1FA0], "isActiveAccountAllowedToUpdateRestrictions") & 1) != 0)
    {
      v6 = (void *)MEMORY[0x24BEB1FA0];
...
{
  id v5;
  SUUIExplicitRestrictionAlertController *v6;
  SUUIExplicitRestrictionAlertController *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUUIExplicitRestrictionAlertController;
  v6 = -[SUUIExplicitRestrictionAlertController init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
void __104__SUUIExplicitRestrictionAlertController_presentExplicitRestrictionAlertIfNeededOfType_completionBlock___block_invoke_2(_QWORD *a1)
{
  void *v2;
  void *v3;
  void *v4;
  ...
  if (v2)
  {
    ...
    if (v4)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("OK_BUTTON"), 0, CFSTR("ExplicitByDefault"));
  ...
  else
  {
    ...
    objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("EXPLICIT_CONTENT_DISABLED_ALERT_MESSAGE"), &stru_2511FF0C8, CFSTR("ExplicitByDefault"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("OK_BUTTON"), &stru_2511FF0C8, CFSTR("ExplicitByDefault"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();

  }
  objc_msgSend(MEMORY[0x24BEBD3B0], "alertControllerWithTitle:message:preferredStyle:", 0, v3, 1);
...
uint64_t __104__SUUIExplicitRestrictionAlertController_presentExplicitRestrictionAlertIfNeededOfType_completionBlock___block_invoke_3(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x24BEB1FA0], "didDisplayExplicitRestrictionAlertOfType:", *(_QWORD *)(a1 + 40));
  result = *(_QWORD *)(a1 + 32);
  if (result)
...
void __104__SUUIExplicitRestrictionAlertController_presentExplicitRestrictionAlertIfNeededOfType_completionBlock___block_invoke_4(_QWORD *a1, char a2)
{
  uint64_t v2;
  void *v3;
  uint64_t v4;
...
LABEL_21:
  ...
  if (v8)
  {
    ...
    if (v10)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", v3, 0, CFSTR("ExplicitByDefault"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = *(void **)(*(_QWORD *)(a1 + 32) + 8);
    if (v18)
      objc_msgSend(v18, "localizedStringForKey:inTable:", v7, CFSTR("ExplicitByDefault"));
    else
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", v7, 0, CFSTR("ExplicitByDefault"));
    ...
    if (v19)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("NOT_NOW_BUTTON"), 0, CFSTR("ExplicitByDefault"));
  ...
  else
  {
    ...
    objc_msgSend(v11, "localizedStringForKey:value:table:", v2, &stru_2511FF0C8, CFSTR("ExplicitByDefault"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "localizedStringForKey:value:table:", v3, &stru_2511FF0C8, CFSTR("ExplicitByDefault"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "localizedStringForKey:value:table:", v7, &stru_2511FF0C8, CFSTR("ExplicitByDefault"));
    v15 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "localizedStringForKey:value:table:", CFSTR("NOT_NOW_BUTTON"), &stru_2511FF0C8, CFSTR("ExplicitByDefault"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();

  }
  objc_msgSend(MEMORY[0x24BEBD3B0], "alertControllerWithTitle:message:preferredStyle:", v9, v13, 1);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v21 = MEMORY[0x24BDAC760];
  v35[0] = MEMORY[0x24BDAC760];
  v35[1] = 3221225472;
  v35[2] = __104__SUUIExplicitRestrictionAlertController_presentExplicitRestrictionAlertIfNeededOfType_completionBlock___block_invoke_6;
  v35[3] = &__block_descriptor_33_e23_v16__0__UIAlertAction_8l;
  v36 = *(_BYTE *)(a1 + 56);
  objc_msgSend(MEMORY[0x24BEBD3A8], "actionWithTitle:style:handler:", v15, 0, v35);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "addAction:", v22);
  objc_msgSend(MEMORY[0x24BEBD3A8], "actionWithTitle:style:handler:", v17, 0, 0);
...
LABEL_40:
    v32[0] = v21;
    v32[1] = 3221225472;
    v32[2] = __104__SUUIExplicitRestrictionAlertController_presentExplicitRestrictionAlertIfNeededOfType_completionBlock___block_invoke_7;
    v32[3] = &unk_2511FC228;
    v25 = *(void **)(a1 + 40);
    v34 = *(_QWORD *)(a1 + 48);
    v33 = v25;
...
void __104__SUUIExplicitRestrictionAlertController_presentExplicitRestrictionAlertIfNeededOfType_completionBlock___block_invoke_6(uint64_t a1)
{
  ...
  if (*(_BYTE *)(a1 + 32))
  {
    v1 = SUUIMobileCoreServicesFramework();
    objc_msgSend(SUUIWeakLinkedClassForString(CFSTR("LSApplicationWorkspace"), v1), "defaultWorkspace");
