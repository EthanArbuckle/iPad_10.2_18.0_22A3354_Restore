...
- (id)addButtonWithTitle:(id)a3
{
  ...
  -[SUUIIncompatibleAppView addSubview:](self, "addSubview:", v7);
...
- (void)setIconImage:(id)a3
{
  ...
  if (v4)
  {
    if (!iconView)
    {
      ...
      v8 = self->_iconView;
      -[SUUIIncompatibleAppView backgroundColor](self, "backgroundColor");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[UIImageView setBackgroundColor:](v8, "setBackgroundColor:", v9);

      -[SUUIIncompatibleAppView addSubview:](self, "addSubview:", self->_iconView);
      iconView = self->_iconView;
    }
    -[UIImageView setImage:](iconView, "setImage:", v11);
    -[UIImageView sizeToFit](self->_iconView, "sizeToFit");
    -[SUUIIncompatibleAppView setNeedsLayout](self, "setNeedsLayout");
  }
  else
  {
...
- (void)setMessage:(id)a3
{
  ...
  if (v4)
  {
    if (!messageLabel)
    {
      ...
      -[SUUIIncompatibleAppView addSubview:](self, "addSubview:", self->_messageLabel);
      messageLabel = self->_messageLabel;
    }
...
- (void)setTitle:(id)a3
{
  ...
  if (v4)
  {
    if (!titleLabel)
    {
      ...
      -[SUUIIncompatibleAppView addSubview:](self, "addSubview:", self->_titleLabel);
      titleLabel = self->_titleLabel;
    }
...
- (void)layoutSubviews
{
  ...
  -[SUUIIncompatibleAppView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v7 = v3 + -30.0;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIIncompatibleAppView setBackgroundColor:](&v7, sel_setBackgroundColor_, v6);
