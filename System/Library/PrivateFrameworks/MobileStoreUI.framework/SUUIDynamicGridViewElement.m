...
- (SUUIDynamicGridViewElement)initWithDOMElement:(id)a3 parent:(id)a4 elementFactory:(id)a5
{
  ...
  v9 = -[SUUIGridViewElement initWithDOMElement:parent:elementFactory:](&v13, sel_initWithDOMElement_parent_elementFactory_, v8, a4, a5);
  if (v9)
  {
    ...
    v11 = v10;
    if (v10)
      v9->_minimumEntityCountForSections = objc_msgSend(v10, "integerValue");
...
- (id)applyUpdatesWithElement:(id)a3
{
  ...
  -[SUUIGridViewElement applyUpdatesWithElement:](&v9, sel_applyUpdatesWithElement_, v4);
  ...
  if (v4 != self || objc_msgSend(v5, "updateType"))
  {
    ...
    self->_minimumEntityCountForSections = -[SUUIDynamicGridViewElement minimumEntityCountForSections](v4, "minimumEntityCountForSections");
  }
...
- (BOOL)allowsMultipleSelectionDuringEditing
{
  ...
  -[SUUIDynamicGridViewElement templateDefinitionViewElementsForType:mode:](self, "templateDefinitionViewElementsForType:mode:", 0x251200F08, 0x251204868);
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        v11 = -[SUUIGridViewElement _countOfInputCheckboxesWithBaseElement:limit:](self, "_countOfInputCheckboxesWithBaseElement:limit:", v10, 1);
...
- (BOOL)hasSectionHeaders
{
  ...
  -[SUUIDynamicGridViewElement templateDefinitionViewElementsForType:mode:](self, "templateDefinitionViewElementsForType:mode:", 0x251204888, 0);
...
- (BOOL)isMalformed
{
  ...
  -[SUUIDynamicGridViewElement templateDefinitionViewElementsForType:mode:](self, "templateDefinitionViewElementsForType:mode:", 0x251200F08, 0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "count") == 0;
...
- (id)templateDefinitionViewElementsForType:(id)a3 mode:(id)a4
{
  ...
  v6 = -[SUUIDynamicGridViewElement _templateDefinitionTypeToModeValueMap](self, "_templateDefinitionTypeToModeValueMap");
...
- (id)_templateDefinitionTypeToModeValueMap
{
  ...
  if (!self->_hasValidTemplateDefinitionMap)
  {
    ...
    v4[1] = 3221225472;
    v4[2] = __67__SUUIDynamicGridViewElement__templateDefinitionTypeToModeValueMap__block_invoke;
    v4[3] = &unk_2511F46F8;
    v4[4] = self;
    -[SUUIDynamicGridViewElement _unfilteredEnumerateChildrenUsingBlock:](self, "_unfilteredEnumerateChildrenUsingBlock:", v4);
  }
...
void __67__SUUIDynamicGridViewElement__templateDefinitionTypeToModeValueMap__block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v9;
  void *v10;
  _SUUIDynamicGridTemplateDefinitionModeValueMap *v11;
  void *v12;
  id v13;
  ...
  if (v3)
  {
    ...
    if (objc_msgSend(v6, "length"))
    {
      ...
      if (!v7)
      {
        v8 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", 1);
        v9 = *(_QWORD *)(a1 + 32);
        v10 = *(void **)(v9 + 304);
        *(_QWORD *)(v9 + 304) = v8;
      ...
      v11 = (_SUUIDynamicGridTemplateDefinitionModeValueMap *)objc_claimAutoreleasedReturnValue();
      if (!v11)
      {
        v11 = objc_alloc_init(_SUUIDynamicGridTemplateDefinitionModeValueMap);
        objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 304), "setObject:forKey:", v11, v6);
      }
      objc_msgSend(v5, "definitionMode");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[_SUUIDynamicGridTemplateDefinitionModeValueMap addTemplateDefinitionViewElement:forMode:](v11, "addTemplateDefinitionViewElement:forMode:", v5, v12);
