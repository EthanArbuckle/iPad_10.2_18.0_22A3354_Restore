...
{
  SUUIKeyValueInfoListPageSection *v3;
  SUUIKeyValueInfoListPageSection *v4;
  objc_super v6;
  ...
  v4 = v3;
  if (v3)
    -[SUUIKeyValueInfoListPageSection _reloadViewElementProperties](v3, "_reloadViewElementProperties");
  return v4;
}
...
- (int64_t)applyUpdateType:(int64_t)a3
{
  ...
  -[SUUIKeyValueInfoListPageSection _reloadViewElementProperties](self, "_reloadViewElementProperties");
  v6.receiver = self;
  v6.super_class = (Class)SUUIKeyValueInfoListPageSection;
...
- (id)cellForIndexPath:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x2512056E8, v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIStorePageSection context](self, "context");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "horizontalPadding");
  +[SUUIKeyValueInfoListCollectionViewCell sizeThatFitsWidth:viewElement:context:](SUUIKeyValueInfoListCollectionViewCell, "sizeThatFitsWidth:viewElement:context:", v10, self->_cellLayoutContext, v7 + v12 * -2.0);
  v14 = v13;
...
- (void)entityProvider:(id)a3 didInvalidateWithContext:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[SUUIKeyValueInfoListPageSection _requestCellLayout](self, "_requestCellLayout");
  v8.receiver = self;
...
- (void)willAppearInContext:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x2512056E8);
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  id v15;
  id v16;
  SUUIKeyValueInfoListPageSection *v17;
  ...
  v11 = v7;
  v12 = v9;
  -[SUUIKeyValueInfoListPageSection _enumerateVisibleViewElementsUsingBlock:](self, "_enumerateVisibleViewElementsUsingBlock:", v13);
...
void __75__SUUIKeyValueInfoListPageSection__enumerateVisibleViewElementsUsingBlock___block_invoke(_QWORD *a1, void *a2, uint64_t a3, uint64_t a4)
{
  uint64_t v6;
  void *v7;
  id v8;
...
- (void)_reloadViewElementProperties
{
  ...
  v4 = (SUUIInfoListViewElement *)objc_claimAutoreleasedReturnValue();
...
- (void)_requestCellLayout
{
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        +[SUUIKeyValueInfoListCollectionViewCell titleColumnWidthWithViewElement:width:context:](SUUIKeyValueInfoListCollectionViewCell, "titleColumnWidthWithViewElement:width:context:", *(_QWORD *)(*((_QWORD *)&v27 + 1) + 8 * i), self->_cellLayoutContext, v8);
        if (v13 < v15)
          v13 = v15;
      }
  ...
  -[SUUIViewElementLayoutContext setAggregateValue:forKey:](cellLayoutContext, "setAggregateValue:forKey:", v17, 0x251205708);
  ...
  if (v19)
  {
    ...
    do
    {
      for (j = 0; j != v20; ++j)
      {
        ...
        +[SUUIKeyValueInfoListCollectionViewCell requestLayoutForViewElement:width:context:](SUUIKeyValueInfoListCollectionViewCell, "requestLayoutForViewElement:width:context:", *(_QWORD *)(*((_QWORD *)&v23 + 1) + 8 * j), self->_cellLayoutContext, v8, (_QWORD)v23);
      }
