...
{
  id v4;
  SUUIModernChartsDocumentViewController *v5;
  SUUIModernChartsDocumentViewController *v6;
  objc_super v8;

  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)SUUIModernChartsDocumentViewController;
  v5 = -[SUUIModernChartsDocumentViewController init](&v8, sel_init);
  v6 = v5;
  if (v5)
    -[SUUIModernChartsDocumentViewController _reloadWithTemplateElement:](v5, "_reloadWithTemplateElement:", v4);
...
- (void)documentDidUpdate:(id)a3
{
  ...
  if (-[SUUIResourceLoader isIdleForReason:](self->_resourceLoader, "isIdleForReason:", 1))
    -[SUUIModernChartsDocumentViewController resourceLoader:didLoadAllForReason:](self, "resourceLoader:didLoadAllForReason:", self->_resourceLoader, 1);
...
- (void)loadView
{
  ...
  SUUIModernChartsView *chartsView;
  id v5;
  ...
  -[SUUIModernChartsView setAutoresizingMask:](self->_chartsView, "setAutoresizingMask:", 18);
  -[SUUIModernChartsView setColumnViewControllers:](self->_chartsView, "setColumnViewControllers:", self->_columnViewControllers);
  objc_msgSend(v5, "addSubview:", self->_chartsView);
  -[SUUIModernChartsDocumentViewController setView:](self, "setView:", v5);
...
- (void)viewWillLayoutSubviews
{
  ...
  chartsView = self->_chartsView;
  -[SUUIModernChartsDocumentViewController _contentInset](self, "_contentInset");
  -[SUUIModernChartsView setContentInset:](chartsView, "setContentInset:");
  activityIndicatorView = self->_activityIndicatorView;
  if (activityIndicatorView)
  {
    -[SUUIModernChartsDocumentViewController _computedFrameForActivityIndicatorView](self, "_computedFrameForActivityIndicatorView");
  ...
  -[SUUIModernChartsDocumentViewController viewWillLayoutSubviews](&v5, sel_viewWillLayoutSubviews);
}
...
- (void)resourceLoaderDidBeginLoading:(id)a3
{
  ...
  v5 = a3;
  -[SUUIModernChartsDocumentViewController parentViewController](self, "parentViewController");
...
- (UIEdgeInsets)_contentInset
{
  ...
  -[SUUIModernChartsDocumentViewController topLayoutGuide](self, "topLayoutGuide");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "length");
  v5 = v4;

  -[SUUIModernChartsDocumentViewController bottomLayoutGuide](self, "bottomLayoutGuide");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_hideActivityIndicator
{
  ...
  -[SUUIActivityIndicatorView removeFromSuperview](self->_activityIndicatorView, "removeFromSuperview");
  activityIndicatorView = self->_activityIndicatorView;
...
- (id)_newColumnViewControllersWithReusableViewControllers:(id)a3
{
  ...
  void *v18;
  char v19;
  SUUIModernChartsDocumentViewController *v20;
  SUUIStorePageSectionsViewController *v21;
  void *v22;
  void *v23;
  const __CFString *v24;
  SUUIMetricsImpressionSession *v25;
  void *v26;
  void *v28;
  id obj;
  SUUIModernChartsDocumentViewController *v30;
  id v31;
  id v32;
  uint64_t v33;
  uint64_t v34;
  ...
  if (v34)
  {
    ...
    do
    {
      for (i = 0; i != v34; ++i)
      {
        ...
        v6 = (void *)objc_msgSend(objc_alloc((Class)SUUIPageComponentClassForComponentType(objc_msgSend(v5, "pageComponentType"))), "initWithViewElement:", v5);
        if (v6)
        {
...
LABEL_15:
          ...
          v21 = -[SUUIStorePageSectionsViewController initWithLayoutStyle:]([SUUIStorePageSectionsViewController alloc], "initWithLayoutStyle:", 0);
          -[SUUIViewController setClientContext:](v21, "setClientContext:", v28);
          -[SUUIViewController operationQueue](v20, "operationQueue");
          v22 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIViewController setOperationQueue:](v21, "setOperationQueue:", v22);

          -[SUUIModernChartsDocumentViewController _resourceLoader](v20, "_resourceLoader");
          v23 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIStorePageSectionsViewController setResourceLoader:](v21, "setResourceLoader:", v23);

          if (v11)
            v24 = v11;
          else
            v24 = &stru_2511FF0C8;
          -[SUUIStorePageSectionsViewController setTitle:](v21, "setTitle:", v24);
          v25 = objc_alloc_init(SUUIMetricsImpressionSession);
          -[SUUIStorePageSectionsViewController setActiveMetricsImpressionSession:](v21, "setActiveMetricsImpressionSession:", v25);

LABEL_21:
          v44 = v6;
          objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", &v44, 1);
          v26 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIStorePageSectionsViewController setSectionsWithPageComponents:](v21, "setSectionsWithPageComponents:", v26);

          -[SUUIModernChartsDocumentViewController addChildViewController:](v20, "addChildViewController:", v21);
...
- (void)_reloadWithTemplateElement:(id)a3
{
  ...
  v7 = -[SUUIModernChartsDocumentViewController _newColumnViewControllersWithReusableViewControllers:](self, "_newColumnViewControllersWithReusableViewControllers:", v6);
  ...
  chartsView = self->_chartsView;
  if (chartsView)
    -[SUUIModernChartsView setColumnViewControllers:](chartsView, "setColumnViewControllers:", self->_columnViewControllers);
  -[SUUIChartsTemplateViewElement activityIndicator](self->_templateElement, "activityIndicator", (_QWORD)v17);
  v16 = (void *)objc_claimAutoreleasedReturnValue();

  if (v16)
    -[SUUIModernChartsDocumentViewController _showActivityIndicator](self, "_showActivityIndicator");
  else
    -[SUUIModernChartsDocumentViewController _hideActivityIndicator](self, "_hideActivityIndicator");

}

- (void)_showActivityIndicator
{
  SUUIActivityIndicatorView *v3;
  SUUIActivityIndicatorView *activityIndicatorView;
  void *v5;
  void *v6;
  void *v7;
  ...
  -[SUUIModernChartsDocumentViewController view](self, "view");
  ...
  -[SUUIChartsTemplateViewElement activityIndicator](self->_templateElement, "activityIndicator");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIModernChartsDocumentViewController _viewLayoutContext](self, "_viewLayoutContext");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIModernChartsDocumentViewController _layoutCache](self, "_layoutCache");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "commitLayoutRequests");

  -[SUUIActivityIndicatorView reloadWithViewElement:width:context:](self->_activityIndicatorView, "reloadWithViewElement:width:context:", v5, v6, v9);
...
- (id)_viewLayoutContext
{
  ...
  if (!viewLayoutContext)
  {
    ...
    v10 = -[SUUIResourceLoader initWithClientContext:]([SUUIResourceLoader alloc], "initWithClientContext:", v6);
    -[SUUIViewElementLayoutContext setResourceLoader:](self->_viewLayoutContext, "setResourceLoader:", v10);
