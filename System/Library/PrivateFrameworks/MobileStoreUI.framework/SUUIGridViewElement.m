...
- (SUUIGridViewElement)initWithDOMElement:(id)a3 parent:(id)a4 elementFactory:(id)a5
{
  ...
  id v10;
  uint64_t v11;
  SUUIDynamicGridViewElement *v12;
  void *v13;
  uint64_t v14;
  objc_super v16;
  ...
  if (v11 == objc_opt_class())
  {
    ...
    if (v14)
    {
      v12 = -[SUUIDynamicGridViewElement initWithDOMElement:parent:elementFactory:]([SUUIDynamicGridViewElement alloc], "initWithDOMElement:parent:elementFactory:", v8, v9, v10);
LABEL_7:
  ...
  if (v12)
  {
    ...
    self = (SUUIGridViewElement *)objc_claimAutoreleasedReturnValue();
    if (-[SUUIGridViewElement length](self, "length"))
      v12->super._showsEditMode = -[SUUIGridViewElement BOOLValue](self, "BOOLValue");
    goto LABEL_7;
  }
LABEL_8:
...
{
  SUUIGridViewElement *v4;
  SUUIGridViewElement *v5;
  id *p_isa;
  id v7;
  ...
  v5 = (SUUIGridViewElement *)objc_claimAutoreleasedReturnValue();
  p_isa = (id *)&v5->super.super.super.isa;
  if (v4 == self || v5 != self)
  {
    showsEditMode = self->_showsEditMode;
    if (showsEditMode != -[SUUIGridViewElement showsEditMode](v5, "showsEditMode"))
    {
      do
      ...
      v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithInteger:", (int)(v9 + 1));
  ...
  else
  {
    ...
    self->_showsEditMode = -[SUUIGridViewElement showsEditMode](v4, "showsEditMode");
  }
...
- (void)enumerateChildrenUsingBlock:(id)a3
{
  ...
  v6[1] = 3221225472;
  v6[2] = __51__SUUIGridViewElement_enumerateChildrenUsingBlock___block_invoke;
  v6[3] = &unk_2511F4BE0;
  v7 = a3;
  v5.receiver = self;
...
- (id)persistenceKey
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SUUIGridViewElement;
  -[SUUIViewElement persistenceKey](&v4, sel_persistenceKey);
...
- (BOOL)allowsMultipleSelectionDuringEditing
{
  ...
  v4[5] = &v5;
  v4[6] = v9;
  -[SUUIGridViewElement enumerateChildrenUsingBlock:](self, "enumerateChildrenUsingBlock:", v4);
  v2 = v6[3] != 0;
...
{
  return (SUUICollectionDOMFeature *)-[SUUIViewElement featureWithName:](self, "featureWithName:", 0x251202928);
}
...
- (int64_t)_countOfInputCheckboxesWithBaseElement:(id)a3 limit:(int64_t)a4
{
  ...
  if (a4)
  {
    ...
    else
    {
      ...
      v10[5] = &v11;
      v10[6] = a4;
      -[SUUIGridViewElement enumerateChildrenUsingBlock:](self, "enumerateChildrenUsingBlock:", v10);
      v8 = v12[3];
    }
