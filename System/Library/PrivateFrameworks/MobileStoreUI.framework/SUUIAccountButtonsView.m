...
{
  id v5;
  SUUIAccountButtonsView *v6;
  SUUIAccountButtonsView *v7;
  SUUIRoundedRectButton *v8;
  SUUIRoundedRectButton *appleIDButton;
  SUUIRoundedRectButton *v10;
  UIButton *redeemButton;
  UIButton *v12;
  void *v13;
  SUUIRoundedRectButton *v14;
  SUUIRoundedRectButton *giftingButton;
  SUUIRoundedRectButton *v16;
  void *v17;
  uint64_t v18;
  SUUILinkButton *ecommerceButton;
  void *v20;
  uint64_t v21;
  ...
  v6 = -[SUUIAccountButtonsView init](&v25, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    -[SUUIAccountButtonsView addSubview:](v7, "addSubview:", v7->_appleIDButton);
    ...
    if (v5)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("REDEEM_BUTTON"), 0, CFSTR("Redeem"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[UIButton setTitle:forState:](v12, "setTitle:forState:", v13, 0);

    -[SUUIAccountButtonsView addSubview:](v7, "addSubview:", v7->_redeemButton);
    ...
    if (v5)
      ...
      +[SUUIClientContext localizedStringForKey:inBundles:](SUUIClientContext, "localizedStringForKey:inBundles:", CFSTR("GIFT_BUTTON"), 0);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIRoundedRectButton setTitle:forState:](v16, "setTitle:forState:", v17, 0);

    v7->_giftingVisibilityHidden = 0;
    -[SUUIAccountButtonsView addSubview:](v7, "addSubview:", v7->_giftingButton);
    v18 = -[SUUIAccountButtonsView _newLinkButtonWithTitle:](v7, "_newLinkButtonWithTitle:", 0);
    ecommerceButton = v7->_ecommerceButton;
    v7->_ecommerceButton = (SUUILinkButton *)v18;

    v7->_ecommerceVisibilityHidden = 1;
    -[SUUIAccountButtonsView addSubview:](v7, "addSubview:", v7->_ecommerceButton);
    if (v5)
      objc_msgSend(v5, "localizedStringForKey:", CFSTR("TERMS_LINK"));
    else
      +[SUUIClientContext localizedStringForKey:inBundles:](SUUIClientContext, "localizedStringForKey:inBundles:", CFSTR("TERMS_LINK"), 0);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = -[SUUIAccountButtonsView _newLinkButtonWithTitle:](v7, "_newLinkButtonWithTitle:", v20);
    termsAndConditionsButton = v7->_termsAndConditionsButton;
    v7->_termsAndConditionsButton = (UIButton *)v21;

    -[SUUIAccountButtonsView addSubview:](v7, "addSubview:", v7->_termsAndConditionsButton);
    -[SUUIAccountButtonsView _reloadFonts](v7, "_reloadFonts");
    objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v23, "addObserver:selector:name:object:", v7, sel__reloadFonts, *MEMORY[0x24BEBE088], 0);
...
- (void)dealloc
{
  ...
  -[SUUIAccountButtonsView dealloc](&v4, sel_dealloc);
}
...
{
  return (NSString *)-[SUUILinkButton titleForState:](self->_ecommerceButton, "titleForState:", 0);
}
...
- (void)setECommerceLinkTitle:(id)a3
{
  ...
  v5 = a3;
  -[SUUILinkButton titleForState:](self->_ecommerceButton, "titleForState:", 0);
  ...
  if (v4 != v5 && (objc_msgSend(v5, "isEqualToString:", v4) & 1) == 0)
  {
    ...
    -[SUUIAccountButtonsView setNeedsLayout](self, "setNeedsLayout");
  }
...
- (BOOL)isRedeemHidden
{
  return -[SUUIClientContext isManagedAppleID](self->_clientContext, "isManagedAppleID");
}
  ...
  if (v4 != v16)
  {
    if (objc_msgSend(v16, "length"))
    {
      if (!self->_accountCreditsLabel)
      {
        ...
        -[SUUIRoundedRectButton setSubtitleWithLabel:](self->_appleIDButton, "setSubtitleWithLabel:", self->_accountCreditsLabel);
      }
      clientContext = self->_clientContext;
      if (clientContext)
        -[SUUIClientContext localizedStringForKey:](clientContext, "localizedStringForKey:", CFSTR("ACCOUNT_CREDITS"));
      else
        +[SUUIClientContext localizedStringForKey:inBundles:](SUUIClientContext, "localizedStringForKey:inBundles:", CFSTR("ACCOUNT_CREDITS"), 0);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = self->_accountCreditsLabel;
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithValidatedFormat:validFormatSpecifiers:error:", v13, CFSTR("%@"), 0, v16);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      -[UILabel setText:](v14, "setText:", v15);

      -[UILabel sizeToFit](self->_accountCreditsLabel, "sizeToFit");
      -[SUUIRoundedRectButton setNeedsLayout](self->_appleIDButton, "setNeedsLayout");
    }
    else
    {
      -[SUUIRoundedRectButton setSubtitleWithLabel:](self->_appleIDButton, "setSubtitleWithLabel:", 0);
...
- (void)layoutSubviews
{
  ...
  -[SUUIAccountButtonsView bounds](self, "bounds");
  if (v3 >= 696.0)
    -[SUUIAccountButtonsView _layoutOneRow](self, "_layoutOneRow");
  else
    -[SUUIAccountButtonsView _layoutTwoRows](self, "_layoutTwoRows");
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  height = a3.height;
  width = a3.width;
  v6 = -[SUUIAccountButtonsView isEcommerceHidden](self, "isEcommerceHidden");
  v7 = !v6;
...
LABEL_7:
    ...
    v12 = v11 + 0.0;
    if (!-[SUUIAccountButtonsView isRedeemHidden](self, "isRedeemHidden"))
    {
...
- (void)tintColorDidChange
{
  ...
  -[SUUIAccountButtonsView tintColor](self, "tintColor");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUILinkButton setTitleColor:forState:](self->_ecommerceButton, "setTitleColor:forState:", v3, 0);
  -[UIButton setTitleColor:forState:](self->_termsAndConditionsButton, "setTitleColor:forState:", v3, 0);
  v4.receiver = self;
  v4.super_class = (Class)SUUIAccountButtonsView;
  -[SUUIAccountButtonsView tintColorDidChange](&v4, sel_tintColorDidChange);
...
- (void)_layoutOneRow
{
  ...
  v9 = v8 / 3.0;
  v10 = floorf(v9);
  -[SUUIRoundedRectButton frame](self->_appleIDButton, "frame");
  ...
  v14 = v13;
  if (-[SUUIAccountButtonsView isGiftingHidden](self, "isGiftingHidden")
    && !-[SUUIAccountButtonsView isRedeemHidden](self, "isRedeemHidden"))
  {
  ...
  else
  {
    ...
    {
      -[SUUIRoundedRectButton frame](self->_giftingButton, "frame");
  ...
  -[SUUIRoundedRectButton setHidden:](self->_giftingButton, "setHidden:", -[SUUIAccountButtonsView isGiftingHidden](self, "isGiftingHidden"));
  -[UIButton setHidden:](self->_redeemButton, "setHidden:", -[SUUIAccountButtonsView isRedeemHidden](self, "isRedeemHidden"));
  ...
  v24 = *(double *)(MEMORY[0x24BDBF028] + 16);
  v25 = *(double *)(MEMORY[0x24BDBF028] + 24);
  -[UIButton sizeThatFits:](self->_termsAndConditionsButton, "sizeThatFits:", v24, v25);
  v27 = v26;
  *(float *)&v26 = (v4 - v26) * 0.5;
  v28 = floorf(*(float *)&v26);
  if (!-[SUUIAccountButtonsView isEcommerceHidden](self, "isEcommerceHidden"))
  {
    -[SUUILinkButton frame](self->_ecommerceButton, "frame");
  ...
  -[SUUILinkButton setHidden:](self->_ecommerceButton, "setHidden:", -[SUUIAccountButtonsView isEcommerceHidden](self, "isEcommerceHidden"));
...
- (void)_layoutTwoRows
{
  ...
  v6 = v5;
  v7 = v3 + -30.0;
  v8 = -[SUUIAccountButtonsView isGiftingHidden](self, "isGiftingHidden");
  ...
  -[SUUIRoundedRectButton setHidden:](self->_giftingButton, "setHidden:", -[SUUIAccountButtonsView isGiftingHidden](self, "isGiftingHidden"));
  if (!-[SUUIAccountButtonsView isRedeemHidden](self, "isRedeemHidden")
    || !-[SUUIAccountButtonsView isGiftingHidden](self, "isGiftingHidden"))
  {
    v25.origin.y = 0.0;
...
- (id)_newLinkButtonWithTitle:(id)a3
{
  ...
  -[SUUILinkButton setTitle:forState:](v5, "setTitle:forState:", v4, 0);

  -[SUUIAccountButtonsView tintColor](self, "tintColor");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUILinkButton setTitleColor:forState:](v5, "setTitleColor:forState:", v6, 0);
...
- (void)_reloadFonts
{
  ...
  -[SUUILinkButton titleLabel](self->_ecommerceButton, "titleLabel");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
