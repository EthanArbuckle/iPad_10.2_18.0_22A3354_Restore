...
- (SUUIRowComponent)initWithCustomPageContext:(id)a3
{
  ...
  v5 = -[SUUIPageComponent initWithCustomPageContext:](&v39, sel_initWithCustomPageContext_, v4);
  if (v5)
  {
        ...
        do
        {
          for (i = 0; i != v17; ++i)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[SUUIRowComponent _childComponentWithContext:](v5, "_childComponentWithContext:", v13);
              ...
              if (v21)
              {
                ...
                if (-[SUUIRowComponent _isChildMissingItemData:](v5, "_isChildMissingItemData:", v21))
    ...
    do
    {
      ...
      if (objc_msgSend(v10, "componentType") == 9)
      {
        ...
        if (v11)
        {
          ...
          if (!v13)
          {
            v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithLongLong:", v12);
            v6[2](v6, v14, a3, &v17);
...
- (id)_updateWithMissingItems:(id)a3
{
  ...
  v10 = self;
  v6 = v4;
  -[SUUIRowComponent enumerateMissingItemIdentifiersFromIndex:usingBlock:](self, "enumerateMissingItemIdentifiersFromIndex:usingBlock:", 0, v8);
...
- (id)_childComponentWithContext:(id)a3
{
  ...
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0
    || ((v6 = SUUIPageComponentTypeForBlockType(v5), v6 <= 0xE) ? (v7 = ((1 << v6) & 0x46A4) == 0) : (v7 = 1), v7))
  {
    v8 = 0;
  }
  else
  {
    v8 = (void *)objc_msgSend(objc_alloc((Class)SUUIPageComponentClassForComponentType(v6)), "initWithCustomPageContext:", v3);
  }
...
- (id)description
{
  ...
  -[SUUIRowComponent description](&v7, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
