...
- (SUUIDeveloperInfoView)initWithDeveloperInfo:(id)a3 clientContext:(id)a4
{
  ...
  void *v27;
  void *v28;
  SUUIProductInformationView *v29;
  SUUIProductInformationView *infoView;
  double v31;
  void *v32;
  double v33;
  double v34;
  ...
  void *v41;
  void *v42;
  SUUIDeveloperInfoLineItemView *v43;
  void *v44;
  void *v45;
  SUUIDeveloperInfoLineItemView *v46;
  objc_super v48;
  _QWORD v49[2];
  _QWORD v50[2];
  _QWORD v51[2];
  ...
  v9 = -[SUUIDeveloperInfoView init](&v48, sel_init);
  v10 = v9;
  if (v9)
  {
    ...
    if (v14)
    {
      if (v8)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("DEVELOPER_INFO_LABEL_TRADE_NAME"), 0, CFSTR("ProductPage"));
    ...
    if (v17)
    {
      if (v8)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("DEVELOPER_INFO_LABEL_TRADE_REP"), 0, CFSTR("ProductPage"));
    ...
    if (v20)
    {
      if (v8)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("DEVELOPER_INFO_LABEL_ADDRESS"), 0, CFSTR("ProductPage"));
    ...
    if (v23)
    {
      if (v8)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("DEVELOPER_INFO_LABEL_PHONE"), 0, CFSTR("ProductPage"));
    ...
    if (v26)
    {
      if (v8)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("DEVELOPER_INFO_LABEL_EMAIL"), 0, CFSTR("ProductPage"));
    ...
    if (objc_msgSend(v13, "count"))
    {
      ...
      -[SUUIProductInformationView setHidesSeparatorView:](v10->_infoView, "setHidesSeparatorView:", 1);
      -[SUUIProductInformationView setInformationLines:](v10->_infoView, "setInformationLines:", v13);
      -[SUUIDeveloperInfoView addSubview:](v10, "addSubview:", v10->_infoView);
      objc_msgSend(MEMORY[0x24BEBD8F8], "mainScreen");
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "scale");
      v34 = 1.0 / v33;

      v35 = objc_msgSend(objc_alloc(MEMORY[0x24BEBDB00]), "initWithFrame:", v12, 0.0, 0.0, v34);
      ...
      -[SUUIDeveloperInfoView addSubview:](v10, "addSubview:", v10->_infoSeparatorView);
    }
    ...
    if (v41)
    {
      if (v8)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("DEVELOPER_INFO_LABEL_ECOMMERCE_REGISTRATION_ID"), 0, CFSTR("ProductPage"));
      v42 = (void *)objc_claimAutoreleasedReturnValue();
      v43 = -[SUUIDeveloperInfoLineItemView initWithLabel:value:]([SUUIDeveloperInfoLineItemView alloc], "initWithLabel:value:", v42, v41);
      ...
      -[SUUIDeveloperInfoView addSubview:](v10, "addSubview:", v43);
    ...
    if (v44)
    {
      if (v8)
        ...
        +[SUUIClientContext localizedStringForKey:inBundles:inTable:](SUUIClientContext, "localizedStringForKey:inBundles:inTable:", CFSTR("DEVELOPER_INFO_LABEL_BUSINESS_REGISTRATION_ID"), 0, CFSTR("ProductPage"));
      v45 = (void *)objc_claimAutoreleasedReturnValue();
      v46 = -[SUUIDeveloperInfoLineItemView initWithLabel:value:]([SUUIDeveloperInfoLineItemView alloc], "initWithLabel:value:", v45, v44);
      ...
      -[SUUIDeveloperInfoView addSubview:](v10, "addSubview:", v46);
...
- (void)layoutSubviews
{
  ...
  -[SUUIDeveloperInfoView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  -[SUUIProductInformationView frame](self->_infoView, "frame");
  v8 = v7;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v4 = a3;
  -[SUUIProductInformationView setBackgroundColor:](self->_infoView, "setBackgroundColor:", v4);
  v13 = 0u;
  v14 = 0u;
  v11 = 0u;
  v12 = 0u;
  ...
  -[SUUIDeveloperInfoView setBackgroundColor:](&v10, sel_setBackgroundColor_, v4);
