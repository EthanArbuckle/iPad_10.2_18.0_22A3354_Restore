...
{
  SUUIScrollingSegmentedController *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)SUUIScrollingSegmentedController;
  result = -[SUUIScrollingSegmentedController initWithNibName:bundle:](&v5, sel_initWithNibName_bundle_, a3, a4);
  if (result)
  {
    result->_scrollingTabAppearanceStatus.progress = 1.0;
    *(_QWORD *)&result->_scrollingTabAppearanceStatus.isBouncingOffTheEdge = 0;
...
- (void)dealloc
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v9 + 1) + 8 * v7++), "removeObserver:forKeyPath:context:", self, CFSTR("navigationItem.title"), _SUUIScrollingSegmentTitleValueObservationContext);
      }
      while (v5 != v7);
  ...
  -[SUUIScrollingSegmentedControllerCollectionView setDataSource:](self->_contentCollectionView, "setDataSource:", 0);
  -[SUUIScrollingSegmentedControllerCollectionView setDelegate:](self->_contentCollectionView, "setDelegate:", 0);
  -[SUUIInteractiveSegmentedControl removeTarget:action:forControlEvents:](self->_titlesSegmentedControl, "removeTarget:action:forControlEvents:", self, sel__titlesSegmentedControlValueChangeAction_, 4096);
  v8.receiver = self;
...
- (void)viewDidLoad
{
  ...
  double Height;
  double v23;
  SUUIScrollingSegmentedControllerCollectionView *v24;
  SUUIScrollingSegmentedControllerCollectionView *contentCollectionView;
  void *v26;
  SUUIScrollingSegmentedControllerCollectionView *v27;
  void *v28;
  SUUIInteractiveSegmentedControl *v29;
  SUUIInteractiveSegmentedControl *titlesSegmentedControl;
  SUUIInteractiveSegmentedControl *v31;
  SUUIScrollingSegmentedControllerNavigationBarTitleView *v32;
  ...
  -[SUUIScrollingSegmentedController viewDidLoad](&v35, sel_viewDidLoad);
  -[SUUIScrollingSegmentedController view](self, "view");
  ...
  v18 = objc_alloc_init(MEMORY[0x24BEBD488]);
  ...
  -[SUUIScrollingSegmentedControllerCollectionView panGestureRecognizer](self->_contentCollectionView, "panGestureRecognizer");
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v26, "_setHysteresis:", 15.0);

  -[SUUIScrollingSegmentedControllerCollectionView setAllowsSelection:](self->_contentCollectionView, "setAllowsSelection:", 0);
  v27 = self->_contentCollectionView;
  objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIScrollingSegmentedControllerCollectionView setBackgroundColor:](v27, "setBackgroundColor:", v28);

  -[SUUIScrollingSegmentedControllerCollectionView setDataSource:](self->_contentCollectionView, "setDataSource:", self);
  -[SUUIScrollingSegmentedControllerCollectionView setDelegate:](self->_contentCollectionView, "setDelegate:", self);
  -[SUUIScrollingSegmentedControllerCollectionView registerClass:forCellWithReuseIdentifier:](self->_contentCollectionView, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251202068);
  -[SUUIScrollingSegmentedControllerCollectionView setScrollsToTop:](self->_contentCollectionView, "setScrollsToTop:", 0);
  -[SUUIScrollingSegmentedControllerCollectionView setPreservesSuperviewLayoutMargins:](self->_contentCollectionView, "setPreservesSuperviewLayoutMargins:", 1);
  -[SUUIScrollingSegmentedControllerCollectionView setShowsHorizontalScrollIndicator:](self->_contentCollectionView, "setShowsHorizontalScrollIndicator:", 0);
  -[SUUIScrollingSegmentedControllerCollectionView setShowsVerticalScrollIndicator:](self->_contentCollectionView, "setShowsVerticalScrollIndicator:", 0);
  -[SUUIScrollingSegmentedControllerCollectionView setPagingEnabled:](self->_contentCollectionView, "setPagingEnabled:", 1);
  -[SUUIScrollingSegmentedControllerCollectionView setScrollEnabled:](self->_contentCollectionView, "setScrollEnabled:", self->_scrollEnabled);
  objc_msgSend(v3, "addSubview:", self->_contentCollectionView);
  -[SUUIScrollingSegmentedController _updateViewBackgroundColor](self, "_updateViewBackgroundColor");
  ...
  -[SUUIInteractiveSegmentedControl setDividerCreationBlock:](self->_titlesSegmentedControl, "setDividerCreationBlock:", &__block_literal_global_12);
  v31 = self->_titlesSegmentedControl;
  +[SUUIStandardInteractiveDividerView defaultWidth](SUUIStandardInteractiveDividerView, "defaultWidth");
  -[SUUIInteractiveSegmentedControl setDividerWidth:](v31, "setDividerWidth:");
  -[SUUIInteractiveSegmentedControl addTarget:action:forControlEvents:](self->_titlesSegmentedControl, "addTarget:action:forControlEvents:", self, sel__titlesSegmentedControlValueChangeAction_, 4096);
  -[SUUIScrollingSegmentedController _reloadTitleSegments](self, "_reloadTitleSegments");
  ...
  -[SUUIScrollingSegmentedControllerNavigationBarTitleView setSegmentedControl:](self->_navigationBarTitleView, "setSegmentedControl:", self->_titlesSegmentedControl);
}
...
{
  return -[SUUIStandardInteractiveDividerView initWithFrame:]([SUUIStandardInteractiveDividerView alloc], "initWithFrame:", a1, a2, a3, a4);
}
...
- (void)viewDidLayoutSubviews
{
  ...
  -[SUUIScrollingSegmentedController viewDidLayoutSubviews](&v32, sel_viewDidLayoutSubviews);
  -[SUUIScrollingSegmentedController view](self, "view");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    {
      -[SUUIScrollingSegmentedControllerCollectionView contentOffset](self->_contentCollectionView, "contentOffset");
      v14 = v19;
      UIRoundToViewScale();
      v15 = v20;
    }
    ...
    -[SUUIScrollingSegmentedControllerCollectionView collectionViewLayout](self->_contentCollectionView, "collectionViewLayout");
  ...
  if (v18)
  {
    ...
    v30 = -[SUUIScrollingSegmentedControllerCollectionView contentOffset](self->_contentCollectionView, "contentOffset");
  ...
  -[SUUIScrollingSegmentedController _updateTitlesSelectionProgress](self, "_updateTitlesSelectionProgress");
  -[SUUIScrollingSegmentedControllerNavigationBarTitleView setNeedsLayout](self->_navigationBarTitleView, "setNeedsLayout");
...
- (id)contentScrollView
{
  ...
  if (!self->_proxyScrollView && -[SUUIScrollingSegmentedController isViewLoaded](self, "isViewLoaded"))
  {
...
- (void)decodeRestorableStateWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectForKey:", CFSTR("_SUUIScrollingSegmentedControllerStateRestorationKeySelectedViewController"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    -[SUUIScrollingSegmentedController viewControllers](self, "viewControllers");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v6, "count"))
    {
      v7 = objc_msgSend(v6, "indexOfObject:", v5);
      if (v7 != 0x7FFFFFFFFFFFFFFFLL)
        -[SUUIScrollingSegmentedController selectViewControllerAtIndex:animated:](self, "selectViewControllerAtIndex:animated:", v7, 0);
    }

  }
  v8.receiver = self;
  v8.super_class = (Class)SUUIScrollingSegmentedController;
  -[SUUIScrollingSegmentedController decodeRestorableStateWithCoder:](&v8, sel_decodeRestorableStateWithCoder_, v4);
...
- (void)encodeRestorableStateWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[SUUIScrollingSegmentedController focusedViewControllerIndex](self, "focusedViewControllerIndex");
  -[SUUIScrollingSegmentedController viewControllers](self, "viewControllers");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (v5 != 0x7FFFFFFFFFFFFFFFLL && v5 < objc_msgSend(v6, "count"))
  {
    ...
    objc_msgSend(v4, "encodeObject:forKey:", v8, CFSTR("_SUUIScrollingSegmentedControllerStateRestorationKeySelectedViewController"));

  }
  v9.receiver = self;
  v9.super_class = (Class)SUUIScrollingSegmentedController;
  -[SUUIScrollingSegmentedController encodeRestorableStateWithCoder:](&v9, sel_encodeRestorableStateWithCoder_, v4);
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  if ((void *)_SUUIScrollingSegmentTitleValueObservationContext == a6)
  {
    ...
    if (viewControllers)
    {
      ...
      {
        v16 = v15;
        -[SUUIInteractiveSegmentedControl segments](self->_titlesSegmentedControl, "segments");
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "objectAtIndex:", v16);
        v18 = (void *)objc_claimAutoreleasedReturnValue();

        if (-[SUUIScrollingSegmentedController _configureSegment:forViewController:](self, "_configureSegment:forViewController:", v18, v13)&& -[SUUIScrollingSegmentedController isViewLoaded](self, "isViewLoaded"))
        {
          -[SUUIScrollingSegmentedController view](self, "view");
          v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[SUUIScrollingSegmentedController observeValueForKeyPath:ofObject:change:context:](&v20, sel_observeValueForKeyPath_ofObject_change_context_, v10, v11, v12, a6);
  }
...
- (void)scrollViewDidChangeContentInset:(id)a3
{
  ...
  v4 = (SUUIProxyScrollView *)a3;
  v5 = v4;
  if (self->_proxyScrollView == v4)
  {
    -[SUUIProxyScrollView window](v4, "window");
    v6 = (void *)objc_claimAutoreleasedReturnValue();

    if (v6)
    {
      -[SUUIProxyScrollView contentInset](v5, "contentInset");
      ...
      if (!v12 || self->_proxyScrollViewContentInsetAdjustment.bottom != v9)
      {
        ...
        -[SUUIScrollingSegmentedController _viewControllerContentScrollViewContentInset](self, "_viewControllerContentScrollViewContentInset");
        v15 = v14;
        v17 = v16;
        v19 = v18;
        v21 = v20;
...
- (void)scrollingSegmentedControllerCollectionViewDidLayoutSubviews:(id)a3
{
  ...
  if (self->_contentCollectionView != a3)
    return;
  -[SUUIScrollingSegmentedController _updateTitlesSelectionProgress](self, "_updateTitlesSelectionProgress");
  -[SUUIScrollingSegmentedController _indexPathOfFocusedItemAllowingLayoutIfNeeded:](self, "_indexPathOfFocusedItemAllowingLayoutIfNeeded:", 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = v4;
  if (!v4)
  {
...
- (void)scrollingTabAppearanceStatusWasUpdated:(id)a3
{
  ...
  if (-[SUUIScrollingSegmentedController isViewLoaded](self, "isViewLoaded"))
    -[SUUIScrollingSegmentedController _updateTitlesSelectionProgress](self, "_updateTitlesSelectionProgress");
}
...
- (UIScrollView)scrollingTabNestedPagingScrollView
{
  ...
  v3 = (id)-[SUUIScrollingSegmentedController view](self, "view");
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  {
    v7 = a4;
    objc_msgSend(a3, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x251202068, v7);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    viewControllers = self->_viewControllers;
...
- (void)collectionView:(id)a3 didEndDisplayingCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  {
    v9 = v7;
    -[SUUIScrollingSegmentedController delegate](self, "delegate");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_opt_respondsToSelector() & 1) != 0)
...
- (CGSize)collectionView:(id)a3 layout:(id)a4 sizeForItemAtIndexPath:(id)a5
{
  ...
  if (self->_contentCollectionView == a3)
    ...
    p_contentCollectionViewItemSize = (CGSize *)MEMORY[0x24BDBF148];
...
{
  SUUIScrollingSegmentedControllerDelegate **p_delegate;
  id WeakRetained;
  char v6;
  id v7;
...
- (void)setMaximumContentWidth:(double)a3
{
  ...
  if (vabdd_f64(self->_maximumContentWidth, a3) > 0.00000011920929)
  {
    ...
    v12 = 0u;
    v13 = 0u;
    -[SUUIScrollingSegmentedControllerCollectionView visibleCells](self->_contentCollectionView, "visibleCells", 0);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  SUUIScrollingSegmentedController *v4;
  _QWORD v5[5];
  ...
  v5[4] = self;
  v4 = self;
  -[SUUIScrollingSegmentedController _setViewControllers:viewUpdatesHandler:](v4, "_setViewControllers:viewUpdatesHandler:", a3, v5);
...
- (UIEdgeInsets)segmentedControlContentEdgeInsets
{
  ...
  -[SUUIScrollingSegmentedController navigationBarTitleView](self, "navigationBarTitleView");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)replaceViewControllerAtIndex:(unint64_t)a3 withViewController:(id)a4
{
  ...
  int v11;
  NSUInteger v12;
  SUUIScrollingSegmentedController *v13;
  _QWORD v14[5];
  id v15;
  NSUInteger v16;
  unint64_t v17;
  ...
  if (v11)
  {
    ...
    v15 = v6;
    v13 = self;
    -[SUUIScrollingSegmentedController _setViewControllers:viewUpdatesHandler:](v13, "_setViewControllers:viewUpdatesHandler:", v7, v14);

  }
  else
  {
    -[SUUIScrollingSegmentedController setViewControllers:](self, "setViewControllers:", v7);
  }
...
- (void)selectViewControllerAtIndex:(unint64_t)a3 animated:(BOOL)a4
{
  ...
  if (a3 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    {
      if ((-[SUUIScrollingSegmentedController isViewLoaded](self, "isViewLoaded") & 1) == 0)
      {
        -[SUUIScrollingSegmentedController view](self, "view");
      ...
      -[SUUIScrollingSegmentedControllerCollectionView layoutIfNeeded](self->_contentCollectionView, "layoutIfNeeded");
      contentCollectionView = self->_contentCollectionView;
      objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", a3, 0);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIScrollingSegmentedControllerCollectionView layoutAttributesForItemAtIndexPath:](contentCollectionView, "layoutAttributesForItemAtIndexPath:", v9);
      ...
      -[SUUIScrollingSegmentedControllerCollectionView contentOffset](self->_contentCollectionView, "contentOffset");
      v19 = v18;
      -[SUUIScrollingSegmentedControllerCollectionView contentInset](self->_contentCollectionView, "contentInset");
      v21 = v20;
      v23 = v22;
      v24 = v19 + v20;
      v26.origin.x = v11;
      ...
      v26.size.width = v15;
      v26.size.height = v17;
      -[SUUIScrollingSegmentedControllerCollectionView setContentOffset:animated:](self->_contentCollectionView, "setContentOffset:animated:", v4, CGRectGetMinX(v26) - v23, v24 - v21);
...
- (id)_indexPathOfFocusedItemAllowingLayoutIfNeeded:(BOOL)a3
{
  ...
  double v7;
  double v8;
  SUUIScrollingSegmentedControllerCollectionView *v9;
  double v10;
  double v11;
  uint64_t v12;
  uint64_t v13;
  ...
  -[SUUIScrollingSegmentedControllerCollectionView bounds](self->_contentCollectionView, "bounds");
  UIRectGetCenter();
  v6 = v5;
  -[SUUIScrollingSegmentedControllerCollectionView contentOffset](self->_contentCollectionView, "contentOffset");
  v8 = v7;
  v9 = self->_contentCollectionView;
  -[SUUIScrollingSegmentedControllerCollectionView contentOffset](v9, "contentOffset");
  v11 = v10;
  if (v3)
    -[SUUIScrollingSegmentedControllerCollectionView layoutIfNeeded](v9, "layoutIfNeeded");
  -[SUUIScrollingSegmentedControllerCollectionView visibleCells](v9, "visibleCells");
  v27 = 0u;
  v28 = 0u;
  v29 = 0u;
  v30 = 0u;
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v13; ++i)
      {
        ...
        -[SUUIScrollingSegmentedControllerCollectionView indexPathForCell:](v9, "indexPathForCell:", *(_QWORD *)(*((_QWORD *)&v27 + 1) + 8 * i));
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        if (v20)
        {
          -[SUUIScrollingSegmentedControllerCollectionView layoutAttributesForItemAtIndexPath:](v9, "layoutAttributesForItemAtIndexPath:", v20);
          v21 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadTitleSegments
{
  ...
  uint64_t v11;
  uint64_t v12;
  SUUIStandardInteractiveSegment *v13;
  void *v14;
  __int128 v15;
  __int128 v16;
  __int128 v17;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if (v12)
        {
          v13 = (SUUIStandardInteractiveSegment *)v12;
        ...
        -[SUUIScrollingSegmentedController _configureSegment:forViewController:](self, "_configureSegment:forViewController:", v13, v11);
        if (!v8)
          v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSArray count](self->_viewControllers, "count"));
  ...
  -[SUUIInteractiveSegmentedControl setSegments:](self->_titlesSegmentedControl, "setSegments:", v8);
  -[SUUIScrollingSegmentedController _updateTitlesSelectionProgress](self, "_updateTitlesSelectionProgress");
  -[SUUIScrollingSegmentedController navigationBarTitleView](self, "navigationBarTitleView");
...
- (void)_scrollToTitlesSelectionProgress:(double)a3 animated:(BOOL)a4
{
  ...
  v4 = a4;
  -[SUUIScrollingSegmentedControllerCollectionView contentSize](self->_contentCollectionView, "contentSize");
  v7 = v6;
  -[SUUIScrollingSegmentedControllerCollectionView bounds](self->_contentCollectionView, "bounds");
  y = v27.origin.y;
  ...
  -[SUUIScrollingSegmentedControllerCollectionView setContentOffset:animated:](self->_contentCollectionView, "setContentOffset:animated:", v4, v20, v13 + rect_16 - v13);
}
...
- (void)_setViewControllers:(id)a3 viewUpdatesHandler:(id)a4
{
  ...
  uint64_t i;
  void *v21;
  SUUIScrollingSegmentedController *v22;
  void *v23;
  void *v24;
  void *v25;
  NSArray *v26;
  ...
  if (viewControllers != v6 && !-[NSArray isEqualToArray:](viewControllers, "isEqualToArray:", v6))
  {
    ...
    v58 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", objc_msgSend(v9, "count"));
    v72 = 0u;
    v73 = 0u;
    v74 = 0u;
    v75 = 0u;
    ...
    if (v13)
    {
      ...
      v17 = *(double *)(MEMORY[0x24BEBE158] + 8);
      v18 = *(double *)(MEMORY[0x24BEBE158] + 16);
      v19 = *(double *)(MEMORY[0x24BEBE158] + 24);
      do
      {
        for (i = 0; i != v14; ++i)
        {
          ...
          if (!-[NSArray containsObject:](self->_viewControllers, "containsObject:", v21))
          {
            ...
            v22 = (SUUIScrollingSegmentedController *)objc_claimAutoreleasedReturnValue();
    ...
    v25 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSArray count](self->_viewControllers, "count"));
    v68 = 0u;
    v69 = 0u;
    v70 = 0u;
    v71 = 0u;
    ...
    if (v27)
    {
      v28 = v27;
      v29 = *(_QWORD *)v69;
      v30 = &OBJC_METACLASS___SUUIDonationResultView;
      v59 = v12;
      do
      {
        for (j = 0; j != v28; ++j)
        {
          ...
          if ((objc_msgSend(v12, "containsObject:", v32) & 1) == 0)
          {
            ...
            if (objc_msgSend(v32, "conformsToProtocol:", &unk_25719F130))
            {
            ...
            -[SUUIScrollingSegmentedController addChildViewController:](self, "addChildViewController:", v32);
            v34 = (void *)objc_msgSend(objc_alloc(&v30[102]), "initWithViewController:", v32);
            ...
            if (!viewControllerToItemContext)
            {
              ...
              v38 = v26;
              v39 = v25;
              v40 = objc_alloc(MEMORY[0x24BDD1650]);
    ...
    if (v51)
    {
      ...
      do
      {
        for (m = 0; m != v52; ++m)
        {
          ...
          if (objc_msgSend(v55, "conformsToProtocol:", &unk_25719F130))
    ...
    -[SUUIScrollingSegmentedController _updateTitleValueObservation](self, "_updateTitleValueObservation");
    v6 = v56;
    v7 = v57;
  }
...
- (void)_updateScrollViewContentOffsetsToTargetContentOffsets
{
  ...
  if (-[SUUIScrollingSegmentedController isViewLoaded](self, "isViewLoaded"))
  {
    ...
    -[SUUIScrollingSegmentedControllerCollectionView contentOffset](self->_contentCollectionView, "contentOffset");
    if (v9 != Width * v8)
      -[SUUIScrollingSegmentedControllerCollectionView setContentOffset:](self->_contentCollectionView, "setContentOffset:");
  }
}
...
- (void)_updateTitlesSelectionProgress
{
  ...
  if (v15 != 1)
    v16 = v13;
  -[SUUIInteractiveSegmentedControl setSelectionProgress:](self->_titlesSegmentedControl, "setSelectionProgress:", v16);
}
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        if ((-[NSMutableArray containsObject:](self->_titleObservingViewControllers, "containsObject:", v9) & 1) == 0)
        {
          ...
          {
            v11 = (NSMutableArray *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", objc_msgSend(obj, "count"));
          ...
          objc_msgSend(v9, "addObserver:forKeyPath:options:context:", self, CFSTR("navigationItem.title"), 0, _SUUIScrollingSegmentTitleValueObservationContext);
        }
      }
  ...
  if (v14)
  {
    ...
    do
    {
      for (j = 0; j != v15; ++j)
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v20 + 1) + 8 * j), "removeObserver:forKeyPath:context:", self, CFSTR("navigationItem.title"), _SUUIScrollingSegmentTitleValueObservationContext);
      }
...
{
  return (SUUIScrollingSegmentedControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
