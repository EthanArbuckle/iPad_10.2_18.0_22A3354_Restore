...
{
  id v6;
  SUUIJSModalDocumentController *v7;
  id v8;
  objc_super v10;
  id location;
...
{
  return (SUUIModalDocumentController *)objc_loadWeakRetained((id *)&self->_modalDocumentController);
}
...
- (void)pushDocument:(id)a3 :(id)a4
{
  ...
  -[SUUIJSModalDocumentController _adjustedOptionsWithOptions:](self, "_adjustedOptionsWithOptions:", v7);
...
void __47__SUUIJSModalDocumentController_pushDocument::__block_invoke(_QWORD *a1)
{
  id WeakRetained;
  id v3;
  uint64_t v4;
  ...
  if (v7)
  {
    v4 = objc_msgSend(objc_alloc(MEMORY[0x24BE519C0]), "initWithAppContext:navigationController:", a1[7], v7);
    v5 = *(_QWORD *)(a1[8] + 8);
    v6 = *(void **)(v5 + 40);
    *(_QWORD *)(v5 + 40) = v4;
...
- (void)replaceDocument:(id)a3 :(id)a4 :(id)a5
{
  ...
  if (v8
    && objc_msgSend(MEMORY[0x24BE51938], "instancesRespondToSelector:", sel_initWithAppContext_document_owner_))
  {
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE51938]), "initWithAppContext:document:owner:", v11, v8, self);
  }
  else
  {
    v12 = 0;
  }
  -[SUUIJSModalDocumentController _adjustedOptionsWithOptions:](self, "_adjustedOptionsWithOptions:", v10);
...
void __51__SUUIJSModalDocumentController_replaceDocument_::__block_invoke(_QWORD *a1)
{
  id WeakRetained;
  void *v3;
  id v4;
...
LABEL_3:
    ...
    if (v15)
    {
      v16 = objc_msgSend(objc_alloc(MEMORY[0x24BE519C0]), "initWithAppContext:navigationController:", a1[8], v15);
      v17 = *(_QWORD *)(a1[10] + 8);
      v18 = *(void **)(v17 + 40);
      *(_QWORD *)(v17 + 40) = v16;
