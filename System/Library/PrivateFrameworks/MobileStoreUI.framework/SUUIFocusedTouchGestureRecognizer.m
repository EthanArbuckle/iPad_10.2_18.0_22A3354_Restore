...
- (SUUIFocusedTouchGestureRecognizer)initWithFocusedView:(id)a3 touchAllowance:(UIEdgeInsets)a4
{
  ...
  CGFloat top;
  id v11;
  SUUIFocusedTouchGestureRecognizer *v12;
  SUUIFocusedTouchGestureRecognizer *v13;
  SUUIFocusedTouchGestureRecognizer *v14;
  void *v15;
  objc_super v17;
  ...
  if (v11)
  {
    ...
    v12 = -[SUUIFocusedTouchGestureRecognizer initWithTarget:action:](&v17, sel_initWithTarget_action_, 0, 0);
    v13 = v12;
    if (v12)
    {
  ...
  else
  {
    ...
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SUUIFocusedTouchGestureRecognizer.m"), 20, CFSTR("A focused view is required."));
...
- (void)reset
{
  ...
  -[SUUIFocusedTouchGestureRecognizer reset](&v4, sel_reset);
}
...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  if (self->_didTouchOutside)
  {
    -[SUUIFocusedTouchGestureRecognizer setState:](self, "setState:", 1);
    v8 = v32;
  }
  else
  {
    ...
    if (v25)
    {
      ...
      do
      {
        for (j = 0; j != v26; ++j)
        {
          ...
          -[SUUIFocusedTouchGestureRecognizer ignoreTouch:forEvent:](self, "ignoreTouch:forEvent:", *(_QWORD *)(*((_QWORD *)&v34 + 1) + 8 * j), v32);
        }
...
LABEL_27:
    ...
    {
      v30 = (NSMutableSet *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEF0]), "initWithSet:", v6);
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  if (!-[NSMutableSet count](self->_activeTouches, "count"))
  {
    if (self->_didTouchOutside)
      ...
      v5 = 5;
    -[SUUIFocusedTouchGestureRecognizer setState:](self, "setState:", v5);
    activeTouches = self->_activeTouches;
    self->_activeTouches = 0;
