...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (v8)
  {
    objc_msgSend(a1, "_attributedStringWithLabel:context:", v8, v11);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "labelLayoutCache");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "requestLayoutForLabel:attributedString:width:", v8, v9, (uint64_t)a4);
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  if (v14)
  {
    objc_msgSend(v8, "sizeForViewElement:width:", v14, a3);
    v13 = v13 + v16;
    if (v11 < v15)
      v11 = v15;
  }
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v12[1] = 3221225472;
  v12[2] = __65__SUUIActivityIndicatorView_reloadWithViewElement_width_context___block_invoke;
  v12[3] = &unk_2511F4AC8;
  v13 = v8;
  v14 = self;
  v15 = v9;
  ...
  -[SUUIActivityIndicatorView _updateSpinnerAnimation](self, "_updateSpinnerAnimation");
...
void __65__SUUIActivityIndicatorView_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    objc_msgSend(v22, "addReusableViewWithReuseIdentifier:", 0x251200628);
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 40) + 432) = SUUIViewElementAlignmentForStyle(v20);
...
- (void)setContentInset:(UIEdgeInsets)a3
{
    ...
    || self->_contentInset.bottom != a3.bottom)
  {
    ...
    -[SUUIActivityIndicatorView setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)didMoveToSuperview
{
  ...
  -[SUUIActivityIndicatorView didMoveToSuperview](&v3, sel_didMoveToSuperview);
  -[SUUIActivityIndicatorView _updateSpinnerAnimation](self, "_updateSpinnerAnimation");
}
...
- (void)didMoveToWindow
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SUUIActivityIndicatorView;
  -[SUUIActivityIndicatorView didMoveToWindow](&v3, sel_didMoveToWindow);
  -[SUUIActivityIndicatorView _updateSpinnerAnimation](self, "_updateSpinnerAnimation");
}
...
- (void)layoutSubviews
{
  ...
  double v20;
  float v21;
  SUUIAttributedStringView *stringView;
  double v23;
  float v24;
  double v25;
  __int128 v26;
  ...
  -[SUUIActivityIndicatorView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  ...
  if (stringView)
  {
    -[SUUIAttributedStringView frame](stringView, "frame");
    v24 = (v4 - v23) * 0.5;
...
- (void)setHidden:(BOOL)a3
{
  ...
  -[SUUIActivityIndicatorView setHidden:](&v4, sel_setHidden_, a3);
  -[SUUIActivityIndicatorView _updateSpinnerAnimation](self, "_updateSpinnerAnimation");
}
...
void __51__SUUIActivityIndicatorView__activityIndicatorSize__block_invoke()
{
  ...
  v2 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BEBD398]), "initWithActivityIndicatorStyle:", 1);
  objc_msgSend(v2, "sizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
...
- (void)_startAnimating
{
  ...
  if (!-[SUUIActivityIndicatorView _isAnimating](self, "_isAnimating"))
  {
    ...
    else
    {
      ...
      v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithDouble:", 0.0);
      objc_msgSend(v8, "setFromValue:", v5);
      v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithDouble:", 6.28318531);
...
- (void)_updateSpinnerAnimation
{
  ...
  -[SUUIActivityIndicatorView window](self, "window");
  v3 = objc_claimAutoreleasedReturnValue();
  if (v3
    && (v4 = (void *)v3, v5 = -[SUUIActivityIndicatorView isHidden](self, "isHidden"), v4, (v5 & 1) == 0))
  {
    -[SUUIActivityIndicatorView _startAnimating](self, "_startAnimating");
  }
  else
  {
    -[SUUIActivityIndicatorView _stopAnimating](self, "_stopAnimating");
  }
}
