...
- (SUUICategory)initWithCategoryDictionary:(id)a3
{
  ...
  v5 = -[SUUICategory init](&v37, sel_init);
  if (v5)
  {
    ...
    +[SUUIArtworkProvidingFactory artworkProviderForStoreResponse:](SUUIArtworkProvidingFactory, "artworkProviderForStoreResponse:", v15);
...
- (BOOL)containsURL:(id)a3
{
  ...
  else
  {
    ...
    v12 = 0u;
    v13 = 0u;
    -[SUUICategory children](self, "children", 0);
