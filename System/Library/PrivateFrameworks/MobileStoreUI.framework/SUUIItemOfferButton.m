...
- (SUUIItemOfferButton)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithRed:green:blue:alpha:", 0.0980392157, 0.670588235, 0.125490196, 1.0);
    ...
    v3->_offerButtonStateDescription = (NSString *)&stru_2511FF0C8;
...
- (void)dealloc
{
  ...
  -[SUUIFocusedTouchGestureRecognizer removeTarget:action:](self->_cancelGestureRecognizer, "removeTarget:action:", self, 0);
  v3.receiver = self;
  v3.super_class = (Class)SUUIItemOfferButton;
  -[SUUIItemOfferButton dealloc](&v3, sel_dealloc);
}
...
- (CGSize)layoutSizeThatFits:(CGSize)a3
{
  ...
  height = a3.height;
  width = a3.width;
  if (-[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation"))
  {
    v6 = (void *)-[NSMutableAttributedString mutableCopy](self->_titleAttributedString, "mutableCopy");
    -[SUUIItemOfferButton _horizontalInsetForTitleStyle:](self, "_horizontalInsetForTitleStyle:", self->_titleStyle);
    v8 = v7;
...
- (NSString)offerButtonStateDescription
{
  ...
  if (-[SUUIItemOfferButton showsConfirmationState](self, "showsConfirmationState")
    && !-[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation"))
  {
...
- (BOOL)isShowingConfirmation
{
  ...
  -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
...
- (void)removeButtonStateAnimations
{
  ...
  if (v5)
  {
    -[SUUIItemOfferButton _sendWillAnimate](self, "_sendWillAnimate");
    -[SUUIItemOfferButton _reloadForCurrentState:](self, "_reloadForCurrentState:", 0);
    -[SUUIItemOfferButton _sendDidAnimate](self, "_sendDidAnimate");
  }
}
...
- (void)setConfirmationTitle:(id)a3
{
  ...
  v9 = a3;
  -[SUUIItemOfferButton confirmationTitle](self, "confirmationTitle");
  ...
  if (v5 != v9 && (objc_msgSend(v5, "isEqualToString:", v9) & 1) == 0)
  {
    ...
    -[SUUIItemOfferButton _updateForChangedConfirmationTitleProperty](self, "_updateForChangedConfirmationTitleProperty");
  }
...
{
  -[SUUIItemOfferButton setProgress:animated:](self, "setProgress:animated:", 1, a3);
}
...
{
  -[SUUIItemOfferButton setProgressType:animated:](self, "setProgressType:animated:", a3, 0);
}
...
- (void)setProgressType:(int64_t)a3 animated:(BOOL)a4
{
  ...
  if (v8 != a3)
  {
    if (a4)
    {
      -[SUUIItemOfferButton _reloadForCurrentState:](self, "_reloadForCurrentState:", 1);
      -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
      ...
      -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v11);
      ...
      -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v16);
      ...
      if (v10)
      {
        ...
        if (v19)
        {
          ...
          v26[1] = 3221225472;
          v26[2] = __48__SUUIItemOfferButton_setProgressType_animated___block_invoke;
          v26[3] = &unk_2511F4908;
          v26[4] = self;
          -[SUUIItemOfferButton _transitionFromProgress:toProgress:withDuration:completion:](self, "_transitionFromProgress:toProgress:withDuration:completion:", v12, v17, v26, 0.4);
        }
        v24[0] = v20;
        v24[1] = 3221225472;
        v24[2] = __48__SUUIItemOfferButton_setProgressType_animated___block_invoke_3;
        v24[3] = &unk_2511F4908;
        v24[4] = self;
        -[SUUIItemOfferButton _transitionFromProgress:toTitleOrImage:withDuration:completion:](self, "_transitionFromProgress:toTitleOrImage:withDuration:completion:", v12, v17, v24, 0.4);
      }
      else
      {
        v25[0] = MEMORY[0x24BDAC760];
        v25[1] = 3221225472;
        v25[2] = __48__SUUIItemOfferButton_setProgressType_animated___block_invoke_2;
        v25[3] = &unk_2511F4908;
        v25[4] = self;
        -[SUUIItemOfferButton _transitionFromTitleOrImage:toProgress:withDuration:completion:](self, "_transitionFromTitleOrImage:toProgress:withDuration:completion:", v12, v17, v25, 0.4);
      }
...
- (void)setShowingConfirmation:(BOOL)a3 animated:(BOOL)a4
{
  ...
  v5 = a3;
  if (-[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation") != a3)
  {
    if (a4)
    {
      -[SUUIItemOfferButton _reloadForCurrentState:](self, "_reloadForCurrentState:", 1);
      -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v7);
      ...
      v15[3] = &unk_2511F4908;
      v15[4] = self;
      -[SUUIItemOfferButton _transitionFromTitle:toTitle:withDuration:completion:](self, "_transitionFromTitle:toTitle:withDuration:completion:", v8, v12, v15, 0.26);
...
- (void)setTitle:(id)a3
{
  ...
  v9 = a3;
  -[SUUIItemOfferButton title](self, "title");
  v5 = (id)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5 != v9 && (objc_msgSend(v5, "isEqualToString:", v9) & 1) == 0)
  {
    ...
    -[SUUIItemOfferButton _updateForChangedTitleProperty](self, "_updateForChangedTitleProperty");
  }
...
- (void)showCloudImage
{
  ...
  if (!self->_cloudImage)
  {
    ...
    -[SUUIItemOfferButton tintColor](self, "tintColor");
...
- (NSString)buyType
{
  ...
  -[SUUIItemOfferButton element](self, "element");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)cloudImageWithTintColor:(id)a3 arrowTintColor:(id)a4
{
  ...
  if (!v17 || cloudImageWithTintColor_arrowTintColor__sLastCloudColor != (_QWORD)v6)
  {
    ...
    objc_msgSend(v20, "drawAtPoint:", *MEMORY[0x24BDBEFB0], v30);
...
+ (id)cloudTintColorForBackgroundColor:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithWhite:alpha:", 1.0, 0.5);
    v4 = objc_claimAutoreleasedReturnValue();
  ...
  v6 = &SUUICoreMediaFramework_sHandle;
  ...
  if (v9 <= 3)
    v6 = (uint64_t *)(id)*off_2511F9DB8[v9];
...
LABEL_16:
    +[SUUIClientContext localizedStringForKey:inBundles:](SUUIClientContext, "localizedStringForKey:inBundles:", v12, 0);
...
- (void)setCloudTintColor:(id)a3
{
  ...
  if (self->_cloudTintColor != v4)
  {
    ...
    if (self->_cloudImage)
    {
      ...
      -[SUUIItemOfferButton setNeedsDisplay](self, "setNeedsDisplay");
      v4 = v12;
    }
  }
...
- (void)setColoringWithAppearance:(id)a3
{
  ...
  if (v9)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemOfferButton setTintColor:](self, "setTintColor:", v8);
  }
  else
  {
    objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithWhite:alpha:", 0.0, 0.5);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemOfferButton setCloudTintColor:](self, "setCloudTintColor:", v8);
  }
...
- (void)setDisabledButSelectable:(BOOL)a3
{
  ...
  -[SUUIItemOfferButton setNeedsLayout](self, "setNeedsLayout");
}
...
- (BOOL)setTitle:(id)a3 confirmationTitle:(id)a4 itemState:(id)a5 clientContext:(id)a6 animated:(BOOL)a7
{
  ...
  self->_offerButtonStateDescription = (NSString *)&stru_2511FF0C8;

  v16 = objc_msgSend(v13, "state");
  v17 = -[SUUIItemOfferButton supportsPlayButton](self, "supportsPlayButton");
  -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIItemOfferButton setEnabled:](self, "setEnabled:", 1);
  v61 = v12;
  v62 = v11;
  v59 = v14;
  v60 = v13;
  ...
  if ((v16 & 2) != 0)
  {
    ...
    -[SUUIItemOfferButton setProgress:](self, "setProgress:", v25);
    v23 = 0;
    v58 = 0;
    v56 = 0;
    v17 = 0;
...
LABEL_13:
  ...
  if ((v16 & 4) != 0)
  {
    ...
    if (!v41)
    {
      ...
      -[SUUIItemOfferButton setEnabled:](self, "setEnabled:", 0);
LABEL_44:
      LODWORD(v55) = 0;
      v24 = 0;
      v56 = 0;
  ...
  if ((v16 & 0x40) != 0)
  {
    ...
    if ((_DWORD)v17)
    {
      ...
      -[SUUIItemOfferButton setImage:](self, "setImage:", v46);
  ...
  if ((v16 & 0x10) == 0)
  {
    v20 = v11;
    v21 = v12;
    v56 = -[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation");
...
LABEL_14:
  ...
  if (v14)
    ...
    +[SUUIClientContext localizedStringForKey:inBundles:](SUUIClientContext, "localizedStringForKey:inBundles:", CFSTR("ITEM_OFFER_BUTTON_INSTALL_APP"), 0);
...
LABEL_15:
  ...
  -[SUUIItemOfferButton setFillStyle:](self, "setFillStyle:", v23);
  -[SUUIItemOfferButton setShowsConfirmationState:](self, "setShowsConfirmationState:", v17);
  v28 = -[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation");
  v29 = -[SUUIItemOfferButton progressType](self, "progressType");
  v30 = &OBJC_IVAR___SUUIItemOfferButton__titleAttributedString;
  if (v28)
    v30 = &OBJC_IVAR___SUUIItemOfferButton__confirmationTitleAttributedString;
  v31 = *(id *)((char *)&self->super.super.super.super.isa + *v30);
  -[UIImageView image](self->_imageView, "image");
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  v63 = v21;
  -[SUUIItemOfferButton setConfirmationTitle:](self, "setConfirmationTitle:", v21);
  v33 = v20;
  -[SUUIItemOfferButton setTitle:](self, "setTitle:", v20);
  if (v58 && (v57 & ((v16 & 0x40) != 0)) == 0)
  {
    if ((_DWORD)v55)
      -[SUUIItemOfferButton showCloudImage](self, "showCloudImage");
    else
      -[SUUIItemOfferButton setImage:](self, "setImage:", 0);
  }
  if (v24 == v29)
  {
    -[SUUIItemOfferButton setShowingConfirmation:animated:](self, "setShowingConfirmation:animated:", v56, v64);
    if (v56 == v28)
    {
      -[UIImageView image](self->_imageView, "image");
  ...
  {
    -[SUUIItemOfferButton setProgressType:animated:](self, "setProgressType:animated:", v24, v64);
    v36 = v61;
    v35 = v62;
    v38 = v59;
    v37 = v60;
...
- (BOOL)setValuesUsingItemOffer:(id)a3 itemState:(id)a4 clientContext:(id)a5 animated:(BOOL)a6
{
  ...
  v16 = -[SUUIItemOfferButton setTitle:confirmationTitle:itemState:clientContext:animated:](self, "setTitle:confirmationTitle:itemState:clientContext:animated:", v13, v14, v11, v12, v6);
...
- (BOOL)setValuesUsingBuyButtonDescriptor:(id)a3 itemState:(id)a4 clientContext:(id)a5 animated:(BOOL)a6
{
  ...
  v6 = a6;
  v10 = a3;
  v11 = (SUUIItemState *)a4;
  v12 = a5;
  -[SUUIItemOfferButton setButtonDescriptor:](self, "setButtonDescriptor:", v10);
  v13 = objc_msgSend(v10, "buttonType");
  if (v13 == 1)
  {
    if (v11)
    {
      -[SUUIItemState setState:](v11, "setState:", -[SUUIItemState state](v11, "state") | 8);
    }
    else
    {
      v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithLongLong:", objc_msgSend(v10, "itemIdentifier"));
      v11 = objc_alloc_init(SUUIItemState);
      -[SUUIItemState setItemIdentifier:](v11, "setItemIdentifier:", v20);
      v21 = -[SUUIStoreIdentifier initWithNumber:]([SUUIStoreIdentifier alloc], "initWithNumber:", v20);
      -[SUUIItemState setStoreIdentifier:](v11, "setStoreIdentifier:", v21);

      -[SUUIItemState setState:](v11, "setState:", 8);
    }
    goto LABEL_15;
  }
  if (!v11)
...
LABEL_15:
  ...
  v14 = v13;
  v15 = -[SUUIItemState state](v11, "state");
  v16 = v15;
  v17 = 0;
  if (v14 == 2 && v15)
    v17 = -[SUUIItemState activeStateIsPreview](v11, "activeStateIsPreview") ^ 1;
  v18 = v14 == 2;
  if (v18 == ((-[SUUIItemState libraryContentFlags](v11, "libraryContentFlags") & 1) == 0))
    v16 &= ~0x40uLL;
  if (v18 == ((-[SUUIItemState downloadContentFlags](v11, "downloadContentFlags") & 1) == 0))
    v16 &= 0xFFFFFFFFFFFFFFFCLL;
  if (-[SUUIItemState state](v11, "state") != v16)
  {
    v19 = (SUUIItemState *)-[SUUIItemState copy](v11, "copy");
    -[SUUIItemState setState:](v19, "setState:", v16);

    v11 = v19;
  }
LABEL_16:
  -[SUUIItemOfferButton setHidden:](self, "setHidden:", v17);
  objc_msgSend(v10, "buttonText");
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "confirmationText");
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v24 = -[SUUIItemOfferButton setTitle:confirmationTitle:itemState:clientContext:animated:](self, "setTitle:confirmationTitle:itemState:clientContext:animated:", v22, v23, v11, v12, v6);
...
- (BOOL)beginTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  if (!-[SUUIItemOfferButton isDisabledButSelectable](self, "isDisabledButSelectable", a3, a4))
  {
    -[SUUIItemOfferButton _reloadForCurrentState:](self, "_reloadForCurrentState:", 1);
    -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v5);
    ...
    -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v11)
    {
      -[SUUIItemOfferButton _transitionFromProgress:toProgress:withDuration:completion:](self, "_transitionFromProgress:toProgress:withDuration:completion:", v6, v9, 0, 0.15);
    }
    else if (-[SUUIItemOfferButton hasNonBorderedImage](self, "hasNonBorderedImage"))
    {
      -[SUUIItemOfferButton _transitionFromImage:toImage:withDuration:completion:](self, "_transitionFromImage:toImage:withDuration:completion:", v6, v9, 0, 0.15);
    }
    else if (-[SUUIItemOfferButton hasBorderedImage](self, "hasBorderedImage"))
    {
      -[SUUIItemOfferButton _transitionFromBorderedImage:toTitle:withDuration:completion:](self, "_transitionFromBorderedImage:toTitle:withDuration:completion:", v6, v9, 0, 0.15);
    }
    else
    {
      -[SUUIItemOfferButton _transitionFromTitle:toTitle:withDuration:completion:](self, "_transitionFromTitle:toTitle:withDuration:completion:", v6, v9, 0, 0.15);
    }
...
- (void)cancelTrackingWithEvent:(id)a3
{
  ...
  if (!-[SUUIItemOfferButton isDisabledButSelectable](self, "isDisabledButSelectable", a3))
  {
    -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v10)
    {
      ...
      v14[3] = &unk_2511F4908;
      v14[4] = self;
      -[SUUIItemOfferButton _transitionFromProgress:toProgress:withDuration:completion:](self, "_transitionFromProgress:toProgress:withDuration:completion:", v5, v8, v14, 0.15);
    }
    else if (-[SUUIItemOfferButton hasNonBorderedImage](self, "hasNonBorderedImage"))
    {
      ...
      v13[3] = &unk_2511F4908;
      v13[4] = self;
      -[SUUIItemOfferButton _transitionFromImage:toImage:withDuration:completion:](self, "_transitionFromImage:toImage:withDuration:completion:", v5, v8, v13, 0.15);
    }
    else if (-[SUUIItemOfferButton hasBorderedImage](self, "hasBorderedImage"))
    {
      ...
      v12[3] = &unk_2511F4908;
      v12[4] = self;
      -[SUUIItemOfferButton _transitionFromBorderedImage:toTitle:withDuration:completion:](self, "_transitionFromBorderedImage:toTitle:withDuration:completion:", v5, v8, v12, 0.15);
    }
    else
    {
      ...
      v11[3] = &unk_2511F4908;
      v11[4] = self;
      -[SUUIItemOfferButton _transitionFromTitle:toTitle:withDuration:completion:](self, "_transitionFromTitle:toTitle:withDuration:completion:", v5, v8, v11, 0.15);
    }
...
- (BOOL)continueTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  v5 = a3;
  if (!-[SUUIItemOfferButton isDisabledButSelectable](self, "isDisabledButSelectable"))
  {
    v6 = -[SUUIItemOfferButton _touchInBounds:](self, "_touchInBounds:", v5);
    -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v6 != v8)
    {
      -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v9);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v12);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v15)
      {
        -[SUUIItemOfferButton _transitionFromProgress:toProgress:withDuration:completion:](self, "_transitionFromProgress:toProgress:withDuration:completion:", v10, v13, 0, 0.5);
      }
      else if (-[SUUIItemOfferButton hasNonBorderedImage](self, "hasNonBorderedImage"))
      {
        -[SUUIItemOfferButton _transitionFromImage:toImage:withDuration:completion:](self, "_transitionFromImage:toImage:withDuration:completion:", v10, v13, 0, 0.5);
      }
      else if (-[SUUIItemOfferButton hasBorderedImage](self, "hasBorderedImage"))
      {
        -[SUUIItemOfferButton _transitionFromBorderedImage:toTitle:withDuration:completion:](self, "_transitionFromBorderedImage:toTitle:withDuration:completion:", v10, v13, 0, 0.5);
      }
      else
      {
        -[SUUIItemOfferButton _transitionFromTitle:toTitle:withDuration:completion:](self, "_transitionFromTitle:toTitle:withDuration:completion:", v10, v13, 0, 0.5);
      }
...
- (void)endTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIItemOfferButton _buttonPropertiesForState:](self, "_buttonPropertiesForState:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v12
    && !-[SUUIItemOfferButton hasNonBorderedImage](self, "hasNonBorderedImage")
    && !-[SUUIItemOfferButton hasBorderedImage](self, "hasBorderedImage")
    && !-[SUUIItemOfferButton isDisabledButSelectable](self, "isDisabledButSelectable"))
  {
    ...
    v17[3] = &unk_2511F4908;
    v17[4] = self;
    -[SUUIItemOfferButton _transitionFromTitle:toTitle:withDuration:completion:](self, "_transitionFromTitle:toTitle:withDuration:completion:", v7, v10, v17, 0.25);
  }
  if (-[SUUIItemOfferButton _touchInBounds:](self, "_touchInBounds:", v5))
  {
    if (-[SUUIItemOfferButton isDisabledButSelectable](self, "isDisabledButSelectable"))
    {
      -[SUUIItemOfferButton element](self, "element");
      ...
      if (v13)
      {
        -[SUUIItemOfferButton element](self, "element");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v14, "dispatchEvent:eventAttribute:canBubble:isCancelable:extraInfo:completionBlock:", 0x251210D08, 0x251210D28, 1, 0, 0, 0);

      }
    }
    else
    {
      if (-[SUUIItemOfferButton progressType](self, "progressType")
        || -[SUUIItemOfferButton hasNonBorderedImage](self, "hasNonBorderedImage")
        || -[SUUIItemOfferButton hasBorderedImage](self, "hasBorderedImage")
        || -[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation")
        || !-[SUUIItemOfferButton showsConfirmationState](self, "showsConfirmationState"))
      {
        v15 = self;
        v16 = 0x20000;
      }
      ...
      -[SUUIItemOfferButton sendActionsForControlEvents:](v15, "sendActionsForControlEvents:", v16);
    }
  }
...
- (void)setEnabled:(BOOL)a3
{
  ...
  -[SUUIItemOfferButton setEnabled:](&v7, sel_setEnabled_, v3 & ~v6);
  -[SUUIItemOfferButton setNeedsLayout](self, "setNeedsLayout");
}
...
- (BOOL)_touchInBounds:(id)a3
{
  ...
  -[SUUIItemOfferButton bounds](self, "bounds");
  v12 = -70.0;
...
- (void)setFrame:(CGRect)a3
{
  ...
  {
    -[SUUIItemOfferButton frame](self, "frame");
    v9 = v8;
    v11 = v10;
    v13.receiver = self;
...
- (void)drawRect:(CGRect)a3
{
  ...
  if (self->_usesDrawRectPath)
  {
    -[SUUIItemOfferButton bounds](self, "bounds", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
    v6 = v5;
    v8 = v7;
    v10 = v9;
    v12 = v11;
    if (-[SUUIItemOfferButton hasNonBorderedImage](self, "hasNonBorderedImage"))
    {
      cloudImage = self->_cloudImage;
      if (!cloudImage)
    ...
    {
      if (-[SUUIItemOfferButton hasBorderedImage](self, "hasBorderedImage"))
      {
        ...
        if (-[SUUIItemOfferButton isEnabled](self, "isEnabled"))
          -[SUUIItemOfferButton tintColor](self, "tintColor");
        else
          objc_msgSend(MEMORY[0x24BEBD4B8], "labelColor");
        v39 = (void *)objc_claimAutoreleasedReturnValue();
        -[SUUIItemOfferButton traitCollection](self, "traitCollection");
...
- (void)didMoveToWindow
{
  ...
  -[SUUIItemOfferButton window](self, "window");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIItemOfferButton didMoveToWindow](&v4, sel_didMoveToWindow);
}
...
- (void)layoutSubviews
{
  ...
  if (-[SUUIItemOfferButton isEnabled](self, "isEnabled"))
  {
    v11 = -[SUUIItemOfferButton isDisabledButSelectable](self, "isDisabledButSelectable");
    v12 = 0.4;
    if (!v11)
      v12 = 1.0;
  }
  ...
  -[SUUIItemOfferButton setAlpha:](self, "setAlpha:", v12);
  ...
  if (borderedImageView)
  {
    ...
    -[SUUIItemOfferButton _borderedImageViewFrame](self, "_borderedImageViewFrame");
  ...
  v17 = -[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation");
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)SUUIItemOfferButton;
  -[SUUIItemOfferButton setBackgroundColor:](&v7, sel_setBackgroundColor_, v6);
...
LABEL_10:
    ...
    v14 = -[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation");
    p_confirmationTitleStyle = p_titleStyle;
    if (v14)
      p_confirmationTitleStyle = &self->_confirmationTitleStyle;
    v16 = *p_confirmationTitleStyle;
    -[SUUIItemOfferButton _horizontalInsetForTitleStyle:](self, "_horizontalInsetForTitleStyle:", *p_confirmationTitleStyle);
    v18 = v17;
...
- (void)tintColorDidChange
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)SUUIItemOfferButton;
  -[SUUIItemOfferButton tintColorDidChange](&v7, sel_tintColorDidChange);
  -[SUUIItemOfferButton tintColor](self, "tintColor");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (self->_cloudImage)
  {
...
{
  if (-[SUUIItemOfferButton isShowingConfirmation](self, "isShowingConfirmation", a3))
    -[SUUIItemOfferButton sendActionsForControlEvents:](self, "sendActionsForControlEvents:", 0x10000);
  -[SUUIItemOfferButton _removeCancelGestureRecognizer](self, "_removeCancelGestureRecognizer");
}
...
+ (id)_cachedImageForAttributedTitle:(id)a3 titleStyle:(int64_t)a4 size:(CGSize)a5 fillStyle:(int64_t)a6 universal:(BOOL)a7 tintColor:(id)a8 interfaceStyle:(int64_t)a9
{
  ...
  {
    v18 = objc_alloc_init(MEMORY[0x24BDBCE40]);
...
+ (id)_imageForAttributedTitle:(id)a3 titleStyle:(int64_t)a4 size:(CGSize)a5 fillStyle:(int64_t)a6 universal:(BOOL)a7 tintColor:(id)a8
{
  ...
  objc_msgSend(MEMORY[0x24BEBD420], "_bezierPathWithArcRoundedRect:cornerRadius:", v64.origin.x, v64.origin.y, v64.size.width, v64.size.height, 3.0);
  v48 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_4:
  ...
  if (v14)
  {
    ...
    objc_msgSend(v29, "addAttribute:value:range:", *MEMORY[0x24BEBB368], v15, 0, objc_msgSend(v29, "length"));
    if (a4 == 2)
    {
      v30 = objc_alloc_init(MEMORY[0x24BEBB4A8]);
  ...
  if (a6 == 1)
  {
    objc_msgSend(MEMORY[0x24BEBD420], "_bezierPathWithArcRoundedRect:cornerRadius:", 0.0, 0.0, width, height, 3.0);
    v51 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (CGSize)_titleSizeThatFitsForSize:(CGSize)a3 titleStyle:(int64_t)a4 mutableAttributedString:(id)a5
{
  ...
  {
    v10 = objc_alloc_init(MEMORY[0x24BDBCE40]);
  ...
  if (a4 == 2)
  {
    objc_msgSend(MEMORY[0x24BEBB520], "boldSystemFontOfSize:", 13.0);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v22 = objc_alloc_init(MEMORY[0x24BEBB4A8]);
...
+ (id)playTintColorForBackgroundColor:(id)a3
{
  ...
  v9 = SUUIColorSchemeStyleForColor(v3);
  if (v9 <= 3)
    v6 = (uint64_t *)(id)*off_2511F9DD8[v9];
...
- (id)_buttonPropertiesForState:(id)a3
{
  ...
  UIColor *v42;
  UIColor *v43;
  SUUIItemOfferButtonProperties *v44;
  unsigned int v46;
  int64_t fillStyle;
  uint64_t v48;
  uint64_t v49;
  ...
  else
  {
    ...
    v37 = &OBJC_IVAR___SUUIItemOfferButton__titleAttributedString;
    if (v36)
      v37 = &OBJC_IVAR___SUUIItemOfferButton__confirmationTitleAttributedString;
...
LABEL_17:
  if (objc_msgSend(v4, "highlighted"))
  {
    ...
    else
    {
      ...
      {
        v32 = (void *)v23;
        SUUIColorByAdjustingBrightness(v20, -0.2);
  ...
  v44 = objc_alloc_init(SUUIItemOfferButtonProperties);
  -[SUUIItemOfferButtonProperties setHasBorderView:](v44, "setHasBorderView:", v48);
  -[SUUIItemOfferButtonProperties setBorderBackgroundColor:](v44, "setBorderBackgroundColor:", v20);
  -[SUUIItemOfferButtonProperties setBorderColor:](v44, "setBorderColor:", v34);
  -[SUUIItemOfferButtonProperties setBorderCompositingFilter:](v44, "setBorderCompositingFilter:", v32);
  -[SUUIItemOfferButtonProperties setBorderWidth:](v44, "setBorderWidth:", v26);
  -[SUUIItemOfferButtonProperties setBorderCornerRadius:](v44, "setBorderCornerRadius:", v22);
  -[SUUIItemOfferButtonProperties setBorderCornerRadiusMatchesHalfBoundingDimension:](v44, "setBorderCornerRadiusMatchesHalfBoundingDimension:", v19);
  -[SUUIItemOfferButtonProperties setHasTitleLabel:](v44, "setHasTitleLabel:", v49);
  -[SUUIItemOfferButtonProperties setAttributedText:](v44, "setAttributedText:", v53);
  -[SUUIItemOfferButtonProperties setTextColor:](v44, "setTextColor:", v13);
  -[SUUIItemOfferButtonProperties setUniversal:](v44, "setUniversal:", HIDWORD(v48));
  -[SUUIItemOfferButtonProperties setTitleStyle:](v44, "setTitleStyle:", titleStyle);
  -[SUUIItemOfferButtonProperties setConfirmationTitleStyle:](v44, "setConfirmationTitleStyle:", confirmationTitleStyle);
  -[SUUIItemOfferButtonProperties setImage:](v44, "setImage:", v24);
  -[SUUIItemOfferButtonProperties setBorderedImage:](v44, "setBorderedImage:", v25);
  -[SUUIItemOfferButtonProperties setProgressType:](v44, "setProgressType:", objc_msgSend(v4, "progressType"));
  -[SUUIItemOfferButtonProperties setProgressIndeterminate:](v44, "setProgressIndeterminate:", HIDWORD(v49));
  -[SUUIItemOfferButtonProperties setProgress:](v44, "setProgress:", self->_progress);
  -[SUUIItemOfferButtonProperties setAlpha:](v44, "setAlpha:", v5);
  -[SUUIItemOfferButtonProperties setCancelRecognizer:](v44, "setCancelRecognizer:", v52);
  -[SUUIItemOfferButtonProperties setRestores:](v44, "setRestores:", self->_downloadRestores);
...
- (id)_imageForProgressType:(int64_t)a3
{
  void (**centerImageProvider)(id, SUUIItemOfferButton *, int64_t);
  void *v6;
...
- (void)_transitionFromBorderedImage:(id)a3 toTitle:(id)a4 withDuration:(double)a5 completion:(id)a6
{
  ...
  -[SUUIItemOfferButton _adjustViewOrderingForProperties:](self, "_adjustViewOrderingForProperties:", v9);
  if (objc_msgSend(v9, "universal"))
  {
    -[SUUIItemOfferButton _insertUniversalView](self, "_insertUniversalView");
  }
  else
  {
...
{
  id v9;
  SUUICircleProgressIndicator *progressIndicator;
  id v11;
  SUUICircleProgressIndicator *v12;
  void *v13;
  SUUICircleProgressIndicator *v14;
  void *v15;
  id v16;
  _QWORD v17[5];
  id v18;
  ...
  -[SUUICircleProgressIndicator setIndeterminate:](self->_progressIndicator, "setIndeterminate:", objc_msgSend(v9, "progressIndeterminate"));
  v12 = self->_progressIndicator;
  -[SUUIItemOfferButton _imageForProgressType:](self, "_imageForProgressType:", objc_msgSend(v9, "progressType"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUICircleProgressIndicator setImage:](v12, "setImage:", v13);
...
- (void)_transitionFromTitleOrImage:(id)a3 toProgress:(id)a4 withDuration:(double)a5 completion:(id)a6
{
  ...
  UIView *v18;
  SUUICircleProgressIndicator *progressIndicator;
  SUUICircleProgressIndicator *v20;
  void *v21;
  void *v22;
  SUUICircleProgressIndicator *v23;
  void *v24;
  void *v25;
  UIImageView *universalImageView;
  UILabel *titleLabel;
  ...
  if (!self->_borderView)
  {
    -[SUUIItemOfferButton _insertBorderView](self, "_insertBorderView");
    -[UIView layer](self->_borderView, "layer");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SUUIItemOfferButton _insertProgressIndicator](self, "_insertProgressIndicator");
  progressIndicator = self->_progressIndicator;
  objc_msgSend(v11, "progress");
  -[SUUICircleProgressIndicator setProgress:](progressIndicator, "setProgress:");
  -[SUUICircleProgressIndicator setIndeterminate:](self->_progressIndicator, "setIndeterminate:", objc_msgSend(v11, "progressIndeterminate"));
  v20 = self->_progressIndicator;
  -[SUUIItemOfferButton buttonDescriptor](self, "buttonDescriptor");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIItemOfferButton _imageForProgressType:](self, "_imageForProgressType:", objc_msgSend(v21, "progressType"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUICircleProgressIndicator setImage:](v20, "setImage:", v22);
  ...
  -[SUUICircleProgressIndicator setHidden:](self->_progressIndicator, "setHidden:", 1);
  -[UIImageView removeFromSuperview](self->_universalImageView, "removeFromSuperview");
  universalImageView = self->_universalImageView;
  self->_universalImageView = 0;
  ...
  -[SUUIItemOfferButton _adjustViewOrderingForProperties:](self, "_adjustViewOrderingForProperties:", v11);
  v31 = MEMORY[0x24BDAC760];
  v32 = (void *)MEMORY[0x24BEBDB00];
  v45[0] = MEMORY[0x24BDAC760];
  v45[1] = 3221225472;
  v45[2] = __86__SUUIItemOfferButton__transitionFromTitleOrImage_toProgress_withDuration_completion___block_invoke;
  v45[3] = &unk_2511F46D0;
  v45[4] = self;
  v46 = v11;
  v42[0] = v31;
  v42[1] = 3221225472;
  v42[2] = __86__SUUIItemOfferButton__transitionFromTitleOrImage_toProgress_withDuration_completion___block_invoke_2;
  v42[3] = &unk_2511F9D98;
  v42[4] = self;
  v43 = v46;
  v44 = v12;
...
- (void)_transitionFromProgress:(id)a3 toTitleOrImage:(id)a4 withDuration:(double)a5 completion:(id)a6
{
  ...
  if (v18)
  {
    -[SUUIItemOfferButton _insertImageView](self, "_insertImageView");
  ...
  {
    -[SUUIItemOfferButton _insertLabel](self, "_insertLabel");
  ...
  -[SUUICircleProgressIndicator removeFromSuperview](self->_progressIndicator, "removeFromSuperview");
  progressIndicator = self->_progressIndicator;
  ...
  v44[1] = 3221225472;
  v44[2] = __86__SUUIItemOfferButton__transitionFromProgress_toTitleOrImage_withDuration_completion___block_invoke;
  v44[3] = &unk_2511F46D0;
  v45 = v11;
  v46 = self;
  v40[0] = v30;
  v40[1] = 3221225472;
  v40[2] = __86__SUUIItemOfferButton__transitionFromProgress_toTitleOrImage_withDuration_completion___block_invoke_2;
  v40[3] = &unk_2511F9D98;
  v41 = v45;
  v42 = self;
  v43 = v12;
...
LABEL_15:
      -[SUUIItemOfferButton insertSubview:aboveSubview:](self, "insertSubview:aboveSubview:", *p_borderView, *p_titleLabel);
      v4 = v9;
      goto LABEL_16;
    }
...
- (void)_insertProgressIndicator
{
  ...
  SUUICircleProgressIndicator *progressIndicator;
  SUUICircleProgressIndicator *v6;
  void *v7;
  ...
  if (!self->_progressIndicator)
  {
    ...
    -[SUUIItemOfferButton bounds](self, "bounds");
    v4 = -[SUUICircleProgressIndicator initWithFrame:](v3, "initWithFrame:");
    progressIndicator = self->_progressIndicator;
    self->_progressIndicator = v4;

    -[SUUICircleProgressIndicator setAutoresizingMask:](self->_progressIndicator, "setAutoresizingMask:", 18);
    v6 = self->_progressIndicator;
    objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUICircleProgressIndicator setBackgroundColor:](v6, "setBackgroundColor:", v7);

    -[SUUICircleProgressIndicator _setHidesBorderView:](self->_progressIndicator, "_setHidesBorderView:", 1);
    -[SUUICircleProgressIndicator setUserInteractionEnabled:](self->_progressIndicator, "setUserInteractionEnabled:", 0);
    -[SUUIItemOfferButton addSubview:](self, "addSubview:", self->_progressIndicator);
  }
}
...
- (void)_insertBorderView
{
  ...
  if (!self->_borderView)
  {
    ...
    -[SUUIItemOfferButton addSubview:](self, "addSubview:", self->_borderView);
  }
}
...
- (void)_insertLabel
{
  ...
  if (!self->_titleLabel)
  {
    ...
    -[SUUIItemOfferButton addSubview:](self, "addSubview:", self->_titleLabel);
    -[SUUIItemOfferButton layoutSubviews](self, "layoutSubviews");
  }
}
...
- (void)_insertImageView
{
  ...
  if (!self->_imageView)
  {
    ...
    -[SUUIItemOfferButton addSubview:](self, "addSubview:", self->_imageView);
  }
}
...
- (void)_insertBorderedImageView
{
  ...
  if (!self->_borderedImageView)
  {
    ...
    -[SUUIItemOfferButton addSubview:](self, "addSubview:", self->_borderedImageView);
  }
}
...
- (void)_insertUniversalView
{
  ...
  if (!self->_universalImageView)
  {
    ...
    v5 = (UIImageView *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD668]), "initWithImage:", v7);
    universalImageView = self->_universalImageView;
    self->_universalImageView = v5;

    -[SUUIItemOfferButton insertSubview:atIndex:](self, "insertSubview:atIndex:", self->_universalImageView, 0);
...
{
  SUUIFocusedTouchGestureRecognizer *v3;
  SUUIFocusedTouchGestureRecognizer *cancelGestureRecognizer;
  id v5;

  if (!self->_cancelGestureRecognizer)
  {
    v3 = -[SUUIFocusedTouchGestureRecognizer initWithFocusedView:touchAllowance:]([SUUIFocusedTouchGestureRecognizer alloc], "initWithFocusedView:touchAllowance:", self, -10.0, -10.0, -10.0, -10.0);
    cancelGestureRecognizer = self->_cancelGestureRecognizer;
    self->_cancelGestureRecognizer = v3;

    -[SUUIFocusedTouchGestureRecognizer addTarget:action:](self->_cancelGestureRecognizer, "addTarget:action:", self, sel__cancelGestureAction_);
  }
  -[SUUIItemOfferButton window](self, "window");
  v5 = (id)objc_claimAutoreleasedReturnValue();
...
- (void)_removeCancelGestureRecognizer
{
  SUUIFocusedTouchGestureRecognizer *cancelGestureRecognizer;
  void *v4;
  SUUIFocusedTouchGestureRecognizer *v5;

  cancelGestureRecognizer = self->_cancelGestureRecognizer;
  if (cancelGestureRecognizer)
  {
    -[SUUIFocusedTouchGestureRecognizer view](cancelGestureRecognizer, "view");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_reloadForCurrentState:(BOOL)a3
{
  ...
  UIImageView *v36;
  void *v37;
  SUUICircleProgressIndicator *v38;
  SUUICircleProgressIndicator *v39;
  void *v40;
  SUUICircleProgressIndicator *v41;
  SUUICircleProgressIndicator *v42;
  UIView *v43;
  __int128 v44;
  void *v45;
  UIView *borderView;
  ...
  if (!a3)
  {
    ...
    else
    {
      ...
      if ((v6 & 1) == 0)
      {
        -[SUUIItemOfferButton setClipsToBounds:](self, "setClipsToBounds:", 0);
  ...
  -[SUUIItemOfferButton setClipsToBounds:](self, "setClipsToBounds:", 1);
  ...
  v10 = (__int128 *)MEMORY[0x24BDBD8B8];
  if (v9)
  {
    -[SUUIItemOfferButton _insertBorderView](self, "_insertBorderView");
    -[UIView layer](self->_borderView, "layer");
  ...
  -[SUUIItemOfferButton _adjustViewOrderingForProperties:](self, "_adjustViewOrderingForProperties:", v8);
  ...
  if (v33)
  {
    -[SUUIItemOfferButton _insertBorderedImageView](self, "_insertBorderedImageView");
  ...
  {
    -[SUUIItemOfferButton _insertProgressIndicator](self, "_insertProgressIndicator");
    -[SUUICircleProgressIndicator layer](self->_progressIndicator, "layer");
    v37 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v37, "removeAllAnimations");

    v38 = self->_progressIndicator;
    objc_msgSend(v8, "progress");
    -[SUUICircleProgressIndicator setProgress:](v38, "setProgress:");
    -[SUUICircleProgressIndicator setIndeterminate:](self->_progressIndicator, "setIndeterminate:", objc_msgSend(v8, "progressIndeterminate"));
    v39 = self->_progressIndicator;
    -[SUUIItemOfferButton _imageForProgressType:](self, "_imageForProgressType:", objc_msgSend(v8, "progressType"));
    v40 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUICircleProgressIndicator setImage:](v39, "setImage:", v40);
  ...
  if ((objc_msgSend(v8, "cancelRecognizer") & 1) != 0)
    -[SUUIItemOfferButton _insertCancelGestureRecognizer](self, "_insertCancelGestureRecognizer");
  else
    -[SUUIItemOfferButton _removeCancelGestureRecognizer](self, "_removeCancelGestureRecognizer");
  -[SUUIItemOfferButton layer](self, "layer");
  v45 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  SUUIItemOfferButtonDelegate **p_delegate;
  id WeakRetained;
  char v5;
  id v6;
...
LABEL_7:
  ...
  else
  {
    ...
    if (self->_confirmationTitleAttributedString)
    {
      ...
      objc_msgSend(v10, "_titleSizeThatFitsForSize:titleStyle:mutableAttributedString:", v11, v12, *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
    ...
    {
      *p_confirmationTitleFitSize = *(CGSize *)MEMORY[0x24BDBF148];
    }
  }
  -[SUUIItemOfferButton _reloadForCurrentState:](self, "_reloadForCurrentState:", 0);
}
...
LABEL_7:
  ...
  else
  {
    ...
    {
      *p_titleFitSize = *(CGSize *)MEMORY[0x24BDBF148];
    }
  }
  -[SUUIItemOfferButton _reloadForCurrentState:](self, "_reloadForCurrentState:", 0);
}
...
{
  return (SUUIItemOfferButtonDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
