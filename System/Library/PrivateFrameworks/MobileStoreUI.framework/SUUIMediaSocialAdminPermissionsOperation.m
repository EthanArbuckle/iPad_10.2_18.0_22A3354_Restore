...
- (SUUIMediaSocialAdminPermissionsOperation)initWithClientContext:(id)a3
{
  ...
  SUUIMediaSocialAdminPermissionsOperation *v7;
  void *v8;
  objc_super v10;
  ...
  if (v6)
  {
    ...
    -[SUUIClientContext URLBag](v7->_clientContext, "URLBag");
...
void __55__SUUIMediaSocialAdminPermissionsOperation_outputBlock__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (void)main
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB7458]), "initWithURL:", v6);
    ...
    if (v19[5])
    {
      -[SUUIMediaSocialAdminPermissionsOperation _authorsWithResponseDictionary:](self, "_authorsWithResponseDictionary:");
  ...
  -[SUUIMediaSocialAdminPermissionsOperation outputBlock](self, "outputBlock");
...
- (id)_authorsWithResponseDictionary:(id)a3
{
  ...
  void *v48;
  uint64_t v49;
  SUUIMediaSocialAdminPermissionsOperation *v51;
  void *v52;
  void *v53;
  id v54;
  void *v55;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (v12)
    {
      ...
      do
      {
        for (i = 0; i != v13; ++i)
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            v17 = -[SUUIMediaSocialAuthor initWithAuthorDictionary:]([SUUIMediaSocialAuthor alloc], "initWithAuthorDictionary:", v16);
            -[SUUIMediaSocialAuthor identifier](v17, "identifier");
            ...
            if (v18)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB1EA0]), "initWithLookupDictionary:", v19);
                ...
                -[SUUIMediaSocialAuthor setName:](v17, "setName:", v24);

                objc_msgSend(v23, "URLWithHeight:width:", 125, 125);
                v25 = (void *)objc_claimAutoreleasedReturnValue();
                -[SUUIMediaSocialAuthor setThumbnailImageURL:](v17, "setThumbnailImageURL:", v25);

                v11 = v57;
                -[SUUIMediaSocialAuthor setStorePlatformData:](v17, "setStorePlatformData:", v19);

              }
              -[SUUIMediaSocialAuthor name](v17, "name");
    ...
    {
      -[SUUIMediaSocialAdminPermissionsOperation _lookupResponseForMissingAuthors:error:](v51, "_lookupResponseForMissingAuthors:error:", v56, 0);
...
- (id)_lookupResponseForMissingAuthors:(id)a3 error:(id *)a4
{
  ...
  v32 = 0;
  v7 = objc_alloc(MEMORY[0x24BEB2050]);
  ...
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEB2058]), "initWithPlatformContext:", v10);
  objc_msgSend(v11, "setKeyProfile:", *MEMORY[0x24BEB2770]);
