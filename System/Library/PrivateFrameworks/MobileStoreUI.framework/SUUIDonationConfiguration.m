...
- (SUUIDonationConfiguration)initWithOperationQueue:(id)a3 clientContext:(id)a4
{
  id v7;
  id v8;
  SUUIDonationConfiguration *v9;
  SUUIDonationConfiguration *v10;
  objc_super v12;
  ...
  v9 = -[SUUIDonationConfiguration init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (void)loadConfigurationWithCompletionBlock:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SUUIDonationConfiguration.m"), 71, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block != nil"));
  ...
  v9 = v6;
  v12 = v9;
  objc_msgSend(v7, "loadValueForKey:completionBlock:", CFSTR("charityGiftPageData"), v11);
...
- (void)_finishLoadWithResponse:(id)a3 error:(id)a4 block:(id)a5
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
      ...
      if (v14)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v19 = -[SUUIGiftCharity initWithCharityDictionary:]([SUUIGiftCharity alloc], "initWithCharityDictionary:", v18);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v23 = (NSURL *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v22);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v26 = (NSURL *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF48]), "initWithString:", v25);
