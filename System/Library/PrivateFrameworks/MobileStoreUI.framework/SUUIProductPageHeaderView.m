...
- (SUUIProductPageHeaderView)initWithClientContext:(id)a3
{
  ...
  v6 = -[SUUIProductPageHeaderView init](&v17, sel_init);
  v7 = v6;
  if (v6)
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BEBD640], "kitImageNamed:", CFSTR("UIButtonBarAction"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      v9 = (UIButton *)objc_alloc_init(MEMORY[0x24BEBD430]);
      ...
      if (!v13)
      {
        -[SUUIProductPageHeaderView tintColor](v7, "tintColor");
      ...
      if (!v13)
      -[SUUIProductPageHeaderView addSubview:](v7, "addSubview:", v7->_shareButton);
...
- (void)dealloc
{
  ...
  if (contentRatingArtworkLoader)
    -[SUUIContentRatingArtworkResourceLoader removeObserver:](contentRatingArtworkLoader, "removeObserver:", self);
  v4.receiver = self;
  v4.super_class = (Class)SUUIProductPageHeaderView;
  -[SUUIProductPageHeaderView dealloc](&v4, sel_dealloc);
}
...
{
  return -[SUUIItemContentRating contentRatingName](self->_contentRating, "contentRatingName");
}
...
- (void)setAgeBandString:(id)a3
{
  ...
  v18 = a3;
  -[SUUIProductPageHeaderView ageBandString](self, "ageBandString");
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (v18)
    {
      if (!ageBandLabel)
      {
        ...
        -[SUUIProductPageHeaderView backgroundColor](self, "backgroundColor");
        ...
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_ageBandLabel);
        ageBandLabel = self->_ageBandLabel;
        v6 = v18;
      }
    ...
    -[SUUIProductPageHeaderView setNeedsLayout](self, "setNeedsLayout");
    v6 = v18;
  }
...
- (void)setArtistName:(id)a3
{
  ...
  v19 = a3;
  -[SUUIProductPageHeaderView artistName](self, "artistName");
  ...
  if (v4 != v19 && (objc_msgSend(v4, "isEqualToString:", v19) & 1) == 0)
  {
    ...
    if (v19)
    {
      if (!artistButton)
      {
        v6 = -[SUUILinkButton initWithArrowStyle:]([SUUILinkButton alloc], "initWithArrowStyle:", 1);
        ...
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_artistButton);
        artistButton = self->_artistButton;
      }
...
{
  SUUIContentRatingArtworkResourceLoader *v5;
  SUUIContentRatingArtworkResourceLoader *contentRatingArtworkLoader;
  SUUIContentRatingArtworkResourceLoader *v7;

  v5 = (SUUIContentRatingArtworkResourceLoader *)a3;
  contentRatingArtworkLoader = self->_contentRatingArtworkLoader;
...
- (void)setColorScheme:(id)a3
{
  ...
  void *v15;
  void *v16;
  SUUIProductPageHeaderLabel *titleLabel;
  void *v18;
  void *v19;
  ...
  if (self->_colorScheme != v5)
  {
    ...
    -[SUUIProductPageHeaderView setBackgroundColor:](self, "setBackgroundColor:", v7);
    ...
    if (v18)
    {
      -[SUUIProductPageHeaderLabel setTextColor:](titleLabel, "setTextColor:", v18);
    }
    else
    {
      objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithWhite:alpha:", 0.0, 1.0);
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIProductPageHeaderLabel setTextColor:](titleLabel, "setTextColor:", v19);
    ...
    if (v24)
    {
      -[SUUIBadgeLabel setBackgroundColor:](editorialBadgeLabel, "setBackgroundColor:", v24);
    }
    else
    {
      +[SUUIBadgeLabel defaultBackgroundColor](SUUIBadgeLabel, "defaultBackgroundColor");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIBadgeLabel setBackgroundColor:](editorialBadgeLabel, "setBackgroundColor:", v25);
    ...
    if (!v28)
    {
      -[SUUIProductPageHeaderView tintColor](self, "tintColor");
...
{
  SUUIItemContentRating *v5;
  SUUIProductPageHeaderLabel *titleLabel;
  void *v7;
  SUUIItemContentRating *v8;

  v5 = (SUUIItemContentRating *)a3;
  if (self->_contentRating != v5)
  {
    v8 = v5;
    objc_storeStrong((id *)&self->_contentRating, a3);
    titleLabel = self->_titleLabel;
    -[SUUIItemContentRating contentRatingName](self->_contentRating, "contentRatingName");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIProductPageHeaderLabel setContentRating:](titleLabel, "setContentRating:", v7);
...
- (void)setEditorialBadge:(id)a3
{
  ...
  if (v4 != v15 && (objc_msgSend(v4, "isEqualToString:", v15) & 1) == 0)
  {
    ...
    if (v15)
    {
      if (!editorialBadgeLabel)
      {
        ...
        else
        {
          ...
          v11 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIBadgeLabel setTextColor:](v8, "setTextColor:", v11);
        ...
        if (v13)
        {
          -[SUUIBadgeLabel setBackgroundColor:](v12, "setBackgroundColor:", v13);
        }
        else
        {
          +[SUUIBadgeLabel defaultBackgroundColor](SUUIBadgeLabel, "defaultBackgroundColor");
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIBadgeLabel setBackgroundColor:](v12, "setBackgroundColor:", v14);

        }
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_editorialBadgeLabel);
        editorialBadgeLabel = self->_editorialBadgeLabel;
      }
    ...
    {
      -[SUUIBadgeLabel removeFromSuperview](editorialBadgeLabel, "removeFromSuperview");
  ...
  if (v4 != v12)
  {
    ...
    if (v12)
    {
      if (!headerImageView)
      {
        ...
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_headerImageView);
        headerImageView = self->_headerImageView;
      }
  ...
  if (v4 != v12)
  {
    ...
    if (v12)
    {
      if (!iconImageView)
      {
        ...
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_iconImageView);
        iconImageView = self->_iconImageView;
      }
  ...
  if (v4 != v16 && (objc_msgSend(v4, "isEqualToString:", v16) & 1) == 0)
  {
    ...
    if (v16)
    {
      if (!inAppPurchasesLabel)
      {
        ...
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_inAppPurchasesLabel);
        inAppPurchasesLabel = self->_inAppPurchasesLabel;
      }
...
- (void)setItemOffer:(id)a3
{
  ...
  if (self->_itemOffer != v5)
  {
    ...
    -[SUUIProductPageHeaderView _reloadItemOfferButton:](self, "_reloadItemOfferButton:", 0);
    v5 = v6;
  }
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (v17)
    {
      if (!itemOfferExplanationLabel)
      {
        ...
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_itemOfferExplanationLabel);
        itemOfferExplanationLabel = self->_itemOfferExplanationLabel;
      }
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (v17)
    {
      if (!itemOfferExplanationTitleLabel)
      {
        ...
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_itemOfferExplanationTitleLabel);
        itemOfferExplanationTitleLabel = self->_itemOfferExplanationTitleLabel;
      }
...
{
  -[SUUIProductPageHeaderView setItemState:animated:](self, "setItemState:animated:", a3, 0);
}
...
- (void)setItemState:(id)a3 animated:(BOOL)a4
{
  ...
  if (self->_itemState != a3)
  {
    ...
    -[SUUIProductPageHeaderView _reloadItemOfferButton:](self, "_reloadItemOfferButton:", v4);
  }
}
...
LABEL_14:
    ...
    else
    {
      ...
      -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_userRatingLabel);
    ...
    if (clientContext)
      -[SUUIClientContext localizedStringForKey:](clientContext, "localizedStringForKey:", CFSTR("NO_RATINGS"));
    else
...
- (void)setTitle:(id)a3
{
  id v4;
  SUUIProductPageHeaderLabel *titleLabel;
  SUUIProductPageHeaderLabel *v6;
  SUUIProductPageHeaderLabel *v7;
  SUUIProductPageHeaderLabel *v8;
  void *v9;
  void *v10;
  SUUIProductPageHeaderLabel *v11;
  void *v12;
  void *v13;
  SUUIProductPageHeaderLabel *v14;
  void *v15;
  void *v16;
  SUUIProductPageHeaderLabel *v17;
  id v18;

  v18 = a3;
  -[SUUIProductPageHeaderLabel text](self->_titleLabel, "text");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  if (v4 != v18 && (objc_msgSend(v4, "isEqualToString:", v18) & 1) == 0)
  {
    ...
    if (v18)
    {
      if (!titleLabel)
      {
        ...
        -[SUUIProductPageHeaderLabel setIsPad:](self->_titleLabel, "setIsPad:", SUUIUserInterfaceIdiom(self->_clientContext) == 1);
        v8 = self->_titleLabel;
        if (self->_headerImageHeight == 0.0)
          -[SUUIProductPageHeaderView backgroundColor](self, "backgroundColor");
        else
          objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        -[SUUIProductPageHeaderLabel setBackgroundColor:](v8, "setBackgroundColor:", v10);
        ...
        if (v12)
        {
          -[SUUIProductPageHeaderLabel setRatingColor:](v11, "setRatingColor:", v12);
        }
        else
        {
          objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithWhite:alpha:", 0.62745098, 1.0);
          v13 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIProductPageHeaderLabel setRatingColor:](v11, "setRatingColor:", v13);
        ...
        if (v15)
        {
          -[SUUIProductPageHeaderLabel setTextColor:](v14, "setTextColor:", v15);
        }
        else
        {
          objc_msgSend(MEMORY[0x24BEBD4B8], "colorWithWhite:alpha:", 0.0, 1.0);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          -[SUUIProductPageHeaderLabel setTextColor:](v14, "setTextColor:", v16);

        }
        -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_titleLabel);
        titleLabel = self->_titleLabel;
      }
      -[SUUIProductPageHeaderLabel setText:](titleLabel, "setText:");
      v17 = self->_titleLabel;
      -[SUUIProductPageHeaderView contentRatingName](self, "contentRatingName");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIProductPageHeaderLabel setContentRating:](v17, "setContentRating:", v9);
    }
    else
    {
      -[SUUIProductPageHeaderLabel removeFromSuperview](titleLabel, "removeFromSuperview");
      v9 = self->_titleLabel;
      self->_titleLabel = 0;
    }
...
- (void)setSecondaryContentRating:(id)a3
{
  ...
  v4 = a3;
  -[SUUIContentRatingArtworkResourceLoader cachedImageForContentRating:withClientContext:](self->_contentRatingArtworkLoader, "cachedImageForContentRating:withClientContext:", v4, self->_clientContext);
  ...
  if (v5)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIProductPageHeaderLabel setSecondaryContentRatingImages:](titleLabel, "setSecondaryContentRatingImages:", v8);

    -[SUUIProductPageHeaderView setNeedsLayout](self, "setNeedsLayout");
  }
  else
  {
    -[SUUIContentRatingArtworkResourceLoader loadImageForContentRating:clientContent:reason:](self->_contentRatingArtworkLoader, "loadImageForContentRating:clientContent:reason:", v4, self->_clientContext, 1);
  }
...
- (void)setUserRating:(double)a3
{
  ...
  if (self->_userRating != a3 || !self->_userRatingStarsView)
  {
    ...
    if (!self->_userRatingStarsView)
    {
      ...
      -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_userRatingStarsView);
    }
...
- (NSString)title
{
  return -[SUUIProductPageHeaderLabel text](self->_titleLabel, "text");
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIItemOfferButton layer](self->_itemOfferButton, "layer");
  ...
  -[SUUIProductPageHeaderView bounds](self, "bounds");
  v7 = v6;
  ...
  v82 = &v90;
  v26 = MinX - v10;
  -[SUUIProductPageHeaderView _getTopLayoutProperties:origins:height:forWidth:](self, "_getTopLayoutProperties:origins:height:forWidth:", &v83, &v82, &v81, MinX - v10);
  titleLabel = self->_titleLabel;
  if (titleLabel)
  ...
  v82 = v84;
  v80 = 0.0;
  -[SUUIProductPageHeaderView _getBottomLayoutProperties:origins:height:forWidth:](self, "_getBottomLayoutProperties:origins:height:forWidth:", &v83, &v82, &v80, v26);
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIProductPageHeaderView setBackgroundColor:](&v13, sel_setBackgroundColor_, v4);
  artistButton = self->_artistButton;
  if (self->_headerImageHeight == 0.0)
    -[SUUIProductPageHeaderView backgroundColor](self, "backgroundColor");
  else
  ...
  if (self->_headerImageHeight == 0.0)
    ...
    objc_msgSend(MEMORY[0x24BEBD4B8], "clearColor");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIProductPageHeaderLabel setBackgroundColor:](titleLabel, "setBackgroundColor:", v10);
  ...
  if (v4)
  {
    -[SUUIBadgeLabel setTextColor:](editorialBadgeLabel, "setTextColor:", v4);
  }
  else
  {
    +[SUUIBadgeLabel defaultTextColor](SUUIBadgeLabel, "defaultTextColor");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[SUUIBadgeLabel setTextColor:](editorialBadgeLabel, "setTextColor:", v12);
...
- (void)sizeToFit
{
  ...
  -[SUUIProductPageHeaderView frame](self, "frame");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v9 = v7 + -30.0;
  ...
  if (shareButton)
  {
    -[UIButton sizeThatFits:](shareButton, "sizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
    v9 = v9 - v13;
  }
  ...
  v30 = 0.0;
  v31 = v36;
  -[SUUIProductPageHeaderView _getTopLayoutProperties:origins:height:forWidth:](self, "_getTopLayoutProperties:origins:height:forWidth:", &v32, &v31, &v30, v9);
  ...
  v31 = v33;
  v29 = 0.0;
  -[SUUIProductPageHeaderView _getBottomLayoutProperties:origins:height:forWidth:](self, "_getBottomLayoutProperties:origins:height:forWidth:", &v32, &v31, &v29, v9);
  headerImageHeight = self->_headerImageHeight;
  v15 = v30 + 7.0 + v29;
  ...
  {
    v21 = *(double *)(MEMORY[0x24BDBF028] + 16);
    v22 = *(double *)(MEMORY[0x24BDBF028] + 24);
...
- (void)itemOfferButtonWillAnimateTransition:(id)a3
{
  ...
  -[SUUIItemOfferButton frame](self->_itemOfferButton, "frame", a3);
  v5 = v4;
  v7 = v6;
  ...
  -[SUUIProductPageHeaderView performSelector:withObject:afterDelay:](self, "performSelector:withObject:afterDelay:", sel__finishButtonAnimation, 0, 1.0);
}
...
{
  -[SUUIProductPageHeaderView bringSubviewToFront:](self, "bringSubviewToFront:", self->_itemOfferButton);
...
- (void)_reloadItemOfferButton:(BOOL)a3
{
  ...
  SUUIItemOfferButton *v9;
  void *v10;
  double v11;

  if (self->_itemOffer && (v4 = a3, !-[SUUIProductPageHeaderView isRestricted](self, "isRestricted")))
  {
    itemOfferButton = self->_itemOfferButton;
    if (!itemOfferButton)
    {
      +[SUUIItemOfferButton itemOfferButtonWithAppearance:](SUUIItemOfferButton, "itemOfferButtonWithAppearance:", 0);
      v7 = (SUUIItemOfferButton *)objc_claimAutoreleasedReturnValue();
      v8 = self->_itemOfferButton;
      self->_itemOfferButton = v7;

      -[SUUIItemOfferButton addTarget:action:forControlEvents:](self->_itemOfferButton, "addTarget:action:forControlEvents:", self, sel__cancelConfirmationAction_, 0x10000);
      -[SUUIItemOfferButton addTarget:action:forControlEvents:](self->_itemOfferButton, "addTarget:action:forControlEvents:", self, sel__showConfirmationAction_, 0x40000);
      v9 = self->_itemOfferButton;
      -[SUUIProductPageHeaderView backgroundColor](self, "backgroundColor");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUIItemOfferButton setBackgroundColor:](v9, "setBackgroundColor:", v10);
      ...
      -[SUUIProductPageHeaderView addSubview:](self, "addSubview:", self->_itemOfferButton);
      itemOfferButton = self->_itemOfferButton;
    }
    if (-[SUUIItemOfferButton setValuesUsingItemOffer:itemState:clientContext:animated:](itemOfferButton, "setValuesUsingItemOffer:itemState:clientContext:animated:", self->_itemOffer, self->_itemState, self->_clientContext, v4))
    {
  ...
  else
  {
    -[SUUIItemOfferButton setDelegate:](self->_itemOfferButton, "setDelegate:", 0);
    -[SUUIItemOfferButton removeTarget:action:forControlEvents:](self->_itemOfferButton, "removeTarget:action:forControlEvents:", self, 0, 0xFFFFFFFFLL);
    -[SUUIItemOfferButton removeFromSuperview](self->_itemOfferButton, "removeFromSuperview");
...
- (void)_getTopLayoutProperties:(id *)a3 origins:(double *)a4 height:(double *)a5 forWidth:(double)a6
{
  ...
  if (titleLabel)
  {
    ...
    *(_QWORD *)v12 = v13;
    *((_QWORD *)v12 + 1) = v14;
    *((_OWORD *)v12 + 1) = xmmword_241EFC970;
  ...
  if (artistButton)
  {
    ...
    *((_QWORD *)v16 + 6) = v17;
    *((_QWORD *)v16 + 7) = v18;
    *((_OWORD *)v16 + 4) = xmmword_241EFC980;
  ...
  SUUIGetLayoutProperties((uint64_t)*a3, 5, a4, a5);
}
