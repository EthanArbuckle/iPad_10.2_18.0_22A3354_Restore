...
{
  SUUITracklistPageSection *v3;
  SUUITracklistPageSection *v4;
  objc_super v6;
  ...
  v4 = v3;
  if (v3)
    -[SUUITracklistPageSection _reloadEntityProvider](v3, "_reloadEntityProvider");
  return v4;
}
...
- (void)addImpressionsForIndexPath:(id)a3 toSession:(id)a4
{
  ...
  -[SUUITracklistPageSection _viewElementForIndex:](self, "_viewElementForIndex:", v10);
...
- (int64_t)applyUpdateType:(int64_t)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SUUITracklistPageSection;
  v4 = -[SUUIStorePageSection applyUpdateType:](&v6, sel_applyUpdateType_, a3);
  if (v4 != (id)2)
    -[SUUITracklistPageSection _reloadEntityProvider](self, "_reloadEntityProvider");
  return (int64_t)v4;
}
...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  v4 = a3;
  -[SUUITracklistPageSection _viewElementForIndex:](self, "_viewElementForIndex:", objc_msgSend(v4, "item"));
  ...
  else
  {
    ...
    -[SUUIStorePageSection backgroundColorForIndexPath:](&v12, sel_backgroundColorForIndexPath_, v4);
...
- (id)cellForIndexPath:(id)a3
{
  ...
  if (v6)
  {
    if (objc_msgSend(v6, "elementType") == 146)
    {
      ...
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      v9 = (uint64_t *)&SUUITracklistLockupCollectionViewCellReuseIdentifier;
    }
    else
    {
      -[SUUIStorePageSection pageComponent](self, "pageComponent");
  ...
  else
  {
    ...
    objc_msgSend(v10, "dequeueReusableCellWithReuseIdentifier:forIndexPath:", 0x251202E88, v4);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  -[SUUITracklistPageSection _viewElementForIndex:](self, "_viewElementForIndex:", v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v9;
  if (v9)
  {
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  {
    objc_msgSend(v5, "dispatchEvent:eventAttribute:canBubble:isCancelable:extraInfo:completionBlock:", 0x251210D08, 0x251210D28, 1, 0, 0, 0);
  }
  -[SUUIStorePageSection context](self, "context", v12, v13, v14, v15, v16);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)collectionViewWillScrollToOffset:(CGPoint)a3 visibleRange:(SUUIIndexPathRange *)a4
{
  ...
  y = a3.y;
  x = a3.x;
  v8 = -[SUUITracklistPageSection numberOfCells](self, "numberOfCells");
...
- (void)collectionViewDidEndDisplayingCellForItemAtIndexPath:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)SUUITracklistPageSection;
  -[SUUIStorePageSection collectionViewDidEndDisplayingCellForItemAtIndexPath:](&v10, sel_collectionViewDidEndDisplayingCellForItemAtIndexPath_, v4);
...
- (void)entityProvider:(id)a3 didInvalidateWithContext:(id)a4
{
  ...
  v7 = a4;
  v8 = a3;
  -[SUUITracklistPageSection _requestCellLayoutWithColumnData:](self, "_requestCellLayoutWithColumnData:", columnData);
  v9.receiver = self;
  v9.super_class = (Class)SUUITracklistPageSection;
  -[SUUIStorePageSection entityProvider:didInvalidateWithContext:](&v9, sel_entityProvider_didInvalidateWithContext_, v8, v7);
...
- (id)firstAppearanceIndexPath
{
  ...
  v3 = -[SUUITracklistPageSection numberOfCells](self, "numberOfCells");
  if (v3 < 1)
  {
    v7 = 0;
  }
  else
  {
    ...
    do
    {
      -[SUUITracklistPageSection _viewElementForIndex:](self, "_viewElementForIndex:", v5 - 1);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v6, "elementType") == 146 && objc_msgSend(v6, "isSelected"))
      {
        objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", v5 - 1, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
        v7 = (void *)objc_claimAutoreleasedReturnValue();
      }
      else
      {
...
- (void)getModalSourceViewForViewElement:(id)a3 completionBlock:(id)a4
{
  ...
  char v11;
  void *v12;
  SUUIModalSourceViewProvider *v13;
  void *v14;
  void *v15;
  void *v16;
  void *v17;
  ...
  v7 = -[SUUITracklistPageSection numberOfCells](self, "numberOfCells");
  if (v7 < 1)
  {
LABEL_5:
    v12 = 0;
LABEL_6:
  ...
  while (1)
  {
    -[SUUITracklistPageSection _viewElementForIndex:](self, "_viewElementForIndex:", v9);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD15D8], "indexPathForItem:inSection:", v9, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v12)
    goto LABEL_6;
  v13 = objc_alloc_init(SUUIModalSourceViewProvider);
  -[SUUIModalSourceViewProvider setUserInfo:](v13, "setUserInfo:", v20);
  -[SUUIStorePageSection context](self, "context");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v18)
    ...
    v19 = v16;
  -[SUUIModalSourceViewProvider setOriginalSourceView:](v13, "setOriginalSourceView:", v19);
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  v5 = -[SUUITracklistPageSection numberOfCells](self, "numberOfCells");
...
- (void)reloadCellWithIndexPath:(id)a3 reason:(int64_t)a4
{
  ...
  if (v7)
  {
    objc_msgSend(v5, "activePageWidth");
    v9 = v8;
    -[SUUITracklistPageSection _viewElementForIndex:](self, "_viewElementForIndex:", objc_msgSend(v11, "item"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)requestLayoutWithReloadReason:(int64_t)a3
{
  ...
  v9 = v8;
  -[SUUITracklistColumnData columnForIdentifier:](self->_columnData, "columnForIdentifier:", 1);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9 != v11)
  {
    ...
    -[SUUITracklistPageSection _requestCellLayoutWithColumnData:](self, "_requestCellLayoutWithColumnData:", self->_columnData);
  }
...
void __58__SUUITracklistPageSection_requestLayoutWithReloadReason___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v5[1] = 3221225472;
  v5[2] = __58__SUUITracklistPageSection_requestLayoutWithReloadReason___block_invoke_2;
  v5[3] = &unk_2511F7E60;
  v6 = v3;
...
- (UIEdgeInsets)sectionContentInset
{
  ...
  -[SUUIStorePageSection sectionContentInset](&v22, sel_sectionContentInset);
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
...
- (void)willAppearInContext:(id)a3
{
  ...
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x2512028C8);
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), CFSTR("SUUITracklistLockupCollectionViewCellReuseIdentifier"));
  objc_msgSend(v5, "registerClass:forCellWithReuseIdentifier:", objc_opt_class(), 0x251212528);
  columnData = self->_columnData;
  self->_columnData = 0;

  v7 = self->_cellLayoutContext;
  v8 = -[SUUIViewElementLayoutContext initWithStorePageSectionContext:previousLayoutContext:]([SUUIViewElementLayoutContext alloc], "initWithStorePageSectionContext:previousLayoutContext:", v4, v7);
  ...
  -[SUUITracklistPageSection _columnData](self, "_columnData");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[SUUIViewElementLayoutContext setAggregateValue:forKey:](self->_cellLayoutContext, "setAggregateValue:forKey:", v10, 0x251203C28);
  objc_msgSend(v4, "activePageWidth");
  objc_msgSend(v10, "adjustColumnsToFitWidth:");
  -[SUUITracklistPageSection _requestCellLayoutWithColumnData:](self, "_requestCellLayoutWithColumnData:", v10);
  v11.receiver = self;
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  -[SUUIViewElementLayoutContext setAggregateValue:forKey:](self->_cellLayoutContext, "setAggregateValue:forKey:", self->_columnData, 0x251203C28);
  -[SUUITracklistPageSection _requestCellLayoutWithColumnData:](self, "_requestCellLayoutWithColumnData:", self->_columnData);
  v10.receiver = self;
  v10.super_class = (Class)SUUITracklistPageSection;
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  v11 = v7;
  v12 = v9;
  -[SUUITracklistPageSection _enumerateVisibleViewElementsUsingBlock:](self, "_enumerateVisibleViewElementsUsingBlock:", v13);
...
- (id)_columnData
{
  ...
  if (!columnData)
  {
    ...
    v30[1] = 3221225472;
    v30[2] = __39__SUUITracklistPageSection__columnData__block_invoke;
    v30[3] = &unk_2511F7F00;
    v30[4] = self;
    v33 = v34;
    v9 = v6;
    ...
    SUUIFontLimitedPreferredFontForTextStyle(20, 5);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v20 = v8;
    v21 = 3221225472;
    v22 = __39__SUUITracklistPageSection__columnData__block_invoke_3;
    v23 = &unk_2511F7F28;
    v14 = v10;
    v29 = v34;
    v24 = v14;
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    if (v18)
      -[SUUITracklistColumnData enumerateColumnsForHeader:usingBlock:](self->_columnData, "enumerateColumnsForHeader:usingBlock:", v18, &__block_literal_global_19);
...
void __39__SUUITracklistPageSection__columnData__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v5)
  {
    v6 = -[SUUITracklistColumnData initWithRepresentativeTrack:]([SUUITracklistColumnData alloc], "initWithRepresentativeTrack:", v3);
    v7 = *(_QWORD *)(a1 + 32);
    v8 = *(void **)(v7 + 96);
    *(_QWORD *)(v7 + 96) = v6;
...
void __39__SUUITracklistPageSection__columnData__block_invoke_2(uint64_t a1, void *a2, void *a3, uint64_t a4)
{
  ...
  else
  {
    if (v8)
    {
      v9 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithUnsignedInteger:", a4);
...
LABEL_4:
    ...
    case 2:
      ...
      v9 = (SUUIBarRatingView *)objc_msgSend(v8, "initWithObjectsAndKeys:", *(_QWORD *)(a1 + 56), *MEMORY[0x24BEBB360], 0);
    ...
    case 3:
      ...
      -[SUUIBarRatingView sizeThatFits:](v9, "sizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
      *(float *)&v13 = v13;
    ...
    case 5:
      ...
      v9 = (SUUIBarRatingView *)objc_msgSend(v14, "initWithObjectsAndKeys:", *(_QWORD *)(a1 + 64), *MEMORY[0x24BEBB360], 0);
      v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1458]), "initWithString:attributes:", v6, v9);
      objc_msgSend(v10, "size");
      v12 = ceil(v15);
      break;
...
void __39__SUUITracklistPageSection__columnData__block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    +[SUUITracklistHeaderCollectionViewCell sizeForHeaderTitleLabel:](SUUITracklistHeaderCollectionViewCell, "sizeForHeaderTitleLabel:", v4);
    v6 = v5;
    objc_msgSend(v10, "preferredWidth");
    v8 = v6;
    v9 = ceilf(v8);
...
- (void)_reloadEntityProvider
{
  ...
  v4 = (SUUIEntityProviding *)objc_claimAutoreleasedReturnValue();
  p_entityProvider = &self->_entityProvider;
  if (*p_entityProvider != v4 && (-[SUUIEntityProviding isEqual:](*p_entityProvider, "isEqual:", v4) & 1) == 0)
...
- (id)_representativeStringForViewElement:(id)a3
{
  ...
  if (v5 > 89)
  {
    if (v5 == 90)
    {
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUUITracklistPageSection _representativeStringForViewElement:](self, "_representativeStringForViewElement:", v10);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_requestCellLayoutWithColumnData:(id)a3
{
  ...
  v14 = -[SUUITracklistPageSection numberOfCells](self, "numberOfCells");
  if (v14 >= 1)
  {
    v15 = v14;
    v16 = 0;
    ...
    do
    {
      ...
      -[SUUITracklistPageSection _viewElementForIndex:](self, "_viewElementForIndex:", v16);
    ...
    for (i = 0; i != v4; ++i)
    {
      ...
      if (v9)
      {
        ...
        if ((_DWORD)v11)
        {
          ...
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          +[SUUIItemOfferButton localizedTitleForItemState:clientContext:](SUUIItemOfferButton, "localizedTitleForItemState:clientContext:", v12, v15);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
      ...
      {
        case 141:
          if (+[SUUIStyledButton usesItemOfferAppearanceForButtonType:itemState:](SUUIStyledButton, "usesItemOfferAppearanceForButtonType:itemState:", 1, v12))
          {
            v18 = v16;
          }
          else
          ...
          if (!v45)
          {
            ...
            SUUIViewElementFontWithStyle(v21);
...
LABEL_33:
        ...
        case 13:
          ...
          if (objc_msgSend(v8, "buttonViewType") == 3)
          {
            ...
            +[SUUIItemOfferButton cloudImageWithTintColor:arrowTintColor:](SUUIItemOfferButton, "cloudImageWithTintColor:arrowTintColor:", v22, v23);
...
LABEL_37:
  ...
  if (v46)
  {
    ...
    -[SUUIItemOfferButton setTitle:](v34, "setTitle:", v46);
    -[SUUIItemOfferButton sizeThatFits:](v34, "sizeThatFits:", *(double *)(MEMORY[0x24BDBF028] + 16), *(double *)(MEMORY[0x24BDBF028] + 24));
    *(float *)&v35 = v35;
    v32 = ceilf(*(float *)&v35);
  ...
  if (v5)
  {
    ...
    v37 = objc_alloc(MEMORY[0x24BDBCE70]);
    v38 = (void *)objc_msgSend(v37, "initWithObjectsAndKeys:", v36, *MEMORY[0x24BEBB360], 0);
    v39 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1458]), "initWithString:attributes:", v5, v38);
