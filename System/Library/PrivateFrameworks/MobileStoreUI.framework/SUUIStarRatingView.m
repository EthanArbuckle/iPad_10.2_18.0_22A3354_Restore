  ...
  if (v4 != v12)
  {
    ...
    if (v12)
    {
      if (!ratingStarsImageView)
      {
        ...
        -[SUUIStarRatingView backgroundColor](self, "backgroundColor");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        -[UIImageView setBackgroundColor:](v9, "setBackgroundColor:", v10);

        -[SUUIStarRatingView addSubview:](self, "addSubview:", self->_ratingStarsImageView);
        ratingStarsImageView = self->_ratingStarsImageView;
      }
      v11 = v12;
    }
...
- (UILabel)textLabel
{
  ...
  if (!textLabel)
  {
    ...
    -[SUUIStarRatingView addSubview:](self, "addSubview:", self->_textLabel);
    textLabel = self->_textLabel;
  }
  return textLabel;
}
...
- (void)layoutSubviews
{
  ...
  -[SUUIStarRatingView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  -[UIImageView image](self->_ratingStarsImageView, "image");
...
- (void)setBackgroundColor:(id)a3
{
  ...
  -[SUUIStarRatingView setBackgroundColor:](&v6, sel_setBackgroundColor_, v5);
