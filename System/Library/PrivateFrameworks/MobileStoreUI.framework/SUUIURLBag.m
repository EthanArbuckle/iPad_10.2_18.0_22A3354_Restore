...
uint64_t __22__SUUIURLBag_bagQueue__block_invoke()
{
  ...
  v0 = objc_alloc_init(MEMORY[0x24BEC8BE8]);
...
{
  objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB0], CFSTR("+[SUUIURLBag URLBagForContext:] is not supported"));
  return 0;
}
...
- (id)valueForKey:(id)a3 error:(id *)a4
{
  ...
  v8 = v7;
  v13 = v8;
  -[SUUIURLBag loadValueForKey:completionBlock:](self, "loadValueForKey:completionBlock:", v6, v12);
...
void __35__SUUIURLBag_existingBagDictionary__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
void __34__SUUIURLBag_storeFrontIdentifier__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (void)_enqueueOperationWithContext:(id)a3 completionBlock:(id)a4
{
  ...
  if (!self->_operation)
  {
    ...
    v14 = (ISLoadURLBagOperation *)objc_msgSend(objc_alloc(MEMORY[0x24BEC8BB8]), "initWithBagContext:", v6);
