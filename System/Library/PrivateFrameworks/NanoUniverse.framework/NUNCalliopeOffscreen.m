...
- (NUNCalliopeOffscreen)initWithDevice:(id)a3 width:(int)a4 height:(int)a5 texture0:(id)a6 texture1:(id)a7 loadAction:(unint64_t)a8 clearColor0:(id)a9 clearColor1:(id)a10
{
  ...
  v25 = -[NUNCalliopeOffscreen init](&v36, sel_init);
  v26 = v25;
  if (v25)
  {
    v25->_width = a4;
...
- (NUNCalliopeOffscreen)initWithDevice:(id)a3 width:(int)a4 height:(int)a5 pixelFormat0:(unint64_t)a6 pixelFormat1:(unint64_t)a7 mipmaps:(int)a8 loadAction:(unint64_t)a9 clearColor0:(id)a10 clearColor1:(id)a11
{
  ...
  v23 = a10.var0;
  v25 = a3;
  _NUNCalliopeCreateTexture(v25, v15, v14, a8, a6, 0);
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  _NUNCalliopeCreateTexture(v25, v15, v14, a8, a7, 0);
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v28 = -[NUNCalliopeOffscreen initWithDevice:width:height:texture0:texture1:loadAction:clearColor0:clearColor1:](self, "initWithDevice:width:height:texture0:texture1:loadAction:clearColor0:clearColor1:", v25, v15, v14, v26, v27, a9, v23, v22, v21, v20, var0, var1, var2, var3);
