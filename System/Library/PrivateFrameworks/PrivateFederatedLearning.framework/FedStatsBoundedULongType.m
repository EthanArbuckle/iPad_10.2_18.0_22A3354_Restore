...
- (id)encodeToIndex:(id)a3 possibleError:(id *)a4
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0
      && (v10 = objc_msgSend(v6, "longValue"), v10 == objc_msgSend(v6, "unsignedLongValue")))
    {
      v11 = objc_msgSend(v6, "unsignedLongValue");
      if (v11 + 1 <= -[FedStatsBoundedULongType bound](self, "bound"))
        v12 = v11 + 1;
      else
        v12 = 0;
...
- (id)decodeFromIndex:(id)a3 possibleError:(id *)a4
{
  ...
  if (!v6)
  {
    if (a4)
    {
      v11 = CFSTR("The decoder can only work with a number type");
LABEL_9:
      +[FedStatsError errorWithCode:description:](FedStatsError, "errorWithCode:description:", 500, v11);
      v10 = 0;
      *a4 = (id)objc_claimAutoreleasedReturnValue();
      goto LABEL_12;
    }
LABEL_10:
  ...
  v8 = objc_msgSend(v6, "unsignedLongValue");
  if (v8 >= -[FedStatsBoundedULongType classCount](self, "classCount"))
  {
    if (a4)
    {
      v11 = CFSTR("The decoder requires a number less than the class count");
      goto LABEL_9;
    }
    goto LABEL_10;
  }
  ...
  if (v9)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLong:", v9 - 1);
