...
void ___STLoadHeaderIconForAppID_block_invoke()
{
  uint64_t v0;
  void *v1;
  ...
  v1 = (void *)_gHeaderIconsByID;
  _gHeaderIconsByID = v0;
...
void ___STLoadHeaderIconForAppID_block_invoke_2(uint64_t a1)
{
  ...
  _LoadIconForAppID((void *)_gHeaderIconsByID, *(void **)(a1 + 32), 2, *(unsigned __int8 *)(a1 + 48));
