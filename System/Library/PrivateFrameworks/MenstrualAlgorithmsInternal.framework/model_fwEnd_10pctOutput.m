...
- (model_fwEnd_10pctOutput)initWithOut:(id)a3 lstm_1_h_out:(id)a4 lstm_1_c_out:(id)a5
{
  ...
  v12 = -[model_fwEnd_10pctOutput init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E720BD8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(v4, "isEqualToString:", CFSTR("out")))
  {
    ...
    -[model_fwEnd_10pctOutput out](self, "out");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("lstm_1_h_out")))
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[model_fwEnd_10pctOutput lstm_1_h_out](self, "lstm_1_h_out");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[model_fwEnd_10pctOutput lstm_1_c_out](self, "lstm_1_c_out");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  v7 = (void *)v6;
