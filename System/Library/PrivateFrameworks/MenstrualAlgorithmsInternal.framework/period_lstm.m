...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("period_lstm"), CFSTR("mlmodelc"));
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
      +[period_lstm URLOfModelInThisBundle].cold.1();
    v4 = 0;
  }
...
- (period_lstm)initWithMLModel:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = -[period_lstm init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
- (period_lstm)init
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[period_lstm initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (period_lstm)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[period_lstm initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (period_lstm)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[period_lstm initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (period_lstm)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[period_lstm initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[period_lstm predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v17;
  void *v18;
  period_lstmOutput *v19;

  v8 = a4;
  v9 = a3;
  -[period_lstm model](self, "model");
  ...
  if (v11)
  {
    ...
    v19 = -[period_lstmOutput initWithOut:lstm_1_h_out:lstm_1_c_out:](v12, "initWithOut:lstm_1_h_out:lstm_1_c_out:", v14, v16, v18);
...
- (id)predictionFromIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5 error:(id *)a6
{
  ...
  id v11;
  id v12;
  period_lstmInput *v13;
  void *v14;

  v10 = a5;
  v11 = a4;
  v12 = a3;
  v13 = -[period_lstmInput initWithIn:lstm_1_h_in:lstm_1_c_in:]([period_lstmInput alloc], "initWithIn:lstm_1_h_in:lstm_1_c_in:", v12, v11, v10);

  -[period_lstm predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v13, a6);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v24 = -[period_lstmOutput initWithOut:lstm_1_h_out:lstm_1_c_out:](v16, "initWithOut:lstm_1_h_out:lstm_1_c_out:", v19, v21, v23);
...
+ (void)URLOfModelInThisBundle
{
  ...
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_221550000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "Could not load period_lstm.mlmodelc in the bundle resource", v0, 2u);
}
