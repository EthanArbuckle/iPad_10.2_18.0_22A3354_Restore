...
- (fwEnddet_lstmOutput)initWithOut:(id)a3 lstm_1_h_out:(id)a4 lstm_1_c_out:(id)a5
{
  ...
  v12 = -[fwEnddet_lstmOutput init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E720BA8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(v4, "isEqualToString:", CFSTR("out")))
  {
    ...
    -[fwEnddet_lstmOutput out](self, "out");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("lstm_1_h_out")))
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[fwEnddet_lstmOutput lstm_1_h_out](self, "lstm_1_h_out");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[fwEnddet_lstmOutput lstm_1_c_out](self, "lstm_1_c_out");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  v7 = (void *)v6;
