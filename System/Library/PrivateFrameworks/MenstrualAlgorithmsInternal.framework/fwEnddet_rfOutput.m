...
{
  id v7;
  fwEnddet_rfOutput *v8;
  fwEnddet_rfOutput *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)fwEnddet_rfOutput;
  v8 = -[fwEnddet_rfOutput init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_classLabel = a3;
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E720B78);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDBFF98], "featureValueWithInt64:", -[fwEnddet_rfOutput classLabel](self, "classLabel"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)MEMORY[0x24BDBFF98];
    -[fwEnddet_rfOutput classProbability](self, "classProbability");
