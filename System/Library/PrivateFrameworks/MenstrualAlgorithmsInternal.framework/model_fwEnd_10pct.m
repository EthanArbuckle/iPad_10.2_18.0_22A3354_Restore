...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("model_fwEnd_10pct"), CFSTR("mlmodelc"));
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
      +[model_fwEnd_10pct URLOfModelInThisBundle].cold.1();
    v4 = 0;
  }
...
{
  id v5;
  model_fwEnd_10pct *v6;
  model_fwEnd_10pct *v7;
  model_fwEnd_10pct *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[model_fwEnd_10pct init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
{
  void *v3;
  model_fwEnd_10pct *v4;

  objc_msgSend((id)objc_opt_class(), "URLOfModelInThisBundle");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[model_fwEnd_10pct initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (model_fwEnd_10pct)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[model_fwEnd_10pct initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (model_fwEnd_10pct)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[model_fwEnd_10pct initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (model_fwEnd_10pct)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[model_fwEnd_10pct initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[model_fwEnd_10pct predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v17;
  void *v18;
  model_fwEnd_10pctOutput *v19;

  v8 = a4;
  v9 = a3;
  -[model_fwEnd_10pct model](self, "model");
  ...
  if (v11)
  {
    ...
    v19 = -[model_fwEnd_10pctOutput initWithOut:lstm_1_h_out:lstm_1_c_out:](v12, "initWithOut:lstm_1_h_out:lstm_1_c_out:", v14, v16, v18);
...
- (id)predictionFromIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5 error:(id *)a6
{
  ...
  v11 = a4;
  v12 = a3;
  v13 = -[model_fwEnd_10pctInput initWithIn:lstm_1_h_in:lstm_1_c_in:]([model_fwEnd_10pctInput alloc], "initWithIn:lstm_1_h_in:lstm_1_c_in:", v12, v11, v10);

  -[model_fwEnd_10pct predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v13, a6);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v24 = -[model_fwEnd_10pctOutput initWithOut:lstm_1_h_out:lstm_1_c_out:](v16, "initWithOut:lstm_1_h_out:lstm_1_c_out:", v19, v21, v23);
...
+ (void)URLOfModelInThisBundle
{
  ...
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_221550000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "Could not load model_fwEnd_10pct.mlmodelc in the bundle resource", v0, 2u);
}
