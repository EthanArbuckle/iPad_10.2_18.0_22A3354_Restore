...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("fwEnddet_rf"), CFSTR("mlmodelc"));
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
      +[fwEnddet_rf URLOfModelInThisBundle].cold.1();
    v4 = 0;
  }
...
- (fwEnddet_rf)initWithMLModel:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = -[fwEnddet_rf init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
- (fwEnddet_rf)init
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[fwEnddet_rf initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (fwEnddet_rf)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[fwEnddet_rf initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (fwEnddet_rf)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[fwEnddet_rf initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (fwEnddet_rf)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[fwEnddet_rf initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[fwEnddet_rf predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  fwEnddet_rfOutput *v12;
  void *v13;
  uint64_t v14;
  void *v15;
  void *v16;
  fwEnddet_rfOutput *v17;

  v8 = a4;
  v9 = a3;
  -[fwEnddet_rf model](self, "model");
  ...
  if (v11)
  {
    ...
    v17 = -[fwEnddet_rfOutput initWithClassLabel:classProbability:](v12, "initWithClassLabel:classProbability:", v14, v16);
...
- (id)predictionFromInput:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = -[fwEnddet_rfInput initWithInput:]([fwEnddet_rfInput alloc], "initWithInput:", v6);

  -[fwEnddet_rf predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  fwEnddet_rfOutput *v16;
  void *v17;
  uint64_t v18;
  void *v19;
  void *v20;
  fwEnddet_rfOutput *v21;
  void *v23;
  id v24;
  id v25;
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v21 = -[fwEnddet_rfOutput initWithClassLabel:classProbability:](v16, "initWithClassLabel:classProbability:", v18, v20);
...
+ (void)URLOfModelInThisBundle
{
  ...
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_221550000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "Could not load fwEnddet_rf.mlmodelc in the bundle resource", v0, 2u);
}
