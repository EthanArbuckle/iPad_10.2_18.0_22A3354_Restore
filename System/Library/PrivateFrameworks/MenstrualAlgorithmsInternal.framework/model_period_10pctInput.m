...
{
  return -[model_period_10pctInput initWithIn:lstm_1_h_in:lstm_1_c_in:](self, "initWithIn:lstm_1_h_in:lstm_1_c_in:", a3, 0, 0);
}
...
- (model_period_10pctInput)initWithIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5
{
  ...
  v12 = -[model_period_10pctInput init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E720B30);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isEqualToString:", CFSTR("in")))
  {
    ...
    {
      -[model_period_10pctInput lstm_1_h_in](self, "lstm_1_h_in");
...
LABEL_9:
    ...
    else
    {
      ...
      -[model_period_10pctInput lstm_1_c_in](self, "lstm_1_c_in");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      if (v6)
      {
        v8 = (void *)MEMORY[0x24BDBFF98];
  ...
  -[model_period_10pctInput in](self, "in");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
