...
{
  return -[period_lstmInput initWithIn:lstm_1_h_in:lstm_1_c_in:](self, "initWithIn:lstm_1_h_in:lstm_1_c_in:", a3, 0, 0);
}
...
- (period_lstmInput)initWithIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5
{
  ...
  v12 = -[period_lstmInput init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E720B00);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isEqualToString:", CFSTR("in")))
  {
    ...
    {
      -[period_lstmInput lstm_1_h_in](self, "lstm_1_h_in");
...
LABEL_9:
    ...
    else
    {
      ...
      -[period_lstmInput lstm_1_c_in](self, "lstm_1_c_in");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      if (v6)
      {
        v8 = (void *)MEMORY[0x24BDBFF98];
