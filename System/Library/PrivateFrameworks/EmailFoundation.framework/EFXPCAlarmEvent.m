...
- (EFXPCAlarmEvent)initWithName:(id)a3 fireDate:(id)a4 isUserVisible:(BOOL)a5
{
  ...
  v10 = -[EFXPCAlarmEvent init](&v16, sel_init);
  if (v10)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    -[EFXPCAlarmEvent name](self, "name");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("<%@:%p name:%@ fireDate:%@ isUserVisible:%d>"), objc_opt_class(), self, self->_name, self->_fireDate, self->_isUserVisible);
}
