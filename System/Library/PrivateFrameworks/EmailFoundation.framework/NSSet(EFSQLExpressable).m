    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_respondsToSelector() & 1) == 0)
        {
          ...
          objc_msgSend(v16, "handleFailureInFunction:file:lineNumber:description:", v15, CFSTR("EFSQLExpressable.m"), 104, CFSTR("Objects in the %@ must conform to protocol EFSQLValueExpressable"), CFSTR("set"));
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_respondsToSelector() & 1) == 0)
        {
          ...
          objc_msgSend(v20, "handleFailureInFunction:file:lineNumber:description:", v19, CFSTR("EFSQLExpressable.m"), 104, CFSTR("Objects in the %@ must conform to protocol EFSQLValueExpressable"), CFSTR("set"));
