@implementation PFPosterPathURLResourceValues
...
void __PFPosterPathURLResourceValues_block_invoke()
{
  ...
  v0 = *MEMORY[0x24BDBCC20];
  v4[0] = *MEMORY[0x24BDBCC90];
  v4[1] = v0;
  v1 = *MEMORY[0x24BDBCC28];
  v5[0] = MEMORY[0x24BDBD1C8];
  v5[1] = v1;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v5, v4, 2);
  v2 = objc_claimAutoreleasedReturnValue();
  v3 = (void *)PFPosterPathURLResourceValues___sharedInstance;
