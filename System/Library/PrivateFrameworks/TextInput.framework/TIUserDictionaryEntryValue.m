...
- (TIUserDictionaryEntryValue)initWithCoder:(id)a3
{
  ...
  v5 = -[TIUserDictionaryEntryValue init](&v15, sel_init);
  if (v5)
  {
...
- (NSString)description
{
  ...
  -[TIUserDictionaryEntryValue shortcut](self, "shortcut");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[TIUserDictionaryEntryValue phrase](self, "phrase");
