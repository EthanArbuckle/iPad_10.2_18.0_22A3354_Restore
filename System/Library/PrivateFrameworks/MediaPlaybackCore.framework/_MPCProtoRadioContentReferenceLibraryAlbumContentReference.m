...
- (id)description
{
  ...
  -[_MPCProtoRadioContentReferenceLibraryAlbumContentReference description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MPCProtoRadioContentReferenceLibraryAlbumContentReference dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_13;
  albumName = self->_albumName;
  if ((unint64_t)albumName | *((_QWORD *)v4 + 3))
  {
