...
void __122__MPModelMovie_MPCStoreFrontLocalEquivalencyMiddlewareAdditions__MPC_modelObjectWithStoreFrontLocalEquivalentModelObject___block_invoke(uint64_t a1, void *a2)
{
  ...
  v12[1] = 3221225472;
  v12[2] = __122__MPModelMovie_MPCStoreFrontLocalEquivalencyMiddlewareAdditions__MPC_modelObjectWithStoreFrontLocalEquivalentModelObject___block_invoke_2;
  v12[3] = &unk_24CAB89F0;
  v5 = v3;
  v13 = v5;
  ...
  if (v6)
  {
    ...
    v10[0] = v4;
    v10[1] = 3221225472;
    v10[2] = __122__MPModelMovie_MPCStoreFrontLocalEquivalencyMiddlewareAdditions__MPC_modelObjectWithStoreFrontLocalEquivalentModelObject___block_invoke_3;
    v10[3] = &unk_24CAB89A8;
    v11 = v5;
...
void __122__MPModelMovie_MPCStoreFrontLocalEquivalencyMiddlewareAdditions__MPC_modelObjectWithStoreFrontLocalEquivalentModelObject___block_invoke_4(uint64_t a1, void *a2)
{
  ...
  v4 = a2;
  if (objc_msgSend(v4, "hasLoadedValueForKey:", *MEMORY[0x24BDDBEC0]))
    objc_msgSend(v4, "setLibraryAddEligible:", objc_msgSend(*(id *)(a1 + 32), "isLibraryAddEligible"));
  if (objc_msgSend(v4, "hasLoadedValueForKey:", *MEMORY[0x24BDDC330]))
  {
    objc_msgSend(*(id *)(a1 + 32), "storeAsset");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setStoreAsset:", v3);
