...
- (id)description
{
  ...
  -[_MPCProtoRadioContentReferenceStoreContentReference description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MPCProtoRadioContentReferenceStoreContentReference dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("storeAdamID"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)result + 1) = self->_storeAdamID;
    *((_BYTE *)result + 16) |= 1u;
  }
  return result;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) != 0 && self->_storeAdamID == *((_QWORD *)v4 + 1))
    {
      v5 = 1;
      goto LABEL_7;
    }
