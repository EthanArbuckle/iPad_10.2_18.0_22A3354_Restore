...
{
  return -[HDStringParameter initWithSummary:required:](self, "initWithSummary:required:", &stru_24F253950, 1);
}

- (HDStringParameter)initWithSummary:(id)a3 required:(BOOL)a4
{
  id v7;
  HDStringParameter *v8;
  HDStringParameter *v9;
  objc_super v11;

  v7 = a3;
  v11.receiver = self;
  v11.super_class = (Class)HDStringParameter;
  v8 = -[HDStringParameter init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[HDStringParameter summary](self, "summary");
...
- (BOOL)validateValue:(id)a3 error:(id *)a4
{
  ...
  if (a4 && (isKindOfClass & 1) == 0)
  {
    ...
    objc_msgSend(v8, "stringWithFormat:", CFSTR("Expected String value, not %@."), v10);
