...
{
  _TtC13HealthBalance42SleepingSampleDaySummaryQueryConfiguration *v4;
  void *v5;
  _QWORD v7[4];

  v4 = self;
  sub_23DC09CF4((uint64_t)a3, (uint64_t)v7);
...
{
  _TtC13HealthBalance42SleepingSampleDaySummaryQueryConfiguration *result;
...
{
  id v4;
  _TtC13HealthBalance42SleepingSampleDaySummaryQueryConfiguration *v5;
...
- (void).cxx_destruct
{
  sub_23DBB73A8((uint64_t)self + OBJC_IVAR____TtC13HealthBalance42SleepingSampleDaySummaryQueryConfiguration_gregorianCalendar, &qword_25431F8F0, (uint64_t (*)(uint64_t))MEMORY[0x24BDCF2D8]);
  sub_23DBB73A8((uint64_t)self + OBJC_IVAR____TtC13HealthBalance42SleepingSampleDaySummaryQueryConfiguration_morningIndexRange, &qword_25431FA60, (uint64_t (*)(uint64_t))sub_23DBB9590);
}
