@implementation SPRankingTopHitMustBeOverrideMinSpellCorrectedAppScore
...
void __SPRankingTopHitMustBeOverrideMinSpellCorrectedAppScore_block_invoke()
{
  ...
  objc_msgSend(v0, "objectForKey:", CFSTR("SPRankingTopHitMustBeOverrideMinSpellCorrectedAppScore"));
