...
- (SSLocaleObserver)init
{
  ...
  v2 = -[SSLocaleObserver init](&v9, sel_init);
  if (v2)
  {
    ...
    v2->_isCJK = 0;
    -[SSLocaleObserver update](v2, "update");
...
void __61__SSLocaleObserver_currentLocaleWithPreferredLanguagesBlock___block_invoke(_QWORD *a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (void)dealloc
{
  ...
  -[SSLocaleObserver dealloc](&v4, sel_dealloc);
}
