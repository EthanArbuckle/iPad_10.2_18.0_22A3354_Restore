...
- (id)description
{
  ...
  -[VCPProtoMovieQualityResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMovieQualityResult dictionaryRepresentation](self, "dictionaryRepresentation");
  ...
  if ((v10.start.flags & 1) != 0)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          v6 = objc_alloc_init(VCPProtoMovieQualityResult);
          v9 = v10;
          +[VCPProtoTimeRange timeRangeWithCMTimeRange:](VCPProtoTimeRange, "timeRangeWithCMTimeRange:", &v9);
          v7 = (void *)objc_claimAutoreleasedReturnValue();
          -[VCPProtoMovieQualityResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMovieQualityResult timeRange](self, "timeRange");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  ...
  -[VCPProtoMovieQualityResult qualityScore](self, "qualityScore");
