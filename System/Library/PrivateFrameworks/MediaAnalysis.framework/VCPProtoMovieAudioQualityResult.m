...
- (id)description
{
  ...
  -[VCPProtoMovieAudioQualityResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMovieAudioQualityResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v4;
  void *v5;
  VCPProtoMovieAudioQualityResult *v6;
  void *v7;
  CMTimeRange v9;
  CMTimeRange v10;
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          v7 = (void *)objc_claimAutoreleasedReturnValue();
          -[VCPProtoMovieAudioQualityResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMovieAudioQualityResult timeRange](self, "timeRange");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  ...
  -[VCPProtoMovieAudioQualityResult confidence](self, "confidence");
