    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          -[VCPProtoMovieBabbleResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMovieBabbleResult timeRange](self, "timeRange");
  ...
  -[VCPProtoMovieBabbleResult confidence](self, "confidence");
...
- (id)description
{
  ...
  -[VCPProtoMovieBabbleResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMovieBabbleResult dictionaryRepresentation](self, "dictionaryRepresentation");
