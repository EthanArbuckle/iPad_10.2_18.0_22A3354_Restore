...
- (id)description
{
  ...
  -[VCPProtoImagePetsResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoImagePetsResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  else
  {
    ...
    -[VCPProtoImagePetsResult setBounds:](v8, "setBounds:", v9);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoImagePetsResult confidence](self, "confidence");
  objc_msgSend(v3, "numberWithFloat:");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = v4;
  v10[1] = CFSTR("petsBounds");
  -[VCPProtoImagePetsResult bounds](self, "bounds");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
