...
void __31__VCPMADVisionResource_session__block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_1B6C4A000, v6, OS_SIGNPOST_INTERVAL_BEGIN, v4, "VNSession_init", ", buf, 2u);
    }

    v7 = objc_alloc_init(MEMORY[0x1E0CEE040]);
    v8 = *(_QWORD *)(a1 + 32);
    v9 = *(void **)(v8 + 16);
    *(_QWORD *)(v8 + 16) = v7;
    ...
    {
      *(_WORD *)v12 = 0;
      _os_signpost_emit_with_name_impl(&dword_1B6C4A000, v11, OS_SIGNPOST_INTERVAL_END, v4, "VNSession_init", ", v12, 2u);
    }
...
void __29__VCPMADVisionResource_purge__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 16), "releaseCachedResources");
  v2 = *(_QWORD *)(a1 + 32);
  v3 = *(void **)(v2 + 16);
  *(_QWORD *)(v2 + 16) = 0;
