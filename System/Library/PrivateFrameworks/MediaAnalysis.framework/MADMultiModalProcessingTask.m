...
- (MADMultiModalProcessingTask)initWithRequests:(id)a3 inputs:(id)a4 cancelBlock:(id)a5 completionHandler:(id)a6
{
  ...
  id v14;
  id v15;
  MADMultiModalProcessingTask *v16;
  MADMultiModalProcessingTask *v17;
...
void __85__MADMultiModalProcessingTask_initWithRequests_inputs_cancelBlock_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = *(_QWORD *)(a1 + 32);
  v5 = a3;
  objc_msgSend(a2, "objectForKeyedSubscript:", CFSTR("Replies"));
...
- (BOOL)run:(id *)a3
{
  ...
  if (v6 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
  {
    ...
    *(_DWORD *)buf = 138412290;
    v66 = signpostPayload;
    _os_signpost_emit_with_name_impl(&dword_1B6C4A000, v8, OS_SIGNPOST_INTERVAL_BEGIN, v6, "MADMultiModalProcessingTask_Run", "%@", buf, 0xCu);
  }
...
LABEL_39:
  ...
  else
  {
    ...
    if (v29)
    {
      ...
      do
      {
        for (j = 0; j != v30; ++j)
        {
          ...
          v34 = objc_alloc_init(MEMORY[0x1E0D47720]);
    ...
    if (v51 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v37))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v66 = v39;
      _os_signpost_emit_with_name_impl(&dword_1B6C4A000, v38, OS_SIGNPOST_INTERVAL_END, spid, "MADMultiModalProcessingTask_Run", "%@", buf, 0xCu);
    }
  ...
  if (v2)
  {
    ...
    do
    {
      for (i = 0; i != v3; ++i)
      {
        ...
        objc_msgSend((id)(v5 + 2776), "subtaskForRequest:inputs:", v8, *(_QWORD *)(*(_QWORD *)(a1 + 32) + v6[337]));
