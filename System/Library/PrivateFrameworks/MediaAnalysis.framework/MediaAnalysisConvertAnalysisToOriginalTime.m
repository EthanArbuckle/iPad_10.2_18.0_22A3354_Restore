@implementation MediaAnalysisConvertAnalysisToOriginalTime

void __MediaAnalysisConvertAnalysisToOriginalTime_block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v5;
  void *v6;
  id v7;
      ...
      for (i = 0; i != v8; ++i)
      {
          ...
          && (v28.duration.value & 0x8000000000000000) == 0)
        {
          ...
          *(float *)&Seconds = Seconds;
          objc_msgSend(v13, "originalTimeForScaledTime:", Seconds);
          ...
          *(float *)&v17 = v17;
          objc_msgSend(v16, "originalTimeForScaledTime:", v17);
