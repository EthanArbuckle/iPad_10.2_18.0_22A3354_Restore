...
- (id)description
{
  ...
  -[VCPProtoMovieHighlightScoreResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMovieHighlightScoreResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&v4 = self->_highlightScore;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("highlightScore"));
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v4;
  void *v5;
  VCPProtoMovieHighlightScoreResult *v6;
  void *v7;
  CMTimeRange v9;
  CMTimeRange v10;
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          v7 = (void *)objc_claimAutoreleasedReturnValue();
          -[VCPProtoMovieHighlightScoreResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMovieHighlightScoreResult timeRange](self, "timeRange");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  ...
  -[VCPProtoMovieHighlightScoreResult highlightScore](self, "highlightScore");
