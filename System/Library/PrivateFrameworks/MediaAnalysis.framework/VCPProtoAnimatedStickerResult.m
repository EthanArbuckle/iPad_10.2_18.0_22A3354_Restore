...
- (id)description
{
  ...
  -[VCPProtoAnimatedStickerResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoAnimatedStickerResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&v4 = self->_stickerScore;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("stickerScore"));
...
- (unint64_t)hash
{
  ...
  stickerScore = self->_stickerScore;
  v5 = -stickerScore;
  if (stickerScore >= 0.0)
    v5 = self->_stickerScore;
  v6 = floorf(v5 + 0.5);
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v4;
  void *v5;
  VCPProtoAnimatedStickerResult *v6;
  void *v7;
  CMTimeRange v9;
  CMTimeRange v10;
  ...
  if ((v10.start.flags & 1) != 0)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          v6 = objc_alloc_init(VCPProtoAnimatedStickerResult);
          v9 = v10;
          +[VCPProtoTimeRange timeRangeWithCMTimeRange:](VCPProtoTimeRange, "timeRangeWithCMTimeRange:", &v9);
          v7 = (void *)objc_claimAutoreleasedReturnValue();
          -[VCPProtoAnimatedStickerResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoAnimatedStickerResult timeRange](self, "timeRange");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  ...
  -[VCPProtoAnimatedStickerResult stickerScore](self, "stickerScore");
