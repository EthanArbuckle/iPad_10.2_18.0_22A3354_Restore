...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("MonzaV4_1"), CFSTR("mlmodelc"));
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
      +[MonzaV4_1 URLOfModelInThisBundle].cold.1();
    v4 = 0;
  }
...
- (MonzaV4_1)initWithMLModel:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = -[MonzaV4_1 init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
- (MonzaV4_1)init
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[MonzaV4_1 initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (MonzaV4_1)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[MonzaV4_1 initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (MonzaV4_1)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[MonzaV4_1 initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (MonzaV4_1)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[MonzaV4_1 initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[MonzaV4_1 predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if (v11)
  {
    ...
    objc_msgSend(v11, "featureValueForName:", CFSTR("angle"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "multiArrayValue");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = -[MonzaV4_1Output initWithAngle:](v12, "initWithAngle:", v14);
...
- (id)predictionFromInputImage:(__CVBuffer *)a3 error:(id *)a4
{
  ...
  v6 = -[MonzaV4_1Input initWithInputImage:]([MonzaV4_1Input alloc], "initWithInputImage:", a3);
  -[MonzaV4_1 predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v6, a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        objc_msgSend(v15, "featureValueForName:", CFSTR("angle"));
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "multiArrayValue");
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v19 = -[MonzaV4_1Output initWithAngle:](v16, "initWithAngle:", v18);
...
+ (void)URLOfModelInThisBundle
{
  ...
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_1B6C4A000, MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR, "Could not load MonzaV4_1.mlmodelc in the bundle resource", v0, 2u);
}
