...
- (id)description
{
  ...
  -[VCPProtoMovieSaliencyResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMovieSaliencyResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v6;
  void *v7;
  VCPProtoMovieSaliencyResult *v8;
  BOOL v9;
  void *v10;
  void *v11;
  CMTimeRange v13;
  ...
  objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("saliencyBounds"));
  v5 = (NSString *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("saliencyConfidence"));
    ...
    if ((v14.duration.flags & 1) != 0 && !v14.duration.epoch)
    {
      ...
      if ((v14.duration.value & 0x8000000000000000) == 0)
      {
        ...
        if (!v9)
        {
          ...
          -[VCPProtoMovieSaliencyResult setTimeRange:](v8, "setTimeRange:", v10);
          ...
          -[VCPProtoMovieSaliencyResult setBounds:](v8, "setBounds:", v11);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMovieSaliencyResult timeRange](self, "timeRange");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  ...
  v15[0] = CFSTR("saliencyBounds");
  -[VCPProtoMovieSaliencyResult bounds](self, "bounds");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "rectValue");
  NSStringFromRect(v17);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v16[0] = v8;
  v15[1] = CFSTR("saliencyConfidence");
  v9 = (void *)MEMORY[0x1E0CB37E8];
  -[VCPProtoMovieSaliencyResult confidence](self, "confidence");
