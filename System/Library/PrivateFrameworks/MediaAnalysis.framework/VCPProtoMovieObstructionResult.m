...
- (id)description
{
  ...
  -[VCPProtoMovieObstructionResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMovieObstructionResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&v4 = self->_obstructionScore;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("obstructionScore"));
...
- (unint64_t)hash
{
  ...
  obstructionScore = self->_obstructionScore;
  v5 = -obstructionScore;
  if (obstructionScore >= 0.0)
    v5 = self->_obstructionScore;
  v6 = floorf(v5 + 0.5);
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v4;
  void *v5;
  VCPProtoMovieObstructionResult *v6;
  void *v7;
  CMTimeRange v9;
  CMTimeRange v10;
  ...
  if ((v10.start.flags & 1) != 0)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          v6 = objc_alloc_init(VCPProtoMovieObstructionResult);
          v9 = v10;
          +[VCPProtoTimeRange timeRangeWithCMTimeRange:](VCPProtoTimeRange, "timeRangeWithCMTimeRange:", &v9);
          v7 = (void *)objc_claimAutoreleasedReturnValue();
          -[VCPProtoMovieObstructionResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMovieObstructionResult timeRange](self, "timeRange");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  ...
  -[VCPProtoMovieObstructionResult obstructionScore](self, "obstructionScore");
