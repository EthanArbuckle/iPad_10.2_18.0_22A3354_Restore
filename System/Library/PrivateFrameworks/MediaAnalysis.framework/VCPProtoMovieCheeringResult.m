...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v4;
  void *v5;
  VCPProtoMovieCheeringResult *v6;
  void *v7;
  CMTimeRange v9;
  CMTimeRange v10;
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          -[VCPProtoMovieCheeringResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMovieCheeringResult timeRange](self, "timeRange");
  ...
  -[VCPProtoMovieCheeringResult confidence](self, "confidence");
...
- (id)description
{
  ...
  -[VCPProtoMovieCheeringResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMovieCheeringResult dictionaryRepresentation](self, "dictionaryRepresentation");
