...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v4;
  void *v5;
  VCPProtoLivePhotoRecommendationResult *v6;
  void *v7;
  CMTimeRange v9;
  CMTimeRange v10;
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          -[VCPProtoLivePhotoRecommendationResult setTimeRange:](v6, "setTimeRange:", v7);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoLivePhotoRecommendationResult timeRange](self, "timeRange");
  ...
  -[VCPProtoLivePhotoRecommendationResult qualityScore](self, "qualityScore");
...
- (id)description
{
  ...
  -[VCPProtoLivePhotoRecommendationResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoLivePhotoRecommendationResult dictionaryRepresentation](self, "dictionaryRepresentation");
