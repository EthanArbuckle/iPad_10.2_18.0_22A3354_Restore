...
- (VCPCNNSmileDetectorMPS)init
{
  ...
  uint64_t v11;
  VCPCNNData *input;
  VCPCNNSmileDetectorMPS *v13;
  int v14;
  void *v15;
  VCPCNNSmileDetectorMPS *v16;
  void *v18;
  void *v19;
  int v20;
  ...
  v6 = -[VCPCNNSmileDetectorMPS init](&v33, sel_init);
  if (!v6)
    goto LABEL_23;
...
LABEL_24:
  ...
  v13 = (VCPCNNSmileDetectorMPS *)objc_claimAutoreleasedReturnValue();
...
LABEL_20:
  ...
  +[VCPCNNConvBlock convBlockWithFilterSize:filterNum:chunk:reLU:padding:](VCPCNNConvBlock, "convBlockWithFilterSize:filterNum:chunk:reLU:padding:", 3, 32, v5, 1, 0);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        objc_msgSend(MEMORY[0x1E0C99E98], "URLWithString:relativeToURL:", CFSTR("cnn_smile.dat"), v27);
...
- (int)computeSmileScore:(float *)a3
{
  ...
  if (!v5)
  {
    ...
    if (!v5)
    {
      ...
      *a3 = *(float *)(objc_msgSend(v7, "data") + 4);
