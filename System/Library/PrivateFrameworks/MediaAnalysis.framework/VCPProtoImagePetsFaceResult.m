...
- (id)description
{
  ...
  -[VCPProtoImagePetsFaceResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoImagePetsFaceResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  NSString *v6;
  BOOL v7;
  VCPProtoImagePetsFaceResult *v8;
  void *v9;
  NSRect v11;

  objc_msgSend(a3, "objectForKeyedSubscript:", CFSTR("attributes"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("petsConfidence"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("petsBounds"));
  ...
  {
    v8 = objc_alloc_init(VCPProtoImagePetsFaceResult);
    ...
    -[VCPProtoImagePetsFaceResult setBounds:](v8, "setBounds:", v9);
...
- (id)exportToLegacyDictionary
{
  ...
  v10[0] = CFSTR("petsConfidence");
  v3 = (void *)MEMORY[0x1E0CB37E8];
  -[VCPProtoImagePetsFaceResult confidence](self, "confidence");
  objc_msgSend(v3, "numberWithFloat:");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = v4;
  v10[1] = CFSTR("petsBounds");
  -[VCPProtoImagePetsFaceResult bounds](self, "bounds");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
