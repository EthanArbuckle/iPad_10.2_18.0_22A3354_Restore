...
- (id)description
{
  ...
  -[VCPProtoMoviePetsFaceResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPProtoMoviePetsFaceResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v6;
  void *v7;
  VCPProtoMoviePetsFaceResult *v8;
  BOOL v9;
  void *v10;
  void *v11;
  CMTimeRange v13;
  ...
  if ((v14.start.flags & 1) != 0)
  {
    ...
    if ((v14.duration.flags & 1) != 0 && !v14.duration.epoch)
    {
      ...
      if ((v14.duration.value & 0x8000000000000000) == 0)
      {
        ...
        if (!v9)
        {
          v8 = objc_alloc_init(VCPProtoMoviePetsFaceResult);
          v13 = v14;
          +[VCPProtoTimeRange timeRangeWithCMTimeRange:](VCPProtoTimeRange, "timeRangeWithCMTimeRange:", &v13);
          v10 = (void *)objc_claimAutoreleasedReturnValue();
          -[VCPProtoMoviePetsFaceResult setTimeRange:](v8, "setTimeRange:", v10);
          ...
          -[VCPProtoMoviePetsFaceResult setBounds:](v8, "setBounds:", v11);
...
- (id)exportToLegacyDictionary
{
  ...
  -[VCPProtoMoviePetsFaceResult timeRange](self, "timeRange");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  ...
  -[VCPProtoMoviePetsFaceResult bounds](self, "bounds");
  ...
  -[VCPProtoMoviePetsFaceResult confidence](self, "confidence");
