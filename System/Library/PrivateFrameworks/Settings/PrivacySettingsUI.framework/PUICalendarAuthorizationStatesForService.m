@implementation PUICalendarAuthorizationStatesForService
...
void __PUICalendarAuthorizationStatesForService_block_invoke_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_error_impl(&dword_1DB1FB000, log, OS_LOG_TYPE_ERROR, "Error when requesting TCC for service: %@ error: %@", (uint8_t *)&v4, 0x16u);
