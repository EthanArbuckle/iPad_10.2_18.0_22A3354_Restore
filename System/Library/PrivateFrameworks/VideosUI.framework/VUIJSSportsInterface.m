...
{
  id v4;
  VUIJSSportsInterface *v5;
  VUIJSSportsJavascriptInterface *v6;
  void *v7;
  uint64_t v8;
  VUIJSSportsJavascriptInterface *implementation;
  objc_super v11;
  ...
  if (v5)
  {
    ...
    v8 = -[VUIJSSportsJavascriptInterface initWithContext:](v6, "initWithContext:", v7);
...
{
  return -[VUIJSSportsJavascriptInterface checkActivityExistsFor:](self->_implementation, "checkActivityExistsFor:", a3);
}

- (id)getTierType:(id)a3
{
  return -[VUIJSSportsJavascriptInterface getTierTypeWithLeagueId:](self->_implementation, "getTierTypeWithLeagueId:", a3);
}

- (id)isPlayByPlayEnabled:(id)a3
{
  return -[VUIJSSportsJavascriptInterface isPlayByPlayEnabledWithLeagueId:](self->_implementation, "isPlayByPlayEnabledWithLeagueId:", a3);
}

- (id)isSportsFeatureEnabled:(id)a3 :(id)a4
{
  return -[VUIJSSportsJavascriptInterface isSportsFeatureEnabledWithLeagueId:featureName:](self->_implementation, "isSportsFeatureEnabledWithLeagueId:featureName:", a3, a4);
}
...
- (id)registerForSportsCanonical:(id)a3 :(id)a4 :(id)a5
{
  ...
  v11 = v9;
  v12 = v8;
  -[VUIJSSportsJavascriptInterface registerWithRequest:successHandler:errorHandler:](implementation, "registerWithRequest:successHandler:errorHandler:", a3, v23, &v18);
