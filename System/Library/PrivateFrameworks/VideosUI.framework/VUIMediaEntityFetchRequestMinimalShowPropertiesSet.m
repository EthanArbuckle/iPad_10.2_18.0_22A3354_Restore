@implementation VUIMediaEntityFetchRequestMinimalShowPropertiesSet
...
void __VUIMediaEntityFetchRequestMinimalShowPropertiesSet_block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("seasonCount"), 0);
  ...
  v3 = (void *)VUIMediaEntityFetchRequestMinimalShowPropertiesSet___minimalShowsPropertiesSet;
