...
- (void)dealloc
{
  ...
  -[VUIShelfLayoutSection setNumberOfItems:](self, "setNumberOfItems:", 0);
  v3.receiver = self;
  v3.super_class = (Class)VUIShelfLayoutSection;
  -[VUIShelfLayoutSection dealloc](&v3, sel_dealloc);
}
...
- (CGRect)firstItemFrame
{
  ...
  if (self->_numberOfItems < 1)
    itemFrames = (CGRect *)MEMORY[0x1E0C9D648];
  else
    itemFrames = self->_itemFrames;
