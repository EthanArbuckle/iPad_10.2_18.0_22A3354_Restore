...
{
  VUIMonogramImageConfiguration *v4;
  VUIMonogramImageConfiguration *v5;
  uint64_t v6;
  UIFont *font;
  void *v8;
  double v9;
  ...
  v4 = -[VUIMonogramImageConfiguration init](&v13, sel_init);
  v5 = v4;
  if (v4)
  {
    v4->_style = a3;
    objc_msgSend(MEMORY[0x1E0DC1350], "systemFontOfSize:weight:", 106.0, 3.0);
    v6 = objc_claimAutoreleasedReturnValue();
    font = v5->_font;
    v5->_font = (UIFont *)v6;

    *(_OWORD *)&v5->_diameter = xmmword_1DA1C2180;
    if (a3 == 2)
    {
