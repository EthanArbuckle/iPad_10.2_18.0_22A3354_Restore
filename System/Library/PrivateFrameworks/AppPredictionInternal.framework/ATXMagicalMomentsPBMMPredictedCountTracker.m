...
- (id)description
{
  ...
  -[ATXMagicalMomentsPBMMPredictedCountTracker description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXMagicalMomentsPBMMPredictedCountTracker dictionaryRepresentation](self, "dictionaryRepresentation");
