...
+ (id)longDescription
{
  return CFSTR("The user exited a known LOI.");
}
...
+ (void)registerForNotificationsWithoutUsingContextStoreForObserver:(id)a3 enterSelector:(SEL)a4 exitSelector:(SEL)a5
{
  ...
  objc_msgSend(v8, "addObserver:selector:name:object:", v7, a4, *MEMORY[0x1E0D80E90], 0);
...
+ (void)unregisterForNotificationsWithoutUsingContextStoreForObserver:(id)a3
{
  ...
  objc_msgSend(v5, "removeObserver:name:object:", v4, *MEMORY[0x1E0D80E90], 0);
