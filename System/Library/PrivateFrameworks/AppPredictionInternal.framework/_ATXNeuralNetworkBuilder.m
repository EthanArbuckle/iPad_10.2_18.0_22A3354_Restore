...
{
  _ATXNeuralNetworkBuilder *v4;
  _ATXNeuralNetworkBuilder *v5;
  uint64_t v6;
  ...
  v4 = -[_ATXNeuralNetworkBuilder init](&v11, sel_init);
  v5 = v4;
  if (v4)
  {
    v4->_prevSize = a3;
...
- (void)addHiddenLayer:(unint64_t)a3 weights:(const float *)a4 bias:(const float *)a5 activation:(unsigned __int8)a6 skip:(BOOL)a7
{
  ...
  if (self->_done)
  {
    ...
    objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_ATXNeuralNetwork.m"), 194, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("!_done"));
  ...
  objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_ATXNeuralNetwork.m"), 195, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("outputSize > 0"));
...
- (void)addOutputLayer:(unint64_t)a3 weights:(const float *)a4 bias:(const float *)a5 activation:(unsigned __int8)a6 softmax:(BOOL)a7
{
  ...
  if (self->_haveOutputLayer)
  {
    ...
    objc_msgSend(v20, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_ATXNeuralNetwork.m"), 213, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("!_haveOutputLayer"));
  ...
  if (self->_done)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_ATXNeuralNetwork.m"), 214, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("!_done"));
...
- (id)serialize
{
  ...
  if (!self->_haveOutputLayer)
  {
    ...
    objc_msgSend(v14, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_ATXNeuralNetwork.m"), 243, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("_haveOutputLayer"));
  ...
  if (self->_done)
  {
    ...
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_ATXNeuralNetwork.m"), 244, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("!_done"));
