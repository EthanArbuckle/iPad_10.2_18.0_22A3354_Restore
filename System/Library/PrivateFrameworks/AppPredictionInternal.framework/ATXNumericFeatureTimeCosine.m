...
{
  return -[ATXImmutableCandidateRelevanceModelFeaturizer initWithFeatureValueNames:](self, "initWithFeatureValueNames:", &unk_1E83D0760);
}
...
- (id)numericFeatureValueForContext:(id)a3 candidate:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", (double)cos((double)v9 * 6.28318531 / 86400.0));
