...
- (id)featureNameForBMUserFocusComputedModeSemanticType:(int)a3
{
  ...
  if ((a3 - 1) < 0xB)
    return off_1E82EBB68[a3 - 1];
  __atxlog_handle_relevance_model();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_FAULT))
    -[ATXCategoricalFeatureUserFocusComputedMode featureNameForBMUserFocusComputedModeSemanticType:].cold.1();
...
- (id)categoricalFeatureValueForContext:(id)a3 candidate:(id)a4
{
  ...
  if (v6)
  {
    ...
    -[ATXCategoricalFeatureUserFocusComputedMode featureNameForBMUserFocusComputedModeSemanticType:](self, "featureNameForBMUserFocusComputedModeSemanticType:", v8);
...
- (void)featureNameForBMUserFocusComputedModeSemanticType:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_6(&dword_1C9A3B000, v2, v3, "%@ - Invalid modeSemanticType attempted to be featurized: %ld", v4, v5, v6, v7, v8);
