...
+ (id)longDescription
{
  return CFSTR("Bluetooth device is connected.");
}
...
+ (BOOL)isActive
{
  ...
  v3 = objc_msgSend(v2, "bluetoothState") == 1;
...
+ (id)sampleEvent
{
  ...
  v5 = -[ATXBluetoothDuetEvent initWithBluetoothState:deviceType:deviceName:hardwareAddress:startDate:endDate:](v2, "initWithBluetoothState:deviceType:deviceName:hardwareAddress:startDate:endDate:", 1, 1, CFSTR("Sample BT Device"), CFSTR("1:1:1:1:1"), v3, v4);
