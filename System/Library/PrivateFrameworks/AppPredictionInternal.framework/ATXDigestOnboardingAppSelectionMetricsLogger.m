...
{
  void *v3;
  ATXDigestOnboardingAppSelectionMetricsLogger *v4;

  v3 = (void *)objc_opt_new();
  v4 = -[ATXDigestOnboardingAppSelectionMetricsLogger initWithDigestOnboardingAppSelectionLoggingBiomeStream:](self, "initWithDigestOnboardingAppSelectionLoggingBiomeStream:", v3);
...
{
  id v5;
  ATXDigestOnboardingAppSelectionMetricsLogger *v6;
  ATXDigestOnboardingAppSelectionMetricsLogger *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ATXDigestOnboardingAppSelectionMetricsLogger;
  v6 = -[ATXDigestOnboardingAppSelectionMetricsLogger init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (id)digestOnboardingAppSelectionBookmark
{
  ...
  objc_msgSend(MEMORY[0x1E0CF94D8], "bookmarksPathFile:", CFSTR("digestOnboardingAppSelectionBookmark"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (void *)objc_msgSend(v2, "initFileURLWithPath:", v3);

  objc_msgSend(MEMORY[0x1E0CF94A0], "bookmarkFromURLPath:maxFileSize:versionNumber:", v4, 1000000, &unk_1E83CBCC8);
...
- (void)logDigestOnboardingAppSelectionMetricsWithXPCActivity:(id)a3
{
  id v4;
  void *v5;
  ATXDigestOnboardingAppSelectionLoggingBiomeStream *digestOnboardingAppSelectionLoggingBiomeStream;
  double v7;
  void *v8;
  void *v9;
  uint64_t v10;
  ...
  v4 = a3;
  -[ATXDigestOnboardingAppSelectionMetricsLogger digestOnboardingAppSelectionBookmark](self, "digestOnboardingAppSelectionBookmark");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  digestOnboardingAppSelectionLoggingBiomeStream = self->_digestOnboardingAppSelectionLoggingBiomeStream;
  objc_msgSend(MEMORY[0x1E0C99D68], "timeIntervalSinceReferenceDate");
  -[ATXDigestOnboardingAppSelectionLoggingBiomeStream publisherFromStartTime:](digestOnboardingAppSelectionLoggingBiomeStream, "publisherFromStartTime:", v7 + -1209600.0);
  ...
  v17[1] = 3221225472;
  v17[2] = __102__ATXDigestOnboardingAppSelectionMetricsLogger_logDigestOnboardingAppSelectionMetricsWithXPCActivity___block_invoke;
  v17[3] = &unk_1E82DC7A8;
  v19 = v20;
  v17[4] = self;
  v11 = v5;
  ...
  v14[0] = v10;
  v14[1] = 3221225472;
  v14[2] = __102__ATXDigestOnboardingAppSelectionMetricsLogger_logDigestOnboardingAppSelectionMetricsWithXPCActivity___block_invoke_16;
  v14[3] = &unk_1E82DC7D0;
  v12 = v4;
  v15 = v12;
  v16 = v20;
...
uint64_t __102__ATXDigestOnboardingAppSelectionMetricsLogger_logDigestOnboardingAppSelectionMetricsWithXPCActivity___block_invoke_16(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
  void *v5;
...
{
  -[ATXDigestOnboardingAppSelectionMetricsLogger logDigestOnboardingAppSelectionMetricsWithXPCActivity:](self, "logDigestOnboardingAppSelectionMetricsWithXPCActivity:", 0);
}
...
- (void)writeBookmarkToFile:(NSObject *)a3 .cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v9 = 2112;
  v10 = a2;
  _os_log_error_impl(&dword_1C9A3B000, a3, OS_LOG_TYPE_ERROR, "%@ - Unable to save bookmark due to : %@", (uint8_t *)&v7, 0x16u);
