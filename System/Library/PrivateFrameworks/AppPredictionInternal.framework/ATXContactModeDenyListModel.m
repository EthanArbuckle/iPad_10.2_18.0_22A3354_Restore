...
{
  id v7;
  ATXContactModeDenyListModel *v8;
  ...
  v8 = -[ATXContactModeDenyListModel init](&v25, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_mode = a3;
    objc_storeStrong((id *)&v8->_contactStore, a4);
    -[ATXContactModeDenyListModel loadContactModeModel](v9, "loadContactModeModel");
...
- (id)scoredEntities
{
  ...
  _QWORD v23[4];
  id v24;
  ATXContactModeDenyListModel *v25;
  ...
  if (!-[ATXContactNotificationEngagementEventProvider successfullyCalculatedNotificationEvents](self->_contactNotificationEngagementEventProvider, "successfullyCalculatedNotificationEvents"))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      -[ATXContactModeDenyListModel scoredEntities].cold.1(v8);
  ...
  objc_msgSend(v9, "enumerateKeysAndObjectsUsingBlock:", &__block_literal_global_205);
  -[ATXContactModeDenyListModel meContact](self, "meContact");
  ...
  v23[1] = 3221225472;
  v23[2] = __45__ATXContactModeDenyListModel_scoredEntities__block_invoke_19;
  v23[3] = &unk_1E82DB268;
  v24 = v16;
  v25 = self;
  v26 = v13;
...
void __45__ATXContactModeDenyListModel_scoredEntities__block_invoke_19(uint64_t a1, uint64_t a2, void *a3)
{
  void *v4;
  void *v5;
  char v6;
  ...
  if ((v6 & 1) == 0)
  {
    ...
    objc_msgSend(v26, "entity");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "setIsVIPContact:", objc_msgSend(v11, "isVIPContactGivenVIPs:contactStore:", *(_QWORD *)(*(_QWORD *)(a1 + 40) + 40), *(_QWORD *)(*(_QWORD *)(a1 + 40) + 16)));
    ...
    if (v16)
    {
      objc_msgSend(v10, "setIsICloudFamilyMember:", objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 56), "containsObject:", v16));
      objc_msgSend(v10, "setIsEmergencyContact:", objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 48), "containsObject:", v16));
      objc_msgSend(v10, "setIsFavoriteContact:", objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 32), "containsObject:", v16));
...
- (id)meContact
{
  ...
  -[ATXContactModeDenyListModel contactKeysToFetch](self, "contactKeysToFetch");
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      -[ATXContactModeDenyListModel meContact].cold.1((uint64_t)v5, v6, v7, v8, v9, v10, v11, v12);
...
- (id)modelName
{
  return CFSTR("ATXContactModeDenyListModel");
}
...
- (id)loadContactModeModel
{
  ...
  v3 = (void *)objc_opt_new();
  -[ATXContactModeDenyListModel modelName](self, "modelName");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)scoreFromContactFeatures:(id)a3
{
  ...
  if ((unint64_t)objc_msgSend(v4, "uniqueOccurrencesInMode") > 2)
  {
    ...
    -[ATXContactModeDenyListModel featuresToModel:](self, "featuresToModel:", v4);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v32 = 0;
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
        -[ATXContactModeDenyListModel scoreFromContactFeatures:].cold.2((uint64_t)v12, v13, v14, v15, v16, v17, v18, v19);
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        -[ATXContactModeDenyListModel scoreFromContactFeatures:].cold.1((uint64_t)v5, v21, v22, v23, v24, v25, v26, v27);
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315907;
    v34 = "-[ATXContactModeDenyListModel scoreFromContactFeatures:]";
    v35 = 2117;
    v36 = v7;
    v37 = 2048;
    v38 = v8;
...
- (id)purgeDeletedContacts:(id)a3
{
  ...
  if (v14 != objc_msgSend(v11, "count"))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      -[ATXContactModeDenyListModel purgeDeletedContacts:].cold.1(v11, v12, v15);
...
void __45__ATXContactModeDenyListModel_scoredEntities__block_invoke_cold_1(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = 136315651;
  v8 = "-[ATXContactModeDenyListModel scoredEntities]_block_invoke";
  v9 = 2117;
  v10 = a1;
  v11 = 2117;
  v12 = v6;
...
- (void)featuresToModel:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_1C9A3B000, log, OS_LOG_TYPE_FAULT, "contactFeatures.entitySpecificFeatures is not a subclass for ATXContactEntityFeatures", v1, 2u);
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_1C9A3B000, a2, a3, "ATXContactModeDenyListModel - Error during inference on the CoreMLModel: %@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1_0();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_1C9A3B000, a2, a3, "ATXContactModeDenyListModel - Error initializing MLDictionaryFeatureProvider for inference on the CoreMLModel: %@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1_0();
}
...
- (void)purgeDeletedContacts:(NSObject *)a3 .cold.1(void *a1, void *a2, NSObject *a3)
{
  ...
  v6 = 136315394;
  v7 = "-[ATXContactModeDenyListModel purgeDeletedContacts:]";
  v8 = 2048;
