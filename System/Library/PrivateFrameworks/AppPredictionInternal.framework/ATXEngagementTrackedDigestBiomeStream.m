...
{
  void *v3;
  ATXEngagementTrackedDigestBiomeStream *v4;

  v3 = (void *)objc_opt_new();
  v4 = -[ATXEngagementTrackedDigestBiomeStream initFromCompletedDigestBiomeStream:](self, "initFromCompletedDigestBiomeStream:", v3);
...
- (id)initFromCompletedDigestBiomeStream:(id)a3
{
  ...
  v6 = -[ATXEngagementTrackedDigestBiomeStream initFromCompletedDigestBiomeStream:resolutionSource:](self, "initFromCompletedDigestBiomeStream:resolutionSource:", v4, v5);
...
- (id)initFromCompletedDigestBiomeStream:(id)a3 resolutionSource:(id)a4
{
  id v7;
  id v8;
  ATXEngagementTrackedDigestBiomeStream *v9;
  id *p_isa;
  objc_super v12;
  ...
  v9 = -[ATXEngagementTrackedDigestBiomeStream init](&v12, sel_init);
...
- (id)publisherFromStartTime:(double)a3
{
  ...
  -[ATXCompletedDigestBiomeStream publisherFromStartTime:](self->_completedDigestStream, "publisherFromStartTime:", a3);
