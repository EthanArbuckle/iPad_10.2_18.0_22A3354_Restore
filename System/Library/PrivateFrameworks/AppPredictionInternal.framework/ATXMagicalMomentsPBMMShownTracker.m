...
- (id)description
{
  ...
  -[ATXMagicalMomentsPBMMShownTracker description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXMagicalMomentsPBMMShownTracker dictionaryRepresentation](self, "dictionaryRepresentation");
