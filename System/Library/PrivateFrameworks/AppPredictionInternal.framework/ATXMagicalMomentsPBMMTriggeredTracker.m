...
- (id)description
{
  ...
  -[ATXMagicalMomentsPBMMTriggeredTracker description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXMagicalMomentsPBMMTriggeredTracker dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copyWithZone:](self->_abGroup, "copyWithZone:", a3);
  v8 = (void *)v6[1];
  v6[1] = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_anchor != *((_DWORD *)v4 + 4))
      goto LABEL_9;
  }
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSString hash](self->_abGroup, "hash") ^ v2;
}
