...
- (id)description
{
  ...
  -[ATXPBBlendingSessionClientModelUpdate description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXPBBlendingSessionClientModelUpdate dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_suggestions, "count"));
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if (-[ATXPBBlendingSessionClientModelUpdate suggestionsCount](self, "suggestionsCount"))
  {
    objc_msgSend(v8, "clearSuggestions");
    v4 = -[ATXPBBlendingSessionClientModelUpdate suggestionsCount](self, "suggestionsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[ATXPBBlendingSessionClientModelUpdate suggestionAtIndex:](self, "suggestionAtIndex:", i);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addSuggestion:", v15);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](clientModelVersion, "isEqual:")))
  {
    ...
    if ((unint64_t)suggestions | v4[3])
      v8 = -[NSMutableArray isEqual:](suggestions, "isEqual:");
    else
      v8 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v4 = -[NSString hash](self->_clientModelVersion, "hash") ^ v3;
  return v4 ^ -[NSMutableArray hash](self->_suggestions, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[ATXPBBlendingSessionClientModelUpdate addSuggestion:](self, "addSuggestion:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
