...
{
  return -[ATXBiomePredictionContextStream initWithStoreConfig:](self, "initWithStoreConfig:", 0);
}

- (ATXBiomePredictionContextStream)initWithStoreConfig:(id)a3
{
  id v4;
  ATXBiomePredictionContextStream *v5;
  id v6;
  void *v7;
  uint64_t v8;
  BMStoreStream *inner;
  ...
  v5 = -[ATXBiomePredictionContextStream init](&v11, sel_init);
  if (v5)
  {
    if (v4)
    {
    ...
    v7 = v6;
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E0D02790]), "initWithPrivateStreamIdentifier:storeConfig:eventDataClass:", CFSTR("predictionContext"), v6, objc_opt_class());
    inner = v5->_inner;
...
- (NSString)identifier
{
  return (NSString *)CFSTR("predictionContext");
}
...
- (void)sendEvent:(id)a3
{
  ...
  v4 = a3;
  -[ATXBiomePredictionContextStream source](self, "source");
