...
- (id)biomePublisherWithBookmark:(id)a3
{
  ...
  -[ATXAppLaunchMacEventProvider biomePublisherWithBookmark:devicePlatform:startTime:](&v9, sel_biomePublisherWithBookmark_devicePlatform_startTime_, v5, 4, v6 + -2419200.0);
...
- (BOOL)isEventFromProvider:(id)a3
{
  ...
  v5 = -[ATXAppLaunchMacEventProvider isEventFromProvider:](&v7, sel_isEventFromProvider_, v4)
    && (objc_msgSend(v4, "isMacPortable") & 1) != 0;
...
- (id)description
{
  return CFSTR("MacPortableAppLaunches");
}
