...
- (id)makeStacksFromWidgets:(id)a3 pageType:(int64_t)a4 environment:(id)a5
{
  ...
  {
    +[ATXSuggestedPagesUtils filterWidgets:bySize:usedPersonalities:](ATXSuggestedPagesUtils, "filterWidgets:bySize:usedPersonalities:", v6, 2, 0);
...
- (void)layOutStacks:(id)a3 numberOfColumns:(unint64_t)a4 forPageType:(int64_t)a5
{
  ...
  if (objc_msgSend(v7, "count") != 2)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("ATXSuggestedPagesStackLayoutTwoLarge.m"), 46, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("stacks.count == 2"));
