...
- (ATXAppModeModel)initWithMode:(unint64_t)a3 modeEntityStore:(id)a4 globalAppModeAffinityModel:(id)a5
{
  ...
  v11 = -[ATXAppModeModel init](&v22, sel_init);
  v12 = v11;
  if (v11)
  {
    v11->_mode = a3;
    -[ATXAppModeModel loadAppModeCoreMLModel](v11, "loadAppModeCoreMLModel");
...
- (id)scoredEntities
{
  ...
  -[ATXGlobalAppModeAffinityModel bundleIds](self->_globalAppModeAffinityModel, "bundleIds");
  ...
  if (self->_modeEventProvider)
  {
    ...
    if (!-[ATXAppInterruptionsEventProvider successfullyCalculatedAppSessionInterruptions](self->_appInterruptionsEventProvider, "successfullyCalculatedAppSessionInterruptions"))
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        -[ATXAppModeModel scoredEntities].cold.2(v18, v19, v20, v21, v22, v23, v24, v25);
    ...
    if (!-[ATXAppNotificationEngagementEventProvider successfullyCalculatedNotificationEvents](self->_appNotificationEngagementEventProvider, "successfullyCalculatedNotificationEvents"))
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        -[ATXAppModeModel scoredEntities].cold.1(v28, v29, v30, v31, v32, v33, v34, v35);
    ...
    v45[0] = v8;
    v45[1] = 3221225472;
    v45[2] = __33__ATXAppModeModel_scoredEntities__block_invoke;
    v45[3] = &unk_1E82DB268;
    v46 = v6;
    v47 = self;
    v48 = v3;
  ...
  v42[0] = v8;
  v42[1] = *((_QWORD *)v9 + 357);
  v42[2] = __33__ATXAppModeModel_scoredEntities__block_invoke_2;
  v42[3] = &unk_1E82E72D0;
  v42[4] = self;
  v37 = v3;
  v43 = v37;
...
- (id)scoredAppModeEntityWithAppFeatures:(id)a3 bundleId:(id)a4
{
  ...
  -[ATXAppModeModel addEntitySpecificFeaturesToAppFeatures:](self, "addEntitySpecificFeaturesToAppFeatures:", v6);
  -[ATXAppModeModel scoreFromAppFeatures:](self, "scoreFromAppFeatures:", v6);
  v16 = v15;
...
- (void)addEntitySpecificFeaturesToAppFeatures:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v8)
    {
      ...
      -[ATXAppModeModel addAppInterruptingSignalsForIdentifier:toAppSpecificFeatures:](self, "addAppInterruptingSignalsForIdentifier:toAppSpecificFeatures:", v22, v18);

      objc_msgSend(v37, "entity");
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v23, "identifier");
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      -[ATXAppModeModel addNotificationsSignalsForIdentifier:toAppSpecificFeatures:](self, "addNotificationsSignalsForIdentifier:toAppSpecificFeatures:", v24, v18);

      objc_msgSend(v37, "entity");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v25, "identifier");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      -[ATXAppModeModel addGlobalModeAffinityPriorsForIdentifier:toAppSpecificFeatures:](self, "addGlobalModeAffinityPriorsForIdentifier:toAppSpecificFeatures:", v26, v18);
...
- (void)addGlobalModeAffinityPriorsForIdentifier:(id)a3 toAppSpecificFeatures:(id)a4
{
  ...
  objc_msgSend(v5, "numberWithDouble:", v12);
  v13 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "setGlobalModeAffinityPrior:", v13);
...
- (id)featuresToModel:(id)a3
{
  ...
  v11 = (void *)MEMORY[0x1E0CB37E8];
  v12 = (double)(unint64_t)objc_msgSend(v4, "localOccurrences");
  objc_msgSend(v8, "globalModeAffinityPrior");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "doubleValue");
  v15 = v14 + v12;
  v16 = (double)(unint64_t)objc_msgSend(v4, "globalOccurrences");
  ...
  objc_msgSend(v11, "numberWithDouble:", v15 / (v17 + v16 + 0.00000001));
  v45 = (void *)objc_claimAutoreleasedReturnValue();

  v18 = (void *)MEMORY[0x1E0CB37E8];
  v19 = (double)(unint64_t)objc_msgSend(v4, "uniqueOccurrencesInMode");
  objc_msgSend(v8, "globalModeAffinityPrior");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "doubleValue");
  v22 = v21 + v19;
  v23 = (double)(unint64_t)objc_msgSend(v4, "modeOccurrences");
  -[ATXModeAffinityModelsConstants scalingFactorForModeGlobalPriors](self->_modeAffinityModelsConstants, "scalingFactorForModeGlobalPriors");
  objc_msgSend(v18, "numberWithDouble:", v22 / (v24 + v23 + 0.00000001));
  v43 = (void *)objc_claimAutoreleasedReturnValue();

  v25 = (void *)MEMORY[0x1E0CB37E8];
  v26 = (double)(unint64_t)objc_msgSend(v4, "localOccurrences");
  objc_msgSend(v8, "globalModeAffinityPrior");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v27, "doubleValue");
  v29 = v28 + v26;
  v30 = objc_msgSend(v4, "localOccurrencesAcrossAllEntities");

  -[ATXModeAffinityModelsConstants scalingFactorForModeGlobalPriors](self->_modeAffinityModelsConstants, "scalingFactorForModeGlobalPriors");
  objc_msgSend(v25, "numberWithDouble:", v29 / (v31 + (double)v30 + 0.00000001));
  ...
  objc_msgSend(v36, "setObject:forKey:", v60, CFSTR("entityOccurredGloballyOverTheLastNDays"));
  objc_msgSend(v36, "setObject:forKey:", v59, CFSTR("entityOccurredInModeOverLastNDays"));
  objc_msgSend(v36, "setObject:forKey:", v63, CFSTR("appCategoryScore"));
  objc_msgSend(v36, "setObject:forKey:", v45, CFSTR("classConditionalProbabilityOfModeGivenEntity"));
  objc_msgSend(v36, "setObject:forKey:", v61, CFSTR("globalOccurrencesOfEntity"));
  objc_msgSend(v36, "setObject:forKey:", v62, CFSTR("globalPopularityForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v58, CFSTR("localOccurrencesOfEntityInMode"));
  objc_msgSend(v36, "setObject:forKey:", v44, CFSTR("modePopularityForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v43, CFSTR("posteriorProbabilityOfEntityGivenMode"));
  objc_msgSend(v36, "setObject:forKey:", v57, CFSTR("ratioOfModePopularityToGlobalPopularityOfEntity"));
  objc_msgSend(v36, "setObject:forKey:", v56, CFSTR("uniqueOccurrencesOfEntityInMode"));
  objc_msgSend(v36, "setObject:forKey:", v55, CFSTR("globalModeAffinityPrior"));
  objc_msgSend(v36, "setObject:forKey:", v54, CFSTR("modeAppInterruptionsCountByEntity"));
  objc_msgSend(v36, "setObject:forKey:", v53, CFSTR("globalAppInterruptionsCountByEntity"));
  objc_msgSend(v36, "setObject:forKey:", v52, CFSTR("modePopularityOfInterruptingEntity"));
  objc_msgSend(v36, "setObject:forKey:", v38, CFSTR("globalPopularityOfInterruptingEntity"));
  objc_msgSend(v36, "setObject:forKey:", v51, CFSTR("modeAppInterruptionsClassConditionalProbabilityByEntity"));
  objc_msgSend(v36, "setObject:forKey:", v50, CFSTR("ratioOfModePopularityToGlobalPopularityOfInterruptingEntity"));
  objc_msgSend(v36, "setObject:forKey:", v49, CFSTR("globalCountOfNotificationsReceivedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v48, CFSTR("modeCountOfNotificationsReceivedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v47, CFSTR("localPopularityOfNotificationsReceivedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v46, CFSTR("globalPopularityOfNotificationsReceivedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v32, CFSTR("ratioOfLocalToGlobalPopularityOfNotificationsReceivedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v33, CFSTR("classConditionalOfNotificationsReceivedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v34, CFSTR("modeCountOfNotificationsClearedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v39, CFSTR("localNotificationsClearedRateForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v35, CFSTR("globalNotificationsClearedRateForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v40, CFSTR("globalCountOfNotificationsClearedForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v41, CFSTR("ratioOfLocalToGlobalNotificationsClearedRateForEntity"));
  objc_msgSend(v36, "setObject:forKey:", v42, CFSTR("classConditionalOfNotificationsClearedForEntity"));
...
- (id)modelName
{
  return CFSTR("ATXAppModeAllowListModel");
}
...
- (id)loadAppModeCoreMLModel
{
  ...
  v3 = (void *)objc_opt_new();
  -[ATXAppModeModel modelName](self, "modelName");
...
- (double)scoreFromAppFeatures:(id)a3
{
  ...
  if (self->_appModeModel)
  {
    ...
    -[ATXAppModeModel featuresToModel:](self, "featuresToModel:", v4);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v31 = 0;
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
        -[ATXAppModeModel scoreFromAppFeatures:].cold.2((uint64_t)v8, v9, v10, v11, v12, v13, v14, v15);
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        -[ATXAppModeModel scoreFromAppFeatures:].cold.1((uint64_t)v18, v19, v20, v21, v22, v23, v24, v25);
...
- (void)scoredEntities
{
  OUTLINED_FUNCTION_3(&dword_1C9A3B000, a1, a3, "ATXAppModeModel: There was an error in calculating app session interruptions from ATXAppInterruptionsEventProvider", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_4();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_1C9A3B000, a2, a3, "ATXAppModeModel - Error during inference on the CoreMLModel: %@", a5, a6, a7, a8, 2u);
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_1C9A3B000, a2, a3, "ATXAppModeModel - Error initializing MLDictionaryFeatureProvider for inference on the CoreMLModel: %@", a5, a6, a7, a8, 2u);
}
