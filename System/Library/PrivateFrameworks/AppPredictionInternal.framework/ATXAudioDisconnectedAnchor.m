...
+ (id)longDescription
{
  return CFSTR("Wired audio device is disconnected.");
}
...
+ (id)predicateForContextStoreRegistration
{
  ...
  objc_msgSend(MEMORY[0x1E0D15C58], "predicateForAudioOutputStatus:", 0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (BOOL)isActive
{
  ...
  v3 = objc_msgSend(v2, "audioState") == 0;
...
+ (id)sampleEvent
{
  ...
  v5 = -[ATXAudioDuetEvent initWithAudioState:deviceIdentifier:portType:portName:routeChangeReason:startDate:endDate:](v2, "initWithAudioState:deviceIdentifier:portType:portName:routeChangeReason:startDate:endDate:", 0, CFSTR("Headphones"), CFSTR("Headphones"), CFSTR("Headphones"), &unk_1E83CDBD0, v3, v4);
