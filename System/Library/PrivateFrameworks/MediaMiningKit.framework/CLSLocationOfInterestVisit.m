...
- (CLSLocationOfInterestVisit)initWithIdentifier:(id)a3 visitInterval:(id)a4 confidence:(double)a5
{
  id v9;
  id v10;
  CLSLocationOfInterestVisit *v11;
  CLSLocationOfInterestVisit *v12;
  objc_super v14;
  ...
  v11 = -[CLSLocationOfInterestVisit init](&v14, sel_init);
  v12 = v11;
  if (v11)
  {
...
- (CLSLocationOfInterestVisit)initWithCoder:(id)a3
{
  ...
  v7 = -[CLSLocationOfInterestVisit initWithIdentifier:visitInterval:confidence:](self, "initWithIdentifier:visitInterval:confidence:", v5, v6);
  if (v7)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      identifier = self->_identifier;
      -[CLSLocationOfInterestVisit identifier](v4, "identifier");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)description
{
  ...
  -[CLSLocationOfInterestVisit description](&v7, sel_description);
...
{
  return (CLSLocationOfInterest *)objc_loadWeakRetained((id *)&self->_locationOfInterest);
}
