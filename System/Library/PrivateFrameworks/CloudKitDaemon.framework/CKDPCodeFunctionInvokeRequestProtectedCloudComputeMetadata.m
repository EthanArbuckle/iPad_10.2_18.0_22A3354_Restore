...
- (id)description
{
  ...
  -[CKDPCodeFunctionInvokeRequestProtectedCloudComputeMetadata description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_cryptoSessions, v5, v6))
  {
    ...
    v10 = objc_msgSend_count(self->_cryptoSessions, v8, v9);
    ...
    objc_msgSend_setObject_forKey_(v4, v23, (uint64_t)v12, CFSTR("cryptoSessions"));
  }
  return v4;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEB037B8(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_cryptoSessionsCount(self, v4, v5))
  {
    ...
    v10 = objc_msgSend_cryptoSessionsCount(self, v8, v9);
    if (v10)
    {
      v12 = v10;
      for (i = 0; i != v12; ++i)
      {
        objc_msgSend_cryptoSessionsAtIndex_(self, v11, i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    ...
    if ((unint64_t)cryptoSessions | v9)
      isEqual = objc_msgSend_isEqual_(cryptoSessions, v7, v9);
    else
      isEqual = 1;
  }
  else
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addCryptoSessions_(self, v7, *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
...
{
  objc_storeStrong((id *)&self->_cryptoSessions, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_cryptoSessions, 0);
}
