...
- (id)description
{
  ...
  -[CKDPConfigurationField description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (value)
  {
    objc_msgSend_dictionaryRepresentation(value, v5, (uint64_t)name);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEA8AB98((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((name = self->_name, v9 = v4[1], !((unint64_t)name | v9))
