...
+ (id)options
{
  if (qword_1ED700A60 != -1)
    dispatch_once(&qword_1ED700A60, &unk_1E7835FE0);
  return (id)qword_1ED700A58;
}
...
- (id)description
{
  ...
  -[CKDPMergeableDeltaMetadataRetrieveRequest description](&v11, sel_description);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEBA32F4((uint64_t)self, (uint64_t)a3);
}
