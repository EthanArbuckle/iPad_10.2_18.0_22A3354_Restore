...
- (id)description
{
  ...
  -[CKDPUserInformationBlockedRequestAccess description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend_dictionaryRepresentation(contactInformation, v5, (uint64_t)userId);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v6, v10, (uint64_t)v9, CFSTR("contactInformation"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v15 = objc_msgSend_copyWithZone_(self->_contactInformation, v14, (uint64_t)a3);
  v16 = (void *)v10[1];
  v10[1] = v15;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((userId = self->_userId, v9 = v4[2], !((unint64_t)userId | v9))
