...
- (id)description
{
  ...
  -[CKDPAdopterFeatureSetAdopterFeature description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  value = self->_value;
  if (value)
    objc_msgSend_setObject_forKey_(v6, v5, (uint64_t)value, CFSTR("value"));
  return v6;
}

- (BOOL)readFrom:(id)a3
{
  return sub_1BEB05E58((uint64_t)self, (uint64_t)a3);
}
