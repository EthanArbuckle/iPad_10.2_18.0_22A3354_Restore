...
- (id)description
{
  ...
  -[CKDPFieldActionReplaceListRange description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (range)
  {
    objc_msgSend_dictionaryRepresentation(range, v4, v5);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v6, v9, (uint64_t)v8, CFSTR("range"));
  ...
  if (objc_msgSend_count(self->_values, v4, v5))
  {
    ...
    objc_msgSend_setObject_forKey_(v6, v26, (uint64_t)v15, CFSTR("value"));
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEAA1248((id *)&self->super.super.isa, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_valuesCount(self, v4, (uint64_t)range))
  {
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        objc_msgSend_valueAtIndex_(self, v11, i);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_range, v11, (uint64_t)a3);
  v13 = (void *)v10[1];
  v10[1] = v12;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((range = self->_range, v9 = v4[1], !((unint64_t)range | v9))
...
- (unint64_t)hash
{
  ...
  v4 = objc_msgSend_hash(self->_range, a2, v2);
