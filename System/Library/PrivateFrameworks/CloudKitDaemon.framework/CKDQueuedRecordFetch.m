...
- (void)addRequestForRecordID:(id)a3 forOperation:(id)a4 withCompletionHandler:(id)a5
{
  ...
  if (!v32)
  {
    ...
    objc_msgSend_handleFailureInMethod_object_file_lineNumber_description_(v28, v29, (uint64_t)a2, self, CFSTR("CKDQueuedRecordFetch.m"), 18, CFSTR("Record ID required when fetching record PCS: %@"), self);
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    objc_msgSend_handleFailureInMethod_object_file_lineNumber_description_(v30, v31, (uint64_t)a2, self, CFSTR("CKDQueuedRecordFetch.m"), 19, CFSTR("Record ID was submitted to the wrong kind of fetcher: %@"), self);
...
- (void)createFetchOperationForItemIDs:(id)a3 operationQueue:(id)a4 operationConfigurationBlock:(id)a5
{
  ...
  objc_msgSend_setDesiredKeys_(v11, v14, MEMORY[0x1E0C9AA60]);
  objc_msgSend_initialOperation(self, v15, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = objc_opt_class();
