...
+ (id)options
{
  if (qword_1ED702B70 != -1)
    dispatch_once(&qword_1ED702B70, &unk_1E78377C0);
  return (id)qword_1ED702B68;
}
...
- (id)description
{
  ...
  -[CKDPSubscriptionDeleteRequest description](&v11, sel_description);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEBFF580((uint64_t)self, (uint64_t)a3);
}
