...
- (id)description
{
  ...
  -[CKDPPackageManifestHeader description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (verificationKey)
    objc_msgSend_setObject_forKey_(v5, v4, (uint64_t)verificationKey, CFSTR("verificationKey"));
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v16 = objc_msgSend_copyWithZone_(self->_verificationKey, v15, (uint64_t)a3);
  v17 = (void *)v12[2];
  v12[2] = v16;
