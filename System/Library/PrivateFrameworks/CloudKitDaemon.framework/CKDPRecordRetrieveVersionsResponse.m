...
- (id)description
{
  ...
  -[CKDPRecordRetrieveVersionsResponse description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend_numberWithBool_(MEMORY[0x1E0CB37E8], v4, self->_isDeleted);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v6, v8, (uint64_t)v7, CFSTR("isDeleted"));
  ...
  if (objc_msgSend_count(self->_recordVersions, v4, v5))
  {
    ...
    objc_msgSend_setObject_forKey_(v6, v25, (uint64_t)v14, CFSTR("recordVersions"));
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEAE0CF8(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_recordVersionsCount(self, v5, v6))
  {
    ...
    if (v11)
    {
      ...
      for (i = 0; i != v13; ++i)
      {
        objc_msgSend_recordVersionsAtIndex_(self, v12, i);
...
LABEL_12:
  ...
  if ((unint64_t)recordVersions | v11)
    isEqual = objc_msgSend_isEqual_(recordVersions, v7, v11);
  else
    isEqual = 1;
LABEL_7:
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addRecordVersions_(self, v9, *(_QWORD *)(*((_QWORD *)&v13 + 1) + 8 * v12++), (_QWORD)v13);
      }
      while (v10 != v12);
...
{
  objc_storeStrong((id *)&self->_recordVersions, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_recordVersions, 0);
}
