...
- (id)description
{
  ...
  -[CKDPMergeableDeltaMetadataRetrieveResponse description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_metadatas, v5, v6))
  {
    ...
    objc_msgSend_setObject_forKey_(v4, v24, (uint64_t)v13, CFSTR("metadata"));
  }
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEAF6F7C(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_metadatasCount(self, v4, v5))
  {
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v11; ++i)
      {
        objc_msgSend_metadataAtIndex_(self, v6, i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((metadatas = self->_metadatas, v9 = v4[2], !((unint64_t)metadatas | v9))
...
- (unint64_t)hash
{
  ...
  v4 = objc_msgSend_hash(self->_metadatas, a2, v2);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v15 != v10)
          objc_enumerationMutation(v5);
        objc_msgSend_addMetadata_(self, v8, *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * i), (_QWORD)v14);
      }
...
{
  objc_storeStrong((id *)&self->_metadatas, a3);
}
