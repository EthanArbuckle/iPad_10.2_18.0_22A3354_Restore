...
- (id)description
{
  ...
  -[CKDPRecordSaveRequestShareIdUpdate description](&v11, sel_description);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEC7CD9C((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    ...
    if ((unint64_t)shareId | v9)
      isEqual = objc_msgSend_isEqual_(shareId, v7, v9);
    else
      isEqual = 1;
  }
  else
