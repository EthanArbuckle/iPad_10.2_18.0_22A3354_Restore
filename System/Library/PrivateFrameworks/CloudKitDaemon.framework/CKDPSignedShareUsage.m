...
- (id)description
{
  ...
  -[CKDPSignedShareUsage description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (shareUsage)
    objc_msgSend_setObject_forKey_(v5, v4, (uint64_t)shareUsage, CFSTR("shareUsage"));
  return v5;
}

- (BOOL)readFrom:(id)a3
{
  return sub_1BEC67284((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v16 = objc_msgSend_copyWithZone_(self->_shareUsage, v15, (uint64_t)a3);
  v17 = (void *)v12[1];
  v12[1] = v16;
...
LABEL_11:
  ...
  if ((unint64_t)shareUsage | v11)
    isEqual = objc_msgSend_isEqual_(shareUsage, v7, v11);
  else
    isEqual = 1;
LABEL_12:
...
{
  objc_storeStrong((id *)&self->_shareUsage, a3);
}
