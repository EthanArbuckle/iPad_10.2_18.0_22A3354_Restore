...
+ (id)options
{
  if (qword_1ED702768 != -1)
    dispatch_once(&qword_1ED702768, &unk_1E7830418);
  return (id)qword_1ED702760;
}
...
- (id)description
{
  ...
  -[CKDPArchiveRecordsRequest description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_idsToArchives, v5, v6))
  {
    ...
    objc_msgSend_setObject_forKey_(v4, v23, (uint64_t)v12, CFSTR("idsToArchive"));
  }
  return v4;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEA3B584(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_idsToArchivesCount(self, v4, v5))
  {
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        objc_msgSend_idsToArchiveAtIndex_(self, v11, i);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addIdsToArchive_(self, v7, *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
...
{
  objc_storeStrong((id *)&self->_idsToArchives, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_idsToArchives, 0);
}
