...
- (id)description
{
  ...
  -[CKDPShareAccessBlockedRequesters description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_blockedUsers, v5, v6))
  {
    ...
    objc_msgSend_setObject_forKey_(v4, v23, (uint64_t)v12, CFSTR("blockedUsers"));
  }
  return v4;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEB3A704(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_blockedUsersCount(self, v4, v5))
  {
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        objc_msgSend_blockedUsersAtIndex_(self, v11, i);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addBlockedUsers_(self, v7, *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
...
{
  objc_storeStrong((id *)&self->_blockedUsers, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_blockedUsers, 0);
}
