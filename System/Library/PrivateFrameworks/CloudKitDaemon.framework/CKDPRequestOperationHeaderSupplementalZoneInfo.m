...
- (id)description
{
  ...
  -[CKDPRequestOperationHeaderSupplementalZoneInfo description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (syncContinuationToken)
    objc_msgSend_setObject_forKey_(v6, v4, (uint64_t)syncContinuationToken, CFSTR("syncContinuationToken"));
  return v6;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v15 = objc_msgSend_copyWithZone_(self->_syncContinuationToken, v14, (uint64_t)a3);
  v16 = (void *)v10[1];
  v10[1] = v15;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((zoneIdentifier = self->_zoneIdentifier, v9 = v4[2], !((unint64_t)zoneIdentifier | v9))
