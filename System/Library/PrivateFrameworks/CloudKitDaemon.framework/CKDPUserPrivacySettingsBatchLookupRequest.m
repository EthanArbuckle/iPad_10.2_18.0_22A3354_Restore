...
+ (id)options
{
  if (qword_1ED702CB8 != -1)
    dispatch_once(&qword_1ED702CB8, &unk_1E7838620);
  return (id)qword_1ED702CB0;
}
...
- (id)description
{
  ...
  -[CKDPUserPrivacySettingsBatchLookupRequest description](&v11, sel_description);
