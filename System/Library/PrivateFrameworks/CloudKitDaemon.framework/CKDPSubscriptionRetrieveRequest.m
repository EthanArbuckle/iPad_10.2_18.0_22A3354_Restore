...
+ (id)options
{
  if (qword_1ED702AB0 != -1)
    dispatch_once(&qword_1ED702AB0, &unk_1E7834960);
  return (id)qword_1ED702AA8;
}
...
- (id)description
{
  ...
  -[CKDPSubscriptionRetrieveRequest description](&v11, sel_description);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEB58B78((uint64_t)self, (uint64_t)a3);
}
