...
{
  id v7;
  CKDAnonymousShareAddURLRequest *v8;
  CKDAnonymousShareAddURLRequest *v9;
  uint64_t v10;
...
- (void)fillOutEquivalencyPropertiesBuilder:(id)a3
{
  ...
  objc_msgSend_encryptedAnonymousSharesToAdd(self, v6, v7, v15.receiver, v15.super_class);
...
- (id)generateRequestOperations
{
  ...
  v45 = (id)objc_opt_new();
  objc_msgSend_encryptedAnonymousSharesToAdd(self, v3, v4);
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_anonymousShareAddRequest(v19, v22, v23);
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend_setAnonymousShareTupleHash_(v24, v25, v16);
        objc_msgSend_encryptedAnonymousSharesToAdd(self, v26, v27);
        ...
        objc_msgSend_encryptedAnonymousShareHashToAddByRequestID(self, v32, v33);
...
- (id)requestDidParseProtobufObject:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend_encryptedAnonymousShareHashToAddByRequestID(self, v5, v6);
  ...
  objc_msgSend_anonymousShareSavedBlock(self, v16, v17);
...
{
  objc_storeStrong((id *)&self->_encryptedAnonymousShareHashToAddByRequestID, a3);
}
