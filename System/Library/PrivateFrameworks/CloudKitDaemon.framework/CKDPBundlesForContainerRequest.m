...
+ (id)options
{
  if (qword_1ED702CA8 != -1)
    dispatch_once(&qword_1ED702CA8, &unk_1E78385A0);
  return (id)qword_1ED702CA0;
}
...
- (id)description
{
  ...
  -[CKDPBundlesForContainerRequest description](&v11, sel_description);
