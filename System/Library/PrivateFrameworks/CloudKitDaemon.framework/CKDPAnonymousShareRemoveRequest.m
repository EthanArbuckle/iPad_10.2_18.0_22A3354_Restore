...
+ (id)options
{
  if (qword_1ED7008B0 != -1)
    dispatch_once(&qword_1ED7008B0, &unk_1E7830BF0);
  return (id)qword_1ED7008A8;
}
...
- (id)description
{
  ...
  -[CKDPAnonymousShareRemoveRequest description](&v11, sel_description);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEA51710((uint64_t)self, (uint64_t)a3);
}
