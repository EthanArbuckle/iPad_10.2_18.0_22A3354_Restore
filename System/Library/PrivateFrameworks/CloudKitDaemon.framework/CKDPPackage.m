...
- (id)description
{
  ...
  -[CKDPPackage description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (manifest)
  {
    objc_msgSend_dictionaryRepresentation(manifest, v4, v5);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v6, v9, (uint64_t)v8, CFSTR("manifest"));

  }
  if (objc_msgSend_count(self->_sections, v4, v5))
  {
    v10 = objc_alloc(MEMORY[0x1E0C99DE8]);
    v13 = objc_msgSend_count(self->_sections, v11, v12);
    ...
    objc_msgSend_setObject_forKey_(v6, v26, (uint64_t)v15, CFSTR("sections"));
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEC1B3BC((id *)&self->super.super.isa, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_sectionsCount(self, v4, (uint64_t)manifest))
  {
    ...
    v10 = objc_msgSend_sectionsCount(self, v8, v9);
    if (v10)
    {
      v12 = v10;
      for (i = 0; i != v12; ++i)
      {
        objc_msgSend_sectionsAtIndex_(self, v11, i);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_manifest, v11, (uint64_t)a3);
  v13 = (void *)v10[1];
  v10[1] = v12;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((manifest = self->_manifest, v9 = v4[1], !((unint64_t)manifest | v9))
     || objc_msgSend_isEqual_(manifest, v7, v9)))
  {
    sections = self->_sections;
    v11 = v4[2];
    if ((unint64_t)sections | v11)
      isEqual = objc_msgSend_isEqual_(sections, v7, v11);
    else
      isEqual = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v4 = objc_msgSend_hash(self->_manifest, a2, v2);
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        objc_msgSend_addSections_(self, v11, *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * i), (_QWORD)v15);
      }
