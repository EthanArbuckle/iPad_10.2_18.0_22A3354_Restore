...
- (id)description
{
  ...
  -[CKDPMoveOplockFailure description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend_dictionaryRepresentation(movedRecordDestinationIdentifier, v4, v5);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v6, v9, (uint64_t)v8, CFSTR("movedRecordDestinationIdentifier"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEB08B9C((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_movedRecordDestinationIdentifier, v11, (uint64_t)a3);
  v13 = (void *)v10[1];
  v10[1] = v12;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (movedRecordDestinationIdentifier)
  {
    ...
    {
      v7 = v4;
      objc_msgSend_mergeFrom_(movedRecordDestinationIdentifier, (const char *)v4, v6);
LABEL_6:
      v4 = v7;
    }
  }
  ...
  {
    v7 = v4;
    objc_msgSend_setMovedRecordDestinationIdentifier_(self, (const char *)v4, v6);
    goto LABEL_6;
  }
...
{
  objc_storeStrong((id *)&self->_movedRecordDestinationIdentifier, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_movedRecordDestinationIdentifier, 0);
}
