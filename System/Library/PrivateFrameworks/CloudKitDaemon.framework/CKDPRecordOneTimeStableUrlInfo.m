...
- (id)description
{
  ...
  -[CKDPRecordOneTimeStableUrlInfo description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_oneTimeUrls, v5, v6))
  {
    ...
    v10 = objc_msgSend_count(self->_oneTimeUrls, v8, v9);
    ...
    objc_msgSend_setObject_forKey_(v4, v23, (uint64_t)v12, CFSTR("oneTimeUrl"));
  }
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_oneTimeUrlsCount(self, v4, v5))
  {
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        objc_msgSend_oneTimeUrlAtIndex_(self, v11, i);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addOneTimeUrl_(self, v7, *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
...
{
  objc_storeStrong((id *)&self->_oneTimeUrls, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_oneTimeUrls, 0);
}
