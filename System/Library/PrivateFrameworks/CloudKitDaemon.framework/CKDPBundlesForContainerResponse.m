...
- (id)description
{
  ...
  -[CKDPBundlesForContainerResponse description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  bundleIDs = self->_bundleIDs;
  if (bundleIDs)
    objc_msgSend_setObject_forKey_(v4, v5, (uint64_t)bundleIDs, CFSTR("bundleID"));
  return v6;
}

- (BOOL)readFrom:(id)a3
{
  return sub_1BEAEF8B0(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_bundleIDsCount(self, v4, v5))
  {
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        objc_msgSend_bundleIDAtIndex_(self, v11, i);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addBundleID_(self, v7, *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
