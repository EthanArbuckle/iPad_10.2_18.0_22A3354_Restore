...
- (id)description
{
  ...
  -[CKDPZoneUsage description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (zoneIdentifier)
  {
    ...
    objc_msgSend_setObject_forKey_(v6, v20, (uint64_t)v19, CFSTR("zoneIdentifier"));
...
LABEL_42:
          ...
          goto LABEL_43;
        case 2u:
          v25 = objc_alloc_init(MEMORY[0x1E0C94C60]);
          objc_storeStrong((id *)&self->_time, v25);
          if (!PBReaderPlaceMark() || (CKDPDateReadFrom() & 1) == 0)
            goto LABEL_45;
          goto LABEL_38;
        case 3u:
          v25 = objc_alloc_init(MEMORY[0x1E0C94C70]);
          v26 = 8;
          goto LABEL_33;
        case 4u:
          v25 = objc_alloc_init(MEMORY[0x1E0C94C70]);
...
LABEL_33:
          ...
          goto LABEL_38;
        case 5u:
          v25 = objc_alloc_init(MEMORY[0x1E0C94C98]);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v22 = objc_msgSend_copyWithZone_(self->_zoneIdentifier, v21, (uint64_t)a3);
  v23 = (void *)v12[5];
  v12[5] = v22;
