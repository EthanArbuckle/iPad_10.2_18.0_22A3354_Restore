...
+ (id)options
{
  if (qword_1ED702860 != -1)
    dispatch_once(&qword_1ED702860, &unk_1E78333F8);
  return (id)qword_1ED702858;
}
...
- (id)description
{
  ...
  -[CKDPUserPrivacySettingsRetrieveRequest description](&v11, sel_description);
