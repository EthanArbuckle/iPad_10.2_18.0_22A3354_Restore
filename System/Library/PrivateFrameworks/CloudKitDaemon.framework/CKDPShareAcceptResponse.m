...
- (id)description
{
  ...
  -[CKDPShareAcceptResponse description](&v11, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (share)
  {
    ...
    objc_msgSend_setObject_forKey_(v6, v9, (uint64_t)v8, CFSTR("share"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEB00544((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_share, v11, (uint64_t)a3);
  v13 = (void *)v10[1];
  v10[1] = v12;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (share)
  {
    ...
    {
      v7 = v4;
      objc_msgSend_mergeFrom_(share, (const char *)v4, v6);
LABEL_6:
      v4 = v7;
    }
  }
  ...
  {
    v7 = v4;
    objc_msgSend_setShare_(self, (const char *)v4, v6);
    goto LABEL_6;
  }
