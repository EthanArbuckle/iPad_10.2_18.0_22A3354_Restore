...
{
  id v7;
  CKDDeclineSharesURLRequest *v8;
  CKDDeclineSharesURLRequest *v9;
  uint64_t v10;
...
- (id)zoneIDsToLock
{
  ...
  v25 = 0u;
  v26 = 0u;
  objc_msgSend_shareMetadatasToDecline(self, v4, v5, 0);
...
- (void)fillOutEquivalencyPropertiesBuilder:(id)a3
{
  ...
  objc_msgSend_shareMetadatasToDecline(self, v6, v7, v15.receiver, v15.super_class);
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v4, v14, (uint64_t)v13, CFSTR("shareMetadatas"));
}
...
- (void)fillOutRequestProperties:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend_shareMetadatasToDecline(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_CKMap_(v7, v8, (uint64_t)&unk_1E7833508);
...
- (id)generateRequestOperations
{
  ...
  v6 = objc_msgSend_countByEnumeratingWithState_objects_count_(obj, v5, (uint64_t)&v46, v50, 16);
  if (v6)
  {
    v9 = v6;
    v10 = *(_QWORD *)v47;
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_shareRecordID(v12, v21, v22);
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend_pShareIdentifierFromRecordID_(v20, v24, (uint64_t)v23);
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend_setShareId_(v16, v26, (uint64_t)v25);

        objc_msgSend_participantID(v12, v27, v28);
        v29 = (void *)objc_claimAutoreleasedReturnValue();

        if (v29)
        {
          objc_msgSend_participantID(v12, v30, v31);
        ...
        objc_msgSend_request(v15, v35, v36);
      ...
      while (v9 != v11);
      v9 = objc_msgSend_countByEnumeratingWithState_objects_count_(obj, v7, (uint64_t)&v46, v50, 16);
    }
    while (v9);
  }
...
- (id)requestDidParseProtobufObject:(id)a3
{
  ...
  objc_msgSend_shareDeclinedBlock(self, v16, v17);
...
- (void)requestDidParseNodeFailure:(id)a3
{
  ...
  objc_msgSend_shareDeclinedBlock(self, v15, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
