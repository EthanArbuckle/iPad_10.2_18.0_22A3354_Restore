...
- (CKDAddAnonymousShareToSharedDBOperation)initWithOperationInfo:(id)a3 container:(id)a4
{
  ...
  const char *v7;
  uint64_t v8;
  CKDAddAnonymousShareToSharedDBOperation *v9;
  uint64_t v10;
  ...
  if (v9)
  {
    objc_msgSend_encryptedAnonymousSharesToAdd(v6, v7, v8);
    v10 = objc_claimAutoreleasedReturnValue();
    encryptedAnonymousSharesToAdd = v9->_encryptedAnonymousSharesToAdd;
    v9->_encryptedAnonymousSharesToAdd = (NSDictionary *)v10;

    objc_msgSend_anonymousShareSavedBlock(v6, v12, v13);
    v14 = objc_claimAutoreleasedReturnValue();
    anonymousShareSavedBlock = v9->_anonymousShareSavedBlock;
    v9->_anonymousShareSavedBlock = (id)v14;
...
- (id)activityCreate
{
  return _os_activity_create(&dword_1BE990000, "daemon/AddAnonymousShareToSharedDB", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
+ (id)nameForState:(unint64_t)a3
{
  ...
  if (a3 == 2)
  {
    v5 = CFSTR("Call _addAnonymousShareToSharedDB");
  }
  else
  {
    v8 = v3;
...
{
  CKDAnonymousShareAddURLRequest *v3;
  const char *v4;
  uint64_t v5;
  void *v6;
  const char *v7;
  ...
  v3 = [CKDAnonymousShareAddURLRequest alloc];
  objc_msgSend_encryptedAnonymousSharesToAdd(self, v4, v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend_initWithOperation_encryptedAnonymousSharesToAdd_(v3, v7, (uint64_t)self, v6);
  ...
  objc_msgSend_setAnonymousShareSavedBlock_(v8, v13, (uint64_t)v23);
  v20[0] = v12;
  v20[1] = 3221225472;
  v20[2] = sub_1BEC5EAA4;
  v20[3] = &unk_1E782E468;
