...
- (id)description
{
  ...
  -[CKDPRecordPermittedCryptoFeatureSet description](&v11, sel_description);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1BEAE5C98((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_minimumSchemaVersion == *((_DWORD *)v4 + 2))
    {
      v7 = 1;
      goto LABEL_7;
    }
