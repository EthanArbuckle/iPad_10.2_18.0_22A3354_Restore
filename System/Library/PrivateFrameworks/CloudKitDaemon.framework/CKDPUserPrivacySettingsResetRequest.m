...
+ (id)options
{
  if (qword_1ED702B80 != -1)
    dispatch_once(&qword_1ED702B80, &unk_1E78377E0);
  return (id)qword_1ED702B78;
}
...
- (id)description
{
  ...
  -[CKDPUserPrivacySettingsResetRequest description](&v11, sel_description);
