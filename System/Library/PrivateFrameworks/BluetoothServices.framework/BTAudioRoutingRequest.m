...
void __34__BTAudioRoutingRequest__activate__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    v4 = (void (**)(_QWORD, _QWORD))MEMORY[0x2199A7854](*(_QWORD *)(*(_QWORD *)(a1 + 32) + 72));
    if (v4)
    {
      v5 = *(_QWORD *)(a1 + 32);
      v6 = *(void **)(v5 + 72);
...
- (void)_invalidated
{
  ...
  if (!self->_invalidateDone)
  {
    ...
    if (!self->_xpcCnx)
    {
      v7 = (void (**)(id, BTAudioRoutingResponse *))MEMORY[0x2199A7854](self->_responseHandler, a2);
...
- (void)_reportError:(id)a3
{
  ...
  v4 = (void (**)(_QWORD, _QWORD))MEMORY[0x2199A7854](self->_responseHandler);
  if (v4)
  {
    responseHandler = self->_responseHandler;
    self->_responseHandler = 0;
