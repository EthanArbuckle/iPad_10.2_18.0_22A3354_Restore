...
- (id)_ensureXPCStarted
{
  ...
  if (!self->_xpcCnx)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_254B6EA70);
    ...
    objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_254B6EAD0);
...
- (void)_interrupted
{
  ...
  v3 = (void (**)(void))MEMORY[0x2199A7854](self->_interruptionHandler);
  if (v3)
  {
    v4 = v3;
    v3[2]();
...
- (void)_invalidated
{
  ...
  if (!self->_invalidateDone)
  {
    ...
    if (!self->_xpcCnx)
    {
      v3 = MEMORY[0x2199A7854](self->_invalidationHandler, a2);
      v4 = (void *)v3;
      if (v3)
...
void __55__BTCloudServicesClient_createDeviceRecord_completion___block_invoke(id *a1)
{
  ...
  v15 = a1[4];
  v16 = a1[6];
  v4 = (void (**)(_QWORD))MEMORY[0x2199A7854](v14);
  if (v2)
  {
...
void __53__BTCloudServicesClient_deviceRecordsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  v14 = &v15;
  v13 = *(id *)(a1 + 40);
  v3 = (void (**)(_QWORD))MEMORY[0x2199A7854](v12);
...
void __72__BTCloudServicesClient_cloudPairingIdentifierForPeripheral_completion___block_invoke(id *a1)
{
  ...
  v15[4] = v2;
  v16 = a1[6];
  v4 = (void (**)(_QWORD))MEMORY[0x2199A7854](v15);
  if (v2)
  {
    if (gLogCategory_BTRootCloudServicesClient <= 30
      && (gLogCategory_BTRootCloudServicesClient != -1 || _LogCategory_Initialize()))
...
void __61__BTCloudServicesClient_createSoundProfileRecord_completion___block_invoke(id *a1)
{
  ...
  v18 = a1[4];
  v19 = a1[6];
  v4 = (void (**)(_QWORD))MEMORY[0x2199A7854](v17);
  if (v2
...
void __61__BTCloudServicesClient_createSoundProfileRecord_completion___block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  v19 = v20;
  v18 = *(id *)(a1 + 48);
  v8 = (void (**)(_QWORD))MEMORY[0x2199A7854](v17);
  if (v6)
  {
...
void __61__BTCloudServicesClient_modifySoundProfileRecord_completion___block_invoke(id *a1)
{
  ...
  v12 = &v13;
  v11 = a1[6];
  v3 = (void (**)(_QWORD))MEMORY[0x2199A7854](v10);
  if (v2
