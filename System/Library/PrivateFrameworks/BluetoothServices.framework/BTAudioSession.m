...
void __41__BTAudioSession_activateWithCompletion___block_invoke(uint64_t a1)
{
  ...
  {
    *(_BYTE *)(v2 + 8) = 1;
    v3 = MEMORY[0x2199A7854](*(_QWORD *)(a1 + 40));
    v4 = *(_QWORD *)(a1 + 32);
    v5 = *(void **)(v4 + 16);
    *(_QWORD *)(v4 + 16) = v3;
...
LABEL_12:
  ...
  v15 = (void (**)(_QWORD, _QWORD))MEMORY[0x2199A7854](*(_QWORD *)(v11 + 16));
  v16 = *(_QWORD *)(a1 + 32);
  v17 = *(void **)(v16 + 16);
  *(_QWORD *)(v16 + 16) = 0;
...
void __28__BTAudioSession_invalidate__block_invoke(uint64_t a1)
{
  ...
  if (!*(_BYTE *)(v1 + 24))
  {
    *(_BYTE *)(v1 + 24) = 1;
    ...
    v12 = (void (**)(id, void *))MEMORY[0x2199A7854](*(_QWORD *)(v7 + 16));
    v9 = *(_QWORD *)(a1 + 32);
    v10 = *(void **)(v9 + 16);
    *(_QWORD *)(v9 + 16) = 0;
...
- (void)_invalidated
{
  ...
  if (!self->_invalidateDone)
  {
    ...
    if (!self->_xpcCnx)
    {
      v11 = (void (**)(id, void *))MEMORY[0x2199A7854](self->_activateCompletion, a2);
      ...
      v5 = (void (**)(_QWORD))MEMORY[0x2199A7854](self->_invalidationHandler);
...
- (void)_reportError:(id)a3
{
  ...
  v7 = (void (**)(_QWORD, _QWORD))MEMORY[0x2199A7854](self->_activateCompletion);
  activateCompletion = self->_activateCompletion;
  self->_activateCompletion = 0;
