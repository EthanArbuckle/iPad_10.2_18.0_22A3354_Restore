...
+ (id)getInternalSupportPath
{
  ...
  {
    ZhuGeLog(262400, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getInternalSupportPath]", 135, CFSTR("Skip retrieving internal support path in restoreOS"), v4, v5, v6, v37);
    v7 = 0;
    v8 = 0;
LABEL_27:
    v33 = 0;
  ...
  if (!v9)
  {
    ...
    ZhuGeLog(262400, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getInternalSupportPath]", 142, CFSTR("Retrieving unchanged internal supported path: %@"), v29, v30, v31, (uint64_t)v8);
    v7 = 0;
    goto LABEL_27;
  }
      ...
      if (v21)
      {
        ...
        do
        {
          for (i = 0; i != v22; ++i)
          {
            ...
            v25 = v8;
            objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@%@"), *(_QWORD *)(*((_QWORD *)&v38 + 1) + 8 * i), v8, (_QWORD)v38);
...
LABEL_29:
    ...
    ZhuGeLog(524544, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getInternalSupportPath]", 174, CFSTR("ZhuGe internal support path is updated to: %@"), v34, v35, v36, (uint64_t)v8);
  ...
  if (a3)
  {
    *a3 = 0;
    ...
    if (!objc_msgSend(a1, "dylibHandler"))
    {
      ...
      if (!v10)
      {
        ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getDylibHandlerWithError:]", 207, CFSTR("Failed to get ZhuGe internal support path for dylib handler!"), v11, v12, v13, v23);
        objc_msgSend(MEMORY[0x24BDD1540], "errorWithZhuGeErrorCode:underlyingError:", 43, 0);
      ...
      if (!objc_msgSend(a1, "dylibHandler"))
      {
        ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getDylibHandlerWithError:]", 218, CFSTR("Failed to dlopen ZhuGe internal armory dylib!"), v17, v18, v19, v23);
...
LABEL_10:
  ...
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getDylibHandlerWithError:]", 194, CFSTR("error p-pointer is nil!"), v5, v6, v7, v23);
    v8 = 0;
    v9 = 0;
  }
  pthread_mutex_unlock((pthread_mutex_t *)objc_msgSend(a1, "recursiveMutex"));
...
+ (id)getXpcProxyWithError:(id *)a3
{
  ...
  if (!a3)
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 273, CFSTR("error p-pointer is nil!"), v5, v6, v7, v40);
LABEL_9:
    v9 = 0;
    v10 = 0;
    v11 = 0;
  ...
  *a3 = 0;
  ...
  if (!v13)
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 286, CFSTR("Failed to get ZhuGe internal support path for xpc proxy!"), v14, v15, v16, v40);
    objc_msgSend(MEMORY[0x24BDD1540], "errorWithZhuGeErrorCode:underlyingError:", 43, 0);
...
LABEL_13:
  ...
  xpc_add_bundle();
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1988]), "initWithServiceName:", CFSTR("com.apple.ZhuGeInternalService"));
  if (!v11)
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 297, CFSTR("Failed to connect \"%@\"!"), v20, v21, v22, (uint64_t)CFSTR("com.apple.ZhuGeInternalService"));
    objc_msgSend(MEMORY[0x24BDD1540], "errorWithZhuGeErrorCode:underlyingError:", 67, 0);
    v37 = (id)objc_claimAutoreleasedReturnValue();
    goto LABEL_13;
  }
  objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_2563E49C0);
  ...
  if (!v33)
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 339, CFSTR("Failed to get proxy for \"%@\"!"), v34, v35, v36, (uint64_t)CFSTR("com.apple.ZhuGeInternalService"));
...
uint64_t __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke(uint64_t a1)
{
  ...
  ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]_block_invoke", 317, CFSTR("Connection to \"%@\" invalidated!"), v2, v3, v4, (uint64_t)CFSTR("com.apple.ZhuGeInternalService"));
...
uint64_t __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke_2(uint64_t a1)
{
  ...
  pthread_mutex_lock((pthread_mutex_t *)objc_msgSend(*(id *)(a1 + 32), "recursiveMutex"));
  ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]_block_invoke_2", 323, CFSTR("Connection to \"%@\" interrupted!"), v2, v3, v4, (uint64_t)CFSTR("com.apple.ZhuGeInternalService"));
  objc_msgSend(*(id *)(a1 + 32), "setXpcProxy:", 0);
  return pthread_mutex_unlock((pthread_mutex_t *)objc_msgSend(*(id *)(a1 + 32), "recursiveMutex"));
}
...
uint64_t __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]_block_invoke_3", 333, CFSTR("Internal connection failed to provide a synchronized proxy, error : %@!"), v5, v6, v7, (uint64_t)v4);
