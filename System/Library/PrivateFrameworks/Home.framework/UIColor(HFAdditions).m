...
+ (id)hf_homePodControlCellBackgroundColor
{
  ...
  if (+[HFUtilities shouldUseControlCenterMaterials](HFUtilities, "shouldUseControlCenterMaterials"))
  {
...
{
  return objc_msgSend(MEMORY[0x1E0CEA478], "colorWithWhite:alpha:", 1.0, 0.2);
}
