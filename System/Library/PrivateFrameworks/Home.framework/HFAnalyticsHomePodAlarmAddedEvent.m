...
- (HFAnalyticsHomePodAlarmAddedEvent)initWithData:(id)a3
{
  ...
  void *v8;
  void *v9;
  HFAnalyticsHomePodAlarmAddedEvent *v10;
  HFAnalyticsHomePodAlarmAddedEvent *v11;
  float v12;
  void *v13;
  uint64_t v14;
  ...
  objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("alarmCreatedSuccessfully"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v6)
    NSLog(CFSTR("HFAnalyticsHomePodAlarmAddedSuccessfullyKey is nil"));
  ...
  v10 = -[HFAnalyticsEvent initWithEventType:](&v17, sel_initWithEventType_, 15);
  v11 = v10;
  if (v10)
  {
    objc_storeStrong((id *)&v10->_homePodAlarmID, v5);
    v11->_alarmAddedSuccessfully = objc_msgSend(v6, "BOOLValue");
...
- (id)payload
{
  ...
  -[HFAnalyticsHomePodAlarmAddedEvent homePodAlarmID](self, "homePodAlarmID");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v5, CFSTR("homePodAlarmID"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HFAnalyticsHomePodAlarmAddedEvent alarmAddedSuccessfully](self, "alarmAddedSuccessfully"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v6, CFSTR("homePodAlarmAddedSuccessfully"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HFAnalyticsHomePodAlarmAddedEvent isMusicAlarm](self, "isMusicAlarm"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v7, CFSTR("isHomePodMusicAlarm"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HFAnalyticsHomePodAlarmAddedEvent hasCustomVolume](self, "hasCustomVolume"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v8, CFSTR("homePodMusicAlarmHasCustomVolume"));

  v9 = (void *)MEMORY[0x1E0CB37E8];
  -[HFAnalyticsHomePodAlarmAddedEvent customVolumeLevel](self, "customVolumeLevel");
  ...
  -[HFAnalyticsHomePodAlarmAddedEvent processName](self, "processName");
