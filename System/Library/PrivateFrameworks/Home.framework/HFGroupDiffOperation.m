...
- (HFGroupDiffOperation)initWithOperationType:(unint64_t)a3 group:(id)a4 fromIndex:(id)a5 toIndex:(id)a6
{
  ...
  id v12;
  id v13;
  HFGroupDiffOperation *v14;
  HFGroupDiffOperation *v15;
  objc_super v17;
  ...
  v14 = -[HFGroupDiffOperation init](&v17, sel_init);
  v15 = v14;
  if (v14)
  {
    v14->_type = a3;
...
- (BOOL)isEqual:(id)a3
{
  HFGroupDiffOperation *v4;
  HFGroupDiffOperation *v5;
  unint64_t v6;
  void *v7;
  void *v8;
  void *v9;
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = -[HFGroupDiffOperation type](self, "type");
      if (v6 != -[HFGroupDiffOperation type](v5, "type"))
      {
        v15 = 0;
LABEL_24:
      ...
      -[HFGroupDiffOperation group](self, "group");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[HFGroupDiffOperation group](v5, "group");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_23:
      ...
      -[HFGroupDiffOperation fromIndex](self, "fromIndex");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[HFGroupDiffOperation fromIndex](v5, "fromIndex");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = v9;
      v12 = v10;
      v13 = v12;
...
LABEL_22:
      ...
      -[HFGroupDiffOperation toIndex](self, "toIndex");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      -[HFGroupDiffOperation toIndex](v5, "toIndex");
...
- (unint64_t)hash
{
  ...
  v3 = -[HFGroupDiffOperation type](self, "type");
  -[HFGroupDiffOperation group](self, "group");
...
- (NSString)description
{
  ...
  v4 = objc_opt_class();
  -[HFGroupDiffOperation _operationDescriptionWithVerboseType:](self, "_operationDescriptionWithVerboseType:", 0);
...
{
  return (NSString *)-[HFGroupDiffOperation _operationDescriptionWithVerboseType:](self, "_operationDescriptionWithVerboseType:", 1);
}
...
- (id)_operationDescriptionWithVerboseType:(BOOL)a3
{
  ...
  v13[3] = &unk_1EA72D530;
  v13[4] = self;
  __61__HFGroupDiffOperation__operationDescriptionWithVerboseType___block_invoke((uint64_t)v13);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[HFGroupDiffOperation type](self, "type");
  if (v6 <= 3)
  {
