...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", *MEMORY[0x1E0CB9A68]);
}
...
id __56__HFLightSensorServiceItem__subclass_updateWithOptions___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v4, "responseForCharacteristicType:", *MEMORY[0x1E0CB8860]);
  ...
  if (v7)
  {
    ...
    if (v10)
    {
      ...
      if (!v11)
        objc_msgSend(v9, "setObject:forKeyedSubscript:", v10, CFSTR("description"));
    }
    objc_msgSend(*(id *)(a1 + 32), "controlDescriptionForCharacteristic:withValue:", v6, v7);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "na_safeSetObject:forKey:", v12, CFSTR("controlDescription"));
