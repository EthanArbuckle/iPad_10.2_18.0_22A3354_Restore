...
- (HFAnalyticsResumeSetupContinueSetupOptionsEvent)initWithData:(id)a3
{
  ...
  void *v9;
  id v10;
  HFAnalyticsResumeSetupContinueSetupOptionsEvent *v11;
  HFAnalyticsResumeSetupContinueSetupOptionsEvent *v12;
  objc_super v14;
  ...
  v11 = -[HFAnalyticsEvent initWithEventType:](&v14, sel_initWithEventType_, 29);
  v12 = v11;
  if (v11)
  {
...
- (id)payload
{
  ...
  -[HFAnalyticsResumeSetupContinueSetupOptionsEvent accessoryType](self, "accessoryType");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "na_safeSetObject:forKey:", v5, CFSTR("accessory"));

  -[HFAnalyticsResumeSetupContinueSetupOptionsEvent resumeSetupOption](self, "resumeSetupOption");
