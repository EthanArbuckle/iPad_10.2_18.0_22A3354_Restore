  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1DD34E000, v12, OS_LOG_TYPE_DEFAULT, "Not moving timer: %@ since it is already in room: %@ ", buf, 0x16u);
    }
  }
  else
  {
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v25 = 2112;
        v26 = v15;
        _os_log_impl(&dword_1DD34E000, v18, OS_LOG_TYPE_DEFAULT, "Moved timer: %@ to room: %@ using targetReferenceAccessory: %@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v23 = 2112;
        v24 = v14;
        _os_log_error_impl(&dword_1DD34E000, v16, OS_LOG_TYPE_ERROR, "Error moving timer: %@ to room: %@ since there is no targetReferenceAccessory for that room", buf, 0x16u);
      }
    }
