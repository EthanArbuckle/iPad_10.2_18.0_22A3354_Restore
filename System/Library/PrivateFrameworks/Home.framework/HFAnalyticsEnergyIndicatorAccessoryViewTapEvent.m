...
- (HFAnalyticsEnergyIndicatorAccessoryViewTapEvent)initWithData:(id)a3
{
  void *v4;
  unint64_t v5;
  HFAnalyticsEnergyIndicatorAccessoryViewTapEvent *result;
  objc_super v7;
  ...
  if (!v5)
    NSLog(CFSTR("HFAnalyticsEnergyIndicatorAccessoryViewTapEvent interactionType is invalid"));
  v7.receiver = self;
  v7.super_class = (Class)HFAnalyticsEnergyIndicatorAccessoryViewTapEvent;
  result = -[HFAnalyticsEvent initWithEventType:](&v7, sel_initWithEventType_, 55);
  if (result)
...
- (id)payload
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HFAnalyticsEnergyIndicatorAccessoryViewTapEvent interactionType](self, "interactionType"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "na_safeSetObject:forKey:", v5, CFSTR("interactionType"));

  objc_msgSend(v4, "na_safeSetObject:forKey:", &unk_1EA7CBAB8, CFSTR("homeAppEventCount"));
  return v4;
}
