...
LABEL_51:
  ...
  objc_msgSend(v60, "sortedArrayUsingComparator:", &__block_literal_global_211);
...
void __58__HFUniqueArrayDiff__createContainerSetFromArray_options___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  +[_HFSetContainer containerWithObject:atIndex:comparator:hashGenerator:](_HFSetContainer, "containerWithObject:atIndex:comparator:hashGenerator:", v7, a3, v10, v8);
...
+ (id)_createContainerSetFromArray:(id)a3 options:(id)a4
{
  ...
  if (v10 != objc_msgSend(v5, "count"))
    NSLog(CFSTR("Detected an attempt to use HFUniqueArrayDiff with duplicate array members. This is not supported and will lead to undefined behavior. Array: %@"), v5);
  v11 = v16;
  v12 = v8;
...
- (void)enumerateChangesUsingBlock:(id)a3
{
  ...
  v4 = a3;
  -[HFUniqueArrayDiff changedIndexes](self, "changedIndexes");
...
- (unint64_t)numberOfOperations
{
  ...
  -[HFUniqueArrayDiff deletedIndexes](self, "deletedIndexes");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "count");
  -[HFUniqueArrayDiff insertedIndexes](self, "insertedIndexes");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "count") + v4;
  -[HFUniqueArrayDiff movedIndexes](self, "movedIndexes");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)enumerateMovesUsingBlock:(id)a3
{
  ...
  objc_msgSend(v6, "sortedArrayUsingComparator:", &__block_literal_global_69_3);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
