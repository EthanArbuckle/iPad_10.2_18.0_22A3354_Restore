...
- (NSXPCConnection)timerManagerServiceConnection
{
  ...
  if (!v3)
  {
    if (!v2->_timerManagerServiceConnection)
    {
      ...
      v5 = objc_msgSend(v4, "initWithMachServiceName:options:", *MEMORY[0x1E0D148A0], 4096);
    ...
    -[NSXPCConnection setInvalidationHandler:](v2->_timerManagerServiceConnection, "setInvalidationHandler:", v7);
    v3 = v2->_timerManagerServiceConnection;
