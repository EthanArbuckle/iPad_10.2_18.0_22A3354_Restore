...
{
  id v5;
  HFAccessoryItemProvider *v6;
  HFAccessoryItemProvider *v7;
  uint64_t v8;
...
- (HFAccessoryItemProvider)init
{
  ...
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("HFAccessoryItemProvider.m"), 36, CFSTR("%s is unavailable; use %@ instead"),
    "-[HFAccessoryItemProvider init]",
    v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[HFAccessoryItemProvider home](self, "home");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)reloadItems
{
  ...
  -[HFAccessoryItemProvider filter](self, "filter");
  ...
  v11[0] = v3;
  v11[1] = 3221225472;
  v11[2] = __38__HFAccessoryItemProvider_reloadItems__block_invoke_2;
  v11[3] = &unk_1EA726E30;
...
HFAccessoryItem *__38__HFAccessoryItemProvider_reloadItems__block_invoke(uint64_t a1, void *a2)
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[HFAccessoryItem initWithAccessory:valueSource:](v5, "initWithAccessory:valueSource:", v3, v6);
...
- (HFCharacteristicValueSource)valueSource
{
  ...
  -[HFAccessoryItemProvider overrideValueSource](self, "overrideValueSource");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
