...
{
  return (NSString *)-[HFItemDiffOperation _operationDescriptionWithVerboseType:](self, "_operationDescriptionWithVerboseType:", 1);
}
...
- (id)_operationDescriptionWithVerboseType:(BOOL)a3
{
  ...
  v12[3] = &unk_1EA7273E0;
  v12[4] = self;
  __60__HFItemDiffOperation__operationDescriptionWithVerboseType___block_invoke((uint64_t)v12);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[HFItemDiffOperation type](self, "type");
  if (v6 <= 3)
  {
    v7 = off_1EA732F30[v6];
    if (!v3)
...
LABEL_6:
  ...
  -[HFItemDiffOperation item](self, "item");
...
LABEL_7:
    v5 = v9;
    _HFStandardIndexPathDescription(v9);
  ...
  if (v3 == 3)
  {
    ...
    objc_msgSend(*(id *)(a1 + 32), "fromIndexPath");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    _HFStandardIndexPathDescription(v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "toIndexPath");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    _HFStandardIndexPathDescription(v7);
...
- (HFItemDiffOperation)initWithOperationType:(unint64_t)a3 item:(id)a4 fromIndexPath:(id)a5 toIndexPath:(id)a6
{
  ...
  id v12;
  id v13;
  HFItemDiffOperation *v14;
  HFItemDiffOperation *v15;
  objc_super v17;
  ...
  v14 = -[HFItemDiffOperation init](&v17, sel_init);
  v15 = v14;
  if (v14)
  {
    v14->_type = a3;
...
- (BOOL)isEqual:(id)a3
{
  HFItemDiffOperation *v4;
  HFItemDiffOperation *v5;
  unint64_t v6;
  void *v7;
  void *v8;
  void *v9;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      v5 = v4;
      v6 = -[HFItemDiffOperation type](self, "type");
      if (v6 != -[HFItemDiffOperation type](v5, "type"))
      {
        v15 = 0;
LABEL_24:
      ...
      -[HFItemDiffOperation item](self, "item");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[HFItemDiffOperation item](v5, "item");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_23:
      ...
      -[HFItemDiffOperation fromIndexPath](self, "fromIndexPath");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[HFItemDiffOperation fromIndexPath](v5, "fromIndexPath");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = v9;
      v12 = v10;
      v13 = v12;
...
LABEL_22:
      ...
      -[HFItemDiffOperation toIndexPath](self, "toIndexPath");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      -[HFItemDiffOperation toIndexPath](v5, "toIndexPath");
...
- (unint64_t)hash
{
  ...
  v3 = -[HFItemDiffOperation type](self, "type");
  -[HFItemDiffOperation item](self, "item");
...
- (NSString)description
{
  ...
  v4 = objc_opt_class();
  -[HFItemDiffOperation _operationDescriptionWithVerboseType:](self, "_operationDescriptionWithVerboseType:", 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
