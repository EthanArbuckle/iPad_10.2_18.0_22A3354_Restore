...
+ (NSSet)serviceTypes
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", *MEMORY[0x1E0CB99B0]);
}
...
- (id)iconDescriptorForRepresentedHomeKitObjects:(id)a3
{
  ...
  v4 = -[HFImageIconDescriptor initWithSystemImageNamed:configuration:]([HFImageIconDescriptor alloc], "initWithSystemImageNamed:configuration:", CFSTR("aqi.medium"), v3);
...
id __60__HFAirQualitySensorStatusItem__subclass_updateWithOptions___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v15 = *MEMORY[0x1E0CB87B0];
      objc_msgSend(v3, "servicesWithValuesPassingTest:forCharacteristicType:", &__block_literal_global_223, *MEMORY[0x1E0CB87B0]);
      ...
      if (v35[3])
      {
        objc_msgSend(v16, "responseForCharacteristicType:", v15);
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "characteristic");
        v29 = (void *)objc_claimAutoreleasedReturnValue();

        objc_msgSend(MEMORY[0x1E0CB3658], "hf_valueFormatterForCharacteristic:options:", v29, 0);
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", v35[3]);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v18, "stringForObjectValue:", v19);
        v20 = (void *)objc_claimAutoreleasedReturnValue();

        objc_msgSend(v7, "setObject:forKeyedSubscript:", v20, CFSTR("description"));
        objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1EA7CD450, CFSTR("statusItemCategory"));
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", 6 - v35[3]);
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        +[HFNumberRange valueWithValue:](HFNumberRange, "valueWithValue:", v21);
        v22 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v7, "setObject:forKeyedSubscript:", v22, CFSTR("statusCurrentValue"));

        +[HFNumberRange rangeWithMaxValue:minValue:](HFNumberRange, "rangeWithMaxValue:minValue:", &unk_1EA7CD468, &unk_1EA7CD480);
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v7, "setObject:forKeyedSubscript:", v23, CFSTR("statusPossibleValues"));
...
{
  return _HFLocalizedStringWithDefaultValue(CFSTR("HFStatusTitleAirQuality"), CFSTR("HFStatusTitleAirQuality"), 1);
}
...
void __60__HFAirQualitySensorStatusItem__subclass_updateWithOptions___block_invoke_3(uint64_t a1, uint64_t a2)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "responseForCharacteristicType:inService:", *MEMORY[0x1E0CB87B0], a2);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
