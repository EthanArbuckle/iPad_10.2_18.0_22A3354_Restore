...
- (ICSBackupStatusView)initWithSpecifier:(id)a3
{
  ...
  v7 = -[ICSBackupStatusView initWithFrame:](&v53, sel_initWithFrame_, a3, *MEMORY[0x24BDBF090], v4, v5, v6);
  if (v7)
  {
    ...
    objc_msgSend(v30, "localizedStringForKey:value:table:", CFSTR("ESTIMATING_TIME_REMAINING"), &stru_251C6B070, CFSTR("Localizable-Backup"));
    ...
    objc_msgSend(v48, "localizedStringForKey:value:table:", CFSTR("DETERMINING_LAST_BACKUP"), &stru_251C6B070, CFSTR("Localizable-Backup"));
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    -[ICSBackupStatusView setLastBackupText:](v7, "setLastBackupText:", v49);
...
- (void)didMoveToSuperview
{
  ...
  -[ICSBackupStatusView bounds](self, "bounds");
  if (v4 == *MEMORY[0x24BDBF148] && v3 == *(double *)(MEMORY[0x24BDBF148] + 8))
    -[ICSBackupStatusView sizeToFit](self, "sizeToFit");
}
...
- (void)_sizeToFitWidth:(double)a3 inTableView:(id)a4
{
  ...
  v6 = a4;
  if (!v6)
    -[ICSBackupStatusView _sizeToFitWidth:inTableView:].cold.1();
  v45 = v6;
  PSTextViewInsets();
  v8 = v7;
  ...
  v13 = v10 + v11 - v8;
  -[ICSBackupStatusView frame](self, "frame");
  v44 = v14;
  v16 = v15;
  ...
  -[ICSBackupStatusView setNeedsLayout](self, "setNeedsLayout");
...
- (double)preferredHeightForWidth:(double)a3 inTableView:(id)a4
{
  ...
  -[ICSBackupStatusView _sizeToFitWidth:inTableView:](self, "_sizeToFitWidth:inTableView:", a4, a3);
  -[ICSBackupStatusView bounds](self, "bounds");
  return v5;
}
...
- (void)sizeToFit
{
  ...
  -[ICSBackupStatusView sizeToFit](&v8, sel_sizeToFit);
  -[ICSBackupStatusView superview](self, "superview");
  ...
  if (v3)
  {
    ...
    -[ICSBackupStatusView _sizeToFitWidth:inTableView:](self, "_sizeToFitWidth:inTableView:", v7, v6);
...
- (void)_layoutSubviews
{
  ...
  if (backupIssueLabel)
  {
    ...
    if (v18)
    {
      -[ICSBackupStatusView bounds](self, "bounds", v8);
      v19 = v20 - v8 - v14;
    }
...
- (void)layoutSubviews
{
  ...
  -[ICSBackupStatusView layoutSubviews](&v3, sel_layoutSubviews);
  -[ICSBackupStatusView _layoutSubviews](self, "_layoutSubviews");
}
...
- (void)setBackupProgress:(double)a3 timeIntervalRemaining:(double)a4
{
  ...
  if (a4 > 604800.0 || a4 <= 0.0)
  {
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "localizedStringForKey:value:table:", CFSTR("ESTIMATING_TIME_REMAINING"), &stru_251C6B070, CFSTR("Localizable-Backup"));
...
- (void)updateViewsForBackupState:(int)a3 restoreState:(int)a4 enabled:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 67109120;
    LODWORD(v48) = a3;
    _os_log_impl(&dword_24B4C1000, v9, OS_LOG_TYPE_DEFAULT, "update view for backup state: %d", buf, 8u);
  }
  ...
  if (((1 << a3) & 0x79) == 0)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "localizedStringForKey:value:table:", CFSTR("BACKING_UP"), &stru_251C6B070, CFSTR("Localizable-Backup"));
    ...
    if (-[NSArray count](self->_syncErrors, "count"))
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412290;
        v48 = syncErrors;
        _os_log_impl(&dword_24B4C1000, v21, OS_LOG_TYPE_DEFAULT, "sync errors only: %@", buf, 0xCu);
      }
      v23 = 0;
      goto LABEL_32;
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412290;
    v48 = backupError;
    _os_log_impl(&dword_24B4C1000, v11, OS_LOG_TYPE_DEFAULT, "backup error only: %@", buf, 0xCu);
  }
...
LABEL_47:
          ...
          v39 = (void *)objc_claimAutoreleasedReturnValue();
          -[NSObject localizedStringForKey:value:table:](v21, "localizedStringForKey:value:table:", v39, &stru_251C6B070, CFSTR("Localizable-Backup"));
          v23 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_31:
    -[NSObject localizedStringForKey:value:table:](v24, "localizedStringForKey:value:table:", v25, &stru_251C6B070, CFSTR("Localizable-Backup"));
    v23 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_32:
...
LABEL_33:
  ...
  -[ICSBackupStatusView footerText](self, "footerText");
...
LABEL_44:
  ...
  v44[1] = 3221225472;
  v44[2] = __70__ICSBackupStatusView_updateViewsForBackupState_restoreState_enabled___block_invoke;
  v44[3] = &unk_251C61060;
  v45 = v10;
  v46 = self;
  v40[0] = v34;
  v40[1] = 3221225472;
  v40[2] = __70__ICSBackupStatusView_updateViewsForBackupState_restoreState_enabled___block_invoke_2;
  v40[3] = &unk_251C61B10;
  v42 = a3;
  v43 = v5;
  v40[4] = self;
...
{
  __assert_rtn("-[ICSBackupStatusView _sizeToFitWidth:inTableView:]", "ICSBackupStatusView.m", 115, "tableView");
}
