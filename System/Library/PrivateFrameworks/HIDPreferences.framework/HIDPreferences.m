void sub_21B144934(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_21B1455C0(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_21B146C2C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
{
  CFPreferencesSetValue(key, value, applicationID, a4, a5);
}
...
{
  CFPreferencesSetMultiple(keysToSet, keysToRemove, applicationID, a4, a5);
}
...
{
  CFPreferencesSetValue(a1, a2, applicationID, userName, hostName);
}
...
{
  CFPreferencesSetMultiple(a1, a2, applicationID, userName, hostName);
}

void sub_21B1483D4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
