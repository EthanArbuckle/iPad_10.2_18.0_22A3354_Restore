...
+ (uint64_t)_repTypesAllowImageTypeOmission:()WebInternal
{
  ...
  *a1 = v2;
  v3 = objc_opt_class();
  v4 = (void *)objc_msgSend(+[WebHTMLRepresentation supportedNonImageMIMETypes](WebHTMLRepresentation, "supportedNonImageMIMETypes"), "objectEnumerator");
  ...
  v7 = objc_opt_class();
  v8 = (void *)objc_msgSend(+[WebHTMLRepresentation supportedMediaMIMETypes](WebHTMLRepresentation, "supportedMediaMIMETypes"), "objectEnumerator");
  ...
  if ((result & 1) == 0)
  {
    +[WebView _getPDFRepresentationClass](WebView, "_getPDFRepresentationClass");
    v12 = objc_opt_class();
    v13 = (void *)objc_msgSend((id)-[objc_class supportedMIMETypes](+[WebView _getPDFRepresentationClass](WebView, "_getPDFRepresentationClass"), "supportedMIMETypes"), "objectEnumerator");
