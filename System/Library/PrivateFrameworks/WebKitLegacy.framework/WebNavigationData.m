...
- (WebNavigationData)initWithURLString:(id)a3 title:(id)a4 originalRequest:(id)a5 response:(id)a6 hasSubstituteData:(BOOL)a7 clientRedirectSource:(id)a8
{
  ...
  WebNavigationDataPrivate *v15;
  void *m_ptr;
  WebNavigationDataPrivate *v17;
  void *v18;
  WebNavigationDataPrivate *v19;
  void *v20;
  WebNavigationDataPrivate *v21;
  void *v22;
  WebNavigationDataPrivate *v23;
  void *v24;
  objc_super v26;

  v26.receiver = self;
  v26.super_class = (Class)WebNavigationData;
  v14 = -[WebNavigationData init](&v26, sel_init);
  if (v14)
  {
...
- (void)dealloc
{
  ...
  -[WebNavigationData dealloc](&v3, sel_dealloc);
}
