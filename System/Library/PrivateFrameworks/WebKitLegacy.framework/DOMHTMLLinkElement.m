...
- (BOOL)_mediaQueryMatchesForOrientation:(int)a3
{
  ...
  v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(core((uint64_t)self) + 40) + 8) + 528);
  if (!v5)
    return 0;
  v6 = *(_QWORD *)(v5 + 8);
  if (!v6)
  ...
  if (!v7)
    return 0;
  v8 = WebCore::ScrollView::layoutSize(*(WebCore::ScrollView **)(v6 + 288));
  v9 = (unint64_t)WebCore::ScrollView::layoutSize(v7) >> 32;
  ...
  v10 = -[DOMHTMLLinkElement _mediaQueryMatches](self, "_mediaQueryMatches", v12, v13);
  WebCore::ScrollView::setFixedLayoutSize();
  WebCore::ScrollView::setUseFixedLayout(v7);
  return v10;
}
...
- (BOOL)_mediaQueryMatches
{
  ...
  if (!v2
    || (*(_WORD *)(v2 + 28) & 0x10) != 0
    && *(_QWORD *)(*(_QWORD *)(v2 + 96) + 24) == *(_QWORD *)(*MEMORY[0x1E0DD6020] + 24))
  {
    return WebCore::HTMLLinkElement::mediaAttributeMatches((WebCore::HTMLLinkElement *)v2);
  }
  result = 105;
  __break(0xC471u);
  return result;
...
- (void)setHreflang:(NSString *)hreflang
{
  ...
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((WTF::AtomStringImpl *)hreflang, v4);
  v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7)
    goto LABEL_4;
...
- (void)setMedia:(NSString *)media
{
  ...
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((WTF::AtomStringImpl *)media, v4);
  v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7)
    goto LABEL_4;
...
- (void)setRel:(NSString *)rel
{
  ...
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((WTF::AtomStringImpl *)rel, v4);
  v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7)
    goto LABEL_4;
...
- (void)setRev:(NSString *)rev
{
  ...
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((WTF::AtomStringImpl *)rev, v4);
  v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7)
    goto LABEL_4;
...
- (id)crossOrigin
{
  ...
  WebCore::HTMLLinkElement::crossOrigin(self->super.super.super.super._internal);
  if (v6)
  {
...
- (DOMStyleSheet)sheet
{
  ...
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v6);
  v3 = (DOMStyleSheet *)kit(*((DOMObjectInternal **)self->super.super.super.super._internal + 25));
