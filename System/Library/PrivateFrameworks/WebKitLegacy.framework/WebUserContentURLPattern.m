...
{
  WebUserContentURLPattern *v4;
  StringImpl *v5;
  WebUserContentURLPatternPrivate *v6;
  WTF::StringImpl *v7;
  ...
  v4 = -[WebUserContentURLPattern init](&v25, sel_init);
  if (!v4)
    return v4;
  v4->_private = objc_alloc_init(WebUserContentURLPatternPrivate);
  MEMORY[0x1D82A3998](&v20, a3);
  v21 = 0;
  v22 = 0;
  v23 = 0;
  v24 = 1;
...
- (void)dealloc
{
  ...
  -[WebUserContentURLPattern dealloc](&v3, sel_dealloc);
}
...
{
  WebUserContentURLPatternPrivate *v3;
  char v4;
  WebCore::UserContentURLPattern *p_pattern;
  StringImpl *v8;
  uint64_t v9;
  WTF::StringImpl *v10;
  int v11;
...
LABEL_13:
  v23 = v10;
  v11 = WebCore::UserContentURLPattern::matchesHost(p_pattern, (const WTF::String *)&v23);
  v12 = v23;
  v23 = 0;
  if (!v12)
    goto LABEL_16;
...
LABEL_27:
  v22 = v15;
  v4 = WebCore::UserContentURLPattern::matchesPath(p_pattern, (const WTF::String *)&v22);
  v16 = v22;
  v22 = 0;
  if (v16)
  {
