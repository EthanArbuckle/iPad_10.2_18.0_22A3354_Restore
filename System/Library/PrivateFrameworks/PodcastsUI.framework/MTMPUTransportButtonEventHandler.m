...
{
  MTMPUTransportButtonEventHandler *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)MTMPUTransportButtonEventHandler;
  result = -[MTMPUTransportButtonEventHandler init](&v3, sel_init);
  if (result)
...
- (void)dealloc
{
  ...
  -[MTMPUTransportButtonEventHandler _clearLongPressTimer](self, "_clearLongPressTimer");
  v3.receiver = self;
  v3.super_class = (Class)MTMPUTransportButtonEventHandler;
  -[MTMPUTransportButtonEventHandler dealloc](&v3, sel_dealloc);
}
...
- (void)cancelTrackingWithEvent:(id)a3
{
  ...
  -[MTMPUTransportButtonEventHandler _clearLongPressTimer](self, "_clearLongPressTimer", a3);
}
...
- (void)endTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  -[MTMPUTransportButtonEventHandler _clearLongPressTimer](self, "_clearLongPressTimer", a3, a4);
