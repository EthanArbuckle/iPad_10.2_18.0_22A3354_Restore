...
{
  return -[MTMPUMutableFontDescriptor _copyAllowingGlobalCacheLookup:](self, "_copyAllowingGlobalCacheLookup:", 1);
}
...
- (void)setDefaultPointSizeAdjustment:(double)a3
{
  if (!MTMPUFloatEqualToFloat(self->super._defaultPointSizeAdjustment, a3))
  {
    ...
    -[MTMPUFontDescriptor _invalidateCachedFontsAndMetrics](self, "_invalidateCachedFontsAndMetrics");
  }
}
...
- (void)_resetToDefaultValues
{
  ...
  -[MTMPUFontDescriptor _resetToDefaultValues](&v2, sel__resetToDefaultValues);
}
