...
- (id)description
{
  ...
  if (v10 != v11)
  {
    ...
    do
    {
      v13 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)v10);
...
{
  -[MTMPULayoutInterpolator addValue:forReferenceMetric:secondaryReferenceMetric:](self, "addValue:forReferenceMetric:secondaryReferenceMetric:", a3, a4, -1.13427449e38);
}
...
- (void)addValue:(double)a3 forReferenceMetric:(double)a4 secondaryReferenceMetric:(double)a5
{
  ...
  EntriesContainer *begin;
  unint64_t v10;
  MTMPU::LayoutInterpolator::EntriesContainer *v11;
  double v12;
  double v13;
  double v14;
  double v15;
  ...
  if (end != begin)
  {
    ...
    do
    {
      ...
      v13 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)v24);
      if (v12 >= v13)
        v10 >>= 1;
      else
        v10 += ~(v10 >> 1);
  ...
  if (self->_entriesContainers.__end_ == end
    || (v14 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)end),
        v15 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)v24),
  ...
  else
  {
    if (v23 >= 0)
      ...
      v16 = (__int128 *)__p;
    objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99778], CFSTR("%s"), v16);
  }
  if (SHIBYTE(v23) < 0)
    operator delete((void *)__p);
  if (v24[0])
...
- (double)valueForReferenceMetric:(double)a3
{
  ...
  -[MTMPULayoutInterpolator valueForReferenceMetric:secondaryReferenceMetric:](self, "valueForReferenceMetric:secondaryReferenceMetric:", a3, -1.13427449e38);
  return result;
}
...
- (double)valueForReferenceMetric:(double)a3 secondaryReferenceMetric:(double)a4
{
  ...
  uint64_t v26;
  unint64_t v27;
  MTMPU::LayoutInterpolator::EntriesContainer *v28;
  double v29;
  double v30;
  double v31;
  double v32;
  ...
  if (end == begin)
  {
    ...
    objc_msgSend(v18, "raise:format:", *MEMORY[0x1E0C99778], CFSTR("Can't call -[%@ %@] before calling -[%@ %@] at least once."), v13, v20, v22, v23);
  ...
  {
    if (v8 == 32)
      return MTMPU::LayoutInterpolator::EntriesContainer::valueForSecondaryReferenceMetric((double **)self->_entriesContainers.__begin_, a4);
    ...
    if (v26)
    {
      ...
      do
      {
        v28 = (MTMPU::LayoutInterpolator::EntriesContainer *)((char *)v25 + 32 * (v27 >> 1));
        v29 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric(v28);
        v30 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)__p);
        if (v29 >= v30)
          v27 >>= 1;
        else
          v27 += ~(v27 >> 1);
      ...
      {
        v31 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)v25);
        v32 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)__p);
        if (MTMPUFloatEqualToFloat(v31, v32))
        {
          v33 = MTMPU::LayoutInterpolator::EntriesContainer::valueForSecondaryReferenceMetric((double **)v25, a4);
        }
        else if (v25 == self->_entriesContainers.__begin_)
        {
          -[MTMPULayoutInterpolator _interpolatedValueForPrimaryReferenceMetric:secondaryReferenceMetric:betweenFirstEntriesContainer:andSecondEntriesContainer:](self, "_interpolatedValueForPrimaryReferenceMetric:secondaryReferenceMetric:betweenFirstEntriesContainer:andSecondEntriesContainer:", v25, (char *)v25 + 32, a3, a4);
        }
        else
        {
          -[MTMPULayoutInterpolator _interpolatedValueForPrimaryReferenceMetric:secondaryReferenceMetric:betweenFirstEntriesContainer:andSecondEntriesContainer:](self, "_interpolatedValueForPrimaryReferenceMetric:secondaryReferenceMetric:betweenFirstEntriesContainer:andSecondEntriesContainer:", (char *)v25 - 32, v25, a3, a4);
        }
        goto LABEL_23;
      }
...
LABEL_23:
  ...
  objc_msgSend(v11, "raise:format:", *MEMORY[0x1E0C99778], CFSTR("Can't call -[%@ valueForReferenceMetric:] without a valid secondary reference metric. Please use -[%@ %@] with a valid last argument."), v13, v15, v16);
...
- (double)_interpolatedValueForPrimaryReferenceMetric:(double)a3 secondaryReferenceMetric:(double)a4 betweenFirstEntriesContainer:(void *)a5 andSecondEntriesContainer:(void *)a6
{
  ...
  v11 = MTMPU::LayoutInterpolator::EntriesContainer::entriesCount((MTMPU::LayoutInterpolator::EntriesContainer *)a5);
  v12 = MTMPU::LayoutInterpolator::EntriesContainer::entriesCount((MTMPU::LayoutInterpolator::EntriesContainer *)a6);
  if (v11 == 1 && v12 == 1)
  {
    MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector((MTMPU::LayoutInterpolator::EntriesContainer *)a5, &v62);
    v13 = *(double *)(v62 + 8);
    v14 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)a5);
    MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector((MTMPU::LayoutInterpolator::EntriesContainer *)a6, &__p);
    v15 = *((double *)__p + 1);
    v16 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MTMPU::LayoutInterpolator::EntriesContainer *)a6);
    v17 = MTMPULayoutLinearRelationMake(v14, v13, v16, v15);
    v19 = MTMPULayoutLinearRelationEvaluate(v17, v18, a3);
    if (*(double *)&__p != 0.0)
    {
      v60 = __p;
      operator delete(__p);
  ...
  else
  {
    ...
    do
    {
      ...
      if (0xAAAAAAAAAAAAAAABLL * ((v53 - (_BYTE *)__src) >> 3) >= 3)
      {
        ...
        v45 = 0.0;
        v43 = 0.0;
        v37 = MTMPU::Point3D::resolveEquationOfPlaneDefinedByFirstThreePointsInVector((double **)&__src, &v45, &v44, &v43, *(double *)&v21, v22, *(double *)&v23, v24, v25, v26, v27, v28);
        v36 = v37;
        if (v37)
        {
          v23 = __p;
...
- (vector<MTMPU::Point3D,)_sortedPointsFor3DInterpolationFromEntriesContainer:(MTMPULayoutInterpolator *)self usingQueriedPoint:(SEL)a3 fallbackSecondaryReferenceMetric:(void *)a4
{
  ...
  uint64_t v16;
  uint64_t v17;
  vector<MTMPU::Point3D, std::allocator<MTMPU::Point3D>> *result;
  _QWORD v19[3];
  void *__p;
  double *v21;
  ...
  result = (vector<MTMPU::Point3D, std::allocator<MTMPU::Point3D>> *)__p;
  if (__p)
  {
    v21 = (double *)__p;
    operator delete(__p);
...
- (void)_sortPointsFor3DInterpolation:(void *)a3 usingQueriedPoint:(Point3D)a4
{
  ...
  if (v6 >= 2)
  {
    ...
    if (v5 == v4)
      ...
      v8 = v7;
    std::__introsort<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_4 &,MTMPU::Point3D *,false>(v4, v5, &v9.var0, v8, 1);
  }
}

- (void).cxx_destruct
{
  vector<MTMPU::LayoutInterpolator::EntriesContainer, std::allocator<MTMPU::LayoutInterpolator::EntriesContainer>> *p_entriesContainers;
