...
+ (void)_startListeningForNotifications
{
  ...
  block[1] = 3221225472;
  block[2] = __52__DABehaviorOptions__startListeningForNotifications__block_invoke_5;
  block[3] = &unk_1E7B9D858;
...
uint64_t __52__DABehaviorOptions__startListeningForNotifications__block_invoke()
{
  ...
  {
    *(_WORD *)v2 = 0;
    _os_log_impl(&dword_1C1D11000, v0, OS_LOG_TYPE_DEBUG, "Bumping behavior token number", v2, 2u);
  }
...
void __52__DABehaviorOptions__startListeningForNotifications__block_invoke_5(uint64_t a1)
{
  NSObject *v2;
...
+ (id)allowlistedEASProtocols
{
    ...
    || allowlistedEASProtocols___lastToken != sDABehaviorToken)
  {
    ...
    if (v3)
    {
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("AllowlistedEASProtocols"));
      v5 = objc_claimAutoreleasedReturnValue();
      v6 = (void *)allowlistedEASProtocols___allowlistedEASProtocols;
      allowlistedEASProtocols___allowlistedEASProtocols = v5;

    }
  }
  return (id)allowlistedEASProtocols___allowlistedEASProtocols;
}
...
+ (BOOL)cookiesEnabled
{
  ...
  if (cookiesEnabled___flagChecked != 1 || cookiesEnabled___lastToken != sDABehaviorToken)
  {
    ...
    if ((MGGetBoolAnswer() & 1) == 0)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1C1D11000, v3, OS_LOG_TYPE_DEFAULT, "Turning off cookie support because we are running on older hardware", buf, 2u);
      }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v11 = v7;
      _os_log_impl(&dword_1C1D11000, v6, OS_LOG_TYPE_DEFAULT, "Due to a profile setting, we are forcing cookies to be %@abled", buf, 0xCu);
    }
    ...
    || useContactsFramerwork___lastToken != sDABehaviorToken)
  {
    ...
    if (v3)
    {
      ...
      if (v5)
      {
        ...
        v6 = (void *)objc_claimAutoreleasedReturnValue();
        useContactsFramerwork___useContactsFramework = objc_msgSend(v6, "intValue") != 0;
...
+ (id)_daManagedDefaultsPath
{
  if (_daManagedDefaultsPath_onceToken != -1)
    dispatch_once(&_daManagedDefaultsPath_onceToken, &__block_literal_global_86);
  return (id)_daManagedDefaultsPath_defaultsPath;
}
...
void __43__DABehaviorOptions__daManagedDefaultsPath__block_invoke()
{
  ...
  _daManagedDefaultsPath_defaultsPath = (uint64_t)CFSTR("/Library/Managed Preferences/mobile/.GlobalPreferences.plist");
...
+ (id)DAManagedDefaults
{
  ...
  objc_msgSend((id)objc_opt_class(), "_daManagedDefaultsPath");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)DAManagedDefaultForKey:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(a1, "DAManagedDefaults");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (BOOL)addDAManagedDefaults:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend((id)objc_opt_class(), "DAManagedDefaults");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v7 = objc_msgSend((id)objc_opt_class(), "setDAManagedDefaults:", v3);
...
+ (void)removeDAManagedDefaults:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend((id)objc_opt_class(), "setDAManagedDefaults:", v5);
  }
...
+ (int64_t)rem_changeTrackingBehaviors
{
    ...
    || rem_changeTrackingBehaviors___lastToken != sDABehaviorToken)
  {
    ...
    if (v3)
    {
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("DADREMChangeTrackingBehaviors"));
      v5 = (void *)objc_claimAutoreleasedReturnValue();

      if (v5)
      {
        objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("DADREMChangeTrackingBehaviors"));
        v6 = (void *)objc_claimAutoreleasedReturnValue();
        rem_changeTrackingBehaviors___remChangeTrackingBehaviors = (int)objc_msgSend(v6, "intValue");
