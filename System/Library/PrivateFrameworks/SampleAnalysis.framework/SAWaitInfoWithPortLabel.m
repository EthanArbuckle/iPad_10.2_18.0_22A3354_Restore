...
- (SAWaitInfoWithPortLabel)initWithKCDataWaitInfo:(const stackshot_thread_waitinfo_v2 *)a3
{
  ...
  uint64_t v9;
  uint64_t v10;
  SAWaitInfoWithPortLabel *result;
  uint8_t v12[16];
  ...
  {
    *(_WORD *)v12 = 0;
    _os_log_error_impl(&dword_1B9BE0000, v4, OS_LOG_TYPE_ERROR, "SAWaitInfoWithPortLabel init with port info", v12, 2u);
  }

  *__error() = v3;
  _SASetCrashLogMessage(2811, "SAWaitInfoWithPortLabel init with port info", v5, v6, v7, v8, v9, v10, v12[0]);
