...
+ (id)filterFromKVFieldTypeNumber:(id)a3
{
  ...
  v4 = KVFieldTypeToCascadeFieldType();
  if ((_DWORD)v4 == (unsigned __int16)*MEMORY[0x24BE15620])
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_25441F970, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      v16 = 2112;
      v17 = v3;
      _os_log_error_impl(&dword_2462C4000, v5, OS_LOG_TYPE_ERROR, "%s Ignoring unsupported KVFieldType filter: %@", buf, 0x16u);
    }
    v6 = 0;
  }
  else
  {
    ...
    v13 = 0;
    v6 = (void *)objc_msgSend_initWithFieldType_error_(v8, v9, v7, &v13);
    v10 = v13;
    if (!v6)
    {
      v11 = qword_25441F970;
...
{
  uint64_t v5;
  SEMCascadeFieldTypeFilter *v6;
  const char *v7;
  SEMCascadeFieldTypeFilter *v8;
  const char *v9;
  SEMCascadeFieldTypeFilter *v10;
  void *v11;
  void *v12;
  void *v13;
  const char *v14;
  ...
  v22.receiver = self;
  v22.super_class = (Class)SEMCascadeFieldTypeFilter;
  v6 = -[SEMCascadeFieldTypeFilter init](&v22, sel_init);
  v8 = v6;
  if (v6 && (v6->_fieldType = v5, (objc_msgSend_isValidFieldType_(MEMORY[0x24BE5B238], v7, v5) & 1) == 0))
  {
...
- (BOOL)isEqual:(id)a3
{
  SEMCascadeFieldTypeFilter *v4;
  SEMCascadeFieldTypeFilter *v5;
  const char *v6;
  char isEqualToCascadeFieldTypeFilter;

  v4 = (SEMCascadeFieldTypeFilter *)a3;
  v5 = v4;
  if (v4 == self)
  {
    isEqualToCascadeFieldTypeFilter = 1;
  }
  else if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    isEqualToCascadeFieldTypeFilter = objc_msgSend_isEqualToCascadeFieldTypeFilter_(self, v6, (uint64_t)v5);
  }
  else
  {
    isEqualToCascadeFieldTypeFilter = 0;
  }
...
- (id)description
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SEMCascadeFieldTypeFilter;
  -[SEMCascadeFieldTypeFilter description](&v9, sel_description);
