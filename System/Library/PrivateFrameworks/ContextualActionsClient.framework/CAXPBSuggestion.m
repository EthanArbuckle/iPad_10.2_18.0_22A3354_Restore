...
{
  -[NSMutableArray removeAllObjects](self->_suggestedActions, "removeAllObjects");
}
...
- (void)addSuggestedActions:(id)a3
{
  ...
  -[NSMutableArray addObject:](suggestedActions, "addObject:", v4);

}

- (unint64_t)suggestedActionsCount
{
  return -[NSMutableArray count](self->_suggestedActions, "count");
}

- (id)suggestedActionsAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_suggestedActions, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[CAXPBSuggestion description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CAXPBSuggestion dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_suggestedActions, "count"))
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_suggestedActions, "count"));
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("suggestedActions"));
  }
  modelVersion = self->_modelVersion;
  if (modelVersion)
    objc_msgSend(v3, "setObject:forKey:", modelVersion, CFSTR("modelVersion"));
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[CAXPBSuggestion suggestedActionsCount](self, "suggestedActionsCount"))
  {
    objc_msgSend(v8, "clearSuggestedActions");
    v4 = -[CAXPBSuggestion suggestedActionsCount](self, "suggestedActionsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[CAXPBSuggestion suggestedActionsAtIndex:](self, "suggestedActionsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addSuggestedActions:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addSuggestedActions:", v11);
  ...
  v12 = -[NSString copyWithZone:](self->_modelVersion, "copyWithZone:", a3);
  v13 = (void *)v5[1];
  v5[1] = v12;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](suggestedActions, "isEqual:")))
  {
    ...
    if ((unint64_t)modelVersion | v4[1])
      v7 = -[NSString isEqual:](modelVersion, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_suggestedActions, "hash");
  return -[NSString hash](self->_modelVersion, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[CAXPBSuggestion addSuggestedActions:](self, "addSuggestedActions:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
{
  objc_storeStrong((id *)&self->_suggestedActions, a3);
}
