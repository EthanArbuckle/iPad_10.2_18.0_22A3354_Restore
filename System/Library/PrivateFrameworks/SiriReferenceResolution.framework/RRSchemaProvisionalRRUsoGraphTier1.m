...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[RRSchemaProvisionalRRUsoGraphTier1 usoGraphTier1](self, "usoGraphTier1");
...
- (id)dictionaryRepresentation
{
  ...
  -[RRSchemaProvisionalRRUsoGraphTier1 willProduceDictionaryRepresentation:](self, "willProduceDictionaryRepresentation:", v3);
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[RRSchemaProvisionalRRUsoGraphTier1 dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RRSchemaProvisionalRRUsoGraphTier1 *v5;
  uint64_t v7;
  ...
  {
    self = -[RRSchemaProvisionalRRUsoGraphTier1 initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RRSchemaProvisionalRRUsoGraphTier1)initWithDictionary:(id)a3
{
  ...
  void *v6;
  void *v7;
  RRSchemaProvisionalRRUsoGraphTier1 *v8;
  objc_super v10;

  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)RRSchemaProvisionalRRUsoGraphTier1;
  v5 = -[RRSchemaProvisionalRRUsoGraphTier1 init](&v10, sel_init);
  if (v5)
  {
    ...
    {
      v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE95EF8]), "initWithDictionary:", v6);
      -[RRSchemaProvisionalRRUsoGraphTier1 setUsoGraphTier1:](v5, "setUsoGraphTier1:", v7);
