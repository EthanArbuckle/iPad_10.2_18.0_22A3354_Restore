...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[RRSchemaProvisionalRREntityPoolResolveFailed reason](self, "reason") - 1;
    if (v4 > 2)
      v5 = CFSTR("RRRESOLVEFAILUREREASON_UNKNOWN");
    else
      v5 = *(&off_24CDCC128 + v4);
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("reason"));
  }
  -[RRSchemaProvisionalRREntityPoolResolveFailed willProduceDictionaryRepresentation:](self, "willProduceDictionaryRepresentation:", v3);
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[RRSchemaProvisionalRREntityPoolResolveFailed dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RRSchemaProvisionalRREntityPoolResolveFailed *v5;
  uint64_t v7;
  ...
  {
    self = -[RRSchemaProvisionalRREntityPoolResolveFailed initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RRSchemaProvisionalRREntityPoolResolveFailed)initWithDictionary:(id)a3
{
  ...
  RRSchemaProvisionalRREntityPoolResolveFailed *v5;
  void *v6;
  RRSchemaProvisionalRREntityPoolResolveFailed *v7;
  objc_super v9;

  v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)RRSchemaProvisionalRREntityPoolResolveFailed;
  v5 = -[RRSchemaProvisionalRREntityPoolResolveFailed init](&v9, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RRSchemaProvisionalRREntityPoolResolveFailed setReason:](v5, "setReason:", objc_msgSend(v6, "intValue"));
    v7 = v5;
