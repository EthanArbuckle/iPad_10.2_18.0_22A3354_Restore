...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[RRSchemaProvisionalRREntityPoolResolveEnded queryResults](self, "queryResults");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    v4 = -[RRSchemaProvisionalRREntityPoolResolveEnded outcome](self, "outcome") - 1;
    if (v4 > 3)
  ...
  -[RRSchemaProvisionalRREntityPoolResolveEnded willProduceDictionaryRepresentation:](self, "willProduceDictionaryRepresentation:", v3, (_QWORD)v15);
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[RRSchemaProvisionalRREntityPoolResolveEnded dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  RRSchemaProvisionalRREntityPoolResolveEnded *v5;
  uint64_t v7;
  ...
  {
    self = -[RRSchemaProvisionalRREntityPoolResolveEnded initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (RRSchemaProvisionalRREntityPoolResolveEnded)initWithDictionary:(id)a3
{
  ...
  void *v15;
  RRSchemaProvisionalRREntityPoolResolveEnded *v16;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
  ...
  v5 = -[RRSchemaProvisionalRREntityPoolResolveEnded init](&v22, sel_init);
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              -[RRSchemaProvisionalRREntityPoolResolveEnded addQueryResults:](v5, "addQueryResults:", v14);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[RRSchemaProvisionalRREntityPoolResolveEnded setOutcome:](v5, "setOutcome:", objc_msgSend(v15, "intValue"));
    v16 = v5;
