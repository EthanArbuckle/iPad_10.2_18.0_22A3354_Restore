...
- (NSArray)subscriptionIDs
{
  ...
  v4 = (void *)-[NSArray copy](self->_subscriptionIDs, "copy");
...
- (void)setSubscriptionIDs:(id)a3
{
  ...
  -[NSMutableSet addObject:](self->super.super._explicitlySetProperties, "addObject:", CFSTR("subscriptionIDs"));
  os_unfair_lock_unlock(p_internalLock);
}
...
- (id)perSubscriptionCompletionBlock
{
  ...
  p_internalLock = &self->super.super._internalLock;
  os_unfair_lock_lock(&self->super.super._internalLock);
  v4 = (void *)objc_msgSend(self->_perSubscriptionCompletionBlock, "copy");
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setPerSubscriptionCompletionBlock:(id)a3
{
  ...
  self->_perSubscriptionCompletionBlock = v6;

  -[NSMutableSet addObject:](self->super.super._explicitlySetProperties, "addObject:", CFSTR("perSubscriptionCompletionBlock"));
  os_unfair_lock_unlock(p_internalLock);
}
...
- (id)fetchSubscriptionCompletionBlock
{
  ...
  p_internalLock = &self->super.super._internalLock;
  os_unfair_lock_lock(&self->super.super._internalLock);
  v4 = (void *)objc_msgSend(self->_fetchSubscriptionCompletionBlock, "copy");
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setFetchSubscriptionCompletionBlock:(id)a3
{
  ...
  self->_fetchSubscriptionCompletionBlock = v6;

  -[NSMutableSet addObject:](self->super.super._explicitlySetProperties, "addObject:", CFSTR("fetchSubscriptionCompletionBlock"));
  os_unfair_lock_unlock(p_internalLock);
}

- (id)_makeOperation
{
  return objc_alloc_init(MEMORY[0x1E0C94E68]);
}
...
- (void)_setUpOperation:(id)a3
{
  ...
  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)WBSRetryableCKFetchSubscriptionsOperation;
  -[WBSRetryableCKDatabaseOperation _setUpOperation:](&v11, sel__setUpOperation_, v4);
  if (-[NSMutableSet containsObject:](self->super.super._explicitlySetProperties, "containsObject:", CFSTR("subscriptionIDs")))objc_msgSend(v4, "setSubscriptionIDs:", self->_subscriptionIDs);
  ...
  if (self->_perSubscriptionCompletionBlock)
  {
    ...
    v8[0] = v5;
    v8[1] = 3221225472;
    v8[2] = __61__WBSRetryableCKFetchSubscriptionsOperation__setUpOperation___block_invoke;
    v8[3] = &unk_1E4B3F128;
    objc_copyWeak(&v9, &location);
    objc_msgSend(v4, "setPerSubscriptionCompletionBlock:", v8);
    objc_destroyWeak(&v9);
  ...
  v6[0] = v5;
  v6[1] = 3221225472;
  v6[2] = __61__WBSRetryableCKFetchSubscriptionsOperation__setUpOperation___block_invoke_3;
  v6[3] = &unk_1E4B3EFC0;
  objc_copyWeak(&v7, &location);
  objc_msgSend(v4, "setFetchSubscriptionCompletionBlock:", v6);
  objc_destroyWeak(&v7);
  objc_destroyWeak(&location);
...
void __61__WBSRetryableCKFetchSubscriptionsOperation__setUpOperation___block_invoke_2(_QWORD *a1)
{
  id WeakRetained;
  void *v3;
  ...
  if (WeakRetained)
  {
    ...
    v3 = (void *)MEMORY[0x1A8599ED0](*(_QWORD *)(a1[4] + 400));
