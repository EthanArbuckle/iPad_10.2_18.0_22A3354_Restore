...
- (NSArray)userIdentityLookupInfos
{
  ...
  v4 = (void *)-[NSArray copy](self->_userIdentityLookupInfos, "copy");
...
- (void)setUserIdentityLookupInfos:(id)a3
{
  ...
  -[NSMutableSet addObject:](self->super._explicitlySetProperties, "addObject:", CFSTR("userIdentityLookupInfos"));
  os_unfair_lock_unlock(p_internalLock);
}
...
- (id)perShareParticipantCompletionBlock
{
  ...
  p_internalLock = &self->super._internalLock;
  os_unfair_lock_lock(&self->super._internalLock);
  v4 = (void *)objc_msgSend(self->_perShareParticipantCompletionBlock, "copy");
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setPerShareParticipantCompletionBlock:(id)a3
{
  ...
  self->_perShareParticipantCompletionBlock = v6;

  -[NSMutableSet addObject:](self->super._explicitlySetProperties, "addObject:", CFSTR("perShareParticipantCompletionBlock"));
  os_unfair_lock_unlock(p_internalLock);
}
...
- (id)fetchShareParticipantsCompletionBlock
{
  ...
  p_internalLock = &self->super._internalLock;
  os_unfair_lock_lock(&self->super._internalLock);
  v4 = (void *)objc_msgSend(self->_fetchShareParticipantsCompletionBlock, "copy");
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setFetchShareParticipantsCompletionBlock:(id)a3
{
  ...
  self->_fetchShareParticipantsCompletionBlock = v6;

  -[NSMutableSet addObject:](self->super._explicitlySetProperties, "addObject:", CFSTR("fetchShareParticipantsCompletionBlock"));
  os_unfair_lock_unlock(p_internalLock);
}

- (id)_makeOperation
{
  return objc_alloc_init(MEMORY[0x1E0C94E58]);
}
...
- (void)_setUpOperation:(id)a3
{
  ...
  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)WBSRetryableCKFetchShareParticipantsOperation;
  -[WBSRetryableCKOperation _setUpOperation:](&v11, sel__setUpOperation_, v4);
  if (-[NSMutableSet containsObject:](self->super._explicitlySetProperties, "containsObject:", CFSTR("userIdentityLookupInfos")))objc_msgSend(v4, "setUserIdentityLookupInfos:", self->_userIdentityLookupInfos);
  ...
  if (self->_perShareParticipantCompletionBlock)
  {
    ...
    v8[0] = v5;
    v8[1] = 3221225472;
    v8[2] = __65__WBSRetryableCKFetchShareParticipantsOperation__setUpOperation___block_invoke;
    v8[3] = &unk_1E4B3F100;
    objc_copyWeak(&v9, &location);
    objc_msgSend(v4, "setPerShareParticipantCompletionBlock:", v8);
    objc_destroyWeak(&v9);
  ...
  v6[0] = v5;
  v6[1] = 3221225472;
  v6[2] = __65__WBSRetryableCKFetchShareParticipantsOperation__setUpOperation___block_invoke_3;
  v6[3] = &unk_1E4B3EE80;
  objc_copyWeak(&v7, &location);
  objc_msgSend(v4, "setFetchShareParticipantsCompletionBlock:", v6);
  objc_destroyWeak(&v7);
  objc_destroyWeak(&location);
...
void __65__WBSRetryableCKFetchShareParticipantsOperation__setUpOperation___block_invoke_2(_QWORD *a1)
{
  id WeakRetained;
  void *v3;
