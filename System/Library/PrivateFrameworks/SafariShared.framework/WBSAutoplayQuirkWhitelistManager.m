...
- (WBSAutoplayQuirkWhitelistManager)init
{
  ...
  void *v9;
  double v10;
  WBSAutoplayQuirkWhitelistManager *v11;
  ...
  objc_msgSend(v6, "URLForResource:withExtension:", CFSTR("SitesAllowedToUseAutoplayQuirks"), CFSTR("plist"));
  ...
  if (v5 != 0.0)
    v10 = v5;
  v11 = -[WBSAutoplayQuirkWhitelistManager initWithBuiltInWhitelistURL:downloadsDirectoryURL:resourceName:resourceVersion:updateDateDefaultsKey:updateInterval:](self, "initWithBuiltInWhitelistURL:downloadsDirectoryURL:resourceName:resourceVersion:updateDateDefaultsKey:updateInterval:", v7, v9, CFSTR("SitesAllowedToUseAutoplayQuirks"), CFSTR("1"), CFSTR("AutoplayQuirksWhitelistConfigurationUpdateDate"), v10);
...
- (WBSAutoplayQuirkWhitelistManager)initWithBuiltInWhitelistURL:(id)a3 downloadsDirectoryURL:(id)a4 resourceName:(id)a5 resourceVersion:(id)a6 updateDateDefaultsKey:(id)a7 updateInterval:(double)a8
{
  ...
  id v17;
  id v18;
  WBSAutoplayQuirkWhitelistManager *v19;
  id v20;
  uint64_t v21;
  uint64_t v22;
  WBSRemotelyUpdatableDataController *remotelyUpdatableDataController;
  WBSAutoplayQuirkWhitelistManager *v24;
  objc_super v26;
  ...
  v19 = -[WBSAutoplayQuirkWhitelistManager init](&v26, sel_init);
  if (v19)
  {
...
{
  return (*(uint64_t (**)(_QWORD, uint64_t))(*(_QWORD *)(a1 + 40) + 16))(*(_QWORD *)(a1 + 40), objc_msgSend(a2, "quirkTypeForDomain:", *(_QWORD *)(a1 + 32)));
}
