...
- (id)perRecordZoneCompletionBlock
{
  ...
  p_internalLock = &self->super.super._internalLock;
  os_unfair_lock_lock(&self->super.super._internalLock);
  v4 = (void *)objc_msgSend(self->_perRecordZoneCompletionBlock, "copy");
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setPerRecordZoneCompletionBlock:(id)a3
{
  ...
  self->_perRecordZoneCompletionBlock = v6;

  -[NSMutableSet addObject:](self->super.super._explicitlySetProperties, "addObject:", CFSTR("perRecordZoneCompletionBlock"));
  os_unfair_lock_unlock(p_internalLock);
}
...
- (id)fetchRecordZonesCompletionBlock
{
  ...
  p_internalLock = &self->super.super._internalLock;
  os_unfair_lock_lock(&self->super.super._internalLock);
  v4 = (void *)objc_msgSend(self->_fetchRecordZonesCompletionBlock, "copy");
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setFetchRecordZonesCompletionBlock:(id)a3
{
  ...
  self->_fetchRecordZonesCompletionBlock = v6;

  -[NSMutableSet addObject:](self->super.super._explicitlySetProperties, "addObject:", CFSTR("fetchRecordZonesCompletionBlock"));
  os_unfair_lock_unlock(p_internalLock);
}

- (id)_makeOperation
{
  return objc_alloc_init(MEMORY[0x1E0C94E00]);
}
...
- (void)_setUpOperation:(id)a3
{
  ...
  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)WBSRetryableCKFetchRecordZonesOperation;
  ...
  if (self->_perRecordZoneCompletionBlock)
  {
    ...
    v8[0] = v5;
    v8[1] = 3221225472;
    v8[2] = __59__WBSRetryableCKFetchRecordZonesOperation__setUpOperation___block_invoke;
    v8[3] = &unk_1E4B3F0B0;
    objc_copyWeak(&v9, &location);
    objc_msgSend(v4, "setPerRecordZoneCompletionBlock:", v8);
    objc_destroyWeak(&v9);
  ...
  v6[0] = v5;
  v6[1] = 3221225472;
  v6[2] = __59__WBSRetryableCKFetchRecordZonesOperation__setUpOperation___block_invoke_3;
  v6[3] = &unk_1E4B3EFC0;
  objc_copyWeak(&v7, &location);
  objc_msgSend(v4, "setFetchRecordZonesCompletionBlock:", v6);
  objc_destroyWeak(&v7);
  objc_destroyWeak(&location);
...
void __59__WBSRetryableCKFetchRecordZonesOperation__setUpOperation___block_invoke_2(_QWORD *a1)
{
  id WeakRetained;
  void *v3;
