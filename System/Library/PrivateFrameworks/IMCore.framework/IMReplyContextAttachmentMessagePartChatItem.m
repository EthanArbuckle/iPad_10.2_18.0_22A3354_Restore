...
- (id)_initWithItem:(id)a3 parentItem:(id)a4 replyMessageGUID:(id)a5 replyIsFromMe:(BOOL)a6 text:(id)a7 index:(int64_t)a8 messagePartRange:(_NSRange)a9 transferGUID:(id)a10 chatContext:(id)a11
{
  ...
  v17 = a5;
  v25.receiver = self;
  v25.super_class = (Class)IMReplyContextAttachmentMessagePartChatItem;
  v18 = -[IMAttachmentMessagePartChatItem _initWithItem:text:index:messagePartRange:transferGUID:chatContext:](&v25, sel__initWithItem_text_index_messagePartRange_transferGUID_chatContext_, v16, a7, a8, a9.location, a9.length, a10, a11);
  if (v18)
  {
    ...
    objc_storeStrong(v18 + 27, a4);
    *((_BYTE *)v18 + 208) = a6;
    objc_storeStrong(v18 + 28, obj);
...
- (id)_initWithItem:(id)a3 parentItem:(id)a4 replyMessageGUID:(id)a5 replyIsFromMe:(BOOL)a6 text:(id)a7 index:(int64_t)a8 messagePartRange:(_NSRange)a9 transferGUID:(id)a10 chatContext:(id)a11 visibleAssociatedMessageChatItems:(id)a12
{
  ...
  v17 = a5;
  v27.receiver = self;
  v27.super_class = (Class)IMReplyContextAttachmentMessagePartChatItem;
  v18 = -[IMAttachmentMessagePartChatItem _initWithItem:text:index:messagePartRange:transferGUID:chatContext:visibleAssociatedMessageChatItems:](&v27, sel__initWithItem_text_index_messagePartRange_transferGUID_chatContext_visibleAssociatedMessageChatItems_, v16, a7, a8, a9.location, a9.length, a10, a11, a12);
  if (v18)
  {
    objc_msgSend(v16, "guid");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
