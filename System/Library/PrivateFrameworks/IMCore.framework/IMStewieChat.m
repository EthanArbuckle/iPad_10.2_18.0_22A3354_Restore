...
- (IMStewieChat)init
{
  ...
  v4 = -[IMStewieChat initWithDaemon:](self, "initWithDaemon:", v3);
...
- (void)sendQuestionnaire:(id)a3
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_impl(&dword_1A1FF4000, v5, OS_LOG_TYPE_INFO, "Sending request to daemon to send questionnaire", v6, 2u);
    }

  }
  -[IMDaemonProtocol sendQuestionnaire:](self->_daemon, "sendQuestionnaire:", v4);
...
- (void)locationUpdateDelivered:(id)a3
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_impl(&dword_1A1FF4000, v5, OS_LOG_TYPE_INFO, "Sending a location update", v6, 2u);
    }

  }
  -[IMDaemonProtocol locationUpdateDelivered:](self->_daemon, "locationUpdateDelivered:", v4);
...
- (void)openStewieChatWithContext:(id)a3
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_impl(&dword_1A1FF4000, v5, OS_LOG_TYPE_INFO, "Opening Stewie chat", v6, 2u);
    }

  }
  -[IMDaemonProtocol openStewieChatWithContext:](self->_daemon, "openStewieChatWithContext:", v4);
...
- (IMStewieChat)initWithDaemon:(id)a3
{
  ...
  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)IMStewieChat;
  v5 = -[IMStewieChat init](&v8, sel_init);
  v6 = v5;
  if (v5)
  {
    -[IMStewieChat setDaemon:](v5, "setDaemon:", v4);
    -[IMStewieChat setUpConnectionToDaemaon](v6, "setUpConnectionToDaemaon");
  }
...
- (void)dealloc
{
  ...
  -[IMStewieChat setDaemon:](self, "setDaemon:", 0);
  v4.receiver = self;
  v4.super_class = (Class)IMStewieChat;
  -[IMStewieChat dealloc](&v4, sel_dealloc);
}
...
- (void)setUpConnectionToDaemaon
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_1A1FF4000, v3, OS_LOG_TYPE_INFO, "Setting up IMAgent connect for Stewie chat", buf, 2u);
    }
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@-IMStewieChat"), v5);
