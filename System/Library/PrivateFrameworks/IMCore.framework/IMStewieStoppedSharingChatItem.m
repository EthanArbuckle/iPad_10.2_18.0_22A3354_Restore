...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  handle = self->_handle;
  -[IMStewieStoppedSharingChatItem chat](self, "chat");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v4, "_initWithItem:emergencyUserHandle:chat:", v5, handle, v7);
...
- (id)_initWithItem:(id)a3 emergencyUserHandle:(id)a4 chat:(id)a5
{
  ...
  v10 = a5;
  v16.receiver = self;
  v16.super_class = (Class)IMStewieStoppedSharingChatItem;
