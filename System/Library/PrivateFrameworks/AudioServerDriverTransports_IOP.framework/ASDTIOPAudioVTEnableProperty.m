...
+ (id)configDictForService:(id)a3
{
  ...
  v8[1] = v3;
  v9[0] = CFSTR("ASDTIOPAudioVTEnableProperty");
  v9[1] = a3;
...
- (ASDTIOPAudioVTEnableProperty)initWithConfig:(id)a3
{
  void *v4;
  void *v5;
  ASDTIOPAudioVTEnableProperty *v6;
  objc_super v8;
  uint64_t v9;
  _QWORD v10[2];
...
- (BOOL)storeUInt32Value:(unsigned int)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(v3) = objc_msgSend(v4, "setEnabled:", v3);
...
- (BOOL)retrieveUInt32Value:(unsigned int *)a3
{
  ...
  -[ASDTIOPAudioVTProperty vtDevice](self, "vtDevice");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(a3) = objc_msgSend(v4, "getIsEnabled:", a3);
