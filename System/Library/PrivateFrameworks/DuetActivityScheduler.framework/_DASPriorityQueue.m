...
- (_DASPriorityQueue)init
{
  ...
  v2 = -[_DASPriorityQueue init](&v6, sel_init);
  if (v2)
  {
...
- (id)description
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "stringWithFormat:", CFSTR("<_DASPriority Queue: Count=%@, High=%@, Low=%@, Items=%@>"), v5, highestPriority, lowestPriority, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
