...
{
  id v7;
  PMLAWDLogisticRegTrackerMock *v8;
  PMLAWDLogisticRegTrackerMock *v9;
  objc_super v11;
...
- (PMLAWDLogisticRegTrackerMock)initWithModel:(id)a3
{
  id v4;
  void *v5;
  PMLAWDLogisticRegTrackerMock *v6;

  v4 = a3;
  v5 = (void *)objc_opt_new();
  v6 = -[PMLAWDLogisticRegTrackerMock initWithAdapter:modelInfo:](self, "initWithAdapter:modelInfo:", v5, v4);
...
+ (id)mockTracker
{
  return (id)objc_msgSend(a1, "mockTrackerForPlanId:", CFSTR("mock-1.0-en"));
}
