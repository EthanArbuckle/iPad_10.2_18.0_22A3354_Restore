...
id ___SubcompletionGenerator_block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(WeakRetained, "SUIAC2GroupCompletionAnimationDidBegin:", v3);
...
void ___SubcompletionGenerator_block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  objc_msgSend(WeakRetained, "SUIAC2GroupCompletionAnimationDidComplete:finished:retargeted:", *(_QWORD *)(a1 + 32), a2, a3);
