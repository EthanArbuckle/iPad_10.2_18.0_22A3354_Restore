...
- (SUIAButtonEmanatingSiriShockwaveStyle)initWithNormalizedButtonEdgeLocation:(CGRect)a3 shockwaveViewBounds:(CGRect)a4
{
  ...
  CGFloat y;
  CGFloat x;
  SUIAButtonEmanatingSiriShockwaveStyle *result;
  objc_super v9;
...
- (id)chromaticAberrationConfigurationForState:(int64_t)a3
{
  ...
  if (objc_msgSend(v5, "siriButtonChromaticAberrationEnabled"))
  {
    ...
    if (!v7)
    {
      ...
      +[_SUIAShockwaveChromaticAberrationConfiguration chromaticAberrationConfigurationForState:variant:buttonEmanating:normalizedStartLocation:settings:bounds:](_SUIAShockwaveChromaticAberrationConfiguration, "chromaticAberrationConfigurationForState:variant:buttonEmanating:normalizedStartLocation:settings:bounds:", a3, 1, 1, v5, self->_normalizedButtonLocation.origin.x, self->_normalizedButtonLocation.origin.y, self->_normalizedButtonLocation.size.width, self->_normalizedButtonLocation.size.height, v8, v9, v10, v11);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)meshConfigurationForState:(int64_t)a3
{
  ...
  {
    if ((objc_msgSend(v5, "siriButtonMeshEnabledLargeScreen") & 1) == 0)
    {
LABEL_3:
      v8 = 0;
      goto LABEL_7;
  ...
  else if (!objc_msgSend(v5, "siriButtonMeshEnabled"))
  {
    goto LABEL_3;
  }
...
- (id)fillLightConfigurationForState:(int64_t)a3
{
  ...
  -[SUIAAbstractShockwaveStyle _shockwaveSettings](self, "_shockwaveSettings");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v5, "siriButtonFillLightEnabled"))
  {
    ...
    {
      -[SUIAAbstractShockwaveStyle shockwaveBounds](self, "shockwaveBounds");
      +[_SUIAShockwaveFillLightConfiguration fillLightConfigurationForState:variant:normalizedStartLocation:settings:bounds:](_SUIAShockwaveFillLightConfiguration, "fillLightConfigurationForState:variant:normalizedStartLocation:settings:bounds:", a3, 1, v5, self->_normalizedButtonLocation.origin.x, self->_normalizedButtonLocation.origin.y, self->_normalizedButtonLocation.size.width, self->_normalizedButtonLocation.size.height, v8, v9, v10, v11);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[SUIAAbstractShockwaveStyle _setConfiguration:forType:state:](self, "_setConfiguration:forType:state:", v7, v6, a3);
    }
  }
...
- (id)edgeLightOverlayConfigurationForState:(int64_t)a3
{
  ...
  -[SUIAAbstractShockwaveStyle _shockwaveSettings](self, "_shockwaveSettings");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v5, "siriButtonEdgeLightEnabled"))
  {
