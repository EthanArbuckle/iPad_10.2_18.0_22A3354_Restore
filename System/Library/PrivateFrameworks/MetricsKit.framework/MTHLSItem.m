...
- (MTHLSItem)initWithStartOverallPosition:(unint64_t)a3 metricsData:(id)a4
{
  ...
  v7 = -[MTHLSItem init](&v10, sel_init);
  v8 = v7;
  if (v7)
  {
    -[MTHLSItem setStartOverallPosition:](v7, "setStartOverallPosition:", a3);
    -[MTHLSItem setEventData:](v8, "setEventData:", v6);
  }
...
- (int64_t)compare:(id)a3
{
  ...
  v4 = a3;
  v5 = -[MTHLSItem startOverallPosition](self, "startOverallPosition");
  ...
  {
    v7 = -[MTHLSItem startOverallPosition](self, "startOverallPosition");
