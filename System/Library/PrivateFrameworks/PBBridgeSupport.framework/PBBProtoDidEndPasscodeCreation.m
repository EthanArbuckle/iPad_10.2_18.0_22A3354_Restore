...
- (id)description
{
  ...
  -[PBBProtoDidEndPasscodeCreation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PBBProtoDidEndPasscodeCreation dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isLong);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("isLong"));
...
- (void)copyTo:(id)a3
{
  *((_BYTE *)a3 + 9) = self->_success;
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_BYTE *)a3 + 8) = self->_isLong;
    *((_BYTE *)a3 + 12) |= 1u;
  }
}
...
{
  self->_success = *((_BYTE *)a3 + 9);
  if ((*((_BYTE *)a3 + 12) & 1) != 0)
  {
    self->_isLong = *((_BYTE *)a3 + 8);
    *(_BYTE *)&self->_has |= 1u;
  }
}
