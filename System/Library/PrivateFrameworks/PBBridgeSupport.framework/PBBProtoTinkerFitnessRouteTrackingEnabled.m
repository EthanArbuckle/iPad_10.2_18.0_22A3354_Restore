...
- (id)description
{
  ...
  -[PBBProtoTinkerFitnessRouteTrackingEnabled description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PBBProtoTinkerFitnessRouteTrackingEnabled dictionaryRepresentation](self, "dictionaryRepresentation");
