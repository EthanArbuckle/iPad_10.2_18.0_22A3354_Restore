...
- (id)description
{
  ...
  -[PBBProtoDeviceManagementSetupRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PBBProtoDeviceManagementSetupRequest dictionaryRepresentation](self, "dictionaryRepresentation");
