...
- (id)description
{
  ...
  -[PBBProtoBeganWaitingForUserResponseToActivationEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PBBProtoBeganWaitingForUserResponseToActivationEvent dictionaryRepresentation](self, "dictionaryRepresentation");
