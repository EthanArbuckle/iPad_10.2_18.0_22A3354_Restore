...
{
  return -[PGStashedMaskView initWithFrame:minimumStashTabSize:](self, "initWithFrame:minimumStashTabSize:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, *MEMORY[0x1E0C9D820], *(double *)(MEMORY[0x1E0C9D820] + 8));
}
...
- (PGStashedMaskView)initWithFrame:(CGRect)a3 minimumStashTabSize:(CGSize)a4
{
  double height;
  double width;
  PGStashedMaskView *v6;
  PGStashedMaskView *v7;
  id v8;
  double v9;
  double v10;
  double v11;
  ...
  if (v6)
  {
    ...
    -[UIView _setContinuousCornerRadius:](v7->_mainBody, "_setContinuousCornerRadius:", 15.0);
    -[UIView _setContinuousCornerRadius:](v7->_tab, "_setContinuousCornerRadius:", 15.0);
    ...
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_mainBody);
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_tab);
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_tabTopCornerFill);
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_tabBottomCornerFill);
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_tabLeftTopCornerDestOut);
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_tabLeftBottomCornerDestOut);
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_tabRightTopCornerDestOut);
    -[PGStashedMaskView addSubview:](v7, "addSubview:", v7->_tabRightBottomCornerDestOut);
    -[PGStashedMaskView setMinimumStashTabSize:](v7, "setMinimumStashTabSize:", width, height);
    -[UIView PG_setAllowsGroupBlending:](v7, "PG_setAllowsGroupBlending:", 0);
    -[UIView PG_setAllowsEdgeAntialiasing:](v7, "PG_setAllowsEdgeAntialiasing:", 1);
  }
  return v7;
}
...
- (void)setTabHidden:(BOOL)a3 left:(BOOL)a4
{
  ...
  if (self->_tabHidden != a3 || self->_tabShownLeft != a4)
  {
    ...
    -[PGStashedMaskView bounds](self, "bounds");
    v6 = 15.0;
    if (v7 >= 105.0)
    {
      -[PGStashedMaskView bounds](self, "bounds", 15.0);
      v6 = 15.0;
      if (v8 < 136.0)
      {
        -[PGStashedMaskView bounds](self, "bounds", 15.0);
        v10 = fmax((v9 + -105.0) / 31.0 + 0.0, 0.0);
        v11 = v10 * -5.0 + 15.0;
        if (v10 >= 1.0)
          v11 = 10.0;
        v6 = fmin(fmax(v11, 10.0), 15.0);
      }
    }
    if (self->_tabHidden)
      v6 = 15.0;
    -[PGStashedMaskView _setContinuousCornerRadius:](self, "_setContinuousCornerRadius:", v6);
    if (a3)
    {
      tab = self->_tab;
      ...
      *(_OWORD *)&v31.tx = *(_OWORD *)(MEMORY[0x1E0C9BAA8] + 32);
      v27 = *(_OWORD *)&v31.tx;
      -[UIView setTransform:](tab, "setTransform:", &v31);
      WeakRetained = objc_loadWeakRetained((id *)&self->_tabShadowView);
      *(_OWORD *)&v31.a = v28;
      *(_OWORD *)&v31.c = v29;
      *(_OWORD *)&v31.tx = v27;
      objc_msgSend(WeakRetained, "setTransform:", &v31);

      tabTopCornerFill = self->_tabTopCornerFill;
      *(_OWORD *)&v31.a = v28;
      *(_OWORD *)&v31.c = v29;
      *(_OWORD *)&v31.tx = v27;
      -[UIView setTransform:](tabTopCornerFill, "setTransform:", &v31);
      tabBottomCornerFill = self->_tabBottomCornerFill;
      *(_OWORD *)&v31.a = v28;
      *(_OWORD *)&v31.c = v29;
      *(_OWORD *)&v31.tx = v27;
      -[UIView setTransform:](tabBottomCornerFill, "setTransform:", &v31);
      v16 = objc_loadWeakRetained((id *)&self->_tabShadowView);
      v17 = v16;
      v18 = 0.0;
    }
    else
    {
      ...
      *(_OWORD *)&v30.tx = *(_OWORD *)(MEMORY[0x1E0C9BAA8] + 32);
      ...
      v23 = self->_tab;
      v30 = v31;
      -[UIView setTransform:](v23, "setTransform:", &v30);
      v24 = objc_loadWeakRetained((id *)&self->_tabShadowView);
      v30 = v31;
      objc_msgSend(v24, "setTransform:", &v30);

      v25 = self->_tabTopCornerFill;
      v30 = v31;
      -[UIView setTransform:](v25, "setTransform:", &v30);
      v26 = self->_tabBottomCornerFill;
      v30 = v31;
      -[UIView setTransform:](v26, "setTransform:", &v30);
      v16 = objc_loadWeakRetained((id *)&self->_tabShadowView);
      v17 = v16;
      v18 = 1.0;
    }
...
- (CGRect)_mainBodyBounds
{
  ...
  v8 = v7;
  v10 = v9;
  -[PGStashedMaskView tabViewBounds](self, "tabViewBounds");
  if (v10 > v11)
    v11 = v10;
  v12 = v4;
  v13 = v6;
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  x = a3.x;
  tab = self->_tab;
  -[PGStashedMaskView superview](self, "superview", a4);
...
- (void)layoutSubviews
{
  ...
  -[PGStashedMaskView layoutSubviews](&v38, sel_layoutSubviews);
  -[PGStashedMaskView bounds](self, "bounds");
  v34 = v4;
  v35 = v3;
  v36 = v5;
  v37 = v6;
  -[PGStashedMaskView _mainBodyBounds](self, "_mainBodyBounds");
  v8 = v7;
  v10 = v9;
  v12 = v11;
  v14 = v13;
  ...
  tabTopCornerFill = self->_tabTopCornerFill;
  -[UIView position](self->_tab, "position");
  -[UIView position](self->_tab, "position");
  UIPointRoundToScale();
  ...
  -[UIView position](self->_tabLeftTopCornerDestOut, "position");
  UIPointRoundToScale();
  ...
  -[UIView position](self->_tabLeftBottomCornerDestOut, "position");
  UIPointRoundToScale();
