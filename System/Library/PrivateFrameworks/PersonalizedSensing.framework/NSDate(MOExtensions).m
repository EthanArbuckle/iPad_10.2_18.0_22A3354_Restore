...
- (id)stringFromDate
{
  ...
  v4 = v3;
  objc_msgSend(MEMORY[0x24BDBCE60], "dateFormatter");
...
- (id)getBundleRelativeDate
{
  ...
  objc_msgSend(MEMORY[0x24BDBCE60], "dayNameFormatterInEnglish");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_243AAA000, v7, OS_LOG_TYPE_INFO, "bundleDay: %@, nowDay: %@", (uint8_t *)&v13, 0x16u);
  }
  ...
  {
    objc_msgSend(MEMORY[0x24BDBCE60], "monthDayFormatter");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
