...
- (AUHelperServiceProtocol)remoteObject
{
  ...
  if (xpcConnection)
  {
    objc_msgSend(xpcConnection, "synchronousRemoteObjectProxyWithErrorHandler:", &__block_literal_global_2);
...
+ (id)xpcConnectionToHelper
{
  ...
  if (v2)
  {
    objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_25637A028);
...
void __32__AUHelperInstance_remoteObject__block_invoke_cold_1(uint64_t a1)
{
  ...
  v3 = 2112;
  v4 = a1;
  _os_log_error_impl(&dword_235CB2000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "%s: Failed to get remote object: %@", (uint8_t *)&v1, 0x16u);
}
...
+ (void)xpcConnectionToHelper
{
  ...
  _os_log_error_impl(&dword_235CB2000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "%s: Failed to get xpc connection", (uint8_t *)&v0, 0xCu);
}
