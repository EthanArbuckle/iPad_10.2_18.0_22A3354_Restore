@implementation UARPStringCrashAnalyticsDirectoryFilePath
...
void __UARPStringCrashAnalyticsDirectoryFilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringWithFormat:", CFSTR("%@/%@"), v3, CFSTR("crsh"));
  v1 = objc_claimAutoreleasedReturnValue();
  v2 = (void *)UARPStringCrashAnalyticsDirectoryFilePath_path;
