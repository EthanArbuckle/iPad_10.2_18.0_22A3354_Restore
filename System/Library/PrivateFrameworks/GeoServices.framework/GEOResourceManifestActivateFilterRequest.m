...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("resourcemanifest.activateFilter"), a3, a4, a5);
}
...
- (GEOResourceManifestActivateFilterRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  ...
  GEOResourceManifestActivateFilterRequest *v12;
  uint64_t v14;
  size_t length;
  objc_super v16;
