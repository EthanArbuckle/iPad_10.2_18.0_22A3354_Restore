...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("subscriptions.cancelDownloadForSubscriptions"), a3, a4, a5);
}

- (GEOMapSubscriptionCancelDownloadRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6;
  GEOMapSubscriptionCancelDownloadRequest *v7;
  void *v8;
  size_t count;
  void *v10;
  size_t i;
  ...
  uint64_t v14;
  void *v15;
  GEOMapSubscriptionCancelDownloadRequest *v16;
  objc_super v18;
