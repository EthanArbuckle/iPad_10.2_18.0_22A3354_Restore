...
- (id)description
{
  ...
  -[GEOPDStopInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDStopInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 2) != 0)
  {
    ...
    if (a2)
      v8 = CFSTR("walkingTime");
    else
      v8 = CFSTR("walking_time");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = -[GEOTimezone copyWithZone:](self->_timezone, "copyWithZone:", a3);
  v9 = *(void **)(v6 + 24);
  *(_QWORD *)(v6 + 24) = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 36) & 1) == 0 || self->_muid != *((_QWORD *)v4 + 2))
      goto LABEL_14;
  }
...
LABEL_14:
  ...
  {
    if ((*((_BYTE *)v4 + 36) & 2) == 0 || self->_walkingTime != *((_DWORD *)v4 + 8))
      goto LABEL_14;
  }
  ...
  if ((unint64_t)timezone | *((_QWORD *)v4 + 3))
    v6 = -[GEOTimezone isEqual:](timezone, "isEqual:");
  else
    v6 = 1;
LABEL_15:
...
LABEL_5:
    v3 = 0;
    return v3 ^ v2 ^ -[GEOTimezone hash](self->_timezone, "hash");
  }
  v2 = 0;
  if ((*(_BYTE *)&self->_flags & 2) == 0)
    goto LABEL_5;
LABEL_3:
  v3 = 2654435761 * self->_walkingTime;
  return v3 ^ v2 ^ -[GEOTimezone hash](self->_timezone, "hash");
}
