...
- (id)description
{
  ...
  -[GEORevealedPlaceCardModuleTypeInfos description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORevealedPlaceCardModuleTypeInfos dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEORevealedPlaceCardModuleTypeInfos readAll:](self, "readAll:", 0);
  if (-[GEORevealedPlaceCardModuleTypeInfos buttonsCount](self, "buttonsCount"))
  {
    objc_msgSend(v8, "clearButtons");
    v4 = -[GEORevealedPlaceCardModuleTypeInfos buttonsCount](self, "buttonsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEORevealedPlaceCardModuleTypeInfos buttonsAtIndex:](self, "buttonsAtIndex:", i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEORevealedPlaceCardModuleTypeInfos readAll:](self, "readAll:", 1);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEORevealedPlaceCardModuleTypeInfos addButtons:](self, "addButtons:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
