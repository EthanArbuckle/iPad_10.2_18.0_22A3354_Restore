...
- (id)description
{
  ...
  -[GEOPDSTransportHint description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSTransportHint dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) != 0 && self->_transportType == *((_DWORD *)v4 + 4))
    {
      v5 = 1;
      goto LABEL_7;
    }
