...
- (id)description
{
  ...
  -[GEOServiceVersion description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOServiceVersion dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("minimumVersion");
    else
      v7 = CFSTR("minimum_version");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)versionDomains | *((_QWORD *)v4 + 2))
  {
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) != 0 && self->_minimumVersion == *((_DWORD *)v4 + 6))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_versionDomains, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_minimumVersion;
  else
    v4 = 0;
  return v4 ^ v3;
}
