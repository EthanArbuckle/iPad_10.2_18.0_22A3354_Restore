...
+ (id)searchResultPhotosFromPlaceData:(id)a3
{
  ...
  v11 = v5;
  v6 = v5;
  objc_msgSend(v4, "enumerateValidComponentValuesOfType:usingBlock:", 102, v10);
...
void __80__GEOPDSearchResultPlacePhoto_PlaceDataExtras__searchResultPhotosFromPlaceData___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    v9 = v3;
    -[GEOPDComponentValue searchResultPlacePhoto](v3);
    ...
    if (v5)
    {
      ...
      -[GEOPDSearchResultPlacePhoto photo](v7);
...
- (id)description
{
  ...
  -[GEOPDSearchResultPlacePhoto description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchResultPlacePhoto dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[GEOPDCaptionedPhoto copyWithZone:](self->_photo, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)photo | v4[2])
      v6 = -[GEOPDCaptionedPhoto isEqual:](photo, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[GEOPDCaptionedPhoto hash](self->_photo, "hash");
}
