...
- (id)description
{
  ...
  -[GEOPDPoiEventFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPoiEventFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 20) & 1) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v6 = CFSTR("includeEventCategoryId");
    else
      v6 = CFSTR("include_event_category_id");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v4 + 16) = self->_includeEventCategoryId;
    *(_BYTE *)(v4 + 20) |= 1u;
  }
