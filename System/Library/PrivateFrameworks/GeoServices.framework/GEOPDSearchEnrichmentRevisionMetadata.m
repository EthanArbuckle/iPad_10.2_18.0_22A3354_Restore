...
- (id)description
{
  ...
  -[GEOPDSearchEnrichmentRevisionMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchEnrichmentRevisionMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 20) & 1) != 0)
  {
    ...
    if (v5)
    {
      if (v5 == 1)
      {
        v6 = CFSTR("SEARCH_ENRICHMENT_REVISION_TYPE_V1");
      }
      else
      {
    ...
    {
      v6 = CFSTR("SEARCH_ENRICHMENT_REVISION_TYPE_DISABLED");
    }
    if (a2)
      v7 = CFSTR("revisionType");
    else
      v7 = CFSTR("revision_type");
...
- (uint64_t)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("revisionType");
      else
        v6 = CFSTR("revision_type");
      ...
      {
        v8 = v7;
        if ((objc_msgSend(v8, "isEqualToString:", CFSTR("SEARCH_ENRICHMENT_REVISION_TYPE_DISABLED")) & 1) != 0)
          v9 = 0;
        else
          v9 = objc_msgSend(v8, "isEqualToString:", CFSTR("SEARCH_ENRICHMENT_REVISION_TYPE_V1"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) != 0 && self->_revisionType == *((_DWORD *)v4 + 4))
    {
      v5 = 1;
      goto LABEL_7;
    }
