...
- (id)description
{
  ...
  -[GEOPDLocatedInsideInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDLocatedInsideInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 2) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("featureType");
    else
      v9 = CFSTR("feature_type");
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_muid != *((_QWORD *)v4 + 2))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_featureType != *((_DWORD *)v4 + 6))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
