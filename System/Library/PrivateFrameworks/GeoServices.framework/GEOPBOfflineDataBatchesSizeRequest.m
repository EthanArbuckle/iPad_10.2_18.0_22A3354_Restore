...
{
  GEOPBOfflineDataBatchesSizeRequest *v2;
  GEOPBOfflineDataBatchesSizeRequest *v3;
  GEOPBOfflineDataBatchesSizeRequest *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPBOfflineDataBatchesSizeRequest;
  v2 = -[GEOPBOfflineDataBatchesSizeRequest init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPBOfflineDataBatchesSizeRequest)initWithData:(id)a3
{
  GEOPBOfflineDataBatchesSizeRequest *v3;
  GEOPBOfflineDataBatchesSizeRequest *v4;
  GEOPBOfflineDataBatchesSizeRequest *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPBOfflineDataBatchesSizeRequest;
  v3 = -[GEOPBOfflineDataBatchesSizeRequest initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  -[GEOPBOfflineDataBatchesSizeRequest dealloc](&v3, sel_dealloc);
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 76) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPBOfflineDataBatchesSizeRequestReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readRegion_tags_168);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 76) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPBOfflineDataBatchesSizeRequestReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSupportedLanguages_tags_169);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 76) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPBOfflineDataBatchesSizeRequestReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLayers_tags_170);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPBOfflineDataBatchesSizeRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPBOfflineDataBatchesSizeRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_171;
    else
      v8 = (int *)&readAll__nonRecursiveTag_172;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOPBOfflineDataBatchesSizeRequest readAll:](self, "readAll:", 0);
    if (self->_region)
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v11 + 17) = self->_readerMarkLength;
  ...
  if (-[GEOPBOfflineDataBatchesSizeRequest supportedLanguagesCount](self, "supportedLanguagesCount"))
  {
    objc_msgSend(v11, "clearSupportedLanguages");
    v4 = -[GEOPBOfflineDataBatchesSizeRequest supportedLanguagesCount](self, "supportedLanguagesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOPBOfflineDataBatchesSizeRequest supportedLanguageAtIndex:](self, "supportedLanguageAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[GEOPBOfflineDataBatchesSizeRequest layersCount](self, "layersCount"))
  {
    objc_msgSend(v11, "clearLayers");
    v8 = -[GEOPBOfflineDataBatchesSizeRequest layersCount](self, "layersCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOPBOfflineDataBatchesSizeRequest readAll:](self, "readAll:", 1);
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[GEOPBOfflineDataBatchesSizeRequest addSupportedLanguage:](self, "addSupportedLanguage:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * i), (_QWORD)v15);
      }
  ...
  if (v12)
  {
    v13 = v12;
    for (j = 0; j != v13; ++j)
      -[GEOPBOfflineDataBatchesSizeRequest addLayers:](self, "addLayers:", objc_msgSend(v4, "layersAtIndex:", j, (_QWORD)v15));
  }
  if ((*((_BYTE *)v4 + 76) & 1) != 0)
  {
