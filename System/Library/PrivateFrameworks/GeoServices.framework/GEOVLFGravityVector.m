...
- (id)description
{
  ...
  -[GEOVLFGravityVector description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOVLFGravityVector dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOVLFGravityVector readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 1) == 0)
  {
    if ((*(_BYTE *)&self->_flags & 2) == 0)
...
LABEL_3:
  ...
  *((_BYTE *)result + 32) |= 2u;
  if ((*(_BYTE *)&self->_flags & 4) == 0)
    return result;
LABEL_4:
  *((_QWORD *)result + 3) = *(_QWORD *)&self->_z;
  *((_BYTE *)result + 32) |= 4u;
  return result;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_16;
  -[GEOVLFGravityVector readAll:](self, "readAll:", 1);
...
LABEL_16:
  ...
  if ((*(_BYTE *)&self->_flags & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 4) == 0 || self->_z != *((double *)v4 + 3))
      goto LABEL_16;
    v5 = 1;
  }
LABEL_17:
