...
- (id)description
{
  ...
  -[GEORPFeedbackFieldOptionAnnotations description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPFeedbackFieldOptionAnnotations dictionaryRepresentation](self, "dictionaryRepresentation");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setKeyString:", v8);
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEORPFeedbackFieldOptionAnnotations readAll:](self, "readAll:", 0);
  if (self->_keyString)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEORPFeedbackFieldOptionAnnotations readAll:](self, "readAll:", 1);
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
    -[GEORPFeedbackFieldOptionAnnotations setKeyString:](self, "setKeyString:", v5);
}
