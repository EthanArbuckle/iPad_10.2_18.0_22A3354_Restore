...
- (id)description
{
  ...
  -[GEOPDModuleConfiguration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDModuleConfiguration dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    if (a2)
      v7 = CFSTR("moduleConfigurationType");
    else
      v7 = CFSTR("module_configuration_type");
  ...
  if (v8)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v11 = CFSTR("moduleConfigurationValue");
    }
    else
    {
      objc_msgSend(v8, "dictionaryRepresentation");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = CFSTR("module_configuration_value");
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[GEOPDModuleConfigurationValue copyWithZone:](self->_moduleConfigurationValue, "copyWithZone:", a3);
  v8 = *(void **)(v6 + 16);
  *(_QWORD *)(v6 + 16) = v7;
...
{
  id v4;
  GEOPDModuleConfigurationValue *moduleConfigurationValue;
  char v6;
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_moduleConfigurationType != *((_DWORD *)v4 + 6))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  if ((unint64_t)moduleConfigurationValue | *((_QWORD *)v4 + 2))
    v6 = -[GEOPDModuleConfigurationValue isEqual:](moduleConfigurationValue, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v2 = 2654435761 * self->_moduleConfigurationType;
  else
    v2 = 0;
  return -[GEOPDModuleConfigurationValue hash](self->_moduleConfigurationValue, "hash") ^ v2;
}
