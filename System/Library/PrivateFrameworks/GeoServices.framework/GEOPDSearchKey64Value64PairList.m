...
- (id)description
{
  ...
  -[GEOPDSearchKey64Value64PairList description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchKey64Value64PairList dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)readFrom:(id)a3
{
  ...
  char v15;
  int v17;
  GEOPDSearchKey64Value64Pair *v19;
  BOOL v20;
...
LABEL_15:
        ...
        if ((v11 >> 3) == 1)
        {
          if ((PBReaderPlaceMark() & 1) == 0)
            goto LABEL_27;
          v19 = objc_alloc_init(GEOPDSearchKey64Value64Pair);
