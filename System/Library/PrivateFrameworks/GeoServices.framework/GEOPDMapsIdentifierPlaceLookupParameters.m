...
- (id)description
{
  ...
  -[GEOPDMapsIdentifierPlaceLookupParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDMapsIdentifierPlaceLookupParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 32) & 2) != 0)
  {
    ...
    if (a2)
      v17 = CFSTR("enablePartialClientization");
    else
      v17 = CFSTR("enable_partial_clientization");
  ...
  if (v4)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if ((objc_msgSend(*(id *)(*((_QWORD *)&v10 + 1) + 8 * v7), "hasGreenTeaWithValue:", a2, (_QWORD)v10) & 1) != 0)
        {
          v8 = 1;
          goto LABEL_12;
        }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    *(_BYTE *)(v6 + 28) = self->_enablePartialClientization;
    *(_BYTE *)(v6 + 32) |= 2u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_resultProviderId != *((_DWORD *)v4 + 6))
      goto LABEL_12;
  }
  ...
  if ((unint64_t)mapsIds | *((_QWORD *)v4 + 2))
  {
...
{
  id v6;
  GEOPDMapsIdentifierPlaceLookupParameters *v7;
  id v8;
  uint64_t v9;
  uint64_t v10;
  uint64_t v11;
  ...
  void *v13;
  void *v14;
  GEOPDMapsIdentifierPlaceLookupParameters *v15;
  __int128 v17;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  ...
  v7 = -[GEOPDMapsIdentifierPlaceLookupParameters init](&v21, sel_init);
  if (v7)
  {
    v19 = 0u;
    v20 = 0u;
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        do
        {
          if (*(_QWORD *)v18 != v11)
            objc_enumerationMutation(v8);
          objc_msgSend(*(id *)(*((_QWORD *)&v17 + 1) + 8 * v12), "mapsIdentifier", (_QWORD)v17);
    ...
    if (a4
      || (+[GEOMapService sharedService](GEOMapService, "sharedService"),
          v14 = (void *)objc_claimAutoreleasedReturnValue(),
          a4 = objc_msgSend(v14, "localSearchProviderID"),
          v14,
          a4))
    {
      *(_BYTE *)&v7->_flags |= 1u;
