...
+ (GEOPDLabelGeometry)labelGeometryWithPlaceData:(id)a3
{
  ...
  v6[3] = &unk_1E1C09768;
  v6[4] = &v7;
  objc_msgSend(v3, "enumerateComponentOfType:enumerationOptions:usingBlock:", 87, 1, v6);
  v4 = (id)v8[5];
...
void __66__GEOPDLabelGeometry_PlaceDataExtras__labelGeometryWithPlaceData___block_invoke(uint64_t a1, id *a2, _BYTE *a3)
{
  void *v5;
  uint64_t v6;
  uint64_t v7;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (v10 && *(_QWORD *)(v10 + 320))
        {
          -[GEOPDComponentValue labelGeometry]((id *)v10);
...
- (id)description
{
  ...
  -[GEOPDLabelGeometry description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDLabelGeometry dictionaryRepresentation](self, "dictionaryRepresentation");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("labelShape");
    else
      v13 = CFSTR("label_shape");
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    if (a2)
      v15 = CFSTR("hasSelectionPolygon");
    else
      v15 = CFSTR("has_selection_polygon");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v5 + 24) = self->_hasSelectionPolygon;
    *(_BYTE *)(v5 + 28) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)labelShapes | *((_QWORD *)v4 + 2))
  {
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_labelShapes, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_hasSelectionPolygon;
  else
    v4 = 0;
  return v4 ^ v3;
}
