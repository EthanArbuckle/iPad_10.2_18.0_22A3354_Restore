...
- (id)description
{
  ...
  -[GEOTransitAdvisory description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTransitAdvisory dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOTransitAdvisory readAll:](self, "readAll:", 0);
  if (self->_text)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOTransitAdvisory readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    text = self->_text;
    if ((unint64_t)text | v4[2])
      v5 = -[GEOFormattedString isEqual:](text, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOTransitAdvisory readAll:](self, "readAll:", 1);
  return -[GEOFormattedString hash](self->_text, "hash");
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    if (v6)
      -[GEOFormattedString mergeFrom:](text, "mergeFrom:", v6);
  }
  else if (v6)
  {
    -[GEOTransitAdvisory setText:](self, "setText:", v6);
  }
}
