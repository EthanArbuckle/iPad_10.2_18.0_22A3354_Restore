...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("locationshift.fetchCachedFunction"), a3, a4, a5);
}

- (GEOLocationShiftingCachedResponseFetchRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6;
  GEOLocationShiftingCachedResponseFetchRequest *v7;
  const void *data;
  void *v9;
  GEOLatLng *v10;
  GEOLatLng *latLng;
  GEOLocationShiftingCachedResponseFetchRequest *v12;
  uint64_t v14;
  size_t length;
  objc_super v16;
