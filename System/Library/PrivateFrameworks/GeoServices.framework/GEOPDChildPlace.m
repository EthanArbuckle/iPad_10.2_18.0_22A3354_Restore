...
- (GEOPDChildPlace)init
{
  ...
  v2 = -[GEOPDChildPlace init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDChildPlace)initWithData:(id)a3
{
  ...
  v3 = -[GEOPDChildPlace initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDChildPlaceReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readMapsId_tags_2);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDChildPlaceReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readName_tags_9);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDChildPlace description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDChildPlace dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_1253;
      else
        v6 = (int *)&readAll__nonRecursiveTag_1254;
      GEOPDChildPlaceReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
