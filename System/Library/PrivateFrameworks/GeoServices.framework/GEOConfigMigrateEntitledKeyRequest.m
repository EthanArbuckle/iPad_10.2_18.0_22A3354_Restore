...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("defaults.migrageEntitledKey"), a3, a4, a5);
}
...
- (GEOConfigMigrateEntitledKeyRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  ...
  uint64_t v9;
  NSString *keyString;
  GEOConfigMigrateEntitledKeyRequest *v11;
  objc_super v13;
...
- (BOOL)isValid
{
  ...
  -[GEOConfigMigrateEntitledKeyRequest keyString](self, "keyString");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v3, "length"))
    v4 = -[GEOConfigMigrateEntitledKeyRequest keyOptions](self, "keyOptions") != 0;
  else
    v4 = 0;
