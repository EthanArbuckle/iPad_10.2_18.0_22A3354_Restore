...
- (id)description
{
  ...
  -[GEOLaneChangeInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLaneChangeInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_19:
    ...
    if (a2)
      v18 = CFSTR("endOffsetCm");
    else
      v18 = CFSTR("end_offset_cm");
  ...
  if (a2)
    v16 = CFSTR("startOffsetCm");
  else
    v16 = CFSTR("start_offset_cm");
...
LABEL_5:
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("numValidLanes");
    else
      v7 = CFSTR("num_valid_lanes");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("startOffsetCm");
      else
        v6 = CFSTR("start_offset_cm");
      ...
      if (a3)
        v8 = CFSTR("endOffsetCm");
      else
        v8 = CFSTR("end_offset_cm");
      ...
      if (a3)
        v10 = CFSTR("numValidLanes");
      else
        v10 = CFSTR("num_valid_lanes");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOLaneChangeInfo readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 4) == 0)
  {
    if ((*(_BYTE *)&self->_flags & 1) == 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_16;
  -[GEOLaneChangeInfo readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 4) == 0 || self->_startOffsetCm != *((_DWORD *)v4 + 6))
      goto LABEL_16;
  }
...
LABEL_16:
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_endOffsetCm != *((_DWORD *)v4 + 4))
      goto LABEL_16;
  }
  ...
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_numValidLanes != *((_DWORD *)v4 + 5))
      goto LABEL_16;
    v5 = 1;
  }
LABEL_17:
...
LABEL_7:
  ...
  v3 = 2654435761 * self->_startOffsetCm;
  if ((*(_BYTE *)&self->_flags & 1) == 0)
    goto LABEL_6;
LABEL_3:
  v4 = 2654435761 * self->_endOffsetCm;
  if ((*(_BYTE *)&self->_flags & 2) == 0)
    goto LABEL_7;
LABEL_4:
  v5 = 2654435761 * self->_numValidLanes;
  return v4 ^ v3 ^ v5;
}
