...
- (id)description
{
  ...
  -[GEOTileSetInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTileSetInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_122:
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "setObject:forKey:", v6, CFSTR("zoom"));
...
LABEL_126:
    ...
    objc_msgSend(v2, "setObject:forKey:", v7, CFSTR("uncertainty"));
...
LABEL_238:
  ...
  objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("uncertainty"));
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOTileSetInfo readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
    v5[3] = self->_style;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_21;
  -[GEOTileSetInfo readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_style != *((_DWORD *)v4 + 3))
      goto LABEL_21;
  }
...
LABEL_21:
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 8) == 0 || self->_zoom != *((_DWORD *)v4 + 5))
      goto LABEL_21;
  }
  ...
  if ((*(_BYTE *)&self->_flags & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 4) == 0 || self->_uncertainty != *((_DWORD *)v4 + 4))
      goto LABEL_21;
    v5 = 1;
  }
LABEL_22:
...
LABEL_9:
  ...
  if ((*(_BYTE *)&self->_flags & 8) == 0)
    goto LABEL_8;
LABEL_4:
  v5 = 2654435761 * self->_zoom;
  if ((*(_BYTE *)&self->_flags & 4) == 0)
    goto LABEL_9;
LABEL_5:
  v6 = 2654435761 * self->_uncertainty;
  return v4 ^ v3 ^ v5 ^ v6;
}
