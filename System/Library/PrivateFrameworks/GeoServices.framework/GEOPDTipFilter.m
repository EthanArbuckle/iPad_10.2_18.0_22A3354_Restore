...
- (void)dealloc
{
  ...
  -[GEOPDTipFilter dealloc](&v3, sel_dealloc);
}
...
LABEL_12:
    if (12 * v9 < v9)
      return 0;
    result = (uint64_t)malloc_type_realloc(*(void **)(a1 + 16), 12 * v9, 0xD0C0B584uLL);
    if (result)
    {
      *(_QWORD *)(a1 + 32) = v9;
      *(_QWORD *)(a1 + 16) = result;
...
- (id)description
{
  ...
  -[GEOPDTipFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDTipFilter dictionaryRepresentation](self, "dictionaryRepresentation");
