@implementation AddValue

uint64_t __AddValue_block_invoke(_QWORD *a1, uint64_t a2)
{
  void *v4;
  uint64_t v5;
  uint64_t v6;
...
uint64_t __AddValue_block_invoke_0(uint64_t a1, uint64_t a2)
{
  ...
  if (*(_QWORD *)(a1 + 64))
  {
    ...
    v46 = *(id *)(v34 + 40);
    v35 = objc_msgSend(v32, "writeExternalResourceWithData:toURL:error:", v33, v31, &v46);
