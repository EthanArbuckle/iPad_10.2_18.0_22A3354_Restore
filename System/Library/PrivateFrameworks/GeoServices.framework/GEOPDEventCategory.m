...
- (id)description
{
  ...
  -[GEOPDEventCategory description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDEventCategory dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    if (a2)
      v7 = CFSTR("eventLookupCategory");
    else
      v7 = CFSTR("event_lookup_category");
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v16 = CFSTR("localizedCategory");
    else
      v16 = CFSTR("localized_category");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_eventLookupCategory != *((_DWORD *)v4 + 6))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  if ((unint64_t)localizedCategorys | *((_QWORD *)v4 + 2))
    v6 = -[NSMutableArray isEqual:](localizedCategorys, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v2 = 2654435761 * self->_eventLookupCategory;
  else
    v2 = 0;
  return -[NSMutableArray hash](self->_localizedCategorys, "hash") ^ v2;
}
