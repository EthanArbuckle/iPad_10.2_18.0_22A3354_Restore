...
- (int)StringAsType:(id)a3
{
  ...
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("AND")) & 1) != 0)
  {
    v4 = 1;
  }
  ...
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("NOT")) & 1) != 0)
  {
    v4 = 3;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("EXPIRATION_TIME")) & 1) != 0)
  {
    v4 = 4;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("TOKEN_SUBSTITUTION_FAILURE_FALLBACK")))
  {
    v4 = 5;
  }
  else
...
- (void)addCondition:(id)a3
{
  ...
  -[NSMutableArray addObject:](conditions, "addObject:", v4);
...
- (NSString)description
{
  ...
  -[GEOCondition description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOCondition dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("expirationTime");
    else
      v9 = CFSTR("expiration_time");
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("condition"));
  }
  v18 = *(void **)(a1 + 8);
  if (v18)
  {
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    else if ((objc_msgSend(v7, "isEqualToString:", CFSTR("AND")) & 1) != 0)
    {
      v8 = 1;
    }
    ...
    else if ((objc_msgSend(v7, "isEqualToString:", CFSTR("NOT")) & 1) != 0)
    {
      v8 = 3;
    }
    else if ((objc_msgSend(v7, "isEqualToString:", CFSTR("EXPIRATION_TIME")) & 1) != 0)
    {
      v8 = 4;
    }
    else if (objc_msgSend(v7, "isEqualToString:", CFSTR("TOKEN_SUBSTITUTION_FAILURE_FALLBACK")))
    {
      v8 = 5;
    }
    else
      ...
      do
      {
        for (i = 0; i != v14; ++i)
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            ...
            if ((a3 & 1) != 0)
              v19 = -[GEOCondition initWithJSON:](v18, "initWithJSON:", v17);
            else
              v19 = -[GEOCondition initWithDictionary:](v18, "initWithDictionary:", v17);
            v20 = (void *)v19;
            objc_msgSend(a1, "addCondition:", v19);
...
- (void)copyTo:(id)a3
{
  ...
  v9 = a3;
  -[GEOCondition readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
    v9[7] = self->_type;
  ...
  if (-[GEOCondition conditionsCount](self, "conditionsCount"))
  {
    objc_msgSend(v9, "clearConditions");
    v5 = -[GEOCondition conditionsCount](self, "conditionsCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[GEOCondition conditionAtIndex:](self, "conditionAtIndex:", i);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "addCondition:", v8);
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        objc_msgSend(v6, "addCondition:", v13);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_14;
  -[GEOCondition readAll:](self, "readAll:", 1);
...
LABEL_14:
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_expirationTime != *((_DWORD *)v4 + 6))
      goto LABEL_14;
  }
  ...
  conditions = self->_conditions;
  if ((unint64_t)conditions | *((_QWORD *)v4 + 2))
    v6 = -[NSMutableArray isEqual:](conditions, "isEqual:");
  else
    v6 = 1;
LABEL_15:
...
LABEL_5:
    v4 = 0;
    return v4 ^ v3 ^ -[NSMutableArray hash](self->_conditions, "hash");
  }
  v3 = 0;
  if ((*(_BYTE *)&self->_flags & 1) == 0)
    goto LABEL_5;
LABEL_3:
  v4 = 2654435761 * self->_expirationTime;
  return v4 ^ v3 ^ -[NSMutableArray hash](self->_conditions, "hash");
}
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        -[GEOCondition addCondition:](self, "addCondition:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * i), (_QWORD)v11);
      }
...
- (int64_t)conditionType
{
  ...
  v2 = -[GEOCondition type](self, "type") - 1;
  if (v2 < 5)
    return v2 + 1;
  else
    return 0;
...
- (NSDate)expirationDate
{
  ...
  if (-[GEOCondition hasExpirationTime](self, "hasExpirationTime"))
  {
    objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeIntervalSinceReferenceDate:", (double)-[GEOCondition expirationTime](self, "expirationTime"));
