...
{
  GEOChargerPlugsInfo *v2;
  GEOChargerPlugsInfo *v3;
  GEOChargerPlugsInfo *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOChargerPlugsInfo;
  v2 = -[GEOChargerPlugsInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOChargerPlugsInfo)initWithData:(id)a3
{
  GEOChargerPlugsInfo *v3;
  GEOChargerPlugsInfo *v4;
  GEOChargerPlugsInfo *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOChargerPlugsInfo;
  v3 = -[GEOChargerPlugsInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOChargerPlugsInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSuggestedChargerPlugs_tags);
        objc_sync_exit(v3);
...
- (void)clearSuggestedChargerPlugs
{
  ...
  *(_BYTE *)&self->_flags |= 8u;
  -[NSMutableArray removeAllObjects](self->_suggestedChargerPlugs, "removeAllObjects");
}
...
{
  -[GEOChargerPlugsInfo _readSuggestedChargerPlugs]((uint64_t)self);
  return -[NSMutableArray count](self->_suggestedChargerPlugs, "count");
}

- (id)suggestedChargerPlugAtIndex:(unint64_t)a3
{
  -[GEOChargerPlugsInfo _readSuggestedChargerPlugs]((uint64_t)self);
  return (id)-[NSMutableArray objectAtIndex:](self->_suggestedChargerPlugs, "objectAtIndex:", a3);
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOChargerPlugsInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSupportedChargerPlugs_tags);
        objc_sync_exit(v3);
...
- (void)clearSupportedChargerPlugs
{
  ...
  *(_BYTE *)&self->_flags |= 4u;
  os_unfair_lock_unlock(p_readerLock);
  *(_BYTE *)&self->_flags |= 8u;
  -[NSMutableArray removeAllObjects](self->_supportedChargerPlugs, "removeAllObjects");
}
...
{
  -[GEOChargerPlugsInfo _readSupportedChargerPlugs]((uint64_t)self);
  return -[NSMutableArray count](self->_supportedChargerPlugs, "count");
}

- (id)supportedChargerPlugAtIndex:(unint64_t)a3
{
  -[GEOChargerPlugsInfo _readSupportedChargerPlugs]((uint64_t)self);
  return (id)-[NSMutableArray objectAtIndex:](self->_supportedChargerPlugs, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOChargerPlugsInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOChargerPlugsInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 24), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("suggestedChargerPlug");
    else
      v13 = CFSTR("suggested_charger_plug");
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    if (a2)
      v22 = CFSTR("supportedChargerPlug");
    else
      v22 = CFSTR("supported_charger_plug");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("suggestedChargerPlug");
      else
        v6 = CFSTR("suggested_charger_plug");
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v15 = -[GEOChargerPlug initWithJSON:](v14, "initWithJSON:", v13);
                else
                  v15 = -[GEOChargerPlug initWithDictionary:](v14, "initWithDictionary:", v13);
                v16 = (void *)v15;
                objc_msgSend(a1, "addSuggestedChargerPlug:", v15);
      ...
      if (a3)
        v17 = CFSTR("supportedChargerPlug");
      else
        v17 = CFSTR("supported_charger_plug");
          ...
          do
          {
            for (j = 0; j != v21; ++j)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v26 = -[GEOChargerPlug initWithJSON:](v25, "initWithJSON:", v24);
                else
                  v26 = -[GEOChargerPlug initWithDictionary:](v25, "initWithDictionary:", v24);
                v27 = (void *)v26;
                objc_msgSend(a1, "addSupportedChargerPlug:", v26);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_794;
    else
      v8 = (int *)&readAll__nonRecursiveTag_795;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOChargerPlugsInfo readAll:](self, "readAll:", 0);
    v22 = 0u;
    v23 = 0u;
    v20 = 0u;
    v21 = 0u;
    v6 = self->_suggestedChargerPlugs;
    ...
    v16 = 0u;
    v17 = 0u;
    v10 = self->_supportedChargerPlugs;
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v12 + 11) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  if (-[GEOChargerPlugsInfo suggestedChargerPlugsCount](self, "suggestedChargerPlugsCount"))
  {
    objc_msgSend(v12, "clearSuggestedChargerPlugs");
    v4 = -[GEOChargerPlugsInfo suggestedChargerPlugsCount](self, "suggestedChargerPlugsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOChargerPlugsInfo suggestedChargerPlugAtIndex:](self, "suggestedChargerPlugAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "addSuggestedChargerPlug:", v7);

      }
    }
  }
  if (-[GEOChargerPlugsInfo supportedChargerPlugsCount](self, "supportedChargerPlugsCount"))
  {
    objc_msgSend(v12, "clearSupportedChargerPlugs");
    v8 = -[GEOChargerPlugsInfo supportedChargerPlugsCount](self, "supportedChargerPlugsCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[GEOChargerPlugsInfo supportedChargerPlugAtIndex:](self, "supportedChargerPlugAtIndex:", j);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "addSupportedChargerPlug:", v11);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v23 = 0u;
  v24 = 0u;
  v8 = self->_suggestedChargerPlugs;
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        objc_msgSend(v5, "addSuggestedChargerPlug:", v12);
  ...
  v19 = 0u;
  v20 = 0u;
  v13 = self->_supportedChargerPlugs;
  ...
  if (v14)
  {
    ...
    do
    {
      for (j = 0; j != v14; ++j)
      {
        ...
        objc_msgSend(v5, "addSupportedChargerPlug:", v17);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOChargerPlugsInfo readAll:](self, "readAll:", 1),
     ...
     || -[NSMutableArray isEqual:](suggestedChargerPlugs, "isEqual:")))
  {
    ...
    if ((unint64_t)supportedChargerPlugs | v4[4])
      v7 = -[NSMutableArray isEqual:](supportedChargerPlugs, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOChargerPlugsInfo readAll:](self, "readAll:", 1);
  v3 = -[NSMutableArray hash](self->_suggestedChargerPlugs, "hash");
  return -[NSMutableArray hash](self->_supportedChargerPlugs, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOChargerPlugsInfo addSuggestedChargerPlug:](self, "addSuggestedChargerPlug:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v9++));
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v16 != v13)
          objc_enumerationMutation(v10);
        -[GEOChargerPlugsInfo addSupportedChargerPlug:](self, "addSupportedChargerPlug:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * v14++), (_QWORD)v15);
      }
      while (v12 != v14);
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOChargerPlugsInfoReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_798);
      objc_sync_exit(v5);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(_BYTE *)&self->_flags |= 9u;
  ...
  if (v3)
  {
    ...
    v21 = 0u;
    v22 = 0u;
    v7 = self->_suggestedChargerPlugs;
    ...
    v17 = 0u;
    v18 = 0u;
    v12 = self->_supportedChargerPlugs;
