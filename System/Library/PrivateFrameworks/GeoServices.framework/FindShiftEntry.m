@implementation FindShiftEntry

uint64_t __FindShiftEntry_block_invoke(uint64_t a1, sqlite3_stmt *a2)
{
  void *v4;
  double v5;
  uint64_t v6;
  ...
  v24 = *(id *)(v14 + 40);
  v15 = objc_msgSend(v12, "bindRealParameter:toValue:inStatement:error:", "@less", a2, &v24, v13);
