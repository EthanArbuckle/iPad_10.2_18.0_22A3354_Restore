      ...
      if (v6)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            -[GEOPDVariableExponentPair clearUnknownFields:](*(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), 1);
          }
          while (v7 != v9);
...
- (id)description
{
  ...
  -[GEOPDClientRankingFeatureTypeComposite description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDClientRankingFeatureTypeComposite dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v14 = CFSTR("variableExponentPair");
    else
      v14 = CFSTR("variable_exponent_pair");
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    if (a2)
      v16 = CFSTR("featureWeight");
    else
      v16 = CFSTR("feature_weight");
...
- (void)writeTo:(id)a3
{
  ...
  v12 = 0u;
  v13 = 0u;
  v5 = self->_variableExponentPairs;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v15 = 0u;
  v16 = 0u;
  v6 = self->_variableExponentPairs;
...
{
  id v4;
  NSMutableArray *variableExponentPairs;
  BOOL v6;
  ...
  if ((unint64_t)variableExponentPairs | *((_QWORD *)v4 + 2))
  {
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) != 0 && self->_featureWeight == *((float *)v4 + 6))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_variableExponentPairs, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
