...
- (id)description
{
  ...
  -[GEOPDSearchCapabilitiesParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchCapabilitiesParameters dictionaryRepresentation](self, "dictionaryRepresentation");
