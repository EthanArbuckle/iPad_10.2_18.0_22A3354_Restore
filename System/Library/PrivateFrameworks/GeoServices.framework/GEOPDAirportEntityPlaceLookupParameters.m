...
{
  GEOPDAirportEntityPlaceLookupParameters *v2;
  GEOPDAirportEntityPlaceLookupParameters *v3;
  GEOPDAirportEntityPlaceLookupParameters *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDAirportEntityPlaceLookupParameters;
  v2 = -[GEOPDAirportEntityPlaceLookupParameters init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDAirportEntityPlaceLookupParameters)initWithData:(id)a3
{
  GEOPDAirportEntityPlaceLookupParameters *v3;
  GEOPDAirportEntityPlaceLookupParameters *v4;
  GEOPDAirportEntityPlaceLookupParameters *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDAirportEntityPlaceLookupParameters;
  v3 = -[GEOPDAirportEntityPlaceLookupParameters initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  -[GEOPDAirportEntityPlaceLookupParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAirportEntityPlaceLookupParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 60) & 2) == 0)
  {
    ...
    if (v5)
    {
      v6 = v5;
      objc_sync_enter(v6);
      GEOPDAirportEntityPlaceLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAirportCode_tags);
      objc_sync_exit(v6);
  ...
  {
    if (a2)
      v8 = CFSTR("airportCode");
    else
      v8 = CFSTR("airport_code");
  ...
  if ((*(_BYTE *)(a1 + 60) & 8) == 0)
  {
    ...
    if (v9)
    {
      v10 = v9;
      objc_sync_enter(v10);
      GEOPDAirportEntityPlaceLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTerminalCode_tags);
      objc_sync_exit(v10);
  ...
  {
    if (a2)
      v12 = CFSTR("terminalCode");
    else
      v12 = CFSTR("terminal_code");
  ...
  if ((*(_BYTE *)(a1 + 60) & 4) == 0)
  {
    ...
    if (v13)
    {
      v14 = v13;
      objc_sync_enter(v14);
      GEOPDAirportEntityPlaceLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readGateCode_tags);
      objc_sync_exit(v14);
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_118;
      else
        v6 = (int *)&readAll__nonRecursiveTag_119;
      GEOPDAirportEntityPlaceLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOPDAirportEntityPlaceLookupParameters readAll:]((uint64_t)self, 0);
    v8 = -[NSString copyWithZone:](self->_airportCode, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;

    v10 = -[NSString copyWithZone:](self->_terminalCode, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 40);
    *(_QWORD *)(v5 + 40) = v10;

    v12 = -[NSString copyWithZone:](self->_gateCode, "copyWithZone:", a3);
    v13 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v12;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](terminalCode, "isEqual:")))
  {
    ...
    if ((unint64_t)gateCode | v4[4])
      v8 = -[NSString isEqual:](gateCode, "isEqual:");
    else
      v8 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDAirportEntityPlaceLookupParameters readAll:]((uint64_t)self, 1);
  v3 = -[NSString hash](self->_airportCode, "hash");
  v4 = -[NSString hash](self->_terminalCode, "hash") ^ v3;
  return v4 ^ -[NSString hash](self->_gateCode, "hash");
}
