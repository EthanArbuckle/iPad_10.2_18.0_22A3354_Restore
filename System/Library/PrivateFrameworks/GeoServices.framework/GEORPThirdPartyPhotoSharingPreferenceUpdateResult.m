...
{
  GEORPThirdPartyPhotoSharingPreferenceUpdateResult *v2;
  GEORPThirdPartyPhotoSharingPreferenceUpdateResult *v3;
  GEORPThirdPartyPhotoSharingPreferenceUpdateResult *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPThirdPartyPhotoSharingPreferenceUpdateResult;
  v2 = -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPThirdPartyPhotoSharingPreferenceUpdateResult)initWithData:(id)a3
{
  GEORPThirdPartyPhotoSharingPreferenceUpdateResult *v3;
  GEORPThirdPartyPhotoSharingPreferenceUpdateResult *v4;
  GEORPThirdPartyPhotoSharingPreferenceUpdateResult *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPThirdPartyPhotoSharingPreferenceUpdateResult;
  v3 = -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult dealloc](&v3, sel_dealloc);
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 1) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPThirdPartyPhotoSharingPreferenceUpdateResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readErrors_tags_168);
        objc_sync_exit(v3);
...
- (id)errorsAsString:(int)a3
{
  ...
  if (!a3)
    return CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_UNSPECIFIED");
  if (a3 == 1)
  {
    v3 = CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_OUTDATED");
  }
  else
  {
...
- (int)StringAsErrors:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_UNSPECIFIED")) & 1) != 0)
    v4 = 0;
  else
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_OUTDATED"));
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPThirdPartyPhotoSharingPreferenceUpdateResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readPreference_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (a1)
  {
      ...
      if (a1[3])
      {
        ...
        do
        {
          ...
          if ((_DWORD)v8)
          {
            if ((_DWORD)v8 == 1)
            {
              v9 = CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_OUTDATED");
            }
            else
            {
          ...
          {
            v9 = CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_UNSPECIFIED");
          }
    ...
    if (v10)
    {
      ...
      objc_msgSend(v4, "setObject:forKey:", v12, CFSTR("preference"));
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  ...
  uint64_t v14;
  void *v15;
  GEORPThirdPartyPhotoSharingPreference *v16;
  uint64_t v17;
  void *v18;
  char v20;
  __int128 v21;
  ...
  do
  {
    for (i = 0; i != v9; ++i)
    {
      ...
      {
        v13 = v12;
        if ((objc_msgSend(v13, "isEqualToString:", CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_UNSPECIFIED")) & 1) != 0)v14 = 0;
        else
          v14 = objc_msgSend(v13, "isEqualToString:", CFSTR("THIRD_PARTY_PHOTO_SHARING_PREFERENCE_UPDATE_ERROR_OUTDATED"));
...
LABEL_20:
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if ((a3 & 1) != 0)
      v17 = -[GEORPThirdPartyPhotoSharingPreference initWithJSON:](v16, "initWithJSON:", v15);
    else
      v17 = -[GEORPThirdPartyPhotoSharingPreference initWithDictionary:](v16, "initWithDictionary:", v15);
    v18 = (void *)v17;
    objc_msgSend(a1, "setPreference:", v17);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_169_0;
    else
      v8 = (int *)&readAll__nonRecursiveTag_170_0;
    GEORPThirdPartyPhotoSharingPreferenceUpdateResultReadSpecified((uint64_t)self, (unint64_t)self->_reader, v8);
    objc_sync_exit(v7);

  }
  if (v3)
    -[GEORPThirdPartyPhotoSharingPreference readAll:](self->_preference, "readAll:", 1);
  os_unfair_lock_unlock(p_readerLock);
}
...
- (void)writeTo:(id)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult readAll:](self, "readAll:", 0);
  v5 = v9;
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v7 + 13) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  if (-[GEORPThirdPartyPhotoSharingPreferenceUpdateResult errorsCount](self, "errorsCount"))
  {
    objc_msgSend(v7, "clearErrors");
    v4 = -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult errorsCount](self, "errorsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
LABEL_5:
    ...
    -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult readAll:](self, "readAll:", 0);
    PBRepeatedInt32Copy();
    v8 = -[GEORPThirdPartyPhotoSharingPreference copyWithZone:](self->_preference, "copyWithZone:", a3);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && (-[GEORPThirdPartyPhotoSharingPreferenceUpdateResult readAll:](self, "readAll:", 1),
        objc_msgSend(v4, "readAll:", 1),
        PBRepeatedInt32IsEqual()))
  {
    preference = self->_preference;
    if ((unint64_t)preference | v4[5])
      v6 = -[GEORPThirdPartyPhotoSharingPreference isEqual:](preference, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[GEORPThirdPartyPhotoSharingPreference hash](self->_preference, "hash") ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4)
  {
    v5 = v4;
    for (i = 0; i != v5; ++i)
      -[GEORPThirdPartyPhotoSharingPreferenceUpdateResult addErrors:](self, "addErrors:", objc_msgSend(v10, "errorsAtIndex:", i));
  }
  preference = self->_preference;
  v8 = v10;
  v9 = v10[5];
