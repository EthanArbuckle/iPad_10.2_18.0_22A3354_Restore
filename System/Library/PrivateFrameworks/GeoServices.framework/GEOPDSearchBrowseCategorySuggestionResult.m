    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[GEOPDBrowseCategory clearUnknownFields:](*(_QWORD *)(*((_QWORD *)&v8 + 1) + 8 * v7++), 1);
        }
        while (v5 != v7);
...
- (id)description
{
  ...
  -[GEOPDSearchBrowseCategorySuggestionResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchBrowseCategorySuggestionResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)categorys | v4[2])
      v6 = -[NSMutableArray isEqual:](categorys, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_categorys, "hash");
}
