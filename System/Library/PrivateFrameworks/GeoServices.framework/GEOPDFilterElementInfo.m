...
{
  GEOPDFilterElementInfo *v2;
  GEOPDFilterElementInfo *v3;
  GEOPDFilterElementInfo *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDFilterElementInfo;
  v2 = -[GEOPDFilterElementInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDFilterElementInfo)initWithData:(id)a3
{
  GEOPDFilterElementInfo *v3;
  GEOPDFilterElementInfo *v4;
  GEOPDFilterElementInfo *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDFilterElementInfo;
  v3 = -[GEOPDFilterElementInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDFilterElementInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readFilterIds_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDFilterElementInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLabel_tags_0);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDFilterElementInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDFilterElementInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  -[GEOPDFilterElementInfo label]((id *)a1);
  ...
  if (v14)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v16, CFSTR("label"));
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_100;
      else
        v6 = (int *)&readAll__nonRecursiveTag_101;
      GEOPDFilterElementInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v13 = -[GEOPDVenueLabel copyWithZone:](self->_label, "copyWithZone:", a3);
  v14 = *(void **)(v5 + 32);
  *(_QWORD *)(v5 + 32) = v13;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](filterIds, "isEqual:")))
  {
    ...
    if ((unint64_t)label | v4[4])
      v7 = -[GEOPDVenueLabel isEqual:](label, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDFilterElementInfo readAll:]((uint64_t)self, 1);
  v3 = -[NSMutableArray hash](self->_filterIds, "hash");
  return -[GEOPDVenueLabel hash](self->_label, "hash") ^ v3;
}
