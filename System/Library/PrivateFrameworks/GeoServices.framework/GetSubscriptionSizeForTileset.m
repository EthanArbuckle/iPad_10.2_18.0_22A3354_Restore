@implementation GetSubscriptionSizeForTileset
...
uint64_t __GetSubscriptionSizeForTileset_block_invoke(uint64_t a1, sqlite3_stmt *a2)
{
  ...
  v23 = *(id *)(v10 + 40);
  v11 = objc_msgSend(v8, "bindIntParameter:toValue:inStatement:error:", "@tileset", v9, a2, &v23);
  ...
  v22 = *(id *)(v14 + 40);
  v15 = objc_msgSend(v12, "bindIntParameter:toValue:inStatement:error:", "@is_current", v13, a2, &v22);
