...
- (id)description
{
  ...
  -[GEOTimeToLeaveHypothesisLogMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTimeToLeaveHypothesisLogMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  -[GEOTimeToLeaveHypothesisLogMessage readAll:](self, "readAll:", 0);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    -[GEOTimeToLeaveHypothesisLogMessage readAll:](self, "readAll:", 1);
