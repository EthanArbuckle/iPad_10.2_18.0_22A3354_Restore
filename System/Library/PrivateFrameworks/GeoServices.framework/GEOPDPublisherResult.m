...
{
  GEOPDPublisherResult *v2;
  GEOPDPublisherResult *v3;
  GEOPDPublisherResult *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDPublisherResult;
  v2 = -[GEOPDPublisherResult init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDPublisherResult)initWithData:(id)a3
{
  GEOPDPublisherResult *v3;
  GEOPDPublisherResult *v4;
  GEOPDPublisherResult *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDPublisherResult;
  v3 = -[GEOPDPublisherResult initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 56) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPublisherResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readPublisherId_tags_5968);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 56) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPublisherResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readComponents_tags_5969);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDPublisherResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPublisherResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPublisherResult publisherId]((id *)a1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_5970;
      else
        v6 = (int *)&readAll__nonRecursiveTag_5971;
      GEOPDPublisherResultReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)publisherId | *((_QWORD *)v4 + 4))
  {
...
LABEL_11:
  ...
  if ((unint64_t)components | *((_QWORD *)v4 + 3))
