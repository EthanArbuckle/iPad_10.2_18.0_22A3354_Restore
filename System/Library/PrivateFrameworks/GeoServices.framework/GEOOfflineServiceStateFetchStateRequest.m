...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("offlinestate.fetchState"), a3, a4, a5);
}

- (GEOOfflineServiceStateFetchStateRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  GEOOfflineServiceStateFetchStateRequest *v4;
  GEOOfflineServiceStateFetchStateRequest *v5;
  GEOOfflineServiceStateFetchStateRequest *v6;
  objc_super v8;
