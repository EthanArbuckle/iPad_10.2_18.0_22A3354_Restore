...
- (id)description
{
  ...
  -[GEOPairedDeviceConfigureSubscriptionShouldSyncRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPairedDeviceConfigureSubscriptionShouldSyncRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("shouldSyncToPairedDevice");
    else
      v7 = CFSTR("should_sync_to_paired_device");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if (a3)
        v8 = CFSTR("shouldSyncToPairedDevice");
      else
        v8 = CFSTR("should_sync_to_paired_device");
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOPairedDeviceConfigureSubscriptionShouldSyncRequest readAll:](self, "readAll:", 0);
  if (self->_identifier)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v6;
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v5 + 24) = self->_shouldSyncToPairedDevice;
    *(_BYTE *)(v5 + 28) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_6;
  -[GEOPairedDeviceConfigureSubscriptionShouldSyncRequest readAll:](self, "readAll:", 1);
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_shouldSyncToPairedDevice;
  else
    v4 = 0;
  return v4 ^ v3;
}
