...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_libraryVersions, "hash");
...
- (id)description
{
  ...
  -[GEOPDAddressObjectFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAddressObjectFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("enableLocation");
    else
      v7 = CFSTR("enable_location");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v5 + 24) = self->_enableLocation;
    *(_BYTE *)(v5 + 28) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)libraryVersions | *((_QWORD *)v4 + 2))
  {
