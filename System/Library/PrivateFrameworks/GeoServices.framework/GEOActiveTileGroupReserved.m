...
- (id)description
{
  ...
  -[GEOActiveTileGroupReserved description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOActiveTileGroupReserved dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("authToken"));
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("authToken"));
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v5 = (void *)objc_msgSend(v4, "copy");
        objc_msgSend(a1, "setAuthToken:", v5);
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOActiveTileGroupReserved readAll:](self, "readAll:", 0);
  if (self->_authToken)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOActiveTileGroupReserved readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    authToken = self->_authToken;
    if ((unint64_t)authToken | v4[2])
      v5 = -[NSString isEqual:](authToken, "isEqual:");
  }
  else
  {
    v5 = 0;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
    -[GEOActiveTileGroupReserved setAuthToken:](self, "setAuthToken:", v5);
}
