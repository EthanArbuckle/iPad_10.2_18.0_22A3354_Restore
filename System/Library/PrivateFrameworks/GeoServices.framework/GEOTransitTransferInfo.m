...
- (id)description
{
  ...
  -[GEOTransitTransferInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTransitTransferInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("transferMuid");
    else
      v7 = CFSTR("transfer_muid");
  ...
  if ((v5 & 2) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("transferTime");
    else
      v9 = CFSTR("transfer_time");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("transferMuid");
      else
        v6 = CFSTR("transfer_muid");
      ...
      if (a3)
        v8 = CFSTR("transferTime");
      else
        v8 = CFSTR("transfer_time");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOTransitTransferInfo readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 1) != 0)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((flags & 1) != 0)
  {
    *(_QWORD *)(v4 + 16) = self->_transferMuid;
    *(_BYTE *)(v4 + 28) |= 1u;
    flags = (char)self->_flags;
  }
  if ((flags & 2) != 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOTransitTransferInfo readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_transferMuid != *((_QWORD *)v4 + 2))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_transferTime != *((_DWORD *)v4 + 6))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    v3 = 2654435761u * self->_transferMuid;
    if ((*(_BYTE *)&self->_flags & 2) != 0)
      goto LABEL_3;
LABEL_5:
    v4 = 0;
  ...
  if ((*(_BYTE *)&self->_flags & 2) == 0)
    goto LABEL_5;
LABEL_3:
  v4 = 2654435761 * self->_transferTime;
  return v4 ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v4 & 1) != 0)
  {
    self->_transferMuid = *((_QWORD *)v5 + 2);
    *(_BYTE *)&self->_flags |= 1u;
    v4 = *((_BYTE *)v5 + 28);
  }
  if ((v4 & 2) != 0)
