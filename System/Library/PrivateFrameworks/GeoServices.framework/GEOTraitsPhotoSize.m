...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOTraitsPhotoSize readAll:](self, "readAll:", 1);
...
- (id)description
{
  ...
  -[GEOTraitsPhotoSize description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTraitsPhotoSize dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOTraitsPhotoSize readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
    v5[5] = self->_width;
