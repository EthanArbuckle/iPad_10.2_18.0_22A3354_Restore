...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  if (-[NSDictionary count](self->_expiringKeys, "count"))
  {
    ...
    v7 = v5;
    v9 = v7;
    -[NSDictionary enumerateKeysAndObjectsUsingBlock:](expiringKeys, "enumerateKeysAndObjectsUsingBlock:", v8);
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_expiringKeys, 0);
}

- (GEOConfigGetExpiringKeysReply)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6;
  GEOConfigGetExpiringKeysReply *v7;
  void *v8;
  size_t count;
  void *v10;
  id v11;
  ...
  uint64_t v13;
  void *v14;
  GEOConfigGetExpiringKeysReply *v15;
  _QWORD applier[5];
  id v18;
  uint64_t *v19;
  uint64_t v20;
  ...
  if (v7)
  {
    xpc_dictionary_get_dictionary(v6, "expiringKeys");
...
{
  objc_storeStrong((id *)&self->_expiringKeys, a3);
}
