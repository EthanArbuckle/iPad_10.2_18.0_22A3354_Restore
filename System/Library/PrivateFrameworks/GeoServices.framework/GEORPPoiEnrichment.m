...
{
  GEORPPoiEnrichment *v2;
  GEORPPoiEnrichment *v3;
  GEORPPoiEnrichment *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPPoiEnrichment;
  v2 = -[GEORPPoiEnrichment init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPPoiEnrichment)initWithData:(id)a3
{
  GEORPPoiEnrichment *v3;
  GEORPPoiEnrichment *v4;
  GEORPPoiEnrichment *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPPoiEnrichment;
  v3 = -[GEORPPoiEnrichment initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPPoiEnrichmentReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readScorecard_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPPoiEnrichmentReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readImages_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPPoiEnrichment description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPPoiEnrichment dictionaryRepresentation](self, "dictionaryRepresentation");
        ...
        if (v12)
        {
          ...
          do
          {
            for (i = 0; i != v13; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                v17 = [GEORPEnrichmentImage alloc];
                if ((a3 & 1) != 0)
                  v18 = -[GEORPEnrichmentImage initWithJSON:](v17, "initWithJSON:", v16);
                else
                  v18 = -[GEORPEnrichmentImage initWithDictionary:](v17, "initWithDictionary:", v16);
                v19 = (void *)v18;
                objc_msgSend(a1, "addImage:", v18);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_157;
    else
      v8 = (int *)&readAll__nonRecursiveTag_158;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPPoiEnrichment readAll:](self, "readAll:", 0);
    if (self->_scorecard)
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v8 + 9) = self->_readerMarkLength;
  ...
  if (-[GEORPPoiEnrichment imagesCount](self, "imagesCount"))
  {
    objc_msgSend(v8, "clearImages");
    v4 = -[GEORPPoiEnrichment imagesCount](self, "imagesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEORPPoiEnrichment imageAtIndex:](self, "imageAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEORPPoiEnrichment readAll:](self, "readAll:", 0);
  v8 = -[GEORPScorecard copyWithZone:](self->_scorecard, "copyWithZone:", a3);
  v9 = (void *)v5[3];
  v5[3] = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPPoiEnrichment readAll:](self, "readAll:", 1),
     ...
     || -[GEORPScorecard isEqual:](scorecard, "isEqual:")))
  {
    ...
    if ((unint64_t)images | v4[2])
      v7 = -[NSMutableArray isEqual:](images, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_images, "hash") ^ v3;
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[GEORPPoiEnrichment addImage:](self, "addImage:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
