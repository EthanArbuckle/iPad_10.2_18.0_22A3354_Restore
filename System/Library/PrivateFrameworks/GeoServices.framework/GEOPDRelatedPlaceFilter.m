...
- (id)description
{
  ...
  -[GEOPDRelatedPlaceFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDRelatedPlaceFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("relatedPlaceTemplateItemCount");
    else
      v7 = CFSTR("related_place_template_item_count");
  ...
  if ((v5 & 2) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("canSupportTemplateModule");
    else
      v9 = CFSTR("can_support_template_module");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((flags & 2) != 0)
  {
    *(_BYTE *)(v4 + 20) = self->_canSupportTemplateModule;
    *(_BYTE *)(v4 + 24) |= 2u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_relatedPlaceTemplateItemCount != *((_DWORD *)v4 + 4))
      goto LABEL_9;
  }
