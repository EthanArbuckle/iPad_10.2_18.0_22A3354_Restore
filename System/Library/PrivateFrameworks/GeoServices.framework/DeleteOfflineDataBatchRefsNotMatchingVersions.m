@implementation DeleteOfflineDataBatchRefsNotMatchingVersions

uint64_t __DeleteOfflineDataBatchRefsNotMatchingVersions_block_invoke(uint64_t a1, uint64_t a2)
{
  uint64_t v4;
  void *v5;
  uint64_t v6;
