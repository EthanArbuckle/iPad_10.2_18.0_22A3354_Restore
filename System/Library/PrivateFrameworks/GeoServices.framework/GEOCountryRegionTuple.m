...
{
  GEOCountryRegionTuple *v2;
  GEOCountryRegionTuple *v3;
  GEOCountryRegionTuple *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOCountryRegionTuple;
  v2 = -[GEOCountryRegionTuple init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCountryRegionTupleReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readRegion_tags_0);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCountryRegionTupleReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCountryCode_tags_5);
        objc_sync_exit(v3);
...
- (GEOCountryRegionTuple)initWithData:(id)a3
{
  GEOCountryRegionTuple *v3;
  GEOCountryRegionTuple *v4;
  GEOCountryRegionTuple *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOCountryRegionTuple;
  v3 = -[GEOCountryRegionTuple initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  -[GEOCountryRegionTuple description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOCountryRegionTuple dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("region"));
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setCountryCode:", v5);

      }
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("region"));
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v7 = (void *)objc_msgSend(v6, "copy");
        objc_msgSend(a1, "setRegion:", v7);
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOCountryRegionTuple readAll:](self, "readAll:", 0);
...
LABEL_5:
    ...
    *(_QWORD *)(v5 + 24) = v8;
    ...
    v10 = -[NSString copyWithZone:](self->_region, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOCountryRegionTuple readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](countryCode, "isEqual:")))
  {
    ...
    if ((unint64_t)region | v4[4])
      v7 = -[NSString isEqual:](region, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_region, "hash") ^ v3;
}
