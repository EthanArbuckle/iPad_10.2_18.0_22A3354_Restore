...
- (id)description
{
  ...
  -[GEOTripInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTripInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 20) & 1) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v6 = CFSTR("hasVisitedFirstStop");
    else
      v6 = CFSTR("has_visited_first_stop");
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOTripInfo readAll:](self, "readAll:", 0);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v4 + 16) = self->_hasVisitedFirstStop;
    *(_BYTE *)(v4 + 20) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_4;
  -[GEOTripInfo readAll:](self, "readAll:", 1);
