...
{
  GEORPCategoryCorrections *v2;
  GEORPCategoryCorrections *v3;
  GEORPCategoryCorrections *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPCategoryCorrections;
  v2 = -[GEORPCategoryCorrections init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPCategoryCorrections)initWithData:(id)a3
{
  GEORPCategoryCorrections *v3;
  GEORPCategoryCorrections *v4;
  GEORPCategoryCorrections *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPCategoryCorrections;
  v3 = -[GEORPCategoryCorrections initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPCategoryCorrectionsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAddeds_tags_309);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPCategoryCorrectionsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readRemoveds_tags_310);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPCategoryCorrections description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPCategoryCorrections dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_311;
    else
      v8 = (int *)&readAll__nonRecursiveTag_312;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPCategoryCorrections readAll:](self, "readAll:", 0);
    v22 = 0u;
    v23 = 0u;
    v20 = 0u;
    v21 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v12 + 11) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  if (-[GEORPCategoryCorrections addedsCount](self, "addedsCount"))
  {
    objc_msgSend(v12, "clearAddeds");
    v4 = -[GEORPCategoryCorrections addedsCount](self, "addedsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEORPCategoryCorrections addedAtIndex:](self, "addedAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "addAdded:", v7);

      }
    }
  }
  if (-[GEORPCategoryCorrections removedsCount](self, "removedsCount"))
  {
    objc_msgSend(v12, "clearRemoveds");
    v8 = -[GEORPCategoryCorrections removedsCount](self, "removedsCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[GEORPCategoryCorrections removedAtIndex:](self, "removedAtIndex:", j);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "addRemoved:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPCategoryCorrections readAll:](self, "readAll:", 1),
     ...
     || -[NSMutableArray isEqual:](addeds, "isEqual:")))
  {
    ...
    if ((unint64_t)removeds | v4[4])
      v7 = -[NSMutableArray isEqual:](removeds, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_removeds, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v20 != v8)
          objc_enumerationMutation(v5);
        -[GEORPCategoryCorrections addAdded:](self, "addAdded:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v9++));
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v16 != v13)
          objc_enumerationMutation(v10);
        -[GEORPCategoryCorrections addRemoved:](self, "addRemoved:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * v14++), (_QWORD)v15);
      }
      while (v12 != v14);
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPCategoryCorrectionsReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_315);
      objc_sync_exit(v5);
