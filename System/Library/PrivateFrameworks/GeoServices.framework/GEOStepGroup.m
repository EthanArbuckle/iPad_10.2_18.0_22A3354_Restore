...
- (GEOStepGroup)init
{
  ...
  v2 = -[GEOStepGroup init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOStepGroup)initWithData:(id)a3
{
  ...
  v3 = -[GEOStepGroup initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  -[GEOStepGroup dealloc](&v3, sel_dealloc);
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 68) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOStepGroupReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readGroupInstruction_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 68) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOStepGroupReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readStepIds_tags);
        objc_sync_exit(v3);
...
{
  $1729E44CE8A3ADE0AA70C2F19EF2BB02 *p_stepIds;
  unint64_t count;
  void *v7;
  uint64_t v8;
  void *v9;
...
- (id)description
{
  ...
  -[GEOStepGroup description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOStepGroup dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "groupInstruction");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v8 = CFSTR("groupInstruction");
    }
    else
    {
      objc_msgSend(v5, "dictionaryRepresentation");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = CFSTR("group_instruction");
    }
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("groupInstruction");
      else
        v6 = CFSTR("group_instruction");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        v10 = (void *)v9;
        objc_msgSend(a1, "setGroupInstruction:", v9);
        ...
        if (v14)
        {
          ...
          do
          {
            for (i = 0; i != v15; ++i)
            {
              ...
              objc_opt_class();
              if ((objc_opt_isKindOfClass() & 1) != 0)
                objc_msgSend(a1, "addStepId:", objc_msgSend(v18, "unsignedIntValue", (_QWORD)v20));
            }
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_6184;
    else
      v8 = (int *)&readAll__nonRecursiveTag_6185;
    GEOStepGroupReadSpecified((uint64_t)self, (unint64_t)self->_reader, v8);
    objc_sync_exit(v7);

  }
  if (v3)
    -[GEOFormattedString readAll:](self->_groupInstruction, "readAll:", 1);
  os_unfair_lock_unlock(p_readerLock);
}
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOStepGroup readAll:](self, "readAll:", 0);
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v7 + 15) = self->_readerMarkLength;
  ...
  if (-[GEOStepGroup stepIdsCount](self, "stepIdsCount"))
  {
    objc_msgSend(v7, "clearStepIds");
    v4 = -[GEOStepGroup stepIdsCount](self, "stepIdsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOStepGroup readAll:](self, "readAll:", 0);
    v8 = -[GEOFormattedString copyWithZone:](self->_groupInstruction, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 48);
    *(_QWORD *)(v5 + 48) = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOStepGroup readAll:](self, "readAll:", 1),
...
- (unint64_t)hash
{
  ...
  -[GEOStepGroup readAll:](self, "readAll:", 1);
  v3 = -[GEOFormattedString hash](self->_groupInstruction, "hash");
...
- (void)mergeFrom:(id)a3
{
  ...
  v4 = v10;
LABEL_7:
  v7 = objc_msgSend(v4, "stepIdsCount");
  if (v7)
  {
    v8 = v7;
    for (i = 0; i != v8; ++i)
      -[GEOStepGroup addStepId:](self, "addStepId:", objc_msgSend(v10, "stepIdAtIndex:", i));
  }
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOStepGroupReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_6188);
      objc_sync_exit(v5);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(_BYTE *)&self->_flags |= 9u;
  ...
  {
    -[GEOStepGroup readAll:](self, "readAll:", 0);
    -[GEOFormattedString clearUnknownFields:](self->_groupInstruction, "clearUnknownFields:", 1);
  }
}
