...
void __GEOGetGEORouteBuilder_PlaceDataCuratedHikeLog_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.GeoServices", "GEORouteBuilder_PlaceDataCuratedHike");
...
void __GEOGetGEORouteBuilder_PersistentDataLog_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.GeoServices", "GEORouteBuilder_PersistentData");
  v1 = (void *)_MergedGlobals_303;
  _MergedGlobals_303 = (uint64_t)v0;
...
void __GEOGetGEORouteBuilder_GeometryRouteLog_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.GeoServices", "GEORouteBuilder_GeometryRoute");
