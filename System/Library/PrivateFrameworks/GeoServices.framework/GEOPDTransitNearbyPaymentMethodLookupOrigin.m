...
- (id)description
{
  ...
  -[GEOPDTransitNearbyPaymentMethodLookupOrigin description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDTransitNearbyPaymentMethodLookupOrigin dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (v5)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v8 = CFSTR("waypointTyped");
    }
    else
    {
      objc_msgSend(v5, "dictionaryRepresentation");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = CFSTR("waypoint_typed");
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[GEOWaypointTyped copyWithZone:](self->_waypointTyped, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)waypointTyped | v4[2])
      v6 = -[GEOWaypointTyped isEqual:](waypointTyped, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[GEOWaypointTyped hash](self->_waypointTyped, "hash");
}
