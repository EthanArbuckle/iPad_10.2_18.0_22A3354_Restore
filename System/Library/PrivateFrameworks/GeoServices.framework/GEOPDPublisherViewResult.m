...
LABEL_12:
    ...
    while (1)
    {
      if (*(_QWORD *)v16 != v11)
        objc_enumerationMutation(v4);
      if (-[GEOPDPublisherViewResultFilter hasGreenTeaWithValue:](*(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * v12), a2))
        break;
      if (v10 == ++v12)
      {
...
{
  GEOPDPublisherViewResult *v2;
  GEOPDPublisherViewResult *v3;
  GEOPDPublisherViewResult *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDPublisherViewResult;
  v2 = -[GEOPDPublisherViewResult init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDPublisherViewResult)initWithData:(id)a3
{
  GEOPDPublisherViewResult *v3;
  GEOPDPublisherViewResult *v4;
  GEOPDPublisherViewResult *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDPublisherViewResult;
  v3 = -[GEOPDPublisherViewResult initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPublisherViewResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readResultFilters_tags_4793);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPublisherViewResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCollectionIds_tags_4794);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDPublisherViewResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPublisherViewResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("resultFilter");
    else
      v13 = CFSTR("result_filter");
  ...
  if (objc_msgSend(*(id *)(a1 + 24), "count"))
  {
    ...
    if (a2)
      v22 = CFSTR("collectionId");
    else
      v22 = CFSTR("collection_id");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_4795;
      else
        v6 = (int *)&readAll__nonRecursiveTag_4796;
      GEOPDPublisherViewResultReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](resultFilters, "isEqual:")))
  {
    ...
    if ((unint64_t)collectionIds | v4[3])
      v7 = -[NSMutableArray isEqual:](collectionIds, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDPublisherViewResult readAll:]((uint64_t)self, 1);
  v3 = -[NSMutableArray hash](self->_resultFilters, "hash");
  return -[NSMutableArray hash](self->_collectionIds, "hash") ^ v3;
}
