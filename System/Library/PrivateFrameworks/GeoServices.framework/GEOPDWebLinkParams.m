...
{
  GEOPDWebLinkParams *v2;
  GEOPDWebLinkParams *v3;
  GEOPDWebLinkParams *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDWebLinkParams;
  v2 = -[GEOPDWebLinkParams init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDWebLinkParams)initWithData:(id)a3
{
  GEOPDWebLinkParams *v3;
  GEOPDWebLinkParams *v4;
  GEOPDWebLinkParams *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDWebLinkParams;
  v3 = -[GEOPDWebLinkParams initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 64) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDWebLinkParamsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTitle_tags_7341);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 64) & 0x10) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDWebLinkParamsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readUrl_tags_7342);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 64) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDWebLinkParamsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readIcon_tags_7343);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDWebLinkParams description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDWebLinkParams dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 64) & 1) != 0)
  {
    ...
    if (a2)
      v11 = CFSTR("supportsEmbeddedWebBrowser");
    else
      v11 = CFSTR("supports_embedded_web_browser");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_7348;
      else
        v6 = (int *)&readAll__nonRecursiveTag_7349;
      GEOPDWebLinkParamsReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 40) = v11;
  ...
  v13 = -[GEOPDIcon copyWithZone:](self->_icon, "copyWithZone:", a3);
  v14 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v13;

  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v5 + 60) = self->_supportsEmbeddedWebBrowser;
    *(_BYTE *)(v5 + 64) |= 1u;
  }
...
- (unint64_t)hash
{
  ...
  v5 = -[GEOPDIcon hash](self->_icon, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v6 = 2654435761 * self->_supportsEmbeddedWebBrowser;
  else
    v6 = 0;
  return v4 ^ v3 ^ v5 ^ v6;
}
