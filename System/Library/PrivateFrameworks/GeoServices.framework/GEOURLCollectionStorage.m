...
{
  GEOURLCollectionStorage *v2;
  GEOURLCollectionStorage *v3;
  GEOURLCollectionStorage *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOURLCollectionStorage;
  v2 = -[GEOURLCollectionStorage init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOURLCollectionStorage)initWithData:(id)a3
{
  GEOURLCollectionStorage *v3;
  GEOURLCollectionStorage *v4;
  GEOURLCollectionStorage *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOURLCollectionStorage;
  v3 = -[GEOURLCollectionStorage initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOURLCollectionStorageReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readName_tags_3351);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOURLCollectionStorageReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readPlaces_tags_1);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOURLCollectionStorage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOURLCollectionStorage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("place"));
  }
  v14 = *(void **)(a1 + 16);
  if (v14)
  {
          ...
          do
          {
            for (i = 0; i != v11; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v16 = -[GEOCollectionPlace initWithJSON:](v15, "initWithJSON:", v14);
                else
                  v16 = -[GEOCollectionPlace initWithDictionary:](v15, "initWithDictionary:", v14);
                v17 = (void *)v16;
                objc_msgSend(a1, "addPlace:", v16);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_3353;
    else
      v8 = (int *)&readAll__nonRecursiveTag_3354;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOURLCollectionStorage readAll:](self, "readAll:", 0);
    if (self->_name)
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v8 + 11) = self->_readerMarkLength;
  ...
  if (-[GEOURLCollectionStorage placesCount](self, "placesCount"))
  {
    objc_msgSend(v8, "clearPlaces");
    v4 = -[GEOURLCollectionStorage placesCount](self, "placesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOURLCollectionStorage placeAtIndex:](self, "placeAtIndex:", i);
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        objc_msgSend((id)v5, "addPlace:", v14);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOURLCollectionStorage readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](name, "isEqual:")))
  {
    ...
    if ((unint64_t)places | v4[4])
      v7 = -[NSMutableArray isEqual:](places, "isEqual:");
    else
      v7 = 1;
  }
  else
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOURLCollectionStorage addPlace:](self, "addPlace:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOURLCollectionStorageReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_3357);
      objc_sync_exit(v5);
