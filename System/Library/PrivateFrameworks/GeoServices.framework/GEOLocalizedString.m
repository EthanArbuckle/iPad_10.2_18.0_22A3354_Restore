...
{
  GEOLocalizedString *v2;
  GEOLocalizedString *v3;
  GEOLocalizedString *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOLocalizedString;
  v2 = -[GEOLocalizedString init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLocalizedStringReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readStringValue_tags_1);
        objc_sync_exit(v3);
...
+ (id)bestLocalizedStringForCurrentLocale:(id)a3 fallbackToFirstAvailable:(BOOL)a4
{
  ...
  objc_msgSend(a1, "bestLocalizedString:forPreferredLanguages:fallbackToFirstAvailable:", v7, v8, v4);
...
+ (id)bestLocalizedString:(id)a3 forPreferredLanguages:(id)a4 fallbackToFirstAvailable:(BOOL)a5
{
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (objc_msgSend(v15, "hasLocale", (_QWORD)v24))
        {
  ...
  objc_msgSend(v17, "mostPreferredLanguageOf:withPreferredLanguages:forUsage:options:", v18, v8, 1, 0);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLocalizedStringReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLocale_tags_570);
        objc_sync_exit(v3);
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (v5)
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("locale"));
  ...
  {
    if (a2)
      v7 = CFSTR("stringValue");
    else
      v7 = CFSTR("string_value");
...
+ (id)bestString:(id)a3 forPreferredLanguages:(id)a4 fallbackToFirstAvailable:(BOOL)a5
{
  ...
  objc_msgSend(a1, "bestLocalizedString:forPreferredLanguages:fallbackToFirstAvailable:", a3, a4, a5);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)bestStringForCurrentLocale:(id)a3 fallbackToFirstAvailable:(BOOL)a4
{
  ...
  objc_msgSend(a1, "bestLocalizedStringForCurrentLocale:fallbackToFirstAvailable:", a3, a4);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (GEOLocalizedString)initWithData:(id)a3
{
  GEOLocalizedString *v3;
  GEOLocalizedString *v4;
  GEOLocalizedString *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOLocalizedString;
  v3 = -[GEOLocalizedString initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  -[GEOLocalizedString description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLocalizedString dictionaryRepresentation](self, "dictionaryRepresentation");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setLocale:", v7);

      }
      if (a3)
        v8 = CFSTR("stringValue");
      else
        v8 = CFSTR("string_value");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setStringValue:", v10);
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOLocalizedString readAll:](self, "readAll:", 0);
    if (self->_locale)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOLocalizedString readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](locale, "isEqual:")))
  {
    ...
    if ((unint64_t)stringValue | v4[4])
      v7 = -[NSString isEqual:](stringValue, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOLocalizedStringReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_579);
      objc_sync_exit(v5);
