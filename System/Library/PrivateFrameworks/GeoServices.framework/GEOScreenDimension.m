...
- (id)description
{
  ...
  -[GEOScreenDimension description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOScreenDimension dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOScreenDimension readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
    v5[3] = *(_QWORD *)&self->_width;
    *((_BYTE *)v5 + 32) |= 2u;
    flags = (char)self->_flags;
  }
  if ((flags & 1) != 0)
  {
    v5[2] = *(_QWORD *)&self->_height;
    *((_BYTE *)v5 + 32) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOScreenDimension readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 2) == 0 || self->_width != *((double *)v4 + 3))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_height != *((double *)v4 + 2))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
