...
{
  GEOPDSearchPhoneNumberIntent *v2;
  GEOPDSearchPhoneNumberIntent *v3;
  GEOPDSearchPhoneNumberIntent *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDSearchPhoneNumberIntent;
  v2 = -[GEOPDSearchPhoneNumberIntent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDSearchPhoneNumberIntent)initWithData:(id)a3
{
  GEOPDSearchPhoneNumberIntent *v3;
  GEOPDSearchPhoneNumberIntent *v4;
  GEOPDSearchPhoneNumberIntent *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDSearchPhoneNumberIntent;
  v3 = -[GEOPDSearchPhoneNumberIntent initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  -[GEOPDSearchPhoneNumberIntent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchPhoneNumberIntent dictionaryRepresentation](self, "dictionaryRepresentation");
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v5)
      {
        v6 = v5;
        objc_sync_enter(v6);
        GEOPDSearchPhoneNumberIntentReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readPhoneNumber_tags);
        objc_sync_exit(v6);
    ...
    if ((*(_BYTE *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v9)
      {
        v10 = v9;
        objc_sync_enter(v10);
        GEOPDSearchPhoneNumberIntentReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTokenSet_tags_828);
        objc_sync_exit(v10);
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_833;
      else
        v6 = (int *)&readAll__nonRecursiveTag_834;
      GEOPDSearchPhoneNumberIntentReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (unint64_t)hash
{
  ...
  -[GEOPDSearchPhoneNumberIntent readAll:]((uint64_t)self, 1);
  v3 = -[NSString hash](self->_phoneNumber, "hash");
