...
- (id)description
{
  ...
  -[GEOPDQuickLinkFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDQuickLinkFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 20) & 1) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v6 = CFSTR("quickLinkItemsCount");
    else
      v6 = CFSTR("quick_link_items_count");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) != 0 && self->_quickLinkItemsCount == *((_DWORD *)v4 + 4))
    {
      v5 = 1;
      goto LABEL_7;
    }
