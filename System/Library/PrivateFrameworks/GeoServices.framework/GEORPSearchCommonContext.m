...
{
  GEORPSearchCommonContext *v2;
  GEORPSearchCommonContext *v3;
  GEORPSearchCommonContext *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPSearchCommonContext;
  v2 = -[GEORPSearchCommonContext init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPSearchCommonContext)initWithData:(id)a3
{
  GEORPSearchCommonContext *v3;
  GEORPSearchCommonContext *v4;
  GEORPSearchCommonContext *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPSearchCommonContext;
  v3 = -[GEORPSearchCommonContext initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPSearchCommonContextReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLastSearchString_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPSearchCommonContextReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLastUserTypedSearchString_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPSearchCommonContext description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPSearchCommonContext dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "lastSearchString");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    if (a2)
      v6 = CFSTR("lastSearchString");
    else
      v6 = CFSTR("last_search_string");
    objc_msgSend(v4, "setObject:forKey:", v5, v6);
  }

  objc_msgSend(a1, "lastUserTypedSearchString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    if (a2)
      v8 = CFSTR("lastUserTypedSearchString");
    else
      v8 = CFSTR("last_user_typed_search_string");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setLastSearchString:", v8);

      }
      if (a3)
        v9 = CFSTR("lastUserTypedSearchString");
      else
        v9 = CFSTR("last_user_typed_search_string");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setLastUserTypedSearchString:", v11);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_2848;
    else
      v8 = (int *)&readAll__nonRecursiveTag_2849;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEORPSearchCommonContext readAll:](self, "readAll:", 0);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPSearchCommonContext readAll:](self, "readAll:", 0);
    v8 = -[NSString copyWithZone:](self->_lastSearchString, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;

    v10 = -[NSString copyWithZone:](self->_lastUserTypedSearchString, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPSearchCommonContext readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](lastSearchString, "isEqual:")))
  {
    ...
    if ((unint64_t)lastUserTypedSearchString | v4[4])
      v7 = -[NSString isEqual:](lastUserTypedSearchString, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEORPSearchCommonContext readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_lastSearchString, "hash");
  return -[NSString hash](self->_lastUserTypedSearchString, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPSearchCommonContextReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_2852);
      objc_sync_exit(v5);
