...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_7143;
      else
        v6 = (int *)&readAll__nonRecursiveTag_7144;
      GEOPDTransitScheduleFilterReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
{
  GEOPDTransitScheduleFilter *v2;
  GEOPDTransitScheduleFilter *v3;
  GEOPDTransitScheduleFilter *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDTransitScheduleFilter;
  v2 = -[GEOPDTransitScheduleFilter init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDTransitScheduleFilter)initWithData:(id)a3
{
  GEOPDTransitScheduleFilter *v3;
  GEOPDTransitScheduleFilter *v4;
  GEOPDTransitScheduleFilter *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDTransitScheduleFilter;
  v3 = -[GEOPDTransitScheduleFilter initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  -[GEOPDTransitScheduleFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDTransitScheduleFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 68) & 8) == 0)
  {
    ...
    if (v5)
    {
      v6 = v5;
      objc_sync_enter(v6);
      GEOPDTransitScheduleFilterReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readDeparturePredicateCountdown_tags_7137);
      objc_sync_exit(v6);
  ...
  if ((*(_BYTE *)(a1 + 68) & 0x10) == 0)
  {
    ...
    if (v11)
    {
      v12 = v11;
      objc_sync_enter(v12);
      GEOPDTransitScheduleFilterReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readDeparturePredicateStamp_tags_7138);
      objc_sync_exit(v12);
