...
{
  GEONavTrayGuidance *v2;
  GEONavTrayGuidance *v3;
  GEONavTrayGuidance *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEONavTrayGuidance;
  v2 = -[GEONavTrayGuidance init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEONavTrayGuidance)initWithData:(id)a3
{
  GEONavTrayGuidance *v3;
  GEONavTrayGuidance *v4;
  GEONavTrayGuidance *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEONavTrayGuidance;
  v3 = -[GEONavTrayGuidance initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEONavTrayGuidanceReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTitle_tags_3241);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEONavTrayGuidanceReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readDetail_tags_3242);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEONavTrayGuidance description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEONavTrayGuidance dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_3243;
    else
      v8 = (int *)&readAll__nonRecursiveTag_3244;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEONavTrayGuidance readAll:](self, "readAll:", 0);
    if (self->_title)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEONavTrayGuidance readAll:](self, "readAll:", 1),
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEONavTrayGuidanceReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_3247);
      objc_sync_exit(v5);
