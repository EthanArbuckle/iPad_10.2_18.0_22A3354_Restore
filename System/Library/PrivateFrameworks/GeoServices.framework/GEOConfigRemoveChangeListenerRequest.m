...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("defaults.removeChangeListenerFor"), a3, a4, a5);
}

- (GEOConfigRemoveChangeListenerRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6;
  GEOConfigRemoveChangeListenerRequest *v7;
  void *v8;
  size_t count;
  void *v10;
  size_t i;
  ...
  uint64_t v14;
  void *v15;
  GEOConfigRemoveChangeListenerRequest *v16;
  objc_super v18;
...
- (BOOL)isValid
{
  ...
  -[GEOConfigRemoveChangeListenerRequest keys](self, "keys");
