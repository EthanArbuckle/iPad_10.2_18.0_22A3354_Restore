...
- (id)description
{
  ...
  -[GEOJunctionView description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOJunctionView dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEOJunctionView readAll:](self, "readAll:", 0);
  if (-[GEOJunctionView imageIdsCount](self, "imageIdsCount"))
  {
    objc_msgSend(v8, "clearImageIds");
    v4 = -[GEOJunctionView imageIdsCount](self, "imageIdsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOJunctionView imageIdAtIndex:](self, "imageIdAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addImageId:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOJunctionView readAll:](self, "readAll:", 1);
...
{
  -[GEOJunctionView readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_imageIds, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOJunctionView addImageId:](self, "addImageId:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
