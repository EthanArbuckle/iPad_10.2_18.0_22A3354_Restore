...
{
  id v6;
  GEOTransitRouteUpdateReplySimple *v7;
  const void *data;
  void *v9;
  GEOTransitRouteUpdateResponse *v10;
  GEOTransitRouteUpdateResponse *response;
  GEOTransitRouteUpdateReplySimple *v12;
  uint64_t v14;
  size_t length;
  objc_super v16;
  ...
  if (v7)
  {
    ...
    if (data)
    {
      ...
      v10 = -[GEOTransitRouteUpdateResponse initWithData:]([GEOTransitRouteUpdateResponse alloc], "initWithData:", v9);
    }
    else
    {
      xpc_dictionary_get_value(v6, "transitUpdateResponseData");
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  if (response)
  {
    -[GEOTransitRouteUpdateResponse data](response, "data");
    v6 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    xpc_dictionary_set_data(v4, "transitUpdateResponseData", (const void *)objc_msgSend(v6, "bytes"), objc_msgSend(v6, "length"));
...
- (BOOL)isValid
{
  ...
  -[GEOTransitRouteUpdateReplySimple response](self, "response");
