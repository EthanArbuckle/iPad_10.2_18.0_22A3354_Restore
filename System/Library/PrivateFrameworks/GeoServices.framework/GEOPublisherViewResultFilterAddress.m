...
- (GEOPublisherViewResultFilterAddress)initWithFilterAddressIdentifier:(id)a3 withPlaces:(id)a4
{
  id v7;
  id v8;
  GEOPublisherViewResultFilterAddress *v9;
  GEOPublisherViewResultFilterAddress *v10;
  _QWORD v12[4];
  id v13;
  uint64_t *v14;
  uint64_t v15;
  ...
  v9 = -[GEOPublisherViewResultFilterAddress init](&v21, sel_init);
  if (v9)
  {
    v15 = 0;
    v16 = &v15;
...
void __82__GEOPublisherViewResultFilterAddress_initWithFilterAddressIdentifier_withPlaces___block_invoke(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  -[GEOPDPublisherViewResultFilterAddress geoId](*(id **)(a1 + 32));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = -[GEOMapItemIdentifier initWithMapsIdentifier:](v7, "initWithMapsIdentifier:", v8);

  if (-[GEOMapItemIdentifier isEqual:](v6, "isEqual:", v9))
  {
...
- (GEOMapItemIdentifier)filterAddressIdentifier
{
  ...
  -[GEOPDPublisherViewResultFilterAddress geoId]((id *)&self->_filterAddressIdentifier->super.super.isa);
