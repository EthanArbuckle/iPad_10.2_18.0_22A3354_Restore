...
- (id)description
{
  ...
  -[GEOTargetLayout description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTargetLayout dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_4:
  ...
  {
    v10 = off_1E1C23868[v9];
  }
  if (a2)
    v11 = CFSTR("layoutInfo");
  else
    v11 = CFSTR("layout_info");
...
LABEL_532:
    ...
    {
      v13 = off_1E1C23888[v12];
    }
    if (a2)
      v14 = CFSTR("layoutStyle");
    else
      v14 = CFSTR("layout_style");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      objc_msgSend(a1, "setUiTarget:", v9);
LABEL_1020:

      if (a3)
        v10 = CFSTR("layoutInfo");
      else
        v10 = CFSTR("layout_info");
      ...
      {
        v12 = v11;
        if ((objc_msgSend(v12, "isEqualToString:", CFSTR("UNKNOWN_LAYOUT")) & 1) != 0)
        {
          v13 = 0;
        }
        else if ((objc_msgSend(v12, "isEqualToString:", CFSTR("MINI_LAYOUT")) & 1) != 0)
        {
          v13 = 1;
        }
        else if ((objc_msgSend(v12, "isEqualToString:", CFSTR("PARTIAL_LAYOUT")) & 1) != 0)
        {
          v13 = 2;
        }
        else if (objc_msgSend(v12, "isEqualToString:", CFSTR("FULL_LAYOUT")))
        {
          v13 = 3;
        }
        else
      ...
      objc_msgSend(a1, "setLayoutInfo:", v13);
LABEL_1037:
      ...
      {
        v16 = v15;
        if ((objc_msgSend(v16, "isEqualToString:", CFSTR("UNKNOWN_STYLE")) & 1) != 0)
        {
          v17 = 0;
        }
        else if ((objc_msgSend(v16, "isEqualToString:", CFSTR("STANDARD_STYLE")) & 1) != 0)
        {
          v17 = 1;
        }
        else if ((objc_msgSend(v16, "isEqualToString:", CFSTR("COMPACT_STYLE")) & 1) != 0)
        {
          v17 = 2;
        }
        else if ((objc_msgSend(v16, "isEqualToString:", CFSTR("SIDE_BAR_STYLE")) & 1) != 0)
        {
          v17 = 3;
        }
        else if ((objc_msgSend(v16, "isEqualToString:", CFSTR("FLOATING_STYLE")) & 1) != 0)
        {
          v17 = 4;
        }
        else if (objc_msgSend(v16, "isEqualToString:", CFSTR("STANDARD_SIDE_STYLE")))
        {
          v17 = 5;
        }
        else
...
LABEL_1058:
      ...
      objc_msgSend(a1, "setLayoutStyle:", v17);
      goto LABEL_1058;
    }
  }
LABEL_1059:
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOTargetLayout readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 4) == 0)
  {
    if ((*(_BYTE *)&self->_flags & 1) == 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_16;
  -[GEOTargetLayout readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 4) == 0 || self->_uiTarget != *((_DWORD *)v4 + 4))
      goto LABEL_16;
  }
...
LABEL_16:
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_layoutInfo != *((_DWORD *)v4 + 2))
      goto LABEL_16;
  }
  ...
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 2) == 0 || self->_layoutStyle != *((_DWORD *)v4 + 3))
      goto LABEL_16;
    v5 = 1;
  }
LABEL_17:
...
LABEL_7:
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
    goto LABEL_6;
LABEL_3:
  v4 = 2654435761 * self->_layoutInfo;
  if ((*(_BYTE *)&self->_flags & 2) == 0)
    goto LABEL_7;
LABEL_4:
