...
{
  GEOPDAutocompleteParametersAddressOnly *v2;
  GEOPDAutocompleteParametersAddressOnly *v3;
  GEOPDAutocompleteParametersAddressOnly *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDAutocompleteParametersAddressOnly;
  v2 = -[GEOPDAutocompleteParametersAddressOnly init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDAutocompleteParametersAddressOnly)initWithData:(id)a3
{
  GEOPDAutocompleteParametersAddressOnly *v3;
  GEOPDAutocompleteParametersAddressOnly *v4;
  GEOPDAutocompleteParametersAddressOnly *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDAutocompleteParametersAddressOnly;
  v3 = -[GEOPDAutocompleteParametersAddressOnly initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAutocompleteParametersAddressOnlyReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readQuery_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 0x10) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAutocompleteParametersAddressOnlyReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readViewportInfo_tags_733);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDAutocompleteParametersAddressOnly description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAutocompleteParametersAddressOnly dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_740;
    else
      v8 = (int *)&readAll__nonRecursiveTag_741;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOPDAutocompleteParametersAddressOnly readAll:](self, "readAll:", 0);
    if (self->_query)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_13;
  -[GEOPDAutocompleteParametersAddressOnly readAll:](self, "readAll:", 1);
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 4) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOPDAutocompleteParametersAddressOnlyReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_744);
      objc_sync_exit(v5);
