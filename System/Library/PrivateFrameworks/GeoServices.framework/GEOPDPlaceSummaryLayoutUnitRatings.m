...
- (id)description
{
  ...
  -[GEOPDPlaceSummaryLayoutUnitRatings description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPlaceSummaryLayoutUnitRatings dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(unsigned __int8 *)a1
{
  ...
  if (a1)
  {
    ...
    if ((a1[12] & 1) != 0)
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      if (a2)
        v6 = CFSTR("shouldShowRatingCount");
      else
        v6 = CFSTR("should_show_rating_count");
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOPDPlaceSummaryLayoutUnitRatings readAll:](self, "readAll:", 0);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *((_BYTE *)result + 8) = self->_shouldShowRatingCount;
    *((_BYTE *)result + 12) |= 1u;
  }
  return result;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_4;
  -[GEOPDPlaceSummaryLayoutUnitRatings readAll:](self, "readAll:", 1);
