...
- (id)description
{
  ...
  -[GEOPDSearchKeyValue64Pair description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchKeyValue64Pair dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) != 0 && self->_value == *((_QWORD *)v4 + 2))
    {
      v6 = 1;
      goto LABEL_9;
    }
