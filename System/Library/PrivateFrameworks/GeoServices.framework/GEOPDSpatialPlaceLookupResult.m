...
{
  GEOPDSpatialPlaceLookupResult *v2;
  GEOPDSpatialPlaceLookupResult *v3;
  GEOPDSpatialPlaceLookupResult *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDSpatialPlaceLookupResult;
  v2 = -[GEOPDSpatialPlaceLookupResult init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDSpatialPlaceLookupResult)initWithData:(id)a3
{
  GEOPDSpatialPlaceLookupResult *v3;
  GEOPDSpatialPlaceLookupResult *v4;
  GEOPDSpatialPlaceLookupResult *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDSpatialPlaceLookupResult;
  v3 = -[GEOPDSpatialPlaceLookupResult initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 56) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDSpatialPlaceLookupResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readPlaces_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 56) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDSpatialPlaceLookupResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readDisplayMapRegion_tags_5519);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDSpatialPlaceLookupResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSpatialPlaceLookupResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_24:
  ...
  -[GEOPDSpatialPlaceLookupResult displayMapRegion]((id *)a1);
  ...
  if (v16)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v19 = CFSTR("displayMapRegion");
    }
    else
    {
      objc_msgSend(v16, "dictionaryRepresentation");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      v19 = CFSTR("display_map_region");
    }
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_5522;
      else
        v6 = (int *)&readAll__nonRecursiveTag_5523;
      GEOPDSpatialPlaceLookupResultReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
LABEL_11:
  ...
  places = self->_places;
  if ((unint64_t)places | *((_QWORD *)v4 + 4) && !-[NSMutableArray isEqual:](places, "isEqual:"))
    goto LABEL_11;
  displayMapRegion = self->_displayMapRegion;
  if ((unint64_t)displayMapRegion | *((_QWORD *)v4 + 3))
    v7 = -[GEOMapRegion isEqual:](displayMapRegion, "isEqual:");
  else
    v7 = 1;
LABEL_12:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    ...
    v3 = 0;
  v4 = -[NSMutableArray hash](self->_places, "hash") ^ v3;
  return v4 ^ -[GEOMapRegion hash](self->_displayMapRegion, "hash");
}
