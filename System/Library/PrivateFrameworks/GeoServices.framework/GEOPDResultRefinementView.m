  ...
  if (v4)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if ((-[GEOPDResultRefinementSection hasGreenTeaWithValue:](*(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v7), a2) & 1) != 0)
        {
          v8 = 1;
          goto LABEL_12;
        }
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          if (*(_QWORD *)v9 != v6)
            objc_enumerationMutation(v3);
          -[GEOPDResultRefinementView addSection:](a1, *(void **)(*((_QWORD *)&v8 + 1) + 8 * v7++));
        }
        while (v5 != v7);
      ...
      if (v6)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            -[GEOPDResultRefinementSection clearUnknownFields:](*(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), 1);
          }
          while (v7 != v9);
...
- (id)description
{
  ...
  -[GEOPDResultRefinementView description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDResultRefinementView dictionaryRepresentation](self, "dictionaryRepresentation");
