...
- (id)description
{
  ...
  -[GEOPDParsecQueryRankingFeatures description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDParsecQueryRankingFeatures dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 2) == 0 || self->_poiScore != *((double *)v4 + 3))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_geoScore != *((double *)v4 + 2))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
