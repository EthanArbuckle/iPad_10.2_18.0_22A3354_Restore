    ...
    if (v5)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          if (v9 && (objc_msgSend(*(id *)(v9 + 16), "hasGreenTeaWithValue:", a2, (_QWORD)v10) & 1) != 0)
          {
...
{
  GEOPDTransitNearbyScheduleLookupParameters *v2;
  GEOPDTransitNearbyScheduleLookupParameters *v3;
  GEOPDTransitNearbyScheduleLookupParameters *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDTransitNearbyScheduleLookupParameters;
  v2 = -[GEOPDTransitNearbyScheduleLookupParameters init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDTransitNearbyScheduleLookupParameters)initWithData:(id)a3
{
  GEOPDTransitNearbyScheduleLookupParameters *v3;
  GEOPDTransitNearbyScheduleLookupParameters *v4;
  GEOPDTransitNearbyScheduleLookupParameters *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDTransitNearbyScheduleLookupParameters;
  v3 = -[GEOPDTransitNearbyScheduleLookupParameters initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDTransitNearbyScheduleLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTransitNearbyScheduleLookupOrigins_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDTransitNearbyScheduleLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readUserLocation_tags_0);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDTransitNearbyScheduleLookupParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDTransitNearbyScheduleLookupParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 24), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("transitNearbyScheduleLookupOrigin");
    else
      v13 = CFSTR("transit_nearby_schedule_lookup_origin");
  ...
  if (v14)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v17 = CFSTR("userLocation");
    }
    else
    {
      objc_msgSend(v14, "dictionaryRepresentation");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      v17 = CFSTR("user_location");
    }
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_5570;
      else
        v6 = (int *)&readAll__nonRecursiveTag_5571;
      GEOPDTransitNearbyScheduleLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    v12 = 0u;
    v13 = 0u;
    v6 = self->_transitNearbyScheduleLookupOrigins;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v16 = 0u;
  v17 = 0u;
  v8 = self->_transitNearbyScheduleLookupOrigins;
  ...
  v13 = -[GEOWaypointTyped copyWithZone:](self->_userLocation, "copyWithZone:", a3);
  v14 = *(void **)(v5 + 32);
  *(_QWORD *)(v5 + 32) = v13;
...
{
  _QWORD *v4;
  NSMutableArray *transitNearbyScheduleLookupOrigins;
  GEOWaypointTyped *userLocation;
  char v7;
     ...
     || -[NSMutableArray isEqual:](transitNearbyScheduleLookupOrigins, "isEqual:")))
  {
    ...
    if ((unint64_t)userLocation | v4[4])
      v7 = -[GEOWaypointTyped isEqual:](userLocation, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDTransitNearbyScheduleLookupParameters readAll:]((uint64_t)self, 1);
  v3 = -[NSMutableArray hash](self->_transitNearbyScheduleLookupOrigins, "hash");
  return -[GEOWaypointTyped hash](self->_userLocation, "hash") ^ v3;
}
