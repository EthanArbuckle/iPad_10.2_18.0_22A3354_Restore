...
- (GEOPDForwardInfo)init
{
  ...
  v2 = -[GEOPDForwardInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDForwardInfo)initWithData:(id)a3
{
  ...
  v3 = -[GEOPDForwardInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDForwardInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCurrentId_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDForwardInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readPreviousIds_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDForwardInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDForwardInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDForwardInfo currentId]((id *)a1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    if (a2)
      v17 = CFSTR("previousId");
    else
      v17 = CFSTR("previous_id");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_4020;
      else
        v6 = (int *)&readAll__nonRecursiveTag_4021;
      GEOPDForwardInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOPDForwardInfo readAll:]((uint64_t)self, 0);
  v8 = -[GEOPDMapsIdentifier copyWithZone:](self->_currentId, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v8;
...
{
  _QWORD *v4;
  GEOPDMapsIdentifier *currentId;
  NSMutableArray *previousIds;
  char v7;
     ...
     || -[GEOPDMapsIdentifier isEqual:](currentId, "isEqual:")))
  {
    ...
    if ((unint64_t)previousIds | v4[4])
      v7 = -[NSMutableArray isEqual:](previousIds, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDForwardInfo readAll:]((uint64_t)self, 1);
  v3 = -[GEOPDMapsIdentifier hash](self->_currentId, "hash");
  return -[NSMutableArray hash](self->_previousIds, "hash") ^ v3;
}
