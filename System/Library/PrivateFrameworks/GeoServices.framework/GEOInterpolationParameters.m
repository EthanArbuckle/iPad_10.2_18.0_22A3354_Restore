...
- (id)description
{
  ...
  -[GEOInterpolationParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOInterpolationParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("fractionalDistance");
    else
      v7 = CFSTR("fractional_distance");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("fractionalDistance");
      else
        v6 = CFSTR("fractional_distance");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOInterpolationParameters readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 1) != 0)
  {
    v5[2] = *(_QWORD *)&self->_fractionalDistance;
    *((_BYTE *)v5 + 28) |= 1u;
    flags = (char)self->_flags;
  }
  if ((flags & 2) != 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOInterpolationParameters readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_fractionalDistance != *((double *)v4 + 2))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_sideOfLine != *((_DWORD *)v4 + 6))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
- (unint64_t)hash
{
  ...
  if ((flags & 1) != 0)
  {
    fractionalDistance = self->_fractionalDistance;
    v6 = -fractionalDistance;
    if (fractionalDistance >= 0.0)
      v6 = self->_fractionalDistance;
    v7 = floor(v6 + 0.5);
  ...
  if ((flags & 2) != 0)
    v9 = 2654435761 * self->_sideOfLine;
  else
    v9 = 0;
  return v9 ^ v4;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v4 & 1) != 0)
  {
    self->_fractionalDistance = *((double *)v5 + 2);
    *(_BYTE *)&self->_flags |= 1u;
    v4 = *((_BYTE *)v5 + 28);
  }
  if ((v4 & 2) != 0)
