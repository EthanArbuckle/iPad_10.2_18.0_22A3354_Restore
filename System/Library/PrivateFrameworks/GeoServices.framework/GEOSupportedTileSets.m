...
- (id)description
{
  ...
  -[GEOSupportedTileSets description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOSupportedTileSets dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("tileSet"));
  }
  v13 = *(void **)(a1 + 8);
  if (v13)
  {
...
LABEL_15:
        ...
        if ((v11 >> 3) == 1)
        {
          if ((PBReaderPlaceMark() & 1) == 0)
            goto LABEL_29;
          v18 = objc_alloc_init(GEOTileSet);
        ...
        else
        {
          ...
          {
            v19 = (PBUnknownFields *)objc_alloc_init(MEMORY[0x1E0D82BB0]);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)tileSets | v4[2])
      v6 = -[NSMutableArray isEqual:](tileSets, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_tileSets, "hash");
}
