...
- (id)description
{
  ...
  -[GEOPDPictureItemContainer description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPictureItemContainer dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("pictureItem");
    else
      v13 = CFSTR("picture_item");
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    if (a2)
      v15 = CFSTR("allowFullScreenPhoto");
    else
      v15 = CFSTR("allow_full_screen_photo");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v5 + 24) = self->_allowFullScreenPhoto;
    *(_BYTE *)(v5 + 28) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)pictureItems | *((_QWORD *)v4 + 2))
  {
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_pictureItems, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_allowFullScreenPhoto;
  else
    v4 = 0;
  return v4 ^ v3;
}
