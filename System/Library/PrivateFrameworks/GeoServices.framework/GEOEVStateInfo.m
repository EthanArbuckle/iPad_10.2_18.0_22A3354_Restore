...
- (id)description
{
  ...
  -[GEOEVStateInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOEVStateInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("remainingBatteryCharge");
    else
      v9 = CFSTR("remaining_battery_charge");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if (a3)
        v8 = CFSTR("remainingBatteryCharge");
      else
        v8 = CFSTR("remaining_battery_charge");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOEVStateInfo readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOEVStateInfo readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_remainingBatteryPercentage != *((_DWORD *)v4 + 5))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_remainingBatteryCharge != *((_DWORD *)v4 + 4))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
LABEL_5:
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
    goto LABEL_5;
LABEL_3:
  v4 = 2654435761 * self->_remainingBatteryCharge;
  return v4 ^ v3;
}
