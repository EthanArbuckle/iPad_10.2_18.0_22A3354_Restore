@implementation GetAllExpired

uint64_t __GetAllExpired_block_invoke(uint64_t a1, sqlite3_stmt *a2)
{
  uint64_t v4;
  void *v5;
  void *v6;
  ...
  if ((_DWORD)v4 != 101)
  {
    ...
    obj = *(id *)(v8 + 40);
    objc_msgSend(v7, "reportSQLiteErrorCode:method:error:", v4, CFSTR("step"), &obj);
