...
- (void)dealloc
{
  ...
  -[GEOPDTransitVehiclePositionParameters dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  -[GEOPDTransitVehiclePositionParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDTransitVehiclePositionParameters dictionaryRepresentation](self, "dictionaryRepresentation");
