...
{
  GEORPCorrectedString *v2;
  GEORPCorrectedString *v3;
  GEORPCorrectedString *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPCorrectedString;
  v2 = -[GEORPCorrectedString init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPCorrectedString)initWithData:(id)a3
{
  GEORPCorrectedString *v3;
  GEORPCorrectedString *v4;
  GEORPCorrectedString *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPCorrectedString;
  v3 = -[GEORPCorrectedString initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPCorrectedStringReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readOriginalValue_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPCorrectedStringReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCorrectedValue_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPCorrectedString description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPCorrectedString dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  objc_msgSend(a1, "correctedValue");
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_386;
    else
      v8 = (int *)&readAll__nonRecursiveTag_387;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEORPCorrectedString readAll:](self, "readAll:", 0);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPCorrectedString readAll:](self, "readAll:", 0);
    v8 = -[NSString copyWithZone:](self->_originalValue, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v8;

    v10 = -[NSString copyWithZone:](self->_correctedValue, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPCorrectedString readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](originalValue, "isEqual:")))
  {
    ...
    if ((unint64_t)correctedValue | v4[3])
      v7 = -[NSString isEqual:](correctedValue, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_correctedValue, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPCorrectedStringReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_390);
      objc_sync_exit(v5);
