...
- (id)description
{
  ...
  -[GEOPDBrowseCategories description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDBrowseCategories dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("browseCategory");
    else
      v13 = CFSTR("browse_category");
...
- (void)_initWithDictionary:(uint64_t)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if ((_DWORD)a3)
        v6 = CFSTR("browseCategory");
      else
        v6 = CFSTR("browse_category");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)browseCategorys | v4[2])
      v6 = -[NSMutableArray isEqual:](browseCategorys, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_browseCategorys, "hash");
}
