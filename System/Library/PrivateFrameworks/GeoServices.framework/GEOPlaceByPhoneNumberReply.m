...
{
  id v6;
  GEOPlaceByPhoneNumberReply *v7;
  const void *data;
  void *v9;
  GEOPDPlaceResponse *v10;
  GEOPDPlaceResponse *response;
  GEOPlaceByPhoneNumberReply *v12;
  uint64_t v14;
  size_t length;
  objc_super v16;
  ...
  if (v7)
  {
    ...
    if (data)
    {
      ...
      v10 = -[GEOPDPlaceResponse initWithData:]([GEOPDPlaceResponse alloc], "initWithData:", v9);
    }
    else
    {
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  if (response)
  {
    ...
    xpc_dictionary_set_data(v4, "resp", (const void *)objc_msgSend(v6, "bytes"), objc_msgSend(v6, "length"));
...
- (BOOL)isValid
{
  ...
  -[GEOPlaceByPhoneNumberReply response](self, "response");
