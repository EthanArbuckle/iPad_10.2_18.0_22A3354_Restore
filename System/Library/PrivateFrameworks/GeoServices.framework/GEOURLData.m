...
- (GEOURLData)init
{
  ...
  v2 = -[GEOURLData init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOURLData)initWithData:(id)a3
{
  ...
  v3 = -[GEOURLData initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOURLDataReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readDisplayTitle_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOURLDataReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readUrl_tags_4);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOURLData description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOURLData dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "displayTitle");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    if (a2)
      v6 = CFSTR("displayTitle");
    else
      v6 = CFSTR("display_title");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setDisplayTitle:", v8);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_7175;
    else
      v8 = (int *)&readAll__nonRecursiveTag_7176;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOURLData readAll:](self, "readAll:", 0);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOURLData readAll:](self, "readAll:", 1),
...
- (unint64_t)hash
{
  ...
  -[GEOURLData readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_displayTitle, "hash");
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOURLDataReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_7179);
      objc_sync_exit(v5);
