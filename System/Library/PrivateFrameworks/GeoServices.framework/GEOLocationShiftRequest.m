...
- (id)description
{
  ...
  -[GEOLocationShiftRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLocationShiftRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(void *)a1
{
  ...
  if (a1)
  {
    ...
    objc_msgSend(v2, "setObject:forKey:", v3, CFSTR("pixel"));
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("pixel"));
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
...
- (void)copyTo:(id)a3
{
  ...
  v5 = (char *)a3;
  -[GEOLocationShiftRequest readAll:](self, "readAll:", 0);
  v4 = *(_QWORD *)&self->_pixel._z;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[GEOLocationShiftRequest readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    v7 = *(_QWORD *)&self->_pixel._x == v4[1]
      && *(_QWORD *)&self->_pixel._y == v4[2]
      && *(_QWORD *)&self->_pixel._z == v4[3];
  }
  else
  {
    v7 = 0;
