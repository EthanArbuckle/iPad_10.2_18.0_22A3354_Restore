...
{
  GEOPDSPunchInQueryHints *v2;
  GEOPDSPunchInQueryHints *v3;
  GEOPDSPunchInQueryHints *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDSPunchInQueryHints;
  v2 = -[GEOPDSPunchInQueryHints init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDSPunchInQueryHints)initWithData:(id)a3
{
  GEOPDSPunchInQueryHints *v3;
  GEOPDSPunchInQueryHints *v4;
  GEOPDSPunchInQueryHints *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDSPunchInQueryHints;
  v3 = -[GEOPDSPunchInQueryHints initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDSPunchInQueryHintsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readOriginalSearchQuery_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDSPunchInQueryHintsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCompletedSearchQuery_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDSPunchInQueryHints description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSPunchInQueryHints dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSPunchInQueryHints originalSearchQuery]((id *)a1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    if (a2)
      v6 = CFSTR("originalSearchQuery");
    else
      v6 = CFSTR("original_search_query");
    objc_msgSend(v4, "setObject:forKey:", v5, v6);
  }

  -[GEOPDSPunchInQueryHints completedSearchQuery]((id *)a1);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    if (a2)
      v8 = CFSTR("completedSearchQuery");
    else
      v8 = CFSTR("completed_search_query");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_271;
      else
        v6 = (int *)&readAll__nonRecursiveTag_272;
      GEOPDSPunchInQueryHintsReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOPDSPunchInQueryHints readAll:]((uint64_t)self, 0);
    v8 = -[NSString copyWithZone:](self->_originalSearchQuery, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v8;

    v10 = -[NSString copyWithZone:](self->_completedSearchQuery, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](originalSearchQuery, "isEqual:")))
  {
    ...
    if ((unint64_t)completedSearchQuery | v4[3])
      v7 = -[NSString isEqual:](completedSearchQuery, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDSPunchInQueryHints readAll:]((uint64_t)self, 1);
  v3 = -[NSString hash](self->_originalSearchQuery, "hash");
  return -[NSString hash](self->_completedSearchQuery, "hash") ^ v3;
}
