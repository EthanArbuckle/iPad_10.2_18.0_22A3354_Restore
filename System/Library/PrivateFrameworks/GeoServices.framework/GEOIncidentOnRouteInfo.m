...
{
  objc_storeStrong((id *)&self->_indexAndOffsets, a3);
}

- (void)clearIndexAndOffsets
{
  -[NSMutableArray removeAllObjects](self->_indexAndOffsets, "removeAllObjects");
}
...
- (void)addIndexAndOffset:(id)a3
{
  ...
  -[NSMutableArray addObject:](indexAndOffsets, "addObject:", v4);

}

- (unint64_t)indexAndOffsetsCount
{
  return -[NSMutableArray count](self->_indexAndOffsets, "count");
}

- (id)indexAndOffsetAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_indexAndOffsets, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOIncidentOnRouteInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOIncidentOnRouteInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("indexAndOffset");
    else
      v13 = CFSTR("index_and_offset");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("indexAndOffset");
      else
        v6 = CFSTR("index_and_offset");
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v15 = -[GEOIndexAndOffset initWithJSON:](v14, "initWithJSON:", v13);
                else
                  v15 = -[GEOIndexAndOffset initWithDictionary:](v14, "initWithDictionary:", v13);
                v16 = (void *)v15;
                objc_msgSend(a1, "addIndexAndOffset:", v15);
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEOIncidentOnRouteInfo readAll:](self, "readAll:", 0);
  if (-[GEOIncidentOnRouteInfo indexAndOffsetsCount](self, "indexAndOffsetsCount"))
  {
    objc_msgSend(v8, "clearIndexAndOffsets");
    v4 = -[GEOIncidentOnRouteInfo indexAndOffsetsCount](self, "indexAndOffsetsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOIncidentOnRouteInfo indexAndOffsetAtIndex:](self, "indexAndOffsetAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addIndexAndOffset:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addIndexAndOffset:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOIncidentOnRouteInfo readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    indexAndOffsets = self->_indexAndOffsets;
    if ((unint64_t)indexAndOffsets | v4[2])
      v5 = -[NSMutableArray isEqual:](indexAndOffsets, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOIncidentOnRouteInfo readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_indexAndOffsets, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOIncidentOnRouteInfo addIndexAndOffset:](self, "addIndexAndOffset:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
