...
- (void)dealloc
{
  ...
  -[GEOPDSearchResultPlacePhotoFilter dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  -[GEOPDSearchResultPlacePhotoFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchResultPlacePhotoFilter dictionaryRepresentation](self, "dictionaryRepresentation");
