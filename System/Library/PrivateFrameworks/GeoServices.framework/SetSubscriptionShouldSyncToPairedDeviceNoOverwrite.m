@implementation SetSubscriptionShouldSyncToPairedDeviceNoOverwrite

uint64_t __SetSubscriptionShouldSyncToPairedDeviceNoOverwrite_block_invoke(uint64_t a1, uint64_t a2)
{
  void *v4;
  uint64_t v5;
  uint64_t v6;
