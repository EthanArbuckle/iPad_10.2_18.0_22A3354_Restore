...
- (id)description
{
  ...
  -[GEOPDSearchKeyValueBoolPair description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchKeyValueBoolPair dictionaryRepresentation](self, "dictionaryRepresentation");
