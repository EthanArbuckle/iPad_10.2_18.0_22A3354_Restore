...
- (id)description
{
  ...
  -[GEOPDSearchKeyValuePairList description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchKeyValuePairList dictionaryRepresentation](self, "dictionaryRepresentation");
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[GEOPDSearchKeyValuePairList addPairs:](a1, *(void **)(*((_QWORD *)&v8 + 1) + 8 * v7++));
        }
        while (v5 != v7);
