...
- (id)description
{
  ...
  -[GEOPDSSearchTierMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSSearchTierMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (uint64_t)_initWithDictionary:(int)a3 isJSON:
{
  ...
  {
    v8 = v7;
    if ((objc_msgSend(v8, "isEqualToString:", CFSTR("SEARCH_TIER_METADATA_UNKNOWN")) & 1) != 0)
    {
      v9 = 0;
    }
    else if ((objc_msgSend(v8, "isEqualToString:", CFSTR("SEARCH_TIER_METADATA_PRIMARY")) & 1) != 0)
    {
      v9 = 1;
    }
    else if (objc_msgSend(v8, "isEqualToString:", CFSTR("SEARCH_TIER_METADATA_AUXILIARY")))
    {
      v9 = 2;
    }
    else
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 4) == 0 || self->_tierType != *((_DWORD *)v4 + 6))
      goto LABEL_16;
  }
...
LABEL_16:
  ...
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_startIndex != *((_DWORD *)v4 + 5))
      goto LABEL_16;
  }
