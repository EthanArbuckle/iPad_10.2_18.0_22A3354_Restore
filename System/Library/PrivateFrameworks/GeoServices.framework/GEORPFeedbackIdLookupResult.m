...
- (id)description
{
  ...
  -[GEORPFeedbackIdLookupResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPFeedbackIdLookupResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEORPFeedbackIdLookupResult readAll:](self, "readAll:", 0);
  if (-[GEORPFeedbackIdLookupResult feedbackInfosCount](self, "feedbackInfosCount"))
  {
    objc_msgSend(v8, "clearFeedbackInfos");
    v4 = -[GEORPFeedbackIdLookupResult feedbackInfosCount](self, "feedbackInfosCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEORPFeedbackIdLookupResult feedbackInfoAtIndex:](self, "feedbackInfoAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addFeedbackInfo:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addFeedbackInfo:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEORPFeedbackIdLookupResult readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    feedbackInfos = self->_feedbackInfos;
    if ((unint64_t)feedbackInfos | v4[2])
      v5 = -[NSMutableArray isEqual:](feedbackInfos, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEORPFeedbackIdLookupResult readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_feedbackInfos, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEORPFeedbackIdLookupResult addFeedbackInfo:](self, "addFeedbackInfo:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
