...
{
  GEOPDAutocompleteEntryHighlightLine *v2;
  GEOPDAutocompleteEntryHighlightLine *v3;
  GEOPDAutocompleteEntryHighlightLine *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDAutocompleteEntryHighlightLine;
  v2 = -[GEOPDAutocompleteEntryHighlightLine init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDAutocompleteEntryHighlightLine)initWithData:(id)a3
{
  GEOPDAutocompleteEntryHighlightLine *v3;
  GEOPDAutocompleteEntryHighlightLine *v4;
  GEOPDAutocompleteEntryHighlightLine *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDAutocompleteEntryHighlightLine;
  v3 = -[GEOPDAutocompleteEntryHighlightLine initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAutocompleteEntryHighlightLineReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLine_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAutocompleteEntryHighlightLineReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSpans_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDAutocompleteEntryHighlightLine description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAutocompleteEntryHighlightLine dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("span"));
  }
  v14 = *(void **)(a1 + 16);
  if (v14)
  {
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  ...
  uint64_t i;
  uint64_t v14;
  GEOPDAutocompleteEntryHighlightSpan *v15;
  uint64_t v16;
  void *v17;
  void *v19;
  __int128 v20;
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setLine:", v7);

      }
      objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("span"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
          ...
          do
          {
            for (i = 0; i != v11; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v16 = -[GEOPDAutocompleteEntryHighlightSpan initWithJSON:](v15, "initWithJSON:", v14);
                else
                  v16 = -[GEOPDAutocompleteEntryHighlightSpan initWithDictionary:](v15, "initWithDictionary:", v14);
                v17 = (void *)v16;
                objc_msgSend(a1, "addSpan:", v16);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_568;
    else
      v8 = (int *)&readAll__nonRecursiveTag_569;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOPDAutocompleteEntryHighlightLine readAll:](self, "readAll:", 0);
    if (self->_line)
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v8 + 11) = self->_readerMarkLength;
  ...
  if (-[GEOPDAutocompleteEntryHighlightLine spansCount](self, "spansCount"))
  {
    objc_msgSend(v8, "clearSpans");
    v4 = -[GEOPDAutocompleteEntryHighlightLine spansCount](self, "spansCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOPDAutocompleteEntryHighlightLine spanAtIndex:](self, "spanAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addSpan:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOPDAutocompleteEntryHighlightLine readAll:](self, "readAll:", 0);
  v8 = -[NSString copyWithZone:](self->_line, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v8;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        objc_msgSend((id)v5, "addSpan:", v14);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOPDAutocompleteEntryHighlightLine readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](line, "isEqual:")))
  {
    ...
    if ((unint64_t)spans | v4[4])
      v7 = -[NSMutableArray isEqual:](spans, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDAutocompleteEntryHighlightLine readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_line, "hash");
  return -[NSMutableArray hash](self->_spans, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[GEOPDAutocompleteEntryHighlightLine addSpan:](self, "addSpan:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOPDAutocompleteEntryHighlightLineReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_572);
      objc_sync_exit(v5);
