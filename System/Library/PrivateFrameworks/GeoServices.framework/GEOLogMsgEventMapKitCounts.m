...
{
  -[NSMutableArray removeAllObjects](self->_mapKitCounts, "removeAllObjects");
}
...
- (void)addMapKitCounts:(id)a3
{
  ...
  -[NSMutableArray addObject:](mapKitCounts, "addObject:", v4);

}

- (unint64_t)mapKitCountsCount
{
  return -[NSMutableArray count](self->_mapKitCounts, "count");
}

- (id)mapKitCountsAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_mapKitCounts, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOLogMsgEventMapKitCounts description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLogMsgEventMapKitCounts dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(id *)a1
{
  ...
  if (objc_msgSend(a1[1], "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("mapKitCounts");
    else
      v13 = CFSTR("map_kit_counts");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("mapKitCounts");
      else
        v6 = CFSTR("map_kit_counts");
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v15 = -[GEOMapKitCount initWithJSON:](v14, "initWithJSON:", v13);
                else
                  v15 = -[GEOMapKitCount initWithDictionary:](v14, "initWithDictionary:", v13);
                v16 = (void *)v15;
                objc_msgSend(a1, "addMapKitCounts:", v15);
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEOLogMsgEventMapKitCounts readAll:](self, "readAll:", 0);
  if (-[GEOLogMsgEventMapKitCounts mapKitCountsCount](self, "mapKitCountsCount"))
  {
    objc_msgSend(v8, "clearMapKitCounts");
    v4 = -[GEOLogMsgEventMapKitCounts mapKitCountsCount](self, "mapKitCountsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOLogMsgEventMapKitCounts mapKitCountsAtIndex:](self, "mapKitCountsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addMapKitCounts:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addMapKitCounts:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOLogMsgEventMapKitCounts readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    mapKitCounts = self->_mapKitCounts;
    if ((unint64_t)mapKitCounts | v4[1])
      v5 = -[NSMutableArray isEqual:](mapKitCounts, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOLogMsgEventMapKitCounts readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_mapKitCounts, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOLogMsgEventMapKitCounts addMapKitCounts:](self, "addMapKitCounts:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
