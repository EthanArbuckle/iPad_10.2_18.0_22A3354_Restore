...
{
  GEOLocalizedDisambiguationLabel *v2;
  GEOLocalizedDisambiguationLabel *v3;
  GEOLocalizedDisambiguationLabel *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOLocalizedDisambiguationLabel;
  v2 = -[GEOLocalizedDisambiguationLabel init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOLocalizedDisambiguationLabel)initWithData:(id)a3
{
  GEOLocalizedDisambiguationLabel *v3;
  GEOLocalizedDisambiguationLabel *v4;
  GEOLocalizedDisambiguationLabel *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOLocalizedDisambiguationLabel;
  v3 = -[GEOLocalizedDisambiguationLabel initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  -[GEOLocalizedDisambiguationLabel description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLocalizedDisambiguationLabel dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 52) & 2) == 0)
  {
    ...
    if (v5)
    {
      v6 = v5;
      objc_sync_enter(v6);
      GEOLocalizedDisambiguationLabelReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLocale_tags);
      objc_sync_exit(v6);
  ...
  v7 = *(id *)(a1 + 24);
  if (v7)
    objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("locale"));
  ...
  if ((*(_BYTE *)(a1 + 52) & 4) == 0)
  {
    ...
    if (v8)
    {
      v9 = v8;
      objc_sync_enter(v9);
      GEOLocalizedDisambiguationLabelReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readString_tags_0);
      objc_sync_exit(v9);
  ...
  v10 = *(id *)(a1 + 32);
  if (v10)
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("string"));
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_1265;
      else
        v6 = (int *)&readAll__nonRecursiveTag_1266;
      GEOLocalizedDisambiguationLabelReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
LABEL_5:
    ...
    *(_QWORD *)(v5 + 24) = v8;
    ...
    v10 = -[NSString copyWithZone:](self->_string, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
