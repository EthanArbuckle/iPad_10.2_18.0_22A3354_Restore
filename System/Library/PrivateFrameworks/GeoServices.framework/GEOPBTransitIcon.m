...
- (NSString)description
{
  ...
  -[GEOPBTransitIcon description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPBTransitIcon dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 2) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("transitTypeEnumValue");
    else
      v9 = CFSTR("transit_type_enum_value");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if (a3)
        v8 = CFSTR("transitTypeEnumValue");
      else
        v8 = CFSTR("transit_type_enum_value");
...
- (void)copyTo:(id)a3
{
  ...
  v6 = a3;
  -[GEOPBTransitIcon readAll:](self, "readAll:", 0);
  v4 = v6;
  flags = (char)self->_flags;
  if ((flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_14;
  -[GEOPBTransitIcon readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_cartoId != *((_DWORD *)v4 + 6))
      goto LABEL_14;
  }
...
LABEL_14:
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 2) == 0 || self->_transitTypeEnumValue != *((_DWORD *)v4 + 7))
      goto LABEL_14;
  }
  ...
  if ((unint64_t)styleAttributes | *((_QWORD *)v4 + 2))
    v6 = -[GEOStyleAttributes isEqual:](styleAttributes, "isEqual:");
  else
    v6 = 1;
LABEL_15:
...
LABEL_5:
    v4 = 0;
    return v4 ^ v3 ^ -[GEOStyleAttributes hash](self->_styleAttributes, "hash");
  }
  v3 = 0;
  if ((*(_BYTE *)&self->_flags & 2) == 0)
    goto LABEL_5;
LABEL_3:
  v4 = 2654435761 * self->_transitTypeEnumValue;
  return v4 ^ v3 ^ -[GEOStyleAttributes hash](self->_styleAttributes, "hash");
}
...
- (int)iconType
{
  if (-[GEOPBTransitIcon hasCartoId](self, "hasCartoId"))
    return 0;
  else
    return !-[GEOPBTransitIcon hasTransitTypeEnumValue](self, "hasTransitTypeEnumValue");
}
...
- (unsigned)iconAttributeKey
{
  ...
  -[GEOPBTransitIcon _firstAttribute](self, "_firstAttribute");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v2, "hasKey"))
...
- (id)_firstAttribute
{
  ...
  if (-[GEOPBTransitIcon hasStyleAttributes](self, "hasStyleAttributes"))
  {
    -[GEOPBTransitIcon styleAttributes](self, "styleAttributes");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v3, "attributesCount"))
    {
      objc_msgSend(v3, "attributeAtIndex:", 0);
      v4 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
