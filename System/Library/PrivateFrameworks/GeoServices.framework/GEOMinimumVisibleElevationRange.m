...
- (id)description
{
  ...
  -[GEOMinimumVisibleElevationRange description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOMinimumVisibleElevationRange dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("lowerBoundCm");
    else
      v7 = CFSTR("lower_bound_cm");
  ...
  if ((v5 & 2) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("upperBoundCm");
    else
      v9 = CFSTR("upper_bound_cm");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("lowerBoundCm");
      else
        v6 = CFSTR("lower_bound_cm");
      ...
      if (a3)
        v8 = CFSTR("upperBoundCm");
      else
        v8 = CFSTR("upper_bound_cm");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOMinimumVisibleElevationRange readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOMinimumVisibleElevationRange readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_lowerBoundCm != *((_DWORD *)v4 + 4))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_upperBoundCm != *((_DWORD *)v4 + 5))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    v3 = 2654435761 * self->_lowerBoundCm;
    if ((*(_BYTE *)&self->_flags & 2) != 0)
      goto LABEL_3;
LABEL_5:
    v4 = 0;
  ...
  if ((*(_BYTE *)&self->_flags & 2) == 0)
    goto LABEL_5;
LABEL_3:
  v4 = 2654435761 * self->_upperBoundCm;
  return v4 ^ v3;
}
