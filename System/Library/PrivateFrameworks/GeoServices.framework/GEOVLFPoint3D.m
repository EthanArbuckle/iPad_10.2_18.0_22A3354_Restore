...
- (id)description
{
  ...
  -[GEOVLFPoint3D description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOVLFPoint3D dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_8:
    ...
    objc_msgSend(v2, "setObject:forKey:", v7, CFSTR("z"));
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOVLFPoint3D readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 1) == 0)
  {
    if ((*(_BYTE *)&self->_flags & 2) == 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_16;
  -[GEOVLFPoint3D readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_x != *((float *)v4 + 2))
      goto LABEL_16;
  }
...
LABEL_16:
  ...
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 2) == 0 || self->_y != *((float *)v4 + 3))
      goto LABEL_16;
  }
  ...
  if ((*(_BYTE *)&self->_flags & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 4) == 0 || self->_z != *((float *)v4 + 4))
      goto LABEL_16;
    v5 = 1;
  }
LABEL_17:
