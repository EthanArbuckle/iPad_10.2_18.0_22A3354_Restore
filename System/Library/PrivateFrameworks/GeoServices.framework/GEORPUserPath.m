...
- (GEORPUserPath)init
{
  ...
  v2 = -[GEORPUserPath init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPUserPath)initWithData:(id)a3
{
  ...
  v3 = -[GEORPUserPath initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  -[GEORPUserPath dealloc](&v3, sel_dealloc);
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 68) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPUserPathReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readNativePaths_tags);
        objc_sync_exit(v3);
...
{
  $27AAA0BB14FCB8642CC83DAEBE69EA4A *p_nativePaths;
  unint64_t count;
  void *v7;
  uint64_t v8;
  void *v9;
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 68) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPUserPathReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readWebPaths_tags);
        objc_sync_exit(v3);
...
- (void)clearWebPaths
{
  ...
  *(_BYTE *)&self->_flags |= 4u;
  os_unfair_lock_unlock(p_readerLock);
  *(_BYTE *)&self->_flags |= 8u;
  -[NSMutableArray removeAllObjects](self->_webPaths, "removeAllObjects");
}
...
{
  -[GEORPUserPath _readWebPaths]((uint64_t)self);
  return -[NSMutableArray count](self->_webPaths, "count");
}

- (id)webPathAtIndex:(unint64_t)a3
{
  -[GEORPUserPath _readWebPaths]((uint64_t)self);
  return (id)-[NSMutableArray objectAtIndex:](self->_webPaths, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEORPUserPath description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPUserPath dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_41:
    ...
    if (a2)
      v11 = CFSTR("nativePath");
    else
      v11 = CFSTR("native_path");
    objc_msgSend(v4, "setObject:forKey:", v5, v11);

  }
  if (a1[6])
  {
    objc_msgSend(a1, "webPaths");
  ...
  if (v14)
  {
    ...
    if (a2)
    {
      ...
      v21[1] = 3221225472;
      v21[2] = __43__GEORPUserPath__dictionaryRepresentation___block_invoke;
      v21[3] = &unk_1E1C00600;
      v18 = v17;
      v22 = v18;
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        while (1)
        {
          for (i = 0; i != v11; ++i)
          {
            ...
            objc_msgSend(v6, "addNativePath:", v16);
          }
          ...
          do
          {
            for (j = 0; j != v21; ++j)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                objc_msgSend(v6, "addWebPath:", v25);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_3205;
    else
      v8 = (int *)&readAll__nonRecursiveTag_3206;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPUserPath readAll:](self, "readAll:", 0);
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v11 + 15) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  if (-[GEORPUserPath nativePathsCount](self, "nativePathsCount"))
  {
    objc_msgSend(v11, "clearNativePaths");
    v4 = -[GEORPUserPath nativePathsCount](self, "nativePathsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (-[GEORPUserPath webPathsCount](self, "webPathsCount"))
  {
    objc_msgSend(v11, "clearWebPaths");
    v7 = -[GEORPUserPath webPathsCount](self, "webPathsCount");
    if (v7)
    {
      v8 = v7;
      for (j = 0; j != v8; ++j)
      {
        -[GEORPUserPath webPathAtIndex:](self, "webPathAtIndex:", j);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v11, "addWebPath:", v10);
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        objc_msgSend(v5, "addWebPath:", v12);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && (-[GEORPUserPath readAll:](self, "readAll:", 1),
        objc_msgSend(v4, "readAll:", 1),
        PBRepeatedInt32IsEqual()))
  {
    webPaths = self->_webPaths;
    if ((unint64_t)webPaths | v4[6])
      v6 = -[NSMutableArray isEqual:](webPaths, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_webPaths, "hash") ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  v5 = objc_msgSend(v4, "nativePathsCount");
  if (v5)
  {
    v6 = v5;
    for (i = 0; i != v6; ++i)
      -[GEORPUserPath addNativePath:](self, "addNativePath:", objc_msgSend(v4, "nativePathAtIndex:", i));
  }
  v15 = 0u;
  v16 = 0u;
  v13 = 0u;
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v14 != v11)
          objc_enumerationMutation(v8);
        -[GEORPUserPath addWebPath:](self, "addWebPath:", *(_QWORD *)(*((_QWORD *)&v13 + 1) + 8 * v12++), (_QWORD)v13);
      }
      while (v10 != v12);
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPUserPathReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_3209);
      objc_sync_exit(v5);
