...
{
  GEOPBTransitShield *v2;
  GEOPBTransitShield *v3;
  GEOPBTransitShield *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPBTransitShield;
  v2 = -[GEOPBTransitShield init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPBTransitShield)initWithData:(id)a3
{
  GEOPBTransitShield *v3;
  GEOPBTransitShield *v4;
  GEOPBTransitShield *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPBTransitShield;
  v3 = -[GEOPBTransitShield initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 56) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPBTransitShieldReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readShieldText_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 56) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPBTransitShieldReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readShieldColor_tags);
        objc_sync_exit(v3);
...
- (NSString)description
{
  ...
  -[GEOPBTransitShield description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPBTransitShield dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 56) & 1) != 0)
  {
    ...
    if (a2)
      v8 = CFSTR("shieldEnumValue");
    else
      v8 = CFSTR("shield_enum_value");
    objc_msgSend(v4, "setObject:forKey:", v7, v8);

  }
  objc_msgSend((id)a1, "shieldColor");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9)
  {
    if (a2)
      v10 = CFSTR("shieldColor");
    else
      v10 = CFSTR("shield_color");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setShieldText:", v8);

      }
      if (a3)
        v9 = CFSTR("shieldEnumValue");
      else
        v9 = CFSTR("shield_enum_value");
      ...
      if (a3)
        v11 = CFSTR("shieldColor");
      else
        v11 = CFSTR("shield_color");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setShieldColor:", v13);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_3617;
    else
      v8 = (int *)&readAll__nonRecursiveTag_3618;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOPBTransitShield readAll:](self, "readAll:", 0);
    if (self->_shieldText)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOPBTransitShield readAll:](self, "readAll:", 0);
  v9 = -[NSString copyWithZone:](self->_shieldText, "copyWithZone:", a3);
  v10 = *(void **)(v5 + 32);
  *(_QWORD *)(v5 + 32) = v9;
  ...
  v11 = -[NSString copyWithZone:](self->_shieldColor, "copyWithZone:", a3);
  v12 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v11;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOPBTransitShield readAll:](self, "readAll:", 1);
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 56) & 1) == 0 || self->_shieldEnumValue != *((_DWORD *)v4 + 13))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  if ((unint64_t)shieldColor | *((_QWORD *)v4 + 3))
    v7 = -[NSString isEqual:](shieldColor, "isEqual:");
  else
    v7 = 1;
LABEL_12:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_shieldEnumValue;
  else
    v4 = 0;
  return v4 ^ v3 ^ -[NSString hash](self->_shieldColor, "hash");
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 2) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOPBTransitShieldReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_3621);
      objc_sync_exit(v5);
...
- (int64_t)shieldType
{
  return -[GEOPBTransitShield shieldEnumValue](self, "shieldEnumValue");
}
