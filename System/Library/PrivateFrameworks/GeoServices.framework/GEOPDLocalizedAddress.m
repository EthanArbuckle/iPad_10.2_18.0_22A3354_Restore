...
{
  GEOPDLocalizedAddress *v2;
  GEOPDLocalizedAddress *v3;
  GEOPDLocalizedAddress *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDLocalizedAddress;
  v2 = -[GEOPDLocalizedAddress init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDLocalizedAddress)initWithData:(id)a3
{
  GEOPDLocalizedAddress *v3;
  GEOPDLocalizedAddress *v4;
  GEOPDLocalizedAddress *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDLocalizedAddress;
  v3 = -[GEOPDLocalizedAddress initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDLocalizedAddressReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAddress_tags_4);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDLocalizedAddress description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDLocalizedAddress dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 52) & 4) == 0)
  {
    ...
    if (v5)
    {
      v6 = v5;
      objc_sync_enter(v6);
      GEOPDLocalizedAddressReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLanguage_tags_1);
      objc_sync_exit(v6);
  ...
  -[GEOPDLocalizedAddress address]((id *)a1);
  ...
  if (v8)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("address"));
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_4658;
      else
        v6 = (int *)&readAll__nonRecursiveTag_4659;
      GEOPDLocalizedAddressReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v9 = [GEOAddress alloc];
        if ((a3 & 1) != 0)
          v10 = -[GEOAddress initWithJSON:](v9, "initWithJSON:", v8);
        else
          v10 = -[GEOAddress initWithDictionary:](v9, "initWithDictionary:", v8);
        v11 = v10;
...
LABEL_5:
    ...
    *(_QWORD *)(v5 + 32) = v8;
    ...
    v10 = -[GEOAddress copyWithZone:](self->_address, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](language, "isEqual:")))
  {
    ...
    if ((unint64_t)address | v4[3])
      v7 = -[GEOAddress isEqual:](address, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[GEOAddress hash](self->_address, "hash") ^ v3;
}
