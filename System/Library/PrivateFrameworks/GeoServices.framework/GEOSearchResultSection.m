...
{
  GEOSearchResultSection *result;

  result = (GEOSearchResultSection *)objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", CFSTR("GEOMethodNotAvailableException"), CFSTR("This method is unavailable."));
  __break(1u);
  return result;
}
...
- (GEOSearchResultSection)initWithSearchResultSection:(id)a3
{
  ...
  v5 = -[GEOSearchResultSection init](&v15, sel_init);
  if (v5)
  {
    v6 = -[GEOPDSSearchResultSection searchResultSectionCellType]((uint64_t)v4);
    if (v6)
    {
      if (v6 != 1)
      {
LABEL_7:
        -[GEOPDSSearchResultSection sectionHeaderDisplayName](v4);
        v8 = objc_claimAutoreleasedReturnValue();
        headerDisplayName = v5->_headerDisplayName;
        v5->_headerDisplayName = (NSString *)v8;

        -[GEOPDSSearchResultSection sectionSubHeaderDisplayName](v4);
        v10 = objc_claimAutoreleasedReturnValue();
        subHeaderDisplayName = v5->_subHeaderDisplayName;
        v5->_subHeaderDisplayName = (NSString *)v10;

        -[GEOPDSSearchResultSection styleAttributes](v4);
