...
- (id)description
{
  ...
  -[GEOPDAllGuidesLocationsViewParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAllGuidesLocationsViewParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)viewportInfo | *((_QWORD *)v4 + 2))
  {
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) != 0 && self->_numClientizedResults == *((_DWORD *)v4 + 6))
    {
      v6 = 1;
      goto LABEL_9;
    }
