@implementation FindSubscriptionsReferencingOldestNTiles

uint64_t __FindSubscriptionsReferencingOldestNTiles_block_invoke(uint64_t a1, sqlite3_stmt *a2)
{
  void *v4;
  uint64_t v5;
  uint64_t v6;
  ...
  obj = *(id *)(v6 + 40);
  v7 = objc_msgSend(v4, "bindInt64Parameter:toValue:inStatement:error:", "@limit", v5, a2, &obj);
