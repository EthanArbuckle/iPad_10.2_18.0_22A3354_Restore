...
- (id)description
{
  ...
  -[GEOPDNearbySearchFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDNearbySearchFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    if (v6 > 1)
    {
      if (v6 == 2)
      {
        v7 = CFSTR("POI_AGE_FILTER_LAST_6_MONTHS");
        goto LABEL_15;
      }
      if (v6 == 10)
      {
        v7 = CFSTR("POI_AGE_FILTER_SERVER");
        goto LABEL_15;
      }
    }
    else
    {
      if (!v6)
      {
        v7 = CFSTR("POI_AGE_FILTER_NONE");
        goto LABEL_15;
      }
      if (v6 == 1)
      {
        v7 = CFSTR("POI_AGE_FILTER_LAST_MONTH");
LABEL_15:
        if (a2)
          v8 = CFSTR("poiAgeFilter");
        else
          v8 = CFSTR("poi_age_filter");
...
- (void)writeTo:(id)a3
{
  ...
  v12 = 0u;
  v13 = 0u;
  v5 = self->_includedCategoryFilters;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v15 = 0u;
  v16 = 0u;
  v6 = self->_includedCategoryFilters;
...
{
  id v4;
  NSMutableArray *includedCategoryFilters;
  BOOL v6;
  ...
  if ((unint64_t)includedCategoryFilters | *((_QWORD *)v4 + 2))
  {
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) != 0 && self->_poiAgeFilter == *((_DWORD *)v4 + 6))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_includedCategoryFilters, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_poiAgeFilter;
  else
    v4 = 0;
  return v4 ^ v3;
}
