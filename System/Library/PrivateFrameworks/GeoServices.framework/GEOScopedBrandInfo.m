...
{
  GEOScopedBrandInfo *v2;
  GEOScopedBrandInfo *v3;
  GEOScopedBrandInfo *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOScopedBrandInfo;
  v2 = -[GEOScopedBrandInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOScopedBrandInfo)initWithData:(id)a3
{
  GEOScopedBrandInfo *v3;
  GEOScopedBrandInfo *v4;
  GEOScopedBrandInfo *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOScopedBrandInfo;
  v3 = -[GEOScopedBrandInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOScopedBrandInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readIsoCountryCode_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOScopedBrandInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLocalizedNames_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOScopedBrandInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOScopedBrandInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(id *)a1
{
  ...
  {
    if (a2)
      v6 = CFSTR("isoCountryCode");
    else
      v6 = CFSTR("iso_country_code");
  ...
  if (objc_msgSend(a1[3], "count"))
  {
    ...
    if (a2)
      v15 = CFSTR("localizedName");
    else
      v15 = CFSTR("localized_name");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setIsoCountryCode:", v8);
          ...
          do
          {
            for (i = 0; i != v13; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                v19 = (void *)v18;
                objc_msgSend(a1, "addLocalizedName:", v18);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_137_0;
    else
      v8 = (int *)&readAll__nonRecursiveTag_138_0;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOScopedBrandInfo readAll:](self, "readAll:", 0);
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v8 + 9) = self->_readerMarkLength;
  ...
  if (-[GEOScopedBrandInfo localizedNamesCount](self, "localizedNamesCount"))
  {
    objc_msgSend(v8, "clearLocalizedNames");
    v4 = -[GEOScopedBrandInfo localizedNamesCount](self, "localizedNamesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOScopedBrandInfo localizedNameAtIndex:](self, "localizedNameAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOScopedBrandInfo readAll:](self, "readAll:", 0);
  v8 = -[NSString copyWithZone:](self->_isoCountryCode, "copyWithZone:", a3);
  v9 = (void *)v5[2];
  v5[2] = v8;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        objc_msgSend(v5, "addLocalizedName:", v14);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOScopedBrandInfo readAll:](self, "readAll:", 1),
...
- (unint64_t)hash
{
  ...
  -[GEOScopedBrandInfo readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_isoCountryCode, "hash");
  return -[NSMutableArray hash](self->_localizedNames, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[GEOScopedBrandInfo addLocalizedName:](self, "addLocalizedName:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
