...
{
  GEOLocalizedBytes *v2;
  GEOLocalizedBytes *v3;
  GEOLocalizedBytes *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOLocalizedBytes;
  v2 = -[GEOLocalizedBytes init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOLocalizedBytes)initWithData:(id)a3
{
  GEOLocalizedBytes *v3;
  GEOLocalizedBytes *v4;
  GEOLocalizedBytes *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOLocalizedBytes;
  v3 = -[GEOLocalizedBytes initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLocalizedBytesReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLocale_tags_1);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLocalizedBytesReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readByteValue_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOLocalizedBytes description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLocalizedBytes dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (v6)
  {
    if ((a2 & 1) != 0)
    {
      ...
      objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("byteValue"));

    }
    else
    {
      objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("byte_value"));
    }
  }
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setByteValue:", v10);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_547_0;
    else
      v8 = (int *)&readAll__nonRecursiveTag_548_0;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOLocalizedBytes readAll:](self, "readAll:", 0);
    if (self->_locale)
...
LABEL_5:
    ...
    *(_QWORD *)(v5 + 32) = v8;
    ...
    v10 = -[NSData copyWithZone:](self->_byteValue, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOLocalizedBytes readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](locale, "isEqual:")))
  {
    ...
    if ((unint64_t)byteValue | v4[3])
      v7 = -[NSData isEqual:](byteValue, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSData hash](self->_byteValue, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOLocalizedBytesReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_551);
      objc_sync_exit(v5);
