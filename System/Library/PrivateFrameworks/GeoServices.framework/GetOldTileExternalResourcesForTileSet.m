@implementation GetOldTileExternalResourcesForTileSet

uint64_t __GetOldTileExternalResourcesForTileSet_block_invoke(uint64_t a1, sqlite3_stmt *a2)
{
  void *v4;
  uint64_t v5;
  uint64_t v6;
  ...
  v20 = *(id *)(v10 + 40);
  v11 = objc_msgSend(v8, "bindIntParameter:toValue:inStatement:error:", "@tileset", v9, a2, &v20);
