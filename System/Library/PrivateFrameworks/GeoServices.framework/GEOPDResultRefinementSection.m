  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if ((-[GEOPDResultRefinement hasGreenTeaWithValue:](*(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v8), a2) & 1) != 0)
        {
          v9 = 1;
          goto LABEL_12;
        }
...
{
  GEOPDResultRefinementSection *v2;
  GEOPDResultRefinementSection *v3;
  GEOPDResultRefinementSection *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDResultRefinementSection;
  v2 = -[GEOPDResultRefinementSection init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDResultRefinementSection)initWithData:(id)a3
{
  GEOPDResultRefinementSection *v3;
  GEOPDResultRefinementSection *v4;
  GEOPDResultRefinementSection *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDResultRefinementSection;
  v3 = -[GEOPDResultRefinementSection initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDResultRefinementSectionReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSectionHeader_tags_0);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDResultRefinementSectionReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readResultRefinements_tags_0);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDResultRefinementSection description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDResultRefinementSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDResultRefinementSection sectionHeader]((id *)a1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    if (a2)
  ...
  if ((*(_BYTE *)(a1 + 60) & 8) == 0)
  {
    ...
    if (v15)
    {
      v16 = v15;
      objc_sync_enter(v16);
      GEOPDResultRefinementSectionReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSectionIdentifier_tags);
      objc_sync_exit(v16);
  ...
  {
    if (a2)
      v18 = CFSTR("sectionIdentifier");
    else
      v18 = CFSTR("section_identifier");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_887;
      else
        v6 = (int *)&readAll__nonRecursiveTag_888;
      GEOPDResultRefinementSectionReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (uint64_t)_initWithDictionary:(int)a3 isJSON:
{
  ...
  {
    if (a3)
      v7 = CFSTR("sectionHeader");
    else
      v7 = CFSTR("section_header");
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v13)
      {
        ...
        do
        {
          ...
          while (v14 != v16);
          v20 = objc_msgSend(v12, "countByEnumeratingWithState:objects:count:", &v27, v31, 16);
          v14 = v20;
        }
        while (v20);
      }
    ...
    if (a3)
      v21 = CFSTR("sectionIdentifier");
    else
      v21 = CFSTR("section_identifier");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 32) = v8;
  ...
  v15 = -[NSString copyWithZone:](self->_sectionIdentifier, "copyWithZone:", a3);
  v16 = *(void **)(v5 + 40);
  *(_QWORD *)(v5 + 40) = v15;
...
- (unint64_t)hash
{
  ...
  v4 = -[NSMutableArray hash](self->_resultRefinements, "hash") ^ v3;
