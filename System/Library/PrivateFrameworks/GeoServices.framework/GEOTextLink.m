...
- (GEOTextLink)init
{
  ...
  v2 = -[GEOTextLink init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOTextLink)initWithData:(id)a3
{
  ...
  v3 = -[GEOTextLink initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOTextLinkReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readUrl_tags_8);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOTextLinkReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readText_tags_1);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOTextLink description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTextLink dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (v6)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("text"));
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if ((a3 & 1) != 0)
          v10 = -[GEOLocalizedString initWithJSON:](v9, "initWithJSON:", v8);
        else
          v10 = -[GEOLocalizedString initWithDictionary:](v9, "initWithDictionary:", v8);
        v11 = (void *)v10;
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_1419;
    else
      v8 = (int *)&readAll__nonRecursiveTag_1420;
    GEOTextLinkReadSpecified((uint64_t)self, (unint64_t)self->_reader, v8);
    objc_sync_exit(v7);

  }
  if (v3)
    -[GEOLocalizedString readAll:](self->_text, "readAll:", 1);
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOTextLink readAll:](self, "readAll:", 0);
    if (self->_url)
...
LABEL_5:
    ...
    *(_QWORD *)(v5 + 32) = v8;
    ...
    v10 = -[GEOLocalizedString copyWithZone:](self->_text, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOTextLink readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](url, "isEqual:")))
  {
    ...
    if ((unint64_t)text | v4[3])
      v7 = -[GEOLocalizedString isEqual:](text, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[GEOLocalizedString hash](self->_text, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOTextLinkReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_1423);
      objc_sync_exit(v5);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(_BYTE *)&self->_flags |= 9u;
  ...
  {
    -[GEOTextLink readAll:](self, "readAll:", 0);
    -[GEOLocalizedString clearUnknownFields:](self->_text, "clearUnknownFields:", 1);
  }
}
