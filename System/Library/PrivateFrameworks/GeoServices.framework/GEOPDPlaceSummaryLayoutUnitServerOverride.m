...
- (id)description
{
  ...
  -[GEOPDPlaceSummaryLayoutUnitServerOverride description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPlaceSummaryLayoutUnitServerOverride dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 12) & 1) != 0)
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      if (a2)
        v6 = CFSTR("serverOverrideIdentifier");
      else
        v6 = CFSTR("server_override_identifier");
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOPDPlaceSummaryLayoutUnitServerOverride readAll:](self, "readAll:", 0);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_6;
  -[GEOPDPlaceSummaryLayoutUnitServerOverride readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  v5 = (*((_BYTE *)v4 + 12) & 1) == 0;
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_serverOverrideIdentifier == *((_DWORD *)v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
