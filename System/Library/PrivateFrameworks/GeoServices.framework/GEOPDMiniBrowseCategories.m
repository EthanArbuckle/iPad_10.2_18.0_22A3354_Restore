...
{
  GEOPDMiniBrowseCategories *v2;
  GEOPDMiniBrowseCategories *v3;
  GEOPDMiniBrowseCategories *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDMiniBrowseCategories;
  v2 = -[GEOPDMiniBrowseCategories init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDMiniBrowseCategories)initWithData:(id)a3
{
  GEOPDMiniBrowseCategories *v3;
  GEOPDMiniBrowseCategories *v4;
  GEOPDMiniBrowseCategories *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDMiniBrowseCategories;
  v3 = -[GEOPDMiniBrowseCategories initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDMiniBrowseCategoriesReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readMiniBrowseCategorys_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDMiniBrowseCategoriesReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTopChildNames_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDMiniBrowseCategories description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDMiniBrowseCategories dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 24), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("miniBrowseCategory");
    else
      v13 = CFSTR("mini_browse_category");
    objc_msgSend(v4, "setObject:forKey:", v5, v13);

  }
  if (*(_QWORD *)(a1 + 32))
  {
    -[GEOPDMiniBrowseCategories topChildNames]((id *)a1);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v15 = CFSTR("topChildName");
    else
      v15 = CFSTR("top_child_name");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_4899;
      else
        v6 = (int *)&readAll__nonRecursiveTag_4900;
      GEOPDMiniBrowseCategoriesReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](miniBrowseCategorys, "isEqual:")))
  {
    ...
    if ((unint64_t)topChildNames | v4[4])
      v7 = -[NSMutableArray isEqual:](topChildNames, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDMiniBrowseCategories readAll:]((uint64_t)self, 1);
  v3 = -[NSMutableArray hash](self->_miniBrowseCategorys, "hash");
  return -[NSMutableArray hash](self->_topChildNames, "hash") ^ v3;
}
