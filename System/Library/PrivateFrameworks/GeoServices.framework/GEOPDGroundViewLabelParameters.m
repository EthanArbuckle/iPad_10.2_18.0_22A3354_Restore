...
- (id)description
{
  ...
  -[GEOPDGroundViewLabelParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDGroundViewLabelParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_QWORD *)(v5 + 16) = self->_locationId;
    *(_BYTE *)(v5 + 32) |= 1u;
  }
  v7 = -[GEOLocation copyWithZone:](self->_location, "copyWithZone:", a3);
  v8 = *(void **)(v6 + 24);
  *(_QWORD *)(v6 + 24) = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_locationId != *((_QWORD *)v4 + 2))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  if ((unint64_t)location | *((_QWORD *)v4 + 3))
    v6 = -[GEOLocation isEqual:](location, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v2 = 2654435761u * self->_locationId;
  else
    v2 = 0;
  return -[GEOLocation hash](self->_location, "hash") ^ v2;
}
