...
- (uint64_t)_regularTileKeyForPolygonSelectionSelectionTileKey:(uint64_t)a3 polyId:(_QWORD *)a4
{
  void *v6;
  uint64_t v7;
  uint64_t v8;
  ...
  if ((GEOSelectionTileKeyGetXYZId(a3, (int *)&v22 + 1, &v22, &v21, &v20) & 1) != 0)
  {
    ...
    v16 = 0u;
    v17 = 0u;
    v7 = objc_msgSend(&unk_1E1E855D0, "countByEnumeratingWithState:objects:count:", &v16, v23, 16);
    if (v7)
    {
      v8 = v7;
      v9 = *(_QWORD *)v17;
LABEL_4:
      ...
      {
        if (*(_QWORD *)v17 != v9)
          objc_enumerationMutation(&unk_1E1E855D0);
        if ((objc_msgSend(v6, "supportsTileStyle:size:scale:", 69, objc_msgSend(*(id *)(*((_QWORD *)&v16 + 1) + 8 * v10), "integerValue"), 0) & 1) != 0)break;
        if (v8 == ++v10)
        {
          v8 = objc_msgSend(&unk_1E1E855D0, "countByEnumeratingWithState:objects:count:", &v16, v23, 16);
          if (v8)
            goto LABEL_4;
          goto LABEL_10;
        }
...
- (id)activeTileSetForKey:(void *)a1
{
  ...
  v12 = 0u;
  v13 = 0u;
  v2 = objc_msgSend(&unk_1E1E855E8, "countByEnumeratingWithState:objects:count:", &v10, v14, 16);
  if (v2)
  {
    v3 = v2;
    v4 = *(_QWORD *)v11;
LABEL_3:
    ...
    {
      if (*(_QWORD *)v11 != v4)
        objc_enumerationMutation(&unk_1E1E855E8);
      v6 = objc_msgSend(*(id *)(*((_QWORD *)&v10 + 1) + 8 * v5), "integerValue");
      if ((objc_msgSend(v1, "supportsTileStyle:size:scale:", 69, v6, 0) & 1) != 0)
        break;
      if (v3 == ++v5)
      {
        v3 = objc_msgSend(&unk_1E1E855E8, "countByEnumeratingWithState:objects:count:", &v10, v14, 16);
        if (v3)
          goto LABEL_3;
        goto LABEL_9;
      }
...
LABEL_9:
  ...
  objc_msgSend(v7, "activeTileSetForStyle:size:scale:", 69, v6, 0);
...
- (id)urlForTileKey:(uint64_t)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v17 = 0;
  *(_QWORD *)&v25 = objc_msgSend(a1, "_regularTileKeyForPolygonSelectionSelectionTileKey:polyId:", a3, &v17);
  *((_QWORD *)&v25 + 1) = v7;
...
- (id)_localizationURLForTileKey:(uint64_t)a3
{
  ...
  v21 = 0;
  *(_QWORD *)&v29 = objc_msgSend(a1, "_regularTileKeyForPolygonSelectionSelectionTileKey:polyId:", a3, &v21);
  *((_QWORD *)&v29 + 1) = v7;
