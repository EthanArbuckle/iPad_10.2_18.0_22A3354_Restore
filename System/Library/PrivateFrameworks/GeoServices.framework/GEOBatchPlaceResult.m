...
- (id)description
{
  ...
  -[GEOBatchPlaceResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOBatchPlaceResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_21:
  ...
  if (v7)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v9, CFSTR("placeResult"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[GEOPlaceResult copyWithZone:](self->_placeResult, "copyWithZone:", a3);
  v8 = (void *)v6[1];
  v6[1] = v7;
...
LABEL_9:
  ...
  if ((unint64_t)placeResult | *((_QWORD *)v4 + 1))
    v6 = -[GEOPlaceResult isEqual:](placeResult, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    ...
    v2 = 0;
  return -[GEOPlaceResult hash](self->_placeResult, "hash") ^ v2;
}
