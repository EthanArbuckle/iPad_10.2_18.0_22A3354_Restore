...
{
  GEOCyclingOptions *v2;
  GEOCyclingOptions *v3;
  GEOCyclingOptions *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOCyclingOptions;
  v2 = -[GEOCyclingOptions init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOCyclingOptions)initWithData:(id)a3
{
  ...
  v3 = -[GEOCyclingOptions initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCyclingOptionsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCyclingUserPreferences_tags);
        objc_sync_exit(v3);
...
{
  -[GEOCyclingOptions _readCyclingUserPreferences]((uint64_t)self);
  return self->_cyclingUserPreferences;
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCyclingOptionsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCyclingVehicleSpecifications_tags);
        objc_sync_exit(v3);
...
{
  -[GEOCyclingOptions _readCyclingVehicleSpecifications]((uint64_t)self);
  return self->_cyclingVehicleSpecifications;
}
...
- (id)description
{
  ...
  -[GEOCyclingOptions description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOCyclingOptions dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "cyclingUserPreferences");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v8 = CFSTR("cyclingUserPreferences");
    }
    else
    {
      objc_msgSend(v5, "dictionaryRepresentation");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = CFSTR("cycling_user_preferences");
    }
    objc_msgSend(v4, "setObject:forKey:", v7, v8);

  }
  objc_msgSend(a1, "cyclingVehicleSpecifications");
  ...
  if (v9)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v12 = CFSTR("cyclingVehicleSpecifications");
    }
    else
    {
      objc_msgSend(v9, "dictionaryRepresentation");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = CFSTR("cycling_vehicle_specifications");
    }
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  const __CFString *v6;
  void *v7;
  GEOCyclingUserPreferences *v8;
  uint64_t v9;
  void *v10;
  const __CFString *v11;
  void *v12;
  GEOCyclingVehicleSpecifications *v13;
  uint64_t v14;
  void *v15;
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("cyclingUserPreferences");
      else
        v6 = CFSTR("cycling_user_preferences");
      objc_msgSend(v5, "objectForKeyedSubscript:", v6);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v8 = [GEOCyclingUserPreferences alloc];
        if ((a3 & 1) != 0)
          v9 = -[GEOCyclingUserPreferences initWithJSON:](v8, "initWithJSON:", v7);
        else
          v9 = -[GEOCyclingUserPreferences initWithDictionary:](v8, "initWithDictionary:", v7);
        v10 = (void *)v9;
        objc_msgSend(a1, "setCyclingUserPreferences:", v9);

      }
      if (a3)
        v11 = CFSTR("cyclingVehicleSpecifications");
      else
        v11 = CFSTR("cycling_vehicle_specifications");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if ((a3 & 1) != 0)
          v14 = -[GEOCyclingVehicleSpecifications initWithJSON:](v13, "initWithJSON:", v12);
        else
          v14 = -[GEOCyclingVehicleSpecifications initWithDictionary:](v13, "initWithDictionary:", v12);
        v15 = (void *)v14;
        objc_msgSend(a1, "setCyclingVehicleSpecifications:", v14);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_1090;
    else
      v8 = (int *)&readAll__nonRecursiveTag_1091;
  ...
  if (v3)
  {
    -[GEOCyclingUserPreferences readAll:](self->_cyclingUserPreferences, "readAll:", 1);
    -[GEOCyclingVehicleSpecifications readAll:](self->_cyclingVehicleSpecifications, "readAll:", 1);
  }
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOCyclingOptions readAll:](self, "readAll:", 0);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOCyclingOptions readAll:](self, "readAll:", 0);
    v8 = -[GEOCyclingUserPreferences copyWithZone:](self->_cyclingUserPreferences, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;

    v10 = -[GEOCyclingVehicleSpecifications copyWithZone:](self->_cyclingVehicleSpecifications, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOCyclingOptions readAll:](self, "readAll:", 1),
     ...
     || -[GEOCyclingUserPreferences isEqual:](cyclingUserPreferences, "isEqual:")))
  {
    ...
    if ((unint64_t)cyclingVehicleSpecifications | v4[4])
      v7 = -[GEOCyclingVehicleSpecifications isEqual:](cyclingVehicleSpecifications, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOCyclingOptions readAll:](self, "readAll:", 1);
  v3 = -[GEOCyclingUserPreferences hash](self->_cyclingUserPreferences, "hash");
  return -[GEOCyclingVehicleSpecifications hash](self->_cyclingVehicleSpecifications, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOCyclingOptionsReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_1094);
      objc_sync_exit(v5);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(_BYTE *)&self->_flags |= 9u;
  ...
  {
    -[GEOCyclingOptions readAll:](self, "readAll:", 0);
    -[GEOCyclingUserPreferences clearUnknownFields:](self->_cyclingUserPreferences, "clearUnknownFields:", 1);
    -[GEOCyclingVehicleSpecifications clearUnknownFields:](self->_cyclingVehicleSpecifications, "clearUnknownFields:", 1);
  }
}
