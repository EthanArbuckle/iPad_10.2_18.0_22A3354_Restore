...
- (id)description
{
  ...
  -[GEOLogMsgEventNetworkEventSummary description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLogMsgEventNetworkEventSummary dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(id *)a1
{
  ...
  if (objc_msgSend(a1[1], "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("groups"));
  }
  return v4;
}
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  ...
  uint64_t i;
  uint64_t v12;
  GEONetEventDimensionalGrouping *v13;
  uint64_t v14;
  void *v15;
  void *v17;
  __int128 v18;
          ...
          do
          {
            for (i = 0; i != v9; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v14 = -[GEONetEventDimensionalGrouping initWithJSON:](v13, "initWithJSON:", v12);
                else
                  v14 = -[GEONetEventDimensionalGrouping initWithDictionary:](v13, "initWithDictionary:", v12);
                v15 = (void *)v14;
                objc_msgSend(a1, "addGroups:", v14);
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEOLogMsgEventNetworkEventSummary readAll:](self, "readAll:", 0);
  if (-[GEOLogMsgEventNetworkEventSummary groupsCount](self, "groupsCount"))
  {
    objc_msgSend(v8, "clearGroups");
    v4 = -[GEOLogMsgEventNetworkEventSummary groupsCount](self, "groupsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOLogMsgEventNetworkEventSummary groupsAtIndex:](self, "groupsAtIndex:", i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOLogMsgEventNetworkEventSummary readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    groups = self->_groups;
    if ((unint64_t)groups | v4[1])
      v5 = -[NSMutableArray isEqual:](groups, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOLogMsgEventNetworkEventSummary readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_groups, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOLogMsgEventNetworkEventSummary addGroups:](self, "addGroups:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
