...
{
  GEOTransitExitPlanInfo *v2;
  GEOTransitExitPlanInfo *v3;
  GEOTransitExitPlanInfo *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOTransitExitPlanInfo;
  v2 = -[GEOTransitExitPlanInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOTransitExitPlanInfo)initWithData:(id)a3
{
  ...
  v3 = -[GEOTransitExitPlanInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  -[GEOTransitExitPlanInfo dealloc](&v3, sel_dealloc);
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 72) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOTransitExitPlanInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSelectedCarIndexs_tags);
        objc_sync_exit(v3);
...
{
  $1729E44CE8A3ADE0AA70C2F19EF2BB02 *p_selectedCarIndexs;
  unint64_t count;
  void *v7;
  uint64_t v8;
  void *v9;
  ...
  count = self->_selectedCarIndexs.count;
  if (count <= a3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 72) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOTransitExitPlanInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLabel_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOTransitExitPlanInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTransitExitPlanInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 72) & 1) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v6 = CFSTR("numberOfCars");
    else
      v6 = CFSTR("number_of_cars");
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (a2)
      v8 = CFSTR("selectedCarIndex");
    else
      v8 = CFSTR("selected_car_index");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
        ...
        if (v11)
        {
          ...
          do
          {
            for (i = 0; i != v12; ++i)
            {
              ...
              objc_opt_class();
              if ((objc_opt_isKindOfClass() & 1) != 0)
                objc_msgSend(a1, "addSelectedCarIndex:", objc_msgSend(v15, "unsignedIntValue", (_QWORD)v21));
            }
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        v19 = (void *)v18;
        objc_msgSend(a1, "setLabel:", v18, (_QWORD)v21);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_770;
    else
      v8 = (int *)&readAll__nonRecursiveTag_771;
    GEOTransitExitPlanInfoReadSpecified((uint64_t)self, (unint64_t)self->_reader, v8);
    objc_sync_exit(v7);

  }
  if (v3)
    -[GEOFormattedString readAll:](self->_label, "readAll:", 1);
  os_unfair_lock_unlock(p_readerLock);
}
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOTransitExitPlanInfo readAll:](self, "readAll:", 0);
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v7 + 15) = self->_readerMarkLength;
  ...
  if (-[GEOTransitExitPlanInfo selectedCarIndexsCount](self, "selectedCarIndexsCount"))
  {
    objc_msgSend(v7, "clearSelectedCarIndexs");
    v4 = -[GEOTransitExitPlanInfo selectedCarIndexsCount](self, "selectedCarIndexsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v9 = -[GEOFormattedString copyWithZone:](self->_label, "copyWithZone:", a3);
  v10 = *(void **)(v5 + 48);
  *(_QWORD *)(v5 + 48) = v9;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_10;
  -[GEOTransitExitPlanInfo readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 72) & 1) == 0 || self->_numberOfCars != *((_DWORD *)v4 + 17))
      goto LABEL_10;
  }
...
LABEL_10:
  ...
  if ((unint64_t)label | *((_QWORD *)v4 + 6))
    v6 = -[GEOFormattedString isEqual:](label, "isEqual:");
  else
    v6 = 1;
LABEL_11:
...
- (unint64_t)hash
{
  ...
  -[GEOTransitExitPlanInfo readAll:](self, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v3 = 2654435761 * self->_numberOfCars;
  else
    v3 = 0;
  v4 = PBRepeatedUInt32Hash() ^ v3;
  return v4 ^ -[GEOFormattedString hash](self->_label, "hash");
}
...
- (void)mergeFrom:(id)a3
{
  ...
  v4 = objc_msgSend(v10, "selectedCarIndexsCount");
  if (v4)
  {
    v5 = v4;
    for (i = 0; i != v5; ++i)
      -[GEOTransitExitPlanInfo addSelectedCarIndex:](self, "addSelectedCarIndex:", objc_msgSend(v10, "selectedCarIndexAtIndex:", i));
  }
  label = self->_label;
  v8 = v10;
  v9 = *((_QWORD *)v10 + 6);
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 2) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOTransitExitPlanInfoReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_774);
      objc_sync_exit(v5);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(_BYTE *)&self->_flags |= 0x12u;
  ...
  {
    -[GEOTransitExitPlanInfo readAll:](self, "readAll:", 0);
    -[GEOFormattedString clearUnknownFields:](self->_label, "clearUnknownFields:", 1);
  }
}
