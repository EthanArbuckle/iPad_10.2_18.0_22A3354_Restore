...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("defaults.getCompanionSyncValuesForKeys"), a3, a4, a5);
}

- (GEOConfigGetCompanionSyncValuesForKeysRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6;
  GEOConfigGetCompanionSyncValuesForKeysRequest *v7;
  void *v8;
  size_t count;
  void *v10;
  size_t i;
  ...
  uint64_t v14;
  void *v15;
  GEOConfigGetCompanionSyncValuesForKeysRequest *v16;
  objc_super v18;
  ...
  if (v7)
  {
    xpc_dictionary_get_array(v6, "keyStrings");
...
- (BOOL)isValid
{
  ...
  -[GEOConfigGetCompanionSyncValuesForKeysRequest keyStrings](self, "keyStrings");
