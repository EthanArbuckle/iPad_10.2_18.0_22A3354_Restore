...
- (id)description
{
  ...
  -[GEOPDSCategoryFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSCategoryFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)categoryMetadata | v4[2])
      v6 = -[NSData isEqual:](categoryMetadata, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSData hash](self->_categoryMetadata, "hash");
}
