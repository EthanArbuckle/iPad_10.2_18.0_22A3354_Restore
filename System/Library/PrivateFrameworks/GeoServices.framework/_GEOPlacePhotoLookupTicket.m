...
- (_GEOPlacePhotoLookupTicket)initWithVendorIdentifier:(id)a3 mapItemIdentifier:(id)a4 range:(_NSRange)a5 traits:(id)a6
{
  ...
  id v14;
  void *v15;
  _GEOPlacePhotoLookupTicket *v16;
  _GEOPlacePhotoLookupTicket *v17;
  objc_super v19;
  ...
  v13 = a4;
  v14 = a6;
  +[GEOPDPlaceRequest photoLookupRequestWithVendorIdentifier:mapItemIdentifier:range:traits:](GEOPDPlaceRequest, "photoLookupRequestWithVendorIdentifier:mapItemIdentifier:range:traits:", v12, v13, location, length, v14);
