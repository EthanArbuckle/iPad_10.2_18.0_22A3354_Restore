...
- (void)clearUnknownFields:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    *(_QWORD *)(a1 + 8) = 0;
    ...
    if (a2)
      objc_msgSend(*(id *)(a1 + 16), "clearUnknownFields:", 1);
  }
}
...
- (id)description
{
  ...
  -[GEOPDSearchOriginationRoutePlanningParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchOriginationRoutePlanningParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    if (a2)
      v10 = CFSTR("isEditServerRecommendedStop");
    else
      v10 = CFSTR("is_edit_server_recommended_stop");
