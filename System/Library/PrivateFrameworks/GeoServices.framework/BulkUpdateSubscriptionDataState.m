@implementation BulkUpdateSubscriptionDataState

uint64_t __BulkUpdateSubscriptionDataState_block_invoke(uint64_t a1, uint64_t a2)
{
  uint64_t v4;
  void *v5;
  uint64_t v6;
  ...
  v22 = *(id *)(v14 + 40);
  v15 = objc_msgSend(v13, "bindInt64Parameter:toValue:inStatement:error:", "@version", v12, a2, &v22);
  ...
  v21 = *(id *)(v18 + 40);
  v19 = objc_msgSend(v17, "bindIntParameter:toValue:inStatement:error:", "@complete", v16, a2, &v21);
