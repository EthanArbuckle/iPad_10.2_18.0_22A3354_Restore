...
{
  GEOPDIndexQueryNode *v2;
  GEOPDIndexQueryNode *v3;
  GEOPDIndexQueryNode *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDIndexQueryNode;
  v2 = -[GEOPDIndexQueryNode init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDIndexQueryNode)initWithData:(id)a3
{
  GEOPDIndexQueryNode *v3;
  GEOPDIndexQueryNode *v4;
  GEOPDIndexQueryNode *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDIndexQueryNode;
  v3 = -[GEOPDIndexQueryNode initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 64) & 4) == 0)
    {
      ...
      if (v4)
      {
        v5 = v4;
        objc_sync_enter(v5);
        GEOPDIndexQueryNodeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readOperands_tags);
        objc_sync_exit(v5);
...
- (id)description
{
  ...
  -[GEOPDIndexQueryNode description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDIndexQueryNode dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 64) & 2) == 0)
  {
    ...
    if (v7)
    {
      v8 = v7;
      objc_sync_enter(v8);
      GEOPDIndexQueryNodeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readField_tags);
      objc_sync_exit(v8);
  ...
  if ((*(_BYTE *)(a1 + 64) & 8) == 0)
  {
    ...
    if (v10)
    {
      v11 = v10;
      objc_sync_enter(v11);
      GEOPDIndexQueryNodeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readValue_tags_0);
      objc_sync_exit(v11);
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v13, CFSTR("operand"));
  }
  v20 = *(void **)(a1 + 16);
  if (v20)
  {
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_2616;
      else
        v6 = (int *)&readAll__nonRecursiveTag_2617;
      GEOPDIndexQueryNodeReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
LABEL_15:
  ...
  objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("operand"));
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[GEOPDIndexQueryNode clearUnknownFields:](*(_QWORD *)(*((_QWORD *)&v8 + 1) + 8 * v7++));
        }
        while (v5 != v7);
