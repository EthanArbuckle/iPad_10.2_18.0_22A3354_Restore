...
{
  GEOPDSImplicitQuerySearchAroundPOI *v2;
  GEOPDSImplicitQuerySearchAroundPOI *v3;
  GEOPDSImplicitQuerySearchAroundPOI *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDSImplicitQuerySearchAroundPOI;
  v2 = -[GEOPDSImplicitQuerySearchAroundPOI init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDSImplicitQuerySearchAroundPOI)initWithData:(id)a3
{
  GEOPDSImplicitQuerySearchAroundPOI *v3;
  GEOPDSImplicitQuerySearchAroundPOI *v4;
  GEOPDSImplicitQuerySearchAroundPOI *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDSImplicitQuerySearchAroundPOI;
  v3 = -[GEOPDSImplicitQuerySearchAroundPOI initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDSImplicitQuerySearchAroundPOIReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readReferenceLocation_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDSImplicitQuerySearchAroundPOI description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSImplicitQuerySearchAroundPOI dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 60) & 4) == 0)
  {
    ...
    if (v5)
    {
      v6 = v5;
      objc_sync_enter(v6);
      GEOPDSImplicitQuerySearchAroundPOIReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCategoryIdOfPoi_tags);
      objc_sync_exit(v6);
  ...
  {
    if (a2)
      v8 = CFSTR("categoryIdOfPoi");
    else
      v8 = CFSTR("category_id_of_poi");
  ...
  if (v9)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v12 = CFSTR("referenceLocation");
    }
    else
    {
      objc_msgSend(v9, "dictionaryRepresentation");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = CFSTR("reference_location");
    }
  ...
  if ((*(_BYTE *)(a1 + 60) & 1) != 0)
  {
    ...
    if (a2)
      v14 = CFSTR("encryptedMuidOfPoi");
    else
      v14 = CFSTR("encrypted_muid_of_poi");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_146;
      else
        v6 = (int *)&readAll__nonRecursiveTag_147;
      GEOPDSImplicitQuerySearchAroundPOIReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOPDSImplicitQuerySearchAroundPOI readAll:]((uint64_t)self, 0);
  v9 = -[NSString copyWithZone:](self->_categoryIdOfPoi, "copyWithZone:", a3);
  v10 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v9;

  v11 = -[GEOLatLng copyWithZone:](self->_referenceLocation, "copyWithZone:", a3);
  v12 = *(void **)(v5 + 40);
  *(_QWORD *)(v5 + 40) = v11;

  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_QWORD *)(v5 + 32) = self->_encryptedMuidOfPoi;
    *(_BYTE *)(v5 + 60) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 60) & 1) != 0 && self->_encryptedMuidOfPoi == *((_QWORD *)v4 + 4))
    {
      v7 = 1;
      goto LABEL_11;
    }
...
- (unint64_t)hash
{
  ...
  -[GEOPDSImplicitQuerySearchAroundPOI readAll:]((uint64_t)self, 1);
  v3 = -[NSString hash](self->_categoryIdOfPoi, "hash");
  v4 = -[GEOLatLng hash](self->_referenceLocation, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v5 = 2654435761u * self->_encryptedMuidOfPoi;
  else
    v5 = 0;
  return v4 ^ v3 ^ v5;
}
