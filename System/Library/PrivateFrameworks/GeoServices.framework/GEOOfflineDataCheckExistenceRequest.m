...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("offlinedata.checkExistence"), a3, a4, a5);
}
...
- (GEOOfflineDataCheckExistenceRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  ...
  GEOOfflineDataCheckExistenceRequest *v10;
  objc_super v12;
