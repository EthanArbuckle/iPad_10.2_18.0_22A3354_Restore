...
{
  GEOPDAllGuidesLocationsViewResult *v2;
  GEOPDAllGuidesLocationsViewResult *v3;
  GEOPDAllGuidesLocationsViewResult *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDAllGuidesLocationsViewResult;
  v2 = -[GEOPDAllGuidesLocationsViewResult init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDAllGuidesLocationsViewResult)initWithData:(id)a3
{
  GEOPDAllGuidesLocationsViewResult *v3;
  GEOPDAllGuidesLocationsViewResult *v4;
  GEOPDAllGuidesLocationsViewResult *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDAllGuidesLocationsViewResult;
  v3 = -[GEOPDAllGuidesLocationsViewResult initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAllGuidesLocationsViewResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readHeader_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAllGuidesLocationsViewResultReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAllGuidesLocationsSections_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDAllGuidesLocationsViewResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAllGuidesLocationsViewResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAllGuidesLocationsViewResult header]((id *)a1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("header"));
  ...
  if (objc_msgSend(*(id *)(a1 + 24), "count"))
  {
    ...
    if (a2)
      v14 = CFSTR("allGuidesLocationsSection");
    else
      v14 = CFSTR("all_guides_locations_section");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_288;
      else
        v6 = (int *)&readAll__nonRecursiveTag_289;
      GEOPDAllGuidesLocationsViewResultReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    v12 = 0u;
    v13 = 0u;
    v6 = self->_allGuidesLocationsSections;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOPDAllGuidesLocationsViewResult readAll:]((uint64_t)self, 0);
  v8 = -[NSString copyWithZone:](self->_header, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 32);
  *(_QWORD *)(v5 + 32) = v8;
  ...
  v16 = 0u;
  v17 = 0u;
  v10 = self->_allGuidesLocationsSections;
...
- (BOOL)isEqual:(id)a3
{
  _QWORD *v4;
  NSString *header;
  NSMutableArray *allGuidesLocationsSections;
  char v7;
     ...
     || -[NSString isEqual:](header, "isEqual:")))
  {
    ...
    if ((unint64_t)allGuidesLocationsSections | v4[3])
      v7 = -[NSMutableArray isEqual:](allGuidesLocationsSections, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_allGuidesLocationsSections, "hash") ^ v3;
}
