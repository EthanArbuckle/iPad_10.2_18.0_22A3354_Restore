...
{
  GEOTransitRouteIdentifier *v2;
  GEOTransitRouteIdentifier *v3;
  GEOTransitRouteIdentifier *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOTransitRouteIdentifier;
  v2 = -[GEOTransitRouteIdentifier init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOTransitRouteIdentifier)initWithData:(id)a3
{
  GEOTransitRouteIdentifier *v3;
  GEOTransitRouteIdentifier *v4;
  GEOTransitRouteIdentifier *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOTransitRouteIdentifier;
  v3 = -[GEOTransitRouteIdentifier initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOTransitRouteIdentifierReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readServerRouteHandle_tags);
        objc_sync_exit(v3);
...
{
  -[GEOTransitRouteIdentifier _readServerRouteHandle]((uint64_t)self);
  return self->_serverRouteHandle;
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOTransitRouteIdentifierReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readClientRouteHandle_tags);
        objc_sync_exit(v3);
...
{
  -[GEOTransitRouteIdentifier _readClientRouteHandle]((uint64_t)self);
  return self->_clientRouteHandle;
}
...
- (id)description
{
  ...
  -[GEOTransitRouteIdentifier description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTransitRouteIdentifier dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "serverRouteHandle");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
    if ((a2 & 1) != 0)
    {
      ...
      objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("serverRouteHandle"));

    }
    else
    {
      objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("server_route_handle"));
    }
  }

  objc_msgSend(a1, "clientRouteHandle");
  ...
  if (v8)
  {
    if ((a2 & 1) != 0)
    {
      ...
      objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("clientRouteHandle"));

    }
    else
    {
      objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("client_route_handle"));
    }
  }
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("serverRouteHandle");
      else
        v6 = CFSTR("server_route_handle");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setServerRouteHandle:", v8);

      }
      if (a3)
        v9 = CFSTR("clientRouteHandle");
      else
        v9 = CFSTR("client_route_handle");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setClientRouteHandle:", v11);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_0;
    else
      v8 = (int *)&readAll__nonRecursiveTag_0;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOTransitRouteIdentifier readAll:](self, "readAll:", 0);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOTransitRouteIdentifier readAll:](self, "readAll:", 0);
    v8 = -[NSData copyWithZone:](self->_serverRouteHandle, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v8;

    v10 = -[NSData copyWithZone:](self->_clientRouteHandle, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOTransitRouteIdentifier readAll:](self, "readAll:", 1),
     ...
     || -[NSData isEqual:](serverRouteHandle, "isEqual:")))
  {
    ...
    if ((unint64_t)clientRouteHandle | v4[3])
      v7 = -[NSData isEqual:](clientRouteHandle, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOTransitRouteIdentifier readAll:](self, "readAll:", 1);
  v3 = -[NSData hash](self->_serverRouteHandle, "hash");
  return -[NSData hash](self->_clientRouteHandle, "hash") ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[4])
    -[GEOTransitRouteIdentifier setServerRouteHandle:](self, "setServerRouteHandle:");
  if (v4[3])
    -[GEOTransitRouteIdentifier setClientRouteHandle:](self, "setClientRouteHandle:");
...
+ (id)routeIdentiferForComposedRoute:(id)a3
{
  ...
  objc_msgSend(v3, "suggestedRoute");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "routeHandle");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTransitRouteIdentifier setServerRouteHandle:](v4, "setServerRouteHandle:", v6);
  ...
  objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v10, 16);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTransitRouteIdentifier setClientRouteHandle:](v4, "setClientRouteHandle:", v8);
...
- (NSUUID)clientRouteID
{
  ...
  -[GEOTransitRouteIdentifier clientRouteHandle](self, "clientRouteHandle");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "_maps_UUIDWithData:", v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
