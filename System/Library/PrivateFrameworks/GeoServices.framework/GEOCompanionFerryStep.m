...
{
  GEOCompanionFerryStep *v2;
  GEOCompanionFerryStep *v3;
  GEOCompanionFerryStep *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOCompanionFerryStep;
  v2 = -[GEOCompanionFerryStep init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOCompanionFerryStep)initWithData:(id)a3
{
  GEOCompanionFerryStep *v3;
  GEOCompanionFerryStep *v4;
  GEOCompanionFerryStep *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOCompanionFerryStep;
  v3 = -[GEOCompanionFerryStep initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  -[GEOCompanionFerryStep clearJunctionElements](self, "clearJunctionElements");
  v3.receiver = self;
  v3.super_class = (Class)GEOCompanionFerryStep;
  -[GEOCompanionFerryStep dealloc](&v3, sel_dealloc);
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 84) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readJunctionElements_tags_226);
        objc_sync_exit(v3);
...
LABEL_12:
    if (16 * v9 < v9)
      return 0;
    result = (uint64_t)malloc_type_realloc(*(void **)(a1 + 16), 16 * v9, 0x5B1193B4uLL);
    if (result)
    {
      *(_QWORD *)(a1 + 32) = v9;
      *(_QWORD *)(a1 + 16) = result;
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 84) & 0x10) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readManeuverNames_tags_227);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 84) & 0x20) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSignposts_tags_228);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 84) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readArtworkOverride_tags_229);
        objc_sync_exit(v3);
...
- (NSString)description
{
  ...
  -[GEOCompanionFerryStep description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOCompanionFerryStep dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_135:
  ...
  {
    v10 = v9;
    if ((objc_msgSend(v10, "isEqualToString:", CFSTR("JCTTYPE_NORMAL")) & 1) != 0)
      v11 = 0;
    else
      v11 = objc_msgSend(v10, "isEqualToString:", CFSTR("JCTTYPE_ROUNDABOUT"));
...
LABEL_142:
    objc_msgSend(a1, "setJunctionType:", v11);
  }
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v50 = 0u;
    v20 = v19;
    v21 = objc_msgSend(v20, "countByEnumeratingWithState:objects:count:", &v49, v60, 16);
    if (v21)
    {
      v22 = v21;
      v23 = *(_QWORD *)v50;
      do
      {
        for (j = 0; j != v22; ++j)
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            ...
            if ((a3 & 1) != 0)
              v27 = -[GEONameInfoList initWithJSON:](v26, "initWithJSON:", v25);
            else
              v27 = -[GEONameInfoList initWithDictionary:](v26, "initWithDictionary:", v25);
            v28 = (void *)v27;
            objc_msgSend(a1, "addManeuverName:", v27);

          }
        }
        v22 = objc_msgSend(v20, "countByEnumeratingWithState:objects:count:", &v49, v60, 16);
      }
      while (v22);
    }
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v46 = 0u;
    v30 = v29;
    v31 = objc_msgSend(v30, "countByEnumeratingWithState:objects:count:", &v45, v59, 16);
    if (v31)
    {
      v32 = v31;
      v33 = *(_QWORD *)v46;
      do
      {
        for (k = 0; k != v32; ++k)
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            ...
            v38 = (void *)v37;
            objc_msgSend(a1, "addSignpost:", v37);

          }
        }
        v32 = objc_msgSend(v30, "countByEnumeratingWithState:objects:count:", &v45, v59, 16);
      }
      while (v32);
    }
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    v40 = [GEOPBTransitArtwork alloc];
    if ((a3 & 1) != 0)
      v41 = -[GEOPBTransitArtwork initWithJSON:](v40, "initWithJSON:", v39);
    else
      v41 = -[GEOPBTransitArtwork initWithDictionary:](v40, "initWithDictionary:", v39);
    v42 = (void *)v41;
    objc_msgSend(a1, "setArtworkOverride:", v41);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_230;
    else
      v8 = (int *)&readAll__nonRecursiveTag_231;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOCompanionFerryStep readAll:](self, "readAll:", 0);
    flags = (char)self->_flags;
    if ((flags & 2) != 0)
    {
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v18 + 17) = self->_readerMarkLength;
  ...
  if (-[GEOCompanionFerryStep junctionElementsCount](self, "junctionElementsCount"))
  {
    objc_msgSend(v18, "clearJunctionElements");
    v5 = -[GEOCompanionFerryStep junctionElementsCount](self, "junctionElementsCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        v8 = -[GEOCompanionFerryStep junctionElementAtIndex:](self, "junctionElementAtIndex:", i);
        objc_msgSend(v18, "addJunctionElement:", v8, v9);
      }
    }
  }
  if (-[GEOCompanionFerryStep maneuverNamesCount](self, "maneuverNamesCount"))
  {
    objc_msgSend(v18, "clearManeuverNames");
    v10 = -[GEOCompanionFerryStep maneuverNamesCount](self, "maneuverNamesCount");
    if (v10)
    {
      v11 = v10;
      for (j = 0; j != v11; ++j)
      {
        -[GEOCompanionFerryStep maneuverNameAtIndex:](self, "maneuverNameAtIndex:", j);
  ...
  if (-[GEOCompanionFerryStep signpostsCount](self, "signpostsCount"))
  {
    objc_msgSend(v18, "clearSignposts");
    v14 = -[GEOCompanionFerryStep signpostsCount](self, "signpostsCount");
    if (v14)
    {
      v15 = v14;
      for (k = 0; k != v15; ++k)
      {
        -[GEOCompanionFerryStep signpostAtIndex:](self, "signpostAtIndex:", k);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_14;
  -[GEOCompanionFerryStep readAll:](self, "readAll:", 1);
  ...
  if (v12)
  {
    ...
    do
    {
      for (j = 0; j != v13; ++j)
      {
        if (*(_QWORD *)v28 != v14)
          objc_enumerationMutation(v11);
        -[GEOCompanionFerryStep addManeuverName:](self, "addManeuverName:", *(_QWORD *)(*((_QWORD *)&v27 + 1) + 8 * j));
      }
  ...
  if (v17)
  {
    ...
    do
    {
      for (k = 0; k != v18; ++k)
      {
        if (*(_QWORD *)v24 != v19)
          objc_enumerationMutation(v16);
        -[GEOCompanionFerryStep addSignpost:](self, "addSignpost:", *(_QWORD *)(*((_QWORD *)&v23 + 1) + 8 * k), (_QWORD)v23);
      }
