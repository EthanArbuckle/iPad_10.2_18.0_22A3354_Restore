...
- (GEOPDChargerInfo)init
{
  ...
  v2 = -[GEOPDChargerInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDChargerInfo)initWithData:(id)a3
{
  ...
  v3 = -[GEOPDChargerInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDChargerInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAvailableChargerIds_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDChargerInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTotalChargerIds_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDChargerInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDChargerInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (*(_QWORD *)(a1 + 24))
  {
    -[GEOPDChargerInfo availableChargerIds]((id *)a1);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v6 = CFSTR("availableChargerId");
    else
      v6 = CFSTR("available_charger_id");
    objc_msgSend(v4, "setObject:forKey:", v5, v6);

  }
  if (*(_QWORD *)(a1 + 32))
  {
    -[GEOPDChargerInfo totalChargerIds]((id *)a1);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v8 = CFSTR("totalChargerId");
    else
      v8 = CFSTR("total_charger_id");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_1131;
      else
        v6 = (int *)&readAll__nonRecursiveTag_1132;
      GEOPDChargerInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
{
  _QWORD *v4;
  NSMutableArray *availableChargerIds;
  NSMutableArray *totalChargerIds;
  char v7;
     ...
     || -[NSMutableArray isEqual:](availableChargerIds, "isEqual:")))
  {
    ...
    if ((unint64_t)totalChargerIds | v4[4])
      v7 = -[NSMutableArray isEqual:](totalChargerIds, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDChargerInfo readAll:]((uint64_t)self, 1);
  v3 = -[NSMutableArray hash](self->_availableChargerIds, "hash");
  return -[NSMutableArray hash](self->_totalChargerIds, "hash") ^ v3;
}
