...
- (id)description
{
  ...
  -[GEORPProblemCollectionResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPProblemCollectionResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEORPProblemCollectionResponse readAll:](self, "readAll:", 0);
  v4 = v5;
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_9;
  -[GEORPProblemCollectionResponse readAll:](self, "readAll:", 1);
...
LABEL_9:
  ...
  if ((unint64_t)problemId | *((_QWORD *)v4 + 1))
    v6 = -[NSString isEqual:](problemId, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    ...
    v3 = 0;
  return -[NSString hash](self->_problemId, "hash") ^ v3;
}
