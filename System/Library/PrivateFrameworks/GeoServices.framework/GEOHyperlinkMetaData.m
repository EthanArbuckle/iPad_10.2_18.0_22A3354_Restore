...
- (int)StringAsHyperlinkType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("PERSONAL_COLLECTION")) & 1) != 0)
  {
    v4 = 0;
  }
  ...
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("POI_CONTAINMENT")) & 1) != 0)
  {
    v4 = 2;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("TAPPABLE_ENTITY")) & 1) != 0)
  {
    v4 = 3;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("NON_TAPPABLE_ENTITY")))
  {
    v4 = 4;
  }
  else
...
- (id)description
{
  ...
  -[GEOHyperlinkMetaData description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOHyperlinkMetaData dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 20) & 1) != 0)
    {
      ...
      {
        v6 = (void *)*((_QWORD *)&off_1E1C14A50 + v5);
      }
      if (a2)
        v7 = CFSTR("hyperlinkType");
      else
        v7 = CFSTR("hyperlink_type");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (!a1)
    goto LABEL_28;
  if (a3)
    v6 = CFSTR("hyperlinkType");
  else
    v6 = CFSTR("hyperlink_type");
  ...
  {
    v8 = v7;
    if ((objc_msgSend(v8, "isEqualToString:", CFSTR("PERSONAL_COLLECTION")) & 1) != 0)
    {
      v9 = 0;
    }
    else if ((objc_msgSend(v8, "isEqualToString:", CFSTR("CURATED_COLLECTION")) & 1) != 0)
    {
      v9 = 1;
    }
    else if ((objc_msgSend(v8, "isEqualToString:", CFSTR("POI_CONTAINMENT")) & 1) != 0)
    {
      v9 = 2;
    }
    else if ((objc_msgSend(v8, "isEqualToString:", CFSTR("TAPPABLE_ENTITY")) & 1) != 0)
    {
      v9 = 3;
    }
    else if (objc_msgSend(v8, "isEqualToString:", CFSTR("NON_TAPPABLE_ENTITY")))
    {
      v9 = 4;
    }
    else
...
LABEL_21:
    objc_msgSend(a1, "setHyperlinkType:", v9);
  }
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOHyperlinkMetaData readAll:](self, "readAll:", 0);
  v4 = v5;
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_9;
  -[GEOHyperlinkMetaData readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_hyperlinkType != *((_DWORD *)v4 + 4))
      goto LABEL_9;
  }
...
- (unint64_t)hash
{
  ...
  -[GEOHyperlinkMetaData readAll:](self, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v3 = 2654435761 * self->_hyperlinkType;
  else
    v3 = 0;
