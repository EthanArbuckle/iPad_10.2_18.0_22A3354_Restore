...
- (id)description
{
  ...
  -[GEOPDTripLink description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDTripLink dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (v7)
  {
    if ((a2 & 1) != 0)
    {
      ...
      objc_msgSend(v4, "setObject:forKey:", v9, CFSTR("linkGeometry"));

    }
    else
    {
      objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("link_geometry"));
    }
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_QWORD *)(v5 + 24) = self->_linkId;
    *(_BYTE *)(v5 + 32) |= 1u;
  }
  v7 = -[NSData copyWithZone:](self->_linkGeometry, "copyWithZone:", a3);
  v8 = *(void **)(v6 + 16);
  *(_QWORD *)(v6 + 16) = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_linkId != *((_QWORD *)v4 + 3))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  if ((unint64_t)linkGeometry | *((_QWORD *)v4 + 2))
    v6 = -[NSData isEqual:](linkGeometry, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v2 = 2654435761u * self->_linkId;
  else
    v2 = 0;
  return -[NSData hash](self->_linkGeometry, "hash") ^ v2;
}
