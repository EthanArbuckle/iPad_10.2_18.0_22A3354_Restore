...
- (GEOLPRPowerType)init
{
  ...
  v2 = -[GEOLPRPowerType init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOLPRPowerType)initWithData:(id)a3
{
  ...
  v3 = -[GEOLPRPowerType initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 1) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLPRPowerTypeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readKey_tags_3);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 8) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLPRPowerTypeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTitles_tags_1);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLPRPowerTypeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSubtitles_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 60) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLPRPowerTypeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSubtypes_tags);
        objc_sync_exit(v3);
...
- (void)clearSubtypes
{
  ...
  *(_BYTE *)&self->_flags |= 4u;
  os_unfair_lock_unlock(p_readerLock);
  *(_BYTE *)&self->_flags |= 0x10u;
  -[NSMutableArray removeAllObjects](self->_subtypes, "removeAllObjects");
}
...
{
  -[GEOLPRPowerType _readSubtypes]((uint64_t)self);
  return -[NSMutableArray count](self->_subtypes, "count");
}

- (id)subtypesAtIndex:(unint64_t)a3
{
  -[GEOLPRPowerType _readSubtypes]((uint64_t)self);
  return (id)-[NSMutableArray objectAtIndex:](self->_subtypes, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOLPRPowerType description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLPRPowerType dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(id *)a1
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", objc_msgSend(a1[5], "count"));
    v39 = 0u;
    v40 = 0u;
    v41 = 0u;
    v42 = 0u;
  ...
  if (objc_msgSend(a1[4], "count"))
  {
    ...
    if (v24)
    {
      ...
      do
      {
        for (k = 0; k != v25; ++k)
        {
          ...
          v28 = *(void **)(*((_QWORD *)&v31 + 1) + 8 * k);
          if ((a2 & 1) != 0)
            objc_msgSend(v28, "jsonRepresentation");
          else
            objc_msgSend(v28, "dictionaryRepresentation", (_QWORD)v31);
          v29 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v22, "addObject:", v29, (_QWORD)v31);
    ...
    objc_msgSend(v4, "setObject:forKey:", v22, CFSTR("subtypes"));
  }
  return v4;
}
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("subtypes"));
        ...
        if (v30)
        {
          ...
          do
          {
            for (k = 0; k != v31; ++k)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                v35 = [GEOLPRPowerType alloc];
                if ((a3 & 1) != 0)
                  v36 = -[GEOLPRPowerType initWithJSON:](v35, "initWithJSON:", v34);
                else
                  v36 = -[GEOLPRPowerType initWithDictionary:](v35, "initWithDictionary:", v34);
                v37 = (void *)v36;
                objc_msgSend(a1, "addSubtypes:", v36);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_192;
    else
      v8 = (int *)&readAll__nonRecursiveTag_193;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOLPRPowerType readAll:](self, "readAll:", 0);
    if (self->_key)
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v16 + 13) = self->_readerMarkLength;
  ...
  if (-[GEOLPRPowerType titlesCount](self, "titlesCount"))
  {
    objc_msgSend(v16, "clearTitles");
    v4 = -[GEOLPRPowerType titlesCount](self, "titlesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOLPRPowerType titleAtIndex:](self, "titleAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v16, "addTitle:", v7);

      }
    }
  }
  if (-[GEOLPRPowerType subtitlesCount](self, "subtitlesCount"))
  {
    objc_msgSend(v16, "clearSubtitles");
    v8 = -[GEOLPRPowerType subtitlesCount](self, "subtitlesCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[GEOLPRPowerType subtitleAtIndex:](self, "subtitleAtIndex:", j);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v16, "addSubtitle:", v11);

      }
    }
  }
  if (-[GEOLPRPowerType subtypesCount](self, "subtypesCount"))
  {
    objc_msgSend(v16, "clearSubtypes");
    v12 = -[GEOLPRPowerType subtypesCount](self, "subtypesCount");
    if (v12)
    {
      v13 = v12;
      for (k = 0; k != v13; ++k)
      {
        -[GEOLPRPowerType subtypesAtIndex:](self, "subtypesAtIndex:", k);
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v16, "addSubtypes:", v15);
  ...
  if (v21)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addSubtypes:", v24);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOLPRPowerType readAll:](self, "readAll:", 1),
     ...
     || -[NSMutableArray isEqual:](subtitles, "isEqual:")))
  {
    ...
    if ((unint64_t)subtypes | v4[4])
      v9 = -[NSMutableArray isEqual:](subtypes, "isEqual:");
    else
      v9 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v5 = -[NSMutableArray hash](self->_subtitles, "hash");
  return v4 ^ v5 ^ -[NSMutableArray hash](self->_subtypes, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[GEOLPRPowerType addTitle:](self, "addTitle:", *(_QWORD *)(*((_QWORD *)&v28 + 1) + 8 * i));
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        if (*(_QWORD *)v25 != v13)
          objc_enumerationMutation(v10);
        -[GEOLPRPowerType addSubtitle:](self, "addSubtitle:", *(_QWORD *)(*((_QWORD *)&v24 + 1) + 8 * j));
      }
  ...
  if (v16)
  {
    ...
    do
    {
      for (k = 0; k != v17; ++k)
      {
        if (*(_QWORD *)v21 != v18)
          objc_enumerationMutation(v15);
        -[GEOLPRPowerType addSubtypes:](self, "addSubtypes:", *(_QWORD *)(*((_QWORD *)&v20 + 1) + 8 * k), (_QWORD)v20);
      }
