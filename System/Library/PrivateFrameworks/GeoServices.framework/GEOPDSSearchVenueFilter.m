...
- (void)clearUnknownFields:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    *(_QWORD *)(a1 + 8) = 0;
    ...
    if (a2)
      -[GEOPDVenueIdentifier clearUnknownFields:](*(_QWORD *)(a1 + 16), 1);
  }
}
...
- (id)description
{
  ...
  -[GEOPDSSearchVenueFilter description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSSearchVenueFilter dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (v5)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v8 = CFSTR("venueFilter");
    }
    else
    {
      objc_msgSend(v5, "dictionaryRepresentation");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = CFSTR("venue_filter");
    }
  ...
  if ((*(_BYTE *)(a1 + 28) & 1) != 0)
  {
    ...
    {
      v10 = off_1E1C05A88[v9];
    }
    if (a2)
      v11 = CFSTR("venueSearchType");
    else
      v11 = CFSTR("venue_search_type");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[GEOPDVenueIdentifier copyWithZone:](self->_venueFilter, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)venueFilter | *((_QWORD *)v4 + 2))
  {
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) != 0 && self->_venueSearchType == *((_DWORD *)v4 + 6))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  ...
  v3 = -[GEOPDVenueIdentifier hash](self->_venueFilter, "hash");
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_venueSearchType;
  else
    v4 = 0;
  return v4 ^ v3;
}
