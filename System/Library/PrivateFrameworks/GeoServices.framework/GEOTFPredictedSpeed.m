...
- (id)description
{
  ...
  -[GEOTFPredictedSpeed description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTFPredictedSpeed dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((v5 & 2) != 0)
    {
      ...
      objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("speed"));
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_speed != *((_DWORD *)v4 + 3))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
