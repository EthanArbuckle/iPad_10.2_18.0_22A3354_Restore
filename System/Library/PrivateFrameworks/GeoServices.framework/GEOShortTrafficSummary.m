...
{
  GEOShortTrafficSummary *v2;
  GEOShortTrafficSummary *v3;
  GEOShortTrafficSummary *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOShortTrafficSummary;
  v2 = -[GEOShortTrafficSummary init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOShortTrafficSummary)initWithData:(id)a3
{
  GEOShortTrafficSummary *v3;
  GEOShortTrafficSummary *v4;
  GEOShortTrafficSummary *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOShortTrafficSummary;
  v3 = -[GEOShortTrafficSummary initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v4)
      {
        v5 = v4;
        objc_sync_enter(v5);
        GEOShortTrafficSummaryReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTitles_tags_2);
        objc_sync_exit(v5);
...
- (id)description
{
  ...
  -[GEOShortTrafficSummary description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOShortTrafficSummary dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 52) & 2) == 0)
  {
    ...
    if (v12)
    {
      v13 = v12;
      objc_sync_enter(v13);
      GEOShortTrafficSummaryReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readDetail_tags_2);
      objc_sync_exit(v13);
  ...
  if (v14)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v16, CFSTR("detail"));
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_1633;
      else
        v6 = (int *)&readAll__nonRecursiveTag_1634;
      GEOShortTrafficSummaryReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v13 = -[GEOFormattedString copyWithZone:](self->_detail, "copyWithZone:", a3);
  v14 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v13;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](titles, "isEqual:")))
  {
    ...
    if ((unint64_t)detail | v4[3])
      v7 = -[GEOFormattedString isEqual:](detail, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[GEOFormattedString hash](self->_detail, "hash") ^ v3;
}
