...
- (id)description
{
  ...
  -[GEORPClientCapabilities description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPClientCapabilities dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 2) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("hasConstrainedProblemStatusSize");
    else
      v7 = CFSTR("has_constrained_problem_status_size");
  ...
  if ((v5 & 8) != 0)
  {
    ...
    if (a2)
      v9 = CFSTR("hasNoOptInRequest");
    else
      v9 = CFSTR("has_no_opt_in_request");
...
LABEL_9:
  ...
  if (a2)
    v11 = CFSTR("hasFeatureHandle");
  else
    v11 = CFSTR("has_feature_handle");
...
LABEL_20:
  ...
  if (a2)
    v13 = CFSTR("hasSupportForIdsBasedNotifications");
  else
    v13 = CFSTR("has_support_for_ids_based_notifications");
...
LABEL_24:
    ...
    {
      v15 = off_1E1C0EA90[v14];
    }
    if (a2)
      v16 = CFSTR("transitMarketSupport");
    else
      v16 = CFSTR("transit_market_support");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("hasConstrainedProblemStatusSize");
      else
        v6 = CFSTR("has_constrained_problem_status_size");
      ...
      if (a3)
        v8 = CFSTR("hasNoOptInRequest");
      else
        v8 = CFSTR("has_no_opt_in_request");
      ...
      if (a3)
        v10 = CFSTR("hasFeatureHandle");
      else
        v10 = CFSTR("has_feature_handle");
      ...
      if (a3)
        v12 = CFSTR("hasSupportForIdsBasedNotifications");
      else
        v12 = CFSTR("has_support_for_ids_based_notifications");
      ...
      if (a3)
        v14 = CFSTR("transitMarketSupport");
      else
        v14 = CFSTR("transit_market_support");
      ...
      {
        v16 = v15;
        if ((objc_msgSend(v16, "isEqualToString:", CFSTR("VERSION_1")) & 1) != 0)
        {
          v17 = 1;
        }
        else if ((objc_msgSend(v16, "isEqualToString:", CFSTR("VERSION_2")) & 1) != 0)
        {
          v17 = 2;
        }
        else if (objc_msgSend(v16, "isEqualToString:", CFSTR("VERSION_3")))
        {
          v17 = 3;
        }
        else
...
LABEL_38:
      ...
      objc_msgSend(a1, "setTransitMarketSupport:", v17);
      goto LABEL_38;
    }
  }
LABEL_39:
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEORPClientCapabilities readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((flags & 2) != 0)
  {
    *((_BYTE *)result + 12) = self->_hasConstrainedProblemStatusSize;
    *((_BYTE *)result + 16) |= 2u;
    flags = (char)self->_flags;
    if ((flags & 8) == 0)
    {
LABEL_3:
  ...
  *((_BYTE *)result + 14) = self->_hasNoOptInRequest;
  *((_BYTE *)result + 16) |= 8u;
  flags = (char)self->_flags;
  if ((flags & 4) == 0)
  {
...
LABEL_10:
  *((_BYTE *)result + 13) = self->_hasFeatureHandle;
  *((_BYTE *)result + 16) |= 4u;
  flags = (char)self->_flags;
  if ((flags & 0x10) == 0)
  {
...
LABEL_11:
  *((_BYTE *)result + 15) = self->_hasSupportForIdsBasedNotifications;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_38;
  -[GEORPClientCapabilities readAll:](self, "readAll:", 1);
...
LABEL_34:
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_transitMarketSupport != *((_DWORD *)v4 + 2))
      goto LABEL_38;
    v5 = 1;
  }
LABEL_39:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    v3 = 2654435761 * self->_hasConstrainedProblemStatusSize;
    if ((*(_BYTE *)&self->_flags & 8) != 0)
    {
LABEL_3:
      v4 = 2654435761 * self->_hasNoOptInRequest;
      if ((*(_BYTE *)&self->_flags & 4) != 0)
        goto LABEL_4;
      goto LABEL_9;
    }
  ...
  {
LABEL_4:
    v5 = 2654435761 * self->_hasFeatureHandle;
    if ((*(_BYTE *)&self->_flags & 0x10) != 0)
      goto LABEL_5;
LABEL_10:
    v6 = 0;
...
LABEL_9:
  ...
  if ((*(_BYTE *)&self->_flags & 0x10) == 0)
    goto LABEL_10;
LABEL_5:
  v6 = 2654435761 * self->_hasSupportForIdsBasedNotifications;
  if ((*(_BYTE *)&self->_flags & 1) == 0)
    goto LABEL_11;
LABEL_6:
  v7 = 2654435761 * self->_transitMarketSupport;
  return v4 ^ v3 ^ v5 ^ v6 ^ v7;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v4 & 2) != 0)
  {
    self->_hasConstrainedProblemStatusSize = *((_BYTE *)v5 + 12);
    *(_BYTE *)&self->_flags |= 2u;
    v4 = *((_BYTE *)v5 + 16);
    if ((v4 & 8) == 0)
    {
LABEL_3:
  ...
  else if ((*((_BYTE *)v5 + 16) & 8) == 0)
  {
    goto LABEL_3;
  }
  self->_hasNoOptInRequest = *((_BYTE *)v5 + 14);
  *(_BYTE *)&self->_flags |= 8u;
  v4 = *((_BYTE *)v5 + 16);
  if ((v4 & 4) == 0)
  {
LABEL_4:
    if ((v4 & 0x10) == 0)
      goto LABEL_5;
LABEL_11:
    self->_hasSupportForIdsBasedNotifications = *((_BYTE *)v5 + 15);
    *(_BYTE *)&self->_flags |= 0x10u;
    if ((*((_BYTE *)v5 + 16) & 1) == 0)
      goto LABEL_7;
    goto LABEL_6;
...
LABEL_10:
  self->_hasFeatureHandle = *((_BYTE *)v5 + 13);
  *(_BYTE *)&self->_flags |= 4u;
  v4 = *((_BYTE *)v5 + 16);
  if ((v4 & 0x10) != 0)
    goto LABEL_11;
