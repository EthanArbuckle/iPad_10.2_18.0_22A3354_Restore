...
- (GEORPSourceInfo)init
{
  ...
  v2 = -[GEORPSourceInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPSourceInfo)initWithData:(id)a3
{
  ...
  v3 = -[GEORPSourceInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPSourceInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSourceApplication_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPSourceInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSourceUrl_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPSourceInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPSourceInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  {
    if (a2)
      v6 = CFSTR("sourceApplication");
    else
      v6 = CFSTR("source_application");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setSourceApplication:", v8);
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setSourceUrl:", v11);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_2931;
    else
      v8 = (int *)&readAll__nonRecursiveTag_2932;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEORPSourceInfo readAll:](self, "readAll:", 0);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPSourceInfo readAll:](self, "readAll:", 0);
    v8 = -[NSString copyWithZone:](self->_sourceApplication, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;

    v10 = -[NSString copyWithZone:](self->_sourceUrl, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPSourceInfo readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](sourceApplication, "isEqual:")))
  {
    ...
    if ((unint64_t)sourceUrl | v4[4])
      v7 = -[NSString isEqual:](sourceUrl, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEORPSourceInfo readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_sourceApplication, "hash");
  return -[NSString hash](self->_sourceUrl, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPSourceInfoReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_2935);
      objc_sync_exit(v5);
