...
- (id)description
{
  ...
  -[GEORoutingSettingsVirtualGarageSetttings description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORoutingSettingsVirtualGarageSetttings dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((v5 & 1) != 0)
    {
      ...
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      if (a2)
        v7 = CFSTR("electronicVehicleCount");
      else
        v7 = CFSTR("electronic_vehicle_count");
    ...
    if ((v5 & 2) != 0)
    {
      ...
      if (a2)
        v9 = CFSTR("licensePlateCount");
      else
        v9 = CFSTR("license_plate_count");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("electronicVehicleCount");
      else
        v6 = CFSTR("electronic_vehicle_count");
      ...
      if (a3)
        v8 = CFSTR("licensePlateCount");
      else
        v8 = CFSTR("license_plate_count");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEORoutingSettingsVirtualGarageSetttings readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEORoutingSettingsVirtualGarageSetttings readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_electronicVehicleCount != *((_DWORD *)v4 + 2))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_licensePlateCount != *((_DWORD *)v4 + 3))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    v3 = 2654435761 * self->_electronicVehicleCount;
    if ((*(_BYTE *)&self->_flags & 2) != 0)
      goto LABEL_3;
LABEL_5:
    v4 = 0;
  ...
  if ((*(_BYTE *)&self->_flags & 2) == 0)
    goto LABEL_5;
LABEL_3:
  v4 = 2654435761 * self->_licensePlateCount;
  return v4 ^ v3;
}
