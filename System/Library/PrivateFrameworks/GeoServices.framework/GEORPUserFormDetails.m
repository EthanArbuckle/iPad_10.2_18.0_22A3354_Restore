...
- (id)userFormStyleAsString:(int)a3
{
  ...
  if (!a3)
    return CFSTR("RAP_RESPONSE_USER_FORM_STYLE_UNKNOWN");
  if (a3 == 1)
  {
    v3 = CFSTR("RAP_RESPONSE_USER_FORM_STYLE_PHOTOS_COMMENTS");
  }
  else
  {
...
- (int)StringAsUserFormStyle:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("RAP_RESPONSE_USER_FORM_STYLE_UNKNOWN")) & 1) != 0)
    v4 = 0;
  else
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("RAP_RESPONSE_USER_FORM_STYLE_PHOTOS_COMMENTS"));
...
- (id)description
{
  ...
  -[GEORPUserFormDetails description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPUserFormDetails dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 20) & 1) != 0)
  {
    ...
    if (v5)
    {
      if (v5 == 1)
      {
        v6 = CFSTR("RAP_RESPONSE_USER_FORM_STYLE_PHOTOS_COMMENTS");
      }
      else
      {
    ...
    {
      v6 = CFSTR("RAP_RESPONSE_USER_FORM_STYLE_UNKNOWN");
    }
    if (a2)
      v7 = CFSTR("userFormStyle");
    else
      v7 = CFSTR("user_form_style");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("userFormStyle");
      else
        v6 = CFSTR("user_form_style");
      ...
      {
        v8 = v7;
        if ((objc_msgSend(v8, "isEqualToString:", CFSTR("RAP_RESPONSE_USER_FORM_STYLE_UNKNOWN")) & 1) != 0)
          v9 = 0;
        else
          v9 = objc_msgSend(v8, "isEqualToString:", CFSTR("RAP_RESPONSE_USER_FORM_STYLE_PHOTOS_COMMENTS"));
...
LABEL_14:
      ...
      objc_msgSend(a1, "setUserFormStyle:", v9);
      goto LABEL_14;
    }
  }
LABEL_15:
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEORPUserFormDetails readAll:](self, "readAll:", 0);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_6;
  -[GEORPUserFormDetails readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  v5 = (*((_BYTE *)v4 + 20) & 1) == 0;
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) != 0 && self->_userFormStyle == *((_DWORD *)v4 + 4))
    {
      v5 = 1;
      goto LABEL_7;
    }
