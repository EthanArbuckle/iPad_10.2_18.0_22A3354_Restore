...
{
  id v6;
  GEOExternalRequestCounterCountReply *v7;
  void *v8;
  size_t count;
  void *v10;
  size_t i;
  void *v12;
  GEOExternalRequestCounterInfo *v13;
  uint64_t v14;
  void *v15;
  GEOExternalRequestCounterCountReply *v16;
  objc_super v18;
  ...
  if (v7)
  {
    xpc_dictionary_get_array(v6, "objects");
    ...
    if (count)
    {
      for (i = 0; i != count; ++i)
      {
        ...
        if (v12)
        {
          v13 = -[GEOExternalRequestCounterInfo initWithXPCDictionary:error:]([GEOExternalRequestCounterInfo alloc], "initWithXPCDictionary:error:", v12, a4);
          if (v13)
