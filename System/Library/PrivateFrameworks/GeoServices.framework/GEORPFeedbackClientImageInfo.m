...
{
  GEORPFeedbackClientImageInfo *v2;
  GEORPFeedbackClientImageInfo *v3;
  GEORPFeedbackClientImageInfo *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPFeedbackClientImageInfo;
  v2 = -[GEORPFeedbackClientImageInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPFeedbackClientImageInfo)initWithData:(id)a3
{
  GEORPFeedbackClientImageInfo *v3;
  GEORPFeedbackClientImageInfo *v4;
  GEORPFeedbackClientImageInfo *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPFeedbackClientImageInfo;
  v3 = -[GEORPFeedbackClientImageInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPFeedbackClientImageInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readProviderImageId_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPFeedbackClientImageInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readImageUrl_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPFeedbackClientImageInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPFeedbackClientImageInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  {
    if (a2)
      v6 = CFSTR("providerImageId");
    else
      v6 = CFSTR("provider_image_id");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setProviderImageId:", v8);
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setImageUrl:", v11);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_806;
    else
      v8 = (int *)&readAll__nonRecursiveTag_807;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEORPFeedbackClientImageInfo readAll:](self, "readAll:", 0);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPFeedbackClientImageInfo readAll:](self, "readAll:", 0);
    v8 = -[NSString copyWithZone:](self->_providerImageId, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPFeedbackClientImageInfo readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](providerImageId, "isEqual:")))
  {
    ...
    if ((unint64_t)imageUrl | v4[3])
      v7 = -[NSString isEqual:](imageUrl, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEORPFeedbackClientImageInfo readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_providerImageId, "hash");
  return -[NSString hash](self->_imageUrl, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPFeedbackClientImageInfoReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_810);
      objc_sync_exit(v5);
