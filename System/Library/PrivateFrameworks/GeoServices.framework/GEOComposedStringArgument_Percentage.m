...
- (id)_stringReplacementWithOptions:(id)a3
{
    ...
    || v4 && v4[9] && -[GEOComposedStringArgument hasDefaultValue](self, "hasDefaultValue"))
  {
    ...
    objc_msgSend(v5, "setMultiplier:", &unk_1E1E81340);
    v6 = -[GEOComposedStringArgument hasOverrideValue](self, "hasOverrideValue");
    v8 = 1;
    if (!v6)
      v8 = 0;
    ...
    objc_msgSend(v5, "stringFromNumber:", v9);
...
{
  id v4;
  GEOComposedStringArgument_Percentage *v5;
  double v6;
  double v7;
  GEOComposedStringArgument_Percentage *v8;
  objc_super v10;
