...
{
  GEORPFeedbackSurveyResponse *v2;
  GEORPFeedbackSurveyResponse *v3;
  GEORPFeedbackSurveyResponse *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPFeedbackSurveyResponse;
  v2 = -[GEORPFeedbackSurveyResponse init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPFeedbackSurveyResponse)initWithData:(id)a3
{
  GEORPFeedbackSurveyResponse *v3;
  GEORPFeedbackSurveyResponse *v4;
  GEORPFeedbackSurveyResponse *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPFeedbackSurveyResponse;
  v3 = -[GEORPFeedbackSurveyResponse initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPFeedbackSurveyResponseReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readOptionId_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPFeedbackSurveyResponseReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readOptionDescription_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPFeedbackSurveyResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPFeedbackSurveyResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  objc_msgSend(a1, "optionDescription");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    if (a2)
      v8 = CFSTR("optionDescription");
    else
      v8 = CFSTR("option_description");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setOptionId:", v8);

      }
      if (a3)
        v9 = CFSTR("optionDescription");
      else
        v9 = CFSTR("option_description");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setOptionDescription:", v11);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_623;
    else
      v8 = (int *)&readAll__nonRecursiveTag_624;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEORPFeedbackSurveyResponse readAll:](self, "readAll:", 0);
    if (self->_optionId)
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPFeedbackSurveyResponse readAll:](self, "readAll:", 0);
    v8 = -[NSString copyWithZone:](self->_optionId, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v8;

    v10 = -[NSString copyWithZone:](self->_optionDescription, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPFeedbackSurveyResponse readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](optionId, "isEqual:")))
  {
    ...
    if ((unint64_t)optionDescription | v4[3])
      v7 = -[NSString isEqual:](optionDescription, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEORPFeedbackSurveyResponse readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_optionId, "hash");
  return -[NSString hash](self->_optionDescription, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPFeedbackSurveyResponseReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_627);
      objc_sync_exit(v5);
