...
- (void)dealloc
{
  ...
  -[GEOPDAmenityRibbonItem dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  -[GEOPDAmenityRibbonItem description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAmenityRibbonItem dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (*(_QWORD *)(a1 + 24))
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v6 = CFSTR("amenityItemIndex");
    else
      v6 = CFSTR("amenity_item_index");
