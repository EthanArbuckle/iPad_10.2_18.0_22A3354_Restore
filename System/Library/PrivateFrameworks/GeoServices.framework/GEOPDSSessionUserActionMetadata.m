...
{
  objc_storeStrong((id *)&self->_userActionMetadataElements, a3);
}

- (void)clearUserActionMetadataElements
{
  -[NSMutableArray removeAllObjects](self->_userActionMetadataElements, "removeAllObjects");
}
...
- (void)addUserActionMetadataElement:(id)a3
{
  ...
  -[NSMutableArray addObject:](userActionMetadataElements, "addObject:", v4);

}

- (unint64_t)userActionMetadataElementsCount
{
  return -[NSMutableArray count](self->_userActionMetadataElements, "count");
}

- (id)userActionMetadataElementAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_userActionMetadataElements, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOPDSSessionUserActionMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSSessionUserActionMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("userActionMetadataElement");
    else
      v13 = CFSTR("user_action_metadata_element");
...
- (void)_initWithDictionary:(uint64_t)a3 isJSON:
{
  ...
  uint64_t v12;
  uint64_t v13;
  GEOPDSUserActionMetadataElement *v14;
  void *v15;
  uint64_t v16;
  id v18;
  __int128 v19;
  ...
  if (a1)
  {
    ...
    {
      if ((_DWORD)a3)
        v6 = CFSTR("userActionMetadataElement");
      else
        v6 = CFSTR("user_action_metadata_element");
            ...
            do
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if (v14)
                  ...
                  v15 = 0;
                objc_msgSend(a1, "addUserActionMetadataElement:", v15);
...
- (void)writeTo:(id)a3
{
  ...
  v12 = 0u;
  v13 = 0u;
  v5 = self->_userActionMetadataElements;
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEOPDSSessionUserActionMetadata readAll:](self, "readAll:", 0);
  if (-[GEOPDSSessionUserActionMetadata userActionMetadataElementsCount](self, "userActionMetadataElementsCount"))
  {
    objc_msgSend(v8, "clearUserActionMetadataElements");
    v4 = -[GEOPDSSessionUserActionMetadata userActionMetadataElementsCount](self, "userActionMetadataElementsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOPDSSessionUserActionMetadata userActionMetadataElementAtIndex:](self, "userActionMetadataElementAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addUserActionMetadataElement:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v15 = 0u;
  v16 = 0u;
  v6 = self->_userActionMetadataElements;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addUserActionMetadataElement:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOPDSSessionUserActionMetadata readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    userActionMetadataElements = self->_userActionMetadataElements;
    if ((unint64_t)userActionMetadataElements | v4[2])
      v5 = -[NSMutableArray isEqual:](userActionMetadataElements, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOPDSSessionUserActionMetadata readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_userActionMetadataElements, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOPDSSessionUserActionMetadata addUserActionMetadataElement:](self, "addUserActionMetadataElement:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
