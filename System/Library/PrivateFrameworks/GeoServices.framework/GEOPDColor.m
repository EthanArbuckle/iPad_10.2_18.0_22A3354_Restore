...
- (id)description
{
  ...
  -[GEOPDColor description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDColor dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((*(_BYTE *)(a1 + 20) & 1) != 0)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("systemColor"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) != 0 && self->_systemColor == *((_DWORD *)v4 + 4))
    {
      v5 = 1;
      goto LABEL_7;
    }
