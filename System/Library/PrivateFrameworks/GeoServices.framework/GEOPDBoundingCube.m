...
{
  GEOPDBoundingCube *v2;
  GEOPDBoundingCube *v3;
  GEOPDBoundingCube *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDBoundingCube;
  v2 = -[GEOPDBoundingCube init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDBoundingCube)initWithData:(id)a3
{
  GEOPDBoundingCube *v3;
  GEOPDBoundingCube *v4;
  GEOPDBoundingCube *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDBoundingCube;
  v3 = -[GEOPDBoundingCube initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDBoundingCubeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readMin_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDBoundingCubeReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readMax_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDBoundingCube description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDBoundingCube dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("min"));

  }
  -[GEOPDBoundingCube max]((id *)a1);
  ...
  if (v8)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("max"));
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_621;
      else
        v6 = (int *)&readAll__nonRecursiveTag_622;
      GEOPDBoundingCubeReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOPDBoundingCube readAll:]((uint64_t)self, 0);
    v8 = -[GEOPDGeographicCoordinate copyWithZone:](self->_min, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v8;

    v10 = -[GEOPDGeographicCoordinate copyWithZone:](self->_max, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
{
  _QWORD *v4;
  GEOPDGeographicCoordinate *min;
  GEOPDGeographicCoordinate *max;
  char v7;
     ...
     || -[GEOPDGeographicCoordinate isEqual:](min, "isEqual:")))
  {
    ...
    if ((unint64_t)max | v4[3])
      v7 = -[GEOPDGeographicCoordinate isEqual:](max, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDBoundingCube readAll:]((uint64_t)self, 1);
  v3 = -[GEOPDGeographicCoordinate hash](self->_min, "hash");
  return -[GEOPDGeographicCoordinate hash](self->_max, "hash") ^ v3;
}
