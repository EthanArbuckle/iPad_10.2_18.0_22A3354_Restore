...
- (GEOABBranchInfo)init
{
  ...
  v2 = -[GEOABBranchInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOABBranchInfo)initWithData:(id)a3
{
  ...
  v3 = -[GEOABBranchInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOABBranchInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAbBranchId_tags_0);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOABBranchInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readMultilayerAbBranchId_tags);
        objc_sync_exit(v3);
...
{
  -[GEOABBranchInfo _readMultilayerAbBranchId]((uint64_t)self);
  return self->_multilayerAbBranchId;
}
...
- (id)description
{
  ...
  -[GEOABBranchInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOABBranchInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (v5)
  {
    if (a2)
      ...
      v6 = CFSTR("ab_branch_id");
    objc_msgSend(v4, "setObject:forKey:", v5, v6);
  }

  objc_msgSend(a1, "multilayerAbBranchId");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    if (a2)
      v8 = CFSTR("multilayerAbBranchId");
    else
      v8 = CFSTR("multilayer_ab_branch_id");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setAbBranchId:", v8);

      }
      if (a3)
        v9 = CFSTR("multilayerAbBranchId");
      else
        v9 = CFSTR("multilayer_ab_branch_id");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setMultilayerAbBranchId:", v11);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_275_1;
    else
      v8 = (int *)&readAll__nonRecursiveTag_276_1;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOABBranchInfo readAll:](self, "readAll:", 0);
    if (self->_abBranchId)
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOABBranchInfo readAll:](self, "readAll:", 0);
    v8 = -[NSString copyWithZone:](self->_abBranchId, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;

    v10 = -[NSString copyWithZone:](self->_multilayerAbBranchId, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOABBranchInfo readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](abBranchId, "isEqual:")))
  {
    ...
    if ((unint64_t)multilayerAbBranchId | v4[4])
      v7 = -[NSString isEqual:](multilayerAbBranchId, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOABBranchInfo readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_abBranchId, "hash");
  return -[NSString hash](self->_multilayerAbBranchId, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOABBranchInfoReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_279);
      objc_sync_exit(v5);
