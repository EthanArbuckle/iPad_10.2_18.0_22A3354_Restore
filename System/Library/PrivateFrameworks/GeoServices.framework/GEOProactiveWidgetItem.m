...
- (id)description
{
  ...
  -[GEOProactiveWidgetItem description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOProactiveWidgetItem dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 12) & 1) != 0)
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      if (a2)
        v6 = CFSTR("timeSinceStart");
      else
        v6 = CFSTR("time_since_start");
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOProactiveWidgetItem readAll:](self, "readAll:", 0);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_6;
  -[GEOProactiveWidgetItem readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  v5 = (*((_BYTE *)v4 + 12) & 1) == 0;
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_timeSinceStart == *((_DWORD *)v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
