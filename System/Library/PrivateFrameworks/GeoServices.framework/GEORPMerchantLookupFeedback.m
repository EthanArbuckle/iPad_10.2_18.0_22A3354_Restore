...
{
  GEORPMerchantLookupFeedback *v2;
  GEORPMerchantLookupFeedback *v3;
  GEORPMerchantLookupFeedback *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPMerchantLookupFeedback;
  v2 = -[GEORPMerchantLookupFeedback init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPMerchantLookupFeedback)initWithData:(id)a3
{
  GEORPMerchantLookupFeedback *v3;
  GEORPMerchantLookupFeedback *v4;
  GEORPMerchantLookupFeedback *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPMerchantLookupFeedback;
  v3 = -[GEORPMerchantLookupFeedback initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPMerchantLookupFeedbackReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readContext_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPMerchantLookupFeedbackReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCorrections_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPMerchantLookupFeedback description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPMerchantLookupFeedback dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  id v5;
  void *v6;
  GEORPMerchantLookupContext *v7;
  uint64_t v8;
  void *v9;
  void *v10;
  GEORPMerchantLookupCorrections *v11;
  uint64_t v12;
  void *v13;
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      {
        v7 = [GEORPMerchantLookupContext alloc];
        if ((a3 & 1) != 0)
          v8 = -[GEORPMerchantLookupContext initWithJSON:](v7, "initWithJSON:", v6);
        else
          v8 = -[GEORPMerchantLookupContext initWithDictionary:](v7, "initWithDictionary:", v6);
        v9 = (void *)v8;
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if ((a3 & 1) != 0)
          v12 = -[GEORPMerchantLookupCorrections initWithJSON:](v11, "initWithJSON:", v10);
        else
          v12 = -[GEORPMerchantLookupCorrections initWithDictionary:](v11, "initWithDictionary:", v10);
        v13 = (void *)v12;
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_2330;
    else
      v8 = (int *)&readAll__nonRecursiveTag_2331;
  ...
  if (v3)
  {
    -[GEORPMerchantLookupContext readAll:](self->_context, "readAll:", 1);
    -[GEORPMerchantLookupCorrections readAll:](self->_corrections, "readAll:", 1);
  }
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEORPMerchantLookupFeedback readAll:](self, "readAll:", 0);
    if (self->_context)
...
{
  GEORPMerchantLookupFeedbackClearSensitiveFields(self, a3, 1);
}
...
- (BOOL)hasGreenTeaWithValue:(BOOL)a3
{
  ...
  v3 = a3;
  -[GEORPMerchantLookupFeedback _readContext]((uint64_t)self);
  return -[GEORPMerchantLookupContext hasGreenTeaWithValue:](self->_context, "hasGreenTeaWithValue:", v3);
}
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEORPMerchantLookupFeedback readAll:](self, "readAll:", 0);
    v8 = -[GEORPMerchantLookupContext copyWithZone:](self->_context, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;

    v10 = -[GEORPMerchantLookupCorrections copyWithZone:](self->_corrections, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPMerchantLookupFeedback readAll:](self, "readAll:", 1),
     ...
     || -[GEORPMerchantLookupContext isEqual:](context, "isEqual:")))
  {
    ...
    if ((unint64_t)corrections | v4[4])
      v7 = -[GEORPMerchantLookupCorrections isEqual:](corrections, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEORPMerchantLookupFeedback readAll:](self, "readAll:", 1);
  v3 = -[GEORPMerchantLookupContext hash](self->_context, "hash");
  return -[GEORPMerchantLookupCorrections hash](self->_corrections, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPMerchantLookupFeedbackReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_2334);
      objc_sync_exit(v5);
