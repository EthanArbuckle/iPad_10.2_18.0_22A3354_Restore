...
+ (id)transitTripStopTimeForPlaceData:(id)a3
{
  ...
  v6[3] = &unk_1E1C09718;
  v6[4] = &v7;
  objc_msgSend(v3, "enumerateValidComponentValuesOfType:usingBlock:", 68, v6);
  v4 = (id)v8[5];
...
void __77__GEOPDTransitTripStopTime_PlaceDataExtras__transitTripStopTimeForPlaceData___block_invoke(uint64_t a1, id *a2, BOOL *a3)
{
  ...
  -[GEOPDComponentValue transitTripStopTime](a2);
...
- (id)description
{
  ...
  -[GEOPDTransitTripStopTime description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDTransitTripStopTime dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)departureSequences | v4[2])
      v6 = -[NSMutableArray isEqual:](departureSequences, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_departureSequences, "hash");
}
