...
- (id)description
{
  ...
  -[GEOPDBatchMerchantLookupBrandResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDBatchMerchantLookupBrandResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_24:
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v16 = CFSTR("merchantLookupBrandResult");
    else
      v16 = CFSTR("merchant_lookup_brand_result");
...
- (void)writeTo:(id)a3
{
  ...
  v10 = 0u;
  v11 = 0u;
  v5 = self->_merchantLookupBrandResults;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v14 = 0u;
  v15 = 0u;
  v7 = self->_merchantLookupBrandResults;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_statusCode != *((_DWORD *)v4 + 6))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  if ((unint64_t)merchantLookupBrandResults | *((_QWORD *)v4 + 2))
    v6 = -[NSMutableArray isEqual:](merchantLookupBrandResults, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    ...
    v2 = 0;
  return -[NSMutableArray hash](self->_merchantLookupBrandResults, "hash") ^ v2;
}
