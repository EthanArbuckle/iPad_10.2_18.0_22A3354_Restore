...
{
  objc_storeStrong((id *)&self->_departureEntrys, a3);
}

- (void)clearDepartureEntrys
{
  -[NSMutableArray removeAllObjects](self->_departureEntrys, "removeAllObjects");
}
...
- (void)addDepartureEntry:(id)a3
{
  ...
  -[NSMutableArray addObject:](departureEntrys, "addObject:", v4);

}

- (unint64_t)departureEntrysCount
{
  return -[NSMutableArray count](self->_departureEntrys, "count");
}

- (id)departureEntryAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_departureEntrys, "objectAtIndex:", a3);
}
...
- (NSString)description
{
  ...
  -[GEOTransitVehiclePositionInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOTransitVehiclePositionInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("departureEntry");
    else
      v13 = CFSTR("departure_entry");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("departureEntry");
      else
        v6 = CFSTR("departure_entry");
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v15 = -[GEOTransitDepartureEntry initWithJSON:](v14, "initWithJSON:", v13);
                else
                  v15 = -[GEOTransitDepartureEntry initWithDictionary:](v14, "initWithDictionary:", v13);
                v16 = (void *)v15;
                objc_msgSend(a1, "addDepartureEntry:", v15);
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEOTransitVehiclePositionInfo readAll:](self, "readAll:", 0);
  if (-[GEOTransitVehiclePositionInfo departureEntrysCount](self, "departureEntrysCount"))
  {
    objc_msgSend(v8, "clearDepartureEntrys");
    v4 = -[GEOTransitVehiclePositionInfo departureEntrysCount](self, "departureEntrysCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOTransitVehiclePositionInfo departureEntryAtIndex:](self, "departureEntryAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addDepartureEntry:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addDepartureEntry:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOTransitVehiclePositionInfo readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    departureEntrys = self->_departureEntrys;
    if ((unint64_t)departureEntrys | v4[2])
      v5 = -[NSMutableArray isEqual:](departureEntrys, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOTransitVehiclePositionInfo readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_departureEntrys, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOTransitVehiclePositionInfo addDepartureEntry:](self, "addDepartureEntry:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
...
- (unint64_t)firstTripID
{
  ...
  -[GEOTransitVehiclePositionInfo departureEntrys](self, "departureEntrys");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "firstObject");
  v3 = (void *)objc_claimAutoreleasedReturnValue();

  if (v3 && objc_msgSend(v3, "hasTripMuid"))
    v4 = objc_msgSend(v3, "tripMuid");
  else
...
- (unint64_t)tripIDForNextUpcomingDeparture
{
  ...
  v15 = 0u;
  v16 = 0u;
  -[GEOTransitVehiclePositionInfo departureEntrys](self, "departureEntrys", 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if (objc_msgSend(v10, "hasDepartureTime")
          && objc_msgSend(v10, "hasTripMuid")
          && v4 <= (double)objc_msgSend(v10, "departureTime"))
        {
          v11 = objc_msgSend(v10, "tripMuid");
          goto LABEL_15;
        }
      }
...
- (NSArray)tripIDs
{
  ...
  if (-[GEOTransitVehiclePositionInfo departureEntrysCount](self, "departureEntrysCount"))
  {
    -[GEOTransitVehiclePositionInfo departureEntrys](self, "departureEntrys");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithBlock:", &__block_literal_global_515);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "filteredArrayUsingPredicate:", v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v5, "valueForKey:", CFSTR("tripMuid"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return objc_msgSend(a2, "hasTripMuid");
}
...
- (NSArray)upcomingTripIDs
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99D68], "timeIntervalSinceReferenceDate");
    v4 = v3 - GEOConfigGetDouble(GeoServicesConfig_DepartureCutoffGracePeriodNetworkDefault, (uint64_t)off_1EDF4D5C8);
    -[GEOTransitVehiclePositionInfo departureEntrys](self, "departureEntrys");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    *(double *)&v10[4] = v4;
    ...
    objc_msgSend(v7, "valueForKey:", CFSTR("tripMuid"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
BOOL __74__GEOTransitVehiclePositionInfo_GEOTransitExtrasInternal__upcomingTripIDs__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  v4 = objc_msgSend(v3, "hasDepartureTime")
    && objc_msgSend(v3, "hasTripMuid")
    && *(double *)(a1 + 32) <= (double)objc_msgSend(v3, "departureTime");
