...
- (void)dealloc
{
  ...
  -[GEOLogMsgStateUGCPhoto dealloc](&v3, sel_dealloc);
}
...
{
  $27AAA0BB14FCB8642CC83DAEBE69EA4A *p_photoSources;
  unint64_t count;
  void *v6;
  uint64_t v7;
  void *v8;
  ...
  count = self->_photoSources.count;
  if (count <= a3)
  {
...
- (int)StringAsPhotoSources:(id)a3
{
  ...
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("TAKEN")))
  {
    v4 = 2;
  }
  else
...
- (id)description
{
  ...
  -[GEOLogMsgStateUGCPhoto description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLogMsgStateUGCPhoto dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (a1)
  {
    ...
    if (a1[2])
    {
      ...
      if (a2)
        v10 = CFSTR("photoSource");
      else
        v10 = CFSTR("photo_source");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("photoSource");
      else
        v6 = CFSTR("photo_source");
        ...
        while (1)
        {
          ...
          do
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              else if ((objc_msgSend(v14, "isEqualToString:", CFSTR("LIBRARY")) & 1) != 0)
              {
                v15 = 1;
              }
              else if (objc_msgSend(v14, "isEqualToString:", CFSTR("TAKEN")))
              {
                v15 = 2;
              }
              else
            ...
            objc_msgSend(a1, "addPhotoSource:", v15, v17, v18, (_QWORD)v19);
LABEL_24:
            ++v12;
          }
          while (v10 != v12);
...
- (void)copyTo:(id)a3
{
  ...
  v7 = a3;
  -[GEOLogMsgStateUGCPhoto readAll:](self, "readAll:", 0);
  if (-[GEOLogMsgStateUGCPhoto photoSourcesCount](self, "photoSourcesCount"))
  {
    objc_msgSend(v7, "clearPhotoSources");
    v4 = -[GEOLogMsgStateUGCPhoto photoSourcesCount](self, "photoSourcesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[GEOLogMsgStateUGCPhoto readAll:](self, "readAll:", 1);
...
- (void)mergeFrom:(id)a3
{
  ...
  v4 = objc_msgSend(v7, "photoSourcesCount");
  if (v4)
  {
    v5 = v4;
    for (i = 0; i != v5; ++i)
      -[GEOLogMsgStateUGCPhoto addPhotoSource:](self, "addPhotoSource:", objc_msgSend(v7, "photoSourceAtIndex:", i));
  }
