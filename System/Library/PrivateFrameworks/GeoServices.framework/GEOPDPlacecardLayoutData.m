...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_5808;
      else
        v6 = (int *)&readAll__nonRecursiveTag_5809;
      GEOPDPlacecardLayoutDataReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
{
  GEOPDPlacecardLayoutData *v2;
  GEOPDPlacecardLayoutData *v3;
  GEOPDPlacecardLayoutData *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDPlacecardLayoutData;
  v2 = -[GEOPDPlacecardLayoutData init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDPlacecardLayoutData)initWithData:(id)a3
{
  GEOPDPlacecardLayoutData *v3;
  GEOPDPlacecardLayoutData *v4;
  GEOPDPlacecardLayoutData *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDPlacecardLayoutData;
  v3 = -[GEOPDPlacecardLayoutData initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPlacecardLayoutDataReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readModuleConfigurations_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPlacecardLayoutDataReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLayoutConfiguration_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDPlacecardLayoutData description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPlacecardLayoutData dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    if (a2)
      v13 = CFSTR("moduleConfiguration");
    else
      v13 = CFSTR("module_configuration");
    objc_msgSend(v4, "setObject:forKey:", v5, v13);

  }
  -[GEOPDPlacecardLayoutData layoutConfiguration]((id *)a1);
  ...
  if (v14)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v17 = CFSTR("layoutConfiguration");
    }
    else
    {
      objc_msgSend(v14, "dictionaryRepresentation");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      v17 = CFSTR("layout_configuration");
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v13 = -[GEOPDPlacecardLayoutConfiguration copyWithZone:](self->_layoutConfiguration, "copyWithZone:", a3);
  v14 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v13;
...
{
  _QWORD *v4;
  NSMutableArray *moduleConfigurations;
     ...
     || -[NSMutableArray isEqual:](moduleConfigurations, "isEqual:")))
  {
    ...
    if ((unint64_t)layoutConfiguration | v4[3])
      v7 = -[GEOPDPlacecardLayoutConfiguration isEqual:](layoutConfiguration, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDPlacecardLayoutData readAll:]((uint64_t)self, 1);
  v3 = -[NSMutableArray hash](self->_moduleConfigurations, "hash");
  return -[GEOPDPlacecardLayoutConfiguration hash](self->_layoutConfiguration, "hash") ^ v3;
}
