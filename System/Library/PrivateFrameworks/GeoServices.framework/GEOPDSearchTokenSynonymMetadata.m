...
- (id)description
{
  ...
  -[GEOPDSearchTokenSynonymMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchTokenSynonymMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 8), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("synonymList"));
  }
  return v4;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)synonymLists | v4[1])
      v6 = -[NSMutableArray isEqual:](synonymLists, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_synonymLists, "hash");
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_synonymLists, 0);
}
