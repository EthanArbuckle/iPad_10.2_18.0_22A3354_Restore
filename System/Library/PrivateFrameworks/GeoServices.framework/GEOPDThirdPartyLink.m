...
{
  GEOPDThirdPartyLink *v2;
  GEOPDThirdPartyLink *v3;
  GEOPDThirdPartyLink *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDThirdPartyLink;
  v2 = -[GEOPDThirdPartyLink init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDThirdPartyLink)initWithData:(id)a3
{
  GEOPDThirdPartyLink *v3;
  GEOPDThirdPartyLink *v4;
  GEOPDThirdPartyLink *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDThirdPartyLink;
  v3 = -[GEOPDThirdPartyLink initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDThirdPartyLinkReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAdamId_tags_6727);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDThirdPartyLinkReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readUrl_tags_6728);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDThirdPartyLink description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDThirdPartyLink dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDThirdPartyLink adamId]((id *)a1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    if (a2)
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_6729;
      else
        v6 = (int *)&readAll__nonRecursiveTag_6730;
      GEOPDThirdPartyLinkReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOPDThirdPartyLink readAll:]((uint64_t)self, 0);
    v8 = -[NSString copyWithZone:](self->_adamId, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;
