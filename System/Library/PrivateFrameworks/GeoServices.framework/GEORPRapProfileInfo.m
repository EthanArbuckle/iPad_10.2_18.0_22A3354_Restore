...
{
  GEORPRapProfileInfo *v2;
  GEORPRapProfileInfo *v3;
  GEORPRapProfileInfo *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEORPRapProfileInfo;
  v2 = -[GEORPRapProfileInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEORPRapProfileInfo)initWithData:(id)a3
{
  GEORPRapProfileInfo *v3;
  GEORPRapProfileInfo *v4;
  GEORPRapProfileInfo *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEORPRapProfileInfo;
  v3 = -[GEORPRapProfileInfo initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPRapProfileInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTitle_tags_1);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEORPRapProfileInfoReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSummary_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEORPRapProfileInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPRapProfileInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (v8)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("summary"));
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        v13 = (void *)v12;
        objc_msgSend(a1, "setSummary:", v12);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_2801;
    else
      v8 = (int *)&readAll__nonRecursiveTag_2802;
  ...
  if (v3)
  {
    ...
    -[GEOLocalizedString readAll:](self->_summary, "readAll:", 1);
  }
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEORPRapProfileInfo readAll:](self, "readAll:", 0);
    if (self->_title)
...
LABEL_5:
    ...
    *(_QWORD *)(v5 + 32) = v8;
    ...
    v10 = -[GEOLocalizedString copyWithZone:](self->_summary, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEORPRapProfileInfo readAll:](self, "readAll:", 1),
     ...
     || -[GEOLocalizedString isEqual:](title, "isEqual:")))
  {
    ...
    if ((unint64_t)summary | v4[3])
      v7 = -[GEOLocalizedString isEqual:](summary, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[GEOLocalizedString hash](self->_summary, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEORPRapProfileInfoReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_2805);
      objc_sync_exit(v5);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(_BYTE *)&self->_flags |= 9u;
  ...
  if (v3)
  {
    ...
    -[GEOLocalizedString clearUnknownFields:](self->_summary, "clearUnknownFields:", 1);
  }
}
