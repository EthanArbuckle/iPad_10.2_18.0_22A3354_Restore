...
- (void)clearUnknownFields:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    *(_QWORD *)(a1 + 8) = 0;
    ...
    -[GEOPDCaptionedPhoto clearUnknownFields:](*(_QWORD *)(a1 + 16));
  }
}
...
- (id)description
{
  ...
  -[GEOPDGuideLocationImage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDGuideLocationImage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (uint64_t)_initWithDictionary:(int)a3 isJSON:
{
  ...
  {
    v9 = v8;
    if ((objc_msgSend(v9, "isEqualToString:", CFSTR("IMAGE_TYPE_UNKNOWN")) & 1) != 0)
    {
      v10 = 0;
    }
    else if ((objc_msgSend(v9, "isEqualToString:", CFSTR("IMAGE_TYPE_LANDSCAPE")) & 1) != 0)
    {
      v10 = 1;
    }
    else if (objc_msgSend(v9, "isEqualToString:", CFSTR("IMAGE_TYPE_PORTRAIT")))
    {
      v10 = 2;
    }
    else
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[GEOPDCaptionedPhoto copyWithZone:](self->_image, "copyWithZone:", a3);
  v8 = *(void **)(v6 + 16);
  *(_QWORD *)(v6 + 16) = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_imageType != *((_DWORD *)v4 + 6))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  if ((unint64_t)image | *((_QWORD *)v4 + 2))
    v6 = -[GEOPDCaptionedPhoto isEqual:](image, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v2 = 2654435761 * self->_imageType;
  else
    v2 = 0;
  return -[GEOPDCaptionedPhoto hash](self->_image, "hash") ^ v2;
}
