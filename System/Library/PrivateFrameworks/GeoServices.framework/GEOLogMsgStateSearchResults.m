...
{
  GEOLogMsgStateSearchResults *v2;
  GEOLogMsgStateSearchResults *v3;
  GEOLogMsgStateSearchResults *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOLogMsgStateSearchResults;
  v2 = -[GEOLogMsgStateSearchResults init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOLogMsgStateSearchResults)initWithData:(id)a3
{
  GEOLogMsgStateSearchResults *v3;
  GEOLogMsgStateSearchResults *v4;
  GEOLogMsgStateSearchResults *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOLogMsgStateSearchResults;
  v3 = -[GEOLogMsgStateSearchResults initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 48) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLogMsgStateSearchResultsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSearchResults_tags_7777);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 48) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOLogMsgStateSearchResultsReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSearchQuery_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOLogMsgStateSearchResults description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOLogMsgStateSearchResults dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 24), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v5, v13, (_QWORD)v19);
  ...
  if ((*(_BYTE *)(a1 + 48) & 1) != 0)
  {
    ...
    if (a2)
      v15 = CFSTR("includesEnrichedResult");
    else
      v15 = CFSTR("includes_enriched_result");
    objc_msgSend(v4, "setObject:forKey:", v14, v15);

  }
  objc_msgSend((id)a1, "searchQuery");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (v16)
  {
    if (a2)
      v17 = CFSTR("searchQuery");
    else
      v17 = CFSTR("search_query");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if (a3)
        v17 = CFSTR("includesEnrichedResult");
      else
        v17 = CFSTR("includes_enriched_result");
      ...
      if (a3)
        v19 = CFSTR("searchQuery");
      else
        v19 = CFSTR("search_query");
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setSearchQuery:", v21);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_7787;
    else
      v8 = (int *)&readAll__nonRecursiveTag_7788;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOLogMsgStateSearchResults readAll:](self, "readAll:", 0);
    v14 = 0u;
    v15 = 0u;
    v12 = 0u;
    v13 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v9 + 9) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  if (-[GEOLogMsgStateSearchResults searchResultsCount](self, "searchResultsCount"))
  {
    objc_msgSend(v9, "clearSearchResults");
    v4 = -[GEOLogMsgStateSearchResults searchResultsCount](self, "searchResultsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOLogMsgStateSearchResults searchResultsAtIndex:](self, "searchResultsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "addSearchResults:", v7);
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *((_BYTE *)v9 + 44) = self->_includesEnrichedResult;
    *((_BYTE *)v9 + 48) |= 1u;
  }
  if (self->_searchQuery)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        objc_msgSend((id)v5, "addSearchResults:", v13);
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    *(_BYTE *)(v5 + 44) = self->_includesEnrichedResult;
    *(_BYTE *)(v5 + 48) |= 1u;
  }
  v14 = -[NSString copyWithZone:](self->_searchQuery, "copyWithZone:", a3, (_QWORD)v16);
  v8 = *(id *)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v14;
LABEL_15:
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_8;
  -[GEOLogMsgStateSearchResults readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  searchResults = self->_searchResults;
  if ((unint64_t)searchResults | *((_QWORD *)v4 + 3))
  {
...
LABEL_14:
  ...
  if ((unint64_t)searchQuery | *((_QWORD *)v4 + 2))
    v6 = -[NSString isEqual:](searchQuery, "isEqual:");
  else
    v6 = 1;
LABEL_9:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) != 0)
    v4 = 2654435761 * self->_includesEnrichedResult;
  else
    v4 = 0;
  return v4 ^ v3 ^ -[NSString hash](self->_searchQuery, "hash");
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[GEOLogMsgStateSearchResults addSearchResults:](self, "addSearchResults:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
  ...
  if ((*((_BYTE *)v4 + 48) & 1) != 0)
  {
    self->_includesEnrichedResult = *((_BYTE *)v4 + 44);
