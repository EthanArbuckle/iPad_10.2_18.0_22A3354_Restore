...
{
  GEOCoarseLocationPolygon *v2;
  GEOCoarseLocationPolygon *v3;
  GEOCoarseLocationPolygon *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOCoarseLocationPolygon;
  v2 = -[GEOCoarseLocationPolygon init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCoarseLocationPolygonReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readShell_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOCoarseLocationPolygonReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readHoles_tags);
        objc_sync_exit(v3);
...
- (GEOCoarseLocationPolygon)initWithData:(id)a3
{
  GEOCoarseLocationPolygon *v3;
  GEOCoarseLocationPolygon *v4;
  GEOCoarseLocationPolygon *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOCoarseLocationPolygon;
  v3 = -[GEOCoarseLocationPolygon initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)clearHoles
{
  ...
  *(_BYTE *)&self->_flags |= 4u;
  -[NSMutableArray removeAllObjects](self->_holes, "removeAllObjects");
}
...
{
  -[GEOCoarseLocationPolygon _readHoles]((uint64_t)self);
  return -[NSMutableArray count](self->_holes, "count");
}

- (id)holesAtIndex:(unint64_t)a3
{
  -[GEOCoarseLocationPolygon _readHoles]((uint64_t)self);
  return (id)-[NSMutableArray objectAtIndex:](self->_holes, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOCoarseLocationPolygon description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOCoarseLocationPolygon dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(id *)a1
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("shell"));

  }
  if (objc_msgSend(a1[2], "count"))
  {
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", objc_msgSend(a1[2], "count"));
    v17 = 0u;
    v18 = 0u;
    v19 = 0u;
    v20 = 0u;
    ...
    objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("holes"));
  }
  return v4;
}
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("shell"));
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v7 = [GEOCoarseLocationRing alloc];
        if ((a3 & 1) != 0)
          v8 = -[GEOCoarseLocationRing initWithJSON:](v7, "initWithJSON:", v6);
        else
          v8 = -[GEOCoarseLocationRing initWithDictionary:](v7, "initWithDictionary:", v6);
        v9 = (void *)v8;
        objc_msgSend(a1, "setShell:", v8);

      }
      objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("holes"));
        ...
        if (v12)
        {
          ...
          do
          {
            for (i = 0; i != v13; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                v17 = [GEOCoarseLocationRing alloc];
                if ((a3 & 1) != 0)
                  v18 = -[GEOCoarseLocationRing initWithJSON:](v17, "initWithJSON:", v16);
                else
                  v18 = -[GEOCoarseLocationRing initWithDictionary:](v17, "initWithDictionary:", v16);
                v19 = (void *)v18;
                objc_msgSend(a1, "addHoles:", v18);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag;
    else
      v8 = (int *)&readAll__nonRecursiveTag;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOCoarseLocationPolygon readAll:](self, "readAll:", 0);
    if (self->_shell)
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v8 + 9) = self->_readerMarkLength;
  ...
  if (-[GEOCoarseLocationPolygon holesCount](self, "holesCount"))
  {
    objc_msgSend(v8, "clearHoles");
    v4 = -[GEOCoarseLocationPolygon holesCount](self, "holesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOCoarseLocationPolygon holesAtIndex:](self, "holesAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addHoles:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOCoarseLocationPolygon readAll:](self, "readAll:", 0);
  v8 = -[GEOCoarseLocationRing copyWithZone:](self->_shell, "copyWithZone:", a3);
  v9 = (void *)v5[3];
  v5[3] = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOCoarseLocationPolygon readAll:](self, "readAll:", 1),
     ...
     || -[GEOCoarseLocationRing isEqual:](shell, "isEqual:")))
  {
    ...
    if ((unint64_t)holes | v4[2])
      v7 = -[NSMutableArray isEqual:](holes, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOCoarseLocationPolygon readAll:](self, "readAll:", 1);
  v3 = -[GEOCoarseLocationRing hash](self->_shell, "hash");
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[GEOCoarseLocationPolygon addHoles:](self, "addHoles:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
