...
+ (id)associatedAppForPlaceData:(id)a3
{
  ...
  v6[3] = &unk_1E1C09718;
  v6[4] = &v7;
  objc_msgSend(v3, "enumerateValidComponentValuesOfType:usingBlock:", 38, v6);
  v4 = (id)v8[5];
...
void __65__GEOPDAssociatedApp_PlaceDataExtras__associatedAppForPlaceData___block_invoke(uint64_t a1, id *a2, BOOL *a3)
{
  ...
  -[GEOPDComponentValue associatedApp](a2);
...
{
  GEOPDAssociatedApp *v2;
  GEOPDAssociatedApp *v3;
  GEOPDAssociatedApp *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDAssociatedApp;
  v2 = -[GEOPDAssociatedApp init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDAssociatedApp)initWithData:(id)a3
{
  GEOPDAssociatedApp *v3;
  GEOPDAssociatedApp *v4;
  GEOPDAssociatedApp *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDAssociatedApp;
  v3 = -[GEOPDAssociatedApp initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAssociatedAppReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readPreferredAppAdamId_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDAssociatedAppReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAlternateAppAdamIds_tags);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDAssociatedApp description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAssociatedApp dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDAssociatedApp preferredAppAdamId]((id *)a1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    if (a2)
      v6 = CFSTR("preferredAppAdamId");
    else
      v6 = CFSTR("preferred_app_adam_id");
    objc_msgSend(v4, "setObject:forKey:", v5, v6);
  }

  if (*(_QWORD *)(a1 + 24))
  {
    -[GEOPDAssociatedApp alternateAppAdamIds]((id *)a1);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v8 = CFSTR("alternateAppAdamId");
    else
      v8 = CFSTR("alternate_app_adam_id");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_439;
      else
        v6 = (int *)&readAll__nonRecursiveTag_440;
      GEOPDAssociatedAppReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOPDAssociatedApp readAll:]((uint64_t)self, 0);
  v8 = -[NSString copyWithZone:](self->_preferredAppAdamId, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 32);
  *(_QWORD *)(v5 + 32) = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](preferredAppAdamId, "isEqual:")))
  {
    ...
    if ((unint64_t)alternateAppAdamIds | v4[3])
      v7 = -[NSMutableArray isEqual:](alternateAppAdamIds, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDAssociatedApp readAll:]((uint64_t)self, 1);
  v3 = -[NSString hash](self->_preferredAppAdamId, "hash");
  return -[NSMutableArray hash](self->_alternateAppAdamIds, "hash") ^ v3;
}
