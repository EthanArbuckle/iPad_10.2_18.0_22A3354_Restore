...
{
  GEOSuggestionEntryList *v2;
  GEOSuggestionEntryList *v3;
  GEOSuggestionEntryList *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOSuggestionEntryList;
  v2 = -[GEOSuggestionEntryList init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOSuggestionEntryList)initWithData:(id)a3
{
  GEOSuggestionEntryList *v3;
  GEOSuggestionEntryList *v4;
  GEOSuggestionEntryList *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOSuggestionEntryList;
  v3 = -[GEOSuggestionEntryList initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)_readSuggestionEntries
{
  ...
  if ((*(_BYTE *)(a1 + 60) & 0x10) == 0)
  {
    ...
    if (v2)
    {
      v3 = v2;
      objc_sync_enter(v3);
      GEOSuggestionEntryListReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readSuggestionEntries_tags);
      objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOSuggestionEntryList description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOSuggestionEntryList dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("suggestionEntries"));
  }
  os_unfair_lock_lock((os_unfair_lock_t)(a1 + 48));
  if ((*(_BYTE *)(a1 + 60) & 8) == 0)
  {
    ...
    if (v12)
    {
      v13 = v12;
      objc_sync_enter(v13);
      GEOSuggestionEntryListReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLocalizedSectionHeader_tags);
      objc_sync_exit(v13);
  ...
  v14 = *(id *)(a1 + 24);
  if (v14)
    objc_msgSend(v4, "setObject:forKey:", v14, CFSTR("localizedSectionHeader"));
  ...
  if ((v15 & 2) != 0)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v16, CFSTR("showSectionHeader"));
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_2858;
      else
        v6 = (int *)&readAll__nonRecursiveTag_2859;
      GEOSuggestionEntryListReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v14 = -[NSString copyWithZone:](self->_localizedSectionHeader, "copyWithZone:", a3);
  v15 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v14;
  ...
  if ((flags & 2) != 0)
  {
    *(_BYTE *)(v5 + 56) = self->_showSectionHeader;
    *(_BYTE *)(v5 + 60) |= 2u;
    flags = (char)self->_flags;
  }
  if ((flags & 1) != 0)
...
LABEL_14:
  ...
  {
    if ((*((_BYTE *)v4 + 60) & 1) == 0 || self->_contentType != *((_DWORD *)v4 + 13))
      goto LABEL_18;
    v7 = 1;
  }
LABEL_19:
...
- (unint64_t)hash
{
  ...
  -[GEOSuggestionEntryList readAll:]((uint64_t)self, 1);
  v3 = -[NSMutableArray hash](self->_suggestionEntries, "hash");
  v4 = -[NSString hash](self->_localizedSectionHeader, "hash");
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    v5 = 2654435761 * self->_showSectionHeader;
    if ((*(_BYTE *)&self->_flags & 1) != 0)
      goto LABEL_3;
LABEL_5:
    v6 = 0;
