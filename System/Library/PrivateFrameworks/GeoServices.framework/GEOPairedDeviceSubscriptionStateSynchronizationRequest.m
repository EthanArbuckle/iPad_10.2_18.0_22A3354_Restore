...
{
  objc_storeStrong((id *)&self->_identifiersToObserves, a3);
}

- (void)clearIdentifiersToObserves
{
  -[NSMutableArray removeAllObjects](self->_identifiersToObserves, "removeAllObjects");
}
...
- (void)addIdentifiersToObserve:(id)a3
{
  ...
  -[NSMutableArray addObject:](identifiersToObserves, "addObject:", v4);

}

- (unint64_t)identifiersToObservesCount
{
  return -[NSMutableArray count](self->_identifiersToObserves, "count");
}

- (id)identifiersToObserveAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_identifiersToObserves, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOPairedDeviceSubscriptionStateSynchronizationRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPairedDeviceSubscriptionStateSynchronizationRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  if (a1[2])
  {
    objc_msgSend(a1, "identifiersToObserves");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v6 = CFSTR("identifiersToObserve");
    else
      v6 = CFSTR("identifiers_to_observe");
          ...
          do
          {
            ...
            do
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                objc_msgSend(a1, "addIdentifiersToObserve:", v14);
...
- (void)writeTo:(id)a3
{
  ...
  v12 = 0u;
  v13 = 0u;
  v5 = self->_identifiersToObserves;
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEOPairedDeviceSubscriptionStateSynchronizationRequest readAll:](self, "readAll:", 0);
  if (-[GEOPairedDeviceSubscriptionStateSynchronizationRequest identifiersToObservesCount](self, "identifiersToObservesCount"))
  {
    objc_msgSend(v8, "clearIdentifiersToObserves");
    v4 = -[GEOPairedDeviceSubscriptionStateSynchronizationRequest identifiersToObservesCount](self, "identifiersToObservesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOPairedDeviceSubscriptionStateSynchronizationRequest identifiersToObserveAtIndex:](self, "identifiersToObserveAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addIdentifiersToObserve:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v15 = 0u;
  v16 = 0u;
  v6 = self->_identifiersToObserves;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addIdentifiersToObserve:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOPairedDeviceSubscriptionStateSynchronizationRequest readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    identifiersToObserves = self->_identifiersToObserves;
    if ((unint64_t)identifiersToObserves | v4[2])
      v5 = -[NSMutableArray isEqual:](identifiersToObserves, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOPairedDeviceSubscriptionStateSynchronizationRequest readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_identifiersToObserves, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOPairedDeviceSubscriptionStateSynchronizationRequest addIdentifiersToObserve:](self, "addIdentifiersToObserve:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
