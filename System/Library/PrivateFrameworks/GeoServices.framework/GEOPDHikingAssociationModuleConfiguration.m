...
- (id)description
{
  ...
  -[GEOPDHikingAssociationModuleConfiguration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDHikingAssociationModuleConfiguration dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (v5)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v8 = CFSTR("templatePlaceConfiguration");
    }
    else
    {
      objc_msgSend(v5, "dictionaryRepresentation");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = CFSTR("template_place_configuration");
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[GEOPDTemplatePlaceModuleConfiguration copyWithZone:](self->_templatePlaceConfiguration, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
{
  _QWORD *v4;
  GEOPDTemplatePlaceModuleConfiguration *templatePlaceConfiguration;
  char v6;
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)templatePlaceConfiguration | v4[2])
      v6 = -[GEOPDTemplatePlaceModuleConfiguration isEqual:](templatePlaceConfiguration, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[GEOPDTemplatePlaceModuleConfiguration hash](self->_templatePlaceConfiguration, "hash");
}
