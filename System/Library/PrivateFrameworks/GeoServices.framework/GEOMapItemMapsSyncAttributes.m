...
{
  GEOMapItemMapsSyncAttributes *v2;
  GEOMapItemMapsSyncAttributes *v3;
  GEOMapItemMapsSyncAttributes *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOMapItemMapsSyncAttributes;
  v2 = -[GEOMapItemMapsSyncAttributes init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOMapItemMapsSyncAttributes)initWithData:(id)a3
{
  GEOMapItemMapsSyncAttributes *v3;
  GEOMapItemMapsSyncAttributes *v4;
  GEOMapItemMapsSyncAttributes *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOMapItemMapsSyncAttributes;
  v3 = -[GEOMapItemMapsSyncAttributes initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOMapItemMapsSyncAttributesReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readMapsSyncIdentifier_tags);
        objc_sync_exit(v3);
...
{
  -[GEOMapItemMapsSyncAttributes _readMapsSyncIdentifier]((uint64_t)self);
  return self->_mapsSyncIdentifier;
}
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOMapItemMapsSyncAttributesReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readMapsSyncObjectType_tags);
        objc_sync_exit(v3);
...
{
  -[GEOMapItemMapsSyncAttributes _readMapsSyncObjectType]((uint64_t)self);
  return self->_mapsSyncObjectType;
}
...
- (id)description
{
  ...
  -[GEOMapItemMapsSyncAttributes description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOMapItemMapsSyncAttributes dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  return -[GEOMapItemMapsSyncAttributes _dictionaryRepresentation:](self, 0);
}
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "mapsSyncIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("mapsSyncIdentifier"));

  objc_msgSend(a1, "mapsSyncObjectType");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("mapsSyncObjectType"));
  ...
  if (v7)
  {
    ...
    if (a2)
    {
      ...
      v14[1] = 3221225472;
      v14[2] = __58__GEOMapItemMapsSyncAttributes__dictionaryRepresentation___block_invoke;
      v14[3] = &unk_1E1C00600;
      v11 = v10;
      v15 = v11;
...
{
  return -[GEOMapItemMapsSyncAttributes _dictionaryRepresentation:](self, 1);
}
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("mapsSyncIdentifier"));
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v5 = (void *)objc_msgSend(v4, "copy");
        objc_msgSend(a1, "setMapsSyncIdentifier:", v5);

      }
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("mapsSyncObjectType"));
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v7 = (void *)objc_msgSend(v6, "copy");
        objc_msgSend(a1, "setMapsSyncObjectType:", v7);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_848;
    else
      v8 = (int *)&readAll__nonRecursiveTag_849;
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOMapItemMapsSyncAttributes readAll:](self, "readAll:", 0);
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOMapItemMapsSyncAttributes readAll:](self, "readAll:", 0);
    v8 = -[NSString copyWithZone:](self->_mapsSyncIdentifier, "copyWithZone:", a3);
    v9 = *(void **)(v5 + 24);
    *(_QWORD *)(v5 + 24) = v8;

    v10 = -[NSString copyWithZone:](self->_mapsSyncObjectType, "copyWithZone:", a3);
    v11 = *(void **)(v5 + 32);
    *(_QWORD *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOMapItemMapsSyncAttributes readAll:](self, "readAll:", 1),
         objc_msgSend(v4, "readAll:", 1),
         mapsSyncIdentifier = self->_mapsSyncIdentifier,
         !((unint64_t)mapsSyncIdentifier | v4[3]))
     || -[NSString isEqual:](mapsSyncIdentifier, "isEqual:")))
  {
    mapsSyncObjectType = self->_mapsSyncObjectType;
    if ((unint64_t)mapsSyncObjectType | v4[4])
      v7 = -[NSString isEqual:](mapsSyncObjectType, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOMapItemMapsSyncAttributes readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_mapsSyncIdentifier, "hash");
  return -[NSString hash](self->_mapsSyncObjectType, "hash") ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOMapItemMapsSyncAttributesReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_852);
      objc_sync_exit(v5);
