...
- (void)clearMessages
{
  -[NSMutableArray removeAllObjects](self->_messages, "removeAllObjects");
}
...
- (void)addMessage:(id)a3
{
  ...
  -[NSMutableArray addObject:](messages, "addObject:", v4);

}

- (unint64_t)messagesCount
{
  return -[NSMutableArray count](self->_messages, "count");
}

- (id)messageAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_messages, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEORPFeedbackConversation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEORPFeedbackConversation dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 16), "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v5, CFSTR("message"));
  }
  v13 = *(void **)(a1 + 8);
  if (v13)
  {
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  ...
  uint64_t i;
  uint64_t v12;
  GEORPFeedbackConversationMessage *v13;
  uint64_t v14;
  void *v15;
  void *v17;
  __int128 v18;
          ...
          do
          {
            for (i = 0; i != v9; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                if ((a3 & 1) != 0)
                  v14 = -[GEORPFeedbackConversationMessage initWithJSON:](v13, "initWithJSON:", v12);
                else
                  v14 = -[GEORPFeedbackConversationMessage initWithDictionary:](v13, "initWithDictionary:", v12);
                v15 = (void *)v14;
                objc_msgSend(a1, "addMessage:", v14);
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  -[GEORPFeedbackConversation readAll:](self, "readAll:", 0);
  if (-[GEORPFeedbackConversation messagesCount](self, "messagesCount"))
  {
    objc_msgSend(v8, "clearMessages");
    v4 = -[GEORPFeedbackConversation messagesCount](self, "messagesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEORPFeedbackConversation messageAtIndex:](self, "messageAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addMessage:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addMessage:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEORPFeedbackConversation readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    messages = self->_messages;
    if ((unint64_t)messages | v4[2])
      v5 = -[NSMutableArray isEqual:](messages, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEORPFeedbackConversation readAll:](self, "readAll:", 1);
  return -[NSMutableArray hash](self->_messages, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEORPFeedbackConversation addMessage:](self, "addMessage:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), (_QWORD)v10);
      }
      while (v7 != v9);
