...
- (id)description
{
  ...
  -[GEOPDBasemapRegionMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDBasemapRegionMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_buildUnitAreaId, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)buildUnitAreaId | v4[2])
      v6 = -[NSString isEqual:](buildUnitAreaId, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSString hash](self->_buildUnitAreaId, "hash");
}
