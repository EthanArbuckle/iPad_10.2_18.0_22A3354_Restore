...
- (id)description
{
  ...
  -[GEOPDPlaceSummaryLayoutUnitNumPlacesInGuide description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPlaceSummaryLayoutUnitNumPlacesInGuide dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  -[GEOPDPlaceSummaryLayoutUnitNumPlacesInGuide readAll:](self, "readAll:", 0);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    -[GEOPDPlaceSummaryLayoutUnitNumPlacesInGuide readAll:](self, "readAll:", 1);
