...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("MAResources.purgeDiskCache"), a3, a4, a5);
}

- (GEOMAResourcePurgeCacheToSizeRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6;
  GEOMAResourcePurgeCacheToSizeRequest *v7;
  GEOMAResourcePurgeCacheToSizeRequest *v8;
  objc_super v10;
