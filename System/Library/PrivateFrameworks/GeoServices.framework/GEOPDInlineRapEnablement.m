...
- (id)description
{
  ...
  -[GEOPDInlineRapEnablement description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDInlineRapEnablement dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v5 & 2) != 0)
  {
    ...
    if (a2)
      v16 = CFSTR("isHoursEditable");
    else
      v16 = CFSTR("is_hours_editable");
...
LABEL_24:
      ...
      if (a2)
        v20 = CFSTR("isWebsiteEditable");
      else
        v20 = CFSTR("is_website_editable");
  ...
  if (a2)
    v18 = CFSTR("isPhoneEditable");
  else
    v18 = CFSTR("is_phone_editable");
...
LABEL_6:
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (a2)
      v7 = CFSTR("isAddressEditable");
    else
      v7 = CFSTR("is_address_editable");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3)
        v6 = CFSTR("isHoursEditable");
      else
        v6 = CFSTR("is_hours_editable");
      ...
      if (a3)
        v8 = CFSTR("isPhoneEditable");
      else
        v8 = CFSTR("is_phone_editable");
      ...
      if (a3)
        v10 = CFSTR("isWebsiteEditable");
      else
        v10 = CFSTR("is_website_editable");
      ...
      if (a3)
        v12 = CFSTR("isAddressEditable");
      else
        v12 = CFSTR("is_address_editable");
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOPDInlineRapEnablement readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((flags & 2) != 0)
  {
    *(_BYTE *)(v4 + 17) = self->_isHoursEditable;
    *(_BYTE *)(v4 + 20) |= 2u;
    flags = (char)self->_flags;
    if ((flags & 4) == 0)
    {
LABEL_3:
      if ((flags & 8) == 0)
        goto LABEL_4;
LABEL_9:
      *(_BYTE *)(v4 + 19) = self->_isWebsiteEditable;
      *(_BYTE *)(v4 + 20) |= 8u;
      if ((*(_BYTE *)&self->_flags & 1) == 0)
        goto LABEL_6;
      goto LABEL_5;
  ...
  *(_BYTE *)(v4 + 18) = self->_isPhoneEditable;
  *(_BYTE *)(v4 + 20) |= 4u;
  flags = (char)self->_flags;
  if ((flags & 8) != 0)
    goto LABEL_9;
LABEL_4:
  ...
  {
LABEL_5:
    *(_BYTE *)(v4 + 16) = self->_isAddressEditable;
    *(_BYTE *)(v4 + 20) |= 1u;
  }
LABEL_6:
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_28;
  -[GEOPDInlineRapEnablement readAll:](self, "readAll:", 1);
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    v3 = 2654435761 * self->_isHoursEditable;
    if ((*(_BYTE *)&self->_flags & 4) != 0)
    {
LABEL_3:
      v4 = 2654435761 * self->_isPhoneEditable;
      if ((*(_BYTE *)&self->_flags & 8) != 0)
        goto LABEL_4;
LABEL_8:
      v5 = 0;
...
LABEL_9:
  ...
  if ((*(_BYTE *)&self->_flags & 8) == 0)
    goto LABEL_8;
LABEL_4:
  v5 = 2654435761 * self->_isWebsiteEditable;
  if ((*(_BYTE *)&self->_flags & 1) == 0)
    goto LABEL_9;
LABEL_5:
  v6 = 2654435761 * self->_isAddressEditable;
  return v4 ^ v3 ^ v5 ^ v6;
}
