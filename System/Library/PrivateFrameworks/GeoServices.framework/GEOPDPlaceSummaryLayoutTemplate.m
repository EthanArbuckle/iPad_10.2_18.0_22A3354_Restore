...
{
  GEOPDPlaceSummaryLayoutTemplate *v2;
  GEOPDPlaceSummaryLayoutTemplate *v3;
  GEOPDPlaceSummaryLayoutTemplate *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDPlaceSummaryLayoutTemplate;
  v2 = -[GEOPDPlaceSummaryLayoutTemplate init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDPlaceSummaryLayoutTemplate)initWithData:(id)a3
{
  GEOPDPlaceSummaryLayoutTemplate *v3;
  GEOPDPlaceSummaryLayoutTemplate *v4;
  GEOPDPlaceSummaryLayoutTemplate *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDPlaceSummaryLayoutTemplate;
  v3 = -[GEOPDPlaceSummaryLayoutTemplate initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPlaceSummaryLayoutTemplateReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTemplateId_tags);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDPlaceSummaryLayoutTemplateReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readTemplateEntrys_tags);
        objc_sync_exit(v3);
...
- (void)clearTemplateEntrys
{
  ...
  *(_BYTE *)&self->_flags |= 4u;
  -[NSMutableArray removeAllObjects](self->_templateEntrys, "removeAllObjects");
}
...
{
  -[GEOPDPlaceSummaryLayoutTemplate _readTemplateEntrys]((uint64_t)self);
  return -[NSMutableArray count](self->_templateEntrys, "count");
}

- (id)templateEntryAtIndex:(unint64_t)a3
{
  -[GEOPDPlaceSummaryLayoutTemplate _readTemplateEntrys]((uint64_t)self);
  return (id)-[NSMutableArray objectAtIndex:](self->_templateEntrys, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOPDPlaceSummaryLayoutTemplate description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPlaceSummaryLayoutTemplate dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(id *)a1
{
  ...
  if (objc_msgSend(a1[2], "count"))
  {
    ...
    if (a2)
      v15 = CFSTR("templateEntry");
    else
      v15 = CFSTR("template_entry");
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  uint64_t i;
  uint64_t v16;
  GEOPDPlaceSummaryLayoutTemplateEntry *v17;
  uint64_t v18;
  void *v19;
  void *v21;
  __int128 v22;
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setTemplateId:", v8);

      }
      if (a3)
        v9 = CFSTR("templateEntry");
      else
        v9 = CFSTR("template_entry");
        ...
        if (v12)
        {
          ...
          do
          {
            for (i = 0; i != v13; ++i)
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                v17 = [GEOPDPlaceSummaryLayoutTemplateEntry alloc];
                if ((a3 & 1) != 0)
                  v18 = -[GEOPDPlaceSummaryLayoutTemplateEntry initWithJSON:](v17, "initWithJSON:", v16);
                else
                  v18 = -[GEOPDPlaceSummaryLayoutTemplateEntry initWithDictionary:](v17, "initWithDictionary:", v16);
                v19 = (void *)v18;
                objc_msgSend(a1, "addTemplateEntry:", v18);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_239;
    else
      v8 = (int *)&readAll__nonRecursiveTag_240;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOPDPlaceSummaryLayoutTemplate readAll:](self, "readAll:", 0);
    if (self->_templateId)
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v8 + 9) = self->_readerMarkLength;
  ...
  if (-[GEOPDPlaceSummaryLayoutTemplate templateEntrysCount](self, "templateEntrysCount"))
  {
    objc_msgSend(v8, "clearTemplateEntrys");
    v4 = -[GEOPDPlaceSummaryLayoutTemplate templateEntrysCount](self, "templateEntrysCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOPDPlaceSummaryLayoutTemplate templateEntryAtIndex:](self, "templateEntryAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addTemplateEntry:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOPDPlaceSummaryLayoutTemplate readAll:](self, "readAll:", 0);
  v8 = -[NSString copyWithZone:](self->_templateId, "copyWithZone:", a3);
  v9 = (void *)v5[3];
  v5[3] = v8;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        objc_msgSend(v5, "addTemplateEntry:", v14);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOPDPlaceSummaryLayoutTemplate readAll:](self, "readAll:", 1),
     ...
     || -[NSString isEqual:](templateId, "isEqual:")))
  {
    ...
    if ((unint64_t)templateEntrys | v4[2])
      v7 = -[NSMutableArray isEqual:](templateEntrys, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOPDPlaceSummaryLayoutTemplate readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_templateId, "hash");
  return -[NSMutableArray hash](self->_templateEntrys, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[GEOPDPlaceSummaryLayoutTemplate addTemplateEntry:](self, "addTemplateEntry:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
