...
- (id)description
{
  ...
  -[GEOPDIdentityMerchantInformation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDIdentityMerchantInformation dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (uint64_t)_initWithDictionary:(int)a3 isJSON:
{
  ...
  {
    if (a3)
      v7 = CFSTR("rpIdentifier");
    else
      v7 = CFSTR("rp_identifier");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_rpIdentifier, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)rpIdentifier | v4[2])
      v6 = -[NSString isEqual:](rpIdentifier, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSString hash](self->_rpIdentifier, "hash");
}
