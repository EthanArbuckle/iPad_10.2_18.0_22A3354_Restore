@implementation GetBatchDataForOfflineDataPK
...
uint64_t __GetBatchDataForOfflineDataPK_block_invoke(uint64_t a1, sqlite3_stmt *a2)
{
  ...
  obj = *(id *)(v6 + 40);
  v7 = objc_msgSend(v4, "bindInt64Parameter:toValue:inStatement:error:", "@offline_data_batch_refs_offline_data_pk", v5, a2, &obj);
  ...
  while ((_DWORD)v8 == 100)
  {
    ...
    objc_msgSend(*(id *)(a1 + 32), "UUIDForColumn:inStatment:", 2, a2);
