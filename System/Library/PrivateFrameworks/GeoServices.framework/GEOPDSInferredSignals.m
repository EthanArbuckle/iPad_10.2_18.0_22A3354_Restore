...
- (id)description
{
  ...
  -[GEOPDSInferredSignals description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSInferredSignals dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (v5)
  {
    if ((a2 & 1) != 0)
    {
      ...
      v8 = CFSTR("inferredInfo");
    }
    else
    {
      objc_msgSend(v5, "dictionaryRepresentation");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = CFSTR("inferred_info");
    }
...
- (void)_initWithDictionary:(uint64_t)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if ((_DWORD)a3)
        v6 = CFSTR("inferredInfo");
      else
        v6 = CFSTR("inferred_info");
      objc_msgSend(v5, "objectForKeyedSubscript:", v6);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        v8 = [GEOPDSInferredInfo alloc];
        if (v8)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[GEOPDSInferredInfo copyWithZone:](self->_inferredInfo, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)inferredInfo | v4[2])
      v6 = -[GEOPDSInferredInfo isEqual:](inferredInfo, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[GEOPDSInferredInfo hash](self->_inferredInfo, "hash");
}
...
- (void)clearUnknownFields:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    *(_QWORD *)(a1 + 8) = 0;
    ...
    if (a2)
      -[GEOPDSInferredInfo clearUnknownFields:](*(_QWORD *)(a1 + 16), 1);
  }
}
