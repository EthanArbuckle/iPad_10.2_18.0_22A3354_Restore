...
- (int)StringAsType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("COARSE_LOCATION_TYPE_UNKNOWN")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("COARSE_LOCATION_TYPE_SNAPPED_TO_GRID")) & 1) != 0)
  {
    v4 = 1;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("COARSE_LOCATION_TYPE_SNAPPED_TO_DATA")))
  {
    v4 = 2;
  }
  else
...
- (id)description
{
  ...
  -[GEOCoarseLocationMetadata description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOCoarseLocationMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      {
        v5 = v4;
        if ((objc_msgSend(v5, "isEqualToString:", CFSTR("COARSE_LOCATION_TYPE_UNKNOWN")) & 1) != 0)
        {
          v6 = 0;
        }
        else if ((objc_msgSend(v5, "isEqualToString:", CFSTR("COARSE_LOCATION_TYPE_SNAPPED_TO_GRID")) & 1) != 0)
        {
          v6 = 1;
        }
        else if (objc_msgSend(v5, "isEqualToString:", CFSTR("COARSE_LOCATION_TYPE_SNAPPED_TO_DATA")))
        {
          v6 = 2;
        }
        else
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOCoarseLocationMetadata readAll:](self, "readAll:", 0);
  if ((*(_BYTE *)&self->_flags & 1) != 0)
  {
    v4[4] = self->_type;
    *((_BYTE *)v4 + 20) |= 1u;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_6;
  -[GEOCoarseLocationMetadata readAll:](self, "readAll:", 1);
