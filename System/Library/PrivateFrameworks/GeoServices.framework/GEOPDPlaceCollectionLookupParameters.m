...
{
  GEOPDPlaceCollectionLookupParameters *v2;
  GEOPDPlaceCollectionLookupParameters *v3;
  GEOPDPlaceCollectionLookupParameters *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDPlaceCollectionLookupParameters;
  v2 = -[GEOPDPlaceCollectionLookupParameters init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDPlaceCollectionLookupParameters)initWithData:(id)a3
{
  GEOPDPlaceCollectionLookupParameters *v3;
  GEOPDPlaceCollectionLookupParameters *v4;
  GEOPDPlaceCollectionLookupParameters *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDPlaceCollectionLookupParameters;
  v3 = -[GEOPDPlaceCollectionLookupParameters initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
...
- (void)_readCenter
{
  ...
  if ((*(_BYTE *)(a1 + 52) & 2) == 0)
  {
    ...
    if (v2)
    {
      v3 = v2;
      objc_sync_enter(v3);
      GEOPDPlaceCollectionLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCenter_tags_0);
      objc_sync_exit(v3);
...
- (void)_readCollectionIds
{
  ...
  if ((*(_BYTE *)(a1 + 52) & 4) == 0)
  {
    ...
    if (v2)
    {
      v3 = v2;
      objc_sync_enter(v3);
      GEOPDPlaceCollectionLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readCollectionIds_tags_3512);
      objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDPlaceCollectionLookupParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDPlaceCollectionLookupParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    if (a2)
      v16 = CFSTR("collectionId");
    else
      v16 = CFSTR("collection_id");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_3515;
      else
        v6 = (int *)&readAll__nonRecursiveTag_3516;
      GEOPDPlaceCollectionLookupParametersReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
...
- (uint64_t)hasGreenTeaWithValue:(uint64_t)a1
{
  ...
  if (!a1)
    return 0;
  -[GEOPDPlaceCollectionLookupParameters _readCenter](a1);
  if ((objc_msgSend(*(id *)(a1 + 24), "hasGreenTeaWithValue:", a2) & 1) != 0)
    return 1;
  -[GEOPDPlaceCollectionLookupParameters _readCollectionIds](a1);
  v13 = 0u;
  v14 = 0u;
