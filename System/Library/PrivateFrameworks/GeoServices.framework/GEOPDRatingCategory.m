...
- (id)displayTitle
{
  ...
  -[GEOPDRatingCategory localizedNames]((id *)&self->super.super.isa);
...
{
  GEOPDRatingCategory *v2;
  GEOPDRatingCategory *v3;
  GEOPDRatingCategory *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOPDRatingCategory;
  v2 = -[GEOPDRatingCategory init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOPDRatingCategory)initWithData:(id)a3
{
  GEOPDRatingCategory *v3;
  GEOPDRatingCategory *v4;
  GEOPDRatingCategory *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOPDRatingCategory;
  v3 = -[GEOPDRatingCategory initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDRatingCategoryReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readKey_tags_4);
        objc_sync_exit(v3);
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOPDRatingCategoryReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readLocalizedNames_tags_2);
        objc_sync_exit(v3);
...
- (id)description
{
  ...
  -[GEOPDRatingCategory description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDRatingCategory dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)readAll:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2)
        v6 = (int *)&readAll__recursiveTag_163;
      else
        v6 = (int *)&readAll__nonRecursiveTag_164;
      GEOPDRatingCategoryReadSpecified(a1, *(_QWORD *)(a1 + 8), v6);
      objc_sync_exit(v5);
