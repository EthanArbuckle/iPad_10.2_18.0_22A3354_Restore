...
- (id)description
{
  ...
  -[GEOPDSearchKeyDoubleValueDoublePair description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDSearchKeyDoubleValueDoublePair dictionaryRepresentation](self, "dictionaryRepresentation");
