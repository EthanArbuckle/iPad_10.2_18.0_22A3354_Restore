      ...
      if (v6)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            -[GEOPDResultRefinementRangeElement clearUnknownFields:](*(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), 1);
          }
          while (v7 != v9);
...
- (id)description
{
  ...
  -[GEOPDResultRefinementRangeDiscrete description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDResultRefinementRangeDiscrete dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if ((v13 & 2) != 0)
  {
    ...
    if (a2)
      v15 = CFSTR("selectedMinElementIndex");
    else
      v15 = CFSTR("selected_min_element_index");
  ...
  if ((v13 & 1) != 0)
  {
    ...
    if (a2)
      v17 = CFSTR("selectedMaxElementIndex");
    else
      v17 = CFSTR("selected_max_element_index");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)elements | *((_QWORD *)v4 + 2))
  {
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 2) == 0 || self->_selectedMinElementIndex != *((_DWORD *)v4 + 7))
      goto LABEL_13;
  }
...
LABEL_13:
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_selectedMaxElementIndex != *((_DWORD *)v4 + 6))
      goto LABEL_13;
    v6 = 1;
  }
LABEL_14:
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_elements, "hash");
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    v4 = 2654435761 * self->_selectedMinElementIndex;
    if ((*(_BYTE *)&self->_flags & 1) != 0)
      goto LABEL_3;
LABEL_5:
    v5 = 0;
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
    goto LABEL_5;
LABEL_3:
  v5 = 2654435761 * self->_selectedMaxElementIndex;
  return v4 ^ v3 ^ v5;
}
