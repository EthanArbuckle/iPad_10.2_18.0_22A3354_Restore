...
{
  objc_storeStrong((id *)&self->_webContentUrl, a3);
}
...
- (id)description
{
  ...
  -[GEOPDModuleOptions description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOPDModuleOptions dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(_QWORD *)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "webContentUrl");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    if (a2)
      v6 = CFSTR("webContentUrl");
    else
      v6 = CFSTR("web_content_url");
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setWebContentUrl:", v8);
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  -[GEOPDModuleOptions readAll:](self, "readAll:", 0);
  if (self->_webContentUrl)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_webContentUrl, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = 1;
    -[GEOPDModuleOptions readAll:](self, "readAll:", 1);
    objc_msgSend(v4, "readAll:", 1);
    webContentUrl = self->_webContentUrl;
    if ((unint64_t)webContentUrl | v4[2])
      v5 = -[NSString isEqual:](webContentUrl, "isEqual:");
  }
  else
  {
    v5 = 0;
...
{
  -[GEOPDModuleOptions readAll:](self, "readAll:", 1);
  return -[NSString hash](self->_webContentUrl, "hash");
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
    -[GEOPDModuleOptions setWebContentUrl:](self, "setWebContentUrl:", v5);
}
