...
{
  return -[GEOXPCRequest initWithMessage:traits:auditToken:throttleToken:](self, "initWithMessage:traits:auditToken:throttleToken:", CFSTR("subscriptions.stopObservingStateForSubscriptions"), a3, a4, a5);
}

- (GEOMapSubscriptionStateStopObservingRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6;
  GEOMapSubscriptionStateStopObservingRequest *v7;
  void *v8;
  size_t count;
  void *v10;
  size_t i;
  ...
  uint64_t v22;
  void *v23;
  GEOMapSubscriptionStateStopObservingRequest *v24;
  objc_super v26;
