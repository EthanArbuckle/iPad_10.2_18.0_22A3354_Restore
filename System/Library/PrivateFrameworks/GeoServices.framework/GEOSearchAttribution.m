...
{
  GEOSearchAttribution *v2;
  GEOSearchAttribution *v3;
  GEOSearchAttribution *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GEOSearchAttribution;
  v2 = -[GEOSearchAttribution init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (GEOSearchAttribution)initWithData:(id)a3
{
  GEOSearchAttribution *v3;
  GEOSearchAttribution *v4;
  GEOSearchAttribution *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GEOSearchAttribution;
  v3 = -[GEOSearchAttribution initWithData:](&v7, sel_initWithData_, a3);
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_BYTE *)(a1 + 56) & 2) == 0)
    {
      ...
      if (v2)
      {
        v3 = v2;
        objc_sync_enter(v3);
        GEOSearchAttributionReadSpecified(a1, *(_QWORD *)(a1 + 8), (int *)&_readAttributionURLs_tags);
        objc_sync_exit(v3);
...
- (void)clearAttributionURLs
{
  ...
  *(_BYTE *)&self->_flags |= 8u;
  -[NSMutableArray removeAllObjects](self->_attributionURLs, "removeAllObjects");
}
...
{
  -[GEOSearchAttribution _readAttributionURLs]((uint64_t)self);
  return -[NSMutableArray count](self->_attributionURLs, "count");
}

- (id)attributionURLsAtIndex:(unint64_t)a3
{
  -[GEOSearchAttribution _readAttributionURLs]((uint64_t)self);
  return (id)-[NSMutableArray objectAtIndex:](self->_attributionURLs, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[GEOSearchAttribution description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOSearchAttribution dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend((id)a1, "sourceIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  ...
  if (*(_QWORD *)(a1 + 24))
  {
    objc_msgSend((id)a1, "attributionURLs");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("attributionURLs"));
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        objc_msgSend(a1, "setSourceIdentifier:", v5);
      ...
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("attributionURLs"));
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
          ...
          do
          {
            ...
            do
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                objc_msgSend(a1, "addAttributionURLs:", v14);
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3)
      v8 = (int *)&readAll__recursiveTag_2679;
    else
      v8 = (int *)&readAll__nonRecursiveTag_2680;
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    -[GEOSearchAttribution readAll:](self, "readAll:", 0);
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v8 + 11) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  objc_msgSend(v8, "setSourceIdentifier:", self->_sourceIdentifier);
  *((_DWORD *)v8 + 13) = self->_sourceVersion;
  if (-[GEOSearchAttribution attributionURLsCount](self, "attributionURLsCount"))
  {
    objc_msgSend(v8, "clearAttributionURLs");
    v4 = -[GEOSearchAttribution attributionURLsCount](self, "attributionURLsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[GEOSearchAttribution attributionURLsAtIndex:](self, "attributionURLsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addAttributionURLs:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  -[GEOSearchAttribution readAll:](self, "readAll:", 0);
  v8 = -[NSString copyWithZone:](self->_sourceIdentifier, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 32);
  *(_QWORD *)(v5 + 32) = v8;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        objc_msgSend((id)v5, "addAttributionURLs:", v14);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class())
    && ((-[GEOSearchAttribution readAll:](self, "readAll:", 1),
    ...
    && self->_sourceVersion == *((_DWORD *)v4 + 13))
  {
    ...
    if ((unint64_t)attributionURLs | v4[3])
      v7 = -[NSMutableArray isEqual:](attributionURLs, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  -[GEOSearchAttribution readAll:](self, "readAll:", 1);
  v3 = -[NSString hash](self->_sourceIdentifier, "hash");
  v4 = 2654435761 * self->_sourceVersion;
  return v4 ^ v3 ^ -[NSMutableArray hash](self->_attributionURLs, "hash");
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[GEOSearchAttribution addAttributionURLs:](self, "addAttributionURLs:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(_BYTE *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      v5 = reader;
      objc_sync_enter(v5);
      GEOSearchAttributionReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_2683);
      objc_sync_exit(v5);
