...
- (id)description
{
  ...
  -[GEOWiFiConnectionSpeedTest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[GEOWiFiConnectionSpeedTest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((v4 & 2) != 0)
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v2, "setObject:forKey:", v5, CFSTR("avgUL"));
    ...
    if ((v4 & 1) != 0)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v3);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v2, "setObject:forKey:", v6, CFSTR("avgDL"));
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("avgUL"));
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      ...
      objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("avgDL"));
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
...
- (void)copyTo:(id)a3
{
  ...
  v5 = a3;
  -[GEOWiFiConnectionSpeedTest readAll:](self, "readAll:", 0);
  flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_11;
  -[GEOWiFiConnectionSpeedTest readAll:](self, "readAll:", 1);
  objc_msgSend(v4, "readAll:", 1);
  if ((*(_BYTE *)&self->_flags & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_avgUL != *((float *)v4 + 3))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_avgDL != *((float *)v4 + 2))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
