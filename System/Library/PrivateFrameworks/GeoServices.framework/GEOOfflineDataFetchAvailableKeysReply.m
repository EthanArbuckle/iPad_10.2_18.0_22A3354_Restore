...
{
  id v6;
  GEOOfflineDataFetchAvailableKeysReply *v7;
  void *v8;
  size_t count;
  void *v10;
  size_t i;
  ...
  uint64_t v14;
  void *v15;
  GEOOfflineDataFetchAvailableKeysReply *v16;
  objc_super v18;
  ...
  if (v7)
  {
    ...
    if (count)
    {
      for (i = 0; i != count; ++i)
      {
        ...
        if (v12)
        {
          v13 = -[GEOOfflineDataKey initWithXPCDictionary:error:]([GEOOfflineDataKey alloc], "initWithXPCDictionary:error:", v12, a4);
          if (v13)
