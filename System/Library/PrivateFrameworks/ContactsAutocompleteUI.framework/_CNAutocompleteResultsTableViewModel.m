...
- (unint64_t)numberOfNonEmptySections
{
  ...
  v4[3] = &unk_1E62BEEC8;
  v4[4] = &v5;
  -[_CNAutocompleteResultsTableViewModel enumerateSections:](self, "enumerateSections:", v4);
  v2 = v6[3];
...
{
  _CNAutocompleteResultsTableViewModel *v4;
  _CNAutocompleteResultsTableViewModel *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)_CNAutocompleteResultsTableViewModel;
  v4 = -[_CNAutocompleteResultsTableViewModel init](&v7, sel_init);
  v5 = v4;
  if (v4)
    -[_CNAutocompleteResultsTableViewModel setNumberOfSections:](v4, "setNumberOfSections:", a3);
  return v5;
}
...
- (id)sectionAtIndex:(unint64_t)a3
{
  ...
  if (self->_numberOfSections >= a3)
  {
    ...
    if (!v3)
    {
      ...
      -[NSMutableDictionary setObject:forKey:](v8, "setObject:forKey:", v3, v9);
...
- (id)computeDiffForModel:(id)a3
{
  ...
  void *v19;
  uint64_t v20;
  _CNAutocompleteTableViewModelDiff *v21;
  ...
  if (v8 == -[_CNAutocompleteResultsTableViewModel numberOfSections](self, "numberOfSections")
    && -[_CNAutocompleteResultsTableViewModel numberOfSections](self, "numberOfSections"))
  {
    for (i = 0; i < -[_CNAutocompleteResultsTableViewModel numberOfSections](self, "numberOfSections"); ++i)
    {
      v10 = objc_msgSend(v4, "numberOfSections");
      if (v10 < -[_CNAutocompleteResultsTableViewModel numberOfSections](self, "numberOfSections"))
      {
        -[_CNAutocompleteResultsTableViewModel sectionAtIndex:](self, "sectionAtIndex:", i);
      ...
      if (v15 > -[_CNAutocompleteResultsTableViewModel numberOfSections](self, "numberOfSections"))
      {
        objc_msgSend(v4, "sectionAtIndex:", i);
...
LABEL_15:
  ...
  -[_CNAutocompleteTableViewModelDiff setChangedRows:](v21, "setChangedRows:", v7);
  -[_CNAutocompleteTableViewModelDiff setDeletedRows:](v21, "setDeletedRows:", v6);
  -[_CNAutocompleteTableViewModelDiff setInsertedRows:](v21, "setInsertedRows:", v5);
