...
{
  PHAMusicCacheMusicKitConsistencyJob *v2;
  NSObject *v3;
  NSObject *v4;
  dispatch_queue_t v5;
  ...
  v2 = -[PHAMusicCacheMusicKitConsistencyJob init](&v8, sel_init);
  if (v2)
  {
...
void __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke(uint64_t a1)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1CAC16000, v2, OS_LOG_TYPE_INFO, "[MemoriesMusic] MusicCacheMusicKitConsistencyJob - beginning music cache music consistency job", buf, 2u);
  }
  ...
  if (WeakRetained)
  {
    ...
    v6 = (void *)MEMORY[0x1E0D76108];
    v8[0] = MEMORY[0x1E0C809B0];
    v8[1] = 3221225472;
    v8[2] = __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_133;
    v8[3] = &unk_1E85213D8;
    v9 = *(id *)(a1 + 32);
    objc_msgSend(v6, "runWithPhotoLibrary:progressReporter:completionHandler:", v5, v4, v8);
...
void __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_133(uint64_t a1, int a2, void *a3)
{
  id v5;
  NSObject *v6;
  _DWORD v7[2];
  ...
  v5 = a3;
  if (__PXLog_genericOnceToken != -1)
    dispatch_once(&__PXLog_genericOnceToken, &__block_literal_global_135);
  ...
  if (os_log_type_enabled((os_log_t)__PXLog_genericOSLog, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 2114;
    v9 = v5;
    _os_log_impl(&dword_1CAC16000, v6, OS_LOG_TYPE_INFO, "[MemoriesMusic] MusicCacheMusicKitConsistencyJob - music cache music kit consistency job completed, success=%d, error=%{public}@", (uint8_t *)v7, 0x12u);
  }
  (*(void (**)(void))(*(_QWORD *)(a1 + 32) + 16))();

}

void __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_2_134()
{
  os_log_t v0;
  void *v1;
...
void __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_2()
{
  os_log_t v0;
  void *v1;
