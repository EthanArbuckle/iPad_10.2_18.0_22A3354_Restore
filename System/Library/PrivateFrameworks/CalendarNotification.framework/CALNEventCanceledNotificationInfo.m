...
- (CALNEventCanceledNotificationInfo)initWithSourceClientIdentifier:(id)a3 launchURL:(id)a4 expirationDate:(id)a5 eventInvitationNotification:(id)a6 eventRepresentationDictionary:(id)a7 isDelegate:(BOOL)a8 sourceTitle:(id)a9 sourceIdentifier:(id)a10
{
  ...
  id v21;
  id v22;
  CALNEventCanceledNotificationInfo *v23;
  uint64_t v24;
  ...
  v23 = -[CALNEventCanceledNotificationInfo init](&v37, sel_init);
  if (v23)
  {
...
- (id)description
{
  ...
  v3 = objc_opt_class();
  -[CALNEventCanceledNotificationInfo sourceClientIdentifier](self, "sourceClientIdentifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CALNEventCanceledNotificationInfo launchURL](self, "launchURL");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[CALNEventCanceledNotificationInfo expirationDate](self, "expirationDate");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[CALNEventCanceledNotificationInfo eventInvitationNotification](self, "eventInvitationNotification");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[CALNEventCanceledNotificationInfo eventRepresentationDictionary](self, "eventRepresentationDictionary");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[CALNEventCanceledNotificationInfo isDelegate](self, "isDelegate"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CALNEventCanceledNotificationInfo sourceTitle](self, "sourceTitle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[CALNEventCanceledNotificationInfo sourceIdentifier](self, "sourceIdentifier");
