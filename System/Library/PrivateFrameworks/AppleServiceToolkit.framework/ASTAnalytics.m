...
+ (void)sendAnalyticsWithEvent:(unint64_t)a3 error:(id)a4
{
  ...
  +[ASTAnalytics sendAnalyticsWithEvent:payloadDict:](ASTAnalytics, "sendAnalyticsWithEvent:payloadDict:", a3, v9);
...
+ (void)sendAnalyticsWithEvent:(unint64_t)a3 payloadDict:(id)a4
{
  ...
  if (+[ASTLinking isCoreAnalyticsFrameworkAvailable](ASTLinking, "isCoreAnalyticsFrameworkAvailable"))
    AnalyticsSendEvent();
