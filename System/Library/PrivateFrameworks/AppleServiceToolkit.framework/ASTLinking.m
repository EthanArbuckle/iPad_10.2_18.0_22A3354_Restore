...
void *__43__ASTLinking_isAXRuntimeFrameworkAvailable__block_invoke()
{
  ...
  result = dlopen((const char *)objc_msgSend(CFSTR("/System/Library/PrivateFrameworks/AXRuntime.framework/AXRuntime"), "UTF8String"), 1);
...
+ (BOOL)isCoreAnalyticsFrameworkAvailable
{
  if (isCoreAnalyticsFrameworkAvailable_coreAnalyticsFramework != -1)
    dispatch_once(&isCoreAnalyticsFrameworkAvailable_coreAnalyticsFramework, &__block_literal_global_6);
...
void *__47__ASTLinking_isCoreAnalyticsFrameworkAvailable__block_invoke()
{
  ...
  result = dlopen((const char *)objc_msgSend(CFSTR("/System/Library/PrivateFrameworks/CoreAnalytics.framework/CoreAnalytics"), "UTF8String"), 1);
...
+ (BOOL)isCheckerBoardServicesFrameworkAvailable
{
  if (isCheckerBoardServicesFrameworkAvailable_checkerBoardServicesFramework != -1)
    dispatch_once(&isCheckerBoardServicesFrameworkAvailable_checkerBoardServicesFramework, &__block_literal_global_7);
...
void *__54__ASTLinking_isCheckerBoardServicesFrameworkAvailable__block_invoke()
{
  ...
  result = dlopen((const char *)objc_msgSend(CFSTR("/System/Library/PrivateFrameworks/CheckerBoardServices.framework/CheckerBoardServices"), "UTF8String"), 1);
