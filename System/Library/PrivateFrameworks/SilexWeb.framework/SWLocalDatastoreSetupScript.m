...
{
  id v5;
  SWLocalDatastoreSetupScript *v6;
  ...
  v6 = -[SWLocalDatastoreSetupScript init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSString)identifier
{
  return (NSString *)CFSTR("localDatastore.setup");
}
...
- (WKUserScript)userScript
{
  ...
  -[SWLocalDatastoreSetupScript datastore](self, "datastore");
...
void __37__SWLocalDatastoreSetupScript_source__block_invoke()
{
  ...
  objc_msgSend(v0, "URLForResource:withExtension:", CFSTR("local-datastore-setup"), CFSTR("js"));
