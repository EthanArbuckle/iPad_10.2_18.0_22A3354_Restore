      ...
      if (v10)
      {
        ...
        while (2)
        {
          ...
          do
          {
            ...
            v15 = objc_msgSend(a1, "bb_isToneEnabledForAlertType:topic:", v7, v14);
...
LABEL_14:
    ...
    {
      v16 = objc_msgSend(a1, "bb_isToneEnabledForAlertType:topic:", v7, 0);
    }
...
- (uint64_t)bb_isToneEnabledForAlertConfiguration:()BulletinBoard
{
  ...
  objc_msgSend(a1, "bb_toneIdentifierForAlertConfiguration:");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v2 = objc_msgSend(v1, "isEqualToString:", *MEMORY[0x24BEB8DD0]) ^ 1;
