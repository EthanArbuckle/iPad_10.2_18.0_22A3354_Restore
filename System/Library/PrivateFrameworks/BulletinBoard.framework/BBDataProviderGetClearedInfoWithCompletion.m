...
void ___BBDataProviderGetClearedInfoWithCompletion_block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)BBLogGeneral, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v3;
    _os_log_impl(&dword_20CCB9000, v2, OS_LOG_TYPE_DEFAULT, "BBDataProvider: Get cleared info for section %{public}@", (uint8_t *)&v7, 0xCu);
  }
  v4 = (void *)MEMORY[0x212B94804]();
  objc_msgSend((id)__server, "_clearedInfoForSectionID:", *(_QWORD *)(a1 + 32));
