...
- (BBSectionIconVariant)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[BBSectionIconVariant init](self, "init");
  if (v5)
  {
    ...
    else
    {
      ...
      if (imageInfo)
        -[BBSectionIconVariant setImageData:](v5, "setImageData:", imageInfo);
      objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("imagePath"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      if (v8)
        -[BBSectionIconVariant setImageName:](v5, "setImageName:", v8);
      objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("applicationIdentifier"));
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      if (v8)
        -[BBSectionIconVariant setApplicationIdentifier:](v5, "setApplicationIdentifier:", v9);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = -[BBSectionIconVariant format](self, "format");
      if (v6 == -[BBSectionIconVariant format](v5, "format")
        && BSEqualObjects()
        && self->_imageInfoType == v5->_imageInfoType)
      {
        -[BBSectionIconVariant bundlePath](self, "bundlePath");
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[BBSectionIconVariant bundlePath](v5, "bundlePath");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        if (BSEqualObjects())
        {
          v9 = -[BBSectionIconVariant isPrecomposed](self, "isPrecomposed");
          v10 = v9 ^ -[BBSectionIconVariant isPrecomposed](v5, "isPrecomposed") ^ 1;
        }
        else
        {
          LOBYTE(v10) = 0;
...
- (unint64_t)hash
{
  ...
  v3 = -[BBSectionIconVariant format](self, "format");
  v4 = objc_msgSend(self->_imageInfo, "hash") ^ v3 ^ self->_imageInfoType;
  -[BBSectionIconVariant bundlePath](self, "bundlePath");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "hash");
  v7 = v4 ^ v6 ^ -[BBSectionIconVariant isPrecomposed](self, "isPrecomposed");
...
{
  id v5;
  BBSectionIconVariant *v6;

  v5 = a4;
  v6 = -[BBSectionIconVariant initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:]([BBSectionIconVariant alloc], "initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:", a3, v5, 1, 0, 0);
...
+ (id)variantWithFormat:(int64_t)a3 applicationIdentifier:(id)a4
{
  ...
  v5 = a4;
  v6 = -[BBSectionIconVariant initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:]([BBSectionIconVariant alloc], "initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:", a3, v5, 4, 0, 0);
...
+ (id)variantWithFormat:(int64_t)a3 imagePath:(id)a4
{
  ...
  v5 = a4;
  v6 = -[BBSectionIconVariant initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:]([BBSectionIconVariant alloc], "initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:", a3, v5, 2, 0, 0);
...
+ (id)variantWithFormat:(int64_t)a3 imageName:(id)a4 inBundleAtPath:(id)a5
{
  id v7;
  id v8;
  BBSectionIconVariant *v9;

  v7 = a5;
  v8 = a4;
  v9 = -[BBSectionIconVariant initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:]([BBSectionIconVariant alloc], "initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:", a3, v8, 3, v7, 0);
...
+ (id)variantWithFormat:(int64_t)a3 systemImageName:(id)a4
{
  ...
  v5 = a4;
  v6 = -[BBSectionIconVariant initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:]([BBSectionIconVariant alloc], "initWithFormat:imageInfo:imageInfoType:bundlePath:precomposed:", a3, v5, 5, 0, 0);
...
- (BBSectionIconVariant)initWithUNCSectionIconVariant:(id)a3
{
  ...
  if (v4
    && (v15.receiver = self,
        ...
        (self = -[BBSectionIconVariant init](&v15, sel_init)) != 0))
  {
    self->_format = objc_msgSend(v4, "format");
    ...
    self->_precomposed = objc_msgSend(v4, "isPrecomposed");
    objc_msgSend(v4, "imageData");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (v8)
      -[BBSectionIconVariant setImageData:](self, "setImageData:", v8);
    objc_msgSend(v4, "imagePath");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if (v9)
      -[BBSectionIconVariant setImagePath:](self, "setImagePath:", v9);
    objc_msgSend(v4, "imageName");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if (v10)
      -[BBSectionIconVariant setImageName:](self, "setImageName:", v10);
    objc_msgSend(v4, "applicationIdentifier");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    if (v11)
      -[BBSectionIconVariant setApplicationIdentifier:](self, "setApplicationIdentifier:", v11);
    objc_msgSend(v4, "systemImageName");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if (v12)
      -[BBSectionIconVariant setSystemImageName:](self, "setSystemImageName:", v12);
    self = self;
...
{
  -[BBSectionIconVariant _setImageInfo:ofType:](self, "_setImageInfo:ofType:", a3, 1);
}
...
{
  -[BBSectionIconVariant _setImageInfo:ofType:](self, "_setImageInfo:ofType:", a3, 2);
}
...
{
  -[BBSectionIconVariant _setImageInfo:ofType:](self, "_setImageInfo:ofType:", a3, 3);
}
...
{
  -[BBSectionIconVariant _setImageInfo:ofType:](self, "_setImageInfo:ofType:", a3, 4);
}
...
{
  -[BBSectionIconVariant _setImageInfo:ofType:](self, "_setImageInfo:ofType:", a3, 5);
}
...
- (BBSectionIconVariant)initWithFormat:(int64_t)a3 imageInfo:(id)a4 imageInfoType:(int64_t)a5 bundlePath:(id)a6 precomposed:(BOOL)a7
{
  id v12;
  id v13;
  BBSectionIconVariant *v14;
  BBSectionIconVariant *v15;
  uint64_t v16;
  id imageInfo;
  uint64_t v18;
  NSString *bundlePath;
  ...
  v14 = -[BBSectionIconVariant init](&v21, sel_init);
  v15 = v14;
  if (v14)
  {
    v14->_format = a3;
    -[BBSectionIconVariant _processImageInfo:imageInfoType:](v14, "_processImageInfo:imageInfoType:", v12, a5);
...
- (id)_processImageInfo:(id)a3 imageInfoType:(int64_t)a4
{
  ...
  if (a4 == 1)
  {
    ...
    -[NSObject bb_objectCache](self, "bb_objectCache");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_setImageInfo:(id)a3 ofType:(int64_t)a4
{
  ...
  if (v6)
  {
    ...
    v10 = v6;
    -[BBSectionIconVariant _processImageInfo:imageInfoType:](self, "_processImageInfo:imageInfoType:", v6, a4);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    imageInfo = self->_imageInfo;
    self->_imageInfo = v8;
LABEL_5:
