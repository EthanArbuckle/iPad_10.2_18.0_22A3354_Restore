...
{
  id v4;
  _BlastDoorLPiTunesMediaMovieBundleMetadata *v5;
  uint64_t v6;
  ...
  _BlastDoorLPiTunesMediaMovieBundleMetadata *v18;
  objc_super v20;
  uint64_t v21;
  ...
  v5 = -[_BlastDoorLPiTunesMediaMovieBundleMetadata init](&v20, sel_init);
  if (v5)
  {
...
{
  _BlastDoorLPiTunesMediaMovieBundleMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  _BlastDoorLPiTunesMediaMovieBundleMetadata *v11;

  v4 = +[_BlastDoorLPiTunesMediaMovieBundleMetadata allocWithZone:](_BlastDoorLPiTunesMediaMovieBundleMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[_BlastDoorLPiTunesMediaMovieBundleMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieBundleMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[_BlastDoorLPiTunesMediaMovieBundleMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieBundleMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[_BlastDoorLPiTunesMediaMovieBundleMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieBundleMetadata setName:](v4, "setName:", v7);

    -[_BlastDoorLPiTunesMediaMovieBundleMetadata genre](self, "genre");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieBundleMetadata setGenre:](v4, "setGenre:", v8);

    -[_BlastDoorLPiTunesMediaMovieBundleMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieBundleMetadata setArtwork:](v4, "setArtwork:", v9);

    -[_BlastDoorLPiTunesMediaMovieBundleMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieBundleMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPiTunesMediaMovieBundleMetadata isEqual:](&v14, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
