...
{
  id v4;
  _BlastDoorLPiTunesMediaPodcastMetadata *v5;
  uint64_t v6;
  ...
  uint64_t v18;
  NSArray *offers;
  _BlastDoorLPiTunesMediaPodcastMetadata *v20;
  objc_super v22;
  uint64_t v23;
  ...
  v5 = -[_BlastDoorLPiTunesMediaPodcastMetadata init](&v22, sel_init);
  if (v5)
  {
...
{
  _BlastDoorLPiTunesMediaPodcastMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  void *v10;
  void *v11;
  _BlastDoorLPiTunesMediaPodcastMetadata *v12;

  v4 = +[_BlastDoorLPiTunesMediaPodcastMetadata allocWithZone:](_BlastDoorLPiTunesMediaPodcastMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[_BlastDoorLPiTunesMediaPodcastMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaPodcastMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[_BlastDoorLPiTunesMediaPodcastMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaPodcastMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[_BlastDoorLPiTunesMediaPodcastMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaPodcastMetadata setName:](v4, "setName:", v7);

    -[_BlastDoorLPiTunesMediaPodcastMetadata artist](self, "artist");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaPodcastMetadata setArtist:](v4, "setArtist:", v8);

    -[_BlastDoorLPiTunesMediaPodcastMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaPodcastMetadata setArtwork:](v4, "setArtwork:", v9);

    -[_BlastDoorLPiTunesMediaPodcastMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaPodcastMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);

    -[_BlastDoorLPiTunesMediaPodcastMetadata offers](self, "offers");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaPodcastMetadata setOffers:](v4, "setOffers:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPiTunesMediaPodcastMetadata isEqual:](&v15, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v7 | (unint64_t)self->_storeFrontIdentifier && !objc_msgSend((id)v7, "isEqual:")
        ...
        || (v10 = v6[5], v10 | (unint64_t)self->_artist) && !objc_msgSend((id)v10, "isEqual:")
        || (v11 = v6[6], v11 | (unint64_t)self->_artwork) && !objc_msgSend((id)v11, "isEqual:")
        || (v12 = v6[7], v12 | (unint64_t)self->_artworkMetadata)
