...
{
  id v4;
  _BlastDoorLPiTunesMediaMusicVideoMetadata *v5;
  uint64_t v6;
  ...
  _BlastDoorLPiTunesMediaMusicVideoMetadata *v18;
  objc_super v20;
  uint64_t v21;
  ...
  v5 = -[_BlastDoorLPiTunesMediaMusicVideoMetadata init](&v20, sel_init);
  if (v5)
  {
...
{
  _BlastDoorLPiTunesMediaMusicVideoMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  _BlastDoorLPiTunesMediaMusicVideoMetadata *v11;

  v4 = +[_BlastDoorLPiTunesMediaMusicVideoMetadata allocWithZone:](_BlastDoorLPiTunesMediaMusicVideoMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[_BlastDoorLPiTunesMediaMusicVideoMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMusicVideoMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[_BlastDoorLPiTunesMediaMusicVideoMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMusicVideoMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[_BlastDoorLPiTunesMediaMusicVideoMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMusicVideoMetadata setName:](v4, "setName:", v7);

    -[_BlastDoorLPiTunesMediaMusicVideoMetadata artist](self, "artist");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMusicVideoMetadata setArtist:](v4, "setArtist:", v8);

    -[_BlastDoorLPiTunesMediaMusicVideoMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMusicVideoMetadata setArtwork:](v4, "setArtwork:", v9);

    -[_BlastDoorLPiTunesMediaMusicVideoMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMusicVideoMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPiTunesMediaMusicVideoMetadata isEqual:](&v14, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
