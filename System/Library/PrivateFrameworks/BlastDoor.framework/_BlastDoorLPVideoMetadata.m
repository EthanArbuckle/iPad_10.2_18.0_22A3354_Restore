...
{
  _BlastDoorLPVideoMetadata *v2;
  _BlastDoorLPVideoMetadata *v3;
  _BlastDoorLPVideoMetadata *v4;
  objc_super v6;
  uint64_t v7;
  ...
  v2 = -[_BlastDoorLPVideoMetadata init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
    v2->_version = 1;
...
- (id)_initWithDictionary:(id)a3
{
  ...
  CGFloat v14;
  CGFloat v15;
  _BlastDoorLPVideoMetadata *v16;

  v4 = a3;
  v5 = -[_BlastDoorLPVideoMetadata init](self, "init");
  if (v5
    && (URLForKey(v4, CFSTR("LPMetadataVideoURL")),
        ...
        v5->_URL))
  {
    ...
    numberForKey(v4, CFSTR("LPMetadataVideoWidth"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    numberForKey(v4, CFSTR("LPMetadataVideoHeight"));
...
- (_BlastDoorLPVideoMetadata)initWithCoder:(id)a3
{
  ...
  v5 = -[_BlastDoorLPVideoMetadata init](&v16, sel_init);
  if (v5)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPVideoMetadata isEqual:](&v13, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
