...
{
  id v4;
  _BlastDoorLPiTunesMediaAlbumMetadata *v5;
  uint64_t v6;
  ...
  uint64_t v18;
  NSArray *offers;
  _BlastDoorLPiTunesMediaAlbumMetadata *v20;
  objc_super v22;
  uint64_t v23;
  ...
  v5 = -[_BlastDoorLPiTunesMediaAlbumMetadata init](&v22, sel_init);
  if (v5)
  {
...
{
  _BlastDoorLPiTunesMediaAlbumMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  void *v10;
  void *v11;
  _BlastDoorLPiTunesMediaAlbumMetadata *v12;

  v4 = +[_BlastDoorLPiTunesMediaAlbumMetadata allocWithZone:](_BlastDoorLPiTunesMediaAlbumMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[_BlastDoorLPiTunesMediaAlbumMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaAlbumMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[_BlastDoorLPiTunesMediaAlbumMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaAlbumMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[_BlastDoorLPiTunesMediaAlbumMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaAlbumMetadata setName:](v4, "setName:", v7);

    -[_BlastDoorLPiTunesMediaAlbumMetadata artist](self, "artist");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaAlbumMetadata setArtist:](v4, "setArtist:", v8);

    -[_BlastDoorLPiTunesMediaAlbumMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaAlbumMetadata setArtwork:](v4, "setArtwork:", v9);

    -[_BlastDoorLPiTunesMediaAlbumMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaAlbumMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);

    -[_BlastDoorLPiTunesMediaAlbumMetadata offers](self, "offers");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaAlbumMetadata setOffers:](v4, "setOffers:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPiTunesMediaAlbumMetadata isEqual:](&v15, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
