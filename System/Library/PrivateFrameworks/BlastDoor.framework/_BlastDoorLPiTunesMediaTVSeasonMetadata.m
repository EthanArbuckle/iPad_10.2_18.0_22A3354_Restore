...
{
  id v4;
  _BlastDoorLPiTunesMediaTVSeasonMetadata *v5;
  uint64_t v6;
  ...
  _BlastDoorLPiTunesMediaTVSeasonMetadata *v18;
  objc_super v20;
  uint64_t v21;
  ...
  v5 = -[_BlastDoorLPiTunesMediaTVSeasonMetadata init](&v20, sel_init);
  if (v5)
  {
...
{
  _BlastDoorLPiTunesMediaTVSeasonMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  _BlastDoorLPiTunesMediaTVSeasonMetadata *v11;

  v4 = +[_BlastDoorLPiTunesMediaTVSeasonMetadata allocWithZone:](_BlastDoorLPiTunesMediaTVSeasonMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[_BlastDoorLPiTunesMediaTVSeasonMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaTVSeasonMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[_BlastDoorLPiTunesMediaTVSeasonMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaTVSeasonMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[_BlastDoorLPiTunesMediaTVSeasonMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaTVSeasonMetadata setName:](v4, "setName:", v7);

    -[_BlastDoorLPiTunesMediaTVSeasonMetadata genre](self, "genre");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaTVSeasonMetadata setGenre:](v4, "setGenre:", v8);

    -[_BlastDoorLPiTunesMediaTVSeasonMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaTVSeasonMetadata setArtwork:](v4, "setArtwork:", v9);

    -[_BlastDoorLPiTunesMediaTVSeasonMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaTVSeasonMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPiTunesMediaTVSeasonMetadata isEqual:](&v14, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
