...
{
  id v4;
  _BlastDoorLPiTunesMediaRadioMetadata *v5;
  uint64_t v6;
  ...
  _BlastDoorLPiTunesMediaRadioMetadata *v18;
  objc_super v20;
  uint64_t v21;
  ...
  v5 = -[_BlastDoorLPiTunesMediaRadioMetadata init](&v20, sel_init);
  if (v5)
  {
...
{
  _BlastDoorLPiTunesMediaRadioMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  _BlastDoorLPiTunesMediaRadioMetadata *v11;

  v4 = +[_BlastDoorLPiTunesMediaRadioMetadata allocWithZone:](_BlastDoorLPiTunesMediaRadioMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[_BlastDoorLPiTunesMediaRadioMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaRadioMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[_BlastDoorLPiTunesMediaRadioMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaRadioMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[_BlastDoorLPiTunesMediaRadioMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaRadioMetadata setName:](v4, "setName:", v7);

    -[_BlastDoorLPiTunesMediaRadioMetadata curator](self, "curator");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaRadioMetadata setCurator:](v4, "setCurator:", v8);

    -[_BlastDoorLPiTunesMediaRadioMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaRadioMetadata setArtwork:](v4, "setArtwork:", v9);

    -[_BlastDoorLPiTunesMediaRadioMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaRadioMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPiTunesMediaRadioMetadata isEqual:](&v14, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
