...
- (id)description
{
  ...
  -[_BlastDoorASCodableWorkout description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_BlastDoorASCodableWorkout dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_33:
  ...
  {
LABEL_10:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_goalInCanonicalUnit);
...
LABEL_11:
  ...
  if ((v9 & 0x200) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isWatchWorkout);
  ...
  if ((v9 & 0x100) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isIndoorWorkout);
...
- (unint64_t)hash
{
  ...
  v43 = -[_BlastDoorASCodableSample hash](self->_sample, "hash");
  has = (__int16)self->_has;
  if ((has & 0x80) != 0)
  {
...
LABEL_15:
  ...
  if (*((_QWORD *)v4 + 13))
  {
    -[_BlastDoorASCodableWorkout setSeymourCatalogWorkoutIdentifier:](self, "setSeymourCatalogWorkoutIdentifier:");
    v4 = v9;
  }
  if (*((_QWORD *)v4 + 14))
  {
