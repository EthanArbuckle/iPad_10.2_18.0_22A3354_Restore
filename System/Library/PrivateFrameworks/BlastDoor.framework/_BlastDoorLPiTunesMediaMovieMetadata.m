...
{
  id v4;
  _BlastDoorLPiTunesMediaMovieMetadata *v5;
  uint64_t v6;
  ...
  _BlastDoorLPiTunesMediaMovieMetadata *v18;
  objc_super v20;
  uint64_t v21;
  ...
  v5 = -[_BlastDoorLPiTunesMediaMovieMetadata init](&v20, sel_init);
  if (v5)
  {
...
{
  _BlastDoorLPiTunesMediaMovieMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  _BlastDoorLPiTunesMediaMovieMetadata *v11;

  v4 = +[_BlastDoorLPiTunesMediaMovieMetadata allocWithZone:](_BlastDoorLPiTunesMediaMovieMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[_BlastDoorLPiTunesMediaMovieMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[_BlastDoorLPiTunesMediaMovieMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[_BlastDoorLPiTunesMediaMovieMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieMetadata setName:](v4, "setName:", v7);

    -[_BlastDoorLPiTunesMediaMovieMetadata genre](self, "genre");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieMetadata setGenre:](v4, "setGenre:", v8);

    -[_BlastDoorLPiTunesMediaMovieMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieMetadata setArtwork:](v4, "setArtwork:", v9);

    -[_BlastDoorLPiTunesMediaMovieMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_BlastDoorLPiTunesMediaMovieMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPiTunesMediaMovieMetadata isEqual:](&v14, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
...
{
  objc_storeStrong((id *)&self->_branding, a3);
}
...
{
  objc_storeStrong((id *)&self->_brandingText, a3);
}
