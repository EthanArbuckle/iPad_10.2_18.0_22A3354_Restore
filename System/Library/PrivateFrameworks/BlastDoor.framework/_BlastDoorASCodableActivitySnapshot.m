...
- (id)description
{
  ...
  -[_BlastDoorASCodableActivitySnapshot description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_BlastDoorASCodableActivitySnapshot dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (unint64_t)hash
{
  ...
  v70 = -[_BlastDoorASCodableSample hash](self->_sample, "hash");
