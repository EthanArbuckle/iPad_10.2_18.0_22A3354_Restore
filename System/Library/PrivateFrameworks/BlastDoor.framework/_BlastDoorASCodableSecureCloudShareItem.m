...
- (id)description
{
  ...
  -[_BlastDoorASCodableSecureCloudShareItem description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_BlastDoorASCodableSecureCloudShareItem dictionaryRepresentation](self, "dictionaryRepresentation");
