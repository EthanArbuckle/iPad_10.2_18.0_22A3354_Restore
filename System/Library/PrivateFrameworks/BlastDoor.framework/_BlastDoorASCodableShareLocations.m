...
- (id)description
{
  ...
  -[_BlastDoorASCodableShareLocations description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_BlastDoorASCodableShareLocations dictionaryRepresentation](self, "dictionaryRepresentation");
