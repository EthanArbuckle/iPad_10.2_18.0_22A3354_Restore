...
{
  _BlastDoorLPIconMetadata *v2;
  _BlastDoorLPIconMetadata *v3;
  _BlastDoorLPIconMetadata *v4;
  objc_super v6;
  uint64_t v7;
  ...
  v2 = -[_BlastDoorLPIconMetadata init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
    v2->_version = 1;
...
{
  id v5;
  _BlastDoorLPIconMetadata *v6;
  _BlastDoorLPIconMetadata *v7;
  _BlastDoorLPIconMetadata *v8;

  v5 = a3;
  v6 = -[_BlastDoorLPIconMetadata init](self, "init");
  v7 = v6;
  if (v6)
  {
...
{
  id v4;
  _BlastDoorLPIconMetadata *v5;
  uint64_t v6;
  NSURL *URL;
  uint64_t v8;
  NSString *accessibilityText;
  _BlastDoorLPIconMetadata *v10;
  objc_super v12;
  uint64_t v13;
  ...
  v5 = -[_BlastDoorLPIconMetadata init](&v12, sel_init);
  if (v5)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_BlastDoorLPIconMetadata isEqual:](&v11, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
