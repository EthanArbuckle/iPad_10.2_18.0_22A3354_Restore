...
- (void)setState:(id)a3
{
  ...
  v4 = *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC11DockKitCore12SensorButton_state);
...
{
  return (NSString *)sub_23A5C0220(self, (uint64_t)a2, (void (*)(void))sub_23A633C84);
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v6;
  void *v7;
  _TtC11DockKitCore12SensorButton *v8;

  v5 = *(id *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC11DockKitCore12SensorButton_state);
  v6 = a3;
  v8 = self;
