...
{
  return _AXSafeSwiftDoubleForKey(self, (uint64_t)a3);
}

- (double)safeSwiftCGFloatForKey:(id)a3
{
  return _AXSafeSwiftCGFloatForKey(self, (uint64_t)a3);
}
...
- (CGPoint)safeSwiftCGPointForKey:(id)a3
{
  ...
  v3 = _AXSafeSwiftCGPointForKey(self, (uint64_t)a3);
  result.y = v4;
  result.x = v3;
  return result;
}
...
- (CGSize)safeSwiftCGSizeForKey:(id)a3
{
  ...
  v3 = _AXSafeSwiftCGSizeForKey(self, (uint64_t)a3);
  result.height = v4;
  result.width = v3;
  return result;
}
...
{
  _AXSafeSwiftCallAsFunctionForKey();
}
