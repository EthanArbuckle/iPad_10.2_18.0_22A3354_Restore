...
- (id)_axDictionaryQueue
{
  ...
  return (id)_axDictionaryQueue__sDictionaryQueue_0;
}
...
- (id)_accessibilityValueForKey:()AXSideStorage
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      -[NSObject(AXSideStorage) _accessibilityValueForKey:].cold.1((uint64_t)a1, v9);
...
LABEL_8:
        ...
        case 2:
          ...
          if ((objc_opt_isKindOfClass() & 1) == 0)
            _AXAssert(0, (uint64_t)"/Library/Caches/com.apple.xbs/Sources/AccessibilityLibraries/Source/AXCoreUtilities/source/Swizzling/AXSideStorage_Implementation.m", (void *)0x6F, (uint64_t)"-[NSObject(AXSideStorage) _accessibilitySetValue:forKey:storageMode:]", CFSTR("value is not a wrapper class: %@"), v14, v15, v16, (uint64_t)v11);
          goto LABEL_8;
      }
    }
    else
...
LABEL_16:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    -[NSObject(AXSideStorage) _accessibilitySetValue:forKey:storageMode:].cold.1((uint64_t)v8, (uint64_t)a1, v17);
