...
void __get_SWCollaborationMetadataClass_block_invoke_cold_1()
{
  ...
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", v1, CFSTR("SFCollaborationUtilities.m"), 120, CFSTR("Unable to find class %s"), "_SWCollaborationMetadata");
