...
{
  SiriContinuitySource *v2;
  SiriContinuitySource *v3;
  objc_super v5;
  ...
  v3 = v2;
  if (v2)
    -[SiriContinuitySource configureConnection](v2, "configureConnection");
  return v3;
}
...
void __43__SiriContinuitySource_configureConnection__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v16[1] = 3221225472;
    v16[2] = __43__SiriContinuitySource_configureConnection__block_invoke_2;
    v16[3] = &unk_1E91FC438;
    v11 = v7;
    v17 = v11;
    objc_msgSend(v3, "setInvalidationHandler:", v16);
    objc_msgSend(v3, "setInterruptionHandler:", &__block_literal_global_17);
    v13[0] = v10;
    v13[1] = 3221225472;
    v13[2] = __43__SiriContinuitySource_configureConnection__block_invoke_20;
    v13[3] = &unk_1E91FC480;
...
void __43__SiriContinuitySource_configureConnection__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "unregisterNonButtonSourceWithType:withUUID:", &unk_1E920E3D0, *(_QWORD *)(a1 + 32));

}

void __43__SiriContinuitySource_configureConnection__block_invoke_18(uint64_t a1, void *a2)
{
  id v2;
  NSObject *v3;
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0CFE6A0], OS_LOG_TYPE_ERROR))
    __43__SiriContinuitySource_configureConnection__block_invoke_18_cold_1((uint64_t)v2, v3);

}

void __43__SiriContinuitySource_configureConnection__block_invoke_20(uint64_t a1, void *a2)
{
  id v3;
  ...
  if (WeakRetained)
  {
    ...
    {
      v8 = 136315394;
      v9 = "-[SiriContinuitySource configureConnection]_block_invoke";
      v10 = 2112;
      v11 = v3;
    ...
    objc_msgSend(v3, "remoteTarget");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "registerNonButtonSourceWithType:withUUID:", &unk_1E920E3D0, *(_QWORD *)(a1 + 32));
...
- (void)activateWithContext:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "activationRequestFromContinuityWithContext:", v5);

  os_unfair_lock_unlock(p_lock);
}

void __43__SiriContinuitySource_configureConnection__block_invoke_18_cold_1(uint64_t a1, NSObject *a2)
{
  int v2;
  const char *v3;
  __int16 v4;
  ...
  v2 = 136315394;
  v3 = "-[SiriContinuitySource configureConnection]_block_invoke";
  v4 = 2112;
  v5 = a1;
