...
- (SASLockStateTransport)initWithSASLockState:(unint64_t)a3
{
  ...
  v4 = -[SASLockStateTransport init](&v7, sel_init);
  if (v4)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a3);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[SASLockStateTransport setTransport:](v4, "setTransport:", v5);
...
- (id)description
{
  ...
  -[SASLockStateTransport transport](self, "transport");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("SASLockStateTransport:%@"), v3);
...
{
  return (id)objc_msgSend(objc_alloc((Class)objc_opt_class()), "initWithSASLockState:", -[SASLockStateTransport SASLockState](self, "SASLockState"));
}
...
- (SASLockStateTransport)initWithCoder:(id)a3
{
  ...
  v5 = -[SASLockStateTransport init](&v9, sel_init);
  if (v5)
  {
