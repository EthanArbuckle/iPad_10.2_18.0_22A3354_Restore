...
{
  SiriSpotlightSource *v2;
  SiriSpotlightSource *v3;
  objc_super v5;
  ...
  v3 = v2;
  if (v2)
    -[SiriSpotlightSource configureConnection](v2, "configureConnection");
  return v3;
}
...
void __42__SiriSpotlightSource_configureConnection__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v16[1] = 3221225472;
    v16[2] = __42__SiriSpotlightSource_configureConnection__block_invoke_2;
    v16[3] = &unk_1E91FC438;
    v11 = v7;
    v17 = v11;
    ...
    v13[0] = v10;
    v13[1] = 3221225472;
    v13[2] = __42__SiriSpotlightSource_configureConnection__block_invoke_20;
    v13[3] = &unk_1E91FC480;
...
void __42__SiriSpotlightSource_configureConnection__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "unregisterNonButtonSourceWithType:withUUID:", &unk_1E920E268, *(_QWORD *)(a1 + 32));

}

void __42__SiriSpotlightSource_configureConnection__block_invoke_18(uint64_t a1, void *a2)
{
  id v2;
  NSObject *v3;
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0CFE6A0], OS_LOG_TYPE_ERROR))
    __42__SiriSpotlightSource_configureConnection__block_invoke_18_cold_1((uint64_t)v2, v3);

}

void __42__SiriSpotlightSource_configureConnection__block_invoke_20(uint64_t a1, void *a2)
{
  id v3;
  ...
  if (WeakRetained)
  {
    ...
    objc_msgSend(v3, "remoteTarget");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "registerNonButtonSourceWithType:withUUID:", &unk_1E920E268, *(_QWORD *)(a1 + 32));
...
- (void)activateWithContext:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "activationRequestFromSpotlightWithContext:", v5);

  os_unfair_lock_unlock(p_lock);
}

void __42__SiriSpotlightSource_configureConnection__block_invoke_18_cold_1(uint64_t a1, NSObject *a2)
{
  int v2;
  const char *v3;
  __int16 v4;
