...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 12999, self->_name);
    v7[2](v7, v5);

  }
  if (self->_nickname)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 13000, self->_nickname);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    -[CCHealthMedicationContent name](self, "name");
  ...
  if (self->_nickname)
  {
    -[CCHealthMedicationContent nickname](self, "nickname");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("nickname"));
...
- (CCHealthMedicationContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCHealthMedicationContent initWithName:nickname:error:]([CCHealthMedicationContent alloc], "initWithName:nickname:error:", v9, v10, a4);
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  if ((a3 - 12996) > 4)
    ...
    return *(&off_25102FFE0 + (unsigned __int16)(a3 - 12996));
}
