...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 27128, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCFindMyDeviceMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCFindMyDeviceMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCFindMyDeviceMetaContent initWithSourceItemIdentifier:error:]([CCFindMyDeviceMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
