...
- (CCAppCustomPhotoAlbumNameMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4
{
  ...
  id v9;
  void *v10;
  CCAppCustomPhotoAlbumNameMetaContent *v11;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 53487, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCAppCustomPhotoAlbumNameMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCAppCustomPhotoAlbumNameMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  CCAppCustomPhotoAlbumNameMetaContent *v10;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCAppCustomPhotoAlbumNameMetaContent initWithSourceItemIdentifier:error:]([CCAppCustomPhotoAlbumNameMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
