...
- (NSString)author
{
  return (NSString *)(id)-[NSString copy](self->_author, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 42189, self->_name);
    v7[2](v7, v5);

  }
  if (self->_author)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 42190, self->_author);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_author)
  {
    -[CCPodcastShow author](self, "author");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("author"));
...
- (CCPodcastShow)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCPodcastShow initWithName:author:error:]([CCPodcastShow alloc], "initWithName:author:error:", v9, v10, a4);
