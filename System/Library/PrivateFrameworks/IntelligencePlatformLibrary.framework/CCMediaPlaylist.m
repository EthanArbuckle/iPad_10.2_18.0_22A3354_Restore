...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 18562, self->_name);
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    -[CCMediaPlaylist name](self, "name");
...
- (CCMediaPlaylist)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCMediaPlaylist initWithName:error:]([CCMediaPlaylist alloc], "initWithName:error:", v9, a4);
