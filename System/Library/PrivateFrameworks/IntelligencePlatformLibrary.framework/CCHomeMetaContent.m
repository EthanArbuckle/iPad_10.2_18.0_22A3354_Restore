...
{
  return (NSString *)(id)-[NSString copy](self->_assistantHomeKitIdentifier, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 7699, self->_sourceItemIdentifier);
    v7[2](v7, v5);

  }
  if (self->_assistantHomeKitIdentifier)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 7700, self->_assistantHomeKitIdentifier);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCHomeMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
  ...
  if (self->_assistantHomeKitIdentifier)
  {
    -[CCHomeMetaContent assistantHomeKitIdentifier](self, "assistantHomeKitIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("assistantHomeKitIdentifier"));
...
- (CCHomeMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("assistantHomeKitIdentifier"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCHomeMetaContent initWithSourceItemIdentifier:assistantHomeKitIdentifier:error:]([CCHomeMetaContent alloc], "initWithSourceItemIdentifier:assistantHomeKitIdentifier:error:", v9, v10, a4);
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  ...
  v3 = CFSTR("assistantHomeKitIdentifier");
  if (a3 != 7700)
    v3 = 0;
  if (a3 == 7699)
