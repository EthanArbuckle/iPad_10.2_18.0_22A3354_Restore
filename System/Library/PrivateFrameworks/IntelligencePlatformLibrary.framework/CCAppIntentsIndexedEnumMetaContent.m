...
- (CCAppIntentsIndexedEnumMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4
{
  ...
  id v9;
  void *v10;
  CCAppIntentsIndexedEnumMetaContent *v11;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 42615, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCAppIntentsIndexedEnumMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCAppIntentsIndexedEnumMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  CCAppIntentsIndexedEnumMetaContent *v10;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCAppIntentsIndexedEnumMetaContent initWithSourceItemIdentifier:error:]([CCAppIntentsIndexedEnumMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
