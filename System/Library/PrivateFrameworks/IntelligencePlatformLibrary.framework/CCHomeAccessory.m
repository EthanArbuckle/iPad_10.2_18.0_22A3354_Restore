...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 7702, self->_name);
    v7[2](v7, v5);

  }
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:enumValue:", 7703, self->_deviceType);
  v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    -[CCHomeAccessory name](self, "name");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("name"));

  }
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[CCHomeAccessory deviceType](self, "deviceType"));
...
- (CCHomeAccessory)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    if (v10)
      ...
      v12 = 0;
    v13 = -[CCHomeAccessory initWithName:deviceType:error:]([CCHomeAccessory alloc], "initWithName:deviceType:error:", v9, v12, a4);
