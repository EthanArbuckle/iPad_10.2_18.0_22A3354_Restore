...
- (CCContactInstantMessageAddress)initWithLabel:(id)a3 username:(id)a4 serviceName:(id)a5 error:(id *)a6
{
  ...
  id v16;
  int v17;
  CCContactInstantMessageAddress *v18;
  int v19;
  void *v20;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19744, self->_label);
    v8[2](v8, v5);

  }
  if (self->_username)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19745, self->_username);
    v8[2](v8, v6);

  }
  if (self->_serviceName)
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19746, self->_serviceName);
    v8[2](v8, v7);
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    -[CCContactInstantMessageAddress label](self, "label");
  ...
  if (self->_username)
  {
    -[CCContactInstantMessageAddress username](self, "username");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("username"));

  }
  if (self->_serviceName)
  {
    -[CCContactInstantMessageAddress serviceName](self, "serviceName");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("serviceName"));
...
- (CCContactInstantMessageAddress)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v10;
  void *v11;
  CCContactInstantMessageAddress *v12;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v12 = -[CCContactInstantMessageAddress initWithLabel:username:serviceName:error:]([CCContactInstantMessageAddress alloc], "initWithLabel:username:serviceName:error:", v9, v10, v11, a4);
