...
- (NSString)email
{
  return (NSString *)(id)-[NSString copy](self->_email, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19765, self->_label);
    v7[2](v7, v5);

  }
  if (self->_email)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19776, self->_email);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    -[CCContactEmailAddress label](self, "label");
  ...
  if (self->_email)
  {
    -[CCContactEmailAddress email](self, "email");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("email"));
...
- (CCContactEmailAddress)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCContactEmailAddress initWithLabel:email:error:]([CCContactEmailAddress alloc], "initWithLabel:email:error:", v9, v10, a4);
