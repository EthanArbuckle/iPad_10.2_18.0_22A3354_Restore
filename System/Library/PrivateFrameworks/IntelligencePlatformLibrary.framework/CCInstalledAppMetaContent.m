...
{
  return (NSString *)(id)-[NSString copy](self->_bundleVersion, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 36445, self->_sourceItemIdentifier);
    v7[2](v7, v5);

  }
  if (self->_bundleVersion)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 36446, self->_bundleVersion);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCInstalledAppMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
  ...
  if (self->_bundleVersion)
  {
    -[CCInstalledAppMetaContent bundleVersion](self, "bundleVersion");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("bundleVersion"));
...
- (CCInstalledAppMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCInstalledAppMetaContent initWithSourceItemIdentifier:bundleVersion:error:]([CCInstalledAppMetaContent alloc], "initWithSourceItemIdentifier:bundleVersion:error:", v9, v10, a4);
