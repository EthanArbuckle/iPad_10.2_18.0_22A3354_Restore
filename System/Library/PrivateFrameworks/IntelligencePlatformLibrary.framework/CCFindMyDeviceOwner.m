...
- (NSString)firstName
{
  return (NSString *)(id)-[NSString copy](self->_firstName, "copy");
}

- (NSString)lastName
{
  return (NSString *)(id)-[NSString copy](self->_lastName, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_firstName)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 27131, self->_firstName);
    v7[2](v7, v5);

  }
  if (self->_lastName)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 27132, self->_lastName);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_firstName)
  {
    -[CCFindMyDeviceOwner firstName](self, "firstName");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("firstName"));

  }
  if (self->_lastName)
  {
    -[CCFindMyDeviceOwner lastName](self, "lastName");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("lastName"));
...
- (CCFindMyDeviceOwner)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  {
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("firstName"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("lastName"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCFindMyDeviceOwner initWithFirstName:lastName:error:]([CCFindMyDeviceOwner alloc], "initWithFirstName:lastName:error:", v9, v10, a4);
