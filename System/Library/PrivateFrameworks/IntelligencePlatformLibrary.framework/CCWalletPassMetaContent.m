...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 46123, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCWalletPassMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCWalletPassMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCWalletPassMetaContent initWithSourceItemIdentifier:error:]([CCWalletPassMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
