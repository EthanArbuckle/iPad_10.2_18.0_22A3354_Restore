...
- (CCAppEntityTypeDisplayRepresentation)initWithName:(id)a3 synonyms:(id)a4 error:(id *)a5
{
  ...
  uint64_t v19;
  void *v20;
  CCAppEntityTypeDisplayRepresentation *v21;
  __int128 v23;
  __int128 v24;
  __int128 v25;
  __int128 v26;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 47352, self->_name);
    v7[2](v7, v5);

  }
  if (self->_synonyms)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:repeatedStringValue:", 47353, self->_synonyms);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    -[CCAppEntityTypeDisplayRepresentation name](self, "name");
  ...
  if (self->_synonyms)
  {
    -[CCAppEntityTypeDisplayRepresentation synonyms](self, "synonyms");
...
- (CCAppEntityTypeDisplayRepresentation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  void *v10;
  CCAppEntityTypeDisplayRepresentation *v11;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v11 = -[CCAppEntityTypeDisplayRepresentation initWithName:synonyms:error:]([CCAppEntityTypeDisplayRepresentation alloc], "initWithName:synonyms:error:", v9, v10, a4);
