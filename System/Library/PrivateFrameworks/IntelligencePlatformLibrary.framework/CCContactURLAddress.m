...
- (NSString)url
{
  return (NSString *)(id)-[NSString copy](self->_url, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19767, self->_label);
    v7[2](v7, v5);

  }
  if (self->_url)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19777, self->_url);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    -[CCContactURLAddress label](self, "label");
  ...
  if (self->_url)
  {
    -[CCContactURLAddress url](self, "url");
...
- (CCContactURLAddress)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCContactURLAddress initWithLabel:url:error:]([CCContactURLAddress alloc], "initWithLabel:url:error:", v9, v10, a4);
