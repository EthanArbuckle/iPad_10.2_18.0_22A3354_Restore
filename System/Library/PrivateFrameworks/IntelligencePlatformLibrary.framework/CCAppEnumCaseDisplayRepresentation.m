...
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4
{
  ...
  v33 = a3;
  v5 = (char *)objc_msgSend(objc_alloc(MEMORY[0x24BE156A0]), "initWithData:", v33);
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_title)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 42618, self->_title);
    v8[2](v8, v5);

  }
  if (self->_subtitle)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 42619, self->_subtitle);
    v8[2](v8, v6);

  }
  if (self->_synonyms)
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:repeatedStringValue:", 42620, self->_synonyms);
    v8[2](v8, v7);
...
- (id)jsonDictionary
{
  ...
  if (self->_title)
  {
    -[CCAppEnumCaseDisplayRepresentation title](self, "title");
  ...
  if (self->_subtitle)
  {
    -[CCAppEnumCaseDisplayRepresentation subtitle](self, "subtitle");
  ...
  if (self->_synonyms)
  {
    -[CCAppEnumCaseDisplayRepresentation synonyms](self, "synonyms");
...
- (CCAppEnumCaseDisplayRepresentation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v12 = -[CCAppEnumCaseDisplayRepresentation initWithTitle:subtitle:synonyms:error:]([CCAppEnumCaseDisplayRepresentation alloc], "initWithTitle:subtitle:synonyms:error:", v9, v10, v11, a4);
