...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 18567, self->_sourceItemIdentifier);
    v7[2](v7, v5);

  }
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:enumValue:", 18568, self->_type);
  v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCMediaLinkedIdentifier sourceItemIdentifier](self, "sourceItemIdentifier");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("sourceItemIdentifier"));

  }
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[CCMediaLinkedIdentifier type](self, "type"));
...
- (CCMediaLinkedIdentifier)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    if (v10)
      ...
      v12 = 0;
    v13 = -[CCMediaLinkedIdentifier initWithSourceItemIdentifier:type:error:]([CCMediaLinkedIdentifier alloc], "initWithSourceItemIdentifier:type:error:", v9, v12, a4);
