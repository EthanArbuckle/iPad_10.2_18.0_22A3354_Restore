...
- (CCAppGlobalMediaAudiobookAuthorMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4
{
  ...
  id v9;
  void *v10;
  CCAppGlobalMediaAudiobookAuthorMetaContent *v11;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 14029, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCAppGlobalMediaAudiobookAuthorMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCAppGlobalMediaAudiobookAuthorMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  CCAppGlobalMediaAudiobookAuthorMetaContent *v10;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCAppGlobalMediaAudiobookAuthorMetaContent initWithSourceItemIdentifier:error:]([CCAppGlobalMediaAudiobookAuthorMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
