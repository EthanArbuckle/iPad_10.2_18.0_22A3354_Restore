...
- (NSString)key
{
  return (NSString *)(id)-[NSString copy](self->_key, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_key)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", (unsigned __int16)*MEMORY[0x24BE15620], self->_key);
    v8[2](v8, v6);

  }
  if (self->_value)
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", *v5, self->_value);
    v8[2](v8, v7);
...
- (id)jsonDictionary
{
  ...
  if (self->_key)
  {
    -[CCSerializedSetDescriptor key](self, "key");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("key"));

  }
  if (self->_value)
  {
    -[CCSerializedSetDescriptor value](self, "value");
...
- (CCSerializedSetDescriptor)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCSerializedSetDescriptor initWithKey:value:error:]([CCSerializedSetDescriptor alloc], "initWithKey:value:error:", v9, v10, a4);
