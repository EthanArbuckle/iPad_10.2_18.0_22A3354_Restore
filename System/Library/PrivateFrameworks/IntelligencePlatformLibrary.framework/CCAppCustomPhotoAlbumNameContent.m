...
- (CCAppCustomPhotoAlbumNameContent)initWithVocabularyString:(id)a3 vocabularyIdentifier:(id)a4 error:(id *)a5
{
  ...
  id v14;
  void *v15;
  CCAppCustomPhotoAlbumNameContent *v16;
  id v18;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 53485, self->_vocabularyString);
    v7[2](v7, v5);

  }
  if (self->_vocabularyIdentifier)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 53486, self->_vocabularyIdentifier);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_vocabularyString)
  {
    -[CCAppCustomPhotoAlbumNameContent vocabularyString](self, "vocabularyString");
  ...
  if (self->_vocabularyIdentifier)
  {
    -[CCAppCustomPhotoAlbumNameContent vocabularyIdentifier](self, "vocabularyIdentifier");
...
- (CCAppCustomPhotoAlbumNameContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  void *v9;
  void *v10;
  CCAppCustomPhotoAlbumNameContent *v11;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCAppCustomPhotoAlbumNameContent initWithVocabularyString:vocabularyIdentifier:error:]([CCAppCustomPhotoAlbumNameContent alloc], "initWithVocabularyString:vocabularyIdentifier:error:", v9, v10, a4);
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  if ((unsigned __int16)(a3 + 12054) > 4u)
    ...
    return *(&off_25102FA08 + (unsigned __int16)(a3 + 12054));
}
