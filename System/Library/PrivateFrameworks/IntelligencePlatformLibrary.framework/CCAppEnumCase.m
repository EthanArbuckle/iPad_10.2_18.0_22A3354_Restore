...
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4
{
  ...
  NSString *v20;
  void *caseIdentifier;
  CCAppEnumCaseDisplayRepresentation *v22;
  CCAppEnumCaseDisplayRepresentation *v23;
...
LABEL_18:
    if ((v15 >> 3) == 2)
    {
      ...
      caseIdentifier = (void *)objc_claimAutoreleasedReturnValue();
      v31 = 0;
      v23 = -[CCItemMessage initWithData:error:](v22, "initWithData:error:", caseIdentifier, &v31);
      v10 = v31;
...
{
  return (NSString *)(id)-[NSString copy](self->_caseIdentifier, "copy");
}

- (CCAppEnumCaseDisplayRepresentation)displayRepresentation
{
  return (CCAppEnumCaseDisplayRepresentation *)(id)-[CCAppEnumCaseDisplayRepresentation copy](self->_displayRepresentation, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 42617, self->_caseIdentifier);
    v7[2](v7, v5);

  }
  if (self->_displayRepresentation)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:subMessageValue:", 42616, self->_displayRepresentation);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_caseIdentifier)
  {
    -[CCAppEnumCase caseIdentifier](self, "caseIdentifier");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("caseIdentifier"));

  }
  if (self->_displayRepresentation)
  {
    -[CCAppEnumCase displayRepresentation](self, "displayRepresentation");
...
- (CCAppEnumCase)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  uint64_t v10;
  void *v11;
  CCAppEnumCaseDisplayRepresentation *v12;
  id v13;
  void *v14;
  CCAppEnumCase *v15;
  id v17[2];
  ...
  {
    objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("caseIdentifier"));
    ...
    if (v10)
    {
      v11 = (void *)v10;
      v17[0] = 0;
      v12 = -[CCAppEnumCaseDisplayRepresentation initWithJSONDictionary:error:]([CCAppEnumCaseDisplayRepresentation alloc], "initWithJSONDictionary:error:", v10, v17);
      v13 = v17[0];
      v14 = v13;
      if (!v12 || v13)
      {
    ...
    v15 = -[CCAppEnumCase initWithCaseIdentifier:displayRepresentation:error:]([CCAppEnumCase alloc], "initWithCaseIdentifier:displayRepresentation:error:", v9, v12, a4);
    v11 = v12;
LABEL_10:
