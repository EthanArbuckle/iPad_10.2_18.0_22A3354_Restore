...
- (CCAppCustomNotebookItemGroupNameMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4
{
  ...
  id v9;
  void *v10;
  CCAppCustomNotebookItemGroupNameMetaContent *v11;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 5600, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCAppCustomNotebookItemGroupNameMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCAppCustomNotebookItemGroupNameMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  CCAppCustomNotebookItemGroupNameMetaContent *v10;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCAppCustomNotebookItemGroupNameMetaContent initWithSourceItemIdentifier:error:]([CCAppCustomNotebookItemGroupNameMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
