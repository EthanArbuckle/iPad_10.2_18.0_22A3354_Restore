...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 49074, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCRadioStationMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCRadioStationMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCRadioStationMetaContent initWithSourceItemIdentifier:error:]([CCRadioStationMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
