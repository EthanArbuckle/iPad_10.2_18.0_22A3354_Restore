...
- (CCAppGlobalMediaMusicArtistNameMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4
{
  ...
  id v9;
  void *v10;
  CCAppGlobalMediaMusicArtistNameMetaContent *v11;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 3619, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCAppGlobalMediaMusicArtistNameMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCAppGlobalMediaMusicArtistNameMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  CCAppGlobalMediaMusicArtistNameMetaContent *v10;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCAppGlobalMediaMusicArtistNameMetaContent initWithSourceItemIdentifier:error:]([CCAppGlobalMediaMusicArtistNameMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
