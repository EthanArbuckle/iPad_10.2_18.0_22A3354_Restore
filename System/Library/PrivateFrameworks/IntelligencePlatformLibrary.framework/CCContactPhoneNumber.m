...
{
  return (NSString *)(id)-[NSString copy](self->_stringValue, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19747, self->_label);
    v7[2](v7, v5);

  }
  if (self->_stringValue)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19748, self->_stringValue);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    -[CCContactPhoneNumber label](self, "label");
  ...
  if (self->_stringValue)
  {
    -[CCContactPhoneNumber stringValue](self, "stringValue");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("stringValue"));
...
- (CCContactPhoneNumber)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCContactPhoneNumber initWithLabel:stringValue:error:]([CCContactPhoneNumber alloc], "initWithLabel:stringValue:error:", v9, v10, a4);
