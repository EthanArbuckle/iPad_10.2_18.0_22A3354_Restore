...
{
  return (NSString *)(id)-[NSString copy](self->_locationName, "copy");
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_title)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 54388, self->_title);
    v7[2](v7, v5);

  }
  if (self->_locationName)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 54389, self->_locationName);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_title)
  {
    -[CCCalendarEventContent title](self, "title");
  ...
  if (self->_locationName)
  {
    -[CCCalendarEventContent locationName](self, "locationName");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("locationName"));
...
- (CCCalendarEventContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCCalendarEventContent initWithTitle:locationName:error:]([CCCalendarEventContent alloc], "initWithTitle:locationName:error:", v9, v10, a4);
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  if ((unsigned __int16)(a3 + 11151) > 4u)
    ...
    return *(&off_25102FBF0 + (unsigned __int16)(a3 + 11151));
}
