...
- (CCAppGlobalMediaPlaylistTitleContent)initWithVocabularyStrings:(id)a3 error:(id *)a4
{
  ...
  uint64_t v14;
  void *v15;
  CCAppGlobalMediaPlaylistTitleContent *v16;
  __int128 v18;
  __int128 v19;
  __int128 v20;
  __int128 v21;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_vocabularyStrings)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:repeatedStringValue:", 34312, self->_vocabularyStrings);
...
- (id)jsonDictionary
{
  ...
  if (self->_vocabularyStrings)
  {
    -[CCAppGlobalMediaPlaylistTitleContent vocabularyStrings](self, "vocabularyStrings");
...
- (CCAppGlobalMediaPlaylistTitleContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  CCAppGlobalMediaPlaylistTitleContent *v10;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = -[CCAppGlobalMediaPlaylistTitleContent initWithVocabularyStrings:error:]([CCAppGlobalMediaPlaylistTitleContent alloc], "initWithVocabularyStrings:error:", v9, a4);
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  ...
  if (a3 != 34312)
    v3 = 0;
  if (a3 == 34307)
    return CFSTR("AppGlobalMediaPlaylistTitle");
  else
    return (id)v3;
}
