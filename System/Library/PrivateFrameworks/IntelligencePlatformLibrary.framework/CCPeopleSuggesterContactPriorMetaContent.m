...
- (CCPeopleSuggesterContactPriorMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4
{
  ...
  id v9;
  void *v10;
  CCPeopleSuggesterContactPriorMetaContent *v11;
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 40576, self->_sourceItemIdentifier);
...
- (id)jsonDictionary
{
  ...
  if (self->_sourceItemIdentifier)
  {
    -[CCPeopleSuggesterContactPriorMetaContent sourceItemIdentifier](self, "sourceItemIdentifier");
...
- (CCPeopleSuggesterContactPriorMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v8;
  void *v9;
  CCPeopleSuggesterContactPriorMetaContent *v10;
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCPeopleSuggesterContactPriorMetaContent initWithSourceItemIdentifier:error:]([CCPeopleSuggesterContactPriorMetaContent alloc], "initWithSourceItemIdentifier:error:", v9, a4);
