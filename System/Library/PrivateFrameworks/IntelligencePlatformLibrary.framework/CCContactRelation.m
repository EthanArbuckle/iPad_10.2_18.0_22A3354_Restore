...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19758, self->_label);
    v7[2](v7, v5);

  }
  if (self->_name)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE15670]), "initWithFieldType:stringValue:", 19759, self->_name);
    v7[2](v7, v6);
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    -[CCContactRelation label](self, "label");
  ...
  if (self->_name)
  {
    -[CCContactRelation name](self, "name");
...
- (CCContactRelation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = -[CCContactRelation initWithLabel:name:error:]([CCContactRelation alloc], "initWithLabel:name:error:", v9, v10, a4);
