...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    ...
    v7 = a3;
    v8 = (id)objc_msgSend([v6 alloc], "initWithFieldType:stringValue:", 18565, self->_name);
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    -[CCMediaTVEpisode name](self, "name");
...
- (CCMediaTVEpisode)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if ((IsInstanceOfExpectedClass & 1) != 0)
  {
    ...
    v10 = -[CCMediaTVEpisode initWithName:error:]([CCMediaTVEpisode alloc], "initWithName:error:", v9, a4);
