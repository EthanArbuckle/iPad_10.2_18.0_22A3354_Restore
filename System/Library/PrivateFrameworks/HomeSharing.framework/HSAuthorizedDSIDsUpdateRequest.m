...
{
  HSAuthorizedDSIDsUpdateRequest *v2;
  HSAuthorizedDSIDsUpdateRequest *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)HSAuthorizedDSIDsUpdateRequest;
  v2 = -[HSRequest initWithAction:](&v5, sel_initWithAction_, CFSTR("authorized-dsids-update"));
  v3 = v2;
  if (v2)
...
- (id)canonicalResponseForResponse:(id)a3
{
  ...
  +[HSResponse responseWithResponse:](HSAuthorizedDSIDsUpdateResponse, "responseWithResponse:", a3);
