...
{
  uint64_t v5;
  HSCheckOutRentalAssetRequest *v6;
  void *v7;
  void *v8;
  objc_super v10;
  ...
  v6 = -[HSRequest initWithAction:](&v10, sel_initWithAction_, CFSTR("checkout-rental-asset"));
  if (v6)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("'dmap.itemid:%d'"), v5);
