...
+ (ECPlainAuthScheme)plainAuthScheme
{
  ...
  return (ECPlainAuthScheme *)(id)plainAuthScheme_sharedInstance;
}
...
- (void)dealloc
{
  ...
  -[ECPlainAuthScheme dealloc](&v5, sel_dealloc);
}

- (id)name
{
  return &stru_1E7123500;
}
...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("PLAIN"), CFSTR("LOGIN"), 0);
}
