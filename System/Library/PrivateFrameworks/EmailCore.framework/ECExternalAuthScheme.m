...
+ (ECExternalAuthScheme)externalAuthScheme
{
  ...
  return (ECExternalAuthScheme *)(id)externalAuthScheme_sharedInstance;
}
...
- (void)dealloc
{
  ...
  -[ECExternalAuthScheme dealloc](&v5, sel_dealloc);
}
...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", CFSTR("EXTERNAL"));
}
