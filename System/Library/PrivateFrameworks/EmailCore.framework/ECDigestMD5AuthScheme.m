...
+ (ECDigestMD5AuthScheme)digestMD5AuthScheme
{
  ...
  return (ECDigestMD5AuthScheme *)(id)digestMD5AuthScheme_sharedInstance;
}
...
- (void)dealloc
{
  ...
  -[ECDigestMD5AuthScheme dealloc](&v5, sel_dealloc);
}
...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", CFSTR("DIGEST-MD5"));
}
