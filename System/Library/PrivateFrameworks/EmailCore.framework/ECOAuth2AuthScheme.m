...
+ (ECOAuth2AuthScheme)oauth2AuthScheme
{
  ...
  return (ECOAuth2AuthScheme *)(id)oauth2AuthScheme_sharedInstance;
}
...
- (void)dealloc
{
  ...
  -[ECOAuth2AuthScheme dealloc](&v5, sel_dealloc);
}
...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", CFSTR("XOAUTH2"));
}
