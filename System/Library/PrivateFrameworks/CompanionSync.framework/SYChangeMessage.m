...
- (id)description
{
  ...
  -[SYChangeMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SYChangeMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_changes, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("changes"));
  }
  return v3;
}
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (!self->_header)
    -[SYChangeMessage writeTo:].cold.1();
  v5 = v4;
...
- (void)copyTo:(id)a3
{
  ...
  if (-[SYChangeMessage changesCount](self, "changesCount"))
  {
    objc_msgSend(v8, "clearChanges");
    v4 = -[SYChangeMessage changesCount](self, "changesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[SYChangeMessage changesAtIndex:](self, "changesAtIndex:", i);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addChanges:", v13);
...
- (BOOL)isEqual:(id)a3
{
    ...
    && ((header = self->_header, !((unint64_t)header | v4[2])) || -[SYMessageHeader isEqual:](header, "isEqual:")))
  {
    ...
    if ((unint64_t)changes | v4[1])
      v7 = -[NSMutableArray isEqual:](changes, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_changes, "hash") ^ v3;
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[SYChangeMessage addChanges:](self, "addChanges:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
