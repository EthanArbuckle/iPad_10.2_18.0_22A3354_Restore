...
- (id)description
{
  ...
  -[SYEndSyncSession description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SYEndSyncSession dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_rollback);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("rollback"));
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (!self->_header)
    -[SYEndSyncSession writeTo:].cold.1();
  v5 = v4;
  PBDataWriterWriteSubmessage();
  if (!self->_sessionID)
    -[SYEndSyncSession writeTo:].cold.2();
...
LABEL_7:
  ...
  else
  {
    if (!v8)
      goto LABEL_15;
    -[SYEndSyncSession setError:](self, "setError:");
  }
  v4 = v9;
LABEL_15:
  if ((*((_BYTE *)v4 + 36) & 1) != 0)
  {
    self->_rollback = *((_BYTE *)v4 + 32);
    *(_BYTE *)&self->_has |= 1u;
  }
