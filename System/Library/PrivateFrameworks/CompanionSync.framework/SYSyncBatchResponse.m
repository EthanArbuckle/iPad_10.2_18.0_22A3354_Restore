...
- (id)description
{
  ...
  -[SYSyncBatchResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SYSyncBatchResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (!self->_header)
    -[SYSyncBatchResponse writeTo:].cold.1();
  PBDataWriterWriteSubmessage();
  if (!self->_sessionID)
    -[SYSyncBatchResponse writeTo:].cold.2();
...
LABEL_14:
  ...
  {
    -[SYSyncBatchResponse setError:](self, "setError:");
    goto LABEL_14;
  }
