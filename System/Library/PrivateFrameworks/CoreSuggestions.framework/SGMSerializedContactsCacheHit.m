...
{
  SGMSerializedContactsCacheHit *v2;
  void *v3;
  id v4;
  void *v5;
  uint64_t v6;
  ...
  v2 = -[SGMSerializedContactsCacheHit init](&v9, sel_init);
  if (v2)
  {
    ...
    v6 = objc_msgSend(v4, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("SerializedContactsCacheHit"), v5, MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
