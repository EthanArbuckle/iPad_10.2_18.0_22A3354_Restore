...
{
  SGMContactResultSelectedInSpotlight *v2;
  id v3;
  uint64_t v4;
  ...
  v2 = -[SGMContactResultSelectedInSpotlight init](&v7, sel_init);
  if (v2)
  {
    v3 = objc_alloc(MEMORY[0x1E0D80F38]);
    v4 = objc_msgSend(v3, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("ContactResultSelectedInSpotlight"), MEMORY[0x1E0C9AA60], MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
