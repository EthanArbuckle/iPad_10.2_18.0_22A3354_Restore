...
{
  SGMSearchResultsUserSelectedContact *v2;
  void *v3;
  void *v4;
  void *v5;
  id v6;
  ...
  v2 = -[SGMSearchResultsUserSelectedContact init](&v11, sel_init);
  if (v2)
  {
    ...
    v8 = objc_msgSend(v6, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("SearchResultsUserSelectedContact"), v7, MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
