...
- (SGMContactDetailRejected)init
{
  ...
  v2 = -[SGMContactDetailRejected init](&v11, sel_init);
  if (v2)
  {
    ...
    v8 = objc_msgSend(v6, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("ContactDetailRejected"), v7, MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
