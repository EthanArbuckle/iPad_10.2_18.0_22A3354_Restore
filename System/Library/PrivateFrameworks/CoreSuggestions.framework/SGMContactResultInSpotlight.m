...
{
  SGMContactResultInSpotlight *v2;
  void *v3;
  id v4;
  void *v5;
  uint64_t v6;
  ...
  v2 = -[SGMContactResultInSpotlight init](&v9, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x1E0D80F20], "freeValuedPropertyWithName:", CFSTR("Visible"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    v4 = objc_alloc(MEMORY[0x1E0D80F38]);
    v10[0] = v3;
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v10, 1);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = objc_msgSend(v4, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("ContactResultInSpotlight"), v5, MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
