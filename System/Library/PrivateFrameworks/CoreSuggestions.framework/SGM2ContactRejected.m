...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("ContactRejected");
}
...
- (id)description
{
  ...
  -[SGM2ContactRejected description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2ContactRejected dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_24:
    ...
    {
      v16 = off_1E47624E8[uiType];
    }
    objc_msgSend(v4, "setObject:forKey:", v16, CFSTR("uiType"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 44) & 1) == 0 || self->_app != *((_DWORD *)v4 + 2))
      goto LABEL_36;
  }
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 44) & 2) == 0 || self->_extracted != *((_DWORD *)v4 + 3))
      goto LABEL_36;
  }
...
LABEL_22:
  ...
  {
    if ((*((_BYTE *)v4 + 44) & 4) == 0 || self->_extractionModelVersion != *((_DWORD *)v4 + 4))
      goto LABEL_36;
  }
  ...
  if ((*(_BYTE *)&self->_has & 8) != 0)
  {
    if ((*((_BYTE *)v4 + 44) & 8) == 0 || self->_type != *((_DWORD *)v4 + 8))
      goto LABEL_36;
  }
  ...
  if ((*(_BYTE *)&self->_has & 0x10) != 0)
  {
    if ((*((_BYTE *)v4 + 44) & 0x10) == 0 || self->_uiType != *((_DWORD *)v4 + 9))
      goto LABEL_36;
    v6 = 1;
  }
LABEL_37:
