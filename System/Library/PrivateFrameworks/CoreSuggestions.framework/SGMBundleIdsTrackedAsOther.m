...
- (SGMBundleIdsTrackedAsOther)init
{
  ...
  v2 = -[SGMBundleIdsTrackedAsOther init](&v9, sel_init);
  if (v2)
  {
    ...
    v6 = objc_msgSend(v4, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("BundleIdsTrackedAsOther"), v5, MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
