...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("EventInBanner");
}
...
- (id)description
{
  ...
  -[SGM2EventInBanner description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2EventInBanner dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 36) & 1) == 0 || self->_app != *((_DWORD *)v4 + 2))
      goto LABEL_23;
  }
...
LABEL_23:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 36) & 2) == 0 || self->_category != *((_DWORD *)v4 + 3))
      goto LABEL_23;
  }
  ...
  if ((*(_BYTE *)&self->_has & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 36) & 4) == 0 || self->_extracted != *((_DWORD *)v4 + 4))
      goto LABEL_23;
  }
  ...
  if ((*(_BYTE *)&self->_has & 8) != 0)
  {
    if ((*((_BYTE *)v4 + 36) & 8) == 0 || self->_state != *((_DWORD *)v4 + 8))
      goto LABEL_23;
    v6 = 1;
  }
LABEL_24:
