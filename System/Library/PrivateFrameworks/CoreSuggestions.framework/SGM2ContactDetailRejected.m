...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("ContactDetailRejected");
}
...
- (id)description
{
  ...
  -[SGM2ContactDetailRejected description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2ContactDetailRejected dictionaryRepresentation](self, "dictionaryRepresentation");
