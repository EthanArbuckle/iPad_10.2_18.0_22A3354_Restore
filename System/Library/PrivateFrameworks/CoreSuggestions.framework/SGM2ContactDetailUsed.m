...
- (NSString)key
{
  if (self->_key)
    ...
    return (NSString *)CFSTR("ContactDetailUsed");
}
...
- (id)description
{
  ...
  -[SGM2ContactDetailUsed description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SGM2ContactDetailUsed dictionaryRepresentation](self, "dictionaryRepresentation");
