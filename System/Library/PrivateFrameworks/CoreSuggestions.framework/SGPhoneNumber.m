...
- (SGPhoneNumber)initWithCoder:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_msgSend(v5, "decodeObjectOfClasses:forKey:", v7, CFSTR("phoneNumber"));
    ...
    else
    {
      ...
      objc_msgSend(phoneNumber, "handleFailureInMethod:object:file:lineNumber:description:", a2, v6, CFSTR("SGPhoneNumber.m"), 30, CFSTR("nonnull property %s *%s was null when decoded"), "NSString", "phoneNumber");
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v4 == self)
    ...
    v6 = v4
      ...
      && -[SGPhoneNumber isEqualToPhoneNumber:](self, "isEqualToPhoneNumber:", v5);
...
- (id)description
{
  ...
  if (objc_msgSend(v4, "length"))
  {
    ...
    v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("%@/'%@'"), v5, self->_phoneNumber);

  }
  else
  {
    v6 = (void *)objc_msgSend(v3, "initWithFormat:", CFSTR("%@/'%@'"), CFSTR("unlabeled"), self->_phoneNumber);
  }
...
+ (id)phoneNumber:(id)a3 label:(id)a4 extractionInfo:(id)a5 recordId:(id)a6
{
  ...
  v11 = a4;
  v12 = a3;
  v13 = -[SGPhoneNumber initWithPhoneNumber:label:extractionInfo:recordId:]([SGPhoneNumber alloc], "initWithPhoneNumber:label:extractionInfo:recordId:", v12, v11, v10, v9);
...
+ (id)phoneNumber:(id)a3 label:(id)a4 extractionType:(unint64_t)a5 recordId:(id)a6
{
  ...
  +[SGPhoneNumber phoneNumber:label:extractionInfo:recordId:](SGPhoneNumber, "phoneNumber:label:extractionInfo:recordId:", v11, v10, v12, v9);
