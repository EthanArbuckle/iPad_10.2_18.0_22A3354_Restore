...
- (SGMDDLinkShown)init
{
  ...
  v2 = -[SGMDDLinkShown init](&v9, sel_init);
  if (v2)
  {
    ...
    v6 = objc_msgSend(v4, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("DDLinkShown"), v5, MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
...
- (void)trackEventWithScalar:(unint64_t)a3 interface:(SGMNLEventInterface_)a4
{
  ...
  if (a4.var0 >= 0x14)
  {
    ...
    objc_msgSend(v8, "handleFailureInFunction:file:lineNumber:description:", v9, CFSTR("SGMetricsDefines.h"), 477, CFSTR("unrecognized tag %lu on SGMNLEventInterface"), a4.var0);

    v7 = CFSTR("ERR_UNMATCHED_TAG");
  }
  else
  {
    v7 = off_1E4761488[a4.var0];
  }
