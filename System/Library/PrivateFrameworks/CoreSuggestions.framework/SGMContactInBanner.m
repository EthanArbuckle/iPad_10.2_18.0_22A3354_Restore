...
- (SGMContactInBanner)init
{
  ...
  v2 = -[SGMContactInBanner init](&v13, sel_init);
  if (v2)
  {
    ...
    v10 = objc_msgSend(v8, "initWithFeatureId:event:registerProperties:propertySubsets:", CFSTR("Found"), CFSTR("ContactInBanner"), v9, MEMORY[0x1E0C9AA60]);
    tracker = v2->_tracker;
