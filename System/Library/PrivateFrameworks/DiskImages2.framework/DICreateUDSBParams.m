...
+ (BOOL)checkExistingFileWithURL:(id)a3 isDirectory:(BOOL)a4 error:(id *)a5
{
  ...
  if (a4)
  {
    objc_msgSend(MEMORY[0x24BDBCF48], "fileURLWithPath:relativeToURL:", CFSTR("Info.plist"), v7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDBCF48], "fileURLWithPath:relativeToURL:", CFSTR("token"), v7);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = objc_retainAutorelease(v8);
    v11 = !access((const char *)objc_msgSend(v10, "fileSystemRepresentation"), 0)
       && !access((const char *)objc_msgSend(objc_retainAutorelease(v9), "fileSystemRepresentation"), 0)
       || +[DIError failWithPOSIXCode:verboseInfo:error:](DIError, "failWithPOSIXCode:verboseInfo:error:", 17, CFSTR("The requested URL is an existing non-sparsebundle folder"), a5);
