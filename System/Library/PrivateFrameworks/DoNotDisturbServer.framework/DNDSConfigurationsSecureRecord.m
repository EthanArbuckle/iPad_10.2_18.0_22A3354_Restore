...
{
  return (DNDSConfigurationsSecureRecord *)-[DNDSConfigurationsSecureRecord _initWithRecord:](self, "_initWithRecord:", 0);
}
...
- (id)_initWithRecord:(id)a3
{
  ...
  v5 = -[DNDSConfigurationsSecureRecord _initWithModeConfigurations:](self, "_initWithModeConfigurations:", v4);
...
{
  id v4;
  DNDSConfigurationsSecureRecord *v5;
  void *v6;
  void *v7;
  ...
  v5 = -[DNDSConfigurationsSecureRecord init](&v11, sel_init);
  if (v5)
  {
...
- (unint64_t)hash
{
  ...
  -[DNDSConfigurationsSecureRecord modeConfigurations](self, "modeConfigurations");
...
- (BOOL)isEqual:(id)a3
{
  DNDSConfigurationsSecureRecord *v4;
  DNDSConfigurationsSecureRecord *v5;
  void *v6;
  void *v7;
  void *v8;
  ...
  v4 = (DNDSConfigurationsSecureRecord *)a3;
  if (self == v4)
  {
    v12 = 1;
  }
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[DNDSConfigurationsSecureRecord modeConfigurations](v5, "modeConfigurations");
...
{
  return -[DNDSConfigurationsSecureRecord _initWithRecord:]([DNDSMutableConfigurationsSecureRecord alloc], "_initWithRecord:", self);
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        v14 = +[DNDSConfigurationSecureRecord newWithDictionaryRepresentation:context:](DNDSConfigurationSecureRecord, "newWithDictionaryRepresentation:context:", v13, v5);
...
- (id)dictionaryRepresentationWithContext:(id)a3
{
  ...
  if ((objc_msgSend(v4, "partitionType") & 2) != 0)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(v15, "dictionaryRepresentationWithContext:", v4);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v6, "setObject:forKey:", v16, v13);
    ...
    v5 = v18;
    objc_msgSend(v18, "setObject:forKey:", v6, CFSTR("modeConfigurations"));
