...
{
  return (MXMNetworkMetric *)(id)objc_msgSend(objc_alloc((Class)a1), "initWithProcessIdentifier:", getpid());
}
...
- (MXMNetworkMetric)initWithProcessIdentifier:(int)a3
{
  ...
  v12 = -[MXMNetworkMetric initWithIdentifier:filter:](self, "initWithIdentifier:filter:", CFSTR("com.apple.metricmeasurement.metric.network"), v11);
...
- (MXMNetworkMetric)initWithProcessName:(id)a3
{
  ...
  if (a3)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    self = -[MXMNetworkMetric initWithIdentifier:filter:](self, "initWithIdentifier:filter:", CFSTR("com.apple.metricmeasurement.metric.network"), v9);
...
- (MXMNetworkMetric)initWithBundleIdentifier:(id)a3
{
  ...
  v5 = -[MXMNetworkMetric initWithProcessName:](self, "initWithProcessName:", v4);
...
- (MXMNetworkMetric)initWithIdentifier:(id)a3 filter:(id)a4
{
  ...
  v5 = v4;
  if (v4)
    -[MXMMetric setPreferredSampleMode:](v4, "setPreferredSampleMode:", -1);
  return v5;
}
