...
{
  CertUIItemDetailsSummaryCell *v4;
  CertUIItemDetailsSummaryCell *v5;
  objc_super v7;
  ...
  if (v4)
  {
    -[CertUIItemDetailsSummaryCell setSelectionStyle:](v4, "setSelectionStyle:", 0);
...
- (void)layoutSubviews
{
  ...
  -[CertUIItemDetailsSummaryCell layoutSubviews](&v23, sel_layoutSubviews);
  v21 = 0u;
  v22 = 0u;
  v19 = 0u;
  v20 = 0u;
  -[CertUIItemDetailsSummaryCell detailViews](self, "detailViews", 0);
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[CertUIItemDetailsSummaryCell contentView](self, "contentView");
...
- (void)setDetailLabelOriginX:(double)a3
{
  ...
  if (self->_detailLabelOriginX != a3)
  {
    ...
    -[CertUIItemDetailsSummaryCell setNeedsLayout](self, "setNeedsLayout");
  }
}
...
- (void)createViewWithDescriptors:(id)a3
{
  ...
  unint64_t v17;
  void *v18;
  CertUIKeyValueView *v19;
  CertUIKeyValueView *v20;
  void *v21;
  __int128 v22;
  __int128 v23;
  __int128 v24;
  ...
  if (objc_msgSend(v4, "count"))
  {
    ...
    do
    {
      ...
      v19 = -[CertUIKeyValueView initWithFrame:]([CertUIKeyValueView alloc], "initWithFrame:", v12, v13, v14, v15);
      v20 = v19;
      if (self->_detailLabelOriginX >= 0.0)
        -[CertUIKeyValueView setPreferredValueLabelOriginX:](v19, "setPreferredValueLabelOriginX:");
      -[CertUIKeyValueView setKey:value:](v20, "setKey:value:", v16, v18);
      -[CertUIItemDetailsSummaryCell contentView](self, "contentView");
  ...
  -[CertUIItemDetailsSummaryCell setDetailViews:](self, "setDetailViews:", v10);
  -[CertUIItemDetailsSummaryCell setNeedsLayout](self, "setNeedsLayout");
...
- (void)createViewWithItemDetailArray:(id)a3
{
  ...
  uint64_t j;
  uint64_t v20;
  CertUIKeyValueView *v21;
  CertUIKeyValueView *v22;
  CertUIKeyValueView *v23;
  void *v24;
  __int128 v25;
  __int128 v26;
  __int128 v27;
  ...
  v31 = 0u;
  v32 = 0u;
  -[CertUIItemDetailsSummaryCell detailViews](self, "detailViews");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    do
    {
      for (j = 0; j != v13; ++j)
      {
        ...
        v22 = -[CertUIKeyValueView initWithFrame:](v21, "initWithFrame:", v15, v16, v17, v18, (_QWORD)v25);
        v23 = v22;
        if (self->_detailLabelOriginX >= 0.0)
          -[CertUIKeyValueView setPreferredValueLabelOriginX:](v22, "setPreferredValueLabelOriginX:");
        -[CertUIKeyValueView setItemDetail:](v23, "setItemDetail:", v20);
        -[CertUIItemDetailsSummaryCell contentView](self, "contentView");
