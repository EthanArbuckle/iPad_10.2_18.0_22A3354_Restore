...
{
  id v13;
  IDSReceivedInvitation *v14;
  IDSReceivedInvitation *v15;
  objc_super v17;
...
- (id)description
{
  ...
  -[IDSReceivedInvitation fromID](self, "fromID");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<IDSReceivedInvitation %p>: uniqueID %@ selfHandle %@ senderMergeID %@ state %ld expirationDate %@ destination %@"), self, v4, v5, v6, v7, v8, v9);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[IDSReceivedInvitation fromID](self, "fromID");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v10, CFSTR("fromID"));

  -[IDSInvitation context](self, "context");
  v11 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v11, *MEMORY[0x1E0D344A8]);
...
- (IDSReceivedInvitation)initWithCoder:(id)a3
{
  ...
  void *v10;
  void *v11;
  IDSReceivedInvitation *v12;

  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0D344E0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0D344C8]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0D344D0]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_msgSend(v4, "decodeIntegerForKey:", *MEMORY[0x1E0D344D8]);
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0D346F8]);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("fromID"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0D344A8]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();

  v12 = -[IDSReceivedInvitation initWithfromID:state:expirationDate:uniqueID:context:](self, "initWithfromID:state:expirationDate:uniqueID:context:", v10, v8, v9, v5, v11);
  -[IDSReceivedInvitation setSelfHandle:](v12, "setSelfHandle:", v6);
  -[IDSReceivedInvitation setSenderMergeID:](v12, "setSenderMergeID:", v7);
