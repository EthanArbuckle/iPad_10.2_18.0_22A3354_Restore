...
{
  id v4;
  SOAuthorizationRequestParametersCore *v5;
  uint64_t v6;
  NSString *identifier;
  uint64_t v8;
  NSURL *url;
  ...
  v5 = -[SOAuthorizationRequestParametersCore init](&v21, sel_init);
  if (v5)
  {
...
- (SOAuthorizationRequestParametersCore)initWithCoder:(id)a3
{
  ...
  v5 = -[SOAuthorizationRequestParametersCore init](&v91, sel_init);
  if (v5)
  {
    v6 = objc_opt_class();
    ...
    v5->_showOnCoverScreen = objc_msgSend(v89, "BOOLValue");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_useInternalExtensions);
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  NSStringFromSelector(sel_useInternalExtensions);
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_cfNetworkInterception);
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  NSStringFromSelector(sel_isCFNetworkInterception);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "encodeObject:forKey:", v29, v30);

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_callerManaged);
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_enableUserInteraction);
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_showOnCoverScreen);
  v42 = (id)objc_claimAutoreleasedReturnValue();
  NSStringFromSelector(sel_canShowOnCoverScreen);
  v41 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "encodeObject:forKey:", v42, v41);
...
- (id)description
{
  ...
  v23[2] = CFSTR("RequestedOperation");
  v23[3] = CFSTR("Realm");
  ...
  v23[4] = CFSTR("AuthorizationOptions");
  v23[5] = CFSTR("UseInternalExtensions");
  ...
  v24[5] = v10;
  v23[6] = CFSTR("ResponseCode");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", responseCode);
  ...
  v24[6] = v11;
  v24[7] = v13;
  v23[7] = CFSTR("CFNetworkInterception");
  v23[8] = CFSTR("CallerManaged");
  ...
  v23[9] = CFSTR("CallerTeamIdentifier");
  v23[10] = CFSTR("LocalizedCallerDisplayName");
  ...
  v24[10] = v17;
  v24[11] = v18;
  v23[11] = CFSTR("EnableUserInteraction");
  v23[12] = CFSTR("ImpersonationBundleIdentifier");
  ...
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v24, v23, 13);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
