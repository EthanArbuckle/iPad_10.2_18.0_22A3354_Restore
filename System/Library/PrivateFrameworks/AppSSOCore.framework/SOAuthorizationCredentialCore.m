...
{
  id v4;
  SOAuthorizationCredentialCore *v5;
  uint64_t v6;
  ...
  v5 = -[SOAuthorizationCredentialCore init](&v15, sel_init);
  if (v5)
  {
    ...
    objc_msgSend(v4, "secKeyProxyEndpoints");
...
- (SOAuthorizationCredentialCore)initWithCoder:(id)a3
{
  ...
  v5 = -[SOAuthorizationCredentialCore init](&v27, sel_init);
  if (v5)
  {
