...
{
  return objc_msgSend(a2, "_reloadSettings");
}
...
id SLGCreateError(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v3, "errorWithDomain:code:userInfo:", CFSTR("SLGLogErrorDomain"), a1, v6);
...
{
  return SLGCreateError(4, CFSTR("Logging is disabled"));
}
...
id SLGCreateSessionMetadata()
{
  ...
  v8 = 0;
  objc_msgSend(MEMORY[0x1E0CB36D8], "dataWithJSONObject:options:error:", v5, 0, &v8);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
id slg_general_log()
{
  ...
  return (id)slg_general_log___logger;
}

void __slg_general_log_block_invoke()
{
  os_log_t v0;
  void *v1;

  v0 = os_log_create("com.apple.internal.StudyLog", "general");
  v1 = (void *)slg_general_log___logger;
  slg_general_log___logger = (uint64_t)v0;

}

void sub_1C8910CBC(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  uint64_t v3;
