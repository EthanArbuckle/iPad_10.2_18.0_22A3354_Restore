...
- (void)car_deepCopyLayer
{
  ...
  if (v2)
  {
      ...
      if (v5)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v11 = (void *)objc_msgSend(v7, "car_deepCopyLayer");
            if (v11)
    ...
    if (v12)
    {
      v14 = (void *)objc_msgSend(v12, "car_deepCopyLayer");
      if (v14)
    ...
    v37 = 0u;
    v38 = 0u;
    objc_msgSend(a1, "car_propertiesToCopy", v13);
...
- (id)car_propertiesToCopy
{
  ...
  if (!car_propertiesToCopy_sCAShapeLayerClass)
    car_propertiesToCopy_sCAShapeLayerClass = (uint64_t)NSClassFromString(CFSTR("CAShapeLayer"));
  objc_msgSend(a1, "car_basicPropertiesToCopy");
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(*(id *)(*((_QWORD *)&v14 + 1) + 8 * v13++), "car_addLayerAndSublayersToArray:allowHiddenLayers:", v6, a4);
        }
        while (v11 != v13);
...
- (id)car_allLayersWhoseNamesContainString:()CARMicaPlayerAdditions
{
  ...
  v4 = a3;
  objc_msgSend(a1, "car_allLayersInTree");
...
- (void)car_setFillOfAllShapeLayersToColor:()CARMicaPlayerAdditions
{
  ...
  objc_msgSend(a1, "car_allLayersWithKindOfClass:", objc_opt_class());
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v10 != v7)
          objc_enumerationMutation(v4);
        objc_msgSend(*(id *)(*((_QWORD *)&v9 + 1) + 8 * v8++), "setFillColor:", a3);
      }
      while (v6 != v8);
