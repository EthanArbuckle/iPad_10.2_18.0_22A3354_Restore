...
- (void)lookupKey:(id)a3 resultBlock:(id)a4
{
  ...
  {
    v17 = (void *)MEMORY[0x219A2EAC0]();
    v18 = OverridesLogContext;
    if (os_log_type_enabled((os_log_t)OverridesLogContext, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315394;
      v25 = "-[SiriNLUMarisaTrie lookupKey:resultBlock:]";
      v26 = 2112;
      v27 = v6;
      _os_log_impl(&dword_21952B000, v18, OS_LOG_TYPE_INFO, "%s [WARN]: Unable to convert NSString to UTF8 NSData. String is:%@", buf, 0x16u);
    }
    v7[2](v7, 0, 0);
  ...
  if (array)
  {
    ...
    if (v6)
    {
      ...
      do
      {
        v8 = *(_QWORD *)&v5[v7];
        if (v8)
          MEMORY[0x219A2E9D0](v8, 0x1050C80717B85FCLL);
        v7 -= 8;
      }
      while (v7);
    }
    MEMORY[0x219A2E9D0](v5 - 8, 0x20C8093837F09);
  }
...
- (SiriNLUMarisaTrie)initWithURL:(id)a3
{
  ...
  if ((v7 & 1) != 0)
  {
    ...
    v8 = -[SiriNLUMarisaTrie init](&v17, sel_init);
    if (v8)
    {
      objc_msgSend(v4, "path");
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 136315650;
        ...
        v22 = 2048;
        v23 = v12;
        _os_log_impl(&dword_21952B000, v10, OS_LOG_TYPE_INFO, "%s OVMarisaTrie %@ loaded {count: %lu}", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 136315394;
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_21952B000, v14, OS_LOG_TYPE_INFO, "%s [WARN]: Unable to locate marisa trie {path: %@}", buf, 0x16u);
...
- (SiriNLUMarisaTrie)init
{
  ...
  return -[SiriNLUMarisaTrie init](&v3, sel_init);
}
...
- (void)enumerateAllEntriesWithBlock:(id)a3
{
  ...
  *(_QWORD *)&v7 = 136315394;
  ...
  while (v5 < marisa::Trie::size((marisa::Trie *)p_trie))
  {
    ...
    v10 = v22;
    v11 = strchr(__s, -1);
    v13 = (void *)MEMORY[0x219A2EAC0](v11, v12);
    v14 = v11 - v8;
...
- (void)enumerateAllRowsWithBlock:(id)a3
{
  ...
  *(_QWORD *)&v7 = 136315394;
  ...
  while (v5 < marisa::Trie::size((marisa::Trie *)p_trie))
  {
    ...
    v11 = v18;
    v10 = v19;
    v12 = (void *)MEMORY[0x219A2EAC0](v8);
...
- (void)lookupPrefix:(id)a3 resultBlock:(id)a4
{
  ...
  while (marisa::Trie::predictive_search((marisa::Trie *)p_trie, (marisa::Agent *)v22))
  {
    ...
    *(_OWORD *)__p = __dst;
    v21 = v19;
    v15 = (void *)MEMORY[0x219A2EAC0](v14);
    if (v21 >= 0)
      v16 = __p;
    else
      v16 = (void **)__p[0];
