...
+ (id)structName
{
  return CFSTR("NotebookShareTemplate");
}
...
+ (id)structFields
{
  ...
  v2 = (void *)structFields_structFields_1484;
  if (!structFields_structFields_1484)
  {
    ...
    v9 = (void *)structFields_structFields_1484;
    structFields_structFields_1484 = v8;
