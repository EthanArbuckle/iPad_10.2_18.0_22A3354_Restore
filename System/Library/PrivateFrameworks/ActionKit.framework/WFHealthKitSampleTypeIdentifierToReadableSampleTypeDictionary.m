@implementation WFHealthKitSampleTypeIdentifierToReadableSampleTypeDictionary
...
void __WFHealthKitSampleTypeIdentifierToReadableSampleTypeDictionary_block_invoke()
{
  ...
  if (v3)
  {
    ...
    do
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        objc_msgSend(v2, "objectForKey:", v7, (_QWORD)v10);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v1, "setObject:forKey:", v7, v8);
  ...
  v9 = (void *)WFHealthKitSampleTypeIdentifierToReadableSampleTypeDictionary_dictionary;
