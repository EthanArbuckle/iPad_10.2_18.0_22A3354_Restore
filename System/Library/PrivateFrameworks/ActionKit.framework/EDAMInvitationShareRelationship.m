...
+ (id)structName
{
  return CFSTR("InvitationShareRelationship");
}
...
+ (id)structFields
{
  ...
  v2 = (void *)structFields_structFields_1298;
  if (!structFields_structFields_1298)
  {
    +[FATField fieldWithIndex:type:optional:name:](FATField, "fieldWithIndex:type:optional:name:", 1, 11, 1, CFSTR("displayName"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    v10[0] = v3;
    +[FATField fieldWithIndex:type:optional:name:structClass:](FATField, "fieldWithIndex:type:optional:name:structClass:", 2, 12, 1, CFSTR("recipientUserIdentity"), objc_opt_class());
    ...
    v8 = (void *)structFields_structFields_1298;
    structFields_structFields_1298 = v7;
...
{
  objc_storeStrong((id *)&self->_recipientUserIdentity, a3);
}
