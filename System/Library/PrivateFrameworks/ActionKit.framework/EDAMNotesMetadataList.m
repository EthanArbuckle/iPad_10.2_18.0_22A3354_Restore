...
+ (id)structName
{
  return CFSTR("NotesMetadataList");
}
...
+ (id)structFields
{
  ...
  v2 = (void *)structFields_structFields_580;
  if (!structFields_structFields_580)
  {
    ...
    v13 = (void *)structFields_structFields_580;
    structFields_structFields_580 = v12;
