...
+ (id)structName
{
  return CFSTR("NoteShareRelationships");
}
...
+ (id)structFields
{
  ...
  v2 = (void *)structFields_structFields_1541;
  if (!structFields_structFields_1541)
  {
    ...
    v9 = (void *)structFields_structFields_1541;
    structFields_structFields_1541 = v8;
