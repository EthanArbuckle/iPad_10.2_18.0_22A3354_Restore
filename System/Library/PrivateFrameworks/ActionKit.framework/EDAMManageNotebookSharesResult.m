...
+ (id)structName
{
  return CFSTR("ManageNotebookSharesResult");
}
...
+ (id)structFields
{
  ...
  v2 = (void *)structFields_structFields_1452;
  if (!structFields_structFields_1452)
  {
    ...
    v6 = (void *)structFields_structFields_1452;
    structFields_structFields_1452 = v5;
