...
- (void)resolveSlot:(id)a3 withProcessedValue:(id)a4 parameter:(id)a5 input:(id)a6 completion:(id)a7
{
  ...
  if (!objc_msgSend(v17, "isEqualToString:", CFSTR("state")))
    goto LABEL_6;
  -[WFSetLowPowerModeAction runningDelegate](self, "runningDelegate");
  ...
  if (v21)
  {
    ...
    if (v22)
    {
      +[WFLowPowerModeSettingsClient getReversalStateWithBookmark:completionHandler:](WFLowPowerModeSettingsClient, "getReversalStateWithBookmark:completionHandler:", v22, v16);
    }
    else
    {
...
- (void)finishRunningWithError:(id)a3
{
  ...
  else
  {
    ...
    v7[3] = &unk_24F8B3230;
    v7[4] = self;
    +[WFLowPowerModeSettingsClient getBookmarkForCurrentStateWithCompletionHandler:](WFLowPowerModeSettingsClient, "getBookmarkForCurrentStateWithCompletionHandler:", v7);
  }
...
void __50__WFSetLowPowerModeAction_finishRunningWithError___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v5)
  {
    ...
    objc_msgSendSuper2(&v9, sel_finishRunningWithError_, 0, *(_QWORD *)(a1 + 32), WFSetLowPowerModeAction, v10.receiver, v10.super_class);
  }
  else
  {
    objc_msgSendSuper2(&v10, sel_finishRunningWithError_, a3, v9.receiver, v9.super_class, *(_QWORD *)(a1 + 32), WFSetLowPowerModeAction);
  }
