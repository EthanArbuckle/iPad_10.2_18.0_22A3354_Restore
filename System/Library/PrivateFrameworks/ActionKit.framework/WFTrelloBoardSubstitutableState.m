...
void __92__WFTrelloBoardSubstitutableState_processWithContext_userInputRequiredHandler_valueHandler___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  v14 = v8;
  v15 = v7;
  objc_msgSend(v9, "objectOfClasses:forKey:completion:", v12, CFSTR("WFTrelloBoards"), v16);

}

void __92__WFTrelloBoardSubstitutableState_processWithContext_userInputRequiredHandler_valueHandler___block_invoke_2(_QWORD *a1, void *a2)
{
  uint64_t v3;
  id v4;

  v3 = a1[6];
  objc_msgSend(a2, "objectMatchingKey:value:", CFSTR("name"), a1[4]);
  v4 = (id)objc_claimAutoreleasedReturnValue();
  (*(void (**)(uint64_t, id, _QWORD))(v3 + 16))(v3, v4, a1[5]);
