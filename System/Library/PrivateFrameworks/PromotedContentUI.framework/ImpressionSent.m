...
- (_TtC17PromotedContentUI14ImpressionSent)initWithFrame:(CGRect)a3
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  *((_BYTE *)&self->super.super.super.isa + OBJC_IVAR____TtC17PromotedContentUI14ImpressionSent_alreadySent) = 0;
  *((_BYTE *)&self->super.super.super.isa + OBJC_IVAR____TtC17PromotedContentUI14ImpressionSent_alreadyRecorded) = 0;
  v8.receiver = self;
...
- (_TtC17PromotedContentUI14ImpressionSent)initWithCoder:(id)a3
{
  ...
  *((_BYTE *)&self->super.super.super.isa + OBJC_IVAR____TtC17PromotedContentUI14ImpressionSent_alreadyRecorded) = 0;
  ...
  return -[ImpressionSent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
