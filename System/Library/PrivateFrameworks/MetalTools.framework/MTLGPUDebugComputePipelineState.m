...
- (void)_initConstantsBuffer:(id)a3 device:(id)a4
{
  void *v7;
  id v8;
  MTLGPUDebugPipelineStateInfoEncoder *v9;
  void *v10;
  uint64_t v11;
  ...
  if (objc_msgSend(v7, "length"))
  {
    ...
    -[MTLGPUDebugImageData setConstantData:](self->_kernelFunctionData, "setConstantData:", v8);

  }
  if (self->_supportsIndirectCommandBuffers
    && (HIBYTE(self->super.super._device[2].dynamicLibraryObjectCache) & 0x20) != 0)
  {
    v9 = -[MTLGPUDebugPipelineStateInfoEncoder initWithDevice:]([MTLGPUDebugPipelineStateInfoEncoder alloc], "initWithDevice:", self->super.super._device);
    v10 = (void *)objc_msgSend((id)objc_msgSend(a4, "baseObject"), "newBufferWithLength:options:", -[MTLGPUDebugPipelineStateInfoEncoder encodedLength](v9, "encodedLength"), 0);
    self->_indirectStateBuffer = -[MTLGPUDebugBuffer initWithBuffer:device:offset:length:track:]([MTLGPUDebugBuffer alloc], "initWithBuffer:device:offset:length:track:", v10, a4, 0, objc_msgSend(v10, "length"), 0);

    -[MTLGPUDebugPipelineStateInfoEncoder setArgumentBuffer:offset:](v9, "setArgumentBuffer:offset:", self->_indirectStateBuffer, 0);
    -[MTLGPUDebugPipelineStateInfoEncoder setComputePipelineState:](v9, "setComputePipelineState:", self);
...
{
  MTLGPUDebugComputePipelineState *v14;
  uint64_t v15;
  NSMutableArray *v16;
  uint64_t v17;
  uint64_t v18;
  ...
  if (v14)
  {
    ...
    v14->_kernelFunctionData = -[MTLGPUDebugImageData initWithFunction:debugInstrumentationData:]([MTLGPUDebugImageData alloc], "initWithFunction:debugInstrumentationData:", v15, objc_msgSend(a3, "debugInstrumentationData"));
    ...
    -[MTLGPUDebugComputePipelineState _initConstantsBuffer:device:](v14, "_initConstantsBuffer:device:", a3, a7);
  }
  return v14;
}
...
{
  MTLGPUDebugComputePipelineState *v11;
  MTLGPUDebugComputePipelineState *v12;
  NSMutableArray *v13;
  uint64_t v14;
  uint64_t v15;
  uint64_t v16;
  ...
  if (v11)
  {
    ...
    -[MTLGPUDebugComputePipelineState _initConstantsBuffer:device:](v12, "_initConstantsBuffer:device:", a3, v12->super.super._device);
  }
  return v12;
}
...
- (id)newVisibleFunctionTableWithDescriptor:(id)a3
{
  ...
  {
    v6 = result;
    v7 = -[MTLGPUDebugVisibleFunctionTable initWithVisibleFunctionTable:descriptor:computePipeline:]([MTLGPUDebugVisibleFunctionTable alloc], "initWithVisibleFunctionTable:descriptor:computePipeline:", result, a3, self);
...
- (id)newIntersectionFunctionTableWithDescriptor:(id)a3
{
  ...
  {
    v6 = result;
    v7 = -[MTLGPUDebugIntersectionFunctionTable initWithIntersectionFunctionTable:device:descriptor:computePipelineState:]([MTLGPUDebugIntersectionFunctionTable alloc], "initWithIntersectionFunctionTable:device:descriptor:computePipelineState:", result, -[MTLToolsComputePipelineState device](self, "device"), a3, self);
...
- (id)functionHandleWithFunction:(id)a3
{
  ...
  uint64_t v8;
  uint64_t v9;
  MTLGPUDebugFunctionHandle *(*v10)(_QWORD *);
  void *v11;
  uint64_t v12;
  MTLGPUDebugComputePipelineState *v13;
  id v14;
...
MTLGPUDebugFunctionHandle *__62__MTLGPUDebugComputePipelineState_functionHandleWithFunction___block_invoke(_QWORD *a1)
{
  return -[MTLGPUDebugFunctionHandle initWithFunctionHandle:computePiplineState:function:]([MTLGPUDebugFunctionHandle alloc], "initWithFunctionHandle:computePiplineState:function:", a1[4], a1[5], a1[6]);
}
...
- (id)newComputePipelineStateWithAdditionalBinaryFunctions:(id)a3 error:(id *)a4
{
  ...
  v13 = -[MTLGPUDebugComputePipelineState initWithComputePipelineState:binaryFunctions:withState:device:pipelineOptions:]([MTLGPUDebugComputePipelineState alloc], "initWithComputePipelineState:binaryFunctions:withState:device:pipelineOptions:", v12, a3, self, self->super.super._device, 0);
...
- (MTLGPUDebugBuffer)globalConstantsBuffer
{
  ...
  if (kernelFunctionData)
    return (MTLGPUDebugBuffer *)*((_QWORD *)kernelFunctionData + 1);
  else
    return 0;
}
