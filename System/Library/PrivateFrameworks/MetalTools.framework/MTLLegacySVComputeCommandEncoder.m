...
{
  MTLLegacySVComputeCommandEncoder *v6;
  MTLLegacySVComputeCommandEncoder *v7;
  uint64_t v8;
  objc_super v10;
  ...
  if (v6)
  {
    ...
    if ((*((_BYTE *)&v7->_options->var0 + 2) & 0x80) == 0)
      -[MTLLegacySVComputeCommandEncoder _initBufferArgumentData:](v7, "_initBufferArgumentData:", v7->super.super.super._device);
  }
  return v7;
}
...
{
  char *v7;
  MTLLegacySVComputeCommandEncoder *v8;
  uint64_t v9;
  objc_super v11;
  ...
  v8 = (MTLLegacySVComputeCommandEncoder *)v7;
  if (v7)
  {
    v9 = *((_QWORD *)v7 + 3) + 264;
    *((_QWORD *)v7 + 8) = v9;
    *((_DWORD *)v7 + 524) = a6;
    *((_DWORD *)v7 + 525) = 0;
    v7[56] = (*(_QWORD *)(v9 + 20) & 0x200000001) != 0;
    MTLGPUDebugStageBufferHandles::clear((MTLGPUDebugStageBufferHandles *)(v7 + 72));
    if ((*((_BYTE *)&v8->_options->var0 + 2) & 0x80) == 0)
      -[MTLLegacySVComputeCommandEncoder _initBufferArgumentData:](v8, "_initBufferArgumentData:", v8->super.super.super._device);
  }
  return v8;
}
...
{
  MTLLegacySVBufferSubAlloc *p_reportBuffer;
  id v8;
...
- (void)setComputePipelineStateBuffers:(id)a3
{
  ...
  if ((*((_BYTE *)&self->_options->var0 + 2) & 0x80) != 0)
  {
    if (objc_msgSend(a3, "globalConstantsBuffer"))
    {
      ...
      -[MTLLegacySVComputeCommandEncoder useResource:usage:](self, "useResource:usage:", objc_msgSend(a3, "globalConstantsBuffer"), 1);
    }
    v14 = 0u;
    v15 = 0u;
    v12 = 0u;
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          if (*(_QWORD *)(v10 + 8))
          {
            ...
            -[MTLLegacySVComputeCommandEncoder useResource:usage:](self, "useResource:usage:", *(_QWORD *)(v10 + 8), 1);
          }
        }
...
{
  -[MTLLegacySVComputeCommandEncoder setBuffer:offset:attributeStride:atIndex:](self, "setBuffer:offset:attributeStride:atIndex:", a3, a4, -1, a5);
}
...
{
  -[MTLLegacySVComputeCommandEncoder setBufferOffset:attributeStride:atIndex:](self, "setBufferOffset:attributeStride:atIndex:", a3, -1, a4);
}

- (void)setBufferOffset:(unint64_t)a3 attributeStride:(unint64_t)a4 atIndex:(unint64_t)a5
{
  MTLGPUDebugStageBufferHandles::setBufferOffset((MTLGPUDebugStageBufferHandles *)&self->_handles, a3, a4, a5);
}
...
- (void)setBuffers:(const void *)a3 offsets:(const unint64_t *)a4 attributeStrides:(const unint64_t *)a5 withRange:(_NSRange)a6
{
  ...
  if (a6.length)
  {
    ...
    do
    {
      -[MTLLegacySVComputeCommandEncoder setBuffer:offset:attributeStride:atIndex:](self, "setBuffer:offset:attributeStride:atIndex:", a3[v12], a4[v12], a5[v12], v12 + location);
      v12 = v13;
    }
    while (length > v13++);
  }
...
{
  -[MTLLegacySVComputeCommandEncoder setBytes:length:attributeStride:atIndex:](self, "setBytes:length:attributeStride:atIndex:", a3, a4, -1, a5);
}

- (void)setBytes:(const void *)a3 length:(unint64_t)a4 attributeStride:(unint64_t)a5 atIndex:(unint64_t)a6
{
  -[MTLLegacySVComputeCommandEncoder setBuffer:offset:attributeStride:atIndex:](self, "setBuffer:offset:attributeStride:atIndex:", -[MTLLegacySVComputeCommandEncoder temporaryBufferWithBytes:length:](self, "temporaryBufferWithBytes:length:", a3, a4), 0, a5, a6);
}
...
- (void)setAccelerationStructures:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLLegacySVComputeCommandEncoder setAccelerationStructure:atBufferIndex:](self, "setAccelerationStructure:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setVisibleFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLLegacySVComputeCommandEncoder setVisibleFunctionTable:atBufferIndex:](self, "setVisibleFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setIntersectionFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLLegacySVComputeCommandEncoder setIntersectionFunctionTable:atBufferIndex:](self, "setIntersectionFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)dispatchThreads:(id *)a3 threadsPerThreadgroup:(id *)a4
{
  ...
  -[MTLLegacySVComputeCommandEncoder flushBindings](self, "flushBindings");
  v9 = *a3;
  v8 = *a4;
  v7.receiver = self;
...
- (void)setThreadgroupMemoryLength:(unint64_t)a3 atIndex:(unint64_t)a4
{
  ...
  {
    MTLGPUDebugThreadgroupLengths::setThreadgroupMemoryLength((MTLGPUDebugThreadgroupLengths *)&self->_threadgroup, a3, a4);
  }
  else
  {
    v4.receiver = self;
...
- (void)useResources:(const void *)a3 count:(unint64_t)a4 usage:(unint64_t)a5
{
  ...
  if (a4)
  {
    ...
    {
      v9 = (uint64_t)*a3++;
      -[MTLLegacySVComputeCommandEncoder useResource:usage:](self, "useResource:usage:", v9, a5);
      --v6;
    }
    while (v6);
  }
...
- (void)useHeaps:(const void *)a3 count:(unint64_t)a4
{
  ...
  if (a4)
  {
    ...
    {
      v7 = (uint64_t)*a3++;
      -[MTLLegacySVComputeCommandEncoder useHeap:](self, "useHeap:", v7);
      --v4;
    }
    while (v4);
  }
...
- (void)setComputePipelineState:(id)a3
{
  ...
  if ((*((_BYTE *)&options->var0 + 2) & 0x40) != 0)
    -[MTLLegacySVComputeCommandEncoder setComputePipelineStateBuffers:](self, "setComputePipelineStateBuffers:", a3);
