...
- (id)newTextureViewWithPixelFormat:(unint64_t)a3
{
  ...
  {
    v5 = result;
    v6 = -[MTLLegacySVTexture initWithTextureView:parentTexture:heap:device:]([MTLLegacySVTexture alloc], "initWithTextureView:parentTexture:heap:device:", result, self, -[MTLToolsResource heap](self, "heap"), self->super.super.super._device);
...
- (id)newTextureViewWithPixelFormat:(unint64_t)a3 textureType:(unint64_t)a4 levels:(_NSRange)a5 slices:(_NSRange)a6
{
  ...
  {
    v8 = result;
    v9 = -[MTLLegacySVTexture initWithTextureView:parentTexture:heap:device:]([MTLLegacySVTexture alloc], "initWithTextureView:parentTexture:heap:device:", result, self, -[MTLToolsResource heap](self, "heap"), self->super.super.super._device);
...
- (id)newTextureViewWithPixelFormat:(unint64_t)a3 textureType:(unint64_t)a4 levels:(_NSRange)a5 slices:(_NSRange)a6 swizzle:(id)a7
{
  ...
  {
    v9 = result;
    v10 = -[MTLLegacySVTexture initWithTextureView:parentTexture:heap:device:]([MTLLegacySVTexture alloc], "initWithTextureView:parentTexture:heap:device:", result, self, -[MTLToolsResource heap](self, "heap"), self->super.super.super._device);
...
- (id)newTextureViewWithPixelFormat:(unint64_t)a3 resourceIndex:(unint64_t)a4
{
  ...
  {
    v6 = result;
    v7 = -[MTLLegacySVTexture initWithTextureView:parentTexture:heap:device:]([MTLLegacySVTexture alloc], "initWithTextureView:parentTexture:heap:device:", result, self, -[MTLToolsResource heap](self, "heap"), self->super.super.super._device);
...
- (id)newTextureViewWithPixelFormat:(unint64_t)a3 textureType:(unint64_t)a4 levels:(_NSRange)a5 slices:(_NSRange)a6 swizzle:(id)a7 resourceIndex:(unint64_t)a8
{
  ...
  {
    v10 = result;
    v11 = -[MTLLegacySVTexture initWithTextureView:parentTexture:heap:device:]([MTLLegacySVTexture alloc], "initWithTextureView:parentTexture:heap:device:", result, self, -[MTLToolsResource heap](self, "heap"), self->super.super.super._device);
