...
{
  unint64_t *v2;
  MTLGPUDebugImageData *v3;

  v2 = (unint64_t *)((char *)self + 48);
  if (!*((_QWORD *)self + 6))
  {
    v3 = -[MTLGPUDebugImageData initWithFunction:]([MTLGPUDebugImageData alloc], "initWithFunction:", self);
    while (!__ldaxr(v2))
    {
...
{
  -[MTLGPUDebugFunction _initImageData](self, "_initImageData");
...
+ (id)convertUserType:(id)a3
{
  ...
  else
  {
    ...
    {
      case 1:
        return +[MTLGPUDebugFunction internalStructTypeFromUserStructType:](MTLGPUDebugFunction, "internalStructTypeFromUserStructType:", a3);
      case 2:
        return +[MTLGPUDebugFunction internalArrayTypeFromUserArrayType:](MTLGPUDebugFunction, "internalArrayTypeFromUserArrayType:", a3);
      case 60:
        break;
      default:
        return a3;
...
LABEL_14:
    ...
    v8 = 0;
LABEL_12:
    v10 = +[MTLGPUDebugFunction convertUserType:](MTLGPUDebugFunction, "convertUserType:", v8);
    v7 = v3;
    if (v10 != v8)
    {
      v11 = v10;
...
LABEL_10:
        ...
        if (objc_msgSend(StructMember, "dataType") == 1)
        {
          ...
          v14 = objc_msgSend(StructMember, "offset");
          v15 = objc_msgSend(StructMember, "argumentIndex");
          IndirectConstant = +[MTLGPUDebugFunction convertUserType:](MTLGPUDebugFunction, "convertUserType:", objc_msgSend(StructMember, "structType"));
        ...
        if (objc_msgSend(StructMember, "dataType") == 2)
        {
          ...
          v14 = objc_msgSend(StructMember, "offset");
          v15 = objc_msgSend(StructMember, "argumentIndex");
          IndirectConstant = +[MTLGPUDebugFunction convertUserType:](MTLGPUDebugFunction, "convertUserType:", objc_msgSend(StructMember, "arrayType"));
...
- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 reflection:(id *)a4 pipelineLibrary:(id)a5 binaryArchives:(id)a6
{
  ...
  void *v15;
  uint64_t v16;
  MTLGPUDebugArgumentEncoder *v17;
  void *v18;
  void *v19;
  uint64_t v20;
  uint64_t v21;
  ...
  void *v24;
  MTLStructType *v25;
  MTLGPUDebugDevice *v26;
  GPUDebugArgumentEncoderLayout *v27;
  _QWORD *v28;
  id *v29;
  void *v30;
  void *context;
  void *v33;
  GPUDebugArgumentEncoderLayout *v34;
  unsigned int v35;
  __int128 v36;
  __int128 v37;
  __int128 v38;
        ...
        while (2)
        {
          for (i = 0; i != v20; ++i)
          {
            ...
            if (!objc_msgSend(v23, "type") && objc_msgSend(v23, "index") == a3)
            {
              ...
              v35 = a3;
              v26 = (MTLGPUDebugDevice *)*((_QWORD *)self + 3);
              v27 = (GPUDebugArgumentEncoderLayout *)operator new();
              GPUDebugArgumentEncoderLayout::GPUDebugArgumentEncoderLayout(v27, v25, v26);
              v34 = v27;
              v28 = std::__hash_table<std::__hash_value_type<unsigned int,std::unique_ptr<GPUDebugArgumentEncoderLayout>>,std::__unordered_map_hasher<unsigned int,std::__hash_value_type<unsigned int,std::unique_ptr<GPUDebugArgumentEncoderLayout>>,std::hash<unsigned int>,std::equal_to<unsigned int>,true>,std::__unordered_map_equal<unsigned int,std::__hash_value_type<unsigned int,std::unique_ptr<GPUDebugArgumentEncoderLayout>>,std::equal_to<unsigned int>,std::hash<unsigned int>,true>,std::allocator<std::__hash_value_type<unsigned int,std::unique_ptr<GPUDebugArgumentEncoderLayout>>>>::__emplace_unique_key_args<unsigned int,unsigned int,std::unique_ptr<GPUDebugArgumentEncoderLayout>>((uint64_t)self + 120, &v35, &v35, (uint64_t *)&v34);
              v29 = (id *)v34;
              v34 = 0;
              v24 = context;
              if (v29)
              {
                GPUDebugArgumentEncoderLayout::~GPUDebugArgumentEncoderLayout(v29);
                MEMORY[0x22E309118]();
              }
              v14 = (_QWORD *)v28[3];
              goto LABEL_42;
...
LABEL_46:
    ...
    if (v14)
    {
      ...
      v17 = -[MTLGPUDebugArgumentEncoder initWithArgumentEncoder:layout:device:]([MTLGPUDebugArgumentEncoder alloc], "initWithArgumentEncoder:layout:device:", v30, v14, -[MTLToolsObject device](self, "device"));
  ...
  {
    v42.receiver = self;
    v42.super_class = (Class)MTLGPUDebugFunction;
  ...
  {
    v41.receiver = self;
    v41.super_class = (Class)MTLGPUDebugFunction;
  ...
  {
    v40.receiver = self;
    v40.super_class = (Class)MTLGPUDebugFunction;
...
{
  return -[MTLGPUDebugFunction newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:](self, "newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:", a3, 0, 0, 0);
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 reflection:(id *)a4
{
  return -[MTLGPUDebugFunction newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:](self, "newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:", a3, a4, 0, 0);
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 pipelineLibrary:(id)a4
{
  return -[MTLGPUDebugFunction newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:](self, "newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:", a3, 0, a4, 0);
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 reflection:(id *)a4 pipelineLibrary:(id)a5
{
  return -[MTLGPUDebugFunction newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:](self, "newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:", a3, a4, a5, 0);
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 reflection:(id *)a4 binaryArchives:(id)a5
{
  return -[MTLGPUDebugFunction newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:](self, "newArgumentEncoderWithBufferIndex:reflection:pipelineLibrary:binaryArchives:", a3, a4, 0, a5);
}
