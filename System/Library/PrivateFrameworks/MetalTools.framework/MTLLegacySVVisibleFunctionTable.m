...
{
  MTLLegacySVVisibleFunctionTable *v5;
  objc_super v7;
  ...
  -[MTLLegacySVVisibleFunctionTable _setupCommon](v5, "_setupCommon");
  return v5;
}
...
- (MTLLegacySVVisibleFunctionTable)initWithVisibleFunctionTable:(id)a3 descriptor:(id)a4 renderPipeline:(id)a5 stage:(unint64_t)a6
{
  ...
  -[MTLLegacySVVisibleFunctionTable _setupCommon](v7, "_setupCommon");
  v7->_stage = a6;
  return v7;
}
...
- (void)setBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  if (a5.length)
  {
    ...
    do
    {
      -[MTLLegacySVVisibleFunctionTable setBuffer:offset:atIndex:](self, "setBuffer:offset:atIndex:", a3[v10], a4[v10], v10 + location);
      v10 = v11;
    }
    while (length > v11++);
  }
