...
- (id)newBufferWithLength:(unint64_t)a3 options:(unint64_t)a4
{
  ...
  if (!v5)
    return 0;
  v6 = (void *)v5;
  v7 = -[MTLLegacySVBuffer initWithBuffer:heap:device:]([MTLLegacySVBuffer alloc], "initWithBuffer:heap:device:", v5, self, self->super.super._device);
...
- (id)newBufferWithLength:(unint64_t)a3 options:(unint64_t)a4 offset:(unint64_t)a5
{
  ...
  if (!v6)
    return 0;
  v7 = (void *)v6;
  v8 = -[MTLLegacySVBuffer initWithBuffer:heap:device:]([MTLLegacySVBuffer alloc], "initWithBuffer:heap:device:", v6, self, self->super.super._device);
...
- (id)newTextureWithDescriptor:(id)a3
{
  ...
  if (!v4)
    return 0;
  v5 = (void *)v4;
  v6 = -[MTLLegacySVTexture initWithTexture:heap:device:]([MTLLegacySVTexture alloc], "initWithTexture:heap:device:", v4, self, self->super.super._device);
...
- (id)newTextureWithDescriptor:(id)a3 offset:(unint64_t)a4
{
  uint64_t v5;
  void *v6;
  MTLLegacySVTexture *v7;

  v5 = -[MTLToolsObject newTextureWithDescriptor:offset:](self->super.super._baseObject, "newTextureWithDescriptor:offset:", a3, a4);
  if (!v5)
    return 0;
  v6 = (void *)v5;
  v7 = -[MTLLegacySVTexture initWithTexture:heap:device:]([MTLLegacySVTexture alloc], "initWithTexture:heap:device:", v5, self, self->super.super._device);
...
- (void)notifyResourceReleasing:(id)a3
{
  ...
  if (*((_BYTE *)&self->super.super._externalReferences + 4))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v17 = objc_msgSend(a3, "resourceIndex");
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        v16 = objc_msgSend(a3, "bufferIndex");
      ...
      else
      {
        ...
        v15 = objc_msgSend(a3, "resourceIndex");
...
{
  MTLLegacySVAccelerationStructure *v5;
  os_unfair_lock_s *p_accelerationStructureLock;
  unsigned int v7;
  unsigned int v8;
  vector<unsigned int, std::allocator<unsigned int>> *p_accelerationStructureIndices;
  ...
  if (!a3)
    return 0;
  v5 = -[MTLLegacySVAccelerationStructure initWithAccelerationStructure:heap:]([MTLLegacySVAccelerationStructure alloc], "initWithAccelerationStructure:heap:", a3, self);
  if (*((_BYTE *)&self->super.super._externalReferences + 4))
  {
    p_accelerationStructureLock = &self->_accelerationStructureLock;
    os_unfair_lock_lock(&self->_accelerationStructureLock);
...
{
  return -[MTLLegacySVHeap _newGPUDebugAccelerationStructure:](self, "_newGPUDebugAccelerationStructure:", -[MTLToolsObject newAccelerationStructureWithSize:](self->super.super._baseObject, "newAccelerationStructureWithSize:", a3));
}

- (id)newAccelerationStructureWithDescriptor:(id)a3
{
  return -[MTLLegacySVHeap _newGPUDebugAccelerationStructure:](self, "_newGPUDebugAccelerationStructure:", -[MTLToolsObject newAccelerationStructureWithDescriptor:](self->super.super._baseObject, "newAccelerationStructureWithDescriptor:", unwrapAccelerationStructureDescriptor(a3)));
}

- (id)newAccelerationStructureWithSize:(unint64_t)a3 offset:(unint64_t)a4
{
  return -[MTLLegacySVHeap _newGPUDebugAccelerationStructure:](self, "_newGPUDebugAccelerationStructure:", -[MTLToolsObject newAccelerationStructureWithSize:offset:](self->super.super._baseObject, "newAccelerationStructureWithSize:offset:", a3, a4));
}

- (id)newAccelerationStructureWithDescriptor:(id)a3 offset:(unint64_t)a4
{
  return -[MTLLegacySVHeap _newGPUDebugAccelerationStructure:](self, "_newGPUDebugAccelerationStructure:", -[MTLToolsObject newAccelerationStructureWithDescriptor:offset:](self->super.super._baseObject, "newAccelerationStructureWithDescriptor:offset:", unwrapAccelerationStructureDescriptor(a3), a4));
}

- (id)newAccelerationStructureWithSize:(unint64_t)a3 resourceIndex:(unint64_t)a4
{
  return -[MTLLegacySVHeap _newGPUDebugAccelerationStructure:](self, "_newGPUDebugAccelerationStructure:", -[MTLToolsObject newAccelerationStructureWithSize:resourceIndex:](self->super.super._baseObject, "newAccelerationStructureWithSize:resourceIndex:", a3, a4));
}

- (id)newAccelerationStructureWithSize:(unint64_t)a3 offset:(unint64_t)a4 resourceIndex:(unint64_t)a5
{
  return -[MTLLegacySVHeap _newGPUDebugAccelerationStructure:](self, "_newGPUDebugAccelerationStructure:", -[MTLToolsObject newAccelerationStructureWithSize:offset:resourceIndex:](self->super.super._baseObject, "newAccelerationStructureWithSize:offset:resourceIndex:", a3, a4, a5));
}
...
- (void).cxx_destruct
{
  ...
  v5 = self->_textureIndices.__begin_;
  if (v5)
  {
