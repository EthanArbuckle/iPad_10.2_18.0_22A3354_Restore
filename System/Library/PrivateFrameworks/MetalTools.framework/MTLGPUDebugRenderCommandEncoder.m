...
{
  MTLGPUDebugRenderCommandEncoder *v8;
  ...
  if (v8)
  {
    ...
    v8->_encoderType = 0;
    p_deviceWrapper = (uint64_t)&v8->super.super.super._device[2]._deviceWrapper;
    v8->_options = (Options *)p_deviceWrapper;
    v8->_drawID.encoderID = a6;
    v8->_drawID.eventID = 0;
    *(&v8->_enableUseResourceValidation + 4) = (*(_QWORD *)(p_deviceWrapper + 20) & 0x200000001) != 0;
    MTLGPUDebugStageBufferHandles::clear(&v8->_vertexHandles);
    if ((*((_BYTE *)&v9->_options->var0 + 2) & 0x80) == 0)
      -[MTLGPUDebugRenderCommandEncoder _initBufferArgumentData:](v9, "_initBufferArgumentData:", v9->super.super.super._device);
...
{
  MTLGPUDebugRenderCommandEncoder *v7;
  uint64_t p_deviceWrapper;
  objc_super v10;
  ...
  if (v7)
  {
    v7->_commandBuffer = (MTLGPUDebugCommandBuffer *)objc_msgSend(a4, "commandBuffer");
    v7->_encoderType = 3;
    p_deviceWrapper = (uint64_t)&v7->super.super.super._device[2]._deviceWrapper;
    v7->_options = (Options *)p_deviceWrapper;
    *(&v7->_enableUseResourceValidation + 4) = (*(_QWORD *)(p_deviceWrapper + 20) & 0x200000001) != 0;
    ...
    if ((*((_BYTE *)&v7->_options->var0 + 2) & 0x80) == 0)
      -[MTLGPUDebugRenderCommandEncoder _initBufferArgumentData:](v7, "_initBufferArgumentData:", v7->super.super.super._device);
  }
  return v7;
}
...
- (void)flushBindings
{
  ...
  int v33;
  uint64_t v34;
  MTLGPUDebugStageBufferHandles *p_vertexHandles;
  Options *v36;
  _BOOL4 v37;
  uint64_t v38;
  unint64_t v39;
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)-[MTLGPUDebugRenderPipelineState vertexFunctionData](self->_currentPipeline, "vertexFunctionData");
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)-[MTLGPUDebugRenderPipelineState fragmentFunctionData](self->_currentPipeline, "fragmentFunctionData");
    ...
    {
      v3 = -[MTLGPUDebugRenderPipelineState fragmentMaxCallStackDepth](self->_currentPipeline, "fragmentMaxCallStackDepth");
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)-[MTLGPUDebugRenderPipelineState tileFunctionData](self->_currentPipeline, "tileFunctionData");
    -[MTLToolsObject setTileBytes:length:atIndex:](self->super.super.super._baseObject, "setTileBytes:length:atIndex:");
    if ((*(_QWORD *)&self->_options->var0 & 0x400000001) != 0)
    {
      LODWORD(v78) = 0;
      v7 = -[MTLGPUDebugRenderPipelineState tileMaxCallStackDepth](self->_currentPipeline, "tileMaxCallStackDepth");
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)-[MTLGPUDebugRenderPipelineState objectFunctionData](self->_currentPipeline, "objectFunctionData");
    -[MTLToolsObject setObjectBytes:length:atIndex:](self->super.super.super._baseObject, "setObjectBytes:length:atIndex:");
    if ((*(_QWORD *)&self->_options->var0 & 0x400000001) != 0)
    {
      LODWORD(v78) = 0;
      v11 = -[MTLGPUDebugRenderPipelineState objectMaxCallStackDepth](self->_currentPipeline, "objectMaxCallStackDepth");
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)-[MTLGPUDebugRenderPipelineState meshFunctionData](self->_currentPipeline, "meshFunctionData");
    -[MTLToolsObject setMeshBytes:length:atIndex:](self->super.super.super._baseObject, "setMeshBytes:length:atIndex:");
    if ((*(_QWORD *)&self->_options->var0 & 0x400000001) != 0)
    {
      LODWORD(v78) = 0;
      v15 = -[MTLGPUDebugRenderPipelineState meshMaxCallStackDepth](self->_currentPipeline, "meshMaxCallStackDepth");
...
- (void)setTessellationControlPointIndexBuffer:(id)a3 offset:(unint64_t)a4
{
  ...
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markBuffer:usage:stages:](self->_commandBuffer, "markBuffer:usage:stages:", a3, 1, 1);
  if ((*((_BYTE *)&self->_options->var0 + 2) & 0x80) != 0)
  {
  ...
  {
LABEL_7:
    -[MTLGPUDebugRenderCommandEncoder useResource:usage:stages:](self, "useResource:usage:stages:", a3, 1, 1);
  ...
  if ((*((_BYTE *)&self->_options->var0 + 2) & 1) != 0)
  {
    switch(a6)
    {
      case 1uLL:
        ...
        -[MTLToolsObject setVertexBuffer:offset:atIndex:](self->super.super.super._baseObject, "setVertexBuffer:offset:atIndex:", a5, 0, 7);
      ...
      case 2uLL:
        ...
        -[MTLToolsObject setFragmentBuffer:offset:atIndex:](self->super.super.super._baseObject, "setFragmentBuffer:offset:atIndex:", a5, 0, 7);
...
LABEL_8:
        if (-[MTLToolsDevice supportsTileShaders](self->super.super.super._device, "supportsTileShaders"))
        {
          ...
          -[MTLToolsObject setTileBuffer:offset:atIndex:](self->super.super.super._baseObject, "setTileBuffer:offset:atIndex:", a5, 0, 7);
        }
        return;
      case 8uLL:
        ...
        -[MTLToolsObject setObjectBuffer:offset:atIndex:](self->super.super.super._baseObject, "setObjectBuffer:offset:atIndex:", a5, 0, 7);
        self->_objectBufferUsageTable = (MTLBuffer *)a3;
        self->_objectTextureUsageTable = (MTLBuffer *)a4;
        v10 = 9080;
        break;
      default:
        if (a6 != 16 || !-[MTLToolsDevice supportsMeshShaders](self->super.super.super._device, "supportsMeshShaders"))
          return;
        ...
        -[MTLToolsObject setMeshBuffer:offset:atIndex:](self->super.super.super._baseObject, "setMeshBuffer:offset:atIndex:", a5, 0, 7);
...
{
  MTLGPUDebugBufferSubAlloc *p_vertexReportBuffer;
  id v8;
  MTLToolsObject *baseObject;
  uint64_t v10;
  uint64_t v11;
...
{
  MTLGPUDebugBufferSubAlloc *p_fragmentReportBuffer;
  id v8;
  MTLToolsObject *baseObject;
  uint64_t v10;
  uint64_t v11;
...
{
  MTLGPUDebugBufferSubAlloc *p_tileReportBuffer;
  id v8;
  MTLToolsObject *baseObject;
  uint64_t v10;
  uint64_t v11;
...
{
  MTLGPUDebugBufferSubAlloc *p_objectReportBuffer;
  id v8;
  MTLToolsObject *baseObject;
  uint64_t v10;
  uint64_t v11;
...
{
  MTLGPUDebugBufferSubAlloc *p_meshReportBuffer;
  id v8;
  MTLToolsObject *baseObject;
  uint64_t v10;
  uint64_t v11;
...
- (void)setRenderPipelineStateBuffers:(id)a3
{
  ...
  if ((*((_BYTE *)&self->_options->var0 + 2) & 0x80) != 0)
  {
      ...
      do
      {
        for (i = 0; i != v12; ++i)
        {
          ...
          if (*(_QWORD *)(v15 + 8))
          {
            ...
            -[MTLGPUDebugRenderCommandEncoder useResource:usage:](self, "useResource:usage:", *(_QWORD *)(v15 + 8), 1);
          }
        }
    ...
    if (v5)
    {
      ...
      -[MTLGPUDebugRenderCommandEncoder useResource:usage:stages:](self, "useResource:usage:stages:", v5, 1, 1);
    }
    if (v6)
    {
      -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", v6);
      -[MTLGPUDebugRenderCommandEncoder useResource:usage:stages:](self, "useResource:usage:stages:", v6, 1, 2);
    }
    if (*(&self->_enableUseResourceValidation + 1))
    {
    ...
    if (v16)
    {
      ...
      -[MTLGPUDebugRenderCommandEncoder useResource:usage:stages:](self, "useResource:usage:stages:", v16, 1, 4);
    }
    if (*(&self->_enableUseResourceValidation + 3) && v17)
    {
      -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", v17);
      -[MTLGPUDebugRenderCommandEncoder useResource:usage:stages:](self, "useResource:usage:stages:", v17, 1, 16);
    }
    if (*(&self->_enableUseResourceValidation + 2) && v18)
    {
      -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", v18);
      -[MTLGPUDebugRenderCommandEncoder useResource:usage:stages:](self, "useResource:usage:stages:", v18, 1, 8);
    }
  }
  else
  {
...
{
  -[MTLGPUDebugRenderCommandEncoder setVertexBuffer:offset:attributeStride:atIndex:](self, "setVertexBuffer:offset:attributeStride:atIndex:", a3, a4, -1, a5);
}

- (void)setVertexBuffer:(id)a3 offset:(unint64_t)a4 attributeStride:(unint64_t)a5 atIndex:(unint64_t)a6
{
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markBuffer:usage:stages:](self->_commandBuffer, "markBuffer:usage:stages:", a3, 3, 1);
...
{
  -[MTLGPUDebugRenderCommandEncoder setVertexBufferOffset:attributeStride:atIndex:](self, "setVertexBufferOffset:attributeStride:atIndex:", a3, -1, a4);
}

- (void)setVertexBufferOffset:(unint64_t)a3 attributeStride:(unint64_t)a4 atIndex:(unint64_t)a5
{
  MTLGPUDebugStageBufferHandles::setBufferOffset(&self->_vertexHandles, a3, a4, a5);
}
...
- (void)setVertexBuffers:(const void *)a3 offsets:(const unint64_t *)a4 attributeStrides:(const unint64_t *)a5 withRange:(_NSRange)a6
{
  ...
  if (a6.length)
  {
    ...
    do
    {
      ...
      v14 = v15;
      v16 = *a5++;
      -[MTLGPUDebugRenderCommandEncoder setVertexBuffer:offset:attributeStride:atIndex:](self, "setVertexBuffer:offset:attributeStride:atIndex:", v12, v14, v16, location++);
      --length;
    }
    while (length);
  }
...
{
  -[MTLGPUDebugRenderCommandEncoder setVertexBytes:length:attributeStride:atIndex:](self, "setVertexBytes:length:attributeStride:atIndex:", a3, a4, -1, a5);
}

- (void)setVertexBytes:(const void *)a3 length:(unint64_t)a4 attributeStride:(unint64_t)a5 atIndex:(unint64_t)a6
{
  -[MTLGPUDebugRenderCommandEncoder setVertexBuffer:offset:attributeStride:atIndex:](self, "setVertexBuffer:offset:attributeStride:atIndex:", -[MTLGPUDebugRenderCommandEncoder temporaryBufferWithBytes:length:](self, "temporaryBufferWithBytes:length:", a3, a4), 0, a5, a6);
}
...
- (void)setFragmentBuffer:(id)a3 offset:(unint64_t)a4 atIndex:(unint64_t)a5
{
  ...
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markBuffer:usage:stages:](self->_commandBuffer, "markBuffer:usage:stages:", a3, 3, 2);
  -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
}

- (void)setFragmentBufferOffset:(unint64_t)a3 atIndex:(unint64_t)a4
{
  MTLGPUDebugStageBufferHandles::setBufferOffset(&self->_fragmentHandles, a3, a4);
}
...
- (void)setFragmentBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  if (a5.length)
  {
    ...
    do
    {
      ...
      v10 = v11;
      v12 = *a4++;
      -[MTLGPUDebugRenderCommandEncoder setFragmentBuffer:offset:atIndex:](self, "setFragmentBuffer:offset:atIndex:", v10, v12, location++);
      --length;
    }
    while (length);
  }
...
{
  -[MTLGPUDebugRenderCommandEncoder setFragmentBuffer:offset:atIndex:](self, "setFragmentBuffer:offset:atIndex:", -[MTLToolsRetainingContainer temporaryBufferWithBytes:length:](-[MTLToolsCommandEncoder commandBuffer](self, "commandBuffer"), "temporaryBufferWithBytes:length:", a3, a4), 0, a5);
}
...
- (void)setTileBuffer:(id)a3 offset:(unint64_t)a4 atIndex:(unint64_t)a5
{
  ...
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markBuffer:usage:stages:](self->_commandBuffer, "markBuffer:usage:stages:", a3, 3, 4);
  -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
}

- (void)setTileBufferOffset:(unint64_t)a3 atIndex:(unint64_t)a4
{
  MTLGPUDebugStageBufferHandles::setBufferOffset(&self->_tileHandles, a3, a4);
}
...
- (void)setTileBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  if (a5.length)
  {
    ...
    do
    {
      ...
      v10 = v11;
      v12 = *a4++;
      -[MTLGPUDebugRenderCommandEncoder setTileBuffer:offset:atIndex:](self, "setTileBuffer:offset:atIndex:", v10, v12, location++);
      --length;
    }
    while (length);
  }
...
{
  -[MTLGPUDebugRenderCommandEncoder setTileBuffer:offset:atIndex:](self, "setTileBuffer:offset:atIndex:", -[MTLToolsRetainingContainer temporaryBufferWithBytes:length:](-[MTLToolsCommandEncoder commandBuffer](self, "commandBuffer"), "temporaryBufferWithBytes:length:", a3, a4), 0, a5);
}
...
- (void)setObjectBuffer:(id)a3 offset:(unint64_t)a4 atIndex:(unint64_t)a5
{
  ...
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markBuffer:usage:stages:](self->_commandBuffer, "markBuffer:usage:stages:", a3, 3, 8);
  -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
}

- (void)setObjectBufferOffset:(unint64_t)a3 atIndex:(unint64_t)a4
{
  MTLGPUDebugStageBufferHandles::setBufferOffset(&self->_objectHandles, a3, a4);
}
...
- (void)setObjectBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  if (a5.length)
  {
    ...
    do
    {
      ...
      v10 = v11;
      v12 = *a4++;
      -[MTLGPUDebugRenderCommandEncoder setObjectBuffer:offset:atIndex:](self, "setObjectBuffer:offset:atIndex:", v10, v12, location++);
      --length;
    }
    while (length);
  }
...
{
  -[MTLGPUDebugRenderCommandEncoder setObjectBuffer:offset:atIndex:](self, "setObjectBuffer:offset:atIndex:", -[MTLToolsRetainingContainer temporaryBufferWithBytes:length:](-[MTLToolsCommandEncoder commandBuffer](self, "commandBuffer"), "temporaryBufferWithBytes:length:", a3, a4), 0, a5);
}
...
- (void)setMeshBuffer:(id)a3 offset:(unint64_t)a4 atIndex:(unint64_t)a5
{
  ...
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markBuffer:usage:stages:](self->_commandBuffer, "markBuffer:usage:stages:", a3, 3, 16);
  -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
}

- (void)setMeshBufferOffset:(unint64_t)a3 atIndex:(unint64_t)a4
{
  MTLGPUDebugStageBufferHandles::setBufferOffset(&self->_meshHandles, a3, a4);
}
...
- (void)setMeshBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  if (a5.length)
  {
    ...
    do
    {
      ...
      v10 = v11;
      v12 = *a4++;
      -[MTLGPUDebugRenderCommandEncoder setMeshBuffer:offset:atIndex:](self, "setMeshBuffer:offset:atIndex:", v10, v12, location++);
      --length;
    }
    while (length);
  }
...
{
  -[MTLGPUDebugRenderCommandEncoder setMeshBuffer:offset:atIndex:](self, "setMeshBuffer:offset:atIndex:", -[MTLToolsRetainingContainer temporaryBufferWithBytes:length:](-[MTLToolsCommandEncoder commandBuffer](self, "commandBuffer"), "temporaryBufferWithBytes:length:", a3, a4), 0, a5);
}
...
- (void)setVertexTexture:(id)a3 atIndex:(unint64_t)a4
{
  ...
  {
    if (*(&self->_enableUseResourceValidation + 4))
      -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", a3, 3, 1);
    -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
  }
...
- (void)setVertexTextures:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      ...
      {
        if (*(&self->_enableUseResourceValidation + 4))
          -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", v8, 3, 1);
...
- (void)setFragmentTexture:(id)a3 atIndex:(unint64_t)a4
{
  ...
  {
    if (*(&self->_enableUseResourceValidation + 4))
      -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", a3, 3, 2);
    -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
  }
...
- (void)setFragmentTextures:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      ...
      {
        if (*(&self->_enableUseResourceValidation + 4))
          -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", v8, 3, 2);
        -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", v8);
      }
...
- (void)setTileTexture:(id)a3 atIndex:(unint64_t)a4
{
  ...
  {
    if (*(&self->_enableUseResourceValidation + 4))
      -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", a3, 3, 4);
    -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
  }
...
- (void)setTileTextures:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      ...
      {
        if (*(&self->_enableUseResourceValidation + 4))
          -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", v8, 3, 4);
        -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", v8);
      }
...
- (void)setMeshTexture:(id)a3 atIndex:(unint64_t)a4
{
  ...
  {
    if (*(&self->_enableUseResourceValidation + 4))
      -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", a3, 3, 16);
    -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
  }
...
- (void)setMeshTextures:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      ...
      {
        if (*(&self->_enableUseResourceValidation + 4))
          -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", v8, 3, 16);
        -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", v8);
      }
...
- (void)setObjectTexture:(id)a3 atIndex:(unint64_t)a4
{
  ...
  {
    if (*(&self->_enableUseResourceValidation + 4))
      -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", a3, 3, 8);
    -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
  }
...
- (void)setObjectTextures:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      ...
      {
        if (*(&self->_enableUseResourceValidation + 4))
          -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", v8, 3, 8);
        -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", v8);
      }
...
- (void)drawPrimitives:(unint64_t)a3 vertexStart:(unint64_t)a4 vertexCount:(unint64_t)a5
{
  ...
  -[MTLGPUDebugRenderCommandEncoder flushBindings](self, "flushBindings");
  v9.receiver = self;
...
- (void)drawPatches:(unint64_t)a3 patchIndexBuffer:(id)a4 patchIndexBufferOffset:(unint64_t)a5 indirectBuffer:(id)a6 indirectBufferOffset:(unint64_t)a7
{
  ...
  -[MTLGPUDebugRenderCommandEncoder flushBindings](self, "flushBindings", a3, a4, a5, a6, a7);
  v12.receiver = self;
  v12.super_class = (Class)MTLGPUDebugRenderCommandEncoder;
...
- (void)drawIndexedPatches:(unint64_t)a3 patchIndexBuffer:(id)a4 patchIndexBufferOffset:(unint64_t)a5 controlPointIndexBuffer:(id)a6 controlPointIndexBufferOffset:(unint64_t)a7 indirectBuffer:(id)a8 indirectBufferOffset:(unint64_t)a9
{
  ...
  if ((*((_BYTE *)&self->_options->var0 + 2) & 0x80) != 0)
  {
    -[MTLGPUDebugRenderCommandEncoder setTessellationControlPointIndexBuffer:offset:](self, "setTessellationControlPointIndexBuffer:offset:", a6, a7);
    -[MTLGPUDebugRenderCommandEncoder drawPatches:patchIndexBuffer:patchIndexBufferOffset:indirectBuffer:indirectBufferOffset:](self, "drawPatches:patchIndexBuffer:patchIndexBufferOffset:indirectBuffer:indirectBufferOffset:", a3, a4, a5, a8, a9);
  }
  else
  {
    -[MTLGPUDebugRenderCommandEncoder flushBindings](self, "flushBindings");
...
- (void)drawIndexedPatches:(unint64_t)a3 patchStart:(unint64_t)a4 patchCount:(unint64_t)a5 patchIndexBuffer:(id)a6 patchIndexBufferOffset:(unint64_t)a7 controlPointIndexBuffer:(id)a8 controlPointIndexBufferOffset:(unint64_t)a9 instanceCount:(unint64_t)a10 baseInstance:(unint64_t)a11
{
  ...
  if ((*((_BYTE *)&self->_options->var0 + 2) & 0x80) != 0)
  {
    -[MTLGPUDebugRenderCommandEncoder setTessellationControlPointIndexBuffer:offset:](self, "setTessellationControlPointIndexBuffer:offset:", a8, a9);
...
- (void)executeCommandsInBuffer:(id)a3 withRange:(_NSRange)a4
{
  ...
  v10 = 1;
  -[MTLGPUDebugRenderCommandEncoder prepareExecuteIndirect:variant:](self, "prepareExecuteIndirect:variant:", a3, &v9);
  v8.receiver = self;
  v8.super_class = (Class)MTLGPUDebugRenderCommandEncoder;
  ...
  -[MTLGPUDebugRenderCommandEncoder restoreInternalState:](self, "restoreInternalState:", a3);
}
...
- (void)executeCommandsInBuffer:(id)a3 indirectBuffer:(id)a4 indirectBufferOffset:(unint64_t)a5
{
  ...
  v10[1] = a5;
  v11 = 0;
  -[MTLGPUDebugRenderCommandEncoder prepareExecuteIndirect:variant:](self, "prepareExecuteIndirect:variant:", a3, v10);
  v9.receiver = self;
  v9.super_class = (Class)MTLGPUDebugRenderCommandEncoder;
...
- (void)_useResourceCommon:(id)a3 usage:(unint64_t)a4 stages:(optional<unsigned long>)a5
{
  ...
  v5 = *(_QWORD *)&a5.var1;
  var1 = a5.var0.var1;
  -[MTLGPUDebugRenderCommandEncoder useResourceInternal:usage:stages:](self, "useResourceInternal:usage:stages:", objc_msgSend(a3, "baseObject"), a4, a5.var0.var1, *(_QWORD *)&a5.var1);
  if ((_BYTE)v5)
    v10 = var1;
  else
    v10 = 27;
  if (*(&self->_enableUseResourceValidation + 4))
  {
    ...
    {
      -[MTLGPUDebugCommandBuffer markBuffer:usage:stages:](self->_commandBuffer, "markBuffer:usage:stages:", a3, a4, v10);
    }
    else
    {
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
        -[MTLGPUDebugCommandBuffer markTexture:usage:stages:](self->_commandBuffer, "markTexture:usage:stages:", a3, a4, v10);
    }
  }
...
{
  -[MTLGPUDebugRenderCommandEncoder _useResourceCommon:usage:stages:](self, "_useResourceCommon:usage:stages:", a3, a4, 0, 0);
}

- (void)useResource:(id)a3 usage:(unint64_t)a4 stages:(unint64_t)a5
{
  -[MTLGPUDebugRenderCommandEncoder _useResourceCommon:usage:stages:](self, "_useResourceCommon:usage:stages:", a3, a4, a5, 1);
}
...
- (void)useResources:(const void *)a3 count:(unint64_t)a4 usage:(unint64_t)a5
{
  ...
  if (a4)
  {
    ...
    {
      v9 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder useResource:usage:](self, "useResource:usage:", v9, a5);
      --v6;
    }
    while (v6);
  }
...
- (void)useResources:(const void *)a3 count:(unint64_t)a4 usage:(unint64_t)a5 stages:(unint64_t)a6
{
  ...
  if (a4)
  {
    ...
    {
      v11 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder useResource:usage:stages:](self, "useResource:usage:stages:", v11, a5, a6);
      --v8;
    }
    while (v8);
  }
...
{
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markHeap:stages:](self->_commandBuffer, "markHeap:stages:", a3, 31);
  -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
...
{
  if (*(&self->_enableUseResourceValidation + 4))
    -[MTLGPUDebugCommandBuffer markHeap:stages:](self->_commandBuffer, "markHeap:stages:", a3, a4);
  -[MTLToolsCommandEncoder addRetainedObject:](self, "addRetainedObject:", a3);
...
- (void)useHeaps:(const void *)a3 count:(unint64_t)a4
{
  ...
  if (a4)
  {
    ...
    {
      v7 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder useHeap:](self, "useHeap:", v7);
      --v4;
    }
    while (v4);
  }
...
- (void)useHeaps:(const void *)a3 count:(unint64_t)a4 stages:(unint64_t)a5
{
  ...
  if (a4)
  {
    ...
    {
      v9 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder useHeap:stages:](self, "useHeap:stages:", v9, a5);
      --v6;
    }
    while (v6);
  }
...
- (void)setRenderPipelineState:(id)a3
{
  ...
  *(&self->_enableUseResourceValidation + 3) = v7;
  ...
  {
    -[MTLGPUDebugCommandBuffer beginUseOfMeshShadersInEncoder:](self->_commandBuffer, "beginUseOfMeshShadersInEncoder:", self);
  ...
  if (self->_currentPipeline != a3)
  {
    if ((*((_BYTE *)&self->_options->var0 + 2) & 0x40) != 0)
      -[MTLGPUDebugRenderCommandEncoder setRenderPipelineStateBuffers:](self, "setRenderPipelineStateBuffers:", a3);
...
- (void)setVertexVisibleFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setVertexVisibleFunctionTable:atBufferIndex:](self, "setVertexVisibleFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setFragmentVisibleFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setFragmentVisibleFunctionTable:atBufferIndex:](self, "setFragmentVisibleFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setTileVisibleFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setTileVisibleFunctionTable:atBufferIndex:](self, "setTileVisibleFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setObjectVisibleFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setObjectVisibleFunctionTable:atBufferIndex:](self, "setObjectVisibleFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setMeshVisibleFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setMeshVisibleFunctionTable:atBufferIndex:](self, "setMeshVisibleFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setVertexIntersectionFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setVertexIntersectionFunctionTable:atBufferIndex:](self, "setVertexIntersectionFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setFragmentIntersectionFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setFragmentIntersectionFunctionTable:atBufferIndex:](self, "setFragmentIntersectionFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setTileIntersectionFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setTileIntersectionFunctionTable:atBufferIndex:](self, "setTileIntersectionFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setObjectIntersectionFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setObjectIntersectionFunctionTable:atBufferIndex:](self, "setObjectIntersectionFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setMeshIntersectionFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLGPUDebugRenderCommandEncoder setMeshIntersectionFunctionTable:atBufferIndex:](self, "setMeshIntersectionFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
