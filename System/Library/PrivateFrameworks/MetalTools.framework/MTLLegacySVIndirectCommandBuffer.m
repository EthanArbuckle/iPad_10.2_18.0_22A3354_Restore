...
{
  -[MTLLegacySVIndirectCommandBuffer setBuffer:offset:attributeStride:atIndex:forStage:commandIndex:](self, "setBuffer:offset:attributeStride:atIndex:forStage:commandIndex:", a3, a4, -1, a5, a6, a7);
}
...
{
  return -[MTLLegacySVIndirectRenderCommand initWithIndirectRenderCommand:commandIndex:indirectCommandBuffer:]([MTLLegacySVIndirectRenderCommand alloc], "initWithIndirectRenderCommand:commandIndex:indirectCommandBuffer:", -[MTLToolsObject indirectRenderCommandAtIndex:](self->super.super.super._baseObject, "indirectRenderCommandAtIndex:"), a3, self);
}

- (id)indirectComputeCommandAtIndex:(unint64_t)a3
{
  return -[MTLLegacySVIndirectComputeCommand initWithIndirectComputeCommand:commandIndex:indirectCommandBuffer:]([MTLLegacySVIndirectComputeCommand alloc], "initWithIndirectComputeCommand:commandIndex:indirectCommandBuffer:", -[MTLToolsObject indirectComputeCommandAtIndex:](self->super.super.super._baseObject, "indirectComputeCommandAtIndex:"), a3, self);
}
...
{
  return (MTLResourceID)-[MTLBuffer gpuAddress](-[MTLLegacySVIndirectCommandBuffer internalICBBuffer](self, "internalICBBuffer"), "gpuAddress");
}
