...
{
  MTLLegacySVIndirectComputeCommand *result;
  objc_super v7;
...
{
  -[MTLLegacySVIndirectComputeCommand setKernelBuffer:offset:attributeStride:atIndex:](self, "setKernelBuffer:offset:attributeStride:atIndex:", a3, a4, -1, a5);
}
