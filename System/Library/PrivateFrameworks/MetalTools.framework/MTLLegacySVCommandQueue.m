...
{
  MTLLegacySVCommandQueue *result;
  objc_super v6;
...
- (id)commandBuffer
{
  return -[MTLLegacySVCommandBuffer initWithCommandBuffer:commandQueue:descriptor:]([MTLLegacySVCommandBuffer alloc], "initWithCommandBuffer:commandQueue:descriptor:", objc_msgSend(-[MTLToolsObject baseObject](self, "baseObject"), "commandBuffer"), self, 0);
}
...
- (id)commandBufferWithDescriptor:(id)a3
{
  ...
  if (v7)
  {
    v8 = -[MTLLegacySVCommandBuffer initWithCommandBuffer:commandQueue:descriptor:]([MTLLegacySVCommandBuffer alloc], "initWithCommandBuffer:commandQueue:descriptor:", v7, self, a3);
