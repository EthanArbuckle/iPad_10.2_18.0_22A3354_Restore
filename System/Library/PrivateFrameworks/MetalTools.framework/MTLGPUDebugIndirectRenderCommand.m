...
{
  MTLGPUDebugIndirectRenderCommand *result;
  objc_super v7;
...
{
  -[MTLGPUDebugIndirectRenderCommand setVertexBuffer:offset:attributeStride:atIndex:](self, "setVertexBuffer:offset:attributeStride:atIndex:", a3, a4, -1, a5);
}
