...
{
  MTLGPUDebugArgumentEncoder *result;
  objc_super v7;
...
- (void)setBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  if (a5.length)
  {
    ...
    do
    {
      -[MTLGPUDebugArgumentEncoder setBuffer:offset:atIndex:](self, "setBuffer:offset:atIndex:", a3[v10], a4[v10], v10 + location);
      v10 = v11;
    }
    while (length > v11++);
  }
...
- (void)setRenderPipelineStates:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      -[MTLGPUDebugArgumentEncoder setRenderPipelineState:atIndex:](self, "setRenderPipelineState:atIndex:", a3[v8], v8 + location);
      v8 = v9;
    }
    while (length > v9++);
  }
...
- (void)setComputePipelineStates:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      -[MTLGPUDebugArgumentEncoder setComputePipelineState:atIndex:](self, "setComputePipelineState:atIndex:", a3[v8], v8 + location);
      v8 = v9;
    }
    while (length > v9++);
  }
...
- (void)setIndirectCommandBuffers:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    do
    {
      -[MTLGPUDebugArgumentEncoder setIndirectCommandBuffer:atIndex:](self, "setIndirectCommandBuffer:atIndex:", a3[v8], v8 + location);
      v8 = v9;
    }
    while (length > v9++);
  }
...
{
  GPUDebugArgumentEncoderLayout *layout;
  uint64_t *v5;
  uint64_t *v6;
  void *v7;
  MTLGPUDebugArgumentEncoder *v8;
  ...
  v8 = -[MTLGPUDebugArgumentEncoder initWithArgumentEncoder:layout:device:]([MTLGPUDebugArgumentEncoder alloc], "initWithArgumentEncoder:layout:device:", v7, v6, self->super.super._device);
