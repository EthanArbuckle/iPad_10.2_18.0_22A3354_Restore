...
- (MTLLegacySVImageData)initWithDynamicLibrary:(id)a3
{
  ...
  v4 = -[MTLLegacySVImageData init](&v6, sel_init);
  *((_QWORD *)v4 + 21) = v4;
...
{
  return -[MTLLegacySVImageData initWithFunction:debugInstrumentationData:](self, "initWithFunction:debugInstrumentationData:", a3, objc_msgSend(a3, "debugInstrumentationData"));
}
...
- (MTLLegacySVImageData)initWithFunction:(id)a3 debugInstrumentationData:(id)a4
{
  ...
  v6 = -[MTLLegacySVImageData init](&v8, sel_init);
  *((_QWORD *)v6 + 21) = v6;
...
- (void)_applyConstantRelocation
{
  ...
  -[MTLLegacySVImageData _applyConstantRelocation:](self, "_applyConstantRelocation:", objc_loadWeak((id *)((char *)self + v3)));
}
...
- (void)_applyConstantRelocation:(id)a3
{
  ...
  {
    v7 = MTLLegacySVBufferHandleToOffset(*((_QWORD *)self + 11));
...
- (void)setConstantData:(id)a3
{
  ...
  if (a3 && objc_msgSend(a3, "length"))
  {
    if (!*((_QWORD *)self + 1))
    {
      LegacySVConstantBufferCache::getOrCreateBuffer((LegacySVConstantBufferCache *)(*((_QWORD *)self + 2) + 432), (NSData *)a3, (uint64_t)v8);
      v6 = v8[1];
      *((_OWORD *)self + 6) = v8[0];
      *((_OWORD *)self + 7) = v6;
      v7 = v10;
      ...
      *((_QWORD *)self + 1) = v7;
      ...
      -[MTLLegacySVImageData _applyConstantRelocation](self, "_applyConstantRelocation");
    }
  }
  else
  {
...
- (void)dealloc
{
  ...
  if (*((_QWORD *)self + 17))
    LegacySVConstantBufferCache::releaseBuffer((LegacySVConstantBufferCache *)(*((_QWORD *)self + 2) + 432), (KeyBufferPair *)self + 2);

  v3.receiver = self;
  v3.super_class = (Class)MTLLegacySVImageData;
  -[MTLLegacySVImageData dealloc](&v3, sel_dealloc);
}
