...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Stack Overflow executing %@"), -[MTLLegacySVGPULog locationDescription](self, "locationDescription"));
}
