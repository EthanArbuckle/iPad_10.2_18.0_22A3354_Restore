...
{
  MTLLegacySVPipelineStateInfoEncoder *v4;
  void *v5;
  id v6;
  id v7;
  objc_super v9;
  ...
  v4 = -[MTLLegacySVPipelineStateInfoEncoder init](&v9, sel_init);
...
- (void)dealloc
{
  ...
  -[MTLLegacySVPipelineStateInfoEncoder dealloc](&v3, sel_dealloc);
}
