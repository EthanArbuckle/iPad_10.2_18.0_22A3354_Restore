...
- (id)newFunctionWithName:(id)a3
{
  ...
  v6 = -[MTLLegacySVLibrary newFunctionWithDescriptor:error:](self, "newFunctionWithDescriptor:error:", v5, 0);
...
- (id)newFunctionWithName:(id)a3 constantValues:(id)a4 error:(id *)a5
{
  ...
  v10 = -[MTLLegacySVLibrary newFunctionWithDescriptor:error:](self, "newFunctionWithDescriptor:error:", v9, a5);
...
- (void)newFunctionWithName:(id)a3 constantValues:(id)a4 completionHandler:(id)a5
{
  ...
  v10[4] = v9;
  v10[5] = a5;
  -[MTLLegacySVLibrary newFunctionWithDescriptor:completionHandler:](self, "newFunctionWithDescriptor:completionHandler:", v9, v10);
}
