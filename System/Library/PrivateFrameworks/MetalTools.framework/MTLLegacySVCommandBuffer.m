...
{
  MTLLegacySVCommandBuffer *v5;
  MTLLegacySVCommandBuffer *v6;
  MTLDevice *v7;
  int v8;
  uint64_t v9;
  objc_super v11;
...
- (void)_lateInit
{
  ...
  if (!*((_BYTE *)self + 149))
  {
    *((_BYTE *)self + 149) = 1;
    ...
    if ((v3 & 2) != 0)
    {
      *((_QWORD *)self + 22) = -[MTLLegacySVCommandBuffer _newReportBuffer](self, "_newReportBuffer");
      *((_QWORD *)self + 23) = 0;
      *((_QWORD *)self + 24) = -[MTLLegacySVCommandBuffer _newReportBuffer](self, "_newReportBuffer");
      *((_QWORD *)self + 25) = 0;
    }
    v4 = (_OWORD *)((char *)self + 232);
    *((_QWORD *)self + 29) = LegacySVMetalBufferHeap::allocBuffer((std::mutex *)(*((_QWORD *)self + 3) + 112));
    *((_DWORD *)self + 60) = v5;
...
- (pair<id<MTLBuffer>,)_temporaryBufferWithLength:(unint64_t)a3
{
  ...
  {
    *v6 = LegacySVMetalBufferHeap::allocBuffer((std::mutex *)(-[MTLToolsObject device](self, "device") + 112));
    *((_DWORD *)self + 60) = v10;
    *((_QWORD *)self + 31) = 0;
    MTLBuffer = (void *)LegacySVMetalBuffer::getMTLBuffer((LegacySVMetalBuffer *)((char *)self + 232));
...
- (id)temporaryBufferWithLength:(unint64_t)a3
{
  ...
  v7 = -[MTLLegacySVCommandBuffer _temporaryBufferWithLength:](self, "_temporaryBufferWithLength:", a3);
  v9 = -[MTLLegacySVBuffer initWithBuffer:device:offset:length:]([MTLLegacySVBuffer alloc], "initWithBuffer:device:offset:length:", v7, *((_QWORD *)self + 3), v8, a3);
...
- (id)temporaryBufferWithBytes:(const void *)a3 length:(unint64_t)a4
{
  ...
  v6 = -[MTLLegacySVCommandBuffer temporaryBufferWithLength:](self, "temporaryBufferWithLength:", a4);
...
{
  -[MTLLegacySVCommandBuffer markHeap:usage:stages:](self, "markHeap:usage:stages:", a3, 1, a4);
}
...
- (void)markHeap:(id)a3 usage:(unint64_t)a4 stages:(unint64_t)a5
{
  ...
  v8 = (char *)*((_QWORD *)self + 60);
  v9 = (char *)*((_QWORD *)self + 61);
  v10 = v8;
  if (v8 != v9)
  {
    v10 = (char *)*((_QWORD *)self + 60);
    while (*(id *)v10 != a3)
    {
      v10 += 24;
      if (v10 == v9)
...
- (void)_checkReportBuffers
{
  ...
  *(_DWORD *)a1 = 136315138;
  *a3 = v7;
  _os_log_error_impl(&dword_22CD98000, a4, OS_LOG_TYPE_ERROR, "%s", a1, 0xCu);
}
...
- (void)beginingEncoder:(id)a3 type:(unint64_t)a4
{
  ...
  {
    std::mutex::lock((std::mutex *)((char *)self + 336));
    -[MTLLegacySVCommandBuffer _encodeReportBuffer:type:](self, "_encodeReportBuffer:type:", a3, a4);
    std::mutex::unlock((std::mutex *)((char *)self + 336));
    v7 = *(_QWORD *)(*((_QWORD *)self + 19) + 20);
  }
  if ((v7 & 0x200000001) != 0)
    -[MTLLegacySVCommandBuffer encodeResourceTableBuffers:type:](self, "encodeResourceTableBuffers:type:", a3, a4);
}
...
- (void)beginUseOfMeshShadersInEncoder:(id)a3
{
  ...
  if ((*(_BYTE *)(*((_QWORD *)self + 19) + 20) & 2) != 0)
  {
    ...
    {
      *((_BYTE *)self + 406) = 0;
      -[MTLLegacySVCommandBuffer _allocReportEntryStorageForType:](self, "_allocReportEntryStorageForType:", 8);
...
- (id)encodeBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5 resultOffset:(unint64_t *)a6
{
  ...
  length = a5.length;
  v10 = -[MTLLegacySVCommandBuffer _temporaryBufferWithLength:](self, "_temporaryBufferWithLength:", objc_msgSend(*((id *)self + 21), "encodedLength", a3, a4, a5.location));
  v12 = v11;
  std::mutex::lock((std::mutex *)((char *)self + 336));
  v19 = (void *)v10;
...
{
  void *v3;
  MTLLegacySVBuffer *v4;

  v3 = (void *)objc_msgSend(*((id *)self + 3), "newInternalBufferWithLength:options:", 7360, 0);
  v4 = -[MTLLegacySVBuffer initWithBuffer:device:offset:length:track:]([MTLLegacySVBuffer alloc], "initWithBuffer:device:offset:length:track:", v3, *((_QWORD *)self + 3), 0, objc_msgSend(v3, "length"), 0);
...
- (ReportBufferEntry)_allocReportEntryStorageForType:(SEL)a3
{
  ...
  else
  {
    ...
    *((_QWORD *)self + 34) = v16;
    result = -[MTLLegacySVCommandBuffer _newReportBuffer](self, "_newReportBuffer");
    v17 = 0;
...
LABEL_4:
    ...
    objc_msgSend(a3, "setBufferUsageTable:textureUsageTable:forStage:", *((_QWORD *)self + 51), *((_QWORD *)self + 55), 1);
    objc_msgSend(a3, "setBufferUsageTable:textureUsageTable:forStage:", v5[1], v6[1], 2);
    objc_msgSend(a3, "setBufferUsageTable:textureUsageTable:forStage:", v5[2], v6[2], 8);
    objc_msgSend(a3, "setBufferUsageTable:textureUsageTable:forStage:", v5[3], v6[3], 16);
    return;
  }
  if (a4 != 1)
  {
  ...
  objc_msgSend(a3, "setBufferUsageTable:textureUsageTable:", *((_QWORD *)self + 51), *((_QWORD *)self + 55));
}
...
LABEL_4:
    if (self)
    {
      -[MTLLegacySVCommandBuffer _allocReportEntryStorageForType:](self, "_allocReportEntryStorageForType:", 1);
      -[MTLLegacySVCommandBuffer _allocReportEntryStorageForType:](self, "_allocReportEntryStorageForType:", 2);
    }
  ...
  if (self)
    -[MTLLegacySVCommandBuffer _allocReportEntryStorageForType:](self, "_allocReportEntryStorageForType:", 3);
  objc_msgSend(a3, "setKernelReportBuffer:offset:", 0, 0);
}

- (id)renderCommandEncoderWithDescriptor:(id)a3
{
  MTLLegacySVRenderCommandEncoder *v5;

  -[MTLLegacySVCommandBuffer _lateInit](self, "_lateInit");
  ...
  -[MTLLegacySVCommandBuffer beginingEncoder:type:](self, "beginingEncoder:type:", v5, 0);
  return v5;
}
...
- (id)sampledRenderCommandEncoderWithDescriptor:(id)a3 programInfoBuffer:(id *)a4 capacity:(unint64_t)a5
{
  ...
  -[MTLLegacySVCommandBuffer beginingEncoder:type:](self, "beginingEncoder:type:", v9, 0);
  return v9;
}
...
{
  -[MTLLegacySVCommandBuffer _lateInit](self, "_lateInit");
  return -[MTLLegacySVParallelRenderCommandEncoder initWithParallelRenderCommandEncoder:parent:descriptor:encoderID:]([MTLLegacySVParallelRenderCommandEncoder alloc], "initWithParallelRenderCommandEncoder:parent:descriptor:encoderID:", objc_msgSend(*((id *)self + 2), "parallelRenderCommandEncoderWithDescriptor:", -[MTLToolsCommandBuffer unwrapMTLRenderPassDescriptor:](self, "unwrapMTLRenderPassDescriptor:", a3)), self, a3, *((unsigned int *)self + 64));
}

- (id)computeCommandEncoderWithDispatchType:(unint64_t)a3
{
  MTLLegacySVComputeCommandEncoder *v5;

  -[MTLLegacySVCommandBuffer _lateInit](self, "_lateInit");
  v5 = -[MTLLegacySVComputeCommandEncoder initWithComputeCommandEncoder:commandBuffer:descriptor:encoderID:]([MTLLegacySVComputeCommandEncoder alloc], "initWithComputeCommandEncoder:commandBuffer:descriptor:encoderID:", objc_msgSend(*((id *)self + 2), "computeCommandEncoderWithDispatchType:", a3), self, 0, *((unsigned int *)self + 64));
  -[MTLLegacySVCommandBuffer beginingEncoder:type:](self, "beginingEncoder:type:", v5, 1);
  return v5;
}

- (id)sampledComputeCommandEncoderWithDispatchType:(unint64_t)a3 programInfoBuffer:(id *)a4 capacity:(unint64_t)a5
{
  MTLLegacySVComputeCommandEncoder *v9;
  ...
  -[MTLLegacySVCommandBuffer beginingEncoder:type:](self, "beginingEncoder:type:", v9, 1);
  return v9;
}
...
{
  return -[MTLLegacySVCommandBuffer computeCommandEncoderWithDispatchType:](self, "computeCommandEncoderWithDispatchType:", 0);
}

- (id)sampledComputeCommandEncoderWithProgramInfoBuffer:(id *)a3 capacity:(unint64_t)a4
{
  return -[MTLLegacySVCommandBuffer sampledComputeCommandEncoderWithDispatchType:programInfoBuffer:capacity:](self, "sampledComputeCommandEncoderWithDispatchType:programInfoBuffer:capacity:", 0, a3, a4);
}

- (id)blitCommandEncoder
{
  MTLLegacySVBlitCommandEncoder *v3;

  -[MTLLegacySVCommandBuffer _lateInit](self, "_lateInit");
  v3 = -[MTLLegacySVBlitCommandEncoder initWithBlitCommandEncoder:parent:descriptor:encoderID:]([MTLLegacySVBlitCommandEncoder alloc], "initWithBlitCommandEncoder:parent:descriptor:encoderID:", objc_msgSend(*((id *)self + 2), "blitCommandEncoder"), self, 0, *((unsigned int *)self + 64));
  -[MTLLegacySVCommandBuffer beginingEncoder:type:](self, "beginingEncoder:type:", v3, 2);
  return v3;
}

- (id)blitCommandEncoderWithDescriptor:(id)a3
{
  MTLLegacySVBlitCommandEncoder *v5;
  ...
  -[MTLLegacySVCommandBuffer beginingEncoder:type:](self, "beginingEncoder:type:", v5, 2);
  return v5;
}
...
- (id)accelerationStructureCommandEncoder
{
  ...
  if (result)
    return -[MTLLegacySVAccelerationStructureCommandEncoder initWithAccelerationStructureCommandEncoder:parent:accelerationStructurePassDescriptor:]([MTLLegacySVAccelerationStructureCommandEncoder alloc], "initWithAccelerationStructureCommandEncoder:parent:accelerationStructurePassDescriptor:", result, self, 0);
  return result;
}
...
- (id)accelerationStructureCommandEncoderWithDescriptor:(id)a3
{
  ...
  if (result)
    return -[MTLLegacySVAccelerationStructureCommandEncoder initWithAccelerationStructureCommandEncoder:parent:accelerationStructurePassDescriptor:]([MTLLegacySVAccelerationStructureCommandEncoder alloc], "initWithAccelerationStructureCommandEncoder:parent:accelerationStructurePassDescriptor:", result, self, a3);
  return result;
}
...
- (void)useResidencySet:(id)a3
{
  ...
  if ((*(_QWORD *)(*((_QWORD *)self + 19) + 20) & 0x200000001) != 0)
  {
    ...
    if (!std::__hash_table<std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::__unordered_map_hasher<unsigned long long,std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::hash<unsigned long long>,std::equal_to<unsigned long long>,true>,std::__unordered_map_equal<unsigned long long,std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::equal_to<unsigned long long>,std::hash<unsigned long long>,true>,std::allocator<std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>>>::find<unsigned long long>((_QWORD *)self + 63, (unint64_t *)&v7))
    {
      v6 = a3;
      v7 = objc_msgSend(a3, "hash");
...
- (void)useResidencySets:(const void *)a3 count:(unint64_t)a4
{
  ...
  if ((*(_QWORD *)(*((_QWORD *)self + 19) + 20) & 0x200000001) != 0 && a4 != 0)
  {
    ...
    do
    {
      ...
      if (!std::__hash_table<std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::__unordered_map_hasher<unsigned long long,std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::hash<unsigned long long>,std::equal_to<unsigned long long>,true>,std::__unordered_map_equal<unsigned long long,std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::equal_to<unsigned long long>,std::hash<unsigned long long>,true>,std::allocator<std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>>>::find<unsigned long long>((_QWORD *)self + 63, (unint64_t *)&v11))
      {
        v11 = objc_msgSend(v12, "hash");
...
- (void)preCommit
{
  ...
  if ((*(_QWORD *)(*((_QWORD *)self + 19) + 20) & 0x200000001) != 0)
  {
    ...
    v4 = objc_msgSend(v3, "countByEnumeratingWithState:objects:count:", &v41, v67, 16);
    if (v4)
    {
      v5 = *(_QWORD *)v42;
      do
      {
        for (i = 0; i != v4; ++i)
        {
          ...
          *(_QWORD *)&v58 = *(_QWORD *)(*((_QWORD *)&v41 + 1) + 8 * i);
          *(_QWORD *)&v54 = objc_msgSend((id)v58, "hash");
    ...
    for (j = (_QWORD *)*((_QWORD *)self + 65); j; j = (_QWORD *)*j)
    {
      *(_QWORD *)&v58 = j[3];
      *(_QWORD *)&v54 = objc_msgSend((id)v58, "hash");
      if (!std::__hash_table<std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::__unordered_map_hasher<unsigned long long,std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::hash<unsigned long long>,std::equal_to<unsigned long long>,true>,std::__unordered_map_equal<unsigned long long,std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>,std::equal_to<unsigned long long>,std::hash<unsigned long long>,true>,std::allocator<std::__hash_value_type<unsigned long long,MTLLegacySVResidencySet *>>>::find<unsigned long long>(&v62, (unint64_t *)&v54))
    ...
    for (k = (_QWORD *)*((_QWORD *)self + 70); k; k = (_QWORD *)*k)
    {
    ...
    if ((_QWORD)v63)
    {
      do
      {
        ...
        v13 = objc_msgSend(v12, "countByEnumeratingWithState:objects:count:", &v37, v66, 16);
        if (v13)
        {
          v14 = *(_QWORD *)v38;
          do
      ...
      while (v10);
      for (ii = (_QWORD *)v59; ii; ii = (_QWORD *)*ii)
      {
        v18 = ii[2];
        objc_opt_class();
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          -[MTLLegacySVCommandBuffer markBuffer:usage:stages:](self, "markBuffer:usage:stages:", v18, 3, 31);
        }
        else
        {
          objc_opt_class();
          if ((objc_opt_isKindOfClass() & 1) != 0)
          {
            -[MTLLegacySVCommandBuffer markTexture:usage:stages:](self, "markTexture:usage:stages:", v18, 3, 31);
          }
          else
          {
            objc_opt_class();
            if ((objc_opt_isKindOfClass() & 1) != 0)
              -[MTLLegacySVCommandBuffer markAccelerationStructure:usage:stages:](self, "markAccelerationStructure:usage:stages:", v18, 3, 31);
          }
        }
      }
    }
    for (jj = (_QWORD *)v55; jj; jj = (_QWORD *)*jj)
      -[MTLLegacySVCommandBuffer markHeap:usage:stages:](self, "markHeap:usage:stages:", jj[2], 3, 31);
      ...
      if (v20 != v21)
      {
        ...
        do
        {
          ...
          if ((v23 & 1) != 0)
          {
            ...
            *(_QWORD *)&v63 = ___ZN12_GLOBAL__N_112_GLOBAL__N_114HeapUsageTable5applyERNS0_16BufferUsageTableES3_S3_S3_RNS0_17TextureUsageTableES5_S5_S5__block_invoke;
            *((_QWORD *)&v63 + 1) = &__block_descriptor_48_e12_v20__0_I8I16l;
            v64 = (char *)self + 408;
            v65 = v20;
            objc_msgSend(v24, "enumerateBufferIndices:", &v62);
            v25 = *(void **)v20;
            *(_QWORD *)&v58 = v22;
            *((_QWORD *)&v58 + 1) = 3221225472;
            *(_QWORD *)&v59 = ___ZN12_GLOBAL__N_112_GLOBAL__N_114HeapUsageTable5applyERNS0_16BufferUsageTableES3_S3_S3_RNS0_17TextureUsageTableES5_S5_S5__block_invoke_2;
            *((_QWORD *)&v59 + 1) = &__block_descriptor_48_e12_v20__0_I8I16l;
            v60 = (char *)self + 408;
            v61 = v20;
            objc_msgSend(v25, "enumerateAccelerationStructureIndices:", &v58);
            v26 = *(void **)v20;
            *(_QWORD *)&v54 = v22;
            *((_QWORD *)&v54 + 1) = 3221225472;
            *(_QWORD *)&v55 = ___ZN12_GLOBAL__N_112_GLOBAL__N_114HeapUsageTable5applyERNS0_16BufferUsageTableES3_S3_S3_RNS0_17TextureUsageTableES5_S5_S5__block_invoke_3;
            *((_QWORD *)&v55 + 1) = &__block_descriptor_48_e12_v20__0_I8I16l;
            v56 = (char *)self + 440;
            v57 = v20;
            objc_msgSend(v26, "enumerateTextureIndices:", &v54);
            v23 = *(_QWORD *)(v20 + 8);
          }
          if ((v23 & 6) != 0)
          {
            ...
            v53[4] = (char *)self + 416;
            v53[5] = v20;
            objc_msgSend(v27, "enumerateBufferIndices:", v53);
            v28 = *(void **)v20;
            v52[0] = v22;
            v52[1] = 3221225472;
            ...
            v52[4] = (char *)self + 416;
            v52[5] = v20;
            objc_msgSend(v28, "enumerateAccelerationStructureIndices:", v52);
            v29 = *(void **)v20;
            v51[0] = v22;
            v51[1] = 3221225472;
            ...
            v51[4] = (char *)self + 448;
            v51[5] = v20;
            objc_msgSend(v29, "enumerateTextureIndices:", v51);
            v23 = *(_QWORD *)(v20 + 8);
          }
          if ((v23 & 8) != 0)
          {
            ...
            v50[4] = (char *)self + 424;
            v50[5] = v20;
            objc_msgSend(v30, "enumerateBufferIndices:", v50);
            v31 = *(void **)v20;
            v49[0] = v22;
            v49[1] = 3221225472;
            ...
            v49[4] = (char *)self + 424;
            v49[5] = v20;
            objc_msgSend(v31, "enumerateAccelerationStructureIndices:", v49);
            v32 = *(void **)v20;
            v48[0] = v22;
            v48[1] = 3221225472;
            ...
            v48[4] = (char *)self + 456;
            v48[5] = v20;
            objc_msgSend(v32, "enumerateTextureIndices:", v48);
            v23 = *(_QWORD *)(v20 + 8);
          }
          if ((v23 & 0x10) != 0)
          {
            ...
            v47[4] = (char *)self + 432;
            v47[5] = v20;
            objc_msgSend(v33, "enumerateBufferIndices:", v47);
            v34 = *(void **)v20;
            v46[0] = v22;
            v46[1] = 3221225472;
            ...
            v46[4] = (char *)self + 432;
            v46[5] = v20;
            objc_msgSend(v34, "enumerateAccelerationStructureIndices:", v46);
            v35 = *(void **)v20;
            v45[0] = v22;
            v45[1] = 3221225472;
            ...
            v45[4] = (char *)self + 464;
            v45[5] = v20;
            objc_msgSend(v35, "enumerateTextureIndices:", v45);
          }
          v20 += 24;
        }
        while (v20 != v21);
  ...
  -[MTLToolsCommandBuffer preCommit](&v36, sel_preCommit);
}
...
- (void)preCompletionHandlers
{
  ...
  uint64_t v5;
  char *v6;
  LegacySVMetalBuffer *v7;
  LegacySVMetalBuffer *v8;
  objc_super v9;

  if ((*(_BYTE *)(*((_QWORD *)self + 19) + 20) & 2) != 0)
    -[MTLLegacySVCommandBuffer _checkReportBuffers](self, "_checkReportBuffers");
  v3 = 0;
  v4 = (char *)self + 408;
  do
  {
  ...
  while (v5 != 32);
  v7 = (LegacySVMetalBuffer *)*((_QWORD *)self + 26);
  v8 = (LegacySVMetalBuffer *)*((_QWORD *)self + 27);
  if (v7 != v8)
  {
    do
...
- (void)dealloc
{
  ...
  void **v7;
  void *v8;
  LegacySVMetalBuffer *v9;
  LegacySVMetalBuffer *v10;
  objc_super v11;
  ...
  v9 = (LegacySVMetalBuffer *)*((_QWORD *)self + 26);
  v10 = (LegacySVMetalBuffer *)*((_QWORD *)self + 27);
  if (v9 != v10)
  {
    do
...
- (void).cxx_destruct
{
  ...
  v3 = (void **)((char *)self + 544);
  v4 = (_QWORD *)*((_QWORD *)self + 70);
  if (v4)
  {
    do
    {
  ...
  *v3 = 0;
  ...
  v10 = (void *)*((_QWORD *)self + 39);
  if (v10)
  {
    *((_QWORD *)self + 40) = v10;
    operator delete(v10);
  }
  v11 = (void *)*((_QWORD *)self + 36);
  if (v11)
  {
    *((_QWORD *)self + 37) = v11;
    operator delete(v11);
  }
  v12 = (void *)*((_QWORD *)self + 33);
  if (v12)
  {
    *((_QWORD *)self + 34) = v12;
    operator delete(v12);
  }
  v13 = (void *)*((_QWORD *)self + 26);
  if (v13)
  {
    *((_QWORD *)self + 27) = v13;
    operator delete(v13);
