...
{
  MTLGPUDebugAccelerationStructureCommandEncoder *v6;
  objc_super v8;
...
- (void)endEncoding
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
}
...
- (void)newBaseAccelerationStructureCommandEncoder
{
  id v3;
  uint64_t v4;
  MTLGPUDebugAccelerationStructureCommandEncoder *i;
  MTLToolsObject *baseObject;
  MTLToolsDevice *device;
  MTLGPUDebugAccelerationStructureCommandEncoder *j;
  MTLToolsObject *v9;
  objc_super v10;
  objc_super v11;
  ...
  if (self->_accelerationStructurePassDescriptor)
    v4 = objc_msgSend(v3, "accelerationStructureCommandEncoderWithDescriptor:", -[MTLToolsObject unwrapMTLAccelerationStructurePassDescriptor:](self->super.super.super._parent, "unwrapMTLAccelerationStructurePassDescriptor:"));
  else
...
{
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitAccelerationStructureType:toAccelerationStructure:](self, "blitAccelerationStructureType:toAccelerationStructure:", 1, a3);
}

- (void)blitInstanceTypetoAccelerationStructure:(id)a3
{
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitAccelerationStructureType:toAccelerationStructure:](self, "blitAccelerationStructureType:toAccelerationStructure:", 2, a3);
}

- (void)blitTypeFromAccelerationStructureDescriptor:(id)a3 toAccelerationStructure:(id)a4
{
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitAccelerationStructureType:toAccelerationStructure:](self, "blitAccelerationStructureType:toAccelerationStructure:", MTLAccelerationStructureTypeFromDescriptor((MTLAccelerationStructureDescriptor *)a3), a4);
}
...
- (id)encodeUnwrapAccelerationStructureDescriptor:(id)a3
{
  ...
  id v11;
  void *v12;
  list<resourceAndUsage, std::allocator<resourceAndUsage>> *p_resourceAndUsageList;
  list<resourceAndUsage, std::allocator<resourceAndUsage>> *i;
  uint64_t v15;
  uint64_t v16;
  uint64_t v18;
  int64x2_t v19;
  ...
  if (objc_msgSend(v5, "isSubclassOfClass:", objc_opt_class()))
  {
    ...
    v11 = -[MTLGPUDebugAccelerationStructureCommandEncoder psoWithFunctionName:](self, "psoWithFunctionName:", CFSTR("unwrap_acceleration_structure_descriptor_buffer"));
...
LABEL_8:
  ...
  v22 = -[MTLGPUDebugAccelerationStructureCommandEncoder psoWithFunctionName:](self, "psoWithFunctionName:", v20);
...
- (id)createChildrenWrappersBufferWithASDescriptor:(id)a3
{
  ...
  if (objc_msgSend(v5, "isSubclassOfClass:", objc_opt_class()))
  {
    ...
    {
      v6 = -[MTLGPUDebugAccelerationStructureCommandEncoder createChildrenWrappersBufferWithIASDescriptor:](self, "createChildrenWrappersBufferWithIASDescriptor:", a3);
      goto LABEL_6;
    }
    return 0;
  }
  ...
  if (!objc_msgSend(v7, "isSubclassOfClass:", objc_opt_class()))
    return 0;
  v6 = -[MTLGPUDebugAccelerationStructureCommandEncoder createChildrenWrappersBufferWithIndirectIASDescriptor:](self, "createChildrenWrappersBufferWithIndirectIASDescriptor:", a3);
LABEL_6:
  v8 = v6;
  if (v6)
    -[MTLGPUDebugAccelerationStructureCommandEncoder useResource:usage:](self, "useResource:usage:", v6, 1);
  return v8;
}
...
- (void)buildAccelerationStructure:(id)a3 descriptor:(id)a4 scratchBuffer:(id)a5 scratchBufferOffset:(unint64_t)a6
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  v11 = -[MTLGPUDebugAccelerationStructureCommandEncoder createChildrenWrappersBufferWithASDescriptor:](self, "createChildrenWrappersBufferWithASDescriptor:", a4);
  v12 = -[MTLGPUDebugAccelerationStructureCommandEncoder encodeUnwrapAccelerationStructureDescriptor:](self, "encodeUnwrapAccelerationStructureDescriptor:", a4);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
  v13.receiver = self;
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:](self, "blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:", a4, a3);
  if (v11)
    -[MTLGPUDebugAccelerationStructureCommandEncoder blitChildrenWrappersBufferAddress:toAccelerationStructure:](self, "blitChildrenWrappersBufferAddress:toAccelerationStructure:", v11, a3);
...
- (void)refitAccelerationStructure:(id)a3 descriptor:(id)a4 destination:(id)a5 scratchBuffer:(id)a6 scratchBufferOffset:(unint64_t)a7
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  v13 = -[MTLGPUDebugAccelerationStructureCommandEncoder createChildrenWrappersBufferWithASDescriptor:](self, "createChildrenWrappersBufferWithASDescriptor:", a4);
  v14 = -[MTLGPUDebugAccelerationStructureCommandEncoder encodeUnwrapAccelerationStructureDescriptor:](self, "encodeUnwrapAccelerationStructureDescriptor:", a4);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
  v15.receiver = self;
  ...
  if (a5)
  {
    -[MTLGPUDebugAccelerationStructureCommandEncoder blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:](self, "blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:", a4, a5);
    if (v13)
      -[MTLGPUDebugAccelerationStructureCommandEncoder blitChildrenWrappersBufferAddress:toAccelerationStructure:](self, "blitChildrenWrappersBufferAddress:toAccelerationStructure:", v13, a5);
  }
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
...
- (void)refitAccelerationStructure:(id)a3 descriptor:(id)a4 destination:(id)a5 scratchBuffer:(id)a6 scratchBufferOffset:(unint64_t)a7 options:(unint64_t)a8
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  v15 = -[MTLGPUDebugAccelerationStructureCommandEncoder createChildrenWrappersBufferWithASDescriptor:](self, "createChildrenWrappersBufferWithASDescriptor:", a4);
  v16 = -[MTLGPUDebugAccelerationStructureCommandEncoder encodeUnwrapAccelerationStructureDescriptor:](self, "encodeUnwrapAccelerationStructureDescriptor:", a4);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
  v17.receiver = self;
  ...
  if (a5)
  {
    -[MTLGPUDebugAccelerationStructureCommandEncoder blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:](self, "blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:", a4, a5);
    if (v15)
      -[MTLGPUDebugAccelerationStructureCommandEncoder blitChildrenWrappersBufferAddress:toAccelerationStructure:](self, "blitChildrenWrappersBufferAddress:toAccelerationStructure:", v15, a5);
  }
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
...
- (void)copyAccelerationStructure:(id)a3 toAccelerationStructure:(id)a4
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitTypeFromAccelerationStructure:toAccelerationStructure:](self, "blitTypeFromAccelerationStructure:toAccelerationStructure:", a3, a4);
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitChildrenWrappersBufferFromAcceleratrionStructure:toAccelerationStructure:](self, "blitChildrenWrappersBufferFromAcceleratrionStructure:toAccelerationStructure:", a3, a4);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
}
...
- (void)deserializePrimitiveAccelerationStructure:(id)a3 fromBuffer:(id)a4 serializedBufferOffset:(unint64_t)a5
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitPrimitiveTypetoAccelerationStructure:](self, "blitPrimitiveTypetoAccelerationStructure:", a3);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
}
...
- (void)deserializeInstanceAccelerationStructure:(id)a3 primitiveAccelerationStructures:(id)a4 fromBuffer:(id)a5 serializedBufferOffset:(unint64_t)a6
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitInstanceTypetoAccelerationStructure:](self, "blitInstanceTypetoAccelerationStructure:", a3);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
}
...
- (void)deserializePrimitiveAccelerationStructure:(id)a3 fromBuffer:(id)a4 serializedBufferOffset:(unint64_t)a5 withDescriptor:(id)a6
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:](self, "blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:", a6, a3);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
}
...
- (void)deserializeInstanceAccelerationStructure:(id)a3 primitiveAccelerationStructures:(id)a4 fromBuffer:(id)a5 serializedBufferOffset:(unint64_t)a6 withDescriptor:(id)a7
{
  ...
  -[MTLGPUDebugAccelerationStructureCommandEncoder destroyBaseAccelerationStructureCommandEncoder](self, "destroyBaseAccelerationStructureCommandEncoder");
  -[MTLGPUDebugAccelerationStructureCommandEncoder blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:](self, "blitTypeFromAccelerationStructureDescriptor:toAccelerationStructure:", a7, a3);
  -[MTLGPUDebugAccelerationStructureCommandEncoder newBaseAccelerationStructureCommandEncoder](self, "newBaseAccelerationStructureCommandEncoder");
}
...
- (void)writeGenericBVHStructureOfAccelerationStructure:(id)a3 headerBuffer:(id)a4 headerBufferOffset:(unint64_t)a5 innerNodeBuffer:(id)a6 innerNodeBufferOffset:(unint64_t)a7 leafNodeBuffer:(id)a8 leafNodeBufferOffset:(unint64_t)a9 primitiveBuffer:(id)a10 primitiveBufferOffset:(unint64_t)a11 geometryBuffer:(id)a12 geometryOffset:(unint64_t)a13 instanceTransformBuffer:(id)a14 instanceTransformOffset:(unint64_t)a15 controlPointBuffer:(id)a16 controlPointBufferOffset:(unint64_t)a17
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
  -[MTLToolsAccelerationStructureCommandEncoder writeGenericBVHStructureOfAccelerationStructure:headerBuffer:headerBufferOffset:innerNodeBuffer:innerNodeBufferOffset:leafNodeBuffer:leafNodeBufferOffset:primitiveBuffer:primitiveBufferOffset:geometryBuffer:geometryOffset:instanceTransformBuffer:instanceTransformOffset:controlPointBuffer:controlPointBufferOffset:](&v17, sel_writeGenericBVHStructureOfAccelerationStructure_headerBuffer_headerBufferOffset_innerNodeBuffer_innerNodeBufferOffset_leafNodeBuffer_leafNodeBufferOffset_primitiveBuffer_primitiveBufferOffset_geometryBuffer_geometryOffset_instanceTransformBuffer_instanceTransformOffset_controlPointBuffer_controlPointBufferOffset_, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, a14, a15, a16, a17);
}
...
- (void)useResource:(id)a3 usage:(unint64_t)a4
{
  ...
  *v7 = p_resourceAndUsageList->__end_.__prev_;
...
- (void)useResources:(const void *)a3 count:(unint64_t)a4 usage:(unint64_t)a5
{
  ...
  if (a4)
  {
    ...
    {
      v9 = (uint64_t)*a3++;
      -[MTLGPUDebugAccelerationStructureCommandEncoder useResource:usage:](self, "useResource:usage:", v9, a5);
      --v6;
    }
    while (v6);
  }
...
- (void)useHeaps:(const void *)a3 count:(unint64_t)a4
{
  ...
  if (a4)
  {
    ...
    {
      v7 = (uint64_t)*a3++;
      -[MTLGPUDebugAccelerationStructureCommandEncoder useHeap:](self, "useHeap:", v7);
      --v4;
    }
    while (v4);
  }
