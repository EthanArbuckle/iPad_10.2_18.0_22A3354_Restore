...
{
  MTLLegacySVIntersectionFunctionTable *v6;
  objc_super v8;
  ...
  if (v6)
  {
    ...
    -[MTLLegacySVIntersectionFunctionTable _setupIdentifier](v6, "_setupIdentifier");
    -[MTLLegacySVIntersectionFunctionTable _initHandleBuffer](v6, "_initHandleBuffer");
  }
  return v6;
}
...
{
  MTLLegacySVIntersectionFunctionTable *v8;
  objc_super v10;
  ...
  if (v8)
  {
    ...
    -[MTLLegacySVIntersectionFunctionTable _setupIdentifier](v8, "_setupIdentifier");
    -[MTLLegacySVIntersectionFunctionTable _initHandleBuffer](v8, "_initHandleBuffer");
  }
  return v8;
}
...
{
  MTLLegacySVIntersectionFunctionTable *v10;
  objc_super v12;
  ...
  if (v10)
  {
    ...
    v10->_stage = a7;
    -[MTLLegacySVIntersectionFunctionTable _setupIdentifier](v10, "_setupIdentifier");
    -[MTLLegacySVIntersectionFunctionTable _initHandleBuffer](v10, "_initHandleBuffer");
  }
  return v10;
}
...
- (void)setFunctions:(const void *)a3 withRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLLegacySVIntersectionFunctionTable setFunction:atIndex:](self, "setFunction:atIndex:", v8, location++);
      --length;
    }
    while (length);
  }
...
- (void)setBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  if (a5.length)
  {
    length = a5.length;
    for (i = 0; i != length; ++i)
      -[MTLLegacySVIntersectionFunctionTable setBuffer:offset:atIndex:](self, "setBuffer:offset:atIndex:", a3[i], a4[i], i);
  }
}
...
- (void)setVisibleFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if (a4.length)
  {
    ...
    {
      v8 = (uint64_t)*a3++;
      -[MTLLegacySVIntersectionFunctionTable setVisibleFunctionTable:atBufferIndex:](self, "setVisibleFunctionTable:atBufferIndex:", v8, location++);
      --length;
    }
    while (length);
  }
