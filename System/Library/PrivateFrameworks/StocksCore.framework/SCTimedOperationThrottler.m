...
{
  id v4;
  SCTimedOperationThrottler *v5;
  SCTimedOperationThrottler *v6;
  SCWOperationThrottler *v7;
  ...
  v5 = -[SCTimedOperationThrottler init](&v10, sel_init);
  v6 = v5;
  if (v5)
  {
    objc_storeWeak((id *)&v5->_delegate, v4);
    v7 = -[SCWOperationThrottler initWithDelegate:]([SCWOperationThrottler alloc], "initWithDelegate:", v6);
...
- (void)tickle
{
  ...
  -[SCTimedOperationThrottler operationThrottler](self, "operationThrottler");
...
- (void)operationThrottler:(id)a3 performAsyncOperationWithCompletion:(id)a4
{
  ...
  -[SCTimedOperationThrottler delegate](self, "delegate", v9, v10, v11, v12, v13);
...
{
  return (SCWOperationThrottlerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
