...
{
  id v4;
  SCUpdateLastAppLaunchUpsellInstanceIDCommand *v5;
  void *v6;
  id v7;
...
{
  return (SCUpdateLastAppLaunchUpsellInstanceIDCommand *)sub_1ABE54C18(a3);
}
...
{
  SCUpdateLastAppLaunchUpsellInstanceIDCommand *result;
...
- (void)executeWithZone:(id)a3
{
  ...
  uint64_t v8;
  void *v9;
  SCUpdateLastAppLaunchUpsellInstanceIDCommand *v10;
  _QWORD v11[6];
