...
- (BOOL)isValidRecord:(id)a3
{
  ...
  -[SCWRecordFieldSchema name](self, "name");
  ...
  if (v7 | v10)
  {
    if ((!-[SCWRecordFieldSchema isEncrypted](self, "isEncrypted") || v10)
      && ((v11 = -[SCWRecordFieldSchema isEncrypted](self, "isEncrypted"), v7) || v11))
    {
      -[SCWRecordFieldSchema valueClass](self, "valueClass");
  ...
  {
    isKindOfClass = !-[SCWRecordFieldSchema isRequired](self, "isRequired");
  }
...
- (SCWRecordFieldSchema)initWithName:(id)a3 valueClass:(Class)a4 required:(BOOL)a5 encrypted:(BOOL)a6
{
  ...
  v12 = -[SCWRecordFieldSchema init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
