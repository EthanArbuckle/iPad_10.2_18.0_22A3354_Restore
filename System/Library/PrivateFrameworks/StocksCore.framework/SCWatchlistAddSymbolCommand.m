...
- (SCWatchlistAddSymbolCommand)initWithSymbol:(id)a3
{
  ...
  v5 = -[SCWatchlistAddSymbolCommand init](&v9, sel_init);
  if (v5)
  {
...
- (SCWatchlistAddSymbolCommand)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  SCWatchlistAddSymbolCommand *v6;
  SCWatchlistAddSymbolCommand *v7;
  ...
  if (v5)
  {
    self = -[SCWatchlistAddSymbolCommand initWithSymbol:](self, "initWithSymbol:", v5);
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[SCWatchlistAddSymbolCommand symbol](self, "symbol");
