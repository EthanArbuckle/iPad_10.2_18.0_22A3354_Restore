...
- (SCWDatabaseMemoryStore)init
{
  ...
  v2 = -[SCWDatabaseMemoryStore init](&v6, sel_init);
  if (v2)
  {
...
- (id)zoneStoreForSchema:(id)a3
{
  ...
  void *v5;
  void *v6;
  SCWZoneMemoryStore *v7;
  void *v8;
  void *v9;

  v4 = a3;
  -[SCWDatabaseMemoryStore zoneStoresByName](self, "zoneStoresByName");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "zoneName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "objectForKeyedSubscript:", v6);
  v7 = (SCWZoneMemoryStore *)objc_claimAutoreleasedReturnValue();
