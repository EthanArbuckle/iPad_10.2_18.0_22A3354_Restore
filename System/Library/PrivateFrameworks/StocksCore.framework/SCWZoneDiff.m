...
- (id)applyToRecords:(id)a3
{
  ...
  v31 = 0u;
  v32 = 0u;
  -[SCWZoneDiff modifiedRecords](self, "modifiedRecords");
  ...
  v27 = 0u;
  v28 = 0u;
  -[SCWZoneDiff deletedRecordIDs](self, "deletedRecordIDs", 0);
...
- (SCWZoneDiff)initWithModifiedRecords:(id)a3 deletedRecordIDs:(id)a4
{
  ...
  v8 = -[SCWZoneDiff init](&v14, sel_init);
  if (v8)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[SCWZoneDiff modifiedRecords](self, "modifiedRecords");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[SCWZoneDiff deletedRecordIDs](self, "deletedRecordIDs");
