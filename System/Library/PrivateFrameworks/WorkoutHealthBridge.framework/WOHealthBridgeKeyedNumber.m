...
- (id)description
{
  ...
  -[WOHealthBridgeKeyedNumber description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WOHealthBridgeKeyedNumber dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->_number);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (!self->_key)
    -[WOHealthBridgeKeyedNumber writeTo:].cold.1();
  v5 = v4;
