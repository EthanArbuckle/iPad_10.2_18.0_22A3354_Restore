...
- (id)description
{
  ...
  -[WOHealthBridgeSyncIdentity description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WOHealthBridgeSyncIdentity dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_hardwareIdentifier)
    -[WOHealthBridgeSyncIdentity writeTo:].cold.1();
  PBDataWriterWriteDataField();
  if (!self->_databaseIdentifier)
    -[WOHealthBridgeSyncIdentity writeTo:].cold.2();
  PBDataWriterWriteDataField();
  if (!self->_instanceDiscriminator)
    -[WOHealthBridgeSyncIdentity writeTo:].cold.3();
...
- (void)copyTo:(id)a3
{
  ...
  hardwareIdentifier = self->_hardwareIdentifier;
  v5 = a3;
  objc_msgSend(v5, "setHardwareIdentifier:", hardwareIdentifier);
  objc_msgSend(v5, "setDatabaseIdentifier:", self->_databaseIdentifier);
  objc_msgSend(v5, "setInstanceDiscriminator:", self->_instanceDiscriminator);
