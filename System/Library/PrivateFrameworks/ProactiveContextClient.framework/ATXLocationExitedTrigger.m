...
{
  id v7;
  ATXLocationExitedTrigger *v8;
  ATXLocationExitedTrigger *v9;
  ATXLocationExitedTrigger *v10;
  objc_super v12;

  v7 = a3;
  v12.receiver = self;
  v12.super_class = (Class)ATXLocationExitedTrigger;
  v8 = -[ATXLocationExitedTrigger init](&v12, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (ATXLocationExitedTrigger)initWithCoder:(id)a3
{
  ...
  v7 = -[ATXLocationExitedTrigger initWithLocationIdentifier:namedLOI:](self, "initWithLocationIdentifier:namedLOI:", v5, v6);
  return v7;
}
