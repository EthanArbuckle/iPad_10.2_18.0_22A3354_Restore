...
{
  id v5;
  ATXWiredAudioConnectedTrigger *v6;
  ATXWiredAudioConnectedTrigger *v7;
  ATXWiredAudioConnectedTrigger *v8;
  objc_super v10;

  v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ATXWiredAudioConnectedTrigger;
  v6 = -[ATXWiredAudioConnectedTrigger init](&v10, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (ATXWiredAudioConnectedTrigger)initWithCoder:(id)a3
{
  ...
  v6 = -[ATXWiredAudioConnectedTrigger initWithDeviceIdentifier:](self, "initWithDeviceIdentifier:", v5);
  return v6;
}
