...
- (wspConnectOut)init
{
  ...
  v2 = -[wspConnectOut init](&v6, sel_init);
  if (v2)
  {
...
- (int)decodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesDecoded:(unsigned int *)a5
{
  ...
  else
  {
    ...
    if (v18 == 200)
    {
      ...
      {
        if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
          -[wspConnectOut decodeBuffer:BufferOffset:BytesDecoded:].cold.2(self);
        v13 = 0;
      }
      else
      {
        ...
        if (v9 - v21 - v16 > 3)
        {
          -[wspConnectOut setServerVersion:](self, "setServerVersion:", *(unsigned int *)(v11 + v22));
          v13 = 0;
          v14 = v23 + 4;
LABEL_6:
          *a5 = v14;
        ...
        if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
          -[wspConnectOut decodeBuffer:BufferOffset:BytesDecoded:].cold.1();
        v13 = 55;
      }
    }
    else
    {
      if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
        -[wspConnectOut decodeBuffer:BufferOffset:BytesDecoded:].cold.3(self);
      v13 = 5;
    }
  }
LABEL_10:
...
- (void)decodeBuffer:BufferOffset:BytesDecoded:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "decodeBuffer:decodeBuffer: no buffer space for ServerVersion, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_6();
}
...
- (void)decodeBuffer:(void *)a1 BufferOffset:BytesDecoded:.cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1(&dword_227C1F000, MEMORY[0x24BDACB70], v2, "wspConnectOut:decodeBuffer: ConnectOut hdr status: 0x%x\n", v3, v4, v5, v6, v7);
...
- (void)decodeBuffer:(void *)a1 BufferOffset:BytesDecoded:.cold.3(void *a1)
{
  ...
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1(&dword_227C1F000, MEMORY[0x24BDACB70], v2, "wspConnectOut:decodeBuffer: Unexpected MsgId: 0x%x\n", v3, v4, v5, v6, v7);
...
- (void)decodeBuffer:BufferOffset:BytesDecoded:.cold.4()
{
  ...
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "wspConnectOut:decodeBuffer: Failed to decode wsp header, error: %d\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_2();
}
...
- (void)decodeBuffer:BufferOffset:BytesDecoded:.cold.5()
{
  ...
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "wspConnectOut:decodeBuffer: no buffer space, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_6();
}
