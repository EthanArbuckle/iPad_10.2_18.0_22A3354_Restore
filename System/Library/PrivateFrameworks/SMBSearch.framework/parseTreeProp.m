...
- (parseTreeProp)initWithParseTreeStr:(id)a3
{
  ...
  v5 = -[parseTreeProp init](&v36, sel_init);
  if (v5)
  {
    ...
    if (v8)
    {
      if (-[cbaseVariant setStringType:UTF8Str:](v8, "setStringType:UTF8Str:", 8, v4))
      {
        ...
        if (v9)
          -[parseTreeProp initWithParseTreeStr:].cold.3(v9, v10, v11, v12, v13, v14, v15, v16);
      }
      else
      {
        ...
        if (v28)
          -[parseTreeProp initWithParseTreeStr:].cold.2(v28, v29, v30, v31, v32, v33, v34, v35);
      }
    }
    else
    {
      ...
      if (v17)
        -[parseTreeProp initWithParseTreeStr:].cold.1(v17, v18, v19, v20, v21, v22, v23, v24);
    }
...
- (unsigned)propertyID
{
  ...
  -[parseTreeProp cProps](self, "cProps");
...
- (int)encodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesWritten:(unsigned int *)a5
{
  ...
  if (objc_msgSend(v8, "length") <= (unint64_t)v6)
  {
    if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
      -[parseTreeProp encodeBuffer:BufferOffset:BytesWritten:].cold.3();
    v11 = 12;
  }
  else
  {
    ...
    {
      if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
        -[parseTreeProp encodeBuffer:BufferOffset:BytesWritten:].cold.2();
    }
    else
    {
      v13 = v16;
      v14 = (v16 + v6);
      -[parseTreeProp variant](self, "variant");
      ...
      {
        if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
          -[parseTreeProp encodeBuffer:BufferOffset:BytesWritten:].cold.1();
      }
      else
      {
        *a5 = v16 + v13;
...
{
  OUTLINED_FUNCTION_0(&dword_227C1F000, MEMORY[0x24BDACB70], a3, "parseTreeProp:initWithServerMachine: failed to alloc cbaseVariant\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0(&dword_227C1F000, MEMORY[0x24BDACB70], a3, "parseTreeProp:initWithServerMachine: failed to alloc cProps\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0(&dword_227C1F000, MEMORY[0x24BDACB70], a3, "parseTreeProp:initWithServerMachine: failed to create VT_BSTR variant\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
...
- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.1()
{
  ...
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "parseTreeProp:encodeBuffer: encode variant error: %d\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_2();
}
...
- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.2()
{
  ...
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "parseTreeProp:encodeBuffer: encode cProps error: %d\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_2();
}
...
- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.3()
{
  ...
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "parseTreeProp:encodeBuffer: no buffer space, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_6();
}
