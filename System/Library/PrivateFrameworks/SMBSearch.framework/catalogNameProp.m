...
- (catalogNameProp)initWithCatName:(id)a3 UseExtBTypes:(BOOL)a4
{
  ...
  v7 = -[catalogNameProp init](&v46, sel_init);
  if (v7)
  {
    ...
    if (!v10)
    {
      ...
      if (v19)
        -[catalogNameProp initWithCatName:UseExtBTypes:].cold.1(v19, v20, v21, v22, v23, v24, v25, v26);
      goto LABEL_15;
    }
    if (v4)
    {
      if (-[cbaseVariant setStringType:UTF8Str:](v10, "setStringType:UTF8Str:", 31, v6))
      {
        ...
        if (v11)
          -[catalogNameProp initWithCatName:UseExtBTypes:].cold.3(v11, v12, v13, v14, v15, v16, v17, v18);
LABEL_15:
    ...
    if (!v7->_cProps)
    {
      ...
      if (v37)
        -[catalogNameProp initWithCatName:UseExtBTypes:].cold.2(v37, v38, v39, v40, v41, v42, v43, v44);
      goto LABEL_15;
    }
  }
LABEL_16:
...
- (unsigned)propertyID
{
  ...
  -[catalogNameProp cProps](self, "cProps");
...
- (int)encodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesWritten:(unsigned int *)a5
{
  ...
  if (objc_msgSend(v8, "length") <= (unint64_t)v6)
  {
    if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
      -[catalogNameProp encodeBuffer:BufferOffset:BytesWritten:].cold.3();
    v11 = 12;
  }
  else
  {
    ...
    {
      if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
        -[catalogNameProp encodeBuffer:BufferOffset:BytesWritten:].cold.2();
    }
    else
    {
      v13 = v16;
      v14 = (v16 + v6);
      -[catalogNameProp variant](self, "variant");
      ...
      {
        if (os_log_type_enabled(MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR))
          -[catalogNameProp encodeBuffer:BufferOffset:BytesWritten:].cold.1();
      }
      else
      {
        *a5 = v16 + v13;
...
{
  OUTLINED_FUNCTION_0(&dword_227C1F000, MEMORY[0x24BDACB70], a3, "catalogNameProp:init: failed to alloc cbaseVariant\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0(&dword_227C1F000, MEMORY[0x24BDACB70], a3, "catalogNameProp:init: failed to alloc cProps\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0(&dword_227C1F000, MEMORY[0x24BDACB70], a3, "catalogNameProp:init: failed to create VT_LPWSTR variant\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0(&dword_227C1F000, MEMORY[0x24BDACB70], a3, "catalogNameProp:init: failed to create VT_BSTR variant\n", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
...
- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.1()
{
  ...
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "catalogNameProp:encodeBuffer: encode variant error: %d\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_2();
}
...
- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.2()
{
  ...
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "catalogNameProp:encodeBuffer: encode cProps error: %d\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_2();
}
...
- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.3()
{
  ...
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4(&dword_227C1F000, MEMORY[0x24BDACB70], v0, "catalogNameProp:encodeBuffer: no buffer space, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
  OUTLINED_FUNCTION_6();
}
