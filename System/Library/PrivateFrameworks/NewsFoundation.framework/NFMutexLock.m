...
- (NFMutexLock)init
{
  return -[NFMutexLock initWithOptions:](self, "initWithOptions:", 0);
}
...
- (void)dealloc
{
  ...
  -[NFMutexLock dealloc](&v3, sel_dealloc);
}
...
- (NFMutexLock)initWithOptions:(unint64_t)a3
{
  ...
  v4 = -[NFMutexLock init](&v6, sel_init);
  if (v4)
  {
    v7.__sig = 0;
...
- (void)performWithLockSync:(id)a3
{
  ...
  v4 = (void (**)(void))a3;
  -[NFMutexLock lock](self, "lock");
  if (v4)
    v4[2]();
  -[NFMutexLock unlock](self, "unlock");
