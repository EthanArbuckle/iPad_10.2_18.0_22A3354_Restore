  ...
  if (a4)
  {
    ...
    if (v8 != 0.0)
    {
      ...
      if (v9 != 0.0)
      {
        ...
        -[EQKitOverlayBox height](v5, "height");
        v14 = v13;
        v15 = *(_QWORD *)(EQKitLayoutManager::layoutContext((EQKitLayoutManager *)a5) + 96);
        ...
        v20 = -[EQKitPathBox initWithCGPath:height:cgColor:drawingMode:lineWidth:](v12, "initWithCGPath:height:cgColor:drawingMode:lineWidth:", PathForNotation, v15, 2, v14, (*(double (**)(uint64_t, uint64_t, unint64_t, __n128))(*(_QWORD *)v19 + 40))(v19, 23, v18 + 8, v17));
