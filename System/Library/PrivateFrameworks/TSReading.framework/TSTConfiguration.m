...
- (TSTConfiguration)init
{
  ...
  v2 = -[TSTConfiguration init](&v5, sel_init);
  v3 = v2;
  if (v2)
  {
    *(_QWORD *)(v2 + 68) = 0xFF0000FFFFLL;
    *((_DWORD *)v2 + 19) = 0x7FFFFFFF;
    *((_DWORD *)v2 + 2) = 0x1000000;
    *((_WORD *)v2 + 6) = 0;
    v2[14] = 0;
    v2[29] = 1;
    *(_QWORD *)(v2 + 21) = 0x10000000100;
    *(_DWORD *)(v2 + 30) = 0;
    *(_DWORD *)(v2 + 33) = 0;
    *(_DWORD *)(v2 + 37) = 65537;
    v2[41] = 0;
    v2[42] = TSUPhoneUI() ^ 1;
    v3[43] = 1;
    objc_msgSend(v3, "setTokenizeFormulaStringLiterals:", 1);
    objc_msgSend(v3, "setFormulaCellEditorSupportsTextTokenEditor:", 1);
    *((_DWORD *)v3 + 11) = 1;
    *(_WORD *)(v3 + 19) = 1;
    *(_DWORD *)(v3 + 15) = 16777473;
    v3[48] = 1;
    *(_QWORD *)(v3 + 49) = 0;
    objc_msgSend(v3, "setFormulaEditorEvaluatesFormulas:", 0);
    objc_msgSend(v3, "setShowReferenceHighlightsOnFormulaCellSelection:", 1);
    objc_msgSend(v3, "setCellEditorsCanScrollToNonLocalTableSelection:", 1);
    objc_msgSend(v3, "setSupportsComplexFilterUI:", 0);
    objc_msgSend(v3, "setSupportsQuickFilterUI:", 0);
    objc_msgSend(v3, "setAllowsFullyFilteredTables:", 1);
    objc_msgSend(v3, "setPasteFilterHidingAsUserHiding:", 0);
    TSUFormatInit();
  }
