...
- (const)mathMLAttributes
{
  ...
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMTr mathMLAttributes]::sAttributesSet, (int *)&-[EQKitMathMLMTr mathMLAttributes]::sAttributesData, (int *)&-[EQKitMathMLMTd mathMLAttributes]::sAttributesData);
  }
