...
{
  self->dirtyCellRange = ($6C2899CC353BE70625C5C4ACBB5C74E2)TSTCellRangeUnionCellRange(*(_QWORD *)&self->dirtyCellRange, *(_QWORD *)&a3);
}

- (void)setDirtyStrokeRange:(id)a3
{
  self->dirtyStrokeRange = ($6C2899CC353BE70625C5C4ACBB5C74E2)TSTCellRangeUnionCellRange(*(_QWORD *)&self->dirtyStrokeRange, *(_QWORD *)&a3);
}
