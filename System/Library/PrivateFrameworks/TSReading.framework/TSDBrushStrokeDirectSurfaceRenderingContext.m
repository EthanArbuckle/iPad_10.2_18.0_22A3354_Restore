...
- (TSDBrushStrokeDirectSurfaceRenderingContext)initWithSurface:(id)a3 frame:(CGRect)a4 transform:(CGAffineTransform *)a5 contentsScale:(double)a6 destinationColorSpaceOverride:(CGColorSpace *)a7 metalDeviceOverride:(id)a8
{
  ...
  id v18;
  id v19;
  TSDBrushStrokeDirectSurfaceRenderingContext *v20;
  TSDBrushStrokeDirectSurfaceRenderingContext *v21;
  __int128 v22;
  __int128 v23;
  objc_super v25;
  ...
  v20 = -[TSDBrushStrokeDirectSurfaceRenderingContext init](&v25, sel_init);
  v21 = v20;
  if (v20)
  {
...
- (void)dealloc
{
  ...
  -[TSDBrushStrokeDirectSurfaceRenderingContext dealloc](&v3, sel_dealloc);
}
