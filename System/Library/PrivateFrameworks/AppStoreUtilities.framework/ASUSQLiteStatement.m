...
- (ASUSQLiteStatement)initWithStatement:(sqlite3_stmt *)a3 onConnection:(id)a4
{
  ...
  v8 = -[ASUSQLiteStatement init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (NSDictionary)columnIndexByName
{
  ...
  if (statement)
  {
    ...
    if (v4 >= 1)
    {
      ...
      do
      {
        v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD16E0]), "initWithInt:", v6);
        v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithUTF8String:", sqlite3_column_name(self->_statement, v6));
  ...
  {
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB0], CFSTR("Statement already finalized"));
    v5 = 0;
  }
...
- (NSString)SQL
{
  ...
  if (statement)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", sqlite3_sql(statement));
...
- (void)bindArray:(id)a3 atPosition:(int)a4
{
  ...
  -[ASUSQLiteStatement bindData:atPosition:](self, "bindData:atPosition:", v6, v4);
...
- (void)bindDouble:(double)a3 atPosition:(int)a4
{
  ...
  if (statement)
    ...
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB0], CFSTR("Statement already finalized"), a3);
}
...
- (void)bindUUID:(id)a3 atPosition:(int)a4
{
  ...
  v6 = (id)objc_claimAutoreleasedReturnValue();
  -[ASUSQLiteStatement bindString:atPosition:](self, "bindString:atPosition:", v6, v4);
