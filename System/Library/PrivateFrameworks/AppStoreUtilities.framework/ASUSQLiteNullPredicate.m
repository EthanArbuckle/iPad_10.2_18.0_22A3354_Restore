...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[ASUSQLitePropertyPredicate isEqual:](&v8, sel_isEqual_, v4))
  {
    v5 = -[ASUSQLiteNullPredicate matchesNull](self, "matchesNull");
...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  v8 = -[ASUSQLiteNullPredicate matchesNull](self, "matchesNull");
