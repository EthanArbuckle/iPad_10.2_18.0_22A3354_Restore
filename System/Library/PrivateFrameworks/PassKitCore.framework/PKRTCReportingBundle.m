@implementation PKRTCReportingBundle
...
void __PKRTCReportingBundle_block_invoke()
{
  ...
  objc_msgSend(v6, "URLByAppendingPathComponent:isDirectory:", CFSTR("PrivateFrameworks/RTCReporting.framework"), 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB34D0]), "initWithURL:", v3);
  v5 = (void *)qword_1ECF226B0;
  qword_1ECF226B0 = v4;
