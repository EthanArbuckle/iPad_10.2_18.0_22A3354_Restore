...
{
  PKPeerPaymentAddAssociatedAccountResponse *v3;
  PKPeerPaymentAddAssociatedAccountResponse *v4;
  void *v5;
  id v6;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v16 = v12;
        _os_log_impl(&dword_18FC92000, v8, OS_LOG_TYPE_DEFAULT, "Malformed PKPeerPaymentAddAssociatedAccountResponse: expected dictionary and received %{public}@", buf, 0xCu);
