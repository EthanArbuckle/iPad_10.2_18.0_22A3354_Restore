...
{
  return -[PKAccountWebServicePaymentsResponse initWithData:account:request:](self, "initWithData:account:request:", a3, 0, 0);
}

- (PKAccountWebServicePaymentsResponse)initWithData:(id)a3 account:(id)a4 request:(id)a5
{
  id v7;
  PKAccountWebServicePaymentsResponse *v8;
  PKAccountWebServicePaymentsResponse *v9;
  void *v10;
  void *v11;
  NSArray *v12;
  void *v13;
  ...
  NSArray *payments;
  PKAccountWebServicePaymentsResponse *v24;
  NSObject *v25;
  objc_class *v26;
  void *v27;
  objc_class *v28;
  void *v29;
  PKAccountWebServicePaymentsResponse *v31;
  id v32;
  __int128 v33;
  __int128 v34;
  __int128 v35;
