...
+ (id)validatorWithObject:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)objc_msgSend(objc_alloc((Class)objc_opt_class()), "initWithInstantFundsOutFeeSummaryItem:", v3);
...
{
  return -[PKInstantFundsOutFeeSummaryItemValidator isValidWithAPIType:withError:](self, "isValidWithAPIType:withError:", 0, a3);
}
...
- (BOOL)isValidWithAPIType:(int64_t)a3 withError:(id *)a4
{
  ...
  if (v6)
  {
    ...
    v18[0] = CFSTR("PKInstantFundsOutFeeSummaryItem amount must be non-negative");
...
LABEL_6:
    ...
    objc_msgSend(v14, "setObject:forKeyedSubscript:", CFSTR("PKInstantFundsOutFeeSummaryItem has an invalid amount"), *MEMORY[0x1E0CB2D50]);
