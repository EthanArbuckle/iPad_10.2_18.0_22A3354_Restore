...
{
  PKPaymentSetupFieldBuiltInTransactionLimit *v4;
  void *v5;
  void *v6;
  objc_super v8;
  ...
  v4 = -[PKPaymentSetupFieldText initWithIdentifier:type:](&v8, sel_initWithIdentifier_type_, CFSTR("transactionLimit"), a4);
  if (v4)
  {
    PKLocalizedMadisonString(CFSTR("TRANSACTION_LIMIT_AMOUNT"), 0);
