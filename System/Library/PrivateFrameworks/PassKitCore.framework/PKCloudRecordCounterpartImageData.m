...
{
  id v4;
  PKCloudRecordCounterpartImageData *v5;
  uint64_t v6;
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("counterpartImageData"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", self->_counterpartImageData, CFSTR("counterpartImageData"), v5.receiver, v5.super_class);
...
- (int64_t)compare:(id)a3
{
  ...
  v4 = a3;
  -[PKPeerPaymentCounterpartImageData identifier](counterpartImageData, "identifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "counterpartImageData");
...
- (id)descriptionWithItem:(BOOL)a3
{
  ...
  v3 = a3;
  -[PKCloudRecordCounterpartImageData _descriptionWithIncludeItem:](self, "_descriptionWithIncludeItem:");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v8.receiver = self;
...
- (id)description
{
  ...
  -[PKCloudRecordCounterpartImageData _descriptionWithIncludeItem:](self, "_descriptionWithIncludeItem:", 0);
...
- (id)_descriptionWithIncludeItem:(BOOL)a3
{
  ...
  {
    if (v3)
      objc_msgSend(v5, "appendFormat:", CFSTR("counterpartImageData: %@\n"), self->_counterpartImageData);
  }
  else
  {
    objc_msgSend(v5, "appendFormat:", CFSTR("No associated counterpartImageData in database\n"), v8);
  }
  return v6;
}
...
- (void)applyCloudRecordObject:(id)a3
{
  ...
  void *v6;
  void *v7;
  PKPeerPaymentCounterpartImageData *v8;
  PKPeerPaymentCounterpartImageData *counterpartImageData;
  objc_super v10;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (!self->_counterpartImageData)
    {
      objc_msgSend(v5, "counterpartImageData");
      v7 = (void *)objc_claimAutoreleasedReturnValue();

      if (v7)
      {
        objc_msgSend(v6, "counterpartImageData");
        v8 = (PKPeerPaymentCounterpartImageData *)objc_claimAutoreleasedReturnValue();
        counterpartImageData = self->_counterpartImageData;
...
{
  objc_storeStrong((id *)&self->_counterpartImageData, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_counterpartImageData, 0);
}
