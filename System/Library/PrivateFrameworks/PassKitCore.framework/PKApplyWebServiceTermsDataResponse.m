...
{
  PKApplyWebServiceTermsDataResponse *v3;
  PKApplyWebServiceTermsDataResponse *v4;
  void *v5;
  uint64_t v6;
  void *v7;
  void *v8;
  ...
  PKApplyWebServiceTermsDataResponse *v29;
  objc_class *v30;
  objc_super v32;
  uint8_t buf[4];
  void *v34;
...
{
  id v4;
  PKApplyWebServiceTermsDataResponse *v5;
  uint64_t v6;
  NSData *termsData;
  uint64_t v8;
  NSString *termsDataFileName;
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("termsData"));
    v6 = objc_claimAutoreleasedReturnValue();
    termsData = v5->_termsData;
    v5->_termsData = (NSData *)v6;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("termsDataFileName"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", self->_termsData, CFSTR("termsData"), v5.receiver, v5.super_class);
  objc_msgSend(v4, "encodeObject:forKey:", self->_termsDataFileName, CFSTR("termsDataFileName"));
