...
- (id)description
{
  ...
  -[PKProtobufCloudStoreZoneInvitationResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PKProtobufCloudStoreZoneInvitationResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self->_version != *((_DWORD *)v4 + 5))
    goto LABEL_9;
  invitation = self->_invitation;
  if ((unint64_t)invitation | *((_QWORD *)v4 + 1))
  {
