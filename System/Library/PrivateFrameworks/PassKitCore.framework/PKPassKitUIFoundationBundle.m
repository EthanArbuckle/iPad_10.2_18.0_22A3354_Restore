@implementation PKPassKitUIFoundationBundle

void __PKPassKitUIFoundationBundle_block_invoke()
{
  void *v0;
  void *v1;
  void *v2;
  ...
  objc_msgSend(v6, "URLByAppendingPathComponent:isDirectory:", CFSTR("PrivateFrameworks/PassKitUIFoundation.framework"), 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB34D0]), "initWithURL:", v3);
  v5 = (void *)qword_1ECF22670;
  qword_1ECF22670 = v4;
