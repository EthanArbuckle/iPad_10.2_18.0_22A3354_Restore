...
{
  PKPaymentProvisioningMethodMetadataResponse *v3;
  PKPaymentProvisioningMethodMetadataResponse *v4;
  void *v5;
  id v6;
  PKPaymentProvisioningMethodMetadata *v7;
  void *provisioningMethodMetadata;
  NSObject *v9;
  objc_class *v10;
  void *v11;
  void *v12;
  ...
  if (v3)
  {
    ...
    {
      v6 = v5;
      v7 = -[PKPaymentProvisioningMethodMetadata initWithDictionary:]([PKPaymentProvisioningMethodMetadata alloc], "initWithDictionary:", v6);
