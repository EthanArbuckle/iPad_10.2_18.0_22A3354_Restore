...
{
  PKAccountWebServiceStatementsResponse *v3;
  PKAccountWebServiceStatementsResponse *v4;
  void *v5;
  void *v6;
  void *v7;
  uint64_t v8;
  ...
  uint64_t v10;
  uint64_t v11;
  PKCreditAccountStatement *v12;
  uint64_t v13;
  NSArray *statements;
  PKAccountWebServiceStatementsResponse *v15;
  NSObject *v16;
  objc_class *v17;
  void *v18;
  objc_class *v19;
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v12 = -[PKCreditAccountStatement initWithDictionary:]([PKCreditAccountStatement alloc], "initWithDictionary:", *(_QWORD *)(*((_QWORD *)&v22 + 1) + 8 * v11));
          if (v12)
