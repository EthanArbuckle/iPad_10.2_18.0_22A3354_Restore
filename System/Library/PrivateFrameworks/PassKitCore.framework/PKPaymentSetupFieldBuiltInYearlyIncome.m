...
- (PKPaymentSetupFieldBuiltInYearlyIncome)initWithIdentifier:(id)a3 type:(unint64_t)a4
{
  ...
  uint64_t v7;
  uint64_t v8;
  PKPaymentSetupFieldBuiltInYearlyIncome *v9;
  void *v10;
  objc_super v12;

  v12.receiver = self;
  v12.super_class = (Class)PKPaymentSetupFieldBuiltInYearlyIncome;
  v9 = -[PKPaymentSetupFieldText initWithIdentifier:type:](&v12, sel_initWithIdentifier_type_, CFSTR("yearlyIncome"), a4);
  if (v9)
  {
    PKLocalizedFeatureString(CFSTR("INCOME"), 2, 0, v4, v5, v6, v7, v8, (uint64_t)v12.receiver);
    ...
    -[PKPaymentSetupFieldText setMaxLength:](v9, "setMaxLength:", 10);
