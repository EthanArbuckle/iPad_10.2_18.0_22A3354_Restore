...
{
  PKPaymentServiceProviderPurchasesResponse *v3;
  PKPaymentServiceProviderPurchasesResponse *v4;
  void *v5;
  void *v6;
  id v7;
  uint64_t v8;
  ...
  uint64_t v11;
  uint64_t v12;
  PKServiceProviderPurchase *v13;
  PKServiceProviderPurchase *v14;
  uint64_t v15;
  NSObject *p_super;
  objc_class *v17;
  void *v18;
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v14 = -[PKServiceProviderPurchase initWithDictionary:](v13, "initWithDictionary:", v12, (_QWORD)v22);
            if (v14)
    ...
    else
    {
      ...
      if (os_log_type_enabled(p_super, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v30 = v19;
        v20 = v19;
        _os_log_impl(&dword_18FC92000, p_super, OS_LOG_TYPE_DEFAULT, "Malformed response: expected array and received %{public}@ inside %@", buf, 0x16u);
