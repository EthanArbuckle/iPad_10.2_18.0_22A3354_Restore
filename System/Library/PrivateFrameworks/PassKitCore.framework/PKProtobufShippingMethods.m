...
- (void)clearMethods
{
  -[NSMutableArray removeAllObjects](self->_methods, "removeAllObjects");
}
...
- (void)addMethods:(id)a3
{
  ...
  -[NSMutableArray addObject:](methods, "addObject:", v4);

}

- (unint64_t)methodsCount
{
  return -[NSMutableArray count](self->_methods, "count");
}

- (id)methodsAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_methods, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[PKProtobufShippingMethods description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PKProtobufShippingMethods dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_methods, "count"))
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_methods, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("methods"));
  }
  defaultMethod = self->_defaultMethod;
  if (defaultMethod)
  {
    -[PKProtobufShippingMethod dictionaryRepresentation](defaultMethod, "dictionaryRepresentation");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v12, CFSTR("defaultMethod"));
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[PKProtobufShippingMethods methodsCount](self, "methodsCount"))
  {
    objc_msgSend(v8, "clearMethods");
    v4 = -[PKProtobufShippingMethods methodsCount](self, "methodsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[PKProtobufShippingMethods methodsAtIndex:](self, "methodsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addMethods:", v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addMethods:", v11);
  ...
  v12 = -[PKProtobufShippingMethod copyWithZone:](self->_defaultMethod, "copyWithZone:", a3);
  v13 = (void *)v5[1];
  v5[1] = v12;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](methods, "isEqual:")))
  {
    ...
    if ((unint64_t)defaultMethod | v4[1])
      v7 = -[PKProtobufShippingMethod isEqual:](defaultMethod, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_methods, "hash");
  return -[PKProtobufShippingMethod hash](self->_defaultMethod, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v13 != v8)
          objc_enumerationMutation(v5);
        -[PKProtobufShippingMethods addMethods:](self, "addMethods:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
...
{
  objc_storeStrong((id *)&self->_defaultMethod, a3);
}
