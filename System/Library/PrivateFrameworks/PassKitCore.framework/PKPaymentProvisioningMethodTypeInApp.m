...
- (PKPaymentProvisioningMethodTypeInApp)init
{
  ...
  return -[PKPaymentProvisioningMethod initWithType:](&v3, sel_initWithType_, 16);
}

- (PKPaymentProvisioningMethodTypeInApp)initWithDictionary:(id)a3
{
  id v4;
  PKPaymentProvisioningMethodTypeInApp *v5;
  void *v6;
  void *v7;
  uint64_t v8;
  NSURL *appLaunchURL;
  ...
  void *v12;
  PKPaymentProvisioningMethodTypeInApp *v13;
  uint64_t v14;
  NSArray *cardTypeSupport;
  _QWORD v17[4];
  PKPaymentProvisioningMethodTypeInApp *v18;
  objc_super v19;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = objc_alloc_init(PKPaymentProvisioningMethodTypeInApp);
