...
{
  PKPeerPaymentPendingRequestPerformActionResponse *v3;
  PKPeerPaymentPendingRequestPerformActionResponse *v4;
  void *v5;
  id v6;
  uint64_t v7;
  NSObject *status;
    ...
    else
    {
      ...
      if (os_log_type_enabled(status, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v17 = 2114;
        v18 = v12;
        _os_log_impl(&dword_18FC92000, status, OS_LOG_TYPE_DEFAULT, "Malformed %{public}@: expected dictionary and received %{public}@", buf, 0x16u);
