...
{
  PKAccountWebServiceInstallmentAuthorizationResponse *v3;
  PKAccountWebServiceInstallmentAuthorizationResponse *v4;
  void *v5;
  uint64_t v6;
  NSString *authorizationToken;
  PKAccountWebServiceInstallmentAuthorizationResponse *v8;
  NSObject *v9;
  objc_class *v10;
  void *v11;
  objc_class *v12;
...
LABEL_11:
  ...
  objc_msgSend(v5, "PKStringForKey:", CFSTR("authorizationToken"));
  ...
  if (!v4->_authorizationToken)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v11;
      _os_log_impl(&dword_18FC92000, v9, OS_LOG_TYPE_DEFAULT, "Malformed %{public}@: expected authorizationToken", buf, 0xCu);
      goto LABEL_10;
    }
    goto LABEL_11;
  }
