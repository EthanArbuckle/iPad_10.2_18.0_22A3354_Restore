...
LABEL_21:
  ...
  if (v10)
  {
    ...
    else
    {
      ...
      {
        v14 = (id)objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v11 + 3);
        if (v14)
        {
          v15 = v14;
          v16 = (uint64_t)v11 + *v11 + 12;
          v17 = (id)objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v16, v11[1]);
          if (v17)
          {
            v18 = v17;
            v19 = (id)objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v16 + v11[1], v11[2]);
            if (v19)
            {
              v20 = v19;
