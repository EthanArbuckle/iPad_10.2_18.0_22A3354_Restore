...
{
  PKAccountWebServiceAccountsResponse *v3;
  PKAccountWebServiceAccountsResponse *v4;
  void *v5;
  uint64_t v6;
  ...
  PKAccountWebServiceAccountsResponse *v23;
  NSObject *v24;
  objc_class *v25;
  void *v26;
  objc_class *v27;
  ...
  if (v3)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      objc_msgSend(v5, "objectForKey:", CFSTR("accounts"));
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              v16 = [PKAccount alloc];
              v17 = -[PKAccount initWithDictionary:](v16, "initWithDictionary:", v15, (_QWORD)v35);
              if (v17)
