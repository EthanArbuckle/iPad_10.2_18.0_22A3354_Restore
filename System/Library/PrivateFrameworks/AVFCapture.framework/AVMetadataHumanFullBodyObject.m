...
{
  return (AVMetadataHumanFullBodyObject *)(id)objc_msgSend(objc_alloc((Class)objc_opt_class()), "initWithFigEmbeddedCaptureDeviceObjectDictionary:input:timeStamp:", a3, a4, a5);
}
...
- (AVMetadataHumanFullBodyObject)initWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5
{
  ...
  return -[AVMetadataBodyObject initWithFigEmbeddedCaptureDeviceObjectDictionary:input:timeStamp:type:](&v6, sel_initWithFigEmbeddedCaptureDeviceObjectDictionary_input_timeStamp_type_, a3, a4, a5, CFSTR("humanFullBody"));
}
...
- (id)initDerivedMetadataObjectFromMetadataObject:(id)a3 withTransform:(CGAffineTransform *)a4 isVideoMirrored:(BOOL)a5 rollAdjustment:(double)a6
{
  ...
  v14[1] = v12;
  v14[2] = *(_OWORD *)&a4->tx;
  return -[AVMetadataBodyObject initDerivedMetadataObjectFromMetadataObject:withTransform:isVideoMirrored:rollAdjustment:type:bodyID:](&v15, sel_initDerivedMetadataObjectFromMetadataObject_withTransform_isVideoMirrored_rollAdjustment_type_bodyID_, a3, v14, v7, CFSTR("humanFullBody"), v11, a6);
}
