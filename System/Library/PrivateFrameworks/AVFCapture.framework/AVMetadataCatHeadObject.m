...
{
  return (id)objc_msgSend(objc_alloc((Class)objc_opt_class()), "initWithFigEmbeddedCaptureDeviceObjectDictionary:input:timeStamp:type:", a3, a4, a5, CFSTR("catHead"));
}
...
- (id)initDerivedMetadataObjectFromMetadataObject:(id)a3 withTransform:(CGAffineTransform *)a4 isVideoMirrored:(BOOL)a5 rollAdjustment:(double)a6
{
  ...
  if (AVMetadataObjectAdjustBaseClassProperties((uint64_t)v20, &v21, v11, v12, v13, v14))
  {
    ...
    return -[AVMetadataObject initWithType:time:duration:bounds:optionalInfoDict:originalMetadataObject:sourceCaptureInput:](&v17, sel_initWithType_time_duration_bounds_optionalInfoDict_originalMetadataObject_sourceCaptureInput_, CFSTR("catHead"), v19, v18, 0, a3, v16, *(_OWORD *)&v21.origin, *(_OWORD *)&v21.size);
  }
  else
  {
