@implementation ZN10TRawSymbolI9Pointer64E14is

unsigned int **___ZN10TRawSymbolI9Pointer64E14is_objc_methodEv_block_invoke(uint64_t a1)
{
  unsigned int **result;
  unsigned int v3;
  ...
  v3 = atomic_load((unsigned int *)result + 7);
  if ((v3 & 0x1000000) == 0)
  {
...
CSCppBitLock *___ZN10TRawSymbolI9Pointer64E14is_objc_methodEv_block_invoke_2(uint64_t a1)
{
  CSCppBitLock *result;
