...
{
  TTRIRecurrenceMonthChooserController *v3;
  uint64_t v4;
...
- (void)updateRecurrenceRuleBuilder:(id)a3
{
  ...
  v7 = a3;
  -[TTRIRecurrenceMonthChooserController monthsOfTheYear](self, "monthsOfTheYear");
...
- (void)updateFromRecurrenceRule:(id)a3
{
  ...
  if (v4)
  {
    ...
    -[TTRIRecurrenceMonthChooserController setMonthsOfTheYear:](self, "setMonthsOfTheYear:", v5);

    -[TTRIRecurrenceMonthChooserController refreshCells](self, "refreshCells");
  }
...
- (id)tableViewCell
{
  ...
  -[TTRIRecurrenceGridChooserController tableViewCell](&v4, sel_tableViewCell);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)cellLabels
{
  ...
  return (id)cellLabels___cellLabels;
}
...
void __50__TTRIRecurrenceMonthChooserController_cellLabels__block_invoke()
{
  ...
  v5 = (void *)cellLabels___cellLabels;
...
- (id)cellAccessibilityLabels
{
  if (cellAccessibilityLabels_onceToken != -1)
    dispatch_once(&cellAccessibilityLabels_onceToken, &__block_literal_global_14);
  return (id)cellAccessibilityLabels___cellAccessibilityLabels;
}
...
void __63__TTRIRecurrenceMonthChooserController_cellAccessibilityLabels__block_invoke()
{
  ...
  v5 = (void *)cellAccessibilityLabels___cellAccessibilityLabels;
...
- (void)prepareForDisplay
{
  ...
  if (!v4)
  {
    -[TTRIRecurrenceChooserController startDateComponents:](self, "startDateComponents:", 8);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[TTRIRecurrenceMonthChooserController setMonthsOfTheYear:](self, "setMonthsOfTheYear:", v7);
...
- (void)selectCell:(id)a3 atIndex:(int64_t)a4
{
  ...
  if (-[NSMutableSet count](self->_monthsOfTheYearSet, "count") != 1 || (objc_msgSend(v6, "selected") & 1) == 0)
  {
    ...
    if (objc_msgSend(v6, "selected")
      && -[TTRIRecurrenceMonthChooserController prohibitsMultipleMonthsInYearlyRecurrence](self, "prohibitsMultipleMonthsInYearlyRecurrence"))
    {
      v11[0] = v7;
      objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v11, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      -[TTRIRecurrenceMonthChooserController setMonthsOfTheYear:](self, "setMonthsOfTheYear:", v8);
