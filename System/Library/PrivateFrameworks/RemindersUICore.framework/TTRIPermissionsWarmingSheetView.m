...
{
  return (_TtC15RemindersUICore31TTRIPermissionsWarmingSheetView *)sub_1B4653034(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC15RemindersUICore31TTRIPermissionsWarmingSheetView)initWithCoder:(id)a3
{
  return (_TtC15RemindersUICore31TTRIPermissionsWarmingSheetView *)sub_1B4653164(a3);
}
