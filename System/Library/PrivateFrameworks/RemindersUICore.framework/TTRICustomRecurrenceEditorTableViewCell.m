...
- (void)layoutSubviews
{
  ...
  -[TTRICustomRecurrenceEditorTableViewCell layoutSubviews](&v3, sel_layoutSubviews);
  -[TTRICustomRecurrenceEditorTableViewCell _layoutSeparator](self, "_layoutSeparator");
}
...
- (void)_layoutSeparator
{
  ...
  if (self->_separatorViewForNonOpaqueTables)
  {
    ...
    v4 = v3;
    -[TTRICustomRecurrenceEditorTableViewCell bounds](self, "bounds");
    v6 = v5;
    v8 = v7;
    v10 = v9;
    v11 = -[TTRICustomRecurrenceEditorTableViewCell usesInsetMargin](self, "usesInsetMargin");
    v12 = 15.0;
    if (!v11)
      v12 = v6;
    -[TTRIRowSeparatorView setFrame:](self->_separatorViewForNonOpaqueTables, "setFrame:", v12, v10 - v4, v8, v4);
  }
}
...
- (void)setUsesInsetMargin:(BOOL)a3
{
  ...
  -[TTRICustomRecurrenceEditorTableViewCell _setMarginExtendsToFullWidth:](self, "_setMarginExtendsToFullWidth:", !a3);
}

- (void)setRowSeparatorColor:(id)a3
{
  TTRIRowSeparatorView *separatorViewForNonOpaqueTables;
  id v6;
  ...
  if (separatorViewForNonOpaqueTables)
    -[TTRIRowSeparatorView setBackgroundColor:](separatorViewForNonOpaqueTables, "setBackgroundColor:", self->_rowSeparatorColor);
...
{
  _BOOL4 v3;
  TTRICustomRecurrenceEditorTableViewCell *v4;
  id v5;
  uint64_t v6;
  ...
  void *v10;
  TTRIRowSeparatorView *separatorViewForNonOpaqueTables;
  TTRIRowSeparatorView *v12;
  TTRIRowSeparatorView *v13;
  void *v14;
  uint64_t v15;
  TTRIRowSeparatorView *v16;
  void *v17;
  ...
  v4 = self;
  v20 = v4;
  if (objc_msgSend((id)objc_opt_class(), "isVibrant"))
  {
    if (v3 && !v4->_rowSeparatorParentView)
    {
      v5 = objc_alloc(MEMORY[0x1E0DC3F58]);
      -[TTRICustomRecurrenceEditorTableViewCell bounds](v4, "bounds");
      ...
      -[TTRICustomRecurrenceEditorTableViewCell rowSeparatorVisualEffect](v4, "rowSeparatorVisualEffect");
      ...
      -[TTRICustomRecurrenceEditorTableViewCell addSubview:](v4, "addSubview:", v4->_rowSeparatorParentView);
    }
  ...
  if (v3)
  {
    if (!separatorViewForNonOpaqueTables)
    {
      ...
      -[TTRIRowSeparatorView setIsVibrant:](v4->_separatorViewForNonOpaqueTables, "setIsVibrant:", objc_msgSend((id)objc_opt_class(), "isVibrant"));
      if (objc_msgSend((id)objc_opt_class(), "isVibrant"))
      {
        -[UIVisualEffectView contentView](v4->_rowSeparatorParentView, "contentView");
      ...
      {
        -[TTRICustomRecurrenceEditorTableViewCell rowSeparatorColor](v4, "rowSeparatorColor");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        if (v14)
          -[TTRICustomRecurrenceEditorTableViewCell rowSeparatorColor](v4, "rowSeparatorColor");
        else
      ...
      v17 = (void *)v15;
      -[TTRIRowSeparatorView setBackgroundColor:](v4->_separatorViewForNonOpaqueTables, "setBackgroundColor:", v15);
  ...
  {
    -[TTRIRowSeparatorView removeFromSuperview](separatorViewForNonOpaqueTables, "removeFromSuperview");
...
- (void)_setMarginExtendsToFullWidth:(BOOL)a3
{
  ...
  if (a3)
    v3 = 0.0;
  -[TTRICustomRecurrenceEditorTableViewCell _setMarginWidth:](self, "_setMarginWidth:", v3);
}
