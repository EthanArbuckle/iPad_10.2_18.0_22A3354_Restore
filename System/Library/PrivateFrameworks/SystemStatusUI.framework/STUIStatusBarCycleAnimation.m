...
- (STUIStatusBarCycleAnimation)initWithLayerAnimations:(id)a3
{
  ...
  v5 = -[STUIStatusBarCycleAnimation init](&v11, sel_init);
...
- (void)dealloc
{
  ...
  -[STUIStatusBarCycleAnimation _stopAnimations](self, "_stopAnimations");
  v3.receiver = self;
  v3.super_class = (Class)STUIStatusBarCycleAnimation;
  -[STUIStatusBarCycleAnimation dealloc](&v3, sel_dealloc);
}

- (STUIStatusBarCycleLayerAnimation)mainLayerAnimation
{
  return (STUIStatusBarCycleLayerAnimation *)-[NSArray firstObject](self->_layerAnimations, "firstObject");
}
...
- (void)start
{
  ...
  if (self->_visible)
  {
    ...
    if (state == 2)
    {
      -[STUIStatusBarCycleAnimation _stopStoppingAnimations](self, "_stopStoppingAnimations");
      -[STUIStatusBarCycleAnimation mainLayerAnimation](self, "mainLayerAnimation");
      ...
      -[STUIStatusBarCycleAnimation _sendCompletionsWithFinished:](self, "_sendCompletionsWithFinished:", 0);

    }
    else if (!state)
    {
      -[STUIStatusBarCycleAnimation _startAnimations](self, "_startAnimations");
    }
  }
  self->_state = 1;
}
...
- (void)stopWithCompletionHandler:(id)a3
{
  ...
  void *v52;
  id v53;
  STUIStatusBarCycleAnimation *v54;
  uint64_t *v55;
  uint64_t *v56;
  uint64_t *v57;
  double v58;
...
double __57__STUIStatusBarCycleAnimation_stopWithCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  *(double *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24) = ceil(*(double *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8)
  ...
  result = *(double *)(a1 + 80) + *(double *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24) * v2;
...
{
  -[STUIStatusBarCycleAnimation _stopAnimations](self, "_stopAnimations", a3, a4);
  if (self->_state == 2)
  {
    self->_state = 0;
    -[STUIStatusBarCycleAnimation _sendCompletionsWithFinished:](self, "_sendCompletionsWithFinished:", 1);
  }
}
...
{
  return (NSString *)-[STUIStatusBarCycleAnimation descriptionWithMultilinePrefix:](self, "descriptionWithMultilinePrefix:", 0);
}

- (NSString)debugDescription
{
  return (NSString *)-[STUIStatusBarCycleAnimation debugDescriptionWithMultilinePrefix:](self, "debugDescriptionWithMultilinePrefix:", 0);
}
...
- (id)succinctDescription
{
  ...
  -[STUIStatusBarCycleAnimation succinctDescriptionBuilder](self, "succinctDescriptionBuilder");
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  ...
  -[STUIStatusBarCycleAnimation descriptionBuilderWithMultilinePrefix:](self, "descriptionBuilderWithMultilinePrefix:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  ...
  -[STUIStatusBarCycleAnimation _descriptionBuilderWithMultilinePrefix:forDebug:](self, "_descriptionBuilderWithMultilinePrefix:forDebug:", a3, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "build");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return -[STUIStatusBarCycleAnimation _descriptionBuilderWithMultilinePrefix:forDebug:](self, "_descriptionBuilderWithMultilinePrefix:forDebug:", a3, 0);
}
...
- (id)_descriptionBuilderWithMultilinePrefix:(id)a3 forDebug:(BOOL)a4
{
  ...
  v8 = -[STUIStatusBarCycleAnimation state](self, "state");
  if (v8 > 2)
    v9 = CFSTR("(unknown)");
  else
    v9 = off_1E8D63B38[v8];
  objc_msgSend(v7, "appendString:withName:", v9, CFSTR("state"));
  -[STUIStatusBarCycleAnimation layerAnimations](self, "layerAnimations");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "appendArraySection:withName:skipIfEmpty:", v10, CFSTR("layerAnimations"), 1);
