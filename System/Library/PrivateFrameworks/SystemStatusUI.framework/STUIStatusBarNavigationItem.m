...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", *MEMORY[0x1E0DB0C90]);
}
...
- (id)createDisplayItemForIdentifier:(id)a3
{
  ...
  -[STUIStatusBarItem createDisplayItemForIdentifier:](&v6, sel_createDisplayItemForIdentifier_, a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  +[STUIStatusBarSystemNavigationAction backNavigationAction](STUIStatusBarSystemNavigationAction, "backNavigationAction");
...
- (STUIStatusBarStringView)nameView
{
  ...
  if (!nameView)
  {
    -[STUIStatusBarNavigationItem _create_nameView](self, "_create_nameView");
    nameView = self->_nameView;
  }
  return nameView;
}
...
- (void)_create_nameView
{
  ...
  -[STUIStatusBarStringView setContentCompressionResistancePriority:forAxis:](self->_nameView, "setContentCompressionResistancePriority:forAxis:", 0, v6);
  -[STUIStatusBarStringView setAccessibilityIdentifier:](self->_nameView, "setAccessibilityIdentifier:", CFSTR("breadcrumb"));
}
...
- (id)applyUpdate:(id)a3 toDisplayItem:(id)a4
{
  ...
  -[STUIStatusBarItem applyUpdate:toDisplayItem:](&v19, sel_applyUpdate_toDisplayItem_, v6, a4);
  ...
  if ((objc_msgSend(v6, "dataChanged") & 1) != 0 || objc_msgSend(v6, "styleAttributesChanged"))
  {
    ...
    -[STUIStatusBarNavigationItem nameView](self, "nameView");
