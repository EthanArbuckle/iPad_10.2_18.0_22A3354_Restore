...
{
  return (id)*MEMORY[0x1E0DB0D10];
}

+ (STUIStatusBarIdentifier)emphasizedQuietModeIdentifier
{
  return (STUIStatusBarIdentifier *)objc_msgSend(a1, "displayItemIdentifierFromString:", CFSTR("emphasizedQuietModeIdentifier"));
}
...
- (id)viewForIdentifier:(id)a3
{
  ...
  if (v5 == v4)
  {
    -[STUIStatusBarIndicatorQuietModeItem emphasizedImageView](self, "emphasizedImageView");
...
- (STUIStatusBarImageView)emphasizedImageView
{
  ...
  {
    -[STUIStatusBarIndicatorQuietModeItem _create_emphasizedImageView](self, "_create_emphasizedImageView");
    emphasizedImageView = self->_emphasizedImageView;
  }
...
- (void)_create_emphasizedImageView
{
  ...
  -[STUIStatusBarImageView setFontStyle:](self->_emphasizedImageView, "setFontStyle:", 1);
}
...
- (id)imageViewForIdentifier:(id)a3
{
  ...
  else
  {
    v9.receiver = self;
    v9.super_class = (Class)STUIStatusBarIndicatorQuietModeItem;
    -[STUIStatusBarIndicatorItem imageViewForIdentifier:](&v9, sel_imageViewForIdentifier_, v4);
    v6 = objc_claimAutoreleasedReturnValue();
  }
  v7 = (void *)v6;
...
- (BOOL)shouldUpdateIndicatorForIdentifier:(id)a3
{
  ...
  else
  {
    ...
    v6 = -[STUIStatusBarIndicatorItem shouldUpdateIndicatorForIdentifier:](&v8, sel_shouldUpdateIndicatorForIdentifier_, v4);
  }
...
- (id)applyUpdate:(id)a3 toDisplayItem:(id)a4
{
  ...
  if (objc_msgSend(v6, "dataChanged"))
  {
    ...
    -[STUIStatusBarIndicatorQuietModeItem imageViewForIdentifier:](self, "imageViewForIdentifier:", v14);
    ...
    -[STUIStatusBarIndicatorQuietModeItem setFocusName:](self, "setFocusName:", v18);
