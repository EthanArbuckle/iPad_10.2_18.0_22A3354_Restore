...
- (STUIStatusBarLockView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[STUIStatusBarLockView addSubview:](v3, "addSubview:", v3->_shackleView);
    v6 = -[STUIStatusBarImageView initWithFrame:]([STUIStatusBarImageView alloc], "initWithFrame:", 0.0, 6.0, 8.0, 6.0);
    bodyView = v3->_bodyView;
    v3->_bodyView = v6;

    -[STUIStatusBarLockView addSubview:](v3, "addSubview:", v3->_bodyView);
  }
  return v3;
}
...
- (void)applyStyleAttributes:(id)a3
{
  ...
  v12 = a3;
  -[STUIStatusBarImageView image](self->_shackleView, "image");
  ...
  if (!v4)
  {
    ...
    -[STUIStatusBarImageView setImage:](self->_shackleView, "setImage:", v7);
  }
  -[STUIStatusBarImageView applyStyleAttributes:](self->_shackleView, "applyStyleAttributes:", v12);
  -[STUIStatusBarImageView image](self->_bodyView, "image");
  ...
  if (!v8)
  {
    ...
    -[STUIStatusBarImageView setImage:](self->_bodyView, "setImage:", v11);
  }
  -[STUIStatusBarImageView applyStyleAttributes:](self->_bodyView, "applyStyleAttributes:", v12);
...
- (void)resetLock
{
  ...
  -[STUIStatusBarImageView layer](self->_shackleView, "layer");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "removeAllAnimations");

  -[STUIStatusBarLockView layer](self, "layer");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "removeAllAnimations");

  -[STUIStatusBarImageView setFrame:](self->_shackleView, "setFrame:", 1.0, 2.0, 6.0, 7.0);
}
...
- (void)jiggleWithCompletionBlock:(id)a3
{
  ...
  else
  {
    ...
    -[STUIStatusBarLockView setCompletionBlock:](self, "setCompletionBlock:", v4);
    -[STUIStatusBarLockView layer](self, "layer");
