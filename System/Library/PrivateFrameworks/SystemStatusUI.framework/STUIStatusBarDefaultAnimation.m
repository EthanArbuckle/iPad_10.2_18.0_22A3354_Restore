@implementation STUIStatusBarDefaultAnimation
...
LABEL_7:
  ...
  v27[1] = v16;
  v27[2] = *(_OWORD *)(a1 + 80);
  objc_msgSend(v7, "setTransform:", v27);
  v14 = (void *)MEMORY[0x1E0DC3F10];
  v17 = 104;
  if (v9 == 1)
    v17 = 96;
...
LABEL_8:
  ...
  v26 = *(_OWORD *)(a1 + 80);
  v20 = v7;
  objc_msgSend(v14, "animateWithDuration:delay:options:animations:completion:", 0, v21, v8, v15, v18);
