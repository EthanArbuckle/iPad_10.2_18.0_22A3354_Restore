...
{
  STUIStatusBarSpacerDisplayItem *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)STUIStatusBarSpacerDisplayItem;
  result = -[STUIStatusBarDisplayItem initWithIdentifier:item:](&v5, sel_initWithIdentifier_item_, a3, a4);
...
- (void)applyUpdate:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6 != self->_size.width || v7 != self->_size.height)
    {
      ...
      -[STUIStatusBarSpacerDisplayItem _applyConstraintsIfNeeded](self, "_applyConstraintsIfNeeded");
    }
  }
...
- (void)setContainerView:(id)a3
{
  ...
  if (v5 != v4)
  {
    ...
    -[STUIStatusBarDisplayItem setContainerView:](&v7, sel_setContainerView_, v4);
    -[STUIStatusBarSpacerDisplayItem _applyConstraintsIfNeeded](self, "_applyConstraintsIfNeeded");
  }
