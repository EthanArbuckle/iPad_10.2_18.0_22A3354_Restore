...
- (void)applyStyleAttributes:(id)a3
{
  ...
  v4 = a3;
  -[STUIStatusBarImageView applyStyleAttributes:](&v7, sel_applyStyleAttributes_, v4);
...
{
  void *v5;
  STUIStatusBarFocusableImageView *v6;

  objc_msgSend(a3, "nextFocusedItem");
  v6 = (STUIStatusBarFocusableImageView *)objc_claimAutoreleasedReturnValue();
  if (v6 == self)
  {
    -[STUIStatusBarFocusableImageView focusedImageTintColor](self, "focusedImageTintColor");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[STUIStatusBarFocusableImageView setTintColor:](self, "setTintColor:", v5);

  }
  else
  {
    -[STUIStatusBarFocusableImageView setTintColor:](self, "setTintColor:", self->_unfocusedTintColor);
  }
