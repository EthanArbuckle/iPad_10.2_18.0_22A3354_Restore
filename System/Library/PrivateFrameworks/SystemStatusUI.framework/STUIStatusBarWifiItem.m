...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", *MEMORY[0x1E0DB0D90]);
}
...
+ (id)groupWithPriority:(int64_t)a3
{
  ...
  +[STUIStatusBarDisplayItemPlacement placementWithIdentifier:priority:](STUIStatusBarDisplayItemPlacement, "placementWithIdentifier:priority:", v5, 2);
  ...
  +[STUIStatusBarDisplayItemPlacement placementWithIdentifier:priority:](STUIStatusBarDisplayItemPlacement, "placementWithIdentifier:priority:", v11, 1);
  ...
  +[STUIStatusBarDisplayItemPlacementGroup groupWithPriority:placements:](STUIStatusBarDisplayItemPlacementWifiGroup, "groupWithPriority:placements:", a3, v13);
...
- (id)applyUpdate:(id)a3 toDisplayItem:(id)a4
{
  ...
  -[STUIStatusBarItem applyUpdate:toDisplayItem:](&v34, sel_applyUpdate_toDisplayItem_, v6, v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v11 == v12)
  {
    ...
    -[STUIStatusBarWifiItem signalView](self, "signalView");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v7, "isEnabled"))
    {
      if ((objc_msgSend(v6, "styleAttributesChanged") & 1) != 0 || objc_msgSend(v6, "dataChanged"))
      {
        -[STUIStatusBarWifiItem _backgroundColorForUpdate:entry:](self, "_backgroundColorForUpdate:entry:", v6, v10);
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setInactiveColor:", v20);

        -[STUIStatusBarWifiItem _fillColorForUpdate:entry:](self, "_fillColorForUpdate:entry:", v6, v10);
      ...
      if (objc_msgSend(v6, "dataChanged"))
      {
        ...
        if (objc_msgSend(v7, "isEnabled"))
        {
          v32 = objc_msgSend(v10, "displayValue");
          if (v26)
            objc_msgSend(v19, "setNumberOfActiveBars:", v32);
    ...
    switch(v28)
    {
      case 5:
        if (objc_msgSend(v10, "type") == 1)
        {
          ...
          v30 = CFSTR("personalhotspot");
          goto LABEL_36;
        }
        break;
      case 4:
        v29 = (void *)MEMORY[0x1E0DC3870];
        v30 = CFSTR("wifi.exclamationmark");
        goto LABEL_36;
      case 1:
        v29 = (void *)MEMORY[0x1E0DC3870];
        v30 = CFSTR("wifi.slash");
LABEL_36:
        objc_msgSend(v29, "systemImageNamed:", v30);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        -[STUIStatusBarWifiItem networkIconView](self, "networkIconView");
  ...
  if (v15 == v16)
  {
    ...
    if (objc_msgSend(v7, "isEnabled"))
    {
      ...
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      -[STUIStatusBarWifiItem rawStringView](self, "rawStringView");
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v31, "setText:", v19);
LABEL_37:
...
- (STUIStatusBarWifiSignalView)signalView
{
  ...
  if (!signalView)
  {
    -[STUIStatusBarWifiItem _create_signalView](self, "_create_signalView");
    signalView = self->_signalView;
  }
  return signalView;
}
...
{
  STUIStatusBarWifiSignalView *v3;
  STUIStatusBarWifiSignalView *v4;
  STUIStatusBarWifiSignalView *signalView;

  v3 = [STUIStatusBarWifiSignalView alloc];
  v4 = -[STUIStatusBarWifiSignalView initWithFrame:](v3, "initWithFrame:", *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
  signalView = self->_signalView;
  self->_signalView = v4;

  -[STUIStatusBarSignalView setNumberOfBars:](self->_signalView, "setNumberOfBars:", 3);
}
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        -[STUIStatusBarItem viewForIdentifier:](&v11, sel_viewForIdentifier_, v4);
        v8 = objc_claimAutoreleasedReturnValue();
      }
    }
  }
...
- (STUIStatusBarImageView)networkIconView
{
  ...
  if (!networkIconView)
  {
    -[STUIStatusBarWifiItem _create_networkIconView](self, "_create_networkIconView");
    networkIconView = self->_networkIconView;
  }
...
- (STUIStatusBarStringView)rawStringView
{
  ...
  if (!rawStringView)
  {
    -[STUIStatusBarWifiItem _create_rawStringView](self, "_create_rawStringView");
    rawStringView = self->_rawStringView;
  }
