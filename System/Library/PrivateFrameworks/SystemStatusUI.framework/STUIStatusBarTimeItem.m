...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", *MEMORY[0x1E0DB0D70], *MEMORY[0x1E0DB0D48], *MEMORY[0x1E0DB0CC0], 0);
}
...
- (id)viewForIdentifier:(id)a3
{
  ...
  if (v5 == v4)
  {
    -[STUIStatusBarTimeItem timeView](self, "timeView");
  ...
  else
  {
    ...
    if (v6 == v4)
    {
      -[STUIStatusBarTimeItem shortTimeView](self, "shortTimeView");
      v9 = objc_claimAutoreleasedReturnValue();
    }
    else
    {
      ...
      if (v7 == v4)
      {
        -[STUIStatusBarTimeItem pillTimeView](self, "pillTimeView");
        v9 = objc_claimAutoreleasedReturnValue();
      }
      else
      {
        ...
        if (v8 == v4)
        {
          -[STUIStatusBarTimeItem dateView](self, "dateView");
          v9 = objc_claimAutoreleasedReturnValue();
        }
        else
        {
...
- (STUIStatusBarStringView)dateView
{
  ...
  if (!dateView)
  {
    -[STUIStatusBarTimeItem _create_dateView](self, "_create_dateView");
    dateView = self->_dateView;
  }
  return dateView;
}
...
- (STUIStatusBarStringView)pillTimeView
{
  ...
  if (!pillTimeView)
  {
    -[STUIStatusBarTimeItem _create_pillTimeView](self, "_create_pillTimeView");
    pillTimeView = self->_pillTimeView;
  }
  return pillTimeView;
}
...
- (void)_create_pillTimeView
{
  ...
  -[STUIStatusBarStringView setFontStyle:](self->_pillTimeView, "setFontStyle:", 1);
  -[STUIStatusBarStringView setAdjustsFontSizeToFitWidth:](self->_pillTimeView, "setAdjustsFontSizeToFitWidth:", 1);
  -[STUIStatusBarStringView setBaselineAdjustment:](self->_pillTimeView, "setBaselineAdjustment:", 1);
  LODWORD(v6) = 1132003328;
  -[STUIStatusBarStringView setContentCompressionResistancePriority:forAxis:](self->_pillTimeView, "setContentCompressionResistancePriority:forAxis:", 0, v6);
}
...
- (STUIStatusBarStringView)timeView
{
  ...
  if (!timeView)
  {
    -[STUIStatusBarTimeItem _create_timeView](self, "_create_timeView");
    timeView = self->_timeView;
  }
  return timeView;
}
...
- (void)_create_timeView
{
  ...
  -[STUIStatusBarStringView setFontStyle:](self->_timeView, "setFontStyle:", 1);
  -[STUIStatusBarStringView setAdjustsFontSizeToFitWidth:](self->_timeView, "setAdjustsFontSizeToFitWidth:", 1);
}
...
{
  return (STUIStatusBarIdentifier *)objc_msgSend(a1, "displayItemIdentifierFromString:", CFSTR("shortTimeDisplayIdentifier"));
}
...
- (STUIStatusBarStringView)shortTimeView
{
  ...
  if (!shortTimeView)
  {
    -[STUIStatusBarTimeItem _create_shortTimeView](self, "_create_shortTimeView");
    shortTimeView = self->_shortTimeView;
  }
...
{
  return (STUIStatusBarIdentifier *)objc_msgSend(a1, "displayItemIdentifierFromString:", CFSTR("timeDisplayIdentifier"));
}
...
- (void)_create_shortTimeView
{
  ...
  -[STUIStatusBarStringView setFontStyle:](self->_shortTimeView, "setFontStyle:", 1);
  -[STUIStatusBarStringView setAdjustsFontSizeToFitWidth:](self->_shortTimeView, "setAdjustsFontSizeToFitWidth:", 1);
}
...
{
  return (STUIStatusBarIdentifier *)objc_msgSend(a1, "displayItemIdentifierFromString:", CFSTR("pillTimeDisplayIdentifier"));
}

+ (STUIStatusBarIdentifier)dateDisplayIdentifier
{
  return (STUIStatusBarIdentifier *)objc_msgSend(a1, "displayItemIdentifierFromString:", CFSTR("dateDisplayIdentifier"));
}
