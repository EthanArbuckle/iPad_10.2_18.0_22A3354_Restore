...
{
  PBUndoInteractionHUDTextPasteButtonTag *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)PBUndoInteractionHUDTextPasteButtonTag;
  result = -[PBUndoInteractionHUDTextPasteButtonTag init](&v5, sel_init);
  if (result)
    result->_minWidth = a3;
  return result;
}
...
{
  id v4;
  PBUndoInteractionHUDTextPasteButtonTag *v5;
  double v6;
  objc_super v8;
...
- (unint64_t)hash
{
  return +[PBUndoInteractionHUDTextPasteButtonTag hash](PBUndoInteractionHUDTextPasteButtonTag, "hash") ^ (unint64_t)self->_minWidth;
}
...
void __64__PBUndoInteractionHUDTextPasteButtonTag_resolvedStyleForStyle___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v3, "setLayoutDirection:", 0);
  ...
  objc_msgSend(v3, "setUserInterfaceIdiom:", 0);
...
- (id)_acceptCalloutBarPasteButtonTagVisit:(id)a3 systemInputAssistantPasteButtonTagVisit:(id)a4 undoInteractionHUDIconPasteButtonTagVisit:(id)a5 undoInteractionHUDTextPasteButtonTagVisit:(id)a6 contextMenuPasteButtonTagVisit:(id)a7 editMenuPasteButtonTagVisit:(id)a8
{
  if (!a6)
    return 0;
  (*((void (**)(id, PBUndoInteractionHUDTextPasteButtonTag *, id, id, id))a6 + 2))(a6, self, a3, a4, a5);
