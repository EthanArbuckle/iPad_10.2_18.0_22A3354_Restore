@implementation CRConnectBluetoothLE
...
void __CRConnectBluetoothLE_block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v11 = v5;
  v8 = v5;
  objc_msgSend(a2, "startBluetoothLEPairingForIdentifier:deviceName:reply:", v6, v7, v9);
...
void __CRConnectBluetoothLE_block_invoke_3_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1A83A2000, v0, v1, "CRConnectBluetoothLE failed to call carkitd: %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
