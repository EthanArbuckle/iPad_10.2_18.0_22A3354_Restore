...
- (void)deleteCache
{
  OUTLINED_FUNCTION_0_0(&dword_20DB2C000, a2, a3, "\"Cleared RK cache with error: %@\", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_4();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_20DB2C000, a1, a3, "\"Cached RK with error: %@\", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_4();
}
...
- (void)fetchRecoveryKeyFromCacheForAltDSID:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_20DB2C000, a2, OS_LOG_TYPE_ERROR, "\"Failed to fetch RK from cache: %@\", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_4();
}
