...
- (_SUICAtomRanged)initWithEditRange:(_NSRange)a3 replacementText:(id)a4
{
  ...
  v8 = -[_SUICAtomRanged init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    -[_SUICAtomRanged setEditRange:](v8, "setEditRange:", location, length);
    -[_SUICAtomRanged setReplacementText:](v9, "setReplacementText:", v7);
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v4 == self)
    ...
    v6 = v4
      ...
      && -[_SUICAtomRanged isEqualToEditScriptAtomRanged:](self, "isEqualToEditScriptAtomRanged:", v5);
...
- (BOOL)isEqualToEditScriptAtomRanged:(id)a3
{
  ...
  if (self == v4)
  {
    v15 = 1;
         ...
         && (v6 = -[_SUICAtomRanged editRange](self, "editRange"), v6 == -[_SUICAtomRanged editRange](v5, "editRange"))
         && (-[_SUICAtomRanged editRange](self, "editRange"),
             v8 = v7,
             -[_SUICAtomRanged editRange](v5, "editRange"),
             v8 == v9))
  {
    -[_SUICAtomRanged replacementText](self, "replacementText");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[_SUICAtomRanged replacementText](v5, "replacementText");
...
+ (id)atomWithEditRange:(_NSRange)a3 replacementText:(id)a4
{
  ...
  location = a3.location;
  v6 = a4;
  v7 = -[_SUICAtomRanged initWithEditRange:replacementText:]([_SUICAtomRanged alloc], "initWithEditRange:replacementText:", location, length, v6);
