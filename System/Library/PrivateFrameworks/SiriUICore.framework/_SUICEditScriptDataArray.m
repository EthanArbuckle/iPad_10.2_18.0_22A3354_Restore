...
{
  id v6;
  _SUICEditScriptDataArray *v7;
  _SUICEditScriptDataArray *v8;
  unint64_t v9;
  uint64_t v10;
  NSArray *v11;
  uint64_t v12;
  ...
  uint64_t v37;
  _QWORD v38[4];
  _SUICEditScriptDataArray *v39;
  objc_super v40;

  v6 = a3;
  v40.receiver = self;
  v40.super_class = (Class)_SUICEditScriptDataArray;
  v7 = -[_SUICEditScriptDataArray init](&v40, sel_init);
  v8 = v7;
  if (v7)
  {
    -[_SUICEditScriptDataArray setCachedStringValue:](v7, "setCachedStringValue:", v6);
    ...
    if (a4 == 1)
    {
      ...
      if (v9)
      {
        ...
        do
        {
          v22 = IsCharacterAtIndexMemberOfCharacterSet(v6, &v37, v14[61].vtable);
          v23 = v22;
          v24 = v37;
          if ((v22 & 1) != 0 || v37 == v21)
          {
...
- (_SUICEditScriptDataArray)initWithArray:(id)a3
{
  ...
  v5 = -[_SUICEditScriptDataArray init](&v9, sel_init);
  if (v5)
  {
...
{
  id v5;
  _SUICEditScriptDataArray *v6;

  v5 = a3;
  v6 = -[_SUICEditScriptDataArray initWithString:chunkSize:]([_SUICEditScriptDataArray alloc], "initWithString:chunkSize:", v5, a4);
...
{
  id v3;
  _SUICEditScriptDataArray *v4;

  v3 = a3;
  v4 = -[_SUICEditScriptDataArray initWithArray:]([_SUICEditScriptDataArray alloc], "initWithArray:", v3);
...
- (id)stringValue
{
  ...
  {
    -[NSArray componentsJoinedByString:](self->_data, "componentsJoinedByString:", &stru_1E4A55AD0);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    -[_SUICEditScriptDataArray setCachedStringValue:](self, "setCachedStringValue:", v4);
...
- (int64_t)characterIndexForItem:(int64_t)a3
{
  ...
  v6 = 0;
  do
    v6 += -[_SUICEditScriptDataArray lengthOfItem:](self, "lengthOfItem:", v5++);
  while (a3 != v5);
  return v6;
}
...
- (int64_t)indexOfFirstDifferenceWithOtherData:(id)a3 shouldReverseIterate:(BOOL)a4 fallsOnWordBoundary:(BOOL *)a5
{
  ...
  v6 = a4;
  v8 = a3;
  v9 = -[_SUICEditScriptDataArray length](self, "length");
  ...
  while (1)
  {
    v17 = v6 ? v16 : v13;
    v18 = v6 ? v15 : v13;
    -[_SUICEditScriptDataArray stringAtIndex:](self, "stringAtIndex:", v17, v28, v29, v30);
