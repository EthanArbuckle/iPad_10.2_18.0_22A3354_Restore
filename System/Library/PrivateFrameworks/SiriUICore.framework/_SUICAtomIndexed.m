...
- (_SUICAtomIndexed)initWithEditOperation:(int64_t)a3 indexToEdit:(unint64_t)a4 newText:(id)a5 indexInArrayB:(unint64_t)a6
{
  ...
  v11 = -[_SUICAtomIndexed init](&v14, sel_init);
  v12 = v11;
  if (v11)
  {
    -[_SUICAtomIndexed setEditOperation:](v11, "setEditOperation:", a3);
    -[_SUICAtomIndexed setIndexToEdit:](v12, "setIndexToEdit:", a4);
    -[_SUICAtomIndexed setIndexInArrayB:](v12, "setIndexInArrayB:", a6);
    -[_SUICAtomIndexed setReplacementText:](v12, "setReplacementText:", v10);
  }
...
{
  id v9;
  _SUICAtomIndexed *v10;

  v9 = a5;
  v10 = -[_SUICAtomIndexed initWithEditOperation:indexToEdit:newText:indexInArrayB:]([_SUICAtomIndexed alloc], "initWithEditOperation:indexToEdit:newText:indexInArrayB:", a3, a4, v9, a6);
