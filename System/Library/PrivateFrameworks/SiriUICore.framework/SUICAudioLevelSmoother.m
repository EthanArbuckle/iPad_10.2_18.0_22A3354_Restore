...
{
  SUICAudioLevelSmoother *result;

  result = -[SUICAudioLevelSmoother _initWithHistoryLength:](self, "_initWithHistoryLength:", a5);
  if (result)
  {
...
{
  SUICAudioLevelSmoother *v4;
  float *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)SUICAudioLevelSmoother;
  v4 = -[SUICAudioLevelSmoother init](&v7, sel_init);
  if (v4)
  {
...
- (void)dealloc
{
  ...
  -[SUICAudioLevelSmoother dealloc](&v3, sel_dealloc);
}
