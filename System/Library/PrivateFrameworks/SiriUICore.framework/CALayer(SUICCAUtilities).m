...
- (__CFString)_suic_additiveAnimationKeyPrefixForKeyPath:()SUICCAUtilities
{
  ...
  v3 = a3;
  v4 = CFSTR("com.apple.VoiceShorcutsUI.additive");
  if (objc_msgSend(v3, "length"))
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@.%@"), CFSTR("com.apple.VoiceShorcutsUI.additive"), v3);
...
- (id)_suic_nextAdditiveAnimationKeyWithKeyPath:()SUICCAUtilities
{
  ...
  v4 = a3;
  objc_getAssociatedObject(a1, &_SUICAdditiveAnimationKeyPrefix);
...
LABEL_3:
    ...
    while (1)
    {
      ...
      if ((objc_msgSend(*(id *)(*((_QWORD *)&v17 + 1) + 8 * v11), "hasPrefix:", CFSTR("com.apple.VoiceShorcutsUI.additive")) & 1) != 0)break;
      if (v9 == ++v11)
      {
...
LABEL_9:
  ...
  objc_msgSend(a1, "_suic_additiveAnimationKeyPrefixForKeyPath:", v4);
...
- (id)_suic_addAdditiveAnimation:()SUICCAUtilities withKeyPath:
{
  ...
  {
    v6 = a3;
    objc_msgSend(a1, "_suic_nextAdditiveAnimationKeyWithKeyPath:", a4);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
