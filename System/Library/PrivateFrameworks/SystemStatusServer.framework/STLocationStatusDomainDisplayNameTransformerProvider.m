...
{
  STLocationStatusDomainDisplayNameTransformerProvider *v2;
  uint64_t v3;
  ...
  v2 = -[STLocationStatusDomainDisplayNameTransformerProvider init](&v8, sel_init);
  if (v2)
  {
...
- (id)dataTransformerForClient:(id)a3
{
  ...
  NSMutableDictionary *entityResolversByLocalization;
  STLocationStatusDomainDisplayNameTransformer *v10;
  void *v11;
  ...
  v7 = (STLocationStatusDomainDisplayNameTransformer *)objc_claimAutoreleasedReturnValue();
  if (!v7)
  {
    ...
    v10 = [STLocationStatusDomainDisplayNameTransformer alloc];
    -[STAttributedEntityResolver beginBatchResolutionSession](v8, "beginBatchResolutionSession");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = -[STLocationStatusDomainDisplayNameTransformer initWithEntityResolver:](v10, "initWithEntityResolver:", v11);
