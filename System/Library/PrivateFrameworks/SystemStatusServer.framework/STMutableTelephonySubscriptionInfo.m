...
{
  return -[STTelephonySubscriptionInfo initWithSubscriptionInfo:](+[STTelephonySubscriptionInfo allocWithZone:](STTelephonySubscriptionInfo, "allocWithZone:", a3), self);
}
...
- (void)setLastKnownNetworkCountryCode:(id)a3
{
  ...
  v6 = a3;
  if ((objc_msgSend(v6, "isEqualToString:", self->super._lastKnownNetworkCountryCode) & 1) == 0)
  {
...
- (void)setIdentifier:(id)a3
{
  ...
  v6 = a3;
  if ((objc_msgSend(v6, "isEqualToString:", self->super._identifier) & 1) == 0)
  {
    v4 = (NSString *)objc_msgSend(v6, "copy");
...
- (void)setSIMLabel:(id)a3
{
  ...
  v6 = a3;
  if ((objc_msgSend(v6, "isEqualToString:", self->super._SIMLabel) & 1) == 0)
  {
    v4 = (NSString *)objc_msgSend(v6, "copy");
...
- (void)setShortSIMLabel:(id)a3
{
  ...
  v6 = a3;
  if ((objc_msgSend(v6, "isEqualToString:", self->super._shortSIMLabel) & 1) == 0)
  {
    v4 = (NSString *)objc_msgSend(v6, "copy");
...
- (void)setSIMStatus:(id)a3
{
  ...
  v6 = a3;
  if ((objc_msgSend(v6, "isEqualToString:", self->super._SIMStatus) & 1) == 0)
  {
    v4 = (NSString *)objc_msgSend(v6, "copy");
...
- (void)setOperatorName:(id)a3
{
  ...
  v6 = a3;
  if ((objc_msgSend(v6, "isEqualToString:", self->super._operatorName) & 1) == 0)
  {
    v4 = (NSString *)objc_msgSend(v6, "copy");
