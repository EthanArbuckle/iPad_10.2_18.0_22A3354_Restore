...
{
  QSSMutablePronGuessStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutablePronGuessStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (QSSStartPronGuessRequest)contentAsQSSStartPronGuessRequest
{
  ...
  if (-[QSSMutablePronGuessStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSStartPronGuessRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (QSSAudioPacket)contentAsQSSAudioPacket
{
  ...
  if (-[QSSMutablePronGuessStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSFinishAudio)contentAsQSSFinishAudio
{
  ...
  if (-[QSSMutablePronGuessStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSCancelRequest)contentAsQSSCancelRequest
{
  ...
  if (-[QSSMutablePronGuessStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSCancelRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
