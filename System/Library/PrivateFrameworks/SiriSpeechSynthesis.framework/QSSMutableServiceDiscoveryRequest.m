...
{
  QSSMutableServiceDiscoveryRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableServiceDiscoveryRequest init](&v6, sel_init);
  if (v2)
  {
...
- (NSString)zk_path
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("zk_path"));
}
