...
{
  QSSMutableBatchTranslationStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableBatchTranslationStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (QSSBatchTranslationRequest)contentAsQSSBatchTranslationRequest
{
  ...
  if (-[QSSMutableBatchTranslationStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSBatchTranslationRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableBatchTranslationStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (QSSBatchTranslationFeedbackRequest)contentAsQSSBatchTranslationFeedbackRequest
{
  ...
  if (-[QSSMutableBatchTranslationStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSBatchTranslationFeedbackRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableBatchTranslationStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSBatchTranslationLoggingRequest)contentAsQSSBatchTranslationLoggingRequest
{
  ...
  if (-[QSSMutableBatchTranslationStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSBatchTranslationLoggingRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableBatchTranslationStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSTranslationSupportedLanguagesRequest)contentAsQSSTranslationSupportedLanguagesRequest
{
  ...
  if (-[QSSMutableBatchTranslationStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSTranslationSupportedLanguagesRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableBatchTranslationStreamingRequest setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
