...
{
  QSSMutableRecognitionChoice *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableRecognitionChoice init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("alternative_index"));
}
