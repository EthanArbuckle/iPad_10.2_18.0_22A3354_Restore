...
{
  QSSMutableEndPointLikelihood *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableEndPointLikelihood init](&v6, sel_init);
  if (v2)
  {
...
- (int)end_point_likelihood
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("end_point_likelihood"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
