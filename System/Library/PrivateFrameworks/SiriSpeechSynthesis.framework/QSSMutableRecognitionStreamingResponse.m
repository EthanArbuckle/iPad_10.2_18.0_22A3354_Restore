...
{
  QSSMutableRecognitionStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableRecognitionStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSFinalSpeechRecognitionResponse)contentAsQSSFinalSpeechRecognitionResponse
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSFinalSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (QSSPartialSpeechRecognitionResponse)contentAsQSSPartialSpeechRecognitionResponse
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSPartialSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSUpdatedAcousticProfile)contentAsQSSUpdatedAcousticProfile
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSUpdatedAcousticProfile:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSEndPointLikelihood)contentAsQSSEndPointLikelihood
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSEndPointLikelihood:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSEndPointCandidate)contentAsQSSEndPointCandidate
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSEndPointCandidate:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSRecognitionProgress)contentAsQSSRecognitionProgress
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSRecognitionProgress:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSCheckForSpeechResponse)contentAsQSSCheckForSpeechResponse
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSCheckForSpeechResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 7);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSRecognitionCandidate)contentAsQSSRecognitionCandidate
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSRecognitionCandidate:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 8);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSRequestStatsResponse)contentAsQSSRequestStatsResponse
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 9)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSRequestStatsResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 9);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSServerEndpointFeatures)contentAsQSSServerEndpointFeatures
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 10)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSServerEndpointFeatures:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 10);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSClientSetupInfo)contentAsQSSClientSetupInfo
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 11)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSClientSetupInfo:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 11);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSAudioLimitExceeded)contentAsQSSAudioLimitExceeded
{
  ...
  if (-[QSSMutableRecognitionStreamingResponse content_type](self, "content_type") == 12)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSAudioLimitExceeded:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableRecognitionStreamingResponse setContent_type:](self, "setContent_type:", 12);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
