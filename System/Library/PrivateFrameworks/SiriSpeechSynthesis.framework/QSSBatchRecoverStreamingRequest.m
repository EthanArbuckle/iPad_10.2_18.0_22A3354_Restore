...
{
  return -[QSSBatchRecoverStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSBatchRecoverStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSBatchRecoverStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchRecoverStreamingRequest *)a4
{
  return -[QSSBatchRecoverStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSBatchRecoverStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchRecoverStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSBatchRecoverStreamingRequest *v10;
  QSSBatchRecoverStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  unsigned int v22;
  siri::speech::schema_fb::StartBatchRecoverRequest *v23;
  uint64_t v24;
  NSMutableDictionary *storage;
  QSSBatchRecoverStreamingRequest *v26;
  uint64_t v28;
  unint64_t v29;
  __int128 v30;
  uint64_t v31;
  ...
  v10 = -[QSSBatchRecoverStreamingRequest init](&v33, sel_init);
  v11 = v10;
  if (!v10)
    goto LABEL_30;
...
{
  const BatchRecoverStreamingRequest *root;
  const BatchRecoverStreamingRequest *v3;
  uint64_t v4;
...
{
  QSSStartBatchRecoverRequest *v3;
  QSSStartBatchRecoverRequest *v4;
  const BatchRecoverStreamingRequest *root;
  const BatchRecoverStreamingRequest *v6;
  uint64_t v7;
  const BatchRecoverStreamingRequest *v8;

  if (-[QSSBatchRecoverStreamingRequest content_type](self, "content_type") == 1)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (QSSStartBatchRecoverRequest *)objc_claimAutoreleasedReturnValue();
    if (!v3)
    {
      ...
      if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
        ...
        v8 = 0;
      v3 = -[QSSStartBatchRecoverRequest initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
- (Offset<siri::speech::qss_fb::BatchRecoverStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[QSSBatchRecoverStreamingRequest content_type](self, "content_type");
  if (-[QSSBatchRecoverStreamingRequest content_type](self, "content_type") == 1)
  {
    -[QSSBatchRecoverStreamingRequest contentAsQSSStartBatchRecoverRequest](self, "contentAsQSSStartBatchRecoverRequest");
...
- (id)flatbuffData
{
  Offset<siri::speech::qss_fb::BatchRecoverStreamingRequest> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSBatchRecoverStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __47__QSSBatchRecoverStreamingRequest_flatbuffData__block_invoke;
