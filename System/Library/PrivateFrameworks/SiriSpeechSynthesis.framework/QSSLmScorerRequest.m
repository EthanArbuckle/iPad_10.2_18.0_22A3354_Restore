...
{
  return -[QSSLmScorerRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSLmScorerRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSLmScorerRequest)initWithFlatbuffData:(id)a3 root:(const LmScorerRequest *)a4
{
  return -[QSSLmScorerRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSLmScorerRequest)initWithFlatbuffData:(id)a3 root:(const LmScorerRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSLmScorerRequest *v10;
  QSSLmScorerRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSLmScorerRequest init](&v39, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::LmScorerRequest>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSLmScorerRequest language](self, "language");
  ...
  -[QSSLmScorerRequest task_name](self, "task_name");
  ...
  -[QSSLmScorerRequest transcript](self, "transcript");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::LmScorerRequest> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSLmScorerRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __34__QSSLmScorerRequest_flatbuffData__block_invoke;
