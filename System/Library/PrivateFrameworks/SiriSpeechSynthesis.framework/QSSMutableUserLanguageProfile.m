...
{
  QSSMutableUserLanguageProfile *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableUserLanguageProfile init](&v6, sel_init);
  if (v2)
  {
...
- (NSData)profile_blob
{
  return (NSData *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("profile_blob"));
}
...
- (void)profile_blob:(id)a3
{
  ...
  -[QSSMutableUserLanguageProfile profile_blob](self, "profile_blob");
...
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("profile_blob_version"));
}
