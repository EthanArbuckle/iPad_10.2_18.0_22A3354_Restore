...
{
  return -[QSSSpeechTranslationFinalRecognitionResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSSpeechTranslationFinalRecognitionResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[QSSSpeechTranslationFinalRecognitionResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationFinalRecognitionResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSSpeechTranslationFinalRecognitionResponse *v10;
  QSSSpeechTranslationFinalRecognitionResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSSpeechTranslationFinalRecognitionResponse *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSSpeechTranslationFinalRecognitionResponse init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSSpeechTranslationFinalRecognitionResponse conversation_id](self, "conversation_id");
  ...
  -[QSSSpeechTranslationFinalRecognitionResponse request_id](self, "request_id");
  ...
  v15 = -[QSSSpeechTranslationFinalRecognitionResponse return_code](self, "return_code");
  -[QSSSpeechTranslationFinalRecognitionResponse return_str](self, "return_str");
  ...
  -[QSSSpeechTranslationFinalRecognitionResponse source_locale](self, "source_locale");
  ...
  -[QSSSpeechTranslationFinalRecognitionResponse recognition_text](self, "recognition_text");
  ...
  -[QSSSpeechTranslationFinalRecognitionResponse recognition_result](self, "recognition_result");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, (int)v30);
}

- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSSpeechTranslationFinalRecognitionResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __60__QSSSpeechTranslationFinalRecognitionResponse_flatbuffData__block_invoke;
