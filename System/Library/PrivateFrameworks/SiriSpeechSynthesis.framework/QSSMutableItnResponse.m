...
- (QSSMutableItnResponse)init
{
  ...
  v2 = -[QSSMutableItnResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("formatted_words_list"));
}
