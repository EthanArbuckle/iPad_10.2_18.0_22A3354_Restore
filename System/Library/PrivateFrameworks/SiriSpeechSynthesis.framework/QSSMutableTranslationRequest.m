...
{
  QSSMutableTranslationRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTranslationRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSSiriTranslationInfo *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("siri_translation_info"));
}
...
{
  return (QSSSpeechTranslationInfo *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("speech_translation_info"));
}
...
{
  return (QSSSiriPayloadTranslationInfo *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("siri_payload_translation_info"));
}
...
{
  return (QSSWebTranslationInfo *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("web_translation_info"));
}
