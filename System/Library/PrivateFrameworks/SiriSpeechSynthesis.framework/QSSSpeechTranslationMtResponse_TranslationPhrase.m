...
{
  return -[QSSSpeechTranslationMtResponse_TranslationPhrase initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSSpeechTranslationMtResponse_TranslationPhrase initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSSpeechTranslationMtResponse_TranslationPhrase)initWithFlatbuffData:(id)a3 root:(const TranslationPhrase *)a4
{
  return -[QSSSpeechTranslationMtResponse_TranslationPhrase initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSSpeechTranslationMtResponse_TranslationPhrase)initWithFlatbuffData:(id)a3 root:(const TranslationPhrase *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSSpeechTranslationMtResponse_TranslationPhrase *v10;
  QSSSpeechTranslationMtResponse_TranslationPhrase *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::SpeechTranslationMtResponse_::TranslationPhrase *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSSpeechTranslationMtResponse_TranslationPhrase *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSSpeechTranslationMtResponse_TranslationPhrase init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::SpeechTranslationMtResponse_::TranslationPhrase>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSSpeechTranslationMtResponse_TranslationPhrase confidence](self, "confidence");
  v6 = v5;
  -[QSSSpeechTranslationMtResponse_TranslationPhrase translation_phrase](self, "translation_phrase");
  ...
  -[QSSSpeechTranslationMtResponse_TranslationPhrase meta_info](self, "meta_info");
  ...
  v16 = -[QSSSpeechTranslationMtResponse_TranslationPhrase low_confidence](self, "low_confidence");
  flatbuffers::FlatBufferBuilder::NotNested((uint64_t)a3);
  *((_BYTE *)a3 + 70) = 1;
  v17 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::SpeechTranslationMtResponse_::TranslationPhrase> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSSpeechTranslationMtResponse_TranslationPhrase addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __64__QSSSpeechTranslationMtResponse_TranslationPhrase_flatbuffData__block_invoke;
