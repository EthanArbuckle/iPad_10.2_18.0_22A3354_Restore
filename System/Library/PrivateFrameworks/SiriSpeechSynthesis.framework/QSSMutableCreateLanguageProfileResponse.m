...
{
  QSSMutableCreateLanguageProfileResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableCreateLanguageProfileResponse init](&v6, sel_init);
  if (v2)
  {
...
- (BOOL)incomplete_profile
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("incomplete_profile"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)recreate_apg_prons
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("recreate_apg_prons"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "BOOLValue");
