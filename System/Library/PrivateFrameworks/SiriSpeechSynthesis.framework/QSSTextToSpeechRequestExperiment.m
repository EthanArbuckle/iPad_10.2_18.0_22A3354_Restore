...
{
  return -[QSSTextToSpeechRequestExperiment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechRequestExperiment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTextToSpeechRequestExperiment)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestExperiment *)a4
{
  return -[QSSTextToSpeechRequestExperiment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechRequestExperiment)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestExperiment *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechRequestExperiment *v10;
  QSSTextToSpeechRequestExperiment *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::Pronunciation *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSTextToSpeechRequestExperiment *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSTextToSpeechRequestExperiment init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestExperiment>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSTextToSpeechRequestExperiment experiment_identifier](self, "experiment_identifier");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechRequestExperiment addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __48__QSSTextToSpeechRequestExperiment_flatbuffData__block_invoke;
