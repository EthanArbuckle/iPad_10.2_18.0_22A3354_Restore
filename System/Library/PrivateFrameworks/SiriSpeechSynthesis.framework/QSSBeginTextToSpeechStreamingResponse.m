...
{
  return -[QSSBeginTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSBeginTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4
{
  return -[QSSBeginTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSBeginTextToSpeechStreamingResponse *v10;
  QSSBeginTextToSpeechStreamingResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSBeginTextToSpeechStreamingResponse *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSBeginTextToSpeechStreamingResponse init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::BeginTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSBeginTextToSpeechStreamingResponse speech_id](self, "speech_id");
  ...
  -[QSSBeginTextToSpeechStreamingResponse session_id](self, "session_id");
  ...
  v15 = -[QSSBeginTextToSpeechStreamingResponse error_code](self, "error_code");
  -[QSSBeginTextToSpeechStreamingResponse error_str](self, "error_str");
  ...
  -[QSSBeginTextToSpeechStreamingResponse stream_id](self, "stream_id");
  ...
  v26 = -[QSSBeginTextToSpeechStreamingResponse audio_type](self, "audio_type");
  -[QSSBeginTextToSpeechStreamingResponse decoder_description](self, "decoder_description");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v28 = objc_msgSend(v27, "addObjectToBuffer:", a3);

  -[QSSBeginTextToSpeechStreamingResponse playback_description](self, "playback_description");
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  LODWORD(v23) = objc_msgSend(v29, "addObjectToBuffer:", a3);

  -[QSSBeginTextToSpeechStreamingResponse meta_info](self, "meta_info");
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  v31 = objc_msgSend(v30, "addObjectToBuffer:", a3);

  -[QSSBeginTextToSpeechStreamingResponse streaming_playback_buffer_size_in_seconds](self, "streaming_playback_buffer_size_in_seconds");
  v33 = v32;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSBeginTextToSpeechStreamingResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __53__QSSBeginTextToSpeechStreamingResponse_flatbuffData__block_invoke;
