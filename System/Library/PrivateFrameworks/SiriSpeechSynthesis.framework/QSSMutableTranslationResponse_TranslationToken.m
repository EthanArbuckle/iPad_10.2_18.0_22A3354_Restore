...
{
  QSSMutableTranslationResponse_TranslationToken *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTranslationResponse_TranslationToken init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSAlignment *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("mt_alignment"));
}
