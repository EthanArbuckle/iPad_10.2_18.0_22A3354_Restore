...
{
  return -[QSSAudioPacket initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSAudioPacket initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSAudioPacket)initWithFlatbuffData:(id)a3 root:(const AudioPacket *)a4
{
  return -[QSSAudioPacket initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSAudioPacket)initWithFlatbuffData:(id)a3 root:(const AudioPacket *)a4 verify:(BOOL)a5
{
  ...
  v10 = -[QSSAudioPacket init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::AudioPacket>)addObjectToBuffer:(void *)a3
{
  ...
  v8[4] = &v9;
  v8[5] = a3;
  -[QSSAudioPacket audio_bytes:](self, "audio_bytes:", v8);
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::AudioPacket> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSAudioPacket addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __30__QSSAudioPacket_flatbuffData__block_invoke;
