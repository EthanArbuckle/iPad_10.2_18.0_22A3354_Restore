...
{
  QSSMutablePronGuessStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutablePronGuessStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSPronGuessResponse)contentAsQSSPronGuessResponse
{
  ...
  if (-[QSSMutablePronGuessStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSPronGuessResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutablePronGuessStreamingResponse setContent_type:](self, "setContent_type:", 1);
