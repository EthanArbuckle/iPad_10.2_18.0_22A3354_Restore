...
{
  return -[QSSUpdatedAcousticProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSUpdatedAcousticProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSUpdatedAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UpdatedAcousticProfile *)a4
{
  return -[QSSUpdatedAcousticProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSUpdatedAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UpdatedAcousticProfile *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSUpdatedAcousticProfile *v10;
  QSSUpdatedAcousticProfile *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::UpdatedAcousticProfile *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSUpdatedAcousticProfile *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSUpdatedAcousticProfile init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::UpdatedAcousticProfile>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSUpdatedAcousticProfile speech_id](self, "speech_id");
  ...
  -[QSSUpdatedAcousticProfile session_id](self, "session_id");
  ...
  v15 = -[QSSUpdatedAcousticProfile return_code](self, "return_code");
  -[QSSUpdatedAcousticProfile return_str](self, "return_str");
  ...
  -[QSSUpdatedAcousticProfile updated_acoustic_profile](self, "updated_acoustic_profile");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::UpdatedAcousticProfile>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, (int)v20);
}

- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::UpdatedAcousticProfile> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSUpdatedAcousticProfile addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __41__QSSUpdatedAcousticProfile_flatbuffData__block_invoke;
