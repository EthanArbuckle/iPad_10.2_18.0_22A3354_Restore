...
{
  return -[QSSClientSetupInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSClientSetupInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSClientSetupInfo)initWithFlatbuffData:(id)a3 root:(const ClientSetupInfo *)a4
{
  return -[QSSClientSetupInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSClientSetupInfo)initWithFlatbuffData:(id)a3 root:(const ClientSetupInfo *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSClientSetupInfo *v10;
  QSSClientSetupInfo *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::ClientSetupInfo *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSClientSetupInfo *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSClientSetupInfo init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::ClientSetupInfo>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSClientSetupInfo endpoint_threshold](self, "endpoint_threshold");
  v6 = v5;
  v7 = -[QSSClientSetupInfo endpoint_extra_delay](self, "endpoint_extra_delay");
  -[QSSClientSetupInfo speech_id](self, "speech_id");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::ClientSetupInfo> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSClientSetupInfo addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __34__QSSClientSetupInfo_flatbuffData__block_invoke;
