...
{
  QSSMutableStreamingTranslationStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableStreamingTranslationStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSTranslationResponse)contentAsQSSTranslationResponse
{
  ...
  if (-[QSSMutableStreamingTranslationStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSTranslationResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableStreamingTranslationStreamingResponse setContent_type:](self, "setContent_type:", 1);
