...
{
  QSSMutableTextToSpeechRouterStreamingStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechRouterStreamingStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (QSSStartTextToSpeechStreamingRequest)contentAsQSSStartTextToSpeechStreamingRequest
{
  ...
  if (-[QSSMutableTextToSpeechRouterStreamingStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSStartTextToSpeechStreamingRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechRouterStreamingStreamingRequest setContent_type:](self, "setContent_type:", 1);
