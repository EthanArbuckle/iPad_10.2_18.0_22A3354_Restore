...
{
  QSSMutableTextToSpeechStreamingStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechStreamingStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSQssAckResponse)contentAsQSSQssAckResponse
{
  ...
  if (-[QSSMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSQssAckResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (QSSBeginTextToSpeechStreamingResponse)contentAsQSSBeginTextToSpeechStreamingResponse
{
  ...
  if (-[QSSMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSBeginTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSPartialTextToSpeechStreamingResponse)contentAsQSSPartialTextToSpeechStreamingResponse
{
  ...
  if (-[QSSMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSPartialTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSFinalTextToSpeechStreamingResponse)contentAsQSSFinalTextToSpeechStreamingResponse
{
  ...
  if (-[QSSMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSFinalTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
