...
{
  QSSMutableRecoverPronsResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableRecoverPronsResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("recovery_return_codes"));
}
...
- (NSArray)voc_tokens
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("voc_tokens"));
}
