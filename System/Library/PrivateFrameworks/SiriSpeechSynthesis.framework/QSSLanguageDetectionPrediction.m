...
{
  return -[QSSLanguageDetectionPrediction initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSLanguageDetectionPrediction initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSLanguageDetectionPrediction)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionPrediction *)a4
{
  return -[QSSLanguageDetectionPrediction initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSLanguageDetectionPrediction)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionPrediction *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSLanguageDetectionPrediction *v10;
  QSSLanguageDetectionPrediction *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::LanguageDetectionPrediction *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSLanguageDetectionPrediction *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSLanguageDetectionPrediction init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::LanguageDetectionPrediction>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSLanguageDetectionPrediction locale](self, "locale");
  ...
  -[QSSLanguageDetectionPrediction confidence](self, "confidence");
  v10 = v9;
  -[QSSLanguageDetectionPrediction threshold](self, "threshold");
  v12 = v11;
  v13 = -[QSSLanguageDetectionPrediction is_low_confidence](self, "is_low_confidence");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::LanguageDetectionPrediction> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSLanguageDetectionPrediction addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __46__QSSLanguageDetectionPrediction_flatbuffData__block_invoke;
