...
{
  QSSMutableCheckForSpeechResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableCheckForSpeechResponse init](&v6, sel_init);
  if (v2)
  {
...
- (BOOL)speech_detected
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("speech_detected"));
