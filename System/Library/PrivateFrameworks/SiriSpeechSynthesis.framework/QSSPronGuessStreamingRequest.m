...
{
  return -[QSSPronGuessStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSPronGuessStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSPronGuessStreamingRequest)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingRequest *)a4
{
  return -[QSSPronGuessStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSPronGuessStreamingRequest)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSPronGuessStreamingRequest *v10;
  QSSPronGuessStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  unsigned int v22;
  siri::speech::schema_fb::StartPronGuessRequest *v23;
  uint64_t v24;
  NSMutableDictionary *storage;
  QSSPronGuessStreamingRequest *v26;
  uint64_t v28;
  unint64_t v29;
  __int128 v30;
  uint64_t v31;
  ...
  v10 = -[QSSPronGuessStreamingRequest init](&v33, sel_init);
  v11 = v10;
  if (!v10)
    goto LABEL_38;
...
{
  const PronGuessStreamingRequest *root;
  const PronGuessStreamingRequest *v3;
  uint64_t v4;
...
{
  QSSStartPronGuessRequest *v3;
  QSSStartPronGuessRequest *v4;
  const PronGuessStreamingRequest *root;
  const PronGuessStreamingRequest *v6;
  uint64_t v7;
  const PronGuessStreamingRequest *v8;

  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 1)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (QSSStartPronGuessRequest *)objc_claimAutoreleasedReturnValue();
    if (!v3)
    {
      ...
      if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
        ...
        v8 = 0;
      v3 = -[QSSStartPronGuessRequest initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
- (QSSAudioPacket)contentAsQSSAudioPacket
{
  ...
  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (QSSFinishAudio)contentAsQSSFinishAudio
{
  ...
  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (QSSCancelRequest)contentAsQSSCancelRequest
{
  ...
  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (QSSCancelRequest *)objc_claimAutoreleasedReturnValue();
    if (!v3)
    {
      ...
      if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
        ...
        v8 = 0;
      v3 = -[QSSCancelRequest initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
      -[NSMutableDictionary setObject:forKeyedSubscript:](self->_storage, "setObject:forKeyedSubscript:", v3, CFSTR("content"));
    }
  }
  else
...
- (Offset<siri::speech::qss_fb::PronGuessStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[QSSPronGuessStreamingRequest content_type](self, "content_type");
  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 1)
  {
    -[QSSPronGuessStreamingRequest contentAsQSSStartPronGuessRequest](self, "contentAsQSSStartPronGuessRequest");
  ...
  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 2)
  {
    -[QSSPronGuessStreamingRequest contentAsQSSAudioPacket](self, "contentAsQSSAudioPacket");
  ...
  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 3)
  {
    -[QSSPronGuessStreamingRequest contentAsQSSFinishAudio](self, "contentAsQSSFinishAudio");
  ...
  if (-[QSSPronGuessStreamingRequest content_type](self, "content_type") == 4)
  {
    -[QSSPronGuessStreamingRequest contentAsQSSCancelRequest](self, "contentAsQSSCancelRequest");
...
- (id)flatbuffData
{
  Offset<siri::speech::qss_fb::PronGuessStreamingRequest> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSPronGuessStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __44__QSSPronGuessStreamingRequest_flatbuffData__block_invoke;
