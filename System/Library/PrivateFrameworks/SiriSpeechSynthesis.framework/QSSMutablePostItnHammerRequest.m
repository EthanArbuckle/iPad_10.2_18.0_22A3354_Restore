...
{
  QSSMutablePostItnHammerRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutablePostItnHammerRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("post_itn_string"));
}
