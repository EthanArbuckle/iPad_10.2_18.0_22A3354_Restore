...
{
  QSSMutableLanguageDetectionPrediction *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableLanguageDetectionPrediction init](&v6, sel_init);
  if (v2)
  {
...
- (BOOL)is_low_confidence
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("is_low_confidence"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
