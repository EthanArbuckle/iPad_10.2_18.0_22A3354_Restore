...
{
  QSSMutableLanguageDetectionStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableLanguageDetectionStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (QSSStartLanguageDetectionRequest)contentAsQSSStartLanguageDetectionRequest
{
  ...
  if (-[QSSMutableLanguageDetectionStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSStartLanguageDetectionRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableLanguageDetectionStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (QSSAudioPacket)contentAsQSSAudioPacket
{
  ...
  if (-[QSSMutableLanguageDetectionStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableLanguageDetectionStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSFinishAudio)contentAsQSSFinishAudio
{
  ...
  if (-[QSSMutableLanguageDetectionStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableLanguageDetectionStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
