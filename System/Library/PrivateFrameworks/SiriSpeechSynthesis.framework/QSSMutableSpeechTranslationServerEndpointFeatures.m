...
{
  QSSMutableSpeechTranslationServerEndpointFeatures *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableSpeechTranslationServerEndpointFeatures init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSServerEndpointFeatures *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("server_endpoint_features"));
}
