...
{
  QSSMutableTextToSpeechSpeechFeatureInputWave *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechSpeechFeatureInputWave init](&v6, sel_init);
  if (v2)
  {
...
- (void)pcm_data:(id)a3
{
  ...
  -[QSSMutableTextToSpeechSpeechFeatureInputWave pcm_data](self, "pcm_data");
