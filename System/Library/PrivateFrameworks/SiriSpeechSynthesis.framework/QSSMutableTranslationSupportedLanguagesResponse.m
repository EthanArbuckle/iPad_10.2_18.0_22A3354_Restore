...
{
  QSSMutableTranslationSupportedLanguagesResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTranslationSupportedLanguagesResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("language_pairs"));
}
