...
{
  return -[QSSShortcutFuzzyMatchResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSShortcutFuzzyMatchResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSShortcutFuzzyMatchResponse)initWithFlatbuffData:(id)a3 root:(const ShortcutFuzzyMatchResponse *)a4
{
  return -[QSSShortcutFuzzyMatchResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSShortcutFuzzyMatchResponse)initWithFlatbuffData:(id)a3 root:(const ShortcutFuzzyMatchResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSShortcutFuzzyMatchResponse *v10;
  QSSShortcutFuzzyMatchResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSShortcutFuzzyMatchResponse *v34;
  uint64_t v36;
  unint64_t v37;
  __int128 v38;
  uint64_t v39;
  ...
  v10 = -[QSSShortcutFuzzyMatchResponse init](&v41, sel_init);
  v11 = v10;
  if (!v10)
    goto LABEL_38;
...
LABEL_39:
  ...
  v25 = -v24;
LABEL_27:
  v26 = *(unsigned __int16 *)((char *)root + v25 + 6);
  if (v26)
  {
...
- (NSArray)shortcut_score_pairs
{
  void *v3;
  const ShortcutFuzzyMatchResponse *root;
  const ShortcutFuzzyMatchResponse *v5;
  uint64_t v6;
  ...
  uint64_t v11;
  QSSShortcutFuzzyMatchResponse_ShortcutScorePair *v12;
    ...
    if (*(unsigned __int16 *)v5->var0 >= 7u)
    {
      ...
      if (v6)
      {
        ...
        if ((_DWORD)v9)
        {
          ...
          do
          {
            v12 = -[QSSShortcutFuzzyMatchResponse_ShortcutScorePair initWithFlatbuffData:root:verify:]([QSSShortcutFuzzyMatchResponse_ShortcutScorePair alloc], "initWithFlatbuffData:root:verify:", self->_data, &v10[*(unsigned int *)v10->var0], 0);
...
- (Offset<siri::speech::schema_fb::ShortcutFuzzyMatchResponse>)addObjectToBuffer:(void *)a3
{
  ...
  int v38;
  int v39;
  Offset<siri::speech::schema_fb::ShortcutFuzzyMatchResponse> v40;
  unsigned int String;
  QSSShortcutFuzzyMatchResponse *v43;
  void *v44;
  __int128 v45;
  __int128 v46;
  __int128 v47;
  ...
  -[QSSShortcutFuzzyMatchResponse utterance](self, "utterance");
  ...
  -[QSSShortcutFuzzyMatchResponse shortcut_score_pairs](self, "shortcut_score_pairs");
  ...
  if (v15)
  {
    ...
    do
    {
      for (i = 0; i != v15; ++i)
      {
        ...
        v19 = objc_msgSend(*(id *)(*((_QWORD *)&v45 + 1) + 8 * i), "addObjectToBuffer:", a3);
        v20 = v19;
        if (v17 >= v13)
        {
          v21 = (v17 - v11) >> 2;
  ...
  v35 = -[QSSShortcutFuzzyMatchResponse return_code](v43, "return_code");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  if (v34)
  {
    v39 = flatbuffers::FlatBufferBuilder::ReferTo((flatbuffers::FlatBufferBuilder *)a3, v34);
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::ShortcutFuzzyMatchResponse> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSShortcutFuzzyMatchResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __45__QSSShortcutFuzzyMatchResponse_flatbuffData__block_invoke;
