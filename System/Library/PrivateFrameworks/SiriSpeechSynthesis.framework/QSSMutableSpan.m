...
- (QSSMutableSpan)init
{
  ...
  v2 = -[QSSMutableSpan init](&v6, sel_init);
  if (v2)
  {
...
- (int)start_index
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("start_index"));
...
- (int)end_index
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("end_index"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
...
- (BOOL)do_not_translate
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("do_not_translate"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
