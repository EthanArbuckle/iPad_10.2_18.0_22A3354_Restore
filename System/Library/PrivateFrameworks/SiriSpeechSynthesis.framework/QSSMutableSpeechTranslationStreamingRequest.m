...
{
  QSSMutableSpeechTranslationStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableSpeechTranslationStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (QSSStartSpeechTranslationRequest)contentAsQSSStartSpeechTranslationRequest
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSStartSpeechTranslationRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (QSSLanguageDetected)contentAsQSSLanguageDetected
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSLanguageDetected:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSAudioPacket)contentAsQSSAudioPacket
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSSpeechTranslationAudioPacket)contentAsQSSSpeechTranslationAudioPacket
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSSpeechTranslationAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSFinishAudio)contentAsQSSFinishAudio
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSSetEndpointerState)contentAsQSSSetEndpointerState
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSSetEndpointerState:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSResetServerEndpointer)contentAsQSSResetServerEndpointer
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSResetServerEndpointer:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 7);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSStartSpeechTranslationLoggingRequest)contentAsQSSStartSpeechTranslationLoggingRequest
{
  ...
  if (-[QSSMutableSpeechTranslationStreamingRequest content_type](self, "content_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSStartSpeechTranslationLoggingRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableSpeechTranslationStreamingRequest setContent_type:](self, "setContent_type:", 8);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
