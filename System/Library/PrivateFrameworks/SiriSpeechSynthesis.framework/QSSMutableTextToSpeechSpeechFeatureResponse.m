...
{
  QSSMutableTextToSpeechSpeechFeatureResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechSpeechFeatureResponse init](&v6, sel_init);
  if (v2)
  {
...
- (NSArray)features
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("features"));
}
