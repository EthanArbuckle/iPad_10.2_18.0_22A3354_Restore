...
{
  QSSMutableShortcutFuzzyMatchResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableShortcutFuzzyMatchResponse init](&v6, sel_init);
  if (v2)
  {
...
- (NSString)utterance
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("utterance"));
}
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("shortcut_score_pairs"));
}
