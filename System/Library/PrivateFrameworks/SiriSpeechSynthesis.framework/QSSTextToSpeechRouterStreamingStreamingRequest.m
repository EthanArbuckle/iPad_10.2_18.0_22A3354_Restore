...
{
  return -[QSSTextToSpeechRouterStreamingStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechRouterStreamingStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[QSSTextToSpeechRouterStreamingStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechRouterStreamingStreamingRequest *v10;
  QSSTextToSpeechRouterStreamingStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSTextToSpeechRouterStreamingStreamingRequest *v26;
  uint64_t v28;
  unint64_t v29;
  __int128 v30;
  uint64_t v31;
  ...
  v10 = -[QSSTextToSpeechRouterStreamingStreamingRequest init](&v33, sel_init);
  v11 = v10;
  if (!v10)
    goto LABEL_30;
...
- (QSSStartTextToSpeechStreamingRequest)contentAsQSSStartTextToSpeechStreamingRequest
{
  ...
  if (-[QSSTextToSpeechRouterStreamingStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[QSSTextToSpeechRouterStreamingStreamingRequest content_type](self, "content_type");
  if (-[QSSTextToSpeechRouterStreamingStreamingRequest content_type](self, "content_type") == 1)
  {
    -[QSSTextToSpeechRouterStreamingStreamingRequest contentAsQSSStartTextToSpeechStreamingRequest](self, "contentAsQSSStartTextToSpeechStreamingRequest");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechRouterStreamingStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __62__QSSTextToSpeechRouterStreamingStreamingRequest_flatbuffData__block_invoke;
