...
{
  QSSMutableGraphemeToPhonemeRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableGraphemeToPhonemeRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSContextWithPronHints *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("context_with_pron_hints"));
}
