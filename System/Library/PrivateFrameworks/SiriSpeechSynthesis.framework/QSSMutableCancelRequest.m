...
- (QSSMutableCancelRequest)init
{
  ...
  v2 = -[QSSMutableCancelRequest init](&v6, sel_init);
  if (v2)
  {
...
- (NSString)reason
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("reason"));
}
