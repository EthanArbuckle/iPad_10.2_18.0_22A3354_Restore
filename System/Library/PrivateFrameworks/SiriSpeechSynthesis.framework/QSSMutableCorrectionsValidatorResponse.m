...
{
  QSSMutableCorrectionsValidatorResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableCorrectionsValidatorResponse init](&v6, sel_init);
  if (v2)
  {
...
- (NSArray)corrections
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("corrections"));
}
