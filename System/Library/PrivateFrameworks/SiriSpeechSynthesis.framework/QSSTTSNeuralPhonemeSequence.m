...
{
  return -[QSSTTSNeuralPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTTSNeuralPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4
{
  return -[QSSTTSNeuralPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTTSNeuralPhonemeSequence *v10;
  QSSTTSNeuralPhonemeSequence *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSTTSNeuralPhonemeSequence *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSTTSNeuralPhonemeSequence init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (NSArray)phonemes
{
  ...
  const TTSNeuralPhonemeSequence *v5;
  uint64_t v6;
...
- (Offset<siri::speech::schema_fb::TTSNeuralPhonemeSequence>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSTTSNeuralPhonemeSequence phonemes](self, "phonemes");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTTSNeuralPhonemeSequence addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __43__QSSTTSNeuralPhonemeSequence_flatbuffData__block_invoke;
