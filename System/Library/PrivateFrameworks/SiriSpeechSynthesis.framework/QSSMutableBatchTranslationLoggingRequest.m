...
{
  QSSMutableBatchTranslationLoggingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableBatchTranslationLoggingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (int)time_to_first_response
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("time_to_first_response"));
...
- (int)time_to_viewport_complete
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("time_to_viewport_complete"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
...
- (int)time_to_page_complete
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("time_to_page_complete"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
