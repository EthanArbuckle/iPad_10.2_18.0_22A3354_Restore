...
{
  return -[QSSTextToSpeechSpeechFeatureOutputFeature initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechSpeechFeatureOutputFeature initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[QSSTextToSpeechSpeechFeatureOutputFeature initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechSpeechFeatureOutputFeature)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureOutputFeature *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechSpeechFeatureOutputFeature *v10;
  QSSTextToSpeechSpeechFeatureOutputFeature *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::TextToSpeechSpeechFeatureOutputFeature *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSTextToSpeechSpeechFeatureOutputFeature *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSTextToSpeechSpeechFeatureOutputFeature init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureOutputFeature>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSTextToSpeechSpeechFeatureOutputFeature phone_name](self, "phone_name");
  ...
  -[QSSTextToSpeechSpeechFeatureOutputFeature begin_time](self, "begin_time");
  v10 = v9;
  -[QSSTextToSpeechSpeechFeatureOutputFeature end_time](self, "end_time");
  v12 = v11;
  -[QSSTextToSpeechSpeechFeatureOutputFeature duration](self, "duration");
  v14 = v13;
  -[QSSTextToSpeechSpeechFeatureOutputFeature pitch](self, "pitch");
  v16 = v15;
  -[QSSTextToSpeechSpeechFeatureOutputFeature energy](self, "energy");
  v18 = v17;
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureOutputFeature> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechSpeechFeatureOutputFeature addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __57__QSSTextToSpeechSpeechFeatureOutputFeature_flatbuffData__block_invoke;
