...
{
  return -[QSSAudioFrame initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSAudioFrame initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSAudioFrame)initWithFlatbuffData:(id)a3 root:(const AudioFrame *)a4
{
  return -[QSSAudioFrame initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSAudioFrame)initWithFlatbuffData:(id)a3 root:(const AudioFrame *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::AudioFrame *root;
  uint64_t v21;
  ...
  v10 = -[QSSAudioFrame init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (void)audio_bytes:(id)a3
{
  ...
  v10 = v4;
  (*((void (**)(id, const AudioFrame *, _QWORD))v4 + 2))(v4, v9 + 4, *(unsigned int *)root[v7 + v8].var0);
...
- (Offset<siri::speech::schema_fb::AudioFrame>)addObjectToBuffer:(void *)a3
{
  ...
  v10 = &v9;
  v11 = 0x3812000000;
  v12 = __Block_byref_object_copy__629;
  v13 = __Block_byref_object_dispose__630;
  v14 = &unk_21E36C185;
  v15 = 0;
  ...
  v8[4] = &v9;
  v8[5] = a3;
  -[QSSAudioFrame audio_bytes:](self, "audio_bytes:", v8);
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::AudioFrame> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSAudioFrame addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __29__QSSAudioFrame_flatbuffData__block_invoke;
