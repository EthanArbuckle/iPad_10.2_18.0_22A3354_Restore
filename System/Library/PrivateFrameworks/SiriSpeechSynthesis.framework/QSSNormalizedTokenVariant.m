...
{
  return -[QSSNormalizedTokenVariant initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSNormalizedTokenVariant initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4
{
  return -[QSSNormalizedTokenVariant initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSNormalizedTokenVariant *v10;
  QSSNormalizedTokenVariant *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSNormalizedTokenVariant init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (NSArray)normalized_tokens
{
  ...
  const NormalizedTokenVariant *v5;
  uint64_t v6;
...
- (Offset<siri::speech::schema_fb::NormalizedTokenVariant>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSNormalizedTokenVariant normalized_tokens](self, "normalized_tokens");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::NormalizedTokenVariant> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSNormalizedTokenVariant addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __41__QSSNormalizedTokenVariant_flatbuffData__block_invoke;
