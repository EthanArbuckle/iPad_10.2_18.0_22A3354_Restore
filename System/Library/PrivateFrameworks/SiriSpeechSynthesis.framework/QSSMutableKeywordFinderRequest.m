...
{
  QSSMutableKeywordFinderRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableKeywordFinderRequest init](&v6, sel_init);
  if (v2)
  {
...
- (NSArray)keywords
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("keywords"));
}
...
- (BOOL)enable_sanitization
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("enable_sanitization"));
