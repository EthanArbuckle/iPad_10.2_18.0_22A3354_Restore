...
{
  return -[QSSWordTimingInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSWordTimingInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSWordTimingInfo)initWithFlatbuffData:(id)a3 root:(const WordTimingInfo *)a4
{
  return -[QSSWordTimingInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSWordTimingInfo)initWithFlatbuffData:(id)a3 root:(const WordTimingInfo *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSWordTimingInfo *v10;
  QSSWordTimingInfo *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSWordTimingInfo init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::WordTimingInfo>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSWordTimingInfo word](self, "word");
  ...
  v9 = -[QSSWordTimingInfo sample_idx](self, "sample_idx");
  v10 = -[QSSWordTimingInfo offset](self, "offset");
  v11 = -[QSSWordTimingInfo length](self, "length");
  -[QSSWordTimingInfo timestamp](self, "timestamp");
  v13 = v12;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSWordTimingInfo addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __33__QSSWordTimingInfo_flatbuffData__block_invoke;
