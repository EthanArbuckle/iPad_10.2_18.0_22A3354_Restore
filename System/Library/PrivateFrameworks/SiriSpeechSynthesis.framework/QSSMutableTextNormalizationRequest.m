...
{
  QSSMutableTextNormalizationRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextNormalizationRequest init](&v6, sel_init);
  if (v2)
  {
...
- (int)nbest_variants_max
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("nbest_variants_max"));
