...
{
  return -[QSSLatnnMitigatorResult initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSLatnnMitigatorResult initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSLatnnMitigatorResult)initWithFlatbuffData:(id)a3 root:(const LatnnMitigatorResult *)a4
{
  return -[QSSLatnnMitigatorResult initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSLatnnMitigatorResult)initWithFlatbuffData:(id)a3 root:(const LatnnMitigatorResult *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSLatnnMitigatorResult *v10;
  QSSLatnnMitigatorResult *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::LatnnMitigatorResult *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSLatnnMitigatorResult *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSLatnnMitigatorResult init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::LatnnMitigatorResult>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[QSSLatnnMitigatorResult processed](self, "processed");
  -[QSSLatnnMitigatorResult version](self, "version");
  ...
  -[QSSLatnnMitigatorResult threshold](self, "threshold");
  v11 = v10;
  -[QSSLatnnMitigatorResult score](self, "score");
  v13 = v12;
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::LatnnMitigatorResult> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSLatnnMitigatorResult addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __39__QSSLatnnMitigatorResult_flatbuffData__block_invoke;
