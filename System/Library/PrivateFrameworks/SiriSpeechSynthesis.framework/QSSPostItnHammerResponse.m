...
{
  return -[QSSPostItnHammerResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSPostItnHammerResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4
{
  return -[QSSPostItnHammerResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSPostItnHammerResponse *v10;
  QSSPostItnHammerResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSPostItnHammerResponse init](&v45, sel_init);
  v11 = v10;
  if (!v10)
    goto LABEL_53;
...
- (NSArray)tokens
{
  void *v3;
  const PostItnHammerResponse *root;
  const PostItnHammerResponse *v5;
  uint64_t v6;
...
- (Offset<siri::speech::schema_fb::PostItnHammerResponse>)addObjectToBuffer:(void *)a3
{
  ...
  int v42;
  int v43;
  Offset<siri::speech::schema_fb::PostItnHammerResponse> v44;
  unsigned int v46;
  int v47;
  unsigned int v48;
  unsigned int v49;
  ...
  -[QSSPostItnHammerResponse speech_id](self, "speech_id");
  ...
  -[QSSPostItnHammerResponse session_id](self, "session_id");
  ...
  -[QSSPostItnHammerResponse language](self, "language");
  ...
  v47 = -[QSSPostItnHammerResponse return_code](self, "return_code");
  -[QSSPostItnHammerResponse return_str](self, "return_str");
  ...
  -[QSSPostItnHammerResponse tokens](self, "tokens");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::PostItnHammerResponse> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSPostItnHammerResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __40__QSSPostItnHammerResponse_flatbuffData__block_invoke;
