...
{
  QSSMutableKeywordFinderResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableKeywordFinderResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSRecognitionSausage *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("corrected_sausage"));
}
