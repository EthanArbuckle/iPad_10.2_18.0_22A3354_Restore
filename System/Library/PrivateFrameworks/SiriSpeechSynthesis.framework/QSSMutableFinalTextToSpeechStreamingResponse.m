...
{
  QSSMutableFinalTextToSpeechStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableFinalTextToSpeechStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (int)total_pkt_number
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("total_pkt_number"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
