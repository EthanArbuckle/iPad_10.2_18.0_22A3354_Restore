...
{
  return -[QSSSetSpeechProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSSetSpeechProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSSetSpeechProfile)initWithFlatbuffData:(id)a3 root:(const SetSpeechProfile *)a4
{
  return -[QSSSetSpeechProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSSetSpeechProfile)initWithFlatbuffData:(id)a3 root:(const SetSpeechProfile *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSSetSpeechProfile *v10;
  QSSSetSpeechProfile *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::SetSpeechProfile *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSSetSpeechProfile *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSSetSpeechProfile init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::SetSpeechProfile>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSSetSpeechProfile speech_id](self, "speech_id");
  ...
  -[QSSSetSpeechProfile session_id](self, "session_id");
  ...
  -[QSSSetSpeechProfile user_language_profile](self, "user_language_profile");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = objc_msgSend(v15, "addObjectToBuffer:", a3);

  -[QSSSetSpeechProfile user_acoustic_profile](self, "user_acoustic_profile");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = objc_msgSend(v17, "addObjectToBuffer:", a3);

  -[QSSSetSpeechProfile language](self, "language");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::SetSpeechProfile> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSSetSpeechProfile addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __35__QSSSetSpeechProfile_flatbuffData__block_invoke;
