...
{
  QSSMutableLanguageDetectionResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableLanguageDetectionResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("detected_locale"));
}
...
- (NSArray)predictions
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("predictions"));
}
