...
{
  return -[QSSTextToSpeechRouterStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechRouterStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[QSSTextToSpeechRouterStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechRouterStreamingStreamingResponse *v10;
  QSSTextToSpeechRouterStreamingStreamingResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSTextToSpeechRouterStreamingStreamingResponse *v26;
  uint64_t v28;
  unint64_t v29;
  __int128 v30;
  uint64_t v31;
  ...
  v10 = -[QSSTextToSpeechRouterStreamingStreamingResponse init](&v33, sel_init);
  v11 = v10;
  if (!v10)
    goto LABEL_35;
...
- (QSSBeginTextToSpeechStreamingResponse)contentAsQSSBeginTextToSpeechStreamingResponse
{
  ...
  if (-[QSSTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (QSSPartialTextToSpeechStreamingResponse)contentAsQSSPartialTextToSpeechStreamingResponse
{
  ...
  if (-[QSSTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (QSSFinalTextToSpeechStreamingResponse)contentAsQSSFinalTextToSpeechStreamingResponse
{
  ...
  if (-[QSSTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[QSSTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type");
  if (-[QSSTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
    -[QSSTextToSpeechRouterStreamingStreamingResponse contentAsQSSBeginTextToSpeechStreamingResponse](self, "contentAsQSSBeginTextToSpeechStreamingResponse");
  ...
  if (-[QSSTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[QSSTextToSpeechRouterStreamingStreamingResponse contentAsQSSPartialTextToSpeechStreamingResponse](self, "contentAsQSSPartialTextToSpeechStreamingResponse");
  ...
  if (-[QSSTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[QSSTextToSpeechRouterStreamingStreamingResponse contentAsQSSFinalTextToSpeechStreamingResponse](self, "contentAsQSSFinalTextToSpeechStreamingResponse");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechRouterStreamingStreamingResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __63__QSSTextToSpeechRouterStreamingStreamingResponse_flatbuffData__block_invoke;
