...
{
  return -[QSSRecognitionPhraseTokens initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSRecognitionPhraseTokens initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4
{
  return -[QSSRecognitionPhraseTokens initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSRecognitionPhraseTokens *v10;
  QSSRecognitionPhraseTokens *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::RecognitionPhraseTokens *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSRecognitionPhraseTokens *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSRecognitionPhraseTokens init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (NSArray)tokens
{
  ...
  const RecognitionPhraseTokens *v5;
  uint64_t v6;
...
- (Offset<siri::speech::schema_fb::RecognitionPhraseTokens>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSRecognitionPhraseTokens tokens](self, "tokens");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::RecognitionPhraseTokens> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSRecognitionPhraseTokens addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __42__QSSRecognitionPhraseTokens_flatbuffData__block_invoke;
