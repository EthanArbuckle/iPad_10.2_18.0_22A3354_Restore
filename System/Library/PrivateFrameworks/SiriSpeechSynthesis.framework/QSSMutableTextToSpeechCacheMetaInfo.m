...
{
  QSSMutableTextToSpeechCacheMetaInfo *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechCacheMetaInfo init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSTextToSpeechMeta *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("meta_info"));
}
...
{
  return (QSSAudioDescription *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("decoder_description"));
}
...
{
  return (QSSAudioDescription *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("playback_description"));
}
...
- (int)audio_length
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("audio_length"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
