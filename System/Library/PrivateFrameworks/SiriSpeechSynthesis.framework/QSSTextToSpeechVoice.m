...
{
  return -[QSSTextToSpeechVoice initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechVoice initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTextToSpeechVoice)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoice *)a4
{
  return -[QSSTextToSpeechVoice initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechVoice)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoice *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechVoice *v10;
  QSSTextToSpeechVoice *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSTextToSpeechVoice init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::TextToSpeechVoice>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSTextToSpeechVoice language](self, "language");
  ...
  -[QSSTextToSpeechVoice gender](self, "gender");
  ...
  -[QSSTextToSpeechVoice name](self, "name");
  ...
  -[QSSTextToSpeechVoice version](self, "version");
  ...
  -[QSSTextToSpeechVoice quality](self, "quality");
  ...
  -[QSSTextToSpeechVoice type](self, "type");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechVoice addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __36__QSSTextToSpeechVoice_flatbuffData__block_invoke;
