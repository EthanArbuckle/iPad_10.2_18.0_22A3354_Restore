...
{
  QSSMutableMultilingualStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableMultilingualStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (QSSStartMultilingualSpeechRequest)contentAsQSSStartMultilingualSpeechRequest
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSStartMultilingualSpeechRequest:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (QSSUpdateAudioInfo)contentAsQSSUpdateAudioInfo
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSUpdateAudioInfo:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSSetRequestOrigin)contentAsQSSSetRequestOrigin
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSSetRequestOrigin:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSSetSpeechContext)contentAsQSSSetSpeechContext
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSSetSpeechContext:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSSetSpeechProfile)contentAsQSSSetSpeechProfile
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSSetSpeechProfile:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSAudioPacket)contentAsQSSAudioPacket
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSFinishAudio)contentAsQSSFinishAudio
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 7);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSLanguageDetected)contentAsQSSLanguageDetected
{
  ...
  if (-[QSSMutableMultilingualStreamingRequest content_type](self, "content_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSLanguageDetected:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 8);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
