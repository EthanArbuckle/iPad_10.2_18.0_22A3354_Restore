...
{
  return -[QSSTTSPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTTSPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTTSPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSPhonemeSequence *)a4
{
  return -[QSSTTSPhonemeSequence initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTTSPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSPhonemeSequence *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTTSPhonemeSequence *v10;
  QSSTTSPhonemeSequence *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::TTSPhonemeSequence *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSTTSPhonemeSequence *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSTTSPhonemeSequence init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if ((_DWORD)v9)
        {
          ...
          do
          {
            v12 = -[QSSTTSWordPhonemes initWithFlatbuffData:root:verify:]([QSSTTSWordPhonemes alloc], "initWithFlatbuffData:root:verify:", self->_data, &v10[*(unsigned int *)v10->var0], 0);
...
- (Offset<siri::speech::schema_fb::TTSPhonemeSequence>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSTTSPhonemeSequence word_phonemes](self, "word_phonemes");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTTSPhonemeSequence addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __37__QSSTTSPhonemeSequence_flatbuffData__block_invoke;
