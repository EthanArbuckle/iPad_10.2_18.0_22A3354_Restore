...
{
  QSSMutableSpeechTranslationTextToSpeechResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableSpeechTranslationTextToSpeechResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("target_locale"));
}
...
{
  return (QSSTextToSpeechResponse *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("text_to_speech_response"));
}
