...
{
  QSSMutableStreamingTranslationRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableStreamingTranslationRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("translation_text"));
}
