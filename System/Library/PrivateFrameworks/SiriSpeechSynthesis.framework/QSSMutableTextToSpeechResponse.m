...
{
  QSSMutableTextToSpeechResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechResponse init](&v6, sel_init);
  if (v2)
  {
...
- (void)audio:(id)a3
{
  ...
  -[QSSMutableTextToSpeechResponse audio](self, "audio");
...
{
  return (QSSTextToSpeechResponseDevData *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("dev_data"));
}
