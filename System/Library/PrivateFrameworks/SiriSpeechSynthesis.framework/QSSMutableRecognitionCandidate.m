...
{
  QSSMutableRecognitionCandidate *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableRecognitionCandidate init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSRecognitionResult *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("recognition_result"));
}
...
- (NSString)result_id
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("result_id"));
}
...
- (double)snr
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("snr"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (int64_t)fingerprint_detection
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("fingerprint_detection"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (QSSAudioAnalytics *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("audio_analytics"));
}
...
{
  return (QSSLatnnMitigatorResult *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("latnn_mitigator_result"));
}
