...
{
  QSSMutableLanguageDetectionStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableLanguageDetectionStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSLanguageDetectionResponse)contentAsQSSLanguageDetectionResponse
{
  ...
  if (-[QSSMutableLanguageDetectionStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSLanguageDetectionResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableLanguageDetectionStreamingResponse setContent_type:](self, "setContent_type:", 1);
