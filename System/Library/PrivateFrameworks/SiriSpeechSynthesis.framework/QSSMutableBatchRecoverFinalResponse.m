...
{
  QSSMutableBatchRecoverFinalResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableBatchRecoverFinalResponse init](&v6, sel_init);
  if (v2)
  {
...
- (int)num_of_requested
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("num_of_requested"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
...
- (int)num_of_processed
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("num_of_processed"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
...
- (int)num_of_succeeded
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("num_of_succeeded"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "intValue");
