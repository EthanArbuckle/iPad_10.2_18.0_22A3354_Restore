...
- (QSSMutableLmScorerRequest)init
{
  ...
  v2 = -[QSSMutableLmScorerRequest init](&v6, sel_init);
  if (v2)
  {
...
- (NSString)transcript
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("transcript"));
}
