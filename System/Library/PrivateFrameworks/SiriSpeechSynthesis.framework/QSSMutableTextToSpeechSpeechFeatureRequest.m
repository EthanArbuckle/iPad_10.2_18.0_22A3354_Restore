...
{
  QSSMutableTextToSpeechSpeechFeatureRequest *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechSpeechFeatureRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSTextToSpeechSpeechFeatureModelIdentifier *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("model_id"));
}
...
{
  return (QSSTextToSpeechSpeechFeatureInputText *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("text"));
}
...
{
  return (QSSTextToSpeechSpeechFeatureInputWave *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("wave_data"));
}
