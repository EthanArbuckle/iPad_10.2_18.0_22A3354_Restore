...
{
  return -[QSSUserAcousticProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSUserAcousticProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSUserAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UserAcousticProfile *)a4
{
  return -[QSSUserAcousticProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSUserAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UserAcousticProfile *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSUserAcousticProfile *v10;
  QSSUserAcousticProfile *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::UserAcousticProfile *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSUserAcousticProfile *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSUserAcousticProfile init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::UserAcousticProfile>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSUserAcousticProfile acoustic_profile_version](self, "acoustic_profile_version");
  ...
  v19[4] = &v20;
  v19[5] = a3;
  -[QSSUserAcousticProfile acoustic_profile_blob:](self, "acoustic_profile_blob:", v19);
  -[QSSUserAcousticProfile profile_checksum](self, "profile_checksum");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::UserAcousticProfile> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSUserAcousticProfile addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __38__QSSUserAcousticProfile_flatbuffData__block_invoke;
