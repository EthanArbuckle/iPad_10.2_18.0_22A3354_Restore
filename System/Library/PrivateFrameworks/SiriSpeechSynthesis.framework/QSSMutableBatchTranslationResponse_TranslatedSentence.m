...
{
  QSSMutableBatchTranslationResponse_TranslatedSentence *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableBatchTranslationResponse_TranslatedSentence init](&v6, sel_init);
  if (v2)
  {
...
- (QSSSpan)source_span
{
  return (QSSSpan *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("source_span"));
}
...
- (QSSSpan)target_span
{
  return (QSSSpan *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("target_span"));
}
