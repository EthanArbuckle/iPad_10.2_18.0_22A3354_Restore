...
{
  return -[QSSTextToSpeechMeta initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechMeta initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTextToSpeechMeta)initWithFlatbuffData:(id)a3 root:(const TextToSpeechMeta *)a4
{
  return -[QSSTextToSpeechMeta initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechMeta)initWithFlatbuffData:(id)a3 root:(const TextToSpeechMeta *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechMeta *v10;
  QSSTextToSpeechMeta *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSTextToSpeechMeta init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
{
  QSSTextToSpeechVoice *v3;
  QSSTextToSpeechVoice *v4;
  ...
  v3 = (QSSTextToSpeechVoice *)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    ...
    if (*(unsigned __int16 *)v6->var0 >= 5u && (v7 = *(unsigned __int16 *)v6[4].var0) != 0)
      ...
      v8 = 0;
    v3 = -[QSSTextToSpeechVoice initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
{
  QSSTextToSpeechResource *v3;
  QSSTextToSpeechResource *v4;
  const TextToSpeechMeta *root;
  const TextToSpeechMeta *v6;
  uint64_t v7;
  const TextToSpeechMeta *v8;
  ...
  v3 = (QSSTextToSpeechResource *)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    ...
    if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
      ...
      v8 = 0;
    v3 = -[QSSTextToSpeechResource initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
- (Offset<siri::speech::schema_fb::TextToSpeechMeta>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSTextToSpeechMeta voice](self, "voice");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "addObjectToBuffer:", a3);

  -[QSSTextToSpeechMeta resource](self, "resource");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechMeta addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __35__QSSTextToSpeechMeta_flatbuffData__block_invoke;
