...
- (QSSMutableLmScorerResponse)init
{
  ...
  v2 = -[QSSMutableLmScorerResponse init](&v6, sel_init);
  if (v2)
  {
...
- (double)ppl
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("ppl"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
