...
{
  QSSMutableTextToSpeechRequestProsodyTransferConfig *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechRequestProsodyTransferConfig init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSTextToSpeechUserVoiceProfile *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("user_voice_profile"));
}
