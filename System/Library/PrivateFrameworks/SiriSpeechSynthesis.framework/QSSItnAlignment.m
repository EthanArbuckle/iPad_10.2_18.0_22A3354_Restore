...
{
  return -[QSSItnAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSItnAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSItnAlignment)initWithFlatbuffData:(id)a3 root:(const ItnAlignment *)a4
{
  return -[QSSItnAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSItnAlignment)initWithFlatbuffData:(id)a3 root:(const ItnAlignment *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::ItnAlignment *root;
  uint64_t v21;
  ...
  v10 = -[QSSItnAlignment init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::ItnAlignment>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = self;
  v5 = -[QSSItnAlignment first_pre_itn_token_index](self, "first_pre_itn_token_index");
  v6 = -[QSSItnAlignment last_pre_itn_token_index](v4, "last_pre_itn_token_index");
  v7 = -[QSSItnAlignment first_post_itn_char_pos](v4, "first_post_itn_char_pos");
  LODWORD(v4) = -[QSSItnAlignment last_post_itn_char_pos](v4, "last_post_itn_char_pos");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::ItnAlignment> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSItnAlignment addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __31__QSSItnAlignment_flatbuffData__block_invoke;
