...
{
  QSSMutableUpdatedAcousticProfile *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableUpdatedAcousticProfile init](&v6, sel_init);
  if (v2)
  {
...
{
  return (QSSUserAcousticProfile *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("updated_acoustic_profile"));
}
