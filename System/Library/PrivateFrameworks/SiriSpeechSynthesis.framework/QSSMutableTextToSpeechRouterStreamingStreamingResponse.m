...
{
  QSSMutableTextToSpeechRouterStreamingStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableTextToSpeechRouterStreamingStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSBeginTextToSpeechStreamingResponse)contentAsQSSBeginTextToSpeechStreamingResponse
{
  ...
  if (-[QSSMutableTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSBeginTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechRouterStreamingStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (QSSPartialTextToSpeechStreamingResponse)contentAsQSSPartialTextToSpeechStreamingResponse
{
  ...
  if (-[QSSMutableTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSPartialTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechRouterStreamingStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSFinalTextToSpeechStreamingResponse)contentAsQSSFinalTextToSpeechStreamingResponse
{
  ...
  if (-[QSSMutableTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSFinalTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableTextToSpeechRouterStreamingStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
