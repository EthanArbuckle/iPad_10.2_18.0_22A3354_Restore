...
{
  return -[QSSTextToSpeechSpeechFeatureInputWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechSpeechFeatureInputWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWord *)a4
{
  return -[QSSTextToSpeechSpeechFeatureInputWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWord *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechSpeechFeatureInputWord *v10;
  QSSTextToSpeechSpeechFeatureInputWord *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSTextToSpeechSpeechFeatureInputWord *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSTextToSpeechSpeechFeatureInputWord init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (NSArray)phonemes
{
  void *v3;
  const TextToSpeechSpeechFeatureInputWord *root;
  const TextToSpeechSpeechFeatureInputWord *v5;
  uint64_t v6;
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSTextToSpeechSpeechFeatureInputWord word](self, "word");
  ...
  -[QSSTextToSpeechSpeechFeatureInputWord phonemes](self, "phonemes");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechSpeechFeatureInputWord addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __53__QSSTextToSpeechSpeechFeatureInputWord_flatbuffData__block_invoke;
