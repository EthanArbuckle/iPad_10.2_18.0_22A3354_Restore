...
- (QSSMutableVocToken)init
{
  ...
  v2 = -[QSSMutableVocToken init](&v6, sel_init);
  if (v2)
  {
...
- (NSData)blob
{
  return (NSData *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("blob"));
}
...
- (void)blob:(id)a3
{
  ...
  -[QSSMutableVocToken blob](self, "blob");
