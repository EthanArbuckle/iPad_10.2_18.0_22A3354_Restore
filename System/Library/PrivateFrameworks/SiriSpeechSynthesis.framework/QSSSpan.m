...
{
  return -[QSSSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSSpan)initWithFlatbuffData:(id)a3 root:(const Span *)a4
{
  return -[QSSSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSSpan)initWithFlatbuffData:(id)a3 root:(const Span *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::Span *root;
  uint64_t v21;
...
- (Offset<siri::speech::schema_fb::Span>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[QSSSpan start_index](self, "start_index");
  v6 = -[QSSSpan end_index](self, "end_index");
  v7 = -[QSSSpan do_not_translate](self, "do_not_translate");
  -[QSSSpan meta_info](self, "meta_info");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::Span> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSSpan addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __23__QSSSpan_flatbuffData__block_invoke;
