...
{
  return -[QSSContextWithPronHints initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSContextWithPronHints initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3 root:(const ContextWithPronHints *)a4
{
  return -[QSSContextWithPronHints initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3 root:(const ContextWithPronHints *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSContextWithPronHints *v10;
  QSSContextWithPronHints *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSContextWithPronHints init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::ContextWithPronHints>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSContextWithPronHints contextual_text](self, "contextual_text");
  ...
  -[QSSContextWithPronHints pron_hints](self, "pron_hints");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::ContextWithPronHints> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSContextWithPronHints addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __39__QSSContextWithPronHints_flatbuffData__block_invoke;
