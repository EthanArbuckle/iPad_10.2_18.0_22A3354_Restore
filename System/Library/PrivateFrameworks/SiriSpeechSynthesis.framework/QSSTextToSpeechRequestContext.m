...
{
  return -[QSSTextToSpeechRequestContext initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechRequestContext initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTextToSpeechRequestContext)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestContext *)a4
{
  return -[QSSTextToSpeechRequestContext initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechRequestContext)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestContext *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechRequestContext *v10;
  QSSTextToSpeechRequestContext *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSTextToSpeechRequestContext *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSTextToSpeechRequestContext init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (NSArray)context_info
{
  ...
  uint64_t v11;
  QSSTextToSpeechRequestContext_ContextInfoEntry *v12;
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if ((_DWORD)v9)
        {
          ...
          do
          {
            v12 = -[QSSTextToSpeechRequestContext_ContextInfoEntry initWithFlatbuffData:root:verify:]([QSSTextToSpeechRequestContext_ContextInfoEntry alloc], "initWithFlatbuffData:root:verify:", self->_data, &v10[*(unsigned int *)v10->var0], 0);
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestContext>)addObjectToBuffer:(void *)a3
{
  ...
  int v38;
  int v39;
  Offset<siri::speech::schema_fb::TextToSpeechRequestContext> v40;
  QSSTextToSpeechRequestContext *v42;
  void *v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
  ...
  -[QSSTextToSpeechRequestContext context_info](self, "context_info");
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        v15 = objc_msgSend(*(id *)(*((_QWORD *)&v44 + 1) + 8 * i), "addObjectToBuffer:", a3, v42);
        v16 = v15;
        if (v13 >= v9)
        {
          v17 = (v13 - v7) >> 2;
  ...
  -[QSSTextToSpeechRequestContext dialog_identifier](v42, "dialog_identifier");
  v31 = (__CFString *)objc_claimAutoreleasedReturnValue();
  v32 = v31;
  if (!v31)
    v31 = &stru_24E246F88;
  v33 = (const char *)-[__CFString UTF8String](objc_retainAutorelease(v31), "UTF8String");
  v34 = strlen(v33);
  String = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v33, v34);
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  if (v30)
  {
    v39 = flatbuffers::FlatBufferBuilder::ReferTo((flatbuffers::FlatBufferBuilder *)a3, v30);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechRequestContext addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __45__QSSTextToSpeechRequestContext_flatbuffData__block_invoke;
