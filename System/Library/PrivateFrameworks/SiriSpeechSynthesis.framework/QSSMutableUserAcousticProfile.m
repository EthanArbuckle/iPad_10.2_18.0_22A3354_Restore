...
{
  QSSMutableUserAcousticProfile *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableUserAcousticProfile init](&v6, sel_init);
  if (v2)
  {
...
- (void)acoustic_profile_blob:(id)a3
{
  ...
  -[QSSMutableUserAcousticProfile acoustic_profile_blob](self, "acoustic_profile_blob");
