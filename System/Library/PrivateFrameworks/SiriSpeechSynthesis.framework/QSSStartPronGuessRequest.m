...
{
  return -[QSSStartPronGuessRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSStartPronGuessRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSStartPronGuessRequest)initWithFlatbuffData:(id)a3 root:(const StartPronGuessRequest *)a4
{
  return -[QSSStartPronGuessRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSStartPronGuessRequest)initWithFlatbuffData:(id)a3 root:(const StartPronGuessRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSStartPronGuessRequest *v10;
  QSSStartPronGuessRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::StartPronGuessRequest *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSStartPronGuessRequest *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSStartPronGuessRequest init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::StartPronGuessRequest>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSStartPronGuessRequest speech_id](self, "speech_id");
  ...
  -[QSSStartPronGuessRequest session_id](self, "session_id");
  ...
  -[QSSStartPronGuessRequest orthography](self, "orthography");
  ...
  -[QSSStartPronGuessRequest language](self, "language");
  ...
  v24 = -[QSSStartPronGuessRequest codec](self, "codec");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::StartPronGuessRequest> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSStartPronGuessRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __40__QSSStartPronGuessRequest_flatbuffData__block_invoke;
