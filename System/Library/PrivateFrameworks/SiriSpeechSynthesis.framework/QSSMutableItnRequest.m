...
- (QSSMutableItnRequest)init
{
  ...
  v2 = -[QSSMutableItnRequest init](&v6, sel_init);
  if (v2)
  {
...
- (NSArray)words_list
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("words_list"));
}
