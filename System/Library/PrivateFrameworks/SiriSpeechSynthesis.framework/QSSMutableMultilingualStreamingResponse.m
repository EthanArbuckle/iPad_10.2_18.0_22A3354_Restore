...
{
  QSSMutableMultilingualStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableMultilingualStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSFinalSpeechRecognitionResponse)contentAsQSSFinalSpeechRecognitionResponse
{
  ...
  if (-[QSSMutableMultilingualStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSFinalSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (QSSPartialSpeechRecognitionResponse)contentAsQSSPartialSpeechRecognitionResponse
{
  ...
  if (-[QSSMutableMultilingualStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSPartialSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSRecognitionCandidate)contentAsQSSRecognitionCandidate
{
  ...
  if (-[QSSMutableMultilingualStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSRecognitionCandidate:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSRequestStatsResponse)contentAsQSSRequestStatsResponse
{
  ...
  if (-[QSSMutableMultilingualStreamingResponse content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSRequestStatsResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingResponse setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSAudioLimitExceeded)contentAsQSSAudioLimitExceeded
{
  ...
  if (-[QSSMutableMultilingualStreamingResponse content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSAudioLimitExceeded:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingResponse setContent_type:](self, "setContent_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (QSSFinalBlazarResponse)contentAsQSSFinalBlazarResponse
{
  ...
  if (-[QSSMutableMultilingualStreamingResponse content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSFinalBlazarResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableMultilingualStreamingResponse setContent_type:](self, "setContent_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
