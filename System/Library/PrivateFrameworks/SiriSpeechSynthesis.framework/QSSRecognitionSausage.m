...
{
  return -[QSSRecognitionSausage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSRecognitionSausage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4
{
  return -[QSSRecognitionSausage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSRecognitionSausage *v10;
  QSSRecognitionSausage *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  v10 = -[QSSRecognitionSausage init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::RecognitionSausage>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSRecognitionSausage positional_tok_phrase_alt](self, "positional_tok_phrase_alt");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::RecognitionSausage> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSRecognitionSausage addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __37__QSSRecognitionSausage_flatbuffData__block_invoke;
