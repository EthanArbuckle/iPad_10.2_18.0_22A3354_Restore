...
{
  return -[QSSTextToSpeechSpeechFeatureInputWave initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSTextToSpeechSpeechFeatureInputWave initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSTextToSpeechSpeechFeatureInputWave)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWave *)a4
{
  return -[QSSTextToSpeechSpeechFeatureInputWave initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSTextToSpeechSpeechFeatureInputWave)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWave *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSTextToSpeechSpeechFeatureInputWave *v10;
  QSSTextToSpeechSpeechFeatureInputWave *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  QSSTextToSpeechSpeechFeatureInputWave *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSTextToSpeechSpeechFeatureInputWave init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWave>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = self;
  v5 = -[QSSTextToSpeechSpeechFeatureInputWave sample_rate](self, "sample_rate");
  v10 = 0;
  v11 = &v10;
  v12 = 0x3812000000;
  ...
  v9[4] = &v10;
  v9[5] = a3;
  -[QSSTextToSpeechSpeechFeatureInputWave pcm_data:](v4, "pcm_data:", v9);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSTextToSpeechSpeechFeatureInputWave addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __53__QSSTextToSpeechSpeechFeatureInputWave_flatbuffData__block_invoke;
