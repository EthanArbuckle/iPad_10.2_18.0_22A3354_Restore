...
{
  QSSMutableBatchRecoverStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[QSSMutableBatchRecoverStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (QSSPronGuessResponse)contentAsQSSPronGuessResponse
{
  ...
  if (-[QSSMutableBatchRecoverStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsQSSPronGuessResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableBatchRecoverStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (QSSBatchRecoverFinalResponse)contentAsQSSBatchRecoverFinalResponse
{
  ...
  if (-[QSSMutableBatchRecoverStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsQSSBatchRecoverFinalResponse:(id)a3
{
  ...
  v5 = a3;
  -[QSSMutableBatchRecoverStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
