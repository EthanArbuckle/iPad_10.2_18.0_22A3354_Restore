...
{
  return -[QSSWebTranslationInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[QSSWebTranslationInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (QSSWebTranslationInfo)initWithFlatbuffData:(id)a3 root:(const WebTranslationInfo *)a4
{
  return -[QSSWebTranslationInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (QSSWebTranslationInfo)initWithFlatbuffData:(id)a3 root:(const WebTranslationInfo *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  QSSWebTranslationInfo *v10;
  QSSWebTranslationInfo *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  unint64_t v19;
  siri::speech::schema_fb::WebTranslationInfo *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  QSSWebTranslationInfo *v23;
  uint64_t v25;
  unint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[QSSWebTranslationInfo init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (Offset<siri::speech::schema_fb::WebTranslationInfo>)addObjectToBuffer:(void *)a3
{
  ...
  -[QSSWebTranslationInfo text](self, "text");
  ...
  -[QSSWebTranslationInfo spans](self, "spans");
...
- (id)flatbuffData
{
  Offset<siri::speech::schema_fb::WebTranslationInfo> v2;
  const char *v3;
  ...
  v18 = 256;
  v19 = 0;
  v2.var0 = -[QSSWebTranslationInfo addObjectToBuffer:](self, "addObjectToBuffer:", &v11);
  ...
  v10[1] = 3221225472;
  v10[2] = __37__QSSWebTranslationInfo_flatbuffData__block_invoke;
