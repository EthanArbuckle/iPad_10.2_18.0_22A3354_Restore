...
{
  CTCarrierSpaceUsagePlanMetrics *v2;
  CTCarrierSpaceUsagePlanMetrics *v3;
  NSString *planLabel;
  ...
  v2 = -[CTCarrierSpaceUsagePlanMetrics init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  -[CTCarrierSpaceUsagePlanMetrics planLabel](self, "planLabel");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planLabel=%@"), v4);

  objc_msgSend(v3, "appendFormat:", CFSTR(", planCategory=%s"), CTCarrierSpacePlanCategoryAsString(-[CTCarrierSpaceUsagePlanMetrics planCategory](self, "planCategory")));
  objc_msgSend(v3, "appendFormat:", CFSTR(", currentUsedPlan=%d"), -[CTCarrierSpaceUsagePlanMetrics currentUsedPlan](self, "currentUsedPlan"));
  -[CTCarrierSpaceUsagePlanMetrics dataUsage](self, "dataUsage");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", data=%@"), v5);

  -[CTCarrierSpaceUsagePlanMetrics messages](self, "messages");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", messages=%@"), v6);

  -[CTCarrierSpaceUsagePlanMetrics voice](self, "voice");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", voice=%@"), v7);

  -[CTCarrierSpaceUsagePlanMetrics remainingBalance](self, "remainingBalance");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", remainingBalance=%@"), v8);

  objc_msgSend(v3, "appendFormat:", CFSTR(", throttled=%d"), -[CTCarrierSpaceUsagePlanMetrics throttled](self, "throttled"));
  -[CTCarrierSpaceUsagePlanMetrics lastUpdatedAt](self, "lastUpdatedAt");
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v4;
  void *v5;
  CTCarrierSpaceUsagePlanMetrics *v7;
  void *v8;
  void *v9;
  char v10;
  int64_t v11;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      -[CTCarrierSpaceUsagePlanMetrics planLabel](self, "planLabel");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      -[CTCarrierSpaceUsagePlanMetrics planLabel](v7, "planLabel");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      if (v8 != v9)
      {
        -[CTCarrierSpaceUsagePlanMetrics planLabel](self, "planLabel");
      ...
      v11 = -[CTCarrierSpaceUsagePlanMetrics planCategory](self, "planCategory");
      if (v11 != -[CTCarrierSpaceUsagePlanMetrics planCategory](v7, "planCategory")
        || (v12 = -[CTCarrierSpaceUsagePlanMetrics currentUsedPlan](self, "currentUsedPlan"),
            v12 != -[CTCarrierSpaceUsagePlanMetrics currentUsedPlan](v7, "currentUsedPlan")))
      {
        v10 = 0;
        goto LABEL_43;
      }
      ...
      -[CTCarrierSpaceUsagePlanMetrics dataUsage](v7, "dataUsage");
      ...
      -[CTCarrierSpaceUsagePlanMetrics messages](v7, "messages");
...
LABEL_41:
      ...
      -[CTCarrierSpaceUsagePlanMetrics voice](v7, "voice");
...
LABEL_38:
      ...
      -[CTCarrierSpaceUsagePlanMetrics remainingBalance](v7, "remainingBalance");
      ...
      v32 = -[CTCarrierSpaceUsagePlanMetrics throttled](self, "throttled");
      if (v32 == -[CTCarrierSpaceUsagePlanMetrics throttled](v7, "throttled"))
      {
        -[CTCarrierSpaceUsagePlanMetrics lastUpdatedAt](self, "lastUpdatedAt");
        v33 = (void *)objc_claimAutoreleasedReturnValue();
        -[CTCarrierSpaceUsagePlanMetrics lastUpdatedAt](v7, "lastUpdatedAt");
...
{
  id v4;
  CTCarrierSpaceUsagePlanMetrics *v5;
  uint64_t v6;
  NSString *planLabel;
  uint64_t v8;
  CTCarrierSpaceUsagePlanItemData *dataUsage;
  ...
  v5 = -[CTCarrierSpaceUsagePlanMetrics init](&v19, sel_init);
  if (v5)
  {
