...
{
  CTCarrierSpaceUsagePlanItemVoice *v2;
  CTCarrierSpaceUsagePlanItemVoice *v3;
  ...
  v2 = -[CTCarrierSpaceUsagePlanItemVoice init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  -[CTCarrierSpaceUsagePlanItemVoice minutesCapacity](self, "minutesCapacity");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", minutesCapacity=%@"), v4);

  -[CTCarrierSpaceUsagePlanItemVoice minutesUsed](self, "minutesUsed");
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  void *v4;
  CTCarrierSpaceUsagePlanItemVoice *v6;
  void *v7;
  void *v8;
  char v9;
  void *v10;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CTCarrierSpaceUsagePlanItemVoice minutesCapacity](v6, "minutesCapacity");
            ...
            objc_msgSend(v3, "isEqualToString:", v4)))
      {
        ...
        -[CTCarrierSpaceUsagePlanItemVoice minutesUsed](v6, "minutesUsed");
...
{
  id v4;
  CTCarrierSpaceUsagePlanItemVoice *v5;
  uint64_t v6;
  NSString *minutesCapacity;
  uint64_t v8;
  NSString *minutesUsed;
  ...
  v5 = -[CTCarrierSpaceUsagePlanItemVoice init](&v11, sel_init);
  if (v5)
  {
