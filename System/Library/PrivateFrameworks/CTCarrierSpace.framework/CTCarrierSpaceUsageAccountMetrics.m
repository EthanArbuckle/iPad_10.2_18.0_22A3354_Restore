...
{
  CTCarrierSpaceUsageAccountMetrics *v2;
  CTCarrierSpaceUsageAccountMetrics *v3;
  ...
  v2 = -[CTCarrierSpaceUsageAccountMetrics init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  -[CTCarrierSpaceUsageAccountMetrics networkUsageLabel](self, "networkUsageLabel");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", networkUsageLabel=%@"), v4);

  objc_msgSend(v3, "appendFormat:", CFSTR(", deviceType=%s"), CTCarrierSpaceDeviceTypeAsString(-[CTCarrierSpaceUsageAccountMetrics deviceType](self, "deviceType")));
  objc_msgSend(v3, "appendFormat:", CFSTR(", localDevice=%d"), -[CTCarrierSpaceUsageAccountMetrics localDevice](self, "localDevice"));
  -[CTCarrierSpaceUsageAccountMetrics subscriptionStatus](self, "subscriptionStatus");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", subscriptionStatus=%@"), v5);

  -[CTCarrierSpaceUsageAccountMetrics planType](self, "planType");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planType=%@"), v6);

  -[CTCarrierSpaceUsageAccountMetrics billingCycleEndDate](self, "billingCycleEndDate");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", billingCycleEndDate=%@"), v7);

  -[CTCarrierSpaceUsageAccountMetrics applicablePlans](self, "applicablePlans");
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v4;
  void *v5;
  CTCarrierSpaceUsageAccountMetrics *v7;
  void *v8;
  void *v9;
  char v10;
  int64_t v11;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      -[CTCarrierSpaceUsageAccountMetrics networkUsageLabel](self, "networkUsageLabel");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      -[CTCarrierSpaceUsageAccountMetrics networkUsageLabel](v7, "networkUsageLabel");
      ...
      v11 = -[CTCarrierSpaceUsageAccountMetrics deviceType](self, "deviceType");
      if (v11 != -[CTCarrierSpaceUsageAccountMetrics deviceType](v7, "deviceType")
        || (v12 = -[CTCarrierSpaceUsageAccountMetrics localDevice](self, "localDevice"),
            v12 != -[CTCarrierSpaceUsageAccountMetrics localDevice](v7, "localDevice")))
      {
        v10 = 0;
        goto LABEL_31;
      }
      ...
      -[CTCarrierSpaceUsageAccountMetrics subscriptionStatus](v7, "subscriptionStatus");
      ...
      -[CTCarrierSpaceUsageAccountMetrics planType](v7, "planType");
      v39 = v5;
...
LABEL_29:
      ...
      -[CTCarrierSpaceUsageAccountMetrics billingCycleEndDate](v7, "billingCycleEndDate");
            ...
            objc_msgSend(v21, "isEqualToDate:")))
      {
        ...
        -[CTCarrierSpaceUsageAccountMetrics applicablePlans](v7, "applicablePlans");
...
{
  id v4;
  CTCarrierSpaceUsageAccountMetrics *v5;
  uint64_t v6;
  NSString *networkUsageLabel;
  uint64_t v8;
  NSString *subscriptionStatus;
  ...
  v5 = -[CTCarrierSpaceUsageAccountMetrics init](&v20, sel_init);
  if (v5)
  {
