...
{
  CTCarrierSpacePlansInfo *v2;
  CTCarrierSpacePlansInfo *v3;
  NSArray *planGroupsList;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)CTCarrierSpacePlansInfo;
  v2 = -[CTCarrierSpacePlansInfo init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  -[CTCarrierSpacePlansInfo planGroupsList](self, "planGroupsList");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(" planGroupsList=%@"), v4);

  -[CTCarrierSpacePlansInfo morePlansURL](self, "morePlansURL");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CTCarrierSpacePlansInfo planGroupsList](v6, "planGroupsList");
            ...
            objc_msgSend(v3, "isEqualToArray:", v4)))
      {
        ...
        -[CTCarrierSpacePlansInfo morePlansURL](v6, "morePlansURL");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = a3;
  objc_msgSend(v5, "encodeObject:forKey:", planGroupsList, CFSTR("planGroupsList"));
...
- (CTCarrierSpacePlansInfo)initWithCoder:(id)a3
{
  ...
  v5 = -[CTCarrierSpacePlansInfo init](&v14, sel_init);
  if (v5)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v8, CFSTR("planGroupsList"));
...
{
  objc_storeStrong((id *)&self->_planGroupsList, a3);
}
