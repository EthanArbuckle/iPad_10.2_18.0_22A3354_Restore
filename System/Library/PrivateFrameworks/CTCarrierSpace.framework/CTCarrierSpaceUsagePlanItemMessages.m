...
{
  CTCarrierSpaceUsagePlanItemMessages *v2;
  CTCarrierSpaceUsagePlanItemMessages *v3;
  NSString *capacity;
  NSString *used;
  objc_super v7;
  ...
  v2 = -[CTCarrierSpaceUsagePlanItemMessages init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  -[CTCarrierSpaceUsagePlanItemMessages capacity](self, "capacity");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", capacity=%@"), v4);

  -[CTCarrierSpaceUsagePlanItemMessages used](self, "used");
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  void *v4;
  CTCarrierSpaceUsagePlanItemMessages *v6;
  void *v7;
  void *v8;
  char v9;
  void *v10;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CTCarrierSpaceUsagePlanItemMessages capacity](v6, "capacity");
            ...
            objc_msgSend(v3, "isEqualToString:", v4)))
      {
        ...
        -[CTCarrierSpaceUsagePlanItemMessages used](v6, "used");
...
{
  id v4;
  CTCarrierSpaceUsagePlanItemMessages *v5;
  uint64_t v6;
  NSString *capacity;
  uint64_t v8;
  NSString *used;
  ...
  v5 = -[CTCarrierSpaceUsagePlanItemMessages init](&v11, sel_init);
  if (v5)
  {
