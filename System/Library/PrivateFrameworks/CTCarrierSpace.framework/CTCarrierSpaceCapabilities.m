...
- (id)description
{
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR(" supportsServices=%d"), -[CTCarrierSpaceCapabilities supportsServices](self, "supportsServices"));
  objc_msgSend(v3, "appendFormat:", CFSTR(" supportsUsage=%d"), -[CTCarrierSpaceCapabilities supportsUsage](self, "supportsUsage"));
  objc_msgSend(v3, "appendFormat:", CFSTR(" supportsPlans=%d"), -[CTCarrierSpaceCapabilities supportsPlans](self, "supportsPlans"));
  objc_msgSend(v3, "appendFormat:", CFSTR(" supportsApplications=%d"), -[CTCarrierSpaceCapabilities supportsApplications](self, "supportsApplications"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0
      && (v5 = -[CTCarrierSpaceCapabilities supportsServices](self, "supportsServices"),
          v5 == -[CTCarrierSpaceCapabilities supportsServices](v4, "supportsServices"))
      && (v6 = -[CTCarrierSpaceCapabilities supportsUsage](self, "supportsUsage"),
          v6 == -[CTCarrierSpaceCapabilities supportsUsage](v4, "supportsUsage"))
      && (v7 = -[CTCarrierSpaceCapabilities supportsPlans](self, "supportsPlans"),
          v7 == -[CTCarrierSpaceCapabilities supportsPlans](v4, "supportsPlans")))
    {
      v10 = -[CTCarrierSpaceCapabilities supportsApplications](self, "supportsApplications");
      v8 = v10 ^ -[CTCarrierSpaceCapabilities supportsApplications](v4, "supportsApplications") ^ 1;
    }
    else
    {
      LOBYTE(v8) = 0;
...
{
  id v4;
  CTCarrierSpaceCapabilities *v5;
  objc_super v7;

  v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)CTCarrierSpaceCapabilities;
  v5 = -[CTCarrierSpaceCapabilities init](&v7, sel_init);
  if (v5)
  {
