...
- (HAPCharacteristicValueTransitionFetch)init
{
  ...
  return -[HAPCharacteristicValueTransitionFetch init](&v3, sel_init);
}
...
- (HAPCharacteristicValueTransitionFetch)initWithHAPInstanceID:(id)a3
{
  ...
  v6 = -[HAPCharacteristicValueTransitionFetch init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  BOOL v17;
  uint64_t v18;
  HAPCharacteristicValueTransitionFetch *v20;
  id v21;
  unint64_t v22;
  uint64_t v23;
  uint64_t v24;
...
- (id)serializeWithError:(id *)a3
{
  ...
  v16 = 0u;
  TLV8BufferInit();
  -[HAPCharacteristicValueTransitionFetch HAPInstanceID](self, "HAPInstanceID");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPCharacteristicValueTransitionFetch HAPInstanceID](self, "HAPInstanceID");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPCharacteristicValueTransitionFetch HAPInstanceID](v5, "HAPInstanceID");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      if (v6 == v7)
      {
        v10 = 1;
...
- (NSString)description
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("<HAPCharacteristicValueTransitionFetch HAPInstanceID=%@>"), v3);
