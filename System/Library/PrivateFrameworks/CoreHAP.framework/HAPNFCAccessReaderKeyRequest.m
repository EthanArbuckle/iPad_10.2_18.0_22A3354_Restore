...
- (HAPNFCAccessReaderKeyRequest)init
{
  ...
  return -[HAPNFCAccessReaderKeyRequest init](&v3, sel_init);
}
...
- (HAPNFCAccessReaderKeyRequest)initWithType:(id)a3 key:(id)a4 readerIdentifier:(id)a5 identifier:(id)a6
{
  ...
  id v13;
  id v14;
  HAPNFCAccessReaderKeyRequest *v15;
  HAPNFCAccessReaderKeyRequest *v16;
  objc_super v18;
  ...
  v15 = -[HAPNFCAccessReaderKeyRequest init](&v18, sel_init);
  v16 = v15;
  if (v15)
  {
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  BOOL v23;
  uint64_t v24;
  HAPNFCAccessReaderKeyRequest *v26;
  id *v27;
  void *v28;
  id v29;
  id v30;
  ...
  if (v8 < 1)
  {
    ...
    v12 = 0;
LABEL_24:
    -[HAPNFCAccessReaderKeyRequest setType:](self, "setType:", v12, v26);
    -[HAPNFCAccessReaderKeyRequest setKey:](self, "setKey:", v22);
    -[HAPNFCAccessReaderKeyRequest setReaderIdentifier:](self, "setReaderIdentifier:", v11);
    -[HAPNFCAccessReaderKeyRequest setIdentifier:](self, "setIdentifier:", v10);
    v9 = 0;
    v23 = 1;
  }
  else
...
- (id)serializeWithError:(id *)a3
{
  ...
  v39 = 0u;
  TLV8BufferInit();
  -[HAPNFCAccessReaderKeyRequest type](self, "type");
...
LABEL_31:
  ...
  -[HAPNFCAccessReaderKeyRequest key](self, "key");
  ...
  {
LABEL_13:
    -[HAPNFCAccessReaderKeyRequest readerIdentifier](self, "readerIdentifier");
    v18 = (void *)objc_claimAutoreleasedReturnValue();

    if (!v18)
    {
LABEL_22:
      -[HAPNFCAccessReaderKeyRequest identifier](self, "identifier");
...
{
  HAPNFCAccessReaderKeyRequest *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  HAPNFCAccessReaderKeyRequest *v9;

  v4 = +[HAPNFCAccessReaderKeyRequest allocWithZone:](HAPNFCAccessReaderKeyRequest, "allocWithZone:", a3);
  -[HAPNFCAccessReaderKeyRequest type](self, "type");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HAPNFCAccessReaderKeyRequest key](self, "key");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v9 = -[HAPNFCAccessReaderKeyRequest initWithType:key:readerIdentifier:identifier:](v4, "initWithType:key:readerIdentifier:identifier:", v5, v6, v7, v8);
...
{
  void *v3;
  HAPNFCAccessReaderKeyRequest *v5;
  HAPNFCAccessReaderKeyRequest *v6;
  void *v7;
  void *v8;
  void *v9;
  char v10;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPNFCAccessReaderKeyRequest type](self, "type");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPNFCAccessReaderKeyRequest type](v6, "type");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      if (v7 != v8)
      {
        -[HAPNFCAccessReaderKeyRequest type](self, "type");
      ...
      -[HAPNFCAccessReaderKeyRequest key](self, "key");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPNFCAccessReaderKeyRequest key](v6, "key");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      if (v11 != v12)
      {
        -[HAPNFCAccessReaderKeyRequest key](self, "key");
...
LABEL_25:
      ...
      -[HAPNFCAccessReaderKeyRequest readerIdentifier](v6, "readerIdentifier");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v30 = (void *)v14;
      if ((void *)v14 == v15)
      {
      ...
      -[HAPNFCAccessReaderKeyRequest identifier](v6, "identifier");
...
- (NSString)description
{
  ...
  -[HAPNFCAccessReaderKeyRequest identifier](self, "identifier");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<HAPNFCAccessReaderKeyRequest type=%@, key=%@, readerIdentifier=%@, identifier=%@>"), v4, v5, v6, v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  id v5;
  HAPNFCAccessReaderKeyRequest *v6;
  HAPNFCAccessReaderKeyRequest *v7;
  id v8;
  id v10;
  ...
  {
    v10 = 0;
    -[HAPNFCAccessReaderKeyRequest parseFromData:error:](v6, "parseFromData:error:", v5, &v10);
    v8 = v10;
    if (v8)
    {
