...
- (HAPFirmwareUpdateReadiness)init
{
  ...
  return -[HAPFirmwareUpdateReadiness init](&v3, sel_init);
}
...
- (HAPFirmwareUpdateReadiness)initWithStagingNotReadyReasons:(id)a3 updateNotReadyReasons:(id)a4
{
  ...
  v9 = -[HAPFirmwareUpdateReadiness init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
LABEL_18:
    ...
    if (v29 == 2)
    {
      ...
      v24 = v11;
      v15 = &v24;
      +[HAPUpdateNotReadyReasonsWrapper parsedFromData:error:](HAPUpdateNotReadyReasonsWrapper, "parsedFromData:error:", v14, &v24);
      v16 = v9;
    ...
    if (v29 == 1)
    {
      ...
      v25 = v11;
      v15 = &v25;
      +[HAPStagingNotReadyReasonsWrapper parsedFromData:error:](HAPStagingNotReadyReasonsWrapper, "parsedFromData:error:", v14, &v25);
      v16 = v10;
...
- (id)serializeWithError:(id *)a3
{
  ...
  v19 = 0u;
  TLV8BufferInit();
  -[HAPFirmwareUpdateReadiness stagingNotReadyReasons](self, "stagingNotReadyReasons");
...
LABEL_14:
  ...
  -[HAPFirmwareUpdateReadiness updateNotReadyReasons](self, "updateNotReadyReasons");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPFirmwareUpdateReadiness stagingNotReadyReasons](self, "stagingNotReadyReasons");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPFirmwareUpdateReadiness stagingNotReadyReasons](v6, "stagingNotReadyReasons");
...
LABEL_14:
      ...
      -[HAPFirmwareUpdateReadiness updateNotReadyReasons](self, "updateNotReadyReasons");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPFirmwareUpdateReadiness updateNotReadyReasons](v6, "updateNotReadyReasons");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      if (v11 == v12)
      {
        v10 = 1;
...
- (NSString)description
{
  ...
  -[HAPFirmwareUpdateReadiness updateNotReadyReasons](self, "updateNotReadyReasons");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<HAPFirmwareUpdateReadiness stagingNotReadyReasons=%@, updateNotReadyReasons=%@>"), v4, v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
