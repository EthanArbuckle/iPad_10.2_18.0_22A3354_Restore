...
- (HAPDataStreamHAPAccessoryPayload)init
{
  ...
  return -[HAPDataStreamHAPAccessoryPayload init](&v3, sel_init);
}
...
- (HAPDataStreamHAPAccessoryPayload)initWithPayload:(id)a3 forceClose:(id)a4 accessoryRequestToSend:(id)a5
{
  ...
  v12 = -[HAPDataStreamHAPAccessoryPayload init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  BOOL v23;
  uint64_t v24;
  HAPDataStreamHAPAccessoryPayload *v26;
  id *v27;
  id v28;
  id v29;
  id v30;
...
- (id)serializeWithError:(id *)a3
{
  ...
  v27 = 0u;
  TLV8BufferInit();
  -[HAPDataStreamHAPAccessoryPayload payload](self, "payload");
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  if (!v5)
  {
LABEL_10:
    -[HAPDataStreamHAPAccessoryPayload forceClose](self, "forceClose");
    ...
    -[HAPDataStreamHAPAccessoryPayload accessoryRequestToSend](self, "accessoryRequestToSend");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPDataStreamHAPAccessoryPayload payload](v7, "payload");
      ...
      -[HAPDataStreamHAPAccessoryPayload forceClose](v7, "forceClose");
      ...
      -[HAPDataStreamHAPAccessoryPayload accessoryRequestToSend](self, "accessoryRequestToSend");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPDataStreamHAPAccessoryPayload accessoryRequestToSend](v7, "accessoryRequestToSend");
...
- (NSString)description
{
  ...
  -[HAPDataStreamHAPAccessoryPayload accessoryRequestToSend](self, "accessoryRequestToSend");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<HAPDataStreamHAPAccessoryPayload payload=%@, forceClose=%@, accessoryRequestToSend=%@>"), v4, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
