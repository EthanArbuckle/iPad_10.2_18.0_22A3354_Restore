...
- (HAPDiagnosticsSnapshotTypeWrapper)init
{
  ...
  result = -[HAPDiagnosticsSnapshotTypeWrapper init](&v3, sel_init);
  if (result)
    result->_value = 0;
  return result;
}
...
- (HAPDiagnosticsSnapshotTypeWrapper)initWithValue:(unint64_t)a3
{
  ...
  result = -[HAPDiagnosticsSnapshotTypeWrapper init](&v5, sel_init);
  if (result)
    result->_value = a3;
  return result;
}
...
{
  return HAPTLVWriteUInt64(-[HAPDiagnosticsSnapshotTypeWrapper value](self, "value", a3));
}
...
- (BOOL)isEqual:(id)a3
{
  HAPDiagnosticsSnapshotTypeWrapper *v4;
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = -[HAPDiagnosticsSnapshotTypeWrapper value](self, "value");
      v7 = -[HAPDiagnosticsSnapshotTypeWrapper value](v5, "value");
...
- (NSString)description
{
  ...
  HAPDiagnosticsSnapshotTypeAsString(-[HAPDiagnosticsSnapshotTypeWrapper value](self, "value"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("<HAPDiagnosticsSnapshotTypeWrapper value=%@>"), v3);
