...
- (HAPDiagnosticsSnapshotFormatWrapper)init
{
  ...
  result = -[HAPDiagnosticsSnapshotFormatWrapper init](&v3, sel_init);
  if (result)
    result->_value = 0;
  return result;
}
...
- (HAPDiagnosticsSnapshotFormatWrapper)initWithValue:(int64_t)a3
{
  ...
  result = -[HAPDiagnosticsSnapshotFormatWrapper init](&v5, sel_init);
  if (result)
    result->_value = a3;
  return result;
}
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (objc_msgSend(v6, "length"))
  {
    ...
    -[HAPDiagnosticsSnapshotFormatWrapper setValue:](self, "setValue:", v9);
    v11 = 1;
  }
  else if (a4)
  {
...
{
  return HAPTLVWriteUInt64(-[HAPDiagnosticsSnapshotFormatWrapper value](self, "value", a3));
}
...
- (BOOL)isEqual:(id)a3
{
  HAPDiagnosticsSnapshotFormatWrapper *v4;
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = -[HAPDiagnosticsSnapshotFormatWrapper value](self, "value");
      v7 = -[HAPDiagnosticsSnapshotFormatWrapper value](v5, "value");
...
- (NSString)description
{
  ...
  HAPDiagnosticsSnapshotFormatAsString(-[HAPDiagnosticsSnapshotFormatWrapper value](self, "value"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("<HAPDiagnosticsSnapshotFormatWrapper value=%@>"), v3);
