...
- (HAPCharacteristicValueRange)init
{
  ...
  return -[HAPCharacteristicValueRange init](&v3, sel_init);
}
...
- (HAPCharacteristicValueRange)initWithLowerBound:(id)a3 upperBound:(id)a4
{
  ...
  v9 = -[HAPCharacteristicValueRange init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
LABEL_12:
    ...
    if (v28 == 1)
    {
      ...
      if (!v15)
      {
        v24 = 0;
        v16 = (id *)&v24;
        objc_msgSend(MEMORY[0x1E0C99D50], "parsedFromData:error:", v14, &v24);
        v17 = v10;
...
- (id)serializeWithError:(id *)a3
{
  ...
  v29 = 0u;
  TLV8BufferInit();
  -[HAPCharacteristicValueRange lowerBound](self, "lowerBound");
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  if (!v5)
  {
LABEL_10:
    -[HAPCharacteristicValueRange upperBound](self, "upperBound");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  void *v3;
  HAPCharacteristicValueRange *v5;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPCharacteristicValueRange lowerBound](self, "lowerBound");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPCharacteristicValueRange lowerBound](v6, "lowerBound");
...
LABEL_14:
      ...
      -[HAPCharacteristicValueRange upperBound](v6, "upperBound");
...
- (NSString)description
{
  ...
  -[HAPCharacteristicValueRange upperBound](self, "upperBound");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<HAPCharacteristicValueRange lowerBound=%@, upperBound=%@>"), v4, v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
