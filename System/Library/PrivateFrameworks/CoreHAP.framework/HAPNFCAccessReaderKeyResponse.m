...
- (HAPNFCAccessReaderKeyResponse)init
{
  ...
  return -[HAPNFCAccessReaderKeyResponse init](&v3, sel_init);
}
...
- (HAPNFCAccessReaderKeyResponse)initWithIdentifier:(id)a3 statusCode:(id)a4
{
  id v7;
  id v8;
  HAPNFCAccessReaderKeyResponse *v9;
  HAPNFCAccessReaderKeyResponse *v10;
  objc_super v12;
  ...
  v9 = -[HAPNFCAccessReaderKeyResponse init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
LABEL_16:
    ...
    -[HAPNFCAccessReaderKeyResponse setStatusCode:](self, "setStatusCode:", v9);
    v11 = 0;
    v19 = 1;
    goto LABEL_24;
  }
...
LABEL_20:
    ...
    if (v30 == 2)
    {
      ...
      v25 = v11;
      +[HAPNFCAccessResponseStatusWrapper parsedFromData:error:](HAPNFCAccessResponseStatusWrapper, "parsedFromData:error:", v14, &v25);
...
- (id)serializeWithError:(id *)a3
{
  ...
  v23 = 0u;
  TLV8BufferInit();
  -[HAPNFCAccessReaderKeyResponse identifier](self, "identifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  if (!v5)
  {
LABEL_10:
    -[HAPNFCAccessReaderKeyResponse statusCode](self, "statusCode");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  HAPNFCAccessReaderKeyResponse *v4;
  void *v5;
  void *v6;
  HAPNFCAccessReaderKeyResponse *v7;

  v4 = +[HAPNFCAccessReaderKeyResponse allocWithZone:](HAPNFCAccessReaderKeyResponse, "allocWithZone:", a3);
  -[HAPNFCAccessReaderKeyResponse identifier](self, "identifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HAPNFCAccessReaderKeyResponse statusCode](self, "statusCode");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[HAPNFCAccessReaderKeyResponse initWithIdentifier:statusCode:](v4, "initWithIdentifier:statusCode:", v5, v6);
...
{
  void *v3;
  HAPNFCAccessReaderKeyResponse *v5;
  HAPNFCAccessReaderKeyResponse *v6;
  void *v7;
  void *v8;
  void *v9;
  char v10;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPNFCAccessReaderKeyResponse identifier](self, "identifier");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPNFCAccessReaderKeyResponse identifier](v6, "identifier");
...
LABEL_14:
      ...
      -[HAPNFCAccessReaderKeyResponse statusCode](v6, "statusCode");
...
- (NSString)description
{
  ...
  -[HAPNFCAccessReaderKeyResponse statusCode](self, "statusCode");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<HAPNFCAccessReaderKeyResponse identifier=%@, statusCode=%@>"), v4, v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  v5 = a3;
  v6 = objc_alloc_init(HAPNFCAccessReaderKeyResponse);
  v7 = v6;
  if (v6)
  {
    v10 = 0;
    -[HAPNFCAccessReaderKeyResponse parseFromData:error:](v6, "parseFromData:error:", v5, &v10);
    v8 = v10;
    if (v8)
    {
