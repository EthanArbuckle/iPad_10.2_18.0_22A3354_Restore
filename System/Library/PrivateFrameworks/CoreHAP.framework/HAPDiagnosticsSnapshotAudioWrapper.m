...
- (HAPDiagnosticsSnapshotAudioWrapper)init
{
  ...
  result = -[HAPDiagnosticsSnapshotAudioWrapper init](&v3, sel_init);
  if (result)
    result->_value = 0;
  return result;
}
...
- (HAPDiagnosticsSnapshotAudioWrapper)initWithValue:(unint64_t)a3
{
  ...
  result = -[HAPDiagnosticsSnapshotAudioWrapper init](&v5, sel_init);
  if (result)
    result->_value = a3;
  return result;
}
...
{
  return HAPTLVWriteUInt64(-[HAPDiagnosticsSnapshotAudioWrapper value](self, "value", a3));
}
...
- (BOOL)isEqual:(id)a3
{
  HAPDiagnosticsSnapshotAudioWrapper *v4;
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = -[HAPDiagnosticsSnapshotAudioWrapper value](self, "value");
      v7 = -[HAPDiagnosticsSnapshotAudioWrapper value](v5, "value");
...
- (NSString)description
{
  ...
  HAPDiagnosticsSnapshotAudioAsString(-[HAPDiagnosticsSnapshotAudioWrapper value](self, "value"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("<HAPDiagnosticsSnapshotAudioWrapper value=%@>"), v3);
