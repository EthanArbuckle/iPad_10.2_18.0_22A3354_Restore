...
- (HAPCharacteristicValueTransitionStart)init
{
  ...
  return -[HAPCharacteristicValueTransitionStart init](&v3, sel_init);
}
...
- (HAPCharacteristicValueTransitionStart)initWithTransitions:(id)a3
{
  ...
  v5 = -[HAPCharacteristicValueTransitionStart init](&v9, sel_init);
  if (v5)
  {
  ...
  if (v8 >= 1)
  {
    ...
    while (1)
    {
      ...
      if (v24 == 1)
      {
        ...
        {
          v20 = 0;
          +[HAPCharacteristicValueTransition parsedFromData:error:](HAPCharacteristicValueTransition, "parsedFromData:error:", v13, &v20);
...
- (id)serializeWithError:(id *)a3
{
  ...
  v28 = 0u;
  v29 = 0u;
  -[HAPCharacteristicValueTransitionStart transitions](self, "transitions");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPCharacteristicValueTransitionStart transitions](v5, "transitions");
...
- (NSString)description
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("<HAPCharacteristicValueTransitionStart transitions=%@>"), v3);
