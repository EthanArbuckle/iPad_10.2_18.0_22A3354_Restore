...
- (HAPDataStreamHAPControllerPayload)init
{
  ...
  return -[HAPDataStreamHAPControllerPayload init](&v3, sel_init);
}
...
- (HAPDataStreamHAPControllerPayload)initWithPayload:(id)a3 sessionIdentifier:(id)a4 forceClose:(id)a5
{
  ...
  v12 = -[HAPDataStreamHAPControllerPayload init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  BOOL v23;
  uint64_t v24;
  HAPDataStreamHAPControllerPayload *v26;
  id *v27;
  id v28;
  id v29;
  id v30;
...
- (id)serializeWithError:(id *)a3
{
  ...
  v27 = 0u;
  TLV8BufferInit();
  -[HAPDataStreamHAPControllerPayload payload](self, "payload");
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  if (!v5)
  {
LABEL_10:
    -[HAPDataStreamHAPControllerPayload sessionIdentifier](self, "sessionIdentifier");
    ...
    -[HAPDataStreamHAPControllerPayload forceClose](self, "forceClose");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[HAPDataStreamHAPControllerPayload payload](v7, "payload");
      ...
      -[HAPDataStreamHAPControllerPayload sessionIdentifier](v7, "sessionIdentifier");
      ...
      -[HAPDataStreamHAPControllerPayload forceClose](self, "forceClose");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      -[HAPDataStreamHAPControllerPayload forceClose](v7, "forceClose");
...
- (NSString)description
{
  ...
  -[HAPDataStreamHAPControllerPayload forceClose](self, "forceClose");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<HAPDataStreamHAPControllerPayload payload=%@, sessionIdentifier=%@, forceClose=%@>"), v4, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
