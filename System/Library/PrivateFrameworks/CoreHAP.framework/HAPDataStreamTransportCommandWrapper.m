...
- (HAPDataStreamTransportCommandWrapper)init
{
  ...
  result = -[HAPDataStreamTransportCommandWrapper init](&v3, sel_init);
  if (result)
    result->_value = 0;
  return result;
}
...
- (HAPDataStreamTransportCommandWrapper)initWithValue:(int64_t)a3
{
  ...
  result = -[HAPDataStreamTransportCommandWrapper init](&v5, sel_init);
  if (result)
    result->_value = a3;
  return result;
}
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (objc_msgSend(v6, "length"))
  {
    ...
    -[HAPDataStreamTransportCommandWrapper setValue:](self, "setValue:", v9);
    v11 = 1;
  }
  else if (a4)
  {
...
{
  return HAPTLVWriteUInt64(-[HAPDataStreamTransportCommandWrapper value](self, "value", a3));
}
...
- (BOOL)isEqual:(id)a3
{
  HAPDataStreamTransportCommandWrapper *v4;
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = -[HAPDataStreamTransportCommandWrapper value](self, "value");
      v7 = -[HAPDataStreamTransportCommandWrapper value](v5, "value");
...
- (NSString)description
{
  ...
  HAPDataStreamTransportCommandAsString(-[HAPDataStreamTransportCommandWrapper value](self, "value"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("<HAPDataStreamTransportCommandWrapper value=%@>"), v3);
