...
LABEL_6:
    ...
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Register for notification with option: %@", (uint8_t *)&v9, 0x16u);
...
- (void)_createStateForHomeUUIDIfNotExist:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Initializing state for home %@ as %@", (uint8_t *)&v10, 0x20u);

    }
    objc_autoreleasePoolPop(v6);
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_homeUUIDToState, "setObject:forKeyedSubscript:", &unk_24E96C380, v4);
  }
...
- (void)_handleCompositeSettingsControllerConfiguredNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 138543362;
    v21 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Did handle CompositeSettingsControllerDidConfigure notification", (uint8_t *)&v20, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v13;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Nil hapAccessoryUUID:%@ or homeUUID:%@", (uint8_t *)&v20, 0x20u);
...
- (void)_handleSiriEndpointProfileSettingsUpdate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@received notification:%@", (uint8_t *)&v24, 0x16u);
        ...
        !v16))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 2112;
      v29 = v13;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@nil home:%@ or accessory:%@", (uint8_t *)&v24, 0x20u);
...
- (void)_handleSiriEndpointProfileCreation:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling HMDSiriEndpointProfileAddedNotification:%@", (uint8_t *)&v21, 0x16u);
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 138543362;
        v22 = v20;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@HomeUUID or home are null, will not update state after siri endpoint profile creation", (uint8_t *)&v21, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = 0;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Accessory %@ is not a HAPAccessory", (uint8_t *)&v21, 0x16u);
...
- (void)_handleResidentDeviceUpdated:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2114;
    v26 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification for resident update: %{public}@", (uint8_t *)&v23, 0x16u);
...
LABEL_16:
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, v22, (uint8_t *)&v23, 0xCu);
...
- (void)_computeResidentStateChangeForHome:(id)a3
{
  ...
  if ((objc_msgSend(v4, "isCurrentDeviceAvailableResident") & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v17;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@updated device is a resident and is the current device, state: %@ -> %@", (uint8_t *)&v23, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Current device is not a resident, will update current state to %@", (uint8_t *)&v23, 0x16u);
    ...
    -[NSMutableDictionary setObject:forKeyedSubscript:](v13->_homeUUIDToState, "setObject:forKeyedSubscript:", &unk_24E96C380, v5);
...
- (void)_handleAccessoryLanguagesChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification for language list change: %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find home to work with, will not process language change", (uint8_t *)&v19, 0xCu);
  ...
  if (v8 && objc_msgSend(v8, "isHomePod"))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v17;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find home for removed accessory, will not process language change", (uint8_t *)&v18, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29_182604 != -1)
    dispatch_once(&logCategory__hmf_once_t29_182604, &__block_literal_global_182605);
  return (id)logCategory__hmf_once_v30_182606;
}
...
void __63__HMDCompositeSettingControllerManagerStateManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v30_182606;
  logCategory__hmf_once_v30_182606 = v0;
