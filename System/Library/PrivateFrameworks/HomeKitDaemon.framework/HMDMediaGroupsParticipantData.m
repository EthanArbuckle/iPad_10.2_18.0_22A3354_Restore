...
- (id)encodeToProtoBufferData
{
  ...
  v3 = objc_alloc_init(MEMORY[0x24BDD77B8]);
  -[HMDMediaGroupsParticipantData destination](self, "destination");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
  {
    v5 = objc_alloc(MEMORY[0x24BDD7798]);
    -[HMDMediaGroupsParticipantData destination](self, "destination");
  ...
  if (v9)
  {
    v10 = objc_alloc(MEMORY[0x24BDD77A8]);
    -[HMDMediaGroupsParticipantData destinationControllerData](self, "destinationControllerData");
...
- (HMDMediaGroupsParticipantData)initWithProtoBufferData:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x24BDD77B8];
  v5 = a3;
  ...
  {
    v11 = objc_alloc(MEMORY[0x24BDD7788]);
  ...
  {
    v16 = -[HMDMediaGroupsParticipantData initWithDestination:destinationControllerData:backedUpGroups:](self, "initWithDestination:destinationControllerData:backedUpGroups:", v10, v14, MEMORY[0x24BDBD1A8]);
  }
