...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating the session", buf, 0xCu);
...
- (id)dumpState
{
  ...
  if (self)
    ...
    retryCount = 0;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", retryCount);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (a1)
  {
    if (*(_QWORD *)(a1 + 64) < 3uLL)
    {
      ...
      if (v17)
      {
        if (v21)
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          v39 = v17;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Sending sync request session %@ with resident %@", buf, 0x20u);
      ...
      else
      {
        if (v21)
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v30;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@No valid residents, cannot continue", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v5;
        _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Retry count has maxed out, cannot continue", buf, 0xCu);
...
void __46__HMDSharedHomeUpdateSession__requestDataSync__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
    {
      HMFGetLogIdentifier();
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", *((double *)v2 + 9));
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543618;
      v18 = v4;
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v3, OS_LOG_TYPE_INFO, "%{public}@Starting the retry timer with %@ seconds", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v1);
    v6 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 1, *((double *)v2 + 9));
    v7 = (void *)*((_QWORD *)v2 + 7);
    *((_QWORD *)v2 + 7) = v6;
    ...
    *((double *)v2 + 9) = *((double *)v2 + 9) + (double)(unint64_t)(60 * requestHomeDataSyncRetryPeriodInMinutes);
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v15;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Bumped the next timer's value to %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_237939 != -1)
    dispatch_once(&logCategory__hmf_once_t1_237939, &__block_literal_global_237940);
  return (id)logCategory__hmf_once_v2_237941;
}
...
void __41__HMDSharedHomeUpdateSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_237941;
  logCategory__hmf_once_v2_237941 = v0;
