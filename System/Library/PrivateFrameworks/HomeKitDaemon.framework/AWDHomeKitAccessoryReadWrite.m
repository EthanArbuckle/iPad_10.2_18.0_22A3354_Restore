...
LABEL_22:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isWrite);
  ...
  {
LABEL_6:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isRemote);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_characteristics, "count"));
    v45 = 0u;
    v46 = 0u;
    v47 = 0u;
    v48 = 0u;
  ...
  if ((*(_BYTE *)&self->_has & 0x80) != 0)
  {
    ...
    {
      v14 = off_24E778948[transportType];
    }
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isTimedWrite);
  ...
  if ((*(_BYTE *)&v24 & 0x20) != 0)
  {
    ...
    if (source >= 9)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_source);
      v36 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v36 = off_24E778988[source];
    }
...
LABEL_36:
  ...
  {
LABEL_37:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isCached);
...
LABEL_46:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isRemoteAccessAllowed);
...
LABEL_61:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isRemotelyReachable);
...
LABEL_62:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_consecutiveFailureCount);
...
LABEL_63:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_timeElapsedSinceFirstFailure);
...
LABEL_64:
  ...
  {
LABEL_51:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isSentOverNoe);
