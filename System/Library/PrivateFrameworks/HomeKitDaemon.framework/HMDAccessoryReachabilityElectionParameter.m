  ...
  if (v4)
  {
    ...
    if (objc_msgSend(v6, "count") != 1)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 2112;
        v35 = v5;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unexpected representation, invalid keys: %@", (uint8_t *)&v32, 0x16u);
    ...
    if (v9)
    {
      ...
      if (v10)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            v34 = 2112;
            v35 = v31;
            _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Invalid reachability: %@", (uint8_t *)&v32, 0x16u);
      ...
      v34 = 2112;
      v35 = v9;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid identifier: %@", (uint8_t *)&v32, 0x16u);
    }
    else
    {
      v20 = (void *)MEMORY[0x227676638]();
...
LABEL_24:
      ...
      v34 = 2112;
      v35 = v24;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid key type: %@", (uint8_t *)&v32, 0x16u);
