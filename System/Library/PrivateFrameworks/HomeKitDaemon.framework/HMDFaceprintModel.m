...
- (HMDFaceprintModel)initWithFaceprint:(id)a3
{
  ...
  v11 = objc_alloc(MEMORY[0x24BE4ECD8]);
  objc_msgSend(v4, "faceCropUUID");
...
- (id)createFaceprint
{
  ...
  if (v3 && v4)
  {
    v6 = objc_alloc(MEMORY[0x24BDD7688]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot create faceprint from model: %@", (uint8_t *)&v16, 0x16u);
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_187459 != -1)
    dispatch_once(&hmbProperties_onceToken_187459, &__block_literal_global_187460);
  return (id)hmbProperties_properties_187461;
}
...
void __34__HMDFaceprintModel_hmbProperties__block_invoke()
{
  ...
  v4 = (void *)hmbProperties_properties_187461;
  hmbProperties_properties_187461 = v3;
