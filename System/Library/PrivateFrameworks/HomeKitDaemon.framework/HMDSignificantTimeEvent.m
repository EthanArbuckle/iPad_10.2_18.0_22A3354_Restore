...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDBCE68], "hmf_unarchiveFromData:error:", v6, 0);
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 138543362;
    v31 = v14;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling transaction updated", (uint8_t *)&v30, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_93485 != -1)
    dispatch_once(&logCategory__hmf_once_t0_93485, &__block_literal_global_93486);
  return (id)logCategory__hmf_once_v1_93487;
}
...
+ (id)nextTimerDateFromHomeLocation:(id)a3 signifiantEvent:(id)a4 offset:(id)a5 loggingObject:(id)a6
{
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v77 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get next significant event fire date because home location is nil", buf, 0xCu);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v80 = 2112;
    v81 = v13;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Current Home Location & time : %@ / %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v14);
  if (objc_msgSend(v10, "isEqualToString:", *MEMORY[0x24BDD6CF8]))
  {
  ...
  {
    if (!objc_msgSend(v10, "isEqualToString:", *MEMORY[0x24BDD6D00]))
    {
      v25 = 0;
      goto LABEL_13;
    }
...
LABEL_13:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v78 = 2112;
    v79 = v25;
    _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@nextSunEventDates %@", buf, 0x16u);
  ...
  if (v25)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      objc_msgSend(v25, "describeElements:", &__block_literal_global_17_93473);
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543618;
      v77 = v34;
      v78 = 2112;
      v79 = v35;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@Set of events to pick from %@", buf, 0x16u);
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v78 = 2112;
        v79 = v11;
        _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_INFO, "%{public}@Adding offset %@ to the sun event dates", buf, 0x16u);
    ...
    objc_msgSend(v40, "sortedArrayUsingComparator:", &__block_literal_global_22_93478);
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      objc_msgSend(v40, "describeElements:", &__block_literal_global_23_93479);
      v55 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543618;
      v77 = v54;
      v78 = 2112;
      v79 = v55;
      _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_INFO, "%{public}@Set of events to pick after offset & current time addition from %@", buf, 0x16u);
    ...
    if (objc_msgSend(v50, "count"))
    {
      ...
      if (v56 == v58)
      {
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v77 = v62;
          _os_log_impl(&dword_2218F0000, v61, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine next timer event for Significant Event", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v78 = 2112;
          v79 = v24;
          _os_log_impl(&dword_2218F0000, v61, OS_LOG_TYPE_INFO, "%{public}@Event next fire date : %@", buf, 0x16u);
...
LABEL_49:
  ...
  else
  {
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v77 = v49;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to get the sun event dates based on home location", buf, 0xCu);
...
void __38__HMDSignificantTimeEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_93487;
  logCategory__hmf_once_v1_93487 = v0;
