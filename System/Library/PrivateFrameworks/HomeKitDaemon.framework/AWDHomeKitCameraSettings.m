...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x20) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isRecordingEnabled);
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isRecordingAudioEnabled);
...
LABEL_14:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_recordingEventTriggers);
...
LABEL_15:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isSmartBulletinBoardNotificationEnabled);
...
LABEL_16:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isInclusionZone);
...
LABEL_17:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isReachabilityNotificationEnabled);
  ...
  {
LABEL_8:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isRecordingCapable);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
