...
- (HMDSiriEndpointEnablementLogEvent)initWithDictionary:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Could not init HMDSiriEndpointEnablementLogEvent with dictionary %@", (uint8_t *)&v15, 0x16u);
...
- (id)serializedMetric
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDSiriEndpointEnablementLogEvent numCapableSiriEndpointAccessories](self, "numCapableSiriEndpointAccessories"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[1] = v4;
  v8[2] = CFSTR("numEnabledEndpoints");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDSiriEndpointEnablementLogEvent numEnabledSiriEndpointAccessories](self, "numEnabledSiriEndpointAccessories"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v9[2] = v5;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_255712 != -1)
    dispatch_once(&logCategory__hmf_once_t11_255712, &__block_literal_global_47_255713);
  return (id)logCategory__hmf_once_v12_255714;
}
...
void __48__HMDSiriEndpointEnablementLogEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_255714;
  logCategory__hmf_once_v12_255714 = v0;
