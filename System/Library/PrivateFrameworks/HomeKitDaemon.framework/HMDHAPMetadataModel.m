...
+ (id)properties
{
  if (properties_onceToken_25981 != -1)
    dispatch_once(&properties_onceToken_25981, &__block_literal_global_454);
  return (id)properties__properties_25982;
}
...
+ (id)modelWithDictionary:(id)a3
{
  ...
  v3 = a3;
  v4 = *MEMORY[0x24BE1BD80];
  objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD80]);
  v5 = (HMDHAPMetadataModel *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    v6 = *MEMORY[0x24BE1BD50];
    objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD50]);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v7)
    {
      ...
      v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"));
      ...
      objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD30]);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDHAPMetadataModel setRawPlist:](v5, "setRawPlist:", v13);

      objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD10]);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDHAPMetadataModel setLegacyIDSData:](v5, "setLegacyIDSData:", v14);

      objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD08]);
...
void __46__HMDHAPMetadataModel_metadataModelObjectUUID__block_invoke()
{
  ...
  v2 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"));
  objc_msgSend(MEMORY[0x24BDD1880], "hm_deriveUUIDFromBaseUUID:withSalts:", v2, &unk_24E970C40);
...
void __33__HMDHAPMetadataModel_properties__block_invoke()
{
  ...
  v6 = (void *)properties__properties_25982;
  properties__properties_25982 = v5;
