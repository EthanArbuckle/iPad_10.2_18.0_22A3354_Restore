        ...
        else
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v26;
            ...
            v46 = 2112;
            v47 = v7;
            _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unable to map counterType %@ to a logEvent counter type", buf, 0x16u);
...
- (HMDXPCMessageCountTracker)init
{
  ...
  if (v2)
  {
    ...
    v14 = objc_alloc(MEMORY[0x24BE3F298]);
...
- (void)incrementCounterOfType:(int64_t)a3 clientName:(id)a4 messageName:(id)a5
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLong:", v13 + 1);
...
+ (HMDXPCMessageCountTracker)sharedTracker
{
  if (sharedTracker_onceToken != -1)
    dispatch_once(&sharedTracker_onceToken, &__block_literal_global_97565);
  return (HMDXPCMessageCountTracker *)(id)sharedTracker_sharedTracker;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t4_97560 != -1)
    dispatch_once(&logCategory__hmf_once_t4_97560, &__block_literal_global_22_97561);
  return (id)logCategory__hmf_once_v5_97562;
}
...
void __40__HMDXPCMessageCountTracker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_97562;
  logCategory__hmf_once_v5_97562 = v0;
