...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 1, CFSTR("kRTPParameters_PayloadType"));
  v3 = objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 2, CFSTR("kRTPParameters_SynchronizationSource"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 5, CFSTR("kRTPParameters_MaxMTU"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 6, CFSTR("kRTPParameters_ComfortNoisePayloadType"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v32 = (void *)v3;
  v34[0] = v3;
  v34[1] = v4;
