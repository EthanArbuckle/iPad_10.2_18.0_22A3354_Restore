  ...
  if (!(_DWORD)v8)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v89 = 2112;
      v90 = v23;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Signature verification of fetched network declarations failed for record %@/%@ with error %@", buf, 0x2Au);
      ...
      if (!v29)
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v87 = 2112;
          v88 = v61;
          _os_log_impl(&dword_2218F0000, v54, OS_LOG_TYPE_ERROR, "%{public}@Fetched Paired metadata failed to parse for record %@/%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v89 = 2112;
        v90 = v37;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Signature verification of fetched Paired metadata failed for record %@/%@ with error %@", buf, 0x2Au);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v87 = 2112;
    v88 = v51;
    _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_ERROR, "%{public}@Fetched network declarations failed to parse for record %@/%@", buf, 0x20u);
      ...
      if ((v18 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v41 = 2112;
          v42 = v31;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@'%@' field value '%@' does not match record name on %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v41 = 2112;
        v42 = v25;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@'%@' field value '%@' does not match zone name on %@", buf, 0x2Au);
...
+ (id)__calculateDigestDataFromRecord:(id)a3 dataKey:(id)a4 dataAssetKey:(id)a5 maxDataSize:(unint64_t)a6 error:(id *)a7
{
  ...
  if (v25)
  {
    objc_msgSend(MEMORY[0x24BDBCE90], "inputStreamWithData:", v25);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v97 = 2112;
        v98 = v25;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to create input stream with data: %@", buf, 0x16u);
...
LABEL_32:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)v89 = 138543618;
            ...
            v91 = 2048;
            v92 = 32;
            _os_log_impl(&dword_2218F0000, v72, OS_LOG_TYPE_ERROR, "%{public}@Failed to allocate %lu bytes to hold digest", v89, 0x16u);
      ...
      v63 = (void *)MEMORY[0x227676638](v50);
      v64 = v79;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v89 = 138543874;
        ...
        v93 = 2112;
        v94 = v68;
        _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_ERROR, "%{public}@Error reading data from record %@: %@", v89, 0x20u);
    ...
    else
    {
      ...
      v55 = (void *)MEMORY[0x227676638](objc_msgSend(v27, "close"));
      v56 = v79;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v89 = 138543874;
        ...
        v93 = 2112;
        v94 = v60;
        _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_ERROR, "%{public}@Data size is bigger than maximum %ld bytes on record %@", v89, 0x20u);
...
+ (BOOL)__verifyDigestDataAgainstSignatureFromRecord:(id)a3 digestData:(id)a4 signatureData:(id)a5 signatureVerificationPublicKeys:(id)a6 error:(id *)a7
{
  ...
  if (v13)
  {
    ...
    v15 = 0;
    v16 = *(_QWORD *)v34;
    v17 = (const __CFString *)*MEMORY[0x24BDE9298];
    while (2)
    {
      v18 = 0;
      v19 = v15;
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_QWORD *)&error[4] = v26;
    ...
    v40 = 2112;
    v41 = v15;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Digest does not match signature on record %@: %@", error, 0x20u);
  ...
  if (!objc_msgSend(v15, "count"))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v24;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have verification keys", buf, 0xCu);
...
- (id)attributeDescriptions
{
  ...
  v3 = (os_unfair_lock_s *)((char *)self + (int)*MEMORY[0x24BE4ED48]);
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDNetworkRouterFirewallRuleCloudZone useAnonymousRequests](self, "useAnonymousRequests"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v24[3] = v15;
  v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F140]), "initWithName:value:", CFSTR("UncommittedModifiedRecordIDsFromLastPull"), v21);
  v24[4] = v16;
...
- (void)setModifiedRecordIDsFromLastPull:(id)a3
{
  ...
  v4 = (NSSet *)a3;
  os_unfair_lock_assert_owner((const os_unfair_lock *)((char *)self + (int)*MEMORY[0x24BE4ED48]));
...
- (id)fetchChangesWithToken:(id)a3 options:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BE6B628], "globalAsyncScheduler", v15, v16, v17, v18);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)__fetchZoneChangesWithFetchInfo:(id)a3
{
  ...
  v4 = a3;
  v5 = objc_alloc_init(MEMORY[0x24BDB90C0]);
  ...
  v10 = objc_alloc(MEMORY[0x24BDB90C8]);
  -[HMBCloudZone cloudZoneID](self, "cloudZoneID");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "zoneID");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)__noteUpdatedRecordID:(id)a3
{
  ...
  v7 = a3;
  v4 = (os_unfair_lock_s *)((char *)self + (int)*MEMORY[0x24BE4ED48]);
  os_unfair_lock_lock_with_options();
  -[HMDNetworkRouterFirewallRuleCloudZone uncommittedModifiedRecordIDsFromLastPull](self, "uncommittedModifiedRecordIDsFromLastPull");
...
- (void)__recordChanged:(id)a3 fetchInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v60 = 2112;
    v61 = v17;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched changed record %@ (%@)", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v60 = 2112;
            v61 = v50;
            _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to update model for %@: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v58 = 2112;
          v59 = v24;
          _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalData: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v58 = 2112;
        v59 = v22;
        _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalID: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v58 = 2112;
      v59 = v20;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode model: %@", buf, 0x16u);
...
- (void)__recordDeleted:(id)a3 recordType:(id)a4 fetchInfo:(id)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v39 = 2112;
    v40 = v9;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched deleted recordID: %@ (%@)", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v37 = 2112;
        v38 = v22;
        _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove model: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v19;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalID: %@", buf, 0x16u);
...
- (void)__zoneChangeTokensUpdated:(id)a3 fetchInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v16;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Change token updated: %@", buf, 0x16u);
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v33 = 2112;
      v34 = v28;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Zone fetch completed successfully, token: %@, moreComing: %@", buf, 0x20u);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v35 = 2112;
    v36 = v22;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Zone fetch completed unsuccessfully, token: %@, error: %@, moreComing: %@", buf, 0x2Au);
...
- (void)__zoneChangesCompleted:(id)a3 fetchInfo:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v6;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Zone change operation completed unsuccessfully: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Zone change operation completed successfully", buf, 0xCu);
...
- (BOOL)__commitLocalChanges:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v59 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Committing local changes", buf, 0xCu);
  ...
  if ((v14 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v60 = 2112;
      v61 = v41;
      _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v59 = v20;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Committed successfully", buf, 0xCu);
  ...
  if (!v23)
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v60 = 2112;
      v61 = v48;
      _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_INFO, "%{public}@Updating change token: %@", buf, 0x16u);
...
LABEL_16:
    _os_log_impl(&dword_2218F0000, v35, v36, v34, buf, 0x16u);
...
- (BOOL)__canRecoverFromError:(id)a3 fetchInfo:(id)a4
{
  ...
  if (objc_msgSend(v6, "hmbIsCKPartialFailureError"))
  {
    ...
    *(_QWORD *)&buf[16] = 0x3032000000;
    v34 = __Block_byref_object_copy__189636;
    v35 = __Block_byref_object_dispose__189637;
    v36 = 0;
  ...
  switch(v14)
  {
    case 21:
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v6;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Change token has expired: %@", buf, 0x16u);
    ...
    case 28:
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v6;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Zone was deleted: %@", buf, 0x16u);
    ...
    case 26:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v6;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Zone does not exist: %@", buf, 0x16u);
...
- (void)__retryFetchWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v27 = 2048;
    v28 = (unint64_t)v17;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Will %s in %lu seconds", buf, 0x20u);
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@CloudZone has been deallocated", buf, 0xCu);
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v18 = 2112;
        v19 = v11;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneFetchCompletionBlock called with unknown zone: %@", buf, 0x16u);
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v18 = 2112;
        v19 = v11;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneChangeTokensUpdatedBlock called with unknown zone: %@", buf, 0x16u);
...
void __71__HMDNetworkRouterFirewallRuleCloudZone_fetchChangesWithToken_options___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    v6 = (os_unfair_lock_s *)&WeakRetained[*MEMORY[0x24BE4ED48]];
    os_unfair_lock_lock_with_options();
      ...
      if (v40)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v46 = 2112;
          v47 = v28;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching all changes for zone: %@, token: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v44 = 2112;
          v45 = v39;
          _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to create mirror input: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v43 = v33;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_DEBUG, "%{public}@Not watching any records", buf, 0xCu);
