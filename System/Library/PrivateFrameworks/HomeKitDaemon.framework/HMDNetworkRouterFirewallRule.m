...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDNetworkRouterFirewallRule isCritical](self, "isCritical"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSString)jsonString
{
  ...
  {
    v14 = 0;
    objc_msgSend(MEMORY[0x24BDD1608], "dataWithJSONObject:options:error:", v3, 2, &v14);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = v14;
    if (v4)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v19 = 2112;
        v20 = v5;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Failed to convert firewall WAN rule %@ to JSON: %@", buf, 0x20u);
...
+ (id)logCategory
{
  ...
  return (id)logCategory__hmf_once_v1_121481;
}

+ (id)__transportProtocolToString:(unsigned __int8)a3
{
  if (a3 < 3u)
    return off_24E785F28[a3];
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Unknown (%d)"), a3);
...
void __43__HMDNetworkRouterFirewallRule_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_121481;
