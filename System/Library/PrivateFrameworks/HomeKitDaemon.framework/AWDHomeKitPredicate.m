...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_presenceEvents, "count"));
    v17 = 0u;
    v18 = 0u;
    v19 = 0u;
    v20 = 0u;
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_containsCharacteristicValue);
...
LABEL_12:
      if ((has & 8) == 0)
        goto LABEL_13;
LABEL_18:
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_containsSignificantTimeOffset, (_QWORD)v17);
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_containsSignificantTime, (_QWORD)v17);
...
LABEL_13:
  ...
  {
LABEL_14:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_containsCalendarTime, (_QWORD)v17);
