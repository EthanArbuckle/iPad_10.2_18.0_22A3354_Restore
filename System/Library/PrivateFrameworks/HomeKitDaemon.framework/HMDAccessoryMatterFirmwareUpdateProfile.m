...
- (void)setMatterFirmwareRevisionNumber:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!self->_matterFirmwareRevisionNumber || (objc_msgSend(v5, "isEqualToNumber:") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating Matter firmware revision number from %@ to %@", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Not setting matter firmware revision number to nil", (uint8_t *)&v19, 0xCu);
...
- (void)_registerForNotifications
{
  ...
  if (v3)
  {
    ...
    v8 = (void *)MEMORY[0x227676638](-[HMDAccessoryMatterFirmwareUpdateProfile _enableCharacteristicsNotifications:](self, "_enableCharacteristicsNotifications:", 1));
    v9 = self;
    HMFGetOSLogHandle();
    v10 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
...
LABEL_6:
      _os_log_impl(&dword_2218F0000, v13, v14, v12, (uint8_t *)&v16, 0xCu);
...
- (void)_enableCharacteristicsNotifications:(BOOL)a3
{
  ...
  if (v3)
  {
    ...
    -[HMDAccessoryMatterFirmwareUpdateProfile readAndProcessCharacteristics:withCompletion:](self, "readAndProcessCharacteristics:withCompletion:", v7, &__block_literal_global_29);
...
- (void)readMatterFirmwareUpdateCharacteristics
{
  ...
  -[HMDAccessoryMatterFirmwareUpdateProfile readAndProcessCharacteristics:withCompletion:](self, "readAndProcessCharacteristics:withCompletion:", v3, &__block_literal_global_34);
...
- (id)characteristics
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", CFSTR("0000026D-0000-1000-8000-0026BB765291"), 0);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", CFSTR("0000026E-0000-1000-8000-0026BB765291"), 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil", buf, 0xCu);
...
- (void)_processIdleStateWithCharacteristic:(id)a3
{
  ...
  {
    v67 = 0;
    objc_msgSend(MEMORY[0x24BE1BB18], "parsedFromData:error:", v7, &v67);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = v67;
    if (v9)
    {
...
LABEL_10:
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v76 = 2112;
      v77 = v9;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse matter firmware update status previous value (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
...
LABEL_8:
    ...
    if (!v19)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v69 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Missing OTA Provider state previous value in Matter Firmware Update Status TLV", buf, 0xCu);
      goto LABEL_8;
    }
    objc_msgSend(v8, "OTAProviderState");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v70 = 2112;
      v71 = v26;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update state previous value : %@", buf, 0x16u);
    ...
    if (!v27)
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v69 = v43;
        _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil. Cannot process initial state from accessory", buf, 0xCu);
      ...
      && objc_msgSend(v29, "isAutomaticThirdPartyAccessorySoftwareUpdateEnabled"))
    {
      ...
      if (!v32)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v69 = v36;
          _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@No active firmware update session, attempting to create one", buf, 0xCu);
        ...
        if (!v32)
        {
          ...
          if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v69 = v60;
            _os_log_impl(&dword_2218F0000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to register and create a firmware update session", buf, 0xCu);
      ...
      if (objc_msgSend(v32, "isMatterFirmwareUpdateRetryAllowed"))
      {
        ...
        if (!v37)
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v69 = v56;
            _os_log_impl(&dword_2218F0000, v55, OS_LOG_TYPE_ERROR, "%{public}@Couldn't get a strong ref to the software update provider delegate", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v69 = v52;
          _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_INFO, "%{public}@Maximum matter firmware update retries reached", buf, 0xCu);
...
LABEL_42:
        _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_INFO, v47, buf, 0xCu);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v69 = v18;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Not processing idle state as previous value is nil", buf, 0xCu);
...
- (void)__handleMatterFirmwareRevisionNumberUpdate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update for %@", (uint8_t *)&v12, 0x16u);
...
- (void)__handleMatterFirmwareUpdateStatusUpdate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v67 = 2112;
    v68 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update for %@", buf, 0x16u);
  ...
  v64 = 0;
  objc_msgSend(MEMORY[0x24BE1BB18], "parsedFromData:error:", v11, &v64);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v64;
  if (!v13)
  {
    ...
    if (!v19)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v66 = v17;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Missing OTA Provider state in Matter Firmware Update Status TLV", buf, 0xCu);
      goto LABEL_9;
    }
    objc_msgSend(v12, "OTAProviderState");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v67 = 2112;
      v68 = v26;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update state : %@", buf, 0x16u);
    ...
    if (!v27)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v66 = v35;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil. Cannot handle matter firmware update status characteristic value change", buf, 0xCu);
    ...
    if (!v29)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v66 = v39;
        _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_INFO, "%{public}@Software update object is nil. Cannot update HMDSoftwareUpdate", buf, 0xCu);
...
LABEL_43:
        ...
        else
        {
          v59 = v30;
          v62 = v29;
          v45 = (void *)MEMORY[0x227676638](v31);
          v46 = v23;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v66 = v48;
            _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", buf, 0xCu);
...
LABEL_44:
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v66 = v54;
            _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", buf, 0xCu);
...
LABEL_52:
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v66 = v42;
        _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_INFO, "%{public}@Not updating software update model states on primary resident", buf, 0xCu);
    ...
    switch(v21)
    {
      case 0:
        if (objc_msgSend(v30, "isAutomaticThirdPartyAccessorySoftwareUpdateEnabled"))
          goto LABEL_35;
        if ((objc_msgSend(v30, "hasAnyResident") & 1) != 0)
          goto LABEL_48;
        v43 = v29;
        v44 = 0;
        goto LABEL_49;
...
LABEL_49:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v73 = 2112;
    v74 = v13;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse matter firmware update status (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
  ...
  if (WeakRetained)
  {
    ...
    if (v5)
    {
      ...
      *(_QWORD *)&v48[16] = 0x3032000000;
      v49 = __Block_byref_object_copy__28842;
      v50 = __Block_byref_object_dispose__28843;
      v31 = a1;
...
uint64_t __88__HMDAccessoryMatterFirmwareUpdateProfile_readAndProcessCharacteristics_withCompletion___block_invoke_32(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Read succeeded for %@", (uint8_t *)&v10, 0x16u);
...
uint64_t __95__HMDAccessoryMatterFirmwareUpdateProfile_handleDisplayableFirmwareVersionUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Matter firmware version string updated", (uint8_t *)&v7, 0xCu);
...
uint64_t __75__HMDAccessoryMatterFirmwareUpdateProfile_handleVIDPIDUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@VID/PID updated", (uint8_t *)&v7, 0xCu);
...
void __70__HMDAccessoryMatterFirmwareUpdateProfile_handleAccessoryIsReachable___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 138543362;
    v17 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is now reachable", (uint8_t *)&v16, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil", (uint8_t *)&v16, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_28871 != -1)
    dispatch_once(&logCategory__hmf_once_t0_28871, &__block_literal_global_28872);
  return (id)logCategory__hmf_once_v1_28873;
}
...
void __54__HMDAccessoryMatterFirmwareUpdateProfile_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_28873;
  logCategory__hmf_once_v1_28873 = v0;
