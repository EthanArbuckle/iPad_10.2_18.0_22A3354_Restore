...
- (HMDCameraStreamSession)initWithSessionID:(id)a3 streamingTierType:(unint64_t)a4 remoteCapabilities:(id)a5 streamPreference:(id)a6
{
  ...
  if (v14)
  {
    ...
    {
      v35 = 0;
      objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v20, &v35);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v39 = 2112;
          v40 = v22;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive remote streaming capabilities from remote capabilities data: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2112;
      v40 = v31;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Initialized stream session with capabilities: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_231405 != -1)
    dispatch_once(&logCategory__hmf_once_t2_231405, &__block_literal_global_231406);
  return (id)logCategory__hmf_once_v3_231407;
}
...
void __37__HMDCameraStreamSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_231407;
  logCategory__hmf_once_v3_231407 = v0;
