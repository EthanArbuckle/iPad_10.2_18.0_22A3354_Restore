...
- (HMDCameraAudioParameterSelection)initWithSessionID:(id)a3 supportedAudioConfiguration:(id)a4 supportedRTPConfiguration:(id)a5 streamingCapabilities:(id)a6
{
  ...
  if (v14)
  {
    ...
    +[HMDAudioCodecGroup arrayWithCodecs:](HMDAudioCodecGroup, "arrayWithCodecs:", &unk_24E970B80);
    v16 = objc_claimAutoreleasedReturnValue();
    audioCodecsPreference = v15->_audioCodecsPreference;
    v15->_audioCodecsPreference = (NSArray *)v16;

    +[HMDBitRateSetting arrayWithSettings:](HMDBitRateSetting, "arrayWithSettings:", &unk_24E970B98);
    v18 = objc_claimAutoreleasedReturnValue();
    bitrateSettingsPreference = v15->_bitrateSettingsPreference;
    v15->_bitrateSettingsPreference = (NSArray *)v18;

    +[HMDAudioSampleRate arrayWithRates:](HMDAudioSampleRate, "arrayWithRates:", &unk_24E970BB0);
    ...
    while (1)
    {
      ...
      if (objc_msgSend(v26, "count") && objc_msgSend(v34, "count"))
      {
        ...
        if (v36)
        {
          ...
          -[HMDCameraAudioParameterSelection setComfortNoiseSupported:](v50, "setComfortNoiseSupported:", MEMORY[0x24BDBD1C0]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v47;
          ...
          v60 = 2112;
          v61 = v34;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@One of the intersected candidates is empty: candidateBitrateSettings: %@, candidateSampleRates: %@", buf, 0x20u);
            ...
            for (i = 0; i != v19; ++i)
            {
              ...
              if (v25 != 0x7FFFFFFFFFFFFFFFLL)
              {
                ...
                if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v56 = 2112;
                  v57 = v32;
                  _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Using audio parameter combination: %@", buf, 0x16u);
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v56 = 2112;
                v57 = v23;
                _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Could not find audio parameter combination: %@", buf, 0x16u);
...
- (void)_generateAllCombinations:(id)a3
{
  ...
  v10 = -[HMDCameraAudioParameterCombination initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:](v5, "initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:", v6, v7, v8, &unk_24E96A490, &unk_24E96A490, &unk_24E96A4A8, v9);
  ...
  v16 = -[HMDCameraAudioParameterCombination initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:](v11, "initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:", v12, v13, v14, &unk_24E96A4D8, &unk_24E96A4D8, &unk_24E96A4A8, v15);
  ...
  v22 = -[HMDCameraAudioParameterCombination initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:](v17, "initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:", v18, v19, v20, &unk_24E96A490, &unk_24E96A490, &unk_24E96A4A8, v21);
  ...
  v28 = -[HMDCameraAudioParameterCombination initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:](v23, "initWithCodecGroup:bitrateSetting:sampleRate:maximumBitrate:minimumBitrate:rtcpInterval:rtpPtime:", v24, v25, v26, &unk_24E96A4D8, &unk_24E96A4D8, &unk_24E96A4A8, v27);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_12205 != -1)
    dispatch_once(&logCategory__hmf_once_t0_12205, &__block_literal_global_12206);
  return (id)logCategory__hmf_once_v1_12207;
}
...
void __47__HMDCameraAudioParameterSelection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_12207;
  logCategory__hmf_once_v1_12207 = v0;
