...
- (HMDHomeWalletKey)initWithPKPass:(id)a3 flow:(id)a4
{
  ...
  if (v19 > 3)
    v20 = *MEMORY[0x24BDD63F8];
  else
    v20 = qword_2226A05E8[v19];
...
- (id)xpcWalletKeyWithExpressEnabled:(BOOL)a3 uwbEnabled:(BOOL)a4 clientWalletKeyUUID:(id)a5
{
  ...
  if (v9)
  {
    ...
    if (_os_feature_enabled_impl())
    {
      ...
      {
        AppBooleanValue = CFPreferencesGetAppBooleanValue(CFSTR("UWBUnlock"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0);
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        HMFGetLogIdentifier();
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        -[HMDHomeWalletKey uuid](v15, "uuid");
        ...
        v26 = 2112;
        v27 = v18;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Client Wallet Key UUID set in local store, using it: %@ instead of %@", (uint8_t *)&v22, 0x20u);
...
LABEL_12:
    v13 = v10;
LABEL_13:
    v19 = objc_alloc(MEMORY[0x24BDD76F8]);
    -[HMDHomeWalletKey customURL](self, "customURL");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = (void *)objc_msgSend(v19, "initWithUUID:customURL:expressEnabled:uwbUnlockEnabled:color:", v13, v20, v6, v5, -[HMDHomeWalletKey color](self, "color"));
...
- (BOOL)isMissingNFCInfo
{
  ...
  v7 = objc_msgSend(v6, "na_any:", &__block_literal_global_41523);
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDHomeWalletKey state](self, "state"));
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v32[8] = v20;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v32, 9);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
