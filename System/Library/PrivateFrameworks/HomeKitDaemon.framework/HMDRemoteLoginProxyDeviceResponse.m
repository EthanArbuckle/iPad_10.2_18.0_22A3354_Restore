...
{
  return (NSString *)CFSTR("kHMDRemoteLoginProxyDeviceResponse");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMDRemoteLoginProxyDeviceResponse");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMDRemoteLoginProxyDeviceResponse messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteLoginProxyDeviceResponse proxyDevice](self, "proxyDevice");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("HMDRemoteLoginProxyDeviceResponse: %@, Proxy-Device %@"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[HMRemoteLoginMessage encodeWithCoder:](&v6, sel_encodeWithCoder_, v4);
  -[HMDRemoteLoginProxyDeviceResponse proxyDevice](self, "proxyDevice", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("proxyDevice"));
...
{
  id v4;
  HMDRemoteLoginProxyDeviceResponse *v5;
  uint64_t v6;
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("proxyDevice"));
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMDRemoteLoginProxyDeviceResponse"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMDRemoteLoginProxyDeviceResponse"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
