...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 1, CFSTR("kStreamingStatus_Status"));
...
- (NSData)tlvData
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDStreamingStatus streamingStatus](self, "streamingStatus"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
