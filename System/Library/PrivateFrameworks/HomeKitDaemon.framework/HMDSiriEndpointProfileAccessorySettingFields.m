...
- (void)setBoolValue:(BOOL)a3 forKeyPath:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v6;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to store BOOLean value: %@ for keypath: %@", (uint8_t *)&v18, 0x20u);
...
- (void)setNumberValue:(id)a3 forKeyPath:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to store integer value: %@ for keypath: %@", (uint8_t *)&v15, 0x20u);
...
- (void)setLanguageValue:(id)a3 forKeyPath:(id)a4
{
  ...
  if ((v9 & 1) != 0)
  {
    +[HMDSiriEndpointProfileAccessorySettingFields fieldKeyForKeyPath:](HMDSiriEndpointProfileAccessorySettingFields, "fieldKeyForKeyPath:", v7);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@%@"), v10, CFSTR("_inputLanguageCode"));
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@%@"), v10, CFSTR("_outputVoiceLanguageCode"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@%@"), v10, CFSTR("_outputVoiceGenderCode"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    p_lock = &self->_lock;
    os_unfair_lock_lock_with_options();
    serializeFields = self->_serializeFields;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v29 = 2112;
      v30 = v7;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to store language value: %@ for keypath: %@", buf, 0x20u);
...
{
  return &unk_24E970DD8;
}

+ (id)numberValueKeyPaths
{
  return &unk_24E970DF0;
}

+ (id)languageValueKeyPaths
{
  return &unk_24E970E08;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t7_81881 != -1)
    dispatch_once(&logCategory__hmf_once_t7_81881, &__block_literal_global_81882);
  return (id)logCategory__hmf_once_v8_81883;
}
...
void __59__HMDSiriEndpointProfileAccessorySettingFields_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_81883;
  logCategory__hmf_once_v8_81883 = v0;
