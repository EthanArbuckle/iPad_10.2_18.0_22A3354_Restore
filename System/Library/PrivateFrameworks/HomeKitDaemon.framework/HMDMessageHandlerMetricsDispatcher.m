...
- (void)submitFailureEventOfType:(unint64_t)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v6;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting failure event: %@ for message: %@", (uint8_t *)&v17, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_157308 != -1)
    dispatch_once(&logCategory__hmf_once_t1_157308, &__block_literal_global_157309);
  return (id)logCategory__hmf_once_v2_157310;
}
...
void __49__HMDMessageHandlerMetricsDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_157310;
  logCategory__hmf_once_v2_157310 = v0;
