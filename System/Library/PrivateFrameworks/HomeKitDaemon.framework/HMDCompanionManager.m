...
+ (id)sharedManager
{
  ...
  if (v4 == 3)
  {
    ...
    block[4] = a1;
    if (sharedManager_onceToken_95306 != -1)
      dispatch_once(&sharedManager_onceToken_95306, block);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_95298 != -1)
    dispatch_once(&logCategory__hmf_once_t6_95298, &__block_literal_global_95299);
  return (id)logCategory__hmf_once_v7_95300;
}
...
void __34__HMDCompanionManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_95300;
  logCategory__hmf_once_v7_95300 = v0;
