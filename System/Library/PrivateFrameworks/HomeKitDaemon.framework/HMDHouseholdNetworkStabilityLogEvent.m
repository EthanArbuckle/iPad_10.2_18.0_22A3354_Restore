...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numStabilityReporters](self, "numStabilityReporters"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v16[0] = v14;
  v15[1] = CFSTR("numWifiAssociations");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numWifiAssociations](self, "numWifiAssociations"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v16[1] = v3;
  v15[2] = CFSTR("numWifiDisassociations");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numWifiDisassociations](self, "numWifiDisassociations"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v16[2] = v4;
  v15[3] = CFSTR("numWifiAPChanges");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numAPChanges](self, "numAPChanges"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v16[3] = v5;
  v15[4] = CFSTR("numGatewayChanges");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numGatewayChanges](self, "numGatewayChanges"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v16[4] = v6;
  v15[5] = CFSTR("numReadWrites");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numReadWrites](self, "numReadWrites"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v16[5] = v7;
  v15[6] = CFSTR("numReadErrors");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numReadErrors](self, "numReadErrors"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v16[6] = v8;
  v15[7] = CFSTR("numWriteErrors");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numWriteErrors](self, "numWriteErrors"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v16[7] = v9;
  v15[8] = CFSTR("numSessionErrors");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numSessionErrors](self, "numSessionErrors"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v16[8] = v10;
  v15[9] = CFSTR("numNetworkSignatures");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHouseholdNetworkStabilityLogEvent numNetworkSignatures](self, "numNetworkSignatures"));
