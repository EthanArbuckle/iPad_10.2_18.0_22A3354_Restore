...
- (HMDHomePersonManager)initWithHome:(id)a3 zoneUUID:(id)a4 workQueue:(id)a5
{
  ...
  HMDPersonCoreDataManager *v30;
  HMDHomePersonManager *v31;

  v8 = a3;
  v9 = a5;
  v10 = (void *)MEMORY[0x24BDD76E8];
  v11 = a4;
...
LABEL_4:
  ...
  v30 = -[HMDPersonCoreDataManager initWithUUID:workQueue:home:userUUID:]([HMDPersonCoreDataManager alloc], "initWithUUID:workQueue:home:userUUID:", v13, v9, v8, 0);
  v31 = -[HMDHomePersonManager initWithUUID:zoneManager:coreDataManager:dataInterfaces:workQueue:home:](self, "initWithUUID:zoneManager:coreDataManager:dataInterfaces:workQueue:home:", v13, v26, v30, v14, v9, v8);
...
{
  id v13;
  HMDHomePersonManager *v14;
  objc_super v16;

  v16.receiver = self;
  v16.super_class = (Class)HMDHomePersonManager;
  v13 = a8;
  v14 = -[HMDPersonManager initWithUUID:zoneManager:coreDataManager:dataInterfaces:workQueue:](&v16, sel_initWithUUID_zoneManager_coreDataManager_dataInterfaces_workQueue_, a3, a4, a5, a6, a7);
...
- (HMIHomePersonManager)hmiPersonManager
{
  ...
  objc_msgSend(v2, "na_map:", &__block_literal_global_106592);
...
- (void)handleUpdatedSettings:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v23 = 2112;
    v24 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Home person manager settings changed: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_106612 != -1)
    dispatch_once(&logCategory__hmf_once_t1_106612, &__block_literal_global_26_106613);
  return (id)logCategory__hmf_once_v2_106614;
}
...
void __35__HMDHomePersonManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_106614;
  logCategory__hmf_once_v2_106614 = v0;
