...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_185139 != -1)
    dispatch_once(&logCategory__hmf_once_t0_185139, &__block_literal_global_185140);
  return (id)logCategory__hmf_once_v1_185141;
}

+ (NSUUID)namespaceID
{
  if (namespaceID_onceToken != -1)
    dispatch_once(&namespaceID_onceToken, &__block_literal_global_1_185136);
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_185123 != -1)
    dispatch_once(&hmbProperties_onceToken_185123, &__block_literal_global_5_185124);
  return (id)hmbProperties_properties_185125;
}
...
void __83__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudAccessoryModel_hmbProperties__block_invoke()
{
  ...
  v3 = (void *)hmbProperties_properties_185125;
  hmbProperties_properties_185125 = v2;
...
void __81__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudAccessoryModel_namespaceID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("da9f7191-31bc-4567-9424-89b86310c2e7"));
...
void __81__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudAccessoryModel_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_185141;
  logCategory__hmf_once_v1_185141 = v0;
