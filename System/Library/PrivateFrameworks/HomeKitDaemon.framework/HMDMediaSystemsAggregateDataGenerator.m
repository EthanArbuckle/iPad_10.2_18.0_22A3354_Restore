...
LABEL_6:
  ...
  if (v10)
  {
    v12 = objc_alloc(MEMORY[0x24BDD7780]);
...
- (id)nameForMediaSystemData:(id)a3 room:(id)a4
{
  ...
  if (v8)
  {
    ...
    if ((v11 & 1) == 0)
    {
      v13 = (void *)MEMORY[0x227676638](v7);
      v14 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v16;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine default group name", (uint8_t *)&v18, 0xCu);
...
- (id)roomForAllDestinationParentIdentifiers:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get room for all destination parent identifiers: %@ data source: %@", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get room for all destination parent identifiers: %@ to no data source", (uint8_t *)&v19, 0x16u);
