          ...
          if ((objc_msgSend(*(id *)(a1 + 40), "containsObject:", v8) & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138545922;
              ...
              v53 = 2114;
              v54 = v17;
              _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@For Task: %{public}@ -- %{public}@ %tu characteristic(s) on accessory %{public}@ completed with error: %{public}@ (Resident first error: %{public}@), Total duration: %ld ms (Local duration: %ld ms, Resident first duration: %ld ms) using transport: %{public}@", buf, 0x70u);
