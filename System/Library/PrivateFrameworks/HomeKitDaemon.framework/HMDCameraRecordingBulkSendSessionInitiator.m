...
- (void)stop
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 138543362;
    v17 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Stopping bulk send session initiator", (uint8_t *)&v16, 0xCu);
  ...
  if (v8)
  {
    if (v12)
    {
      ...
      v18 = 2112;
      v19 = v8;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Removing bulk send listener: %@", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    if (v12)
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Ignoring stop request because we have no active listener", (uint8_t *)&v16, 0xCu);
...
- (void)openNewSessionWithCallback:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Opening new session", buf, 0xCu);
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot open new session because a session is already being opened", buf, 0xCu);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v22;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Registering bulk send listener before opening new session", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v35 = v29;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Establishing local HAP connection with accessory because it cannot currently accept bulk send listeners", buf, 0xCu);
...
- (void)_registerBulkSendListener
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering bulk send listener: %@", (uint8_t *)&v12, 0x16u);
...
- (void)listenerDidReceiveDataStreamStart:(id)a3
{
  ...
  if (v6 == v4)
  {
    if (v10)
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Data stream did start for listener: %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    if (v10)
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring data stream start for irrelevant listener: %@", (uint8_t *)&v19, 0x16u);
...
- (void)listenerDidReceiveDataStreamClose:(id)a3
{
  ...
  if (v6 == v4)
  {
    if (v10)
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Data stream did close for listener: %@", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    if (v10)
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring data stream close for irrelevant listener: %@", (uint8_t *)&v13, 0x16u);
...
uint64_t __103__HMDCameraRecordingBulkSendSessionInitiator_handleAccessoryDoesSupportBulkSendDataStreamNotification___block_invoke(uint64_t a1)
{
  ...
  if ((_DWORD)result)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Accessory now supports data streams so registering bulk send listener because we were waiting for accessory", (uint8_t *)&v7, 0xCu);
...
void __73__HMDCameraRecordingBulkSendSessionInitiator_openNewSessionWithCallback___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to start HAP session with camera: %@", (uint8_t *)&v9, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_148253 != -1)
    dispatch_once(&logCategory__hmf_once_t14_148253, &__block_literal_global_148254);
  return (id)logCategory__hmf_once_v15_148255;
}
...
void __57__HMDCameraRecordingBulkSendSessionInitiator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v15_148255;
  logCategory__hmf_once_v15_148255 = v0;
