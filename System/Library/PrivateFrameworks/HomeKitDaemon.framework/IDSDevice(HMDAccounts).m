...
- (id)hmd_productInfo
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v28 = 2112;
    v29 = v8;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Could not determine product platform from product name '%@' for device: %@", buf, 0x20u);
...
LABEL_7:
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v28 = 2112;
      v29 = v13;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Could not determine product class from model identifier '%@' for device: %@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v12);
  }
LABEL_10:
  v17 = objc_alloc(MEMORY[0x24BE3F260]);
  v18 = (void *)MEMORY[0x24BE3F270];
...
LABEL_11:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    v22 = 138543362;
    v23 = v20;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create device identifier", (uint8_t *)&v22, 0xCu);
