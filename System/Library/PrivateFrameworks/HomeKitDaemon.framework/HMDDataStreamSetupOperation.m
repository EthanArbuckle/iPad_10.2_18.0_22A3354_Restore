...
- (void)continueStreamSetupWithResponse:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v62 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] Parsing accessory response", buf, 0xCu);
    ...
    if (v20)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v63 = 2112;
        v64 = v25;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply errored out: %@", buf, 0x16u);
    ...
    if (v34 || !v33)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v63 = 2112;
        v64 = v34;
        _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply could not be parsed (error=%@)", buf, 0x16u);
...
LABEL_42:
      _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, v48, buf, 0xCu);
...
LABEL_46:
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", v38);
    v34 = (id)objc_claimAutoreleasedReturnValue();
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v63 = 2112;
        v64 = v53;
        _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write failed with status %@", buf, 0x16u);
...
LABEL_17:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v62 = v30;
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply does not contain a response", buf, 0xCu);
...
- (void)startSetup
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%s must be overridden in a subclass/category"), "-[HMDDataStreamSetupOperation startSetup]");
...
- (void)processTransportSetupResponse:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%s must be overridden in a subclass/category"), "-[HMDDataStreamSetupOperation processTransportSetupResponse:]");
