...
{
  return (id)objc_msgSend(MEMORY[0x24BE6B608], "futureWithNoResult", a3);
}
...
{
  return (id)objc_msgSend(MEMORY[0x24BE6B608], "futureWithResult:", &unk_24E96B858);
}
...
- (NSUUID)currentAccessoryUUID
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "na_firstObjectPassingTest:", &__block_literal_global_166);
