...
- (HMDAccountHandle)initWithURI:(id)a3 local:(BOOL)a4
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      v9 = v6;
      if (v8 != -1)
        dispatch_once(&__identifierForURI_onceToken, &__block_literal_global_425);
...
- (HMDAccountHandle)initWithBackingModel:(id)a3
{
  ...
  v5 = (HMDAccountHandle *)objc_claimAutoreleasedReturnValue();
  ...
  v8 = -[HMDAccountHandle initWithURI:local:](self, "initWithURI:local:", v6, objc_msgSend(v7, "BOOLValue"));
...
LABEL_6:
  ...
  v15 = (HMDAccountHandle *)_HMFPreconditionFailure();
  return (HMDAccountHandle *)-[HMDAccountHandle backingModelType](v15, v16);
}
...
- (BOOL)updateBackingModel:(id)a3 error:(id *)a4
{
  ...
  if ((v8 & 1) != 0)
  {
    ...
    objc_msgSend(v5, "idsURI");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = HMFEqualObjects();

    if ((v11 & 1) == 0)
      objc_msgSend(v5, "setIdsURI:", v9);

    v12 = -[HMDAccountHandle isLocal](self, "isLocal");
    objc_msgSend(v5, "local");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = v13;
    if (!v13 || v12 != objc_msgSend(v13, "BOOLValue"))
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", v12);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setLocal:", v15);
  ...
  {
    v17 = (HMDAccountHandle *)_HMFPreconditionFailure();
    return -[HMDAccountHandle backingModelKey](v17, v18);
  }
}
...
- (CNContact)contact
{
  ...
  v6 = &v5;
  v7 = 0x3032000000;
  v8 = __Block_byref_object_copy__104483;
  v9 = __Block_byref_object_dispose__104484;
  v10 = 0;
  ...
  v4[4] = self;
  v4[5] = &v5;
  objc_msgSend(MEMORY[0x24BE3F138], "activityWithName:parent:options:block:", CFSTR("Account.Contact"), 0, 1, v4);
  v2 = (id)v6[5];
...
- (CKUserIdentityLookupInfo)cloudKitLookupInfo
{
  ...
  if (v3 == 2)
  {
    ...
    if (v5)
    {
      v6 = objc_msgSend(objc_alloc(MEMORY[0x24BDB9258]), "initWithPhoneNumber:", v5);
      goto LABEL_7;
    }
LABEL_9:
    v8 = 0;
  ...
  if (v3 == 1)
  {
    ...
    if (v5)
    {
      v6 = objc_msgSend(objc_alloc(MEMORY[0x24BDB9258]), "initWithEmailAddress:", v5);
LABEL_7:
      v8 = (void *)v6;
LABEL_10:
  ...
  if (v13)
  {
      ...
      if (objc_msgSend(v20, "diff:differingFields:", v15, 0))
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v45 = v24;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating account handle", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v45 = v36;
        _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve model for updated account handle", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v32 = v49;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated:newValues:message:]", buf, 0x20u);
...
- (id)modelObjectWithChangeType:(unint64_t)a3 version:(int64_t)a4
{
  ...
  if (v6)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccountHandle isLocal](self, "isLocal"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Account handle is missing parent identifier, returning nil", (uint8_t *)&v19, 0xCu);
...
void __27__HMDAccountHandle_contact__block_invoke(uint64_t a1)
{
  ...
  if (HMDAccountHandleModelIdentifierNamespaceUUIDString_block_invoke_onceToken != -1)
    dispatch_once(&HMDAccountHandleModelIdentifierNamespaceUUIDString_block_invoke_onceToken, &__block_literal_global_104488);
  v17 = *(id *)(a1 + 32);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_104523 != -1)
    dispatch_once(&logCategory__hmf_once_t9_104523, &__block_literal_global_306_104524);
  return (id)logCategory__hmf_once_v10_104525;
}
...
void __31__HMDAccountHandle_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_104525;
  logCategory__hmf_once_v10_104525 = v0;
