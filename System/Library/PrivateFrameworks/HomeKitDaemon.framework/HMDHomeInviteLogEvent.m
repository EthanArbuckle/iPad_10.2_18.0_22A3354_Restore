      ...
      default:
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v17 = v12;
          _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@No home invitation event to log. Invitation was cancelled or is pending.", buf, 0xCu);
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent received](self, "received"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v21[0] = v19;
  v20[1] = CFSTR("filtered_BOOL");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent filtered](self, "filtered"));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v21[1] = v18;
  v20[2] = CFSTR("suppressedNotification_BOOL");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent suppressedNotification](self, "suppressedNotification"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v21[2] = v17;
  v20[3] = CFSTR("accepted_BOOL");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent accepted](self, "accepted"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v21[3] = v16;
  v20[4] = CFSTR("declined_BOOL");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent declined](self, "declined"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v21[4] = v15;
  v20[5] = CFSTR("ignored_BOOL");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent ignored](self, "ignored"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v21[5] = v14;
  v20[6] = CFSTR("expired_BOOL");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent expired](self, "expired"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomeInviteLogEvent isFMFDevice](self, "isFMFDevice"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v21[14] = v11;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v21, v20, 15);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
