...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_144930 != -1)
    dispatch_once(&logCategory__hmf_once_t0_144930, &__block_literal_global_144931);
  return (id)logCategory__hmf_once_v1_144932;
}
...
void __33__HMDRemoteLoginBase_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_144932;
  logCategory__hmf_once_v1_144932 = v0;
