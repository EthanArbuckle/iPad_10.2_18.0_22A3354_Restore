...
- (void)_setupMessageRegistrations
{
  ...
  -[COMeshController registerHandler:forCommandClass:](self, "registerHandler:forCommandClass:", &__block_literal_global_214221, objc_opt_class());
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Could not find the destination node to send the ping request", buf, 0xCu);
...
- (NSArray)meshNodes
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "na_map:", &__block_literal_global_20_214158);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)debugDescriptionForMeshState
{
  ...
  if (v4 >= 5)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Unknown(%d)"), -[COMeshController state](self, "state"));
...
void __72__HMDCoordinationLocalElectionMeshController__setupMessageRegistrations__block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Responding to ping request", (uint8_t *)&v13, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_214243 != -1)
    dispatch_once(&logCategory__hmf_once_t3_214243, &__block_literal_global_45_214244);
  return (id)logCategory__hmf_once_v4_214245;
}
...
void __57__HMDCoordinationLocalElectionMeshController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_214245;
  logCategory__hmf_once_v4_214245 = v0;
