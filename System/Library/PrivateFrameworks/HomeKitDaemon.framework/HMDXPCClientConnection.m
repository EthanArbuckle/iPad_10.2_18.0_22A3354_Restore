...
- (Class)principalClass
{
  ...
  objc_msgSend(v2, "hmf_stringForKey:", *MEMORY[0x24BDD6A38]);
...
- (void)__handleApplicationStateChange:(id)a3
{
  ...
  else
  {
    ...
    +[HMDXPCMessageTransport defaultTransport](v10, v11);
  }
}
...
+ (unint64_t)entitlementsForConnection:(id)a3
{
  ...
  if (!validateEntitlementForConnection(CFSTR("com.apple.private.homekit"), v4))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Client should adopt %@ entitlement: %@", (uint8_t *)&v13, 0x20u);
...
- (void)updateSendPolicyParameters:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting sendPolicyParameters to %@", (uint8_t *)&v9, 0x16u);
...
- (unint64_t)homeManagerOptions
{
  ...
  -[HMDXPCClientConnection userInfo](self, "userInfo");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "hmf_numberForKey:", *MEMORY[0x24BDD6088]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDXPCClientConnection clientPid](self, "clientPid", v5));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)deactivate
{
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Deactivating XPC connection", (uint8_t *)&v12, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Not de-activating already de-activated XPC connection", (uint8_t *)&v12, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t36 != -1)
    dispatch_once(&logCategory__hmf_once_t36, &__block_literal_global_53323);
...
- (HMDXPCClientConnection)initWithConnection:(id)a3
{
  ...
  {
    v5 = v4;
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%u"), objc_msgSend(v4, "processIdentifier"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v15 = (HMDXPCClientConnection *)_HMFPreconditionFailure();
    return -[HMDXPCClientConnection initWithConnection:queue:messageCountTracker:requestTracker:](v15, v16, v17, v18, v19, v20);
  }
}
...
LABEL_10:
  ...
  {
LABEL_11:
    v22 = (HMDXPCClientConnection *)_HMFPreconditionFailure();
    -[HMDXPCClientConnection dealloc](v22, v23);
    return result;
  }
  v24.receiver = self;
  v24.super_class = (Class)HMDXPCClientConnection;
  v16 = -[HMDXPCClientConnection init](&v24, sel_init);
  if (v16)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%d"), objc_msgSend(v11, "processIdentifier"));
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@XPC connection got deallocated.", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updated user info: %@", buf, 0x16u);
...
- (NSString)clientName
{
  ...
  -[HMDXPCClientConnection userInfo](self, "userInfo");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "hmf_stringForKey:", *MEMORY[0x24BDD6A40]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)clientUUID
{
  ...
  -[HMDXPCClientConnection userInfo](self, "userInfo");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "hmf_UUIDForKey:", *MEMORY[0x24BDD7298]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isAdaptive
{
  ...
  -[HMDXPCClientConnection userInfo](self, "userInfo");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "hmf_BOOLForKey:", *MEMORY[0x24BDD5E40]);
  ...
  else
  {
    ...
    if (processInfo)
    {
      ...
      else
      {
        ...
        {
          -[NSDictionary hmf_stringForKey:](self->_userInfo, "hmf_stringForKey:", *MEMORY[0x24BDD6A40]);
...
- (BOOL)isAuthorizedForLocationAccess
{
  ...
  if ((-[HMDXPCClientConnection entitlements](self, "entitlements") & 0x400) != 0)
  {
    ...
    v4 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F198]), "initWithBundle:", v3);
  }
  else
  {
    -[HMDXPCClientConnection processInfo](self, "processInfo");
...
- (NSDictionary)stateDump
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDXPCClientConnection clientPid](self, "clientPid"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)canSendMessage:(id)a3
{
  ...
  if (v5 && (objc_msgSend(v5, "isEqual:", self) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v27 = 32;
LABEL_55:
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_DEBUG, v12, (uint8_t *)&v31, v27);
LABEL_56:
...
LABEL_54:
  ...
  if (v15)
  {
    ...
    v37 = 2112;
    v38 = v30;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Cannot send message %@: Message send policy %@ does not pass client connection send policy: %@", (uint8_t *)&v31, 0x2Au);
...
- (void)_handleMessage:(id)a3 responseHandler:(id)a4
{
  ...
  v7 = objc_alloc(MEMORY[0x24BE3F138]);
  v8 = (void *)MEMORY[0x24BE3F1B0];
  objc_msgSend(v6, "name");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "activityNameWithMessageName:", v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v55 = (void *)objc_msgSend(v7, "initWithName:", v10);

  objc_msgSend(v6, "headers");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "objectForKeyedSubscript:", *MEMORY[0x24BDD5248]);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v55, "setClientMetricIdentifier:", v14);
  objc_msgSend(v6, "name");
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    if (getDenylistKeys_onceToken != -1)
      dispatch_once(&getDenylistKeys_onceToken, &__block_literal_global_360_53241);
    ...
    *(_DWORD *)buf = 138545410;
    ...
    v78 = 2114;
    v79 = v23;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Received incoming message %{public}@ (%{public}@) from client '%{public}@' for target %{public}@ that does%{public}s expect a response, payload %{public}@, QoS: %{public}@", buf, 0x5Cu);
  ...
  objc_msgSend(v27, "setActivity:", v55);
  -[HMDXPCClientConnection applicationBundleIdentifier](v15, "applicationBundleIdentifier");
  v36 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v27, "setUntrustedClientIdentifier:", v36);
  ...
  if (v54)
  {
    ...
    v59 = v53;
    v60 = v6;
    objc_msgSend(v27, "setResponseHandler:", v56);
  ...
  {
    objc_msgSend(v55, "end");
  }
  -[HMFMessageTransport delegate](v15, "delegate");
  v42 = (void *)objc_claimAutoreleasedReturnValue();
  v43 = (void *)objc_msgSend(v27, "copy");
  objc_msgSend(v42, "messageTransport:didReceiveMessage:", v15, v43);
...
- (void)activate
{
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Not activating already activated XPC connection", (uint8_t *)&v12, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Activating XPC connection", (uint8_t *)&v12, 0xCu);
...
- (void)initiateRefresh
{
  ...
  v3 = (void *)MEMORY[0x24BE3F1B0];
  v4 = *MEMORY[0x24BDD7290];
...
void __56__HMDXPCClientConnection_sendMessage_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "canSendMessage:", *(_QWORD *)(a1 + 40)) & 1) != 0)
  {
      ...
      || objc_msgSend(*(id *)(a1 + 40), "requiresHomeLocationEntitlement"))
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Marking location for message: %@", buf, 0x16u);
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "setHeaderValue:forKey:", v11, *MEMORY[0x24BDD72C0]);
...
void __56__HMDXPCClientConnection_sendMessage_completionHandler___block_invoke_127(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remote object proxy for sending message: %@", (uint8_t *)&v8, 0x16u);
...
void __57__HMDXPCClientConnection___handleApplicationStateChange___block_invoke(uint64_t a1)
{
  ...
  if (v4 == 1)
  {
    if (objc_msgSend(*(id *)(a1 + 40), "isActivated"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v13 = 138543362;
        v14 = v12;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Deactivating XPC connection that is now in the background", (uint8_t *)&v13, 0xCu);
  ...
  else if (!v4 && (objc_msgSend(*(id *)(a1 + 40), "isActivated") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Activating XPC connection that is now in the foreground and initiating refresh", (uint8_t *)&v13, 0xCu);
