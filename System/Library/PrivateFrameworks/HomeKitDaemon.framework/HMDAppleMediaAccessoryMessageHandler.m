...
- (void)handleAppleMediaAccessoryDeviceUpdatedNotification:(id)a3
{
  ...
  if (-[HMDMessageHandler hasQueuedOutgoingMessages](self, "hasQueuedOutgoingMessages"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling apple media accessory device updated notification: %@", (uint8_t *)&v9, 0x16u);
...
- (void)handleAppleMediaAccessoryDeviceIsReachableNotification:(id)a3
{
  ...
  if (v7)
  {
    if (-[HMDMessageHandler hasQueuedOutgoingMessagesForDevice:](self, "hasQueuedOutgoingMessagesForDevice:", v7))
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 2112;
        v20 = v7;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling remote device is reachable notification with device: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v16;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get device from remote device is reachable notification object: %@", (uint8_t *)&v17, 0x16u);
