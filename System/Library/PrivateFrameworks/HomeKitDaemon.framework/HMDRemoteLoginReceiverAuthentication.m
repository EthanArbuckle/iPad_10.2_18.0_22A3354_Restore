...
- (void)_authenticateForAccountType:(unint64_t)a3 usingAuthenticationResults:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v14;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Authenticating account type %@", (uint8_t *)&v21, 0x16u);
  ...
  if (a3)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v19;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@%s: Unknown account services: %@", (uint8_t *)&v21, 0x20u);
...
- (void)_authenticateStoreWithAuthenticationResults:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v28 = a4;
  objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x24BE0ABF0]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x24BE0AB48]);
  v8 = objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x24BE0ABD0]);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x24BE0ABD8]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v42 = 2112;
    v43 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Authenticating iTunes account with username %@, altDSID: %@, pet: %@", buf, 0x2Au);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v38 = 2112;
    v39 = v19;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Password: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v15);
  v20 = objc_alloc_init(MEMORY[0x24BE08020]);
  objc_msgSend(v20, "setAuthenticationType:", 1);
  v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE08038]), "initWithAuthenticationResults:options:", v6, v20);
...
- (void)_authenticateAccount:(id)a3 targetedAccountType:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Authenticating the account with context: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&location[4] = v13;
      v17 = 2112;
      v18 = v9;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Authentication results is not valid, resulted in error %@", location, 0x16u);
...
- (void)_completedAuthenticationRequest:(id)a3 loggedInAccount:(id)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v7, "conformsToProtocol:", &unk_2558A38A0))
    v8 = v7;
  else
    v8 = 0;
  v9 = v8;
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@iTunes authentication failed. (%@). Error: %@", (uint8_t *)&v11, 0x20u);
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@iTunes successfully authenticated. Making active. (%@).", buf, 0x16u);
  ...
  objc_msgSend(*(id *)(a1 + 48), "account");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("wasOtherAccount"));
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke_27(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v8;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Succeeded in save of account: %@", (uint8_t *)&v11, 0x16u);
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke_29(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v17 = 2112;
    v18 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to save account %@: %@", (uint8_t *)&v13, 0x20u);
...
void __78__HMDRemoteLoginReceiverAuthentication__saveRemoteVerifiedAccount_completion___block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if ((a2 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v11;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Save of verified account successful; %@.",
        (uint8_t *)&v17,
        0x16u);
  ...
  else
  {
    ...
    if (v12 == 5)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 2112;
        v20 = v15;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Account already existed %@.", (uint8_t *)&v17, 0x16u);
    ...
    else if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Save of account failed. This will stop further attempts as this should not fail. Error: %@", (uint8_t *)&v17, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_169204 != -1)
    dispatch_once(&logCategory__hmf_once_t0_169204, &__block_literal_global_169205);
  return (id)logCategory__hmf_once_v1_169206;
}
...
void __51__HMDRemoteLoginReceiverAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_169206;
  logCategory__hmf_once_v1_169206 = v0;
