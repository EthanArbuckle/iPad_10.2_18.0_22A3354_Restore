...
- (void)_requestUserPermissionForUnauthenticatedAccessory:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  v16 = *MEMORY[0x24BDBD6E0];
  v23[0] = *MEMORY[0x24BDBD6D8];
  v23[1] = v16;
  v24[0] = v12;
  v24[1] = v13;
  v17 = *MEMORY[0x24BDBD6F8];
  v23[2] = *MEMORY[0x24BDBD6F0];
  v23[3] = v17;
  v24[2] = v14;
  v24[3] = v15;
...
- (void)_requestUserPermissionWithAccessoryPPIDInfo:(id)a3 name:(id)a4 category:(id)a5 withContext:(id)a6 queue:(id)a7 completionHandler:(id)a8
{
  ...
  if (objc_msgSend(v14, "isDenylisted"))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Accessory is Blacklisted - Rejecting", buf, 0xCu);
  ...
  else
  {
    ...
    if (!v29)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v76 = 2112;
        v77 = v30;
        _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
        ...
        if (!v42)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v76 = 2112;
            v77 = v43;
            _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    ...
    v51 = *MEMORY[0x24BDBD6E0];
    v68[0] = *MEMORY[0x24BDBD6D8];
    v68[1] = v51;
    v69[0] = v23;
    v69[1] = v25;
    v52 = *MEMORY[0x24BDBD6F8];
    v68[2] = *MEMORY[0x24BDBD6F0];
    v68[3] = v52;
    v69[2] = v49;
    v69[3] = v50;
...
- (void)_requestUserPermissionForDeletionOfHomeWithName:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  if (!v22)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v51 = 2112;
      v52 = v23;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
  ...
  v30 = *MEMORY[0x24BDBD6F0];
  v43[0] = *MEMORY[0x24BDBD6D8];
  v43[1] = v30;
  v44[0] = v19;
  v44[1] = v28;
  v31 = *MEMORY[0x24BDBD6F8];
  v43[2] = *MEMORY[0x24BEB0E10];
  v43[3] = v31;
  v44[2] = &unk_24E96AD90;
  v44[3] = v29;
...
- (void)_requestUserPermissionForRemovalOfRouter:(id)a3 accessoriesRequiringManualReconfiguration:(id)a4 withContext:(id)a5 queue:(id)a6 completionHandler:(id)a7
{
  ...
  v45 = *MEMORY[0x24BDBD6D8];
  v70[0] = *MEMORY[0x24BDBD6D8];
  ...
  v71[0] = v15;
  v16 = *MEMORY[0x24BDBD6E0];
  v70[1] = *MEMORY[0x24BDBD6E0];
  localizedWiFiStringKey();
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  HMDLocalizedStringForKey(v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v71[1] = v18;
  v50 = *MEMORY[0x24BDBD6F0];
  v70[2] = *MEMORY[0x24BDBD6F0];
  HMDLocalizedStringForKey(CFSTR("CANCEL"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v71[2] = v19;
  v49 = *MEMORY[0x24BDBD6F8];
  v70[3] = *MEMORY[0x24BDBD6F8];
  if (v13)
    v20 = CFSTR("CONTINUE");
  else
    v20 = CFSTR("REMOVE");
  ...
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v48 = *MEMORY[0x24BEB0E28];
  v70[4] = *MEMORY[0x24BEB0E28];
  v71[3] = v22;
  v71[4] = v21;
...
LABEL_17:
  ...
  {
    v44 = v24;
    objc_msgSend(MEMORY[0x24BDD1640], "localizedStringByJoiningStrings:", v53);
    ...
    if (!v33)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v66 = 2112;
        v67 = v34;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
...
- (void)_requestUserPermissionForRemovalOfSpecificWiFiCredentialedAccessory:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v41 = 2112;
      v42 = v17;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
  ...
  v44[1] = v23;
  v43[2] = *MEMORY[0x24BDBD6F0];
  HMDLocalizedStringForKey(CFSTR("CANCEL"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v44[2] = v24;
  v43[3] = *MEMORY[0x24BDBD6F8];
  HMDLocalizedStringForKey(CFSTR("REMOVE"));
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  v43[4] = *MEMORY[0x24BEB0E28];
  v44[3] = v25;
  v44[4] = &unk_24E96AD90;
...
- (void)_showUserDialogForIncompatibleAccessory:(id)a3 name:(id)a4 category:(id)a5 withContext:(id)a6 queue:(id)a7 completionHandler:(id)a8
{
  ...
  v17 = *MEMORY[0x24BDBD6E0];
  v22[0] = *MEMORY[0x24BDBD6D8];
  v22[1] = v17;
  v23[0] = v14;
  v23[1] = v15;
  v22[2] = *MEMORY[0x24BDBD6F8];
  v23[2] = v16;
...
- (void)_requestUserPermissionForLegacyWACAccessory:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  HMDLocalizedStringForKey(CFSTR("ALLOW"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = *MEMORY[0x24BDBD6E0];
  v39[0] = *MEMORY[0x24BDBD6D8];
  v39[1] = v27;
  v40[0] = v13;
  v40[1] = v24;
  v28 = *MEMORY[0x24BDBD6F8];
  v39[2] = *MEMORY[0x24BDBD6F0];
  v39[3] = v28;
  v40[2] = v25;
  v40[3] = v26;
...
- (void)_displayKeychainSyncForHome:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  HMDLocalizedStringForKey(CFSTR("OK"));
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  v26 = *MEMORY[0x24BDBD6E0];
  v37[0] = *MEMORY[0x24BDBD6D8];
  v37[1] = v26;
  v38[0] = v14;
  v38[1] = v23;
  v27 = *MEMORY[0x24BDBD6F0];
  v37[2] = *MEMORY[0x24BDBD6F8];
  v37[3] = v27;
  v38[2] = v25;
  v38[3] = v24;
...
- (void)_displayInternalTTRErrorWithContext:(id)a3 message:(id)a4 completionHandler:(id)a5
{
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = *MEMORY[0x24BDBD6E0];
  v17[0] = *MEMORY[0x24BDBD6D8];
  v17[1] = v13;
  v18[0] = v11;
  v18[1] = v9;
  v14 = *MEMORY[0x24BDBD6F8];
  v17[2] = *MEMORY[0x24BDBD718];
  v17[3] = v14;
  v18[2] = v12;
...
- (BOOL)_presentDialogWithInfo:(id)a3 options:(unint64_t)a4 targetResponse:(unint64_t)a5 textField:(id *)a6 withContext:(id)a7 selectedByPeerDevice:(BOOL *)a8 timeout:(double)a9
{
  ...
  v16 = a7;
  error = -1;
  v17 = CFUserNotificationCreate((CFAllocatorRef)*MEMORY[0x24BDBD240], a9, a4, &error, (CFDictionaryRef)a3);
  if (error
  ...
  else
  {
    if (a6)
    {
      CFUserNotificationGetResponseValue(v17, (CFStringRef)*MEMORY[0x24BDBD728], 0);
      ...
      if (!v5)
      {
        ...
        if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v44 = v6;
LABEL_13:
          _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
...
LABEL_15:
    ...
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = *MEMORY[0x24BDBD6E0];
    v35[0] = *MEMORY[0x24BDBD6D8];
    v35[1] = v18;
    v36[0] = v2;
    v36[1] = v15;
    v19 = *MEMORY[0x24BDBD6F0];
    v35[2] = *MEMORY[0x24BDBD6F8];
    v35[3] = v19;
    v36[2] = v17;
    v36[3] = v16;
    v20 = *MEMORY[0x24BEB0E58];
    v35[4] = *MEMORY[0x24BDBD6E8];
    v35[5] = v20;
    v36[4] = MEMORY[0x24BDBD1C8];
...
void __89__HMDUIDialogPresenter_confirmReportAccessory_context_completionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = *MEMORY[0x24BDBD6E0];
  v25[0] = *MEMORY[0x24BDBD6D8];
  v25[1] = v14;
  v26[0] = v10;
  v26[1] = v11;
  v15 = *MEMORY[0x24BDBD6F0];
  v25[2] = *MEMORY[0x24BDBD718];
  v25[3] = v15;
  v26[2] = v12;
  v26[3] = v13;
...
+ (id)sharedUIDialogPresenter
{
  if (sharedUIDialogPresenter_onceToken != -1)
    dispatch_once(&sharedUIDialogPresenter_onceToken, &__block_literal_global_57937);
