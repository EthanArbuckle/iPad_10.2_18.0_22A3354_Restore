...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v11, 0xCu);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 138543362;
    v12 = v10;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@This device does not support Thread network stability reporting", (uint8_t *)&v11, 0xCu);
...
- (void)_runLoggingForDate:(id)a3 isDailySummary:(BOOL)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 2112;
      v19 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Submitting HMDThreadNetworkStabilityLogEvent: %@", (uint8_t *)&v16, 0x16u);
...
- (id)_keyOfLargestCountInHistogram:(id)a3
{
  ...
  v8 = &v7;
  v9 = 0x3032000000;
  v10 = __Block_byref_object_copy__195353;
  v11 = __Block_byref_object_dispose__195354;
  v12 = 0;
...
{
  if (supportedEventClasses_onceToken_195398 != -1)
    dispatch_once(&supportedEventClasses_onceToken_195398, &__block_literal_global_195399);
  return (id)supportedEventClasses_supportedEventClasses_195400;
}
...
void __49__HMDThreadNetworkObserver_supportedEventClasses__block_invoke()
{
  ...
  v1 = (void *)supportedEventClasses_supportedEventClasses_195400;
  supportedEventClasses_supportedEventClasses_195400 = v0;
