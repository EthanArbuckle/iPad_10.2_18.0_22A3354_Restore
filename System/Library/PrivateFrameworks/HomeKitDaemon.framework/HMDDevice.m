...
LABEL_25:
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v28;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to create device identifier", buf, 0xCu);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v25;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Device is required", buf, 0xCu);
...
- (HMDDevice)initWithIdentifier:(id)a3 handles:(id)a4 name:(id)a5 productInfo:(id)a6 version:(id)a7 capabilities:(id)a8
{
  ...
  if (v14)
  {
    v20 = v19;
    v37.receiver = self;
    v37.super_class = (Class)HMDDevice;
    v21 = -[HMDDevice init](&v37, sel_init);
    v22 = v21;
    if (v21)
    {
  ...
  else
  {
    ...
    return -[HMDDevice initWithDeviceAddress:](v34, v35, v36);
  }
}
...
- (HMDDevice)initWithBackingModel:(id)a3
{
  ...
  v12 = -[HMDDevice initWithIdentifier:handles:name:productInfo:version:capabilities:](self, "initWithIdentifier:handles:name:productInfo:version:capabilities:", v5, v9, v6, v7, v8, 0);
  v13 = v12;
  if (v12)
  {
...
- (BOOL)updateBackingModel:(id)a3 error:(id *)a4
{
  ...
  {
    v34 = (HMDDevice *)_HMFPreconditionFailure();
    return -[HMDDevice backingModelPrimaryKey](v34, v35);
  }
  else
  {
    if (-[HMDDevice isCurrentDevice](self, "isCurrentDevice"))
    {
      ...
      if (!v10)
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        -[HMDDevice setCapabilities:](self, "setCapabilities:", v11);
    ...
    if ((v14 & 1) == 0)
      objc_msgSend(v5, "setIdentifier:", v12);
    ...
    if (v20 != objc_msgSend(v18, "count")
      || (objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", v19),
          ...
          (v23 & 1) == 0))
    {
      objc_msgSend(v5, "setHandles:", v18);
    }
    ...
    if (v24)
    {
      objc_msgSend(v5, "rpIdentity");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      v26 = HMFEqualObjects();

      if ((v26 & 1) == 0)
        objc_msgSend(v5, "setRpIdentity:", v24);
    }
    ...
    if ((v29 & 1) == 0)
      objc_msgSend(v5, "setProductInfo:", v27);
    ...
    if ((v32 & 1) == 0)
      objc_msgSend(v5, "setVersion:", v30);
...
- (NSArray)attributeDescriptions
{
  ...
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  v29 = (void *)objc_msgSend(v3, "initWithName:value:", CFSTR("ID"));
  v32[0] = v29;
  ...
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v28 = (void *)v5;
  v26 = (void *)objc_msgSend(v4, "initWithName:value:options:formatter:", CFSTR("Nm"), v5, 0);
  v32[1] = v26;
  ...
  v23 = (__CFString *)v8;
  v25 = (void *)objc_msgSend(v6, "initWithName:value:", CFSTR("Ver"), v8);
  v32[2] = v25;
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = (void *)objc_msgSend(v9, "initWithName:value:", CFSTR("Cap"), v11);
  v32[3] = v12;
  v13 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDDevice sharedUserIDSIdentifier](self, "sharedUserIDSIdentifier");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = (void *)objc_msgSend(v13, "initWithName:value:", CFSTR("SHID"), v14);
  v32[4] = v15;
  v16 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDDevice idsIdentifier](self, "idsIdentifier");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = (void *)objc_msgSend(v16, "initWithName:value:", CFSTR("IDS"), v17);
  v32[5] = v18;
  v19 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDDevice handles](self, "handles");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v21 = (void *)objc_msgSend(v19, "initWithName:value:", CFSTR("Hndl"), v20);
  v32[6] = v21;
...
- (BOOL)isSameAccountWithDevice:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v10;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Device is missing account %@", (uint8_t *)&v16, 0x16u);
  ...
  if (v7)
  {
    ...
    if (v7 == v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 138543362;
        v20 = v12;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Processing updated account handle", (uint8_t *)&v19, 0xCu);
    ...
    if (!self->_modelIdentifier)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v18;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Missing parent identifier while updating model identifier.", buf, 0xCu);
      ...
      objc_msgSend(p_isa[8], "modelParentIdentifier");
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      v21 = v20 == 0;

      if (v21)
        objc_msgSend(p_isa[8], "setModelParentIdentifier:", self->_modelIdentifier);
    }
    v22 = v4;
    v23 = self;
...
- (void)updateVersion:(id)a3
{
  ...
  v4 = a3;
  -[HMDDevice setVersion:](self, "setVersion:", v4);
  +[HMDAccountRegistry sharedRegistry](HMDAccountRegistry, "sharedRegistry");
  v5 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "updateDevice:toVersion:", self, v4);
...
- (void)updateWithDevice:(id)a3
{
  ...
  if (v4 && self != v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating with device -- local: %@, remote: %@", (uint8_t *)&v11, 0x20u);

    }
    objc_autoreleasePoolPop(v6);
    -[HMDDevice mergeObject:](v7, "mergeObject:", v5);
    +[HMDAccountRegistry sharedRegistry](HMDAccountRegistry, "sharedRegistry");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "updateDevice:withDevice:", v7, v7);
...
- (BOOL)addHandle:(id)a3
{
  ...
  if ((v8 & 1) == 0)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDevice setHandles:](self, "setHandles:", v9);

    objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "postNotificationName:object:", CFSTR("HMDDeviceUpdatedNotification"), self);

    +[HMDAccountRegistry sharedRegistry](HMDAccountRegistry, "sharedRegistry");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "updateDevice:withDevice:", self, self);
...
- (void)setRpIdentity:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v12 = 2112;
    v13 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Setting RPIdentity %@", (uint8_t *)&v10, 0x16u);
...
- (BOOL)mergeObject:(id)a3
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v80 = 2112;
      v81 = v16;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Updating device name to %@", (uint8_t *)&v78, 0x16u);
  ...
  if (v18)
  {
    ...
    if ((v22 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
      {
        ...
        v80 = 2112;
        v81 = v27;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Updating device product info to %@", (uint8_t *)&v78, 0x16u);
  ...
  else
  {
    ...
    v35 = objc_msgSend(v33, "isGreaterThanVersion:", v34);
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
  {
    ...
    v80 = 2112;
    v81 = v40;
    _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_DEBUG, "%{public}@Updating device version to %@", (uint8_t *)&v78, 0x16u);

  }
  objc_autoreleasePoolPop(v36);
  objc_msgSend(v6, "version");
  v41 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDDevice setVersion:](v37, "setVersion:", v41);
...
LABEL_22:
  ...
  if (v42)
  {
    ...
    if ((v46 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_DEBUG))
      {
        ...
        v80 = 2112;
        v81 = v51;
        _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_DEBUG, "%{public}@Updating device capabilities to: %@", (uint8_t *)&v78, 0x16u);

      }
      objc_autoreleasePoolPop(v47);
      objc_msgSend(v6, "capabilities");
      v52 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDDevice setCapabilities:](v48, "setCapabilities:", v52);
  ...
  if (v53)
  {
    ...
    if ((v57 & 1) == 0)
    {
      ...
      -[HMDDevice setRpIdentity:](self, "setRpIdentity:", v58);

      v11 = 1;
    }
  }
  v59 = (void *)MEMORY[0x24BDBCEF0];
  -[HMDDevice handles](self, "handles");
  ...
  v65 = objc_msgSend(v61, "mergeObject:", v64);
  ...
  if (v65)
  {
    ...
    if (os_log_type_enabled(v68, OS_LOG_TYPE_DEBUG))
    {
      ...
      v80 = 2112;
      v81 = v61;
      _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_DEBUG, "%{public}@Updating handles: %@", (uint8_t *)&v78, 0x16u);

    }
    objc_autoreleasePoolPop(v66);
    objc_msgSend(v61, "allObjects");
    v70 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDevice setHandles:](v67, "setHandles:", v70);
...
LABEL_35:
  ...
  if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
  {
    ...
    v78 = 138543362;
    v79 = v74;
    _os_log_impl(&dword_2218F0000, v73, OS_LOG_TYPE_INFO, "%{public}@Merge resulted in changes, posting update notification", (uint8_t *)&v78, 0xCu);

  }
  objc_autoreleasePoolPop(v71);
  objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
  v75 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v75, "postNotificationName:object:", CFSTR("HMDDeviceUpdatedNotification"), v72);
...
- (HMDDevice)initWithCoder:(id)a3
{
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v51 = 2112;
        v52 = v24;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating the version of device '%@'", buf, 0x16u);
  ...
  else
  {
    ...
    objc_msgSend(*(id *)(v4 + 2176), "UUID");
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    v31 = -[HMDBackingStoreModelObject initWithUUID:](v29, "initWithUUID:", v30);

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v3, "decodeBoolForKey:", CFSTR("HM.supportsKeychainSync")));
    v32 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsKeychainSync:](v31, "setSupportsKeychainSync:", v32);

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v3, "decodeBoolForKey:", CFSTR("HM.supportsCloudDataSync")));
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCloudDataSync:](v31, "setSupportsCloudDataSync:", v33);

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v3, "decodeBoolForKey:", CFSTR("HM.residentCapable")));
    v34 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setResidentCapable:](v31, "setResidentCapable:", v34);

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v3, "decodeBoolForKey:", CFSTR("HM.remoteGatewayCapable")));
  ...
  v36 = -[HMDDevice initWithIdentifier:handles:name:productInfo:version:capabilities:](self, "initWithIdentifier:handles:name:productInfo:version:capabilities:", v5, v15, v6, v48, v17, v28);
  if (v36)
  {
    if ((objc_msgSend(v3, "containsValueForKey:", CFSTR("HM.modelIdentifier")) & 1) != 0)
    {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v32 = a3;
  v4 = objc_msgSend(v32, "hmd_isForXPCTransport");
  -[HMDDevice identifier](self, "identifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4)
  {
    objc_msgSend(v32, "encodeObject:forKey:", v5, CFSTR("HM.identifier"));

    -[HMDDevice name](self, "name");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v6, CFSTR("HM.name"));

    -[HMDDevice productInfo](self, "productInfo");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v7, *MEMORY[0x24BDD5B30]);

    objc_msgSend(v32, "encodeBool:forKey:", -[HMDDevice isCurrentDevice](self, "isCurrentDevice"), CFSTR("HM.currentDevice"));
    -[HMDDevice idsIdentifier](self, "idsIdentifier");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v8, *MEMORY[0x24BDD5B28]);

    if ((objc_msgSend(v32, "hmd_entitlements") & 0x1000) != 0)
    {
      -[HMDDevice remoteDestinationString](self, "remoteDestinationString");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeObject:forKey:", v9, *MEMORY[0x24BDD5B20]);
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v11, *MEMORY[0x24BDD5B38]);

    v12 = -[HMDDevice supportsHH2](self, "supportsHH2");
    objc_msgSend(v32, "encodeBool:forKey:", v12, *MEMORY[0x24BDD5BA0]);
  }
  else
  {
    objc_msgSend(v32, "encodeObject:forKey:", v5, CFSTR("HM.identifier"));
    ...
    -[HMDDevice handles](self, "handles");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v13, CFSTR("HM.handles"));

    -[HMDDevice name](self, "name");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v14, CFSTR("HM.name"));

    -[HMDDevice version](self, "version");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v15, CFSTR("HM.version2"));
      ...
      || objc_msgSend(v32, "hmd_isForRemoteTransportOnSameAccount"))
    {
      -[HMDDevice productInfo](self, "productInfo");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeObject:forKey:", v16, CFSTR("HM.productInfo"));
    ...
    if (v17)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%tu.%tu"), objc_msgSend(v17, "majorVersion"), objc_msgSend(v17, "minorVersion"));
      v19 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v32, "encodeObject:forKey:", v21, CFSTR("HM.version"));

    -[HMDDevice remoteDestinationString](self, "remoteDestinationString");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v22, CFSTR("HM.destination"));

    -[HMDDevice idsIdentifier](self, "idsIdentifier");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v23, CFSTR("HM.idsIdentifier"));

    -[HMDDevice rpIdentity](self, "rpIdentity");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v24, CFSTR("HM.rpIdentity"));

    -[HMDDevice capabilities](self, "capabilities");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v32, "encodeObject:forKey:", v25, CFSTR("HM.capabilities"));
    if (v25)
    {
      -[HMDDevice capabilities](self, "capabilities");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeBool:forKey:", objc_msgSend(v26, "supportsKeychainSync"), CFSTR("HM.supportsKeychainSync"));

      -[HMDDevice capabilities](self, "capabilities");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeBool:forKey:", objc_msgSend(v27, "supportsCloudDataSync"), CFSTR("HM.supportsCloudDataSync"));

      -[HMDDevice capabilities](self, "capabilities");
      v28 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeBool:forKey:", objc_msgSend(v28, "isResidentCapable"), CFSTR("HM.residentCapable"));

      -[HMDDevice capabilities](self, "capabilities");
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeBool:forKey:", objc_msgSend(v29, "isRemoteGatewayCapable"), CFSTR("HM.remoteGatewayCapable"));
    ...
    if (objc_msgSend(v32, "hmd_isForLocalStore"))
    {
      -[HMDDevice modelIdentifier](self, "modelIdentifier");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeObject:forKey:", v30, CFSTR("HM.modelIdentifier"));

      objc_msgSend(v32, "encodeBool:forKey:", -[HMDDevice isLocallyTracked](self, "isLocallyTracked"), CFSTR("HM.locallyTracked"));
      objc_msgSend(v32, "encodeBool:forKey:", -[HMDDevice isCloudTracked](self, "isCloudTracked"), CFSTR("HM.cloudTracked"));
      -[HMDDevice sharedUserIDSIdentifier](self, "sharedUserIDSIdentifier");
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v32, "encodeObject:forKey:", v31, CFSTR("HM.sharedUserIDSIdentifier"));
...
- (void)transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  if ((isKindOfClass & 1) != 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v17 = 138543362;
      v18 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Received remove capabilities", (uint8_t *)&v17, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = v22;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectRemoved:message:]", (uint8_t *)&v17, 0x20u);
  ...
  if (!(v12 | v15))
  {
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&v89[4] = v52;
      ...
      v91 = v13;
      v92 = 2112;
      v93 = (id)objc_opt_class();
      v53 = v93;
      _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated:newValues:message:]", v89, 0x20u);

    }
    objc_autoreleasePoolPop(v49);
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 2);
    v54 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "respondWithError:", v54);
...
LABEL_48:
  ...
  if (v81)
  {
    ...
    v76 = v10;
    v75 = v10;
    objc_msgSend(v75, "transactionResult");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDevice modelObjectWithChangeType:version:](v21, "modelObjectWithChangeType:version:", 0, 4);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      v25 = v24;
    ...
    {
      v84 = 0;
      v27 = objc_msgSend(v26, "diff:differingFields:", v22, &v84);
      v28 = v84;
      if (!v27)
      {
        v47 = v80;
      ...
      v95 = 0u;
      obj = v28;
      v29 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v94, v89, 16);
      if (!v29)
        goto LABEL_41;
      v30 = v29;
      v31 = *(_QWORD *)v95;
        ...
        do
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v87 = 2112;
            v88 = v33;
            _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating device information for %@", buf, 0x16u);

            v22 = v82;
          }

          objc_autoreleasePoolPop(v34);
          if (objc_msgSend(v33, "isEqualToString:", CFSTR("handles")))
          {
            objc_msgSend(v22, "deviceHandles");
            v38 = (void *)objc_claimAutoreleasedReturnValue();
            if (v38)
              -[HMDDevice setHandles:](v35, "setHandles:", v38);
            goto LABEL_34;
          }
          if (objc_msgSend(v33, "isEqualToString:", CFSTR("name")))
          {
            objc_msgSend(v22, "name");
            v38 = (void *)objc_claimAutoreleasedReturnValue();
            v39 = (void *)objc_msgSend(v38, "copy");
            -[HMDDevice setName:](v35, "setName:", v39);
LABEL_33:

LABEL_34:
            objc_msgSend(v23, "markChanged");
            goto LABEL_35;
          }
          if (objc_msgSend(v33, "isEqualToString:", CFSTR("version")))
          {
            objc_msgSend(v22, "version");
            v38 = (void *)objc_claimAutoreleasedReturnValue();
            v39 = (void *)objc_msgSend(v38, "copy");
            -[HMDDevice setVersion:](v35, "setVersion:", v39);
            goto LABEL_33;
          }
          if (objc_msgSend(v33, "isEqualToString:", CFSTR("productInfo")))
          {
            objc_msgSend(v22, "productInfo");
            v38 = (void *)objc_claimAutoreleasedReturnValue();
            v39 = (void *)objc_msgSend(v38, "copy");
            -[HMDDevice setProductInfo:](v35, "setProductInfo:", v39);
            goto LABEL_33;
          }
          if (objc_msgSend(v33, "isEqualToString:", CFSTR("rpIdentity")))
          {
            objc_msgSend(v22, "rpIdentity");
            v38 = (void *)objc_claimAutoreleasedReturnValue();
            v39 = (void *)objc_msgSend(v38, "copy");
            -[HMDDevice setRpIdentity:](v35, "setRpIdentity:", v39);
            goto LABEL_33;
          }
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v87 = 2112;
            v88 = v33;
            _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Unexpected field! -- changedField: %@", buf, 0x16u);
...
LABEL_35:
        ...
        while (v30 != v32);
        v44 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v94, v89, 16);
        v30 = v44;
        if (!v44)
        {
LABEL_41:

          if (objc_msgSend(v23, "changed"))
          {
            -[HMDDevice setDirty:](v21, "setDirty:", 1);
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&v89[4] = v64;
      _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve device model for updated device", v89, 0xCu);
    ...
    v46 = v75;
    objc_msgSend(v75, "respondWithError:", v65);
    v28 = (id)v65;
    v47 = v80;
    v20 = v81;
    v48 = v16;
LABEL_56:
  ...
  else
  {
    ...
    if (v80)
    {
      ...
      v56 = v80;
      v57 = v10;
      objc_msgSend(v57, "transactionResult");
      v58 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDDevice capabilities](v55, "capabilities");
      v59 = (void *)objc_claimAutoreleasedReturnValue();
      v60 = v59;
      if (v59)
      {
        objc_msgSend(v59, "transactionObjectUpdated:newValues:message:", 0, v56, v57);
      }
      else
      {
        v66 = -[HMDDeviceCapabilities initWithObjectModel:]([HMDDeviceCapabilities alloc], "initWithObjectModel:", v56);
        -[HMDDevice setCapabilities:](v55, "setCapabilities:", v66);
        ...
        if (v67)
        {
          ...
          *(_QWORD *)&v94 = CFSTR("HMDDeviceCapabilitiesUpdatedDifferingFieldsNotificationKey");
          objc_msgSend(v56, "setProperties");
          v78 = v13;
          v69 = (void *)objc_claimAutoreleasedReturnValue();
          *(_QWORD *)v89 = v69;
          objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v89, &v94, 1);
          v70 = v8;
          v71 = (void *)objc_claimAutoreleasedReturnValue();
          logAndPostNotification(CFSTR("HMDDeviceCapabilitiiesUpdatedNotification"), v68, v71);
      ...
      if (objc_msgSend(v58, "changed"))
      {
        -[HMDDevice setDirty:](v55, "setDirty:", 1);
        objc_msgSend(v58, "backingStore");
  ...
  if (objc_msgSend(v4, "source") == 2)
  {
      ...
      || objc_msgSend(v6, "isCurrentDeviceDataOwnerForDevice:", self))
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 138543362;
        v25 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Not marking cloud transaction as a change for current device", (uint8_t *)&v24, 0xCu);
    ...
    v13 = (void *)MEMORY[0x227676638](v18);
    v14 = self;
    HMFGetOSLogHandle();
...
LABEL_20:
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, v17, (uint8_t *)&v24, 0xCu);
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 138543362;
    v25 = v23;
    _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Not marking local transaction for cloud upload", (uint8_t *)&v24, 0xCu);

  }
  objc_autoreleasePoolPop(v20);
  -[HMDDevice setCloudTracked:](v21, "setCloudTracked:", 1);
...
- (id)modelObjectWithChangeType:(unint64_t)a3 version:(int64_t)a4
{
  ...
  -[HMDDeviceModel setHandles:](v9, "setHandles:", v21);
...
LABEL_25:
    _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, v35, buf, 0x20u);
  ...
  if ((v27 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v60 = 2112;
      v61 = v47;
      _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@Updating Device Rapport identity from %@ to %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v60 = 2112;
      v61 = v53;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@Rapport identity changed from %@ to %@", buf, 0x20u);
...
+ (HMDDevice)deviceWithDestination:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Invalid destination: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t25_157989 != -1)
    dispatch_once(&logCategory__hmf_once_t25_157989, &__block_literal_global_157990);
  return (id)logCategory__hmf_once_v26_157991;
}
...
void __24__HMDDevice_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v26_157991;
  logCategory__hmf_once_v26_157991 = v0;
