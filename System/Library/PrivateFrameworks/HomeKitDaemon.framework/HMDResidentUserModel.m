...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_1519 != -1)
    dispatch_once(&properties_onceToken_1519, block);
  return (id)properties__properties_1520;
}
...
void __34__HMDResidentUserModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_1520;
  properties__properties_1520 = v3;

  v5 = (void *)properties__properties_1520;
  v12[0] = CFSTR("device");
