...
{
  return -[HMDUserActivityType3Report initWithUser:state:withReason:changedTimestamp:lastUpdateTimestamp:](self, "initWithUser:state:withReason:changedTimestamp:lastUpdateTimestamp:", a3, a4, a5, 0, 0);
}
...
{
  HMDUserActivityType3Report *result;
  objc_super v9;
...
- (id)initFromMessagePayload:(id)a3 withUser:(id)a4
{
  ...
  void *v8;
  _QWORD *v9;
  HMDUserActivityType3Report *v10;
  objc_super v12;

  v6 = a3;
  v7 = a4;
  objc_msgSend(v6, "hmf_numberForKey:", CFSTR("HAS.T3.US"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v7 = -[HMDUserActivityType3Report state](self, "state");
...
- (id)serializedRemoteMessagePayload
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDUserActivityType3Report state](self, "state"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v5, CFSTR("HAS.T3.US"));
...
- (id)copyReportWithChangedTimestamp:(id)a3
{
  ...
  v10 = -[HMDUserActivityType3Report initWithUser:state:withReason:changedTimestamp:lastUpdateTimestamp:](v5, "initWithUser:state:withReason:changedTimestamp:lastUpdateTimestamp:", v6, v7, v8, v4, v9);
...
- (id)copyReportWithLastUpdateTimestamp:(id)a3 reason:(unint64_t)a4
{
  ...
  -[HMDUserActivityReport user](self, "user");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = -[HMDUserActivityType3Report state](self, "state");
  -[HMDUserActivityReport changedTimestamp](self, "changedTimestamp");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = -[HMDUserActivityType3Report initWithUser:state:withReason:changedTimestamp:lastUpdateTimestamp:](v7, "initWithUser:state:withReason:changedTimestamp:lastUpdateTimestamp:", v8, v9, a4, v10, v6);
