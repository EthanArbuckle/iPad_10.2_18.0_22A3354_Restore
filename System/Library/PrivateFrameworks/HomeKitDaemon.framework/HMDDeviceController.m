...
+ (id)placeholderDeviceControllerWithIdentifier:(id)a3
{
  ...
  if (a3)
  {
    v3 = a3;
    v4 = [HMDDevice alloc];
    v5 = -[HMDDevice initWithIdentifier:handles:name:productInfo:version:capabilities:](v4, "initWithIdentifier:handles:name:productInfo:version:capabilities:", v3, MEMORY[0x24BDBD1A8], 0, 0, 0, 0);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_134354 != -1)
    dispatch_once(&logCategory__hmf_once_t4_134354, &__block_literal_global_134355);
  return (id)logCategory__hmf_once_v5_134356;
}
...
void __34__HMDDeviceController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_134356;
  logCategory__hmf_once_v5_134356 = v0;
