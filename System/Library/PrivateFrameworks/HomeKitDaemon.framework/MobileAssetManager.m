...
- (void)purgeAllInstalledAssetsWithCompletion:(id)a3
{
  ...
  *(_QWORD *)(v9 + 24) = self;
  ...
  v12[5] = v11;
  swift_retain();
  sub_2219F6010((uint64_t)v7, (uint64_t)&unk_25573D2A0, (uint64_t)v12);
  swift_release();
}
...
- (void)startWithCompletion:(id)a3
{
  ...
  *(_QWORD *)(v9 + 24) = self;
  ...
  v12[5] = v11;
  swift_retain();
  sub_2219F6010((uint64_t)v7, (uint64_t)&unk_25573D280, (uint64_t)v12);
  swift_release();
}
...
- (void)updateAssetsWithForce:(BOOL)a3 completion:(id)a4
{
  ...
  *(_QWORD *)(v11 + 32) = self;
  ...
  v14[5] = v13;
  swift_retain();
  sub_2219F6010((uint64_t)v9, (uint64_t)&unk_25573D260, (uint64_t)v14);
  swift_release();
}
