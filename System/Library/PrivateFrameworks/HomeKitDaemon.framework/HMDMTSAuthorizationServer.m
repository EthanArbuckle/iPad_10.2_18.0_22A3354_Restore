...
- (HMDMTSAuthorizationServer)initWithAccountManager:(id)a3
{
  ...
  v6 = -[HMDMTSAuthorizationServer initWithUIDialogPresenter:accountManager:systemPreferenceReader:](self, "initWithUIDialogPresenter:accountManager:systemPreferenceReader:", v5, v4, &__block_literal_global_213603);
...
- (void)showRestrictedCharacteristicsAccessWarningAlert
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Showing restricted characteristics access warning", buf, 0xCu);
...
- (void)checkRestrictedCharacteristicsAccessAllowedWithCompletionHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v13;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Restricted characteristics access allowed returning %@", (uint8_t *)&v14, 0x16u);
...
void __76__HMDMTSAuthorizationServer_showRestrictedCharacteristicsAccessWarningAlert__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Restricted characteristics access warning dismissed", (uint8_t *)&v6, 0xCu);
...
id __52__HMDMTSAuthorizationServer_initWithAccountManager___block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x24BE3F290];
  v3 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_213610 != -1)
    dispatch_once(&logCategory__hmf_once_t3_213610, &__block_literal_global_4_213611);
  return (id)logCategory__hmf_once_v4_213612;
}
...
void __40__HMDMTSAuthorizationServer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_213612;
  logCategory__hmf_once_v4_213612 = v0;
