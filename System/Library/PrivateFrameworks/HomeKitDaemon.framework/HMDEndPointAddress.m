...
- (NSData)tlvData
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDEndPointAddress isIPv6Address](self, "isIPv6Address"));
...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1BBE0], "wrappertlv:name:", 2, CFSTR("kStreamManagementControlPoint__ControllerAddress__IPAddress"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 1, CFSTR("kStreamManagementControlPoint__ControllerAddress__IPAddressVersion"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 3, CFSTR("kStreamManagementControlPoint__ControllerAddress__VideoRTPPort"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 4, CFSTR("kStreamManagementControlPoint__ControllerAddress__AudioRTPPort"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v17[0] = v3;
  v17[1] = v4;
  v17[2] = v5;
