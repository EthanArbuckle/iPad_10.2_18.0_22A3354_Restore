...
- (void)updateStreamClientUsingMessage:(id)a3
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 2112;
      v41 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating stream client process info: %@", (uint8_t *)&v38, 0x16u);
    ...
    if (v16)
    {
      if (!-[HMDCameraStreamControlMessageHandler _isNegotiateMessage:](v10, "_isNegotiateMessage:", v16))
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
        {
          ...
          v40 = 2112;
          v41 = v37;
          _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Cannot update stream client because stream is handling a non-negotiate message: %@", (uint8_t *)&v38, 0x16u);
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v40 = 2112;
        v41 = v22;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Responding with canceled error to existing current message: %@", (uint8_t *)&v38, 0x16u);

      }
      objc_autoreleasePoolPop(v18);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 14);
      v23 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        v40 = 2112;
        v41 = v30;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Notifying existing stream client that stream has stopped and responding to new stream client message: %@", (uint8_t *)&v38, 0x16u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v40 = 2112;
    v41 = v25;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot find XPC client connection while updating stream using message: %@", (uint8_t *)&v38, 0x16u);
...
- (BOOL)_isNegotiateMessage:(id)a3
{
  ...
  else
  {
    objc_msgSend(v3, "name");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = objc_msgSend(v6, "isEqualToString:", *MEMORY[0x24BDD5630]);
...
- (BOOL)_isStopMessage:(id)a3
{
  ...
  objc_msgSend(v3, "name");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD5648]) & 1) != 0)
  {
    v5 = 1;
  }
  else
...
- (BOOL)_isSetAudioStreamSettingMessage:(id)a3
{
  ...
  objc_msgSend(a3, "name");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD5638]);
...
- (BOOL)_isSetAudioVolumeMessage:(id)a3
{
  ...
  objc_msgSend(a3, "name");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD5640]);
...
- (void)_stopStreamWithError:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failing stream session %@: %@", (uint8_t *)&v17, 0x20u);
    ...
    objc_msgSend(MEMORY[0x24BE3F1B0], "messageWithName:messagePayload:", *MEMORY[0x24BDD5648], v11);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)handleMessage:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2112;
      v30 = v12;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Session ID is not present in payload for message %@: %@", (uint8_t *)&v25, 0x20u);
LABEL_6:
  ...
  if (!-[HMDCameraStreamControlMessageHandler _isStopMessage:](self, "_isStopMessage:", v4))
  {
    ...
    if (!v17)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 2112;
        v28 = v24;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unknown message type %@", (uint8_t *)&v25, 0x16u);
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2112;
      v30 = v19;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Current message %@ is already being processed, rejecting message %@", (uint8_t *)&v25, 0x20u);
...
LABEL_10:
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, v16, (uint8_t *)&v23, 0xCu);
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v141 = 2112;
      v142 = v12;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Handling negotiation message: %@", buf, 0x20u);
    ...
    if (-[HMDCameraStreamControlMessageHandler _shouldHandleNegotiateMessage:accessoryReachable:](v8, "_shouldHandleNegotiateMessage:accessoryReachable:", v4, v14))
    {
        ...
        if ((HMIsStreamingAllowedForCameraAccessMode() & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v141 = 2112;
            v142 = v22;
            _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@[%@] Streaming is disallowed for current access mode: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v139 = 2112;
          v140 = v6;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Camera profile settings are not initialized; skipping controller side checks to disallow stream request",
            buf,
            0x16u);
      ...
      {
        v136 = 0;
        objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v30, &v136);
        ...
        if (!v31)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v141 = 2112;
            v142 = v32;
            _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to unarchive camera stream preferences from camera session preference message: %@", buf, 0x20u);
      ...
      if ((v38 & 1) == 0 && !v41)
      {
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v141 = 2112;
          v142 = v4;
          _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot find XPC client connection for negotiate stream message received over XPC: %@", buf, 0x20u);
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v141 = 2112;
        v142 = v49;
        _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@[%@] Using stream client process info: %@", buf, 0x20u);
      ...
      if ((_DWORD)v14)
      {
        ...
        if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v139 = 2112;
          v140 = v133;
          _os_log_impl(&dword_2218F0000, v66, OS_LOG_TYPE_INFO, "%{public}@[%@] Creating local stream control manager because accessory is reachable", buf, 0x16u);
...
LABEL_44:
          ...
          else
          {
            ...
            if (os_log_type_enabled(v107, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v139 = 2112;
              v140 = v94;
              _os_log_impl(&dword_2218F0000, v107, OS_LOG_TYPE_ERROR, "%{public}@Cannot start stream session: %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v114, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v139 = 2112;
          v140 = v133;
          _os_log_impl(&dword_2218F0000, v114, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to get the local network address config", buf, 0x16u);
      ...
      else
      {
        ...
        if (v81 == 1)
        {
          ...
          if (os_log_type_enabled(v84, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v139 = 2112;
            v140 = v133;
            _os_log_impl(&dword_2218F0000, v85, OS_LOG_TYPE_INFO, "%{public}@[%@] Creating remote stream control manager because accessory is not reachable", buf, 0x16u);
        ...
        if (os_log_type_enabled(v84, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v139 = 2112;
          v140 = v133;
          _os_log_impl(&dword_2218F0000, v85, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot create stream because accessory is unreachable and there is no reachable remote access device", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v139 = 2112;
      v140 = v25;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find session ID in negotiate message payload: %@", buf, 0x16u);
...
- (void)_handleRemoteSetupMessage:(id)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v5;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling remote setup message %@ from device: %@", (uint8_t *)&v18, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Could not find remote source device for remote setup message: %@", (uint8_t *)&v18, 0x16u);
...
- (void)_handleStartMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling start message with identifier: %@", (uint8_t *)&v17, 0x16u);
...
- (void)_handleReconfigureMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling reconfigure message with identifier: %@", (uint8_t *)&v14, 0x16u);
...
- (void)_handleStopMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2112;
    v31 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling stop message with identifier: %@", (uint8_t *)&v28, 0x16u);
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 2112;
      v31 = v23;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Stop is being called before current message has been processed: %@", (uint8_t *)&v28, 0x16u);
...
- (void)_handleSetAudioVolume:(id)a3
{
  ...
  {
    objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD5628]);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Ignoring set audio volume message as it is not entitled for SPI access", buf, 0xCu);
...
- (void)setAudioVolume:(id)a3 callback:(id)a4
{
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Changing audio volume setting is not allowed on this device", buf, 0xCu);
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Missing parameter to set the audio stream state", buf, 0xCu);
...
- (void)_handleSetAudioState:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Missing parameter to set the audio stream state", buf, 0xCu);
    ...
    if (v7 == 3)
    {
      if ((objc_msgSend(v4, "isAuthorizedForMicrophoneAccess") & 1) != 0)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v38 = v23;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Bi-directional audio is not supported on this device for camera streaming.", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Denying incoming message %@ for client pid %ld since the process is not authorized for microphone access", buf, 0x20u);
...
LABEL_17:
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2048;
      v40 = v8;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Invalid audio stream setting: %lu", buf, 0x16u);
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v8, CFSTR("kAudioStreamSetting"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v36 = v11;
  ...
  if (v4)
  {
    ...
    if (!v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 2112;
        v15 = v4;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating activity attribution with applicationBundleIdentifier: %@", (uint8_t *)&v12, 0x16u);
...
- (void)_respondToLocalNegotiateStreamMessage:(id)a3
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setObject:forKeyedSubscript:", v10, *MEMORY[0x24BDD6DC0]);
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setObject:forKeyedSubscript:", v17, *MEMORY[0x24BDD6F00]);
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v6;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Responding to message %@ with payload %@", (uint8_t *)&v24, 0x20u);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Stream setup timer fired", (uint8_t *)&v13, 0xCu);
...
- (void)streamControlManager:(id)a3 didNegotiateStreamWithSelectedParameters:(id)a4
{
  ...
  if (v9 == v6)
  {
    ...
    if (v19)
    {
      ...
      v21 = objc_msgSend(v20, "isEqualToString:", *MEMORY[0x24BDD5630]);
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          v37 = 138543362;
          v38 = v25;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Handling did negotiate stream callback by starting stream", (uint8_t *)&v37, 0xCu);
      ...
      if (v31)
      {
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          v39 = 2112;
          v40 = v34;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Handling did negotiate stream callback by responding to remote negotiate stream message: %@", (uint8_t *)&v37, 0x16u);
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        v39 = 2112;
        v40 = v36;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Unexpected current message while handling did negotiate stream callback: %@", (uint8_t *)&v37, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v37 = 138543362;
        v38 = v29;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Received did negotiate stream without a current message", (uint8_t *)&v37, 0xCu);
LABEL_18:
...
LABEL_20:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    v41 = 2112;
    v42 = v6;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring did negotiate stream because our stream control manager %@ does not match the provided one: %@", (uint8_t *)&v37, 0x20u);
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = v20;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending stream remote setup notification to %@", buf, 0x16u);
    ...
    if (v23)
    {
      ...
      objc_msgSend(MEMORY[0x24BE3F1D0], "internalMessageWithName:messagePayload:", CFSTR("kStreamRemoteConnectionSetupNotificationKey"), v27);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v41 = v37;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@No home manager", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v44 = 2112;
      v45 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring did set up remote connection because our stream control manager %@ does not match the provided one: %@", buf, 0x20u);
...
- (void)streamControlManagerDidStartStream:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (v16)
    {
      ...
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      v18 = objc_msgSend(v17, "isEqualToString:", *MEMORY[0x24BDD5630]);
...
LABEL_17:
      ...
      if (v20)
      {
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          v36 = 2112;
          v37 = v26;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Handling did start stream callback by responding to remote start stream message: %@", (uint8_t *)&v34, 0x16u);
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        v36 = 2112;
        v37 = v33;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpected current message while handling did start stream callback: %@", (uint8_t *)&v34, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 138543362;
        v35 = v32;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received did start stream without a current message", (uint8_t *)&v34, 0xCu);
LABEL_15:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    v38 = 2112;
    v39 = v4;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring did start stream because our stream control manager %@ does not match the provided one: %@", (uint8_t *)&v34, 0x20u);
...
- (void)streamControlManagerDidReceiveFirstFrame:(id)a3
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD5630]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v20;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Received did receive first frame with an unexpected current message: %@", (uint8_t *)&v21, 0x16u);
  ...
  if (v6 == v4)
  {
    ...
    if ((v10 & 1) != 0)
    {
      if (v14)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v39 = 2112;
        v40 = v20;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Responding to %@ with identifier %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v36 = v31;
          _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@No response handler set for message", buf, 0xCu);
    ...
    else
    {
      if (v14)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v27;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@No pending reconfigure stream request", buf, 0xCu);
...
- (void)streamControlManager:(id)a3 didStopStreamWithSessionID:(id)a4 error:(id)a5
{
  ...
  if ((v13 & 1) != 0)
  {
    if (v17)
    {
      ...
      v39 = 2114;
      v40 = v10;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Stream did stop with error: %{public}@", (uint8_t *)&v37, 0x16u);
    ...
    if (v20)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        v39 = 2112;
        v40 = v25;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Responding to the current message: %@", (uint8_t *)&v37, 0x16u);
    ...
    if (v27)
    {
      if (v31)
      {
        ...
        v37 = 138543362;
        v38 = v32;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@This is a stream being relayed elsewhere so sending remote stream stopped message", (uint8_t *)&v37, 0xCu);
    ...
    else
    {
      if (v31)
      {
        ...
        v37 = 138543362;
        v38 = v36;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@This is a stream being shown locally so sending local stream stopped message", (uint8_t *)&v37, 0xCu);
  ...
  else
  {
    if (v17)
    {
      ...
      v41 = 2112;
      v42 = v35;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Ignoring did stop stream callback for session ID %@ because our session ID is %@", (uint8_t *)&v37, 0x20u);
...
- (void)_sendStreamStoppedMessageWithError:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Notifying client that stream has stopped: %@", (uint8_t *)&v24, 0x16u);
    ...
    objc_msgSend(MEMORY[0x24BE3F1D0], "messageWithName:destination:payload:", *MEMORY[0x24BDD5650], v20, v12);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 138543362;
      v25 = v23;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot send stream stopped message because XPC client connection doesn't exist", (uint8_t *)&v24, 0xCu);
...
- (void)_sendStreamStoppedRemoteNotificationWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = 2112;
    v32 = v10;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending stream stopped notification to %@", (uint8_t *)&v29, 0x16u);
  ...
  if (v13)
  {
    ...
    objc_msgSend(MEMORY[0x24BE3F1D0], "internalMessageWithName:messagePayload:", CFSTR("kStreamStoppedRemoteNotificationKey"), v14);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "sendSecureMessage:target:userID:destination:responseQueue:responseHandler:", v20, v21, 0, v23, v24, &__block_literal_global_52_86406);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v28;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@No home manager", (uint8_t *)&v29, 0xCu);
...
- (void)_resetStreamSession:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Resetting the current stream session with error: %@", (uint8_t *)&v13, 0x16u);
...
void __80__HMDCameraStreamControlMessageHandler_handleConnectionDeactivatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping stream because client has deactivated", (uint8_t *)&v11, 0xCu);

    }
    objc_autoreleasePoolPop(v5);
    v9 = *(void **)(a1 + 32);
    objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1048);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
void __65__HMDCameraStreamControlMessageHandler_handleProcessStateChange___block_invoke(uint64_t a1)
{
    ...
    && objc_msgSend(*(id *)(a1 + 32), "_shouldStopStreamSessionForProcessInfo:", *(_QWORD *)(a1 + 40)))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Stopping stream because client is no longer in foreground", (uint8_t *)&v12, 0xCu);
...
void __82__HMDCameraStreamControlMessageHandler_handleCameraSettingsDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Camera profile settings are not initialized, skipping cancelling pending stream requests", (uint8_t *)&v12, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t38_86500 != -1)
    dispatch_once(&logCategory__hmf_once_t38_86500, &__block_literal_global_86501);
  return (id)logCategory__hmf_once_v39_86502;
}
...
void __51__HMDCameraStreamControlMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v39_86502;
  logCategory__hmf_once_v39_86502 = v0;
