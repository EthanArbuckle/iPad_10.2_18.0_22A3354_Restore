...
- (HMDAssistantAccessControl)initWithUser:(id)a3 model:(id)a4
{
  ...
  if (v7)
  {
    ...
    v11 = -[HMDAssistantAccessControl initWithUser:appleAccessories:enabled:](self, "initWithUser:appleAccessories:enabled:", v6, MEMORY[0x24BDBD1A8], v10);
    if (v11)
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BDBCEF0], "setWithArray:", v19);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 138543362;
      v33 = v30;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Model is required", (uint8_t *)&v32, 0xCu);
...
{
  return -[HMDAssistantAccessControl initWithUser:appleAccessories:hapAccessoryIdentifiers:enabled:activityNotificationsEnabledForPersonalRequests:](self, "initWithUser:appleAccessories:hapAccessoryIdentifiers:enabled:activityNotificationsEnabledForPersonalRequests:", a3, a4, MEMORY[0x24BDBD1A8], a5, 1);
}
...
- (HMDAssistantAccessControl)initWithUser:(id)a3 appleAccessories:(id)a4 hapAccessoryIdentifiers:(id)a5 enabled:(BOOL)a6 activityNotificationsEnabledForPersonalRequests:(BOOL)a7
{
  ...
  if (v15)
  {
    ...
    objc_msgSend(MEMORY[0x24BDBCEF0], "setWithArray:", v14);
...
{
  return -[HMDAssistantAccessControl initWithUser:appleAccessories:hapAccessoryIdentifiers:enabled:activityNotificationsEnabledForPersonalRequests:](self, "initWithUser:appleAccessories:hapAccessoryIdentifiers:enabled:activityNotificationsEnabledForPersonalRequests:", a3, MEMORY[0x24BDBD1A8], MEMORY[0x24BDBD1A8], 1, 1);
}
...
- (BOOL)isEnabled
{
  ...
  -[HMDAssistantAccessControl settingsController](self, "settingsController");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  {
    objc_msgSend(v3, "assistantAccessControlAccessoriesToEncode");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    enabled = objc_msgSend(v5, "count") != 0;
...
- (BOOL)areActivityNotificationsEnabledForPersonalRequests
{
  void *v3;
  void *v4;
  char activityNotificationsEnabledForPersonalRequests;
  os_unfair_lock_s *p_lock;
  ...
  if (v3)
  {
    activityNotificationsEnabledForPersonalRequests = objc_msgSend(v3, "assistantAccessControlActivityNotificationsEnabledForPersonalRequests");
  }
  else
  {
    p_lock = &self->_lock;
...
- (NSArray)accessories
{
  ...
  if (v3)
  {
    ...
    v23 = 0u;
    v24 = 0u;
    objc_msgSend(v4, "assistantAccessControlAccessoriesToEncode", 0);
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0; i != v11; ++i)
        {
          ...
          objc_msgSend(v9, "accessoryWithUUID:", *(_QWORD *)(*((_QWORD *)&v23 + 1) + 8 * i));
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          if (v14)
  ...
  else
  {
    ...
    if (objc_msgSend(v19, "count"))
    {
      __accessoriesWithModelIDs(self, v19);
      v20 = objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v21, "arrayByAddingObjectsFromArray:", v16);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)addAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v22 = 2112;
      v23 = v12;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Added accessory %@", (uint8_t *)&v20, 0x16u);
...
LABEL_18:
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v26 = 2112;
      v27 = v15;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Removed accessory %@", (uint8_t *)&v24, 0x16u);
...
- (HMDAssistantAccessControlModel)model
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAssistantAccessControl isEnabled](self, "isEnabled"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setEnabled:", v4);

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAssistantAccessControl options](self, "options"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setOptions:", v5);

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAssistantAccessControl areActivityNotificationsEnabledForPersonalRequests](self, "areActivityNotificationsEnabledForPersonalRequests"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "na_map:", &__block_literal_global_37_234780);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)transactionWithObjectChangeType:(unint64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to create model without parent user", (uint8_t *)&v15, 0xCu);
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (v13)
  {
    ...
    if (objc_msgSend(v15, "propertyWasSet:", CFSTR("accessoryModelIDs")))
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v104 = 2112;
        v105 = v34;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Got access control update for apple media accessories: %@, allCurrent:%@", buf, 0x20u);
      ...
      if ((v35 & 1) != 0)
      {
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v40;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@accessories list is the same skipping", buf, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v38, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v104 = 2112;
          v105 = context;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Updated assistant access control apple media accessories to: %@, from: %@", buf, 0x20u);
    ...
    if (objc_msgSend(v15, "propertyWasSet:", CFSTR("siriEndpointAccessoryModelUUIDs")))
    {
      ...
      if (v14)
      {
        objc_msgSend(v46, "na_map:", &__block_literal_global_31_234752);
      ...
      if ((HMFEqualObjects() & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v104 = 2112;
          v105 = v49;
          _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_ERROR, "%{public}@Fatal: found non hap accessory in endpoint list %@, accessories: %@", buf, 0x20u);
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v104 = 2112;
        v105 = v61;
        _os_log_impl(&dword_2218F0000, v56, OS_LOG_TYPE_DEFAULT, "%{public}@Got access control update for hap accessories: %@, allCurrent:%@", buf, 0x20u);
      ...
      if ((v62 & 1) != 0)
      {
        if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v67;
          _os_log_impl(&dword_2218F0000, v66, OS_LOG_TYPE_INFO, "%{public}@endpoint list is the same skipping", buf, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v65, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v104 = 2112;
          v105 = contextb;
          _os_log_impl(&dword_2218F0000, v66, OS_LOG_TYPE_DEFAULT, "%{public}@Updated assistant access control accessories to: %@ from: %@", buf, 0x20u);
...
- (HMDAssistantAccessControl)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x24BDD48E0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[HMDAssistantAccessControl initWithUser:](self, "initWithUser:", v5);
  if (v6)
  {
    v6->_enabled = objc_msgSend(v4, "decodeBoolForKey:", *MEMORY[0x24BDD52C8]);
    v6->_options = objc_msgSend(v4, "decodeIntegerForKey:", *MEMORY[0x24BDD52D0]);
    v7 = *MEMORY[0x24BDD52C0];
    v6->_activityNotificationsEnabledForPersonalRequests = objc_msgSend(v4, "containsValueForKey:", *MEMORY[0x24BDD52C0])? objc_msgSend(v4, "decodeBoolForKey:", v7): 1;
    v8 = *MEMORY[0x24BDD52B8];
    if (objc_msgSend(v4, "containsValueForKey:", *MEMORY[0x24BDD52B8]))
    {
      ...
      if (objc_msgSend(v18, "count"))
      {
        ...
        objc_msgSend(v18, "na_map:", &__block_literal_global_50);
        v20 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMDAssistantAccessControl user](self, "user");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeConditionalObject:forKey:", v5, *MEMORY[0x24BDD48E0]);

  v6 = -[HMDAssistantAccessControl isEnabled](self, "isEnabled");
  objc_msgSend(v4, "encodeBool:forKey:", v6, *MEMORY[0x24BDD52C8]);
  v7 = -[HMDAssistantAccessControl options](self, "options");
  objc_msgSend(v4, "encodeInteger:forKey:", v7, *MEMORY[0x24BDD52D0]);
  ...
  objc_msgSend(v4, "encodeBool:forKey:", v8, *MEMORY[0x24BDD52C0]);
  -[HMDAssistantAccessControl accessories](self, "accessories");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (!v18)
          objc_msgSend(v10, "addObject:", v16, (_QWORD)v23);
  ...
  v19 = objc_msgSend(v4, "hmd_isForXPCTransport");
  v20 = *MEMORY[0x24BDD52B8];
  if (v19)
  {
  ...
  else
  {
    ...
    -[HMDAssistantAccessControl _hapAccessoryIdentifiers]((char *)self);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v21, "na_map:", &__block_literal_global_51_234722);
    v22 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v4, "encodeObject:forKey:", v22, CFSTR("HMD.ac.siriEndpointIdentifiers"));
  }
...
{
  return (HMDUserAccessorySettingsDataController *)objc_loadWeakRetained((id *)&self->_settingsController);
}
...
- (void)_populateModel:(void *)a3 withAccessoryIdsFromAccessories:
{
  ...
  {
    v4 = a2;
    objc_msgSend(a3, "na_map:", &__block_literal_global_29_234781);
...
void __61__HMDAssistantAccessControl_notifyClientOfUpdateWithMessage___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    v4 = (void *)MEMORY[0x24BE3F1D0];
    v5 = *MEMORY[0x24BDD7038];
    objc_msgSend(*(id *)(a1 + 40), "identifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = *MEMORY[0x24BDD7030];
    v20[0] = v3;
    v8 = *MEMORY[0x24BDD7020];
    v19[0] = v7;
    v19[1] = v8;
      ...
      if (v9 == 1)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v37 = 2112;
          v38 = v6;
          _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory was removed: %@", buf, 0x16u);
              ...
              v18))
        {
          ...
          objc_msgSend(v31, "na_map:", &__block_literal_global_234787);
          v25 = (void *)objc_claimAutoreleasedReturnValue();
...
void __52__HMDAssistantAccessControl_handleRemovedAccessory___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Error: %@ running transaction to remove accessory: %@ from ACL adding it back.", (uint8_t *)&v13, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Removed accessory %@ from assistant access control list.", (uint8_t *)&v13, 0x16u);
...
uint64_t __52__HMDAssistantAccessControl_handleRemovedAccessory___block_invoke_23(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "UUIDString");
}
...
+ (HMDAssistantAccessControl)accessControlWithMessage:(id)a3 user:(id)a4 currentAccessories:(id)a5 error:(id *)a6
{
  ...
  v11 = a4;
  v79 = a5;
  objc_msgSend(v10, "dataForKey:", *MEMORY[0x24BDD7030]);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (v12)
  {
    ...
    if (v18)
    {
      objc_msgSend(v10, "arrayForKey:", *MEMORY[0x24BDD7020]);
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      if (v19)
      {
        v73 = v11;
...
LABEL_6:
          ...
          while (1)
          {
            ...
            v25 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v24);
            if (!v25)
            {
              ...
              if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v88 = 2112;
                v89 = v24;
                _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_INFO, "%{public}@Invalid accessory identifier: %@", buf, 0x16u);
              ...
              && (objc_msgSend(a1, "isAccessorySupported:", v28) & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v88 = 2112;
                v89 = v28;
                _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_INFO, "%{public}@Accessory not supported: %@", buf, 0x16u);
...
LABEL_51:
                ...
                v38 = v76;
                v59 = obj;
                objc_msgSend(MEMORY[0x24BDD1540], "hmPrivateErrorWithCode:", v65);
...
LABEL_52:
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v88 = 2112;
            v89 = v24;
            _os_log_impl(&dword_2218F0000, v62, OS_LOG_TYPE_INFO, "%{public}@Failed to lookup accessory with identifier: %@", buf, 0x16u);
...
LABEL_21:
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v88 = 2112;
          v89 = obj;
          _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@Generated access control from message with accessories %@", buf, 0x16u);
...
LABEL_55:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v88 = 2112;
          v89 = v54;
          _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Missing access control accessories in message payload: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v87 = v49;
        _os_log_impl(&dword_2218F0000, v48, OS_LOG_TYPE_INFO, "%{public}@Invalid access control in message payload", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v88 = 2112;
      v89 = v45;
      _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@Missing serialized access control in message payload: %@", buf, 0x16u);
...
+ (id)modelIDNamespace
{
  if (modelIDNamespace_onceToken_234818 != -1)
    dispatch_once(&modelIDNamespace_onceToken_234818, &__block_literal_global_35_234819);
  return (id)modelIDNamespace_modelIDNamespace_234820;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t53_234813 != -1)
    dispatch_once(&logCategory__hmf_once_t53_234813, &__block_literal_global_39_234814);
  return (id)logCategory__hmf_once_v54_234815;
}
...
void __40__HMDAssistantAccessControl_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v54_234815;
  logCategory__hmf_once_v54_234815 = v0;
...
void __45__HMDAssistantAccessControl_modelIDNamespace__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("5FF02DEF-EFB2-45C7-BF0C-042B4F336FD8"));
  v1 = (void *)modelIDNamespace_modelIDNamespace_234820;
  modelIDNamespace_modelIDNamespace_234820 = v0;
