...
- (unint64_t)_getCurrentFrameSize
{
  if (self->_currentframeType - 1 > 2)
    ...
    return self->_payloadLength + qword_2226A06A8[(self->_currentframeType - 1)];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_50201 != -1)
    dispatch_once(&logCategory__hmf_once_t0_50201, &__block_literal_global_50202);
  return (id)logCategory__hmf_once_v1_50203;
}
...
void __39__HMDDataStreamFrameReader_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_50203;
  logCategory__hmf_once_v1_50203 = v0;
