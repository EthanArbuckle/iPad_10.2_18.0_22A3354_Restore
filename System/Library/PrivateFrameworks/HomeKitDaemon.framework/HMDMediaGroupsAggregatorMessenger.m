...
- (void)sendRequestToUpdateAssociatedGroupIdentifier:(id)a3 forGroupIdentifier:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v38 = 2112;
    v39 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending request to update associated group identifier: %@ for group identifier: %@", buf, 0x20u);
  ...
  v16 = objc_alloc(MEMORY[0x24BE3F1D0]);
  +[HMDMediaGroupsAggregatorUpdateAssociatedGroupIdentifierPayload messageName](HMDMediaGroupsAggregatorUpdateAssociatedGroupIdentifierPayload, "messageName");
...
- (void)routeMessage:(id)a3 localHandler:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message: %@/%@ due to no router", (uint8_t *)&v17, 0x20u);
...
- (void)routeUpdateAssociatedGroupIdentifierRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v16 = 2112;
    v17 = v10;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing update associated group identifier request message: %@/%@", buf, 0x20u);
...
- (void)locallyHandleUpdateAssociatedGroupIdentifierRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v10;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Locally handling update associated group identifier request message: %@/%@", (uint8_t *)&v23, 0x20u);
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v4;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse message payload from message: %@", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v4;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get a message payload from message: %@", (uint8_t *)&v23, 0x16u);
...
- (id)router
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get router due to no data source", (uint8_t *)&v11, 0xCu);
...
void __112__HMDMediaGroupsAggregatorMessenger_sendRequestToUpdateAssociatedGroupIdentifier_forGroupIdentifier_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Send request to update associated group identifier: %@ for group identifier: %@ responded with error: %@", (uint8_t *)&v13, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_254753 != -1)
    dispatch_once(&logCategory__hmf_once_t8_254753, &__block_literal_global_254754);
  return (id)logCategory__hmf_once_v9_254755;
}
...
void __48__HMDMediaGroupsAggregatorMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_254755;
  logCategory__hmf_once_v9_254755 = v0;
