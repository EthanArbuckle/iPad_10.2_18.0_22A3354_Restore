...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x24BDD16A8], "stringWithFormat:", CFSTR("type: %@"), v4);
...
- (void)_registerForMessages
{
  ...
  -[HMDEvent _registerForMessages](&v5, sel__registerForMessages);
  objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "addObserver:selector:name:object:", self, sel__handlePrivilegeUpdate_, CFSTR("HMDUserPrivilegeDidChangeNotification"), 0);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to activate since event hasn't been configured", buf, 0xCu);
  ...
  if (-[HMDEvent activationType](self, "activationType") > 1)
  {
      ...
      || (objc_msgSend(v4, "homePresence"), v11 = (void *)objc_claimAutoreleasedReturnValue(), v11, !v11))
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v92 = 2112;
        v93 = v4;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Received home presence update is nil: %@", buf, 0x16u);
    ...
    if (v15 != v13)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v94 = 2112;
        v95 = v13;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Received home presence update, homes are not matching: %@, ours: %@", buf, 0x20u);
    ...
    if ((objc_msgSend(v4, "isUpdate") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v91 = v52;
        _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_INFO, "%{public}@Home presence is not an update", buf, 0xCu);
    ...
    if (v24)
    {
      if ((objc_msgSend(v23, "isEqualToString:", *MEMORY[0x24BDD6A10]) & 1) == 0
        && (objc_msgSend(v23, "isEqualToString:", *MEMORY[0x24BDD6A28]) & 1) == 0
        && (objc_msgSend(v23, "isEqualToString:", *MEMORY[0x24BDD6A18]) & 1) == 0
        && !objc_msgSend(v23, "isEqualToString:", *MEMORY[0x24BDD6A30])
...
LABEL_23:
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v92 = 2112;
          v93 = v33;
          _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@Evaluated status: %@", buf, 0x16u);
          ...
          if (v28)
          {
            if (v38)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v92 = 2112;
              v93 = v34;
              _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Execution session %@ is already underway, no need to create another one", buf, 0x16u);
            ...
            if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v96 = 2112;
              v97 = v42;
              _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_INFO, "%{public}@%@ device to execution session %@, device %@", buf, 0x2Au);
          ...
          else
          {
            if (v38)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v92 = 2112;
              v93 = v34;
              _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Evaluated status is changing to NO, resetting the execution session %@", buf, 0x16u);
        ...
        else if (v28 == -[HMDPresenceEvent currentStatus](v30, "currentStatus"))
        {
          ...
          if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v92 = 2112;
            v93 = v70;
            _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_INFO, "%{public}@Current status is not changing from %@", buf, 0x16u);
        ...
        else if ((objc_msgSend(v4, "isUpdate") & 1) != 0)
        {
          if (v28)
          {
            ...
            v57 = (void *)MEMORY[0x227676638](-[HMDPresenceEvent setExecutionSession:](v30, "setExecutionSession:", v56));
            v58 = v30;
            HMFGetOSLogHandle();
            ...
            if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v94 = 2112;
              v95 = v55;
              _os_log_impl(&dword_2218F0000, v59, OS_LOG_TYPE_INFO, "%{public}@Created execution session %@ with triggerDevice: %@", buf, 0x20u);
            ...
            if (!v56)
            {
              ...
              if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v91 = v64;
                _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_INFO, "%{public}@Could not create execution session, updating the current status to YES", buf, 0xCu);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v85, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v92 = 2112;
              v93 = v87;
              _os_log_impl(&dword_2218F0000, v85, OS_LOG_TYPE_INFO, "%{public}@This event is moving to inactive state, current execution session %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v94 = 2112;
            v95 = v82;
            _os_log_impl(&dword_2218F0000, v79, OS_LOG_TYPE_INFO, "%{public}@Evaluation status is changing from %@ to %@", buf, 0x20u);
      ...
      if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v92 = 2112;
        v93 = v75;
        _os_log_impl(&dword_2218F0000, v73, OS_LOG_TYPE_INFO, "%{public}@User presence in the update is not relevant to the user in this event: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v91 = v74;
        _os_log_impl(&dword_2218F0000, v73, OS_LOG_TYPE_INFO, "%{public}@User Presence is nil, not firing event", buf, 0xCu);
...
LABEL_67:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v92 = 2112;
    v93 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Ignoring the home presence update since the activation type is %@", buf, 0x16u);
...
- (BOOL)evaluateWithHomePresenceUpdate:(id)a3 presenceType:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Activation is set to %@", (uint8_t *)&v17, 0x16u);
...
- (BOOL)evaluateWithUserPresence:(id)a3 presenceType:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  if ((objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDD6A10]) & 1) == 0
    && (objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDD6A08]) & 1) == 0
    && !objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDD6A28]))
  {
    if (((objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDD6A18]) & 1) != 0
       || (objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDD6A20]) & 1) != 0
       || objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDD6A30]))
...
LABEL_14:
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v16;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Returning result to not fire event", (uint8_t *)&v18, 0xCu);
...
LABEL_7:
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, v13, (uint8_t *)&v18, 0xCu);
...
- (BOOL)_evaluateWithHomePresence:(id)a3 presenceType:(id)a4 users:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  if (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD6A10]))
  {
  ...
  {
    if (!objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD6A18]))
    {
      if (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD6A08]))
      {
        v15 = objc_msgSend(v8, "isAnyUserAtHome");
      }
      else
      {
        if (!objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD6A20]))
        {
          if (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD6A28]))
          {
          ...
          {
            if (!objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD6A30]))
            {
              v13 = 0;
              goto LABEL_6;
            }
...
- (BOOL)compatibleWithUser:(id)a3
{
  ...
  -[HMDPresenceEvent presenceType](self, "presenceType");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDD6A10]) & 1) != 0
    || objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDD6A18]))
  {
    -[HMDPresenceEvent thisUser](self, "thisUser");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else if ((objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDD6A08]) & 1) != 0
         || (objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDD6A20]) & 1) != 0)
  {
    LOBYTE(v7) = 1;
  }
  else if ((objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDD6A28]) & 1) != 0
         || objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDD6A30]))
  {
    v20 = 0u;
    v21 = 0u;
    v18 = 0u;
...
LABEL_22:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2112;
    v27 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Checking if the username %@ is compatible: %@", buf, 0x20u);
...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  if (v5 | v6)
  {
    ...
    if (v5)
    {
      ...
      if ((objc_msgSend((id)v5, "isEqualToString:", *MEMORY[0x24BDD6A10]) & 1) != 0
        || objc_msgSend((id)v5, "isEqualToString:", *MEMORY[0x24BDD6A18]))
      {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to update Presence event as parameters are NIL", buf, 0xCu);
...
- (void)_updateUsers:(id)a3 home:(id)a4
{
  ...
  v22 = v7;
  objc_msgSend(v7, "usersIncludingPendingUsers:", 1);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)MEMORY[0x227676638]();
  v10 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v32 = 2112;
    v33 = v8;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating users: %@, %@", buf, 0x20u);
...
- (HMDPresenceEvent)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD78E8], "activationGranularityWithCoder:", v4);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v18, "isEqualToString:", *MEMORY[0x24BDD6A28]) & 1) != 0
    || objc_msgSend(v18, "isEqualToString:", *MEMORY[0x24BDD6A30]))
  {
    v22 = 0u;
    v23 = 0u;
    v20 = 0u;
...
- (id)_presenceTypeForClient
{
  ...
  -[HMDPresenceEvent presenceType](self, "presenceType");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = *MEMORY[0x24BDD6A28];
  if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD6A28]) & 1) != 0
    || objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD6A30]))
  {
    -[HMDPresenceEvent userUUIDs](self, "userUUIDs");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      v11 = (id *)MEMORY[0x24BDD6A10];
    }
    else
    {
      if (!objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BDD6A30]))
      {
LABEL_10:

        return v3;
      }
      v11 = (id *)MEMORY[0x24BDD6A18];
    }
    v12 = *v11;
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = v13;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling transaction updated", buf, 0xCu);
          ...
          (v19 & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v51 = 2112;
        v52 = v26;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating presence type from %@ to %@", buf, 0x20u);
...
- (id)analyticsPresenceEventData
{
  ...
  -[HMDPresenceEvent presenceType](self, "presenceType");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD6A28]) & 1) != 0)
  {
    v5 = 1;
LABEL_9:
  ...
  if ((objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD6A30]) & 1) != 0)
  {
    v5 = 2;
    goto LABEL_9;
  }
  if ((objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD6A08]) & 1) != 0)
  {
    v5 = 3;
    goto LABEL_9;
  }
  if (objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD6A20]))
  {
    v5 = 4;
    goto LABEL_9;
  }
...
void __43__HMDPresenceEvent_didEndExecutionSession___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating the current status to YES after the execution session is complete", (uint8_t *)&v11, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v9;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Received a callback that execution session %@ has ended, but is not known session", (uint8_t *)&v11, 0x16u);
  ...
  if (v2 - 2 < 2)
  {
    if (*(_BYTE *)(a1 + 40))
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 2112;
        v15 = v7;
        _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Activation is changing to %@, initializing the current status", (uint8_t *)&v12, 0x16u);
...
void __43__HMDPresenceEvent__handlePrivilegeUpdate___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  +[HMCContext findPresenceEventWithModelID:](HMCContext, "findPresenceEventWithModelID:", v2);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v3)
  {
    ...
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "na_map:", &__block_literal_global_33_41908);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to find the MKFPresenceEvent with modelID: %@", buf, 0x16u);
...
void __43__HMDPresenceEvent__handlePrivilegeUpdate___block_invoke_2(uint64_t a1)
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (os_unfair_lock_s *)((char *)*v2 + 88);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@User privilege changed. Going to update users", (uint8_t *)&v12, 0xCu);

  }
  objc_autoreleasePoolPop(v6);
  objc_msgSend(*(id *)(a1 + 32), "_updateUsers:home:", *(_QWORD *)(a1 + 40), v3);
  os_unfair_lock_unlock(v4);
  objc_msgSend(v3, "homeManager");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 32), "uuid");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "updateGenerationCounterWithReason:sourceUUID:shouldNotifyClients:", CFSTR("User Privilege changed"), v11, 1);

}

id __43__HMDPresenceEvent__handlePrivilegeUpdate___block_invoke_31(uint64_t a1, void *a2)
{
  void *v2;
  void *v3;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_41934 != -1)
    dispatch_once(&logCategory__hmf_once_t5_41934, &__block_literal_global_41935);
  return (id)logCategory__hmf_once_v6_41936;
}
...
void __31__HMDPresenceEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_41936;
  logCategory__hmf_once_v6_41936 = v0;
