...
- (void)_createSettingsFromModel:(id)a3
{
  ...
  if (v56)
  {
    ...
    if (self)
    {
      ...
      *(_QWORD *)&v59[16] = __74__HMDCompositeSettingsController__addedOrUpdatedSettingsFrom_newSettings___block_invoke;
      ...
      v17 = v16;
      v62 = v17;
      v18 = (void *)MEMORY[0x227676638](objc_msgSend(v14, "na_each:", v59));
      v19 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v17;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Settings changed %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v59[12] = 2112;
      *(_QWORD *)&v59[14] = v22;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Updated Settings %@", v59, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&v59[4] = v46;
      _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_INFO, "%{public}@Nil database (_createSettingsFromModel)", v59, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Nil database (fetchSettingForKeyPath)", buf, 0xCu);
    ...
    if (!objc_msgSend(v10, "count"))
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)((char *)&aBlock + 4) = v24;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Empty keypaths array", (uint8_t *)&aBlock, 0xCu);

        v21 = v33;
      }

      objc_autoreleasePoolPop(v21);
      v19[2](v19, MEMORY[0x24BDBD1A8]);
      v17 = MEMORY[0x24BDAC760];
    }
    if (self)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)&aBlock + 4) = v31;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Nil database (fetchSettingsForKeyPaths)", (uint8_t *)&aBlock, 0xCu);
...
- (id)fetchSynchronousSettingsForKeyPaths:(id)a3 callerVersion:(id)a4 callerPrivilege:(unint64_t)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Nil database (fetchSynchronousSettingsForKeyPaths)", buf, 0xCu);
...
- (void)updateSettingForKeyPath:(id)a3 value:(id)a4 callerVersion:(id)a5 completion:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v24;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Nil database (updateSettingForKeyPath)", buf, 0xCu);
...
- (void)updateSettingsForKeyPaths:(id)a3 callerVersion:(id)a4 completion:(id)a5
{
  ...
  if (objc_msgSend(v8, "count"))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v34 = v26;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Nil database (updateSettingsForKeyPaths)", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@settings is empty", buf, 0xCu);
...
- (id)_settingFromSetting:(id)a3 value:(id)a4 error:(id *)a5
{
  ...
  if (!v11)
  {
    ...
    if (v24)
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 19, CFSTR("Invalid string setting value"), 0, CFSTR("Setting type is String, please pass a String value"));
        ...
        if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v149 = 2112;
          v150 = v13;
          _os_log_impl(&dword_2218F0000, v67, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
    ...
    else
    {
      ...
      if (v43)
      {
        ...
        {
          objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 19, CFSTR("Invalid BOOL setting value"), 0, CFSTR("Setting type is Bool, please pass a Bool value"));
          v13 = (id)objc_claimAutoreleasedReturnValue();
          ...
          if (os_log_type_enabled(v93, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v149 = 2112;
            v150 = v13;
            _os_log_impl(&dword_2218F0000, v93, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
      ...
      else
      {
        ...
        if (v71)
        {
          ...
          if (!v74)
          {
            objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 19, CFSTR("Invalid Number setting value"), 0, CFSTR("Setting type is Number, please pass a Number value"));
            v13 = (id)objc_claimAutoreleasedReturnValue();
            ...
            if (os_log_type_enabled(v77, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v149 = 2112;
              v150 = v13;
              _os_log_impl(&dword_2218F0000, v77, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
        ...
        else
        {
          ...
          if (v97)
          {
            ...
            v145 = v8;
            v98 = v9;
            if (objc_msgSend(v98, "conformsToProtocol:", &unk_2557CA3D8))
              v99 = v98;
            else
              v99 = 0;
            v100 = v99;
            ...
            if (!v100)
            {
              objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 19, CFSTR("Invalid Language setting value"), 0, CFSTR("Setting type is Language, please pass a Language value"));
              v13 = (id)objc_claimAutoreleasedReturnValue();
              ...
              if (os_log_type_enabled(v103, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v149 = 2112;
                v150 = v13;
                _os_log_impl(&dword_2218F0000, v103, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
          ...
          {
            v118 = v8;
            objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 19, CFSTR("trying to create an invalid setting from value"), 0, 0);
            v13 = (id)objc_claimAutoreleasedReturnValue();
            ...
            if (os_log_type_enabled(v121, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v149 = 2112;
              v150 = v13;
              _os_log_impl(&dword_2218F0000, v121, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Unable to derived setting"), CFSTR("unknown version type"), 0);
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v151 = 2112;
      v152 = v35;
      _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive setting due to unknown version value type: %@ error: %@", buf, 0x20u);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          v134 = v111;
          objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 19, CFSTR("Unable to derived setting"), CFSTR("unknown setting type"), 0);
          ...
          if (os_log_type_enabled(v126, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v151 = 2112;
            v152 = v123;
            _os_log_impl(&dword_2218F0000, v126, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive setting due to unknown setting object type: %@ error: %@", buf, 0x20u);
  ...
  if (self)
  {
    ...
    if (v7)
    {
      if (v11)
      {
        ...
        v22 = 2112;
        v23 = v6;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Processing  model deletion, model:%@", (uint8_t *)&v20, 0x16u);
      ...
      objc_setProperty_atomic_copy(v9, v17, MEMORY[0x24BDBD1B8], 24);
    ...
    else
    {
      if (v11)
      {
        ...
        v20 = 138543362;
        v21 = v19;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_handleModelDeletion)", (uint8_t *)&v20, 0xCu);
...
- (void)database:(id)a3 didConfigureWithError:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v32[12] = 2112;
      *(_QWORD *)&v32[14] = v8;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Error configuring database adapter: %@", v32, 0x16u);
    ...
    if (self)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v37 = v27;
          _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_migrateAndCreateSettings)", buf, 0xCu);
...
- (id)_migrateUpdatedSettings:(void *)a1
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v9;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Settings to migrate: %@", buf, 0x16u);
    ...
    if (objc_msgSend(v9, "count"))
    {
      ...
      objc_msgSend(objc_getProperty(v11, v18, 64, 1), "queue", v14, 3221225472, __58__HMDCompositeSettingsController__migrateUpdatedSettings___block_invoke_29, &unk_24E784CF8, v11);
      v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v25;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_migrateUpdatedSettings)", buf, 0xCu);
...
void __58__HMDCompositeSettingsController__migrateUpdatedSettings___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v19 = 2112;
    v20 = v6;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating setting on model: %@, setting: %@", buf, 0x20u);
  ...
  if (a1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v15 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Nil database (_handleModelCreationOrUpdate)", buf, 0xCu);
  ...
  if (v53)
  {
    ...
    while (1)
    {
      ...
      do
      {
        ...
        if (!v13)
        {
          objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 21, CFSTR("Setting has not been configured yet (no current setting)"), 0, 0);
          ...
          if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v44;
            _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
        ...
        if (v15)
        {
          ...
          if (v18)
          {
            objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 10, CFSTR("Write version does not meet the minimum"), 0, 0);
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_WORD *)&buf[12] = 2112;
              *(_QWORD *)&buf[14] = v8;
              _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
...
LABEL_27:
                ...
                *(_WORD *)&buf[12] = 2112;
                *(_QWORD *)&buf[14] = v8;
                _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
...
LABEL_29:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v16;
            _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
...
LABEL_40:
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v74 = 138543362;
    v75 = v43;
    _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Nil database (_updateSettingsForKeyPaths)", v74, 0xCu);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Finished updating models:%@ error:%@", buf, 0x20u);
    ...
    objc_msgSend(objc_getProperty(v6, v12, 64, 1), "queue", v16[0], 3221225472, __86__HMDCompositeSettingsController__updateSettingsForKeyPaths_callerVersion_completion___block_invoke_74, &unk_24E784DB8);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v1)
  {
    ...
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Nil database (_updateSettingForKeyPath)", buf, 0xCu);
          ...
          if (v7)
          {
            ...
            if (!v12)
            {
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_WORD *)&buf[12] = 2112;
                *(_QWORD *)&buf[14] = v16;
                _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
            ...
            if (v15)
            {
              ...
              if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_WORD *)&buf[12] = 2112;
                *(_QWORD *)&buf[14] = v16;
                _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
            ...
            if (!v17)
            {
              ...
              if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_WORD *)&buf[12] = 2112;
                *(_QWORD *)&buf[14] = v16;
                _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v29 = 2112;
      v30 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@updating current setting:%@, new setting:%@ error:%@", buf, 0x2Au);
    ...
    v21 = *(id *)(a1 + 56);
    v22 = *(id *)(a1 + 64);
    v12 = (void *)MEMORY[0x24BE6B628];
    objc_msgSend(objc_getProperty(v6, v13, 64, 1), "queue", v17[0], 3221225472, __90__HMDCompositeSettingsController__updateSettingForKeyPath_value_callerVersion_completion___block_invoke_67, &unk_24E784D90, v6);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
void __90__HMDCompositeSettingsController__updateSettingForKeyPath_value_callerVersion_completion___block_invoke_67(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@updating setting:%@, error:%@", (uint8_t *)&v11, 0x20u);
  ...
  if (a1 && v11)
  {
    if (objc_msgSend(objc_getProperty(a1, v12, 56, 1), "containsObject:", v9))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v52 = 2112;
        v53 = v9;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Blocked fetch setting with key path: %@", buf, 0x16u);
    ...
    if (!v19)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v51 = v40;
        _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@Nil database (_fetchSettingForKeyPath)", buf, 0xCu);
    ...
    if (!v20)
    {
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 21, CFSTR("Setting has not been configured yet (no setting)"), 0, 0);
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v52 = 2112;
        v53 = v42;
        _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_ERROR, "%{public}@_fetchSettingForKeyPath Error: %@", buf, 0x16u);
    ...
    if (!v25
      || (-[HMDCompositeSettingOperationResult privileges](v25, "privileges"),
          ...
          v28 == -1))
    {
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 17, CFSTR("Insufficient User read Privilege or missing Metadata"), 0, 0);
      v31 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 10, CFSTR("Read version does not meet the minimum"), 0, 0);
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      v32 = (void *)MEMORY[0x227676638]();
      v33 = a1;
      HMFGetOSLogHandle();
...
LABEL_19:
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, v36, buf, 0x16u);
...
void __62__HMDCompositeSettingsController_filteredSettingsForSettings___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Filtering setting with blocked key path: %@", (uint8_t *)&v9, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13_112877 != -1)
    dispatch_once(&logCategory__hmf_once_t13_112877, &__block_literal_global_112878);
  return (id)logCategory__hmf_once_v14_112879;
}
...
void __45__HMDCompositeSettingsController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v14_112879;
  logCategory__hmf_once_v14_112879 = v0;
