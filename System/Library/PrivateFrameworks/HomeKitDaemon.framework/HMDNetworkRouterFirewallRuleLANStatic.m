...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", -[HMDNetworkRouterFirewallRuleLANStatic portStart](self, "portStart"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v6, "initWithName:value:", CFSTR("PortStart"), v7);
  v20[1] = v8;
  v9 = objc_alloc(MEMORY[0x24BE3F140]);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", -[HMDNetworkRouterFirewallRuleLANStatic portEnd](self, "portEnd"));
...
- (id)prettyJSONDictionary
{
  ...
  if (v9 == 2)
  {
    -[HMDNetworkRouterFirewallRuleLANStatic icmpTypes](self, "icmpTypes");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "na_map:", &__block_literal_global_253600);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(a1, "__decodeTransportProtocolFromJSONDictionary:key:transportProtocol:error:", v19, CFSTR("r"), &v52, a11))
  {
    ...
    if (v21)
    {
      ...
      if (!v23)
      {
        ...
        if (!v23)
        {
          v37 = (void *)MEMORY[0x227676638](v22);
          v38 = a1;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v55 = 2112;
            v56 = v22;
            _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid IP address value: %@", buf, 0x16u);
...
LABEL_39:
            _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, v29, buf, 0xCu);
