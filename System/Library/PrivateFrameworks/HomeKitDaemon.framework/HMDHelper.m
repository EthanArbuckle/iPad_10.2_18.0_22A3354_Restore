...
- (id)hashedRouteIDForIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (!v6)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)((char *)&v38 + 4) = v20;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot set up a connection to assistantServices framework to hash the routeID", (uint8_t *)&v38, 0xCu);
    ...
    *((_QWORD *)&v38 + 1) = &v38;
    v39 = 0x3032000000;
    v40 = __Block_byref_object_copy__217188;
    v41 = __Block_byref_object_dispose__217189;
    v42 = 0;
    ...
    if (dispatch_group_wait(v9, v10))
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v36 = 2112;
        v37 = v4;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Timed out encoding routeID %@", buf, 0x16u);
      ...
      if (v22)
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v36 = 2112;
            v37 = v14;
            _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Base64-converted hashedRouteUID %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v36 = 2112;
          v37 = v29;
          _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to base64 encode hashedRouteUIDData %@", buf, 0x16u);
...
LABEL_15:
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v36 = 2112;
        v37 = v4;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode routeID %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)((char *)&v38 + 4) = v17;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@nil routeID - nothing to hash", (uint8_t *)&v38, 0xCu);
...
void __40__HMDHelper_hashedRouteIDForIdentifier___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Hashed routeUID as %@", (uint8_t *)&v13, 0x16u);
