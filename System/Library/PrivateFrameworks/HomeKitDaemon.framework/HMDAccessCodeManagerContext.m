...
LABEL_9:
  ...
  if (v12)
  {
    ...
    objc_msgSend(MEMORY[0x24BE3F168], "blessWithImplicitContext:", v13->_workQueue);
  }
...
- (int64_t)accessoryReadWriteRetries
{
  ...
  objc_msgSend(MEMORY[0x24BE3F248], "sharedPreferences");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "preferenceForKey:", CFSTR("HMDAccessCodeManagerAccessoryReadWriteRetriesHH2"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)accessoryReadWriteRetryTimeInterval
{
  ...
  objc_msgSend(MEMORY[0x24BE3F248], "sharedPreferences");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "preferenceForKey:", CFSTR("HMDAccessCodeManagerAccessoryReadWriteRetryTimeIntervalHH2"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "numberValue");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_performMockedWriteRequests:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to mock data for write requests: %@", (uint8_t *)&v15, 0x16u);
...
- (id)performWriteRequests:(id)a3 withRetries:(int64_t)a4 timeInterval:(double)a5 loggingObject:(id)a6
{
  ...
  if (-[HMDAccessCodeManagerContext isDemoDataMockerEnabled](self, "isDemoDataMockerEnabled"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Demo Data Mocker is enabled, not writing to real accessory.", (uint8_t *)&v19, 0xCu);
...
- (id)performReadRequests:(id)a3 withRetries:(int64_t)a4 timeInterval:(double)a5 loggingObject:(id)a6
{
  ...
  if (-[HMDAccessCodeManagerContext isDemoDataMockerEnabled](self, "isDemoDataMockerEnabled"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Demo Data Mocker is enabled, not reading from real accessory.", (uint8_t *)&v19, 0xCu);
...
- (NSArray)accessoriesSupportingAccessCodes
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "na_filter:", &__block_literal_global_3771);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (id)objc_msgSend(MEMORY[0x24BDD72D8], "generateAccessCodeValueFromConstraints:accessoryAccessCodes:homeAccessCodes:", a3, a4, a5);
}
...
id __78__HMDAccessCodeManagerContext_uuidsOfAccessoriesSupportingAccessCodesForUser___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  if (objc_msgSend(v3, "supportsAccessCodesForUser:", *(_QWORD *)(a1 + 32)))
  {
