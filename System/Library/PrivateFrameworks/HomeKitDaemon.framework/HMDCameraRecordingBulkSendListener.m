...
void __76__HMDCameraRecordingBulkSendListener_accessory_didCloseDataStreamWithError___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory did close data stream", (uint8_t *)&v10, 0xCu);
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 3305);
  ...
  if (a1)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2112;
        v21 = v7;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Calling pending callback with result: %@ error: %@", (uint8_t *)&v16, 0x20u);
...
void __65__HMDCameraRecordingBulkSendListener_accessoryDidStartListening___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory did start listening", (uint8_t *)&v15, 0xCu);
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v15 = 138543362;
        v16 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling pending open bulk send session request", (uint8_t *)&v15, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_177049 != -1)
    dispatch_once(&logCategory__hmf_once_t4_177049, &__block_literal_global_177050);
  return (id)logCategory__hmf_once_v5_177051;
}
...
void __49__HMDCameraRecordingBulkSendListener_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_177051;
  logCategory__hmf_once_v5_177051 = v0;
