...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_byteOffset);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_byteLength);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_9:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->_timeOffset);
