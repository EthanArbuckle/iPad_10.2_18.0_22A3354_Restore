...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_150642 != -1)
    dispatch_once(&properties_onceToken_150642, block);
  return (id)properties__properties_150643;
}
...
void __27__HMDEventModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_150643;
  properties__properties_150643 = v3;

  v5 = (void *)properties__properties_150643;
  v9 = CFSTR("endEvent");
