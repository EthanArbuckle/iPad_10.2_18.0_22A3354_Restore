    ...
    && -[HMDResidentUser configurationState](self, "configurationState") == 2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v11 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Disabling as we are blocked", buf, 0xCu);
  ...
  if (v4)
  {
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v4;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating the device: %@", (uint8_t *)&v20, 0x16u);
    ...
    if ((v14 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v4;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating the device: %@", (uint8_t *)&v20, 0x16u);
...
- (id)modelObjectWithChangeType:(unint64_t)a3 version:(int64_t)a4
{
  ...
  if (v7)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDResidentUser configurationState](self, "configurationState"));
        ...
        else
        {
          ...
          if (v29 == 2)
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v39 = v33;
              _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_INFO, "%{public}@Disabling", buf, 0xCu);
...
LABEL_16:
    ...
    if (!v19)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v29 = v24;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Missing expected userID", buf, 0xCu);
