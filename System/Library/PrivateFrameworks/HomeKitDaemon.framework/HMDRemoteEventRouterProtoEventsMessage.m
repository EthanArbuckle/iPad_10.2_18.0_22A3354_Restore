...
- (id)description
{
  ...
  -[HMDRemoteEventRouterProtoEventsMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteEventRouterProtoEventsMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_cachedEvents, "count"));
    v19 = 0u;
    v20 = 0u;
    v21 = 0u;
    v22 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  v12 = a3;
  if (-[HMDRemoteEventRouterProtoEventsMessage eventsCount](self, "eventsCount"))
  {
    objc_msgSend(v12, "clearEvents");
    v4 = -[HMDRemoteEventRouterProtoEventsMessage eventsCount](self, "eventsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HMDRemoteEventRouterProtoEventsMessage eventsAtIndex:](self, "eventsAtIndex:", i);
  ...
  if (-[HMDRemoteEventRouterProtoEventsMessage cachedEventsCount](self, "cachedEventsCount"))
  {
    objc_msgSend(v12, "clearCachedEvents");
    v8 = -[HMDRemoteEventRouterProtoEventsMessage cachedEventsCount](self, "cachedEventsCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[HMDRemoteEventRouterProtoEventsMessage cachedEventsAtIndex:](self, "cachedEventsAtIndex:", j);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v20 != v8)
          objc_enumerationMutation(v5);
        -[HMDRemoteEventRouterProtoEventsMessage addEvents:](self, "addEvents:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v9++));
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v16 != v13)
          objc_enumerationMutation(v10);
        -[HMDRemoteEventRouterProtoEventsMessage addCachedEvents:](self, "addCachedEvents:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * v14++), (_QWORD)v15);
      }
      while (v12 != v14);
