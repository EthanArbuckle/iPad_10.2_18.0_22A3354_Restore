...
- (void)addClientConnection:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Adding client connection: %@", (uint8_t *)&v14, 0x16u);
...
- (void)removeClientConnection:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing client connection: %@", (uint8_t *)&v14, 0x16u);
...
void __76__HMDActiveXPCClientConnectionsManager_handleClientConnectionDidDeactivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling client connection did deactivate: %@", (uint8_t *)&v8, 0x16u);
...
void __74__HMDActiveXPCClientConnectionsManager_handleClientConnectionDidActivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling client connection did activate: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_235696 != -1)
    dispatch_once(&logCategory__hmf_once_t6_235696, &__block_literal_global_235697);
  return (id)logCategory__hmf_once_v7_235698;
}
...
void __51__HMDActiveXPCClientConnectionsManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_235698;
  logCategory__hmf_once_v7_235698 = v0;
