...
- (HMDMediaSessionState)initWithSessionIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      muted = v7->_muted;
      v7->_muted = (NSNumber *)MEMORY[0x24BDBD1C0];

      v7->_sleepWakeState = 0;
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
          ...
          v12 == -[HMDMediaSessionState repeatState](v6, "repeatState")))
    {
      ...
      if (vabds_f32(v15, v17) >= *MEMORY[0x24BDD7AF0])
      {
        v20 = 0;
      }
      else
...
- (id)dumpState
{
  ...
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObject:forKey:", v12, *MEMORY[0x24BE3EB68]);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
