  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v26;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Created context %@ for message %@", buf, 0x20u);
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v41 = 2112;
      v42 = v12;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Completed context %@ for message %@ with error: %@", buf, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_81260 != -1)
    dispatch_once(&logCategory__hmf_once_t2_81260, &__block_literal_global_81261);
  return (id)logCategory__hmf_once_v3_81262;
}
...
void __54__HMDModernTransportMessageContextManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_81262;
  logCategory__hmf_once_v3_81262 = v0;
