  ...
  if (v6 == v4)
  {
    ...
    if (v7 == 2)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration failed - timed out waiting for accessory reconnection", (uint8_t *)&v13, 0xCu);
...
- (void)_commitConfigurationUpdate
{
  ...
  v5 = objc_alloc(MEMORY[0x24BE1BC28]);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", -[HMDWiFiManagementController reconfigurationCookie](self, "reconfigurationCookie"));
      ...
      if (!v16)
      {
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v50 = 2112;
          v51 = v17;
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize Wi-Fi Configuration Control request for %@: %@", buf, 0x20u);
...
LABEL_16:
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v50 = 2112;
        v51 = v8;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Writing Wi-Fi Configuration Control request for %@: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v48 = 2112;
        v49 = v14;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Reading Wi-Fi Configuration Control for %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Missing required characteristic: %@", buf, 0x16u);
...
void __98__HMDWiFiManagementController__performWiFiConfigurationControlRequest_withDescription_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v6)
  {
    ...
    {
      v32 = 0;
      objc_msgSend(MEMORY[0x24BE1BC40], "parsedFromData:error:", v17, &v32);
      ...
      if (v18)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v37 = 2112;
          v38 = v18;
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Received Wi-Fi Configuration Control response for %@: %@", buf, 0x20u);
...
LABEL_23:
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v37 = 2112;
      v38 = v14;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse Wi-Fi Configuration Control response for %@: %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v37 = 2112;
    v38 = v12;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Wi-Fi Configuration Control request for %@ failed: %@", buf, 0x20u);
...
LABEL_12:
    ...
    && objc_msgSend(*(id *)(a1 + 32), "reconfigurationCookie") == v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 138543362;
      v27 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration successful", (uint8_t *)&v26, 0xCu);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    v32 = 1024;
    v33 = v23;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit fail-safe Wi-Fi reconfiguration (cookie: %04x, status: %08x, expected cookie: %04x)", (uint8_t *)&v26, 0x1Eu);
...
void __60__HMDWiFiManagementController__accessoryDidBecomeReachable___block_invoke_3(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138543362;
      v9 = v5;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration connection verification failed", (uint8_t *)&v8, 0xCu);

    }
    objc_autoreleasePoolPop(v2);
    v6 = *(void **)(a1 + 32);
    objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1081);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_9:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v22 = 2112;
    v23 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Performing fail-safe Wi-Fi reconfiguration with SSID '%@'", buf, 0x16u);
...
void __102__HMDWiFiManagementController_safelyReconfigureWithSSID_PSK_verificationCallback_logEvent_completion___block_invoke_13(id *a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (v22 != v20)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v46 = 2048;
          v47 = v22;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Configured %@ value %ld is out of range, using %ld", buf, 0x2Au);

        }
        objc_autoreleasePoolPop(v23);
      }
      v27 = objc_alloc_init(MEMORY[0x24BE1BC40]);
      v28 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC48]), "initWithValue:", 3);
      objc_msgSend(v27, "setOperationType:", v28);

      v29 = objc_alloc(MEMORY[0x24BE1BC28]);
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", objc_msgSend(a1[4], "reconfigurationCookie"));
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v33 = objc_alloc(MEMORY[0x24BE1BC28]);
    ...
    && objc_msgSend(*(id *)(a1 + 32), "reconfigurationCookie") == (unsigned __int16)v8)
  {
    ...
    if ((v8 & 0x20000) != 0)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v30 = 2048;
        *(_QWORD *)v31 = v23;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration initiated, awaiting accessory disconnect/reconnect with timeout of %ld seconds", (uint8_t *)&v28, 0x16u);
      ...
      v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 1, (double)*(uint64_t *)(a1 + 40));
      objc_msgSend(*(id *)(a1 + 32), "workQueue");
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 138543362;
      v29 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Wi-Fi reconfiguration without session restart is not supported", (uint8_t *)&v28, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v31 = v8;
      v31[2] = 1024;
      *(_DWORD *)&v31[3] = v20;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to initiate fail-safe Wi-Fi reconfiguration (status: %08x, expected cookie: %04x)", (uint8_t *)&v28, 0x18u);

    }
    objc_autoreleasePoolPop(v16);
    v14 = *(void **)(a1 + 32);
    objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1080);
    v15 = objc_claimAutoreleasedReturnValue();
  }
  v21 = (void *)v15;
...
LABEL_9:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v26 = 2112;
    v27 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Performing simple Wi-Fi reconfiguration with SSID '%@'", buf, 0x16u);
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", &unk_24E96AF10);
...
LABEL_5:
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Simple Wi-Fi reconfiguration successful", (uint8_t *)&v17, 0xCu);
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve Wi-Fi network information for '%@': %@", buf, 0x20u);
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v3;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@No password available for Wi-Fi network '%@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t23_73827 != -1)
    dispatch_once(&logCategory__hmf_once_t23_73827, &__block_literal_global_73828);
  return (id)logCategory__hmf_once_v24_73829;
}
...
void __42__HMDWiFiManagementController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v24_73829;
  logCategory__hmf_once_v24_73829 = v0;
