...
{
  return -[HMDDataStreamBulkSendProtocol initWithQueue:accessory:logIdentifier:bulkSendSessionContextFactory:](self, "initWithQueue:accessory:logIdentifier:bulkSendSessionContextFactory:", a3, a4, a5, &__block_literal_global_166727);
}
...
- (void)addListener:(id)a3 fileType:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Rejecting BulkSend registration for file type %@; handler already exists",
        (uint8_t *)&v17,
        0x16u);
...
- (void)_notifyActiveStatusChangedFromPreviousValue:(BOOL)a3
{
  ...
  if (-[HMDDataStreamBulkSendProtocol isActive](self, "isActive") != a3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v8;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@BulkSend protocol changes active to %@", (uint8_t *)&v10, 0x16u);
...
- (void)_closeAllSessionsWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Session closed; removing %lu listeners and closing %lu sessions",
      buf,
      0x20u);
  ...
  objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD1308], -1005, v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)dataStream:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@DataStream failed with error; cleaning up. (%@)",
      (uint8_t *)&v12,
      0x16u);
...
- (void)dataStreamInitiatedClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream initiated closing...", (uint8_t *)&v9, 0xCu);
...
- (void)dataStreamDidClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream closed; cleaning up",
      (uint8_t *)&v9,
      0xCu);
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v23 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@DataStream did open; connected.", buf, 0xCu);
...
LABEL_10:
      _os_log_impl(&dword_2218F0000, v19, v20, v18, (uint8_t *)&v21, 0x16u);
  ...
  if (-[HMDDataStreamBulkSendProtocol isConnected](self, "isConnected"))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2112;
        v21 = v11;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@DataSend received unexpected request '%@'", (uint8_t *)&v18, 0x16u);
...
- (id)_createSessionCandidateWithRequestHeader:(id)a3 metadata:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive candidate session (header %@)", (uint8_t *)&v14, 0x16u);
...
- (id)_createSessionFromCandidate:(id)a3 queue:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    v21 = 2112;
    v22 = v8;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive session with streamIdentifier=%@", (uint8_t *)&v19, 0x16u);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v21 = 2048;
      v22 = v5;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending open response with status %@ (%ld)", buf, 0x20u);
...
{
  -[HMDDataStreamBulkSendProtocol _sendOpenResponseWithRequestHeader:payload:status:](self, "_sendOpenResponseWithRequestHeader:payload:status:", a3, MEMORY[0x24BDBD1B8], a4);
}
...
- (void)_handleOpenWithRequestHeader:(id)a3 payload:(id)a4
{
  ...
  if (v10 && v13)
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        v33 = 2112;
        v34 = v10;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Received 'open' with type=%@; passing to listener",
          (uint8_t *)&v31,
          0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v33 = 2112;
        v34 = v10;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Received 'open' for type=%@ but no active listener accepted it", (uint8_t *)&v31, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v13;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Dropping 'open' because it is missing required keys (type=%@, target=%@)", (uint8_t *)&v31, 0x20u);
...
- (void)_handleCloseMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v15)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v28 = 2112;
        v29 = v7;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Received close packet for stream identifier: %@", (uint8_t *)&v26, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        v28 = 2112;
        v29 = v7;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Close packet for streamIdentifier=%@ dropped because no session is active", (uint8_t *)&v26, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v24;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Close dropped because streamIdentifier was not included", (uint8_t *)&v26, 0xCu);
...
- (void)_handleDataMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        v19 = 2112;
        v20 = v7;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Data packet for streamIdentifier=%@ dropped because no session is active", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Data packet dropped because no session identifier was present", (uint8_t *)&v17, 0xCu);
...
LABEL_15:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 138543362;
    v22 = v20;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Received message with no packets", (uint8_t *)&v21, 0xCu);
...
- (void)_sendCloseMessageWithIdentifier:(id)a3 reason:(unsigned __int16)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 1024;
      v19 = v4;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Sending 'close' for sid=%@ with reason %d", (uint8_t *)&v14, 0x1Cu);

    }
    objc_autoreleasePoolPop(v10);
    objc_msgSend(v7, "sendEventForProtocol:topic:payload:completion:", CFSTR("dataSend"), CFSTR("close"), v9, &__block_literal_global_42_166691);
...
- (void)_sendAckMessageWithIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending 'ack' for sid=%@", (uint8_t *)&v11, 0x16u);

    }
    objc_autoreleasePoolPop(v7);
    objc_msgSend(v5, "sendEventForProtocol:topic:payload:completion:", CFSTR("dataSend"), CFSTR("ack"), v6, &__block_literal_global_43_166688);
...
- (void)_openSessionForFileType:(id)a3 reason:(id)a4 metadata:(id)a5 queue:(id)a6 callback:(id)a7
{
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v50 = 2112;
    v51 = v14;
    _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Starting bulk session with identifier: %@ and metadata: %@", buf, 0x20u);
...
LABEL_15:
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, v21, buf, 0x16u);
...
LABEL_16:
    ...
    if (objc_msgSend(v24, "shouldCloseSessionWithTimeoutReason"))
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v41 = v28;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@Skipping invoking the session start callback since handle response timer hasn't expired", buf, 0xCu);
...
LABEL_21:
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = 0;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@Could not find expired timer for session with identifier: %@", buf, 0x16u);
  ...
  if (v12)
  {
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v59 = 2112;
      v60 = v7;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Received bulk send open response for session with identifier: %@ error: %@", buf, 0x20u);
    ...
    if (objc_msgSend(v12, "shouldCloseSessionWithTimeoutReason"))
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v57 = 2112;
        v58 = v24;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Session with identifier: %@ has timed out, sending close event to accessory", buf, 0x16u);
    ...
    else
    {
      ...
      if (v28)
      {
        ...
        if (v30)
        {
          ...
          objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD5BD8], v35, 0);
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v61 = 2112;
            v62 = v52;
            _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_ERROR, "%{public}@Received non-success status in header: %@ payload status: %@. Mapped to error: %@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v56 = v39;
          _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Could not find a status in header", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v36);
        objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD5BD8], 27, 0);
  ...
  else
  {
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v57 = 2112;
      v58 = v27;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Could not find pending bulk send session context for session identifier: %@", buf, 0x16u);
...
HMDDataStreamBulkSendPendingSessionContext *__71__HMDDataStreamBulkSendProtocol_initWithQueue_accessory_logIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 0, 10.0);
