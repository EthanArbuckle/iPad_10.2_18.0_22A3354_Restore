...
- (HMDHAPMediaProfile)initWithMediaServices:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      v8->_airPlayEnable = -1;
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.HMDHAPMediaProfile.%@"), CFSTR("com.apple.HomeKitDaemon.Local"), v7);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v20 = 2112;
      v21 = v5;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot create media profile, cannot determine accessory from services %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v19 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Not registering for notifications as accessory is nil", buf, 0xCu);
...
- (id)_smartSpeakerTargetMediaStateCharacteristic
{
  ...
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x24BDD5A58]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (HMDCharacteristic)smartSpeakerCurrentMediaStateCharacteristic
{
  ...
  -[HMDHAPMediaProfile _smartSpeakerService](self, "_smartSpeakerService");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x24BDD5858]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (HMDCharacteristic)smartSpeakerVolumeCharacteristic
{
  ...
  -[HMDHAPMediaProfile _smartSpeakerService](self, "_smartSpeakerService");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x24BDD5A98]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_smartSpeakerMutedCharacteristic
{
  ...
  -[HMDHAPMediaProfile _smartSpeakerService](self, "_smartSpeakerService");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x24BDD5920]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)_updatePlayback:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@No local media session for hapMediaProfile", buf, 0xCu);
    ...
    if (v10)
    {
      ...
      if (v13)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v33 = v24;
            _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Update Playback] failed to create target media state write request", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v33 = v20;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Update Playback] accessory not part of profile", buf, 0xCu);
...
- (BOOL)_updateRefreshPlayback:(id)a3
{
  ...
  if (!-[HMDMediaProfile _updateRefreshPlayback:](&v50, sel__updateRefreshPlayback_))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v7;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@No local media session for hapMediaProfile", buf, 0xCu);
    ...
    if (v36)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v53 = v17;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker airplay enable state is not available", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v14);
      }
      objc_msgSend(v38, "arrayForKey:", *MEMORY[0x24BDD66F0], v34);
      v48 = 0u;
      v49 = 0u;
      v46 = 0u;
      v47 = 0u;
      ...
      {
        v19 = *(_QWORD *)v47;
        v20 = *MEMORY[0x24BDD66E0];
        v21 = *MEMORY[0x24BDD6758];
        v39 = *MEMORY[0x24BDD66D0];
        do
        {
          for (i = 0; i != v18; ++i)
          {
            ...
            if (objc_msgSend(v23, "isEqual:", v20))
            {
              ...
              if (!v24)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v53 = v28;
                  _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker current media state is not available", buf, 0xCu);
            ...
            else if (objc_msgSend(v23, "isEqual:", v21))
            {
              ...
              if (!v24)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v53 = v29;
                  _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker volume is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (!v24)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v53 = v30;
                  _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker muted is not available", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v54 = 2112;
        v55 = v11;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] accessory not part of profile (%@)", buf, 0x16u);
...
- (id)mediaSessionFromProfile
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media session from profile due to no media session state from profile", buf, 0xCu);
...
- (id)_mediaSessionStateFromProfile
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media session state from profile due to no accessory", (uint8_t *)&v13, 0xCu);
...
- (void)updateMediaSessionState:(id)a3 usingServices:(id)a4
{
  ...
  v9 = a3;
  objc_msgSend(a4, "na_filter:", &__block_literal_global_220738);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)updateMediaSessionState:(id)a3 usingCharacteristics:(id)a4
{
  ...
  if (v7)
  {
    v8 = v7;
    v9 = *(_QWORD *)v35;
    v10 = *MEMORY[0x24BDD5858];
    v11 = *MEMORY[0x24BDD5A98];
    v33 = *MEMORY[0x24BDD5920];
    do
    {
      v12 = 0;
      do
...
- (void)_handleCharacteristicChanges:(id)a3
{
  ...
  v5 = 0;
  v6 = *(_QWORD *)v38;
  v7 = *MEMORY[0x24BDD5858];
  v8 = *MEMORY[0x24BDD5A98];
  v33 = *MEMORY[0x24BDD5920];
  do
  {
    v9 = 0;
  ...
  if (v7)
  {
    ...
    if (objc_msgSend(v8, "count"))
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v8;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@%@ notifications for characteristics: %@", (uint8_t *)&v18, 0x20u);
...
- (void)_disableCharacteristicNotifications
{
  ...
  if (objc_msgSend(v3, "count"))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Disabling notifications for characteristics :%@", (uint8_t *)&v12, 0x16u);
...
- (BOOL)_updateAudioControl:(id)a3
{
  ...
  if (!-[HMDMediaProfile _updateAudioControl:](&v36, sel__updateAudioControl_, v4))
  {
    ...
    objc_autoreleasePoolPop(v6);
    objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD66B0]);
    v10 = objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD6698]);
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v39 = 2112;
          v40 = v18;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] accessory not part of profile (%@)", buf, 0x16u);
      ...
      if (v10)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v38 = v23;
            _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] smart speaker volume is not available", buf, 0xCu);
      ...
      if (v11)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v38 = v27;
            _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] smart speaker muted is not available", buf, 0xCu);
...
- (void)_updateCurrentMediaState:(id)a3 volumePercentage:(id)a4 muted:(id)a5 enable:(id)a6 message:(id)a7
{
  ...
  if (v12 || v13 || v14 || v15)
  {
    v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", 3);
    v18 = v17;
    if (v12)
      objc_msgSend(v17, "setValue:forKey:", v12, *MEMORY[0x24BDD66E0]);
    if (v13)
      objc_msgSend(v18, "setValue:forKey:", v13, *MEMORY[0x24BDD6758]);
    if (v14)
      objc_msgSend(v18, "setValue:forKey:", v14, *MEMORY[0x24BDD66D0]);
    v41 = v18;
    ...
    if (v15)
    {
      ...
      if (-[HMDHAPMediaProfile airPlayEnable](self, "airPlayEnable") != v22)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDHAPMediaProfile airPlayEnable](self, "airPlayEnable"));
        v23 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v48 = 2112;
      v49 = v14;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated current media state %@, volume %@, muted %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v24);
    v28 = objc_alloc(MEMORY[0x24BE3F1B8]);
    -[HMDAccessoryProfile uniqueIdentifier](v25, "uniqueIdentifier");
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    v30 = (void *)objc_msgSend(v28, "initWithTarget:", v29);

    v31 = (void *)MEMORY[0x24BE3F1D0];
    v32 = *MEMORY[0x24BDD66E8];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x24BDD6680]);
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set AirPlay Enable] failed to create AirPlay enable write request", (uint8_t *)location, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set AirPlay Enable] accessory not part of profile", (uint8_t *)location, 0xCu);
        ...
        do
        {
          ...
          else
          {
            ...
            if (v24)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(WeakRetained, "airPlayEnable"));
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              v43 = v25;
          ...
          if (v11)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v42 = 2112;
              v43 = v20;
              _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Write value %@ failed with error %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v26;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid response with write values %@", buf, 0x16u);
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v31 = 2112;
              v32 = v20;
              _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Current device is primary:%@ and does not support home hub", buf, 0x16u);
  ...
  if (v4)
  {
    ...
    if (v5 && objc_msgSend(v5, "isCurrentDevice"))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 2112;
        v19 = v13;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Current device was added as a resident device (%@ / %@) notification.", (uint8_t *)&v14, 0x20u);
...
void __45__HMDHAPMediaProfile__updateRefreshPlayback___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_msgSend(v3, "count"))
  {
    ...
    v58 = 0;
    v9 = *(_QWORD *)v60;
    v57 = *MEMORY[0x24BDD5858];
    v54 = *MEMORY[0x24BDD5A98];
    v52 = *MEMORY[0x24BDD5920];
    while (1)
    {
      for (i = 0; i != v7; ++i)
      {
...
LABEL_34:
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v66 = 2112;
          v67 = v18;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Read failed with error %@", buf, 0x16u);
...
LABEL_43:
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v66 = 2112;
    v67 = v44;
    _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v25;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
