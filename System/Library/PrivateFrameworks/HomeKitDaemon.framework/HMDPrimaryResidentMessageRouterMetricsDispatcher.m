...
- (void)submitFailureEventWithMessageName:(id)a3 failureType:(int64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v12;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting failure event with message name: %@ failure type: %@", (uint8_t *)&v15, 0x20u);
