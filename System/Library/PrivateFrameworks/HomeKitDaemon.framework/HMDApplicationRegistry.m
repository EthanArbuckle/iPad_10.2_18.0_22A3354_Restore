...
+ (id)sharedRegistry
{
  if (sharedRegistry_onceToken_154916 != -1)
    dispatch_once(&sharedRegistry_onceToken_154916, &__block_literal_global_154917);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_154911 != -1)
    dispatch_once(&logCategory__hmf_once_t3_154911, &__block_literal_global_9_154912);
  return (id)logCategory__hmf_once_v4_154913;
}
...
void __37__HMDApplicationRegistry_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_154913;
  logCategory__hmf_once_v4_154913 = v0;
