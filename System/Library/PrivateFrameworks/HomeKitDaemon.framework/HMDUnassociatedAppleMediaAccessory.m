...
- (id)modelForChangeType:(unint64_t)a3 uuid:(id)a4 parentUUID:(id)a5
{
  ...
  v7 = a5;
  v8 = a4;
  v9 = -[HMDBackingStoreModelObject initWithObjectChangeType:uuid:parentUUID:]([HMDAppleMediaAccessoryModel alloc], "initWithObjectChangeType:uuid:parentUUID:", a3, v8, v7);
...
- (HMDUnassociatedAppleMediaAccessory)initWithIdentifier:(id)a3 name:(id)a4 category:(id)a5 requiredPairingCapabilities:(unint64_t)a6 minimumPairingSoftware:(id)a7 productColor:(int64_t)a8 idsIdentifierString:(id)a9 rawAccessoryCapabilities:(id)a10 rawResidentCapabilities:(id)a11 messageDispatcher:(id)a12
{
  ...
  v18 = -[HMDUnassociatedMediaAccessory initWithIdentifier:name:category:messageDispatcher:](&v27, sel_initWithIdentifier_name_category_messageDispatcher_, a3, a4, a5, a12);
  if (v18)
  {
    v19 = -[HMDCapabilityFlags initWithCapabilityOptions:]([HMDCapabilityFlags alloc], "initWithCapabilityOptions:", a6);
...
- (id)descriptionWithPointer:(BOOL)a3 additionalDescription:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDUnassociatedAppleMediaAccessory supportedStereoPairVersions](self, "supportedStereoPairVersions"));
...
- (id)addTransactionForHome:(id)a3
{
  ...
  -[HMDUnassociatedMediaAccessory addTransactionForHome:](&v31, sel_addTransactionForHome_, a3);
  ...
  if (v6)
  {
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v13 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x24BDD49E0]);
    ...
    if (v13)
    {
      ...
      {
        objc_msgSend(v6, "setSupportedStereoPairVersions:", &unk_24E96AC58);
      }
    }
    ...
    v25 = -[HMDUnassociatedAppleMediaAccessory variant](self, "variant");
    if ((v13 & (v25 == 0)) != 0)
      v26 = 1;
    else
      v26 = v25;
    if (v26)
    {
      ...
      objc_msgSend(v6, "setVariant:", v27);

    }
    -[HMDUnassociatedAppleMediaAccessory rawAccessoryCapabilities](self, "rawAccessoryCapabilities");
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setAccessoryCapabilities:", v28);

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDUnassociatedAppleMediaAccessory productColor](self, "productColor"));
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setProductColor:", v29);
...
- (BOOL)canPairGivenCapabilities:(unint64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@No required capabilities found.", (uint8_t *)&v14, 0xCu);
...
- (id)dumpDescription
{
  ...
  objc_msgSend(v16, "setObject:forKey:", v12, *MEMORY[0x24BE3EB68]);
  return v16;
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMDUnassociatedAppleMediaAccessory softwareVersion](self, "softwareVersion");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x24BDD4FF0]);
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDUnassociatedAppleMediaAccessory supportedStereoPairVersions](self, "supportedStereoPairVersions"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v9, *MEMORY[0x24BDD6F38]);
  ...
  objc_msgSend(v4, "encodeInteger:forKey:", v13, *MEMORY[0x24BDD6A48]);
  -[HMDUnassociatedAppleMediaAccessory idsIdentifierString](self, "idsIdentifierString");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    objc_msgSend(v4, "encodeBool:forKey:", v17, *MEMORY[0x24BDD4B20]);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8 != -1)
    dispatch_once(&logCategory__hmf_once_t8, &__block_literal_global_47994);
