...
void __65__HMDCameraPowerAssertionHandler_deregisterRemoteRequestHandler___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v22;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Cannot find session %@ in current assertion holders %@", (uint8_t *)&v23, 0x20u);
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v10;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Deregistering power assertion holder %@, current camera power assertion holders: %@", (uint8_t *)&v23, 0x20u);
  ...
  if (!v12)
  {
    if (objc_msgSend(*(id *)(a1 + 32), "powerAssertion"))
    {
      ...
      v13 = (void *)MEMORY[0x227676638](objc_msgSend(*(id *)(a1 + 32), "setPowerAssertion:", 0));
      v14 = *(id *)(a1 + 32);
      HMFGetOSLogHandle();
      v15 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
...
LABEL_12:
        _os_log_impl(&dword_2218F0000, v18, v19, v17, (uint8_t *)&v23, 0xCu);
...
void __76__HMDCameraPowerAssertionHandler_registerRemoteRequestHandler_forSessionID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Registering power assertion holder for session %@", (uint8_t *)&v21, 0x16u);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v20;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Current camera power assertion holders: %@", (uint8_t *)&v21, 0x16u);
...
+ (id)sharedHandler
{
  if (sharedHandler_onceToken_168627 != -1)
    dispatch_once(&sharedHandler_onceToken_168627, &__block_literal_global_168628);
  return (id)assertionHandler;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t0_168622 != -1)
    dispatch_once(&logCategory__hmf_once_t0_168622, &__block_literal_global_20_168623);
  return (id)logCategory__hmf_once_v1_168624;
}
...
void __45__HMDCameraPowerAssertionHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_168624;
  logCategory__hmf_once_v1_168624 = v0;
