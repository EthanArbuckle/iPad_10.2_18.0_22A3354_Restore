...
- (void)_createSnapshotContext
{
  ...
  objc_msgSend(MEMORY[0x24BDE5658], "remoteContext");
...
- (void)_backboardServicesRelaunched
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Backboard services is relaunched", (uint8_t *)&v8, 0xCu);
...
- (id)createSlotWithFilePath:(id)a3
{
  ...
  v16 = &v15;
  v17 = 0x3032000000;
  v18 = __Block_byref_object_copy__60371;
  v19 = __Block_byref_object_dispose__60372;
  v20 = 0;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F200]), "initWithName:", CFSTR("com.apple.homed.snapshot-catransaction-createslot."));
...
- (void)fillSlotWithIdentifier:(id)a3 filePath:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v11;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Filling snapshot slot %u for file %@ with image %@", (uint8_t *)&v17, 0x26u);
...
- (void)clearSlotWithIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Clearing slot %@", (uint8_t *)&v11, 0x16u);
...
- (id)_createSlotWithFilePath:(id)a3 snapshotCATransaction:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v6;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Created snapshot slot %u for file %@", (uint8_t *)&v16, 0x1Cu);
...
- (void)deleteSlotWithIdentifier:(id)a3 filePath:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F200]), "initWithName:", CFSTR("com.apple.homed.snapshot-catransaction-deleteslot."));
  -[HMDSnapshotCATransactionHandler clientQueue](self, "clientQueue");
...
- (void)_deleteSlotWithIdentifier:(id)a3 filePath:(id)a4 snapshotCATransaction:(id)a5
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v9;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Released the snapshot slot %u for file %@", (uint8_t *)&v18, 0x1Cu);
...
- (CGImage)createSnapshotCGImageRef:(id)a3
{
  ...
  v6 = (void *)*MEMORY[0x24BDBD268];
  v7 = (void *)*MEMORY[0x24BDD97C8];
...
LABEL_8:
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, v17, (uint8_t *)&v19, 0x16u);
...
+ (id)sharedHandler
{
  if (sharedHandler_onceToken != -1)
    dispatch_once(&sharedHandler_onceToken, &__block_literal_global_60392);
  return (id)handler;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t2_60387 != -1)
    dispatch_once(&logCategory__hmf_once_t2_60387, &__block_literal_global_2_60388);
  return (id)logCategory__hmf_once_v3_60389;
}
...
void __46__HMDSnapshotCATransactionHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_60389;
  logCategory__hmf_once_v3_60389 = v0;
