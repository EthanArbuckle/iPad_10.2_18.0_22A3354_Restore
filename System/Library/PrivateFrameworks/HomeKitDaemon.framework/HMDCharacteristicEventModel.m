...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_199998 != -1)
    dispatch_once(&properties_onceToken_199998, block);
  return (id)properties__properties_199999;
}
...
void __41__HMDCharacteristicEventModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_199999;
  properties__properties_199999 = v3;

  v5 = (void *)properties__properties_199999;
  v9 = CFSTR("eventValue");
