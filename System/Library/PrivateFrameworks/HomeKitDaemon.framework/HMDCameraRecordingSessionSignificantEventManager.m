...
- (HMDCameraRecordingSessionSignificantEventManager)initWithWorkQueue:(id)a3 faceClassificationResolver:(id)a4 logIdentifier:(id)a5
{
  ...
  if (v9)
  {
    ...
    if (v13)
    {
      ...
      v14->_significantEventUUIDFactory = &__block_literal_global_77647;

      faceClassificationUUIDFactory = v14->_faceClassificationUUIDFactory;
      v14->_faceClassificationUUIDFactory = &__block_literal_global_4_77648;
...
- (void)resetState
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Resetting state", (uint8_t *)&v9, 0xCu);
...
- (id)_significantEventsForFrameResult:(id)a3 analyzerResult:(id)a4 dateOfOccurrence:(id)a5 timeOffsetWithinClip:(double)a6 recordingEventTriggers:(unint64_t)a7
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v64 = 2112;
    v65 = v18;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Finding significant events for frame result %@ with analyzer events: %@", buf, 0x20u);
  ...
  if (!v21)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v64 = 2112;
      v65 = v45;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create hero frame from frame %@: %@", buf, 0x20u);
...
- (id)_significantEventsForAnalyzerEvent:(id)a3 dateOfOccurrence:(id)a4 heroFrameData:(id)a5 timeOffsetWithinClip:(double)a6 recordingEventTriggers:(unint64_t)a7
{
  ...
  if (v17 >= 3)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2048;
      v41 = v18;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unknown analyzer event confidence level: %ld", buf, 0x16u);
  ...
  {
    v19 = qword_2226A0980[v17];
  }
  v23 = (void *)MEMORY[0x24BDBCF20];
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v16, a7);
...
- (id)_filteredAndUpdatedSignificantEventsFromSignificantEvents:(id)a3
{
  ...
  objc_msgSend(v9, "sortedArrayUsingComparator:", &__block_literal_global_13_77619);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      for (i = 0; i != v64; ++i)
      {
        ...
        if (v14)
        {
          ...
          if (v17)
          {
            ...
            {
              v22 = (void *)MEMORY[0x227676638](objc_msgSend(v8, "removeObject:", v20));
              v23 = v63;
              HMFGetOSLogHandle();
              v24 = objc_claimAutoreleasedReturnValue();
              if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v78 = 2112;
                v79 = v20;
                _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Adding new face classifications %@ to existing significant event: %@", buf, 0x20u);
...
LABEL_21:
            ...
            if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v76 = 2112;
              v77 = v13;
              _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@Skipping significant event because it is already represented: %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (v35)
            {
              ...
              if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v76 = 2112;
                v77 = v13;
                _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_INFO, "%{public}@Adding new significant event: %@", buf, 0x16u);
            ...
            {
              v46 = (void *)MEMORY[0x227676638](objc_msgSend(v8, "removeObject:", v14));
              v47 = v63;
              HMFGetOSLogHandle();
              ...
              if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v78 = 2112;
                v79 = v13;
                _os_log_impl(&dword_2218F0000, v48, OS_LOG_TYPE_INFO, "%{public}@Updating existing significant event with UUID %@ using new significant event: %@", buf, 0x20u);
...
LABEL_27:
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v76 = 2112;
          v77 = v13;
          _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@Adding new significant event: %@", buf, 0x16u);
...
BOOL __113__HMDCameraRecordingSessionSignificantEventManager__isAnyEventInAnalyzerEvents_includedInRecordingEventTriggers___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v3;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Recording fragment due to recording trigger event: %@", (uint8_t *)&v16, 0x16u);
...
{
  return objc_msgSend(MEMORY[0x24BDD1880], "UUID");
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13 != -1)
    dispatch_once(&logCategory__hmf_once_t13, &__block_literal_global_25_77655);
