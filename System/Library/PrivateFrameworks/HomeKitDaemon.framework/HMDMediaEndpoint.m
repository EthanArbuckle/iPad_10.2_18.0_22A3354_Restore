...
- (void)externalDevice
{
  ...
  if (v3)
  {
    ...
    if (!ExternalDevice)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v17 = 2112;
        v18 = v4;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Cannot look up the external device for endpoint %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@No endpoint to look up origin", (uint8_t *)&v15, 0xCu);
  ...
  if (result)
  {
    ...
    if (!result)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        v8 = 138543362;
        v9 = v7;
        _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Cannot look up origin from external device", (uint8_t *)&v8, 0xCu);
...
- (void)_connectWithCompletionHandler:(id)a3
{
  ...
  if (v7)
  {
    ...
    if ((_DWORD)ConnectionState == 1)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v25 = v15;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Already in the process of connecting to the external device...", buf, 0xCu);
    ...
    {
      v16 = (void *)MEMORY[0x227676638](v10);
      v17 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v25 = v19;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@No connection to external device - setting up connection state callback and attempting to connect...", buf, 0xCu);
...
- (void)registerForNowPlayingUpdates:(BOOL)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ for playback state changes", (uint8_t *)&v14, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v14 = 138543362;
      v15 = (uint64_t)v13;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up external device for endpoint to register for playback state updates", (uint8_t *)&v14, 0xCu);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v3;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Attempt to connect to the endpoint to set the playback state failed with error %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v15;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Attempting to locally set the playback state command with mediaRemote", buf, 0xCu);
      ...
      if (!v17)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v31 = 2112;
          v32 = v18;
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Sending the command to mediaremote failed for media endpoint %@", buf, 0x16u);
        ...
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 74, CFSTR("Media remote command send failure "), CFSTR("Media remote command send failure"), 0, v23);
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v25;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up origin for mediaSession to set playback state after connection", buf, 0xCu);
      ...
      if (*(_QWORD *)(a1 + 32))
      {
        ...
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 4, CFSTR("Cannot lookup origin"), CFSTR("Cannot lookup origin"), 0, v26);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v3;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Attempt to connect to the endpoint to get the playback state failed with error %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v23 = v15;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Endpoint Attempting to locally read the playback state from media remote", buf, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v23 = v17;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up origin for mediaSession to get playback state after connection", buf, 0xCu);
      ...
      if (*(_QWORD *)(a1 + 32))
      {
        ...
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 4, CFSTR("Cannot lookup origin"), CFSTR("Cannot lookup origin"), 0, v18);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        (*(void (**)(void))(*(_QWORD *)(a1 + 32) + 16))();
...
void __59__HMDMediaEndpoint__getPlaybackStateWithCompletionHandler___block_invoke_20(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2048;
    v14 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Locally read the playback state as: %tu", (uint8_t *)&v11, 0x16u);
    ...
    if ((_DWORD)a2 != 1 && v8 != (_DWORD)a2)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&v26[6] = v8;
        ...
        v29 = 2112;
        v30 = a3;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Connection state changed to %u (from %u) for endpoint %@ with error %@", (uint8_t *)&v23, 0x2Cu);
      ...
      if ((_DWORD)a2 == 3 && v8 == 2)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v25 = 2112;
          *(_QWORD *)v26 = v19;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Attempting to refresh the session for the accessories on endpoint (%@) disconnect", (uint8_t *)&v23, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28_115897 != -1)
    dispatch_once(&logCategory__hmf_once_t28_115897, &__block_literal_global_115898);
  return (id)logCategory__hmf_once_v29_115899;
}
...
void __31__HMDMediaEndpoint_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v29_115899;
  logCategory__hmf_once_v29_115899 = v0;
