...
- (void)startObservingPresenceForDevice:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@startObservingPresenceForDevice: called before configureWithDataSource:", (uint8_t *)&v11, 0xCu);
  ...
  objc_msgSend(v10, "startObservingDevice:subActivity:", v4, *MEMORY[0x24BE4F940]);
...
- (void)stopObservingPresenceForDevice:(id)a3
{
  ...
  objc_msgSend(v5, "stopObservingDevice:subActivity:", v4, *MEMORY[0x24BE4F940]);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v7;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying delegates of IDS Activity update: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v7;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Received IDS Activity update for unkonwn device: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_184645 != -1)
    dispatch_once(&logCategory__hmf_once_t17_184645, &__block_literal_global_133_184646);
  return (id)logCategory__hmf_once_v18_184647;
}
...
void __44__HMDIDSActivityMonitorObserver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_184647;
  logCategory__hmf_once_v18_184647 = v0;
