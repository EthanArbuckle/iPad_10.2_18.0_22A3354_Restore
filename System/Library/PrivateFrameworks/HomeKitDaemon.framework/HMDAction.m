...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v9[0] = v4;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAction type](self, "type"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v9[1] = v5;
...
- (HMDAction)initWithCoder:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode HMDAction missing key: %@", (uint8_t *)&v14, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_165863 != -1)
    dispatch_once(&logCategory__hmf_once_t2_165863, &__block_literal_global_165864);
  return (id)logCategory__hmf_once_v3_165865;
}
...
void __24__HMDAction_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_165865;
  logCategory__hmf_once_v3_165865 = v0;
