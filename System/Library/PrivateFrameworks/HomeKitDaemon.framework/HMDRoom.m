...
- (id)dumpState
{
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v11, *MEMORY[0x24BE3EA58]);
...
- (void)_handleRenameRequest:(id)a3
{
  ...
  if (objc_msgSend(v5, "length") <= v6)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2112;
      v30 = v11;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@New name does not conform to the HomeKit naming standard: %@", (uint8_t *)&v27, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@New name is longer than the pre-defined max length", (uint8_t *)&v27, 0xCu);
  ...
  if (!v14)
  {
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v39 = 2112;
      v40 = &unk_24E96BC90;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot update name for the default room %@, %@, errorCode: %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v15);
    objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD5BD8], 29, 0);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_18:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v19;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Always return success for transaction update during replay and lookup", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_140450 != -1)
    dispatch_once(&logCategory__hmf_once_t12_140450, &__block_literal_global_140451);
  return (id)logCategory__hmf_once_v13_140452;
}
...
void __22__HMDRoom_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_140452;
  logCategory__hmf_once_v13_140452 = v0;
...
- (NSDictionary)assistantObject
{
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v57 = 2112;
    v58 = v3;
    _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping because one of the properties of room is nil: name %@  home %@", buf, 0x20u);
