...
- (void)associateToHome:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v60 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Starting association", buf, 0xCu);
    ...
    if (v16)
    {
      ...
      if ((objc_msgSend(v17, "isCurrentUser") & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v60 = v32;
          _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Only the owner of the home can perform association", buf, 0xCu);
      ...
      if (v42)
      {
        v18 = objc_msgSend(MEMORY[0x24BDB25E0], "shouldRestrictConnectionWithUserPrivilege:", objc_msgSend(v6, "minimumMediaUserPrivilege"));
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v61 = 2112;
        v62 = v17;
        _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_DEFAULT, "%{public}@Missing authorized peer for user: %@", buf, 0x16u);
...
LABEL_33:
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v60 = v28;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Missing output device", buf, 0xCu);
...
LABEL_34:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v60 = v24;
    _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Missing advertisement", buf, 0xCu);
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v71 = 2112;
      v72 = v9;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to update configuration while associating to home with error: %@, %@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v19);
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 54, CFSTR("Communication failure"), CFSTR("Failed to set administration password."), 0, v10);
    v23 = objc_claimAutoreleasedReturnValue();
    goto LABEL_16;
  }
...
LABEL_14:
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_DEFAULT, v28, buf, 0xCu);
...
LABEL_16:
  ...
  if (v13 && v14)
  {
    v15 = objc_alloc(MEMORY[0x24BE3F228]);
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F230]), "initWithPairingKeyData:", v14);
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 48, CFSTR("Not supported."), CFSTR("Accessory missing pairing identity"), 0);
    ...
    if ((v32 & 1) != 0)
    {
      ...
      if (v34 < 2)
      {
        ...
        if ((v54 & 1) != 0)
        {
          ...
          v55 = (void *)MEMORY[0x227676638](objc_msgSend(v52, "setAssociated:", 1));
          v56 = WeakRetained;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v68 = v58;
            _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_INFO, "%{public}@Successfully associated", buf, 0xCu);
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v68 = v62;
          _os_log_impl(&dword_2218F0000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to set media password", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v69 = 2112;
          v70 = v39;
          _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Unexpected peers found: %@", buf, 0x16u);
...
LABEL_42:
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v68 = v51;
      _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to add ourselves as a peer", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v68 = v45;
      _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid or missing pairing identity", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t20 != -1)
    dispatch_once(&logCategory__hmf_once_t20, &__block_literal_global_52337);
