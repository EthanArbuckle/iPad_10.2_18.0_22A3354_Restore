...
- (id)toMessagePayload
{
  ...
  v21[0] = v5;
  v20[1] = CFSTR("rip");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDPrimaryElectionMeshInformation reachableIPAccessories](self, "reachableIPAccessories"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v21[1] = v6;
  v20[2] = CFSTR("res");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDPrimaryElectionMeshInformation residentsInMesh](self, "residentsInMesh"));
...
+ (id)meshInformationWithMeshController:(id)a3 home:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "na_firstObjectPassingTest:", &__block_literal_global_152692);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v9)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to find responder, not creating mesh information", (uint8_t *)&buf, 0xCu);
      ...
      if (!v11)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v52 = 2114;
          v53 = v31;
          _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to find leader identifier: %{public}@", buf, 0x16u);
      ...
      if (!v13)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v52 = 2114;
          v53 = v14;
          _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Unable to find leader identifier: %{public}@", buf, 0x16u);
...
LABEL_18:
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, v22, buf, 0x16u);
...
LABEL_25:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v52 = 2114;
    v53 = v9;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Unable to find responder identifier: %{public}@", buf, 0x16u);
