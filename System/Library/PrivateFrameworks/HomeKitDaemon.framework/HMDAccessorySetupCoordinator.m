...
LABEL_11:
  ...
  if (v16)
  {
    ...
    v17->_urlStringCHIPAccessorySetupPayloadFactory = &__block_literal_global_201605;
    ...
    v17->_decimalStringRepresentationCHIPAccessorySetupPayloadFactory = &__block_literal_global_45_201606;

    payloadCHIPAccessorySetupPayloadFactory = v17->_payloadCHIPAccessorySetupPayloadFactory;
    v17->_payloadCHIPAccessorySetupPayloadFactory = &__block_literal_global_47_201607;
...
- (id)createCHIPSetupAccessoryPayloadWithSetupPayloadURL:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v10;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload URL string: %@", (uint8_t *)&v19, 0x16u);
...
- (id)createSetupAccessoryPayloadWithCHIPSetupPayload:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload %@", (uint8_t *)&v17, 0x16u);
...
- (void)startMetricsForThirdPartyPairing
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 138543362;
    v24 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Start metrics for 3rd party pairing", (uint8_t *)&v23, 0xCu);
  ...
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F138]), "initWithName:", CFSTR("CHIP Third Party Pairing"));
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = CFSTR("Start");
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\", (uint8_t *)&v23, 0x20u);
  ...
  v20 = (void *)objc_msgSend(v19, "initWithTag:data:", v17, MEMORY[0x24BDBD1B8]);
...
- (void)stopMetricsForThirdPartyPairingWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Stop metrics for 3rd party pairing, error:%@", (uint8_t *)&v22, 0x16u);
  ...
  if (v10)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = CFSTR("Stop");
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\", (uint8_t *)&v22, 0x20u);
      ...
      v18 = (void *)objc_msgSend(v17, "initWithTag:data:", v16, MEMORY[0x24BDBD1B8]);
...
- (void)handleCreateCHIPSetupAccessoryPayloadMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v32 = 2112;
    v33 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling create CHIP setup accessory payload message payload: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v6);
  objc_msgSend(v4, "URLForKey:", *MEMORY[0x24BDD4F18]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "stringForKey:", *MEMORY[0x24BDD4EE8]);
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v25;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Could not find any setup information in message payload: %@", buf, 0x16u);
...
- (void)handleStageCHIPAccessoryPairingInStepsMessage:(id)a3
{
  ...
  if (v9)
  {
    v95 = objc_msgSend(v4, "BOOLForKey:", *MEMORY[0x24BDD4F20]);
    ...
    v25 = (void **)MEMORY[0x24BE4EEE8];
    v26 = (uint64_t *)MEMORY[0x24BE4EEB8];
    v27 = 0x24BDD1000uLL;
    v28 = (uint64_t *)MEMORY[0x24BE4EEB0];
    if (v24)
    {
      HMFGetLogIdentifier();
      ...
      v102 = *v26;
      v109 = v21;
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v9, "communicationProtocol"));
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      v93 = *v28;
      v30 = *MEMORY[0x24BE4EED8];
      v31 = *MEMORY[0x24BE4EEA8];
      -[HMDAccessorySetupCoordinator currentBundleIdentifier](v22, "currentBundleIdentifier");
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      v33 = *MEMORY[0x24BE4EEE0];
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v9, "requiresMatterCustomCommissioningFlow"));
      ...
      *(_DWORD *)buf = 138546434;
      ...
      v151 = 2112;
      v152 = v34;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x84u);

      v21 = v109;
      v37 = (uint64_t *)MEMORY[0x24BE4EEB8];

      v25 = (void **)MEMORY[0x24BE4EEE8];
    }
    else
    {
      v36 = *MEMORY[0x24BE4EEE0];
      v103 = *MEMORY[0x24BE4EED8];
      v100 = *MEMORY[0x24BE4EEA8];
      v35 = v106;
      v37 = (uint64_t *)MEMORY[0x24BE4EEB8];
    }
    ...
    v39 = objc_alloc(MEMORY[0x24BE4F1D0]);
    v40 = v22;
    v41 = *v25;
    v42 = *v37;
    objc_msgSend(*(id *)(v27 + 1760), "numberWithInteger:", objc_msgSend(v9, "communicationProtocol"));
    v43 = (void *)objc_claimAutoreleasedReturnValue();
    v110 = v9;
    v44 = *MEMORY[0x24BE4EEB0];
    v97 = v40;
    -[HMDAccessorySetupCoordinator currentBundleIdentifier](v40, "currentBundleIdentifier");
    v45 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(v27 + 1760), "numberWithBool:", objc_msgSend(v110, "requiresMatterCustomCommissioningFlow"));
    ...
    if (v50)
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
      {
        ...
        v56 = *MEMORY[0x24BE4EF18];
        objc_msgSend(v52, "vendorID");
        v90 = (void *)objc_claimAutoreleasedReturnValue();
        v57 = *MEMORY[0x24BE4EF08];
        v92 = v53;
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v52, "supportsSoftAP"));
        v58 = (void *)objc_claimAutoreleasedReturnValue();
        v59 = *MEMORY[0x24BE4EEC8];
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v52, "hasShortDiscriminator"));
        ...
        *(_DWORD *)buf = 138545410;
        ...
        v143 = 2112;
        v144 = v60;
        _os_log_impl(&dword_2218F0000, v55, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x5Cu);

        v53 = v92;
      }
      else
      {
        v98 = *MEMORY[0x24BE4EF18];
        v94 = *MEMORY[0x24BE4EF08];
        v59 = *MEMORY[0x24BE4EEC8];
        v61 = v104;
      }
      ...
      if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v131 = 2112;
        v132 = v83;
        _os_log_impl(&dword_2218F0000, v81, OS_LOG_TYPE_INFO, "%{public}@Handling stage CHIP accessory pairing in steps message with setup payload: %@, request UUID: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v129 = 2112;
        v130 = v110;
        _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory setup payload on setup accessory payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v129 = 2112;
      v130 = v17;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Could not find setup accessory payload in message payload: %@", buf, 0x16u);
...
- (void)handleConfirmDeviceCredentialMessage:(id)a3
{
  ...
  objc_msgSend(v4, "uuidForKey:", *MEMORY[0x24BDD4F28]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v42 = 2112;
      v43 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling confirm device credential message with staging request UUID: %@", (uint8_t *)&v40, 0x16u);
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v42 = 2112;
          v43 = v19;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to confirm device credential message with queued pairing error: %@", (uint8_t *)&v40, 0x16u);
...
LABEL_9:
      ...
      if (!v29)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          v42 = 2112;
          v43 = v6;
          _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@No pending confirm device credential completion handler exists for staging request UUID: %@", (uint8_t *)&v40, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v42 = 2112;
        v43 = v6;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for confirm device credential message with staging request UUID: %@", (uint8_t *)&v40, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v42 = 2112;
      v43 = v23;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in confirm device credential message payload: %@", (uint8_t *)&v40, 0x16u);
...
- (void)handleRejectDeviceCredentialMessage:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v45 = 2112;
      v46 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling reject device credential message with staging request UUID: %@", (uint8_t *)&v43, 0x16u);
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v45 = 2112;
          v46 = v19;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to reject device credential message with queued pairing error: %@", (uint8_t *)&v43, 0x16u);
...
LABEL_21:
          _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, v35, (uint8_t *)&v43, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v45 = 2112;
        v46 = v6;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for reject device credential message with staging request UUID: %@", (uint8_t *)&v43, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v45 = 2112;
      v46 = v23;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in reject device credential message payload: %@", (uint8_t *)&v43, 0x16u);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v6;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling select Thread network message for request UUID: %@", buf, 0x16u);
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2112;
        v47 = v6;
        _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for select Thread network message with staging request UUID: %@", buf, 0x16u);
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2112;
        v47 = v21;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Responding to select Thread network message with queued pairing error: %@", buf, 0x16u);
...
LABEL_25:
    ...
    _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, v41, buf, 0x16u);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v46 = 2112;
    v47 = v28;
    _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in select-thread-network message payload: %@", buf, 0x16u);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v6;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling select wifi network message for request UUID: %@", buf, 0x16u);
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2112;
        v47 = v6;
        _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for select wifi network message with staging request UUID: %@", buf, 0x16u);
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2112;
        v47 = v21;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Responding to select wifi network message with queued pairing error: %@", buf, 0x16u);
...
LABEL_25:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v46 = 2112;
    v47 = v28;
    _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in select-wifi-network message payload: %@", buf, 0x16u);
...
- (void)handleCancelStagingMessage:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 2112;
      v40 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling cancel staging message with staging request UUID: %@", (uint8_t *)&v37, 0x16u);
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v39 = 2112;
          v40 = v19;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to cancel staging message with success in presence of queued pairing error: %@", (uint8_t *)&v37, 0x16u);
      ...
      else
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            v39 = 2112;
            v40 = v6;
            _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Staging request UUID: %@ is not ready to cancel yet", (uint8_t *)&v37, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        v39 = 2112;
        v40 = v6;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for cancel staging message with staging request UUID: %@", (uint8_t *)&v37, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v39 = 2112;
      v40 = v22;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in cancel staging message payload: %@", (uint8_t *)&v37, 0x16u);
...
- (void)handleCreateCHIPSetupPayloadMessage:(id)a3
{
  ...
  objc_msgSend(v4, "stringForKey:", *MEMORY[0x24BDD4EE0]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    ...
    if (v8)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD5C70]);
              ...
              (v14 & 1) == 0))
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v59 = v18;
            _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Starting metrics collection for 3rd party pairing via locker", buf, 0xCu);
          ...
          v24 = (uint64_t *)MEMORY[0x24BE4EEA8];
          if (v23)
          {
            HMFGetLogIdentifier();
            v53 = v20;
            v25 = (void *)objc_claimAutoreleasedReturnValue();
            v26 = (void *)*MEMORY[0x24BE4EEE8];
            v27 = *v24;
            ...
            *(_DWORD *)buf = 138544386;
            ...
            v66 = 2112;
            v67 = v28;
            _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\", buf, 0x34u);
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v60 = 2112;
        v61 = v8;
        _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_INFO, "%{public}@Opening pairing window with PIN on CHIP accessory server: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v60 = 2112;
        v61 = v6;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory server with identifier: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v60 = 2112;
      v61 = v34;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory pairing identifier in message payload: %@", buf, 0x16u);
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v20 = 2112;
      v21 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Discarding staged accessory server with identifier: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v20 = 2112;
      v21 = v14;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory pairing identifier in message payload: %@", buf, 0x16u);
...
- (id)_createCHIPSetupAccessoryPayloadWithSetupPayloadDecimalStringRepresentation:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from decimal string representation: %@", (uint8_t *)&v17, 0x16u);
...
- (id)_setupPayloadWithCHIPSetupPayload:(id)a3 setupPayloadURL:(id)a4
{
  ...
  if (!v6)
    _HMFPreconditionFailure();
  v8 = v7;
  v9 = objc_alloc(MEMORY[0x24BDD7868]);
  ...
  v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7500]), "initWithCHIPSetupPayload:", v6);
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    v38 = v12;
    _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@Created CHIP setup accessory payload: %@", buf, 0x16u);
...
- (void)_handleStagedPairingDeviceCredential:(id)a3 completionHandler:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v40 = 2112;
    v41 = v19;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling device credential %@ for request UUID: %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v15);
  objc_msgSend(v12, "UUID", *MEMORY[0x24BDD4F28]);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v35[0] = v20;
  v34[1] = *MEMORY[0x24BDD4EF0];
  encodeRootObject();
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v35[1] = v21;
  ...
  if (v23)
  {
    ...
    v25 = (void *)MEMORY[0x227676638](objc_msgSend(v12, "setPendingRequestMessage:", 0));
    v26 = v16;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\", buf, 0x20u);
    ...
    v32 = (void *)objc_msgSend(v31, "initWithTag:data:", v29, MEMORY[0x24BDBD1B8]);
...
- (void)_handleStagedPairingWiFiNetworkScanResults:(id)a3 completionHandler:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v41 = 2112;
    v42 = v19;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling WiFi scan results %@ for request UUID: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (!v21)
    {
      if (v10)
      {
        v35[0] = *MEMORY[0x24BDD4F28];
        objc_msgSend(v12, "UUID");
        v27 = (void *)objc_claimAutoreleasedReturnValue();
        v36[0] = v27;
        v35[1] = *MEMORY[0x24BDD4F48];
        encodeRootObject();
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        v36[1] = v28;
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2112;
    v40 = v26;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received WiFi scan results for request UUID: %@", buf, 0x16u);
...
- (void)_handleStagedPairingThreadNetworkScanResults:(id)a3 completionHandler:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v54 = 2112;
    v55 = v19;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling Thread scan results %@ for request UUID: %@", buf, 0x20u);
...
LABEL_6:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v52 = 2112;
      v53 = v26;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received Thread scan results for request UUID: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\", buf, 0x20u);
    ...
    objc_msgSend(MEMORY[0x24BE4F1C0], "sharedInstance");
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    v34 = objc_alloc(MEMORY[0x24BE4F1D0]);
    v35 = (void *)objc_msgSend(v34, "initWithTag:data:", v32, MEMORY[0x24BDBD1B8]);
    objc_msgSend(v13, "tagProcessorList");
    v36 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v41 = (void *)MEMORY[0x227676638](objc_msgSend(v12, "setPendingRequestMessage:", 0));
  v42 = v16;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\", buf, 0x20u);
  ...
  objc_msgSend(MEMORY[0x24BE4F1C0], "sharedInstance");
  v35 = (void *)objc_claimAutoreleasedReturnValue();
  v46 = objc_alloc(MEMORY[0x24BE4F1D0]);
  v36 = (void *)objc_msgSend(v46, "initWithTag:data:", v45, MEMORY[0x24BDBD1B8]);
  objc_msgSend(v13, "tagProcessorList");
  v47 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleStagedPairingReadyToCancel:(id)a3 forRequest:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v13;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Handling ready to cancel for request UUID: %@", (uint8_t *)&v25, 0x16u);
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 138543362;
      v26 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to a pending Cancel message", (uint8_t *)&v25, 0xCu);
...
- (void)_handleStagedPairingProgressState:(int64_t)a3 forRequest:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v29 = 2112;
    v30 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling progress state (%ld) for request UUID: %@", buf, 0x20u);
  ...
  if ((unint64_t)(a3 - 1) > 0x25)
    ...
    v13 = qword_2226A0850[a3 - 1];
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", v13);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "UUID", *MEMORY[0x24BDD4F28]);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v23[1] = *MEMORY[0x24BDD4F08];
  v24[0] = v15;
  v24[1] = v14;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v24, v23, 2);
  v16 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(MEMORY[0x24BE3F1D0], "entitledMessageWithName:messagePayload:", *MEMORY[0x24BDD4F70], v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleStagedPairingServer:(id)a3 error:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v99 = 2112;
    v100 = v20;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Handling staged pairing identifier %@ and error %@ for request UUID: %@", buf, 0x2Au);
        ...
        v21))
  {
    ...
    if (v22)
    {
      ...
      v27 = (void **)MEMORY[0x24BE4EED0];
      if (v26)
      {
        HMFGetLogIdentifier();
        v83 = v23;
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        v29 = (__CFString *)*MEMORY[0x24BE4EEE8];
        v30 = v12;
        v31 = v11;
        v32 = *v27;
        objc_msgSend(v10, "productID");
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v101 = 2112;
        v102 = v33;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\", buf, 0x34u);
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v97 = 2112;
        v98 = v56;
        _os_log_impl(&dword_2218F0000, v54, OS_LOG_TYPE_INFO, "%{public}@Successfully staged CHIP accessory server with identifier %@ in multiple steps for request UUID: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v97 = 2112;
      v98 = v59;
      _os_log_impl(&dword_2218F0000, v62, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage CHIP accessory pairing for request UUID %@: %@", buf, 0x20u);
    ...
    if (!v65)
    {
      if (v69)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v97 = 2112;
        v98 = v80;
        _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_INFO, "%{public}@Queueing staging error %@ for request UUID: %@", buf, 0x20u);
    ...
    if (v69)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v97 = 2112;
      v98 = v59;
      _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_INFO, "%{public}@Responding for request UUID %@ with error: %@", buf, 0x20u);
    ...
    v74 = v73;
    if (v73 == (void *)*MEMORY[0x24BDD5BD8])
    {
...
LABEL_40:
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v95 = 2112;
    v96 = v42;
    _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received staged pairing identifier for request UUID: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
  {
    HMFGetLogIdentifier();
    v46 = (void *)objc_claimAutoreleasedReturnValue();
    v47 = (__CFString *)*MEMORY[0x24BE4EEF0];
    *(_DWORD *)buf = 138543874;
    v94 = v46;
    v95 = 2114;
    v96 = v47;
    ...
    _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\", buf, 0x20u);
  ...
  v76 = objc_alloc(MEMORY[0x24BE4F1D0]);
  v77 = (void *)objc_msgSend(v76, "initWithTag:data:", v47, MEMORY[0x24BDBD1B8]);
  objc_msgSend(v13, "tagProcessorList");
  v78 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)logIdentifier
{
  ...
  objc_msgSend(MEMORY[0x24BDD7450], "UUID");
...
{
  return (NSUUID *)objc_msgSend(MEMORY[0x24BDD7450], "UUID");
}
    ...
    if (v7)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v60 = 2112;
        v61 = v14;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Passing back pairing UUID %@ for staged pairing identifier: %@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v8);
      objc_msgSend(a1[5], "pendingRequestMessage");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v66[0] = *MEMORY[0x24BDD4F28];
      objc_msgSend(a1[5], "UUID");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      v17 = *MEMORY[0x24BDD4EE0];
      v18 = a1[7];
      v67[0] = v16;
      v67[1] = v18;
      v19 = *MEMORY[0x24BDD4EF8];
      v66[1] = v17;
      v66[2] = v19;
      objc_msgSend(v7, "uuid");
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v25 = objc_claimAutoreleasedReturnValue();
      v26 = os_log_type_enabled(v25, OS_LOG_TYPE_INFO);
      v27 = (uint64_t *)MEMORY[0x24BE4EE98];
      if (v26)
      {
        HMFGetLogIdentifier();
        v51 = v23;
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        v29 = (void *)*MEMORY[0x24BE4EE90];
        v30 = v27;
        v31 = v5;
        v32 = v7;
        v33 = v6;
      ...
      if (v47)
      {
        v54 = *MEMORY[0x24BE4EE98];
        objc_msgSend(a1[8], "softwareVersionString");
        v25 = objc_claimAutoreleasedReturnValue();
        v55 = v25;
        objc_msgSend(*(id *)(v21 + 3696), "dictionaryWithObjects:forKeys:count:", &v55, &v54, 1);
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v60 = 2112;
        v61 = v5;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Could not find system commissioner pairing for newly staged server with identifier %@ in all pairings: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v58 = 2112;
      v59 = v6;
      _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@System commissioner failed to fetch pairings: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v36);
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 2, 0, 0, 0, v6);
    v40 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(a1[5], "pendingRequestMessage");
    v41 = (void *)objc_claimAutoreleasedReturnValue();
...
void __78__HMDAccessorySetupCoordinator_handleCancelStagedCHIPAccessoryPairingMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to discard staged accessory server: %@", (uint8_t *)&v10, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to open pairing window with PIN: %@", buf, 0x16u);
...
id __110__HMDAccessorySetupCoordinator_initWithWorkQueue_messageDispatcher_chipAccessoryServerBrowser_chipDataSource___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x24BE4EF50];
  v3 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t75_201617 != -1)
    dispatch_once(&logCategory__hmf_once_t75_201617, &__block_literal_global_138);
  return (id)logCategory__hmf_once_v76_201618;
}
...
void __43__HMDAccessorySetupCoordinator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v76_201618;
  logCategory__hmf_once_v76_201618 = v0;
