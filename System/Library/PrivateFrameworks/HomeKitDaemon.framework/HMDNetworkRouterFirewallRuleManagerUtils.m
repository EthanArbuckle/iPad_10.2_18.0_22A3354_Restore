...
+ (id)dumpTLVsFromJSONData:(id)a3 error:(id *)a4
{
  ...
  if (v46)
  {
    ...
    v56 = &v55;
    v57 = 0x3032000000;
    v58 = __Block_byref_object_copy__150169;
    v59 = __Block_byref_object_dispose__150170;
    v60 = 0;
...
LABEL_43:
    ...
    else
    {
      if (!objc_msgSend(v44, "hmf_isEmpty"))
      {
        if ((unint64_t)objc_msgSend(v44, "count") >= 2)
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v70 = 2048;
            v71 = v14;
            _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Multiple declarations (%lu) found, choosing the first", buf, 0x16u);
        ...
        if (objc_msgSend(v38, "hmf_isEmpty"))
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v69 = v17;
            _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@No rule configurations were found", buf, 0xCu);
        ...
        {
          objc_msgSend(MEMORY[0x24BDBCED8], "dictionaryWithCapacity:", objc_msgSend(v38, "count"));
          ...
          objc_msgSend(MEMORY[0x24BDD1608], "dataWithJSONObject:options:error:", v35, 3, a4);
...
LABEL_40:
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v69 = v10;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@No network declarations were found", buf, 0xCu);
  ...
  if (v9)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v14;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid declarations found", (uint8_t *)&v18, 0xCu);
