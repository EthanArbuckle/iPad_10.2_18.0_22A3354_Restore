...
- (HMDAppleMediaProfile)initWithAccessory:(id)a3 uniqueIdentifier:(id)a4 services:(id)a5 workQueue:(id)a6
{
  ...
  if (v11 && objc_msgSend(v10, "isCurrentAccessory"))
  {
    ...
    objc_msgSend(MEMORY[0x24BE64D70], "deviceActivePlayerPath");
...
- (void)setMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting media system %@ on profile %@", (uint8_t *)&v10, 0x20u);
  ...
  if (!-[HMDMediaProfile _updatePlayback:](&v23, sel__updatePlayback_, v4))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@No local session for mediaProfile - attempting to redispatch the command to resident/device", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v6);
    v10 = *MEMORY[0x24BDD66E0];
...
- (BOOL)_updateRefreshPlayback:(id)a3
{
  ...
  if (!-[HMDMediaProfile _updateRefreshPlayback:](&v29, sel__updateRefreshPlayback_, v4))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@No local session for mediaProfile - attempting to redispatch the command to resident/device", buf, 0xCu);
    ...
    if (v9)
    {
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "arrayForKey:", *MEMORY[0x24BDD66F0]);
      v26 = 0u;
      v27 = 0u;
      v24 = 0u;
      v25 = 0u;
    ...
    if ((-[__CFString isDeviceReachable](v12, "isDeviceReachable") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v58 = 2112;
        v59 = v12;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Attempting to send message: %@ to unreachable accessory: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v58 = 2112;
          v59 = v49;
          _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@Sending remote message to device (%@) for set value execution with request property %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = v19;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@The value %@ passed in is either nil or non NSNumber", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = v12;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@The device of Media Accessory %@ is not found", buf, 0x16u);
...
- (void)sessionAudioControlUpdated:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Media profile is part of a media system - passing on handling the audio control  update notification for session", buf, 0xCu);
...
- (void)didFinishLoadingRequestForController:(id)a3
{
  ...
  if (v4)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setObject:forKeyedSubscript:", v9, *MEMORY[0x24BDD6750]);

    objc_msgSend(v7, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("force-notify"));
    v10 = objc_msgSend(v6, "state");
    if (v10 > 6)
      v11 = 3;
    else
      v11 = qword_2226A1210[v10];
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", v11);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setObject:forKeyedSubscript:", v12, *MEMORY[0x24BDD66E0]);
    ...
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setObject:forKeyedSubscript:", v17, *MEMORY[0x24BDD6738]);
    ...
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setObject:forKeyedSubscript:", v22, *MEMORY[0x24BDD6708]);

    objc_msgSend(v6, "tracklist");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v23, "uniqueIdentifier");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setObject:forKeyedSubscript:", v24, *MEMORY[0x24BDD66C8]);

    objc_msgSend(v4, "state");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v25, "volume");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setObject:forKeyedSubscript:", v26, *MEMORY[0x24BDD6758]);
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138545154;
      ...
      v59 = 2112;
      v60 = v7;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@didFinishLoadingRequestForController called for mediaSession:%@ pb:%tu s:%tu r:%tu v:%@ m:%@ userInfo:%@", buf, 0x52u);
...
- (void)didUpdateSleepWakeState:(unint64_t)a3
{
  ...
  if (v5)
  {
    ...
    v54[0] = *MEMORY[0x24BDD6750];
    objc_msgSend(v5, "uuid");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "UUIDString");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v54[1] = CFSTR("force-notify");
    v55[0] = v9;
    v55[1] = MEMORY[0x24BDBD1C8];
    ...
    if (a3)
    {
      ...
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v11, "setValue:forKey:", v12, *MEMORY[0x24BDD6748]);

    }
    v13 = (void *)objc_msgSend(v11, "copy");
    -[HMDMediaProfile handleSessionUpdatedNotification:](self, "handleSessionUpdatedNotification:", v13);
    ...
    {
      v47 = v11;
      v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD73E0]), "initWithSleepWakeState:", a3);
      ...
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      v23 = objc_msgSend(v20, "initWithSource:cachePolicy:combineType:timestamp:", v22, 2, 2, v19);

      v24 = objc_alloc(MEMORY[0x24BE4ED80]);
      v46 = v17;
      objc_msgSend(v17, "protoData");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      v45 = (void *)v23;
      v26 = (void *)objc_msgSend(v24, "initWithEventData:metadata:", v25, v23);

      v27 = (void *)MEMORY[0x24BDD73A0];
      v28 = *MEMORY[0x24BDD4BC8];
      objc_msgSend(v14, "uuid");
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v27, "topicFromSuffixID:homeUUID:accessoryUUID:", v28, v16, v29);
      v30 = (void *)objc_claimAutoreleasedReturnValue();

      -[HMDMediaProfile eventForwarder](self, "eventForwarder");
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v31, "forwardEvent:topic:completion:", v26, v30, 0);
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v52 = 2048;
        v53 = a3;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@didUpdateSleepWakeState called for mediaSession: %@ sw:%tu", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v50 = 2112;
        v51 = v14;
        _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@Unable to post sleep wake state event for accessory without home: %@", buf, 0x16u);
