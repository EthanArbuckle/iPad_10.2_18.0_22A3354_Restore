...
LABEL_16:
  ...
  if (v11)
  {
    -[HMDPowerLogObserver _handleHH2CloudKitOperationEvent:](self, "_handleHH2CloudKitOperationEvent:", v11);
    goto LABEL_16;
  }
LABEL_17:
...
- (void)_reportConfiguration:(id)a3
{
  ...
  objc_msgSend(v29, "setObject:forKeyedSubscript:", CFSTR("HomeKit Home Configuration"), *MEMORY[0x24BE3EC28]);
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v5, "isResidentEnabled"));
  ...
  objc_msgSend(v29, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("isCurrentDeviceHH2Enabled"));
  -[HMDPowerLogObserver context](self, "context");
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "powerLogger");
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = *MEMORY[0x24BE3EC38];
...
- (void)_reportCameraSettingsConfiguration:(id)a3
{
  ...
  objc_msgSend(v40, "setObject:forKeyedSubscript:", CFSTR("HomeKit Camera Configuration"), *MEMORY[0x24BE3EC28]);
...
- (void)_handleHH2CloudKitOperationEvent:(id)a3
{
  ...
  if (objc_msgSend(a3, "operationType") == 1)
  {
    -[HMDPowerLogObserver context](self, "context");
    v5 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "powerLogger");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "reportIncomingCloudPush:", CFSTR("HH2 CloudKit Import"));
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v10, 0xCu);
...
+ (id)supportedEventClasses
{
  if (supportedEventClasses_onceToken != -1)
    dispatch_once(&supportedEventClasses_onceToken, &__block_literal_global_41163);
