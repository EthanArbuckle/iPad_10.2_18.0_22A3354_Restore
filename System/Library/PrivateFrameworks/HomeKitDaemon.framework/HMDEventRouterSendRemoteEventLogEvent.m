...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDEventRouterSendRemoteEventLogEvent sourceDeviceType](self, "sourceDeviceType"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v11[1] = v4;
  v10[2] = CFSTR("destinationDeviceType");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDEventRouterSendRemoteEventLogEvent destinationDeviceType](self, "destinationDeviceType"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v11[2] = v5;
  v10[3] = CFSTR("isCachedEvent");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDEventRouterSendRemoteEventLogEvent isCachedEvent](self, "isCachedEvent"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v11[3] = v6;
  v10[4] = CFSTR("responseMessageType");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDEventRouterSendRemoteEventLogEvent responseMessageType](self, "responseMessageType"));
