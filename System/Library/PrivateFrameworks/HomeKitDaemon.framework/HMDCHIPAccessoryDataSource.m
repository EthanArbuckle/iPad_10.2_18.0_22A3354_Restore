    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v29 = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", buf, 0xCu);
...
LABEL_13:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v21;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Accessory reference is nil", buf, 0xCu);
...
- (void)updateNodeID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model node ID to %@", buf, 0x16u);
...
- (void)updateVendorID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model vendor ID to %@", buf, 0x16u);
...
- (void)updateProductID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model product ID to %@", buf, 0x16u);
...
- (void)updateVendorID:(id)a3 productID:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v24 = 2112;
    v25 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@updateVendorID:productID: Updating accessory model vendor ID to %@, product ID to %@", buf, 0x20u);
...
- (void)updateAttributeDatabase:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model attribute database to %@", buf, 0x16u);
...
- (NSSet)pairings
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "na_map:", &__block_literal_global_70682);
...
- (void)updatePairings:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model pairings to %@", buf, 0x16u);
...
- (void)updateExtendedMACAddress:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model extended MAC address to %@", buf, 0x16u);
...
- (void)updateWedSupport:(BOOL)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v11;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model wed support to %@", buf, 0x16u);
...
- (void)updateSoftwareVersionNumber:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model software version to %@", buf, 0x16u);
...
- (void)updateSupportedLinkLayerTypes:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory model link layer types to %@", buf, 0x16u);
...
void __56__HMDCHIPAccessoryDataSource_updatePairings_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = *(void **)(a1 + 32);
  v3 = a2;
  objc_msgSend(v2, "na_map:", &__block_literal_global_26_70679);
...
id __56__HMDCHIPAccessoryDataSource_updatePairings_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x24BDD74F8];
  v3 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_70711 != -1)
    dispatch_once(&logCategory__hmf_once_t15_70711, &__block_literal_global_41_70712);
  return (id)logCategory__hmf_once_v16_70713;
}
...
void __41__HMDCHIPAccessoryDataSource_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v16_70713;
  logCategory__hmf_once_v16_70713 = v0;
