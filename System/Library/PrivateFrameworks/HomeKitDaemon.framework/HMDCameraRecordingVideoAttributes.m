...
- (HMDCameraRecordingVideoAttributes)initWithResolution:(int64_t)a3 frameRate:(id)a4
{
  ...
  if (v8)
  {
    ...
    {
      v11 = (NSNumber *)qword_24E78E548[v10];
      v12 = (NSNumber *)qword_24E78E5D0[v10];
    }
...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 1, CFSTR("kVideoAttributesImageWidth"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 2, CFSTR("kVideoAttributesImageHeight"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 3, CFSTR("kVideoAttributesFrameRate"));
