...
- (HMDSetting)initWithModel:(id)a3
{
  ...
  v11 = -[HMDSetting initWithIdentifier:parentIdentifier:name:properties:type:value:constraints:](self, "initWithIdentifier:parentIdentifier:name:properties:type:value:constraints:", v6, v7, v8, v9, v10, v5, MEMORY[0x24BDBD1A8]);
  return v11;
}
...
- (BOOL)updateWithSettingValue:(id)a3
{
  ...
  if (!-[HMDSetting isValidValue:error:](self, "isValidValue:error:", v4, 0))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v4;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Received value is not valid %@", (uint8_t *)&v17, 0x16u);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating setting %@ in transaction from %@ to %@", (uint8_t *)&v17, 0x2Au);
...
- (BOOL)isValidValue:(id)a3 error:(id *)a4
{
  ...
  switch(v10)
  {
    case 1:
      ...
      v15 = v7;
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v8, "type"));
...
LABEL_61:
          _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, v17, v105, 0x16u);
    ...
    case 5:
      ...
      if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v105 = 138543362;
        v106 = v58;
        _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_INFO, "%{public}@Value cannot be used for collection.", v105, 0xCu);
        ...
        case 3:
          ...
          if (v34)
          {
            if (!v22)
            {
              ...
              if (os_log_type_enabled(v71, OS_LOG_TYPE_DEFAULT))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v111 = 2112;
                v112 = v73;
                _os_log_impl(&dword_2218F0000, v71, OS_LOG_TYPE_DEFAULT, "%{public}@Value is nil but have step value constraint: %@", buf, 0x16u);
            ...
            if (v40 > 0.00000011920929)
            {
              ...
              {
                contextb = (void *)MEMORY[0x227676638](v41);
                v100 = v21;
                HMFGetOSLogHandle();
                ...
                if (os_log_type_enabled(v84, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  v115 = 2112;
                  v116 = v26;
                  _os_log_impl(&dword_2218F0000, v84, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, does not conform to step, %@, from current value: %@", buf, 0x2Au);
...
LABEL_44:
              _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_DEFAULT, v52, buf, 0x16u);
...
LABEL_74:
              _os_log_impl(&dword_2218F0000, v66, OS_LOG_TYPE_DEFAULT, v68, buf, 0x20u);
...
LABEL_75:
            ...
            if (v88)
            {
              objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 44);
              v75 = (id)objc_claimAutoreleasedReturnValue();
              v22 = 0;
              goto LABEL_91;
            }
          ...
          if (objc_msgSend(v22, "compare:", v44) == 1)
          {
            ...
            if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v113 = 2112;
              v114 = v44;
              _os_log_impl(&dword_2218F0000, v81, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, more than maximum value: %@", buf, 0x20u);
          ...
          if (objc_msgSend(v22, "compare:", v31) == -1)
          {
            ...
            if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v113 = 2112;
              v114 = v31;
              _os_log_impl(&dword_2218F0000, v76, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, less than minimum value: %@", buf, 0x20u);
        ...
        default:
          ...
          if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v111 = 2112;
            v112 = v22;
            _os_log_impl(&dword_2218F0000, v61, OS_LOG_TYPE_ERROR, "%{public}@Did not understand value %@", buf, 0x16u);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v4, "hmd_isForXPCTransport") & 1) != 0)
  {
    -[HMDSetting identifier](self, "identifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x24BDD4E20]);
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x24BDD4E30]);

    -[HMDSetting name](self, "name");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v8, *MEMORY[0x24BDD4E28]);

    -[HMDSetting constraints](self, "constraints");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v9, *MEMORY[0x24BDD4DF8]);
    ...
    objc_msgSend(v4, "encodeObject:forKey:", v11, *MEMORY[0x24BDD4E60]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Did not encode setting as transport is not XPC.", (uint8_t *)&v16, 0xCu);
  ...
  switch(objc_msgSend(v4, "integerValue"))
  {
    ...
    default:
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        v19 = 2112;
        v20 = v4;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine type of setting value for model %@ of type %@.", (uint8_t *)&v15, 0x20u);
...
LABEL_11:
      v12 = 0;
LABEL_12:
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7988]), "initWithType:stringValue:numberValue:dataValue:selectionIdentifier:selectionValue:", objc_msgSend(v4, "integerValue"), v12, v11, v5, v7, v6);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7 != -1)
    dispatch_once(&logCategory__hmf_once_t7, &__block_literal_global_442);
