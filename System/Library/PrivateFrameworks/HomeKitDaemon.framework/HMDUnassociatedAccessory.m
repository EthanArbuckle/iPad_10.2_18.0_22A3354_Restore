...
- (id)descriptionWithPointer:(BOOL)a3 additionalDescription:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDUnassociatedAccessory isKnownToSystemCommissioner](self, "isKnownToSystemCommissioner"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v20, "stringWithFormat:", CFSTR("<%@%@, UUID = %@, knownToSystemCommissioner = %@, RPK(Hash) = %@, NodeID = %@, Identifier = %@, Name = %@, Category = %@%@>"), v25, v23, v24, v7, v10, v11, v12, v13, v15, &stru_24E79DB48);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (id)dumpDescription
{
  ...
  objc_msgSend(v3, "setObject:forKey:", v9, *MEMORY[0x24BE3EB68]);
  return v3;
}
...
- (void)setCategory:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDD7668], "cachedInstanceForHMAccessoryCategory:", v4);
...
- (void)updateCategoryWithCategoryIdentifier:(id)a3
{
  ...
  if (a3)
  {
    ...
    v6 = objc_alloc(MEMORY[0x24BDD7338]);
...
- (void)_handleIdentify:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Identifying", buf, 0xCu);
...
- (void)identifyWithCompletionHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@The accessory does not support identify", (uint8_t *)&v10, 0xCu);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v20, "encodeInteger:forKey:", v9, *MEMORY[0x24BDD4928]);
  ...
  if (objc_msgSend(v20, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    ...
    objc_msgSend(v20, "encodeBool:forKey:", v10, *MEMORY[0x24BDD5020]);
    v11 = -[HMDUnassociatedAccessory isKnownToSystemCommissioner](self, "isKnownToSystemCommissioner");
    objc_msgSend(v20, "encodeBool:forKey:", v11, *MEMORY[0x24BDD4C40]);
    -[HMDUnassociatedAccessory rootPublicKey](self, "rootPublicKey");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v12, *MEMORY[0x24BDD4DC0]);

    -[HMDUnassociatedAccessory nodeID](self, "nodeID");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v13, *MEMORY[0x24BDD4AD8]);

    -[HMDUnassociatedAccessory commissioningID](self, "commissioningID");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v14, *MEMORY[0x24BDD4AD0]);
    ...
    objc_msgSend(v20, "encodeObject:forKey:", v16, *MEMORY[0x24BDD4D40]);

    -[HMDUnassociatedAccessory vendorID](self, "vendorID");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v17, *MEMORY[0x24BDD5160]);

    v18 = -[HMDUnassociatedAccessory requiresThreadRouter](self, "requiresThreadRouter");
    objc_msgSend(v20, "encodeBool:forKey:", v18, *MEMORY[0x24BDD4DA0]);
    -[HMDUnassociatedAccessory identifier](self, "identifier");
...
void __44__HMDUnassociatedAccessory__handleIdentify___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Identified with error: %@", (uint8_t *)&v11, 0x16u);
...
+ (id)otherAccessoryCategory
{
  ...
  v4 = objc_alloc(MEMORY[0x24BDD7338]);
  ...
  objc_msgSend(MEMORY[0x24BDD7668], "cachedInstanceForHMAccessoryCategory:", v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_162036 != -1)
    dispatch_once(&logCategory__hmf_once_t10_162036, &__block_literal_global_162037);
  return (id)logCategory__hmf_once_v11_162038;
}
...
void __39__HMDUnassociatedAccessory_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_162038;
  logCategory__hmf_once_v11_162038 = v0;
