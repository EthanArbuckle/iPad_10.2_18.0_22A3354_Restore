...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_32437 != -1)
    dispatch_once(&logCategory__hmf_once_t0_32437, &__block_literal_global_32438);
  return (id)logCategory__hmf_once_v1_32439;
}
...
void __41__HMDLostModeManager_Common__logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_32439;
  logCategory__hmf_once_v1_32439 = v0;
...
- (HMDLostModeManager)init
{
  ...
  if (v2)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, v3, (CFNotificationCallback)__HMDLostModeManagerLostModeChangeNotification, (CFStringRef)*MEMORY[0x24BE31CE8], 0, CFNotificationSuspensionBehaviorCoalesce);
    v5 = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(v5, v3, (CFNotificationCallback)__HMDLostModeManagerExitLostModeWithAuthCompleteNotification, (CFStringRef)*MEMORY[0x24BE31CB8], 0, CFNotificationSuspensionBehaviorCoalesce);
...
+ (id)sharedManager
{
  if (sharedManager_onceToken_166512 != -1)
    dispatch_once(&sharedManager_onceToken_166512, &__block_literal_global_166513);
