...
- (HMDSoftwareUpdateDocumentationAsset)initWithDocumentationMetadata:(id)a3
{
  ...
  v8 = -[HMDSoftwareUpdateDocumentationAsset initWithDocumentationMetadata:dateWithTimeIntervalSinceNowFactory:URLSessionFactory:extractorFactory:notificationCenter:fileManager:](self, "initWithDocumentationMetadata:dateWithTimeIntervalSinceNowFactory:URLSessionFactory:extractorFactory:notificationCenter:fileManager:", v5, &__block_literal_global_135_163016, &__block_literal_global_137_163017, &__block_literal_global_140_163018, v6, v7);
...
- (HMSoftwareUpdateDocumentation)documentation
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v21 = 138543362;
    v22 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing documentation", (uint8_t *)&v21, 0xCu);
  ...
  if (v7 == 4)
  {
    ...
    if (!v11 || (v12 = objc_msgSend(objc_alloc(MEMORY[0x24BDD79F0]), "initWithBundle:", v11)) == 0)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 138543362;
        v22 = v16;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to find documentation bundle", (uint8_t *)&v21, 0xCu);

      }
      objc_autoreleasePoolPop(v13);
      v12 = objc_msgSend(objc_alloc(MEMORY[0x24BDD79F0]), "initWithAsset:", v14);
    }
    v17 = (void *)v12;
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v19;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Documentation not cached", (uint8_t *)&v21, 0xCu);
...
- (void)increaseDownloadRetryCount
{
  ...
  if (v4 >= objc_msgSend(&unk_24E971108, "count"))
    v5 = objc_msgSend(&unk_24E971108, "count") - 1;
  else
    v5 = -[HMDSoftwareUpdateDocumentationAsset downloadRetryCount](self, "downloadRetryCount");
  objc_msgSend(&unk_24E971108, "objectAtIndexedSubscript:", v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDSoftwareUpdateDocumentationAsset dateWithTimeIntervalSinceNowFactory](self, "dateWithTimeIntervalSinceNowFactory");
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Increased download retry count to: %lu next retry is at: %@", (uint8_t *)&v15, 0x20u);
...
- (void)resetDownloadRetryCount
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Resetting download retry count", (uint8_t *)&v9, 0xCu);
...
LABEL_16:
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v28 = v16;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive asset metadata (write)", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v28 = v24;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive asset metadata (encode)", buf, 0xCu);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v8;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create asset directory with error: %@", buf, 0x16u);
...
- (BOOL)purgeWithError:(id *)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 138543362;
    v14 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Purging", (uint8_t *)&v13, 0xCu);
...
- (void)URLSession:(id)a3 task:(id)a4 didCompleteWithError:(id)a5
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to download asset with error: %@", (uint8_t *)&v15, 0x16u);
...
- (void)URLSession:(id)a3 downloadTask:(id)a4 didWriteData:(int64_t)a5 totalBytesWritten:(int64_t)a6 totalBytesExpectedToWrite:(int64_t)a7
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2048;
    v21 = (float)(v16 * 100.0);
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Download progress: %.1f%%", (uint8_t *)&v18, 0x16u);
...
- (void)URLSession:(id)a3 downloadTask:(id)a4 didFinishDownloadingToURL:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v51 = 2112;
    v52 = v15;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Finished downloading archived asset to: %@", buf, 0x16u);
  ...
  if (v18 && (objc_msgSend(v18, "statusCode") > 399 || objc_msgSend(v18, "statusCode") <= 199))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v53 = 2112;
      v54 = v18;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to download asset to '%@' due to bad response status: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v53 = 2112;
        v54 = v29;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to move downloaded asset to '%@' with error: %@. Removing existing assets at that path.", buf, 0x20u);
      ...
      if ((v38 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v53 = 2112;
          v54 = v25;
          _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove existing asset at url '%@' with error: %@.", buf, 0x20u);
...
- (void)setExtractionProgress:(double)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2048;
    v12 = a3 * 100.0;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Unarchive progress: %.1f%%", (uint8_t *)&v9, 0x16u);
...
- (void)extractionCompleteAtArchivePath:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Completed unarchiving to path: %@", (uint8_t *)&v9, 0x16u);
...
- (void)extractionEnteredPassThroughMode
{
  ...
  v3 = (void *)MEMORY[0x227676638](-[HMDSoftwareUpdateDocumentationAsset setExtractionEnteredPassThrough:](self, "setExtractionEnteredPassThrough:", 1));
  v4 = self;
  HMFGetOSLogHandle();
  v5 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Unarchive in pass through mode", (uint8_t *)&v7, 0xCu);
...
void __54__HMDSoftwareUpdateDocumentationAsset_finishUnarchive__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v7;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Finishing unarchive", buf, 0xCu);
...
void __54__HMDSoftwareUpdateDocumentationAsset_cancelUnarchive__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling unarchive", buf, 0xCu);
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v10;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Failed to remove bundle with error: %@", buf, 0x16u);
...
void __53__HMDSoftwareUpdateDocumentationAsset_startUnarchive__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v7;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting unarchive", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v3);
    objc_msgSend(*(id *)(a1 + 32), "setState:", 3);
    v8 = (void *)MEMORY[0x24BEB2C98];
    ...
    if (v13)
    {
      ...
      if (v16)
      {
        v17 = (void *)MEMORY[0x227676638](objc_msgSend(*(id *)(a1 + 32), "setArchivedFileStream:", v16));
        v18 = *(id *)(a1 + 32);
        HMFGetOSLogHandle();
        v19 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v44 = 2112;
          v45 = v13;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Starting extraction using options: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v43 = v39;
          _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to create input stream", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v44 = 2112;
        v45 = v35;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_INFO, "%{public}@Failed to create validation options for unarchiving with digest: %@", buf, 0x16u);
  ...
  else
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v29;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to unarchive, asset is not downloaded", buf, 0xCu);
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_finishDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Finished download", (uint8_t *)&v8, 0xCu);
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_cancelDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling download", (uint8_t *)&v8, 0xCu);
...
LABEL_16:
      _os_log_impl(&dword_2218F0000, v7, v8, v6, (uint8_t *)&v33, 0xCu);
...
LABEL_18:
  ...
  if ((v9 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 138543362;
      v34 = v28;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Not attempting to download documentation now as we are in a backoff", (uint8_t *)&v33, 0xCu);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v33 = 138543362;
    v34 = v13;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Starting download", (uint8_t *)&v33, 0xCu);
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v23;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Resuming task: %@", (uint8_t *)&v33, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 138543362;
      v34 = v32;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot download software update from nil url", (uint8_t *)&v33, 0xCu);
...
id __69__HMDSoftwareUpdateDocumentationAsset_initWithDocumentationMetadata___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = (objc_class *)MEMORY[0x24BEB2C98];
  v5 = a3;
  v6 = a2;
...
{
  return objc_msgSend(MEMORY[0x24BDD1850], "sessionWithConfiguration:delegate:delegateQueue:", a2, a3, a4);
}
...
+ (NSURL)assetDirectoryURL
{
  if (assetDirectoryURL_onceToken != -1)
    dispatch_once(&assetDirectoryURL_onceToken, &__block_literal_global_123_163045);
...
+ (id)assetWithURL:(id)a3 fileManager:(id)a4
{
  ...
  if (v6)
  {
    ...
    {
      v36 = 0;
      objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v9, &v36);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = (__CFString *)v36;
      ...
      if (v10)
      {
        ...
        if (v16 != objc_msgSend(v10, "state"))
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
          {
            HMFGetLogIdentifier();
            v32 = (void *)objc_claimAutoreleasedReturnValue();
            v33 = off_24E78B088[v16];
            *(_DWORD *)buf = 138543618;
            v38 = v32;
            v39 = 2112;
            v40 = v33;
            _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Setting state to: %@", buf, 0x16u);
      ...
      {
        v25 = (void *)MEMORY[0x227676638](v12);
        v26 = a1;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v39 = 2112;
          v40 = v11;
          _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive software update documentation asset from serialized object data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v39 = 2112;
        v40 = v21;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to find metadata at path: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t74_163037 != -1)
    dispatch_once(&logCategory__hmf_once_t74_163037, &__block_literal_global_158);
  return (id)logCategory__hmf_once_v75_163038;
}
...
void __50__HMDSoftwareUpdateDocumentationAsset_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v75_163038;
  logCategory__hmf_once_v75_163038 = v0;
...
void __56__HMDSoftwareUpdateDocumentationAsset_assetDirectoryURL__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BE3F158], "defaultCache");
