...
- (void)registerForMessagesWithHome:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD79C8], "messageName");
...
- (void)routeSiriEndpointApplyOnboardingSelectionsRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing siri endpoint apply onboarding selections request message: %@", buf, 0x16u);
...
- (id)intermediateApplyOnboardingSelectionsRequestMessageForMessage:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = objc_alloc(MEMORY[0x24BDD79B8]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory UUID for intermediate apply onboarding selections message handler using message: %@", buf, 0x16u);
...
void __104__HMDSiriEndpointProfilesMessenger_intermediateApplyOnboardingSelectionsRequestMessageForMessage_error___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD79C0]), "initWithPayload:", v6);
    if (v8)
    {
      ...
      v23[0] = v11;
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v8, "onboardingResult"));
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      v23[1] = v12;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v26 = 2112;
        v27 = v6;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response using apply onboarding intermediate response payload: %@", buf, 0x16u);
  ...
  {
    v14 = (void *)MEMORY[0x227676638](v7);
    v15 = a1[5];
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v5;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response payload for apply onboarding intermediate response with error: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_30578 != -1)
    dispatch_once(&logCategory__hmf_once_t4_30578, &__block_literal_global_30579);
  return (id)logCategory__hmf_once_v5_30580;
}
...
void __47__HMDSiriEndpointProfilesMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_30580;
  logCategory__hmf_once_v5_30580 = v0;
