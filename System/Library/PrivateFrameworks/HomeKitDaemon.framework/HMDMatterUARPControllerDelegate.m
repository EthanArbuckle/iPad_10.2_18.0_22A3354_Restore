...
- (void)assetAvailablityUpdateForAccessory:(id)a3 assetID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)&buf[24] = updated;
    ...
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update Available for accessory:%@, status:%s, release notes status:%s", buf, 0x2Au);
    ...
    if (v19)
    {
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          *(_QWORD *)&buf[24] = v28;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Available version %@ is equal or older than current accessory version %@", buf, 0x20u);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)&buf[4] = v18;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update not supported on this device; ignoring",
      buf,
      0xCu);
...
- (BOOL)sendMessageToAccessory:(id)a3 uarpMsg:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v14 = 138543362;
    v15 = v12;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@sendMessageToAccessory: failed. This function should not be called for Matter accessories", (uint8_t *)&v14, 0xCu);
...
- (id)newUploader
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter Accessory Software Update not enabled.", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_170079 != -1)
    dispatch_once(&logCategory__hmf_once_t0_170079, &__block_literal_global_170080);
  return (id)logCategory__hmf_once_v1_170081;
}
...
void __46__HMDMatterUARPControllerDelegate_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_170081;
  logCategory__hmf_once_v1_170081 = v0;
