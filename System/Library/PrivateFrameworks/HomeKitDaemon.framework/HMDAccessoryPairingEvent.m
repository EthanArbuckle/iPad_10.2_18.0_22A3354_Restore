...
- (void)_setBtLoad
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Pairing BT Load: %d AudioTsk: %d NonAudioTsk: %d", (uint8_t *)&v12, 0x1Eu);
      ...
      if (v40 <= 0.0)
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v79 = 2112;
          v80 = v53;
          _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_INFO, "%{public}@Submitting placeholder metric values since same accessory request UUID %@ being paired multiple times before CA event submission", buf, 0x16u);
    ...
    if (v59 != v61)
    {
      ...
      if (os_log_type_enabled(v64, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v81 = 2112;
        v82 = v67;
        _os_log_impl(&dword_2218F0000, v64, OS_LOG_TYPE_ERROR, "%{public}@Unexpected step and error in submitting pairing log event %@ %@", buf, 0x20u);
    ...
    if (v70)
    {
      ...
      if (os_log_type_enabled(v73, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v79 = 2112;
        v80 = v75;
        _os_log_impl(&dword_2218F0000, v73, OS_LOG_TYPE_ERROR, "%{public}@Unexpected error contains underlying error %@", buf, 0x16u);
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDAccessoryPairingEvent certificationStatus](self, "certificationStatus"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("accessoryCertificationStatus"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDAccessoryPairingEvent communicationProtocol](self, "communicationProtocol"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v15, CFSTR("accessoryCommunicationProtocol"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDAccessoryPairingEvent linkType](self, "linkType"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v16, CFSTR("accessoryTransportType"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessoryPairingEvent authMethod](self, "authMethod"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent isAddOperation](self, "isAddOperation"));
  v21 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_9:
  ...
  v29 = 0;
LABEL_12:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDAccessoryPairingEvent retryCount](self, "retryCount"));
  v38 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_13:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent didUseWiFiPPSK](self, "didUseWiFiPPSK"));
  v39 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[HMDAccessoryPairingEvent isAddOperation](self, "isAddOperation"))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent didUseOwnershipProof](self, "didUseOwnershipProof"));
    v46 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v46, CFSTR("isAddedWithWACOwnershipProof"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent isFirstHAPAccessoryInAnyHome](self, "isFirstHAPAccessoryInAnyHome"));
    v47 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v47, CFSTR("firstHAPAccessoryForUser"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent isFirstHAPAccessoryInHome](self, "isFirstHAPAccessoryInHome"));
    v48 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent isNetworkRouterReplace](self, "isNetworkRouterReplace"));
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v49, CFSTR("isNetworkRouterReplace"));

  }
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent isThreadAccessory](self, "isThreadAccessory"));
  v50 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent isBTCommissioned](self, "isBTCommissioned"));
    v51 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v51, CFSTR("threadOnboardIsBTCommissioned"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[HMDAccessoryPairingEvent threadStatus](self, "threadStatus"));
    v52 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v52, CFSTR("threadStatus"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[HMDAccessoryPairingEvent threadCapabilities](self, "threadCapabilities"));
    v53 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent retry](self, "retry"));
  v70 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v70, CFSTR("HMDAccessoryPairingEventRetry"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessoryPairingEvent recoveryType](self, "recoveryType"));
  v71 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v71, CFSTR("HMDAccessoryPairingEventRecoveryType"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessoryPairingEvent previousRecoveryType](self, "previousRecoveryType"));
  v72 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v72, CFSTR("HMDAccessoryPairingEventPreviousRecoveryType"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent isPrimaryResidentOnline](self, "isPrimaryResidentOnline"));
  v73 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v73, CFSTR("isPrimaryResidentOnline"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessoryPairingEvent hasResidentInHome](self, "hasResidentInHome"));
  v74 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v74, CFSTR("hasResidentInHome"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDAccessoryPairingEvent btLoad](self, "btLoad"));
  v75 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v75, CFSTR("btLoad"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDAccessoryPairingEvent btAudioTask](self, "btAudioTask"));
  v76 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v76, CFSTR("btAudioTask"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDAccessoryPairingEvent btNonAudioTask](self, "btNonAudioTask"));
  v77 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v77, CFSTR("btNonAudioTask"));

  if (-[HMDAccessoryPairingEvent _isMatterAccessory](self, "_isMatterAccessory"))
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[HMDAccessoryPairingEvent currentWiFiBand](self, "currentWiFiBand"));
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessoryPairingEvent userPrivilege](self, "userPrivilege"));
    v80 = (void *)objc_claimAutoreleasedReturnValue();
    v81 = CFSTR("userPrivilege");
  }
  else
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessoryPairingEvent pairingUIState](self, "pairingUIState"));
    v80 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_100337 != -1)
    dispatch_once(&logCategory__hmf_once_t15_100337, &__block_literal_global_100338);
  return (id)logCategory__hmf_once_v16_100339;
}
...
void __39__HMDAccessoryPairingEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v16_100339;
  logCategory__hmf_once_v16_100339 = v0;
