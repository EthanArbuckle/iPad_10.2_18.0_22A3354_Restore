...
{
  objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCA98], CFSTR("-init is not a valid initializer for HMDSecureRemoteStream"));
...
LABEL_6:
  ...
  if (initWithType_commitTimeout_clientIdleTimeout_serverIdleTimeout_sendInternalTimeout_sendUserTimeout___hmf_once_t0 != -1)
    dispatch_once(&initWithType_commitTimeout_clientIdleTimeout_serverIdleTimeout_sendInternalTimeout_sendUserTimeout___hmf_once_t0, &__block_literal_global_241958);
  ...
  if (!v24)
    goto LABEL_10;
  objc_storeStrong((id *)&v15->_userQueue, MEMORY[0x24BDAC9B8]);
...
- (void)_start
{
  ...
  if (!self->_started)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v45 = v7;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Starting", buf, 0xCu);
  ...
  if (state == 11 || state == 1)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v45 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Start failed, attempt to restart session", buf, 0xCu);
  ...
  if (!(_DWORD)v14)
  {
    if (!started)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v45 = v41;
        _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_DEBUG, "%{public}@Started", buf, 0xCu);
...
LABEL_13:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", DebugGetErrorString(), *MEMORY[0x24BDD0FC8]);
    v21 = objc_claimAutoreleasedReturnValue();
    v22 = (void *)v21;
    v23 = CFSTR("?");
    if (v21)
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v46 = 2112;
    v47 = v25;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Start failed: %@", buf, 0x16u);
  ...
  if (self->_started)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v76 = 2112;
      v77 = v13;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Stopping: %@", buf, 0x16u);
      if ((_DWORD)v5)
      {
  ...
  if (started)
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v76 = 2112;
      v77 = v52;
      _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_DEBUG, "%{public}@Stopped: %@", buf, 0x16u);
      if ((_DWORD)v5)
      {
...
LABEL_4:
  ...
  if (v7)
  {
    ...
    handler[3] = &unk_24E79C240;
    handler[4] = self;
    dispatch_source_set_event_handler(v7, handler);
    dispatch_source_set_cancel_handler((dispatch_source_t)self->_idleTimer, &__block_literal_global_44_241943);
    v4 = self->_idleTimer;
    goto LABEL_4;
  }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v22;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@idle timer failed: %@", buf, 0x16u);
...
- (void)_sendUserRequest:(id)a3 options:(id)a4 responseHandler:(id)a5
{
  ...
  if (self->_started)
  {
    ...
    v13 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)self->_internalQueue);
    if (v13)
    {
      v14 = v13;
      handler[0] = MEMORY[0x24BDAC760];
      ...
      dispatch_source_set_cancel_handler(v14, &__block_literal_global_45_241940);
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v52 = 2112;
        v53 = v8;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Scheduled user request, utid %@\n%@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v50 = 2112;
    v51 = v36;
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Send user request failed: %@", buf, 0x16u);
...
- (void)_completeUserTransaction:(id)a3 response:(id)a4 options:(id)a5 status:(int)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v57 = 2112;
    v58 = v21;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Completed user request, utid %@, status %@\n%@", buf, 0x2Au);
    if (a6)
    {
...
LABEL_24:
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v55 = 2112;
      v56 = v12;
      _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Missing, utid %@ for response %@", buf, 0x20u);
...
- (void)_sendRequest:(id)a3 options:(id)a4 responseHandler:(id)a5
{
  ...
  v12 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)self->_internalQueue);
  if (v12)
  {
    v13 = v12;
    ...
    handler[3] = &unk_24E79C268;
    handler[4] = self;
    v15 = v11;
    v41 = v15;
    dispatch_source_set_event_handler(v13, handler);

    dispatch_source_set_cancel_handler(v13, &__block_literal_global_57_241936);
    ...
    v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithDictionary:", v33);
    ...
    v22 = (void *)MEMORY[0x227676638](objc_msgSend(v21, "setObject:forKeyedSubscript:", CFSTR("request"), CFSTR("type")));
    v23 = self;
    HMFGetOSLogHandle();
    v24 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v46 = 2112;
      v47 = v21;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Sending request, tid %@\n%@", buf, 0x20u);
  ...
  if (v13)
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v60 = 2112;
      v61 = v26;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Completed request, tid %@, status %@\n%@", buf, 0x2Au);
      if (a6)
      {
  ...
  else
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = v10;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Missing, tid %@", buf, 0x16u);
...
- (void)_transportReceivedMessage:(id)a3 options:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v41 = 2112;
    v42 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Transport received message %@", buf, 0x16u);
  ...
  else if (objc_msgSend(v14, "isEqual:", CFSTR("response")))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v43 = 2112;
      v44 = v6;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Received response, tid %@, %@", buf, 0x20u);
...
LABEL_19:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v43 = 2112;
    v44 = v6;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Transport message error: %@, %@", buf, 0x20u);
      ...
      default:
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v15 = 1024;
          v16 = state;
          _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Bad state: %d", buf, 0x12u);
...
LABEL_10:
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = v17;
      objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v28, &v27, 1, v22);
      v18 = v4;
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v20;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Pair-verify failed: %@", buf, 0x16u);
...
LABEL_17:
  ...
  if (v9)
  {
    ...
    objc_msgSend(MEMORY[0x24BDBCEC8], "dataWithLength:", v11 + 16);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if (v12)
    {
      ...
      while (!v18);
      v19 = (void *)MEMORY[0x227676638](v15);
      v20 = self;
      HMFGetOSLogHandle();
      v21 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v50 = 2112;
        v51 = v8;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Sending prepare request, utid %@ %@", buf, 0x20u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v48 = 2112;
    v49 = v34;
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Send prepare request failed: %@", buf, 0x16u);
...
- (int)_clientHandlePrepareResponse:(id)a3 options:(id)a4
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDBCEC8], "dataWithLength:", v10 - 16);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v11)
    {
      v12 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 138543362;
      v26 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Received prepare response", (uint8_t *)&v25, 0xCu);
...
- (int)_clientSendCommitRequest:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", (double)self->_sendInternalTimeoutNanos / 1000000000.0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v53[0] = CFSTR("op");
    v53[1] = CFSTR("utid");
    v54[0] = CFSTR("commit");
    ...
    if (v8)
    {
      ...
      if (v11)
      {
        ...
        while (!v17);
        v18 = (void *)MEMORY[0x227676638](v14);
        v19 = self;
        HMFGetOSLogHandle();
        v20 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v51 = 2112;
          v52 = v7;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Sending commit request, utid %@ %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v49 = 2112;
    v50 = v34;
    _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Send commit request failed: %@", buf, 0x16u);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v34 = 2112;
    v35 = v16;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Received commit response, utid %@ %@", buf, 0x20u);
  ...
  v27 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v18);
...
LABEL_14:
        ...
        return;
      default:
        v10 = (void *)MEMORY[0x227676638](self, a2);
        v11 = self;
        HMFGetOSLogHandle();
        v12 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v23 = 1024;
          v24 = state;
          _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Bad state: %d", buf, 0x12u);
...
LABEL_8:
  ...
  *((_QWORD *)&v48 + 1) = _pairingCopyIdentity;
  ...
  if ((_DWORD)isKindOfClass)
  {
    ...
    v22 = 0;
LABEL_20:
    v23 = (void *)MEMORY[0x227676638](isKindOfClass);
    v24 = self;
    HMFGetOSLogHandle();
    v25 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      *(_QWORD *)&v48 = v36;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Pair-verify failed: %@, %@", buf, 0x20u);
...
LABEL_9:
  ...
  {
    v45[0] = CFSTR("data");
    objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", v42, v41);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    v46[0] = v15;
    v46[1] = CFSTR("pv");
    v45[1] = CFSTR("op");
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v16;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Sending pair-verify response %@", buf, 0x16u);
...
LABEL_25:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v51 = 2112;
    v52 = v6;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Received request, tid %@ %@", buf, 0x20u);
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x24BDBCEC8], "dataWithLength:", v15);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      if (v16)
      {
        ...
        else
        {
          ...
          while (!v23);
          objc_msgSend(MEMORY[0x24BDD1770], "propertyListWithData:options:format:error:", v42, 0, 0, 0);
          v20 = (void *)objc_claimAutoreleasedReturnValue();
          if (v20)
          {
...
LABEL_18:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v46 = v32;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v46, &v45, 1, v36);
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    v34 = v29;
    v6 = v28;
    v20 = v39;
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v51 = 2112;
    v52 = v6;
    _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Request failed: %@, %@", buf, 0x20u);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v38 = 2112;
    v39 = v8;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Received prepare request, utid %@ %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v13);
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v11);
  logRemoteMessageEvent(v12, v9, v17);

  v18 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)v14->_internalQueue);
  if (v18)
  {
    v19 = v18;
    handler[0] = MEMORY[0x24BDAC760];
    ...
    dispatch_source_set_cancel_handler(v19, &__block_literal_global_89_241876);
...
- (int)_serverHandleCommitRequest:(id)a3 options:(id)a4 responseHandler:(id)a5
{
  ...
  objc_msgSend(v51, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("processing"));
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v73 = 2112;
    v74 = *(double *)&v48;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Received commit request, utid %@ %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v13);
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", *(_QWORD *)&v52);
...
LABEL_13:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v73 = 2112;
    v74 = v52;
    _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Starting commit response timeout of %.03f seconds for transaction: %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v20);
  v25 = dispatch_source_create(MEMORY[0x24BDACA18], 0, 0, (dispatch_queue_t)v21->_internalQueue);
  if (v25)
  {
    v26 = v25;
    ...
    dispatch_source_set_cancel_handler(v26, &__block_literal_global_94_241849);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", DebugGetErrorString(), context);
    v40 = objc_claimAutoreleasedReturnValue();
    v41 = (void *)v40;
    v42 = CFSTR("?");
    if (v40)
    ...
    objc_msgSend(v39, "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD1100], v34, v43);
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v73 = 2112;
    v74 = *(double *)&v48;
    _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Commit failed: %@ %@", buf, 0x20u);
...
- (void)_serverCompletePrepareRequest:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing prepare request, tid %@", (uint8_t *)&v13, 0x16u);
...
- (id)logIdentifier
{
  ...
  if (type == 2)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("S(%@)"), self->_sessionID);
  }
  else
  {
    if (type != 1)
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("C(%@)"), self->_sessionID);
  }
  ...
  if (!*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 72) + 8) + 24))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v6;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Transaction, %@, timed out, sending cancelled error", buf, 0x16u);
  ...
  if (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 64) + 8) + 24))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Transaction, %@, has already been completed", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v29 = 2112;
      v30 = v7;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEBUG, "%{public}@sending commit response, utid %@ %@", buf, 0x20u);
...
void __85__HMDSecureRemoteStreamInternal__serverHandlePrepareRequest_options_responseHandler___block_invoke_3(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 2112;
    v14 = v8;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Sending prepare response options %@, utid %@", (uint8_t *)&v9, 0x20u);
...
LABEL_29:
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v56 = 2112;
      v57 = v46;
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Response failed: %@, %@", buf, 0x20u);
  ...
  v12 = 0;
LABEL_9:
  objc_msgSend(MEMORY[0x24BDBCEC8], "dataWithLength:", v13 + 16);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v14)
  {
    v31 = 4294960568;
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v56 = 2112;
    v57 = v22;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Sending response, tid %@ %@", buf, 0x20u);
...
- (id)_encodeBinaryPlist:(void *)a1
{
  ...
  {
    v11 = 0;
    objc_msgSend(MEMORY[0x24BDD1770], "dataWithPropertyList:format:options:error:", v3, 200, 0, &v11);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = v11;
    if (!v4)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v14 = 2112;
        v15 = v5;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode payload as binary PList: %@", buf, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    if (v15)
      v17 = (const __CFString *)v15;
    v26 = v17;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v26, &v25, 1, v20);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v19;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Commit response failed: %@", buf, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v19;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Prepare response failed: %@", buf, 0x16u);
...
void __59__HMDSecureRemoteStreamInternal__clientPairVerifyExchange___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v31 = 2112;
    v32 = v21;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Pair-verify response failed: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t49_241966 != -1)
    dispatch_once(&logCategory__hmf_once_t49_241966, &__block_literal_global_95_241967);
  return (id)logCategory__hmf_once_v50_241968;
}
...
void __44__HMDSecureRemoteStreamInternal_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v50_241968;
  logCategory__hmf_once_v50_241968 = v0;
