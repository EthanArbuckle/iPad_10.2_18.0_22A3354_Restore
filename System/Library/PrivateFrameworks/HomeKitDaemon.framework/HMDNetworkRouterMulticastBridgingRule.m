...
+ (id)ruleFromFirewallRuleLAN:(id)a3
{
  ...
  v6 = objc_alloc(MEMORY[0x24BE1BC28]);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", objc_msgSend(v3, "port"));
    ...
    while (1)
    {
      ...
      switch(v34)
      {
        ...
        case 4:
          ...
          v26 = v10;
          v17 = &v26;
          objc_msgSend(MEMORY[0x24BE1BC28], "parsedFromData:error:", v16, &v26);
          v18 = v11;
