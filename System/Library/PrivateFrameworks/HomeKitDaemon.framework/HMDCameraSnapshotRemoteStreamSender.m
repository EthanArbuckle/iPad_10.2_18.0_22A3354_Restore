...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteStreamSender", buf, 0xCu);
...
- (void)snapshotLocal:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (v12)
  {
    if (v17)
    {
      ...
      v23 = 2112;
      v24 = v12;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Snapshot local capture has ended in %@", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    if (v17)
    {
      ...
      v23 = 2112;
      v24 = v11;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Scheduling the transfer of file %@ through IDS", (uint8_t *)&v21, 0x16u);
...
void __58__HMDCameraSnapshotRemoteStreamSender_sendSnapshotAtPath___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Sending the snapshot %@", (uint8_t *)&v8, 0x16u);
...
uint64_t __51__HMDCameraSnapshotRemoteStreamSender_getSnapshot___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Getting the snapshot from local snapshot handler", (uint8_t *)&v8, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_15077 != -1)
    dispatch_once(&logCategory__hmf_once_t1_15077, &__block_literal_global_15078);
  return (id)logCategory__hmf_once_v2_15079;
}
...
void __50__HMDCameraSnapshotRemoteStreamSender_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_15079;
  logCategory__hmf_once_v2_15079 = v0;
