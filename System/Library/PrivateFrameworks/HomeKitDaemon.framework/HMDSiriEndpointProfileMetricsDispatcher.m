  ...
  if (-[HMDSiriEndpointProfileMetricsDispatcher dataSourceShouldSubmitRoutineConfigurationEvent](self, "dataSourceShouldSubmitRoutineConfigurationEvent"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Submitting routine configuration event", buf, 0xCu);
...
- (BOOL)dataSourceShouldSubmitRoutineConfigurationEvent
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get should submit routine configuration event due to no data source", (uint8_t *)&v11, 0xCu);
...
- (id)dataSourceAccessoryCategoryType
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory category type due to no data source", (uint8_t *)&v11, 0xCu);
...
- (id)dataSourceCompositeSettingsControllerManager
{
  ...
  if (v3)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 2112;
        v19 = v4;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get composite settings controller manager from data source: %@", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory category type due to no data source", (uint8_t *)&v16, 0xCu);
...
- (id)dataSourceProfileFields
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get profile fields due to no data source", buf, 0xCu);
        ...
        if (v12)
        {
          ...
          else
          {
            ...
            else
            {
              ...
              if ((v30 & 1) != 0)
              {
                v45 = objc_alloc(MEMORY[0x24BDD7978]);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v56 = 2112;
                  v57 = v11;
                  _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to set setting from result: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v58 = 2112;
            v59 = v23;
            _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to local fetch setting for key path: %@ error: %@", buf, 0x20u);
...
void __74__HMDSiriEndpointProfileMetricsDispatcher_submitRoutineConfigurationEvent__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Fetch accessory setting fields failed", (uint8_t *)&v9, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_127726 != -1)
    dispatch_once(&logCategory__hmf_once_t12_127726, &__block_literal_global_127727);
  return (id)logCategory__hmf_once_v13_127728;
}
...
void __54__HMDSiriEndpointProfileMetricsDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_127728;
  logCategory__hmf_once_v13_127728 = v0;
