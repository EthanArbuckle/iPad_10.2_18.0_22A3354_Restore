...
- (id)dumpDescription
{
  ...
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x24BE3EB68]);
  ...
  if (objc_msgSend(v12, "count"))
    objc_msgSend(v24, "setObject:forKey:", v12, *MEMORY[0x24BE3EA48]);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Identify by /identify URL or unpaired BTLE characteristic write", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v24;
            ...
            v31 = 2048;
            v32 = v22;
            _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unhandled linkType: %tu", buf, 0x16u);
...
void __57__HMDUnpairedHAPAccessory_identifyWithCompletionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Identify by /identify URL completed with error: %@", (uint8_t *)&v10, 0x16u);
