...
LABEL_9:
    ...
    return (HMDAccessoryTransportInformation *)-[HMDAccessoryTransportInformation hapAccessory](v17, v18);
  }
  v19.receiver = self;
...
- (NSDictionary)transportInfoDictionary
{
  ...
  v9[1] = v4;
  v8[2] = CFSTR("linkType");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDAccessoryTransportInformation linkType](self, "linkType"));
...
- (HMDAccessoryTransportInformation)initWithCoder:(id)a3
{
  ...
  if (v8 || v7 == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot decode from serverIdentifier: %@ instanceID: %@ linkType: %@", (uint8_t *)&v17, 0x2Au);
