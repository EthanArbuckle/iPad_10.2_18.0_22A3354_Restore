...
- (void)finish
{
  ...
  v3 = (void *)MEMORY[0x227676638](-[HMDCameraClipOperation _markEndDateAndSubmitUploadOperationEvent](self, "_markEndDateAndSubmitUploadOperationEvent"));
  v4 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v11 = 2048;
    v12 = v7;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Operation finished in %.2fs", buf, 0x16u);
...
- (void)cancelWithError:(id)a3
{
  ...
  v5 = (void *)MEMORY[0x227676638](-[HMDCameraClipOperation _markEndDateAndSubmitUploadOperationEvent](self, "_markEndDateAndSubmitUploadOperationEvent"));
  v6 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v13 = 2048;
    v14 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Operation canceled after %.2fs", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v22 = 2112;
      v23 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch local clip model with ID %@: %@", buf, 0x20u);
...
- (id)updateClipModel:(id)a3
{
  ...
  if (v5)
  {
    v6 = objc_alloc(MEMORY[0x24BE4ED10]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v16;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Aborting save of clip model because no video streaming asset was found: %@", (uint8_t *)&v20, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_45111 != -1)
    dispatch_once(&logCategory__hmf_once_t4_45111, &__block_literal_global_45112);
  return (id)logCategory__hmf_once_v5_45113;
}
...
void __37__HMDCameraClipOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_45113;
  logCategory__hmf_once_v5_45113 = v0;
