...
- (void)sendDeleteSiriHistoryRequestForAccessoryWithUUID:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending delete siri history request message for accessory uuid: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v8);
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD79C8]), "initWithAccessoryUUID:", v6);
...
- (void)routeSiriEndpointDeleteSiriHistoryMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing siri endpoint delete siri history message: %@", buf, 0x16u);
...
void __102__HMDAppleMediaAccessoryMessenger_sendDeleteSiriHistoryRequestForAccessoryWithUUID_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v5;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Delete siri history message responded with error: %@", (uint8_t *)&v11, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_85785 != -1)
    dispatch_once(&logCategory__hmf_once_t4_85785, &__block_literal_global_85786);
  return (id)logCategory__hmf_once_v5_85787;
}
...
void __46__HMDAppleMediaAccessoryMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_85787;
  logCategory__hmf_once_v5_85787 = v0;
