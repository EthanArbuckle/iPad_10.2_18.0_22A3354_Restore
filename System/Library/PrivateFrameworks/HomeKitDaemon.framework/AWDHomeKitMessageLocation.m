...
LABEL_5:
    if ((has & 0x20) == 0)
      goto LABEL_6;
LABEL_13:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_numOfReachableIPAcc);
...
LABEL_6:
  ...
  {
LABEL_7:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_numOfReachableBTLEAcc);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
