...
- (void)startup
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v27 = 2112;
    v28 = v8;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Subscribing to home: %@, accessory: %@ keyPaths on startup.", buf, 0x20u);
  ...
  if (v14 && objc_msgSend(v14, "count"))
  {
    ...
    v20[3] = &unk_24E79A980;
    v20[4] = v4;
    objc_msgSend(v15, "changeRegistrationsForConsumer:topicFilterAdditions:topicFilterRemovals:completion:", v4, v14, MEMORY[0x24BDBD1A8], v20);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v19;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@No default settings keypaths are found", buf, 0xCu);
...
- (void)updateSettingWithKeyPath:(id)a3 settingValue:(id)a4 completion:(id)a5
{
  ...
  if (v11)
  {
    ...
    if (v12)
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2114;
        v27 = v8;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending update %{public}@ to controller", (uint8_t *)&v24, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 138543362;
        v25 = v22;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@No current settings controller.", (uint8_t *)&v24, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 138543362;
      v25 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not obtain setting value from given legacy value.", (uint8_t *)&v24, 0xCu);
...
- (id)_settingValueForKeyPath:(id)a3 value:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  if (!objc_msgSend(MEMORY[0x24BDD7418], "isKeyPathForBooleanSettingType:", v6))
  {
    if (!objc_msgSend(MEMORY[0x24BDD7418], "isKeyPathForConstrainedNumberSettingType:", v6))
    {
      if (!objc_msgSend(MEMORY[0x24BDD7418], "isKeyPathForTapAssistanceSelectionSettingType:", v6))
      {
        objc_msgSend(MEMORY[0x24BDD7418], "languageKeyPaths");
        ...
        if (!v10)
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
          {
            ...
            v50 = 2112;
            v51 = v39;
            _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Passed value = %@, is not a language setting", (uint8_t *)&v48, 0x16u);
      ...
      {
        v10 = v21;
        v22 = objc_msgSend(MEMORY[0x24BDD7418], "itemIndexWithTapAssistanceSelectionItem:", v21);
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", v22);
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x24BDD7418], "scaleUpNumberSettingValue:", v23);
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v54 = 2114;
          v55 = v6;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Updating legacy selection item index value %@ to %@: %{public}@", (uint8_t *)&v48, 0x2Au);

        }
        objc_autoreleasePoolPop(v26);
        v31 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7970]), "initWithIntegerValue:", v25);
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        v52 = 2114;
        v53 = v6;
        _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Passed in value: %@ is not a selection item for setting: %{public}@", (uint8_t *)&v48, 0x20u);
...
LABEL_36:
    ...
    if (v10)
    {
      objc_msgSend(MEMORY[0x24BDD7418], "scaleUpNumberSettingValue:", v12);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v54 = 2114;
        v55 = v6;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Updating legacy integer value %@ to %@: %{public}@", (uint8_t *)&v48, 0x2Au);

      }
      objc_autoreleasePoolPop(v16);
      v11 = objc_msgSend(objc_alloc(MEMORY[0x24BDD7970]), "initWithIntegerValue:", v15);
      goto LABEL_31;
    }
    v32 = (void *)MEMORY[0x227676638]();
    v33 = self;
...
LABEL_34:
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, v36, (uint8_t *)&v48, 0x20u);

      goto LABEL_35;
    }
    goto LABEL_35;
  }
  v11 = objc_msgSend(objc_alloc(MEMORY[0x24BDD7968]), "initWithBoolValue:", objc_msgSend(v10, "BOOLValue"));
LABEL_31:
  v31 = (void *)v11;
LABEL_37:
...
- (id)_transformLegacyLanguageSettingValueToImmutableSetting:(id)a3
{
  ...
  if ((unint64_t)objc_msgSend(v5, "count") > 2)
  {
    ...
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7978]), "initWithInputLanguageCode:outputVoiceLanguageCode:outputVoiceGenderCode:voiceName:", v11, v12, v13, v14);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get expected language code count from legacy language setting encoding: %@", (uint8_t *)&v16, 0x16u);
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v27 = 2114;
        v28 = v14;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Forwarding decoded setting event for %{public}@", (uint8_t *)&v25, 0x16u);
    ...
    else
    {
      ...
      if (v15)
      {
        if (v19)
        {
          ...
          v27 = 2114;
          v28 = v21;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Forwarding decoded setting event for %{public}@", (uint8_t *)&v25, 0x16u);
      ...
      else
      {
        if (v19)
        {
          ...
          v27 = 2114;
          v28 = v7;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Parsed setting for topic%{public}@ is neither BOOL nor integer", (uint8_t *)&v25, 0x16u);
...

{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v11;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@available language fetch returned Error =%@", (uint8_t *)&v16, 0x16u);
...
LABEL_13:
        ...
        {
          v16 = v17;
          objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v17, "integerValue"));
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v25;
          ...
          v39 = 2114;
          v40 = v8;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Parsed setting for topic%{public}@ is not of {Integer, Bool, Language}", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_222499 != -1)
    dispatch_once(&logCategory__hmf_once_t0_222499, &__block_literal_global_222500);
  return (id)logCategory__hmf_once_v1_222501;
}
...
+ (id)parsedBoolSettingEvent:(id)a3 topic:(id)a4
{
  ...
  {
    v30 = 0;
    objc_msgSend(MEMORY[0x24BDD7708], "decodeSettingFromEvent:error:", v6, &v30);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = v30;
    if (v13)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v33 = 2114;
          v34 = v7;
          _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Obtained setting but not of BOOL type. %{public}@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v33 = 2114;
        v34 = v7;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received setting change event but could not decode. %{public}@", buf, 0x16u);
...
LABEL_5:
  v25 = 0;
  objc_msgSend(MEMORY[0x24BDD7708], "decodeSettingFromEvent:error:", v6, &v25);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = v25;
  if (v15)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2114;
      v29 = v7;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Obtained setting but not of bounded integer type. %{public}@", buf, 0x16u);
...
+ (id)parsedLanguageSetting:(id)a3 topic:(id)a4
{
  ...
  if (v9)
  {
    ...
    {
      v26 = 0;
      objc_msgSend(MEMORY[0x24BDD7708], "decodeSettingFromEvent:error:", v6, &v26);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = v26;
      if (v13)
      {
...
LABEL_13:
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, v23, buf, 0x16u);
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v35 = 2112;
        v36 = v14;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@unable to decode event:%@ %@", buf, 0x20u);
...
void __48__HMDLegacyAccessorySettingsAdaptor_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_222501;
  logCategory__hmf_once_v1_222501 = v0;
