...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_deviceType);
...
LABEL_11:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_role);
...
LABEL_5:
    if ((has & 4) == 0)
      goto LABEL_6;
LABEL_13:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_closeReason);
