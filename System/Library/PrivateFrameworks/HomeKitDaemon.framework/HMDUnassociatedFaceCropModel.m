...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_57598 != -1)
    dispatch_once(&hmbProperties_onceToken_57598, &__block_literal_global_57599);
  return (id)hmbProperties_properties_57600;
}
...
{
  if (sentinelParentUUID_onceToken_57590 != -1)
    dispatch_once(&sentinelParentUUID_onceToken_57590, &__block_literal_global_13);
  return (NSUUID *)(id)sentinelParentUUID_sentinelParentUUID_57591;
}
...
+ (id)unassociatedFaceCropsBetweenDatesQueryWithIsAscending:(BOOL)a3
{
  ...
  if (unassociatedFaceCropsBetweenDatesQueryWithIsAscending__onceToken != -1)
    dispatch_once(&unassociatedFaceCropsBetweenDatesQueryWithIsAscending__onceToken, &__block_literal_global_17);
...
void __86__HMDUnassociatedFaceCropModel_unassociatedFaceCropsBetweenDatesQueryWithIsAscending___block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BE4ECD0], "argumentWithPropertyName:", CFSTR("dateCreated"));
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", CFSTR("dateCreated >= :dateAfter AND dateCreated < :dateBefore ORDER BY dateCreated ASC"), CFSTR("dateAfter"), &unk_24E970D00, v3);
  ...
  objc_msgSend(v6, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", CFSTR("dateCreated > :dateAfter AND dateCreated <= :dateBefore ORDER BY dateCreated DESC"), CFSTR("dateBefore"), &unk_24E970D18, v9);
...
void __50__HMDUnassociatedFaceCropModel_sentinelParentUUID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("58F70219-F689-486A-B16D-8143BD41ABDF"));
  v1 = (void *)sentinelParentUUID_sentinelParentUUID_57591;
  sentinelParentUUID_sentinelParentUUID_57591 = v0;
...
void __45__HMDUnassociatedFaceCropModel_hmbProperties__block_invoke()
{
  ...
  v8 = (void *)hmbProperties_properties_57600;
  hmbProperties_properties_57600 = v7;
...
- (id)createFaceCrop
{
  ...
  if (v3 && v4)
  {
    v6 = objc_alloc(MEMORY[0x24BDD7680]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v10;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot create face crop from model: %@", (uint8_t *)&v14, 0x16u);
