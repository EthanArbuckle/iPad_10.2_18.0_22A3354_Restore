...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_130191 != -1)
    dispatch_once(&logCategory__hmf_once_t3_130191, &__block_literal_global_130192);
  return (id)logCategory__hmf_once_v4_130193;
}
...
void __34__HMDHomeObjectLookup_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_130193;
  logCategory__hmf_once_v4_130193 = v0;
