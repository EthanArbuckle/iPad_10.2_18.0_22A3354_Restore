...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_pushCount);
...
LABEL_41:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_fetchCount);
...
LABEL_42:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_uploadCount);
  ...
  {
LABEL_6:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_uploadErrorCount);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_topReasons, "count"));
    v43 = 0u;
    v44 = 0u;
    v45 = 0u;
    v46 = 0u;
  ...
  {
    v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_topErrors, "count"));
    v39 = 0u;
    v40 = 0u;
    v41 = 0u;
    v42 = 0u;
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_uploadMaximumDelayReached);
...
LABEL_27:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_hasDecryptionFailed);
...
LABEL_46:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_lastDecryptionFailed);
...
LABEL_47:
  ...
  if (dataSyncState >= 6)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_dataSyncState);
    v31 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v31 = off_24E780918[dataSyncState];
  }
...
LABEL_51:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_homeManagerFetchCount);
...
LABEL_52:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_homeZoneFetchCount);
...
LABEL_53:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_homeManagerUploadCount);
...
LABEL_54:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_homeZoneUploadCount);
...
LABEL_55:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_homeDataMegabytesFetched);
...
LABEL_35:
    if ((*(_WORD *)&v20 & 0x200) == 0)
      goto LABEL_36;
LABEL_57:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_legacyHomeDataMegabytesFetched);
...
LABEL_56:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_homeDataMegabytesPushed);
...
LABEL_36:
  ...
  {
LABEL_37:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_legacyHomeDataMegabytesPushed);
...
- (BOOL)readFrom:(id)a3
{
  ...
  {
    v9 = &OBJC_IVAR___HMDCameraBulletinNotificationManager__currentPrimary;
...
LABEL_14:
      ...
      switch((v14 >> 3))
      {
        case 1u:
          ...
          v22 = 0;
          v23 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 1u;
          while (1)
          {
            v24 = *v5;
...
LABEL_148:
        ...
        case 2u:
          ...
          v29 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x800u;
          while (2)
          {
            v31 = *v5;
...
LABEL_152:
        ...
        case 3u:
          ...
          v35 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 4u;
          while (2)
          {
            v36 = *v5;
...
LABEL_156:
        ...
        case 4u:
          ...
          v40 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x1000u;
          while (2)
          {
            v41 = *v5;
...
LABEL_160:
        ...
        case 5u:
          ...
          v45 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x2000u;
          while (2)
          {
            v46 = *v5;
...
LABEL_164:
        ...
        case 6u:
          ...
          v50 = v9;
          v51 = v11;
          v52 = objc_alloc_init((Class)(v11 + 3424));
...
LABEL_215:
        ...
        case 8u:
          ...
          v54 = 0;
          v55 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x10000u;
          while (2)
          {
            v56 = *v5;
...
LABEL_168:
        ...
        case 9u:
          ...
          v60 = 0;
          v61 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x4000u;
          while (2)
          {
            v62 = *v5;
...
LABEL_172:
        ...
        case 0xAu:
          ...
          v66 = 0;
          v67 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x8000u;
          while (2)
          {
            v68 = *v5;
...
LABEL_177:
        ...
        case 0xBu:
          ...
          v72 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 2u;
          while (2)
          {
            v73 = *v5;
...
LABEL_181:
        ...
        case 0xCu:
          ...
          v77 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x20u;
          while (2)
          {
            v78 = *v5;
...
LABEL_185:
        ...
        case 0xDu:
          ...
          v82 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x80u;
          while (2)
          {
            v83 = *v5;
...
LABEL_189:
        ...
        case 0xEu:
          ...
          v87 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x40u;
          while (2)
          {
            v88 = *v5;
...
LABEL_193:
        ...
        case 0xFu:
          ...
          v92 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x100u;
          while (2)
          {
            v93 = *v5;
...
LABEL_197:
        ...
        case 0x10u:
          ...
          v97 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 8u;
          while (2)
          {
            v98 = *v5;
...
LABEL_201:
        ...
        case 0x11u:
          ...
          v102 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x10u;
          while (2)
          {
            v103 = *v5;
...
LABEL_205:
        ...
        case 0x12u:
          ...
          v107 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x200u;
          while (2)
          {
            v108 = *v5;
...
LABEL_209:
        ...
        case 0x13u:
          ...
          v112 = 0;
          v30 = 0;
          *(_DWORD *)((char *)&self->super.super.isa + v9[781]) |= 0x400u;
          while (2)
          {
            v113 = *v5;
