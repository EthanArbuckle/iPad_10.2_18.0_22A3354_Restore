    ...
    if (v10)
    {
      if (objc_msgSend(v10, "isSimulatedBySoftware"))
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          v25 = 138543362;
          v26 = v15;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@CLLocation is simulated by the software", (uint8_t *)&v25, 0xCu);
...
LABEL_18:
      ...
      if (objc_msgSend(v10, "isProducedByAccessory"))
      {
        ...
        if (!-[HMDCarPlayDataSource synchronouslyFetchIsCarPlayConnectedStatus](v19, "synchronouslyFetchIsCarPlayConnectedStatus"))
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            ...
            v25 = 138543362;
            v26 = v24;
            _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@CLLocation is simulated by the accessory and CarPlay is not connected.", (uint8_t *)&v25, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 138543362;
        v26 = v18;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@CLLocation does not contain the location source information", (uint8_t *)&v25, 0xCu);
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 138543362;
    v26 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Not checking for location simulation due to override", (uint8_t *)&v25, 0xCu);
