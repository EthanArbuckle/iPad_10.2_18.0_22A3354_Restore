...
+ (void)findChangedSettingsWithRootGroup:(id)a3 currentGroups:(id)a4 currentSettings:(id)a5 completion:(id)a6
{
  ...
  v61 = v14;
  v56 = v10;
  objc_msgSend(MEMORY[0x24BDD1650], "strongToWeakObjectsMapTable", context);
  ...
  if (objc_msgSend(v7, "na_any:", v25))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple groups collison", buf, 0xCu);
