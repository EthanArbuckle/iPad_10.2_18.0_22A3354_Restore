  ...
  if (v5 != v7)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v235 = 2112;
      v236 = v30;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Attempting to get metadata for mismatched number of characteristics (%@) : %@, and values (%@): %@", buf, 0x34u);
...
LABEL_13:
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v228 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no home data for event", buf, 0xCu);
      goto LABEL_11;
    }
    goto LABEL_12;
  }
  ...
  {
    v45 = 0;
    v182 = *MEMORY[0x24BDD5A58];
    v181 = *MEMORY[0x24BDD5A98];
    v178 = *MEMORY[0x24BDD5920];
    v222 = self;
    do
    {
      -[HMDCharacteristicReadWriteLogEvent characteristicsInRequest](self, "characteristicsInRequest");
                ...
                if (objc_msgSend(v77, "isEqualToString:", CFSTR("00000228-0000-1000-8000-0026BB765291")))
                {
                  ...
                  if (!v82)
                  {
                    ...
                    if (os_log_type_enabled(v128, OS_LOG_TYPE_DEFAULT))
                    {
                      ...
                      *(_DWORD *)buf = 138543362;
                      v228 = v131;
                      _os_log_impl(&dword_2218F0000, v128, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to log event metadata to biome, smart speaker event is missing media profile", buf, 0xCu);
                  ...
                  if (objc_msgSend(v80, "isEqualToString:", v182))
                  {
                    ...
                    if (v85)
                    {
                      ...
                      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", qword_2226A1160[v86]);
...
LABEL_97:
                      v209 = objc_alloc(MEMORY[0x24BE0CBB8]);
                      ...
                      v132 = (void *)objc_msgSend(v209, "initWithBase:accessoryUniqueIdentifier:accessoryStateString:accessoryStateNumber:accessoryStateData:accessoryMediaRouteIdentifier:zoneUniqueIdentifiers:roomUniqueIdentifier:accessoryName:roomName:zoneNames:homeName:", v224, v203, MEMORY[0x24BDBD1B8], v207, MEMORY[0x24BDBD1B8], v205, v201, v199, v146, v147, v148, v150);
...
LABEL_93:
                      _os_log_impl(&dword_2218F0000, v92, OS_LOG_TYPE_DEFAULT, v93, buf, 0xCu);
...
LABEL_94:
                  ...
                  else
                  {
                    if (objc_msgSend(v80, "isEqualToString:", v181))
                    {
                      ...
                      if (os_log_type_enabled(v154, OS_LOG_TYPE_DEFAULT))
                      {
                        ...
                        *(_DWORD *)buf = 138543362;
                        v228 = v157;
                        _os_log_impl(&dword_2218F0000, v154, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to log event metadata to biome, unknown volume state not eligible for donation", buf, 0xCu);
                    ...
                    else
                    {
                      ...
                      if (os_log_type_enabled(v167, OS_LOG_TYPE_DEFAULT))
                      {
                        ...
                        *(_DWORD *)buf = 138543362;
                        v228 = v169;
                        _os_log_impl(&dword_2218F0000, v167, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to log event metadata to biome, unknown mute state not eligible for donation", buf, 0xCu);
                ...
                if (v101)
                {
                  v183 = objc_alloc(MEMORY[0x24BE0CB90]);
                  -[HMDCharacteristicReadWriteLogEvent accessoryUniqueIdentifier](self, "accessoryUniqueIdentifier");
                ...
                else
                {
                  if (v104)
                  {
                    v184 = objc_alloc(MEMORY[0x24BE0CB90]);
                    -[HMDCharacteristicReadWriteLogEvent accessoryUniqueIdentifier](self, "accessoryUniqueIdentifier");
                    v200 = (void *)objc_claimAutoreleasedReturnValue();
                    objc_msgSend(v200, "UUIDString");
                    v217 = (void *)objc_claimAutoreleasedReturnValue();
                  ...
                  else
                  {
                    if (!v107)
                    {
                      ...
                      if (os_log_type_enabled(v161, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138544386;
                        ...
                        v236 = v105;
                        v164 = v163;
                        _os_log_impl(&dword_2218F0000, v161, OS_LOG_TYPE_INFO, "%{public}@Unable to log event metadata to biome, unknown write value type (%@) for characteristic: %@, Service: %@, written value: %@", buf, 0x34u);
                    ...
                    v185 = objc_alloc(MEMORY[0x24BE0CB90]);
                    -[HMDCharacteristicReadWriteLogEvent accessoryUniqueIdentifier](self, "accessoryUniqueIdentifier");
                    v200 = (void *)objc_claimAutoreleasedReturnValue();
                    objc_msgSend(v200, "UUIDString");
                    v217 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_112:
            ...
            if (os_log_type_enabled(v73, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v228 = v75;
              _os_log_impl(&dword_2218F0000, v73, OS_LOG_TYPE_ERROR, "%{public}@HAP event ineligible for donation because data source is nil", buf, 0xCu);
...
LABEL_54:
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v231 = 2112;
            v232 = v95;
            _os_log_impl(&dword_2218F0000, v62, OS_LOG_TYPE_DEBUG, "%{public}@Unable to log event metadata to biome, not eligible for donation. Characteristic: %@, Service: %@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", v45);
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v231 = 2112;
          v232 = v69;
          _os_log_impl(&dword_2218F0000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no characteristic type for characteristic (%@) at index: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v231 = 2112;
          v232 = v65;
          _os_log_impl(&dword_2218F0000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no service type for characteristic (%@) at index: %@", buf, 0x20u);
...
- (HMDCharacteristicReadWriteLogEvent)initWithStartTime:(double)a3 characteristics:(id)a4 hmdAccessory:(id)a5 hapAccessory:(id)a6 source:(unint64_t)a7 isWriteOperation:(BOOL)a8 isTimedWrite:(BOOL)a9 isLocal:(BOOL)a10 transactionId:(id)a11 isCached:(BOOL)a12 bundleId:(id)a13 userUUID:(id)a14 writtenValues:(id)a15
{
  ...
  void *v161;
  void *v162;
  HMDCharacteristicReadWriteLogEvent *v163;
  objc_super v164;
  _QWORD v165[4];
  id v166;
  __int128 v167;
  ...
  v164.receiver = self;
  v164.super_class = (Class)HMDCharacteristicReadWriteLogEvent;
  v32 = -[HMMDatedHomeLogEvent initWithStartTime:homeUUID:](&v164, sel_initWithStartTime_homeUUID_, v31, a3);
  ...
  if (v32)
  {
    v156 = v29;
    v154 = v25;
    objc_msgSend(MEMORY[0x24BE3F138], "currentClientMetricIdentifier");
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v39;
      _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@[HMDCharacteristicReadWriteLogEvent] %@...", buf, 0x16u);
    ...
    if (v42)
    {
      v163->_accessoryCertificationStatus = objc_msgSend(v42, "certificationStatus");
      v163->_communicationProtocol = objc_msgSend(v42, "communicationProtocol");
      objc_msgSend(v42, "expectedTransport");
      v43 = objc_claimAutoreleasedReturnValue();
      expectedTransport = v163->_expectedTransport;
      v163->_expectedTransport = (NSString *)v43;

    }
    objc_msgSend(v40, "uuid");
    v45 = objc_claimAutoreleasedReturnValue();
    accessoryUUID = v163->_accessoryUUID;
    v163->_accessoryUUID = (NSUUID *)v45;

    objc_msgSend(v40, "identifier");
    v47 = objc_claimAutoreleasedReturnValue();
    accessoryIdentifier = v163->_accessoryIdentifier;
    v163->_accessoryIdentifier = (NSString *)v47;

    objc_msgSend(v40, "spiClientIdentifier");
    v49 = objc_claimAutoreleasedReturnValue();
    accessoryUniqueIdentifier = v163->_accessoryUniqueIdentifier;
    v163->_accessoryUniqueIdentifier = (NSUUID *)v49;

    objc_msgSend(v40, "name");
    v51 = objc_claimAutoreleasedReturnValue();
    accessoryName = v163->_accessoryName;
    v163->_accessoryName = (NSString *)v51;
    ...
    accessoryCategory = v163->_accessoryCategory;
    v163->_accessoryCategory = (NSString *)v54;

    objc_msgSend(v40, "manufacturer");
    v56 = objc_claimAutoreleasedReturnValue();
    accessoryManufacturer = v163->_accessoryManufacturer;
    v163->_accessoryManufacturer = (NSString *)v56;

    objc_msgSend(v40, "room");
    v58 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v58, "spiClientIdentifier");
    v59 = objc_claimAutoreleasedReturnValue();
    accessoryRoomUniqueIdentifier = v163->_accessoryRoomUniqueIdentifier;
    v163->_accessoryRoomUniqueIdentifier = (NSUUID *)v59;

    v158 = v58;
    objc_msgSend(v58, "name");
    v61 = (void *)objc_claimAutoreleasedReturnValue();
    v62 = objc_msgSend(v61, "copy");
    accessoryRoomName = v163->_accessoryRoomName;
    v163->_accessoryRoomName = (NSString *)v62;

    objc_msgSend(v162, "accessoryMetric");
    v64 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v64, "sessionMetric");
    v65 = (void *)objc_claimAutoreleasedReturnValue();

    v163->_hasSession = objc_msgSend(v40, "hasActiveSession");
    v163->_reachable = objc_msgSend(v40, "isReachable");
    v66 = objc_msgSend(v65, "successfulSessionRetries");
    v163->_recentSessionRetries = objc_msgSend(v65, "sessionFailures") + v66;
    objc_msgSend(v65, "topError");
    v67 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_topSessionFailureErrorCode = objc_msgSend(v67, "code");
    ...
    topSessionFailureErrorDomain = v163->_topSessionFailureErrorDomain;
    v163->_topSessionFailureErrorDomain = (NSString *)v69;

    objc_msgSend(v30, "threadNetworkID");
    v71 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_homeThreadCapable = v71 != 0;

    v163->_lastKnownLinkQuality = 5;
    objc_storeStrong((id *)&v163->_characteristicsInRequest, a4);
    v163->_triggerSource = a7;
    v163->_isWriteOperation = v16;
    v163->_isTimedWrite = a9;
    v163->_isLocal = a10;
    objc_msgSend(v24, "UUIDString");
    v72 = objc_claimAutoreleasedReturnValue();
    transactionIdentifier = v163->_transactionIdentifier;
    v163->_transactionIdentifier = (NSString *)v72;

    v163->_isCached = a12;
    v163->_linkType = objc_msgSend(v26, "linkType");
    v163->_linkLayerType = objc_msgSend(v26, "linkLayerType");
    objc_msgSend(v155, "version");
    v74 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v74, "versionString");
    v75 = objc_claimAutoreleasedReturnValue();
    transportProtocolVersion = v163->_transportProtocolVersion;
    v163->_transportProtocolVersion = (NSString *)v75;

    +[HMDMetricsUtilities primaryServiceTypeForHAPAccessory:](HMDMetricsUtilities, "primaryServiceTypeForHAPAccessory:", v162);
    v77 = objc_claimAutoreleasedReturnValue();
    primaryServiceType = v163->_primaryServiceType;
    v163->_primaryServiceType = (NSString *)v77;

    if (v160)
    {
      objc_msgSend(v160, "UUIDString");
      v79 = objc_claimAutoreleasedReturnValue();
      userUUID = v163->_userUUID;
      v163->_userUUID = (NSString *)v79;
    }
    else
    {
      ...
      v83 = v163->_userUUID;
      v163->_userUUID = (NSString *)v82;

    }
    objc_msgSend(v30, "spiClientIdentifier");
    v84 = (void *)objc_claimAutoreleasedReturnValue();
    v85 = objc_msgSend(v84, "copy");
    homeUniqueIdentifier = v163->_homeUniqueIdentifier;
    v163->_homeUniqueIdentifier = (NSUUID *)v85;

    objc_msgSend(v30, "name");
    v87 = (void *)objc_claimAutoreleasedReturnValue();
    v88 = objc_msgSend(v87, "copy");
    homeName = v163->_homeName;
    v163->_homeName = (NSString *)v88;

    v90 = objc_msgSend(v30, "atHomeLevel");
    v91 = 1;
    if (v90 != 2)
      v91 = objc_msgSend(v30, "atHomeLevel") == 3;
    v163->_isAtHome = v91;
    objc_msgSend(v30, "residentDeviceManager");
    v92 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_isResidentAvailable = objc_msgSend(v92, "isResidentAvailable");

    objc_msgSend(v30, "residentDeviceManager");
    v93 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_isCurrentDeviceAvailableResident = objc_msgSend(v93, "isCurrentDeviceAvailableResident");

    objc_msgSend(v30, "residentDeviceManager");
    v94 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_isCurrentDevicePrimaryResident = objc_msgSend(v94, "isCurrentDevicePrimaryResident");

    objc_msgSend(v30, "residentDeviceManager");
    v95 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_isCurrentDeviceConfirmedPrimaryResident = objc_msgSend(v95, "isCurrentDeviceConfirmedPrimaryResident");

    objc_msgSend(v30, "residentDeviceManager");
    v96 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v96, "primaryResidentDevice");
    v97 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_isPrimaryResidentReachable = objc_msgSend(v97, "isReachable");

    objc_msgSend(v30, "currentUser");
    v98 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_isRemoteAccessAllowed = objc_msgSend(v98, "isRemoteAccessAllowed");

    v163->_isRemotelyReachable = objc_msgSend(v40, "isRemotelyReachable");
    v163->_isResidentFirstEnabled = 1;
    v163->_isDeviceAtHome = objc_msgSend(v30, "homeLocation") == 1;
    v99 = v25;
    v100 = isInternalBuild();
    v101 = v99;
    v102 = v101;
    if (v101)
    {
      if ((HMDShouldRedactBundleIdForBuildType(v101, v100) & 1) != 0)
        v103 = CFSTR("External");
      else
        v103 = (const __CFString *)objc_msgSend(v102, "copy");
    }
    else
    {
      v103 = CFSTR("Unknown");
    ...
    bundleId = v163->_bundleId;
    v163->_bundleId = &v103->isa;

    v153 = v30;
    if (v30)
    {
      v149 = v26;
      -[HMDCharacteristicReadWriteLogEvent characteristicsInRequest](v163, "characteristicsInRequest");
      ...
      v170 = 0u;
      v108 = v105;
      v109 = objc_msgSend(v108, "countByEnumeratingWithState:objects:count:", &v167, buf, 16);
      if (v109)
      {
        v110 = v109;
        v111 = *(_QWORD *)v168;
        do
        {
          for (i = 0; i != v110; ++i)
          {
            ...
            objc_msgSend(*(id *)(*((_QWORD *)&v167 + 1) + 8 * i), "service");
            ...
            if (v113)
            {
              ...
              objc_msgSend(v107, "objectForKeyedSubscript:", v115);
              v116 = (void *)objc_claimAutoreleasedReturnValue();

              if (!v116)
              {
                objc_msgSend(v106, "serviceGroups");
                v117 = (void *)objc_claimAutoreleasedReturnValue();
                v165[0] = MEMORY[0x24BDAC760];
                v165[1] = 3221225472;
                v165[2] = __90__HMDCharacteristicReadWriteLogEvent_serviceUUIDToServiceGroupsForCharacteristics_inHome___block_invoke;
                v165[3] = &unk_24E78F1F8;
                v118 = v114;
                v166 = v118;
                objc_msgSend(v117, "na_firstObjectPassingTest:", v165);
                v119 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                if (v119)
                {
                  ...
                  objc_msgSend(v107, "setObject:forKeyedSubscript:", v119, v120);
          ...
          v110 = objc_msgSend(v108, "countByEnumeratingWithState:objects:count:", &v167, buf, 16);
        }
        while (v110);
      }

      v121 = (void *)objc_msgSend(v107, "copy");
      v26 = v149;
      v30 = v153;
      v25 = v154;
    }
    ...
    {
      v121 = (void *)MEMORY[0x24BDBD1B8];
    }
    objc_msgSend(v121, "na_dictionaryByMappingValues:", &__block_literal_global_137_189314);
    v122 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v121, "na_dictionaryByMappingValues:", &__block_literal_global_139_189315);
    v123 = (void *)objc_claimAutoreleasedReturnValue();
    v124 = objc_msgSend(v123, "copy");
    serviceUUIDToServiceGroupName = v163->_serviceUUIDToServiceGroupName;
    v163->_serviceUUIDToServiceGroupName = (NSDictionary *)v124;

    v126 = objc_msgSend(v122, "copy");
    serviceUUIDToServiceGroupUniqueIdentifier = v163->_serviceUUIDToServiceGroupUniqueIdentifier;
    v163->_serviceUUIDToServiceGroupUniqueIdentifier = (NSDictionary *)v126;

    v128 = (void *)MEMORY[0x24BDBD1A8];
    if (v30 && v158)
    {
      objc_msgSend(v158, "uuid");
      ...
      *(_QWORD *)&buf[16] = __62__HMDCharacteristicReadWriteLogEvent_zonesForRoomUUID_inHome___block_invoke;
      ...
      v131 = v129;
      v173 = v131;
      objc_msgSend(v130, "na_filter:", buf);
      v128 = (void *)objc_claimAutoreleasedReturnValue();

    }
    objc_msgSend(v128, "na_map:", &__block_literal_global_141_189316);
    v132 = objc_claimAutoreleasedReturnValue();
    accessoryZoneUniqueIdentifiers = v163->_accessoryZoneUniqueIdentifiers;
    v163->_accessoryZoneUniqueIdentifiers = (NSArray *)v132;

    objc_msgSend(v128, "na_map:", &__block_literal_global_142_189317);
    v134 = objc_claimAutoreleasedReturnValue();
    accessoryZoneNames = v163->_accessoryZoneNames;
    v163->_accessoryZoneNames = (NSArray *)v134;

    objc_msgSend(v30, "accessories");
    v136 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_numAccessoriesInHome = objc_msgSend(v136, "count");

    objc_msgSend(v30, "actionSets");
    v137 = (void *)objc_claimAutoreleasedReturnValue();
    v138 = (void *)objc_msgSend(v137, "copy");

    objc_msgSend(v138, "na_filter:", &__block_literal_global_144);
    v139 = (void *)objc_claimAutoreleasedReturnValue();
    v163->_numNonEmptyScenesInHome = objc_msgSend(v139, "count");

    objc_msgSend(v159, "accessoryProfiles");
    v140 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v140, "na_firstObjectPassingTest:", &__block_literal_global_146_189318);
    v141 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v141, "mediaRouteID");
    v142 = objc_claimAutoreleasedReturnValue();
    accessoryMediaRouteID = v163->_accessoryMediaRouteID;
    v163->_accessoryMediaRouteID = (NSString *)v142;

    v144 = objc_msgSend(v156, "copy");
    writtenValues = v163->_writtenValues;
    v163->_writtenValues = (NSArray *)v144;

    objc_msgSend(v162, "findServiceWithServiceType:", CFSTR("00000701-0000-1000-8000-0026BB765291"));
    v146 = (void *)objc_claimAutoreleasedReturnValue();

    if (v146)
      v163->_threadAccessory = 1;
    objc_msgSend(v26, "server");
    v147 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0 && v147)
      v163->_isSentOverThread = 1;
...
- (void)_setBtLoad
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@RW BT Load: %d AudioTsk: %d NonAudioTsk: %d", (uint8_t *)&v12, 0x1Eu);
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDCharacteristicReadWriteLogEvent communicationProtocol](self, "communicationProtocol"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCharacteristicReadWriteLogEvent consecutiveFailureCount](self, "consecutiveFailureCount"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v13, CFSTR("consecutiveFailureCount"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isCached](self, "isCached"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("isCached"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isCurrentDeviceConfirmedPrimaryResident](self, "isCurrentDeviceConfirmedPrimaryResident"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v15, CFSTR("isCurrentDeviceConfirmedPrimaryResident"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isCurrentDevicePrimaryResident](self, "isCurrentDevicePrimaryResident"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v16, CFSTR("isCurrentDevicePrimaryResident"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isCurrentDeviceAvailableResident](self, "isCurrentDeviceAvailableResident"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v17, CFSTR("isCurrentDeviceAvailableResident"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isPrimaryResidentReachable](self, "isPrimaryResidentReachable"));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v18, CFSTR("isPrimaryResidentReachable"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDCharacteristicReadWriteLogEvent isLocal](self, "isLocal") ^ 1);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v19, CFSTR("isRemote"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isRemotelyReachable](self, "isRemotelyReachable"));
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v20, CFSTR("isRemotelyReachable"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isRemoteAccessAllowed](self, "isRemoteAccessAllowed"));
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v21, CFSTR("isRemoteAccessAllowed"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isResidentAvailable](self, "isResidentAvailable"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("isSentOverThread"));
  }
  else
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isSentOverThread](self, "isSentOverThread"));
    v23 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[HMDCharacteristicReadWriteLogEvent linkLayerType](self, "linkLayerType") == 4)
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("isThreadAccessory"));
  }
  else
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isThreadAccessory](self, "isThreadAccessory"));
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v24, CFSTR("isThreadAccessory"));

  }
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isWriteOperation](self, "isWriteOperation"));
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v25, CFSTR("isWrite"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isTimedWrite](self, "isTimedWrite"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (v33 > 6)
      ...
      v34 = off_24E79B0E0[v33];
    v32 = v34;
  }
  v35 = v32;
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v32, CFSTR("transportType"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDCharacteristicReadWriteLogEvent linkLayerType](self, "linkLayerType"));
  v36 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v36, CFSTR("linkLayerType"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isModernTransport](self, "isModernTransport"));
  v37 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v37, CFSTR("isModernTransport"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isSlowRapport](self, "isSlowRapport"));
  v38 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v38, CFSTR("isSlowRapport"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isDeviceAtHome](self, "isDeviceAtHome"));
  v39 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v39, CFSTR("isDeviceAtHome"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDCharacteristicReadWriteLogEvent localDurationInMilliseconds](self, "localDurationInMilliseconds"));
  v40 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v40, CFSTR("localDuration"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDCharacteristicReadWriteLogEvent residentFirstDurationInMilliseconds](self, "residentFirstDurationInMilliseconds"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDCharacteristicReadWriteLogEvent btLoad](self, "btLoad"));
  v43 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v43, CFSTR("btLoad"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDCharacteristicReadWriteLogEvent btAudioTask](self, "btAudioTask"));
  v44 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v44, CFSTR("btAudioTask"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDCharacteristicReadWriteLogEvent btNonAudioTask](self, "btNonAudioTask"));
  v45 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v45, CFSTR("btNonAudioTask"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent hasSession](self, "hasSession"));
  v46 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v46, CFSTR("hasActiveSession"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isReachable](self, "isReachable"));
  v47 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v47, CFSTR("isReachable"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCharacteristicReadWriteLogEvent recentSessionRetries](self, "recentSessionRetries"));
  v48 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v48, CFSTR("recentSessionRetries"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDCharacteristicReadWriteLogEvent topSessionFailureErrorCode](self, "topSessionFailureErrorCode"));
  v49 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCharacteristicReadWriteLogEvent isHomeThreadCapable](self, "isHomeThreadCapable"));
  v51 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v51, CFSTR("isHomeThreadCapable"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCharacteristicReadWriteLogEvent lastKnownLinkQuality](self, "lastKnownLinkQuality"));
  ...
  objc_msgSend(v59, "objectForKeyedSubscript:", *MEMORY[0x24BDD1398]);
  ...
  if (v62)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v62, "code"));
    v64 = (void *)objc_claimAutoreleasedReturnValue();
...
- (SISchemaTopLevelUnionType)siriInstrumentationMessage
{
  ...
  v3 = objc_alloc_init(MEMORY[0x24BE94CE8]);
  v4 = objc_alloc(MEMORY[0x24BDD1880]);
  -[HMDCharacteristicReadWriteLogEvent clientMetricIdentifier](self, "clientMetricIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v4, "initWithUUIDString:", v5);

  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE95C78]), "initWithNSUUID:", v6);
  ...
  v23 = objc_alloc_init(MEMORY[0x24BE94CF0]);
...
+ (id)eventWithCharacteristicsToRead:(id)a3 hmdAccessory:(id)a4 hapAccessory:(id)a5 source:(unint64_t)a6 isLocal:(BOOL)a7 transactionId:(id)a8 isCached:(BOOL)a9 bundleId:(id)a10 userUUID:(id)a11
{
  ...
  LOBYTE(v27) = a9;
  LOBYTE(v26) = a7;
  v24 = -[HMDCharacteristicReadWriteLogEvent initWithCharacteristics:hmdAccessory:hapAccessory:source:isWriteOperation:isTimedWrite:isLocal:transactionId:isCached:bundleId:userUUID:writtenValues:](v23, "initWithCharacteristics:hmdAccessory:hapAccessory:source:isWriteOperation:isTimedWrite:isLocal:transactionId:isCached:bundleId:userUUID:writtenValues:", v22, v21, v20, a6, 0, 0, v26, v19, v27, v18, v17, MEMORY[0x24BDBD1A8]);
