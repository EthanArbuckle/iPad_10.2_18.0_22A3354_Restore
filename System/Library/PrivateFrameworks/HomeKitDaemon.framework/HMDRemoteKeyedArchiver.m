...
- (id)initForWritingWithRemoteDeviceIsOnSameAccount:(BOOL)a3 remoteGateway:(BOOL)a4 remoteUserIsAdministrator:(BOOL)a5 user:(id)a6 dataVersion:(int64_t)a7 supportedFeatures:(id)a8
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2112;
    v31 = v14;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Encoding for user : %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v17);
  v20 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1618]), "initRequiringSecureCoding:", 1);
  archiver = v16->_archiver;
  v16->_archiver = (NSKeyedArchiver *)v20;

  objc_setAssociatedObject(v16->_archiver, CFSTR("kTransportTypeAssociationKey"), MEMORY[0x24BDBD1C8], (void *)0x301);
  if (v12)
  {
    objc_setAssociatedObject(v16->_archiver, CFSTR("DeviceIsOnSameAccountKey"), MEMORY[0x24BDBD1C8], (void *)0x301);
    if (!v11)
    {
LABEL_6:
      if (!v10)
        goto LABEL_7;
LABEL_15:
      objc_setAssociatedObject(v16->_archiver, CFSTR("RemoteUserIsAdministrator"), MEMORY[0x24BDBD1C8], (void *)0x301);
      if (!v14)
        goto LABEL_9;
      goto LABEL_8;
    }
  ...
  objc_setAssociatedObject(v16->_archiver, CFSTR("RemoteGateway"), MEMORY[0x24BDBD1C8], (void *)0x301);
  if (v10)
    goto LABEL_15;
LABEL_7:
  if (v14)
