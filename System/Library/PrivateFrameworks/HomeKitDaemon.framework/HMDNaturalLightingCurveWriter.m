...
- (HMDNaturalLightingCurveWriter)initWithUUID:(id)a3 workQueue:(id)a4 logIdentifier:(id)a5
{
  ...
  v13 = -[HMDNaturalLightingCurveWriter initWithUUID:workQueue:logIdentifier:dataSource:notificationCenter:timerFactory:](self, "initWithUUID:workQueue:logIdentifier:dataSource:notificationCenter:timerFactory:", v10, v9, v8, v11, v12, &__block_literal_global_249564);
...
- (void)configureWithLightProfile:(id)a3
{
  ...
  v8 = (void *)MEMORY[0x227676638](-[HMDNaturalLightingCurveWriter setLightProfile:](self, "setLightProfile:", v4));
  v9 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring with home: %@", buf, 0x16u);
    ...
    if (v4)
    {
      ...
      if (v12 >= 0.0)
      {
        ...
        if (v28 - v12 <= 0.0)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            v55 = 2048;
            v56 = v28;
            _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_INFO, "%{public}@Updating curve since time elapsed since transition start is greater than curve update interval %f:%f", (uint8_t *)&v51, 0x20u);
        ...
        else
        {
          ...
          if (v31 < v34)
          {
            if (v37)
            {
              ...
              v53 = 2048;
              v54 = v29;
              _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@Starting timer for natural lighting curve update: %fs", (uint8_t *)&v51, 0x16u);
          ...
          if (v37)
          {
            ...
            v59 = 2048;
            v60 = v50;
            _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating curve because accessory time (%fs) and controller time (%fs) difference (%fs) is greater than threshold (%fs)", (uint8_t *)&v51, 0x34u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          v55 = 2112;
          v56 = *(double *)&v8;
          _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating curve because transition start date is ahead of the current date %@:%@", (uint8_t *)&v51, 0x20u);
...
LABEL_25:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      v53 = 2112;
      v54 = 0.0;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Stopping characteristic write timer because active transition context is not set: %@", (uint8_t *)&v51, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v51 = 138543362;
      v52 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Skipping active transition context update because current device is not primary resident", (uint8_t *)&v51, 0xCu);
...
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling current device primary resident changed: %@ with reason: %@", (uint8_t *)&v12, 0x20u);
...
- (void)writeWithNaturalLightingEnabled:(BOOL)a3 reason:(id)a4 completion:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping curve write with reason because current device is not a primary resident: %@", (uint8_t *)&v19, 0x16u);
...
- (void)synchronizeCurveWithActiveTransitionContext:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 138543362;
    v28 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Synchronizing curve...", (uint8_t *)&v27, 0xCu);
...
LABEL_14:
      _os_log_impl(&dword_2218F0000, v24, v25, v23, (uint8_t *)&v27, 0xCu);
...
LABEL_13:
  ...
  if (v21)
  {
    ...
    v27 = 138543362;
    v28 = v26;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Start sychronizing curve", (uint8_t *)&v27, 0xCu);
    ...
    if (v14)
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v24 = 2112;
        v25 = v4;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Rewriting the characteristic because timer: %@ fired", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v15);
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("timer expired: %@"), v4);
    ...
    else
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v23 = v21;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Canceling periodic characteristic writer timer because natural lighting is no longer enabled", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v26 = 2112;
      v27 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Received timer did fire callback for unknown timer. Expected: %@ received: %@", buf, 0x20u);
...
void __73__HMDNaturalLightingCurveWriter_handlePrimaryResidentUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if ((_DWORD)v5 != objc_msgSend(*(id *)(a1 + 32), "isCurrentDevicePrimaryResident"))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Current device primary changed from: (%@->%@)", (uint8_t *)&v14, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_249567 != -1)
    dispatch_once(&logCategory__hmf_once_t19_249567, &__block_literal_global_17_249568);
  return (id)logCategory__hmf_once_v20_249569;
}
...
void __44__HMDNaturalLightingCurveWriter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v20_249569;
  logCategory__hmf_once_v20_249569 = v0;
