...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v7[0] = CFSTR("HMDHomeNFCReaderIdentifierCodingKey");
  -[HMDHomeNFCReaderKey identifier](self, "identifier");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v7[1] = CFSTR("HMDHomeNFCReaderPublicKeyExternalRepresentationCodingKey");
  v8[0] = v3;
  -[HMDHomeNFCReaderKey publicKeyExternalRepresentation](self, "publicKeyExternalRepresentation");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v8[1] = v4;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v21 = 2112;
        v22 = v9;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to copy nfc reader key external representation: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v7;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to create nfc reader key: %@", buf, 0x16u);
...
+ (id)createWithExternalRepresentation:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nfc reader key external representation length %lu", (uint8_t *)&v12, 0x16u);
...
+ (id)createWithDictionaryRepresentation:(id)a3
{
  ...
  void *v4;
  void *v5;
  HMDHomeNFCReaderKey *v6;

  v3 = a3;
  objc_msgSend(v3, "hmf_dataForKey:", CFSTR("HMDHomeNFCReaderIdentifierCodingKey"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4)
  {
    objc_msgSend(v3, "hmf_dataForKey:", CFSTR("HMDHomeNFCReaderPublicKeyExternalRepresentationCodingKey"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (v5)
      v6 = -[HMDHomeNFCReaderKey initWithIdentifier:privateKey:publicKeyExternalRepresentation:]([HMDHomeNFCReaderKey alloc], "initWithIdentifier:privateKey:publicKeyExternalRepresentation:", v4, 0, v5);
    else
      v6 = 0;
...
- (id)createKeychainItemForHome:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v6, "setType:", &unk_24E96BE10);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v15;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create keychain item for home: %@ from: %@, external representation is nil", (uint8_t *)&v19, 0x20u);
...
LABEL_8:
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v17, 0x20u);
...
LABEL_9:
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_msgSend(v7, "isEqualToNumber:", &unk_24E96BE10);
  ...
  if ((v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = v4;
      v21 = 2112;
      v22 = (const __CFString *)&unk_24E96BE10;
