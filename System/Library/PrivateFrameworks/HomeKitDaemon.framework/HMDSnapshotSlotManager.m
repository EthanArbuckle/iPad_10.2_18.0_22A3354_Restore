  ...
  if (v2)
  {
    ...
    if (v7)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(*(id *)(v10 + 3680), "hmd_dateFromSnapshotFileName:", v12);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v81 = 2112;
              v82 = v12;
              _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring snapshot file with date in the future: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v81 = 2112;
      v82 = v64;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Built the snapshot file dictionary: %@", buf, 0x16u);
    ...
    if (v30)
    {
            ...
            if ((objc_msgSend(v36, "isEqualToString:", v30) & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)v75 = 138543618;
                ...
                v77 = 2112;
                v78 = v39;
                _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Removing obsolete snapshot at path: %@", v75, 0x16u);
      ...
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@/%@"), v24[7], v30);
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v75 = 138543618;
        ...
        v77 = 2112;
        v78 = v49;
        _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Found the most recent snapshot %@", v75, 0x16u);
    ...
    if (v49)
    {
      v54 = (void *)MEMORY[0x227676638]((id)objc_msgSend(v24, "createSlotForSnapshotFile:requestMessages:shouldNotifyClients:", v49, MEMORY[0x24BDBD1A8], 0));
      v55 = v24;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v83 = 138543618;
        ...
        v85 = 2112;
        v86 = Property;
        _os_log_impl(&dword_2218F0000, v56, OS_LOG_TYPE_INFO, "%{public}@Created the most recent snapshot %@", v83, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v83 = 138543362;
        v84 = v61;
        _os_log_impl(&dword_2218F0000, v56, OS_LOG_TYPE_INFO, "%{public}@No recent snapshot found", v83, 0xCu);
...
- (void)handleFillSnapshotSlot:(id)a3
{
  ...
  objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD6DC0]);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v6;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Filling snapshot with slot identifier %@", (uint8_t *)&v27, 0x16u);
  ...
  if (v12)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v6;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot fill snapshot with slot identifier %@ because it no longer exist", (uint8_t *)&v27, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v29 = 2112;
      v30 = v4;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot fill snapshot for message without process info: %@", (uint8_t *)&v27, 0x16u);
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Releasing snapshot file with slot identifier: %@", buf, 0x16u);
    ...
    v41 = 0u;
    v42 = 0u;
    v12 = &OBJC_IVAR___HMDAccessoryBrowser__workQueue;
    v38 = v4;
    if (self)
    ...
    if (v15)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          v20 = v12;
          if (self)
            v21 = *(Class *)((char *)&v8->super.super.isa + v12[832]);
          else
            v21 = 0;
          v22 = v21;
          ...
          if (v25)
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v48 = 2112;
              v49 = (uint64_t)v23;
              _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Releasing snapshot file: %@", buf, 0x16u);
            ...
            v31 = obj;
            if (self)
              v36 = *(Class *)((char *)&v33->super.super.isa + v20[832]);
            else
              v36 = 0;
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = (uint64_t)v40;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find snapshot file to release with slot identifier: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = (uint64_t)v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot find slot identifier in release snapshot message payload: %@", buf, 0x16u);
...
- (id)encodedMostRecentSnapshotForMessage:(id)a3
{
  ...
  if (!isMostRecentSnapshotValid(v7))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v7;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Not encoding invalid most recent snapshot for message %@: %@", (uint8_t *)&v27, 0x20u);
...
LABEL_14:
  ...
  if (v12)
  {
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v7;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Associating process info %@ with most recent snapshot file: %@", (uint8_t *)&v27, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v29 = 2112;
      v30 = v4;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot encode most recent snapshot for message without process info: %@", (uint8_t *)&v27, 0x16u);
...
void __88__HMDSnapshotSlotManager_createSlotForSnapshotFile_requestMessages_shouldNotifyClients___block_invoke(uint64_t a1)
{
  ...
  v4 = &OBJC_IVAR___HMDAccessoryBrowser__workQueue;
  if (v2)
  {
    v5 = v2;
    v6 = *(_QWORD *)v49;
      ...
      do
      {
        ...
        if (v10)
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v54 = v16;
            _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Associating process info %@ with snapshot file: %@", buf, 0x20u);
        ...
        else
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v8;
            _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot associate snapshot file for message without process info: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v26;
    _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Current snapshot-application map: %@", buf, 0x16u);
  ...
  if (v27)
  {
    ...
    if (!isMostRecentSnapshotValid(v30))
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v30;
        _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_INFO, "%{public}@Not updating most recent snapshot with invalid snaphot: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v30;
      _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Updating most recent snapshot to %@", buf, 0x16u);
...
void __72__HMDSnapshotSlotManager__updateMostRecentSnapshot_shouldNotifyClients___block_invoke(uint64_t a1)
{
  ...
  v6 = (void *)objc_msgSend(v5, "initWithName:destination:payload:", *MEMORY[0x24BDD5610], v4, v10);
...
void __54__HMDSnapshotSlotManager_backboardServicesRelaunched___block_invoke(uint64_t a1)
{
  ...
  v11 = (id)objc_msgSend(*(id *)(a1 + 32), "createSlotForSnapshotFile:requestMessages:shouldNotifyClients:", v12, MEMORY[0x24BDBD1A8], 1);
}
  ...
  if (v1)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v29[22] = 2112;
        v30 = v9;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Received notification that process info state changed: %@, stateNumber: %@", v29, 0x20u);
      ...
      if (v16)
      {
        ...
        if (v19)
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&v29[22] = 2112;
            v30 = v19;
            _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Removing snapshot file associated with non-foreground app %@: %@", v29, 0x20u);
        ...
        if (v17 == 4)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&v29[12] = 2112;
            *(_QWORD *)&v29[14] = v5;
            _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Clearing any of the filled snapshot slots for terminated process: %@", v29, 0x16u);
  ...
  if (v4)
  {
          ...
          if (objc_msgSend(v14, "containsObject:", v3))
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v32 = 2112;
              v33 = v11;
              _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Cannot clear snapshot slot identifier %@ because is still in use by %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v4;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Clearing snapshot slot for snapshot %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_220460 != -1)
    dispatch_once(&logCategory__hmf_once_t0_220460, &__block_literal_global_220461);
  return (id)logCategory__hmf_once_v1_220462;
}
...
void __37__HMDSnapshotSlotManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_220462;
  logCategory__hmf_once_v1_220462 = v0;
