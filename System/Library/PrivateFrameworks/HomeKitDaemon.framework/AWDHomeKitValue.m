...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", self->_intVal);
...
LABEL_13:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->_doubleVal);
  ...
  {
LABEL_7:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_BOOLVal);
