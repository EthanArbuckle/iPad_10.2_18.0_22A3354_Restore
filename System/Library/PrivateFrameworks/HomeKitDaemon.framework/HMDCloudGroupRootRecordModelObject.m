...
+ (id)properties
{
  if (properties_onceToken_16638 != -1)
    dispatch_once(&properties_onceToken_16638, &__block_literal_global_68);
  return (id)properties__properties_16639;
}
...
void __48__HMDCloudGroupRootRecordModelObject_properties__block_invoke()
{
  ...
  v2 = (void *)properties__properties_16639;
  properties__properties_16639 = v1;
