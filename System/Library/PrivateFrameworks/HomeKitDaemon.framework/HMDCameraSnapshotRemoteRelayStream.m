...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteRelayStream", buf, 0xCu);
...
- (void)_sendImageSendFailure:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2112;
    v31 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending image send failure to %@", buf, 0x16u);
  ...
  objc_msgSend(MEMORY[0x24BE3F1D0], "internalMessageWithName:messagePayload:", CFSTR("kTakeSnapshotSendFailedNotificationKey"), v16);
...
- (void)snapshotRelayReceiver:(id)a3 didStartGettingImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back for getting image with error %@", (uint8_t *)&v15, 0x16u);
...
- (void)snapshotRelayReceiver:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v12;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back that the image %@ has been saved after relay with error %@", (uint8_t *)&v19, 0x20u);
...
- (void)snapshotStreamSender:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v14;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back that the image transfer to watch has begun", (uint8_t *)&v15, 0xCu);
...
- (void)snapshotStreamSender:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x16u);
...
void __50__HMDCameraSnapshotRemoteRelayStream_getSnapshot___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Getting the snapshot from local snapshot handler", (uint8_t *)&v7, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_101315 != -1)
    dispatch_once(&logCategory__hmf_once_t1_101315, &__block_literal_global_101316);
  return (id)logCategory__hmf_once_v2_101317;
}
...
void __49__HMDCameraSnapshotRemoteRelayStream_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_101317;
  logCategory__hmf_once_v2_101317 = v0;
