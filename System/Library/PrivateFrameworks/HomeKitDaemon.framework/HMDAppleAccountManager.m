...
+ (HMDAppleAccountManager)sharedManager
{
  ...
  block[4] = a1;
  if (sharedManager_onceToken_147418 != -1)
    dispatch_once(&sharedManager_onceToken_147418, block);
...
- (HMDAccount)account
{
  ...
  -[HMDAppleAccountManager accountRegistry](self, "accountRegistry");
...
- (HMDAppleAccountManager)initWithIDSService:(id)a3 activityBroadcaster:(id)a4 dataSource:(id)a5
{
  ...
  if (v9)
  {
    ...
    v12 = -[HMDAppleAccountManager init](&v50, sel_init);
    if (v12)
    {
      HMFGetOSLogHandle();
      ...
      v28 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F170]), "initWithMinimumTimeInterval:maximumTimeInterval:exponentialFactor:options:", 3, 1, 1.0, 86400.0);
      ...
      v32 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 2, 15.0);
      ...
      objc_msgSend(v34, "setDelegate:", v12);

      -[HMDAppleAccountManager devicesChangeBackoffTimer](v12, "devicesChangeBackoffTimer");
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v35, "setDelegateQueue:", v12->_queue);
      ...
      *(_QWORD *)obj = 0;
      ...
      v49 = 0;
      objc_msgSend(MEMORY[0x24BE3F180], "futureWithPromise:", &v49);
      ...
      v48 = 0;
      objc_msgSend(MEMORY[0x24BE3F180], "futureWithPromise:", &v48);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&obj[4] = v46;
      _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_ERROR, "%{public}@Service is required", obj, 0xCu);
...
- (void)_registerForRapportNotifications
{
  ...
  if (!-[HMDAppleAccountManager isRapportIdentitiesChangedNotificationTokenValid](self, "isRapportIdentitiesChangedNotificationTokenValid"))
  {
    ...
    if ((_DWORD)v4)
    {
      v9 = (void *)MEMORY[0x227676638](v4, v5, v6, v7);
      v10 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v23 = 1024;
        v24 = v8;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to register for %s: %d", buf, 0x1Cu);
...
- (void)configureWithAccountRegistry:(id)a3
{
  ...
  v4 = a3;
  -[HMDAppleAccountManager setAccountRegistry:](self, "setAccountRegistry:", v4);
  v17 = 0;
  v18 = &v17;
  v19 = 0x3032000000;
  v20 = __Block_byref_object_copy__147387;
  v21 = __Block_byref_object_dispose__147388;
  v22 = 0;
  objc_msgSend(v4, "fetchAccountsWithLocalFlag:", 1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v18[5])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v25 = 2112;
      v26 = v12;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Using local account %@ fetched from the database.", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v8);
    -[HMDAppleAccountManager deviceAccountSettledPromise](v9, "deviceAccountSettledPromise");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "fulfillWithNoValue");
...
- (HMDAccountRegistry)accountRegistry
{
  ...
  {
    result = (HMDAccountRegistry *)_HMFPreconditionFailure();
    __break(1u);
  }
  return result;
}
...
- (void)__handleModifiedAccount:(id)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 138543362;
      v21 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification account was modified", (uint8_t *)&v20, 0xCu);
      ...
      if (!v12)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            v20 = 138543362;
            v21 = v18;
            _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to create account", (uint8_t *)&v20, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 138543362;
      v21 = v14;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring account notification", (uint8_t *)&v20, 0xCu);
...
- (void)__handleRemovedAccountWithCompletion:(id)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v39 = 138543362;
      v40 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification account was removed", (uint8_t *)&v39, 0xCu);
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      {
        ...
        v39 = 138543362;
        v40 = v16;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_FAULT, "%{public}@Got primary iCloud account removed notification even though user is still signed in", (uint8_t *)&v39, 0xCu);
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v39 = 138543362;
        v40 = v20;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Got primary iCloud account removed notification even though user is still signed in", (uint8_t *)&v39, 0xCu);

      }
      objc_autoreleasePoolPop(v17);
      objc_msgSend(MEMORY[0x24BDD1540], "hmPrivateErrorWithCode:", 2721);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        v41 = 2112;
        v42 = account;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@Current account: %@", (uint8_t *)&v39, 0x16u);
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v39 = 138543362;
        v40 = v35;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Primary apple account is removed & logged out", (uint8_t *)&v39, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 138543362;
      v40 = v22;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring account notification", (uint8_t *)&v39, 0xCu);
...
- (void)__handleUpdatedName:(id)a3
{
  ...
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x24BE3F110]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Trying to update mergeID on currentAccount: %@", buf, 0x16u);
    ...
    {
      v13 = MEMORY[0x227675558](v12);
    }
    else if ((objc_msgSend(v12, "_appearsToBeBusinessID") & 1) != 0)
    {
      v13 = MEMORY[0x227675540](v12);
    }
    else
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v34 = 2112;
        v35 = v5;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot determine destination with handle value: %@, account handle: %@", buf, 0x20u);
  ...
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v3;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Account is missing a handle so cannot update mergeID: %@", buf, 0x16u);
...
- (void)updateSenderCorrelationIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7 && objc_msgSend(v7, "isEqual:", v4))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v12;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@MergeID is the same, not updating", buf, 0xCu);
    ...
    {
      v13 = (void *)MEMORY[0x227676638](objc_msgSend(v6, "setSenderCorrelationIdentifier:", v4));
      v14 = self;
      HMFGetOSLogHandle();
      v15 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v6;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Updated mergeID for currentAccount : %@. Also going to ask IDS about the mergeID.", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Current account went away, not updating", buf, 0xCu);
      ...
      if ((isKindOfClass & 1) != 0)
      {
        ...
        if ((v18 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v63 = v40;
            _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_DEBUG, "%{public}@Not pushing back account handles while inactive", buf, 0xCu);
...
LABEL_50:
            _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, v45, buf, 0x16u);
...
LABEL_54:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v63 = v29;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Manager cannot confirm account model process due to nil parameter.", buf, 0xCu);
...
LABEL_27:
    ...
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, v22, (uint8_t *)&v30, 0xCu);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    v30 = 138543362;
    v31 = v26;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Manager cannot confirm account model process due to nil parameter.", (uint8_t *)&v30, 0xCu);
...
{
  return objc_msgSend(a3, "isCurrentDevice");
}
  ...
  if (v8)
  {
    ...
    if ((v12 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v31;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Account update does not match current account identifier", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v39 = 2112;
        v40 = v27;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Account update does not match current account identifier -- current identifier: %@, received identifier: %@", buf, 0x20u);
...
- (void)processAccountModelRemove:(id)a3 message:(id)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unexpected object model received", buf, 0xCu);
LABEL_9:
...
LABEL_10:
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v29;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Account update does not match current account identifier", buf, 0xCu);
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v37 = 2112;
      v38 = v25;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Account update does not match current account identifier -- current identifier: %@, received identifier: %@", buf, 0x20u);
...
- (void)connection:(id)a3 didReceivePublicToken:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v20 = 2112;
    v21 = v13;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Received push token: %@", buf, 0x16u);
...
{
  return (NSUUID *)objc_msgSend(MEMORY[0x24BDD7600], "UUID");
}
...
- (void)account:(id)a3 isActiveChanged:(BOOL)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification that account is active changed", (uint8_t *)&v15, 0xCu);
...
- (void)account:(id)a3 aliasesChanged:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 138543362;
    v15 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification that aliases changed", (uint8_t *)&v14, 0xCu);
...
- (void)service:(id)a3 activeAccountsChanged:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Received notification that the current account changed", buf, 0xCu);
...
- (void)service:(id)a3 devicesChanged:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Received notification that devices changed on the current account", (uint8_t *)&v15, 0xCu);
...
- (void)accountChangeObserver:(id)a3 observedDeletedAccount:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification of removed account %@", buf, 0x16u);
...
void __71__HMDAppleAccountManager_accountChangeObserver_observedDeletedAccount___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 138543362;
    v15 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Resolving current device settled promise due to sign out", (uint8_t *)&v14, 0xCu);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v13;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Completed handling of removed account %@", (uint8_t *)&v14, 0x16u);
...
uint64_t __59__HMDAppleAccountManager_connection_didReceivePublicToken___block_invoke(uint64_t a1)
{
  ...
  if ((v2 & 1) != 0)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v11 = 138543362;
      v12 = v7;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification that the push token changed", (uint8_t *)&v11, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2048;
      v14 = v10;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@We got the push token before the apple account manager is started. Will process this token once it starts up. token length: %lu", (uint8_t *)&v11, 0x16u);
...
void __60__HMDAppleAccountManager___deviceRemovedFromCurrentAccount___block_invoke(uint64_t a1)
{
  ...
  if (v6)
  {
    ...
    if (!v7)
      __handleUpdatedDevice_147283(*(void **)(a1 + 40), 0);
  }
}
...
void __56__HMDAppleAccountManager___deviceAddedToCurrentAccount___block_invoke(uint64_t a1)
{
  ...
  if (v6)
  {
    ...
    __handleUpdatedDevice_147283(v7, v8);
...
void __50__HMDAppleAccountManager___updateMergeIDOnAccount__block_invoke_3(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v14;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Found mergeID %@ for destination %@, new attribute %@", (uint8_t *)&v20, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v19;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Did not get the mergeID after querying IDS: %@", (uint8_t *)&v20, 0x16u);
...
void __51__HMDAppleAccountManager___handleMigrationUpdated___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v7;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Received notification that migration completed", (uint8_t *)&v11, 0xCu);
  ...
  if (v2)
  {
    ...
    if ((v5 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v20 = 2112;
        v21 = v10;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Updating name: %@", (uint8_t *)&v18, 0x16u);
...
void __43__HMDAppleAccountManager___localDataReset___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "isMonitoring"))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 138543362;
      v17 = v5;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Repushing account transactions", (uint8_t *)&v16, 0xCu);
...
LABEL_14:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 138543362;
        v17 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to re-create account", (uint8_t *)&v16, 0xCu);
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot add account after local reset", (uint8_t *)&v16, 0xCu);
...
void __30__HMDAppleAccountManager_stop__block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "isMonitoring"))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping", buf, 0xCu);
  ...
  if ((result & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting", (uint8_t *)&buf, 0xCu);
    ...
    v31 = objc_msgSend(v30, "countByEnumeratingWithState:objects:count:", &v53, v57, 16);
    if (v31)
    {
      v32 = v31;
      v33 = *(_QWORD *)v54;
      do
      {
        ...
        v32 = objc_msgSend(v30, "countByEnumeratingWithState:objects:count:", &v53, v57, 16);
      }
      while (v32);
    }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_QWORD *)((char *)&buf + 4) = v43;
            _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to create account", (uint8_t *)&buf, 0xCu);
    ...
    if (v44)
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)((char *)&buf + 4) = v48;
        _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@We might have a missed the didReceivePublicToken earlier. Let's set the token first.", (uint8_t *)&buf, 0xCu);
    ...
    objc_msgSend(v52, "fulfillWithNoValue");
...
void __55__HMDAppleAccountManager_configureWithAccountRegistry___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@More than one account found. Removing %@", (uint8_t *)&v12, 0x16u);

    }
    objc_autoreleasePoolPop(v8);
    objc_msgSend(*(id *)(a1 + 40), "removeAccount:", v4);
  }
  else
  {
...
void __58__HMDAppleAccountManager__registerForRapportNotifications__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v7 = 138543362;
      v8 = v5;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification that rapport identity changed, update current device", (uint8_t *)&v7, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t107_147413 != -1)
    dispatch_once(&logCategory__hmf_once_t107_147413, &__block_literal_global_147414);
  return (id)logCategory__hmf_once_v108_147415;
}
...
void __37__HMDAppleAccountManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v108_147415;
  logCategory__hmf_once_v108_147415 = v0;
...
void __39__HMDAppleAccountManager_sharedManager__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 138543362;
    v15 = v13;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Creating an HMDAppleAccountManager", (uint8_t *)&v14, 0xCu);
