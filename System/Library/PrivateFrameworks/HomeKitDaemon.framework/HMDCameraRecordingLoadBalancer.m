...
- (void)recordingDidStartForCameraWithUUID:(id)a3
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(v7, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1B8], v8);
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v4;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Got recordingDidEndForCamera: %@ with numberOfActiveRecordingSessions == 0", (uint8_t *)&v27, 0x16u);
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v4;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Got recordingDidEndForCamera: %@ with no corresponding entry in recordingSessionSummariesByCameraUUIDString", (uint8_t *)&v27, 0x16u);
...
- (void)setReadyToRecord:(BOOL)a3 forCameraWithUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v6;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Setting ready to record to %@ for camera with UUID %@", (uint8_t *)&v15, 0x20u);
...
- (void)handleRecordingSessionForwardingSuccessForDecision:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v4;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling successful load balancing decision: %@", (uint8_t *)&v26, 0x16u);
...
- (id)_loadBalancingDecisionForCamera:(id)a3 deviceFilter:(id)a4
{
            ...
            for (i = 0; i != v11; ++i)
            {
              ...
              if (v15)
              {
                ...
                if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_WORD *)&buf[12] = 2112;
                  *(_QWORD *)&buf[14] = v21;
                  _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Expiring cached HMDCameraRecordingLoadBalancerDecision: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v97 = v44;
    _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_INFO, "%{public}@Residents sorted for camera (%@): %@", buf, 0x20u);
...
- (id)_loadBalancingDescriptionFromSortedNodes:(id)a3
{
  ...
  {
    objc_msgSend(v3, "na_map:", &__block_literal_global_242957);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)systemResourceUsageDidChangeTo:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating resource usage to %@", (uint8_t *)&v17, 0x16u);
...
id __75__HMDCameraRecordingLoadBalancer__loadBalancingDescriptionFromSortedNodes___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v6, "removeObject:", &stru_24E79DB48);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_242998 != -1)
    dispatch_once(&logCategory__hmf_once_t19_242998, &__block_literal_global_44_242999);
  return (id)logCategory__hmf_once_v20_243000;
}
...
void __45__HMDCameraRecordingLoadBalancer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v20_243000;
  logCategory__hmf_once_v20_243000 = v0;
