...
- (HMDMediaAccessoryAdvertisement)initWithOutputDevice:(id)a3
{
  ...
  if (+[HMDMediaAccessoryAdvertisement canAirPortExpressSupportMediaAccessory:](HMDMediaAccessoryAdvertisement, "canAirPortExpressSupportMediaAccessory:", v8))
  {
    ...
    v10 = (void *)objc_msgSend(v9, "initWithUUIDString:", *MEMORY[0x24BDD4990]);
    objc_msgSend(MEMORY[0x24BDD7338], "categoryWithIdentifier:", v10);
    v11 = (void *)objc_claimAutoreleasedReturnValue();

  }
  else
  {
    objc_msgSend(MEMORY[0x24BDD7338], "categoryForProductClass:", HMFProductClassFromString());
    v11 = (void *)objc_claimAutoreleasedReturnValue();
  }
