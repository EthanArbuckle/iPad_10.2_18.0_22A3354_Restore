...
- (SFDeviceDiscovery)deviceDiscovery
{
  ...
  if (!deviceDiscovery)
  {
    v4 = (SFDeviceDiscovery *)objc_alloc_init(MEMORY[0x24BE90128]);
...
- (void)setDiscoveryFlags:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2048;
    v12 = a3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Setting device discovery flags to %ld", (uint8_t *)&v9, 0x16u);
...
- (void)start
{
  ...
  objc_msgSend(v2, "activateWithCompletion:", &__block_literal_global_103614);
...
- (void)repairDevice:(id)a3 flags:(unsigned int)a4 completion:(id)a5
{
  ...
  v5 = *(_QWORD *)&a4;
  v7 = a5;
  v8 = (objc_class *)MEMORY[0x24BE900E8];
  v9 = a3;
