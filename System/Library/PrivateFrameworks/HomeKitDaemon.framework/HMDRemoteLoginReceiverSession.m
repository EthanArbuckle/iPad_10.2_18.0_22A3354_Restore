...
- (HMDRemoteLoginReceiverSession)initWithSessionID:(id)a3 remoteAuthentication:(id)a4 completion:(id)a5
{
  ...
  id v10;
  id v11;
  HMDRemoteLoginReceiverSession *v12;
  HMDRemoteLoginReceiverSession *v13;
  void *v14;
  id completion;
  objc_super v17;
  ...
  v12 = -[HMDRemoteLoginReceiverSession init](&v17, sel_init);
  v13 = v12;
  if (v12)
  {
...
{
  void *v3;
  HMDRemoteLoginReceiverSession *v4;
  NSObject *v5;
  void *v6;
  objc_super v7;
  uint8_t buf[4];
  ...
  -[HMDRemoteLoginReceiverSession dealloc](&v7, sel_dealloc);
}
...
- (id)description
{
  ...
  -[HMDRemoteLoginReceiverSession sessionID](self, "sessionID");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("[Login-Receiver-Session: %@]"), v3);
