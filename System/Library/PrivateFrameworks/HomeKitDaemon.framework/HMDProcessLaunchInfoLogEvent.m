...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent submissionState](self, "submissionState"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent homeDataLoadedMilliseconds](self, "homeDataLoadedMilliseconds"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("homeDataLoadedMilliseconds"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent xpcMessageTransportReadyMilliseconds](self, "xpcMessageTransportReadyMilliseconds"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v13, CFSTR("xpcMessageTransportReadyMilliseconds"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent millisecondsSinceLaunchToDataSyncStateGood](self, "millisecondsSinceLaunchToDataSyncStateGood"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("dataSyncStateGoodMilliseconds"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent millisecondsToAccountResolved](self, "millisecondsToAccountResolved"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v15, CFSTR("accountResolvedMilliseconds"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent numUncommittedRecords](self, "numUncommittedRecords"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v16, CFSTR("numUncommittedRecords"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent numUncommittedAndPushedRecords](self, "numUncommittedAndPushedRecords"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent processLaunchCount](self, "processLaunchCount"));
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v20, CFSTR("processLaunchCount"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent processExitCount](self, "processExitCount"));
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v21, CFSTR("processExitCount"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent processCrashCount](self, "processCrashCount"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v22, CFSTR("processCrashCount"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent processJetsamCount](self, "processJetsamCount"));
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v23, CFSTR("processJetsamCount"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDProcessLaunchInfoLogEvent processIdleExitCount](self, "processIdleExitCount"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v24, CFSTR("processIdleExitCount"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDProcessLaunchInfoLogEvent isConfigurationLoaded](self, "isConfigurationLoaded"));
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v25, CFSTR("isConfigurationLoaded_BOOL"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDProcessLaunchInfoLogEvent isTTSUInProgress](self, "isTTSUInProgress"));
