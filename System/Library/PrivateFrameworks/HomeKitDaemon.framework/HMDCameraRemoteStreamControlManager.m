...
- (void)_negotiateStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v28 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Received a request to relay start stream to resident", buf, 0xCu);
...
- (void)_setParametersSelected:(id)a3
{
  ...
  {
    v66 = 0;
    objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v6, &v66);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v66;
    if (v9)
    {
      v65 = v10;
      objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v8, &v65);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v64 = v65;
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v69 = 2112;
          v70 = v31;
          _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Received protocol parameters with Setup Endpoint Write %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v69 = 2112;
          v70 = v36;
          _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Setup Endpoint Read %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v69 = 2112;
          v70 = v41;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@Selected stream config %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v69 = 2112;
          v70 = v64;
          _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera video tier parameters from video parameters data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v69 = 2112;
        v70 = v10;
        _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera protocol parameters from protocol parameters data: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v68 = v46;
      _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_ERROR, "%{public}@Did not get protocol or tier parameters data", buf, 0xCu);
...
- (void)_idsSessionCreatedAndConfigNegotiated
{
  ...
  if ((objc_msgSend(v3, "containsState:", 4) & 1) != 0)
  {
    ...
    if ((v5 & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138543362;
        v19 = v9;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Negotiation is completed", (uint8_t *)&v18, 0xCu);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v17;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Current state: %@, waiting", (uint8_t *)&v18, 0x16u);
...
- (void)_relaySessionStarted:(id)a3
{
  ...
  if (v5)
  {
    if (v4)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 2112;
        v19 = v4;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Relay session failed to start: %@", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Stream session is no longer valid, stopping the IDS session", (uint8_t *)&v16, 0xCu);
...
- (void)_startStreamWithRemoteSettings:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v60 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Stream sender is set, redispatching the start request to resident", buf, 0xCu);
  ...
  else
  {
    ...
    if (v39)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v60 = v55;
          _os_log_impl(&dword_2218F0000, v54, OS_LOG_TYPE_ERROR, "%{public}@Could not extract a configuration from the given parameters", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v60 = v51;
        _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_ERROR, "%{public}@Failed to create stream manager for remote stream", buf, 0xCu);
...
- (void)_dispatchStartRequestToResidentWithVideoSSRC:(id)a3 audioSSRC:(id)a4
{
  ...
  if (v6 && v7)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Dispatching the start request to resident", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v32;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@No SSRC, cannot start the stream", buf, 0xCu);
...
- (void)_setUpRemoteConnectionWithDevice:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Remote side has been setup", (uint8_t *)&v11, 0xCu);
...
- (void)_stopCurrentStreamSessionWithError:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@No current stream session to stop", (uint8_t *)&v12, 0xCu);
...
- (void)_sendStopMessageToResident
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Sending stop stream message to resident", buf, 0xCu);
  ...
  -[HMDCameraStreamControlManager workQueue](v4, "workQueue");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "sendMessageWithName:cameraSessionID:payload:target:responseQueue:responseHandler:", CFSTR("kStopRemoteStreamRequestKey"), v11, v9, v12, v13, &__block_literal_global_45759);
...
- (void)sessionReceiver:(id)a3 didEndSessionWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Received a callback that IDS session has ended, stopping the stream", (uint8_t *)&v12, 0xCu);
...
- (void)deviceConnectionSender:(id)a3 didSetUpWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up IDSDeviceConnection for stream", (uint8_t *)&v12, 0xCu);
...
- (void)deviceConnectionSender:(id)a3 didEndSessionWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Received a callback that IDS initiator session has ended, stopping the stream", (uint8_t *)&v12, 0xCu);
...
- (void)streamManager:(id)a3 didStartStreamWithError:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Stream manager did start stream", buf, 0xCu);
...
- (void)streamManagerDidStopStream:(id)a3 error:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Session stopped before starting; cleaning up the stream",
        (uint8_t *)&v14,
        0xCu);
...
- (void)_dispatchReconfigureToResident:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v16 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Dispatching the reconfigure request to resident", buf, 0xCu);
...
- (void)_sendUpdatedConfiguration
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending updated configuration", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v23 = v20;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Reselected config failed to extract", buf, 0xCu);
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138543362;
        v19 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Received reply for reconfigure remote stream session for session", (uint8_t *)&v18, 0xCu);
      ...
      if (v5)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v20 = 2112;
          v21 = v5;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Relayed reconfigure remote stream session request to resident failed: %@", (uint8_t *)&v18, 0x16u);
...
uint64_t __59__HMDCameraRemoteStreamControlManager_stopStreamWithError___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to stop", (uint8_t *)&v8, 0xCu);
...
void __71__HMDCameraRemoteStreamControlManager_setUpRemoteConnectionWithDevice___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to remotely set up", (uint8_t *)&v7, 0xCu);
...
uint64_t __58__HMDCameraRemoteStreamControlManager__reconfigureStream___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to reconfigure", (uint8_t *)&v13, 0xCu);
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138543362;
        v19 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Received reply for start remote stream session for session", (uint8_t *)&v18, 0xCu);
      ...
      if (v5)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v20 = 2112;
          v21 = v5;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Relayed start remote stream session request to resident failed: %@", (uint8_t *)&v18, 0x16u);
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138543362;
        v19 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Received reply for negotiate remote stream session", (uint8_t *)&v18, 0xCu);
      ...
      if (v5)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v20 = 2112;
          v21 = v5;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Relayed negotiate remote stream session request to resident failed: %@", (uint8_t *)&v18, 0x16u);
