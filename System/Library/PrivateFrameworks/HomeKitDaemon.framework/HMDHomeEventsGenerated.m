...
+ (id)topicMap
{
  return &unk_24E9732B0;
}

+ (id)allTopics
{
  return &unk_24E9712E8;
}
...
+ (id)indexTopicForTopicSuffix:(id)a3 indexName:(id)a4
{
  ...
  v5 = a4;
  +[؋ objectForKeyedSubscript:](&unk_24E973328, "objectForKeyedSubscript:", a3);
...
{
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("index.home.%@.info"), a3);
}
  ...
  if (v3)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (v6)
        {
          +[؋ objectForKeyedSubscript:](&unk_24E973418, "objectForKeyedSubscript:", CFSTR("indexes"));
          v12 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)upstreamHomeTopicForTopic:(id)a3 homeUUID:(id)a4
{
  ...
  +[؋ objectForKeyedSubscript:](&unk_24E973490, "objectForKeyedSubscript:", v19);
...
+ (id)accessorySettingsTopicsForAccessory:(id)a3 homeUUID:(id)a4
{
  ...
  if (v8)
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v13, "isEqualToString:", *MEMORY[0x24BDD49E0]) & 1) != 0)
    {
...
void __63__HMDHomeEventsGenerated_expandedTopicsWithTopics_homeManager___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4 && objc_msgSend(v4, "isIndexTopic"))
  {
    ...
    else
    {
      ...
      v64 = 0u;
      v65 = 0u;
      v32 = +[؋ countByEnumeratingWithState:objects:count:](&unk_24E973508, "countByEnumeratingWithState:objects:count:", &v64, v72, 16);
      if (v32)
      {
        v33 = v32;
        v34 = *(_QWORD *)v65;
        do
        {
          ...
          {
            if (*(_QWORD *)v65 != v34)
              objc_enumerationMutation(&unk_24E973508);
            v36 = *(_QWORD *)(*((_QWORD *)&v64 + 1) + 8 * i);
            +[؋ objectForKeyedSubscript:](&unk_24E973580, "objectForKeyedSubscript:", v36);
          ...
          v33 = +[؋ countByEnumeratingWithState:objects:count:](&unk_24E973508, "countByEnumeratingWithState:objects:count:", &v64, v72, 16);
        }
        while (v33);
      }
...
LABEL_18:
      ...
      else
      {
        ...
        if (v14)
        {
          objc_msgSend(v5, "topicSuffix");
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          +[؋ objectForKeyedSubscript:](&unk_24E9733A0, "objectForKeyedSubscript:", v15);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
