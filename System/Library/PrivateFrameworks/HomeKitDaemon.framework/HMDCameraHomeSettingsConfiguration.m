  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v68 = 2112;
      v69 = v25;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Camera accessory settings: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v68 = 2112;
      v69 = v39;
      _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Camera user settings: %@", buf, 0x16u);
