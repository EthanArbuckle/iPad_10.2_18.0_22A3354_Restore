...
- (void)setIdle:(BOOL)a3
{
  ...
  if (idle != v3)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v6, "conformsToProtocol:", &unk_2557EF1B8))
      v7 = v6;
    else
      v7 = 0;
    v8 = v7;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)&location[4] = v28;
      v51 = 2112;
      v52 = v29;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot open stream, failed to get local pairing identity with error: %@", location, 0x16u);
...
- (void)_closeWithError:(id)a3
{
  ...
  -[HMFMessageTransport delegate](self, "delegate");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v4, "conformsToProtocol:", &unk_2557EF1B8))
    v5 = v4;
  else
    v5 = 0;
  v6 = v5;
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification device was removed from account", (uint8_t *)&v13, 0xCu);

      }
      objc_autoreleasePoolPop(v8);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 17, 0, CFSTR("Device was removed from account."), 0);
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v12;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification account was removed from registry", (uint8_t *)&v14, 0xCu);

      }
      objc_autoreleasePoolPop(v9);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 17, 0, CFSTR("Account was removed from registry."), 0);
      ...
      if (v11)
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            v20 = 138543362;
            v21 = v18;
            _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Received notification peer identity was removed", (uint8_t *)&v20, 0xCu);

          }
          objc_autoreleasePoolPop(v15);
          objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 17, 0, CFSTR("Identity was removed."), 0);
          v19 = (void *)objc_claimAutoreleasedReturnValue();
...
void __70__HMDSecureRemoteStream_handleSecureMessage_fromDevice_fromTransport___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = *(void **)(a1 + 40);
    objc_msgSend(MEMORY[0x24BDBCF20], "setWithObject:", CFSTR("kIDSMessageSourceIDKey"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2112;
    v31 = v8;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Received encrypted secure message: %@", buf, 0x16u);
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v20;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Unable to map productClass for device %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v17);
    v16 = CFSTR("Unknown");
  }
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v14, CFSTR("kRemoteMessageRestrictionKey"));
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v27[0] = v21;
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend((id)objc_opt_class(), "restriction"));
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v27[3] = v23;
...
void __96__HMDSecureRemoteStream_handleCompletedMessage_options_responsePayload_error_completionHandler___block_invoke(uint64_t a1)
{
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v36 = 2112;
        v37 = v6;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize error with error: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v7);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 52, CFSTR("Generic error."), CFSTR("Failed to deserialize remote error."), 0, v6);
      v5 = (void *)objc_claimAutoreleasedReturnValue();
    }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v46 = 2114;
    v47 = v20;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Received response %{public}@ to secure message: %{public}@ and identifier %{public}@, with transport error: %{public}@, error: %{public}@, options: %{public}@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = v32;
    _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@The session is now idle", buf, 0xCu);
...
void __55__HMDSecureRemoteStream_sendMessage_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v42 = 2112;
    v43 = v14;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Sending message: %@", buf, 0x16u);
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = v17;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Message serialization failed: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v18);
  }
  v38[0] = CFSTR("kRemoteMessageRestrictionKey");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v2, "restriction"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v39[0] = v22;
  ...
  v27 = objc_alloc(MEMORY[0x24BE3F138]);
  MEMORY[0x227675180](*(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 56));
  v28 = (void *)objc_claimAutoreleasedReturnValue();
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 48, CFSTR("Not supported"), CFSTR("Cannot send messages without a valid pairing identity"), 0, *(_QWORD *)(a1 + 32));
  v2 = (id)objc_claimAutoreleasedReturnValue();
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that remote session has stopped due to error: %@", (uint8_t *)&v9, 0x16u);
      ...
      if ((v8 & 1) == 0)
      {
        ...
        if (v12)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            v25 = 138543362;
            v26 = v16;
            _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Swapping out the local pairing identifier for legacy remote sessions", (uint8_t *)&v25, 0xCu);
      ...
      if (v13 && v11 != v13)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v78 = 2112;
          v79 = v13;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Peer device resolved from the registry -- tracked: %@, resolved: %@", buf, 0x20u);
...
LABEL_10:
        ...
        if ((v32 & 1) != 0)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v75 = v36;
            _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Successfully authenticated peer identity", buf, 0xCu);
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v76 = 2112;
          v77 = v50;
          _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to authenticate peer identity for device: %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v80 = 2112;
          v81 = v69;
          _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_INFO, "%{public}@The provided pairing identity, %@, for peer, %@, is not registered to account: %@", buf, 0x2Au);
...
LABEL_16:
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v75 = v29;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping account authentication check as the peer account is not authenticated", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v60, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v76 = 2112;
            v77 = v63;
            _os_log_impl(&dword_2218F0000, v60, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDSecureSession] Unable to get the 'userID' from destination '%@'", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v78 = 2112;
        v79 = v44;
        _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find identity, %@, for peer: %@", buf, 0x20u);
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_311(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v72 = 2112;
        v73 = v23;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Received request to setup reverse secure connection: %@", buf, 0x16u);
    ...
    else
    {
      ...
      v42 = (void *)MEMORY[0x227676638](objc_msgSend(v13, "setSecure:", 1));
      v43 = WeakRetained;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v74 = 2112;
        v75 = v49;
        _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@Received decrypted secure message, %@, with payload: %@", buf, 0x20u);
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_3_321(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if ((_DWORD)v10)
    {
      objc_msgSend(v8, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("supportsSharedIdentities"));
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", maximumSecureRemoteStreams);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v44 = 2112;
      v45 = v6;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending encrypted secure message %@ to %@ with options:\n%@", (uint8_t *)&v38, 0x2Au);
    ...
    v32 = v31;
    v33 = -[HMDRemoteMessage initWithName:destination:payload:type:timeout:secure:restriction:]([HMDRemoteMessage alloc], "initWithName:destination:payload:type:timeout:secure:restriction:", v32, v23, v8, 3, 0, 17, v27);
    objc_msgSend(v6, "hmf_stringForKey:", CFSTR("kRemoteMessageAttributedMessageNameKey"));
    v34 = (void *)objc_claimAutoreleasedReturnValue();

    -[HMDRemoteMessage setAttributedMessageName:](v33, "setAttributedMessageName:", v34);
    objc_msgSend(v15, "delegate");
    v35 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v35, "conformsToProtocol:", &unk_2557EF1B8))
      v36 = v35;
    else
      v36 = 0;
    v37 = v36;
    ...
    if (v37)
      objc_msgSend(v37, "secureRemoteStream:receivedRequestToSendMessage:", v15, v33);
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_316(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v34 = 2114;
    v35 = v5;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to decrypted secure message: %{public}@, payload %@ with error: %{public}@", buf, 0x2Au);
...
uint64_t __65__HMDSecureRemoteStream_startAndInvokeOnQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v7;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting secure session in %@ mode", (uint8_t *)&v9, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t98 != -1)
    dispatch_once(&logCategory__hmf_once_t98, &__block_literal_global_344_242164);
