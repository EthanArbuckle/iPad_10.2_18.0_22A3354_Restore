...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1B9F0], "wrappertlv:name:objectCreator:", 1, CFSTR("kVideoCodecParameters__ProfileID"), &__block_literal_global_6473);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1B9F0], "wrappertlv:name:objectCreator:", 2, CFSTR("kVideoCodecParameters__Level"), &__block_literal_global_95);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1B9F0], "wrappertlv:name:objectCreator:", 3, CFSTR("kVideoCodecParameters__PacketizationMode"), &__block_literal_global_97);
