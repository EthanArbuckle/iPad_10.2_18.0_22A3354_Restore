...
- (id)translateImageWidth:(id)a3 imageHeight:(id)a4
{
  ...
  v5 = a3;
  v6 = a4;
  if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A1C0)
    && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A1D8) & 1) != 0)
  {
    v7 = 1;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A1F0)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A208) & 1) != 0)
  {
    v7 = 2;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A220)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A1F0) & 1) != 0)
  {
    v7 = 3;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A238)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A250) & 1) != 0)
  {
    v7 = 4;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A268)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A280) & 1) != 0)
  {
    v7 = 5;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A1C0)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A298) & 1) != 0)
  {
    v7 = 6;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A1F0)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A2B0) & 1) != 0)
  {
    v7 = 7;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A220)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A208) & 1) != 0)
  {
    v7 = 8;
         ...
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A2C8) & 1) != 0)
  {
    v7 = 9;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A2E0)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A2F8) & 1) != 0)
  {
    v7 = 10;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A2B0)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A1F0) & 1) != 0)
  {
    v7 = 11;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A208)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A220) & 1) != 0)
  {
    v7 = 12;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A2C8)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A268) & 1) != 0)
  {
    v7 = 13;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A2F8)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A2E0) & 1) != 0)
  {
    v7 = 14;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A310)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A328) & 1) != 0)
  {
    v7 = 15;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A340)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A2F8) & 1) != 0)
  {
    v7 = 16;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A328)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A310) & 1) != 0)
  {
    v7 = 17;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A2F8)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A340) & 1) != 0)
  {
    v7 = 18;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A280)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A268) & 1) != 0)
  {
    v7 = 19;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A250)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A238) & 1) != 0)
  {
    v7 = 20;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A1F0)
  ...
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A1D8)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A1C0) & 1) != 0)
  {
    v7 = 23;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A358)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A358) & 1) != 0)
  {
    v7 = 24;
  }
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A2F8)
  ...
  else if (objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A370)
         && (objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A388) & 1) != 0)
  {
    v7 = 28;
  }
  else
  {
    if (!objc_msgSend(v5, "isEqualToNumber:", &unk_24E96A388)
      || !objc_msgSend(v6, "isEqualToNumber:", &unk_24E96A370))
    {
      v8 = 0;
      goto LABEL_89;
    }
...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 1, CFSTR("kVideoAttributes__ImageWidth"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 2, CFSTR("kVideoAttributes__ImageHeight"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 3, CFSTR("kVideoAttributes__FrameRate"));
...
+ (BOOL)translateImageResolution:(id)a3 imageWidth:(id *)a4 imageHeight:(id *)a5
{
  ...
  if (v7 <= 0x1C)
  {
    v8 = (void *)qword_24E774CA0[v7];
    *a4 = (id)qword_24E774BB8[v7];
    *a5 = v8;
  }
  return v7 < 0x1D;
}
