...
- (void)_encodeForSPIEntitledXPCTransportWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x24BDD4908]);
...
LABEL_38:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    v24 = 2048;
    v25 = v9;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@HMDNetworkRouterFirewallRuleWANPurpose value 0x%lx contains flags with no explicit mapping to HMAccessoryAllowedHostPurpose", (uint8_t *)&v22, 0x16u);
...
LABEL_42:
  ...
  objc_msgSend(v4, "encodeObject:forKey:", v16, *MEMORY[0x24BDD4910]);
  ...
  objc_msgSend(v4, "encodeObject:forKey:", v19, *MEMORY[0x24BDD4900]);

  -[HMDAccessoryAllowedHost jsonWANRule](self, "jsonWANRule");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v21 = objc_msgSend(v20, "isEqualToString:", CFSTR("{\"f\":0,\"n\":\"Any Internet Destination\",\"r\":{\"i\":\"*\",\"it\":[{\"p\":1,\"t\":0}]},\"t\":5,\"u\":1}"));

  objc_msgSend(v4, "encodeBool:forKey:", v21, *MEMORY[0x24BDD4918]);
}
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAccessoryAllowedHost purpose](self, "purpose"));
...
+ (id)allowedHostsFromJSONFirewallWANRules:(id)a3
{
  ...
  objc_msgSend(a3, "na_map:", &__block_literal_global_130274);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (!v3)
