...
- (void)_askForUserPermissionFromDevice:(id)a3 executionSessionID:(id)a4
{
    ...
    if ((v11 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v38 = v21;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Cannot find the compatible resident to send the permission request, marking it as failure", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v27;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Cannot ask for permission without execution session identifier", buf, 0xCu);
...
- (void)_createBulletinNotification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Not creating a bulletin because event trigger is nil", (uint8_t *)&v19, 0xCu);
...
- (void)_userResponse:(unint64_t)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v54 = 2112;
    v55 = v11;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Bulletin notification response ended with %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v54 = 2112;
      v55 = v25;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@self.metricEvent.metric.userResponseDelay %@", buf, 0x16u);
  ...
  if (v29)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v33;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_INFO, "%{public}@Issuing trigger reponse to local execution session", buf, 0xCu);
  ...
  else
  {
    ...
    if (!-[HMDEventTriggerSession sendResidentMessage:payload:responseHandler:](v8, "sendResidentMessage:payload:responseHandler:", CFSTR("kEventTriggerUserPermissionResponseKey"), v34, v40))
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v53 = v44;
        _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@Could not find compatible resident, Cannot send response", buf, 0xCu);
...
- (void)_handleUserPermissionRemoteResponse:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v25 = 2112;
    v26 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response %@ from the device %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v19;
            ...
            v26 = 2112;
            v27 = v10;
            _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending the remove dialog message to %@", buf, 0x16u);
...
- (void)_handleUserPermissionRemoveDialogRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received user confirmation remove dialog request", (uint8_t *)&v9, 0xCu);
...
- (void)_sessionComplete
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Declaring session is complete", (uint8_t *)&v8, 0xCu);
...
void __74__HMDEventTriggerUserConfirmationSession__userResponse_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v5;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending user permission response resulted with error %@", (uint8_t *)&v13, 0x16u);
...
void __55__HMDEventTriggerUserConfirmationSession_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if ((_DWORD)v2)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@User did not respond to confirm trigger execution", (uint8_t *)&v8, 0xCu);
...
void __93__HMDEventTriggerUserConfirmationSession__askForUserPermissionFromDevice_executionSessionID___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v5;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Received error for user permission request: %@, marking user permission as denied", (uint8_t *)&v15, 0x16u);
...
void __63__HMDEventTriggerUserConfirmationSession_askForUserPermission___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      if (v9)
      {
        ...
        v17 = 138543362;
        v18 = v10;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@This device owns the trigger, asking the permission locally", (uint8_t *)&v17, 0xCu);
    ...
    else
    {
      if (v9)
      {
        ...
        v19 = 2112;
        v20 = v16;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@This device does not own the trigger, asking the permission with the device %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Confirmation session is missing associated execution session identifier", (uint8_t *)&v17, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_177343 != -1)
    dispatch_once(&logCategory__hmf_once_t0_177343, &__block_literal_global_177344);
  return (id)logCategory__hmf_once_v1_177345;
}
...
void __53__HMDEventTriggerUserConfirmationSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_177345;
  logCategory__hmf_once_v1_177345 = v0;
