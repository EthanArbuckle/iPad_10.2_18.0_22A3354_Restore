...
- (HMDCloudPairedMetadataDiagnostics)initWithAccessoryIdentifier:(id)a3 jsonDictionary:(id)a4
{
  ...
  *(_QWORD *)&v38[13] = *MEMORY[0x24BDAC8D0];
  v6 = a3;
  v7 = a4;
      ...
      if (v17)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v38 = v20;
          v38[2] = 2112;
          *(_QWORD *)&v38[3] = v6;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid uploadType: %u received in JSON for accessory: %@", buf, 0x1Cu);
...
LABEL_17:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    *(_QWORD *)v38 = v6;
    _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Version configuration must contain firmware version: %@", buf, 0x16u);
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCloudPairedMetadataDiagnostics consentVersion](self, "consentVersion"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = (void *)objc_msgSend(v9, "initWithName:value:", CFSTR("consentVersion"), v10);
  v17[2] = v11;
  v12 = objc_alloc(MEMORY[0x24BE3F140]);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCloudPairedMetadataDiagnostics uploadType](self, "uploadType"));
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_164176 != -1)
    dispatch_once(&logCategory__hmf_once_t0_164176, &__block_literal_global_164177);
  return (id)logCategory__hmf_once_v1_164178;
}
...
void __48__HMDCloudPairedMetadataDiagnostics_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_164178;
  logCategory__hmf_once_v1_164178 = v0;
