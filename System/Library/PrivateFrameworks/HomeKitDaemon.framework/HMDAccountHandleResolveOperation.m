...
- (void)main
{
  ...
  -[HMDRemoteMessage setResponseRestriction:](v11, "setResponseRestriction:", 1);
  v49 = 0;
  +[HMDRemoteMessageSerialization dictionaryForMessage:isHH2Payload:error:](HMDRemoteMessageSerialization, "dictionaryForMessage:isHH2Payload:error:", v11, 1, &v49);
  ...
  if (v12)
  {
    ...
    v52[1] = *MEMORY[0x24BE4FAA8];
    v53[0] = v16;
    v53[1] = MEMORY[0x24BDBD1C8];
    ...
    if ((v23 & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = v24;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Started resolve with identifier: %@", buf, 0x16u);
      ...
      v36 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v24);
      v10 = v45;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = v44;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to send message with error: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v25);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 54, 0, 0, 0, v44);
      v34 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = v14;
      _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize message with error: %@", buf, 0x16u);
    ...
    if (v21)
    {
      ...
      if (v10)
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          v29 = 138543362;
          v30 = v26;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Confirmed resolve sent successfully", (uint8_t *)&v29, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v31 = 2112;
          v32 = v17;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send message to server with error: %@", (uint8_t *)&v29, 0x16u);

        }
        objc_autoreleasePoolPop(v22);
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 54, 0, 0, 0, v17);
      ...
      if ((objc_msgSend(v21, "hmf_isEqualToUUID:", v20) & 1) != 0)
      {
          ...
          if ((v25 & 1) != 0)
          {
            if (v29)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v55 = 2112;
              v56 = v50;
              _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Received response from: %@", buf, 0x16u);
          ...
          else
          {
            if (v29)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v55 = 2112;
              v56 = v50;
              _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Ignoring response from unsupported device: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v54 = v43;
            _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Failed to parse sender account handle", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v57 = 2112;
          v58 = v52;
          _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring message with transaction ID: %@, expected %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_75635 != -1)
    dispatch_once(&logCategory__hmf_once_t4_75635, &__block_literal_global_75636);
  return (id)logCategory__hmf_once_v5_75637;
}
...
void __47__HMDAccountHandleResolveOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_75637;
  logCategory__hmf_once_v5_75637 = v0;
