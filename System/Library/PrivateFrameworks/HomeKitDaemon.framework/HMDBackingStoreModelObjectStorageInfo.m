  ...
  *((_BYTE *)v22 + 8) = v10;
  ...
  if (v37)
  {
    if ((-[objc_class isSubclassOfClass:](a3, "isSubclassOfClass:", objc_opt_class()) & 1) != 0)
    {
      ...
      {
        objc_msgSend(v37, "hmf_enumerateWithAutoreleasePoolUsingBlock:", &__block_literal_global_22009);
  ...
  if (v23 && v10 && (objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v49 = 2112;
      v50 = v34;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to create a Storage Info with a default value %@ of type %@ when the stored type is %@", buf, 0x2Au);
...
void __131__HMDBackingStoreModelObjectStorageInfo_initWithClass_logging_readOnly_unavailable_defaultSet_defaultValue_additonalDecodeClasses___block_invoke(uint64_t a1, objc_class *a2, _BYTE *a3)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Encoding top level type of %@ will fail in the future.", (uint8_t *)&v11, 0x16u);
