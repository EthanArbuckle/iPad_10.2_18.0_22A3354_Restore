...
- (BOOL)accessoryReachable:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v5;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: accessory %@ is now reachable.", (uint8_t *)&v11, 0x20u);
...
- (BOOL)accessoryUnreachable:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v5;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: accessory %@ is now unreachable.", (uint8_t *)&v11, 0x20u);
...
- (BOOL)recvDataFromAccessory:(id)a3 data:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", (uint8_t *)&v14, 0x16u);
...
- (BOOL)applyStagedAssetsForAccessory:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", (uint8_t *)&v11, 0x16u);
...
- (BOOL)pauseAssetTransfersForAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", (uint8_t *)&v10, 0x16u);
...
- (BOOL)cancelAssetStagingForAccessory:(id)a3 asset:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", (uint8_t *)&v13, 0x16u);
