...
- (BOOL)evaluate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", (uint8_t *)&v8, 0xCu);
...
- (void)notify:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending notification with policy status %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v5);
  objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", v3, CFSTR("HMDAccessoryFirmwareUpdatePolicyStatusChangedKey"));
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_140770 != -1)
    dispatch_once(&logCategory__hmf_once_t0_140770, &__block_literal_global_140771);
  return (id)logCategory__hmf_once_v1_140772;
}
...
void __47__HMDAccessoryFirmwareUpdatePolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_140772;
  logCategory__hmf_once_v1_140772 = v0;
