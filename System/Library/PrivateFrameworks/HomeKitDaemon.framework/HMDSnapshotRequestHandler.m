  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Completion handler is nil", buf, 0xCu);
...
- (void)streamSnapshotHandler:(id)a3 didGetNewSnapshot:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Received new snapshot", (uint8_t *)&v13, 0xCu);
...
- (void)streamSnapshotHandler:(id)a3 didGetLastSnapshot:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Received last snapshot", (uint8_t *)&v13, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (mostRecentSnapshotInvalidationTimer == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Snapshot invalidation timer has fired, resetting the most recent snapshot", (uint8_t *)&v10, 0xCu);
...
- (HMDSnapshotFile)_saveSnapshotFile:(id *)a1
{
  ...
  if (a1)
  {
    ...
    if (v7)
    {
      ...
      v8 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 0, 2.0);
      v9 = a1[6];
      a1[6] = (id)v8;
    ...
    if ((unint64_t)objc_msgSend(v7, "count") < 2)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v58 = v25;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Need to gather supported video resolutions by the camera", buf, 0xCu);
        ...
        if (v26)
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v58 = v29;
            _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Getting Supported Configuration", buf, 0xCu);
          ...
          if (v46)
          {
            ...
            {
              v34 = *(_QWORD *)v54;
              v35 = *MEMORY[0x24BE1B7A0];
              v36 = *MEMORY[0x24BE1B600];
              do
              {
                for (i = 0; i != v33; ++i)
                {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v59 = 2112;
        v60 = v14;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@There is already a request in progress so piggy backing on that: %@", buf, 0x16u);
...
LABEL_3:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v58 = v19;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Most recent snapshot is still valid", buf, 0xCu);
  ...
  if (a1)
  {
    ...
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v20;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Accessory is no longer available, cannot handle snapshot request", buf, 0xCu);
    ...
    if (v8)
    {
      ...
      if ((unint64_t)(v9 - 1) < 0xA)
      {
        if (v13)
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(_QWORD *)&buf[14] = v15;
          _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Overriding the resolution requested to %@", buf, 0x16u);
...
LABEL_37:
        ...
        objc_msgSend(v51, "setObject:forKeyedSubscript:", *MEMORY[0x24BE1B8E0], *MEMORY[0x24BE1B900]);
        -[HMDVideoResolution imageWidth](v91, "imageWidth");
        v52 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v51, "setObject:forKeyedSubscript:", v52, *MEMORY[0x24BE1B8F0]);

        -[HMDVideoResolution imageHeight](v91, "imageHeight");
        v53 = (void *)objc_claimAutoreleasedReturnValue();

        objc_msgSend(v51, "setObject:forKeyedSubscript:", v53, *MEMORY[0x24BE1B8E8]);
        v54 = v51;
        v55 = v50;
        ...
        if (v56)
        {
          ...
          if (v57)
          {
            objc_msgSend(v54, "setObject:forKeyedSubscript:", v57, *MEMORY[0x24BE1B480]);
          }
          else
          {
            ...
            if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              *(_QWORD *)&buf[4] = v61;
              _os_log_impl(&dword_2218F0000, v60, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the HAP instance id (aid) for bridged accessory.", buf, 0xCu);
...
LABEL_46:
          ...
          objc_msgSend(v67, "findCharacteristicWithType:", *MEMORY[0x24BDD58A8]);
          ...
          objc_msgSend(v54, "setObject:forKeyedSubscript:", v78, *MEMORY[0x24BE1B8F8]);
...
LABEL_54:
          ...
          if (os_log_type_enabled(v76, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&v99[18] = 1024;
            *(_DWORD *)&v99[20] = v70;
            _os_log_impl(&dword_2218F0000, v76, OS_LOG_TYPE_INFO, "%{public}@Either event snapshot active characteristic (%d) or periodic snapshot active characteristic (%d) is not present", v99, 0x18u);
        ...
        *(_QWORD *)&buf[16] = 0x3032000000;
        v103 = __Block_byref_object_copy__254562;
        v104 = __Block_byref_object_dispose__254563;
        v105 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BE3F200]), "initWithName:", CFSTR("com.apple.homed.snapshot-request"));
        v80 = (void *)MEMORY[0x227676638](objc_msgSend(v92, "markMilestoneFor:", CFSTR("SentSnapshotRequestToAccessory")));
        v81 = v88;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&v106[12] = 2112;
          *(_QWORD *)&v106[14] = v79;
          _os_log_impl(&dword_2218F0000, v82, OS_LOG_TYPE_INFO, "%{public}@Sending snapshot request to accessory with options: %@", v106, 0x16u);
      ...
      if (v13)
      {
        ...
        *(_WORD *)&buf[12] = 2048;
        *(_QWORD *)&buf[14] = v9;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Not overriding the resolution requested to %tu", buf, 0x16u);
    ...
    {
      +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", qword_24E79BEF0[a3], a3, a1, v7, v90);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v103 = v28;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Resolutions in order of preference: %@ for tier: %@", buf, 0x20u);
...
LABEL_24:
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)((char *)v101 + 2) = v43;
        _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@Found preferred resolution: %@ in supported resolutions: %@ for tier: %@", v99, 0x2Au);
...
LABEL_34:
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)((char *)v101 + 2) = v48;
        _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@Didn't find preferred resolution in supported resolutions: %@ for tier: %@. Defaulting to resolution: %@", v99, 0x2Au);
      ...
      if (objc_msgSend(v9, "length"))
      {
        ...
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v46 = v19;
            _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to save snapshot file", buf, 0xCu);

            v16 = v37;
          }

          objc_autoreleasePoolPop(v16);
          objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1038);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v47 = 2112;
          v48 = v11;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Accessory sent 0 length data for snapshot request of resolution %@", buf, 0x16u);

        }
        v21 = v11;

        objc_autoreleasePoolPop(v26);
        objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1037);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v49 = 2112;
        v50 = v10;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Accessory failed to send data for snapshot request of resolution %@: %@", buf, 0x20u);
...
void __77__HMDSnapshotRequestHandler__getSupportedVideoResolutions_streamingTierType___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v77 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received response for supported configurations", buf, 0xCu);
  ...
  if (v6)
  {
    ...
    if (v14)
    {
      v15 = v14;
      v16 = *(_QWORD *)v63;
      v17 = *MEMORY[0x24BE1B600];
      v53 = *(_QWORD *)v63;
      v54 = v13;
      v52 = *MEMORY[0x24BE1B600];
      do
      {
        v18 = 0;
        v56 = v15;
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v78 = 2112;
      v79 = v47;
      _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_INFO, "%{public}@Supported resolutions are: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_254607 != -1)
    dispatch_once(&logCategory__hmf_once_t0_254607, &__block_literal_global_254608);
  return (id)logCategory__hmf_once_v1_254609;
}
...
void __40__HMDSnapshotRequestHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_254609;
  logCategory__hmf_once_v1_254609 = v0;
