...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHH2MigrationLogEvent isAutoMigration](self, "isAutoMigration"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("isAutoMigration"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHH2MigrationLogEvent isDryRun](self, "isDryRun"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHH2MigrationLogEvent isMigrationSuccessful](self, "isMigrationSuccessful"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("migrationSuccess"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDHH2MigrationLogEvent migrationAttempt](self, "migrationAttempt"));
