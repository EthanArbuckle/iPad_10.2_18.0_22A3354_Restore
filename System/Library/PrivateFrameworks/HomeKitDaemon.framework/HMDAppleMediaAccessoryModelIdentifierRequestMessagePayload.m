...
- (HMDAppleMediaAccessoryModelIdentifierRequestMessagePayload)initWithPayload:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_stringForKey:", *MEMORY[0x24BDD4D00]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive message due to no accessory identifier in payload: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_103701 != -1)
    dispatch_once(&logCategory__hmf_once_t1_103701, &__block_literal_global_103702);
  return (id)logCategory__hmf_once_v2_103703;
}
...
void __73__HMDAppleMediaAccessoryModelIdentifierRequestMessagePayload_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_103703;
  logCategory__hmf_once_v2_103703 = v0;
