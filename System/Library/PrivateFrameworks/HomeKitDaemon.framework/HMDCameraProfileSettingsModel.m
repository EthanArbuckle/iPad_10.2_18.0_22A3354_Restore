...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_101586 != -1)
    dispatch_once(&hmbProperties_onceToken_101586, &__block_literal_global_101587);
  return (id)hmbProperties__properties_101588;
}
...
void __46__HMDCameraProfileSettingsModel_hmbProperties__block_invoke()
{
  ...
  v28[10] = *MEMORY[0x24BDAC8D0];
  v27[0] = CFSTR("versionField");
  objc_msgSend(MEMORY[0x24BE4ECB8], "fieldWithClass:", objc_opt_class());
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v28[0] = v23;
  v27[1] = CFSTR("accessModeAtHomeField");
  objc_msgSend(MEMORY[0x24BE4ECB8], "fieldWithClass:", objc_opt_class());
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v28[1] = v22;
  v27[2] = CFSTR("accessModeNotAtHomeField");
  objc_msgSend(MEMORY[0x24BE4ECB8], "fieldWithClass:", objc_opt_class());
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v28[2] = v21;
  v27[3] = CFSTR("recordingStorageDurationField");
  objc_msgSend(MEMORY[0x24BE4ECB8], "fieldWithClass:", objc_opt_class());
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v28[3] = v20;
  v27[4] = CFSTR("recordingEventTriggersField");
  objc_msgSend(MEMORY[0x24BE4ECB8], "fieldWithClass:", objc_opt_class());
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v28[4] = v19;
  v27[5] = CFSTR("smartBulletinBoardNotificationDataField");
  ...
  v28[5] = v16;
  v27[6] = CFSTR("accessModeChangeNotificationEnabledField");
  ...
  v28[6] = v6;
  v27[7] = CFSTR("reachabilityEventNotificationEnabledField");
  ...
  v28[7] = v11;
  v27[8] = CFSTR("activityZonesField");
  objc_msgSend(MEMORY[0x24BE4ECB8], "fieldWithClass:", objc_opt_class());
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v28[8] = v12;
  v27[9] = CFSTR("activityZonesIncludedForSignificantEventDetectionField");
  objc_msgSend(MEMORY[0x24BE4ECB8], "fieldWithClass:", objc_opt_class());
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v28[9] = v13;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v28, v27, 10);
  v14 = objc_claimAutoreleasedReturnValue();
  v15 = (void *)hmbProperties__properties_101588;
  hmbProperties__properties_101588 = v14;
...
- (unint64_t)mostPrivateAccessMode
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCameraProfileSettingsModel accessModeAtHome](self, "accessModeAtHome"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(&unk_24E970EC8, "indexOfObject:", v3);

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCameraProfileSettingsModel accessModeNotAtHome](self, "accessModeNotAtHome"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(&unk_24E970EC8, "indexOfObject:", v5);

  if (v4 >= v6)
    v7 = v6;
  else
    v7 = v4;
  objc_msgSend(&unk_24E970EC8, "objectAtIndex:", v7);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v17 = 2112;
        v18 = v7;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode HMDBulletinBoardNotification: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v21 = 2112;
        v22 = v10;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode activity zones: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v14 = 2112;
      v15 = v6;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to encode activity zones: %@", buf, 0x16u);
