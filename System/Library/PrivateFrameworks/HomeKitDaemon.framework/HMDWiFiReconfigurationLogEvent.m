...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDWiFiReconfigurationLogEvent isUsingFailSafeUpdate](self, "isUsingFailSafeUpdate"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("failSafeUpdate"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDWiFiReconfigurationLogEvent credentialType](self, "credentialType"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("credentialType"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", ceil((double)-[HMMLogEvent durationMilliseconds](self, "durationMilliseconds") / 1000.0));
