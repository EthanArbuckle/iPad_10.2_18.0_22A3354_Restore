...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCameraRecordingSessionCoordinationLogEvent isUsingRemoteDeviceAnalysisNode](self, "isUsingRemoteDeviceAnalysisNode"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDCameraRecordingSessionCoordinationLogEvent retryCount](self, "retryCount"));
