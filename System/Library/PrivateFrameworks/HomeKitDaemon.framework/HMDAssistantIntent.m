...
LABEL_33:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            v34 = 138543362;
            v35 = v30;
            _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@The actionSet provided by the intent does not exist.", (uint8_t *)&v34, 0xCu);
...
LABEL_22:
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          v36 = 2112;
          v37 = v13;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Intent execution with entityType %@ is not yet supported.", (uint8_t *)&v34, 0x16u);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    v34 = 138543362;
    v35 = v17;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Error - There is no content in intent to handle.", (uint8_t *)&v34, 0xCu);
...
- (id)_getObjectsWithUUID
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("%K =[d] %@"), CFSTR("objectSPIIdentifier"), v8);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleActionSetForConfirmation:(id)a3 message:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BE3F1B0], "messageWithMessage:messagePayload:", v5, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_149170 != -1)
    dispatch_once(&logCategory__hmf_once_t3_149170, &__block_literal_global_149171);
  return (id)logCategory__hmf_once_v4_149172;
}
...
void __33__HMDAssistantIntent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_149172;
  logCategory__hmf_once_v4_149172 = v0;
