...
LABEL_11:
  ...
  if ((objc_msgSend(v4, "conformsToProtocol:", &unk_25587B8C0) & 1) == 0)
  {
    v14 = (void *)MEMORY[0x227676638]();
    v12 = self;
    HMFGetOSLogHandle();
  ...
  if (v6)
  {
    ...
    objc_msgSend(MEMORY[0x24BE61580], "sharedManager");
...
- (void)_reportFailureWithContext:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v17 = 138543362;
    v18 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failing activation", (uint8_t *)&v17, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Delegate does not implement didFinishActivation:context:", (uint8_t *)&v17, 0xCu);
...
- (void)retryOrReportFailure:(id)a3 context:(id)a4
{
  ...
  if (!objc_msgSend(v8, "isEqual:", *MEMORY[0x24BE61558]))
  {
...
LABEL_10:
    v18 = 55;
LABEL_11:
    objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD5BD8], v18, 0);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    v20 = 138543362;
    v21 = v13;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Network unavailable", (uint8_t *)&v20, 0xCu);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 138543362;
    v21 = v17;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Waiting to retry", (uint8_t *)&v20, 0xCu);
...
- (void)_handleResponseMetadata:(id)a3 ppid:(id)a4 locale:(id)a5 context:(id)a6 error:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v57 = 2112;
    v58 = v14;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Received metadata: %@ for PPID: %@, locale: %@", buf, 0x2Au);
...
- (void)saveRetryOperation:(unint64_t)a3 token:(id)a4 authFeatures:(unint64_t)a5 uuid:(id)a6 context:(id)a7 locale:(id)a8 model:(id)a9
{
  ...
  {
    v20 = objc_alloc(MEMORY[0x24BE3F298]);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    if (v9 > 3)
      ...
      v10 = off_24E782C10[v9];
    v28 = 138543618;
    v29 = v8;
    v30 = 2112;
    v31 = v10;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Retry timer expired for operation: %@", (uint8_t *)&v28, 0x16u);
        ...
        if (v12 != 1)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            if (v26 > 3)
              ...
              v27 = off_24E782C10[v26];
            v28 = 138543618;
            v29 = v25;
            v30 = 2112;
            v31 = v27;
            _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Invalid retry operation: %@", (uint8_t *)&v28, 0x16u);
...
void __57__HMDAuthServer_sendActivationConfirmation_uuid_context___block_invoke_3(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_ERROR, "%{public}@Activation confirmation with server failed with error: %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v15 = 138543362;
        v16 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Delegate does not implement didFinishActivation:context:", (uint8_t *)&v15, 0xCu);
...
LABEL_14:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v14 = 12;
LABEL_12:
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v19, v14);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
  {
    ...
    v21 = 2112;
    v22 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_ERROR, "%{public}@Activation with server failed with error: %@", (uint8_t *)&v19, 0x16u);
...
void __75__HMDAuthServer_sendPPIDInfoRequest_model_token_authFeatures_uuid_context___block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)MEMORY[0x227676638](inited);
  v5 = *v2;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v57 = 2112;
    v58 = v13;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Requesting metadata for locale: %@, Model: %@, Language Code: %@, Country Code: %@ Identifier: %@, swAuthFeatures: %@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v46 = v21;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Checking token for HomeKit", buf, 0xCu);
...
LABEL_12:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v46 = v25;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Checking token for AirPlayAudio", buf, 0xCu);
...
LABEL_15:
  if ((objc_msgSend(MEMORY[0x24BE61580], "isTokenValidForFeatures:token:", v17, *(_QWORD *)(a1 + 40)) & 1) != 0)
  {
    objc_msgSend(*(id *)(a1 + 32), "tokenManager");
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v47 = 2112;
      v48 = v34;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Token validation failed for auth features: %@", buf, 0x16u);
...
void __48__HMDAuthServer_getPPIDInfo_model_cert_context___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    v34 = 2112;
    v35 = v12;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Requesting Cert metadata for locale: %@, Model: %@, Language Code: %@, Country Code: %@ Identifier: %@", buf, 0x3Eu);
...
void __67__HMDAuthServer__handleResponseMetadata_ppid_locale_context_error___block_invoke(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_ERROR, "%{public}@Failed to get PPID Info from server with error: %@", buf, 0x16u);
  ...
  {
    objc_msgSend(*(id *)(a1 + 40), "resetRetryOperation");
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B9A0]), "initWithName:manufacturer:modelName:category:certificationStatus:denylisted:ppid:", *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 56), *(_QWORD *)(a1 + 64), *(_QWORD *)(a1 + 72), *(_QWORD *)(a1 + 80), *(_QWORD *)(a1 + 88), *(_QWORD *)(a1 + 96));
    objc_msgSend(*(id *)(a1 + 40), "delegate");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_opt_respondsToSelector() & 1) != 0)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v17 = v12;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Delegate does not implement handlePPIDInfoResponse:context:", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t21_98405 != -1)
    dispatch_once(&logCategory__hmf_once_t21_98405, &__block_literal_global_98406);
  return (id)logCategory__hmf_once_v22_98407;
}
...
void __28__HMDAuthServer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v22_98407;
  logCategory__hmf_once_v22_98407 = v0;
