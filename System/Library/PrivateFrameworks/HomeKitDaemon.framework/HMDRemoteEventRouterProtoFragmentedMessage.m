...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_fragmentNumber);
...
LABEL_5:
      if ((has & 1) == 0)
        goto LABEL_6;
LABEL_11:
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_totalFragments);
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_totalSize);
...
LABEL_6:
  ...
  {
LABEL_7:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_routerVersion);
