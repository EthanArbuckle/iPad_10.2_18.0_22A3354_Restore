  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[4] = v45;
      v62 = 2112;
      v63 = v46;
      _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_ERROR, "%{public}@There is no action in Action Set: %@", buf, 0x16u);
...
LABEL_16:
  ...
  if (!+[HMDDeviceCapabilities supportsIntentDonation](HMDDeviceCapabilities, "supportsIntentDonation"))
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[4] = v45;
      _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@HomePod is not eligible for intent donation", buf, 0xCu);
      goto LABEL_14;
    }
    goto LABEL_15;
  }
  ...
  if (v10 != 5)
  {
    if (v14)
    {
      ...
      *(_QWORD *)&buf[4] = v48;
      v62 = 2112;
      v63 = v49;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@The trigger source \"%@\" is not supported for donation in HomeKit. HomeKit intent donation only supports First Party App.", buf, 0x16u);
  ...
  if (v14)
  {
    ...
    *(_QWORD *)&buf[4] = v15;
    ...
    v64 = 2112;
    v65 = v17;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@The trigger source is: \"%@\" (bundleID: %@)", buf, 0x20u);
  ...
  v20 = objc_alloc(MEMORY[0x24BDDA1A0]);
  v60 = v12;
  v21 = v19;
  ...
  v25 = objc_alloc(MEMORY[0x24BDDA1A0]);
  ...
  v29 = objc_alloc(MEMORY[0x24BDD9D90]);
  ...
  *(_QWORD *)buf = v30;
  ...
  v33 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD9D80]), "initWithType:BOOLValue:", 1, 1);
  v34 = objc_alloc(MEMORY[0x24BDD9D88]);
  v67[0] = v33;
  ...
  v37 = objc_alloc(MEMORY[0x24BDD9C48]);
  v66 = v36;
  ...
  v40 = isWatch();
  v41 = (_QWORD *)MEMORY[0x24BDD6778];
  if (!v40)
    v41 = (_QWORD *)MEMORY[0x24BDD5C70];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[4] = v53;
      ...
      v64 = 2112;
      v65 = v56;
      _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the intent of Action Set \"%@\" in Home \"%@\", buf, 0x20u);
...
- (void)_donateIntent:(id)a3 withActionSet:(id)a4
{
  ...
  v6 = a3;
  v7 = (objc_class *)MEMORY[0x24BDD9DF0];
  v8 = a4;
...
- (void)_removeIntentForActionSet:(id)a3
{
  ...
  v7 = isWatch();
  v8 = (id *)MEMORY[0x24BDD6778];
  if (!v7)
    v8 = (id *)MEMORY[0x24BDD5C70];
  v9 = (void *)MEMORY[0x24BDC2470];
  v10 = *v8;
...
void __50__HMDDonationHandler__donateIntent_withActionSet___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v3;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to donate home intent of Action Set \"%@\" in Home \"%@\" with error - %@", (uint8_t *)&v17, 0x2Au);
  ...
  else if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v16;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Successfully donate home intent(s) of Action Set \"%@\" in Home \"%@\" to Siri Actions - intent: %@", (uint8_t *)&v17, 0x2Au);
...
+ (id)sharedDonationHandler
{
  if (sharedDonationHandler_onceToken != -1)
    dispatch_once(&sharedDonationHandler_onceToken, &__block_literal_global_197115);
  return (id)sharedDonationHandler_donationHandler;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t9_197110 != -1)
    dispatch_once(&logCategory__hmf_once_t9_197110, &__block_literal_global_15_197111);
  return (id)logCategory__hmf_once_v10_197112;
}
...
void __33__HMDDonationHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_197112;
  logCategory__hmf_once_v10_197112 = v0;
