...
- (id)convertToLegacyV4
{
  ...
  void *v15;
  __int16 v16;
  HMDBackingStoreModelObject *v17;
  uint64_t v18;

  v18 = *MEMORY[0x24BDAC8D0];
  v3 = +[HMDLegacyV4Model hmbModelClassForHMDModelClass:](HMDLegacyV4Model, "hmbModelClassForHMDModelClass:", objc_opt_class());
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Generating random parent UUID for %@", (uint8_t *)&v14, 0x16u);
  ...
  v11 = (void *)objc_msgSend(v9, "initWithModelID:parentModelID:", v10, v4);

  v12 = (void *)-[NSMutableDictionary mutableCopy](self->_reserved, "mutableCopy");
  objc_msgSend(v11, "setHmbReserved:", v12);
...
- (HMDBackingStoreModelObject)initWithManagedObject:(id)a3 changeType:(unint64_t)a4 detached:(BOOL)a5 error:(id *)a6
{
  ...
  void *v16;
  int v17;
  HMDBackingStoreModelObject *v18;
  HMDBackingStoreModelObject *v19;
  char v20;
  BOOL v21;
  id v22;
  HMDBackingStoreModelObject *v23;
  ...
  v12 = objc_msgSend(v10, "isDeleted");
  objc_msgSend(v10, "hmd_modelID");
  ...
  if (!v13)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v36 = 2112;
    v37 = objc_opt_class();
    v28 = "%{public}@Unable to determine modelID for %@";
    goto LABEL_24;
  }
  if (a5)
    goto LABEL_7;
  objc_msgSend(v10, "hmd_parentModelID");
  ...
  if (!v14)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v36 = 2112;
    v37 = objc_opt_class();
    v28 = "%{public}@Unable to determine parentModelID for %@";
LABEL_24:
...
LABEL_27:
  ...
  v17 = objc_msgSend(v16, "hmf_isEqualToUUID:", v15);
...
LABEL_7:
  v15 = 0;
LABEL_8:
  v18 = -[HMDBackingStoreModelObject initWithObjectChangeType:uuid:parentUUID:](self, "initWithObjectChangeType:uuid:parentUUID:", a4, v13, v15);
  v19 = v18;
  if (v18)
    v20 = v12;
  else
  ...
  if ((v20 & 1) != 0)
    goto LABEL_14;
  v33 = 0;
  v21 = -[HMDBackingStoreModelObject cd_populateFromManagedObject:error:](v18, "cd_populateFromManagedObject:error:", v10, &v33);
  v22 = v33;
  if (!v21)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v38 = 2112;
      v39 = v22;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to populate properties from managed object %@: %@", buf, 0x20u);
  ...
  -[HMDBackingStoreModelObject setManagedObject:](v19, "setManagedObject:", v10);
...
- (BOOL)cd_populateFromManagedObject:(id)a3 error:(id *)a4
{
  ...
  void *v21;
  HMDBackingStoreModelObject *v22;
  id v23;
...
LABEL_9:
  ...
  v6 = v5;
  objc_msgSend(v5, "valueForKey:", CFSTR("modelID"));
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    -[HMDBackingStoreModelObject setUuid:](self, "setUuid:", v9);
    objc_msgSend((id)objc_opt_class(), "properties");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = MEMORY[0x24BDAC760];
    v19 = 3221225472;
    v20 = __75__HMDBackingStoreModelObject_CoreData__cd_populateFromManagedObject_error___block_invoke;
    v21 = &unk_24E782318;
    v22 = self;
    v23 = v6;
    v11 = v6;
    objc_msgSend(v10, "enumerateKeysAndObjectsUsingBlock:", &v18);
    -[HMDBackingStoreModelObject setManagedObject:](self, "setManagedObject:", v11, v18, v19, v20, v21, v22);

    return 1;
  }
LABEL_10:
  v13 = (HMDBackingStoreModelObject *)_HMFPreconditionFailure();
  return -[HMDBackingStoreModelObject cd_generateValueForProperty:managedObjectField:context:](v13, v14, v15, v16, v17);
}
...
- (id)cd_generateValueForProperty:(id)a3 managedObjectField:(id)a4 context:(id)a5
{
  ...
  if ((isKindOfClass & 1) != 0 || !-[HMDBackingStoreModelObject propertyWasSet:](self, "propertyWasSet:", v7))
  {
    v13 = 0;
  }
  else
  {
    -[HMDBackingStoreModelObject valueForKey:](self, "valueForKey:", v7);
...
- (id)cd_uuidValueFromStringModelObjectField:(id)a3
{
  ...
  v4 = a3;
  if (-[HMDBackingStoreModelObject propertyWasSet:](self, "propertyWasSet:", v4))
  {
    -[HMDBackingStoreModelObject valueForKey:](self, "valueForKey:", v4);
    ...
    if (v5)
    {
      ...
      if ((isKindOfClass & 1) == 0
        || (v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v7)) == 0)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
        {
          ...
          v22 = 2112;
          v23 = v7;
          _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Model field %@.%@ is not a valid UUID string: '%@'", (uint8_t *)&v16, 0x2Au);
...
- (BOOL)cd_updateManagedObjectInContext:(id)a3 error:(id *)a4
{
  ...
  BOOL v18;
  BOOL result;
  HMDBackingStoreModelObject *v20;
  SEL v21;
  id v22;
  id *v23;
  _QWORD v24[5];
  ...
  if (v7)
  {
    ...
    if (!v9)
    {
      -[HMDBackingStoreModelObject managedObject](self, "managedObject");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "insertObject:", v10);

    }
  }
  else
  {
    -[HMDBackingStoreModelObject cd_currentManagedObjectInContext:error:](self, "cd_currentManagedObjectInContext:error:", v6, a4);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDBackingStoreModelObject setManagedObject:](self, "setManagedObject:", v11);
  ...
  if (v14 == v6)
  {
    -[HMDBackingStoreModelObject cd_populateParentRelationshipInContext:error:](self, "cd_populateParentRelationshipInContext:error:", v6, a4);
    -[HMDBackingStoreModelObject managedObject](self, "managedObject");
    ...
    v24[1] = 3221225472;
    v24[2] = __78__HMDBackingStoreModelObject_CoreData__cd_updateManagedObjectInContext_error___block_invoke;
    v24[3] = &unk_24E782340;
    v24[4] = self;
    v25 = v6;
...
LABEL_9:
  ...
  v20 = (HMDBackingStoreModelObject *)_HMFPreconditionFailure();
  -[HMDBackingStoreModelObject cd_populateParentRelationshipInContext:error:](v20, v21, v22, v23);
  return result;
}
...
- (void)cd_populateParentRelationshipInContext:(id)a3 error:(id *)a4
{
  ...
  objc_msgSend((id)objc_opt_class(), "cd_parentReferenceName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    v9 = v6;
    -[HMDBackingStoreModelObject cd_fetchParentForManagedObjectUsingParentReferenceName:error:](self, "cd_fetchParentForManagedObjectUsingParentReferenceName:error:", v6, a4);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDBackingStoreModelObject managedObject](self, "managedObject");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)cd_fetchParentForManagedObjectUsingParentReferenceName:(id)a3 error:(id *)a4
{
  ...
  id v10;
  void *v11;
  HMDBackingStoreModelObject *v12;
  NSObject *v13;
  void *v14;
  void *v15;
  void *v16;
  ...
  NSObject *v30;
  HMDBackingStoreModelObject *v31;
  void *v32;
  void *v33;
  uint64_t v34;
  HMDBackingStoreModelObject *v35;
  NSObject *v36;
  void *v37;
  void *v38;
  HMDBackingStoreModelObject *v39;
  id v40;
  void *v41;
  uint64_t v42;
  HMDBackingStoreModelObject *v43;
  NSObject *v44;
  HMDBackingStoreModelObject *v45;
  void *v46;
  void *v47;
  void *v49;
  void *v50;
  ...
  void *v64;
  __int16 v65;
  HMDBackingStoreModelObject *v66;
  __int16 v67;
  void *v68;
  __int16 v69;
  id v70;
...
LABEL_22:
    ...
    objc_msgSend(v18, "destinationEntity");
    ...
    objc_msgSend(v23, "predicateWithSubstitutionVariables:", v24);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v22, "setPredicate:", v25);

    objc_msgSend(v22, "execute:", a4);
    ...
    if (v26)
    {
      if (objc_msgSend(v26, "count"))
      {
        if ((unint64_t)objc_msgSend(v27, "count") >= 2)
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            -[HMDBackingStoreModelObject managedObject](v29, "managedObject");
            v52 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v52, "entity");
            v50 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v50, "name");
            v60 = v18;
            v31 = (HMDBackingStoreModelObject *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v60, "destinationEntity");
            v54 = v28;
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v69 = 2112;
            v70 = v33;
            _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Found multiple parent models of %@.%@ (%@) (using first)", buf, 0x2Au);
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
      {
        ...
        -[HMDBackingStoreModelObject managedObject](v43, "managedObject");
        v53 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v53, "entity");
        v51 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v51, "name");
        v45 = (HMDBackingStoreModelObject *)objc_claimAutoreleasedReturnValue();
        -[HMDBackingStoreModelObject parentUUID](v43, "parentUUID");
        v62 = v18;
        v46 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v62, "destinationEntity");
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v69 = 2112;
        v70 = v47;
        _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to find parent model of %@.%@ (%@)", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        v61 = v18;
        v39 = (HMDBackingStoreModelObject *)objc_claimAutoreleasedReturnValue();
        v40 = *a4;
        *(_DWORD *)buf = 138544130;
        v64 = v37;
        v65 = 2112;
        ...
        v69 = 2112;
        v70 = v40;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@Fetch of parentModel model %@.%@ failed: %@", buf, 0x2Au);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v65 = 2112;
    v66 = v12;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@ParentUUID is null for %@", buf, 0x16u);
...
- (id)cd_fetchManagedObjectInContext:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    ...
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
      {
        ...
        v38 = 2112;
        v39 = v15;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_FAULT, "%{public}@Managed object context appears to be reset on this object %@, someone did something very bad: %@/%@", (uint8_t *)&v32, 0x2Au);
  ...
  else
  {
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)objc_opt_class(), "fetchByModelID");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v40 = CFSTR("MODELID");
    -[HMDBackingStoreModelObject uuid](self, "uuid");
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v17, "predicateWithSubstitutionVariables:", v19);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        HMFGetLogIdentifier();
        v26 = (void *)objc_claimAutoreleasedReturnValue();
        v27 = (void *)objc_msgSend((id)objc_opt_class(), "cd_entityClass");
        v28 = v27;
        -[HMDBackingStoreModelObject uuid](v24, "uuid");
        ...
        v38 = 2112;
        v39 = v30;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Fetch of model %@.%@ failed: %@", (uint8_t *)&v32, 0x2Au);
...
- (id)cd_currentManagedObjectInContext:(id)a3 error:(id *)a4
{
  ...
  if (a4)
    ...
    v7 = (id *)&v21;
  -[HMDBackingStoreModelObject cd_fetchManagedObjectInContext:error:](self, "cd_fetchManagedObjectInContext:error:", v6, v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v8 && *v7)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      HMFGetLogIdentifier();
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDBackingStoreModelObject bsoType](v14, "bsoType");
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDBackingStoreModelObject uuid](v14, "uuid");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      v19 = *v7;
      *(_DWORD *)buf = 138544130;
      v23 = v16;
      ...
      v28 = 2112;
      v29 = v19;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to fetch existing managed object for %@.%@: %@", buf, 0x2Au);
  ...
  if (!v9)
  {
    if (-[HMDBackingStoreModelObject objectChangeType](self, "objectChangeType") != 1)
    {
LABEL_12:
      v9 = 0;
      goto LABEL_13;
    }
    v10 = objc_alloc(MEMORY[0x24BDBB698]);
    objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "cd_entityClass"), "entity");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = (void *)objc_msgSend(v10, "initWithEntity:insertIntoManagedObjectContext:", v11, v6);

    -[HMDBackingStoreModelObject uuid](self, "uuid");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "setModelID:", v12);

    -[HMDBackingStoreModelObject setManagedObject:](self, "setManagedObject:", v9);
  }
LABEL_13:
...
- (id)cd_childrenExcluding:(id)a3 fromContext:(id)a4 error:(id *)a5
{
  ...
  _QWORD v19[4];
  id v20;
  HMDBackingStoreModelObject *v21;
  id v22;
  uint64_t *v23;
  uint64_t *v24;
  uint64_t v25;
  ...
  v9 = a4;
  v10 = objc_opt_class();
  if ((HMDModelClassIsCDRepresentable(v10) & 1) != 0)
  {
    -[HMDBackingStoreModelObject cd_fetchManagedObjectInContext:error:](self, "cd_fetchManagedObjectInContext:error:", v9, a5);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    if (v11)
    {
      v31 = 0;
      v32 = &v31;
      v33 = 0x3032000000;
      v34 = __Block_byref_object_copy__92358;
      v35 = __Block_byref_object_dispose__92359;
      v36 = 0;
      v25 = 0;
      v26 = &v25;
      v27 = 0x3032000000;
      v28 = __Block_byref_object_copy__92358;
      v29 = __Block_byref_object_dispose__92359;
...
void __79__HMDBackingStoreModelObject_CoreData__cd_childrenExcluding_fromContext_error___block_invoke(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  id v7;
  id v8;
  void *v9;
  ...
  if ((objc_msgSend(v7, "isEqual:", *(_QWORD *)(a1 + 32)) & 1) == 0)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "managedObjectClassName");
    ...
    if (HMDManagedObjectClassIsBSORepresentable((uint64_t)v11))
    {
      ...
      if (v13)
      {
        ...
        obj = *(id *)(v22 + 40);
        v23 = +[HMDBackingStoreModelObject cd_addChildren:excluding:toSet:error:](HMDBackingStoreModelObject, "cd_addChildren:excluding:toSet:error:", v19, v20, v21, &obj);
...
void __78__HMDBackingStoreModelObject_CoreData__cd_updateManagedObjectInContext_error___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v8 = a2;
  objc_msgSend(*(id *)(a1 + 32), "cd_generateValueForProperty:managedObjectField:context:", a3);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    v6 = v5;
    if ((void *)*MEMORY[0x24BDBD430] == v5)
    {

      v6 = 0;
    }
    objc_msgSend(*(id *)(a1 + 32), "managedObject");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
void __75__HMDBackingStoreModelObject_CoreData__cd_populateFromManagedObject_error___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    objc_msgSend(*(id *)(a1 + 32), "cd_generateValueForModelObjectFromManagedObject:modelObjectField:modelFieldInfo:", *(_QWORD *)(a1 + 40), v5, v6);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    if (v7)
    {
      v8 = v7;
      ...
      else
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
          {
            ...
            v20 = v13;
            v21 = 2112;
            v22 = objc_msgSend(v6, "classObj");
            _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Value from managed object field %@ is of unexpected type %@ (expected %@)", (uint8_t *)&v15, 0x2Au);
      ...
      objc_msgSend(*(id *)(a1 + 32), "setValue:forKey:", v8, v5);
LABEL_10:
...
+ (NSPredicate)fetchByModelID
{
  if (fetchByModelID_onceToken != -1)
    dispatch_once(&fetchByModelID_onceToken, &__block_literal_global_62);
  return (NSPredicate *)(id)fetchByModelID_fetchByModelID;
}
  ...
  if (v14)
  {
    ...
    while (2)
    {
      for (i = 0; i != v15; ++i)
      {
        ...
        HMDCastIfManagedObjectBSORepresentable(*(void **)(*((_QWORD *)&v32 + 1) + 8 * i));
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v19 = v18;
        if (v18)
        {
          objc_msgSend(v18, "hmd_modelID");
          v20 = (void *)objc_claimAutoreleasedReturnValue();
          v21 = objc_msgSend(v11, "containsObject:", v20);

          if ((v21 & 1) == 0)
          {
            v31 = 0;
            objc_msgSend(v19, "hmd_modelsWithChangeType:detached:error:", 0, 0, &v31);
            v22 = (void *)objc_claimAutoreleasedReturnValue();
            v23 = v31;
            if (!v22)
            {
              ...
              if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v40 = 2112;
                v41 = v23;
                _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Unable to create model from %@: %@", buf, 0x20u);
...
void __54__HMDBackingStoreModelObject_CoreData__fetchByModelID__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("%K == $MODELID"), CFSTR("modelID"));
...
- (id)typeNameForDebug
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@/%@"), v4, v2);
...
- (HMDBackingStoreModelObject)initWithVersion:(id)a3 changeType:(unint64_t)a4 uuid:(id)a5 parentUUID:(id)a6
{
  ...
  if (v13)
  {
    ...
    objc_msgSend(MEMORY[0x24BE3F210], "hmf_cachedInstanceForNSUUID:", v11);
    v21 = objc_claimAutoreleasedReturnValue();
    uuid = v13->_uuid;
    v13->_uuid = (NSUUID *)v21;

    objc_msgSend(MEMORY[0x24BE3F210], "hmf_cachedInstanceForNSUUID:", v12);
...
- (id)backedObjectWithParent:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    ...
    v10 = v9;
    if (v9
      && objc_msgSend(v9, "conformsToProtocol:", &unk_255777700)
...
LABEL_16:
            ...
            v18 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("[%lu]"), v23 + v25);
            v19 = (void *)objc_claimAutoreleasedReturnValue();
            v33 = v18;
            v34 = v19;
            goto LABEL_36;
...
- (id)encodeAsNSDictionaryFor:(unint64_t)a3 error:(id *)a4
{
  ...
  if (!v7)
  {
    if (a4)
    {
      objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BE3EBB0], 3, &unk_24E971AA0);
      *a4 = (id)objc_claimAutoreleasedReturnValue();
    }
    return 0;
  }
...
LABEL_68:
          ...
          v24 = (void *)v70;
          if (!objc_msgSend((id)objc_opt_class(), "conformsToProtocol:", &unk_25576DB50)
            || (objc_msgSend((id)objc_opt_class(), "supportsSecureCoding") & 1) == 0)
          {
            if (v25)
            {
              v51 = (void *)MEMORY[0x24BDD1540];
              v52 = *MEMORY[0x24BE3EBB0];
              v85 = CFSTR("message");
              objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("/%@ (property does not support secureCoding)"), v28);
              v53 = (void *)objc_claimAutoreleasedReturnValue();
              v86 = v53;
          ...
          if (!v43)
          {
            if (v25)
            {
              ...
              v65 = *MEMORY[0x24BE3EBB0];
              v83 = CFSTR("message");
              objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("/%@ (property could not be encoded as NSData)"), v28);
...
- (id)encodeForCloud:(id *)a3
{
  ...
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithRecordType:", CFSTR("ObjectRecord"));
  -[HMDBackingStoreModelObject encodeWithEncoding:for:error:](self, "encodeWithEncoding:for:error:", 1, 1, a3);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    objc_msgSend(v5, "setObject:forKey:", &unk_24E96C608, CFSTR("k00"));
...
- (void)setParentUUIDIfNotNil:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
  {
    ...
    v17 = 138543362;
    v18 = v10;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Parent identifier is already present for this object", (uint8_t *)&v17, 0xCu);
  ...
  if (*p_parentUUID)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Parent identifier is already present for this object", (uint8_t *)&v17, 0xCu);
...
- (id)setProperties
{
  ...
  objc_msgSend(MEMORY[0x24BDBCEF0], "setWithCapacity:", -[NSMutableDictionary count](self->_reserved, "count"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = 0u;
  v12 = 0u;
  v13 = 0u;
    ...
    if (-[HMDBackingStoreModelObject bsoIgnoreModel](v5, "bsoIgnoreModel"))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v37 = 2112;
        v38 = v12;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Dropping merge merge from model %@ (our version less than ignore before version %@ <= %@)", buf, 0x2Au);

      }
      v13 = (void *)v7;
LABEL_16:
      objc_autoreleasePoolPop(v13);
      objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD5BD8], 19, 0);
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      goto LABEL_17;
    }
    -[HMDBackingStoreModelObject bsoType](self, "bsoType");
    ...
    if ((-[objc_class isSubclassOfClass:](v15, "isSubclassOfClass:", v17) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v35 = 2112;
        v36 = v15;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot merge from model class, %@, to model class, %@", buf, 0x20u);
...
LABEL_10:
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, v17, (uint8_t *)&v25, 0x2Au);
LABEL_11:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    v33 = 2112;
    v34 = v24;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to set property %@ of %@ from type %@ (does not match the expected type %@)", (uint8_t *)&v25, 0x34u);
...
- (id)defaultValueForPropertyNamed:(id)a3 isSet:(BOOL *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to get default value of property %@ from type %@ (no such property exists)", (uint8_t *)&v16, 0x20u);
...
- (void)dumpWithVerbosity:(BOOL)a3 prefix:(id)a4 logType:(unsigned __int8)a5
{
  ...
  if (os_log_type_enabled(v12, (os_log_type_t)a5))
  {
    ...
    v16 = 2112;
    v17 = v9;
    _os_log_impl(&dword_2218F0000, v12, (os_log_type_t)a5, "%{public}@HMDBackingStoreModelObject %@", (uint8_t *)&v14, 0x16u);
...
{
  return -[HMDBackingStoreModelObject debugString:prefix:](self, "debugString:prefix:", a3, &stru_24E79DB48);
}
...
- (void)dumpDebug
{
  -[HMDBackingStoreModelObject dumpDebug:](self, "dumpDebug:", &stru_24E79DB48);
}
...
- (void)setValue:(id)a3 forKey:(id)a4
{
  ...
  if (v12)
    v10 = v12;
  v11 = v10;
  -[NSMutableDictionary setObject:forKey:](reserved, "setObject:forKey:", v11, v6);
...
- (id)valueForKey:(id)a3
{
  ...
  -[NSMutableDictionary objectForKey:](self->_reserved, "objectForKey:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if ((void *)*MEMORY[0x24BDBD430] == v3)
    v3 = 0;
  v5 = v3;
...
{
  objc_storeStrong((id *)&self->_bsoDataVersion, a3);
}
...
{
  objc_storeStrong((id *)&self->_managedObject, a3);
}
...
LABEL_12:
  ...
  else if (objc_msgSend(v8, "propertyIsReadOnly:", v5))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v16;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to merge %@ property of model class %@ (marked readonly for %@).", (uint8_t *)&v21, 0x2Au);
...
+ (id)bsoSchemaHash
{
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("551E3F88-0C11-4402-A486-6D1EB759AADD"));
...
+ (id)objectFromDictionaryData:(id)a3 type:(id)a4 error:(id *)a5
{
  ...
  v10 = (void *)MEMORY[0x227676638]();
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1620]), "initForReadingFromData:error:", v8, 0);
  +[HMDBackingStore internalAllowedTypes](HMDBackingStore, "internalAllowedTypes");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v109 = *MEMORY[0x24BDD0E88];
    ...
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v76, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v124 = 2112;
        v125 = v108;
        _os_log_impl(&dword_2218F0000, v76, OS_LOG_TYPE_ERROR, "%{public}@Received an object with a dictionary missing the kType key: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v80, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v123 = v81;
        _os_log_impl(&dword_2218F0000, v80, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Received a model missing a critical field.", buf, 0xCu);
  ...
  *(_QWORD *)(v20 + 48) = v34;
  ...
  if (!v36)
  {
    ...
    if (!v13)
    {
      ...
      v97 = *MEMORY[0x24BE3EBB0];
      v135 = CFSTR("message");
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("expecting a versioning key named %@ but one does not exist"), CFSTR("_v"));
      v40 = (void *)objc_claimAutoreleasedReturnValue();
      v136 = v40;
  ...
  v134[5] = CFSTR("_d");
  v134[6] = CFSTR("_G");
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v134, 7);
...
LABEL_36:
        ...
        {
          objc_msgSend(MEMORY[0x24BE3F208], "hmf_cachedInstanceForString:", v46);
          v57 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(*(id *)(v20 + 8), "removeObjectForKey:", v46);
...
LABEL_52:
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          if (!objc_msgSend((id)objc_msgSend(v47, "classObj"), "isEqual:", objc_opt_class()))
          {
            v57 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1620]), "initForReadingFromData:error:", v49, 0);
            ...
            {
              context = (void *)MEMORY[0x227676638](v60);
              v62 = v107;
              HMFGetOSLogHandle();
              ...
              if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v127 = v65;
                v66 = (void *)v65;
                _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_ERROR, "%{public}@failed to unarchive implicitly archived property %@: %@", buf, 0x20u);
          ...
          v94 = *MEMORY[0x24BE3EBB0];
          v128 = CFSTR("message");
          objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("should not have a internally handled type of NSObject (but we hit one for key %@)"), v46);
...
+ (id)objectFromData:(id)a3 encoding:(unint64_t)a4 record:(id)a5 error:(id *)a6
{
  ...
  v13 = (void *)MEMORY[0x227676638]();
  v24 = 0;
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1620]), "initForReadingFromData:error:", v11, &v24);
  v15 = v24;
  v16 = objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithCoder:", v14);
  v17 = (void *)v12[10];
  v12[10] = v16;
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v29 = 2112;
      v30 = v15;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Unable to unarchive CKRecord for BSO (%@): %@", buf, 0x20u);
...
+ (id)objectFromCloud:(id)a3 error:(id *)a4
{
  ...
  if (v8)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("k%02lu"), objc_msgSend(v8, "unsignedIntValue"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)formatValue:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("<NSArray: %lu items>"), objc_msgSend(v3, "count"));
    goto LABEL_7;
  }
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("<NSDictionary: %lu items>"), objc_msgSend(v3, "count"));
LABEL_7:
...
LABEL_8:
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("<NSData: %lu bytes>"), objc_msgSend(v3, "length"));
      v4 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_187295 != -1)
    dispatch_once(&logCategory__hmf_once_t19_187295, &__block_literal_global_187296);
  return (id)logCategory__hmf_once_v20_187297;
}
...
void __41__HMDBackingStoreModelObject_logCategory__block_invoke()
{
  ...
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)logCategory__hmf_once_v20_187297;
  logCategory__hmf_once_v20_187297 = v0;
