...
- (void)startRetryTimer
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDMediaGroupsAggregateBackupMessageTimer attemptCount](v4, "attemptCount"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v20 = 138543618;
    v21 = v6;
    v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting timer with attempts: %@", (uint8_t *)&v20, 0x16u);
  ...
  if (-[HMDMediaGroupsAggregateBackupMessageTimer attemptCount](v4, "attemptCount") < 0x24)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v19;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to start new timer due to no timer provider", (uint8_t *)&v20, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = &unk_24E96BF30;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create retry timer due to reaching the max attempt count: %@", (uint8_t *)&v20, 0x16u);
...
{
  return (HMDMediaGroupsAggregateBackupMessageTimer *)(id)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", a4, a3);
}
  ...
  if (v5 == v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of triggered timer due to no delegate", (uint8_t *)&v12, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_161072 != -1)
    dispatch_once(&logCategory__hmf_once_t4_161072, &__block_literal_global_161073);
  return (id)logCategory__hmf_once_v5_161074;
}
...
void __56__HMDMediaGroupsAggregateBackupMessageTimer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_161074;
  logCategory__hmf_once_v5_161074 = v0;
