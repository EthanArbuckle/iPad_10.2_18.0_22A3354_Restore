...
LABEL_9:
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, v23, buf, 0xCu);
  ...
  if (v25)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v33;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@HMDMPCSessionData initialized with playbackArchive: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v79 = 2112;
            v80 = v14;
            _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not map profile UUID (%@) to MediaProfile", buf, 0x16u);
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v81 = 138543618;
      ...
      v83 = 2112;
      v84 = (uint64_t)v20;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive in entirety: %@", v81, 0x16u);
    ...
    objc_autoreleasePoolPop(v29);
    v72 = 0;
    objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v20, &v72);
    ...
    if (!v34)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v81 = 138543618;
        ...
        v83 = 2112;
        v84 = (uint64_t)v35;
        _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode playbackArchive: %@", v81, 0x16u);
    ...
    if (v21)
    {
      if (v43)
      {
        ...
        *(_DWORD *)v81 = 138543618;
        ...
        v83 = 2112;
        v84 = v21;
        _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive session identifier: %@", v81, 0x16u);
      ...
      if (v34)
      {
        ...
        while (v46 >> v47++);
        context = (void *)MEMORY[0x227676638](v48);
        v50 = v41;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v81 = 138543874;
          ...
          v85 = 2112;
          v86 = v54;
          _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive: %@ options: %@", v81, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v81 = 138543618;
          ...
          v52 = v61;
          v84 = (uint64_t)v61;
          _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode playbackArchive session identifier. home %@", v81, 0x16u);
    ...
    else
    {
      if (v43)
      {
        ...
        *(_DWORD *)v81 = 138543362;
        v82 = v55;
        _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Key to playbackArchive not found", v81, 0xCu);
...
- (HMDMPCSessionData)initWithMediaAction:(id)a3 source:(id)a4 clientName:(id)a5
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v8, "state"));
...
- (id)dictionaryRepresentation:(BOOL)a3
{
  ...
  objc_msgSend(v6, "na_map:", &__block_literal_global_174052);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v53 = 2112;
      v54 = v18;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive: %@", buf, 0x16u);
    ...
    if (v3)
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v52 = v23;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive in entirety", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v53 = 2112;
          v54 = v27;
          _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Couldn't encode playbackArchive: %@", buf, 0x16u);
    ...
    else
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v53 = 2112;
        v54 = v29;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive session identifier: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v53 = 2112;
        v54 = v43;
        _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive options: %@", buf, 0x16u);
