...
- (HMDCameraAccessModeBulletinNotificationRegistration)initWithAccessoryUUID:(id)a3 conditions:(id)a4
{
  ...
  HMDCameraAccessModeBulletinNotificationRegistration *v13;
  SEL v14;
  id v15;
  objc_super v16;
  ...
  if (v6)
  {
    v8 = v7;
    v16.receiver = self;
    v16.super_class = (Class)HMDCameraAccessModeBulletinNotificationRegistration;
  ...
  {
    v13 = (HMDCameraAccessModeBulletinNotificationRegistration *)_HMFPreconditionFailure();
    return -[HMDCameraAccessModeBulletinNotificationRegistration initWithDictionary:](v13, v14, v15);
  }
}
...
- (HMDCameraAccessModeBulletinNotificationRegistration)initWithDictionary:(id)a3
{
  ...
  void *v5;
  void *v6;
  HMDCameraAccessModeBulletinNotificationRegistration *v7;
  uint64_t v8;
  void *v9;
  uint64_t v10;
  NSUUID *accessoryUUID;
  HMDCameraAccessModeBulletinNotificationRegistration *v12;
  HMDCameraAccessModeBulletinNotificationRegistration *v14;
  SEL v15;
  objc_super v16;
...
LABEL_7:
  ...
  objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("HMDCAMBNR.ck.au"));
  ...
  return (HMDCameraAccessModeBulletinNotificationRegistration *)-[HMDCameraAccessModeBulletinNotificationRegistration serializedRegistrationForRemoteMessage](v14, v15);
}
...
- (id)serializedRegistrationForRemoteMessage
{
  ...
  -[HMDCameraAccessModeBulletinNotificationRegistration accessoryUUID](self, "accessoryUUID");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "UUIDString");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v6, CFSTR("HMDCAMBNR.ck.au"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMDCameraAccessModeBulletinNotificationRegistration accessoryUUID](self, "accessoryUUID", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("HMDCAMBNR.ck.au"));
...
- (HMDCameraAccessModeBulletinNotificationRegistration)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("HMDCAMBNR.ck.au"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (v6)
    {
      -[HMDBulletinNotificationRegistration conditions](v5, "conditions");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      self = -[HMDCameraAccessModeBulletinNotificationRegistration initWithAccessoryUUID:conditions:](self, "initWithAccessoryUUID:conditions:", v6, v7);
