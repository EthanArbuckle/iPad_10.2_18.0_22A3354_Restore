...
- (HMDWidgetConfigurationReader)init
{
  ...
  v4 = *MEMORY[0x24BDD5C70];
  v5 = objc_alloc_init(MEMORY[0x24BE16A28]);
...
- (id)fetchedHomeWidgets
{
  ...
  v13 = &v12;
  v14 = 0x3032000000;
  v15 = __Block_byref_object_copy__127271;
  v16 = __Block_byref_object_dispose__127272;
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v16;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Fetched configured widgets: %@", buf, 0x16u);
  ...
  if (!v14)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v85 = 2112;
      v86 = v29;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Ignoring widget configuration because the intent is not INAppIntent: %@", buf, 0x16u);
  ...
  if (!v82)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v87 = 2112;
      v88[0] = v32;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Ignoring widget configuration because %@ key is missing from serialized parameters: %@", buf, 0x20u);
...
LABEL_21:
  ...
  if ((v19 & 1) != 0)
  {
    v20 = objc_alloc_init(MEMORY[0x24BE5B918]);
    v21 = v20;
    v74 = v16;
    if (v16)
    {
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v85 = 2112;
                    v86 = v45;
                    _os_log_impl(&dword_2218F0000, v56, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly missing the identifier in %@", buf, 0x16u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v85 = 2112;
                  v86 = v45;
                  _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_ERROR, "%{public}@accessoryOrScene is not a dictionary! %@", buf, 0x16u);
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%llu"), v60);
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)((char *)v88 + 6) = v18;
      _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_DEBUG, "%{public}@IFObjectHasher: computed widget identifier %{public}@ with useHomeKitRecommendations=%{BOOL}d, accessoriesAndScenes=%@", buf, 0x26u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v87 = 2112;
      v88[0] = v37;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Ignoring widget configuration because %@ key is missing from serialized parameters: %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_127278 != -1)
    dispatch_once(&logCategory__hmf_once_t10_127278, &__block_literal_global_127279);
  return (id)logCategory__hmf_once_v11_127280;
}
...
void __43__HMDWidgetConfigurationReader_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_127280;
  logCategory__hmf_once_v11_127280 = v0;
