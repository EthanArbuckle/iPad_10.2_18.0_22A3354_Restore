...
- (id)flagForSpecifier:(id)a3 periodicity:(int64_t)a4
{
  ...
  if (!v9)
  {
    ...
    if ((v11 & 1) == 0)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Specifier's class must be registered in the allowedSpecifierClasses in HMDTimeBasedFlagsManager: %@"), objc_opt_class());
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v14, "exceptionWithName:reason:userInfo:", *MEMORY[0x24BDBCAB8], v15, 0);
...
- (id)unarchiveFlags
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v23 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Loading legacy flags", buf, 0xCu);
...
LABEL_5:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v24 = 2112;
    v25 = v3;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Final restored flags: %@", buf, 0x16u);
...
- (id)unarchiveLegacyFlags
{
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v30;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Legacy flags missing data", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v26;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@No legacy event flags found", buf, 0xCu);
...
+ (NSSet)allowedSpecifierClasses
{
  if (allowedSpecifierClasses__hmf_once_t4 != -1)
    dispatch_once(&allowedSpecifierClasses__hmf_once_t4, &__block_literal_global_13212);
