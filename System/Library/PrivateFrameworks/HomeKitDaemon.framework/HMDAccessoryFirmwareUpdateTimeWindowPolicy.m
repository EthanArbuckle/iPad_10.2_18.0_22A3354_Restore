...
- (BOOL)evaluate
{
  ...
  if (!v12 || !v19)
  {
    v39 = (void *)MEMORY[0x227676638](v26);
    v40 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v58 = v42;
      _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_INFO, "%{public}@Invalid time window, policy status evaluated to NO", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v39);
    v27 = objc_alloc_init(MEMORY[0x24BDBCE68]);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v63 = 2112;
    v64 = v34;
    _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Evaluate now=%@ in interval=[%@, %@]", buf, 0x2Au);
  ...
  {
    v36 = objc_alloc_init(MEMORY[0x24BDBCE68]);
...
LABEL_18:
  ...
  if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v59 = 2112;
    v60 = v49;
    _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to %@", buf, 0x16u);
...
- (void)_startReevaluateTimer:(id)a3
{
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 1, v8);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_163791 != -1)
    dispatch_once(&logCategory__hmf_once_t2_163791, &__block_literal_global_64_163792);
  return (id)logCategory__hmf_once_v3_163793;
}
...
void __57__HMDAccessoryFirmwareUpdateTimeWindowPolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_163793;
  logCategory__hmf_once_v3_163793 = v0;
