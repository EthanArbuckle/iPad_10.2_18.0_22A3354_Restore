  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          objc_msgSend(MEMORY[0x24BDD7408], "constraintWithDictonaryRepresentation:", v10, (_QWORD)v14);
...
+ (id)valueWithType:()Metadata representation:
{
  ...
  if ((unint64_t)(a3 - 1) < 3)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid constraint value: %@", (uint8_t *)&v19, 0x16u);
...
LABEL_14:
  ...
  if (v9)
  {
    v7 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDD7400]), "initWithTitle:", v8);
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid constraint value: %@", (uint8_t *)&v19, 0x16u);
