...
- (HMDXPCConnection)initWithXPCConnection:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = -[HMDXPCConnection init](&v12, sel_init);
    v8 = v7;
    if (v7)
  ...
  {
    v10 = (HMDXPCConnection *)_HMFPreconditionFailure();
    return (HMDXPCConnection *)-[HMDXPCConnection processInfo](v10, v11);
  }
}
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDXPCConnection processIdentifier](self, "processIdentifier"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
