...
- (void)updateWithHAPAccessoryServer:(id)a3
{
  ...
  v16 = a3;
  if (objc_msgSend(v16, "conformsToProtocol:", &unk_255908FC8))
    v4 = v16;
  else
    v4 = 0;
  v5 = v4;
