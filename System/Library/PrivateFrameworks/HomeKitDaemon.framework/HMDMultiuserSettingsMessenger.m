...
- (void)registerForMessages
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v15 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Registered for Multiuser Settings Metrics Messages", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v6);
  -[HMDMultiuserSettingsMessenger messageDispatcher](v7, "messageDispatcher");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = *MEMORY[0x24BDD6770];
  v13[0] = v3;
  v13[1] = v5;
...
- (void)handleFetchMultiuserSettingsRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v10;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling fetch Multiuser Settings Request, %@", (uint8_t *)&v14, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_175476 != -1)
    dispatch_once(&logCategory__hmf_once_t2_175476, &__block_literal_global_175477);
  return (id)logCategory__hmf_once_v3_175478;
}
...
void __44__HMDMultiuserSettingsMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_175478;
  logCategory__hmf_once_v3_175478 = v0;
