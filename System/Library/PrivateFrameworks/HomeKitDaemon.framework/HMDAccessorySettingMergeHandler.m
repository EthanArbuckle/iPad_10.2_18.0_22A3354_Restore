  ...
  if (v15 != objc_msgSend(v11, "type"))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v199 = 2112;
      v200 = v30;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Value types are not matching: self %@, second %@", buf, 0x20u);
      ...
      case 3:
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v197 = 2112;
          v198 = v45;
          _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@Setting type is %@, keeping the values", buf, 0x16u);
        ...
        if (v46)
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v199 = 2112;
            v200 = v53;
            _os_log_impl(&dword_2218F0000, v56, OS_LOG_TYPE_INFO, "%{public}@Comparing the values: self %@, second %@", buf, 0x20u);
          ...
          if ((HMFEqualObjects() & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v196 = v61;
              _os_log_impl(&dword_2218F0000, v60, OS_LOG_TYPE_INFO, "%{public}@Values are not matching, going to compute the value", buf, 0xCu);
            ...
            if (!v62)
            {
              ...
              if (os_log_type_enabled(v161, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v196 = v162;
                _os_log_impl(&dword_2218F0000, v161, OS_LOG_TYPE_ERROR, "%{public}@Cannot come up with the merged value", buf, 0xCu);
            ...
            if ((v65 & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v199 = 2112;
                v200 = v63;
                _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_INFO, "%{public}@Updating the value from %@ to %@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v127, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v201 = 2112;
              v202 = v133;
              _os_log_impl(&dword_2218F0000, v127, OS_LOG_TYPE_INFO, "%{public}@Numerical Constraints are not matching (merged: %@) (first: %@), (second: %@) updating the constraints", buf, 0x2Au);
...
LABEL_103:
        ...
        if (os_log_type_enabled(v119, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v196 = v120;
          _os_log_impl(&dword_2218F0000, v119, OS_LOG_TYPE_ERROR, "%{public}@Merged constraints is invalid, cannot merge this setting", buf, 0xCu);
      ...
      case 4:
        ...
        if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v197 = 2112;
          v198 = v76;
          _os_log_impl(&dword_2218F0000, v79, OS_LOG_TYPE_INFO, "%{public}@Setting type is selection, merged constraints: %@", buf, 0x16u);
...
LABEL_66:
              ...
              if (os_log_type_enabled(v108, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v196 = v109;
                _os_log_impl(&dword_2218F0000, v108, OS_LOG_TYPE_INFO, "%{public}@Did not find first's selection in merged list", buf, 0xCu);
...
LABEL_87:
                ...
                if (os_log_type_enabled(v136, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v196 = v137;
                  _os_log_impl(&dword_2218F0000, v136, OS_LOG_TYPE_INFO, "%{public}@Did not find second's selection in merged list, updating the selected value to nil", buf, 0xCu);
...
LABEL_90:
              ...
              if ((v140 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v143, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v199 = 2112;
                  v200 = v176;
                  _os_log_impl(&dword_2218F0000, v143, OS_LOG_TYPE_INFO, "%{public}@Updating the value from %@ to %@", buf, 0x20u);
              ...
              objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", obja);
              ...
              if ((v150 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v154, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v199 = 2112;
                  v200 = v158;
                  _os_log_impl(&dword_2218F0000, v154, OS_LOG_TYPE_INFO, "%{public}@Selection Constraints are not matching (merged: %@) (first: %@), updating the constraints", buf, 0x20u);
        ...
        if (os_log_type_enabled(v123, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v196 = v124;
          _os_log_impl(&dword_2218F0000, v123, OS_LOG_TYPE_ERROR, "%{public}@There are no elements in the intersection of selection list", buf, 0xCu);
          ...
          && objc_msgSend(v11, "isConstraintMergeStrategyReflection"))
        {
          ...
          if (os_log_type_enabled(v91, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            v203 = 2112;
            v204 = v94;
            _os_log_impl(&dword_2218F0000, v91, OS_LOG_TYPE_DEBUG, "%{public}@merge constraints first: %@, %@, second: %@, %@", buf, 0x34u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v102, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v197 = 2112;
            v198 = v104;
            _os_log_impl(&dword_2218F0000, v102, OS_LOG_TYPE_INFO, "%{public}@Updating constraints to %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v199 = 2112;
      v200 = v39;
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Setting names are not matching: self %@, second %@", buf, 0x20u);
  ...
  if ((v19 & 1) != 0)
  {
    ...
    if (!v20 || !v92 || !v91)
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v97 = v40;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Min, max or step is nil", buf, 0xCu);
...
LABEL_80:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      if (v31 >= 5)
      {
        objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Unknown HMDAccessorySettingMergeStrategyType %tu"), v31);
        v32 = (__CFString *)objc_claimAutoreleasedReturnValue();
      }
      else
      {
        v32 = off_24E77DC20[v31];
      }
      *(_DWORD *)buf = 138543618;
      v97 = v29;
      v98 = 2112;
      v99 = v32;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Merge strategy is %@", buf, 0x16u);
    ...
    if (v41 == 4)
    {
      ...
      if (v62 && v63)
      {
        if (v65)
        {
          ...
          *(_DWORD *)buf = 138543362;
          v97 = v66;
          _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Current values are within the merged range", buf, 0xCu);
        ...
        if (v67 != -1)
        {
          if (v71)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v98 = 2112;
            v99 = v90;
            _os_log_impl(&dword_2218F0000, v70, OS_LOG_TYPE_INFO, "%{public}@Retaining current value %@", buf, 0x16u);
        ...
        if (v71)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v98 = 2112;
          v99 = v87;
          _os_log_impl(&dword_2218F0000, v70, OS_LOG_TYPE_INFO, "%{public}@Choosing second setting's value %@", buf, 0x16u);
...
LABEL_52:
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v98 = 2112;
          v99 = v90;
          _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Only current value %@ is within the merged range", buf, 0x16u);
      ...
      if (!v63)
      {
        if (v65)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v98 = 2112;
          v99 = v92;
          _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Neither of the values are within the merged range, choosing the max %@", buf, 0x16u);
      ...
      if (v41 == 1)
      {
        ...
        if (v38)
        {
          if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v98 = 2112;
            v99 = v38;
            _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_INFO, "%{public}@Using the conflict value %@ as a merged value", buf, 0x16u);
        ...
        else
        {
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v97 = v76;
            _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_ERROR, "%{public}@Cannot find the conflict value", buf, 0xCu);
    ...
    if (v48 && v49)
    {
      ...
      if (v56 == -1)
      {
        if (v60)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v98 = 2112;
          v99 = v90;
          _os_log_impl(&dword_2218F0000, v59, OS_LOG_TYPE_INFO, "%{public}@Retaining current value %@", buf, 0x16u);
      ...
      if (v60)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v98 = 2112;
        v99 = v55;
        _os_log_impl(&dword_2218F0000, v59, OS_LOG_TYPE_INFO, "%{public}@Choosing second setting's value %@", buf, 0x16u);
...
LABEL_63:
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v98 = 2112;
        v99 = v18;
        _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Only second setting's value %@ is within the merged range", buf, 0x16u);
...
LABEL_79:
    ...
    if (v53)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v98 = 2112;
      v99 = v89;
      _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Neither of the values are within the merged range, choosing the min %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v98 = 2112;
      v99 = v12;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Cannot extract min, max and step from merged constraints %@", buf, 0x16u);
...
+ (BOOL)_isNumber:(id)a3 betweenStart:(id)a4 andEnd:(id)a5 first:(id)a6
{
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Given value is nil, cannot determine whether within the range", (uint8_t *)&v19, 0xCu);
...
+ (id)_mergeRangeConstraintsFirst:(id)a3 second:(id)a4 shouldAddMissing:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v90 = 2112;
    v91 = *(double *)&v17;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Cannot extract min, max and step from this setting's constraints %@", buf, 0x16u);
    ...
    if (v21)
    {
      if (v22 && v23 && v79)
      {
          ...
          if (!v81)
          {
            ...
            if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v90 = 2112;
              v91 = *(double *)&v8;
              _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Taking min constraint from %@", buf, 0x16u);
          ...
          if (!v80)
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v90 = 2112;
              v91 = *(double *)&v8;
              _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Taking max constraint from %@", buf, 0x16u);
          ...
          if (!v12)
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v90 = 2112;
              v91 = *(double *)&v18;
              _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Taking step constraint from %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v89 = v39;
          _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Min, max or step is nil", buf, 0xCu);
...
LABEL_28:
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v94 = 2112;
            v95 = v78;
            _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@Chosen min: %@, step: %@, max: %@", buf, 0x2Au);
          ...
          {
            v67 = v41;
            v68 = (void *)MEMORY[0x227676638](v51);
            v69 = v46;
            HMFGetOSLogHandle();
            v70 = objc_claimAutoreleasedReturnValue();
            v23 = v74;
...
LABEL_56:
              _os_log_impl(&dword_2218F0000, v70, OS_LOG_TYPE_ERROR, v72, buf, 0x16u);
          ...
          else
          {
            ...
            v54 = (void *)objc_claimAutoreleasedReturnValue();
            v55 = compareCharacteristicValue(v76, v54, (void *)1, &unk_24E9735A8);

            v23 = v74;
            if (v55)
            {
              v56 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7408]), "initWithType:value:", 1, v41);
              v57 = v73;
              objc_msgSend(v73, "addObject:", v56);

              v58 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7408]), "initWithType:value:", 3, v76);
              objc_msgSend(v73, "addObject:", v58);

              v18 = v8;
              v59 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7408]), "initWithType:value:", 2, v78);
...
LABEL_47:
        _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_ERROR, v65, buf, 0xCu);
...
+ (BOOL)_extractMinMaxStep:(id)a3 minConstraint:(id *)a4 maxConstraint:(id *)a5 stepConstraint:(id *)a6 first:(id)a7
{
  ...
  if (!a4 || !a5 || !a6)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v28;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot return result in invalid data", buf, 0xCu);
  ...
  if (!*a4 || !*a5 || !*a6)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v47 = 2112;
      v48 = v33;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Could not find min %@ or max %@ or step %@", buf, 0x2Au);
...
+ (id)_mergeValidValueConstraintsFirst:(id)a3 second:(id)a4 shouldAddMissing:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Valid value constraints: this: %lu, second: %lu", (uint8_t *)&v31, 0x20u);

  }
  objc_autoreleasePoolPop(v17);
  if (v5)
  {
    v21 = (void *)MEMORY[0x227676638](objc_msgSend(v12, "unionSet:", v16));
    v22 = v18;
    HMFGetOSLogHandle();
    v23 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
...
LABEL_8:
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, v26, (uint8_t *)&v31, 0x16u);

    }
  }
  else
  {
    v21 = (void *)MEMORY[0x227676638](objc_msgSend(v12, "intersectSet:", v16));
    v27 = v18;
    HMFGetOSLogHandle();
    v23 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
