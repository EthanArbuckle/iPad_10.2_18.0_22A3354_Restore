...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_113066 != -1)
    dispatch_once(&logCategory__hmf_once_t0_113066, &__block_literal_global_113067);
  return (id)logCategory__hmf_once_v1_113068;
}
...
void __43__HMDRemoteLoginAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_113068;
  logCategory__hmf_once_v1_113068 = v0;
