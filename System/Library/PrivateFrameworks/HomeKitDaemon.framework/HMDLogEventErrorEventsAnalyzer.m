...
+ (NSArray)errorEventsRequestGroupKeys
{
  if (errorEventsRequestGroupKeys_onceToken != -1)
    dispatch_once(&errorEventsRequestGroupKeys_onceToken, &__block_literal_global_252086);
...
- (HMDLogEventErrorEventsAnalyzer)initWithDataSource:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v15, 18);
    ...
    objc_msgSend(v4, "addThresholdTrigger:forEventName:requestGroup:atThreshold:", CFSTR("cloudKitImportErrorCount"), CFSTR("Any Error"), CFSTR("CoreDataCloudKitImportEvent"), 1);
    objc_msgSend(v4, "addThresholdTrigger:forEventName:requestGroup:atThreshold:", CFSTR("cloudKitExportErrorCount"), CFSTR("Any Error"), CFSTR("CoreDataCloudKitExportEvent"), 1);
  }
...
- (void)didReceiveEventFromDispatcher:(id)a3
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@_UnderlyingError"), v4);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v29, "error");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "userInfo");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "objectForKeyedSubscript:", *MEMORY[0x24BDD1398]);
...
- (id)eventCounterRequestGroupNameForLogEvent:(id)a3
{
  ...
  if (v41)
  {
    if (objc_msgSend(v41, "operationType") == 1)
    {
      v5 = CFSTR("CoreDataCloudKitImportEvent");
    }
    else if (objc_msgSend(v41, "operationType") == 2)
    {
      v5 = CFSTR("CoreDataCloudKitExportEvent");
    }
  }
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@_UnderlyingError"), v7);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HMDLogEventErrorEventsAnalyzer eventCountersManager](self, "eventCountersManager");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@_UnderlyingError"), v8);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
