...
- (NSDictionary)bulletinContext
{
  ...
  v37[5] = v28;
  v36[6] = *MEMORY[0x24BDD5370];
  objc_msgSend(v5, "contextSPIUniqueIdentifier");
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v26, "UUIDString");
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  v37[6] = v25;
  v36[7] = *MEMORY[0x24BDD5360];
  v34 = v4;
...
LABEL_13:
  ...
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v31, *MEMORY[0x24BE3EB68]);

  -[HMDCharacteristic metadata](self, "metadata");
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v32, "dumpState");
  v33 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v33, *MEMORY[0x24BE3EB00]);
...
- (BOOL)updateWithDictionary:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BE3F208], "hmf_cachedInstanceForString:", v9);
  ...
  v18 = -[HMDCharacteristic _characteristicPropertiesRelevantForCurrentUser:](self, "_characteristicPropertiesRelevantForCurrentUser:", v17);
  ...
  if (v19)
  {
    +[HMDCharacteristicMetadata characteristicMetadataWithDictionary:](HMDCharacteristicMetadata, "characteristicMetadataWithDictionary:", v19);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    if (v20 && !-[HMDCharacteristicMetadata isEqual:](self->_metadata, "isEqual:", v20))
    {
      +[HMFObjectCacheHMDCharacteristicMetadata cachedInstanceForCharacteristicMetadata:](HMFObjectCacheHMDCharacteristicMetadata, "cachedInstanceForCharacteristicMetadata:", v20);
      v21 = (HMDCharacteristicMetadata *)objc_claimAutoreleasedReturnValue();
...
{
  return -[HMDCharacteristic _characteristicDictionaryWithAuthData:](self, "_characteristicDictionaryWithAuthData:", 0);
}
...
- (id)_characteristicDictionaryWithAuthData:(BOOL)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", self->_characteristicProperties);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (int64_t)_characteristicPropertiesRelevantForCurrentUser:(int64_t)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_msgSend(v6, "isRestrictedGuest");
    ...
    if (v16 == 1)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138545154;
        ...
        v62 = 2112;
        v63 = v24;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring stale characteristic update value: %@, state number: %@, updated time: %@ Current value: %@ state number: %@, updated time: %@, accessory: %@", buf, 0x52u);
...
LABEL_12:
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEFAULT, v20, (uint8_t *)&v27, 0xCu);
...
- (NSData)authorizationData
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      ...
      {
        objc_msgSend(v7, "ownerCharacteristicAuthorizationData");
        v8 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "authorizationDataForCharacteristicWithInstanceID:accessoryUUID:homeModelID:", v9, v10, v11);
      }
      v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)validateValueForWrite:(id)a3 outValue:(id *)a4
{
  ...
  if ((-[HMDCharacteristic characteristicProperties](self, "characteristicProperties") & 4) != 0)
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 5);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)validateValueForNotify:(id)a3 outValue:(id *)a4
{
  ...
  if ((-[HMDCharacteristic characteristicProperties](self, "characteristicProperties") & 1) != 0)
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 7);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isClientNotificationEnabled
{
  ...
  -[HMDCharacteristic notificationRegistrations](self, "notificationRegistrations");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "na_any:", &__block_literal_global_89_106104);
...
- (BOOL)isNonBulletinNotificationEnabled
{
  ...
  -[HMDCharacteristic notificationRegistrations](self, "notificationRegistrations");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "na_any:", &__block_literal_global_91_106103);
...
- (BOOL)isNonClientNotificationEnabled
{
  ...
  -[HMDCharacteristic notificationRegistrations](self, "notificationRegistrations");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "na_any:", &__block_literal_global_92);
...
- (id)clientIdentifiersWithNotificationsEnabled
{
  ...
  -[HMDCharacteristic notificationRegistrations](self, "notificationRegistrations");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "na_map:", &__block_literal_global_96_106100);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v33 = 2048;
        v34 = v19;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Adding notification registration for client identifier: %@ threshold : %f", buf, 0x20u);
...
LABEL_16:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v10;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Removing notification registration for client identifier: %@", buf, 0x16u);
...
- (BOOL)supportsNotificationContext
{
  ...
  if ((self->_characteristicProperties & 0x100) != 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Notification context is supported for characteristic:%@", (uint8_t *)&v12, 0x16u);
  ...
  else
  {
    -[HMDCharacteristic type](self, "type");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    v4 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x24BE1B628]);

    if (v4)
    {
      -[HMDCharacteristic service](self, "service");
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "findCharacteristicWithType:", *MEMORY[0x24BE1B500]);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)contextDataForWriteRequestWithIdentifier:(id)a3
{
  ...
  {
    v5 = objc_alloc(MEMORY[0x24BE1BA10]);
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", v4);
    ...
    if (v9)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v25 = 2112;
        v26 = v4;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode context data:%@ with error:%@ identifier:%@", buf, 0x2Au);
    ...
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v23 = 2112;
        v24 = v4;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Context data:%@ for write request with identifier:%@", buf, 0x20u);
...
- (id)_initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BE3F208], "hmf_cachedInstanceForString:", v8);
    v9 = objc_claimAutoreleasedReturnValue();
    ...
    v5->_characteristicProperties = -[HMDCharacteristic _characteristicPropertiesRelevantForCurrentUser:](v5, "_characteristicPropertiesRelevantForCurrentUser:", (int)objc_msgSend(v4, "decodeInt32ForKey:", CFSTR("characteristicProperties")));
    ...
    if (v19)
    {
      objc_msgSend(v19, "na_map:", &__block_literal_global_103_106086);
      v21 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      v24 = objc_msgSend(v4, "hmd_isHH2MigrationInProgress");
      if (v24)
      {
...
- (void)_encodeWithCoder:(id)a3
{
  ...
  v40 = a3;
  v4 = objc_msgSend(v40, "hmd_isForXPCTransport");
  v5 = objc_msgSend(v40, "hmd_isForXPCTransportEntitledForSPIAccess");
  +[HMDHAPMetadata getSharedInstance](HMDHAPMetadata, "getSharedInstance");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDCharacteristic service](self, "service");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v40, "encodeConditionalObject:forKey:", v9, CFSTR("accessory"));
  objc_msgSend(v40, "encodeConditionalObject:forKey:", v7, CFSTR("service"));
  -[HMDCharacteristic characteristicInstanceID](self, "characteristicInstanceID");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v40, "encodeObject:forKey:", v10, CFSTR("characteristicInstanceID"));

  -[HMDCharacteristic characteristicType](self, "characteristicType");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v40, "encodeObject:forKey:", v11, CFSTR("characteristicType"));
  ...
  objc_msgSend(v40, "encodeInt32:forKey:", v13, CFSTR("characteristicProperties"));
  if ((objc_msgSend(v40, "hmd_isForRemoteGatewayCoder") & 1) == 0)
  {
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = objc_msgSend(v18, "isEqual:", CFSTR("unknown"));

    if ((v19 & 1) == 0)
    {
      -[HMDCharacteristic metadata](self, "metadata");
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v40, "encodeObject:forKey:", v20, CFSTR("characteristicMetadata"));

    }
    v21 = objc_msgSend(v40, "hmd_isForLocalStore");
    v22 = -[NSData length](self->_authorizationData, "length");
    v23 = v22 == 0;
    if (v22 && (v21 & 1) == 0)
      v23 = objc_msgSend(v40, "hmd_isForRemoteTransportOnSameAccount") ^ 1;
    if (objc_msgSend(v40, "hmd_isHH2MigrationInProgress") && (v23 & 1) == 0)
      objc_msgSend(v40, "encodeObject:forKey:", self->_authorizationData, CFSTR("kCharacteristicAuthorizationDataCodingKey"));
    if (!v21)
      goto LABEL_30;
    -[HMDCharacteristic notificationRegistrations](self, "notificationRegistrations");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "na_map:", &__block_literal_global_105_106078);
    v25 = (void *)objc_claimAutoreleasedReturnValue();

    if (objc_msgSend(v25, "count"))
      objc_msgSend(v40, "encodeObject:forKey:", v25, CFSTR("characteristicNotificationRegistrations"));
    -[HMDCharacteristic value](self, "value");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    if ((v13 & 1) != 0)
    {
      -[HMDCharacteristic type](self, "type");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      if (!objc_msgSend(v6, "isStandardCharacteristicType:", v27)
        || !v26
        || !isAllowedCharType())
      {
        goto LABEL_28;
      ...
      if (v28)
      {
        -[HMDCharacteristic value](self, "value");
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v40, "encodeObject:forKey:", v29, CFSTR("characteristicValue"));

        -[HMDCharacteristic stateNumber](self, "stateNumber");
        v27 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v40, "encodeObject:forKey:", v27, CFSTR("HM.stateNumber"));
LABEL_28:

      }
    }
    objc_msgSend(v40, "encodeBool:forKey:", -[HMDCharacteristic broadcastNotificationEnabled](self, "broadcastNotificationEnabled"), CFSTR("characteristicBroadcastNotificationEnabled"));
...
LABEL_30:
    if (objc_msgSend(v40, "hmd_isForXPCTransport"))
    {
      ...
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      v33 = objc_msgSend(v30, "requiresDeviceUnlock:forService:", v31, v32);

      -[HMDCharacteristic notificationRegistrations](self, "notificationRegistrations");
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      v35 = objc_msgSend(v34, "count") != 0;

      objc_msgSend(v40, "encodeBool:forKey:", v35, CFSTR("characteristicNotificationEnabled"));
      -[HMDCharacteristic value](self, "value");
      ...
      {
        objc_msgSend(v40, "encodeObject:forKey:", v36, CFSTR("characteristicValue"));
      }
      if (objc_msgSend(v40, "hmd_isForXPCTransportEntitledForSPIAccess"))
      {
        if (v33)
          objc_msgSend(v40, "encodeBool:forKey:", 1, CFSTR("HM.requiresDeviceUnlock"));
        -[HMDCharacteristic authorizationData](self, "authorizationData");
        v37 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v40, "encodeBool:forKey:", objc_msgSend(v37, "length") != 0, CFSTR("HM.characteristicAuthDataPresent"));

        -[HMDCharacteristic lastKnownValueUpdateTime](self, "lastKnownValueUpdateTime");
        v38 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v40, "encodeObject:forKey:", v38, CFSTR("characteristicValueUpdateTime"));

        -[HMDCharacteristic notificationEnabledTime](self, "notificationEnabledTime");
        v39 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v40, "encodeObject:forKey:", v39, CFSTR("characteristicNotificationEnableTime"));
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("0x%tx"), -[HMDCharacteristic properties](self, "properties"));
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v48[10] = v26;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v48, 11);
...
uint64_t __53__HMDCharacteristic_isNonBulletinNotificationEnabled__block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v2, "clientID");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v3, "isEqual:", CFSTR("com.apple.HomeKitDaemon.bulletinNotificationManager")) & 1) != 0)
  {
    v4 = 0;
  }
  else
  {
    objc_msgSend(v2, "clientID");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v4 = objc_msgSend(v5, "isEqual:", CFSTR("com.apple.HomeKitDaemon.bulletinBoard")) ^ 1;
...
{
  return &__block_literal_global_106168;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t43_106164 != -1)
    dispatch_once(&logCategory__hmf_once_t43_106164, &__block_literal_global_107);
  return (id)logCategory__hmf_once_v44_106165;
}

+ (NSDictionary)currentTargetStateCharacteristicTypeMap
{
  if (currentTargetStateCharacteristicTypeMap_onceToken != -1)
    dispatch_once(&currentTargetStateCharacteristicTypeMap_onceToken, &__block_literal_global_139_106162);
  return (NSDictionary *)(id)currentTargetStateCharacteristicTypeMap_characteristicsMap;
}
...
void __60__HMDCharacteristic_currentTargetStateCharacteristicTypeMap__block_invoke()
{
  ...
  v0 = *MEMORY[0x24BDD5A78];
  v1 = *MEMORY[0x24BDD5830];
  v14[0] = *MEMORY[0x24BDD5880];
  v14[1] = v1;
  v2 = *MEMORY[0x24BDD5A30];
  v15[0] = v0;
  v15[1] = v2;
  v3 = *MEMORY[0x24BDD5A68];
  v4 = *MEMORY[0x24BDD5818];
  v14[2] = *MEMORY[0x24BDD5868];
  v14[3] = v4;
  v5 = *MEMORY[0x24BDD5A18];
  v15[2] = v3;
  v15[3] = v5;
  v6 = *MEMORY[0x24BDD5A50];
  v7 = *MEMORY[0x24BDD5838];
  v14[4] = *MEMORY[0x24BDD5850];
  v14[5] = v7;
  v8 = *MEMORY[0x24BDD5A38];
  v15[4] = v6;
  v15[5] = v8;
  v9 = *MEMORY[0x24BDD5A60];
  v10 = *MEMORY[0x24BDD5870];
  v14[6] = *MEMORY[0x24BDD5860];
  v14[7] = v10;
  v11 = *MEMORY[0x24BDD5A70];
  v15[6] = v9;
  v15[7] = v11;
  v14[8] = *MEMORY[0x24BDD5890];
  v15[8] = *MEMORY[0x24BDD5A80];
...
void __32__HMDCharacteristic_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v44_106165;
  logCategory__hmf_once_v44_106165 = v0;
