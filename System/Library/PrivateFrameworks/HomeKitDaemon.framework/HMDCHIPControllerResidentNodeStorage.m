...
- (NSDictionary)debugDictionaryRepresentation
{
  ...
  -[HMDCHIPControllerResidentNodeStorage keyValueStore](self, "keyValueStore");
...
- (BOOL)updateUsingHomeModel:(id)a3
{
  id v4;
  void *v5;
  HMDCHIPControllerResidentNodeStorage *v6;
  NSObject *v7;
  void *v8;
  int v10;
  void *v11;
...
{
  HMDCHIPControllerResidentNodeStorage *v4;
  void *v5;

  v4 = -[HMDCHIPControllerResidentNodeStorage init](+[HMDCHIPControllerResidentNodeStorage allocWithZone:](HMDCHIPControllerResidentNodeStorage, "allocWithZone:", a3), "init");
  -[HMDCHIPControllerResidentNodeStorage keyValueStore](self, "keyValueStore");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDCHIPControllerResidentNodeStorage setKeyValueStore:](v4, "setKeyValueStore:", v5);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_250457 != -1)
    dispatch_once(&logCategory__hmf_once_t3_250457, &__block_literal_global_250458);
  return (id)logCategory__hmf_once_v4_250459;
}
...
void __51__HMDCHIPControllerResidentNodeStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_250459;
  logCategory__hmf_once_v4_250459 = v0;
