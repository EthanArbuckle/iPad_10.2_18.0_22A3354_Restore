...
- (void)main
{
  ...
  v4 = objc_alloc(MEMORY[0x24BE4ED10]);
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("add models for %@"), objc_opt_class());
...
void __39__HMDCameraClipAddModelsOperation_main__block_invoke_5(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully added models", (uint8_t *)&v8, 0xCu);
...
void __39__HMDCameraClipAddModelsOperation_main__block_invoke_7(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to add models: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_231511 != -1)
    dispatch_once(&logCategory__hmf_once_t3_231511, &__block_literal_global_231512);
  return (id)logCategory__hmf_once_v4_231513;
}
...
void __46__HMDCameraClipAddModelsOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_231513;
  logCategory__hmf_once_v4_231513 = v0;
