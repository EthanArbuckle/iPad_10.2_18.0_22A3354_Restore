...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", -[HMDNetworkRouterFirewallRuleLANMulticast port](self, "port"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v19, "addressFamily") != 1 && objc_msgSend(v20, "addressFamily") != 2)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v36 = 2112;
      v37 = v20;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid IP address value: %@", buf, 0x16u);
