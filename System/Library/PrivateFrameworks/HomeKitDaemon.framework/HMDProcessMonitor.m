...
+ (id)logCategory
{
  if (logCategory__hmf_once_t22_150836 != -1)
    dispatch_once(&logCategory__hmf_once_t22_150836, &__block_literal_global_21_150837);
  return (id)logCategory__hmf_once_v23_150838;
}
...
- (void)_processAppStateChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Processing change of state for %@", (uint8_t *)&v9, 0x16u);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    if (v10)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v12;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Processing pending terminated applications after timer expired", buf, 0xCu);
  ...
  else
  {
    if (v10)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v11;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Received an unknown watchdog timer expiry", buf, 0xCu);
...
- (id)processInfoForConnection:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 2112;
      v19 = v5;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Created process info: %@", (uint8_t *)&v16, 0x16u);
...
- (void)removeProcess:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing process info: %@", (uint8_t *)&v17, 0x16u);
  ...
  if (v9)
  {
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v17 = 138543362;
        v18 = v16;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating application monitor because last process info was removed from application info", (uint8_t *)&v17, 0xCu);
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = v27;
            ...
            v36 = 2112;
            v37 = v6;
            _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Dropping termination notification for %@", buf, 0x16u);
...
- (NSArray)foregroundProcesses
{
  ...
  -[NSMutableSet allObjects](self->_processes, "allObjects");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "na_map:", &__block_literal_global_150810);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)addProcess:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Adding process info: %@", (uint8_t *)&v9, 0x16u);
...
void __45__HMDProcessMonitor_updateApplicationMonitor__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v4 = objc_alloc_init(MEMORY[0x24BE80CF8]);
...
void __45__HMDProcessMonitor_updateApplicationMonitor__block_invoke_15(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    if (!WeakRetained[2])
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BE80CC8], "monitorWithConfiguration:", *(_QWORD *)(a1 + 40));
        v9 = objc_claimAutoreleasedReturnValue();
        v10 = (void *)v3[2];
        v3[2] = v9;
        goto LABEL_11;
...
LABEL_11:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Lost self pointer for HMDProcessMonitor configuration block.", (uint8_t *)&v11, 0xCu);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v57 = 2112;
      v58 = v8;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Received app state change: %@", buf, 0x16u);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v59 = 2112;
        v60 = v19;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating %@ with new state: %@", buf, 0x20u);
          ...
          || objc_msgSend(v13, "isSuspended"))
        {
          if ((objc_msgSend(v13, "isTerminated") & 1) == 0 && objc_msgSend(v13, "isEntitledForSPIAccess"))
          {
            ...
            if (!objc_msgSend(v13, "isTerminated")
              || !objc_msgSend(v21, "isEqual:", *MEMORY[0x24BDD6360]))
            {
              ...
              if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v57 = 2112;
                v58 = v21;
                _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_DEFAULT, "%{public}@Delaying notification of backgrounding, termination or suspension %@", buf, 0x16u);
              ...
              {
                v50 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 0, 5.0);
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v56 = v25;
              _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Handling HomeUIService termination with no delay", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v48, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v57 = 2112;
            v58 = v13;
            _os_log_impl(&dword_2218F0000, v48, OS_LOG_TYPE_DEFAULT, "%{public}@%@ back into foreground", buf, 0x16u);
...
LABEL_37:
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v56 = v38;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Unknown appState - ignoring", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v57 = 2048;
        v58 = (id)v33;
        _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up processInfo for pid %lu", buf, 0x16u);
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v56 = v28;
    _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Lost self for RBSProcessMonitorUpdateInfo.", buf, 0xCu);
...
void __32__HMDProcessMonitor_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v23_150838;
  logCategory__hmf_once_v23_150838 = v0;
