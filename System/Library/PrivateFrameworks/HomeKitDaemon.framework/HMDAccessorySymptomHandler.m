...
- (HMDAccessorySymptomHandler)initWithAccessory:(id)a3 logIdentifier:(id)a4 symptomManager:(id)a5 activeClientConnectionsManager:(id)a6
{
  ...
  if (v14)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD7A28], "symptomsHandlerUUIDFromAccessoryUUID:", v15->_accessoryUUID);
...
- (void)updateSymptoms:(id)a3
{
  ...
  if ((v7 & 1) != 0)
  {
    if (v11)
    {
      ...
      v18 = 2112;
      v19 = v13;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Not updating accessory symptoms from %@", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    if (v11)
    {
      ...
      v20 = 2112;
      v21 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory symptoms from %@ to %@", (uint8_t *)&v16, 0x20u);
...
- (id)_filteredSymptomsForSymptoms:(id)a3
{
  ...
  if (v9)
  {
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 11);
    ...
    if ((objc_msgSend(v11, "supportsCaptiveNetworks") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 2112;
        v22 = v9;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Remove NeedCaptiveLeaseRenewal symptom as accessory %@ does not support captive networks", (uint8_t *)&v19, 0x16u);

      }
      objc_autoreleasePoolPop(v12);
      v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 19);
...
LABEL_18:
    ...
    *(_OWORD *)buf = *MEMORY[0x24BE3EF38];
    v22 = *(_QWORD *)(MEMORY[0x24BE3EF38] + 16);
...
- (void)_notifyAllSubscribedClientConnections
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Notifying all %lu subscribed clients of updated symptom state", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed clients to notify of updated symptom state", (uint8_t *)&v13, 0xCu);
...
- (void)_notifySubscribedClientConnection:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Notifying subscribed client of updated symptom state: %@", (uint8_t *)&v11, 0x16u);
...
- (void)_notifySubscribedClientConnections:(id)a3
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setObject:forKeyedSubscript:", v8, *MEMORY[0x24BDD6F60]);

  -[HMDAccessorySymptomHandler sfDeviceIdentifier](self, "sfDeviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setObject:forKeyedSubscript:", v9, *MEMORY[0x24BDD6F48]);
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x24BE3F1D0], "entitledMessageWithName:messagePayload:", v13, v6);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleInitiateFixMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v26 = 2112;
    v27 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling initiate fix message: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v19;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot initiate fix for non-Apple-media accessory %@", buf, 0x16u);
...
- (void)_handleSubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = (uint64_t)v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling subscribe message: %@", (uint8_t *)&v22, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v20;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Subscribing transport was not of expected class %@: %@", (uint8_t *)&v22, 0x20u);
...
- (void)_handleUnsubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = (uint64_t)v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling unsubscribe message: %@", (uint8_t *)&v22, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v20;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unsubscribing transport was not of expected class %@: %@", (uint8_t *)&v22, 0x20u);
...
void __56__HMDAccessorySymptomHandler__handleInitiateFixMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to initiate fix for accessory %@: %@", (uint8_t *)&v12, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v11;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Successfully initiated fix for accessory: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24 != -1)
    dispatch_once(&logCategory__hmf_once_t24, &__block_literal_global_20923);
