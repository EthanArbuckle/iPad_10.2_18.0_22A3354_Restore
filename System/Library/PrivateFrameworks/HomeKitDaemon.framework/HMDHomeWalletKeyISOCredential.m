...
- (void)encodeWithCompletion:(id)a3
{
  ...
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE10208]), "initEC2WithAlgorithm:curveIdentifier:x:y:d:keyOperations:keyIdentifier:", -7, 1, v21, v20, 0, 0, 0);
  objc_msgSend(MEMORY[0x24BDBCE50], "dataWithCOSEKey:", v6);
  ...
  v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BE00]), "initWithElementIdentifier:dataValue:", CFSTR("credential_id"), v9);
  v24 = v10;
  ...
  v13 = objc_alloc(MEMORY[0x24BE1BE10]);
...
- (void)signPayloadWithBuilder:(id)a3 data:(id)a4 completion:(id)a5
{
  ...
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCE50]), "initWithBytes:length:", v28, 64);
  v19 = objc_alloc(MEMORY[0x24BE1BDF8]);
  -[HMDHomeWalletKeyISOCredential pairingIdentity](self, "pairingIdentity");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
