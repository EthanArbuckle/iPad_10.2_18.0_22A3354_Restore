...
LABEL_7:
  ...
  if (v9)
  {
    ...
    v10->_personManagerFactory = &__block_literal_global_176306;
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v28 = 2112;
      v29 = v10;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Initialized home person manager settings: %@, home person manager zone UUID: %@", buf, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v19;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", buf, 0xCu);
...
- (id)updateSettingsModelWithSettings:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v47 = 2112;
    v48 = v5;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating home person manager settings: %@", buf, 0x16u);
  ...
  if (v11)
  {
          ...
          !v15))
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v47 = 2112;
        v48 = v32;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Face Classification is now enabled. Updating settings with new home person manager zone UUID: %@", buf, 0x16u);
    ...
    else if ((objc_msgSend(v5, "isFaceClassificationEnabled") & 1) == 0)
    {
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v46 = v20;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Face Classification is now disabled. Updating settings to remove zone UUID", buf, 0xCu);
    ...
    v33 = objc_alloc_init(MEMORY[0x24BE6B608]);
    v34 = objc_alloc(MEMORY[0x24BE3F1D0]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v46 = v24;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", buf, 0xCu);
...
- (void)handleUpdatedSettingsModel:(id)a3 previousSettingsModel:(id)a4 message:(id)a5
{
  ...
  v15 = (void *)MEMORY[0x227676638]((id)objc_msgSend(v14, "merge:", v8));
  v16 = self;
  HMFGetOSLogHandle();
  v17 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v60 = 2112;
    v61 = v19;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling updated home person manager settings model: %@", buf, 0x16u);
      ...
      if ((v23 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v62 = 2112;
          v63 = v50;
          _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Updating home person manager settings from %@ to %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v62 = 2112;
          v63 = v29;
          _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_INFO, "%{public}@Updating home person manager zone UUID from %@ to %@", buf, 0x20u);
...
- (void)configurePersonManagerWithZoneUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Configuring home person manager: %@", (uint8_t *)&v20, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 138543362;
      v21 = v19;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", (uint8_t *)&v20, 0xCu);
...
- (void)removeCloudDataDueToHomeGraphObjectRemoval:(BOOL)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing home person cloud data", (uint8_t *)&v18, 0xCu);

    }
    objc_autoreleasePoolPop(v7);
    -[HMDHomePersonDataManager personManager](v8, "personManager");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = objc_alloc_init(MEMORY[0x24BDD76F0]);
...
- (void)handleUpdateSettingsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v32 = 2112;
    v33 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling update person manager settings message payload: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v6);
  v11 = *MEMORY[0x24BDD6220];
  v29 = objc_opt_class();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v24;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not find person manager settings in message payload: %@", buf, 0x16u);
...
LABEL_4:
    if (*(_QWORD *)(a1 + 40))
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v5;
        _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Home person manager zone UUID is now nil. Removing home person manager", (uint8_t *)&v14, 0xCu);
...
LABEL_8:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v12;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Home person manager zone UUID changed from %@ to %@. Configuring home person manager", (uint8_t *)&v14, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_176313 != -1)
    dispatch_once(&logCategory__hmf_once_t17_176313, &__block_literal_global_25_176314);
  return (id)logCategory__hmf_once_v18_176315;
}
...
void __39__HMDHomePersonDataManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_176315;
  logCategory__hmf_once_v18_176315 = v0;
