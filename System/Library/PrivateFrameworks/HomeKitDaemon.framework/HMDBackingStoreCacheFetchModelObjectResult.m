...
- (HMDBackingStoreCacheFetchModelObjectResult)initWithRecord:(id)a3 data:(id)a4 encoding:(unint64_t)a5 error:(id *)a6
{
  ...
  if (v10 && v11)
  {
    v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1620]), "initForReadingFromData:error:", v10, 0);
    v14 = objc_msgSend(objc_alloc(MEMORY[0x24BDB91D8]), "initWithCoder:", v13);
    record = v12->_record;
    ...
    if (*a6)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 2112;
        v29 = v22;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@unable to decode cached object %@", buf, 0x16u);
