...
- (id)_nextTimerDate
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Next Fire Date : [%@]", (uint8_t *)&v15, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_236229 != -1)
    dispatch_once(&logCategory__hmf_once_t0_236229, &__block_literal_global_236230);
  return (id)logCategory__hmf_once_v1_236231;
}
...
void __31__HMDDurationEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_236231;
  logCategory__hmf_once_v1_236231 = v0;
