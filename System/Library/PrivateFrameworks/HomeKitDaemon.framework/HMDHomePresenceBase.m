...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_139390 != -1)
    dispatch_once(&logCategory__hmf_once_t0_139390, &__block_literal_global_139391);
  return (id)logCategory__hmf_once_v1_139392;
}
...
void __34__HMDHomePresenceBase_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_139392;
  logCategory__hmf_once_v1_139392 = v0;
