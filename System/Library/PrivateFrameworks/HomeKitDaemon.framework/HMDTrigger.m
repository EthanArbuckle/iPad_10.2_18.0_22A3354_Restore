...
- (HMDTrigger)initWithModel:(id)a3 home:(id)a4
{
  ...
  void *v25;
  int v26;
  HMDTriggerDeleteAfterExecutionPolicy *v27;
  ...
  if (v10)
  {
    ...
    if (v26)
      v27 = objc_alloc_init(HMDTriggerDeleteAfterExecutionPolicy);
    else
      v27 = 0;
...
- (id)attributeDescriptions
{
  ...
  v29 = (void *)objc_msgSend(v3, "initWithName:value:", CFSTR("NM"), v30);
  v31[0] = v29;
  v4 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDTrigger configuredName](self, "configuredName");
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = (void *)objc_msgSend(v4, "initWithName:value:", CFSTR("CN"), v28);
  v31[1] = v27;
  v5 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDTrigger uuid](self, "uuid");
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v25 = (void *)objc_msgSend(v5, "initWithName:value:", CFSTR("UUID"), v26);
  v31[2] = v25;
  v6 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDTrigger active](self, "active");
  HMFBooleanToString();
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v23 = (void *)objc_msgSend(v6, "initWithName:value:", CFSTR("ACT"), v24);
  v31[3] = v23;
  v7 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDTrigger shouldActivateOnLocalDevice](self, "shouldActivateOnLocalDevice");
  HMFBooleanToString();
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v7, "initWithName:value:", CFSTR("AOLD"), v22);
  v31[4] = v8;
  ...
  v13 = (void *)objc_msgSend(v9, "initWithName:value:options:formatter:", CFSTR("USR"), v11, 2, v12);
  v31[5] = v13;
  v14 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDTrigger actionSets](self, "actionSets");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = (void *)objc_msgSend(v14, "initWithName:value:", CFSTR("AS"), v15);
  v31[6] = v16;
  v17 = objc_alloc(MEMORY[0x24BE3F140]);
  -[HMDTrigger policy](self, "policy");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = (void *)objc_msgSend(v17, "initWithName:value:", CFSTR("PO"), v18);
  v31[7] = v19;
...
- (id)dumpState
{
  ...
  v12 = v34;
  v33 = (void *)v11;
  objc_msgSend(v34, "setObject:forKeyedSubscript:", v11, *MEMORY[0x24BE3EB68]);
  -[HMDTrigger actionSets](self, "actionSets");
  ...
  if (v14)
  {
    ...
    v12 = v34;
    objc_msgSend(v34, "setObject:forKeyedSubscript:", v37, *MEMORY[0x24BE3EA50]);
...
- (void)_forceEvaluate
{
  ...
  if (-[HMDTrigger active](self, "active"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Trigger is active. Hence force evaluating", (uint8_t *)&v7, 0xCu);
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v29 = 2112;
        v30 = v6;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Action set %@ has been removed from home, cleaning the trigger", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v11);
      v15 = (void *)MEMORY[0x24BE3F1D0];
      v26[0] = MEMORY[0x24BDBD1C0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v24;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Not the owner of this home, cannot clean up the action set reference", buf, 0xCu);
...
LABEL_10:
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, v11, (uint8_t *)&v12, 0xCu);
...
- (void)sendTriggerFiredNotification:(id)a3
{
  ...
  if (-[HMDTrigger _isTriggerFiredNotificationEntitled](self, "_isTriggerFiredNotificationEntitled"))
    objc_msgSend(MEMORY[0x24BE3F1B0], "entitledMessageWithName:messagePayload:", CFSTR("kTriggerFiredNotificationKey"), v4);
  else
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v19 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating trigger", buf, 0xCu);
...
- (void)activateWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Work queue is not configured, cannot activate", buf, 0xCu);
...
- (void)activateAfterResidentChangeWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Re-evaluating trigger after resident change", (uint8_t *)&v9, 0xCu);
...
- (void)markChangedForMessage:(id)a3 triggerModel:(id)a4
{
  ...
  if (v10)
  {
    if (v14)
    {
      ...
      v17 = 138543362;
      v18 = v15;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Not re-activating the trigger after applying the trigger model since it only contains mostRecentFireDate", (uint8_t *)&v17, 0xCu);
  ...
  else
  {
    if (v14)
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Activating the trigger after applying the trigger model", (uint8_t *)&v17, 0xCu);
...
- (void)_activate:(BOOL)a3 completionHandler:(id)a4
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD5BD8], 25, 0);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v6[2](v6, v14);
...
LABEL_8:
  ...
  if (objc_msgSend(v6, "length") > v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@New name is longer than the pre-defined max length", buf, 0xCu);
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v42 = 2112;
      v43 = v14;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Rename request received : [%@, %@] [%@, %@]", buf, 0x34u);
...
- (id)canRenameTriggerWithNewName:(id)a3 configuredName:(id)a4 error:(id *)a5
{
  ...
  if (*a5)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v52 = 2112;
      v53 = v18;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Invalid characters found in trigger name. %@", buf, 0x16u);
  ...
  if (!v20)
  {
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v51 = v37;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Name cannot be empty.", buf, 0xCu);
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v52 = 2112;
    v53 = v13;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@New Trigger name after trimming invalid characters : %@", buf, 0x16u);
  ...
  if (v27)
  {
    ...
    if (v29)
    {
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v51 = v34;
        _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Cannot rename the trigger as new trigger name & configured names are same.", buf, 0xCu);
...
LABEL_16:
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v56 = 2112;
      v57 = v47;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@Allowing rename request as current name : %@ & strippedName are same : %@ but configuredName [%@] is different", buf, 0x2Au);
    ...
    if (v39)
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v56 = 2112;
        v57 = v39;
        _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Cannot rename the trigger from %@ to %@ due to %@", buf, 0x2Au);
...
- (void)_handleAddTriggerOwnedActionSetRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1880], "hm_deriveUUIDFromBaseUUID:", v5);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "UUIDString");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDActionSetModel setName:](v9, "setName:", v11);

    -[HMDActionSetModel setType:](v9, "setType:", *MEMORY[0x24BDD5218]);
    -[HMDTrigger emptyModelObject](self, "emptyModelObject");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v28 = 138543362;
    v29 = v26;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@ActionSetUUID not set.", (uint8_t *)&v28, 0xCu);
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 138543362;
        v27 = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Remove of trigger action set, not posting event trigger update model as requested", (uint8_t *)&v26, 0xCu);
...
- (void)_handleRemoveTriggerOwnedActionSetRequest:(id)a3 postUpdate:(BOOL)a4
{
  ...
  if (v7)
  {
    ...
    {
      v24 = (void *)MEMORY[0x227676638](v16);
      v25 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 138543362;
        v29 = v27;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Remove of trigger owned action set, not posting event trigger update model as requested", (uint8_t *)&v28, 0xCu);
...
- (void)_updateActionSetRequest:(id)a3 postUpdate:(BOOL)a4
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x24BDD5218]);
...
- (void)_actionSetsUpdated:(id)a3 message:(id)a4
{
  ...
  v73 = (void *)v12;
  v74 = v9;
  v13 = (void *)MEMORY[0x227676638](objc_msgSend(v9, "minusSet:", v12));
  v14 = self;
  HMFGetOSLogHandle();
  v15 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v98 = 2112;
    v99 = v9;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@addedActionSets: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v98 = 2112;
    v99 = v73;
    _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@removedActionSets: %@", buf, 0x16u);
        ...
        do
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v98 = 2112;
            v99 = v28;
            _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_INFO, "%{public}@Action set %@ has been added", buf, 0x16u);

          }
          objc_autoreleasePoolPop(v29);
          v33 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v28);
                ...
                (v34 = (void *)objc_claimAutoreleasedReturnValue()) != 0))
          {
            ...
            if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v97 = v44;
              _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@Responding to clients that actionSet has been added to the trigger.", buf, 0xCu);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v98 = 2112;
              v99 = v28;
              _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@Action set %@ could not be found", buf, 0x16u);
        ...
        for (i = 0; i != v51; ++i)
        {
          ...
          if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v98 = 2112;
            v99 = v54;
            _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_INFO, "%{public}@Action set %@ has been deleted", buf, 0x16u);
          ...
          if (v59)
          {
            ...
            if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v97 = v67;
              _os_log_impl(&dword_2218F0000, v66, OS_LOG_TYPE_INFO, "%{public}@Notifying clients that actionSet has been removed from the trigger.", buf, 0xCu);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v70, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v98 = 2112;
              v99 = v54;
              _os_log_impl(&dword_2218F0000, v70, OS_LOG_TYPE_INFO, "%{public}@Action set %@ could not be found", buf, 0x16u);
...
- (void)_handleUpdateTriggerPolicyRequest:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend(v4, "dictionaryForKey:", *MEMORY[0x24BDD6FD0]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v25 = 0;
    v7 = objc_msgSend(v6, "hmf_BOOLForKey:isPresent:", *MEMORY[0x24BDD6FC0], &v25);
    if (v25)
    {
      v8 = v7;
      -[HMDTrigger emptyModelObject](self, "emptyModelObject");
    ...
    {
      v21 = (void *)MEMORY[0x227676638](v7);
      v22 = self;
      HMFGetOSLogHandle();
      v23 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v24;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid payload for update policy request", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Trigger not associated to a home", buf, 0xCu);
...
- (void)_handleRemoveTriggerPolicyRequest:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Policy already removed", (uint8_t *)&v19, 0xCu);
...
- (void)_executeActionSets:(id)a3 captureCurrentState:(BOOL)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v34;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Executing action sets: %@", buf, 0x16u);
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Not executing action sets: device is in lost mode", buf, 0xCu);
  ...
  else
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v29;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Not executing action sets: trigger is unconfigured", buf, 0xCu);
    ...
    {
      objc_msgSend(v34, "na_filter:", &__block_literal_global_49);
      v36 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v36, "count"))
      {
        ...
        *(_QWORD *)&buf[16] = 0x3032000000;
        v56 = __Block_byref_object_copy__1277;
        v57 = __Block_byref_object_dispose__1278;
        v58 = 0;
        v52[0] = 0;
        v52[1] = v52;
        v52[2] = 0x3032000000;
        v52[3] = __Block_byref_object_copy__1277;
        v52[4] = __Block_byref_object_dispose__1278;
        objc_msgSend(MEMORY[0x24BDBCED8], "dictionary");
        ...
        if (v20)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              v43[1] = 3221225472;
              v43[2] = __71__HMDTrigger__executeActionSets_captureCurrentState_completionHandler___block_invoke_50;
              v43[3] = &unk_24E7736A0;
              v43[4] = v8;
              v46 = buf;
              v24 = v19;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v33;
          _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Not executing action sets: all action sets have an empty list of actions", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v30);
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 25);
        v19 = objc_claimAutoreleasedReturnValue();
        v35[2](v35, v19, 0);
      }
...
- (void)_registerForMessages
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v24, "administratorHandler");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_fillBaseObjectChangeModel:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDTrigger active](self, "active"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", v11 & (v12 != 0));
  v13 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setAutoDelete:", v13);
...
- (void)_handleTriggerUpdate:(id)a3 message:(id)a4
{
  ...
  void *v54;
  int v55;
  HMDTriggerDeleteAfterExecutionPolicy *v56;
  void *v57;
  void *v58;
  void *v59;
  void *v60;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v68 = 2112;
    v69 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling base trigger update: %@, %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v72 = 2112;
    v73 = v27;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Parameter configured From : [%@, %@] To: [%@, %@]", buf, 0x34u);
  ...
  -[HMDTrigger configuredName](v23, "configuredName");
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v30, "setObject:forKeyedSubscript:", v32, *MEMORY[0x24BDD6FB0]);
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v66 = 2112;
    v67 = v30;
    _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@name parameter configured : payload : %@", buf, 0x16u);
...
LABEL_13:
  ...
  objc_msgSend(v6, "setProperties");
  v47 = (void *)objc_claimAutoreleasedReturnValue();
  v48 = objc_msgSend(v47, "containsObject:", CFSTR("active"));

  if (v48)
  {
    objc_msgSend(v6, "active");
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDTrigger setActive:](v9, "setActive:", objc_msgSend(v49, "BOOLValue"));

    v62 = CFSTR("kTriggerActivate");
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDTrigger active](v9, "active"));
    v50 = (void *)objc_claimAutoreleasedReturnValue();
    v63 = v50;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v63, &v62, 1);
    v51 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v7, "respondWithPayload:", v51);
  }
  objc_msgSend(v6, "setProperties");
  v52 = (void *)objc_claimAutoreleasedReturnValue();
  v53 = objc_msgSend(v52, "containsObject:", CFSTR("autoDelete"));
  ...
  if (v53)
  {
    ...
    if (v55)
    {
      ...
      -[HMDTrigger setPolicy:](v9, "setPolicy:", v56);
    ...
    objc_msgSend(*(id *)(v16 + 3800), "dictionaryWithCapacity:", 1);
    v59 = (void *)objc_claimAutoreleasedReturnValue();
    if (v58)
    {
      objc_msgSend(v58, "UUIDString");
      v60 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v59, "setObject:forKeyedSubscript:", v60, *MEMORY[0x24BDD6FE0]);
...
- (void)executeCompleteWithError:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Trigger is marked to be deleted after execution (finished with error: %@), removing...", (uint8_t *)&v13, 0x16u);
...
- (id)_initWithCoder:(id)a3
{
  ...
  if (v8)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x24BDD6FA8]);
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v35, *MEMORY[0x24BDD6FC8]);
    v36 = objc_claimAutoreleasedReturnValue();
    policy = v8->_policy;
...
- (void)_encodeWithCoder:(id)a3
{
  ...
  -[HMDTrigger home](self, "home");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "encodeConditionalObject:forKey:", v4, CFSTR("home"));
  -[HMDTrigger name](self, "name");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "encodeObject:forKey:", v5, CFSTR("triggerName"));

  -[HMDTrigger uuid](self, "uuid");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "UUIDString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "encodeObject:forKey:", v7, CFSTR("triggerUUID"));

  -[HMDTrigger actionSets](self, "actionSets");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "encodeObject:forKey:", v8, CFSTR("triggerActionSets"));

  objc_msgSend(v20, "encodeBool:forKey:", -[HMDTrigger active](self, "active"), CFSTR("triggerActive"));
  -[HMDTrigger configuredName](self, "configuredName");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "encodeObject:forKey:", v9, *MEMORY[0x24BDD6FA8]);

  LODWORD(v9) = objc_msgSend(v20, "hmd_isForXPCTransport");
  v10 = objc_msgSend(v20, "hmd_isForXPCTransportEntitledForSPIAccess");
  if (!(_DWORD)v9)
  {
    -[HMDTrigger actionSetUUIDs](self, "actionSetUUIDs");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v16, CFSTR("triggerActionSetUUIDs"));

    -[HMDTrigger owner](self, "owner");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v17, CFSTR("HM.user"));

    -[HMDTrigger policy](self, "policy");
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v18, *MEMORY[0x24BDD6FC8]);

LABEL_8:
    -[HMDTrigger mostRecentFireDate](self, "mostRecentFireDate");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v19, CFSTR("triggerLastFireDate"));

    goto LABEL_9;
  }
  v11 = v10;
  v12 = -[HMDTrigger shouldEncodeLastFireDate:](self, "shouldEncodeLastFireDate:", v20);
  if (v11)
  {
    -[HMDTrigger policy](self, "policy");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "encodeObject:forKey:", v13, *MEMORY[0x24BDD6FC8]);
    ...
    if (v14)
    {
      -[HMDTrigger owner](self, "owner");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v20, "encodeObject:forKey:", v15, CFSTR("HM.user"));
...
- (id)updateEventTriggerMessage:(int)a3 message:(id)a4 relay:(BOOL)a5
{
  ...
  objc_msgSend(v12, "setResponseHandler:", v11);
...
void __54__HMDTrigger_updateEventTriggerMessage_message_relay___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    objc_msgSend(*(id *)(a1 + 32), "userForHome:", *(_QWORD *)(a1 + 40));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v8, "isOwner") & 1) != 0)
    {
      v9 = 1;
    }
    else if (objc_msgSend(v8, "isAdministrator"))
    {
      v9 = 2;
    }
    else
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "setRequestOrigin:", v9);

    v12 = *(unsigned int *)(a1 + 56);
    -[HomeKitEventTriggerUpdateLogEvent analyticsData](v7, "analyticsData");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "setUpdateType:", v12);
...
void __71__HMDTrigger__executeActionSets_captureCurrentState_completionHandler___block_invoke_50(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  NSObject *v7;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_1323 != -1)
    dispatch_once(&logCategory__hmf_once_t0_1323, &__block_literal_global_1324);
  return (id)logCategory__hmf_once_v1_1325;
}
...
void __25__HMDTrigger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_1325;
  logCategory__hmf_once_v1_1325 = v0;
