...
- (HMDBackingStoreLogAddTransactionOperation)initWithTransaction:(id)a3
{
  ...
  v4 = a3;
  isWatch();
  v5 = -[HMDBackingStoreLogAddTransactionOperation initWithAtomicSaveEnabled:transaction:](self, "initWithAtomicSaveEnabled:transaction:", 1, v4);
      ...
      if (v18)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_QWORD *)&location[4] = v23;
          ...
          v35 = 2112;
          v36 = v18;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit non-atomic transaction %lu: %@", location, 0x20u);
      ...
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_QWORD *)&location[4] = v24;
          v33 = 2048;
          v34 = v13;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully committed non-atomic transaction %lu to log", location, 0x16u);
  ...
  if (!v3)
  {
    ...
    if (v6)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 32;
LABEL_10:
        _os_log_impl(&dword_2218F0000, v18, v19, v17, (uint8_t *)&v22, v20);
