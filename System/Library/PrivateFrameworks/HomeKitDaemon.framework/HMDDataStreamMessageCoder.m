...
+ (BOOL)_decryptEncryptedOPACKFrame:(id)a3 sessionEncryption:(id)a4 receivedHeader:(id *)a5 receivedPayload:(id *)a6 error:(id *)a7
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1050);
    v13 = 0;
...
+ (id)_encodeOPACKHeader:(id)a3 payload:(id)a4 error:(id *)a5
{
  ...
  v7 = a4;
  v18 = 0;
  v8 = (void *)MEMORY[0x2276758C4](a3, 0, &v18);
  if (v18)
    v9 = 1;
  else
    v9 = v8 == 0;
  if (!v9)
  {
    v11 = MEMORY[0x2276758C4](v7, 0, &v18);
    v12 = (void *)v11;
    if (v18 || !v11)
    {
      if (a5)
    ...
    else
    {
      ...
      {
        v17 = v13;
        objc_msgSend(MEMORY[0x24BDBCEC8], "dataWithCapacity:", v13 + v14 + 1);
...
+ (id)_encryptEncryptedOPACKHeader:(id)a3 payload:(id)a4 sessionEncryption:(id)a5 error:(id *)a6
{
  ...
  if ((unint64_t)(v12 + 20) < 0x100000)
  {
    ...
    v18[2] = BYTE1(v12);
    v18[3] = v12;
    objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", v18, 4);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "encrypt:additionalAuthenticatedData:", v11, v15);
    v16 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDBCEC8], "dataWithCapacity:", v13);
