...
- (void)handleAccessorySettingsFetchRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v52 = 2112;
    v53 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling accessory settings fetch request message: %@", buf, 0x16u);
  ...
  if (v9)
  {
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7428]), "initWithPayload:", v9);
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v52 = 2112;
        v53 = v9;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch request payload with message payload: %@", buf, 0x16u);
    ...
    if (v11)
    {
      ...
      if (!v13)
      {
          ...
          if (objc_msgSend(v32, "containsObject:", CFSTR("root.siri.availableLanguages")))
          {
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              ...
              v47 = v33;
              v37 = (void *)v36;
              _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Fetching siri available language setting", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v51 = (uint64_t)v42;
            _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due to no delegate", buf, 0xCu);
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v52 = 2112;
        v53 = v14;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due caller privilege data sourcing error: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v51 = (uint64_t)v30;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due no caller version", buf, 0xCu);
...
LABEL_32:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v51 = (uint64_t)v22;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload on fetch request message", buf, 0xCu);
...
- (id)siriAvailableLanguagesSetting
{
  ...
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7728]), "initWithKeyPath:readOnly:languageValues:", CFSTR("root.siri.availableLanguages"), 1, v3);
  return v4;
}
...
- (void)handleAccessorySettingsUpdateRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2112;
    v40 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling accessory settings update request message: %@", buf, 0x16u);
  ...
  if (v9)
  {
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7440]), "initWithPayload:", v9);
    if (v10)
    {
      -[HMDAccessorySettingsLocalMessageHandler callerVersionForMessage:](v6, "callerVersionForMessage:", v4);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      if (v11)
      {
        ...
        if (v12)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v38 = v36;
              _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due to no delegate", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v38 = v32;
            _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting as unable to determine setting value from payload", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v38 = v28;
          _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due no caller version", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v39 = 2112;
        v40 = v9;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create update request payload with message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to update settings due to no payload found on message", buf, 0xCu);
...
LABEL_7:
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, v14, (uint8_t *)&v16, 0xCu);
  ...
  if ((objc_msgSend(v4, "isRemote") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 2112;
        v17 = v5;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get caller version from remote source device: %@", (uint8_t *)&v14, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_122130 != -1)
    dispatch_once(&logCategory__hmf_once_t16_122130, &__block_literal_global_122131);
  return (id)logCategory__hmf_once_v17_122132;
}
...
void __54__HMDAccessorySettingsLocalMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v17_122132;
  logCategory__hmf_once_v17_122132 = v0;
