...
- (void)_authenticateAccount:(id)a3 alreadyExists:(BOOL)a4 withCompanionDevice:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2112;
    v31 = v9;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Authenticating the account %@, service type %@, with companion device: %@", (uint8_t *)&v24, 0x2Au);

  }
  objc_autoreleasePoolPop(v10);
  v16 = objc_alloc_init(MEMORY[0x24BE0ACB8]);
...
void __62__HMDRemoteLoginReceiverCompanionAuthentication__authenticate__block_invoke(uint64_t a1, char a2, uint64_t a3, void *a4)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Save-remote-verified-account failed with error %@", (uint8_t *)&v16, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_75850 != -1)
    dispatch_once(&logCategory__hmf_once_t1_75850, &__block_literal_global_75851);
  return (id)logCategory__hmf_once_v2_75852;
}
...
void __60__HMDRemoteLoginReceiverCompanionAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_75852;
  logCategory__hmf_once_v2_75852 = v0;
