...
LABEL_14:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDMPCResolveDestinationOperation mediaApplicationDestination](v16, "mediaApplicationDestination"));
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543618;
      v24 = v18;
      v25 = 2112;
      v26 = v19;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unknown destination %@ for resolve destination operation, using system media destination", buf, 0x16u);
...
LABEL_13:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v25 = 2112;
    v26 = v11;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Using custom media application destination for bundle identifier %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v7);
  v12 = objc_alloc(MEMORY[0x24BE64D28]);
  -[HMDMPCResolveDestinationOperation mediaApplicationIdentifier](v8, "mediaApplicationIdentifier");
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v31 = 2112;
        v32 = v18;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to resolve hashed media profiles given %@ hashedRouteIDs, resolved to %@", buf, 0x20u);
      ...
      objc_msgSend(MEMORY[0x24BDD1540], "hmfErrorWithCode:reason:", 3, v8);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_138369 != -1)
    dispatch_once(&logCategory__hmf_once_t3_138369, &__block_literal_global_138370);
  return (id)logCategory__hmf_once_v4_138371;
}
...
void __48__HMDMPCResolveDestinationOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_138371;
  logCategory__hmf_once_v4_138371 = v0;
