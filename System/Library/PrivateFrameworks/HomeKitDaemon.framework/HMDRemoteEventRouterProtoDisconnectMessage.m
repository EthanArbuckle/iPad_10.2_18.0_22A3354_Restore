...
- (id)description
{
  ...
  -[HMDRemoteEventRouterProtoDisconnectMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteEventRouterProtoDisconnectMessage dictionaryRepresentation](self, "dictionaryRepresentation");
