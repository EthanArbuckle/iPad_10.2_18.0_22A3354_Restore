...
- (HMDAppleMediaAccessorySetupLogEvent)initWithRole:(int64_t)a3 setupStartTime:(unint64_t)a4 setupEndTime:(unint64_t)a5 accessoryAddEndTime:(unint64_t)a6 accessoryRemoveTime:(unint64_t)a7 configurationEndTime:(unint64_t)a8 setupSessionError:(id)a9 setupSessionIdentifier:(id)a10 isRepairSession:(BOOL)a11 category:(id)a12 accessorySoftwareVersion:(id)a13 setupClientBundleID:(id)a14 retryCount:(unint64_t)a15 firstSettingTime:(unint64_t)a16 languageSettingTime:(unint64_t)a17 accessoryInDefaultRoom:(BOOL)a18 lastPrimaryResidentAvailableTime:(unint64_t)a19 numberOfTimesPrimaryResidentChanged:(unsigned int)a20 lastPrimaryClientConnectedTime:(unint64_t)a21 numberOfTimesPrimaryClientConnected:(unsigned int)a22 numberOfTimesPrimaryClientDisconnected:(unsigned int)a23 numberOfTimesPrimaryClientConnectMessageFailed:(unsigned int)a24 lastPrimaryClientConnectMessageFailError:(id)a25 accessoryDiagnosticInfoFetchError:(id)a26 primaryResidentDiagnosticInfoFetchError:(id)a27
{
  ...
  if (v35)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", a15);
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent configurationEndTime](self, "configurationEndTime")- -[HMDAppleMediaAccessorySetupLogEvent setupStartTime](self, "setupStartTime"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent setupEndTime](self, "setupEndTime")- -[HMDAppleMediaAccessorySetupLogEvent setupStartTime](self, "setupStartTime"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent accessoryAddEndTime](self, "accessoryAddEndTime")- -[HMDAppleMediaAccessorySetupLogEvent setupStartTime](self, "setupStartTime"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent firstSettingTime](self, "firstSettingTime")- -[HMDAppleMediaAccessorySetupLogEvent setupStartTime](self, "setupStartTime"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent languageSettingTime](self, "languageSettingTime")- -[HMDAppleMediaAccessorySetupLogEvent setupStartTime](self, "setupStartTime"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent accessoryRemoveTime](self, "accessoryRemoveTime")- -[HMDAppleMediaAccessorySetupLogEvent setupStartTime](self, "setupStartTime"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent lastPrimaryResidentAvailableTime](self, "lastPrimaryResidentAvailableTime")- -[HMDAppleMediaAccessorySetupLogEvent accessoryAddEndTime](self, "accessoryAddEndTime"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("hmd_latencyLastPrimaryResidentAvailableTime"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[HMDAppleMediaAccessorySetupLogEvent numberOfTimesPrimaryResidentChanged](self, "numberOfTimesPrimaryResidentChanged"));
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDAppleMediaAccessorySetupLogEvent lastPrimaryClientConnectedTime](self, "lastPrimaryClientConnectedTime")- -[HMDAppleMediaAccessorySetupLogEvent accessoryAddEndTime](self, "accessoryAddEndTime"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("hmd_latencyLastPrimaryClientConnectedTime"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[HMDAppleMediaAccessorySetupLogEvent numberOfTimesPrimaryClientConnected](self, "numberOfTimesPrimaryClientConnected"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v13, CFSTR("hmd_numberOfTimesPrimaryClientConnected"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[HMDAppleMediaAccessorySetupLogEvent numberOfTimesPrimaryClientDisconnected](self, "numberOfTimesPrimaryClientDisconnected"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("hmd_numberOfTimesPrimaryClientDisconnected"));

  }
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[HMDAppleMediaAccessorySetupLogEvent numberOfTimesPrimaryClientConnectMessageFailed](self, "numberOfTimesPrimaryClientConnectMessageFailed"));
  ...
  if (v27)
  {
    ...
    if (v35)
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v35, "code"));
  ...
  if (v38)
  {
    ...
    if (v46)
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v46, "code"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAppleMediaAccessorySetupLogEvent isRepairSession](self, "isRepairSession"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAppleMediaAccessorySetupLogEvent accessoryInDefaultRoom](self, "accessoryInDefaultRoom"));
