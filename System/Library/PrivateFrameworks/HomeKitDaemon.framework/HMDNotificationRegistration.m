...
LABEL_6:
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, v16, (uint8_t *)&v21, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_231673 != -1)
    dispatch_once(&logCategory__hmf_once_t0_231673, &__block_literal_global_231674);
  return (id)logCategory__hmf_once_v1_231675;
}
...
void __42__HMDNotificationRegistration_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_231675;
  logCategory__hmf_once_v1_231675 = v0;
