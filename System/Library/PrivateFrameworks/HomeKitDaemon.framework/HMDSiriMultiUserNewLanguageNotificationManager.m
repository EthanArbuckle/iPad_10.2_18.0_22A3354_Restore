...
- (void)checkAllMediaAccessoriesAndPostNotificationIfNecessary
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Checking all media accessories for RMV new language notification", buf, 0xCu);
  ...
  if (objc_msgSend(v10, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v17 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@No media accessories in home", buf, 0xCu);
...
LABEL_8:
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, v13, buf, 0xCu);
    ...
    if (v17 && v19)
    {
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v62 = 2112;
        v63 = v17;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Current device siri language: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v62 = 2112;
        v63 = v19;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Media accessory siri language: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v62 = 2112;
        v63 = v36;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Media accessory software version: %@", buf, 0x16u);
      ...
      if ((v37 & 1) != 0)
      {
        if (v38)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v62 = 2112;
          v63 = v22;
          _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Siri languages requiring notification: %@", buf, 0x16u);
        ...
        if ((objc_msgSend(v22, "containsObject:", v19) & 1) != 0)
        {
          ...
          objc_msgSend(v41, "na_filter:", &__block_literal_global_115);
          ...
          if ((v43 & 1) != 0)
          {
            if (v47)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v62 = 2112;
              v63 = v19;
              _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_INFO, "%{public}@Posting notification for language: %@", buf, 0x16u);
          ...
          else
          {
            if (v47)
            {
              ...
              *(_DWORD *)buf = 138543362;
              v61 = v57;
              _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_INFO, "%{public}@Not posting RMV new language notification because at least one homepod is on a lower software version", buf, 0xCu);
...
LABEL_32:
    ...
    else if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v56 = 32;
LABEL_33:
      _os_log_impl(&dword_2218F0000, v54, v55, v53, buf, v56);
...
uint64_t __92__HMDSiriMultiUserNewLanguageNotificationManager_mediaAccessory_didUpdateSoftwareToVersion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Media accessory: %@, did update to software version: %@", (uint8_t *)&v9, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t35 != -1)
    dispatch_once(&logCategory__hmf_once_t35, &__block_literal_global_116_14766);
