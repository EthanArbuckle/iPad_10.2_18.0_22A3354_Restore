...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_88099 != -1)
    dispatch_once(&logCategory__hmf_once_t1_88099, &__block_literal_global_88100);
  return (id)logCategory__hmf_once_v2_88101;
}
...
void __56__HMDRemoteLoginReceiverProxyAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_88101;
  logCategory__hmf_once_v2_88101 = v0;
