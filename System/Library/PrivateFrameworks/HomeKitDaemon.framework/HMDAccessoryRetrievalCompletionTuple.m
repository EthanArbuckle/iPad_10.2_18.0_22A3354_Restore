...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2112;
      v29 = v20;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Accessory retrieval timed out for accessory %@/%@", (uint8_t *)&v24, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 138543362;
      v25 = v19;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Accessory retrieval lost reference to home", (uint8_t *)&v24, 0xCu);
