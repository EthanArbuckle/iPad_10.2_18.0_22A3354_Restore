...
+ (id)descriptorFromControllerStatus:(id)a3 controllerDescriptor:(id)a4 errorCode:(id)a5
{
  ...
  v13 = objc_alloc(MEMORY[0x24BDD79E0]);
  ...
  if (v16)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", objc_msgSend(v8, "downloadSize"));
  ...
  if (v26)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v8, "rampEnabled"));
...
+ (id)progressFromControllerProgress:(id)a3
{
  ...
  v3 = (objc_class *)MEMORY[0x24BDD7A00];
  v4 = a3;
  v5 = [v3 alloc];
