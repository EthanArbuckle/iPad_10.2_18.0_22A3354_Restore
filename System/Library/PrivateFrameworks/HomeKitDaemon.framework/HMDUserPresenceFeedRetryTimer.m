...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDUserPresenceFeedRetryTimer retryCount](self, "retryCount"));
...
- (void)startWithDelegate:(id)a3 delegateQueue:(id)a4 responseTime:(double)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v33 = 2112;
    v34 = v16;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting the timer after response time %@ and retry time interval %@", (uint8_t *)&v29, 0x20u);
  ...
  if (-[HMDUserPresenceFeedRetryTimer shouldRetryImmediately:](v11, "shouldRetryImmediately:", a5))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = v23;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Response time %@ is more than retry timer %@", (uint8_t *)&v29, 0x20u);
  ...
  {
    -[HMDUserPresenceFeedRetryTimer retryTimeInterval](v11, "retryTimeInterval");
    v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 1, v25 - a5);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_9340 != -1)
    dispatch_once(&logCategory__hmf_once_t2_9340, &__block_literal_global_9341);
  return (id)logCategory__hmf_once_v3_9342;
}
...
void __44__HMDUserPresenceFeedRetryTimer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_9342;
  logCategory__hmf_once_v3_9342 = v0;
