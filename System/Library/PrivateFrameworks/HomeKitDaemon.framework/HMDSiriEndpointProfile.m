...
- (HMDSiriEndpointProfile)initWithSiriEndpointServices:(id)a3 notificationCenter:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v15)
    {
      ...
      v15->_siriEndpointVersion = (NSString *)&stru_24E79DB48;
      ...
      v15->_siriEngineVersion = (NSString *)&stru_24E79DB48;

      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.HMDSiriEndpointProfile.Endpoint.%@"), CFSTR("com.apple.HomeKitDaemon.Local"), v10);
      v21 = objc_claimAutoreleasedReturnValue();
      clientEndpointIdentifier = v15->_clientEndpointIdentifier;
      v15->_clientEndpointIdentifier = (NSString *)v21;

      v45 = v10;
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.HMDSiriEndpointProfile.Settings.%@"), CFSTR("com.apple.HomeKitDaemon.Local"), v10);
      ...
      v37 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F278]), "initWithValue:", &unk_24E96B7E0);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v57 = 2112;
      v58 = v6;
      _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@Cannot create Siri Endpoint profile, cannot determine accessory from services %@", buf, 0x16u);
...
- (void)registerForMessages
{
  ...
  objc_msgSend(v3, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD6D78], self, v8, sel__handleRefreshProfileState_);
  objc_msgSend(v3, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD6D50], self, v8, sel_handleEnableNotifications_);
...
- (id)_siriEndpointVersionCharacteristic
{
  ...
  -[HMDSiriEndpointProfile _siriEndpointService](self, "_siriEndpointService");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x24BDD5A88]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_siriEndpointActiveIdentifierCharacteristic
{
  ...
  -[HMDSiriEndpointProfile _siriEndpointService](self, "_siriEndpointService");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x24BDD5778]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)stageNeedsOnboarding:(int64_t)a3 withTimeout:(double)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2048;
    v16 = a3;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Staging needsOnboarding: %ld", (uint8_t *)&v13, 0x16u);
...
- (void)_handleCharacteristicChanges:(id)a3
{
  ...
  if (v90)
  {
    context = 0;
    v89 = *(_QWORD *)v127;
    v101 = *MEMORY[0x24BDD5A88];
    v92 = *MEMORY[0x24BDD5778];
    v102 = v7;
    v107 = v8;
    while (1)
    {
                      ...
                      if (v33)
                      {
                        ...
                        if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          v135 = 2112;
                          v136 = v35;
                          _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Parsed HMDSiriEndpointSessionStateTLV: %@ with error: %@", buf, 0x20u);
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          v28 = 2112;
          v29 = v17;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling %@/%@", (uint8_t *)&v24, 0x20u);
...
- (void)handleEnableNotifications:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD6D48]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD6D58]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] parameters not specific", (uint8_t *)&v13, 0xCu);
...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  if (v8 == v6)
  {
    -[HMDSiriEndpointProfile stagedNeedsOnboarding](self, "stagedNeedsOnboarding");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "commitValue:", &unk_24E96B7E0);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unknown stage value: %@ did expire value: %@", (uint8_t *)&v14, 0x20u);
...
- (void)_handleRefreshProfileState:(id)a3 completionHandler:(id)a4
{
  ...
  if (v8)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v90, "arrayForKey:", *MEMORY[0x24BDD6D70]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = v10;
    if (v10)
    {
    ...
    {
      v18 = *MEMORY[0x24BDD6DA0];
      v114[0] = *MEMORY[0x24BDD6D80];
      v114[1] = v18;
    ...
    if (v89)
    {
      v86 = *MEMORY[0x24BDD6D80];
      v87 = *(_QWORD *)v108;
      v82 = *MEMORY[0x24BDD6DA0];
      do
      {
        v20 = 0;
        do
          ...
          if (objc_msgSend(v22, "isEqual:", v86))
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v28;
                _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint session status is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v33;
                _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint version is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v38;
                _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint active identifier is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v43;
                _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint manually disable is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v47;
                _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint multifunction button is not available", buf, 0xCu);
          ...
          else
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v61;
                _os_log_impl(&dword_2218F0000, v60, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri enable is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v66;
                _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri listening is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v71;
                _os_log_impl(&dword_2218F0000, v70, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri touch is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v75, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v76;
                _os_log_impl(&dword_2218F0000, v75, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri light on use is not available", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v79, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v80;
                _os_log_impl(&dword_2218F0000, v79, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri engine is not available", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v117 = 2112;
      v118 = v14;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile] accessory not part of profile (%@)", buf, 0x16u);
...
- (void)_updateSessionState:(id)a3 settings:(id)a4 message:(id)a5
{
  ...
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", 6);
  v110 = v11;
  if (v8)
  {
    ...
    if (v14 != -[HMDSiriEndpointProfile sessionState](self, "sessionState"))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v113 = 2112;
        v114 = v19;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating session state: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v15);
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile sessionState](v16, "sessionState"));
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile sessionState](self, "sessionState"));
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "setValue:forKey:", v21, *MEMORY[0x24BDD6D90]);
    ...
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "setValue:forKey:", v28, *MEMORY[0x24BDD6D88]);

  }
  v29 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", 5);
  if (v9)
  {
    ...
    if (v30)
    {
      ...
      if (-[HMDSiriEndpointProfile siriEnable](self, "siriEnable") != v34)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile siriEnable](self, "siriEnable"));
    ...
    if (v36)
    {
      ...
      if (-[HMDSiriEndpointProfile siriListening](self, "siriListening") != v40)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile siriListening](self, "siriListening"));
    ...
    if (v42)
    {
      ...
      if (-[HMDSiriEndpointProfile siriTouchToUse](self, "siriTouchToUse") != v46)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile siriTouchToUse](self, "siriTouchToUse"));
        v47 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v48)
    {
      ...
      if (-[HMDSiriEndpointProfile siriLightOnUse](self, "siriLightOnUse") != v52)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile siriLightOnUse](self, "siriLightOnUse"));
    ...
    if (v54)
    {
      ...
      v56 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "setValue:forKey:", v56, *MEMORY[0x24BDD6DB8]);
    ...
    if (v57)
    {
      ...
      objc_msgSend(v10, "setValue:forKey:", v63, *MEMORY[0x24BDD6DA8]);
    ...
    if (v64)
    {
      ...
      -[HMDSiriEndpointProfile activeIdentifier](self, "activeIdentifier");
      v72 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "setValue:forKey:", v72, *MEMORY[0x24BDD6D18]);
    ...
    if (v73)
    {
      ...
      if (v75 != v76)
      {
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDSiriEndpointProfile manuallyDisabled](self, "manuallyDisabled"));
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDSiriEndpointProfile manuallyDisabled](self, "manuallyDisabled"));
      v79 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "setValue:forKey:", v79, *MEMORY[0x24BDD6D60]);
    ...
    if (v80)
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile multifunctionButton](self, "multifunctionButton"));
      ...
      objc_msgSend(v10, "setValue:forKey:", v86, *MEMORY[0x24BDD6D68]);
    ...
    if (objc_msgSend(v9, "assistantsUpdated"))
    {
      ...
      objc_msgSend(v10, "setValue:forKey:", v88, *MEMORY[0x24BDD6D38]);
  ...
  if (v89)
  {
    ...
    if (v93)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v113 = 2112;
      v114 = v10;
      _os_log_impl(&dword_2218F0000, v92, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated profile state: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v90);
    v96 = objc_alloc(MEMORY[0x24BE3F1B8]);
    -[HMDAccessoryProfile uniqueIdentifier](v91, "uniqueIdentifier");
    v97 = (void *)objc_claimAutoreleasedReturnValue();
    v98 = (void *)objc_msgSend(v96, "initWithTarget:", v97);

    v99 = (void *)MEMORY[0x24BE3F1D0];
    v100 = *MEMORY[0x24BDD6DB0];
  ...
  else
  {
    if (v93)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v112 = v106;
      _os_log_impl(&dword_2218F0000, v92, OS_LOG_TYPE_INFO, "%{public}@No changes, not notifying XPC clients", buf, 0xCu);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile sessionState](self, "sessionState", v15.receiver, v15.super_class));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x24BDD6D90]);

  -[HMDSiriEndpointProfile sessionHubIdentifier](self, "sessionHubIdentifier");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "UUIDString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x24BDD6D88]);

  -[HMDSiriEndpointProfile siriEndpointVersion](self, "siriEndpointVersion");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v8, *MEMORY[0x24BDD6DB8]);

  v9 = -[HMDSiriEndpointProfile _capability](self, "_capability");
  objc_msgSend(v4, "encodeInteger:forKey:", v9, *MEMORY[0x24BDD6D40]);
  -[HMDSiriEndpointProfile siriEngineVersion](self, "siriEngineVersion");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v10, *MEMORY[0x24BDD6DA8]);

  -[HMDSiriEndpointProfile activeIdentifier](self, "activeIdentifier");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v11, *MEMORY[0x24BDD6D18]);

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDSiriEndpointProfile manuallyDisabled](self, "manuallyDisabled"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v12, *MEMORY[0x24BDD6D60]);

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDSiriEndpointProfile multifunctionButton](self, "multifunctionButton"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v13, *MEMORY[0x24BDD6D68]);

  -[HMDSiriEndpointProfile assistants](self, "assistants");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v14, *MEMORY[0x24BDD6D38]);
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Enable] failed to create siri enable write request", (uint8_t *)location, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Enable] accessory not part of profile", (uint8_t *)location, 0xCu);
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          LODWORD(location[0]) = 138543362;
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Listening] failed to create siri enable write request", (uint8_t *)location, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(location[0]) = 138543362;
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Listening] accessory not part of profile", (uint8_t *)location, 0xCu);
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          LODWORD(location[0]) = 138543362;
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Touch To Use] failed to create siri enable write request", (uint8_t *)location, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(location[0]) = 138543362;
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Touch To Use] accessory not part of profile", (uint8_t *)location, 0xCu);
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          LODWORD(location[0]) = 138543362;
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Light On Use] failed to create siri enable write request", (uint8_t *)location, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(location[0]) = 138543362;
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Light On Use] accessory not part of profile", (uint8_t *)location, 0xCu);
...
LABEL_5:
    ...
    if (v8 && objc_msgSend(v7, "count"))
    {
      ...
      if (v12)
      {
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          v35 = 2112;
          v36 = v7;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@[Profile Notifications] %@ notifications for characteristics for %@: %@", (uint8_t *)&v29, 0x2Au);
      ...
      else
      {
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          v29 = 138543362;
          v30 = v28;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] accessory not part of profile", (uint8_t *)&v29, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = v9;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] nothing to %@ because characteristic.count (%ld) or client indentifier %@", (uint8_t *)&v29, 0x2Au);
  ...
  v24 = (void *)MEMORY[0x227676638](self, a2);
  v25 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    v31 = 2048;
    v32 = a4;
    _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] options is not valid: %ld", (uint8_t *)&v29, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2048;
    v11 = v7;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_ERROR, "%{public}@[Notifications] options is not valid: %ld", (uint8_t *)&v8, 0x16u);
        ...
        do
        {
          ...
          if (v11)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v48 = 2112;
              v49 = v20;
              _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Write request %@ failed with error %@", buf, 0x20u);
          ...
          else
          {
            ...
            if (v24)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(WeakRetained, "siriLightOnUse"));
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              v43 = v25;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v31;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
        ...
        do
        {
          ...
          else
          {
            ...
            if (v24)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(WeakRetained, "siriTouchToUse"));
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              v43 = v25;
              objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v43, &v42, 1);
              v26 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        do
        {
          ...
          else
          {
            ...
            if (v24)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(WeakRetained, "siriListening"));
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              v43 = v25;
              objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v43, &v42, 1);
              v26 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        do
        {
          ...
          else
          {
            ...
            if (v24)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(WeakRetained, "siriEnable"));
              v25 = (void *)objc_claimAutoreleasedReturnValue();
              v43 = v25;
              objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v43, &v42, 1);
              v26 = (void *)objc_claimAutoreleasedReturnValue();
...
void __71__HMDSiriEndpointProfile__handleRefreshProfileState_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_msgSend(v3, "count"))
  {
    ...
    v90 = 0;
    v91 = *(_QWORD *)v98;
    v86 = *MEMORY[0x24BDD5A88];
    v85 = *MEMORY[0x24BDD5778];
    while (1)
    {
      v9 = 0;
      v87 = v7;
          ...
          if (v21)
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v106 = 2112;
              v107 = v25;
              _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Response Parsed HMDSiriEndpointSessionStateTLV: %@ with error: %@", buf, 0x20u);
...
LABEL_15:
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v104 = 2112;
          v105 = (uint64_t)v17;
          _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Read failed with error %@", buf, 0x16u);
...
LABEL_81:
  ...
  if (os_log_type_enabled(v74, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v104 = 2112;
    v105 = v76;
    _os_log_impl(&dword_2218F0000, v74, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
...
void __69__HMDSiriEndpointProfile_notifyClientsDidUpdateStagedNeedsOnboarding__block_invoke(uint64_t a1)
{
  ...
  v18 = *MEMORY[0x24BDD6D40];
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(*(id *)(a1 + 32), "_capability"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v19[0] = v2;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated needsOnboarding: %@", (uint8_t *)&v14, 0x16u);

  }
  objc_autoreleasePoolPop(v4);
  v8 = objc_alloc(MEMORY[0x24BE3F1B8]);
  objc_msgSend(*(id *)(a1 + 32), "uniqueIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v8, "initWithTarget:", v9);

  objc_msgSend(MEMORY[0x24BE3F1D0], "messageWithName:destination:payload:", *MEMORY[0x24BDD6DB0], v10, v3);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
void __58__HMDSiriEndpointProfile_handleDeviceCapabilitiesUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = 2112;
    v32 = v14;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling updated resident capabilities: %@ notification: %@", (uint8_t *)&v27, 0x20u);
  ...
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v18, "na_firstObjectPassingTest:", &__block_literal_global_139_131808);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v21 == v4 && (objc_msgSend(v9, "containsObject:", CFSTR("supportsSiriEndpointSetup")) & 1) != 0)
    {
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          v29 = 2112;
          v30 = v20;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Current device was updated to support Siri Endpoint Settings (%@)", (uint8_t *)&v27, 0x16u);
          ...
          if (v12)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v29 = 2112;
              v30 = v19;
              _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Current device is primary:%@ and does not support home hub", buf, 0x16u);
...
uint64_t __52__HMDSiriEndpointProfile_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@", (uint8_t *)&v11, 0x16u);
...
void __45__HMDSiriEndpointProfile_registerForMessages__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering for characteristic notifcations since current device supports home hub", (uint8_t *)&v9, 0xCu);
...
+ (void)initialize
{
  objc_msgSend(MEMORY[0x24BE3F248], "setDefaultValue:forPreferenceKey:", &unk_24E9714A8, CFSTR("siriProfileOnBoardingPendingTime"));
}

+ (id)namespace
{
  if (namespace_onceToken_131850 != -1)
    dispatch_once(&namespace_onceToken_131850, &__block_literal_global_131851);
  return (id)namespace_namespace_131852;
}
...
void __35__HMDSiriEndpointProfile_namespace__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("4CF0DBFA-FE71-485F-956B-20002E66B3AA"));
  v1 = (void *)namespace_namespace_131852;
  namespace_namespace_131852 = v0;
