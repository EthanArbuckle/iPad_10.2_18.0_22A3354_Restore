...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDHomePodSensorPairingLogEvent pairingSuccess](self, "pairingSuccess"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDHomePodSensorPairingLogEvent failureReason](self, "failureReason"));
