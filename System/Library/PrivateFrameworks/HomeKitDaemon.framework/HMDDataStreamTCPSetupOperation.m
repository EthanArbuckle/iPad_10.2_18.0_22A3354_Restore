...
- (void)startSetup
{
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Creating new DataStream using TCP", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v5);
    -[HMDDataStreamTCPSetupOperation controllerKeySalt](v6, "controllerKeySalt");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BA98]), "initWithValue:", 0);
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BAA8]), "initWithValue:", 0);
    v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BAB0]), "initWithCommand:transportType:controllerKeySalt:", v11, v12, v10);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v34 = 2112;
        v35 = v14;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; cannot serialize request (%@)",
          buf,
          0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v21;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; does not appear to be IP-connected",
        buf,
        0xCu);
...
LABEL_10:
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, v20, (uint8_t *)&v22, 0xCu);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v24 = 2112;
    v25 = v14;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] The setup transfer succeeded; will use port %@",
      (uint8_t *)&v22,
      0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; device appears to have lost IP-connectivity",
        (uint8_t *)location,
        0xCu);
...
- (id)_createTCPTransport
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] Accessory is a Siri endpoint, creating transport with elevated scheduling mode", (uint8_t *)&v19, 0xCu);
...
- (void)_finishStreamTransport
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v15 = 138543362;
      v16 = v8;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] DataStream configuration valid; starting stream",
        (uint8_t *)&v15,
        0xCu);
  ...
  else
  {
    if (v7)
    {
      ...
      v21 = 1024;
      v22 = v14 != 0;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] Setup still in progress (hasPort=%d, hasHostname=%d, hasEnc=%d)", (uint8_t *)&v15, 0x1Eu);
  ...
  if (WeakRetained)
  {
    ...
    if (!v5 || v6)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 2112;
        v17 = v6;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to create secure session for the accessory (%@)", (uint8_t *)&v14, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        v16 = 2112;
        v17 = v5;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] Key creation succeeded; will use session encryption %@",
          (uint8_t *)&v14,
          0x16u);
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        v13 = 138543362;
        v14 = v10;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; invalid IP address",
          (uint8_t *)&v13,
          0xCu);
      ...
      v12 = (void *)objc_msgSend(v11, "initWithDomain:code:userInfo:", *MEMORY[0x24BDD5BD8], 54, 0);
