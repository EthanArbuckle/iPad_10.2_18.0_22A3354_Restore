...
- (HMDCameraRecordingLoadBalancingAttempt)initWithLocalResponseTimeout:(double)a3 logIdentifier:(id)a4
{
  ...
  v6 = (objc_class *)MEMORY[0x24BE3F298];
  v7 = a4;
  ...
  if (v5 == v4)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        v12 = 138543362;
        v13 = v10;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Timed out waiting for load balancing message response", (uint8_t *)&v12, 0xCu);

      }
      objc_autoreleasePoolPop(v7);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 8, CFSTR("Timed out waiting for load balancing message response"), 0, 0);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_250768 != -1)
    dispatch_once(&logCategory__hmf_once_t1_250768, &__block_literal_global_250769);
  return (id)logCategory__hmf_once_v2_250770;
}
...
void __53__HMDCameraRecordingLoadBalancingAttempt_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_250770;
  logCategory__hmf_once_v2_250770 = v0;
