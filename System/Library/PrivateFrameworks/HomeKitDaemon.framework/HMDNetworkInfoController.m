...
- (HMDNetworkInfoController)init
{
  ...
  v3 = (HMDNetworkInfoController *)sub_2219E7974(v2);
  swift_release();
  swift_getObjectType();
...
- (void)start
{
  ...
  v7 = self;
  v8 = v6(0xD000000000000015, 0x800000022268F810, sub_2219E7AB0, v10, v4, v5);
...
- (id)obtainNetworkInfoProto
{
  ...
  __swift_instantiateConcreteTypeFromMangledName(&qword_255741770);
