...
- (HMDDiagnosticReporterLogObserver)initWithLogEventDispatcher:(id)a3
{
  ...
  if (v5)
  {
    ...
    v15 = objc_msgSend(objc_alloc(MEMORY[0x24BEB3478]), "initWithQueue:", v6->_clientQueue);
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v9, 0xCu);
...
void __66__HMDDiagnosticReporterLogObserver_didReceiveEventFromDispatcher___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "shouldSubmitEvent:", *(_QWORD *)(a1 + 40)))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", objc_msgSend(v2, "identifier"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "setObject:forKeyedSubscript:", v9, *MEMORY[0x24BEB3570]);

    objc_msgSend(MEMORY[0x24BDD1488], "mainBundle");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "objectForInfoDictionaryKey:", *MEMORY[0x24BDBD2A0]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();

    if (v11)
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v11, CFSTR("projectver"));
    if (objc_msgSend(*(id *)(a1 + 40), "conformsToProtocol:", &unk_2557BB8A0))
    {
      v12 = *(id *)(a1 + 40);
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v19;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Submitting event: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v8;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Submitting signature: %@", buf, 0x16u);
    ...
    v35[1] = 3221225472;
    v35[2] = __66__HMDDiagnosticReporterLogObserver_didReceiveEventFromDispatcher___block_invoke_72;
    v35[3] = &unk_24E79BAC0;
    ...
    if ((v25 & 1) == 0)
    {
      v30 = (void *)MEMORY[0x227676638](v26, v27, v28, v29);
      v31 = *(id *)(a1 + 32);
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v40 = 2112;
        v41 = v34;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to submit event: %@", buf, 0x16u);
...
void __66__HMDDiagnosticReporterLogObserver_didReceiveEventFromDispatcher___block_invoke_72(uint64_t a1, void *a2)
{
  id v3;
  id WeakRetained;
  void *v5;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Submitted event with response: %@", (uint8_t *)&v9, 0x16u);
...
{
  if (supportedEventClasses_onceToken_252284 != -1)
    dispatch_once(&supportedEventClasses_onceToken_252284, &__block_literal_global_252285);
  return (id)supportedEventClasses_supportedEventClasses_252286;
}
...
+ (id)typeForEvent:(id)a3
{
  ...
  v3 = a3;
  if (!objc_msgSend(v3, "conformsToProtocol:", &unk_2557BB8A0)
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_252265 != -1)
    dispatch_once(&logCategory__hmf_once_t10_252265, &__block_literal_global_74_252266);
  return (id)logCategory__hmf_once_v11_252267;
}
...
void __47__HMDDiagnosticReporterLogObserver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_252267;
  logCategory__hmf_once_v11_252267 = v0;
...
void __57__HMDDiagnosticReporterLogObserver_supportedEventClasses__block_invoke()
{
  ...
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)supportedEventClasses_supportedEventClasses_252286;
  supportedEventClasses_supportedEventClasses_252286 = v0;
