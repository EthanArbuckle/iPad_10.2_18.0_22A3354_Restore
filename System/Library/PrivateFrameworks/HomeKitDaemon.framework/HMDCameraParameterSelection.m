...
LABEL_20:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v50 = 2112;
    v51 = v15;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Local preference is set for %@, replying the same as filtered: %@", buf, 0x20u);
...
+ (id)selectedSRTPParametersFromCryptoSuites:(id)a3
{
  ...
  if (v5)
  {
    ...
    v14 = (const __SecRandom *)*MEMORY[0x24BDE94B8];
          ...
          SecRandomCopyBytes(v14, v17, (void *)objc_msgSend(v18, "mutableBytes"))))
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 138543362;
        v30 = v22;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate random bytes", (uint8_t *)&v29, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 138543362;
      v30 = v27;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to select Crypto Suite", (uint8_t *)&v29, 0xCu);
...
+ (id)_selectedCryptoSuiteFromCameraCryptoSuites:(id)a3
{
  ...
  v4 = a3;
  +[HMDSRTPCryptoSuite arrayWithSuites:](HMDSRTPCryptoSuite, "arrayWithSuites:", &unk_24E971150);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (isInternalBuild() && v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 138543362;
      v21 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Making SRTP camera stream unencrypted", (uint8_t *)&v20, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_182917 != -1)
    dispatch_once(&logCategory__hmf_once_t6_182917, &__block_literal_global_182918);
  return (id)logCategory__hmf_once_v7_182919;
}
...
void __42__HMDCameraParameterSelection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_182919;
  logCategory__hmf_once_v7_182919 = v0;
