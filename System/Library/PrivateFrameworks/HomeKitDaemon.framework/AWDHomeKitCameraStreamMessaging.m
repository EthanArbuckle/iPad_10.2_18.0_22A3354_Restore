...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_receivedNegotiationRequest);
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_sentNegotiationRequest);
...
LABEL_13:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_sentNegotiationResponse);
...
LABEL_14:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_receivedStartRequest);
...
LABEL_15:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_sentStartRequest);
...
LABEL_7:
    if ((has & 8) == 0)
      goto LABEL_8;
LABEL_17:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_sentConnSetup);
...
LABEL_16:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_sentStartResponse);
...
LABEL_8:
  ...
  {
LABEL_9:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_receivedConnSetup);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
