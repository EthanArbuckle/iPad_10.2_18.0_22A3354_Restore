...
LABEL_5:
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Checking existing follow up setup items", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v39 = 2112;
        v40 = (int64_t)v31;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unable to get followup controller from datasource: %@", buf, 0x16u);
  ...
  if (a3 == 1)
  {
    objc_msgSend(v7, "setUniqueIdentifier:", *MEMORY[0x24BDD5B48]);
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2048;
    v40 = a3;
    _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Unexpected setup mode to start advertising: %ld", buf, 0x16u);
...
- (void)_stopAdvertising:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2048;
    v40 = a3;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Stopping advertising for followup mode: %ld", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v6);
  if (a3 == 1)
  {
    v15 = *MEMORY[0x24BDD5B50];
    v35[0] = *MEMORY[0x24BDD5B48];
    v35[1] = v15;
  ...
  if (a3 != 2)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2048;
      v40 = a3;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Unknown followup mode passed to stop advertising: %ld", buf, 0x16u);
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v34;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly called stop advertising for tvos update mode on non-atv device", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2112;
      v40 = (int64_t)v30;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Unable to get followup controller from data source: %@", buf, 0x16u);
...
+ (NSArray)allPossibleFollowUpItemIdentifiers
{
  ...
  v3[0] = *MEMORY[0x24BDD5B50];
  v3[1] = CFSTR("com.apple.HomeKit.UpdateTvOS");
  v3[2] = *MEMORY[0x24BDD5B48];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_68834 != -1)
    dispatch_once(&logCategory__hmf_once_t7_68834, &__block_literal_global_68835);
  return (id)logCategory__hmf_once_v8_68836;
}
...
void __37__HMDCoreFollowUpManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_68836;
  logCategory__hmf_once_v8_68836 = v0;
