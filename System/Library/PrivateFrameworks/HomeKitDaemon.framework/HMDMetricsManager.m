...
- (HMDMetricsManager)initWithMessageDispatcher:(id)a3 accountManager:(id)a4 notificationSettingsProvider:(id)a5
{
  ...
  v8 = objc_alloc_init(MEMORY[0x24BE4F1A0]);
  ...
  objc_msgSend(MEMORY[0x24BE4F188], "sharedInstance");
  ...
  if ((_os_feature_enabled_impl() & 1) != 0)
  {
    ...
    v12 = objc_alloc(MEMORY[0x24BE4F180]);
    v13 = (HMMCountersManager *)objc_msgSend(v12, "initWithDataModelName:atPath:", *MEMORY[0x24BE4F110], v11);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = v17;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new counters manager. Falling back to legacy manager. Error: %@", buf, 0x16u);
  ...
  v42 = v18;
  v25 = objc_alloc(MEMORY[0x24BE4F178]);
  ...
  v30 = objc_alloc(MEMORY[0x24BE3F298]);
  ...
  objc_msgSend(MEMORY[0x24BE4F1A8], "sharedManager");
...
- (HMDMetricsManager)initWithMessageDispatcher:(id)a3 accountManager:(id)a4 notificationSettingsProvider:(id)a5 logEventDispatcher:(id)a6 dailyScheduler:(id)a7 dateProvider:(id)a8 legacyCountersManager:(id)a9 flagsManager:(id)a10 ewsLogger:(id)a11 deviceStateManager:(id)a12 networkObserver:(id)a13 coreAnalyticsTagObserver:(id)a14 backgroundLoggingTimer:(id)a15 radarInitiator:(id)a16 notificationCenter:(id)a17 userDefaults:(id)a18 currentSoftwareVersion:(id)a19
{
  ...
  if (v28)
  {
    ...
    objc_msgSend(v24, "addCommonField:withValue:", CFSTR("isHH2Enabled"), &unk_24E96B408, a3);
...
- (void)_configureObservers
{
  ...
  v8 = (HMMCoreAnalyticsLogEventObserver *)objc_msgSend(objc_alloc(MEMORY[0x24BE4F170]), "initWithDelegate:filters:", self->_coreAnalyticsDelegate, self->_coreAnalyticsFilters);
  ...
  v14 = objc_alloc(MEMORY[0x24BE4F1B0]);
  ...
  v40 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 8, 300.0);
  ...
  v57 = -[HMDCoreDataLogEventsAnalyzer initWithEventCountersManager:logEventSubmitter:dailyScheduler:]([HMDCoreDataLogEventsAnalyzer alloc], "initWithEventCountersManager:logEventSubmitter:dailyScheduler:", self->_legacyCountersManager, self->_logEventDispatcher, self->_dailyScheduler);
  coreDataLogEventsAnalyzer = self->_coreDataLogEventsAnalyzer;
  self->_coreDataLogEventsAnalyzer = v57;

  -[HMDMetricsManager addAnalyzer:toListOfAggregationAnalysisEventContributing:](self, "addAnalyzer:toListOfAggregationAnalysisEventContributing:", self->_coreDataLogEventsAnalyzer, self->_aggregationAnalysisEventContributingAnalyzers);
  v59 = -[HMDWidgetTimelineRefresherEventsAnalyzer initWithEventCountersManager:logEventSubmitter:dailyScheduler:]([HMDWidgetTimelineRefresherEventsAnalyzer alloc], "initWithEventCountersManager:logEventSubmitter:dailyScheduler:", self->_legacyCountersManager, self->_logEventDispatcher, self->_dailyScheduler);
  ...
  v61 = -[HMDUserActivityStateDetectorLogEventAnalyzer initWithDataSource:]([HMDUserActivityStateDetectorLogEventAnalyzer alloc], "initWithDataSource:", self);
  userActivityStateDetectorLogEventAnalyzer = self->_userActivityStateDetectorLogEventAnalyzer;
  self->_userActivityStateDetectorLogEventAnalyzer = v61;
...
- (void)addAnalyzer:(id)a3 toListOfAggregationAnalysisEventContributing:(id)a4
{
  ...
  v6 = a3;
  v5 = a4;
  if (objc_msgSend(v6, "conformsToProtocol:", &unk_2557B92C8))
...
- (void)_configureManagers
{
  ...
  HMDMetricsHomeDataChangedManager *v5;
  void *v6;
  HMDMetricsHomeDataChangedManager *v7;
  HMDMetricsHomeDataChangedManager *metricsHomeDataChangedManager;
  HMDHouseholdMetricsManager *v9;
  void *v10;
  void *v11;
  void *v12;
  void *v13;
  ...
  HMMDateProvider *dateProvider;
  void *v16;
  HMDHouseholdMetricsManager *v17;
  ...
  v7 = -[HMDMetricsHomeDataChangedManager initWithCountersManager:currentHomeDataSource:dateProvider:](v5, "initWithCountersManager:currentHomeDataSource:dateProvider:", v6, self, self->_dateProvider);
  metricsHomeDataChangedManager = self->_metricsHomeDataChangedManager;
  self->_metricsHomeDataChangedManager = v7;

  if (isInternalBuild())
    -[HMDMetricsHomeDataChangedManager start](self->_metricsHomeDataChangedManager, "start");
  v9 = [HMDHouseholdMetricsManager alloc];
  -[HMDMetricsManager legacyCountersManager](self, "legacyCountersManager");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDMetricsManager accessoryDetailsManager](self, "accessoryDetailsManager");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDMetricsManager metricsHomeDataChangedManager](self, "metricsHomeDataChangedManager");
  ...
  v17 = -[HMDHouseholdMetricsManager initWithCountersManager:dataSource:accessoryDetailsManager:metricsHomeDataChangedManager:dailyScheduler:logEventSubmitter:dateProvider:activityContributors:](v9, "initWithCountersManager:dataSource:accessoryDetailsManager:metricsHomeDataChangedManager:dailyScheduler:logEventSubmitter:dateProvider:activityContributors:", v10, self, v11, v12, v13, v14, dateProvider, v16);
  ...
  if (v4 == 3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v58 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering for homeutil messages", buf, 0xCu);
...
- (void)startMetricsCollection
{
  ...
  if (-[HMDMetricsManager metricsCollectionStarted](self, "metricsCollectionStarted"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v7;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Metrics collection already started", (uint8_t *)&v19, 0xCu);
  ...
  else
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "addObserver:forProtocol:", v9, &unk_2557699C8);
...
- (void)runDailyTask
{
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2112;
        v47 = v6;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@[CA] Serial Number: %@", buf, 0x16u);
  ...
  -[HMDMetricsManager submitResidentSelectionDenominatorEvents](self, "submitResidentSelectionDenominatorEvents");
...
- (void)submitResidentSelectionDenominatorEvents
{
  ...
  -[HMDMetricsManager logEventDispatcher](self, "logEventDispatcher");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  +[HMDStatusChannelManagementLogEvent denominatorEvent](HMDStatusChannelManagementLogEvent, "denominatorEvent");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "submitLogEvent:", v4);

  -[HMDMetricsManager logEventDispatcher](self, "logEventDispatcher");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  +[HMDStatusChannelObserveLogEvent denominatorEvent](HMDStatusChannelObserveLogEvent, "denominatorEvent");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        if (objc_msgSend(v13, "isCurrentDeviceAvailableResident"))
        {
          -[HMDMetricsManager logEventDispatcher](self, "logEventDispatcher");
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v13, "uuid");
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v13, "residentDeviceManager");
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          +[HMDResidentSelectionPrimaryResidentChangedLogEvent denominatorEvent:residentSelectionMode:](HMDResidentSelectionPrimaryResidentChangedLogEvent, "denominatorEvent:residentSelectionMode:", v15, objc_msgSend(v16, "residentSelectionMode"));
          v17 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v14, "submitLogEvent:", v17);

          -[HMDMetricsManager logEventDispatcher](self, "logEventDispatcher");
          v18 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v13, "uuid");
          v19 = (void *)objc_claimAutoreleasedReturnValue();
          +[HMDResidentStatusChannelPublishLogEvent denominatorEvent:](HMDResidentStatusChannelPublishLogEvent, "denominatorEvent:", v19);
          v20 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v18, "submitLogEvent:", v20);

          -[HMDMetricsManager logEventDispatcher](self, "logEventDispatcher");
          v21 = (void *)objc_claimAutoreleasedReturnValue();
          +[HMDStatusChannelPublishLogEvent denominatorEvent](HMDStatusChannelPublishLogEvent, "denominatorEvent");
          v22 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v21, "submitLogEvent:", v22);
        ...
        objc_msgSend(v13, "uuid");
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        +[HMDResidentStatusChannelObserveLogEvent denominatorEvent:](HMDResidentStatusChannelObserveLogEvent, "denominatorEvent:", v24);
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v23, "submitLogEvent:", v25);
...
- (void)logEventAggregationAnalysisLogEvents
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2114;
    v20 = v10;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated event counts since last metric submission (reset every 24 hrs): %{public}@", (uint8_t *)&v17, 0x16u);
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2114;
    v20 = v16;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated error counts since last metric submission (reset every 24 hrs): %{public}@", (uint8_t *)&v17, 0x16u);
...
- (void)registerTaggedLoggingProcessors
{
  ...
  v3 = (void *)MEMORY[0x24BE4F1C8];
  v6[0] = *MEMORY[0x24BE4EEF8];
...
- (void)startAnalyzers
{
  ...
  -[HMDMetricsManager logEventDispatcher](self, "logEventDispatcher");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDMetricsManager coreDataLogEventsAnalyzer](self, "coreDataLogEventsAnalyzer");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v26 = objc_opt_class();
  v27 = objc_opt_class();
  v28 = objc_opt_class();
  ...
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v18, "addObserver:forEventClasses:", v19, v20, v26, v27);
  ...
  if (isInternalBuild())
  {
    ...
    if (v21)
    {
      ...
      -[HMDMetricsManager eventCountingAnalyzer](self, "eventCountingAnalyzer");
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v22, "addObserver:forProtocol:", v23, &unk_255769580);
  ...
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v24, "addObserver:forEventClass:", v25, objc_opt_class());
...
- (void)registerEWSTriggers
{
  ...
  -[HMDMetricsManager addThresholdTrigger:forEventName:requestGroup:atThreshold:](self, "addThresholdTrigger:forEventName:requestGroup:atThreshold:", CFSTR("coreDataCloudStoreCommitCount"), CFSTR("CloudStoreCommitCount"), CFSTR("CoreDataAggregationEventGroup"), 10);
  -[HMDMetricsManager addThresholdTrigger:forEventName:requestGroup:atThreshold:](self, "addThresholdTrigger:forEventName:requestGroup:atThreshold:", CFSTR("cloudKitImportCount"), CFSTR("CloudKitImportCount"), CFSTR("CoreDataAggregationEventGroup"), 10);
  -[HMDMetricsManager addThresholdTrigger:forEventName:requestGroup:atThreshold:](self, "addThresholdTrigger:forEventName:requestGroup:atThreshold:", CFSTR("cloudKitExportCount"), CFSTR("CloudKitExportCount"), CFSTR("CoreDataAggregationEventGroup"), 50);
}
...
- (void)registerPrimaryChangedCounterTriggerTTRforHome:(id)a3
{
  void *v4;
  id v5;
  void *v6;
  ...
  v5 = a3;
  objc_msgSend(v4, "numberWithInteger:", 938669);
  v8 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "stringValue");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(v7) = 1;
  -[HMDMetricsManager addTTRThresholdTrigger:radarTitle:componentName:componentVersion:componentID:forEventName:requestGroup:atThreshold:primaryOnly:forHome:](self, "addTTRThresholdTrigger:radarTitle:componentName:componentVersion:componentID:forEventName:requestGroup:atThreshold:primaryOnly:forHome:", CFSTR("Excessive primary resident changes detected. Please include resident logs"), CFSTR("HomeKit Issue Detected: Excessive primary resident changes"), CFSTR("HomeKit"), CFSTR("Resident"), v6, CFSTR("v3ResidentSelectionPrimaryResidentChangedCount"), CFSTR("HMDLogEventElectionEventsAnalyzerRequestGroup"), 5, v7, v5);

}

- (void)addTTRThresholdTrigger:(id)a3 radarTitle:(id)a4 componentName:(id)a5 componentVersion:(id)a6 componentID:(id)a7 forEventName:(id)a8 requestGroup:(id)a9 atThreshold:(unint64_t)a10 primaryOnly:(BOOL)a11 forHome:(id)a12
{
  id v19;
  id v20;
  id v21;
  ...
  id v24;
  id v25;
  HMDCounterThresholdTTRTrigger *v26;
  void *v27;
  HMDCounterThresholdTTRTrigger *v28;
  uint64_t v29;
  id v30;
  id v31;
  ...
  v26 = [HMDCounterThresholdTTRTrigger alloc];
  -[HMDMetricsManager radarInitiator](self, "radarInitiator");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(v29) = a11;
  v28 = -[HMDCounterThresholdTTRTrigger initWithThreshold:message:radarTitle:componentName:componentVersion:componentID:radarInitiator:primaryOnly:forHome:](v26, "initWithThreshold:message:radarTitle:componentName:componentVersion:componentID:radarInitiator:primaryOnly:forHome:", a10, v25, v24, v23, v22, v21, v27, v29, v19);

  objc_msgSend(v31, "addObserver:forEventName:requestGroup:", v28, v20, v30);
}
  ...
  if (-[HMDMetricsManager _canRunCountersManagerCommand:](self, "_canRunCountersManagerCommand:", v4))
  {
    ...
    else
    {
      if (!v54 || !v55)
      {
        ...
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalHomes"));
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v28, CFSTR("totalHomes"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v22, "totalUsers"));
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v29, CFSTR("totalUsers"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalAccessories"));
        v30 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v30, CFSTR("totalAccessories"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalHAPAccessories"));
        v31 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v31, CFSTR("totalHAPAccessories"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalCHIPAccessories"));
        v32 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v32, CFSTR("totalMatterAccessories"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalThreadAccessories"));
        v33 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v33, CFSTR("totalThreadAccessories"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalCameraAccessories"));
        v34 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v34, CFSTR("totalCameraAccessories"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalAppleAudioAccessories"));
        v35 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v35, CFSTR("totalAppleAudioAccessories"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalAppleTVAccessories"));
        v36 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v36, CFSTR("totalAppleTVAccessories"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalScenes"));
        v37 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v37, CFSTR("totalScenes"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v22, "totalTriggers"));
        v38 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v38, CFSTR("totalTriggers"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v22, "totalWidgets"));
        v39 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v39, CFSTR("totalWidgets"));

        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v22, "isFMFDevice"));
        v40 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "setObject:forKeyedSubscript:", v40, CFSTR("isFMFDevice"));

        objc_msgSend(v19, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("isHH2Enabled"));
        if (v55)
        {
...
- (void)_handleAddEphemeralContainer:(id)a3
{
  ...
  if (-[HMDMetricsManager _canRunCountersManagerCommand:](self, "_canRunCountersManagerCommand:"))
  {
    ...
    if (!v4)
    {
      objc_msgSend(MEMORY[0x24BDD1540], "hmfErrorWithCode:reason:", 3, CFSTR("Ephemeral container name required"));
      v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v8)
    {
      ...
      do
      {
        for (i = 0; i != v9; ++i)
        {
          ...
          objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v12, "isActive", (_QWORD)v17));
          v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleFetchEventCounters:(id)a3
{
  ...
  v16[0] = v8;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v16, &v15, 1, v10, v11, v12, v13);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)waitToCompleteCurrentlyQueuedTasks
{
  ...
  dispatch_sync(v2, &__block_literal_global_354);
...
void __41__HMDMetricsManager__handleReadCounters___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v8)
  {
    objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BE4F120]);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_29:
  ...
  if (v9)
  {
    objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BE4F128]);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_8:
    objc_msgSend(v7, "objectForKeyedSubscript:", *MEMORY[0x24BE4F118]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (NSUUID)namespaceUUID
{
  if (namespaceUUID_onceToken != -1)
    dispatch_once(&namespaceUUID_onceToken, &__block_literal_global_111191);
...
+ (HMMLogEventSubmitting)sharedLogEventSubmitter
{
  ...
  if (!sharedDispatcher)
  {
    ...
    {
      v3 = objc_alloc_init(MEMORY[0x24BE4F168]);
...
+ (void)submitMinimalCoreAnalyticsEvent:(id)a3
{
  ...
  v4 = objc_alloc(MEMORY[0x24BE4F170]);
  v5 = (void *)objc_msgSend(v4, "initWithDelegate:filters:", v6, MEMORY[0x24BDBD1A8]);
...
void __34__HMDMetricsManager_namespaceUUID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("D3872CF5-6B42-43E3-8D60-9E0A0C8483DA"));
