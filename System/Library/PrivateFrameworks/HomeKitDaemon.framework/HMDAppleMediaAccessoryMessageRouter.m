...
- (void)routeMessage:(id)a3 allowRemoteRelayFromPrimary:(BOOL)a4 localHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v8;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Routing message: %@", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v16;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source device while routing message error: %@", (uint8_t *)&v21, 0x16u);
...
LABEL_7:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v33 = 2112;
      v34 = v17;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Relaying remote message: %@", (uint8_t *)&v31, 0x16u);
  ...
  if (v5 && objc_msgSend(v10, "isCurrentDevicePrimaryResident"))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = v15;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Allowing relay for message: %@", (uint8_t *)&v31, 0x16u);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    v33 = 2112;
    v34 = v8;
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to relay message due to being a remote message: %@", (uint8_t *)&v31, 0x16u);
...
- (id)dataSourceDeviceForMessage:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source device due to no data source", (uint8_t *)&v13, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_140241 != -1)
    dispatch_once(&logCategory__hmf_once_t6_140241, &__block_literal_global_140242);
  return (id)logCategory__hmf_once_v7_140243;
}
...
void __50__HMDAppleMediaAccessoryMessageRouter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_140243;
  logCategory__hmf_once_v7_140243 = v0;
