...
LABEL_4:
    if ((has & 4) == 0)
      goto LABEL_5;
LABEL_11:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_numPresenceRegionValidUsers);
...
LABEL_10:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_numPresenceAuthUsers);
...
LABEL_5:
  ...
  {
LABEL_6:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_primaryResident);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
