...
- (HMDRemoteEventRouterProcessStateChangeAssertion)initWithQueue:(id)a3 timerProvider:(id)a4 applicationsAndIntervals:(id)a5 dataSource:(id)a6
{
  ...
  if (v15)
  {
    ...
    v18 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCEF0]), "initWithCapacity:", objc_msgSend(v13, "count"));
    foregroundProcesses = v16->_foregroundProcesses;
    v16->_foregroundProcesses = (NSMutableSet *)v18;

    v20 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", objc_msgSend(v13, "count"));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v15;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Ignoring foreground state change for application %@ with state: %@", buf, 0x20u);
...
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)a3
{
  ...
  v19 = (void *)MEMORY[0x227676638](v14, v15, v16, v17, v18);
  v20 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", v9, v25, v26, v27, v28, v29);
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v35 = 2112;
    v36 = v23;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Starting backgroundTimer: %@ interval: %@", buf, 0x20u);
...
- (void)_removeBackgroundTimer:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v4;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Remove backgroundTimer: %@", (uint8_t *)&v10, 0x16u);
...
- (void)_backgroundTimerDidExpire:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2112;
    v36 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@bundleIdentifier: %@ backgroundTimer: %@ expired.", (uint8_t *)&v31, 0x20u);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2112;
    v36 = v18;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@foregroundProcesses %@, backgroundProcesses %@", (uint8_t *)&v31, 0x20u);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2112;
    v36 = v28;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground %@", (uint8_t *)&v31, 0x20u);
...
void __111__HMDRemoteEventRouterProcessStateChangeAssertion_foregroundStateChangedWithBundleIdentifier_applicationState___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 2112;
    v41 = v9;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Application %@ state changed to %@", (uint8_t *)&v36, 0x20u);
  ...
  if ((*(_QWORD *)(a1 + 48) | 2) == 2)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v38 = 2112;
      v39 = v19;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground YES", (uint8_t *)&v36, 0x16u);
...
LABEL_16:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 138543362;
      v37 = v35;
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to enable background timer.", (uint8_t *)&v36, 0xCu);
...
LABEL_17:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 2112;
    v41 = v31;
    _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@foregroundProcesses %@, backgroundProcesses %@", (uint8_t *)&v36, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_187550 != -1)
    dispatch_once(&logCategory__hmf_once_t10_187550, &__block_literal_global_187551);
  return (id)logCategory__hmf_once_v11_187552;
}
...
void __62__HMDRemoteEventRouterProcessStateChangeAssertion_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_187552;
  logCategory__hmf_once_v11_187552 = v0;
