...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_118436 != -1)
    dispatch_once(&logCategory__hmf_once_t0_118436, &__block_literal_global_118437);
  return (id)logCategory__hmf_once_v1_118438;
}
...
void __34__HMDLogEventAnalyzer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_118438;
  logCategory__hmf_once_v1_118438 = v0;
