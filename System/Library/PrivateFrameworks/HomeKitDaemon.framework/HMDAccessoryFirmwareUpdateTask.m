...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_211455 != -1)
    dispatch_once(&logCategory__hmf_once_t0_211455, &__block_literal_global_211456);
  return (id)logCategory__hmf_once_v1_211457;
}
...
void __45__HMDAccessoryFirmwareUpdateTask_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_211457;
  logCategory__hmf_once_v1_211457 = v0;
