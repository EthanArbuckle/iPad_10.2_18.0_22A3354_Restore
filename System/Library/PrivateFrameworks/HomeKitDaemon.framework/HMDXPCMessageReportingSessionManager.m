...
- (HMDXPCMessageReportingSessionManager)init
{
  ...
  if (v2)
  {
    ...
    v2->_endSessionTimerFactory = &__block_literal_global_179454;

    consumeSessionResultsTimerFactory = v2->_consumeSessionResultsTimerFactory;
    v2->_consumeSessionResultsTimerFactory = &__block_literal_global_49_179455;
...
- (void)startSessionWithUUID:(id)a3 reportContext:(id)a4 xpcClientConnection:(id)a5
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2048;
    v36 = v13;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Starting reporting session with UUID: %@, reportDomain: %@, requestInfo: %@, timeout: %fs", (uint8_t *)&v27, 0x34u);
...
- (void)addResponseMessagePayload:(id)a3 toSessionWithUUID:(id)a4
{
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Adding response message payload to session with UUID: %@", (uint8_t *)&v16, 0x16u);
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v49 = 2112;
      v50 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No existing session to end with UUID: %@", buf, 0x16u);
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v49 = 2112;
      v50 = v4;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@Ending session with UUID: %@", buf, 0x16u);
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v49 = 2112;
        v50 = v4;
        _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@XPC client connection is still active so not reporting completion of session with UUID: %@", buf, 0x16u);

      }
    }
    else
    {
      if (objc_msgSend(v29, "isEqualToString:", *MEMORY[0x24BDD6A58]))
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v49 = 2112;
          v50 = v30;
          _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Reporting completion of Siri request with requestInfo: %@", buf, 0x16u);
      ...
      if (isInternalBuild() && objc_msgSend(v29, "isEqualToString:", *MEMORY[0x24BDD6A60]))
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v49 = 2112;
          v50 = v30;
          _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Reporting completion of HomeUtil request with requestInfo: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v51 = 2112;
        v52 = v30;
        _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@Not reporting completion of request with unhandled domain: %@, requestInfo: %@", buf, 0x20u);
...
LABEL_26:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v49 = 2112;
    v50 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Not ending already-ended session with UUID: %@", buf, 0x16u);
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v37 = 2112;
            v38 = v22;
            _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Consuming %lu response message payloads for session with UUID: %@", buf, 0x20u);
      ...
      if ((_DWORD)v10)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v31 = 2112;
          v32 = v9;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Results retrieval timed out for session with UUID: %@", buf, 0x16u);
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v31 = 2112;
          v32 = v9;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@End timed out for session with UUID: %@", buf, 0x16u);
...
void __44__HMDXPCMessageReportingSessionManager_init__block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = (objc_class *)MEMORY[0x24BE092E8];
  v5 = a3;
  v6 = a2;
  v8 = (id)objc_msgSend([v4 alloc], "initWithContext:", v6);

  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE092E0]), "initWithRequestInfo:", v8);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_179461 != -1)
    dispatch_once(&logCategory__hmf_once_t16_179461, &__block_literal_global_58_179462);
  return (id)logCategory__hmf_once_v17_179463;
}
...
void __51__HMDXPCMessageReportingSessionManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v17_179463;
  logCategory__hmf_once_v17_179463 = v0;
