...
+ (id)fetchRequest
{
  return (id)objc_msgSend(MEMORY[0x24BDBB678], "fetchRequestWithEntityName:", CFSTR("MKFCharacteristicEvent"));
}
...
- (BOOL)validateForInsertOrUpdate:(id *)a3
{
  ...
  if (v5)
  {
    -[_MKFCharacteristicEvent service](self, "service");
...
{
  return -[MKFObjectDatabaseID initWithMKFObject:]([MKFCharacteristicEventDatabaseID alloc], "initWithMKFObject:", self);
}
...
- (MKFHome)home
{
  ...
  -[_MKFCharacteristicEvent trigger](self, "trigger");
