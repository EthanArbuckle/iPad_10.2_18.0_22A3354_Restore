...
- (HMDPhotoLibraryObserver)initWithUUID:(id)a3 workQueue:(id)a4 photoLibrary:(id)a5
{
  ...
  v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 4, 2592000.0);
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 0, 300.0);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Minor update timer fired", (uint8_t *)&v21, 0xCu);
  ...
  if (v8 == v4)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Major update timer fired", (uint8_t *)&v21, 0xCu);
  ...
  else
  {
    ...
    if (v9 == v4)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 138543362;
        v22 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Photo library persons did change debounce timer fired", (uint8_t *)&v21, 0xCu);
...
void __55__HMDPhotoLibraryObserver_photoLibraryPersonsDidChange__block_invoke(uint64_t a1)
{
  ...
  if (v8 < v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Photo library persons did change; handling change immediately since we've been debouncing since %@",
        (uint8_t *)&v21,
        0x16u);
...
LABEL_6:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Photo library persons did change; resuming debounce timer",
        (uint8_t *)&v21,
        0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_248158 != -1)
    dispatch_once(&logCategory__hmf_once_t5_248158, &__block_literal_global_248159);
  return (id)logCategory__hmf_once_v6_248160;
}
...
void __38__HMDPhotoLibraryObserver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_248160;
  logCategory__hmf_once_v6_248160 = v0;
