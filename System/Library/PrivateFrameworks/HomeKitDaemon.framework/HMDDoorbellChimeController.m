  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring new significant event since we are not the primary resident", buf, 0xCu);
...
- (void)_handleCharacteristicsValueUpdatedNotification:(id)a3
{
  ...
  v21 = v10;
  objc_msgSend(v10, "na_filter:", &__block_literal_global_134223);
  v23 = 0u;
  v24 = 0u;
  v25 = 0u;
  v26 = 0u;
      ...
      for (i = 0; i != v13; ++i)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v29 = 2112;
          v30 = v16;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Handling doorbell input event characteristic: %@", buf, 0x16u);
...
- (void)_notifyAllAccessoriesForDoorbellPressAndPlayChimeSound:(BOOL)a3 attemptCloudPullIfNoPersonsFound:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v125 = 2112;
    v126 = v14;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying accessories for doorbell press with shouldPlayChime: %@, attemptCloudPullIfNoPersonsFound: %@", buf, 0x20u);
...
LABEL_11:
    ...
    v34 = (void *)MEMORY[0x227676638](-[HMDDoorbellChimeNotificationLogEvent setNumHomePodsWithDoorbellChimeEnabled:](v32, "setNumHomePodsWithDoorbellChimeEnabled:", -[HMDDoorbellChimeController _numHomePodsWithDoorbellChimeEnabled](v10, "_numHomePodsWithDoorbellChimeEnabled")));
    v35 = v10;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v123 = 2112;
      v124 = *(double *)&v33;
      _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@Determined destinations for CoreUtils to notify for doorbell chime: %@", buf, 0x16u);
      ...
      if (!v42 && v4)
      {
        ...
        if (v49)
        {
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v122 = v53;
            _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_INFO, "%{public}@Did not find person identification text, so performing cloud pull", buf, 0xCu);

          }
          objc_autoreleasePoolPop(v50);
          objc_msgSend(v49, "performCloudPull");
          v54 = (void *)objc_claimAutoreleasedReturnValue();
          v55 = (void *)MEMORY[0x24BE6B628];
    ...
    if (v5 || v42)
    {
      ...
      if (v66)
      {
        ...
        if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v122 = v70;
          _os_log_impl(&dword_2218F0000, v69, OS_LOG_TYPE_INFO, "%{public}@Coordination path is enabled so taking coordination route for eligible accessories", buf, 0xCu);
      ...
      else
      {
        ...
        if (v84)
        {
          ...
          if (v88)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v122 = v89;
            _os_log_impl(&dword_2218F0000, v87, OS_LOG_TYPE_INFO, "%{public}@Taking HomeKit path as coordination path is disabled", buf, 0xCu);
        ...
        else
        {
          if (v88)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v122 = v98;
            _os_log_impl(&dword_2218F0000, v87, OS_LOG_TYPE_INFO, "%{public}@Coordination path is disabled so not taking coordination route for any accessories", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v122 = v64;
        _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_INFO, "%{public}@Not playing chime and found no persons to announce, so doing nothing", buf, 0xCu);
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v125 = 2048;
      v126 = v24;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@It has been %lfs since the last unidentified chime, and our maximum allowed announce delay is %lfs", buf, 0x20u);
    ...
    if (v27 < v18)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v122 = v31;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Not notifying accessories since we have exceeded our maximum allowed announce delay", buf, 0xCu);
  ...
  if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v122 = v82;
    _os_log_impl(&dword_2218F0000, v81, OS_LOG_TYPE_INFO, "%{public}@Ignoring updated person information because there was not a recent doorbell press", buf, 0xCu);
...
- (void)notifyAccessoriesViaCoordinationFreePathWithDelay:(double)a3 home:(id)a4 shouldPlayChime:(BOOL)a5 personIdentificationText:(id)a6 nexusNotificationDestinationIDs:(id)a7 logEvent:(id)a8
{
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v21;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Taking HomeKit path as coordination path is disabled", buf, 0xCu);
  ...
  {
    objc_msgSend(MEMORY[0x24BDBCE60], "date", v25, v26, v27, v28, v29);
...
- (void)_chimeCoreUtilDoorbellWithDestination:(id)a3 shouldPlayChime:(BOOL)a4 logEvent:(id)a5 personIdentificationText:(id)a6
{
  ...
  {
    v15 = objc_alloc_init(MEMORY[0x24BE297C0]);
    v16 = v15;
    if (v8)
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v50 = 2112;
      v51 = v16;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Posting action: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Destination count is 0", buf, 0xCu);
...
- (id)_destinationIDsToNotifyForDoorbellChimeUsingCoreUtilAction
{
  ...
  objc_msgSend(v21, "na_map:", &__block_literal_global_60_134186);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)_numHomePodsWithDoorbellChimeEnabled
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "na_map:", &__block_literal_global_63_134182);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v6, "na_filter:", &__block_literal_global_64_134183);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)handleCharacteristicsValueUpdatedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring characteristic value updated notification since we are not the primary resident", buf, 0xCu);
...
LABEL_10:
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, v15, (uint8_t *)&v22, 0x2Au);
...
void __118__HMDDoorbellChimeController__chimeCoreUtilDoorbellWithDestination_shouldPlayChime_logEvent_personIdentificationText___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully posted action %@", (uint8_t *)&v9, 0x16u);
...
void __118__HMDDoorbellChimeController__chimeCoreUtilDoorbellWithDestination_shouldPlayChime_logEvent_personIdentificationText___block_invoke_53(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to post action %@: %@", (uint8_t *)&v9, 0x20u);
...
void __118__HMDDoorbellChimeController__notifyAllAccessoriesForDoorbellPressAndPlayChimeSound_attemptCloudPullIfNoPersonsFound___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Cloud pull succeeded; attempting to announce without playing chime",
      (uint8_t *)&v8,
      0xCu);
...
void __118__HMDDoorbellChimeController__notifyAllAccessoriesForDoorbellPressAndPlayChimeSound_attemptCloudPullIfNoPersonsFound___block_invoke_38(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v85 = 2112;
    v86 = v5;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Coordinating doorbell chime with delay of %@s", buf, 0x16u);
  ...
  if (v12 && v14)
  {
    ...
    if (!v20 || !v23)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v84 = v45;
        _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@Nil chime mode keyPath or chime date keyPath", buf, 0xCu);
    ...
    if (*(_BYTE *)(a1 + 72))
    {
      ...
      if (!v26)
      {
        v64 = v17;
        v67 = v5;
        objc_msgSend(v70, "setObject:forKey:", &unk_24E96B810, v20);
        goto LABEL_22;
      }
      objc_msgSend(*(id *)(a1 + 32), "context");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v29)
      {
        v64 = v17;
        v67 = v5;
        objc_msgSend(v70, "setObject:forKey:", &unk_24E96B840, v20);
        v30 = *(void **)(a1 + 48);
        v31 = v70;
        v32 = v29;
LABEL_20:
...
LABEL_29:
        ...
        *(_DWORD *)buf = 138543362;
        v84 = v63;
        _os_log_impl(&dword_2218F0000, v62, OS_LOG_TYPE_ERROR, "%{public}@KeyPaths for chime are nil, or this is not an ATV build", buf, 0xCu);
...
LABEL_31:
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v87 = 2112;
    v88 = v14;
    _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Cannot chime using coordination with currentAccessoryUUID: %@ accessoryUUID: %@", buf, 0x20u);
...
void __118__HMDDoorbellChimeController__notifyAllAccessoriesForDoorbellPressAndPlayChimeSound_attemptCloudPullIfNoPersonsFound___block_invoke_43(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v8;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully posted state:%@", (uint8_t *)&v12, 0x16u);
...
void __118__HMDDoorbellChimeController__notifyAllAccessoriesForDoorbellPressAndPlayChimeSound_attemptCloudPullIfNoPersonsFound___block_invoke_44(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to post state %@: %@", (uint8_t *)&v12, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t31_134238 != -1)
    dispatch_once(&logCategory__hmf_once_t31_134238, &__block_literal_global_65_134239);
  return (id)logCategory__hmf_once_v32_134240;
}
...
void __41__HMDDoorbellChimeController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v32_134240;
  logCategory__hmf_once_v32_134240 = v0;
