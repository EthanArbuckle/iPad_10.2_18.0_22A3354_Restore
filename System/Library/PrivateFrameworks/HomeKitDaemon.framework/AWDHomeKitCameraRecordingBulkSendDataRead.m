...
LABEL_11:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_chunkSequenceNumber);
...
LABEL_21:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_bytesRead);
...
LABEL_23:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_bitRate);
...
LABEL_15:
    if ((v9 & 0x40) == 0)
      goto LABEL_16;
LABEL_25:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_imageWidth);
...
LABEL_24:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_imageHeight);
...
LABEL_16:
  ...
  {
LABEL_17:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_iFrameInterval);
