...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteStreamReceiver", buf, 0xCu);
...
- (void)_getSnapshot:(unint64_t)a3
{
  ...
  v18 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BE3F138]), "initWithName:", CFSTR("Snapshot Stream Receiver"));
...
- (void)_callDidSaveImageDelegateWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v24 = 2112;
    v25 = v11;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that download of image %@ has completed with error %@ for session %@", buf, 0x2Au);
...
- (void)streamReceiver:(id)a3 didReceiveFileWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v7;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Image receive has completed with error: %@", (uint8_t *)&v13, 0x16u);

  }
  objc_autoreleasePoolPop(v9);
  -[HMDCameraSnapshotRemoteStreamReceiver _callDidSaveImageDelegateWithError:](v10, "_callDidSaveImageDelegateWithError:", v7);
  -[HMDCameraSnapshotReceiver _sendConfirmationToResident:](v10, "_sendConfirmationToResident:", &__block_literal_global_31_201854);
  ...
  if (WeakRetained)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v15 = 2112;
        v16 = v5;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Take snapshot relayed to resident has ended in error %@", (uint8_t *)&v13, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_201893 != -1)
    dispatch_once(&logCategory__hmf_once_t1_201893, &__block_literal_global_201894);
  return (id)logCategory__hmf_once_v2_201895;
}
...
void __52__HMDCameraSnapshotRemoteStreamReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_201895;
  logCategory__hmf_once_v2_201895 = v0;
