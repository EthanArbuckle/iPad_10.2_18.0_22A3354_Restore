...
- (HMDAppleMediaAccessoryModelIdentifierResponseMessagePayload)initWithPayload:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_UUIDForKey:", *MEMORY[0x24BDD5128]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive message due to no model identifier in payload: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_75160 != -1)
    dispatch_once(&logCategory__hmf_once_t1_75160, &__block_literal_global_75161);
  return (id)logCategory__hmf_once_v2_75162;
}
...
void __74__HMDAppleMediaAccessoryModelIdentifierResponseMessagePayload_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_75162;
  logCategory__hmf_once_v2_75162 = v0;
