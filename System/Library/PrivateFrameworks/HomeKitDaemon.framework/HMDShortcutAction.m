...
- (id)stateDump
{
  ...
  objc_msgSend(v4, "na_map:", &__block_literal_global_2667);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v11.receiver = self;
...
- (void)executeWithSource:(unint64_t)a3 clientName:(id)a4 completionHandler:(id)a5
{
  ...
  if (WorkflowKitLibraryCore_frameworkLibrary && self->_controller)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)&buf[14] = shortcut;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Executing shortcut action : %{public}@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[4] = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@The shortcut action is unavailable to execute", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v23 = 2112;
        v24 = v14;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to process model update with error: %@", buf, 0x16u);
...
- (HMDShortcutAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x24BDD7278]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  shortcutData = self->_shortcutData;
  if (shortcutData)
    objc_msgSend(v4, "encodeObject:forKey:", shortcutData, *MEMORY[0x24BDD7278]);
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v26 = 2112;
      v27 = v18;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@[%@] %@ requires device to be unlock", buf, 0x20u);
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Does this shortcut action contain any unsecuring actions: [%@]", buf, 0x16u);
  ...
  if (a1)
  {
    ...
    if (WorkflowKitLibraryCore_frameworkLibrary)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v10;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Shortcuts framework is available on this OS", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          ...
          v26 = 32;
LABEL_15:
          _os_log_impl(&dword_2218F0000, v24, v25, v23, buf, v26);
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v36 = 2112;
      v37 = v10;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Going to deserialize shortcut dictionary [%@]", buf, 0x16u);
    ...
    v32 = v16;
    v33 = v9;
    v17 = (void *)MEMORY[0x227676638](objc_msgSend(v10, "hmf_enumerateWithAutoreleasePoolUsingBlock:", v30));
    v18 = v12;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v36 = 2112;
      v37 = v15;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Found actionSets from shortcut dictionary : %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v17);
    v26 = (void *)MEMORY[0x227676638](v21, v22, v23, v24, v25);
    v27 = v18;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v36 = 2112;
      v37 = v16;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Found characteristics from shortcut dictionary : %@", buf, 0x16u);
...
- (void)unpackActionsAndActionSets:(void *)a3 actionSets:(void *)a4 characteristicWriteTuples:(void *)a5 homeUUID:
{
  ...
  if (a1)
  {
    v11 = *MEMORY[0x24BDD51D8];
    objc_msgSend(v9, "hmf_stringForKey:", *MEMORY[0x24BDD51D8]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v12, "isEqualToString:", *MEMORY[0x24BDD51E0]) & 1) != 0)
    {
      objc_msgSend(v9, "hmf_stringForKey:", *MEMORY[0x24BDD51E8]);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = objc_msgSend(v13, "isEqualToString:", *MEMORY[0x24BDD51F0]);

      if ((v14 & 1) != 0)
      {
        objc_msgSend(v9, "hmf_dataForKey:", *MEMORY[0x24BDD51D0]);
        v15 = objc_claimAutoreleasedReturnValue();
        if (!v15)
        {
          v154 = 0;
          v155 = (void *)MEMORY[0x227676638]();
          v156 = a1;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v157, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            *(_QWORD *)&buf[4] = v158;
            _os_log_impl(&dword_2218F0000, v157, OS_LOG_TYPE_ERROR, "%{public}@Did not find any serialized homekit data in this shortcut dictionary", buf, 0xCu);
        ...
        v201 = (void *)v15;
        v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7890]), "initWithData:", v15);
        v202 = v16;
        if (!v16)
        {
          ...
          if (os_log_type_enabled(v161, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            *(_QWORD *)&buf[4] = v162;
            _os_log_impl(&dword_2218F0000, v161, OS_LOG_TYPE_ERROR, "%{public}@Could not initialize PB actionSet data", buf, 0xCu);
                      ...
                      if ((objc_msgSend(v32, "hasServiceReference") & 1) != 0)
                      {
                        ...
                        if (!v35)
                        {
                          ...
                          if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
                          {
                            ...
                            *(_DWORD *)buf = 138543362;
                            *(_QWORD *)&buf[4] = v73;
                            _os_log_impl(&dword_2218F0000, v72, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode characteristic uniqueIdentifier", buf, 0xCu);
                                        ...
                                        if (v51)
                                        {
                                          ...
                                          if (!v54)
                                          {
                                            ...
                                            if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
                                            {
                                              ...
                                              *(_DWORD *)buf = 138543362;
                                              *(_QWORD *)&buf[4] = v58;
                                              _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode service uniqueIdentifier", buf, 0xCu);
...
LABEL_95:
                                            ...
                                            if (os_log_type_enabled(v124, OS_LOG_TYPE_INFO))
                                            {
                                              ...
                                              *(_DWORD *)v224 = 138543618;
                                              ...
                                              v226 = 2112;
                                              v227 = v35;
                                              _os_log_impl(&dword_2218F0000, v124, OS_LOG_TYPE_INFO, "%{public}@Unable to find the characteristic with uniqueIdentifier: %@", v224, 0x16u);
...
LABEL_96:
                                            ...
                                            if (os_log_type_enabled(v120, OS_LOG_TYPE_INFO))
                                            {
                                              ...
                                              *(_DWORD *)v228 = 138543618;
                                              ...
                                              v230 = 2112;
                                              v231 = v189;
                                              _os_log_impl(&dword_2218F0000, v120, OS_LOG_TYPE_INFO, "%{public}@Unable to find the service with uniqueIdentifier : %@", v228, 0x16u);
                                        ...
                                        else
                                        {
                                          ...
                                          if (os_log_type_enabled(v106, OS_LOG_TYPE_ERROR))
                                          {
                                            ...
                                            *(_WORD *)&buf[12] = 2112;
                                            *(_QWORD *)&buf[14] = v197;
                                            _os_log_impl(&dword_2218F0000, v106, OS_LOG_TYPE_ERROR, "%{public}@Can't find accessory %@", buf, 0x16u);
                                      ...
                                      else
                                      {
                                        ...
                                        if (os_log_type_enabled(v109, OS_LOG_TYPE_ERROR))
                                        {
                                          ...
                                          *(_QWORD *)&buf[14] = v184;
                                          ...
                                          v235 = 2112;
                                          v236 = v112;
                                          _os_log_impl(&dword_2218F0000, v109, OS_LOG_TYPE_ERROR, "%{public}@Trying to dereference characteristic reference from different home [Looking for :%@] against [spiIdenfitifer : %@], [UUID : %@]", buf, 0x2Au);
                                    ...
                                    else
                                    {
                                      ...
                                      if (os_log_type_enabled(v102, OS_LOG_TYPE_ERROR))
                                      {
                                        ...
                                        *(_DWORD *)buf = 138543362;
                                        *(_QWORD *)&buf[4] = v103;
                                        _os_log_impl(&dword_2218F0000, v102, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode Home uniqueIdentifier", buf, 0xCu);
                                  ...
                                  else
                                  {
                                    ...
                                    if (os_log_type_enabled(v98, OS_LOG_TYPE_ERROR))
                                    {
                                      ...
                                      *(_DWORD *)buf = 138543362;
                                      *(_QWORD *)&buf[4] = v99;
                                      _os_log_impl(&dword_2218F0000, v98, OS_LOG_TYPE_ERROR, "%{public}@Characteristic write action's HomeReference does not have uniqueIdentifier set", buf, 0xCu);
                                ...
                                else
                                {
                                  ...
                                  if (os_log_type_enabled(v94, OS_LOG_TYPE_ERROR))
                                  {
                                    ...
                                    *(_DWORD *)buf = 138543362;
                                    *(_QWORD *)&buf[4] = v95;
                                    _os_log_impl(&dword_2218F0000, v94, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode accessory uniqueIdentifier", buf, 0xCu);
...
LABEL_68:
                                _os_log_impl(&dword_2218F0000, v90, OS_LOG_TYPE_ERROR, v91, buf, 0xCu);
...
LABEL_62:
                            _os_log_impl(&dword_2218F0000, v81, OS_LOG_TYPE_ERROR, v82, buf, 0xCu);
...
LABEL_53:
                        _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_ERROR, v69, buf, 0xCu);
...
LABEL_112:
                    ...
                    v126 = (void *)MEMORY[0x24BDD1620];
                    objc_msgSend(MEMORY[0x24BDD75F0], "allowedTargetValueClassesForShortcuts");
                    ...
                    if (v130)
                    {
                      ...
                      if (os_log_type_enabled(v133, OS_LOG_TYPE_ERROR))
                      {
                        ...
                        *(_QWORD *)&buf[14] = v130;
                        ...
                        v237 = 2112;
                        v238 = v204;
                        _os_log_impl(&dword_2218F0000, v133, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive allowed target value from target value data (%@) for characteristic: %@ in action set: %@ home: %@", buf, 0x34u);
                    ...
                    if (v63)
                    {
                      ...
                      else
                      {
                        ...
                        if (os_log_type_enabled(v145, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *(_DWORD *)buf = 138543362;
                          *(_QWORD *)&buf[4] = v146;
                          _os_log_impl(&dword_2218F0000, v145, OS_LOG_TYPE_INFO, "%{public}@Did not find the target value belonging to the write action", buf, 0xCu);
...
LABEL_123:
                    ...
                    if (os_log_type_enabled(v141, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138543362;
                      *(_QWORD *)&buf[4] = v142;
                      _os_log_impl(&dword_2218F0000, v141, OS_LOG_TYPE_INFO, "%{public}@Did not find the accessory/characteristic belonging to the write action", buf, 0xCu);
...
LABEL_132:
              ...
              if (os_log_type_enabled(v175, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_QWORD *)&buf[14] = v204;
                v233 = 2112;
                v234 = v192;
                _os_log_impl(&dword_2218F0000, v175, OS_LOG_TYPE_ERROR, "%{public}@Cannot deserialize actionSet for different home. expected home :%@, found home :%@", buf, 0x20u);
...
LABEL_155:
            ...
            else
            {
              ...
              if (os_log_type_enabled(v171, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                *(_QWORD *)&buf[4] = v172;
                _os_log_impl(&dword_2218F0000, v171, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode Home UUID", buf, 0xCu);
...
LABEL_147:
            _os_log_impl(&dword_2218F0000, v165, OS_LOG_TYPE_ERROR, v167, buf, 0xCu);
...
LABEL_159:
    ...
    if (os_log_type_enabled(v149, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[14] = v152;
      v233 = 2112;
      v234 = v153;
      _os_log_impl(&dword_2218F0000, v149, OS_LOG_TYPE_ERROR, "%{public}@Protobuf version mismatch : ProtoKey: %@, ProtoVersion: %@", buf, 0x20u);
...
uint64_t __58__HMDShortcutAction_doesActionSetContainUnsecuringAction___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@ActionSet %@ unsecure the home : %@", (uint8_t *)&v11, 0x20u);
  ...
  if (!objc_msgSend(v4, "isEqual:", v3))
  {
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v19;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Could not find actionSet based on actionSet.uuid. Now searching using spiClientIdentifier", buf, 0xCu);
      ...
      if (!v15)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v31 = 2112;
          v32 = v21;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not find actionSet [%@]", buf, 0x16u);
...
LABEL_4:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v35 = 2112;
    v36 = v12;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Skipping actionSet to avoid cycle. [Checking ActionSet : %@] against [ActionSetUUID: %@] [ActionSet SPI Identifier: %@]", buf, 0x2Au);
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Does this shortcut action contain any secure class accessories: [%@]", buf, 0x16u);
...
uint64_t __62__HMDShortcutAction_doesActionSetContainSecureCharacteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@ActionSet %@ contain secure class accessory : %@", (uint8_t *)&v11, 0x20u);
...
void __68__HMDShortcutAction_executeWithSource_clientName_completionHandler___block_invoke(uint64_t a1, void *a2, int a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2114;
      v26 = v5;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to execute shortcut action %{public}@ with error: %{public}@", (uint8_t *)&v21, 0x20u);

    }
    objc_autoreleasePoolPop(v7);
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", -1, 0, 0, 0, v5);
    v13 = objc_claimAutoreleasedReturnValue();
LABEL_9:
    v17 = (void *)v13;
    goto LABEL_10;
  ...
  if (a3)
  {
    if (v14)
    {
      ...
      v23 = 2112;
      v24 = v16;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@shortcut action execution was cancelled : %@", (uint8_t *)&v21, 0x16u);
  ...
  if (v14)
  {
    ...
    v23 = 2112;
    v24 = v20;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Shortcut action successfully executed : %@", (uint8_t *)&v21, 0x16u);
...
+ (id)actionWithDictionaryRepresentation:(id)a3 home:(id)a4 actionSet:(id)a5
{
  ...
  {
    objc_msgSend(v8, "hmf_dataForKey:", *MEMORY[0x24BDD7278]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if (v12)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 2112;
        v28 = v8;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing serialized shortcut: %@", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v11;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid action type: %@", (uint8_t *)&v25, 0x16u);
