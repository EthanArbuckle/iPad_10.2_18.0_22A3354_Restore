...
- (void)startupWithLocalDatabase:(id)a3 completion:(id)a4
{
  ...
  {
    v11 = objc_alloc(MEMORY[0x24BDB9038]);
    ...
    v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE4EC58]), "initWithContainerID:", v10);
    v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE4EC50]), "initWithLocalDatabase:configuration:", v6, v13);
    if (v14)
    {
...
- (void)__startupWithMirroredLocalZone:(id)a3 completion:(id)a4
{
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v12, "conformsToProtocol:", &unk_25586AA10))
    v13 = v12;
  else
    v13 = 0;
  v14 = v13;
...
- (void)shutdownWithCompletion:(id)a3
{
  ...
  if (-[HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator isRunning](self, "isRunning"))
  {
    ...
    {
      v15 = v6;
      if (objc_msgSend(v15, "conformsToProtocol:", &unk_25580CD58))
        v16 = v15;
      else
        v16 = 0;
      v11 = v16;
...
- (void)_fetchCloudChangesWithQualityOfService:(int64_t)a3 ignoreLastFetchedAccessories:(BOOL)a4 forceChangeNotifications:(BOOL)a5 requiredRecordIDs:(id)a6 schedulerXpcActivity:(id)a7 completion:(id)a8
{
  ...
  if (v13 && (objc_msgSend(v13, "isSubsetOfSet:", v21) & 1) == 0)
  {
    ...
    v27 = (void *)MEMORY[0x227676638](objc_msgSend(v22, "minusSet:", v21));
    v28 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v44 = 2112;
      v45 = v22;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Cloud fetch triggered but required records are not watched: %@", buf, 0x16u);
...
- (id)_fetchNetworkDeclarationsForRecordIDs:(id)a3 options:(id)a4 ignoreOverrides:(BOOL)a5 error:(id *)a6
{
  ...
  objc_msgSend(MEMORY[0x24BDBCEF0], "setWithCapacity:", objc_msgSend(v52, "count", v48));
        ...
        if (v25)
        {
          if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v69 = 2112;
            v70 = v24;
            _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_DEBUG, "%{public}@%@ data for %@ parsed successfully", buf, 0x20u);
        ...
        if (v21)
        {
          if (v35)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v67 = 2112;
            v68 = v24;
            _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Override data for %@ failed to parse successfully, removing", buf, 0x16u);
        ...
        else
        {
          if (v35)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v67 = 2112;
            v68 = v24;
            _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Cloud data for %@ failed to parse successfully", buf, 0x16u);
    ...
    if ((v41 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v67 = 2112;
        v68 = v42;
        _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove invalid override data: %@", buf, 0x16u);
  ...
  if (!v63)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v70 = 2112;
      v71 = v6;
      _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have firmware version on %@", buf, 0x16u);
    ...
    do
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v72 = 2112;
        v73 = v6;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Version configuration contains identifier %@ that does not match requested identifier %@", buf, 0x20u);
          ...
          if (v37 != 1)
          {
            ...
            if (os_log_type_enabled(v40, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v70 = 2112;
              v71 = v12;
              _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple rule configurations with the same version for %@", buf, 0x16u);
          ...
          if (v29 != -1)
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v70 = 2112;
              v71 = v12;
              _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple version configurations with the same version for %@", buf, 0x16u);
...
- (id)_fetchPairedMetadataForAccessories:(id)a3 options:(id)a4 ignoreOverrides:(BOOL)a5 error:(id *)a6
{
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v91 = 2112;
      v92 = v20;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Fetch paired metadata for record failed with error %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v91 = 2112;
    v92 = v70;
    _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Fetched paired metadata dictionary %@", buf, 0x16u);
  ...
  if (a5)
  {
    v73 = v27;
    v68 = v11;
    v75 = (__CFString *)MEMORY[0x24BDBD1B8];
LABEL_27:
    objc_msgSend(MEMORY[0x24BDBCEF0], "setWithCapacity:", -[__CFString count](v70, "count"));
          ...
          if (v46)
          {
            if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v93 = 2112;
              v94 = v45;
              _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_INFO, "%{public}@%@ data for %@ parsed successfully", buf, 0x20u);
          ...
          if (v42)
          {
            if (v56)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v91 = 2112;
              v92 = v45;
              _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_ERROR, "%{public}@Override data for %@ failed to parse successfully, removing", buf, 0x16u);
          ...
          else
          {
            if (v56)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v91 = 2112;
              v92 = v45;
              _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_ERROR, "%{public}@Cloud data for %@ failed to parse successfully", buf, 0x16u);
...
LABEL_52:
          ...
          if ((v61 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v91 = 2112;
              v92 = v62;
              _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove invalid override data: %@", buf, 0x16u);
  ...
  if (!v20)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v91 = 2112;
      v92 = v75;
      _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_INFO, "%{public}@Fetched overrides dictionary %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v91 = 2112;
    v92 = v20;
    _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Fetch overrides for paired metadata failed with error %@", buf, 0x16u);
...
- (id)fetchPairedMetadataVersionConfigurationsForAccessories:(id)a3 qualityOfService:(int64_t)a4 ignoreOverrides:(BOOL)a5 error:(id *)a6
{
        ...
        if (!v18)
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v93 = 2112;
            v94 = v17;
            _os_log_impl(&dword_2218F0000, v56, OS_LOG_TYPE_ERROR, "%{public}@Firmware version not specified on %@", buf, 0x16u);
  ...
  if (v20)
  {
    ...
    {
      v69 = v19;
      objc_msgSend(MEMORY[0x24BDBCED8], "dictionaryWithCapacity:", objc_msgSend(v21, "count"));
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      v81 = 0u;
      v82 = 0u;
      v83 = 0u;
            ...
            if (v29)
            {
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v93 = 2112;
                v94 = v28;
                _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@More than one rule configuration for %@", buf, 0x16u);
      ...
      objc_msgSend(MEMORY[0x24BDBCEF0], "setWithCapacity:", objc_msgSend(obj, "count"));
              ...
              if (v42)
              {
                if (v46)
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v95 = 2112;
                  v96 = v42;
                  _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_DEBUG, "%{public}@Found pairedMetadata version configuration for %@: %@", buf, 0x20u);
              ...
              else
              {
                if (v46)
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v93 = 2112;
                  v94 = v36;
                  _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_DEBUG, "%{public}@No pairedMetadata version configuration for %@", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v50, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v93 = 2112;
                v94 = v36;
                _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_DEBUG, "%{public}@No pairedMetadata present for %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v93 = 2112;
        v94 = v12;
        _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_INFO, "%{public}@No pairedMetadata present for %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v95 = 2112;
      v96 = v62;
      _os_log_impl(&dword_2218F0000, v60, OS_LOG_TYPE_INFO, "%{public}@Nil pairedMetadata for %@ with error %@", buf, 0x20u);
        ...
        if (!v18)
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v50 = 2112;
            v51 = v17;
            _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Firmware version not specified on %@", buf, 0x16u);
  ...
  if (!v58)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v65 = 2112;
      v66 = v6;
      _os_log_impl(&dword_2218F0000, v48, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have firmware version on %@", buf, 0x16u);
    ...
    do
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v67 = 2112;
        v68 = v6;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Rule configuration contains identifier %@ that does not match requested identifier %@", buf, 0x20u);
...
LABEL_23:
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v65 = 2112;
            v66 = v12;
            _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple rule configurations with the same version for %@", buf, 0x16u);
    ...
    if ((objc_msgSend(v10, "BOOLValue") & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v22 = 2112;
        v23 = v6;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Cloud fetch is needed for (some of) %@", buf, 0x16u);
...
- (void)_dumpCloudRecordsForProductGroup:(id)a3 productNumber:(id)a4 rawOutput:(BOOL)a5 verifySignatures:(BOOL)a6 completion:(id)a7
{
  ...
  v48[1] = v48;
  v48[2] = 0x3032000000;
  v48[3] = __Block_byref_object_copy__162288;
  v48[4] = __Block_byref_object_dispose__162289;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v51 = v34;
        _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@No idea how to validate signatures on another mirror class", buf, 0xCu);
...
- (BOOL)addOverrides:(id)a3 replace:(BOOL)a4 error:(id *)a5
{
  ...
  v22 = &v21;
  v23 = 0x3032000000;
  v24 = __Block_byref_object_copy__162288;
  v25 = __Block_byref_object_dispose__162289;
  v26 = 0;
    ...
    *((_QWORD *)&v23 + 1) = &v23;
    ...
    if ((objc_msgSend(v6, "isRunning") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v22 = v19;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Starting cloud fetch scheduler", buf, 0xCu);
...
LABEL_18:
      if (objc_msgSend(v7, "isRunning"))
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v22 = v11;
          _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Stopping cloud fetch scheduler", buf, 0xCu);
...
LABEL_15:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)((char *)&v23 + 4) = v15;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Not starting cloud fetch scheduler because we should not be running", (uint8_t *)&v23, 0xCu);
...
- (void)__stopCloudFetchScheduler
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Unconditionally stopping cloud fetch scheduler", (uint8_t *)&v9, 0xCu);
...
- (void)__cloudFetchSchedulerFired:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Cloud fetch scheduler fired", buf, 0xCu);
...
void __89__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator___cloudFetchSchedulerFired___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched cloud changes with poll timer: %@", (uint8_t *)&v14, 0x16u);
  ...
  else if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch cloud changes with poll timer: %@", (uint8_t *)&v14, 0x16u);
...
void __89__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator_addOverrides_replace_error___block_invoke(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 2112;
      v29 = v7;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Firmware version specified on %@", (uint8_t *)&v26, 0x16u);
  ...
  else
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v28 = 2112;
        v29 = v7;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Multiple declarations given for the same identifier %@", (uint8_t *)&v26, 0x16u);
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v32 = 2112;
        v33 = v19;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Found %lu valid public key%s in record %@", buf, 0x2Au);
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 2112;
        v29 = (uint64_t)v22;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@No valid public keys found in record %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (v8)
    {
      ...
      if (objc_msgSend(v8, "count"))
      {
              ...
              if (v17)
              {
                ...
                if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v71 = 2112;
                  v72 = v16;
                  _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@More than one rule configuration for %@", buf, 0x16u);
        ...
        v22 = v56;
        objc_msgSend(MEMORY[0x24BDBCEF0], "setWithCapacity:", objc_msgSend(*(id *)(v56 + 48), "count"));
        v54 = (void *)objc_claimAutoreleasedReturnValue();
        v60 = 0u;
        v61 = 0u;
        v62 = 0u;
                ...
                if (v30)
                {
                  if (v34)
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    v73 = 2112;
                    v74 = v30;
                    _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_DEBUG, "%{public}@Found rule configuration for %@: %@", buf, 0x20u);
                ...
                else
                {
                  if (v34)
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v71 = 2112;
                    v72 = v24;
                    _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_DEBUG, "%{public}@No declaration for %@", buf, 0x16u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v71 = 2112;
                  v72 = v24;
                  _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_DEBUG, "%{public}@No declarations for %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v71 = 2112;
          v72 = v48;
          _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_DEBUG, "%{public}@No declarations for %@", buf, 0x16u);
  ...
  if ((a2 & 1) != 0)
  {
    ...
    if (!*(_QWORD *)(a1 + 48))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v26 = v18;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Resetting the cloud fetch scheduler after a successful force fetch", buf, 0xCu);
...
void __85__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator_shutdownWithCompletion___block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v6;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down local zone: %@", (uint8_t *)&v11, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_162500 != -1)
    dispatch_once(&logCategory__hmf_once_t0_162500, &__block_literal_global_162501);
  return (id)logCategory__hmf_once_v1_162502;
}
...
LABEL_8:
  ...
  if (v6 != 1)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2048;
      v16 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Unknown container target value %lu, ignoring", (uint8_t *)&v13, 0x16u);
...
LABEL_6:
  ...
  if ((unint64_t)(v6 - 1) >= 2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2048;
      v15 = v6;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Unknown container environment value %ld, ignoring", (uint8_t *)&v12, 0x16u);
...
+ (id)__jsonStringFromDictionary:(id)a3 rawOutput:(BOOL)a4 error:(id *)a5
{
  ...
  if (a4)
    ...
    v5 = 3;
  objc_msgSend(MEMORY[0x24BDD1608], "dataWithJSONObject:options:error:", a3, v5, a5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
...
LABEL_22:
        ...
        if (v53)
        {
          ...
          else
          {
            ...
            if (!v38)
            {
              objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("INVALID: %@"), v39);
        ...
        else
        {
          ...
          if (!v43)
          {
            objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("INVALID: %@"), v63);
...
+ (id)__createProcessingOptionsWithLabel:(id)a3 qualityOfService:(int64_t)a4
{
  ...
  objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", a3);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
void __103__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator___jsonFromPairedMetadata_rawOutput_error___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!*(_BYTE *)(a1 + 48))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse declaration for %@", (uint8_t *)&v22, 0x16u);

    }
    objc_autoreleasePoolPop(v18);
  }
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithData:encoding:", v6, 4);
...
void __73__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_162502;
  logCategory__hmf_once_v1_162502 = v0;
