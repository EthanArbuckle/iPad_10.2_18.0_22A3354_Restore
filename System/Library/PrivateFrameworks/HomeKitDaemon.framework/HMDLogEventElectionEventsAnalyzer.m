...
LABEL_36:
    ...
    else
    {
      ...
      if (v24 && objc_msgSend(v24, "triggerReason") == 3 && objc_msgSend(v24, "count"))
      {
        -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
        v27 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v27, "incrementEventCounterForEventName:", CFSTR("v3ResidentSelectionPrimaryResidentChangedCount"));
...
- (void)handlePrimaryResidentChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received update primary resident notification but the primary resident is nil", (uint8_t *)&v16, 0xCu);
...
- (void)populateAggregationAnalysisLogEvent:(id)a3 forDate:(id)a4
{
  ...
  objc_msgSend(v25, "setCurrentDeviceStartedLegacyElectionCount:", objc_msgSend(v7, "fetchEventCounterForEventName:forDate:", CFSTR("currentDeviceStartedElectionCount"), v6));

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "setV2ElectionCoordinationMeshUpdateCount:", objc_msgSend(v8, "fetchEventCounterForEventName:forDate:", CFSTR("v2ElectionCoordinationMeshUpdateCount"), v6));

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "setV2ElectionCoordinationMeshLeaderElectedCount:", objc_msgSend(v9, "fetchEventCounterForEventName:forDate:", CFSTR("v2ElectionCoordinationMeshLeaderElectedCount"), v6));

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "setV2ElectionCoordinationMeshLeaderChangedCount:", objc_msgSend(v10, "fetchEventCounterForEventName:forDate:", CFSTR("v2ElectionCoordinationMeshLeaderChangedCount"), v6));

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "setV2ElectionPrimaryResidentElectionRunCount:", objc_msgSend(v11, "fetchEventCounterForEventName:forDate:", CFSTR("v2ElectionPrimaryResidentElectionRunCount"), v6));

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "setV2ElectionPrimaryResidentChangedCount:", objc_msgSend(v12, "fetchEventCounterForEventName:forDate:", CFSTR("v2ElectionPrimaryResidentChangedCount"), v6));

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "setResidentSelectionPrimaryResidentChangedCount:", objc_msgSend(v13, "fetchEventCounterForEventName:forDate:", CFSTR("v3ResidentSelectionPrimaryResidentChangedCount"), v6));
  ...
  objc_msgSend(v25, "setV2ElectionCoordinationCurrentDeviceFlapCount:", objc_msgSend(v14, "fetchEventCounterForEventName:forDate:", CFSTR("v2ElectionCoordinationCurrentDeviceFlapCount"), v6));

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v15, "durationForCounter:forDate:", CFSTR("PrimaryResidentDurationSeconds"), v6);
  v17 = v16;

  objc_msgSend(v25, "setPrimaryResidentDurationMinutes:", (uint64_t)((v17 + 59.0) / 60.0));
  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v18, "durationForCounter:forDate:", CFSTR("v2CurrentDeviceInPrimaryMeshDurationSeconds"), v6);
  v20 = v19;

  -[HMDLogEventElectionEventsAnalyzer counterGroup](self, "counterGroup");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v21, "durationForCounter:forDate:", CFSTR("v2CurrentDeviceInSecondaryMeshDurationSeconds"), v6);
  v23 = v22;
  ...
  objc_msgSend(v25, "setV2ElectionPercentageDurationCurrentDeviceIsInPrimaryMesh:", v24);
