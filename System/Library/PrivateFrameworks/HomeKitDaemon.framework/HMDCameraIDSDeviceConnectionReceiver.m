...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocing HMDCameraIDSDeviceConnectionReceiver", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_30965 != -1)
    dispatch_once(&logCategory__hmf_once_t3_30965, &__block_literal_global_30966);
  return (id)logCategory__hmf_once_v4_30967;
}
...
void __51__HMDCameraIDSDeviceConnectionReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_30967;
  logCategory__hmf_once_v4_30967 = v0;
