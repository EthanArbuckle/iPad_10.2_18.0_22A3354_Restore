...
LABEL_7:
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    v105 = 2112;
    v106 = v13;
    _os_log_impl(&dword_2218F0000, v3, OS_LOG_TYPE_INFO, "%{public}@Updating storage node ID from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_8:
  ...
  if (v16)
  {
    -[HMDCHIPAccessoryStorage vendorID](self, "vendorID");
    v3 = objc_claimAutoreleasedReturnValue();
    if ((-[NSObject isEqualToNumber:](v3, "isEqualToNumber:", &unk_24E96AE68) & 1) == 0)
      goto LABEL_18;
  }
  objc_msgSend(v5, "setProperties");
...
LABEL_19:
  ...
  if ((v20 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
    {
      ...
      v105 = 2112;
      v106 = v25;
      _os_log_impl(&dword_2218F0000, v3, OS_LOG_TYPE_INFO, "%{public}@Updating storage vendor ID from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_31:
  ...
  if ((v30 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      v105 = 2112;
      v106 = v36;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating storage product ID from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_32:
  ...
  if (objc_msgSend(v37, "containsObject:", CFSTR("chipAttributeDatabase")))
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      v105 = 2112;
      v106 = v46;
      _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@Updating storage attribute database from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_38:
  ...
  if (objc_msgSend(v47, "containsObject:", CFSTR("chipPairingsData")))
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      v105 = 2112;
      v106 = v56;
      _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_INFO, "%{public}@Updating storage pairings from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_44:
  ...
  if (objc_msgSend(v57, "containsObject:", CFSTR("chipWEDSupport")))
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
    {
      ...
      v105 = 2112;
      v106 = v67;
      _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating storage WED support from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_50:
  ...
  if (objc_msgSend(v68, "containsObject:", CFSTR("chipExtendedMACAddress")))
  {
    ...
    if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
    {
      ...
      v105 = 2112;
      v106 = v77;
      _os_log_impl(&dword_2218F0000, v74, OS_LOG_TYPE_INFO, "%{public}@Updating storage eMAC Address from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_56:
  ...
  if (objc_msgSend(v78, "containsObject:", CFSTR("matterSoftwareVersionNumber")))
  {
    ...
    if (os_log_type_enabled(v84, OS_LOG_TYPE_INFO))
    {
      ...
      v105 = 2112;
      v106 = v87;
      _os_log_impl(&dword_2218F0000, v84, OS_LOG_TYPE_INFO, "%{public}@Updating accessory software version number from %@ to %@", (uint8_t *)&v101, 0x20u);
...
LABEL_62:
  ...
  if ((_DWORD)v89)
  {
    ...
    if (v90)
    {
      ...
      if ((objc_msgSend(v89, "isEqualToNumber:", &unk_24E96AE68) & 1) == 0)
      {
...
LABEL_72:
    ...
    if ((v93 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v96, OS_LOG_TYPE_INFO))
      {
        ...
        v105 = 2112;
        v106 = v99;
        _os_log_impl(&dword_2218F0000, v96, OS_LOG_TYPE_INFO, "%{public}@Updating matter accessory supported link layer types from %@ to %@", (uint8_t *)&v101, 0x20u);
...
- (unint64_t)hash
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDCHIPAccessoryStorage wedSupport](self, "wedSupport"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_69521 != -1)
    dispatch_once(&logCategory__hmf_once_t10_69521, &__block_literal_global_69522);
  return (id)logCategory__hmf_once_v11_69523;
}
...
void __38__HMDCHIPAccessoryStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_69523;
  logCategory__hmf_once_v11_69523 = v0;
