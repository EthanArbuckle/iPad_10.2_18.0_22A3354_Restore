...
- (HMDUserSettingsPerHomeLogEvent)initWithUser:(id)a3 userDataController:(id)a4 homeUUID:(id)a5
{
  ...
  if (v10)
  {
    ...
    v10->_isRecognizeMyVoiceEnabled = objc_msgSend(v8, "siriIdentifyVoiceEnabled");
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDUserSettingsPerHomeLogEvent isOwner](self, "isOwner"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("isOwner"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDUserSettingsPerHomeLogEvent isAdmin](self, "isAdmin"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("isAdmin"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDUserSettingsPerHomeLogEvent isRemoteAccessAllowed](self, "isRemoteAccessAllowed"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("isRemoteAccessAllowed"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDUserSettingsPerHomeLogEvent isRecognizeMyVoiceEnabled](self, "isRecognizeMyVoiceEnabled"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("isRecognizeMyVoiceEnabled"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDUserSettingsPerHomeLogEvent isPersonalRequestsEnabled](self, "isPersonalRequestsEnabled"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("isPersonalRequestsEnabled"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDUserSettingsPerHomeLogEvent isAnnounceAccessAllowed](self, "isAnnounceAccessAllowed"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("isAnnounceAccessAllowed"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDUserSettingsPerHomeLogEvent camerasAccessLevel](self, "camerasAccessLevel"));
