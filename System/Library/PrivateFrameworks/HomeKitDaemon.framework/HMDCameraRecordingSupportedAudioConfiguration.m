...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1B9F0], "wrappertlv:name:objectCreator:", 1, CFSTR("kSupportedAudioConfigurationCodecConfigurations"), &__block_literal_global_168_246746);
