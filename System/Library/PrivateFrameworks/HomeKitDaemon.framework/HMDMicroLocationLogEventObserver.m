...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_4521 != -1)
    dispatch_once(&logCategory__hmf_once_t1_4521, &__block_literal_global_4522);
  return (id)logCategory__hmf_once_v2_4523;
}
...
void __47__HMDMicroLocationLogEventObserver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_4523;
  logCategory__hmf_once_v2_4523 = v0;
  ...
  if (a1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v17 = 138543362;
        v18 = v15;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Event ineligible for donation because data source is nil", (uint8_t *)&v17, 0xCu);
