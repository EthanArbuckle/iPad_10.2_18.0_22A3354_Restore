...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_databaseSize);
...
LABEL_4:
    if ((has & 0x40) == 0)
      goto LABEL_5;
LABEL_23:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isResidentCapable);
...
LABEL_22:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_metadataVersion);
...
LABEL_5:
  if ((has & 0x80) == 0)
    goto LABEL_6;
LABEL_24:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isResidentEnabled);
...
LABEL_6:
  ...
  if ((v12 & 0x20) == 0)
  {
    if ((*(_BYTE *)&self->_has & 0x10) == 0)
      goto LABEL_17;
LABEL_26:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_hasWatchDevice, (_QWORD)v22);
...
LABEL_17:
  ...
  {
LABEL_18:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_hasActiveWatchDevice, (_QWORD)v22);
...
- (BOOL)readFrom:(id)a3
{
  ...
  if (*(_QWORD *)((char *)a3 + (int)*MEMORY[0x24BE7AF60]) < *(_QWORD *)((char *)a3 + (int)*MEMORY[0x24BE7AF50]))
  {
    ...
    v10 = &OBJC_IVAR___HMDCameraBulletinNotificationManager__currentPrimary;
    v11 = (int *)MEMORY[0x24BE7AF30];
    v12 = &OBJC_IVAR___HMDCameraBulletinNotificationManager__currentPrimary;
    while (!*((_BYTE *)a3 + *v7))
    {
      v13 = 0;
      v14 = 0;
...
LABEL_14:
      ...
      switch((v15 >> 3))
      {
        case 1u:
          ...
          v23 = 0;
          v24 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 1u;
          while (1)
          {
            v25 = *v5;
...
LABEL_81:
          if (*((_BYTE *)a3 + *v7))
            v24 = 0;
LABEL_83:
          *(Class *)((char *)&self->super.super.isa + v10[708]) = (Class)v24;
          goto LABEL_114;
        case 2u:
          v33 = 0;
          v34 = 0;
          v35 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 2u;
          while (2)
          {
            v36 = *v5;
...
LABEL_87:
        ...
        case 3u:
          ...
          v40 = 0;
          v35 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 4u;
          while (2)
          {
            v41 = *v5;
...
LABEL_92:
        ...
        case 4u:
          ...
          v45 = 0;
          v46 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 0x40u;
          while (2)
          {
            v47 = *v5;
...
LABEL_96:
        ...
        case 5u:
          ...
          v51 = 0;
          v52 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 0x80u;
          while (2)
          {
            v53 = *v5;
...
LABEL_114:
        ...
        case 7u:
          ...
          v61 = 0;
          v62 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 0x20u;
          while (2)
          {
            v63 = *v5;
...
LABEL_104:
        ...
        case 8u:
          ...
          v67 = 0;
          v68 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 0x10u;
          while (2)
          {
            v69 = *v5;
...
LABEL_108:
        ...
        case 9u:
          ...
          v73 = 0;
          v74 = 0;
          *((_BYTE *)&self->super.super.isa + v9[707]) |= 8u;
          while (2)
          {
            v75 = *v5;
