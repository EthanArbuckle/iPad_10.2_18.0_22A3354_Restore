...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_195575 != -1)
    dispatch_once(&logCategory__hmf_once_t5_195575, &__block_literal_global_123_195576);
  return (id)logCategory__hmf_once_v6_195577;
}
...
void __53__HMDAccessoryDiagnosticsSessionInternal_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_195577;
  logCategory__hmf_once_v6_195577 = v0;
