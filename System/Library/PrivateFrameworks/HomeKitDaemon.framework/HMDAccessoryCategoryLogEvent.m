...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessoryCategoryLogEvent accessoryDetailsType](self, "accessoryDetailsType"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", &unk_24E96ADC0, CFSTR("accessoryCategoryCount"));
