...
- (void)main
{
  ...
  v13[1] = v13;
  v13[2] = 0x3032000000;
  v13[3] = __Block_byref_object_copy__166022;
  v13[4] = __Block_byref_object_dispose__166023;
  v14 = 0;
...
- (id)_updateClipModel:(id)a3 usingStreamingAsset:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE4ED38]), "initWithUploadStreamingAsset:", v7);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v30;
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Submitting clip model update", buf, 0xCu);
...
- (id)_retryDelayForError:(id)a3
{
        ...
        v5))
  {
    ...
    if (v6 != 34 && v6 != 121)
    {
      ...
      objc_msgSend(v8, "hmf_numberForKey:", *MEMORY[0x24BDB8EB8]);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    if (v9)
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Retry timer fired for append", (uint8_t *)&v13, 0xCu);
  ...
  else
  {
    if (v9)
    {
      ...
      v13 = 138543362;
      v14 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Operation timed out, cancelling", (uint8_t *)&v13, 0xCu);
...
id __83__HMDCameraClipAppendStreamingAssetOperation__updateClipModel_usingStreamingAsset___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@No mirrorOutputResult available for clip update, failing operation", (uint8_t *)&v13, 0xCu);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Appending %lu bytes of data to streaming asset", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v19);
    v23 = objc_alloc_init(MEMORY[0x24BE6B608]);
    v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDB9250]), "initWithStreamingAsset:", v10);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v43 = v7;
      v32 = v41;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Property \"%@\" was of unexpected class %@: %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v27);
    v33 = (void *)MEMORY[0x24BE6B608];
...
id __50__HMDCameraClipAppendStreamingAssetOperation_main__block_invoke_22(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully appended to streaming asset", (uint8_t *)&v10, 0xCu);
...
void __50__HMDCameraClipAppendStreamingAssetOperation_main__block_invoke_24(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully updated clip model with updated streaming asset", (uint8_t *)&v8, 0xCu);
...
void __50__HMDCameraClipAppendStreamingAssetOperation_main__block_invoke_26(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v29 = 2112;
    v30 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to append to streaming asset: %@", (uint8_t *)&v27, 0x16u);
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v9;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Retrying failed append in %@ seconds", (uint8_t *)&v27, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v26;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Unable to retry append operation, canceling", (uint8_t *)&v27, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_166058 != -1)
    dispatch_once(&logCategory__hmf_once_t12_166058, &__block_literal_global_166059);
  return (id)logCategory__hmf_once_v13_166060;
}
...
void __57__HMDCameraClipAppendStreamingAssetOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_166060;
  logCategory__hmf_once_v13_166060 = v0;
