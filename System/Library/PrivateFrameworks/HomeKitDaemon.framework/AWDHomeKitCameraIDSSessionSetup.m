...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_idsSessionInvitationSent);
...
LABEL_3:
      if ((has & 8) == 0)
        goto LABEL_4;
LABEL_9:
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_idsSessionStartedOnResident);
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_idsSessionInvitationReceived);
...
LABEL_4:
  ...
  {
LABEL_5:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_idsSessionStartedOnReceiver);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
