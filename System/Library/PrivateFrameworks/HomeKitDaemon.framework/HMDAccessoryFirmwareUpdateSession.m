...
- (HMDAccessoryFirmwareUpdateSession)initWithHAPAccessory:(id)a3 uarpAccessory:(id)a4 accessoryFirmwareUpdateManager:(id)a5 logEventManager:(id)a6 wingman:(id)a7
{
  ...
  if (v17)
  {
    ...
    v17->_registerFailureRetryTimerFactory = &__block_literal_global_168106;
  ...
  if (internalState != a3)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if (a3 - 1 > 4)
        ...
        v12 = off_24E78BBF0[a3 - 1];
      v13 = 138543618;
      v14 = v10;
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@State changed to %@", (uint8_t *)&v13, 0x16u);
...
- (HMFSoftwareVersion)accessoryVersion
{
  ...
  if (objc_msgSend(v2, "supportsCHIP"))
  {
    ...
    v9 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F270]), "initWithMajorVersion:minorVersion:updateVersion:", objc_msgSend(v8, "unsignedLongValue"), 0, 0);
    v5 = (void *)v9;
  }
    ...
    else
    {
      ...
      if (!v33)
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v45 = 138543362;
          v46 = v37;
          _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Starting user-initiated update", (uint8_t *)&v45, 0xCu);
...
LABEL_29:
            _os_log_impl(&dword_2218F0000, v43, v44, v42, (uint8_t *)&v45, 0xCu);
...
LABEL_33:
          ...
          case 5uLL:
            ...
            v45 = 138543362;
            v46 = v19;
            _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot update while registration is in progress", (uint8_t *)&v45, 0xCu);
            goto LABEL_18;
          default:
            goto LABEL_20;
        }
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 22;
LABEL_17:
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, v22, (uint8_t *)&v45, v24);
...
LABEL_20:
  ...
  if (os_log_type_enabled(&v17->super.super, OS_LOG_TYPE_ERROR))
  {
    ...
    v49 = 2112;
    v50 = v31;
    _os_log_impl(&dword_2218F0000, &v17->super.super, OS_LOG_TYPE_ERROR, "%{public}@Requested install version %@ is different than available version %@", (uint8_t *)&v45, 0x20u);
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: called by the controller's scheduler. Only a Matter Accessory can pause a firmware staging/application. No action taken.", buf, 0x16u);
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v19 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Pause ignored with socket in closing state", buf, 0xCu);
...
- (void)resumeWithState:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v40 = 2112;
    v41 = v16;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Resume called with sessionState: %@ accessoryState %@ resumeState %@", buf, 0x2Au);
...
LABEL_21:
  ...
  v21 = (void *)MEMORY[0x227676638](-[HMDAccessoryFirmwareUpdateSession setLastStagedVersion:](v7, "setLastStagedVersion:", 0));
  v22 = v7;
  HMFGetOSLogHandle();
  v23 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
...
- (void)_startSocketIdleTimer
{
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = (void *)objc_claimAutoreleasedReturnValue(), v5 = objc_msgSend(v4, "supportsCHIP"), v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      v27 = 2112;
      v28 = v19;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Start socket idle timer for %@ seconds", (uint8_t *)&v25, 0x16u);

    }
    objc_autoreleasePoolPop(v15);
    v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 1, v14);
...
- (void)_resetSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 138543362;
    v16 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reset socket idle timer", (uint8_t *)&v15, 0xCu);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](v5, "hapAccessory"), v8 = (void *)objc_claimAutoreleasedReturnValue(), v9 = objc_msgSend(v8, "supportsCHIP"), v8, v9))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", (uint8_t *)&v15, 0x16u);
...
- (void)_cancelSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 138543362;
    v16 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel socket idle timer", (uint8_t *)&v15, 0xCu);
...
- (void)_handleSocketTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 138543362;
    v15 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Socket idle timeout", (uint8_t *)&v14, 0xCu);
    ...
    || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))
  {
    ...
    if ((objc_msgSend(v8, "supportsCHIP") & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", (uint8_t *)&v14, 0x16u);
...
- (void)_cancelQueryFirmwareUpdateResultTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel query firmware update result duration timer", (uint8_t *)&v9, 0xCu);
...
- (void)_handleQueryFirmwareUpdateResultTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Query firmware update result duration timeout", (uint8_t *)&v8, 0xCu);
...
- (void)_cancelRegisterFailureRetryTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel register failure retry timer", (uint8_t *)&v9, 0xCu);
...
- (void)_handleRegisterFailureRetryTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Register failure retry timeout", (uint8_t *)&v8, 0xCu);
...
- (void)_withOpenSocketDoBlock:(id)a3 error:(id)a4
{
    ...
    && !CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0)|| !objc_msgSend(v9, "supportsCHIP"))
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 15, 0, CFSTR("Socket open already in progress"), 0);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v7[2](v7, v14);
    }
    else
    {
      ...
      if (v14)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v31 = v23;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Opening HDS connection to accessory", buf, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v31 = v24;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@No dataStreamSocketController", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v19);
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 54, 0, CFSTR("No dataStreamSocketController"), 0);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", buf, 0x16u);
  ...
  if (-[HMDAccessoryFirmwareUpdateSession internalState](self, "internalState"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if ((unint64_t)(v8 - 1) > 4)
        ...
        v9 = off_24E78BBF0[v8 - 1];
      v10 = 138543618;
      v11 = v7;
      v12 = 2112;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Synced state is: %@", (uint8_t *)&v10, 0x16u);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v3, "supportsCHIP"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", buf, 0x16u);
...
LABEL_10:
    ...
    {
      v13 = (void *)MEMORY[0x227676638](-[HMDAccessoryFirmwareUpdateSession setApplyHDSRetryCount:](self, "setApplyHDSRetryCount:", -[HMDAccessoryFirmwareUpdateSession applyHDSRetryCount](self, "applyHDSRetryCount") + 1));
      v14 = self;
      HMFGetOSLogHandle();
      v15 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        HMFGetLogIdentifier();
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessoryFirmwareUpdateSession applyHDSRetryCount](v14, "applyHDSRetryCount"));
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        *(_DWORD *)buf = 138543874;
        v28 = v16;
        v29 = 2112;
        v30 = (const char *)&unk_24E96C068;
        v31 = 2112;
        v32 = v17;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Rescheduling apply task after HDS failure in %@ sec for retry: %@", buf, 0x20u);
    ...
    else
    {
      if (-[HMDAccessoryFirmwareUpdateSession internalState](self, "internalState") == 3)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v28 = v12;
          _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Out of HDS retries for apply. Moving update back to downloaded.", buf, 0xCu);
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v25;
    _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not performing HDS retries because firmware apply has not started and accessory %@ is unreachable", buf, 0x16u);
...
- (BOOL)isReadyForStaging
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    v30 = 2112;
    v31 = v14;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Not ready for staging - Not ready reasons: %@ (%{public}@), updateState %@ (%{public}@), isStagedFirmwareVersionUpToDate %@", buf, 0x3Eu);
...
- (BOOL)isCurrentUpdateLatest
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@No available version from UARP", (uint8_t *)&v14, 0xCu);
...
- (BOOL)isReadyToApplyUpdate
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    v30 = 2112;
    v31 = v14;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Not ready for applying update - Not ready reason: %@ (%{public}@), updateState %@ (%@), isFirmwareVersionUpToDate %@", buf, 0x3Eu);
    ...
    || !objc_msgSend(v6, "isGreaterThanVersion:", v3))
  {
    if (!objc_msgSend(v7, "isGreaterThanVersion:", v6))
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v17 = 138543362;
        v18 = v16;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unhandled version combination in nextStateToSchedule", (uint8_t *)&v17, 0xCu);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v4, "supportsCHIP"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: firmware has been downloaded for Matter Accessory. Matter Accessory responsible for staging firmware. No action taken.", buf, 0x16u);
...
- (void)stagingComplete
{
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v4, "supportsCHIP"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", (uint8_t *)&v14, 0x16u);
  ...
  else
  {
      ...
      || -[HMDAccessoryFirmwareUpdateSession isUserInitiatedInstall](self, "isUserInitiatedInstall"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v12;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Staging complete", (uint8_t *)&v14, 0xCu);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v4, "supportsCHIP"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware application. No action taken.", buf, 0x16u);
        ...
        if (v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v31 = 2112;
            v32 = v19;
            _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Staged version %@ is different then available version %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v29 = 2112;
          v30 = v24;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Not auto applying firmware update because isAutomaticThirdPartyAccessorySoftwareUpdateEnabled = %@", buf, 0x16u);
...
- (void)_applyFirmware
{
  ...
  else
  {
    ...
    v11 = (void *)MEMORY[0x227676638](-[HMDAccessoryFirmwareUpdateSession setInternalState:](self, "setInternalState:", 4));
    v12 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to apply asset", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v32 = 2112;
          v33 = (const char *)v4;
          _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@No firmwareUpdateProfile for accessory: %@", buf, 0x16u);
    ...
    {
      v20 = (void *)MEMORY[0x227676638](-[HMDAccessoryFirmwareUpdateSession setUserInitiatedInstall:](v12, "setUserInitiatedInstall:", 0));
      v21 = v12;
      HMFGetOSLogHandle();
      v22 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v24;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@applyFirmwareUpdateOnAccessoryList failed for %@", buf, 0x16u);
...
- (void)startApplyDurationTimers
{
  ...
  if (!v5)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 1, v4);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v24 = 2112;
    v25 = v19;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting up to %@ seconds for accessory to apply update", (uint8_t *)&v22, 0x16u);
...
- (double)_expectedApplyDuration
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Expected duration is not set - default to minimum apply duration", (uint8_t *)&v12, 0xCu);
...
- (void)_stagingFailed
{
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v4, "supportsCHIP"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", (uint8_t *)&v20, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Staging failed", (uint8_t *)&v20, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v19;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@No more staging retries for this accessory's firmware update session", (uint8_t *)&v20, 0xCu);
...
- (void)_applyFailed
{
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = (void *)objc_claimAutoreleasedReturnValue(), v5 = objc_msgSend(v4, "supportsCHIP"), v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware application. No action taken.", (uint8_t *)&v14, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Apply did not complete or failed in the accessory", (uint8_t *)&v14, 0xCu);
...
LABEL_21:
      _os_log_impl(&dword_2218F0000, v20, v21, v19, (uint8_t *)&v23, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      if ((unint64_t)(v13 - 1) > 4)
        ...
        v14 = off_24E78BBF0[v13 - 1];
      v23 = 138543618;
      v24 = v12;
      v25 = 2112;
      v26 = v14;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Scheduling next operation, state %@", (uint8_t *)&v23, 0x16u);
...
- (void)_endSession
{
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v4, "supportsCHIP"))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", (uint8_t *)&v23, 0xCu);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v25 = 2112;
    v26 = v16;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Session ended (already ended: %@)", (uint8_t *)&v23, 0x16u);
...
- (void)_cancelApplyTimer
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply timer cancelled", (uint8_t *)&v12, 0xCu);
...
- (void)_updateSoftwareUpdateStateForMatterAccessoryWithState:(unint64_t)a3
{
  ...
  if (a3 == 1)
  {
    ...
    if (objc_msgSend(v7, "isEqualToVersion:", v6))
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v33 = 2112;
        v34 = v5;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Update is already installed for acc:%@ uarpAcc:%@ softwareUpdate:%@", (uint8_t *)&v27, 0x2Au);
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v26;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Marking Update as %@, matter accessory will trigger staging by itself.", (uint8_t *)&v27, 0x16u);
  ...
  {
    v15 = (void *)MEMORY[0x227676638](self, a2);
    v16 = self;
    HMFGetOSLogHandle();
    v17 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = v20;
      v21 = v20;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unsupported state %@ for Matter Accessory, ignoring.", (uint8_t *)&v27, 0x16u);
...
- (void)handleAccessoryFirmwareVersionNumberChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version number updated notification", (uint8_t *)&v9, 0xCu);
...
- (void)handleAccessoryVIDPIDChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received matter VID PID updated notification", (uint8_t *)&v9, 0xCu);
...
- (void)handleAccessoryFirmwareVersionChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware updated notification", (uint8_t *)&v9, 0xCu);
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v43 = 2112;
      v44 = v23;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@isAccessoryVersionInSyncWithAssetVersion: VersionNumberInSync : %@, VersionStringInSync: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v47 = 2112;
      v48 = v13;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@isAccessoryVersionInSyncWithAssetVersion: AssetVersionNumber: %@, MatterFirmwareRevisionNumber: %@, AssetVersionString %@, FirmwareVersionString: %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = 0;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Matter firmware version is invalid: %@", buf, 0x16u);
...
- (void)_updateSoftwareUpdateNotReadyReasons
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v47 = 2112;
    v48 = v19;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown stagingNotReadyReasons %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v47 = 2112;
    v48 = v27;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown applyNotReadyReasons %@", buf, 0x16u);
  ...
  if (v28)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      v41 = (void *)objc_claimAutoreleasedReturnValue();
      v43 = v30;
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v44, "needsAttentionReasons"));
      ...
      HAPStagingNotReadyReasonsAsString();
      v37 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v5, "stagingNotReadyReasons"));
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "updateNotReadyReasons");
      HAPUpdateNotReadyReasonsAsString();
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v5, "updateNotReadyReasons"));
      ...
      *(_DWORD *)buf = 138545410;
      ...
      v61 = 2114;
      v62 = v35;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_INFO, "%{public}@SoftwareUpdate needsAttentionReasons changed - old %{public}@ (%{public}@) new %{public}@ (%{public}@) staging reasons %{public}@ (%{public}@) apply reasons %{public}@ (%{public}@)", buf, 0x5Cu);
...
- (void)incrementMatterFirmwareUpdateRetryCount
{
  ...
  {
    v3 = (void *)MEMORY[0x227676638](-[HMDAccessoryFirmwareUpdateSession setMatterFirmwareUpdateRetryCount:](self, "setMatterFirmwareUpdateRetryCount:", -[HMDAccessoryFirmwareUpdateSession matterFirmwareUpdateRetryCount](self, "matterFirmwareUpdateRetryCount")+ 1));
    v4 = self;
    HMFGetOSLogHandle();
    v5 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2048;
      v12 = 10;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update retry attempt %lu of %lu", (uint8_t *)&v7, 0x20u);
...
LABEL_8:
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v48 = 2112;
      v49 = v9;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version (%@) is older than either current accessory version (%@) or the staged version (%@)", buf, 0x2Au);
...
LABEL_39:
      if (objc_msgSend(v4, "isEqualToVersion:", v8))
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v43 = v28;
          _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is the same as the current accessory version. Software Update has been installed.", buf, 0xCu);
...
LABEL_23:
      ...
      if (objc_msgSend(v4, "isEqualToVersion:", v9))
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v43 = v34;
          _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is staged on accessory. Software Update has been downloaded.", buf, 0xCu);
    ...
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, v35, buf, 0xCu);
    goto LABEL_6;
  }
  v15 = (void *)MEMORY[0x227676638]();
  v16 = self;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v43 = v18;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@firmware version not available in UARP accessory", buf, 0xCu);
...
- (void)_resetAvailableSoftwareUpdate
{
  ...
  if (v4)
    objc_msgSend(v5, "updateSoftwareUpdate:completionHandler:", 0, &__block_literal_global_86_167957);
...
- (void)_updateAvailableSoftwareUpdateState:(int64_t)a3
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = v36;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Not updating state from %@ to %@ because update firmware version is not set by UARP", (uint8_t *)&v39, 0x20u);
  ...
  if (a3 == 2 && -[HMDAccessoryFirmwareUpdateSession isFirmwareVersionUpToDate](self, "isFirmwareVersionUpToDate"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      if ((unint64_t)(v12 - 1) > 4)
        ...
        v13 = off_24E78BBF0[v12 - 1];
      v39 = 138543618;
      v40 = v11;
      v41 = 2112;
      v42 = v13;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Not updating state from %@ to downloaded because firmware version is up to date", (uint8_t *)&v39, 0x16u);
...
LABEL_24:
        ...
        v17))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v43 = 2112;
      v44 = v38;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating available software update state from %@ to %@", (uint8_t *)&v39, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      v41 = 2112;
      v42 = v34;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_INFO, "%{public}@New available software update with state %@", (uint8_t *)&v39, 0x16u);
    ...
    objc_msgSend(v6, "updateSoftwareUpdate:completionHandler:", v35, &__block_literal_global_87_167955);
...
LABEL_5:
    ...
    if (-[HMDAccessoryFirmwareUpdateSession documentationAvailable](self, "documentationAvailable"))
    {
      ...
      objc_msgSend(v6, "updateSoftwareUpdate:completionHandler:", v5, &__block_literal_global_88_167950);
      goto LABEL_5;
    }
  }
LABEL_6:
...
- (id)newSoftwareUpdateWithState:(int64_t)a3
{
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v51 = 2112;
      v52 = v18;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@No release date set for asset, using current date - assetID %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    v63 = 2112;
    v64 = v31;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Creating SoftwareUpdate with version %@, state %@, downloadSize %@(uarpAccessory downloadSize %@), documentation %@, release date %@, duration %@", buf, 0x52u);
...
- (id)newDocumentationMetadata
{
  ...
  if (-[HMDAccessoryFirmwareUpdateSession documentationAvailable](self, "documentationAvailable"))
  {
    ...
    if (v17)
    {
      v19 = objc_alloc(MEMORY[0x24BDD79F8]);
      v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F160]), "initWithAlgorithm:value:", 2, v17);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v33 = 2112;
        v34 = v18;
        _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Couldn't create digest for URLs local %@ remote: %@ error: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v15;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEBUG, "%{public}@No documentation available for %@", buf, 0x16u);
...
- (BOOL)sendMessageToAccessory:(id)a3 uarpMsg:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2112;
    v35 = v14;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@sendMessageToAccessory called with %@ bytes", buf, 0x16u);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](v11, "hapAccessory"), v15 = (void *)objc_claimAutoreleasedReturnValue(), v16 = objc_msgSend(v15, "supportsCHIP"), v15, v16))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", buf, 0x16u);
  ...
  else
  {
    ...
    else
    {
      if (a5)
      {
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 54, 0, CFSTR("Socket not open"), 0);
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v33 = v27;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@sendMessageToAccessory: Socket not open", buf, 0xCu);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v5 = (void *)objc_claimAutoreleasedReturnValue(), v6 = objc_msgSend(v5, "supportsCHIP"), v5, v6))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", buf, 0x16u);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = (void *)objc_claimAutoreleasedReturnValue(), v5 = objc_msgSend(v4, "supportsCHIP"), v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@%s: called on accessory that supports Matter", buf, 0x16u);
...
- (void)firmwareStagingProgress:(id)a3 assetID:(id)a4 bytesSent:(unint64_t)a5 bytesTotal:(unint64_t)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    v24 = 2112;
    v25 = v17;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEBUG, "%{public}@firmwareStagingProgress called for accessory %@ %@/%@ bytes sent", (uint8_t *)&v18, 0x2Au);
...
- (void)firmwareStagingComplete:(id)a3 assetID:(id)a4 withStatus:(unint64_t)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    HMFGetLogIdentifier();
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%s"), UARPFirmwareStagingCompletionStatusToString());
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    *(_DWORD *)buf = 138543618;
    v23 = v13;
    v24 = 2112;
    v25 = v14;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@firmwareStagingComplete called with status %@", buf, 0x16u);
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v7 = (void *)objc_claimAutoreleasedReturnValue(), v8 = objc_msgSend(v7, "supportsCHIP"), v7, v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for staging firmware. No action taken.", buf, 0x16u);
        ...
        else
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
            {
              ...
              v20 = 138543362;
              v21 = v19;
              _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unknown timer", (uint8_t *)&v20, 0xCu);
...
LABEL_4:
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, v8, buf, 0xCu);
...
- (void)_handleApplyTimerFired
{
  ...
  v5 = (void *)MEMORY[0x227676638](-[HMDAccessoryFirmwareUpdateSession setUserInitiatedInstall:](self, "setUserInitiatedInstall:", 0));
  v6 = self;
  HMFGetOSLogHandle();
  v7 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v25 = 2112;
    v26 = v11;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Apply timer fired for %@ %@ install", buf, 0x20u);
  ...
  if (-[HMDAccessoryFirmwareUpdateSession isFirmwareVersionUpToDate](v6, "isFirmwareVersionUpToDate"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware is up to date", buf, 0xCu);
    ...
    && !CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0)|| (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v6 = (void *)objc_claimAutoreleasedReturnValue(), v7 = objc_msgSend(v6, "supportsCHIP"), v6, !v7))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&v42[14] = v17;
      ...
      v45 = 2112;
      v46 = v20;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@HDS socket closed in state %@ for %@accessory %@", v42, 0x2Au);
    ...
    _os_log_impl(&dword_2218F0000, v33, v34, v32, v42, 0xCu);
...
LABEL_32:
           ...
           && -[HMDAccessoryFirmwareUpdateSession isFirmwareVersionUpToDate](v28, "isFirmwareVersionUpToDate"))
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)v42 = 138543362;
        *(_QWORD *)&v42[4] = v41;
        _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Registration complete", v42, 0xCu);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_QWORD *)&v42[14] = "-[HMDAccessoryFirmwareUpdateSession socketDidClose:]";
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", v42, 0x16u);
...
- (void)socket:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@HDS socket %@ closed: %@ failed for accessory %@ with error %@", (uint8_t *)&v14, 0x34u);
...
- (void)_logDebugStates:(const char *)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    if ((unint64_t)(v16 - 1) > 4)
      ...
      v17 = off_24E78BBF0[v16 - 1];
    v26 = v17;
    v30 = v8;
    if (v10 - 1 > 4)
      v18 = CFSTR("Up To Date");
    else
      v18 = off_24E78BBF0[v10 - 1];
    ...
    *(_DWORD *)buf = 138546434;
    ...
    v59 = 2114;
    v60 = v24;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@%@ States <Session internal %@, next %@, accessory %@, SU %@> Versions <available %@, staged %@ (last %@), accessory %@, asset %{public}@> Not Ready Reasons <Stage (%{public}@) Apply (%{public}@)>", buf, 0x84u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v6;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@No staged firmware in accessory %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v10);
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 3, 0, CFSTR("No staged firmware in accessory"), 0);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to rescind staged firmware for UARP accessory %@", (uint8_t *)&v12, 0x16u);

    }
    objc_autoreleasePoolPop(v7);
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 58, 0, CFSTR("Failed to rescind staged firmware for UARP accessory %@"), 0);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    (*(void (**)(void))(*(_QWORD *)(a1 + 48) + 16))();
...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke_135(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening socket for UARP communication: %@", (uint8_t *)&v8, 0x16u);
...
uint64_t __51__HMDAccessoryFirmwareUpdateSession_logDebugStates__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, asset: %@, auto update: %@", (uint8_t *)&v11, 0x2Au);
...
LABEL_8:
  ...
  v5 = (void *)MEMORY[0x227676638](objc_msgSend(WeakRetained, "setCurrentAutomaticApplyRetriesCount:", objc_msgSend(WeakRetained, "currentAutomaticApplyRetriesCount") + 1));
  v6 = WeakRetained;
  HMFGetOSLogHandle();
  v7 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    HMFGetLogIdentifier();
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v6, "currentAutomaticApplyRetriesCount"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    *(_DWORD *)buf = 138543618;
    v18 = v8;
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Firmware is still not applied after apply timer fired: retries count=%@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v18 = v13;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Out of retries for automatic apply", buf, 0xCu);
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 138543362;
    v28 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Asking UARP for Apply Results", (uint8_t *)&v27, 0xCu);
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v27 = 138543362;
      v28 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Start the timer for querying result", (uint8_t *)&v27, 0xCu);

    }
    objc_autoreleasePoolPop(v9);
    v13 = objc_alloc(MEMORY[0x24BE3F298]);
    objc_msgSend(MEMORY[0x24BE3F248], "sharedPreferences");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke_107(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening HDS socket: %@", (uint8_t *)&v8, 0x16u);
...
void __78__HMDAccessoryFirmwareUpdateSession_stagedFirmwareRescindComplete_withStatus___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 2112;
    v15 = v8;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Staged firmware rescinded with status: %@ for accessory %@", (uint8_t *)&v10, 0x20u);
...
void __85__HMDAccessoryFirmwareUpdateSession_firmwareUpdateResult_vendorSpecificStatus_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v8;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Results from apply accessory %@ status %@", (uint8_t *)&v12, 0x20u);
  ...
  switch(*(_QWORD *)(a1 + 56))
  {
    case 0:
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v48 = (uint64_t)v37;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Asset staging complete", buf, 0xCu);
      ...
      if ((v7 & 1) != 0)
      {
        if (v11)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v51 = 2112;
          v52 = v15;
          _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Staging %@ for asset %@", buf, 0x20u);
      ...
      else
      {
        if (v11)
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v53 = 2112;
          v54 = v33;
          _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring Staging %@ for asset %@ with current asset %@", buf, 0x2Au);
...
LABEL_28:
        _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_DEFAULT, v46, buf, 0xCu);
...
LABEL_29:
    ...
    case 5:
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v48 = (uint64_t)v21;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Update canceled", buf, 0xCu);
    ...
    default:
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v51 = 2112;
        v52 = v29;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Staging completion status %@ not handled for accessory %@", buf, 0x20u);
...
void __80__HMDAccessoryFirmwareUpdateSession_assetAvailablityUpdateForAccessory_assetID___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v143 = 2112;
    v144 = v12;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@assetAvailabilityUpdate called with firmware %{public}@,  status: <%{public}@, %{public}s> releaseNotes status: <%{public}@, %{public}s> for asset %@", buf, 0x48u);
...
LABEL_15:
    ...
    if (objc_msgSend(a1[4], "downloadStatus") == 2)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v132 = v34;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Firmware failed to download", buf, 0xCu);
    ...
    v37 = (void *)MEMORY[0x227676638](objc_msgSend(v4, "setUserInitiatedStaging:", objc_msgSend(a1[5], "userInitiatedFirmwareStaging")));
    v38 = v4;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v133 = 2112;
      v134 = v44;
      _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_DEBUG, "%{public}@userInitiatedFirmwareStaging: %@", buf, 0x16u);
      ...
      switch(objc_msgSend(a1[4], "updateAvailabilityStatus"))
      {
        ...
        case 1:
          ...
          if (os_log_type_enabled(v80, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v135 = 2112;
            v136 = v83;
            _os_log_impl(&dword_2218F0000, v80, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to download asset for accessory:%@ assetID:%@", buf, 0x20u);
          ...
          v84 = MEMORY[0x227676638](objc_msgSend(v79, "setUserInitiatedInstall:", 0));
          v85 = v79;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v86, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v135 = 2112;
            v136 = v89;
            _os_log_impl(&dword_2218F0000, v86, OS_LOG_TYPE_ERROR, "%{public}@downloadAvailableFirmwareUpdate failed for accessory:%@ assetID:%@", buf, 0x20u);
        ...
        case 2:
          ...
          if (os_log_type_enabled(v92, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v132 = v96;
            _os_log_impl(&dword_2218F0000, v92, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware downloading", buf, 0xCu);
        ...
        case 3:
          ...
          if (os_log_type_enabled(v98, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v133 = 2114;
            v134 = v100;
            _os_log_impl(&dword_2218F0000, v98, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware downloaded to %{public}@", buf, 0x16u);
...
LABEL_36:
          _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_ERROR, v51, buf, 0x16u);
...
LABEL_42:
          _os_log_impl(&dword_2218F0000, v68, v69, v67, buf, 0xCu);
          ...
          case 1:
            ...
            if (os_log_type_enabled(v102, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v135 = 2112;
              v136 = v106;
              _os_log_impl(&dword_2218F0000, v102, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to download release notes for accessory:%@ assetID:%@", buf, 0x20u);
            ...
            if (os_log_type_enabled(v109, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v135 = 2112;
              v136 = v112;
              _os_log_impl(&dword_2218F0000, v109, OS_LOG_TYPE_ERROR, "%{public}@Download of release notes failed for accessory:%@ assetID:%@", buf, 0x20u);
          ...
          case 3:
            ...
            if (os_log_type_enabled(v115, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v133 = 2114;
              v134 = v117;
              _os_log_impl(&dword_2218F0000, v115, OS_LOG_TYPE_DEFAULT, "%{public}@Release notes downloaded to %{public}@", buf, 0x16u);
...
LABEL_49:
            _os_log_impl(&dword_2218F0000, v72, OS_LOG_TYPE_ERROR, v76, buf, 0x16u);
...
LABEL_52:
    ...
    if (os_log_type_enabled(v54, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v132 = v58;
      _os_log_impl(&dword_2218F0000, v54, OS_LOG_TYPE_DEFAULT, "%{public}@No asset download needed", buf, 0xCu);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v139 = 2112;
    v140 = v16;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring assetAvailability with asset version %@: current asset %@, accessory %@, staged %@", buf, 0x34u);
...
void __46__HMDAccessoryFirmwareUpdateSession__register__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v42 = 2112;
    v43 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Register accessory failed for %@ - couldn't open socket error:%@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v4);
  if ((unint64_t)objc_msgSend(*(id *)(a1 + 32), "currentRegisterFailureCount") < 0xA)
  {
    v15 = (void *)MEMORY[0x227676638](objc_msgSend(*(id *)(a1 + 32), "setCurrentRegisterFailureCount:", objc_msgSend(*(id *)(a1 + 32), "currentRegisterFailureCount") + 1));
    HMFGetOSLogHandle();
    v16 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = &unk_24E96C068;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Rescheduling register in %@ seconds", buf, 0x16u);
  ...
  else
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v39 = v14;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Register retry timer is active", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
      {
        HMFGetLogIdentifier();
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", v24 / 3600.0);
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        *(_DWORD *)buf = 138543618;
        v39 = v28;
        v40 = 2112;
        v41 = v29;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting up to %@ hours to retry registering accessory", buf, 0x16u);
...
void __58__HMDAccessoryFirmwareUpdateSession_socketDidReceiveData___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    *(_QWORD *)&v6 = 138543874;
    ...
    while (1)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@HDS socket received %@ bytes", buf, 0x16u);
      ...
      if ((v14 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = v28;
          ...
          v35 = 2112;
          v36 = v15;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Couldn't send data from accessory %@ to controller: %@", buf, 0x20u);
    ...
    v24 = (void *)MEMORY[0x227676638](objc_msgSend(v17, "setDataStreamSocket:", 0));
    v25 = v17;
    HMFGetOSLogHandle();
    v26 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v27;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Socket closed", buf, 0xCu);
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAvailableSoftwareUpdateState___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Not updating available software update state from %@ to %@ because apply timer is active", (uint8_t *)&v10, 0x20u);
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAccessoryVendorIDAndProductID__block_invoke(uint64_t a1)
{
  ...
  if ((v8 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v24;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory vendor ID property", (uint8_t *)&v26, 0xCu);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v14;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Accessory vendor ID updated to %@", (uint8_t *)&v26, 0x16u);
  ...
  if ((v18 & 1) == 0)
  {
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v25;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory product ID property", (uint8_t *)&v26, 0xCu);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v23;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Accessory product ID updated to %@", (uint8_t *)&v26, 0x16u);
...
void __82__HMDAccessoryFirmwareUpdateSession_handleFirmwareUpdateStateChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory state changed to %@", (uint8_t *)&v18, 0x16u);
  ...
  if (objc_msgSend(v6, "internalState") == 2 && (!objc_msgSend(v4, "longValue") || objc_msgSend(v4, "longValue") == 2))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 138543362;
      v19 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Restarting staging", (uint8_t *)&v18, 0xCu);
  ...
  else if (objc_msgSend(v6, "internalState") == 3 && objc_msgSend(v4, "longValue") == 4)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Detected remote apply in progress", (uint8_t *)&v18, 0xCu);
...
void __73__HMDAccessoryFirmwareUpdateSession_updateAccessoryStagedFirmwareVersion__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v41 = 2112;
    v42 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version changed from %@ to %@", (uint8_t *)&v37, 0x20u);
  ...
  if (!v13)
  {
    ...
    if ((v26 & 1) != 0)
    {
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        v37 = 138543362;
        v38 = v31;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Updated UARP staged firmware version property", (uint8_t *)&v37, 0xCu);
...
LABEL_19:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v41 = 2112;
        v42 = v36;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@checkForUpdate failed for accessory %@ %@", (uint8_t *)&v37, 0x20u);
    ...
    else if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 138543362;
      v38 = v32;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP staged firmware version property", (uint8_t *)&v37, 0xCu);
LABEL_17:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v39 = 2112;
    v40 = v18;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version newer than available version (%@)", (uint8_t *)&v37, 0x16u);
  ...
  if ((objc_msgSend(v11, "checkForUpdateForAccessory:", v2) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 138543362;
      v38 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Error request UARP to check for available updates", (uint8_t *)&v37, 0xCu);
...
LABEL_4:
    ...
    if ((v20 & 1) != 0)
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v42 = 2112;
        v43 = v26;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Accessory %@: UARP accessory firmware version property updated to %@ (accessoryVersion is %@)", buf, 0x2Au);
    ...
    else
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v37 = v27;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory firmware version property", buf, 0xCu);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v37 = v31;
    _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Waiting for version number and version string to be in sync before proceeding", buf, 0xCu);
...
void __74__HMDAccessoryFirmwareUpdateSession__handleAutomaticUpdateEnabledChanged___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v11 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Notification missing required key", buf, 0xCu);
...
void __50__HMDAccessoryFirmwareUpdateSession_stageFirmware__block_invoke(uint64_t a1)
{
  ...
  if ((v6 & 1) != 0)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@UARP initated asset staging", (uint8_t *)&v14, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to initate asset staging in UARP controller", (uint8_t *)&v14, 0xCu);
...
void __70__HMDAccessoryFirmwareUpdateSession__evaluateHDSRetryForApplyFirmware__block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "sessionEnded") & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      v6 = 138543362;
      v7 = v5;
      _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Session has been ended, stop performing retries", (uint8_t *)&v6, 0xCu);
...
void __66__HMDAccessoryFirmwareUpdateSession__withOpenSocketDoBlock_error___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v4)
    {
      ...
      v5 = (void *)MEMORY[0x227676638](objc_msgSend(v3, "setApplyHDSRetryCount:", 0));
      v6 = v3;
      HMFGetOSLogHandle();
      v7 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 138543362;
        v29 = v8;
        _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Opened HDS connection to accessory", (uint8_t *)&v28, 0xCu);
      ...
      if ((v14 & 1) != 0)
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v28 = 138543362;
          v29 = v19;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Notified UARP accessory is reachable", (uint8_t *)&v28, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v28 = 138543362;
          v29 = v25;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify about reachable accessory to UARP", (uint8_t *)&v28, 0xCu);

        }
        objc_autoreleasePoolPop(v15);
        v26 = *(_QWORD *)(a1 + 56);
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 23, 0, CFSTR("UARP accessoryReachable failed"), 0);
        v27 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v30 = 2112;
        v31 = v24;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Couldn't open HDS connection to accessory error %@", (uint8_t *)&v28, 0x16u);
    ...
    switch(objc_msgSend(*(id *)(a1 + 32), "internalState"))
    {
      case 0:
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
        {
          ...
          v27 = 138543362;
          v28 = v8;
          _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Next action: -", (uint8_t *)&v27, 0xCu);
...
LABEL_17:
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, v13, (uint8_t *)&v27, 0xCu);
...
LABEL_18:
      ...
      case 3:
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          v27 = 138543362;
          v28 = v17;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Next action: applyFirmware", (uint8_t *)&v27, 0xCu);
      ...
      case 4:
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          if ((unint64_t)(v21 - 1) > 4)
            ...
            v22 = off_24E78BBF0[v21 - 1];
          v27 = 138543618;
          v28 = v20;
          v29 = 2112;
          v30 = v22;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Ignoring resume in state %@", (uint8_t *)&v27, 0x16u);
...
LABEL_31:
      ...
      case 5:
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
        {
          ...
          v27 = 138543362;
          v28 = v26;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Next action: register", (uint8_t *)&v27, 0xCu);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    HMFGetLogIdentifier();
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(*(id *)(a1 + 32), "currentCommunicationErrorCount"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    *(_DWORD *)buf = 138543874;
    v21 = v9;
    v22 = 2112;
    ...
    v24 = 2112;
    v25 = v3;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@HAP Communication Error occurrence: %@ error: %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v21 = v14;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Out of retries for socket open", buf, 0xCu);
...
void __53__HMDAccessoryFirmwareUpdateSession_resumeWithState___block_invoke_73(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@rescheduling task after socket open failed", (uint8_t *)&v6, 0xCu);
...
+ (id)__calculateDigestDataFromFile:(id)a3 maxDataSize:(unint64_t)a4 error:(id *)a5
{
  ...
  v12 = v11;
  objc_msgSend(MEMORY[0x24BDBCE90], "inputStreamWithURL:", v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v13)
  {
    v24 = (void *)MEMORY[0x227676638]();
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v52 = 2112;
      v53 = v12;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Couldn't open input stream for %@", (uint8_t *)&data, 0x16u);
...
LABEL_17:
  ...
  if (v14 >= 1)
  {
    ...
    v28 = (void *)MEMORY[0x227676638](objc_msgSend(v13, "close"));
    v29 = v10;
    HMFGetOSLogHandle();
    v30 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v48 = 2112;
      v49 = v12;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Data size is bigger than maximum %ld bytes on file %@", buf, 0x20u);
...
LABEL_11:
  ...
  if (v14 < 0)
  {
    v33 = (void *)MEMORY[0x227676638](v19);
    v34 = v10;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v48 = 2112;
      v49 = v37;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Error reading documentation from %@: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2048;
      v47 = 20;
      _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to allocate %lu bytes to hold digest", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t197 != -1)
    dispatch_once(&logCategory__hmf_once_t197, &__block_literal_global_124_168113);
