  ...
  if (v4)
  {
    if (!v9
      || (objc_msgSend(v9, "endDate"),
          ...
          (v16 & 1) == 0))
    {
      v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1508]), "initWithStartDate:endDate:", v6, v10);
      -[HMDCameraRecordingSessionTimelineManager motionActiveDateIntervals](self, "motionActiveDateIntervals");
...
LABEL_12:
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, v25, (uint8_t *)&v34, 0x16u);
  ...
  else if (v9)
  {
    ...
    if (v27)
    {
      ...
      v29 = objc_alloc(MEMORY[0x24BDD1508]);
      objc_msgSend(v9, "startDate");
...
- (void)handleDoorbellDidActivateAtDate:(id)a3
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1508]), "initWithStartDate:endDate:", v8, v10);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2048;
    v30 = v18;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Doorbell trigger activated at time offset: %f", (uint8_t *)&v27, 0x16u);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2048;
    v30 = v25;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Doorbell trigger will be deactivated at time offset: %f", (uint8_t *)&v27, 0x16u);
...
- (BOOL)isDoorbellTriggerActiveAtAnyTimeAfterOffset:(double)a3
{
  ...
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1508]), "initWithStartDate:endDate:", v7, v8);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_90684 != -1)
    dispatch_once(&logCategory__hmf_once_t4_90684, &__block_literal_global_90685);
  return (id)logCategory__hmf_once_v5_90686;
}
...
void __55__HMDCameraRecordingSessionTimelineManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_90686;
  logCategory__hmf_once_v5_90686 = v0;
