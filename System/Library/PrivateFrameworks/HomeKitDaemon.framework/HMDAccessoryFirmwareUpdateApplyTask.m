  ...
  if (!-[HMDAccessoryFirmwareUpdateApplyTask isUserInitiated](self, "isUserInitiated"))
  {
    ...
    switch(v3)
    {
      case 4:
        ...
        xpc_dictionary_set_string(v4, (const char *)*MEMORY[0x24BDAC5E8], "com.apple.homed.firmwareUpdate.threadAccessory.apply.group");
        v5 = (const char *)*MEMORY[0x24BDAC5E0];
        v6 = CFSTR("firmwareUpdateThreadAccessoryApplyConcurrentLimit");
        goto LABEL_8;
      case 3:
        v4 = xpc_dictionary_create(0, 0, 0);
        xpc_dictionary_set_string(v4, (const char *)*MEMORY[0x24BDAC5E8], "com.apple.homed.firmwareUpdate.bleAccessory.apply.group");
        v8 = (const char *)*MEMORY[0x24BDAC5E0];
        v9 = uint32ForPreference(CFSTR("firmwareUpdateBLEAccessoryApplyConcurrentLimit"));
        xpc_dictionary_set_uint64(v4, v8, v9);
        goto LABEL_10;
      case 2:
        v4 = xpc_dictionary_create(0, 0, 0);
        xpc_dictionary_set_string(v4, (const char *)*MEMORY[0x24BDAC5E8], "com.apple.homed.firmwareUpdate.ipAccessory.apply.group");
        v5 = (const char *)*MEMORY[0x24BDAC5E0];
...
- (BOOL)shouldRun
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v14;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Apply task shouldn't run - readyForApply:%@ needsApply:%@ (%@) policyCheck: %@", (uint8_t *)&v16, 0x34u);
