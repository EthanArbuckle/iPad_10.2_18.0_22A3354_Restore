...
- (id)modelWithParentIdentifier:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySettingMetadata properties](self, "properties"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDAccessorySettingModel setProperties:](v7, "setProperties:", v8);

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDAccessorySettingMetadata type](self, "type"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[HMDAccessorySettingModel setConfigurationVersion:](v7, "setConfigurationVersion:", &unk_24E96AC70);
  return v7;
}
...
LABEL_41:
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, v13, buf, 0x16u);
...
LABEL_30:
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v44 = 2112;
              v45 = v19;
              _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid item with title '%@', constraints: %@", buf, 0x20u);
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = v16;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid string value: %@", buf, 0x16u);
