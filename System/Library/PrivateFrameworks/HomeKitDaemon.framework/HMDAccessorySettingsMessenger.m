...
- (HMDAccessorySettingsMessenger)initWithMessageTargetUUID:(id)a3 messageDispatcher:(id)a4 messageRouter:(id)a5 messageHandler:(id)a6 logEventSubmitter:(id)a7
{
  ...
  id v17;
  void *v18;
  HMDAccessorySettingsMessenger *v19;
  HMDAccessorySettingsMessenger *v20;
...
LABEL_12:
  ...
  {
LABEL_13:
    v22 = (HMDAccessorySettingsMessenger *)_HMFPreconditionFailure();
    -[HMDAccessorySettingsMessenger registerForMessagesWithHome:](v22, v23, v24);
    return result;
  }
  v26.receiver = self;
  v26.super_class = (Class)HMDAccessorySettingsMessenger;
  v19 = -[HMDAccessorySettingsMessenger init](&v26, sel_init);
  v20 = v19;
  if (v19)
  {
...
- (void)sendFetchAccessorySettingsRequestWithAccessoryUUID:(id)a3 keyPaths:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v32 = 2112;
    v33 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending fetch request with accessoryUUID: %@ keypaths: %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v11);
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7428]), "initWithAccessoryUUID:keyPaths:", v8, v9);
...
- (id)fetchLogEventFromMessage:(id)a3
{
  ...
  v11 = objc_alloc(MEMORY[0x24BDD7428]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode fetch request payload for metric generation", (uint8_t *)&v22, 0xCu);
...
LABEL_4:
  ...
  if (!v9)
  {
    v32 = (void *)MEMORY[0x227676638](v11);
    v33 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v52 = 2112;
      v53 = 0;
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Send fetch request responded with error: %@", buf, 0x16u);
  ...
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7430]), "initWithPayload:", v9);
  if (v14)
  {
    v15 = v14;
    v43 = self;
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v52 = 2112;
    v53 = v9;
    _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode fetch request response payload: %@", buf, 0x16u);
...
- (void)sendUpdateAccessorySettingRequestWithAccessoryUUID:(id)a3 keyPath:(id)a4 settingValue:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v39 = 2112;
    v40 = v12;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending update request with accessoryUUID: %@ keypath: %@ value: %@", buf, 0x2Au);

  }
  objc_autoreleasePoolPop(v14);
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7440]), "initWithAccessoryUUID:keyPath:settingValue:", v10, v11, v12);
  ...
  v22 = objc_alloc(MEMORY[0x24BE3F1D0]);
  v23 = *MEMORY[0x24BDD4EB0];
...
- (void)routeAccessorySettingsFetchRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v33 = 2112;
    v34 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing accessory settings fetch request message: %@", buf, 0x16u);
  ...
  v26 = v22;
  v24 = v22;
  objc_msgSend(v23, "routeMessage:localHandler:", v24, v25);
...
- (void)routeAccessorySettingsUpdateRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing accessory settings update request message: %@", buf, 0x16u);
  ...
  v13 = v9;
  v11 = v9;
  objc_msgSend(v10, "routeMessage:localHandler:", v11, v12);
...
void __123__HMDAccessorySettingsMessenger_sendUpdateAccessorySettingRequestWithAccessoryUUID_keyPath_settingValue_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Send update request responded with error: %@", (uint8_t *)&v13, 0x16u);
  ...
  else if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Send update request responded", (uint8_t *)&v13, 0xCu);
...
void __111__HMDAccessorySettingsMessenger_sendFetchAccessorySettingsRequestWithAccessoryUUID_keyPaths_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7430]), "initWithPayload:", v6);
    ...
    if (v7)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v12;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Send fetch request responded", (uint8_t *)&v22, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 2112;
        v25 = v6;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode fetch request response payload: %@", (uint8_t *)&v22, 0x16u);

      }
      objc_autoreleasePoolPop(v8);
      v13 = *(_QWORD *)(a1 + 48);
      objc_msgSend(MEMORY[0x24BDD7410], "fetchResultsWithKeyPaths:failureType:", *(_QWORD *)(a1 + 40), 3);
      v14 = objc_claimAutoreleasedReturnValue();
    }
    v21 = (void *)v14;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v5;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Send fetch request responded with error: %@", (uint8_t *)&v22, 0x16u);

    }
    objc_autoreleasePoolPop(v15);
    v19 = *(_QWORD *)(a1 + 48);
    objc_msgSend(MEMORY[0x24BDD7410], "fetchResultsWithKeyPaths:failureType:", *(_QWORD *)(a1 + 40), 0);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_226107 != -1)
    dispatch_once(&logCategory__hmf_once_t11_226107, &__block_literal_global_226108);
  return (id)logCategory__hmf_once_v12_226109;
}
...
void __44__HMDAccessorySettingsMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_226109;
  logCategory__hmf_once_v12_226109 = v0;
