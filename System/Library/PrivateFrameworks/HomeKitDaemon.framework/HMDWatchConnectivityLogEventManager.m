...
- (HMDWatchConnectivityLogEventManager)init
{
  ...
  if (v2)
  {
    v3 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 13, 86400.0);
...
- (void)completeCurrentReport
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@WatchConnectivityLogEventManagerTimer fired: Watch added: %lu Watch removed: %lu reportComplete: %d", (uint8_t *)&v11, 0x26u);
...
{
  if (sharedInstance_onceToken_79593 != -1)
    dispatch_once(&sharedInstance_onceToken_79593, &__block_literal_global_79594);
