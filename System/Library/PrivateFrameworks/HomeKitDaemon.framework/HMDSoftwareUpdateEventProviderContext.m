...
- (void)forwardEvent:(id)a3 withTopicSuffixID:(unint64_t)a4
{
  ...
  if (v8 && v10)
  {
    objc_msgSend(MEMORY[0x24BDD73A0], "topicFromSuffixID:homeUUID:accessoryUUID:", a4, v10, v8);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v28 = 2112;
        v29 = v8;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get topic with suffix: %ld, homeUUID: %@, accessoryUUID: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v26 = 2112;
      v27 = v8;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nil value in homeUUID: %@, accessoryUUID: %@", buf, 0x20u);
...
- (id)lastEventForTopicSuffixID:(unint64_t)a3
{
  ...
  if (v6 && v8)
  {
    objc_msgSend(MEMORY[0x24BDD73A0], "topicFromSuffixID:homeUUID:accessoryUUID:", a3, v8, v6);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if (v10)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get topic with suffix: %ld, homeUUID: %@, accessoryUUID: %@", (uint8_t *)&v17, 0x2Au);
...
void __72__HMDSoftwareUpdateEventProviderContext_forwardEvent_withTopicSuffixID___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error in forwarding the event: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_81164 != -1)
    dispatch_once(&logCategory__hmf_once_t4_81164, &__block_literal_global_81165);
  return (id)logCategory__hmf_once_v5_81166;
}
...
void __52__HMDSoftwareUpdateEventProviderContext_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_81166;
  logCategory__hmf_once_v5_81166 = v0;
