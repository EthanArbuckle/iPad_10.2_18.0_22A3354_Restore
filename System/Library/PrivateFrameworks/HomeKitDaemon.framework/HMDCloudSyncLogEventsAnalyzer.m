...
- (HMDCloudSyncLogEventsAnalyzer)initWithDataSource:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v20, 10);
...
- (void)didReceiveEventFromDispatcher:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    v38 = objc_opt_class();
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@[CloudSyncLogEventsAnalyzer] Processing Cloud Event: %@", buf, 0x16u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v37 = 2112;
                  v38 = v31;
                  _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Event class: %@ matched none of the handlers in HMDCloudSyncLogEventsAnalyzer", buf, 0x16u);
...
- (void)handleUploadReasonLogEvent:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@[HMDCloudSyncLogEventsAnalyzer] Received upload reason: %{public}@ Count for legacy: %ld homeZone: %ld homeManager: %ld", (uint8_t *)&v15, 0x34u);
