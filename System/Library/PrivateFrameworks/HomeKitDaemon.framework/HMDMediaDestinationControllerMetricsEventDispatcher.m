...
- (void)startStagedDestinationIdentifierCommittedEventWithStagedDestinationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Tracking staged destination identifier: %@", (uint8_t *)&v13, 0x16u);
...
- (void)submitStagedDestinationIdentifierCommittedEventWithCommittedDestinationIdentifier:(id)a3
{
    ...
    && (-[HMDMediaDestinationControllerStagedDestinationIdentifierCommittedEvent stagedDestinationIdentifier](v5, "stagedDestinationIdentifier"), v7 = (void *)objc_claimAutoreleasedReturnValue(), v8 = HMFEqualObjects(), v7, (v8 & 1) != 0))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@submitting staged destination identifier committed event with committed destination identifier: %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Skipping staged destination identifier committed event due to out-dated information", (uint8_t *)&v19, 0xCu);
...
- (void)submitDailySetDestinationEvent
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 138543362;
    v21 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Submitting daily set destination event", (uint8_t *)&v20, 0xCu);
...
- (id)dataSourceCurrentUser
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current user from data source: %@", (uint8_t *)&v10, 0x16u);
...
- (id)dataSourceCurrentDestinationType
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current destination type due to no data source", (uint8_t *)&v13, 0xCu);
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination type due to no data source", (uint8_t *)&v13, 0xCu);
...
- (id)dataSourceIsTriggeredOnControllerDevice
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get is triggered on controller device due to no data source", (uint8_t *)&v11, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_59844 != -1)
    dispatch_once(&logCategory__hmf_once_t12_59844, &__block_literal_global_59845);
  return (id)logCategory__hmf_once_v13_59846;
}
...
void __66__HMDMediaDestinationControllerMetricsEventDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_59846;
  logCategory__hmf_once_v13_59846 = v0;
