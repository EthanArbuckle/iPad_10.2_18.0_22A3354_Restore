...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDRemoteDeviceReachabilityChangeLogEvent reachable](self, "reachable"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDRemoteDeviceReachabilityChangeLogEvent targetSupportsIDSPresence](self, "targetSupportsIDSPresence"));
