...
- (void)requestBackoff
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Backoff requested", buf, 0xCu);
...
- (void)clearBackoff
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Backoff cleared", buf, 0xCu);
...
- (void)scanner:(id)a3 didUpdateDevice:(id)a4
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v20[22] = 2112;
      v21 = v9;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating WAC device: %@ -> %@", v20, 0x20u);
...
- (void)scanner:(id)a3 didError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Error while scanning for WAC devices: %@", (uint8_t *)&v12, 0x16u);
...
- (void)scannerDidStop:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@WAC Scan Stopped...", buf, 0xCu);
  ...
  if (-[HMDWACBrowser scanIsActive](v6, "scanIsActive"))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2048;
      v19 = 2;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Scan was still flagged as active, restarting after %lu seconds...", buf, 0x16u);
...
uint64_t __44__HMDWACBrowser_startBrowsingForAccessories__block_invoke(uint64_t a1)
{
  ...
  if ((result & 1) == 0)
  {
    v3 = (void *)MEMORY[0x227676638](objc_msgSend(*(id *)(a1 + 32), "setScanIsActive:", 1));
    v4 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    v5 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Activating WAC Scanner...", (uint8_t *)&v7, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_151265 != -1)
    dispatch_once(&logCategory__hmf_once_t9_151265, &__block_literal_global_151266);
  return (id)logCategory__hmf_once_v10_151267;
}
...
void __28__HMDWACBrowser_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_151267;
  logCategory__hmf_once_v10_151267 = v0;
