...
- (void)_registerForMessages:(id)a3 withHome:(id)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v29 = 2112;
    v30 = v22;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "Registering for messages with user privilege: (exists: %d) %@", (uint8_t *)v28, 0x12u);
...
- (void)_registerForAccessoryMessages:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "na_firstObjectPassingTest:", &__block_literal_global_99_99444);
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)&v38[14] = v7 != 0;
    v39 = 2112;
    v40 = v14;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "Registering for accessory messages %@, user privilege: (exists: %d) %@", v38, 0x1Cu);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v32 = 2112;
      v33 = v17;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "Responding to %@ with message size: %@, fragment: 0", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v32 = 2112;
      v33 = v24;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEFAULT, "Responding to %@ with message size: %@", buf, 0x16u);
...
- (BOOL)isErrorHMENotAcceptingConnections:(id)a3
{
  ...
  if (objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BE4ED68]))
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@user UUID missed", buf, 0xCu);
...
- (void)_handleRequestMessage:(id)a3 connectionMode:(int64_t)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v25 = 2112;
    v26 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "Handle request message: %@ connection mode: %@", buf, 0x16u);
  ...
  if (!v12)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "Did not find message payload.", buf, 2u);
    }
  ...
  if (!v14)
  {
    if (!v15)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEFAULT, "No payload from fragment message", buf, 2u);
      }
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      v24 = v15;
      _os_log_error_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "Could not decode payload from fragment message %@", buf, 0xCu);
    }
LABEL_23:
...
LABEL_11:
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "Decoded payload does not have request.", buf, 2u);
    }
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleProtoRequest:(id)a3 originalMessage:(id)a4 connectionMode:(int64_t)a5
{
  ...
  switch(objc_msgSend(v8, "request"))
  {
    case 0u:
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, logger, OS_LOG_TYPE_ERROR, "Unable to find request type.", buf, 2u);
      }
...
LABEL_15:
    ...
    default:
      ...
      {
        *(_WORD *)v17 = 0;
        _os_log_error_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "Received an unrecognized request type.", v17, 2u);
      }
      v11 = (void *)MEMORY[0x24BDD1540];
      v12 = -1;
LABEL_8:
...
- (void)_handleConnectRequest:(id)a3 originalMessage:(id)a4 connectionMode:(int64_t)a5
{
  ...
  void *v21;
  void *v22;
  HMDRemoteEventRouterServerConnection *v23;
  NSObject *v24;
  void *v25;
  int v26;
  NSObject *v27;
  ...
  void *v34;
  NSObject *v35;
  HMDRemoteEventRouterServerConnection *v36;
  void *v37;
  void *v38;
  void *v39;
  void *v40;
  ...
  id v48;
  void *v49;
  HMDRemoteEventRouterServerConnection *v50;
  void *v51;
  int v52;
  void *v53;
  id v54;
  ...
  id v61;
  id v62;
  HMDRemoteEventRouterServerConnection *v63;
  int64_t v64;
  _QWORD v65[4];
  id v66;
  uint8_t buf[4];
  HMDRemoteEventRouterServerConnection *v68;
  uint64_t v69;
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v15
    || (!self ? (v16 = 0) : (v16 = objc_getProperty(self, v14, 40, 1)),
...
LABEL_12:
    ...
    if (!v19 || !v20)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, logger, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
    ...
    if (!v21)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "Could not find user for incoming request.", buf, 2u);
      }
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 2);
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "respondWithError:", v31);
      goto LABEL_48;
    }
    v52 = v17;
    ...
    v23 = (HMDRemoteEventRouterServerConnection *)objc_claimAutoreleasedReturnValue();
...
LABEL_37:
        ...
        {
          v37 = (void *)MEMORY[0x24BE4ED88];
          objc_msgSend(v8, "connectEvent");
          v38 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v37, "fromProtobuff:", v38);
        ...
        {
          v39 = (void *)MEMORY[0x24BE4ED88];
          objc_msgSend(v8, "unregisterEvent");
          v40 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v39, "fromProtobuff:", v40);
        ...
        if (v43)
        {
          ...
          objc_msgSend(v45, "na_map:", &__block_literal_global_116_99422);
          v46 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v41, "addObjectsFromArray:", v46);

        }
        if (self)
          v47 = objc_getProperty(self, v44, 104, 1);
        else
          v47 = 0;
        v48 = v47;
        v49 = (void *)objc_msgSend(v41, "copy");
        ...
        v63 = v56;
        v50 = v56;
        objc_msgSend(v48, "connectWithConnection:connectEvent:unregisterEvent:topicFilterAdditions:completion:", v50, v53, v51, v49, v59);
...
LABEL_49:
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v68 = v23;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_DEFAULT, "Connection mode is different remove existing %@", buf, 0xCu);
      }
      -[HMDRemoteEventRouterServer currentConnections](self, "currentConnections");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v56 = -[HMDRemoteEventRouterServerConnection initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:]([HMDRemoteEventRouterServerConnection alloc], "initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:", v19, v57, objc_msgSend(v10, "BOOLForKey:", CFSTR("isFragmented")));
    if (v57 == 1)
    {
      v27 = self->_logger;
      v26 = v52;
...
LABEL_33:
        ...
        objc_msgSend(v32, "addObject:", v56);
        ...
        if (os_signpost_enabled(v33))
        {
          ...
          v35 = v33;
          objc_msgSend(v34, "numberWithInteger:", v57);
          v36 = (HMDRemoteEventRouterServerConnection *)objc_claimAutoreleasedReturnValue();
          *(_DWORD *)buf = 138412290;
          v68 = v36;
          _os_signpost_emit_with_name_impl(&dword_2218F0000, v35, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterServerConnectionCreated", "connectionMode=%{signpost.description:attribute}@ ", buf, 0xCu);

          v13 = v55;
        }
        if (v26)
        {
          objc_msgSend(v13, "markSetupEndStage:error:", 15, 0);
          objc_msgSend(v13, "markSetupBeginStage:error:", 16, 0);
        }
        goto LABEL_37;
      }
      *(_DWORD *)buf = 138412290;
      v68 = v56;
      v28 = "Created resident connection %@";
    }
    else
    {
      v26 = v52;
      ...
      *(_DWORD *)buf = 138412290;
      v68 = v56;
      v28 = "Created primary client connection %@";
    }
    _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_DEFAULT, v28, buf, 0xCu);
    goto LABEL_33;
  }
  objc_msgSend(v13, "markSetupBeginStage:error:", 15, 0);
  v17 = 1;
  if (v8)
    goto LABEL_12;
LABEL_8:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "Did not find connect request in payload.", buf, 2u);
  }
  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)refreshConnections:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Refresh connections for user:%@", buf, 0x16u);
...
- (void)_handleDisconnectRequest:(id)a3 originalMessage:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v10 && v11)
    {
      ...
      else
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_error_impl(&dword_2218F0000, logger, OS_LOG_TYPE_ERROR, "No connection was found to disconnect.", buf, 2u);
        }
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 2);
        v21 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 2);
      v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "Did not find disconnect request in payload.", buf, 2u);
    }
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleChangeRegistrationsRequest:(id)a3 originalMessage:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v9 && v10)
    {
      ...
      if (v14)
      {
        ...
        objc_msgSend(v28, "na_map:", &__block_literal_global_127);
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v6, "topicFilterRemovals");
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v19, "na_map:", &__block_literal_global_128_99400);
        v20 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          v40 = 2112;
          v41 = v13;
          _os_log_error_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "No connection was found during change registrations request in current connections: %@ device identifier: %@", buf, 0x16u);
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 2);
      v24 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "Did not change registrations request in payload.", buf, 2u);
    }
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleKeepAliveRequest:(id)a3 originalMessage:(id)a4
{
  ...
  if (v6)
  {
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          v30 = 2112;
          v31 = v14;
          _os_log_error_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "No connection was found for keep alive request in current connections: %@ device identifier: %@", buf, 0x16u);
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 2);
      v20 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "Did not keep-alive request in payload.", buf, 2u);
    }
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "respondWithError:", v9);
...
- (void)_handleFetchEventsRequest:(id)a3 originalMessage:(id)a4 connectionMode:(int64_t)a5
{
  ...
  if (v8)
  {
    ...
    if (v12 && v13)
    {
      if (self && self->_isResidentEventProviding)
      {
              ...
              (v17 = objc_claimAutoreleasedReturnValue()) != 0))
        {
          ...
          if (v20)
          {
            ...
            v23 = objc_alloc_init(MEMORY[0x24BE4EDC8]);
            ...
            if ((v22 & 1) != 0)
            {
              ...
              v28 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v28, "na_map:", &__block_literal_global_139_99386);
              v29 = (void *)objc_claimAutoreleasedReturnValue();
              -[HMDRemoteEventRouterServer logMetricsForLiveEvents:cachedEvents:destinationDevice:destinationDeviceIdentifier:responseMessageType:](self, "logMetricsForLiveEvents:cachedEvents:destinationDevice:destinationDeviceIdentifier:responseMessageType:", MEMORY[0x24BDBD1A8], v28, v12, v14, 1);
          ...
          else
          {
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_error_impl(&dword_2218F0000, logger, OS_LOG_TYPE_ERROR, "Got a fetch request with no topics.", buf, 2u);
            }
            objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
        ...
        else
        {
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_error_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "Could not find user for incoming request.", buf, 2u);
          }
          objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 2);
          v18 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "Could not process fetch as non-resident event providing device.", buf, 2u);
      }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
      v39 = (void *)MEMORY[0x24BDD1540];
      v40 = 2;
    }
...
LABEL_37:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "Did not find fetch request in payload.", buf, 2u);
  }
  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)server:(id)a3 shouldProcessEventsForConnection:(id)a4 shouldLogState:(BOOL)a5
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v36 = 2112;
    v37 = WeakRetained;
    _os_log_impl(&dword_2218F0000, logger, OS_LOG_TYPE_DEFAULT, "Checking if server should process events for connection: %@, dataSource: %@", (uint8_t *)&v34, 0x16u);
  }
LABEL_5:
  v14 = v10;
  objc_opt_class();
    ...
    if (v20)
    {
      ...
      if (!-[HMDRemoteEventRouterServer isPrimaryResident]((os_unfair_lock_s *)self) || !v23)
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v40 = 2112;
          v41 = v20;
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for resident connection mode. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", (uint8_t *)&v34, 0x2Au);
      ...
      if (v5)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v38 = 2112;
          v39 = v20;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "Not allowing connection while both devices are known as primary, this should resolve shortly. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", (uint8_t *)&v34, 0x20u);
...
LABEL_33:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 138412290;
        v35 = v26;
        _os_log_error_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "Unexpectedly did not find device for resident. %@", (uint8_t *)&v34, 0xCu);
        goto LABEL_23;
      }
    }
LABEL_24:
...
LABEL_14:
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v34 = 138543362;
      v35 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for primary connection mode.", (uint8_t *)&v34, 0xCu);
LABEL_32:
  ...
  if (-[HMDRemoteEventRouterServer isPrimaryResident]((os_unfair_lock_s *)self))
  {
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v25 = v15;
        _os_log_impl(&dword_2218F0000, logger, OS_LOG_TYPE_DEFAULT, "Notifying on connecting to primary %@", buf, 0xCu);
      }
...
- (void)server:(id)a3 connectionDidExpire:(id)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    v8 = 138412290;
    v9 = v5;
    _os_log_error_impl(&dword_2218F0000, logger, OS_LOG_TYPE_ERROR, "Removing connection on expiry %@", (uint8_t *)&v8, 0xCu);
  }
  -[HMDRemoteEventRouterServer currentConnections](self, "currentConnections");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)server:(id)a3 connectionDidFail:(id)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    v8 = 138412290;
    v9 = v5;
    _os_log_error_impl(&dword_2218F0000, logger, OS_LOG_TYPE_ERROR, "Removing connection on error %@", (uint8_t *)&v8, 0xCu);
  }
  -[HMDRemoteEventRouterServer currentConnections](self, "currentConnections");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "removeObject:", v5);
...
- (void)server:(id)a3 sendEvents:(id)a4 cachedEvents:(id)a5 connection:(id)a6 completion:(id)a7
{
  ...
  objc_msgSend(v11, "na_map:", &__block_literal_global_149);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v12, "na_map:", &__block_literal_global_150);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v27)
  {
    ...
    if (v28)
    {
      ...
      if (v32)
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412290;
          v47 = v37;
          _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_DEFAULT, "Sending events of size: %@", buf, 0xCu);
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v47 = v11;
          _os_log_debug_impl(&dword_2218F0000, logger, OS_LOG_TYPE_DEBUG, "Sending events: %@", buf, 0xCu);
        }
        -[HMDRemoteEventRouterProtoServerMessage data](v15, "data");
        v38 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_error_impl(&dword_2218F0000, v43, OS_LOG_TYPE_ERROR, "Could not create destination", buf, 2u);
        }
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138412290;
        v47 = v25;
        _os_log_error_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "Device no longer available %@", buf, 0xCu);
      }
      v29 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      v47 = v25;
      _os_log_error_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "Could not find remote connection for connection %@", buf, 0xCu);
    }
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 3);
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    v14[2](v14, v29);
...
- (BOOL)shouldAllowEvent:(id)a3 topic:(id)a4 connection:(id)a5
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v36 = 2112;
    v37 = v7;
    _os_log_debug_impl(&dword_2218F0000, logger, OS_LOG_TYPE_DEBUG, "Checking access control connection: %@, topic: %@", buf, 0x16u);
  }
  os_unfair_lock_lock_with_options();
  ...
  if (v10)
  {
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138412290;
        v35 = v10;
        _os_log_error_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "Could not find user ACL provider for %@", buf, 0xCu);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v36 = 2112;
        v37 = v8;
        _os_log_debug_impl(&dword_2218F0000, v28, OS_LOG_TYPE_DEBUG, "No device when attempting to check access control for %@ to %@", buf, 0x16u);
      }
    }
    v26 = 0;
LABEL_26:
...
- (void)configureWithHome:(id)a3 isPrimaryResident:(BOOL)a4 isResidentEventProviding:(BOOL)a5 additionalPolicies:(id)a6
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v19 = 2112;
    v20 = v16;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "Configuring on device isPrimaryResident. %@ isResidentEventProviding: %@", (uint8_t *)&v17, 0x16u);
...
- (id)diagnosticInfo
{
  ...
  v26 = *MEMORY[0x24BDAC8D0];
  v3 = objc_alloc_init(MEMORY[0x24BDD7908]);
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v13 = objc_alloc_init(MEMORY[0x24BDD7900]);
          if (v12)
            v14 = *(void **)(v12 + 16);
          else
            v14 = 0;
...
LABEL_15:
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, v31, buf, 0x16u);
...
LABEL_16:
  ...
  if (v7)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "na_map:", &__block_literal_global_159);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Fetch collection completed with %ld items.", buf, 0x16u);
    ...
    v38[1] = 3221225472;
    v38[2] = __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_160;
    v38[3] = &unk_24E79BD80;
    v38[4] = *(_QWORD *)(a1 + 32);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = v5;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Device no longer available %@", buf, 0x16u);
...
void __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_160(uint64_t a1, void *a2)
{
  __CFString *v3;
  void *v4;
  id v5;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v10;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Fetch collection response completed with %@%@", (uint8_t *)&v11, 0x20u);
...
uint64_t __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_158(uint64_t a1, void *a2)
{
...
uint64_t __81__HMDRemoteEventRouterServer_responseHandlerForSendMessageIdentifier_completion___block_invoke_2(_QWORD *a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v2;
      _os_log_error_impl(&dword_2218F0000, v4, OS_LOG_TYPE_ERROR, "Failed to send message: %@ error: %@", (uint8_t *)&v14, 0x16u);
    }
  }
  else
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT)
      && (v6 = a1[6],
          v14 = 138412290,
          v15 = v6,
          _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "Successfully sent message: %@", (uint8_t *)&v14, 0xCu), (v3 = a1[5]) == 0))
    {
      WeakRetained = 0;
    }
    else
    ...
    {
      v11 = (void *)a1[5];
      v12 = v11 ? objc_getProperty(v11, v9, 40, 1) : 0;
      if (objc_msgSend(v10, "hmf_isEqualToUUID:", v12))
        objc_msgSend(v8, "markSetupEndStage:error:", 16, a1[4]);
    }
...
id __87__HMDRemoteEventRouterServer__handleFetchEventsRequest_originalMessage_connectionMode___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ((objc_msgSend(v3, "hasTopic") & 1) == 0)
  {
    ...
    {
      *(_WORD *)v9 = 0;
      _os_log_error_impl(&dword_2218F0000, v4, OS_LOG_TYPE_ERROR, "No topic found!", v9, 2u);
    }
  }
  v5 = (void *)MEMORY[0x24BE3F208];
...
void __80__HMDRemoteEventRouterServer__handleChangeRegistrationsRequest_originalMessage___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    objc_msgSend(a2, "na_map:", &__block_literal_global_129_99402);
    v6 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "na_map:", &__block_literal_global_130_99403);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 40), "logMetricsForLiveEvents:cachedEvents:destinationDevice:destinationDeviceIdentifier:responseMessageType:", MEMORY[0x24BDBD1A8], v6, *(_QWORD *)(a1 + 56), *(_QWORD *)(a1 + 64), 3);
...
void __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    objc_msgSend(v16, "na_map:", &__block_literal_global_119);
    v7 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "na_map:", &__block_literal_global_121);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "logMetricsForLiveEvents:cachedEvents:destinationDevice:destinationDeviceIdentifier:responseMessageType:", MEMORY[0x24BDBD1A8], v7, *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 56), 2);
  ...
  if (objc_msgSend(v9, "count"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v22 = 2112;
      v23 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Removing connections: %@ due to removed user: %@", buf, 0x20u);
...
os_unfair_lock_s *__85__HMDRemoteEventRouterServer_handlePrimaryResidentIsCurrentDeviceChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if ((_DWORD)v4 != (_DWORD)result)
  {
    ...
    v15 = 138412290;
    v16 = v10;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "Primary resident status changed to %@", (uint8_t *)&v15, 0xCu);
...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x24BE4EDB0]), "initWithQueue:provider:registrationEventRouter:storeReadHandle:logCategory:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 56), objc_msgSend(objc_retainAutorelease(*(id *)(a1 + 64)), "UTF8String"));
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t4_99473 != -1)
    dispatch_once(&logCategory__hmf_once_t4_99473, &__block_literal_global_99474);
  return (id)logCategory__hmf_once_v5_99475;
}
...
void __41__HMDRemoteEventRouterServer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_99475;
  logCategory__hmf_once_v5_99475 = v0;
