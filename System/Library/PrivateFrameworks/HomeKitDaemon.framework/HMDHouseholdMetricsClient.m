...
- (id)handleRequestMessageWithPayload:(id)a3 outError:(id *)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v45 = 2112;
    v46 = v6;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Processing request, payload=%@", buf, 0x16u);
  ...
  if ((v12 & 1) != 0)
  {
    ...
    if (v16)
      v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v16);
    else
      v17 = 0;
    ...
    if (v17 && v25)
    {
      ...
      v27 = v13;
      v42 = v27;
      v28 = (void *)MEMORY[0x227676638](objc_msgSend(v26, "enumerateKeysAndObjectsUsingBlock:", v41));
      v29 = v8;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = (const char *)v27;
        _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Responding with payload=%@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2080;
        v46 = v37;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Missing %s in request, responding with error", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v32);
      if (a4)
      {
        objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BE3EBB0], 20, 0);
        v22 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v44 = (uint64_t)v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@DNU disabled, responding with error", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v18);
    if (a4)
    {
      objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BE3EBB0], 17, 0);
      v22 = 0;
      *a4 = (id)objc_claimAutoreleasedReturnValue();
    }
    else
...
void __70__HMDHouseholdMetricsClient_handleRequestMessageWithPayload_outError___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v8 && (objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (v9)
    {
      if ((objc_msgSend(MEMORY[0x24BDD1770], "propertyList:isValidForFormat:", v9, 200) & 1) != 0)
      {
...
LABEL_13:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    v23 = 2114;
    v24 = v5;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Dropping %{public}@ because it's factory doesn't serialize", (uint8_t *)&v21, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_239645 != -1)
    dispatch_once(&logCategory__hmf_once_t9_239645, &__block_literal_global_19_239646);
  return (id)logCategory__hmf_once_v10_239647;
}
...
void __40__HMDHouseholdMetricsClient_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_239647;
  logCategory__hmf_once_v10_239647 = v0;
