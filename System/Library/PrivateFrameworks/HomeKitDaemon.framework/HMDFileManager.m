...
{
  return (id)objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfURL:options:error:", a3, a4, a5);
}
...
- (BOOL)zipItemAtURL:(id)a3 toURL:(id)a4 error:(id *)a5
{
  ...
  if (v9)
  {
    v14 = *MEMORY[0x24BEB2CD8];
    v15[0] = *MEMORY[0x24BEB2CC8];
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v15, &v14, 1, 0, 0, 0, 0, 0, v9, 0, 0, 0, 0, 0, 0, 0);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)JSONObjectWithURL:(id)a3 error:(id *)a4
{
  ...
  v5 = (objc_class *)MEMORY[0x24BDBCE90];
  v6 = a3;
  ...
  if (v7)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1608], "JSONObjectWithStream:options:error:", v7, 0, a4);
...
- (BOOL)writeJSONObject:(id)a3 toURL:(id)a4 error:(id *)a5
{
  ...
  v7 = a3;
  v8 = (objc_class *)MEMORY[0x24BDBCF08];
  v9 = a4;
  ...
  if (v10)
  {
    ...
    v11 = objc_msgSend(MEMORY[0x24BDD1608], "writeJSONObject:toStream:options:error:", v7, v10, 1, a5) != 0;
  }
  else if (a5)
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmfErrorWithCode:", 2);
...
{
  return (id)objc_msgSend(MEMORY[0x24BDD1578], "fileHandleForReadingFromURL:error:", a3, a4);
}
