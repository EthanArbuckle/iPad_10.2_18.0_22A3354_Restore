...
- (HMDDataStream)initWithTransport:(id)a3 sessionEncryption:(id)a4 workQueue:(id)a5 logIdentifier:(id)a6
{
  ...
  v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 0, 10.0);
...
- (void)setActive:(BOOL)a3
{
  ...
  if (self->_active != v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@DataStream changes active to %@", (uint8_t *)&v12, 0x16u);
...
- (void)connect
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@DataStream connecting", (uint8_t *)&v12, 0xCu);
...
- (void)close
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v20 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@DataStream closing", buf, 0xCu);
...
- (void)sendEventForProtocol:(id)a3 topic:(id)a4 payload:(id)a5 completion:(id)a6
{
  ...
  if (-[HMDDataStream firstMessageReceived](self, "firstMessageReceived"))
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1062);
      v15 = (HMDDataStreamPendingEvent *)objc_claimAutoreleasedReturnValue();
...
- (void)setTrafficClass:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2048;
    v13 = a3;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting traffic class %lu on transport", (uint8_t *)&v10, 0x16u);
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v7;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Data stream failure (%@)", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v7;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Data stream failure (%@); but no delegate",
        buf,
        0x16u);
...
- (void)transportDidClose:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream closed", buf, 0xCu);
  ...
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream closed (but no delegate!)", buf, 0xCu);
...
- (void)transportDidOpen:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream OPEN!", buf, 0xCu);
  ...
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream OPEN (but no delegate!)", buf, 0xCu);
...
- (void)transport:(id)a3 didReceiveRawFrame:(id)a4
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v150 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Data stream received frame", buf, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v150 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Data stream received frame; but no delegate",
        buf,
        0xCu);
...
LABEL_27:
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v151 = 2112;
            v152 = v33;
            _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@DataStream dropping incoming message (%@)", buf, 0x16u);
...
LABEL_121:
          ...
          if (!v61)
          {
            ...
            if (os_log_type_enabled(v110, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v150 = v111;
              _os_log_impl(&dword_2218F0000, v110, OS_LOG_TYPE_INFO, "%{public}@DataStream dropping incoming message (header missing protocol)", buf, 0xCu);
...
LABEL_117:
            ...
            if (os_log_type_enabled(v126, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v150 = v127;
              _os_log_impl(&dword_2218F0000, v126, OS_LOG_TYPE_INFO, "%{public}@Message received but no protocol accepted it; dropped!",
                buf,
                0xCu);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v120, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v151 = 2112;
              v152 = v61;
              _os_log_impl(&dword_2218F0000, v120, OS_LOG_TYPE_INFO, "%{public}@DataStream dropping incoming message (no protocol named %@)", buf, 0x16u);
...
LABEL_72:
              ...
              if (v10)
              {
                ...
                if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
                {
                  ...
                  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v76, "count"));
                  v78 = (void *)objc_claimAutoreleasedReturnValue();
                  *(_DWORD *)v155 = 138543618;
                  v156 = v77;
                  v157 = 2112;
                  v158 = v78;
                  _os_log_impl(&dword_2218F0000, v75, OS_LOG_TYPE_INFO, "%{public}@Sending out all pending requests [%@]", v155, 0x16u);
                ...
                if (os_log_type_enabled(v94, OS_LOG_TYPE_INFO))
                {
                  ...
                  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v91, "count"));
                  v96 = (void *)objc_claimAutoreleasedReturnValue();
                  *(_DWORD *)v155 = 138543618;
                  v156 = v95;
                  v157 = 2112;
                  v158 = v96;
                  _os_log_impl(&dword_2218F0000, v94, OS_LOG_TYPE_INFO, "%{public}@Sending out all pending events [%@]", v155, 0x16u);
...
LABEL_69:
            ...
            if (os_log_type_enabled(v68, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v150 = v69;
              _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_ERROR, "%{public}@Received unexpected first message on the data stream", buf, 0xCu);
          ...
          if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v153 = 2112;
            v154 = v49;
            _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_ERROR, "%{public}@Received unexpected %@ key value: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v153 = 2112;
            v154 = v46;
            _os_log_impl(&dword_2218F0000, v56, OS_LOG_TYPE_ERROR, "%{public}@Expected protocol name: %@ received: %@", buf, 0x20u);
...
LABEL_68:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v150 = v27;
    _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@DataStream dropping truncated frame of zero-length", buf, 0xCu);
...
LABEL_16:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v44 = 2112;
    v45 = v26;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@No pending request found for response with header: %@. Pending %@", buf, 0x20u);
...
void __65__HMDDataStream_sendRequestForProtocol_topic_payload_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v12 = 2112;
      v13 = v4;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEBUG, "%{public}@DataStream pending the request: %@", (uint8_t *)&v10, 0x16u);
    ...
    if (v13)
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v26 = 2112;
        v27 = v13;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@DataStream encoding message failed (%@)", buf, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v28 = 2112;
        v29 = v20;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@DataStream Sending Message: %@ --> %@", buf, 0x20u);
