  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v19 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Invalid inputs for HMFWoWLANInfo.", buf, 0xCu);
...
- (HMFWoWLANInfo)initWithWakeVersion:(unsigned __int8)a3 wakePort:(unsigned __int16)a4 wakeAddress:(id)a5 wakeType:(int64_t)a6 wakePacketType:(int64_t)a7 wakePattern:(id)a8
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid wake address", buf, 0xCu);
...
- (NSString)wakeAddressString
{
    ...
    && -[HMFWoWLANInfo wakePacketType](self, "wakePacketType") == 1)
  {
    ...
    if (v3)
    {
      v4 = objc_alloc(MEMORY[0x24BE3F1A0]);
      -[HMFWoWLANInfo wakeAddress](self, "wakeAddress");
      v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_18:
              ...
              while (*(unsigned __int8 *)(v14 + v16) == v20[v16])
              {
                if (++v16 == 6)
                {
                  ...
                  if (v15 != 16)
                    goto LABEL_18;
                  v17 = objc_alloc(MEMORY[0x24BE3F1A0]);
                  objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", v20, 6);
                  v18 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)description
{
  ...
  if (v3)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", -[HMFWoWLANInfo version](self, "version"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMFWoWLANInfo wakeType](self, "wakeType"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", -[HMFWoWLANInfo wakePort](self, "wakePort"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMFWoWLANInfo wakeAddressString](self, "wakeAddressString");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMFWoWLANInfo wakePacketType](self, "wakePacketType"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
