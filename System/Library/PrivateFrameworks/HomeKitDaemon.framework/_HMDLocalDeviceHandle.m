...
- (_HMDLocalDeviceHandle)initWithDeviceIdentifier:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing device identifier parameter", (uint8_t *)&v14, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v30 = 2112;
        v31 = v7;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to parse destination, %@, with error: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v19;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Missing destination parameter", buf, 0xCu);
