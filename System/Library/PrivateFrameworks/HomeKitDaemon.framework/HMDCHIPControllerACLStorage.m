...
- (NSDictionary)debugDictionaryRepresentation
{
  ...
  -[HMDCHIPControllerACLStorage keyValueStore](self, "keyValueStore");
...
- (BOOL)updateUsingHomeModel:(id)a3
{
  id v4;
  void *v5;
  HMDCHIPControllerACLStorage *v6;
  NSObject *v7;
  void *v8;
  int v10;
  void *v11;
...
{
  HMDCHIPControllerACLStorage *v4;
  void *v5;

  v4 = -[HMDCHIPControllerACLStorage init](+[HMDCHIPControllerACLStorage allocWithZone:](HMDCHIPControllerACLStorage, "allocWithZone:", a3), "init");
  -[HMDCHIPControllerACLStorage keyValueStore](self, "keyValueStore");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDCHIPControllerACLStorage setKeyValueStore:](v4, "setKeyValueStore:", v5);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_250159 != -1)
    dispatch_once(&logCategory__hmf_once_t3_250159, &__block_literal_global_250160);
  return (id)logCategory__hmf_once_v4_250161;
}
...
void __42__HMDCHIPControllerACLStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_250161;
  logCategory__hmf_once_v4_250161 = v0;
