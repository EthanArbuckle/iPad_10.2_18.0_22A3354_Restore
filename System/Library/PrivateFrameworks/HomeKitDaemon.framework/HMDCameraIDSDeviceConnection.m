...
LABEL_7:
  ...
  if (v13)
  {
    ...
    v14->_idsDeviceConnectionFactory = &__block_literal_global_61637;
...
- (void)_createStreamSocketWithDevice:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating stream sockets with device: %@", buf, 0x16u);
  ...
  if (v100)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v100;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Mapped HMDDevice to IDSDevice: %@", buf, 0x16u);
    ...
    *(_QWORD *)&buf[16] = 0x2020000000;
    ...
    v124[2] = 0x2020000000;
    v125 = 0;
    v91 = (void *)*MEMORY[0x24BE4FA18];
    v39 = *MEMORY[0x24BE4FA18];
    v93 = *MEMORY[0x24BE4FA28];
    v142[0] = *MEMORY[0x24BE4FA28];
    v142[1] = v39;
    v143[0] = &unk_24E96AE08;
    v143[1] = &unk_24E96AE20;
    v90 = *MEMORY[0x24BE4FA20];
    v142[2] = *MEMORY[0x24BE4FA20];
    v143[2] = v23;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v143, v142, 3);
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v137 = 138543618;
      ...
      v139 = 2112;
      v140 = v23;
      _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_INFO, "%{public}@Creating watch video connection with name: %@", v137, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v137 = 138543362;
        v138 = v52;
        _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video IDSDeviceConnection", v137, 0xCu);

      }
      objc_autoreleasePoolPop(v49);
      objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1021);
    ...
    v135[0] = v93;
    v135[1] = v91;
    v136[0] = &unk_24E96AE08;
    v136[1] = &unk_24E96AE38;
    v135[2] = v90;
    v136[2] = v97;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v136, v135, 3);
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v137 = 138543618;
      ...
      v139 = 2112;
      v140 = v97;
      _os_log_impl(&dword_2218F0000, v58, OS_LOG_TYPE_INFO, "%{public}@Creating watch audio connection with name: %@", v137, 0x16u);
    ...
    if (!v63)
    {
      ...
      if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v137 = 138543362;
        v138 = v66;
        _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio IDSDeviceConnection", v137, 0xCu);

      }
      objc_autoreleasePoolPop(context);
      objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1022);
    ...
    if (v63)
    {
      v132[0] = v93;
      v132[1] = v91;
      v133[0] = &unk_24E96AE50;
      v133[1] = &unk_24E96AE38;
      v132[2] = v90;
      v133[2] = v95;
      ...
      objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v131, 2);
      ...
      if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v137 = 138543618;
        ...
        v139 = 2112;
        v140 = v95;
        _os_log_impl(&dword_2218F0000, v72, OS_LOG_TYPE_INFO, "%{public}@Creating keep alive connection with name: %@", v137, 0x16u);
      ...
      if (!v77)
      {
        ...
        if (os_log_type_enabled(v79, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v137 = 138543362;
          v138 = v80;
          _os_log_impl(&dword_2218F0000, v79, OS_LOG_TYPE_ERROR, "%{public}@Failed to create keep alive IDSDeviceConnection", v137, 0xCu);

        }
        objc_autoreleasePoolPop(v92);
        objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1023);
...
LABEL_35:
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v34;
        _os_log_impl(&dword_2218F0000, v86, OS_LOG_TYPE_ERROR, "%{public}@Failed to create IDS connections: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v145 = v33;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Could not find IDSDevice matching IDS identifier %@. All devices: %@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v11);
    objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1020);
    v34 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)timerDidFire:(id)a3
{
  ...
  if (self)
  {
    ...
    if (objc_getProperty(self, v6, 80, 1) == _cmd)
    {
      ...
      if (v11 == -1)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v25 = 1024;
          v26 = v22;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Failed to send the sample data %d", buf, 0x12u);

        }
        objc_autoreleasePoolPop(v12);
        objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1025);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v27 = 2048;
        v28 = v11;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Data %u transfer is complete with total transferred bytes: %lu", buf, 0x1Cu);
    ...
    else
    {
      ...
      if (!v7)
        goto LABEL_14;
      objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1026);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
...
void __46__HMDCameraIDSDeviceConnection_startKeepAlive__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    v3 = objc_alloc(MEMORY[0x24BE3F298]);
  ...
  if (v12)
  {
    ...
    v17 = dispatch_source_create(MEMORY[0x24BDACA00], v14, 0, Property);
...
void __54__HMDCameraIDSDeviceConnection__setReceiveByteHandler__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v21 = 2048;
    v22 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Received keep-alive byte number %u with length %zd", buf, 0x1Cu);
  ...
  if (v3 < 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Recv from socket returned error, marking the stream as failure", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v9);
    objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1027);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (a2 == -1)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video connection: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v21 = 1024;
      v22 = a2;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Created watch video connection with name: %@ socket: %d", buf, 0x1Cu);
  ...
  if (a2 == -1)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio connection: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v21 = 1024;
      v22 = a2;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Created watch audio connection with name: %@ socket: %d", buf, 0x1Cu);
  ...
  if (a2 == -1)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create keep alive connection: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v21 = 1024;
      v22 = a2;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Created watch keep alive connection with name: %@ socket: %d", buf, 0x1Cu);
...
void __62__HMDCameraIDSDeviceConnection__createStreamSocketWithDevice___block_invoke_33(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    if (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 24))
    {
      if (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 64) + 8) + 24))
      {
        if (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 72) + 8) + 24))
        {
          ...
          v4 = (void *)MEMORY[0x227676638](objc_msgSend(v3, "setKeepAliveConnection:", *(_QWORD *)(a1 + 48)));
          v5 = v3;
          HMFGetOSLogHandle();
          v6 = objc_claimAutoreleasedReturnValue();
          if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
          {
            ...
            v24 = 138543362;
            v25 = v7;
            _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully created stream sockets", (uint8_t *)&v24, 0xCu);
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          v24 = 138543362;
          v25 = v22;
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to open keep alive socket", (uint8_t *)&v24, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          v24 = 138543362;
          v25 = v19;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to open video socket", (uint8_t *)&v24, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 138543362;
        v25 = v14;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to open audio socket", (uint8_t *)&v24, 0xCu);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    v24 = 138543362;
    v25 = v10;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Lost self while creating sockets", (uint8_t *)&v24, 0xCu);
...
id __82__HMDCameraIDSDeviceConnection_initWithSessionID_workQueue_idsProxyStreamService___block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  v8 = (objc_class *)MEMORY[0x24BE4FC08];
  v9 = a5;
  v10 = a4;
  v11 = a3;
  v12 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t25 != -1)
    dispatch_once(&logCategory__hmf_once_t25, &__block_literal_global_39_61646);
