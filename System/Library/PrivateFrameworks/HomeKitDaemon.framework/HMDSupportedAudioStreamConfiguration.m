...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1B9F0], "wrappertlv:name:objectCreator:", 1, CFSTR("kSupportedAudioStreamConfiguration_AudioCodecConfigurations"), &__block_literal_global_379);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 2, CFSTR("kSupportedAudioStreamConfiguration_ComfortNoise"));
