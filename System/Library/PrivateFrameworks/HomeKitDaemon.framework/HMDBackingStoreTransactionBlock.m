  ...
  if (-[HMDBackingStoreTransactionBlock committed](self, "committed"))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v56 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@adding to a committed transaction block probably indicates a bad state.", buf, 0xCu);
          ...
          if (v20)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v57 = 2112;
              v58 = v28;
              _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Just got request to add duplicate model object to transaction %@! (Both will be processed):", buf, 0x16u);
...
- (void)run:(id)a3
{
  ...
  objc_msgSend(v5, "commit:run:save:coreDataBlock:completionHandler:", self, 1, 1, 0, v4);
...
- (void)runWithoutSave:(id)a3
{
  ...
  -[HMDBackingStoreTransactionBlock backingStore](self, "backingStore");
  v5 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "commit:run:save:archiveInline:coreDataBlock:completionHandler:", self, 1, 0, 1, 0, v4);
...
- (void)runWithCoreDataBlock:(id)a3 withCompletionBlock:(id)a4
{
  ...
  objc_msgSend(v8, "commit:run:save:coreDataBlock:completionHandler:", self, 1, 1, v7, v6);
...
- (void)dumpWithVerbosity:(BOOL)a3 prefix:(id)a4 logType:(unsigned __int8)a5
{
  ...
  if (os_log_type_enabled(v9, (os_log_type_t)v5))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v37 = 2112;
    v38 = v12;
    _os_log_impl(&dword_2218F0000, v9, (os_log_type_t)v5, "%{public}@%@options: %@", buf, 0x20u);
      ...
      do
      {
        for (i = 0; i != v16; ++i)
        {
          ...
          if (v26)
            ...
            v22 = 0;
          objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@%@:"), v27, v21);
...
- (void)dumpDebug
{
  -[HMDBackingStoreTransactionBlock dumpDebug:](self, "dumpDebug:", &stru_24E79DB48);
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_202627 != -1)
    dispatch_once(&logCategory__hmf_once_t4_202627, &__block_literal_global_202628);
  return (id)logCategory__hmf_once_v5_202629;
}
...
void __46__HMDBackingStoreTransactionBlock_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_202629;
  logCategory__hmf_once_v5_202629 = v0;
