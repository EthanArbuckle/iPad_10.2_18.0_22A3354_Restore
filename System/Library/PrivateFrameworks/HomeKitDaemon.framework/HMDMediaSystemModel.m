        ...
        else
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v22;
            ...
            v31 = 2112;
            v32 = v12;
            _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Accessory UUID is nil for media component: %@", buf, 0x16u);
...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_133462 != -1)
    dispatch_once(&properties_onceToken_133462, block);
  return (id)properties__properties_133463;
}
...
void __33__HMDMediaSystemModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_133463;
  properties__properties_133463 = v3;

  v5 = (void *)properties__properties_133463;
  v11[0] = CFSTR("name");
