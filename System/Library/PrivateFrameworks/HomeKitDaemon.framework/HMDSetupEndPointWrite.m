...
- (BOOL)_parseFromTLVDataImpl
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BAC8], "wrappertlv:name:", 3, CFSTR("kSetupEndPoint__ControllerAddress"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BAC8], "wrappertlv:name:", 4, CFSTR("kSetupEndPoint__SRTPVideoParameters"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BAC8], "wrappertlv:name:", 5, CFSTR("kSetupEndPoint__SRTPAudioParameters"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v32[0] = v3;
  v32[1] = v4;
  v32[2] = v5;
...
- (HMDSetupEndPointWrite)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v21 = -[HMDEndPointAddress initWithIPAddress:isIPv6Address:videoRTPPort:audioRTPPort:]([HMDEndPointAddress alloc], "initWithIPAddress:isIPv6Address:videoRTPPort:audioRTPPort:", &stru_24E79DB48, 0, &unk_24E96A3A0, &unk_24E96A3A0);
    address = v5->_address;
    v5->_address = v21;
