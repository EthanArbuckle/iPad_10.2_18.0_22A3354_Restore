...
- (HMDTargetConfiguration)initWithAccessory:(id)a3 buttonConfiguration:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 2112;
      v33 = v26;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Attempting to create a target with an accessory %@/%@ that is not configured with a home", (uint8_t *)&v28, 0x20u);
