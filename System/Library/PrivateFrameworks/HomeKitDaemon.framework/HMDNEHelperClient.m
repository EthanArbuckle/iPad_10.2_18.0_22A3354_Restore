...
- (HMDNEHelperClient)init
{
  ...
  if (v2)
  {
    ...
    v2->_cachedEntries = (NSArray *)MEMORY[0x24BDBD1A8];
  ...
  if (-[NSArray indexOfObjectPassingTest:](cachedEntries, "indexOfObjectPassingTest:", v17) == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Caching process identifiers for %@: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Local cache hit for %@: %@", buf, 0x20u);
...
- (id)cacheCopyAppUUIDForSigningIdentifier:(id)a3 executablePath:(id)a4
{
  ...
  v10 = (void *)v9;
  if (v9 && MEMORY[0x227677370](v9) == MEMORY[0x24BDACF78])
  {
    v14 = 0;
    v15 = &v14;
    v16 = 0x3032000000;
    v17 = __Block_byref_object_copy__12675;
    v18 = __Block_byref_object_dispose__12676;
...
- (id)cacheCopySigningIdentifierForProcessIdentifier:(id)a3
{
  ...
  else
  {
    ...
    v9 = (void *)v8;
    if (v8 && MEMORY[0x227677370](v8) == MEMORY[0x24BDACFF0])
    {
...
- (void)cacheClearUUIDs
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Clearing cached UUIDs", (uint8_t *)&v8, 0xCu);

  }
  objc_autoreleasePoolPop(v3);
  cachedEntries = v4->_cachedEntries;
  v4->_cachedEntries = (NSArray *)MEMORY[0x24BDBD1A8];
...
uint64_t __73__HMDNEHelperClient_cacheCopyAppUUIDForSigningIdentifier_executablePath___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  v4 = a3;
  v5 = v4;
  if (v4 && MEMORY[0x227677370](v4) == MEMORY[0x24BDAD000])
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDBytes:", xpc_uuid_get_bytes(v5));
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3 != -1)
    dispatch_once(&logCategory__hmf_once_t3, &__block_literal_global_12685);
