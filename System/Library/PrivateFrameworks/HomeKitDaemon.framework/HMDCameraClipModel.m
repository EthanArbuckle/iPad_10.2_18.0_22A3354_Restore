...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_251312 != -1)
    dispatch_once(&hmbProperties_onceToken_251312, &__block_literal_global_251313);
  return (id)hmbProperties_properties_251314;
}
...
{
  if (sentinelParentUUID_onceToken_251303 != -1)
    dispatch_once(&sentinelParentUUID_onceToken_251303, &__block_literal_global_42_251304);
  return (NSUUID *)(id)sentinelParentUUID_sentinelParentUUID_251305;
}

+ (HMBModelInfiniteQuery)incompleteClipsQuery
{
  if (incompleteClipsQuery_onceToken != -1)
    dispatch_once(&incompleteClipsQuery_onceToken, &__block_literal_global_46_251295);
...
+ (HMBModelInfiniteQuery)clipsWithNeedsUploadFeedbackStatusQuery
{
  if (clipsWithNeedsUploadFeedbackStatusQuery_onceToken != -1)
    dispatch_once(&clipsWithNeedsUploadFeedbackStatusQuery_onceToken, &__block_literal_global_51_251287);
...
+ (HMBModelInfiniteQuery)clipsBeforeDateQuery
{
  if (clipsBeforeDateQuery_onceToken != -1)
    dispatch_once(&clipsBeforeDateQuery_onceToken, &__block_literal_global_57_251283);
...
void __62__HMDCameraClipModel_countOfClipsWithQualityBetweenDatesQuery__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)MEMORY[0x24BE4ECB0];
  v11[0] = CFSTR("quality");
  objc_msgSend(MEMORY[0x24BE4ECD0], "argumentWithPropertyName:", CFSTR("qualityField"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v5;
  v11[1] = CFSTR("dateAfter");
  objc_msgSend(MEMORY[0x24BE4ECD0], "argumentWithPropertyName:", CFSTR("startDate"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v12[1] = v6;
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "queryWithSQLPredicate:indexedProperties:arguments:", v3, &unk_24E971378, v8);
...
void __65__HMDCameraClipModel_clipsWithQualityBetweenDatesDescendingQuery__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v12, v11, 3);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", v3, CFSTR("dateBefore"), &unk_24E971360, v8);
  v9 = objc_claimAutoreleasedReturnValue();
...
void __64__HMDCameraClipModel_clipsWithQualityBetweenDatesAscendingQuery__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v12, v11, 3);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", v3, CFSTR("dateAfter"), &unk_24E971348, v8);
  v9 = objc_claimAutoreleasedReturnValue();
...
void __42__HMDCameraClipModel_clipsBeforeDateQuery__block_invoke()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", CFSTR("startDate <= :dateBefore ORDER BY startDate DESC"), CFSTR("dateBefore"), &unk_24E971330, v2);
...
void __61__HMDCameraClipModel_clipsWithNeedsUploadFeedbackStatusQuery__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BE4ECD0], "argumentWithPropertyName:defaultValue:", CFSTR("feedbackStatusField"), &unk_24E96D748);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v6[0] = v1;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v6, &v5, 1);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", CFSTR("feedbackStatusField == :feedbackStatusField"), CFSTR("feedbackStatusField"), &unk_24E971318, v2);
  v3 = objc_claimAutoreleasedReturnValue();
...
void __42__HMDCameraClipModel_incompleteClipsQuery__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BE4ECD0], "argumentWithPropertyName:defaultValue:");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v8[1] = CFSTR("startDate");
  v9[0] = v1;
  v2 = (void *)MEMORY[0x24BE4ECD0];
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", CFSTR("isComplete == :isComplete AND startDate <= :startDate ORDER BY startDate DESC"), CFSTR("startDate"), &unk_24E971300, v5);
...
void __40__HMDCameraClipModel_sentinelParentUUID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("C795FE32-95CB-4EE4-9197-6E572C6C2365"));
  v1 = (void *)sentinelParentUUID_sentinelParentUUID_251305;
  sentinelParentUUID_sentinelParentUUID_251305 = v0;
...
void __35__HMDCameraClipModel_hmbProperties__block_invoke()
{
  ...
  v7 = objc_opt_class();
  objc_msgSend(MEMORY[0x24BE4ECC0], "externalRecordField:", CFSTR("sa00"));
  ...
  v9 = objc_opt_class();
  objc_msgSend(MEMORY[0x24BE4ECC0], "encryptedExternalRecordField:", CFSTR("ebl00"));
  ...
  v52[13] = v22;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v52, v51, 14);
  v23 = objc_claimAutoreleasedReturnValue();
  v24 = (void *)hmbProperties_properties_251314;
  hmbProperties_properties_251314 = v23;
...
- (id)createClipWithSignificantEvents:(id)a3
{
  ...
  if (v4 && v5 && v6 && v7 && v8 && v9 && v10)
  {
    v43 = v7;
    v45 = v6;
    v12 = objc_msgSend(objc_alloc(MEMORY[0x24BDD7548]), "initWithKey:scheme:", v4, objc_msgSend(v5, "unsignedIntegerValue"));
    ...
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    v27 = objc_alloc(MEMORY[0x24BDD7538]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v53 = 2112;
      v54 = v23;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot create clip from model: %@", buf, 0x16u);
...
id __54__HMDCameraClipModel_createClipWithSignificantEvents___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    {
      v6 = objc_alloc(MEMORY[0x24BDD7568]);
    ...
    {
      v12 = objc_msgSend(objc_alloc(MEMORY[0x24BDD7570]), "initWithByteLength:byteOffset:", -[HMDCameraClipSegmentMetadata byteLength](v5, "byteLength"), -[HMDCameraClipSegmentMetadata byteOffset](v5, "byteOffset"));
    }
    v18 = (void *)v12;
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v17;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode video segment metadata for clip %@", (uint8_t *)&v20, 0x16u);
