...
- (id)getBtLoadData
{
  ...
  if (v6 >= 10.0)
  {
    ...
    v7 = objc_alloc_init(MEMORY[0x24BEC2AF8]);
    ...
    *(int8x8_t *)&v2->_btAudioTask = vand_s8((int8x8_t)vshl_u32((uint32x2_t)vdup_n_s32(v8), (uint32x2_t)0xFFFFFFF4FFFFFFF8), (int8x8_t)0xF0000000FLL);
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v29 = 2048;
      v30 = v8;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@BT Load: %d AudioTsk: %d NonAudioTsk: %d Raw: %lld", buf, 0x28u);

    }
    objc_autoreleasePoolPop(v10);

  }
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDWirelessLoadManager btLoad](v2, "btLoad", CFSTR("kBtLoadKey")));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v20[0] = v14;
  v19[1] = CFSTR("kBtAudioTask");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDWirelessLoadManager btAudioTask](v2, "btAudioTask"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v20[1] = v15;
  v19[2] = CFSTR("kBtNonAudioTask");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", -[HMDWirelessLoadManager btNonAudioTask](v2, "btNonAudioTask"));
...
+ (id)sharedInstance
{
  ...
  block[4] = a1;
  if (sharedInstance__hmf_once_t0_127379 != -1)
    dispatch_once(&sharedInstance__hmf_once_t0_127379, block);
  return (id)sharedInstance__hmf_once_v1_127380;
}
...
void __40__HMDWirelessLoadManager_sharedInstance__block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)sharedInstance__hmf_once_v1_127380;
  sharedInstance__hmf_once_v1_127380 = (uint64_t)v1;
