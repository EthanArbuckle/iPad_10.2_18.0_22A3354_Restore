...
- (BOOL)_shouldFallbackLocallyWithError:(id)a3 accessory:(id)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v9, "isLocalAccessoryCommunicationAllowed");

  if (!v10)
    goto LABEL_31;
  if (objc_msgSend(v6, "isHMError"))
  {
    v11 = objc_msgSend(v6, "code");
    goto LABEL_5;
  }
  if (!objc_msgSend(v6, "isHAPError"))
  {
LABEL_27:
    v12 = 1;
    goto LABEL_32;
...
LABEL_5:
    ...
    switch(v11)
    {
      ...
      case 4:
        ...
        v14 = objc_msgSend(v7, "hasBTLELink");
        if (!v13)
        {
          if (!v14 || (objc_msgSend(v7, "isReachable") & 1) == 0 && (objc_msgSend(v7, "isBLELinkConnected") & 1) == 0)
            break;
          goto LABEL_27;
        }
        if (v14 && ((objc_msgSend(v7, "isReachable") & 1) != 0 || (objc_msgSend(v7, "isBLELinkConnected") & 1) != 0)
          || (objc_msgSend(v7, "supportsCHIP") & 1) != 0)
        {
          goto LABEL_27;
        }
        break;
      ...
      default:
        ...
        if (objc_msgSend(v17, "isHMError") && objc_msgSend(v17, "code") == 3203)
          goto LABEL_33;
        v18 = objc_msgSend(v7, "canWakeViaCustomWoBLE");
  ...
  if (!objc_msgSend(v7, "canWakeViaCustomWoBLE"))
  {
LABEL_31:
    v12 = 0;
    goto LABEL_32;
  ...
  if (objc_msgSend(v17, "isHMError"))
    v12 = objc_msgSend(v17, "code") != 2400;
  else
LABEL_33:
    v12 = 1;
...
void __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v44[1] = 3221225472;
    v44[2] = __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_319;
    v44[3] = &unk_24E79AD98;
    v18 = v16;
    v45 = v18;
    v46 = v6;
    ...
    if (objc_msgSend(v19, "count"))
    {
      ...
      v42[1] = 3221225472;
      v42[2] = __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_321;
      v42[3] = &unk_24E79AAA0;
      v43 = v20;
    ...
    if (objc_msgSend(v18, "count") && (objc_msgSend(v6, "supportsMultiPartResponse") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v56 = 2112;
        v57 = v3;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@[%@] Missing remote responses. Falling back to locally processing requests: %@ -> %@", buf, 0x2Au);
    ...
    if (objc_msgSend(v22, "count"))
    {
      ...
      v40[1] = 3221225472;
      v40[2] = __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_322;
      v40[3] = &unk_24E79ADC0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v51 = v36;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for HMDHAPAccessoryRemoteOperationWithLocalFallbackTask remote task completion handler", buf, 0xCu);
...
id __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_319(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  void *v5;
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v40 = 2112;
      v41 = v3;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Lost reference to accessory for response: %@", (uint8_t *)&v36, 0x20u);
...
LABEL_13:
  ...
  if (v17)
  {
    if (v21)
    {
      ...
      v40 = 2112;
      v41 = v3;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@[%@] Skip falling back to locally processing accessory for response: %@", (uint8_t *)&v36, 0x20u);
  ...
  else
  {
    if (v21)
    {
      ...
      v42 = 2112;
      v43 = v3;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@[%@] Falling back to locally processing request: %@ -> %@", (uint8_t *)&v36, 0x2Au);
...
void __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_321(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
  void *v5;
...
void __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_322(uint64_t a1, void *a2)
{
  id v3;
  id WeakRetained;
  void *v5;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for fallback local task completion", (uint8_t *)&v10, 0xCu);
...
void __65__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask_completion__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for HMDHAPAccessoryRemoteOperationWithLocalFallbackTask completion", (uint8_t *)&v11, 0xCu);
...
void __105__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__startScanningForSuspendedAccessoriesWithRequests___block_invoke_4(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(*(id *)(a1 + 48), "count"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(*(id *)(a1 + 56), "count"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = *(_QWORD *)(a1 + 64);
    v22 = 138544642;
    v23 = v5;
    ...
    v32 = 2112;
    v33 = v10;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Scanning locally for suspended accessory (%@/%@/%@) completed with error: %@.", (uint8_t *)&v22, 0x3Eu);
  ...
  if (!*(_QWORD *)(a1 + 64) && objc_msgSend(*(id *)(a1 + 56), "count"))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v32 = 2048;
      v33 = v20;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Adding responses for suspended accessory %@/%@/%@ with %ld requests", (uint8_t *)&v22, 0x3Eu);
