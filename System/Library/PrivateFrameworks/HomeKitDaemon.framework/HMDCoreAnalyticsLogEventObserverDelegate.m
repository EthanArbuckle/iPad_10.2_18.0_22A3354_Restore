...
- (void)addCommonDimensionsToEventDictionary:(id)a3
{
  ...
  objc_msgSend(v25, "deviceStateProvider");
  ...
  objc_msgSend(v22, "numberWithBool:", objc_msgSend(v23, "hh2SentinelZoneExists"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v24, CFSTR("hh2SentinelZoneExists"));
...
- (void)addDimensionsForAccessoryIdentifier:(id)a3 toEventDictionary:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2114;
      v17 = v6;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Accessory with identifier %{public}@ doesn't exist", (uint8_t *)&v14, 0x16u);
...
- (NSDictionary)aggregatedHomeCategorizationDimensions
{
  ...
  if (!aggregatedHomeCategorizationDimensions)
  {
    ...
    if (v7)
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "totalHomeCategoryBitMask"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v8, CFSTR("totalHomeCategoryBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "totalAppleMediaCategoryBitMask"));
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v9, CFSTR("totalAppleMediaBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "totalThirdPartyMediaCategoryBitMask"));
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v10, CFSTR("totalThirdPartyMediaBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "currentUserPrivilegeBitMask"));
      v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)deviceCapabilitiesAndEnablementsDimensions
{
  ...
  if (!deviceCapabilitiesAndEnablementsDimensions)
  {
    ...
    if (v7)
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isFMFDevice"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v8, CFSTR("isFMFDevice"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentCapable"));
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v9, CFSTR("currentDeviceResidentCapable"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentEnabled"));
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v10, CFSTR("currentDeviceResidentEnabled"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isPrimaryResidentForSomeHome"));
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v11, CFSTR("currentDeviceResidentPrimaryResidentAnyHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentFirstEnabledAnyHome"));
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v12, CFSTR("isResidentFirstEnabledAnyHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentElectionV2EnabledAnyHome"));
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v13, CFSTR("isResidentElectionV2EnabledAnyHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "totalResidentElectionBitMask"));
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v14, CFSTR("totalResidentElectionBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentSelectionEnabledAnyHome"));
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v15, CFSTR("isResidentSelectionEnabledAnyHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentSelectionModeAutoAnyHome"));
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v16, CFSTR("isResidentSelectionModeAutoAnyHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentSelectionModeManualAnyHome"));
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v17, CFSTR("isResidentSelectionModeManualAnyHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentSelectionModeCoordinationAnyHome"));
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v18, CFSTR("isResidentSelectionModeCoordinationAnyHome"));

    }
    objc_msgSend(v5, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("isHH2Enabled"));
    objc_msgSend(v5, "setObject:forKeyedSubscript:", &unk_24E96A7F0, CFSTR("isHH2Enabled_INT"));
    v19 = (NSDictionary *)objc_msgSend(v5, "copy");
...
- (NSDictionary)aggregatedHomeDimensions
{
  ...
  if (!aggregatedHomeDimensions)
  {
    ...
    if (v7)
    {
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "totalUserPrivilegeBitMask"));
      v64 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v64, CFSTR("totalUserPrivilegeBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isTelevisionOnlyConfiguration"));
      v65 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "setObject:forKeyedSubscript:", v65, CFSTR("televisionOnlyConfiguration"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isMediaOnlyConfiguration"));
...
- (id)dimensionsForHome:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (v7)
    {
      objc_msgSend(MEMORY[0x24BDBCED8], "dictionary");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "homeCategoryBitMask"));
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v9, CFSTR("homeCategoryBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "thirdPartyMediaCategoryBitMask"));
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v10, CFSTR("thirdPartyMediaBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "appleMediaCategoryBitMask"));
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v11, CFSTR("appleMediaBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isOwnerUser"));
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "currentUserPrivilege"));
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v22, CFSTR("currentUserPrivilegeInHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "userPrivilegeBitMask"));
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "residentElectionBitMask"));
      v54 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v54, CFSTR("residentElectionBitMask"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v7, "isResidentSelectionEnabled"));
      v55 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v55, CFSTR("residentSelectionEnabledInHome"));

      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v7, "residentSelectionMode"));
      v56 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "setObject:forKeyedSubscript:", v56, CFSTR("residentSelectionModeInHome"));
