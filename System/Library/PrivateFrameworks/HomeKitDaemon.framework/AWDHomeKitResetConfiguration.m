@implementation AWDHomeKitResetConfiguration
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)AWDHomeKitResetConfiguration;
  -[AWDHomeKitResetConfiguration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDHomeKitResetConfiguration dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 20) & 2) == 0 || self->_errorCode != *((_DWORD *)v4 + 4))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
