...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_13 != -1)
    dispatch_once(&hmbProperties_onceToken_13, &__block_literal_global_15_239999);
...
+ (HMBModelInfiniteQuery)registeredDevicesQuery
{
  if (registeredDevicesQuery_onceToken != -1)
    dispatch_once(&registeredDevicesQuery_onceToken, &__block_literal_global_22_239990);
...
void __57__HMDIDSActivityRegistrationModel_registeredDevicesQuery__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BE4ECD0], "argumentWithPropertyName:", CFSTR("subjectDeviceIdentifier"));
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v6[0] = v1;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v6, &v5, 1);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "queryWithSQLPredicate:sequenceArgumentName:indexedProperties:arguments:", CFSTR("subjectDeviceIdentifier == :subjectDeviceIdentifier"), CFSTR("subjectDeviceIdentifier"), &unk_24E9712A0, v2);
