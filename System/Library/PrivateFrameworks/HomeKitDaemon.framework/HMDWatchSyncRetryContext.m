...
+ (id)createWithWatchIdentifier:(id)a3 watchSync:(id)a4 retryAttempt:(int64_t)a5
{
  ...
  if (objc_msgSend(v11, "integerValue") <= 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = v11;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Value for maximum watch sync retry attempts key: %@ is less than equal to 0: %@", (uint8_t *)&v31, 0x20u);
  ...
  if (objc_msgSend(v11, "integerValue") <= a5)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v11;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Exhausted all watch sync retry attempts. Current attempt: %lu, maximum attempts: %@", (uint8_t *)&v31, 0x20u);
...
LABEL_11:
  ...
  if (v16 <= 0.0)
  {
    v27 = (void *)MEMORY[0x227676638](v15);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = v14;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Value for watch sync initial retry interval: %@ is less than equal to 0: %@", (uint8_t *)&v31, 0x20u);
