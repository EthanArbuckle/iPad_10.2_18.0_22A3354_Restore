...
+ (id)categoryWithIdentifier:()HMDHAPMetadata
{
  ...
  v5 = (void *)objc_msgSend(v4, "initWithUUIDString:", *MEMORY[0x24BDD4A58]);
  ...
  if (v6)
  {
    objc_msgSend(v7, "categoryForType:", *MEMORY[0x24BDD4A50]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
  ...
  v12 = objc_alloc(MEMORY[0x24BDD7338]);
  objc_msgSend(v3, "UUIDString");
  ...
  objc_msgSend(MEMORY[0x24BDD7668], "cachedInstanceForHMAccessoryCategory:", v15);
...
+ (id)categoryWithCategoryIdentifier:()HMDHAPMetadata
{
  ...
  v7 = objc_alloc(MEMORY[0x24BDD7338]);
  ...
  objc_msgSend(MEMORY[0x24BDD7668], "cachedInstanceForHMAccessoryCategory:", v10);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (uint64_t)categoryForProductInfo:()HMDHAPMetadata
{
  ...
  return objc_msgSend(MEMORY[0x24BDD7338], "categoryForProductClass:", v3);
}
...
+ (id)categoryForProductClass:()HMDHAPMetadata
{
  ...
  if (a3 == 6)
  {
    v3 = (void *)MEMORY[0x24BDD7338];
    v4 = objc_alloc(MEMORY[0x24BDD1880]);
    v5 = (_QWORD *)MEMORY[0x24BDD49E0];
  }
  else
  {
    v3 = (void *)MEMORY[0x24BDD7338];
    ...
    {
      v4 = objc_alloc(MEMORY[0x24BDD1880]);
      v5 = (_QWORD *)MEMORY[0x24BDD49A0];
    }
    else
    {
      v4 = objc_alloc(MEMORY[0x24BDD1880]);
      v5 = (_QWORD *)MEMORY[0x24BDD4A30];
    }
  }
