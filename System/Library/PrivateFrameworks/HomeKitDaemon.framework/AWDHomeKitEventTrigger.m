...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 8) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_executeOnce);
  ...
  if ((has & 4) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_containsRecurrences);
  ...
  if ((v16 & 1) != 0)
  {
    ...
    {
      v18 = off_24E78ED80[activationState];
    }
  ...
  if ((v16 & 2) != 0)
  {
    ...
    if (activationType >= 4)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_activationType);
      v20 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v20 = off_24E78EDA8[activationType];
    }
