...
- (id)initWithAsset:()Asset
{
  ...
  if (v5)
  {
    ...
    if ((v9 & 1) != 0)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v77 = 2112;
          v78 = v14;
          _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Unarchiving the non-streamable asset: %@", buf, 0x16u);
        ...
        if ((v18 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v79 = 2112;
            v80 = v19;
            _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive contents of asset: %@ with error: %@", buf, 0x20u);
      ...
      v72 = v19;
      objc_msgSend(v30, "contentsOfDirectoryAtURL:includingPropertiesForKeys:options:error:", v31, MEMORY[0x24BDBD1A8], 4, &v72);
      ...
      if (!objc_msgSend(v32, "count"))
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v77 = 2112;
          v78 = v33;
          _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_ERROR, "%{public}@No release notes found. Error: %@", buf, 0x16u);
      ...
      objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("self.lastPathComponent MATCHES %@"), CFSTR("(^[a-z]{2}(-|_)[A-Za-z0-9]+).txt"));
      ...
      if (!objc_msgSend(v35, "count"))
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v76 = v48;
          _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_ERROR, "%{public}@No valid release notes found.", buf, 0xCu);
      ...
      v63 = v37;
      if (v42
        || (objc_msgSend(v35, "na_firstObjectPassingTest:", &__block_literal_global_163168),
            (v42 = (void *)objc_claimAutoreleasedReturnValue()) != 0))
      {
        objc_msgSend(v4, "testDocumentData");
        v49 = (void *)objc_claimAutoreleasedReturnValue();

        v50 = objc_alloc(MEMORY[0x24BDD78C8]);
        if (v49)
        {
          objc_msgSend(v4, "testDocumentData");
...
LABEL_46:
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v79 = 2112;
        v80 = v33;
        _os_log_impl(&dword_2218F0000, v58, OS_LOG_TYPE_ERROR, "%{public}@Unable to load release note document, %@, with error: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v77 = 2112;
      v78 = v28;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@No asset in path: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v76 = v26;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@The asset url is required", buf, 0xCu);
LABEL_15:
