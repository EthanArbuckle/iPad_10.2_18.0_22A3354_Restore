...
LABEL_13:
  ...
  {
LABEL_7:
    objc_msgSend(v8, "hmf_objectPassingTest:", &__block_literal_global_100432);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v11, "operationTypes"))
    {
      if (a5)
      {
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 48, CFSTR("Operation not supported"), CFSTR("Configuration changes not supported"), 0);
