...
LABEL_21:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v40 = v34;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio stream interface", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v31;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video stream interface", buf, 0xCu);
...
- (void)_startStreamWithVideoConfig:(id)a3 audioConfig:(id)a4
{
  ...
  if (objc_msgSend(v9, "conformsToProtocol:", &unk_2557B76C0))
    v10 = v9;
  else
    v10 = 0;
  v11 = v10;
  ...
  if (v11)
  {
    ...
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v79 = v17;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay for remote stream", buf, 0xCu);
  ...
  else
  {
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v79 = v45;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Starting local stream", buf, 0xCu);
    ...
    {
      v50 = qword_2226A0B40[v49];
      v51 = qword_2226A0B78[v49];
    }
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v54);
    ...
    v77[6] = v68;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v77, v76, 7);
...
- (void)_stopStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping stream", (uint8_t *)&v12, 0xCu);
...
- (void)_callStreamStarted:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v16 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManager:didStartStream:slotIdentifier", buf, 0xCu);
...
- (void)_callReceivedFirstFrame
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidReceiveFirstFrame:", buf, 0xCu);
...
- (void)_callRelayStarted
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidStartRelay:", buf, 0xCu);
...
- (void)_callStreamStoppedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v16 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidStopStream", buf, 0xCu);
...
- (void)_callNetworkImproved
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidNetworkImprove", buf, 0xCu);
...
- (void)_callNetworkDeteriorated
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidNetworkDeteriorate", buf, 0xCu);
...
- (void)_callConfigurationUpdated
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidUpdateConfiguration", buf, 0xCu);
...
- (void)videoStream:(id)a3 didStart:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v37 = 138543362;
    v38 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Synchronizing video and audio streams", (uint8_t *)&v37, 0xCu);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    v39 = 2048;
    v40 = v21;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Creating AVCRemoteVideoClient with stream token: %lu", (uint8_t *)&v37, 0x16u);

  }
  objc_autoreleasePoolPop(v15);
  v22 = objc_alloc(MEMORY[0x24BDFDA18]);
  -[HMDCameraStreamManager videoStreamInterface](v16, "videoStreamInterface");
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    v39 = 2112;
    v40 = (uint64_t)v32;
    _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Updated slot identifier to %@", (uint8_t *)&v37, 0x16u);
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
  {
    ...
    v37 = 138543362;
    v38 = v36;
    _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Video stream has started, waiting for the first frame to arrive", (uint8_t *)&v37, 0xCu);
...
- (void)videoStream:(id)a3 didStop:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2114;
    v15 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Video stream session has stopped with error %{public}@", (uint8_t *)&v12, 0x16u);
...
- (void)videoStreamDidNetworkImprove:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Video stream's network has improved", (uint8_t *)&v9, 0xCu);
...
- (void)videoStreamDidNetworkDeteriorate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Video stream's network has deteriorated", (uint8_t *)&v9, 0xCu);
...
- (void)videoStreamDidUpdateConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Video stream's configuration update complete", (uint8_t *)&v9, 0xCu);
...
void __50__HMDCameraStreamManager_remoteVideoServerDidDie___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Video server has died", (uint8_t *)&v6, 0xCu);
...
void __63__HMDCameraStreamManager_remoteVideoClientDidReceiveLastFrame___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Last frame has been received", (uint8_t *)&v6, 0xCu);
...
void __75__HMDCameraStreamManager_remoteVideoClient_remoteVideoAttributesDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 2112;
    v10 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Remote video attributes did change: %@", (uint8_t *)&v7, 0x16u);
...
void __64__HMDCameraStreamManager_remoteVideoClientDidReceiveFirstFrame___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@First frame has been received", (uint8_t *)&v15, 0xCu);
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", v8 / v10);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_22262 != -1)
    dispatch_once(&logCategory__hmf_once_t2_22262, &__block_literal_global_22263);
  return (id)logCategory__hmf_once_v3_22264;
}
...
void __37__HMDCameraStreamManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_22264;
  logCategory__hmf_once_v3_22264 = v0;
