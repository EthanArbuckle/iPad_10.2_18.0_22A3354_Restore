...
- (HMDCloudPairedMetadata)initWithBaseAccessoryIdentifier:(id)a3 data:(id)a4 allowUnzippedData:(BOOL)a5
{
  ...
  v9 = a4;
  v27 = 0;
  objc_msgSend(MEMORY[0x24BDD1608], "JSONObjectWithData:options:error:", v9, 0, &v27);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v30 = 2112;
        v31 = v18;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@JSON is not a dictionary: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_170630 != -1)
    dispatch_once(&logCategory__hmf_once_t0_170630, &__block_literal_global_170631);
  return (id)logCategory__hmf_once_v1_170632;
}
...
+ (id)__decodeVersionConfigurationWithVersionString:(id)a3 versionConfigurationValue:(id)a4 baseAccessoryIdentifier:(id)a5
{
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Version configuration for version '%@' is not a dictionary: %@", (uint8_t *)&v29, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = v8;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Version configuration contains an invalid version string: %@", (uint8_t *)&v29, 0x16u);
...
LABEL_31:
  ...
  *(_QWORD *)&buf[16] = 0x2020000000;
  LOBYTE(v51) = 0;
  objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithCapacity:", objc_msgSend(v10, "count", v40));
...
void __37__HMDCloudPairedMetadata_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_170632;
  logCategory__hmf_once_v1_170632 = v0;
