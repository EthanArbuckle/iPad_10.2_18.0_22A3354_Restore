...
+ (id)properties
{
  if (properties_onceToken_29189 != -1)
    dispatch_once(&properties_onceToken_29189, &__block_literal_global_197);
  return (id)properties__properties_29190;
}
...
void __34__HMDServiceGroupModel_properties__block_invoke()
{
  ...
  v3 = (void *)properties__properties_29190;
  properties__properties_29190 = v2;
...
- (id)cd_generateValueForModelObjectFromManagedObject:(id)a3 modelObjectField:(id)a4 modelFieldInfo:(id)a5
{
  ...
  v9 = a5;
  v10 = a3;
  if (objc_msgSend(v8, "isEqualToString:", CFSTR("services")))
  {
...
- (id)cd_generateValueForProperty:(id)a3 managedObjectField:(id)a4 context:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  if (objc_msgSend(v9, "isEqualToString:", CFSTR("services_")))
  {
    if (-[HMDBackingStoreModelObject propertyWasSet:](self, "propertyWasSet:", CFSTR("services")))
    {
      -[HMDServiceGroupModel services](self, "services");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
