...
- (HMDAccessoryFirmwareUpdateConcurrencyLogEventManager)initWithCountersManager:(id)a3
{
  ...
  if (v6)
  {
    ...
    v8 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", 7);
    currentActivity = v7->_currentActivity;
    v7->_currentActivity = (NSMutableArray *)v8;

    v10 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", 7);
    ...
    for (i = 0; i != 7; ++i)
    {
      -[NSMutableArray setObject:atIndexedSubscript:](v7->_currentActivity, "setObject:atIndexedSubscript:", &unk_24E96B558, i);
      -[NSMutableArray setObject:atIndexedSubscript:](v7->_peakActivity, "setObject:atIndexedSubscript:", &unk_24E96B558, i);
    }
  }
...
- (void)startWithCategory:(unint64_t)a3 accessory:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v37 = 2112;
      v38 = v6;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Starting %@ while %@ is in progress for accessory %@", (uint8_t *)&v31, 0x2Au);
...
- (void)stopWithCategory:(unint64_t)a3 accessory:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v10 != a3)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v42 = 2112;
        v43 = v23;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping with mismatched categories current: %@, at start: %@", (uint8_t *)&v38, 0x20u);
    ...
    if (v27)
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v27 - 1);
      v28 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDAccessoryFirmwareUpdateConcurrencyLogEventManager currentActivity](self, "currentActivity");
      v29 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        v42 = 2112;
        v43 = v6;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Stopping category %@ when current activity is 0 for accessory %@", (uint8_t *)&v38, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v42 = 2112;
      v43 = v6;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping %@ when nothing is in progress for accessory %@", (uint8_t *)&v38, 0x20u);
