...
- (void)_reportInternalErrorCode:(int64_t)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", a3);
  v4 = (id)objc_claimAutoreleasedReturnValue();
  -[HMDCameraStreamControlManager _cleanUpStreamSessionWithError:](self, "_cleanUpStreamSessionWithError:", v4);
...
- (id)managerProtocol
{
  ...
  if (-[HMDCameraStreamControlManager conformsToProtocol:](self, "conformsToProtocol:", &unk_2557D1D10))
    v3 = self;
  else
    v3 = 0;
  return v3;
...
- (void)_callStreamNegotiated:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Stream negotiated", buf, 0xCu);
...
- (void)_callStreamRemoteConnectionSetup
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream remote connection setup", buf, 0xCu);
...
- (void)_callStreamStarted
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream started", buf, 0xCu);
...
- (void)_callStreamFirstFrameReceived
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@First frame received", buf, 0xCu);
...
- (void)_callStreamReconfigured
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream reconfigured", buf, 0xCu);
...
- (void)_callStreamStoppedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v25 = 2112;
    v26 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Stream with session ID %@ stopped with error %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_192978 != -1)
    dispatch_once(&logCategory__hmf_once_t6_192978, &__block_literal_global_192979);
  return (id)logCategory__hmf_once_v7_192980;
}
...
void __44__HMDCameraStreamControlManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_192980;
  logCategory__hmf_once_v7_192980 = v0;
