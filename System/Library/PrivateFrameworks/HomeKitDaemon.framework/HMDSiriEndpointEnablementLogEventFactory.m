...
- (id)logEventsPopulatedForHomeWithUUID:(id)a3 associatedWithDate:(id)a4
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2112;
    v31 = v6;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@No home found with UUID %@", buf, 0x16u);
  ...
  else
  {
    if (objc_msgSend(v4, "count"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@We are trying to serialize %lu HMDSiriEndpointEnablementLogEvent objects, which is impossible", (uint8_t *)&v14, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_255722 != -1)
    dispatch_once(&logCategory__hmf_once_t6_255722, &__block_literal_global_255723);
  return (id)logCategory__hmf_once_v7_255724;
}
...
void __55__HMDSiriEndpointEnablementLogEventFactory_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_255724;
  logCategory__hmf_once_v7_255724 = v0;
