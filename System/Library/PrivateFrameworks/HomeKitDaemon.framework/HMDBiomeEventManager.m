...
- (HMDBiomeEventManager)init
{
  ...
  v9 = objc_alloc_init(MEMORY[0x24BE0CBA8]);
  v10 = objc_alloc_init(MEMORY[0x24BE0CBC0]);
  v11 = objc_alloc_init(MEMORY[0x24BE0CB98]);
  v12 = -[HMDBiomeEventManager initWithNotificationCenter:actionSetStream:mediaAccessoryStream:accessoryStream:prunableStreamFactory:workQueue:](self, "initWithNotificationCenter:actionSetStream:mediaAccessoryStream:accessoryStream:prunableStreamFactory:workQueue:", v8, v9, v10, v11, &__block_literal_global_110440, v7);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@No home found for home accessory notification: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v28 = 2112;
        v29 = v8;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@No home found for removed accessory notification: %@ for accessory: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v4;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@No accessory found for removed accessory notification: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v35 = 2112;
          v36 = v10;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@No home found for removed service notification: %@ for service: %@ on accessory: %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v33 = 2112;
        v34 = v8;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@No accessory found for removed service notification: %@ for service: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v4;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@No service found for removed service notification: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v26 = 2112;
        v27 = v8;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@No home found for emptied action set notification: %@ for action set: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v4;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@No action set found for emptied action set notification: %@", buf, 0x16u);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Deleting all events in biome", buf, 0xCu);
    ...
    if (v11)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[HMDBiomeEventManager _deleteEventFromStartDate:toEndDate:stream:passingDeleteEventTest:](v4, *(void **)(*((_QWORD *)&v16 + 1) + 8 * v14++), &__block_literal_global_34_110399);
        }
        while (v12 != v14);
...
- (void)_deleteEventFromStartDate:(void *)a3 toEndDate:stream:passingDeleteEventTest:
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v46 = 2112;
    v47 = v5;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events from: (%@) to: (%@) in stream: %@", buf, 0x2Au);
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v50 = 2112;
      v51 = v23;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Deleted matching biome events from: (%@) to: (%@) in stream: %@ with success: %@ (%@)", buf, 0x3Eu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v44 = 2112;
      v45 = v5;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Unable to find public stream to prune for stream identifier: %@ of stream: %@", buf, 0x20u);
...
void __114__HMDBiomeEventManager_fetchMostRecentEventWithCharacteristicType_serviceType_homeSPIClientIdentifier_completion___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    v38 = &v37;
    v39 = 0x3032000000;
    v40 = __Block_byref_object_copy__110407;
    v41 = __Block_byref_object_dispose__110408;
    v42 = 0;
    v32[0] = v15;
    v32[1] = 3221225472;
  ...
  if (*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 64) + 8) + 40) && objc_msgSend(v3, "state"))
  {
    ...
    *(_QWORD *)(v5 + 40) = 0;
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v13;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Error fetching most revnet event of characeristic type: %@, service type: %@, in home with unique Identifier: %@", (uint8_t *)&v14, 0x2Au);
...
void __60__HMDBiomeEventManager__handleActionSetEmptiedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v18[10] = 2112;
      *(_QWORD *)&v18[12] = v9;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for action set with uniqueIdentifier: %@, uuid: %@, in home with uniqueIdentifier: %@ uuid %@", buf, 0x34u);
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&v22[22] = v12;
      v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for accessory's (uniqueIdentifier: %@ uuid: %@) service with uniqueIdentifier: %@, uuid: %@, in home with uniqueIdentifier: %@ uuid %@", buf, 0x48u);
...
void __60__HMDBiomeEventManager__handleAccessoryRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v24[10] = 2112;
      *(_QWORD *)&v24[12] = v9;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for accessory with uniqueIdentifier: %@, uuid: %@, in home with uniqueIdentifier: %@ uuid %@", buf, 0x34u);
...
void __55__HMDBiomeEventManager__handleHomeRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for home with uniqueIdentifier: %@, uuid: %@", buf, 0x20u);
...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x24BE0CD88]), "initWithPublicStream:", a2);
}
