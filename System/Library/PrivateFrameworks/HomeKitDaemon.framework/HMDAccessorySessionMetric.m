...
- (HMDAccessorySessionMetric)initWithAccessory:(id)a3 workQueue:(id)a4
{
  ...
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 0, 30.0);
...
- (HMDAccessorySessionMetric)initWithAccessory:(id)a3 workQueue:(id)a4 hapSessionTTRTimer:(id)a5 hapSessionTTRAllowList:(id)a6 radarInitiator:(id)a7
{
  ...
  if (v17)
  {
    ...
    v26 = objc_msgSend(objc_alloc(MEMORY[0x24BE1B938]), "initWithNumIPs:numIPsTried:numBonjourNames:", 0, 0, 0);
...
- (NSDictionary)state
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetric hasActiveSession](self, "hasActiveSession"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetric sessionFailures](self, "sessionFailures"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v26, CFSTR("sessionFailures"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetric successfulSessionRetries](self, "successfulSessionRetries"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetric isFromPrimary](self, "isFromPrimary"));
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v30, CFSTR("isFromPrimary"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v6, "numActiveSessionClients"));
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetric isHomeThreadCapable](self, "isHomeThreadCapable"));
  v42 = (void *)objc_claimAutoreleasedReturnValue();
  v41 = (void *)objc_msgSend(v17, "initWithName:value:", CFSTR("isHomeThreadCapable"), v42);
  v63[9] = v41;
  v18 = objc_alloc(MEMORY[0x24BE3F140]);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetric isPrimaryResidentThreadCapable](self, "isPrimaryResidentThreadCapable"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetric isThreadNetworkUp](self, "isThreadNetworkUp"));
  ...
  v63[14] = v35;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v63, 15);
...
- (NSError)topError
{
  ...
  objc_msgSend(v3, "keysSortedByValueUsingComparator:", &__block_literal_global_205960);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_updateSessionState:(BOOL)a3 linkLayerType:(int64_t)a4 sessionInfo:(id)a5 bookkeeping:(id)a6 withError:(id)a7
{
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v119 = 2112;
        v120 = v24;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Session was already started on %@ for: %@", buf, 0x20u);
  ...
  if (v9)
  {
    if (v35)
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v121 = 2112;
      v122 = v41;
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Session started on %{public}@ for accessory: %{public}@ discovered by %@", buf, 0x2Au);
  ...
  if (v35)
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v121 = 2112;
    v122 = v47;
    _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Session ended on %{public}@ with error: %{public}@ for accessory: %@", buf, 0x2Au);
      ...
      if (v77)
      {
        ...
        if (v79)
        {
          if (v83)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v116 = v84;
            _os_log_impl(&dword_2218F0000, v82, OS_LOG_TYPE_INFO, "%{public}@Not starting timer to initiate radar for accessory because one is already running", buf, 0xCu);
        ...
        else
        {
          if (v83)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v116 = v85;
            _os_log_impl(&dword_2218F0000, v82, OS_LOG_TYPE_INFO, "%{public}@Starting timer to initiate radar for accessory", buf, 0xCu);
...
LABEL_53:
  ...
  if (v95)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v98 + 1);
...
- (void)_submitMetric
{
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v42 = 2114;
    v43 = v24;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Submitting SessionMetric for accessory: %@/%{public}@ - %{public}@", (uint8_t *)&v36, 0x2Au);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 2114;
    v41 = v33;
    _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Skipped Submitting SessionMetric for %@/%{public}@", (uint8_t *)&v36, 0x20u);
...
- (void)_resetSessionMetric
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 2114;
    v16 = v9;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Resetting session metric - accessory: %{public}@", (uint8_t *)&v13, 0x16u);
  ...
  if (v6 == v4)
  {
    ...
    if (v7)
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v22 = 2114;
        v23 = v13;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@HAP session TTR timer fired. Initiating radar for allowed accessory: %{public}@", buf, 0x16u);
    ...
    else
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v21 = v19;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Accessory reference is nil when handling HAP session TTR timer", buf, 0xCu);
...
LABEL_10:
        _os_log_impl(&dword_2218F0000, v10, v11, v9, (uint8_t *)&v29, 0x16u);
...
LABEL_17:
      _os_log_impl(&dword_2218F0000, v27, v28, v26, (uint8_t *)&v29, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t20_206019 != -1)
    dispatch_once(&logCategory__hmf_once_t20_206019, &__block_literal_global_72_206020);
  return (id)logCategory__hmf_once_v21_206021;
}
...
void __40__HMDAccessorySessionMetric_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v21_206021;
  logCategory__hmf_once_v21_206021 = v0;
