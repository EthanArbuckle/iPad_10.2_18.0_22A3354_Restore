...
- (void)sendData:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&v14[4] = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Data send already in progress", v14, 0xCu);
...
- (void)sendIDSInvitation
{
  ...
  {
    v7 = (void *)v6;
    v8 = *MEMORY[0x24BE4FB98];
    v38[0] = *MEMORY[0x24BE4FBA0];
    v38[1] = v8;
    v39[0] = &unk_24E96D238;
    v39[1] = MEMORY[0x24BDBD1C0];
    v38[2] = *MEMORY[0x24BE4FB88];
    v39[2] = &unk_24E96D250;
...
- (void)_startDataTransfer
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Total number of bytes to send: %tu", buf, 0x16u);
  ...
  v13 = dispatch_source_create(MEMORY[0x24BDACA30], v11, 0, v12);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v12 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSRelayInitiator", buf, 0xCu);
...
- (void)session:(id)a3 receivedInvitationAcceptFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %{public}@ has been accepted by: %@, waiting for session to get started", (uint8_t *)&v13, 0x20u);
...
- (void)session:(id)a3 receivedInvitationDeclineFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ has been declined by: %@", (uint8_t *)&v14, 0x20u);

  }
  objc_autoreleasePoolPop(v9);
  objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1028);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)session:(id)a3 receivedInvitationCancelFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ was canceled by: %@", (uint8_t *)&v14, 0x20u);

  }
  objc_autoreleasePoolPop(v9);
  objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1029);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDCameraSnapshotIDSRelayInitiator _callFileTransferFailed:](v10, "_callFileTransferFailed:", v13);
...
- (void)sessionStarted:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2114;
    v14 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@IDSSession %{public}@ has started", (uint8_t *)&v11, 0x16u);
...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2114;
    v23 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@IDSSession %{public}@ has ended with reason: %{public}u and error %{public}@", (uint8_t *)&v16, 0x26u);
  ...
  if (WeakRetained)
  {
    ...
    if (v9 == -1)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v28 = 2048;
        v29 = v5;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to send the data of size %tu", (uint8_t *)&v26, 0x16u);
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2048;
      v29 = v9;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Sent %lu bytes", (uint8_t *)&v26, 0x16u);
    ...
    if (!v17)
    {
      v18 = (void *)MEMORY[0x227676638](objc_msgSend(v11[6], "markWithReason:", CFSTR("Transfer completed")));
      v19 = v11;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 138543362;
        v27 = v21;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@File transfer is complete with total transferred bytes", (uint8_t *)&v26, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_225505 != -1)
    dispatch_once(&logCategory__hmf_once_t0_225505, &__block_literal_global_225506);
  return (id)logCategory__hmf_once_v1_225507;
}
...
void __49__HMDCameraSnapshotIDSRelayInitiator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_225507;
  logCategory__hmf_once_v1_225507 = v0;
