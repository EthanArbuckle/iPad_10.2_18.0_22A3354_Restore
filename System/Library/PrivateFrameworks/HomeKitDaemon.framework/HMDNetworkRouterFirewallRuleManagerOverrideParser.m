...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_17557 != -1)
    dispatch_once(&logCategory__hmf_once_t0_17557, &__block_literal_global_17558);
  return (id)logCategory__hmf_once_v1_17559;
}
...
+ (id)parseFromData:(id)a3
{
  ...
  v4 = a3;
  v36 = 0;
  objc_msgSend(MEMORY[0x24BDD1608], "JSONObjectWithData:options:error:", v4, 0, &v36);
  ...
  if (v8)
  {
        ...
        if (!objc_msgSend(v19, "count", v29, v30, v31, v32))
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v37 = 138543618;
            ...
            v39 = 2112;
            v40 = v14;
            _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@JSON contains no overrides: %@", v37, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v14;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@JSON is not a dictionary: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse JSON: %@", buf, 0x16u);
...
+ (id)_parseOverrideNetworkDeclarationsWithProductGroup:(id)a3 productNumber:(id)a4 productNumberDictionary:(id)a5 accessoryIdentifier:(id)a6
{
  ...
  {
    v35 = 0;
    objc_msgSend(MEMORY[0x24BDD1608], "dataWithJSONObject:options:error:", v15, 0, &v35);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v42 = 2112;
          v43 = v11;
          _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@JSON dictionary for '%@':'%@' did not parse correctly: %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v44 = 2112;
        v45 = v17;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@JSON dictionary for '%@':'%@' failed to convert to JSON: %@: %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v44 = 2112;
      v45 = v13;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@JSON for '%@':'%@' contains an invalid '%@' value: %@", buf, 0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v28 = 2112;
        v29 = v10;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@JSON value for '%@' is not a dictionary: %@", buf, 0x20u);
    ...
    if (!+[HMDAccessory validateProductData:](HMDAccessory, "validateProductData:", v9))
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v53 = 2112;
        v54 = v9;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Computed product data is invalid: %@", buf, 0x16u);
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v55 = 2112;
        v56 = v7;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Overrides contain multiple entries for '%@':'%@'", buf, 0x20u);
    ...
    if (!v23)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v57 = 2112;
        v58 = v21;
        _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@JSON value for '%@':'%@' is not a dictionary: %@", buf, 0x2Au);
...
LABEL_34:
          _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, v41, buf, 0x2Au);
        ...
        *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 8) + 24) = 1;
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v57 = 2112;
          v58 = v23;
          _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_ERROR, "%{public}@JSON dictionary for '%@':'%@' did not have network declaration or pairedMetadata: %@", buf, 0x2Au);
...
void __64__HMDNetworkRouterFirewallRuleManagerOverrideParser_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_17559;
  logCategory__hmf_once_v1_17559 = v0;
