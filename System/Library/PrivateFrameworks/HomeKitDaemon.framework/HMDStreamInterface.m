...
- (HMDStreamInterface)initWithSessionID:(id)a3 workQueue:(id)a4 delegateQueue:(id)a5 sessionHandler:(id)a6 localRTPSocket:(int)a7
{
  ...
  if (v17)
  {
    ...
    v18->_socketCloseHandler = &__block_literal_global_79729;
...
- (BOOL)loadMiscFields:(id)a3
{
  ...
  if (objc_msgSend(v5, "conformsToProtocol:", &unk_2557BCEA0))
    v6 = v5;
  else
    v6 = 0;
  v7 = v6;
  ...
  if (v7)
  {
    ...
    objc_msgSend(v8, "extractNetworkConfig:peerNameExtractor:", v9, MEMORY[0x24BDAE6C0]);
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v15;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@IDSDevice connection: Peer IP address: %@\n", (uint8_t *)&v29, 0x16u);
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v20;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@IDSDevice connection: Peer port      : %@\n", (uint8_t *)&v29, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_79746 != -1)
    dispatch_once(&logCategory__hmf_once_t0_79746, &__block_literal_global_9_79747);
  return (id)logCategory__hmf_once_v1_79748;
}
...
LABEL_14:
    ...
    *(_DWORD *)buf = 138543362;
    ...
    v21 = 12;
LABEL_17:
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, v19, buf, v21);
...
LABEL_8:
  objc_msgSend(a1, "extractNetworkConfig:peerNameExtractor:", v6, MEMORY[0x24BDAE770]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "rtpPort");
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v29 = 2112;
    v30 = v17;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Opened socket at address %@ and port %@", buf, 0x20u);
  ...
  if ((((uint64_t (*)(uint64_t, _WORD *, int *))a4)(v5, v30, &v18) & 0x80000000) != 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 1024;
      v22 = v13;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Failed to get the peer name %d", buf, 0x12u);
...
void __33__HMDStreamInterface_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_79748;
  logCategory__hmf_once_v1_79748 = v0;
