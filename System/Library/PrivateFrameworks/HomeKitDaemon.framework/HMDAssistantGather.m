...
- (void)_gatherHomeKitObjects
{
  ...
  v128 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F200]), "initWithName:", CFSTR("com.apple.homed.gather-home-objects"));
        ...
        if (!v9)
        {
          ...
          if (os_log_type_enabled(v123, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v196 = 2112;
            v197 = v127;
            _os_log_impl(&dword_2218F0000, v123, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot create an assistant object for home %@/%@; skipping all objects in home",
              buf,
              0x20u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  v198 = 2112;
                  v199 = v67;
                  _os_log_impl(&dword_2218F0000, v62, OS_LOG_TYPE_INFO, "%{public}@Dropping empty service group %@ in home %@/%@ from sync data", buf, 0x2Au);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v89, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  v198 = 2112;
                  v199 = v95;
                  _os_log_impl(&dword_2218F0000, v89, OS_LOG_TYPE_INFO, "%{public}@Dropping empty zone %@ in home %@/%@ from sync data", buf, 0x2Au);
                ...
                if (!v105)
                {
                  ...
                  if (os_log_type_enabled(v108, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    v198 = 2112;
                    v199 = v113;
                    _os_log_impl(&dword_2218F0000, v108, OS_LOG_TYPE_INFO, "%{public}@Dropping empty user-defined actionSet %@ in home %@/%@ from sync data", buf, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_179715 != -1)
    dispatch_once(&logCategory__hmf_once_t0_179715, &__block_literal_global_179716);
  return (id)logCategory__hmf_once_v1_179717;
}
...
void __33__HMDAssistantGather_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_179717;
  logCategory__hmf_once_v1_179717 = v0;
