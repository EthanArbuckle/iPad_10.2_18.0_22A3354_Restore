...
- (id)_createTcpConnection
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2048;
    v21 = schedulingMode;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating TCP connection with scheduling mode %ld", (uint8_t *)&v18, 0x16u);
...
- (void)connect
{
  ...
  if (v3)
  {
    ...
    if (v4)
    {
      if (v8)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v22;
        _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Connect called on an already-connecting transport", buf, 0xCu);
    ...
    else if (v8)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v9;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Connect called on an already-running transport", buf, 0xCu);
  ...
  else
  {
    ...
    if (v11)
    {
      ...
      v17 = (void *)MEMORY[0x227676638](v13, v14, v15, v16);
      v18 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v20;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket starting", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v26;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create TCP connection (out of memory?)", buf, 0xCu);
...
- (void)_handleReadClose
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket read-end closed (half-close scenario)", (uint8_t *)&v7, 0xCu);
...
- (void)_doReceive
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream has encountered irrecoverable framing issue. Closing socket.", buf, 0xCu);
...
- (void)_closeWithError:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      v15 = 138543362;
      v16 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket closing socket.", (uint8_t *)&v15, 0xCu);
  ...
  else
  {
    if (v9)
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket invoked closed but nothing to clean up.", (uint8_t *)&v15, 0xCu);
...
- (void)setTrafficClass:(unint64_t)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2048;
      v14 = a3;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Setting traffic class to %lu", (uint8_t *)&v11, 0x16u);
...
void __53__HMDDataStreamTCPTransport_sendRawFrame_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@DataStream Socket write error (%@)", (uint8_t *)&v10, 0x16u);
  ...
  else if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@DataStream Socket wrote bytes.", (uint8_t *)&v10, 0xCu);
  ...
  if (WeakRetained)
  {
    if (v8)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@DataStream Socket read %zd bytes", (uint8_t *)&v21, 0x16u);
    ...
    if (v10)
    {
      v17 = (void *)MEMORY[0x227676638](WeakRetained);
      v18 = v12;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2112;
        size = (size_t)v10;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket read error (%@)", (uint8_t *)&v21, 0x16u);
  ...
  if (WeakRetained)
  {
    if ((a2 - 4) >= 2)
    {
      if (a2 == 3)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
        {
          ...
          v15 = 138543362;
          v16 = v14;
          _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket connected", (uint8_t *)&v15, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v17 = 2112;
        v18 = v5;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket disconnected with error (%@)", (uint8_t *)&v15, 0x16u);
