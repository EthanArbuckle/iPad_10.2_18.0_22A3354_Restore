...
- (HMDDeviceSetupManager)initWithNotificationCenter:(id)a3 followUpManager:(id)a4 darwinNotificationProvider:(id)a5
{
  ...
  if (v12)
  {
    ...
    if (*p_proxSetupNotificationToken == -1)
    {
      ...
      v20 = objc_msgSend(v17, "notifyRegisterDispatch:outToken:queue:handler:", v18, &v13->_proxSetupNotificationToken, MEMORY[0x24BDAC9B8], v27);
      ...
      if (v20)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v31 = v24;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to register for ProxSetup notifications", buf, 0xCu);
    ...
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v14 = v11;
          _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to unregister for ProxSetup notifications", buf, 0xCu);
...
+ (id)sharedManager
{
  if (sharedManager_onceToken_209059 != -1)
    dispatch_once(&sharedManager_onceToken_209059, &__block_literal_global_209060);
  return (id)sharedManager_sharedManager_209061;
}
...
void __38__HMDDeviceSetupManager_sharedManager__block_invoke()
{
  ...
  v2 = objc_alloc_init(MEMORY[0x24BDD7608]);
  ...
  v4 = (void *)sharedManager_sharedManager_209061;
  sharedManager_sharedManager_209061 = v3;
