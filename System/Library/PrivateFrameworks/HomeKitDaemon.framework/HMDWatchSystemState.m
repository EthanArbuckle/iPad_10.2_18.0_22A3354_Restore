  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v26 = 2112;
      v27 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@[HMDWatchState] companion reachability is changing from %@ to %@", buf, 0x20u);
...
- (void)_callDidUpdateReachabilityChangeForCompanion:(BOOL)a3 forDelegate:(id)a4
{
  ...
  v4 = a3;
  v5 = a4;
  if (objc_msgSend(v5, "conformsToProtocol:", &unk_25587B778) && (objc_opt_respondsToSelector() & 1) != 0)
