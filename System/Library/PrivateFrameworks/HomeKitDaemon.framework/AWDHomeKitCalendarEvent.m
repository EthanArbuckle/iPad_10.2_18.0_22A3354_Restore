@implementation AWDHomeKitCalendarEvent
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)AWDHomeKitCalendarEvent;
  -[AWDHomeKitCalendarEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDHomeKitCalendarEvent dictionaryRepresentation](self, "dictionaryRepresentation");
