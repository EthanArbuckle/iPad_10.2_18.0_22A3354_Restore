...
- (HMDHomeInvitation)initWithCoder:(id)a3 invitationData:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  objc_msgSend(v6, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("home"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = -[HMDHomeInvitation initWithInvitationData:forHome:](self, "initWithInvitationData:forHome:", v7, v8);

  if (v9 && objc_msgSend(v6, "containsValueForKey:", CFSTR("idsInvitationUUID")))
  {
    objc_msgSend(v6, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("idsInvitationUUID"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v8, "encodeConditionalObject:forKey:", v4, CFSTR("home"));

  -[HMDHomeInvitation invitationData](self, "invitationData");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "encodeObject:forKey:", v5, CFSTR("HM.invitationData"));
  ...
  if (v6)
  {
    ...
    objc_msgSend(v8, "encodeObject:forKey:", v7, CFSTR("idsInvitationUUID"));
...
- (void)updateTimer:(unint64_t)a3 clientQueue:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDBCE60], "dateWithTimeIntervalSinceNow:", (double)a3);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_QWORD *)&location[4] = v7;
        v12 = 2112;
        v13 = v8;
        _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Not calling invitation (%@) expiration handler, no client queue set", location, 0x16u);
...
- (void)_configureTimer
{
  ...
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 1, v6);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_QWORD *)&location[4] = v10;
        v16 = 2112;
        v17 = v11;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Not calling invitation (%@) resolution handler, no client queue set", location, 0x16u);
...
- (id)describeWithFormat
{
  ...
  -[HMDHomeInvitation endDate](self, "endDate");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD76D0], "homeInvitationStateDescription:", -[HMDHomeInvitation invitationState](self, "invitationState"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDHomeInvitation home](self, "home");
...
{
  objc_storeStrong((id *)&self->_idsInvitationUUID, a3);
}
...
{
  objc_storeStrong((id *)&self->_shareToken, a3);
}
...
void __27__HMDHomeInvitation_expire__block_invoke(uint64_t a1)
{
        ...
        v4))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 2112;
      v17 = v8;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Calling invitation (%@) expiration handler", (uint8_t *)&v14, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 2112;
      v17 = v13;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Not calling invitation (%@) expiration handler, not set", (uint8_t *)&v14, 0x16u);
