...
- (void)readMigratorRecord
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Going to read migrator record from : %@", buf, 0x16u);
  ...
  v15 = 0;
  objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfFile:options:error:", v8, 2, &v15);
  ...
  if (v10 || !v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v10;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Current device is not the migrator: %@", buf, 0x16u);
...
- (void)unarchiveRecordFromData:(id)a3
{
  ...
  if (v5)
  {
    v6 = (void *)MEMORY[0x227676638](-[HMDHH2MigratorRecord updateValuesFromDict:](self, "updateValuesFromDict:", v5));
    v7 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Successfully got the HH2 Migrator record : %@", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the valid HH2 Migrator record from stored archive.", (uint8_t *)&v13, 0xCu);
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%lu"), -[HMDHH2MigratorRecord currentMigrationAttempt](self, "currentMigrationAttempt"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_10:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        v10 = 138543362;
        v11 = v8;
        _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot prepare HH2 migrator record", (uint8_t *)&v10, 0xCu);
...
- (BOOL)writeMigratorRecord:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to create an archive of the HH2 migrator record : %@", (uint8_t *)&v19, 0x16u);
LABEL_9:
...
LABEL_10:
  ...
  if ((v7 & 1) == 0)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v17;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to write the HH2 migrator record to %@", (uint8_t *)&v19, 0x16u);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v14;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Successfully written HH2 migrator record to disk: %@ : %@", (uint8_t *)&v19, 0x20u);
...
- (BOOL)writeToDisk
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot prepare HH2 migrator record dictionary", (uint8_t *)&v10, 0xCu);
...
LABEL_11:
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, v11, (uint8_t *)&v18, 0xCu);
...
LABEL_12:
  ...
  if (-[HMDHH2MigratorRecord migrateFromTestDirectory](self, "migrateFromTestDirectory"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Not enforcing the migration attempt as we are doing migration from test directory", (uint8_t *)&v18, 0xCu);
...
LABEL_13:
  v13 = (void *)MEMORY[0x227676638](-[HMDHH2MigratorRecord setCurrentMigrationAttempt:](self, "setCurrentMigrationAttempt:", -[HMDHH2MigratorRecord currentMigrationAttempt](self, "currentMigrationAttempt") + 1));
  v14 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 1024;
    v21 = v17;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Increased migration attempt to %u", (uint8_t *)&v18, 0x12u);
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to remove migration record from disk %@ (%@)", buf, 0x20u);
...
+ (id)singleRecord
{
  if (singleRecord_onceToken != -1)
    dispatch_once(&singleRecord_onceToken, &__block_literal_global_116459);
  return (id)singleRecord_singleMigratorRecord;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t4_116454 != -1)
    dispatch_once(&logCategory__hmf_once_t4_116454, &__block_literal_global_13_116455);
  return (id)logCategory__hmf_once_v5_116456;
}
...
+ (id)archiveMigratorDict:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Going to archive : %@", (uint8_t *)&v11, 0x16u);
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v25 = 2112;
      v26 = v13;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive HMDHH2MigratorRecord from archive data: %@", buf, 0x16u);
...
+ (BOOL)recordMigrationFailureWithError:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDBCED8], "dictionary");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setObject:forKeyedSubscript:", v5, *MEMORY[0x24BDD5FD8]);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = 2112;
    v32 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Going to write migration failure record : [%@] -> [%@]", (uint8_t *)&v27, 0x20u);
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 22;
LABEL_13:
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, v23, (uint8_t *)&v27, v25);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v31 = 2112;
    v32 = v7;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully written migration failure record on disk : %@, %@", (uint8_t *)&v27, 0x20u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = (uint64_t)v2;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Found migration failure record on disk at %@. Going to read it.", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v5);
    v51 = 0;
    objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfFile:options:error:", v2, 2, &v51);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v51;
    if (v9)
    {
      ...
      if (v18)
      {
        ...
        if (v21)
        {
          objc_msgSend(v20, "objectForKeyedSubscript:", *MEMORY[0x24BDD5FD8]);
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Successfully read the migration failure record %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v56 = 2112;
            v57 = (uint64_t)v20;
            _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to open the migration failure record from archive data: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v56 = 2112;
          v57 = (uint64_t)v19;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive migration failure record from archive data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = (uint64_t)v10;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Unable to read the migration failure record due to an error: [%@]", buf, 0x16u);
...
void __35__HMDHH2MigratorRecord_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_116456;
  logCategory__hmf_once_v5_116456 = v0;
