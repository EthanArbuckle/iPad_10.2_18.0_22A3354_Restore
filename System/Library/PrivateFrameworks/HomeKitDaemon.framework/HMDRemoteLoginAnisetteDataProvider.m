...
- (void)provisionAnisetteWithCompletion:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD78F0]), "initNewMessage");
...
- (void)syncAnisetteWithSIMData:(id)a3 completion:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A30]), "initNewMessage");
...
- (void)eraseAnisetteWithCompletion:(id)a3
{
  ...
  v17[1] = *MEMORY[0x24BDAC8D0];
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7628]), "initNewMessage");
  objc_msgSend(v5, "messageName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = v6;
  encodeRootObject();
...
- (void)fetchAnisetteDataAndProvisionIfNecessary:(BOOL)a3 withCompletion:(id)a4
{
  ...
  v6 = a4;
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7690]), "initNewMessage");
...
- (void)legacyAnisetteDataForDSID:(id)a3 withCompletion:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7730]), "initNewMessage");
...
void __79__HMDRemoteLoginAnisetteDataProvider_legacyAnisetteDataForDSID_withCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  objc_msgSend(MEMORY[0x24BDD7738], "objWithDict:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v8;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Received %@", (uint8_t *)&v15, 0x16u);
...
void __94__HMDRemoteLoginAnisetteDataProvider_fetchAnisetteDataAndProvisionIfNecessary_withCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = a3;
  WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  objc_msgSend(MEMORY[0x24BDD7698], "objWithDict:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)MEMORY[0x227676638]();
  v10 = WeakRetained;
  HMFGetOSLogHandle();
...
void __66__HMDRemoteLoginAnisetteDataProvider_eraseAnisetteWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = a3;
  WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  objc_msgSend(MEMORY[0x24BDD7630], "objWithDict:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)MEMORY[0x227676638]();
  v10 = WeakRetained;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Received %@", (uint8_t *)&v13, 0x16u);
...
void __73__HMDRemoteLoginAnisetteDataProvider_syncAnisetteWithSIMData_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = a3;
  WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  objc_msgSend(MEMORY[0x24BDD7A38], "objWithDict:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)MEMORY[0x227676638]();
  v10 = WeakRetained;
  HMFGetOSLogHandle();
...
void __70__HMDRemoteLoginAnisetteDataProvider_provisionAnisetteWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = a3;
  WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  objc_msgSend(MEMORY[0x24BDD78F8], "objWithDict:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)MEMORY[0x227676638]();
  v10 = WeakRetained;
  HMFGetOSLogHandle();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_85663 != -1)
    dispatch_once(&logCategory__hmf_once_t0_85663, &__block_literal_global_85664);
  return (id)logCategory__hmf_once_v1_85665;
}
...
void __49__HMDRemoteLoginAnisetteDataProvider_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_85665;
  logCategory__hmf_once_v1_85665 = v0;
