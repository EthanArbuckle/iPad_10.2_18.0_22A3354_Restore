...
+ (HMDXPCMessageTransport)defaultTransport
{
  if (defaultTransport_onceToken != -1)
    dispatch_once(&defaultTransport_onceToken, &__block_literal_global_94982);
  return (HMDXPCMessageTransport *)(id)defaultTransport_defaultTransport;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t6_94974 != -1)
    dispatch_once(&logCategory__hmf_once_t6_94974, &__block_literal_global_95_94975);
  return (id)logCategory__hmf_once_v7_94976;
}
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v54 = 2112;
    v55 = v6;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@New XPC connection requested: %@", buf, 0x16u);
  ...
  if ((v15 & v14) != v14)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v56 = 2112;
      v57 = v12;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Rejecting connection missing entitlements %@: %@", buf, 0x20u);
  ...
  if ((objc_msgSend(v12, "isAuthorizedForHomeDataAccess") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", objc_msgSend(v12, "clientPid"));
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543618;
      v53 = v26;
      v54 = 2112;
      v55 = v27;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Rejecting connection from client with PID %@ because it is not authorized for Home data access", buf, 0x16u);
...
LABEL_16:
  ...
  v35 = (void *)MEMORY[0x227676638](objc_msgSend(v6, "setInvalidationHandler:", v41));
  v36 = v8;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v54 = 2112;
    v55 = v12;
    _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Resuming new XPC connection: %@", buf, 0x16u);
...
LABEL_11:
  ...
  if (v15)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_2557DB690);
    v20 = objc_claimAutoreleasedReturnValue();
    exportedInterface = v15->_exportedInterface;
    v15->_exportedInterface = (NSXPCInterface *)v20;

    objc_msgSend(MEMORY[0x24BDD1990], "interfaceWithProtocol:", &unk_255908F00);
    v22 = objc_claimAutoreleasedReturnValue();
    ...
    v15->_clientConnectionFactory = &__block_literal_global_68_94960;
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 138543362;
    v15 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting XPC message transport", (uint8_t *)&v14, 0xCu);
...
- (void)stop
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping XPC message transport", (uint8_t *)&v8, 0xCu);
...
- (NSDictionary)stateDump
{
  ...
  objc_msgSend(v3, "na_map:", &__block_literal_global_75_94934);
...
void __61__HMDXPCMessageTransport_listener_shouldAcceptNewConnection___block_invoke_100(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Daemon received interruption for %@", (uint8_t *)&v8, 0x16u);
...
void __61__HMDXPCMessageTransport_listener_shouldAcceptNewConnection___block_invoke_101(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Daemon received invalidation for %@", (uint8_t *)&v12, 0x16u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&v70[16] = 16;
      ...
      v77 = 2114;
      v78 = v38;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Sent message %{public}@(%{public,uuid_t}.16P) with target %{uuid_t}.16P to %{public}lu/%{public}lu clients with message send policy %{public}@", buf, 0x54u);
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v65, 14);
      ...
      *(_WORD *)&v70[8] = 2114;
      *(_QWORD *)&v70[10] = v53;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Sent message %{public}@ with payload: %{public}@ (skipped ineligible clients: %{public}@)", buf, 0x2Au);
...
LABEL_18:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&v70[16] = 16;
    ...
    v73 = 2114;
    v74 = v31;
    _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Not sending message %{public}@(%{public,uuid_t}.16P) with target %{uuid_t}.16P because no clients are eligible for send policy: %{public}@", buf, 0x40u);
...
void __56__HMDXPCMessageTransport_sendMessage_completionHandler___block_invoke_89(uint64_t a1)
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 54, CFSTR("Failed to send message."), CFSTR("No eligible clients"), 0);
...
+ (HMDXPCMessageTransport)accessorySetupTransport
{
  if (accessorySetupTransport_onceToken != -1)
    dispatch_once(&accessorySetupTransport_onceToken, &__block_literal_global_5_94979);
...
void __37__HMDXPCMessageTransport_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_94976;
  logCategory__hmf_once_v7_94976 = v0;
...
void __49__HMDXPCMessageTransport_accessorySetupTransport__block_invoke()
{
  ...
  v0 = objc_alloc(MEMORY[0x24BDD7870]);
  v3 = (id)objc_msgSend(v0, "initWithMachServiceName:", *MEMORY[0x24BDD7280]);
...
void __42__HMDXPCMessageTransport_defaultTransport__block_invoke()
{
  ...
  v0 = objc_alloc(MEMORY[0x24BDD7870]);
  v3 = (id)objc_msgSend(v0, "initWithMachServiceName:", *MEMORY[0x24BDD72B0]);
  objc_msgSend(v3, "setRequiredEntitlements:", 1);
