...
- (HMDCameraSnapshotSessionID)initWithAccessory:(id)a3 message:(id)a4
{
  ...
  if (v8)
  {
    ...
    v14 = objc_msgSend(v7, "BOOLForKey:", *MEMORY[0x24BDD5608]);
    v15 = v14;
    if (v9)
      v16 = 1;
    else
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v7;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Snapshot session ID is not present in message: %@", buf, 0x16u);
