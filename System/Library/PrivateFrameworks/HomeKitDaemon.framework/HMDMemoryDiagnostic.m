...
+ (void)configureMemoryDiagnostic
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v9;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Setting diagnostic memory limit for build %@ to %@MB", (uint8_t *)&v23, 0x20u);
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v14;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to set diagnostic memory limit: %@", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 138543362;
      v24 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current build version, return", (uint8_t *)&v23, 0xCu);
...
+ (id)_configureCurrentProcessLevel:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("memorystatus_control returned %d"), v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6)
  {
    ...
    if (v7 && objc_msgSend(v4, "isEqualToString:", v7))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 2112;
        v19 = v8;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Previous diagnostic memory limit for build %@ is set to %@MB", (uint8_t *)&v14, 0x20u);
...
+ (id)_nextLevelFromPreviousLevel:(id)a3
{
  ...
  v13 = &v12;
  v14 = 0x3032000000;
  v15 = __Block_byref_object_copy__30476;
  v16 = __Block_byref_object_dispose__30477;
  v4 = a3;
  v17 = v4;
