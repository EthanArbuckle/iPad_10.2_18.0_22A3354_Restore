...
LABEL_28:
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v54 = 2112;
    v55 = v24;
    _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Local network config: %@", buf, 0x16u);
  ...
  if (v48)
  {
    ...
    else
    {
      if (!isiOSDevice())
      {
        objc_msgSend(MEMORY[0x24BDBCE88], "exceptionWithName:reason:userInfo:", *MEMORY[0x24BDBCAB0], CFSTR("Cannot relay stream from current device"), 0);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@is being deallocated, stopping stream", buf, 0xCu);
...
- (void)setUpRemoteConnectionWithDevice:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Remote setup - this should not be called", (uint8_t *)&v9, 0xCu);
...
- (void)_negotiateStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v47 = 138543362;
    v48 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Received a request to negotiate video stream", (uint8_t *)&v47, 0xCu);
  ...
  if ((_DWORD)v8)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v47 = 138543362;
      v48 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Supported config cache is valid, using it", (uint8_t *)&v47, 0xCu);
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      v49 = 2112;
      v50 = v32;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Cached supportedVideoConfiguration: %@", (uint8_t *)&v47, 0x16u);
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      v49 = 2112;
      v50 = v39;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Cached supportedAudioConfiguration: %@", (uint8_t *)&v47, 0x16u);
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      v49 = 2112;
      v50 = v46;
      _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Cached supportedRTPConfiguration: %@", (uint8_t *)&v47, 0x16u);
...
- (void)_getSupportedConfigurations
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Getting Supported Configuration", buf, 0xCu);
  ...
  if (v9)
  {
    ...
    objc_msgSend(v10, "findCharacteristicWithType:", *MEMORY[0x24BE1B5F8]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();

    -[HMDCameraStreamControlManager streamManagementService](v4, "streamManagementService");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "findCharacteristicWithType:", *MEMORY[0x24BE1B600]);
    v13 = (void *)objc_claimAutoreleasedReturnValue();

    -[HMDCameraStreamControlManager streamManagementService](v4, "streamManagementService");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "findCharacteristicWithType:", *MEMORY[0x24BE1B5F0]);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleSupportedParameters:(id)a3
{
  ...
  if (v3)
  {
    ...
    v64 = 0;
    v5 = *(_QWORD *)v68;
    v63 = *MEMORY[0x24BE1B600];
    v61 = *MEMORY[0x24BE1B5F0];
    v60 = *MEMORY[0x24BE1B5F8];
    while (1)
    {
      for (i = 0; i != v4; ++i)
      {
...
LABEL_18:
  ...
  if (v66 && v64 && v62)
  {
    ...
    if (v26 && v27 && v28)
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Updating supportedVideoConfiguration: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Updating supportedAudioConfiguration: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v73 = 2112;
        v74 = v29;
        _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_INFO, "%{public}@Updating supportedRTPConfiguration: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v72 = v58;
        _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_ERROR, "%{public}@Response from accessory is not valid for at least one configuration", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v72 = v54;
      _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_ERROR, "%{public}@Accessory did not respond to all requests", buf, 0xCu);
...
- (void)_writeSetupEndPoint
{
  ...
  if (v19)
  {
    ...
    if ((v28 & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v76 = 2112;
        v77 = v39;
        _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Writing setup endpoint characteristic value: %@", buf, 0x16u);
      ...
      if (v43)
      {
        ...
        if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v75 = v68;
          _os_log_impl(&dword_2218F0000, v67, OS_LOG_TYPE_ERROR, "%{public}@Could not select the end point setup parameters", buf, 0xCu);
      ...
      else
      {
        ...
        if (v46)
        {
          ...
          objc_msgSend(v47, "findCharacteristicWithType:", *MEMORY[0x24BE1B5D8]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v75 = v64;
        _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_ERROR, "%{public}@Could not find the right match in the supported list", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v75 = v60;
      _os_log_impl(&dword_2218F0000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to create stream manager for local stream", buf, 0xCu);
...
- (void)_sendSetupEndPointRead
{
  ...
  if (v5)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "findCharacteristicWithType:", *MEMORY[0x24BE1B5D8]);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Reading setup endpoint characteristic", buf, 0xCu);
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v60 = 2112;
          v61 = v19;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Received setup endpoint read response: %@", buf, 0x16u);
        ...
        if (-[HMDSetupEndPointRead responseStatus](v19, "responseStatus"))
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v60 = 2112;
            v61 = v30;
            _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Accessory setup endpoint read failed: %@", buf, 0x16u);
...
LABEL_33:
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v59 = v50;
          _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_ERROR, "%{public}@Validation of setup endpoint failed", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v59 = v38;
          _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to construct setup endpoint", buf, 0xCu);
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v59 = v34;
    _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Accessory did not respond to all requests", buf, 0xCu);
...
LABEL_11:
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, v23, (uint8_t *)&v27, 0xCu);
...
- (void)_startStreamWithRemoteSettings:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v65 = 2112;
    v66 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received request to start stream with remote settings: %@", buf, 0x16u);
  ...
  if (-[HMDCameraLocalStreamControlManager isSendingStream](v6, "isSendingStream"))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v64 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Using the sync sources from remote settings", buf, 0xCu);
  ...
  else
  {
    ...
    {
LABEL_14:
      v43 = (void *)MEMORY[0x227676638](-[HMDCameraStreamControlManager _reportInternalErrorCode:](v6, "_reportInternalErrorCode:", 1045));
      v44 = v6;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v64 = v46;
        _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_INFO, "%{public}@SSRC is nil, cannot select config parameters", buf, 0xCu);
  ...
  if (v32)
  {
    ...
    if (v35 >= v36)
    {
      if (v40)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v64 = v48;
        _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@Remote MTU is provided, and is lower than local MTU", buf, 0xCu);
...
LABEL_19:
      _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, v42, buf, 0xCu);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v69 = 2112;
    v70 = v50;
    _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_INFO, "%{public}@Remote MTU %@, Local MTU %@, Picked MTU %@", buf, 0x2Au);
...
- (id)_calculateMTU
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v11;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Reporting stream sender reported MTU %@", (uint8_t *)&v22, 0x16u);
...
LABEL_9:
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v41 = 2112;
        v42 = v32;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Current state: %@, waiting", buf, 0x16u);
...
LABEL_10:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v36;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Could not extract a configuration from the given parameters", buf, 0xCu);
...
- (void)_stopCurrentStreamSessionWithError:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Session is not in progress", (uint8_t *)&v11, 0xCu);
...
- (void)_writeStartConfig
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v5;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Writing start stream configuration: %@", (uint8_t *)&v11, 0x16u);
...
- (void)_writeReselectConfig
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v5;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Writing reselect stream configuration: %@", (uint8_t *)&v11, 0x16u);
...
- (void)_writeSelectConfig:(id)a3 reconfigure:(BOOL)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Writing characteristic for selected stream configuration", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v10);
    -[HMDCameraStreamControlManager streamManagementService](v11, "streamManagementService");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "findCharacteristicWithType:", *MEMORY[0x24BE1B5D0]);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_writeStopConfig:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Stopping the stream right away", buf, 0xCu);
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v22;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Writing stop stream configuration: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v23);
      -[HMDCameraStreamControlManager streamManagementService](v24, "streamManagementService");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v27, "findCharacteristicWithType:", *MEMORY[0x24BE1B5D0]);
      v28 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v33;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@No current stream session to write stop config for", buf, 0xCu);
...
- (void)_cleanUpStreamSessionWithError:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Cleaning up the stream", (uint8_t *)&v12, 0xCu);
  ...
  else
  {
    if (v9)
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@No current stream session to clean up", (uint8_t *)&v12, 0xCu);
...
- (void)sessionInitiator:(id)a3 didSetUpWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up IDSSession for stream", (uint8_t *)&v17, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Session initiator is setup", (uint8_t *)&v17, 0xCu);
...
- (void)sessionInitiator:(id)a3 didEndSessionWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Session stopped, stopping the stream", (uint8_t *)&v12, 0xCu);
...
- (void)deviceConnectionSender:(id)a3 didSetUpWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up IDSDeviceConnection for stream", (uint8_t *)&v17, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Device connection sender is set up", (uint8_t *)&v17, 0xCu);
...
- (void)streamManager:(id)a3 didStartStreamWithError:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Stream manager did start stream", (uint8_t *)&v12, 0xCu);
...
- (void)streamManagerDidNetworkImprove:(id)a3
{
  ...
  if (v7)
  {
    if (v11)
    {
      ...
      v16 = 138543362;
      v17 = v12;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Picked a higher tier", (uint8_t *)&v16, 0xCu);
  ...
  else
  {
    if (v11)
    {
      ...
      v16 = 138543362;
      v17 = v13;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Already in highest tier, not changing the tier", (uint8_t *)&v16, 0xCu);
...
- (void)streamManagerDidNetworkDeteriorate:(id)a3
{
  ...
  if (v7)
  {
    if (v11)
    {
      ...
      v16 = 138543362;
      v17 = v12;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Picked a lower tier", (uint8_t *)&v16, 0xCu);
  ...
  else
  {
    if (v11)
    {
      ...
      v16 = 138543362;
      v17 = v13;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Already in lowest tier, not changing the tier", (uint8_t *)&v16, 0xCu);
...
- (void)streamManagerDidUpdateConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Stream configuration update complete", (uint8_t *)&v11, 0xCu);
...
- (void)_sendUpdatedConfiguration
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v6;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Sending updated configuration", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v21 = v18;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Reselected config failed to extract", buf, 0xCu);
...
LABEL_9:
    _os_log_impl(&dword_2218F0000, v14, v15, v13, (uint8_t *)&v16, 0xCu);
    goto LABEL_10;
  }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    v18 = 2112;
    v19 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@The stop stream configuration characteristic write failed: %@", (uint8_t *)&v16, 0x16u);
...
void __69__HMDCameraLocalStreamControlManager__writeSelectConfig_reconfigure___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received response for selected stream configuration write characteristic", (uint8_t *)&v22, 0xCu);
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
        {
          ...
          v24 = 2114;
          v25 = v16;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Write reply ended in error response: %{public}@", (uint8_t *)&v22, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 138543362;
        v23 = v21;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@The write reply does not contain a response", (uint8_t *)&v22, 0xCu);
...
uint64_t __58__HMDCameraLocalStreamControlManager_stopStreamWithError___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Received request to stop the stream with session ID %@", (uint8_t *)&v13, 0x16u);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to stop", (uint8_t *)&v13, 0xCu);
...
void __57__HMDCameraLocalStreamControlManager__reconfigureStream___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2112;
    v35 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Received request to reconfigure the stream with session ID %@", buf, 0x16u);
  ...
  if (v7)
  {
    ...
    {
      v31 = 0;
      objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v8, &v31);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = v31;
      ...
      if (v9)
      {
        if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v36 = 2112;
          v37 = v9;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Updating the current picked tier from %@ to %@", buf, 0x20u);
      ...
      else
      {
        if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v34 = 2112;
          v35 = v10;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera video tier from video tier data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v33 = v28;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Missing reconfigured tier data", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v24;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to reconfigure", buf, 0xCu);
...
void __60__HMDCameraLocalStreamControlManager__sendSetupEndPointRead__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received response for setup endpoint read", (uint8_t *)&v9, 0xCu);
...
void __57__HMDCameraLocalStreamControlManager__writeSetupEndPoint__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Received response for setup endpoint write", buf, 0xCu);
...
LABEL_6:
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v41 = 2112;
        v42 = v27;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@The setup endpoint write reply errored out: %@", buf, 0x16u);
...
LABEL_18:
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v40 = v32;
        _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@The setup endpoint write reply does not contain a response", buf, 0xCu);
...
void __65__HMDCameraLocalStreamControlManager__getSupportedConfigurations__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received response for supported configurations", (uint8_t *)&v9, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t72_149565 != -1)
    dispatch_once(&logCategory__hmf_once_t72_149565, &__block_literal_global_149566);
  return (id)logCategory__hmf_once_v73_149567;
}
...
void __49__HMDCameraLocalStreamControlManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v73_149567;
  logCategory__hmf_once_v73_149567 = v0;
