...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_136447 != -1)
    dispatch_once(&hmbProperties_onceToken_136447, &__block_literal_global_136448);
  return (id)hmbProperties__properties_136449;
}
...
void __57__HMDCameraRecordingReachabilityEventModel_hmbProperties__block_invoke()
{
  ...
  v3 = (void *)hmbProperties__properties_136449;
  hmbProperties__properties_136449 = v2;
...
- (id)createEvent
{
  ...
  if (v3)
  {
    v4 = objc_alloc(MEMORY[0x24BDD7588]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot create reachability event from model: %@", (uint8_t *)&v14, 0x16u);
