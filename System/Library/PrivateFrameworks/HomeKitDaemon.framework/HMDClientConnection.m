...
- (void)_registerForMessages
{
  ...
  objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD7E08], self, v5, sel__handleSiriIntentRequest_);
  ...
  objc_msgSend(v8, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5AC0], self, v7, sel__handleSiriCommand_);

  -[HMDClientConnection msgDispatcher](self, "msgDispatcher");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5AC8], self, v7, sel__handleSiriSyncDataRequest_);
  ...
  if (v11 == 6)
  {
    ...
    v13 = *MEMORY[0x24BDD5AB8];
    +[HMDXPCMessagePolicy policyWithEntitlements:](HMDXPCMessagePolicy, "policyWithEntitlements:", 5);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v19[0] = v14;
    v18 = *MEMORY[0x24BDD51A8];
...
- (void)_handleSiriCommand:(id)a3
{
  ...
  v46 = a3;
  v5 = objc_alloc(MEMORY[0x24BE3F138]);
  v6 = (void *)MEMORY[0x24BDD17C8];
  MEMORY[0x227675180](self, a2);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "stringWithFormat:", CFSTR("%@, %s:%ld"), v7, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Messaging/XPC/HMDClientConnection.m", 121);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD1620], "deserializeObjectWithData:allowedClass:frameworkClasses:", v43, objc_opt_class(), &unk_24E971138);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v66 = 2112;
    v67 = v20;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Incoming Siri command(%{public}@) serverValidity %{public}@:\n%@", buf, 0x34u);
    ...
    && (objc_msgSend(v45, "isAccessAllowedWhenLocked") & 1) == 0)
  {
    ...
    v24 = objc_alloc_init(MEMORY[0x24BE812B8]);
    v25 = v24;
    if (v21)
    {
      objc_msgSend(v24, "setCommandOutcome:", *MEMORY[0x24BE81EC0]);
    ...
    {
      objc_msgSend(v24, "setCommandOutcome:", *MEMORY[0x24BE81EB0]);
      v26 = objc_alloc_init(MEMORY[0x24BE812A0]);
      objc_msgSend(v26, "setOutcome:", *MEMORY[0x24BE81BF8]);
      v57 = v26;
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v64 = 2112;
      v65 = v38;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@%@ - response for Siri command(%@): %@", buf, 0x2Au);
...
- (void)_handleSiriIntentRequest:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "dataForKey:", *MEMORY[0x24BDD7E00]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    v33 = 0;
    objc_msgSend(MEMORY[0x24BDD1620], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v5, &v33);
    ...
    if (v6)
    {
      ...
      objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD7E10]);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v10)
      {
        if (v15)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v39 = v16;
          v17 = (void *)v16;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Error - Data sync in progress - Unable to %@ intent [ %@ ] ", buf, 0x20u);

        }
        objc_autoreleasePoolPop(v12);
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 77);
        v18 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        if (v15)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v38 = 2112;
          v39 = (uint64_t)v29;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Received to %@ intent: [ %@ ]", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v36 = 2112;
        v37 = v7;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive control home intent from the message payload data: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Error - Did not get the intent", buf, 0xCu);
...
void __42__HMDClientConnection__handleSiriCommand___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    v44 = v6;
    v45 = v5;
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE812B8]), "initWithDictionary:", v5);
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v58 = 2114;
      v59 = v16;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Outgoing Response for Siri command(%{public}@): %{public}@", buf, 0x2Au);
...
LABEL_18:
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v56 = 2114;
      v57 = v6;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Error executing Siri command: %{public}@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v53 = v30;
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Nil response for Siri command", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_166213 != -1)
    dispatch_once(&logCategory__hmf_once_t10_166213, &__block_literal_global_166214);
  return (id)logCategory__hmf_once_v11_166215;
}
...
void __34__HMDClientConnection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_166215;
  logCategory__hmf_once_v11_166215 = v0;
