...
LABEL_35:
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, v28, (uint8_t *)&v34, 0xCu);
...
LABEL_18:
            _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, v20, (uint8_t *)&v34, 0xCu);
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          v36 = 2112;
          v37 = v31;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Non-resident - shouldn't be here; region status:%@, policy status(AnyUserAtHome):NO",
            (uint8_t *)&v34,
            0x16u);
...
LABEL_28:
    _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, v25, (uint8_t *)&v34, 0xCu);
LABEL_29:
...
LABEL_10:
          ...
          v36 = 2112;
          v37 = v13;
          _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Resident, policy status evaluated to %@", (uint8_t *)&v34, 0x16u);
...
uint64_t __65__HMDAccessoryFirmwareUpdatePresencePolicy_handlePresenceChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Presence has changed, updating policy status", (uint8_t *)&v7, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_145667 != -1)
    dispatch_once(&logCategory__hmf_once_t0_145667, &__block_literal_global_145668);
  return (id)logCategory__hmf_once_v1_145669;
}
...
void __55__HMDAccessoryFirmwareUpdatePresencePolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_145669;
  logCategory__hmf_once_v1_145669 = v0;
