  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to create reconnaissance session with nil identifier", buf, 0xCu);
  ...
  if (v3 != -1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v16 = 1024;
      v17 = v4;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting features: %u", buf, 0x12u);

    }
    objc_autoreleasePoolPop(v5);
  }
  accessoryIdentifier = self->_accessoryIdentifier;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", &accessoryIdentifier, 1);
      ...
      if (!-[__CFArray count](a2, "count"))
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v38 = 2112;
          v39 = a4;
          _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find accessory with error: %@", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v28);
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 2, 0, 0, 0, a4);
...
LABEL_23:
    ...
    v13 = 0;
    p_info = &OBJC_METACLASS___HMDMediaPlaybackActionModel.info;
    v15 = &OBJC_IVAR___HMDCameraBulletinNotificationManager__currentPrimary;
    v35 = v11;
    do
    {
      v16 = (void *)objc_msgSend(objc_alloc((Class)(p_info + 246)), "initWithOutputDevice:", CFArrayGetValueAtIndex(a2, v13));
      v17 = v16;
      if (v16)
      {
        v18 = *(void **)&v8[v15[281]];
        ...
        if ((_DWORD)v18)
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v38 = 2112;
            v39 = v17;
            _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Found output device: %@", buf, 0x16u);
...
+ (double)defaultTimeout
{
  if (defaultTimeout_onceToken != -1)
    dispatch_once(&defaultTimeout_onceToken, &__block_literal_global_63768);
  return *(double *)&defaultTimeout_timeout;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t9_63763 != -1)
    dispatch_once(&logCategory__hmf_once_t9_63763, &__block_literal_global_13_63764);
  return (id)logCategory__hmf_once_v10_63765;
}
...
void __47__HMDMediaAccessoryBrowseOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_63765;
  logCategory__hmf_once_v10_63765 = v0;
