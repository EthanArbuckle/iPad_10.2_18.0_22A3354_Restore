...
- (void)refreshCurrentDevicePrimaryResidentWithDevice:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v5;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating is current device primary resident: %@ using device: %@", (uint8_t *)&v12, 0x20u);
...
- (void)refreshConfirmedPrimaryResidentDeviceIdentifierWithDevice:(id)a3
{
  ...
  if ((v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v5;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating confirmed primary resident device identifier: %@ using device: %@", (uint8_t *)&v13, 0x20u);
...
- (void)refreshHasResidentDevices
{
  ...
  if (v3 != -[HMDPrimaryResidentChangeMonitor hasResidentDevices](self, "hasResidentDevices"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v8;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Updating has resident devices: %@", (uint8_t *)&v9, 0x16u);
...
- (id)confirmedPrimaryResidentDevice
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get confirmed primary resident device due to no data source", (uint8_t *)&v11, 0xCu);
...
- (BOOL)dataSourceHasResidentDevices
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to source has resident devices due to no data source", (uint8_t *)&v11, 0xCu);
...
- (void)notifyChangeToIsCurrentPrimaryResident
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Posting HMDPrimaryResidentChangeMonitorIsCurrentDeviceChangeNotification notification", (uint8_t *)&v8, 0xCu);
...
- (void)notifyChangeToConfirmedPrimaryResidentDeviceIdentifier
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Posting HMDPrimaryResidentChangeMonitorConfirmedDeviceIdentifierChangeNotification notification", (uint8_t *)&v8, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_77496 != -1)
    dispatch_once(&logCategory__hmf_once_t7_77496, &__block_literal_global_77497);
  return (id)logCategory__hmf_once_v8_77498;
}
...
void __46__HMDPrimaryResidentChangeMonitor_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_77498;
  logCategory__hmf_once_v8_77498 = v0;
