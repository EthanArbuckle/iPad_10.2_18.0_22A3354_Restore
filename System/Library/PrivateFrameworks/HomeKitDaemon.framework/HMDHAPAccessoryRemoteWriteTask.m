...
- (BOOL)_appendServiceListWithRequest:(id)a3 serviceList:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (v17)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@-%@"), v15, CFSTR("kAuthorizationDataKey"));
    ...
    if (v24)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@-%@"), v22, CFSTR("kCharacteristicContextDataForWriteKey"));
    ...
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v9, "includeResponseValue"));
