...
- (void)subscribeToWiFiInfoUpdate
{
  ...
  if (v4)
  {
    ...
    v11[4] = self;
    v12 = v4;
    objc_msgSend(v5, "changeRegistrationsForConsumer:topicFilterAdditions:topicFilterRemovals:completion:", self, v6, MEMORY[0x24BDBD1A8], v11);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@wifi info topic is nil", buf, 0xCu);
...
- (void)didReceiveEvent:(id)a3 topic:(id)a4
{
  ...
  if (v9 && (v10 = objc_msgSend(v9, "accessoryEventTopicSuffixID"), v10 == *MEMORY[0x24BDD4BE8]))
  {
    v11 = v6;
    if (self)
    {
      v12 = objc_alloc(MEMORY[0x24BDD73F0]);
      ...
      if (v14)
      {
              ...
              (v17 & 1) == 0))
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v41 = v15;
            _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating received wifi info from: %@ to: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v41 = v22;
            _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Received wifi info: %@ saved wifi info: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v30;
          _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Error decoding the event to wifi info object", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v7;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Do not handle topic: %@", buf, 0x16u);
      ...
      for (i = 0; i != v21; ++i)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v41 = 2112;
          v42 = v24;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Received cached event: %@ topic: %@ during subscription", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_75918 != -1)
    dispatch_once(&logCategory__hmf_once_t8_75918, &__block_literal_global_75919);
  return (id)logCategory__hmf_once_v9_75920;
}
...
void __51__HMDAppleMediaAccessoryInfoSubscriber_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_75920;
  logCategory__hmf_once_v9_75920 = v0;
