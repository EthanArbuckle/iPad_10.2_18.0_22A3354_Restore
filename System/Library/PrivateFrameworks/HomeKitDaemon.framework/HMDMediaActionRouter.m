...
LABEL_19:
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v61 = 2112;
            v62 = v42;
            _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@For home %@, always using resident %@:%@ to execute Media Action scenes", buf, 0x2Au);
...
LABEL_15:
      v27 = (void *)MEMORY[0x227676638](v26);
      v28 = v5;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v61 = 2112;
        v62 = v33;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Couldn't find TargetResidentDevice %@ in home %@:%@", buf, 0x2Au);
...
- (void)routeMediaActionForExecution:(id)a3 source:(unint64_t)a4 clientName:(id)a5 completion:(id)a6
{
  ...
  objc_msgSend(v13, "na_map:", &__block_literal_global_121985);
  v14 = (void *)objc_claimAutoreleasedReturnValue();

  v15 = [HMDMediaPlaybackActionEvent alloc];
  objc_msgSend(v9, "playbackArchive");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v9, "state"));
...
- (void)routeSessionDataForExecution:(id)a3 encodePlaybackArchive:(BOOL)a4 completion:(id)a5
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmfErrorWithCode:reason:", 3, CFSTR("Session Data is nil, could not send action"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to package media action for execution, invalid message payload", (uint8_t *)&v18, 0xCu);
...
- (void)sendMediaActionMessageToCompanionWithSessionData:(id)a3 encodePlaybackArchive:(BOOL)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v20 = v13;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Running media action on companion", buf, 0xCu);
...
- (void)sendMediaActionMessageToDevice:(id)a3 sessionData:(id)a4 encodePlaybackArchive:(BOOL)a5 canForwardMessage:(BOOL)a6 completion:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v47 = 2112;
    v48 = v24;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending media action to < %@ : %@ > canForward: %@", buf, 0x2Au);
...
LABEL_11:
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v22;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Forwarding media action for remote device: %@", buf, 0x16u);
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmfErrorWithCode:reason:", 3, CFSTR("Session Data nil"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to route media action for execution, invalid message payload", buf, 0xCu);
...
- (void)gatherTargetDevicesForExecutingMediaActionWithProfiles:(id)a3 targetSystemMediaApplication:(BOOL)a4 outResidentDevicesInMediaAction:(id *)a5 outHomePodsInMediaAction:(id *)a6 outResidentDevicesSupportingMediaActions:(id *)a7 outHomePodsSupportingMediaActions:(id *)a8 outNonOdeonHomePodsSupportingMediaActions:(id *)a9 outNonOdeonResidentDevicesSupportingMediaActions:(id *)a10 outNonOdeonResidentDevicesInMediaAction:(id *)a11 outNonOdeonHomePodsInMediaAction:(id *)a12 dataSource:(id)a13
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v84 = 2112;
    v85 = v21;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Available residents: %@", buf, 0x16u);
  ...
  objc_msgSend(v25, "na_map:", &__block_literal_global_34_121963);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)targetResidentDeviceForExecutingMediaActionWithProfiles:(id)a3 targetSystemMediaApplication:(BOOL)a4
{
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v154 = 2112;
        v155 = (uint64_t)v14;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@[Target Device] Picking resident device override: %@", buf, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v154 = 2112;
        v155 = (uint64_t)v21;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Available residents: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v156 = 2048;
        v157 = v32;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Number of reachable residents: %lu, number of residents in action: %lu", buf, 0x20u);

      }
      v135 = v24;

      objc_autoreleasePoolPop(context);
      v33 = objc_msgSend(v139, "na_any:", &__block_literal_global_35_121944);
      v34 = v33;
      if (v33)
        v35 = objc_msgSend(v25, "na_any:", &__block_literal_global_36_121945);
      else
        v35 = 0;
      objc_msgSend(v22, "na_firstObjectPassingTest:", &__block_literal_global_37_121946);
      v36 = (void *)objc_claimAutoreleasedReturnValue();
      if (v36)
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v154 = 2112;
          v155 = (uint64_t)v42;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a resident and part of action: %@", buf, 0x16u);
        ...
        if (v43)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v154 = 2112;
            v155 = (uint64_t)v49;
            _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking non-odeon HomePod in action: %@", buf, 0x16u);
          ...
          if (v50)
          {
            ...
            if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v154 = 2112;
              v155 = (uint64_t)v57;
              _os_log_impl(&dword_2218F0000, v54, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking non-odeon resident device in action: %@", buf, 0x16u);
            ...
            if (v119)
            {
              ...
              if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v154 = 2112;
                v155 = (uint64_t)v64;
                _os_log_impl(&dword_2218F0000, v61, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking HomePod in action: %@", buf, 0x16u);
              ...
              if (v118)
              {
                ...
                if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v154 = 2112;
                  v155 = (uint64_t)v71;
                  _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking resident device in action: %@", buf, 0x16u);
                ...
                if (v75)
                {
                  ...
                  if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v154 = 2112;
                    v155 = (uint64_t)v80;
                    _os_log_impl(&dword_2218F0000, v78, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a HomePod and not part of action and is non-odeon: %@", buf, 0x16u);
                  ...
                  if (v117)
                  {
                    ...
                    if (os_log_type_enabled(v85, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138543618;
                      ...
                      v154 = 2112;
                      v155 = (uint64_t)v87;
                      _os_log_impl(&dword_2218F0000, v85, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any non-odeon HomePod: %@", buf, 0x16u);
                    ...
                    if (v89)
                    {
                      ...
                      if (os_log_type_enabled(v92, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138543618;
                        ...
                        v154 = 2112;
                        v155 = (uint64_t)v94;
                        _os_log_impl(&dword_2218F0000, v92, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a resident and not part of action and is non-odeon: %@", buf, 0x16u);
                      ...
                      if (v95)
                      {
                        ...
                        if (os_log_type_enabled(v98, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *(_DWORD *)buf = 138543618;
                          ...
                          v154 = 2112;
                          v155 = (uint64_t)v100;
                          _os_log_impl(&dword_2218F0000, v98, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any HomePod resident: %@", buf, 0x16u);
                        ...
                        if (v116)
                        {
                          ...
                          if (os_log_type_enabled(v103, OS_LOG_TYPE_INFO))
                          {
                            ...
                            *(_DWORD *)buf = 138543618;
                            ...
                            v154 = 2112;
                            v155 = (uint64_t)v105;
                            _os_log_impl(&dword_2218F0000, v103, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any non-odeon resident: %@", buf, 0x16u);
                          ...
                          if (v15)
                          {
                            if (v108)
                            {
                              ...
                              *(_DWORD *)buf = 138543618;
                              ...
                              v154 = 2112;
                              v155 = (uint64_t)v110;
                              _os_log_impl(&dword_2218F0000, v107, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any resident: %@", buf, 0x16u);
                          ...
                          else
                          {
                            if (v108)
                            {
                              ...
                              *(_DWORD *)buf = 138543618;
                              ...
                              v154 = 2048;
                              v155 = v113;
                              _os_log_impl(&dword_2218F0000, v107, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Couldn't find media action resident to route to, out of %lu candidates", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v153 = v19;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid data source", buf, 0xCu);
...
- (void)executeMediaActionWithSessionData:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Running media action locally", (uint8_t *)&v13, 0xCu);
...
void __106__HMDMediaActionRouter_sendMediaActionMessageToCompanionWithSessionData_encodePlaybackArchive_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unable to execute media action on companion: %@", (uint8_t *)&v8, 0x16u);
...
void __102__HMDMediaActionRouter_sendMediaActionMessageToResident_sessionData_encodePlaybackArchive_completion___block_invoke(uint64_t a1, void *a2)
{
        ...
        (v5 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Device < %@ : %@ > unreachable, rerouting", (uint8_t *)&v13, 0x20u);
