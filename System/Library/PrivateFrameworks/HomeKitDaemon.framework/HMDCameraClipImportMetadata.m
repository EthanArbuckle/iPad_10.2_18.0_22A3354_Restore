...
- (id)initClipData:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v45 = 2112;
      v46 = v4;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Could not find start date string in clip data: %@", buf, 0x16u);
  ...
  v7 = (void *)v6;
  v8 = objc_alloc_init(MEMORY[0x24BDD15D0]);
    ...
    if (v10)
    {
      ...
      if (v11)
      {
        ...
        if (v12)
        {
          ...
          objc_msgSend(v11, "na_map:", &__block_literal_global_118_205546);
          v14 = objc_claimAutoreleasedReturnValue();
          posterFrames = v5->_posterFrames;
          v5->_posterFrames = (NSArray *)v14;

          objc_msgSend(v12, "na_map:", &__block_literal_global_121_205547);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v45 = 2112;
            v46 = v4;
            _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not find video fragments in clip data: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v45 = 2112;
          v46 = v4;
          _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Could not find poster frames in clip data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = v4;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not find target fragment duration in clip data: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v45 = 2112;
      v46 = v7;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not parse start date from string: %@", buf, 0x16u);
