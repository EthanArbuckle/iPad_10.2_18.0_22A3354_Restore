...
- (BOOL)validateForInsertOrUpdate:(id *)a3
{
  ...
  if (v5)
  {
    -[_MKFCameraReachabilityBulletinRegistration accessory](self, "accessory");
...
{
  return -[MKFObjectDatabaseID initWithMKFObject:]([MKFCameraReachabilityBulletinRegistrationDatabaseID alloc], "initWithMKFObject:", self);
}
...
- (MKFHome)home
{
  ...
  -[_MKFCameraReachabilityBulletinRegistration user](self, "user");
...
{
  return (Protocol *)&unk_255830938;
}

+ (id)fetchRequest
{
  return (id)objc_msgSend(MEMORY[0x24BDBB678], "fetchRequestWithEntityName:", CFSTR("MKFCameraReachabilityBulletinRegistration"));
}
