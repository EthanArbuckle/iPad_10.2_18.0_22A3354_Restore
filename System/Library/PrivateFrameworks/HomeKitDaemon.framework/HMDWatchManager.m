  ...
  if (v8 == v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Devices changed: %@", buf, 0x16u);
...
- (void)service:(id)a3 connectedDevicesChanged:(id)a4
{
  ...
  if (v8 == v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 2112;
      v16 = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Connected devices changed: %@", (uint8_t *)&v13, 0x16u);
...
+ (id)sharedManager
{
  ...
  if (+[HMDDeviceCapabilities isCompanionCapable](HMDDeviceCapabilities, "isCompanionCapable"))
  {
    ...
    block[4] = a1;
    if (sharedManager_onceToken_204115 != -1)
      dispatch_once(&sharedManager_onceToken_204115, block);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_204107 != -1)
    dispatch_once(&logCategory__hmf_once_t7_204107, &__block_literal_global_204108);
  return (id)logCategory__hmf_once_v8_204109;
}
...
void __30__HMDWatchManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_204109;
  logCategory__hmf_once_v8_204109 = v0;
