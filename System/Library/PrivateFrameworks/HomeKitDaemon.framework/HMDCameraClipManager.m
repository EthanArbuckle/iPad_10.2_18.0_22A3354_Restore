...
- (void)setHasWriteAccess:(BOOL)a3
{
  ...
  if (self->_hasWriteAccess != v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v11;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating has write access from %@ to %@", (uint8_t *)&v13, 0x20u);
...
- (void)configure
{
  ...
  if (v5)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5460], self, v10, sel_handleFetchVideoSegmentsAssetContextMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5528], self, v10, sel_handleSubscribeMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5530], self, v10, sel_handleUnsubscribeMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5518], self, v10, sel_handlePerformCloudPullMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5418], self, v10, sel_handleFetchClipMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5420], self, v10, sel_handleFetchClipsMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5410], self, v10, sel_handleFetchClipForSignificantEventMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5428], self, v10, sel_handleFetchCountOfClipsMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5440], self, v10, sel_handleFetchHeroFrameDataRepresentationMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5448], self, v10, sel_handleFetchHeroFrameURLMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5430], self, v10, sel_handleFetchFaceCropDataRepresentationMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5438], self, v10, sel_handleFetchFaceCropURLMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5458], self, v10, sel_handleFetchSignificantEventsMessage_);
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD53F8], self, v12, sel_handleDeleteClipMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD53F0], self, v12, sel_handleDeleteAllClipsMessage_);
    objc_msgSend(v6, "registerForMessage:receiver:policies:selector:", *MEMORY[0x24BDD5468], self, v12, sel_handleHandleFaceMisclassificationMessage_);
    ...
    v26 = (void *)objc_msgSend((id)v25, "mutableCopy");

    objc_msgSend(v26, "setZoneOwner:", objc_msgSend(v5, "isOwnerUser"));
    -[HMDCameraClipManager featuresDataSource](self, "featuresDataSource");
    v27 = (void *)objc_claimAutoreleasedReturnValue();
    LOBYTE(v25) = objc_msgSend(v27, "isPersistentBulletinRegistrationsFeatureEnabled");
    ...
    if ((v25 & 1) == 0)
    {
      ...
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v26, "setExternalRecordTypesForSubscriptions:", v30);

    }
    -[HMDCameraClipManager zoneManager](self, "zoneManager");
    v31 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v31, "setDefaultConfiguration:", v26);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v40;
      _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Skipping camera clip manager configure because home reference is nil", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant notification model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v22 = 2112;
      v23 = v8;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant notification model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
...
- (id)remove
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Asked to remove clip manager zones", (uint8_t *)&v11, 0xCu);
...
- (id)enableCloudStorage
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v22 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Asked to enable cloud storage", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v17;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@User is not the zone owner; cannot enable cloud storage",
        buf,
        0xCu);
...
- (id)disableCloudStorage
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 138543362;
    v26 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Asked to disable cloud storage", (uint8_t *)&v25, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v25 = 138543362;
      v26 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@User is not the zone owner; cannot disable cloud storage",
        (uint8_t *)&v25,
        0xCu);
...
- (id)performCloudPull
{
  ...
  v3 = objc_alloc_init(MEMORY[0x24BE6B608]);
  -[HMDCameraClipManager workQueue](self, "workQueue");
...
- (id)significantEventsForClipContainingDate:(id)a3
{
  ...
  if (v5)
  {
    ...
    *((_QWORD *)&buf + 1) = &buf;
    v38 = 0x3032000000;
    v39 = __Block_byref_object_copy__194406;
    v40 = __Block_byref_object_dispose__194407;
    v41 = 0;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v31 = 138543874;
          ...
          v35 = 2112;
          v36 = v4;
          _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Clip: %@, does not contain date: %@", v31, 0x20u);
    ...
    {
      v20 = (void *)MEMORY[0x227676638](v9);
      v21 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v31 = 138543618;
        ...
        v33 = 2112;
        v34 = v4;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Did not find any clips before date: %@", v31, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch significant events clip containing date because zones are not ready", (uint8_t *)&buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)&buf[14] = 16;
            ...
            v36 = 2112;
            v37 = v14;
            _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant notification model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant events for clip UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
...
- (id)_faceClassificationsForSignificantEventWithUUID:(id)a3
{
  ...
  if (v6)
  {
    objc_msgSend(v6, "na_map:", &__block_literal_global_194400);
    v8 = objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch face classification models for significant event UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
...
- (BOOL)_fetchSignificantEventsWithDateInterval:(id)a3 isAscending:(BOOL)a4 error:(id *)a5 handler:(id)a6
{
  ...
  v35 = v12;
  v13 = _Block_copy(&v30);
  v18 = (void *)MEMORY[0x227676638](v13, v14, v15, v16, v17);
  v19 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v40 = 2112;
    v41 = v10;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Fetching significant events with date interval: %@", buf, 0x16u);
...
- (BOOL)_fetchClipsWithDateInterval:(id)a3 quality:(int64_t)a4 isAscending:(BOOL)a5 error:(id *)a6 handler:(id)a7
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v45 = 2112;
    v46 = v12;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Fetching clips with date interval: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v44 = v31;
    _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Finished fetching clips", buf, 0xCu);
...
- (id)_fetchCanonicalHeroFrameURLForClipModel:(id)a3
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "sortedArrayUsingComparator:", &__block_literal_global_126_194390);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      for (i = 0; i != v12; ++i)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v46 = 2112;
          v47 = v20;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant event notification model: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v46 = 2112;
    v47 = v37;
    _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@Could not find hero frame on any significant event for clip model: %@", buf, 0x16u);
        ...
        v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v35 = 2112;
      v36 = v6;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Using existing cached hero frame URL for significant event with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);

    }
    objc_autoreleasePoolPop(v9);
    objc_msgSend(MEMORY[0x24BE6B608], "futureWithResult:", v6);
    v27 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Force fetching significant event model from cloud for hero frame url", buf, 0xCu);
        ...
        v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v6;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Using existing cached face crop URL: %@", buf, 0x16u);
...
- (id)_performCloudPull
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v16;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Cannot perform cloud pull because zones are not ready", buf, 0xCu);
  ...
  if (objc_msgSend(v13, "count"))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v13;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Completing incomplete clips: %@", buf, 0x16u);
    ...
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(v16 + 3344), "optionsWithLabel:", CFSTR("Complete Incomplete Clips"));
    v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v14, "count"))
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v14;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Removing incomplete 0-duration clip UUIDs: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v24);
    objc_msgSend(*(id *)(v16 + 3344), "optionsWithLabel:", CFSTR("Remove 0-duration Incomplete Clips"));
    v28 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_cleanUpExpiredClips
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDBCEF0], "setWithCapacity:", -[HMDCameraClipManager fetchBatchLimit](self, "fetchBatchLimit"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", CFSTR("Remove expired clips"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v11, "count"))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2048;
      v25 = v17;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Removing %lu expired clips", buf, 0x16u);
  ...
  if (v11)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribed transports of %lu updated clips, %lu removed clips", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v12);
    v43[0] = *MEMORY[0x24BDD5508];
    v36 = v6;
    encodeRootObjectForIncomingXPCMessage(v6, 0);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v43[1] = *MEMORY[0x24BDD54E0];
    v44[0] = v19;
    v35 = v7;
    v44[1] = v7;
    ...
    if (v23)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(MEMORY[0x24BE3F1D0], "entitledMessageWithName:messagePayload:", v26, v20);
          v29 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v29, "setTransport:", v28);
          v30 = objc_alloc(MEMORY[0x24BE3F1B8]);
  ...
  else
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed transports to notify of %lu updated clips, %lu removed clips", buf, 0x20u);
  ...
  if (v11)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v51 = 2048;
      v52 = objc_msgSend(v7, "count");
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribed transports of %lu updated significant events, %lu removed significant events", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v12);
    v43[0] = *MEMORY[0x24BDD5510];
    v36 = v6;
    encodeRootObjectForIncomingXPCMessage(v6, 0);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v43[1] = *MEMORY[0x24BDD54E8];
    v44[0] = v19;
    v35 = v7;
    v44[1] = v7;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v44, v43, 2);
  ...
  else
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v49 = 2048;
      v50 = objc_msgSend(v7, "count");
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed transports to notify of %lu updated significant events, %lu removed significant events", buf, 0x20u);
...
- (void)_fetchAssetContextForMessage:(id)a3 propertyName:(id)a4
{
  ...
  if (v9)
  {
    objc_msgSend(v6, "uuidForKey:", *MEMORY[0x24BDD5490]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v24;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failing request to fetch asset context because message has no clip UUID: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v6;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch asset context for message because zones are not ready: %@", buf, 0x16u);
        ...
        for (i = 0; i != v14; ++i)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v44 = 2112;
            v45 = v33;
            _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Found existing significant event model %@ associated with new clip model %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = v33;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to create clip from clip model: %@", buf, 0x16u);
...
- (void)_handleChangedSignificantEventNotificationModel:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changed significant event notification model because its associated clip model does not exist: %@", (uint8_t *)&v16, 0x16u);
...
- (void)_handleChangedFaceClassificationModel:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changed face classification model because its associated significant event does not exist: %@", (uint8_t *)&v16, 0x16u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Waiting for mirror output future to complete: %@", buf, 0x16u);
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "flatMap:", &__block_literal_global_148_194332);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_handleFaceMisclassificationForFaceCropURL:(id)a3 personUUID:(id)a4 personManagerUUID:(id)a5 significantEventModel:(id)a6
{
  ...
  {
    v36 = v17;
    v18 = (void *)MEMORY[0x227676638](-[HMDCameraClipManager _notifyPrimaryResidentAboutFaceMisclassificationForFaceCropData:personUUID:personManagerUUID:](self, "_notifyPrimaryResidentAboutFaceMisclassificationForFaceCropData:personUUID:personManagerUUID:", v16, v11, v12));
    v19 = self;
    HMFGetOSLogHandle();
    v20 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v44 = 2112;
      v45 = v13;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Removing all face classifications for significant event model: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v18);
    objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", CFSTR("Remove all face classifications from significant event"));
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDCameraClipManager localZone](v19, "localZone");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v37[0] = v26;
    v37[1] = 3221225472;
    v37[2] = __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke_155;
    v37[3] = &unk_24E78FD30;
    v37[4] = v19;
    v38 = v13;
    objc_msgSend(v27, "flatMap:", v37);
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v28, "flatMap:", &__block_literal_global_161_194322);
    v29 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v46 = 2112;
      v47 = v17;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not load face crop data at URL %@: %@", buf, 0x20u);
...
- (void)_notifyPrimaryResidentAboutFaceMisclassificationForFaceCropData:(id)a3 personUUID:(id)a4 personManagerUUID:(id)a5
{
    ...
    if (v22)
    {
      if (v26)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v21;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Directly handling face misclassification message because we are the primary resident: %@", buf, 0x16u);
    ...
    else
    {
      if (v26)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v21;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Sending remote handle face misclassification message to primary resident: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v31;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Could not find primary resident to send face misclassification message to", buf, 0xCu);
...
- (id)_removeClipsWithUUIDs:(id)a3 options:(id)a4
{
  ...
  objc_msgSend(v9, "flatMap:", &__block_literal_global_165_194311);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_removeAllFaceClassificationModels
{
  ...
  objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", CFSTR("Remove all face classification models"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDCameraClipManager localZone](self, "localZone");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v8[0] = objc_opt_class();
...
- (void)handleSubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 138543362;
    v28 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling subscribe message", (uint8_t *)&v27, 0xCu);
  ...
  if (v12)
  {
    ...
    if (!v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v27 = 138543362;
        v28 = v18;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Asked to subscribe to changes when no cloud zone exists; Restarting zone manager",
          (uint8_t *)&v27,
          0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = v25;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Subscribing transport was not of expected class %@: %@", (uint8_t *)&v27, 0x20u);
...
- (void)handleFetchClipMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2114;
    v40 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch clip message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    objc_msgSend(v4, "uuidForKey:", *MEMORY[0x24BDD5490]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if (v12)
    {
      -[HMDCameraClipManager localZone](v7, "localZone");
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v41 = 2112;
          v42 = v15;
          _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip with UUID %@: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v39 = 2112;
        v40 = v29;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip UUID in message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v24;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch clip because zones are not ready", buf, 0xCu);
...
- (void)handleFetchClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v56 = 2114;
    v57 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch clips message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      objc_msgSend(v4, "dateForKey:", *MEMORY[0x24BDD54B0]);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "dateForKey:", *MEMORY[0x24BDD54B8]);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD54D0]);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD54F0]);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "numberForKey:", *MEMORY[0x24BDD54D8]);
      v18 = objc_claimAutoreleasedReturnValue();
      v19 = (void *)v18;
      if (v14 && v15 && v16 && v17 && v18)
      {
        ...
        if ((v21 & 1) != 0)
        {
          v49[0] = v23;
          v49[1] = 3221225472;
          v49[2] = __48__HMDCameraClipManager_handleFetchClipsMessage___block_invoke_170;
          v49[3] = &unk_24E79C240;
          v50 = v4;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v56 = 2112;
            v57 = v25;
            _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch clip models from local zone: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = v4;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch server from message: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v55 = v29;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch clips because zones are not ready", buf, 0xCu);
...
- (void)handleFetchClipForSignificantEventMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch clip for significant event message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    objc_msgSend(v4, "setForKey:", *MEMORY[0x24BDD54F8]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (!v13)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        *(_QWORD *)&buf[24] = v34;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event UUID in decoded UUIDs %@ in message payload: %@", buf, 0x20u);
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[28] = 2112;
        *(_QWORD *)&buf[30] = v16;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
...
LABEL_40:
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[18] = 2098;
      *(_QWORD *)&buf[20] = &v68;
      _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find clip model with UUID %{public,uuid_t}.16P. Falling back to using the associated clip", buf, 0x1Cu);
    ...
    if (v19)
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v19;
        _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@Fetching clip model using associated clip reference: %@", buf, 0x16u);
...
LABEL_37:
      ...
      *(_WORD *)&buf[28] = 2112;
      *(_QWORD *)&buf[30] = v16;
      _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    ...
    else
    {
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v15;
        _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_ERROR, "%{public}@No associatedClip found for significant event model: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    *(_QWORD *)&buf[4] = v29;
    _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch clip for significant event because zones are not ready", buf, 0xCu);
...
- (void)handleFetchCountOfClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v49 = 2114;
    v50 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch count of clips message: %{public}@", buf, 0x16u);
    ...
    if (v12 && v13 && v14)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v51 = 2112;
        v52 = v13;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Fetching count of clips between %@ and %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v49 = 2112;
          v50 = v26;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch count of clip models from local zone: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v49 = 2112;
        v50 = v36;
        _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Could not find required value in message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v31;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch count of clips because zones are not ready", buf, 0xCu);
...
- (void)handleFetchVideoSegmentsAssetContextMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch video segments asset context message", (uint8_t *)&v15, 0xCu);
...
- (void)handleFetchHeroFrameDataRepresentationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v44 = 2114;
    v45 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch hero frame data representation with message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (v12)
    {
      ...
      if (v14)
      {
        ...
        v38[0] = v17;
        v38[1] = 3221225472;
        v38[2] = __70__HMDCameraClipManager_handleFetchHeroFrameDataRepresentationMessage___block_invoke_175;
        v38[3] = &unk_24E78FE08;
        v19 = v4;
        v39 = v19;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v46 = 2112;
          v47 = v15;
          _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip with UUID %@: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v44 = 2112;
        v45 = v30;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot find clip UUID in message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v25;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch hero frame data representation because zones are not ready", buf, 0xCu);
...
- (void)handleFetchHeroFrameURLMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch hero frame URL message with payload: %@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (v12)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[18] = 2098;
          *(_QWORD *)&buf[20] = &v39;
          _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed requesting to fetch hero frame url because no clip could be found for UUID %{public,uuid_t}.16P", buf, 0x1Cu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v29;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch hero frame url because clip uuid cannot be found in message payload", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v25;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch hero frame url because zones are not ready", buf, 0xCu);
...
- (void)handleFetchFaceCropDataRepresentationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch face crop data representation with message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      if (v15)
      {
        ...
        v39[0] = v18;
        v39[1] = 3221225472;
        v39[2] = __69__HMDCameraClipManager_handleFetchFaceCropDataRepresentationMessage___block_invoke_178;
        v39[3] = &unk_24E78FE08;
        v20 = v4;
        v40 = v20;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[28] = 2112;
          *(_QWORD *)&buf[30] = v16;
          _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        *(_QWORD *)&buf[24] = v31;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event UUID in decoded UUIDs %@ in message payload: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v26;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch face crop data representation because zones are not ready", buf, 0xCu);
...
- (void)handleFetchFaceCropURLMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch face crop for message: %{public}@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v26;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch face crop url because zones are not ready", buf, 0xCu);
...
- (void)handleFetchSignificantEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v58 = 2114;
    v59 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch significant event message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (v15)
      {
        ...
        {
          v46 = v23;
          v27 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1508]), "initWithStartDate:endDate:", v16, v23);
          ...
          if ((v28 & 1) != 0)
          {
            v49[0] = v29;
            v49[1] = 3221225472;
            v49[2] = __60__HMDCameraClipManager_handleFetchSignificantEventsMessage___block_invoke_179;
            v49[3] = &unk_24E79C240;
            v50 = v4;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v58 = 2112;
              v59 = v45;
              _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant event models from local zone: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v58 = 2112;
            v59 = v40;
            _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Could not find required value in message payload: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v58 = 2112;
          v59 = v4;
          _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch server from message: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v57 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch significant events because zones are not ready", buf, 0xCu);
...
- (void)handleDeleteClipMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v33 = 2114;
    v34 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling delete clip message: %{public}@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v33 = 2112;
        v34 = v28;
        _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip UUID in message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Cannot delete clip because zones are not ready", buf, 0xCu);
...
- (void)handleDeleteAllClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling delete all clips message", buf, 0xCu);
...
- (void)handleHandleFaceMisclassificationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling handle face misclassification message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (v15)
    {
      ...
      if (v17)
      {
        ...
        if (v19)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_WORD *)&buf[28] = 2112;
              *(_QWORD *)&buf[30] = v23;
              _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v18;
            _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle misclassification for face classification without a person: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(_QWORD *)&buf[14] = v16;
          _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Could not find face classification on significant event: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        *(_QWORD *)&buf[24] = v39;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event in decoded significant events %@ in message payload: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v34;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to handle face misclassification because zones are not ready", buf, 0xCu);
...
- (void)handleRemoteHandleFaceMisclassificationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(_QWORD *)&buf[14] = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling remote handle face misclassification message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (v12 && v14 && v13)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[18] = 2098;
          *(_QWORD *)&buf[20] = &v32;
          _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not find person manager with UUID %{public,uuid_t}.16P to handle misclassified person", buf, 0x1Cu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v26;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not find all face misclassification information in message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to handle face misclassification because zones are not ready", buf, 0xCu);
...
- (void)handleImportClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v44 = 2114;
    v45 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling import clips message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    objc_msgSend(v4, "dataForKey:", *MEMORY[0x24BDD5488]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if (v12)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v44 = 2112;
          v45 = v18;
          _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera clips import dictionary from clip data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v44 = 2112;
        v45 = v33;
        _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find serialized import data in message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v28;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot import clips because zones are not ready", buf, 0xCu);
...
- (void)handleFetchIsCloudStorageEnabledMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v41 = 2114;
    v42 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch is cloud storage enabled message: %{public}@", buf, 0x16u);
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v28;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch is cloud storage enabled because zones are not ready", buf, 0xCu);
  ...
  if ((v14 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v33;
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@User is not the zone owner; cannot fetch is cloud storage enabled",
        buf,
        0xCu);
...
LABEL_12:
  ...
  v35[0] = v21;
  v35[1] = 3221225472;
  v35[2] = __64__HMDCameraClipManager_handleFetchIsCloudStorageEnabledMessage___block_invoke_185;
  v35[3] = &unk_24E79BCC8;
  v35[4] = v7;
  v36 = v22;
...
- (void)handleUpdateCloudStorageMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2114;
    v28 = v10;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling update cloud storage message: %{public}@", buf, 0x16u);
  ...
  if (v11)
  {
    if (objc_msgSend(v4, "BOOLForKey:", *MEMORY[0x24BDD54C8]))
    {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot update cloud storage because zones are not ready", buf, 0xCu);
...
- (void)zoneManagerDidStart:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Camera clips zone manager started", buf, 0xCu);
  ...
  if ((v15 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v49 = 2112;
      v50 = v21;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Suppressing all clip-related notifications before %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v44;
      _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot create feedback manager because home reference is nil", buf, 0xCu);
...
- (void)zoneManagerDidStop:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Camera clips zone manager stopped", (uint8_t *)&v11, 0xCu);
  ...
  if (v13)
  {
    ...
    if (v15 == 1)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v20;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Received all storage disabled notification", (uint8_t *)&v22, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v24 = 2112;
        v25 = v9;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Received unknown notification: %@", (uint8_t *)&v22, 0x16u);
...
void __44__HMDCameraClipManager_zoneManagerDidStart___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Camera clips cloud zone finished starting up", (uint8_t *)&v10, 0xCu);
...
void __58__HMDCameraClipManager_localZone_didProcessModelDeletion___block_invoke(uint64_t a1)
{
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        v43 = 2098;
        v44 = &v40;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Significant event notification deleted with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          v43 = 2098;
          v44 = &v39;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Significant event face classification deleted with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)&buf[14] = 16;
    v43 = 2098;
    v44 = &v41;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Clip deleted with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      v35 = 2098;
      v36 = &v33;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Clip updated with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        v35 = 2098;
        v36 = &v32;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Significant event notification updated with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          v35 = 2098;
          v36 = &v31;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Face classification updated with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      v35 = 2098;
      v36 = &v33;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@New clip received with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        v35 = 2098;
        v36 = &v32;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@New significant event notification received with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          v35 = 2098;
          v36 = &v31;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@New face classification received with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
  ...
  if (v4)
  {
    ...
    if ((v7 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Home person manager face classification is disabled; removing all face classification models",
          (uint8_t *)&v12,
          0xCu);
...
void __64__HMDCameraClipManager_handleFetchIsCloudStorageEnabledMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v11;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Fetched is cloud storage enabled: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v7);
  v12 = *(void **)(a1 + 40);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", v6, *MEMORY[0x24BDD54C8]);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = v13;
...
void __64__HMDCameraClipManager_handleFetchIsCloudStorageEnabledMessage___block_invoke_185(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch is cloud storage enabled: %@", (uint8_t *)&v8, 0x16u);
...
uint64_t __60__HMDCameraClipManager_handleFetchSignificantEventsMessage___block_invoke_179(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "respondWithSuccess");
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v20 = 2112;
      v21 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data from URL %@: %@", buf, 0x20u);
...
void __69__HMDCameraClipManager_handleFetchFaceCropDataRepresentationMessage___block_invoke_178(uint64_t a1, void *a2)
{
  void *v2;
  void *v3;
  id v4;
...
void __70__HMDCameraClipManager_handleFetchHeroFrameDataRepresentationMessage___block_invoke_175(uint64_t a1, void *a2)
{
  void *v2;
  void *v3;
  id v4;
...
uint64_t __48__HMDCameraClipManager_handleFetchClipsMessage___block_invoke_170(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "respondWithSuccess");
}
...
id __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Adding unassociated face crop to home person dataset for misclassified face classification", (uint8_t *)&v12, 0xCu);
...
id __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke_155(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating face classification to use unassociated face crop: %@", (uint8_t *)&v21, 0x16u);
  ...
  objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", CFSTR("Create face classification with unassociated face crop"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
...
uint64_t __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke_160()
{
  return objc_msgSend(MEMORY[0x24BE6B608], "futureWithNoResult");
}
...
void __82__HMDCameraClipManager__notifyForChangedSignificantEventModel_mirrorOutputFuture___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v21;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create significant event from model: %@", (uint8_t *)&v24, 0x16u);
LABEL_12:
...
LABEL_13:
  ...
  if (v13 == -1)
  {
    if (v17)
    {
      ...
      v28 = 2112;
      v29 = v23;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring significant event with date of occurrence %@ because it is before %@", (uint8_t *)&v24, 0x20u);
  ...
  if (v17)
  {
    ...
    v26 = 2112;
    v27 = v7;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate about updated significant event: %@", (uint8_t *)&v24, 0x16u);
  ...
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_opt_respondsToSelector() & 1) != 0)
    objc_msgSend(v19, "clipManager:didUpdateSignificantEvent:", *(_QWORD *)(a1 + 32), v7);
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (v9)
      {
        ...
        {
          v63 = v6;
          v11 = (void *)MEMORY[0x24BDD7538];
          objc_msgSend(v5, "streamingAssetVersion");
          v12 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v11, "requiredHTTPHeadersForStreamingAssetVersion:", v12);
          v13 = objc_claimAutoreleasedReturnValue();

          v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7540]), "initWithURL:expirationDate:requiredHTTPHeaders:", v9, v10, v13);
          v15 = (void *)MEMORY[0x227676638]();
          v16 = *(id *)(a1 + 32);
          HMFGetOSLogHandle();
          v17 = objc_claimAutoreleasedReturnValue();
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)&buf[24] = 16;
            ...
            v14 = v64;
            v73 = v64;
            _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched streaming asset with property name %@ for clip UUID %{public,uuid_t}.16P with context %@", buf, 0x30u);
          ...
          objc_autoreleasePoolPop(v15);
          v62 = *(void **)(a1 + 48);
          v66[0] = *MEMORY[0x24BDD5478];
          encodeRootObjectForIncomingXPCMessage(v14, 0);
          v49 = (void *)objc_claimAutoreleasedReturnValue();
          v67[0] = v49;
          v66[1] = *MEMORY[0x24BDD5480];
          objc_msgSend(MEMORY[0x24BDBCF20], "set");
          v50 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        else
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)&buf[24] = 16;
            v70 = 2098;
            v71 = &v74;
            _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Could not find content download URL expiration date on streaming asset %@ for clip with UUID: %{public,uuid_t}.16P", buf, 0x26u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)&buf[24] = 16;
          v70 = 2098;
          v71 = &v75;
          _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not find content download URL on streaming asset %@ for clip with UUID: %{public,uuid_t}.16P", buf, 0x26u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)&buf[24] = 16;
        v70 = 2098;
        v71 = &v76;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Could not find streaming asset on property named %@ for clip with UUID: %{public,uuid_t}.16P", buf, 0x26u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[20] = &v77;
      v70 = 2112;
      v71 = v6;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch complete model for clip UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
...
void __44__HMDCameraClipManager__cleanUpExpiredClips__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2112;
    v21 = (uint64_t)v8;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Removing expired clip: %@", (uint8_t *)&v18, 0x16u);
  ...
  if (v11 >= objc_msgSend(*(id *)(a1 + 32), "fetchBatchLimit"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 2048;
      v21 = v16;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Removing %lu expired clips", (uint8_t *)&v18, 0x16u);
...
void __65__HMDCameraClipManager__cleanUpIncompleteClipsForInitialStartup___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v49 = 2112;
    v50 = v8;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cleaning up incomplete clip: %@", (uint8_t *)&v47, 0x16u);

  }
  objc_autoreleasePoolPop(v4);
  v9 = *(void **)(a1 + 40);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v3, "quality"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[HMDCameraClipModel setIsComplete:](v22, "setIsComplete:", MEMORY[0x24BDBD1C8]);
    v23 = *(void **)(a1 + 48);
  }
  ...
  if (v27 >= objc_msgSend(*(id *)(a1 + 32), "fetchBatchLimit"))
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v49 = 2112;
      v50 = v32;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Completing batch of incomplete clips: %@", (uint8_t *)&v47, 0x16u);
    ...
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    v34 = *(_QWORD *)(a1 + 48);
    objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", CFSTR("Complete Incomplete Clips"));
    v35 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v37 >= objc_msgSend(*(id *)(a1 + 32), "fetchBatchLimit"))
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v49 = 2112;
      v50 = v42;
      _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Removing batch of incomplete 0-duration clip UUIDs: %@", (uint8_t *)&v47, 0x16u);

    }
    objc_autoreleasePoolPop(v38);
    v43 = *(void **)(a1 + 32);
    v44 = *(_QWORD *)(a1 + 56);
    objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", CFSTR("Remove 0-duration Incomplete Clips"));
    v45 = (void *)objc_claimAutoreleasedReturnValue();
...
void __41__HMDCameraClipManager__performCloudPull__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform cloud pull due to cloud zone fetch timer firing: %@", (uint8_t *)&v8, 0x16u);
...
id __66__HMDCameraClipManager__fetchFaceCropURLForSignificantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched face crop URL: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Could not find face crop file URL on fetched asset: %@", (uint8_t *)&v17, 0x16u);
...
void __66__HMDCameraClipManager__fetchFaceCropURLForSignificantEventModel___block_invoke_130(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch complete significant event notification model: %@", (uint8_t *)&v8, 0x16u);
...
id __67__HMDCameraClipManager__fetchHeroFrameURLForSignificantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched hero frame URL: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Could not find hero frame file URL on fetched asset: %@", (uint8_t *)&v17, 0x16u);
...
uint64_t __64__HMDCameraClipManager__fetchCanonicalHeroFrameURLForClipModel___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v4, "confidenceLevel"));
    }
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
void __86__HMDCameraClipManager__fetchClipsWithDateInterval_quality_isAscending_error_handler___block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant events for clip model %@", (uint8_t *)&v14, 0x16u);
...
id __184__HMDCameraClipManager_initWithZoneManager_quotaManager_faceClassificationResolver_clientConnectionsTimer_messageDispatcher_workQueue_cameraProfileUUID_fileManager_featuresDataSource___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = (objc_class *)MEMORY[0x24BDD7578];
  v4 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t149 != -1)
    dispatch_once(&logCategory__hmf_once_t149, &__block_literal_global_186_194488);
