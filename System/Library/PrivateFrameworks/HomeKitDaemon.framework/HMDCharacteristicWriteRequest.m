...
+ (id)writeRequestForTransitionStartWithLightProfile:(id)a3 naturalLightingEnabled:(BOOL)a4 startDate:(id)a5 type:(unint64_t)a6 dataSource:(id)a7
{
  ...
  if (v16)
  {
    objc_msgSend(MEMORY[0x24BE1BA40], "naturalLightingValueTransitionWithLightProfile:naturalLightingEnabled:startDate:dataSource:", v12, v10, v13, v14);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    if (v17)
    {
      v41 = a6;
      v18 = objc_alloc_init(MEMORY[0x24BE1BA48]);
      v19 = objc_alloc(MEMORY[0x24BE1BA70]);
      v47 = v17;
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v50 = 2112;
          v51 = v27;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Writing value to transition control characteristic: %@", buf, 0x16u);
      ...
      else
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v52 = 2112;
          v53 = v45;
          _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize transition control write request %@:%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v50 = 2112;
        v51 = v12;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to create natural lighting transition for light profile: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Value Transition Control Characteristic %@:%@", buf, 0x20u);
...
+ (id)writeRequestForTransitionFetchWithLightProfile:(id)a3
{
  ...
  v6 = (const __CFString *)*MEMORY[0x24BDD57F0];
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      v9 = objc_alloc(MEMORY[0x24BE1BA68]);
      v10 = objc_alloc(MEMORY[0x24BE1BC28]);
      ...
      v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BA48]), "initWithTransitionFetch:transitionStart:", v13, 0);
      v36 = 0;
      ...
      if (v15)
      {
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v39 = 2112;
          v40 = v21;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Writing value to transition control characteristic: %@", buf, 0x16u);
      ...
      else
      {
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v41 = 2112;
          v42 = v16;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize transition control write request %@:%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Value Transition Control Characteristic %@:%@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v41 = 2112;
      v42 = v6;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_251798 != -1)
    dispatch_once(&logCategory__hmf_once_t3_251798, &__block_literal_global_101_251799);
  return (id)logCategory__hmf_once_v4_251800;
}
...
void __44__HMDCharacteristicWriteRequest_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_251800;
  logCategory__hmf_once_v4_251800 = v0;
