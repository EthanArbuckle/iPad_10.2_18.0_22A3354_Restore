...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_146738 != -1)
    dispatch_once(&logCategory__hmf_once_t0_146738, &__block_literal_global_146739);
  return (id)logCategory__hmf_once_v1_146740;
}
...
void __55__HMDRemoteLoginAnisetteDataProviderBridge_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_146740;
  logCategory__hmf_once_v1_146740 = v0;
