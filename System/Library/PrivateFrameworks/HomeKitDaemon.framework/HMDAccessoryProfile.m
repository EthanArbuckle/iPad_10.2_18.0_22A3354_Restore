...
- (void)configureWithMessageDispatcher:(id)a3 configurationTracker:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v9;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring profile: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_159742 != -1)
    dispatch_once(&logCategory__hmf_once_t1_159742, &__block_literal_global_159743);
  return (id)logCategory__hmf_once_v2_159744;
}
...
void __34__HMDAccessoryProfile_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_159744;
  logCategory__hmf_once_v2_159744 = v0;
