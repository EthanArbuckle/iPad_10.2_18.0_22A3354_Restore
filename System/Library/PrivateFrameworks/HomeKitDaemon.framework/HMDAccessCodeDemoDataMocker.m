        ...
        if (!v10)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v51 = 2112;
            v52 = v9;
            _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control response: %@", buf, 0x16u);
        ...
        if (!v8)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v50 = 2112;
            v51 = v7;
            _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control response: %@", buf, 0x16u);
...
- (id)_controlResponseForReadRequest:(id)a3
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B958]), "initWithValue:", 1);
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", &unk_24E96D028);
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", &unk_24E96D040);
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", &unk_24E96D058);
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B960]), "initWithCharacterSet:minimumValueLength:maximumValueLength:maximumAccessCodes:", v3, v4, v5, v6);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v20 = 2112;
      v21 = 0;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x16u);
...
- (id)_handleListRequest
{
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", v9);
        v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B980]), "initWithValue:", 0);
        v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B990]), "initWithValue:", 0);
        v13 = objc_alloc(MEMORY[0x24BE1B978]);
        -[HMDAccessCodeDemoDataMocker accessCodes](self, "accessCodes");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B988]), "initWithValue:", 1);
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B968]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v17, 0, v21);
...
- (id)_handleReadRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", v10);
        v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B980]), "initWithValue:", 0);
        v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B990]), "initWithValue:", 0);
        v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B978]), "initWithIdentifier:accessCode:flags:statusCode:", v13, v12, v14, v15);
  ...
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B988]), "initWithValue:", 2);
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B968]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v17, 0, v22);
...
- (id)_handleAddRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", v14);
        v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B980]), "initWithValue:", 0);
        v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B990]), "initWithValue:", 0);
        v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B978]), "initWithIdentifier:accessCode:flags:statusCode:", v16, v9, v17, v18);
  ...
  v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B988]), "initWithValue:", 3);
  v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B968]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v20, 0, v25);
...
- (id)_handleUpdateRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", v11);
        v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B980]), "initWithValue:", 0);
        v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B990]), "initWithValue:", 0);
        v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B978]), "initWithIdentifier:accessCode:flags:statusCode:", v14, v12, v15, v16);
  ...
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B988]), "initWithValue:", 4);
  v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B968]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v18, 0, v23);
...
- (id)_handleRemoveRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BC28]), "initWithValue:", v10);
        v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B980]), "initWithValue:", 0);
        v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B990]), "initWithValue:", 0);
        v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B978]), "initWithIdentifier:accessCode:flags:statusCode:", v14, v12, v15, v16);
        objc_msgSend(v23, "addObject:", v17);
  ...
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B988]), "initWithValue:", 5);
  v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1B968]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v18, 0, v23);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_212058 != -1)
    dispatch_once(&logCategory__hmf_once_t3_212058, &__block_literal_global_212059);
  return (id)logCategory__hmf_once_v4_212060;
}
...
void __42__HMDAccessCodeDemoDataMocker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_212060;
  logCategory__hmf_once_v4_212060 = v0;
