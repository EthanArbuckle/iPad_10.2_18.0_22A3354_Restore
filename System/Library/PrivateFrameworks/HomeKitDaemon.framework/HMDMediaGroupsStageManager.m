...
- (HMDMediaGroupsStageManager)initWithIdentifier:(id)a3 userDefaults:(id)a4
{
  ...
  if (v8)
  {
    ...
    v11 = -[HMDMediaGroupsAggregateData initWithDestinations:destinationControllersData:](v10, "initWithDestinations:destinationControllersData:", MEMORY[0x24BDBD1A8], MEMORY[0x24BDBD1A8]);
    v20.receiver = self;
    ...
    if (v12)
    {
      ...
      v14 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F278]), "initWithValue:", 0);
...
- (void)configure
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring with staged aggregate data: %@", (uint8_t *)&v11, 0x16u);
  ...
  else
  {
    if (v7)
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring without staged data", (uint8_t *)&v11, 0xCu);
...
- (void)stageNullDestinationForCurrentDestinationControllerIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Stage null destination for current destination controller identifier: %@", (uint8_t *)&v9, 0x16u);
...
- (void)unstageNullDestinationForCurrentDestinationController
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Unstage null destination for current destination controller", (uint8_t *)&v7, 0xCu);
...
- (void)refreshManager
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Refresh resulted in no change to aggregate data: %@", (uint8_t *)&v15, 0x16u);
...
- (id)transformedDestinations
{
  ...
  if (v7)
  {
    addOrReplaceElements(v7, v4, &__block_literal_global_255909);
...
- (id)transformedDestinationControllersData
{
  ...
  if (v5)
  {
    addOrReplaceElements(v5, v8, &__block_literal_global_8_255906);
...
- (id)transformedGroups
{
  ...
  if (v7)
  {
    addOrReplaceElements(v7, v4, &__block_literal_global_11_255902);
    v8 = (id)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (void)notifyOfUpdatedAggregateData
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Notifying of updated aggregate data: %@", (uint8_t *)&v14, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of updated aggregate data due to no delegate", (uint8_t *)&v14, 0xCu);
...
- (void)commitAggregateData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Committing aggregate data: %@", (uint8_t *)&v9, 0x16u);
...
- (void)saveAssociatedGroupDataForLegacyCurrentAccessory:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to save associated group data due to unknown category for current accessory: %@", (uint8_t *)&v9, 0x16u);
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v26 = 2112;
          v27 = v9;
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage associated data due to no root destination identifier from media system: %@", buf, 0x16u);
...
LABEL_17:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v30 = 2112;
    v31 = v4;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage associated data due to no destination: %@ home: %@ for the current HomePod accessory: %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 2112;
        v29 = v4;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed stage associated group data due to no home for current accessory: %@", buf, 0x16u);
...
- (void)saveDataForLegacyMediaSystem:(id)a3
{
  ...
  if (v5 && v6)
  {
    ...
    if (v15 && v30)
    {
      v16 = objc_alloc(MEMORY[0x24BDD77E8]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v39 = 2112;
        v40 = v4;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage data due to missing home identifier: %@ name: %@ for media system: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage data due to missing destinations for media system: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v26 = 2112;
      v27 = v9;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination from component: %@ accessory: %@", buf, 0x20u);
...
- (void)saveAggregateData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving aggregate data: %@", (uint8_t *)&v11, 0x16u);
...
- (void)saveIdentifier
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Saving identifier: %@", (uint8_t *)&v11, 0x16u);
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v15 = 2112;
        v16 = v4;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to saved aggregate data due to unable to decode data: %@", (uint8_t *)&v13, 0x16u);
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v15 = 2112;
        v16 = v4;
        _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to decode identifier: %@", (uint8_t *)&v13, 0x16u);
...
- (void)saveDestinationControllerData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving destination controller data: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    v11 = -[HMDMediaGroupsAggregateData initWithDestinations:destinationControllersData:](v12, "initWithDestinations:destinationControllersData:", MEMORY[0x24BDBD1A8], MEMORY[0x24BDBD1A8]);
  }
  v13 = v11;
...
- (void)saveDestinations:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving destinations: %@", (uint8_t *)&v17, 0x16u);
...
- (void)saveGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving group: %@", (uint8_t *)&v17, 0x16u);
...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling expired staged aggregate data: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_255923 != -1)
    dispatch_once(&logCategory__hmf_once_t24_255923, &__block_literal_global_20_255924);
  return (id)logCategory__hmf_once_v25_255925;
}
...
void __41__HMDMediaGroupsStageManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_255925;
  logCategory__hmf_once_v25_255925 = v0;
