...
- (HMDAccessorySettingsController)initWithQueue:(id)a3 delegate:(id)a4 dataSource:(id)a5 parentUUID:(id)a6 codingKey:(id)a7 logEventSubmitter:(id)a8 settingOwner:(BOOL)a9 migrationOwner:(BOOL)a10 factory:(id)a11 rootGroup:(id)a12 notificationCenter:(id)a13
{
  ...
  if (v24)
  {
    ...
    v41 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x24BDD1710]);
...
- (BOOL)shouldEncodeForNonAdminSharedUserForSetting:(id)a3
{
  ...
  v4 = objc_msgSend(&unk_24E9711F8, "containsObject:", v3);
...
LABEL_11:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      v27 = 2112;
      v28 = v19;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Filtering out keyPath = %@, filtered? = %@", (uint8_t *)&v23, 0x20u);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v25 = 2112;
    v26 = v5;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode xpc settings for controller due to no home for data source: %@", (uint8_t *)&v23, 0x16u);
...
- (NSString)description
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySettingsController isSettingOwner](self, "isSettingOwner"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySettingsController isMigrationOwner](self, "isMigrationOwner"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)settingsHierarchyDidChange
{
  ...
  v19[1] = v19;
  v19[2] = 0x3032000000;
  v19[3] = __Block_byref_object_copy__204977;
  v19[4] = __Block_byref_object_dispose__204978;
  v20 = 0;
  v17[0] = 0;
  v17[1] = v17;
  v17[2] = 0x3032000000;
  v17[3] = __Block_byref_object_copy__204977;
  v17[4] = __Block_byref_object_dispose__204978;
  v18 = 0;
  v15[0] = 0;
  v15[1] = v15;
  v15[2] = 0x3032000000;
  v15[3] = __Block_byref_object_copy__204977;
  v15[4] = __Block_byref_object_dispose__204978;
  v16 = 0;
  v13[0] = 0;
  v13[1] = v13;
  v13[2] = 0x3032000000;
  v13[3] = __Block_byref_object_copy__204977;
  v13[4] = __Block_byref_object_dispose__204978;
  p_lock = &self->_lock;
  v14 = 0;
...
- (void)_scheduleAuditWithReason:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v25 = 2112;
    v26 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Received audit with reason %@", (uint8_t *)&v23, 0x16u);
  ...
  if (-[HMDAccessorySettingsController hasCreatedUnprocessedRootGroup](v6, "hasCreatedUnprocessedRootGroup"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 138543362;
      v24 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Not scheduling audit as the root group has been created but not processed yet", (uint8_t *)&v23, 0xCu);
  ...
  else
  {
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v18;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@There is already an fix setting request in queue, kicking it again", (uint8_t *)&v23, 0xCu);
...
LABEL_8:
      _os_log_impl(&dword_2218F0000, v9, v10, v8, buf, 0xCu);
...
- (void)_createSettings
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v39 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Is setting migration owner will create settings.", buf, 0xCu);
  ...
  if (v10)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_2218F0000, logger, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "SettingsCreate", ", buf, 2u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v39 = v29;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Did not find any models to create settings.", buf, 0xCu);
...
- (void)_migrateSettingsWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v33 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Check if migration is required.", buf, 0xCu);
  ...
  if (v11 && objc_msgSend(v11, "count"))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v12;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Have settings to migrate. %@", buf, 0x16u);
...
- (void)_performDependantFixup
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v36 = 2112;
    v37 = v6;
    _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Performing dependent fixup with %@", buf, 0x16u);
...
- (void)onMessageUpdateValue:(id)a3 settingIdentifier:(id)a4 senderVersion:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v13;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for identifier %@", (uint8_t *)&v24, 0x16u);
...
- (void)onMessageUpdateValue:(id)a3 settingKeyPath:(id)a4 senderVersion:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v13;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", (uint8_t *)&v23, 0x16u);
...
- (void)_onMessageUpdateValue:(id)a3 settingKeyPath:(id)a4 senderVersion:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v13;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for keyPath %@", (uint8_t *)&v23, 0x16u);
    ...
    if (-[HMDAccessorySettingsController isProxy](self, "isProxy"))
    {
      if (a6 == 6)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v71 = 2112;
          v72 = v13;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay update value on setting(%@) to a second AudioAccessory", buf, 0x16u);
        ...
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", -1, CFSTR("Cannot relay to an AudioAccessory multiple times"), CFSTR("Failed to handle relay."), 0);
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v71 = 2112;
        v72 = v31;
        _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@Forwarding update value message to owner device %@.", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v71 = 2114;
        v72 = v37;
        _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Delegating update for %{public}@ to adaptor", buf, 0x16u);
...
LABEL_19:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v73 = 2112;
    v74 = v17;
    _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Forwarding update value for %@ to owner controller. %@", buf, 0x20u);
...
- (void)_runUpdateTransactionWithValue:(id)a3 setting:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v47 = 2112;
    v48 = v8;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Updating %@ value from %@ to %@", buf, 0x2Au);
  ...
  if ((_DWORD)v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Will remove owner from access control on language change.", buf, 0xCu);
...
- (void)onMessageAddConstraint:(id)a3 keyPath:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v34 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Received add constraint request %@ for setting %@", buf, 0x20u);
  ...
  *(_QWORD *)&buf[16] = 0x3032000000;
  v34 = __Block_byref_object_copy__204977;
  v35 = __Block_byref_object_dispose__204978;
...
- (void)onMessageRemoveConstraint:(id)a3 keyPath:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v34 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Received remove constraint request %@ for setting %@", buf, 0x20u);
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v55 = 2112;
      v56 = v9;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", buf, 0x16u);
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v55 = 2112;
      v56 = v12;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot update constraints on atomic setting %@", buf, 0x16u);
...
LABEL_9:
  ...
  if (v24)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v54 = v28;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@Ignoring owner controller for updating constraint.", buf, 0xCu);
  ...
  if (-[HMDAccessorySettingsController isProxy](self, "isProxy"))
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v54 = v32;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Only the setting owner is allowed to remove constraints.", buf, 0xCu);
  ...
  else
  {
    ...
    if (objc_msgSend(v33, "count"))
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v54 = v37;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating constraints", buf, 0xCu);
...
- (void)_cacheConstraintAdditions:(id)a3 removals:(id)a4 setting:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@%@ caching additions %@, removals %@", (uint8_t *)&v15, 0x2Au);
                  ...
                  (v26 = (void *)objc_claimAutoreleasedReturnValue()) == 0))
            {
              ...
              if (os_log_type_enabled(v44, OS_LOG_TYPE_DEFAULT))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v100 = 2112;
                v101 = v47;
                _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find constraint identifier: %@, currentConstraints: %@, allConstraints: %@", buf, 0x2Au);

              }
              objc_autoreleasePoolPop(v42);
              objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Constraint not found"), CFSTR("Failed to find constraint"), 0);
      ...
      if (v30)
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v98 = 2112;
          v99 = v28;
          _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Forwarding replace constraints for %@ to owner controller. %@", buf, 0x20u);
    ...
    if (-[HMDAccessorySettingsController isProxy](self, "isProxy", v73))
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v96 = 2112;
        v97 = v77;
        _os_log_impl(&dword_2218F0000, v51, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay constraint replacement(%@) to a second AudioAccessory", buf, 0x16u);
...
LABEL_48:
      ...
      if (objc_msgSend(v19, "count") == 1)
      {
        ...
        if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v96 = 2112;
          v97 = v65;
          _os_log_impl(&dword_2218F0000, v68, OS_LOG_TYPE_INFO, "%{public}@Remove managed configuration profile for constraint: %@", buf, 0x16u);
    ...
    _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_ERROR, v59, buf, 0x16u);
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v96 = 2112;
    v97 = v15;
    _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", buf, 0x16u);
...
- (void)_replaceConstraintsOnSetting:(id)a3 additions:(id)a4 removals:(id)a5 completion:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v117 = 2112;
    v118 = v11;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Replacing constraints, %@, with constraint, %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v115 = 2112;
    v116 = v12;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Removing constraints: %@", buf, 0x16u);
      ...
      if (v36)
      {
        ...
        if (os_log_type_enabled(v77, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v115 = 2112;
          v116 = v28;
          _os_log_impl(&dword_2218F0000, v77, OS_LOG_TYPE_ERROR, "%{public}@Constraint has already been removed %@", buf, 0x16u);
...
LABEL_45:
    ...
    if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v114 = v71;
      _os_log_impl(&dword_2218F0000, v70, OS_LOG_TYPE_ERROR, "%{public}@Didn't find same number of constraints to remove", buf, 0xCu);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v115 = 2112;
    v116 = v11;
    _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_INFO, "%{public}@Adding constraints: %@", buf, 0x16u);
...
- (void)_replaceConstraintsOnMessageToChildWithAdditions:(id)a3 removedChildConstraints:(id)a4 settingKeyPath:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  if (v16)
  {
    ...
    v54 = v14;
    v56 = v12;
    v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", objc_msgSend(v13, "count"));
    v57 = 0u;
    v58 = 0u;
    v59 = 0u;
    v60 = 0u;
          ...
          if (!v24)
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v64 = 2112;
              v65 = v23;
              _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Didn't find constraints to remove in Owner Controller %@", buf, 0x16u);

            }
            objc_autoreleasePoolPop(v34);
            objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Constraint not found in owner controller"), CFSTR("Did not find constraint in owner controller"), 0);
            v38 = (void *)objc_claimAutoreleasedReturnValue();
            v15[2](v15, v38);
    ...
    v12 = v56;
    v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCE30]), "initWithArray:copyItems:", v56, 1);
    ...
    if (v27 == objc_msgSend(v18, "count"))
    {
      if (-[HMDAccessorySettingsController isProxy](self, "isProxy"))
      {
        if (v53 != 6)
        {
          objc_msgSend(v17, "na_map:", &__block_literal_global_138_204921);
          v48 = (void *)objc_claimAutoreleasedReturnValue();
          -[HMDAccessorySettingsController messageHandler](self, "messageHandler");
          v49 = (void *)objc_claimAutoreleasedReturnValue();
          -[HMDAccessorySettingsController delegate](self, "delegate");
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v64 = 2112;
          v65 = v16;
          _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay constraint replacement to child for setting(%@) to a second AudioAccessory", buf, 0x16u);
...
LABEL_28:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v63 = v46;
        _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Didn't find same number of constraints to remove", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v43);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Constraints don't match"), CFSTR("Didn't find same number of constraints to remove in media system"), 0);
      v47 = (void *)objc_claimAutoreleasedReturnValue();
      v15[2](v15, v47);
...
LABEL_26:
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v64 = 2112;
    v65 = v14;
    _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for keyPath %@", buf, 0x16u);
...
- (BOOL)canUser:(id)a3 editConstraintsForSettingWithKeyPath:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@User %@ cannot edit accessory setting at key path %@ because it does not exist.", (uint8_t *)&v17, 0x20u);
...
- (void)_removeManagedConfigurationProfile:(id)a3 completion:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Remove managed configuration profile", (uint8_t *)&v22, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 138543362;
        v23 = v19;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Nil datasource.", (uint8_t *)&v22, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v17;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Managed configuration profile data is nil", (uint8_t *)&v22, 0xCu);
...
- (void)handleUpdatedGroupModel:(id)a3 completion:(id)a4
{
  ...
  void *v39;
  void *v40;
  HMDAccessorySettingsController *v41;
  NSObject *v42;
  void *v43;
  ...
  void *v46;
  __int16 v47;
  HMDAccessorySettingGroup *v48;
  __int16 v49;
  HMDAccessorySettingGroup *v50;
  uint64_t v51;
  ...
  if (!v8)
  {
    v25 = (void *)MEMORY[0x227676638](v9);
    v26 = self;
    HMFGetOSLogHandle();
    v27 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      v47 = 2112;
      v48 = v6;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode group from model %@", (uint8_t *)&v45, 0x16u);
  ...
  if (!v12)
  {
    ...
    v33 = (HMDAccessorySettingGroup *)objc_claimAutoreleasedReturnValue();

    if (v33)
    {
      v34 = (void *)MEMORY[0x227676638](-[HMDAccessorySettingGroup addGroup:](v33, "addGroup:", v8));
      v35 = self;
      HMFGetOSLogHandle();
      v36 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        v49 = 2112;
        v50 = v33;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_INFO, "%{public}@Added group %@ to %@", (uint8_t *)&v45, 0x20u);
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
    {
      ...
      -[HMDAccessorySettingGroup parentUUID](v6, "parentUUID");
      v44 = (HMDAccessorySettingGroup *)objc_claimAutoreleasedReturnValue();
      v45 = 138543874;
      v46 = v43;
      v47 = 2112;
      v48 = v44;
      v49 = 2112;
      v50 = v8;
      _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_ERROR, "%{public}@Parent group %@ to add group %@ not found", (uint8_t *)&v45, 0x20u);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v49 = 2112;
    v50 = v17;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Assigning root group from transaction model: %@ id: %@.", (uint8_t *)&v45, 0x20u);

  }
  objc_autoreleasePoolPop(v13);
  -[HMDAccessorySettingsController rootGroup](v14, "rootGroup");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      HMFGetLogIdentifier();
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDAccessorySettingsController rootGroup](v21, "rootGroup");
      v24 = (HMDAccessorySettingGroup *)objc_claimAutoreleasedReturnValue();
      v45 = 138543874;
      v46 = v23;
      v47 = 2112;
      v48 = v24;
      v49 = 2112;
      v50 = v8;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@RootGroup changing unexpectedly %@ / %@.", (uint8_t *)&v45, 0x20u);
...
LABEL_19:
  ...
  v39 = v38;
  if (v38)
    objc_msgSend(v38, "scheduleAuditWithReason:from:", 4, self);
LABEL_25:
  ...
  if (v10)
  {
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v30 = 2112;
        v31 = v22;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Root group model %@ was removed %@", (uint8_t *)&v26, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v37 = 2112;
          v38 = v25;
          _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Setting changed %@ value", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v37 = 2112;
        v38 = v19;
        _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive accessory setting supported value from model's value: %@", buf, 0x16u);
...
LABEL_10:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    v24 = 2112;
    v25 = v8;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Parent group %@ to add setting %@ not found", (uint8_t *)&v20, 0x20u);
...
- (void)handleRemovedSettingModel:(id)a3 completion:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v20;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Setting with id %@ not found", (uint8_t *)&v22, 0x16u);
...
- (void)handleUpdatedSettingConstraintModel:(id)a3 completion:(id)a4
{
  ...
  if (v10)
  {
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7408]), "initWithModel:", v6);
    if (v11)
    {
      objc_msgSend(v10, "constraints");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if ((v13 & 1) != 0)
      {
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v39 = 2112;
          v40 = v11;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Constraint already exists and is not mutable: %@", buf, 0x16u);
      ...
      else
      {
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v39 = 2112;
          v40 = v11;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Added accessory settings constraint: %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v41 = 2112;
          v42 = v31;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Added accessory settings constraint: %@, setting: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v41 = 2112;
      v42 = v6;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Setting %@ to add constraint %@ not found", buf, 0x20u);
...
- (void)handleRemovedSettingConstraintModel:(id)a3 completion:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      if (v16)
      {
        ...
        v30 = 2112;
        v31 = v14;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Removed constraint: %@ from setting: %@", (uint8_t *)&v26, 0x20u);
    ...
    else
    {
      if (v16)
      {
        ...
        v30 = 2112;
        v31 = v14;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Constraint already removed: %@ from setting: %@", (uint8_t *)&v26, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = 2112;
      v31 = v6;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Setting %@ to remove constraint %@ not found", (uint8_t *)&v26, 0x20u);
...
- (void)handleLanguageChangeTimerFired
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Accessory settings language change timer did fire, notifying delegate", (uint8_t *)&v8, 0xCu);
...
- (void)didUpdateSettingConstraints:(id)a3
{
  ...
  if (self && v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Accessory settings languages did change, resuming language change timer", buf, 0xCu);
...
- (void)decodeWithCoder:(id)a3
{
  ...
  v8 = (void *)MEMORY[0x227676638](-[HMDAccessorySettingsController setNestedGroupsDataSourcesWithGroup:](self, "setNestedGroupsDataSourcesWithGroup:", v7));
  v9 = self;
  HMFGetOSLogHandle();
  v10 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Assigning root group on decode. %@", (uint8_t *)&v14, 0x16u);
...
- (NSString)siriLanguage
{
  ...
  if (v3)
  {
    ...
    if (objc_msgSend(v9, "hmf_isEmpty"))
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse siri language componenets", (uint8_t *)&v20, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch siri language because the HMDAccessorySetting was nil", (uint8_t *)&v20, 0xCu);
...
- (void)configureIsSettingOwner:(BOOL)a3 migrationOwner:(BOOL)a4 home:(id)a5 legacySettingsAdaptor:(id)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v42 = 2112;
    v43 = v19;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Configuring settingOwner: %@, migrationOwner: %@, rootGroup: %@", buf, 0x2Au);
    ...
    if ((v13 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v29 = 2114;
        v30 = v11;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting keyPath: %{public}@ on notification from adaptor to %{public}@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2114;
      v28 = v9;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Did not find setting with keyPath: %{public}@ on update from fetched settings adaptor", buf, 0x16u);
...
- (void)legacySettingsAdaptor:(id)a3 didUpdateSettingKeyPath:(id)a4 numberValue:(id)a5
{
  ...
  if (v11)
  {
    ...
    if ((v14 & 1) == 0)
    {
      ...
      if (objc_msgSend(MEMORY[0x24BDD7418], "isKeyPathForTapAssistanceSelectionSettingType:", v9))
      {
        v18 = objc_msgSend(v17, "integerValue");
        objc_msgSend(MEMORY[0x24BDD7418], "tapAssistanceSelectionItemWithIndex:", v18);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        v20 = (void *)MEMORY[0x227676638]();
        v21 = self;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v43 = 2114;
          v44 = v19;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@ to %{public}@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v43 = 2114;
          v44 = v17;
          _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting keyPath: %{public}@ on notification from adaptor to %{public}@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2114;
      v42 = v9;
      _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Did not find setting with keyPath: %{public}@ on update from fetched settings adaptor", buf, 0x16u);
...
- (void)legacySettingsAdaptor:(id)a3 didLoadSettingKeyPath:(id)a4 selectedLanguageValue:(id)a5 availableLanguageList:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v13;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Did update setting from keyPath:%@ value = %@, availableLanguageList = %@", (uint8_t *)&v18, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v22 = 2112;
        v23 = v5;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get language constraints from language setting: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v3;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get language setting from root group: %@", buf, 0x16u);
...
id __51__HMDAccessorySettingsController_languageValueList__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    if ((unint64_t)objc_msgSend(v8, "count") > 2)
    {
      ...
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7978]), "initWithInputLanguageCode:outputVoiceLanguageCode:outputVoiceGenderCode:voiceName:", v18, v19, v20, v21);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v7;
        _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get expected language code count from legacy language setting encoding: %@", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v3;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get legacy langage setting encoding from language constaint: %@", (uint8_t *)&v23, 0x16u);
...
void __92__HMDAccessorySettingsController_legacySettingsAdaptor_didUpdateSettingKeyPath_numberValue___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@ with error %@", (uint8_t *)&v13, 0x20u);
...
void __92__HMDAccessorySettingsController_legacySettingsAdaptor_didUpdateSettingKeyPath_numberValue___block_invoke_153(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v15 = 2114;
    v16 = v12;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@", (uint8_t *)&v13, 0x16u);
    ...
    if (!v2)
    {
      ...
      if (v3)
      {
        if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
        {
          ...
          v10 = 138543362;
          v11 = v8;
          _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Already initiated settings creation for older software counterpart. Will not attempt again", (uint8_t *)&v10, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v10 = 138543362;
          v11 = v9;
          _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Detected no settings with older software counterpart. Will create settings.", (uint8_t *)&v10, 0xCu);
...
uint64_t __53__HMDAccessorySettingsController_updateSettingOwner___block_invoke(uint64_t a1)
{
  ...
  if (*(unsigned __int8 *)(a1 + 40) != (_DWORD)result)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 2112;
      v11 = v7;
      _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting owner to %@", (uint8_t *)&v8, 0x16u);
...
void __83__HMDAccessorySettingsController_didChangeDependantSettings_ownerSettingsKeyPaths___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x227676638](objc_msgSend(*(id *)(a1 + 32), "setOwnerController:", *(_QWORD *)(a1 + 40)));
  v3 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v31 = 2112;
    v32 = v7;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Evaluating dependents from %@ to current %@", buf, 0x20u);
      ...
      if (v15 && (objc_msgSend(v15, "isReflected") & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v21;
          ...
          v29 = 2112;
          v30 = v16;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Setting %@ became reflected", buf, 0x16u);
  ...
  if (!*(_QWORD *)(a1 + 48))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v24 = 2112;
      v25 = v14;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Successfully replaced %@ constraints with %@ constraints.", buf, 0x20u);
...
void __144__HMDAccessorySettingsController_onMessageReplaceConstraintsWithAdditions_constraintIdsToRemove_keyPath_senderProductClass_isRemote_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v8;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Got response from owner failing current %@.", (uint8_t *)&v11, 0x16u);
...
void __79__HMDAccessorySettingsController_onMessageRemoveConstraint_keyPath_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v50 = 2112;
    v51 = v2;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Executing remove constraint request %@ for setting %@", buf, 0x20u);
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = v20;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", buf, 0x16u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = v2;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove constraint on atomic setting %@", buf, 0x16u);
...
LABEL_11:
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v47 = v25;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Ignoring owner controller for removing constraint.", buf, 0xCu);
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "isProxy"))
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v47 = v29;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Only the setting owner is allowed to remove constraints.", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v50 = 2112;
      v51 = v2;
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_INFO, "%{public}@Removing constraint %@ from setting %@", buf, 0x20u);
...
void __76__HMDAccessorySettingsController_onMessageAddConstraint_keyPath_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v56 = 2112;
    v57 = v2;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Executing add constraint request %@ for setting %@", buf, 0x20u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v54 = 2112;
      v55 = v2;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot add constraint on atomic setting %@", buf, 0x16u);
...
LABEL_11:
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v25;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Ignoring owner controller for adding constraint.", buf, 0xCu);
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "isProxy"))
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v29;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Only the setting owner is allowed to add constraints.", buf, 0xCu);
    ...
    if ((v33 & 1) != 0)
    {
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v56 = 2112;
        v57 = v2;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Adding constraint %@ on setting %@", buf, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v58 = 2112;
        v59 = v31;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_ERROR, "%{public}@Constraint %@ cannot be added to setting %@. error: %@", buf, 0x2Au);
  ...
  else
  {
    if (objc_msgSend(*(id *)(a1 + 32), "configurationVersion") >= a3)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v30 = 2048;
        v31 = v22;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Not changing locally as the new config version isnt higher %tu (current %tu)", (uint8_t *)&v26, 0x20u);
    ...
    else
    {
      ...
      if ((v11 & 1) != 0)
      {
        if (v15)
        {
          ...
          v28 = 2112;
          v29 = (unint64_t)v17;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Not updating the value from %@ as the new value is same", (uint8_t *)&v26, 0x16u);
      ...
      else
      {
        if (v15)
        {
          ...
          v30 = 2112;
          v31 = (uint64_t)v7;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Updating the value locally from %@ to %@", (uint8_t *)&v26, 0x20u);
...
void __102__HMDAccessorySettingsController__updateValue_forSetting_senderVersion_senderProductClass_completion___block_invoke_98(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Adaptor update result keyPath:%{public}@ error: %@", (uint8_t *)&v11, 0x20u);
...
void __58__HMDAccessorySettingsController_owner_didUpdateSettings___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v52 = 2112;
    v53 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Owner %@ sent fix settings request", buf, 0x16u);
          ...
          if ((v20 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              v58 = 2112;
              v59 = v16;
              _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Comparing between %@ and owner %@, Values are not matching: %@, %@", buf, 0x34u);
            ...
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", objc_msgSend(v15, "configurationVersion") + 1);
            v30 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            if (objc_msgSend(v34, "count"))
            {
              ...
              if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = v40;
                ...
                v56 = 2112;
                v57 = v39;
                _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Added constraints %@ in fixup %@ and owner %@.", buf, 0x2Au);
...
void __56__HMDAccessorySettingsController_scheduleDependantFixup__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v19 = 2112;
    v20 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received request to fix settings for dependents: %@", (uint8_t *)&v17, 0x16u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@There is already an fix setting request in queue, kicking it again", (uint8_t *)&v17, 0xCu);
...
void __65__HMDAccessorySettingsController__migrateSettingsWithCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Finished migrating settings.", (uint8_t *)&v9, 0xCu);
...
void __49__HMDAccessorySettingsController__createSettings__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v34 = 138543362;
    v35 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Finished creating settings.", (uint8_t *)&v34, 0xCu);
  ...
  v39[1] = v12;
  v13 = (id)objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v39, v38, 2);
  ...
  {
    LOWORD(v34) = 0;
    _os_signpost_emit_with_name_impl(&dword_2218F0000, v16, OS_SIGNPOST_INTERVAL_END, v17, "SettingsCreate", ", (uint8_t *)&v34, 2u);
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2048;
    v37 = v22;
    _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Setup start timestamp %f", (uint8_t *)&v34, 0x16u);
  ...
  v26 = v25;
  v27 = (void *)MEMORY[0x227676638](v24);
  v28 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v29 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2048;
    v37 = v31;
    _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Settings creation latency %f", (uint8_t *)&v34, 0x16u);
...
void __47__HMDAccessorySettingsController_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Fix settings timer has fired, issuing fix settings", (uint8_t *)&v14, 0xCu);
  ...
  else
  {
    ...
    if (v4 == v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v9;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Audit settings timer has fired, issuing audit for settings", (uint8_t *)&v14, 0xCu);
...
uint64_t __63__HMDAccessorySettingsController_scheduleAuditWithReason_from___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received audit with reason %@ from %@", (uint8_t *)&v9, 0x20u);
...
void __60__HMDAccessorySettingsController_settingsHierarchyDidChange__block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v57 = 2112;
    v58 = v9;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Added groups: %@, settings: %@. Removed groups: %@, settings: %@", buf, 0x34u);
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v55 = 2112;
    v56 = v38;
    _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Current root:%@, settings: %@, groups: %@", buf, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_205092 != -1)
    dispatch_once(&logCategory__hmf_once_t3_205092, &__block_literal_global_205093);
  return (id)logCategory__hmf_once_v4_205094;
}
...
void __45__HMDAccessorySettingsController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_205094;
  logCategory__hmf_once_v4_205094 = v0;
