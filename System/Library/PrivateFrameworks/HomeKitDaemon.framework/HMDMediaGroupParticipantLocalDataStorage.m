...
- (void)configureWithHome:(id)a3 messageDispatcher:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring media groups participant local storage", (uint8_t *)&v13, 0xCu);
...
- (id)protoParticipantData
{
  ...
  if (!v3)
    goto LABEL_4;
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD77B8]), "initWithData:", v3);
  if (!v4)
  {
    _HMFPreconditionFailure();
LABEL_4:
...
- (id)lastCachedEventParticipantData
{
    ...
    if (v5)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v24 = 2112;
          v25 = v5;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode last cached event participant data: %@ from event: %@", (uint8_t *)&v20, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last cached event participant data due to missing topic name", (uint8_t *)&v20, 0xCu);
...
- (id)createDefaultParticipantData
{
  ...
  return -[HMDMediaGroupsParticipantData initWithDestination:destinationControllerData:backedUpGroups:](v2, "initWithDestination:destinationControllerData:backedUpGroups:", 0, 0, MEMORY[0x24BDBD1A8]);
}
...
- (id)migratedParticipantData:(id)a3 withDestinationSupportOptions:(unint64_t)a4
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v20;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Attempted to migrate expected destination support options: %@ without a destination", (uint8_t *)&v22, 0x16u);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v13;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Migrating supported options to: %@", (uint8_t *)&v22, 0x16u);
...
- (void)migrateWithExpectedDestinationControllerSupportOptions:(unint64_t)a3
{
  ...
  if (v5)
  {
    if (objc_msgSend(v5, "supportedOptions") != a3)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 2112;
        v20 = v11;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Migrating expected destination controller support options: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v16;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Attempted to migrate with expected support options: %@ without a destination controller", (uint8_t *)&v17, 0x16u);
  ...
  if (-[HMDMediaGroupParticipantLocalDataStorage hasDataToPublishInParticipantData:](self, "hasDataToPublishInParticipantData:", v3))
  {
    ...
    if (v5)
    {
      if (v9)
      {
        ...
        v14 = 2112;
        v15 = v4;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Skipping publish due to last cached event participant data: %@", (uint8_t *)&v12, 0x16u);
    ...
    else
    {
      if (v9)
      {
        ...
        v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Publishing cached object due to mismatching last cached event data", (uint8_t *)&v12, 0xCu);
...
- (void)publishCachedObject
{
    ...
    else
    {
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v21;
        _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to publish data due to no topic name or event source", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v20;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping publish due to no data", buf, 0xCu);
...
- (id)topicName
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get topic name due to no data source", (uint8_t *)&v11, 0xCu);
...
- (void)updateParticipantData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating participant data: %@", (uint8_t *)&v11, 0x16u);
...
- (void)updateDestinationControllerData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating DestinationControllerData: %@", (uint8_t *)&v18, 0x16u);
  ...
  {
    LOWORD(v18) = 0;
    _os_signpost_emit_with_name_impl(&dword_2218F0000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "MediaGroupsParticipantUpdateDestinationController", ", (uint8_t *)&v18, 2u);
  }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v4;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping update destination controller due to no change to value: %@", (uint8_t *)&v18, 0x16u);
...
- (void)updateDestinationControllerDestinationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destinaiton controller destination identifier: %@", (uint8_t *)&v18, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v4;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination controller destination identifier: %@ due to no controller data", (uint8_t *)&v18, 0x16u);
...
- (void)notifyDidChangeDestinationIdentifier:(id)a3 forDestinationControllerIdentifier:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of updated destination identifier due to missing delegate", (uint8_t *)&v14, 0xCu);
...
- (void)updateDestinationControllerSupportedOptions:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destination controller supported options: %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v18;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination controller supported options: %@ due to no controller data", (uint8_t *)&v19, 0x16u);
...
- (void)updateDestinationControllerAvailableDestinationIdentifiers:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destination controller available destination identifiers: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v4;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination controller available destination identifiers: %@ due to no controller data", (uint8_t *)&v17, 0x16u);
...
- (void)updateMediaDestination:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating media destination: %@", (uint8_t *)&v18, 0x16u);
  ...
  {
    LOWORD(v18) = 0;
    _os_signpost_emit_with_name_impl(&dword_2218F0000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "MediaGroupsParticipantUpdateDestination", ", (uint8_t *)&v18, 2u);
  }
  -[HMDMediaGroupParticipantLocalDataStorage participantData](v6, "participantData");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v4;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping destination update due to no changed in value: %@", (uint8_t *)&v18, 0x16u);
...
- (void)updateAudioGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating audio group identifier: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v4;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to update audio group identifier: %@ due to no destination data", (uint8_t *)&v17, 0x16u);
...
- (void)updateDestinationSupportOptions:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destination support options: %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v18;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination support options: %@ due to no destination data", (uint8_t *)&v19, 0x16u);
...
- (void)updateBackupGroupData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v9;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Update backup groups: count(%@)", (uint8_t *)&v26, 0x16u);
  ...
  {
    LOWORD(v26) = 0;
    _os_signpost_emit_with_name_impl(&dword_2218F0000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "MediaGroupsParticipantUpdateBackupGroup", ", (uint8_t *)&v26, 2u);
  }
  -[HMDMediaGroupParticipantLocalDataStorage participantData](v6, "participantData");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v23;
    _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Skipping backup groups update due to no change to values: count(%@)", (uint8_t *)&v26, 0x16u);
...
void __63__HMDMediaGroupParticipantLocalDataStorage_publishCachedObject__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_ERROR, "%{public}@Forwarding event completed with error: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t39 != -1)
    dispatch_once(&logCategory__hmf_once_t39, &__block_literal_global_9960);
