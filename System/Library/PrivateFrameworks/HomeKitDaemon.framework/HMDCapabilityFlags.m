...
- (HMDCapabilityFlags)initWithCapabilityOptions:(unint64_t)a3
{
  ...
  do
  {
    if ((a3 >> v6))
      v8 = v7;
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", (a3 >> v6));
  ...
  objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytesNoCopy:length:freeWhenDone:", v11, v10, 1);
...
- (HMDCapabilityFlags)initWithCapabilities:(id)a3
{
  ...
  if (v9 >= 9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v12;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Ran over 64 bits, you sure this is expected?", buf, 0xCu);
  ...
  objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytesNoCopy:length:freeWhenDone:", v13, v9, 1);
