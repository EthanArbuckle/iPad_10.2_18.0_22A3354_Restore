...
- (HMDEvent)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v6);
    uuid = v5->_uuid;
    v5->_uuid = (NSUUID *)v7;
...
- (BOOL)_activate:(unint64_t)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v12;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating the activation type from %@ to %@", (uint8_t *)&v17, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_150629 != -1)
    dispatch_once(&logCategory__hmf_once_t0_150629, &__block_literal_global_150630);
  return (id)logCategory__hmf_once_v1_150631;
}
...
void __23__HMDEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_150631;
  logCategory__hmf_once_v1_150631 = v0;
