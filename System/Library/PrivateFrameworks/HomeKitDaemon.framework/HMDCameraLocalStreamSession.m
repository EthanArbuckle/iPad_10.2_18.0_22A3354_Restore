...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_219496 != -1)
    dispatch_once(&logCategory__hmf_once_t2_219496, &__block_literal_global_219497);
  return (id)logCategory__hmf_once_v3_219498;
}
...
void __42__HMDCameraLocalStreamSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_219498;
  logCategory__hmf_once_v3_219498 = v0;
