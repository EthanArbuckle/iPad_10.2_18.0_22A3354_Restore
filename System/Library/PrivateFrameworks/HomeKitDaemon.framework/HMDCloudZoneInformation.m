    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v24;
            ...
            v34 = 2112;
            v35 = v10;
            _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot convert zone information to zone information dictionary, %@", buf, 0x16u);
        ...
        else
        {
          ...
          objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend(v10, "schemaVersion"));
