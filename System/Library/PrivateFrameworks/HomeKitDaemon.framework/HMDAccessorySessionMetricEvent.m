...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v5, "isAccessoryBatteryPowered"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("isAccessoryBatteryPowered"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v5, "isAccessoryBridged"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("isAccessoryBridged"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", objc_msgSend(v5, "isThreadAccessory"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v11, CFSTR("isThreadAccessory"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetricEvent isHomeThreadCapable](self, "isHomeThreadCapable"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("isHomeThreadCapable"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetricEvent isPrimaryThreadCapable](self, "isPrimaryThreadCapable"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v13, CFSTR("isPrimaryResidentThreadCapable"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetricEvent isThreadNetworkUp](self, "isThreadNetworkUp"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("isThreadNetworkUp"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetricEvent isPrimary](self, "isPrimary"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v15, CFSTR("isPrimary"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent percentageDurationActiveSession](self, "percentageDurationActiveSession"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v16, CFSTR("percentageDurationActiveSession"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent percentDurationReachable](self, "percentDurationReachable"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent sessionFailures](self, "sessionFailures"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent successfulSessionRetries](self, "successfulSessionRetries"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v24, CFSTR("successfulSessionRetries"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDAccessorySessionMetricEvent topErrorCode](self, "topErrorCode"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent numActiveSessionClients](self, "numActiveSessionClients"));
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v27, CFSTR("numActiveSessionClients"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent lastSeenSecondsAgo](self, "lastSeenSecondsAgo"));
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v28, CFSTR("lastSeenSecondsAgo"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetricEvent lastSeenWithLowBattery](self, "lastSeenWithLowBattery"));
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v29, CFSTR("lastSeenWithLowBattery"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent numIPAddresses](self, "numIPAddresses"));
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v30, CFSTR("numIPAddressesResolved"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent numIPAddressesTried](self, "numIPAddressesTried"));
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v31, CFSTR("numIPAddressesTried"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDAccessorySessionMetricEvent numBonjourNames](self, "numBonjourNames"));
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v32, CFSTR("numBonjourNamesSeen"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[HMDAccessorySessionMetricEvent bonjourUpdateForced](self, "bonjourUpdateForced"));
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
  {
    ...
    v47 = 2112;
    v48 = v3;
    _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_DEBUG, "%{public}@Serialized HMDAccessorySessionMetricEvent for accessory: %@/%@ - %@", (uint8_t *)&v41, 0x2Au);
