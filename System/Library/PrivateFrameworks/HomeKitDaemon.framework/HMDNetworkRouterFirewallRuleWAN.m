...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[HMDNetworkRouterFirewallRuleWAN purpose](self, "purpose"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v23 = (void *)objc_msgSend(v4, "initWithName:value:", CFSTR("Purpose"), v24);
  v26[0] = v23;
  v5 = objc_alloc(MEMORY[0x24BE3F140]);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", -[HMDNetworkRouterFirewallRuleWAN transportProtocol](self, "transportProtocol"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", -[HMDNetworkRouterFirewallRuleWAN portStart](self, "portStart"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v8, "initWithName:value:", CFSTR("PortStart"), v9);
  v26[3] = v10;
  v11 = objc_alloc(MEMORY[0x24BE3F140]);
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedShort:", -[HMDNetworkRouterFirewallRuleWAN portEnd](self, "portEnd"));
...
LABEL_33:
  ...
  if (v9)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Unknown (0x%llx)"), v9);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_36:
  ...
  if (v15 >= 2)
  {
    if (v15 == 2)
    {
      -[HMDNetworkRouterFirewallRuleWAN icmpTypes](self, "icmpTypes");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "na_map:", &__block_literal_global_161);
      v20 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (HMFNetAddress)ipAddressAnyIPv4
{
  if (ipAddressAnyIPv4_onceToken != -1)
    dispatch_once(&ipAddressAnyIPv4_onceToken, &__block_literal_global_121_192036);
...
+ (HMFNetAddress)ipAddressAnyIPv6
{
  if (ipAddressAnyIPv6_onceToken != -1)
    dispatch_once(&ipAddressAnyIPv6_onceToken, &__block_literal_global_123_192035);
...
LABEL_10:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v25 = 2112;
      v26 = v8;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@WAN rule contains an unkown type value %@: %@", buf, 0x20u);
  ...
  if (!objc_msgSend(v9, "count"))
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v112 = (uint64_t)v42;
      _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an empty hostname array", buf, 0xCu);
  ...
  if (!v20)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v113 = 2112;
      v114 = v65;
      _os_log_impl(&dword_2218F0000, v63, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a non-string hostname: %@", buf, 0x16u);
  ...
  if (!objc_msgSend(v21, "length") || (unint64_t)objc_msgSend(v21, "length") >= 0xFE)
  {
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v103 = 138543874;
      ...
      v107 = 2048;
      v108 = v60;
      _os_log_impl(&dword_2218F0000, v58, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its length is out of bounds: %lu", v103, 0x20u);
...
LABEL_61:
  ...
  if ((unint64_t)objc_msgSend(v22, "count") > 1)
  {
    if (validateHostNameForWANFirewallRule_onceTokenRegex != -1)
      dispatch_once(&validateHostNameForWANFirewallRule_onceTokenRegex, &__block_literal_global_198929);
    v99 = 0u;
    v100 = 0u;
    v97 = 0u;
    v98 = 0u;
      ...
      if (objc_msgSend((id)validateHostNameForWANFirewallRule_componentRegex, "numberOfMatchesInString:options:range:", v27, 0, 0, v28) != 1)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v103 = 138543874;
          ...
          v50 = 32;
LABEL_49:
          _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_INFO, v48, v103, v50);
        ...
        if (v30)
        {
          ...
          if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2218F0000, v73, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its second-to-last component contains a wildcard", v103, 0x16u);
        ...
        if (objc_msgSend(v31, "isEqualToString:", CFSTR("local")))
        {
          ...
          if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2218F0000, v77, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component is 'local'", v103, 0x16u);
        ...
        if (objc_msgSend(v31, "containsString:", CFSTR("*")))
        {
          ...
          if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2218F0000, v77, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component contains a wildcard", v103, 0x16u);
        ...
        if (objc_msgSend(v31, "rangeOfCharacterFromSet:", v32) == 0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2218F0000, v82, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component does not contain letters", v103, 0x16u);
        ...
        if (objc_msgSend(v89, "containsObject:", v21))
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v113 = 2112;
            v114 = v21;
            _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a duplicate hostname: %@", buf, 0x16u);
...
LABEL_50:
  ...
  if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v103 = 138543874;
    ...
    v107 = 2048;
    v108 = 2;
    _os_log_impl(&dword_2218F0000, v69, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because it does not contain at least %lu components", v103, 0x20u);
...
LABEL_52:
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v113 = 2112;
    v114 = v21;
    _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid hostname: %@", buf, 0x16u);
...
+ (BOOL)__decodeAddresses:(id)a3 subject:(id *)a4
{
  ...
  if (!objc_msgSend(v6, "count"))
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v59 = v34;
      _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an empty address array", buf, 0xCu);
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v60 = 2112;
          v61 = v12;
          _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a non-string address: %@", buf, 0x16u);
      ...
      if (!v16)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v60 = 2112;
          v61 = v14;
          _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid address: %@", buf, 0x16u);
      ...
      if (objc_msgSend(v10, "containsObject:", v15))
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v60 = 2112;
          v61 = v15;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a duplicate address: %@", buf, 0x16u);
  ...
  if ((HIDWORD(v52) & v49 & 1) != 0 || (v52 & HIDWORD(v49) & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v60 = 2112;
      v61 = v8;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a mix of wildcard and non-wildcard addresses: %@", buf, 0x16u);
...
LABEL_10:
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v27, 0x20u);
...
LABEL_20:
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, v23, (uint8_t *)&v27, 0x20u);
...
LABEL_10:
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v18;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@IP address range must have matching address family", (uint8_t *)&v20, 0xCu);
...
LABEL_24:
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, v16, buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v37 = 2112;
        v38 = v28;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Invalid address value: %@", buf, 0x16u);
...
LABEL_11:
            _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, v15, buf, 0xCu);
    ...
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v34 = 2112;
        v35 = v6;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid '%@' value: %@", buf, 0x20u);
...
void __47__HMDNetworkRouterFirewallRuleWAN_ipAddressAny__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F1E0]), "initWithHostname:", CFSTR("*"));
...
void __51__HMDNetworkRouterFirewallRuleWAN_ipAddressAnyIPv6__block_invoke()
{
  ...
  v2[0] = xmmword_2226A0FC0;
  *(_OWORD *)((char *)v2 + 12) = *(__int128 *)((char *)&xmmword_2226A0FC0 + 12);
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F1E0]), "initWithSocketAddress:", v2);
