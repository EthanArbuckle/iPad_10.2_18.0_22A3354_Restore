...
- (HMDSymptomManager)initWithDataSource:(id)a3
{
  ...
  v13 = -[HMDSymptomManager initWithQueue:dataSource:supportsRegistering:supportsCurrentDeviceSymptoms:deviceDiscovery:companionLinkClient:wifiManager:notificationCenter:sharingClientFactory:](self, "initWithQueue:dataSource:supportsRegistering:supportsCurrentDeviceSymptoms:deviceDiscovery:companionLinkClient:wifiManager:notificationCenter:sharingClientFactory:", v8, v4, +[HMDDeviceCapabilities supportsSymptomsHandler](HMDDeviceCapabilities, "supportsSymptomsHandler"), 0, v9, v10, v11, v12, &__block_literal_global_151130);
...
- (HMDSymptomManager)initWithQueue:(id)a3 dataSource:(id)a4 supportsRegistering:(BOOL)a5 supportsCurrentDeviceSymptoms:(BOOL)a6 deviceDiscovery:(id)a7 companionLinkClient:(id)a8 wifiManager:(id)a9 notificationCenter:(id)a10 sharingClientFactory:(id)a11
{
  ...
  if (v20)
  {
    ...
    v21->_nearbyAccessoryUUIDsNotOnCurrentNetwork = (NSArray *)MEMORY[0x24BDBD1A8];
    ...
    -[NSNotificationCenter addObserver:selector:name:object:](v21->_notificationCenter, "addObserver:selector:name:object:", v21, sel_handleCurrentNetworkDidChangeNotification_, *MEMORY[0x24BE3F130], 0);
  }
  if (v13)
...
- (void)_startDeviceDiscovery
{
  ...
  -[HMDSymptomManager deviceDiscovery](self, "deviceDiscovery", v8, 3221225472, __42__HMDSymptomManager__startDeviceDiscovery__block_invoke_3, &unk_24E789A98);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v25 = v15;
    _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Starting SFDeviceDiscovery in HMDSymptomManager", buf, 0xCu);
...
- (void)_startCompanionLinkClient
{
  ...
  -[HMDSymptomManager companionLinkClient](self, "companionLinkClient", v6, 3221225472, __46__HMDSymptomManager__startCompanionLinkClient__block_invoke_92, &unk_24E789AE8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v23 = v13;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting RPCompanionLinkClient in HMDSymptomManager", buf, 0xCu);
...
- (void)_stop
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Stopping SFDeviceDiscovery and RPCompanionLinkClient in HMDSymptomManager.", (uint8_t *)&v10, 0xCu);
...
- (void)_registerForCurrentDeviceSymptoms
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v10;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Device doesn't support retrieving problem flags.", buf, 0xCu);
...
- (void)_initiateFixForAccessory:(id)a3 completion:(id)a4
{
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 11);
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v34 = 1024;
        v35 = v16;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Asking SFClient to repair device %@ with flags %d", (uint8_t *)&v30, 0x1Cu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v32 = 2112;
        v33 = v6;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Sharing has not discovered SFDevice for %@, not initiating fix process.", (uint8_t *)&v30, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = v6;
      _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@The accessory (%@) does not have idsIdentifier, not initiating fix process.", (uint8_t *)&v30, 0x16u);
  ...
  if (v6)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v13;
        _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Peforming network mismatch fetch as accessory is in list", (uint8_t *)&v14, 0xCu);

      }
      objc_autoreleasePoolPop(v10);
      -[HMDSymptomManager updateNetworkMismatchInfoWithCompletionHandler:](v11, "updateNetworkMismatchInfoWithCompletionHandler:", &__block_literal_global_103_151062);
    }
  }
  ...
  if (v39)
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v81 = 2112;
      v82 = v43;
      _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@ is not reachable over local network: %@", buf, 0x20u);
...
LABEL_38:
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v83 = 2112;
          v84 = v57;
          _os_log_impl(&dword_2218F0000, v54, OS_LOG_TYPE_INFO, "%{public}@Mismatched WiFi SSID, current: %@ accessory(%@): %@", buf, 0x2Au);
        ...
        if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v79 = 2112;
          v80 = v62;
          _os_log_impl(&dword_2218F0000, v60, OS_LOG_TYPE_INFO, "%{public}@Creating WiFi network mismatch symptom for nearby IDS identifier that is not network reachable: %@", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v58);
        v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 11);
      ...
      if (!v47)
      {
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v79 = 2112;
          v80 = v5;
          _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ WiFi info is nil", buf, 0x16u);
  ...
  if (v69)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v79 = 2112;
      v80 = v29;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_INFO, "%{public}@Creating captive lease renewal symptom, WiFi SSID: %@", buf, 0x16u);

      v24 = v73;
    }

    objc_autoreleasePoolPop(v24);
    v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 19);
  ...
  if ((v32 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v81 = 2112;
      v82 = v9;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_INFO, "%{public}@Updating symptoms for accessory with IDS identifier %@: %@", buf, 0x20u);
...
- (void)_sfDeviceFoundHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Found new SFDevice: %@", (uint8_t *)&v18, 0x16u);
...
- (void)_sfDeviceChangedHandler:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v4;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@SFDevice %@ changed", (uint8_t *)&v20, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v4;
      _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_INFO, "%{public}@Did not find SFDevice %@ in the nearby SFDevices, so treating it as a found device", (uint8_t *)&v20, 0x16u);
...
- (void)_sfDeviceLostHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Lost SFDevice: %@", (uint8_t *)&v17, 0x16u);
...
- (void)_rpDeviceFoundHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Found new RPCompanionLinkDevice: %@)", (uint8_t *)&v13, 0x16u);
...
- (void)_rpDeviceChangedHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@RPCompanionLinkDevice %@ changed", (uint8_t *)&v25, 0x16u);
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v4;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@RPCompanionLinkDevice %@ changed", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v24;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Did not find RPCompanionLinkDevice %@ in the network reachable RPCompanionLinkDevices: %@", (uint8_t *)&v25, 0x20u);
...
- (void)_rpDeviceLostHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Lost RPCompanionLinkDevice: %@", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_ERROR, "%{public}@Could not obtain accessory from WiFi network info change notification: %@", buf, 0x16u);
...
void __54__HMDSymptomManager__registerForCurrentDeviceSymptoms__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 2112;
    v15 = v5;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Setting current device problem flags on start %llu, error: %@", (uint8_t *)&v10, 0x20u);
...
void __54__HMDSymptomManager__registerForCurrentDeviceSymptoms__block_invoke_97(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Current device problem flags changed", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Device doesn't support retrieving problem flags.", buf, 0xCu);
...
void __54__HMDSymptomManager__registerForCurrentDeviceSymptoms__block_invoke_98(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 2112;
    v15 = v5;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Setting current device problem flags to %llu, error: %@", (uint8_t *)&v10, 0x20u);
...
void __46__HMDSymptomManager__startCompanionLinkClient__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Found RPCompanionLinkDevice: %@", (uint8_t *)&v11, 0x16u);
...
void __46__HMDSymptomManager__startCompanionLinkClient__block_invoke_90(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEBUG, "%{public}@RPCompanionLinkDevice %@ changed", (uint8_t *)&v11, 0x16u);
...
void __46__HMDSymptomManager__startCompanionLinkClient__block_invoke_92(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Lost RPCompanionLinkDevice: %@", (uint8_t *)&v11, 0x16u);
...
uint64_t __63__HMDSymptomManager_stopDiscoveringSymptomsRequiringNearbyInfo__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for symptoms requiring nearby info", (uint8_t *)&v9, 0xCu);

  }
  objc_autoreleasePoolPop(v2);
  objc_msgSend(*(id *)(a1 + 32), "setDeviceDiscoveryFlags:", 0x10000);
  objc_msgSend(*(id *)(a1 + 32), "setNearbyAccessoryUUIDsNotOnCurrentNetwork:", MEMORY[0x24BDBD1A8]);
  v6 = *(void **)(a1 + 32);
...
uint64_t __64__HMDSymptomManager_startDiscoveringSymptomsRequiringNearbyInfo__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting discovery for symptoms requiring nearby info", buf, 0xCu);
...
void __64__HMDSymptomManager_startDiscoveringSymptomsRequiringNearbyInfo__block_invoke_86(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 2112;
    v10 = v6;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Updated network mismatch accessories to %@", (uint8_t *)&v7, 0x16u);
...
void __41__HMDSymptomManager_deregisterAccessory___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v8;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Deregistering accessory: %@", (uint8_t *)&v12, 0x16u);
    ...
    if (v3)
    {
      ...
      if (!v5)
      {
        if (v9)
        {
          ...
          v36 = 2112;
          v37 = v3;
          _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering accessory (%@) for idsIdentifier %@", (uint8_t *)&v32, 0x20u);
...
LABEL_11:
        _os_log_impl(&dword_2218F0000, v13, v14, v12, (uint8_t *)&v32, 0x16u);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    v32 = 138543362;
    v33 = v18;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_DEBUG, "%{public}@This device doesn't support registering accessories", (uint8_t *)&v32, 0xCu);
...
{
  return objc_alloc_init(MEMORY[0x24BE900E8]);
}
...
+ (id)_symptomsForProblemFlags:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v33 = 2048;
    v34 = a3;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Parsing problem flags %llu to HMSymptoms", (uint8_t *)&v31, 0x16u);
  ...
  if ((a3 & 2) != 0)
  {
    v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 1);
...
LABEL_5:
  ...
  v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 2);
...
LABEL_27:
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 3);
  objc_msgSend(v9, "addObject:", v17);
...
LABEL_28:
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 4);
...
LABEL_29:
  v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 5);
...
LABEL_30:
  v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 6);
...
LABEL_31:
  v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 7);
...
LABEL_32:
  v22 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 8);
...
LABEL_33:
  v23 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 9);
...
LABEL_34:
  v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 10);
...
LABEL_35:
  v25 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 13);
...
LABEL_36:
  v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 14);
...
LABEL_37:
  v27 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 16);
...
LABEL_38:
  v28 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 17);
...
LABEL_18:
    if ((a3 & 0x20000) == 0)
      goto LABEL_19;
LABEL_40:
    v30 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 20);
...
LABEL_39:
  v29 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 18);
...
LABEL_19:
  ...
  {
LABEL_20:
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 21);
...
LABEL_21:
  ...
  if ((a3 & 0x20) != 0 && v11)
  {
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7A20]), "initWithType:", 1000);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t44 != -1)
    dispatch_once(&logCategory__hmf_once_t44, &__block_literal_global_106_151136);
