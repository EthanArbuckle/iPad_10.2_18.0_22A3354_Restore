...
- (HMDEventCounterGroup)initWithContext:(id)a3 serializedEventCounters:(id)a4 uptimeProvider:(id)a5
{
  ...
  if (v11)
  {
    ...
    if (v9)
    {
      v15 = objc_msgSend(objc_alloc(MEMORY[0x24BDBCED8]), "initWithCapacity:", objc_msgSend(v9, "count"));
...
- (unint64_t)maxCounterName:(id *)a3
{
  ...
  v14 = &v13;
  v15 = 0x3032000000;
  v16 = __Block_byref_object_copy__26480;
  v17 = __Block_byref_object_dispose__26481;
  v18 = 0;
  v9 = 0;
  v10 = &v9;
  v11 = 0x2020000000;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v22 = v15;
          _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Can't call observers; context has been deallocated",
            buf,
            0xCu);
