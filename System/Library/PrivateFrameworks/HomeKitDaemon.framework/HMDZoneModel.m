...
- (id)dependentUUIDs
{
  ...
  -[HMDZoneModel roomUUIDs](self, "roomUUIDs");
  ...
  v15 = 0u;
  v16 = 0u;
  -[HMDZoneModel roomUUIDs](self, "roomUUIDs", 0);
...
+ (id)properties
{
  if (properties_onceToken_95904 != -1)
    dispatch_once(&properties_onceToken_95904, &__block_literal_global_95905);
  return (id)properties__properties_95906;
}
...
void __26__HMDZoneModel_properties__block_invoke()
{
  ...
  v3 = (void *)properties__properties_95906;
  properties__properties_95906 = v2;
...
- (id)cd_generateValueForModelObjectFromManagedObject:(id)a3 modelObjectField:(id)a4 modelFieldInfo:(id)a5
{
  ...
  v9 = a5;
  v10 = a3;
  if (objc_msgSend(v8, "isEqualToString:", CFSTR("roomUUIDs")))
  {
    objc_msgSend(v10, "rooms");
    v11 = (void *)objc_claimAutoreleasedReturnValue();

    +[HMDBackingStore cdlsModelIDStringsForManagedObjects:](HMDBackingStore, "cdlsModelIDStringsForManagedObjects:", v11);
...
- (id)cd_generateValueForProperty:(id)a3 managedObjectField:(id)a4 context:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  if (objc_msgSend(v9, "isEqualToString:", CFSTR("rooms_")))
  {
    if (-[HMDBackingStoreModelObject propertyWasSet:](self, "propertyWasSet:", CFSTR("roomUUIDs")))
    {
      -[HMDZoneModel roomUUIDs](self, "roomUUIDs");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      +[HMDBackingStore cdlsFetchManagedObjectsWithUUIDStrings:ofManagedObjectType:](HMDBackingStore, "cdlsFetchManagedObjectsWithUUIDStrings:ofManagedObjectType:", v11, objc_opt_class());
      v12 = (void *)objc_claimAutoreleasedReturnValue();
