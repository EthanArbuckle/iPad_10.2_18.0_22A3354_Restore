      ...
      if ((v10 & 1) != 0)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v27 = 2112;
          v28 = v15;
          _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Current HMDHAPMetadata version %@ schemaVersion %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v25 = 2112;
          v26 = v8;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to instantiate the current metadata %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v18;
        _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to get plain metadata path", buf, 0xCu);
...
- (HMDHAPMetadata)initWithDictionary:(id)a3 hapMetadata:(id)a4 error:(id *)a5
{
  ...
  if (a3 && a4)
  {
    ...
    objc_msgSend(v11, "setObject:forKeyedSubscript:", v12, *MEMORY[0x24BE1BC98]);
...
- (HMDHAPMetadata)initWithFullPlist:(id)a3 hapMetadata:(id)a4
{
  ...
  return (HMDHAPMetadata *)-[HMDHAPMetadata xpcData:](v11, v12, v13);
}
...
LABEL_32:
        ...
        v27 = (id)*MEMORY[0x24BE1B4D0];
        v28 = (id)*MEMORY[0x24BE1B4E0];
        v29 = (id)*MEMORY[0x24BE1B508];
        -[HMDHAPMetadata hapMetadata](self, "hapMetadata");
...
LABEL_31:
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          v41 = 2112;
          v42 = v6;
          _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Service %@ or service being associated %@ are not compatible", (uint8_t *)&v37, 0x20u);

        }
        objc_autoreleasePoolPop(v32);
        objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 62);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        goto LABEL_31;
      }
    }
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 32;
LABEL_12:
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v37, v21);
...
- (BOOL)shouldAllowToWakeSuspendedAccessoryForOperation:(int64_t)a3 service:(id)a4 characteristicType:(id)a5 value:(id)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v68 = 2112;
    v69 = v12;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Checking if operation: '%@' is allowed to wake accessory for service: '%@' characteristic: '%@' with value '%@'", buf, 0x34u);
  ...
  if (v20)
  {
    ...
    if (v21)
    {
      objc_msgSend(v21, "hmf_arrayForKey:", *MEMORY[0x24BE1BD90]);
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      if ((unint64_t)a3 > 0xA)
        v24 = CFSTR("Undefined");
      else
        v24 = off_24E7800A8[a3];
      v26 = v24;
      ...
      if (v27)
      {
        if (a3 == 3)
        {
          objc_msgSend(v22, "hmf_arrayForKey:", *MEMORY[0x24BE1BD78]);
          ...
          if (v28)
          {
                  ...
                  if (v12 && objc_msgSend(*(id *)(*((_QWORD *)&v55 + 1) + 8 * i), "isEqual:", v12))
                  {
                    ...
                    if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
                    {
                      ...
                      *(_DWORD *)buf = 138544386;
                      ...
                      v68 = 2112;
                      v69 = v12;
                      _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_DEBUG, "%{public}@Operation: %@ on service '%@' and characteristic '%@' with value '%@' is allowed to wake accessory", buf, 0x34u);
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v66 = 2112;
              v67 = v11;
              _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Operation: %@ on service '%@' and characteristic '%@' is not allowed to wake accessory", buf, 0x2Au);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v66 = 2112;
              v67 = v11;
              _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_DEBUG, "%{public}@Operation: %@ on service '%@' and characteristic '%@' is allowed to wake accessory", buf, 0x2Au);
...
- (BOOL)shouldAutoEnableNotificationForCharacteristic:(id)a3 ofService:(id)a4
{
  ...
  if (isCharacteristicHeartBeat(v7, v6) && (isiOSDevice() || isWatch() || isMac()))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v16 = 138543362;
      v17 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Forcing shouldAutoEnableNotification to NO for Heart Beat characteristic", (uint8_t *)&v16, 0xCu);
  ...
  else
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if (-[HMDHAPMetadata checkTupleExistsInSet:forChrType:svcType:](self, "checkTupleExistsInSet:forChrType:svcType:", v13, v6, v7))
    {
      v12 = 1;
    }
    else
    {
      ...
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = objc_msgSend(v14, "containsObject:", v6);
...
- (id)categoryForOther
{
  ...
  objc_msgSend(v2, "objectForKeyedSubscript:", &unk_24E96A730);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)audioAccessoryCategory
{
  ...
  return -[HMDHAPMetadataCategory initWithIdentifier:uuid:name:description:](v2, "initWithIdentifier:uuid:name:description:", &unk_24E96A748, *MEMORY[0x24BDD49E0], CFSTR("homepod"), CFSTR("HomePod"));
}
...
- (id)serviceSubtypeForValue:(id)a3 forServiceType:(id)a4
{
  ...
  if (v5)
  {
    ...
    if (!v8)
    {
      v9 = objc_msgSend(v6, "isEqualToString:", *MEMORY[0x24BE1B880]);
      v10 = (id *)MEMORY[0x24BDD6B08];
      if (!v9)
        v10 = (id *)MEMORY[0x24BDD6B20];
      v8 = *v10;
    }
  }
  else
...
- (id)mapToAssistantCharacteristicName:(id)a3
{
  ...
  if (v4)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v5, "isEqual:", *MEMORY[0x24BE1B5A0]) & 1) == 0
      && (objc_msgSend(v5, "isEqual:", *MEMORY[0x24BE1B598]) & 1) == 0)
    {
...
LABEL_18:
    ...
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", v23 != 0);
      v21 = (id)objc_claimAutoreleasedReturnValue();
    }
    else
    {
...
- (id)parseAndSetRawPlist:(id)a3
{
  ...
  if (v4)
  {
    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCA8]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (-[HMDHAPMetadata parseAndSetHMMetadataWithHMPlist:](self, "parseAndSetHMMetadataWithHMPlist:", v6))
    {
      objc_msgSend(v5, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCB8]);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v21 = 2112;
          v22 = v7;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse assistant metadata from plist %@", (uint8_t *)&v19, 0x16u);

        }
        objc_autoreleasePoolPop(v15);
        objc_msgSend(MEMORY[0x24BDD1540], "hmInternalErrorWithCode:", 1001);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 2112;
        v22 = v6;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HM metadata from plist %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set HMDMetadata because rawPlist is nil.", (uint8_t *)&v19, 0xCu);
...
- (BOOL)parseAndSetHMMetadataWithHMPlist:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD48]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCB0]);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDHAPMetadata parseAndSetAllowableSecuringWrites:](self, "parseAndSetAllowableSecuringWrites:", v8);

    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD88]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDHAPMetadata parseAndSetWakeOnOperationsFilter:](self, "parseAndSetWakeOnOperationsFilter:", v9);

    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCC8]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDHAPMetadata parseAndSetHMCategories:](self, "parseAndSetHMCategories:", v10);

    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCF0]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = *MEMORY[0x24BE1BD58];
    objc_msgSend(v11, "hmf_arrayForKey:", *MEMORY[0x24BE1BD58]);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v15 = *MEMORY[0x24BE1BCD0];
    objc_msgSend(v11, "hmf_arrayForKey:", *MEMORY[0x24BE1BCD0]);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCE8]);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_21:
    ...
    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD20]);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD18]);
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCC0]);
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCD8]);
    v31 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v35)
    {
      ...
      if (v37)
      {
        ...
        objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1B6C8]);
...
- (BOOL)parseAndSetAssistantMetadataWithAssistantPlist:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD58]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
  ...
  objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BCD0]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD70]);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)parseMetadataTupleSetFromPlist:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristic/service tuples: %@", (uint8_t *)&v12, 0x16u);
...
- (void)parseAndSetAllowableSecuringWrites:(id)a3
{
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v28;
            ...
            v36 = 2112;
            v37 = v12;
            _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unknown characteristic '%@' while parsing tuple", buf, 0x16u);
  ...
  if (!objc_msgSend(v5, "count"))
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v26;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@There are no allowable securing writes in the metadata", buf, 0xCu);
...
- (void)parseAndSetHMCategories:(id)a3
{
  ...
  if (v5)
  {
    v6 = v5;
    v28 = *(_QWORD *)v30;
    v27 = *MEMORY[0x24BE1BD00];
    v7 = *MEMORY[0x24BE1BD68];
    v8 = *MEMORY[0x24BE1BCE0];
    do
    {
      for (i = 0; i != v6; ++i)
      {
  ...
  if (!objc_msgSend(v26, "count"))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v22;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@There are no accessory categories in the metadata", buf, 0xCu);
...
- (void)parseAndSetHMAccessoryFirmwareUpdatePolicies:(id)a3
{
  ...
  if (v4)
  {
    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1B728]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v5, "hmf_dictionaryForKey:", *MEMORY[0x24BE1B6C0]);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Accessory firmware update policies not defined!", (uint8_t *)&v14, 0xCu);
...
- (BOOL)policyConfigurationAvailableForAllHAPServices
{
  ...
  v14 = &v13;
  v15 = 0x3032000000;
  v16 = __Block_byref_object_copy__25855;
  v17 = __Block_byref_object_dispose__25856;
  v18 = 0;
  -[HMDHAPMetadata hapMetadata](self, "hapMetadata");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v10;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Firmware update policy configuration missing for service:%@", buf, 0x16u);
...
- (id)parseHMAccessoryFirmwareUpdatePolicyServices:(id)a3
{
  ...
  if (v4)
  {
    objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1B708]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = 0x24BDBC000uLL;
    ...
    {
      v59 = *(_QWORD *)v75;
      context = (void *)*MEMORY[0x24BE1B6F8];
      v64 = self;
LABEL_4:
      v10 = 0;
      while (1)
      {
        ...
        if (!v12)
        {
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v81 = 2112;
            v82 = v69;
            _os_log_impl(&dword_2218F0000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed while parsing policy configuration for service:%@.", buf, 0x16u);
        ...
        v13 = v12;
        v60 = v10;
        objc_msgSend(*(id *)(v7 + 3800), "dictionaryWithCapacity:", objc_msgSend(v12, "count"));
        v14 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                if (!v20)
                {
                  ...
                  if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v81 = 2112;
                    v82 = v69;
                    _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_ERROR, "%{public}@Category type not found for service:%@.", buf, 0x16u);
                  ...
                  else
                  {
                    ...
                    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      v83 = 2112;
                      v84 = v69;
                      _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Service configuration failed for category %@ in service:%@.", buf, 0x20u);
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    v83 = 2112;
                    v84 = v69;
                    _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Criteria configuration failed for category %@ in service:%@.", buf, 0x20u);
        ...
        {
          objc_msgSend(MEMORY[0x24BDD17C8], "stringWithString:", context);
          ...
          if (!v35)
          {
            ...
            if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v83 = 2112;
              v84 = v69;
              _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_ERROR, "%{public}@Service configuration failed for category %@ in service:%@.", buf, 0x20u);
...
LABEL_46:
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v81 = 2112;
        v82 = v11;
        _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_ERROR, "%{public}@Service type not found for service:%@.", buf, 0x16u);
...
- (id)parseHMAccessoryFirmwareUpdatePolicyCriteria:(id)a3
{
  ...
  -[HMDAccessoryFirmwareUpdatePolicyCriteria setAnyUserAtHome:](v5, "setAnyUserAtHome:", objc_msgSend(v4, "hmf_BOOLForKey:", *MEMORY[0x24BE1B6D0]));
  -[HMDAccessoryFirmwareUpdatePolicyCriteria setNoUserAtHome:](v5, "setNoUserAtHome:", objc_msgSend(v4, "hmf_BOOLForKey:", *MEMORY[0x24BE1B700]));
  -[HMDAccessoryFirmwareUpdatePolicyCriteria setCheckForScheduledAutomation:](v5, "setCheckForScheduledAutomation:", objc_msgSend(v4, "hmf_BOOLForKey:", *MEMORY[0x24BE1B6F0]));
  objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1B6E8]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6)
  {
    ...
    if (!v8)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 138543362;
        v28 = v25;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristics", (uint8_t *)&v27, 0xCu);
  ...
  objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x24BE1B718]);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v9;
  if (v9)
  {
    objc_msgSend(v9, "hmf_stringForKey:", *MEMORY[0x24BE1B720]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "hmf_stringForKey:", *MEMORY[0x24BE1B710]);
    v12 = objc_claimAutoreleasedReturnValue();
    v13 = (void *)v12;
    if (v11 && v12)
    {
...
LABEL_18:
    ...
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, v21, (uint8_t *)&v27, 0xCu);
...
- (id)parseHMAccessoryFirmwareUpdatePolicyCharacteristics:(id)a3
{
  ...
  {
    v48 = *(_QWORD *)v51;
    v46 = *MEMORY[0x24BE1B6E0];
    v44 = *MEMORY[0x24BE1B6D8];
    v43 = v4;
LABEL_3:
    v6 = 0;
    while (1)
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v56 = 2112;
          v57 = v9;
          _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed while parsing characteristic %@", buf, 0x16u);
...
LABEL_34:
          ...
          else
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v56 = 2112;
              v57 = v9;
              _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_ERROR, "%{public}@Characteristic configuration failed for characteristic %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v56 = 2112;
            v57 = v9;
            _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Format not found for characteristic %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v56 = 2112;
          v57 = v9;
          _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Values not available for characteristic %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = v7;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@Type not found for characteristic name %@", buf, 0x16u);
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v25 = 2112;
            v26 = v11;
            _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@ServiceName %@ is not a standard HAP serviceName", buf, 0x16u);
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v25 = 2112;
            v26 = v11;
            _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@characteristicName %@ is not a standard HAP characteristicName", buf, 0x16u);
        ...
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v32 = 2112;
            v33 = v13;
            _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Assistant service %@ not mappable - no such HAP service %@", buf, 0x20u);
...
- (BOOL)parseAndSetAssistantCharacteristics:(id)a3
{
  ...
  {
    v54 = *(_QWORD *)v60;
    v53 = *MEMORY[0x24BE1BD40];
    v51 = *MEMORY[0x24BE1BD38];
    v50 = *MEMORY[0x24BE1BD98];
    v52 = *MEMORY[0x24BE1BCF8];
    v48 = *MEMORY[0x24BE1BD60];
    v47 = *MEMORY[0x24BE1BD78];
    v46 = *MEMORY[0x24BE1BD28];
    *(_QWORD *)&v6 = 138543618;
    v45 = v6;
    v57 = v4;
    v55 = v5;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = v45;
                ...
                v65 = 2112;
                v66 = v8;
                _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Assistant characteristic %@ format not specified unknown", buf, 0x16u);
...
LABEL_27:
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, v22, buf, 0x20u);
        ...
        if ((v14 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v27 = 2112;
            v28 = v11;
            _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Assistant unit %@ unknown", buf, 0x16u);
...
- (BOOL)checkTupleExistsInSet:(id)a3 forChrType:(id)a4 svcType:(id)a5
{
  ...
  v7 = (objc_class *)MEMORY[0x24BE1BB30];
  v8 = a5;
  v9 = a4;
  v10 = a3;
...
void __60__HMDHAPMetadata_statusHAPCharacteristicTypesForServiceType__block_invoke()
{
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v39[0] = v17;
  v38[1] = *MEMORY[0x24BE1B7D0];
  v31 = *MEMORY[0x24BE1B520];
  v1 = v31;
  v3 = *MEMORY[0x24BE1B540];
  v30[0] = *MEMORY[0x24BE1B4D8];
  v2 = v30[0];
  v30[1] = v3;
  v4 = *MEMORY[0x24BE1B4A8];
  v30[2] = *MEMORY[0x24BE1B4E8];
  v30[3] = v4;
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v39[1] = v5;
  v38[2] = *MEMORY[0x24BE1B870];
  v28 = v1;
  v27[0] = v2;
  v27[1] = v3;
  v27[2] = *MEMORY[0x24BE1B4F0];
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v39[2] = v7;
  v38[3] = *MEMORY[0x24BE1B880];
  v25 = *MEMORY[0x24BE1B550];
  v8 = v25;
  v9 = *MEMORY[0x24BE1B5C0];
  v24[0] = v4;
  v24[1] = v9;
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v39[3] = v11;
  v38[4] = *MEMORY[0x24BE1B7E0];
  v22 = v8;
  v21[0] = v4;
  v21[1] = v9;
  v21[2] = *MEMORY[0x24BE1B5B8];
...
void __69__HMDHAPMetadata_disallowedAssistantCharacteristicTypesByServiceType__block_invoke()
{
  ...
  v6 = *MEMORY[0x24BDD6B70];
  v0 = (void *)MEMORY[0x24BDBCF20];
  v5 = *MEMORY[0x24BDD5770];
...
void __40__HMDHAPMetadata_aliasedHAPServiceTypes__block_invoke()
{
  ...
  v2 = *MEMORY[0x24BE1B888];
  v3[0] = *MEMORY[0x24BE1B7B8];
...
void __47__HMDHAPMetadata_aliasedHAPCharacteristicTypes__block_invoke()
{
  ...
  v0 = *MEMORY[0x24BE1B590];
  v1 = *MEMORY[0x24BE1B4F8];
  v9[0] = *MEMORY[0x24BE1B4A8];
  v9[1] = v1;
  v2 = *MEMORY[0x24BE1B528];
  v10[0] = v0;
  v10[1] = v2;
  v3 = *MEMORY[0x24BE1B658];
  v9[2] = *MEMORY[0x24BE1B530];
  v9[3] = v3;
  v4 = *MEMORY[0x24BE1B650];
  v10[2] = v2;
  v10[3] = v4;
  v5 = *MEMORY[0x24BE1B5A0];
  v9[4] = *MEMORY[0x24BE1B620];
  v9[5] = v5;
  v6 = *MEMORY[0x24BE1B4B0];
  v10[4] = v4;
  v10[5] = v6;
  v9[6] = *MEMORY[0x24BE1B598];
  v10[6] = v6;
...
void __69__HMDHAPMetadata_mapToAssistantServiceSubtypeName_accessoryCategory___block_invoke()
{
  ...
  v33[0] = *MEMORY[0x24BDD4998];
  v31 = *MEMORY[0x24BDD6BA8];
  v0 = v31;
  v32 = *MEMORY[0x24BE81FB0];
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v32, &v31, 1);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  v34[0] = v1;
  v33[1] = *MEMORY[0x24BDD4970];
  v2 = *MEMORY[0x24BE81FA8];
  v3 = *MEMORY[0x24BDD6C80];
  v28[0] = v0;
  v28[1] = v3;
  v4 = *MEMORY[0x24BE81FC0];
  v30[0] = v2;
  v30[1] = v4;
  v29 = *MEMORY[0x24BDD6BC8];
  v5 = v29;
  v30[2] = v4;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v30, v28, 3);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v34[1] = v6;
  v33[2] = *MEMORY[0x24BDD4988];
  v26 = v0;
  v27 = *MEMORY[0x24BE81FF0];
  v7 = v27;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v27, &v26, 1);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v34[2] = v8;
  v33[3] = *MEMORY[0x24BDD4978];
  v24 = v0;
  v25 = v7;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v25, &v24, 1);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v34[3] = v9;
  v33[4] = *MEMORY[0x24BDD49C8];
  v22 = v0;
  v23 = *MEMORY[0x24BE81FB8];
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v23, &v22, 1);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v34[4] = v10;
  v33[5] = *MEMORY[0x24BDD4A70];
  v20[0] = v3;
  v20[1] = v5;
  v21[0] = v4;
  v21[1] = v4;
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v34[6] = v12;
  v33[7] = *MEMORY[0x24BDD49D0];
  v16 = v5;
  v17 = *MEMORY[0x24BE82020];
...
void __51__HMDHAPMetadata_mapToAssistantServiceSubtypeName___block_invoke()
{
  ...
  v0 = *MEMORY[0x24BE81FD8];
  v1 = *MEMORY[0x24BDD6B10];
  v16[0] = *MEMORY[0x24BDD6B08];
  v16[1] = v1;
  v2 = *MEMORY[0x24BE81FF8];
  v17[0] = v0;
  v17[1] = v2;
  v3 = *MEMORY[0x24BE82008];
  v4 = *MEMORY[0x24BDD6B28];
  v16[2] = *MEMORY[0x24BDD6B18];
  v16[3] = v4;
  v5 = *MEMORY[0x24BE82018];
  v17[2] = v3;
  v17[3] = v5;
  v6 = *MEMORY[0x24BE82010];
  v7 = *MEMORY[0x24BE1B7E8];
  v16[4] = *MEMORY[0x24BE1B7B8];
  v16[5] = v7;
  v8 = *MEMORY[0x24BE82000];
  v17[4] = v6;
  v17[5] = v8;
  v9 = *MEMORY[0x24BE81FC8];
  v10 = *MEMORY[0x24BDD6BC0];
  v16[6] = *MEMORY[0x24BDD6B98];
  v16[7] = v10;
  v11 = *MEMORY[0x24BE81FD0];
  v17[6] = v9;
  v17[7] = v11;
  v12 = *MEMORY[0x24BDD6CA8];
  v16[8] = *MEMORY[0x24BDD6CA0];
  v16[9] = v12;
  v13 = *MEMORY[0x24BE82030];
  v17[8] = *MEMORY[0x24BE82028];
  v17[9] = v13;
...
void __56__HMDHAPMetadata_serviceSubtypeForValue_forServiceType___block_invoke()
{
  ...
  v8 = *MEMORY[0x24BE1B880];
  v0 = *MEMORY[0x24BDD6B08];
  v6[0] = &unk_24E96A760;
  v6[1] = &unk_24E96A778;
  v1 = *MEMORY[0x24BDD6B10];
  v7[0] = v0;
  ...
  v6[2] = &unk_24E96A790;
  v6[3] = &unk_24E96A7A8;
  v2 = *MEMORY[0x24BDD6B28];
  v7[2] = *MEMORY[0x24BDD6B18];
  v7[3] = v2;
...
void __74__HMDHAPMetadata_shouldRefreshValueForCharacteristicWithType_serviceType___block_invoke()
{
  ...
  v0 = *MEMORY[0x24BDD5A98];
  v11[0] = *MEMORY[0x24BDD5858];
  v11[1] = v0;
  v1 = *MEMORY[0x24BDD57F8];
  v11[2] = *MEMORY[0x24BDD5920];
  v11[3] = v1;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v11, 4);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v13[0] = v2;
  v12[1] = CFSTR("00000253-0000-1000-8000-0026BB765291");
  v3 = *MEMORY[0x24BDD5778];
  ...
  v5 = *MEMORY[0x24BDD5928];
  v9[0] = *MEMORY[0x24BDD58E0];
  v9[1] = v5;
  v9[2] = *MEMORY[0x24BDD5770];
...
void __83__HMDHAPMetadata_shouldFilterEnableNotificationsForCharacteristicType_serviceType___block_invoke()
{
  ...
  v0 = (void *)MEMORY[0x24BDBCF20];
  v1 = *MEMORY[0x24BDD6C68];
  v10[0] = *MEMORY[0x24BDD6C60];
  v10[1] = v1;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v10, 2);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
void __54__HMDHAPMetadata_shouldHomeAppShowTileForServiceType___block_invoke()
{
  ...
  v18[29] = *MEMORY[0x24BDAC8D0];
  v0 = (void *)MEMORY[0x24BDBCF20];
  v1 = *MEMORY[0x24BE1B868];
  v18[0] = *MEMORY[0x24BE1B7E8];
  v18[1] = v1;
  v2 = *MEMORY[0x24BE1B7C8];
  v18[2] = *MEMORY[0x24BE1B870];
  v18[3] = v2;
  v3 = *MEMORY[0x24BE1B888];
  v18[4] = *MEMORY[0x24BE1B7B8];
  v18[5] = v3;
  v4 = *MEMORY[0x24BE1B7F0];
  v18[6] = *MEMORY[0x24BE1B7F8];
  v18[7] = v4;
  v5 = *MEMORY[0x24BE1B890];
  v18[8] = *MEMORY[0x24BE1B7A8];
  v18[9] = v5;
  v6 = *MEMORY[0x24BE1B808];
  v18[10] = *MEMORY[0x24BE1B898];
  v18[11] = v6;
  v7 = *MEMORY[0x24BE1B858];
  v18[12] = *MEMORY[0x24BE1B810];
  v18[13] = v7;
  v8 = *MEMORY[0x24BE1B820];
  v18[14] = *MEMORY[0x24BE1B818];
  v18[15] = v8;
  v9 = *MEMORY[0x24BE1B838];
  v18[16] = *MEMORY[0x24BE1B828];
  v18[17] = v9;
  v10 = *MEMORY[0x24BE1B850];
  v18[18] = *MEMORY[0x24BE1B848];
  v18[19] = v10;
  v11 = *MEMORY[0x24BE1B840];
  v18[20] = *MEMORY[0x24BE1B830];
  v18[21] = v11;
  v12 = *MEMORY[0x24BE1B798];
  v18[22] = *MEMORY[0x24BE1B860];
  v18[23] = v12;
  v13 = *MEMORY[0x24BE1B7D8];
  v18[24] = *MEMORY[0x24BE1B7D0];
  v18[25] = v13;
  v14 = *MEMORY[0x24BE1B880];
  v18[26] = *MEMORY[0x24BE1B7E0];
  v18[27] = v14;
  v18[28] = *MEMORY[0x24BE1B7C0];
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v18, 29);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
void __80__HMDHAPMetadata_shouldEnableHomeNotificationForCharacteristicType_serviceType___block_invoke()
{
  ...
  v4 = *MEMORY[0x24BDD5770];
  v14[0] = *MEMORY[0x24BDD5928];
  v14[1] = v4;
...
void __74__HMDHAPMetadata_shouldAutoEnableNotificationForCharacteristic_ofService___block_invoke()
{
  ...
  v4 = *MEMORY[0x24BDD6B50];
  v3 = *MEMORY[0x24BDD59E0];
...
void __41__HMDHAPMetadata_isTargetCharacteristic___block_invoke()
{
  ...
  isTargetCharacteristic__targetCharacteristic = (uint64_t)&unk_24E970C28;
...
void __48__HMDHAPMetadata_requiresTimedWrite_forService___block_invoke()
{
  ...
  v0 = *MEMORY[0x24BE1B618];
  v4[0] = *MEMORY[0x24BE1B648];
  v4[1] = v0;
  v1 = *MEMORY[0x24BE1B4D8];
  v4[2] = *MEMORY[0x24BE1B610];
  v4[3] = v1;
  v4[4] = *MEMORY[0x24BE1B540];
...
+ (HMDHAPMetadata)metadataWithPath:(id)a3 error:(id *)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithContentsOfURL:error:", v7, a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = v8;
  if (v8)
  {
    v10 = *MEMORY[0x24BE1BD30];
    objc_msgSend(v8, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD30]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    if (v11)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 2112;
        v21 = v10;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find metadata for key: %@", (uint8_t *)&v18, 0x16u);
...
+ (HMDHAPMetadata)metadataWithDictionary:(id)a3 error:(id *)a4
{
  ...
  v5 = a3;
  v14 = 0;
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BB20]), "initWithDictionary:error:", v5, &v14);
  v7 = v14;
  v8 = v7;
  if (a4)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to parse HAP metadata from %@ - error %@", buf, 0x20u);
...
+ (id)metadataCache
{
  if (metadataCache_onceToken != -1)
    dispatch_once(&metadataCache_onceToken, &__block_literal_global_25959);
...
+ (id)getBuiltinInstance
{
  ...
  if (!v4)
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "hmf_dictionaryForKey:", *MEMORY[0x24BE1BD30]);
    v8 = (void *)objc_claimAutoreleasedReturnValue();

    v29 = 0;
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE1BB20]), "initWithDictionary:error:", v8, &v29);
    v10 = v29;
    if (v10 || !v9)
    {
      v21 = (void *)MEMORY[0x227676638]();
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v10;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to instantiate builtin HAP metadata %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (!v10 && v5)
      {
        v11 = (void *)MEMORY[0x227676638](objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("builtin")));
        HMFGetOSLogHandle();
        v12 = (id)objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v34 = 2112;
          v35 = v15;
          _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Builtin HAPMetadata version %@ schemaVersion %@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v34 = 2112;
          v35 = v20;
          _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Builtin HMDHAPMetadata version %@ schemaVersion %@", buf, 0x20u);
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v10;
        _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to instantiate builtin metadata %@", buf, 0x16u);
...
+ (void)_logCurrentMetadata
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v7;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_INFO, "%{public}@Switching to HMDHAPMetadata version %@ schemaVersion %@", (uint8_t *)&v8, 0x20u);
...
+ (BOOL)isServiceType:(id)a3 compatibleWithAccessoryCategoryType:(id)a4
{
  ...
  v7 = a3;
  if (v5 != -1)
    dispatch_once(&isServiceType_compatibleWithAccessoryCategoryType__onceToken, &__block_literal_global_139_25946);
...
{
  return +[HMDHAPMetadata dataFromMetadataDictionaryWithKey:](HMDHAPMetadata, "dataFromMetadataDictionaryWithKey:", *MEMORY[0x24BE1BD10]);
}

+ (id)legacyV3DataForCloud
{
  return +[HMDHAPMetadata dataFromMetadataDictionaryWithKey:](HMDHAPMetadata, "dataFromMetadataDictionaryWithKey:", *MEMORY[0x24BE1BD08]);
}
...
+ (BOOL)isOwnerPrivilegeRequiredForWritingCharacteristicType:(id)a3 serviceType:(id)a4
{
  ...
  v7 = (objc_msgSend(v5, "isEqualToString:", CFSTR("00000264-0000-1000-8000-0026BB765291")) & 1) != 0
    ...
    || objc_msgSend(v6, "isEqualToString:", *MEMORY[0x24BDD6B70])
    && !objc_msgSend(v5, "isEqualToString:", *MEMORY[0x24BDD5980]);
...
+ (BOOL)isAdminPrivilegeRequiredForWritingCharacteristicType:(id)a3 serviceType:(id)a4
{
  ...
  v4 = a4;
  if ((objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD6B60]) & 1) != 0)
    v5 = 1;
  else
    v5 = objc_msgSend(v4, "isEqualToString:", *MEMORY[0x24BDD6B70]);
...
+ (void)prepareMetadata
{
  ...
  objc_msgSend(MEMORY[0x24BE1BB20], "setCurrentMetadataHook:", &__block_literal_global_148);
  ...
  if (v5 - 881 <= 2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v51 = 2048;
      v52 = v5;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@Invalid builtin metadata version %lu", buf, 0x16u);
  ...
  +[HMDPersistentStore loadPlainMetadataDictionary](HMDPersistentStore, "loadPlainMetadataDictionary");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = *MEMORY[0x24BE1BD80];
  objc_msgSend(v9, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD80]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v13)
    goto LABEL_20;
  v14 = (void *)v13;
  v15 = *MEMORY[0x24BE1BD50];
  objc_msgSend(v9, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD50]);
  v16 = objc_claimAutoreleasedReturnValue();
  if (!v16)
    goto LABEL_19;
  v17 = (void *)v16;
  v47 = v12;
  v48 = a1;
  v18 = *MEMORY[0x24BE1BD30];
  objc_msgSend(v9, "objectForKeyedSubscript:", *MEMORY[0x24BE1BD30]);
  v19 = objc_claimAutoreleasedReturnValue();
  if (!v19)
  {
LABEL_18:
    ...
    if (isInternalBuild() && v5 == 880 && (unint64_t)(v47 - 881) <= 1)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v55 = 2048;
        v56 = v47;
        _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_INFO, "%{public}@Metadata fix - Constructing version 883 metadata from current builtin version %lu, current builtin plist version %lu, archived version %lu", buf, 0x2Au);
      ...
      objc_msgSend(v26, "setObject:forKeyedSubscript:", &unk_24E96A718, v10);
      objc_msgSend(v26, "objectForKeyedSubscript:", v24);
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v35, "setObject:forKeyedSubscript:", &unk_24E96A718, v10);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v50 = v38;
    _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Cached metadata is not newer than the built-in one, prefer built-in metadata.", buf, 0xCu);
  ...
  if (v40 < v42)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v50 = v45;
      _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@Built-in metadata is newer than the cached one, uploading to the cloud when homed is ready with at least one home or the first home being added.", buf, 0xCu);
...
void __42__HMDHAPMetadata_isHomedVersionSupported___block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F2A8]), "initWithVersionString:", CFSTR("4.0"));
...
void __68__HMDHAPMetadata_isServiceType_compatibleWithAccessoryCategoryType___block_invoke()
{
  ...
  v33[25] = *MEMORY[0x24BDAC8D0];
  v32[0] = *MEMORY[0x24BDD4A18];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C30], 0);
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  v33[0] = v31;
  v32[1] = *MEMORY[0x24BDD49B8];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6B98], 0);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  v33[1] = v30;
  v32[2] = *MEMORY[0x24BDD49C0];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C08], 0);
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  v33[2] = v29;
  v32[3] = *MEMORY[0x24BDD49C8];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6BA8], *MEMORY[0x24BDD6C90], 0);
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  v33[3] = v28;
  v32[4] = *MEMORY[0x24BDD49D8];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6BC0], 0);
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v33[4] = v27;
  v32[5] = *MEMORY[0x24BDD49E8];
  v0 = *MEMORY[0x24BDD6B68];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6B68], 0);
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v33[5] = v26;
  v32[6] = *MEMORY[0x24BDD4A78];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", v0, 0);
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  v33[6] = v25;
  v32[7] = *MEMORY[0x24BDD49F0];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C00], 0);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v33[7] = v24;
  v32[8] = *MEMORY[0x24BDD4A00];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C28], 0);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v33[8] = v23;
  v32[9] = *MEMORY[0x24BDD4A08];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C50], 0);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v33[9] = v22;
  v32[10] = *MEMORY[0x24BDD4A20];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C40], *MEMORY[0x24BDD6C78], *MEMORY[0x24BDD6B48], *MEMORY[0x24BDD6B78], *MEMORY[0x24BDD6B80], *MEMORY[0x24BDD6B88], *MEMORY[0x24BDD6BD8], *MEMORY[0x24BDD6BF0], *MEMORY[0x24BDD6BF8], *MEMORY[0x24BDD6C18], *MEMORY[0x24BDD6C20], 0);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v33[10] = v21;
  v32[11] = *MEMORY[0x24BDD4A40];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C58], 0);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v33[11] = v20;
  v32[12] = *MEMORY[0x24BDD4A70];
  v1 = *MEMORY[0x24BDD6C80];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C80], 0);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v33[12] = v19;
  v32[13] = *MEMORY[0x24BDD4A88];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6CA0], 0);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v33[13] = v18;
  v32[14] = *MEMORY[0x24BDD4A90];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6CA8], 0);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v33[14] = v17;
  v32[15] = *MEMORY[0x24BDD4998];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6B40], 0);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v33[15] = v16;
  v32[16] = *MEMORY[0x24BDD4980];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", v1, 0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v33[16] = v2;
  v32[17] = *MEMORY[0x24BDD4988];
  v3 = *MEMORY[0x24BDD6BD0];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6BD0], 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v33[17] = v4;
  v32[18] = *MEMORY[0x24BDD4978];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", v3, 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v33[18] = v5;
  v32[19] = *MEMORY[0x24BDD4A38];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6BE8], 0);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v33[19] = v6;
  v32[20] = *MEMORY[0x24BDD49D0];
  v7 = *MEMORY[0x24BDD6BB0];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6BB0], 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v33[20] = v8;
  v32[21] = *MEMORY[0x24BDD4A28];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", v7, 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v33[21] = v9;
  v32[22] = *MEMORY[0x24BDD4A50];
  v10 = *MEMORY[0x24BDD6C70];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", *MEMORY[0x24BDD6C70], 0);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v33[22] = v11;
  v32[23] = *MEMORY[0x24BDD4A60];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", v10, 0);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v33[23] = v12;
  v32[24] = *MEMORY[0x24BDD4A68];
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithObjects:", v10, 0);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v33[24] = v13;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v33, v32, 25);
  v14 = objc_claimAutoreleasedReturnValue();
