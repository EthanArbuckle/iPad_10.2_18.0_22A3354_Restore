...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_67965 != -1)
    dispatch_once(&logCategory__hmf_once_t0_67965, &__block_literal_global_67966);
  return (id)logCategory__hmf_once_v1_67967;
}
...
void __41__HMDHomeManagerObjectLookup_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_67967;
  logCategory__hmf_once_v1_67967 = v0;
