...
- (HMDNameValidator)initWithUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("length != 0"));
...
- (id)despaceName:(id)a3
{
  ...
  objc_msgSend(v11, "componentsJoinedByString:", &stru_24E79DB48);
...
- (id)_validateName:(id)a3
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v26 = 2112;
      v27 = v3;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ is empty", (uint8_t *)&v24, 0x16u);
  ...
  if (!objc_msgSend(v3, "rangeOfCharacterFromSet:options:", v6, 129))
  {
    ...
    if (v14 != objc_msgSend(v3, "length") - 1)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v26 = 2112;
        v27 = v3;
        _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ does not end with allowed characters", (uint8_t *)&v24, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v26 = 2112;
        v27 = v3;
        _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ contains disallowed characters", (uint8_t *)&v24, 0x16u);

      }
      objc_autoreleasePoolPop(v20);
      objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", 35);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v26 = 2112;
    v27 = v3;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ does not start with allowed characters", (uint8_t *)&v24, 0x16u);
...
LABEL_15:
  ...
  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", v10);
...
- (id)trimNotAllowedCharactersFromName:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 2112;
      v19 = v5;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ is empty", (uint8_t *)&v16, 0x16u);
...
- (id)_checkForConflict:(id)a3 namespace:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@", (uint8_t *)&v17, 0x16u);

    }
    objc_autoreleasePoolPop(v12);
    v11 = 2;
  }
  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", v11);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_9:
  ...
  if (!v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@ to remove name %@", (uint8_t *)&v19, 0x20u);
...
- (id)_removeName:(id)a3 namespace:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 2112;
      v21 = v6;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@ to remove name %@", (uint8_t *)&v16, 0x20u);
  ...
  if (objc_msgSend(v7, "isEqual:", v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v85 = 2112;
      v86 = v9;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Attempting to replace %@ with same entry in namespaces %@ - skipping...", buf, 0x20u);
          ...
          if (v20)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v87 = 2112;
              v88 = v20;
              _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to remove existing name %@ from namespace %@ error %@", buf, 0x2Au);
            ...
            if (v31)
            {
              ...
              if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v87 = 2112;
                v88 = v55;
                _os_log_impl(&dword_2218F0000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to add new name %@ from namespace %@  error %@", buf, 0x2Au);
                    ...
                    if (v41)
                    {
                      ...
                      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        v87 = 2112;
                        v88 = v41;
                        _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove new name %@ to namespace %@ error %@", buf, 0x2Au);
                    ...
                    if (v50)
                    {
                      ...
                      if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        v87 = 2112;
                        v88 = v50;
                        _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_ERROR, "%{public}@Failed to add existing name %@ to namespace %@ error %@", buf, 0x2Au);
...
- (id)addNamespace:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to add namespace", (uint8_t *)&v11, 0xCu);
...
- (id)removeNamespace:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to remove namespace", (uint8_t *)&v11, 0xCu);
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v8;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to add %@", buf, 0x16u);
...
LABEL_10:
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1540], "hmPrivateErrorWithCode:", 2300);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = *MEMORY[0x24BDD1398];
    v20 = v16;
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", &v20, &v19, 1);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:userInfo:", 95, v17);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)removeName:(id)a3 namespace:(id)a4
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to remove %@", (uint8_t *)&v15, 0x16u);
  ...
  if (!objc_msgSend(v12, "count"))
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v28 = 2112;
      v29 = v11;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Empty set of namespace UUIDs in operation to replace %@ with %@", buf, 0x20u);
...
LABEL_11:
  ...
  if (v6 && !isNameValidWithVoiceShortcut(v11))
  {
    ...
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:userInfo:", 95, v20);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
