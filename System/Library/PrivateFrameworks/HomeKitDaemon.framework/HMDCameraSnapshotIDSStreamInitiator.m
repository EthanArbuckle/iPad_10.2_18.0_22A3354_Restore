...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSStreamInitiator", buf, 0xCu);
...
- (void)_sendFile:(id)a3
{
  ...
  v44 = *MEMORY[0x24BE4FAA8];
  v45 = MEMORY[0x24BDBD1C8];
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v40 = 2112;
      v41 = v20;
      _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_ERROR, "%{public}@Sending file %@ failed with error %@", buf, 0x20u);
  ...
  {
    v27 = (void *)MEMORY[0x227676638](-[HMDCameraSnapshotIDSStreamInitiator setSendFileIdentifier:](self, "setSendFileIdentifier:", v19));
    v28 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v40 = 2112;
      v41 = v19;
      _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Sent the resource transfer request for %@ with identifier %@", buf, 0x20u);
    ...
    if (v18)
    {
      ...
      if (v14)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          v29 = 2112;
          v30 = v14;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received confirmation from IDS that the file send failed for identifier %@: %@", (uint8_t *)&v25, 0x20u);
      ...
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          v27 = 2112;
          v28 = v13;
          _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Received confirmation from IDS that the file send succeeded for identifier: %@", (uint8_t *)&v25, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_252788 != -1)
    dispatch_once(&logCategory__hmf_once_t3_252788, &__block_literal_global_252789);
  return (id)logCategory__hmf_once_v4_252790;
}
...
void __50__HMDCameraSnapshotIDSStreamInitiator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_252790;
  logCategory__hmf_once_v4_252790 = v0;
