      ...
      while (1)
      {
        ...
        if (v13)
        {
          ...
          if (v14)
          {
            ...
            {
              v48 = (void *)v15;
              v49 = objc_alloc(MEMORY[0x24BDD7678]);
              objc_msgSend(v9, "personManagerUUID");
        ...
        {
          v22 = (void *)v21;
          v23 = objc_alloc(MEMORY[0x24BDD7678]);
          objc_msgSend(v9, "personManagerUUID");
        ...
        else
        {
          ...
          {
            v27 = (void *)v26;
            v28 = objc_alloc(MEMORY[0x24BDD7678]);
            objc_msgSend(v9, "personManagerUUID");
...
LABEL_25:
              ...
              if (v20 && v34)
              {
                v35 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7848]), "initWithUUID:", v20);
                objc_msgSend(v35, "setName:", v22);
                v36 = objc_alloc(MEMORY[0x24BDD7678]);
                objc_msgSend(v9, "personManagerUUID");
              ...
              else
              {
                ...
                if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v72 = 2112;
                  v73 = v9;
                  _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_DEFAULT, "%{public}@Could not determine face classification for significant event face classification: %@", buf, 0x16u);
            ...
            v33 = objc_alloc(MEMORY[0x24BDD7678]);
            objc_msgSend(v9, "personManagerUUID");
...
LABEL_41:
    v53 = v60;
    if (v62)
      objc_msgSend(MEMORY[0x24BDBCEB8], "arrayWithObject:");
    else
      objc_msgSend(MEMORY[0x24BDBCEB8], "array");
    v54 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = v57;
    objc_msgSend(v60, "sortedArrayUsingComparator:", &__block_literal_global_120748);
    v55 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v54, "addObjectsFromArray:", v55);
    objc_msgSend(v54, "sortWithOptions:usingComparator:", 16, &__block_literal_global_3_120749);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v46;
      _os_log_impl(&dword_2218F0000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Not returning a face classification because home reference is nil", buf, 0xCu);
...
- (id)personManagerWithUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v14;
      _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Returning nil because home reference is nil", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_120755 != -1)
    dispatch_once(&logCategory__hmf_once_t3_120755, &__block_literal_global_6);
  return (id)logCategory__hmf_once_v4_120756;
}
...
void __66__HMDCameraSignificantEventFaceClassificationResolver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_120756;
  logCategory__hmf_once_v4_120756 = v0;
