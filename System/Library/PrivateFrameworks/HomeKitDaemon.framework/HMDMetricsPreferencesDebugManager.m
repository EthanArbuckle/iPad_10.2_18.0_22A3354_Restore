...
- (void)submitPreferencesSizeLogEventsForApplicationID:(id)a3 submissionTrigger:(unint64_t)a4
{
  ...
  if (isInternalBuild())
  {
    ...
    v9 = CFPreferencesCopyKeyList(v6, (CFStringRef)*MEMORY[0x24BDBD590], (CFStringRef)*MEMORY[0x24BDBD588]);
    v30 = 0u;
    v31 = 0u;
    v32 = 0u;
    v33 = 0u;
        ...
        for (i = 0; i != v26; ++i)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v40 = 2112;
            v41 = cf;
            _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Preferences Key: %{public}@ Size of value: %ld Description: %@", buf, 0x2Au);
