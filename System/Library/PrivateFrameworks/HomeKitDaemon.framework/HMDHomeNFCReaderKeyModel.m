...
+ (id)properties
{
  if (properties_onceToken_284 != -1)
    dispatch_once(&properties_onceToken_284, &__block_literal_global_286_112264);
  return (id)properties__properties_285;
}
...
void __38__HMDHomeNFCReaderKeyModel_properties__block_invoke()
{
  ...
  v2 = (void *)properties__properties_285;
  properties__properties_285 = v1;
