...
- (void)submitFailureEventWithFailureCode:(unint64_t)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v6;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting failure event with failure code: %@ error: %@", (uint8_t *)&v14, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_249292 != -1)
    dispatch_once(&logCategory__hmf_once_t1_249292, &__block_literal_global_249293);
  return (id)logCategory__hmf_once_v2_249294;
}
...
void __58__HMDMediaDestinationManagerMetricsDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_249294;
  logCategory__hmf_once_v2_249294 = v0;
