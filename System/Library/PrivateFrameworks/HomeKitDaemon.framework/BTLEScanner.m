...
- (void)_checkCanScan
{
  ...
  if (-[BTLEScanner countForQueue:](self, "countForQueue:", CFSTR("ScanQueue")))
  {
    ...
    v6 = objc_alloc(MEMORY[0x24BE3F298]);
    ...
    v15 = objc_alloc_init(MEMORY[0x24BE29788]);
    v16 = v15;
    if (v2)
    {
...
void __28__BTLEScanner__checkCanScan__block_invoke_3(uint64_t a1)
{
  ...
  v21 = &v20;
  v22 = 0x3032000000;
  v23 = __Block_byref_object_copy__71129;
  v24 = __Block_byref_object_dispose__71130;
  v25 = 0;
  v16 = 0;
  v17 = &v16;
  v18 = 0x2020000000;
...
uint64_t __28__BTLEScanner__checkCanScan__block_invoke_10(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v30 = 2112;
    v31 = v15;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Scan result -- looking for %@ found %@", buf, 0x20u);
