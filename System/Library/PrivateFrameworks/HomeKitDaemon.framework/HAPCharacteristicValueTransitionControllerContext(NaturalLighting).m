...
- (HMDNaturalLightingActiveTransitionContext)activeTransitionContext
{
  ...
  if (v2)
  {
    objc_msgSend(MEMORY[0x24BDD1880], "hmf_UUIDWithBytesAsData:", v2);
          ...
          v6))
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v21 = 2112;
          v22 = a1;
          _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Start time missing in the controller context %@", (uint8_t *)&v19, 0x16u);
