...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v11 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the IDS connection sender", buf, 0xCu);
...
- (void)_startPacketRelayWithIDSDeviceSession:(id)a3 cameraVideoSSRC:(unsigned int)a4 cameraAudioSSRC:(unsigned int)a5
{
  ...
  v47 = a3;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F200]), "initWithName:", CFSTR("com.apple.homed.packet-relay"));
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v50 = v12;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@IDS Session is present", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v9);
  v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDFDA00]), "initWithIncomingSSRC:acceptPacketType:", v6, 0);
  v14 = (void *)MEMORY[0x24BDFDA10];
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v51 = 1024;
    LODWORD(v52) = v6;
    _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@Creating video relay connection with SSRC %08x", buf, 0x12u);

  }
  objc_autoreleasePoolPop(v17);
  v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDFDA00]), "initWithIncomingSSRC:acceptPacketType:", v5, 0);
  v22 = (void *)MEMORY[0x24BDFDA10];
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v51 = 1024;
    LODWORD(v52) = v5;
    _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_INFO, "%{public}@Creating audio relay connection with SSRC %08x", buf, 0x12u);

  }
  objc_autoreleasePoolPop(v25);
  v29 = (void *)MEMORY[0x24BDFDA10];
  v30 = v47;
  ...
  if (!v16 || !v24 || !v32)
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v50 = v44;
      _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to create relay objects", buf, 0xCu);
  ...
  v33 = objc_alloc(MEMORY[0x24BDFDA08]);
  v53[0] = v16;
  v53[1] = v24;
  ...
  if (v36)
  {
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v51 = 2114;
      v52 = v36;
      _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay with error %{public}@", buf, 0x16u);
...
LABEL_17:
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v50 = v45;
    _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay", buf, 0xCu);
...
- (void)_startPacketRelayWithVideoSocket:(int)a3 videoNetworkConfig:(id)a4 cameraVideoSSRC:(unsigned int)a5 audioSocket:(int)a6 audioNetworkConfig:(id)a7 cameraAudioSSRC:(unsigned int)a8
{
  ...
  v8 = *(_QWORD *)&a6;
  v10 = *(_QWORD *)&a3;
  v12 = (objc_class *)MEMORY[0x24BE3F200];
  v13 = a7;
  v14 = a4;
...
LABEL_11:
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v29;
      _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to create relay objects", buf, 0xCu);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Creating video relay between %@:%tu (%d,%d)", buf, 0x2Cu);

  }
  objc_autoreleasePoolPop(v10);
  v15 = objc_alloc_init(MEMORY[0x24BDFD9F8]);
  objc_msgSend(v15, "setIp:", v8);
  objc_msgSend(v15, "setPort:", (unsigned __int16)a5);
  objc_msgSend(MEMORY[0x24BDFDA10], "connectionWithSocket:remoteAddress:", (unsigned __int16)a3, v15);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v17 = (void *)MEMORY[0x24BDFDA10];
  -[HMDCameraIDSDeviceConnection watchVideoConnection](v11, "watchVideoConnection");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v16 || !v19)
    goto LABEL_11;
  v32 = 0;
  v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDFDA08]), "initWithConnection:connection:error:", v16, v19, &v32);
  v21 = v32;
  ...
  if (v21)
  {
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2114;
      v36 = v21;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay with error %{public}@", buf, 0x16u);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v30;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay for video", buf, 0xCu);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v41 = 1024;
    v42 = objc_msgSend(v14, "socket");
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Creating audio relay between %@:%tu (%d,%d)", buf, 0x2Cu);
  ...
  if (v21)
  {
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v21;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio packet relay with error %@", buf, 0x16u);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v30;
    _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay for audio", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_145379 != -1)
    dispatch_once(&logCategory__hmf_once_t17_145379, &__block_literal_global_145380);
  return (id)logCategory__hmf_once_v18_145381;
}
...
void __49__HMDCameraIDSDeviceConnectionSender_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_145381;
  logCategory__hmf_once_v18_145381 = v0;
