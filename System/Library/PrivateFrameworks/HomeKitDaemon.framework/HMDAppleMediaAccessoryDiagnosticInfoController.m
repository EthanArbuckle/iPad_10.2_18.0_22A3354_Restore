...
- (id)_diagnosticInfoWithAdditionalKeys:(id)a3
{
  ...
  v6 = objc_alloc_init(MEMORY[0x24BDD7368]);
  ...
  if (v5)
  {
    v9 = objc_alloc_init(MEMORY[0x24BDD7350]);
    objc_msgSend(v6, "setAppleMediaAccessoryDiagnosticInfo:", v9);

    v10 = objc_alloc_init(MEMORY[0x24BDD7358]);
    ...
    if (objc_msgSend(v4, "containsObject:", *MEMORY[0x24BDD5EF0]))
    {
    ...
    if (v46)
    {
      ...
      v49 = objc_alloc_init(MEMORY[0x24BDD7360]);
    ...
    v91 = objc_alloc_init(MEMORY[0x24BDD7370]);
    ...
    {
      v98 = objc_alloc_init(MEMORY[0x24BDD7378]);
...
+ (id)diagnosticInfoDescriptionWithData:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7368]), "initWithData:", v3);
  if (v4)
  {
    v5 = objc_alloc_init(MEMORY[0x24BDBCED8]);
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", objc_msgSend(v4, "version"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "setObject:forKeyedSubscript:", v6, CFSTR("version"));

    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", objc_msgSend(v4, "homeHubVersion"));
    ...
    {
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", objc_msgSend(v4, "numHomes"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v4, "hasAppleMediaAccessoryDiagnosticInfo"))
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", objc_msgSend(v9, "sfProblemFlags"));
        v55 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        do
        {
          for (i = 0; i != v57; ++i)
          {
            ...
            if (v62)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v58 + i);
              v64 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        do
        {
          for (j = 0; j != v73; ++j)
          {
            ...
            if (v78)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v74 + j);
              v80 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        do
        {
          ...
          do
          {
            ...
            if (v93)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkInfo.%@.%@"), v94, CFSTR("name"));
              v95 = (void *)objc_claimAutoreleasedReturnValue();
              ...
              if (v96)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkInfo.%@.%@"), v94, CFSTR("mac"));
              ...
              if (v100)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkInfo.%@.%@"), v94, CFSTR("ipv4"));
              ...
              if (v104)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkInfo.%@.%@"), v94, CFSTR("ipv6"));
              ...
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkInfo.%@.%@"), v94, CFSTR("wifi.SSID"));
                v107 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkInfo.%@.%@"), v94, CFSTR("wifi.BSSID"));
                v95 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        do
        {
          for (k = 0; k != v113; ++k)
          {
            ...
            if (v116)
            {
              ...
              objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkService.%@.%@"), v117, CFSTR("name"));
              ...
              if (v119)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkService.%@.%@"), v117, CFSTR("NetSigV4"));
              ...
              if (v122)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkService.%@.%@"), v117, CFSTR("netSigV6"));
              ...
              if (v125)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkService.%@.%@"), v117, CFSTR("routerV4"));
              ...
              if (v128)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkService.%@.%@"), v117, CFSTR("routerV6"));
              ...
              if (v132)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkService.%@.%@"), v117, CFSTR("ipv4"));
              ...
              if (v136)
              {
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("dev.networkService.%@.%@"), v117, CFSTR("ipv6"));
    ...
    if (objc_msgSend(v4, "hasLastSetupInfo"))
    {
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", objc_msgSend(v165, "lastKnownStageUnderlyingErrorCode"));
      ...
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", objc_msgSend(v165, "savedEventState"));
