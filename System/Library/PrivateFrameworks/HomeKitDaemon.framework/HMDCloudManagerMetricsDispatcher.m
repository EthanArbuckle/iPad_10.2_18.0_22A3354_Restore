...
- (void)submitFailureEventWithModelType:(id)a3 failureCode:(unint64_t)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v25 = 2112;
    v26 = v9;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Submitting failure event with model type: %@ failure code: %@ error: %@", buf, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_243077 != -1)
    dispatch_once(&logCategory__hmf_once_t1_243077, &__block_literal_global_243078);
  return (id)logCategory__hmf_once_v2_243079;
}
...
void __47__HMDCloudManagerMetricsDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_243079;
  logCategory__hmf_once_v2_243079 = v0;
