...
- (id)createUserInfoWithWithSignificantEvents:(id)a3 previewImageNotificationUUID:(id)a4 camera:(id)a5 home:(id)a6 accessory:(id)a7 recordingService:(id)a8 clipUUID:(id)a9
{
  ...
  objc_msgSend(v19, "na_map:", &__block_literal_global_48_218557);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v24, "allObjects");
  v41 = (void *)objc_claimAutoreleasedReturnValue();

  v25 = objc_msgSend(v19, "na_any:", &__block_literal_global_49_218558);
  v26 = *MEMORY[0x24BDD5350];
  v43[0] = *MEMORY[0x24BDD5358];
  v43[1] = v26;
  v44[0] = v41;
  v44[1] = v21;
  v43[2] = *MEMORY[0x24BDD5348];
  objc_msgSend(v18, "UUIDString");
  v27 = (void *)objc_claimAutoreleasedReturnValue();

  v28 = *MEMORY[0x24BDD5370];
  v44[2] = v27;
  v44[3] = v23;
  v29 = *MEMORY[0x24BDD7120];
  v43[3] = v28;
  v43[4] = v29;
  ...
  objc_msgSend(v36, "setObject:forKeyedSubscript:", v37, *MEMORY[0x24BDD5340]);
...
+ (id)localizedMessageForSignificantEvents:(id)a3 cameraAccessory:(id)a4
{
  ...
  objc_msgSend(v10, "na_map:", &__block_literal_global_218589);
  ...
  if (!v45)
  {
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v74 = 2112;
      v75 = v47;
      _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
...
+ (id)actionURLForHomeUUID:(id)a3 cameraUUID:(id)a4
{
  ...
  v5 = (void *)MEMORY[0x24BDD74F0];
  v6 = a4;
  objc_msgSend(v5, "tupleWithQueryType:uuidString:", 0, a3);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD74F0], "tupleWithQueryType:uuidString:", 5, v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
