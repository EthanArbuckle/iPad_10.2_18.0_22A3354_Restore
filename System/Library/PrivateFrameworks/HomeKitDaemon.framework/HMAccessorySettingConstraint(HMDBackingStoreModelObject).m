  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v32;
      _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Model missing 'type'", buf, 0xCu);
...
LABEL_19:
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v38;
      _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Model missing 'value'", buf, 0xCu);
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v44 = 2112;
      v45 = v16;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive accessory setting constraint model supported value from the model's value: %@", buf, 0x16u);
  ...
  if (v21)
  {
    ...
    objc_msgSend(v22, "getUUIDBytes:", &v21[*MEMORY[0x24BDD7AE8]]);
