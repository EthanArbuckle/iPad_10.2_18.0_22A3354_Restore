...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x24BE1BB90], "wrappertlv:name:", 1, CFSTR("kVideoParameters_Codec"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BAC8], "wrappertlv:name:", 2, CFSTR("kVideoParameters_CodecParameters"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BAC8], "wrappertlv:name:", 3, CFSTR("kVideoParameters_Attributes"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE1BAC8], "wrappertlv:name:", 4, CFSTR("kVideoParameters_RTPParameter"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v33[0] = v3;
  v33[1] = v4;
  v33[2] = v5;
