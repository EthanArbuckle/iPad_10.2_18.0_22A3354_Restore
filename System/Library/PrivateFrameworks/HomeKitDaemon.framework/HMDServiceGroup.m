...
- (HMDServiceGroup)initWithName:(id)a3 uuid:(id)a4 home:(id)a5 queue:(id)a6
{
  ...
  if (v14)
  {
    ...
    v18 = (void *)v17;
    objc_msgSend(MEMORY[0x24BE3F210], "hmf_cachedInstanceForNSUUID:", v17);
    ...
    objc_msgSend(MEMORY[0x24BE3F210], "hmf_cachedInstanceForNSUUID:", v21);
...
- (id)dumpState
{
  ...
  objc_msgSend(v26, "setObject:forKeyedSubscript:", v25, *MEMORY[0x24BE3EB68]);
  ...
  if (objc_msgSend(v7, "count"))
  {
    ...
    objc_msgSend(v26, "setObject:forKeyedSubscript:", v29, *MEMORY[0x24BE3EB48]);
    -[HMDServiceGroup appData](self, "appData");
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v21, "dumpState");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v26, "setObject:forKeyedSubscript:", v22, *MEMORY[0x24BE3EA58]);
...
- (void)removeService:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Cannot remove nil service from service group", (uint8_t *)&v16, 0xCu);
...
- (HMDServiceGroup)initWithCoder:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x24BDD7DA0]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "hm_truncatedNameString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v4, "hm_decodeAndCacheUUIDFromStringForKey:", *MEMORY[0x24BDD7DC0]);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = -[HMDServiceGroup initWithName:uuid:home:queue:](self, "initWithName:uuid:home:queue:", v7, v8, v5, 0);
  if (v9)
  {
    objc_msgSend(v4, "hm_decodeArrayOfConditionalObjects:forKey:", objc_opt_class(), *MEMORY[0x24BDD7DB8]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v13, *MEMORY[0x24BDD7DB0]);
    v41 = (void *)objc_claimAutoreleasedReturnValue();

    v14 = v10;
    v15 = &OBJC_IVAR___HMDUserPhotosPersonDataManager__supportsFaceClassification;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMDServiceGroup name](self, "name");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v5, *MEMORY[0x24BDD7DA0]);

  -[HMDServiceGroup uuid](self, "uuid");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "UUIDString");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v7, *MEMORY[0x24BDD7DC0]);
  ...
  {
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "hm_encodeArrayOfConditionalObjects:forKey:", v11, *MEMORY[0x24BDD7DB8]);

    objc_msgSend(v17, "encodeObject:forKey:", self->_serviceUUIDs, *MEMORY[0x24BDD7DB0]);
  }
  else
  {
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "hm_encodeArrayOfConditionalObjects:forKey:", v12, *MEMORY[0x24BDD7DB8]);
...
- (void)_registerForMessages
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Not registering for messages as home is nil", buf, 0xCu);
...
- (void)_handleAddServiceRequest:(id)a3
{
  ...
  if (v5 && v6)
  {
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v61 = 2112;
        v62 = v24;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Service with UUID %@ does not exist in home %@", buf, 0x20u);
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = objc_msgSend(v13, "isEqualToString:", *MEMORY[0x24BE1B780]);
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v61 = 2112;
        v62 = v18;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Rejecting attempt to associate acc info service with UUID %@ in home %@", buf, 0x20u);
    ...
    if (v28 >= maximumServicesPerServiceGroup)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v65 = 2112;
        v66 = v41;
        _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_INFO, "%{public}@Can't add service %@:%@ to service group %@ in home %@; already at maximum services for group",
          buf,
          0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v65 = 2112;
        v66 = v35;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Service %@:%@ already exists in service group %@ in home %@", buf, 0x34u);
    ...
    objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:", v36, v49);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v42 = 2112;
        v43 = v23;
        _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_ERROR, "%{public}@Service %@:%@ does not exist in group %@ in home %@", buf, 0x34u);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = v26;
        _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", (uint8_t *)&v21, 0x20u);
  ...
  if (v23)
  {
    ...
    do
    {
      for (k = 0; k != v23; ++k)
      {
        ...
        if (v27)
        {
          v28 = (void *)MEMORY[0x227676638](-[NSMutableDictionary setObject:forKey:](v50->_serviceMapping, "setObject:forKey:", v27, v26));
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v72 = 2112;
            v73 = name;
            _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Add service uuid: %@ to group: %@", buf, 0x20u);
  ...
  if (v33)
  {
    ...
    do
    {
      for (m = 0; m != v33; ++m)
      {
        ...
        if (v37)
        {
          v38 = (void *)MEMORY[0x227676638](-[NSMutableDictionary removeObjectForKey:](v50->_serviceMapping, "removeObjectForKey:", v36));
          HMFGetOSLogHandle();
          v39 = (id)objc_claimAutoreleasedReturnValue();
          if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v72 = 2112;
            v73 = v41;
            _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@Remove service uuid: %@ from group: %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t33 != -1)
    dispatch_once(&logCategory__hmf_once_t33, &__block_literal_global_29244);
