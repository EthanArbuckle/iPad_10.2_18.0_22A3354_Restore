...
- (void)configure
{
  ...
  if (-[HMDCloudPhotosSettingObserver isSupported](self, "isSupported"))
  {
    ...
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "addObserver:selector:name:object:", self, sel_handleAccountStoreDidChangeNotification_, *MEMORY[0x24BDB41E0], 0);
...
- (void)handleAccountStoreDidChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 138543362;
    v18 = v8;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Received account change notification", (uint8_t *)&v17, 0xCu);
  ...
  if ((_DWORD)v9 != -[HMDCloudPhotosSettingObserver isCloudPhotosEnabled](v6, "isCloudPhotosEnabled"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating cloudPhotosEnabled from %@ to %@", (uint8_t *)&v17, 0x20u);
...
- (BOOL)isCloudPhotosEnabledOnAccount
{
  ...
  v3 = objc_msgSend(v2, "isEnabledForDataclass:", *MEMORY[0x24BDB3DE0]);
...
{
  if (sharedInstance_onceToken_137745 != -1)
    dispatch_once(&sharedInstance_onceToken_137745, &__block_literal_global_137746);
  return (HMDCloudPhotosSettingObserver *)(id)sharedInstance_cloudPhotoSettingObserver;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t2_137740 != -1)
    dispatch_once(&logCategory__hmf_once_t2_137740, &__block_literal_global_6_137741);
  return (id)logCategory__hmf_once_v3_137742;
}
...
void __44__HMDCloudPhotosSettingObserver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_137742;
  logCategory__hmf_once_v3_137742 = v0;
