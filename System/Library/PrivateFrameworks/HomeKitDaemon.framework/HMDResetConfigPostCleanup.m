        ...
        (v7 & 1) != 0))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v51 = 2112;
      v52 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Found reset config post cleanup record on disk at %@. Going to read it.", buf, 0x16u);
        ...
        if (!v26)
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v51 = 2112;
            v52 = v25;
            _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Unable to open the reset config post cleanup record : %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v51 = 2112;
          v52 = v24;
          _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive reset config post cleanup record from archive data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v51 = 2112;
        v52 = v15;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@Unable to read the post cleanup record due to an error: [%@]", buf, 0x16u);
  ...
  if (a3 && a4 != 1)
  {
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v46 = 2112;
        v47 = v11;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Found existing reason : %@", (uint8_t *)&v44, 0x16u);

      }
      objc_autoreleasePoolPop(v12);
    }
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLong:", -[__CFString unsignedLongValue](v11, "unsignedLongValue") | a4);
    ...
    if (!v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v44 = 138543362;
        v45 = v41;
        _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unable to write reset config cleanup record", (uint8_t *)&v44, 0xCu);
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      v48 = 2112;
      v49 = v18;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Going to write reset config cleanup record : [%@] -> [%@]", (uint8_t *)&v44, 0x20u);
    ...
    if (v24)
    {
      ...
      if ((v26 & 1) != 0)
      {
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v35 = 42;
LABEL_30:
          _os_log_impl(&dword_2218F0000, v33, v34, v32, (uint8_t *)&v44, v35);
...
LABEL_32:
  ...
  v36 = (void *)MEMORY[0x227676638](a1, a2);
  v37 = a1;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    v48 = 2112;
    v49 = v42;
    _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_ERROR, "%{public}@Clean up reason or steps are needed. [reason: %@] [steps: %@]", (uint8_t *)&v44, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v25 = 2112;
          v26 = v14;
          _os_log_impl(&dword_2218F0000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unable to cast NSNumber from dictionary value : %@, %@", buf, 0x20u);
...
+ (void)performResetConfigPostCleanupSteps:(unint64_t)a3 dueToReason:(unint64_t)a4
{
  ...
  v7 = (void *)MEMORY[0x227676638](a1, a2);
  v8 = a1;
  HMFGetOSLogHandle();
  ...
  if (a3 != 1 && a4)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 2112;
      v33 = v14;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Going to perform reset config post cleanup steps: %@ due to reason: %@", (uint8_t *)&v28, 0x20u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    v32 = 2112;
    v33 = v17;
    _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Clean up reason or steps are not known. [reason: %@] [steps: %@]", (uint8_t *)&v28, 0x20u);
...
+ (void)performIndividualCleanupTasks:(unint64_t)a3 onRootDirectory:(id)a4
{
  ...
  if ((v4 & 2) != 0)
  {
    +[HMDCoreData storeNameForConfiguration:](HMDCoreData, "storeNameForConfiguration:", CFSTR("core.sqlite"));
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(a1, "sqlFileListToRemove:fromRootDirectory:", v15, v6);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_3:
  ...
  +[HMDCoreData storeNameForConfiguration:](HMDCoreData, "storeNameForConfiguration:", CFSTR("core-cloudkit.sqlite"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "sqlFileListToRemove:fromRootDirectory:", v17, v6);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_14:
  +[HMDCoreData storeNameForConfiguration:](HMDCoreData, "storeNameForConfiguration:", CFSTR("core-local.sqlite"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "sqlFileListToRemove:fromRootDirectory:", v19, v6);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_15:
  +[HMDCoreData storeNameForConfiguration:](HMDCoreData, "storeNameForConfiguration:", CFSTR("core-cloudkit-shared.sqlite"));
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "sqlFileListToRemove:fromRootDirectory:", v21, v6);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_16:
  objc_msgSend(a1, "sqlFileListToRemove:fromRootDirectory:", CFSTR("core-client.sqlite"), v6);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_9:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v7;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Going to remove following files : %@", (uint8_t *)&v25, 0x16u);

  }
  objc_autoreleasePoolPop(v10);
  v14 = (void *)objc_msgSend(v7, "copy");
  objc_msgSend(v11, "removeFilesAtLocation:", v14);

}

+ (id)filesToExcludeFromCacheDirectory
{
  return (id)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E9712B8);
}

+ (id)filesToExcludeFromHomedDirectory
{
  return (id)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E9712D0);
}
...
+ (id)sqlFileListToRemove:(id)a3 fromRootDirectory:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@-shm"), v6);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "URLByAppendingPathComponent:", v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "addObject:", v12);

  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@-wal"), v6);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (void)deleteFilesInsideDirectory:(id)a3 excludingFiles:(id)a4 shouldSkipDirectories:(BOOL)a5 usingFileManager:(id)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2112;
    v31 = v10;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Going to delete all the files inside directory: %@", buf, 0x16u);
...
+ (id)resetConfigPostCleanupFileLocation
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@Failed to create homekit daemon cache directory", (uint8_t *)&v11, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t25_241113 != -1)
    dispatch_once(&logCategory__hmf_once_t25_241113, &__block_literal_global_241114);
  return (id)logCategory__hmf_once_v26_241115;
}
...
void __40__HMDResetConfigPostCleanup_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v26_241115;
  logCategory__hmf_once_v26_241115 = v0;
...
void __110__HMDResetConfigPostCleanup_deleteFilesInsideDirectory_excludingFiles_shouldSkipDirectories_usingFileManager___block_invoke(uint64_t a1, void *a2)
{
        ...
        v7))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Not deleting excluded file: %@", buf, 0x16u);
  ...
  {
    v18 = 0;
    objc_msgSend(v4, "getResourceValue:forKey:error:", &v18, *MEMORY[0x24BDBCC60], 0);
    v12 = v18;
    if (objc_msgSend(v12, "BOOLValue") && *(_BYTE *)(a1 + 56))
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v22 = 2112;
        v23 = v4;
        _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping the directory : %@", buf, 0x16u);
  ...
  if ((v4 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v25 = 2112;
      v26 = v8;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@%@ removed file [%@] with error: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v3;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@File is not deletable by homed: %@", buf, 0x16u);
