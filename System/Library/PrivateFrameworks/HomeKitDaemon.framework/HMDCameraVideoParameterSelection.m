...
- (HMDCameraVideoParameterSelection)initWithSessionID:(id)a3 videoTierParameters:(id)a4 supportedVideoConfiguration:(id)a5 supportedRTPConfiguration:(id)a6 streamingCapabilities:(id)a7
{
  ...
  if (v17)
  {
    ...
    +[HMDVideoCodec arrayWithCodecTypes:](HMDVideoCodec, "arrayWithCodecTypes:", &unk_24E971018);
    v19 = objc_claimAutoreleasedReturnValue();
    videoCodecsPreference = v18->_videoCodecsPreference;
    v18->_videoCodecsPreference = (NSArray *)v19;

    +[HMDH264Profile arrayWithProfiles:](HMDH264Profile, "arrayWithProfiles:", &unk_24E971030);
    v21 = objc_claimAutoreleasedReturnValue();
    h264ProfilesPreference = v18->_h264ProfilesPreference;
    v18->_h264ProfilesPreference = (NSArray *)v21;

    +[HMDH264Level arrayWithLevels:](HMDH264Level, "arrayWithLevels:", &unk_24E971048);
    v23 = objc_claimAutoreleasedReturnValue();
    h264LevelsPreference = v18->_h264LevelsPreference;
    v18->_h264LevelsPreference = (NSArray *)v23;

    +[HMDPacketizationMode arrayWithModes:](HMDPacketizationMode, "arrayWithModes:", &unk_24E971060);
...
- (void)_setVideoResolutionPreference
{
  ...
  +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", &unk_24E971078);
  v7 = objc_claimAutoreleasedReturnValue();
  +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", &unk_24E971090);
  v8 = objc_claimAutoreleasedReturnValue();
  v28 = (void *)v7;
  objc_msgSend(v3, "addObjectsFromArray:", v7);
  v27 = (void *)v8;
  objc_msgSend(v4, "addObjectsFromArray:", v8);
  +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", &unk_24E9710A8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", &unk_24E9710C0);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", &unk_24E9710D8);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v32 = 2112;
    v33 = v26;
    _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Setting the video resolution preference order to %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544642;
          ...
          v119 = 2112;
          v120 = v58;
          _os_log_impl(&dword_2218F0000, v74, OS_LOG_TYPE_INFO, "%{public}@One of the intersected candidates is empty: candidateProfiles: %@, candidateLevels: %@, candidatePacketModes: %@, candidateVideoResolutions: %@, candidateAttributes: %@", buf, 0x3Eu);
                  ...
                  for (i = 0; i != v25; ++i)
                  {
                    ...
                    if (v35 != 0x7FFFFFFFFFFFFFFFLL)
                    {
                      ...
                      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138543618;
                        ...
                        v86 = 2112;
                        v87 = v43;
                        _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_INFO, "%{public}@Selected video parameter combination: %@", buf, 0x16u);
                    ...
                    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138543618;
                      ...
                      v86 = 2112;
                      v87 = v40;
                      _os_log_impl(&dword_2218F0000, v38, OS_LOG_TYPE_INFO, "%{public}@Combination does not exist for video resolution: %@", buf, 0x16u);
...
- (void)_generateAllCombinations
{
  ...
  +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", &unk_24E9710F0);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDBCEB8], "array");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v159 = 0u;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_136434 != -1)
    dispatch_once(&logCategory__hmf_once_t1_136434, &__block_literal_global_136435);
  return (id)logCategory__hmf_once_v2_136436;
}
...
void __47__HMDCameraVideoParameterSelection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_136436;
  logCategory__hmf_once_v2_136436 = v0;
