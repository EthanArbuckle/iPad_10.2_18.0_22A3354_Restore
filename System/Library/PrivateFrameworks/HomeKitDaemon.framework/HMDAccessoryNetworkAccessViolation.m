...
- (HMDAccessoryNetworkAccessViolation)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x24BDD4C88]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x24BDD4C90]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
    ...
    || objc_msgSend(v6, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    -[HMDAccessoryNetworkAccessViolation lastViolationDate](self, "lastViolationDate");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "encodeObject:forKey:", v4, *MEMORY[0x24BDD4C88]);

    -[HMDAccessoryNetworkAccessViolation lastResetDate](self, "lastResetDate");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "encodeObject:forKey:", v5, *MEMORY[0x24BDD4C90]);
...
+ (id)noViolation
{
  if (noViolation_onceToken != -1)
    dispatch_once(&noViolation_onceToken, &__block_literal_global_99141);
