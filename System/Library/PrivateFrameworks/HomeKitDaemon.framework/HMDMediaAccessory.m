...
LABEL_13:
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, v22, buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid added advertisement: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid removed advertisement: %@", buf, 0x16u);
...
- (void)handleUpdatedAdvertisement:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Updated with advertisement: %@", (uint8_t *)&v9, 0x16u);
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (v13)
  {
    ...
    v35 = &v34;
    v36 = 0x3032000000;
    v37 = __Block_byref_object_copy__88194;
    v38 = __Block_byref_object_dispose__88195;
    v39 = 0;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  {
    objc_msgSend(v4, "encodeBool:forKey:", 1, *MEMORY[0x24BDD5068]);
  }
...
void __68__HMDMediaAccessory_notifyConnectivityChangedWithReachabilityState___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) != 0)
  {
    if (v7)
    {
      ...
      v13 = 2112;
      v14 = v9;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying clients of updated media accessory reachability: %@", (uint8_t *)&v11, 0x16u);
  ...
  else
  {
    if (v7)
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring non-remote reachability change while remote access is enabled", (uint8_t *)&v11, 0xCu);
...
- (NSDictionary)assistantObject
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_msgSend(v6, "isEqual:", *MEMORY[0x24BDD4990]);

  if ((v7 & 1) != 0)
  {
    v8 = (id *)MEMORY[0x24BE82038];
LABEL_5:
    v11 = *v8;
    v12 = (id)*MEMORY[0x24BE81FA0];
    v13 = v12;
    if (v11)
      v14 = v12 == 0;
    else
  ...
  objc_msgSend(v5, "categoryType");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v9, "isEqual:", *MEMORY[0x24BDD4A30]);

  if ((v10 & 1) != 0)
  {
    v8 = (id *)MEMORY[0x24BE82130];
    goto LABEL_5;
  }
  if (-[HMDMediaAccessory isMemberOfClass:](self, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v5;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Media accessory with invalid accessory category: %@", buf, 0x16u);
