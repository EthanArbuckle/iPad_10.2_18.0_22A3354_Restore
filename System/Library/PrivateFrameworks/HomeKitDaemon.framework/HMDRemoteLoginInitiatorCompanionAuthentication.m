  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v33 = 2112;
      v34 = v15;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@Loaded credentials for account %@, %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_108511 != -1)
    dispatch_once(&logCategory__hmf_once_t1_108511, &__block_literal_global_108512);
  return (id)logCategory__hmf_once_v2_108513;
}
...
void __61__HMDRemoteLoginInitiatorCompanionAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_108513;
  logCategory__hmf_once_v2_108513 = v0;
