...
+ (id)sharedInstance
{
  if (sharedInstance_onceToken_138254 != -1)
    dispatch_once(&sharedInstance_onceToken_138254, &__block_literal_global_138255);
  return (id)sharedInstance_sharedInstance_138256;
}
...
void __82__HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorLocalZoneID_sharedInstance__block_invoke()
{
  ...
  if (v2)
  {
    ...
    v1 = (void *)sharedInstance_sharedInstance_138256;
    sharedInstance_sharedInstance_138256 = (uint64_t)v0;
