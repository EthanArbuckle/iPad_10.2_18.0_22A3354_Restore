@implementation AWDHomeKitTargetControllerCommand
...
- (int)StringAsCommand:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("AWDHomeKitTargetControllerCommandType_Selected")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("AWDHomeKitTargetControllerCommandType_Deselected")) & 1) != 0)
  {
    v4 = 1;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("AWDHomeKitTargetControllerCommandType_TriggeredSiri")))
  {
    v4 = 2;
  }
  else
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)AWDHomeKitTargetControllerCommand;
  -[AWDHomeKitTargetControllerCommand description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDHomeKitTargetControllerCommand dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    ...
    if (command >= 3)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_command);
      v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v7 = off_24E77AF48[command];
    }
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("command"));
  ...
  if ((v10 & 8) != 0)
  {
    ...
    {
      v12 = off_24E77AF60[transportType];
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 40) & 4) == 0 || self->_command != *((_DWORD *)v4 + 5))
      goto LABEL_24;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    if (!v8)
      goto LABEL_11;
    v10 = v5;
    -[AWDHomeKitTargetControllerCommand setVendorDetails:](self, "setVendorDetails:");
  }
  v5 = v10;
LABEL_11:
  v9 = *((_BYTE *)v5 + 40);
