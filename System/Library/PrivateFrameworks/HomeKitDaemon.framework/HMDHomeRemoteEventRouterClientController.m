...
- (id)dumpStateDescription
{
  ...
  objc_msgSend(MEMORY[0x24BDD16A8], "stringWithString:", CFSTR("[HMDHomeRemoteEventRouterClientController"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (self)
  {
    objc_msgSend(objc_getProperty(self, v3, 88, 1), "dumpStateDescription");
...
LABEL_21:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    v38 = v7;
    _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine destination for event router client: %@", buf, 0x16u);
...
LABEL_19:
  ...
  {
    v16 = v26;
    +[HMDAccessoryEventsGenerated topicsRemovingAccessoryTopics:accessoryUUID:](HMDAccessoryEventsGenerated, "topicsRemovingAccessoryTopics:accessoryUUID:", v7, objc_getProperty(self, v27, 104, 1));
    v23 = (id)objc_claimAutoreleasedReturnValue();
LABEL_24:
...
- (void)delegatingRouter:(id)a3 fetchCachedEventsForTopics:(id)a4 forRouter:(id)a5 cachedEventCollection:(id)a6
{
  ...
  if (-[HMDHomeRemoteEventRouterClientController isCurrentDevicePrimaryResident](self, "isCurrentDevicePrimaryResident"))
  {
    ...
    if (!v14
      || (!self ? (v16 = 0) : (v16 = objc_getProperty(self, v15, 88, 1)),
    ...
    {
      objc_msgSend(v9, "na_filter:", &__block_literal_global_79_101494);
...
void __120__HMDHomeRemoteEventRouterClientController_delegatingRouter_fetchCachedEventsForTopics_forRouter_cachedEventCollection___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch events from router: %@", (uint8_t *)&v17, 0x16u);

    }
    objc_autoreleasePoolPop(v10);
  }
  v15 = *(void **)(a1 + 48);
  objc_msgSend(v8, "na_map:", &__block_literal_global_82_101497);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
...
id __120__HMDHomeRemoteEventRouterClientController_delegatingRouter_fetchCachedEventsForTopics_forRouter_cachedEventCollection___block_invoke_80(uint64_t a1, void *a2, void *a3)
{
  objc_class *v4;
  id v5;
  id v6;
...
void __72__HMDHomeRemoteEventRouterClientController_fetchWithFilters_completion___block_invoke(uint64_t a1)
{
  ...
  if (v1)
  {
    ...
    if ((objc_msgSend(v1, "isCurrentDevicePrimaryResident") & 1) != 0)
    {
      ...
      v36[1] = v36;
      v36[2] = 0x3032000000;
      v36[3] = __Block_byref_object_copy__101505;
      v36[4] = __Block_byref_object_dispose__101506;
      v37 = 0;
      v32 = 0u;
      v33 = 0u;
      v34 = 0u;
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_msgSend(v15, "na_filter:", &__block_literal_global_101507);
            v16 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      objc_msgSend(objc_getProperty(v1, v21, 88, 1), "eventRouterClient");
...
void __73__HMDHomeRemoteEventRouterClientController__fetchWithFilters_completion___block_invoke_3(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v18;
      _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch events from router: %@", (uint8_t *)&v19, 0x16u);
...
uint64_t __73__HMDHomeRemoteEventRouterClientController_networkAvailabilityDidChange___block_invoke(uint64_t result, const char *a2)
{
  ...
  if (v2)
  {
    ...
    Property = objc_getProperty(*(id *)(result + 32), a2, 24, 1);
    dispatch_assert_queue_V2(Property);
    v14 = 0u;
    v15 = 0u;
    v12 = 0u;
  ...
  if (v1)
  {
    ...
    if (WeakRetained)
    {
        ...
        && objc_msgSend(v6, "isCurrentDeviceResidentCapableForRemoteEventRouterClientController:", v1))
      {
        ...
        v28 = 0u;
        v29 = 0u;
        v8 = (void *)objc_msgSend(objc_getProperty(v1, v7, 96, 1), "copy");
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v32 = 138543874;
          ...
          v36 = 2112;
          v37 = v3;
          _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_INFO, "%{public}@Removing %@ client resident event router(s) for accessory: %@", v32, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v40 = 2112;
        v41 = v3;
        _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident router for accessory: %@ due to nil datasource", buf, 0x16u);
  ...
  if (v1)
  {
    ...
    if (WeakRetained)
    {
        ...
        && objc_msgSend(v6, "isCurrentDeviceResidentCapableForRemoteEventRouterClientController:", v1))
      {
              ...
              if (v14)
              {
                ...
                if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v61 = 2112;
                  v62 = v3;
                  _os_log_impl(&dword_2218F0000, v50, OS_LOG_TYPE_INFO, "%{public}@Not creating resident router for accessory (%@) as it already exists.", buf, 0x16u);
        ...
        v52 = (void *)v15;
        objc_msgSend(v18, "residentClientWithAccessoryUUID:homeUUID:queue:dataSource:messageDispatcher:notificationCenter:requestMessageName:updateMessageName:multiHopFetchResponseMessageName:storeReadHandle:storeWriteHandle:", v3, v20, v22, v1, v54, v53, v24, v26, objc_getProperty(v1, v27, 56, 1), v15, v16);
        ...
        v39 = objc_msgSend(objc_getProperty(v1, v38, 96, 1), "addObject:", v28);
        v40 = (void *)MEMORY[0x227676638](v39);
        v41 = v1;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v63 = 2112;
          v64 = v28;
          _os_log_impl(&dword_2218F0000, v42, OS_LOG_TYPE_INFO, "%{public}@Created resident router for accessory: %@, client: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v66 = 138543618;
        ...
        v68 = 2112;
        v69 = v3;
        _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident router for accessory: %@ due to nil datasource", v66, 0x16u);
...
- (void)_sendNetworkAvailableOnStartingMessaging:(uint64_t)a1
{
  ...
  v9[1] = v9;
  v9[2] = 0x3032000000;
  v9[3] = __Block_byref_object_copy__101505;
  v9[4] = __Block_byref_object_dispose__101506;
  v4 = *(id *)(a1 + 112);
  v10 = v4;
  ...
  if (!v6)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v20 = 2112;
        v21 = v15;
        _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Mark network as available on transport start %@", (uint8_t *)&v18, 0x16u);
...
void __71__HMDHomeRemoteEventRouterClientController_updateCurrentAccessoryUUID___block_invoke(uint64_t a1, const char *a2)
{
  ...
  if ((objc_msgSend(Property, "hmf_isEqualToUUID:", *(_QWORD *)(a1 + 40)) & 1) == 0)
  {
    v5 = *(void **)(a1 + 32);
    if (v5)
      objc_setProperty_atomic(v5, v4, *(id *)(a1 + 40), 104);
  }
}
...
id __226__HMDHomeRemoteEventRouterClientController_initWithMessageTargetUUID_workQueue_dataSource_requestMessageName_updateMessageName_multiHopFetchResponseMessageName_clientUserMessagePolicy_currentAccessoryUUID_assertionController___block_invoke(uint64_t a1, void *a2)
{
  ...
  v7 = objc_alloc(MEMORY[0x24BE4ED78]);
  v8 = *(_QWORD *)(a1 + 40);
