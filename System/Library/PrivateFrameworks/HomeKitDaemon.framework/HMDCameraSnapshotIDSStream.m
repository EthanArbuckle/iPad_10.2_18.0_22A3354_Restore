...
LABEL_9:
  ...
  if (v13)
  {
    ...
    v15 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F200]), "initWithName:", CFSTR("com.apple.homed.snapshot-stream"));
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSStream", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_121776 != -1)
    dispatch_once(&logCategory__hmf_once_t1_121776, &__block_literal_global_121777);
  return (id)logCategory__hmf_once_v2_121778;
}
...
void __41__HMDCameraSnapshotIDSStream_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_121778;
  logCategory__hmf_once_v2_121778 = v0;
