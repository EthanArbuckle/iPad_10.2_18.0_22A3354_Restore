...
+ (void)fetchIsTwoFactorAuthenticationEnabledForAccountWithReason:(id)a3 completionHandler:(id)a4
{
  ...
  v14 = objc_alloc_init(MEMORY[0x24BE0ACB8]);
  ...
  v15 = (void *)MEMORY[0x227676638](objc_msgSend(v14, "setShouldPreventInteractiveAuth:", 1));
  v16 = a1;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v30 = 2112;
    v31 = v6;
    _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_INFO, "%{public}@Querying 2FA status with username: %@ altDSID: %@ reason: %@", buf, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_236911 != -1)
    dispatch_once(&logCategory__hmf_once_t4_236911, &__block_literal_global_236912);
  return (id)logCategory__hmf_once_v5_236913;
}
...
void __38__HMDRemoteLoginUtilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_236913;
  logCategory__hmf_once_v5_236913 = v0;
...
void __103__HMDRemoteLoginUtilities_fetchIsTwoFactorAuthenticationEnabledForAccountWithReason_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    objc_msgSend(v5, "hmf_BOOLForKey:", *MEMORY[0x24BE0ABB8]);
...
LABEL_8:
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_INFO, "%{public}@Unable to directly determine 2FA authentication status: %@", (uint8_t *)&v17, 0x16u);
