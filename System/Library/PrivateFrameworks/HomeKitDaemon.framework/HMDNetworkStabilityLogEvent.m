...
- (HMDNetworkStabilityLogEvent)initWithDictionary:(id)a3
{
  ...
  v55 = v6;
  if (v6)
    v63 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", v6);
  else
    v63 = 0;
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numWifiAssociations](self, "numWifiAssociations"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v19[0] = v17;
  v18[1] = CFSTR("numWifiDisassociations");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numWifiDisassociations](self, "numWifiDisassociations"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v19[1] = v16;
  v18[2] = CFSTR("numWifiAPChanges");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numAPChanges](self, "numAPChanges"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v19[2] = v15;
  v18[3] = CFSTR("numGatewayChanges");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numGatewayChanges](self, "numGatewayChanges"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v19[3] = v14;
  v18[4] = CFSTR("numReadWrites");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numReadWrites](self, "numReadWrites"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v19[4] = v3;
  v18[5] = CFSTR("numReadErrors");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numReadErrors](self, "numReadErrors"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v19[5] = v4;
  v18[6] = CFSTR("numWriteErrors");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numWriteErrors](self, "numWriteErrors"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent numSessionErrors](self, "numSessionErrors"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[HMDNetworkStabilityLogEvent localHourOfDay](self, "localHourOfDay"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v19[11] = v10;
  v18[12] = CFSTR("collectionDurationMinutes");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[HMDNetworkStabilityLogEvent collectionDurationMinutes](self, "collectionDurationMinutes"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v19[12] = v11;
