...
+ (id)modelNamespace
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("3FFD3711-E751-4F46-A74F-4F0B4E877E8F"));
}
...
+ (id)properties
{
  if (properties_onceToken_180002 != -1)
    dispatch_once(&properties_onceToken_180002, &__block_literal_global_180003);
  return (id)properties__properties_180004;
}
...
void __53__HMDAccessoryNetworkProtectionGroupModel_properties__block_invoke()
{
  ...
  v5 = (void *)properties__properties_180004;
  properties__properties_180004 = v4;
