...
- (id)unarchive
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Unarchived flags store: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 138543362;
      v18 = v15;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@No time-based flag archive found", (uint8_t *)&v17, 0xCu);
