...
{
  return -[HMDMatterAccessoryPairingEndContext initWithStep:error:sourceErrorDomain:isCancelled:]([HMDMatterAccessoryPairingEndContext alloc], "initWithStep:error:sourceErrorDomain:isCancelled:", &unk_24E96ACD0, 0, 0, 0);
}
...
+ (id)hmContextWithCancelledError:(id)a3
{
  ...
  v5 = -[HMDMatterAccessoryPairingEndContext initWithStep:error:sourceErrorDomain:isCancelled:](v4, "initWithStep:error:sourceErrorDomain:isCancelled:", 0, v3, *MEMORY[0x24BDD5BD8], 1);
...
+ (id)hmmtrContextWithStep:(unint64_t)a3 error:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", a3);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = -[HMDMatterAccessoryPairingEndContext initWithStep:error:sourceErrorDomain:isCancelled:](v6, "initWithStep:error:sourceErrorDomain:isCancelled:", v7, v5, *MEMORY[0x24BE4EE80], 0);
