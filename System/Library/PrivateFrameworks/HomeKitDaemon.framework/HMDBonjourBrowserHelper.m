  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v23;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Browsing interval or types count must be greater than 0", buf, 0xCu);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F1F8]), "initWithDomain:serviceType:", CFSTR("local."), v11);
...
- (void)_stopBrowsers
{
  ...
  if ((v4 & 1) != 0)
  {
    ...
    v12 = (void *)MEMORY[0x227676638](-[HMDBonjourBrowserHelper _updateTimerWithTimeout:](self, "_updateTimerWithTimeout:"));
    v13 = self;
    HMFGetOSLogHandle();
    v14 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2112;
      v40 = v17;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Waiting to restart browsing after: %@ seconds", buf, 0x16u);
...
- (void)_updateTimerWithTimeout:(double)a3
{
  ...
  if (a3 > 0.0)
  {
    v9 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BE3F298]), "initWithTimeInterval:options:", 0, a3);
...
- (void)netServiceBrowser:(id)a3 didStopBrowsingWithError:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v15;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_INFO, "%{public}@Stopped browsing for services of type: %@ with error: %@. Found %@ servcies.", (uint8_t *)&v16, 0x2Au);
...
void __41__HMDBonjourBrowserHelper__startBrowsers__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v11;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting browsing for services of type: %@ with error: %@ for %@ seconds", (uint8_t *)&v12, 0x2Au);
