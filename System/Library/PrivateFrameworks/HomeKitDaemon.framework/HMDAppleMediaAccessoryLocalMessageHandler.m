...
- (void)handleSiriEndpointDeleteSiriHistoryMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2112;
    v40 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling siri endpoint delete siri history message: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v43 = 2112;
            v44 = v17;
            _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to get endpoint identifier for accessory: %@ for delete siri history message: %@ error: %@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v43 = 2112;
          v44 = v15;
          _os_log_impl(&dword_2218F0000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory with uuid: %@ for delete siri history message: %@ error: %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v41 = 2112;
        v42 = v12;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode message payload from delete siri history message payload: %@ error: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v41 = 2112;
      v42 = v11;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message payload from delete siri history message: %@ error: %@", buf, 0x20u);
...
- (id)dataSourceAccessoryWithUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory with uuid: %@ due to no data source", (uint8_t *)&v13, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_58909 != -1)
    dispatch_once(&logCategory__hmf_once_t6_58909, &__block_literal_global_58910);
  return (id)logCategory__hmf_once_v7_58911;
}
...
void __56__HMDAppleMediaAccessoryLocalMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_58911;
  logCategory__hmf_once_v7_58911 = v0;
