...
- (void)_handleBulletinBoardNotificationServiceGroupRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v6;
      _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to a request for notification service group with payload %@", (uint8_t *)&v12, 0x16u);
...
- (BOOL)_isSupportedAssociationService:(id)a3
{
  ...
  v3 = *MEMORY[0x24BE1B7A8];
  v10[0] = *MEMORY[0x24BE1B7E8];
  v10[1] = v3;
  v4 = *MEMORY[0x24BE1B7F0];
  v10[2] = *MEMORY[0x24BE1B7C8];
  v10[3] = v4;
...
- (BOOL)_isAlarmService:(id)a3
{
  ...
  objc_msgSend(a3, "findCharacteristicWithType:", *MEMORY[0x24BE1B5C8]);
...
- (BOOL)_isNotificationGeneratingService:(id)a3
{
  ...
  v3 = *MEMORY[0x24BE1B848];
  v9[0] = *MEMORY[0x24BE1B7B0];
  v9[1] = v3;
...
- (void)configureBulletinNotification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_ERROR, "%{public}@configureBulletinNotification called before configure", (uint8_t *)&v9, 0xCu);
...
- (void)_configureServices
{
  ...
  if (v5)
  {
    ...
    if (v71)
    {
      ...
      if (v70)
      {
                      ...
                      if (-[HMDBulletinBoardNotificationServiceGroup _isSupportedAssociationService:](self, "_isSupportedAssociationService:", v33))
                      {
                        ...
                        if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          v107 = 2112;
                          v108 = v38;
                          _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_DEBUG, "%{public}@Service %@ with type %@ is a supported service for association", buf, 0x20u);
                      ...
                      if (-[HMDBulletinBoardNotificationServiceGroup _isAlarmService:](self, "_isAlarmService:", v49))
                      {
                        ...
                        if (os_log_type_enabled(v52, OS_LOG_TYPE_DEBUG))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          v107 = 2112;
                          v108 = v54;
                          _os_log_impl(&dword_2218F0000, v52, OS_LOG_TYPE_DEBUG, "%{public}@Service %@ with type %@ contains an alarm system, adding it to association", buf, 0x20u);
        ...
        if (os_log_type_enabled(v58, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v105 = 2112;
          v106 = v67;
          _os_log_impl(&dword_2218F0000, v58, OS_LOG_TYPE_DEBUG, "%{public}@Camera Notification Services %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v104 = v66;
            _os_log_impl(&dword_2218F0000, v65, OS_LOG_TYPE_INFO, "%{public}@There are no cameras, no association of services", buf, 0xCu);

          }
          objc_autoreleasePoolPop(v63);
          v61 = (void *)MEMORY[0x24BDBD1B8];
          v60 = v64;
          v62 = (void *)MEMORY[0x24BDBD1B8];
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v104 = v22;
          _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@No accessory, bailing out", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v104 = v17;
        _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@No home, bailing out", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v104 = v13;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@No room, bailing out", buf, 0xCu);
...
- (void)_updateAssociatedServices:(id)a3 associatedCameras:(id)a4
{
  ...
  void *v36;
  void *v37;
  HMDBulletinBoardNotificationServiceGroup *v38;
  NSObject *v39;
  void *v40;
  void *v41;
  HMDBulletinBoardNotificationServiceGroup *v42;
  NSObject *v43;
  void *v44;
  void *v45;
  void *v46;
  ...
  {
    v19 = (void *)MEMORY[0x227676638](-[HMDBulletinBoardNotificationServiceGroup setAssociatedServiceUUIDs:](self, "setAssociatedServiceUUIDs:", v13));
    v20 = self;
    HMFGetOSLogHandle();
    v21 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v13;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_INFO, "%{public}@Updating associated services with %@", buf, 0x16u);
  ...
  -[HMDBulletinBoardNotificationServiceGroup _updateAssociatedServicesTable:](v18, "_updateAssociatedServicesTable:", v6);
LABEL_8:
  objc_msgSend(MEMORY[0x24BDD15C0], "weakObjectsHashTable");
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v54 = 0u;
  ...
  v25 = objc_msgSend(v24, "countByEnumeratingWithState:objects:count:", &v54, v58, 16);
  if (v25)
  {
    v26 = v25;
    v27 = *(_QWORD *)v55;
    do
    {
      for (i = 0; i != v26; ++i)
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v54 + 1) + 8 * i), "cameraProfile");
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v23, "addObject:", v29);

      }
      v26 = objc_msgSend(v24, "countByEnumeratingWithState:objects:count:", &v54, v58, 16);
    }
    while (v26);
  }
  ...
  if ((v32 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v10;
      _os_log_impl(&dword_2218F0000, v43, OS_LOG_TYPE_INFO, "%{public}@Updating associated cameras with %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v41);
    -[HMDBulletinBoardNotificationServiceGroup setCameraProfileUUIDs:](v42, "setCameraProfileUUIDs:", v10);
    -[HMDBulletinBoardNotificationServiceGroup setCameraProfilesTable:](v42, "setCameraProfilesTable:", v23);
    objc_msgSend(v30, "updateRegistrations");
    v36 = v50;
    goto LABEL_25;
  }
...
LABEL_25:
    ...
    objc_msgSend(v47, "saveWithReason:postSyncNotification:", CFSTR("HMDBulletinBoardNotificationServiceGroupUpdatedSaveReason"), 0);
    objc_msgSend(v47, "accessoryBulletinNotificationManager");
    ...
    v52 = v13;
    v53 = v10;
    objc_msgSend(v48, "updateServiceGroup:completion:", self, v51);

    goto LABEL_26;
  }
  v37 = (void *)MEMORY[0x227676638](v35);
  v38 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v60 = v40;
    _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_DEBUG, "%{public}@No change in service and camera associations", buf, 0xCu);
...
- (id)dumpState
{
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, *MEMORY[0x24BE3EA80]);
  objc_msgSend(MEMORY[0x24BDBCEB8], "array");
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v11, *MEMORY[0x24BE3EA70]);
  return v3;
}
  ...
  if (v7 == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find the camera profile with unique id %@", buf, 0x16u);
...
- (id)actionContextForCameraProfileID:(id)a3
{
  ...
  if (v5)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = objc_msgSend(v11, "isEqualToString:", *MEMORY[0x24BE1B848]);
...
LABEL_4:
    ...
    v23 = *MEMORY[0x24BE1B7E8];
    objc_msgSend(v22, "objectForKeyedSubscript:", *MEMORY[0x24BE1B7E8]);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    v87 = v4;
    v88 = v7;
    v79 = v5;
    ...
    if (objc_msgSend(v24, "count"))
    {
      ...
      if (v28)
      {
        ...
        if (v41)
        {
          ...
          v8 = 0x24BDBC000;
LABEL_26:
          v46 = objc_alloc_init(MEMORY[0x24BDD17C8]);
          v47 = *MEMORY[0x24BE1B808];
          objc_msgSend(v22, "objectForKeyedSubscript:", *MEMORY[0x24BE1B808]);
          v48 = (void *)objc_claimAutoreleasedReturnValue();
          v49 = objc_msgSend(v48, "count");

          v50 = *MEMORY[0x24BE1B7F0];
          objc_msgSend(v22, "objectForKeyedSubscript:", *MEMORY[0x24BE1B7F0]);
...
LABEL_45:
            ...
            v71 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(MEMORY[0x24BDF8820], "actionWithIdentifier:title:options:", CFSTR("DISMISS"), v71, 0);
            v72 = (void *)objc_claimAutoreleasedReturnValue();
            v98[0] = CFSTR("categoryID");
            v98[1] = CFSTR("bulletinActionButtonDescription");
            v99[0] = CFSTR("HomeAppBulletinCategory");
            v99[1] = v55;
            v98[2] = *MEMORY[0x24BDD5350];
            ...
            v99[2] = v75;
            v99[3] = v72;
            objc_msgSend(*(id *)(v56 + 3696), "dictionaryWithObjects:forKeys:count:", v99, v98, 4);
            v17 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_44:
              ...
              v101[2] = v46;
              v101[3] = v54;
              objc_msgSend(*(id *)(v66 + 3696), "dictionaryWithObjects:forKeys:count:", v101, v100, 4);
              v70 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v103[3] = v43;
      v8 = 0x24BDBC000uLL;
      objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v103, v102, 4);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v108 = 2112;
    v109 = v4;
    _os_log_impl(&dword_2218F0000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find the camera profile with unique id %@, not providing any context", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = 0;
      _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not initialize from decoded bulletinBoardNotification: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29_13544 != -1)
    dispatch_once(&logCategory__hmf_once_t29_13544, &__block_literal_global_13545);
  return (id)logCategory__hmf_once_v30_13546;
}
...
void __55__HMDBulletinBoardNotificationServiceGroup_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v30_13546;
  logCategory__hmf_once_v30_13546 = v0;
