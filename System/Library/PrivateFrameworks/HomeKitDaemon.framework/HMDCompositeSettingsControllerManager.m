    ...
    if ((unint64_t)(v11 - 4) <= 0xFFFFFFFFFFFFFFFDLL)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v57 = 2112;
        v58 = v8;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Current state is not resident or primary resident for owner:%@, home:%@", buf, 0x20u);
...
LABEL_29:
  ...
  if (v11 == 3)
  {
    ...
    if (self)
    {
      ...
      {
        objc_msgSend(&unk_24E9711C8, "arrayByAddingObjectsFromArray:", &unk_24E9711E0);
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v61 = 2112;
      v62 = v31;
      _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_INFO, "%{public}@Created setting controller %@ for owner:%@ home:%@ blocklist: %@", buf, 0x34u);
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.%@"), v8, v50);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v57 = 2112;
      v58 = v8;
      _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Current state is not primary resident for owner:%@, home:%@ so skipping controller creation", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Ignoring composite setting controller configuration update as we are not the primary resident for home:%@ accessory:%@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v7;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Ignoring siri endpoint setting update as we are not the primary resident for home:%@ accessory:%@", buf, 0x20u);
...
- (void)didUpdateCurrentRunState:(int64_t)a3 updatedState:(int64_t)a4 forHome:(id)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v35 = 2112;
    v36 = v8;
    _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@CurrentState: %ld, UpdatedState: %ld, Home:%@", buf, 0x2Au);
  ...
  if (!v17)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = (int64_t)v16;
      _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_ERROR, "%{public}@Home not found %@", buf, 0x16u);
  ...
  block[0] = v15;
  block[1] = 3221225472;
  block[2] = __87__HMDCompositeSettingsControllerManager_didUpdateCurrentRunState_updatedState_forHome___block_invoke_115;
...
- (void)languagesDidChangeForHome:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling languages changed for homeUUID: %@", buf, 0x16u);
...
- (void)_updateLanguageEventIfNeededWithHome:(void *)a3 uuid:
{
  ...
  if (a1)
  {
    ...
    if (v12 == 3 && v10)
    {
      ...
      {
        MEMORY[0x2276752E8](v5, v7, CFSTR("root.siri.availableLanguages"));
        ...
        {
          v45 = 0;
          objc_msgSend(MEMORY[0x24BDD7708], "decodeSettingFromEvent:error:", v21, &v45);
          v22 = (void *)objc_claimAutoreleasedReturnValue();
          v23 = v45;
          if (v23)
          {
        ...
        v31 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7728]), "initWithKeyPath:readOnly:languageValues:", CFSTR("root.siri.availableLanguages"), 1, v20);
        v32 = v31;
        if (!v22 || (objc_msgSend(v31, "isEqual:", v22) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v50 = 2112;
            v51 = v32;
            _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_DEBUG, "%{public}@Updating language event for topic %@, with Value: %@", buf, 0x20u);

          }
          objc_autoreleasePoolPop(v33);
          v15 = v41;
          v37 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7708]), "initWithSetting:eventSource:eventTimestamp:", v32, v41, v14);
          objc_msgSend(v9, "eventForwarder");
          v38 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v38, "forwardEvent:topic:completion:", v37, v44, &__block_literal_global_96_204312);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v47 = v30;
        _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_INFO, "%{public}@Not checking for need to post language events because this device is not the primary resident.", buf, 0xCu);
...
void __87__HMDCompositeSettingsControllerManager_didUpdateCurrentRunState_updatedState_forHome___block_invoke_115(uint64_t a1)
{
  void *v1;
  const char *v2;
  id v3;
...
LABEL_6:
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v74 = 2112;
          v75 = v3;
          _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_INFO, "%{public}@creating controller for state %ld, home: %@", buf, 0x20u);
        ...
        v47 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v47, "na_filter:", &__block_literal_global_121_204322);
        v48 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_postSettingUpdatesIfDifferentWithHome:(void *)a3 uuid:(void *)a4 settings:(void *)a5 metadata:
{
  ...
  void *v35;
  void *v36;
  HMDCompositeSettingOperationResult *v37;
  void *v38;
  void *v39;
  id v40;
  NSObject *v41;
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v74 = 2048;
      v75 = v17;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Posting updates with eventStoreHandle:%@, for settings count:%lu, with run state:%ld", buf, 0x2Au);
    ...
    if (v17 == 3 && v57)
    {
      ...
      if (v58)
      {
        ...
        do
        {
          for (i = 0; i != v58; ++i)
          {
            if (*(_QWORD *)v64 != v55)
              objc_enumerationMutation(obj);
            v23 = *(_QWORD *)(*((_QWORD *)&v63 + 1) + 8 * i);
            objc_msgSend(obj, "objectForKeyedSubscript:", v23);
            v24 = objc_claimAutoreleasedReturnValue();
            MEMORY[0x2276752E8](v9, v59, v23);
            v25 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v57, "lastEventForTopic:", v25);
            v26 = objc_claimAutoreleasedReturnValue();
            v61 = (void *)v26;
            if (v26)
            {
              v62 = 0;
              objc_msgSend(MEMORY[0x24BDD7708], "decodeSettingFromEvent:error:", v26, &v62);
            ...
            objc_msgSend(v56, "objectForKeyedSubscript:", v23);
            v35 = (void *)objc_claimAutoreleasedReturnValue();
            v36 = (void *)v24;
            v37 = -[HMDCompositeSettingOperationResult initWithKeyPath:setting:metadata:error:](v34, "initWithKeyPath:setting:metadata:error:", v23, v24, v35, 0);
            +[HMDCompositeSettingsControllerManager immutableSettingFromFetchReturn:](HMDCompositeSettingsControllerManager, "immutableSettingFromFetchReturn:", v37);
            v38 = (void *)objc_claimAutoreleasedReturnValue();

            if (v27 && objc_msgSend(v27, "isEqual:", v38))
            {
              ...
              if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v72 = 2112;
                v73 = v23;
                _os_log_impl(&dword_2218F0000, v41, OS_LOG_TYPE_INFO, "%{public}@Skip sending event for accessory %@ setting %@ as it matches stored", buf, 0x20u);
            ...
            {
              v43 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7708]), "initWithSetting:eventSource:eventTimestamp:", v38, v51, v15);
              objc_msgSend(v52, "eventForwarder");
              v44 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v44, "forwardEvent:topic:completion:", v43, v25, &__block_literal_global_94_204335);
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v70 = 2112;
        v71 = v49;
        _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@Diff from persistent store?: %@, skipping all updates", buf, 0x16u);
...
uint64_t __87__HMDCompositeSettingsControllerManager__actualScanHomeAndCreateControllers_isPrimary___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[18] = 2096;
    *(_QWORD *)&buf[20] = &v26;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating controller for: %{uuid_t}.16P", buf, 0x1Cu);
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      *(_QWORD *)&buf[24] = v10;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@controller for uuid:%@, homeUUID:%@ already exists", buf, 0x20u);
...
- (void)_manageCharacteristicsBackedSettingsChangeForHomeUUID:(void *)a3 accessoryUUID:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v55 = v7;
      _os_log_impl(&dword_2218F0000, v11, OS_LOG_TYPE_INFO, "%{public}@managing characteristic backed settings for home:%@, accessory:%@", buf, 0x20u);
    ...
    if (!v14)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v28;
        _os_log_impl(&dword_2218F0000, v27, OS_LOG_TYPE_ERROR, "%{public}@Nil siriEndpointBridge", buf, 0xCu);
...
LABEL_19:
      ...
      && !-[HMDCompositeBoolSetting BOOLValue](v32, "BOOLValue"))
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v48;
        _os_log_impl(&dword_2218F0000, v47, OS_LOG_TYPE_INFO, "%{public}@Setting Siri enabled to NO", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v44;
        _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_INFO, "%{public}@Not transforming allowHeySiri and tapToAccess settings", buf, 0xCu);
...
void __134__HMDCompositeSettingsControllerManager__processCharacteristicBackedSettingsChangeForHomeUUID_accessoryUUID_allowHeySiri_tapToAccess___block_invoke(id *a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v8;
    _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_INFO, "%{public}@Siri enabled setting update returned result:%@, home:%@ accessory:%@", (uint8_t *)&v14, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v54 = 2112;
          v55 = v18;
          _os_log_impl(&dword_2218F0000, v31, OS_LOG_TYPE_ERROR, "%{public}@Unable to fetch SiriEnabled setting operation result:%@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v56 = 2112;
        v57 = v10;
        _os_log_impl(&dword_2218F0000, v36, OS_LOG_TYPE_ERROR, "%{public}@No controller for home:%@ accessory:%@", buf, 0x20u);
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke(id *a1)
{
  ...
  if (v3 != 3)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v89 = v49;
      _os_log_impl(&dword_2218F0000, v48, OS_LOG_TYPE_INFO, "%{public}@Device is not a primary resident", buf, 0xCu);
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.%@"), a1[5], a1[6]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v6 || (objc_msgSend(v6, "configured") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v89 = v54;
      _os_log_impl(&dword_2218F0000, v53, OS_LOG_TYPE_INFO, "%{public}@Controller is not created or not configured", buf, 0xCu);
...
LABEL_12:
  ...
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", 7);
  v8 = [HMDCompositeSettingsKeyPathValueItem alloc];
  p_info = &OBJC_METACLASS___MKFHomeMediaSettingDatabaseID.info;
  ...
  if (v33)
  {
    ...
    p_info = (__objc2_class_ro **)(&OBJC_METACLASS___MKFHomeMediaSettingDatabaseID + 32);
  }
  else
  {
    objc_msgSend(MEMORY[0x24BDD7420], "defaultLanguageValue");
    v45 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  +[HMDHomeKitVersion currentVersion](HMDHomeKitVersion, "currentVersion");
  v57 = (void *)objc_claimAutoreleasedReturnValue();
  v58 = (void *)objc_msgSend(objc_alloc((Class)(p_info + 476)), "initWithValue:", objc_msgSend(a1[7], "allowHeySiri"));
  ...
  if (v64)
  {
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v90 = 2112;
      v91 = v64;
      _os_log_impl(&dword_2218F0000, v67, OS_LOG_TYPE_ERROR, "%{public}@Error while checking certification status error:%@", buf, 0x16u);
  ...
  v78[1] = 3221225472;
  v78[2] = __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_104;
  v78[3] = &unk_24E791610;
  v86 = v63;
  v78[4] = v71;
  v85 = a1[8];
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_104(uint64_t a1, void *a2, void *a3, void *a4)
{
  id v7;
  id v8;
  id v9;
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v19;
      _os_log_impl(&dword_2218F0000, v17, OS_LOG_TYPE_ERROR, "%{public}@Applying onboarding selections to controller failed with error: %@", buf, 0x16u);
  ...
  else
  {
    ...
    v27[0] = MEMORY[0x24BDAC760];
    v27[1] = 3221225472;
    v27[2] = __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_106;
    v27[3] = &unk_24E7915E8;
    v26 = *(void **)(a1 + 88);
    v32 = *(_QWORD *)(a1 + 96);
    v27[4] = v22;
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_106(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  else
  {
    ...
    v27[0] = MEMORY[0x24BDAC760];
    v27[1] = 3221225472;
    v27[2] = __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_107;
    v27[3] = &unk_24E7915C0;
    v24 = *(_QWORD *)(a1 + 32);
    v25 = *(void **)(a1 + 40);
    v26 = *(void **)(a1 + 64);
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_107(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v14;
      _os_log_impl(&dword_2218F0000, v12, OS_LOG_TYPE_ERROR, "%{public}@Applying onboarding selections to controller failed with error: %@", (uint8_t *)&v22, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v21;
      _os_log_impl(&dword_2218F0000, v20, OS_LOG_TYPE_INFO, "%{public}@Applying onboarding selections to controller successful", (uint8_t *)&v22, 0xCu);
          ...
          if (v9)
          {
            if (v70)
            {
              if (v11)
              {
                ...
                {
                  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:description:reason:suggestion:", -1, CFSTR("Not a primary resident"), 0, 0);
                  v17 = (void *)objc_claimAutoreleasedReturnValue();
                  v32 = (void *)MEMORY[0x227676638]();
                  v33 = v1;
                  HMFGetOSLogHandle();
                  ...
                  if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_WORD *)&buf[12] = 2112;
                    *(_QWORD *)&buf[14] = v17;
                    _os_log_impl(&dword_2218F0000, v34, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
                ...
                v15 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.%@"), v7, v71);
                v16 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v15, "objectForKey:", v16);
                v17 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                if (!v17)
                {
                  ...
                  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_WORD *)&buf[22] = 2112;
                    v73 = v7;
                    _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_ERROR, "%{public}@Unconfigured controller for uuid:%@, home:%@", buf, 0x20u);
...
LABEL_25:
                ...
                if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_WORD *)&v74[10] = 2112;
                  *(_QWORD *)&v74[12] = v68;
                  _os_log_impl(&dword_2218F0000, v22, OS_LOG_TYPE_INFO, "%{public}@Characteristic backed keyPath update for home:%@, accessory:%@, keyPath:%@, value:%@", buf, 0x34u);
                ...
                if (!v25)
                {
                  ...
                  if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_WORD *)&buf[12] = 2112;
                    *(_QWORD *)&buf[14] = v44;
                    _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Invalid BOOL value:%@", buf, 0x16u);

                  }
                  objc_autoreleasePoolPop(contexta);
                  v48 = [HMDCompositeSettingOperationResult alloc];
                  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:userInfo:", 43, 0);
                  v49 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                if (objc_msgSend(v24, "BOOLValue"))
                {
                  if (v19)
                  {
                    v62 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7968]), "initWithBoolValue:", 1);
                    *(_QWORD *)buf = MEMORY[0x24BDAC760];
                    *(_QWORD *)&buf[8] = 3221225472;
...
LABEL_43:
                  ...
                  objc_msgSend(MEMORY[0x24BDD1540], "hmErrorWithCode:userInfo:", 27, 0);
                  v54 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                else
                {
                  if (v19)
                  {
                    v31 = (void (**)(id, HMDCompositeSettingOperationResult *, id, id))objc_msgSend(objc_alloc(MEMORY[0x24BDD7968]), "initWithBoolValue:", objc_msgSend(v24, "BOOLValue"));
                    *(_QWORD *)buf = MEMORY[0x24BDAC760];
                    *(_QWORD *)&buf[8] = 3221225472;
                ...
                *(_DWORD *)buf = 138543362;
                *(_QWORD *)&buf[4] = v61;
                _os_log_impl(&dword_2218F0000, v57, OS_LOG_TYPE_ERROR, "%{public}@No Siri endpoint bridge", buf, 0xCu);
...
- (id)dataSourceIsCurrentDevicePrimaryResidentForHomeUUID:(void *)a1
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(MEMORY[0x24BE3F150], "BOOLeanWithBool:", v6);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2218F0000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine current device is primary resident due to no data source", (uint8_t *)&v13, 0xCu);
...
void __130__HMDCompositeSettingsControllerManager_localFetchSettingsForUUID_homeUUID_withKeyPaths_callerVersion_callerPrivilege_completion___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (v13 && (objc_msgSend(v13, "BOOLValue") & 1) != 0)
    {
      ...
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v16 = v54;
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.%@"), v7, v54);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v18)
      {
        objc_msgSend(v8, "na_filter:", &__block_literal_global_204397);
        v51 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)((char *)&v62 + 2) = v7;
          _os_log_impl(&dword_2218F0000, v40, OS_LOG_TYPE_INFO, "%{public}@Siri is enabled:%@ for owner:%@, home:%@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          v61 = v7;
          _os_log_impl(&dword_2218F0000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unconfigured controller for uuid:%@, home:%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        ...
        LOWORD(v62) = 2112;
        *(_QWORD *)((char *)&v62 + 2) = v7;
        _os_log_impl(&dword_2218F0000, v24, OS_LOG_TYPE_ERROR, "%{public}@Error: %@, owner:%@, home:%@", buf, 0x2Au);
...
+ (id)immutableSettingFromFetchReturn:(id)a3
{
  ...
  if (v4)
  {
    ...
    if ((isKindOfClass & 1) != 0)
    {
      v10 = objc_alloc(MEMORY[0x24BDD74E0]);
...
LABEL_29:
    ...
    if ((v14 & 1) != 0)
    {
      v16 = objc_alloc(MEMORY[0x24BDD7710]);
      objc_msgSend(v3, "keyPath");
      v17 = (id)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if ((v20 & 1) != 0)
      {
        ...
        v40 = objc_alloc(MEMORY[0x24BDD74E8]);
        objc_msgSend(v3, "keyPath");
        v18 = (id)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        v44 = v17;
        v43 = objc_alloc(MEMORY[0x24BDD7720]);
        objc_msgSend(v3, "keyPath");
        v32 = objc_claimAutoreleasedReturnValue();
        v39 = objc_alloc(MEMORY[0x24BDD7978]);
...
{
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("HMDCompositeSettingsZone.%@"), a3);
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t35_204442 != -1)
    dispatch_once(&logCategory__hmf_once_t35_204442, &__block_literal_global_110_204443);
  return (id)logCategory__hmf_once_v36_204444;
}
...
void __52__HMDCompositeSettingsControllerManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v36_204444;
  logCategory__hmf_once_v36_204444 = v0;
...
- (void)accessorySettingsLocalMessageHandler:(id)a3 didReceiveFetchRequestMessage:(id)a4 withHomeUUID:(id)a5 accessoryUUID:(id)a6 keyPaths:(id)a7 callerVersion:(id)a8 callerPrivilege:(unint64_t)a9 siriAvailableLanguagesSetting:(id)a10
{
  ...
  if (v23)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2114;
      v44 = v19;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch using current accessory %{public}@", buf, 0x16u);
  ...
  {
    objc_msgSend(v19, "na_filter:", &__block_literal_global_243545);
  ...
  if (v22)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v52 = 2112;
      v53 = v19;
      _os_log_impl(&dword_2218F0000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Update using current accessory keyPath: %{public}@, value: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v50 = 2112;
        v51 = v19;
        _os_log_impl(&dword_2218F0000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due to no composite setting value conversion for setting value: %@", buf, 0x16u);
...
void __210__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveUpdateRequestMessage_withHomeUUID_accessoryUUID_keyPath_value_callerVersion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Update %{public}@ result: %@", (uint8_t *)&v10, 0x20u);
...
void __210__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveUpdateRequestMessage_withHomeUUID_accessoryUUID_keyPath_value_callerVersion___block_invoke_11(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v10)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v10;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_ERROR, "%{public}@Update completed with error: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_INFO, "%{public}@Update complete", (uint8_t *)&v17, 0xCu);
...
void __250__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveFetchRequestMessage_withHomeUUID_accessoryUUID_keyPaths_callerVersion_callerPrivilege_siriAvailableLanguagesSetting___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v19 = 2112;
    v20 = v6;
    _os_log_impl(&dword_2218F0000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched settings %@, error: %@", (uint8_t *)&v15, 0x20u);

  }
  objc_autoreleasePoolPop(v7);
  v11 = objc_alloc_init(MEMORY[0x24BDD7808]);
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7430]), "initWithSettings:failureInformation:", v5, v11);
  v13 = *(void **)(a1 + 40);
...
void __250__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveFetchRequestMessage_withHomeUUID_accessoryUUID_keyPaths_callerVersion_callerPrivilege_siriAvailableLanguagesSetting___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  v36 = a3;
  v34 = a4;
  v8 = objc_alloc_init(MEMORY[0x24BDD7808]);
  ...
  if (v19)
  {
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v29 = 42;
LABEL_18:
      _os_log_impl(&dword_2218F0000, v27, v28, v26, buf, v29);
  ...
  objc_autoreleasePoolPop(v20);
  v31 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD7430]), "initWithSettings:failureInformation:", v9, v8);
  v32 = *(void **)(a1 + 56);
