...
- (void)dumpWithVerbosity:(BOOL)a3 prefix:(id)a4 logType:(unsigned __int8)a5
{
  ...
  if (os_log_type_enabled(v38, type))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v51 = 2112;
    v52 = v44;
    _os_log_impl(&dword_2218F0000, v38, type, "%{public}@HMDBackingStoreModelObjectUnsupported %@", buf, 0x16u);
...
- (void)dumpDebug
{
  -[HMDBackingStoreModelObjectUnsupported dumpDebug:](self, "dumpDebug:", &stru_24E79DB48);
}
