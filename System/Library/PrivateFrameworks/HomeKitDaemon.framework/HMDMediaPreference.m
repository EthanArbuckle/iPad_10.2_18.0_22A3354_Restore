...
- (HMDMediaPreference)initWithKey:(id)a3 options:(unint64_t)a4 defaultValue:(id)a5
{
  ...
  if (v10)
  {
    v11 = objc_msgSend(objc_alloc(MEMORY[0x24BE3F290]), "initWithKey:options:defaultValue:", v8, a4, v9);
...
{
  objc_msgSend(MEMORY[0x24BE3F248], "setPreferenceClass:forPreferenceKey:", a1, CFSTR("enableMediaAccessories"));
}
