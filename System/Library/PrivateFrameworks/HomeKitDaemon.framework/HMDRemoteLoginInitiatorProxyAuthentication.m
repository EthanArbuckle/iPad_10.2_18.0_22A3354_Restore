...
- (void)_authenticate
{
  ...
  objc_msgSend(v8, "hmf_stringForKey:", *MEMORY[0x24BE0ABD8]);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteLoginProxyAuthenticationRequest setRawPassword:](v5, "setRawPassword:", v9);

  -[HMDRemoteLoginInitiatorProxyAuthentication authResults](self, "authResults");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "hmf_stringForKey:", *MEMORY[0x24BE0ABD0]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteLoginProxyAuthenticationRequest setPasswordToken:](v5, "setPasswordToken:", v11);

  -[HMDRemoteLoginInitiatorProxyAuthentication authResults](self, "authResults");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "hmf_stringForKey:", *MEMORY[0x24BE0AB48]);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteLoginProxyAuthenticationRequest setAltDSID:](v5, "setAltDSID:", v13);

  v14 = (void *)MEMORY[0x227676638](-[HMDRemoteLoginAuthenticationRequest setTargetedAccountType:](v5, "setTargetedAccountType:", 0));
  v15 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v38 = 2112;
    v39 = v20;
    _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Received username %@, pet %@, alt-dsid %@", buf, 0x2Au);
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2112;
    v35 = v26;
    _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Received password: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1 != -1)
    dispatch_once(&logCategory__hmf_once_t1, &__block_literal_global_512);
