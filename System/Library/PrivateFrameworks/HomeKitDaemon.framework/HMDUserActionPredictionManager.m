...
- (HMDUserActionPredictionManager)initWithHome:(id)a3
{
  ...
  {
    v7 = v6;
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD1880]), "initWithUUIDString:", CFSTR("9A1A9B9D-BE90-4E26-A5EC-70FE027E74EA"));
...
- (id)_removeZones
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_INFO, "%{public}@Removing all user action prediction manager data", (uint8_t *)&v11, 0xCu);
...
- (void)zoneManagerDidStart:(id)a3
{
  ...
  void *v41;
  void *v42;
  HMDUserActionPredictionManager *v43;
  NSObject *v44;
  void *v45;
  id v46;
  void *v47;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v56 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@User Action zone manager started", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v6);
  v10 = objc_alloc(MEMORY[0x24BE3F138]);
  v11 = (void *)MEMORY[0x24BDD17C8];
  MEMORY[0x227675180](v7, a2);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "stringWithFormat:", CFSTR("%@, %s:%ld"), v12, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/User/User Action Predictions/HMDUserActionPredictionManager.m", 135);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v54 = 0;
  objc_msgSend(v18, "fetchModelsOfType:error:", objc_opt_class(), &v54);
  ...
  v51 = 0u;
  obj = v19;
  v20 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v50, v60, 16);
  if (v20)
  {
    v21 = v20;
    v22 = *(_QWORD *)v51;
    do
    {
      for (i = 0; i != v21; ++i)
      {
        ...
        objc_msgSend(MEMORY[0x24BE4ED10], "optionsWithLabel:", CFSTR("Remove no longer used user action prediction"));
        v31 = (void *)objc_claimAutoreleasedReturnValue();
        v32 = (id)objc_msgSend(v25, "removeModelIDs:options:", v30, v31);

        v7 = v26;
      }
      v21 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v50, v60, 16);
    }
    while (v21);
  }
  ...
  if (v46)
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v57 = 2112;
      v58 = v46;
      _os_log_impl(&dword_2218F0000, v35, OS_LOG_TYPE_ERROR, "%{public}@User Action model fetch failed: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v57 = 2112;
    v58 = v41;
    _os_log_impl(&dword_2218F0000, v39, OS_LOG_TYPE_INFO, "%{public}@Startup User Action model fetch of %@ existing models is complete", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v37);
  v42 = (void *)MEMORY[0x227676638](objc_msgSend(v47, "invalidate"));
  v43 = v38;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v56 = v45;
    _os_log_impl(&dword_2218F0000, v44, OS_LOG_TYPE_INFO, "%{public}@Removing user action prediction zone as its no longer needed in roar", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v42);
  -[HMDUserActionPredictionManager removeZones](v43, "removeZones");
...
- (void)zoneManagerDidStop:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_2218F0000, v8, OS_LOG_TYPE_INFO, "%{public}@User Action zone manager stopped", (uint8_t *)&v10, 0xCu);
