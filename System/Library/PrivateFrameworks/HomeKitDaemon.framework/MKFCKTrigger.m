...
- (BOOL)importIntoLocalModel:(id)a3 updatedProperties:(id)a4 context:(id)a5
{
  ...
  if (v10)
  {
    ...
    objc_msgSend(v14, "objectForKeyedSubscript:", CFSTR("actionSets_"));
    v15 = (void *)objc_claimAutoreleasedReturnValue();

    -[MKFCKModel relationshipForLocalName:localModel:](self, "relationshipForLocalName:localModel:", CFSTR("actionSets_"), v12);
...
+ (id)fetchRequest
{
  return (id)objc_msgSend(MEMORY[0x24BDBB678], "fetchRequestWithEntityName:", CFSTR("MKFCKTrigger"));
}
