...
LABEL_24:
    ...
    v6 = Mutable;
    NetworkInterfaceEntity = SCDynamicStoreKeyCreateNetworkInterfaceEntity(0, (CFStringRef)*MEMORY[0x24BDF59B0], (CFStringRef)*MEMORY[0x24BDF5990], (CFStringRef)*MEMORY[0x24BDF5A10]);
