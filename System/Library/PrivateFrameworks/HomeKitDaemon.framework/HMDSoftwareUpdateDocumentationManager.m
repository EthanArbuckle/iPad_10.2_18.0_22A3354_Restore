...
- (HMDSoftwareUpdateDocumentationManager)initWithFileManager:(id)a3
{
  ...
  if (v6)
  {
    ...
    v16 = (HMFNetMonitor *)objc_alloc_init(MEMORY[0x24BE3F1F0]);
...
- (void)addAsset:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDD15E0], "indexSetWithIndex:", -[NSMutableOrderedSet count](self->_assets, "count"));
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v4;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Auditing asset: %@", buf, 0x16u);
          ...
          if ((v16 & 1) != 0)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v32 = 2112;
              v33 = v4;
              _os_log_impl(&dword_2218F0000, v23, OS_LOG_TYPE_INFO, "%{public}@Asset still in use: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v4;
      _os_log_impl(&dword_2218F0000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Asset no longer in use, removing: %@", buf, 0x16u);
...
- (void)networkMonitorIsReachable:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v7;
    _os_log_impl(&dword_2218F0000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Network is reachable, starting automatic caching", buf, 0xCu);
        ...
        if (objc_msgSend(v13, "shouldAutomaticallyCache") && objc_msgSend(v13, "state") <= 3)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v25 = 2112;
            v26 = v13;
            _os_log_impl(&dword_2218F0000, v16, OS_LOG_TYPE_INFO, "%{public}@Starting automatic caching for asset: %@", buf, 0x16u);
        ...
        if (v9 == v10)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v23 = 2112;
            v24 = v15;
            _os_log_impl(&dword_2218F0000, v13, OS_LOG_TYPE_INFO, "%{public}@Unregistering metadata: %@", buf, 0x16u);
...
void __71__HMDSoftwareUpdateDocumentationManager_registerDocumentationMetadata___block_invoke(uint64_t a1)
{
  ...
  v26 = *MEMORY[0x24BDAC8D0];
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BE3F218]), "initWithObservedObject:", *(_QWORD *)(a1 + 32));
  ...
  if ((v4 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v9;
      _os_log_impl(&dword_2218F0000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering metadata: %@", buf, 0x16u);
    ...
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v24 = 2112;
        v25 = v11;
        _os_log_impl(&dword_2218F0000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Creating new documentation asset: %@", buf, 0x16u);
...
void __58__HMDSoftwareUpdateDocumentationManager_parseCachedAssets__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v52 = v5;
    _os_log_impl(&dword_2218F0000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing cached assets", buf, 0xCu);
  ...
  if (v8)
  {
    ...
    v12 = HMDAppleMediaAccessoryMessenger;
    if (v11)
    {
      v13 = v11;
      v14 = *(_QWORD *)v46;
      do
      {
        for (i = 0; i != v13; ++i)
        {
          ...
          objc_msgSend(*(id *)(a1 + 32), "fileManager");
          v17 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(&v12[32], "assetWithURL:fileManager:", v16, v17);
              ...
              if (objc_msgSend(v18, "state") <= 3)
              {
                ...
                if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v53 = 2112;
                  v54 = v18;
                  _os_log_impl(&dword_2218F0000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Starting automatic caching of asset: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v53 = 2112;
      v54 = v10;
      _os_log_impl(&dword_2218F0000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Found cached assets: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v31;
      _os_log_impl(&dword_2218F0000, v30, OS_LOG_TYPE_INFO, "%{public}@Will purge unregistered assets in 60s", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v53 = 2112;
      v54 = v9;
      _os_log_impl(&dword_2218F0000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to get cached assets with error: %@", buf, 0x16u);
...
void __58__HMDSoftwareUpdateDocumentationManager_parseCachedAssets__block_invoke_9(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v20 = 2112;
    v21 = v7;
    _os_log_impl(&dword_2218F0000, v5, OS_LOG_TYPE_INFO, "%{public}@Auditing cached assets: %@", buf, 0x16u);
...
+ (HMDSoftwareUpdateDocumentationManager)sharedManager
{
  ...
  block[4] = a1;
  if (sharedManager_onceToken_178928 != -1)
    dispatch_once(&sharedManager_onceToken_178928, block);
  return (HMDSoftwareUpdateDocumentationManager *)(id)sharedManager_sharedManager_178929;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t15_178923 != -1)
    dispatch_once(&logCategory__hmf_once_t15_178923, &__block_literal_global_178924);
  return (id)logCategory__hmf_once_v16_178925;
}
...
void __52__HMDSoftwareUpdateDocumentationManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v16_178925;
  logCategory__hmf_once_v16_178925 = v0;
...
void __54__HMDSoftwareUpdateDocumentationManager_sharedManager__block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)sharedManager_sharedManager_178929;
  sharedManager_sharedManager_178929 = (uint64_t)v1;
