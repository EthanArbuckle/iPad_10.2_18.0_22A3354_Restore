...
LABEL_13:
          ...
          v15 = (void *)v17;
          v18 = objc_alloc(*(Class *)(v9 + 3112));
          objc_msgSend(*(id *)(v10 + 1760), "numberWithUnsignedShort:", objc_msgSend(v12, "portStart"));
          ...
          {
            v20 = objc_alloc(*(Class *)(v9 + 3112));
            objc_msgSend(*(id *)(v10 + 1760), "numberWithUnsignedShort:", objc_msgSend(v12, "portEnd"));
...
LABEL_24:
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(_QWORD *)&buf[14] = v12;
          _os_log_impl(&dword_2218F0000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert WAN rule to TLV, skipping: %@", buf, 0x16u);
