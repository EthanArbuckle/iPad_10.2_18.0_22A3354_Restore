...
- (NSDictionary)debugDictionaryRepresentation
{
  ...
  -[HMDCHIPControllerNonResidentNodeStorage keyValueStore](self, "keyValueStore");
...
- (BOOL)updateUsingHomeModel:(id)a3
{
  id v4;
  void *v5;
  HMDCHIPControllerNonResidentNodeStorage *v6;
  NSObject *v7;
  void *v8;
  int v10;
  void *v11;
...
{
  HMDCHIPControllerNonResidentNodeStorage *v4;
  void *v5;

  v4 = -[HMDCHIPControllerNonResidentNodeStorage init](+[HMDCHIPControllerNonResidentNodeStorage allocWithZone:](HMDCHIPControllerNonResidentNodeStorage, "allocWithZone:", a3), "init");
  -[HMDCHIPControllerNonResidentNodeStorage keyValueStore](self, "keyValueStore");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDCHIPControllerNonResidentNodeStorage setKeyValueStore:](v4, "setKeyValueStore:", v5);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_250358 != -1)
    dispatch_once(&logCategory__hmf_once_t3_250358, &__block_literal_global_250359);
  return (id)logCategory__hmf_once_v4_250360;
}
...
void __54__HMDCHIPControllerNonResidentNodeStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_250360;
  logCategory__hmf_once_v4_250360 = v0;
