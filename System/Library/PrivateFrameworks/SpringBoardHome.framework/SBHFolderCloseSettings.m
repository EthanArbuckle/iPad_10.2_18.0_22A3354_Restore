...
{
  SBHCrossfadeAppSuspendSettings *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  v3 = -[PTSettings initWithDefaultValues]([SBHCrossfadeAppSuspendSettings alloc], "initWithDefaultValues");
  ...
  objc_msgSend(v13, "setDelay:", 0.15);
  ...
  objc_msgSend(v16, "setCurve:", 0x20000);
