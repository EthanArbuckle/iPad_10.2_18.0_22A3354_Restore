...
LABEL_13:
      _os_log_impl(&dword_213A7E000, &v10->super, OS_LOG_TYPE_DEFAULT, v14, (uint8_t *)&v16, 0xCu);
    }
LABEL_14:
    v13 = 0;
    goto LABEL_15;
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136446722;
      ...
      v15 = 2114;
      v16 = v6;
      _os_log_impl(&dword_213A7E000, v8, OS_LOG_TYPE_DEFAULT, "%{public}s - Failed to read preferences file:  %{public}@ - Error:  %{public}@", buf, 0x20u);
  ...
  if ((v4 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136446722;
      ...
      v14 = 2114;
      v15 = v5;
      _os_log_impl(&dword_213A7E000, v6, OS_LOG_TYPE_DEFAULT, "%{public}s - Failed to save preferences file:  %{public}@ - Error:  %{public}@", buf, 0x20u);
...
- (void)raiseInvalidPropertyListObjectExceptionForObject:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136446466;
    ...
    v10 = 2114;
    v11 = v6;
    _os_log_impl(&dword_213A7E000, v7, OS_LOG_TYPE_DEFAULT, "%{public}s - Exception:  %{public}@", buf, 0x16u);
  }
...
{
  OUTLINED_FUNCTION_0_0(&dword_213A7E000, a1, a3, "%{public}s - Key is nil.", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
...
- (void)setObject:(os_log_t)log forKey:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2114;
  v6 = a2;
  _os_log_debug_impl(&dword_213A7E000, log, OS_LOG_TYPE_DEBUG, "Setting preference %{public}@:%{public}@", (uint8_t *)&v3, 0x16u);
  OUTLINED_FUNCTION_1();
}
...
{
  OUTLINED_FUNCTION_0_0(&dword_213A7E000, a1, a3, "%{public}s - Keys array pointer is nil.", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
