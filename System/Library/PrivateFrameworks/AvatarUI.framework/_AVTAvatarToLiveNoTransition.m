...
- (_AVTAvatarToLiveNoTransition)initWithModel:(id)a3 animated:(BOOL)a4 completionHandler:(id)a5 logger:(id)a6
{
  _BOOL8 v8;
  id v11;
  _AVTAvatarToLiveNoTransition *v12;
  _AVTAvatarToLiveNoTransition *v13;
  objc_super v15;
...
- (void)_startTransition
{
  ...
  -[_AVTAvatarToLiveNoTransition avatarTransitionModel](self, "avatarTransitionModel");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "transitionLiveViewToFront");

  -[_AVTAvatarToLiveNoTransition avatarTransitionModel](self, "avatarTransitionModel");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "applyFullAlpha");
