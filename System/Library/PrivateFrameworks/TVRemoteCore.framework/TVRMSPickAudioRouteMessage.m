...
- (id)description
{
  ...
  -[TVRMSPickAudioRouteMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[TVRMSPickAudioRouteMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("macAddress"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 1) != 0)
  {
    *((_QWORD *)result + 1) = self->_macAddress;
    *((_BYTE *)result + 20) |= 1u;
    has = (char)self->_has;
  }
  if ((has & 2) != 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_macAddress != *((_QWORD *)v4 + 1))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 20) & 2) == 0 || self->_sessionIdentifier != *((_DWORD *)v4 + 4))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
