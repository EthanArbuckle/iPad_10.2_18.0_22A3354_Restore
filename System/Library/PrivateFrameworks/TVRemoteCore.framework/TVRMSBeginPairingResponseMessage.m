...
- (id)description
{
  ...
  -[TVRMSBeginPairingResponseMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[TVRMSBeginPairingResponseMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("responseCode"));
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_responseCode != *((_DWORD *)v4 + 2))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
