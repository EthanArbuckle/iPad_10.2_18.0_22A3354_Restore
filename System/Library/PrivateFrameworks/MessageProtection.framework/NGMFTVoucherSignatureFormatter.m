...
{
  id v4;
  NGMFTVoucherSignatureFormatter *v5;
  void *v6;
  NSData *v7;
  NSData *v8;
  NSData *signedData;
  NGMFTVoucherSignatureFormatter *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)NGMFTVoucherSignatureFormatter;
  v5 = -[NGMFTVoucherSignatureFormatter init](&v12, sel_init);
  if (v5)
  {
    objc_msgSend(CFSTR("com.apple.FaceTime.Voucher"), "dataUsingEncoding:", 4);
