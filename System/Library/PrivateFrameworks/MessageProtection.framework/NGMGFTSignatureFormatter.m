...
{
  id v4;
  NGMGFTSignatureFormatter *v5;
  void *v6;
  NSData *v7;
  NSData *v8;
  NSData *signedData;
  NGMGFTSignatureFormatter *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)NGMGFTSignatureFormatter;
  v5 = -[NGMGFTSignatureFormatter init](&v12, sel_init);
  if (v5)
  {
    objc_msgSend(CFSTR("com.apple.FaceTime.QRKeying"), "dataUsingEncoding:", 4);
