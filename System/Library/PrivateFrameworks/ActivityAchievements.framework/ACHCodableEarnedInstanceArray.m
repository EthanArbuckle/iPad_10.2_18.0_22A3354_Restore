...
{
  id v5;
  ACHCodableEarnedInstanceArray *v6;

  v5 = a3;
  v6 = -[ACHCodableEarnedInstanceArray initWithData:]([ACHCodableEarnedInstanceArray alloc], "initWithData:", v5);
...
{
  id v4;
  ACHCodableEarnedInstanceArray *v5;
  void *v6;

  v4 = a3;
  v5 = objc_alloc_init(ACHCodableEarnedInstanceArray);
  v6 = (void *)objc_msgSend(v4, "mutableCopy");

  -[ACHCodableEarnedInstanceArray setEarnedInstances:](v5, "setEarnedInstances:", v6);
  return v5;
}
...
- (id)description
{
  ...
  -[ACHCodableEarnedInstanceArray description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ACHCodableEarnedInstanceArray dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_earnedInstances, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("earnedInstances"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[ACHCodableEarnedInstanceArray earnedInstancesCount](self, "earnedInstancesCount"))
  {
    objc_msgSend(v8, "clearEarnedInstances");
    v4 = -[ACHCodableEarnedInstanceArray earnedInstancesCount](self, "earnedInstancesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[ACHCodableEarnedInstanceArray earnedInstancesAtIndex:](self, "earnedInstancesAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addEarnedInstances:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addEarnedInstances:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)earnedInstances | v4[1])
      v6 = -[NSMutableArray isEqual:](earnedInstances, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_earnedInstances, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[ACHCodableEarnedInstanceArray addEarnedInstances:](self, "addEarnedInstances:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
