...
void __31__BTBannerUISession_invalidate__block_invoke(uint64_t a1)
{
  ...
  v2 = MEMORY[0x23B7FD6BC](*(_QWORD *)(*(_QWORD *)(a1 + 32) + 48));
  v3 = (void *)v2;
  if (v2)
...
- (void)_xpcEvent:(id)a3
{
  ...
  v16 = a3;
  if (MEMORY[0x23B7FD8CC]() == MEMORY[0x24BDACFA0])
  {
  ...
  else if (v16 == (id)MEMORY[0x24BDACF38])
  {
    ...
    v8 = MEMORY[0x23B7FD6BC](self->_actionHandler);
    v9 = (void *)v8;
    if (v8)
  ...
  else if (v16 == (id)MEMORY[0x24BDACF30])
  {
    ...
    v11 = MEMORY[0x23B7FD6BC](self->_actionHandler);
    v12 = (void *)v11;
    if (v11)
...
- (void)_xpcCompleted:(id)a3
{
  ...
  else
  {
    ...
    if (v5)
    {
      ...
      v6 = MEMORY[0x23B7FD6BC](self->_actionHandler);
      v7 = (void *)v6;
      if (v6)
...
- (void)_xpcConnectionMessage:(id)a3
{
  ...
  switch(int64)
  {
    ...
    case 1:
      ...
      v10 = MEMORY[0x23B7FD6BC](self->_actionHandler);
      v9 = (void *)v10;
      if (!v10)
        break;
    ...
    case 2:
      ...
      v12 = MEMORY[0x23B7FD6BC](self->_actionHandler);
      v9 = (void *)v12;
      if (!v12)
        break;
    ...
    case 3:
      ...
      v13 = MEMORY[0x23B7FD6BC](self->_actionHandler);
      v9 = (void *)v13;
      if (!v13)
        break;
