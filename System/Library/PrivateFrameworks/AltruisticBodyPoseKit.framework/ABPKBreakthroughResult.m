...
- (ABPKBreakthroughResult)init
{
  ...
  v2 = -[ABPKBreakthroughResult init](&v6, sel_init);
  if (v2)
  {
...
- (int)overlayResultOnImage:(__CVBuffer *)a3 withResult:(__CVBuffer *)a4 withColor:
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_210836000, v8, OS_LOG_TYPE_DEBUG, " Overlaying breakthrough results on image ", buf, 2u);
  }
