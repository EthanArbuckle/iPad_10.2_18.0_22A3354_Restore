...
{
  ABPKMLModelConfiguration2DBreakthrough *v2;
  void *v3;
  void *v4;
  uint64_t v5;
  ...
  if (v2)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", kABPK2DBreakthroughNetworkName);
...
- (id)inputTensorNames
{
  ...
  v3[0] = kABPK2DBreakthroughInputTensorName;
...
- (id)outputTensorNames
{
  ...
  v3[0] = kABPK2DBreakthroughOutputHeatmapsTensorName;
  v3[1] = kABPK2DBreakthroughOutputAffinityMapsTensorName;
...
- (CGSize)inputDimensions
{
  ...
  -[ABPKMLModelConfiguration2DBreakthrough inputDimensionsForABPKDeviceOrientation:](self, "inputDimensionsForABPKDeviceOrientation:", 3);
  result.height = v3;
  result.width = v2;
  return result;
}
