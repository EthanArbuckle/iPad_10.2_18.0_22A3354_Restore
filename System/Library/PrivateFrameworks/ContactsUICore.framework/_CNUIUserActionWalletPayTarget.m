...
- (id)actionsForPhoneNumbers:(id)a3 contact:(id)a4 discoveringEnvironment:(id)a5
{
  ...
  _QWORD v11[4];
  id v12;
  _CNUIUserActionWalletPayTarget *v13;
...
- (_CNUIUserActionWalletPayTarget)init
{
  ...
  v2 = *MEMORY[0x1E0C965F0];
  v4.receiver = self;
  v4.super_class = (Class)_CNUIUserActionWalletPayTarget;
  return -[CNUIUserActionTarget initWithName:bundleIdentifier:teamIdentifier:](&v4, sel_initWithName_bundleIdentifier_teamIdentifier_, CFSTR("Wallet"), v2, 0);
}
