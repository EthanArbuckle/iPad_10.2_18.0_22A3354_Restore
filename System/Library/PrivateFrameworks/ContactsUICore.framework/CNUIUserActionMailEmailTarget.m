...
id __90___CNUIUserActionMailEmailTarget_actionsForEmailAddresses_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99E98], "_cnui_mailURLFutureWithHandle:contact:", v7, *(_QWORD *)(a1 + 32));
    ...
    v14 = *MEMORY[0x1E0C96618];
    objc_msgSend(*(id *)(a1 + 40), "bundleIdentifier");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    +[CNUIUserActionItem itemWithType:contactProperty:bundleIdentifier:url:group:options:](CNUIUserActionItem, "itemWithType:contactProperty:bundleIdentifier:url:group:options:", v14, v13, v15, v8, 1, 0);
