...
id __90___CNUIUserActionWalletPayTarget_actionsForEmailAddresses_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99E98], "_cnui_walletPayURLFutureWithHandle:", v7);
    ...
    v14 = *MEMORY[0x1E0C96630];
    objc_msgSend(*(id *)(a1 + 40), "bundleIdentifier");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    +[CNUIUserActionItem itemWithType:contactProperty:bundleIdentifier:url:isSensitive:group:options:](CNUIUserActionItem, "itemWithType:contactProperty:bundleIdentifier:url:isSensitive:group:options:", v14, v13, v15, v8, 1, 10, 0);
