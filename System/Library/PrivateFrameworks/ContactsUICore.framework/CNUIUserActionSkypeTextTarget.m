...
id __90___CNUIUserActionSkypeTextTarget_actionsForEmailAddresses_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99E98], "_cnui_skypeTextURLFutureWithHandle:", v7);
...
id __88___CNUIUserActionSkypeTextTarget_actionsForPhoneNumbers_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99E98], "_cnui_skypeTextURLFutureWithHandle:", v8);
