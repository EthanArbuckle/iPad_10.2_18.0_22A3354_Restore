...
- (id)actionsForEmailAddresses:(id)a3 contact:(id)a4 discoveringEnvironment:(id)a5
{
  ...
  _QWORD v11[4];
  id v12;
  _CNUIUserActionStartVideoCallIntentTarget *v13;
...
- (id)actionsForSocialProfiles:(id)a3 contact:(id)a4 discoveringEnvironment:(id)a5
{
  ...
  _QWORD v13[4];
  id v14;
  _CNUIUserActionStartVideoCallIntentTarget *v15;
  _QWORD v16[5];
  ...
  v16[1] = 3221225472;
  v16[2] = __101___CNUIUserActionStartVideoCallIntentTarget_actionsForSocialProfiles_contact_discoveringEnvironment___block_invoke;
  v16[3] = &unk_1EA6031A8;
  v16[4] = self;
  ...
  v13[0] = v8;
  v13[1] = 3221225472;
  v13[2] = __101___CNUIUserActionStartVideoCallIntentTarget_actionsForSocialProfiles_contact_discoveringEnvironment___block_invoke_3;
  v13[3] = &unk_1EA603158;
  v14 = v7;
  v15 = self;
  v10 = v7;
...
- (id)actionsForInstantMessageAddresses:(id)a3 contact:(id)a4 discoveringEnvironment:(id)a5
{
  ...
  v16[0] = MEMORY[0x1E0C809B0];
  v16[1] = 3221225472;
  v16[2] = __110___CNUIUserActionStartVideoCallIntentTarget_actionsForInstantMessageAddresses_contact_discoveringEnvironment___block_invoke;
  v16[3] = &unk_1EA6031A8;
  v16[4] = self;
  objc_msgSend(a3, "_cn_filter:", v16);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v13[0] = v8;
  v13[1] = 3221225472;
  v13[2] = __110___CNUIUserActionStartVideoCallIntentTarget_actionsForInstantMessageAddresses_contact_discoveringEnvironment___block_invoke_3;
  v13[3] = &unk_1EA603158;
  v14 = v7;
  v15 = self;
  v10 = v7;
