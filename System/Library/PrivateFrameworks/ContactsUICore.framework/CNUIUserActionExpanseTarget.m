...
id __73___CNUIUserActionExpanseTarget_actionsForContact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E98], "_cnui_expanseURLFutureWithHandle:", v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = *MEMORY[0x1E0C96610];
  objc_msgSend(*(id *)(a1 + 32), "bundleIdentifier");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  +[CNUIUserActionItem itemWithType:contactProperty:bundleIdentifier:url:group:options:](CNUIUserActionItem, "itemWithType:contactProperty:bundleIdentifier:url:group:options:", v11, v3, v12, v10, 5, 0);
