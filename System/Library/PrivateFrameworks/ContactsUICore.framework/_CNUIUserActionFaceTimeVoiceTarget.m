...
- (id)actionsForContact:(id)a3 discoveringEnvironment:(id)a4
{
  ...
  void *v21;
  id v22;
  _CNUIUserActionFaceTimeVoiceTarget *v23;
  _QWORD v24[2];
...
- (_CNUIUserActionFaceTimeVoiceTarget)init
{
  ...
  return -[CNUIUserActionTarget initWithName:bundleIdentifier:teamIdentifier:](&v4, sel_initWithName_bundleIdentifier_teamIdentifier_, CFSTR("FaceTime Audio"), v2, 0);
}
