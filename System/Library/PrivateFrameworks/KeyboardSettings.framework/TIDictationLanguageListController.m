...
- (TIDictationLanguageListController)init
{
  ...
  {
    -[TIDictationLanguageListController setDictaionOfflineStatusObserver:](v2, "setDictaionOfflineStatusObserver:", -[KSDictationOfflineStatusObserver initWithDelegate:]([KSDictationOfflineStatusObserver alloc], "initWithDelegate:", v2));
...
{
  -[TIDictationLanguageListController setDictaionOfflineStatusObserver:](self, "setDictaionOfflineStatusObserver:", -[KSDictationOfflineStatusObserver initWithDelegate:]([KSDictationOfflineStatusObserver alloc], "initWithDelegate:", self));
  return 1;
}
...
- (id)dictationFooterText
{
  ...
  v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController"), "enabledDictationLanguages");
  if (v4)
    v5 = v4;
  else
  ...
  v39 = 0;
  v39 = objc_msgSend(MEMORY[0x24BDBCEF0], "set");
  v28 = 0;
  v29 = &v28;
  v30 = 0x3052000000;
  ...
  v33 = 0;
  v33 = objc_msgSend(MEMORY[0x24BDBCEF0], "set");
  v22 = 0;
  v23 = &v22;
  v24 = 0x3052000000;
  ...
  v27 = 0;
  v27 = objc_msgSend(MEMORY[0x24BDBCEF0], "set");
  v7 = -[TIDictationLanguageListController offlineStatusForLanguage](self, "offlineStatusForLanguage");
  v21[0] = MEMORY[0x24BDAC760];
  v21[1] = 3221225472;
  v21[2] = __56__TIDictationLanguageListController_dictationFooterText__block_invoke;
  v21[3] = &unk_251079A70;
  v21[4] = v6;
  v21[5] = &v28;
  v21[6] = &v34;
  v21[7] = &v22;
  -[NSDictionary enumerateKeysAndObjectsUsingBlock:](v7, "enumerateKeysAndObjectsUsingBlock:", v21);
  if (objc_msgSend((id)v29[5], "count"))
  {
    v8 = (void *)MEMORY[0x24BDD17C8];
    v9 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_HIGH_QUALITY_EXPLANATION_SUFFIX_INSTALLED_WITH_LANGUAGES"), &stru_25107A038, CFSTR("Keyboard"));
  ...
  if (objc_msgSend((id)v35[5], "count"))
  {
    ...
    v12 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_OFFLINE_EXPLANATION_SUFFIX_INSTALLED_WITH_LANGUAGES"), &stru_25107A038, CFSTR("Keyboard"));
    v13 = objc_msgSend(v11, "stringWithFormat:", v12, +[KSKeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KSKeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", objc_msgSend((id)v35[5], "allObjects"), 1, 0));
    v14 = -[__CFString length](v10, "length");
    v15 = CFSTR("\n\n");
    if (!v14)
      v15 = &stru_25107A038;
    v10 = (__CFString *)-[__CFString stringByAppendingFormat:](v10, "stringByAppendingFormat:", CFSTR("%@%@"), v15, v13);
  }
  if (objc_msgSend((id)v29[5], "count"))
    objc_msgSend(v6, "minusSet:", v29[5]);
  if (objc_msgSend((id)v35[5], "count"))
    objc_msgSend(v6, "minusSet:", v35[5]);
  if (objc_msgSend(v6, "count")
    && (!objc_msgSend(v6, "isEqual:", v23[5]) || -[__CFString length](v10, "length")))
  {
    v16 = objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ONLINE_EXPLANATION_SUFFIX_NOT_INSTALLED_WITH_LANGUAGES"), &stru_25107A038, CFSTR("Dictation")), +[KSKeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KSKeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", objc_msgSend(v6, "allObjects"), 1, 0));
    v17 = -[__CFString length](v10, "length");
    v18 = CFSTR("\n\n");
    if (!v17)
      v18 = &stru_25107A038;
    v10 = (__CFString *)-[__CFString stringByAppendingFormat:](v10, "stringByAppendingFormat:", CFSTR("%@%@"), v18, v16);
  }
  if (!-[__CFString length](v10, "length") && objc_msgSend((id)v23[5], "count"))
  {
    v19 = (void *)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v10 = (__CFString *)objc_msgSend(v19, "localizedStringForKey:value:table:", SFLocalizableWAPIStringKeyForKey(), &stru_25107A038, CFSTR("Keyboard"));
  }
...
- (id)dictationLanguagesSpecifiers
{
  ...
  if (!v18)
  {
    ...
    -[TIDictationLanguageListController setTitle:](self, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Dictation Languages"), &stru_25107A038, CFSTR("Dictation")));
    v18 = objc_alloc_init(MEMORY[0x24BDBCEB8]);
    v3 = (void *)objc_msgSend(MEMORY[0x24BEB5B00], "sharedPreferencesController");
    v4 = (void *)objc_msgSend(v3, "suggestedDictationModesForKeyboardLanguages:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController"), "activeDictationSupportedInputModeIdentifiers"));
    v5 = (id)objc_msgSend((id)objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F8], "sharedPreferencesController"), "preferencesActions"), "valueForPreferenceKey:", CFSTR("DictationLanguagesEnabled")), "mutableCopy");
    v19 = 0u;
    v20 = 0u;
    v21 = 0u;
    v22 = 0u;
...
- (id)slsDictationLanguagesSpecifiers
{
  ...
  if (!v33)
  {
    ...
    if (!objc_msgSend(v6, "count"))
      objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController"), "updateEnabledDictationLanguages:", 1);
    v36 = 0u;
    v37 = 0u;
    v34 = 0u;
    v35 = 0u;
    ...
    if ((unint64_t)objc_msgSend(v4, "count") >= 2)
    {
      if (v27 >= 2)
      {
        ...
        v16 = (void *)objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Automatic-Language-Detection"), &stru_25107A038, CFSTR("Dictation")), v32, sel_setSLSEnabled_specifier_, sel_isSLSEnabled_, 0, 6, 0);
        ...
        v21 = objc_msgSend(v19, "localizedStringForKey:value:table:", v20, &stru_25107A038, CFSTR("Dictation"));
        objc_msgSend(v15, "setProperty:forKey:", objc_msgSend(v17, "stringWithFormat:", CFSTR("%@\n\n%@"), v21, objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("SLS_EXPLANATION_SUFFIX"), &stru_25107A038, CFSTR("Dictation"))), *MEMORY[0x24BE75A68]);
        objc_msgSend(v33, "addObject:", v16);
      }
      if ((unint64_t)objc_msgSend(v4, "count") < 5)
        v22 = 0;
      else
        v22 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Dictation"), &stru_25107A038, CFSTR("Dictation"));
    ...
    {
      v25 = (void *)objc_msgSend(MEMORY[0x24BE75590], "groupSpecifierWithID:name:", CFSTR("SLS_LANGUAGES"), objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Auto-Detection"), &stru_25107A038, CFSTR("Dictation")));
      objc_msgSend(v25, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("SLS_FOOTER_TEXT"), &stru_25107A038, CFSTR("Dictation")), *MEMORY[0x24BE75A68]);
...
- (id)onDeviceDictationLanguagesSpecifiers
{
  ...
  -[TIDictationLanguageListController setTitle:](v2, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Dictation Languages"), &stru_25107A038, CFSTR("Dictation")));
...
LABEL_33:
      ...
      if (v29)
      {
        ...
        do
        {
          for (i = 0; i != v30; ++i)
          {
            ...
            {
              v36 = v35;
              v37 = +[KSWeakRefHolder weakRefHolderWithObject:](KSWeakRefHolder, "weakRefHolderWithObject:", v108);
  ...
  v49 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_ABOUT_LINK"), &stru_25107A038, CFSTR("Keyboard"));
  if (!v104)
  {
    v53 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER"), &stru_25107A038, CFSTR("Keyboard"));
    goto LABEL_68;
  }
  if (!objc_msgSend(v102, "count"))
  {
    if (v104 != 1)
    {
      ...
      if (objc_msgSend(v98, "count"))
      {
        ...
        v69 = (void *)objc_msgSend(v67, "stringWithFormat:", objc_msgSend(v68, "localizedStringForKey:value:table:", LocStringKeyBasedOnLanguageCount(CFSTR("DICTATION_ON_DEVICE_PRIVATE_PROCESSING_WITH_LANGUAGE"), objc_msgSend(v100, "count"), 0), &stru_25107A038, CFSTR("Keyboard")), +[KSKeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KSKeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v100, 1, v26));
        v52 = objc_msgSend(v69, "stringByAppendingFormat:", CFSTR(" %@"), objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER_SOMETIMES"), &stru_25107A038, CFSTR("Keyboard")));
LABEL_92:
        v54 = (void *)v52;
        v81 = (void *)MEMORY[0x24BDD17C8];
        v85 = (void *)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
        v83 = objc_msgSend(v85, "localizedStringForKey:value:table:", LocStringKeyBasedOnLanguageCount(CFSTR("DICTATION_ON_DEVICE_SUPPORT_DOWNLOADING_WITH_LANGUAGE"), objc_msgSend(v98, "count"), 0), &stru_25107A038, CFSTR("Keyboard"));
      ...
      else
      {
        ...
        if (!v77)
        {
          v91 = objc_msgSend(v79, "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_PRIVATE_PROCESSING"), &stru_25107A038, CFSTR("Keyboard"));
          ...
          v53 = objc_msgSend(v78, "stringWithFormat:", CFSTR("%@ %@"), v91, objc_msgSend(v92, "localizedStringForKey:value:table:", v93, &stru_25107A038, CFSTR("Keyboard")));
          goto LABEL_68;
        }
        v80 = (void *)objc_msgSend(v78, "stringWithFormat:", objc_msgSend(v79, "localizedStringForKey:value:table:", LocStringKeyBasedOnLanguageCount(CFSTR("DICTATION_ON_DEVICE_PRIVATE_PROCESSING_WITH_LANGUAGE"), objc_msgSend(v100, "count"), 0), &stru_25107A038, CFSTR("Keyboard")), +[KSKeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KSKeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v100, 1, v26));
        v54 = (void *)objc_msgSend(v80, "stringByAppendingFormat:", CFSTR(" %@"), objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER_SOMETIMES"), &stru_25107A038, CFSTR("Keyboard")));
        v81 = (void *)MEMORY[0x24BDD17C8];
        ...
        v83 = objc_msgSend(v82, "localizedStringForKey:value:table:", SFLocalizableWAPIStringKeyForKey(), &stru_25107A038, CFSTR("Keyboard"));
        v84 = (uint64_t)v99;
      }
      v58 = objc_msgSend(v81, "stringWithFormat:", v83, +[KSKeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KSKeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v84, 1, v26));
      goto LABEL_94;
    }
    if (objc_msgSend(v98, "count"))
    {
      v54 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER_WHEN_NECESSARY"), &stru_25107A038, CFSTR("Keyboard"));
      v56 = (void *)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v57 = CFSTR("DICTATION_ON_DEVICE_SUPPORT_DOWNLOADING");
LABEL_73:
      v58 = objc_msgSend(v56, "localizedStringForKey:value:table:", v57, &stru_25107A038, CFSTR("Keyboard"));
      goto LABEL_94;
    }
    ...
    if (!v72)
    {
      v54 = (void *)objc_msgSend(v73, "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER_WHEN_NECESSARY"), &stru_25107A038, CFSTR("Keyboard"));
      v90 = objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v57 = (const __CFString *)SFLocalizableWAPIStringKeyForKey();
      v56 = (void *)v90;
      goto LABEL_73;
    }
    v74 = (void *)objc_msgSend(v73, "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_PRIVATE_PROCESSING"), &stru_25107A038, CFSTR("Keyboard"));
    ...
    v53 = objc_msgSend(v74, "stringByAppendingFormat:", CFSTR(" %@"), objc_msgSend(v75, "localizedStringForKey:value:table:", v76, &stru_25107A038, CFSTR("Keyboard")));
LABEL_68:
    v54 = (void *)v53;
    goto LABEL_69;
  }
  if (objc_msgSend(v100, "count") || objc_msgSend(v98, "count"))
  {
    if (objc_msgSend(v98, "count"))
    {
      if (objc_msgSend(v100, "count"))
      {
        ...
        v52 = objc_msgSend(v50, "stringWithFormat:", objc_msgSend(v51, "localizedStringForKey:value:table:", LocStringKeyBasedOnLanguageCount(CFSTR("DICTATION_ON_DEVICE_PRIVATE_PROCESSING_WITH_LANGUAGE"), objc_msgSend(v100, "count"), 0), &stru_25107A038, CFSTR("Keyboard")), +[KSKeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KSKeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v100, 1, v26));
        goto LABEL_92;
      }
LABEL_91:
      v52 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER_WHEN_NECESSARY"), &stru_25107A038, CFSTR("Keyboard"));
      goto LABEL_92;
    }
...
- (id)onDeviceNotCapableDictationLanguagesSpecifiers
{
  ...
  if (!v28)
  {
    ...
    v5 = (void *)objc_msgSend(v4, "suggestedDictationModesForKeyboardLanguages:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController"), "activeDictationSupportedInputModeIdentifiers"));
    v6 = (id)objc_msgSend((id)objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F8], "sharedPreferencesController"), "preferencesActions"), "valueForPreferenceKey:", CFSTR("DictationLanguagesEnabled")), "mutableCopy");
    ...
    v14 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_ABOUT_LINK"), &stru_25107A038, CFSTR("Keyboard"));
    v15 = (void *)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER"), &stru_25107A038, CFSTR("Keyboard")), v14);
    if (!v27)
      goto LABEL_19;
    if (objc_msgSend(v25, "count"))
    {
      ...
      v18 = objc_msgSend(v16, "stringWithFormat:", objc_msgSend(v17, "localizedStringForKey:value:table:", LocStringKeyBasedOnLanguageCount(CFSTR("DICTATION_OFFLINE_EXPLANATION_SUFFIX_INSTALLED_WITH_LANGUAGE"), objc_msgSend(v25, "count"), 0), &stru_25107A038, CFSTR("Keyboard")), +[KSKeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KSKeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v25, 1, 0));
      if (!v18)
      {
LABEL_19:
    ...
    else
    {
      ...
      v18 = objc_msgSend(v22, "localizedStringForKey:value:table:", SFLocalizableWAPIStringKeyForKey(), &stru_25107A038, CFSTR("Keyboard"));
      if (!v18)
        goto LABEL_19;
    }
...
- (id)tableView:(id)a3 enhancedDictationCellForRowAtIndexPath:(id)a4
{
  ...
  v8 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F8], "sharedPreferencesController"), "preferencesActions");
  v9 = objc_msgSend((id)objc_opt_class(), "numberOfEnabledEntries:", objc_msgSend(v8, "valueForPreferenceKey:", *MEMORY[0x24BEBE110]));
  objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController");
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    v10 = (void *)objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController");
  ...
  if ((v12 & 1) != 0)
  {
    objc_msgSend((id)objc_msgSend(v6, "titleLabel"), "setTextColor:", objc_msgSend(MEMORY[0x24BEBD4B8], "labelColor"));
    objc_msgSend(v6, "setSelectionStyle:", 3);
    v13 = 0;
  }
  else
  {
    objc_msgSend((id)objc_msgSend(v6, "titleLabel"), "setTextColor:", objc_msgSend(MEMORY[0x24BEBD4B8], "secondaryLabelColor"));
    objc_msgSend(v6, "setSelectionStyle:", 0);
    v13 = objc_msgSend(MEMORY[0x24BEBD4B8], "systemGrayColor");
  }
...
- (id)tableView:(id)a3 classicDictationCellForRowAtIndexPath:(id)a4
{
  ...
  v7 = (void *)-[TIDictationLanguageListController specifierAtIndex:](self, "specifierAtIndex:", -[TIDictationLanguageListController indexForIndexPath:](self, "indexForIndexPath:", a4));
  v8 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F8], "sharedPreferencesController"), "preferencesActions");
  v9 = (void *)objc_msgSend(v8, "valueForPreferenceKey:", *MEMORY[0x24BEBE110]);
  if (!objc_msgSend(a4, "section"))
  {
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0)
    {
      v25 = (void *)objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController");
...
LABEL_29:
      ...
      objc_msgSend(v6, "setSelectionStyle:", 0);
      v29 = objc_msgSend(MEMORY[0x24BEBD4B8], "systemGrayColor");
LABEL_41:
...
- (void)toggleSLSEnabled:(id)a3
{
  ...
  if (!v15)
  {
    v16 = (void *)objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F8], "sharedPreferencesController"), "preferencesActions"), "valueForPreferenceKey:", CFSTR("DictationLanguagesEnabled"));
    if ((v6 & 1) != 0)
    {
      objc_msgSend(v5, "setChecked:", v6 ^ 1u);
      v17 = objc_msgSend(MEMORY[0x24BEBD4B8], "grayColor");
    }
    else
    {
      if (!objc_msgSend((id)objc_msgSend(v16, "objectForKeyedSubscript:", v7), "BOOLValue"))
        return;
      objc_msgSend(v5, "setChecked:", v6 ^ 1u);
      v17 = objc_msgSend(MEMORY[0x24BEBD4B8], "blackColor");
    }
...
- (void)handleSmartLanguageSelectionOnDictationLanguageToggle:(BOOL)a3 enabledDictationLanguages:(id)a4 specifier:(id)a5
{
  ...
  if (v7)
  {
    ...
    {
      v26 = (id)objc_msgSend((id)objc_msgSend(a4, "keysOfEntriesPassingTest:", &__block_literal_global_2), "mutableCopy");
      objc_msgSend(v26, "intersectSet:", objc_msgSend(v8, "keysOfEntriesPassingTest:", &__block_literal_global_322));
      objc_msgSend(v26, "removeObject:", v9);
      v27 = (void *)objc_msgSend(MEMORY[0x24BEB5B00], "sharedPreferencesController");
      v28 = (void *)objc_msgSend(v27, "suggestedDictationModesForKeyboardLanguages:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F0], "sharedInputModeController"), "activeDictationSupportedInputModeIdentifiers"));
      v38 = 0u;
      v39 = 0u;
      v40 = 0u;
      v41 = 0u;
...
- (void)toggleDictationLanguage:(id)a3
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
    objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBD6F8], "sharedPreferencesController"), "preferencesActions"), "setEnabledDictationLanguages:", v7);
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BE17D00], "sharedCloudSettingsManager"), "writeToCloudSettings:forStore:", &unk_2510837C8, CFSTR("com.apple.cloudsettings.keyboard"));
  -[TIDictationLanguageListController reloadSpecifiers](self, "reloadSpecifiers");
}
