...
- (void)dealloc
{
  ...
  -[KSAddExtensionKeyboardController dealloc](&v3, sel_dealloc);
}
...
- (id)specifiers
{
  ...
  if (!result)
  {
    result = -[KSAddExtensionKeyboardController newSpecifiers](self, "newSpecifiers");
...
- (id)newSpecifiers
{
  ...
  v20 = 0u;
  v21 = 0u;
  obj = (id)objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", CFSTR("TIKBIdentifiersKey"));
  ...
  -[KSAddExtensionKeyboardController setModuleSpecifiers:](v17, "setModuleSpecifiers:", objc_msgSend(v3, "sortedArrayUsingComparator:", &__block_literal_global_0));
  v12 = -[NSArray count](-[KSAddExtensionKeyboardController moduleSpecifiers](v17, "moduleSpecifiers"), "count");
  v17->_didRequestOpenAccess = v6;
  if (!objc_msgSend(obj, "count")
    || -[KSAddExtensionKeyboardController behavesAsModalForAddSheet](v17, "behavesAsModalForAddSheet")
    || ((v6 ^ 1) & 1) != 0)
  {
    v13 = v15;
    if (v12 >= 2)
  ...
  {
    -[KSAddExtensionKeyboardController setNetworkAccessSpecifierForKeyboardInputMode:](v17, "setNetworkAccessSpecifierForKeyboardInputMode:", objc_msgSend(obj, "firstObject"));
    v13 = v15;
    objc_msgSend(v15, "addObject:", -[KSAddExtensionKeyboardController networkAccessSpecifier](v17, "networkAccessSpecifier"));
    if (v12 >= 2)
    {
      objc_msgSend(v15, "addObject:", objc_msgSend(MEMORY[0x24BE75590], "groupSpecifierWithName:", &stru_25107A038));
LABEL_19:
      objc_msgSend(v13, "addObjectsFromArray:", -[KSAddExtensionKeyboardController moduleSpecifiers](v17, "moduleSpecifiers"));
    }
  }
  -[KSAddExtensionKeyboardController trackExtensionsContainedInApp](v17, "trackExtensionsContainedInApp");
  return v13;
}
...
- (void)trackExtensionsContainedInApp
{
  ...
  {
    v3 = (void *)objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", CFSTR("TIKBAllIdentifiersKey"));
    TIStatisticGetKey();
    ...
    if (v4)
    {
      ...
      do
      {
        for (i = 0; i != v5; ++i)
        {
          ...
          if (objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "specifiersForExtensionInputMode:parentSpecifier:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * i), -[KSAddExtensionKeyboardController specifier](self, "specifier")), "count"))
          {
            ++v6;
          }
        }
...
- (void)setPrivacyAccess:(id)a3 forSpecifier:(id)a4
{
  ...
  uint64_t v16;
  void *v17;
  KSAddExtensionKeyboardController *v18;
  uint64_t v19;
  uint64_t v20;
...
LABEL_12:
  ...
  v7 = objc_msgSend((id)-[PSSpecifier identifier](-[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier"), "identifier"), "isEqualToString:", objc_msgSend(a4, "identifier"));
  v8 = v7;
  ...
  if (v9 || !objc_msgSend(a3, "BOOLValue"))
  {
    ...
    if (v8)
    {
      -[KSAddExtensionKeyboardController setNetworkPolicyValue:](self, "setNetworkPolicyValue:", a3);
  ...
  v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("ADD_THIRD_PARTY_KEYBOARD_WARNING_TITLE"), &stru_25107A038, CFSTR("Keyboard"));
  v12 = (void *)-[KSAddExtensionKeyboardController specifier](self, "specifier");
  v13 = objc_msgSend(v10, "stringWithFormat:", v11, objc_msgSend(v12, "propertyForKey:", *MEMORY[0x24BE75D50]), v23[0], 3221225472, __66__KSAddExtensionKeyboardController_setPrivacyAccess_forSpecifier___block_invoke, &unk_2510798C8, self);
  v14 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("ADD_THIRD_PARTY_KEYBOARD_WARNING_MESSAGE"), &stru_25107A038, CFSTR("Keyboard"));
  v15 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("ADD_THIRD_PARTY_KEYBOARD_WARNING_CANCEL"), &stru_25107A038, CFSTR("Keyboard"));
  v16 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("ADD_THIRD_PARTY_KEYBOARD_WARNING_ACTION"), &stru_25107A038, CFSTR("Keyboard"));
  -[KSAddExtensionKeyboardController setNetworkAccessAlertController:](self, "setNetworkAccessAlertController:", objc_msgSend(MEMORY[0x24BEBD3B0], "alertControllerWithTitle:message:preferredStyle:", v13, v14, 1));
  -[KSAddExtensionKeyboardController setNetworkAccessAlertActionDefault:](self, "setNetworkAccessAlertActionDefault:", objc_msgSend(MEMORY[0x24BEBD3A8], "actionWithTitle:style:handler:", v16, 0, v23));
  -[KSAddExtensionKeyboardController setNetworkAccessAlertActionCancel:](self, "setNetworkAccessAlertActionCancel:", objc_msgSend(MEMORY[0x24BEBD3A8], "actionWithTitle:style:handler:", v15, 1, v23));
  -[UIAlertController addAction:](-[KSAddExtensionKeyboardController networkAccessAlertController](self, "networkAccessAlertController"), "addAction:", -[KSAddExtensionKeyboardController networkAccessAlertActionDefault](self, "networkAccessAlertActionDefault"));
  -[UIAlertController addAction:](-[KSAddExtensionKeyboardController networkAccessAlertController](self, "networkAccessAlertController"), "addAction:", -[KSAddExtensionKeyboardController networkAccessAlertActionCancel](self, "networkAccessAlertActionCancel"));
  -[KSAddExtensionKeyboardController setSpecifierForWarning:](self, "setSpecifierForWarning:", a4);
  v17 = (void *)objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
  objc_msgSend(v17, "addObserver:selector:name:object:", self, sel_didEnterBackground_, *MEMORY[0x24BEBE010], 0);
  if (objc_msgSend((id)-[KSAddExtensionKeyboardController view](self, "view"), "window"))
    v18 = self;
  else
    v18 = (KSAddExtensionKeyboardController *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBDB58], "keyWindow"), "rootViewController");
  v22 = -[KSAddExtensionKeyboardController view](v18, "view");
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BEBDB08], "_viewControllerForFullScreenPresentationFromView:", v22), "presentViewController:animated:completion:", -[KSAddExtensionKeyboardController networkAccessAlertController](self, "networkAccessAlertController"), 1, 0);
}
...
uint64_t __66__KSAddExtensionKeyboardController_setPrivacyAccess_forSpecifier___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (result)
  {
    ...
    objc_msgSend(v5, "removeObserver:name:object:", *(_QWORD *)(a1 + 32), *MEMORY[0x24BEBE010], 0);
...
- (void)didEnterBackground:(id)a3
{
  ...
  if (-[KSAddExtensionKeyboardController specifierForWarning](self, "specifierForWarning", a3))
  {
    ...
    -[UIAlertController dismissViewControllerAnimated:completion:](-[KSAddExtensionKeyboardController networkAccessAlertController](self, "networkAccessAlertController"), "dismissViewControllerAnimated:completion:", 0, 0);
    -[KSAddExtensionKeyboardController setSpecifierForWarning:](self, "setSpecifierForWarning:", 0);
    -[KSAddExtensionKeyboardController setNetworkAccessAlertController:](self, "setNetworkAccessAlertController:", 0);
    -[KSAddExtensionKeyboardController setNetworkAccessAlertActionCancel:](self, "setNetworkAccessAlertActionCancel:", 0);
    -[KSAddExtensionKeyboardController setNetworkAccessAlertActionDefault:](self, "setNetworkAccessAlertActionDefault:", 0);
  }
  v5 = -[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier");
  objc_msgSend((id)-[PSSpecifier propertyForKey:](v5, "propertyForKey:", *MEMORY[0x24BE75D18]), "reloadWithSpecifier:animated:", -[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier"), 1);
}
...
- (void)updateNetworkPolicyStateIfNecessaryForCell:(id)a3
{
  ...
  if ((id)-[PSSpecifier propertyForKey:](v5, "propertyForKey:", *MEMORY[0x24BE75D18]) == a3)
    -[KSAddExtensionKeyboardController updateNetworkPolicyState](self, "updateNetworkPolicyState");
}
...
- (void)updateNetworkPolicyState
{
  ...
  if (-[KSAddExtensionKeyboardController behavesAsModalForAddSheet](self, "behavesAsModalForAddSheet"))
  {
    LOBYTE(v3) = 0;
    goto LABEL_16;
  }
  cf = CFBundleCreate(0, (CFURLRef)objc_msgSend((id)objc_msgSend((id)objc_msgSend((id)objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", CFSTR("TIKBAllIdentifiersKey")), "firstObject"), "containingBundle"), "bundleURL"));
...
LABEL_14:
  if (cf)
    CFRelease(cf);
LABEL_16:
  v13 = -[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier");
...
- (void)setNetworkPolicyValue:(id)a3
{
  ...
  v4 = (void *)objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", CFSTR("TIKBAllIdentifiersKey"));
...
{
  -[KSAddExtensionKeyboardController updateNetworkPolicyStateIfNecessaryForCell:](self, "updateNetworkPolicyStateIfNecessaryForCell:", a4);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if (-[KSAddExtensionKeyboardController behavesAsModalForAddSheet](self, "behavesAsModalForAddSheet"))
  {
    v4 = (void *)-[KSAddExtensionKeyboardController navigationItem](self, "navigationItem");
    v5 = (void *)-[KSAddExtensionKeyboardController specifier](self, "specifier");
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  -[KSAddExtensionKeyboardController viewDidAppear:](&v4, sel_viewDidAppear_, a3);
  -[KSAddExtensionKeyboardController updateDoneButton](self, "updateDoneButton");
}
...
- (id)selectedInputModes
{
  ...
  v3 = (void *)objc_msgSend(MEMORY[0x24BDBCEB8], "array");
  if (-[NSArray count](-[KSAddExtensionKeyboardController moduleSpecifiers](self, "moduleSpecifiers"), "count") > 1)
  {
    v16 = 0u;
    v17 = 0u;
    v14 = 0u;
    v15 = 0u;
    v5 = -[KSAddExtensionKeyboardController moduleSpecifiers](self, "moduleSpecifiers", 0);
  ...
  {
    v4 = -[NSArray firstObject](-[KSAddExtensionKeyboardController moduleSpecifiers](self, "moduleSpecifiers"), "firstObject");
...
- (void)addCheckedInputModes
{
  ...
  v4 = -[KSAddExtensionKeyboardController selectedInputModes](self, "selectedInputModes");
  if (objc_msgSend(v4, "count"))
  {
    +[KSKeyboardListController setInputModes:](KSKeyboardListController, "setInputModes:", objc_msgSend(v3, "arrayByAddingObjectsFromArray:", v4));
    if (TIStatisticShouldSample())
    {
...
{
  if (-[KSAddExtensionKeyboardController behavesAsModalForAddSheet](self, "behavesAsModalForAddSheet"))
    objc_msgSend((id)objc_msgSend((id)-[KSAddExtensionKeyboardController navigationItem](self, "navigationItem"), "rightBarButtonItem"), "setEnabled:", objc_msgSend(-[KSAddExtensionKeyboardController selectedInputModes](self, "selectedInputModes"), "count") != 0);
}

- (void)cancelButtonTapped
{
  objc_msgSend((id)-[KSAddExtensionKeyboardController parentController](self, "parentController"), "dismiss");
}

- (void)doneButtonTapped
{
  -[KSAddExtensionKeyboardController addCheckedInputModes](self, "addCheckedInputModes");
  objc_msgSend((id)-[KSAddExtensionKeyboardController parentController](self, "parentController"), "dismissForDone");
}
