...
{
  id v4;
  KSDictationOfflineStatusObserver *v5;
  KSDictationOfflineStatusObserver *v6;
  __CFNotificationCenter *DarwinNotifyCenter;
  int v8;
  CFStringRef *v9;
  _QWORD block[4];
  KSDictationOfflineStatusObserver *v12;
  objc_super v13;

  v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)KSDictationOfflineStatusObserver;
  v5 = -[KSDictationOfflineStatusObserver init](&v13, sel_init);
  v6 = v5;
  if (v5)
  {
    -[KSDictationOfflineStatusObserver setDelegate:](v5, "setDelegate:", v4);
...
- (void)dealloc
{
  ...
  -[KSDictationOfflineStatusObserver dealloc](&v6, sel_dealloc);
}

- (KSDictationOfflineStatusObserverDelegate)delegate
{
  return (KSDictationOfflineStatusObserverDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
