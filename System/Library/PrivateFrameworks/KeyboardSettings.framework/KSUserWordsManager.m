...
{
  KSUserWordsManager *v2;
  __CFNotificationCenter *DarwinNotifyCenter;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)KSUserWordsManager;
  v2 = -[KSUserWordsManager init](&v5, sel_init);
  if (v2)
  {
...
- (void)dealloc
{
  ...
  -[KSUserWordsManager dealloc](&v4, sel_dealloc);
}
...
- (NSArray)entries
{
  ...
  if (!result)
  {
    -[KSUserWordsManager setCache:](self, "setCache:", -[_KSTextReplacementClientStore textReplacementEntries](self->_textReplacementStore, "textReplacementEntries"));
    return self->_cache;
  }
  return result;
}
...
- (void)requestSync
{
  -[_KSTextReplacementClientStore requestSyncWithCompletionBlock:](self->_textReplacementStore, "requestSyncWithCompletionBlock:", &__block_literal_global_4);
}
...
- (void)notifyObserversOfChange
{
  ...
  -[KSUserWordsManager setCache:](self, "setCache:", 0);
  v10 = 0u;
  v11 = 0u;
  v8 = 0u;
  v9 = 0u;
