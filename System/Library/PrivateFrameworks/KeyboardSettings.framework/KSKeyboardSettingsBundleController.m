...
- (id)keyboardsValue:(id)a3
{
  ...
  v3 = +[KSKeyboardListController count](KSKeyboardListController, "count", a3);
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("KEYBOARD_COUNT"), &stru_25107A038, CFSTR("Keyboard")), objc_msgSend(MEMORY[0x24BDD16F0], "localizedStringFromNumber:numberStyle:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", v3), 1));
}
...
- (id)specifiersWithSpecifier:(id)a3
{
  ...
  if (objc_msgSend((id)objc_msgSend(a3, "propertyForKey:", *MEMORY[0x24BE75AC0]), "isEqualToString:", CFSTR("General")))
  {
    ...
    v7 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Keyboard"), &stru_25107A038, CFSTR("Keyboard"));
...
LABEL_10:
  ...
  if (objc_msgSend((id)objc_msgSend(a3, "propertyForKey:", v5), "isEqualToString:", CFSTR("Keyboard")))
  {
    ...
    v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("KEYBOARDS"), &stru_25107A038, CFSTR("Keyboard"));
...
LABEL_9:
  ...
  if (objc_msgSend(+[TIKeyboardExtensionController keyboardsForBundleID:](TIKeyboardExtensionController, "keyboardsForBundleID:", v13), "count"))
  {
    ...
    v15 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("KEYBOARDS"), &stru_25107A038, CFSTR("Keyboard"));
    ...
    v17 = objc_msgSend(MEMORY[0x24BEBD640], "imageNamed:inBundle:", CFSTR("KeyboardSettings"), objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()));
...
- (void)dealloc
{
  ...
  -[KSKeyboardSettingsBundleController dealloc](&v3, sel_dealloc);
}
