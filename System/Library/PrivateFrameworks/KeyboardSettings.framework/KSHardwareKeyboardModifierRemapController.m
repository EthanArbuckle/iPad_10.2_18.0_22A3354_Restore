...
- (id)specifiers
{
  ...
  if (!v4)
  {
    v5 = -[KSHardwareKeyboardModifierRemapController newSpecifiers](self, "newSpecifiers");
...
- (id)subtitleForSpecifier:(id)a3
{
  ...
  -[KSHardwareKeyboardModifierRemapController valueForRemappingKey:](self, "valueForRemappingKey:", v4);
...
- (void)dealloc
{
  ...
  -[KSHardwareKeyboardModifierRemapController dealloc](&v4, sel_dealloc);
}
...
- (void)reloadSpecifiersWithAnimation
{
  ...
  -[KSHardwareKeyboardModifierRemapController specifiers](self, "specifiers");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  v3 = -[KSHardwareKeyboardModifierRemapController newSpecifiers](self, "newSpecifiers");
  -[KSHardwareKeyboardModifierRemapController updateSpecifiersInRange:withSpecifiers:](self, "updateSpecifiersInRange:withSpecifiers:", 0, objc_msgSend(v4, "count"), v3);

}

- (void)loadKeyboards
{
  KSHardwareKeyboardModifierRemapController *v2;
  ...
  objc_msgSend(MEMORY[0x24BDBCEB8], "array", self);
  ...
  v38 = 0u;
  obj = v5;
  v28 = -[__CFArray countByEnumeratingWithState:objects:count:](obj, "countByEnumeratingWithState:objects:count:", &v37, v48, 16);
  if (v28)
  {
    v27 = *(_QWORD *)v38;
    do
    {
      for (i = 0; i != v28; ++i)
      {
        ...
        v6 = *(__IOHIDServiceClient **)(*((_QWORD *)&v37 + 1) + 8 * i);
        v31 = (void *)IOHIDServiceClientCopyProperty(v6, CFSTR("DeviceUsagePairs"));
        objc_opt_class();
          ...
          if (v8)
          {
            ...
            while (2)
            {
              for (j = 0; j != v8; ++j)
              {
                ...
                v11 = *(void **)(*((_QWORD *)&v33 + 1) + 8 * j);
                objc_opt_class();
                if ((objc_opt_isKindOfClass() & 1) != 0)
                {
                  objc_msgSend(v11, "objectForKey:", CFSTR("DeviceUsagePage"));
                  v12 = (void *)objc_claimAutoreleasedReturnValue();
                  objc_msgSend(v11, "objectForKey:", CFSTR("DeviceUsage"));
                  v13 = (void *)objc_claimAutoreleasedReturnValue();
                  if (objc_msgSend(v12, "isEqual:", &unk_251083A98)
                    && objc_msgSend(v13, "isEqual:", &unk_251083AB0))
                  {
...
LABEL_23:
  ...
  {
    if (!v24[175] || (objc_msgSend(v25, "containsObject:") & 1) == 0)
    {
...
LABEL_33:
  ...
  else
  {
    ...
    if (v17 && v17 != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      objc_msgSend(v19, "objectAtIndex:", v17 - 1);
      v14 = (void *)objc_claimAutoreleasedReturnValue();

      objc_msgSend(v24, "navigationController");
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      v21 = (id)objc_msgSend(v20, "popToViewController:animated:", v14, 1);
...
- (void)resetRemapping
{
  ...
  -[KSHardwareKeyboardModifierRemapController saveRemapping](self, "saveRemapping");
  -[KSHardwareKeyboardModifierRemapController reloadSpecifiers](self, "reloadSpecifiers");
}
...
- (void)loadRemapping
{
  ...
  if (initializeDictionaries_onceToken != -1)
    dispatch_once(&initializeDictionaries_onceToken, &__block_literal_global_3);
  -[KSHardwareKeyboardModifierRemapController loadKeyboards](self, "loadKeyboards");
...
- (void)saveRemapping
{
  ...
  void *v46;
  void *v47;
  KSHardwareKeyboardModifierRemapController *v48;
  void *v49;
  uint64_t v50;
  void *v51;
...
- (id)newSpecifiers
{
  ...
  -[KSHardwareKeyboardModifierRemapController loadRemapping](self, "loadRemapping");
  v3 = objc_alloc_init(MEMORY[0x24BDBCEB8]);
  if (-[NSMutableArray count](self->_keyboards, "count"))
  {
    -[KSHardwareKeyboardModifierRemapController keyboardsSectionSpecifiers](self, "keyboardsSectionSpecifiers");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "addObjectsFromArray:", v4);

    -[KSHardwareKeyboardModifierRemapController keysSectionSpecifiers](self, "keysSectionSpecifiers");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("MODIFIER_KEYS_RESTORE_DEFAULTS"), &stru_25107A038, CFSTR("Keyboard"));
...
- (id)keysSectionSpecifiers
{
  ...
  if (self->_currentKeyboard)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("MODIFIER_KEYS_FOOTER_TEXT"), &stru_25107A038, CFSTR("Keyboard"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  -[KSHardwareKeyboardModifierRemapController tableView:cellForRowAtIndexPath:](&v15, sel_tableView_cellForRowAtIndexPath_, a3, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    -[KSHardwareKeyboardModifierRemapController specifierAtIndexPath:](self, "specifierAtIndexPath:", v6);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[KSHardwareKeyboardModifierRemapController subtitleForSpecifier:](self, "subtitleForSpecifier:", v8);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  else
  {
    ...
    -[KSHardwareKeyboardModifierRemapController tableView:didSelectRowAtIndexPath:](&v10, sel_tableView_didSelectRowAtIndexPath_, v6, v7);
  }
