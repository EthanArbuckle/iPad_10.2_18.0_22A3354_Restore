...
- (id)subtitle
{
  ...
  if (-[UIKeyboardInputMode isExtensionInputMode](-[KSInputModeTableCell inputMode](self, "inputMode"), "isExtensionInputMode"))
  {
    ...
    return -[KSInputModeTableCell subtitle](&v15, sel_subtitle);
  }
  else
  {
    v4 = (void *)-[UIKeyboardInputMode identifier](-[KSInputModeTableCell inputMode](self, "inputMode"), "identifier");
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
...
LABEL_5:
      ...
      while (1)
      {
        ...
        if (v7 == ++v10)
        {
          ...
          if (v7)
            goto LABEL_5;
          return +[KSKeyboardListController displayNameForHardwareLayout:inputMode:](KSKeyboardListController, "displayNameForHardwareLayout:inputMode:", v8, -[KSInputModeTableCell inputMode](self, "inputMode"));
        }
      }
    }
    else
