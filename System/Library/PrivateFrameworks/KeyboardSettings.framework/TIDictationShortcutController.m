...
- (id)specifiers
{
  ...
  if (!v3)
  {
    ...
    v5 = (void *)objc_msgSend(MEMORY[0x24BE75590], "groupSpecifierWithName:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_SHORTCUT_EXPLANATION"), &stru_25107A038, CFSTR("Dictation")));
    ...
    objc_msgSend(v6, "setProperty:forKey:", &unk_251083A50, *MEMORY[0x24BE759E0]);
    ...
    objc_msgSend(v11, "setProperty:forKey:", &unk_251083A50, v10);
    objc_msgSend(v3, "addObject:", v11);
    v13 = (void *)objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Command"), &stru_25107A038, CFSTR("Keyboard")), self, 0, 0, 0, 3, 0);
    objc_msgSend(v13, "setProperty:forKey:", CFSTR("command"), v12);
    objc_msgSend(v13, "setProperty:forKey:", &unk_251083A68, v10);
    objc_msgSend(v3, "addObject:", v13);
    v14 = (void *)objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("NO_SHORTCUT"), &stru_25107A038, CFSTR("Keyboard")), self, 0, 0, 0, 3, 0);
    objc_msgSend(v14, "setProperty:forKey:", CFSTR("noshortcut"), v12);
    objc_msgSend(v14, "setProperty:forKey:", &unk_251083A80, v10);
...
+ (id)attributedTitleForDictationShortcutValue:(int64_t)a3
{
  ...
  if (a3)
    ...
    v6 = CFSTR("control");
  return +[KSKeyboardListController attributedTitleForSymbolName:cellTitle:](KSKeyboardListController, "attributedTitleForSymbolName:cellTitle:", v6, objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", v5, &stru_25107A038, CFSTR("Keyboard")));
}
