...
- (UIEditUserWordController)initWithText:(id)a3
{
  ...
  v4 = -[KSEditUserWordController init](&v6, sel_init);
  if (v4)
  {
    -[KSEditUserWordController setDictionaryController:](v4, "setDictionaryController:", objc_alloc_init(KSUserWordsManager));
    -[KSEditUserWordController setTarget:](v4, "setTarget:", a3);
  }
  return v4;
}
...
- (UIEditUserWordController)initWithText:(id)a3 andShortcut:(id)a4
{
  ...
  v6 = -[KSEditUserWordController init](&v8, sel_init);
  if (v6)
  {
    -[KSEditUserWordController setDictionaryController:](v6, "setDictionaryController:", objc_alloc_init(KSUserWordsManager));
    -[KSEditUserWordController setTarget:](v6, "setTarget:", a3);
    -[KSEditUserWordController setShortcut:](v6, "setShortcut:", a4);
  }
  return v6;
}
...
- (void)viewDidLoad
{
  ...
  -[KSEditUserWordController viewDidLoad](&v9, sel_viewDidLoad);
  objc_msgSend((id)-[UIEditUserWordController navigationItem](self, "navigationItem"), "setLeftBarButtonItem:", (id)objc_msgSend(objc_alloc(MEMORY[0x24BEBD410]), "initWithBarButtonSystemItem:target:action:", 1, self, sel__dismiss));
