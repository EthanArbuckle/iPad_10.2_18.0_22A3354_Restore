...
{
  IMTrimDatabaseToMessageCount *result;
  objc_super v7;
...
{
  _IMDSqlOperationBeginQuery((uint64_t)a3, (CFStringRef)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("INSERT INTO message SELECT %@ from source.message ORDER BY DATE DESC LIMIT ?;"),
