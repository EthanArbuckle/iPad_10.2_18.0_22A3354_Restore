...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.CarPlayApp.in-call");
}
...
void __44__CRSInCallAssertionSpecification_interface__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BE0BE50], "protocolForProtocol:", &unk_254B487C8);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setServer:", v2);

  objc_msgSend(MEMORY[0x24BE0BE50], "protocolForProtocol:", &unk_254B48920);
