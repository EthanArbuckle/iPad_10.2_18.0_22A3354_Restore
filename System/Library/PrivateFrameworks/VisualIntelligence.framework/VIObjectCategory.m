...
- (VIObjectCategory)initWithKnowledgeGraphID:(id)a3 labelDebugDescription:(id)a4
{
  ...
  v8 = -[VIObjectCategory init](&v14, sel_init);
  if (v8)
  {
...
- (VIObjectCategory)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[VIObjectCategory init](self, "init");
  if (v5)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    v6 = v5;
    knowledgeGraphID = self->_knowledgeGraphID;
    -[VIObjectCategory knowledgeGraphID](v6, "knowledgeGraphID");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (VIObjectIsEqual((unint64_t)knowledgeGraphID, (uint64_t)v8))
    {
      labelDebugDescription = self->_labelDebugDescription;
      -[VIObjectCategory labelDebugDescription](v6, "labelDebugDescription");
