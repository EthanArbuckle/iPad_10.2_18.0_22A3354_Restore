...
- (VIRegionalAnnotation)initWithLabel:(id)a3 normalizedBoundingBox:(CGRect)a4 confidence:(float)a5
{
  ...
  v12 = -[VIRegionalAnnotation init](&v16, sel_init);
  if (v12)
  {
...
- (BOOL)isEqual:(id)a3
{
  VIRegionalAnnotation *v4;
  VIRegionalAnnotation *v5;
  VIRegionalAnnotation *v6;
  float confidence;
  float v8;
  CGFloat v9;
  CGFloat v10;
  ...
  else
  {
    ...
    -[VIRegionalAnnotation confidence](v6, "confidence");
    if (confidence == v8
      && (-[VIRegionalAnnotation normalizedBoundingBox](v6, "normalizedBoundingBox"),
          v17.origin.x = v9,
          v17.origin.y = v10,
          v17.size.width = v11,
          v17.size.height = v12,
    ...
    {
      label = self->_label;
      -[VIRegionalAnnotation label](v6, "label");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      IsEqual = VIObjectIsEqual((unint64_t)label, (uint64_t)v14);
...
- (unint64_t)hash
{
  ...
  if (v42 < 0.0)
    ...
    v47 = v45;
  return v23 ^ v11 ^ v31 ^ v39 ^ v47 ^ -[NSString hash](self->_label, "hash");
}
