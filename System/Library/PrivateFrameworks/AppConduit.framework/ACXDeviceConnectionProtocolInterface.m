...
{
  ACXDeviceConnectionProtocolInterface *result;
...
+ (void)configureInterface:(id)a3
{
  ...
  objc_msgSend(v4, "setClasses:forSelector:argumentIndex:ofReply:", v7, sel_fetchLocalizedValuesFromAllDevicesForInfoPlistKeys_forAppWithBundleID_fetchingFirstMatchingLocalizationInList_completion_, 0, 1);
