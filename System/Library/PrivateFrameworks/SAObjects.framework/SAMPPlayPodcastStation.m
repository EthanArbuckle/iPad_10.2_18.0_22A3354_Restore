...
- (id)encodedClassName
{
  return CFSTR("PlayPodcastStation");
}
...
{
  return (SAMPPodcastStation *)AceObjectAceObjectForProperty(self, (uint64_t)CFSTR("station"));
}

- (void)setStation:(id)a3
{
  AceObjectSetAceObjectForProperty(self, CFSTR("station"), a3);
}
