...
- (id)_accessQueue_buildIdentityForVersion:(unint64_t)a3 supplement:(unint64_t)a4
{
  ...
  if (a4)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("descriptors don't support multiple supplements : provider=%@ descriptor=%@ role=%@ posterUUID=%@ version=%llu supplement=%llu"), v8, v9, v11, v10, a3, a4);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
      -[PBFPosterDescriptorStoreCoordinator _accessQueue_buildIdentityForVersion:supplement:].cold.2(a2);
LABEL_12:
  ...
  if (!v8 || !v9 || !v10 || !v11)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("descriptors missing component : provider=%@ descriptor=%@ role=%@ posterUUID=%@ version=%llu supplement=%llu"), v8, v9, v11, v10, a3, 0);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
      -[PBFPosterDescriptorStoreCoordinator _accessQueue_buildIdentityForVersion:supplement:].cold.1(a2);
    goto LABEL_12;
  }
  objc_msgSend(MEMORY[0x1E0D7F8E0], "descriptorIdentityWithProvider:identifier:role:posterUUID:version:", v8, v9, v11, v10, a3);
