...
- (void)scene:(id)a3 willConnectToSession:(id)a4 options:(id)a5
{
  ...
  id v9;
  id v10;
  _TtC11PosterBoard39InlineComplicationSnapshotSceneDelegate *v11;
...
{
  id v4;
  _TtC11PosterBoard39InlineComplicationSnapshotSceneDelegate *v5;
...
- (_TtC11PosterBoard39InlineComplicationSnapshotSceneDelegate)init
{
  ...
  *(Class *)((char *)&self->super.super.isa
  ...
  return -[InlineComplicationSnapshotSceneDelegate init](&v3, sel_init);
}
