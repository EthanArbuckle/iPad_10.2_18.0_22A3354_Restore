...
- (CLIndoorAvailabilityTileParams)initWithAvailabilityTile:(void *)a3
{
  ...
  v4 = -[CLIndoorAvailabilityTileParams init](&v8, sel_init);
  if (!v4)
    return (CLIndoorAvailabilityTileParams *)v4;
  *((double *)v4 + 50) = sub_216468F4C((uint64_t)a3);
  *((float *)v4 + 84) = sub_216468F18((uint64_t)a3);
  *((_DWORD *)v4 + 85) = sub_216468F30((uint64_t)a3);
  *((_DWORD *)v4 + 86) = sub_21646900C((uint64_t)a3);
  *((_DWORD *)v4 + 87) = sub_216457674((uint64_t)a3);
  *((_DWORD *)v4 + 88) = sub_216469018((uint64_t)a3);
  v5 = sub_216468F3C((uint64_t)a3);
  v4[328] = v5;
  if (v5)
  {
    sub_2164A5FE8((uint64_t)a3, (uint64_t)&v9);
    v6 = v15;
    v4[329] = v15 & 1;
    if ((v6 & 1) != 0)
    {
...
LABEL_7:
  ...
  *(_DWORD *)(v4 + 329) = 0;
  *((_DWORD *)v4 + 93) = sub_216468F24((uint64_t)a3);
  v4[333] = sub_216468FFC((uint64_t)a3);
  *((float *)v4 + 94) = sub_216468F0C((uint64_t)a3);
  *((_DWORD *)v4 + 95) = sub_216457C4C((uint64_t)a3);
  *((_DWORD *)v4 + 96) = sub_216457A0C((uint64_t)a3);
  *((_DWORD *)v4 + 97) = sub_216457818((uint64_t)a3);
  *((_DWORD *)v4 + 98) = sub_2164573A8((uint64_t)a3);
  sub_216469024((uint64_t)a3, &v9);
  if (!v4[8])
  {
    if (!(_BYTE)v9)
      return (CLIndoorAvailabilityTileParams *)v4;
    sub_21645A980((uint64_t)(v4 + 16), (uint64_t)&v10);
    v4[8] = 1;
    if (!(_BYTE)v9)
      return (CLIndoorAvailabilityTileParams *)v4;
LABEL_21:
  ...
  if (!(_BYTE)v9)
    sub_21645F900((_QWORD *)v4 + 2);
  sub_216468CD8((uint64_t)(v4 + 16), (uint64_t)&v10);
  if ((_BYTE)v9)
    goto LABEL_21;
  return (CLIndoorAvailabilityTileParams *)v4;
}
...
- (void).cxx_destruct
{
  if (self->_optionalParams.m_initialized)
    sub_21645F900((a8 *)((char *)&self->_optionalParams.m_storage.dummy_.aligner_ + 7));
}
...
- (CLIndoorAvailabilityTileParams)init
{
  ...
  return -[CLIndoorAvailabilityTileParams init](&v3, sel_init);
}
...
- (optional<proto::params::LocalizerParameters>)localizerParams
{
  ...
  *v2 = 0;
  if (self->_optionalParams.m_initialized)
  {
    self = (CLIndoorAvailabilityTileParams *)sub_21645A980((uint64_t)(v2 + 8), (uint64_t)&self->_optionalParams.m_storage.dummy_.aligner_ + 7);
    *v3 = 1;
  }
