...
{
  return (NSString *)-[SBAbstractDefaults descriptionWithMultilinePrefix:](self, "descriptionWithMultilinePrefix:", 0);
}
...
- (id)succinctDescription
{
  ...
  -[SBAbstractDefaults succinctDescriptionBuilder](self, "succinctDescriptionBuilder");
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  ...
  -[SBAbstractDefaults descriptionBuilderWithMultilinePrefix:](self, "descriptionBuilderWithMultilinePrefix:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  ...
  -[SBAbstractDefaults succinctDescriptionBuilder](self, "succinctDescriptionBuilder", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
