...
{
  if (qword_1EF921298 != -1)
    dispatch_once(&qword_1EF921298, &unk_1E82966F8);
  return (id)qword_1EF921290;
}
...
- ($AA6A45B2DFCED8527C3A0E9A46B0D48F)processIncomingExpressions:(SEL)a3
{
  ...
  *(_OWORD *)&retstr->var6 = 0u;
  ...
  v99 = 0u;
  v100 = 0u;
  v71 = objc_msgSend(&unk_1E829BA60, "countByEnumeratingWithState:objects:count:", &v99, v103, 16);
  if (v71)
  {
    v65 = *(_QWORD *)v100;
    v69 = v5;
    ...
    do
    {
      ...
      {
        if (*(_QWORD *)v100 != v65)
          objc_enumerationMutation(&unk_1E829BA60);
        ...
        -[CVAMotionTrackingExpressionConfiguration_Exclave previousExpressions](self, "previousExpressions");
        -[CVAMotionTrackingExpressionConfiguration_Exclave previousExpressions](self, "previousExpressions");
        -[CVAMotionTrackingExpressionConfiguration_Exclave previousExpressions](self, "previousExpressions");
        -[CVAMotionTrackingExpressionConfiguration_Exclave previousExpressions](self, "previousExpressions");
        -[CVAMotionTrackingExpressionConfiguration_Exclave previousExpressions](self, "previousExpressions");
  ...
  v88[1] = v62;
  return ($AA6A45B2DFCED8527C3A0E9A46B0D48F *)-[CVAMotionTrackingExpressionConfiguration_Exclave setPreviousExpressions:](self, "setPreviousExpressions:", v88);
}
