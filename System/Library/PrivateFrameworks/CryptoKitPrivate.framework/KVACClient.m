...
{
  return (_TtC16CryptoKitPrivate10KVACClient *)sub_1D2C62FA4((uint64_t)self, (uint64_t)a2, a3, (uint64_t)a4, (uint64_t (*)(uint64_t, uint64_t))KVACClient.init(tokenChallenge:));
}
...
- (id)makeRequestAndReturnError:(id *)a3
{
  ...
  void *v7;
  void *v8;
  _TtC16CryptoKitPrivate10KVACClient *v9;
  void *v10;
  void *v11;
  void *v12;
  void *v13;
  ...
  v9 = self;
  sub_1D2C5E488(v3, v4, v5, (uint64_t)v6, v7, v8);
  v11 = v10;
  v13 = v12;
  v15 = v14;
  v17 = v16;
  v18 = objc_allocWithZone((Class)type metadata accessor for KVACRequestWrapper());
  v19 = sub_1D2C5F014(v11, v13, v15, v17);
...
- (id)makeCredentialWithIssuance:(id)a3 request:(id)a4 error:(id *)a5
{
  ...
  v8 = a4;
  v9 = self;
  v10 = sub_1D2C61564((uint64_t)v7, (uint64_t)v8);
...
{
  _TtC16CryptoKitPrivate10KVACClient *result;
...
- (void).cxx_destruct
{
  ...
  v6 = *(id *)&self->client[OBJC_IVAR____TtC16CryptoKitPrivate10KVACClient_client];
