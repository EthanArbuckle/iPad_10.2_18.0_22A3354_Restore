...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("InferredMode"));
}

- (BMInferredModeStream)init
{
  BMInferredModeStream *v2;
  ...
  v2 = -[BMInferredModeStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMInferredModeStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMInferredModeStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
