...
- (id)description
{
  ...
  -[BMPBNewsArticleViewEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBNewsArticleViewEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (publication)
    objc_msgSend(v4, "setObject:forKey:", publication, CFSTR("publication"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v12;
  ...
  v14 = -[NSString copyWithZone:](self->_summary, "copyWithZone:", a3);
  v15 = *(void **)(v5 + 56);
  *(_QWORD *)(v5 + 56) = v14;

  v16 = -[NSString copyWithZone:](self->_publication, "copyWithZone:", a3);
  v17 = *(void **)(v5 + 48);
  *(_QWORD *)(v5 + 48) = v16;

  v18 = -[NSString copyWithZone:](self->_contentProtection, "copyWithZone:", a3);
  v19 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v18;

  v20 = -[NSString copyWithZone:](self->_personaId, "copyWithZone:", a3);
  v21 = *(void **)(v5 + 40);
  *(_QWORD *)(v5 + 40) = v20;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_23;
  uniqueId = self->_uniqueId;
  if ((unint64_t)uniqueId | *((_QWORD *)v4 + 9))
  {
...
LABEL_23:
  ...
  summary = self->_summary;
  if ((unint64_t)summary | *((_QWORD *)v4 + 7))
  {
    if (!-[NSString isEqual:](summary, "isEqual:"))
      goto LABEL_23;
  }
  publication = self->_publication;
  if ((unint64_t)publication | *((_QWORD *)v4 + 6))
  {
...
- (unint64_t)hash
{
  ...
  v12 = v11 ^ -[NSString hash](self->_summary, "hash");
  v13 = v10 ^ v12 ^ -[NSString hash](self->_publication, "hash");
...
{
  objc_storeStrong((id *)&self->_publication, a3);
}
