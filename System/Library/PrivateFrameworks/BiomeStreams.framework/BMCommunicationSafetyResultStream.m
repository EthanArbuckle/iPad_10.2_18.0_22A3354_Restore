...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("CommunicationSafetyResult"));
}

- (BMCommunicationSafetyResultStream)init
{
  BMCommunicationSafetyResultStream *v2;
  ...
  v2 = -[BMCommunicationSafetyResultStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMCommunicationSafetyResultStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMCommunicationSafetyResultStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
