...
- (id)description
{
  ...
  -[BMPBGameControllerEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBGameControllerEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("isControllerConnected"));

    has = (char)self->_has;
  }
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_numberOfControllersConnected);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("numberOfControllersConnected"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((_BYTE *)result + 12) = self->_isControllerConnected;
    *((_BYTE *)result + 16) |= 2u;
    has = (char)self->_has;
  }
  if ((has & 1) != 0)
...
LABEL_10:
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_numberOfControllersConnected != *((_DWORD *)v4 + 2))
      goto LABEL_14;
    v5 = 1;
  }
LABEL_15:
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_isControllerConnected = *((_BYTE *)v4 + 12);
    *(_BYTE *)&self->_has |= 2u;
    v5 = *((_BYTE *)v4 + 16);
  }
  if ((v5 & 1) != 0)
