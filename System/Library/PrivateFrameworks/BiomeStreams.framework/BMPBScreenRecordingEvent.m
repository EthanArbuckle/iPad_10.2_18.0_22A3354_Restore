...
- (id)description
{
  ...
  -[BMPBScreenRecordingEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBScreenRecordingEvent dictionaryRepresentation](self, "dictionaryRepresentation");
