...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("CommunicationSafetyResultWithoutImage"));
}

- (BMCommunicationSafetyResultWithoutImageStream)init
{
  BMCommunicationSafetyResultWithoutImageStream *v2;
  ...
  v2 = -[BMCommunicationSafetyResultWithoutImageStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMCommunicationSafetyResultWithoutImageStream identifier](v2, "identifier");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = -[BMRestrictedStream initWithIdentifier:eventDataClass:](v3, "initWithIdentifier:eventDataClass:", v4, NSClassFromString(CFSTR("_BMCommunicationSafetyResultWithoutImageEvent")));
    stream = v2->_stream;
...
- (id)publisher
{
  ...
  -[BMCommunicationSafetyResultWithoutImageStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
