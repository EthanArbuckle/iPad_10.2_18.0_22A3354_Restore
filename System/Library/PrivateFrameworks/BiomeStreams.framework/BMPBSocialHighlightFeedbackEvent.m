...
- (id)description
{
  ...
  -[BMPBSocialHighlightFeedbackEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBSocialHighlightFeedbackEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (highlight)
  {
    -[BMPBRankableSocialHighlight dictionaryRepresentation](highlight, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v6;
  ...
  v9 = -[BMPBRankableSocialHighlight copyWithZone:](self->_highlight, "copyWithZone:", a3);
  v10 = *(void **)(v5 + 40);
  *(_QWORD *)(v5 + 40) = v9;

  v11 = -[NSString copyWithZone:](self->_clientVariant, "copyWithZone:", a3);
  v12 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v11;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 48) & 2) == 0 || self->_feedbackType != *((_DWORD *)v4 + 8))
      goto LABEL_18;
  }
...
LABEL_18:
  ...
  highlight = self->_highlight;
  if ((unint64_t)highlight | *((_QWORD *)v4 + 5)
    && !-[BMPBRankableSocialHighlight isEqual:](highlight, "isEqual:"))
  {
    goto LABEL_18;
  }
  clientVariant = self->_clientVariant;
  if ((unint64_t)clientVariant | *((_QWORD *)v4 + 3))
    v8 = -[NSString isEqual:](clientVariant, "isEqual:");
  else
    v8 = 1;
LABEL_19:
...
LABEL_11:
  v10 = v4 ^ v3 ^ v9 ^ -[BMPBRankableSocialHighlight hash](self->_highlight, "hash");
  return v10 ^ -[NSString hash](self->_clientVariant, "hash");
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_feedbackType = *((_DWORD *)v4 + 8);
    *(_BYTE *)&self->_has |= 2u;
    v5 = *((_BYTE *)v4 + 48);
  }
  if ((v5 & 1) != 0)
