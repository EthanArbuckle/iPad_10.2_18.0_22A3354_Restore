...
void __get_CDContextualKeyPathClass_block_invoke_cold_1()
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "Class get_CDContextualKeyPathClass(void)_block_invoke");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", v1, CFSTR("BMTipsStreams.m"), 33, CFSTR("Unable to find class %s"), "_CDContextualKeyPath");
