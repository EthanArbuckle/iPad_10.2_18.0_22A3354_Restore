...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("UserActivityMetadata"));
}

- (BMUserActivityMetadataStream)init
{
  BMUserActivityMetadataStream *v2;
  ...
  v2 = -[BMUserActivityMetadataStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMUserActivityMetadataStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMUserActivityMetadataStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
