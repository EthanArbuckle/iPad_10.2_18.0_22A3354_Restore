...
{
  id v6;
  BMAlternateTestEvent *v7;
  BMAlternateTestEvent *v8;
  objc_super v10;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  uint64_t v4;
  id v5;
  BMAlternateTestEvent *v6;

  v4 = *(_QWORD *)&a4;
  v5 = a3;
  v6 = -[BMAlternateTestEvent initWithData:dataVersion:]([BMAlternateTestEvent alloc], "initWithData:dataVersion:", v5, v4);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v5, "encodeInt32:forKey:", p_data->content, CFSTR("alternateContent"));
