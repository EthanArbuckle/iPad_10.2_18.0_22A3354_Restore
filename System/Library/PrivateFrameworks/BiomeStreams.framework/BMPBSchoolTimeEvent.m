...
- (int)StringAsReason:(id)a3
{
  ...
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("Scheduled")))
  {
    v4 = 2;
  }
  else
...
- (id)description
{
  ...
  -[BMPBSchoolTimeEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBSchoolTimeEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((_BYTE *)result + 12) = self->_starting;
    *((_BYTE *)result + 16) |= 2u;
    has = (char)self->_has;
  }
  if ((has & 1) != 0)
