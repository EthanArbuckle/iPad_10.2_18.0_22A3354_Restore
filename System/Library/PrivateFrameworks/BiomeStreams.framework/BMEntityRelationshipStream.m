...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("EntityRelationship"));
}

- (BMEntityRelationshipStream)init
{
  BMEntityRelationshipStream *v2;
  ...
  v2 = -[BMEntityRelationshipStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMEntityRelationshipStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMEntityRelationshipStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
