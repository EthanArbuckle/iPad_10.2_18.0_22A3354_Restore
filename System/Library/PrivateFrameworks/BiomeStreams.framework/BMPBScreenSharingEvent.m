...
- (int)StringAsType:(id)a3
{
  ...
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("Unspecified")) & 1) != 0)
    ...
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("AirPlayMirroring"));
...
- (id)description
{
  ...
  -[BMPBScreenSharingEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBScreenSharingEvent dictionaryRepresentation](self, "dictionaryRepresentation");
