...
- (id)identifier
{
  return (id)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("SafariPageView"));
}

- (BMSafariPageViewStream)init
{
  void *v3;
  BMSafariPageViewStream *v4;

  -[BMSafariPageViewStream identifier](self, "identifier");
