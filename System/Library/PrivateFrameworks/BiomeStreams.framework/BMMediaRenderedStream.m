...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("MediaRendered"));
}

- (BMMediaRenderedStream)init
{
  BMMediaRenderedStream *v2;
  ...
  v2 = -[BMMediaRenderedStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMMediaRenderedStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMMediaRenderedStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
