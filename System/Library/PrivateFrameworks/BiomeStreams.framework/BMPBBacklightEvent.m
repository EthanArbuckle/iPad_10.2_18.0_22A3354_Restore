...
- (id)description
{
  ...
  -[BMPBBacklightEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBBacklightEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_backlightLevel);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("backlightLevel"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 1) != 0)
  {
    *((_QWORD *)result + 1) = *(_QWORD *)&self->_absoluteTimestamp;
    *((_BYTE *)result + 24) |= 1u;
    has = (char)self->_has;
  }
  if ((has & 2) != 0)
  {
    *((_QWORD *)result + 2) = self->_backlightLevel;
    *((_BYTE *)result + 24) |= 2u;
  }
  return result;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_absoluteTimestamp != *((double *)v4 + 1))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_backlightLevel != *((_QWORD *)v4 + 2))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
- (unint64_t)hash
{
  ...
  if ((has & 2) != 0)
    v9 = 2654435761u * self->_backlightLevel;
  else
    v9 = 0;
  return v9 ^ v4;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_backlightLevel = *((_QWORD *)v4 + 2);
    *(_BYTE *)&self->_has |= 2u;
  }
