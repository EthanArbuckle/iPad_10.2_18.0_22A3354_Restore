...
- (id)description
{
  ...
  -[BMPBSocialMediaHandle description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBSocialMediaHandle dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](bundleId, "isEqual:")))
  {
    ...
    if ((unint64_t)handle | v4[2])
      v7 = -[NSString isEqual:](handle, "isEqual:");
    else
      v7 = 1;
  }
  else
