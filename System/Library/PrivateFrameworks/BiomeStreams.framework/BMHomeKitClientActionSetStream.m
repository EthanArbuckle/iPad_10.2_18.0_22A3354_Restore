...
{
  BMHomeKitClientActionSetStream *v2;
  void *v3;
  void *v4;
  void *v5;
  void *v6;
  ...
  v2 = -[BMHomeKitClientActionSetStream init](&v18, sel_init);
  if (v2)
  {
    BMRootLibraryBridge();
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
        -[BMHomeKitClientActionSetStream init].cold.1(v9, v10, v11, v12, v13, v14, v15, v16);
...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D20], "streamIdentifierForStream:", 16);
}
...
- (id)publisher
{
  ...
  -[BMHomeKitClientActionSetStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)init
{
  OUTLINED_FUNCTION_0_2(&dword_18D810000, a1, a3, "Unable to initialize BMPublicStreamHomeKitClientActionSet, please consult error logs for cause", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_2();
}
