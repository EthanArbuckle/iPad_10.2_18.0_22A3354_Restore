...
- (int)StringAsReason:(id)a3
{
  ...
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("WiFi")))
  {
    v4 = 2;
  }
  else
...
- (id)description
{
  ...
  -[BMPBCarPlayEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBCarPlayEvent dictionaryRepresentation](self, "dictionaryRepresentation");
