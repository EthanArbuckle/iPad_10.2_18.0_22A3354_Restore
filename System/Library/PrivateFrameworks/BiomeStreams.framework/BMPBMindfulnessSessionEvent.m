...
- (int)StringAsSessionType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("Breathe")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("Reflect")) & 1) != 0)
  {
    v4 = 1;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("Meditation")))
  {
    v4 = 2;
  }
  else
...
- (int)StringAsStateType:(id)a3
{
  ...
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("Resume")))
  {
    v4 = 4;
  }
  else
...
- (id)description
{
  ...
  -[BMPBMindfulnessSessionEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBMindfulnessSessionEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    ...
    {
      v6 = off_1E2648D70[sessionType];
    }
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("sessionType"));
  ...
  if ((has & 2) != 0)
  {
    ...
    if (stateType >= 5)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_stateType);
      v8 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v8 = off_1E2648D88[stateType];
    }
    objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("stateType"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_sessionType != *((_DWORD *)v4 + 2))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_stateType != *((_DWORD *)v4 + 3))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 1) != 0)
  {
    self->_sessionType = *((_DWORD *)v4 + 2);
    *(_BYTE *)&self->_has |= 1u;
    v5 = *((_BYTE *)v4 + 16);
  }
  if ((v5 & 2) != 0)
  {
    self->_stateType = *((_DWORD *)v4 + 3);
    *(_BYTE *)&self->_has |= 2u;
  }
