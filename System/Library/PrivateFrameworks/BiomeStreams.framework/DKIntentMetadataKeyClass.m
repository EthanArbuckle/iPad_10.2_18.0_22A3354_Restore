...
void __get_DKIntentMetadataKeyClass_block_invoke_cold_1(_QWORD *a1)
{
  void *v2;
  void *v3;
  ...
  objc_msgSend(v2, "handleFailureInFunction:file:lineNumber:description:", v3, CFSTR("BMIntentStreams.m"), 28, CFSTR("%s"), *a1);
...
void __get_DKIntentMetadataKeyClass_block_invoke_cold_2()
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "Class get_DKIntentMetadataKeyClass(void)_block_invoke");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", v1, CFSTR("BMIntentStreams.m"), 29, CFSTR("Unable to find class %s"), "_DKIntentMetadataKey");
