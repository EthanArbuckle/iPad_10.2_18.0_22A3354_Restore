...
- (int)StringAsReason:(id)a3
{
  ...
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("ManualControlCenter")) & 1) != 0)
  {
    v4 = 1;
  }
  ...
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("ManualExitFriction")) & 1) != 0)
  {
    v4 = 4;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("ManualBulletin")) & 1) != 0)
  {
    v4 = 5;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("ManualVanillaControlCenter")))
  {
    v4 = 6;
  }
  else
...
- (id)description
{
  ...
  -[BMPBDoNotDisturbWhileDrivingEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBDoNotDisturbWhileDrivingEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("isStart"));
...
LABEL_10:
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_reason != *((_DWORD *)v4 + 2))
      goto LABEL_14;
    v5 = 1;
  }
LABEL_15:
