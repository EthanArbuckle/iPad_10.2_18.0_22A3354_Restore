...
- (NSString)identifier
{
  return (NSString *)CFSTR("MediaReaction");
}

- (BMMediaReactionStream)init
{
  BMMediaReactionStream *v2;
  ...
  v2 = -[BMMediaReactionStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMMediaReactionStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMMediaReactionStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
