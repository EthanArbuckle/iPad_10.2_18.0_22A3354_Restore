...
- (id)identifier
{
  return (id)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("SiriQuery"));
}

- (BMSiriQueryStream)init
{
  void *v3;
  BMSiriQueryStream *v4;

  -[BMSiriQueryStream identifier](self, "identifier");
