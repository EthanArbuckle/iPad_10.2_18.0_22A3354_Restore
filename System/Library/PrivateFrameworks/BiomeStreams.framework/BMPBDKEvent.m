...
- (id)description
{
  ...
  -[BMPBDKEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBDKEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (dkEvent)
    objc_msgSend(v3, "setObject:forKey:", dkEvent, CFSTR("dkEvent"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  dkEvent = self->_dkEvent;
  if (dkEvent)
    objc_msgSend(a3, "setDkEvent:", dkEvent);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_dkEvent, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)dkEvent | v4[1])
      v6 = -[NSData isEqual:](dkEvent, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSData hash](self->_dkEvent, "hash");
}
