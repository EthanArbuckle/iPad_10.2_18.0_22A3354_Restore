...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D20], "streamIdentifierForStream:", 7);
}
...
- (BMCarPlayStream)init
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)BMCarPlayStream;
  v2 = -[BMCarPlayStream init](&v17, sel_init);
  if (v2)
  {
    BMRootLibraryBridge();
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "CarPlay");
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
        -[BMCarPlayStream init].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
...
- (id)publisher
{
  ...
  -[BMCarPlayStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)init
{
  OUTLINED_FUNCTION_0_2(&dword_18D810000, a1, a3, "Unable to initialize BMPublicStreamCarPlay, please consult error logs for cause", a5, a6, a7, a8, 0);
}
