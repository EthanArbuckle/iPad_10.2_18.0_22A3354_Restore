...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D20], "streamIdentifierForStream:", 11);
}
...
- (BMAlarmStream)init
{
  ...
  v2 = -[BMAlarmStream init](&v10, sel_init);
  if (v2)
  {
    BMRootLibraryBridge();
...
- (id)publisher
{
  ...
  -[BMAlarmStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)init
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18D810000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPublicStreamAlarm, please consult error logs for cause", v1, 2u);
}
