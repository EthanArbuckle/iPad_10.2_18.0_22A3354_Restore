...
- (id)identifier
{
  return (id)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("ParsecSearchEngagement"));
}

- (BMParsecSearchEngagementStream)init
{
  void *v3;
  BMParsecSearchEngagementStream *v4;

  -[BMParsecSearchEngagementStream identifier](self, "identifier");
