...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("MicroLocationTruthTag"));
}

- (BMMicroLocationTruthTagStream)init
{
  BMMicroLocationTruthTagStream *v2;
  ...
  v2 = -[BMMicroLocationTruthTagStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMMicroLocationTruthTagStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMMicroLocationTruthTagStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
