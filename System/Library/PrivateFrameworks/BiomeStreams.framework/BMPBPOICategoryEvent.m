...
- (id)description
{
  ...
  -[BMPBPOICategoryEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BMPBPOICategoryEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    objc_msgSend(v4, "setObject:forKey:", v7, CFSTR("rank"));

    has = (char)self->_has;
  }
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_timeIntervalSince1970);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v8, CFSTR("timeIntervalSince1970"));
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 1) != 0)
  {
    *((_QWORD *)v4 + 1) = *(_QWORD *)&self->_timeIntervalSince1970;
    *((_BYTE *)v4 + 28) |= 1u;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_poiCategory, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_13;
  poiCategory = self->_poiCategory;
  if ((unint64_t)poiCategory | *((_QWORD *)v4 + 2))
  {
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_rank != *((_DWORD *)v4 + 6))
      goto LABEL_13;
  }
...
LABEL_13:
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 1) == 0 || self->_timeIntervalSince1970 != *((double *)v4 + 1))
      goto LABEL_13;
    v6 = 1;
  }
LABEL_14:
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_poiCategory, "hash");
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 1) != 0)
  {
    self->_timeIntervalSince1970 = *((double *)v4 + 1);
    *(_BYTE *)&self->_has |= 1u;
  }
