...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("SiriDictation"));
}

- (BMSiriDictationStream)init
{
  BMSiriDictationStream *v2;
  ...
  v2 = -[BMSiriDictationStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMSiriDictationStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMSiriDictationStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
