...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("UserFocusActivity"));
}

- (BMUserFocusActivityStream)init
{
  BMUserFocusActivityStream *v2;
  void *v3;
  void *v4;
  void *v5;
  uint64_t v6;
  ...
  v17.receiver = self;
  v17.super_class = (Class)BMUserFocusActivityStream;
  v2 = -[BMUserFocusActivityStream init](&v17, sel_init);
  if (v2)
  {
    BMRootLibraryBridge();
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
        -[BMUserFocusActivityStream init].cold.1(v8, v9, v10, v11, v12, v13, v14, v15);
...
- (id)publisher
{
  ...
  -[BMUserFocusActivityStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)init
{
  OUTLINED_FUNCTION_0_2(&dword_18D810000, a1, a3, "Unable to initialize BMPublicStreamsUserFocusActivity, please consult error logs for cause", a5, a6, a7, a8, 0);
}
