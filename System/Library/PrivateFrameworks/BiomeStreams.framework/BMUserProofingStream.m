...
- (NSString)identifier
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0D01D40], "libraryPathForStreamIdentifier:", CFSTR("UserProofingMetadata"));
}

- (BMUserProofingStream)init
{
  BMUserProofingStream *v2;
  ...
  v2 = -[BMUserProofingStream init](&v8, sel_init);
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    -[BMUserProofingStream identifier](v2, "identifier");
...
- (id)publisher
{
  ...
  -[BMUserProofingStream identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
