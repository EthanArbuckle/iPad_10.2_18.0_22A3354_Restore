...
{
  AVResourceReclamationAssertion *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)AVResourceReclamationAssertion;
  v4 = -[AVResourceReclamationAssertion init](&v6, sel_init);
  if (v4)
...
- (void)dealloc
{
  ...
  -[AVResourceReclamationAssertion invalidate](self, "invalidate");

  v3.receiver = self;
  v3.super_class = (Class)AVResourceReclamationAssertion;
  -[AVResourceReclamationAssertion dealloc](&v3, sel_dealloc);
}
