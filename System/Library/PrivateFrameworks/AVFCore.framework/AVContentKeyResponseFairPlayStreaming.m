...
{
  AVContentKeyResponseFairPlayStreaming *v6;
  objc_super v8;

  v8.receiver = self;
  v8.super_class = (Class)AVContentKeyResponseFairPlayStreaming;
  v6 = -[AVContentKeyResponse initWithKeySystem:](&v8, sel_initWithKeySystem_, CFSTR("FairPlayStreaming"));
  if (v6)
  {
    v6->_keyData = (NSData *)objc_msgSend(a3, "copy");
    v6->_renewalDate = (NSDate *)objc_msgSend(a4, "copy");
  }
  return v6;
}
