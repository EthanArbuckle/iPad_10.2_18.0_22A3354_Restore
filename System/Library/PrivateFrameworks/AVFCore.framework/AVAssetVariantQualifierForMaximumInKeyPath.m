...
{
  AVAssetVariantQualifierForMaximumInKeyPath *v5;
  AVAssetVariantQualifierForMaximumInKeyPath *v7;
  void *v8;
  uint64_t v9;
  uint64_t v10;
  uint64_t v11;
  ...
  if (v5)
  {
    if (!-[AVAssetVariantQualifierForMaximumInKeyPath _validateKeyPath:](v5, "_validateKeyPath:", objc_msgSend(a3, "_keyPath")))
    {
      v7 = v5;
...
{
  return -[AVAssetVariantQualifierForMaximumInKeyPath initWithFigAssetVariantQualifierForMaximumInKeyPath:]([AVAssetVariantQualifierForMaximumInKeyPath alloc], "initWithFigAssetVariantQualifierForMaximumInKeyPath:", self->_figAssetVariantQualifier);
}
...
{
  AVAssetVariantQualifierForMaximumInKeyPath *v6;
  AVAssetVariantQualifierForMaximumInKeyPath *v8;
  uint64_t v9;
  uint64_t v10;
  uint64_t v11;
  uint64_t v12;
  ...
  if (v6)
    v6->_figAssetVariantQualifier = (FigAssetVariantQualifierForMaximumInKeyPathObjC *)(id)objc_msgSend(a3, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("keyPath"));
  return v6;
}
