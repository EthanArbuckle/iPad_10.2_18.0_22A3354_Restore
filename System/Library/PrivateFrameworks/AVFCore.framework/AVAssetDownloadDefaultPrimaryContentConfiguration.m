...
- (void)_setupContentConfigWithDownloadConfig:(FigStreamingAssetDownloadConfig *)a3 asset:(id)a4
{
  ...
  if (v7)
  {
    v8 = +[AVAssetVariantQualifier predicateForChannelCount:mediaSelectionOption:operatorType:](AVAssetVariantQualifier, "predicateForChannelCount:mediaSelectionOption:operatorType:", 2, v7, 1);
    if (v8)
    {
...
- (void)_serializeIntoDownloadConfig:(FigStreamingAssetDownloadConfig *)a3 asset:(id)a4
{
  ...
  if (!-[NSArray count](-[AVAssetDownloadContentConfiguration variantQualifiers](self, "variantQualifiers"), "count"))
  {
    ...
    v9[6] = v7;
    v9[7] = a3;
    objc_msgSend(a4, "loadValuesAsynchronouslyForKeys:completionHandler:", &unk_1E3093BE0, v9);
