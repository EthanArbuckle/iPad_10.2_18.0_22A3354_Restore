@implementation AVMakeRemoveRouteDescriptorOperation
...
uint64_t __AVMakeRemoveRouteDescriptorOperation_block_invoke_30(_QWORD *a1)
{
  NSObject *os_log_and_send_and_compose_flags_and_os_log_type;
  uint64_t v3;
  uint64_t v4;
  ...
  v3 = a1[5];
  v5 = a1[6];
  v6 = *(uint64_t (**)(uint64_t, uint64_t, uint64_t))(*(_QWORD *)(CMBaseObjectGetVTable() + 16) + 104);
  if (v6)
    v7 = v6(v3, v4, v5);
  else
    v7 = 4294954514;
