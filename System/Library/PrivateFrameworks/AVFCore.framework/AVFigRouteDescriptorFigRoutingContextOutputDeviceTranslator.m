...
{
  AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator *v4;
  AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator *v5;
  AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator *v6;
  objc_super v8;

  v8.receiver = self;
  v8.super_class = (Class)AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator;
  v4 = -[AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator init](&v8, sel_init);
  v5 = v4;
  if (v4)
  {
...
- (void)dealloc
{
  ...
  -[AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator dealloc](&v2, sel_dealloc);
}
...
- (id)predictedOutputDeviceFromRoutingContext:(OpaqueFigRoutingContext *)a3
{
  ...
  v7 = +[AVOutputDevice outputDeviceWithRouteDescriptor:withRoutingContext:](AVOutputDevice, "outputDeviceWithRouteDescriptor:withRoutingContext:", cf, a3);
  v6 = cf;
  if (cf)
LABEL_4:
    CFRelease(v6);
...
- (id)outputDevicesFromRoutingContext:(OpaqueFigRoutingContext *)a3
{
  ...
  if (v5 && !v5(a3, &theArray))
  {
    for (i = 0; ; ++i)
    {
      ...
      if (i >= Count)
        break;
      v8 = +[AVOutputDevice outputDeviceWithRouteDescriptor:withRoutingContext:](AVOutputDevice, "outputDeviceWithRouteDescriptor:withRoutingContext:", CFArrayGetValueAtIndex(theArray, i), a3);
      if (v8)
...
{
  return (AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator *)-[AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator initForUsingRouteConfigUpdatedNotification:](self, "initForUsingRouteConfigUpdatedNotification:", AVOutputContextUsesRouteConfigUpdatedNotification());
}
...
- (void)addOutputDevice:(id)a3 withOptions:(__CFDictionary *)a4 toRoutingContext:(OpaqueFigRoutingContext *)a5 completionHandler:(id)a6
{
  ...
  v15 = 0;
  FigRouteDescriptor = AVOutputDeviceGetFigRouteDescriptor(a3, &v15);
  v11 = FigRouteDescriptor;
  if (FigRouteDescriptor && v15)
  {
    v12 = AVMakeAddRouteDescriptorOperation(a5, v15, a4, self->_useRouteConfigUpdatedNotification);
    v14[0] = MEMORY[0x1E0C809B0];
    v14[1] = 3221225472;
