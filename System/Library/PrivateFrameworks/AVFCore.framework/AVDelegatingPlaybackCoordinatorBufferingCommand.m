...
- (AVDelegatingPlaybackCoordinatorBufferingCommand)init
{
  ...
  v7 = (void *)objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], AVMethodExceptionReasonWithObjectAndSelector((objc_class *)self, a2, (uint64_t)CFSTR("-[AVDelegatingPlaybackCoordinatorBufferingCommand init] unavailable"), v2, v3, v4, v5, v6, v8), 0);
...
{
  AVDelegatingPlaybackCoordinatorBufferingCommand *v14;
  objc_super v16;
...
- (void)dealloc
{
  ...
  -[AVDelegatingPlaybackCoordinatorBufferingCommand dealloc](&v3, sel_dealloc);
}
