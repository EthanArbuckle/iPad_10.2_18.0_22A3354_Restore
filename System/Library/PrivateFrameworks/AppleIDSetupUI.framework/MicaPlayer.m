...
- (void)notifyDelegateDidChangePlaybackTime
{
  ...
  if (!-[MicaPlayer isNotifyingDelegate](self, "isNotifyingDelegate"))
  {
    WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
    if (WeakRetained)
    {
      ...
      if ((v6 & 1) != 0)
      {
        -[MicaPlayer setIsNotifyingDelegate:](self, "setIsNotifyingDelegate:", 1);
        v7 = objc_loadWeakRetained((id *)&self->_delegate);
        objc_msgSend(v7, "micaPlayerDidChangePlaybackTime:", self);

        -[MicaPlayer setIsNotifyingDelegate:](self, "setIsNotifyingDelegate:", 0);
      }
    }
  }
}
