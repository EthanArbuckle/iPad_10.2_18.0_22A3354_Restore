...
- (id)_musicKit_self_avRoute
{
  ...
  v9 = getMPAVRouteClass_softClass;
  if (!getMPAVRouteClass_softClass)
  {
    v5[0] = MEMORY[0x1E0C809B0];
    v5[1] = 3221225472;
    v5[2] = __getMPAVRouteClass_block_invoke;
    v5[3] = &unk_1E9C05688;
    v5[4] = &v6;
    __getMPAVRouteClass_block_invoke((uint64_t)v5);
    v2 = (void *)v7[3];
  }
...
- (id)musicKit_avRoute_routeName
{
  ...
  objc_msgSend(a1, "_musicKit_self_avRoute");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "routeName");
