...
- (id)_activeProductionWithRenditionsInProductions:(id)a3
{
  ...
  v4 = (void *)objc_msgSend(a3, "filteredArrayUsingPredicate:", objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("renditions != nil AND isActive == 1")));
  ...
  if (v6 != 1)
    NSLog(CFSTR("WARNING: More than one active productions with renditions for %@"), -[TDAsset sourceRelativePath](self, "sourceRelativePath"));
  return v7;
}
...
- (BOOL)hasCursorProduction
{
  ...
  v3 = -[TDPhotoshopAsset hasProduction](self, "hasProduction");
  if (v3)
  {
    -[TDPhotoshopAsset production](self, "production");
    objc_opt_class();
...
- (id)production
{
  ...
  v3 = (void *)objc_msgSend((id)-[TDPhotoshopAsset productions](self, "productions"), "allObjects");
  ...
  {
    result = -[TDPhotoshopAsset _activeProductionWithRenditionsInProductions:](self, "_activeProductionWithRenditionsInProductions:", v3);
    if (result)
      return result;
    result = -[TDPhotoshopAsset _productionWithRenditionsInProductions:](self, "_productionWithRenditionsInProductions:", v3);
  }
  if (v4 >= 1 && !result)
...
- (BOOL)hasProduction
{
  return -[TDPhotoshopAsset production](self, "production") != 0;
}
...
- (id)copyDataFromAttributes
{
  ...
  v4 = -[TDPhotoshopAsset valueForKey:](self, "valueForKey:", CFSTR("category"));
  if (v4)
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("category"));
  v5 = -[TDPhotoshopAsset valueForKey:](self, "valueForKey:", CFSTR("name"));
  if (v5)
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("name"));
  v6 = (void *)-[TDPhotoshopAsset valueForKey:](self, "valueForKey:", CFSTR("source"));
  if (v6)
...
- (void)setAttributesFromCopyData:(id)a3
{
  ...
  if (v5)
    -[TDPhotoshopAsset setValue:forKey:](self, "setValue:forKey:", v5, CFSTR("category"));
  v6 = objc_msgSend(v4, "objectForKey:", CFSTR("name"));
  if (v6)
    -[TDPhotoshopAsset setValue:forKey:](self, "setValue:forKey:", v6, CFSTR("name"));
}
