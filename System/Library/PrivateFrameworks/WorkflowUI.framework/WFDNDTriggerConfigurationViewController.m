...
{
  id v7;
  WFDNDTriggerConfigurationViewController *v8;
  WFDNDTriggerConfigurationViewController *v9;
  WFDNDTriggerConfigurationViewController *v10;
  void *v12;
  objc_super v13;
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("WFDNDTriggerConfigurationViewController.m"), 31, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("[trigger isKindOfClass:[WFDNDTrigger class]]"));
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[WFDNDTriggerConfigurationViewController viewWillAppear:](&v5, sel_viewWillAppear_, a3);
  -[WFTriggerConfigurationViewController tableView](self, "tableView");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  -[WFDNDTriggerConfigurationViewController infoForSection:](self, "infoForSection:", a4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[WFDNDTriggerConfigurationViewController infoForSection:](self, "infoForSection:", objc_msgSend(v6, "section"));
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  v5 = a4;
  -[WFDNDTriggerConfigurationViewController infoForSection:](self, "infoForSection:", objc_msgSend(v5, "section"));
