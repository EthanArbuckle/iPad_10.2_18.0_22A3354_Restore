...
- (id)_accessibilityViewChildrenWithOptions:(id)a3
{
  ...
  -[WFGlyphPickerCollectionView _accessibilityViewChildrenWithOptions:](&v18, sel__accessibilityViewChildrenWithOptions_, a3);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[WFGlyphPickerCollectionView visibleCells](self, "visibleCells", (_QWORD)v14);
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        objc_opt_class();
        if ((objc_opt_isKindOfClass() & 1) != 0 && (objc_msgSend(v12, "containsObject:", v11) & 1) == 0)
