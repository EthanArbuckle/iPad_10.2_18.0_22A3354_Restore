...
{
  id v7;
  WFExternalDisplayTriggerConfigurationViewController *v8;
  WFExternalDisplayTriggerConfigurationViewController *v9;
  WFExternalDisplayTriggerConfigurationViewController *v10;
  void *v12;
  objc_super v13;
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("WFExternalDisplayTriggerConfigurationViewController.m"), 31, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("[trigger isKindOfClass:[WFExternalDisplayTrigger class]]"));
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[WFExternalDisplayTriggerConfigurationViewController infoForSection:](self, "infoForSection:", objc_msgSend(v6, "section"));
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  -[WFExternalDisplayTriggerConfigurationViewController infoForSection:](self, "infoForSection:", a4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  v5 = a4;
  -[WFExternalDisplayTriggerConfigurationViewController infoForSection:](self, "infoForSection:", objc_msgSend(v5, "section"));
