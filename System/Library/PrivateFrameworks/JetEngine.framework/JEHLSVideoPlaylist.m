...
{
  id v6;
  JEHLSVideoPlaylist *v7;
  JEHLSVideoPlaylist *v8;
  objc_super v10;

  v6 = a4;
  v10.receiver = self;
  v10.super_class = (Class)JEHLSVideoPlaylist;
  v7 = -[JEHLSVideoPlaylist init](&v10, sel_init);
  v8 = v7;
  if (v7)
  {
    -[JEHLSVideoPlaylist setStartPosition:](v7, "setStartPosition:", a3);
    -[JEHLSVideoPlaylist setMainFeatureMetricsData:](v8, "setMainFeatureMetricsData:", v6);
  }
...
{
  return -[JEHLSVideoPlaylist initWithStartPosition:mainFeatureMetricsData:](self, "initWithStartPosition:mainFeatureMetricsData:", 0, a3);
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[JEHLSVideoPlaylist addRollInfoItem:](self, "addRollInfoItem:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++));
      }
      while (v6 != v8);
...
- (void)addRollInfoItem:(id)a3
{
  ...
  -[JEHLSVideoPlaylist addItemStartAtSeconds:durationSeconds:metricsData:](self, "addItemStartAtSeconds:durationSeconds:metricsData:", v4, v6, v7);
...
- (void)addItemStartAtSeconds:(double)a3 durationSeconds:(double)a4 metricsData:(id)a5
{
  ...
  v8 = a5;
  v9 = -[JEHLSRollItem initWithStartOverallPosition:duration:metricsData:]([JEHLSRollItem alloc], "initWithStartOverallPosition:duration:metricsData:", (unint64_t)(a3 * 1000.0), (unint64_t)(a4 * 1000.0), v8);

  -[JEHLSVideoPlaylist addRollItem:](self, "addRollItem:", v9);
}
...
- (void)addItemStartAtMilliseconds:(unint64_t)a3 durationMilliseconds:(unint64_t)a4 metricsData:(id)a5
{
  ...
  v8 = a5;
  v9 = -[JEHLSRollItem initWithStartOverallPosition:duration:metricsData:]([JEHLSRollItem alloc], "initWithStartOverallPosition:duration:metricsData:", a3, a4, v8);
...
{
  -[JEHLSVideoPlaylist addItemStartAtMilliseconds:durationMilliseconds:metricsData:](self, "addItemStartAtMilliseconds:durationMilliseconds:metricsData:", a3, a4 - a3, a5);
}
...
- (id)itemAtOverallPosition:(unint64_t)a3 rangeOptions:(int64_t)a4
{
  ...
  v4 = a4;
  v7 = -[JEHLSVideoPlaylist indexOfLastRollItemWithStartBeforePosition:](self, "indexOfLastRollItemWithStartBeforePosition:");
  if (v7 == 0x7FFFFFFFFFFFFFFFLL)
  {
    -[JEHLSVideoPlaylist mainFeatureItemWithStartOverallPosition:](self, "mainFeatureItemWithStartOverallPosition:", 0);
  ...
  else
  {
    ...
    if ((v4 & 1) == 0)
    {
      do
      {
        -[JEHLSVideoPlaylist rollItems](self, "rollItems");
    ...
    {
      -[JEHLSVideoPlaylist mainFeatureItemWithStartOverallPosition:](self, "mainFeatureItemWithStartOverallPosition:", objc_msgSend(v16, "endOverallPosition"));
...
- (id)itemsBetweenStartOverallPosition:(unint64_t)a3 endOverallPosition:(unint64_t)a4
{
  ...
  if (v9)
  {
    v10 = -[JEHLSVideoPlaylist indexOfLastRollItemWithStartBeforePosition:](self, "indexOfLastRollItemWithStartBeforePosition:", a3);
    ...
    while (1)
    {
      ...
      if (objc_msgSend(v13, "endOverallPosition") < a4)
      {
        ...
        if (v10 >= v15)
        {
          -[JEHLSVideoPlaylist mainFeatureItemWithStartOverallPosition:](self, "mainFeatureItemWithStartOverallPosition:", objc_msgSend(v13, "endOverallPosition"));
...
- (void)addRollItem:(id)a3
{
  ...
  +[JEHLSItem comparator](JEHLSItem, "comparator");
...
- (id)mainFeatureItemWithStartOverallPosition:(unint64_t)a3
{
  ...
  v5 = [JEHLSItem alloc];
  -[JEHLSVideoPlaylist mainFeatureMetricsData](self, "mainFeatureMetricsData");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[JEHLSItem initWithStartOverallPosition:metricsData:](v5, "initWithStartOverallPosition:metricsData:", a3, v6);

  v8 = -[JEHLSVideoPlaylist startPosition](self, "startPosition");
  v9 = -[JEHLSVideoPlaylist indexOfLastRollItemWithStartBeforePosition:](self, "indexOfLastRollItemWithStartBeforePosition:", a3);
  ...
  -[JEHLSItem setStartPosition:](v7, "setStartPosition:", v8);
  return v7;
}
