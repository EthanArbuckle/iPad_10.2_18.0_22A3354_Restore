...
void __26__ADOptOutRequest_options__block_invoke()
{
  ...
  options_sOptions_3 = (uint64_t)&unk_1E82BEC00;
...
- (id)description
{
  ...
  -[ADOptOutRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ADOptOutRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 8) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_optedOutStatus);
...
LABEL_5:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_transmitTimestamp);
...
LABEL_13:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_statusChangeTimestamp);
...
LABEL_11:
  ...
  return v5 ^ v3 ^ v10 ^ v11 ^ v16 ^ -[NSData hash](self->_dPID, "hash");
}
