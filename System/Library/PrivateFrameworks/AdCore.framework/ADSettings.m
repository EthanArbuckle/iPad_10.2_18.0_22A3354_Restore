...
- (id)description
{
  ...
  -[ADSettings description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ADSettings dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_parameters, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if (-[ADSettings parametersCount](self, "parametersCount"))
  {
    objc_msgSend(v8, "clearParameters");
    v4 = -[ADSettings parametersCount](self, "parametersCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[ADSettings parametersAtIndex:](self, "parametersAtIndex:", i);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[ADSettings addParameters:](self, "addParameters:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
