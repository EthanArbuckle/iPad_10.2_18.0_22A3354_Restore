...
void __31__ADAttributionRequest_options__block_invoke()
{
  ...
  options_sOptions = (uint64_t)&unk_1E82BEB38;
...
- (int)StringAsDownloadType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("NoDownload")) & 1) != 0)
  {
    v4 = 0;
  }
  ...
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("Redownload")))
  {
    v4 = 2;
  }
  else
...
- (id)description
{
  ...
  -[ADAttributionRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ADAttributionRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 8) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_purchaseTimestamp);
...
LABEL_11:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_iAdConversionTimestamp);
...
LABEL_17:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_iAdImpressionTimestamp);
...
LABEL_18:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_attributedByiTunes);
...
LABEL_23:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_searchAdClickTimestamp);
  ...
  if ((v20 & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_downloadClickTimestamp);
  ...
  if ((v20 & 0x20) != 0)
  {
    ...
    if (downloadType >= 3)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_downloadType);
      v23 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v23 = off_1E82B1CB0[downloadType];
    }
...
- (unint64_t)hash
{
  ...
  v42 = -[NSData hash](self->_iAdID, "hash");
  v41 = -[NSData hash](self->_tiltID, "hash");
  v40 = -[NSData hash](self->_anonymousDemandiAdID, "hash");
...
LABEL_30:
  v20 = -[NSData hash](self->_toroID, "hash", v36);
  v21 = -[NSData hash](self->_dPID, "hash");
  if ((*(_BYTE *)&self->_has & 0x10) != 0)
  {
