...
void __33__ADLogAnalyticsResponse_options__block_invoke()
{
  ...
  options_sOptions_8 = (uint64_t)&unk_1E82BECC8;
...
- (id)description
{
  ...
  -[ADLogAnalyticsResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ADLogAnalyticsResponse dictionaryRepresentation](self, "dictionaryRepresentation");
