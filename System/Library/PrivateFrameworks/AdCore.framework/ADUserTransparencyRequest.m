...
void __36__ADUserTransparencyRequest_options__block_invoke()
{
  ...
  options_sOptions_12 = (uint64_t)&unk_1E82BED68;
...
- (id)description
{
  ...
  -[ADUserTransparencyRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ADUserTransparencyRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isSignedInToiTunes);
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_dPID, "hash");
  v4 = -[NSString hash](self->_localeIdentifier, "hash");
  v5 = -[NSData hash](self->_iAdID, "hash");
  v6 = -[NSData hash](self->_contentiAdID, "hash");
