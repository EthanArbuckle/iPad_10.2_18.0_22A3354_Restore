...
void __34__ADSegmentUpdateResponse_options__block_invoke()
{
  ...
  options_sOptions_13 = (uint64_t)&unk_1E82BED90;
...
- (id)description
{
  ...
  -[ADSegmentUpdateResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ADSegmentUpdateResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_segmentRefreshIntervalInSeconds);
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_maxSegmentUpdateIntervalInSeconds);
