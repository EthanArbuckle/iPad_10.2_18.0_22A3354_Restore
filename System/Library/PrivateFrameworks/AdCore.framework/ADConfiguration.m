...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_requestType);
...
- (id)description
{
  ...
  -[ADConfiguration description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ADConfiguration dictionaryRepresentation](self, "dictionaryRepresentation");
