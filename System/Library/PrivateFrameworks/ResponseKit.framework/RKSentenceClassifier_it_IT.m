...
- (id)lexicalEntitiesFromString:(id)a3
{
  ...
  objc_msgSend(v5, "stringByReplacingOccurrencesOfString:withString:", CFSTR("cos'è"), CFSTR("cosa è"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v6, "stringByReplacingOccurrencesOfString:withString:", CFSTR("com'è"), CFSTR("come è"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v7, "stringByReplacingOccurrencesOfString:withString:", CFSTR("quant'è"), CFSTR("quanto è"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();

  v11.receiver = self;
  v11.super_class = (Class)RKSentenceClassifier_it_IT;
  -[RKSentenceClassifier lexicalEntitiesFromString:](&v11, sel_lexicalEntitiesFromString_, v8);
...
- (id)classifySentence
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD1758], "predicateWithFormat:", CFSTR("partOfSpeech == %@ && ((word == 'ti') || (word == 'tu'))"), *MEMORY[0x24BDD0F48]);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
