...
{
  CSClarityboardStartMonitor *result;
  objc_super v3;
...
LABEL_6:
  ...
  self->_isClarityBoardStarted = -[CSClarityboardStartMonitor _checkClarityBoardStarted](self, "_checkClarityBoardStarted");
...
- (void)_stopMonitoring
{
  ...
  if (notifyToken != -1)
  {
    ...
    if (os_log_type_enabled((os_log_t)CSLogContextFacilityCoreSpeech, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1B502E000, v4, OS_LOG_TYPE_DEFAULT, "%s Stop monitoring : Clarityboard start", (uint8_t *)&v5, 0xCu);
    }
  }
}
...
- (void)_notifyObserver:(id)a3 withStarted:(BOOL)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
    objc_msgSend(v6, "CSClarityboardStartMonitor:didReceiveStarted:", self, v4);
...
- (BOOL)_checkClarityBoardStarted
{
  ...
  if (os_log_type_enabled((os_log_t)CSLogContextFacilityCoreSpeech, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 2114;
    v10 = v4;
    _os_log_impl(&dword_1B502E000, v3, OS_LOG_TYPE_DEFAULT, "%s ClarityBoard started = %{public}@", (uint8_t *)&check, 0x16u);
  }
  return v2;
}
...
{
  *(_BYTE *)(*(_QWORD *)(a1 + 32) + 28) = objc_msgSend(*(id *)(a1 + 32), "_checkClarityBoardStarted");
  return objc_msgSend(*(id *)(a1 + 32), "_didReceiveClarityboardStarted:", *(unsigned __int8 *)(*(_QWORD *)(a1 + 32) + 28));
}

+ (id)sharedInstance
{
  if (sharedInstance_onceToken_772 != -1)
    dispatch_once(&sharedInstance_onceToken_772, &__block_literal_global_773);
  return (id)sharedInstance__sharedInstance_774;
}

void __44__CSClarityboardStartMonitor_sharedInstance__block_invoke()
{
  CSClarityboardStartMonitor *v0;
  void *v1;

  v0 = objc_alloc_init(CSClarityboardStartMonitor);
  v1 = (void *)sharedInstance__sharedInstance_774;
  sharedInstance__sharedInstance_774 = (uint64_t)v0;
