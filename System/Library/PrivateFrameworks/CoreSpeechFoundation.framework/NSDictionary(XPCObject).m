...
LABEL_5:
  ...
  if (MEMORY[0x1B5E46F84](v4) != MEMORY[0x1E0C812F8])
  {
    ...
    if (os_log_type_enabled((os_log_t)CSLogContextFacilityCoreSpeech, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_error_impl(&dword_1B502E000, v6, OS_LOG_TYPE_ERROR, "%s xpc object should be XPC_TYPE_DICTIONARY", buf, 0xCu);
    }
    goto LABEL_5;
  }
  ...
  if (v8)
  {
    ...
    applier[3] = &unk_1E687FD20;
    v12 = v8;
    xpc_dictionary_apply(v5, applier);

  }
  v7 = (void *)objc_msgSend(a1, "initWithDictionary:", v9);
