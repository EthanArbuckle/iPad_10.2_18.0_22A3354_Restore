...
- (CSVoiceTriggerPhraseConfig)initWithName:(id)a3 threshold:(float)a4 secondChanceThreshold:(float)a5 loggingThreshold:(float)a6 ndapiScaleFactor:(float)a7 recognizerScoreOffset:(float)a8 recognizerScoreScaleFactor:(float)a9 recognizerToken:(id)a10 twoShotFeedbackDelay:(float)a11 remoraTwoShotFeedbackDelay:(float)a12 keywordRejectLoggingThreshold:(float)a13 speakerRejectLoggingThreshold:(float)a14 preTriggerSilenceOffset:(float)a15
{
  id v26;
  id v27;
  CSVoiceTriggerPhraseConfig *v28;
  CSVoiceTriggerPhraseConfig *v29;
  objc_super v31;
  ...
  v28 = -[CSVoiceTriggerPhraseConfig init](&v31, sel_init);
  v29 = v28;
  if (v28)
  {
...
{
  CSVoiceTriggerPhraseConfig *v15;
  void *v16;
  void *v17;
  int v18;
  int v19;
  ...
  double v31;
  double v32;
  CSVoiceTriggerPhraseConfig *v33;
  uint64_t v35;

  v15 = [CSVoiceTriggerPhraseConfig alloc];
  -[CSVoiceTriggerPhraseConfig name](self, "name");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  -[CSVoiceTriggerPhraseConfig recognizerToken](self, "recognizerToken");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  -[CSVoiceTriggerPhraseConfig twoShotFeedbackDelay](self, "twoShotFeedbackDelay");
  v19 = v18;
  -[CSVoiceTriggerPhraseConfig remoraTwoShotFeedbackDelay](self, "remoraTwoShotFeedbackDelay");
  v21 = v20;
  -[CSVoiceTriggerPhraseConfig speakerRejectLoggingThreshold](self, "speakerRejectLoggingThreshold");
  v23 = v22;
  -[CSVoiceTriggerPhraseConfig preTriggerSilenceOffset](self, "preTriggerSilenceOffset");
  LODWORD(v35) = v24;
  *(float *)&v25 = a3;
  *(float *)&v26 = a4;
  *(float *)&v27 = a5;
