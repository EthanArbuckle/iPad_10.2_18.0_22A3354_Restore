  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)__osl, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 136315138;
      v11 = v4;
      _os_log_impl(&dword_218BD4000, v7, OS_LOG_TYPE_DEFAULT, "%s", buf, 0xCu);
    }
  }
}
...
{
  return objc_msgSend(a1, "earlyBootAccessoryAttached:", a2);
}
...
{
  FudLog(6, (uint64_t)CFSTR("%s"), a3, a4, a5, a6, a7, a8, a2);
}
...
void FudLogv_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 136315138;
  v3 = a1;
  _os_log_debug_impl(&dword_218BD4000, a2, OS_LOG_TYPE_DEBUG, "%s", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void FudLogv_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 136315138;
  v3 = a1;
  _os_log_error_impl(&dword_218BD4000, a2, OS_LOG_TYPE_ERROR, "%s", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void FudLogv_cold_3(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 136315138;
  v3 = a1;
  _os_log_fault_impl(&dword_218BD4000, a2, OS_LOG_TYPE_FAULT, "%s", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
