...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v4 = v5.receiver;
  -[HelpfulRemoteUiHostingVC viewDidAppear:](&v5, sel_viewDidAppear_, v3);
  sub_20E006EAC();
...
- (void)presentModalRUIController:(RUINavigationController *)a3 completion:(id)a4
{
  ...
  _TtC14FamilyCircleUI24HelpfulRemoteUiHostingVC *v16;
  uint64_t v17;
  ...
  v15 = a3;
  v16 = self;
  sub_20E032A2C((uint64_t)v9, (uint64_t)&unk_254A01AE8, (uint64_t)v14);
  swift_release();
}
...
- (void)replaceModalRUIController:(RUINavigationController *)a3 byController:(RUINavigationController *)a4 completion:(id)a5
{
  ...
  _TtC14FamilyCircleUI24HelpfulRemoteUiHostingVC *v19;
  uint64_t v20;
  ...
  v18 = a4;
  v19 = self;
  sub_20E032A2C((uint64_t)v11, (uint64_t)&unk_254A01AC8, (uint64_t)v16);
  swift_release();
}
...
- (_TtC14FamilyCircleUI24HelpfulRemoteUiHostingVC)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  void *v7;
  id v8;
  _TtC14FamilyCircleUI24HelpfulRemoteUiHostingVC *v9;
  objc_super v11;
  ...
  if (a3)
  {
    ...
    *((_BYTE *)&self->super.super.super.isa + OBJC_IVAR____TtC14FamilyCircleUI24HelpfulRemoteUiHostingVC_shouldAddSpinner) = 0;
    v6 = a4;
