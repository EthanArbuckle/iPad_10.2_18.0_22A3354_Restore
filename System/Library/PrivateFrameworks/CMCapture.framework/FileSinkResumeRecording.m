...
LABEL_10:
  ...
  if (!v6)
    goto LABEL_10;
LABEL_5:
  objc_msgSend(v6, "resumeRecording");
  v8 = objc_msgSend(*(id *)(DerivedStorage + 624), "cameraSourcePipelineWithSourceID:", -[FigCaptureMovieFileSinkPipeline videoSourceID](v5));
  result = objc_msgSend((id)-[FigCaptureCameraSourcePipeline captureDevice](v8), "setFrameSkippingWhenNotRecordingEnabled:", 0);
  if (v7)
  {
    result = objc_msgSend((id)-[FigCaptureMovieFileSinkPipeline captureDevice](v5), "autoImageControlMode");
    if ((_DWORD)result == 1)
      return objc_msgSend((id)-[FigCaptureMovieFileSinkPipeline captureDevice](v5), "setAutoImageControlMode:", 2);
  }
  return result;
}
