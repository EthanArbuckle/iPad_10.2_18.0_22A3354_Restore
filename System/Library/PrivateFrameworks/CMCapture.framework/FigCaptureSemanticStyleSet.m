...
{
  return (FigCaptureSemanticStyleSet *)-[FigCaptureSemanticStyleSet initWithSemanticStyles:regions:]([FigCaptureSemanticStyleSet alloc], a3, a4);
}

- (_QWORD)initWithSemanticStyles:(void *)a3 regions:
{
  _QWORD *v5;
  id v6;
  id v7;
...
- (FigCaptureSemanticStyleSet)initWithXPCEncoding:(id)a3
{
  ...
  v4 = -[FigCaptureSemanticStyleSet init](&v19, sel_init);
  if (v4)
  {
    ...
    if (xpc_array_get_count(value))
    {
      v7 = 0;
      do
        -[NSArray addObject:](v6, "addObject:", -[FigCaptureSemanticStyle initWithXPCEncoding:]([FigCaptureSemanticStyle alloc], "initWithXPCEncoding:", xpc_array_get_value(value, v7++)));
...
- (id)copyXPCEncoding
{
  ...
  if (-[NSArray count](self->_semanticStyles, "count"))
  {
    v4 = 0;
    do
    {
      v5 = (void *)objc_msgSend(-[NSArray objectAtIndexedSubscript:](self->_semanticStyles, "objectAtIndexedSubscript:", v4), "copyXPCEncoding");
      xpc_array_append_value(empty, v5);

      ++v4;
    }
    while (-[NSArray count](self->_semanticStyles, "count") > v4);
  }
  ...
  if (-[NSArray count](self->_regions, "count"))
  {
    ...
    do
    {
      ...
      -[FigCaptureSemanticStyleSet regionAtIndex:](self, "regionAtIndex:", v7);
      v10 = v9;
      v12 = v11;
      v14 = v13;
...
- (void)dealloc
{
  ...
  -[FigCaptureSemanticStyleSet dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[FigCaptureSemanticStyleSet initWithSemanticStyles:regions:](+[FigCaptureSemanticStyleSet allocWithZone:](FigCaptureSemanticStyleSet, "allocWithZone:", a3), self->_semanticStyles, self->_regions);
}
...
- (NSString)description
{
  ...
  v3 = (void *)-[NSString mutableCopy](-[NSArray description](self->_semanticStyles, "description"), "mutableCopy");
  ...
  if (-[NSArray count](self->_regions, "count"))
  {
    ...
    do
    {
      -[FigCaptureSemanticStyleSet regionAtIndex:](self, "regionAtIndex:", v4);
...
- (id)largestRegionSemanticStyle
{
  ...
  v4 = -[NSArray count](self->_semanticStyles, "count");
  v5 = 8;
  if (v3 > v4)
    v5 = 16;
  ...
  do
  {
    -[FigCaptureSemanticStyleSet regionAtIndex:](self, "regionAtIndex:", v8);
    if (v11 * v12 > v10)
    {
      v10 = v11 * v12;
      v9 = -[NSArray objectAtIndexedSubscript:](self->_semanticStyles, "objectAtIndexedSubscript:", v8);
    }
    ++v8;
  }
  while (v7 != v8);
...
- (float)largestEdgeOffset
{
  ...
  if (!-[NSArray count](-[FigCaptureSemanticStyleSet semanticStyles](self, "semanticStyles"), "count"))
    return 0.0;
  v3 = 0;
  v4 = 0.0;
  do
  ...
  while (-[NSArray count](-[FigCaptureSemanticStyleSet semanticStyles](self, "semanticStyles"), "count") > v3);
  return v4;
}

- (float)_edgeOffsetForRegionAtIndex:(void *)a1
{
  CGFloat x;
  CGFloat y;
  CGFloat width;
  ...
  if (!a1)
    return 0.0;
  objc_msgSend(a1, "regionAtIndex:", a2);
  x = v9.origin.x;
  y = v9.origin.y;
  width = v9.size.width;
  ...
  result = CGRectGetMinX(v10);
  if ((float)(1.0 - result) <= result)
    result = 1.0 - result;
  if (result <= v7)
    return v7;
  return result;
