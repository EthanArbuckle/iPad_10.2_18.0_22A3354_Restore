...
- (id)fetchWithCustomClassesAndRetain:(id)a3 err:(int *)a4
{
  ...
  if (archive)
  {
    self->_dictionary = (NSDictionary *)+[BWDeferredContainer unarchiveObject:classes:error:](BWDeferredContainer, "unarchiveObject:classes:error:", archive, v8, &v14);
  ...
  else
  {
    ...
    if (URL)
    {
      v13 = (NSDictionary *)+[BWDeferredContainer unarchiveObjectWithURL:classes:error:](BWDeferredContainer, "unarchiveObjectWithURL:classes:error:", URL, v8, &v14);
...
{
  BWDeferredDictionaryIntermediate *v7;
  objc_super v9;
...
- (id)archive:(int *)a3
{
  ...
  if (dictionary)
  {
    if (+[BWDeferredContainer archiveObject:error:](BWDeferredContainer, "archiveObject:error:", dictionary, &v13))
    {
...
- (id)description
{
  ...
  v5 = -[NSDictionary description](self->_dictionary, "description");
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR("<%@ %p>: tag:%@ dictionary:%@"), objc_opt_class(), self, -[BWDeferredIntermediate tag](self, "tag"), v5);
