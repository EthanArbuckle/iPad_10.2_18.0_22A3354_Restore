...
- (id)nextObject
{
  ...
  {
    v3 = -[BWGraph _sinkNodes](self->super._graph, "_sinkNodes");
    currentSinkIndex = self->_currentSinkIndex;
    if (currentSinkIndex >= objc_msgSend(v3, "count"))
      return 0;
    -[NSMutableArray bw_push:](self->_stack, "bw_push:", objc_msgSend(v3, "objectAtIndexedSubscript:", self->_currentSinkIndex));
    -[BWNodeEnumerator _updateVisitedCount:]((uint64_t)self, objc_msgSend(v3, "objectAtIndexedSubscript:", self->_currentSinkIndex));
    ++self->_currentSinkIndex;
  }
  stack = self->_stack;
  if (self->_ordering)
  {
    v6 = -[BWReverseDepthFirstEnumerator _nextUnvisitedParent:]((uint64_t)self, -[NSMutableArray bw_peek](stack, "bw_peek"));
    if (v6)
    {
      v7 = (void *)v6;
      do
  ...
  else
  {
    ...
    v19 = 0u;
    v20 = 0u;
    v9 = (void *)objc_msgSend((id)objc_msgSend(v8, "inputs", 0), "reverseObjectEnumerator");
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v14 = objc_msgSend((id)objc_msgSend((id)objc_msgSend(*(id *)(*((_QWORD *)&v17 + 1) + 8 * v13), "connection"), "output"), "node");
          if (v14)
          {
            v15 = v14;
...
- (uint64_t)_nextUnvisitedParent:(uint64_t)a1
{
  ...
  v11 = 0u;
  v12 = 0u;
  v3 = (void *)objc_msgSend((id)objc_msgSend(a2, "inputs", 0), "reverseObjectEnumerator");
...
LABEL_4:
  ...
  while (1)
  {
    ...
    v8 = objc_msgSend((id)objc_msgSend((id)objc_msgSend(*(id *)(*((_QWORD *)&v11 + 1) + 8 * v7), "connection"), "output"), "node");
    if (v8)
    {
      v9 = v8;
...
{
  BWReverseDepthFirstEnumerator *v5;
  BWReverseDepthFirstEnumerator *v6;
  objc_super v8;
