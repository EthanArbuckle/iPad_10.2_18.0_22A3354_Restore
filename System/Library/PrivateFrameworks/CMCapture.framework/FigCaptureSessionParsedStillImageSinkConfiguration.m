...
- (_QWORD)initWithStillImageConnectionConfiguration:(void *)a3 movieFileVideoConnectionConfiguration:(void *)a4 pointCloudDataConnectionConfiguration:
{
  _QWORD *v7;
  objc_super v9;
...
- (void)dealloc
{
  ...
  -[FigCaptureSessionParsedStillImageSinkConfiguration dealloc](&v3, sel_dealloc);
}
