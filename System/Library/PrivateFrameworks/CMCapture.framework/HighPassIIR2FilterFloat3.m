...
{
  HighPassIIR2FilterFloat3 *v2;
  HighPassIIR2FilterFloat3 *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)HighPassIIR2FilterFloat3;
  v2 = -[HighPassIIR2FilterFloat3 init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[HighPassIIR2FilterFloat3 reset](v2, "reset");
  return v3;
}
...
- (float32x4_t)updateValue:(double)a3 withPole:
{
  ...
  if (*(float *)&a3 > 0.0 && *(float *)&a3 < 1.0)
  {
    ...
    *(float *)&a3 = 1.0
    ...
    result = vdivq_f32(vsubq_f32(a2, v11), (float32x4_t)vdupq_lane_s32(*(int32x2_t *)&a3, 0));
    a1[4] = result;
  }
  else
  {
