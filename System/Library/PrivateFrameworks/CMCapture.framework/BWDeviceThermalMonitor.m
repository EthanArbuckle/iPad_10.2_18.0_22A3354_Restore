...
- (BWDeviceThermalMonitor)init
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)BWDeviceThermalMonitor;
  v2 = -[BWDeviceThermalMonitor init](&v11, sel_init);
  if (v2)
  {
    ...
    *((_QWORD *)v2 + 1) = v4;
    ...
    handler[4] = v5;
    if (!notify_register_dispatch((const char *)*MEMORY[0x1E0C839F8], (int *)v2 + 4, *((dispatch_queue_t *)v2 + 1), handler))
    {
      v7 = *((_QWORD *)v2 + 1);
      block[0] = v6;
      block[1] = 3221225472;
...
- (void)dealloc
{
  ...
  -[BWDeviceThermalMonitor dealloc](&v4, sel_dealloc);
}
