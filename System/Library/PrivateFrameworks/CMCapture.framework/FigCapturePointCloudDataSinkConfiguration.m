...
{
  FigCapturePointCloudDataSinkConfiguration *v4;
  objc_super v6;
...
- (id)copyXPCEncoding
{
  ...
  xpc_dictionary_set_BOOL(v3, "discardsLatePointCloudData", -[FigCapturePointCloudDataSinkConfiguration discardsLatePointCloudData](self, "discardsLatePointCloudData"));
  return v3;
}
...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@ discards:%d"), -[FigCaptureSinkConfiguration description](&v3, sel_description), -[FigCapturePointCloudDataSinkConfiguration discardsLatePointCloudData](self, "discardsLatePointCloudData"));
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      v6 = -[FigCapturePointCloudDataSinkConfiguration discardsLatePointCloudData](self, "discardsLatePointCloudData");
      LOBYTE(v5) = v6 ^ objc_msgSend(a3, "discardsLatePointCloudData") ^ 1;
    }
    else
    {
      LOBYTE(v5) = 0;
