...
{
  BWPointCloudDensificationNodeConfiguration *v16;
  objc_super v18;

  v18.receiver = self;
  v18.super_class = (Class)BWPointCloudDensificationNodeConfiguration;
  v16 = -[BWPointCloudDensificationNodeConfiguration init](&v18, sel_init);
  if (v16)
  {
...
- (void)dealloc
{
  ...
  -[BWPointCloudDensificationNodeConfiguration dealloc](&v3, sel_dealloc);
}
