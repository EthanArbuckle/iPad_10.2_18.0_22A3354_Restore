...
+ (void)addRulesForU1ToCollection:(id)a3
{
  ...
  v19 = 0u;
  v20 = 0u;
  v4 = objc_msgSend(&unk_1E9EFA220, "countByEnumeratingWithState:objects:count:", &v17, v16, 16);
  if (v4)
  {
    v5 = v4;
    v6 = *(_QWORD *)v18;
    while (2)
    {
      ...
      {
        if (*(_QWORD *)v18 != v6)
          objc_enumerationMutation(&unk_1E9EFA220);
        v8 = objc_msgSend(*(id *)(*((_QWORD *)&v17 + 1) + 8 * i), "intValue");
        v9 = [VCVideoRule alloc];
        LODWORD(v10) = 30.0;
        v11 = -[VCVideoRule initWithFrameWidth:frameHeight:frameRate:payload:](v9, "initWithFrameWidth:frameHeight:frameRate:payload:", 480, 480, v8, v10);
        if (!v11)
        {
          if ((int)VRTraceGetErrorLogLevelForModule() >= 3)
          {
            ...
            if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0CF2758], OS_LOG_TYPE_ERROR))
              +[VCVideoRuleCollectionsBodyData addRulesForU1ToCollection:].cold.1(v14, (uint64_t)a3, v15);
          }
          return;
        }
        v12 = (void *)v11;
      ...
      v5 = objc_msgSend(&unk_1E9EFA220, "countByEnumeratingWithState:objects:count:", &v17, v16, 16);
      if (v5)
        continue;
      break;
    }
...
+ (void)addRulesForU1ToCollection:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v4 = a1;
  v5 = 2080;
  v6 = "+[VCVideoRuleCollectionsBodyData addRulesForU1ToCollection:]";
  v7 = 1024;
  v8 = 19;
  v9 = 2112;
  v10 = a2;
