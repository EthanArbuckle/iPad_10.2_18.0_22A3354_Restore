...
- (id)description
{
  ...
  -[WiFiAnalyticsAWDWiFiUsageSnapshot description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WiFiAnalyticsAWDWiFiUsageSnapshot dictionaryRepresentation](self, "dictionaryRepresentation");
