...
- (id)description
{
  ...
  -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats packetsCount](self, "packetsCount"))
  {
    objc_msgSend(v37, "clearPackets");
    v4 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats packetsCount](self, "packetsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats packetsAtIndex:](self, "packetsAtIndex:", i);
  ...
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats bytesCount](self, "bytesCount"))
  {
    objc_msgSend(v37, "clearBytes");
    v8 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats bytesCount](self, "bytesCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats bytesAtIndex:](self, "bytesAtIndex:", j);
  ...
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats npeersCount](self, "npeersCount"))
  {
    objc_msgSend(v37, "clearNpeers");
    v12 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats npeersCount](self, "npeersCount");
    if (v12)
    {
      v13 = v12;
      for (k = 0; k != v13; ++k)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats npeersAtIndex:](self, "npeersAtIndex:", k);
...
LABEL_20:
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats enableStatesCount](self, "enableStatesCount"))
  {
    objc_msgSend(v37, "clearEnableStates");
    v17 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats enableStatesCount](self, "enableStatesCount");
    if (v17)
    {
      v18 = v17;
      for (m = 0; m != v18; ++m)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats enableStateAtIndex:](self, "enableStateAtIndex:", m);
  ...
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyBKsCount](self, "txLatencyBKsCount"))
  {
    objc_msgSend(v37, "clearTxLatencyBKs");
    v21 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyBKsCount](self, "txLatencyBKsCount");
    if (v21)
    {
      v22 = v21;
      for (n = 0; n != v22; ++n)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyBKAtIndex:](self, "txLatencyBKAtIndex:", n);
  ...
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyBEsCount](self, "txLatencyBEsCount"))
  {
    objc_msgSend(v37, "clearTxLatencyBEs");
    v25 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyBEsCount](self, "txLatencyBEsCount");
    if (v25)
    {
      v26 = v25;
      for (ii = 0; ii != v26; ++ii)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyBEAtIndex:](self, "txLatencyBEAtIndex:", ii);
        v28 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyVOsCount](self, "txLatencyVOsCount"))
  {
    objc_msgSend(v37, "clearTxLatencyVOs");
    v29 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyVOsCount](self, "txLatencyVOsCount");
    if (v29)
    {
      v30 = v29;
      for (jj = 0; jj != v30; ++jj)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyVOAtIndex:](self, "txLatencyVOAtIndex:", jj);
  ...
  if (-[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyVIsCount](self, "txLatencyVIsCount"))
  {
    objc_msgSend(v37, "clearTxLatencyVIs");
    v33 = -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyVIsCount](self, "txLatencyVIsCount");
    if (v33)
    {
      v34 = v33;
      for (kk = 0; kk != v34; ++kk)
      {
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats txLatencyVIAtIndex:](self, "txLatencyVIAtIndex:", kk);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v75 != v8)
          objc_enumerationMutation(v5);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addPackets:](self, "addPackets:", *(_QWORD *)(*((_QWORD *)&v74 + 1) + 8 * i));
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        if (*(_QWORD *)v71 != v13)
          objc_enumerationMutation(v10);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addBytes:](self, "addBytes:", *(_QWORD *)(*((_QWORD *)&v70 + 1) + 8 * j));
      }
  ...
  if (v16)
  {
    ...
    do
    {
      for (k = 0; k != v17; ++k)
      {
        if (*(_QWORD *)v67 != v18)
          objc_enumerationMutation(v15);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addNpeers:](self, "addNpeers:", *(_QWORD *)(*((_QWORD *)&v66 + 1) + 8 * k));
      }
  ...
  if (v22)
  {
    ...
    do
    {
      for (m = 0; m != v23; ++m)
      {
        if (*(_QWORD *)v63 != v24)
          objc_enumerationMutation(v21);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addEnableState:](self, "addEnableState:", *(_QWORD *)(*((_QWORD *)&v62 + 1) + 8 * m));
      }
  ...
  if (v27)
  {
    ...
    do
    {
      for (n = 0; n != v28; ++n)
      {
        if (*(_QWORD *)v59 != v29)
          objc_enumerationMutation(v26);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addTxLatencyBK:](self, "addTxLatencyBK:", *(_QWORD *)(*((_QWORD *)&v58 + 1) + 8 * n));
      }
  ...
  if (v32)
  {
    ...
    do
    {
      for (ii = 0; ii != v33; ++ii)
      {
        if (*(_QWORD *)v55 != v34)
          objc_enumerationMutation(v31);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addTxLatencyBE:](self, "addTxLatencyBE:", *(_QWORD *)(*((_QWORD *)&v54 + 1) + 8 * ii));
      }
  ...
  if (v37)
  {
    ...
    do
    {
      for (jj = 0; jj != v38; ++jj)
      {
        if (*(_QWORD *)v51 != v39)
          objc_enumerationMutation(v36);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addTxLatencyVO:](self, "addTxLatencyVO:", *(_QWORD *)(*((_QWORD *)&v50 + 1) + 8 * jj));
      }
  ...
  if (v42)
  {
    ...
    do
    {
      for (kk = 0; kk != v43; ++kk)
      {
        if (*(_QWORD *)v47 != v44)
          objc_enumerationMutation(v41);
        -[WiFiAnalyticsAWDWiFiNWActivityIRInterfaceStats addTxLatencyVI:](self, "addTxLatencyVI:", *(_QWORD *)(*((_QWORD *)&v46 + 1) + 8 * kk), (_QWORD)v46);
      }
