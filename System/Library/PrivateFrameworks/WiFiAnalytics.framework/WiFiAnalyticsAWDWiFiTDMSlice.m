...
- (id)description
{
  ...
  -[WiFiAnalyticsAWDWiFiTDMSlice description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WiFiAnalyticsAWDWiFiTDMSlice dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x200) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txaONCount);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("txaONCount"));
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txaTimeoutCount);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("txaTimeoutCount"));
...
LABEL_17:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txaPORCount);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("txaPORCount"));
...
LABEL_18:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txPathEnableReqCount);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v10, CFSTR("txPathEnableReqCount"));
...
LABEL_19:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txPathMuteCount);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v11, CFSTR("txPathMuteCount"));
...
LABEL_20:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txPriorityCount);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v12, CFSTR("txPriorityCount"));
...
LABEL_21:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txDeferredCount);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v13, CFSTR("txDeferredCount"));
...
LABEL_22:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_txMuteCount);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v14, CFSTR("txMuteCount"));
...
LABEL_23:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_ackTxPowerBackoffCount);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v15, CFSTR("ackTxPowerBackoffCount"));
...
LABEL_11:
    if ((has & 2) == 0)
      goto LABEL_12;
LABEL_25:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_txPriDuration);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v17, CFSTR("txPriDuration"));
...
LABEL_24:
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_txaDuration);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v16, CFSTR("txaDuration"));
...
LABEL_12:
  ...
  {
LABEL_13:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_txDeferDuration);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("txDeferDuration"));
...
LABEL_11:
    if ((has & 2) == 0)
      goto LABEL_12;
LABEL_25:
    *((_QWORD *)v4 + 2) = self->_txPriDuration;
    *((_WORD *)v4 + 34) |= 2u;
    if ((*(_WORD *)&self->_has & 1) == 0)
      goto LABEL_14;
    goto LABEL_13;
...
LABEL_12:
  ...
  {
LABEL_13:
    *((_QWORD *)v4 + 1) = self->_txDeferDuration;
    *((_WORD *)v4 + 34) |= 1u;
  }
LABEL_14:
...
LABEL_62:
  ...
  if ((has & 4) != 0)
  {
    if ((v6 & 4) == 0 || self->_txaDuration != *((_QWORD *)v4 + 3))
      goto LABEL_62;
  }
  else if ((v6 & 4) != 0)
  {
  ...
  if ((has & 2) != 0)
  {
    if ((v6 & 2) == 0 || self->_txPriDuration != *((_QWORD *)v4 + 2))
      goto LABEL_62;
  }
  else if ((v6 & 2) != 0)
  {
  ...
  if ((has & 1) != 0)
  {
    if ((v6 & 1) == 0 || self->_txDeferDuration != *((_QWORD *)v4 + 1))
      goto LABEL_62;
    v7 = 1;
  }
  else
...
LABEL_11:
    if ((v5 & 2) == 0)
      goto LABEL_12;
LABEL_25:
    self->_txPriDuration = *((_QWORD *)v4 + 2);
    *(_WORD *)&self->_has |= 2u;
    if ((*((_WORD *)v4 + 34) & 1) == 0)
      goto LABEL_14;
    goto LABEL_13;
...
LABEL_12:
  ...
  {
LABEL_13:
    self->_txDeferDuration = *((_QWORD *)v4 + 1);
    *(_WORD *)&self->_has |= 1u;
  }
LABEL_14:
