...
- (void)addSliceStats:(id)a3
{
  ...
  -[NSMutableArray addObject:](sliceStats, "addObject:", v4);
...
- (id)description
{
  ...
  -[WiFiAnalyticsAWDWiFiTDM description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WiFiAnalyticsAWDWiFiTDM dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[WiFiAnalyticsAWDWiFiTDM sliceStatsCount](self, "sliceStatsCount"))
  {
    objc_msgSend(v8, "clearSliceStats");
    v4 = -[WiFiAnalyticsAWDWiFiTDM sliceStatsCount](self, "sliceStatsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[WiFiAnalyticsAWDWiFiTDM sliceStatsAtIndex:](self, "sliceStatsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addSliceStats:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)sliceStats | v4[1])
      v6 = -[NSMutableArray isEqual:](sliceStats, "isEqual:");
    else
      v6 = 1;
  }
  else
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[WiFiAnalyticsAWDWiFiTDM addSliceStats:](self, "addSliceStats:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
...
{
  objc_storeStrong((id *)&self->_sliceStats, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_sliceStats, 0);
}
