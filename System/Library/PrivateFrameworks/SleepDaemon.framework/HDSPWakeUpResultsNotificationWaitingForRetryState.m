...
- (void)didEnter
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v6, "scheduleRetryAttempt");
...
- (void)didExit
{
  ...
  if (v5)
  {
    -[HKSPStateMachineState stateMachine](self, "stateMachine");
    v6 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "unscheduleRetryAttempt");
...
- (void)retryAttemptEventDue
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v4 = v9;
    _os_log_impl(&dword_21610C000, v3, OS_LOG_TYPE_DEFAULT, "[%{public}@] Received retry event", (uint8_t *)&v8, 0xCu);
