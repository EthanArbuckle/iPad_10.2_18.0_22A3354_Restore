...
- (int)StringAsSyncType:(id)a3
{
  ...
  v3 = a3;
  v4 = 1;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("Reset")) & 1) == 0)
  {
    if (objc_msgSend(v3, "isEqualToString:", CFSTR("Delta")))
      v4 = 2;
    else
      v4 = 1;
  }
...
- (id)description
{
  ...
  -[MSPMediaSyncHeader description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[MSPMediaSyncHeader dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_totalPackages);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("totalPackages"));
  ...
  if ((has & 1) != 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_syncType);
      v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("syncType"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_totalPackages != *((_DWORD *)v4 + 3))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_syncType != *((_DWORD *)v4 + 2))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
