...
- (BOOL)registerWithConnection:(id)a3
{
  ...
  if (self->_block)
  {
    ...
    LODWORD(v6) = sqlite3_create_function_v2(v6, (const char *)objc_msgSend(v7, "UTF8String"), -[ML3DatabaseFunction argumentCount](self, "argumentCount"), 2049, self, (void (__cdecl *)(sqlite3_context *, int, sqlite3_value **))_ML3DatabaseFunctionRunBlock, 0, 0, 0);
