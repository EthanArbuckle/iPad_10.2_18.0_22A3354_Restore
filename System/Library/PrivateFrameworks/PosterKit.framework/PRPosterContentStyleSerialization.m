...
+ (id)dataForContentStyle:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      +[PRPosterContentStyleSerialization dataForContentStyle:error:].cold.1((uint64_t)v5, (uint64_t)v8, v9);
...
+ (id)contentStyleForData:(id)a3 error:(id *)a4
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      +[PRPosterContentStyleSerialization contentStyleForData:error:].cold.1((uint64_t)v11, v12);
...
+ (void)dataForContentStyle:(os_log_t)log error:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2114;
  v6 = a2;
  _os_log_error_impl(&dword_18B634000, log, OS_LOG_TYPE_ERROR, "Failed to archive %@: %{public}@", (uint8_t *)&v3, 0x16u);
}
...
+ (void)contentStyleForData:(uint64_t)a1 error:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138543362;
  v3 = a1;
  _os_log_debug_impl(&dword_18B634000, a2, OS_LOG_TYPE_DEBUG, "Unable to unarchive content style: %{public}@", (uint8_t *)&v2, 0xCu);
}
