...
- (double)itemViewLuminance
{
  ...
  -[_PREditingPosterContentTwoToneStyleCoordinatorImpl effectiveColor1](self, "effectiveColor1");
...
- (id)itemView
{
  ...
  if (!itemView)
  {
    -[_PREditingPosterContentTwoToneStyleCoordinatorImpl effectiveColor1](self, "effectiveColor1");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    -[_PREditingPosterContentTwoToneStyleCoordinatorImpl effectiveColor2](self, "effectiveColor2");
    ...
    v9 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3F10]), "initWithFrame:", 0.0, 0.0, 50.0, 50.0);
    -[UIView setClipsToBounds:](v9, "setClipsToBounds:", 1);
    v10 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3F10]), "initWithFrame:", 0.0, 0.0, 25.0, 50.0);
    ...
    v11 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3F10]), "initWithFrame:", 25.0, 0.0, 25.0, 50.0);
