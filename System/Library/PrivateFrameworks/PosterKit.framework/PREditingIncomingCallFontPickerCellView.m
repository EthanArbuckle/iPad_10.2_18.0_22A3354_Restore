...
- (void)configureWithFont:(id)a3 text:(id)a4
{
  ...
  v7 = a4;
  -[PREditingFontPickerCellView configureWithFont:text:](&v9, sel_configureWithFont_text_, v6, v7);
  if (objc_msgSend(v7, "length", v9.receiver, v9.super_class) == 1)
  {
    -[PREditingIncomingCallFontPickerCellView imageRepresentingFont:text:](self, "imageRepresentingFont:text:", v6, v7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();

    if (v8)
      -[PREditingIncomingCallFontPickerCellView displayImage:](self, "displayImage:", v8);
    else
      -[PREditingIncomingCallFontPickerCellView displayText:usingFont:](self, "displayText:usingFont:", CFSTR("Aa"), v6);
  }
  else
  {
    -[PREditingIncomingCallFontPickerCellView displayText:usingFont:](self, "displayText:usingFont:", v7, v6);
    v8 = v7;
  }
...
- (void)displayText:(id)a3 usingFont:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[PREditingIncomingCallFontPickerCellView contentView](self, "contentView");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  ...
  else
  {
    ...
    -[PREditingIncomingCallFontPickerCellView addSubview:](self, "addSubview:", v15);
    v24 = (void *)MEMORY[0x1E0CB3718];
    objc_msgSend(v15, "topAnchor");
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    -[PREditingIncomingCallFontPickerCellView topAnchor](self, "topAnchor");
    ...
    -[PREditingIncomingCallFontPickerCellView bottomAnchor](self, "bottomAnchor");
    ...
    -[PREditingIncomingCallFontPickerCellView leadingAnchor](self, "leadingAnchor");
    ...
    -[PREditingIncomingCallFontPickerCellView trailingAnchor](self, "trailingAnchor");
...
- (void)displayImage:(id)a3
{
  ...
  else
  {
    ...
    -[PREditingIncomingCallFontPickerCellView addSubview:](self, "addSubview:", v12);
    v24 = (void *)MEMORY[0x1E0CB3718];
...
- (id)imageRepresentingFont:(id)a3 text:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "pr_fontWithName:forRole:includingFallbackFonts:", v8, CFSTR("PRPosterRoleIncomingCall"), 0);
  ...
  v12 = -[PREditingIncomingCallFontPickerCellView glyphForText:usingFontRef:](self, "glyphForText:usingFontRef:", v6, v11);
  if ((_DWORD)v12)
  {
    -[PREditingIncomingCallFontPickerCellView imageFromGlyph:fromFontRef:](self, "imageFromGlyph:fromFontRef:", v12, v11);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = v13;
    if (v13)
      v15 = v13;
...
- (id)imageFromGlyph:(unsigned __int16)a3 fromFontRef:(__CTFont *)a4
{
  ...
  v10 = (const CGPath *)MEMORY[0x18D77BE00](PathForGlyph, &v19);
  -[PREditingFontPickerCellView cellSize](self, "cellSize");
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  -[PREditingIncomingCallFontPickerCellView traitCollectionDidChange:](&v6, sel_traitCollectionDidChange_, a3);
  -[PREditingFontPickerCellView contentFont](self, "contentFont");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PREditingFontPickerCellView contentText](self, "contentText");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[PREditingIncomingCallFontPickerCellView configureWithFont:text:](self, "configureWithFont:text:", v4, v5);
