...
{
  PRSelectableEditingItemView *v3;
  CGPath *Mutable;
  CGFloat v5;
  CGFloat v6;
  id v7;
  ...
  if (v3)
  {
    ...
    -[PRSelectableEditingItemView intrinsicContentSize](v3, "intrinsicContentSize");
    v38.size.width = v5;
    v38.size.height = v6;
    v38.origin.x = 0.0;
    v38.origin.y = 0.0;
    ...
    v7 = objc_alloc_init(MEMORY[0x1E0D7FD28]);
    ...
    -[PRSelectableEditingItemView addSubview:](v3, "addSubview:", v7);
    ...
    -[PRSelectableEditingItemView topAnchor](v3, "topAnchor");
    ...
    -[PRSelectableEditingItemView leadingAnchor](v3, "leadingAnchor");
    ...
    -[PRSelectableEditingItemView trailingAnchor](v3, "trailingAnchor");
    ...
    -[PRSelectableEditingItemView bottomAnchor](v3, "bottomAnchor");
    ...
    v34 = v32;
    v23 = v32;
    v24 = (id)-[PRSelectableEditingItemView registerForTraitChanges:withHandler:](v3, "registerForTraitChanges:withHandler:", v22, v33);
...
- (void)setSelected:(BOOL)a3
{
  ...
  if (self->_selected != a3)
  {
    v3 = a3;
    self->_selected = a3;
    -[PRSelectableEditingItemView selectionView](self, "selectionView");
