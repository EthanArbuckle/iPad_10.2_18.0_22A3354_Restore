...
- (PREditorColorPickerConstantColor)init
{
  ...
  v4 = -[PREditorColorPickerConstantColor initWithBaseUIColor:](self, "initWithBaseUIColor:", v3);
...
{
  return -[PREditorColorPickerConstantColor initWithBaseUIColor:initialVariation:](self, "initWithBaseUIColor:initialVariation:", a3, 0.0);
}
...
- (PREditorColorPickerConstantColor)initWithBaseUIColor:(id)a3 initialVariation:(double)a4
{
  ...
  v6 = a3;
  v7 = -[PRPosterColor initWithColor:preferredStyle:]([PRPosterColor alloc], "initWithColor:preferredStyle:", v6, 0);

  v8 = -[PREditorColorPickerConstantColor initWithColor:initialVariation:](self, "initWithColor:initialVariation:", v7, a4);
  return v8;
}
...
{
  id v6;
  PREditorColorPickerConstantColor *v7;
  uint64_t v8;
  PRPosterColor *color;
  objc_super v11;
  ...
  v7 = -[PREditorColorPickerConstantColor init](&v11, sel_init);
  if (v7)
  {
...
{
  return (PRPosterColor *)-[PREditorColorPickerConstantColor colorWithVariation:](self, "colorWithVariation:", -1.0);
}
...
- (PREditorColorPickerConstantColor)colorWithVariation:(double)a3
{
  ...
  return (PREditorColorPickerConstantColor *)-[PRPosterColor copyWithLuminance:](self->_color, "copyWithLuminance:");
}
...
- (double)variationForLuminance:(double)a3
{
  ...
  -[PREditorColorPickerConstantColor baseColor](self, "baseColor");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[PREditorColorPickerConstantColor leftSliderColor](self, "leftSliderColor");
  ...
  if (v12 <= 1.0)
    ...
    v13 = 1.0;
  -[PREditorColorPickerConstantColor rightSliderColor](self, "rightSliderColor");
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = (PREditorColorPickerConstantColor *)a3;
  if (self == v4)
  {
    v14 = 1;
  }
  else
  {
    ...
    if ((isKindOfClass & 1) != 0)
    {
      ...
      -[PREditorColorPickerConstantColor baseColor](v7, "baseColor");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = BSEqualObjects();

      if (v10
        && (-[PREditorColorPickerConstantColor initialVariation](self, "initialVariation"),
            v12 = v11,
            -[PREditorColorPickerConstantColor initialVariation](v7, "initialVariation"),
            v12 == v13))
      {
        -[PREditorColorPickerConstantColor localizedName](self, "localizedName");
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        -[PREditorColorPickerConstantColor localizedName](v7, "localizedName");
...
- (unint64_t)hash
{
  ...
  -[PREditorColorPickerConstantColor color](self, "color");
...
- (NSString)description
{
  ...
  void *v10;
  PREditorColorPickerConstantColor *v11;
  id v12;
...
- (PREditorColorPickerConstantColor)initWithCoder:(id)a3
{
  ...
  double v7;
  double v8;
  PREditorColorPickerConstantColor *v9;
  ...
  v9 = -[PREditorColorPickerConstantColor initWithColor:initialVariation:](self, "initWithColor:initialVariation:", v6, v8);
  return v9;
}
