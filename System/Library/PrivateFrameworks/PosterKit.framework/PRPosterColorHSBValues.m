...
- (PRPosterColorHSBValues)initWithColor:(id)a3
{
  ...
  return -[PRPosterColorHSBValues initWithHue:saturation:brightness:](self, "initWithHue:saturation:brightness:", v7, v6, v5);
}

- (PRPosterColorHSBValues)initWithHue:(double)a3 saturation:(double)a4 brightness:(double)a5
{
  PRPosterColorHSBValues *result;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)PRPosterColorHSBValues;
  result = -[PRPosterColorHSBValues init](&v9, sel_init);
  if (result)
  {
    result->_hue = a3;
...
- (id)hslValues
{
  ...
  if (v4 > 0.0)
    v5 = (brightness - v3) / v4;
  return -[PRPosterColorHSLValues initWithHue:saturation:luminance:]([PRPosterColorHSLValues alloc], "initWithHue:saturation:luminance:", self->_hue, v5, v3);
}
...
- (id)colorWithAlpha:(double)a3
{
  ...
  -[PRPosterColorHSBValues hue](self, "hue");
  v7 = v6;
  -[PRPosterColorHSBValues saturation](self, "saturation");
  v9 = v8;
  -[PRPosterColorHSBValues brightness](self, "brightness");
