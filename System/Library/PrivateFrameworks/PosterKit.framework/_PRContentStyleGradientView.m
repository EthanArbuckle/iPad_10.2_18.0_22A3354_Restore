...
{
  _PRContentStyleGradientView *v3;
  _PRContentStyleGradientView *v4;
  uint64_t v5;
  ...
  if (v3)
  {
    -[_PRContentStyleGradientView setClipsToBounds:](v3, "setClipsToBounds:", 1);
    ...
    -[_PRContentStyleGradientView bounds](v4, "bounds");
    -[CAGradientLayer setFrame:](v7, "setFrame:");
    -[_PRContentStyleGradientView layer](v4, "layer");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "addSublayer:", v4->_gradientLayer);

    objc_msgSend(MEMORY[0x1E0CD2780], "filterWithType:", *MEMORY[0x1E0CD2C88]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "setValue:forKey:", &unk_1E21DCDD0, CFSTR("inputRadius"));
...
- (void)layoutSubviews
{
  ...
  -[_PRContentStyleGradientView layoutSubviews](&v4, sel_layoutSubviews);
  gradientLayer = self->_gradientLayer;
  -[_PRContentStyleGradientView bounds](self, "bounds");
