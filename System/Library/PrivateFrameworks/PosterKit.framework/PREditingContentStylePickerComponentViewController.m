...
{
  id v5;
  PREditingContentStylePickerComponentViewController *v6;
  PREditingContentStylePickerComponentViewController *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)PREditingContentStylePickerComponentViewController;
  v6 = -[PREditingContentStylePickerComponentViewController init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
{
  PREditorContentStylePickerConfiguration *v3;
  PREditingContentStylePickerComponentViewController *v4;

  v3 = objc_alloc_init(PREditorContentStylePickerConfiguration);
  v4 = -[PREditingContentStylePickerComponentViewController initWithConfiguration:](self, "initWithConfiguration:", v3);
...
- (void)loadItemsViewControllerIfNeeded
{
  void *v3;
  uint64_t v4;
  PREditingContentStyleItemsViewController *v5;
  PREditingContentStyleItemsScrollableStackViewController *v6;
  PUIColorWellView *v7;
  ...
  PREditingContentStyleItemsDataSource *v13;

  if (!self->_itemsViewController)
  {
    v13 = -[PREditingContentStyleItemsDataSource initWithConfiguration:includesSuggestedStyle:delegate:]([PREditingContentStyleItemsDataSource alloc], "initWithConfiguration:includesSuggestedStyle:delegate:", self->_configuration, 1, self);
    objc_storeStrong((id *)&self->_dataSource, v13);
    if (-[PREditorContentStylePickerConfiguration isForTitleStylePicker](self->_configuration, "isForTitleStylePicker")
    ...
    {
      v6 = -[PREditingContentStyleItemsViewController initWithDataSource:configuration:]([PREditingContentStyleItemsScrollableStackViewController alloc], "initWithDataSource:configuration:", v13, self->_configuration);
      -[PREditingContentStyleItemsViewController setDelegate:](v6, "setDelegate:", self);
    }
    else
    {
      v5 = -[PREditingContentStyleItemsViewController initWithDataSource:configuration:]([PREditingContentStyleItemsViewController alloc], "initWithDataSource:configuration:", v13, self->_configuration);
      -[PREditingContentStyleItemsViewController setDelegate:](v5, "setDelegate:", self);
      v6 = v5;
      if (-[PREditorContentStylePickerConfiguration colorWellDisplayMode](self->_configuration, "colorWellDisplayMode") == 2)
      {
        -[PREditingContentStyleItemsViewController colorWellView](v6, "colorWellView");
    ...
    -[PREditingContentStyleItemsViewController setContentsLuminance:](v6, "setContentsLuminance:", self->_contentsLuminance);
...
- (void)loadView
{
  ...
  void *v15;
  void *v16;
  PREditingVariationSlider *v17;
  void *v18;
  PREditingVariationSlider *v19;
  void *v20;
  void *v21;
  char v22;
  PREditingVariationSlider *v23;
  void *v24;
  void *v25;
  void *v26;
  void *v27;
  ...
  -[PREditingContentStylePickerComponentViewController loadItemsViewControllerIfNeeded](self, "loadItemsViewControllerIfNeeded");
  -[PREditingContentStylePickerComponentViewController itemsViewController](self, "itemsViewController");
  ...
  objc_msgSend(v9, "selectedContentStyleCoordinator");
  v13 = objc_claimAutoreleasedReturnValue();
  -[PREditingContentStyleItemsDataSource firstCoordinatorPassingTest:](self->_dataSource, "firstCoordinatorPassingTest:", &__block_literal_global_359);
  v14 = (void *)objc_claimAutoreleasedReturnValue();

  v70 = (void *)v13;
  if (!v13)
  {
    -[PREditingContentStylePickerComponentViewController delegate](self, "delegate");
  ...
  if (v14)
  {
    ...
    -[PREditorContentStylePickerConfiguration identifier](self->_configuration, "identifier");
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = -[PREditingVariationSlider initWithStyleCoordinator:contextIdentifier:](v17, "initWithStyleCoordinator:contextIdentifier:", v70, v18);

    -[PREditingVariationSlider addTarget:action:forControlEvents:](v19, "addTarget:action:forControlEvents:", self, sel_colorSliderDidUpdateVariation_, 4096);
    objc_msgSend(v9, "selectedContentStyleCoordinator");
    ...
    v23 = v19;
    if ((v22 & 1) == 0)
      -[PREditingVariationSlider setHidden:](v19, "setHidden:", 1);
  ...
  v66 = v12;
  v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0DC3CA8]), "initWithArrangedSubviews:", v12);
  ...
  -[PREditingContentStylePickerComponentViewController addChildViewController:](self, "addChildViewController:", v9);
  -[PREditingContentStylePickerComponentViewController setView:](self, "setView:", v3);
  v67 = v9;
  ...
  if (v23)
  {
    -[PREditingVariationSlider heightAnchor](v73, "heightAnchor");
    v38 = (void *)objc_claimAutoreleasedReturnValue();
    +[PREditingVariationSlider defaultHeight](PREditingVariationSlider, "defaultHeight");
    objc_msgSend(v38, "constraintEqualToConstant:");
    v39 = (void *)objc_claimAutoreleasedReturnValue();
    v75[0] = v39;
    -[PREditingVariationSlider leadingAnchor](v73, "leadingAnchor");
    ...
    v75[1] = v42;
    -[PREditingVariationSlider trailingAnchor](v73, "trailingAnchor");
  ...
  v74[4] = v53;
  objc_msgSend(*(id *)(v37 + 3360), "arrayWithObjects:count:", v74, 5);
...
- (void)setContentsLuminance:(double)a3
{
  ...
  if (-[PREditingContentStylePickerComponentViewController isViewLoaded](self, "isViewLoaded"))
    -[PREditingContentStyleItemsViewController setContentsLuminance:](self->_itemsViewController, "setContentsLuminance:", a3);
}
...
- (double)estimatedHeight
{
  ...
  -[PREditingContentStylePickerComponentViewController loadItemsViewControllerIfNeeded](self, "loadItemsViewControllerIfNeeded");
  -[PREditingContentStyleItemsViewController estimatedHeight](self->_itemsViewController, "estimatedHeight");
  v4 = v3;
  if (self->_sliderView)
  {
    -[PREditingContentStyleItemsViewController selectedContentStyleCoordinator](self->_itemsViewController, "selectedContentStyleCoordinator");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "style");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v6, "allowsVariation") & 1) != 0)
    {
      v7 = -[PREditingContentStylePickerComponentViewController shouldShowContentStyleItems](self, "shouldShowContentStyleItems");
...
- (void)contentStyleItemsViewController:(id)a3 didSelectContentStyleCoordinator:(id)a4
{
  ...
  -[PREditingContentStyleItemsDataSource firstCoordinatorPassingTest:](self->_dataSource, "firstCoordinatorPassingTest:", &__block_literal_global_363);
  v8 = (void *)objc_claimAutoreleasedReturnValue();

  if (v8 && (_DWORD)v7 == -[PREditingVariationSlider isHidden](self->_sliderView, "isHidden"))
    -[PREditingContentStylePickerComponentViewController updateSliderVisibility:](self, "updateSliderVisibility:", v7);
  -[PREditingVariationSlider setStyleCoordinator:](self->_sliderView, "setStyleCoordinator:", v5);
  objc_msgSend(v5, "style");
  v10 = (id)objc_claimAutoreleasedReturnValue();
  v9 = objc_msgSend(v5, "isSuggested");

  -[PREditingContentStylePickerComponentViewController _didSelectContentStyle:isSuggestedStyle:](self, "_didSelectContentStyle:isSuggestedStyle:", v10, v9);
}
...
- (void)contentStyleItemsViewControllerDidUpdateEstimatedSize:(id)a3
{
  ...
  -[PREditingContentStylePickerComponentViewController delegate](self, "delegate", a3);
  v4 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "contentStylePickerComponentViewControllerDidChangeHeight:", self);
...
- (void)updateSliderVisibility:(BOOL)a3
{
  ...
  -[PREditingVariationSlider setHidden:](self->_sliderView, "setHidden:", !a3);
  -[PREditingContentStylePickerComponentViewController delegate](self, "delegate");
  v4 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "contentStylePickerComponentViewControllerDidChangeHeight:", self);
...
- (void)_didSelectContentStyle:(id)a3 isSuggestedStyle:(BOOL)a4
{
  ...
  objc_msgSend(v7, "contentStylePickerComponentViewController:didSelectStyle:isSuggestedStyle:userSelected:", self, v6, v4, 1);
...
- (void)colorSliderDidUpdateVariation:(id)a3
{
  ...
  -[PREditingContentStyleItemsViewController selectedContentStyleCoordinator](self->_itemsViewController, "selectedContentStyleCoordinator", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4)
  {
    v6 = v4;
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[PREditingContentStylePickerComponentViewController _didSelectContentStyle:isSuggestedStyle:](self, "_didSelectContentStyle:isSuggestedStyle:", v5, objc_msgSend(v6, "isSuggested"));
...
- (id)coordinatorForStyle:(id)a3 isSuggestedStyle:(BOOL)a4 fromDataSource:(id)a5
{
  ...
  -[PREditingContentStylePickerComponentViewController delegate](self, "delegate");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "contentStylePickerComponentViewController:coordinatorForStyle:isSuggested:", self, v7, v5);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (PREditingContentStylePickerComponentViewControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
...
{
  objc_storeStrong((id *)&self->_uiKitColorPickerContentStyleCoordinator, a3);
}
