...
+ (id)posterColorForColor:(id)a3 withAppliedVariation:(double)a4
{
  ...
  v5 = a3;
  v6 = -[PRPosterColor initWithColor:preferredStyle:]([PRPosterColor alloc], "initWithColor:preferredStyle:", v5, 0);

  v7 = a4 * -0.25;
  -[PRPosterColor hslValues](v6, "hslValues");
  ...
  if (v11 > 1.0)
    v11 = 1.0;
  v12 = -[PRPosterColor copyWithLuminance:](v6, "copyWithLuminance:", v11);
...
{
  id v6;
  PREditingColorVariationStore *v7;
  ...
  v7 = -[PREditingColorVariationStore init](&v14, sel_init);
  if (v7)
  {
...
{
  return -[PREditingColorVariationStore initWithVariationStorage:version:](self, "initWithVariationStorage:version:", 0, objc_msgSend((id)objc_opt_class(), "version"));
}
...
- (id)baseColorForVariedColor:(id)a3 forContextIdentifier:(id)a4 variation:(double *)a5 forDataLayerPicker:(BOOL)a6
{
  ...
  _QWORD v17[4];
  id v18;
  PREditingColorVariationStore *v19;
  uint64_t *v20;
  uint64_t *v21;
  BOOL v22;
  uint64_t v23;
...
void __106__PREditingColorVariationStore_baseColorForVariedColor_forContextIdentifier_variation_forDataLayerPicker___block_invoke(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  ...
  if (*(_BYTE *)(a1 + 64))
  {
    ...
    v16 = -[PRPosterColor initWithColor:]([PRPosterColor alloc], "initWithColor:", v10);

  }
  else
  {
    objc_msgSend((id)objc_opt_class(), "posterColorForColor:withAppliedVariation:", *(_QWORD *)(a1 + 32), -v8);
    v16 = (PRPosterColor *)objc_claimAutoreleasedReturnValue();
  }
  -[PRPosterColor identifier](v16, "identifier");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = objc_msgSend(v7, "isEqualToString:", v11);

  if (v12)
  {
    -[PRPosterColor color](v16, "color");
