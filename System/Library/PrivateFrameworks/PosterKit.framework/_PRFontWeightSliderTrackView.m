...
{
  id v5;
  _PRFontWeightSliderTrackView *v6;
  ...
  v6 = -[_PRFontWeightSliderTrackView initWithFrame:](&v9, sel_initWithFrame_, *MEMORY[0x1E0C9D648], *(double *)(MEMORY[0x1E0C9D648] + 8), *(double *)(MEMORY[0x1E0C9D648] + 16), *(double *)(MEMORY[0x1E0C9D648] + 24));
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_trackBackgroundColor, a3);
    -[_PRFontWeightSliderTrackView setOpaque:](v7, "setOpaque:", 0);
    -[_PRFontWeightSliderTrackView setContentMode:](v7, "setContentMode:", 3);
  }
...
- (void)drawRect:(CGRect)a3
{
  ...
  v9 = objc_msgSend((id)*MEMORY[0x1E0DC4730], "userInterfaceLayoutDirection");
  v10 = x;
  v11 = y;
  v12 = width;
  v13 = height;
  ...
  v21 = objc_alloc_init(MEMORY[0x1E0DC3508]);
  ...
  -[_PRFontWeightSliderTrackView trackBackgroundColor](self, "trackBackgroundColor");
