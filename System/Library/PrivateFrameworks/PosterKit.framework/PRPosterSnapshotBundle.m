...
{
  id v5;
  PRPosterSnapshotBundle *v6;
  PRPosterSnapshotBundle *v7;
  PRPosterSnapshotBundle *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[PRPosterSnapshotBundle init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
- (PRPosterSnapshotBundle)initWithURL:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0D7FD18];
  v5 = a3;
  v6 = (void *)objc_msgSend([v4 alloc], "initWithURL:", v5);

  v7 = -[PRPosterSnapshotBundle initWithUnderlyingSnapshotBundle:](self, "initWithUnderlyingSnapshotBundle:", v6);
  return v7;
}
...
+ (id)snapshotBundleAtURL:(id)a3 error:(id *)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0D7FD18], "snapshotBundleAtURL:error:", a3, a4);
...
- (NSArray)snapshotLevelSets
{
  ...
  objc_msgSend(v2, "bs_mapNoNulls:", &__block_literal_global_8);
...
PRPosterLevelSet *__43__PRPosterSnapshotBundle_snapshotLevelSets__block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = -[PRPosterLevelSet initWithLevels:](v3, "initWithLevels:", v4);
  return v5;
}
...
- (id)snapshotForLevelSet:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0D7FCF8];
  v5 = a3;
  v6 = [v4 alloc];
