...
{
  PRPosterColorHSLValues *result;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)PRPosterColorHSLValues;
  result = -[PRPosterColorHSLValues init](&v9, sel_init);
  if (result)
  {
    result->_hue = a3;
...
- (id)hsbValues
{
  ...
  return -[PRPosterColorHSBValues initWithHue:saturation:brightness:]([PRPosterColorHSBValues alloc], "initWithHue:saturation:brightness:", self->_hue, v5, v4);
}
