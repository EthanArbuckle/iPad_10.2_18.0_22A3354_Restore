...
{
  id v5;
  PRQuickActionsSceneHostViewController *v6;
  PRQuickActionsSceneHostViewController *v7;
  id *p_scene;
  void *v9;
  uint64_t v10;
  ...
  v6 = -[PRQuickActionsSceneHostViewController init](&v33, sel_init);
  v7 = v6;
  if (v6)
  {
    p_scene = (id *)&v6->_scene;
    objc_storeStrong((id *)&v6->_scene, a3);
    objc_msgSend(*p_scene, "configureParameters:", &__block_literal_global_38);
    objc_msgSend(*p_scene, "uiPresentationManager");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "createPresenterWithIdentifier:", CFSTR("quickActions"));
    v10 = objc_claimAutoreleasedReturnValue();
    v32 = v5;
    scenePresenter = v7->_scenePresenter;
    v7->_scenePresenter = (UIScenePresenter *)v10;

    -[UIScenePresenter modifyPresentationContext:](v7->_scenePresenter, "modifyPresentationContext:", &__block_literal_global_5_1);
    ...
    -[PRQuickActionsSceneHostViewController view](v7, "view");
...
{
  return objc_msgSend(a2, "updateSettingsWithBlock:", &__block_literal_global_2_1);
}
...
- (void)loadView
{
  ...
  -[PRQuickActionsSceneHostViewController setView:](self, "setView:", v3);
...
- (void)viewDidLayoutSubviews
{
  ...
  -[PRQuickActionsSceneHostViewController viewDidLayoutSubviews](&v13, sel_viewDidLayoutSubviews);
  -[PRQuickActionsSceneHostViewController view](self, "view");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
