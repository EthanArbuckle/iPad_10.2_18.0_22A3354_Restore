...
- (PRMutablePosterHomeScreenConfiguration)initWithSelectedAppearanceType:(unint64_t)a3 lockPosterAppearance:(id)a4 solidColorAppearance:(id)a5 gradientAppearance:(id)a6 homePosterAppearance:(id)a7 customizationConfiguration:(id)a8
{
  ...
  id v17;
  id v18;
  PRMutablePosterHomeScreenConfiguration *v19;
  PRMutablePosterHomeScreenConfiguration *v20;
  uint64_t v21;
...
{
  return -[PRPosterHomeScreenConfiguration initWithHomeScreenConfiguration:]([PRImmutableHomeScreenConfiguration alloc], "initWithHomeScreenConfiguration:", self);
}
