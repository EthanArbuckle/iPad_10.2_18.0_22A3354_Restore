...
- (PRPosterSolidColorHomeScreenAppearance)initWithColor:(id)a3 colorPickerConfiguration:(id)a4
{
  ...
  v8 = -[PRPosterSolidColorHomeScreenAppearance init](&v14, sel_init);
  if (v8)
  {
    ...
    if (!v11)
    {
      ...
      -[PREditorColorPickerConfiguration setIdentifier:](v11, "setIdentifier:", CFSTR("solidHomeScreenAppearance"));
    }
...
- (PRPosterSolidColorHomeScreenAppearance)init
{
  ...
  v4 = -[PRPosterSolidColorHomeScreenAppearance initWithColor:colorPickerConfiguration:](self, "initWithColor:colorPickerConfiguration:", 0, v3);
...
- (PRPosterColor)effectiveColor
{
  ...
  -[PRPosterSolidColorHomeScreenAppearance color](self, "color");
  v3 = (PRPosterColor *)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    -[PRPosterSolidColorHomeScreenAppearance colorPickerConfiguration](self, "colorPickerConfiguration");
    ...
    if (!v3)
    {
      ...
      objc_msgSend(MEMORY[0x1E0DC3658], "colorWithRed:green:blue:alpha:", 0.984313725, 0.921568627, 0.48627451, 1.0);
...
- (PRPosterSolidColorHomeScreenAppearance)initWithCoder:(id)a3
{
  ...
  v10 = -[PRPosterSolidColorHomeScreenAppearance initWithColor:colorPickerConfiguration:](self, "initWithColor:colorPickerConfiguration:", v5, v9);
  return v10;
}
