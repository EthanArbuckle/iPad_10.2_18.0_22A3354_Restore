...
- (id)fullDescription
{
  ...
  v22 = v4;
  v13 = v4;
  v14 = (void (**)(_QWORD, _QWORD))MEMORY[0x219A05224](v21);
...
uint64_t __28__AHTLoader_fullDescription__block_invoke(uint64_t a1, uint64_t a2, unsigned int a3)
{
  ...
  objc_msgSend(&stru_24D660648, "stringByPaddingToLength:withString:startingAtIndex:", a3, a2, 0);
