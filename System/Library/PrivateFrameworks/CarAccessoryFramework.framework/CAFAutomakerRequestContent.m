...
- (NSArray)requestContentServices
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:", v7, CFSTR("0x0000000017000004"));

  objc_opt_class();
  -[CAFAccessory servicesForType:](self, "servicesForType:", CFSTR("0x0000000017000004"));
...
{
  return CFSTR("0x0000000001200001");
}

+ (id)observerProtocol
{
  return &unk_25682CB80;
}
