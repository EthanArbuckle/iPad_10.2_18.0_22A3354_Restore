...
- (CAFArrayCharacteristic)indicesUserVisibleValueCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000036000009"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000036000009"));
...
- (NSArray)indicesUserVisibleValue
{
  ...
  -[CAFMultipleSelectImageSetting indicesUserVisibleValueCharacteristic](self, "indicesUserVisibleValueCharacteristic");
...
- (NSArray)listUserVisibleValue
{
  ...
  -[CAFMultipleSelectImageSetting listUserVisibleValueCharacteristic](self, "listUserVisibleValueCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "arrayValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSArray)images
{
  ...
  -[CAFMultipleSelectImageSetting imagesCharacteristic](self, "imagesCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "arrayValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000016000017");
}

+ (id)observerProtocol
{
  return &unk_25682E218;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000036000009")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFMultipleSelectImageSetting indicesUserVisibleValue](self, "indicesUserVisibleValue");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "multipleSelectImageSettingService:didUpdateIndicesUserVisibleValue:", self, v13);
LABEL_12:
  ...
  if ((objc_msgSend(v14, "isEqual:", CFSTR("0x0000000036000007")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v18)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFMultipleSelectImageSetting listUserVisibleValue](self, "listUserVisibleValue");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "multipleSelectImageSettingService:didUpdateListUserVisibleValue:", self, v13);
      goto LABEL_12;
    }
  }
  else
...
LABEL_13:
  ...
  if (v22)
  {
    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFMultipleSelectImageSetting images](self, "images");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "multipleSelectImageSettingService:didUpdateImages:", self, v13);
    goto LABEL_12;
  }
LABEL_14:
  v23.receiver = self;
...
- (BOOL)registeredForIndicesUserVisibleValue
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000036000009"));
