...
- (id)name
{
  ...
  -[CAFRemoteNotification identifierCharacteristic](self, "identifierCharacteristic");
  ...
  -[CAFRemoteNotification displayZoneIdentifierCharacteristic](self, "displayZoneIdentifierCharacteristic");
...
- (NSString)userVisibleLabel
{
  ...
  -[CAFRemoteNotification userVisibleLabelCharacteristic](self, "userVisibleLabelCharacteristic");
...
- (NSString)userVisibleDescription
{
  ...
  -[CAFRemoteNotification userVisibleDescriptionCharacteristic](self, "userVisibleDescriptionCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CAFNotificationUserActionsCharacteristic)notificationUserActionsCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000037000002"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000037000002"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (CAFNotificationUserActions)notificationUserActions
{
  ...
  -[CAFRemoteNotification notificationUserActionsCharacteristic](self, "notificationUserActionsCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "notificationUserActionsValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unsigned)userAction
{
  ...
  -[CAFRemoteNotification userActionCharacteristic](self, "userActionCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CAFSymbolImageWithColorCharacteristic)symbolNameAndColorCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000037000008"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000037000008"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (CAFSymbolImageWithColor)symbolNameAndColor
{
  ...
  -[CAFRemoteNotification symbolNameAndColorCharacteristic](self, "symbolNameAndColorCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "symbolImageWithColorValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSString)displayPanelIdentifier
{
  ...
  -[CAFRemoteNotification displayPanelIdentifierCharacteristic](self, "displayPanelIdentifierCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000017000001");
}

+ (id)observerProtocol
{
  return &unk_25682F618;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000030000001")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFRemoteNotification userVisibleLabel](self, "userVisibleLabel");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "remoteNotificationService:didUpdateUserVisibleLabel:", self, v13);
LABEL_33:
  ...
  if ((objc_msgSend(v14, "isEqual:", CFSTR("0x0000000030000005")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v18)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFRemoteNotification userVisibleDescription](self, "userVisibleDescription");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "remoteNotificationService:didUpdateUserVisibleDescription:", self, v13);
      goto LABEL_33;
    }
  }
  else
  ...
  if ((objc_msgSend(v19, "isEqual:", CFSTR("0x0000000030000019")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v23)
    {
      ...
      -[CAFRemoteNotification identifier](self, "identifier");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v24, "remoteNotificationService:didUpdateIdentifier:", self, v25);
LABEL_32:

      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFRemoteNotification name](self, "name");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "remoteNotificationService:didUpdateName:", self, v13);
      goto LABEL_33;
    }
  }
  else
  ...
  if ((objc_msgSend(v26, "isEqual:", CFSTR("0x0000000037000002")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v30)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFRemoteNotification notificationUserActions](self, "notificationUserActions");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "remoteNotificationService:didUpdateNotificationUserActions:", self, v13);
      goto LABEL_33;
    }
  }
  else
  ...
  if ((objc_msgSend(v31, "isEqual:", CFSTR("0x0000000037000003")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
  ...
  if ((objc_msgSend(v36, "isEqual:", CFSTR("0x0000000037000008")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v40)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFRemoteNotification symbolNameAndColor](self, "symbolNameAndColor");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "remoteNotificationService:didUpdateSymbolNameAndColor:", self, v13);
      goto LABEL_33;
    }
  }
  else
  ...
  if ((objc_msgSend(v41, "isEqual:", CFSTR("0x0000000037000007")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v45)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFRemoteNotification displayPanelIdentifier](self, "displayPanelIdentifier");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "remoteNotificationService:didUpdateDisplayPanelIdentifier:", self, v13);
      goto LABEL_33;
    }
  }
  else
...
LABEL_34:
  ...
  if (v49)
  {
    -[CAFService observers](self, "observers");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFRemoteNotification displayZoneIdentifier](self, "displayZoneIdentifier");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v24, "remoteNotificationService:didUpdateDisplayZoneIdentifier:", self, v25);
    goto LABEL_32;
  }
LABEL_35:
  v50.receiver = self;
...
- (BOOL)registeredForNotificationUserActions
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000037000002"));
...
- (BOOL)registeredForSymbolNameAndColor
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000037000008"));
