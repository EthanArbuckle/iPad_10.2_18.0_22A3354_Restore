...
- (CAFMeasurementCharacteristic)aqiCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000031000010"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000031000010"));
...
- (NSMeasurement)aqi
{
  ...
  -[CAFInteriorConditions aqiCharacteristic](self, "aqiCharacteristic");
...
{
  return CFSTR("0x0000000011000013");
}

+ (id)observerProtocol
{
  return &unk_256830DE0;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v7, "isEqual:", CFSTR("0x0000000031000010")))
    goto LABEL_4;
  ...
  if (v11)
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFInteriorConditions aqi](self, "aqi");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "interiorConditionsService:didUpdateAqi:", self, v12);
...
- (BOOL)registeredForAQI
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000031000010"));
