...
- (void)setUint64Value:(unint64_t)a3
{
  ...
  -[CAFUInt64Characteristic range](self, "range");
  ...
  if ((v6 & 1) != 0)
  {
    ...
    objc_msgSend(v7, "numberWithUnsignedLongLong:", objc_msgSend(v14, "valueRoundedToNearestStepValue:", a3));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      -[CAFUInt64Characteristic setUint64Value:].cold.1((uint64_t)self, a3, v13);
...
- (id)formattedValue
{
  ...
  if (v3)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%llu"), -[CAFUInt64Characteristic uint64Value](self, "uint64Value"));
...
- (void)setUint64Value:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2050;
  v6 = a2;
  _os_log_error_impl(&dword_237717000, log, OS_LOG_TYPE_ERROR, "%{public}@ uint64Value out of range %{public}llu", (uint8_t *)&v3, 0x16u);
}
