...
- (CAFInt8Characteristic)gearShiftRecommendationCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000041000016"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000041000016"));
...
- (char)gearShiftRecommendation
{
  ...
  -[CAFGearRecommendation gearShiftRecommendationCharacteristic](self, "gearShiftRecommendationCharacteristic");
...
{
  return CFSTR("0x000000001A000007");
}

+ (id)observerProtocol
{
  return &unk_25682CDF0;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v7, "isEqual:", CFSTR("0x0000000041000016")))
    goto LABEL_4;
...
- (BOOL)registeredForGearShiftRecommendation
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000041000016"));
