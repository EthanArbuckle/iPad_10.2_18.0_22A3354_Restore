...
- (CAFPairedDeviceList)pairedDeviceListValue
{
  ...
  +[CAFPairedDeviceList pairedDeviceListWithArray:](CAFPairedDeviceList, "pairedDeviceListWithArray:", v2);
...
- (id)formattedValue
{
  ...
  -[CAFPairedDeviceListCharacteristic pairedDeviceListValue](self, "pairedDeviceListValue");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
