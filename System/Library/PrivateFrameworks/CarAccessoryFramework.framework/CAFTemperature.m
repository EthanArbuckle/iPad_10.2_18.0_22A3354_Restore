...
- (id)name
{
  ...
  -[CAFTemperature vehicleLayoutKeyCharacteristic](self, "vehicleLayoutKeyCharacteristic");
...
- (CAFMeasurementCharacteristic)currentTemperatureCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000031000019"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000031000019"));
...
- (NSMeasurement)currentTemperature
{
  ...
  -[CAFTemperature currentTemperatureCharacteristic](self, "currentTemperatureCharacteristic");
...
- (CAFMeasurementCharacteristic)targetTemperatureCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000031000017"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000031000017"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (NSMeasurement)targetTemperature
{
  ...
  -[CAFTemperature targetTemperatureCharacteristic](self, "targetTemperatureCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "measurementValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000011000002");
}

+ (id)observerProtocol
{
  return &unk_25682D658;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000031000019")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFTemperature currentTemperature](self, "currentTemperature");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "temperatureService:didUpdateCurrentTemperature:", self, v13);
LABEL_12:
  ...
  if ((objc_msgSend(v14, "isEqual:", CFSTR("0x0000000031000017")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v18)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFTemperature targetTemperature](self, "targetTemperature");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "temperatureService:didUpdateTargetTemperature:", self, v13);
      goto LABEL_12;
    }
  }
  else
...
LABEL_13:
  ...
  if (v22)
  {
    ...
    -[CAFTemperature vehicleLayoutKey](self, "vehicleLayoutKey");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v23, "temperatureService:didUpdateVehicleLayoutKey:", self, v24);

    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFTemperature name](self, "name");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "temperatureService:didUpdateName:", self, v13);
    goto LABEL_12;
  }
LABEL_14:
  v25.receiver = self;
...
- (BOOL)registeredForCurrentTemperature
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000031000019"));
...
- (BOOL)registeredForTargetTemperature
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000031000017"));
