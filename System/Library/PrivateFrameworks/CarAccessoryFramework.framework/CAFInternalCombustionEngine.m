...
- (CAFEngineRPM)engineRPMService
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:", v7, CFSTR("0x000000001A00000F"));

  objc_opt_class();
  -[CAFAccessory servicesForType:](self, "servicesForType:", CFSTR("0x000000001A00000F"));
...
- (CAFEngineTemperature)engineTemperatureService
{
  ...
  objc_msgSend((id)objc_opt_class(), "accessoryIdentifier");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:", v7, CFSTR("0x000000001A000010"));

  objc_opt_class();
  -[CAFAccessory servicesForType:](self, "servicesForType:", CFSTR("0x000000001A000010"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "firstObject");
  v9 = (id)objc_claimAutoreleasedReturnValue();
  if (v9 && (objc_opt_isKindOfClass() & 1) != 0)
...
{
  return CFSTR("0x0000000009000005");
}

+ (id)observerProtocol
{
  return &unk_25682E740;
}
