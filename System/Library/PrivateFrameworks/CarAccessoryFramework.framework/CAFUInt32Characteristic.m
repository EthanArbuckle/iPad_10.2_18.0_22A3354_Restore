...
- (void)setUint32Value:(unsigned int)a3
{
  ...
  v3 = *(_QWORD *)&a3;
  -[CAFUInt32Characteristic range](self, "range");
  ...
  if ((v6 & 1) != 0)
  {
    ...
    objc_msgSend(v7, "numberWithUnsignedInt:", objc_msgSend(v14, "valueRoundedToNearestStepValue:", v3));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      -[CAFUInt32Characteristic setUint32Value:].cold.1((uint64_t)self, v3, v13);
...
- (id)formattedValue
{
  ...
  if (v3)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%u"), -[CAFUInt32Characteristic uint32Value](self, "uint32Value"));
...
- (void)setUint32Value:(os_log_t)log .cold.1(uint64_t a1, int a2, os_log_t log)
{
  ...
  v5 = 1026;
  v6 = a2;
  _os_log_error_impl(&dword_237717000, log, OS_LOG_TYPE_ERROR, "%{public}@ uint32Value out of range %{public}u", (uint8_t *)&v3, 0x12u);
}
