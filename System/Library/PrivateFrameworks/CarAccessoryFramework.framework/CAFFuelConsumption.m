...
- (NSMeasurement)fuelEfficiency
{
  ...
  -[CAFFuelConsumption fuelEfficiencyCharacteristic](self, "fuelEfficiencyCharacteristic");
...
{
  return CFSTR("0x000000001A000014");
}

+ (id)observerProtocol
{
  return &unk_256831F08;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v7, "isEqual:", CFSTR("0x0000000035000013")))
    goto LABEL_4;
  ...
  if (v11)
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFFuelConsumption fuelEfficiency](self, "fuelEfficiency");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "fuelConsumptionService:didUpdateFuelEfficiency:", self, v12);
