...
- (id)name
{
  ...
  -[CAFClimateControlsLocked vehicleLayoutKeyCharacteristic](self, "vehicleLayoutKeyCharacteristic");
...
- (CAFLockStateCharacteristic)lockStateCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000042000009"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000042000009"));
...
- (unsigned)lockState
{
  ...
  -[CAFClimateControlsLocked lockStateCharacteristic](self, "lockStateCharacteristic");
...
- (void)setLockState:(unsigned __int8)a3
{
  ...
  objc_msgSend(v4, "setLockStateValue:", v3);
...
{
  return CFSTR("0x0000000011000010");
}

+ (id)observerProtocol
{
  return &unk_256831D50;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000042000009")) & 1) != 0)
  {
...
LABEL_8:
  ...
  if (v16)
  {
    ...
    -[CAFClimateControlsLocked vehicleLayoutKey](self, "vehicleLayoutKey");
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "climateControlsLockedService:didUpdateVehicleLayoutKey:", self, v18);

    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFClimateControlsLocked name](self, "name");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "climateControlsLockedService:didUpdateName:", self, v19);
...
- (BOOL)registeredForLockState
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000042000009"));
