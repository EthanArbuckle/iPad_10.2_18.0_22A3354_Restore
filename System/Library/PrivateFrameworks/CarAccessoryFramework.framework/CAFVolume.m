...
- (id)name
{
  ...
  -[CAFVolume volumeTypeCharacteristic](self, "volumeTypeCharacteristic");
  ...
  -[CAFVolume userVisibleLabelCharacteristic](self, "userVisibleLabelCharacteristic");
...
- (CAFVolumeTypeCharacteristic)volumeTypeCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000033000005"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000033000005"));
...
- (unsigned)volumeType
{
  ...
  v3 = objc_msgSend(v2, "volumeTypeValue");
...
- (CAFUInt8Characteristic)volumeCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000033000006"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000033000006"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (unsigned)volume
{
  ...
  -[CAFVolume volumeCharacteristic](self, "volumeCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000013000002");
}

+ (id)observerProtocol
{
  return &unk_25682C2B0;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000033000005")) & 1) != 0)
  {
...
LABEL_12:
      ...
      -[CAFVolume name](self, "name");
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "volumeService:didUpdateName:", self, v24);
  ...
  if ((objc_msgSend(v13, "isEqual:", CFSTR("0x0000000033000006")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
...
LABEL_13:
  ...
  objc_msgSend(v6, "characteristicType");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v18, "isEqual:", CFSTR("0x0000000030000001")))
    goto LABEL_13;
  objc_msgSend(v6, "uniqueIdentifier");
  ...
  if (v22)
  {
    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFVolume userVisibleLabel](self, "userVisibleLabel");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "volumeService:didUpdateUserVisibleLabel:", self, v23);
...
- (BOOL)registeredForVolumeType
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000033000005"));
...
- (BOOL)registeredForVolume
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000033000006"));
...
- (int64_t)typeCompare:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", objc_msgSend(v4, "volumeType"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(&unk_2509585D8, "indexOfObject:", v5);

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", -[CAFVolume volumeType](self, "volumeType"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_msgSend(&unk_2509585D8, "indexOfObject:", v7);

  if (v6 == v8)
  {
    if (v6 == 6)
    {
      objc_msgSend(v4, "userVisibleLabel");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFVolume userVisibleLabel](self, "userVisibleLabel");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = objc_msgSend(v9, "compare:options:", v10, 1);
