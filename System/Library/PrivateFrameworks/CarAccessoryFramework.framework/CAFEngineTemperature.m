...
- (NSMeasurement)temperature
{
  ...
  -[CAFEngineTemperature temperatureCharacteristic](self, "temperatureCharacteristic");
...
- (unsigned)temperatureState
{
  ...
  -[CAFEngineTemperature temperatureStateCharacteristic](self, "temperatureStateCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSMeasurement)temperatureMin
{
  ...
  -[CAFEngineTemperature temperatureMinCharacteristic](self, "temperatureMinCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "measurementValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSMeasurement)temperatureMax
{
  ...
  -[CAFEngineTemperature temperatureMaxCharacteristic](self, "temperatureMaxCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "measurementValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSMeasurement)temperatureMarkerCold
{
  ...
  -[CAFEngineTemperature temperatureMarkerColdCharacteristic](self, "temperatureMarkerColdCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "measurementValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSMeasurement)temperatureMarkerHot
{
  ...
  -[CAFEngineTemperature temperatureMarkerHotCharacteristic](self, "temperatureMarkerHotCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "measurementValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x000000001A000010");
}

+ (id)observerProtocol
{
  return &unk_25682F978;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x000000003000001D")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFEngineTemperature temperature](self, "temperature");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "engineTemperatureService:didUpdateTemperature:", self, v13);
LABEL_24:
  ...
  if ((objc_msgSend(v19, "isEqual:", CFSTR("0x0000000030000054")) & 1) != 0)
  {
    ...
    if (v23)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFEngineTemperature temperatureMin](self, "temperatureMin");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "engineTemperatureService:didUpdateTemperatureMin:", self, v13);
      goto LABEL_24;
    }
  }
  else
  ...
  if ((objc_msgSend(v24, "isEqual:", CFSTR("0x0000000030000055")) & 1) != 0)
  {
    ...
    if (v28)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFEngineTemperature temperatureMax](self, "temperatureMax");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "engineTemperatureService:didUpdateTemperatureMax:", self, v13);
      goto LABEL_24;
    }
  }
  else
  ...
  if ((objc_msgSend(v29, "isEqual:", CFSTR("0x0000000030000056")) & 1) != 0)
  {
    ...
    if (v33)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFEngineTemperature temperatureMarkerCold](self, "temperatureMarkerCold");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "engineTemperatureService:didUpdateTemperatureMarkerCold:", self, v13);
      goto LABEL_24;
    }
  }
  else
...
LABEL_25:
  ...
  if (v37)
  {
    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFEngineTemperature temperatureMarkerHot](self, "temperatureMarkerHot");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "engineTemperatureService:didUpdateTemperatureMarkerHot:", self, v13);
    goto LABEL_24;
  }
LABEL_26:
  v38.receiver = self;
