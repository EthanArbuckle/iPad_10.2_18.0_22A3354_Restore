...
- (CAFSelectSettingEntry)selectSettingEntryValue
{
  ...
  v5 = -[CAFSelectSettingEntry initWithDictionary:](v3, "initWithDictionary:", v4);
...
- (id)formattedValue
{
  ...
  -[CAFSelectSettingEntryCharacteristic selectSettingEntryValue](self, "selectSettingEntryValue");
...
{
  return CFSTR("SelectSettingEntry");
}
