...
- (NSString)userVisibleValue
{
  ...
  -[CAFDeepLinkSetting userVisibleValueCharacteristic](self, "userVisibleValueCharacteristic");
...
- (NSString)contentURLAction
{
  ...
  -[CAFDeepLinkSetting contentURLActionCharacteristic](self, "contentURLActionCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000016000006");
}

+ (id)observerProtocol
{
  return &unk_25682F110;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000030000017")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFDeepLinkSetting userVisibleValue](self, "userVisibleValue");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "deepLinkSettingService:didUpdateUserVisibleValue:", self, v13);
LABEL_8:
  ...
  objc_msgSend(v6, "characteristicType");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v12, "isEqual:", CFSTR("0x0000000036000066")))
  {
LABEL_9:
  ...
  if (v17)
  {
    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFDeepLinkSetting contentURLAction](self, "contentURLAction");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "deepLinkSettingService:didUpdateContentURLAction:", self, v13);
    goto LABEL_8;
  }
LABEL_10:
  v18.receiver = self;
