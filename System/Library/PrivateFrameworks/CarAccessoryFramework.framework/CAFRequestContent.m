...
- (id)name
{
  ...
  -[CAFRequestContent displayPanelIdentifierCharacteristic](self, "displayPanelIdentifierCharacteristic");
  ...
  -[CAFRequestContent displayZoneIdentifierCharacteristic](self, "displayZoneIdentifierCharacteristic");
...
- (BOOL)on
{
  ...
  -[CAFRequestContent onCharacteristic](self, "onCharacteristic");
...
- (CAFStringCharacteristic)contentURLCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000030000007"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000030000007"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (NSString)contentURL
{
  ...
  -[CAFRequestContent contentURLCharacteristic](self, "contentURLCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)userDismissible
{
  ...
  -[CAFRequestContent userDismissibleCharacteristic](self, "userDismissibleCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "BOOLValue");
...
{
  return CFSTR("0x0000000017000004");
}

+ (id)observerProtocol
{
  return &unk_25682C728;
}
...
LABEL_22:
  ...
  if ((objc_msgSend(v13, "isEqual:", CFSTR("0x0000000030000007")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v17)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFRequestContent contentURL](self, "contentURL");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "requestContentService:didUpdateContentURL:", self, v18);
LABEL_21:
  ...
  if ((objc_msgSend(v19, "isEqual:", CFSTR("0x0000000036000063")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
  ...
  if ((objc_msgSend(v24, "isEqual:", CFSTR("0x0000000037000007")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v28)
    {
      ...
      -[CAFRequestContent displayPanelIdentifier](self, "displayPanelIdentifier");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v29, "requestContentService:didUpdateDisplayPanelIdentifier:", self, v30);
LABEL_20:

      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFRequestContent name](self, "name");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "requestContentService:didUpdateName:", self, v18);
      goto LABEL_21;
    }
  }
  else
  ...
  if (v34)
  {
    -[CAFService observers](self, "observers");
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFRequestContent displayZoneIdentifier](self, "displayZoneIdentifier");
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v29, "requestContentService:didUpdateDisplayZoneIdentifier:", self, v30);
    goto LABEL_20;
  }
LABEL_23:
  v35.receiver = self;
...
- (BOOL)registeredForContentURL
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000030000007"));
