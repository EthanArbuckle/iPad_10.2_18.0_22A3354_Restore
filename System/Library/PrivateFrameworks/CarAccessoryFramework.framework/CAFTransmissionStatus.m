...
- (CAFTransmissionModeCharacteristic)transmissionModeCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000041000011"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000041000011"));
...
- (unsigned)transmissionMode
{
  ...
  -[CAFTransmissionStatus transmissionModeCharacteristic](self, "transmissionModeCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "transmissionModeValue");
...
- (CAFUInt8Characteristic)gearPositionCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000041000012"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000041000012"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (unsigned)gearPosition
{
  ...
  -[CAFTransmissionStatus gearPositionCharacteristic](self, "gearPositionCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x000000001A000003");
}

+ (id)observerProtocol
{
  return &unk_25682D830;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000041000011")) & 1) != 0)
  {
...
LABEL_8:
  ...
  objc_msgSend(v6, "characteristicType");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v12, "isEqual:", CFSTR("0x0000000041000012")))
    goto LABEL_8;
  objc_msgSend(v6, "uniqueIdentifier");
...
- (BOOL)registeredForTransmissionMode
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000041000011"));
...
- (BOOL)registeredForGearPosition
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000041000012"));
