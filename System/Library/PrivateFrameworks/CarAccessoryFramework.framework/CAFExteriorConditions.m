...
- (NSMeasurement)temperature
{
  ...
  -[CAFExteriorConditions temperatureCharacteristic](self, "temperatureCharacteristic");
...
- (NSMeasurement)aqi
{
  ...
  -[CAFExteriorConditions aqiCharacteristic](self, "aqiCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "measurementValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000011000009");
}

+ (id)observerProtocol
{
  return &unk_2568305E8;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x000000003000001D")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFExteriorConditions temperature](self, "temperature");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "exteriorConditionsService:didUpdateTemperature:", self, v13);
LABEL_8:
  ...
  objc_msgSend(v6, "characteristicType");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v12, "isEqual:", CFSTR("0x0000000031000010")))
  {
LABEL_9:
  ...
  if (v17)
  {
    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFExteriorConditions aqi](self, "aqi");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "exteriorConditionsService:didUpdateAqi:", self, v13);
    goto LABEL_8;
  }
LABEL_10:
  v18.receiver = self;
