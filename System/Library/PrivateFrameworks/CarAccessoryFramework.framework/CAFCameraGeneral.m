...
- (BOOL)on
{
  ...
  -[CAFCameraGeneral onCharacteristic](self, "onCharacteristic");
...
- (BOOL)userDismissible
{
  ...
  -[CAFCameraGeneral userDismissibleCharacteristic](self, "userDismissibleCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "BOOLValue");
...
{
  return CFSTR("0x000000001F000001");
}

+ (id)observerProtocol
{
  return &unk_256832168;
}
...
LABEL_8:
  ...
  objc_msgSend(v6, "characteristicType");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v12, "isEqual:", CFSTR("0x0000000036000063")))
    goto LABEL_8;
  objc_msgSend(v6, "uniqueIdentifier");
