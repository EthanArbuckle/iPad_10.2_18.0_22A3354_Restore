...
+ (CAFProminenceInfo)prominenceInfoWithProminenceInformations:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc((Class)a1), "initWithProminenceInformations:", v4);
...
{
  id v5;
  CAFProminenceInfo *v6;
  CAFProminenceInfo *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CAFProminenceInfo;
  v6 = -[CAFProminenceInfo init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (CAFProminenceInfo)initWithArray:(id)a3
{
  ...
  void *v15;
  id v16;
  CAFProminenceInfo *v17;
  objc_super v18;

  v4 = a3;
  v18.receiver = self;
  v18.super_class = (Class)CAFProminenceInfo;
  v5 = -[CAFProminenceInfo init](&v18, sel_init);
  if (v5)
  {
...
void __35__CAFProminenceInfo_initWithArray___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    v4 = -[CAFProminenceInformation initWithDictionary:]([CAFProminenceInformation alloc], "initWithDictionary:", v3);
    objc_msgSend(*(id *)(a1 + 32), "addObject:", v4);
  }
  else
  {
    objc_msgSend(MEMORY[0x24BDD1540], "CAF_elementParseFailedForDataSupportType:", CFSTR("ProminenceInfo"));
    ...
    *(_QWORD *)(v7 + 16) = v5;
    ...
    CAFGeneralLogging();
    v4 = (CAFProminenceInformation *)objc_claimAutoreleasedReturnValue();
...
- (NSString)formattedValue
{
  ...
  -[CAFProminenceInfo prominenceInformations](self, "prominenceInformations");
...
void __35__CAFProminenceInfo_initWithArray___block_invoke_cold_1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  v6 = 2114;
  v7 = a2;
  _os_log_error_impl(&dword_237717000, log, OS_LOG_TYPE_ERROR, "%{public}@: Error parsing dictionary from ProminenceInfo array - %{public}@", (uint8_t *)&v4, 0x16u);
}
