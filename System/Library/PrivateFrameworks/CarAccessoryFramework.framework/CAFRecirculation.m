...
- (BOOL)on
{
  ...
  -[CAFRecirculation onCharacteristic](self, "onCharacteristic");
...
- (BOOL)autoMode
{
  ...
  -[CAFRecirculation autoModeCharacteristic](self, "autoModeCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "BOOLValue");
...
{
  return CFSTR("0x0000000011000011");
}

+ (id)observerProtocol
{
  return &unk_256831AD8;
}
