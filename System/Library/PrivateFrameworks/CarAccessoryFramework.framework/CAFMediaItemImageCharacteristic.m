...
- (CAFMediaItemImage)mediaItemImageValue
{
  ...
  v5 = -[CAFMediaItemImage initWithDictionary:](v3, "initWithDictionary:", v4);
...
- (id)formattedValue
{
  ...
  -[CAFMediaItemImageCharacteristic mediaItemImageValue](self, "mediaItemImageValue");
