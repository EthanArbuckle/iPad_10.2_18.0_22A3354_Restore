...
- (NSMeasurement)power
{
  ...
  -[CAFChargingRate powerCharacteristic](self, "powerCharacteristic");
...
- (CAFMeasurementCharacteristic)chargingSpeedCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x000000004000000A"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x000000004000000A"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (NSMeasurement)chargingSpeed
{
  ...
  -[CAFChargingRate chargingSpeedCharacteristic](self, "chargingSpeedCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "measurementValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000019000003");
}

+ (id)observerProtocol
{
  return &unk_25682D218;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000030000028")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFChargingRate power](self, "power");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "chargingRateService:didUpdatePower:", self, v13);
LABEL_8:
  ...
  objc_msgSend(v6, "characteristicType");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v12, "isEqual:", CFSTR("0x000000004000000A")))
  {
LABEL_9:
  ...
  if (v17)
  {
    -[CAFService observers](self, "observers");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[CAFChargingRate chargingSpeed](self, "chargingSpeed");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "chargingRateService:didUpdateChargingSpeed:", self, v13);
    goto LABEL_8;
  }
LABEL_10:
  v18.receiver = self;
...
- (BOOL)registeredForChargingSpeed
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x000000004000000A"));
