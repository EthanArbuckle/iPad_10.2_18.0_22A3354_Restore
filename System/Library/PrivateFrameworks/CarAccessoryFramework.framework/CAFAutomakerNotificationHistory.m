...
- (NSArray)historicalNotificationServices
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:", v7, CFSTR("0x0000000021000001"));

  objc_opt_class();
  -[CAFAccessory servicesForType:](self, "servicesForType:", CFSTR("0x0000000021000001"));
...
{
  return CFSTR("0x0000000001400001");
}

+ (id)observerProtocol
{
  return &unk_25682BD58;
}
