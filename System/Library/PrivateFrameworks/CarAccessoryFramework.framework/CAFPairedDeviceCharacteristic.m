...
- (CAFPairedDevice)pairedDeviceValue
{
  ...
  v5 = -[CAFPairedDevice initWithDictionary:](v3, "initWithDictionary:", v4);
...
- (id)formattedValue
{
  ...
  -[CAFPairedDeviceCharacteristic pairedDeviceValue](self, "pairedDeviceValue");
