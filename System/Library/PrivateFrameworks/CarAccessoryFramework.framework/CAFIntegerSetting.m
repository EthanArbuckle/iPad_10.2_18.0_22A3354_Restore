...
- (CAFInt32Characteristic)valueCharacteristic
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000030000010"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000030000010"));
...
- (int)value
{
  ...
  -[CAFIntegerSetting valueCharacteristic](self, "valueCharacteristic");
...
- (NSString)userVisibleValue
{
  ...
  -[CAFIntegerSetting userVisibleValueCharacteristic](self, "userVisibleValueCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSString)maximumSymbolName
{
  ...
  -[CAFIntegerSetting maximumSymbolNameCharacteristic](self, "maximumSymbolNameCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSString)minimumSymbolName
{
  ...
  -[CAFIntegerSetting minimumSymbolNameCharacteristic](self, "minimumSymbolNameCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringValue");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (CAFBoolCharacteristic)stepperBarHiddenCharacteristic
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000036000027"));

  objc_opt_class();
  -[CAFService characteristicForType:](self, "characteristicForType:", CFSTR("0x0000000036000027"));
  v10 = (id)objc_claimAutoreleasedReturnValue();
  if (v10 && (objc_opt_isKindOfClass() & 1) != 0)
    v11 = v10;
  else
...
- (BOOL)stepperBarHidden
{
  ...
  -[CAFIntegerSetting stepperBarHiddenCharacteristic](self, "stepperBarHiddenCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000016000007");
}

+ (id)observerProtocol
{
  return &unk_256830CD0;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000030000010")) & 1) != 0)
  {
...
LABEL_21:
  ...
  if ((objc_msgSend(v13, "isEqual:", CFSTR("0x0000000030000017")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v17)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFIntegerSetting userVisibleValue](self, "userVisibleValue");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "integerSettingService:didUpdateUserVisibleValue:", self, v18);
LABEL_16:
  ...
  if ((objc_msgSend(v19, "isEqual:", CFSTR("0x0000000036000026")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v23)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFIntegerSetting maximumSymbolName](self, "maximumSymbolName");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "integerSettingService:didUpdateMaximumSymbolName:", self, v18);
      goto LABEL_16;
    }
  }
  else
  ...
  if ((objc_msgSend(v24, "isEqual:", CFSTR("0x0000000036000025")) & 1) != 0)
  {
    objc_msgSend(v6, "uniqueIdentifier");
    ...
    if (v28)
    {
      -[CAFService observers](self, "observers");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      -[CAFIntegerSetting minimumSymbolName](self, "minimumSymbolName");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "integerSettingService:didUpdateMinimumSymbolName:", self, v18);
      goto LABEL_16;
    }
  }
  else
  ...
  objc_msgSend(v6, "characteristicType");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v12, "isEqual:", CFSTR("0x0000000036000027")))
    goto LABEL_21;
  objc_msgSend(v6, "uniqueIdentifier");
...
LABEL_22:
  ...
  -[CAFAutomakerSetting _characteristicDidUpdate:fromGroupUpdate:](&v33, sel__characteristicDidUpdate_fromGroupUpdate_, v6, v4);
...
- (BOOL)registeredForInt32Value
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000030000010"));
...
- (BOOL)registeredForStepperBarHidden
{
  ...
  objc_msgSend((id)objc_opt_class(), "serviceIdentifier");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v6, "hasAccessory:service:characteristic:", v8, v9, CFSTR("0x0000000036000027"));
