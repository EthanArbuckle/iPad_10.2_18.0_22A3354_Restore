...
- (void)testDevRequestNoParamsWithCompletion:(id)a3
{
  ...
  v4 = a3;
  -[CAFTestControlSync testDevRequestNoParamsControl](self, "testDevRequestNoParamsControl");
...
- (void)testDevRequestWithReqParamsWithTestInput1:(unsigned __int8)a3 testInput2:(id)a4 completion:(id)a5
{
  ...
  v8 = a4;
  v9 = a5;
  -[CAFTestControlSync testDevRequestWithReqParamsControl](self, "testDevRequestWithReqParamsControl");
...
- (void)testDevRequestWithResParamsWithCompletion:(id)a3
{
  ...
  v4 = a3;
  -[CAFTestControlSync testDevRequestWithResParamsControl](self, "testDevRequestWithResParamsControl");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
...
- (void)testDevRequestWithReqAndResParamsWithTestInput5:(unsigned __int8)a3 testInput6:(id)a4 completion:(id)a5
{
  ...
  v8 = a4;
  v9 = a5;
  -[CAFTestControlSync testDevRequestWithReqAndResParamsControl](self, "testDevRequestWithReqAndResParamsControl");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = v10;
  if (v10)
  {
...
- (id)testAccRequestNoParamsHandler
{
  ...
  -[CAFTestControlSync testAccRequestNoParamsControl](self, "testAccRequestNoParamsControl");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)testAccRequestWithReqParamsHandler
{
  ...
  -[CAFTestControlSync testAccRequestWithReqParamsControl](self, "testAccRequestWithReqParamsControl");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "handler");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)testAccRequestWithResParamsHandler
{
  ...
  -[CAFTestControlSync testAccRequestWithResParamsControl](self, "testAccRequestWithResParamsControl");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "handler");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)testAccRequestWithReqAndResParamsHandler
{
  ...
  -[CAFTestControlSync testAccRequestWithReqAndResParamsControl](self, "testAccRequestWithReqAndResParamsControl");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "handler");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x00000000FE000008");
}

+ (id)observerProtocol
{
  return &unk_256830520;
}
...
- (void)_controlDidUpdate:(id)a3
{
  ...
  if ((objc_msgSend(v5, "isEqual:", CFSTR("0x00000000FF000028")) & 1) != 0)
  {
    ...
    if (v9)
    {
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "testControlSyncServiceDidUpdateTestDevRequestNoParams:", self);
LABEL_16:
  ...
  if ((objc_msgSend(v11, "isEqual:", CFSTR("0x00000000FF000029")) & 1) != 0)
  {
    ...
    if (v15)
    {
      -[CAFService observers](self, "observers");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "testControlSyncServiceDidUpdateTestDevRequestWithReqParams:", self);
      goto LABEL_16;
    }
  }
  else
  ...
  if ((objc_msgSend(v16, "isEqual:", CFSTR("0x00000000FF00002A")) & 1) != 0)
  {
    ...
    if (v20)
    {
      -[CAFService observers](self, "observers");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "testControlSyncServiceDidUpdateTestDevRequestWithResParams:", self);
      goto LABEL_16;
    }
  }
  else
  ...
  if (v24)
  {
    -[CAFService observers](self, "observers");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "testControlSyncServiceDidUpdateTestDevRequestWithReqAndResParams:", self);
    goto LABEL_16;
  }
LABEL_17:
  v25.receiver = self;
