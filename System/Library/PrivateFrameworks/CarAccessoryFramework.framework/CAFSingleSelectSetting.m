...
- (CAFSelectSettingEntryList)selectSettingEntryList
{
  ...
  -[CAFSingleSelectSetting selectSettingEntryListCharacteristic](self, "selectSettingEntryListCharacteristic");
...
- (unsigned)selectedEntryIndex
{
  ...
  -[CAFSingleSelectSetting selectedEntryIndexCharacteristic](self, "selectedEntryIndexCharacteristic");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("0x0000000016000004");
}

+ (id)observerProtocol
{
  return &unk_25682D158;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ((objc_msgSend(v7, "isEqual:", CFSTR("0x0000000036000024")) & 1) != 0)
  {
    ...
    if (v11)
    {
      ...
      -[CAFSingleSelectSetting selectSettingEntryList](self, "selectSettingEntryList");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "singleSelectSettingService:didUpdateSelectSettingEntryList:", self, v13);
