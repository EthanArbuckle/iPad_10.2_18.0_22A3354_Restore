...
- (void)setUint8Value:(unsigned __int8)a3
{
  ...
  v3 = a3;
  -[CAFUInt8Characteristic range](self, "range");
  ...
  if ((v6 & 1) != 0)
  {
    ...
    objc_msgSend(v7, "numberWithUnsignedChar:", objc_msgSend(v14, "valueRoundedToNearestStepValue:", v3));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      -[CAFUInt8Characteristic setUint8Value:].cold.1((uint64_t)self, v3, v13);
...
- (id)formattedValue
{
  ...
  if (v3)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%hhu"), -[CAFUInt8Characteristic uint8Value](self, "uint8Value"));
...
- (void)setUint8Value:(os_log_t)log .cold.1(uint64_t a1, unsigned __int8 a2, os_log_t log)
{
  ...
  v5 = 1026;
  v6 = a2;
  _os_log_error_impl(&dword_237717000, log, OS_LOG_TYPE_ERROR, "%{public}@ uint8Value out of range %{public}hhu", (uint8_t *)&v3, 0x12u);
}
