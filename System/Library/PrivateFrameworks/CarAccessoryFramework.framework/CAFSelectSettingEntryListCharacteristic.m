...
- (CAFSelectSettingEntryList)selectSettingEntryListValue
{
  ...
  +[CAFSelectSettingEntryList selectSettingEntryListWithArray:](CAFSelectSettingEntryList, "selectSettingEntryListWithArray:", v2);
...
- (void)setSelectSettingEntryListValue:(id)a3
{
  ...
  objc_msgSend(a3, "selectSettingEntrys");
...
- (id)formattedValue
{
  ...
  -[CAFSelectSettingEntryListCharacteristic selectSettingEntryListValue](self, "selectSettingEntryListValue");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return CFSTR("SelectSettingEntryList");
}
