...
- (BOOL)hidden
{
  ...
  -[CAFRemainingRange hiddenCharacteristic](self, "hiddenCharacteristic");
...
{
  return CFSTR("0x000000001A00000B");
}

+ (id)observerProtocol
{
  return &unk_256830018;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v7, "isEqual:", CFSTR("0x0000000036000023")))
    goto LABEL_4;
...
LABEL_4:
  ...
  -[CAFDistanceDisplay _characteristicDidUpdate:fromGroupUpdate:](&v12, sel__characteristicDidUpdate_fromGroupUpdate_, v6, v4);
