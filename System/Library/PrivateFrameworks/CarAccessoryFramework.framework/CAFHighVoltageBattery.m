...
- (CAFBatteryLevel)batteryLevelService
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:", v7, CFSTR("0x000000001A000006"));

  objc_opt_class();
  -[CAFAccessory servicesForType:](self, "servicesForType:", CFSTR("0x000000001A000006"));
...
- (CAFBatteryTemperature)batteryTemperatureService
{
  ...
  objc_msgSend((id)objc_opt_class(), "accessoryIdentifier");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "validateRegisteredForAccessory:service:", v7, CFSTR("0x000000001A000011"));

  objc_opt_class();
  -[CAFAccessory servicesForType:](self, "servicesForType:", CFSTR("0x000000001A000011"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "firstObject");
  v9 = (id)objc_claimAutoreleasedReturnValue();
  if (v9 && (objc_opt_isKindOfClass() & 1) != 0)
...
{
  return CFSTR("0x0000000009000007");
}

+ (id)observerProtocol
{
  return &unk_25682D568;
}
