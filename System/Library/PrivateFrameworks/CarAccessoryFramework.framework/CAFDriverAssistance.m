...
- (CAFTargetSpeed)targetSpeedService
{
  ...
  objc_msgSend(v6, "validateRegisteredForAccessory:service:", v7, CFSTR("0x000000001E000004"));

  objc_opt_class();
  -[CAFAccessory servicesForType:](self, "servicesForType:", CFSTR("0x000000001E000004"));
...
{
  return CFSTR("0x000000000E000001");
}

+ (id)observerProtocol
{
  return &unk_2568314A0;
}
