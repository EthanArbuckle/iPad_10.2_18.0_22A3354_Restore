...
- (CEKFrameRateAssertion)initWithFrameRateRange:(CAFrameRateRange)a3 highFrameRateReason:(unsigned int)a4
{
  ...
  float maximum;
  float minimum;
  CEKFrameRateAssertion *v8;
  CEKFrameRateAssertion *v9;
  id v10;
  void *v11;
  CEKFrameRateAssertion *v12;
  uint64_t v13;
  BSSimpleAssertion *assertion;
  _QWORD v16[4];
  CEKFrameRateAssertion *v17;
  int v18;
  objc_super v19;
  ...
  v8 = -[CEKFrameRateAssertion init](&v19, sel_init);
  v9 = v8;
  if (v8)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("CEKFrameRateReason-%d"), v4);
    ...
    v17 = v12;
    v18 = v4;
    v13 = objc_msgSend(v10, "initWithIdentifier:forReason:invalidationBlock:", CFSTR("CEKFrameRateAssertion"), v11, v16);
...
uint64_t __68__CEKFrameRateAssertion_initWithFrameRateRange_highFrameRateReason___block_invoke()
{
