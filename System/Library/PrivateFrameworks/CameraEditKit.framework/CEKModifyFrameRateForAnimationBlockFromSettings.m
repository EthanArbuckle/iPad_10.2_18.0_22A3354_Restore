...
uint64_t ___CEKModifyFrameRateForAnimationBlockFromSettings_block_invoke(uint64_t a1, double a2, double a3, double a4)
{
  ...
  return objc_msgSend(MEMORY[0x1E0DC3F10], "cek_modifyAnimationsWithPreferredFrameRateRange:updateReason:animations:", *(unsigned int *)(a1 + 52), *(_QWORD *)(a1 + 32), a2, a3, a4);
}
