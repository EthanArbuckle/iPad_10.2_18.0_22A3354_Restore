@implementation _PASLanguageDetection
...
+ (id)languageForLocaleIdentifier:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v30, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_PASLanguageDetection.m"), 61, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("localeIdentifier != nil"));
...
LABEL_19:
  ...
  if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT))
  {
    *(_DWORD *)buf = 138412290;
    v32 = v5;
    _os_log_fault_impl(&dword_1A0957000, MEMORY[0x1E0C81028], OS_LOG_TYPE_FAULT, "Provided locale identifier (%@) is not a valid identifier", buf, 0xCu);
  }
  v7 = (__CFString *)v5;
LABEL_37:
...
+ (id)defaultLanguage
{
  ...
  +[_PASLanguageDetection languageForLocaleIdentifier:](_PASLanguageDetection, "languageForLocaleIdentifier:", v3);
...
+ (id)detectLanguageFromText:(id)a3
{
  ...
  +[_PASLanguageDetection dominantLanguageTagFromText:](_PASLanguageDetection, "dominantLanguageTagFromText:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  {
  ...
  {
    +[_PASLanguageDetection defaultLanguage](_PASLanguageDetection, "defaultLanguage");
...
+ (id)detectLanguageFromTextHeuristically:(id)a3
{
  ...
  v3 = a3;
  if (+[_PASLanguageDetection _userIsMultilingual]())
  {
    +[_PASLanguageDetection userLanguages](_PASLanguageDetection, "userLanguages");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    +[_PASLanguageDetection detectLanguageFromTextHeuristicallyWithLanguages:languages:defaultLanguage:](_PASLanguageDetection, "detectLanguageFromTextHeuristicallyWithLanguages:languages:defaultLanguage:", v3, v4, 0);
...
+ (id)detectLanguageFromTextHeuristicallyWithLanguages:(id)a3 languages:(id)a4 defaultLanguage:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "_pas_mappedArrayWithTransform:", &__block_literal_global);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  +[_PASLanguageDetection _dominantLanguageTagFromTextWithMaxLength:maxLength:minimumProbability:hints:hintsCount:](0.575, (uint64_t)_PASLanguageDetection, v7, 30, (uint64_t)v13, objc_msgSend(v12, "count"));
  ...
  {
    +[_PASLanguageDetection _dominantLanguageTagFromTextWithMaxLength:maxLength:minimumProbability:hints:hintsCount:](0.75, (uint64_t)_PASLanguageDetection, v7, 500, (uint64_t)v13, objc_msgSend(v12, "count"));
...
+ (id)detectLanguageFromTextWithMaxLength:(id)a3 maxLength:(unint64_t)a4 minimumProbability:(double)a5
{
  ...
  +[_PASLanguageDetection _dominantLanguageTagFromTextWithMaxLength:maxLength:minimumProbability:](a5, (uint64_t)_PASLanguageDetection, a3, a4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
  {
...
+ (id)detectLanguageFromTextIfMultilingual:(id)a3
{
  ...
  v3 = a3;
  if (+[_PASLanguageDetection _userIsMultilingual]())
    +[_PASLanguageDetection detectLanguageFromText:](_PASLanguageDetection, "detectLanguageFromText:", v3);
  else
    +[_PASLanguageDetection defaultLanguage](_PASLanguageDetection, "defaultLanguage");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return +[_PASLanguageDetection _dominantLanguageTagFromTextWithMaxLength:maxLength:minimumProbability:](0.575, (uint64_t)_PASLanguageDetection, a3, 30);
}
...
+ (id)_dominantLanguageTagFromTextWithMaxLength:(void *)a3 maxLength:(uint64_t)a4 minimumProbability:
{
  ...
  v6 = a3;
  objc_opt_self();
  +[_PASLanguageDetection _dominantLanguageTagFromTextWithMaxLength:maxLength:minimumProbability:hints:hintsCount:](a1, (uint64_t)_PASLanguageDetection, v6, a4, 0, 0);
...
+ (id)_dominantLanguageTagFromTextWithMaxLength:(void *)a3 maxLength:(uint64_t)a4 minimumProbability:(uint64_t)a5 hints:(uint64_t)a6 hintsCount:
{
  ...
  {
    if (_dominantLanguageTagFromTextWithMaxLength_maxLength_minimumProbability_hints_hintsCount___pasOnceToken1 != -1)
      dispatch_once(&_dominantLanguageTagFromTextWithMaxLength_maxLength_minimumProbability_hints_hintsCount___pasOnceToken1, &__block_literal_global_172);
    ...
    v14[1] = 3221225472;
    v14[2] = __113___PASLanguageDetection__dominantLanguageTagFromTextWithMaxLength_maxLength_minimumProbability_hints_hintsCount___block_invoke_178;
    v14[3] = &unk_1E442F188;
    v17 = a5;
    v18 = a6;
    v19 = a4;
