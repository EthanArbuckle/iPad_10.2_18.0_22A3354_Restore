...
{
  return -[TRIPBStringFloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
}

- (TRIPBStringFloatDictionary)initWithFloats:(const float *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  TRIPBStringFloatDictionary *v8;
  double v9;
  uint64_t v10;
  ...
  v8 = -[TRIPBStringFloatDictionary init](&v16, sel_init);
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        ...
        {
          if (!*a4)
            objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", v10, CFSTR("Attempting to add nil key to a Dictionary"));
          dictionary = v8->_dictionary;
          v12 = *(_DWORD *)a3++;
          LODWORD(v9) = v12;
          v13 = objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v9);
          v14 = (uint64_t)*a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v13, v14);
          --a5;
        }
        while (a5);
      }
...
{
  TRIPBStringFloatDictionary *v4;
  TRIPBStringFloatDictionary *v5;

  v4 = -[TRIPBStringFloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 9426, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBStringFloatDictionary;
  -[TRIPBStringFloatDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBStringFloatDictionary initWithDictionary:](+[TRIPBStringFloatDictionary allocWithZone:](TRIPBStringFloatDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)setTRIPBGenericValue:(id *)a3 forTRIPBGenericValueKey:(id *)a4
{
  ...
  LODWORD(v4) = a3->var1;
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v4), a4->var2);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9C128;
  v3[4] = a3;
  -[TRIPBStringFloatDictionary enumerateKeysAndFloatsUsingBlock:](self, "enumerateKeysAndFloatsUsingBlock:", v3);
}

uint64_t __53__TRIPBStringFloatDictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, float a3)
{
  return (*(uint64_t (**)(_QWORD, uint64_t, uint64_t))(*(_QWORD *)(a1 + 32) + 16))(*(_QWORD *)(a1 + 32), a2, objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%.*g"), 6, a3));
}
...
- (void)setFloat:(float)a3 forKey:(id)a4
{
  ...
  *(float *)&v7 = a3;
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v7), a4);
  autocreator = self->_autocreator;
  if (autocreator)
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
