...
{
  return -[TRIPBInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
}

- (TRIPBInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  TRIPBInt64FloatDictionary *v8;
  double v9;
  ...
  v8 = -[TRIPBInt64FloatDictionary init](&v15, sel_init);
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v12, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", v13));
          --a5;
        }
        while (a5);
      }
...
{
  TRIPBInt64FloatDictionary *v4;
  TRIPBInt64FloatDictionary *v5;

  v4 = -[TRIPBInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 7634, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt64FloatDictionary;
  -[TRIPBInt64FloatDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBInt64FloatDictionary initWithDictionary:](+[TRIPBInt64FloatDictionary allocWithZone:](TRIPBInt64FloatDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)setTRIPBGenericValue:(id *)a3 forTRIPBGenericValueKey:(id *)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v7, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", a4->var2));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BFE8;
  v3[4] = a3;
  -[TRIPBInt64FloatDictionary enumerateKeysAndFloatsUsingBlock:](self, "enumerateKeysAndFloatsUsingBlock:", v3);
}
