...
{
  return -[TRIPBInt32UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
}

- (TRIPBInt32UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TRIPBInt32UInt32Dictionary *v8;
  ...
  v8 = -[TRIPBInt32UInt32Dictionary init](&v14, sel_init);
  if (v8)
  {
...
{
  TRIPBInt32UInt32Dictionary *v4;
  TRIPBInt32UInt32Dictionary *v5;

  v4 = -[TRIPBInt32UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 3223, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt32UInt32Dictionary;
  -[TRIPBInt32UInt32Dictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBInt32UInt32Dictionary initWithDictionary:](+[TRIPBInt32UInt32Dictionary allocWithZone:](TRIPBInt32UInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateKeysAndUInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v6, "intValue"), objc_msgSend((id)-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "unsignedIntValue"), &v7);
  }
  while (!v7);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BCA0;
  v3[4] = a3;
  -[TRIPBInt32UInt32Dictionary enumerateKeysAndUInt32sUsingBlock:](self, "enumerateKeysAndUInt32sUsingBlock:", v3);
}
