...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBArray.m"), 2460, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBAutocreatedArray;
  -[TRIPBAutocreatedArray dealloc](&v3, sel_dealloc);
}
...
- (void)insertObject:(id)a3 atIndex:(unint64_t)a4
{
  ...
  if (!array)
  {
    array = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E0C99DE8]);
    self->_array = array;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  array = self->_array;
  if (array)
    return (id)-[NSMutableArray copyWithZone:](array, "copyWithZone:", a3);
  else
    return (id)objc_msgSend((id)objc_msgSend(MEMORY[0x1E0C99DE8], "allocWithZone:", a3), "init");
}
...
- (id)mutableCopyWithZone:(_NSZone *)a3
{
  ...
  array = self->_array;
  if (array)
    return (id)-[NSMutableArray mutableCopyWithZone:](array, "mutableCopyWithZone:", a3);
  else
    return (id)objc_msgSend((id)objc_msgSend(MEMORY[0x1E0C99DE8], "allocWithZone:", a3), "init");
}
