...
{
  TRIPBOneofDescriptor *v6;
  TRIPBOneofDescriptor *v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t v10;
  uint64_t i;
  ...
  v17.receiver = self;
  v17.super_class = (Class)TRIPBOneofDescriptor;
  v6 = -[TRIPBOneofDescriptor init](&v17, sel_init);
  v7 = v6;
  if (v6)
  {
    v6->name_ = a3;
    ...
    if (v8)
    {
      ...
      do
      {
        for (i = 0; i != v9; ++i)
        {
          ...
          *(_QWORD *)(*(_QWORD *)(*((_QWORD *)&v13 + 1) + 8 * i) + 16) = v7;
        }
        v9 = objc_msgSend(a4, "countByEnumeratingWithState:objects:count:", &v13, v18, 16);
      }
      while (v9);
    }
    v7->caseSel_ = SelFromStrings(0, (char *)a3, "OneOfCase", 0);
  }
  return v7;
}
...
- (void)dealloc
{
  ...
  -[TRIPBOneofDescriptor dealloc](&v3, sel_dealloc);
}

- (NSString)name
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", self->name_);
}
