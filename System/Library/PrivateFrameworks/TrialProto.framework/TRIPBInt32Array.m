...
- (TRIPBInt32Array)init
{
  ...
  return -[TRIPBInt32Array init](&v3, sel_init);
}

- (TRIPBInt32Array)initWithValueArray:(id)a3
{
  return -[TRIPBInt32Array initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (TRIPBInt32Array)initWithValues:(const int *)a3 count:(unint64_t)a4
{
  ...
  v6 = -[TRIPBInt32Array init](self, "init");
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
- (TRIPBInt32Array)initWithCapacity:(unint64_t)a3
{
  ...
  v4 = -[TRIPBInt32Array initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
    -[TRIPBInt32Array internalResizeToCapacity:](v4, "internalResizeToCapacity:", a3);
  return v5;
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBInt32Array initWithValues:count:](+[TRIPBInt32Array allocWithZone:](TRIPBInt32Array, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBArray.m"), 373, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt32Array;
  -[TRIPBInt32Array dealloc](&v3, sel_dealloc);
}
...
{
  -[TRIPBInt32Array enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addValue:(int)a3
{
  ...
  v3 = a3;
  -[TRIPBInt32Array addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const int *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[TRIPBInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[TRIPBInt32Array addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[TRIPBInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[TRIPBInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
