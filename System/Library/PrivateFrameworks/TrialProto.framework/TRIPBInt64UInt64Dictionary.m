...
{
  return -[TRIPBInt64UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
}

- (TRIPBInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  TRIPBInt64UInt64Dictionary *v8;
  ...
  v8 = -[TRIPBInt64UInt64Dictionary init](&v14, sel_init);
  if (v8)
  {
...
{
  TRIPBInt64UInt64Dictionary *v4;
  TRIPBInt64UInt64Dictionary *v5;

  v4 = -[TRIPBInt64UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 7085, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt64UInt64Dictionary;
  -[TRIPBInt64UInt64Dictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBInt64UInt64Dictionary initWithDictionary:](+[TRIPBInt64UInt64Dictionary allocWithZone:](TRIPBInt64UInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateKeysAndUInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v6, "longLongValue"), objc_msgSend((id)-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "unsignedLongLongValue"), &v7);
  }
  while (!v7);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BF70;
  v3[4] = a3;
  -[TRIPBInt64UInt64Dictionary enumerateKeysAndUInt64sUsingBlock:](self, "enumerateKeysAndUInt64sUsingBlock:", v3);
}
