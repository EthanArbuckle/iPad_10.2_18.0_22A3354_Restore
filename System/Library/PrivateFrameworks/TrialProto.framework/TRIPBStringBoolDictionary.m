...
{
  return -[TRIPBStringBoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
}

- (TRIPBStringBoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  TRIPBStringBoolDictionary *v8;
  uint64_t v9;
  ...
  v8 = -[TRIPBStringBoolDictionary init](&v15, sel_init);
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        ...
        do
        {
          ...
          v12 = objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v11);
          v13 = (uint64_t)*a4++;
...
{
  TRIPBStringBoolDictionary *v4;
  TRIPBStringBoolDictionary *v5;

  v4 = -[TRIPBStringBoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 9235, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBStringBoolDictionary;
  -[TRIPBStringBoolDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBStringBoolDictionary initWithDictionary:](+[TRIPBStringBoolDictionary allocWithZone:](TRIPBStringBoolDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", a3->var0), a4->var2);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9C100;
  v3[4] = a3;
  -[TRIPBStringBoolDictionary enumerateKeysAndBoolsUsingBlock:](self, "enumerateKeysAndBoolsUsingBlock:", v3);
}
...
- (void)setBool:(BOOL)a3 forKey:(id)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v5), a4);
  autocreator = self->_autocreator;
  if (autocreator)
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
