...
{
  return -[TRIPBUInt32BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
}

- (TRIPBUInt32BoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  TRIPBUInt32BoolDictionary *v8;
  ...
  v8 = -[TRIPBUInt32BoolDictionary init](&v14, sel_init);
  if (v8)
  {
...
{
  TRIPBUInt32BoolDictionary *v4;
  TRIPBUInt32BoolDictionary *v5;

  v4 = -[TRIPBUInt32BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 2207, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt32BoolDictionary;
  -[TRIPBUInt32BoolDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBUInt32BoolDictionary initWithDictionary:](+[TRIPBUInt32BoolDictionary allocWithZone:](TRIPBUInt32BoolDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateKeysAndBoolsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v6, "unsignedIntValue"), objc_msgSend((id)-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "BOOLValue"), &v7);
  }
  while (!v7);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BC00;
  v3[4] = a3;
  -[TRIPBUInt32BoolDictionary enumerateKeysAndBoolsUsingBlock:](self, "enumerateKeysAndBoolsUsingBlock:", v3);
}
