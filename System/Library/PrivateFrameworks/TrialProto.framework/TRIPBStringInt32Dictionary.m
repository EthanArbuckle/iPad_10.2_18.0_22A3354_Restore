...
{
  return -[TRIPBStringInt32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (TRIPBStringInt32Dictionary)initWithInt32s:(const int *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  TRIPBStringInt32Dictionary *v8;
  uint64_t v9;
  ...
  v8 = -[TRIPBStringInt32Dictionary init](&v15, sel_init);
  if (v8)
  {
...
{
  TRIPBStringInt32Dictionary *v4;
  TRIPBStringInt32Dictionary *v5;

  v4 = -[TRIPBStringInt32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 8662, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBStringInt32Dictionary;
  -[TRIPBStringInt32Dictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBStringInt32Dictionary initWithDictionary:](+[TRIPBStringInt32Dictionary allocWithZone:](TRIPBStringInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9C088;
  v3[4] = a3;
  -[TRIPBStringInt32Dictionary enumerateKeysAndInt32sUsingBlock:](self, "enumerateKeysAndInt32sUsingBlock:", v3);
}

uint64_t __53__TRIPBStringInt32Dictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  return (*(uint64_t (**)(_QWORD, uint64_t, uint64_t))(*(_QWORD *)(a1 + 32) + 16))(*(_QWORD *)(a1 + 32), a2, objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%d"), a3));
}
