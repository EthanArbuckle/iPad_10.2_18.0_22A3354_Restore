...
{
  return -[TRIPBUInt32FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
}

- (TRIPBUInt32FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  TRIPBUInt32FloatDictionary *v8;
  double v9;
  ...
  v8 = -[TRIPBUInt32FloatDictionary init](&v15, sel_init);
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v12, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", v13));
          --a5;
        }
        while (a5);
      }
...
{
  TRIPBUInt32FloatDictionary *v4;
  TRIPBUInt32FloatDictionary *v5;

  v4 = -[TRIPBUInt32FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 2390, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt32FloatDictionary;
  -[TRIPBUInt32FloatDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBUInt32FloatDictionary initWithDictionary:](+[TRIPBUInt32FloatDictionary allocWithZone:](TRIPBUInt32FloatDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)setTRIPBGenericValue:(id *)a3 forTRIPBGenericValueKey:(id *)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v7, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", a4->var3));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BC28;
  v3[4] = a3;
  -[TRIPBUInt32FloatDictionary enumerateKeysAndFloatsUsingBlock:](self, "enumerateKeysAndFloatsUsingBlock:", v3);
}
