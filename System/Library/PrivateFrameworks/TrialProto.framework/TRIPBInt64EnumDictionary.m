...
{
  return -[TRIPBInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", 0, 0, 0, 0);
}

- (TRIPBInt64EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[TRIPBInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", a3, 0, 0, 0);
}
...
- (TRIPBInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const int64_t *)a5 count:(unint64_t)a6
{
  ...
  v10 = -[TRIPBInt64EnumDictionary init](&v18, sel_init);
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      do
      {
        ...
        v16 = *a5++;
        -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v15, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", v16));
        --a6;
      }
      while (a6);
    }
...
{
  TRIPBInt64EnumDictionary *v4;
  TRIPBInt64EnumDictionary *v5;

  v4 = -[TRIPBInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", objc_msgSend(a3, "validationFunc"), 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 8013, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt64EnumDictionary;
  -[TRIPBInt64EnumDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBInt64EnumDictionary initWithDictionary:](+[TRIPBInt64EnumDictionary allocWithZone:](TRIPBInt64EnumDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateKeysAndRawValuesUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v6, "longLongValue"), objc_msgSend((id)-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "intValue"), &v7);
  }
  while (!v7);
}
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v18 = ComputeDictInt64FieldSize(v16, 1, v8);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  v5 = a5;
  v7 = *(_QWORD *)&a3;
  v8 = ComputeDictInt64FieldSize(a4->var2, 1, a5);
  v9 = 2;
  v10 = 3;
  v11 = 4;
  v12 = 5;
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BF48;
  v3[4] = a3;
  -[TRIPBInt64EnumDictionary enumerateKeysAndRawValuesUsingBlock:](self, "enumerateKeysAndRawValuesUsingBlock:", v3);
}
...
- (BOOL)getEnum:(int *)a3 forKey:(int64_t)a4
{
  ...
  v6 = (void *)-[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", a4));
  v7 = v6;
  if (a3 && v6)
  {
...
- (void)enumerateKeysAndEnumsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v8, "longLongValue"), v9, &v10);
  }
  while (!v10);
}
...
- (void)setEnum:(int)a3 forKey:(int64_t)a4
{
  ...
  if ((((uint64_t (*)(_QWORD, SEL))self->_validationFunc)(*(_QWORD *)&a3, a2) & 1) == 0)
    objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99778], CFSTR("TRIPBInt64EnumDictionary: Attempt to set an unknown enum value (%d)"), v5);
  dictionary = self->_dictionary;
  v8 = objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v5);
  -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v8, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator)
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
