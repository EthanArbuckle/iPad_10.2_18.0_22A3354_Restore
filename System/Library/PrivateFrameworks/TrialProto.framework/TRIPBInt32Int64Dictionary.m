...
{
  return -[TRIPBInt32Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
}

- (TRIPBInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TRIPBInt32Int64Dictionary *v8;
  ...
  v8 = -[TRIPBInt32Int64Dictionary init](&v13, sel_init);
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          LODWORD(v10) = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v11, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v10));
          --a5;
        }
        while (a5);
      }
...
{
  TRIPBInt32Int64Dictionary *v4;
  TRIPBInt32Int64Dictionary *v5;

  v4 = -[TRIPBInt32Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 3772, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt32Int64Dictionary;
  -[TRIPBInt32Int64Dictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBInt32Int64Dictionary initWithDictionary:](+[TRIPBInt32Int64Dictionary allocWithZone:](TRIPBInt32Int64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v6, "intValue"), objc_msgSend((id)-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "longLongValue"), &v7);
  }
  while (!v7);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BD18;
  v3[4] = a3;
  -[TRIPBInt32Int64Dictionary enumerateKeysAndInt64sUsingBlock:](self, "enumerateKeysAndInt64sUsingBlock:", v3);
}
