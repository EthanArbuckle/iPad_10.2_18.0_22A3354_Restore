...
{
  return -[TRIPBStringEnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", 0, 0, 0, 0);
}

- (TRIPBStringEnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[TRIPBStringEnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", a3, 0, 0, 0);
}

- (TRIPBStringEnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(id *)a5 count:(unint64_t)a6
{
  TRIPBStringEnumDictionary *v10;
  ...
  v10 = -[TRIPBStringEnumDictionary init](&v19, sel_init);
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      ...
      {
        if (!*a5)
          objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", v13, CFSTR("Attempting to add nil key to a Dictionary"));
        dictionary = v10->_dictionary;
        v15 = *a4++;
        v16 = objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v15);
        v17 = (uint64_t)*a5++;
        -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v16, v17);
        --a6;
      }
      while (a6);
    }
...
{
  TRIPBStringEnumDictionary *v4;
  TRIPBStringEnumDictionary *v5;

  v4 = -[TRIPBStringEnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", objc_msgSend(a3, "validationFunc"), 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 9821, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBStringEnumDictionary;
  -[TRIPBStringEnumDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBStringEnumDictionary initWithDictionary:](+[TRIPBStringEnumDictionary allocWithZone:](TRIPBStringEnumDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  v5 = a5;
  v7 = *(_QWORD *)&a3;
  v8 = ComputeDictStringFieldSize(a4->var7, a5);
  v9 = 2;
  v10 = 3;
  v11 = 4;
  v12 = 5;
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", a3->var3), a4->var2);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9C088;
  v3[4] = a3;
  -[TRIPBStringEnumDictionary enumerateKeysAndRawValuesUsingBlock:](self, "enumerateKeysAndRawValuesUsingBlock:", v3);
}

uint64_t __52__TRIPBStringEnumDictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2)
{
  return (*(uint64_t (**)(_QWORD, uint64_t, uint64_t))(*(_QWORD *)(a1 + 32) + 16))(*(_QWORD *)(a1 + 32), a2, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:"));
}
...
- (BOOL)getEnum:(int *)a3 forKey:(id)a4
{
  ...
  v6 = (void *)-[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", a4);
  v7 = v6;
  if (a3 && v6)
  {
...
- (void)enumerateKeysAndEnumsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v7)
      break;
    v8 = v7;
    v9 = objc_msgSend((id)-[NSMutableDictionary objectForKeyedSubscript:](self->_dictionary, "objectForKeyedSubscript:", v7), "intValue");
...
- (void)setRawValue:(int)a3 forKey:(id)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v5), a4);
  autocreator = self->_autocreator;
  if (autocreator)
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
...
- (void)setEnum:(int)a3 forKey:(id)a4
{
  ...
  if ((((uint64_t (*)(uint64_t, SEL))self->_validationFunc)(v5, a2) & 1) == 0)
    objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99778], CFSTR("TRIPBStringEnumDictionary: Attempt to set an unknown enum value (%d)"), v5);
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", v5), a4);
  autocreator = self->_autocreator;
  if (autocreator)
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
