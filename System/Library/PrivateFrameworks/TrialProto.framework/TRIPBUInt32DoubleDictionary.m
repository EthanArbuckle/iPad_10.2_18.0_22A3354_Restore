...
{
  return -[TRIPBUInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
}

- (TRIPBUInt32DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  TRIPBUInt32DoubleDictionary *v8;
  ...
  v8 = -[TRIPBUInt32DoubleDictionary init](&v13, sel_init);
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          LODWORD(v10) = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v11, objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", LODWORD(v10)));
          --a5;
        }
        while (a5);
      }
...
{
  TRIPBUInt32DoubleDictionary *v4;
  TRIPBUInt32DoubleDictionary *v5;

  v4 = -[TRIPBUInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 2573, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt32DoubleDictionary;
  -[TRIPBUInt32DoubleDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBUInt32DoubleDictionary initWithDictionary:](+[TRIPBUInt32DoubleDictionary allocWithZone:](TRIPBUInt32DoubleDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BC50;
  v3[4] = a3;
  -[TRIPBUInt32DoubleDictionary enumerateKeysAndDoublesUsingBlock:](self, "enumerateKeysAndDoublesUsingBlock:", v3);
}
