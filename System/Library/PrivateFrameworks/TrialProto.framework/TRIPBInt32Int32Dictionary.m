...
{
  return -[TRIPBInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (TRIPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TRIPBInt32Int32Dictionary *v8;
  ...
  v8 = -[TRIPBInt32Int32Dictionary init](&v14, sel_init);
  if (v8)
  {
...
{
  TRIPBInt32Int32Dictionary *v4;
  TRIPBInt32Int32Dictionary *v5;

  v4 = -[TRIPBInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 3406, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt32Int32Dictionary;
  -[TRIPBInt32Int32Dictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBInt32Int32Dictionary initWithDictionary:](+[TRIPBInt32Int32Dictionary allocWithZone:](TRIPBInt32Int32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9BCC8;
  v3[4] = a3;
  -[TRIPBInt32Int32Dictionary enumerateKeysAndInt32sUsingBlock:](self, "enumerateKeysAndInt32sUsingBlock:", v3);
}
