...
{
  return -[TRIPBStringDoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
}

- (TRIPBStringDoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  TRIPBStringDoubleDictionary *v8;
  uint64_t v9;
  ...
  v8 = -[TRIPBStringDoubleDictionary init](&v15, sel_init);
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        ...
        do
        {
          ...
          v11 = *a3++;
          v12 = objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v11);
          v13 = (uint64_t)*a4++;
...
{
  TRIPBStringDoubleDictionary *v4;
  TRIPBStringDoubleDictionary *v5;

  v4 = -[TRIPBStringDoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIPBDictionary.m"), 9617, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)TRIPBStringDoubleDictionary;
  -[TRIPBStringDoubleDictionary dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TRIPBStringDoubleDictionary initWithDictionary:](+[TRIPBStringDoubleDictionary allocWithZone:](TRIPBStringDoubleDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", a3->var6), a4->var2);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E2E9C150;
  v3[4] = a3;
  -[TRIPBStringDoubleDictionary enumerateKeysAndDoublesUsingBlock:](self, "enumerateKeysAndDoublesUsingBlock:", v3);
}

uint64_t __54__TRIPBStringDoubleDictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, double a3)
{
  return (*(uint64_t (**)(_QWORD, uint64_t, uint64_t))(*(_QWORD *)(a1 + 32) + 16))(*(_QWORD *)(a1 + 32), a2, objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%.*lg"), 15, *(_QWORD *)&a3));
}
...
- (void)setDouble:(double)a3 forKey:(id)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", a3), a4);
  autocreator = self->_autocreator;
  if (autocreator)
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
