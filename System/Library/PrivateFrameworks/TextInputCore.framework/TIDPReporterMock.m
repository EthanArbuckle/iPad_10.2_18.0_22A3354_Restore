...
- (TIDPReporterMock)init
{
  ...
  v3 = -[TIDPReporterMock init](&v7, sel_init);
  if (v3 == self)
  {
...
{
  -[TIDPReporterMock record:](self, "record:", a3, a4);
  return 1;
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[TIDPReporterMock record:](self, "record:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v9++));
      }
      while (v7 != v9);
...
- (BOOL)recordTokenFrequency:(id)a3 withLocale:(id)a4 withTokenType:(id)a5
{
  ...
  v7 = a3;
  v8 = (void *)objc_msgSend([v6 alloc], "initWithObjects:", v7, 0);

  -[TIDPReporterMock record:](self, "record:", v8);
  return 1;
}
