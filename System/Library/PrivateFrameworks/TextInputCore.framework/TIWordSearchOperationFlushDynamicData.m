...
{
  id v4;
  TIWordSearchOperationFlushDynamicData *v5;
  uint64_t v6;
  ...
  v5 = -[TIWordSearchOperationFlushDynamicData init](&v9, sel_init);
  if (v5)
  {
...
- (void)perform
{
  ...
  -[TIWordSearchOperationFlushDynamicData mecabraWrapper](self, "mecabraWrapper");
