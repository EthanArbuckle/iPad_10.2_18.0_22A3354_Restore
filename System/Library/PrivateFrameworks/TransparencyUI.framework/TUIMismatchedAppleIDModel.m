...
{
  return -[TUIMismatchedAppleIDModel initWithFlow:](self, "initWithFlow:", 0);
}

- (TUIMismatchedAppleIDModel)initWithFlow:(unint64_t)a3
{
  TUIMismatchedAppleIDModel *v4;
  TUIMismatchedAppleIDModel *v5;
  NSString *symbolName;
  void *v7;
  uint64_t v8;
  NSString *title;
  ...
  v4 = -[TUIMismatchedAppleIDModel init](&v24, sel_init);
  v5 = v4;
  if (v4)
  {
    symbolName = v4->_symbolName;
    v4->_symbolName = (NSString *)CFSTR("person.icloud");

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "localizedStringForKey:value:table:", CFSTR("MISMATCHED_APPLEID_ERROR_TITLE"), &stru_251A5E438, CFSTR("Localizable"));
    ...
    {
      v11 = v10;
      v12 = CFSTR("MISMATCHED_APPLEID_OPTOUT_ERROR_DETAIL");
    }
    else
    {
      v11 = v10;
      v12 = CFSTR("MISMATCHED_APPLEID_OPTIN_ERROR_DETAIL");
    }
    ...
    objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("MISMATCHED_APPLEID_ERROR_PRIMARY_BUTTON"), &stru_251A5E438, CFSTR("Localizable"));
