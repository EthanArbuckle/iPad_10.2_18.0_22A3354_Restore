...
+ (OZChannelBase)_newOZChannelWithName:(id)a3 channelID:(unsigned int)a4 flags:(unsigned int)a5
{
  ...
  OZChannelPosition3D::OZChannelPosition3D((OZChannelPosition3D *)v8, &v10, 0, a4, a5, 3u);
  PCString::~PCString(&v10);
  OZChannel::setDiscrete((OZChannel *)(v8 + 136), 0, 0);
  OZChannel::setDiscrete((OZChannel *)(v8 + 288), 0, 0);
  OZChannel::setDiscrete((OZChannel *)(v8 + 736), 0, 0);
...
- (void)getPositionAtTime:(id *)a3 x:(double *)a4 y:(double *)a5 z:(double *)a6
{
  ...
  (*(void (**)(CMTime *__return_ptr, char *, $3CC8671D27C23BF42ADDB32F2B5E48AE *))(*(_QWORD *)v10 + 336))(&v14, v10, a3);
  if (a4)
  {
    OZChannel::getValueAsDouble((OZChannel *)(v10 + 136), &v14, 0.0);
    *(_QWORD *)a4 = v11;
  }
  if (a5)
  {
    OZChannel::getValueAsDouble((OZChannel *)(v10 + 288), &v14, 0.0);
    *(_QWORD *)a5 = v12;
  }
  if (a6)
  {
    OZChannel::getValueAsDouble((OZChannel *)(v10 + 736), &v14, 0.0);
    *(_QWORD *)a6 = v13;
  }
}
...
- (void)setDoubleValuesAtTime:(id *)a3 curveX:(double)a4 curveY:(double)a5 curveZ:(double)a6 options:(unsigned int)a7
{
  ...
  *(_BYTE *)(OZCoreGlobals::getInstance(Instance) + 8) = v7 & 1;
  ...
  v19 = (OZCoreGlobals *)(*(uint64_t (**)(_QWORD *, _QWORD *, _QWORD, double))(v17[75] + 712))(v17 + 75, v20, 0, a6);
...
- (void)offsetPositionAtTime:(id *)a3 deltaX:(double)a4 deltaY:(double)a5 deltaZ:(double)a6 options:(unsigned int)a7
{
  ...
  if (pOZChannel)
  {
    v13 = (OZChannelPosition3D *)pOZChannel;
  }
  else
  {
    v13 = 0;
  ...
  *(_BYTE *)(OZCoreGlobals::getInstance(Instance) + 8) = v7 & 1;
  ...
  (*(void (**)(CMTime *__return_ptr, OZChannelPosition3D *, $3CC8671D27C23BF42ADDB32F2B5E48AE *))(*(_QWORD *)v13 + 336))(&v18, v13, a3);
  v17 = (OZCoreGlobals *)OZChannelPosition3D::offsetPosition(v13, &v18, a4, a5, a6, 1);
  *(_BYTE *)(OZCoreGlobals::getInstance(v17) + 8) = v16;
}
...
- (void)setDefaultCurveX:(double)a3 curveY:(double)a4 curveZ:(double)a5
{
  ...
  v18 = (OZChannel *)(v9 + 92);
  v19 = (*(uint64_t (**)(_QWORD *))(v9[92] + 512))(v9 + 92);
  v20 = v9[92];
  if (v19)
    v21 = (*(uint64_t (**)(_QWORD *))(v20 + 832))(v9 + 92) == 0;
  else
    v21 = (*(uint64_t (**)(_QWORD *, uint64_t))(v20 + 496))(v9 + 92, 1) ^ 1;
...
LABEL_4:
  ...
  {
    v10 = 0;
    (*(void (**)(_QWORD, uint64_t *))(**(_QWORD **)(v9[106] + 8) + 264))(*(_QWORD *)(v9[106] + 8), &v10);
    *(_QWORD *)a5 = v10;
  }
}
...
LABEL_4:
  ...
  {
    v10 = 0;
    (*(void (**)(_QWORD, uint64_t *))(**(_QWORD **)(v9[106] + 8) + 256))(*(_QWORD *)(v9[106] + 8), &v10);
    *(_QWORD *)a5 = v10;
  }
}
...
- (id)zChannel
{
  ...
  if (pOZChannel)
  return CHChannelWrapperForOZChannel((OZChannelBase *)(pOZChannel + 736), 0);
}
