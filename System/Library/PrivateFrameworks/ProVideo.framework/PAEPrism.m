...
- (id)properties
{
  ...
  return (id)objc_msgSend(v2, "dictionaryWithObjectsAndKeys:", v3, CFSTR("MayRemapTime"), v4, CFSTR("SupportsLargeRenderScale"), v5, CFSTR("SupportsHeliumRendering"), objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", 3), CFSTR("AutoColorProcessingSupport"), 0);
}
...
- (BOOL)addParameters
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v3, "addFloatSliderWithName:parmId:defaultValue:parameterMin:parameterMax:sliderMin:sliderMax:delta:parmFlags:", objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("Prism::Amount"), 0, 0), 1, 0, 7.0, 0.0, dbl_1B3050110[v7], 0.0, 32.0, 1.0);
    objc_msgSend(v3, "addAngleSliderWithName:parmId:defaultValue:parameterMin:parameterMax:parmFlags:", objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("Prism::Angle"), 0, 0), 2, 0, 0.0, 0.0, 6.28318531);
    objc_msgSend(v3, "addToggleButtonWithName:parmId:defaultValue:parmFlags:", objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("Prism::Crop"), 0, 0), 3, 0, 33);
    objc_msgSend(v3, "addPointParameterWithName:parmId:defaultX:defaultY:parmFlags:", objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("Prism::OSC Center"), 0, 0), 4, 2, 0.5, 0.5);
  }
  return v6;
}
...
- (BOOL)canThrowRenderOutput:(id)a3 withInput:(id)a4 withInfo:(id *)a5
{
  ...
  if (v9)
  {
    ...
    v18[0] = 0.0;
    objc_msgSend(v9, "getFloatValue:fromParm:atFxTime:", v18, 1, a5->var0.var1);
    v18[0] = v18[0] * 0.5;
    v17 = 0.0;
    objc_msgSend(v9, "getFloatValue:fromParm:atFxTime:", &v17, 2, a5->var0.var1);
    if (objc_msgSend(a4, "origin") == 2)
      v17 = -v17;
    v16 = 0;
    objc_msgSend(v9, "getBoolValue:fromParm:atFxTime:", &v16, 3, a5->var0.var1);
    v10 = objc_msgSend(a4, "imageType");
    if (-[PAESharedDefaultBase getRenderMode:](self, "getRenderMode:", a5->var0.var1) && v10 == 3)
    {
      if (v18[0] == 0.0)
      {
        if (a4)
        ...
        if (*(_QWORD *)&v14[0])
          (*(void (**)(_QWORD))(**(_QWORD **)&v14[0] + 24))(*(_QWORD *)&v14[0]);
      }
      else
      {
        if (a4)
        ...
        (*(void (**)(HPrism *, _QWORD, uint64_t))(*(_QWORD *)v11 + 120))(v11, 0, v15);
        *(_QWORD *)&v14[0] = v11;
        (*(void (**)(HPrism *))(*(_QWORD *)v11 + 16))(v11);
        if (v16)
          -[PAESharedDefaultBase crop:fromImage:toImage:](self, "crop:fromImage:toImage:", v14, a4, a3);
        objc_msgSend(a3, "setHeliumRef:", v14);
        if (*(_QWORD *)&v14[0])
          (*(void (**)(_QWORD))(**(_QWORD **)&v14[0] + 24))(*(_QWORD *)&v14[0]);
        (*(void (**)(HPrism *))(*(_QWORD *)v11 + 24))(v11);
        if (v15)
