...
+ (OZChannelBase)_newOZChannelWithName:(id)a3 channelID:(unsigned int)a4 flags:(unsigned int)a5
{
  ...
  OZChannelRotation3D::OZChannelRotation3D((OZChannelRotation3D *)v8, &v10, 0, a4, a5, 4u, 0, 0);
...
- (void)getRotationAtTime:(id *)a3 x:(double *)a4 y:(double *)a5 z:(double *)a6
{
  ...
  v14 = 0;
  v15 = 0;
  (*(void (**)(CMTime *__return_ptr, void *, $3CC8671D27C23BF42ADDB32F2B5E48AE *))(*(_QWORD *)v10 + 336))(&v12, v10, a3);
  OZChannelRotation3D::getValueAsEulerAngles((uint64_t)v10, &v12, &v13, 0.0);
  v11 = v14;
  *(_QWORD *)a4 = v13;
  *(_QWORD *)a5 = v11;
  *(_QWORD *)a6 = v15;
