...
+ (id)valueWithSIMDFloat2:()SIMD
{
  ...
  *(double *)v2 = a1;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", v2, "[2f]");
...
+ (id)valueWithSIMDFloat3:()SIMD
{
  ...
  v2 = a1.n128_u64[0];
  v3 = a1.n128_u32[2];
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", &v2, "[3f]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDFloat4:()SIMD
{
  ...
  v2 = a1;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", &v2, "[4f]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDFloat8:()SIMD
{
  ...
  v5[0] = *a3;
  v5[1] = v3;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", v5, "[8f]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDFloat16:()SIMD
{
  ...
  v7[2] = v4;
  v7[3] = v3;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", v7, "[16f]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDDouble2:()SIMD
{
  ...
  v3 = *MEMORY[0x1E0C80C00];
  v2 = a1;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", &v2, "[2d]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDDouble3:()SIMD
{
  ...
  v5 = *a3;
  v6 = v3;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", &v5, "[3d]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDDouble4:()SIMD
{
  ...
  v5[0] = *a3;
  v5[1] = v3;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", v5, "[4d]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDDouble8:()SIMD
{
  ...
  v7[2] = v4;
  v7[3] = v3;
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", v7, "[8d]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDFloat3x3:()SIMD
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", v5, "[9f]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDDouble3x3:()SIMD
{
  ...
  v10[1] = v6;
  v10[2] = v8;
  v10[3] = vzip1q_s64(v3, v4);
  v11 = a3[5].i64[0];
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", v10, "[9d]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDFloat4x4:()SIMD
{
  ...
  v16 = v6;
  v17 = vzip2_s32(v8, v7);
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", &v10, "[16f]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDDouble4x4:()SIMD
{
  ...
  v10 = *(int8x16_t *)(a3 + 96);
  v9 = *(int64x2_t *)(a3 + 112);
  v13 = vzip1q_s64(*(int64x2_t *)a3, v6);
  v14 = v8.i64[0];
  v11 = vextq_s8(v10, (int8x16_t)v3, 8uLL);
  v10.i64[1] = v4.i64[1];
  v15 = v10;
  v16 = vzip2q_s64(v6, v8);
  v17 = v11;
  v18 = vzip1q_s64(v5, v7);
  v19 = v9.i64[0];
  v20 = vzip2q_s64(v3, v5);
  v21 = vzip2q_s64(v7, v9);
  objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithBytes:objCType:", &v13, "[16d]");
  return (id)objc_claimAutoreleasedReturnValue();
}
...
+ (id)valueWithSIMDQuatD:()SIMD
{
  ...
  v5[0] = *a3;
  v5[1] = v3;
  objc_msgSend(a1, "valueWithSIMDDouble4:", v5);
  return (id)objc_claimAutoreleasedReturnValue();
}
...
- (double)SIMDFloat8Value
{
  ...
  v6 = *MEMORY[0x1E0C80C00];
  objc_msgSend(a1, "getValue:size:", v5, 32);
  result = *(double *)v5;
  v4 = v5[1];
  *a2 = v5[0];
  a2[1] = v4;
...
- (__n128)SIMDFloat16Value
{
  ...
  v7 = *MEMORY[0x1E0C80C00];
  objc_msgSend(a1, "getValue:size:", v6, 64);
  result = (__n128)v6[0];
  v4 = v6[1];
  v5 = v6[3];
  *(_OWORD *)(a2 + 32) = v6[2];
