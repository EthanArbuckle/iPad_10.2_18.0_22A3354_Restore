...
- (_TtC19HealthMedicationsUI30MedicationsDayHistoryEmptyCell)initWithCoder:(id)a3
{
  ...
  *((_QWORD *)v5 + 4) = 0;
  v8.receiver = self;
  v8.super_class = v6;
  return -[MedicationsDayHistoryEmptyCell initWithCoder:](&v8, sel_initWithCoder_, a3);
}

- (void).cxx_destruct
{
  sub_1BC0F7954((uint64_t)self + OBJC_IVAR____TtC19HealthMedicationsUI30MedicationsDayHistoryEmptyCell_item);
}
