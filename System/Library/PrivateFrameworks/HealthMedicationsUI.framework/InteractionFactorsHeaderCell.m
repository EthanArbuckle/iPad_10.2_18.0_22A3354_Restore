...
- (_TtC19HealthMedicationsUI28InteractionFactorsHeaderCell)initWithFrame:(CGRect)a3
{
  ...
  double x;
  char *v7;
  _TtC19HealthMedicationsUI28InteractionFactorsHeaderCell *v8;
  objc_super v10;
...
- (_TtC19HealthMedicationsUI28InteractionFactorsHeaderCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.super.isa
  ...
  return -[InteractionFactorsHeaderCell initWithCoder:](&v6, sel_initWithCoder_, a3);
}
...
- (void)awakeFromNib
{
  ...
  v2 = v3.receiver;
  -[InteractionFactorsHeaderCell awakeFromNib](&v3, sel_awakeFromNib);
  sub_1BC14D46C();
...
- (void).cxx_destruct
{
  sub_1BC0E1CFC((uint64_t)self + OBJC_IVAR____TtC19HealthMedicationsUI28InteractionFactorsHeaderCell_item, (unint64_t *)&qword_1EDA0F7D0, (void (*)(uint64_t))sub_1BC0E1B94);
