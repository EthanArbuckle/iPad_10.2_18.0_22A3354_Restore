...
- (_TtC19HealthMedicationsUI19SeparatorFooterCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.super.isa
  ...
  return -[SeparatorFooterCell initWithCoder:](&v6, sel_initWithCoder_, a3);
}

- (void).cxx_destruct
{
  sub_1BC0F7954((uint64_t)self + OBJC_IVAR____TtC19HealthMedicationsUI19SeparatorFooterCell_item);
