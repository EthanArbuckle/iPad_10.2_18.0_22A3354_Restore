...
- (_TtC19HealthMedicationsUI26MedicationLogDetailsHeader)initWithFrame:(CGRect)a3
{
  ...
  char *v8;
  objc_class *v9;
  _TtC19HealthMedicationsUI26MedicationLogDetailsHeader *v10;
  objc_super v12;
...
- (_TtC19HealthMedicationsUI26MedicationLogDetailsHeader)initWithCoder:(id)a3
{
  char *v4;
  id v5;
  _TtC19HealthMedicationsUI26MedicationLogDetailsHeader *result;
  ...
  *((_QWORD *)v4 + 4) = 0;
  ...
  result = (_TtC19HealthMedicationsUI26MedicationLogDetailsHeader *)sub_1BC2B52B8();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_1BC0E1CFC((uint64_t)self + OBJC_IVAR____TtC19HealthMedicationsUI26MedicationLogDetailsHeader_item, (unint64_t *)&qword_1EDA0F7D0, (void (*)(uint64_t))sub_1BC0E1B94);
}
