...
- (_TtC19HealthMedicationsUI27MedicationEducationItemCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.super.isa
  ...
  return -[MedicationEducationItemCell initWithCoder:](&v6, sel_initWithCoder_, a3);
}

- (void).cxx_destruct
{
  sub_1BC0F7954((uint64_t)self + OBJC_IVAR____TtC19HealthMedicationsUI27MedicationEducationItemCell_item);
