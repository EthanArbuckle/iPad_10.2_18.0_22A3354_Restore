...
{
  return (_TtC19HealthMedicationsUI28InteractionCriticalAlertCell *)sub_1BC1B1ED0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC19HealthMedicationsUI28InteractionCriticalAlertCell)initWithCoder:(id)a3
{
  return (_TtC19HealthMedicationsUI28InteractionCriticalAlertCell *)sub_1BC1B209C(a3);
}

- (void)awakeFromNib
{
  _TtC19HealthMedicationsUI28InteractionCriticalAlertCell *v2;
...
- (void)_bridgedUpdateConfigurationUsingState:(id)a3
{
  ...
  uint64_t v6;
  char *v7;
  _TtC19HealthMedicationsUI28InteractionCriticalAlertCell *v8;
  uint64_t v9;
...
{
  uint64_t v6;
  _TtC19HealthMedicationsUI28InteractionCriticalAlertCell *v7;
  id v8;
  uint64_t v9;
  void *v10;
  id v11;
  ...
  else
  {
    ...
    -[InteractionCriticalAlertCell touchesBegan:withEvent:](&v14, sel_touchesBegan_withEvent_, v13, v8);
...
- (void).cxx_destruct
{
  sub_1BC18C5BC((uint64_t)self + OBJC_IVAR____TtC19HealthMedicationsUI28InteractionCriticalAlertCell_item, (unint64_t *)&qword_1EDA0F7D0, (unint64_t *)&qword_1EDA0F7C0, MEMORY[0x1E0D2A060]);
  swift_bridgeObjectRelease();
