...
+ (id)_secKeyCreationAttributesForSpecifier:(id)a3
{
  ...
  objc_msgSend(v5, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("SFKey.m"), 740, CFSTR("subclass %@ must implement %@"), v6, v7);
...
- (_SFPublicKey)initWithData:(id)a3 specifier:(id)a4 error:(id *)a5
{
  ...
  else
  {
    ...
    objc_msgSend(v19, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SFKey.m"), 755, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("data"));
  ...
  objc_msgSend(v20, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SFKey.m"), 756, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("specifier2"));
...
- (_SFPublicKey)initWithSecKey:(__SecKey *)a3
{
  ...
  void *v7;
  _SFPublicKey *v8;
  SFPublicKey_Ivars *v9;
  id publicKeyInternal;
  void *v13;
  objc_super v14;
  ...
  if (!a3)
  {
    ...
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("SFKey.m"), 780, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("secKey"));
  ...
  if (v8)
  {
    ...
    *((_QWORD *)v8->_publicKeyInternal + 1) = a3;
...
- (__SecKey)_secKey
{
  return (__SecKey *)*((_QWORD *)self->_publicKeyInternal + 1);
}

- (id)keyData
{
  return SecKeyCopyExternalRepresentation(*((SecKeyRef *)self->_publicKeyInternal + 1), 0);
}
...
- (void)dealloc
{
  ...
  v3 = (const void *)*((_QWORD *)self->_publicKeyInternal + 1);
  if (v3)
  {
    CFRelease(v3);
    *((_QWORD *)self->_publicKeyInternal + 1) = 0;
  }
  v4.receiver = self;
  v4.super_class = (Class)_SFPublicKey;
...
- (void).cxx_destruct
{
  objc_storeStrong(&self->_publicKeyInternal, 0);
}
