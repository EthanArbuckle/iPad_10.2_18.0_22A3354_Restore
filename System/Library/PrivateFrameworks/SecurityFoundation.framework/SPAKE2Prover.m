...
- (SPAKE2Prover)initWithSalt:(id)a3 code:(id)a4 error:(id *)a5
{
  ...
  v10 = -[SPAKE2Prover init](&v18, sel_init);
  if (!v10)
    goto LABEL_4;
  v11 = -[SPAKE2Common initWithSalt:code:]([SPAKE2Common alloc], "initWithSalt:code:", v8, v9);
  -[SPAKE2Prover setCommon:](v10, "setCommon:", v11);

  -[SPAKE2Prover common](v10, "common");
  ...
  v15 = objc_msgSend(v14, "setupProver:", a5);
...
- (id)getMsg1WithError:(id *)a3
{
  ...
  -[SPAKE2Prover common](self, "common");
