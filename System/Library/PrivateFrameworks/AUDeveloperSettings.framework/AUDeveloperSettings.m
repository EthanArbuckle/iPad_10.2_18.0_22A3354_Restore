...
void sub_21BF1EDA8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_21BF1F06C(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_21BF20C58(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_21BF21FD0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_21BF2255C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
LABEL_6:
  ...
  getOBTextWelcomeControllerClass_softClass_0 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24);
  return result;
}

void sub_21BF237B8(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_21BF24A18(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_21BF24EB0(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_21BF28050(_Unwind_Exception *a1)
{
  void *v1;
...
uint64_t __getOBTextWelcomeControllerClass_block_invoke_cold_1()
{
  ...
  v0 = abort_report_np();
  return +[AUInternalSettingsController clearSettingsAssetLocationForFollowup].cold.1(v0);
}
