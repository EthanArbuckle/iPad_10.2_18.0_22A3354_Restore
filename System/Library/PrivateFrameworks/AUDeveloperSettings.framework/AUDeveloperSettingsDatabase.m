...
- (void)updateAccessory:(id)a3 locationType:(unint64_t)a4
{
  ...
  if (-[AUDeveloperSettingsDatabase isValidLocationType:](self, "isValidLocationType:", a4))
  {
    ...
    if (os_log_type_enabled(log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 2112;
      v21 = v14;
      _os_log_impl(&dword_21BF1C000, v12, OS_LOG_TYPE_DEFAULT, "%s: Updating location = %s for accessoryName = %@", (uint8_t *)&v16, 0x20u);
...
- (void)addAccessoryWithSerialNumber:(id)a3 info:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v13 = 2112;
      v14 = v7;
      _os_log_impl(&dword_21BF1C000, log, OS_LOG_TYPE_DEFAULT, "%s: Not adding empty serial number with info = %@", (uint8_t *)&v11, 0x16u);
    }
  }
...
- (void)setAccessoriesDictionary:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v6 = 2112;
  v7 = a1;
  _os_log_debug_impl(&dword_21BF1C000, a2, OS_LOG_TYPE_DEBUG, "%s: seting %@:%@", (uint8_t *)&v2, 0x20u);
}
...
- (void)accessoriesDictionary
{
  ...
  _os_log_error_impl(&dword_21BF1C000, v0, OS_LOG_TYPE_ERROR, "%s: received unknown object = %@", (uint8_t *)v1, 0x16u);
  OUTLINED_FUNCTION_1();
}
...
- (void)seedParticipationDictionary
{
  ...
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_21BF1C000, v0, v1, "%s: dictionary = %@", v2, v3, v4, v5, 2u);
  OUTLINED_FUNCTION_1();
}
