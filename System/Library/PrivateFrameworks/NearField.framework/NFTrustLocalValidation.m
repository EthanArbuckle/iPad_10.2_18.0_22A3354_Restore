...
- (NFTrustLocalValidation)initWithCoder:(id)a3
{
  ...
  v5 = -[NFTrustObject initWithCoder:](&v7, sel_initWithCoder_, v4);
  if (v5)
...
{
  return (id)objc_msgSend(a1, "withPrimitiveLocalValidation:", 1);
}

+ (id)localValidationWithTouchID
{
  return (id)objc_msgSend(a1, "withPrimitiveLocalValidation:", 2);
}

+ (id)localValidationWithFaceID
{
  return (id)objc_msgSend(a1, "withPrimitiveLocalValidation:", 4);
}
