...
- (NFPeerPaymentRequest)initWithDictionary:(id)a3
{
  ...
  v5 = -[NFPeerPaymentRequest init](&v11, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("topUpRequest"));
    v6 = objc_claimAutoreleasedReturnValue();
    topUpRequest = v5->_topUpRequest;
    v5->_topUpRequest = (NFECommercePaymentRequest *)v6;

    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("transferRequest"));
