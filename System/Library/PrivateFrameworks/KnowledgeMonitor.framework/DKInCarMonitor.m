...
{
  return objc_msgSend(*(id *)(a1 + 32), "setConnectedStatus:", 1);
}

uint64_t __24___DKInCarMonitor_start__block_invoke_2(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "setConnectedStatus:", 0);
}
...
uint64_t __24___DKInCarMonitor_start__block_invoke_3(uint64_t a1)
{
  ...
  if (!(_DWORD)result)
  {
    *(_BYTE *)(*(_QWORD *)(a1 + 32) + 145) = state64 != 0;
    return objc_msgSend((id)objc_opt_class(), "setIsConnected:", *(unsigned __int8 *)(*(_QWORD *)(a1 + 32) + 145));
  }
  return result;
}
