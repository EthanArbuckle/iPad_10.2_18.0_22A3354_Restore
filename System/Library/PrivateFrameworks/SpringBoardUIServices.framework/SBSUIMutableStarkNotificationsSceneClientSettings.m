...
- (void)setShouldBorrowScreen:(BOOL)a3
{
  ...
  -[FBSSettings otherSettings](self, "otherSettings");
  v3 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setFlag:forSetting:", BSSettingFlagForBool(), 2998744416);

}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[FBSSettings initWithSettings:]([SBSUIStarkNotificationsSceneClientSettings alloc], "initWithSettings:", self);
}
