...
{
  return -[FBSSettings initWithSettings:]([SBUIMutableBannerSceneClientSettings alloc], "initWithSettings:", self);
}
...
- (id)keyDescriptionForSetting:(unint64_t)a3
{
  ...
  -[BNSceneClientSettings keyDescriptionForSetting:](&v7, sel_keyDescriptionForSetting_);
...
- (id)valueDescriptionForFlag:(int64_t)a3 object:(id)a4 ofSetting:(unint64_t)a5
{
  ...
  -[BNSceneClientSettings valueDescriptionForFlag:object:ofSetting:](&v12, sel_valueDescriptionForFlag_object_ofSetting_, a3, v8, a5);
