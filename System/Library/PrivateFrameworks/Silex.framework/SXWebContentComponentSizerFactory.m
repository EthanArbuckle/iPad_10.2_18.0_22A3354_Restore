...
- (SXWebContentComponentSizerFactory)initWithDOMObjectProvider:(id)a3 loadingPolicyProvider:(id)a4
{
  id v7;
  id v8;
  SXWebContentComponentSizerFactory *v9;
  SXWebContentComponentSizerFactory *v10;
  objc_super v12;
  ...
  v9 = -[SXWebContentComponentSizerFactory init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (NSString)type
{
  return (NSString *)CFSTR("webcontent");
}
...
- (id)sizerForComponent:(id)a3 componentLayout:(id)a4 layoutOptions:(id)a5 DOMObjectProvider:(id)a6
{
  ...
  id v13;
  void *v14;
  SXWebContentComponentSizer *v15;
  void *v16;
  ...
  -[SXWebContentComponentSizerFactory loadingPolicyProvider](self, "loadingPolicyProvider");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v17 = -[SXWebContentComponentSizer initWithComponent:componentLayout:componentStyle:DOMObjectProvider:layoutOptions:loadingPolicyProvider:](v15, "initWithComponent:componentLayout:componentStyle:DOMObjectProvider:layoutOptions:loadingPolicyProvider:", v13, v12, v14, v10, v11, v16);
