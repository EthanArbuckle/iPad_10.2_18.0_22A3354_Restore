...
{
  id v5;
  SXQuickLookComponentErrorTransitionContext *v6;
  SXQuickLookComponentErrorTransitionContext *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SXQuickLookComponentErrorTransitionContext;
  v6 = -[SXQuickLookComponentErrorTransitionContext init](&v9, sel_init);
  v7 = v6;
  if (v6)
