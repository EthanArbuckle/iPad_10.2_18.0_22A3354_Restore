...
- (double)calculateHeight
{
  ...
  -[SXMosaicGalleryPortraitLivingRoomLayout desiredHeightForLargeItem](self, "desiredHeightForLargeItem");
  v4 = v3;
  -[SXMosaicGalleryPortraitLivingRoomLayout desiredHeightForSmallerItems](self, "desiredHeightForSmallerItems");
  if (v4 >= v5)
    v6 = v5;
  else
    v6 = v4;
      ...
      if (v12)
      {
        ...
        do
        {
          for (i = 0; i != v14; ++i)
          {
            ...
            v18 = -[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForItem:](self, "columnRangeForItem:", v17);
            v20 = v19;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = -[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForItem:](self, "columnRangeForItem:", *(_QWORD *)(*((_QWORD *)&v35 + 1) + 8 * v10));
        v13 = v12;
        v14 = -[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForLargeItem](self, "columnRangeForLargeItem");
        if (v13 == v15 && v11 == v14)
          v9 = 0.0;
        -[SXMosaicGalleryGroupLayout columnLayout](self, "columnLayout");
        ...
        v24 = v23;
        if (v11 == -[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForSmallerItems](self, "columnRangeForSmallerItems")&& v13 == v25)
        {
          -[SXMosaicGalleryGroupLayout columnLayout](self, "columnLayout");
        ...
        if (v11 == -[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForSmallerItems](self, "columnRangeForSmallerItems")&& v13 == v30)
        {
          -[SXMosaicGalleryGroupLayout columnLayout](self, "columnLayout");
...
- (_NSRange)columnRangeForItem:(id)a3
{
  ...
  if (!(v10 | v12))
  {
    if (v7 == -[SXMosaicGalleryPortraitLivingRoomLayout indexOfLargeItem](self, "indexOfLargeItem"))
      v13 = -[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForLargeItem](self, "columnRangeForLargeItem");
    else
      v13 = -[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForSmallerItems](self, "columnRangeForSmallerItems");
    v10 = v13;
    v12 = v14;
    -[SXMosaicGalleryGroupLayout columnRanges](self, "columnRanges");
...
- (_NSRange)columnRangeForSmallerItems
{
  ...
  v4 = v3 + ~-[SXMosaicGalleryPortraitLivingRoomLayout columnRangeForLargeItem](self, "columnRangeForLargeItem");
  v5 = 1;
  result.length = v5;
  result.location = v4;
  return result;
...
- (_NSRange)columnRangeForLargeItem
{
  ...
  v2 = -[SXMosaicGalleryPortraitLivingRoomLayout indexOfLargeItem](self, "indexOfLargeItem") != 0;
  v3 = 1;
  result.length = v3;
  result.location = v2;
  return result;
...
- (double)desiredHeightForLargeItem
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectAtIndex:", -[SXMosaicGalleryPortraitLivingRoomLayout indexOfLargeItem](self, "indexOfLargeItem"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)desiredHeightForSmallerItems
{
  ...
  v3 = -[SXMosaicGalleryPortraitLivingRoomLayout indexOfLargeItem](self, "indexOfLargeItem") == 0;
  -[SXMosaicGalleryGroupLayout columnLayout](self, "columnLayout");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)indexOfLargeItem
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "indexOfObjectPassingTest:", &__block_literal_global_18);
...
{
  return objc_msgSend(a2, "tileType") == 2;
}
