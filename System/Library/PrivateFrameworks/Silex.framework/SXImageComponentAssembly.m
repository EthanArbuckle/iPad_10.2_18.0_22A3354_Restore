...
- (void)loadInRegistry:(id)a3
{
  ...
  objc_msgSend(v4, "whenResolvingProtocol:scope:callbackBlock:", &unk_254F3E388, v5, &__block_literal_global_78);

  objc_msgSend(v3, "callback");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  TFCallbackScopeAny();
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "whenResolvingProtocol:scope:callbackBlock:", &unk_254F6F8B0, v7, &__block_literal_global_54_17);

  objc_msgSend(v3, "publicContainer");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (id)objc_msgSend(v8, "registerClass:factory:", objc_opt_class(), &__block_literal_global_57_14);

  objc_msgSend(v3, "publicContainer");
  v11 = (id)objc_claimAutoreleasedReturnValue();

  v10 = (id)objc_msgSend(v11, "registerClass:factory:", objc_opt_class(), &__block_literal_global_123_0);
}
...
{
  id v2;
  SXImageComponentViewFactory *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  void *v10;
  void *v11;
  SXImageComponentViewFactory *v12;
  ...
  v12 = -[SXImageComponentViewFactory initWithDOMObjectProvider:viewport:presentationDelegateProvider:componentStyleRendererFactory:analyticsReportingProvider:appStateMonitor:imageViewFactory:mediaSharingPolicyProvider:](v3, "initWithDOMObjectProvider:viewport:presentationDelegateProvider:componentStyleRendererFactory:analyticsReportingProvider:appStateMonitor:imageViewFactory:mediaSharingPolicyProvider:", v4, v5, v6, v7, v8, v9, v10, v11);
  return v12;
}

SXImageComponentSizerFactory *__43__SXImageComponentAssembly_loadInRegistry___block_invoke_4()
{
  return objc_alloc_init(SXImageComponentSizerFactory);
}
