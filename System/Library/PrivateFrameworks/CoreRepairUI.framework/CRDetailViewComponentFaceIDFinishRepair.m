...
{
  CRDetailViewComponentFaceIDFinishRepair *v2;
  void *v3;
  void *v4;
  void *v5;
  void *v6;
  ...
  if (v2)
  {
    ...
    objc_msgSend(v10, "localizedStringWithKey:defaultString:", CFSTR("FINISH_FACEID_DESC"), CFSTR("FINISH_FACEID_DESC"));
    ...
    if (-[CRUDetailViewComponent deviceClass](v2, "deviceClass") == 3)
    {
      ...
      objc_msgSend(v16, "localizedStringWithKey:defaultString:", CFSTR("TRUEDEPTH_KB_URL_IPAD"), CFSTR("TRUEDEPTH_KB_URL_IPAD"));
      ...
      objc_msgSend(v19, "localizedStringWithKey:defaultString:", CFSTR("FINISH_FACEID_DESC_IPAD"), CFSTR("FINISH_FACEID_DESC_IPAD"));
    ...
    objc_msgSend(v22, "localizedStringWithKey:defaultString:", CFSTR("FaceID"), CFSTR("FaceID"));
