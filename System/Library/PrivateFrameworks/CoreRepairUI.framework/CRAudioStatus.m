...
- (CRAudioStatus)init
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)CRAudioStatus;
  v2 = -[CRComponentAuth init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[CRComponentAuth setComponentName:](v2, "setComponentName:", CFSTR("Audio"));
  return v3;
}

- (int64_t)copyComponentStatus
{
  if (-[CRAudioStatus isComponentFailed](self, "isComponentFailed"))
    return -1;
  else
    return 1;
}
...
- (BOOL)isComponentFailed
{
  ...
  if (MatchingServices)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 67109120;
      v15 = v8;
      _os_log_impl(&dword_22AC64000, v9, OS_LOG_TYPE_DEFAULT, "No AudioHardwareError Speaker IO registry, error: %d", buf, 8u);
    }
