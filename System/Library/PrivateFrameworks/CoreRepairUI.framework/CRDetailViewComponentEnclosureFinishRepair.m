...
{
  CRDetailViewComponentEnclosureFinishRepair *v2;
  void *v3;
  void *v4;
  void *v5;
  void *v6;
  ...
  v18.receiver = self;
  v18.super_class = (Class)CRDetailViewComponentEnclosureFinishRepair;
  ...
  if (v2)
  {
    ...
    objc_msgSend(v10, "localizedStringWithKey:defaultString:", CFSTR("FINISH_ENCLOSURE_DESC"), CFSTR("FINISH_ENCLOSURE_DESC"));
    ...
    objc_msgSend(v15, "localizedStringWithKey:defaultString:", CFSTR("ENCLOSURE"), CFSTR("ENCLOSURE"));
