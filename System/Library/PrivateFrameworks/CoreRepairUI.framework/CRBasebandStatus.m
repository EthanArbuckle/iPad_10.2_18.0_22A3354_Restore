...
- (CRBasebandStatus)init
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)CRBasebandStatus;
  v2 = -[CRComponentAuth init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[CRComponentAuth setComponentName:](v2, "setComponentName:", CFSTR("Baseband"));
  return v3;
}

- (int64_t)copyComponentStatus
{
  if (-[CRBasebandStatus isComponentFailed](self, "isComponentFailed"))
    return -1;
  else
    return 1;
}
