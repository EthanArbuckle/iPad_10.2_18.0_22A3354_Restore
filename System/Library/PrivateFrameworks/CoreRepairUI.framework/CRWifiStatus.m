...
- (CRWifiStatus)init
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)CRWifiStatus;
  v2 = -[CRComponentAuth init](&v5, sel_init);
  v3 = v2;
  if (v2)
    -[CRComponentAuth setComponentName:](v2, "setComponentName:", CFSTR("Wifi"));
  return v3;
}

- (int64_t)copyComponentStatus
{
  if (-[CRWifiStatus isComponentFailed](self, "isComponentFailed"))
    return -1;
  else
    return 1;
}
