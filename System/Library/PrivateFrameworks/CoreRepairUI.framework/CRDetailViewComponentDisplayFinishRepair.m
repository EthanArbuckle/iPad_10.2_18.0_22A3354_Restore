...
{
  CRDetailViewComponentDisplayFinishRepair *v2;
  void *v3;
  void *v4;
  void *v5;
  void *v6;
  ...
  v25.receiver = self;
  v25.super_class = (Class)CRDetailViewComponentDisplayFinishRepair;
  ...
  if (v2)
  {
    ...
    objc_msgSend(v10, "localizedStringWithKey:defaultString:", CFSTR("FINISH_DISPLAY_DESC"), CFSTR("FINISH_DISPLAY_DESC"));
    ...
    if (-[CRUDetailViewComponent deviceClass](v2, "deviceClass") == 3)
    {
      ...
      objc_msgSend(v16, "localizedStringWithKey:defaultString:", CFSTR("DISPLAY_REPAIR_KB_URL_IPAD"), CFSTR("DISPLAY_REPAIR_KB_URL_IPAD"));
      ...
      objc_msgSend(v19, "localizedStringWithKey:defaultString:", CFSTR("FINISH_DISPLAY_DESC_IPAD"), CFSTR("FINISH_DISPLAY_DESC_IPAD"));
    ...
    objc_msgSend(v22, "localizedStringWithKey:defaultString:", CFSTR("Display"), CFSTR("Display"));
