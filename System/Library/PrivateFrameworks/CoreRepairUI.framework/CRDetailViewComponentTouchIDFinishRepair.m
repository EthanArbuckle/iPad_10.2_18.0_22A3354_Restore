...
{
  CRDetailViewComponentTouchIDFinishRepair *v2;
  void *v3;
  void *v4;
  void *v5;
  void *v6;
  ...
  v18.receiver = self;
  v18.super_class = (Class)CRDetailViewComponentTouchIDFinishRepair;
  ...
  if (v2)
  {
    ...
    objc_msgSend(v10, "localizedStringWithKey:defaultString:", CFSTR("FINISH_TOUCHID_DESC_IPAD"), CFSTR("FINISH_TOUCHID_DESC_IPAD"));
    ...
    objc_msgSend(v15, "localizedStringWithKey:defaultString:", CFSTR("TouchID"), CFSTR("TouchID"));
