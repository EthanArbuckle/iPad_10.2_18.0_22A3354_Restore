...
- (id)_init
{
  ...
  v2 = -[MRSystemHealthComponentHandler initWithComponentName:](&v6, sel_initWithComponentName_, CFSTR("AudioCodec"));
  v3 = v2;
  if (v2)
  {
...
+ (id)sharedSingleton
{
  ...
  block[1] = 3221225472;
  block[2] = sub_22AC7D534;
  block[3] = &unk_24F4D4948;
  block[4] = a1;
  if (qword_255B49900 != -1)
    dispatch_once(&qword_255B49900, block);
  return (id)qword_255B498F8;
}
