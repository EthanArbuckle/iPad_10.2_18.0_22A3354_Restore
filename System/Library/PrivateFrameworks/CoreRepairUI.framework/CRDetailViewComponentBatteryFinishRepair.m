...
{
  CRDetailViewComponentBatteryFinishRepair *v2;
  void *v3;
  void *v4;
  void *v5;
  void *v6;
  ...
  v18.receiver = self;
  v18.super_class = (Class)CRDetailViewComponentBatteryFinishRepair;
  ...
  if (v2)
  {
    ...
    objc_msgSend(v10, "localizedStringWithKey:defaultString:", CFSTR("FINISH_BATTERY_DESC"), CFSTR("FINISH_BATTERY_DESC"));
    ...
    objc_msgSend(v15, "localizedStringWithKey:defaultString:", CFSTR("Battery"), CFSTR("Battery"));
