...
- (blkcnt_t)vui_onDiskSizeOfFileAtPath:()VideosUICore status:
{
  ...
  v5 = lstat((const char *)objc_msgSend(objc_retainAutorelease(a3), "cStringUsingEncoding:", 4, (unsigned __int128)0, (unsigned __int128)0, (unsigned __int128)0, (unsigned __int128)0, (unsigned __int128)0, (unsigned __int128)0, 0), &v7);
  if (a4)
    *a4 = v5;
  if (v5)
    return 0;
...
LABEL_3:
    ...
    while (1)
    {
      ...
      v16 = lstat((const char *)objc_msgSend(v15, "cStringUsingEncoding:", 4), &v19);
