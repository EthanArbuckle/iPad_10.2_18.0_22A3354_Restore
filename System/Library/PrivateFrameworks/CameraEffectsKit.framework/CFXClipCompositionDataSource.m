...
{
  id v5;
  CFXClipCompositionDataSource *v6;
  CFXClipCompositionDataSource *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CFXClipCompositionDataSource;
  v6 = -[CFXClipCompositionDataSource init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (int)duration
{
  ...
  -[CFXClipCompositionDataSource clip](self, "clip");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return +[CFXVideoSettings screenCanShow2160P](CFXVideoSettings, "screenCanShow2160P");
}
...
- (id)colorSpace
{
  ...
  -[CFXClip mediaItem](self->_clip, "mediaItem");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
