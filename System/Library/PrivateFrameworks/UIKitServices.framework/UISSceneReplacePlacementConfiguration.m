...
{
  id v5;
  UISSceneReplacePlacementConfiguration *v6;
  UISSceneReplacePlacementConfiguration *v7;
  objc_super v9;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[UISScenePlacementConfiguration isEqual:](&v9, sel_isEqual_, v4))
  {
    ...
    -[UISSceneReplacePlacementConfiguration targetSceneSessionPersistentIdentifier](self, "targetSceneSessionPersistentIdentifier");
...
{
  id v4;
  UISSceneReplacePlacementConfiguration *v5;
  uint64_t v6;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[UISSceneReplacePlacementConfiguration targetSceneSessionPersistentIdentifier](self, "targetSceneSessionPersistentIdentifier", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  ...
  _QWORD v9[4];
  id v10;
  UISSceneReplacePlacementConfiguration *v11;
  objc_super v12;
