...
{
  return (_TtC9SeymourUI16ActionBannerCell *)sub_22B7D9CD0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)prepareForReuse
{
  ...
  char *v5;
  objc_class *v6;
  _TtC9SeymourUI16ActionBannerCell *v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t v10;
  objc_super v11;
  ...
  v11.super_class = v6;
  v7 = self;
  -[ActionBannerCell prepareForReuse](&v11, sel_prepareForReuse);
  v8 = type metadata accessor for ShelfCellItemInfo();
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(_QWORD *)(v8 - 8) + 56))(v5, 1, 1, v8);
  v9 = (uint64_t)v7 + OBJC_IVAR____TtC9SeymourUI16ActionBannerCell_itemInfo;
  swift_beginAccess();
...
- (void).cxx_destruct
{
  sub_22B119BC0((uint64_t)self + OBJC_IVAR____TtC9SeymourUI16ActionBannerCell_delegate);
  sub_22B168AF8((uint64_t)self + OBJC_IVAR____TtC9SeymourUI16ActionBannerCell_itemInfo);
