...
{
  return (_TtC9SeymourUI21TVShelfLargeTitleView *)sub_22B3E0064(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)applyLayoutAttributes:(id)a3
{
  ...
  objc_class *v8;
  id v9;
  _TtC9SeymourUI21TVShelfLargeTitleView *v10;
  id v11;
  uint64_t v12;
  uint64_t v13;
  uint64_t v14;
  ...
  v9 = a3;
  v10 = self;
  -[TVShelfLargeTitleView applyLayoutAttributes:](&v15, sel_applyLayoutAttributes_, v9);
  v11 = objc_msgSend(v9, sel_indexPath);
  sub_22BA79BCC();

  v12 = sub_22BA79C14();
  (*(void (**)(char *, _QWORD, uint64_t, uint64_t))(*(_QWORD *)(v12 - 8) + 56))(v7, 0, 1, v12);
  v13 = (uint64_t)v10 + OBJC_IVAR____TtC9SeymourUI21TVShelfLargeTitleView_indexPath;
  swift_beginAccess();
...
- (void)prepareForReuse
{
  ...
  v2 = (char *)v4.receiver;
  -[TVShelfLargeTitleView prepareForReuse](&v4, sel_prepareForReuse);
  v3 = &v2[OBJC_IVAR____TtC9SeymourUI21TVShelfLargeTitleView_shelf];
  *(_QWORD *)v3 = 0;
  *((_QWORD *)v3 + 1) = 0;
...
- (void).cxx_destruct
{
  sub_22B18BA1C((uint64_t)self + OBJC_IVAR____TtC9SeymourUI21TVShelfLargeTitleView_indexPath);
  sub_22B119BC0((uint64_t)self + OBJC_IVAR____TtC9SeymourUI21TVShelfLargeTitleView_delegate);
  swift_unknownObjectRelease();
