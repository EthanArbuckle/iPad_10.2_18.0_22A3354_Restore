...
{
  return (_TtC9SeymourUI19ActionBrickItemCell *)sub_22B182DD8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
{
  _TtC9SeymourUI19ActionBrickItemCell *v2;
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)a3 withHorizontalFittingPriority:(float)a4 verticalFittingPriority:(float)a5
{
  double height;
  double width;
  _TtC9SeymourUI19ActionBrickItemCell *v9;
  id v10;
  double v11;
  double v12;
  double v13;
  ...
  width = a3.width;
  v9 = self;
  v10 = -[ActionBrickItemCell contentView](v9, sel_contentView);
  *(float *)&v11 = a4;
  *(float *)&v12 = a5;
...
- (void)downloadButtonTapped:(id)a3
{
  ...
  uint64_t v11;
  id v12;
  _TtC9SeymourUI19ActionBrickItemCell *v13;
  uint64_t v14;

  v5 = type metadata accessor for ShelfItemAction();
  v6 = MEMORY[0x24BDAC7A8](v5);
  v8 = (char *)&v14 - ((v7 + 15) & 0xFFFFFFFFFFFFFFF0);
  v9 = MEMORY[0x22E2F3FFC]((char *)self + OBJC_IVAR____TtC9SeymourUI19ActionBrickItemCell_delegate, v6);
  if (v9)
  {
    v10 = v9;
...
- (void).cxx_destruct
{
  sub_22B119BC0((uint64_t)self + OBJC_IVAR____TtC9SeymourUI19ActionBrickItemCell_delegate);
  sub_22B168AF8((uint64_t)self + OBJC_IVAR____TtC9SeymourUI19ActionBrickItemCell_itemInfo);
