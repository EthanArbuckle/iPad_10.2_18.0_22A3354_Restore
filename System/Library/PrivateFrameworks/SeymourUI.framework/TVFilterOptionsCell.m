...
{
  return (_TtC9SeymourUI19TVFilterOptionsCell *)sub_22B3C0F00(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)didUpdateFocusInContext:(id)a3 withAnimationCoordinator:(id)a4
{
  id v6;
  id v7;
  _TtC9SeymourUI19TVFilterOptionsCell *v8;
...
- (void)prepareForReuse
{
  ...
  char *v5;
  objc_class *v6;
  _TtC9SeymourUI19TVFilterOptionsCell *v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t v10;
  objc_super v11;
  ...
  v6 = (objc_class *)type metadata accessor for TVFilterOptionsCell();
  v11.receiver = self;
  v11.super_class = v6;
  v7 = self;
  ...
  v9 = (uint64_t)v7 + OBJC_IVAR____TtC9SeymourUI19TVFilterOptionsCell_itemInfo;
  swift_beginAccess();
...
- (void).cxx_destruct
{
  sub_22B119BC0((uint64_t)self + OBJC_IVAR____TtC9SeymourUI19TVFilterOptionsCell_delegate);
  sub_22B168AF8((uint64_t)self + OBJC_IVAR____TtC9SeymourUI19TVFilterOptionsCell_itemInfo);
