...
{
  return (_TtC9SeymourUI31WorkoutPlanGalleryBrickItemCell *)sub_22B3727B0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)a3 withHorizontalFittingPriority:(float)a4 verticalFittingPriority:(float)a5
{
  double height;
  double width;
  _TtC9SeymourUI31WorkoutPlanGalleryBrickItemCell *v9;
  id v10;
  double v11;
  double v12;
  double v13;
  ...
  width = a3.width;
  v9 = self;
  v10 = -[WorkoutPlanGalleryBrickItemCell contentView](v9, sel_contentView);
  *(float *)&v11 = a4;
  *(float *)&v12 = a5;
...
- (void).cxx_destruct
{
  sub_22B119BC0((uint64_t)self + OBJC_IVAR____TtC9SeymourUI31WorkoutPlanGalleryBrickItemCell_delegate);
  sub_22B168AF8((uint64_t)self + OBJC_IVAR____TtC9SeymourUI31WorkoutPlanGalleryBrickItemCell_itemInfo);
