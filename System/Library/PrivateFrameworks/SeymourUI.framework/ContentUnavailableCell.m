...
{
  return (_TtC9SeymourUI22ContentUnavailableCell *)sub_22B32651C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)prepareForReuse
{
  ...
  char *v5;
  objc_class *v6;
  _TtC9SeymourUI22ContentUnavailableCell *v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t v10;
  objc_super v11;
  ...
  v11.super_class = v6;
  v7 = self;
  -[ContentUnavailableCell prepareForReuse](&v11, sel_prepareForReuse);
  v8 = type metadata accessor for ShelfCellItemInfo();
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(_QWORD *)(v8 - 8) + 56))(v5, 1, 1, v8);
  v9 = (uint64_t)v7 + OBJC_IVAR____TtC9SeymourUI22ContentUnavailableCell_itemInfo;
  swift_beginAccess();
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)a3 withHorizontalFittingPriority:(float)a4 verticalFittingPriority:(float)a5
{
  double height;
  double width;
  _TtC9SeymourUI22ContentUnavailableCell *v9;
  id v10;
  double v11;
  double v12;
  double v13;
  ...
  width = a3.width;
  v9 = self;
  v10 = -[ContentUnavailableCell contentView](v9, sel_contentView);
  *(float *)&v11 = a4;
  *(float *)&v12 = a5;
...
- (void).cxx_destruct
{
  sub_22B119BC0((uint64_t)self + OBJC_IVAR____TtC9SeymourUI22ContentUnavailableCell_delegate);
  sub_22B168AF8((uint64_t)self + OBJC_IVAR____TtC9SeymourUI22ContentUnavailableCell_itemInfo);
