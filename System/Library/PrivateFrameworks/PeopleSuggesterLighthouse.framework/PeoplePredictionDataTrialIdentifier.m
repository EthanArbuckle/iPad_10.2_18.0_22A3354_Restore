...
- (id)description
{
  ...
  -[PeoplePredictionDataTrialIdentifier description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PeoplePredictionDataTrialIdentifier dictionaryRepresentation](self, "dictionaryRepresentation");
