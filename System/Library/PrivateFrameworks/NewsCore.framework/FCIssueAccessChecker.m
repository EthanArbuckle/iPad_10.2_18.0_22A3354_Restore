...
void __85__FCIssueAccessChecker_initWithPaidAccessChecker_privateChannelMembershipController___block_invoke(uint64_t a1, void *a2)
{
  ...
  v7 = -[FCIssueDraftAccessChecker initWithPrivateChannelMembershipController:]([FCIssueDraftAccessChecker alloc], "initWithPrivateChannelMembershipController:", *(_QWORD *)(a1 + 32));
...
- (FCIssueAccessChecker)init
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@: %s"), CFSTR("Do not call method"), "-[FCIssueAccessChecker init]");
...
- (FCIssueAccessChecker)initWithAccessCheckers:(id)a3
{
  ...
  if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315906;
    v10 = "-[FCIssueAccessChecker initWithAccessCheckers:]";
    v11 = 2080;
    v12 = "FCIssueAccessChecker.m";
    v13 = 1024;
    v14 = 29;
    v15 = 2114;
    v16 = v4;
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@: %s"), CFSTR("Do not call method"), "-[FCIssueAccessChecker initWithAccessCheckers:]");
