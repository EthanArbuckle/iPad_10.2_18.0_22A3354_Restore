...
{
  return -[FCNewsTabiTagCohortMembershipEndpoint initWithDictionary:](self, "initWithDictionary:", 0);
}
...
- (FCNewsTabiTagCohortMembershipEndpoint)initWithDictionary:(id)a3
{
  ...
  void *v6;
  id v7;
  FCNewsTabiTagCohortMembershipConfiguration *v8;
  FCNewsTabiTagCohortMembershipConfiguration *v9;
  FCNewsTabiTagCohortMembershipConfiguration *v10;
  FCNewsTabiTagCohortMembershipEndpoint *v11;
  FCNewsTabiTagCohortMembershipEndpoint *v12;
  void *v13;
  FCNewsTabiEventAggregationOutputsConfiguration *v14;
  FCNewsTabiEventAggregationOutputsConfiguration *eventAggregationOutputs;
  FCNewsTabiTagCohortMembershipEndpoint *v16;
  objc_super v18;
  _QWORD v19[4];
  id v20;
  _QWORD v21[4];
  ...
  {
    v7 = v5;
    v8 = -[FCNewsTabiTagCohortMembershipConfiguration initWithDictionary:]([FCNewsTabiTagCohortMembershipConfiguration alloc], "initWithDictionary:", v4);
    v9 = v8;
    if (v8)
    {
      v10 = v8;
      ...
      v11 = -[FCNewsTabiTagCohortMembershipEndpoint init](&v18, sel_init);
      v12 = v11;
      if (v11)
      {
    ...
    else
    {
      ...
      v19[1] = 3221225472;
      v19[2] = __60__FCNewsTabiTagCohortMembershipEndpoint_initWithDictionary___block_invoke_4;
      v19[3] = &unk_1E463B350;
      v20 = v4;
      __60__FCNewsTabiTagCohortMembershipEndpoint_initWithDictionary___block_invoke_4((uint64_t)v19);
...
uint64_t __60__FCNewsTabiTagCohortMembershipEndpoint_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1A1B90000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiTagCohortMembershipEndpoint due to failure to decode packageAssetID from configuration %{public}@", (uint8_t *)&v7, 0xCu);

  }
  return 0;
}

uint64_t __60__FCNewsTabiTagCohortMembershipEndpoint_initWithDictionary___block_invoke_4(uint64_t a1)
{
  void *v2;
  void *v4;
  NSObject *v5;
  ...
  if (os_log_type_enabled((os_log_t)FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1A1B90000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiTagCohortMembershipEndpoint due to failure to decode configuration from configuration %{public}@", (uint8_t *)&v7, 0xCu);
...
- (id)description
{
  ...
  -[FCNewsTabiTagCohortMembershipEndpoint packageAssetID](self, "packageAssetID");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR("\n\tpackageAssetID: %@;"), v4);

  -[FCNewsTabiTagCohortMembershipEndpoint configuration](self, "configuration");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "indentedDescription");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR("\n\tconfiguration: %@;"), v6);

  -[FCNewsTabiTagCohortMembershipEndpoint eventAggregationOutputs](self, "eventAggregationOutputs");
