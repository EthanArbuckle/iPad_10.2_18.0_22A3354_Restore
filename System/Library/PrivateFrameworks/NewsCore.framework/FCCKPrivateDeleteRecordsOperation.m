...
- (BOOL)validateOperation
{
  ...
  -[FCCKPrivateDeleteRecordsOperation recordIDsToDelete](self, "recordIDsToDelete");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = objc_msgSend(v4, "count");

  if (!v5 && os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("can't delete records without records IDs to delete"));
...
- (void)performOperation
{
  ...
  FCCKPrivateDeleteRecordsOperation *v12;
  ...
  v9[3] = &unk_1E463B408;
  v9[4] = self;
  -[FCCKPrivateDatabaseCKOperationResults notifyWhenFinishWithQoS:completionHandler:](v8, "notifyWhenFinishWithQoS:completionHandler:", -[FCCKPrivateDeleteRecordsOperation qualityOfService](self, "qualityOfService"), v9);
...
void __53__FCCKPrivateDeleteRecordsOperation_performOperation__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
    ...
    v5 = 0;
  v6 = v5;
  objc_msgSend(v4, "setRecordIDsToDelete:", v6);
...
void __53__FCCKPrivateDeleteRecordsOperation_performOperation__block_invoke_2(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (v6)
    ...
    v9 = 0;
  v10 = v9;
  objc_msgSend(v5, "operationDidFinishWithItemIDs:resultItems:error:", v10, v8, v7);
...
void __53__FCCKPrivateDeleteRecordsOperation_performOperation__block_invoke_3(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  v5 = *(void **)(a1 + 32);
  v6 = a3;
  objc_msgSend(v5, "setResultDeletedRecordIDs:", a2);
...
- (void)operationWillFinishWithError:(id)a3
{
  ...
  v7 = a3;
  -[FCCKPrivateDeleteRecordsOperation deleteRecordsCompletionBlock](self, "deleteRecordsCompletionBlock");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v4)
  {
    ...
    -[FCCKPrivateDeleteRecordsOperation resultDeletedRecordIDs](self, "resultDeletedRecordIDs");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
