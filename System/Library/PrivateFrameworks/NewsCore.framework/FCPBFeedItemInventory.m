...
- (void)dealloc
{
  ...
  -[FCPBFeedItemInventory setLastRefreshed:](self, "setLastRefreshed:", 0);
  -[FCPBFeedItemInventory setFeedItems:](self, "setFeedItems:", 0);
  v3.receiver = self;
  v3.super_class = (Class)FCPBFeedItemInventory;
  -[FCPBFeedItemInventory dealloc](&v3, sel_dealloc);
}
...
- (void)addFeedItems:(id)a3
{
  ...
  if (!feedItems)
  {
    feedItems = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E0C99DE8]);
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)FCPBFeedItemInventory;
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@ %@"), -[FCPBFeedItemInventory description](&v3, sel_description), -[FCPBFeedItemInventory dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_inventoryVersion), CFSTR("inventory_version"));
    has = (char)self->_has;
  }
  if ((has & 1) != 0)
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_feedItemVersion), CFSTR("feed_item_version"));
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_feedItems, "count"));
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
