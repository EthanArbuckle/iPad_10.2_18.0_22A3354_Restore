...
- (void)validate
{
  ...
  if (-[FCHCRecordExistenceExpectation shouldExist](self, "shouldExist"))
  {
    objc_msgSend(MEMORY[0x1E0CB3978], "isMainThread");
    if (!v14[5] || v8[5])
    {
      v3 = (void *)MEMORY[0x1E0C99DA0];
      -[FCHCRecordExistenceExpectation recordID](self, "recordID");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "raise:format:", *MEMORY[0x1E0C99750], CFSTR("record should exist in database: %@"), v4);
LABEL_8:
  ...
  else
  {
    ...
    if (v14[5] || (objc_msgSend((id)v8[5], "fc_isCKUnknownItemError") & 1) == 0)
    {
      ...
      -[FCHCRecordExistenceExpectation recordID](self, "recordID");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v5, "raise:format:", *MEMORY[0x1E0C99750], CFSTR("record should not exist in database: %@"), v4);
      goto LABEL_8;
    }
  }
...
void __42__FCHCRecordExistenceExpectation_validate__block_invoke_2(_QWORD *a1, void *a2, void *a3)
{
  id v5;
  id v6;
  uint64_t v7;
