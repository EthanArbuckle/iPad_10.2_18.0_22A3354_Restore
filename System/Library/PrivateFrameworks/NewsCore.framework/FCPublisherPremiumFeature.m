...
- (FCPublisherPremiumFeature)init
{
  ...
  -[FCPublisherPremiumFeature initWithTagID:](self, "initWithTagID:", 0);
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@: %s"), CFSTR("Do not call method"), "-[FCPublisherPremiumFeature init]");
...
{
  id v5;
  FCPublisherPremiumFeature *v6;
  FCPublisherPremiumFeature *v7;
  uint64_t v8;
  ...
  if (v6)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@%@%@"), CFSTR("f5"), CFSTR("+"), v5);
...
- (FCPublisherPremiumFeature)initWithPersonalizationIdentifier:(id)a3
{
  ...
  else
  {
    ...
    self = -[FCPublisherPremiumFeature initWithTagID:](self, "initWithTagID:", v8);
