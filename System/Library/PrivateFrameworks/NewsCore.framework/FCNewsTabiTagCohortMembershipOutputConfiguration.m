...
- (FCNewsTabiTagCohortMembershipOutputConfiguration)initWithDictionary:(id)a3
{
  ...
  FCNewsTabiTagCohortMembershipOutputConfiguration *v10;
  objc_super v12;
  _QWORD v13[4];
  id v14;

  v4 = a3;
  FCAppConfigurationStringValue(v4, (uint64_t)CFSTR("cohortMembershipOutputName"), 0);
  ...
  if (v5)
  {
    ...
    v8 = -[FCNewsTabiTagCohortMembershipOutputConfiguration init](&v12, sel_init);
    v9 = v8;
    if (v8)
...
uint64_t __71__FCNewsTabiTagCohortMembershipOutputConfiguration_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1A1B90000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiTagCohortMembershipOutputConfiguration due to failure to decode cohortMembershipOutputName from configuration %{public}@", (uint8_t *)&v7, 0xCu);
...
- (id)description
{
  ...
  -[FCNewsTabiTagCohortMembershipOutputConfiguration cohortMembershipOutputName](self, "cohortMembershipOutputName");
...
{
  objc_storeStrong((id *)&self->_cohortMembershipOutputName, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_cohortMembershipOutputName, 0);
}
