...
{
  id v5;
  FCIssueDraftAccessChecker *v6;
  FCIssueDraftAccessChecker *v7;
  void *v9;
  objc_super v10;
  uint8_t buf[4];
  const char *v12;
...
- (FCIssueDraftAccessChecker)init
{
  ...
  if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315906;
    ...
    v9 = 2080;
    v10 = "FCIssueDraftAccessChecker.m";
    v11 = 1024;
    v12 = 24;
    v13 = 2114;
    v14 = v2;
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@: %s"), CFSTR("Do not call method"), "-[FCIssueDraftAccessChecker init]");
...
- (BOOL)canSynchronouslyCheckAccessToItem:(id)a3
{
  ...
  {
    v5 = -[FCIssueDraftAccessChecker shouldShowAllDraftContent](self, "shouldShowAllDraftContent");
  }
  else
  {
    v5 = 0;
...
- (BOOL)hasAccessToItem:(id)a3 blockedReason:(unint64_t *)a4 error:(id *)a5
{
  ...
  if (!objc_msgSend(v7, "isDraft")
    ...
    || -[FCIssueDraftAccessChecker shouldShowAllDraftContent](self, "shouldShowAllDraftContent"))
  {
    LOBYTE(a5) = 1;
  }
  else if (a5)
...
LABEL_6:
  if (-[FCIssueDraftAccessChecker canSynchronouslyCheckAccessToItem:](self, "canSynchronouslyCheckAccessToItem:", v8))
  {
    v17.receiver = self;
  ...
  {
    -[FCIssueDraftAccessChecker privateChannelMembershipController](self, "privateChannelMembershipController");
    ...
    v15 = v8;
    v16 = v9;
    objc_msgSend(v10, "isAllowedToSeeIssueID:completionBlock:", v11, v14);
