...
- (id)description
{
  ...
  -[FCCKPResponseOperationResultErrorServer description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[FCCKPResponseOperationResultErrorServer dictionaryRepresentation](self, "dictionaryRepresentation");
