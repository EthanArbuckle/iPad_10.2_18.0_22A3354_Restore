...
- (id)backingHeadlineIDs
{
  ...
  -[FCReadingHistoryFeedDescriptor readingHistory](self, "readingHistory");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "sortedVisitedArticleIDs");
...
- (FCReadingHistoryFeedDescriptor)initWithReadingHistory:(id)a3
{
  ...
  return -[FCPrivateZoneFeedDescriptor initWithPrivateDataController:identifier:feedType:](&v4, sel_initWithPrivateDataController_identifier_feedType_, a3, CFSTR("FCReading-History"), 3);
}
...
- (FCReadingHistoryFeedDescriptor)initWithPrivateDataController:(id)a3 identifier:(id)a4 feedType:(int64_t)a5
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@: %s"), CFSTR("Do not call method"), "-[FCReadingHistoryFeedDescriptor initWithPrivateDataController:identifier:feedType:]");
