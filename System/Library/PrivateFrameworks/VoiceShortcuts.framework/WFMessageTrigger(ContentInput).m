...
- (id)contentCollectionWithEventInfo:()ContentInput
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315394;
    ...
    v19 = 2112;
    v20 = v3;
    _os_log_impl(&dword_1C146A000, v4, OS_LOG_TYPE_DEBUG, "%s Creating WFMessageContentItem from eventinfo: %@", buf, 0x16u);
  }
...
LABEL_19:
  ...
  -[NSObject if_map:](v14, "if_map:", &__block_literal_global_164);
