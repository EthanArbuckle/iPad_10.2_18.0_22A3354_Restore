...
- (void)clearFiles
{
  -[NSMutableArray removeAllObjects](self->_files, "removeAllObjects");
}
...
- (void)addFiles:(id)a3
{
  ...
  -[NSMutableArray addObject:](files, "addObject:", v4);

}

- (unint64_t)filesCount
{
  return -[NSMutableArray count](self->_files, "count");
}

- (id)filesAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_files, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[VCPBIntentDefinition description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VCPBIntentDefinition dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_files, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("files"));
  }
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  objc_msgSend(v8, "setAssociatedBundleID:", self->_associatedBundleID);
  if (-[VCPBIntentDefinition filesCount](self, "filesCount"))
  {
    objc_msgSend(v8, "clearFiles");
    v4 = -[VCPBIntentDefinition filesCount](self, "filesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[VCPBIntentDefinition filesAtIndex:](self, "filesAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addFiles:", v7);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](associatedBundleID, "isEqual:")))
  {
    ...
    if ((unint64_t)files | v4[2])
      v7 = -[NSMutableArray isEqual:](files, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_associatedBundleID, "hash");
  return -[NSMutableArray hash](self->_files, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[VCPBIntentDefinition addFiles:](self, "addFiles:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
