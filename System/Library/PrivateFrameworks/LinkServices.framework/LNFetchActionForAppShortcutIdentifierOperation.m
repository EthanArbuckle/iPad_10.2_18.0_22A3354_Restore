...
- (LNFetchActionForAppShortcutIdentifierOperation)initWithConnectionInterface:(id)a3 appShortcutIdentifier:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  id v14;
  void *v15;
  LNFetchActionForAppShortcutIdentifierOperation *v16;
  uint64_t v17;
  NSString *appShortcutIdentifier;
  uint64_t v19;
  id completionHandler;
  LNFetchActionForAppShortcutIdentifierOperation *v21;
  void *v23;
  void *v24;
  void *v25;
  objc_super v26;
...
LABEL_8:
    ...
    objc_msgSend(v24, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("LNFetchActionForAppShortcutIdentifierOperation.m"), 29, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("appShortcutIdentifier"));
  ...
  objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("LNFetchActionForAppShortcutIdentifierOperation.m"), 28, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("connectionInterface"));
...
LABEL_9:
  ...
  objc_msgSend(v25, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("LNFetchActionForAppShortcutIdentifierOperation.m"), 30, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("completionHandler"));
...
LABEL_4:
  ...
  v16 = -[LNInterfaceConnectionOperation initWithIdentifier:connectionInterface:priority:queue:activity:](&v26, sel_initWithIdentifier_connectionInterface_priority_queue_activity_, v15, v11, 1, v13, &__block_literal_global_8546);
...
- (void)start
{
  ...
  {
    -[LNFetchActionForAppShortcutIdentifierOperation appShortcutIdentifier](self, "appShortcutIdentifier");
  ...
  v7[3] = &unk_1E45DD760;
  v7[4] = self;
  objc_msgSend(v5, "fetchActionForAppShortcutIdentifier:completionHandler:", v6, v7);
...
- (void)finishWithError:(id)a3
{
  ...
  v4 = a3;
  -[LNFetchActionForAppShortcutIdentifierOperation completionHandler](self, "completionHandler");
  v5 = (void *)objc_claimAutoreleasedReturnValue();

  if (v5)
  {
    -[LNFetchActionForAppShortcutIdentifierOperation result](self, "result");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[LNFetchActionForAppShortcutIdentifierOperation setCompletionHandler:](self, "setCompletionHandler:", 0);
    v4 = (id)v7;
  }
  v10.receiver = self;
...
{
  return _os_activity_create(&dword_1A18F6000, "appintents:fetch action for appshortcut identifier", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
