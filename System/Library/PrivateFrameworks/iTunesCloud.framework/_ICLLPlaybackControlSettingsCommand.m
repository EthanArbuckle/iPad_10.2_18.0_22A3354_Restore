...
- (id)description
{
  ...
  -[_ICLLPlaybackControlSettingsCommand description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_ICLLPlaybackControlSettingsCommand dictionaryRepresentation](self, "dictionaryRepresentation");
