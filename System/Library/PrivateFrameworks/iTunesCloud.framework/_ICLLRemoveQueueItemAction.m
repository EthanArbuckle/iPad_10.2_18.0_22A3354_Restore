...
- (id)description
{
  ...
  -[_ICLLRemoveQueueItemAction description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_ICLLRemoveQueueItemAction dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (removedItemIds)
    objc_msgSend(v3, "setObject:forKey:", removedItemIds, CFSTR("removedItemIds"));
  queueQuery = self->_queueQuery;
  if (queueQuery)
  {
    -[_ICLLQueueQuery dictionaryRepresentation](queueQuery, "dictionaryRepresentation");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("queueQuery"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v6 + 8) = v7;
  ...
  v15 = -[_ICLLQueueQuery copyWithZone:](self->_queueQuery, "copyWithZone:", a3);
  v16 = *(void **)(v6 + 16);
  *(_QWORD *)(v6 + 16) = v15;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 44) & 2) == 0 || self->_revision != *((_DWORD *)v4 + 10))
      goto LABEL_19;
  }
...
LABEL_19:
  ...
  removedItemIds = self->_removedItemIds;
  if ((unint64_t)removedItemIds | *((_QWORD *)v4 + 4)
    && !-[NSMutableArray isEqual:](removedItemIds, "isEqual:"))
  {
    goto LABEL_19;
  }
  queueQuery = self->_queueQuery;
  if ((unint64_t)queueQuery | *((_QWORD *)v4 + 2))
    v10 = -[_ICLLQueueQuery isEqual:](queueQuery, "isEqual:");
  else
    v10 = 1;
LABEL_20:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v5 = 0;
  v6 = v4 ^ v3 ^ v5 ^ -[NSMutableArray hash](self->_removedItemIds, "hash");
  return v6 ^ -[_ICLLQueueQuery hash](self->_queueQuery, "hash");
}
...
- (void)addRemovedItemIds:(uint64_t)a1
{
  id v3;
  void *v4;
  id v5;
