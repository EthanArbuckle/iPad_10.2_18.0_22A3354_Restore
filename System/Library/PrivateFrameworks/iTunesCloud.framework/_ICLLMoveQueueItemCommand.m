...
- (id)description
{
  ...
  -[_ICLLMoveQueueItemCommand description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_ICLLMoveQueueItemCommand dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v6 + 8) = v7;
  ...
  v9 = -[NSString copyWithZone:](self->_queueContext, "copyWithZone:", a3);
  v10 = *(void **)(v6 + 24);
  *(_QWORD *)(v6 + 24) = v9;
...
LABEL_17:
  ...
  if ((unint64_t)queueContext | *((_QWORD *)v4 + 3))
    v9 = -[NSString isEqual:](queueContext, "isEqual:");
  else
    v9 = 1;
LABEL_18:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v5 = 0;
  return v4 ^ v3 ^ v5 ^ -[NSString hash](self->_queueContext, "hash");
}
