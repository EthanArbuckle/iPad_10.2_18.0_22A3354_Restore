...
- (id)description
{
  ...
  -[_ICLLParticipantQuery description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_ICLLParticipantQuery dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_participants, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("participant"));
  }
  return v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)participants | v4[1])
      v6 = -[NSMutableArray isEqual:](participants, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_participants, "hash");
}
...
- (void)addParticipant:(uint64_t)a1
{
  id v3;
  void *v4;
  id v5;
