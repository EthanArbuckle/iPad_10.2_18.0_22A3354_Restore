...
- (id)description
{
  ...
  -[_ICLLReplaceQueueItemsCommand description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_ICLLReplaceQueueItemsCommand dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (autoPlay)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v15, CFSTR("autoPlay"));
  ...
  if (radio)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v17, CFSTR("radio"));
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v18, CFSTR("trackGenerationSource"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v16 = -[NSString copyWithZone:](self->_queueContext, "copyWithZone:", a3);
  v17 = (void *)v6[4];
  v6[4] = v16;
...
LABEL_6:
  ...
  v7 = v5 ^ v6 ^ -[NSString hash](self->_queueContext, "hash");
