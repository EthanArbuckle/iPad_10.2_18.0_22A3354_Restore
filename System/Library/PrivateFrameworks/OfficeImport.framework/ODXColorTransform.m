...
+ (void)readNode:(_xmlNode *)a3 transform:(id)a4 state:(id)a5
{
  ...
  CXNamespace *v12;
  _BOOL4 v13;
  ODDColorTransformStyleLabel *v14;
  void *v15;
  id v16;
  ...
  HasName = CXNodeHasName(a3, v8, (xmlChar *)"colorsDef");

  if (!HasName)
    objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", CFSTR("ODXException"), CFSTR("Not a diagram color transform node"));
  objc_msgSend(v7, "ODXDiagramNamespace");
  ...
  while (1)
  {
    ...
    +[ODXColorTransformStyleLabel readNode:label:state:](ODXColorTransformStyleLabel, "readNode:label:state:", v11, v14, v7);
