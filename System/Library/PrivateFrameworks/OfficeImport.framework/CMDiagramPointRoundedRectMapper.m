...
- (void)mapAt:(id)a3 withState:(id)a4
{
  ...
  +[CMShapeRenderer renderCanonicalShape:fill:stroke:adjustValues:orientedBounds:state:drawingContext:](CMShapeRenderer, "renderCanonicalShape:fill:stroke:adjustValues:orientedBounds:state:drawingContext:", 2, v11, v12, 0, self->super.mOrientedBounds, v7, self->super.mDrawingContext);
