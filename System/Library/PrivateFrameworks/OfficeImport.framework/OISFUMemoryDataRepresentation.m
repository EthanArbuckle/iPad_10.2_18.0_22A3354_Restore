...
{
  OISFUMemoryDataRepresentation *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)OISFUMemoryDataRepresentation;
  v4 = -[OISFUMemoryDataRepresentation init](&v6, sel_init);
  if (v4)
...
{
  OISFUMemoryDataRepresentation *v4;
  OISFUMemoryDataRepresentation *v5;
  void *v6;
  int64_t v7;
  char *v8;
  void *v9;
  ...
  v4 = -[OISFUMemoryDataRepresentation init](&v14, sel_init);
  v5 = v4;
  if (v4)
  {
    if (a3)
...
- (void)dealloc
{
  ...
  -[OISFUMemoryDataRepresentation dealloc](&v3, sel_dealloc);
}
...
{
  return -[OISFUMemoryInputStream initWithData:]([OISFUMemoryInputStream alloc], "initWithData:", self->mData);
}
...
- (BOOL)hasSameLocationAs:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
    return 0;
  v5 = -[OISFUMemoryDataRepresentation data](self, "data");
