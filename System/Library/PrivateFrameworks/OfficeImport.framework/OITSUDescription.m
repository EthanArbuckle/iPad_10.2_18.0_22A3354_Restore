...
- (OITSUDescription)initWithObject:(id)a3 class:(Class)a4 header:(id)a5
{
  ...
  v8 = -[OITSUDescription init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_object = a3;
...
- (OITSUDescription)initWithCFType:(void *)a3 header:(id)a4
{
  ...
  v6 = -[OITSUDescription init](&v9, sel_init);
  v7 = v6;
  if (v6)
  {
    v6->_cfType = a3;
...
{
  void *v9;
  OITSUDescription *v10;

  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithFormat:arguments:", a5, a6);
  v10 = -[OITSUDescription initWithObject:class:header:](self, "initWithObject:class:header:", a3, a4, v9);
...
- (OITSUDescription)initWithObject:(id)a3 class:(Class)a4 format:(id)a5
{
  ...
  return -[OITSUDescription initWithObject:class:format:arguments:](self, "initWithObject:class:format:arguments:", a3, a4, a5, &v6);
}
...
- (OITSUDescription)initWithObject:(id)a3 format:(id)a4
{
  ...
  return -[OITSUDescription initWithObject:class:format:arguments:](self, "initWithObject:class:format:arguments:", a3, object_getClass(a3), a4, &v5);
}

- (OITSUDescription)initWithObject:(id)a3
{
  return -[OITSUDescription initWithObject:class:format:](self, "initWithObject:class:format:", a3, object_getClass(a3), &stru_24F3BFFF8);
}
...
+ (id)descriptionWithObject:(id)a3 class:(Class)a4 format:(id)a5
{
  ...
  return -[OITSUDescription initWithObject:class:format:arguments:]([OITSUDescription alloc], "initWithObject:class:format:arguments:", a3, a4, a5, &v6);
}
...
+ (id)descriptionWithObject:(id)a3 format:(id)a4
{
  ...
  return -[OITSUDescription initWithObject:class:format:arguments:]([OITSUDescription alloc], "initWithObject:class:format:arguments:", a3, object_getClass(a3), a4, &v5);
}

+ (id)descriptionWithObject:(id)a3 class:(Class)a4
{
  return -[OITSUDescription initWithObject:class:format:]([OITSUDescription alloc], "initWithObject:class:format:", a3, a4, &stru_24F3BFFF8);
}
...
+ (id)descriptionWithCFType:(void *)a3 format:(id)a4
{
  ...
  v6 = -[OITSUDescription initWithCFType:header:]([OITSUDescription alloc], "initWithCFType:header:", a3, v5);
...
{
  return (id)objc_msgSend(a1, "descriptionWithObject:format:", a3, &stru_24F3BFFF8);
}
...
- (void)dealloc
{
  ...
  -[OITSUDescription dealloc](&v3, sel_dealloc);
}
...
- (void)addField:(id)a3 format:(id)a4
{
  ...
  -[OITSUDescription addField:value:](self, "addField:value:", a3, v6);
...
- (void)addFieldWithFormat:(id)a3
{
  ...
  -[OITSUDescription addField:value:](self, "addField:value:", 0, v4);

}

- (void)addFieldValue:(id)a3
{
  -[OITSUDescription addFieldWithFormat:](self, "addFieldWithFormat:", CFSTR("%@"), a3);
}
...
- (void)addSuperDescription
{
  ...
  v5 = -[OITSUDescription description](&v6, sel_description);
...
LABEL_5:
    v3 = -[OITSUDescription p_header](self, "p_header");
    goto LABEL_6;
  }
  v4 = (void *)objc_msgSend(MEMORY[0x24BDD16A8], "stringWithFormat:", CFSTR("%@ {"), -[OITSUDescription p_header](self, "p_header"));
