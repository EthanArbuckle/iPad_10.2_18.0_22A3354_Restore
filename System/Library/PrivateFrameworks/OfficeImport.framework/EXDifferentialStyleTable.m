...
+ (void)readFrom:(_xmlNode *)a3 state:(id)a4
{
  ...
  if (a3)
  {
    ...
    objc_msgSend(v6, "differentialStyles");
    ...
    while (Child)
    {
      +[EXDifferentialStyle edDifferentialStyleFromXmlDifferentialStyleElement:state:](EXDifferentialStyle, "edDifferentialStyleFromXmlDifferentialStyleElement:state:", Child, v12);
