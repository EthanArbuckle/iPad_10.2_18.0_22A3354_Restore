...
- (void)mapPoint:(id)a3 bounds:(CGRect)a4
{
  ...
  x = a4.origin.x;
  v9 = a3;
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("bullet%d%c"), -[ODIState pointCount](self->super.mState, "pointCount"), -[ODIState pointIndex](self->super.mState, "pointIndex") + 97);
