...
- (OITSUHTMLTable)init
{
  ...
  v2 = -[OITSUHTMLTable init](&v4, sel_init);
  if (v2)
  {
...
- (void)dealloc
{
  ...
  -[OITSUHTMLTable dealloc](&v3, sel_dealloc);
}
...
{
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%tu,%tu"), a3, a4);
}
...
{
  -[OITSUHTMLTable addRowWithCellMarkup:](self, "addRowWithCellMarkup:", objc_msgSend(a3, "tsu_arrayByTransformingWithBlock:", &__block_literal_global_16));
}
...
uint64_t __37__OITSUHTMLTable_addRowWithCellText___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
    return objc_msgSend((id)objc_msgSend(a2, "tsu_arrayByFlattening"), "componentsJoinedByString:", &stru_24F3BFFF8);
  else
...
- (void)setColumnClasses:(id)a3
{
  ...
  if (objc_msgSend(a3, "count"))
  {
    ...
    do
    {
      -[OITSUHTMLTable setClass:ofColumnIndex:](self, "setClass:ofColumnIndex:", objc_msgSend(a3, "objectAtIndexedSubscript:", v5), v5);
      ++v5;
    }
...
- (void)deleteColumnWithTitle:(id)a3
{
  ...
  v4 = -[OITSUHTMLTable indexOfColumnWithTitle:](self, "indexOfColumnWithTitle:", a3);
