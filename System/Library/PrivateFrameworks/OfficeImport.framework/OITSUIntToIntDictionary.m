...
{
  return -[OITSUIntToIntDictionary initWithCapacity:](self, "initWithCapacity:", 0);
}

- (OITSUIntToIntDictionary)initWithCapacity:(unint64_t)a3
{
  OITSUIntToIntDictionary *v4;
  objc_super v6;
  ...
  v6.receiver = self;
  v6.super_class = (Class)OITSUIntToIntDictionary;
  v4 = -[OITSUIntToIntDictionary init](&v6, sel_init);
  if (v4)
...
- (void)dealloc
{
  ...
  -[OITSUIntToIntDictionary dealloc](&v3, sel_dealloc);
}
...
- (id)keyEnumerator
{
  return -[OITSUIntToIntDictionaryKeyEnumerator initWithIntegerKeyDictionary:]([OITSUIntToIntDictionaryKeyEnumerator alloc], "initWithIntegerKeyDictionary:", self);
}
...
- (void)applyFromIntToIntDictionary:(id)a3
{
  ...
  if (a3)
  {
    ...
    if (v5)
    {
      ...
      do
      {
        -[OITSUIntToIntDictionary setInt:forKey:](self, "setInt:forKey:", objc_msgSend(a3, "intForKey:", v6[v7]), v6[v7]);
        v7 = v8;
      }
      while (v5 > v8++);
    }
...
- (id)arrayOfBoxedKeys
{
  ...
  v3 = -[OITSUIntToIntDictionary count](self, "count");
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[OITSUIntToIntDictionary count](self, "count"));
  v5 = (const void **)malloc_type_calloc(v3, 8uLL, 0x10040436913F5uLL);
  CFDictionaryGetKeysAndValues(-[OITSUIntToIntDictionary p_cfDictionary](self, "p_cfDictionary"), v5, 0);
  if (v3)
  {
    v6 = 0;
    v7 = 1;
...
- (id)allValues
{
  ...
  v4 = objc_alloc_init(MEMORY[0x24BDD1698]);
  v5 = (const void **)malloc_type_calloc(v3, 8uLL, 0x100004000313F17uLL);
  CFDictionaryGetKeysAndValues(-[OITSUIntToIntDictionary p_cfDictionary](self, "p_cfDictionary"), 0, v5);
  if (v3)
  {
    v6 = v5;
    do
...
- (id)description
{
  ...
  v3 = -[OITSUIntToIntDictionary keyEnumerator](self, "keyEnumerator");
  ...
  if (v5 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    {
      v7 = -[OITSUIntToIntDictionary intForKey:](self, "intForKey:", i);
...
- (void)enumerateKeysAndValuesUsingBlock:(id)a3
{
  ...
  if (a3)
  {
    v5 = -[OITSUIntToIntDictionary keyEnumerator](self, "keyEnumerator");
    v6 = objc_msgSend(v5, "nextKey");
    if (v6 != 0x7FFFFFFFFFFFFFFFLL)
    {
      for (i = (const void *)v6; i != (const void *)0x7FFFFFFFFFFFFFFFLL; i = (const void *)objc_msgSend(v5, "nextKey"))
      {
