...
- (void)dealloc
{
  ...
  {
    MEMORY[0x22E2DDFE4]();
    NSZoneFree((NSZone *)-[OITSURegularExpression zone](self, "zone"), self->_reserved);
  }
  v3.receiver = self;
  v3.super_class = (Class)OITSURegularExpression;
  -[OITSURegularExpression dealloc](&v3, sel_dealloc);
}

- (OITSURegularExpression)initWithExpressionString:(id)a3
{
  return -[OITSURegularExpression initWithExpressionString:options:](self, "initWithExpressionString:options:", a3, 0);
}
...
- (OITSURegularExpression)initWithExpressionString:(id)a3 options:(unsigned int)a4
{
  ...
  v6 = -[OITSURegularExpression init](&v14, sel_init);
  if (v6)
  {
    ...
    *((_QWORD *)v6 + 2) = v10;
    ...
    if ((_DWORD)v12)
    {
      NSLog((NSString *)CFSTR("*** %s: error %d"), "-[OITSURegularExpression initWithExpressionString:options:]", v12);
...
{
  return -[OITSURegularExpression initWithExpressionString:](self, "initWithExpressionString:", &stru_24F3BFFF8);
}

- (id)copyWithZone:(_NSZone *)a3
{
  if ((_NSZone *)-[OITSURegularExpression zone](self, "zone") == a3)
    return self;
  else
...
- (_NSRange)matchedRangeForCString:(const char *)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  v12 = -[OITSURegularExpression numberOfSubexpressions](self, "numberOfSubexpressions");
  v13 = a6;
  if (v12 >= a6)
    v14 = a6;
  else
...
- (_NSRange)matchedRangeForString:(id)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  v12 = -[OITSURegularExpression matchedRangeForCString:range:subexpressionRanges:count:](self, "matchedRangeForCString:range:subexpressionRanges:count:", -[__CFData bytes](ASCIIData, "bytes"), location, length, a5, v6);
  v14 = v13;
...
- (OITSURegularExpression)initWithCoder:(id)a3
{
  ...
  {
    if (v6 == 1)
      return -[OITSURegularExpression initWithExpressionString:](self, "initWithExpressionString:", objc_msgSend(a3, "decodeObject"));
  }
  else
  {
    ...
    -[OITSURegularExpression dealloc](self, "dealloc");
    return 0;
  }
  return self;
}
