...
{
  OITSUIntegerKeyDictionaryKeyEnumerator *v4;
  size_t v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)OITSUIntegerKeyDictionaryKeyEnumerator;
  v4 = -[OITSUIntegerKeyDictionaryKeyEnumerator init](&v7, sel_init);
  if (v4)
  {
...
- (void)dealloc
{
  ...
  -[OITSUIntegerKeyDictionaryKeyEnumerator dealloc](&v4, sel_dealloc);
}
