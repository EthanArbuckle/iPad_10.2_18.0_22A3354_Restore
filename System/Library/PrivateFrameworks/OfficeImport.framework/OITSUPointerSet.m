...
- (void)dealloc
{
  ...
  -[OITSUPointerSet dealloc](&v4, sel_dealloc);
}
...
- (OITSUPointerSet)initWithObjects:(const void *)a3 count:(unint64_t)a4
{
  ...
  v6 = -[OITSUPointerSet init](&v9, sel_init);
  v7 = v6;
  if (a4 && v6)
...
- (OITSUPointerSet)initWithCFSet:(__CFSet *)a3
{
  ...
  v4 = -[OITSUPointerSet init](&v7, sel_init);
  v5 = v4;
  if (a3 && v4)
...
- (id)setByAddingObject:(id)a3
{
  ...
  v5 = -[OITSUPointerSet count](self, "count");
  v6 = v5;
  v7 = v5 + 1;
  v8 = 1;
  if (v5 + 1 < 0x41)
  ...
  -[OITSUPointerSet getObjects:](self, "getObjects:", v9);
  *(_QWORD *)&v9[8 * v6] = a3;
