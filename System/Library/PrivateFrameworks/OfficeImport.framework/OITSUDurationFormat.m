...
{
  OITSUDurationFormat *v6;
  objc_super v8;

  v8.receiver = self;
  v8.super_class = (Class)OITSUDurationFormat;
  v6 = -[OITSUDurationFormat init](&v8, sel_init);
  if (v6)
  {
...
- (void)dealloc
{
  ...
  -[OITSUDurationFormat dealloc](&v3, sel_dealloc);
}
...
{
  return (NSString *)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("SFTDurationFormat[%p]: Format String: %@ Name: %@"), self, self->mFormat, self->mName);
}
