...
- (id)addProgressObserverWithValueInterval:(double)a3 queue:(id)a4 handler:(id)a5
{
  ...
  -[OITSUProgressGroup p_updateChildrenProgressObservers](self, "p_updateChildrenProgressObservers");
  return v6;
}
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        objc_msgSend((id)objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 32), "objectAtIndex:", v6 + i), "removeProgressObserver:", *(_QWORD *)(*((_QWORD *)&v29 + 1) + 8 * i));
      }
    ...
    if (v14)
    {
      ...
      do
      {
        for (j = 0; j != v15; ++j)
        {
          ...
          v24[0] = v17;
          v24[1] = 3221225472;
          v24[2] = __55__OITSUProgressGroup_p_updateChildrenProgressObservers__block_invoke_2;
          v24[3] = &unk_24F39A608;
          v24[4] = v20;
          objc_msgSend(v12, "addObject:", objc_msgSend(v19, "addProgressObserverWithValueInterval:queue:handler:", v21, v24, v22));
        }
