...
- (void)scene:(id)a3 willConnectToSession:(id)a4 options:(id)a5
{
  ...
  id v9;
  id v10;
  _TtC10ChronoCore27AmbientCompactSceneDelegate *v11;
...
{
  id v4;
  _TtC10ChronoCore27AmbientCompactSceneDelegate *v5;
...
- (_TtC10ChronoCore27AmbientCompactSceneDelegate)init
{
  ...
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC10ChronoCore27AmbientCompactSceneDelegate__cancellables) = (Class)MEMORY[0x1E0DEE9D8];
  *(Class *)((char *)&self->super.super.super.super.isa
