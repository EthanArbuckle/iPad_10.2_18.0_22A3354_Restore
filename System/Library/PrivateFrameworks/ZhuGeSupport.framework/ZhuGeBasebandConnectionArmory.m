...
+ (id)getCoreTelephonyClient
{
  ...
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeBaseband.m", "+[ZhuGeBasebandConnectionArmory getCoreTelephonyClient]", 101, CFSTR("Failed to weak link core telephony client framework!"), v2, v3, v4, v9);
    v7 = 0;
  }
  return v7;
}

void __55__ZhuGeBasebandConnectionArmory_getCoreTelephonyClient__block_invoke()
{
...
void __54__ZhuGeBasebandConnectionArmory_getCTServerConnection__block_invoke()
{
  dispatch_semaphore_t v0;
  void *v1;
