...
- (id)_ZhuGeDescriptionWithLayer:()ZhuGe
{
  ...
  v5 = 4 * a3;
  objc_msgSend(&stru_251C3EC38, "stringByPaddingToLength:withString:startingAtIndex:", 4 * a3, CFSTR(" "), 0);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(&stru_251C3EC38, "stringByPaddingToLength:withString:startingAtIndex:", (4 * a3) | 2, CFSTR(" "), 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(&stru_251C3EC38, "stringByPaddingToLength:withString:startingAtIndex:", v5 + 4, CFSTR(" "), 0);
