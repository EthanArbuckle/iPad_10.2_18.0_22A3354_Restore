...
- (ZhuGeCache)initWithName:(id)a3 andCapacity:(id)a4 andCacheType:(Class)a5
{
  ...
  v11 = -[ZhuGeCache init](&v18, sel_init);
  v12 = v11;
  if (v11)
  {
    ...
    v13 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSNumber integerValue](v12->_capacity, "integerValue"));
    cacheList = v12->_cacheList;
    v12->_cacheList = (NSMutableArray *)v13;

    v15 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99E08]), "initWithCapacity:", -[NSNumber integerValue](v12->_capacity, "integerValue"));
...
- (void)clearCache
{
  ...
  -[ZhuGeCache cacheDict](self, "cacheDict");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "removeAllObjects");

  -[ZhuGeCache cacheList](self, "cacheList");
...
- (BOOL)setCache:(id)a3 forKey:(id)a4 withError:(id *)a5
{
  ...
  if (!a5)
  {
    -[ZhuGeCache name](self, "name");
    v29 = (void *)objc_claimAutoreleasedReturnValue();
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 91, CFSTR("In %@, error p-pointer is nil!"), v30, v31, v32, (uint64_t)v29);
  ...
  *a5 = 0;
  if (!v8)
  {
    ...
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 97, CFSTR("In %@, aCache pointer is nil!"), v34, v35, v36, (uint64_t)v33);
LABEL_17:
...
LABEL_18:
  ...
  if (!v9)
  {
    -[ZhuGeCache name](self, "name");
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 103, CFSTR("In %@, aKey pointer is nil!"), v37, v38, v39, (uint64_t)v33);
    goto LABEL_17;
  }
  -[ZhuGeCache cacheList](self, "cacheList");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    -[ZhuGeCache cacheType](self, "cacheType");
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      -[ZhuGeCache name](self, "name");
      v43 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 115, CFSTR("In %@, key \"%@\" got a wrong cache class type \"%@\"!"), v44, v45, v46, (uint64_t)v43);
  ...
  -[ZhuGeCache capacity](self, "capacity");
