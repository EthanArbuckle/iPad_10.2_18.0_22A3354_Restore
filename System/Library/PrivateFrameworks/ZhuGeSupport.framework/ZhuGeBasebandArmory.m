...
LABEL_10:
  ...
  ZhuGeLog(262400, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeBaseband.m", "+[ZhuGeBasebandArmory getBasebandClass]", 198, CFSTR("baseband class: %@"), v3, v4, v5, v2);
  objc_opt_class();
...
+ (BOOL)isBasebandReady
{
  ...
  v10 = 0;
  +[ZhuGeBasebandPostponementStatusArmory query:isCachable:withError:](ZhuGeBasebandPostponementStatusArmory, "query:isCachable:withError:", v3, 0, &v10);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ZhuGeLog(262400, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeBaseband.m", "+[ZhuGeBasebandArmory isBasebandReady]", 234, CFSTR("postponement status %@"), v5, v6, v7, (uint64_t)v4);
...
+ (BOOL)waitUntilBasebandReady:(int)a3 retryInterval:(int)a4
{
  ...
  if (v6)
  {
    LOBYTE(v6) = +[ZhuGeBasebandArmory isBasebandReady](ZhuGeBasebandArmory, "isBasebandReady");
    if ((v6 & 1) == 0 && a3 >= 1)
    {
      v7 = (double)a4;
      v8 = 1;
...
+ (id)getProperty:(char)a3[512] inPlane:(char)a4[128] withName:(__CFString *)a5 withOption:(unsigned int)a6
{
  ...
  if (v10)
  {
    ...
    IOObjectRelease(v14);
    if (!v15)
      ZhuGeLog(256, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeBaseband.m", "+[ZhuGeBasebandArmory getProperty:inPlane:withName:withOption:]", 276, CFSTR("can not find property %@ under %s"), v16, v17, v18, (uint64_t)a5);
  }
  else
  {
    ZhuGeLog(256, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeBaseband.m", "+[ZhuGeBasebandArmory getProperty:inPlane:withName:withOption:]", 269, CFSTR("can not find entry at %s"), v11, v12, v13, (uint64_t)a3);
    v15 = 0;
  }
  return v15;
}
