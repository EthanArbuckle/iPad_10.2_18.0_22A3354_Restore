...
{
  id v4;
  CalAggregateMigrationController *v5;
  uint64_t v6;
  NSArray *controllers;
  objc_super v9;
  ...
  v5 = -[CalAggregateMigrationController init](&v9, sel_init);
  if (v5)
  {
...
- (BOOL)shouldPerformMigration
{
  ...
  v9 = 0u;
  v10 = 0u;
  -[CalAggregateMigrationController controllers](self, "controllers", 0);
  ...
  if (v3)
  {
    ...
    while (2)
    {
      for (i = 0; i != v3; ++i)
      {
        ...
        if ((objc_msgSend(*(id *)(*((_QWORD *)&v7 + 1) + 8 * i), "shouldPerformMigration") & 1) != 0)
        {
          LOBYTE(v3) = 1;
          goto LABEL_11;
        }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v9 + 1) + 8 * v8++), "migrationDidFinishWithResult:", a3);
      }
      while (v6 != v8);
