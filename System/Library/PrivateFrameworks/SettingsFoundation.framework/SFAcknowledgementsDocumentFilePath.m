@implementation SFAcknowledgementsDocumentFilePath
...
void __SFAcknowledgementsDocumentFilePath_block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@.bundle"), CFSTR("Acknowledgements"));
  ...
  v6 = (void *)SFAcknowledgementsDocumentFilePath___path;
