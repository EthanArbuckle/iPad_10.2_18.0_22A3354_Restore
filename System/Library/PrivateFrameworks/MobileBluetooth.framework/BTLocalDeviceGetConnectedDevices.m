@implementation BTLocalDeviceGetConnectedDevices
...
void __BTLocalDeviceGetConnectedDevices_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_9_0(&dword_1B6BF1000, v0, v1, "kCBMsgIdLocalDeviceGetConnectedDevicesMsg reply result:%llx count:%lx", v2, v3);
  OUTLINED_FUNCTION_4();
}
