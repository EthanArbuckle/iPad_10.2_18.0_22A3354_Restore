@implementation BTAccessoryManagerGetTimeSyncId
...
void __BTAccessoryManagerGetTimeSyncId_block_invoke(uint64_t a1, xpc_object_t xdict)
{
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 24) = xpc_dictionary_get_uint64(xdict, "kCBMsgArgID");
  if (MBFLogInitOnce != -1)
...
void __BTAccessoryManagerGetTimeSyncId_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_3(&dword_1B6BF1000, v0, v1, "kCBMsgIdAccessoryGetTimeSyncIdMsg reply result:%llx", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_4();
}
