@implementation BTDiscoveryAgentGetDevices
...
void __BTDiscoveryAgentGetDevices_block_invoke_cold_1()
{
  ...
  v3 = 2048;
  v4 = v0;
  _os_log_debug_impl(&dword_1B6BF1000, v1, OS_LOG_TYPE_DEBUG, "kCBMsgIdDiscoveryAgentGetDevicesMsg reply result:%llx count:%lx", v2, 0x16u);
  OUTLINED_FUNCTION_4();
}
