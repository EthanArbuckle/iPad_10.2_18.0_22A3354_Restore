@implementation BTLocalDeviceGetConnectingDevices
...
void __BTLocalDeviceGetConnectingDevices_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_9_0(&dword_1B6BF1000, v0, v1, "kCBMsgIdLocalDeviceGetConnectingDevicesMsg reply result:%llx count:%lx", v2, v3);
  OUTLINED_FUNCTION_4();
}
