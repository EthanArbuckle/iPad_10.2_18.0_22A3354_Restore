@implementation BTLocalDeviceGetModulePower
...
void __BTLocalDeviceGetModulePower_block_invoke(uint64_t a1, xpc_object_t xdict)
{
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 24) = xpc_dictionary_get_uint64(xdict, "kCBMsgArgBTPowerMode");
  if (MBFLogInitOnce != -1)
  ...
  if (os_log_type_enabled((os_log_t)MBFLogComponent, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 2048;
    v10 = v6;
    _os_log_impl(&dword_1B6BF1000, v4, OS_LOG_TYPE_DEFAULT, "kCBMsgIdLocalDeviceGetModulePowerMsg reply with power state: %llx, result: %llx", (uint8_t *)&v7, 0x16u);
  }
}
