@implementation BTDeviceAddressToString

void __BTDeviceAddressToString_block_invoke(_QWORD *a1, xpc_object_t xdict)
{
  char *v4;
  const char *string;
...
void __BTDeviceAddressToString_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_3(&dword_1B6BF1000, v0, v1, "kCBMsgIdDeviceAddressToStringMsg reply result:%llx", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_4();
}
