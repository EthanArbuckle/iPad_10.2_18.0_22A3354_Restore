@implementation BTLocalDeviceUnregisterForPowerUpdates
...
void __BTLocalDeviceUnregisterForPowerUpdates_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_3(&dword_1B6BF1000, v0, v1, "kCBMsgIdLocalDeviceUnregisterForPowerUpdatesMsg reply result:%llx", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_4();
}
