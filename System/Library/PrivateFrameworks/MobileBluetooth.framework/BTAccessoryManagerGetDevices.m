@implementation BTAccessoryManagerGetDevices
...
void __BTAccessoryManagerGetDevices_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_9(&dword_1B6BF1000, v1, (uint64_t)v1, "kCBMsgIdAccessoryGetDevicesMsg reply result:%llx count:%lx", (uint8_t *)&v2);
  OUTLINED_FUNCTION_4();
}
