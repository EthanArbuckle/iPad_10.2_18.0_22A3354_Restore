@implementation BTAccessoryManagerSpatialAudioConfig
...
void __BTAccessoryManagerSpatialAudioConfig_block_invoke(uint64_t a1, xpc_object_t xdict)
{
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = xpc_dictionary_get_uint64(xdict, "kCBMsgArgResult");
  ...
  if (os_log_type_enabled((os_log_t)MBFLogComponent, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v5 = 134217984;
    v6 = v4;
    _os_log_impl(&dword_1B6BF1000, v3, OS_LOG_TYPE_DEFAULT, "kCBMsgBTAccessorySmartRouteMode reply result:%llx", (uint8_t *)&v5, 0xCu);
  }
}
