@implementation BTAccessoryManagerGetSpatialAudioActive
...
void __BTAccessoryManagerGetSpatialAudioActive_block_invoke(uint64_t a1, xpc_object_t xdict)
{
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 8) + 24) = xpc_dictionary_get_uint64(xdict, "kCBMsgArgAccessoryGenericConfigMode");
  ...
  if (os_log_type_enabled((os_log_t)MBFLogComponent, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v6 = 134217984;
    v7 = v5;
    _os_log_impl(&dword_1B6BF1000, v4, OS_LOG_TYPE_DEFAULT, "BTAccessoryManagerGetSpatialAudioActive reply result:%llx", (uint8_t *)&v6, 0xCu);
  }
}
