...
{
  -[PNRProvisionalMetrics setMetricsValue:](self, "setMetricsValue:", 0.0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
{
  -[PNRProvisionalMetrics setStartTimestamp:](self, "setStartTimestamp:", 0);
  *(_BYTE *)&self->_has &= ~2u;
}
...
{
  -[PNRProvisionalMetrics setStartTimestampEventName:](self, "setStartTimestampEventName:", 0);
}
...
{
  -[PNRProvisionalMetrics setEndTimestamp:](self, "setEndTimestamp:", 0);
  *(_BYTE *)&self->_has &= ~4u;
}
...
{
  -[PNRProvisionalMetrics setEndTimestampEventName:](self, "setEndTimestampEventName:", 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  -[PNRProvisionalMetrics startTimestampEventName](self, "startTimestampEventName");
  ...
  if ((*(_BYTE *)&self->_has & 4) != 0)
    PBDataWriterWriteInt64Field();
  -[PNRProvisionalMetrics endTimestampEventName](self, "endTimestampEventName");
...
{
  unsigned __int8 *v4;
  $6E51C8D7FCAA56AD72E55EF27F412CC7 has;
  unsigned int v6;
  double metricsValue;
  double v8;
  int v9;
  ...
  if ((*(_BYTE *)&has & 1) != 0)
  {
    metricsValue = self->_metricsValue;
    objc_msgSend(v4, "metricsValue");
    if (metricsValue != v8)
      goto LABEL_22;
    has = self->_has;
    v6 = v4[48];
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 4) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", -[PNRProvisionalMetrics endTimestamp](self, "endTimestamp"));
  ...
  if ((has & 1) != 0)
  {
    ...
    -[PNRProvisionalMetrics metricsValue](self, "metricsValue");
    objc_msgSend(v8, "numberWithDouble:");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("metricsValue"));

    has = (char)self->_has;
  }
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", -[PNRProvisionalMetrics startTimestamp](self, "startTimestamp"));
  ...
  -[PNRProvisionalMetrics willProduceDictionaryRepresentation:](self, "willProduceDictionaryRepresentation:", v3);
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[PNRProvisionalMetrics dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (PNRProvisionalMetrics)initWithJSON:(id)a3
{
  ...
  {
    self = -[PNRProvisionalMetrics initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PNRProvisionalMetrics)initWithDictionary:(id)a3
{
  ...
  v5 = -[PNRProvisionalMetrics init](&v15, sel_init);
  if (v5)
  {
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("metricsValue"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PNRProvisionalMetrics setStartTimestamp:](v5, "setStartTimestamp:", objc_msgSend(v7, "longLongValue"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PNRProvisionalMetrics setStartTimestampEventName:](v5, "setStartTimestampEventName:", v9);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PNRProvisionalMetrics setEndTimestamp:](v5, "setEndTimestamp:", objc_msgSend(v10, "longLongValue"));
    ...
    {
      v12 = (void *)objc_msgSend(v11, "copy");
      -[PNRProvisionalMetrics setEndTimestampEventName:](v5, "setEndTimestampEventName:", v12);
