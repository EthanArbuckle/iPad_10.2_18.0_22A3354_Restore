...
{
  -[PNRProvisionalSageErrorInfo setErrorDomain:](self, "setErrorDomain:", 0);
}
...
{
  -[PNRProvisionalSageErrorInfo setErrorCode:](self, "setErrorCode:", 0);
  *(_BYTE *)&self->_has &= ~1u;
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = a3;
  -[PNRProvisionalSageErrorInfo errorDomain](self, "errorDomain");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", -[PNRProvisionalSageErrorInfo errorCode](self, "errorCode"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[PNRProvisionalSageErrorInfo willProduceDictionaryRepresentation:](self, "willProduceDictionaryRepresentation:", v3);
  return v3;
}
...
- (NSData)jsonData
{
  ...
  -[PNRProvisionalSageErrorInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
{
  void *v4;
  PNRProvisionalSageErrorInfo *v5;
  uint64_t v7;
  ...
  {
    self = -[PNRProvisionalSageErrorInfo initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (PNRProvisionalSageErrorInfo)initWithDictionary:(id)a3
{
  ...
  void *v7;
  void *v8;
  PNRProvisionalSageErrorInfo *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)PNRProvisionalSageErrorInfo;
  v5 = -[PNRProvisionalSageErrorInfo init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[PNRProvisionalSageErrorInfo setErrorDomain:](v5, "setErrorDomain:", v7);
    ...
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[PNRProvisionalSageErrorInfo setErrorCode:](v5, "setErrorCode:", objc_msgSend(v8, "longLongValue"));
    v9 = v5;
