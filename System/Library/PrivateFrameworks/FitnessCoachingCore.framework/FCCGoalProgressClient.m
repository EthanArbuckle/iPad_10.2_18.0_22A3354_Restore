...
- (FCCGoalProgressClient)init
{
  FCCXPCClient *v3;
  void *v4;
  FCCGoalProgressClient *v5;

  v3 = objc_alloc_init(FCCXPCClient);
  HKCreateSerialDispatchQueueWithQOSClass();
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[FCCGoalProgressClient initWithQueue:xpcClient:](self, "initWithQueue:xpcClient:", v4, v3);
...
- (FCCGoalProgressClient)initWithQueue:(id)a3 xpcClient:(id)a4
{
  id v7;
  id v8;
  FCCGoalProgressClient *v9;
  FCCGoalProgressClient *v10;
  objc_super v12;
  ...
  v9 = -[FCCGoalProgressClient init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_postGoalProgressNotification:completion:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
}
...
- (void)_postGoalProgressNotification:(id)a3 completion:(id)a4
{
  ...
  -[FCCXPCClient transportMessage:data:completion:](self->_xpcClient, "transportMessage:data:completion:", 5, v7, v6);
