...
- (FCCGoalCompletionClient)init
{
  FCCXPCClient *v3;
  void *v4;
  FCCGoalCompletionClient *v5;

  v3 = objc_alloc_init(FCCXPCClient);
  HKCreateSerialDispatchQueueWithQOSClass();
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[FCCGoalCompletionClient initWithQueue:xpcClient:](self, "initWithQueue:xpcClient:", v4, v3);
...
- (FCCGoalCompletionClient)initWithQueue:(id)a3 xpcClient:(id)a4
{
  id v7;
  id v8;
  FCCGoalCompletionClient *v9;
  FCCGoalCompletionClient *v10;
  objc_super v12;
  ...
  v9 = -[FCCGoalCompletionClient init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_postGoalCompletionNotification:completion:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
}
...
- (void)_postGoalCompletionNotification:(id)a3 completion:(id)a4
{
  ...
  -[FCCXPCClient transportMessage:data:completion:](self->_xpcClient, "transportMessage:data:completion:", 3, v7, v6);
