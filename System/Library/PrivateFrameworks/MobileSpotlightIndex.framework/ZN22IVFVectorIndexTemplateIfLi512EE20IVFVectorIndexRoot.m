@implementation ZN22IVFVectorIndexTemplateIfLi512EE20IVFVectorIndexRoot

_DWORD *___ZN22IVFVectorIndexTemplateIfLi512EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE14compactForTestIS2_EENSt3__19enable_ifIXsr13is_persistentIT_EE5valueEbE4typeEPS4_PVi_block_invoke(uint64_t a1, unsigned int *a2, BOOL *a3)
{
  uint64_t v5;
  _DWORD *result;

  v5 = **((_QWORD **)a2 + 3);
  result = IVFVectorIndexTemplate<float,512>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::lookupForInsert(*(_QWORD *)(a1 + 32), a2[2], *((void **)a2 + 2), *a2, 0, *((float *)a2 + 1));
  *((_QWORD *)result + 256) = v5;
  *a3 = **(_DWORD **)(a1 + 40) != 0;
  return result;
}
...
int *___ZN22IVFVectorIndexTemplateIfLi512EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE6existsERK10CIVector_sIfLi512EE_block_invoke(uint64_t a1, int a2, float *a3, _BYTE *a4)
{
  ...
  v10 = (const void *)_windowsResolvePtr(v9 + 40, *(_QWORD *)(v9 + 24) + *(_QWORD *)(v9 + 16) * *(unsigned int *)a3, 0x810uLL);
  result = (int *)memcmp(v8, v10, 0x800uLL);
  if (!(_DWORD)result)
  {
    v12 = *__error();
...
int *___ZN22IVFVectorIndexTemplateIfLi512EE20IVFVectorIndexRoot_sI32vi_onefixedsize_memory_allocator18vi_memory_postingsE6existsERK10CIVector_sIfLi512EE_block_invoke(uint64_t a1, int a2, float *a3, _BYTE *a4)
{
  ...
  v8 = *(const void **)(a1 + 48);
  Ptr = (const void *)vi_onefixedsize_memory_allocator::getPtr(*(_QWORD **)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 32) + 16), *(unsigned int *)a3, 2068);
  result = (int *)memcmp(v8, Ptr, 0x800uLL);
  if (!(_DWORD)result)
  {
    v11 = *__error();
