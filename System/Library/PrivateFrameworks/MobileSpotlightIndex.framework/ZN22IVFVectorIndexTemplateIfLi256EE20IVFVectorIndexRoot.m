@implementation ZN22IVFVectorIndexTemplateIfLi256EE20IVFVectorIndexRoot

_DWORD *___ZN22IVFVectorIndexTemplateIfLi256EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE14compactForTestIS2_EENSt3__19enable_ifIXsr13is_persistentIT_EE5valueEbE4typeEPS4_PVi_block_invoke(uint64_t a1, unsigned int *a2, BOOL *a3)
{
  uint64_t v5;
  _DWORD *result;

  v5 = **((_QWORD **)a2 + 3);
  result = IVFVectorIndexTemplate<float,256>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::lookupForInsert(*(_QWORD *)(a1 + 32), a2[2], *((void **)a2 + 2), *a2, 0, *((float *)a2 + 1));
