@implementation ZN2QP25VisualGenerationFormatter8setParseENSt3

_QWORD *___ZN2QP25VisualGenerationFormatter8setParseENSt3__110shared_ptrINS_5ParseEEE_block_invoke_8(uint64_t a1, uint64_t *a2)
{
  uint64_t v2;
  _QWORD *result;
  uint64_t v4;
