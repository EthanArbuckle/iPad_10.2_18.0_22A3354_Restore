...
LABEL_25:
    ...
    v6 = (v3 + ((v5 >> 8) & 0xF) - 1) / ((v5 >> 8) & 0xF) * (unint64_t)(v5 & 0x18);
    v7 = (DWORD1(v3) + (HIWORD(v5) & 0xF) - 1) / (HIWORD(v5) & 0xF) * (unint64_t)DWORD2(v3) * v6;
  }
  else
  {
    v9 = DWORD1(v3);
    v6 = pixelBytes_0(a3) * (unint64_t)v3;
    v7 = v6 * v9;
  }
  result.var1 = v7;
  result.var0 = v6;
...
{
  __assert_rtn("compressedFormatInfo", "TXRFormatInfoFuncs.h", 253, "!\"Unhandled compressed format\");
}
