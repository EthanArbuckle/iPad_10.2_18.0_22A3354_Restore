...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("gan_model_pre_A11"), CFSTR("mlmodelc"));
...
{
  id v5;
  gan_model_pre_A11 *v6;
  gan_model_pre_A11 *v7;
  gan_model_pre_A11 *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[gan_model_pre_A11 init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
{
  void *v3;
  gan_model_pre_A11 *v4;

  objc_msgSend((id)objc_opt_class(), "URLOfModelInThisBundle");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[gan_model_pre_A11 initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (gan_model_pre_A11)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[gan_model_pre_A11 initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (gan_model_pre_A11)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[gan_model_pre_A11 initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (gan_model_pre_A11)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[gan_model_pre_A11 initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[gan_model_pre_A11 predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  gan_model_pre_A11Output *v12;
  void *v13;
  void *v14;
  gan_model_pre_A11Output *v15;

  v8 = a4;
  v9 = a3;
  -[gan_model_pre_A11 model](self, "model");
  ...
  if (v11)
  {
    ...
    objc_msgSend(v11, "featureValueForName:", CFSTR("output"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "multiArrayValue");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = -[gan_model_pre_A11Output initWithOutput:](v12, "initWithOutput:", v14);
...
{
  id v6;
  gan_model_pre_A11Input *v7;
  void *v8;

  v6 = a3;
  v7 = -[gan_model_pre_A11Input initWithInput:]([gan_model_pre_A11Input alloc], "initWithInput:", v6);

  -[gan_model_pre_A11 predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  gan_model_pre_A11Output *v16;
  void *v17;
  void *v18;
  gan_model_pre_A11Output *v19;
  id v21;
  id v22;
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        objc_msgSend(v15, "featureValueForName:", CFSTR("output"));
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "multiArrayValue");
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v19 = -[gan_model_pre_A11Output initWithOutput:](v16, "initWithOutput:", v18);
...
+ (void)URLOfModelInThisBundle
{
  ...
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_1B3A68000, MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR, "Could not load gan_model_pre_A11.mlmodelc in the bundle resource", v0, 2u);
}
