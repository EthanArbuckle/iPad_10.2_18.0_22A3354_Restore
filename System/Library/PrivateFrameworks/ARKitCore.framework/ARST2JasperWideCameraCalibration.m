@implementation ARST2JasperWideCameraCalibration
...
void __ARST2JasperWideCameraCalibration_block_invoke()
{
  ...
  v0 = ARST2CameraToJasperExtrinsics((void *)*MEMORY[0x1E0C89FA0]).n128_u64[0];
  v16 = v1;
  v17 = *(double *)&v0;
  v14 = v3;
  v15 = v2;
  ...
  if (v18 && v10)
  {
    ...
    v13 = (void *)ARST2JasperWideCameraCalibration::cameraCalibration;
