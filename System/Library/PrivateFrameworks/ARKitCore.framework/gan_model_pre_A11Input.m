...
- (gan_model_pre_A11Input)initWithInput:(id)a3
{
  ...
  v6 = -[gan_model_pre_A11Input init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E66CEE20);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("input")))
  {
    ...
    -[gan_model_pre_A11Input input](self, "input");
