...
- (void)configure:(id)a3
{
  ...
  v9 = a3;
  if (-[PLBatteryUIResponseTypeOngoingUpgradeInsight shouldShowSuggestionThroughOverrides](self, "shouldShowSuggestionThroughOverrides"))
  {
    -[PLBatteryUIResponseTypeOngoingUpgradeInsight setSuggest:](self, "setSuggest:", 1);
  }
  else
  {
    ...
    -[PLBatteryUIResponseTypeOngoingUpgradeInsight setEnd:](self, "setEnd:", v7);
...
- (void)run
{
  OUTLINED_FUNCTION_0_1(&dword_1DA9D6000, a1, a3, "OngoingUpgradeInsight: Restore occured more than a week ago", a5, a6, a7, a8, 0);
}

void __51__PLBatteryUIResponseTypeOngoingUpgradeInsight_run__block_invoke(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  id v6;
  void *v7;
  int v8;
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      __51__PLBatteryUIResponseTypeOngoingUpgradeInsight_run__block_invoke_cold_1(v9, v10, v11, v12, v13, v14, v15, v16);
...
- (id)result
{
  ...
  if (!-[PLBatteryUIResponseTypeOngoingUpgradeInsight suggest](self, "suggest"))
    return (id)MEMORY[0x1E0C9AA70];
  ADClientSetValueForScalarKey();
  v3 = (void *)objc_opt_new();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", CFSTR("insight"), CFSTR("category"));
  objc_msgSend(v3, "setObject:forKeyedSubscript:", CFSTR("ongoingUpgrade"), CFSTR("type"));
  v9 = v3;
  v4 = v3;
  AnalyticsSendEventLazy();
  v5 = (void *)MEMORY[0x1E0C99D68];
  -[PLBatteryUIResponseTypeOngoingUpgradeInsight lastUpgradeTimestamp](self, "lastUpgradeTimestamp");
...
- (BOOL)shouldShowSuggestionThroughOverrides
{
  ...
  if (v2)
  {
    +[PLUtilities powerlogDefaultForKey:](PLUtilities, "powerlogDefaultForKey:", CFSTR("BUI_ONGOINGUPGRADE_SUGGESTION_SHOW"));
...
- (BOOL)didUpgradeInLast:(double)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    -[PLBatteryUIResponseTypeOngoingUpgradeInsight didUpgradeInLast:].cold.1(v10, v9, v11, v12);
...
- (BOOL)didUpgrade
{
  ...
  -[PLBatteryUIResponseTypeOngoingUpgradeInsight responderService](self, "responderService");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    -[PLBatteryUIResponseTypeOngoingUpgradeInsight didUpgrade].cold.1(v5, v6);
...
void __51__PLBatteryUIResponseTypeOngoingUpgradeInsight_run__block_invoke_cold_1(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  OUTLINED_FUNCTION_0_1(&dword_1DA9D6000, a1, a3, "OngoingUpgradeInsight: DeviceSetup entity in the breakdown", a5, a6, a7, a8, 0);
}

- (void)didUpgradeInLast:(uint64_t)a3 .cold.1(NSObject *a1, double a2, uint64_t a3, uint64_t a4)
{
  int v4;
  double v5;
  uint64_t v6;
  ...
  v4 = 134217984;
  v5 = a2;
  OUTLINED_FUNCTION_7_0(&dword_1DA9D6000, a1, a4, "OngoingUpgradeInsight: Seconds since last upgrade:%f", (uint8_t *)&v4);
}
...
- (void)didUpgrade
{
  ...
  OUTLINED_FUNCTION_7_0(&dword_1DA9D6000, a2, v3, "OngoingUpgradeInsight: Build count:%lu", (uint8_t *)&v4);
}
