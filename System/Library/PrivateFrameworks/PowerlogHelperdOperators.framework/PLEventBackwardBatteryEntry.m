  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
        +[PLEventBackwardBatteryEntry populatewRaForEntry:withRawData:].cold.1((uint64_t)v7, v9);
...
+ (void)populatewRaForEntry:(uint64_t)a1 withRawData:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v4 = 138412290;
  v5 = v3;
  _os_log_error_impl(&dword_1DA9D6000, a2, OS_LOG_TYPE_ERROR, "unknown wRa format: %@", (uint8_t *)&v4, 0xCu);
