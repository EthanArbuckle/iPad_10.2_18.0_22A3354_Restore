...
+ (id)start
{
  ...
  return (id)+[PLProcessCPUWrapper start]::sharedPLProcessCpuWrapper;
}
...
void __28__PLProcessCPUWrapper_start__block_invoke()
{
  ...
  v1 = (void *)+[PLProcessCPUWrapper start]::sharedPLProcessCpuWrapper;
  +[PLProcessCPUWrapper start]::sharedPLProcessCpuWrapper = (uint64_t)v0;
