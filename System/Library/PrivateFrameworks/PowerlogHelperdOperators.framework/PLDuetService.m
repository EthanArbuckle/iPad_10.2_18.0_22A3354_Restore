...
- (void)setupBatterySaverModeForNotification:(id)a3
{
  ...
  if (v10)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      -[PLDuetService setupBatterySaverModeForNotification:].cold.3();
  }
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      -[PLDuetService setupBatterySaverModeForNotification:].cold.2();
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      -[PLDuetService setupBatterySaverModeForNotification:].cold.1();
  }
...
- (void)handleBatterySaverModeToken:(int)a3 withNotification:(id)a4
{
  ...
  if (notify_get_state(a3, &state64))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      -[PLDuetService handleBatterySaverModeToken:withNotification:].cold.2();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      -[PLDuetService handleBatterySaverModeToken:withNotification:].cold.1();

    -[PLDuetService logEventForwardBatterySaverModeWithState:fromNotification:](self, "logEventForwardBatterySaverModeWithState:fromNotification:", v8 != 0, v6);
  }
...
- (void)logEventForwardBatterySaverModeWithState:(BOOL)a3 fromNotification:(id)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    -[PLDuetService logEventForwardBatterySaverModeWithState:fromNotification:].cold.1();
...
- (void)setupBatterySaverModeForNotification:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, v0, v1, "batterysaver: setup complete for %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)setupBatterySaverModeForNotification:.cold.2()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, v0, v1, "batterysaver: re-syncing %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)setupBatterySaverModeForNotification:.cold.3()
{
  ...
  OUTLINED_FUNCTION_3_4(&dword_1DA9D6000, v0, v1, "batterysaver: failed to register for %@ with status %d");
  OUTLINED_FUNCTION_1();
}
...
- (void)setupBatterySaverModeForNotification:.cold.4()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, v0, v1, "batterysaver: setting up %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)handleBatterySaverModeToken:withNotification:.cold.1()
{
  ...
  v3 = 2048;
  v4 = v0;
  OUTLINED_FUNCTION_7(&dword_1DA9D6000, v1, (uint64_t)v1, "batterysaver: callback %@=%llu", v2);
  OUTLINED_FUNCTION_1();
}
...
- (void)handleBatterySaverModeToken:withNotification:.cold.2()
{
  ...
  OUTLINED_FUNCTION_10_0();
  OUTLINED_FUNCTION_3_4(&dword_1DA9D6000, v0, v1, "batterysaver: notify_get_state failed for %@ with status %d");
  OUTLINED_FUNCTION_1();
}
...
- (void)logEventForwardBatterySaverModeWithState:fromNotification:.cold.1()
{
  ...
  v3 = 1024;
  v4 = v0;
  _os_log_debug_impl(&dword_1DA9D6000, v1, OS_LOG_TYPE_DEBUG, "batterysaver: %@=%d", v2, 0x12u);
  OUTLINED_FUNCTION_1();
}
