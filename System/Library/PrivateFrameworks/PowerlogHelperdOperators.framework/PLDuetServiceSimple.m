...
- (void)initOperatorDependancies:(id)a3
{
  ...
  if (v4)
  {
    ...
    v44[3] = &unk_1EA16CF18;
    v44[4] = self;
    v7 = (void *)objc_msgSend(v5, "initWithOperator:withRegistration:withBlock:", v4, &unk_1EA1D8008, v44);
    ...
    v43[3] = &unk_1EA16D1A8;
    v43[4] = self;
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80098]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1EA1D8030, v43);
    ...
    v42[3] = &unk_1EA16CF18;
    v42[4] = self;
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80090]), "initWithOperator:withRegistration:withBlock:", v4, &unk_1EA1D8058, v42);
    ...
    if ((_DWORD)v11)
    {
      ...
      v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80080]), "initWithKey:withValue:withComparisonOperation:", CFSTR("timestampEnd"), &unk_1EA1C0518, 6);
...
- (void)didReceiveStartEventWithPayload:(id)a3
{
  ...
  if (v17)
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v81[1] = 3221225472;
      v81[2] = __55__PLDuetServiceSimple_didReceiveStartEventWithPayload___block_invoke_296;
      v81[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      v81[4] = v19;
      if (didReceiveStartEventWithPayload__defaultOnce_294 != -1)
        dispatch_once(&didReceiveStartEventWithPayload__defaultOnce_294, v81);
      if (didReceiveStartEventWithPayload__classDebugEnabled_295)
      {
  ...
  v45 = objc_msgSend(v44, "countByEnumeratingWithState:objects:count:", &v77, v85, 16);
  v74 = v26;
  if (v45)
  {
    v46 = v45;
      ...
      do
      {
        ...
        if (!v50)
        {
          if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
          {
            ...
            block[4] = v51;
            if (didReceiveStartEventWithPayload__defaultOnce_304 != -1)
              dispatch_once(&didReceiveStartEventWithPayload__defaultOnce_304, block);
            if (didReceiveStartEventWithPayload__classDebugEnabled_305)
            {
              v52 = self;
  ...
  objc_msgSend(v61, "setObject:forKeyedSubscript:", v26, v72);
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v75[1] = 3221225472;
    v75[2] = __55__PLDuetServiceSimple_didReceiveStartEventWithPayload___block_invoke_311;
    v75[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    v75[4] = v62;
    if (didReceiveStartEventWithPayload__defaultOnce_309 != -1)
      dispatch_once(&didReceiveStartEventWithPayload__defaultOnce_309, v75);
    if (didReceiveStartEventWithPayload__classDebugEnabled_310)
    {
      v63 = (void *)MEMORY[0x1E0CB3940];
      -[PLDuetServiceSimple bundleIDToState](self, "bundleIDToState");
      v64 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v63, "stringWithFormat:", CFSTR("bundleIDToState=%@"), v64);
      ...
      objc_msgSend(v66, "logMessage:fromFile:fromFunction:fromLineNumber:", v65, v68, v69, 841);
...
uint64_t __55__PLDuetServiceSimple_didReceiveStartEventWithPayload___block_invoke_296(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStartEventWithPayload__classDebugEnabled_295 = result;
  return result;
}
...
uint64_t __55__PLDuetServiceSimple_didReceiveStartEventWithPayload___block_invoke_306(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStartEventWithPayload__classDebugEnabled_305 = result;
  return result;
}
...
uint64_t __55__PLDuetServiceSimple_didReceiveStartEventWithPayload___block_invoke_311(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStartEventWithPayload__classDebugEnabled_310 = result;
  return result;
}
...
- (id)didReceiveStopEventWithPayload:(id)a3
{
  ...
  if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
  {
    ...
    v213[4] = v16;
    v17 = v213;
    if (didReceiveStopEventWithPayload__defaultOnce_314 != -1)
      dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_314, v17);

    if (didReceiveStopEventWithPayload__classDebugEnabled_315)
    {
  ...
  if (v15)
  {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v212[4] = v34;
      v35 = v212;
      if (didReceiveStopEventWithPayload__defaultOnce_317 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_317, v35);

      if (didReceiveStopEventWithPayload__classDebugEnabled_318)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v211[4] = v44;
      v45 = v211;
      if (didReceiveStopEventWithPayload__defaultOnce_322 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_322, v45);

      if (didReceiveStopEventWithPayload__classDebugEnabled_323)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v210[4] = v53;
      v54 = v210;
      if (didReceiveStopEventWithPayload__defaultOnce_327 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_327, v54);

      if (didReceiveStopEventWithPayload__classDebugEnabled_328)
      {
    ...
    v61 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v206, v220, 16);
    if (v61)
    {
      v62 = v61;
      v188 = *(_QWORD *)v207;
      ...
      do
      {
        ...
        do
        {
          ...
          if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
          {
            ...
            v205[4] = v66;
            v67 = v205;
            if (didReceiveStopEventWithPayload__defaultOnce_332 != -1)
              dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_332, v67);

            if (didReceiveStopEventWithPayload__classDebugEnabled_333)
            {
              ...
              if (os_log_type_enabled(v73, OS_LOG_TYPE_DEBUG))
              {
                *(_DWORD *)buf = 138412290;
                v219 = v68;
                _os_log_debug_impl(&dword_1DA9D6000, v73, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
              }
          ...
          if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
          {
            ...
            v204[4] = v83;
            v84 = v204;
            if (didReceiveStopEventWithPayload__defaultOnce_337 != -1)
              dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_337, v84);

            if (didReceiveStopEventWithPayload__classDebugEnabled_338)
            {
              v85 = self;
              objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("overlappingState=%@"), v65);
              ...
              if (os_log_type_enabled(v91, OS_LOG_TYPE_DEBUG))
              {
                *(_DWORD *)buf = 138412290;
                v219 = v86;
                _os_log_debug_impl(&dword_1DA9D6000, v91, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
              }
        ...
        while (v62 != v64);
        v62 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v206, v220, 16);
      }
      while (v62);
    }
    else
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v203[4] = v94;
      v95 = v203;
      if (didReceiveStopEventWithPayload__defaultOnce_340 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_340, v95);

      if (didReceiveStopEventWithPayload__classDebugEnabled_341)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v202[4] = v104;
      v105 = v202;
      if (didReceiveStopEventWithPayload__defaultOnce_345 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_345, v105);

      if (didReceiveStopEventWithPayload__classDebugEnabled_346)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v201[4] = v113;
      v114 = v201;
      if (didReceiveStopEventWithPayload__defaultOnce_350 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_350, v114);

      if (didReceiveStopEventWithPayload__classDebugEnabled_351)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v200[4] = v124;
      v125 = v200;
      if (didReceiveStopEventWithPayload__defaultOnce_359 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_359, v125);

      if (didReceiveStopEventWithPayload__classDebugEnabled_360)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v199[4] = v138;
      v139 = v199;
      if (didReceiveStopEventWithPayload__defaultOnce_370 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_370, v139);

      if (didReceiveStopEventWithPayload__classDebugEnabled_371)
      {
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v198[4] = v147;
      v148 = v198;
      if (didReceiveStopEventWithPayload__defaultOnce_375 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_375, v148);

      if (didReceiveStopEventWithPayload__classDebugEnabled_376)
      {
    ...
    if (v159)
    {
      ...
      if (v162)
      {
        ...
        v165 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D80080]), "initWithKey:withValue:withComparisonOperation:", CFSTR("timestampEnd"), &unk_1EA1C0518, 6);
        -[PLDuetServiceImpl duetService](self, "duetService");
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v189[4] = v173;
      v174 = v189;
      if (didReceiveStopEventWithPayload__defaultOnce_391 != -1)
        dispatch_once(&didReceiveStopEventWithPayload__defaultOnce_391, v174);

      if (didReceiveStopEventWithPayload__classDebugEnabled_392)
      {
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_316(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_315 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_319(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_318 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_324(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_323 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_329(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_328 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_334(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_333 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_339(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_338 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_342(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_341 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_347(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_346 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_352(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_351 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_361(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_360 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_372(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_371 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_377(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_376 = result;
  return result;
}
...
uint64_t __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_2(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  didReceiveStopEventWithPayload__classDebugEnabled_392 = result;
  return result;
}
...
- (double)numCPUSecondsForPid:(int)a3
{
  ...
  result = 0.0;
  if (!v3)
    +[PLUtilities secondsFromMachTime:](PLUtilities, "secondsFromMachTime:", (_QWORD)v6, 0.0);
  return result;
}
...
- (double)numCPUSecondsForBundleID:(id)a3
{
  ...
  if (v13)
  {
      ...
      do
      {
        ...
        if (v18 >= 1)
        {
          if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
          {
            ...
            block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
            block[4] = v19;
            if (numCPUSecondsForBundleID__defaultOnce_395 != -1)
              dispatch_once(&numCPUSecondsForBundleID__defaultOnce_395, block);
            if (numCPUSecondsForBundleID__classDebugEnabled_396)
            {
              ...
              if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
              {
                buffer = 138412290;
                v52 = v20;
                _os_log_debug_impl(&dword_1DA9D6000, v25, OS_LOG_TYPE_DEBUG, "%@", (uint8_t *)&buffer, 0xCu);
              }
          ...
          if (!v29)
          {
            +[PLUtilities bundleIDFromPid:](PLUtilities, "bundleIDFromPid:", v17);
            v29 = (void *)objc_claimAutoreleasedReturnValue();
            if (!v29)
            {
          ...
          if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
          {
            ...
            v48[4] = v30;
            if (numCPUSecondsForBundleID__defaultOnce_400 != -1)
              dispatch_once(&numCPUSecondsForBundleID__defaultOnce_400, v48);
            if (numCPUSecondsForBundleID__classDebugEnabled_401)
            {
              ...
              if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
              {
                buffer = 138412290;
                v52 = v31;
                _os_log_debug_impl(&dword_1DA9D6000, v36, OS_LOG_TYPE_DEBUG, "%@", (uint8_t *)&buffer, 0xCu);
              }
    ...
    if (objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
    {
      ...
      v47[4] = v38;
      if (numCPUSecondsForBundleID__defaultOnce_405 != -1)
        dispatch_once(&numCPUSecondsForBundleID__defaultOnce_405, v47);
      if (numCPUSecondsForBundleID__classDebugEnabled_406)
      {
...
uint64_t __48__PLDuetServiceSimple_numCPUSecondsForBundleID___block_invoke_397(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  numCPUSecondsForBundleID__classDebugEnabled_396 = result;
  return result;
}
...
uint64_t __48__PLDuetServiceSimple_numCPUSecondsForBundleID___block_invoke_402(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  numCPUSecondsForBundleID__classDebugEnabled_401 = result;
  return result;
}
...
uint64_t __48__PLDuetServiceSimple_numCPUSecondsForBundleID___block_invoke_407(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  numCPUSecondsForBundleID__classDebugEnabled_406 = result;
  return result;
}
