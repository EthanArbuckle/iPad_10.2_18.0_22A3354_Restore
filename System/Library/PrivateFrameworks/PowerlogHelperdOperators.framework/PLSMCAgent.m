      ...
      for (i = 0; i != v9; ++i)
      {
        ...
        if (-[PLSMCAgent SMCKeyExists:](self, "SMCKeyExists:", v12, v16, (_QWORD)v17))
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v16;
            v22 = v12;
            _os_log_debug_impl(&dword_1DA9D6000, v14, OS_LOG_TYPE_DEBUG, "ExistingKeys: keyName=%@", buf, 0xCu);
          }
...
void __71__PLSMCAgent_getAccumEntryFromSample_lastSample_withEntryKey_withDate___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v29 = a2;
  v5 = a3;
  +[PLSMCAgent channelValueKey:](PLSMCAgent, "channelValueKey:", v29);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = *(void **)(a1 + 32);
  +[PLSMCAgent cycleCountKey:](PLSMCAgent, "cycleCountKey:", v29);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = *(void **)(a1 + 32);
  +[PLSMCAgent variantKey:](PLSMCAgent, "variantKey:", v29);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v15, "setObject:forKeyedSubscript:", v14, v16);

  +[PLSMCAgent channelValueDiffKey:](PLSMCAgent, "channelValueDiffKey:", v29);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 32), "definedKeys");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_10:
          +[PLUtilities roundToSigFigDouble:withSigFig:](PLUtilities, "roundToSigFigDouble:withSigFig:", 4, v26);
          objc_msgSend(v27, "numberWithDouble:");
          v28 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(*(id *)(a1 + 32), "setObject:forKeyedSubscript:", v28, v17);
  ...
  if (v8 && v9 && a5)
  {
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        -[PLSMCAgent logAccumKeysToCA:withLastSample:andDate:].cold.1();
...
- (void)logThermalAggregationKeysToCA
{
  ...
  OUTLINED_FUNCTION_0_1(&dword_1DA9D6000, v0, v1, "Log Thermal Aggregated Keys to CA", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
      ...
      else
      {
        ...
        if (!v17)
        {
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
            -[PLSMCAgent writeKeyNumeric:withValue:].cold.3();
          v16 = 1;
          goto LABEL_15;
        }
...
LABEL_15:
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      -[PLSMCAgent writeKeyNumeric:withValue:].cold.2(v8, v9, v10, v11, v12, v13, v14, v15);
  }
  else
  {
    PLLogSMC();
    v8 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      -[PLSMCAgent writeKeyNumeric:withValue:].cold.1();
  }
...
- (BOOL)sampleKey:(id *)a3 forKey:(unsigned int)a4
{
  ...
  if (!-[PLSMCAgent getChannelInfo:](self, "getChannelInfo:", *(_QWORD *)&a4))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      -[PLSMCAgent sampleKey:forKey:].cold.1(v4, v6, v7, v8, v9, v10, v11, v12);
    goto LABEL_7;
  }
  -[PLSMCAgent smcConnection](self, "smcConnection");
  if (SMCOSAccumSampleChannel())
  {
    ...
    v6 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      -[PLSMCAgent sampleKey:forKey:].cold.2();
LABEL_7:
...
- (const)getChannelInfo:(unsigned int)a3
{
  ...
  if (!ChannelInfoForKey)
  {
    ...
    v4 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
      -[PLSMCAgent getChannelInfo:].cold.1();
...
LABEL_4:
    ...
    if (-[PLSMCAgent sampleKey:forKey:](self, "sampleKey:forKey:", a4, v8))
    {
      if (a4->var1)
      {
        PLLogSMC();
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
          -[PLSMCAgent readKeyViaOSAccum:toOutput:].cold.3();
        LOBYTE(v8) = 1;
        goto LABEL_16;
      }
      if (!objc_msgSend(MEMORY[0x1E0D7FFA0], "debugEnabled"))
      ...
      v18 = 3221225472;
      v19 = __41__PLSMCAgent_readKeyViaOSAccum_toOutput___block_invoke_471;
      v20 = &__block_descriptor_40_e5_v8__0lu32l8;
      v21 = v11;
      if (readKeyViaOSAccum_toOutput__defaultOnce_469 != -1)
        dispatch_once(&readKeyViaOSAccum_toOutput__defaultOnce_469, &v17);
      if (!readKeyViaOSAccum_toOutput__classDebugEnabled_470)
        goto LABEL_4;
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%s: Returned cycleCount is zero for %u key, returning kSMCReturnError"), "-[PLSMCAgent readKeyViaOSAccum:toOutput:]", v8, v17, v18, v19, v20, v21);
      v10 = objc_claimAutoreleasedReturnValue();
      ...
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "logMessage:fromFile:fromFunction:fromLineNumber:", v10, v14, v15, 2920);
...
uint64_t __41__PLSMCAgent_readKeyViaOSAccum_toOutput___block_invoke_466(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  readKeyViaOSAccum_toOutput__classDebugEnabled_465 = result;
  return result;
}
...
uint64_t __41__PLSMCAgent_readKeyViaOSAccum_toOutput___block_invoke_471(uint64_t a1)
{
  ...
  result = objc_msgSend(MEMORY[0x1E0D7FFA0], "isClassDebugEnabled:", *(_QWORD *)(a1 + 32));
  readKeyViaOSAccum_toOutput__classDebugEnabled_470 = result;
  return result;
}
...
- (void)logThermalInstantAndAccumlatedKeys
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, v0, v1, "Logging Thermal Instant entry: %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)logPowerDeliveryKeys
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_0_1(&dword_1DA9D6000, v0, v1, "Log Power Delivery Keys to CA", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
...
- (void)logDRAMVendorKey
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, v0, v1, "Log DRAM Vendor key with value %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (id)thermalKeys
{
  if (thermalKeys_onceToken != -1)
    dispatch_once(&thermalKeys_onceToken, &__block_literal_global_476);
  return (id)thermalKeys_thermalKeys;
}
...
void __25__PLSMCAgent_thermalKeys__block_invoke()
{
  ...
  v1 = (void *)thermalKeys_thermalKeys;
  thermalKeys_thermalKeys = v0;
...
- (id)metricMonitorInstantKeys
{
  if (metricMonitorInstantKeys_onceToken != -1)
    dispatch_once(&metricMonitorInstantKeys_onceToken, &__block_literal_global_550);
  return (id)metricMonitorInstantKeys_metricMonitorKeys;
}
...
void __38__PLSMCAgent_metricMonitorInstantKeys__block_invoke()
{
  ...
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)metricMonitorInstantKeys_metricMonitorKeys;
...
- (id)displayAccumulatedKeys
{
  if (displayAccumulatedKeys_onceToken != -1)
    dispatch_once(&displayAccumulatedKeys_onceToken, &__block_literal_global_551);
  return (id)displayAccumulatedKeys_accumulatedKeys;
}
...
void __36__PLSMCAgent_displayAccumulatedKeys__block_invoke()
{
  ...
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)displayAccumulatedKeys_accumulatedKeys;
  displayAccumulatedKeys_accumulatedKeys = v0;
...
- (id)accumulatedKeys
{
  if (accumulatedKeys_onceToken != -1)
    dispatch_once(&accumulatedKeys_onceToken, &__block_literal_global_552);
  return (id)accumulatedKeys_accumulatedKeys;
}
...
void __29__PLSMCAgent_accumulatedKeys__block_invoke()
{
  ...
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)accumulatedKeys_accumulatedKeys;
  accumulatedKeys_accumulatedKeys = v0;
...
- (id)powerAccumulatedKeys
{
  if (powerAccumulatedKeys_onceToken != -1)
    dispatch_once(&powerAccumulatedKeys_onceToken, &__block_literal_global_553);
  return (id)powerAccumulatedKeys_accumulatedKeys;
}
...
void __34__PLSMCAgent_powerAccumulatedKeys__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("PSTR"), CFSTR("PBat"), CFSTR("VBat"), CFSTR("PDLP"), CFSTR("PDEP"), CFSTR("PP0b"), CFSTR("PP1b"), CFSTR("PP2b"), CFSTR("PP3b"), CFSTR("PP4b"), CFSTR("PP5b"), CFSTR("PP6b"), CFSTR("PP7b"), CFSTR("PP8b"), CFSTR("PP9b"), CFSTR("PPab"), CFSTR("PPbb"),
    ...
    0);
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)powerAccumulatedKeys_accumulatedKeys;
...
- (id)thermalInstantKeys
{
  if (thermalInstantKeys_onceToken != -1)
    dispatch_once(&thermalInstantKeys_onceToken, &__block_literal_global_554);
  return (id)thermalInstantKeys_thermalKeys;
}
...
void __32__PLSMCAgent_thermalInstantKeys__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("TN0n"), CFSTR("TV0A"), CFSTR("TVFM"), CFSTR("voC0"), CFSTR("mlCC"), CFSTR("voP0"), CFSTR("voT0"), CFSTR("voR1"), CFSTR("voR2"), CFSTR("xPb1"), CFSTR("xPb2"), CFSTR("mlNN"), CFSTR("voS0"), CFSTR("xPSp"), CFSTR("voBB"), CFSTR("xPDs"), CFSTR("cmSM"),
    ...
    CFSTR("mlr5"));
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)thermalInstantKeys_thermalKeys;
  thermalInstantKeys_thermalKeys = v0;
...
- (id)thermalAggregationKeys
{
  if (thermalAggregationKeys_onceToken != -1)
    dispatch_once(&thermalAggregationKeys_onceToken, &__block_literal_global_555);
  return (id)thermalAggregationKeys_thermalKeys;
}
...
void __36__PLSMCAgent_thermalAggregationKeys__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E20], "setWithObjects:", CFSTR("B0AP"), CFSTR("TB5B"), CFSTR("TVBA"), CFSTR("TVBB"), CFSTR("TVBC"), CFSTR("TVBF"), CFSTR("TVBQ"), CFSTR("TVBM"), CFSTR("TVBR"), CFSTR("TVFD"), CFSTR("TVFL"), CFSTR("TVFG"), CFSTR("TVLN"), CFSTR("TV0s"), CFSTR("TV2s"), CFSTR("TG0V"), CFSTR("TH0T"),
    ...
    CFSTR("TIOP"));
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)thermalAggregationKeys_thermalKeys;
...
- (id)powerDeliveryKeys
{
  if (powerDeliveryKeys_onceToken != -1)
    dispatch_once(&powerDeliveryKeys_onceToken, &__block_literal_global_559);
  return (id)powerDeliveryKeys_powerKeys;
}
...
void __31__PLSMCAgent_powerDeliveryKeys__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "set");
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)powerDeliveryKeys_powerKeys;
...
- (id)powerDeliveryResetKeys
{
  if (powerDeliveryResetKeys_onceToken != -1)
    dispatch_once(&powerDeliveryResetKeys_onceToken, &__block_literal_global_560);
  return (id)powerDeliveryResetKeys_powerKeys;
}
...
void __36__PLSMCAgent_powerDeliveryResetKeys__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "set");
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)powerDeliveryResetKeys_powerKeys;
...
- (id)DRAMVendorKey
{
  if (DRAMVendorKey_onceToken != -1)
    dispatch_once(&DRAMVendorKey_onceToken, &__block_literal_global_561);
  return (id)DRAMVendorKey_vendorKey;
}
...
void __27__PLSMCAgent_DRAMVendorKey__block_invoke()
{
  ...
  DRAMVendorKey_vendorKey = (uint64_t)CFSTR("MDSV");
...
- (id)virtualTemperatureKeys
{
  if (virtualTemperatureKeys_onceToken != -1)
    dispatch_once(&virtualTemperatureKeys_onceToken, &__block_literal_global_562);
  return (id)virtualTemperatureKeys_thermalKeys;
}
...
void __36__PLSMCAgent_virtualTemperatureKeys__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("TVBA"), CFSTR("TVBB"), CFSTR("TVBC"), CFSTR("TVBE"), CFSTR("TVBF"), CFSTR("TVBM"), CFSTR("TVBN"), CFSTR("TVBQ"), CFSTR("TVBR"), CFSTR("TVFC"), CFSTR("TVFD"), CFSTR("TVFG"), CFSTR("TVFL"), CFSTR("TVLN"), CFSTR("TVRH"), CFSTR("TVRM"), CFSTR("TVRQ"),
    ...
    0);
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)virtualTemperatureKeys_thermalKeys;
...
+ (BOOL)supportsThermalSMC
{
  if (supportsThermalSMC_onceToken != -1)
    dispatch_once(&supportsThermalSMC_onceToken, &__block_literal_global_563);
...
+ (BOOL)shouldModelDisplayPowerFromSMC
{
  if (shouldModelDisplayPowerFromSMC_onceToken != -1)
    dispatch_once(&shouldModelDisplayPowerFromSMC_onceToken, &__block_literal_global_565);
...
+ (BOOL)supportsBasicSMC
{
  if (supportsBasicSMC_onceToken != -1)
    dispatch_once(&supportsBasicSMC_onceToken, &__block_literal_global_566);
...
+ (id)parsePMUEvents:(unint64_t)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E08], "dictionary");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(&unk_1EA1DBD28, "count"))
  {
    v5 = 0;
    v6 = 0;
    do
    {
      objc_msgSend(&unk_1EA1DBD28, "objectAtIndexedSubscript:", v6);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    while (v6 < objc_msgSend(&unk_1EA1DBD28, "count"));
  }
  return v4;
}
...
+ (void)reportPMUEventsToCA:(id)a3
{
  ...
  {
    if ((reportPMUEventsToCA__pushedAZero & 1) != 0)
      goto LABEL_10;
    if (reportPMUEventsToCA__onceToken != -1)
      dispatch_once(&reportPMUEventsToCA__onceToken, &__block_literal_global_579);
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 134218242;
      ...
      v10 = 2112;
      v11 = v5;
      _os_log_impl(&dword_1DA9D6000, v6, OS_LOG_TYPE_INFO, "PMU events: %llu -> %@", buf, 0x16u);
    }
...
void __34__PLSMCAgent_reportPMUEventsToCA___block_invoke()
{
  ...
  {
    *(_WORD *)v1 = 0;
    _os_log_impl(&dword_1DA9D6000, v0, OS_LOG_TYPE_INFO, "PMU events: pushed empty event", v1, 2u);
  }
...
- (void)logAccumKeysToCA:withLastSample:andDate:.cold.1()
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_0_1(&dword_1DA9D6000, v0, v1, "Log Power Accumulated Keys to CA", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
...
void __29__PLSMCAgent_logDisplayPower__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_6_0(&dword_1DA9D6000, v0, v1, "Failed to log, invalid SMC connection", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
...
void __29__PLSMCAgent_logDisplayPower__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_6_0(&dword_1DA9D6000, v0, v1, "Failed to sample OSAccumulator channel", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
...
void __43__PLSMCAgent_logThermalAggregationKeysToCA__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, v0, v1, "logging key to CA: %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)readKey:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_3_2(&dword_1DA9D6000, v0, v1, "%@: %@");
  OUTLINED_FUNCTION_1();
}
...
{
  OUTLINED_FUNCTION_12_1(&dword_1DA9D6000, a2, a3, "Unknown numeric SMC type: %d", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_6();
}
...
- (void)readKey:.cold.3()
{
  ...
  OUTLINED_FUNCTION_13_3(*MEMORY[0x1E0C80C00]);
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_4(&dword_1DA9D6000, v0, v1, "Unsupported key size %d for SMC key %@.");
  OUTLINED_FUNCTION_1();
}
...
- (void)readKey:.cold.4()
{
  ...
  OUTLINED_FUNCTION_13_3(*MEMORY[0x1E0C80C00]);
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_4(&dword_1DA9D6000, v0, v1, "Unsupported key size %d for SMC key %@ with Array attribute.");
  OUTLINED_FUNCTION_1();
}
...
- (void)writeKeyNumeric:withValue:.cold.1()
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_6_0(&dword_1DA9D6000, v0, v1, "Not a valid key name", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
...
{
  OUTLINED_FUNCTION_12_1(&dword_1DA9D6000, a1, a3, "SMCMakeUInt32Key for %u key returned 0", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_6();
}
...
- (void)writeKeyNumeric:withValue:.cold.3()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_3_2(&dword_1DA9D6000, v0, v1, "%@: %llu");
  OUTLINED_FUNCTION_1();
}
...
- (void)writeKeyNumeric:withValue:.cold.4()
{
  ...
  OUTLINED_FUNCTION_11_2(&dword_1DA9D6000, v0, v1, "Writing to %u key failed with %d", v2, v3);
  OUTLINED_FUNCTION_1();
}
...
- (void)writeKeyNumeric:withValue:.cold.7()
{
  ...
  OUTLINED_FUNCTION_12_2();
  OUTLINED_FUNCTION_11_2(&dword_1DA9D6000, v0, v1, "SMCGetKeyInfo for %u key failed with %d", v2, v3);
  OUTLINED_FUNCTION_1();
}
...
{
  OUTLINED_FUNCTION_12_1(&dword_1DA9D6000, a2, a3, "Fail to fetch channelInfo for key %u", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_6();
}
...
- (void)sampleKey:forKey:.cold.2()
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_6_0(&dword_1DA9D6000, v0, v1, "SMCOSAccumSampleChannel fails", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
...
- (void)getChannelInfo:.cold.1()
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_6_0(&dword_1DA9D6000, v0, v1, "Invalid reference to SMCAccumChannelInfo", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
...
- (void)readKeyViaOSAccum:toOutput:.cold.3()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, v0, v1, "Accumulated key: %@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
...
- (void)readKeyViaOSAccum:(int)a1 toOutput:(NSObject *)a2 .cold.4(int a1, NSObject *a2)
{
  ...
  v2 = 136315394;
  v3 = "-[PLSMCAgent readKeyViaOSAccum:toOutput:]";
  v4 = 1024;
  v5 = a1;
  _os_log_error_impl(&dword_1DA9D6000, a2, OS_LOG_TYPE_ERROR, "%s: %u key call to sampleKey failed, returning kSMCReturnError", (uint8_t *)&v2, 0x12u);
  OUTLINED_FUNCTION_1();
}
