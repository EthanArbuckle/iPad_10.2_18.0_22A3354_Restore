...
void __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke()
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_2((uint64_t)v4, v5, v6, v7, v8, v9, v10, v11);

  objc_msgSend(MEMORY[0x1E0D800B8], "sharedCore");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "storage");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "entriesForKey:withQuery:", v3, v4);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v15)
  {
    objc_msgSend(v15, "objectForKeyedSubscript:", v0);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", v1, v20, 56);
  v21 = (void *)objc_claimAutoreleasedReturnValue();

  PLLogCommon();
  v22 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_1((uint64_t)v21, v22, v23, v24, v25, v26, v27, v28);

  objc_msgSend(MEMORY[0x1E0D800B8], "sharedCore");
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v29, "storage");
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v30, "entriesForKey:withQuery:", v20, v21);
  ...
  if (v32)
  {
    objc_msgSend(v32, "objectForKeyedSubscript:", v0);
  ...
  *(double *)&representativeDisplayPower_representativeDisplayPower = v19 + v35;
...
void __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_1(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, a2, a3, "dynamicDisplayPower: running query %@", a5, a6, a7, a8, 2u);
}

void __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_2(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, a2, a3, "displayPower: running query %@", a5, a6, a7, a8, 2u);
}
