...
- (void)taskingStartNotificationReceived:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1DA9D6000, v4, OS_LOG_TYPE_DEFAULT, "Received tasking start notification", buf, 2u);
  }
...
void __47__PLSoCAgent_taskingStartNotificationReceived___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
      __47__PLSoCAgent_taskingStartNotificationReceived___block_invoke_cold_2((uint64_t)v2, v4, v5, v6, v7, v8, v9, v10);
...
- (void)taskingEndNotificationReceived:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1DA9D6000, v4, OS_LOG_TYPE_DEFAULT, "Received tasking end notification", buf, 2u);
  }
...
- (id)requestLTSStats
{
  ...
  if (!mach_service)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      -[PLSoCAgent requestLTSStats].cold.1();
    goto LABEL_12;
  }
  ...
  if (!v5)
  {
    ...
    v6 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      -[PLSoCAgent requestLTSStats].cold.2();
LABEL_12:
    v10 = 0;
    goto LABEL_19;
  }
  ...
  if (v7)
  {
    if (MEMORY[0x1DF0A4DA0](v7) == MEMORY[0x1E0C812F8])
    {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      -[PLSoCAgent requestLTSStats].cold.3();
...
void __47__PLSoCAgent_taskingStartNotificationReceived___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_6_0(&dword_1DA9D6000, v0, v1, "LTSStats are unavailable", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}

void __47__PLSoCAgent_taskingStartNotificationReceived___block_invoke_cold_2(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  OUTLINED_FUNCTION_0(&dword_1DA9D6000, a2, a3, "Got callback for PLSoCAgent_EventPoint_LifetimeServoStats: %@", a5, a6, a7, a8, 2u);
}
...
- (void)requestLTSStats
{
  ...
  OUTLINED_FUNCTION_11();
  OUTLINED_FUNCTION_6_0(&dword_1DA9D6000, v0, v1, "Received an error in response", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_6();
}
