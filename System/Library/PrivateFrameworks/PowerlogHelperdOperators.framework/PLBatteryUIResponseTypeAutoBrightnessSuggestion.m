...
- (void)configure:(id)a3
{
  ...
  -[PLBatteryUIResponseTypeAutoBrightnessSuggestion setHasALSPowerSaved:](self, "setHasALSPowerSaved:", +[PLDisplayAgent shouldLogALSPowerSaved](PLDisplayAgent, "shouldLogALSPowerSaved"));
  -[PLBatteryUIResponseTypeAutoBrightnessSuggestion setIsALSEnabled:](self, "setIsALSEnabled:", objc_msgSend(v8, "BOOLValue"));
  -[PLBatteryUIResponseTypeAutoBrightnessSuggestion responderService](self, "responderService");
  ...
  -[PLBatteryUIResponseTypeAutoBrightnessSuggestion setAlsPowerSavedEntries:](self, "setAlsPowerSavedEntries:", v7);

}

- (void)run
{
  OUTLINED_FUNCTION_0_1(&dword_1DA9D6000, a1, a3, "Auto Brightness Suggestion: hasALSPowerSaved is NO", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_6();
}
...
- (id)result
{
  ...
  -[PLBatteryUIResponseTypeAutoBrightnessSuggestion setAlsPowerSavedEntries:](self, "setAlsPowerSavedEntries:", 0);
  if (!-[PLBatteryUIResponseTypeAutoBrightnessSuggestion suggest](self, "suggest"))
    return MEMORY[0x1E0C9AA70];
  ADClientSetValueForScalarKey();
  v3 = (void *)objc_opt_new();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", CFSTR("suggestion"), CFSTR("category"));
  objc_msgSend(v3, "setObject:forKeyedSubscript:", CFSTR("autoBrightness"), CFSTR("type"));
  ...
  -[PLBatteryUIResponseTypeAutoBrightnessSuggestion energyPercent](self, "energyPercent", v9, 3221225472, __57__PLBatteryUIResponseTypeAutoBrightnessSuggestion_result__block_invoke, &unk_1EA16D238);
...
- (BOOL)shouldShowSuggestionThroughOverrides
{
  ...
  if (v2)
  {
    +[PLUtilities powerlogDefaultForKey:](PLUtilities, "powerlogDefaultForKey:", CFSTR("BUI_AUTOBRIGHTNESS_SUGGESTION_SHOW"));
