...
- (id)setHashMap:(id)a3 forKey:(id)a4
{
  ...
  v6 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", 1);
...
- (id)readNegativeSampleArray:(id)a3 withAttachments:(id)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v29 && v28)
  {
    ...
    if (v25)
    {
      v24 = (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithContentsOfURL:encoding:error:", v25, 4, v31);
      ...
      else
      {
        ...
        if (v16)
        {
          ...
          while (1)
          {
            ...
            v21 = *(id *)(__b[1] + 8 * v13);
            v9 = v22;
            v10 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", objc_msgSend(v21, "longLongValue"));
        ...
        v35 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", 1);
        v27 = 1;
...
- (id)readNegativeSampleArrayBytes:(id)a3 withAttachments:(id)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v25 && v24)
  {
    ...
    if (v21)
    {
      v20 = (id)objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfURL:options:error:", v21, 1, v27);
      if (v20)
      {
        ...
        else
        {
          ...
          for (i = 0; ; ++i)
          {
            ...
            v11 = v19;
            v12 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", v17);
...
- (id)readDownSampleDictionary:(id)a3 withAttachments:(id)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v36 && v35)
  {
    ...
    if (v32)
    {
      v31 = (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithContentsOfURL:encoding:error:", v32, 4, v38);
...
LABEL_18:
        ...
        if (!v34)
        {
          ...
          v42 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", 1);
          v34 = 1;
        }
        objc_storeStrong(&v29, 0);
        objc_storeStrong(&v30, 0);
...
- (id)readDownSampleDictionaryBytes:(id)a3 withAttachments:(id)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v33 && v32 && v31)
  {
    ...
    if (v27 && v26)
    {
      v25 = (id)objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfURL:options:error:", v27);
      v24 = (id)objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfURL:options:error:", v26, 1, v35);
      if (v25 && v24)
      {
          ...
          else
          {
            ...
            for (i = 0; ; ++i)
            {
              ...
              *(_QWORD *)&v20[2] = 8;
              ...
              v19[0] = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", v21);
              v18 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", v20[0]);
            ...
            v39 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", 1);
            v30 = 1;
            objc_storeStrong(&v23, 0);
          }
        }
...
- (id)readHashMapDictionaryBytes:(id)a3 withAttachments:(id)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v33 && v32 && v31)
  {
    ...
    if (v28 && v26)
    {
      v25 = (id)objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfURL:options:error:", v28);
      v24 = (id)objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfURL:options:error:", v26, 1, v35);
      if (v24 && v25)
      {
        v14 = objc_msgSend(v25, "length");
        if (v14 == objc_msgSend(v24, "length"))
        {
          ...
          else
          {
            ...
            for (i = 0; ; ++i)
            {
              ...
              objc_msgSend(v24, "getBytes:range:", v20, 8 * i, 8);
              v19[0] = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", v21);
              v18 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", v20[0]);
              objc_msgSend(v23, "setObject:forKey:", v18, v19[0]);
              objc_storeStrong(&v18, 0);
              objc_storeStrong(v19, 0);
            }
...
- (id)readWeightsArrayBytes:(id)a3 withAttachments:(id)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v16)
  {
    ...
    if (v13)
    {
      v12 = (id)objc_msgSend(MEMORY[0x24BDBCE50], "dataWithContentsOfURL:options:error:", v13, 1, v18);
      if (v12)
      {
        objc_storeStrong((id *)&v21->_weightAttachment, v12);
        v22 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLong:", 1);
      }
      else
      {
        v22 = 0;
