...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  v7 = a3;
  objc_msgSend(v6, "predicateWithFormat:", CFSTR("%K != nil"), CFSTR("libraryScope"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v33 = CFSTR("activeLibraryScopeParticipationState");
  v34[0] = &unk_1E375E5B0;
  ...
  else
  {
    ...
    if (v15)
    {
      ...
      if (v18)
      {
        ...
        objc_msgSend(v23, "logWithMessage:fromCodeLocation:type:", v22, "PLModelMigrationActions_16000.m", 816, 16);
