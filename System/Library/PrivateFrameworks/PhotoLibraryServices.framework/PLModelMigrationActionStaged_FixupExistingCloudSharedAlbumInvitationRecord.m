...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  if (v11)
  {
    ...
    v36[1] = 3221225472;
    v36[2] = __122__PLModelMigrationActionStaged_FixupExistingCloudSharedAlbumInvitationRecord_performActionWithManagedObjectContext_error___block_invoke;
    v36[3] = &unk_1E366D968;
    v36[4] = self;
    v38 = &v45;
    v39 = &v41;
      ...
      if (!v46[5])
      {
        ...
        if (v26)
        {
          ...
          if (v28)
          {
            ...
            objc_msgSend(v33, "logWithMessage:fromCodeLocation:type:", v32, "PLModelMigrationActionStaged.m", 121, 16);
  ...
  else
  {
    ...
    if (v17)
    {
      ...
      if (v19)
      {
        ...
        objc_msgSend(v25, "logWithMessage:fromCodeLocation:type:", v24, "PLModelMigrationActionStaged.m", 125, 16);
