...
{
  uint64_t v3;
  PLPrimaryResourceDataStoreDataRecipe *v5;
  uint64_t v6;
  void *v8;
  objc_super v9;
  ...
  v5 = -[PLPrimaryResourceDataStoreDataRecipe init](&v9, sel_init);
  if (v5)
  {
    ...
    if (v6 != objc_opt_class())
    {
      ...
      objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, v5, CFSTR("PLPrimaryResourceDataStoreDataRecipe.m"), 34, CFSTR("wrong recipe class passed to recipe initializer."));
