...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  v7 = a3;
  objc_msgSend(v6, "predicateWithFormat:", CFSTR("%K = %@"), CFSTR("kind"), &unk_1E375E5E0);
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      ...
      if (v15)
      {
        ...
        objc_msgSend(v18, "logWithMessage:fromCodeLocation:type:", v17, "PLModelMigrationActions_16000.m", 1080, 0);
  ...
  else
  {
    ...
    if (v20)
    {
      ...
      if (v23)
      {
        ...
        objc_msgSend(v28, "logWithMessage:fromCodeLocation:type:", v27, "PLModelMigrationActions_16000.m", 1084, 16);
