...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K = %d"), CFSTR("recipeID"), 65944);
  ...
  if (v11)
  {
    ...
    v36[1] = 3221225472;
    v36[2] = __100__PLModelMigrationAction_PromoteLeftoverDeferredAssets_performActionWithManagedObjectContext_error___block_invoke;
    v36[3] = &unk_1E366AC10;
    v36[4] = self;
    v38 = &v41;
    v39 = &v47;
      ...
      if (!v42[5])
      {
        ...
        if (v26)
        {
          ...
          if (v28)
          {
            ...
            objc_msgSend(v33, "logWithMessage:fromCodeLocation:type:", v32, "PLModelMigrationActions_15000.m", 182, 16);
  ...
  else
  {
    ...
    if (v17)
    {
      ...
      if (v19)
      {
        ...
        objc_msgSend(v25, "logWithMessage:fromCodeLocation:type:", v24, "PLModelMigrationActions_15000.m", 186, 16);
