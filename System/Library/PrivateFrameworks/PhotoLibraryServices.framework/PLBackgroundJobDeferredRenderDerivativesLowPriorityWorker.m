...
{
  return (id)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E3763308);
}
...
- (id)_predicateToFetchDeferredAssets
{
  ...
  -[PLBackgroundJobDeferredRenderDerivativesLowPriorityWorker deferredProcessingStatesHandled](self, "deferredProcessingStatesHandled");
