  ...
  if (v10)
  {
    ...
    if (v18)
    {
      ...
      if (v21)
      {
        ...
        -[PLModelMigrationActionBackground logger](self, "logger", &v30, v27);
        v26 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v26, "logWithMessage:fromCodeLocation:type:", v25, "PLModelMigrationActionBackground.m", 1383, 16);
