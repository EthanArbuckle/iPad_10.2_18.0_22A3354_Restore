...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  v48[1] = 3221225472;
  v48[2] = __106__PLModelMigrationAction_FixComputeSyncResourceFileExtension_performActionWithManagedObjectContext_error___block_invoke;
  v48[3] = &unk_1E36700D0;
  v21 = v6;
  v49 = v21;
  v47[0] = v20;
  v47[1] = 3221225472;
  v47[2] = __106__PLModelMigrationAction_FixComputeSyncResourceFileExtension_performActionWithManagedObjectContext_error___block_invoke_2;
  v47[3] = &unk_1E3670818;
  v47[4] = self;
  v47[5] = &v50;
  v46[0] = v20;
  v46[1] = 3221225472;
  v46[2] = __106__PLModelMigrationAction_FixComputeSyncResourceFileExtension_performActionWithManagedObjectContext_error___block_invoke_3;
  v46[3] = &unk_1E36694A0;
  v46[4] = self;
  v46[5] = &v56;
  v46[6] = &v62;
  v46[7] = &v50;
  v22 = -[PLEnumerateAndSaveController initWithName:fetchRequest:context:pathManager:concurrent:refreshAllAfterSave:generateContextBlock:didFetchObjectIDsBlock:processResultBlock:](v16, "initWithName:fetchRequest:context:pathManager:concurrent:refreshAllAfterSave:generateContextBlock:didFetchObjectIDsBlock:processResultBlock:", v18, v9, v21, v19, 0, 1, v48, v47, v46);

  v23 = (id *)(v57 + 5);
  obj = (id)v57[5];
  LOBYTE(v19) = -[PLEnumerateAndSaveController processObjectsWithError:](v22, "processObjectsWithError:", &obj);
  ...
  if ((v19 & 1) != 0)
  {
    ...
    v28 = objc_msgSend((id)v51[5], "totalUnitCount");
    v66 = 134217984;
    v67 = v28;
    LODWORD(v44) = 12;
    ...
    objc_msgSend(v30, "logWithMessage:fromCodeLocation:type:", v29, "PLModelMigrationActions_18000.m", 1307, 0);
  ...
  else
  {
    ...
    objc_msgSend(v38, "logWithMessage:fromCodeLocation:type:", v29, "PLModelMigrationActions_18000.m", 1305, 16);
