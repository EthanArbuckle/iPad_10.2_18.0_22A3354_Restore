...
{
  SKSetupMacSetupServer *v2;
  SKSetupMacSetupServer *v3;
  SKSetupMacSetupServer *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)SKSetupMacSetupServer;
  v2 = -[SKSetupBase initWithLogCategory:](&v6, sel_initWithLogCategory_, &gLogCategory_SKSetupMacSetupServer);
  v3 = v2;
  if (v2)
    v4 = v2;
...
- (void)_activate
{
  ...
  if (self->super._sendDataHandler)
    -[SKSetupMacSetupServer _oobEnsureStarted](self, "_oobEnsureStarted");
  else
    -[SKSetupMacSetupServer _bleServerEnsureStarted](self, "_bleServerEnsureStarted");
  -[SKSetupMacSetupServer _prepareSteps](self, "_prepareSteps");
  v3.receiver = self;
...
- (void)_invalidate
{
  ...
  -[SKSetupMacSetupServer _bleAdvertiserEnsureStopped](self, "_bleAdvertiserEnsureStopped");
  -[SKSetupMacSetupServer _bleServerEnsureStopped](self, "_bleServerEnsureStopped");
  v3.receiver = self;
  v3.super_class = (Class)SKSetupMacSetupServer;
...
- (void)_run
{
  if (-[SKSetupMacSetupServer _bleAdvertiserShouldRun](self, "_bleAdvertiserShouldRun"))
    -[SKSetupMacSetupServer _bleAdvertiserEnsureStarted](self, "_bleAdvertiserEnsureStarted");
  else
    -[SKSetupMacSetupServer _bleAdvertiserEnsureStopped](self, "_bleAdvertiserEnsureStopped");
}
...
- (void)_bleAdvertiserEnsureStarted
{
  ...
  if (!self->_bleAdvertiser)
  {
    ...
    objc_msgSend(v4, "setNearbyActionType:", 46);
...
- (void)_bleServerAcceptConnecton:(id)a3
{
  ...
  if (!v4)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:](self, "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:", v5, 0, 0, &__block_literal_global_77);
    goto LABEL_8;
  }
  v5 = v4;
  var0 = self->super._ucat->var0;
...
- (void)_oobEnsureStarted
{
  ...
  if (!self->super._skCnx)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:](self, "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:", v3, 0, 0, &__block_literal_global_21);
...
void __48__SKSetupMacSetupServer__bleServerEnsureStarted__block_invoke_2(uint64_t a1, void *a2)
{
  id v3;
  uint64_t v4;
  uint64_t v5;
...
void __52__SKSetupMacSetupServer__bleAdvertiserEnsureStarted__block_invoke(uint64_t a1, void *a2)
{
  id v3;
  uint64_t v4;
  int v5;
