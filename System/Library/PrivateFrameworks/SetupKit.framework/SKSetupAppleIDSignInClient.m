...
{
  SKSetupAppleIDSignInClient *v2;
  SKSetupAppleIDSignInClient *v3;
  SKSetupAppleIDSignInClient *v4;
  objc_super v6;
...
- (void)_activate
{
  ...
  -[SKSetupAppleIDSignInClient _prepareSteps](self, "_prepareSteps");
  v3.receiver = self;
...
- (void)_run
{
  ...
  if (!self->super._invalidateCalled)
  {
    while (1)
    {
      ...
      {
        case 11:
          -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:](self, "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:", 0, 1, 1, &__block_literal_global_1028);
