...
{
  SKSetupFieldDiagnosticsServer *v2;
  SKSetupFieldDiagnosticsServer *v3;
  SKSetupFieldDiagnosticsServer *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)SKSetupFieldDiagnosticsServer;
  v2 = -[SKSetupBase initWithLogCategory:](&v6, sel_initWithLogCategory_, &gLogCategory_SKSetupFieldDiagnosticsServer);
  v3 = v2;
  if (v2)
    v4 = v2;
...
- (void)_activate
{
  ...
  if (self->super._sendDataHandler)
    -[SKSetupFieldDiagnosticsServer _oobEnsureStarted](self, "_oobEnsureStarted");
  else
    -[SKSetupFieldDiagnosticsServer _bleServerEnsureStarted](self, "_bleServerEnsureStarted");
  -[SKSetupFieldDiagnosticsServer _prepareSteps](self, "_prepareSteps");
  v3.receiver = self;
...
- (void)_invalidate
{
  ...
  -[SKSetupFieldDiagnosticsServer _bleAdvertiserEnsureStopped](self, "_bleAdvertiserEnsureStopped");
  -[SKSetupFieldDiagnosticsServer _bleServerEnsureStopped](self, "_bleServerEnsureStopped");
  v3.receiver = self;
  v3.super_class = (Class)SKSetupFieldDiagnosticsServer;
...
- (void)_run
{
  if (-[SKSetupFieldDiagnosticsServer _bleAdvertiserShouldRun](self, "_bleAdvertiserShouldRun"))
    -[SKSetupFieldDiagnosticsServer _bleAdvertiserEnsureStarted](self, "_bleAdvertiserEnsureStarted");
  else
    -[SKSetupFieldDiagnosticsServer _bleAdvertiserEnsureStopped](self, "_bleAdvertiserEnsureStopped");
}
...
- (void)_bleAdvertiserEnsureStarted
{
  ...
  if (!self->_bleAdvertiser)
  {
    ...
    objc_msgSend(v4, "setNearbyActionType:", 44);
...
- (void)_bleServerEnsureStarted
{
  ...
  if (!self->_bleServer)
  {
    ...
    v9[1] = 3221225472;
    v9[2] = __56__SKSetupFieldDiagnosticsServer__bleServerEnsureStarted__block_invoke;
    v9[3] = &unk_24D22A798;
    v9[4] = v4;
    v9[5] = self;
    ...
    v8[0] = v5;
    v8[1] = 3221225472;
    v8[2] = __56__SKSetupFieldDiagnosticsServer__bleServerEnsureStarted__block_invoke_2;
    v8[3] = &unk_24D22B140;
    v8[4] = v4;
    v8[5] = self;
...
- (void)_bleServerAcceptConnecton:(id)a3
{
  ...
  if (!v4)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:](self, "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:", v5, 0, 0, &__block_literal_global_1176);
    goto LABEL_8;
  }
  v5 = v4;
  var0 = self->super._ucat->var0;
...
- (void)_oobEnsureStarted
{
  ...
  if (!self->super._skCnx)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:](self, "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:", v3, 0, 0, &__block_literal_global_23);
...
void __56__SKSetupFieldDiagnosticsServer__bleServerEnsureStarted__block_invoke_2(uint64_t a1, void *a2)
{
  id v3;
  uint64_t v4;
  uint64_t v5;
...
void __60__SKSetupFieldDiagnosticsServer__bleAdvertiserEnsureStarted__block_invoke(uint64_t a1, void *a2)
{
  id v3;
  uint64_t v4;
  int v5;
