...
- (_TtC24DVTInstrumentsFoundation23CoreMLPerfRunnerService)initWithChannel:(id)a3
{
  uint64_t v4;
  id v5;
  _TtC24DVTInstrumentsFoundation23CoreMLPerfRunnerService *v6;
  uint64_t v7;
  objc_class *v8;
  id v9;
  _TtC24DVTInstrumentsFoundation23CoreMLPerfRunnerService *v10;
  objc_super v12;
...
{
  uint64_t v2;
  _TtC24DVTInstrumentsFoundation23CoreMLPerfRunnerService *v3;
  uint64_t v4;
  os_log_type_t v5;
  NSObject *v6;
  uint8_t *v7;
  ...
  if (v2 != -1)
    swift_once();
  v4 = sub_222BC7DA4();
  sub_222BAC438(v4, (uint64_t)qword_25576F458);
  v5 = sub_222BC7E94();
  v6 = sub_222BC7D8C();
  if (os_log_type_enabled(v6, v5))
  {
    ...
    *(_WORD *)v7 = 0;
    _os_log_impl(&dword_222B17000, v6, v5, "PerfRunnerService - deinit invoked", v7, 2u);
    MEMORY[0x22767A418](v7, -1, -1);
  }

  v8.receiver = v3;
  v8.super_class = (Class)type metadata accessor for CoreMLPerfRunnerService();
  -[CoreMLPerfRunnerService dealloc](&v8, sel_dealloc);
}
...
{
  _TtC24DVTInstrumentsFoundation23CoreMLPerfRunnerService *result;
