...
- (MicaPlayer)initWithFileName:(id)a3 retinaScale:(double)a4
{
  ...
  v9 = -[MicaPlayer initWithFileName:bundle:retinaScale:](self, "initWithFileName:bundle:retinaScale:", v7, v8, a4);
...
- (MicaPlayer)initWithFileName:(id)a3 bundle:(id)a4 retinaScale:(double)a5
{
  ...
  v8 = a3;
  objc_msgSend(a4, "URLForResource:withExtension:", v8, CFSTR("caar"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v9;
  if (v9)
  {
    objc_msgSend(v9, "path");
    v11 = (MicaPlayer *)objc_claimAutoreleasedReturnValue();
    v12 = -[MicaPlayer initWithPath:retinaScale:](self, "initWithPath:retinaScale:", v11, a5);
    self = v11;
  }
  else
  {
    ...
    NSLog(CFSTR("Unable to find Mica document: %@ at %@"), v8, v13);
...
{
  if (-[MicaPlayer isPlaybackAtEnd](self, "isPlaybackAtEnd", a3))
  {
