...
- (GKResourceRequest)init
{
  ...
  v2 = -[GKResourceRequest init](&v9, sel_init);
  if (v2)
  {
...
{
  objc_msgSend(MEMORY[0x1E0C99DA0], "raise:format:", *MEMORY[0x1E0C99750], CFSTR("%s not overriden on %@"), "-[GKResourceRequest makeLoadOperation]", objc_opt_class());
  return 0;
}
...
- (id)description
{
  ...
  -[GKResourceRequest cacheKey](self, "cacheKey");
...
- (unint64_t)hash
{
  ...
  -[GKResourceRequest requestKey](self, "requestKey");
