...
- (void)mp_moveAndResizeWithinParentLayer:()MicaPlayerAdditions usingGravity:geometryFlipped:retinaScale:animate:
{
  ...
  if (v24 >= 0.00001)
    ...
    v28 = 0.00001;
  v29 = (void *)*MEMORY[0x1E0CD2FB0];
  if (a6)
  {
    if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2FB0]))
    {
      v30 = (void **)MEMORY[0x1E0CD2F68];
LABEL_22:
      v33 = *v30;
LABEL_23:
      v34 = v33;
    ...
    v31 = (void *)*MEMORY[0x1E0CD2FA8];
    if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2FA8]))
    {
      v30 = (void **)MEMORY[0x1E0CD2F60];
      goto LABEL_22;
    }
    v32 = (void *)*MEMORY[0x1E0CD2FB8];
    if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2FB8]))
    {
      v30 = (void **)MEMORY[0x1E0CD2F70];
      goto LABEL_22;
    }
    v40 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F68]);
    v33 = v29;
    if ((v40 & 1) != 0)
      goto LABEL_23;
    v41 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F60]);
    v33 = v31;
    if ((v41 & 1) != 0)
      goto LABEL_23;
    v42 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F70]);
    v33 = v32;
    if (v42)
      goto LABEL_23;
  }
...
LABEL_31:
  ...
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F80]))
    goto LABEL_48;
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F78]))
  {
    v39 = 0.5;
    v14 = v14 + v25 * 0.5 - v27 * 0.5;
LABEL_49:
  ...
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2FA0]))
  {
    v14 = v14 + v25 - v27;
LABEL_48:
    v39 = 0.5;
  ...
  v35 = 1.0;
  if ((objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F68]) & 1) != 0)
    goto LABEL_31;
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F60]))
  {
    v14 = v14 + v25 * 0.5 - v27 * 0.5;
    goto LABEL_31;
  }
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F70]))
  {
    v14 = v14 + v25 - v27;
    goto LABEL_31;
  }
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F88]))
  {
    v36 = v25 / v27;
    v35 = v26 / v28;
  }
  ...
  {
    if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F90]))
    {
      if (v25 / v27 >= v26 / v28)
        v35 = v26 / v28;
      else
    ...
    {
      if (!objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CD2F98]))
      {
