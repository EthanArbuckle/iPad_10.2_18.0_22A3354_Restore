...
- (id)description
{
  ...
  -[VMAudioMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[VMAudioMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (audioData)
    objc_msgSend(v3, "setObject:forKey:", audioData, CFSTR("audioData"));
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSData copyWithZone:](self->_audioData, "copyWithZone:", a3);
  v8 = (void *)v6[1];
  v6[1] = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_protocolVersion != *((_DWORD *)v4 + 4))
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  audioData = self->_audioData;
  if ((unint64_t)audioData | *((_QWORD *)v4 + 1))
    v6 = -[NSData isEqual:](audioData, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSData hash](self->_audioData, "hash") ^ v2;
}
