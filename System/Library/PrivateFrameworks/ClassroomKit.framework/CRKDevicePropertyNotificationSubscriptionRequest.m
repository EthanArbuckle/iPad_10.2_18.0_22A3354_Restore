...
{
  id v4;
  CRKDevicePropertyNotificationSubscriptionRequest *v5;
  void *v6;
  uint64_t v7;
  void *v8;
  uint64_t v9;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[CRKDevicePropertyNotificationSubscriptionRequest propertyKeys](self, "propertyKeys", v6.receiver, v6.super_class);
