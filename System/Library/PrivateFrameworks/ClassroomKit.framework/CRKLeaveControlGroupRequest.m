...
{
  id v4;
  CRKLeaveControlGroupRequest *v5;
  void *v6;
  uint64_t v7;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[CRKLeaveControlGroupRequest groupIdentifier](self, "groupIdentifier", v7.receiver, v7.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("groupIdentifier"));

  -[CRKLeaveControlGroupRequest leaderIdentifiers](self, "leaderIdentifiers");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
