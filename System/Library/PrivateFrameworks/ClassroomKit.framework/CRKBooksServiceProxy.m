...
- (CRKBooksServiceProxy)init
{
  ...
  v2 = -[CRKBooksServiceProxy init](&v6, sel_init);
  if (v2)
  {
    v3 = -[CRKValidXPCConnectionProvider initWithBuilder:]([CRKValidXPCConnectionProvider alloc], "initWithBuilder:", &__block_literal_global_11);
...
{
  return objc_msgSend(MEMORY[0x24BDD1988], "crk_booksServiceConnection");
}
...
- (void)fetchBooksWithRequest:(id)a3 completion:(id)a4
{
  ...
  v9 = v6;
  v7 = v6;
  -[CRKBooksServiceProxy _fetchBooksWithRequest:completion:](self, "_fetchBooksWithRequest:completion:", a3, v8);
...
- (void)_fetchBooksWithRequest:(id)a3 completion:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[CRKBooksServiceProxy connectionProvider](self, "connectionProvider");
  ...
  v16[1] = 3221225472;
  v16[2] = __58__CRKBooksServiceProxy__fetchBooksWithRequest_completion___block_invoke;
  v16[3] = &unk_24D9C6EB0;
  v11 = v6;
  v17 = v11;
  ...
  v14[0] = v10;
  v14[1] = 3221225472;
  v14[2] = __58__CRKBooksServiceProxy__fetchBooksWithRequest_completion___block_invoke_3;
  v14[3] = &unk_24D9C7648;
  v15 = v11;
  v13 = v11;
  objc_msgSend(v12, "fetchBooksWithRequest:completion:", v7, v14);
...
uint64_t __58__CRKBooksServiceProxy__fetchBooksWithRequest_completion___block_invoke_4(_QWORD *a1)
{
...
- (void)fetchChaptersWithRequest:(id)a3 completion:(id)a4
{
  ...
  v9 = v6;
  v7 = v6;
  -[CRKBooksServiceProxy _fetchChaptersWithRequest:completion:](self, "_fetchChaptersWithRequest:completion:", a3, v8);
...
- (void)_fetchChaptersWithRequest:(id)a3 completion:(id)a4
{
  ...
  v16[0] = MEMORY[0x24BDAC760];
  v16[1] = 3221225472;
  v16[2] = __61__CRKBooksServiceProxy__fetchChaptersWithRequest_completion___block_invoke;
  v16[3] = &unk_24D9C6EB0;
  v11 = v6;
  v17 = v11;
  objc_msgSend(v9, "remoteObjectProxyWithErrorHandler:", v16);
  ...
  v14[0] = v10;
  v14[1] = 3221225472;
  v14[2] = __61__CRKBooksServiceProxy__fetchChaptersWithRequest_completion___block_invoke_3;
  v14[3] = &unk_24D9C7698;
  v15 = v11;
  v13 = v11;
  objc_msgSend(v12, "fetchChaptersWithRequest:completion:", v7, v14);
...
uint64_t __61__CRKBooksServiceProxy__fetchChaptersWithRequest_completion___block_invoke_4(_QWORD *a1)
{
  return (*(uint64_t (**)(_QWORD, _QWORD, _QWORD))(a1[6] + 16))(a1[6], a1[4], a1[5]);
}
