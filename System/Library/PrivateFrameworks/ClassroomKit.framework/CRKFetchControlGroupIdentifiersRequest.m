...
{
  id v4;
  CRKFetchControlGroupIdentifiersRequest *v5;
  void *v6;
  void *v7;
  uint64_t v8;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[CRKFetchControlGroupIdentifiersRequest includeTemporary](self, "includeTemporary", v7.receiver, v7.super_class));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("includeTemporary"));

  -[CRKFetchControlGroupIdentifiersRequest leaderIdentifier](self, "leaderIdentifier");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
