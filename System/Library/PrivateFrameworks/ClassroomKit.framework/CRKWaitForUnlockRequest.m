...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[CRKWaitForUnlockRequest shouldBecomeExclusive](self, "shouldBecomeExclusive", v6.receiver, v6.super_class));
