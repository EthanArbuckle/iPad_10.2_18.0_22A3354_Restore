...
- (CRKTableEntriesWithColumnSpacer)initWithOrigin:(id)a3 index:(unint64_t)a4 spacerEntry:(id)a5
{
  ...
  id v11;
  void *v12;
  CRKTableEntriesWithColumnSpacer *v13;
  CRKTableEntriesWithColumnSpacer *v14;
  void *v16;
  void *v17;
  objc_super v18;
  ...
  else
  {
    ...
    objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("CRKTableEntriesWithColumnSpacer.m"), 23, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("origin"));
  ...
  objc_msgSend(v17, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("CRKTableEntriesWithColumnSpacer.m"), 24, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("spacerEntry"));

LABEL_3:
  v18.receiver = self;
  v18.super_class = (Class)CRKTableEntriesWithColumnSpacer;
  v13 = -[CRKTableEntriesWithColumnSpacer init](&v18, sel_init);
  v14 = v13;
  if (v13)
  {
