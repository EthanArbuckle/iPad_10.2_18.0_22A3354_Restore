...
{
  id v4;
  CRKFetchLastLoginDateRequest *v5;
  void *v6;
  uint64_t v7;
  void *v8;
  uint64_t v9;
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v8, CFSTR("appleIDs"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[CRKFetchLastLoginDateRequest appleIDs](self, "appleIDs", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("appleIDs"));
