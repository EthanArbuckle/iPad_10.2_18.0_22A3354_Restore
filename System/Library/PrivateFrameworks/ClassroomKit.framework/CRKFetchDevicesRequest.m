...
- (CRKFetchDevicesRequest)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v8, CFSTR("deviceIdentifiers"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[CRKFetchDevicesRequest deviceIdentifiers](self, "deviceIdentifiers", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("deviceIdentifiers"));
