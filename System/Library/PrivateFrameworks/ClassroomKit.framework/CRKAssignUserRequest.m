...
- (CRKAssignUserRequest)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v38, CFSTR("enrolledCourseIdentifiers"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[CRKAssignUserRequest userIdentifier](self, "userIdentifier", v16.receiver, v16.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("userIdentifier"));

  -[CRKAssignUserRequest groupID](self, "groupID");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, CFSTR("groupID"));

  -[CRKAssignUserRequest displayName](self, "displayName");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, CFSTR("displayName"));

  -[CRKAssignUserRequest givenName](self, "givenName");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v8, CFSTR("givenName"));

  -[CRKAssignUserRequest familyName](self, "familyName");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v9, CFSTR("familyName"));

  -[CRKAssignUserRequest imageURL](self, "imageURL");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v10, CFSTR("imageURL"));

  -[CRKAssignUserRequest fullScreenImageURL](self, "fullScreenImageURL");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v11, CFSTR("fullScreenImageURL"));

  -[CRKAssignUserRequest appleID](self, "appleID");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v12, CFSTR("appleID"));

  -[CRKAssignUserRequest passcodeType](self, "passcodeType");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v13, CFSTR("passcodeType"));

  -[CRKAssignUserRequest password](self, "password");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v14, CFSTR("password"));

  -[CRKAssignUserRequest enrolledCourseIdentifiers](self, "enrolledCourseIdentifiers");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v15, CFSTR("enrolledCourseIdentifiers"));
