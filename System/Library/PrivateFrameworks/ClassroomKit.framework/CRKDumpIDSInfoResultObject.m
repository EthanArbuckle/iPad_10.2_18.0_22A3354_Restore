...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[CRKDumpIDSInfoResultObject info](self, "info", v6.receiver, v6.super_class);
...
- (CRKDumpIDSInfoResultObject)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v14, CFSTR("info"));
