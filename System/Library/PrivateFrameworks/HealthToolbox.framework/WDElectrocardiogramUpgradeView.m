...
- (id)titleString
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("ELECTROCARDIOGRAM_UPGRADE_TITLE"), &stru_24D38E7C8, CFSTR("WellnessDashboard-Localizable-Cinnamon"));
...
- (id)bodyString
{
  ...
  WDBundle();
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("ELECTROCARDIOGRAM_UPGRADE_BODY"), &stru_24D38E7C8, CFSTR("WellnessDashboard-Localizable-Cinnamon"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  HKConditionallyRedactedHeartRhythmString();
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)buttonTitleString
{
  ...
  WDBundle();
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("ELECTROCARDIOGRAM_UPGRADE_BUTTON_TITLE"), &stru_24D38E7C8, CFSTR("WellnessDashboard-Localizable-Cinnamon"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  HKConditionallyRedactedHeartRhythmString();
  v4 = (void *)objc_claimAutoreleasedReturnValue();
