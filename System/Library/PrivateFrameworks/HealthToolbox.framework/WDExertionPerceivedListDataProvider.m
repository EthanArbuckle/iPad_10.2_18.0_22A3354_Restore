...
- (id)createDataFetcherForSampleType:(id)a3 predicate:(id)a4 limit:(int64_t)a5 sortDescriptors:(id)a6 resultsHandler:(id)a7
{
  ...
  v12 = a6;
  v13 = a7;
  if (-[WDExertionPerceivedListDataProvider shouldDisplayAllSamples](self, "shouldDisplayAllSamples"))
  {
    v14 = 0;
  }
  else
  {
    ...
    v14 = -[WDExertionDataFetcher initWithHealthStore:predicate:exertionTypeCode:limit:sortDescriptors:resultsHandler:](v15, "initWithHealthStore:predicate:exertionTypeCode:limit:sortDescriptors:resultsHandler:", v16, v11, 304, a5, v12, v13);
