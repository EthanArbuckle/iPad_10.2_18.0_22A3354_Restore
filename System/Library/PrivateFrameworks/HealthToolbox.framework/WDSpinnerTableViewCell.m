...
{
  return (NSString *)CFSTR("WDSpinnerTableViewCellIdentifier");
}

- (WDSpinnerTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  WDSpinnerTableViewCell *v4;
  WDSpinnerTableViewCell *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)WDSpinnerTableViewCell;
  v4 = -[WDSpinnerTableViewCell initWithStyle:reuseIdentifier:](&v7, sel_initWithStyle_reuseIdentifier_, a3, a4);
  v5 = v4;
  if (v4)
  {
    -[WDSpinnerTableViewCell setSelectionStyle:](v4, "setSelectionStyle:", 0);
    -[WDSpinnerTableViewCell setupSubviews](v5, "setupSubviews");
    -[WDSpinnerTableViewCell setupConstraints](v5, "setupConstraints");
  }
  return v5;
}
...
- (void)setupSubviews
{
  ...
  -[WDSpinnerTableViewCell setContentContainerView:](self, "setContentContainerView:", v3);

  -[WDSpinnerTableViewCell contentView](self, "contentView");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[WDSpinnerTableViewCell contentContainerView](self, "contentContainerView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "addSubview:", v5);

  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF67D0]), "initWithActivityIndicatorStyle:", 100);
  -[WDSpinnerTableViewCell setSpinner:](self, "setSpinner:", v6);

  -[WDSpinnerTableViewCell contentContainerView](self, "contentContainerView");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[WDSpinnerTableViewCell spinner](self, "spinner");
...
- (void)setupConstraints
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "constraintGreaterThanOrEqualToConstant:", *MEMORY[0x24BDF7DE8]);
...
- (void)setWaitingReason:(id)a3
{
  ...
  v4 = a3;
  -[WDSpinnerTableViewCell waitingReasonLabel](self, "waitingReasonLabel");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v5)
  {
    ...
    -[WDSpinnerTableViewCell setWaitingReasonLabel:](self, "setWaitingReasonLabel:", v9);
...
- (void)prepareForReuse
{
  ...
  -[WDSpinnerTableViewCell prepareForReuse](&v4, sel_prepareForReuse);
  -[WDSpinnerTableViewCell spinner](self, "spinner");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
