...
- (void)_addObservers
{
  ...
  objc_msgSend(v3, "addObserver:selector:name:object:", self, sel_applicationWillEnterForeground, *MEMORY[0x24BDF75D0], 0);
  objc_msgSend(v3, "addObserver:selector:name:object:", self, sel_applicationDidEnterBackground, *MEMORY[0x24BDF7528], 0);

}

- (WDTableViewController)initWithStyle:(int64_t)a3
{
  WDTableViewController *v3;
  WDTableViewController *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)WDTableViewController;
  v3 = -[WDTableViewController initWithStyle:](&v6, sel_initWithStyle_, a3);
  v4 = v3;
  if (v3)
    -[WDTableViewController _addObservers](v3, "_addObservers");
  return v4;
}
...
{
  WDTableViewController *v4;
  WDTableViewController *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)WDTableViewController;
  v4 = -[WDTableViewController initWithNibName:bundle:](&v7, sel_initWithNibName_bundle_, a3, a4);
  v5 = v4;
  if (v4)
    -[WDTableViewController _addObservers](v4, "_addObservers");
  return v5;
}
...
- (WDTableViewController)initWithCoder:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)WDTableViewController;
  v3 = -[WDTableViewController initWithCoder:](&v6, sel_initWithCoder_, a3);
  v4 = v3;
  if (v3)
    -[WDTableViewController _addObservers](v3, "_addObservers");
  return v4;
...
- (void)dealloc
{
  ...
  -[WDTableViewController dealloc](&v4, sel_dealloc);
}
...
- (void)viewDidLoad
{
  ...
  -[WDTableViewController tableView](self, "tableView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[WDTableViewController reloadTable](self, "reloadTable");
}
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  -[WDTableViewController _section:](self, "_section:", a4);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[WDTableViewController _sectionAtIndexPath:](self, "_sectionAtIndexPath:", v6);
...
- (id)tableView:(id)a3 viewForFooterInSection:(int64_t)a4
{
  ...
  objc_msgSend(v7, "viewForFooter:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (double)tableView:(id)a3 estimatedHeightForRowAtIndexPath:(id)a4
{
  ...
  v5 = a4;
  -[WDTableViewController _sectionAtIndexPath:](self, "_sectionAtIndexPath:", v5);
...
- (void)reloadSection:(unint64_t)a3 animated:(BOOL)a4
{
  ...
  v4 = a4;
  v7 = objc_msgSend(MEMORY[0x24BDF6F90], "areAnimationsEnabled");
  if ((_DWORD)v7 == v4)
  {
    -[WDTableViewController tableView](self, "tableView");
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x24BDF6F90], "setAnimationsEnabled:", v8);
  }
}

- (void)pushViewController:(id)a3
{
  -[WDTableViewController pushViewController:animated:](self, "pushViewController:animated:", a3, 1);
}
...
- (void)pushViewController:(id)a3 animated:(BOOL)a4
{
  ...
  v4 = a4;
  v6 = a3;
  -[WDTableViewController navigationController](self, "navigationController");
  v7 = (id)objc_claimAutoreleasedReturnValue();
