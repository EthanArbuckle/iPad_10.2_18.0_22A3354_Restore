...
{
  id v3;
  FIUIHostingAreaLayoutView *v4;
  FIUIHostingAreaLayoutView *v5;

  v3 = a3;
  v4 = [FIUIHostingAreaLayoutView alloc];
  v5 = -[FIUIHostingAreaLayoutView initWithFrame:](v4, "initWithFrame:", *MEMORY[0x24BDBF090], *(double *)(MEMORY[0x24BDBF090] + 8), *(double *)(MEMORY[0x24BDBF090] + 16), *(double *)(MEMORY[0x24BDBF090] + 24));
  -[FIUIHostingAreaLayoutView setHostedView:](v5, "setHostedView:", v3);
...
- (void)setHostedView:(id)a3
{
  ...
  -[FIUIHostingAreaLayoutView hostedView](self, "hostedView");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setTranslatesAutoresizingMaskIntoConstraints:", 0);

  -[FIUIHostingAreaLayoutView hostedView](self, "hostedView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[FIUIHostingAreaLayoutView addSubview:](self, "addSubview:", v5);

  -[FIUIHostingAreaLayoutView safeAreaLayoutGuide](self, "safeAreaLayoutGuide");
...
- (CGSize)intrinsicContentSize
{
  ...
  v6 = v5;
  -[FIUIHostingAreaLayoutView safeAreaInsets](self, "safeAreaInsets");
  v8 = v6 + v7;
  -[FIUIHostingAreaLayoutView safeAreaInsets](self, "safeAreaInsets");
  v10 = v8 + v9;
