...
void __33__AssistantMetrics_sharedMetrics__block_invoke()
{
  AssistantMetrics *v0;
  void *v1;

  v0 = objc_alloc_init(AssistantMetrics);
...
+ (void)didVisit
{
  ...
  +[AssistantMetrics sharedMetrics](AssistantMetrics, "sharedMetrics");
...
- (id)__enableSiriTracker
{
  ...
  if (!enableSiriTracker)
  {
    ...
    -[AssistantMetrics __siriSourceProperty](self, "__siriSourceProperty");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v11[0] = v5;
    -[AssistantMetrics __confirmedTrueFalseProperty](self, "__confirmedTrueFalseProperty");
...
- (id)__toggleTracker
{
  ...
  {
    v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    -[AssistantMetrics __toggleTrackerNameProperty](self, "__toggleTrackerNameProperty");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v11[0] = v5;
    -[AssistantMetrics __onOffProperty](self, "__onOffProperty");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v11[1] = v6;
    objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v11, 2);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)__detailVisitFoundInAppsTracker
{
  ...
  {
    v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    -[AssistantMetrics __foundInAppsProperty](self, "__foundInAppsProperty");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v10[0] = v5;
    objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v10, 1);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)__detailToggleFoundInAppsTracker
{
  ...
  {
    v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    -[AssistantMetrics __detailToggleTrackerNameProperty](self, "__detailToggleTrackerNameProperty");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[AssistantMetrics __foundInAppsProperty](self, "__foundInAppsProperty", v5);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v12[1] = v6;
    -[AssistantMetrics __onOffProperty](self, "__onOffProperty");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
