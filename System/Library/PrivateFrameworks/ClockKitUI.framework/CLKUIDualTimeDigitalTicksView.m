...
- (CLKUIDualTimeDigitalTicksView)initWithFrame:(CGRect)a3 configuration:(id *)a4 timer:(id)a5
{
  ...
  id v12;
  char *v13;
  CLKUIDualTimeDigitalTicksView *v14;
  CGSize var0;
  __int128 v16;
  void *v17;
  ...
  v14 = (CLKUIDualTimeDigitalTicksView *)v13;
  if (v13)
  {
    v13[514] = 0;
    var0 = a4->var0;
    ...
    *((_QWORD *)v13 + 66) = 0;
    ...
    -[CLKUIDualTimeDigitalTicksView _configureTicks](v14, "_configureTicks");
...
- (void)setOverrideDate:(id)a3
{
  ...
  if (self->_overrideDate != v5)
  {
    ...
    -[CLKUIDualTimeDigitalTicksView refreshTicks](self, "refreshTicks");
    v5 = v6;
  }
...
- (void)refreshTicks
{
  -[CLKUIDualTimeDigitalTicksView _refreshDigitalTicksWithNow:secondFraction:](self, "_refreshDigitalTicksWithNow:secondFraction:", 0, 0.0);
}
...
- (void)startAnimation
{
  ...
  if (!self->_clockTimerToken)
  {
    ...
    -[CLKClockTimer startUpdatesWithUpdateFrequency:withHandler:identificationLog:](timer, "startUpdatesWithUpdateFrequency:withHandler:identificationLog:", 2, &v6, &__block_literal_global_2);
  ...
  -[CLKUIDualTimeDigitalTicksView refreshTicks](self, "refreshTicks", v6, v7, v8, v9);
}
...
const __CFString *__47__CLKUIDualTimeDigitalTicksView_startAnimation__block_invoke_2()
{
  return CFSTR("CLKUIDualTimeView");
}
...
- (void)layoutSubviews
{
  ...
  -[CLKUIDualTimeDigitalTicksView layoutSubviews](&v9, sel_layoutSubviews);
  v3 = (void *)objc_opt_class();
  -[CLKUIDualTimeDigitalTicksView frame](self, "frame");
  objc_msgSend(v3, "_sizeFromFrame:");
  v6 = v5;
  v7 = v4;
  if (self->_lastSize.width != v5 || self->_lastSize.height != v4)
  {
    -[CLKUIDualTimeDigitalTicksView _configureTicks](self, "_configureTicks");
...
- (void)_configureTicks
{
  ...
  -[CLKUIDualTimeDigitalTicksView bounds](self, "bounds");
  ...
  do
  {
    ...
    if (_disabledLayerActions_onceToken != -1)
      dispatch_once(&_disabledLayerActions_onceToken, &__block_literal_global_84);
    objc_msgSend(v7, "setActions:", _disabledLayerActions__dictionary);
    ...
    -[CLKUIDualTimeDigitalTicksView layer](self, "layer");
...
- (void)_refreshDigitalTicksWithNow:(id)a3 secondFraction:(double)a4
{
  ...
  {
    -[CLKUIDualTimeDigitalTicksView delegate](self, "delegate");
    ...
    if (v6)
    {
      ...
      -[CLKUIDualTimeDigitalTicksView _colorizeDigitalTicksWithActiveColor:inactiveColor:now:secondFraction:](self, "_colorizeDigitalTicksWithActiveColor:inactiveColor:now:secondFraction:", v8, v10, v11, a4);
    }
  }
...
{
  return (CLKUIDualTimeDigitalTicksViewPaletteDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
