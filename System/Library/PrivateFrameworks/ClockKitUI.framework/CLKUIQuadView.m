...
- (BOOL)renderSynchronouslyWithImageQueueDiscard:(BOOL)a3 inGroup:(id)a4 completion:(id)a5
{
  ...
  v8 = a4;
  v9 = (void (**)(_QWORD))a5;
  -[NSCountedSet count](self->_disabledRenderingReasons, "count");
  kdebug_trace();
  if (-[NSCountedSet count](self->_disabledRenderingReasons, "count"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)&buf[14] = disabledRenderingReasons;
      _os_log_impl(&dword_1CB9A4000, v10, OS_LOG_TYPE_DEFAULT, "CLKUIQuadView (%@): Rendering disabled for reasons: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    *(_QWORD *)&buf[16] = 0x2020000000;
    ...
    {
      v13 = -[CLKUIQuadView _sync_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:](self, "_sync_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:", v8, !v6, 1, v9, v14);
...
uint64_t __77__CLKUIQuadView_renderSynchronouslyWithImageQueueDiscard_inGroup_completion___block_invoke(uint64_t a1)
{
  ...
  result = objc_msgSend(*(id *)(a1 + 32), "_sync_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:", *(_QWORD *)(a1 + 40), *(_BYTE *)(a1 + 72) == 0, 1, *(_QWORD *)(a1 + 48), *(double *)(a1 + 64));
...
- (void)_prepareAndRenderForTime:(double)a3 inGroup:(id)a4 checkForDrawable:(BOOL)a5 renderDiscontinuity:(BOOL)a6 completion:(id)a7
{
  if (self->_asyncRenderQueue)
    -[CLKUIQuadView _async_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:](self, "_async_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:", a4, a5, a6, a7, a3);
  else
    -[CLKUIQuadView _sync_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:](self, "_sync_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:", a4, a5, a6, a7, a3);
}
...
{
  objc_msgSend(*(id *)(a1 + 32), "_sync_prepareAndRenderForTime:inGroup:checkForDrawable:renderDiscontinuity:completion:", *(_QWORD *)(a1 + 40), *(unsigned __int8 *)(a1 + 64), *(unsigned __int8 *)(a1 + 65), *(_QWORD *)(a1 + 48), *(double *)(a1 + 56));
...
- (BOOL)_sync_prepareAndRenderForTime:(double)a3 inGroup:(id)a4 checkForDrawable:(BOOL)a5 renderDiscontinuity:(BOOL)a6 completion:(id)a7
{
  ...
  v17 = v12;
  v18 = v13;
  v19 = -[CLKUIQuadView _displayAndCheckForDrawable:renderDiscontinuity:withCompletion:](self, "_displayAndCheckForDrawable:renderDiscontinuity:withCompletion:", v9, v8, v21);
  kdebug_trace();
  ++self->_frameNum;
