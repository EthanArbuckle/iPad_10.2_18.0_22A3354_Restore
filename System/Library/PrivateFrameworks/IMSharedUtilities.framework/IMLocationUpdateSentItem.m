...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[IMLocationUpdateSentItem otherUnformattedID](self, "otherUnformattedID");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setOtherUnformattedID:", v5);

  -[IMLocationUpdateSentItem otherHandle](self, "otherHandle");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setOtherHandle:", v6);

  -[IMLocationUpdateSentItem otherCountryCode](self, "otherCountryCode");
...
- (IMLocationUpdateSentItem)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[IMLocationUpdateSentItem setOtherCountryCode:](v5, "setOtherCountryCode:", v6);

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("otherHandle"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[IMLocationUpdateSentItem setOtherHandle:](v5, "setOtherHandle:", v7);

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("otherUnformattedID"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[IMLocationUpdateSentItem setOtherUnformattedID:](v5, "setOtherUnformattedID:", v8);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[IMLocationUpdateSentItem otherCountryCode](self, "otherCountryCode", v8.receiver, v8.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = (IMLocationUpdateSentItem *)a3;
  if (v4 == self)
  {
    v10 = 1;
  }
...
LABEL_23:
      ...
      -[IMLocationUpdateSentItem otherCountryCode](v5, "otherCountryCode");
      ...
      -[IMLocationUpdateSentItem otherHandle](v5, "otherHandle");
      ...
      -[IMLocationUpdateSentItem otherUnformattedID](v5, "otherUnformattedID", v22);
      ...
      else
      {
        ...
        -[IMLocationUpdateSentItem otherUnformattedID](v5, "otherUnformattedID");
