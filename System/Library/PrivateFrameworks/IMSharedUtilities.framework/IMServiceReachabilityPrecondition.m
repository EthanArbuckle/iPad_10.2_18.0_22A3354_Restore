...
+ (id)preconditionWithDictionary:(id)a3
{
  ...
  v14 = 0u;
  v15 = 0u;
  +[IMServiceReachabilityPrecondition _preconditionClasses](IMServiceReachabilityPrecondition, "_preconditionClasses", 0);
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v12 + 1) + 8 * v8), "preconditionWithDictionary:", v3);
