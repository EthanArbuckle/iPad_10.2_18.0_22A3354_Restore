...
- (TSUMutablePointerSet)init
{
  ...
  if (-[TSUMutablePointerSet isMemberOfClass:](self, "isMemberOfClass:", objc_opt_class()))
    return -[TSUMutablePointerSet initWithCapacity:](self, "initWithCapacity:", 0);
  v4.receiver = self;
  v4.super_class = (Class)TSUMutablePointerSet;
  return -[TSUMutablePointerSet init](&v4, sel_init);
}
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)TSUMutablePointerSet;
  -[TSUMutablePointerSet dealloc](&v4, sel_dealloc);
}

- (TSUMutablePointerSet)initWithCapacity:(unint64_t)a3
{
  TSUMutablePointerSet *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)TSUMutablePointerSet;
  v4 = -[TSUMutablePointerSet init](&v6, sel_init);
  if (v4)
...
{
  unint64_t v4;
  TSUMutablePointerSet *v6;
  const void *v7;

  v4 = a4;
  v6 = -[TSUMutablePointerSet initWithCapacity:](self, "initWithCapacity:", a4);
  if (v6 && v4)
  {
    do
    {
...
- (id)allObjects
{
  ...
  v3 = -[TSUMutablePointerSet count](self, "count");
  v4 = v3;
  if (v3 >= 0x41)
    v5 = 1;
  else
  ...
  -[TSUMutablePointerSet getObjects:](self, "getObjects:", v6);
...
- (id)setByAddingObject:(id)a3
{
  ...
  v5 = -[TSUMutablePointerSet count](self, "count");
  v6 = v5;
  v7 = v5 + 1;
  v8 = 1;
  if (v5 + 1 < 0x41)
  ...
  -[TSUMutablePointerSet getObjects:](self, "getObjects:", v9);
  *(_QWORD *)&v9[8 * v6] = a3;
