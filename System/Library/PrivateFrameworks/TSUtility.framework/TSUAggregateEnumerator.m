...
- (TSUAggregateEnumerator)initWithFirstObject:(id)a3 argumentList:(char *)a4
{
  ...
  v11 = a4;
  v5 = -[TSUAggregateEnumerator init](&v10, sel_init);
  if (v5)
  {
...
- (TSUAggregateEnumerator)initWithObjects:(id)a3
{
  ...
  return -[TSUAggregateEnumerator initWithFirstObject:argumentList:](self, "initWithFirstObject:argumentList:", a3, &v4);
}
...
{
  return -[TSUAggregateEnumerator initWithObjects:](self, "initWithObjects:", 0);
}
...
- (void)dealloc
{
  ...
  -[TSUAggregateEnumerator dealloc](&v3, sel_dealloc);
}
