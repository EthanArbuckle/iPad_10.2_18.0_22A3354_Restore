...
- (SFUJsonScanner)initWithString:(id)a3
{
  ...
  v4 = -[SFUJsonScanner init](&v8, sel_init);
  if (v4)
  {
...
- (void)dealloc
{
  ...
  -[SFUJsonScanner dealloc](&v3, sel_dealloc);
}
...
- (id)parseHexCharacter
{
  ...
  while (1)
  {
    v5 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
    v6 = v5 - 48;
    if ((v5 - 48) >= 0xA)
      break;
LABEL_7:
...
- (id)parseString
{
  ...
  if (-[SFUJsonScanner nextCharacter](self, "nextCharacter") != 34)
    return 0;
  mOffset = self->mOffset;
  ...
  while (2)
  {
    ...
    while (1)
    {
      v6 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
      if (v6 == 34)
      {
    ...
    -[SFUJsonScanner appendCharactersInRange:toString:](self, "appendCharactersInRange:toString:", mOffset, v5, v4);
    v9 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
    result = 0;
    if (v9 > 97)
    {
      switch(v9)
      {
        ...
        case 't':
          ...
          goto LABEL_26;
        case 'u':
          result = -[SFUJsonScanner parseHexCharacter](self, "parseHexCharacter");
...
- (id)parseDictionaryWithMaxDepth:(int)a3
{
  ...
  {
    -[SFUJsonScanner skipWhitespace](self, "skipWhitespace");
    mOffset = self->mOffset;
    ...
    else
    {
      ...
      result = -[SFUJsonScanner parseString](self, "parseString");
      if (result)
      {
        v11 = result;
        while (1)
        {
          -[SFUJsonScanner skipWhitespace](self, "skipWhitespace");
          if (-[SFUJsonScanner nextCharacter](self, "nextCharacter") != 58)
            return 0;
          -[SFUJsonScanner skipWhitespace](self, "skipWhitespace");
          result = -[SFUJsonScanner parseObjectWithMaxDepth:](self, "parseObjectWithMaxDepth:", v8);
          if (!result)
            return result;
          objc_msgSend(v10, "setObject:forKey:", result, v11);
          -[SFUJsonScanner skipWhitespace](self, "skipWhitespace");
          v12 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
          if (v12 != 44)
            break;
          -[SFUJsonScanner skipWhitespace](self, "skipWhitespace");
          result = -[SFUJsonScanner parseString](self, "parseString");
...
- (BOOL)parseConstantString:(const char *)a3
{
  ...
  do
  {
    result = -[SFUJsonScanner nextCharacter](self, "nextCharacter") == *(v4 - 1);
    if (!result)
      break;
  }
...
- (id)parseNull
{
  if (-[SFUJsonScanner parseConstantString:](self, "parseConstantString:", "null"))
...
- (id)parseTrue
{
  if (-[SFUJsonScanner parseConstantString:](self, "parseConstantString:", "true"))
...
- (id)parseFalse
{
  if (-[SFUJsonScanner parseConstantString:](self, "parseConstantString:", "false"))
...
- (id)parseNumber
{
  ...
  mOffset = self->mOffset;
  v4 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
  if ((_DWORD)v4 == 45)
    v4 = -[SFUJsonScanner nextCharacter](self, "nextCharacter", v4);
  if (-[NSCharacterSet characterIsMember:](self->mDecimalDigitCharacterSet, "characterIsMember:", v4))
  {
    ...
    if (v6 == 46)
    {
      if (!-[NSCharacterSet characterIsMember:](self->mDecimalDigitCharacterSet, "characterIsMember:", -[SFUJsonScanner nextCharacter](self, "nextCharacter")))return 0;
      do
      {
        v7 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
        if (!(_DWORD)v7)
          goto LABEL_17;
        v6 = v7;
      }
...
LABEL_17:
    ...
    v8 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
    ...
    {
      do
        v10 = -[SFUJsonScanner nextCharacter](self, "nextCharacter");
      while ((_DWORD)v10
...
- (id)parseObjectWithMaxDepth:(int)a3
{
  ...
  if (v6 > 0x6D)
  {
    ...
    {
      case 'n':
        return -[SFUJsonScanner parseNull](self, "parseNull", v5);
      case 't':
        return -[SFUJsonScanner parseTrue](self, "parseTrue", v5);
      case '{':
        return -[SFUJsonScanner parseDictionaryWithMaxDepth:](self, "parseDictionaryWithMaxDepth:", v5);
    }
  }
  else
  {
    ...
    {
      case '"':
        return -[SFUJsonScanner parseString](self, "parseString", v5);
      case '[':
        return -[SFUJsonScanner parseArrayWithMaxDepth:](self, "parseArrayWithMaxDepth:", v5);
      case 'f':
        return -[SFUJsonScanner parseFalse](self, "parseFalse", v5);
    }
  }
  return -[SFUJsonScanner parseNumber](self, "parseNumber", v5);
}
