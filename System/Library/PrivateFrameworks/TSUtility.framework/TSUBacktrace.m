...
- (TSUBacktrace)initWithAdjustment:(int)a3
{
  ...
  v4 = -[TSUBacktrace init](&v8, sel_init);
  if (v4)
  {
    v39 = 0u;
    v40 = 0u;
...
- (TSUBacktrace)init
{
  return -[TSUBacktrace initWithAdjustment:](self, "initWithAdjustment:", 2);
}
...
- (void)dealloc
{
  ...
  -[TSUBacktrace dealloc](&v3, sel_dealloc);
}
...
- (id)backtraceString
{
  ...
  v3 = backtrace_symbols(&self->_callstack[self->_initAdjustment], self->_frames - self->_initAdjustment);
  v4 = (void *)objc_msgSend(MEMORY[0x24BDD16A8], "stringWithString:", CFSTR("Backtrace:\n"));
...
- (id)caller
{
  return -[TSUBacktrace callerAtIndex:](self, "callerAtIndex:", 1);
}

- (id)callee
{
  return -[TSUBacktrace callerAtIndex:](self, "callerAtIndex:", 0);
}
