...
- (TSUMutableRetainedPointerSet)init
{
  ...
  if (-[TSUMutableRetainedPointerSet isMemberOfClass:](self, "isMemberOfClass:", objc_opt_class()))
    return -[TSUMutableRetainedPointerSet initWithCapacity:](self, "initWithCapacity:", 0);
  v4.receiver = self;
...
{
  TSUMutableRetainedPointerSet *v4;
  ...
  v4 = -[TSUMutablePointerSet init](&v8, sel_init);
  if (v4)
  {
    v7.version = 0;
