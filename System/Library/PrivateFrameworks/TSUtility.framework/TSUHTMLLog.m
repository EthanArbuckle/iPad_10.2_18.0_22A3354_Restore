...
- (TSUHTMLLog)initWithPath:(id)a3
{
  ...
  v4 = -[TSUHTMLLog init](&v10, sel_init);
  if (v4)
  {
...
- (void)dealloc
{
  ...
  -[TSUHTMLLog dealloc](&v3, sel_dealloc);
}
...
- (id)uniqueIdentifierWithPrefix:(id)a3
{
  ...
  return (id)objc_msgSend(v3, "stringWithFormat:", CFSTR("%@-%lu"), a3, uniquifier);
}
...
- (void)_writeMarkupData:(id)a3
{
  ...
  {
    self->_logStarted = 1;
    -[TSUHTMLLog logBegin](self, "logBegin");
  }
...
- (void)writeMarkup:(id)a3
{
  ...
  -[TSUHTMLLog _writeMarkupData:](self, "_writeMarkupData:", objc_msgSend(MEMORY[0x24BDD17C8], "tsu_stringWithFormat:arguments:", a3, &v3));
}
...
- (void)writeText:(id)a3
{
  ...
  -[TSUHTMLLog _writeMarkupData:](self, "_writeMarkupData:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD17C8], "tsu_stringWithFormat:arguments:", a3, &v3), "tsu_escapeXML"));
}

- (void)close
{
  -[NSFileHandle closeFile](self->_handle, "closeFile");
  NSLog((NSString *)CFSTR("Closed log at path %@"), -[TSUHTMLLog path](self, "path"));
}
...
{
  self->_logStarted = 1;
  -[TSUHTMLLog clear](self, "clear");
  -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("<html>\n"));
  -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("<head>\n"));
  -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("<meta charset='UTF-8'/>\n"));
  if (-[TSUHTMLLog title](self, "title"))
    -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("<title>%@</title>"), -[TSUHTMLLog title](self, "title"));
  if (-[TSUHTMLLog script](self, "script"))
    -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("<script language='javascript'>\n%@\n</script>"), -[TSUHTMLLog script](self, "script"));
  if (-[TSUHTMLLog stylesheet](self, "stylesheet"))
    -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("<style type='text/css'>\n<!--\n%@\n-->\n</style>"), -[TSUHTMLLog stylesheet](self, "stylesheet"));
  -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("</head>\n"));
  -[TSUHTMLLog writeMarkup:](self, "writeMarkup:", CFSTR("<body>\n"));
}
