...
{
  return -[SFUMemoryInputStream initWithData:offset:length:](self, "initWithData:offset:length:", a3, 0, objc_msgSend(a3, "length"));
}

- (SFUMemoryInputStream)initWithData:(id)a3 offset:(unint64_t)a4 length:(unint64_t)a5
{
  SFUMemoryInputStream *v8;
  SFUMemoryInputStream *v9;
  unint64_t v10;
  NSData *v11;
  uint64_t v12;
  objc_super v14;
  ...
  v8 = -[SFUMemoryInputStream init](&v14, sel_init);
  v9 = v8;
  if (v8)
  {
    if (a3)
...
- (void)dealloc
{
  ...
  -[SFUMemoryInputStream dealloc](&v3, sel_dealloc);
}
...
- (BOOL)seekWithinBufferToOffset:(int64_t)a3
{
  ...
  if (v4 >= a3)
    -[SFUMemoryInputStream seekToOffset:](self, "seekToOffset:", a3);
  return v4 >= a3;
}
