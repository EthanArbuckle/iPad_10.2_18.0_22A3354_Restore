...
- (TSUProgress)init
{
  ...
  v2 = -[TSUProgress init](&v5, sel_init);
  if (v2)
  {
    v3 = objc_opt_class();
...
- (id)addProgressObserverWithValueInterval:(double)a3 queue:(id)a4 handler:(id)a5
{
  ...
  if (a4 && a5)
  {
    v5 = -[TSUProgressObserver initWithValueInterval:queue:handler:]([TSUProgressObserver alloc], "initWithValueInterval:queue:handler:", a4, a5, a3);
    mProgressObserversQueue = self->mProgressObserversQueue;
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v9 + 1) + 8 * i), "handleValue:maxValue:isIndeterminate:", *(unsigned __int8 *)(a1 + 56), *(double *)(a1 + 40), *(double *)(a1 + 48));
      }
