...
{
  _TtC8StocksUI26LinkActionActivityProvider *result;
...
- (void).cxx_destruct
{
  ...
  swift_release();
  swift_unknownObjectRelease();
  __swift_destroy_boxed_opaque_existential_1((uint64_t)self + OBJC_IVAR____TtC8StocksUI26LinkActionActivityProvider_watchlistManager);
}
...
- (id)activityGroupForAction:(id)a3 sourceView:(id)a4 sourceRect:(CGRect)a5
{
  ...
  double x;
  id v12;
  _TtC8StocksUI26LinkActionActivityProvider *v13;
  _QWORD *v14;
  ...
  v12 = a4;
  v13 = self;
  v14 = sub_1DC3EC290((uint64_t)a3, a4, x, y, width, height);
  swift_unknownObjectRelease();
...
{
  _TtC8StocksUI26LinkActionActivityProvider *v4;
  id v5;
