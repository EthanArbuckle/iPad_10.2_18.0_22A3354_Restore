...
{
  return -[FBSSettings initWithSettings:]([SPUISearchViewSceneSettings alloc], "initWithSettings:", self);
}
...
- (id)valueDescriptionForFlag:(int64_t)a3 object:(id)a4 ofSetting:(unint64_t)a5
{
  ...
  if (a5 - 1000 > 3 || a5 == 1001)
  {
    ...
    -[SPUIMutableLegibilitySceneSettings valueDescriptionForFlag:object:ofSetting:](&v13, sel_valueDescriptionForFlag_object_ofSetting_, a3, v8, a5);
