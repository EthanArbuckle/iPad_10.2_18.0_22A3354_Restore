...
{
  return (NSString *)CFSTR("com.apple.asset.data");
}
...
+ (id)buildWithIdentifier:(id)a3 reference:(id)a4 authentication:(id)a5
{
  ...
  objc_msgSend(v10, "setDeclarationType:", CFSTR("com.apple.asset.data"));
  if (v7)
  {
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3 reference:(id)a4
{
  ...
  objc_msgSend(v7, "setDeclarationType:", CFSTR("com.apple.asset.data"));
  if (v5)
  {
...
+ (id)supportedOS
{
  ...
  v28[0] = &unk_251629700;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516252F0);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v27[0] = v21;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625308);
  ...
  v29[0] = v19;
  v28[1] = &unk_251629718;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625320);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v26[0] = v18;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625338);
  ...
  v29[1] = v16;
  v28[2] = &unk_251629730;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625350);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v25[0] = v15;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625368);
  ...
  v29[2] = v13;
  v28[3] = &unk_251629748;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625380);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v24[0] = v2;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625398);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v24[1] = v3;
  ...
  v29[3] = v4;
  v28[4] = &unk_251629760;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516253B0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v23[0] = v5;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516253C8);
  ...
  v29[4] = v7;
  v28[5] = &unk_251629778;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516253E0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v22[0] = v8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516253F8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v22[1] = v9;
...
- (BOOL)loadPayloadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelAssetDataDeclaration allowedPayloadKeys](RMModelAssetDataDeclaration, "allowedPayloadKeys");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)serializePayloadWithType:(signed __int16)a3
{
  ...
  -[RMModelAssetDataDeclaration payloadReference](self, "payloadReference");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = MEMORY[0x24BDAC760];
  v13[0] = MEMORY[0x24BDAC760];
  v13[1] = 3221225472;
  v13[2] = __56__RMModelAssetDataDeclaration_serializePayloadWithType___block_invoke;
  ...
  -[RMModelAssetDataDeclaration payloadAuthentication](self, "payloadAuthentication");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = v7;
  v11[1] = 3221225472;
  v11[2] = __56__RMModelAssetDataDeclaration_serializePayloadWithType___block_invoke_2;
