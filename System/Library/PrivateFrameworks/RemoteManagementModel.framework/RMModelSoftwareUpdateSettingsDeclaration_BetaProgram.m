...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelSoftwareUpdateSettingsDeclaration_BetaProgram allowedPayloadKeys](RMModelSoftwareUpdateSettingsDeclaration_BetaProgram, "allowedPayloadKeys");
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  -[RMModelSoftwareUpdateSettingsDeclaration_BetaProgram payloadDescription](self, "payloadDescription");
  ...
  -[RMModelSoftwareUpdateSettingsDeclaration_BetaProgram payloadToken](self, "payloadToken");
