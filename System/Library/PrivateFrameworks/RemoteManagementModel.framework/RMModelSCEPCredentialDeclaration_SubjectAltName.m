...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelSCEPCredentialDeclaration_SubjectAltName allowedPayloadKeys](RMModelSCEPCredentialDeclaration_SubjectAltName, "allowedPayloadKeys");
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  -[RMModelSCEPCredentialDeclaration_SubjectAltName payloadRfc822Name](self, "payloadRfc822Name");
  ...
  -[RMModelSCEPCredentialDeclaration_SubjectAltName payloadDNSName](self, "payloadDNSName");
  ...
  -[RMModelSCEPCredentialDeclaration_SubjectAltName payloadUniformResourceIdentifier](self, "payloadUniformResourceIdentifier");
  ...
  -[RMModelSCEPCredentialDeclaration_SubjectAltName payloadNtPrincipalName](self, "payloadNtPrincipalName");
