...
{
  return (NSString *)CFSTR("com.apple.asset.credential.identity");
}
...
+ (id)buildWithIdentifier:(id)a3 reference:(id)a4 authentication:(id)a5 accessible:(id)a6
{
  ...
  objc_msgSend(v13, "setDeclarationType:", CFSTR("com.apple.asset.credential.identity"));
  if (v9)
  {
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3 reference:(id)a4
{
  ...
  objc_msgSend(v7, "setDeclarationType:", CFSTR("com.apple.asset.credential.identity"));
  if (v5)
  {
...
+ (id)supportedOS
{
  ...
  v28[0] = &unk_251629550;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624F90);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v27[0] = v21;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624FA8);
  ...
  v29[0] = v19;
  v28[1] = &unk_251629568;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624FC0);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v26[0] = v18;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624FD8);
  ...
  v29[1] = v16;
  v28[2] = &unk_251629580;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624FF0);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v25[0] = v15;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625008);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v25[1] = v14;
  ...
  v29[2] = v13;
  v28[3] = &unk_251629598;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625020);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v24[0] = v2;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625038);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v24[1] = v3;
  ...
  v29[3] = v4;
  v28[4] = &unk_2516295B0;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625050);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v23[0] = v5;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625068);
  ...
  v29[4] = v7;
  v28[5] = &unk_2516295C8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625080);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v22[0] = v8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251625098);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v22[1] = v9;
...
- (BOOL)loadPayloadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelAssetCredentialIdentityDeclaration allowedPayloadKeys](RMModelAssetCredentialIdentityDeclaration, "allowedPayloadKeys");
...
- (id)serializePayloadWithType:(signed __int16)a3
{
  ...
  -[RMModelAssetCredentialIdentityDeclaration payloadReference](self, "payloadReference");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = MEMORY[0x24BDAC760];
  v14[0] = MEMORY[0x24BDAC760];
  v14[1] = 3221225472;
  v14[2] = __70__RMModelAssetCredentialIdentityDeclaration_serializePayloadWithType___block_invoke;
  ...
  -[RMModelAssetCredentialIdentityDeclaration payloadAuthentication](self, "payloadAuthentication");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v7;
  v12[1] = 3221225472;
  v12[2] = __70__RMModelAssetCredentialIdentityDeclaration_serializePayloadWithType___block_invoke_2;
  ...
  -[RMModelAssetCredentialIdentityDeclaration payloadAccessible](self, "payloadAccessible");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
