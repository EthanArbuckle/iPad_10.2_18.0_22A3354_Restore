...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelAccountMailDeclaration_SMIMEEncryption allowedPayloadKeys](RMModelAccountMailDeclaration_SMIMEEncryption, "allowedPayloadKeys");
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  v4 = (void *)objc_opt_new();
  -[RMModelAccountMailDeclaration_SMIMEEncryption payloadEnabled](self, "payloadEnabled");
  ...
  -[RMModelAccountMailDeclaration_SMIMEEncryption payloadIdentityAssetReference](self, "payloadIdentityAssetReference");
  ...
  -[RMModelAccountMailDeclaration_SMIMEEncryption payloadUserOverrideable](self, "payloadUserOverrideable");
  ...
  -[RMModelAccountMailDeclaration_SMIMEEncryption payloadIdentityUserOverrideable](self, "payloadIdentityUserOverrideable");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelAccountMailDeclaration_SMIMEEncryption payloadPerMessageSwitchEnabled](self, "payloadPerMessageSwitchEnabled");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
