...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelAccountExchangeDeclaration_SMIME allowedPayloadKeys](RMModelAccountExchangeDeclaration_SMIME, "allowedPayloadKeys");
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  -[RMModelAccountExchangeDeclaration_SMIME payloadSigning](self, "payloadSigning");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = MEMORY[0x24BDAC760];
  v13[0] = MEMORY[0x24BDAC760];
  v13[1] = 3221225472;
  v13[2] = __61__RMModelAccountExchangeDeclaration_SMIME_serializeWithType___block_invoke;
  ...
  -[RMModelAccountExchangeDeclaration_SMIME payloadEncryption](self, "payloadEncryption");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = v7;
  v11[1] = 3221225472;
  v11[2] = __61__RMModelAccountExchangeDeclaration_SMIME_serializeWithType___block_invoke_2;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[RMModelAccountExchangeDeclaration_SMIMESigning copy](self->_payloadSigning, "copy");
  v6 = (void *)v4[2];
  v4[2] = v5;

  v7 = -[RMModelAccountExchangeDeclaration_SMIMEEncryption copy](self->_payloadEncryption, "copy");
  v8 = (void *)v4[3];
  v4[3] = v7;
