...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelAccountExchangeDeclaration_SMIMESigning allowedPayloadKeys](RMModelAccountExchangeDeclaration_SMIMESigning, "allowedPayloadKeys");
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  v4 = (void *)objc_opt_new();
  -[RMModelAccountExchangeDeclaration_SMIMESigning payloadEnabled](self, "payloadEnabled");
  ...
  -[RMModelAccountExchangeDeclaration_SMIMESigning payloadIdentityAssetReference](self, "payloadIdentityAssetReference");
  ...
  -[RMModelAccountExchangeDeclaration_SMIMESigning payloadUserOverrideable](self, "payloadUserOverrideable");
  ...
  -[RMModelAccountExchangeDeclaration_SMIMESigning payloadIdentityUserOverrideable](self, "payloadIdentityUserOverrideable");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
