...
+ (id)assetTypes
{
  return (id)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624390);
}
...
- (id)assetReferences
{
  ...
  return -[RMModelConfigurationBase assetReferencesFromKeyPaths:payloadObject:](self, "assetReferencesFromKeyPaths:payloadObject:", assetReferences_assetPaths_0, self);
}
...
void __51__RMModelAccountCardDAVDeclaration_assetReferences__block_invoke()
{
  ...
  v0 = -[RMModelConfigurationSchemaAssetReference initWithAssetTypes:keyPath:]([RMModelConfigurationSchemaAssetReference alloc], "initWithAssetTypes:keyPath:", &unk_2516243A8, CFSTR("$.payloadAuthenticationCredentialsAssetReference"));
  v3[0] = v0;
...
+ (id)buildWithIdentifier:(id)a3 visibleName:(id)a4 hostName:(id)a5 port:(id)a6 path:(id)a7 authenticationCredentialsAssetReference:(id)a8
{
  ...
  objc_msgSend(v19, "setDeclarationType:", CFSTR("com.apple.configuration.account.carddav"));
  if (v13)
  {
...
+ (id)supportedOS
{
  ...
  v20[0] = &unk_251628FB0;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516243C0);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v19[0] = v15;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516243D8);
  ...
  v21[0] = v13;
  v20[1] = &unk_251628FF8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_2516243F0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v18[0] = v2;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624408);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v18[1] = v3;
  ...
  v21[1] = v4;
  v20[2] = &unk_251628FC8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624420);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v17[0] = v5;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624438);
  ...
  v21[2] = v7;
  v20[3] = &unk_251629010;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624450);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v16[0] = v8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251624468);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v16[1] = v9;
...
- (BOOL)loadPayloadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelAccountCardDAVDeclaration allowedPayloadKeys](RMModelAccountCardDAVDeclaration, "allowedPayloadKeys");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)serializePayloadWithType:(signed __int16)a3
{
  ...
  -[RMModelAccountCardDAVDeclaration payloadVisibleName](self, "payloadVisibleName");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelAccountCardDAVDeclaration payloadHostName](self, "payloadHostName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelAccountCardDAVDeclaration payloadPort](self, "payloadPort");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelAccountCardDAVDeclaration payloadPath](self, "payloadPath");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelAccountCardDAVDeclaration payloadAuthenticationCredentialsAssetReference](self, "payloadAuthenticationCredentialsAssetReference");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
