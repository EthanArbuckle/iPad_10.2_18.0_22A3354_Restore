...
+ (id)statusItemType
{
  return CFSTR("account.list.mail.incoming");
}
...
+ (id)buildWithIdentifier:(id)a3 removed:(id)a4 declarationIdentifier:(id)a5 visibleName:(id)a6 hostname:(id)a7 port:(id)a8 username:(id)a9 isMailEnabled:(id)a10 areNotesEnabled:(id)a11
{
  ...
  objc_msgSend(v25, "setStatusIsMailEnabled:", v17);
...
+ (id)supportedOS
{
  ...
  v20[0] = &unk_25162A4F8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626BB0);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v19[0] = v15;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626BC8);
  ...
  v21[0] = v13;
  v20[1] = &unk_25162A540;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626BE0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v18[0] = v2;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626BF8);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v18[1] = v3;
  ...
  v21[1] = v4;
  v20[2] = &unk_25162A510;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626C10);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v17[0] = v5;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626C28);
  ...
  v21[2] = v7;
  v20[3] = &unk_25162A558;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626C40);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v16[0] = v8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626C58);
...
- (BOOL)loadPayloadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelStatusAccountListMailIncoming allowedStatusKeys](RMModelStatusAccountListMailIncoming, "allowedStatusKeys");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)serializePayloadWithType:(signed __int16)a3
{
  ...
  v4 = (void *)objc_opt_new();
  -[RMModelStatusAccountListMailIncoming statusIdentifier](self, "statusIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListMailIncoming statusRemoved](self, "statusRemoved");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListMailIncoming statusDeclarationIdentifier](self, "statusDeclarationIdentifier");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListMailIncoming statusVisibleName](self, "statusVisibleName");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListMailIncoming statusHostname](self, "statusHostname");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListMailIncoming statusPort](self, "statusPort");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListMailIncoming statusUsername](self, "statusUsername");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListMailIncoming statusIsMailEnabled](self, "statusIsMailEnabled");
  ...
  -[RMModelStatusAccountListMailIncoming statusAreNotesEnabled](self, "statusAreNotesEnabled");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
