...
+ (NSSet)allowedStatusKeys
{
  ...
  v6[4] = CFSTR("calendar-url");
  v6[5] = CFSTR("username");
  v6[6] = CFSTR("is-enabled");
...
+ (id)statusItemType
{
  return CFSTR("account.list.subscribed-calendar");
}
...
+ (id)buildWithIdentifier:(id)a3 removed:(id)a4 declarationIdentifier:(id)a5 visibleName:(id)a6 calendarUrl:(id)a7 username:(id)a8 isEnabled:(id)a9
{
  ...
  objc_msgSend(v22, "setStatusCalendarUrl:", v17);
  objc_msgSend(v22, "setStatusUsername:", v16);

  objc_msgSend(v22, "setStatusIsEnabled:", v15);
  return v22;
}
...
+ (id)supportedOS
{
  ...
  v20[0] = &unk_25162A5E8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626D30);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v19[0] = v15;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626D48);
  ...
  v21[0] = v13;
  v20[1] = &unk_25162A630;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626D60);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v18[0] = v2;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626D78);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v18[1] = v3;
  ...
  v21[1] = v4;
  v20[2] = &unk_25162A600;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626D90);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v17[0] = v5;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626DA8);
  ...
  v21[2] = v7;
  v20[3] = &unk_25162A648;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626DC0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v16[0] = v8;
  objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_251626DD8);
...
- (BOOL)loadPayloadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  +[RMModelStatusAccountListSubscribedCalendar allowedStatusKeys](RMModelStatusAccountListSubscribedCalendar, "allowedStatusKeys");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[RMModelPayloadBase loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:](self, "loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:", v7, CFSTR("identifier"), CFSTR("statusIdentifier"), 1, 0, a5))
  {
    ...
    if (-[RMModelPayloadBase loadBooleanFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:](self, "loadBooleanFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:", v7, CFSTR("_removed"), CFSTR("statusRemoved"), 0, MEMORY[0x24BDBD1C0], a5))
    {
      ...
      if (-[RMModelPayloadBase loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:](self, "loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:", v7, CFSTR("declaration-identifier"), CFSTR("statusDeclarationIdentifier"), 0, 0, a5))
      {
        ...
        {
          v13 = 0;
          if (-[RMModelPayloadBase loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:](self, "loadStringFromDictionary:usingKey:forKeyPath:isRequired:defaultValue:error:", v7, CFSTR("calendar-url"), CFSTR("statusCalendarUrl"), 0, 0, a5))
          {
            v13 = 0;
...
- (id)serializePayloadWithType:(signed __int16)a3
{
  ...
  v4 = (void *)objc_opt_new();
  -[RMModelStatusAccountListSubscribedCalendar statusIdentifier](self, "statusIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListSubscribedCalendar statusRemoved](self, "statusRemoved");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListSubscribedCalendar statusDeclarationIdentifier](self, "statusDeclarationIdentifier");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListSubscribedCalendar statusVisibleName](self, "statusVisibleName");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[RMModelStatusAccountListSubscribedCalendar statusCalendarUrl](self, "statusCalendarUrl");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[RMModelPayloadBase serializeStringIntoDictionary:usingKey:value:isRequired:defaultValue:](self, "serializeStringIntoDictionary:usingKey:value:isRequired:defaultValue:", v4, CFSTR("calendar-url"), v9, 0, 0);

  -[RMModelStatusAccountListSubscribedCalendar statusUsername](self, "statusUsername");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[RMModelPayloadBase serializeStringIntoDictionary:usingKey:value:isRequired:defaultValue:](self, "serializeStringIntoDictionary:usingKey:value:isRequired:defaultValue:", v4, CFSTR("username"), v10, 0, 0);

  -[RMModelStatusAccountListSubscribedCalendar statusIsEnabled](self, "statusIsEnabled");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[RMModelPayloadBase serializeBooleanIntoDictionary:usingKey:value:isRequired:defaultValue:](self, "serializeBooleanIntoDictionary:usingKey:value:isRequired:defaultValue:", v4, CFSTR("is-enabled"), v11, 0, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v13 = -[NSString copy](self->_statusCalendarUrl, "copy");
  v14 = (void *)v4[6];
  v4[6] = v13;

  v15 = -[NSString copy](self->_statusUsername, "copy");
  v16 = (void *)v4[7];
  v4[7] = v15;

  v17 = -[NSNumber copy](self->_statusIsEnabled, "copy");
  v18 = (void *)v4[8];
  v4[8] = v17;
