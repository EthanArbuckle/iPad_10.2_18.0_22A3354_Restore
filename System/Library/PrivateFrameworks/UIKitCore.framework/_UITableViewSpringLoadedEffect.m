...
{
  _UITableViewSpringLoadedEffect *v2;
  void *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)_UITableViewSpringLoadedEffect;
  v2 = -[_UITableViewSpringLoadedEffect init](&v5, sel_init);
  if (v2)
  {
    +[UISpringLoadedInteraction _blinkEffect](UISpringLoadedInteraction, "_blinkEffect");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    -[_UITableViewSpringLoadedEffect setBlinkEffect:](v2, "setBlinkEffect:", v3);
...
- (void)interaction:(id)a3 didChangeWithContext:(id)a4
{
  ...
  if (v25 == 1)
  {
    ...
    if (v23)
      goto LABEL_29;
    objc_msgSend(v8, "_highlightSpringLoadedRowAtIndexPath:", v9);
LABEL_28:
    -[_UITableViewSpringLoadedEffect blinkEffect](self, "blinkEffect");
  ...
  if (v25)
  {
    -[_UITableViewSpringLoadedEffect stateBlinkTimer](self, "stateBlinkTimer");
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v30, "invalidate");

    -[_UITableViewSpringLoadedEffect setStateBlinkTimer:](self, "setStateBlinkTimer:", 0);
  }
  else
  {
    -[_UITableViewSpringLoadedEffect stateBlinkTimer](self, "stateBlinkTimer");
    ...
    -[_UITableViewSpringLoadedEffect setStateBlinkTimer:](self, "setStateBlinkTimer:", 0);
    objc_msgSend(v8, "_unhighlightSpringLoadedRow");
