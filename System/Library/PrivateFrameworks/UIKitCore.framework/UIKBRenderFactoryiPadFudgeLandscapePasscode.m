...
- (id)_traitsForKey:(id)a3 onKeyplane:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[UIKBRenderFactoryiPadFudge _traitsForKey:onKeyplane:](&v12, sel__traitsForKey_onKeyplane_, v7, v6);
  ...
  if (v9)
  {
    -[UIKBRenderFactoryiPadFudgeLandscapePasscode activeControlKeyTraits](self, "activeControlKeyTraits");
