...
- (void)_commonInit
{
  ...
  v12 = &v11;
  v13 = 0x2050000000;
  v3 = (void *)_MergedGlobals_961;
  v14 = _MergedGlobals_961;
  if (!_MergedGlobals_961)
  {
...
{
  _UIWiFiSignalView *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)_UIWiFiSignalView;
  v4 = -[UIView init](&v6, sel_init);
  -[_UIWiFiSignalView _commonInit](v4, "_commonInit");
  -[_UIWiFiSignalView setSizeCategory:](v4, "setSizeCategory:", a3);
  return v4;
}

- (_UIWiFiSignalView)initWithFrame:(CGRect)a3
{
  _UIWiFiSignalView *v3;
  objc_super v5;
  ...
  -[_UIWiFiSignalView _commonInit](v3, "_commonInit");
  return v3;
}
