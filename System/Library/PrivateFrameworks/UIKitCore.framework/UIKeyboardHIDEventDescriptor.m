...
id __62___UIKeyboardHIDEventDescriptor_appendDescriptionToFormatter___block_invoke(uint64_t a1)
{
  ...
  v9 = (id)objc_msgSend(*(id *)(a1 + 32), "appendUInt64:withName:", *(unsigned __int16 *)(*(_QWORD *)(a1 + 40) + 24), CFSTR("usagePage"));
  return (id)objc_msgSend(*(id *)(a1 + 32), "appendUInt64:withName:", *(unsigned __int16 *)(*(_QWORD *)(a1 + 40) + 32), CFSTR("usage"));
}
