...
- (_EditScriptIndexedAtom)initWithEditOperation:(int64_t)a3 indexToEdit:(unint64_t)a4 newText:(id)a5 indexInArrayB:(unint64_t)a6
{
  ...
  _EditScriptIndexedAtom *v12;
  objc_super v14;

  v10 = a5;
  v14.receiver = self;
  v14.super_class = (Class)_EditScriptIndexedAtom;
  v11 = -[_EditScriptIndexedAtom init](&v14, sel_init);
  v12 = v11;
  if (v11)
  {
    -[_EditScriptIndexedAtom setEditOperation:](v11, "setEditOperation:", a3);
    -[_EditScriptIndexedAtom setIndexToEdit:](v12, "setIndexToEdit:", a4);
    -[_EditScriptIndexedAtom setIndexInArrayB:](v12, "setIndexInArrayB:", a6);
    -[_EditScriptIndexedAtom setReplacementText:](v12, "setReplacementText:", v10);
  }
...
LABEL_6:
  ...
  if (v5 > 2)
    ...
    v6 = off_1E16D5728[v5];
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lu"), self->_indexToEdit);
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("editOpertaion:%@, editIndex:%lu newText:%@ indexInArrayB:%@\n"), v6, self->_indexToEdit, p_isa, v8);
...
{
  id v9;
  _EditScriptIndexedAtom *v10;

  v9 = a5;
  v10 = -[_EditScriptIndexedAtom initWithEditOperation:indexToEdit:newText:indexInArrayB:]([_EditScriptIndexedAtom alloc], "initWithEditOperation:indexToEdit:newText:indexInArrayB:", a3, a4, v9, a6);
