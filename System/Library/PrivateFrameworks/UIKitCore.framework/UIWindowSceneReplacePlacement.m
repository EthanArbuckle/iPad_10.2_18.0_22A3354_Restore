...
{
  return objc_msgSend(*(id *)(a1 + 32), "appendString:withName:", *(_QWORD *)(*(_QWORD *)(a1 + 40) + 8), CFSTR("targetScenePersistentIdentifier"));
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[UIWindowSceneReplacePlacement _targetSceneSessionPersistentIdentifier](self, "_targetSceneSessionPersistentIdentifier");
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  ...
  _QWORD v9[4];
  id v10;
  UIWindowSceneReplacePlacement *v11;
  objc_super v12;
