...
- (_UIFocusMapRect)initWithFrame:(CGRect)a3 coordinateSpace:(id)a4
{
  ...
  v10 = -[_UIFocusMapRect init](&v13, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (BOOL)intersectsRect:(CGRect)a3
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  -[_UIFocusMapRect frame](self, "frame");
  v8 = v7;
  v10 = v9;
  v12 = v11;
  v14 = v13;
...
- (BOOL)intersectsRegion:(id)a3 inSnapshot:(id)a4
{
  ...
  -[_UIFocusMapRect coordinateSpace](self, "coordinateSpace");
  ...
  if ((v11 & 1) == 0)
  {
    ...
    objc_msgSend(v14, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusMapArea.m"), 39, CFSTR("Focus: unable to compare intersecting regions from a snapshot using a different coordinate space than the map area's coordinate space. This is a UIKit bug."));

  }
  objc_msgSend(v8, "snapshotFrameForRegion:", v7);
  v12 = -[_UIFocusMapRect intersectsRect:](self, "intersectsRect:");
...
- (NSString)description
{
  ...
  v6 = -[UIDescriptionBuilder appendName:object:](v3, "appendName:object:", v4, v5);

  NSStringFromSelector(sel_coordinateSpace);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  WeakRetained = objc_loadWeakRetained((id *)&self->_coordinateSpace);
  v9 = -[UIDescriptionBuilder appendName:object:](v3, "appendName:object:", v7, WeakRetained);
