...
- (_UIStatusBarPillView)initWithFrame:(CGRect)a3
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)_UIStatusBarPillView;
  v3 = -[_UIStatusBarRoundedCornerView initWithFrame:](&v13, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = objc_alloc_init(UIVisualEffectView);
  visualEffectView = v3->_visualEffectView;
  v3->_visualEffectView = v4;

  -[UIView setHidden:](v3->_visualEffectView, "setHidden:", 1);
  -[UIView addSubview:](v3, "addSubview:", v3->_visualEffectView);
  v3->_pulsing = 1;
  ...
  +[UIColor colorWithWhite:alpha:](UIColor, "colorWithWhite:alpha:", 0.0980392157, 0.18);
  ...
  -[_UIStatusBarPersistentAnimationView setPersistentAnimations:](v3, "setPersistentAnimations:", v11);
...
- (void)setPillColor:(id)a3
{
  ...
  -[_UIStatusBarPillView _updateBackgroundColor](self, "_updateBackgroundColor");
}
...
- (void)resumePersistentAnimation
{
  ...
  if (self->_pulsing)
  {
    ...
    objc_msgSend(v5, "setToValue:", &unk_1E1A955A0);
...
- (void)layoutSubviews
{
  ...
  -[_UIStatusBarRoundedCornerView layoutSubviews](&v14, sel_layoutSubviews);
...
- (void)setVisualEffect:(id)a3
{
  ...
  if (self->_visualEffect != v5)
  {
    ...
    -[UIView setHidden:](self->_visualEffectView, "setHidden:", v5 == 0);
  }
...
- (void)setPulsing:(BOOL)a3
{
  if (self->_pulsing != a3)
  {
    self->_pulsing = a3;
    if (a3)
      -[_UIStatusBarPillView resumePersistentAnimation](self, "resumePersistentAnimation");
    else
...
- (void)_updateBackgroundColor
{
  ...
  {
LABEL_5:
    -[_UIStatusBarPillView pillColor](self, "pillColor");
