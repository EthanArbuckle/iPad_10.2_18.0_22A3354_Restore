...
- (_UIDebugIssueReportFormatter)init
{
  ...
  _UIDebugIssueReportFormatter *v3;
  NSString *header;
  NSString *footer;
  ...
  v2 = -[_UIDebugReportFormatter init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    header = v2->_header;
    ...
    v3->_noIssuesDescription = (NSString *)&stru_1E16EDF20;
...
- (id)_componentsFromReport:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIDebugIssueReport.m"), 129, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("report"));
  ...
  if (v7)
  {
    ...
    v21[1] = v21;
    v21[2] = 0x3032000000;
    v21[3] = __Block_byref_object_copy__87;
    v21[4] = __Block_byref_object_dispose__87;
    v22 = 0;
    objc_msgSend(v5, "issues");
    ...
    -[_UIDebugIssueReportFormatter header](self, "header");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[_UIDebugReportComponents setHeader:](v11, "setHeader:", v12);

    -[_UIDebugIssueReportFormatter footer](self, "footer");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[_UIDebugReportComponents setFooter:](v11, "setFooter:", v13);

    -[_UIDebugReportComponents setBody:](v11, "setBody:", v10);
  ...
  {
    v11 = objc_alloc_init(_UIDebugReportComponents);
    -[_UIDebugIssueReportFormatter noIssuesDescription](self, "noIssuesDescription");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[_UIDebugReportComponents setBody:](v11, "setBody:", v14);
...
- (id)stringFromReport:(id)a3
{
  ...
  -[_UIDebugIssueReportFormatter _componentsFromReport:](self, "_componentsFromReport:", a3);
