...
{
  return -[_UIAlertControllerVisualStyleAlertTVCustomCurveFactory initWithCustomCurve:](self, "initWithCustomCurve:", 0);
}

- (_UIAlertControllerVisualStyleAlertTVCustomCurveFactory)initWithCustomCurve:(unint64_t)a3
{
  _UIAlertControllerVisualStyleAlertTVCustomCurveFactory *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)_UIAlertControllerVisualStyleAlertTVCustomCurveFactory;
  result = -[_UIAlertControllerVisualStyleAlertTVCustomCurveFactory init](&v5, sel_init);
  if (result)
    result->_curve = a3;
  return result;
}
...
- (id)_timingFunctionForAnimationInView:(id)a3 withKeyPath:(id)a4
{
  ...
  v4 = -[_UIAlertControllerVisualStyleAlertTVCustomCurveFactory curve](self, "curve", a3, a4);
  if (v4 == 1)
  {
