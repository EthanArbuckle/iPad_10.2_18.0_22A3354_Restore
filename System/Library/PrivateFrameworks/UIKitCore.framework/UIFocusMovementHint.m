...
- (UIFocusMovementHint)initWithMovementDirection:(CGVector)a3 itemSize:(CGSize)a4
{
  ...
  result = -[UIFocusMovementHint init](&v18, sel_init);
  if (result)
  {
    ...
    {
      v17 = (float64x2_t)xmmword_18667C650;
    }
    else
    {
      if (height <= width)
      ...
      if (v11 < 0.0)
        v11 = 0.0;
      v12 = vmulq_n_f64((float64x2_t)xmmword_18667C660, fmin(v11, 1.0));
      ...
      *(_QWORD *)&_Q1.f64[0] = *(_OWORD *)&vaddq_f64(v12, _Q1);
      ...
      v17 = vminnmq_f64((float64x2_t)vbslq_s8((int8x16_t)vcgtq_f64((float64x2_t)xmmword_18667C670, _Q1), (int8x16_t)xmmword_18667C670, (int8x16_t)_Q1), (float64x2_t)xmmword_18667C680);
    }
...
- (CATransform3D)interactionTransform
{
  ...
  *(_OWORD *)&retstr->m23 = v36;
  -[UIFocusMovementHint rotation](self, "rotation");
  v7 = v6;
  v9 = v8;
  -[UIFocusMovementHint translation](self, "translation");
  v11 = v10;
  v13 = v12;
  *(_OWORD *)&v44.m31 = v41;
  *(_OWORD *)&v44.m33 = v42;
  ...
  *(_OWORD *)&retstr->m23 = v33;
  result = -[UIFocusMovementHint perspectiveTransform](self, "perspectiveTransform");
  retstr->m34 = v43;
  return result;
}
