...
- (void)configureSensorViewWithoutPortalIfNeededForTargetScreen:(id)a3
{
  ...
  +[_UIStatusBar sensorActivityIndicatorForScreen:](_UIStatusBar, "sensorActivityIndicatorForScreen:", a3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[_UIStatusBarSensorActivityView sensorActivityView](self, "sensorActivityView");
  ...
  if (v4)
  {
    ...
    -[_UIStatusBarSensorActivityView setSensorActivityView:](self, "setSensorActivityView:", v4);
    -[_UIStatusBarSensorActivityView sensorActivityView](self, "sensorActivityView");
  ...
  else
  {
    ...
    if (v6)
    {
      ...
      -[_UIStatusBarSensorActivityView setSensorActivityView:](self, "setSensorActivityView:", 0);
    }
  }
...
- (void)layoutSubviews
{
  ...
  {
    v15 = (void *)v3;
    +[_UIStatusBar sensorActivityIndicatorForScreen:](_UIStatusBar, "sensorActivityIndicatorForScreen:", v3);
...
- (void)configurePortalViewIfNeededForTargetScreen:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      v7 = -[_UIPortalView initWithSourceView:]([_UIPortalView alloc], "initWithSourceView:", v4);
      v8 = self->_portalView;
      self->_portalView = v7;

      -[_UIPortalView setName:](self->_portalView, "setName:", CFSTR("_UIStatusBarSensorActivityView.portal"));
      -[_UIPortalView setMatchesAlpha:](self->_portalView, "setMatchesAlpha:", 0);
      -[UIView addSubview:](self, "addSubview:", self->_portalView);
    }
...
- (void)applyStyleAttributes:(id)a3
{
  ...
  -[_UIStatusBarSensorActivityView setIconSize:](self, "setIconSize:", v4);
  if (self->_portalView)
    v6 = iconSize == v4;
  else
    v6 = 1;
...
- (CGSize)intrinsicContentSize
{
  ...
  if (self->_portalView)
  {
    +[_UIStatusBarBatteryView _statusBarIntrinsicContentSizeForIconSize:](_UIStatusBarBatteryView, "_statusBarIntrinsicContentSizeForIconSize:", self->_iconSize);
    v3 = 7.0;
  }
  else
  {
