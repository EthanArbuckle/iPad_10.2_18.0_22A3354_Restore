...
- (BOOL)cacheMatchesCapacity:(double)a3 fillColor:(id)a4 tintColor:(id)a5 showingBolt:(BOOL)a6 reverseLayout:(BOOL)a7 scale:(double)a8 showsPercentage:(BOOL)a9 contentSizeCategory:(id)a10
{
  ...
  v19 = a5;
  v20 = a10;
  -[_UIStatusBarBatteryViewAXHUDImageCacheInfo capacity](self, "capacity");
  if (v21 == a3)
  {
    -[_UIStatusBarBatteryViewAXHUDImageCacheInfo fillColor](self, "fillColor");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v22, "isEqual:", v18))
    {
      -[_UIStatusBarBatteryViewAXHUDImageCacheInfo tintColor](self, "tintColor");
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v23, "isEqual:", v19)
        && -[_UIStatusBarBatteryViewAXHUDImageCacheInfo showBolt](self, "showBolt") == v14
        && -[_UIStatusBarBatteryViewAXHUDImageCacheInfo reverseLayoutDirection](self, "reverseLayoutDirection") == v13
        && (-[_UIStatusBarBatteryViewAXHUDImageCacheInfo scale](self, "scale"), v24 == a8)
        && -[_UIStatusBarBatteryViewAXHUDImageCacheInfo showsPercentage](self, "showsPercentage") == v11)
      {
        -[_UIStatusBarBatteryViewAXHUDImageCacheInfo contentSizeCategory](self, "contentSizeCategory");
