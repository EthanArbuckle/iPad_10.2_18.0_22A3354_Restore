...
- (_UIDebugIssueReport)init
{
  ...
  v2 = -[_UIDebugIssueReport init](&v6, sel_init);
  if (v2)
  {
...
- (void)addIssue:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIDebugIssueReport.m"), 91, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("issue"));
