...
{
  _UIFocusMovementInfo *result;
  CGSize v3;
  objc_super v4;

  v4.receiver = self;
  v4.super_class = (Class)_UIFocusMovementInfo;
  result = -[_UIFocusMovementInfo init](&v4, sel_init);
  if (result)
  {
    result->_heading = 0;
    ...
    *(_DWORD *)&result->_looping = 65792;
    ...
    result->_fallbackMovementOriginatingFrame.origin = (CGPoint)*MEMORY[0x1E0C9D628];
...
- (_UIFocusMovementInfo)initWithHeading:(unint64_t)a3 velocity:(CGVector)a4 isInitial:(BOOL)a5 shouldLoadScrollableContainer:(BOOL)a6 groupFilter:(int64_t)a7 inputType:(unint64_t)a8
{
  ...
  dy = a4.dy;
  dx = a4.dx;
  result = -[_UIFocusMovementInfo init](self, "init");
  if (result)
  {
    if (!a3)
    {
...
{
  _UIFocusMovementInfo *v15;
  _UIFocusMovementInfo *v16;
  CGFloat v17;

  v15 = -[_UIFocusMovementInfo init](self, "init");
  v16 = v15;
  if (v15)
  {
    v15->_heading = a3;
...
{
  return -[_UIFocusMovementInfo initWithHeading:linearHeading:isInitial:shouldLoadScrollableContainer:looping:groupFilter:inputType:](self, "initWithHeading:linearHeading:isInitial:shouldLoadScrollableContainer:looping:groupFilter:inputType:", a3, a4, a5, a6, a7, a8, 5);
}
...
- (NSString)description
{
  ...
  _UIStringFromFocusHeading(-[_UIFocusMovementInfo heading](self, "heading"));
...
{
  return self->_linearHeading || (-[_UIFocusMovementInfo heading](self, "heading") & 0x330) != 0;
}
...
- (_UIFocusMovementInfo)initWithXPCDictionary:(id)a3
{
  ...
  v5 = -[_UIFocusMovementInfo init](&v11, sel_init);
  if (v5)
  {
...
- (_UIFocusMovementInfo)initWithCoder:(id)a3
{
  ...
  v5 = -[_UIFocusMovementInfo init](&v13, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = a3;
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo heading](self, "heading"), CFSTR("FocusMovementHeadingKey"));
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo _linearHeading](self, "_linearHeading"), CFSTR("FocusMovementLinearHeadingKey"));
  -[_UIFocusMovementInfo _velocity](self, "_velocity");
  ...
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _isVelocityBased](self, "_isVelocityBased"), CFSTR("FocusMovementIsVelocityBasedKey"));
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _isInitialMovement](self, "_isInitialMovement"), CFSTR("FocusMovementIsInitialMovementKey"));
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _shouldLoadScrollableContainer](self, "_shouldLoadScrollableContainer"), CFSTR("FocusMovementShouldLoadScrollableContainerKey"));
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _isLooping](self, "_isLooping"), CFSTR("FocusMovementLoopingKey"));
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo _groupFilter](self, "_groupFilter"), CFSTR("FocusMovementGroupFilterKey"));
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo _inputType](self, "_inputType"), CFSTR("FocusMovementInputTypeKey"));
  -[_UIFocusMovementInfo _fallbackMovementOriginatingFrame](self, "_fallbackMovementOriginatingFrame");
