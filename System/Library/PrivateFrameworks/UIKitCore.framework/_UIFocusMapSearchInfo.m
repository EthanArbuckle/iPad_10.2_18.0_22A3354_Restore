...
- (_UIFocusMapSearchInfo)init
{
  ...
  v2 = -[_UIFocusMapSearchInfo init](&v8, sel_init);
  if (v2)
  {
...
- (NSArray)snapshots
{
  ...
  -[_UIFocusMapSearchInfo mutableSnapshots](self, "mutableSnapshots");
...
- (NSArray)destinationRegions
{
  ...
  -[_UIFocusMapSearchInfo mutableDestinationRegions](self, "mutableDestinationRegions");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = (void *)objc_msgSend(v2, "copy");
