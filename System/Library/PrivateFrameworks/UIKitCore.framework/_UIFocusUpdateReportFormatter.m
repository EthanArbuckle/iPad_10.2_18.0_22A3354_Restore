...
- (id)_componentsFromReport:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusUpdateReport.m"), 67, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("report"));

  }
  v6 = objc_alloc_init(_UIDebugReportComponents);
  -[_UIFocusUpdateReportFormatter _headerForReport:](self, "_headerForReport:", v5);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[_UIDebugReportComponents setHeader:](v6, "setHeader:", v7);

  -[_UIFocusUpdateReportFormatter _bodyForReport:](self, "_bodyForReport:", v5);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[_UIDebugReportComponents setBody:](v6, "setBody:", v8);
...
- (id)stringFromReport:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusUpdateReport.m"), 78, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("report"));

  }
  -[_UIFocusUpdateReportFormatter _componentsFromReport:](self, "_componentsFromReport:", v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[_UIDebugReportFormatter stringFromReportComponents:](self, "stringFromReportComponents:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_bodyForReport:(id)a3
{
  ...
  if ((v11 & 1) == 0)
  {
    ...
    if (v13)
    {
      +[_UIDebugReportFormatter defaultFormatter](_UIDebugIssueReportFormatter, "defaultFormatter");
