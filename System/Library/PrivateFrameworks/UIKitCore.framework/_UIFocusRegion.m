...
- (_UIFocusRegion)initWithFrame:(CGRect)a3 coordinateSpace:(id)a4
{
  ...
  if (!v11)
  {
    ...
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusRegion.m"), 232, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("coordinateSpace"));

  }
  v16.receiver = self;
  v16.super_class = (Class)_UIFocusRegion;
  v12 = -[_UIFocusRegion init](&v16, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (id)_focusRegionWithAdjustedFrame:(CGRect)a3 coordinateSpace:(id)a4
{
  ...
  if (CGRectIsEmpty(v15))
  {
    ...
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusRegion.m"), 244, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("!CGRectIsEmpty(frame)"));
...
LABEL_5:
    ...
    objc_msgSend(v14, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusRegion.m"), 245, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("coordinateSpace"));
...
- (id)_descriptionBuilder
{
  ...
  -[_UIFocusRegion regionFrame](self, "regionFrame");
  NSStringFromCGRect(v11);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (id)objc_msgSend(v3, "appendName:object:", CFSTR("frame"), v4);

  -[_UIFocusRegion regionCoordinateSpace](self, "regionCoordinateSpace");
  ...
  if (v6)
  {
    ...
    v8 = (id)objc_msgSend(v3, "appendName:object:usingLightweightDescription:", CFSTR("coordinateSpace"), v7, 1);

  }
  else
  {
    v9 = (id)objc_msgSend(v3, "appendName:object:", CFSTR("coordinateSpace"), CFSTR("global"));
  }
  return v3;
}
...
- (id)description
{
  ...
  -[_UIFocusRegion _descriptionBuilder](self, "_descriptionBuilder");
...
- (BOOL)isEqual:(id)a3
{
  ...
  UICoordinateSpace *v7;
  UICoordinateSpace *v8;
  UICoordinateSpace *v9;
  int v10;
  BOOL v11;
  ...
  {
    if (-[_UIFocusRegion isMemberOfClass:](self, "isMemberOfClass:", objc_opt_class()))
    {
      v5 = v4;
...
LABEL_13:
        ...
        v10 = -[UICoordinateSpace isEqual:](v7, "isEqual:", v8);
...
- (unint64_t)hash
{
  ...
  v3 = -[UICoordinateSpace hash](self->_regionCoordinateSpace, "hash");
  v4 = vorrq_s8(vandq_s8((int8x16_t)vcvtq_u64_f64((float64x2_t)self->_regionFrame.origin), (int8x16_t)xmmword_18667C920), vandq_s8((int8x16_t)vcvtq_u64_f64((float64x2_t)self->_regionFrame.size), (int8x16_t)xmmword_18667C910));
...
{
  return _UIEffectiveFocusRegionBoundariesForHeading(-[_UIFocusRegion _focusableBoundaries](self, "_focusableBoundaries"), a3);
}
...
- (unint64_t)_effectiveBoundariesBlockingFocusMovementRequest:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_UIFocusRegion _boundariesBlockingFocusMovementRequest:](self, "_boundariesBlockingFocusMovementRequest:", v4);
