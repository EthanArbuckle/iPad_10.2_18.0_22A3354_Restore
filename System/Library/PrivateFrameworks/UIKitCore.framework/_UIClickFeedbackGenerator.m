...
- (_UIClickFeedbackGenerator)initWithView:(id)a3
{
  ...
  v4 = a3;
  +[_UIClickFeedbackGeneratorConfiguration defaultConfiguration](_UIClickFeedbackGeneratorConfiguration, "defaultConfiguration");
...
- (void)pressedDownAtLocation:(CGPoint)a3
{
  ...
  -[_UIClickFeedbackGenerator _clickConfiguration](self, "_clickConfiguration");
  v7 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "clickDownPattern");
...
- (void)pressedDown
{
  -[_UIClickFeedbackGenerator pressedDownAtLocation:](self, "pressedDownAtLocation:", 1.79769313e308, 1.79769313e308);
}
...
- (void)pressedUpAtLocation:(CGPoint)a3
{
  ...
  -[_UIClickFeedbackGenerator _clickConfiguration](self, "_clickConfiguration");
  v7 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "clickUpPattern");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[UIFeedbackGenerator _playFeedback:atLocation:](self, "_playFeedback:atLocation:", v6, x, y);
...
- (void)pressedUp
{
  -[_UIClickFeedbackGenerator pressedUpAtLocation:](self, "pressedUpAtLocation:", 1.79769313e308, 1.79769313e308);
}
...
{
  -[_UIClickFeedbackGenerator userInteractionStartedAtLocation:](self, "userInteractionStartedAtLocation:", 1.79769313e308, 1.79769313e308);
}
...
- (void)userInteractionEndedAtLocation:(CGPoint)a3
{
  ...
  {
    v7 = userInteractionEndedAtLocation____s_category;
    if (!userInteractionEndedAtLocation____s_category)
    {
      v7 = __UILogCategoryGetNode("Assert", (uint64_t)&g_UILogCategories, (uint64_t (*)(_BYTE *))__UILogCategoryNewNode)- 16;
      atomic_store(v7, (unint64_t *)&userInteractionEndedAtLocation____s_category);
    }
    v8 = *(NSObject **)(v7 + 8);
...
{
  -[_UIClickFeedbackGenerator userInteractionEndedAtLocation:](self, "userInteractionEndedAtLocation:", 1.79769313e308, 1.79769313e308);
}
...
- (void)userInteractionCancelledAtLocation:(CGPoint)a3
{
  ...
  {
    v7 = userInteractionCancelledAtLocation____s_category;
    if (!userInteractionCancelledAtLocation____s_category)
    {
      v7 = __UILogCategoryGetNode("Assert", (uint64_t)&g_UILogCategories, (uint64_t (*)(_BYTE *))__UILogCategoryNewNode)- 16;
      atomic_store(v7, (unint64_t *)&userInteractionCancelledAtLocation____s_category);
    }
    v8 = *(NSObject **)(v7 + 8);
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
...
{
  -[_UIClickFeedbackGenerator userInteractionCancelledAtLocation:](self, "userInteractionCancelledAtLocation:", 1.79769313e308, 1.79769313e308);
}
