...
{
  _UIDebugLogStatement *v2;
  _UIDebugLogStatement *v3;
  NSString *prefix;
  NSString *text;
  objc_super v7;
  ...
  v2 = -[_UIDebugLogStatement init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    prefix = v2->_prefix;
    v2->_prefix = (NSString *)&stru_1E16EDF20;

    text = v3->_text;
    v3->_text = (NSString *)&stru_1E16EDF20;
