  ...
  if ((objc_msgSend(v5, "isPreferredByItself") & 1) == 0)
  {
    ...
    if (v41)
    {
      ...
      if (v27)
      {
        ...
        +[_UIDebugLogMessage messageWithStyle:string:](_UIDebugLogMessage, "messageWithStyle:string:", 2, v33);
      ...
      else
      {
        ...
        +[_UIDebugLogMessage messageWithStyle:string:](_UIDebugLogMessage, "messageWithStyle:string:", 2, v36);
