...
- (void)_gestureRecognizerDriver:(id)a3 didUpdateState:(int64_t)a4 previousState:(int64_t)a5
{
  ...
  uint64_t v7;
  unint64_t v8;
  uint64_t (*stateCombiner)(uint64_t, uint64_t);
  void *v10;

  -[NSArray objectAtIndexedSubscript:](self->_drivers, "objectAtIndexedSubscript:", 0, a4, a5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_msgSend(v6, "state");

  if (-[NSArray count](self->_drivers, "count") >= 2)
  {
    v8 = 1;
    do
    {
      stateCombiner = (uint64_t (*)(uint64_t, uint64_t))self->_stateCombiner;
      -[NSArray objectAtIndexedSubscript:](self->_drivers, "objectAtIndexedSubscript:", v8);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v7 = stateCombiner(v7, objc_msgSend(v10, "state"));

      ++v8;
    }
    while (v8 < -[NSArray count](self->_drivers, "count"));
  }
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v10 + 1) + 8 * v9++), "setContext:", a3, (_QWORD)v10);
      }
      while (v7 != v9);
...
- (void)reset
{
  ...
  -[_UIGestureRecognizerDriver reset](&v12, sel_reset);
  v10 = 0u;
  v11 = 0u;
  v8 = 0u;
  v9 = 0u;
...
- (void)fail
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)_UIGestureRecognizerCompositionDriver;
  -[_UIGestureRecognizerDriver fail](&v12, sel_fail);
  v10 = 0u;
  v11 = 0u;
  v8 = 0u;
  v9 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v9 != v6)
          objc_enumerationMutation(v3);
        objc_msgSend(*(id *)(*((_QWORD *)&v8 + 1) + 8 * v7++), "fail", (_QWORD)v8);
      }
      while (v5 != v7);
      v5 = -[NSArray countByEnumeratingWithState:objects:count:](v3, "countByEnumeratingWithState:objects:count:", &v8, v13, 16);
    }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v11 + 1) + 8 * v10++), "touchesBegan:withEvent:", a3, a4, (_QWORD)v11);
      }
      while (v8 != v10);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        objc_msgSend(*(id *)(*((_QWORD *)&v11 + 1) + 8 * v10++), "touchesMoved:withEvent:", a3, a4, (_QWORD)v11);
      }
      while (v8 != v10);
      v8 = -[NSArray countByEnumeratingWithState:objects:count:](v6, "countByEnumeratingWithState:objects:count:", &v11, v15, 16);
    }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        objc_msgSend(*(id *)(*((_QWORD *)&v11 + 1) + 8 * v10++), "touchesEnded:withEvent:", a3, a4, (_QWORD)v11);
      }
      while (v8 != v10);
      v8 = -[NSArray countByEnumeratingWithState:objects:count:](v6, "countByEnumeratingWithState:objects:count:", &v11, v15, 16);
    }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        objc_msgSend(*(id *)(*((_QWORD *)&v11 + 1) + 8 * v10++), "touchesCancelled:withEvent:", a3, a4, (_QWORD)v11);
      }
      while (v8 != v10);
      v8 = -[NSArray countByEnumeratingWithState:objects:count:](v6, "countByEnumeratingWithState:objects:count:", &v11, v15, 16);
    }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v9 + 1) + 8 * v8++), "transformChangedWithEvent:", a3, (_QWORD)v9);
      }
      while (v6 != v8);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v11 != v7)
          objc_enumerationMutation(v4);
        objc_msgSend(*(id *)(*((_QWORD *)&v10 + 1) + 8 * v8++), "shouldReceiveEvent:", a3, (_QWORD)v10);
      }
      while (v6 != v8);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        if (*(_QWORD *)v14 != v10)
          objc_enumerationMutation(v6);
        v9 |= objc_msgSend(*(id *)(*((_QWORD *)&v13 + 1) + 8 * i), "shouldReceiveComponent:withEvent:", a3, a4, (_QWORD)v13);
      }
...
- (NSString)description
{
  ...
  -[_UIGestureRecognizerDriver description](&v15, sel_description);
  ...
  if (objc_msgSend(v4, "length"))
  {
    ...
    objc_msgSend(v4, "appendString:", CFSTR("; children=["));
    v13 = 0u;
    v14 = 0u;
    v11 = 0u;
    v12 = 0u;
