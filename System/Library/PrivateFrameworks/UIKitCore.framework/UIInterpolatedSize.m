@implementation UIInterpolatedSize

+ (id)valueWithCGSize:(CGSize)a3
{
  CGFloat height;
  CGFloat width;
  CGFloat *v5;
...
{
  return vabdd_f64(self->_size.width, *((double *)a3 + 1)) < *((double *)a4 + 1)
      && vabdd_f64(self->_size.height, *((double *)a3 + 2)) < *((double *)a4 + 2);
}
...
- (BOOL)isUndefined
{
  ...
  v3 = fabs(self->_size.width);
  result = 1;
  if (v3 != INFINITY)
    return fabs(self->_size.height) == INFINITY;
  return result;
}

- (id)getValue
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3B18], "valueWithCGSize:", self->_size.width, self->_size.height);
}

+ (id)epsilonCompatibleWithVector:(id)a3
{
  if (qword_1ECD82398 != -1)
    dispatch_once(&qword_1ECD82398, &__block_literal_global_641);
  return (id)_MergedGlobals_1316;
}

void __50__UIInterpolatedSize_epsilonCompatibleWithVector___block_invoke()
{
  void *v0;
  double v1;
  double v2;
  ...
  +[UIInterpolatedSize valueWithCGSize:](UIInterpolatedSize, "valueWithCGSize:", v2, v2);
  v3 = objc_claimAutoreleasedReturnValue();
  v4 = (void *)_MergedGlobals_1316;
  _MergedGlobals_1316 = v3;

}

+ (id)zeroCompatibleWithVector:(id)a3
{
  if (qword_1ECD823A8 != -1)
    dispatch_once(&qword_1ECD823A8, &__block_literal_global_3_26);
  return (id)qword_1ECD823A0;
}

void __47__UIInterpolatedSize_zeroCompatibleWithVector___block_invoke()
{
  uint64_t v0;
  void *v1;

  +[UIInterpolatedSize valueWithCGSize:](UIInterpolatedSize, "valueWithCGSize:", *MEMORY[0x1E0C9D820], *(double *)(MEMORY[0x1E0C9D820] + 8));
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)qword_1ECD823A0;
  qword_1ECD823A0 = v0;
...
{
  +[UIInterpolatedSize valueWithCGSize:](UIInterpolatedSize, "valueWithCGSize:", a3, self->_size.width, self->_size.height);
  return (id)objc_claimAutoreleasedReturnValue();
}

- (void)reinitWithVector:(id)a3
{
  self->_size = *(CGSize *)((char *)a3 + 8);
}
