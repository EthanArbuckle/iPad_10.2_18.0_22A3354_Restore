...
+ (id)objectOfClass:(Class)a3 forCanvas:(id)a4 withOptions:(id)a5 createIfNecessary:(BOOL)a6
{
  ...
  block[4] = v11;
  if (qword_1ECD81FB0 != -1)
    dispatch_once(&qword_1ECD81FB0, block);
  v29 = 0u;
  v30 = 0u;
  v27 = 0u;
  v28 = 0u;
  v12 = (id)qword_1ECD81FA8;
  ...
  if (v13)
  {
    ...
    while (2)
    {
      for (i = 0; i != v13; i = (char *)i + 1)
      {
        ...
        {
          objc_msgSend(v16, "_intendedCanvas");
...
LABEL_18:
  ...
  if (!v13 && v26)
  {
    ...
    if (v20)
    {
      ...
      if ((objc_msgSend((id)qword_1ECD81FB8, "containsObject:", v24) & 1) != 0)
      {
        v13 = 0;
      }
      else
      {
        objc_msgSend((id)qword_1ECD81FB8, "addObject:", v24);
        v13 = (id)objc_msgSend([a3 alloc], "_initWithCanvas:options:", v9, v10);
        objc_msgSend((id)qword_1ECD81FA8, "addObject:", v13);
        objc_msgSend((id)qword_1ECD81FB8, "removeObject:", v24);
      }
...
+ (void)canvasDisconnected:(id)a3
{
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        objc_msgSend(v12, "_intendedCanvas", (_QWORD)v15);
  ...
  objc_msgSend((id)qword_1ECD81FA8, "removeObjectsInArray:", v6);
  objc_sync_exit(v7);
...
+ (void)removeObjectsOfClass:(Class)a3
{
  ...
  objc_msgSend((id)qword_1ECD81FA8, "removeObjectsInArray:", v4);
  objc_sync_exit(v5);
...
+ (void)removeObject:(id)a3
{
  ...
  v4 = a1;
  objc_sync_enter(v4);
  objc_msgSend((id)qword_1ECD81FA8, "removeObject:", v5);
  objc_sync_exit(v4);
