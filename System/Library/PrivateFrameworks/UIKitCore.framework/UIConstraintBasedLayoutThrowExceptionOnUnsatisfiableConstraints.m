...
void ___UIConstraintBasedLayoutThrowExceptionOnUnsatisfiableConstraints_block_invoke()
{
  ...
  byte_1ECD790B7 = 0;
  v0 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x1E0C99EA0], "standardUserDefaults"), "objectForKey:", CFSTR("UIConstraintBasedLayoutThrowExceptionOnUnsatisfiableConstraints"));
  if (v0)
  {
  ...
  if (!qword_1ECD79138)
  {
    ...
    atomic_store(v2, (unint64_t *)&qword_1ECD79138);
  }
  v3 = *(NSObject **)(v2 + 8);
  if (os_log_type_enabled(v3, OS_LOG_TYPE_ERROR))
  {
    ...
    if (!byte_1ECD790B7)
      v4 = CFSTR("OFF");
    v5 = 138412546;
    v6 = CFSTR("UIConstraintBasedLayoutThrowExceptionOnUnsatisfiableConstraints");
    v7 = 2112;
    v8 = v4;
