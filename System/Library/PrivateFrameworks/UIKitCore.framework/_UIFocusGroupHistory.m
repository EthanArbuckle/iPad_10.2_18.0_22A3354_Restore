...
- (_UIFocusGroupHistory)init
{
  ...
  v2 = -[_UIFocusGroupHistory init](&v8, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x1E0CB3870], "pointerFunctionsWithOptions:", 0);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB3870], "pointerFunctionsWithOptions:", 517);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3748]), "initWithKeyPointerFunctions:valuePointerFunctions:capacity:", v3, v4, 10);
...
- (void)setLastFocusedItem:(id)a3 forGroupIdentifier:(id)a4
{
  ...
  if (!v10)
  {
    ...
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusGroupHistory.m"), 37, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("item"));
...
LABEL_5:
    ...
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusGroupHistory.m"), 38, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("groupIdentifier"));
