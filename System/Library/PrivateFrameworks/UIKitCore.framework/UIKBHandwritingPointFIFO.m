...
{
  id v4;
  UIKBHandwritingPointFIFO *v5;
  UIKBHandwritingPointFIFO *v6;
  objc_super v8;

  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)UIKBHandwritingPointFIFO;
  v5 = -[UIKBHandwritingPointFIFO init](&v8, sel_init);
  v6 = v5;
  if (v5)
    -[UIKBHandwritingPointFIFO setNextFIFO:](v5, "setNextFIFO:", v4);
...
- (void)emitPoint:(id *)a3
{
  ...
  v7 = v4;
  v8 = v3;
  -[UIKBHandwritingPointFIFO nextFIFO](self, "nextFIFO", a3);
...
- (void)flush
{
  ...
  -[UIKBHandwritingPointFIFO nextFIFO](self, "nextFIFO");
