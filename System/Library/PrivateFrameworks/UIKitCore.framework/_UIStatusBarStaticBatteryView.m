...
- (void)_createBodyLayers
{
  ...
  -[_UIStatusBarBatteryView setBodyLayer:](self, "setBodyLayer:", v7);
  ...
  -[_UIStatusBarBatteryView setPinLayer:](self, "setPinLayer:", v5);
  -[UIView layer](self, "layer");
...
- (void)_createFillLayer
{
  ...
  -[_UIStatusBarBatteryView setFillLayer:](self, "setFillLayer:", v5);
  +[UIColor clearColor](UIColor, "clearColor");
  v3 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
  objc_msgSend(v5, "setContentsMultiplyColor:", objc_msgSend(v3, "CGColor"));

  -[_UIStatusBarBatteryView bodyLayer](self, "bodyLayer");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "addSublayer:", v5);

  -[_UIStatusBarBatteryView setPercentFillLayer:](self, "setPercentFillLayer:", v5);
}
...
- (void)_createBoltLayersWithSize:(CGSize)a3
{
  ...
  -[_UIStatusBarStaticBatteryView _batteryPathScaleFactor](self, "_batteryPathScaleFactor");
  v10 = width * v9;
  v11 = height * v9;
  ...
  -[_UIStatusBarBatteryView setBoltMaskLayer:](self, "setBoltMaskLayer:", v15);
  ...
  -[_UIStatusBarBatteryView setBoltLayer:](self, "setBoltLayer:", v18);
...
- (CGSize)_boltPathSize
{
  ...
  -[_UIStatusBarBatteryView boltMaskLayer](self, "boltMaskLayer");
...
- (CGRect)_boltRectForTraitCollection:(id)a3 boltSize:(CGSize)a4
{
  ...
  height = a4.height;
  width = a4.width;
  -[_UIStatusBarBatteryView _bodyRectForTraitCollection:](self, "_bodyRectForTraitCollection:", a3);
  x = v21.origin.x;
  y = v21.origin.y;
  v9 = v21.size.width;
  v10 = v21.size.height;
  ...
  -[_UIStatusBarStaticBatteryView _batteryBoltLargeScaleFactor](self, "_batteryBoltLargeScaleFactor");
  v14 = v13;
...
- (CGRect)_updateBodyLayers
{
  ...
  -[UIView traitCollection](self, "traitCollection");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[_UIStatusBarStaticBatteryView _useImagesWithCutoutsForBolt](self, "_useImagesWithCutoutsForBolt");
  v5 = -[UIView _shouldReverseLayoutDirection](self, "_shouldReverseLayoutDirection");
  v6 = -[_UIStatusBarBatteryView showsPercentage](self, "showsPercentage");
  ...
  if (v4)
  {
    ...
    -[_UIStatusBarStaticBatteryView _boltPathSize](self, "_boltPathSize");
    v36 = v35;
    v58 = v37;
    ...
    v57 = v36;
    v38 = v63;
    objc_msgSend((id)objc_opt_class(), "_batteryBodyImageWithSize:forScale:batteryRect:cornerRadius:lineWidth:withBoltCutOutOfSize:inRect:boltFlipped:", v5, v25, v63, v10, v60, v66, v65, v67, v61, *(_QWORD *)&v8, v57, v58, v39, v40, v41, v42);
  }
  else
  {
    v38 = v63;
    objc_msgSend((id)objc_opt_class(), "_batteryBodyImageWithSize:forScale:batteryRect:cornerRadius:lineWidth:filled:", v6, v25, v63, v10, v16, v66, v65, v67, v27, *(_QWORD *)&v8);
  }
  v43 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
  v44 = objc_msgSend(v43, "CGImage");
  -[_UIStatusBarBatteryView bodyLayer](self, "bodyLayer");
  v45 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v45, "setContents:", v44);
  ...
  -[_UIStatusBarBatteryView pinLayer](self, "pinLayer");
  ...
  objc_msgSend(v52, "setContents:", v51);
...
- (void)_updateFillLayer
{
  ...
  v42 = v7;
  v40 = 0.0;
  -[_UIStatusBarBatteryView _fillLayerFrame:cornerRadius:](self, "_fillLayerFrame:cornerRadius:", &v41, &v40);
  if (-[_UIStatusBarStaticBatteryView _useImagesWithCutoutsForBolt](self, "_useImagesWithCutoutsForBolt"))
  {
    -[_UIStatusBarBatteryView boltMaskLayer](self, "boltMaskLayer");
    ...
    objc_msgSend((id)objc_opt_class(), "_batteryFillImageWithSize:forScale:cornerRadius:withBoltCutOutOfSize:inRect:boltFlipped:", v4, v42, v6, v40, v14, v16, v17 - *(double *)&v41, v18 - *((double *)&v41 + 1), v19, v20);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (-[_UIStatusBarBatteryView showsPercentage](self, "showsPercentage"))
  {
    -[_UIStatusBarBatteryView _lineWidthAndInterspaceForTraitCollection:](self, "_lineWidthAndInterspaceForTraitCollection:", v3);
    v23 = v22;
    -[_UIStatusBarBatteryView _bodyRectForTraitCollection:](self, "_bodyRectForTraitCollection:", v3);
    ...
    objc_msgSend((id)objc_opt_class(), "_percentFillImageWithSize:forScale:batteryRect:cornerRadius:lineWidth:", v42, v6, v25, v27, v29, v31, v32, *(_QWORD *)&v23);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    objc_msgSend((id)objc_opt_class(), "_batteryFillImageWithSize:forScale:cornerRadius:", v42, v6, v40);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
  }
  v34 = objc_retainAutorelease(v21);
  v35 = objc_msgSend(v34, "CGImage");
  -[_UIStatusBarBatteryView fillLayer](self, "fillLayer");
...
- (void)_updateBodyColors
{
  ...
  if (-[_UIStatusBarBatteryView showsPercentage](self, "showsPercentage"))
  {
  ...
  -[_UIStatusBarBatteryView boltLayer](self, "boltLayer");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_updateBatteryFillColor
{
  ...
  if (-[_UIStatusBarBatteryView showsPercentage](self, "showsPercentage"))
    -[_UIStatusBarStaticBatteryView _updateBodyColors](self, "_updateBodyColors");
}
...
- (double)_batteryPathScaleFactor
{
  ...
  v4 = 1.0 / v3;
  -[_UIStatusBarBatteryView _batteryBoltLargeScaleFactor](&v7, sel__batteryBoltLargeScaleFactor);
  return v4 / (1.0 / v5);
}

- (BOOL)_useImagesWithCutoutsForBolt
{
  return !-[_UIStatusBarBatteryView showsPercentage](self, "showsPercentage")
      && !self->_inflightBoltAnimationCount
      && -[_UIStatusBarBatteryView _shouldShowBolt](self, "_shouldShowBolt");
}
...
- (void)_willBeginAnimatingBoltToVisible:(BOOL)a3
{
  ...
  -[_UIStatusBarStaticBatteryView _updateBodyLayers](self, "_updateBodyLayers");
  -[_UIStatusBarStaticBatteryView _updateFillLayer](self, "_updateFillLayer");
...
- (void)setShowsPercentage:(BOOL)a3
{
  ...
  -[_UIStatusBarBatteryView setShowsPercentage:](&v4, sel_setShowsPercentage_, a3);
...
- (void)setLowBatteryMode:(int64_t)a3
{
  ...
  -[_UIStatusBarBatteryView setLowBatteryMode:](&v6, sel_setLowBatteryMode_, a3);
  if (v5 != -[_UIStatusBarBatteryView isLowBattery](self, "isLowBattery"))
    -[_UIStatusBarStaticBatteryView _updateBatteryFillColor](self, "_updateBatteryFillColor");
}
...
+ (id)_renderedImageOfSize:(CGSize)a3 scale:(double)a4 withActions:(id)a5
{
  ...
  if (!v10)
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_UIStatusBarStaticBatteryView.m"), 331, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("actions"));
...
+ (id)_batteryBodyImageWithSize:(CGSize)a3 forScale:(double)a4 batteryRect:(CGRect)a5 cornerRadius:(double)a6 lineWidth:(double)a7 filled:(BOOL)a8
{
  ...
  double v14;
  double v15;
  _UIStatusBarSignalViewCacheKey *v17;
  void *v18;
  void *v19;
  ...
  v14 = a3.height;
  v15 = a3.width;
  if (qword_1ECD7DCD8 != -1)
    dispatch_once(&qword_1ECD7DCD8, &__block_literal_global_231);
  v17 = -[_UIStatusBarSignalViewCacheKey initWithClass:size:rect:radius:lineWidth:alternate:scale:]([_UIStatusBarSignalViewCacheKey alloc], "initWithClass:size:rect:radius:lineWidth:alternate:scale:", a1, v8, v15, v14, x, y, width, height, a6, a7, *(_QWORD *)&a4);
  objc_msgSend((id)_MergedGlobals_1054, "objectForKey:", v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v18)
  {
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)_MergedGlobals_1054, "setObject:forKey:", v18, v17);
...
+ (id)_batteryBodyImageWithSize:(double)a3 forScale:(double)a4 batteryRect:(double)a5 cornerRadius:(double)a6 lineWidth:(double)a7 withBoltCutOutOfSize:(double)a8 inRect:(double)a9 boltFlipped:(uint64_t)a10
{
  ...
  if (!v30)
  {
    ...
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ECD7DCE0, "setObject:forKey:", v30, v29);
...
+ (id)_percentFillImageWithSize:(CGSize)a3 forScale:(double)a4 batteryRect:(CGRect)a5 cornerRadius:(double)a6 lineWidth:(double)a7
{
  ...
  double v12;
  double v13;
  _UIStatusBarSignalViewCacheKey *v15;
  void *v16;
  double v17;
  void *v18;
  ...
  v12 = a3.height;
  v13 = a3.width;
  if (qword_1ECD7DCF8 != -1)
    dispatch_once(&qword_1ECD7DCF8, &__block_literal_global_21_2);
  v15 = -[_UIStatusBarSignalViewCacheKey initWithClass:size:rect:radius:lineWidth:alternate:scale:]([_UIStatusBarSignalViewCacheKey alloc], "initWithClass:size:rect:radius:lineWidth:alternate:scale:", a1, 0, v13, v12, x, y, width, height, a6, a7, *(_QWORD *)&a4);
  objc_msgSend((id)qword_1ECD7DCF0, "objectForKey:", v15);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v16)
  {
    if (width >= a6 + a6)
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ECD7DCF0, "setObject:forKey:", v16, v15);
...
+ (id)_batteryPinImageWithSize:(CGSize)a3 forScale:(double)a4 complexPinPath:(BOOL)a5
{
  ...
  double height;
  double width;
  _UIStatusBarSignalViewCacheKey *v10;
  _UIStatusBarSignalViewCacheKey *v11;
  void *v12;
  void *v13;
  ...
  height = a3.height;
  width = a3.width;
  if (qword_1ECD7DD08 != -1)
    dispatch_once(&qword_1ECD7DD08, &__block_literal_global_22_2);
  v10 = [_UIStatusBarSignalViewCacheKey alloc];
  v11 = -[_UIStatusBarSignalViewCacheKey initWithClass:size:rect:radius:lineWidth:alternate:scale:](v10, "initWithClass:size:rect:radius:lineWidth:alternate:scale:", a1, v5, width, height, *MEMORY[0x1E0C9D628], *(double *)(MEMORY[0x1E0C9D628] + 8), *(double *)(MEMORY[0x1E0C9D628] + 16), *(double *)(MEMORY[0x1E0C9D628] + 24), 0.0, 0.0, *(_QWORD *)&a4);
  objc_msgSend((id)qword_1ECD7DD00, "objectForKey:", v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v12)
  {
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ECD7DD00, "setObject:forKey:", v12, v11);
...
+ (id)_batteryBoltImageWithSize:(CGSize)a3 boltSize:(CGSize)a4 forScale:(double)a5
{
  ...
  double v9;
  _UIStatusBarSignalViewCacheKey *v11;
  _UIStatusBarSignalViewCacheKey *v12;
  void *v13;
  double v14;
  void *v15;
  ...
  if (!v13)
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ECD7DD10, "setObject:forKey:", v13, v12);
...
+ (id)_batteryBoltMaskImageWithSize:(CGSize)a3 boltSize:(CGSize)a4 forScale:(double)a5
{
  ...
  v8 = a3.height;
  v9 = a3.width;
  if (qword_1ECD7DD28 != -1)
    dispatch_once(&qword_1ECD7DD28, &__block_literal_global_24_1);
  v11 = [_UIStatusBarSignalViewCacheKey alloc];
  v12 = -[_UIStatusBarSignalViewCacheKey initWithClass:size:rect:radius:lineWidth:secondarySize:secondaryRect:alternate:scale:](v11, "initWithClass:size:rect:radius:lineWidth:secondarySize:secondaryRect:alternate:scale:", a1, 0, v9, v8, *(_QWORD *)&width, *(_QWORD *)&height, *MEMORY[0x1E0C9D628], *(_QWORD *)(MEMORY[0x1E0C9D628] + 8), *(_QWORD *)(MEMORY[0x1E0C9D628] + 16), *(_QWORD *)(MEMORY[0x1E0C9D628] + 24), *(_QWORD *)&a5);
  objc_msgSend((id)qword_1ECD7DD20, "objectForKey:", v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v13)
  {
    if (v9 / width <= v8 / height)
    ...
    objc_msgSend(a1, "_imageWithRenderedBezierPath:size:scale:pathScaleFactor:stroke:fill:", v15, 0, 1, v9, v8, a5, v14);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ECD7DD20, "setObject:forKey:", v13, v12);
...
+ (id)_batteryFillImageWithSize:(CGSize)a3 forScale:(double)a4 cornerRadius:(double)a5
{
  ...
  height = a3.height;
  width = a3.width;
  if (qword_1ECD7DD38 != -1)
    dispatch_once(&qword_1ECD7DD38, &__block_literal_global_25_0);
  v10 = [_UIStatusBarSignalViewCacheKey alloc];
  v11 = -[_UIStatusBarSignalViewCacheKey initWithClass:size:rect:radius:lineWidth:alternate:scale:](v10, "initWithClass:size:rect:radius:lineWidth:alternate:scale:", a1, 0, width, height, *MEMORY[0x1E0C9D628], *(double *)(MEMORY[0x1E0C9D628] + 8), *(double *)(MEMORY[0x1E0C9D628] + 16), *(double *)(MEMORY[0x1E0C9D628] + 24), a5, 0.0, *(_QWORD *)&a4);
  objc_msgSend((id)qword_1ECD7DD30, "objectForKey:", v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v12)
  {
    +[UIBezierPath _bezierPathWithArcRoundedRect:cornerRadius:](UIBezierPath, "_bezierPathWithArcRoundedRect:cornerRadius:", *MEMORY[0x1E0C9D538], *(double *)(MEMORY[0x1E0C9D538] + 8), width, height, a5);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(a1, "_imageWithRenderedBezierPath:size:scale:pathScaleFactor:stroke:fill:", v13, 0, 1, width, height, a4, 1.0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ECD7DD30, "setObject:forKey:", v12, v11);
...
+ (id)_batteryFillImageWithSize:(CGSize)a3 forScale:(double)a4 cornerRadius:(double)a5 withBoltCutOutOfSize:(CGSize)a6 inRect:(CGRect)a7 boltFlipped:(BOOL)a8
{
  ...
  double width;
  double v12;
  _UIStatusBarSignalViewCacheKey *v14;
  _UIStatusBarSignalViewCacheKey *v15;
  void *v16;
  void *v17;
  void *v18;
  ...
  v21 = a3.height;
  v12 = a3.width;
  if (qword_1ECD7DD48 != -1)
    dispatch_once(&qword_1ECD7DD48, &__block_literal_global_26_0);
  ...
  objc_msgSend((id)qword_1ECD7DD40, "objectForKey:", v15);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v16)
  {
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend((id)qword_1ECD7DD40, "setObject:forKey:", v16, v15);
