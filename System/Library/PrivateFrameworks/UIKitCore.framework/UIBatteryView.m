...
void __35___UIBatteryView__batteryFillColor__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v3 = *(_QWORD *)(a1 + 32);
  v4 = a2;
  objc_msgSend(v4, "setAccessibilityContrast:", v3);
  objc_msgSend(v4, "setUserInterfaceStyle:", *(_QWORD *)(a1 + 40));
...
void __35___UIBatteryView__updateBodyColors__block_invoke(uint64_t a1)
{
  ...
  if (v2[419])
  {
    objc_msgSend(v2, "_batteryUnfilledColor");
    v30 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    v3 = objc_msgSend(v30, "CGColor");
    objc_msgSend(*(id *)(a1 + 32), "bodyShapeLayer");
    ...
    objc_msgSend(*(id *)(a1 + 32), "pinShapeLayer");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setFillColor:", v3);

    objc_msgSend(*(id *)(a1 + 32), "_batteryTextColor");
    v7 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    v8 = objc_msgSend(v7, "CGColor");
    objc_msgSend(*(id *)(a1 + 32), "boltShapeLayer");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "setFillColor:", v8);

    objc_msgSend(*(id *)(a1 + 32), "_batteryFillColor");
    v10 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    v11 = objc_msgSend(v10, "CGColor");
    objc_msgSend(*(id *)(a1 + 32), "percentFillShapeLayer");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "setFillColor:", v11);
  ...
  else
  {
    ...
    objc_msgSend(*(id *)(a1 + 32), "pinColor");
    ...
    objc_msgSend(*(id *)(a1 + 32), "boltColor");
    v24 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    v25 = objc_msgSend(v24, "CGColor");
    objc_msgSend(*(id *)(a1 + 32), "boltShapeLayer");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v26, "setFillColor:", v25);
...
void __41___UIBatteryView__updateBatteryFillColor__block_invoke(uint64_t a1)
{
  ...
  if (v2[419])
  {
    ...
    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 552), "setBackgroundColor:", objc_msgSend(v3, "CGColor"));
  ...
  {
    objc_msgSend(v2, "_batteryFillColor");
    v6 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 552), "setBackgroundColor:", objc_msgSend(v6, "CGColor"));
  }
...
id __39___UIBatteryView__updatePercentageFont__block_invoke(uint64_t a1)
{
  ...
  v8 = *(_QWORD *)(a1 + 32);
  if (*(_BYTE *)(a1 + 48) && *(_QWORD *)(v8 + 480) || *(double *)(v8 + 472) >= 0.995)
  {
