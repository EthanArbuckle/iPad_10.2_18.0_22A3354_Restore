...
- (id)_focusRegionWithAdjustedFrame:(CGRect)a3 coordinateSpace:(id)a4
{
  ...
  -[_UIFocusRegion _focusRegionWithAdjustedFrame:coordinateSpace:](&v9, sel__focusRegionWithAdjustedFrame_coordinateSpace_, a4, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[_UIFocusGuideRegion delegate](self, "delegate");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setDelegate:", v6);

  -[_UIFocusGuideRegion owningEnvironment](self, "owningEnvironment");
  ...
  -[_UIFocusGuideRegion _focusPriority](self, "_focusPriority");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[_UIFocusRegion isEqual:](&v12, sel_isEqual_, v4))
  {
    v5 = (id *)v4;
...
{
  return !-[_UIFocusGuideRegion _isUnoccludable](self, "_isUnoccludable");
}
...
- (id)_nextFocusedItemForFocusMovementRequest:(id)a3 inMap:(id)a4 withSnapshot:(id)a5
{
  ...
  v13 = -[_UIFocusGuideRegion _isEnabledForFocusedRegion:inSnapshot:](self, "_isEnabledForFocusedRegion:inSnapshot:", v12, v10);

  if (v13)
  {
    -[_UIFocusGuideRegion _delegatePreferredFocusEnvironmentsForMovementRequest:](self, "_delegatePreferredFocusEnvironmentsForMovementRequest:", v8);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    if (!objc_msgSend(v14, "count"))
    {
      -[_UIFocusGuideRegion owningEnvironment](self, "owningEnvironment");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      _UIFocusEnvironmentPreferredFocusEnvironments(v15);
    ...
    -[_UIFocusGuideRegion _fallbackFocusItemForMovementRequest:inFocusMap:withSnapshot:](self, "_fallbackFocusItemForMovementRequest:inFocusMap:withSnapshot:", v8, v9, v10);
...
- (id)_focusedItemForLinearSorting:(id)a3 inMap:(id)a4 withSnapshot:(id)a5
{
  ...
  else
  {
    ...
    -[_UIFocusRegion _focusedItemForLinearSorting:inMap:withSnapshot:](&v15, sel__focusedItemForLinearSorting_inMap_withSnapshot_, v8, v9, v10);
    v12 = objc_claimAutoreleasedReturnValue();
  }
  v13 = (void *)v12;
...
- (id)_debugDrawingConfigurationWithDebugInfo:(id)a3
{
  ...
  LODWORD(v4) = -[_UIFocusGuideRegion _isEnabledForFocusedRegion:inSnapshot:](self, "_isEnabledForFocusedRegion:inSnapshot:", v6, v7);
  if ((_DWORD)v4)
  {
    +[_UIFocusRegionDebugDrawingConfiguration guideConfigurationForRegion:](_UIFocusRegionDebugDrawingConfiguration, "guideConfigurationForRegion:", self);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
{
  return (_UIFocusGuideRegionDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
...
{
  return (UIFocusEnvironment *)objc_loadWeakRetained((id *)&self->_owningEnvironment);
}
