...
- (void)dealloc
{
  ...
  -[UIKeyboardInputManagerClient dealloc](&v3, sel_dealloc);
}

- (UIKeyboardInputManagerClient)initWithImplProxy:(id)a3
{
  id v4;
  UIKeyboardInputManagerClient *v5;
  uint64_t v6;
  ...
  v5 = -[UIKeyboardInputManagerClient init](&v14, sel_init);
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x1E0DBDC18], "serverInterface");
    ...
    objc_msgSend(MEMORY[0x1E0CB3B50], "interfaceWithProtocol:", &unk_1EDE913E0);
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  if (-[UIKeyboardInputManagerClient conformsToProtocol:](&v7, sel_conformsToProtocol_, v4))
    v5 = 1;
  else
...
- (id)methodSignatureForSelector:(SEL)a3
{
  ...
  -[UIKeyboardInputManagerClient methodSignatureForSelector:](&v9, sel_methodSignatureForSelector_);
...
- (void)forwardInvocation:(id)a3
{
  ...
  v4 = a3;
  if (objc_msgSend(MEMORY[0x1E0DBDC18], "instancesRespondToSelector:", objc_msgSend(v4, "selector")))
  {
    v5 = -[UIKeyboardInputManagerClientRequest initWithInvocation:]([UIKeyboardInputManagerClientRequest alloc], "initWithInvocation:", v4);
    -[UIKeyboardInputManagerClient handleRequest:](self, "handleRequest:", v5);
  ...
  else
  {
    ...
    -[UIKeyboardInputManagerClient forwardInvocation:](&v6, sel_forwardInvocation_, v4);
  }
...
- (void)handleRequest:(id)a3
{
  ...
  void *v14;
  UIKeyboardInputManagerClient *v15;
  id v16;

  v4 = a3;
  -[UIKeyboardInputManagerClient connection](self, "connection");
...
- (void)handleError:(id)a3 forRequest:(id)a4
{
  ...
  if ((unint64_t)objc_msgSend(v6, "errorCount") > 1)
  {
    ...
    -[UIKeyboardInputManagerClient setConnection:](self, "setConnection:", 0);
    objc_msgSend(v6, "invocation");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    NSStringFromSelector((SEL)objc_msgSend(v7, "selector"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    NSLog(CFSTR("Please check for kbd crash logs. %s closed connection to keyboard daemon after two consecutive failures sending %@"), "-[UIKeyboardInputManagerClient handleError:forRequest:]", v8);
  }
  else
  {
    objc_msgSend(v6, "invocation");
    ...
    NSStringFromSelector((SEL)objc_msgSend(v7, "selector"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    NSLog(CFSTR("%s will retry sending %@ to keyboard daemon after receiving %@"), "-[UIKeyboardInputManagerClient handleError:forRequest:]", v8, v10);
  }

  -[UIKeyboardInputManagerClient handleRequest:](self, "handleRequest:", v6);
}
