...
- (BOOL)shouldAllowInteraction:(id)a3 withContext:(id)a4
{
  ...
  objc_msgSend(v6, "_indexPathForSpringLoadingAtPoint:");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  realCellForRowAtIndexPath(v6, v8);
...
LABEL_5:
  ...
  if (!objc_msgSend(v6, "_shouldSpringLoadRowAtIndexPath:withContext:", v8, v5))
    goto LABEL_13;
  objc_msgSend(v5, "targetView");
  ...
  if ((v16 & 1) == 0
    || (objc_msgSend(v6, "_delegateProxy"),
        ...
        v18 = objc_msgSend(v17, "tableView:shouldHighlightRowAtIndexPath:", v6, v8),
        v17,
        v18))
  {
