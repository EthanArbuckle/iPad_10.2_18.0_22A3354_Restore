...
{
  UIDigitizerTapGestureRecognizer *v4;
  UIDigitizerTapGestureRecognizer *v5;
  ...
  if (v4)
  {
    ...
    -[UIGestureRecognizer setAllowedPressTypes:](&v16, sel_setAllowedPressTypes_, &unk_1E1A93590);
    v15.receiver = v5;
    v15.super_class = (Class)UIDigitizerTapGestureRecognizer;
    -[UIGestureRecognizer setAllowedTouchTypes:](&v15, sel_setAllowedTouchTypes_, &unk_1E1A935A8);
    v6 = objc_alloc_init(_UIDigitizerGestureRecognizerImp);
    imp = v5->_imp;
    v5->_imp = v6;

    -[_UIDigitizerGestureRecognizerImp setDelegate:](v5->_imp, "setDelegate:", v5);
    -[_UIDigitizerGestureRecognizerImp setMinimumPressDuration:](v5->_imp, "setMinimumPressDuration:", 0.0);
    v8 = _UIInternalPreferenceUsesDefault_1((int *)algn_1ECD76528, (uint64_t)CFSTR("DigitizerTapGestureRecognizerDefaultDuration"));
    v9 = *(double *)&qword_1ECD76530;
    if (v8)
      v9 = 0.5;
    -[_UIDigitizerGestureRecognizerImp setMaximumPressDuration:](v5->_imp, "setMaximumPressDuration:", v9);
...
- (CGPoint)digitizerLocation
{
  ...
  if (v3 == UIGestureRecognizerStateEnded)
    -[_UIDigitizerGestureRecognizerImp digitizerLocation](imp, "digitizerLocation");
  else
    -[_UIDigitizerGestureRecognizerImp defaultDigitizerLocation](imp, "defaultDigitizerLocation");
  result.y = v6;
  result.x = v5;
  return result;
}
...
- (double)maximumPressDuration
{
  ...
  -[_UIDigitizerGestureRecognizerImp maximumPressDuration](self->_imp, "maximumPressDuration");
  return result;
}

- (void)setMaximumPressDuration:(double)a3
{
  -[_UIDigitizerGestureRecognizerImp setMaximumPressDuration:](self->_imp, "setMaximumPressDuration:", a3);
}
