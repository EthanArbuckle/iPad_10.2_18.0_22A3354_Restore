...
- (_UIFocusMapSnapshotter)init
{
  ...
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusMapSnapshotter.m"), 37, CFSTR("-init is not a valid initializer for this class."));
...
- (_UIFocusMapSnapshotter)initWithFocusSystem:(id)a3 rootContainer:(id)a4 coordinateSpace:(id)a5 searchInfo:(id)a6 ignoresRootContainerClippingRect:(BOOL)a7
{
  ...
  id v15;
  id v16;
  _UIFocusMapSnapshotter *v17;
  _UIFocusMapSnapshotter *v18;
  CGSize v19;
  void *v21;
  void *v22;
  void *v23;
...
LABEL_8:
    ...
    objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusMapSnapshotter.m"), 44, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("rootContainer"));
  ...
  objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusMapSnapshotter.m"), 43, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("focusSystem"));
...
LABEL_9:
  ...
  objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_UIFocusMapSnapshotter.m"), 45, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("coordinateSpace"));

LABEL_4:
  v24.receiver = self;
  v24.super_class = (Class)_UIFocusMapSnapshotter;
  v17 = -[_UIFocusMapSnapshotter init](&v24, sel_init);
  v18 = v17;
  if (v17)
  {
    ...
    v18->_snapshotFrame.origin = (CGPoint)*MEMORY[0x1E0C9D628];
...
- (id)_searchAreaForContainerSearchRect:(CGRect)a3
{
  ...
  if (v20)
  {
    +[_UIFocusRegionEvaluator frameForRegion:inCoordinateSpace:](_UIFocusRegionEvaluator, "frameForRegion:inCoordinateSpace:", v20, WeakRetained);
    v22 = v21;
    v24 = v23;
    v26 = v25;
    v28 = v27;
  ...
  v46.size.width = v38;
  v46.size.height = v40;
  if (!CGRectIsNull(v46) && (_UIRectSmartIntersectsRect(v34, v36, v38, v40, x, y, width, height) & 1) == 0)
  {
...
- (id)captureSnapshot
{
  ...
  v13 = -[_UIFocusMapRect initWithFrame:coordinateSpace:]([_UIFocusMapRect alloc], "initWithFrame:coordinateSpace:", v4, x, y, width, height);
  -[_UIFocusMapSnapshotter _searchAreaForContainerSearchRect:](self, "_searchAreaForContainerSearchRect:", x, y, width, height);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = -[_UIFocusMapSnapshot _initWithSnapshotter:mapArea:searchArea:]([_UIFocusMapSnapshot alloc], "_initWithSnapshotter:mapArea:searchArea:", self, v13, v14);
