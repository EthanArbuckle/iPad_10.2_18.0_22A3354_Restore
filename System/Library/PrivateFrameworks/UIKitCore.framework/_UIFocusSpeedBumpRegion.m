...
{
  _UIFocusSpeedBumpRegion *result;
  objc_super v7;
...
- (id)_focusRegionWithAdjustedFrame:(CGRect)a3 coordinateSpace:(id)a4
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)_UIFocusSpeedBumpRegion;
  -[_UIFocusRegion _focusRegionWithAdjustedFrame:coordinateSpace:](&v7, sel__focusRegionWithAdjustedFrame_coordinateSpace_, a4, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)_UIFocusSpeedBumpRegion;
  if (-[_UIFocusRegion isEqual:](&v7, sel_isEqual_, v4))
...
- (unint64_t)_boundariesBlockingFocusMovementRequest:(id)a3
{
  ...
  if ((v5 & 1) != 0)
    ...
    return -[_UIFocusSpeedBumpRegion speedBumpEdges](self, "speedBumpEdges");
}
