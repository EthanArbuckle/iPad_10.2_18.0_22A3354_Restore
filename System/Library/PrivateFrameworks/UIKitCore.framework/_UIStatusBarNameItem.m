...
- (id)dependentEntryKeys
{
  ...
  -[_UIStatusBarNameItem nameEntryKey](self, "nameEntryKey");
...
- (_UIStatusBarStringView)nameView
{
  ...
  if (!nameView)
  {
    -[_UIStatusBarNameItem _create_nameView](self, "_create_nameView");
    nameView = self->_nameView;
  }
  return nameView;
}
...
- (id)applyUpdate:(id)a3 toDisplayItem:(id)a4
{
  ...
  -[_UIStatusBarItem applyUpdate:toDisplayItem:](&v16, sel_applyUpdate_toDisplayItem_, v6, v7);
  ...
  if (objc_msgSend(v6, "dataChanged"))
  {
    ...
    if (objc_msgSend(v7, "isEnabled"))
    {
      ...
      -[_UIStatusBarNameItem nameView](self, "nameView");
