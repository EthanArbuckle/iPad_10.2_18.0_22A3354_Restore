...
void onKeybagLockStatusChange(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "handkeKeybagLockStatusChange:", (int)MKBGetDeviceLockState());

}

uint64_t onUnlockedSinceBoot(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "handleUnlockedSinceBoot");
}
...
void onNowPlayingInfoChange(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = a2;
  if (objc_msgSend(a3, "isEqualToString:", *MEMORY[0x24BE65760]))
    objc_msgSend(v4, "handleNowPlayingInfoDidChange");

}

void sub_2188D5F74(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_2188D654C(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_2188D66BC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_list va;
...
{
  return +[PMMPredictor sharedInstance](PMMPredictor, "sharedInstance");
}

void sub_2188D784C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
void sub_2188D79C0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
void serverConnectionCallback()
{
  ...
  {
    *(_WORD *)v1 = 0;
    _os_log_impl(&dword_2188D0000, v0, OS_LOG_TYPE_DEFAULT, "CTService: received notification \n", v1, 2u);
  }

}

void sub_2188D8634(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}

void sub_2188D88FC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}

void sub_2188D8BC4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}

void sub_2188D8E98(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}
