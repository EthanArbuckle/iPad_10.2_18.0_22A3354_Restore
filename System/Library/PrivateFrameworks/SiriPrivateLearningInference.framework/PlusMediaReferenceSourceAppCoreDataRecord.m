...
- (PlusMediaReferenceSourceAppCoreDataRecord)initWithEntity:(id)a3 insertIntoManagedObjectContext:(id)a4
{
  ...
  return -[PlusMediaReferenceSourceAppCoreDataRecord initWithEntity:insertIntoManagedObjectContext:](&v7, sel_initWithEntity_insertIntoManagedObjectContext_, a3, a4);
}
