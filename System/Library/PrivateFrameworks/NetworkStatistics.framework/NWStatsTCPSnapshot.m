...
{
  const nstat_tcp_descriptor *descriptor;
...
- (NSString)TCPState
{
  ...
  v6[2] = xmmword_24CBD2E28;
  v6[3] = *(_OWORD *)&off_24CBD2E38;
  v6[4] = xmmword_24CBD2E48;
  v7 = CFSTR("TimeWait");
  v6[0] = xmmword_24CBD2E08;
  v6[1] = *(_OWORD *)&off_24CBD2E18;
  if (state > 0xA)
    v3 = 0;
  else
    v3 = *((id *)v6 + state);
...
- (NSString)congestionAlgorithm
{
  ...
  {
    v4 = (NSString *)objc_msgSend(objc_alloc(MEMORY[0x24BDD17C8]), "initWithFormat:", CFSTR("%.16s"), self->_descriptor->cc_algo);
