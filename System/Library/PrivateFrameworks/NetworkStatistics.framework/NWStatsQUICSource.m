...
{
  id v8;
  NWStatsQUICSource *v9;
  NWStatsQUICSource *v10;
  uint64_t v11;
  objc_super v13;
  ...
  v9 = -[NWStatsQUICSource init](&v13, sel_init);
  v10 = v9;
  if (v9)
  {
    memcpy(&v9->_nstatQUICUpdate, a3, sizeof(v9->_nstatQUICUpdate));
    -[NWStatsSource setFlowFlags:](v10, "setFlowFlags:", -[NWStatsSource flagsForProvider:sockaddr:](v10, "flagsForProvider:sockaddr:", v10->_nstatQUICUpdate.provider, &v10->_nstatQUICUpdate.quic_desc.remote));
    -[NWStatsQUICSource deriveAttribution:](v10, "deriveAttribution:", v8);
    v11 = objc_msgSend(v8, "currentForegroundStateForProcessWithPid:", v10->_nstatQUICUpdate.quic_desc.epid);
...
- (void)deriveAttribution:(id)a3
{
  ...
  v4 = a3;
  v14 = 0;
  +[NWStatsProtocolSnapshot _referenceIntervalWithContinuousTime:](NWStatsProtocolSnapshot, "_referenceIntervalWithContinuousTime:", self->_nstatQUICUpdate.quic_desc.start_timestamp);
  -[NWStatsSource setCreationTimestamp:](self, "setCreationTimestamp:");
  -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", self->_nstatQUICUpdate.quic_desc.uuid);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", self->_nstatQUICUpdate.quic_desc.euuid);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "bestIdentifierForUUID:EUUID:pid:epid:procname:derivation:", v5, v6, self->_nstatQUICUpdate.quic_desc.pid, self->_nstatQUICUpdate.quic_desc.epid, self->_nstatQUICUpdate.quic_desc.pname, (char *)&v14 + 4);
  ...
  if (*(_QWORD *)self->_nstatQUICUpdate.quic_desc.uuid == *(_QWORD *)self->_nstatQUICUpdate.quic_desc.euuid
    && *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.uuid[8] == *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.euuid[8])
  {
    v11 = 0;
  }
  else
  {
    objc_msgSend(v4, "bestIdentifierForUUID:EUUID:pid:epid:procname:derivation:", v5, 0, self->_nstatQUICUpdate.quic_desc.pid, 0, self->_nstatQUICUpdate.quic_desc.pname, &v14);
  ...
  {
    objc_msgSend(v4, "allIdentifiersForUUID:EUUID:pid:epid:procname:", v5, v6, self->_nstatQUICUpdate.quic_desc.pid, self->_nstatQUICUpdate.quic_desc.epid, self->_nstatQUICUpdate.quic_desc.pname);
...
- (BOOL)updateWithUpdate:(nstat_msg_src_update_convenient *)a3 length:(int64_t)a4 monitor:(id)a5
{
  ...
  else
  {
    if (a3->var0.tcp.pid != self->_nstatQUICUpdate.quic_desc.pid
      ...
      || (*(_QWORD *)a3->var0.conn.euuid == *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.local.v4.sin_len
        ? (v10 = *(_QWORD *)&a3->var0.conn.euuid[8] == *(_QWORD *)self->_nstatQUICUpdate.quic_desc.local.v6.sin6_addr.__u6_addr8)
        : (v10 = 0),
          v10
        ? (v11 = *(_QWORD *)a3->var0.conn.cuuid == *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.local.v6.sin6_addr.__u6_addr32[2])
        : (v11 = 0),
          v11
        ? (v12 = a3->var0.tcp.local.v6.sin6_scope_id == (unint64_t)self->_nstatQUICUpdate.quic_desc.local.v6.sin6_scope_id)
        : (v12 = 0),
          !v12
       || (*(_QWORD *)&a3->var0.conn.cuuid[12] == *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.remote.v4.sin_len
         ? (v13 = *(_QWORD *)&a3->var0.conn.puuid[4] == *(_QWORD *)self->_nstatQUICUpdate.quic_desc.remote.v6.sin6_addr.__u6_addr8)
         : (v13 = 0),
           v13
         ? (v14 = *(_QWORD *)&a3->var0.conn.puuid[12] == *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.remote.v6.sin6_addr.__u6_addr32[2])
         : (v14 = 0),
           v14
         ? (v15 = a3->var0.tcp.remote.v6.sin6_scope_id == (unint64_t)self->_nstatQUICUpdate.quic_desc.remote.v6.sin6_scope_id)
         : (v15 = 0),
           !v15)))
    {
      -[NWStatsQUICSource significantMetadataChange:monitor:](self, "significantMetadataChange:monitor:", &a3->var0, v8);
    }
    -[NWStatsSource saveOldValues:](self, "saveOldValues:", &self->_nstatQUICUpdate.counts);
...
- (id)createSnapshot:(int)a3 firstOccurrence:(BOOL)a4
{
  ...
  v9 = -[NWStatsQUICSnapshot initWithUpdate:startTime:flowFlags:previously:bluetoothCounts:peerEgressCellularCounts:](v7, "initWithUpdate:startTime:flowFlags:previously:bluetoothCounts:peerEgressCellularCounts:", &self->_nstatQUICUpdate, -[NWStatsSource flowFlags](self, "flowFlags"), -[NWStatsSource prevItemsPtr](self, "prevItemsPtr"), &self->_nstatBluetoothCounts, 0, v8);
...
- (id)description
{
  nstat_msg_src_update_quic *p_nstatQUICUpdate;
  id v4;
  char *pname;
  void *v6;
  uint64_t pid;
  ...
  -[NWStatsSource attributedEntity](self, "attributedEntity");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  pid = p_nstatQUICUpdate->quic_desc.pid;
  epid = p_nstatQUICUpdate->quic_desc.epid;
  -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatQUICUpdate->quic_desc.uuid);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatQUICUpdate->quic_desc.euuid);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatQUICUpdate->quic_desc.fuuid);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[NWStatsSource creationTimestamp](self, "creationTimestamp");
  dateStringMillisecondsFromReferenceInterval(v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = (void *)objc_msgSend(v4, "initWithFormat:", CFSTR("NWStatsQUICSource %s attributed %@ pid %d epid %d uuid %@ euuid %@ fuuid %@ started %@"), pname, v6, pid, epid, v9, v10, v11, v13);
...
- (void)significantMetadataChange:(nstat_tcp_descriptor *)a3 monitor:(id)a4
{
  ...
  if (!memcmp(a3->pname, self->_nstatQUICUpdate.quic_desc.pname, 0x40uLL))
    ...
    v11 = v10 | 0x200000;
  if (*(_QWORD *)&a3->local.v4.sin_len != *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.local.v4.sin_len
    || *(_QWORD *)a3->local.v6.sin6_addr.__u6_addr8 != *(_QWORD *)self->_nstatQUICUpdate.quic_desc.local.v6.sin6_addr.__u6_addr8
    || *(_QWORD *)&a3->local.v6.sin6_addr.__u6_addr32[2] != *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.local.v6.sin6_addr.__u6_addr32[2]
    || a3->local.v6.sin6_scope_id != (unint64_t)self->_nstatQUICUpdate.quic_desc.local.v6.sin6_scope_id)
  {
    HavePortDiffOnly = sockaddrsHavePortDiffOnly((uint64_t)&self->_nstatQUICUpdate.quic_desc.local, (uint64_t)&a3->local);
    if (HavePortDiffOnly)
      v16 = 0x80000;
    else
      v16 = 0x20000;
    if (HavePortDiffOnly)
      v17 = CFSTR("QUIC local port");
    else
      v17 = CFSTR("QUIC local address");
    v11 |= v16;
    -[NWStatsSource logAddressChangeOn:procName:variant:oldAddress:newAddress:](self, "logAddressChangeOn:procName:variant:oldAddress:newAddress:", self->_nstatQUICUpdate.srcref, a3->pname, v17, &self->_nstatQUICUpdate.quic_desc.local, &a3->local);
  }
  if (*(_QWORD *)&a3->remote.v4.sin_len != *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.remote.v4.sin_len
    || *(_QWORD *)a3->remote.v6.sin6_addr.__u6_addr8 != *(_QWORD *)self->_nstatQUICUpdate.quic_desc.remote.v6.sin6_addr.__u6_addr8
    || *(_QWORD *)&a3->remote.v6.sin6_addr.__u6_addr32[2] != *(_QWORD *)&self->_nstatQUICUpdate.quic_desc.remote.v6.sin6_addr.__u6_addr32[2]
    || a3->remote.v6.sin6_scope_id != (unint64_t)self->_nstatQUICUpdate.quic_desc.remote.v6.sin6_scope_id)
  {
    v21 = sockaddrsHavePortDiffOnly((uint64_t)&self->_nstatQUICUpdate.quic_desc.remote, (uint64_t)&a3->remote);
    if (v21)
      v22 = 0x100000;
    else
      v22 = 0x40000;
    if (v21)
      v23 = CFSTR("QUIC remote port");
    else
      v23 = CFSTR("QUIC remote address");
    v11 |= v22;
    -[NWStatsSource logAddressChangeOn:procName:variant:oldAddress:newAddress:](self, "logAddressChangeOn:procName:variant:oldAddress:newAddress:", self->_nstatQUICUpdate.srcref, a3->pname, v23, &self->_nstatQUICUpdate.quic_desc.remote, &a3->remote);
  }
  if ((v11 & 0x21F000) != 0)
  {
    LODWORD(v24) = a3->epid;
    -[NWStatsSource logAttributionChangeOn:oldProcName:newProcName:oldPid:newPid:oldEPid:newEPid:oldUUID:newUUID:oldEUUID:newEUUID:monitor:](self, "logAttributionChangeOn:oldProcName:newProcName:oldPid:newPid:oldEPid:newEPid:oldUUID:newUUID:oldEUUID:newEUUID:monitor:", self->_nstatQUICUpdate.srcref, self->_nstatQUICUpdate.quic_desc.pname, a3->pname, self->_nstatQUICUpdate.quic_desc.pid, a3->pid, self->_nstatQUICUpdate.quic_desc.epid, v24, self->_nstatQUICUpdate.quic_desc.uuid, a3->uuid, self->_nstatQUICUpdate.quic_desc.euuid, a3->euuid, v26);
    -[NWStatsQUICSource deriveAttribution:](self, "deriveAttribution:", v26);
  }
