...
- (id)traditionalDictionary
{
  ...
  -[NWSSnapshot _createCountsForProvider:](&v52, sel__createCountsForProvider_, 4);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (!v3)
    goto LABEL_34;
  objc_msgSend(v3, "setObject:forKeyedSubscript:", kNStatProviderUDP, kNStatSrcKeyProvider);
  -[NWSUDPSnapshot localAddress](self, "localAddress");
  ...
  -[NWSUDPSnapshot remoteAddress](self, "remoteAddress");
  ...
  -[NWSUDPSnapshot euuid](self, "euuid");
  ...
  -[NWSUDPSnapshot fuuid](self, "fuuid");
  ...
  -[NWSUDPSnapshot vuuid](self, "vuuid");
  ...
  -[NWSUDPSnapshot processName](self, "processName");
