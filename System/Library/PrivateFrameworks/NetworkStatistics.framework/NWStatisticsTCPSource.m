...
- (id)_currentSnapshot
{
  return -[NWSTCPSnapshot initWithCounts:TCPDescriptor:sourceIdent:events:seqno:provider:]([NWSTCPSnapshot alloc], "initWithCounts:TCPDescriptor:sourceIdent:events:seqno:provider:", -[NWStatisticsSource _nstat_counts](self, "_nstat_counts"), &self->_descriptor, -[NWStatisticsSource reference](self, "reference"), self->_eventFlags, -[NWStatisticsSource snapshotRevision](self, "snapshotRevision"), -[NWStatisticsSource provider](self, "provider"));
}
...
{
  id v8;
  NWStatisticsTCPSource *v9;
  NWStatisticsTCPSource *v10;
  int v11;
  NSObject *v12;
  const char *v13;
  int sa_len;
  ...
  v9 = -[NWStatisticsSource initWithManager:source:provider:](&v24, sel_initWithManager_source_provider_, v8, 0, 2);
  if (!v9)
    goto LABEL_5;
  v40 = 0u;
  v41 = 0u;
...
LABEL_5:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    v35 = 2096;
    v36 = a5;
    _os_log_impl(&dword_211429000, v12, OS_LOG_TYPE_INFO, "Manager %p: %s TCP source for local address %{network:sockaddr}.*P, remote address %{network:sockaddr}.*P", buf, 0x36u);
  }
