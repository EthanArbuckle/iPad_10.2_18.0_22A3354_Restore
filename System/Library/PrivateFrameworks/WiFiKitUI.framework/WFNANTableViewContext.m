  ...
  if (WFCurrentLogLevel() && v5)
  {
    ...
    if (os_log_type_enabled(v7, v6))
    {
      ...
      *(_DWORD *)buf = 134217984;
      v13 = v8;
      _os_log_impl(&dword_2196CC000, v7, v6, "Added new publisher, new count is %lu", buf, 0xCu);
    }
...
- (void)addSubscriber:(id)a3
{
  ...
  if (WFCurrentLogLevel() && v5)
  {
    ...
    if (os_log_type_enabled(v7, v6))
    {
      ...
      *(_DWORD *)buf = 134217984;
      v13 = v8;
      _os_log_impl(&dword_2196CC000, v7, v6, "Added new subcriber, new count is %lu", buf, 0xCu);
    }
  ...
  if (WFCurrentLogLevel() && v13)
  {
    ...
    if (os_log_type_enabled(v15, v14))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      _os_log_impl(&dword_2196CC000, v15, v14, "Added new discovery result for subscriber %@, new count is %lu", buf, 0x16u);
  ...
  if (WFCurrentLogLevel() && v13)
  {
    ...
    if (os_log_type_enabled(v15, v14))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v25 = 2048;
      v26 = objc_msgSend(v10, "count");
      _os_log_impl(&dword_2196CC000, v15, v14, "Added new data session for publisher %@, new count is %lu", buf, 0x16u);
  ...
  if (WFCurrentLogLevel() && v13)
  {
    ...
    if (os_log_type_enabled(v15, v14))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v25 = 2048;
      v26 = objc_msgSend(v10, "count");
      _os_log_impl(&dword_2196CC000, v15, v14, "Added new data session for subscriber %@, new count is %lu", buf, 0x16u);
  ...
  if (WFCurrentLogLevel() && v6)
  {
    ...
    if (os_log_type_enabled(v8, v7))
    {
      ...
      *(_DWORD *)buf = 134218240;
      ...
      v15 = 2048;
      v16 = v9;
      _os_log_impl(&dword_2196CC000, v8, v7, "Removed publisher at index %ld, new count is %lu", buf, 0x16u);
    }
    ...
    if (WFCurrentLogLevel() && v8)
    {
      ...
      if (os_log_type_enabled(v10, v9))
      {
        ...
        *(_DWORD *)buf = 134218240;
        ...
        v16 = 2048;
        v17 = v11;
        _os_log_impl(&dword_2196CC000, v10, v9, "Removed publisher at index %ld, new count is %lu", buf, 0x16u);
      }
...
LABEL_5:
    ...
    if (WFCurrentLogLevel() && v6 && os_log_type_enabled(v6, v7))
    {
      *(_DWORD *)buf = 138412290;
      v15 = (char *)v4;
      _os_log_impl(&dword_2196CC000, v6, v7, "Publisher %@ does not exist", buf, 0xCu);
    }
  }
  ...
  if (WFCurrentLogLevel() && v6)
  {
    ...
    if (os_log_type_enabled(v8, v7))
    {
      ...
      *(_DWORD *)buf = 134218240;
      ...
      v15 = 2048;
      v16 = v9;
      _os_log_impl(&dword_2196CC000, v8, v7, "Removed subscriber at index %ld, new count is %lu", buf, 0x16u);
    }
    ...
    if (WFCurrentLogLevel() && v8)
    {
      ...
      if (os_log_type_enabled(v10, v9))
      {
        ...
        *(_DWORD *)buf = 134218240;
        ...
        v16 = 2048;
        v17 = v11;
        _os_log_impl(&dword_2196CC000, v10, v9, "Removed subscriber at index %ld, new count is %lu", buf, 0x16u);
      }
...
LABEL_5:
    ...
    if (WFCurrentLogLevel() && v6 && os_log_type_enabled(v6, v7))
    {
      *(_DWORD *)buf = 138412290;
      v15 = (char *)v4;
      _os_log_impl(&dword_2196CC000, v6, v7, "Subscriber %@ does not exist", buf, 0xCu);
    }
  }
    ...
    if (WFCurrentLogLevel() && v25)
    {
      ...
      if (os_log_type_enabled(v27, v26))
      {
        ...
        *(_QWORD *)&v34[10] = objc_msgSend(v12, "count");
        _os_log_impl(&dword_2196CC000, v27, v26, "Removed discovery result for subcriber %@, new count is %lu", buf, 0x16u);
...
LABEL_6:
  ...
  if (WFCurrentLogLevel() && v17)
  {
    ...
    if (os_log_type_enabled(v19, v18))
    {
      ...
      *(_WORD *)&v34[14] = 2112;
      *(_QWORD *)&v34[16] = v22;
      _os_log_impl(&dword_2196CC000, v19, v18, "Discovery result with publish ID %hhu and address %@ does not exist for subscriber %@", buf, 0x1Cu);
    ...
    if (WFCurrentLogLevel() && v19)
    {
      ...
      if (os_log_type_enabled(v21, v20))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        _os_log_impl(&dword_2196CC000, v21, v20, "Removed data session for publisher %@, new count is %lu", buf, 0x16u);
  ...
  if (WFCurrentLogLevel() && v12)
  {
    ...
    if (os_log_type_enabled(v14, v13))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v29 = 2112;
      v30 = (uint64_t)v16;
      _os_log_impl(&dword_2196CC000, v14, v13, "Data session %@ does not exist for publisher %@", buf, 0x16u);
    ...
    if (WFCurrentLogLevel() && v19)
    {
      ...
      if (os_log_type_enabled(v21, v20))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v29 = 2048;
        v30 = objc_msgSend(v10, "count");
        _os_log_impl(&dword_2196CC000, v21, v20, "Removed data session for subscriber %@, new count is %lu", buf, 0x16u);
  ...
  if (WFCurrentLogLevel() && v12)
  {
    ...
    if (os_log_type_enabled(v14, v13))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v29 = 2112;
      v30 = (uint64_t)v16;
      _os_log_impl(&dword_2196CC000, v14, v13, "Data session %@ does not exist for subscriber %@", buf, 0x16u);
...
- (void)publisherStarted:(id)a3
{
  ...
  if (WFCurrentLogLevel() && v4)
  {
    ...
    if (os_log_type_enabled(v6, v5))
    {
      ...
      v9 = 138412290;
      v10 = v8;
      _os_log_impl(&dword_2196CC000, v6, v5, "NAN publish %@ started", (uint8_t *)&v9, 0xCu);
...
- (void)publisher:(id)a3 failedToStartWithError:(int64_t)a4
{
  ...
  if (WFCurrentLogLevel() && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      v14 = 2048;
      v15 = a4;
      _os_log_impl(&dword_2196CC000, v9, v8, "NAN publish %@ failed to start with error %ld", (uint8_t *)&v12, 0x16u);
...
- (void)publisher:(id)a3 terminatedWithReason:(int64_t)a4
{
  ...
  if (WFCurrentLogLevel() && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      v14 = 2048;
      v15 = a4;
      _os_log_impl(&dword_2196CC000, v9, v8, "NAN publish %@ terminated with reason %ld", (uint8_t *)&v12, 0x16u);
...
- (void)publisher:(id)a3 dataConfirmedForHandle:(id)a4 localInterfaceIndex:(unsigned int)a5 serviceSpecificInfo:(id)a6
{
  ...
  if (WFCurrentLogLevel() && v10)
  {
    ...
    if (os_log_type_enabled(v12, v11))
    {
      ...
      v14 = 138412290;
      v15 = v13;
      _os_log_impl(&dword_2196CC000, v12, v11, "Data confirmed for session with peer %@", (uint8_t *)&v14, 0xCu);
...
- (void)publisher:(id)a3 dataTerminatedForHandle:(id)a4 reason:(int64_t)a5
{
  ...
  if (WFCurrentLogLevel() && v9)
  {
    ...
    if (os_log_type_enabled(v11, v10))
    {
      ...
      v13 = 138412290;
      v14 = v12;
      _os_log_impl(&dword_2196CC000, v11, v10, "Data terminated for session with peer %@", (uint8_t *)&v13, 0xCu);
...
- (void)subscriberStarted:(id)a3
{
  ...
  if (WFCurrentLogLevel() && v4)
  {
    ...
    if (os_log_type_enabled(v6, v5))
    {
      ...
      v9 = 138412290;
      v10 = v8;
      _os_log_impl(&dword_2196CC000, v6, v5, "NAN subscribe %@ started", (uint8_t *)&v9, 0xCu);
...
- (void)subscriber:(id)a3 failedToStartWithError:(int64_t)a4
{
  ...
  if (WFCurrentLogLevel() && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      v14 = 2048;
      v15 = a4;
      _os_log_impl(&dword_2196CC000, v9, v8, "NAN subscribe %@ failed to start with error %ld", (uint8_t *)&v12, 0x16u);
...
- (void)subscriber:(id)a3 terminatedWithReason:(int64_t)a4
{
  ...
  if (WFCurrentLogLevel() && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      v14 = 2048;
      v15 = a4;
      _os_log_impl(&dword_2196CC000, v9, v8, "NAN subscribe %@ terminated with reason %ld", (uint8_t *)&v12, 0x16u);
...
- (void)subscriber:(id)a3 receivedDiscoveyResult:(id)a4
{
  ...
  if (WFCurrentLogLevel() && v8)
  {
    ...
    if (os_log_type_enabled(v10, v9))
    {
      ...
      v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_2196CC000, v10, v9, "NAN subscribe %@ received discovery result %@", (uint8_t *)&v15, 0x16u);
...
- (void)subscriber:(id)a3 lostDiscoveryResultForPublishID:(unsigned __int8)a4 address:(id)a5
{
  ...
  if (WFCurrentLogLevel() && v10)
  {
    ...
    if (os_log_type_enabled(v12, v11))
    {
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_2196CC000, v12, v11, "NAN subscribe %@ lost discovery result with publish ID %hhu and address %@", (uint8_t *)&v16, 0x1Cu);
