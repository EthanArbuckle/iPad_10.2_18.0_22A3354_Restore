...
- (WFNANDiscoveryResultsTableViewController)initWithContext:(id)a3 forSubscriber:(id)a4
{
  ...
  if (v10)
  {
    ...
    v10->_passphrase = (NSString *)&stru_24DB39F78;
...
LABEL_13:
    objc_msgSend(v22, "localizedStringForKey:value:table:", v23, &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "textLabel");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
    ...
    && -[WFNANTableViewContext getDiscoveryResultsCountForSubscriber:](self->_context, "getDiscoveryResultsCountForSubscriber:", self->_subscriber) >= 1)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "localizedStringForKey:value:table:", CFSTR("kWFLocNANPassphrasePopupTitle"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("kWFLocNANPassphrasePopupMessage"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(MEMORY[0x24BEBD3A8], "actionWithTitle:style:handler:", CFSTR("Cancel"), 0, &__block_literal_global_6);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
...
void __78__WFNANDiscoveryResultsTableViewController_tableView_didSelectRowAtIndexPath___block_invoke(uint64_t a1, void *a2)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("kWFLocNANPassphrase"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
void __78__WFNANDiscoveryResultsTableViewController_tableView_didSelectRowAtIndexPath___block_invoke_3(uint64_t a1)
{
  ...
  if (WFCurrentLogLevel() && v3)
  {
    ...
    if (os_log_type_enabled(v5, v4))
    {
      ...
      v11 = 138412290;
      v12 = v6;
      _os_log_impl(&dword_2196CC000, v5, v4, "Establishing a data session with discovery result %@", (uint8_t *)&v11, 0xCu);
  ...
  if (WFCurrentLogLevel() && v11)
  {
    ...
    if (os_log_type_enabled(v13, v12))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v29 = 2112;
      v30 = v16;
      _os_log_impl(&dword_2196CC000, v13, v12, "NAN data session %@ confirmed for peer (address: %@, serviceSpecificInfo: %@)", buf, 0x20u);
...
- (void)dataSession:(id)a3 failedToStartWithError:(int64_t)a4
{
  ...
  if (WFCurrentLogLevel() && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      v15 = 2048;
      v16 = a4;
      _os_log_impl(&dword_2196CC000, v9, v8, "NAN data session %@ failed to start with error %ld", (uint8_t *)&v13, 0x16u);
...
- (void)dataSession:(id)a3 terminatedWithReason:(int64_t)a4
{
  ...
  if (WFCurrentLogLevel() && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      v15 = 2048;
      v16 = a4;
      _os_log_impl(&dword_2196CC000, v9, v8, "NAN data session %@ terminated with reason %ld", (uint8_t *)&v13, 0x16u);
...
- (void)dataSessionRequestStarted:(id)a3
{
  ...
  if (WFCurrentLogLevel() && v4)
  {
    ...
    if (os_log_type_enabled(v6, v5))
    {
      ...
      v8 = 138412290;
      v9 = v7;
      _os_log_impl(&dword_2196CC000, v6, v5, "NAN data session %@ started", (uint8_t *)&v8, 0xCu);
