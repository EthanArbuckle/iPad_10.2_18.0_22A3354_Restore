...
- (WFDiagnosticsTableViewController)initWithDiagnosticsContext:(id)a3 detailsProviderContext:(id)a4
{
  ...
  id v7;
  void *v8;
  WFDiagnosticsTableViewController *v9;

  v6 = a4;
  v7 = a3;
  +[WFAppearanceProxy defaultAppearanceProxy](WFAppearanceProxy, "defaultAppearanceProxy");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = -[WFDiagnosticsTableViewController initWithDiagnosticsContext:detailsProviderContext:appearanceProxy:](self, "initWithDiagnosticsContext:detailsProviderContext:appearanceProxy:", v7, v6, v8);
  ...
  if (WFCurrentLogLevel() && v9)
  {
    ...
    if (os_log_type_enabled(v11, v10))
    {
      ...
      *(_QWORD *)&v22[14] = v13;
      ...
      _os_log_impl(&dword_2196CC000, v11, v10, "NetQuality: %s: Date is %@, responsiveness %.3f, existing view? %s existing date? %@", v22, 0x34u);
...
- (void)_openNetworkQualityDetails:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v30 = (id)objc_msgSend(v4, "initWithTitle:detailText:symbolName:contentLayout:", v6, 0, 0, 2);

  v7 = WFCurrentDeviceCapability();
  LODWORD(v5) = WFCapabilityIsChinaDevice(v7);
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityLearnMoreSection1Title"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = v10;
  if ((_DWORD)v5)
    v12 = CFSTR("kWFLocNetworkQualityLearnMoreSection1TextCH");
  else
    v12 = CFSTR("kWFLocNetworkQualityLearnMoreSection1Text");
  objc_msgSend(v10, "localizedStringForKey:value:table:", v12, &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v30, "addSectionWithHeader:content:", v9, v13);

  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityLearnMoreSection2Title"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityLearnMoreSection2Text"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v30, "addSectionWithHeader:content:", v15, v17);

  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v18, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityLearnMoreSection3Title"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityLearnMoreSection3Text"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v30, "addSectionWithHeader:content:", v19, v21);

  objc_msgSend(MEMORY[0x24BE6E440], "accessoryButton");
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v23, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityKBURL"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v22, "setTitle:forState:", v24, 0);

  objc_msgSend(v22, "addTarget:action:forControlEvents:", self, sel__networkQualityOpenURL, 64);
  objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v25, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityLearnMoreSection4Text"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v30, "addSectionWithHeader:content:accessoryButton:", 0, v26, v22);

  v27 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD410]), "initWithBarButtonSystemItem:target:action:", 0, self, sel_donePressed);
  objc_msgSend(v30, "navigationItem");
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v28, "setRightBarButtonItem:", v27);

  v29 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD7A0]), "initWithRootViewController:", v30);
  -[WFDiagnosticsTableViewController presentViewController:animated:completion:](self, "presentViewController:animated:completion:", v29, 1, 0);
...
- (void)_reloadNetworkQualityCell
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "indexOfObject:", &unk_24DB59788);
...
- (void)_updateNetworkQualityFooterText
{
  ...
  if (v4)
  {
    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityFooterKnown"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v21 = (id)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityFooterLink"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("kWFLocNetworkQualityFooterLastChecked"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!-[WFDiagnosticsTableViewController networkQualitySpinning](self, "networkQualitySpinning"))
  {
    ...
    if (WFCurrentLogLevel() && v3 && os_log_type_enabled(v3, v4))
    {
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_impl(&dword_2196CC000, v3, v4, "NetQuality: %s: User scheduled a run", buf, 0xCu);
    }

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("kWFLocSettingNetworkQualityAlertTitle"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "localizedStringForKey:value:table:", CFSTR("kWFLocSettingNetworkQualityAlertText"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "localizedStringForKey:value:table:", CFSTR("kWFLocSettingNetworkQualityAlertContinue"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "localizedStringForKey:value:table:", CFSTR("kWFLocSettingNetworkQualityAlertCancel"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(MEMORY[0x24BEBD3B0], "alertControllerWithTitle:message:preferredStyle:", v6, v8, 1);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BEBD3A8], "actionWithTitle:style:handler:", v12, 1, &__block_literal_global_2);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v16[3] = &unk_24DB378E8;
    v16[4] = self;
    objc_msgSend(MEMORY[0x24BEBD3A8], "actionWithTitle:style:handler:", v10, 0, v16);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD9F8]), "initWithStyle:reuseIdentifier:", 1, 0);
  ...
  switch(v8)
  {
    case 0:
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsDiagnosis"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    case 1:
      if (!objc_msgSend(v5, "row"))
      {
        ...
        objc_msgSend(v48, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsBSSID"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      if (objc_msgSend(v5, "row") == 1)
      {
        objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v18, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsChannel"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "textLabel");
        v20 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (objc_msgSend(v5, "row") == 2)
      {
        ...
        objc_msgSend(v66, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsSignalStrength"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    ...
    case 2:
      if (!objc_msgSend(v5, "row"))
      {
        ...
        objc_msgSend(v51, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsSecurity"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      if (objc_msgSend(v5, "row") == 1)
      {
        objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v23, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsCaptive"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "textLabel");
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        objc_msgSend(v27, "localizedStringForKey:value:table:", v29, &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      else
      {
        if (objc_msgSend(v5, "row") == 2)
        {
          ...
          objc_msgSend(v75, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsDeployment"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
        ...
        if (objc_msgSend(v5, "row") == 3)
        {
          ...
          objc_msgSend(v99, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsMotion"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    ...
    case 3:
      if (!objc_msgSend(v5, "row"))
      {
        ...
        objc_msgSend(v54, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsGateway"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
...
LABEL_25:
      ...
      if (objc_msgSend(v5, "row") == 1)
      {
        ...
        objc_msgSend(v32, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsInternet"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      if (objc_msgSend(v5, "row") == 2)
      {
        ...
        objc_msgSend(v78, "localizedStringForKey:value:table:", CFSTR("kWFLocSettingNetworkQualityText"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
        ...
        if (WFCurrentLogLevel() && v81)
        {
          ...
          if (os_log_type_enabled(v83, v82))
          {
            ...
            *(_QWORD *)&v109[14] = v86;
            v110 = 2080;
            v111 = v88;
            _os_log_impl(&dword_2196CC000, v83, v82, "NetQuality: %s: Responsiveness is %.1f, execution running? %s", v109, 0x20u);
...
LABEL_57:
    ...
    case 4:
      if (!objc_msgSend(v5, "row"))
      {
        ...
        objc_msgSend(v60, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsBeaconPER"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      if (objc_msgSend(v5, "row") == 1)
      {
        ...
        objc_msgSend(v42, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsTransmitPER"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      objc_msgSend(v89, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsReceivedFrames"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
    ...
    case 5:
      if (objc_msgSend(v5, "row"))
      {
        if (objc_msgSend(v5, "row") == 1)
        {
          ...
          objc_msgSend(v45, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsBluetooth"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
        ...
        else
        {
          ...
          objc_msgSend(v92, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsScan"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
      ...
      else
      {
        ...
        objc_msgSend(v63, "localizedStringForKey:value:table:", CFSTR("kWFLocDiagnosticsAWDLMode"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
