...
- (void)viewDidLoad
{
  ...
  objc_msgSend(v3, "localizedStringForKey:value:table:", CFSTR("kWFLocNANSubscribe"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
...
id __57__WFNANSubscribeTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v12 == 1)
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v13)
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BEBD9F8]), "initWithStyle:reuseIdentifier:", 1, CFSTR("WFNANTableViewTextCellIdentifier"));
    if (!objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 1032), "getSubscribersCount"))
    {
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v28 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v28, "localizedStringForKey:value:table:", CFSTR("kWFLocNANNoSubscribers"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
  ...
  if (!v12)
  {
    if (!objc_msgSend(v8, "row"))
    {
      ...
      objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v25, "localizedStringForKey:value:table:", CFSTR("kWFLocNANServiceName"), &stru_24DB39F78, CFSTR("WiFiKitUILocalizableStrings"));
