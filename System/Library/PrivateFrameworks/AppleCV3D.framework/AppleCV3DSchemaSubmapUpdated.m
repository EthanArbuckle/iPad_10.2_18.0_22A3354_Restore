@implementation AppleCV3DSchemaSubmapUpdated
...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  if (-[AppleCV3DSchemaSubmapUpdated submapId](self, "submapId"))
    PBDataWriterWriteUint64Field();
  if (-[AppleCV3DSchemaSubmapUpdated isLocationAttached](self, "isLocationAttached"))
    PBDataWriterWriteBOOLField();
  v4 = -[AppleCV3DSchemaSubmapUpdated bytesWrittenToDisk](self, "bytesWrittenToDisk");
  v5 = v6;
  if (v4)
  {
    PBDataWriterWriteUint64Field();
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[AppleCV3DSchemaSubmapUpdated bytesWrittenToDisk](self, "bytesWrittenToDisk"));
  ...
  if (self->_isLocationAttached)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[AppleCV3DSchemaSubmapUpdated isLocationAttached](self, "isLocationAttached"));
  ...
  if (self->_submapId)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[AppleCV3DSchemaSubmapUpdated submapId](self, "submapId"));
...
- (NSData)jsonData
{
  ...
  -[AppleCV3DSchemaSubmapUpdated dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (AppleCV3DSchemaSubmapUpdated)initWithJSON:(id)a3
{
  void *v4;
  AppleCV3DSchemaSubmapUpdated *v5;
  uint64_t v7;
  ...
  {
    self = -[AppleCV3DSchemaSubmapUpdated initWithDictionary:](self, "initWithDictionary:", v4);
    v5 = self;
  }
...
- (AppleCV3DSchemaSubmapUpdated)initWithDictionary:(id)a3
{
  id v4;
  AppleCV3DSchemaSubmapUpdated *v5;
  void *v6;
  ...
  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)AppleCV3DSchemaSubmapUpdated;
  v5 = -[AppleCV3DSchemaSubmapUpdated init](&v11, sel_init);
  if (v5)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[AppleCV3DSchemaSubmapUpdated setSubmapId:](v5, "setSubmapId:", objc_msgSend(v6, "unsignedLongLongValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("isLocationAttached"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[AppleCV3DSchemaSubmapUpdated setIsLocationAttached:](v5, "setIsLocationAttached:", objc_msgSend(v7, "BOOLValue"));
    objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("bytesWrittenToDisk"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      -[AppleCV3DSchemaSubmapUpdated setBytesWrittenToDisk:](v5, "setBytesWrittenToDisk:", objc_msgSend(v8, "unsignedLongLongValue"));
    v9 = v5;
