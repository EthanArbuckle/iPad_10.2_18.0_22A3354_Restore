...
{
  objc_storeStrong((id *)&self->super._configuration, a3);
}
...
{
  objc_storeStrong((id *)&self->super._monitorContext, a3);
}
...
{
  objc_storeStrong((id *)&self->super._allowReadToken, a3);
}

- (void)setSafetyCacheKey:(id)a3
{
  objc_storeStrong((id *)&self->super._safetyCacheKey, a3);
}

- (void)setStartMessageGUID:(id)a3
{
  objc_storeStrong((id *)&self->super._startMessageGUID, a3);
}

- (void)setScheduledSendMessageGUID:(id)a3
{
  objc_storeStrong((id *)&self->super._scheduledSendMessageGUID, a3);
}

- (void)setScheduledSendMessageDate:(id)a3
{
  objc_storeStrong((id *)&self->super._scheduledSendMessageDate, a3);
}

- (void)setActiveDeviceIdentifier:(id)a3
{
  objc_storeStrong((id *)&self->super._activeDeviceIdentifier, a3);
}

- (void)setEstimatedEndDate:(id)a3
{
  objc_storeStrong((id *)&self->super._estimatedEndDate, a3);
}

- (void)setCoarseEstimatedEndDate:(id)a3
{
  objc_storeStrong((id *)&self->super._coarseEstimatedEndDate, a3);
}
...
{
  objc_storeStrong((id *)&self->super._sessionStateTransitionDate, a3);
}

- (void)setActivePairedDeviceIdentifier:(id)a3
{
  objc_storeStrong((id *)&self->super._activePairedDeviceIdentifier, a3);
}
