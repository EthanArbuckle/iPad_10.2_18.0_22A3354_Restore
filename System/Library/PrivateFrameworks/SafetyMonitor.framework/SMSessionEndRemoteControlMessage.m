...
- (SMSessionEndRemoteControlMessage)initWithSessionEndReason:(unint64_t)a3 sessionID:(id)a4 sourceDeviceType:(int64_t)a5 sourceDeviceID:(id)a6
{
  ...
  void *v12;
  void *v13;
  SMSessionEndRemoteControlMessage *v14;
  ...
  v14 = -[SMSessionEndRemoteControlMessage initWithDate:messageID:sessionEndReason:sessionID:sourceDeviceType:sourceDeviceID:](self, "initWithDate:messageID:sessionEndReason:sessionID:sourceDeviceType:sourceDeviceID:", v12, v13, a3, v11, a5, v10);
...
- (SMSessionEndRemoteControlMessage)initWithDate:(id)a3 messageID:(id)a4 sessionEndReason:(unint64_t)a5 sessionID:(id)a6 sourceDeviceType:(int64_t)a7 sourceDeviceID:(id)a8
{
  ...
  id v16;
  id v17;
  SMSessionEndRemoteControlMessage *v18;
  SMSessionEndRemoteControlMessage *v19;
  SMSessionEndRemoteControlMessage *v20;
  NSObject *v21;
  const char *v22;
  objc_super v24;
  uint8_t buf[16];
...
- (SMSessionEndRemoteControlMessage)initWithDictionary:(id)a3
{
  ...
  NSObject *v27;
  uint64_t v28;
  SMSessionEndRemoteControlMessage *v29;
  objc_class *v30;
  void *v31;
  void *v32;
  const char *v33;
        ...
        if (v23)
        {
          ...
          if (v24)
          {
            ...
            if (v26)
            {
              ...
              v28 = v25;
              v23 = v60;
              self = -[SMSessionEndRemoteControlMessage initWithDate:messageID:sessionEndReason:sessionID:sourceDeviceType:sourceDeviceID:](self, "initWithDate:messageID:sessionEndReason:sessionID:sourceDeviceType:sourceDeviceID:", v14, v17, v20, v60, v28, v26);
              v29 = self;
            }
            else
            {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          v64 = 2112;
          v65 = v49;
          _os_log_error_impl(&dword_245521000, v47, OS_LOG_TYPE_ERROR, "#RemoteControl,%@,%@,missing sessionEndReason", buf, 0x16u);
...
- (id)outputToDictionary
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInteger:", -[SMSessionEndRemoteControlMessage sessionEndReason](self, "sessionEndReason"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("sessionEndReason"));

  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[SMSessionEndRemoteControlMessage sourceDeviceType](self, "sourceDeviceType"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("idsDeviceType"));

  -[SMSessionEndRemoteControlMessage sourceDeviceID](self, "sourceDeviceID");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeInteger:forKey:", -[SMSessionEndRemoteControlMessage sessionEndReason](self, "sessionEndReason"), CFSTR("sessionEndReason"));
  objc_msgSend(v4, "encodeInteger:forKey:", -[SMSessionEndRemoteControlMessage sourceDeviceType](self, "sourceDeviceType"), CFSTR("idsDeviceType"));
  -[SMSessionEndRemoteControlMessage sourceDeviceID](self, "sourceDeviceID");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (SMSessionEndRemoteControlMessage)initWithCoder:(id)a3
{
  ...
  uint64_t v13;
  NSObject *v14;
  SMSessionEndRemoteControlMessage *v15;
  objc_class *v16;
  void *v17;
  void *v18;
  const char *v19;
...
LABEL_32:
  ...
  if (v8 == 1)
  {
    ...
    if (v11)
    {
      v12 = objc_msgSend(v6, "decodeIntegerForKey:", CFSTR("sessionEndReason"));
      objc_msgSend(v6, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("sourceDeviceId"));
      v13 = objc_claimAutoreleasedReturnValue();
      if (v13)
      {
        v14 = v13;
        self = -[SMSessionEndRemoteControlMessage initWithDate:messageID:sessionEndReason:sessionID:sourceDeviceType:sourceDeviceID:](self, "initWithDate:messageID:sessionEndReason:sessionID:sourceDeviceType:sourceDeviceID:", v10, v9, v12, v11, objc_msgSend(v6, "decodeIntegerForKey:", CFSTR("idsDeviceType")), v13);
        v15 = self;
LABEL_28:
