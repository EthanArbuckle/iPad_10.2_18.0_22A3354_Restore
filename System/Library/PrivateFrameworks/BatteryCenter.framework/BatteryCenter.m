...
void sub_2115B3868(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_2115B3A50(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_2115B4300(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  uint64_t v9;
  va_list va;
...
void sub_2115B5C08(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_2115B5D2C(_Unwind_Exception *exception_object)
{
  _Unwind_Resume(exception_object);
}

void sub_2115B61C4(_Unwind_Exception *a1)
{
  void *v1;
...
id BCStringFromParts(id a1)
{
  ...
  if (a1)
  {
    ...
    v3 = v2;
    v8 = v3;
    v4 = MEMORY[0x212BDD484](v7);
    v5 = (void (**)(_QWORD, _QWORD, _QWORD))v4;
    if ((v1 & 1) != 0)
    {
      (*(void (**)(uint64_t, id, const __CFString *))(v4 + 16))(v4, v3, CFSTR("left"));
      if ((v1 & 2) == 0)
      {
LABEL_4:
        if ((v1 & 4) == 0)
...
LABEL_5:
        ((void (**)(_QWORD, id, const __CFString *))v5)[2](v5, v3, CFSTR("case"));
        goto LABEL_6;
      }
    }
    else if ((v1 & 2) == 0)
    ...
    ((void (**)(_QWORD, id, const __CFString *))v5)[2](v5, v3, CFSTR("right"));
    if ((v1 & 4) == 0)
      goto LABEL_6;
    goto LABEL_5;
  }
