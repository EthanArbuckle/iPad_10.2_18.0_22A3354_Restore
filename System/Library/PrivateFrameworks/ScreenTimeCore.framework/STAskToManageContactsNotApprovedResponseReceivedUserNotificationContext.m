...
{
  id v3;
  STAskToManageContactsNotApprovedResponseReceivedUserNotificationContext *v4;
  uint64_t v5;
  NSString *childName;
  objc_super v8;
...
{
  id v4;
  STAskToManageContactsNotApprovedResponseReceivedUserNotificationContext *v5;
  uint64_t v6;
  NSString *childName;
  objc_super v9;
...
- (void)customizeNotificationContent:(id)a3 withCompletionBlock:(id)a4
{
  ...
  _QWORD v9[4];
  id v10;
  STAskToManageContactsNotApprovedResponseReceivedUserNotificationContext *v11;
  id v12;

  v9[1] = 3221225472;
  v9[2] = __124__STAskToManageContactsNotApprovedResponseReceivedUserNotificationContext_customizeNotificationContent_withCompletionBlock___block_invoke;
  v9[3] = &unk_1E9370AC8;
  v10 = a3;
  v11 = self;
  v12 = a4;
...
uint64_t __124__STAskToManageContactsNotApprovedResponseReceivedUserNotificationContext_customizeNotificationContent_withCompletionBlock___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v2, "localizedUserNotificationStringForKey:arguments:", CFSTR("AskToManageContactsNotApprovedResponseReceivedNotificationTitle"), v4);
  ...
  objc_msgSend(v6, "localizedUserNotificationStringForKey:arguments:", CFSTR("AskToManageContactsNotApprovedResponseReceivedNotificationBody"), v8);
