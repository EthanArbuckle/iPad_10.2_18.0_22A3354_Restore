...
{
  id v4;
  STAgePresetsResetCoreAnalyticsEvent *v5;
  uint64_t v6;
  NSString *sessionId;
  objc_super v9;
  ...
  v5 = -[STAgePresetsResetCoreAnalyticsEvent init](&v9, sel_init);
  if (v5)
  {
...
- (NSString)name
{
  return (NSString *)CFSTR("com.apple.Family.AgePresetsReset");
}

+ (id)description
{
  return CFSTR("AgePresetsReset");
}
...
- (NSDictionary)payload
{
  ...
  -[STAgePresetsResetCoreAnalyticsEvent sessionId](self, "sessionId");
