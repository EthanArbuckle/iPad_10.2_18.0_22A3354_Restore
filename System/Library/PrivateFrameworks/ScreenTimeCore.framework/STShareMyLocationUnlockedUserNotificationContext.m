...
- (STShareMyLocationUnlockedUserNotificationContext)init
{
  ...
  return -[STUserNotificationContext initWithIdentifier:](&v3, sel_initWithIdentifier_, CFSTR("share_my_location_unlocked"));
}
...
- (void)customizeNotificationContent:(id)a3 withCompletionBlock:(id)a4
{
  ...
  v9[1] = 3221225472;
  v9[2] = __101__STShareMyLocationUnlockedUserNotificationContext_customizeNotificationContent_withCompletionBlock___block_invoke;
  v9[3] = &unk_1E9370C08;
  v10 = a3;
  v11 = a4;
  v8.receiver = self;
  v8.super_class = (Class)STShareMyLocationUnlockedUserNotificationContext;
...
uint64_t __101__STShareMyLocationUnlockedUserNotificationContext_customizeNotificationContent_withCompletionBlock___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "localizedUserNotificationStringForKey:arguments:", CFSTR("ShareMyLocationUnlockedUserNotificationTitle"), 0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 32), "setTitle:", v2);

  objc_msgSend(MEMORY[0x1E0CB3940], "localizedUserNotificationStringForKey:arguments:", CFSTR("ShareMyLocationUnlockedUserNotificationBody"), 0);
