id PPLPeopleViewServiceLog()
{
  ...
  return (id)PPLPeopleViewServiceLog_log;
}
...
id PPLPeopleEntitySceneSettingValueDescription(uint64_t a1, void *a2)
{
  ...
  if (a1 != 9000)
    return 0;
  objc_msgSend(a2, "description", v2, v3);
  return (id)objc_claimAutoreleasedReturnValue();
}

void sub_216B13A44(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, id *location, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,id a25)
{
