...
- (UIDelayedAction)init
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", "-[UIDelayedAction init]");
...
{
  return -[UIDelayedAction initWithTarget:action:userInfo:delay:mode:](self, "initWithTarget:action:userInfo:delay:mode:", a3, a4, a5, *MEMORY[0x24BDBCA90], a6);
}
...
- (void)touchWithDelay:(double)a3
{
  ...
  {
    v9 = (NSTimer *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCF40]), "initWithFireDate:interval:target:selector:userInfo:repeats:", v7, self, sel_timerFired_, self->m_userInfo, 0, a3);
    v10 = self->m_timer;
    self->m_timer = v9;
