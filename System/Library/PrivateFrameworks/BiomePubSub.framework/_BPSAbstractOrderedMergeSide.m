...
{
  id v7;
  _BPSAbstractOrderedMergeSide *v8;
  _BPSAbstractOrderedMergeSide *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)_BPSAbstractOrderedMergeSide;
  v8 = -[_BPSAbstractOrderedMergeSide init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_index = a3;
...
- (void)receiveSubscription:(id)a3
{
  ...
  v4 = a3;
  -[_BPSAbstractOrderedMergeSide combiner](self, "combiner");
...
{
  _BPSAbstractOrderedMergeSide *v4;
  id v5;
  void *v6;
  int64_t v7;
  ...
  v4 = self;
  v5 = a3;
  -[_BPSAbstractOrderedMergeSide combiner](v4, "combiner");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_msgSend(v6, "receiveInput:atIndex:", v5, -[_BPSAbstractOrderedMergeSide index](v4, "index"));
...
- (void)receiveCompletion:(id)a3
{
  ...
  v6 = self;
  v4 = a3;
  -[_BPSAbstractOrderedMergeSide combiner](v6, "combiner");
