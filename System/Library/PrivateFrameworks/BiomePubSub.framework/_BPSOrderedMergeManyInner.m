...
- (_BPSOrderedMergeManyInner)initWithDownstream:(id)a3 upstreamCount:(unint64_t)a4 comparator:(id)a5
{
  ...
  v9 = -[_BPSAbstractOrderedMerge initWithDownstream:upstreamCount:](&v13, sel_initWithDownstream_upstreamCount_, a3, a4);
  if (v9)
  {
    v10 = _Block_copy(v8);
...
- (int64_t)compareFirst:(id)a3 withSecond:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  -[_BPSOrderedMergeManyInner comparator](self, "comparator");
