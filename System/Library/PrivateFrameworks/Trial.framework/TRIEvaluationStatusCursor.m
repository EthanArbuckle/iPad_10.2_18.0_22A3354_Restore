...
{
  TRIEvaluationStatusCursor *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TRIEvaluationStatusCursor;
  result = -[TRIEvaluationStatusCursor init](&v5, sel_init);
  if (result)
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (!v7)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TRIEvaluationStatusProvider.m"), 88, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("data"));
