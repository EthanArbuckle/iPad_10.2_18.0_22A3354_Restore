...
{
  void (**v5)(id, TRIFBCloudKitTreatmentRecordAssetBuilder *);
  void *v6;
  TRIFBCloudKitTreatmentRecordAssetBuilder *v7;
  id v8;
  TRIFBCloudKitTreatmentRecordAssetBuilder *v9;
  void *v10;
  _BOOL4 v11;
  uint64_t v12;
  uint64_t v13;
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v26, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 658, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));
  ...
  {
    v27.receiver = v7;
    v27.super_class = (Class)TRIFBCloudKitTreatmentRecordAssetBuilder;
    v9 = (TRIFBCloudKitTreatmentRecordAssetBuilder *)objc_msgSendSuper2(&v27, sel_init);
    v7 = v9;
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        *(_DWORD *)(v12 + 8) = *(_DWORD *)(v13 + 32) - *(_DWORD *)(v13 + 48) + *(_DWORD *)(v13 + 40);
        v7->_bldr = (CloudKitTreatmentRecordAssetBuilder *)v12;
      }
    }
  }
  ...
  if (*v19 < 7u || !v19[3])
  {
    ...
    objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", sel__finish, v7, CFSTR("TRIFBFastFactorLevels_generated.mm"), 602, CFSTR("%@"), CFSTR("Failed to set required field \"treatmentId\" on a table of type: TRIFBCloudKitTreatmentRecordAssetBuilder"));

    v28[0] = *MEMORY[0x1E0CB2D50];
    v27.receiver = CFSTR("Failed to set required field \"treatmentId\" on a table of type: TRIFBCloudKitTreatmentRecordAssetBuilder");
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v27, v28, 1);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    v23 = objc_alloc(MEMORY[0x1E0CB35C8]);
    v24 = (void *)objc_msgSend(v23, "initWithDomain:code:userInfo:", *MEMORY[0x1E0CFCEB0], 4, v22);
    -[AFBBufferBuilder setError:](v7->_owner, "setError:", v24);

LABEL_13:
    v20 = &unk_1E3C194F0;
    goto LABEL_14;
  }
  v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithUnsignedInt:", v17);
LABEL_14:
...
- (id)trifbFinishedBufferWithRootCloudKitTreatmentRecordAssetOfs:()TRIFBCloudKitTreatmentRecordAsset error:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 680, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
  ...
  {
    v26 = 0;
    v12 = objc_msgSend(a1, "trifbFinishBufferWithRootCloudKitTreatmentRecordAssetOfs:error:", v7, &v26);
    v13 = v26;
    if (!v12)
    {
      v9 = 0;
  ...
  else
  {
    ...
    v24[1] = 3221225472;
    v24[2] = __120__AFBBufferBuilder_TRIFBCloudKitTreatmentRecordAsset__trifbFinishedBufferWithRootCloudKitTreatmentRecordAssetOfs_error___block_invoke;
...
- (uint64_t)trifbFinishBufferWithRootCloudKitTreatmentRecordAssetOfs:()TRIFBCloudKitTreatmentRecordAsset error:
{
  ...
  if (!v7)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 714, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (_QWORD)trifbCreateVectorOfCloudKitTreatmentRecordAssetWithOffsets:()TRIFBCloudKitTreatmentRecordAsset
{
  _QWORD *v2;
