...
{
  void (**v5)(id, TRIFBMobileAssetReferenceBuilder *);
  void *v6;
  TRIFBMobileAssetReferenceBuilder *v7;
  id v8;
  TRIFBMobileAssetReferenceBuilder *v9;
  void *v10;
  _BOOL4 v11;
  uint64_t v12;
  uint64_t v13;
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v31, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 2346, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));
  ...
  {
    v32.receiver = v7;
    v32.super_class = (Class)TRIFBMobileAssetReferenceBuilder;
    v9 = (TRIFBMobileAssetReferenceBuilder *)objc_msgSendSuper2(&v32, sel_init);
    v7 = v9;
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        *(_DWORD *)(v12 + 8) = *(_DWORD *)(v13 + 32) - *(_DWORD *)(v13 + 48) + *(_DWORD *)(v13 + 40);
        v7->_bldr = (MobileAssetReferenceBuilder *)v12;
      }
    }
  }
  ...
  if (v20 < 5 || !v19[2])
  {
    ...
    objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", sel__finish, v7, CFSTR("TRIFBFastFactorLevels_generated.mm"), 2238, CFSTR("%@"), CFSTR("Failed to set required field \"type\" on a table of type: TRIFBMobileAssetReferenceBuilder"));

    v33[0] = *MEMORY[0x1E0CB2D50];
    v32.receiver = CFSTR("Failed to set required field \"type\" on a table of type: TRIFBMobileAssetReferenceBuilder");
...
LABEL_20:
  ...
  if (v20 < 7 || !v19[3])
  {
    ...
    objc_msgSend(v26, "handleFailureInMethod:object:file:lineNumber:description:", sel__finish, v7, CFSTR("TRIFBFastFactorLevels_generated.mm"), 2249, CFSTR("%@"), CFSTR("Failed to set required field \"specifier\" on a table of type: TRIFBMobileAssetReferenceBuilder"));

    v33[0] = *MEMORY[0x1E0CB2D50];
    v32.receiver = CFSTR("Failed to set required field \"specifier\" on a table of type: TRIFBMobileAssetReferenceBuilder");
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v32, v33, 1);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v20 < 9 || !v19[4])
  {
    ...
    objc_msgSend(v28, "handleFailureInMethod:object:file:lineNumber:description:", sel__finish, v7, CFSTR("TRIFBFastFactorLevels_generated.mm"), 2260, CFSTR("%@"), CFSTR("Failed to set required field \"version\" on a table of type: TRIFBMobileAssetReferenceBuilder"));

    v33[0] = *MEMORY[0x1E0CB2D50];
    v32.receiver = CFSTR("Failed to set required field \"version\" on a table of type: TRIFBMobileAssetReferenceBuilder");
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v32, v33, 1);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)trifbFinishedBufferWithRootMobileAssetReferenceOfs:()TRIFBMobileAssetReference error:
{
  ...
  if (!v7)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 2368, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
  ...
  {
    v26 = 0;
    v12 = objc_msgSend(a1, "trifbFinishBufferWithRootMobileAssetReferenceOfs:error:", v7, &v26);
    v13 = v26;
    if (!v12)
    {
      v9 = 0;
  ...
  else
  {
    ...
    v24[1] = 3221225472;
    v24[2] = __104__AFBBufferBuilder_TRIFBMobileAssetReference__trifbFinishedBufferWithRootMobileAssetReferenceOfs_error___block_invoke;
...
- (uint64_t)trifbFinishBufferWithRootMobileAssetReferenceOfs:()TRIFBMobileAssetReference error:
{
  ...
  if (!v7)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 2402, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (_QWORD)trifbCreateVectorOfMobileAssetReferenceWithOffsets:()TRIFBMobileAssetReference
{
  _QWORD *v2;
