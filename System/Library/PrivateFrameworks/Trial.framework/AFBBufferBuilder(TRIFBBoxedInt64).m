...
- (id)trifbCreateBoxedInt64FromBoxedInt64:()TRIFBBoxedInt64
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 5305, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("BoxedInt64"));
...
- (id)trifbCreateVectorOfBoxedInt64WithCount:()TRIFBBoxedInt64 block:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 5332, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));
...
- (_QWORD)trifbCreateVectorOfBoxedInt64FromArray:()TRIFBBoxedInt64
{
  _QWORD *v2;
...
- (_QWORD)trifbCreateVectorOfBoxedInt64WithCount:()TRIFBBoxedInt64 block:
{
  _QWORD *v2;
