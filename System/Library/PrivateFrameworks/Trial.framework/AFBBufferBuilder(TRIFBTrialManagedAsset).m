...
{
  void (**v5)(id, TRIFBTrialManagedAssetBuilder *);
  void *v6;
  TRIFBTrialManagedAssetBuilder *v7;
  id v8;
  TRIFBTrialManagedAssetBuilder *v9;
  void *v10;
  _BOOL4 v11;
  uint64_t v12;
  uint64_t v13;
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v29, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 1606, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));
  ...
  {
    v30.receiver = v7;
    v30.super_class = (Class)TRIFBTrialManagedAssetBuilder;
    v9 = (TRIFBTrialManagedAssetBuilder *)objc_msgSendSuper2(&v30, sel_init);
    v7 = v9;
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        *(_DWORD *)(v12 + 8) = *(_DWORD *)(v13 + 32) - *(_DWORD *)(v13 + 48) + *(_DWORD *)(v13 + 40);
        v7->_bldr = (TrialManagedAssetBuilder *)v12;
      }
    }
  }
  ...
  if (v20 < 9 || !v19[4])
  {
    ...
    objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", sel__finish, v7, CFSTR("TRIFBFastFactorLevels_generated.mm"), 1490, CFSTR("%@"), CFSTR("Failed to set required field \"assetId\" on a table of type: TRIFBTrialManagedAssetBuilder"));

    v31[0] = *MEMORY[0x1E0CB2D50];
    v30.receiver = CFSTR("Failed to set required field \"assetId\" on a table of type: TRIFBTrialManagedAssetBuilder");
...
LABEL_17:
  ...
  if (v20 < 0xD || !v19[6])
  {
    ...
    objc_msgSend(v26, "handleFailureInMethod:object:file:lineNumber:description:", sel__finish, v7, CFSTR("TRIFBFastFactorLevels_generated.mm"), 1501, CFSTR("%@"), CFSTR("Failed to set required field \"cloudKitMetadata\" on a table of type: TRIFBTrialManagedAssetBuilder"));

    v31[0] = *MEMORY[0x1E0CB2D50];
    v30.receiver = CFSTR("Failed to set required field \"cloudKitMetadata\" on a table of type: TRIFBTrialManagedAssetBuilder");
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v30, v31, 1);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)trifbFinishedBufferWithRootTrialManagedAssetOfs:()TRIFBTrialManagedAsset error:
{
  ...
  if (!v7)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 1628, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
  ...
  {
    v26 = 0;
    v12 = objc_msgSend(a1, "trifbFinishBufferWithRootTrialManagedAssetOfs:error:", v7, &v26);
    v13 = v26;
    if (!v12)
    {
      v9 = 0;
  ...
  else
  {
    ...
    v24[1] = 3221225472;
    v24[2] = __98__AFBBufferBuilder_TRIFBTrialManagedAsset__trifbFinishedBufferWithRootTrialManagedAssetOfs_error___block_invoke;
...
- (uint64_t)trifbFinishBufferWithRootTrialManagedAssetOfs:()TRIFBTrialManagedAsset error:
{
  ...
  if (!v7)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("TRIFBFastFactorLevels_generated.mm"), 1662, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (_QWORD)trifbCreateVectorOfTrialManagedAssetWithOffsets:()TRIFBTrialManagedAsset
{
  _QWORD *v2;
