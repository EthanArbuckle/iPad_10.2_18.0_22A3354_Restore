...
{
  CDRichComplicationCornerStackedTextView *v3;
  CDRichComplicationCornerStackedTextView *v4;
  void *v5;
  uint64_t v6;
  ...
  v3 = -[CDRichComplicationCornerBaseTextView initWithFontFallback:](&v12, sel_initWithFontFallback_, a3);
  v4 = v3;
  if (v3)
  {
    ...
    -[CLKUICurvedColoringLabel setUsesTextProviderTintColoring:](v4->_outerLabel, "setUsesTextProviderTintColoring:", 1);
  }
  return v4;
}
...
- (void)layoutSubviews
{
  ...
  -[CDRichComplicationCornerBaseTextView layoutSubviews](&v13, sel_layoutSubviews);
  v11 = 0u;
  v12 = 0u;
  v9 = 0u;
  v10 = 0u;
...
- (void)_setFontConfiguration:(CDRichComplicationFontConfiguration *)a3
{
  ...
  -[CDRichComplicationCornerBaseTextView _setFontConfiguration:](&v8, sel__setFontConfiguration_, v9);
  if (a3->var1)
  {
...
- (void)_handleTemplate:(id)a3 reason:(int64_t)a4
{
  ...
  objc_msgSend(v5, "innerTextProvider");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "setTextProvider:", v7);

  outerLabel = self->_outerLabel;
  objc_msgSend(v5, "outerTextProvider");
  v9 = (id)objc_claimAutoreleasedReturnValue();

  -[CLKUICurvedColoringLabel setTextProvider:](outerLabel, "setTextProvider:", v9);
}
...
- (void)_enumerateLabelsWithBlock:(id)a3
{
  ...
  -[CDRichComplicationCornerBaseTextView _enumerateLabelsWithBlock:](&v5, sel__enumerateLabelsWithBlock_, v4);
...
- (void)transitionToMonochromeWithFraction:(double)a3
{
  ...
  -[CDRichComplicationCornerBaseTextView innerLabel](self, "innerLabel");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "transitionToMonochromeWithFraction:style:", 2, a3);
...
- (void)updateMonochromeColor
{
  ...
  -[CDRichComplicationCornerBaseTextView innerLabel](self, "innerLabel");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "updateMonochromeColorWithStyle:", 2);
