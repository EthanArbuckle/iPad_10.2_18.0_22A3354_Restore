...
{
  return -[FTTextToSpeechVoiceResource initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextToSpeechVoiceResource initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoiceResource *)a4
{
  return -[FTTextToSpeechVoiceResource initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoiceResource *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTextToSpeechVoiceResource *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  FTTextToSpeechVoiceResource *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTTextToSpeechVoiceResource init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
{
  FTTextToSpeechVoiceResource *v4;
  int v5;
  int v6;
  int v7;
  _QWORD v9[6];
  ...
  v4 = self;
  v5 = -[FTTextToSpeechVoiceResource type](self, "type");
  v10 = 0;
  v11 = &v10;
  v12 = 0x3812000000;
  ...
  v9[4] = &v10;
  v9[5] = a3;
  -[FTTextToSpeechVoiceResource data:](v4, "data:", v9);
  *((_BYTE *)a3 + 70) = 1;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextToSpeechVoiceResource addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __43__FTTextToSpeechVoiceResource_flatbuffData__block_invoke;
