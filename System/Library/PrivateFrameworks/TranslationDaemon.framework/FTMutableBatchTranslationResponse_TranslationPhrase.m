...
{
  FTMutableBatchTranslationResponse_TranslationPhrase *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableBatchTranslationResponse_TranslationPhrase init](&v6, sel_init);
  if (v2)
  {
...
{
  return (NSString *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("translation_phrase"));
}
...
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("repeated_spans"));
}
...
{
  return (FTTranslationPhraseMetaInfo *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("meta_info_data"));
}
