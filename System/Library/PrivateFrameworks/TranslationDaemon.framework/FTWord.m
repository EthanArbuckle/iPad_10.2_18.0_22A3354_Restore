...
{
  return -[FTWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTWord)initWithFlatbuffData:(id)a3 root:(const Word *)a4
{
  return -[FTWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTWord)initWithFlatbuffData:(id)a3 root:(const Word *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::Word *v19;
  FTWord *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
...
- (void)pronunciations:(id)a3
{
  ...
  v10 = v4;
  (*((void (**)(id, const Word *, _QWORD))v4 + 2))(v4, v9 + 4, *(unsigned int *)root[v7 + v8].var0);
...
- (Offset<siri::speech::schema_fb::Word>)addObjectToBuffer:(void *)a3
{
  ...
  int v16;
  int v17;
  Offset<siri::speech::schema_fb::Word> v18;
  _QWORD v20[6];
  uint64_t v21;
  uint64_t *v22;
  uint64_t v23;
  ...
  -[FTWord orthography](self, "orthography");
  ...
  v20[4] = &v21;
  v20[5] = a3;
  -[FTWord pronunciations:](self, "pronunciations:", v20);
  v10 = -[FTWord frequency](self, "frequency");
  -[FTWord tag](self, "tag");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 6, *((_DWORD *)v22 + 12));
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((char *)a3, 8, v10, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 10, (int)v13);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTWord addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __22__FTWord_flatbuffData__block_invoke;
