...
{
  return -[FTTextToSpeechCacheObject initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextToSpeechCacheObject initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4
{
  return -[FTTextToSpeechCacheObject initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::TextToSpeechCacheObject *v19;
  FTTextToSpeechCacheObject *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTTextToSpeechCacheObject init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)word_timing_info
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTTextToSpeechCacheObject word_timing_info_enumerateObjectsUsingBlock:](self, "word_timing_info_enumerateObjectsUsingBlock:", v6);
...
- (void)word_timing_info_enumerateObjectsUsingBlock:(id)a3
{
  ...
  void *v6;
  const TextToSpeechCacheObject *root;
  const TextToSpeechCacheObject *v8;
  uint64_t v9;
  const TextToSpeechCacheObject *v10;
  uint64_t v11;
  uint64_t v12;
...
- (Offset<siri::speech::schema_fb::TextToSpeechCacheObject>)addObjectToBuffer:(void *)a3
{
  ...
  v34[4] = &v35;
  v34[5] = a3;
  -[FTTextToSpeechCacheObject audio:](self, "audio:", v34);
  memset(&v33, 0, sizeof(v33));
  -[FTTextToSpeechCacheObject word_timing_info](self, "word_timing_info");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v29 = 0u;
  v30 = 0u;
  -[FTTextToSpeechCacheObject word_timing_info](self, "word_timing_info", 0);
  ...
  if (v33.__end_ == v33.__begin_)
    v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::WordTimingInfo>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::WordTimingInfo>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::WordTimingInfo>> const&)::t;
  else
    v22 = v33.__begin_;
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  v25 = *((_DWORD *)a3 + 12);
  v26 = *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 4, *((_DWORD *)v36 + 12));
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextToSpeechCacheObject addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __41__FTTextToSpeechCacheObject_flatbuffData__block_invoke;
