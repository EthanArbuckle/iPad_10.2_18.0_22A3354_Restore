...
{
  FTMutableAsrKeywordFinderMessage *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableAsrKeywordFinderMessage init](&v6, sel_init);
  if (v2)
  {
...
- (FTKeywordFinderRequest)session_messageAsFTKeywordFinderRequest
{
  ...
  if (-[FTMutableAsrKeywordFinderMessage session_message_type](self, "session_message_type") == 1)
  {
...
- (void)setSession_messageAsFTKeywordFinderRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableAsrKeywordFinderMessage setSession_message_type:](self, "setSession_message_type:", 1);
...
- (FTKeywordFinderResponse)session_messageAsFTKeywordFinderResponse
{
  ...
  if (-[FTMutableAsrKeywordFinderMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTKeywordFinderResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableAsrKeywordFinderMessage setSession_message_type:](self, "setSession_message_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
