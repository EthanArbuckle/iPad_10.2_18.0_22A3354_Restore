...
{
  id v5;
  FTBatchTranslationStreamingContext *v6;
  FTBatchTranslationStreamingContext *v7;
  FTBatchTranslationStreamingContext *v8;
  objc_super v10;

  v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)FTBatchTranslationStreamingContext;
  v6 = -[FTBatchTranslationStreamingContext init](&v10, sel_init);
  v7 = v6;
  if (v6)
  {
