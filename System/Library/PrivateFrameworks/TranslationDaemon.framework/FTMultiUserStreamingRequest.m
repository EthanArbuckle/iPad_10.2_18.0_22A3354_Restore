...
{
  return -[FTMultiUserStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTMultiUserStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTMultiUserStreamingRequest)initWithFlatbuffData:(id)a3 root:(const MultiUserStreamingRequest *)a4
{
  return -[FTMultiUserStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTMultiUserStreamingRequest)initWithFlatbuffData:(id)a3 root:(const MultiUserStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTMultiUserStreamingRequest *v10;
  FTMultiUserStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::MultiUserStreamingRequest *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTMultiUserStreamingRequest *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTMultiUserStreamingRequest init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (FTMultiUserStartSpeechRequest)contentAsFTMultiUserStartSpeechRequest
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (FTUpdateAudioInfo)contentAsFTUpdateAudioInfo
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetRequestOrigin)contentAsFTSetRequestOrigin
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetSpeechContext)contentAsFTSetSpeechContext
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetSpeechProfile)contentAsFTSetSpeechProfile
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetEndpointerState)contentAsFTSetEndpointerState
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTAudioPacket)contentAsFTAudioPacket
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTFinishAudio)contentAsFTFinishAudio
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTResetServerEndpointer)contentAsFTResetServerEndpointer
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 9)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetAlternateRecognitionSausage)contentAsFTSetAlternateRecognitionSausage
{
  ...
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 10)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FLTBFBufferAccessor)content
{
  ...
  switch(-[FTMultiUserStreamingRequest content_type](self, "content_type"))
  {
    case 1:
      -[FTMultiUserStreamingRequest contentAsFTMultiUserStartSpeechRequest](self, "contentAsFTMultiUserStartSpeechRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 2:
      -[FTMultiUserStreamingRequest contentAsFTUpdateAudioInfo](self, "contentAsFTUpdateAudioInfo");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 3:
      -[FTMultiUserStreamingRequest contentAsFTSetRequestOrigin](self, "contentAsFTSetRequestOrigin");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 4:
      -[FTMultiUserStreamingRequest contentAsFTSetSpeechContext](self, "contentAsFTSetSpeechContext");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 5:
      -[FTMultiUserStreamingRequest contentAsFTSetSpeechProfile](self, "contentAsFTSetSpeechProfile");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 6:
      -[FTMultiUserStreamingRequest contentAsFTSetEndpointerState](self, "contentAsFTSetEndpointerState");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 7:
      -[FTMultiUserStreamingRequest contentAsFTAudioPacket](self, "contentAsFTAudioPacket");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 8:
      -[FTMultiUserStreamingRequest contentAsFTFinishAudio](self, "contentAsFTFinishAudio");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 9:
      -[FTMultiUserStreamingRequest contentAsFTResetServerEndpointer](self, "contentAsFTResetServerEndpointer");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 10:
      -[FTMultiUserStreamingRequest contentAsFTSetAlternateRecognitionSausage](self, "contentAsFTSetAlternateRecognitionSausage");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    default:
      v3 = 0;
...
- (Offset<siri::speech::qss_fb::MultiUserStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTMultiUserStreamingRequest content_type](self, "content_type");
  if (-[FTMultiUserStreamingRequest content_type](self, "content_type") == 1)
  {
    -[FTMultiUserStreamingRequest contentAsFTMultiUserStartSpeechRequest](self, "contentAsFTMultiUserStartSpeechRequest");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTMultiUserStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __43__FTMultiUserStreamingRequest_flatbuffData__block_invoke;
