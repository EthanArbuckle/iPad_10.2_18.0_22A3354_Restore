...
{
  FTMutableTtsTextToSpeechStreamingMessage *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTtsTextToSpeechStreamingMessage init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartTextToSpeechStreamingRequest)session_messageAsFTStartTextToSpeechStreamingRequest
{
  ...
  if (-[FTMutableTtsTextToSpeechStreamingMessage session_message_type](self, "session_message_type") == 1)
  {
...
- (void)setSession_messageAsFTStartTextToSpeechStreamingRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTtsTextToSpeechStreamingMessage setSession_message_type:](self, "setSession_message_type:", 1);
...
- (FTQssAckResponse)session_messageAsFTQssAckResponse
{
  ...
  if (-[FTMutableTtsTextToSpeechStreamingMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTQssAckResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTtsTextToSpeechStreamingMessage setSession_message_type:](self, "setSession_message_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTBeginTextToSpeechStreamingResponse)session_messageAsFTBeginTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTtsTextToSpeechStreamingMessage session_message_type](self, "session_message_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTBeginTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTtsTextToSpeechStreamingMessage setSession_message_type:](self, "setSession_message_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTPartialTextToSpeechStreamingResponse)session_messageAsFTPartialTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTtsTextToSpeechStreamingMessage session_message_type](self, "session_message_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTPartialTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTtsTextToSpeechStreamingMessage setSession_message_type:](self, "setSession_message_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTFinalTextToSpeechStreamingResponse)session_messageAsFTFinalTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTtsTextToSpeechStreamingMessage session_message_type](self, "session_message_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTFinalTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTtsTextToSpeechStreamingMessage setSession_message_type:](self, "setSession_message_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
