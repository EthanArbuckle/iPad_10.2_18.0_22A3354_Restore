...
- (void)performShortcutFuzzyMatch:(id)a3 requestBuilder:(id)a4 completion:(id)a5
{
  ...
  v11 = v9;
  v13 = v11;
  -[OspreyChannel unaryRequestWithMethodName:requestData:requestBuilder:responseHandler:](self, "unaryRequestWithMethodName:requestData:requestBuilder:responseHandler:", CFSTR("/siri.speech.qss_fb.Nl/ShortcutFuzzyMatch"), v10, v8, v12);
...
void __67__FTNlService_performShortcutFuzzyMatch_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    v6 = -[FTShortcutFuzzyMatchResponse initAndVerifyWithFlatbuffData:]([FTShortcutFuzzyMatchResponse alloc], "initAndVerifyWithFlatbuffData:", v8);
    if (v6)
    {
      (*(void (**)(void))(*(_QWORD *)(a1 + 32) + 16))();
    }
