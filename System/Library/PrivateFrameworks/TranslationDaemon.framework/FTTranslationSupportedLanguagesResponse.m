...
{
  return -[FTTranslationSupportedLanguagesResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTranslationSupportedLanguagesResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTranslationSupportedLanguagesResponse)initWithFlatbuffData:(id)a3 root:(const TranslationSupportedLanguagesResponse *)a4
{
  return -[FTTranslationSupportedLanguagesResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTranslationSupportedLanguagesResponse)initWithFlatbuffData:(id)a3 root:(const TranslationSupportedLanguagesResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTranslationSupportedLanguagesResponse *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::TranslationSupportedLanguagesResponse *v19;
  FTTranslationSupportedLanguagesResponse *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTTranslationSupportedLanguagesResponse init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)language_pairs
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTTranslationSupportedLanguagesResponse language_pairs_enumerateObjectsUsingBlock:](self, "language_pairs_enumerateObjectsUsingBlock:", v6);
...
- (id)language_pairs_objectAtIndex:(unint64_t)a3
{
  void *v5;
  void *v6;
  FTTranslationSupportedLanguagesResponse_LanguagePair *v7;
  FTTranslationSupportedLanguagesResponse_LanguagePair *v8;
  const TranslationSupportedLanguagesResponse *root;
  ...
  if (v5)
  {
    ...
    v7 = (FTTranslationSupportedLanguagesResponse_LanguagePair *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    root = self->_root;
    ...
    v7 = -[FTTranslationSupportedLanguagesResponse_LanguagePair initWithFlatbuffData:root:verify:]([FTTranslationSupportedLanguagesResponse_LanguagePair alloc], "initWithFlatbuffData:root:verify:", self->_data, v12 + 4 + *(unsigned int *)(v12 + 4), 0);
  }
  v8 = v7;
LABEL_8:
...
{
  void (**v4)(id, FTTranslationSupportedLanguagesResponse_LanguagePair *, uint64_t, unsigned __int8 *);
  void *v5;
  void *v6;
  const TranslationSupportedLanguagesResponse *root;
  const TranslationSupportedLanguagesResponse *v8;
  uint64_t v9;
  const TranslationSupportedLanguagesResponse *v10;
  uint64_t v11;
  uint64_t v12;
  ...
  uint64_t v15;
  uint64_t v16;
  FTTranslationSupportedLanguagesResponse_LanguagePair *v17;
  int v18;
  uint64_t v19;
  unsigned __int8 v20;

  v4 = (void (**)(id, FTTranslationSupportedLanguagesResponse_LanguagePair *, uint64_t, unsigned __int8 *))a3;
  -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("language_pairs"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
    ...
    if (*(unsigned __int16 *)v8->var0 >= 0xBu)
    {
      ...
      if (v9)
      {
        ...
        if ((_DWORD)v12)
        {
          ...
          do
          {
            v17 = -[FTTranslationSupportedLanguagesResponse_LanguagePair initWithFlatbuffData:root:verify:]([FTTranslationSupportedLanguagesResponse_LanguagePair alloc], "initWithFlatbuffData:root:verify:", self->_data, v13 + v14 + *(unsigned int *)(v13 + 4 * v15), 0);
            v4[2](v4, v17, v15, &v20);
            v18 = v20;
...
- (Offset<siri::speech::schema_fb::TranslationSupportedLanguagesResponse>)addObjectToBuffer:(void *)a3
{
  ...
  int v35;
  int v36;
  Offset<siri::speech::schema_fb::TranslationSupportedLanguagesResponse> v37;
  int v39;
  int v40;
  int v41;
  __int128 v42;
  ...
  -[FTTranslationSupportedLanguagesResponse request_id](self, "request_id");
  ...
  v10 = -[FTTranslationSupportedLanguagesResponse return_code](self, "return_code");
  -[FTTranslationSupportedLanguagesResponse return_string](self, "return_string");
  ...
  -[FTTranslationSupportedLanguagesResponse language_pairs](self, "language_pairs");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v46, objc_msgSend(v15, "count"));
  ...
  if (v17)
  {
    ...
    do
    {
      for (i = 0; i != v17; ++i)
      {
        ...
        v20 = objc_msgSend(*(id *)(*((_QWORD *)&v42 + 1) + 8 * i), "addObjectToBuffer:", a3);
        v21 = v20;
        end = v46.__end_;
  ...
  if (v46.__end_ == v46.__begin_)
    v32 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TranslationSupportedLanguagesResponse_::LanguagePair>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TranslationSupportedLanguagesResponse_::LanguagePair>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TranslationSupportedLanguagesResponse_::LanguagePair>> const&)::t;
  else
    v32 = v46.__begin_;
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((char *)a3, 6, v41, 0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTranslationSupportedLanguagesResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __55__FTTranslationSupportedLanguagesResponse_flatbuffData__block_invoke;
