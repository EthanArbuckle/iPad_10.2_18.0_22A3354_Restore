...
{
  FTMutableBlazarBatchTranslationMessage *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableBlazarBatchTranslationMessage init](&v6, sel_init);
  if (v2)
  {
...
- (FTBatchTranslationRequest)session_messageAsFTBatchTranslationRequest
{
  ...
  if (-[FTMutableBlazarBatchTranslationMessage session_message_type](self, "session_message_type") == 1)
  {
...
- (void)setSession_messageAsFTBatchTranslationRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarBatchTranslationMessage setSession_message_type:](self, "setSession_message_type:", 1);
...
- (FTBatchTranslationFeedbackRequest)session_messageAsFTBatchTranslationFeedbackRequest
{
  ...
  if (-[FTMutableBlazarBatchTranslationMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTBatchTranslationFeedbackRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarBatchTranslationMessage setSession_message_type:](self, "setSession_message_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTBatchTranslationLoggingRequest)session_messageAsFTBatchTranslationLoggingRequest
{
  ...
  if (-[FTMutableBlazarBatchTranslationMessage session_message_type](self, "session_message_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTBatchTranslationLoggingRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarBatchTranslationMessage setSession_message_type:](self, "setSession_message_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTTranslationSupportedLanguagesRequest)session_messageAsFTTranslationSupportedLanguagesRequest
{
  ...
  if (-[FTMutableBlazarBatchTranslationMessage session_message_type](self, "session_message_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTTranslationSupportedLanguagesRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarBatchTranslationMessage setSession_message_type:](self, "setSession_message_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTBatchTranslationResponse)session_messageAsFTBatchTranslationResponse
{
  ...
  if (-[FTMutableBlazarBatchTranslationMessage session_message_type](self, "session_message_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTBatchTranslationResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarBatchTranslationMessage setSession_message_type:](self, "setSession_message_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTFinalBlazarResponse)session_messageAsFTFinalBlazarResponse
{
  ...
  if (-[FTMutableBlazarBatchTranslationMessage session_message_type](self, "session_message_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTFinalBlazarResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarBatchTranslationMessage setSession_message_type:](self, "setSession_message_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTTranslationSupportedLanguagesResponse)session_messageAsFTTranslationSupportedLanguagesResponse
{
  ...
  if (-[FTMutableBlazarBatchTranslationMessage session_message_type](self, "session_message_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTTranslationSupportedLanguagesResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarBatchTranslationMessage setSession_message_type:](self, "setSession_message_type:", 7);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
