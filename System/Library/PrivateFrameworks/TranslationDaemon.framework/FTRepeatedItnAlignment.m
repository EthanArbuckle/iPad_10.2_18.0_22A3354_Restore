...
{
  return -[FTRepeatedItnAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTRepeatedItnAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4
{
  return -[FTRepeatedItnAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTRepeatedItnAlignment *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const RepeatedItnAlignment *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::RepeatedItnAlignment *v19;
  FTRepeatedItnAlignment *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTRepeatedItnAlignment init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)itn_alignment
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("itn_alignment"));
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTRepeatedItnAlignment itn_alignment_enumerateObjectsUsingBlock:](self, "itn_alignment_enumerateObjectsUsingBlock:", v6);
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_storage, "setObject:forKeyedSubscript:", v3, CFSTR("itn_alignment"));
...
- (id)itn_alignment_objectAtIndex:(unint64_t)a3
{
  ...
  FTItnAlignment *v8;
  const RepeatedItnAlignment *root;
  const RepeatedItnAlignment *v10;
  uint64_t v11;
  uint64_t v12;
...
- (Offset<siri::speech::schema_fb::RepeatedItnAlignment>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v25;
  uint64_t v26;
  Offset<siri::speech::schema_fb::RepeatedItnAlignment> v27;
  __int128 v29;
  __int128 v30;
  __int128 v31;
  __int128 v32;
  ...
  -[FTRepeatedItnAlignment itn_alignment](self, "itn_alignment");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v29 = 0u;
  v30 = 0u;
  -[FTRepeatedItnAlignment itn_alignment](self, "itn_alignment", 0);
  ...
  if (v33.__end_ == v33.__begin_)
    v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::ItnAlignment>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::ItnAlignment>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::ItnAlignment>> const&)::t;
  else
    v22 = v33.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTRepeatedItnAlignment addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __38__FTRepeatedItnAlignment_flatbuffData__block_invoke;
