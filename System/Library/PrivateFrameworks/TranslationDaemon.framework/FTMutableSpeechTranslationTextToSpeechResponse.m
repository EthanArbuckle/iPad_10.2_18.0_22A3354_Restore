...
{
  FTMutableSpeechTranslationTextToSpeechResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableSpeechTranslationTextToSpeechResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTTextToSpeechResponse *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("text_to_speech_response"));
}
