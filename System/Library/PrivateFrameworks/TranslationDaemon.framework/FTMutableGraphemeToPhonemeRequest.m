...
{
  FTMutableGraphemeToPhonemeRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableGraphemeToPhonemeRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTContextWithPronHints *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("context_with_pron_hints"));
}
