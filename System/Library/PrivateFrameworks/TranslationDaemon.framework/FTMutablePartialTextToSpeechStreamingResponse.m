...
{
  FTMutablePartialTextToSpeechStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutablePartialTextToSpeechStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (void)audio:(id)a3
{
  ...
  -[FTMutablePartialTextToSpeechStreamingResponse audio](self, "audio");
