...
{
  FTMutableTextToSpeechSpeechFeatureRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTextToSpeechSpeechFeatureRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTTextToSpeechSpeechFeatureModelIdentifier *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("model_id"));
}
...
{
  return (FTTextToSpeechSpeechFeatureInputText *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("text"));
}
...
- (NSArray)lexicon
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("lexicon"));
}
...
- (BOOL)support_homograph
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("support_homograph"));
