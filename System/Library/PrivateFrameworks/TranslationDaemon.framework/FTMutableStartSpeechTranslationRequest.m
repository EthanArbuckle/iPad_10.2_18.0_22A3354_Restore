...
{
  FTMutableStartSpeechTranslationRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableStartSpeechTranslationRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTTranslationRequest *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("translation_request"));
}
