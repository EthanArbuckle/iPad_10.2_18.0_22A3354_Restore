...
{
  return -[FTPostItnHammerResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTPostItnHammerResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4
{
  return -[FTPostItnHammerResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTPostItnHammerResponse *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const PostItnHammerResponse *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::PostItnHammerResponse *v19;
  FTPostItnHammerResponse *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTPostItnHammerResponse init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSString)speech_id
{
  ...
  uint64_t v4;
  uint64_t v5;
  const PostItnHammerResponse *v6;
...
{
  const PostItnHammerResponse *root;
  const PostItnHammerResponse *v3;
  uint64_t v4;
...
- (NSArray)tokens
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTPostItnHammerResponse tokens_enumerateObjectsUsingBlock:](self, "tokens_enumerateObjectsUsingBlock:", v6);
...
- (id)tokens_objectAtIndex:(unint64_t)a3
{
  ...
  const PostItnHammerResponse *root;
  const PostItnHammerResponse *v10;
  uint64_t v11;
  uint64_t v12;
...
- (unint64_t)tokens_count
{
  ...
  unint64_t v5;
  const PostItnHammerResponse *root;
  const PostItnHammerResponse *v7;
  uint64_t v8;
...
- (void)tokens_enumerateObjectsUsingBlock:(id)a3
{
  ...
  void *v6;
  const PostItnHammerResponse *root;
  const PostItnHammerResponse *v8;
  uint64_t v9;
  const PostItnHammerResponse *v10;
  uint64_t v11;
  uint64_t v12;
...
- (Offset<siri::speech::schema_fb::PostItnHammerResponse>)addObjectToBuffer:(void *)a3
{
  ...
  int v45;
  int v46;
  Offset<siri::speech::schema_fb::PostItnHammerResponse> v47;
  int v49;
  int v50;
  int v51;
  int v52;
  ...
  -[FTPostItnHammerResponse speech_id](self, "speech_id");
  ...
  -[FTPostItnHammerResponse session_id](self, "session_id");
  ...
  -[FTPostItnHammerResponse language](self, "language");
  ...
  v20 = -[FTPostItnHammerResponse return_code](self, "return_code");
  -[FTPostItnHammerResponse return_str](self, "return_str");
  ...
  -[FTPostItnHammerResponse tokens](self, "tokens");
  ...
  if (v58.__end_ == v58.__begin_)
    v42 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>> const&)::t;
  else
    v42 = v58.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTPostItnHammerResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __39__FTPostItnHammerResponse_flatbuffData__block_invoke;
