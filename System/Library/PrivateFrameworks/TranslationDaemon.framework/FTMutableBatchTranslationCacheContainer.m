...
{
  FTMutableBatchTranslationCacheContainer *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableBatchTranslationCacheContainer init](&v6, sel_init);
  if (v2)
  {
...
- (int)sentence_count
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("sentence_count"));
