...
{
  return -[FTLanguageDetected initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTLanguageDetected initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4
{
  return -[FTLanguageDetected initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::LanguageDetected *v19;
  FTLanguageDetected *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTLanguageDetected init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)predictions
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTLanguageDetected predictions_enumerateObjectsUsingBlock:](self, "predictions_enumerateObjectsUsingBlock:", v6);
...
- (Offset<siri::speech::schema_fb::LanguageDetected>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTLanguageDetected detected_locale](self, "detected_locale");
  ...
  -[FTLanguageDetected predictions](self, "predictions");
  ...
  if (v38.__end_ == v38.__begin_)
    v26 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageDetectionPrediction>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageDetectionPrediction>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageDetectionPrediction>> const&)::t;
  else
    v26 = v38.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTLanguageDetected addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __34__FTLanguageDetected_flatbuffData__block_invoke;
