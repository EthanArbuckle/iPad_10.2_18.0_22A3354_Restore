...
{
  return -[FTSetRequestOrigin initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTSetRequestOrigin initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTSetRequestOrigin)initWithFlatbuffData:(id)a3 root:(const SetRequestOrigin *)a4
{
  return -[FTSetRequestOrigin initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTSetRequestOrigin)initWithFlatbuffData:(id)a3 root:(const SetRequestOrigin *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::SetRequestOrigin *v19;
  FTSetRequestOrigin *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTSetRequestOrigin init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::SetRequestOrigin>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = self;
  -[FTSetRequestOrigin latitude](self, "latitude");
  v6 = v5;
  -[FTSetRequestOrigin longitude](v4, "longitude");
  v8 = v7;
  LODWORD(v4) = -[FTSetRequestOrigin enable_geo_location_features](v4, "enable_geo_location_features");
  *((_BYTE *)a3 + 70) = 1;
  v9 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<double>((char *)a3, 4, v6, 0.0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<double>((char *)a3, 6, v8, 0.0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTSetRequestOrigin addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __34__FTSetRequestOrigin_flatbuffData__block_invoke;
