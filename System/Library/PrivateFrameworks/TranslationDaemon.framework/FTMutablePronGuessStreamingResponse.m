...
{
  FTMutablePronGuessStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutablePronGuessStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (FTPronGuessResponse)contentAsFTPronGuessResponse
{
  ...
  if (-[FTMutablePronGuessStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTPronGuessResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutablePronGuessStreamingResponse setContent_type:](self, "setContent_type:", 1);
