...
{
  return -[FTLanguageDetectionStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTLanguageDetectionStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionStreamingRequest *)a4
{
  return -[FTLanguageDetectionStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTLanguageDetectionStreamingRequest *v10;
  FTLanguageDetectionStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::LanguageDetectionStreamingRequest *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTLanguageDetectionStreamingRequest *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTLanguageDetectionStreamingRequest init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (FTStartLanguageDetectionRequest)contentAsFTStartLanguageDetectionRequest
{
  ...
  if (-[FTLanguageDetectionStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (FTAudioPacket)contentAsFTAudioPacket
{
  ...
  if (-[FTLanguageDetectionStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTFinishAudio)contentAsFTFinishAudio
{
  ...
  if (-[FTLanguageDetectionStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FLTBFBufferAccessor)content
{
  ...
  v3 = -[FTLanguageDetectionStreamingRequest content_type](self, "content_type");
  switch(v3)
  {
    case 3:
      -[FTLanguageDetectionStreamingRequest contentAsFTFinishAudio](self, "contentAsFTFinishAudio");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 2:
      -[FTLanguageDetectionStreamingRequest contentAsFTAudioPacket](self, "contentAsFTAudioPacket");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 1:
      -[FTLanguageDetectionStreamingRequest contentAsFTStartLanguageDetectionRequest](self, "contentAsFTStartLanguageDetectionRequest");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    default:
      v4 = 0;
...
- (Offset<siri::speech::qss_fb::LanguageDetectionStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTLanguageDetectionStreamingRequest content_type](self, "content_type");
  if (-[FTLanguageDetectionStreamingRequest content_type](self, "content_type") == 1)
  {
    -[FTLanguageDetectionStreamingRequest contentAsFTStartLanguageDetectionRequest](self, "contentAsFTStartLanguageDetectionRequest");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTLanguageDetectionStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __51__FTLanguageDetectionStreamingRequest_flatbuffData__block_invoke;
