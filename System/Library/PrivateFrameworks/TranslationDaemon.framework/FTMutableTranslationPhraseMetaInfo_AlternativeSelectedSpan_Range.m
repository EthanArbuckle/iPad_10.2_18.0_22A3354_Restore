...
{
  FTMutableTranslationPhraseMetaInfo_AlternativeSelectedSpan_Range *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTranslationPhraseMetaInfo_AlternativeSelectedSpan_Range init](&v6, sel_init);
  if (v2)
  {
...
- (int)start
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("start"));
