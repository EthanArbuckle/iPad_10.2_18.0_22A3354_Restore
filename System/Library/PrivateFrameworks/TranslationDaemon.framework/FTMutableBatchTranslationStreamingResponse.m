...
{
  FTMutableBatchTranslationStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableBatchTranslationStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (FTBatchTranslationResponse)contentAsFTBatchTranslationResponse
{
  ...
  if (-[FTMutableBatchTranslationStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTBatchTranslationResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBatchTranslationStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (FTFinalBlazarResponse)contentAsFTFinalBlazarResponse
{
  ...
  if (-[FTMutableBatchTranslationStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTFinalBlazarResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBatchTranslationStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTTranslationSupportedLanguagesResponse)contentAsFTTranslationSupportedLanguagesResponse
{
  ...
  if (-[FTMutableBatchTranslationStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTTranslationSupportedLanguagesResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBatchTranslationStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
