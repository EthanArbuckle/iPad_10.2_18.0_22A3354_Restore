...
{
  FTMutableTextToSpeechSpeechFeatureInputWave *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTextToSpeechSpeechFeatureInputWave init](&v6, sel_init);
  if (v2)
  {
...
- (void)pcm_data:(id)a3
{
  ...
  -[FTMutableTextToSpeechSpeechFeatureInputWave pcm_data](self, "pcm_data");
