...
{
  return -[FTAsrTextNormalizationMessage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTAsrTextNormalizationMessage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTAsrTextNormalizationMessage)initWithFlatbuffData:(id)a3 root:(const AsrTextNormalizationMessage *)a4
{
  return -[FTAsrTextNormalizationMessage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTAsrTextNormalizationMessage)initWithFlatbuffData:(id)a3 root:(const AsrTextNormalizationMessage *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTAsrTextNormalizationMessage *v10;
  FTAsrTextNormalizationMessage *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::AsrTextNormalizationMessage *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTAsrTextNormalizationMessage *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTAsrTextNormalizationMessage init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
{
  const AsrTextNormalizationMessage *root;
  const AsrTextNormalizationMessage *v3;
  uint64_t v4;
...
{
  FTTextNormalizationRequest *v3;
  FTTextNormalizationRequest *v4;
  const AsrTextNormalizationMessage *root;
  const AsrTextNormalizationMessage *v6;
  uint64_t v7;
  const AsrTextNormalizationMessage *v8;

  if (-[FTAsrTextNormalizationMessage session_message_type](self, "session_message_type") == 1)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (FTTextNormalizationRequest *)objc_claimAutoreleasedReturnValue();
    if (!v3)
    {
      ...
      if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
        ...
        v8 = 0;
      v3 = -[FTTextNormalizationRequest initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
{
  FTTextNormalizationResponse *v3;
  FTTextNormalizationResponse *v4;
  const AsrTextNormalizationMessage *root;
  const AsrTextNormalizationMessage *v6;
  uint64_t v7;
  const AsrTextNormalizationMessage *v8;

  if (-[FTAsrTextNormalizationMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (FTTextNormalizationResponse *)objc_claimAutoreleasedReturnValue();
    if (!v3)
    {
      ...
      if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
        ...
        v8 = 0;
      v3 = -[FTTextNormalizationResponse initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
      -[NSMutableDictionary setObject:forKeyedSubscript:](self->_storage, "setObject:forKeyedSubscript:", v3, CFSTR("session_message"));
    }
  }
  else
...
- (FLTBFBufferAccessor)session_message
{
  ...
  v3 = -[FTAsrTextNormalizationMessage session_message_type](self, "session_message_type");
  if (v3 == 2)
  {
    -[FTAsrTextNormalizationMessage session_messageAsFTTextNormalizationResponse](self, "session_messageAsFTTextNormalizationResponse");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (v3 == 1)
  {
    -[FTAsrTextNormalizationMessage session_messageAsFTTextNormalizationRequest](self, "session_messageAsFTTextNormalizationRequest");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (Offset<siri::speech::qss_fb::AsrTextNormalizationMessage>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTAsrTextNormalizationMessage session_message_type](self, "session_message_type");
  if (-[FTAsrTextNormalizationMessage session_message_type](self, "session_message_type") == 1)
  {
    -[FTAsrTextNormalizationMessage session_messageAsFTTextNormalizationRequest](self, "session_messageAsFTTextNormalizationRequest");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTAsrTextNormalizationMessage addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __45__FTAsrTextNormalizationMessage_flatbuffData__block_invoke;
