...
{
  FTMutableMultilingualStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableMultilingualStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartMultilingualSpeechRequest)contentAsFTStartMultilingualSpeechRequest
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTStartMultilingualSpeechRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (FTUpdateAudioInfo)contentAsFTUpdateAudioInfo
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTUpdateAudioInfo:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTSetRequestOrigin)contentAsFTSetRequestOrigin
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTSetRequestOrigin:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTSetSpeechContext)contentAsFTSetSpeechContext
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTSetSpeechContext:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTSetSpeechProfile)contentAsFTSetSpeechProfile
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTSetSpeechProfile:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTAudioPacket)contentAsFTAudioPacket
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTFinishAudio)contentAsFTFinishAudio
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 7);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTLanguageDetected)contentAsFTLanguageDetected
{
  ...
  if (-[FTMutableMultilingualStreamingRequest content_type](self, "content_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTLanguageDetected:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultilingualStreamingRequest setContent_type:](self, "setContent_type:", 8);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
