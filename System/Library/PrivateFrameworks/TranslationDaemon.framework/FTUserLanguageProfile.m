...
{
  return -[FTUserLanguageProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTUserLanguageProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTUserLanguageProfile)initWithFlatbuffData:(id)a3 root:(const UserLanguageProfile *)a4
{
  return -[FTUserLanguageProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTUserLanguageProfile)initWithFlatbuffData:(id)a3 root:(const UserLanguageProfile *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::UserLanguageProfile *v19;
  FTUserLanguageProfile *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTUserLanguageProfile init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::UserLanguageProfile>)addObjectToBuffer:(void *)a3
{
  ...
  v19[4] = &v20;
  v19[5] = a3;
  -[FTUserLanguageProfile profile_blob:](self, "profile_blob:", v19);
  -[FTUserLanguageProfile profile_blob_version](self, "profile_blob_version");
  ...
  -[FTUserLanguageProfile profile_checksum](self, "profile_checksum");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  v15 = *((_DWORD *)a3 + 12);
  v16 = *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 4, *((_DWORD *)v21 + 12));
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTUserLanguageProfile addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __37__FTUserLanguageProfile_flatbuffData__block_invoke;
