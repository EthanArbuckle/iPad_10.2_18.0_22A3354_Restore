...
{
  return -[FTAudioAnalytics_AcousticFeaturesEntry initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTAudioAnalytics_AcousticFeaturesEntry initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTAudioAnalytics_AcousticFeaturesEntry)initWithFlatbuffData:(id)a3 root:(const AcousticFeaturesEntry *)a4
{
  return -[FTAudioAnalytics_AcousticFeaturesEntry initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTAudioAnalytics_AcousticFeaturesEntry)initWithFlatbuffData:(id)a3 root:(const AcousticFeaturesEntry *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTAudioAnalytics_AcousticFeaturesEntry *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::AudioAnalytics_::AcousticFeaturesEntry *v19;
  FTAudioAnalytics_AcousticFeaturesEntry *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTAudioAnalytics_AcousticFeaturesEntry init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
{
  FTAcousticFeature *v3;
  FTAcousticFeature *v4;
  const AcousticFeaturesEntry *root;
  const AcousticFeaturesEntry *v6;
  uint64_t v7;
  ...
  v3 = (FTAcousticFeature *)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    ...
    if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
      ...
      v8 = 0;
    v3 = -[FTAcousticFeature initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
- (Offset<siri::speech::schema_fb::AudioAnalytics_::AcousticFeaturesEntry>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTAudioAnalytics_AcousticFeaturesEntry key](self, "key");
  ...
  -[FTAudioAnalytics_AcousticFeaturesEntry value](self, "value");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::AudioAnalytics_::AcousticFeaturesEntry>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (__int16)v9);
}
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTAudioAnalytics_AcousticFeaturesEntry addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __54__FTAudioAnalytics_AcousticFeaturesEntry_flatbuffData__block_invoke;
