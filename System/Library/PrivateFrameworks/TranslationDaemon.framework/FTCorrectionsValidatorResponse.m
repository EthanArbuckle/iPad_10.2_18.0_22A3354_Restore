...
{
  return -[FTCorrectionsValidatorResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTCorrectionsValidatorResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTCorrectionsValidatorResponse)initWithFlatbuffData:(id)a3 root:(const CorrectionsValidatorResponse *)a4
{
  return -[FTCorrectionsValidatorResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTCorrectionsValidatorResponse)initWithFlatbuffData:(id)a3 root:(const CorrectionsValidatorResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTCorrectionsValidatorResponse *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::CorrectionsValidatorResponse *v19;
  FTCorrectionsValidatorResponse *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTCorrectionsValidatorResponse init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)corrections
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTCorrectionsValidatorResponse corrections_enumerateObjectsUsingBlock:](self, "corrections_enumerateObjectsUsingBlock:", v6);
...
- (id)corrections_objectAtIndex:(unint64_t)a3
{
  void *v5;
  void *v6;
  FTCorrectionsAlignment *v7;
  FTCorrectionsAlignment *v8;
  const CorrectionsValidatorResponse *root;
  ...
  if (v5)
  {
    ...
    v7 = (FTCorrectionsAlignment *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    root = self->_root;
    ...
    v7 = -[FTCorrectionsAlignment initWithFlatbuffData:root:verify:]([FTCorrectionsAlignment alloc], "initWithFlatbuffData:root:verify:", self->_data, v12 + 4 + *(unsigned int *)(v12 + 4), 0);
  }
  v8 = v7;
LABEL_8:
...
{
  void (**v4)(id, FTCorrectionsAlignment *, uint64_t, unsigned __int8 *);
  void *v5;
  void *v6;
  const CorrectionsValidatorResponse *root;
  const CorrectionsValidatorResponse *v8;
  uint64_t v9;
  const CorrectionsValidatorResponse *v10;
  uint64_t v11;
  uint64_t v12;
  ...
  uint64_t v15;
  uint64_t v16;
  FTCorrectionsAlignment *v17;
  int v18;
  uint64_t v19;
  unsigned __int8 v20;

  v4 = (void (**)(id, FTCorrectionsAlignment *, uint64_t, unsigned __int8 *))a3;
  -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("corrections"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
    ...
    if (*(unsigned __int16 *)v8->var0 >= 0xFu)
    {
      ...
      if (v9)
      {
        ...
        if ((_DWORD)v12)
        {
          ...
          do
          {
            v17 = -[FTCorrectionsAlignment initWithFlatbuffData:root:verify:]([FTCorrectionsAlignment alloc], "initWithFlatbuffData:root:verify:", self->_data, v13 + v14 + *(unsigned int *)(v13 + 4 * v15), 0);
            v4[2](v4, v17, v15, &v20);
            v18 = v20;
...
- (Offset<siri::speech::schema_fb::CorrectionsValidatorResponse>)addObjectToBuffer:(void *)a3
{
  ...
  int v45;
  int v46;
  Offset<siri::speech::schema_fb::CorrectionsValidatorResponse> v47;
  int v49;
  int v50;
  int v51;
  int v52;
  ...
  -[FTCorrectionsValidatorResponse speech_id](self, "speech_id");
  ...
  -[FTCorrectionsValidatorResponse session_id](self, "session_id");
  ...
  -[FTCorrectionsValidatorResponse language](self, "language");
  ...
  v20 = -[FTCorrectionsValidatorResponse return_code](self, "return_code");
  -[FTCorrectionsValidatorResponse return_str](self, "return_str");
  ...
  -[FTCorrectionsValidatorResponse corrections](self, "corrections");
  ...
  if (v58.__end_ == v58.__begin_)
    v42 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::CorrectionsAlignment>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::CorrectionsAlignment>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::CorrectionsAlignment>> const&)::t;
  else
    v42 = v58.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTCorrectionsValidatorResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __46__FTCorrectionsValidatorResponse_flatbuffData__block_invoke;
