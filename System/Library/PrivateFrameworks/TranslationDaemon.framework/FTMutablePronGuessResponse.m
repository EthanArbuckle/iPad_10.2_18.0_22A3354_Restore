...
- (FTMutablePronGuessResponse)init
{
  ...
  v2 = -[FTMutablePronGuessResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTVocToken *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("voc_token"));
}
