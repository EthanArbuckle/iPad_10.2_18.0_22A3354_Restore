...
{
  return -[FTClientSetupInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTClientSetupInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTClientSetupInfo)initWithFlatbuffData:(id)a3 root:(const ClientSetupInfo *)a4
{
  return -[FTClientSetupInfo initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTClientSetupInfo)initWithFlatbuffData:(id)a3 root:(const ClientSetupInfo *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTClientSetupInfo *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const ClientSetupInfo *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::ClientSetupInfo *v19;
  FTClientSetupInfo *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTClientSetupInfo init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::ClientSetupInfo>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTClientSetupInfo endpoint_threshold](self, "endpoint_threshold");
  v6 = v5;
  v7 = -[FTClientSetupInfo endpoint_extra_delay](self, "endpoint_extra_delay");
  -[FTClientSetupInfo speech_id](self, "speech_id");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>((char *)a3, 6, v7, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 8, (int)v10);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTClientSetupInfo addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __33__FTClientSetupInfo_flatbuffData__block_invoke;
