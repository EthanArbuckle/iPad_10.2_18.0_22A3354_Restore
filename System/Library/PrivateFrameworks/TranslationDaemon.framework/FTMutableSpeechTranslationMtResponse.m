...
{
  FTMutableSpeechTranslationMtResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableSpeechTranslationMtResponse init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTTranslationLocalePair *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("translation_locale_pair"));
}
...
- (BOOL)is_final
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("is_final"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
