...
{
  return -[FTAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTAlignment)initWithFlatbuffData:(id)a3 root:(const Alignment *)a4
{
  return -[FTAlignment initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTAlignment)initWithFlatbuffData:(id)a3 root:(const Alignment *)a4 verify:(BOOL)a5
{
  ...
  unint64_t v13;
  uint64_t v14;
  const Alignment *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::Alignment *v19;
  FTAlignment *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  ...
  v10 = -[FTAlignment init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)index
{
  ...
  -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("index"));
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTAlignment index_enumerateObjectsUsingBlock:](self, "index_enumerateObjectsUsingBlock:", v6);
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_storage, "setObject:forKeyedSubscript:", v3, CFSTR("index"));
...
- (Offset<siri::speech::schema_fb::Alignment>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v25;
  uint64_t v26;
  Offset<siri::speech::schema_fb::Alignment> v27;
  __int128 v29;
  __int128 v30;
  __int128 v31;
  __int128 v32;
  ...
  v29 = 0u;
  v30 = 0u;
  -[FTAlignment index](self, "index", 0);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v10 = objc_msgSend(*(id *)(*((_QWORD *)&v29 + 1) + 8 * i), "intValue");
        v11 = v10;
        end = v33.__end_;
  ...
  v23 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<int>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v22, v33.__end_ - v33.__begin_);
  *((_BYTE *)a3 + 70) = 1;
  v24 = *((_QWORD *)a3 + 5);
  v25 = *((_QWORD *)a3 + 6);
  v26 = *((_QWORD *)a3 + 4);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTAlignment addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __27__FTAlignment_flatbuffData__block_invoke;
