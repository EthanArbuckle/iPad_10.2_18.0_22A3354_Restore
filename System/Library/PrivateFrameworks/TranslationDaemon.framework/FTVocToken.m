...
{
  return -[FTVocToken initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTVocToken initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTVocToken)initWithFlatbuffData:(id)a3 root:(const VocToken *)a4
{
  return -[FTVocToken initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTVocToken)initWithFlatbuffData:(id)a3 root:(const VocToken *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::VocToken *v19;
  FTVocToken *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  ...
  v10 = -[FTVocToken init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (void)blob:(id)a3
{
  ...
  v10 = v4;
  (*((void (**)(id, const VocToken *, _QWORD))v4 + 2))(v4, v9 + 4, *(unsigned int *)root[v7 + v8].var0);
...
- (Offset<siri::speech::schema_fb::VocToken>)addObjectToBuffer:(void *)a3
{
  ...
  int v10;
  int v11;
  Offset<siri::speech::schema_fb::VocToken> v12;
  _QWORD v14[6];
  uint64_t v15;
  uint64_t *v16;
  uint64_t v17;
  ...
  -[FTVocToken orthography](self, "orthography");
  ...
  v14[4] = &v15;
  v14[5] = a3;
  -[FTVocToken blob:](self, "blob:", v14);
  *((_BYTE *)a3 + 70) = 1;
  v9 = *((_DWORD *)a3 + 8);
  v10 = *((_DWORD *)a3 + 12);
  v11 = *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 4, (int)v7);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 6, *((_DWORD *)v16 + 12));
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTVocToken addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __26__FTVocToken_flatbuffData__block_invoke;
