...
{
  return -[FTBatchTranslationResponse_TranslationPhrase initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTBatchTranslationResponse_TranslationPhrase initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTBatchTranslationResponse_TranslationPhrase)initWithFlatbuffData:(id)a3 root:(const TranslationPhrase *)a4
{
  return -[FTBatchTranslationResponse_TranslationPhrase initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTBatchTranslationResponse_TranslationPhrase)initWithFlatbuffData:(id)a3 root:(const TranslationPhrase *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTBatchTranslationResponse_TranslationPhrase *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::BatchTranslationResponse_::TranslationPhrase *v19;
  FTBatchTranslationResponse_TranslationPhrase *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTBatchTranslationResponse_TranslationPhrase init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)repeated_spans
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTBatchTranslationResponse_TranslationPhrase repeated_spans_enumerateObjectsUsingBlock:](self, "repeated_spans_enumerateObjectsUsingBlock:", v6);
...
- (Offset<siri::speech::schema_fb::BatchTranslationResponse_::TranslationPhrase>)addObjectToBuffer:(void *)a3
{
  ...
  int v39;
  int v40;
  Offset<siri::speech::schema_fb::BatchTranslationResponse_::TranslationPhrase> v41;
  int v43;
  int v44;
  int v45;
  FTBatchTranslationResponse_TranslationPhrase *v46;
  __int128 v47;
  __int128 v48;
  __int128 v49;
  __int128 v50;
  ...
  -[FTBatchTranslationResponse_TranslationPhrase confidence](self, "confidence");
  v6 = v5;
  -[FTBatchTranslationResponse_TranslationPhrase translation_phrase](self, "translation_phrase");
  ...
  -[FTBatchTranslationResponse_TranslationPhrase meta_info](self, "meta_info");
  ...
  v15 = strlen(v14);
  v44 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v14, v15);

  v43 = -[FTBatchTranslationResponse_TranslationPhrase low_confidence](self, "low_confidence");
  memset(&v51, 0, sizeof(v51));
  -[FTBatchTranslationResponse_TranslationPhrase repeated_spans](self, "repeated_spans");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v51, objc_msgSend(v16, "count"));
  ...
  if (v18)
  {
    ...
    do
    {
      for (i = 0; i != v18; ++i)
      {
        ...
        v21 = objc_msgSend(*(id *)(*((_QWORD *)&v47 + 1) + 8 * i), "addObjectToBuffer:", a3);
        v22 = v21;
        end = v51.__end_;
        if (v51.__end_ >= v51.__end_cap_.__value_)
        {
          begin = v51.__begin_;
          v26 = v51.__end_ - v51.__begin_;
          v27 = v26 + 1;
          if ((unint64_t)(v26 + 1) >> 62)
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          v28 = (char *)v51.__end_cap_.__value_ - (char *)v51.__begin_;
  ...
  if (v51.__end_ == v51.__begin_)
    v33 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RepeatedSpan>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RepeatedSpan>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RepeatedSpan>> const&)::t;
  else
    v33 = v51.__begin_;
  v34 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v33, v51.__end_ - v51.__begin_);
  -[FTBatchTranslationResponse_TranslationPhrase meta_info_data](v46, "meta_info_data");
  v35 = (void *)objc_claimAutoreleasedReturnValue();
  v36 = objc_msgSend(v35, "addObjectToBuffer:", a3);

  v37 = -[FTBatchTranslationResponse_TranslationPhrase contains_masked_profanity](v46, "contains_masked_profanity");
  *((_BYTE *)a3 + 70) = 1;
  v38 = *((_DWORD *)a3 + 8);
  v39 = *((_DWORD *)a3 + 12);
  v40 = *((_DWORD *)a3 + 10);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 8, v44);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>((char *)a3, 10, v43, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 12, v34);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 14, v36);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>((char *)a3, 16, v37, 0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTBatchTranslationResponse_TranslationPhrase addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __60__FTBatchTranslationResponse_TranslationPhrase_flatbuffData__block_invoke;
