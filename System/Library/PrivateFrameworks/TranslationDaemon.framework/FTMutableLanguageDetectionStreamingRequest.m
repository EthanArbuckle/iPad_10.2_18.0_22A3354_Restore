...
{
  FTMutableLanguageDetectionStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableLanguageDetectionStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartLanguageDetectionRequest)contentAsFTStartLanguageDetectionRequest
{
  ...
  if (-[FTMutableLanguageDetectionStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTStartLanguageDetectionRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableLanguageDetectionStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (FTAudioPacket)contentAsFTAudioPacket
{
  ...
  if (-[FTMutableLanguageDetectionStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableLanguageDetectionStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTFinishAudio)contentAsFTFinishAudio
{
  ...
  if (-[FTMutableLanguageDetectionStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableLanguageDetectionStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
