...
{
  FTMutableTextToSpeechRouterStreamingStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTextToSpeechRouterStreamingStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (FTBeginTextToSpeechStreamingResponse)contentAsFTBeginTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTBeginTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechRouterStreamingStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (FTPartialTextToSpeechStreamingResponse)contentAsFTPartialTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTPartialTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechRouterStreamingStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTFinalTextToSpeechStreamingResponse)contentAsFTFinalTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTFinalTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechRouterStreamingStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
