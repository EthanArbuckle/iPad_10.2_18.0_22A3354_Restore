...
{
  return -[FTRecognitionPhraseTokens initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTRecognitionPhraseTokens initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4
{
  return -[FTRecognitionPhraseTokens initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTRecognitionPhraseTokens *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const RecognitionPhraseTokens *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::RecognitionPhraseTokens *v19;
  FTRecognitionPhraseTokens *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTRecognitionPhraseTokens init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)tokens
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTRecognitionPhraseTokens tokens_enumerateObjectsUsingBlock:](self, "tokens_enumerateObjectsUsingBlock:", v6);
...
- (id)tokens_objectAtIndex:(unint64_t)a3
{
  ...
  const RecognitionPhraseTokens *root;
  const RecognitionPhraseTokens *v10;
  uint64_t v11;
  uint64_t v12;
...
- (unint64_t)tokens_count
{
  ...
  unint64_t v5;
  const RecognitionPhraseTokens *root;
  const RecognitionPhraseTokens *v7;
  uint64_t v8;
...
- (void)tokens_enumerateObjectsUsingBlock:(id)a3
{
  ...
  void *v6;
  const RecognitionPhraseTokens *root;
  const RecognitionPhraseTokens *v8;
  uint64_t v9;
  const RecognitionPhraseTokens *v10;
  uint64_t v11;
  uint64_t v12;
...
- (Offset<siri::speech::schema_fb::RecognitionPhraseTokens>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v25;
  uint64_t v26;
  Offset<siri::speech::schema_fb::RecognitionPhraseTokens> v27;
  __int128 v29;
  __int128 v30;
  __int128 v31;
  __int128 v32;
  ...
  -[FTRecognitionPhraseTokens tokens](self, "tokens");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v29 = 0u;
  v30 = 0u;
  -[FTRecognitionPhraseTokens tokens](self, "tokens", 0);
  ...
  if (v33.__end_ == v33.__begin_)
    v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>> const&)::t;
  else
    v22 = v33.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTRecognitionPhraseTokens addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __41__FTRecognitionPhraseTokens_flatbuffData__block_invoke;
