...
{
  return -[FTTTSWordPhonemes initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTTSWordPhonemes initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTTSWordPhonemes)initWithFlatbuffData:(id)a3 root:(const TTSWordPhonemes *)a4
{
  return -[FTTTSWordPhonemes initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTTSWordPhonemes)initWithFlatbuffData:(id)a3 root:(const TTSWordPhonemes *)a4 verify:(BOOL)a5
{
  ...
  v10 = -[FTTTSWordPhonemes init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)phonemes
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTTTSWordPhonemes phonemes_enumerateObjectsUsingBlock:](self, "phonemes_enumerateObjectsUsingBlock:", v6);
...
- (Offset<siri::speech::schema_fb::TTSWordPhonemes>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTTTSWordPhonemes phonemes](self, "phonemes");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v31 = 0u;
  v32 = 0u;
  -[FTTTSWordPhonemes phonemes](self, "phonemes", 0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTTSWordPhonemes addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __33__FTTTSWordPhonemes_flatbuffData__block_invoke;
