...
{
  return -[FTSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTSpan)initWithFlatbuffData:(id)a3 root:(const Span *)a4
{
  return -[FTSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTSpan)initWithFlatbuffData:(id)a3 root:(const Span *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::Span *v19;
  FTSpan *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
...
- (Offset<siri::speech::schema_fb::Span>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTSpan start_index](self, "start_index");
  v6 = -[FTSpan end_index](self, "end_index");
  v7 = -[FTSpan do_not_translate](self, "do_not_translate");
  -[FTSpan meta_info](self, "meta_info");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 10, (int)v10);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTSpan addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __22__FTSpan_flatbuffData__block_invoke;
