...
{
  return -[FTBatchTranslationStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTBatchTranslationStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingRequest *)a4
{
  return -[FTBatchTranslationStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTBatchTranslationStreamingRequest *v10;
  FTBatchTranslationStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::BatchTranslationStreamingRequest *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTBatchTranslationStreamingRequest *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTBatchTranslationStreamingRequest init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (FTBatchTranslationRequest)contentAsFTBatchTranslationRequest
{
  ...
  if (-[FTBatchTranslationStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (FTBatchTranslationFeedbackRequest)contentAsFTBatchTranslationFeedbackRequest
{
  ...
  if (-[FTBatchTranslationStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTBatchTranslationLoggingRequest)contentAsFTBatchTranslationLoggingRequest
{
  ...
  if (-[FTBatchTranslationStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTTranslationSupportedLanguagesRequest)contentAsFTTranslationSupportedLanguagesRequest
{
  ...
  if (-[FTBatchTranslationStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FLTBFBufferAccessor)content
{
  ...
  switch(-[FTBatchTranslationStreamingRequest content_type](self, "content_type"))
  {
    case 1:
      -[FTBatchTranslationStreamingRequest contentAsFTBatchTranslationRequest](self, "contentAsFTBatchTranslationRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 2:
      -[FTBatchTranslationStreamingRequest contentAsFTBatchTranslationFeedbackRequest](self, "contentAsFTBatchTranslationFeedbackRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 3:
      -[FTBatchTranslationStreamingRequest contentAsFTBatchTranslationLoggingRequest](self, "contentAsFTBatchTranslationLoggingRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 4:
      -[FTBatchTranslationStreamingRequest contentAsFTTranslationSupportedLanguagesRequest](self, "contentAsFTTranslationSupportedLanguagesRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    default:
      v3 = 0;
...
- (Offset<siri::speech::qss_fb::BatchTranslationStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTBatchTranslationStreamingRequest content_type](self, "content_type");
  if (-[FTBatchTranslationStreamingRequest content_type](self, "content_type") == 1)
  {
    -[FTBatchTranslationStreamingRequest contentAsFTBatchTranslationRequest](self, "contentAsFTBatchTranslationRequest");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTBatchTranslationStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __50__FTBatchTranslationStreamingRequest_flatbuffData__block_invoke;
