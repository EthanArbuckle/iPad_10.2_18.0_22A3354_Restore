...
{
  return -[FTTextToSpeechStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextToSpeechStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechStreamingStreamingResponse *)a4
{
  return -[FTTextToSpeechStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechStreamingStreamingResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTextToSpeechStreamingStreamingResponse *v10;
  FTTextToSpeechStreamingStreamingResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::TextToSpeechStreamingStreamingResponse *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTTextToSpeechStreamingStreamingResponse *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTTextToSpeechStreamingStreamingResponse init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (FTQssAckResponse)contentAsFTQssAckResponse
{
  ...
  if (-[FTTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (FTBeginTextToSpeechStreamingResponse)contentAsFTBeginTextToSpeechStreamingResponse
{
  ...
  if (-[FTTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTPartialTextToSpeechStreamingResponse)contentAsFTPartialTextToSpeechStreamingResponse
{
  ...
  if (-[FTTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTFinalTextToSpeechStreamingResponse)contentAsFTFinalTextToSpeechStreamingResponse
{
  ...
  if (-[FTTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FLTBFBufferAccessor)content
{
  ...
  switch(-[FTTextToSpeechStreamingStreamingResponse content_type](self, "content_type"))
  {
    case 1:
      -[FTTextToSpeechStreamingStreamingResponse contentAsFTQssAckResponse](self, "contentAsFTQssAckResponse");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 2:
      -[FTTextToSpeechStreamingStreamingResponse contentAsFTBeginTextToSpeechStreamingResponse](self, "contentAsFTBeginTextToSpeechStreamingResponse");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 3:
      -[FTTextToSpeechStreamingStreamingResponse contentAsFTPartialTextToSpeechStreamingResponse](self, "contentAsFTPartialTextToSpeechStreamingResponse");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 4:
      -[FTTextToSpeechStreamingStreamingResponse contentAsFTFinalTextToSpeechStreamingResponse](self, "contentAsFTFinalTextToSpeechStreamingResponse");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    default:
      v3 = 0;
...
- (Offset<siri::speech::qss_fb::TextToSpeechStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTTextToSpeechStreamingStreamingResponse content_type](self, "content_type");
  if (-[FTTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
    -[FTTextToSpeechStreamingStreamingResponse contentAsFTQssAckResponse](self, "contentAsFTQssAckResponse");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextToSpeechStreamingStreamingResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __56__FTTextToSpeechStreamingStreamingResponse_flatbuffData__block_invoke;
