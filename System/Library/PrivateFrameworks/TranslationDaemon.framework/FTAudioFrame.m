...
{
  return -[FTAudioFrame initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTAudioFrame initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTAudioFrame)initWithFlatbuffData:(id)a3 root:(const AudioFrame *)a4
{
  return -[FTAudioFrame initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTAudioFrame)initWithFlatbuffData:(id)a3 root:(const AudioFrame *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::AudioFrame *v19;
  FTAudioFrame *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  ...
  v10 = -[FTAudioFrame init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::AudioFrame>)addObjectToBuffer:(void *)a3
{
  ...
  v8[4] = &v9;
  v8[5] = a3;
  -[FTAudioFrame audio_bytes:](self, "audio_bytes:", v8);
  v3[70] = 1;
  v4 = *((_QWORD *)v3 + 5);
  v5 = *((_QWORD *)v3 + 6);
  v6 = *((_QWORD *)v3 + 4);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTAudioFrame addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __28__FTAudioFrame_flatbuffData__block_invoke;
