...
{
  return -[FTMultilingualStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTMultilingualStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTMultilingualStreamingRequest)initWithFlatbuffData:(id)a3 root:(const MultilingualStreamingRequest *)a4
{
  return -[FTMultilingualStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTMultilingualStreamingRequest)initWithFlatbuffData:(id)a3 root:(const MultilingualStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTMultilingualStreamingRequest *v10;
  FTMultilingualStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::MultilingualStreamingRequest *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTMultilingualStreamingRequest *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTMultilingualStreamingRequest init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (FTStartMultilingualSpeechRequest)contentAsFTStartMultilingualSpeechRequest
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (FTUpdateAudioInfo)contentAsFTUpdateAudioInfo
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetRequestOrigin)contentAsFTSetRequestOrigin
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetSpeechContext)contentAsFTSetSpeechContext
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTSetSpeechProfile)contentAsFTSetSpeechProfile
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTAudioPacket)contentAsFTAudioPacket
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTFinishAudio)contentAsFTFinishAudio
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTLanguageDetected)contentAsFTLanguageDetected
{
  ...
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FLTBFBufferAccessor)content
{
  ...
  switch(-[FTMultilingualStreamingRequest content_type](self, "content_type"))
  {
    case 1:
      -[FTMultilingualStreamingRequest contentAsFTStartMultilingualSpeechRequest](self, "contentAsFTStartMultilingualSpeechRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 2:
      -[FTMultilingualStreamingRequest contentAsFTUpdateAudioInfo](self, "contentAsFTUpdateAudioInfo");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 3:
      -[FTMultilingualStreamingRequest contentAsFTSetRequestOrigin](self, "contentAsFTSetRequestOrigin");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 4:
      -[FTMultilingualStreamingRequest contentAsFTSetSpeechContext](self, "contentAsFTSetSpeechContext");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 5:
      -[FTMultilingualStreamingRequest contentAsFTSetSpeechProfile](self, "contentAsFTSetSpeechProfile");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 6:
      -[FTMultilingualStreamingRequest contentAsFTAudioPacket](self, "contentAsFTAudioPacket");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 7:
      -[FTMultilingualStreamingRequest contentAsFTFinishAudio](self, "contentAsFTFinishAudio");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 8:
      -[FTMultilingualStreamingRequest contentAsFTLanguageDetected](self, "contentAsFTLanguageDetected");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    default:
      v3 = 0;
...
- (Offset<siri::speech::qss_fb::MultilingualStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTMultilingualStreamingRequest content_type](self, "content_type");
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type") == 1)
  {
    -[FTMultilingualStreamingRequest contentAsFTStartMultilingualSpeechRequest](self, "contentAsFTStartMultilingualSpeechRequest");
  ...
  v30 = v17;
  v31 = v15;
  if (-[FTMultilingualStreamingRequest content_type](self, "content_type", v28) == 8)
  {
    -[FTMultilingualStreamingRequest contentAsFTLanguageDetected](self, "contentAsFTLanguageDetected");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTMultilingualStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __46__FTMultilingualStreamingRequest_flatbuffData__block_invoke;
