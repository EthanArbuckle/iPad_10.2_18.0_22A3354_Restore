...
{
  FTMutableMultiUserStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableMultiUserStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (FTFinalSpeechRecognitionResponse)contentAsFTFinalSpeechRecognitionResponse
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTFinalSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (FTPartialSpeechRecognitionResponse)contentAsFTPartialSpeechRecognitionResponse
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTPartialSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTRecognitionProgress)contentAsFTRecognitionProgress
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTRecognitionProgress:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTRecognitionCandidate)contentAsFTRecognitionCandidate
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTRecognitionCandidate:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTRequestStatsResponse)contentAsFTRequestStatsResponse
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTRequestStatsResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTServerEndpointFeatures)contentAsFTServerEndpointFeatures
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTServerEndpointFeatures:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTClientSetupInfo)contentAsFTClientSetupInfo
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTClientSetupInfo:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 7);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTAudioLimitExceeded)contentAsFTAudioLimitExceeded
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTAudioLimitExceeded:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 8);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTFinalBlazarResponse)contentAsFTFinalBlazarResponse
{
  ...
  if (-[FTMutableMultiUserStreamingResponse content_type](self, "content_type") == 9)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTFinalBlazarResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableMultiUserStreamingResponse setContent_type:](self, "setContent_type:", 9);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
