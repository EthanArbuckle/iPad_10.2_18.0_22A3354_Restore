...
{
  return -[FTRecognitionCandidate initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTRecognitionCandidate initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTRecognitionCandidate)initWithFlatbuffData:(id)a3 root:(const RecognitionCandidate *)a4
{
  return -[FTRecognitionCandidate initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTRecognitionCandidate)initWithFlatbuffData:(id)a3 root:(const RecognitionCandidate *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::RecognitionCandidate *v19;
  FTRecognitionCandidate *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTRecognitionCandidate init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::RecognitionCandidate>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTRecognitionCandidate speech_id](self, "speech_id");
  ...
  -[FTRecognitionCandidate session_id](self, "session_id");
  ...
  v15 = -[FTRecognitionCandidate return_code](self, "return_code");
  -[FTRecognitionCandidate return_str](self, "return_str");
  ...
  -[FTRecognitionCandidate recognition_result](self, "recognition_result");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v22 = objc_msgSend(v21, "addObjectToBuffer:", a3);

  -[FTRecognitionCandidate result_id](self, "result_id");
  ...
  v26 = strlen(v25);
  v57 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v25, v26);
  v56 = v22;

  -[FTRecognitionCandidate snr](self, "snr");
  v28 = v27;
  v29 = -[FTRecognitionCandidate fingerprint_detection](self, "fingerprint_detection");
  -[FTRecognitionCandidate audio_analytics](self, "audio_analytics");
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  v55 = objc_msgSend(v30, "addObjectToBuffer:", a3);

  v54 = -[FTRecognitionCandidate watermark_detection](self, "watermark_detection");
  -[FTRecognitionCandidate watermark_peak_average](self, "watermark_peak_average");
  v32 = v31;
  -[FTRecognitionCandidate language](self, "language");
  ...
  v36 = strlen(v35);
  v53 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v35, v36);
  v52 = v29;
  v37 = v15;

  -[FTRecognitionCandidate latnn_mitigator_result](self, "latnn_mitigator_result");
  v38 = (void *)objc_claimAutoreleasedReturnValue();
  v51 = objc_msgSend(v38, "addObjectToBuffer:", a3);

  -[FTRecognitionCandidate request_locale](self, "request_locale");
  ...
  v44 = -[FTRecognitionCandidate speech_profile_used](self, "speech_profile_used");
  -[FTRecognitionCandidate result_candidate_id](self, "result_candidate_id");
  ...
  *((_BYTE *)a3 + 70) = 1;
  v49 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((char *)a3, 8, v37, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 10, v20);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 12, v56);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 14, v57);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<double>((char *)a3, 16, v28, 0.0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((char *)a3, 18, v52, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 20, v55);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((char *)a3, 22, v54, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<double>((char *)a3, 24, v32, 0.0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 26, v53);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 28, v51);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 30, v43);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>((char *)a3, 32, v44, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 34, (int)v47);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTRecognitionCandidate addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __38__FTRecognitionCandidate_flatbuffData__block_invoke;
