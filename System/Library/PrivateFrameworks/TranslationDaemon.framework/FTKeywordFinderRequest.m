...
{
  return -[FTKeywordFinderRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTKeywordFinderRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTKeywordFinderRequest)initWithFlatbuffData:(id)a3 root:(const KeywordFinderRequest *)a4
{
  return -[FTKeywordFinderRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTKeywordFinderRequest)initWithFlatbuffData:(id)a3 root:(const KeywordFinderRequest *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::KeywordFinderRequest *v19;
  FTKeywordFinderRequest *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTKeywordFinderRequest init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)keywords
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTKeywordFinderRequest keywords_enumerateObjectsUsingBlock:](self, "keywords_enumerateObjectsUsingBlock:", v6);
...
- (id)keywords_objectAtIndex:(unint64_t)a3
{
  ...
  if (v5)
  {
    ...
    v7 = (FTKeyword *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    root = self->_root;
    ...
    v7 = -[FTKeyword initWithFlatbuffData:root:verify:]([FTKeyword alloc], "initWithFlatbuffData:root:verify:", self->_data, v12 + 4 + *(unsigned int *)(v12 + 4), 0);
  }
  v8 = v7;
LABEL_8:
...
{
  void (**v4)(id, FTKeyword *, uint64_t, unsigned __int8 *);
  void *v5;
  void *v6;
  const KeywordFinderRequest *root;
  ...
  v4 = (void (**)(id, FTKeyword *, uint64_t, unsigned __int8 *))a3;
  -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("keywords"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5)
    ...
    if (*(unsigned __int16 *)v8->var0 >= 0xBu)
    {
      ...
      if (v9)
      {
        ...
        if ((_DWORD)v12)
        {
          ...
          do
          {
            v17 = -[FTKeyword initWithFlatbuffData:root:verify:]([FTKeyword alloc], "initWithFlatbuffData:root:verify:", self->_data, v13 + v14 + *(unsigned int *)(v13 + 4 * v15), 0);
            v4[2](v4, v17, v15, &v20);
            v18 = v20;
...
- (Offset<siri::speech::schema_fb::KeywordFinderRequest>)addObjectToBuffer:(void *)a3
{
  ...
  int v42;
  int v43;
  Offset<siri::speech::schema_fb::KeywordFinderRequest> v44;
  int v46;
  int v47;
  int v48;
  FTKeywordFinderRequest *v49;
  __int128 v50;
  __int128 v51;
  __int128 v52;
  __int128 v53;
  ...
  -[FTKeywordFinderRequest speech_id](self, "speech_id");
  ...
  -[FTKeywordFinderRequest session_id](self, "session_id");
  ...
  -[FTKeywordFinderRequest language](self, "language");
  ...
  v18 = strlen(v17);
  v46 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v17, v18);

  memset(&v54, 0, sizeof(v54));
  -[FTKeywordFinderRequest keywords](self, "keywords");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v54, objc_msgSend(v19, "count"));
  ...
  if (v21)
  {
    ...
    do
    {
      for (i = 0; i != v21; ++i)
      {
        ...
        v24 = objc_msgSend(*(id *)(*((_QWORD *)&v50 + 1) + 8 * i), "addObjectToBuffer:", a3);
        v25 = v24;
        end = v54.__end_;
        if (v54.__end_ >= v54.__end_cap_.__value_)
        {
          begin = v54.__begin_;
          v29 = v54.__end_ - v54.__begin_;
          v30 = v29 + 1;
          if ((unint64_t)(v29 + 1) >> 62)
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          v31 = (char *)v54.__end_cap_.__value_ - (char *)v54.__begin_;
  ...
  if (v54.__end_ == v54.__begin_)
    v36 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Keyword>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Keyword>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Keyword>> const&)::t;
  else
    v36 = v54.__begin_;
  v37 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v36, v54.__end_ - v54.__begin_);
  -[FTKeywordFinderRequest recognition_result](v49, "recognition_result");
  v38 = (void *)objc_claimAutoreleasedReturnValue();
  v39 = objc_msgSend(v38, "addObjectToBuffer:", a3);

  v40 = -[FTKeywordFinderRequest enable_sanitization](v49, "enable_sanitization");
  *((_BYTE *)a3 + 70) = 1;
  v41 = *((_DWORD *)a3 + 8);
  v42 = *((_DWORD *)a3 + 12);
  v43 = *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 4, v48);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>((char *)a3, 14, v40, 0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTKeywordFinderRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __38__FTKeywordFinderRequest_flatbuffData__block_invoke;
