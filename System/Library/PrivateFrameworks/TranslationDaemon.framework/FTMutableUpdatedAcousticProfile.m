...
{
  FTMutableUpdatedAcousticProfile *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableUpdatedAcousticProfile init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTUserAcousticProfile *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("updated_acoustic_profile"));
}
