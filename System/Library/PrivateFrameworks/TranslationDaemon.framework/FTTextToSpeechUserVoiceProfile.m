...
{
  return -[FTTextToSpeechUserVoiceProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextToSpeechUserVoiceProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTextToSpeechUserVoiceProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserVoiceProfile *)a4
{
  return -[FTTextToSpeechUserVoiceProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextToSpeechUserVoiceProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserVoiceProfile *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTextToSpeechUserVoiceProfile *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  FTTextToSpeechUserVoiceProfile *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTTextToSpeechUserVoiceProfile init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::TextToSpeechUserVoiceProfile>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = self;
  -[FTTextToSpeechUserVoiceProfile pitch_mean](self, "pitch_mean");
  v6 = v5;
  -[FTTextToSpeechUserVoiceProfile pitch_std](v4, "pitch_std");
  v8 = v7;
  -[FTTextToSpeechUserVoiceProfile energy_mean](v4, "energy_mean");
  v10 = v9;
  -[FTTextToSpeechUserVoiceProfile energy_std](v4, "energy_std");
  v12 = v11;
  -[FTTextToSpeechUserVoiceProfile duration_mean](v4, "duration_mean");
  v14 = v13;
  -[FTTextToSpeechUserVoiceProfile duration_std](v4, "duration_std");
  v16 = v15;
  *((_BYTE *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::TextToSpeechUserVoiceProfile>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (__int16)v4);
}
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextToSpeechUserVoiceProfile addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __46__FTTextToSpeechUserVoiceProfile_flatbuffData__block_invoke;
