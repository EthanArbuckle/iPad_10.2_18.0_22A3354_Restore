...
{
  return -[FTBatchTranslationCacheContainer initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTBatchTranslationCacheContainer initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTBatchTranslationCacheContainer)initWithFlatbuffData:(id)a3 root:(const BatchTranslationCacheContainer *)a4
{
  return -[FTBatchTranslationCacheContainer initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTBatchTranslationCacheContainer)initWithFlatbuffData:(id)a3 root:(const BatchTranslationCacheContainer *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTBatchTranslationCacheContainer *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::BatchTranslationCacheContainer *v19;
  FTBatchTranslationCacheContainer *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTBatchTranslationCacheContainer init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)spans
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTBatchTranslationCacheContainer spans_enumerateObjectsUsingBlock:](self, "spans_enumerateObjectsUsingBlock:", v6);
...
- (void)spans_enumerateObjectsUsingBlock:(id)a3
{
  ...
  void *v6;
  const BatchTranslationCacheContainer *root;
  const BatchTranslationCacheContainer *v8;
  uint64_t v9;
  const BatchTranslationCacheContainer *v10;
  uint64_t v11;
  uint64_t v12;
...
- (Offset<siri::speech::schema_fb::BatchTranslationCacheContainer>)addObjectToBuffer:(void *)a3
{
  ...
  int v40;
  int v41;
  Offset<siri::speech::schema_fb::BatchTranslationCacheContainer> v42;
  uint64_t v44;
  FTBatchTranslationCacheContainer *v45;
  __int128 v46;
  __int128 v47;
  __int128 v48;
  __int128 v49;
  ...
  -[FTBatchTranslationCacheContainer request_id](self, "request_id");
  ...
  -[FTBatchTranslationCacheContainer translated_text](self, "translated_text");
  ...
  -[FTBatchTranslationCacheContainer spans](self, "spans");
  ...
  if (v16)
  {
    ...
    do
    {
      for (i = 0; i != v16; ++i)
      {
        ...
        v19 = objc_msgSend(*(id *)(*((_QWORD *)&v46 + 1) + 8 * i), "addObjectToBuffer:", a3, v44);
        v20 = v19;
        end = v50.__end_;
  ...
  if (v50.__end_ == v50.__begin_)
    v31 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RepeatedSpan>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RepeatedSpan>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RepeatedSpan>> const&)::t;
  else
    v31 = v50.__begin_;
  ...
  v33 = -[FTBatchTranslationCacheContainer sentence_count](v45, "sentence_count");
  -[FTBatchTranslationCacheContainer translated_text_romanized](v45, "translated_text_romanized");
  ...
  v38 = -[FTBatchTranslationCacheContainer contains_masked_profanity](v45, "contains_masked_profanity");
  *((_BYTE *)a3 + 70) = 1;
  v39 = *((_DWORD *)a3 + 8);
  v40 = *((_DWORD *)a3 + 12);
  v41 = *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 4, SHIDWORD(v44));
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>((char *)a3, 14, v38, 0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTBatchTranslationCacheContainer addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __48__FTBatchTranslationCacheContainer_flatbuffData__block_invoke;
