...
- (FTMutableAsrItnMessage)init
{
  ...
  v2 = -[FTMutableAsrItnMessage init](&v6, sel_init);
  if (v2)
  {
...
- (FTItnRequest)session_messageAsFTItnRequest
{
  ...
  if (-[FTMutableAsrItnMessage session_message_type](self, "session_message_type") == 1)
  {
...
- (void)setSession_messageAsFTItnRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableAsrItnMessage setSession_message_type:](self, "setSession_message_type:", 1);
...
- (FTItnResponse)session_messageAsFTItnResponse
{
  ...
  if (-[FTMutableAsrItnMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTItnResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableAsrItnMessage setSession_message_type:](self, "setSession_message_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
