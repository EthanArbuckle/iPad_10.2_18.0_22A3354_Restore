...
{
  return -[FTTextToSpeechSpeechFeatureInputWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextToSpeechSpeechFeatureInputWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWord *)a4
{
  return -[FTTextToSpeechSpeechFeatureInputWord initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWord *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTextToSpeechSpeechFeatureInputWord *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const TextToSpeechSpeechFeatureInputWord *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::ContextWithPronHints *v19;
  FTTextToSpeechSpeechFeatureInputWord *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTTextToSpeechSpeechFeatureInputWord init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSString)word
{
  ...
  uint64_t v4;
  uint64_t v5;
  const TextToSpeechSpeechFeatureInputWord *v6;
...
- (NSArray)phonemes
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTTextToSpeechSpeechFeatureInputWord phonemes_enumerateObjectsUsingBlock:](self, "phonemes_enumerateObjectsUsingBlock:", v6);
...
- (id)phonemes_objectAtIndex:(unint64_t)a3
{
  ...
  void *v8;
  const TextToSpeechSpeechFeatureInputWord *root;
  const TextToSpeechSpeechFeatureInputWord *v10;
  uint64_t v11;
  uint64_t v12;
  unsigned int *v13;
...
- (unint64_t)phonemes_count
{
  ...
  unint64_t v5;
  const TextToSpeechSpeechFeatureInputWord *root;
  const TextToSpeechSpeechFeatureInputWord *v7;
  uint64_t v8;
...
- (void)phonemes_enumerateObjectsUsingBlock:(id)a3
{
  ...
  void *v6;
  const TextToSpeechSpeechFeatureInputWord *root;
  const TextToSpeechSpeechFeatureInputWord *v8;
  uint64_t v9;
  const TextToSpeechSpeechFeatureInputWord *v10;
  uint64_t v11;
  uint64_t v12;
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord>)addObjectToBuffer:(void *)a3
{
  ...
  int v31;
  int v32;
  Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord> v33;
  int String;
  __int128 v36;
  __int128 v37;
  __int128 v38;
  ...
  -[FTTextToSpeechSpeechFeatureInputWord word](self, "word");
  ...
  -[FTTextToSpeechSpeechFeatureInputWord phonemes](self, "phonemes");
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        v14 = (const char *)objc_msgSend(objc_retainAutorelease(*(id *)(*((_QWORD *)&v36 + 1) + 8 * i)), "UTF8String");
        v15 = strlen(v14);
        ...
        if (v40.__end_ >= v40.__end_cap_.__value_)
        {
          ...
          v23 = (char *)v40.__end_cap_.__value_ - (char *)v40.__begin_;
          ...
          if (v24)
          {
            v25 = (char *)std::__allocate_at_least[abi:ne180100]<std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>((uint64_t)&v40.__end_cap_, v24);
            begin = v40.__begin_;
            end = v40.__end_;
          }
          else
  ...
  if (v40.__end_ == v40.__begin_)
    v28 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<apple::aiml::flatbuffers2::String>,std::allocator<apple::aiml::flatbuffers2::Offset<apple::aiml::flatbuffers2::String>>>(std::vector<apple::aiml::flatbuffers2::Offset<apple::aiml::flatbuffers2::String>> const&)::t;
  else
    v28 = v40.__begin_;
  v29 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v28, v40.__end_ - v40.__begin_);
  *((_BYTE *)a3 + 70) = 1;
  v30 = *((_DWORD *)a3 + 8);
  v31 = *((_DWORD *)a3 + 12);
  v32 = *((_DWORD *)a3 + 10);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextToSpeechSpeechFeatureInputWord addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __52__FTTextToSpeechSpeechFeatureInputWord_flatbuffData__block_invoke;
