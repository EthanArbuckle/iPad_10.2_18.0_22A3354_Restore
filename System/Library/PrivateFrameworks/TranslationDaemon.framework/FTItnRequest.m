...
{
  return -[FTItnRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTItnRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTItnRequest)initWithFlatbuffData:(id)a3 root:(const ItnRequest *)a4
{
  return -[FTItnRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTItnRequest)initWithFlatbuffData:(id)a3 root:(const ItnRequest *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::ItnRequest *v19;
  FTItnRequest *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  ...
  v10 = -[FTItnRequest init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)words_list
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTItnRequest words_list_enumerateObjectsUsingBlock:](self, "words_list_enumerateObjectsUsingBlock:", v6);
...
- (Offset<siri::speech::schema_fb::ItnRequest>)addObjectToBuffer:(void *)a3
{
  ...
  int v39;
  int v40;
  Offset<siri::speech::schema_fb::ItnRequest> v41;
  int v43;
  int v44;
  int v45;
  __int128 v46;
  ...
  -[FTItnRequest speech_id](self, "speech_id");
  ...
  -[FTItnRequest session_id](self, "session_id");
  ...
  -[FTItnRequest language](self, "language");
  ...
  -[FTItnRequest words_list](self, "words_list");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v50, objc_msgSend(v19, "count"));
  ...
  if (v21)
  {
    ...
    do
    {
      for (i = 0; i != v21; ++i)
      {
        ...
        v24 = objc_msgSend(*(id *)(*((_QWORD *)&v46 + 1) + 8 * i), "addObjectToBuffer:", a3);
        v25 = v24;
        end = v50.__end_;
  ...
  if (v50.__end_ == v50.__begin_)
    v36 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>> const&)::t;
  else
    v36 = v50.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTItnRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __28__FTItnRequest_flatbuffData__block_invoke;
