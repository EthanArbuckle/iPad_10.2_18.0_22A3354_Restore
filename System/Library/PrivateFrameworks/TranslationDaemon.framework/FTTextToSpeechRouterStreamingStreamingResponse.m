...
{
  return -[FTTextToSpeechRouterStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextToSpeechRouterStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[FTTextToSpeechRouterStreamingStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTextToSpeechRouterStreamingStreamingResponse *v10;
  FTTextToSpeechRouterStreamingStreamingResponse *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTTextToSpeechRouterStreamingStreamingResponse *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTTextToSpeechRouterStreamingStreamingResponse init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (FTBeginTextToSpeechStreamingResponse)contentAsFTBeginTextToSpeechStreamingResponse
{
  ...
  if (-[FTTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (FTPartialTextToSpeechStreamingResponse)contentAsFTPartialTextToSpeechStreamingResponse
{
  ...
  if (-[FTTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTFinalTextToSpeechStreamingResponse)contentAsFTFinalTextToSpeechStreamingResponse
{
  ...
  if (-[FTTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FLTBFBufferAccessor)content
{
  ...
  v3 = -[FTTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type");
  switch(v3)
  {
    case 3:
      -[FTTextToSpeechRouterStreamingStreamingResponse contentAsFTFinalTextToSpeechStreamingResponse](self, "contentAsFTFinalTextToSpeechStreamingResponse");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 2:
      -[FTTextToSpeechRouterStreamingStreamingResponse contentAsFTPartialTextToSpeechStreamingResponse](self, "contentAsFTPartialTextToSpeechStreamingResponse");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 1:
      -[FTTextToSpeechRouterStreamingStreamingResponse contentAsFTBeginTextToSpeechStreamingResponse](self, "contentAsFTBeginTextToSpeechStreamingResponse");
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    default:
      v4 = 0;
...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type");
  if (-[FTTextToSpeechRouterStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
    -[FTTextToSpeechRouterStreamingStreamingResponse contentAsFTBeginTextToSpeechStreamingResponse](self, "contentAsFTBeginTextToSpeechStreamingResponse");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextToSpeechRouterStreamingStreamingResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __62__FTTextToSpeechRouterStreamingStreamingResponse_flatbuffData__block_invoke;
