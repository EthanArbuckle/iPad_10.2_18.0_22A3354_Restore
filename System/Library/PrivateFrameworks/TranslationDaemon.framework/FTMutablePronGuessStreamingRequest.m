...
{
  FTMutablePronGuessStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutablePronGuessStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartPronGuessRequest)contentAsFTStartPronGuessRequest
{
  ...
  if (-[FTMutablePronGuessStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTStartPronGuessRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 1);
...
- (FTAudioPacket)contentAsFTAudioPacket
{
  ...
  if (-[FTMutablePronGuessStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[FTMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTFinishAudio)contentAsFTFinishAudio
{
  ...
  if (-[FTMutablePronGuessStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[FTMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTCancelRequest)contentAsFTCancelRequest
{
  ...
  if (-[FTMutablePronGuessStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTCancelRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutablePronGuessStreamingRequest setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
