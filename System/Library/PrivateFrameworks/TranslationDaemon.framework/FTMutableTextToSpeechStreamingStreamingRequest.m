...
{
  FTMutableTextToSpeechStreamingStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTextToSpeechStreamingStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartTextToSpeechStreamingRequest)contentAsFTStartTextToSpeechStreamingRequest
{
  ...
  if (-[FTMutableTextToSpeechStreamingStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTStartTextToSpeechStreamingRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechStreamingStreamingRequest setContent_type:](self, "setContent_type:", 1);
