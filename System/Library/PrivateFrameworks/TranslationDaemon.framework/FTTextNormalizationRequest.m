...
{
  return -[FTTextNormalizationRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextNormalizationRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTTextNormalizationRequest)initWithFlatbuffData:(id)a3 root:(const TextNormalizationRequest *)a4
{
  return -[FTTextNormalizationRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextNormalizationRequest)initWithFlatbuffData:(id)a3 root:(const TextNormalizationRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTextNormalizationRequest *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  FTTextNormalizationRequest *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTTextNormalizationRequest init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::TextNormalizationRequest>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTTextNormalizationRequest speech_id](self, "speech_id");
  ...
  -[FTTextNormalizationRequest session_id](self, "session_id");
  ...
  -[FTTextNormalizationRequest language](self, "language");
  ...
  -[FTTextNormalizationRequest text](self, "text");
  ...
  v24 = -[FTTextNormalizationRequest nbest_variants_max](self, "nbest_variants_max");
  *((_BYTE *)a3 + 70) = 1;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextNormalizationRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __42__FTTextNormalizationRequest_flatbuffData__block_invoke;
