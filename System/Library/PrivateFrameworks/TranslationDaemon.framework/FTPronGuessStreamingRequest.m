...
{
  return -[FTPronGuessStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTPronGuessStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTPronGuessStreamingRequest)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingRequest *)a4
{
  return -[FTPronGuessStreamingRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTPronGuessStreamingRequest)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTPronGuessStreamingRequest *v10;
  FTPronGuessStreamingRequest *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::PronGuessStreamingRequest *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTPronGuessStreamingRequest *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTPronGuessStreamingRequest init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (FTStartPronGuessRequest)contentAsFTStartPronGuessRequest
{
  ...
  if (-[FTPronGuessStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (FTAudioPacket)contentAsFTAudioPacket
{
  ...
  if (-[FTPronGuessStreamingRequest content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTFinishAudio)contentAsFTFinishAudio
{
  ...
  if (-[FTPronGuessStreamingRequest content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FTCancelRequest)contentAsFTCancelRequest
{
  ...
  if (-[FTPronGuessStreamingRequest content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("content"));
...
- (FLTBFBufferAccessor)content
{
  ...
  switch(-[FTPronGuessStreamingRequest content_type](self, "content_type"))
  {
    case 1:
      -[FTPronGuessStreamingRequest contentAsFTStartPronGuessRequest](self, "contentAsFTStartPronGuessRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 2:
      -[FTPronGuessStreamingRequest contentAsFTAudioPacket](self, "contentAsFTAudioPacket");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 3:
      -[FTPronGuessStreamingRequest contentAsFTFinishAudio](self, "contentAsFTFinishAudio");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    case 4:
      -[FTPronGuessStreamingRequest contentAsFTCancelRequest](self, "contentAsFTCancelRequest");
      v3 = (void *)objc_claimAutoreleasedReturnValue();
      break;
    default:
      v3 = 0;
...
- (Offset<siri::speech::qss_fb::PronGuessStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTPronGuessStreamingRequest content_type](self, "content_type");
  if (-[FTPronGuessStreamingRequest content_type](self, "content_type") == 1)
  {
    -[FTPronGuessStreamingRequest contentAsFTStartPronGuessRequest](self, "contentAsFTStartPronGuessRequest");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTPronGuessStreamingRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __43__FTPronGuessStreamingRequest_flatbuffData__block_invoke;
