...
{
  return -[FTRepeatedSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTRepeatedSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4
{
  return -[FTRepeatedSpan initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4 verify:(BOOL)a5
{
  ...
  unint64_t v13;
  uint64_t v14;
  const RepeatedSpan *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::RepeatedSpan *v19;
  FTRepeatedSpan *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  ...
  v10 = -[FTRepeatedSpan init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)span
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTRepeatedSpan span_enumerateObjectsUsingBlock:](self, "span_enumerateObjectsUsingBlock:", v6);
...
- (Offset<siri::speech::schema_fb::RepeatedSpan>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v25;
  uint64_t v26;
  Offset<siri::speech::schema_fb::RepeatedSpan> v27;
  __int128 v29;
  __int128 v30;
  __int128 v31;
  __int128 v32;
  ...
  v29 = 0u;
  v30 = 0u;
  -[FTRepeatedSpan span](self, "span", 0);
  ...
  if (v33.__end_ == v33.__begin_)
    v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>> const&)::t;
  else
    v22 = v33.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTRepeatedSpan addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __30__FTRepeatedSpan_flatbuffData__block_invoke;
