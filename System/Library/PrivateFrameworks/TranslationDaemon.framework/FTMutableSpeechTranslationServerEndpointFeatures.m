...
{
  FTMutableSpeechTranslationServerEndpointFeatures *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableSpeechTranslationServerEndpointFeatures init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTServerEndpointFeatures *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("server_endpoint_features"));
}
