...
{
  FTMutableLanguageDetectionStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableLanguageDetectionStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (FTLanguageDetectionResponse)contentAsFTLanguageDetectionResponse
{
  ...
  if (-[FTMutableLanguageDetectionStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTLanguageDetectionResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableLanguageDetectionStreamingResponse setContent_type:](self, "setContent_type:", 1);
