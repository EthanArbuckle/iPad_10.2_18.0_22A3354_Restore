...
{
  FTMutableTextToSpeechRouterStreamingStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTextToSpeechRouterStreamingStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartTextToSpeechStreamingRequest)contentAsFTStartTextToSpeechStreamingRequest
{
  ...
  if (-[FTMutableTextToSpeechRouterStreamingStreamingRequest content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTStartTextToSpeechStreamingRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechRouterStreamingStreamingRequest setContent_type:](self, "setContent_type:", 1);
