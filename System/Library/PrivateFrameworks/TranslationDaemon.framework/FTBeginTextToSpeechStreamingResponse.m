...
{
  return -[FTBeginTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTBeginTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4
{
  return -[FTBeginTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTBeginTextToSpeechStreamingResponse *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  FTBeginTextToSpeechStreamingResponse *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTBeginTextToSpeechStreamingResponse init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::BeginTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTBeginTextToSpeechStreamingResponse speech_id](self, "speech_id");
  ...
  -[FTBeginTextToSpeechStreamingResponse session_id](self, "session_id");
  ...
  v15 = -[FTBeginTextToSpeechStreamingResponse error_code](self, "error_code");
  -[FTBeginTextToSpeechStreamingResponse error_str](self, "error_str");
  ...
  v19 = strlen(v18);
  v36 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v18, v19);
  v37 = v14;
  v20 = String;

  -[FTBeginTextToSpeechStreamingResponse stream_id](self, "stream_id");
  ...
  v26 = -[FTBeginTextToSpeechStreamingResponse audio_type](self, "audio_type");
  -[FTBeginTextToSpeechStreamingResponse decoder_description](self, "decoder_description");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v28 = objc_msgSend(v27, "addObjectToBuffer:", a3);

  -[FTBeginTextToSpeechStreamingResponse playback_description](self, "playback_description");
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  LODWORD(v23) = objc_msgSend(v29, "addObjectToBuffer:", a3);

  -[FTBeginTextToSpeechStreamingResponse meta_info](self, "meta_info");
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  v31 = objc_msgSend(v30, "addObjectToBuffer:", a3);

  -[FTBeginTextToSpeechStreamingResponse streaming_playback_buffer_size_in_seconds](self, "streaming_playback_buffer_size_in_seconds");
  v33 = v32;
  *((_BYTE *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 10, v36);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 12, v25);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((char *)a3, 14, v26, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 16, v28);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 18, (int)v23);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 20, v31);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<float>((char *)a3, 22, v33, 0.0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTBeginTextToSpeechStreamingResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __52__FTBeginTextToSpeechStreamingResponse_flatbuffData__block_invoke;
