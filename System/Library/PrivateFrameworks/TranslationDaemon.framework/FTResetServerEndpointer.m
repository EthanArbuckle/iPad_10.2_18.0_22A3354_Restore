...
{
  return -[FTResetServerEndpointer initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTResetServerEndpointer initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTResetServerEndpointer)initWithFlatbuffData:(id)a3 root:(const ResetServerEndpointer *)a4
{
  return -[FTResetServerEndpointer initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTResetServerEndpointer)initWithFlatbuffData:(id)a3 root:(const ResetServerEndpointer *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTResetServerEndpointer *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const ResetServerEndpointer *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::ResetServerEndpointer *v19;
  FTResetServerEndpointer *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTResetServerEndpointer init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
{
  const ResetServerEndpointer *root;
  const ResetServerEndpointer *v3;
  uint64_t v4;
...
- (Offset<siri::speech::schema_fb::ResetServerEndpointer>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = -[FTResetServerEndpointer speech_packet_count](self, "speech_packet_count");
  *((_BYTE *)a3 + 70) = 1;
  v5 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned long long>((char *)a3, 4, v4, 0);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTResetServerEndpointer addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __39__FTResetServerEndpointer_flatbuffData__block_invoke;
