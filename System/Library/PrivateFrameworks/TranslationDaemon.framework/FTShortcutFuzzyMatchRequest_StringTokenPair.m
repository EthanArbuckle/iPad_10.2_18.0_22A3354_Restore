...
{
  return -[FTShortcutFuzzyMatchRequest_StringTokenPair initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTShortcutFuzzyMatchRequest_StringTokenPair initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTShortcutFuzzyMatchRequest_StringTokenPair)initWithFlatbuffData:(id)a3 root:(const StringTokenPair *)a4
{
  return -[FTShortcutFuzzyMatchRequest_StringTokenPair initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTShortcutFuzzyMatchRequest_StringTokenPair)initWithFlatbuffData:(id)a3 root:(const StringTokenPair *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTShortcutFuzzyMatchRequest_StringTokenPair *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  FTShortcutFuzzyMatchRequest_StringTokenPair *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTShortcutFuzzyMatchRequest_StringTokenPair init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)tokens
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTShortcutFuzzyMatchRequest_StringTokenPair tokens_enumerateObjectsUsingBlock:](self, "tokens_enumerateObjectsUsingBlock:", v6);
...
- (Offset<siri::speech::schema_fb::ShortcutFuzzyMatchRequest_::StringTokenPair>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTShortcutFuzzyMatchRequest_StringTokenPair raw_string](self, "raw_string");
  ...
  -[FTShortcutFuzzyMatchRequest_StringTokenPair tokens](self, "tokens");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTShortcutFuzzyMatchRequest_StringTokenPair addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __59__FTShortcutFuzzyMatchRequest_StringTokenPair_flatbuffData__block_invoke;
