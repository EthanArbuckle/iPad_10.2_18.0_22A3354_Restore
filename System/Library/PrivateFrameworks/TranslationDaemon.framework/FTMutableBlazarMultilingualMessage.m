...
{
  FTMutableBlazarMultilingualMessage *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableBlazarMultilingualMessage init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartMultilingualSpeechRequest)session_messageAsFTStartMultilingualSpeechRequest
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 1)
  {
...
- (void)setSession_messageAsFTStartMultilingualSpeechRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 1);
...
- (FTUpdateAudioInfo)session_messageAsFTUpdateAudioInfo
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTUpdateAudioInfo:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTSetRequestOrigin)session_messageAsFTSetRequestOrigin
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTSetRequestOrigin:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTSetSpeechContext)session_messageAsFTSetSpeechContext
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTSetSpeechContext:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTSetSpeechProfile)session_messageAsFTSetSpeechProfile
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTSetSpeechProfile:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTAudioPacket)session_messageAsFTAudioPacket
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 6)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 6);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTFinishAudio)session_messageAsFTFinishAudio
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 7)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 7);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTLanguageDetected)session_messageAsFTLanguageDetected
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 8)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTLanguageDetected:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 8);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTFinalSpeechRecognitionResponse)session_messageAsFTFinalSpeechRecognitionResponse
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 9)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTFinalSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 9);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTPartialSpeechRecognitionResponse)session_messageAsFTPartialSpeechRecognitionResponse
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 10)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTPartialSpeechRecognitionResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 10);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTRecognitionCandidate)session_messageAsFTRecognitionCandidate
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 11)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTRecognitionCandidate:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 11);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTRequestStatsResponse)session_messageAsFTRequestStatsResponse
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 12)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTRequestStatsResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 12);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTAudioLimitExceeded)session_messageAsFTAudioLimitExceeded
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 13)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTAudioLimitExceeded:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 13);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTFinalBlazarResponse)session_messageAsFTFinalBlazarResponse
{
  ...
  if (-[FTMutableBlazarMultilingualMessage session_message_type](self, "session_message_type") == 14)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTFinalBlazarResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableBlazarMultilingualMessage setSession_message_type:](self, "setSession_message_type:", 14);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
