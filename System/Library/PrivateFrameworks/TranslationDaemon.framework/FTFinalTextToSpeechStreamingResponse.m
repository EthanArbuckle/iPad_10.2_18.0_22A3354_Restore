...
{
  return -[FTFinalTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTFinalTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTFinalTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const FinalTextToSpeechStreamingResponse *)a4
{
  return -[FTFinalTextToSpeechStreamingResponse initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTFinalTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const FinalTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTFinalTextToSpeechStreamingResponse *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  FTFinalTextToSpeechStreamingResponse *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTFinalTextToSpeechStreamingResponse init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (FTTextToSpeechResponseDevData)dev_data
{
  ...
  const FinalTextToSpeechStreamingResponse *v6;
  uint64_t v7;
  const FinalTextToSpeechStreamingResponse *v8;
...
- (Offset<siri::speech::schema_fb::FinalTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTFinalTextToSpeechStreamingResponse speech_id](self, "speech_id");
  ...
  -[FTFinalTextToSpeechStreamingResponse session_id](self, "session_id");
  ...
  v15 = -[FTFinalTextToSpeechStreamingResponse error_code](self, "error_code");
  -[FTFinalTextToSpeechStreamingResponse error_str](self, "error_str");
  ...
  -[FTFinalTextToSpeechStreamingResponse stream_id](self, "stream_id");
  ...
  LODWORD(v23) = -[FTFinalTextToSpeechStreamingResponse total_pkt_number](self, "total_pkt_number");
  -[FTFinalTextToSpeechStreamingResponse dev_data](self, "dev_data");
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = objc_msgSend(v26, "addObjectToBuffer:", a3);

  *((_BYTE *)a3 + 70) = 1;
  LODWORD(v26) = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>((char *)a3, 14, (int)v23, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 16, v27);
  return (Offset<siri::speech::schema_fb::FinalTextToSpeechStreamingResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (__int16)v26);
}
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTFinalTextToSpeechStreamingResponse addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __52__FTFinalTextToSpeechStreamingResponse_flatbuffData__block_invoke;
