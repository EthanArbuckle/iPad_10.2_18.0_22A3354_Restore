...
{
  return -[FTSetSpeechProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTSetSpeechProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTSetSpeechProfile)initWithFlatbuffData:(id)a3 root:(const SetSpeechProfile *)a4
{
  return -[FTSetSpeechProfile initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTSetSpeechProfile)initWithFlatbuffData:(id)a3 root:(const SetSpeechProfile *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTSetSpeechProfile *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  const SetSpeechProfile *root;
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::SetSpeechProfile *v19;
  FTSetSpeechProfile *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTSetSpeechProfile init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::SetSpeechProfile>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTSetSpeechProfile speech_id](self, "speech_id");
  ...
  -[FTSetSpeechProfile session_id](self, "session_id");
  ...
  -[FTSetSpeechProfile user_language_profile](self, "user_language_profile");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = objc_msgSend(v15, "addObjectToBuffer:", a3);

  -[FTSetSpeechProfile user_acoustic_profile](self, "user_acoustic_profile");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = objc_msgSend(v17, "addObjectToBuffer:", a3);

  -[FTSetSpeechProfile language](self, "language");
  ...
  *((_BYTE *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 10, v18);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 12, (int)v21);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTSetSpeechProfile addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __34__FTSetSpeechProfile_flatbuffData__block_invoke;
