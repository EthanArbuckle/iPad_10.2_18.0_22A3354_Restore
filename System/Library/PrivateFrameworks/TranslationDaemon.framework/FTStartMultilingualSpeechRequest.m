...
{
  return -[FTStartMultilingualSpeechRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTStartMultilingualSpeechRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTStartMultilingualSpeechRequest)initWithFlatbuffData:(id)a3 root:(const StartMultilingualSpeechRequest *)a4
{
  return -[FTStartMultilingualSpeechRequest initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTStartMultilingualSpeechRequest)initWithFlatbuffData:(id)a3 root:(const StartMultilingualSpeechRequest *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTStartMultilingualSpeechRequest *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  uint64_t v17;
  uint64_t v18;
  siri::speech::schema_fb::StartMultilingualSpeechRequest *v19;
  FTStartMultilingualSpeechRequest *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTStartMultilingualSpeechRequest init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
- (NSArray)language_parameters_by_id
{
  ...
  if (!v3)
  {
    ...
    v3 = v4;
    v7 = v3;
    -[FTStartMultilingualSpeechRequest language_parameters_by_id_enumerateObjectsUsingBlock:](self, "language_parameters_by_id_enumerateObjectsUsingBlock:", v6);
...
- (id)language_parameters_by_id_objectAtIndex:(unint64_t)a3
{
  void *v5;
  void *v6;
  FTLanguageParameters *v7;
  FTLanguageParameters *v8;
  const StartMultilingualSpeechRequest *root;
  ...
  if (v5)
  {
    ...
    v7 = (FTLanguageParameters *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    root = self->_root;
    ...
    v7 = -[FTLanguageParameters initWithFlatbuffData:root:verify:]([FTLanguageParameters alloc], "initWithFlatbuffData:root:verify:", self->_data, v12 + 4 + *(unsigned int *)(v12 + 4), 0);
  }
  v8 = v7;
LABEL_8:
...
{
  void (**v4)(id, FTLanguageParameters *, uint64_t, unsigned __int8 *);
  void *v5;
  void *v6;
  const StartMultilingualSpeechRequest *root;
  const StartMultilingualSpeechRequest *v8;
    ...
    if (*(unsigned __int16 *)v8->var0 >= 7u)
    {
      ...
      if (v9)
      {
        ...
        if ((_DWORD)v12)
        {
          ...
          do
          {
            v17 = -[FTLanguageParameters initWithFlatbuffData:root:verify:]([FTLanguageParameters alloc], "initWithFlatbuffData:root:verify:", self->_data, v13 + v14 + *(unsigned int *)(v13 + 4 * v15), 0);
            v4[2](v4, v17, v15, &v20);
            v18 = v20;
...
- (Offset<siri::speech::schema_fb::StartMultilingualSpeechRequest>)addObjectToBuffer:(void *)a3
{
  ...
  int v27;
  int v28;
  Offset<siri::speech::schema_fb::StartMultilingualSpeechRequest> v29;
  int v31;
  __int128 v32;
  __int128 v33;
  __int128 v34;
  ...
  -[FTStartMultilingualSpeechRequest start_speech_request](self, "start_speech_request");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "addObjectToBuffer:", a3);

  memset(&v36, 0, sizeof(v36));
  -[FTStartMultilingualSpeechRequest language_parameters_by_id](self, "language_parameters_by_id");
  ...
  if (v36.__end_ == v36.__begin_)
    v24 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageParameters>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageParameters>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageParameters>> const&)::t;
  else
    v24 = v36.__begin_;
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTStartMultilingualSpeechRequest addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __48__FTStartMultilingualSpeechRequest_flatbuffData__block_invoke;
