...
{
  FTMutableStartTextToSpeechStreamingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableStartTextToSpeechStreamingRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTTextToSpeechRequestMeta *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("meta_info"));
}
...
{
  return (FTTextToSpeechRequestContext *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("context"));
}
...
{
  return (FTTextToSpeechRequestExperiment *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("experiment"));
}
...
{
  return (FTTTSRequestFeatureFlags *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("feature_flags"));
}
...
{
  return (FTTextToSpeechRequestDebug *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("debug"));
}
...
{
  return (FTTextToSpeechUserProfile *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("profile"));
}
...
{
  return (FTTextToSpeechRequestDevConfig *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("dev_config"));
}
...
{
  return (FTTextToSpeechRequestProsodyTransferConfig *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("prosody_config"));
}
...
{
  return (FTTextToSpeechRequestProsodyControlConfig *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("prosody_control_config"));
}
