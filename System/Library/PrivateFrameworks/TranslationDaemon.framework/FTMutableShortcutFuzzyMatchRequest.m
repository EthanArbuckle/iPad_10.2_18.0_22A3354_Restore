...
{
  FTMutableShortcutFuzzyMatchRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableShortcutFuzzyMatchRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTShortcutFuzzyMatchRequest_StringTokenPair *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("utterance"));
}
