...
{
  FTMutableApgPronGuessMessage *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableApgPronGuessMessage init](&v6, sel_init);
  if (v2)
  {
...
- (FTStartPronGuessRequest)session_messageAsFTStartPronGuessRequest
{
  ...
  if (-[FTMutableApgPronGuessMessage session_message_type](self, "session_message_type") == 1)
  {
...
- (void)setSession_messageAsFTStartPronGuessRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableApgPronGuessMessage setSession_message_type:](self, "setSession_message_type:", 1);
...
- (FTAudioPacket)session_messageAsFTAudioPacket
{
  ...
  if (-[FTMutableApgPronGuessMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTAudioPacket:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableApgPronGuessMessage setSession_message_type:](self, "setSession_message_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTFinishAudio)session_messageAsFTFinishAudio
{
  ...
  if (-[FTMutableApgPronGuessMessage session_message_type](self, "session_message_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTFinishAudio:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableApgPronGuessMessage setSession_message_type:](self, "setSession_message_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTCancelRequest)session_messageAsFTCancelRequest
{
  ...
  if (-[FTMutableApgPronGuessMessage session_message_type](self, "session_message_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTCancelRequest:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableApgPronGuessMessage setSession_message_type:](self, "setSession_message_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
...
- (FTPronGuessResponse)session_messageAsFTPronGuessResponse
{
  ...
  if (-[FTMutableApgPronGuessMessage session_message_type](self, "session_message_type") == 5)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setSession_messageAsFTPronGuessResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableApgPronGuessMessage setSession_message_type:](self, "setSession_message_type:", 5);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("session_message"));
