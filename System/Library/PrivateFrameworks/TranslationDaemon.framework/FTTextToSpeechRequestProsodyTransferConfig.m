...
{
  return -[FTTextToSpeechRequestProsodyTransferConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTTextToSpeechRequestProsodyTransferConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}
...
{
  return -[FTTextToSpeechRequestProsodyTransferConfig initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTTextToSpeechRequestProsodyTransferConfig)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestProsodyTransferConfig *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTTextToSpeechRequestProsodyTransferConfig *v10;
  id *p_data;
  unsigned int *v12;
  unint64_t v13;
  uint64_t v14;
  ...
  FTTextToSpeechRequestProsodyTransferConfig *v20;
  _QWORD v22[2];
  __int128 v23;
  uint64_t v24;
  char v25;
  ...
  v10 = -[FTTextToSpeechRequestProsodyTransferConfig init](&v26, sel_init);
  if (!v10)
    goto LABEL_13;
...
{
  FTTextToSpeechUserVoiceProfile *v3;
  FTTextToSpeechUserVoiceProfile *v4;
  const TextToSpeechRequestProsodyTransferConfig *root;
  const TextToSpeechRequestProsodyTransferConfig *v6;
  uint64_t v7;
  const TextToSpeechRequestProsodyTransferConfig *v8;
  ...
  v3 = (FTTextToSpeechUserVoiceProfile *)objc_claimAutoreleasedReturnValue();
  if (!v3)
  {
    ...
    if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
      ...
      v8 = 0;
    v3 = -[FTTextToSpeechUserVoiceProfile initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestProsodyTransferConfig>)addObjectToBuffer:(void *)a3
{
  ...
  -[FTTextToSpeechRequestProsodyTransferConfig wave_data](self, "wave_data");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "addObjectToBuffer:", a3);

  -[FTTextToSpeechRequestProsodyTransferConfig user_voice_profile](self, "user_voice_profile");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_msgSend(v7, "addObjectToBuffer:", a3);

  -[FTTextToSpeechRequestProsodyTransferConfig user_voice_profile_url](self, "user_voice_profile_url");
  ...
  *((_BYTE *)a3 + 70) = 1;
  v13 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((char *)a3, 8, (int)v11);
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTTextToSpeechRequestProsodyTransferConfig addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __58__FTTextToSpeechRequestProsodyTransferConfig_flatbuffData__block_invoke;
