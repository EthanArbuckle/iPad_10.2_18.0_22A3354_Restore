...
{
  FTMutableTextToSpeechStreamingStreamingResponse *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableTextToSpeechStreamingStreamingResponse init](&v6, sel_init);
  if (v2)
  {
...
- (FTQssAckResponse)contentAsFTQssAckResponse
{
  ...
  if (-[FTMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 1)
  {
...
- (void)setContentAsFTQssAckResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 1);
...
- (FTBeginTextToSpeechStreamingResponse)contentAsFTBeginTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTBeginTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 2);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTPartialTextToSpeechStreamingResponse)contentAsFTPartialTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 3)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTPartialTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 3);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
...
- (FTFinalTextToSpeechStreamingResponse)contentAsFTFinalTextToSpeechStreamingResponse
{
  ...
  if (-[FTMutableTextToSpeechStreamingStreamingResponse content_type](self, "content_type") == 4)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("content"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)setContentAsFTFinalTextToSpeechStreamingResponse:(id)a3
{
  ...
  v5 = a3;
  -[FTMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", 4);
  v4 = (void *)objc_msgSend(v5, "copy");
  -[NSMutableDictionary setObject:forKeyedSubscript:](self->super._storage, "setObject:forKeyedSubscript:", v4, CFSTR("content"));
