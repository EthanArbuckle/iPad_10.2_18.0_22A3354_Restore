...
{
  FTMutableSpeechTranslationInfo *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableSpeechTranslationInfo init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTRecognitionSausage *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("raw_sausage"));
}
