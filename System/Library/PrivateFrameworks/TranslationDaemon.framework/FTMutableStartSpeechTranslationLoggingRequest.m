...
{
  FTMutableStartSpeechTranslationLoggingRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableStartSpeechTranslationLoggingRequest init](&v6, sel_init);
  if (v2)
  {
...
{
  return (FTLanguageDetected *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("detected_locale"));
}
