...
{
  id v5;
  FTMultilingualStreamingContext *v6;
  FTMultilingualStreamingContext *v7;
  FTMultilingualStreamingContext *v8;
  objc_super v10;

  v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)FTMultilingualStreamingContext;
  v6 = -[FTMultilingualStreamingContext init](&v10, sel_init);
  v7 = v6;
  if (v6)
  {
