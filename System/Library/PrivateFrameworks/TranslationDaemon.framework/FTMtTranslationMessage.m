...
{
  return -[FTMtTranslationMessage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 0);
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return -[FTMtTranslationMessage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, 0, 1);
}

- (FTMtTranslationMessage)initWithFlatbuffData:(id)a3 root:(const MtTranslationMessage *)a4
{
  return -[FTMtTranslationMessage initWithFlatbuffData:root:verify:](self, "initWithFlatbuffData:root:verify:", a3, a4, 0);
}
...
- (FTMtTranslationMessage)initWithFlatbuffData:(id)a3 root:(const MtTranslationMessage *)a4 verify:(BOOL)a5
{
  _BOOL4 v5;
  id v9;
  FTMtTranslationMessage *v10;
  FTMtTranslationMessage *v11;
  id *p_data;
  unsigned int *v13;
  unint64_t v14;
  uint64_t v15;
  ...
  uint64_t v18;
  uint64_t v19;
  siri::speech::qss_fb::MtTranslationMessage *root;
  uint64_t v21;
  NSMutableDictionary *storage;
  FTMtTranslationMessage *v23;
  uint64_t v25;
  uint64_t v26;
  __int128 v27;
  uint64_t v28;
  ...
  v10 = -[FTMtTranslationMessage init](&v30, sel_init);
  v11 = v10;
  if (v10)
  {
...
{
  const MtTranslationMessage *root;
  const MtTranslationMessage *v3;
  uint64_t v4;
...
- (FTTranslationRequest)session_messageAsFTTranslationRequest
{
  ...
  const MtTranslationMessage *root;
  const MtTranslationMessage *v6;
  uint64_t v7;
  const MtTranslationMessage *v8;

  if (-[FTMtTranslationMessage session_message_type](self, "session_message_type") == 1)
  {
...
{
  FTTranslationResponse *v3;
  FTTranslationResponse *v4;
  const MtTranslationMessage *root;
  const MtTranslationMessage *v6;
  uint64_t v7;
  const MtTranslationMessage *v8;

  if (-[FTMtTranslationMessage session_message_type](self, "session_message_type") == 2)
  {
    -[NSMutableDictionary objectForKeyedSubscript:](self->_storage, "objectForKeyedSubscript:", CFSTR("session_message"));
    v3 = (FTTranslationResponse *)objc_claimAutoreleasedReturnValue();
    if (!v3)
    {
      v4 = [FTTranslationResponse alloc];
      root = self->_root;
      v6 = &root[-*(int *)root->var0];
      if (*(unsigned __int16 *)v6->var0 >= 7u && (v7 = *(unsigned __int16 *)v6[6].var0) != 0)
        v8 = &root[v7 + *(unsigned int *)root[v7].var0];
        ...
        v8 = 0;
      v3 = -[FTTranslationResponse initWithFlatbuffData:root:verify:](v4, "initWithFlatbuffData:root:verify:", self->_data, v8, 0);
      -[NSMutableDictionary setObject:forKeyedSubscript:](self->_storage, "setObject:forKeyedSubscript:", v3, CFSTR("session_message"));
    }
  }
  else
...
- (FLTBFBufferAccessor)session_message
{
  ...
  v3 = -[FTMtTranslationMessage session_message_type](self, "session_message_type");
  if (v3 == 2)
  {
    -[FTMtTranslationMessage session_messageAsFTTranslationResponse](self, "session_messageAsFTTranslationResponse");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (v3 == 1)
  {
    -[FTMtTranslationMessage session_messageAsFTTranslationRequest](self, "session_messageAsFTTranslationRequest");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (Offset<siri::speech::qss_fb::MtTranslationMessage>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = -[FTMtTranslationMessage session_message_type](self, "session_message_type");
  if (-[FTMtTranslationMessage session_message_type](self, "session_message_type") == 1)
  {
    -[FTMtTranslationMessage session_messageAsFTTranslationRequest](self, "session_messageAsFTTranslationRequest");
...
- (id)flatbuffData
{
  ...
  v18 = 256;
  v19 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v11, -[FTMtTranslationMessage addObjectToBuffer:](self, "addObjectToBuffer:", &v11), 0, 0);
  v2 = operator new();
  v3 = v12;
  v4 = v14;
  v5 = v15;
  ...
  *(_QWORD *)(v2 + 40) = v6;
  ...
  v10[1] = 3221225472;
  v10[2] = __38__FTMtTranslationMessage_flatbuffData__block_invoke;
