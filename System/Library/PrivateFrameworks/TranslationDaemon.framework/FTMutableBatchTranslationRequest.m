...
{
  FTMutableBatchTranslationRequest *v2;
  uint64_t v3;
  ...
  v2 = -[FTMutableBatchTranslationRequest init](&v6, sel_init);
  if (v2)
  {
...
- (NSArray)paragraphs
{
  return (NSArray *)-[NSMutableDictionary objectForKeyedSubscript:](self->super._storage, "objectForKeyedSubscript:", CFSTR("paragraphs"));
}
