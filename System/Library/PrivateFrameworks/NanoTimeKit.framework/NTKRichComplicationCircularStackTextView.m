...
- (NTKRichComplicationCircularStackTextView)init
{
  ...
  return -[NTKRichComplicationBaseCircularStackTextView initWithFamily:](&v3, sel_initWithFamily_, 10);
}
...
- (void)_handleTemplate:(id)a3 reason:(int64_t)a4
{
  ...
  v5 = a3;
  -[NTKRichComplicationBaseCircularStackTextView setHighlightMode:](self, "setHighlightMode:", objc_msgSend(v5, "highlightMode"));
