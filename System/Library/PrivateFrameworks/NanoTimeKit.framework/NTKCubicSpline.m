...
- (NTKCubicSpline)initWithNumberOfControlPoints:(int)a3 isClosed:(BOOL)a4
{
  ...
  v6 = -[NTKCubicSpline init](&v12, sel_init);
  v7 = v6;
  if (v6)
  {
    v6->_length = v5;
    ...
    v7->_closed = v4;
    +[NTKCubicSplineMatrixCache sharedInstance](NTKCubicSplineMatrixCache, "sharedInstance");
...
- (void)dealloc
{
  ...
  -[NTKCubicSpline dealloc](&v3, sel_dealloc);
}
...
- (void)_processClosedSpline
{
  ...
  *(float32x2_t *)&self->_workspace->var0[2 * var0 - 2] = vmul_f32(vsub_f32(*(float32x2_t *)self->_controlPoints->var0, *(float32x2_t *)&self->_controlPoints->var0[2 * var0 - 4]), _D1);
  -[NTKCubicSpline _processSpline](self, "_processSpline");
}
...
{
  if (self->_closed)
    -[NTKCubicSpline _processClosedSpline](self, "_processClosedSpline");
  else
    -[NTKCubicSpline _processOpenSpline](self, "_processOpenSpline");
...
- (void)interpolateWithSteps:(int)a3 interpolation:(id)a4
{
  ...
  if ((a3 & 0x80000000) == 0)
  {
    ...
    do
    {
      ...
      *(float *)&v10 = v10;
      v11 = 0;
      -[NTKCubicSpline interpolateAt:derivative:](self, "interpolateAt:derivative:", &v11, (double)v10);
      v6[2](v6, v7);
      v7 = (v7 + 1);
    }
    while (v9 != (_DWORD)v7);
