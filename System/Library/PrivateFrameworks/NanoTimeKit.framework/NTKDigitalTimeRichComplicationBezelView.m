...
{
  NTKDigitalTimeRichComplicationBezelView *v2;
  void *v3;
  void *v4;
  NTKDigitalTimeRichComplicationBezelView *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)NTKDigitalTimeRichComplicationBezelView;
  v2 = -[NTKRichComplicationBezelBaseTextView init](&v7, sel_init);
  if (v2)
  {
    ...
    -[NTKDigitalTimeRichComplicationBezelView setBackgroundColor:](v2, "setBackgroundColor:", v4);
...
- (void)dealloc
{
  ...
  -[NTKDigitalTimeRichComplicationBezelView dealloc](&v4, sel_dealloc);
}
...
- (id)_createLabelViewWithFont:(id)a3
{
  ...
  +[CLKUITimeLabel labelWithOptions:forDevice:](NTKDigitalTimeLabel, "labelWithOptions:forDevice:", 1, v5);
  ...
  -[NTKDigitalTimeRichComplicationBezelView timeOffsetChanged](self, "timeOffsetChanged");
...
- (void)setTimeTravelDate:(id)a3 animated:(BOOL)a4
{
  ...
  -[NTKDigitalTimeRichComplicationBezelView updateDate](self, "updateDate");
