@implementation NTKAllCircularMediumComplicationTypes
...
void __NTKAllCircularMediumComplicationTypes_block_invoke()
{
  ...
  v8 = 0u;
  v9 = 0u;
  v2 = objc_msgSend(&unk_1E6CAAC30, "countByEnumeratingWithState:objects:count:", &v8, v12, 16);
  if (v2)
  {
    v3 = v2;
    v4 = *(_QWORD *)v9;
    do
    {
      ...
      {
        if (*(_QWORD *)v9 != v4)
          objc_enumerationMutation(&unk_1E6CAAC30);
        objc_msgSend(v1, "removeIndex:", objc_msgSend(*(id *)(*((_QWORD *)&v8 + 1) + 8 * v5++), "unsignedIntegerValue"));
      }
      while (v3 != v5);
      v3 = objc_msgSend(&unk_1E6CAAC30, "countByEnumeratingWithState:objects:count:", &v8, v12, 16);
    }
    while (v3);
  }
  v6 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB36B8]), "initWithIndexSet:", v1);
  v7 = (void *)NTKAllCircularMediumComplicationTypes_results;
