...
void ___NTKKaleidoscopeLoggingObjectForDomain_block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v2, "substringFromIndex:", objc_msgSend(CFSTR("NTKKaleidoscopeLoggingDomain"), "length"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();

  v7 = objc_retainAutorelease(v3);
  v4 = os_log_create("com.apple.NanoTimeKit.Kaleidoscope", (const char *)objc_msgSend(v7, "cStringUsingEncoding:", 4));
  v5 = *(_QWORD *)(a1 + 32);
