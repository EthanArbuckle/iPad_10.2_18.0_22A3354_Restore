...
- (id)_outerView
{
  ...
  if (!swiftUIView)
  {
    ...
    -[CDComplicationHostingView setShouldAccentDesaturatedView:](self->_swiftUIView, "setShouldAccentDesaturatedView:", 1);
...
- (void)_handleTemplate:(id)a3 reason:(int64_t)a4
{
  ...
  -[CDComplicationHostingView setViewData:](self->_swiftUIView, "setViewData:", v8);
}
