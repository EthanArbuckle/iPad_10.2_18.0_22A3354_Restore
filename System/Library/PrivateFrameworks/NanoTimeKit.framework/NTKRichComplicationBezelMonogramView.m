...
- (void)setComplicationTemplate:(id)a3 reason:(int64_t)a4
{
  ...
  -[NTKRichComplicationBezelMonogramView _labelFont](self, "_labelFont");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[CLKUIColoringLabel setFont:](self->_textLabel, "setFont:", v6);

  -[NTKRichComplicationBezelMonogramView setNeedsLayout](self, "setNeedsLayout");
}
...
- (id)_createLabelViewWithFont:(id)a3
{
  ...
  v13[1] = 3221225472;
  v13[2] = __65__NTKRichComplicationBezelMonogramView__createLabelViewWithFont___block_invoke;
  v13[3] = &unk_1E6BCD7C8;
  objc_copyWeak(&v14, &location);
  objc_msgSend(v5, "setNowProvider:", v13);
  v11[0] = v6;
  v11[1] = 3221225472;
  v11[2] = __65__NTKRichComplicationBezelMonogramView__createLabelViewWithFont___block_invoke_2;
  v11[3] = &unk_1E6BCD7F0;
