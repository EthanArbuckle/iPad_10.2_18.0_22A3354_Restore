...
- (void)_setFontConfiguration:(CDRichComplicationFontConfiguration *)a3
{
  ...
  -[CDRichComplicationCornerBaseTextView _setFontConfiguration:](&v7, sel__setFontConfiguration_, v8);
  if (a3->var1)
  {
...
- (void)_handleTemplate:(id)a3 reason:(int64_t)a4
{
  ...
  objc_msgSend(v8, "setTextProvider:", v7);

  objc_msgSend(v6, "imageProvider");
  v9 = (id)objc_claimAutoreleasedReturnValue();

  -[CDRichComplicationImageView setImageProvider:reason:](self->_imageView, "setImageProvider:reason:", v9, a4);
}
