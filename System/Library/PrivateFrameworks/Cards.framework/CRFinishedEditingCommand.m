...
{
  CRFinishedEditingCommand *v5;
  void *v6;
  void *v7;

  v5 = objc_alloc_init(CRFinishedEditingCommand);
  -[CRFinishedEditingCommand userInfo](self, "userInfo");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = (void *)objc_msgSend(v6, "copyWithZone:", a3);
  -[CRFinishedEditingCommand setUserInfo:](v5, "setUserInfo:", v7);

  -[CRFinishedEditingCommand setCommandDirection:](v5, "setCommandDirection:", -[CRFinishedEditingCommand commandDirection](self, "commandDirection"));
  return v5;
}
