...
- (const)mathMLAttributes
{
  ...
  if ((v2 & 1) == 0
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMUnderover mathMLAttributes]::sAttributesSet, -[EQKitMathMLMUnderover mathMLAttributes]::sAttributesData, -[EQKitMathMLMStringLiteral mathMLAttributes]::sAttributesData);
  }
