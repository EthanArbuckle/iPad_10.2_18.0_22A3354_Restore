...
- (EQKitLayoutElementaryStackCarryRow)initWithChildren:(id)a3 decimalPoint:(unint64_t)a4 position:(int64_t)a5 followingSpace:(double)a6 crossouts:(const void *)a7
{
  ...
  if (v8)
  {
    ...
    if (&v9->mCrossouts != a7)
      std::vector<EQKitTypes::Notation::Enum>::__assign_with_size[abi:ne180100]<EQKitTypes::Notation::Enum*,EQKitTypes::Notation::Enum*>(p_mCrossouts, *(char **)a7, *((_QWORD *)a7 + 1), (uint64_t)(*((_QWORD *)a7 + 1) - *(_QWORD *)a7) >> 2);
  }
  return v9;
}
