...
- (id)newBoxWithStackWidth:(double)a3 columnWidthIter:(__wrap_iter<double *>)a4 iterMax:(__wrap_iter<double *>)a5 previousRow:(id)a6 layoutManager:(const void *)a7
{
  ...
  return -[EQKitRule initWithHeight:depth:width:cgColor:]([EQKitRule alloc], "initWithHeight:depth:width:cgColor:", *(_QWORD *)(EQKitLayoutManager::layoutContext((EQKitLayoutManager *)a7) + 112), 0.0, self->mThickness, a3);
}
