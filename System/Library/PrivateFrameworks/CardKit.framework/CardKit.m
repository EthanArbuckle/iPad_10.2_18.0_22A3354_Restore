...
void sub_218FCD784(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  uint64_t v3;
...
void sub_218FCDBB8(_Unwind_Exception *a1)
{
  id *v1;
...
void sub_218FCE618(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_218FCEB68(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, id *location)
{
  id *v11;
  id *v12;
  uint64_t v13;
...
void sub_218FCEF94(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, id a9)
{
  objc_destroyWeak(&a9);
  _Unwind_Resume(a1);
}

void sub_218FCF1B0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
void sub_218FCFD74(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  uint64_t v9;
  va_list va;
...
void sub_218FD0DEC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
void sub_218FD30EC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_218FD4EB4(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_218FD535C(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  id *v3;
...
void sub_218FD5810(_Unwind_Exception *a1)
{
  id *v1;
...
BOOL CRKIsRTL(void *a1)
{
  ...
  v3 = v2;
  if (v1)
    v4 = objc_msgSend(v1, "effectiveUserInterfaceLayoutDirection");
  else
    v4 = objc_msgSend(v2, "userInterfaceLayoutDirection");
  v5 = v4 == 1;
