...
{
  RB::Transition::Effect::set_begin_time((uint64_t)&self->_effect, a3);
}
...
{
  RB::Transition::Effect::set_duration((uint64_t)&self->_effect, a3);
}
...
{
  RB::Transition::Effect::set_remove_animation((uint64_t)&self->_effect, a3);
}

- (unsigned)events
{
  return *((_BYTE *)&self->_effect + 1) & 0x3F;
}
