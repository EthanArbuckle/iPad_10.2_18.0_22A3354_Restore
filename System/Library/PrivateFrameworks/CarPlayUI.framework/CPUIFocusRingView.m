...
- (CPUIFocusRingView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    -[CPUIFocusRingView setBackgroundColor:](v3, "setBackgroundColor:", v4);
...
- (void)_updateFocusRect
{
  ...
  -[CPUIFocusRingView focusPath](self, "focusPath");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "removeAllPoints");

  -[CPUIFocusRingView setFocusPath:](self, "setFocusPath:", 0);
  -[CPUIFocusRingView setNeedsDisplay](self, "setNeedsDisplay");
}
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  -[CPUIFocusRingView traitCollectionDidChange:](&v4, sel_traitCollectionDidChange_, a3);
  -[CPUIFocusRingView _updateFocusRect](self, "_updateFocusRect");
}
...
- (void)layoutSubviews
{
  ...
  -[CPUIFocusRingView layoutSubviews](&v3, sel_layoutSubviews);
  -[CPUIFocusRingView _updateFocusRect](self, "_updateFocusRect");
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  if (!v12)
  {
    ...
    -[CPUIFocusRingView cornerRadius](self, "cornerRadius");
    ...
    -[CPUIFocusRingView setFocusPath:](self, "setFocusPath:", v15);

  }
  -[CPUIFocusRingView ringColor](self, "ringColor");
