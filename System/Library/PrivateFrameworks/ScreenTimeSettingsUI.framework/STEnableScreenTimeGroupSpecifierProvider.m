...
+ (id)providerWithCoordinator:(id)a3 rootViewController:(id)a4
{
  ...
  v5 = a4;
  +[STRootGroupSpecifierProvider providerWithCoordinator:](STEnableScreenTimeGroupSpecifierProvider, "providerWithCoordinator:", a3);
...
{
  STEnableScreenTimeGroupSpecifierProvider *v2;
  void *v3;
  _BOOL8 v4;
  void *v5;
  void *v6;
  ...
  if (v2)
  {
    ...
    objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("EnableScreenTimeButtonName"), &stru_24DB8A1D0, 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    -[PSSpecifier setButtonAction:](v2->_setupScreenTimeSpecifier, "setButtonAction:", sel_setupScreenTime_);
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", v4);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[PSSpecifier setObject:forKeyedSubscript:](v2->_setupScreenTimeSpecifier, "setObject:forKeyedSubscript:", v9, *MEMORY[0x24BE75A18]);

    -[STGroupSpecifierProvider mutableSpecifiers](v2, "mutableSpecifiers");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "addObject:", v2->_setupScreenTimeSpecifier);
    objc_msgSend(MEMORY[0x24BE63CB0], "sharedConnection");
...
- (void)setCoordinator:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "removeObserver:forKeyPath:context:", self, CFSTR("viewModel.canStartScreenTime"), "STSetupScreenTimeGroupSpecifierProviderObservationContext");
  objc_msgSend(v5, "removeObserver:forKeyPath:context:", self, CFSTR("viewModel.me"), "STSetupScreenTimeGroupSpecifierProviderObservationContext");
  v6.receiver = self;
  ...
  objc_msgSend(v4, "addObserver:forKeyPath:options:context:", self, CFSTR("viewModel.me"), 4, "STSetupScreenTimeGroupSpecifierProviderObservationContext");
  objc_msgSend(v4, "addObserver:forKeyPath:options:context:", self, CFSTR("viewModel.canStartScreenTime"), 4, "STSetupScreenTimeGroupSpecifierProviderObservationContext");
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  if (a6 == "STSetupScreenTimeGroupSpecifierProviderObservationContext")
  {
    ...
    if (objc_msgSend(v10, "isEqualToString:", CFSTR("viewModel.canStartScreenTime")))
    {
      if (v12 == 2)
      {
      ...
      -[STGroupSpecifierProvider setIsHidden:](self, "setIsHidden:", objc_msgSend(v15, "canStartScreenTime") ^ 1);
    }
    else
    {
      ...
      if (v12 == 2)
      {
        ...
        objc_msgSend(v13, "localizedStringForKey:value:table:", CFSTR("ScreenTimeRestrictedFooterText"), &stru_24DB8A1D0, 0);
        v14 = (void *)objc_claimAutoreleasedReturnValue();

      }
      else
      {
        -[STEnableScreenTimeGroupSpecifierProvider enableScreenTimeFooterText](self, "enableScreenTimeFooterText");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
      }
      ...
      if ((objc_msgSend(v17, "isEqualToString:", v14) & 1) == 0)
      {
        ...
        -[STGroupSpecifierProvider reloadSpecifier:animated:](self, "reloadSpecifier:animated:", v15, 1);
      }
  ...
  -[STEnableScreenTimeGroupSpecifierProvider observeValueForKeyPath:ofObject:change:context:](&v18, sel_observeValueForKeyPath_ofObject_change_context_, v10, a4, a5, a6);
LABEL_15:
...
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)a3 userInfo:(id)a4
{
  ...
  -[STEnableScreenTimeGroupSpecifierProvider setupScreenTimeSpecifier](self, "setupScreenTimeSpecifier");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)enableScreenTimeFooterText
{
  ...
  if ((v3 & 1) == 0)
  {
    v14 = CFSTR("EnableScreenTimeFooterText");
LABEL_8:
  ...
  {
LABEL_7:
    v14 = CFSTR("EnableScreenTimeRemoteGenericFooterText");
    goto LABEL_8;
  }
  ...
  objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("EnableScreenTimeRemoteFooterText"), &stru_24DB8A1D0, 0);
...
- (void)setupScreenTime:(id)a3
{
  ...
  -[STEnableScreenTimeGroupSpecifierProvider rootViewController](self, "rootViewController", v11, v12, v13, v14);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
void __60__STEnableScreenTimeGroupSpecifierProvider_setupScreenTime___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_FAULT))
      __60__STEnableScreenTimeGroupSpecifierProvider_setupScreenTime___block_invoke_2_cold_1((uint64_t)v3, v4);
...
void __60__STEnableScreenTimeGroupSpecifierProvider_setupScreenTime___block_invoke_2_cold_1(uint64_t a1, NSObject *a2)
{
  int v2;
  uint64_t v3;
  uint64_t v4;
  ...
  v2 = 138543362;
  v3 = a1;
  _os_log_fault_impl(&dword_219AB4000, a2, OS_LOG_TYPE_FAULT, "failed to set screen time enabled: %{public}@", (uint8_t *)&v2, 0xCu);
}
