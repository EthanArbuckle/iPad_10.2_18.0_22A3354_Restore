...
- (id)specifiers
{
  ...
  void *v4;
  void *v5;
  STAllowPhotoRestrictionsController *v6;
  id v7;
  void *v8;
  void *v9;
  void *v10;
  ...
  if (!v4)
  {
    ...
    -[PUIPhotosPrivacyController specifiers](&v23, sel_specifiers);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0)
      -[STAllowPhotoRestrictionsController specifiers].cold.1();
    ...
    objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("PHOTOS_EXPLANATION"), &stru_24DB8A1D0, CFSTR("Restrictions"));
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  id WeakRetained;
  PSSpecifier *allowedGroup;
  STAllowPhotoRestrictionsController *v15;
  id v16;
  PSSpecifier *v17;
  id v18;
  void *v19;
  ...
  id v32;
  id v33;
  STAllowPhotoRestrictionsController *v34;

  v6 = a3;
  v7 = a4;
  v8 = objc_msgSend(v7, "section");
  -[STAllowPhotoRestrictionsController indexPathForIndex:](self, "indexPathForIndex:", -[STAllowPhotoRestrictionsController indexOfSpecifier:](self, "indexOfSpecifier:", self->_allowedGroup));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    -[STAllowPhotoRestrictionsController tableView:didSelectRowAtIndexPath:](&v30, sel_tableView_didSelectRowAtIndexPath_, v6, v7);
    ...
    v17 = allowedGroup;
    v18 = v7;
    -[STAllowPhotoRestrictionsController indexPathForIndex:](v15, "indexPathForIndex:", -[STAllowPhotoRestrictionsController indexOfSpecifier:](v15, "indexOfSpecifier:", v17));
    ...
    if (objc_msgSend(v18, "section") == v20)
    {
      ...
      -[STAllowPhotoRestrictionsController specifierAtIndex:](v15, "specifierAtIndex:", -[STAllowPhotoRestrictionsController indexForIndexPath:](v15, "indexForIndexPath:", v18));
      v22 = v6;
      ...
      -[PUIPhotosPrivacyController updateSpecifiersForImposedSettings](v15, "updateSpecifiersForImposedSettings");
...
- (void)specifiers
{
  __assert_rtn("-[STAllowPhotoRestrictionsController specifiers]", "STAllowPhotoRestrictionsController.m", 27, "[specifiers isKindOfClass:[NSMutableArray class]]");
}
