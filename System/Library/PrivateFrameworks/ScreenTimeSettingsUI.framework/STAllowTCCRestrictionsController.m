...
- (id)specifiers
{
  ...
  void *v8;
  int v9;
  STAllowTCCRestrictionsController *v10;
  id v11;
  void *v12;
  void *v13;
  void *v14;
  ...
  if (!v4)
  {
    ...
    -[PUITCCAccessController specifiers](&v31, sel_specifiers);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0)
      -[STAllowTCCRestrictionsController specifiers].cold.1();
    ...
    objc_msgSend(*(id *)((char *)&self->super.super.super.super.super.super.isa + v6), "performGetter");
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = objc_msgSend(v30, "BOOLValue");
    v10 = self;
    v11 = v7;
    v28 = v5;
    v29 = v8;
    ...
    if (v11)
    {
      ...
      v26 = v9 ^ (objc_msgSend(v13, "restrictionType") == 1);
    ...
    objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("AllowChangesSpecifierName"), &stru_24DB8A1D0, CFSTR("Restrictions"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", v14, v10, 0, 0, 0, 3, 0);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    v16 = *MEMORY[0x24BE75AC0];
    objc_msgSend(v15, "setObject:forKeyedSubscript:", CFSTR("ALLOW"), *MEMORY[0x24BE75AC0]);

    objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("DontAllowChangesSpecifierName"), &stru_24DB8A1D0, CFSTR("Restrictions"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", v17, v10, 0, 0, 0, 3, 0);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "setObject:forKeyedSubscript:", CFSTR("DISALLOW"), v16);

    objc_msgSend(MEMORY[0x24BE75590], "emptyGroupSpecifier");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "setObject:forKeyedSubscript:", CFSTR("ALLOW_GROUP"), v16);
    objc_msgSend(v12, "localizedStringForKey:value:table:", v29, &stru_24DB8A1D0, CFSTR("Restrictions"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v19, "setObject:forKeyedSubscript:", v20, *MEMORY[0x24BE75A68]);
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", 1);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "setObject:forKeyedSubscript:", v21, *MEMORY[0x24BE75B28]);

    if (v26)
      v22 = v15;
    else
      v22 = v18;
    objc_msgSend(v19, "setObject:forKeyedSubscript:", v22, *MEMORY[0x24BE75C20]);
    objc_msgSend(v28, "insertObject:atIndex:", v19, 0);
    objc_msgSend(v28, "insertObject:atIndex:", v15, 1);
    objc_msgSend(v28, "insertObject:atIndex:", v18, 2);
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  id WeakRetained;
  PSSpecifier *allowedGroup;
  STAllowTCCRestrictionsController *v15;
  id v16;
  PSSpecifier *v17;
  id v18;
  void *v19;
  ...
  id v32;
  id v33;
  STAllowTCCRestrictionsController *v34;

  v6 = a3;
  v7 = a4;
  v8 = objc_msgSend(v7, "section");
  -[STAllowTCCRestrictionsController indexPathForIndex:](self, "indexPathForIndex:", -[STAllowTCCRestrictionsController indexOfSpecifier:](self, "indexOfSpecifier:", self->_allowedGroup));
  ...
  else
  {
    ...
    -[STAllowTCCRestrictionsController tableView:didSelectRowAtIndexPath:](&v30, sel_tableView_didSelectRowAtIndexPath_, v6, v7);
    ...
    v17 = allowedGroup;
    v18 = v7;
    -[STAllowTCCRestrictionsController indexPathForIndex:](v15, "indexPathForIndex:", -[STAllowTCCRestrictionsController indexOfSpecifier:](v15, "indexOfSpecifier:", v17));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v18, "section") == v20)
    {
      ...
      -[STAllowTCCRestrictionsController specifierAtIndex:](v15, "specifierAtIndex:", -[STAllowTCCRestrictionsController indexForIndexPath:](v15, "indexForIndexPath:", v18));
      v22 = v6;
      ...
      -[PUITCCAccessController updateSpecifiersForImposedSettings](v15, "updateSpecifiersForImposedSettings");
...
- (void)specifiers
{
  __assert_rtn("-[STAllowTCCRestrictionsController specifiers]", "STAllowTCCRestrictionsController.m", 26, "[specifiers isKindOfClass:[NSMutableArray class]]");
}
