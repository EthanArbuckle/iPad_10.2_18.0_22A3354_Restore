...
+ (float32x2_t)rotate:(float)a1 axis:(float32x4_t)a2
{
  ...
  _S2 = _Q3.i32[1];
  result = vmla_n_f32((float32x2_t)__PAIR64__(vmulq_n_f32(_Q3, *(float *)&v2).u32[2], LODWORD(v2.__cosval)), *(float32x2_t *)_Q3.f32, _Q6.f32[0]);
  _Q3.i32[0] = _Q3.i32[2];
  __asm
  {
    FMLA            S17, S2, V6.S[1]
...
+ (float)perspective_fov:(float)a3 aspect:near:far:
{
  ...
  *(float *)&a2 = *(float *)&a2 * 0.5;
  objc_msgSend(a1, "degreesToRadians:", a2);
...
+ (double)lookAt:(float32x4_t)a1 center:(float32x4_t)a2 up:(float32x4_t)a3
{
  ...
  v11 = (float32x4_t)vextq_s8((int8x16_t)vuzp1q_s32((int32x4_t)v9, (int32x4_t)v9), (int8x16_t)v9, 0xCuLL);
  ...
  *(float32x2_t *)v9.f32 = vmul_f32(*(float32x2_t *)v9.f32, vrsqrts_f32((float32x2_t)v10.u32[0], vmul_f32(*(float32x2_t *)v9.f32, *(float32x2_t *)v9.f32)));
  v12 = vmulq_n_f32(v11, vmul_f32(*(float32x2_t *)v9.f32, vrsqrts_f32((float32x2_t)v10.u32[0], vmul_f32(*(float32x2_t *)v9.f32, *(float32x2_t *)v9.f32))).f32[0]);
  v13 = (int32x4_t)vmlaq_f32(vmulq_f32((float32x4_t)vextq_s8((int8x16_t)vuzp1q_s32((int32x4_t)v12, (int32x4_t)v12), (int8x16_t)v12, 0xCuLL), vnegq_f32(v7)), v12, v8);
  v8.i32[0] = v12.i32[0];
...
+ (float64x2_t)fromMatrix:(int32x4_t)a3@<Q1>
{
  ...
  v4 = a4.n128_f32[2] + (float)(*(float *)a2.i32 + *(float *)&a3.i32[1]);
  if (v4 >= 0.0)
  {
    v14 = sqrtf(v4 + 1.0);
    v15 = v14 + v14;
    v16 = vrecpe_f32((float32x2_t)COERCE_UNSIGNED_INT(v14 + v14));
    v17 = vmul_f32(v16, vrecps_f32((float32x2_t)COERCE_UNSIGNED_INT(v14 + v14), v16));
    v17.i32[0] = vmul_f32(v17, vrecps_f32((float32x2_t)COERCE_UNSIGNED_INT(v14 + v14), v17)).u32[0];
    v28 = vmul_n_f32(vsub_f32((float32x2_t)vzip1_s32((int32x2_t)*(_OWORD *)&vextq_s8((int8x16_t)a3, (int8x16_t)a3, 8uLL), (int32x2_t)a4.n128_u64[0]), (float32x2_t)vext_s8((int8x8_t)a4.n128_u64[0], (int8x8_t)*(_OWORD *)&vextq_s8((int8x16_t)a2, (int8x16_t)a2, 8uLL), 4uLL)), v17.f32[0]);
  ...
  else if (*(float *)a2.i32 < *(float *)&a3.i32[1] || *(float *)a2.i32 < a4.n128_f32[2])
  {
    ...
    {
      v31 = sqrtf(*(float *)&a3.i32[1] + (float)(v6 - a4.n128_f32[2]));
      *(float *)&v32 = v31 + v31;
      ...
      v34.i32[1] = v32;
      v36 = (float32x2_t)vrev64_s32((int32x2_t)a4.n128_u64[0]);
      ...
      v30 = vmul_n_f32(v37, v35.f32[0]);
      v35.i32[1] = 0.25;
      v28 = vmul_f32(v34, v35);
    }
    else
    {
      v7 = (float32x2_t)__PAIR64__(a2.u32[1], COERCE_UNSIGNED_INT(sqrtf(a4.n128_f32[2] + (float)(v6 - *(float *)&a3.i32[1]))));
      v8 = vadd_f32((float32x2_t)vzip1_s32((int32x2_t)*(_OWORD *)&vextq_s8((int8x16_t)a2, (int8x16_t)a2, 8uLL), (int32x2_t)*(_OWORD *)&vextq_s8((int8x16_t)a3, (int8x16_t)a3, 8uLL)), (float32x2_t)a4.n128_u64[0]);
      v9 = (float32x2_t)vdup_lane_s32(*(int32x2_t *)a3.i8, 0);
      v10 = vsub_f32(*(float32x2_t *)a2.i8, v9);
      v9.i32[0] = 2.0;
      v9.i32[0] = vmul_f32(v7, v9).u32[0];
      v9.i32[1] = v10.i32[1];
      v11 = vrecpe_f32((float32x2_t)v9.u32[0]);
      v12 = vmul_f32(v11, vrecps_f32((float32x2_t)v9.u32[0], v11));
      v10.i32[0] = vmul_f32(v12, vrecps_f32((float32x2_t)v9.u32[0], v12)).u32[0];
      v28 = vmul_n_f32(v8, v10.f32[0]);
  ...
  {
    v19 = (float32x2_t)vdup_lane_s32(*(int32x2_t *)a3.i8, 0);
    v20 = vadd_f32(*(float32x2_t *)a2.i8, v19);
    v19.i32[0] = 2.0;
