...
void __69__ARCoachingControlBlurredBackgroundView_normalEffectsForARDarkStyle__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0CEA950], "mainScreen", v2);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  UIRoundToScreenScale();
...
void __71__ARCoachingControlBlurredBackgroundView_normalEffectsForDarkModeStyle__block_invoke()
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v12[2] = v8;
  objc_msgSend(MEMORY[0x1E0CEA480], "colorEffectSaturate:", 1.8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v12[3] = v9;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v12, 4);
  v10 = objc_claimAutoreleasedReturnValue();
...
{
  ARCoachingControlBlurredBackgroundView *v7;
  ARCoachingControlBlurredBackgroundView *v8;
  objc_super v10;

  v10.receiver = self;
  v10.super_class = (Class)ARCoachingControlBlurredBackgroundView;
  v7 = -[ARCoachingControlBlurredBackgroundView initWithFrame:](&v10, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v8 = v7;
  if (v7)
  {
    v7->_enabled = 1;
    ...
    v7->_controlStyle = a5;
    -[ARCoachingControlBlurredBackgroundView updateBackgroundEffects](v7, "updateBackgroundEffects");
  }
  return v8;
}
...
- (void)setControlStyle:(int64_t)a3
{
  if (self->_controlStyle != a3)
  {
    ...
    -[ARCoachingControlBlurredBackgroundView updateBackgroundEffects](self, "updateBackgroundEffects");
  }
}
...
- (void)updateBackgroundEffects
{
  ...
  if (-[ARCoachingControlBlurredBackgroundView controlStyle](self, "controlStyle") == 2)
  {
    if (-[ARCoachingControlBlurredBackgroundView isHighlighted](self, "isHighlighted")
      || -[ARCoachingControlBlurredBackgroundView isSelected](self, "isSelected"))
    {
  ...
  else if (-[ARCoachingControlBlurredBackgroundView controlStyle](self, "controlStyle") == 3)
  {
    if (-[ARCoachingControlBlurredBackgroundView isHighlighted](self, "isHighlighted")
      || -[ARCoachingControlBlurredBackgroundView isSelected](self, "isSelected"))
    {
  ...
  {
    if (-[ARCoachingControlBlurredBackgroundView isSelected](self, "isSelected")
      || -[ARCoachingControlBlurredBackgroundView backgroundStyle](self, "backgroundStyle") == 1)
    {
      v4 = -[ARCoachingControlBlurredBackgroundView isEnabled](self, "isEnabled");
    ...
    else if (-[ARCoachingControlBlurredBackgroundView isEnabled](self, "isEnabled"))
    {
      v6 = -[ARCoachingControlBlurredBackgroundView isHighlighted](self, "isHighlighted");
      v7 = -[ARCoachingControlBlurredBackgroundView controlStyle](self, "controlStyle");
    ...
    {
      v9 = -[ARCoachingControlBlurredBackgroundView controlStyle](self, "controlStyle");
  ...
  v11 = (id)v3;
  -[ARCoachingControlBlurredBackgroundView setBackgroundEffects:](self, "setBackgroundEffects:", v3);
