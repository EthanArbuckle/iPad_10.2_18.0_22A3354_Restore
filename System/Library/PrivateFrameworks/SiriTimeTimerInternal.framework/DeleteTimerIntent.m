...
- (DeleteTimerIntent)init
{
  ...
  return -[DeleteTimerIntent init](&v3, sel_init);
}
...
- (DeleteTimerIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v9 = -[DeleteTimerIntent initWithIdentifier:backingStore:](&v11, sel_initWithIdentifier_backingStore_, v7, a4);
...
- (DeleteTimerIntent)initWithCoder:(id)a3
{
  ...
  return -[DeleteTimerIntent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
...
- (DeleteTimerIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v10 = -[DeleteTimerIntent initWithDomain:verb:parametersByName:](&v12, sel_initWithDomain_verb_parametersByName_, v7, v8, v9);
