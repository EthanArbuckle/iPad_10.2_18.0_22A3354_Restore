...
- (CreateTimerIntent)init
{
  ...
  return -[CreateTimerIntent init](&v3, sel_init);
}
...
- (CreateTimerIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v9 = -[CreateTimerIntent initWithIdentifier:backingStore:](&v11, sel_initWithIdentifier_backingStore_, v7, a4);
...
- (CreateTimerIntent)initWithCoder:(id)a3
{
  ...
  return -[CreateTimerIntent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
...
- (CreateTimerIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v10 = -[CreateTimerIntent initWithDomain:verb:parametersByName:](&v12, sel_initWithDomain_verb_parametersByName_, v7, v8, v9);
