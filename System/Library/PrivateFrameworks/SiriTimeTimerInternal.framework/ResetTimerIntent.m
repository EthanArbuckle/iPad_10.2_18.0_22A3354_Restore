...
- (ResetTimerIntent)init
{
  ...
  return -[ResetTimerIntent init](&v3, sel_init);
}
...
- (ResetTimerIntent)initWithCoder:(id)a3
{
  ...
  return -[ResetTimerIntent initWithCoder:](&v5, sel_initWithCoder_, a3);
}
...
- (ResetTimerIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v9 = -[ResetTimerIntent initWithIdentifier:backingStore:](&v11, sel_initWithIdentifier_backingStore_, v7, a4);
...
- (ResetTimerIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v10 = -[ResetTimerIntent initWithDomain:verb:parametersByName:](&v12, sel_initWithDomain_verb_parametersByName_, v7, v8, v9);
