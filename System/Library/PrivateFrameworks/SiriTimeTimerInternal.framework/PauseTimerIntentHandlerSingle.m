...
- (_TtC21SiriTimeTimerInternal29PauseTimerIntentHandlerSingle)init
{
  objc_class *v2;
  id v3;
  _TtC21SiriTimeTimerInternal29PauseTimerIntentHandlerSingle *v4;
  objc_super v6;
  _QWORD v7[5];
  ...
  sub_24739E418((uint64_t)v7, (uint64_t)v3 + OBJC_IVAR____TtC21SiriTimeTimerInternal29PauseTimerIntentHandlerSingle_siriTimerManager);
  v6.receiver = v3;
  v6.super_class = v2;
  swift_retain();
  v4 = -[PauseTimerIntentHandlerSingle init](&v6, sel_init);
...
- (void)confirmPauseTimer:(PauseTimerIntent *)a3 completion:(id)a4
{
  ...
  _QWORD *v14;
  _QWORD *v15;
  PauseTimerIntent *v16;
  _TtC21SiriTimeTimerInternal29PauseTimerIntentHandlerSingle *v17;
  uint64_t v18;
...
{
  sub_2473BBA20(self, (int)a2, a3, a4, (void (*)(id, id, void *))sub_2473BBAFC);
}
...
{
  sub_2473BBA20(self, (int)a2, a3, a4, (void (*)(id, id, void *))sub_2473BBE30);
}

- (void).cxx_destruct
{
  __swift_destroy_boxed_opaque_existential_1((uint64_t)self + OBJC_IVAR____TtC21SiriTimeTimerInternal29PauseTimerIntentHandlerSingle_siriTimerManager);
}
