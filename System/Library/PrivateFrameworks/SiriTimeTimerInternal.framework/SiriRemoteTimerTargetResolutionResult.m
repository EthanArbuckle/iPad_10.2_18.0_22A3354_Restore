...
+ (id)successWithResolvedSiriRemoteTimerTarget:(id)a3
{
  ...
  v4 = a3;
  v5 = static SiriRemoteTimerTargetResolutionResult.success(with:)((uint64_t)v4);
...
+ (id)disambiguationWithSiriRemoteTimerTargetsToDisambiguate:(id)a3
{
  ...
  v3 = sub_2473EE4B8();
  swift_getObjCClassMetadata();
  v4 = static SiriRemoteTimerTargetResolutionResult.disambiguation(with:)(v3);
...
+ (id)confirmationRequiredWithSiriRemoteTimerTargetToConfirm:(id)a3
{
  ...
  swift_getObjCClassMetadata();
  v4 = a3;
  v5 = static SiriRemoteTimerTargetResolutionResult.confirmationRequired(with:)((uint64_t)a3);
...
- (SiriRemoteTimerTargetResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  id v6;
  void *v7;
  SiriRemoteTimerTargetResolutionResult *v8;
  SiriRemoteTimerTargetResolutionResult *v9;
  objc_super v11;
  ...
  v8 = -[SiriRemoteTimerTargetResolutionResult initWithJSONDictionary:forIntent:](&v11, sel_initWithJSONDictionary_forIntent_, v7, v6);
