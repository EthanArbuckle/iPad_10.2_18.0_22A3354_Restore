...
{
  id v6;
  ResumeTimerIntentResponse *v7;
  int64_t *v8;
  ResumeTimerIntentResponse *v9;

  v6 = a4;
  v7 = -[ResumeTimerIntentResponse init](self, sel_init);
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___ResumeTimerIntentResponse_code);
  swift_beginAccess();
  *v8 = a3;
  v9 = v7;
  -[ResumeTimerIntentResponse setUserActivity:](v9, sel_setUserActivity_, v6);
...
- (ResumeTimerIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___ResumeTimerIntentResponse_code) = 0;
  ...
  return -[ResumeTimerIntentResponse init](&v3, sel_init);
}

- (ResumeTimerIntentResponse)initWithCoder:(id)a3
{
  return (ResumeTimerIntentResponse *)sub_2473EB8C0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (ResumeTimerIntentResponse)initWithBackingStore:(id)a3
{
  return (ResumeTimerIntentResponse *)sub_2473EB8C0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
