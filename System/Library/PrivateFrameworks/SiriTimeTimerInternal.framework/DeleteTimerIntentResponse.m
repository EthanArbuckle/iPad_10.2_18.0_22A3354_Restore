...
- (DeleteTimerIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___DeleteTimerIntentResponse_code) = 0;
  ...
  return -[DeleteTimerIntentResponse init](&v3, sel_init);
}
...
{
  return (DeleteTimerIntentResponse *)sub_2473E8434((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}

- (DeleteTimerIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  id v6;
  DeleteTimerIntentResponse *v7;
  int64_t *v8;
  DeleteTimerIntentResponse *v9;

  v6 = a4;
  v7 = -[DeleteTimerIntentResponse init](self, sel_init);
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___DeleteTimerIntentResponse_code);
  swift_beginAccess();
  *v8 = a3;
  v9 = v7;
  -[DeleteTimerIntentResponse setUserActivity:](v9, sel_setUserActivity_, v6);
...
{
  return (DeleteTimerIntentResponse *)sub_2473E8434((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}
