...
- (void)resolveTargetTimerForDeleteTimer:(id)a3 withCompletion:(id)a4
{
  void *v6;
  id v7;
  _TtC21SiriTimeTimerInternal30DeleteTimerIntentHandlerSingle *v8;

  v6 = _Block_copy(a4);
  _Block_copy(v6);
  v7 = a3;
  v8 = self;
  sub_2473B0328(v7, (uint64_t)v8, (uint64_t)v6);
  _Block_release(v6);
  _Block_release(v6);
...
- (void)resolveAssociatedDeviceTargetForDeleteTimer:(DeleteTimerIntent *)a3 withCompletion:(id)a4
{
  ...
  _QWORD *v14;
  _QWORD *v15;
  DeleteTimerIntent *v16;
  _TtC21SiriTimeTimerInternal30DeleteTimerIntentHandlerSingle *v17;
  uint64_t v18;
...
- (void)handleDeleteTimer:(id)a3 completion:(id)a4
{
  ...
  v7 = a3;
  v8 = self;
  sub_2473B065C((uint64_t)v8, (void (**)(_QWORD, _QWORD))v6);
  _Block_release(v6);
  _Block_release(v6);
...
{
  _TtC21SiriTimeTimerInternal30DeleteTimerIntentHandlerSingle *result;
...
- (void).cxx_destruct
{
  __swift_destroy_boxed_opaque_existential_1((uint64_t)self + OBJC_IVAR____TtC21SiriTimeTimerInternal30DeleteTimerIntentHandlerSingle_siriTimerManager);
}
