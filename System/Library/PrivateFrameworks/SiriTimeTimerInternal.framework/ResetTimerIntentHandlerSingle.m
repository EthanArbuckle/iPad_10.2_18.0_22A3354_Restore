...
- (_TtC21SiriTimeTimerInternal29ResetTimerIntentHandlerSingle)init
{
  objc_class *v2;
  id v3;
  _TtC21SiriTimeTimerInternal29ResetTimerIntentHandlerSingle *v4;
  objc_super v6;
  _QWORD v7[5];
  ...
  sub_24739E418((uint64_t)v7, (uint64_t)v3 + OBJC_IVAR____TtC21SiriTimeTimerInternal29ResetTimerIntentHandlerSingle_siriTimerManager);
  v6.receiver = v3;
  v6.super_class = v2;
  swift_retain();
  v4 = -[ResetTimerIntentHandlerSingle init](&v6, sel_init);
...
- (void)confirmResetTimer:(ResetTimerIntent *)a3 completion:(id)a4
{
  ...
  _QWORD *v14;
  _QWORD *v15;
  ResetTimerIntent *v16;
  _TtC21SiriTimeTimerInternal29ResetTimerIntentHandlerSingle *v17;
  uint64_t v18;
  ...
  v16 = a3;
  v17 = self;
  sub_2473E3DAC((uint64_t)v10, (uint64_t)&unk_25769EF00, (uint64_t)v15);
  swift_release();
}

- (void)resolveTargetTimerForResetTimer:(id)a3 withCompletion:(id)a4
{
  sub_2473BBA20(self, (int)a2, a3, a4, (void (*)(id, id, void *))sub_2473E3FA0);
}
...
- (void)resolveAssociatedDeviceTargetForResetTimer:(ResetTimerIntent *)a3 withCompletion:(id)a4
{
  ...
  v16 = a3;
  v17 = self;
  sub_2473E3DAC((uint64_t)v10, (uint64_t)&unk_25769EEE0, (uint64_t)v15);
  swift_release();
}
...
{
  sub_2473BBA20(self, (int)a2, a3, a4, (void (*)(id, id, void *))sub_2473E42D4);
}

- (void).cxx_destruct
{
  __swift_destroy_boxed_opaque_existential_1((uint64_t)self + OBJC_IVAR____TtC21SiriTimeTimerInternal29ResetTimerIntentHandlerSingle_siriTimerManager);
}
