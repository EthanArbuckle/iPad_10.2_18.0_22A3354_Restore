...
- (void)viewDidLoad
{
  _TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController *v2;
...
{
  _TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController *v4;
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v4 = (char *)v9.receiver;
  -[ActivityDoorAttributeCustomizationViewController viewWillDisappear:](&v9, sel_viewWillDisappear_, v3);
...
- (_TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  v8 = a4;
  return (_TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController *)sub_2275398CC(v5, v7, a4);
}

- (_TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController)initWithCoder:(id)a3
{
  return (_TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController *)sub_227539ADC(a3);
}
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease();
  sub_22731A160((uint64_t)self + OBJC_IVAR____TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController_activity, (uint64_t)v3, (uint64_t *)&unk_2558D7870);
  sub_22733F1C4(v3);
  sub_22731A1A4((uint64_t)self + OBJC_IVAR____TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController_delegate, &qword_2558DBE98);
}
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  char *v13;
  id v14;
  _TtC16MagnifierSupport48ActivityDoorAttributeCustomizationViewController *v15;
  void *v16;
  uint64_t v18;
