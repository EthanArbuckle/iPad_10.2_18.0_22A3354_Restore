...
- (ACTTransposeKeyTaps)initWithFirstTap:(id)a3 secondTap:(id)a4
{
  id v7;
  id v8;
  ACTTransposeKeyTaps *v9;
  ACTTransposeKeyTaps *v10;
  objc_super v12;
  ...
  v9 = -[ACTTransposeKeyTaps init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)description
{
  ...
  -[ACTTransposeKeyTaps firstTap](self, "firstTap");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[ACTTransposeKeyTaps secondTap](self, "secondTap");
...
- (id)shortDescription
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("Transpose first/second: %@ "), v3);
