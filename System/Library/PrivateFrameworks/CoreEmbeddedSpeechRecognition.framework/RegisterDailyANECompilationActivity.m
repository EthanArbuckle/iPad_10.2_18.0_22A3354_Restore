...
void ___RegisterDailyANECompilationActivity_block_invoke_2(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  v3 = a3;
  +[CoreEmbeddedSpeechRecognizer compileAllAssetsWithType:completion:](CoreEmbeddedSpeechRecognizer, "compileAllAssetsWithType:completion:", 3, &__block_literal_global_203);
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0CFE6C0], OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_debug_impl(&dword_1B3E5F000, v4, OS_LOG_TYPE_DEBUG, "%s On-Device ASR: XPC: Done triggering daily ANE compilation", (uint8_t *)&v5, 0xCu);
    if (!v3)
      goto LABEL_4;
    goto LABEL_3;
  }
