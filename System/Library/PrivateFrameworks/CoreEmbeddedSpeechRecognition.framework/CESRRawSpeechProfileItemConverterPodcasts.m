...
{
  CESRRawSpeechProfileItemConverterPodcasts *v2;
  KVItemBuilder *v3;
  ...
  v2 = -[CESRRawSpeechProfileItemConverterPodcasts init](&v6, sel_init);
  if (v2)
  {
...
- (id)speechCategoryId
{
  return CFSTR("com.apple.media.podcasts");
}
...
- (id)vocabularyItemFromSpeechWords:(id)a3 speechNamespace:(id)a4 error:(id *)a5
{
  ...
  if (v8 && objc_msgSend(v8, "count"))
  {
    ...
    {
      if ((objc_msgSend(v9, "isEqualToString:", CFSTR("podcastTitle")) & 1) != 0)
      {
        ...
        v38 = 0;
        v12 = (id)-[KVItemBuilder setItemType:itemId:error:](builder, "setItemType:itemId:error:", 16, v10, &v38);
        v13 = v38;
        ...
        v16 = self->_builder;
        v37 = v13;
        -[KVItemBuilder addFieldWithType:value:error:](v16, "addFieldWithType:value:error:", 700, v15, &v37);
...
LABEL_7:
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unexpected namespace: %@ for category: %@"), v9, CFSTR("com.apple.media.podcasts"));
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v42 = v10;
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("rawSpeechProfile contains a Podcasts item with an unexpected number of speech words (expected only 1): %@ namespace: %@"), v8, v9);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v44 = v10;
  ...
  else
  {
    ...
    v46[0] = CFSTR("rawSpeechProfile contains a Podcasts item missing speech words.");
