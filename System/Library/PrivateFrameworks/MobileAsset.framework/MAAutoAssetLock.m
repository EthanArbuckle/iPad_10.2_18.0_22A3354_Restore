...
- (id)initForSelector:(id)a3 withLocalContentURL:(id)a4 withAssetAttributes:(id)a5
{
  ...
  v12 = -[MAAutoAssetLock init](&v17, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (MAAutoAssetLock)initWithCoder:(id)a3
{
  ...
  v5 = -[MAAutoAssetLock init](&v16, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[MAAutoAssetLock fullAssetSelector](self, "fullAssetSelector");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("fullAssetSelector"));

  -[MAAutoAssetLock localContentURL](self, "localContentURL");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, CFSTR("localContentURL"));

  objc_msgSend(v4, "encodeBool:forKey:", -[MAAutoAssetLock inhibitedFromEmergencyRemoval](self, "inhibitedFromEmergencyRemoval"), CFSTR("inhibitedFromEmergencyRemoval"));
  -[MAAutoAssetLock lockReasons](self, "lockReasons");
...
- (id)summary
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[MAAutoAssetLock assetAttributes](self, "assetAttributes");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "safeSummary");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (-[MAAutoAssetLock inhibitedFromEmergencyRemoval](self, "inhibitedFromEmergencyRemoval"))
    v10 = CFSTR("Y");
  else
    v10 = CFSTR("N");
  -[MAAutoAssetLock lockReasons](self, "lockReasons");
