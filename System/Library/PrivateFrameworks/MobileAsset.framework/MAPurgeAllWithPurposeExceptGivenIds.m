@implementation MAPurgeAllWithPurposeExceptGivenIds
...
void __MAPurgeAllWithPurposeExceptGivenIds_block_invoke(uint64_t a1, void *a2)
{
  ...
  if (MEMORY[0x1AF44F218]() == MEMORY[0x1E0C81310])
  {
    ...
    _MobileAssetLog(0, 6, (uint64_t)"MAPurgeAllWithPurposeExceptGivenIds_block_invoke", CFSTR("Asset purge all with exceptions failed due to XPC"), v17, v18, v19, v20, v22);
  }
  else
  {
