...
- (_SRSTSharedClientDelegate)delegate
{
  ...
  swift_beginAccess();
  return (_SRSTSharedClientDelegate *)(id)MEMORY[0x2199DD49C](v2);
}
...
- (void).cxx_destruct
{
  ...
  v4 = __swift_instantiateConcreteTypeFromMangledName(&demangling cache variable for type metadata for Published<SharedState?>);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  v5 = (char *)self + OBJC_IVAR____SRSTSharedClient__mostRecentEvent;
  v6 = __swift_instantiateConcreteTypeFromMangledName(&demangling cache variable for type metadata for Published<SharedEvent?>);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v6 - 8) + 8))(v5, v6);
}

- (_SRSTSharedClient)init
{
  _SRSTSharedClient *result;
