...
- (SRSTCallClient)init
{
  ...
  v2 = -[SRSTCallClient init](&v6, sel_init);
  v3 = objc_opt_new();
  underlyingObject = v2->_underlyingObject;
  v2->_underlyingObject = (_SRSTCallClient *)v3;

  -[_SRSTCallClient setDelegate:](v2->_underlyingObject, "setDelegate:", v2);
  return v2;
}
...
- (SRSTCallState)currentState
{
  ...
  -[_SRSTCallClient currentState](self->_underlyingObject, "currentState");
...
{
  return -[_SRSTCallClient mostRecentEventName](self->_underlyingObject, "mostRecentEventName");
}

- (void)dispatchEvent:(int64_t)a3
{
  -[_SRSTCallClient dispatchEvent:](self->_underlyingObject, "dispatchEvent:", a3);
}
...
- (void)stateMachineWithClient:(id)a3 didReceiveEvent:(int64_t)a4
{
  ...
  -[SRSTCallClient delegate](self, "delegate", a3);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_opt_respondsToSelector();

  if ((v7 & 1) != 0)
  {
    -[SRSTCallClient delegate](self, "delegate");
...
- (void)stateMachineWithClient:(id)a3 didTransitionToState:(id)a4
{
  ...
  v6 = -[SRSTCallState initWithUnderlyingObject:]([SRSTCallState alloc], "initWithUnderlyingObject:", v5);
...
- (void)stopClient
{
  -[_SRSTCallClient stopClient](self->_underlyingObject, "stopClient");
}

- (SRSTCallClientDelegate)delegate
{
  return (SRSTCallClientDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
