...
{
  AFMyriadGoodnessScoreContext *v2;
  uint64_t v3;
  NSSet *reasons;
  objc_super v6;
  ...
  v2 = -[AFMyriadGoodnessScoreContext init](&v6, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", &unk_1E3AA6DC0);
    v3 = objc_claimAutoreleasedReturnValue();
    reasons = v2->_reasons;
    v2->_reasons = (NSSet *)v3;

    v2->_mediaPlaybackInterruptedTime = 0.0;
    -[AFMyriadGoodnessScoreContext setOverridingContext:](v2, "setOverridingContext:", 0);
...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("reasons: %@, playback interrupted time: %f"), self->_reasons, *(_QWORD *)&self->_mediaPlaybackInterruptedTime);
}
