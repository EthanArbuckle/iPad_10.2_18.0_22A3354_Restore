...
void __83__SASSpeechPartialResult_AFSpeechTokenAdditions__createUsingPhrases_andUtterances___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v18 = 0u;
  v19 = 0u;
  objc_msgSend(*(id *)(a1 + 32), "objectAtIndexedSubscript:", a3, 0);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "interpretations");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "objectAtIndexedSubscript:", objc_msgSend(v5, "integerValue"));
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v14 = *(void **)(a1 + 40);
        objc_msgSend(*(id *)(*((_QWORD *)&v16 + 1) + 8 * v13), "aceToken");
