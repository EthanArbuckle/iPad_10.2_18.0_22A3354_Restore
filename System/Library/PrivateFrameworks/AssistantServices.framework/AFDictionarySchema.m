...
- (AFDictionarySchema)init
{
  ...
  v2 = -[AFDictionarySchema init](&v6, sel_init);
  if (v2)
  {
...
- (id)coerceObject:(id)a3 error:(id *)a4
{
  ...
  v20 = &v19;
  v21 = 0x3032000000;
  v22 = __Block_byref_object_copy__7225;
  v23 = __Block_byref_object_dispose__7226;
  v24 = 0;
...
void __41__AFDictionarySchema_coerceObject_error___block_invoke(uint64_t a1, void *a2, void *a3, BOOL *a4)
{
  ...
  if (!v9)
  {
    +[AFCoercion identityCoercion](AFCoercion, "identityCoercion");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
  v13 = 0;
