...
{
  id v5;
  _AFMyriadGoodnessScoreOverrideStateMutation *v6;
  ...
  v6 = -[_AFMyriadGoodnessScoreOverrideStateMutation init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (int64_t)getOverrideOption
{
  if ((*(_BYTE *)&self->_mutationFlags & 2) != 0)
    ...
    return -[AFMyriadGoodnessScoreOverrideState overrideOption](self->_base, "overrideOption");
}
...
- (id)getReason
{
  ...
  {
    -[AFMyriadGoodnessScoreOverrideState reason](self->_base, "reason");
