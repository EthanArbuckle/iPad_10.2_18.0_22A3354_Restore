...
{
  return -[AFTwoArgumentSafetyBlock initWithBlock:defaultValue1:defaultValue2:](self, "initWithBlock:defaultValue1:defaultValue2:", a3, 0, 0);
}
...
- (AFTwoArgumentSafetyBlock)initWithBlock:(id)a3 defaultValue1:(id)a4 defaultValue2:(id)a5
{
  ...
  v11 = -[AFTwoArgumentSafetyBlock init](&v15, sel_init);
  if (v11)
  {
    v12 = MEMORY[0x1A1AC0C3C](v8);
    block = v11->_block;
    v11->_block = (id)v12;
...
- (void)dealloc
{
  ...
  -[AFTwoArgumentSafetyBlock invokeWithValue:andValue:](self, "invokeWithValue:andValue:", self->_defaultValue1, self->_defaultValue2);
  v3.receiver = self;
  v3.super_class = (Class)AFTwoArgumentSafetyBlock;
  -[AFTwoArgumentSafetyBlock dealloc](&v3, sel_dealloc);
}
