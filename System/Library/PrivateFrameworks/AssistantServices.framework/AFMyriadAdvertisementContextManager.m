...
{
  id v5;
  AFMyriadAdvertisementContextManager *v6;
  AFMyriadAdvertisementContextManager *v7;
  AFMyriadAdvertisementContextManager *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[AFMyriadAdvertisementContextManager init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
- (void)pushMyriadAdvertisementContext:(id)a3 completionHandler:(id)a4
{
  ...
  _QWORD block[4];
  id v12;
  AFMyriadAdvertisementContextManager *v13;
  id v14;
...
void __73__AFMyriadAdvertisementContextManager_triggerABCForType_subType_context___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v2, "triggerABCForType:subType:context:completionHandler:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 56), &__block_literal_global_41158);
...
void __73__AFMyriadAdvertisementContextManager_triggerABCForType_subType_context___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled((os_log_t)AFSiriLogContextConnection, OS_LOG_TYPE_ERROR))
    {
      ...
      v6 = 2112;
      v7 = v2;
      _os_log_error_impl(&dword_19AF50000, v3, OS_LOG_TYPE_ERROR, "%s #myriad triggerABCForSubType failed: %@", (uint8_t *)&v4, 0x16u);
    }
  }
...
void __88__AFMyriadAdvertisementContextManager_pushMyriadAdvertisementContext_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)AFSiriLogContextConnection, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315394;
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_19AF50000, v2, OS_LOG_TYPE_INFO, "%s #myriad Pushing Myriad advertisement context %@", buf, 0x16u);
  }
  ...
  v6[3] = &unk_1E3A36950;
  v7 = *(id *)(a1 + 48);
  objc_msgSend(v4, "pushMyriadAdvertisementContext:completionHandler:", v5, v6);
...
void __88__AFMyriadAdvertisementContextManager_pushMyriadAdvertisementContext_completionHandler___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  AFMyriadAdvertisementContextRecord *v7;
  void *v8;
  NSObject *v9;
  void *v10;
  void *v11;
  ...
  const char *v13;
  __int16 v14;
  AFMyriadAdvertisementContextRecord *v15;
  __int16 v16;
  void *v17;
  uint64_t v18;
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "myriadAdvertisementContext");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    v6 = -[AFMyriadAdvertisementContextRecord initWithMyriadAdvertisementContextRecordData:]([AFMyriadAdvertisementContextRecord alloc], "initWithMyriadAdvertisementContextRecordData:", v5);
    v7 = v6;
    if (v6)
    {
      -[AFMyriadAdvertisementContextRecord deviceID](v6, "deviceID");
      ...
      else
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
        {
          ...
          v16 = 2112;
          v17 = v11;
          _os_log_error_impl(&dword_19AF50000, v9, OS_LOG_TYPE_ERROR, "%s #myriad Dropped %@ from %@ because there's no device ID.", (uint8_t *)&v12, 0x20u);
          if (!v10)
