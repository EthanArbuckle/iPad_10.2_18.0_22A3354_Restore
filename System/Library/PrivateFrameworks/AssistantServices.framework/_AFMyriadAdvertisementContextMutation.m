...
{
  id v5;
  _AFMyriadAdvertisementContextMutation *v6;
  ...
  v6 = -[_AFMyriadAdvertisementContextMutation init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (unint64_t)getGeneration
{
  if ((*(_BYTE *)&self->_mutationFlags & 2) != 0)
    ...
    return -[AFMyriadAdvertisementContext generation](self->_base, "generation");
}
...
- (id)getContextData
{
  ...
  {
    -[AFMyriadAdvertisementContext contextData](self->_base, "contextData");
...
- (double)getContextFetchDelay
{
  ...
  -[AFMyriadAdvertisementContext contextFetchDelay](self->_base, "contextFetchDelay");
  return result;
}
