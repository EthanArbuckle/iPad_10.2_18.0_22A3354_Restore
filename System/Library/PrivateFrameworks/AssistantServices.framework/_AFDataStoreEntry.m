...
- (_AFDataStoreEntry)initWithType:(int64_t)a3 value:(id)a4
{
  ...
  v8 = -[_AFDataStoreEntry init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_type = a3;
...
{
  if (-[_AFDataStoreEntry type](self, "type"))
    return CFSTR("Image");
  else
...
- (id)_valueForPropertyListRepresentation:(id)a3 type:(int64_t)a4
{
  ...
  if (a4 == 1 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    ...
    -[AFImagePNGData setImageData:](v7, "setImageData:", v8);
...
- (id)propertyListRepresentation
{
  ...
  -[_AFDataStoreEntry _propertyListStringForType](self, "_propertyListStringForType");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("Type"));

  -[_AFDataStoreEntry _valuePropertyListRepresentation](self, "_valuePropertyListRepresentation");
...
- (_AFDataStoreEntry)initWithPropertyListRepresentation:(id)a3 error:(id *)p_isa
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[AFDictionarySchema setObjectCoercion:forKey:](v7, "setObjectCoercion:forKey:", v8, CFSTR("Version"));

  +[AFCoercion typeAssertionWithClass:](AFCoercion, "typeAssertionWithClass:", objc_opt_class());
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[AFDictionarySchema setObjectCoercion:forKey:](v7, "setObjectCoercion:forKey:", v9, CFSTR("Type"));

  -[AFDictionarySchema coerceObject:error:](v7, "coerceObject:error:", v6, p_isa);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12 == 1)
  {
    ...
    v14 = -[_AFDataStoreEntry _typeForPropertyListString:](self, "_typeForPropertyListString:", v13);

    objc_msgSend(v10, "objectForKey:", CFSTR("Value"));
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    -[_AFDataStoreEntry _valueForPropertyListRepresentation:type:](self, "_valueForPropertyListRepresentation:type:", v15, v14);
    v16 = (void *)objc_claimAutoreleasedReturnValue();

    if (v16)
    {
      self = -[_AFDataStoreEntry initWithType:value:](self, "initWithType:value:", v14, v16);
      p_isa = (id *)&self->super.isa;
    }
    else if (p_isa)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unable to decode value for data store entry %@"), v6);
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      +[AFConversationError errorWithCode:localizedFailureReason:](AFConversationError, "errorWithCode:localizedFailureReason:", 300, v18);
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)AFSiriLogContextConnection, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      v22 = 2050;
      v23 = v12;
      _os_log_error_impl(&dword_19AF50000, v17, OS_LOG_TYPE_ERROR, "%s unable to deserialize property list with version %{public}ld; returning nil",
        buf,
        0x16u);
    }
    p_isa = 0;
