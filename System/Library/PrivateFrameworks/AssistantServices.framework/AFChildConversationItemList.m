...
- (AFChildConversationItemList)initWithConversation:(id)a3 parentItemIdentifier:(id)a4
{
  id v7;
  id v8;
  AFChildConversationItemList *v9;
  AFChildConversationItemList *v10;
  uint64_t v11;
  ...
  v9 = -[AFChildConversationItemList init](&v14, sel_init);
  v10 = v9;
  if (v9)
  {
...
{
  return -[AFChildConversationItemList initWithConversation:parentItemIdentifier:](self, "initWithConversation:parentItemIdentifier:", 0, 0);
}
...
- (int64_t)numberOfItems
{
  ...
  -[AFChildConversationItemList _conversation](self, "_conversation");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[AFChildConversationItemList _parentItemIdentifier](self, "_parentItemIdentifier");
...
- (id)itemAtIndex:(int64_t)a3
{
  ...
  -[AFChildConversationItemList _indexPathForItemAtIndex:](self, "_indexPathForItemAtIndex:", a3);
...
{
  -[AFChildConversationItemList _addItemsForAceObjects:type:dialogPhase:asChildrenOfItemWithIdentifier:](self, "_addItemsForAceObjects:type:dialogPhase:asChildrenOfItemWithIdentifier:", a3, a4, a5, 0);
}
...
- (void)addItemsForAceObjects:(id)a3 type:(int64_t)a4 dialogPhase:(id)a5 asChildrenOfItemAtIndex:(int64_t)a6
{
  ...
  v10 = a5;
  v11 = a3;
  -[AFChildConversationItemList _identifierOfItemAtIndex:](self, "_identifierOfItemAtIndex:", a6);
  v12 = (id)objc_claimAutoreleasedReturnValue();
  -[AFChildConversationItemList _addItemsForAceObjects:type:dialogPhase:asChildrenOfItemWithIdentifier:](self, "_addItemsForAceObjects:type:dialogPhase:asChildrenOfItemWithIdentifier:", v11, a4, v10, v12);
...
- (id)identifiersForItemsAtIndexes:(id)a3
{
  ...
  _QWORD v10[4];
  id v11;
  AFChildConversationItemList *v12;
...
- (void)removeItemsAtIndexes:(id)a3
{
  ...
  _QWORD v9[4];
  id v10;
  AFChildConversationItemList *v11;
  ...
  v9[1] = 3221225472;
  v9[2] = __52__AFChildConversationItemList_removeItemsAtIndexes___block_invoke;
  v9[3] = &unk_1E3A368D8;
  v10 = v6;
  v11 = self;
  v8 = v6;
...
- (void)removeItemsWithIdentifiers:(id)a3
{
  ...
  v9[0] = MEMORY[0x1E0C809B0];
  v9[1] = 3221225472;
  v9[2] = __58__AFChildConversationItemList_removeItemsWithIdentifiers___block_invoke;
  v9[3] = &unk_1E3A36900;
  v9[4] = self;
  v10 = v6;
  v8 = v6;
...
- (BOOL)itemIsRestoredAtIndex:(int64_t)a3
{
  ...
  -[AFChildConversationItemList _indexPathForLastRestoredItem](self, "_indexPathForLastRestoredItem");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    -[AFChildConversationItemList _indexPathForItemAtIndex:](self, "_indexPathForItemAtIndex:", a3);
...
- (id)_identifierOfItemAtIndex:(int64_t)a3
{
  ...
  -[AFChildConversationItemList itemAtIndex:](self, "itemAtIndex:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
