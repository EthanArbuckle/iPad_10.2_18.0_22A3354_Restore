...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", self->_objectIdentifier, CFSTR("ObjectCreatedResponseObjectIdentifier"), v5.receiver, v5.super_class);
...
{
  id v4;
  AFObjectCreatedSiriResponse *v5;
  void *v6;
  uint64_t v7;
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("ObjectCreatedResponseObjectIdentifier"));
