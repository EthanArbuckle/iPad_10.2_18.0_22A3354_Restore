...
- (id)description
{
  ...
  -[MXItnAlignment description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[MXItnAlignment dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_firstPreItnTokenIndex);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("first_pre_itn_token_index"));
...
LABEL_3:
      if ((has & 1) == 0)
        goto LABEL_4;
LABEL_9:
      objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_firstPostItnCharPos);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v3, "setObject:forKey:", v9, CFSTR("first_post_itn_char_pos"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_lastPreItnTokenIndex);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("last_pre_itn_token_index"));
...
LABEL_4:
  ...
  {
LABEL_5:
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_lastPostItnCharPos);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("last_post_itn_char_pos"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_firstPreItnTokenIndex != *((_DWORD *)v4 + 3))
      goto LABEL_21;
  }
...
LABEL_21:
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 8) == 0 || self->_lastPreItnTokenIndex != *((_DWORD *)v4 + 5))
      goto LABEL_21;
  }
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_firstPostItnCharPos != *((_DWORD *)v4 + 2))
      goto LABEL_21;
  }
  ...
  if ((*(_BYTE *)&self->_has & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 4) == 0 || self->_lastPostItnCharPos != *((_DWORD *)v4 + 4))
      goto LABEL_21;
    v5 = 1;
  }
LABEL_22:
