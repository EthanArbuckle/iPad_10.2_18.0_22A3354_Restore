  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        objc_msgSend(v10, "localizedStringForKey:value:table:", CFSTR("ACCESSORY"), &stru_1EA29D890, CFSTR("Devices"));
        v4 = (id)objc_claimAutoreleasedReturnValue();
...
- (void)unpair
{
  ...
  if (_os_feature_enabled_impl())
  {
    ...
    if (v3)
    {
      ...
      -[CBPeripheral untag:](self->_peripheral, "untag:", *MEMORY[0x1E0CB5CB0]);
