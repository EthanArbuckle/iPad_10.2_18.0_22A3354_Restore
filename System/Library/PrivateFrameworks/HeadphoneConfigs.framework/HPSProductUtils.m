...
LABEL_15:
      objc_msgSend(v6, "localizedStringForKey:value:table:", v5, &stru_1EA29D890, v8);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v10;
    _os_log_impl(&dword_1DB30C000, v11, OS_LOG_TYPE_DEFAULT, "HPSProductUtils: getProductSpecificString called with pid %d and descKey %@ value %@", (uint8_t *)v13, 0x1Cu);
  }
...
+ (BOOL)isAirPods:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1DB30C000, v7, OS_LOG_TYPE_DEFAULT, "HPSProductUtils: isAirPods:%i productID:%i", (uint8_t *)v16, 0xEu);
    }
  }
  else
  {
...
+ (void)getProductSpecificString:(os_log_t)log descriptionKey:.cold.1(uint64_t a1, int a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_error_impl(&dword_1DB30C000, log, OS_LOG_TYPE_ERROR, "HPSProductUtils: getProductSpecificString called with invalid pid %d and (or) descKey %@", (uint8_t *)v3, 0x12u);
}
...
{
  OUTLINED_FUNCTION_0(&dword_1DB30C000, a1, a3, "HPSProductUtils: Cannot check if is Apple Headphone, Null Device pointer", a5, a6, a7, a8, 0);
...
{
  OUTLINED_FUNCTION_0(&dword_1DB30C000, a1, a3, "HPSProductUtils: Cannot check if is AirPods, Null Device pointer", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_1_0();
}
...
{
  OUTLINED_FUNCTION_0(&dword_1DB30C000, a1, a3, "HPSProductUtils: Cannot check if is Beats Non Wx, Null Device pointer", a5, a6, a7, a8, 0);
  OUTLINED_FUNCTION_1_0();
}
