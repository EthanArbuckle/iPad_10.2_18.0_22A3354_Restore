...
+ (id)sharedReportCrashService
{
  ...
  return (id)sharedReportCrashService_sharedReportCrashService;
}

void __48__MXReportCrashService_sharedReportCrashService__block_invoke(uint64_t a1)
{
  id v1;
  void *v2;
  ...
  sharedReportCrashService_sharedReportCrashService = (uint64_t)v1;

}

- (MXReportCrashService)init
{
  MXReportCrashService *v2;
  os_log_t v3;
  ...
  v2 = -[MXService initWithSourceID:](&v11, sel_initWithSourceID_, 5);
  if (v2)
  {
    v3 = os_log_create("com.apple.metrickit.service.reportcrash", (const char *)&unk_229EF5085);
    ...
    if (!v2->_MXReportCrashServiceLogHandle)
      objc_storeStrong((id *)&v2->_MXReportCrashServiceLogHandle, MEMORY[0x24BDACB70]);
...
- (BOOL)startService
{
  NSObject *MXReportCrashServiceLogHandle;
  NSObject *v5;
  objc_super v6;
  uint8_t buf[16];
  objc_super v8;
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_229EEF000, MXReportCrashServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Starting report crash service.", buf, 2u);
  }
  if (-[MXReportCrashService _updateService](self, "_updateService"))
    return 1;
  v5 = self->_MXReportCrashServiceLogHandle;
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    -[MXReportCrashService startService].cold.1(v5);
  v6.receiver = self;
...
- (BOOL)stopService
{
  ...
  if (-[MXService stopService](&v7, sel_stopService))
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_impl(&dword_229EEF000, MXReportCrashServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Stopping report crash service.", v6, 2u);
    }
  }
  return !-[MXService isStarted](self, "isStarted");
}
...
- (BOOL)_updateService
{
  ...
  -[NSMutableArray removeAllObjects](self->_reportCrashDataPaths, "removeAllObjects");
  objc_msgSend(MEMORY[0x24BDD1580], "defaultManager");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  +[MXUtilities containerPath](MXUtilities, "containerPath");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(&unk_24F33C3F0, "objectAtIndexedSubscript:", 5);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(MXReportCrashServiceLogHandle, OS_LOG_TYPE_ERROR))
      -[MXSpinTracerService _updateService].cold.1((uint64_t)v10, MXReportCrashServiceLogHandle);
  }
  else
  {
...
- (void)unarchiveReportCrashDataForDateString:(id)a3
{
  ...
  void *v14;
  void *v15;
  MXReportCrashService *v16;
  void *v17;
  void *v18;
  MXReportCrashService *v19;
  void *v20;
  uint64_t v21;
  void *v22;
  id v23;
  ...
  v46 = 0u;
  v37 = (void *)v4;
  -[NSMutableArray filteredArrayUsingPredicate:](self->_reportCrashDataPaths, "filteredArrayUsingPredicate:", v4);
      ...
      for (i = 0; i != v42; i = v26 + 1)
      {
        ...
        if (os_log_type_enabled(MXReportCrashServiceLogHandle, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v51 = 2112;
          v52 = (uint64_t)v40;
          _os_log_impl(&dword_229EEF000, MXReportCrashServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Found log file: %@ for date: %@", buf, 0x16u);
        }
        objc_msgSend(MEMORY[0x24BDD1580], "defaultManager");
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        +[MXUtilities containerPath](MXUtilities, "containerPath");
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(&unk_24F33C408, "objectAtIndexedSubscript:", 5);
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        if (v18)
        {
          ...
          if (v23)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
            {
              *(_DWORD *)buf = 138412290;
              v50 = (uint64_t)v23;
              _os_log_error_impl(&dword_229EEF000, v24, OS_LOG_TYPE_ERROR, "Failed to unarchive report crash data: %@", buf, 0xCu);
            }
          }
          else
          {
              ...
              && (v31 = objc_msgSend(v22, "sourceID"), v31 == -[MXService sourceID](v19, "sourceID")))
            {
              ...
              -[NSMutableArray addObject:](v19->_unarchivedReportCrashData, "addObject:", v22);
            }
            else
            {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412290;
            v50 = (uint64_t)v8;
            _os_log_debug_impl(&dword_229EEF000, v25, OS_LOG_TYPE_DEBUG, "Failed to read report crash data contents: %@", buf, 0xCu);
          }
        }
...
- (id)getDiagnosticsForClient:(id)a3 dateString:(id)a4
{
  ...
  if (!self->_unarchivedReportCrashData)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_229EEF000, MXReportCrashServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Unarchived report crash data not yet set, running unarchive.", buf, 2u);
    }
    -[MXReportCrashService unarchiveReportCrashDataForDateString:](self, "unarchiveReportCrashDataForDateString:", v7);
  }
  v30 = v7;
  ...
  if (objc_msgSend(v9, "count"))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v41 = v6;
      _os_log_impl(&dword_229EEF000, v20, OS_LOG_TYPE_DEFAULT, "Found report crash diagnostics for client: %@", buf, 0xCu);
    }
...
- (void)startService
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_229EEF000, log, OS_LOG_TYPE_ERROR, "Failed to start report crash service.", v1, 2u);
}
