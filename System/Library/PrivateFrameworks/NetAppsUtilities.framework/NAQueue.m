...
- (void)enqueue:(id)a3
{
  -[NAQueueingStrategy enqueueObject:buffer:](self->_strategy, "enqueueObject:buffer:", a3, self->_buffer);
}
...
+ (id)priorityQueueWithComparator:(id)a3
{
  ...
  v4 = a3;
  v5 = -[_NAPriorityQueueingStrategy initWithComparator:]([_NAPriorityQueueingStrategy alloc], "initWithComparator:", v4);
...
- (NAQueue)init
{
  _NADefaultQueueingStrategy *v3;
  NAQueue *v4;

  v3 = objc_alloc_init(_NADefaultQueueingStrategy);
  v4 = -[NAQueue initWithStrategy:](self, "initWithStrategy:", v3);
...
+ (id)boundedQueueWithCapacity:(unint64_t)a3
{
  ...
  v4 = -[_NABoundedQueueingStrategy initWithCapacity:]([_NABoundedQueueingStrategy alloc], "initWithCapacity:", a3);
...
+ (id)boundedQueueWithCapacity:(unint64_t)a3 overflowHandler:(id)a4
{
  ...
  v6 = a4;
  v7 = -[_NABoundedQueueingStrategy initWithCapacity:overflowHandler:]([_NABoundedQueueingStrategy alloc], "initWithCapacity:overflowHandler:", a3, v6);
