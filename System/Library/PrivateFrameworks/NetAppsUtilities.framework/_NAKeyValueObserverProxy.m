...
- (_NAKeyValueObserverProxy)initWithWeakObserver:(id)a3 observedObject:(id)a4 keyPath:(id)a5 options:(unint64_t)a6 observerBlock:(id)a7
{
  ...
  v15 = -[_NAObserverProxy initWithWeakObserver:](&v20, sel_initWithWeakObserver_, a3);
  v16 = v15;
  if (v15)
  {
    objc_storeWeak(&v15->_observedObject, v12);
    objc_storeStrong((id *)&v16->_keyPath, a5);
    v17 = MEMORY[0x1B5E0F7A8](v14);
...
- (void)invalidate
{
  ...
  -[_NAObserverProxy invalidate](&v4, sel_invalidate);
}
