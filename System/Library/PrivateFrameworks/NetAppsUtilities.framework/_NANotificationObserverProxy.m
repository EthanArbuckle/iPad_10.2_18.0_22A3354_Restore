...
- (_NANotificationObserverProxy)initWithWeakObserver:(id)a3 notificationName:(id)a4 observerQueue:(id)a5 observerBlock:(id)a6
{
  ...
  _NANotificationObserverProxy *v15;
  uint64_t v16;
  id observerBlock;
  _NANotificationObserverProxy *v18;
  void *v19;
  uint64_t v20;
  id notificationObserver;
  _QWORD v23[5];
  _QWORD v24[5];
  _NANotificationObserverProxy *v25;
  objc_super v26;
  ...
  v14 = -[_NAObserverProxy initWithWeakObserver:](&v26, sel_initWithWeakObserver_, v10);
  v15 = v14;
  if (v14)
  {
    objc_storeStrong((id *)&v14->_notificationName, a4);
    objc_storeStrong((id *)&v15->_observerQueue, a5);
    v16 = MEMORY[0x1B5E0F7A8](v13);
...
- (void)performObserverBlock
{
  ...
  if (-[_NAObserverProxy isValid](self, "isValid"))
  {
    -[_NAObserverProxy weakObserver](self, "weakObserver");
...
- (void)invalidate
{
  ...
  -[_NAObserverProxy invalidate](&v5, sel_invalidate);
}
