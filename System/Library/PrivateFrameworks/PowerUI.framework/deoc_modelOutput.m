...
- (deoc_modelOutput)initWithNext_drain_is_significant:(int64_t)a3 classProbability:(id)a4
{
  ...
  v8 = -[deoc_modelOutput init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24D44ACC8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDBFF98], "featureValueWithInt64:", -[deoc_modelOutput next_drain_is_significant](self, "next_drain_is_significant"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)MEMORY[0x24BDBFF98];
    -[deoc_modelOutput classProbability](self, "classProbability");
