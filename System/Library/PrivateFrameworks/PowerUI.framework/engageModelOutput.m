...
- (engageModelOutput)initWithEngage:(int64_t)a3 classProbability:(id)a4
{
  ...
  v8 = -[engageModelOutput init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_engage = a3;
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24D44ACF8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDBFF98], "featureValueWithInt64:", -[engageModelOutput engage](self, "engage"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)MEMORY[0x24BDBFF98];
    -[engageModelOutput classProbability](self, "classProbability");
