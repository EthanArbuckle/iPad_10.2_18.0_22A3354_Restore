...
{
  id v7;
  deoc_two_stage_sequential_low_secondOutput *v8;
  deoc_two_stage_sequential_low_secondOutput *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)deoc_two_stage_sequential_low_secondOutput;
  v8 = -[deoc_two_stage_sequential_low_secondOutput init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_target = a3;
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24D44ADB8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDBFF98], "featureValueWithInt64:", -[deoc_two_stage_sequential_low_secondOutput target](self, "target"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)MEMORY[0x24BDBFF98];
    -[deoc_two_stage_sequential_low_secondOutput classProbability](self, "classProbability");
