...
- (deoc_ultraOutput)initWithTarget:(int64_t)a3 classProbability:(id)a4
{
  ...
  v8 = -[deoc_ultraOutput init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_target = a3;
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24D44AE18);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDBFF98], "featureValueWithInt64:", -[deoc_ultraOutput target](self, "target"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)MEMORY[0x24BDBFF98];
    -[deoc_ultraOutput classProbability](self, "classProbability");
