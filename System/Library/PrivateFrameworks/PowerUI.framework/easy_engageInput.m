...
{
  easy_engageInput *result;
  objc_super v29;

  v29.receiver = self;
  v29.super_class = (Class)easy_engageInput;
  result = -[easy_engageInput init](&v29, sel_init);
  if (result)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24D44AD10);
}
...
- (id)featureValueForName:(id)a3
{
    ...
    || objc_msgSend(v4, "isEqualToString:", CFSTR("classic_time_between_uses_med_dur_24")))
  {
    ...
    -[easy_engageInput classic_time_between_uses_med_dur](self, "classic_time_between_uses_med_dur");
  }
  ...
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[easy_engageInput classic_time_between_uses_std_dur](self, "classic_time_between_uses_std_dur");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("hour")))
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[easy_engageInput hour](self, "hour");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("is_weekend")))
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[easy_engageInput is_weekend](self, "is_weekend");
  }
  ...
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[easy_engageInput hour_plus](self, "hour_plus");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("hours_until_use")))
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[easy_engageInput hours_until_use](self, "hours_until_use");
  }
  else
  {
    ...
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[easy_engageInput meaningful_undercharge_rolling_average](self, "meaningful_undercharge_rolling_average");
  }
