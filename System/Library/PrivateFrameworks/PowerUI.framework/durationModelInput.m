...
{
  durationModelInput *result;
  objc_super v37;

  v37.receiver = self;
  v37.super_class = (Class)durationModelInput;
  result = -[durationModelInput init](&v37, sel_init);
  if (result)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24D44AC80);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(v4, "isEqualToString:", CFSTR("plugin_battery_level")))
  {
    ...
    -[durationModelInput plugin_battery_level](self, "plugin_battery_level");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("time_from_plugin")))
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[durationModelInput time_from_plugin](self, "time_from_plugin");
  }
  ...
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[durationModelInput med_dur](self, "med_dur");
  }
  ...
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[durationModelInput cnt_dur](self, "cnt_dur");
  }
  ...
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[durationModelInput std_dur](self, "std_dur");
  }
  ...
  {
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[durationModelInput weekday_med_dur](self, "weekday_med_dur");
  }
  else
  {
    ...
    v5 = (void *)MEMORY[0x24BDBFF98];
    -[durationModelInput weekday_std_dur](self, "weekday_std_dur");
  }
