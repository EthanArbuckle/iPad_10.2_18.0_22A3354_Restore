...
LABEL_6:
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_scsSpacing);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  if (bandwidth >= 0x12)
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_bandwidth);
    v8 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v8 = off_251429680[bandwidth];
  }
