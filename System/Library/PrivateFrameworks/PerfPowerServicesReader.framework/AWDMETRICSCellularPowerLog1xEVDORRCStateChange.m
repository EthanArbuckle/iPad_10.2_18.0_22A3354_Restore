...
- (int)StringAsCause:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("MO")) & 1) != 0)
  {
    v4 = 0;
  }
...
- (id)description
{
  ...
  -[AWDMETRICSCellularPowerLog1xEVDORRCStateChange description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDMETRICSCellularPowerLog1xEVDORRCStateChange dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_19:
  ...
  if (cause)
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_cause);
