...
- (int)StringAsEvent:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("ENDC_OFF")) & 1) != 0)
    v4 = 0;
  else
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("ENDC_ON"));
...
- (id)description
{
  ...
  -[AWDMETRICSCellularPowerLogNRNSAENDCEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDMETRICSCellularPowerLogNRNSAENDCEvent dictionaryRepresentation](self, "dictionaryRepresentation");
