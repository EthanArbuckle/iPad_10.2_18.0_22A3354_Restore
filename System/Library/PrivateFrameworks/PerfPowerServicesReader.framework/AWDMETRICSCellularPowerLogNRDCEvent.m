...
- (int)StringAsEvent:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("NRDC_OFF")) & 1) != 0)
    v4 = 0;
  else
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("NRDC_ON"));
...
- (id)description
{
  ...
  -[AWDMETRICSCellularPowerLogNRDCEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDMETRICSCellularPowerLogNRDCEvent dictionaryRepresentation](self, "dictionaryRepresentation");
