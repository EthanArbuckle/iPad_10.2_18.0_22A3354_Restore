...
- (id)description
{
  ...
  -[AWDMETRICSCellularPowerLogLTECarrierComponentInfo description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDMETRICSCellularPowerLogLTECarrierComponentInfo dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_carrierInfos, "count"));
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("carrier_info"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v10 = v4;
  if (-[AWDMETRICSCellularPowerLogLTECarrierComponentInfo carrierInfosCount](self, "carrierInfosCount"))
  {
    objc_msgSend(v10, "clearCarrierInfos");
    v6 = -[AWDMETRICSCellularPowerLogLTECarrierComponentInfo carrierInfosCount](self, "carrierInfosCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        -[AWDMETRICSCellularPowerLogLTECarrierComponentInfo carrierInfoAtIndex:](self, "carrierInfoAtIndex:", i);
...
LABEL_14:
  ...
  if ((unint64_t)carrierInfos | *((_QWORD *)v4 + 2))
    v6 = -[NSMutableArray isEqual:](carrierInfos, "isEqual:");
  else
    v6 = 1;
LABEL_15:
...
LABEL_5:
    v3 = 0;
    return v3 ^ v2 ^ -[NSMutableArray hash](self->_carrierInfos, "hash");
  }
  v2 = 0;
  if ((*(_BYTE *)&self->_has & 2) == 0)
    goto LABEL_5;
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[AWDMETRICSCellularPowerLogLTECarrierComponentInfo addCarrierInfo:](self, "addCarrierInfo:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
