@implementation PUFeedCollectionViewSectionLayoutInfo

- (PUFeedCollectionViewSectionLayoutInfo)init
{
  PUFeedCollectionViewSectionLayoutInfo *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)PUFeedCollectionViewSectionLayoutInfo;
  result = -[PUFeedCollectionViewSectionLayoutInfo init](&v3, sel_init);
  if (result)
...
- (CGRect)frame
{
  ...
  -[PUFeedCollectionViewSectionLayoutInfo origin](self, "origin");
  v4 = v3;
  v6 = v5;
  -[PUFeedCollectionViewSectionLayoutInfo size](self, "size");
  v8 = v7;
  v10 = v9;
  v11 = v4;
  v12 = v6;
...
- (void)setOrigin:(CGPoint)a3
{
  ...
  if (a3.x != x || a3.y != y)
  {
    ...
    v18 = 0u;
    v19 = 0u;
    -[PUFeedCollectionViewSectionLayoutInfo fixedLayoutAttributes](self, "fixedLayoutAttributes", 0);
