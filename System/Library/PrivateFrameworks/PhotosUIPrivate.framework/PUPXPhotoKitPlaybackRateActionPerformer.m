...
- (void)performUserInteractionTask
{
  ...
  if (objc_msgSend(v5, "count"))
  {
    ...
    v15[1] = 3221225472;
    v15[2] = __69__PUPXPhotoKitPlaybackRateActionPerformer_performUserInteractionTask__block_invoke_540;
    v15[3] = &unk_1E58A3CB8;
    v15[4] = self;
...
LABEL_4:
        ...
        objc_msgSend(v7, "executeWithUndoManager:completionHandler:", v8, &__block_literal_global_544);
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1AAB61000, v9, OS_LOG_TYPE_INFO, "No valid assets to apply playback rate, aborting.", buf, 2u);
  }
...
void __69__PUPXPhotoKitPlaybackRateActionPerformer_performUserInteractionTask__block_invoke_540(uint64_t a1, void *a2)
{
  void *v2;
  id v3;
...
void __94__PUPXPhotoKitPlaybackRateActionPerformer_canPerformWithSelectionSnapshot_person_socialGroup___block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
  id v5;
  id v6;
