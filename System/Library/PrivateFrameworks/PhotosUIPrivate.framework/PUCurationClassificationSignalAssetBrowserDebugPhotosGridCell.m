...
- (void)layoutSubviews
{
  ...
  if (!self->_scoreLabel)
  {
    ...
    -[PUCurationClassificationSignalAssetBrowserDebugPhotosGridCell addSubview:](self, "addSubview:", self->_scoreLabel);
  }
  -[PUCurationClassificationSignalAssetBrowserDebugPhotosGridCell bounds](self, "bounds");
...
- (void)setColor:(id)a3
{
  ...
  v5 = a3;
  -[UILabel setTextColor:](self->_scoreLabel, "setTextColor:", v5);
