...
- (void)layoutSubviews
{
  ...
  if (!self->_scoreLabel)
  {
    ...
    -[PUTopPeopleWallpaperSuggestionsDebugPhotosGridCell addSubview:](self, "addSubview:", self->_scoreLabel);
  }
  -[PUTopPeopleWallpaperSuggestionsDebugPhotosGridCell bounds](self, "bounds");
