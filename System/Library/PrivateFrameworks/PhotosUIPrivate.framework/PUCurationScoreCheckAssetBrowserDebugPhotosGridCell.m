@implementation PUCurationScoreCheckAssetBrowserDebugPhotosGridCell
...
- (void)layoutSubviews
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)PUCurationScoreCheckAssetBrowserDebugPhotosGridCell;
  ...
  if (!self->_scoreLabel)
  {
    ...
    -[PUCurationScoreCheckAssetBrowserDebugPhotosGridCell addSubview:](self, "addSubview:", self->_scoreLabel);
  }
  -[PUCurationScoreCheckAssetBrowserDebugPhotosGridCell bounds](self, "bounds");
