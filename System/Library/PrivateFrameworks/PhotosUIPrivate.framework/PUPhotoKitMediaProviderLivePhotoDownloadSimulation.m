...
{
  PUPhotoKitMediaProviderLivePhotoDownloadSimulation *v2;
  PUPhotoKitMediaProviderLivePhotoDownloadSimulation *v3;
  PUPhotoKitMediaProviderLivePhotoDownloadSimulation *v4;
  uint64_t v5;
  id internalResultHandler;
  _QWORD v8[4];
  PUPhotoKitMediaProviderLivePhotoDownloadSimulation *v9;
  objc_super v10;
...
- (void)_handleResultLivePhoto:(id)a3 info:(id)a4
{
  ...
  v12 = v11;
  if ((v8 & 1) != 0 || objc_msgSend(v11, "isThumbnail"))
  {
    -[PUPhotoKitMediaProviderLivePhotoDownloadSimulation externalResultHandler](self, "externalResultHandler");
  ...
  {
    -[PUPhotoKitMediaProviderLivePhotoDownloadSimulation _setResultLivePhoto:](self, "_setResultLivePhoto:", v14);
    -[PUPhotoKitMediaProviderLivePhotoDownloadSimulation _setResultInfo:](self, "_setResultInfo:", v6);
...
- (void)updateSimulationWithProgress:(double)a3
{
  ...
  -[PUPhotoKitMediaProviderLivePhotoDownloadSimulation externalProgressHandler](self, "externalProgressHandler");
...
- (void)endSimulationWithError:(id)a3
{
  ...
  -[PUPhotoKitMediaProviderLivePhotoDownloadSimulation _resultLivePhoto](self, "_resultLivePhoto");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[PUPhotoKitMediaProviderLivePhotoDownloadSimulation _resultInfo](self, "_resultInfo");
...
{
  objc_storeStrong((id *)&self->__resultLivePhoto, a3);
}
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_handleResultLivePhoto:info:", a2, a3);
}
