@implementation PUAlbumPickerViewControllerPadSpec
...
- (id)newAlbumListViewController
{
  ...
  -[PUAlbumPickerViewControllerPadSpec albumListViewControllerSpec](self, "albumListViewControllerSpec");
...
- (void)configureSessionInfo:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "setPromptLocation:", 0);
  objc_msgSend(v3, "setBannerGenerator:", &__block_literal_global_150);

}

PUPickerBanner *__59__PUAlbumPickerViewControllerPadSpec_configureSessionInfo___block_invoke()
{
  PUPickerBanner *v0;
  void *v1;
