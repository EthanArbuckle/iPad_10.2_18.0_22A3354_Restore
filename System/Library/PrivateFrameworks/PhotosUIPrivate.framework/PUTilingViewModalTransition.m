...
- (PUTilingViewModalTransition)initWithEndPoint:(id)a3
{
  ...
  double v9;
  double v10;
  PUTilingViewModalTransition *v11;
  ...
  v11 = -[PUViewControllerTransition initWithDuration:](&v19, sel_initWithDuration_, v10);
  if (v11)
  {
    v12 = [PUTilingViewTransitionHelper alloc];
    -[PUViewControllerTransition duration](v11, "duration");
    v14 = v13;
    -[PUViewControllerTransition duration](v11, "duration");
...
{
  -[PUTilingViewModalTransition _animateTransitionWithOperation:](self, "_animateTransitionWithOperation:", 1);
}

- (void)animateDismissTransition
{
  -[PUTilingViewModalTransition _animateTransitionWithOperation:](self, "_animateTransitionWithOperation:", 2);
}
...
- (void)_animateTransitionWithOperation:(int64_t)a3
{
  ...
  -[PUTilingViewModalTransition _tilingViewTransitionHelper](self, "_tilingViewTransitionHelper");
