...
- (id)runQuery:(id)a3 error:(id *)a4
{
  ...
  int v7;
  void *v8;
  FedStatsSQLiteDatabaseQueryResult *v9;
  FedStatsSQLiteDatabaseQueryResult *v10;
  sqlite3_stmt *ppStmt;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (!v7)
    {
      ...
      v9 = -[FedStatsSQLiteDatabaseQueryResult initWithQueryStatement:](v10, "initWithQueryStatement:", ppStmt);
      goto LABEL_9;
    }
    if (a4)
    {
