...
- (HKMHMostPrevalentDomainsQuery)initWithDayIndexRange:(id)a3 gregorianCalendar:(id)a4 predicate:(id)a5 resultsHandler:(id)a6
{
  ...
  id v15;
  void *v16;
  HKMHMostPrevalentDomainsQuery *v17;
  uint64_t v18;
  id resultsHandler;
  objc_super v21;
...
void __78__HKMHMostPrevalentDomainsQuery_client_deliverMostPrevalentDomains_queryUUID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x24BDD3038], OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    ...
    v4 = v13;
    _os_log_impl(&dword_2416DD000, v3, OS_LOG_TYPE_DEFAULT, "[%{public}@] Received MostPrevalentDomains", buf, 0xCu);
  ...
  if (v5)
  {
    ...
    v9[1] = 3221225472;
    v9[2] = __78__HKMHMostPrevalentDomainsQuery_client_deliverMostPrevalentDomains_queryUUID___block_invoke_183;
    v9[3] = &unk_25119D730;
    v9[4] = v7;
    v11 = v5;
    v10 = *(id *)(a1 + 48);
...
uint64_t __78__HKMHMostPrevalentDomainsQuery_client_deliverMostPrevalentDomains_queryUUID___block_invoke_183(uint64_t a1)
{
  void *v2;
  NSObject *v3;
  id v4;
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x24BDD3038], OS_LOG_TYPE_DEFAULT))
  {
    ...
    v4 = v7;
    _os_log_impl(&dword_2416DD000, v3, OS_LOG_TYPE_DEFAULT, "[%{public}@] Delivering MostPrevalentDomains", (uint8_t *)&v6, 0xCu);
...
+ (void)configureClientInterface:(id)a3
{
  ...
  v5 = (id)objc_msgSend(v4, "hk_setArrayOfClass:forSelector:argumentIndex:ofReply:", objc_opt_class(), sel_client_deliverMostPrevalentDomains_queryUUID_, 0, 0);
