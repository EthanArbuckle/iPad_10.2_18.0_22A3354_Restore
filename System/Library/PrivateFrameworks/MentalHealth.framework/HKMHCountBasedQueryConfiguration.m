...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[HKMHCountBasedQueryConfiguration dayIndexRange](self, "dayIndexRange");
  objc_msgSend(v4, "setDayIndexRange:", v5, v6);
  -[HKMHCountBasedQueryConfiguration gregorianCalendar](self, "gregorianCalendar");
...
{
  id v4;
  HKMHCountBasedQueryConfiguration *v5;
  uint64_t v6;
