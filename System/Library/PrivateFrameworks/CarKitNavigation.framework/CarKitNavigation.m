id CRNavigationServiceInterface()
{
  ...
  return (id)CRNavigationServiceInterface_interface;
}

id CRNavigationClientInterface()
{
  if (CRNavigationClientInterface_onceToken != -1)
    dispatch_once(&CRNavigationClientInterface_onceToken, &__block_literal_global_67);
  return (id)CRNavigationClientInterface_interface;
}
...
id CarNavLogging()
{
  ...
  return (id)CarNavLogging_facility;
}
