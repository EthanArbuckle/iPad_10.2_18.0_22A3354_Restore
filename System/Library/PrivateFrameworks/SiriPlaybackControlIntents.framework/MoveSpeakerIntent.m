...
{
  id v3;
  MoveSpeakerIntent *result;

  v3 = a3;
  MoveSpeakerIntent.init(coder:)();
  return result;
}
...
- (MoveSpeakerIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v8 = a4;
  MoveSpeakerIntent.init(identifier:backingStore:)(v5, v7, a4);
  return result;
}
...
- (MoveSpeakerIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  if (a5)
    sub_2249ECD68();
  MoveSpeakerIntent.init(domain:verb:parametersByName:)();
  return result;
}
