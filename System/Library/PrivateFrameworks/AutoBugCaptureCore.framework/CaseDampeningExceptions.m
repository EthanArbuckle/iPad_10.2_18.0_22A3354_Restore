...
LABEL_68:
    ...
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E08]), "initWithDictionary:", &unk_1EA3CF730);
    if (_isNPIDevice)
    {
      v10 = _logHandle;
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1DBAE1000, v10, OS_LOG_TYPE_INFO, "Modifying Cellular exceptions list for NPI devices", buf, 2u);
      }
      objc_msgSend(v9, "setObject:forKeyedSubscript:", &unk_1EA3CFF48, CFSTR("Baseband Stability"));
      objc_msgSend(v9, "setObject:forKeyedSubscript:", &unk_1EA3CFF60, CFSTR("IMS Call KPI"));
    }
    ...
    v37[10] = &unk_1EA3CF8E8;
    v37[11] = &unk_1EA3CF938;
    v34 = (void *)v8;
    v37[0] = v8;
    v37[1] = v9;
    v36[12] = CFSTR("SpotlightIndex");
    v37[12] = &unk_1EA3CF988;
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v37, v36, 13);
...
LABEL_65:
      ...
      _os_log_impl(&dword_1DBAE1000, v18, OS_LOG_TYPE_DEFAULT, v19, buf, 2u);
      goto LABEL_55;
    }
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0)
...
LABEL_67:
    ...
    _os_log_impl(&dword_1DBAE1000, v23, OS_LOG_TYPE_DEFAULT, v24, buf, 2u);
    goto LABEL_34;
  }
  v20 = 0;
LABEL_69:
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.1(uint64_t a1, void *a2)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1DBAE1000, v5, v6, "Found unexpected object %@ of class %@ as exception for subtype %@", v7, v8, v9, v10, v11);
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.2(uint64_t a1, void *a2)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1DBAE1000, v5, v6, "Found unexpected object %@ of class %@ as exception for type %@", v7, v8, v9, v10, v11);
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.3(uint64_t a1, void *a2)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1DBAE1000, v5, v6, "Found unexpected object %@ of class %@ as exception for domain %@", v7, v8, v9, v10, v11);
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.4(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_1DBAE1000, a2, OS_LOG_TYPE_DEBUG, "Comparing case signature %@ against allowed exceptions list.", (uint8_t *)&v2, 0xCu);
}
