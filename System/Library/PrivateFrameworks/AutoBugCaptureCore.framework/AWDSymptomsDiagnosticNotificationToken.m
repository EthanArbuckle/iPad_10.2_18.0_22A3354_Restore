...
- (id)description
{
  ...
  -[AWDSymptomsDiagnosticNotificationToken description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDSymptomsDiagnosticNotificationToken dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (notificationToken)
    objc_msgSend(v3, "setObject:forKey:", notificationToken, CFSTR("notificationToken"));
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copyWithZone:](self->_notificationToken, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
LABEL_9:
  ...
  notificationToken = self->_notificationToken;
  if ((unint64_t)notificationToken | *((_QWORD *)v4 + 2))
    v6 = -[NSString isEqual:](notificationToken, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSString hash](self->_notificationToken, "hash") ^ v2;
}
