...
- (WFHourlyForecastRequest)initWithLocation:(id)a3 completionHandler:(id)a4
{
  ...
  id v7;
  void *v8;
  WFHourlyForecastRequest *v9;
  WFHourlyForecastRequest *v10;
  WFHourlyForecastRequest *v11;
  uint64_t v12;
  NSLocale *locale;
  objc_super v15;
...
- (void)startWithService:(id)a3
{
  ...
  -[WFHourlyForecastRequest locale](self, "locale");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[WFTask identifier](self, "identifier");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "hourlyForecastForLocation:locale:taskIdentifier:", v7, v5, v6);
