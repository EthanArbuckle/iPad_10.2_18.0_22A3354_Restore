...
- (void)dealloc
{
  ...
  -[SCDANotifyStatePublisher _unregister](self, "_unregister");
  name = self->_name;
  if (name)
  {
    free(name);
  ...
  -[SCDANotifyStatePublisher dealloc](&v4, sel_dealloc);
}
...
- (SCDANotifyStatePublisher)initWithName:(id)a3 queue:(id)a4
{
  id v6;
  id v7;
  SCDANotifyStatePublisher *v8;
  SCDANotifyStatePublisher *v9;
  size_t v10;
  char *v11;
  NSObject *v12;
  NSObject *queue;
  _QWORD block[4];
  SCDANotifyStatePublisher *v16;
  objc_super v17;
  uint8_t buf[4];
  const char *v19;
  __int16 v20;
  ...
  v8 = -[SCDANotifyStatePublisher init](&v17, sel_init);
  v9 = v8;
  if (v8)
  {
    objc_storeStrong((id *)&v8->_queue, a4);
    v10 = objc_msgSend(v6, "maximumLengthOfBytesUsingEncoding:", 4) + 1;
    v11 = (char *)malloc_type_malloc(v10, 0x422A99F9uLL);
    v9->_name = v11;
    if ((objc_msgSend(v6, "getCString:maxLength:encoding:", v11, v10, 4) & 1) == 0)
    {
      ...
      if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        ...
        v20 = 2112;
        v21 = v6;
        _os_log_error_impl(&dword_246211000, v12, OS_LOG_TYPE_ERROR, "%s Unable to get C string of name from %@.", buf, 0x16u);
      }
    }
...
- (void)_notifyWithState:(unint64_t)a3
{
  ...
  {
    if (-[SCDANotifyStatePublisher _setState:withToken:](self, "_setState:withToken:", a3))
...
- (BOOL)_setState:(unint64_t)a3 withToken:(int)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 1024;
      v20 = v7;
      _os_log_error_impl(&dword_246211000, v8, OS_LOG_TYPE_ERROR, "%s Failed to set state to %llu of %s with token %d (status = %u).", (uint8_t *)&v11, 0x2Cu);
    }
  }
  return v7 == 0;
}
...
LABEL_7:
  ...
  v8 = SCDALogContextCore;
  v9 = os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR);
  if (v9)
  {
    name = self->_name;
    *(_DWORD *)buf = 136315906;
    ...
    v19 = 1024;
    v20 = state;
    _os_log_error_impl(&dword_246211000, v8, OS_LOG_TYPE_ERROR, "%s Failed to get state of %s with token %d (status = %u).", buf, 0x22u);
    LOBYTE(v9) = 0;
  }
  return v9;
}
    ...
    if (v3)
    {
      ...
      if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 136315650;
        ...
        v15 = 1024;
        v16 = v4;
        _os_log_error_impl(&dword_246211000, v5, OS_LOG_TYPE_ERROR, "%s Failed to get registration token of %s (status = %u).", buf, 0x1Cu);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 136315650;
        ...
        v15 = 1024;
        v16 = v7;
        _os_log_impl(&dword_246211000, v8, OS_LOG_TYPE_INFO, "%s Registration token of %s is %d.", buf, 0x1Cu);
      }
    }
  }
}
...
- (void)_unregister
{
  ...
  if (registrationToken != -1)
  {
    ...
    if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 2080;
      v9 = name;
      _os_log_impl(&dword_246211000, v4, OS_LOG_TYPE_INFO, "%s Registration token of %s is invalidated.", (uint8_t *)&v6, 0x16u);
    }
  }
}
