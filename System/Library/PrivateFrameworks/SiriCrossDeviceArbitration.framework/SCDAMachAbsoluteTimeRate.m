  ...
  if (v0)
  {
    ...
    if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      v10 = 1024;
      v11 = v1;
      _os_log_error_impl(&dword_246211000, v2, OS_LOG_TYPE_ERROR, "%s mach_timebase_info() failed with %d.", buf, 0x12u);
    }
  }
  else
  {
    ...
    *(double *)&_SCDAMachAbsoluteTimeRate_rate = v5;
    ...
    if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315906;
      ...
      v14 = 2048;
      v15 = v5;
      _os_log_impl(&dword_246211000, v6, OS_LOG_TYPE_INFO, "%s machTimebaseInfo.numer = %u, machTimebaseInfo.denom = %u, rate = %f", buf, 0x22u);
    }
  }
}
