...
- (void)_initializeMessageObj:(id)a3
{
  ...
  int v8;
  uint64_t v9;
  scdaAccessoryMessage *p_message;
  SCDAAccessoryMessage *v11;
  uint64_t v12;
  NSObject *v13;
  unsigned __int8 v14;
  uint8_t buf[4];
  ...
  if (v4)
  {
    if (objc_msgSend(v4, "length"))
    {
      ...
      if (v14)
      {
          ...
          if (v14 || v6 > 0x2F)
          {
            ...
            if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR))
            {
              *(_DWORD *)buf = 136315650;
              ...
              v19 = 2048;
              v20 = v7;
              _os_log_error_impl(&dword_246211000, v13, OS_LOG_TYPE_ERROR, "%s Wedged message received with version: %hhu and message length: %zu", buf, 0x1Cu);
            }
            goto LABEL_13;
          }
          v9 = objc_msgSend(objc_retainAutorelease(v5), "bytes");
        ...
        -[SCDAAccessoryMessage _copyRawBytesFromSource:toDest:length:](v11, "_copyRawBytesFromSource:toDest:length:", v9, p_message, v12);
        self->_isSane = 1;
LABEL_13:
        -[SCDAAccessoryMessage _initWithMessage:](self, "_initWithMessage:", &self->_message);
      }
    }
  }
...
- (void)_initializeMessageObjFromDictionary:(id)a3
{
  ...
  v4 = a3;
  +[SCDAAccessoryMessage acknowledgeRequestKey](SCDAAccessoryMessage, "acknowledgeRequestKey");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  +[SCDAAccessoryMessage sessionIdKey](SCDAAccessoryMessage, "sessionIdKey");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", v7);
  v8 = (NSUUID *)objc_claimAutoreleasedReturnValue();

  +[SCDAAccessoryMessage requestTypeKey](SCDAAccessoryMessage, "requestTypeKey");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  +[SCDAAccessoryMessage messageKey](SCDAAccessoryMessage, "messageKey");
  ...
  if (v12)
  {
    ...
    {
      -[SCDAAccessoryMessage _initializeMessageObj:](self, "_initializeMessageObj:", v12);
      goto LABEL_31;
    }
  }
  objc_opt_class();
      ...
      if (v14)
      {
        ...
        switch(v17)
        {
          case 10:
            p_message = &self->_message;
            self->_isSane = 1;
            +[SCDAAccessoryMessage electionDecisionKey](SCDAAccessoryMessage, "electionDecisionKey");
          ...
          case 9:
            p_message = &self->_message;
            self->_isSane = 1;
            +[SCDAAccessoryMessage emergencyHandledKey](SCDAAccessoryMessage, "emergencyHandledKey");
        ...
        -[SCDAAccessoryMessage _initWithMessage:](self, "_initWithMessage:", p_message);
...
LABEL_18:
      ...
      if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 136315650;
        ...
        v30 = 2112;
        v31 = accessoryId;
        _os_log_debug_impl(&dword_246211000, v18, OS_LOG_TYPE_DEBUG, "%s Unknown request type %@ for accessory id: %@, Ignoring.", buf, 0x20u);
      }
      self->_isSane = 0;
      goto LABEL_30;
    }
  ...
  if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315906;
    ...
    v32 = 2112;
    v33 = v16;
    _os_log_impl(&dword_246211000, v15, OS_LOG_TYPE_INFO, "%s Received a payload %@ with session id %@ for accessory id: %@, Ignoring.", buf, 0x2Au);
  }
  self->_isSane = 0;
LABEL_31:
...
- (SCDAAccessoryMessage)initWithRequestType:(unint64_t)a3 session:(unint64_t)a4 voiceTriggerEndTime:(double)a5 audioHash:(unsigned __int16)a6 goodnessScore:(unsigned __int8)a7 userConfidenceScore:(unsigned __int8)a8 tieBreaker:(unsigned __int8)a9 deviceClass:(unsigned __int8)a10 deviceGroup:(unsigned __int8)a11 productType:(unsigned __int8)a12 electionDecision:(unsigned __int8)a13 emergencyHandled:(unsigned __int8)a14 ack:(unsigned __int8)a15 accessoryId:(id)a16
{
  ...
  v25 = -[SCDAAccessoryMessage init](&v28, sel_init);
  v26 = v25;
  if (v25)
  {
    *(_OWORD *)(v25 + 9) = 0u;
...
- (id)initPreheatMessageWithSessionId:(unint64_t)a3 accessoryId:(id)a4
{
  ...
  v8 = -[SCDAAccessoryMessage init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    *(_OWORD *)(v8 + 9) = 0u;
...
- (id)initElectionDecisionMessageWithSessionId:(unint64_t)a3 decision:(BOOL)a4 accessoryId:(id)a5
{
  ...
  v10 = -[SCDAAccessoryMessage init](&v13, sel_init);
  v11 = v10;
  if (v10)
  {
    *(_OWORD *)(v10 + 9) = 0u;
...
- (SCDAAccessoryMessage)initWithAccessoryMessage:(id)a3 accessoryId:(id)a4
{
  id v6;
  id v7;
  SCDAAccessoryMessage *v8;
  SCDAAccessoryMessage *v9;
  objc_super v11;
  ...
  if (v8)
  {
    ...
    *(_OWORD *)&v9->_message.version = 0u;
    -[SCDAAccessoryMessage _initializeMessageObj:](v9, "_initializeMessageObj:", v6);
  }
...
- (SCDAAccessoryMessage)initWithAccessoryMessageAsDictionary:(id)a3 accessoryId:(id)a4
{
  ...
  if (v8)
  {
    ...
    *(_OWORD *)&v9->_message.session = 0u;
    *(_OWORD *)&v9->_message.version = 0u;
    -[SCDAAccessoryMessage _initializeMessageObjFromDictionary:](v9, "_initializeMessageObjFromDictionary:", v6);
  }
...
- (id)description
{
  ...
  v27[0] = CFSTR("iSane");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isSane);
  ...
  {
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("1 (ACKNOWLEDGEMENT)"));
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_serializedProtocol);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v28[2] = v24;
  v27[3] = CFSTR("Version");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.version);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v28[3] = v23;
  v27[4] = CFSTR("RequestType");
  v4 = (void *)MEMORY[0x24BDD17C8];
  requestType = self->_message.requestType;
  +[SCDAAccessoryMessage myriadRequestTypeAsString:](SCDAAccessoryMessage, "myriadRequestTypeAsString:", requestType);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "stringWithFormat:", CFSTR("%llu (%@)"), requestType, v22);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v28[4] = v21;
  v27[5] = CFSTR("Session");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_message.session);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v28[5] = v20;
  v27[6] = CFSTR("VoiceTrigger endtime");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", self->_message.voiceTriggerEndTime);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v28[6] = v19;
  v27[7] = CFSTR("AudioHash");
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("hash=%#04x"), self->_message.audioHash);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v28[7] = v6;
  v27[8] = CFSTR("GoodnessScore");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.goodnessScore);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v28[8] = v7;
  v27[9] = CFSTR("UserConfidence");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.userConfidenceScore);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v28[9] = v8;
  v27[10] = CFSTR("TieBreaker");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.tieBreaker);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v28[10] = v9;
  v27[11] = CFSTR("DeviceClass");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.deviceClass);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v28[11] = v10;
  v27[12] = CFSTR("DeviceGroup");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.deviceGroup);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v28[12] = v11;
  v27[13] = CFSTR("ProductType");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.productType);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v28[13] = v12;
  v27[14] = CFSTR("ElectionDecision");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.electionDecision);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v28[14] = v13;
  v27[15] = CFSTR("EmergencyHandled");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", self->_message.emergencyHandled);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v28[15] = v14;
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v28, v27, 16);
...
{
  if (a3 - 1 > 9)
    return CFSTR("scdaRequestTypeUnknown");
  else
    return off_25174A3B0[a3 - 1];
}
