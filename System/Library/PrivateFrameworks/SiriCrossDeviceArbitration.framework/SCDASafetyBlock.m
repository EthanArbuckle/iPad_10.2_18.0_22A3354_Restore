...
- (SCDASafetyBlock)initWithBlock:(id)a3
{
  ...
  v5 = -[SCDASafetyBlock init](&v9, sel_init);
  if (v5)
  {
    v6 = MEMORY[0x249555380](v4);
    block = v5->_block;
    v5->_block = (id)v6;
...
- (BOOL)invoke
{
  return -[SCDASafetyBlock invokeWithSignal:](self, "invokeWithSignal:", 0);
}
...
- (void)dealloc
{
  ...
  -[SCDASafetyBlock invokeWithSignal:](self, "invokeWithSignal:", -1);
  v3.receiver = self;
  v3.super_class = (Class)SCDASafetyBlock;
  -[SCDASafetyBlock dealloc](&v3, sel_dealloc);
}
