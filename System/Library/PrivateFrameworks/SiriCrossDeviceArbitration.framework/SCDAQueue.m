...
- (void)dealloc
{
  ...
  -[SCDAQueue dealloc](&v6, sel_dealloc);
}
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  ...
  if (!self->_count || a3->var3[0] == 1)
    return 0;
  var0 = a3->var0;
  v12 = (SCDALinkedListItem *)(id)a3->var0;
  if (!var0)
    v12 = self->_head;
  v13 = v12;
  v6 = 0;
...
- (id)frontObject
{
  return -[SCDALinkedListItem object](self->_head, "object");
}
...
- (id)objectAtIndex:(unint64_t)a3
{
  unint64_t count;
  unint64_t v4;
  SCDALinkedListItem *head;
  void *v6;
  SCDALinkedListItem *v7;
  SCDALinkedListItem *v8;
  ...
  else
  {
    ...
    if (count - 1 == a3)
    {
      head = self->_tail;
LABEL_7:
      -[SCDALinkedListItem object](head, "object");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      return v6;
    }
    v7 = self->_head;
    ...
    {
      v8 = v7;
      -[SCDALinkedListItem nextItem](v7, "nextItem");
      v7 = (SCDALinkedListItem *)objc_claimAutoreleasedReturnValue();

      --v4;
    }
    while (v4);
    -[SCDALinkedListItem object](v7, "object");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)enqueueObjects:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  SCDALinkedListItem *v13;
  SCDALinkedListItem *v14;
  uint64_t v15;
  void *v16;
  char v17;
  void *v18;
  ...
  do
  {
    ...
    do
    {
      ...
      v14 = -[SCDALinkedListItem initWithObject:]([SCDALinkedListItem alloc], "initWithObject:", *(_QWORD *)(*((_QWORD *)&v20 + 1) + 8 * v12));
      v7 = v14;
      if (v6)
      {
        if (!v13)
          goto LABEL_10;
LABEL_9:
        -[SCDALinkedListItem insertAfterItem:](v7, "insertAfterItem:", v13);
        goto LABEL_10;
      }
      v6 = v14;
      if (v13)
...
LABEL_15:
  ...
  self->_count += v19;
  -[SCDAQueue delegate](self, "delegate");
...
- (id)dequeueObject
{
  ...
  {
    -[SCDALinkedListItem object](v3, "object");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = self->_head;
    v6 = v5;
    if (self->_tail == v5)
    ...
    -[SCDALinkedListItem nextItem](self->_head, "nextItem");
    v7 = (SCDALinkedListItem *)objc_claimAutoreleasedReturnValue();
    head = self->_head;
    self->_head = v7;

    -[SCDALinkedListItem removeFromList](v6, "removeFromList");
    --self->_count;
...
- (id)description
{
  ...
  -[SCDAQueue description](&v7, sel_description);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SCDAQueue _objects](self, "_objects");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (SCDAQueueDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
