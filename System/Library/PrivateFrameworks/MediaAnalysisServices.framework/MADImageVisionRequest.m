...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  {
    v14.receiver = a1;
    v14.super_class = (Class)&OBJC_METACLASS___MADImageVisionRequest;
  ...
  else
  {
    ...
    if (v5)
      +[MADImageVisionRequest allocWithZone:].cold.1(v5, v6, v7, v8, v9, v10, v11, v12);
    return 0;
  }
}
...
{
  OUTLINED_FUNCTION_0(&dword_1D461A000, MEMORY[0x1E0C81028], a3, "Subclassing MADImageVisionRequest not allowed.", a5, a6, a7, a8, 0);
}
