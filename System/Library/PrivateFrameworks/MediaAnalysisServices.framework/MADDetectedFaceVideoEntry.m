...
- (MADDetectedFaceVideoEntry)initWithTimeRange:(id *)a3 confidence:(double)a4 boundingBox:(CGRect)a5
{
  ...
  CGFloat y;
  CGFloat x;
  MADDetectedFaceVideoEntry *result;
  __int128 v12;
  __int128 v13;
  objc_super v14;
  ...
  result = -[MADDetectedFaceVideoEntry init](&v14, sel_init);
  if (result)
  {
...
- (MADDetectedFaceVideoEntry)initWithCoder:(id)a3
{
  ...
  v5 = -[MADDetectedFaceVideoEntry init](&v15, sel_init);
  if (v5)
  {
    if (v4)
    {
...
- (id)description
{
  ...
  *(_OWORD *)&range.duration.timescale = *(_OWORD *)&self->_timeRange.duration.timescale;
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR("%@: %-.4fs-%-.4fs, "), CFSTR("TimeRange"), *(_QWORD *)&Seconds, CMTimeGetSeconds(&v12));
  -[MADDetectedFaceVideoEntry boundingBox](self, "boundingBox");
  NSStringFromRect(v14);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR("%@: %@, "), CFSTR("BoundingBox"), v8);

  -[MADDetectedFaceVideoEntry confidence](self, "confidence");
