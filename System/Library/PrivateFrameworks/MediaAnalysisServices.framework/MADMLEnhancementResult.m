...
{
  id v5;
  MADMLEnhancementResult *v6;
  MADMLEnhancementResult *v7;
  objc_super v9;
  ...
  if (!result)
  {
           ...
           || -[IOSurface pixelFormat](self->_surface, "pixelFormat") == 1278226488)
    {
      ...
      if (v5 == 1278226488)
        ...
        v7 = 8448;
      *(_OWORD *)&callbacks.version = xmmword_1E97E2380;
      *(_OWORD *)&callbacks.releaseBytePointer = *(_OWORD *)&off_1E97E2390;
