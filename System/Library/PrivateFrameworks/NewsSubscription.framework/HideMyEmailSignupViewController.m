...
{
  _TtC16NewsSubscription31HideMyEmailSignupViewController *result;

  result = (_TtC16NewsSubscription31HideMyEmailSignupViewController *)sub_1BA438260();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  __swift_destroy_boxed_opaque_existential_1((uint64_t)self + OBJC_IVAR____TtC16NewsSubscription31HideMyEmailSignupViewController_purchasePresenter);
}

- (void)viewDidLoad
{
  _TtC16NewsSubscription31HideMyEmailSignupViewController *v2;
...
- (void)viewWillLayoutSubviews
{
  ...
  -[HideMyEmailSignupViewController viewWillLayoutSubviews](&v15, sel_viewWillLayoutSubviews);
  v3 = objc_msgSend(*(id *)&v2[OBJC_IVAR____TtC16NewsSubscription31HideMyEmailSignupViewController_blueprintViewController], sel_view, v15.receiver, v15.super_class);
  if (v3)
  {
    v4 = v3;
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  v4 = a3;
  v5 = v7.receiver;
  -[HideMyEmailSignupViewController traitCollectionDidChange:](&v7, sel_traitCollectionDidChange_, v4);
