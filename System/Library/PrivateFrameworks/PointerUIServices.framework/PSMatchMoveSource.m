...
{
  PSMatchMoveSource *result;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)PSMatchMoveSource;
  result = -[PSMatchMoveSource init](&v7, sel_init);
  if (result)
  {
...
- (id)debugDescription
{
  ...
  NSStringFromClass(v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<%@: %p; <0x%x -> 0x%llx> shouldInvalidateIfPointerLeavesDisplay: %d>"),
    v5,
    self,
    self->_sourceContextID,
    self->_sourceLayerRenderID,
    self->_shouldBeInvalidatedIfPointerLeavesDisplay);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  id v4;
  PSMatchMoveSource *v5;
  objc_super v7;

  v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)PSMatchMoveSource;
  v5 = -[PSMatchMoveSource init](&v7, sel_init);
  if (v5)
  {
