...
+ (id)titleForScreen:(int64_t)a3 workflow:(int64_t)a4
{
  ...
  if (a3 == 1)
  {
    ...
    v5 = CFSTR("RECEIVE_SECOND_EDU_SCREEN_TITLE");
    v6 = CFSTR("SEND_SECOND_EDU_SCREEN_TITLE");
  }
  else
  {
    if (a3)
      return a1;
    v4 = (void *)MEMORY[0x24BE853F8];
    v5 = CFSTR("RECEIVE_FIRST_EDU_SCREEN_TITLE");
    v6 = CFSTR("SEND_FIRST_EDU_SCREEN_TITLE");
  }
  if (a4 == 1)
    v7 = v6;
  else
    v7 = v5;
  objc_msgSend(v4, "localizedStringForKey:", v7);
...
+ (id)bulletsForScreenOneUnder13:(int64_t)a3
{
  ...
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v7, CFSTR("bullet-bathing-suit"), 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v5, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v9, CFSTR("bullet-sad"), CFSTR("😔"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v15[1] = v10;
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v6);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v11, CFSTR("bullet-window-shocked"), 0);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v15[2] = v12;
...
+ (id)bulletsForScreenOneOver13:(int64_t)a3
{
  ...
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v6, CFSTR("bullet-monkey-hiding"), CFSTR("🙈"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v7;
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v5);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v8, CFSTR("bullet-window-shocked"), 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v12[1] = v9;
...
+ (id)bulletsForScreenTwoUnder13:(int64_t)a3
{
  ...
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v6, CFSTR("bullet-family"), CFSTR("👨‍👩‍👧‍👦"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v7;
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v5);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v8, CFSTR("bullet-teacher"), 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v12[1] = v9;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v12, 2);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)bulletsForScreenTwoOver13:(int64_t)a3
{
  ...
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v6, CFSTR("bullet-dancers"), CFSTR("👯"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v7;
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v5);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenBullet bullet:imageName:emoji:](USUIInterventionScreenBullet, "bullet:imageName:emoji:", v8, CFSTR("bullet-monkey-covering-mouth"), CFSTR("🙊"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v12[1] = v9;
  objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v12, 2);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)actionsForScreenOne:(int64_t)a3 type:(int64_t)a4 options:(int64_t)a5
{
  ...
  v5 = a5;
  v15[3] = *MEMORY[0x24BDAC8D0];
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", CFSTR("NOT_NOW"), a4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenAction action:primary:actionID:](USUIInterventionScreenAction, "action:primary:actionID:", v6, 1, 1);
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", CFSTR("IM_SURE"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenAction action:primary:actionID:](USUIInterventionScreenAction, "action:primary:actionID:", v8, 0, 3);
  v9 = (void *)objc_claimAutoreleasedReturnValue();

  if ((v5 & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", CFSTR("MORE_HELP"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    +[USUIInterventionScreenAction action:primary:actionID:](USUIInterventionScreenAction, "action:primary:actionID:", v11, 0, 2);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)actionsForScreenTwo:(int64_t)a3 type:(int64_t)a4
{
  ...
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenAction action:primary:actionID:](USUIInterventionScreenAction, "action:primary:actionID:", v8, 1, 4);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v10);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenAction action:primary:actionID:](USUIInterventionScreenAction, "action:primary:actionID:", v11, 0, 5);
  v12 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(MEMORY[0x24BE853F8], "localizedStringForKey:", v7);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  +[USUIInterventionScreenAction action:primary:actionID:](USUIInterventionScreenAction, "action:primary:actionID:", v13, 0, 6);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
