@implementation AVTPlistDatabaseMemojiAssetsForComponentType
...
void __AVTPlistDatabaseMemojiAssetsForComponentType_block_invoke()
{
  ...
  -[AVTResourceLocator pathForMemojiResource:ofType:inDirectory:isDirectory:](v0, (uint64_t)CFSTR("assetIdentifiersByComponentType"), (uint64_t)CFSTR("plist"), (uint64_t)v1, 0);
  v4 = (id)objc_claimAutoreleasedReturnValue();

  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithContentsOfFile:", v4);
  v2 = objc_claimAutoreleasedReturnValue();
  v3 = (void *)AVTPlistDatabaseMemojiAssetsForComponentType::kAVTPlistDatabase_assetIdentifiersByComponentType;
