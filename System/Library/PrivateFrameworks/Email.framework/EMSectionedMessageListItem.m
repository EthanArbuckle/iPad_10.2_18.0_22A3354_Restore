...
void __54___EMSectionedMessageListItem_EFCacheable__cachedSelf__block_invoke()
{
  ...
  cachedSelf_sTableLock_46 = 0;
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3690]), "initWithOptions:capacity:", 5, 0);
  v1 = (void *)cachedSelf_sUniqueObjectIDs_47;
  cachedSelf_sUniqueObjectIDs_47 = v0;
...
id __45___EMSectionedMessageListItem_initWithCoder___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    *(_QWORD *)(v4 + 8) = v3;
    ...
    objc_msgSend(v6, "decodeObjectOfClasses:forKey:", v9, CFSTR("EFPropertyKey_underlyingItem"));
...
void __47___EMSectionedMessageListItem_encodeWithCoder___block_invoke(uint64_t a1)
{
  ...
  v3 = *(void **)(a1 + 32);
  objc_msgSend(*(id *)(a1 + 40), "underlyingItem");
