...
- (ASKCellularDataInquiry)initWithBundle:(id)a3
{
  ...
  v6 = -[ASKCellularDataInquiry init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (BOOL)isEnabledForBundle
{
  ...
  if (v3)
  {
    ...
    {
      v5 = v4;
      -[ASKCellularDataInquiry bundle](self, "bundle");
      ...
      if ((_DWORD)v8)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 67240448;
          ...
          v15 = 1026;
          v16 = HIDWORD(v8);
          _os_log_impl(&dword_1D8328000, v10, OS_LOG_TYPE_ERROR, "Could not determine cellular usage policy, reason: CTError(domain: %{public}d, error: %{public}d)", buf, 0xEu);
        }
