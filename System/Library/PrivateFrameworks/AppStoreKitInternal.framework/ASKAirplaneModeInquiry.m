...
- (ASKAirplaneModeInquiry)init
{
  ...
  v2 = -[ASKAirplaneModeInquiry init](&v6, sel_init);
  if (v2)
  {
...
- (BOOL)isEnabled
{
  ...
  -[ASKAirplaneModeInquiry radiosPreferences](self, "radiosPreferences");
...
- (void)airplaneModeChanged
{
  ...
  -[ASKAirplaneModeInquiry delegate](self, "delegate");
