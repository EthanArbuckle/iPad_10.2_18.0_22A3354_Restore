@implementation ASKNetworkQualityInquiryReportMake
...
void __ASKNetworkQualityInquiryReportMake_block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v7 = a2;
  v5 = a3;
  if (LinkQualityDataKeyIsAllowed_onceToken[0] != -1)
    dispatch_once(LinkQualityDataKeyIsAllowed_onceToken, &__block_literal_global_4);
