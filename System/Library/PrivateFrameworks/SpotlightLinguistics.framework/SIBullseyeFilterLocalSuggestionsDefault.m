@implementation SIBullseyeFilterLocalSuggestionsDefault
...
uint64_t __SIBullseyeFilterLocalSuggestionsDefault_block_invoke()
{
  ...
  result = CFPreferencesGetAppBooleanValue(CFSTR("SPBullseyeFilterLocalSuggestions"), v0, &keyExistsAndHasValidFormat);
