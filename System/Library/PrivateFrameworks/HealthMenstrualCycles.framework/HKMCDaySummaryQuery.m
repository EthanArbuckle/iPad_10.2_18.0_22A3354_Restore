...
- (HKMCDaySummaryQuery)initWithDayIndexRange:(id)a3 ascending:(BOOL)a4 limit:(int64_t)a5 resultsHandler:(id)a6
{
  ...
  v12 = -[HKQuery _initWithObjectType:predicate:](&v17, sel__initWithObjectType_predicate_, 0, 0);
  v13 = v12;
  if (v12)
  {
...
void __103__HKMCDaySummaryQuery_client_deliverDaySummaries_clearPending_isFinalBatch_daySummaryAnchor_queryUUID___block_invoke(uint64_t a1)
{
  ...
  if (*(_BYTE *)(a1 + 65))
  {
    ...
    *(_QWORD *)(v8 + 160) = 0;
    ...
    v10 = (void *)MEMORY[0x219A1F070](*(_QWORD *)(*(_QWORD *)(a1 + 32) + 152));
    if (v10)
    {
      v11 = *(void **)(a1 + 32);
      v12 = *(_QWORD *)(a1 + 48);
      ...
      v13[1] = 3221225472;
      v13[2] = __103__HKMCDaySummaryQuery_client_deliverDaySummaries_clearPending_isFinalBatch_daySummaryAnchor_queryUUID___block_invoke_183;
      v13[3] = &unk_24D99E0B0;
      v13[4] = v11;
      v14 = v7;
      v16 = v10;
...
uint64_t __103__HKMCDaySummaryQuery_client_deliverDaySummaries_clearPending_isFinalBatch_daySummaryAnchor_queryUUID___block_invoke_183(uint64_t a1)
{
  void *v2;
  NSObject *v3;
  void *v4;
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x24BDD3030], OS_LOG_TYPE_DEFAULT))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_218A9C000, v3, OS_LOG_TYPE_DEFAULT, "[%{public}@] Delivering %@ summaries: %@", (uint8_t *)&v11, 0x20u);
...
+ (void)configureClientInterface:(id)a3
{
  ...
  v5 = (id)objc_msgSend(v4, "hk_setArrayOfClass:forSelector:argumentIndex:ofReply:", objc_opt_class(), sel_client_deliverDaySummaries_clearPending_isFinalBatch_daySummaryAnchor_queryUUID_, 0, 0);
...
- (void)queue_deliverError:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)MEMORY[0x219A1F070](self->_resultsHandler);
...
uint64_t __42__HKMCDaySummaryQuery_queue_deliverError___block_invoke(_QWORD *a1)
{
...
void __103__HKMCDaySummaryQuery_client_deliverDaySummaries_clearPending_isFinalBatch_daySummaryAnchor_queryUUID___block_invoke_cold_1(uint64_t a1, void *a2)
{
  ...
  *(_DWORD *)buf = 138544642;
  ...
  v27 = 2112;
  v28 = v15;
  _os_log_debug_impl(&dword_218A9C000, v3, OS_LOG_TYPE_DEBUG, "[%{public}@] Received batch of %@ summaries (%@ - %@), clear pending: %@, is final: %@", buf, 0x3Eu);
