...
{
  -[NSMutableArray removeAllObjects](self->_bundleIdPatterns, "removeAllObjects");
}
...
- (void)addBundleIdPatterns:(id)a3
{
  ...
  -[NSMutableArray addObject:](bundleIdPatterns, "addObject:", v4);

}

- (unint64_t)bundleIdPatternsCount
{
  return -[NSMutableArray count](self->_bundleIdPatterns, "count");
}

- (id)bundleIdPatternsAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_bundleIdPatterns, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[BCSDomainBundleIdPatterns description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BCSDomainBundleIdPatterns dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_bundleIdPatterns, "count"))
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_bundleIdPatterns, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("bundle_id_patterns"));
  }
  return v4;
}
...
LABEL_26:
    ...
    -[BCSDomainBundleIdPatterns addBundleIdPatterns:](self, "addBundleIdPatterns:", domain);
...
- (void)copyTo:(id)a3
{
  ...
  if (-[BCSDomainBundleIdPatterns bundleIdPatternsCount](self, "bundleIdPatternsCount"))
  {
    objc_msgSend(v8, "clearBundleIdPatterns");
    v4 = -[BCSDomainBundleIdPatterns bundleIdPatternsCount](self, "bundleIdPatternsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[BCSDomainBundleIdPatterns bundleIdPatternsAtIndex:](self, "bundleIdPatternsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addBundleIdPatterns:", v7);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addBundleIdPatterns:", v13);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](domain, "isEqual:")))
  {
    ...
    if ((unint64_t)bundleIdPatterns | v4[1])
      v7 = -[NSMutableArray isEqual:](bundleIdPatterns, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_bundleIdPatterns, "hash") ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[BCSDomainBundleIdPatterns addBundleIdPatterns:](self, "addBundleIdPatterns:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
{
  objc_storeStrong((id *)&self->_bundleIdPatterns, a3);
}
