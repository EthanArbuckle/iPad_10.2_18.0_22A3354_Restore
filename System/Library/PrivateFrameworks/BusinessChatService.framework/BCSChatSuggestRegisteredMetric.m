...
{
  return (NSString *)CFSTR("com.apple.businesschatd.chatSuggestRegistered");
}
...
- (NSDictionary)coreAnalyticsPayload
{
  ...
  -[BCSChatSuggestRegisteredMetric timingMeasurement](self, "timingMeasurement");
  ...
  v11[0] = v6;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[BCSChatSuggestRegisteredMetric errorCode](self, "errorCode"));
