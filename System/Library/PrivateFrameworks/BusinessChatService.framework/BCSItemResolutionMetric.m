...
{
  return (NSString *)CFSTR("com.apple.businesschatd.itemResolution");
}
...
- (NSDictionary)coreAnalyticsPayload
{
  ...
  -[BCSItemResolutionMetric itemIdentifier](self, "itemIdentifier");
  ...
  -[BCSItemResolutionMetric cacheHitMeasurement](self, "cacheHitMeasurement");
  ...
  -[BCSItemResolutionMetric timingMeasurement](self, "timingMeasurement");
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[BCSItemResolutionMetric errorCode](self, "errorCode"));
