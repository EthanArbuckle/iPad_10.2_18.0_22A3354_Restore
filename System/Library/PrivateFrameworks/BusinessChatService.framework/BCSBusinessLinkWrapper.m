...
- (id)description
{
  ...
  -[BCSBusinessLinkWrapper description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BCSBusinessLinkWrapper dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  orgId = self->_orgId;
  if (orgId)
    objc_msgSend(v3, "setObject:forKey:", orgId, CFSTR("orgId"));
  message = self->_message;
  if (message)
  {
    -[BCSBusinessLinkMessage dictionaryRepresentation](message, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_orgId, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v6;

  v8 = -[BCSBusinessLinkMessage copyWithZone:](self->_message, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_10;
  orgId = self->_orgId;
  if ((unint64_t)orgId | *((_QWORD *)v4 + 3))
  {
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_orgId, "hash");
  v4 = -[BCSBusinessLinkMessage hash](self->_message, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
...
- (void)setOrgId:(id)a3
{
  objc_storeStrong((id *)&self->_orgId, a3);
}
