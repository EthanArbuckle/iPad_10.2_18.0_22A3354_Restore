...
- (void)addDisplayName:(id)a3
{
  ...
  -[NSMutableArray addObject:](displayNames, "addObject:", v4);
...
- (id)description
{
  ...
  -[BCSEmailMetadataParquetMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BCSEmailMetadataParquetMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", self->_keyHash);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("key_hash"));
  ...
  if (-[NSMutableArray count](self->_displayNames, "count"))
  {
    v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_displayNames, "count"));
    v24 = 0u;
    v25 = 0u;
    v26 = 0u;
    v27 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v13, CFSTR("display_name"));
  }
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isVerified);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v20, CFSTR("is_verified"));
...
LABEL_47:
        ...
        case 2u:
          ...
          goto LABEL_43;
        case 3u:
          v27 = objc_alloc_init(BCSEmailLocalizedString);
          -[BCSEmailMetadataParquetMessage addName:](self, "addName:", v27);
          goto LABEL_31;
        case 4u:
          v27 = objc_alloc_init(BCSEmailLocalizedString);
          -[BCSEmailMetadataParquetMessage addDisplayName:](self, "addDisplayName:", v27);
LABEL_31:
...
- (void)copyTo:(id)a3
{
  ...
  if (-[BCSEmailMetadataParquetMessage namesCount](self, "namesCount"))
  {
    objc_msgSend(v14, "clearNames");
    v5 = -[BCSEmailMetadataParquetMessage namesCount](self, "namesCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[BCSEmailMetadataParquetMessage nameAtIndex:](self, "nameAtIndex:", i);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v14, "addName:", v8);

      }
    }
  }
  if (-[BCSEmailMetadataParquetMessage displayNamesCount](self, "displayNamesCount"))
  {
    objc_msgSend(v14, "clearDisplayNames");
    v9 = -[BCSEmailMetadataParquetMessage displayNamesCount](self, "displayNamesCount");
    if (v9)
    {
      v10 = v9;
      for (j = 0; j != v10; ++j)
      {
        -[BCSEmailMetadataParquetMessage displayNameAtIndex:](self, "displayNameAtIndex:", j);
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v14, "addDisplayName:", v12);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v6 + 40) = v7;
  ...
  if (v16)
  {
    ...
    do
    {
      for (j = 0; j != v17; ++j)
      {
        ...
        objc_msgSend((id)v6, "addDisplayName:", v20);
  ...
  v21 = -[NSString copyWithZone:](self->_businessId, "copyWithZone:", a3, (_QWORD)v26);
  v22 = *(void **)(v6 + 16);
  *(_QWORD *)(v6 + 16) = v21;

  v23 = -[NSString copyWithZone:](self->_companyId, "copyWithZone:", a3);
  v24 = *(void **)(v6 + 24);
  *(_QWORD *)(v6 + 24) = v23;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 60) & 1) == 0 || self->_keyHash != *((_QWORD *)v4 + 1))
      goto LABEL_25;
  }
  ...
  key = self->_key;
  if ((unint64_t)key | *((_QWORD *)v4 + 5) && !-[NSString isEqual:](key, "isEqual:"))
    goto LABEL_25;
  names = self->_names;
  if ((unint64_t)names | *((_QWORD *)v4 + 6))
  {
    if (!-[NSMutableArray isEqual:](names, "isEqual:"))
      goto LABEL_25;
  }
  displayNames = self->_displayNames;
  if ((unint64_t)displayNames | *((_QWORD *)v4 + 4))
  {
...
LABEL_21:
  businessId = self->_businessId;
  if ((unint64_t)businessId | *((_QWORD *)v4 + 2) && !-[NSString isEqual:](businessId, "isEqual:"))
    goto LABEL_25;
  companyId = self->_companyId;
  if ((unint64_t)companyId | *((_QWORD *)v4 + 3))
    v10 = -[NSString isEqual:](companyId, "isEqual:");
  else
    v10 = 1;
LABEL_26:
...
- (unint64_t)hash
{
  ...
  v6 = -[NSMutableArray hash](self->_displayNames, "hash");
  if ((*(_BYTE *)&self->_has & 2) != 0)
    v7 = 2654435761 * self->_isVerified;
  else
    v7 = 0;
  v8 = v4 ^ v3 ^ v5 ^ v6;
  v9 = v7 ^ -[NSString hash](self->_businessId, "hash");
  return v8 ^ v9 ^ -[NSString hash](self->_companyId, "hash");
}
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        -[BCSEmailMetadataParquetMessage addName:](self, "addName:", *(_QWORD *)(*((_QWORD *)&v20 + 1) + 8 * i));
      }
  ...
  if (v12)
  {
    ...
    do
    {
      for (j = 0; j != v13; ++j)
      {
        ...
        -[BCSEmailMetadataParquetMessage addDisplayName:](self, "addDisplayName:", *(_QWORD *)(*((_QWORD *)&v16 + 1) + 8 * j), (_QWORD)v16);
      }
