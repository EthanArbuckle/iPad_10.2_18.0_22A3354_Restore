...
{
  return (NSString *)CFSTR("com.apple.businesschatd.linkRegistered");
}
...
- (NSDictionary)coreAnalyticsPayload
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[BCSBusinessLinkRegisteredMetric isChoppingEnabled](self, "isChoppingEnabled"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v13[0] = v3;
  v12[1] = CFSTR("successfulChop");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[BCSBusinessLinkRegisteredMetric successfulChop](self, "successfulChop"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v13[1] = v4;
  v12[2] = CFSTR("duration");
  v5 = (void *)MEMORY[0x24BDD16E0];
  -[BCSBusinessLinkRegisteredMetric timingMeasurement](self, "timingMeasurement");
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[BCSBusinessLinkRegisteredMetric errorCode](self, "errorCode"));
