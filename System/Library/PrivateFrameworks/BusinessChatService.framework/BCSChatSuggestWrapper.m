...
- (id)description
{
  ...
  -[BCSChatSuggestWrapper description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[BCSChatSuggestWrapper dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (message)
  {
    -[BCSChatSuggestMessage dictionaryRepresentation](message, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 24) = v6;
  ...
  v8 = -[BCSChatSuggestMessage copyWithZone:](self->_message, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 16);
  *(_QWORD *)(v5 + 16) = v8;
...
- (unint64_t)hash
{
  ...
  v4 = -[BCSChatSuggestMessage hash](self->_message, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
