...
{
  return (NSString *)CFSTR("com.apple.businesschatd.chatSuggestFetch");
}
...
- (NSDictionary)coreAnalyticsPayload
{
  ...
  -[BCSChatSuggestFetchMetric timingMeasurement](self, "timingMeasurement");
  ...
  v11[0] = v6;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", -[BCSChatSuggestFetchMetric errorCode](self, "errorCode"));
