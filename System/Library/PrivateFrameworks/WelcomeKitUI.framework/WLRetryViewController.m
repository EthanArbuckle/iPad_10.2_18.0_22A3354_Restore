...
- (WLRetryViewController)initWithWelcomeController:(id)a3
{
  ...
  v11 = -[WLRetryViewController initWithTitle:detailText:icon:contentLayout:](&v19, sel_initWithTitle_detailText_icon_contentLayout_, v6, v7, v10, 2);
  ...
  if (v11)
  {
    ...
    -[OBTrayButton addTarget:action:forControlEvents:](v11->_retryButton, "addTarget:action:forControlEvents:", v11, sel__retry_, 64);
    -[WLRetryViewController buttonTray](v11, "buttonTray");
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[WLRetryViewController viewWillAppear:](&v4, sel_viewWillAppear_, a3);
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)WLRetryViewController;
  -[WLRetryViewController viewDidDisappear:](&v4, sel_viewDidDisappear_, a3);
  -[OBTrayButton hidesBusyIndicator](self->_retryButton, "hidesBusyIndicator");
}
...
- (void)_retry:(id)a3
{
  ...
  -[OBTrayButton showsBusyIndicator](self->_retryButton, "showsBusyIndicator", a3);
