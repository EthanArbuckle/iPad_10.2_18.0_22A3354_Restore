...
- (WLFailureViewController)initWithWelcomeController:(id)a3 context:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x24BDF69C8], "modelSpecificLocalizedStringKeyForKey:", CFSTR("FAILURE_DETAIL"));
  ...
  v15 = -[WLFailureViewController initWithTitle:detailText:icon:contentLayout:](&v40, sel_initWithTitle_detailText_icon_contentLayout_, v9, v11, v14, 2);
  ...
  if (v15)
  {
    ...
    if (objc_msgSend(v8, "isEnabled"))
    {
      ...
      -[WLFailureViewController contentView](v15, "contentView");
    ...
    -[WLFailureViewController buttonTray](v15, "buttonTray");
...
- (void)_detailTapped:(id)a3
{
  ...
  -[WLFailureViewController presentViewController:animated:completion:](self, "presentViewController:animated:completion:", v4, 1, 0);
