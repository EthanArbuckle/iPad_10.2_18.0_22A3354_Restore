...
+ (id)ringLayerWithBlendMode:(id)a3 diameter:(double)a4 lineWidth:(double)a5 brightnessAmount:(double)a6 saturationAmount:(double)a7
{
  ...
  objc_msgSend(v13, "setLineCap:", *MEMORY[0x24BDE5CE8]);
  objc_msgSend(MEMORY[0x24BDE56B0], "filterWithType:", v12);
  v15 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v13, "setCompositingFilter:", v15);
  objc_msgSend(MEMORY[0x24BDE56B0], "brightnessFilterWithAmount:", a6);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDE56B0], "saturationFilterWithAmount:", a7);
