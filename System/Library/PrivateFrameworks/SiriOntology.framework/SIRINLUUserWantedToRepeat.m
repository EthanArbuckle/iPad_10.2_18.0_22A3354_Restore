...
- (SIRINLUUserWantedToRepeat)initWithSystemDialogActId:(id)a3 reference:(id)a4
{
  id v7;
  id v8;
  SIRINLUUserWantedToRepeat *v9;
  SIRINLUUserWantedToRepeat *v10;
  objc_super v12;
  ...
  v9 = -[SIRINLUUserWantedToRepeat init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (SIRINLUUserWantedToRepeat)initWithCoder:(id)a3
{
  ...
  v5 = -[SIRINLUUserWantedToRepeat init](&v11, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[SIRINLUUserWantedToRepeat systemDialogActId](self, "systemDialogActId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("systemDialogActId"));

  -[SIRINLUUserWantedToRepeat reference](self, "reference");
...
- (id)description
{
  ...
  objc_msgSend(v6, "stringWithFormat:", CFSTR("{UserWantedToRepeat\n  systemDialogActId: %@\n  reference:\n%@\n}"), v7, v5);
