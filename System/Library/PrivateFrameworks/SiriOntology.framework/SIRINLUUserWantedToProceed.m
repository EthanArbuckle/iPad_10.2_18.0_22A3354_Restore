...
{
  id v5;
  SIRINLUUserWantedToProceed *v6;
  SIRINLUUserWantedToProceed *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SIRINLUUserWantedToProceed;
  v6 = -[SIRINLUUserWantedToProceed init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (SIRINLUUserWantedToProceed)initWithTaskId:(id)a3 reference:(id)a4
{
  id v7;
  id v8;
  SIRINLUUserWantedToProceed *v9;
  SIRINLUUserWantedToProceed *v10;
  objc_super v12;
  ...
  v9 = -[SIRINLUUserWantedToProceed init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (SIRINLUUserWantedToProceed)initWithCoder:(id)a3
{
  ...
  v5 = -[SIRINLUUserWantedToProceed init](&v11, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[SIRINLUUserWantedToProceed taskId](self, "taskId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("taskId"));

  -[SIRINLUUserWantedToProceed reference](self, "reference");
...
- (id)description
{
  ...
  objc_msgSend(v6, "stringWithFormat:", CFSTR("{UserWantedToProceed\n  taskId: %@\n  reference:\n%@\n}"), v7, v5);
