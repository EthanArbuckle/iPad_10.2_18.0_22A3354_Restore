...
{
  id v5;
  SIRINLUUserWantedToPause *v6;
  SIRINLUUserWantedToPause *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SIRINLUUserWantedToPause;
  v6 = -[SIRINLUUserWantedToPause init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (SIRINLUUserWantedToPause)initWithTaskId:(id)a3 reference:(id)a4
{
  id v7;
  id v8;
  SIRINLUUserWantedToPause *v9;
  SIRINLUUserWantedToPause *v10;
  objc_super v12;
  ...
  v9 = -[SIRINLUUserWantedToPause init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (SIRINLUUserWantedToPause)initWithCoder:(id)a3
{
  ...
  v5 = -[SIRINLUUserWantedToPause init](&v11, sel_init);
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[SIRINLUUserWantedToPause taskId](self, "taskId");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("taskId"));

  -[SIRINLUUserWantedToPause reference](self, "reference");
...
- (id)description
{
  ...
  objc_msgSend(v6, "stringWithFormat:", CFSTR("{UserWantedToPause\n  taskId: %@\n  reference:\n%@\n}"), v7, v5);
