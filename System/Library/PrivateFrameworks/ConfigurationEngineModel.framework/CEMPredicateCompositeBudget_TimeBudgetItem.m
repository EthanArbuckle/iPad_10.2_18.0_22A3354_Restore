...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPredicateCompositeBudget_TimeBudgetItem allowedPayloadKeys](CEMPredicateCompositeBudget_TimeBudgetItem, "allowedPayloadKeys");
  ...
  {
    v19 = 0;
    -[CEMPayloadBase loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:](self, "loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:", v6, CFSTR("Days"), &__block_literal_global_190, 0, 0, &v19);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  -[CEMPayloadBase serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:](self, "serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:", v4, CFSTR("Days"), self->_payloadDays, &__block_literal_global_191, 0, 0);
