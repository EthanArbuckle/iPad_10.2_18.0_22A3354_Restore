...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.builtinwireless");
}

+ (id)profileType
{
  return CFSTR("com.apple.builtinwireless.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.builtinwireless"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XBuiltinWirelessDeclaration allowedPayloadKeys](CEMNetwork8021XBuiltinWirelessDeclaration, "allowedPayloadKeys");
