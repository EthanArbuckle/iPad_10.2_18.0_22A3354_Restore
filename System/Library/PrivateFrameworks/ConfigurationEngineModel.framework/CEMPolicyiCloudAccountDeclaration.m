...
{
  return (NSString *)CFSTR("com.apple.configuration.policy.icloud.account");
}
...
+ (id)buildWithIdentifier:(id)a3 withMode:(id)a4
{
  ...
  objc_msgSend(v7, "setDeclarationType:", CFSTR("com.apple.configuration.policy.icloud.account"));
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPolicyiCloudAccountDeclaration allowedPayloadKeys](CEMPolicyiCloudAccountDeclaration, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v7, CFSTR("Mode"), 1, 0, &v17);
