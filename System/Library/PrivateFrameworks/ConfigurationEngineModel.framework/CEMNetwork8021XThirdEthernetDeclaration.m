...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.thirdethernet");
}

+ (id)profileType
{
  return CFSTR("com.apple.thirdethernet.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.thirdethernet"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XThirdEthernetDeclaration allowedPayloadKeys](CEMNetwork8021XThirdEthernetDeclaration, "allowedPayloadKeys");
