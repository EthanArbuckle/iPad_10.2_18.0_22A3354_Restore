...
{
  return (NSString *)CFSTR("com.apple.command.device.shutdown");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.device.shutdown"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMDeviceShutDownCommand allowedPayloadKeys](CEMDeviceShutDownCommand, "allowedPayloadKeys");
