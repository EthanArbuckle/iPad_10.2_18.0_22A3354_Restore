...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  CEMAccountLDAPDeclaration_CommunicationServiceRulesDefaultServiceHandlers *v13;
  id v14;
  ...
  +[CEMAccountLDAPDeclaration_CommunicationServiceRules allowedPayloadKeys](CEMAccountLDAPDeclaration_CommunicationServiceRules, "allowedPayloadKeys");
  ...
  v13 = (CEMAccountLDAPDeclaration_CommunicationServiceRulesDefaultServiceHandlers *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[CEMAccountLDAPDeclaration_CommunicationServiceRulesDefaultServiceHandlers copy](self->_payloadDefaultServiceHandlers, "copy");
  v6 = (void *)v4[2];
  v4[2] = v5;
