...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.globalethernet");
}

+ (id)profileType
{
  return CFSTR("com.apple.globalethernet.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.globalethernet"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XGlobalEthernetDeclaration allowedPayloadKeys](CEMNetwork8021XGlobalEthernetDeclaration, "allowedPayloadKeys");
