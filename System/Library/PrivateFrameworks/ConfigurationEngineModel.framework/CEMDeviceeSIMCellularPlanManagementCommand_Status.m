...
+ (NSSet)allowedReasons
{
  ...
  v6[0] = CFSTR("UnableToCommunicate");
  v6[1] = CFSTR("HardwareNotSupported");
  v6[2] = CFSTR("UnableToPerform");
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMDeviceeSIMCellularPlanManagementCommand_Status allowedStatusKeys](CEMDeviceeSIMCellularPlanManagementCommand_Status, "allowedStatusKeys");
