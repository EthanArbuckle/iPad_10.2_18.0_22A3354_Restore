...
{
  return (NSString *)CFSTR("com.apple.command.device.restrictions.list");
}
...
+ (NSSet)allowedPayloadKeys
{
  ...
  v6[0] = CFSTR("ProfileRestrictions");
...
+ (id)buildWithIdentifier:(id)a3 withProfileRestrictions:(id)a4
{
  ...
  objc_msgSend(v7, "setCommandType:", CFSTR("com.apple.command.device.restrictions.list"));
  if (v5)
  {
  ...
  objc_msgSend(v7, "setPayloadProfileRestrictions:", v10);
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.device.restrictions.list"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMDeviceListRestrictionsCommand allowedPayloadKeys](CEMDeviceListRestrictionsCommand, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadBooleanFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadBooleanFromDictionary:withKey:isRequired:defaultValue:error:", v7, CFSTR("ProfileRestrictions"), 0, MEMORY[0x24BDBD1C0], &v17);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CEMPayloadBase serializeBooleanIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeBooleanIntoDictionary:withKey:withValue:isRequired:defaultValue:", v4, CFSTR("ProfileRestrictions"), self->_payloadProfileRestrictions, 0, MEMORY[0x24BDBD1C0]);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[NSNumber copy](self->_payloadProfileRestrictions, "copy");
  v6 = (void *)v4[7];
  v4[7] = v5;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_payloadProfileRestrictions, 0);
}
