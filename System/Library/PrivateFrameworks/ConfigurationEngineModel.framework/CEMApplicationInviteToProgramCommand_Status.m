...
+ (NSSet)allowedReasons
{
  ...
  v6[0] = CFSTR("InvalidProgramID");
  v6[1] = CFSTR("InvalidInvitationURL");
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMApplicationInviteToProgramCommand_Status allowedStatusKeys](CEMApplicationInviteToProgramCommand_Status, "allowedStatusKeys");
