...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMActivationSimpleDeclaration_StatusInstalledConfigurationsItem allowedStatusKeys](CEMActivationSimpleDeclaration_StatusInstalledConfigurationsItem, "allowedStatusKeys");
