...
{
  return (NSString *)CFSTR("com.apple.command.device.restart");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.device.restart"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMDeviceRestartCommand allowedPayloadKeys](CEMDeviceRestartCommand, "allowedPayloadKeys");
