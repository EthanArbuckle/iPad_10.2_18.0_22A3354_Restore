...
{
  return (NSString *)CFSTR("com.apple.command.application.validate");
}
...
+ (id)buildWithIdentifier:(id)a3 withBundleIdentifiers:(id)a4
{
  ...
  objc_msgSend(v7, "setCommandType:", CFSTR("com.apple.command.application.validate"));
  if (v5)
  {
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.application.validate"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMApplicationValidateApplicationsCommand allowedPayloadKeys](CEMApplicationValidateApplicationsCommand, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:](self, "loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:", v7, CFSTR("BundleIdentifiers"), &__block_literal_global_8, 0, 0, &v17);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[CEMPayloadBase serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:](self, "serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:", v4, CFSTR("BundleIdentifiers"), self->_payloadBundleIdentifiers, &__block_literal_global_13_0, 0, 0);
