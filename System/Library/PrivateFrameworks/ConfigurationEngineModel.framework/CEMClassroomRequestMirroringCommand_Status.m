...
+ (NSSet)allowedReasons
{
  ...
  v6[0] = CFSTR("Prompting");
  v6[1] = CFSTR("DestinationNotFound");
  v6[2] = CFSTR("Cancelled");
  v6[3] = CFSTR("Unknown");
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMClassroomRequestMirroringCommand_Status allowedStatusKeys](CEMClassroomRequestMirroringCommand_Status, "allowedStatusKeys");
