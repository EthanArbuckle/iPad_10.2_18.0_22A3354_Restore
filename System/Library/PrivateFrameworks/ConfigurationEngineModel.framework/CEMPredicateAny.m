...
{
  return (NSString *)CFSTR("com.apple.predicate.any");
}
...
+ (id)buildWithPredicates:(id)a3
{
  ...
  objc_msgSend(v4, "setPayloadType:", CFSTR("com.apple.predicate.any"));
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPredicateAny allowedPayloadKeys](CEMPredicateAny, "allowedPayloadKeys");
