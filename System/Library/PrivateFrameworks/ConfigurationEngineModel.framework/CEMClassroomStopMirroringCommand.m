...
{
  return (NSString *)CFSTR("com.apple.command.classroom.mirroring.stop");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.classroom.mirroring.stop"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMClassroomStopMirroringCommand allowedPayloadKeys](CEMClassroomStopMirroringCommand, "allowedPayloadKeys");
