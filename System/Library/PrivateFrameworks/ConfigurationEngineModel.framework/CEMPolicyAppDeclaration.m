...
{
  return (NSString *)CFSTR("com.apple.configuration.policy.application");
}
...
+ (id)buildWithIdentifier:(id)a3 withMode:(id)a4 withApps:(id)a5
{
  ...
  objc_msgSend(v10, "setDeclarationType:", CFSTR("com.apple.configuration.policy.application"));
  if (v7)
  {
  ...
  objc_msgSend(v10, "setPayloadApps:", v8);
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3 withMode:(id)a4
{
  ...
  objc_msgSend(v7, "setDeclarationType:", CFSTR("com.apple.configuration.policy.application"));
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPolicyAppDeclaration allowedPayloadKeys](CEMPolicyAppDeclaration, "allowedPayloadKeys");
  ...
  v20 = 0;
  -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v6, CFSTR("Mode"), 1, 0, &v20);
  ...
  {
    v19 = 0;
    -[CEMPayloadBase loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:](self, "loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:", v6, CFSTR("Apps"), &__block_literal_global_28, 0, 0, &v19);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  -[CEMPayloadBase serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:](self, "serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:", v4, CFSTR("Apps"), self->_payloadApps, &__block_literal_global_27_0, 0, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSArray copy](self->_payloadApps, "copy");
  v8 = (void *)v4[10];
  v4[10] = v7;
