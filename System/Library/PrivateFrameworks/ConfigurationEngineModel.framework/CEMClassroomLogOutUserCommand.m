...
{
  return (NSString *)CFSTR("com.apple.command.classroom.user.logout");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.classroom.user.logout"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMClassroomLogOutUserCommand allowedPayloadKeys](CEMClassroomLogOutUserCommand, "allowedPayloadKeys");
