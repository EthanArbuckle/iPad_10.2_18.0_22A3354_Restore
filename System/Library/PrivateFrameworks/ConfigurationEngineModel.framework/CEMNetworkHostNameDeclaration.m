...
{
  return (NSString *)CFSTR("com.apple.configuration.network.hostname");
}
...
+ (id)buildWithIdentifier:(id)a3 withName:(id)a4
{
  ...
  objc_msgSend(v7, "setDeclarationType:", CFSTR("com.apple.configuration.network.hostname"));
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetworkHostNameDeclaration allowedPayloadKeys](CEMNetworkHostNameDeclaration, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v7, CFSTR("Name"), 1, 0, &v17);
