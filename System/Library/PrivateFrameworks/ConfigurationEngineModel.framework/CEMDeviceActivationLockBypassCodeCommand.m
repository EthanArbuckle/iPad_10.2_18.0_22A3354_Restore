...
{
  return (NSString *)CFSTR("com.apple.command.device.activationlock.bypasscode");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.device.activationlock.bypasscode"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMDeviceActivationLockBypassCodeCommand allowedPayloadKeys](CEMDeviceActivationLockBypassCodeCommand, "allowedPayloadKeys");
