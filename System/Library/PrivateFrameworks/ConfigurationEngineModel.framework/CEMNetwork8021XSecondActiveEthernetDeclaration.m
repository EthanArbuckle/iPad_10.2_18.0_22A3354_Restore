...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.secondactiveethernet");
}

+ (id)profileType
{
  return CFSTR("com.apple.secondactiveethernet.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.secondactiveethernet"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XSecondActiveEthernetDeclaration allowedPayloadKeys](CEMNetwork8021XSecondActiveEthernetDeclaration, "allowedPayloadKeys");
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v13; ++i)
      {
        ...
        if (objc_msgSend(v8, "containsObject:", v16, (_QWORD)v21))
        {
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        -[NSDictionary objectForKeyedSubscript:](self->_payloadANY, "objectForKeyedSubscript:", v10, (_QWORD)v14);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[NSDictionary copy](self->_payloadANY, "copy");
  v6 = (void *)v4[9];
  v4[9] = v5;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_payloadANY, 0);
}
