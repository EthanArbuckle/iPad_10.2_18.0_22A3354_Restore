...
{
  return (NSString *)CFSTR("com.apple.command.application.extensions.mappings");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.application.extensions.mappings"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNSExtensionsMappingsNSExtensionsCommand allowedPayloadKeys](CEMNSExtensionsMappingsNSExtensionsCommand, "allowedPayloadKeys");
