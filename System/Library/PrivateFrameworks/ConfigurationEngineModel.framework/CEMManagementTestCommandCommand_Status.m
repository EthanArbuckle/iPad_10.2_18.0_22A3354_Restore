...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMManagementTestCommandCommand_Status allowedStatusKeys](CEMManagementTestCommandCommand_Status, "allowedStatusKeys");
...
- (id)serializePayload
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[CEMPayloadBase serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:", v3, CFSTR("Echo"), self->_statusEcho, 1, 0);
