...
{
  return (NSString *)CFSTR("com.apple.command.management.state");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.management.state"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMManagementStateCommand allowedPayloadKeys](CEMManagementStateCommand, "allowedPayloadKeys");
