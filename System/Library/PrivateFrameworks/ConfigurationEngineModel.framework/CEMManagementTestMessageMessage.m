...
{
  return (NSString *)CFSTR("com.apple.message.management.test");
}
...
+ (id)buildWithEcho:(id)a3
{
  ...
  objc_msgSend(v4, "setPayloadEcho:", v3);
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMManagementTestMessageMessage allowedPayloadKeys](CEMManagementTestMessageMessage, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v7, CFSTR("Echo"), 1, 0, &v17);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[CEMMessageBase copyWithZone:](&v8, sel_copyWithZone_, a3);
