...
{
  return (NSString *)CFSTR("com.apple.command.device.lostmode.playsound");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.device.lostmode.playsound"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMDevicePlayLostModeSoundCommand allowedPayloadKeys](CEMDevicePlayLostModeSoundCommand, "allowedPayloadKeys");
