...
+ (NSSet)allowedReasons
{
  ...
  v6[0] = CFSTR("MissingUser");
  v6[1] = CFSTR("LoggedInUser");
  v6[2] = CFSTR("PendingDataSync");
  v6[3] = CFSTR("CannotDelete");
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMClassroomDeleteUserCommand_Status allowedStatusKeys](CEMClassroomDeleteUserCommand_Status, "allowedStatusKeys");
