...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMUserNameAndPasswordCredentialsDeclaration allowedPayloadKeys](CEMUserNameAndPasswordCredentialsDeclaration, "allowedPayloadKeys");
  ...
  {
    v19 = 0;
    -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v6, CFSTR("Password"), 1, 0, &v19);
...
- (id)serializePayload
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[CEMPayloadBase serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:", v3, CFSTR("UserName"), self->_payloadUserName, 1, 0);
  -[CEMPayloadBase serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:", v3, CFSTR("Password"), self->_payloadPassword, 1, 0);
