...
{
  return (NSString *)CFSTR("com.apple.configuration.network.vpn.appmapping");
}

+ (id)profileType
{
  return CFSTR("com.apple.vpn.managed.appmapping");
}
...
+ (id)buildWithIdentifier:(id)a3 withAppLayerVPNMapping:(id)a4
{
  ...
  objc_msgSend(v7, "setDeclarationType:", CFSTR("com.apple.configuration.network.vpn.appmapping"));
  if (v5)
  {
  ...
  objc_msgSend(v7, "setPayloadAppLayerVPNMapping:", v6);
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetworkVPNAppToAppLayerMappingDeclaration allowedPayloadKeys](CEMNetworkVPNAppToAppLayerMappingDeclaration, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadArrayFromDictionary:withKey:classType:nested:isRequired:defaultValue:error:](self, "loadArrayFromDictionary:withKey:classType:nested:isRequired:defaultValue:error:", v7, CFSTR("AppLayerVPNMapping"), objc_opt_class(), 0, 1, 0, &v17);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  v11 = v4;
  v7 = v4;
  -[CEMPayloadBase serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:](self, "serializeArrayIntoDictionary:withKey:withValue:itemSerializer:isRequired:defaultValue:", v5, CFSTR("AppLayerVPNMapping"), payloadAppLayerVPNMapping, v10, 1, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[NSArray copy](self->_payloadAppLayerVPNMapping, "copy");
  v6 = (void *)v4[9];
  v4[9] = v5;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_payloadAppLayerVPNMapping, 0);
}
