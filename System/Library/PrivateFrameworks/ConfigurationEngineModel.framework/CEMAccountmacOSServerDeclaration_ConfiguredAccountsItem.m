...
+ (id)buildWithType:(id)a3 withPort:(id)a4
{
  ...
  if (v5)
    ...
    v8 = &unk_24C69CC38;
  objc_msgSend(v7, "setPayloadPort:", v8);
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMAccountmacOSServerDeclaration_ConfiguredAccountsItem allowedPayloadKeys](CEMAccountmacOSServerDeclaration_ConfiguredAccountsItem, "allowedPayloadKeys");
  ...
  {
    v19 = 0;
    -[CEMPayloadBase loadIntegerFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadIntegerFromDictionary:withKey:isRequired:defaultValue:error:", v6, CFSTR("Port"), 0, &unk_24C69CC38, &v19);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  -[CEMPayloadBase serializeIntegerIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeIntegerIntoDictionary:withKey:withValue:isRequired:defaultValue:", v4, CFSTR("Port"), self->_payloadPort, 0, &unk_24C69CC38);
