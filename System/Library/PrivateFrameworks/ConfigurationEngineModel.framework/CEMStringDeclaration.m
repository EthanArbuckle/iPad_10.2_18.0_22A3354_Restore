...
{
  return (NSString *)CFSTR("com.apple.asset.string");
}
...
+ (id)buildWithIdentifier:(id)a3 withDescriptor:(id)a4 withData:(id)a5
{
  ...
  objc_msgSend(v10, "setDeclarationType:", CFSTR("com.apple.asset.string"));
  if (v7)
  {
  ...
  objc_msgSend(v10, "setPayloadData:", v8);
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMStringDeclaration allowedPayloadKeys](CEMStringDeclaration, "allowedPayloadKeys");
  ...
  {
    v19 = 0;
    -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v6, CFSTR("Data"), 1, 0, &v19);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  -[CEMPayloadBase serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:", v5, CFSTR("Data"), self->_payloadData, 1, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copy](self->_payloadData, "copy");
  v8 = (void *)v4[10];
  v4[10] = v7;
