...
{
  return (NSString *)CFSTR("com.apple.command.classroom.user.unlock");
}
...
+ (id)buildWithIdentifier:(id)a3 withUserName:(id)a4
{
  ...
  objc_msgSend(v7, "setCommandType:", CFSTR("com.apple.command.classroom.user.unlock"));
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMClassroomUnlockUserAccountCommand allowedPayloadKeys](CEMClassroomUnlockUserAccountCommand, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v7, CFSTR("UserName"), 1, 0, &v17);
