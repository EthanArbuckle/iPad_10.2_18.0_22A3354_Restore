...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.thirdactiveethernet");
}

+ (id)profileType
{
  return CFSTR("com.apple.thirdactiveethernet.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.thirdactiveethernet"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XThirdActiveEthernetDeclaration allowedPayloadKeys](CEMNetwork8021XThirdActiveEthernetDeclaration, "allowedPayloadKeys");
