...
{
  return (NSString *)CFSTR("com.apple.asset.book.store");
}
...
+ (id)buildWithIdentifier:(id)a3 withDescriptor:(id)a4 withITunesStoreID:(id)a5
{
  ...
  objc_msgSend(v10, "setDeclarationType:", CFSTR("com.apple.asset.book.store"));
  if (v7)
  {
  ...
  objc_msgSend(v10, "setPayloadITunesStoreID:", v8);
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMBookBookStoreDeclaration allowedPayloadKeys](CEMBookBookStoreDeclaration, "allowedPayloadKeys");
  ...
  {
    v19 = 0;
    -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v6, CFSTR("iTunesStoreID"), 1, 0, &v19);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  -[CEMPayloadBase serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:", v5, CFSTR("iTunesStoreID"), self->_payloadITunesStoreID, 1, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copy](self->_payloadITunesStoreID, "copy");
  v8 = (void *)v4[10];
  v4[10] = v7;
