...
{
  return (NSString *)CFSTR("com.apple.command.passcode.firmware.verify");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.passcode.firmware.verify"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPasscodeVerifyFirmwarePasswordCommand allowedPayloadKeys](CEMPasscodeVerifyFirmwarePasswordCommand, "allowedPayloadKeys");
