...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMActivationBasicDeclaration_StatusInstalledConfigurationsItem allowedStatusKeys](CEMActivationBasicDeclaration_StatusInstalledConfigurationsItem, "allowedStatusKeys");
