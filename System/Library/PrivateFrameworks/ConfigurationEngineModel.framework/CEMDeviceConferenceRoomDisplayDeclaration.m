...
{
  return (NSString *)CFSTR("com.apple.configuration.device.conferenceroomdisplay");
}

+ (id)profileType
{
  return CFSTR("com.apple.conferenceroomdisplay");
}
...
+ (id)buildWithIdentifier:(id)a3 withMessage:(id)a4
{
  ...
  objc_msgSend(v7, "setDeclarationType:", CFSTR("com.apple.configuration.device.conferenceroomdisplay"));
  if (v5)
  {
  ...
  objc_msgSend(v7, "setPayloadMessage:", v6);
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.device.conferenceroomdisplay"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMDeviceConferenceRoomDisplayDeclaration allowedPayloadKeys](CEMDeviceConferenceRoomDisplayDeclaration, "allowedPayloadKeys");
  ...
  v17 = 0;
  -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v7, CFSTR("Message"), 0, 0, &v17);
