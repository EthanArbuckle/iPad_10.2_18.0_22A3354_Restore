...
{
  return (NSString *)CFSTR("com.apple.command.passcode.unlocktoken");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setCommandType:", CFSTR("com.apple.command.passcode.unlocktoken"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPasscodeRequestUnlockTokenCommand allowedPayloadKeys](CEMPasscodeRequestUnlockTokenCommand, "allowedPayloadKeys");
