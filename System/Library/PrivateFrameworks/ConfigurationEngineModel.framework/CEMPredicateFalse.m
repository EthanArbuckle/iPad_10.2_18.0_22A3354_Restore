...
{
  return (NSString *)CFSTR("com.apple.predicate.false");
}
...
+ (id)build
{
  ...
  objc_msgSend(v2, "setPayloadType:", CFSTR("com.apple.predicate.false"));
  return v2;
}
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPredicateFalse allowedPayloadKeys](CEMPredicateFalse, "allowedPayloadKeys");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[CEMPredicateBase copyWithZone:](&v8, sel_copyWithZone_, a3);
