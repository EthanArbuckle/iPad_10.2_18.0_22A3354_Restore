...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMAssetBaseReference allowedPayloadKeys](CEMAssetBaseReference, "allowedPayloadKeys");
  ...
  if (!v14)
  {
    ...
    if (!v14)
    {
      ...
      if (!v14)
      {
        ...
        {
          v25 = 0;
          -[CEMPayloadBase loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:](self, "loadArrayFromDictionary:withKey:validator:isRequired:defaultValue:error:", v6, CFSTR("CertificatePinningIdentifiers"), &__block_literal_global_9, 0, 0, &v25);
