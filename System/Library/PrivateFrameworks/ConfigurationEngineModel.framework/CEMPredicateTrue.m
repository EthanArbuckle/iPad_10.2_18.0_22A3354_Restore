...
{
  return (NSString *)CFSTR("com.apple.predicate.true");
}
...
+ (id)build
{
  ...
  objc_msgSend(v2, "setPayloadType:", CFSTR("com.apple.predicate.true"));
  return v2;
}
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMPredicateTrue allowedPayloadKeys](CEMPredicateTrue, "allowedPayloadKeys");
