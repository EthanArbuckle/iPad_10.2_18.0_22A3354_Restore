...
{
  return (NSString *)CFSTR("com.apple.configuration.security.identity.preference");
}
...
+ (id)buildWithIdentifier:(id)a3 withName:(id)a4 withIdentityIdentifier:(id)a5
{
  ...
  objc_msgSend(v10, "setDeclarationType:", CFSTR("com.apple.configuration.security.identity.preference"));
  if (v7)
  {
  ...
  objc_msgSend(v10, "setPayloadIdentityIdentifier:", v8);
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMSecurityIdentityPreferenceDeclaration allowedPayloadKeys](CEMSecurityIdentityPreferenceDeclaration, "allowedPayloadKeys");
  ...
  {
    v19 = 0;
    -[CEMPayloadBase loadStringFromDictionary:withKey:isRequired:defaultValue:error:](self, "loadStringFromDictionary:withKey:isRequired:defaultValue:error:", v6, CFSTR("IdentityIdentifier"), 1, 0, &v19);
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  -[CEMPayloadBase serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:](self, "serializeStringIntoDictionary:withKey:withValue:isRequired:defaultValue:", v4, CFSTR("IdentityIdentifier"), self->_payloadIdentityIdentifier, 1, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSString copy](self->_payloadIdentityIdentifier, "copy");
  v8 = (void *)v4[10];
  v4[10] = v7;
