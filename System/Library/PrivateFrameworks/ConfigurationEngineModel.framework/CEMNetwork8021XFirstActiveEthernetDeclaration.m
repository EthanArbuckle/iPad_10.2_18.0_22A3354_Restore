...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.firstactiveethernet");
}

+ (id)profileType
{
  return CFSTR("com.apple.firstactiveethernet.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.firstactiveethernet"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XFirstActiveEthernetDeclaration allowedPayloadKeys](CEMNetwork8021XFirstActiveEthernetDeclaration, "allowedPayloadKeys");
