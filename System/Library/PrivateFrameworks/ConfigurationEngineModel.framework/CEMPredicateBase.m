...
+ (id)predicateForPayload:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("Could not match predicate type: %@"), v9);
...
- (BOOL)evaluateWithOptions:(id)a3 error:(id *)a4
{
  ...
  if (a4)
  {
    ...
    v9[0] = CFSTR("Could not evaluate predicate - need sub-class implementation");
    objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v9, &v8, 1);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "errorWithDomain:code:userInfo:", CFSTR("error"), 1, v6);
