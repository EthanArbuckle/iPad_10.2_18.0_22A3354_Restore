...
{
  return (NSString *)CFSTR("com.apple.command.application.remove");
}
...
+ (id)buildWithIdentifier:(id)a3 withBundleIdentifier:(id)a4
{
  ...
  objc_msgSend(v7, "setCommandType:", CFSTR("com.apple.command.application.remove"));
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMApplicationRemoveApplicationCommand allowedPayloadKeys](CEMApplicationRemoveApplicationCommand, "allowedPayloadKeys");
