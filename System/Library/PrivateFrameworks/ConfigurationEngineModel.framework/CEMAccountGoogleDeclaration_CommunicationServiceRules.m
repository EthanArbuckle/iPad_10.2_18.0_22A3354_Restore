...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  CEMAccountGoogleDeclaration_CommunicationServiceRulesDefaultServiceHandlers *v13;
  id v14;
  ...
  +[CEMAccountGoogleDeclaration_CommunicationServiceRules allowedPayloadKeys](CEMAccountGoogleDeclaration_CommunicationServiceRules, "allowedPayloadKeys");
  ...
  v13 = (CEMAccountGoogleDeclaration_CommunicationServiceRulesDefaultServiceHandlers *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[CEMAccountGoogleDeclaration_CommunicationServiceRulesDefaultServiceHandlers copy](self->_payloadDefaultServiceHandlers, "copy");
  v6 = (void *)v4[2];
  v4[2] = v5;
