...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.firstethernet");
}

+ (id)profileType
{
  return CFSTR("com.apple.firstethernet.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.firstethernet"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XFirstEthernetDeclaration allowedPayloadKeys](CEMNetwork8021XFirstEthernetDeclaration, "allowedPayloadKeys");
