...
{
  return (NSString *)CFSTR("com.apple.configuration.network.802.1X.secondethernet");
}

+ (id)profileType
{
  return CFSTR("com.apple.secondethernet.managed");
}
...
+ (id)buildWithIdentifier:(id)a3
{
  ...
  objc_msgSend(v4, "setDeclarationType:", CFSTR("com.apple.configuration.network.802.1X.secondethernet"));
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMNetwork8021XSecondEthernetDeclaration allowedPayloadKeys](CEMNetwork8021XSecondEthernetDeclaration, "allowedPayloadKeys");
