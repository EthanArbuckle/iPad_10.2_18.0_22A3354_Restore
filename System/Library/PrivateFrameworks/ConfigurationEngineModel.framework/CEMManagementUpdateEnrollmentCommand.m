...
{
  return (NSString *)CFSTR("com.apple.command.management.enrollment");
}
...
+ (id)buildWithIdentifier:(id)a3 withProfile:(id)a4
{
  ...
  objc_msgSend(v7, "setCommandType:", CFSTR("com.apple.command.management.enrollment"));
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMManagementUpdateEnrollmentCommand allowedPayloadKeys](CEMManagementUpdateEnrollmentCommand, "allowedPayloadKeys");
