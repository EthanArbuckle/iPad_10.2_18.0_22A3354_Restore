...
{
  return (NSString *)CFSTR("com.apple.asset.certificate");
}
...
+ (id)buildWithIdentifier:(id)a3 withDescriptor:(id)a4 withReference:(id)a5
{
  ...
  objc_msgSend(v10, "setDeclarationType:", CFSTR("com.apple.asset.certificate"));
  if (v7)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  +[CEMCertificateDeclaration allowedPayloadKeys](CEMCertificateDeclaration, "allowedPayloadKeys");
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  v18[1] = 3221225472;
  v18[2] = __64__CEMCertificateDeclaration_serializePayloadWithAssetProviders___block_invoke;
  v18[3] = &unk_24C638560;
  v8 = v4;
  v19 = v8;
  ...
  v13 = v7;
  v14 = 3221225472;
  v15 = __64__CEMCertificateDeclaration_serializePayloadWithAssetProviders___block_invoke_2;
  v16 = &unk_24C638560;
  v17 = v8;
  v10 = v8;
