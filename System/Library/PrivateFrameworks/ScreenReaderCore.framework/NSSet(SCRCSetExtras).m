...
- (void)scrc_deepMutableCopyWithZone:()SCRCSetExtras
{
  ...
  v5 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDBCEF0], "allocWithZone:"), "initWithCapacity:", objc_msgSend(a1, "count"));
  if (v5)
  {
    v19 = 0u;
    v20 = 0u;
    ...
    if (v7)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if (!v13
            || (v14 = (void *)objc_msgSend(v11, "scrc_deepMutableCopyWithZone:", a3),
