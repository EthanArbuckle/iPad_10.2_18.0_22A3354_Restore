...
- (id)description
{
  ...
  -[NRPBSwitchRecordCollection description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NRPBSwitchRecordCollection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)records | v4[1])
      v6 = -[NSMutableArray isEqual:](records, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_records, "hash");
}
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[NRPBSwitchRecordCollection addRecords:](a1, *(void **)(*((_QWORD *)&v8 + 1) + 8 * v7++));
        }
        while (v5 != v7);
