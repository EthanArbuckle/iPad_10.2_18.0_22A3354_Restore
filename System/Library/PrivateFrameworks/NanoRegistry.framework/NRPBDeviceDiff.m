...
- (id)description
{
  ...
  -[NRPBDeviceDiff description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NRPBDeviceDiff dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  names = self->_names;
  if (names)
    objc_msgSend(v3, "setObject:forKey:", names, CFSTR("names"));
  if (-[NSMutableArray count](self->_diffs, "count"))
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_diffs, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("diffs"));
  }
  return v4;
}
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](names, "isEqual:")))
  {
    ...
    if ((unint64_t)diffs | v4[1])
      v7 = -[NSMutableArray isEqual:](diffs, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_diffs, "hash") ^ v3;
}
