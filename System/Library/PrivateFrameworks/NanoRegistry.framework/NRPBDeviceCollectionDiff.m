...
- (void)addPairingIDs:(uint64_t)a1
{
  id v3;
  void *v4;
  id v5;
...
- (id)description
{
  ...
  -[NRPBDeviceCollectionDiff description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NRPBDeviceCollectionDiff dictionaryRepresentation](self, "dictionaryRepresentation");
