...
- (id)description
{
  ...
  -[NRPBDevicePropertyDiffType description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NRPBDevicePropertyDiffType dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (diff)
  {
    -[NRPBDevicePropertyDiff dictionaryRepresentation](diff, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NRPBDevicePropertyDiff copyWithZone:](self->_diff, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
LABEL_9:
  ...
  if ((unint64_t)diff | *((_QWORD *)v4 + 2))
    v6 = -[NRPBDevicePropertyDiff isEqual:](diff, "isEqual:");
  else
    v6 = 1;
LABEL_10:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NRPBDevicePropertyDiff hash](self->_diff, "hash") ^ v2;
}
