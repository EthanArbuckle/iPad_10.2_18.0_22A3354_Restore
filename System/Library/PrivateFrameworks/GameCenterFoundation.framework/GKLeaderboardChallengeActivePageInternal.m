...
{
  if (secureCodedPropertyKeys_onceToken_321 != -1)
    dispatch_once(&secureCodedPropertyKeys_onceToken_321, &__block_literal_global_322);
  return (id)secureCodedPropertyKeys_sSecureCodedKeys_320;
}
...
void __67__GKLeaderboardChallengeActivePageInternal_secureCodedPropertyKeys__block_invoke()
{
  ...
  v4 = (void *)secureCodedPropertyKeys_sSecureCodedKeys_320;
  secureCodedPropertyKeys_sSecureCodedKeys_320 = v3;
...
{
  id v3;
  GKLeaderboardChallengeActivePageInternal *v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  objc_msgSend(v5, "_gkMapWithBlock:", &__block_literal_global_326);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[GKLeaderboardChallengeActivePageInternal setActives:](v4, "setActives:", v6);

  objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("next-url"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[GKLeaderboardChallengeActivePageInternal setNextURL:](v4, "setNextURL:", v7);
  return v4;
}
...
{
  return +[GKLeaderboardChallengeActiveInternal initWithServerFragment:](GKLeaderboardChallengeActiveInternal, "initWithServerFragment:", a2);
}
...
{
  objc_storeStrong((id *)&self->_actives, a3);
}
