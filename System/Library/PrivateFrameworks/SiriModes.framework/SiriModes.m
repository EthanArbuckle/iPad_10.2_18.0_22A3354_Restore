uint64_t MDModeGetName(uint64_t a1)
{
  ...
  if ((unint64_t)(a1 - 1) > 2)
    ...
    v1 = off_24D4720D8[a1 - 1];
  return objc_msgSend(CFSTR("MDMode"), "stringByAppendingString:", v1);
}

const __CFString *MDModeGetNameForAnalytics(uint64_t a1)
{
  if ((unint64_t)(a1 - 1) > 2)
    return CFSTR("VoiceOnly");
  else
    return off_24D4720D8[a1 - 1];
}
