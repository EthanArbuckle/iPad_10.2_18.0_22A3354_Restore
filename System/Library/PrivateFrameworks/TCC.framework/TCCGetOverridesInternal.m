@implementation TCCGetOverridesInternal

void __TCCGetOverridesInternal_block_invoke(_QWORD *a1)
{
  void *v1;
...
void __TCCGetOverridesInternal_block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (value && MEMORY[0x1A859163C](value) == MEMORY[0x1E0C812C8])
    {
...
void __TCCGetOverridesInternal_block_invoke_2_cold_2()
{
  ...
  v2[0] = 136446466;
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_2(&dword_1A364C000, v0, v1, "%{public}s: Missing or invalid overrides: %{public}@", (uint8_t *)v2);
  OUTLINED_FUNCTION_0();
}
