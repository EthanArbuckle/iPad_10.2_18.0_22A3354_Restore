@implementation TCCAccessCopyBundleIdentifiersForService
    ...
    if (value)
    {
      ...
      *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = Mutable;
      if (Mutable)
      {
        ...
        applier[2] = __TCCAccessCopyBundleIdentifiersForService_block_invoke_248;
        applier[3] = &unk_1E4A2E738;
...
void __TCCAccessCopyBundleIdentifiersForService_block_invoke(_QWORD *a1)
{
  void *v1;
...
uint64_t __TCCAccessCopyBundleIdentifiersForService_block_invoke_248(uint64_t a1, int a2, xpc_object_t xstring)
{
