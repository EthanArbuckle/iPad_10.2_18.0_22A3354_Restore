@implementation TCCAccessCopyInformationForBundleId
...
void __TCCAccessCopyInformationForBundleId_block_invoke(_QWORD *a1)
{
  void *v1;
...
void __TCCAccessCopyInformationForBundleId_block_invoke_2_cold_1(void *a1)
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0_1(&dword_1A364C000, v1, v2, "%{public}s to per-user: %{public}s", v3, v4, v5, v6, 2u);
  OUTLINED_FUNCTION_3();
}
