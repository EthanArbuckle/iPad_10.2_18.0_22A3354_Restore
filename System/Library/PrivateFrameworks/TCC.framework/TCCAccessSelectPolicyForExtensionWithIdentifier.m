@implementation TCCAccessSelectPolicyForExtensionWithIdentifier

void __TCCAccessSelectPolicyForExtensionWithIdentifier_block_invoke(_QWORD *a1)
{
  void *v1;
...
void __TCCAccessSelectPolicyForExtensionWithIdentifier_block_invoke_2(uint64_t a1, void *a2)
{
  ...
  {
    *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = xpc_dictionary_get_BOOL(a2, "result");
  }
}
