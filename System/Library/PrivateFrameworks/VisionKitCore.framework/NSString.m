...
uint64_t __44__NSString_VK__vk_uniqueWordsWithMinLength___block_invoke_94(uint64_t a1, uint64_t a2)
{
...
void __40__NSString_VK__vk_substringWithVKRange___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  void *v5;
  void *v6;
  uint64_t v7;
  ...
  objc_msgSend(v6, "vk_substringWithRange:", v7, v8);
