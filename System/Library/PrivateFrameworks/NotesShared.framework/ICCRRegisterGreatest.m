...
- (void)setContents:(id)a3
{
  ...
  v6 = -[ICCRRegisterGreatest compare:with:](self, "compare:with:", v5, v4);

  if (v6 == -1)
  {
    v7.receiver = self;
    v7.super_class = (Class)ICCRRegisterGreatest;
    -[ICCRRegisterLatest setContents:](&v7, sel_setContents_, v4);
  }
...
- (void)mergeWith:(id)a3
{
  ...
  -[ICCRRegisterGreatest mergeWithRegisterGreatest:](self, "mergeWithRegisterGreatest:", v5);
...
- (void)mergeWithRegisterGreatest:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[ICCRRegisterGreatest compare:with:](self, "compare:with:", v4, v5);

  if (v6 == -1)
  {
    objc_msgSend(v9, "contents");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[ICCRRegisterLatest _setContents:](self, "_setContents:", v7);
