...
+ (void)registerCRClasses
{
  ...
  if (!sTypeSet)
  {
    ...
    objc_msgSend(a1, "_registerClass:forType:cluster:", objc_opt_class(), CFSTR("com.apple.CRDT.CRTuple"), 0);
    ...
    objc_msgSend(a1, "_registerClass:forType:cluster:", objc_opt_class(), CFSTR("com.apple.CRDT.CRTree"), 0);
    objc_msgSend(a1, "_registerClass:forType:cluster:", objc_opt_class(), CFSTR("com.apple.CRDT.CRTreeNode"), 0);
    objc_msgSend(a1, "_registerClass:forType:cluster:", objc_opt_class(), CFSTR("com.apple.CRDT.NSData"), 1);
    objc_msgSend(a1, "_registerClass:forType:cluster:", objc_opt_class(), CFSTR("com.apple.CRDT.NSDate"), 1);
  }
}
  ...
  if (v6)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        -[ICCRCoder typeToClassDict](self, "typeToClassDict", v16);
