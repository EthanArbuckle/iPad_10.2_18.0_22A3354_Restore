...
- (unint64_t)count
{
  ...
  -[ICCRDictionary contents](self, "contents");
...
- (ICCRDictionary)initWithDocument:(id)a3
{
  ...
  v5 = -[ICCRDictionary init](&v9, sel_init);
  if (v5)
  {
...
- (void)walkGraph:(id)a3
{
  ...
  v15 = 0u;
  v16 = 0u;
  -[ICCRDictionary contents](self, "contents", 0);
...
- (ICCRDictionary)init
{
  ...
  v2 = -[ICCRDictionary init](&v6, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x1E0CB3748], "strongToStrongObjectsMapTable");
...
- (void)encodeWithICCRCoder:(id)a3
{
  ...
  -[ICCRDictionary encodeWithICCRCoder:dictionary:](self, "encodeWithICCRCoder:dictionary:", v7, v6);

}

- (void)encodeWithICCRCoder:(id)a3 dictionary:(void *)a4
{
  -[ICCRDictionary encodeWithICCRCoder:dictionary:elementValueCoder:](self, "encodeWithICCRCoder:dictionary:elementValueCoder:", a3, a4, &__block_literal_global_35);
}
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        -[ICCRDictionary contents](v26, "contents");
...
- (ICCRDictionary)initWithICCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 6)
  {
    v6 = -[ICCRDictionary initWithICCRCoder:dictionary:](self, "initWithICCRCoder:dictionary:", v4, *(_QWORD *)(v5 + 40));
  }
  else
  {
    objc_msgSend(v4, "document");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = -[ICCRDictionary initWithDocument:](self, "initWithDocument:", v7);
...
{
  return -[ICCRDictionary initWithICCRCoder:dictionary:elementValueDecoder:](self, "initWithICCRCoder:dictionary:elementValueDecoder:", a3, a4, &__block_literal_global_86);
}
...
- (ICCRDictionary)initWithICCRCoder:(id)a3 dictionary:(const void *)a4 elementValueDecoder:(id)a5
{
  ...
  id v16;
  void *v17;
  ICCRVectorTimestamp *v18;
  ICCRVectorTimestamp *v19;
  ICCRVectorTimestamp *v20;
  uint64_t v21;
  ICCRDictionaryElement *v22;
  id v23;
  _QWORD v25[4];
  id v26;
  ICCRDictionary *v27;
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = -[ICCRDictionary initWithDocument:](self, "initWithDocument:", v10);
    ...
    if (*((_DWORD *)a4 + 12))
    {
      for (i = (uint64_t *)*((_QWORD *)a4 + 5); i != (uint64_t *)(*((_QWORD *)a4 + 5) + 8 * *((int *)a4 + 12)); ++i)
      {
        ...
        if ((*(_BYTE *)(v14 + 32) & 4) != 0)
        {
          ...
          v18 = -[ICCRVectorTimestamp initWithProtobufTimestamp:decoder:](v20, "initWithProtobufTimestamp:decoder:", v21, v8);
          if (!v17)
            goto LABEL_11;
        }
        else
        ...
        v22 = -[ICCRDictionaryElement initWithValue:timestamp:]([ICCRDictionaryElement alloc], "initWithValue:timestamp:", v15, v18);
...
- (void)setObject:(id)a3 forKey:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v9)
    {
      v10 = (ICCRDictionaryElement *)os_log_create("com.apple.notes", "Topotext");
      if (os_log_type_enabled(&v10->super, OS_LOG_TYPE_DEBUG))
        -[ICCRDictionary setObject:forKey:].cold.1(&v10->super);
    }
    else
    {
      v10 = -[ICCRDictionaryElement initWithValue:]([ICCRDictionaryElement alloc], "initWithValue:", v6);
      -[ICCRDictionary document](self, "document");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = objc_msgSend(v11, "replicaClock");

      -[ICCRDictionaryElement timestamp](v10, "timestamp");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    -[ICCRDictionary removeObjectForKey:](self, "removeObjectForKey:", v7);
  }
...
{
  -[ICCRDictionary objectForKey:](self, "objectForKey:", a3);
...
- (void)removeObjectForKey:(id)a3
{
  ...
  -[ICCRDictionary document](self, "document");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[ICCRDictionary setRemoveClock:](self, "setRemoveClock:", objc_msgSend(v5, "replicaClock") + 1);
...
- (void)removeAllObjects
{
  ...
  -[ICCRDictionary setRemoveClock:](self, "setRemoveClock:", objc_msgSend(v4, "replicaClock") + 1);
...
- (void)realizeLocalChangesIn:(id)a3
{
  ...
  if (-[ICCRDictionary removeClock](self, "removeClock") >= 1)
  {
    v20 = objc_msgSend(v4, "unserializedReplicaClock");
    v21 = -[ICCRDictionary removeClock](self, "removeClock");
    if (v20 <= v21)
      v22 = v21;
    else
      v22 = v20;
  ...
  -[ICCRDictionary setRemoveClock:](self, "setRemoveClock:", 0);
...
- (void)mergeWith:(id)a3
{
  ...
  -[ICCRDictionary mergeWithDictionary:](self, "mergeWithDictionary:", v5);
...
- (id)deltaSince:(id)a3 in:(id)a4
{
  ...
  v5 = a3;
  v21 = a4;
  v20 = -[ICCRDictionary initWithDocument:]([ICCRDictionary alloc], "initWithDocument:", v21);
  v25 = 0u;
  v26 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v13, "minusVectorTimestamp:", v5);
        objc_msgSend(v11, "value");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v14, "deltaSince:in:", v5, v21);
        v15 = (void *)objc_claimAutoreleasedReturnValue();

        v16 = objc_alloc_init(ICCRDictionaryElement);
        -[ICCRDictionaryElement setValue:](v16, "setValue:", v15);
        -[ICCRDictionaryElement setTimestamp:](v16, "setTimestamp:", v13);
        -[ICCRDictionary contents](v20, "contents");
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "setObject:forKey:", v16, v9);
...
- (NSString)description
{
  ...
  if (-[ICCRDictionary count](self, "count"))
  {
...
- (void)setObject:(os_log_t)log forKey:.cold.1(os_log_t log)
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_debug_impl(&dword_1BD918000, log, OS_LOG_TYPE_DEBUG, "Setting value for an existing key has no effect in a ICCRDictionary.", v1, 2u);
}
