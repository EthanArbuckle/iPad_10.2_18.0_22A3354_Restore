...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[ICTTVectorMultiTimestamp initWithCapacity:](+[ICTTVectorMultiTimestamp allocWithZone:](ICTTVectorMultiTimestamp, "allocWithZone:", a3), "initWithCapacity:", -[NSArray count](self->_timestamps, "count"));
  -[ICTTVectorMultiTimestamp mergeWithTimestamp:](v4, "mergeWithTimestamp:", self);
  return v4;
}
...
- (ICTTVectorMultiTimestamp)initWithCapacity:(unint64_t)a3
{
  ...
  NSArray *timestamps;
  uint64_t v7;
  ICTTVectorTimestamp *v8;
  objc_super v10;

  v10.receiver = self;
  v10.super_class = (Class)ICTTVectorMultiTimestamp;
  v4 = -[ICTTVectorMultiTimestamp init](&v10, sel_init);
  if (v4)
  {
...
- (ICTTVectorMultiTimestamp)initWithArchive:(const void *)a3 andCapacity:(unint64_t)a4
{
  ...
  uint64_t v30;
  NSObject *v31;
  ICTTVectorMultiTimestamp *v32;

  v6 = -[ICTTVectorMultiTimestamp initWithCapacity:](self, "initWithCapacity:", a4);
  v7 = v6;
  if (!v6)
  {
LABEL_29:
  ...
  if (v8)
  {
    ...
    while (1)
    {
      ...
      if (*((char *)v17 + 23) < 0)
        v17 = (uint64_t *)*v17;
      v18 = (os_log_t)objc_msgSend(v16, "initWithUUIDBytes:", v17);
      v19 = *(unsigned int *)(v13 + 56);
      if (v19 != a4)
      {
        v31 = os_log_create("com.apple.notes", "Topotext");
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
          -[ICTTVectorMultiTimestamp(ICTTVectorTimestampPersistenceAdditions) initWithArchive:andCapacity:].cold.2(v19, a4, v31);
      ...
      if ((_DWORD)v19)
      {
        ...
        do
        {
          ...
          if ((*(_BYTE *)(google::protobuf::internal::RepeatedPtrFieldBase::Get<google::protobuf::RepeatedPtrField<topotext::VectorTimestamp_Clock_ReplicaClock>::TypeHandler>(v21, v20)+ 32) & 2) != 0)v23 = *(unsigned int *)(google::protobuf::internal::RepeatedPtrFieldBase::Get<google::protobuf::RepeatedPtrField<topotext::VectorTimestamp_Clock_ReplicaClock>::TypeHandler>(v21, v20)+ 44);
            ...
            v23 = 0;
          -[ICTTVectorMultiTimestamp setClock:subclock:forUUID:atIndex:](v7, "setClock:subclock:forUUID:atIndex:", v22, v23, v18, v20++);
        }
        while (a4 != v20);
      }
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      -[ICTTVectorMultiTimestamp(ICTTVectorTimestampPersistenceAdditions) initWithArchive:andCapacity:].cold.1(v18, v24, v25, v26, v27, v28, v29, v30);
LABEL_28:
...
- (ICTTVectorMultiTimestamp)initWithTimestamps:(id)a3
{
  ...
  v5 = -[ICTTVectorMultiTimestamp init](&v9, sel_init);
  if (v5)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = a3;
  objc_opt_class();
  v5 = (objc_opt_isKindOfClass() & 1) != 0 && -[ICTTVectorMultiTimestamp compareTo:](self, "compareTo:", v4) == 0;
...
- (ICTTVectorMultiTimestamp)initWithData:(id)a3 andCapacity:(unint64_t)a4
{
  ...
  {
    self = -[ICTTVectorMultiTimestamp initWithArchive:andCapacity:](self, "initWithArchive:andCapacity:", v20, a4);
    v10 = self;
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      -[ICTTVectorMultiTimestamp(ICTTVectorTimestampPersistenceAdditions) initWithData:andCapacity:].cold.1(v11, v12, v13, v14, v15, v16, v17, v18);
...
- (void)saveToArchive:(void *)a3
{
  ...
  v33 = 0u;
  v34 = 0u;
  -[ICTTVectorMultiTimestamp sortedUUIDs](self, "sortedUUIDs");
      ...
      for (i = 0; i != v30; ++i)
      {
        ...
        *((_DWORD *)v11 + 8) |= 1u;
        ...
        if (v16)
        {
          for (j = 0; j != v16; ++j)
          {
            -[ICTTVectorMultiTimestamp clockElementForUUID:atIndex:](self, "clockElementForUUID:atIndex:", v7, j);
            ...
            {
              v25 = ICTTBoundedCheckedCastNSUIntegerToUInt32(objc_msgSend(v18, "clock"));
              *((_DWORD *)v22 + 8) |= 1u;
              *((_DWORD *)v22 + 10) = v25;
            }
            if (objc_msgSend(v18, "subclock"))
            {
              v26 = ICTTBoundedCheckedCastNSUIntegerToUInt32(objc_msgSend(v18, "subclock"));
              *((_DWORD *)v22 + 8) |= 2u;
              *((_DWORD *)v22 + 11) = v26;
            }
