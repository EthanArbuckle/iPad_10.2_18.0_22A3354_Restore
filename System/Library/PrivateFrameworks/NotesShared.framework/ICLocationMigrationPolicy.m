...
- (BOOL)createDestinationInstancesForSourceInstance:(id)a3 entityMapping:(id)a4 manager:(id)a5 error:(id *)a6
{
  ...
  if (v13)
  {
    ...
    objc_msgSend(v10, "valueForKey:", CFSTR("placemark"));
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    if (v18)
    {
      v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB36F8]), "initRequiringSecureCoding:", 1);
      objc_msgSend(v19, "encodeObject:forKey:", v18, CFSTR("placemark"));
      objc_msgSend(v19, "encodedData");
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v17, "setValue:forKey:", v20, CFSTR("placemarkData"));
