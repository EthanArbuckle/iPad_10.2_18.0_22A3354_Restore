...
{
  ICTTMergeableStringUndoGroup *v2;
  uint64_t v3;
  ...
  v2 = -[ICTTMergeableStringUndoGroup init](&v8, sel_init);
  if (v2)
  {
...
- (void)closeGroup
{
  -[ICTTMergeableStringUndoGroup setSeen:](self, "setSeen:", 0);
}
...
- (void)addCommand:(id)a3
{
  ...
  {
    -[ICTTMergeableStringUndoGroup commands](self, "commands");
...
- (BOOL)addSeenRange:(TopoIDRange *)a3
{
  ...
  clock = a3->var0.clock;
  var1 = a3->var1;
  -[ICTTMergeableStringUndoGroup seen](self, "seen");
  ...
  if (v9)
  {
    if ((objc_msgSend(v9, "containsIndexesInRange:", clock, var1) & 1) != 0)
    {
      v10 = 0;
    }
    else
  ...
  {
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3788]), "initWithIndexesInRange:", clock, var1);
    -[ICTTMergeableStringUndoGroup seen](self, "seen");
...
- (BOOL)hasTopoIDsThatCanChange
{
  ...
  v9 = 0u;
  v10 = 0u;
  -[ICTTMergeableStringUndoGroup commands](self, "commands", 0);
...
- (NSString)description
{
  ...
  -[ICTTMergeableStringUndoGroup commands](self, "commands");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<ICTTMergeableStringUndoGroup %p %@>"), self, v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
