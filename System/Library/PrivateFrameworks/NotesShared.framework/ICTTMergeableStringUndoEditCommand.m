...
{
  ICTTMergeableStringUndoEditCommand *v2;
  _QWORD *v3;
  _QWORD *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)ICTTMergeableStringUndoEditCommand;
  v2 = -[ICTTMergeableStringUndoEditCommand init](&v6, sel_init);
  if (v2)
  {
...
- (void)dealloc
{
  ...
  if (deleteRanges)
  {
    ...
    MEMORY[0x1C3B7A848](deleteRanges, 0x20C40960023A9);
  }
  ...
  if (insertStrings)
  {
    ...
    MEMORY[0x1C3B7A848](insertStrings, 0x20C40960023A9);
  }
  v5.receiver = self;
  v5.super_class = (Class)ICTTMergeableStringUndoEditCommand;
  -[ICTTMergeableStringUndoEditCommand dealloc](&v5, sel_dealloc);
}
...
- (void)updateTopoIDRange:(TopoIDRange *)a3 toNewRangeID:(TopoIDRange *)a4
{
  ...
  v13 = a4->var0.clock;
  v14 = v11;
  -[ICTTMergeableStringUndoEditCommand updateInsertTopoIDRange:toNewRangeID:](self, "updateInsertTopoIDRange:toNewRangeID:", &v15, &v12);
  v21 = (void **)&v18;
...
- (void)updateInsertTopoIDRange:(TopoIDRange *)a3 toNewRangeID:(TopoIDRange *)a4
{
  ...
  while (v7 != v8)
  {
    if ((objc_msgSend(*(id *)v7, "isEqual:", a3->var0.replicaID) & 1) != 0)
    {
      v9 = *(_DWORD *)(v7 + 8);
      clock = a3->var0.clock;
      if (v9 >= clock && (v9 != clock || objc_msgSend(*(id *)v7, "TTCompare:", a3->var0.replicaID) != -1))
      {
        v11 = a3->var0.replicaID;
        v12 = (void *)(a3->var1 + a3->var0.clock);
        v14[0] = v11;
        v14[1] = v12;
...
- (BOOL)addToGroup:(id)a3
{
  ...
  v4 = a3;
  v5 = -[ICTTMergeableStringUndoEditCommand deleteRanges](self, "deleteRanges");
  v6 = *v5;
  v7 = v5[1];
  while (v6 != v7)
  {
...
- (NSString)description
{
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR("<ICTTMergeableStringUndoEditCommand %p Delete:"), self);
  deleteRanges = (uint64_t *)self->_deleteRanges;
  v5 = *deleteRanges;
  v6 = deleteRanges[1];
  if (*deleteRanges != v6)
