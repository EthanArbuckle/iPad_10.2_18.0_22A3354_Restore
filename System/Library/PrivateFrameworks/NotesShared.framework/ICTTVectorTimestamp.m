...
- (ICTTVectorTimestamp)init
{
  ...
  v2 = -[ICTTVectorTimestamp init](&v6, sel_init);
  if (v2)
  {
...
- (unint64_t)compareTo:(id)a3
{
  ...
  -[ICTTVectorTimestamp allUUIDs](self, "allUUIDs");
  ...
  while (2)
  {
    for (i = 0; i != v11; ++i)
    {
      ...
      -[ICTTVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", v16);
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        -[ICTTVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", v9);
        ...
        -[ICTTVectorTimestamp setClock:subclock:forUUID:](self, "setClock:subclock:forUUID:", objc_msgSend(v13, "clock"), objc_msgSend(v13, "subclock"), v9);
...
{
  id v8;
  ICTTVectorTimestampElement *v9;

  v8 = a5;
  v9 = objc_alloc_init(ICTTVectorTimestampElement);
  -[ICTTVectorTimestampElement setClock:](v9, "setClock:", a3);
  -[ICTTVectorTimestampElement setSubclock:](v9, "setSubclock:", a4);
...
{
  ICTTVectorTimestamp *v4;

  v4 = -[ICTTVectorTimestamp init](+[ICTTVectorTimestamp allocWithZone:](ICTTVectorTimestamp, "allocWithZone:", a3), "init");
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = a3;
  objc_opt_class();
  v5 = (objc_opt_isKindOfClass() & 1) != 0 && -[ICTTVectorTimestamp compareTo:](self, "compareTo:", v4) == 0;
...
- (void)setClock:(unint64_t)a3 forUUID:(id)a4
{
  NSMutableDictionary *clock;
  id v7;
  ICTTVectorTimestampElement *v8;
  ICTTVectorTimestampElement *v9;

  clock = self->_clock;
  v7 = a4;
  -[NSMutableDictionary objectForKeyedSubscript:](clock, "objectForKeyedSubscript:", v7);
  v8 = (ICTTVectorTimestampElement *)objc_claimAutoreleasedReturnValue();
  if (!v8)
    v8 = objc_alloc_init(ICTTVectorTimestampElement);
  v9 = v8;
  -[ICTTVectorTimestampElement setClock:](v8, "setClock:", a3);
...
- (void)incrementClockForUUID:(id)a3
{
  ...
  v4 = a3;
  -[ICTTVectorTimestamp setClock:forUUID:](self, "setClock:forUUID:", -[ICTTVectorTimestamp clockForUUID:](self, "clockForUUID:", v4) + 1, v4);
...
- (id)description
{
  ...
  v14 = 0u;
  v15 = 0u;
  -[ICTTVectorTimestamp sortedUUIDs](self, "sortedUUIDs");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        -[ICTTVectorTimestamp clockElementForUUID:](self, "clockElementForUUID:", v11);
...
- (ICTTVectorTimestamp)initWithData:(id)a3
{
  ...
  void *v6;
  ICTTVectorTimestamp *v7;

  v4 = a3;
  v5 = -[ICTTVectorMultiTimestamp initWithData:andCapacity:]([ICTTVectorMultiTimestamp alloc], "initWithData:andCapacity:", v4, 1);
  -[ICTTVectorMultiTimestamp timestamps](v5, "timestamps");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "objectAtIndexedSubscript:", 0);
  v7 = (ICTTVectorTimestamp *)objc_claimAutoreleasedReturnValue();
...
- (ICTTVectorTimestamp)initWithArchive:(const void *)a3
{
  ...
  void *v5;
  ICTTVectorTimestamp *v6;

  v4 = -[ICTTVectorMultiTimestamp initWithArchive:andCapacity:]([ICTTVectorMultiTimestamp alloc], "initWithArchive:andCapacity:", a3, 1);
  -[ICTTVectorMultiTimestamp timestamps](v4, "timestamps");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "objectAtIndexedSubscript:", 0);
  v6 = (ICTTVectorTimestamp *)objc_claimAutoreleasedReturnValue();
...
- (void)saveToArchive:(void *)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[ICTTVectorMultiTimestamp initWithTimestamps:](v5, "initWithTimestamps:", v6);

  -[ICTTVectorMultiTimestamp saveToArchive:](v7, "saveToArchive:", a3);
}

- (id)serialize
{
  ICTTVectorMultiTimestamp *v3;
  void *v4;
  ICTTVectorMultiTimestamp *v5;
  void *v6;
  _QWORD v8[2];
  ...
  v5 = -[ICTTVectorMultiTimestamp initWithTimestamps:](v3, "initWithTimestamps:", v4);

  -[ICTTVectorMultiTimestamp serialize](v5, "serialize");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
