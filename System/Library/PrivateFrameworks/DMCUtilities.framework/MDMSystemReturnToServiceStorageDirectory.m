@implementation MDMSystemReturnToServiceStorageDirectory
...
void __MDMSystemReturnToServiceStorageDirectory_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("Stash"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)MDMSystemReturnToServiceStorageDirectory_str;
