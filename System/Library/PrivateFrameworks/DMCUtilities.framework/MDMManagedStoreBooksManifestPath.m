@implementation MDMManagedStoreBooksManifestPath
...
void __MDMManagedStoreBooksManifestPath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("ManagedBooks.plist"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)MDMManagedStoreBooksManifestPath_str;
