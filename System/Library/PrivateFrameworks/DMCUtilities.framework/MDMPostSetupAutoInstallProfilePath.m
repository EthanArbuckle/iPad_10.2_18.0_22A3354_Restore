@implementation MDMPostSetupAutoInstallProfilePath
...
void __MDMPostSetupAutoInstallProfilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("PostSetupProfile.mobileconfig"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)MDMPostSetupAutoInstallProfilePath_str;
