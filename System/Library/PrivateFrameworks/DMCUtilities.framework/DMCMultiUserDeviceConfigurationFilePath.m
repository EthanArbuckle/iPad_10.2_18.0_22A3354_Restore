@implementation DMCMultiUserDeviceConfigurationFilePath
...
void __DMCMultiUserDeviceConfigurationFilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("MultiUserDeviceConfiguration.plist"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)DMCMultiUserDeviceConfigurationFilePath_str;
