...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  -[DMCProtocolWellKnownResponse responseServers](self, "responseServers");
  ...
  v10 = a3;
  -[DMCModelPayloadBase serializeArrayIntoDictionary:usingKey:value:itemSerializer:isRequired:defaultValue:](self, "serializeArrayIntoDictionary:usingKey:value:itemSerializer:isRequired:defaultValue:", v5, CFSTR("Servers"), v6, v9, 1, 0);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[DMCModelPayloadBase copyWithZone:](&v8, sel_copyWithZone_, a3);
