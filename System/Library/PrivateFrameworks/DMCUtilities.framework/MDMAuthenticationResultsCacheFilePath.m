@implementation MDMAuthenticationResultsCacheFilePath
...
void __MDMAuthenticationResultsCacheFilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("AuthenticationResultsCache.plist"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)MDMAuthenticationResultsCacheFilePath_str;
