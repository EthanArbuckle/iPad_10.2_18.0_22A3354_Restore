@implementation DMCSystemLostModeRequestPath
...
void __DMCSystemLostModeRequestPath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("LostModeRequest.plist"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)DMCSystemLostModeRequestPath_str;
