@implementation MDMDEPTokenSyncActivitiesFilePath
...
void __MDMDEPTokenSyncActivitiesFilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("MDMDEPTokenSyncActivities.plist"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)MDMDEPTokenSyncActivitiesFilePath_str;
