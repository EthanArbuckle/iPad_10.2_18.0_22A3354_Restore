...
void __AppleIDSSOAuthenticationBundle_block_invoke()
{
  ...
  +[DMCLazyInitializationUtilities loadNSBundleAtURL:completionBlock:](DMCLazyInitializationUtilities, "loadNSBundleAtURL:completionBlock:", v0, &__block_literal_global_109);
