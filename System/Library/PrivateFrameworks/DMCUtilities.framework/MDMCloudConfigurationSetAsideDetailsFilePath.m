@implementation MDMCloudConfigurationSetAsideDetailsFilePath
...
void __MDMCloudConfigurationSetAsideDetailsFilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("CloudConfigurationSetAsideDetails.plist"));
