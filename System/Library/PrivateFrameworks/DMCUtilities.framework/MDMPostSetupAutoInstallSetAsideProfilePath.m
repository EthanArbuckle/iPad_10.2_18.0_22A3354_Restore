@implementation MDMPostSetupAutoInstallSetAsideProfilePath
...
void __MDMPostSetupAutoInstallSetAsideProfilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("PostSetupSetAsideProfile.mobileconfig"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)MDMPostSetupAutoInstallSetAsideProfilePath_str;
