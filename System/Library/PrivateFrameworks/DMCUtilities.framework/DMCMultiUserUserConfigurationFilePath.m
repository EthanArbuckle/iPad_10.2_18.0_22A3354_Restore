@implementation DMCMultiUserUserConfigurationFilePath
...
void __DMCMultiUserUserConfigurationFilePath_block_invoke()
{
  ...
  objc_msgSend(v0, "stringByAppendingPathComponent:", CFSTR("MultiUserUserConfiguration.plist"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  v1 = objc_msgSend(v3, "copy");
  v2 = (void *)DMCMultiUserUserConfigurationFilePath_str;
