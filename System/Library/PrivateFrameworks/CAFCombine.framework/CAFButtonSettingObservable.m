...
{
  _TtC10CAFCombine26CAFButtonSettingObservable *v2;
  uint64_t v3;
  uint64_t v4;
  uint64_t v5;
  void *v6;
...
{
  CAFButtonSettingObservable.init()();
}

- (void)automakerSettingService:(id)a3 didUpdateUserVisibleLabel:(id)a4
{
  @objc CAFMultipleSelectImageSettingObservable.automakerSettingService(_:didUpdateUserVisibleLabel:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFButtonSettingObservable.automakerSettingService(_:didUpdateUserVisibleLabel:));
}

- (void)automakerSettingService:(id)a3 didUpdateSectionIdentifier:(id)a4
{
  @objc CAFButtonSettingObservable.automakerSettingService(_:didUpdateSectionIdentifier:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFButtonSettingObservable.automakerSettingService(_:didUpdateSectionIdentifier:));
}

- (void)automakerSettingService:(id)a3 didUpdateSortOrder:(unsigned __int8)a4
{
  id v5;
  _TtC10CAFCombine26CAFButtonSettingObservable *v6;
...
{
  @objc CAFMultipleSelectImageSettingObservable.automakerSettingService(_:didUpdateUserVisibleLabel:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFButtonSettingObservable.automakerSettingService(_:didUpdateIdentifier:));
}
...
{
  @objc CAFButtonSettingObservable.automakerSettingService(_:didUpdateSectionIdentifier:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFButtonSettingObservable.automakerSettingService(_:didUpdateVehicleLayoutKey:));
}

- (void)automakerSettingService:(id)a3 didUpdateSymbolName:(id)a4
{
  @objc CAFButtonSettingObservable.automakerSettingService(_:didUpdateSectionIdentifier:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFButtonSettingObservable.automakerSettingService(_:didUpdateSymbolName:));
}
...
- (void)automakerSettingService:(id)a3 didUpdateProminenceInfo:(id)a4
{
  id v6;
  id v7;
  _TtC10CAFCombine26CAFButtonSettingObservable *v8;
...
{
  @objc CAFMultipleSelectImageSettingObservable.automakerSettingService(_:didUpdateUserVisibleLabel:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFButtonSettingObservable.buttonSettingService(_:didUpdateName:));
}
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  id v9;
  uint64_t v10;
  _TtC10CAFCombine26CAFButtonSettingObservable *v11;
...
{
  id v6;
  _TtC10CAFCombine26CAFButtonSettingObservable *v7;
...
{
  id v4;
  _TtC10CAFCombine26CAFButtonSettingObservable *v5;
