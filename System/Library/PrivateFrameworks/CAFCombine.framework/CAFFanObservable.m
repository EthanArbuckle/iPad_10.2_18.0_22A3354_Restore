...
{
  _TtC10CAFCombine16CAFFanObservable *v2;
  uint64_t v3;
  uint64_t v4;
  uint64_t v5;
  void *v6;
...
{
  CAFFanObservable.init()();
}

- (void)fanService:(id)a3 didUpdateFanLevel:(unsigned __int8)a4
{
  id v5;
  _TtC10CAFCombine16CAFFanObservable *v6;
...
{
  @objc CAFTemperatureObservable.temperatureService(_:didUpdateVehicleLayoutKey:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFFanObservable.fanService(_:didUpdateVehicleLayoutKey:));
}

- (void)fanService:(id)a3 didUpdateName:(id)a4
{
  @objc CAFTemperatureObservable.temperatureService(_:didUpdateVehicleLayoutKey:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFFanObservable.fanService(_:didUpdateName:));
}
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  id v9;
  uint64_t v10;
  _TtC10CAFCombine16CAFFanObservable *v11;
...
{
  id v6;
  _TtC10CAFCombine16CAFFanObservable *v7;
...
{
  id v4;
  _TtC10CAFCombine16CAFFanObservable *v5;
