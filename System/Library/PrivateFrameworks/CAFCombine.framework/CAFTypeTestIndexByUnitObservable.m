...
{
  _TtC10CAFCombine32CAFTypeTestIndexByUnitObservable *v2;
  uint64_t v3;
  uint64_t v4;
  uint64_t v5;
  void *v6;
...
{
  CAFTypeTestIndexByUnitObservable.init()();
}

- (void)typeTestIndexByUnitService:(id)a3 didUpdateDistanceUnitRawValue:(unsigned __int16)a4
{
  id v5;
  _TtC10CAFCombine32CAFTypeTestIndexByUnitObservable *v6;
...
{
  id v6;
  _TtC10CAFCombine32CAFTypeTestIndexByUnitObservable *v7;
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  id v9;
  uint64_t v10;
  _TtC10CAFCombine32CAFTypeTestIndexByUnitObservable *v11;
...
{
  id v4;
  _TtC10CAFCombine32CAFTypeTestIndexByUnitObservable *v5;
