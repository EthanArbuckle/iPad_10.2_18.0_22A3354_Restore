...
{
  _TtC10CAFCombine25CAFClosureStateObservable *v2;
  uint64_t v3;
  uint64_t v4;
  uint64_t v5;
  void *v6;
...
{
  CAFClosureStateObservable.init()();
}

- (void)closureStateService:(id)a3 didUpdateLatchState:(BOOL)a4
{
  id v5;
  _TtC10CAFCombine25CAFClosureStateObservable *v6;
...
{
  @objc CAFTemperatureObservable.temperatureService(_:didUpdateVehicleLayoutKey:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFClosureStateObservable.closureStateService(_:didUpdateVehicleLayoutKey:));
}

- (void)closureStateService:(id)a3 didUpdateName:(id)a4
{
  @objc CAFTemperatureObservable.temperatureService(_:didUpdateVehicleLayoutKey:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFClosureStateObservable.closureStateService(_:didUpdateName:));
}
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  id v9;
  uint64_t v10;
  _TtC10CAFCombine25CAFClosureStateObservable *v11;
...
{
  id v6;
  _TtC10CAFCombine25CAFClosureStateObservable *v7;
...
{
  id v4;
  _TtC10CAFCombine25CAFClosureStateObservable *v5;
