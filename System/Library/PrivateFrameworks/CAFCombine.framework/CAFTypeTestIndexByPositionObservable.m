...
{
  _TtC10CAFCombine36CAFTypeTestIndexByPositionObservable *v2;
  uint64_t v3;
  uint64_t v4;
  uint64_t v5;
  void *v6;
...
{
  CAFTypeTestIndexByPositionObservable.init()();
}

- (void)typeTestIndexByPositionService:(id)a3 didUpdateVehicleLayoutKey:(id)a4
{
  @objc CAFTemperatureObservable.temperatureService(_:didUpdateVehicleLayoutKey:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFTypeTestIndexByPositionObservable.typeTestIndexByPositionService(_:didUpdateVehicleLayoutKey:));
}

- (void)typeTestIndexByPositionService:(id)a3 didUpdateTestInt32:(int)a4
{
  id v5;
  _TtC10CAFCombine36CAFTypeTestIndexByPositionObservable *v6;
...
{
  @objc CAFTemperatureObservable.temperatureService(_:didUpdateVehicleLayoutKey:)(self, (uint64_t)a2, a3, (uint64_t)a4, (void (*)(void))CAFTypeTestIndexByPositionObservable.typeTestIndexByPositionService(_:didUpdateName:));
}
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  id v9;
  uint64_t v10;
  _TtC10CAFCombine36CAFTypeTestIndexByPositionObservable *v11;
...
{
  id v6;
  _TtC10CAFCombine36CAFTypeTestIndexByPositionObservable *v7;
...
{
  id v4;
  _TtC10CAFCombine36CAFTypeTestIndexByPositionObservable *v5;
