...
{
  SiriCoreZlibDataDecompressor *v2;
  SiriCoreZlibDataDecompressor *v3;
  int v4;
  int v5;
  NSObject *v6;
  SiriCoreZlibDataDecompressor *v7;
  objc_super v9;
  uint8_t buf[4];
  const char *v11;
  __int16 v12;
  ...
  v2 = -[SiriCoreZlibDataDecompressor init](&v9, sel_init);
  v3 = v2;
  if (v2
    && (v2->_inflateStream.zfree = 0,
        v2->_inflateStream.opaque = 0,
        v2->_inflateStream.zalloc = 0,
        (v4 = inflateInit_(&v2->_inflateStream, "1.2.12", 112)) != 0))
  {
    v5 = v4;
...
- (void)dealloc
{
  ...
  -[SiriCoreZlibDataDecompressor dealloc](&v3, sel_dealloc);
}
  ...
  if (v6 && dispatch_data_get_size(v6))
  {
      ...
      if (v10 == 1)
      {
        ...
        if (os_log_type_enabled((os_log_t)*MEMORY[0x24BE08FC0], OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 136315138;
          ...
          _os_log_impl(&dword_211AB2000, v11, OS_LOG_TYPE_INFO, "%s Z_STREAM_END", buf, 0xCu);
        }
      }
      goto LABEL_11;
    }
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x24BE08FC0], OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 136315650;
      ...
      v32 = 2080;
      v33 = msg;
      _os_log_error_impl(&dword_211AB2000, v14, OS_LOG_TYPE_ERROR, "%s Inflate finished with unexpected status %{public}d %s", buf, 0x1Cu);
      if (!a4)
        goto LABEL_11;
    }
    else if (!a4)
...
uint64_t __62__SiriCoreZlibDataDecompressor_decompressedDataForData_error___block_invoke(_QWORD *a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  uint64_t v6;
  NSObject *v7;
  ...
  *(_DWORD *)(a1[4] + 16) = a5;
  ...
  while (1)
  {
    ...
    *(_DWORD *)(*(_QWORD *)(a1[5] + 8) + 24) = inflate((z_streamp)(a1[4] + 8), 2);
