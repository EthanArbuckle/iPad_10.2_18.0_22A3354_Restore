...
+ (void)registerPipelineBuilder:(id)a3 forIdentifier:(id)a4
{
  ...
  if (!v40)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "builder != nil");
    ...
    _NUAssertFailHandler((uint64_t)"+[NUPipelineBuilderRegistry registerPipelineBuilder:forIdentifier:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/API/NUPipeline.m", 1190, CFSTR("Invalid parameter not satisfying: %s"), v27, v28, v29, v30, (uint64_t)"builder != nil");
  }
  if (!v5)
  {
    NUAssertLogger_4813();
    ...
    _NUAssertFailHandler((uint64_t)"+[NUPipelineBuilderRegistry registerPipelineBuilder:forIdentifier:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/API/NUPipeline.m", 1191, CFSTR("Invalid parameter not satisfying: %s"), v36, v37, v38, v39, (uint64_t)"identifier != nil");
  }
  v6 = -[_NUPipelineBuilderRenderPipeline initWithPipelineBuilder:]([_NUPipelineBuilderRenderPipeline alloc], "initWithPipelineBuilder:", v40);
  +[NURenderPipelineRegistry sharedRegistry](NURenderPipelineRegistry, "sharedRegistry");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "registerRenderPipeline:forIdentifier:", v6, v5);
...
+ (id)pipelineBuilderForIdentifier:(id)a3
{
  ...
  if (!v3)
  {
    ...
    _NUAssertFailHandler((uint64_t)"+[NUPipelineBuilderRegistry pipelineBuilderForIdentifier:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/API/NUPipeline.m", 1197, CFSTR("Invalid parameter not satisfying: %s"), v21, v22, v23, v24, (uint64_t)"identifier != nil");
  }
  v4 = v3;
  +[NURenderPipelineRegistry sharedRegistry](NURenderPipelineRegistry, "sharedRegistry");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "renderPipelineForIdentifier:", v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    objc_msgSend(v6, "pipelineBuilder");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
