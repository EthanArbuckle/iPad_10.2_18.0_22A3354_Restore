...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUCoalescer init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Util/NUCoalescer.m", 16, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v24, v25, v26, v27, v23);
}

- (NUCoalescer)initWithDelay:(double)a3
{
  return -[NUCoalescer initWithDelay:queue:](self, "initWithDelay:queue:", MEMORY[0x1E0C80D38], a3);
}
...
- (NUCoalescer)initWithDelay:(double)a3 queue:(id)a4
{
  ...
  if (a3 <= 0.0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "delay > 0.0");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543362;
      v48 = v15;
    ...
    _NUAssertFailHandler((uint64_t)"-[NUCoalescer initWithDelay:queue:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Util/NUCoalescer.m", 26, CFSTR("Invalid parameter not satisfying: %s"), v33, v34, v35, v36, (uint64_t)"delay > 0.0");
  }
  v7 = v6;
  if (!v6)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUCoalescer initWithDelay:queue:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Util/NUCoalescer.m", 27, CFSTR("Invalid parameter not satisfying: %s"), v42, v43, v44, v45, (uint64_t)"queue != nil");
  }
  v46.receiver = self;
  v46.super_class = (Class)NUCoalescer;
  v8 = -[NUCoalescer init](&v46, sel_init);
  v9 = (void *)*((_QWORD *)v8 + 3);
  *((_QWORD *)v8 + 3) = v7;
  v10 = v7;
  ...
  *((_QWORD *)v8 + 1) = v11;
  ...
  dispatch_source_set_event_handler(*((dispatch_source_t *)v8 + 1), &__block_literal_global_6960);
...
- (void)coalesceBlock:(id)a3
{
  ...
  if (!handler)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "block != nil", 0);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543362;
      v26 = v9;
    ...
    _NUAssertFailHandler((uint64_t)"-[NUCoalescer coalesceBlock:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Util/NUCoalescer.m", 47, CFSTR("Invalid parameter not satisfying: %s"), v20, v21, v22, v23, (uint64_t)"block != nil");
  }
  dispatch_suspend((dispatch_object_t)self->_timer);
  timer = self->_timer;
  -[NUCoalescer delay](self, "delay");
...
- (void)dealloc
{
  ...
  -[NUCoalescer dealloc](&v3, sel_dealloc);
}
