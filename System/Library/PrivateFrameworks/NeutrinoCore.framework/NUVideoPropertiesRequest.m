...
- (id)newRenderJob
{
  return -[NURenderJob initWithRequest:]([NUVideoPropertiesJob alloc], "initWithRequest:", self);
}
...
- (void)submit:(id)a3
{
  ...
  if (objc_msgSend(v5, "purpose") == 1)
  {
    ...
    if (os_log_type_enabled((os_log_t)_NUAssertLogger, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v8 = v6;
      objc_msgSend(v7, "stringWithFormat:", CFSTR("submitting a video properties request on a still image purpose context"));
...
LABEL_14:
    _NUAssertContinueHandler((uint64_t)"-[NUVideoPropertiesRequest submit:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUVideoPropertiesRequest.m", 44, CFSTR("submitting a video properties request on a still image purpose context"), v12, v13, v14, v15, *(uint64_t *)v26);
  }
