...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUEnumSetting init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 557, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v24, v25, v26, v27, v23);
}
...
LABEL_15:
  ...
  NSStringFromSelector(a2);
  objc_claimAutoreleasedReturnValue();
  _NUAssertFailHandler((uint64_t)"-[NUEnumSetting initWithAttributes:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 562, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v26, v27, v28, v29, v25);
}
...
- (NUEnumSetting)initWithValues:(id)a3 attributes:(id)a4
{
  ...
  if (!v6)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "values != nil");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543362;
      v31 = v14;
    ...
    _NUAssertFailHandler((uint64_t)"-[NUEnumSetting initWithValues:attributes:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 567, CFSTR("Invalid parameter not satisfying: %s"), v25, v26, v27, v28, (uint64_t)"values != nil");
  }
  v8 = v7;
  v29.receiver = self;
...
- (id)description
{
  ...
  v4 = objc_opt_class();
  -[NUEnumSetting values](self, "values");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[NUModel attributes](self, "attributes");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<%@ values:%@ attributes:%@>"), v4, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (NSString *)-[NSDictionary objectForKeyedSubscript:](self->super.super._attributes, "objectForKeyedSubscript:", CFSTR("default"));
}

- (NSString)identityValue
{
  return (NSString *)-[NSDictionary objectForKeyedSubscript:](self->super.super._attributes, "objectForKeyedSubscript:", CFSTR("identity"));
}
...
- (BOOL)validate:(id)a3 error:(id *)a4
{
  ...
  if (!v6)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUEnumSetting validate:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 593, CFSTR("Invalid parameter not satisfying: %s"), v31, v32, v33, v34, (uint64_t)"object != nil");
  }
  if (!a4)
  {
    NUAssertLogger_20294();
    ...
    _NUAssertFailHandler((uint64_t)"-[NUEnumSetting validate:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 594, CFSTR("Invalid parameter not satisfying: %s"), v40, v41, v42, v43, (uint64_t)"error != NULL");
  }
  v7 = v6;
  if (+[NUModel validateString:error:](NUModel, "validateString:error:", v6, a4))
  {
    ...
    {
      +[NUError rangeError:object:](NUError, "rangeError:object:", CFSTR("Not a possible value"), v7);
      v10 = 0;
...
- (BOOL)isValid:(id *)a3
{
  ...
  if (!a3)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUEnumSetting isValid:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 612, CFSTR("Invalid parameter not satisfying: %s"), v18, v19, v20, v21, (uint64_t)"error != NULL");
  }
  return -[NUEnumSetting validateValues:](self, "validateValues:")
      && -[NUModel validateAttributes:](self, "validateAttributes:", a3);
}
...
- (BOOL)validateValues:(id *)a3
{
  ...
  if (!a3)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUEnumSetting validateValues:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 624, CFSTR("Invalid parameter not satisfying: %s"), v26, v27, v28, v29, (uint64_t)"error != NULL");
  }
  if (-[NSArray count](self->_values, "count"))
  {
    if (+[NUModel validateStringArray:error:](NUModel, "validateStringArray:error:", self->_values, a3))
    {
      ...
      v33 = 0u;
      v6 = self->_values;
      v7 = -[NSArray countByEnumeratingWithState:objects:count:](v6, "countByEnumeratingWithState:objects:count:", &v30, v34, 16);
      if (v7)
      {
        v8 = v7;
        v9 = *(_QWORD *)v31;
        while (2)
        {
          for (i = 0; i != v8; ++i)
          {
            ...
            {
              +[NUError duplicateError:object:](NUError, "duplicateError:object:", CFSTR("Duplicate value"), v11);
              v12 = 0;
          ...
          v8 = -[NSArray countByEnumeratingWithState:objects:count:](v6, "countByEnumeratingWithState:objects:count:", &v30, v34, 16);
          if (v8)
            continue;
          break;
        }
...
LABEL_16:
  ...
  {
    +[NUError missingError:object:](NUError, "missingError:object:", CFSTR("Missing values"), self);
    v12 = 0;
    *a3 = (id)objc_claimAutoreleasedReturnValue();
  }
  return v12;
...
- (BOOL)serializeIntoDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  objc_msgSend(v6, "setObject:forKeyedSubscript:", CFSTR("enum"), CFSTR("isa"));
  objc_msgSend(v6, "setObject:forKeyedSubscript:", self->_values, CFSTR("values"));
...
+ (id)deserializeFromDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6)
  {
    ...
    _NUAssertFailHandler((uint64_t)"+[NUEnumSetting deserializeFromDictionary:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 663, CFSTR("Invalid parameter not satisfying: %s"), v34, v35, v36, v37, (uint64_t)"dictionary != nil");
  }
  if (!a4)
  {
    NUAssertLogger_20294();
    ...
    _NUAssertFailHandler((uint64_t)"+[NUEnumSetting deserializeFromDictionary:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Schema/NUSetting.m", 664, CFSTR("Invalid parameter not satisfying: %s"), v43, v44, v45, v46, (uint64_t)"error != NULL");
  }
  v7 = v6;
  ...
  if (!v8)
  {
    +[NUError missingError:object:](NUError, "missingError:object:", CFSTR("Missing values"), v7);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_9:
    v12 = 0;
    *a4 = v13;
  ...
  {
    +[NUError invalidError:object:](NUError, "invalidError:object:", CFSTR("Invalid values"), v8);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    goto LABEL_9;
  }
  v9 = v8;
  ...
  if (v10)
  {
    v12 = (void *)objc_msgSend(objc_alloc((Class)a1), "initWithValues:attributes:", v9, v10);
  }
  else
  {
    +[NUError errorWithCode:reason:object:underlyingError:](NUError, "errorWithCode:reason:object:underlyingError:", 1, CFSTR("Failed to deserialized attributes"), v7, v11);
    v12 = 0;
    *a4 = (id)objc_claimAutoreleasedReturnValue();
  }
