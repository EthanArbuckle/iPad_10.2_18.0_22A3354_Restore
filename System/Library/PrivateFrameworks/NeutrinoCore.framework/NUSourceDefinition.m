...
+ (id)imageSourceDefinitionWithURL:(id)a3 options:(id)a4
{
  ...
  void *v8;
  void *v9;
  NUImageFileSourceDefinition *v10;
  NSObject *v12;
  void *v13;
  void *specific;
  NSObject *v15;
  ...
  if (!v5)
  {
    ...
    _NUAssertFailHandler((uint64_t)"+[NUSourceDefinition imageSourceDefinitionWithURL:options:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUSource.m", 60, CFSTR("Invalid parameter not satisfying: %s"), v24, v25, v26, v27, (uint64_t)"imageURL != nil");
  }
  v7 = v6;
  ...
  v10 = -[NUFileSourceDefinition initWithURL:UTI:]([NUImageFileSourceDefinition alloc], "initWithURL:UTI:", v5, v9);
  return v10;
}
...
+ (id)videoSourceDefinitionWithURL:(id)a3 options:(id)a4
{
  ...
  void *v8;
  void *v9;
  NUVideoFileSourceDefinition *v10;
  NSObject *v12;
  void *v13;
  void *specific;
  NSObject *v15;
  ...
  if (!v5)
  {
    ...
    _NUAssertFailHandler((uint64_t)"+[NUSourceDefinition videoSourceDefinitionWithURL:options:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUSource.m", 66, CFSTR("Invalid parameter not satisfying: %s"), v24, v25, v26, v27, (uint64_t)"videoURL != nil");
  }
  v7 = v6;
  objc_msgSend(v6, "objectForKeyedSubscript:", CFSTR("ContentType"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v10 = -[NUFileSourceDefinition initWithURL:UTI:]([NUVideoFileSourceDefinition alloc], "initWithURL:UTI:", v5, v9);
  return v10;
}
...
+ (id)livePhotoSourceDefinitionWithImage:(id)a3 video:(id)a4 options:(id)a5
{
  ...
  id v9;
  void *v10;
  NULivePhotoSourceDefinition *v11;
  NSObject *v13;
  void *v14;
  void *specific;
  NSObject *v16;
  ...
  if (!v7)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "imageDefinition != nil");
    ...
    _NUAssertFailHandler((uint64_t)"+[NUSourceDefinition livePhotoSourceDefinitionWithImage:video:options:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUSource.m", 72, CFSTR("Invalid parameter not satisfying: %s"), v32, v33, v34, v35, (uint64_t)"imageDefinition != nil");
  }
  if (!v8)
  {
    NUAssertLogger_7182();
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "videoDefinition != nil");
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543362;
      v46 = v21;
    ...
    _NUAssertFailHandler((uint64_t)"+[NUSourceDefinition livePhotoSourceDefinitionWithImage:video:options:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUSource.m", 73, CFSTR("Invalid parameter not satisfying: %s"), v41, v42, v43, v44, (uint64_t)"videoDefinition != nil");
  }
  v10 = v9;
  v11 = -[NULivePhotoSourceDefinition initWithImageSourceDefinition:videoSourceDefinition:]([NULivePhotoSourceDefinition alloc], "initWithImageSourceDefinition:videoSourceDefinition:", v7, v8);
