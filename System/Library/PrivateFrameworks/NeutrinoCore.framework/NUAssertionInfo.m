...
- (id)prettyMethodName
{
  ...
  -[NUAssertionInfo functionName](self, "functionName");
  ...
  {
    v5 = -[NUAssertionInfo isClassMethod](self, "isClassMethod");
    v6 = (void *)MEMORY[0x1E0CB3940];
    NSStringFromClass(-[NUAssertionInfo objectClass](self, "objectClass"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    NSStringFromSelector(-[NUAssertionInfo selector](self, "selector"));
...
- (id)description
{
  ...
  -[NUAssertionInfo prettyMethodName](self, "prettyMethodName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[NUAssertionInfo message](self, "message");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[NUAssertionInfo currentlyExecutingJobName](self, "currentlyExecutingJobName");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<%@: %p> failure in %@: %@ %@"), v5, self, v6, v7, v8);
...
- (BOOL)isWarning
{
  return !-[NUAssertionInfo isFatal](self, "isFatal");
}
