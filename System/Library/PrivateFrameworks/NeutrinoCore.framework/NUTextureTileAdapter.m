...
- (NUTextureTileAdapter)initWithFrameRect:(id *)a3 contentRect:(id *)a4 texture:(id)a5
{
  ...
  if (!v8)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "texture != nil");
    ...
    _NUAssertFailHandler((uint64_t)"-[NUTextureTileAdapter initWithFrameRect:contentRect:texture:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Image/NUImageFactory.mm", 1077, CFSTR("Invalid parameter not satisfying: %s"), v24, v25, v26, v27, (uint64_t)"texture != nil");
  }
  v28.receiver = self;
  v28.super_class = (Class)NUTextureTileAdapter;
  v9 = -[NUTextureTileAdapter init](&v28, sel_init);
  var1 = a3->var1;
...
- (NUTextureTileAdapter)init
{
  ...
  _NUAssertFailHandler((uint64_t)"-[NUTextureTileAdapter init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Image/NUImageFactory.mm", 1086, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v17, v18, v19, v20, v16);
}

- (id)_surface
{
  return (id)-[MTLTexture iosurface](self->_texture, "iosurface");
}
...
- (BOOL)isShared
{
  ...
  -[NUTextureTileAdapter _surface](self, "_surface");
...
- (BOOL)decrementUseCount
{
  ...
  -[NUTextureTileAdapter _surface](self, "_surface");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "decrementUseCount");
  v3 = objc_msgSend(v2, "isInUse") ^ 1;
