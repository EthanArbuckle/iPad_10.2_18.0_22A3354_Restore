...
+ (id)propertyListFromComposition:(id)a3 error:(id *)a4
{
  ...
  if (!v5)
  {
    ...
    _NUAssertFailHandler((uint64_t)"+[NUAdjustmentSerialization propertyListFromComposition:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUAdjustmentSerialization.m", 16, CFSTR("Invalid parameter not satisfying: %s"), v28, v29, v30, v31, (uint64_t)"composition != nil");
  }
  if (!a4)
  {
    NUAssertLogger_5();
    ...
    _NUAssertFailHandler((uint64_t)"+[NUAdjustmentSerialization propertyListFromComposition:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUAdjustmentSerialization.m", 17, CFSTR("Invalid parameter not satisfying: %s"), v37, v38, v39, v40, (uint64_t)"error != NULL");
  }
  v6 = v5;
  +[NUSchema serializeIdentifiableItem:error:](NUSchema, "serializeIdentifiableItem:error:", v5, a4);
...
+ (id)compositionFromPropertyList:(id)a3 error:(id *)a4
{
  ...
  if (!v5)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Invalid parameter not satisfying: %s"), "plist != nil");
    ...
    _NUAssertFailHandler((uint64_t)"+[NUAdjustmentSerialization compositionFromPropertyList:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUAdjustmentSerialization.m", 24, CFSTR("Invalid parameter not satisfying: %s"), v29, v30, v31, v32, (uint64_t)"plist != nil");
  }
  if (!a4)
  {
    NUAssertLogger_5();
    ...
    _NUAssertFailHandler((uint64_t)"+[NUAdjustmentSerialization compositionFromPropertyList:error:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUAdjustmentSerialization.m", 25, CFSTR("Invalid parameter not satisfying: %s"), v38, v39, v40, v41, (uint64_t)"error != NULL");
  }
  v6 = v5;
  +[NUSchema deserializeIdentifiableItem:error:](NUSchema, "deserializeIdentifiableItem:error:", v5, a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    objc_opt_class();
