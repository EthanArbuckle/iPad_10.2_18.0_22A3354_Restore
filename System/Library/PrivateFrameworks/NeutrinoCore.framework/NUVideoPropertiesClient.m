...
- (void)submitPropertiesRequestForComposition:(id)a3 completion:(id)a4
{
  ...
  if (!v40)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUVideoPropertiesClient submitPropertiesRequestForComposition:completion:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUVideoPropertiesRequest.m", 14, CFSTR("Invalid parameter not satisfying: %s"), v27, v28, v29, v30, (uint64_t)"composition != nil");
  }
  if (!v6)
  {
    NUAssertLogger_456();
    ...
    _NUAssertFailHandler((uint64_t)"-[NUVideoPropertiesClient submitPropertiesRequestForComposition:completion:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUVideoPropertiesRequest.m", 15, CFSTR("Invalid parameter not satisfying: %s"), v36, v37, v38, v39, (uint64_t)"completionBlock != nil");
  }
  v7 = -[NURenderRequest initWithComposition:]([NUVideoPropertiesRequest alloc], "initWithComposition:", v40);
  -[NURenderRequest setName:](v7, "setName:", CFSTR("NUVideoPropertiesRequest-generic"));
