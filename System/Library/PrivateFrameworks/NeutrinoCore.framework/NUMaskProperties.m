...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUMaskProperties init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Mask/NUMaskUtilities.m", 16, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v24, v25, v26, v27, v23);
}
...
- (NUMaskProperties)initWithDensity:(double)a3 bounds:(id *)a4 size:(id)a5
{
  ...
  result = -[NUMaskProperties init](&v11, sel_init);
  result->_density = a3;
  v10 = a4->var1;
