...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUCacheNodeSourceDerivation init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/NUCacheNode.m", 991, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v24, v25, v26, v27, v23);
}

- (NUCacheNodeSourceDerivation)initWithSubsampleFactor:(int64_t)a3
{
  NUCacheNodeSourceDerivation *result;
  NSObject *v5;
  void *v6;
  void *specific;
  NSObject *v8;
  ...
  if (a3 <= 0)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUCacheNodeSourceDerivation initWithSubsampleFactor:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/NUCacheNode.m", 996, CFSTR("Invalid parameter not satisfying: %s"), v17, v18, v19, v20, (uint64_t)"subsampleFactor > 0");
  }
  v21.receiver = self;
  v21.super_class = (Class)NUCacheNodeSourceDerivation;
  result = -[NUCacheNodeSourceDerivation init](&v21, sel_init);
