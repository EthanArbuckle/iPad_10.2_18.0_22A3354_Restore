@implementation NUStyleTransferOriginalNode

- (NUStyleTransferOriginalNode)initWithInput:(id)a3 settings:(id)a4
{
  id v6;
  id v7;
  void *v8;
  void *v9;
  NUStyleTransferOriginalNode *v10;
  NSObject *v12;
  void *v13;
  void *specific;
  NSObject *v15;
  ...
  if (!v6)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUStyleTransferOriginalNode initWithInput:settings:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/NUStyleTransferNode.m", 1077, CFSTR("Invalid parameter not satisfying: %s"), v24, v25, v26, v27, (uint64_t)"input != nil");
  }
  v8 = v7;
  v29 = CFSTR("input");
  v30 = v6;
  ...
  v28.receiver = self;
  v28.super_class = (Class)NUStyleTransferOriginalNode;
  v10 = -[NURenderNode initWithSettings:inputs:](&v28, sel_initWithSettings_inputs_, v8, v9);

  return v10;
}

- (NUStyleTransferOriginalNode)initWithSettings:(id)a3 inputs:(id)a4
{
  id v6;
  id v7;
  void *v8;
...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUStyleTransferOriginalNode initWithSettings:inputs:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/NUStyleTransferNode.m", 1087, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v29, v30, v31, v32, v28);
}
...
- (id)resolvedNodeWithCachedInputs:(id)a3 settings:(id)a4 pipelineState:(id)a5 error:(id *)a6
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)NUStyleTransferOriginalNode;
...
- (id)nodeByReplayingAgainstCache:(id)a3 pipelineState:(id)a4 error:(id *)a5
{
  ...
  if (objc_msgSend(v9, "evaluationMode"))
  {
    if (objc_msgSend(v9, "auxiliaryImageType") == 1)
    {
      ...
      objc_msgSend(v10, "setAuxiliaryImageType:", 10);

      v9 = v10;
    }
    -[NUStyleTransferOriginalNode inputNode](self, "inputNode");
  ...
  {
    v14.receiver = self;
    v14.super_class = (Class)NUStyleTransferOriginalNode;
    -[NURenderNode nodeByReplayingAgainstCache:pipelineState:error:](&v14, sel_nodeByReplayingAgainstCache_pipelineState_error_, v8, v9, a5);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  }
