...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUImageExportFormat copyWithZone:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUImageExportFormat.m", 43, CFSTR("This is an abstract method! Subclass '%@' should provide concrete implementation"), v23, v24, v25, v26, v22);
}
...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUImageExportFormat fileType]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUImageExportFormat.m", 48, CFSTR("This is an abstract method! Subclass '%@' should provide concrete implementation"), v22, v23, v24, v25, v21);
}
...
LABEL_15:
  ...
  NSStringFromClass(v20);
  v21 = objc_claimAutoreleasedReturnValue();
  _NUAssertFailHandler((uint64_t)"-[NUImageExportFormat pixelFormat]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUImageExportFormat.m", 53, CFSTR("This is an abstract method! Subclass '%@' should provide concrete implementation"), v22, v23, v24, v25, v21);
}
...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUImageExportFormat addImageDestinationOptionsToImageProperties:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUImageExportFormat.m", 58, CFSTR("This is an abstract method! Subclass '%@' should provide concrete implementation"), v24, v25, v26, v27, v23);
}
...
+ (id)defaultFormatForURL:(id)a3
{
  ...
  int v8;
  __objc2_class *v9;
  NUImageExportFormatGeneric *v10;
  void *v11;
  int v12;
  void *v13;
  int v14;
  void *v15;
  int v16;
  NUImageExportFormatGeneric *v17;
  NSObject *v19;
  void *v20;
  void *specific;
  NSObject *v22;
  ...
  if (!v3)
  {
    ...
    _NUAssertFailHandler((uint64_t)"+[NUImageExportFormat defaultFormatForURL:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUImageExportFormat.m", 20, CFSTR("Invalid parameter not satisfying: %s"), v31, v32, v33, v34, (uint64_t)"fileURL != nil");
  }
  v4 = v3;
  ...
  if (objc_msgSend(v5, "length"))
  {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (!v16)
          {
            v17 = -[NUImageExportFormatGeneric initWithFileType:]([NUImageExportFormatGeneric alloc], "initWithFileType:", v6);
            goto LABEL_13;
          }
    ...
    v17 = (NUImageExportFormatGeneric *)objc_alloc_init(v9);
LABEL_13:
    v10 = v17;
