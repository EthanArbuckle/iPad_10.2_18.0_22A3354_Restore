...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUFitScalePolicy init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 81, CFSTR("Initializer not available: -[%@ %@], use designated initializer instead."), v24, v25, v26, v27, v23);
}
...
- (NUFitScalePolicy)initWithTargetPixelSize:(id)a3
{
  ...
  if (!a3.var0 || (var1 = a3.var1) == 0)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUFitScalePolicy initWithTargetPixelSize:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 91, CFSTR("Invalid parameter not satisfying: %s"), v18, v19, v20, v21, (uint64_t)"!NUPixelSizeIsEmpty(size)");
  }
  var0 = a3.var0;
  v22.receiver = self;
  v22.super_class = (Class)NUFitScalePolicy;
  result = -[NUFitScalePolicy init](&v22, sel_init);
...
- ($0AC6E346AE4835514AAA8AC86D8F4844)scaleForImageSize:(id)a3
{
  ...
  if (!a3.var0 || !a3.var1)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUFitScalePolicy scaleForImageSize:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 102, CFSTR("Invalid parameter not satisfying: %s"), v21, v22, v23, v24, (uint64_t)"!NUPixelSizeIsEmpty(imageSize)");
  }
  v3 = NUScaleToFitSizeInSize(a3.var0, a3.var1, self->_size.width, self->_size.height);
  v5 = v4;
...
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("<%@:%p> fitInSize=(%ld, %ld)"), objc_opt_class(), self, self->_size.width, self->_size.height);
}

- (NSString)description
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("{fit: %ldx%ld}"), self->_size.width, self->_size.height);
}
