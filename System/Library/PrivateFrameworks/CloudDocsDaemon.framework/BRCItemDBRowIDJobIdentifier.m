...
{
  return (NSString *)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), self->_itemDBRowID);
}

- (id)matchingJobsWhereSQLClause
{
  return (id)objc_msgSend(MEMORY[0x1E0DE81D0], "formatInjection:", CFSTR("throttle_id = %lld"), self->_itemDBRowID);
}

- (id)columns
{
  return (id)objc_msgSend(MEMORY[0x1E0DE81E0], "rawInjection:length:", "throttle_id", 11);
}

- (id)columnsValues
{
  return (id)objc_msgSend(MEMORY[0x1E0DE81D0], "formatInjection:", CFSTR("%lld"), self->_itemDBRowID);
}
