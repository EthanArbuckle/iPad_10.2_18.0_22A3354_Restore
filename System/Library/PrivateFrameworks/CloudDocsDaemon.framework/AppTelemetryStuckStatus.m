...
LABEL_27:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingReconciliationJobCode);
...
LABEL_28:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingReconciliationJobSchedulingState);
...
LABEL_29:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingReconciliationJobBlockingCode);
...
LABEL_30:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskEnumerationStatus);
...
LABEL_32:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingReconciliation);
...
LABEL_33:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenNotPendingReconciliation);
...
LABEL_34:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingSyncUpDeletion);
...
LABEL_35:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingSyncDownDeletion);
...
LABEL_36:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingSyncUpReparent);
...
LABEL_37:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingSyncUp);
...
LABEL_38:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingSyncDownReparent);
...
LABEL_39:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingSyncDown);
...
LABEL_40:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningDiskNumberOfChildrenPendingRejection);
...
LABEL_41:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningProviderEnumerationStatus);
...
LABEL_43:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningProviderNumberOfChildren);
...
LABEL_21:
    if ((*(_WORD *)&has & 0x8000) == 0)
      goto LABEL_22;
LABEL_45:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningProviderNumberOfChildrenFailingCreation);
...
LABEL_44:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningProviderNumberOfChildrenPendingCreation);
...
LABEL_22:
  ...
  {
LABEL_23:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemPendingScanningProviderRemovalOfDatalessBitStatus);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
