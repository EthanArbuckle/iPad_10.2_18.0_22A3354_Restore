...
- (uint64_t)deserializeFilename:()BRCSerializationAdditions basename:bounceno:extension:userInfo:error:
{
  ...
  if ((v15 & 1) == 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 1001, CFSTR("%@"), v47);
      v25 = 0;
      v24 = 0;
      v26 = 0;
      v18 = 0;
...
LABEL_24:
  ...
  if ((v19 & 1) != 0)
  {
    if (v18 && -[__CFString integerValue](v18, "integerValue") <= 1)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v50 = 2112;
        v51 = v39;
        _os_log_impl(&dword_1CBD43000, v40, OS_LOG_TYPE_DEFAULT, "[WARNING] The server sent a bounceNo <= 1: %@%@", buf, 0x16u);
      }

      v18 = 0;
    }
    v21 = (__CFString *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithData:encoding:", v16, 4);
    if (!v21)
    {
      brc_bread_crumbs();
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", -[__CFString br_safeFileSystemRepresentation](v21, "br_safeFileSystemRepresentation"));
    ...
    if (a3)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "br_pathWithFileSystemRepresentation:", objc_msgSend(objc_retainAutorelease(v25), "fileSystemRepresentation"));
    ...
    if (a4)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "br_pathWithFileSystemRepresentation:", objc_msgSend(objc_retainAutorelease(v24), "fileSystemRepresentation"));
    ...
    if ((v15 & 1) != 0)
    {
      ...
      if ((v18 & 1) != 0)
      {
        ...
        if ((v22 & 1) == 0)
        {
          ...
          {
            objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 1001, CFSTR("%@"), v102);
        ...
        {
          objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D10C90], 1001, v11);
...
LABEL_45:
        ...
        if ((v85 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            v107 = 2112;
            v108 = v43;
            _os_log_fault_impl(&dword_1CBD43000, v44, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Aliases parent ref zoneID %@ must be equal to aliases zoneID %@!%@", buf, 0x20u);

          }
          v89 = (void *)MEMORY[0x1E0CB35C8];
          v45 = *MEMORY[0x1E0D10C90];
          objc_msgSend(a1, "recordID");
        ...
        v41 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D10E88]), "initWithRecordZoneID:", v38);
        v83 = v41;
              ...
              if ((v71 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v74, OS_LOG_TYPE_DEFAULT))
                {
                  *(_DWORD *)buf = 138412546;
                  ...
                  v105 = 2112;
                  v106 = v73;
                  _os_log_impl(&dword_1CBD43000, v74, OS_LOG_TYPE_DEFAULT, "[WARNING] can't deserialize filename: %@%@", buf, 0x16u);
                }
...
- (BOOL)deserializeiWorkSharingOptions:()BRCSerializationAdditions error:
{
  ...
  v20 = 0;
  v8 = *MEMORY[0x1E0C94B58];
  v9 = objc_msgSend(a1, "_deserializeValue:forKey:encrypted:expectClass:allowNil:errorDescription:", &v20, *MEMORY[0x1E0C94B58], 0, objc_opt_class(), 1, &v22);
  v10 = v20;
  v11 = v10;
  if ((v9 & 1) == 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 1001, CFSTR("%@"), v22);
  ...
  if (objc_msgSend(v10, "BOOLValue"))
  {
    v21 |= 1uLL;
    v19 = 0;
    v12 = *MEMORY[0x1E0C94B50];
    v13 = objc_msgSend(a1, "_deserializeValue:forKey:encrypted:expectClass:allowNil:errorDescription:", &v19, *MEMORY[0x1E0C94B50], 0, objc_opt_class(), 0, &v22);
    v14 = v19;
    v15 = v14;
    if ((v13 & 1) != 0)
    {
...
- (uint64_t)deserializeStatInfo:()BRCSerializationAdditions serverMetrics:itemID:session:error:
{
  ...
  v18 = *MEMORY[0x1E0C94730];
  v19 = objc_msgSend(v17, "isEqualToString:", *MEMORY[0x1E0C94730]);
    ...
    else
    {
      ...
      else
      {
        ...
        if ((v32 & 1) == 0)
        {
          ...
          if (v22)
          {
            objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 1001, CFSTR("%@"), v77);
  ...
  if ((v33 & 1) == 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 1001, CFSTR("%@"), v224);
  ...
  if ((BRCIsBusyDate(objc_msgSend(v37, "longLongValue")) & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v73, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v227 = 2112;
      v228 = (uint64_t)v72;
      _os_log_impl(&dword_1CBD43000, v73, OS_LOG_TYPE_DEFAULT, "[WARNING] Ignoring Finder busy date on %@%@", buf, 0x16u);
    }
LABEL_110:
...
LABEL_115:
    ...
    {
      v79 = v103;
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D10C90], 1001, v14);
      ...
      if (v104)
      {
        ...
        if (os_log_type_enabled(v106, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 136315906;
          ...
          v231 = 2112;
          v232 = v105;
          _os_log_error_impl(&dword_1CBD43000, v106, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
        }
...
LABEL_132:
      ...
      {
        v131 = objc_alloc(MEMORY[0x1E0D10E88]);
        objc_msgSend(a1, "recordID");
...
LABEL_163:
        ...
        {
          v147 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithData:encoding:", v186, 4);
        ...
        +[BRCAccountSession userIdentityForName:db:](BRCAccountSession, "userIdentityForName:db:", v154, v159);
...
LABEL_187:
            ...
            v157 = v201;
LABEL_188:
            v169 = objc_alloc_init(MEMORY[0x1E0D10EE0]);
...
LABEL_197:
    ...
    if (os_log_type_enabled(v116, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v231 = 2112;
      v232 = v115;
      _os_log_fault_impl(&dword_1CBD43000, v116, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ parent ref zoneID %@ must be equal to record's zoneID %@!%@", buf, 0x2Au);

      v114 = v190;
    }

    v117 = (void *)MEMORY[0x1E0CB35C8];
    v118 = *MEMORY[0x1E0D10C90];
    objc_msgSend(a1, "recordID");
    ...
    if (v123)
    {
      ...
      if (os_log_type_enabled(v125, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 136315906;
        ...
        v231 = 2112;
        v232 = v124;
        _os_log_error_impl(&dword_1CBD43000, v125, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
      }
...
- (uint64_t)deserializeSymlinkTarget:()BRCSerializationAdditions error:
{
  ...
  if ((v6 & 1) == 0)
  {
    if (a4)
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 1001, CFSTR("%@"), v15);
      *a4 = (id)objc_claimAutoreleasedReturnValue();
    }
    v10 = v8;
    v8 = 0;
...
- (uint64_t)deserializeVersion:()BRCSerializationAdditions fakeStatInfo:contentBoundaryKey:clientZone:outOfBandUpload:error:
{
  ...
  if ((v15 & 1) == 0)
  {
    ...
    else
    {
      if (a8)
      {
        objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 1001, CFSTR("%@"), v194);
        v30 = 0;
        v31 = 0;
        v32 = 0;
        v33 = 0;
    ...
    if ((v51 & 1) != 0)
    {
            ...
            (v159 & 1) == 0))
      {
        ...
        *a5 = (id)objc_claimAutoreleasedReturnValue();
        ...
        v74 = objc_alloc(MEMORY[0x1E0D10E88]);
        objc_msgSend(a1, "recordID");
        ...
        if (!v170)
        {
          ...
          if (os_log_type_enabled(v80, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)buf = 136315394;
            ...
            v197 = 2112;
            v198 = v79;
            _os_log_fault_impl(&dword_1CBD43000, v80, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: The server should have set an mtime for %s%@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v108, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138413314;
              ...
              v203 = 2112;
              v204 = v107;
              _os_log_impl(&dword_1CBD43000, v108, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ record %@ has a size inconsistency, %llu != %llu%@", buf, 0x34u);

            }
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", objc_msgSend(v169, "size"));
            v35 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_144:
        ...
        if (objc_msgSend(v14, "count"))
        {
          ...
          if (v92)
          {
            ...
            if (os_log_type_enabled(v94, (os_log_type_t)0x90u))
            {
              ...
              *(_DWORD *)buf = 136315906;
              ...
              v201 = 2112;
              v202 = (uint64_t)v93;
              _os_log_error_impl(&dword_1CBD43000, v94, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
            }
          ...
          if (os_log_type_enabled(v96, (os_log_type_t)0x90u))
          {
            *(_DWORD *)buf = 138412802;
            ...
            v199 = 2112;
            v200 = (uint64_t)v95;
            _os_log_error_impl(&dword_1CBD43000, v96, (os_log_type_t)0x90u, "[ERROR] failed deserializing version in %@: %@%@", buf, 0x20u);
          }
        ...
        else
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v120, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138412802;
              ...
              v199 = 2112;
              v200 = (uint64_t)v119;
              _os_log_impl(&dword_1CBD43000, v120, OS_LOG_TYPE_DEFAULT, "[WARNING] Server gave us an unrepresentable filename: \"%@\" using \"%@\"%@", buf, 0x20u);
          ...
          if (v128)
          {
            v129 = objc_alloc(MEMORY[0x1E0C99E60]);
            objc_msgSend(a1, "conflictLoserEtags");
...
- (uint64_t)locateSideCarServerZone:()BRCSerializationAdditions shareRecordName:withSession:
{
  ...
  if (v9)
  {
    ...
    *a4 = (void *)v14;
    ...
    {
      v18 = objc_alloc(MEMORY[0x1E0D10E88]);
...
- (void)seralizeBirthtime:()BRCSerializationAdditions
{
  ...
  if (v6)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", BRCRoundedTimestamp(a3));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)serializeSpecialIdentityForFilename:()BRCSerializationAdditions parentIDIsCloudDocsRoot:parentIDisDocumentsFolder:
{
  ...
  if (a4)
  {
    if ((objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D10DC8]) & 1) != 0)
    {
      v8 = &unk_1E87D7220;
LABEL_11:
    ...
    if ((objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D10DD8]) & 1) != 0)
    {
      v8 = &unk_1E87D7238;
      goto LABEL_11;
    }
    if ((objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D10E00]) & 1) == 0)
    {
      if ((objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D10DE0]) & 1) == 0)
        goto LABEL_12;
      v8 = &unk_1E87D7268;
      goto LABEL_11;
    }
LABEL_10:
  ...
  if (a5 && objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D10E00]))
    goto LABEL_10;
LABEL_12:
  ...
  if (v17)
  {
    ...
    if (v16)
    {
      ...
      if (v24)
      {
        ...
        objc_msgSend(v27, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("br_bougusSaltingKey"));
  ...
  if (v13 < 0)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v32 = 2112;
      v33 = v21;
      _os_log_fault_impl(&dword_1CBD43000, v22, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ has negative value %@!%@", buf, 0x20u);
    }

    if (v27)
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorInvalidParameter:value:", v11, v10);
...
LABEL_46:
  ...
  if ((objc_msgSend(v15, "isSharedToMe") & 1) == 0)
  {
    ...
    if ((a4 & 0x1000) != 0 || v116)
    {
      ...
      if (v65)
      {
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v117, "favoriteRank"));
        v66 = (void *)objc_claimAutoreleasedReturnValue();
      }
      else
      {
  ...
  if (!v69)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v117, "isHiddenExt"));
    v70 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((a4 & 4) != 0 || v116)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", objc_msgSend(v117, "mode") & 1);
      v73 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(a1, "setObject:forKeyedSubscript:", v73, CFSTR("writable"));

      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", (objc_msgSend(v117, "mode") >> 1) & 1);
  ...
  if ((a4 & 0x100) != 0 || v116)
  {
    ...
    if (v76)
    {
      ...
      if ((_DWORD)v78)
      {
        ...
        objc_msgSend(MEMORY[0x1E0C94BB8], "br_assetWithFileURL:boundaryKey:", v80, v82);
        v86 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (objc_msgSend(v15, "isFinderBookmark"))
      {
        ...
        if (os_log_type_enabled(v105, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v121 = 2112;
          v122 = v104;
          _os_log_impl(&dword_1CBD43000, v105, OS_LOG_TYPE_DEFAULT, "[WARNING] Item is missing structure CKInfo so using the version CKInfo because they are the same record %@%@", buf, 0x16u);
        }
...
- (uint64_t)_updateSize:()BRCSerializationAdditions mtime:shouldUseEnhancedDrivePrivacy:item:error:
{
  ...
  if (v11)
  {
    ...
    if (a5)
    {
      ...
      {
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", BRCRoundedTimestamp(objc_msgSend(v11, "unsignedLongLongValue")));
        v16 = (void *)objc_claimAutoreleasedReturnValue();
...
- (uint64_t)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:
{
  ...
  if ((objc_msgSend(v10, "isPausedFromSync") & 1) != 0 || objc_msgSend(v10, "isResumingSync"))
    v13 = 0x40000;
  else
    v13 = 33423360;
  v66 = v13;
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v16, "isCloudDocsAppLibrary"))
  {
    objc_msgSend(v10, "clientZone");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v17, "isCloudDocsZone"))
    {
      objc_msgSend(v10, "parentItemIDInZone");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      v19 = objc_msgSend(v18, "isNonDesktopRoot");
  ...
  objc_msgSend(v10, "parentItemIDInZone");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  v21 = objc_msgSend(v20, "isDocumentsFolder");
  ...
  if (objc_msgSend(v10, "isSharedToMeTopLevelItem"))
  {
    ...
    if (v22 == 1)
    {
      ...
      objc_msgSend(v25, "latestVersion");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v26, "originalPOSIXName");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      v28 = v27;
      if (v27)
      {
      ...
      objc_msgSend(a1, "serializeFilename:forCreation:basehashSalt:parentIDIsCloudDocsRoot:parentIDIsDocumentsFolder:", v32, 1, 0, v19, v21);
    }
    v31 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95070]), "initShareIDWithShareableItem:", v10);
    v33 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C950C0]), "initWithRecordID:action:", v31, 0);
    objc_msgSend(a1, "setShare:", v33);
  ...
  if ((v30 & 1) == 0)
  {
    objc_msgSend(v11, "originalPOSIXName");
    v31 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(a1, "serializeFilename:forCreation:basehashSalt:parentIDIsCloudDocsRoot:parentIDIsDocumentsFolder:", v31, v67 == 0, v68, v19, v21);
LABEL_30:

  }
  if ((v12 & 1) != 0 || (a4 & v66 & 0x80000) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v11, "size"));
    v34 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
LABEL_39:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v11, "mtime"));
    v35 = (void *)objc_claimAutoreleasedReturnValue();
    goto LABEL_41;
  }
  v35 = 0;
LABEL_41:
  v36 = objc_msgSend(a1, "_updateSize:mtime:shouldUseEnhancedDrivePrivacy:item:error:", v34, v35, objc_msgSend(v10, "shouldUseEnhancedDrivePrivacyWhenNeedsPreserving:", v68 != 0), v10, a7);
  if ((v36 & 1) == 0)
    goto LABEL_63;
  ...
  if (!v38)
  {
    ...
    objc_msgSend(a1, "encryptedValues");
    v41 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v41, "objectForKeyedSubscript:", CFSTR("xattrSignature"));
    v42 = objc_claimAutoreleasedReturnValue();
    if (v42)
      goto LABEL_47;
    objc_msgSend(v10, "clientZone");
    v56 = (void *)objc_claimAutoreleasedReturnValue();
    v57 = objc_msgSend(v56, "enhancedDrivePrivacyEnabled");
...
LABEL_52:
    ...
    objc_msgSend(a1, "encryptedValues");
    v44 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v44, "setObject:forKeyedSubscript:", v43, CFSTR("quarantine"));
  ...
  objc_msgSend(a1, "encryptedValues");
  v43 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v43, "setObject:forKeyedSubscript:", 0, CFSTR("xattrSignature"));
LABEL_53:
...
LABEL_54:
  ...
  v46 = v45;
  if ((a4 & 0x800000) != 0 && objc_msgSend(v45, "count") && v67)
  {
    objc_msgSend(v11, "conflictLoserEtags");
    v47 = (void *)objc_claimAutoreleasedReturnValue();
    v48 = (void *)objc_msgSend(v47, "mutableCopy");

    objc_msgSend(v48, "minusSet:", v46);
    objc_msgSend(v48, "allObjects");
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(a1, "setConflictLoserEtags:", v49);
  ...
  if ((v64 & 1) != 0)
  {
    ...
    v53 = objc_msgSend(v52, "forceFailIfExistOnRevival");
...
- (void)serializeSideCarInfo:()BRCSerializationAdditions filenameExtension:diffs:deadInServerTruth:
{
  ...
  if ((a5 & 0x1000) != 0 || a6)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v16, "favoriteRank"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v16 = 2112;
      v17 = v10;
      _os_log_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Created app library through sync flow %@%@", buf, 0x16u);
    }
...
LABEL_33:
    ...
    if (objc_msgSend(v12, "brc_isAppLibraryRootRecordID"))
    {
      ...
      if (objc_msgSend(v21, "isEqualToString:", *MEMORY[0x1E0D10DB0]))
      {
        brc_bread_crumbs();
        v35 = (void *)objc_claimAutoreleasedReturnValue();
        brc_default_log();
    ...
    if (objc_msgSend(v12, "brc_isAppLibraryDocumentsRecordID"))
    {
      ...
      if (objc_msgSend(v24, "isEqualToString:", *MEMORY[0x1E0D10DB0]))
      {
        brc_bread_crumbs();
        v37 = (void *)objc_claimAutoreleasedReturnValue();
        brc_default_log();
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v28, "brc_isAppLibraryRootRecordID"))
      {
        ...
        if (objc_msgSend(v29, "isEqualToString:", *MEMORY[0x1E0D10DB0]))
        {
          brc_bread_crumbs();
          v39 = (void *)objc_claimAutoreleasedReturnValue();
          brc_default_log();
      ...
      if (-[NSObject isEqualToString:](v32, "isEqualToString:", *MEMORY[0x1E0D10DB0]))
      {
        brc_bread_crumbs();
        v41 = (void *)objc_claimAutoreleasedReturnValue();
        brc_default_log();
...
- (void)deserializeFilename:()BRCSerializationAdditions basename:bounceno:extension:userInfo:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: empty basename and no bounceno%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)deserializeFilename:()BRCSerializationAdditions basename:bounceno:extension:userInfo:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  _os_log_debug_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] basename is nil -> replace with empty string%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
- (void)deserializeAliasInfo:()BRCSerializationAdditions serverZone:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: No alias target%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_deserializeRootSharingOptions:()BRCSerializationAdditions .cold.1()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: Record %@ is missing its PSK or routing key!%@", v1);
  OUTLINED_FUNCTION_2();
}
...
- (void)deserializeStatInfo:()BRCSerializationAdditions serverMetrics:itemID:session:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, v2, "[CRIT] UNREACHABLE: The server should have set a birthtime on %s%@", v3);
...
- (void)deserializeVersion:()BRCSerializationAdditions fakeStatInfo:contentBoundaryKey:clientZone:outOfBandUpload:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: The record name is not a content in the shared zone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)deserializeVersion:()BRCSerializationAdditions fakeStatInfo:contentBoundaryKey:clientZone:outOfBandUpload:error:.cold.2()
{
  ...
  v10 = 2112;
  v11 = v1;
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] %@ record %@ doesn't have a lastEditorDeviceName%@", (uint8_t *)&v6, 0x20u);
...
- (void)deserializeVersion:()BRCSerializationAdditions fakeStatInfo:contentBoundaryKey:clientZone:outOfBandUpload:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, v3, "[CRIT] UNREACHABLE: Got unexpected content boundary key for recordID %@%@", v4);
...
- (void)_locateSideCarServerZone:()BRCSerializationAdditions withShareAliasReference:withSession:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: si.isBRAlias%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeFilename:()BRCSerializationAdditions forCreation:setExtension:inSharedAlias:basehashSaltIfNotShareAlias:parentIDIsCloudDocsRoot:parentIDIsDocumentsFolder:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: invalid filename%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeFilename:()BRCSerializationAdditions forCreation:setExtension:inSharedAlias:basehashSaltIfNotShareAlias:parentIDIsCloudDocsRoot:parentIDIsDocumentsFolder:.cold.2()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] couldn't set basename to '%@'%@", v1, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeStatInfo:()BRCSerializationAdditions diffs:stageID:deadInServerTruth:shouldPCSChainStatus:basehashSaltGetter:childBasehashSaltGetter:error:.cold.1(void *a1, uint64_t a2, uint64_t a3, NSObject *a4)
{
  ...
  *(_WORD *)(a3 + 12) = 2112;
  *(_QWORD *)(a3 + 14) = a2;
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, a4, a3, "[CRIT] UNREACHABLE: Couldn't find xattr for signature %@%@", (uint8_t *)a3);
...
- (void)serializeStatInfo:()BRCSerializationAdditions diffs:stageID:deadInServerTruth:shouldPCSChainStatus:basehashSaltGetter:childBasehashSaltGetter:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: childBasehashSaltGetter%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self.encryptedValues[kBRRecordKeyXattrSignature] || !item.clientZone.enhancedDrivePrivacyEnabled%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self[kBRRecordKeyXattr]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: (diffs & BRC_IF_CONTENT_SIGNATURE) || item.isDocumentBeingCopiedToNewZone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.4()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: version != nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.5()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, (uint64_t)v0, "[DEBUG] On Sync-up of %@ using old etag due to iWork conflict%@", v1);
  OUTLINED_FUNCTION_2();
}
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: ![zoneName isEqualToString:BRUbiquitousDefaultContainerID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.2()
{
  ...
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] found parent app documents record named: %@%@", v4, v5, v6, v7, v8);
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.4()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] found parent app library record named: %@%@", v4, v5, v6, v7, v8);
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.5()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, (uint64_t)v0, "[CRIT] UNREACHABLE: parent is not a CKReference for %@%@", v1);
  OUTLINED_FUNCTION_2();
}
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.7()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] found app documents record named: %@%@", v4, v5, v6, v7, v8);
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.9()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] found app library record named: %@%@", v4, v5, v6, v7, v8);
