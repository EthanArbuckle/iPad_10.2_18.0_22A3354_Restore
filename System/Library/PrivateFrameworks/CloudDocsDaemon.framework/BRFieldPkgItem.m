...
LABEL_8:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isWritable);
  ...
  {
LABEL_9:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isExecutable);
...
LABEL_10:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_xattrIndex);
