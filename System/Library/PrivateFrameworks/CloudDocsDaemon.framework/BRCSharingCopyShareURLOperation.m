...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing/copy-shareURL", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)_completedWithURL:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished copying URL %@ for share %@ error %@%@", (uint8_t *)&v13, 0x2Au);
  }
...
void __39__BRCSharingCopyShareURLOperation_main__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v40 = 2112;
    v41 = v10;
    _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Share: %@%@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v40 = 2112;
    v41 = v12;
    _os_log_debug_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] Prepared record: %@%@", buf, 0x16u);
  }
        ...
        !v22))
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v40 = 2112;
      v41 = v32;
      _os_log_fault_impl(&dword_1CBD43000, v33, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't get a share URL for %@%@", buf, 0x16u);
    }
...
void __39__BRCSharingCopyShareURLOperation_main__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Couldn't get a share URL%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
