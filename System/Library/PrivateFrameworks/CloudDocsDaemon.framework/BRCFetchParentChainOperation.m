...
- (BRCFetchParentChainOperation)initWithParentID:(id)a3 sessionContext:(id)a4 zone:(id)a5 isUserWaiting:(BOOL)a6
{
  ...
  if (v17)
  {
    objc_msgSend(MEMORY[0x1E0C94F88], "br_fetchParentChain");
...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sync/fetch-parent-chain", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)_fetchParentChain:(id)a3
{
  ...
  {
    v7 = objc_alloc(MEMORY[0x1E0D10E88]);
    ...
    v13 = objc_alloc(MEMORY[0x1E0C950C0]);
    v14 = (void *)objc_msgSend(v13, "initWithRecordID:action:", v4, *MEMORY[0x1E0C94A40]);
    ...
    v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95010]), "initWithRecordType:predicate:", CFSTR("FetchAncestors"), v17);
    v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95038]), "initWithQuery:", v18);
    objc_msgSend(v4, "zoneID");
  ...
  else
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 40) + 520) = objc_msgSend(*(id *)(a1 + 32), "xattrsFetchedTotalSize");
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: Couldn't allocate ranks when fetching parent chain"));
      v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)main
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_debug_impl(&dword_1CBD43000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetching parent chain of %@%@", (uint8_t *)&v4, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
- (void)cancelToBeReplacedByOperation:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    v32 = 2112;
    v33 = v5;
    _os_log_debug_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] Cancelling %@ to be replaced by %@%@", buf, 0x20u);
  }
...
- (void)_fetchParentChain:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] found zone root record ID%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
void __50__BRCFetchParentChainOperation__fetchParentChain___block_invoke_3_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't allocate ranks when fetching parent chain%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
- (void)finishWithResult:(NSObject *)a3 error:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v21 = 2112;
  v22 = a2;
  _os_log_debug_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetch parent chain of %@ took [%f] Secs and fetched [%llu,%llu] records [%llu] xattrs%@", (uint8_t *)&v11, 0x3Eu);
