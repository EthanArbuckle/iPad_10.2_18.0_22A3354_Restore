...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing/iWork-publishing", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  if (forPublish)
    ...
    v6 = 0;
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94F30]), "initWithRecordIDsToWebShare:recordIDsToUnshare:", v6, v5);
...
void __35__BRCiWorkPublishingOperation_main__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v9)
  {
    ...
    if (*(_BYTE *)(v10 + 520) && !*(_QWORD *)(v10 + 528))
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: No sharing info and no error"));
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_2(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (!a4 || v9)
  {
    ...
    if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
    {
      ...
      v23 = 2112;
      v24 = v15;
      _os_log_error_impl(&dword_1CBD43000, v16, (os_log_type_t)0x90u, "[ERROR] Failed sharing %@ - %@%@", (uint8_t *)&v19, 0x20u);
    }
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithChar:", BRMakeiWorkSharingOptions());
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_10(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_error_impl(&dword_1CBD43000, v8, (os_log_type_t)0x90u, "[ERROR] Failed unsharing %@ - %@%@", (uint8_t *)&v15, 0x20u);
    }
...
- (void)initWithDocumentItem:sessionContext:forPublish:readonly:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: item.st.iWorkShareable%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: No sharing info and no error%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self->_forPublish%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_2_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@ was shared%@");
  OUTLINED_FUNCTION_2();
}
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_10_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@ was unshared%@");
  OUTLINED_FUNCTION_2();
}
