...
- (BRCThrottler)initWithName:(id)a3 throttleParameters:(id)a4 queue:(id)a5 handler:(id)a6
{
  ...
  if (v14)
  {
    ...
    v22 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, v12);
    source = v14->_source;
    ...
    {
      ((void (*)(id))*MEMORY[0x1E0D11070])(v25);
...
void __33__BRCThrottler_scheduleNextEvent__block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v8 = 2112;
  v9 = a2;
  _os_log_debug_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Next event will fire in %fs%@", (uint8_t *)&v6, 0x16u);
}
