...
- (NSData)signature
{
  ...
  objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", self->_sig, 21);
...
- (void)signature
{
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, a2, a3, "[CRIT] Assertion failed: !_isOpen%@", a5, a6, a7, a8, 2u);
}
