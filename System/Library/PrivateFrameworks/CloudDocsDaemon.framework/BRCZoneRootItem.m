...
LABEL_9:
  ...
  if (!objc_msgSend(v7, "isSharedZoneRoot"))
  {
    ...
    -[BRCAccountSession appLibraryByRowID:](v8, "appLibraryByRowID:", v13);
...
- (void)initWithZoneRootItemID:session:.cold.1()
{
  ...
  v3 = 2112;
  v4 = v0;
  _os_log_fault_impl(&dword_1CBD43000, v1, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Constructing shared zone root item for itemID %@ is not supported%@", v2, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
- (void)initWithZoneRootItemID:session:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: itemID.isNonDesktopRoot%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)saveToDB
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] API MISUSE: can't save a zone root item%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)fileID
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self.appLibrary.fileID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)parentItemOnFS
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: asking the parent item of a root item%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)parentItemID
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: asking the parent item ID of a root item%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)st
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: asking the structural bit of a zone root is not supported%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
