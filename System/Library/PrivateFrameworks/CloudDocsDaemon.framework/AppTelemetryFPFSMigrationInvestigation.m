...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isSuccessful);
...
LABEL_3:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemsNotMigratedCount);
...
LABEL_45:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_totalItemCount);
...
LABEL_46:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_accountQuotaUsage);
...
LABEL_47:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isAccountDataSeparated);
...
LABEL_48:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_importTime);
...
LABEL_49:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_typesOfMigratedItemsMask);
...
LABEL_50:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_typesOfNonMigratedItemsMask);
...
LABEL_51:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemsNotFoundInDB);
...
LABEL_52:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_bouncedItemsCount);
  ...
  {
LABEL_12:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_bouncedItemsMatrix);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_13:
  ...
  if ((*(_BYTE *)&v9 & 8) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_busyDateNotMigratedCount);
...
LABEL_21:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_childItemsNotMigratedCount);
...
LABEL_56:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_ignoredFromSyncItemsNotMigratedCount);
...
LABEL_57:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemsReconciledInFileProvider);
...
LABEL_58:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemsMigratedWithoutAlreadyMayExistFlag);
...
LABEL_59:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_durationBetweenDbCreationAndMigrationStart);
...
LABEL_61:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_stateOfDownloadJobs);
...
LABEL_62:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_stateOfUploadJobs);
...
LABEL_63:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_stateOfOtherJobs);
...
LABEL_64:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_numberOfItemsPendingReconciliation);
...
LABEL_65:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_numberOfItemsPendingSelection);
...
LABEL_66:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_numberOfItemsPendingScanningDisk);
...
LABEL_67:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_numberOfItemsPendingScanningProvider);
...
LABEL_69:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_xpcActivityTimeSinceLastRegistration);
...
LABEL_71:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_xpcActivityTimeSinceLastActivation);
...
LABEL_72:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_xpcActivityDasdContext);
...
LABEL_39:
    if ((*(_WORD *)&v9 & 0x2000) == 0)
      goto LABEL_40;
LABEL_74:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemsReconciledInFileProviderDelta);
...
LABEL_73:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemsNotMigratedDelta);
...
LABEL_40:
  ...
  {
LABEL_41:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_xpcActivityTimeSinceLastAbleToRun);
