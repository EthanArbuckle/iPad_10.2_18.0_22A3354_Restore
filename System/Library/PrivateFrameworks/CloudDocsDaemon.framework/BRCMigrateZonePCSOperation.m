...
- (void)_createCloudDocsZone:(id)a3
{
  ...
  v6 = (void *)objc_msgSend(v5, "initWithZoneName:ownerName:", *MEMORY[0x1E0D10DB0], *MEMORY[0x1E0C94730]);
...
void __51__BRCMigrateZonePCSOperation__createCloudDocsZone___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
    ...
    v7 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0C95088]), "initWithZoneID:", *(_QWORD *)(a1 + 32));
  v8 = v7;
...
- (void)_fetchZonesNeedingMigration:(id)a3
{
  ...
  v8 = (void *)objc_msgSend(v7, "initWithZoneName:ownerName:", *MEMORY[0x1E0D10DB0], *MEMORY[0x1E0C94730]);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v26 = 2112;
      v27 = v10;
      _os_log_error_impl(&dword_1CBD43000, v11, (os_log_type_t)0x90u, "[ERROR] Failed fetching zones to prep PCS for %@ - %@%@", buf, 0x20u);
    }
    ...
    if (objc_msgSend(v7, "count"))
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v26 = 2112;
        v27 = v12;
        _os_log_debug_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] Prepping PCS for %@ -> %@%@", buf, 0x20u);
      }

      v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94BA0]), "initWithSourceZoneIDs:targetZone:", v7, v8);
...
uint64_t __34__BRCMigrateZonePCSOperation_main__block_invoke_17(uint64_t a1)
{
  ...
  return objc_msgSend(*(id *)(a1 + 32), "completedWithResult:error:", MEMORY[0x1E0C9AAB0], 0);
}
  ...
  if (v6 && !objc_msgSend(v6, "brc_isCloudKitErrorZoneMigrated"))
  {
    ...
    if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v25 = 2112;
      v26 = v13;
      _os_log_error_impl(&dword_1CBD43000, v14, (os_log_type_t)0x90u, "[ERROR] Failed migrating PCS for %@ - %@%@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v25 = 2112;
      v26 = v8;
      _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] PCS migration %@ for %@%@", buf, 0x20u);
    }
...
void __34__BRCMigrateZonePCSOperation_main__block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] No zones need PCS prep currently%@", (uint8_t *)&v2, 0xCu);
}
