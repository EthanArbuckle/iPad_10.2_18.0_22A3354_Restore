...
- (BRCThrottle)initWithName:(id)a3 andParameters:(id)a4
{
  ...
  if (v4)
  {
    v5 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99E08]), "initWithCapacity:", 32);
    retryCounters = v4->_retryCounters;
    v4->_retryCounters = (NSMutableDictionary *)v5;

    v7 = -[BRCMinHeap initWithComparator:]([BRCMinHeap alloc], "initWithComparator:", &__block_literal_global_18);
...
- (void)_cleanupStaleCounters:(int64_t)a3
{
  ...
  if (v6)
  {
    ...
    while (1)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v11, "throttleHash"));
  ...
  if (v12 == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&v28[6] = v14;
      ...
      v19 = 38;
LABEL_14:
      _os_log_debug_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEBUG, v17, buf, v19);
      goto LABEL_11;
    }
    goto LABEL_11;
  }
...
LABEL_31:
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_QWORD *)&buf[4] = v21;
          _os_log_fault_impl(&dword_1CBD43000, v22, OS_LOG_TYPE_FAULT, "[CRIT] API MISUSE: unhandled format specifier%@", buf, 0xCu);
        }
        ...
        if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
        {
          ...
          *(_WORD *)&buf[8] = 2112;
          *(_QWORD *)&buf[10] = v23;
          _os_log_error_impl(&dword_1CBD43000, v24, (os_log_type_t)0x90u, "[ERROR] unhandled format specifier %%%c\n%@", buf, 0x12u);
        }
