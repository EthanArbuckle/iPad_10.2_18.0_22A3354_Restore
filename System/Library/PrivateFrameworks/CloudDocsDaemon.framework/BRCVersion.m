...
- (BRCUserRowID)lastEditorRowID
{
  ...
  if (-[BRCVersion _hasLastEditorRowID](self, "_hasLastEditorRowID"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", --[NSNumber longLongValue](self->_lastEditorDeviceOrUserRowID, "longLongValue"));
...
- (id)lastEditorUserIdentityWithDB:(id)a3
{
  ...
  if (v5)
  {
    +[BRCAccountSession userIdentityForKey:db:](BRCAccountSession, "userIdentityForKey:db:", v5, v4);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (id)descriptionWithContext:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37A0]), "initWithCapacity:", 64);
  ckInfo = self->_ckInfo;
  if (ckInfo)
  {
...
- (BRCVersion)initWithCoder:(id)a3
{
  ...
  v28.receiver = self;
  v28.super_class = (Class)BRCVersion;
  v5 = -[BRCVersion init](&v28, sel_init);
  if (v5)
  {
    ...
    v5->_mtime = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("mtime"));
    ...
    v5->_thumbnailSize = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("thumbnailSize"));
    ...
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("editedKey"));
    v14 = objc_claimAutoreleasedReturnValue();
    editedSinceShared = v5->_editedSinceShared;
    v5->_editedSinceShared = (NSNumber *)v14;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("deviceKey"));
    ...
    if (_BRCClassesConflictLoserEtags_once != -1)
      dispatch_once(&_BRCClassesConflictLoserEtags_once, &__block_literal_global_10);
    v20 = (id)_BRCClassesConflictLoserEtags_allowedClasses;
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v20, CFSTR("conflictLoserEtags"));
    v21 = objc_claimAutoreleasedReturnValue();
    conflictLoserEtags = v5->_conflictLoserEtags;
    v5->_conflictLoserEtags = (NSSet *)v21;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("xattrSig"));
    v23 = objc_claimAutoreleasedReturnValue();
    xattrSignature = v5->_xattrSignature;
    v5->_xattrSignature = (NSData *)v23;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("quarantineInfo"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v5, "encodeInt64:forKey:", self->_mtime, CFSTR("mtime"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_originalPOSIXName, CFSTR("name"));
  objc_msgSend(v5, "encodeInt64:forKey:", self->_size, CFSTR("size"));
  objc_msgSend(v5, "encodeInt64:forKey:", self->_thumbnailSize, CFSTR("thumbnailSize"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_thumbnailSignature, CFSTR("thumbnail"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_contentSignature, CFSTR("content"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_editedSinceShared, CFSTR("editedKey"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_lastEditorDeviceOrUserRowID, CFSTR("deviceKey"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_lastEditorDeviceName, CFSTR("deviceName"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_conflictLoserEtags, CFSTR("conflictLoserEtags"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_xattrSignature, CFSTR("xattrSig"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_quarantineInfo, CFSTR("quarantineInfo"));
...
- (BOOL)isSmallAndMostRecentClientsGenerateThumbnails
{
  ...
  if (-[BRCVersion size](self, "size") <= v4)
  {
    ...
    v5 = objc_claimAutoreleasedReturnValue();
    v9 = objc_msgSend(MEMORY[0x1E0CD32F0], "canMostRecentClientsGenerateThumbnailsForUTI:", v5);
    if (v9)
    {
      brc_bread_crumbs();
      v6 = objc_claimAutoreleasedReturnValue();
...
LABEL_15:
        _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, v12, (uint8_t *)&v14, 0x20u);
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_debug_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] Not being greedy because document is bigger %@ than minimum size (%@) to generate a thumbnail%@", (uint8_t *)&v14, 0x20u);
...
- (void)setLastEditorDeviceRowID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: lastEditorDeviceRowID && lastEditorDeviceRowID.longLongValue > 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)setLastEditorDeviceRowID:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: ![self _hasLastEditorRowID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)setLastEditorRowID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !_lastEditorDeviceOrUserRowID || ![self _hasLastEditorDeviceRowID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)isPackage
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _contentSignature%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)isSmallAndMostRecentClientsGenerateThumbnails
{
  ...
  OUTLINED_FUNCTION_4_0();
  _os_log_debug_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Not being greedy because current version size is 0%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
