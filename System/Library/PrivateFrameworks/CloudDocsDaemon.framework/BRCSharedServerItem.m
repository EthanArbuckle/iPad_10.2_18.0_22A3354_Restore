...
- (id)fallbackParentAppLibraryOnFS
{
  ...
  -[BRCAccountSession fallbackAppLibraryForClientZone:extension:](session, "fallbackAppLibraryForClientZone:extension:", v5, v9);
...
- (id)fallbackParentItemOnFS
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
    {
      ...
      v21 = 2112;
      v22 = v9;
      _os_log_fault_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't find %@ in %@%@", (uint8_t *)&v17, 0x20u);

    }
    -[BRCAccountSession appLibraryByID:](self->super._session, "appLibraryByID:", *MEMORY[0x1E0D10DB0]);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)fallbackParentItemIDOnFS
{
  ...
  if (db == v6)
    objc_msgSend(v3, "recreateDocumentsFolderIfNeededOnDisk");
...
- (id)parentItemOnFS
{
  ...
  {
    -[BRCAccountSession serverAliasItemForSharedItem:](self->super._session, "serverAliasItemForSharedItem:", self);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v3 = v6;
    if (!v6)
    {
...
- (id)parentItemIDOnFSInDB:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v22 = 2112;
    v23 = v5;
    _os_log_debug_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx computing the parent item id of %@%@", buf, 0x20u);
  ...
  {
    -[BRCAccountSession serverAliasItemForSharedItem:db:](self->super._session, "serverAliasItemForSharedItem:db:", self, v4);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (v8)
    {
      brc_bread_crumbs();
...
- (id)aliasDerivedStructure
{
  ...
  {
    -[BRCAccountSession serverAliasItemForSharedItem:db:](self->super._session, "serverAliasItemForSharedItem:db:", self, self->super._db);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)fallbackParentItemOnFS
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: fallbackItem%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)parentItemIDOnFSInDB:(uint64_t)a3 .cold.1(void *a1, uint64_t a2, uint64_t a3, NSObject *a4)
{
  ...
  *(_WORD *)(a3 + 12) = 2112;
  *(_QWORD *)(a3 + 14) = a2;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a4, a3, "[DEBUG] falling back to an app library documents root: %@%@", (uint8_t *)a3);
...
- (void)parentItemIDOnFSInDB:(NSObject *)a3 .cold.2(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v5 = 2112;
  v6 = a2;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a3, (uint64_t)a3, "[DEBUG] found the alias representing this item: %@%@", (uint8_t *)&v3);
}
