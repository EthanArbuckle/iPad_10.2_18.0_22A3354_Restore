...
LABEL_11:
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v12 = v6;
      _os_log_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] No path for Caches directory%@", buf, 0xCu);
    }
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v27;
            ...
            v34 = 2112;
            v35 = v17;
            _os_log_debug_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] Located ubiquity salt path by the duck test - %@%@", buf, 0x16u);
          }
...
LABEL_21:
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v34 = 2112;
      v35 = v24;
      _os_log_impl(&dword_1CBD43000, v25, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't locate ubiquity salt path in %@%@", buf, 0x16u);
    }
...
+ (id)br_currentMobileDocumentsDirWithRefreshCache:()BRCPathAdditions
{
  ...
  if (!v7)
  {
    if (MEMORY[0x1D17A5F40]())
    {
      objc_msgSend(MEMORY[0x1E0D10E78], "br_getProviderDomainIDForCurrentPersona");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      if (v8)
      {
        v30 = 0;
        objc_msgSend(MEMORY[0x1E0CAACA8], "providerDomainWithID:cachePolicy:error:", v8, 0, &v30);
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        v10 = v30;
      }
      else
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_QWORD *)((char *)&v34 + 2) = v11;
        _os_log_debug_impl(&dword_1CBD43000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] Getting root item for provider domain ID: %@. Found domain: %@. Current persona: %@%@", buf, 0x2Au);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        *(_QWORD *)&buf[4] = v23;
        _os_log_impl(&dword_1CBD43000, v24, OS_LOG_TYPE_DEFAULT, "[WARNING] No path for Mobile Documents directory%@", buf, 0xCu);
      }
...
+ (void)br_currentMobileDocumentsDirWithRefreshCache:()BRCPathAdditions .cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v6 = 2112;
  v7 = a2;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a3, (uint64_t)a3, "[DEBUG] Getting root URL from storage URLs: %@%@", (uint8_t *)&v4);
}
