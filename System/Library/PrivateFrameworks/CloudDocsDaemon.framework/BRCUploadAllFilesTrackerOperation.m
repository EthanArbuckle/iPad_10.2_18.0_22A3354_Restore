...
- (void)clientZone:(id)a3 didFinishUploadingAllItemsWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v31 = 2112;
    v32 = v9;
    _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: finished uploading all items in %@: %@%@", buf, 0x2Au);
  ...
  if (!-[NSMutableArray count](self->_zonesStillUploading, "count") && self->_zonesStillUploading)
  {
    if (-[NSMutableDictionary count](self->_perContainerIDError, "count"))
    {
      ...
      v16 = (void *)-[NSMutableDictionary copy](self->_perContainerIDError, "copy", *MEMORY[0x1E0D10CF0]);
      v24 = v16;
...
- (void)main
{
  ...
  v6 = v4;
  v7 = v19;
  v12 = (void *)MEMORY[0x1D17A6BE8](v7, v8, v9, v10, v11);
  v20 = 0uLL;
  v21 = 0;
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v23 = v13;
    _os_log_debug_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx dispatching to %s%@", block, 0x20u);
  }
  ...
  *(_QWORD *)&block[16] = __dispatch_async_with_logs_block_invoke_22;
  v23 = &unk_1E875D578;
  v15 = v6;
  v24 = v15;
  v16 = v7;
