...
- (BRCAccountWaitOperation)initWithCKContainer:(id)a3
{
  ...
  if (v6)
  {
    ...
    v9 = dispatch_source_create(MEMORY[0x1E0C80D78], 0, 0, v8);
    source = v7->_source;
    ...
    v16 = v14;
    v17 = v16;
    v18 = (void (**)(_QWORD *))MEMORY[0x1E0D11070];
    v19 = v16;
...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "account-waiter", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)_accountChangeHandler
{
  ...
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] ┏%llx handling account change%@");
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v28 = v6;
    _os_log_debug_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got status %ld%@", block, 0x20u);
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v28 = v14;
    _os_log_debug_impl(&dword_1CBD43000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx dispatching to %s%@", block, 0x20u);
  }
  ...
  *(_QWORD *)&block[16] = __dispatch_async_with_logs_block_invoke_5;
  v28 = &unk_1E875D578;
  v16 = v11;
  v29 = v16;
  v17 = v12;
...
- (void)start
{
  ...
  objc_msgSend(v3, "addObserver:selector:name:object:", self, sel__accountDidChange, *MEMORY[0x1E0C94690], 0);
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  objc_msgSend(v9, "removeObserver:name:object:", self, *MEMORY[0x1E0C94690], 0);
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_18_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Account is now available%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_18_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  _os_log_fault_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unknown account status%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_18_cold_3()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_0_1();
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] Error when asking CloudKit about the account status: %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_18_cold_4()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] No account loaded yet, let's wait for the account notification from CloudKit%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_18_cold_5()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Account is restricted let's wait for a notification from CloudKit%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_18_cold_6()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Account is temporarily unavailable, let's wait for a notification from CloudKit%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
