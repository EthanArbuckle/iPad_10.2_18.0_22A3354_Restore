    ...
    if (v11 < v13)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v37 = v14;
        _os_log_impl(&dword_1CBD43000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] Batch operatoin completed but some records were not handled by perRecordCompletionBlock%@", buf, 0xCu);
      }

      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D10B70], 149, 0);
...
- (void)setFetchRecordsCompletionBlock:(id)a3
{
  ...
  v4 = (void *)MEMORY[0x1D17A6DB0](a3, a2);
