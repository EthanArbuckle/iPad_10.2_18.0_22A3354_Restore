...
uint64_t __91__BRCSyncConsistencyReport__finishReport_session_temporaryDBURL_mountFD_completionHandler___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      v5 = 138412290;
      v6 = v2;
      _os_log_impl(&dword_1CBD43000, v3, OS_LOG_TYPE_DEFAULT, "[WARNING] Telemetry sync consistency report did not run%@", (uint8_t *)&v5, 0xCu);
    }
  }
        ...
        if (v33)
        {
          ...
          if (os_log_type_enabled(v78, (os_log_type_t)0x90u))
          {
            *(_DWORD *)buf = 138412802;
            ...
            v137 = 2112;
            v138 = v77;
            _os_log_error_impl(&dword_1CBD43000, v78, (os_log_type_t)0x90u, "[ERROR] Failed to mount snapshot at %@ - %@%@", buf, 0x20u);
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v72, (os_log_type_t)0x90u))
          {
            *(_DWORD *)buf = 138412802;
            ...
            v137 = 2112;
            v138 = v71;
            _os_log_error_impl(&dword_1CBD43000, v72, (os_log_type_t)0x90u, "[ERROR] Failed to generate snapshot at %@ - %@%@", buf, 0x20u);
          }
...
LABEL_11:
    ...
    v90 = (__CFString *)v36;
    objc_msgSend(*(id *)(v17 + 3736), "fileURLWithPath:", v36);
    ...
    if (v9 && objc_msgSend(v9, "count"))
    {
      ...
      v121[1] = 3221225472;
      v121[2] = __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_604;
      v121[3] = &unk_1E875EE08;
      v122 = v43;
    ...
    if (v47)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          v116 = 0;
          objc_msgSend(MEMORY[0x1E0CAACB8], "wrapperWithURL:readonly:error:", v51, 1, &v116);
    ...
    v114[1] = 3221225472;
    v114[2] = __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_2_606;
    v114[3] = &unk_1E875EE30;
    v55 = v27;
    v115 = v55;
    ...
    v99[1] = 3221225472;
    v99[2] = __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_609;
    v99[3] = &unk_1E875EE80;
    v100 = v56;
    v105 = v98;
    v101 = v57;
...
LABEL_25:
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithPOSIXCode:", 28);
...
uint64_t __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_604(uint64_t a1, uint64_t a2)
{
  return objc_msgSend(*(id *)(a1 + 32), "URLByAppendingPathComponent:", a2);
}

id __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_2_606(uint64_t a1, void *a2)
{
  void *v2;
  objc_class *v3;
  id v4;
...
void __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_609(uint64_t a1, void *a2, void *a3, void *a4)
{
  id v7;
  id v8;
  id v9;
...
void __91__BRCSyncConsistencyReport__finishReport_session_temporaryDBURL_mountFD_completionHandler___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_10_0(&dword_1CBD43000, v4, v5, "[DEBUG] Telemetry sync consistency report succeeded with %lu error and %lu warning events%@", v6, v7, v8, v9, 2u);
...
+ (void)cleanupApfsSnapshotWithMountFD:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Failed to delete old snapshot - %@%@");
  OUTLINED_FUNCTION_2();
}
...
+ (void)cleanupApfsSnapshotWithMountFD:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Failed to unmount old snapshot - %@%@");
  OUTLINED_FUNCTION_2();
}
