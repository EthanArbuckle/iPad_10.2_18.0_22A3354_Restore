...
- (id)dictionaryRepresentation
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_fileID);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_generationID);
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_size);
