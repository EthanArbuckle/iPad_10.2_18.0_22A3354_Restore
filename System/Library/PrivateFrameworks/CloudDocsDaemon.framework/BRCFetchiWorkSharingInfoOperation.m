...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing/iWork-publishing-fetch", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  v6 = *MEMORY[0x1E0C94B50];
  v10[0] = *MEMORY[0x1E0C94B58];
  v10[1] = v6;
  v7 = *MEMORY[0x1E0C94B60];
  v10[2] = *MEMORY[0x1E0C94B48];
  v10[3] = v7;
...
void __41__BRCFetchiWorkSharingInfoOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: No error and invalid number of records %lu"), objc_msgSend(v5, "count"));
...
void __41__BRCFetchiWorkSharingInfoOperation_main__block_invoke_cold_1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  v7 = 2112;
  v8 = a2;
  _os_log_fault_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: No error and invalid number of records %lu%@", (uint8_t *)&v5, 0x16u);
}
