...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "BRCSharingModifyShareOperation/? (subclass activity missing)", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
LABEL_27:
    ...
    if (v17 == objc_msgSend(v3, "sharingOptions"))
    {
      v18 = 0;
           ...
           || (objc_msgSend(v3, "clientZone"),
               ...
               v18 = objc_msgSend(v19, "isPrivateZone"),
               v19,
               v18))
    {
    ...
    v13 = -[BRCItemToPathLookup initWithItem:]([BRCItemToPathLookup alloc], "initWithItem:", v3);
    -[BRCItemToPathLookup byFileSystemID](v13, "byFileSystemID");
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setOrRemoveSpotlightAttributeAt:", v20);
  ...
  {
    brc_bread_crumbs();
    v13 = (BRCItemToPathLookup *)objc_claimAutoreleasedReturnValue();
    brc_default_log();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v31 = 2112;
      v32 = v13;
      _os_log_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't find item %@ in zone %@%@", buf, 0x20u);
    }
...
- (void)_performAfterCopyingPublicSharingKeyWithRecordID:(id)a3 completion:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = objc_alloc(MEMORY[0x1E0C94E18]);
  v18[0] = v6;
...
void __94__BRCSharingModifyShareOperation__performAfterCopyingPublicSharingKeyWithRecordID_completion___block_invoke(_QWORD *a1, void *a2, void *a3)
{
  ...
  if (!v12)
  {
    ...
    if (v8
      || (objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorPermissionError:", CFSTR("Couldn't get public sharing key")),
...
- (void)_performAfterGettingPublicSharingKeyForRecord:(id)a3 completion:(id)a4
{
  ...
  v11 = objc_alloc(MEMORY[0x1E0C94F10]);
  v22[0] = v6;
...
void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (!v7 && !v9)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no records and no error"));
  ...
  if (!(v12 | v7))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no error and no sharing key"));
    v7 = objc_claimAutoreleasedReturnValue();
  }
  if (v7)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v36 = 2112;
      v37 = v20;
      _os_log_debug_impl(&dword_1CBD43000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] Got sharing identity for share - %@%@", buf, 0x16u);
    }
...
LABEL_4:
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no public sharing identity. avoiding breaking iwork shares"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
...
void __95__BRCSharingModifyShareOperation__performAfterFetchingiWorkRoutingTokenIfNecessary_completion___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (!(v4 | v5))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no routing key on share identity prepared record"));
...
LABEL_7:
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = objc_alloc(MEMORY[0x1E0C94E18]);
  v32[0] = v17;
...
void __108__BRCSharingModifyShareOperation__performAfterFetchingiWorkSharingIdentityOnItem_wantRoutingKey_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "objectForKeyedSubscript:", *MEMORY[0x1E0C94B48]);
  ...
  if (v8
    || (objc_msgSend(v6, "encryptedValues"),
        v9 = (void *)objc_claimAutoreleasedReturnValue(),
        objc_msgSend(v9, "objectForKeyedSubscript:", *MEMORY[0x1E0C94B60]),
        v8 = (void *)objc_claimAutoreleasedReturnValue(),
        v9,
        v8))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: sharing identity isn't encrypted data"));
      v12 = objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: base token isn't a string"));
      v15 = objc_claimAutoreleasedReturnValue();
  ...
  if (v16 && !v5)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      v42 = 2112;
      v43 = v17;
      _os_log_fault_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: no base token %@ or sharing identity %@ and no error%@", buf, 0x20u);
    }

    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no base token %@ or sharing identity %@ and no error"), v7, v8);
  ...
  else
  {
    objc_msgSend(v6, "encryptedValues");
    v26 = (void *)objc_claimAutoreleasedReturnValue();
    v27 = *MEMORY[0x1E0C94B60];
    objc_msgSend(v26, "objectForKeyedSubscript:", *MEMORY[0x1E0C94B60]);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (!v22 || (objc_msgSend(v8, "isEqualToData:", v22) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v42 = 2112;
        v43 = v28;
        _os_log_fault_impl(&dword_1CBD43000, v29, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Sharing identities don't match (%@ vs %@)! Trying to fix up the identities%@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v40 = 2112;
      v41 = v35;
      _os_log_debug_impl(&dword_1CBD43000, v36, OS_LOG_TYPE_DEBUG, "[DEBUG] Got iWork sharing identify for share - %@%@", buf, 0x16u);
    }
...
LABEL_7:
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: not a directory nor a document"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)initWithName:zone:share:sessionContext:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _itemID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_performAfterGettingPublicSharingKeyForRecord:completion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: contentsRecord%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_performAfterGettingPublicSharingKeyForRecord:completion:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] requesting sharing identity on %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Fetching sharing identity failed - %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no error and no sharing key%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no records and no error%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_performAfterFetchingiWorkRoutingTokenIfNecessary:completion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no public sharing identity. avoiding breaking iwork shares%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_performAfterFetchingiWorkRoutingTokenIfNecessary:completion:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Yanking the routing key from the server for %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __95__BRCSharingModifyShareOperation__performAfterFetchingiWorkRoutingTokenIfNecessary_completion___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: [self->_share.publicSharingIdentity isEqualToData:self->_sharingIdentityPreparedRecord.encryptedPublicSharingKey]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __95__BRCSharingModifyShareOperation__performAfterFetchingiWorkRoutingTokenIfNecessary_completion___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no routing key on share identity prepared record%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_performAfterFetchingiWorkSharingIdentityOnItem:wantRoutingKey:completion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Requesting iwork sharing identity on %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __108__BRCSharingModifyShareOperation__performAfterFetchingiWorkSharingIdentityOnItem_wantRoutingKey_completion___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Fetching iWork sharing identity failed - %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __108__BRCSharingModifyShareOperation__performAfterFetchingiWorkSharingIdentityOnItem_wantRoutingKey_completion___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: base token isn't a string%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __108__BRCSharingModifyShareOperation__performAfterFetchingiWorkSharingIdentityOnItem_wantRoutingKey_completion___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: sharing identity isn't encrypted data%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __112__BRCSharingModifyShareOperation__performAfterPreparingSharingIdentityIfNecessaryWhenWantRoutingKey_completion___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: not a directory nor a document%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
