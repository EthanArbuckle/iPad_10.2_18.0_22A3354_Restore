...
- (id)additionalPayload
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isPackage);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = v3;
  v8[1] = CFSTR("contentSize");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_contentSize);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[1] = v4;
  v8[2] = CFSTR("syncUpBatchSize");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_syncUpBatchSize);
