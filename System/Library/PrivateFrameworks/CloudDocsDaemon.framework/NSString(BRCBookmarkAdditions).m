...
- (uint64_t)parseUnsaltedBookmarkDataWithItemID:()BRCBookmarkAdditions mangledID:error:
{
  ...
  if (objc_msgSend(v9, "count") == 2)
  {
    ...
    if (v12)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorInvalidParameter:value:", CFSTR("unsaltedBookmarkData"), a1);
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(v23, (os_log_type_t)0x90u))
        {
          ...
          v34 = 2112;
          v35 = v22;
          _os_log_error_impl(&dword_1CBD43000, v23, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v28, 0x2Au);
        }
    ...
    else
    {
      ...
      if (v15)
      {
        ...
        if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
        {
          ...
          v34 = 2112;
          v35 = v19;
          _os_log_error_impl(&dword_1CBD43000, v20, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v28, 0x2Au);
        }
...
LABEL_27:
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
    {
      ...
      v34 = 2112;
      v35 = v17;
      _os_log_error_impl(&dword_1CBD43000, v18, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v28, 0x2Au);
    }
...
- (uint64_t)parseBookmarkDataWithAccountSession:()BRCBookmarkAdditions docID:itemID:mangledID:unsaltedBookmarkData:error:
{
  ...
  if (objc_msgSend(v14, "count") == 3)
  {
    ...
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    obj = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D10E88]), "initWithAliasTargetContainerString:", v15);
      ...
      && (objc_msgSend(v17, "isEqualToString:", CFSTR("BRGetFileNameFromServerInfoBlob")) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v32, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138413058;
        ...
        v63 = 2112;
        v64 = v31;
        _os_log_error_impl(&dword_1CBD43000, v32, (os_log_type_t)0x90u, "[ERROR] checksum from bookmark %@ is not equal to expected checksum %@ for %@%@", buf, 0x2Au);
      }

      v18 = obj;
      if (v30)
      {
        objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorAccountMismatch");
        v27 = 0;
...
LABEL_29:
    ...
    {
      v41 = v16;
      objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorInvalidParameter:value:", CFSTR("bookmarkData"), a1);
...
+ (void)bookmarkDataWithItemResolutionString:()BRCBookmarkAdditions serverZoneMangledID:saltAccountDSID:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: should have an accountID to salt with%@", (uint8_t *)&v2, 0xCu);
}
