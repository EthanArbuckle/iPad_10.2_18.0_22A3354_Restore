...
+ (__CFString)brc_hexadecimalStringWithBytes:()BRCCryptographicAdditions length:
{
  ...
  v6 = (__CFString *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37A0]), "initWithCapacity:", 2 * a4);
  if (v6)
  {
    for (; v4; v4 -= v7)
    {
...
- (id)brc_SHA1WithSalt:()BRCCryptographicAdditions
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "brc_hexadecimalStringWithBytes:length:", macOut, 20);
  return (id)objc_claimAutoreleasedReturnValue();
}
...
- (id)brc_dataFromHexidecimalString
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DF0], "dataWithCapacity:", v3 >> 1);
