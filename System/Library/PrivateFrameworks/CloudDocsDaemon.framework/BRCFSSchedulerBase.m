...
- (BRCFSSchedulerBase)initWithSession:(id)a3 name:(id)a4 tableName:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_msgSend(MEMORY[0x1E0DE81D8], "nameWithString:", v11);
    ...
    -[BRCAccountSession defaultScheduler](v13->_session, "defaultScheduler");
...
void __53__BRCFSSchedulerBase_initWithSession_name_tableName___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_debug_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@: scheduling%@", buf, 0x20u);
  }
...
- (BOOL)canRetryJobWithID:(id)a3
{
  ...
  v9 = (void *)objc_msgSend(v5, "numberWithSQL:", CFSTR("SELECT next_retry_stamp > %llu FROM %@ WHERE %@"), v6, tableName, v8);

  LOBYTE(v8) = objc_msgSend(v9, "BOOLValue") ^ 1;
  return (char)v8;
}
...
- (id)descriptionForJobsMatching:(id)a3 ordering:(id)a4 additionalColumns:(id)a5 additionalValuesHandler:(id)a6 context:(id)a7
{
  ...
  if (v13)
  {
    objc_msgSend(MEMORY[0x1E0DE81E0], "rawInjection:length:", ",", 1);
...
- (unint64_t)postponeJobID:(id)a3 withThrottle:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v29 = 2112;
    v30 = v7;
    _os_log_debug_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: post-poning job%@", buf, 0x20u);
  }
...
- (brc_job_update)insertOrUpdateJobID:(id)a3 throttle:(id)a4 withState:(int)a5 insertedSQLColumn:(id)a6 insertedSQLValues:(id)a7 updatedSQLValues:(id)a8 error:(id *)a9
{
  ...
  _os_log_debug_impl(&dword_1CBD43000, v53, OS_LOG_TYPE_DEBUG, v52, buf, v54);
LABEL_23:
...
- (void)rescheduleSuspendedJobsMatching:(id)a3 inState:(int)a4
{
  ...
  if (v6)
  {
    objc_msgSend(MEMORY[0x1E0DE81E0], "rawInjection:length:", "AND ", 4);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "matchingJobsWhereSQLClause");
  }
  else
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      v27 = 2112;
      v28 = v13;
      _os_log_debug_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: retrying %lld suspended jobs matching %@ in %s%@", buf, 0x34u);
    ...
    if (-[BRCFSSchedulerBase updateStamps:throttle:now:](self, "updateStamps:throttle:now:", a3, v11, v12))
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138413314;
        ...
        v34 = 2112;
        v35 = v17;
        _os_log_debug_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: backing off %.3fs (count: %d)%@", buf, 0x30u);
      }
...
- (BOOL)setState:(int)a3 forJobsMatching:(id)a4
{
  ...
  v20 = a3;
  v19[4] = self;
  v9 = (void *)MEMORY[0x1D17A6DB0](v19);
  objc_msgSend(v6, "matchingJobsWhereSQLClause");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      v29 = 2112;
      v30 = v13;
      _os_log_debug_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: Updated %lld jobs to state %s%@", buf, 0x34u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: Deleted %lld jobs%@", buf, 0x2Au);
...
- (void)resetBackoffForJobWithID:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v19 = 2112;
    v20 = v5;
    _os_log_debug_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: resetting backoff for job%@", buf, 0x20u);
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v13 = 2112;
      v14 = v6;
      _os_log_debug_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: Cleaned up %lld expired jobs%@", buf, 0x20u);
    }
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v12 = 2112;
        v13 = v5;
        _os_log_debug_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: Throttle id %@ has work%@", buf, 0x20u);
      }
...
- (void)schedule
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_FAULT))
  {
    v4 = 138412290;
    v5 = v2;
    _os_log_fault_impl(&dword_1CBD43000, v3, OS_LOG_TYPE_FAULT, "[CRIT] API MISUSE: should be implemented by subclass%@", (uint8_t *)&v4, 0xCu);
  }
...
- (void)scheduleWithBatchSize:(int)a3 whereSQLClause:(id)a4 columns:(id)a5 actionHandler:(id)a6
{
  ...
  if (v10)
  {
    objc_msgSend(MEMORY[0x1E0DE81E0], "rawInjection:length:", "AND (", 5);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0DE81E0], "rawInjection:length:", ")", 1);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v33 = 2112;
        v34 = v24;
        _os_log_debug_impl(&dword_1CBD43000, v25, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: going to sleep for %.3fs%@", buf, 0x20u);
      }
    }
...
- (void)cancel
{
  ...
  OUTLINED_FUNCTION_4(*MEMORY[0x1E0C80C00]);
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@: cancelling!%@");
  OUTLINED_FUNCTION_2();
}
...
void __53__BRCFSSchedulerBase_initWithSession_name_tableName___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  _os_log_debug_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] cancelled%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
- (void)canRetryJobWithID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: jobID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)postponeJobID:withThrottle:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: stamps.state != BRCJobStateInvalid%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)updateStamps:throttle:now:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: throttle%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)computeStamps:forJobID:throttle:shouldBackoff:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !rs.next%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)scheduleWithBatchSize:whereSQLClause:columns:actionHandler:.cold.1()
{
  ...
  v10 = 2112;
  v11 = v0;
  _os_log_debug_impl(&dword_1CBD43000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: nothing schedulable, going to sleep %s%@", (uint8_t *)&v6, 0x20u);
}
...
- (void)scheduleWithBatchSize:whereSQLClause:columns:actionHandler:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4(*MEMORY[0x1E0C80C00]);
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@: Finishing batch and allowing other jobs to run%@");
  OUTLINED_FUNCTION_2();
}
