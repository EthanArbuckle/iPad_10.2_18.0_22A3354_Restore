...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sync-down/periodic-sync", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (BOOL)scheduleSyncDownIfNeededForZoneID:(id)a3 zoneIfAny:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v65 = 2112;
    v66 = v10;
    _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx considering whether or not to schedule sync down for %@%@", buf, 0x20u);
  }

  if (!objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D10DA0]))
  {
    if (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D10E20]))
    {
    ...
    if (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D11150]))
    {
...
LABEL_51:
        ...
        if (-[CKServerChangeToken hasValue:forName:](v14, "hasValue:forName:", *MEMORY[0x1E0D10BF8], *MEMORY[0x1E0D10BF0]))
        {
          brc_bread_crumbs();
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self.group%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __32__BRCPeriodicSyncOperation_main__block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    v26 = 2112;
    v27 = v8;
    _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx completed fetching changed zone\nzones: %@%@", buf, 0x20u);
  }
  ...
  if (!v5)
  {
    if (!v6)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: No error found"));
...
void __32__BRCPeriodicSyncOperation_main__block_invoke_16(uint64_t a1)
{
  ...
  else
  {
    ...
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "objectForKey:", *MEMORY[0x1E0C94940]);
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136315394;
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEFAULT, "[NOTICE] scheduled a %s periodic sync%@", buf, 0x16u);
    }
...
- (void)scheduleSyncDownIfNeededForZoneID:zoneIfAny:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] container-metadata appears to be out of sync in the periodic check, forcing sync%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)scheduleSyncDownIfNeededForZoneID:zoneIfAny:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] zone health appears to be out of sync in the periodic check, forcing sync%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)scheduleSyncDownIfNeededForZoneID:zoneIfAny:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] side-car appears to be out of sync in the periodic check, forcing sync%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)scheduleSyncDownIfNeededForZoneID:zoneIfAny:.cold.4()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, (uint64_t)v0, "[NOTIF] Enhanced Drive Privacy enablement detected via periodic sync for %@%@", v1);
  OUTLINED_FUNCTION_2();
}
...
- (void)scheduleSyncDownIfNeededForZoneID:(uint64_t)a3 zoneIfAny:.cold.5(void *a1, uint64_t a2, uint64_t a3)
{
  ...
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v6, v4, "[DEBUG] Not considering %@ for periodic sync because it is blocked from sync%@", v5);
...
- (void)scheduleSyncDownIfNeededForZoneID:(uint64_t)a3 zoneIfAny:.cold.6(void *a1, uint64_t a2, uint64_t a3)
{
  ...
  OUTLINED_FUNCTION_10((uint64_t)a1, a2, a3, 5.778e-34);
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v6, v4, "[DEBUG] %@ appears to be out of sync in the periodic check, forcing sync%@", v5);
...
void __32__BRCPeriodicSyncOperation_main__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] can't fetch all changed zones: %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __32__BRCPeriodicSyncOperation_main__block_invoke_2_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: No error found%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
