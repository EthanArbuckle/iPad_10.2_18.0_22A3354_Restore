...
- (BOOL)_finishIfBlockedFromListing
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      v9 = 138412290;
      v10 = v5;
      _os_log_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] Can't list anymore in the middle of a rec-list operation%@", (uint8_t *)&v9, 0xCu);
    }
    ...
    while (1)
    {
      ...
      if (objc_msgSend(v11, "isDocumentsFolder"))
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v24 = v16;
          _os_log_fault_impl(&dword_1CBD43000, v12, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: !childID.isDocumentsFolder%@", buf, 0xCu);
        }
      ...
      if (objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 528), "containsObject:", v11))
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v24 = v17;
          _os_log_fault_impl(&dword_1CBD43000, v15, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: ![self->_itemsToList containsObject:childID]%@", buf, 0xCu);
        }
    ...
    if (v2)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v34 = 2112;
        v35 = v4;
        _os_log_debug_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ listing next item %@%@", buf, 0x20u);
        ...
        if ((objc_msgSend(v2, "isEqualToItemID:", *(_QWORD *)(v8 + 536)) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            v32 = 2112;
            v33 = v15;
            _os_log_impl(&dword_1CBD43000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] ItemID %@ isn't able to be listed%@", buf, 0x16u);
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "finishIfCancelled") & 1) == 0)
  {
    if (objc_msgSend(v3, "brc_isIgnorableListDirectoryError"))
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
      {
        ...
        v12 = 2112;
        v13 = v4;
        _os_log_debug_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Continuing %@ after encountering a ignorable error for %@%@", (uint8_t *)&v8, 0x20u);
...
{
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, a2, a3, "[CRIT] Assertion failed: ![self->_itemsFailedListing containsObject:itemID]%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
