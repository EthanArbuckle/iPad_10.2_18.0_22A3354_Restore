...
- (BRCCollaborationUploadOperation)initWithRecord:(id)a3 progress:(id)a4 syncContext:(id)a5 sessionContext:(id)a6
{
  ...
  if (v18)
  {
    ...
    objc_msgSend(MEMORY[0x1E0C94F88], "br_collaborationUpload");
...
- (void)main
{
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, a2, a3, "[DEBUG] Starting the upload operation%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
...
void __39__BRCCollaborationUploadOperation_main__block_invoke(uint64_t a1, void *a2, double a3)
{
  ...
  if (a3 < 0.0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v11 = 2112;
      v12 = v6;
      _os_log_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] Upload: Received negative progress from CK. progress [%f]%@", (uint8_t *)&v9, 0x16u);
    }
...
void __39__BRCCollaborationUploadOperation_main__block_invoke_138(uint64_t a1, void *a2, void *a3, void *a4)
{
  id v7;
  id v8;
  void *v9;
