...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing.fetch-user-record-id", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  objc_msgSend(v3, "setDesiredKeys:", MEMORY[0x1E0C9AA60]);
...
void __44__BRCSharingFetchUserRecordIDOperation_main__block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: no record and no error%@", (uint8_t *)&v2, 0xCu);
}
