...
- (void)_init
{
  ...
  v3 = *MEMORY[0x1E0D838B8];
  v23[0] = *MEMORY[0x1E0D838B0];
  v23[1] = v3;
  v24[0] = CFSTR("bird");
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", +[BRCAnalyticsReporter isTelemetryReportingEnabled](BRCAnalyticsReporter, "isTelemetryReportingEnabled"));
...
- (void)init
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_1CBD43000, a2, (os_log_type_t)0x90u, "[ERROR] BRCRTCReporter Failed to start%@", (uint8_t *)&v2, 0xCu);
}
