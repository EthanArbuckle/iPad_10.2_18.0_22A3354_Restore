...
- (void)encounteredErrorWithPCSState:(unsigned int)a3 enhancedDrivePrivacyEnabled:(BOOL)a4 privateDB:(BOOL)a5 atDate:(id)a6
{
  ...
  {
    v18 = v17;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", objc_msgSend(v17, "longLongValue") + 1);
...
- (void)encounteredErrors:(unint64_t)a3 atDate:(id)a4
{
  ...
  objc_msgSend(v6, "pairWithLeft:andRight:", &unk_1E87D7130, v10);
  ...
  {
    v12 = v11;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", objc_msgSend(v11, "unsignedLongLongValue") + a3);
...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("<%@:%p e:%@ ppcs:%@ spcs:%@>"), objc_opt_class(), self, self->_error, self->_privateDBErrorCountByPCSAndEDPState, self->_shareDBErrorCountByPCSAndEDPState);
}
