...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing/lookup-participants", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94E50]), "initWithUserIdentityLookupInfos:", self->_userIdentities);
...
void __45__BRCSharingLookupParticipantsOperation_main__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (!v3)
  {
    ...
    if (v9 == objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 520), "count"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        v20 = 2112;
        v21 = (uint64_t)v10;
        _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] fetched share participants: %@%@", (uint8_t *)&v18, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
      {
        ...
        v22 = 2112;
        v23 = v12;
        _os_log_fault_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Unexpected number of share participants: expected %lu got %lu%@", (uint8_t *)&v18, 0x20u);
      }

      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10B70], 15, CFSTR("Unexpected number of share participants"));
  ...
  if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
  {
    ...
    v22 = 2112;
    v23 = v5;
    _os_log_error_impl(&dword_1CBD43000, v6, (os_log_type_t)0x90u, "[ERROR] failed share participant lookup for %@ - %@%@", (uint8_t *)&v18, 0x20u);
  }
