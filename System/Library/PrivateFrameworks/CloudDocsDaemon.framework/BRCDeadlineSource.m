...
- (id)description
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("<deadline %@: %@>"), self->_name, v4);
...
- (void)resume
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: _suspendCount >= 0%@", (uint8_t *)&v2, 0xCu);
}
