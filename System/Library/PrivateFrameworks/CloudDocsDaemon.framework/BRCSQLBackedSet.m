...
+ (id)_databaseRootDirectory
{
  ...
  if (objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0D10BD8]))
  {
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v29, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v51 = 2112;
      v52 = v28;
      _os_log_error_impl(&dword_1CBD43000, v29, (os_log_type_t)0x90u, "[ERROR] Failed creating root folder for DB: %@. %@%@", buf, 0x20u);
    }
...
void __54__BRCSQLBackedSet_initArrayOfClass_withSQLType_error___block_invoke_11(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_error_impl(&dword_1CBD43000, v9, (os_log_type_t)0x90u, "[ERROR] sqlite error handler called - %@ (%@)%@", (uint8_t *)&v11, 0x20u);
  }
...
void __54__BRCSQLBackedSet_initArrayOfClass_withSQLType_error___block_invoke_13(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_error_impl(&dword_1CBD43000, v9, (os_log_type_t)0x90u, "[ERROR] Auto rollback handler called - %@ (%@)%@", (uint8_t *)&v11, 0x20u);
  }
...
LABEL_17:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorInvalidParameter:value:", CFSTR("object"), 0);
    v10 = (id)objc_claimAutoreleasedReturnValue();
    if (v10)
    {
      brc_bread_crumbs();
...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("<%@ count:%lu>"), objc_opt_class(), self->_count);
}
...
- (void)initArrayOfClass:withSQLType:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_debug_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Opening db at: %@%@", v1, 0x16u);
}
...
void __54__BRCSQLBackedSet_initArrayOfClass_withSQLType_error___block_invoke_cold_1()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] db corruption handler called: %@%@", v1, 0x16u);
}
