...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_sharedZone);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((has & 0x20) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_nonDiscretionary);
...
LABEL_21:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_hasForegroundClients);
  ...
  {
LABEL_22:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isPCSChained);
...
LABEL_23:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_eventTimestamp);
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isEnhancedDrivePrivacyEnabled);
