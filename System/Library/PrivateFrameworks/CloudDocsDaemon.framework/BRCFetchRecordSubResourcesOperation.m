...
LABEL_10:
    ...
    *((_QWORD *)v19 + 70) = v41;
    ...
    v44 = (const dispatch_source_type_s *)MEMORY[0x1E0C80D78];
    v45 = dispatch_source_create(MEMORY[0x1E0C80D78], 0, 0, v43);
    ...
    *((_QWORD *)v19 + 74) = v48;
    ...
    v54 = v52;
    v55 = v54;
    v56 = (void (**)(id))MEMORY[0x1E0D11070];
    v57 = v54;
    if (*MEMORY[0x1E0D11070])
    {
      ((void (*)(_QWORD *))*MEMORY[0x1E0D11070])(v54);
...
void __149__BRCFetchRecordSubResourcesOperation_initAndScheduleWithServerZone_parentOperation_pendingChangesStream_contentRecordsFetchedInline_sessionContext___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v11 = 2112;
    v12 = v2;
    _os_log_debug_impl(&dword_1CBD43000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ scheduling xattr fetch%@", buf, 0x20u);
...
void __149__BRCFetchRecordSubResourcesOperation_initAndScheduleWithServerZone_parentOperation_pendingChangesStream_contentRecordsFetchedInline_sessionContext___block_invoke_7(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v11 = 2112;
    v12 = v2;
    _os_log_debug_impl(&dword_1CBD43000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ scheduling deserialize%@", buf, 0x20u);
...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "fetch-record-subresources", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
    ...
    if ((objc_msgSend(v4, "brc_isInterestingRecordForSyncDown") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v154 = 2112;
        v155 = v15;
        _os_log_impl(&dword_1CBD43000, v29, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ got a record we're not interested in: '%@'%@", buf, 0x20u);
    ...
    if ((objc_msgSend(v4, "brc_isInterestingRecordForSave") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v154 = 2112;
        v155 = v33;
        _os_log_debug_impl(&dword_1CBD43000, v34, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ ignoring record we're not interested in saving named: %@%@", buf, 0x20u);
    ...
    else if (!-[BRCPendingChangesStream hasFetchRecordByID:](self->_pendingChangesStream, "hasFetchRecordByID:", v27))
    {
      ...
      if (os_log_type_enabled(v106, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v154 = 2112;
        v155 = v105;
        _os_log_debug_impl(&dword_1CBD43000, v106, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ needs to fetch shareID %@%@", buf, 0x20u);
...
LABEL_28:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v154 = 2112;
          v155 = v46;
          _os_log_debug_impl(&dword_1CBD43000, v47, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ needs to fetch xattr signature %@%@", buf, 0x20u);
    ...
    if (v49)
    {
      ...
      v53 = objc_alloc(MEMORY[0x1E0C95070]);
      ...
      if (v56)
      {
        ...
        if (os_log_type_enabled(v58, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v154 = 2112;
          v155 = v57;
          _os_log_debug_impl(&dword_1CBD43000, v58, OS_LOG_TYPE_DEBUG, "[DEBUG] Release block %@ on %@%@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            v154 = 2112;
            v155 = v141;
            _os_log_impl(&dword_1CBD43000, v81, OS_LOG_TYPE_DEFAULT, "[WARNING] Expected recordIDBlockingSave %@ got %@%@", buf, 0x20u);
        ...
        if (!v91)
        {
          ...
          if (os_log_type_enabled(v94, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            v154 = 2112;
            v155 = v93;
            _os_log_debug_impl(&dword_1CBD43000, v94, OS_LOG_TYPE_DEBUG, "[DEBUG] Block %@ on %@%@", buf, 0x20u);
...
LABEL_82:
    ...
    if ((objc_msgSend(v62, "isEqualToString:", CFSTR("structure")) & 1) != 0)
    {
      ...
      if (v64)
      {
        ...
        v68 = (void *)v67;
        v69 = objc_alloc(MEMORY[0x1E0C95070]);
        -[BRCFetchSubResourceRecord zoneID](v15, "zoneID");
          ...
          if (!v107)
          {
            ...
            if (os_log_type_enabled(v112, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138412802;
              ...
              v154 = 2112;
              v155 = v111;
              _os_log_debug_impl(&dword_1CBD43000, v112, OS_LOG_TYPE_DEBUG, "[DEBUG] Block %@ on %@%@", buf, 0x20u);
        ...
        if (v36 || v79 || v78)
        {
          ...
          if (os_log_type_enabled(v101, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            _os_log_debug_impl(&dword_1CBD43000, v101, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ record changed %@ which needs subResources fetched%@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v97, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            v154 = 2112;
            v155 = v96;
            _os_log_debug_impl(&dword_1CBD43000, v97, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ record changed %@%@", buf, 0x20u);
...
LABEL_100:
    ...
    v74 = objc_msgSend(v73, "isEqualToString:", *MEMORY[0x1E0C94A20]);
    ...
    if (!v71)
    {
      ...
      if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v152 = 2112;
        v153 = v75;
        _os_log_impl(&dword_1CBD43000, v76, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't determine record type for root share record %@%@", buf, 0x16u);
      }

    }
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0
      && objc_msgSend(v71, "isEqualToString:", *MEMORY[0x1E0D10D48]))
    {
  ...
  if (!self->_error && (-[BRCFetchRecordSubResourcesOperation isCancelled](self, "isCancelled") & 1) == 0)
  {
    ...
    else if (!-[BRCPendingChangesStream hasFetchRecordByID:](self->_pendingChangesStream, "hasFetchRecordByID:", v6))
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        _os_log_debug_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ scheduling recordID deserialize for %@%@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v30 = 2112;
      v31 = v9;
      _os_log_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ has no need to deserialize %@ because we've already fetch it%@", buf, 0x20u);
    ...
    if (objc_msgSend(v4, "brc_isZoneRootRecordID"))
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v34 = 2112;
        v35 = v6;
        _os_log_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ Zone root record ID was deleted %@%@", buf, 0x20u);
    ...
    else if (objc_msgSend(v4, "brc_isAppLibraryRootRecordID"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v34 = 2112;
        v35 = v10;
        _os_log_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ App library root record ID was deleted %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v34 = 2112;
        v35 = v9;
        _os_log_debug_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ record ID was deleted %@%@", buf, 0x20u);
  ...
  if (!self->_error && (-[BRCFetchRecordSubResourcesOperation isCancelled](self, "isCancelled") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_debug_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ share ID was deleted %@%@", buf, 0x20u);
...
- (void)stopWithError:(id)a3
{
  ...
  if (!self->_isDoneFetchingRecords)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v16 = 2112;
      v17 = v7;
      _os_log_debug_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ stopping fetching records with error %@%@", (uint8_t *)&v12, 0x20u);
...
- (void)cancel
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, (uint64_t)v0, "[DEBUG] cancelling %@%@", v1);
  OUTLINED_FUNCTION_2();
}
...
- (void)stop
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _xattrFetchingGroup == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (BOOL)_willFetchRecordForDeserialize:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: Fetch loop trying to fetch %@"), v4);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_scheduleDeserialize
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _deserializeState != BRCDeserializeStateWaitingForNextBatchSave%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
LABEL_4:
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v59 = 2112;
      v60 = v12;
      _os_log_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] We deserialized record id %@ which was useless because it came later%@", buf, 0x16u);
    }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v43, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v63 = 2112;
      v64 = v42;
      _os_log_error_impl(&dword_1CBD43000, v43, (os_log_type_t)0x90u, "[ERROR] %@ Deserialize record failed for %@ - %@%@", buf, 0x2Au);
...
void __59__BRCFetchRecordSubResourcesOperation__scheduleDeserialize__block_invoke_30(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if ((objc_msgSend(v4, "brc_isCloudKitCancellationError") & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v20 = 2112;
      v21 = v5;
      _os_log_debug_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] failed to deserialize records for %@: %@%@", (uint8_t *)&v16, 0x20u);
LABEL_22:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      v20 = 2112;
      v21 = v5;
      _os_log_error_impl(&dword_1CBD43000, v6, (os_log_type_t)0x90u, "[ERROR] failed to deserialize records for %@: %@%@", (uint8_t *)&v16, 0x20u);
      goto LABEL_22;
    }
  }
...
LABEL_16:
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      v20 = 2112;
      v21 = v12;
      _os_log_debug_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ finished fetching record batch to deserialize%s%@", (uint8_t *)&v16, 0x20u);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2112;
    v21 = v9;
    _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ encountered an operation error so we should stop %@%@", (uint8_t *)&v16, 0x20u);
...
LABEL_4:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    v21 = 2112;
    v22 = v11;
    _os_log_debug_impl(&dword_1CBD43000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ has sub resource that no longer has info to fetch %@ -> %@%@", (uint8_t *)&v15, 0x2Au);
      ...
      do
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v26 = 2112;
          v27 = v8;
          _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] %@%@", buf, 0x16u);
        }
...
- (void)_scheduleXattrFetch
{
  ...
  v6 = 2112;
  v7 = a2;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a3, (uint64_t)a3, "[DEBUG] ┣%llx running the xattr fetch operation%@", (uint8_t *)&v4);
  OUTLINED_FUNCTION_2();
}
...
void __58__BRCFetchRecordSubResourcesOperation__scheduleXattrFetch__block_invoke_36(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v76 = 2112;
    v77 = (uint64_t)v6;
    _os_log_debug_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx %@ finished fetching xattrs%@", buf, 0x20u);
    ...
    if ((objc_msgSend(v5, "brc_isCloudKitCancellationError") & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v76 = 2112;
        v77 = (uint64_t)v8;
        _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] failed to fetch xattr assets for %@: %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v76 = 2112;
        v77 = (uint64_t)v8;
        _os_log_error_impl(&dword_1CBD43000, v9, (os_log_type_t)0x90u, "[ERROR] failed to fetch xattr assets for %@: %@%@", buf, 0x20u);
              ...
              if ((v23 & 1) != 0)
              {
                ...
                if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
                {
                  ...
                  *(_DWORD *)buf = 138413058;
                  ...
                  v78 = 2112;
                  v79 = v24;
                  _os_log_debug_impl(&dword_1CBD43000, v25, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ saved xattr for signature: %@ sz:%lld%@", buf, 0x2Au);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v27, (os_log_type_t)0x90u))
                {
                  ...
                  *(_DWORD *)buf = 138413058;
                  ...
                  v78 = 2112;
                  v79 = v26;
                  _os_log_error_impl(&dword_1CBD43000, v27, (os_log_type_t)0x90u, "[ERROR] %@ failed to store xattr for signature: %@ - %@%@", buf, 0x2Au);
...
LABEL_42:
  ...
  if (os_log_type_enabled(v46, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v78 = 2112;
    v79 = v45;
    _os_log_fault_impl(&dword_1CBD43000, v46, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Received %lu xattr records instead of expected %lu records for %@%@", buf, 0x2Au);
  ...
  objc_msgSend(*(id *)(v58 + 32), "name");
  v50 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v47, "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: Received %lu xattr records instead of expected %lu records for %@"), v48, v49, v50);
...
- (void)_createSubResourceGroupsFromPendingChangesStreamIfNecessary
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Creating _deserializeGroup because we have more records to deserialize in _pendingChangesStream%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_prepareToSaveRecords
{
  ...
  v7 = v5;
  v8 = 2048;
  v9 = OUTLINED_FUNCTION_9_4(520);
  v10 = 2048;
  v11 = OUTLINED_FUNCTION_9_4(528);
  v12 = 2048;
  v13 = OUTLINED_FUNCTION_9_4(552);
  v14 = 2112;
  v15 = a2;
  _os_log_debug_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ preparing to save record batch with %lu in memory items %lu subresource items %lu moved zone names%@", (uint8_t *)&v6, 0x34u);
...
void __60__BRCFetchRecordSubResourcesOperation__prepareToSaveRecords__block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if ((objc_msgSend(v7, "sharingOptions") & 0x48) != 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v29 = 2112;
      v30 = v9;
      _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ no longer needs to fetch shareID in %@ from server truth check%@", (uint8_t *)&v25, 0x20u);
  ...
  if (v14)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
      {
        ...
        v29 = 2112;
        v30 = v16;
        _os_log_debug_impl(&dword_1CBD43000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ is no longer blocked for save in %@ from server truth check%@", (uint8_t *)&v25, 0x20u);
...
void __60__BRCFetchRecordSubResourcesOperation__prepareToSaveRecords__block_invoke_43(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ is no longer blocked for save in %@ from server truth check%@", (uint8_t *)&v15, 0x20u);
          ...
          if ((pendingChangesStream & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138412802;
              ...
              v51 = 2112;
              v52 = v20;
              _os_log_impl(&dword_1CBD43000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] We need to fetch %@ to unblock %@ from saving, but it wasn't found.  Forcing fetch%@", buf, 0x20u);
            ...
            if (!v2->_deserializeGroup)
            {
              ...
              if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
              {
                *(_DWORD *)buf = v41;
                v48 = (uint64_t)v26;
                _os_log_debug_impl(&dword_1CBD43000, v27, OS_LOG_TYPE_DEBUG, "[DEBUG] Creating _deserializeGroup because we have more records to deserialize in memory%@", buf, 0xCu);
              }
  ...
  if (v33)
  {
    ...
    if (os_log_type_enabled(v35, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v51 = 2112;
      v52 = v34;
      _os_log_error_impl(&dword_1CBD43000, v35, (os_log_type_t)0x90u, "[ERROR] We need to fetch %llu records in the pending changes stream to allow saving for %@.  Forcing fetch%@", buf, 0x20u);
  ...
  if (!error)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413570;
      ...
      v59 = 2112;
      v60 = v13;
      _os_log_debug_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ saving records with server change token:%@ requestID:%llu caught up:%s directly:%s%@", buf, 0x3Eu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          v51 = 2112;
          v52 = (uint64_t)v25;
          _os_log_impl(&dword_1CBD43000, v26, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ Allocating ranks failed when not caught up.  We'll save to pending changes from now on%@", buf, 0x16u);
  ...
  if (!self->_error)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_WORD *)&v59[22] = 2080;
      ...
      v61 = 2112;
      v62 = v8;
      _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ saving records with query cursor:%@ directly:%s%@", v59, 0x2Au);
    ...
    else
    {
      ...
      if (v13)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          v57 = 2112;
          v58 = v27;
          _os_log_impl(&dword_1CBD43000, v28, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ got a (temporary) broken structure while listing directory contents%@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v56 = v33;
        _os_log_impl(&dword_1CBD43000, v34, OS_LOG_TYPE_DEFAULT, "[WARNING] Allocating ranks failed when not caught up and listing.  We'll save to pending changes from now on%@", buf, 0xCu);
      }
...
- (void)records
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _subResourceRecordsByID.count == 0 && _pendingChangesStream == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)initAndScheduleWithServerZone:parentOperation:pendingChangesStream:contentRecordsFetchedInline:sessionContext:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: serverZone && parentOperation%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)addRecord:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _recordsByID[recordID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)addRecord:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: ![_deletedRecordIDs containsObject:recordID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)addRecord:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: ![_deletedShareIDs containsObject:recordID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)addRecord:.cold.7()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: [contentRecordName hasPrefix:kBRRecordIDPrefixContent]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)addRecord:.cold.8()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !_isDoneFetchingRecords%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)addRecordIDToDeserialize:recordType:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _subResourceRecordsByID[recordID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)shareIDWasDeleted:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: ![_deletedShareIDs containsObject:shareID]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)shareIDWasDeleted:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _recordsByID[shareID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_notifyWhenRecordsAreFetched:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Wait on _deserializeGroup to remaining records to deserialize%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __68__BRCFetchRecordSubResourcesOperation__notifyWhenRecordsAreFetched___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Wait on _xattrFetchingGroup to remaining xattrs records%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)notifyWhenCaughtUp:whenRecordsAreFetchedAndFinish:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Not fetching records blocking save because we aren't caught up%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)notifyWhenCaughtUp:whenRecordsAreFetchedAndFinish:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _recordsByID.count == 0 && _deletedShareIDs.count == 0 && _deletedRecordIDs.count == 0 && _subResourceRecordsByID.count == 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)notifyWhenCaughtUp:whenRecordsAreFetchedAndFinish:.cold.3()
{
  ...
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, v3, "[DEBUG] %@ waiting to fetch all records%@", v4);
...
void __89__BRCFetchRecordSubResourcesOperation_notifyWhenCaughtUp_whenRecordsAreFetchedAndFinish___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Done waiting on deserialize/xattr groups%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)stopWithError:.cold.1()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, v3, "[DEBUG] %@ resuming deserialize source which was waiting for batch save%@", v4);
...
- (void)finishWithResult:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _queryFinishedClientTruthCallback == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)finishWithResult:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _queryFinishedServerTruthCallback == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)finishWithResult:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self.cancelled || _deserializeGroup == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)finishWithResult:error:.cold.4()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self.cancelled || _xattrFetchingGroup == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)finishWithResult:error:.cold.5()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, v3, "[DEBUG] %@ finished record fetcher%@", v4);
...
- (void)_willFetchRecordForDeserialize:.cold.1()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  _os_log_fault_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Fetch loop trying to fetch %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
void __59__BRCFetchRecordSubResourcesOperation__scheduleDeserialize__block_invoke_28_cold_1()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] We can't find a record which really should exist - %@.  Unblocking other records from save%@", v1, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
void __58__BRCFetchRecordSubResourcesOperation__scheduleXattrFetch__block_invoke_36_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v5 = 2112;
  v6 = a1;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a3, (uint64_t)a3, "[DEBUG] Removed xattr requirement from %lld in-memory subResourceRecords%@", (uint8_t *)&v3);
  OUTLINED_FUNCTION_2();
}
...
- (void)saveRecordsWithServerChangeToken:clientChangeToken:syncStatus:.cold.1()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, v3, "[DEBUG] %@ recreating pending changes stream with updated change token%@", v4);
...
- (void)saveRecordsWithServerChangeToken:clientChangeToken:syncStatus:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !_queryFinishedClientTruthCallback%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)saveRecordsWithServerChangeToken:clientChangeToken:syncStatus:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !_queryFinishedServerTruthCallback%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)saveRecordsWithQueryCursor:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _pendingChangesStream%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)saveRecordsWithQueryCursor:(uint64_t)a3 .cold.2(void *a1, uint64_t a2, uint64_t a3, NSObject *a4)
{
  ...
  *(_WORD *)(a3 + 12) = 2112;
  *(_QWORD *)(a3 + 14) = a2;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a4, a3, "[DEBUG] %@ Destroying pending changes db because we are done with it%@", (uint8_t *)a3);
...
- (void)saveRecordsWithQueryCursor:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _pendingChangesStream || !cursor%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
