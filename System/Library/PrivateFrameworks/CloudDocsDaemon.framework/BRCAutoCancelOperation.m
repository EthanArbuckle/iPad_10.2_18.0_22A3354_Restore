...
void __48__BRCAutoCancelOperation__initializeCancelTimer__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    v4 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, *(dispatch_queue_t *)(a1 + 32));
...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "BRCAutoCancelOperation/? (subclass activity missing)", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
void __48__BRCAutoCancelOperation__initializeCancelTimer__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] No one is waiting on %@ anymore so cancelling%@");
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCAutoCancelOperation__initializeCancelTimer__block_invoke_2_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] We have observers again for %@ so not cancelling yet%@");
  OUTLINED_FUNCTION_2();
}
