...
- (BRCClientState)init
{
  return -[BRCClientState initWithDictionary:clientStateData:](self, "initWithDictionary:clientStateData:", MEMORY[0x1E0C9AA70], 0);
}
...
- (id)_stateToData
{
  ...
  dict = self->_dict;
  v10 = 0;
  objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", dict, 1, &v10);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
  {
    abc_report_panic_with_signature();
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unexpected error while converting client state to data!"));
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
      __48__BRCDaemon_listener_shouldAcceptNewConnection___block_invoke_106_cold_1(v6, (uint64_t)v7, v8);
