...
- (id)_getChangesStreamSafeDBHolder
{
  ...
  v35[4] = v11;
  v14 = (void (**)(_QWORD))MEMORY[0x1D17A6DB0](v35);
  ...
  while (1)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = v12;
      ...
      v15 = 2112;
      v16 = v9;
      _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Closing changes stream %@%@", buf, 0x16u);
    }
  ...
  if (dbHasOpened)
  {
    ...
    if ((v12 & 1) == 0)
    {
      ...
      if ((v13 & 1) == 0)
      {
        ...
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        if (objc_msgSend(v17, "isEqualToString:", *MEMORY[0x1E0DE81E8]))
        {
...
- (id)initForListingWithParent:(id)a3 serverZone:(id)a4
{
  ...
  if (v8)
  {
    ...
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    v22 = objc_msgSend(v21, "isEqualToString:", *MEMORY[0x1E0C94730]);
    if ((v22 & 1) != 0)
    {
      v23 = &stru_1E8769030;
    }
...
uint64_t __51__BRCPendingChangesStream__createSchemaIfNecessary__block_invoke(uint64_t a1, void *a2)
{
  ...
  +[BRCUserDefaults defaultsForMangledID:](BRCUserDefaults, "defaultsForMangledID:", 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), objc_msgSend(v5, "sqliteCacheSize"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld"), objc_msgSend(v5, "sqliteCacheSpill"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)MEMORY[0x1E0DE81E0];
...
- (void)_openDB
{
  ...
  *(_WORD *)(a3 + 12) = 2112;
  *(_QWORD *)(a3 + 14) = a2;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a4, a3, "[DEBUG] database is opening so creating at %@%@", (uint8_t *)a3);
...
void __34__BRCPendingChangesStream__openDB__block_invoke_159(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
  {
    ...
    v21 = 2112;
    v22 = v10;
    _os_log_error_impl(&dword_1CBD43000, v11, (os_log_type_t)0x90u, "[ERROR] sqlite error handler called on pending sync db - %@ (%@)%@", (uint8_t *)&v17, 0x20u);
  }
...
void __34__BRCPendingChangesStream__openDB__block_invoke_163(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
  {
    ...
    v21 = 2112;
    v22 = v10;
    _os_log_error_impl(&dword_1CBD43000, v11, (os_log_type_t)0x90u, "[ERROR] Auto rollback handler called on pending sync db - %@ (%@)%@", (uint8_t *)&v17, 0x20u);
  }
...
- (void)_closeChangeStream
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@ - Closing the database (setting to nil)%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)fetchTokenState:(id)a3
{
  ...
  if (self->_hasBeenCreated)
  {
    ...
    if (!self->_error)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: Trying to fetch token state without a db"));
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: There should always be one entry"));
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        v2 = 0;
        v10 = 1;
      }
...
- (void)fetchQueryCursor:(id)a3
{
  ...
  if (self->_hasBeenCreated)
  {
    ...
    if (!self->_error)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: Trying to fetch query cursor without a db"));
      v11 = (NSError *)objc_claimAutoreleasedReturnValue();
      error = self->_error;
      self->_error = v11;
...
- (BOOL)enumerateRecordsOfType:(int64_t)a3 block:(id)a4
{
  ...
  if (self->_hasBeenCreated)
  {
    ...
    if (!self->_error)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: Trying to enumerate records without a db"));
...
LABEL_3:
  ...
  {
    dispatch_once(&_recordTypeFromRecordID_isShare_isDelete__onceToken, &__block_literal_global_192);
    if (a4)
      goto LABEL_3;
  }
    ...
    for (i = 0; i != v5; ++i)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412290;
        v87 = v22;
        _os_log_fault_impl(&dword_1CBD43000, v23, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rc && db.changes == 1%@", buf, 0xCu);
      }
      ...
      if (objc_msgSend(v3, "changes"))
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          v88 = 2112;
          v89 = (uint64_t)v18;
          _os_log_impl(&dword_1CBD43000, v19, OS_LOG_TYPE_DEFAULT, "[WARNING] Removed item in pending resources table because it was saved %@%@", buf, 0x16u);
  ...
  while (2)
  {
    ...
    while (2)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412290;
        v87 = v33;
        _os_log_fault_impl(&dword_1CBD43000, v34, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rc && db.changes == 1%@", buf, 0xCu);
      }
        ...
        if (objc_msgSend(v3, "changes"))
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v88 = 2112;
            v89 = v6;
            _os_log_impl(&dword_1CBD43000, v32, OS_LOG_TYPE_DEFAULT, "[WARNING] Removed item in pending resources table because it was deleted %@%@", buf, 0x16u);
          }
  ...
  while (2)
  {
    ...
    while (2)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412290;
        v87 = v66;
        _os_log_fault_impl(&dword_1CBD43000, v43, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rc && db.changes == 1%@", buf, 0xCu);
      }
          ...
          if (objc_msgSend(v3, "changes"))
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138412546;
              ...
              v46 = 2112;
              v47 = v27;
              _os_log_debug_impl(&dword_1CBD43000, v28, OS_LOG_TYPE_DEBUG, "[DEBUG] Deleted %@ from the pending subResources table because it was persisted directly to the server truth%@", buf, 0x16u);
...
- (BOOL)hasRecordIDsToDeserialize
{
  ...
  else
  {
    objc_msgSend(v3, "db");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = objc_msgSend(v6, "performWithFlags:action:", 1, &__block_literal_global_218_0);
    ...
    if (objc_msgSend(v7, "changes"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v31 = 2112;
        v32 = v10;
        _os_log_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Removed recordID %@ from record changes table because it now needs sub resources%@", buf, 0x16u);
  ...
  if (objc_msgSend(v7, "changes"))
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v33 = 2112;
      v34 = error;
      _os_log_debug_impl(&dword_1CBD43000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] Unblocked %lld records waiting on save of %@ even though it's a sub-resource record%@", buf, 0x20u);
        ...
        if (objc_msgSend(v3, "changes"))
        {
          ...
          if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 134218498;
            ...
            v27 = 2112;
            v28 = v10;
            _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items which no longer need to fetch xattr %@%@", buf, 0x20u);
          }
  ...
  if (objc_msgSend(v3, "changes"))
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v24 = 2112;
      v25 = v5;
      _os_log_error_impl(&dword_1CBD43000, v6, (os_log_type_t)0x90u, "[ERROR] We couldn't fetch recordID %@ so it's not going to save. We deleted %lld items from pending subresources table for this%@", buf, 0x20u);
    }
  ...
  if (objc_msgSend(v3, "changes"))
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_error_impl(&dword_1CBD43000, v8, (os_log_type_t)0x90u, "[ERROR] We couldn't fetch recordID %@ so it's not going to save. We marked %lld as not needing fetch anymore%@", buf, 0x20u);
    }
  ...
  if (objc_msgSend(v3, "changes"))
  {
    ...
    if (os_log_type_enabled(v10, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v24 = 2112;
      v25 = v9;
      _os_log_error_impl(&dword_1CBD43000, v10, (os_log_type_t)0x90u, "[ERROR] We couldn't fetch recordID %@ so it's not going to save. We marked %lld as not blocked for save anymore%@", buf, 0x20u);
    }
  ...
  if (objc_msgSend(v3, "execute:", CFSTR("UPDATE records_needing_subresources SET record_id_blocking_save = NULL WHERE record_id = %@ AND record_id_blocking_save = %@"), *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40))&& objc_msgSend(v3, "changes"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_debug_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Unblocked record %@ blocked on record %@%@", buf, 0x20u);
  ...
  if (objc_msgSend(v6, "changes"))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items to be unblocked for fetching %@%@", buf, 0x20u);
    }
    ...
    if (objc_msgSend(v6, "changes"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 134218498;
        ...
        v21 = 2112;
        v22 = v10;
        _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items to be unblocked for saving %@%@", buf, 0x20u);
      }
...
- (void)destroyDatabase
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@ - Destroying the database%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_getChangesStreamSafeDBHolder
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Opening changes stream %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_dbBecameCorrupted:withDescription:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Deleting database at path: %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_dbBecameCorrupted:withDescription:.cold.2()
{
  ...
  OUTLINED_FUNCTION_9(&dword_1CBD43000, v0, v1, "[ERROR] We are in an error scenario, trying to close the DB, but it's busy - let's avoid dealloc it%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_dbBecameCorrupted:withDescription:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, (uint64_t)v0, "[CRIT] error closing BRCPendingChangesStream DB connection: %@%@", v1);
  OUTLINED_FUNCTION_2();
}
...
- (void)_dropExistingTablesWithDB:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, v3, "[DEBUG] Dropping pending fetch table at %@%@", v4);
...
void __51__BRCPendingChangesStream__createSchemaIfNecessary__block_invoke_cold_1()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, v3, "[CRIT] UNREACHABLE: Failed to set the cache spill - %@%@", v4);
...
void __51__BRCPendingChangesStream__createSchemaIfNecessary__block_invoke_cold_2()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, v3, "[CRIT] UNREACHABLE: Failed to set the cache size - %@%@", v4);
...
void __34__BRCPendingChangesStream__openDB__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_9(&dword_1CBD43000, v0, v1, "[ERROR] db corruption handler called on pending sync db%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __34__BRCPendingChangesStream__openDB__block_invoke_159_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] disk is full - exiting%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)fetchTokenState:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Trying to fetch token state without a db%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __43__BRCPendingChangesStream_fetchTokenState___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: There should always be one entry%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)fetchQueryCursor:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Trying to fetch query cursor without a db%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)enumerateRecordsOfType:block:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Trying to enumerate records without a db%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __56__BRCPendingChangesStream_enumerateRecordsOfType_block___block_invoke_cold_1()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v0, v3, "[CRIT] UNREACHABLE: Failed enumerating records - %@%@", v4);
...
- (void)_recordTypeFromRecordID:isShare:isDelete:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: recordType != 0%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __139__BRCPendingChangesStream_saveEditedRecords_deletedRecordIDs_deletedShareIDs_subResourceEditedRecords_serverChangeToken_clientChangeToken___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_15_2(*MEMORY[0x1E0C80C00]);
  LODWORD(v3) = 138412546;
  *(_QWORD *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v1, v2, "[ERROR] Failed saving to the pending changes stream - %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
void __139__BRCPendingChangesStream_saveEditedRecords_deletedRecordIDs_deletedShareIDs_subResourceEditedRecords_serverChangeToken_clientChangeToken___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Persisted %llu records needing subResource fetch%@");
  OUTLINED_FUNCTION_2();
}
...
void __82__BRCPendingChangesStream_saveEditedRecords_subResourceEditedRecords_queryCursor___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_7_0();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Persisted %llu sub resource records which need fetch%@");
  OUTLINED_FUNCTION_2();
}
...
void __82__BRCPendingChangesStream_saveEditedRecords_subResourceEditedRecords_queryCursor___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_7_0();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Persisted %llu records which are fully fetched%@");
  OUTLINED_FUNCTION_2();
}
...
void __88__BRCPendingChangesStream_saveSubResourceRecords_afterSavingMainTableItems_queryCursor___block_invoke_cold_1()
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v1, v2, "[ERROR] Failed to save subResource records after saving main table items - %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
void __88__BRCPendingChangesStream_saveSubResourceRecords_afterSavingMainTableItems_queryCursor___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_7_0();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Persisted %lld subResource records to the pending changes db%@");
  OUTLINED_FUNCTION_2();
}
...
void __88__BRCPendingChangesStream_saveSubResourceRecords_afterSavingMainTableItems_queryCursor___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, v2, "[DEBUG] Removed %llu records from the pending fetches table because we should have just saved them%@", v3);
}
...
- (void)_finishedFetchingRecordMetadata:withDB:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: db.isInTransaction%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
