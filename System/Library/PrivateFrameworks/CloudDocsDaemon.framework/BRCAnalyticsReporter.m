...
- (void)registerBackgroundXPCActivities
{
  ...
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] iCloud Analytics collection is disabled, unregistering xpc_activity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_waitForApplySchedulerToBeIdleWithCompletion:(id)a3
{
  ...
  v8 = v4;
  v19 = v8;
  v9 = (void (**)(_QWORD, _QWORD))MEMORY[0x1D17A6DB0](v17);
  -[BRCAccountSession applyScheduler](v7, "applyScheduler");
...
- (void)_handleApplySchedulerTimeoutWithActivity:(id)a3 telemetryEventType:(int)a4
{
  ...
  v6 = self->_session;
  -[BRCAccountSession cloudDocsClientZone](v6, "cloudDocsClientZone");
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v26 = v10;
    _os_log_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Telemetry timed out waiting for the apply scheduler%@", buf, 0xCu);
  }
...
- (void)_gatherAppTelemetryEventsWithActivity:(id)a3
{
  ...
  v5 = self->_session;
  -[BRCAccountSession clientTruthWorkloop](v5, "clientTruthWorkloop");
  v6 = objc_claimAutoreleasedReturnValue();
  if (!v6)
    goto LABEL_7;
  v7 = (void *)v6;
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke(uint64_t a1, int a2)
{
  ...
  else
  {
    ...
    v32[1] = 3221225472;
    v32[2] = __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_42;
    v32[3] = &unk_1E875E2C8;
    v33 = *(id *)(a1 + 32);
    ...
    if (v17)
    {
      if ((objc_msgSend(v17, "isDirectory") & 1) != 0)
      {
        ...
        *(_QWORD *)(v19 + 64) = v18;
        ...
        v28[0] = v16;
        v28[1] = 3221225472;
        v28[2] = __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_48;
        v28[3] = &unk_1E875EAD0;
        v29 = v17;
        v27 = *(int8x16_t *)(a1 + 32);
        v22 = (id)v27.i64[0];
...
id __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_42(uint64_t a1, void *a2, uint64_t a3)
{
  void *v4;
  id v5;
  void *v6;
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_48(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  uint64_t v5;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
      __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_48_cold_1(a1);
...
- (void)_setupSyncConsistencyDeferralTimerWithActivity:(id)a3
{
  ...
  else
  {
    ...
    v19[0] = v12;
    v19[1] = 3221225472;
    v19[2] = __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke_50;
    v19[3] = &unk_1E875DC98;
...
void __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke(uint64_t a1)
{
  ...
  if (xpc_activity_should_defer(*(xpc_activity_t *)(a1 + 32)))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      v8 = 138412290;
      v9 = v4;
      _os_log_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEFAULT, "[WARNING] Deferring the sync consistency checker%@", (uint8_t *)&v8, 0xCu);
    }
...
void __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke_50(uint64_t a1)
{
  _QWORD *WeakRetained;
  void *v2;
  _QWORD *v3;
...
- (void)_setupSyncConsistencyCancellationTimerWithActivity:(id)a3 session:(id)a4
{
  ...
  else
  {
    ...
    v24[0] = v16;
    v24[1] = 3221225472;
    v24[2] = __83__BRCAnalyticsReporter__setupSyncConsistencyCancellationTimerWithActivity_session___block_invoke_53;
    v24[3] = &unk_1E875DC98;
...
void __83__BRCAnalyticsReporter__setupSyncConsistencyCancellationTimerWithActivity_session___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    v6 = 138412290;
    v7 = v2;
    _os_log_impl(&dword_1CBD43000, v3, OS_LOG_TYPE_DEFAULT, "[WARNING] Cancelling the sync consistency checker because it timed out%@", (uint8_t *)&v6, 0xCu);
  }
...
void __83__BRCAnalyticsReporter__setupSyncConsistencyCancellationTimerWithActivity_session___block_invoke_53(uint64_t a1)
{
  _QWORD *WeakRetained;
  void *v2;
  _QWORD *v3;
...
- (BOOL)_resumePausedTreeConsistencyCheckOperationWithActivity:(id)a3
{
  ...
  v12[0] = v6;
  v12[1] = 3221225472;
  v12[2] = __79__BRCAnalyticsReporter__resumePausedTreeConsistencyCheckOperationWithActivity___block_invoke_55;
  v12[3] = &unk_1E875EB20;
  v12[4] = &v14;
...
void __79__BRCAnalyticsReporter__resumePausedTreeConsistencyCheckOperationWithActivity___block_invoke_55(uint64_t a1, void *a2)
{
  objc_storeStrong((id *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 40), a2);
}
...
void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke(uint64_t a1, int a2)
{
  ...
  else
  {
    ...
    block[0] = MEMORY[0x1E0C809B0];
    block[1] = 3221225472;
    block[2] = __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_56;
...
void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_56(uint64_t a1)
{
  void *v2;
  uint64_t v3;
  _QWORD v4[5];
...
- (void)_reportSyncUpBackoffInfo
{
  ...
  v27 = 0u;
  v28 = 0u;
  -[BRCAccountSession clientZones](self->_session, "clientZones");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          if (v12 > v15)
          {
            ...
            if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              v33 = 2112;
              v34 = v16;
              _os_log_impl(&dword_1CBD43000, v17, OS_LOG_TYPE_DEFAULT, "[WARNING] Client zone %@ has a sync up backoff ratio of %f which is too large%@", buf, 0x20u);
            }
          ...
          if (v14 > v18)
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              v33 = 2112;
              v34 = v19;
              _os_log_impl(&dword_1CBD43000, v20, OS_LOG_TYPE_DEFAULT, "[WARNING] Client zone %@ has a sync up backoff delay of %f which is too large%@", buf, 0x20u);
            }
      ...
      do
      {
        ...
        if ((v14 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v19;
            v25 = v15;
            _os_log_fault_impl(&dword_1CBD43000, v16, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [metric.eventName isEqualToString:kind]%@", buf, 0xCu);
          }
...
- (void)dumpToContext:(id)a3
{
  ...
  objc_msgSend(v15, "writeLineWithFormat:", &stru_1E8769030);
  ...
  objc_msgSend(v17, "writeLineWithFormat:", &stru_1E8769030, v18, v19, v20, v21);
...
+ (BOOL)isTelemetryReportingEnabled
{
  ...
  if (CFPreferencesGetAppBooleanValue(CFSTR("AllowiCloudAnalytics"), CFSTR("com.apple.Preferences"), 0))
    return 1;
  return objc_msgSend(MEMORY[0x1E0D10ED0], "isInternalBuild");
}
...
void __55__BRCAnalyticsReporter_registerBackgroundXPCActivities__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Failed to defer the activity for analytics%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __55__BRCAnalyticsReporter_registerBackgroundXPCActivities__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Reporting analytics metrics%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_handleApplySchedulerTimeoutWithActivity:telemetryEventType:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Defering app telemetry gather for now%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_handleApplySchedulerTimeoutWithActivity:telemetryEventType:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_9(&dword_1CBD43000, v0, v1, "[ERROR] Failed to defer the app telemetry xpc activity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_handleApplySchedulerTimeoutWithActivity:telemetryEventType:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_9(&dword_1CBD43000, v0, v1, "[ERROR] Failed to finish the app telemetry xpc activity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_gatherAppTelemetryEventsWithActivity:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Finishing app telemetry gather because the session logged out%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_gatherAppTelemetryEventsWithActivity:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_9(&dword_1CBD43000, v0, v1, "[ERROR] Failed to set the app telemetry xpc activity state to done%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_9(&dword_1CBD43000, v0, v1, "[ERROR] Failed to finish the app telemetry activity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: %@ should be a directory%@");
  OUTLINED_FUNCTION_2();
}
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_cold_4(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(*(_QWORD *)a1 + 64);
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v1, v2, "[CRIT] UNREACHABLE: We are already checking telemetry on %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}

void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_48_cold_1(uint64_t a1)
{
  uint64_t v1;
  os_log_t v2;
  __int128 v3;
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(a1 + 32);
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v1, v2, "[ERROR] Failed to generate a report for shared folder %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)_setupSyncConsistencyDeferralTimerWithActivity:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Already have a deferral timer registered%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Can't defer the sync consistency activity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_setupSyncConsistencyCancellationTimerWithActivity:session:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Already have a cancellation timer registered%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_resumePausedTreeConsistencyCheckOperationWithActivity:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Successfully resumed existing tree consistency operation%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_resumePausedTreeConsistencyCheckOperationWithActivity:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Failed resuming tree consistency operation%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __79__BRCAnalyticsReporter__resumePausedTreeConsistencyCheckOperationWithActivity___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] error connecting to telemetry-disk-checker xpc service: %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Failed to defer the xpc activity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Deferring activity because a snapshot already exists%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __66__BRCAnalyticsReporter_createFSEventToSyncUpEventForFileID_genID___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_10_0(&dword_1CBD43000, v1, v2, "[DEBUG] analytics: creating %@ event for fileID %lld%@", v3, v4, v5, v6, 2u);
}
...
void __86__BRCAnalyticsReporter_createUserDownloadEventForOperationID_isRecursive_isForBackup___block_invoke_cold_1()
{
  ...
  v4 = v0;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v1, v2, "[DEBUG] analytics: creating %@ event%@", v3);
  OUTLINED_FUNCTION_2();
}
