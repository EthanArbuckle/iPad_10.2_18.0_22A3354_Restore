    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v38 = 2112;
        v39 = v17;
        _os_log_error_impl(&dword_1CBD43000, v18, (os_log_type_t)0x90u, "[ERROR] couldn't remove domain %@ in a sync way: %@%@", buf, 0x20u);
      }
    }
...
{
  return objc_msgSend(a1, "br_signalEnumeratorForContainerItemIdentifier:completionHandler:", *MEMORY[0x1E0CAABD8], a3);
}
...
- (void)br_removeDomain:()BRCAdditions options:sync:completionHandler:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(_QWORD *)&v3[14] = a2;
  OUTLINED_FUNCTION_0(&dword_1CBD43000, a2, a3, "[DEBUG] Successfully removed domain %@ in a sync way%@", *(_QWORD *)v3, *(_QWORD *)&v3[8], *(_QWORD *)&v3[16]);
  OUTLINED_FUNCTION_2();
}
