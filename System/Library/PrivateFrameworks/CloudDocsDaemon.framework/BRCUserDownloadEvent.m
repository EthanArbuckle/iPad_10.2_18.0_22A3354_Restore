...
- (id)additionalPayload
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isDownloadingForBackup);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v11[1] = v4;
  v10[2] = CFSTR("isRecursiveDownload");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isRecursiveDownload);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v11[2] = v5;
  v10[3] = CFSTR("itemCount");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_itemCount);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v11[3] = v6;
  v10[4] = CFSTR("totalContentSize");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_totalContentSize);
...
- (id)subDescription
{
  ...
  if (self->_isDownloadingForBackup)
    ...
    v3 = "";
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR(" sz:%lld cnt:%lld %s%s"), self->_totalContentSize, self->_itemCount, v2, v3);
}
