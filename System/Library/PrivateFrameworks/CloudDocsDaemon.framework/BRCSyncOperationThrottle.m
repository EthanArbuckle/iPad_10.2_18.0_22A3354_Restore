...
- (id)description
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37A0]), "initWithFormat:", CFSTR("<%@ delay:%.1fs id:%@"), objc_opt_class(), *(_QWORD *)&self->_delay, self->_mangledID);
  v4 = v3;
  if (self->_graceNextRequest)
...
- (void)updateForError:(id)a3
{
  ...
  if (v16 != 0.0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      v31 = 2112;
      v32 = v18;
      _os_log_debug_impl(&dword_1CBD43000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] server provided backoff %.03fs (delay %.03fs)%@", (uint8_t *)&v27, 0x20u);
    }
...
- (BOOL)scheduleIfPossibleWithCurrentTimestamp:(int64_t)a3 signalSourceIfFailed:(id)a4 description:(id)a5
{
  ...
  if (v10 - a3 >= 0x2540BE401)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      v32 = 2112;
      v33 = v11;
      _os_log_debug_impl(&dword_1CBD43000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ sync-%@ is throttled for more than 10s: %.1fs (%@)%@", (uint8_t *)&v24, 0x34u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v28 = 2112;
      v29 = v13;
      _os_log_debug_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] syncing %@ %@%@", (uint8_t *)&v24, 0x20u);
    }
...
- (void)updateForError:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_debug_impl(&dword_1CBD43000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Sync: Updated sync throttle %@%@", (uint8_t *)&v3, 0x16u);
  OUTLINED_FUNCTION_2();
}
