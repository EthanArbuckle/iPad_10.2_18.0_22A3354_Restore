...
LABEL_3:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@=%@"), CFSTR("redirectReason"), v7);
    v11 = objc_claimAutoreleasedReturnValue();
  }
  v12 = (void *)v11;
...
LABEL_8:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    v38 = 2112;
    v39 = v21;
    _os_log_debug_impl(&dword_1CBD43000, v22, OS_LOG_TYPE_DEBUG, "[DEBUG] Opening in web browser (reason: %@) %@%@", buf, 0x20u);
  }

  objc_msgSend(MEMORY[0x1E0CA5878], "defaultWorkspace");
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v32 = *MEMORY[0x1E0CA57D8];
...
- (void)openiCloudSettings
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E98], "URLWithString:", CFSTR("prefs:root=APPLE_ACCOUNT&path=ICLOUD_SERVICE/com.apple.Dataclass.Ubiquity"));
...
- (void)openAppStoreForBundleID:(id)a3
{
  ...
  if (a3)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("itms-apps://?bundleIdentifier=%@"), a3);
...
- (void)openShareURLInWebBrowser:withReason:.cold.1()
{
  ...
  v3 = 2112;
  v4 = v0;
  _os_log_error_impl(&dword_1CBD43000, v1, (os_log_type_t)0x90u, "[ERROR] Can't open \"%@\" using default web browser%@", v2, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
- (void)openShareURLInWebBrowser:withReason:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: redirectReason%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)openShareURLInWebBrowser:withReason:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: shareURL%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)openAppStoreForBundleID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] passed nil app bundle ID%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
