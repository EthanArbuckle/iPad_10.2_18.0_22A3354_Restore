...
- (void)_setupCoalesceUpdateTimerWithUtilityHandlerBlock:(id)a3
{
  ...
  v5 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, (dispatch_queue_t)self->_callbackQueue);
  coalesceUpdateTimer = self->_coalesceUpdateTimer;
...
{
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, a2, a3, "[CRIT] Assertion failed: !_coalesceUpdateTimer%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, a2, a3, "[CRIT] Assertion failed: coalesceUpdateTimer == self->_coalesceUpdateTimer Expecting same address%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, a2, a3, "[CRIT] Assertion failed: !_coalesceUpdateTimer _coalesceUpdateTimer should exist only when moving from NO -> YES%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
