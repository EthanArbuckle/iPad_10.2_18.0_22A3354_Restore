...
- (BRCListDirectoryContentsOperation)initWithItemID:(id)a3 sessionContext:(id)a4 zone:(id)a5 isUserWaiting:(BOOL)a6
{
  ...
  if (v17)
  {
    ...
    objc_msgSend(MEMORY[0x1E0C94F88], "br_listDirectoryContents");
...
- (void)_cursorWasUpdated:(id)a3 subResourcesOp:(id)a4
{
  ...
  if (v8
    && (objc_msgSend(v7, "error"),
        ...
        v10 = objc_msgSend(v9, "brc_checkErrorsFromCloudKit:", &__block_literal_global_67),
        v9,
        v10))
  {
    objc_msgSend(v7, "error");
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      v24 = 2112;
      v25 = v12;
      _os_log_debug_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ finished listing batch with cursor %@%@", (uint8_t *)&v20, 0x20u);
...
- (void)_scheduleQueryOp
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(_QWORD *)&v3[14] = a2;
  OUTLINED_FUNCTION_0(&dword_1CBD43000, a2, a3, "[DEBUG] Dropping list directory database because of a token fetch error - %@%@", *(_QWORD *)v3, *(_QWORD *)&v3[8], *(_QWORD *)&v3[16]);
  OUTLINED_FUNCTION_2();
}
...
LABEL_4:
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEFAULT, "[WARNING] Not trying to promote %@ to a normal directory%@", buf, 0x16u);
...
void __53__BRCListDirectoryContentsOperation__scheduleQueryOp__block_invoke_2_101(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    v25 = 2112;
    v26 = v10;
    _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Listing directory contents of %@: Got record: ID [%@] Type [%@], error %@%@", (uint8_t *)&v17, 0x34u);
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a3, v5, "[DEBUG] Listing directory contents of %@%@", v6);
...
void __53__BRCListDirectoryContentsOperation__scheduleQueryOp__block_invoke_76_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a3, v5, "[DEBUG] Finished listing directory contents of %@%@", v6);
...
void __53__BRCListDirectoryContentsOperation__scheduleQueryOp__block_invoke_2_97_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetching the root as well of this share accept fault%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, a2, a3, "[CRIT] Assertion failed: !continuationCursor%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
...
- (void)finishWithResult:(NSObject *)a3 error:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v21 = 2112;
  v22 = a2;
  _os_log_debug_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Listing directory contents of %@ took [%f] Secs and fetched [%llu,%llu] records [%llu] xattrs%@", (uint8_t *)&v11, 0x3Eu);
