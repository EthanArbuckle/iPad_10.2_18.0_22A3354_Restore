...
- (BOOL)_removeFPDomain:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&v36[8] = 2112;
    *(_QWORD *)&v36[10] = v7;
    _os_log_debug_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Will remove domain: %@%@", buf, 0x16u);
  }

  v9 = 0;
  while (1)
  {
    v10 = (void *)MEMORY[0x1E0CAAD28];
    extensionID = self->_extensionID;
    ...
    if (dispatch_semaphore_wait(v13, v14))
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&v36[14] = 2112;
        *(_QWORD *)&v36[16] = v15;
        _os_log_impl(&dword_1CBD43000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] %d: removeDomain:%@ timed out%@", buf, 0x1Cu);
      }

      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithPOSIXCode:", 60);
...
void __40__BRCMiniCiconia__removeFPDomain_error___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEFAULT, "[WARNING] %d: removeDomain:%@ failed: %@%@", (uint8_t *)v12, 0x26u);
        ...
        if (objc_msgSend(v15, "br_isCiconiaDomain"))
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v52 = 2112;
            v53 = v16;
            _os_log_debug_impl(&dword_1CBD43000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] Found old domain %@, dropping%@", buf, 0x16u);
          }
          ...
          if (v19 && !v45[5])
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138412802;
              ...
              v54 = 2112;
              v55 = v20;
              _os_log_impl(&dword_1CBD43000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to remove old domain %@: %@%@", buf, 0x20u);
...
void __44__BRCMiniCiconia__cleanupOldCiconiaDomains___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 2112;
      v18 = v7;
      _os_log_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] %d: enumerating domains failed: %@%@", (uint8_t *)v14, 0x1Cu);
...
- (BOOL)_removeWorkDirectory:(id *)a3
{
  ...
  MEMORY[0x1D17A69C0](objc_msgSend(v25, "fileSystemRepresentation"), 0);
...
- (void)_cleanupOldCiconiaDomains:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Looking for old Ciconia domains%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_removeWorkDirectory:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Retry removing work directory%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_removeWorkDirectory:(os_log_t)log .cold.2(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_error_impl(&dword_1CBD43000, log, (os_log_type_t)0x90u, "[ERROR] Error: %lld%@", (uint8_t *)&v4, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
- (void)_removeWorkDirectory:(os_log_t)log .cold.3(uint64_t a1, int a2, os_log_t log)
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_error_impl(&dword_1CBD43000, log, (os_log_type_t)0x90u, "[ERROR] Failed removing domain %{errno}d%@", (uint8_t *)v3, 0x12u);
  OUTLINED_FUNCTION_2();
}
...
- (void)_removeWorkDirectory:(NSObject *)a3 .cold.4(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  v8 = 2112;
  v9 = a2;
  _os_log_debug_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Removing FP domain on disk: %@%@", v7, 0x16u);
...
- (void)_removeWorkDirectory:.cold.5()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Removing work directory%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
