...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing/copyParticipantToken", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
void __73__BRCSharingCopyParticipantTokenOperation__fetchBaseTokenWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    if (!(v5 | v8))
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: No base token so the share token we would return would be invalid for iwork"));
...
- (void)_fetchParticipantKeyWithCompletion:(id)a3
{
  ...
  v4 = a3;
  v5 = objc_alloc(MEMORY[0x1E0C94E48]);
  v21[0] = self->_shareID;
  ...
  if (baseToken)
  {
    ...
    v20 = baseToken;
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v20, &shareID, 1);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_2:
  ...
  if (!*(_QWORD *)(v5 + 560) && !*(_QWORD *)(v5 + 544))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no error and no participantKey"));
...
- (void)_fetchParticipantDocumentTokenWithCompletion:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K == %@"), CFSTR("participantKey"), self->_participantKey);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95010]), "initWithRecordType:predicate:", CFSTR("FetchParticipantDocumentToken"), v5);
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95038]), "initWithQuery:", v6);
...
void __88__BRCSharingCopyParticipantTokenOperation__fetchParticipantDocumentTokenWithCompletion___block_invoke_2(_QWORD *a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v22 = 2112;
    v23 = v7;
    _os_log_debug_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx handling result of %@: %@%@", buf, 0x2Au);
  }
  ...
  if (!v6)
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no error and no participantDocumentToken"));
...
- (void)main
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorInvalidParameter:value:", CFSTR("shareID"), 0);
    v3 = (id)objc_claimAutoreleasedReturnValue();
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218754;
      ...
      v19 = 2112;
      v20 = v4;
      _os_log_debug_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Failed to get participantDocumentToken for item: %@ with error %@%@", buf, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_debug_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Succeed to get participantDocumentToken. item: %@%@", buf, 0x20u);
    }
...
- (void)initWithItem:sessionContext:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Can't fetch shareID for item %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __73__BRCSharingCopyParticipantTokenOperation__fetchBaseTokenWithCompletion___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: No base token so the share token we would return would be invalid for iwork%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __78__BRCSharingCopyParticipantTokenOperation__fetchParticipantKeyWithCompletion___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no error and no participantKey%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __88__BRCSharingCopyParticipantTokenOperation__fetchParticipantDocumentTokenWithCompletion___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no error and no participantDocumentToken%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
