...
- (NSString)ownerName
{
  return (NSString *)(id)*MEMORY[0x1E0C94730];
}
...
- (BRMangledID)mangledID
{
  ...
  v3 = objc_alloc(MEMORY[0x1E0D10E88]);
...
- (NSMutableDictionary)plist
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", objc_msgSend(v4, "clientRequestID"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("clientRequestID"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v4, "lastSyncDownStatus"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)_saveItemID:(id)a3 stat:(id)a4 serverMetrics:(id)a5 record:(id)a6 origName:(id)a7 base:(id)a8 no:(id)a9 ext:(id)a10
{
  ...
  uint64_t v151;
  uint64_t v152;
  BRCPQLConnection *v153;
  BRCPQLConnection *v154;
  void *v155;
  void *v156;
  void *v157;
  void *v158;
  ...
  -[BRCAccountSession userKeyForOwnerName:db:](session, "userKeyForOwnerName:db:", v23, self->_db);
...
LABEL_38:
      ...
      if (-[BRCServerZone isSharedZone](self, "isSharedZone")
        && (objc_msgSend(v17, "parentID"),
            ...
            v59 = objc_msgSend(v58, "isSharedZoneRoot"),
            v58,
            (v59 & 1) == 0))
      {
        db = self->_db;
        ...
        v63 = -[BRCPQLConnection fetch:](db, "fetch:", CFSTR("SELECT item_favoriterank, item_lastusedtime, item_finder_tags, item_side_car_ckinfo FROM server_items WHERE item_id = %@ AND zone_rowid = %@"), v25, v62);

        v64 = objc_msgSend(v63, "next");
        if (v64)
        {
          ...
          objc_msgSend(v63, "dataAtIndex:", 2);
          v65 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v17, "setFinderTags:", v65);

          objc_msgSend(v63, "objectOfClass:atIndex:", objc_opt_class(), 3);
          v168 = (void *)objc_claimAutoreleasedReturnValue();
          v66 = v63;
        }
        else
        {
          -[BRCServerZone asSharedZone](self, "asSharedZone");
          v67 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v25, "sideCarRecordNameWithZone:", v67);
          v68 = (void *)objc_claimAutoreleasedReturnValue();

          v66 = -[BRCPQLConnection fetch:](self->_db, "fetch:", CFSTR("SELECT item_favoriterank, item_lastusedtime, item_finder_tags, item_side_car_ckinfo FROM side_car_lookahead WHERE record_name = %@"), v68);
          if (objc_msgSend(v66, "next"))
          {
            ...
            objc_msgSend(v66, "dataAtIndex:", 2);
            v69 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v17, "setFinderTags:", v69);

            objc_msgSend(v66, "objectOfClass:atIndex:", objc_opt_class(), 3);
            v168 = (void *)objc_claimAutoreleasedReturnValue();
            -[BRCPQLConnection execute:](self->_db, "execute:", CFSTR("DELETE FROM side_car_lookahead WHERE record_name = %@"), v68);
          }
          else
          {
            v168 = 0;
      ...
      v70 = objc_msgSend(v17, "type");
      v71 = -1;
      if (v70 <= 0xA && ((1 << v70) & 0x611) != 0)
      {
        objc_msgSend(v19, "deserializeFolderSharingOptions:", &v177);
        if ((-[BRCServerZone state](self, "state") & 4) != 0)
        {
          objc_msgSend(v17, "setType:", 0);
        }
        else
        {
          v72 = -[PQLConnection numberWithSQL:](self->_db, "numberWithSQL:", CFSTR("SELECT item_type FROM server_items WHERE item_id = %@ AND zone_rowid = %@"), v25, self->_dbRowID);
          v73 = v72;
          if (v72)
          {
            objc_msgSend(v17, "setType:", (char)objc_msgSend(v72, "longLongValue"));
            v117 = objc_msgSend(v17, "type");
          ...
          else
          {
            ...
            +[BRCUserDefaults defaultsForMangledID:](BRCUserDefaults, "defaultsForMangledID:", v74);
            v75 = (void *)objc_claimAutoreleasedReturnValue();
            v76 = objc_msgSend(v75, "forceDeltaInitialSync");

            if (v76)
              v77 = 0;
            else
              v77 = 9;
            objc_msgSend(v17, "setType:", v77);
            v60 = 1;
          }
      ...
      if (v78)
      {
        v79 = objc_msgSend(v17, "type");
        v165 = 2;
        if (v79 > 0xA || ((1 << v79) & 0x611) == 0)
          goto LABEL_71;
        if ((objc_msgSend(v19, "hasChainPCS") & 1) == 0)
        {
          brc_bread_crumbs();
      ...
      else if (objc_msgSend(v19, "hasChainPCS"))
      {
        v83 = 4;
      }
      else
...
LABEL_71:
      ...
      v148 = objc_msgSend(v17, "state");
      v146 = objc_msgSend(v17, "type");
      v144 = objc_msgSend(v17, "mode");
      v142 = objc_msgSend(v17, "birthtime");
      v140 = objc_msgSend(v17, "lastUsedTime");
      v138 = objc_msgSend(v17, "favoriteRank");
      objc_msgSend(v17, "parentID");
      v161 = (void *)objc_claimAutoreleasedReturnValue();
      v99 = (const __CFString *)v17[7];
      if (!v99)
        v99 = &stru_1E8769030;
      v136 = v99;
      v134 = objc_msgSend(v17, "isHiddenExt");
...
LABEL_72:
        v84 = v26;
        if ((objc_msgSend(v25, "isDocumentsFolder") & 1) == 0
          && -[NSArray containsObject:](self->_directoriesCreatedLastSyncUp, "containsObject:", v25)
          && objc_msgSend(v17, "type") == 9)
        {
          ...
          {
            objc_msgSend(v25, "debugItemIDString");
            v87 = (void *)objc_claimAutoreleasedReturnValue();
            *(_DWORD *)buf = 138412546;
            v179 = v87;
            v180 = 2112;
            v181 = v85;
            _os_log_impl(&dword_1CBD43000, v86, OS_LOG_TYPE_DEFAULT, "[NOTICE] Promoting %@ to be a normal directory because it was created from our own sync up%@", buf, 0x16u);
        ...
        v147 = objc_msgSend(v17, "state");
        v145 = objc_msgSend(v17, "type");
        v143 = objc_msgSend(v17, "mode");
        v141 = objc_msgSend(v17, "birthtime");
        v139 = objc_msgSend(v17, "lastUsedTime");
        v137 = objc_msgSend(v17, "favoriteRank");
        objc_msgSend(v17, "parentID");
        v160 = (void *)objc_claimAutoreleasedReturnValue();
        v88 = (const __CFString *)v17[7];
        if (!v88)
          v88 = &stru_1E8769030;
        v135 = v88;
...
LABEL_94:
      ...
      v107 = objc_msgSend(v17, "type");
      if (v107 <= 0xA
        && ((1 << v107) & 0x611) != 0
        && (objc_msgSend(v164, "modificationDate"),
            v108 = (void *)objc_claimAutoreleasedReturnValue(),
            objc_msgSend(v108, "timeIntervalSince1970"),
            v110 = (uint64_t)v109,
            v108,
            !-[BRCPQLConnection execute:](self->_db, "execute:", CFSTR("UPDATE server_items SET  version_mtime = %lld  WHERE item_id = %@ AND zone_rowid = %@"), v110, v25, self->_dbRowID)))
      {
        v29 = 0;
      }
      else
    ...
    v25 = v16;
    v33 = -[PQLConnection itemIDWithSQL:](v30, "itemIDWithSQL:", CFSTR("SELECT item_id FROM server_items  WHERE item_id != %@ AND item_parent_id = %@ AND item_filename = %@ AND +zone_rowid = %@"), v16, v31, v32, self->_dbRowID);
...
LABEL_37:
    ...
    v36 = -[BRCPQLConnection fetch:](v34, "fetch:", CFSTR("SELECT item_origname, item_filename FROM server_items  WHERE item_id = %@ AND item_parent_id = %@ AND +zone_rowid = %@"), v16, v35, self->_dbRowID);

    if (objc_msgSend(v36, "next"))
    {
      objc_msgSend(v36, "stringAtIndex:", 0);
      ...
      if (v39)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412802;
          ...
          v182 = 2112;
          v183 = v40;
          _os_log_debug_impl(&dword_1CBD43000, v41, OS_LOG_TYPE_DEBUG, "[DEBUG] Keeping bounce of %@ even though it clashes with %@%@", buf, 0x20u);
        }

        v167 = v36;
        objc_msgSend(v36, "stringAtIndex:", 1);
        v42 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "setLogicalName:", v42);
        v43 = v172;
        v172 = v37;
        v26 = v170;
        goto LABEL_34;
    ...
    v44 = objc_msgSend(v169, "integerValue");
    if (v44 <= 1)
      v45 = 1;
    else
      v45 = v44;
...
LABEL_36:
    ...
    while (1)
    {
      ...
      objc_msgSend(v47, "br_representableHFSFileNameWithBase:suffix:extension:makeDotFile:", v174, v49, v173, 0);
      v42 = (void *)objc_claimAutoreleasedReturnValue();

      if (!-[BRCPQLConnection execute:](self->_db, "execute:", CFSTR("UPDATE OR IGNORE server_items SET  item_rank = NULL, item_depth = 0, item_filename = %@, item_origname = IFNULL(item_origname, item_filename) WHERE zone_rowid = %@ AND item_id = %@"), v42, self->_dbRowID, v33))
      {
        brc_bread_crumbs();
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_FAULT))
        {
          ...
          objc_msgSend(v157, "localizedDescription");
          v55 = (void *)objc_claimAutoreleasedReturnValue();
          *(_DWORD *)buf = 138412546;
          v179 = v55;
          v180 = 2112;
          v181 = v50;
          _os_log_fault_impl(&dword_1CBD43000, v51, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: got a SQL Error: %@%@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v53, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v182 = 2112;
        v183 = v52;
        _os_log_debug_impl(&dword_1CBD43000, v53, OS_LOG_TYPE_DEBUG, "[DEBUG] Not bouncing %@ to %@ because that's not a unique filename%@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      v186 = 2112;
      v187 = v43;
      _os_log_impl(&dword_1CBD43000, v56, OS_LOG_TYPE_DEFAULT, "[WARNING] Bounced itemID %@ from \"%@\" to \"%@\" because it clashes with %@%@", buf, 0x34u);
...
LABEL_35:
  ...
  if (os_log_type_enabled(v28, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v182 = 2112;
    v183 = v27;
    _os_log_error_impl(&dword_1CBD43000, v28, (os_log_type_t)0x90u, "[ERROR] can't save %@: missing ownerKey for ownerName \"%@\"%@", buf, 0x20u);
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if ((v19 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v86 = 2112;
        v87 = v41;
        _os_log_fault_impl(&dword_1CBD43000, v42, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't deserialize filename: %@ of %@%@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      v90 = 2112;
      v91 = v25;
      _os_log_impl(&dword_1CBD43000, v26, OS_LOG_TYPE_DEFAULT, "[WARNING] changing filename to \"%@\" because \"%@\" is unrepresentable (item ID: %@, last editor: %@)%@", buf, 0x34u);
...
LABEL_28:
  ...
  if (os_log_type_enabled(v52, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v88 = 2112;
    v89 = v51;
    _os_log_error_impl(&dword_1CBD43000, v52, (os_log_type_t)0x90u, "[ERROR] changing filename to \"%@\" because \"%@\" is %s name%@", buf, 0x2Au);
...
LABEL_35:
    ...
    if (!v58)
    {
      ...
      if (os_log_type_enabled(v63, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v86 = 2112;
        v87 = v62;
        _os_log_fault_impl(&dword_1CBD43000, v63, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't deserialize filename: %@ of %@%@", buf, 0x20u);
      }
  ...
  if (-[BRCServerZone _saveItemID:stat:serverMetrics:record:origName:base:no:ext:](v33, "_saveItemID:stat:serverMetrics:record:origName:base:no:ext:", v11, v12, v13, v14, v18, v79, v80))
  {
    ...
    else
    {
      v65 = v14;
      v66 = a7;
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("no record to update: %@"), v11);
      ...
      if (a7)
      {
        ...
        if (os_log_type_enabled(v68, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 136315906;
          ...
          v88 = 2112;
          v89 = v67;
          _os_log_error_impl(&dword_1CBD43000, v68, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
        }
  ...
  if (os_log_type_enabled(v61, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v86 = 2112;
    v87 = v60;
    _os_log_error_impl(&dword_1CBD43000, v61, (os_log_type_t)0x90u, "[ERROR] Failed to update record (%@): %@%@", buf, 0x20u);
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v22, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v40 = 2112;
      v41 = v21;
      _os_log_error_impl(&dword_1CBD43000, v22, (os_log_type_t)0x90u, "[ERROR] failed saving document %@: %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v40 = 2112;
        v41 = v21;
        _os_log_debug_impl(&dword_1CBD43000, v22, OS_LOG_TYPE_DEBUG, "[DEBUG] Document without a structure record but we haven't completed full sync.  Dropping the record on the floor for now i:%@ %@%@", buf, 0x20u);
      }
    }
    goto LABEL_11;
  }
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v30 = 2112;
      v31 = v17;
      _os_log_error_impl(&dword_1CBD43000, v18, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
...
- (BOOL)_saveEditedDocumentContentRecord:(id)a3 error:(id *)a4
{
  ...
  if ((v15 & 1) != 0)
  {
    ...
    if ((v19 & 1) != 0)
    {
      ...
      -[BRCAccountSession cachedCurrentUserRecordName](self->_session, "cachedCurrentUserRecordName");
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      v70 = 0;
      ...
      if (v22)
      {
        if ((objc_msgSend(v63, "isEqualToString:", v22) & 1) == 0)
        {
          ...
          if ((v24 & 1) == 0)
          {
            ...
            objc_msgSend(v16, "setEditedSinceShared:", MEMORY[0x1E0C9AAB0]);
            v22 = v25;
          }
        }
      }
      if (objc_msgSend(v22, "isEqualToString:", *MEMORY[0x1E0C94730]))
      {
        ...
        if (v29 == 64)
        {
          -[BRCAccountSession createUserKeyForOwnerName:](session, "createUserKeyForOwnerName:", v22);
          v32 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v16, "setLastEditorRowID:", v32);
        }
        else
        {
          -[BRCAccountSession createDeviceKeyForNameInServerDB:](session, "createDeviceKeyForNameInServerDB:", v28);
          v32 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      -[BRCAccountSession createUserKeyForOwnerName:](self->_session, "createUserKeyForOwnerName:", v22);
...
LABEL_54:
      ...
      v42 = (void *)objc_claimAutoreleasedReturnValue();
      v61 = v22;
      +[BRCAccountSession userIdentityForName:db:](BRCAccountSession, "userIdentityForName:db:", v22, v42);
      v43 = (void *)objc_claimAutoreleasedReturnValue();
      v44 = v43;
      if (v43)
        v45 = v43;
        ...
        if (objc_msgSend(v16, "isPackage"))
        {
          ...
          if ((v51 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v55, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              v82 = 2112;
              v83 = v54;
              _os_log_fault_impl(&dword_1CBD43000, v55, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't deserialize extension: %@ of %@%@", buf, 0x20u);
            }
          ...
          if (v69)
          {
              ...
              && ((objc_msgSend(v69, "brc_isForcedPackageExtension") | v53) & 1) == 0)
            {
              ...
              objc_msgSend(MEMORY[0x1E0CB3940], "brc_addForcedPackageExtension:", v69);
            }
          }
...
LABEL_53:
  ...
  _os_log_error_impl(&dword_1CBD43000, v37, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
...
LABEL_31:
        ...
        if (os_log_type_enabled(v25, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v40 = 2112;
          v41 = v24;
          _os_log_error_impl(&dword_1CBD43000, v25, (os_log_type_t)0x90u, "[ERROR] failed saving symlink %@: %@%@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v40 = 2112;
          v41 = v21;
          _os_log_error_impl(&dword_1CBD43000, v22, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
...
LABEL_29:
  ...
  if (os_log_type_enabled(v19, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v40 = 2112;
    v41 = v18;
    _os_log_error_impl(&dword_1CBD43000, v19, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
...
LABEL_18:
      ...
      if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v37 = 2112;
        v38 = v23;
        _os_log_error_impl(&dword_1CBD43000, v24, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v37 = 2112;
    v38 = v20;
    _os_log_error_impl(&dword_1CBD43000, v21, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
...
- (BOOL)_saveEditedAliasRecord:(id)a3 zonesNeedingAllocRanks:(id)a4 error:(id *)a5
{
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[BRCAccountSession userKeyForOwnerName:db:](session, "userKeyForOwnerName:db:", v13, self->_db);
    ...
    if (v16)
    {
      ...
      if ((v19 & 1) != 0)
      {
        ...
        if (v31)
        {
          ...
          v32 = (void *)objc_claimAutoreleasedReturnValue();
          -[BRCAccountSession clientZoneByMangledID:](self->_session, "clientZoneByMangledID:", v32);
          v33 = (void *)objc_claimAutoreleasedReturnValue();
          v16 = v70;
          v9 = v71;
            ...
            if (-[BRCPQLConnection changes](self->_db, "changes"))
            {
              ...
              if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138412802;
                ...
                v80 = 2112;
                v81 = v37;
                _os_log_debug_impl(&dword_1CBD43000, v38, OS_LOG_TYPE_DEBUG, "[DEBUG] Requesting a new item rank for target %@ of %@%@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v50, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v80 = 2112;
          v81 = v49;
          _os_log_error_impl(&dword_1CBD43000, v50, (os_log_type_t)0x90u, "[ERROR] failed saving alias %@: %@%@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v80 = 2112;
          v81 = v46;
          _os_log_error_impl(&dword_1CBD43000, v47, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
      ...
      if (v43)
      {
        ...
        if (os_log_type_enabled(v45, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 136315906;
          ...
          v82 = 2112;
          v83 = v44;
          _os_log_error_impl(&dword_1CBD43000, v45, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
        }
...
LABEL_9:
  -[BRCAccountSession learnParticipantIdentitiesForShare:forceUpdate:](self->_session, "learnParticipantIdentitiesForShare:forceUpdate:", v6, 0);
  if (!v8)
  {
    brc_bread_crumbs();
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v40 = v24;
      _os_log_impl(&dword_1CBD43000, v25, OS_LOG_TYPE_DEFAULT, "[WARNING] ignoring unknown itemID on share%@", buf, 0xCu);
    }
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v43 = 2112;
      v44 = v27;
      _os_log_error_impl(&dword_1CBD43000, v28, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
  ...
  if (!-[BRCPQLConnection execute:](self->_db, "execute:", CFSTR("UPDATE server_items    SET item_rank = NULL, item_sharing_options = (%lu | (item_sharing_options & %lu)),         item_mode = (%ld | (item_mode & %lu)), item_depth = 0  WHERE item_id = %@ AND zone_rowid = %@"), v38, 7, ((unint64_t)(v38 & 0x20) >> 5) ^ 1, v18, v8, self->_dbRowID))
  {
    ...
    if (os_log_type_enabled(v31, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v43 = 2112;
      v44 = v30;
      _os_log_error_impl(&dword_1CBD43000, v31, (os_log_type_t)0x90u, "[ERROR] failed saving document %@: %@%@", buf, 0x20u);
  ...
  if (objc_msgSend(v12, "isEqualToString:", CFSTR("structure")))
  {
    ...
    else
    {
      if (!objc_msgSend(v11, "hasPrefix:", CFSTR("finderBookmark/")))
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: structure record which isn't a directory or document"));
        v27 = (void *)objc_claimAutoreleasedReturnValue();
        if (v27)
        {
          brc_bread_crumbs();
          ...
          if (os_log_type_enabled(v29, (os_log_type_t)0x90u))
          {
            ...
            v37 = 2112;
            v38 = v28;
            _os_log_error_impl(&dword_1CBD43000, v29, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v31, 0x2Au);
          }
...
LABEL_20:
  ...
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0C94A20]))
  {
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v33 = 2112;
    v34 = v22;
    _os_log_impl(&dword_1CBD43000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Consistent state but unknown record type (recordType: %@).%@", (uint8_t *)&v31, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        v13 = 2112;
        v14 = v7;
        _os_log_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] deleted shareID %@ was for already dead item%@", buf, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v15 = 2112;
      v16 = v7;
      _os_log_error_impl(&dword_1CBD43000, v8, (os_log_type_t)0x90u, "[ERROR] failed saving tombstone share %@: %@%@", buf, 0x20u);
...
- (BOOL)_markItemDeadForRecordID:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[BRCAccountSession userKeyForOwnerName:db:](session, "userKeyForOwnerName:db:", v8, self->_db);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          v24 = 2112;
          v25 = v14;
          _os_log_error_impl(&dword_1CBD43000, v15, (os_log_type_t)0x90u, "[ERROR] failed saving tombstone %@: %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v24 = 2112;
        v25 = v10;
        _os_log_error_impl(&dword_1CBD43000, v14, (os_log_type_t)0x90u, "[ERROR] can't save %@: missing ownerKey for ownerName \"%@\"%@", buf, 0x20u);
...
LABEL_3:
    ...
    while (1)
    {
      ...
      v10 = (void *)MEMORY[0x1D17A6BE8](v5);
...
- (void)_reportCantSaveProblem:(id)a3 record:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v8, "isEqualToString:", *MEMORY[0x1E0D10C90]))
  {
...
LABEL_21:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v26 = 2112;
    v27 = v20;
    _os_log_impl(&dword_1CBD43000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] Recovered sharing options on %@ by setting ck share options to null%@", buf, 0x16u);
  }
LABEL_22:
...
- (BOOL)allocateRanksWhenCaughtUp:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&v118[8] = 2112;
    *(_QWORD *)&v118[10] = v10;
    _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] caughtUp [%s] fullSync [%s]%@", buf, 0x20u);
  }
  ...
  objc_msgSend(MEMORY[0x1E0DE81E0], "rawInjection:length:", v12, v13);
          ...
          if (objc_msgSend(v29, "BOOLValue"))
          {
            ...
            if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412546;
              ...
              v117 = 2112;
              *(_QWORD *)v118 = v30;
              _os_log_debug_impl(&dword_1CBD43000, v31, OS_LOG_TYPE_DEBUG, "[DEBUG] Server killed %@ but it still has live children%@", buf, 0x16u);
            }
            ...
            if (v109)
            {
              ...
              if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT))
              {
                ...
                *(_WORD *)&v118[4] = 2112;
                *(_QWORD *)&v118[6] = v33;
                _os_log_fault_impl(&dword_1CBD43000, v34, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server killed %s but it still has %d live children%@", buf, 0x1Cu);
              }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_WORD *)&v118[4] = 2112;
                *(_QWORD *)&v118[6] = v35;
                _os_log_debug_impl(&dword_1CBD43000, v36, OS_LOG_TYPE_DEBUG, "[DEBUG] State inconsistent because %@ has %d live children%@", buf, 0x1Cu);
              }
              v32 = v29;
            }
            ...
            if (v105)
            {
              ...
              if (os_log_type_enabled(v47, OS_LOG_TYPE_FAULT))
              {
                *(_DWORD *)buf = 138412546;
                ...
                v117 = 2112;
                *(_QWORD *)v118 = v46;
                _os_log_fault_impl(&dword_1CBD43000, v47, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: State inconsistent because %@ is a document with no version%@", buf, 0x16u);
              }

              -[BRCClientZone asPrivateClientZone](self->_clientZone, "asPrivateClientZone");
              v48 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v16[368], "structureRecordPrefixForItemType:targetZoneShared:", 1, 0);
...
LABEL_47:
            ...
            else
            {
              ...
              if (os_log_type_enabled(v49, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138412546;
                ...
                v117 = 2112;
                *(_QWORD *)v118 = v48;
                _os_log_debug_impl(&dword_1CBD43000, v49, OS_LOG_TYPE_DEBUG, "[DEBUG] We haven't received a content record on %@ yet, delaying for now%@", buf, 0x16u);
                goto LABEL_47;
              }
            }
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412546;
              ...
              v117 = 2112;
              *(_QWORD *)v118 = v29;
              _os_log_debug_impl(&dword_1CBD43000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %@ to be a directory fault because it has a new unapplied item%@", buf, 0x16u);
            }
            v39 = 0;
            v23 = -3;
LABEL_66:
              ...
              else
              {
                if (v109)
                {
                  ...
                  if (os_log_type_enabled(v62, OS_LOG_TYPE_FAULT))
                  {
                    ...
                    *(_WORD *)&v118[8] = 2112;
                    *(_QWORD *)&v118[10] = v61;
                    _os_log_fault_impl(&dword_1CBD43000, v62, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent live item %s parented to dead item %s%@", buf, 0x20u);
                  }
                ...
                if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_WORD *)&v118[8] = 2112;
                  *(_QWORD *)&v118[10] = v75;
                  _os_log_impl(&dword_1CBD43000, v76, OS_LOG_TYPE_DEFAULT, "[WARNING] Server sent us live item %@ parented to dead item %@ but we haven't completed full sync. Delaying apply%@", buf, 0x20u);
                }
              ...
              if ((objc_msgSend(v39, "next") & 1) == 0)
              {
                if (!v102)
                {
                  ...
                  if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_WORD *)&v118[8] = 2112;
                    *(_QWORD *)&v118[10] = v29;
                    _os_log_debug_impl(&dword_1CBD43000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] Server sent us an item %@ which we couldn't locate share for, but we aren't caught up yet (parented to %@)%@", buf, 0x20u);
                  }
                  goto LABEL_51;
                }
                brc_bread_crumbs();
                ...
                if (os_log_type_enabled(v79, OS_LOG_TYPE_FAULT))
                {
                  ...
                  *(_WORD *)&v118[8] = 2112;
                  *(_QWORD *)&v118[10] = v101;
                  _os_log_fault_impl(&dword_1CBD43000, v79, OS_LOG_TYPE_FAULT, "[CRIT] Server sent us an item %@ which has non-root share options but isn't parented to a share (parented to %@)%@", buf, 0x20u);
                }
                ...
                if (!-[BRCServerZone _recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:](self, "_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:", v20, v112, v18, v24))
                {
                  ...
                  if (os_log_type_enabled(v35, OS_LOG_TYPE_FAULT))
                  {
                    ...
                    *(_WORD *)&v118[8] = 2112;
                    *(_QWORD *)&v118[10] = v29;
                    _os_log_fault_impl(&dword_1CBD43000, v35, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent us an item %@ which has non-root share options but isn't parented to a share (parented to %@)%@", buf, 0x20u);
                  }
LABEL_51:
                  v23 = -4;
                  goto LABEL_66;
...
LABEL_68:
            ...
            if (os_log_type_enabled(v68, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_WORD *)&v118[8] = 2112;
              *(_QWORD *)&v118[10] = v67;
              _os_log_fault_impl(&dword_1CBD43000, v68, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent item %@ which is parented to a non-directory %@%@", buf, 0x20u);
            }
...
LABEL_82:
          ...
          if ((v108 & 4) != 0)
          {
            ...
            if (os_log_type_enabled(v41, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)buf = 136315394;
              ...
              v117 = 2112;
              *(_QWORD *)v118 = v40;
              _os_log_fault_impl(&dword_1CBD43000, v41, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent item %s which isn't a descendant of 'root'%@", buf, 0x16u);
            }

            -[BRCClientZone asPrivateClientZone](self->_clientZone, "asPrivateClientZone");
            v42 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v16[368], "structureRecordPrefixForItemType:targetZoneShared:", v20, 0);
            v43 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v112, "itemIDString");
            v44 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          if (os_log_type_enabled(v53, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_WORD *)&v118[8] = 2112;
            *(_QWORD *)&v118[10] = v52;
            _os_log_debug_impl(&dword_1CBD43000, v53, OS_LOG_TYPE_DEBUG, "[DEBUG] Found orphan when we haven't completed initial sync item [%@] parent [%@].  Delaying apply for now%@", buf, 0x20u);
          }
...
LABEL_93:
          _os_log_debug_impl(&dword_1CBD43000, v57, OS_LOG_TYPE_DEBUG, v58, buf, 0xCu);
          goto LABEL_94;
        }
        v23 = 0;
        v22 = 0;
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          v117 = 2112;
          *(_QWORD *)v118 = v26;
          _os_log_fault_impl(&dword_1CBD43000, v27, OS_LOG_TYPE_FAULT, "[CRIT] Server sent us an item %@ which has non-root share options but should be a root share%@", buf, 0x16u);
        }
          ...
          || !-[BRCServerZone _recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:](self, "_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:", v20, v112, v18, v24))
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            v117 = 2112;
            *(_QWORD *)v118 = v29;
            _os_log_fault_impl(&dword_1CBD43000, v35, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent us an item %@ which has non-root share options but should be a root share%@", buf, 0x16u);
          }
          v39 = 0;
          goto LABEL_51;
        }
...
LABEL_69:
      ...
      if (os_log_type_enabled(v60, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v118[8] = 2112;
        *(_QWORD *)&v118[10] = v59;
        _os_log_debug_impl(&dword_1CBD43000, v60, OS_LOG_TYPE_DEBUG, "[DEBUG] Setting rowid [%lld] item_depth [%lld]%@", buf, 0x20u);
      }
  ...
  if (objc_msgSend(v86, "next"))
  {
    ...
    do
    {
      ...
      if (os_log_type_enabled(v91, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v118[8] = 2112;
        *(_QWORD *)&v118[10] = v90;
        _os_log_debug_impl(&dword_1CBD43000, v91, OS_LOG_TYPE_DEBUG, "[DEBUG] Setting rowid [%lld] rank to [%lld]%@", buf, 0x20u);
      }
  ...
  if (os_log_type_enabled(v93, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)&v118[10] = v87;
    v119 = 2112;
    v120 = v92;
    _os_log_debug_impl(&dword_1CBD43000, v93, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: Allocated ranks [%lld, %lld]%@", buf, 0x2Au);
...
- (void)checkIfFinishedFullSync
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@ has no more directory faults so it is now full sync%@");
  OUTLINED_FUNCTION_2();
}
...
LABEL_4:
      ...
      while (1)
      {
        ...
        v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D10E88]), "initWithZoneName:ownerName:", v10, 0);
        -[BRCAccountSession getOrCreateAppLibraryAndPrivateZonesIfNecessary:](self->_session, "getOrCreateAppLibraryAndPrivateZonesIfNecessary:", v12);
        v13 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_15:
          ...
          for (i = 0; i != v19; ++i)
          {
            ...
            if (objc_msgSend(v23, "isEqualToString:", v21))
            {
              ...
              if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
              {
                *(_DWORD *)buf = 138412290;
                v36 = v24;
                _os_log_fault_impl(&dword_1CBD43000, v25, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Can't CZM the clouddocs zone%@", buf, 0xCu);
              }

            }
            else
            {
              -[BRCAccountSession privateServerZoneByID:](self->_session, "privateServerZoneByID:", v23);
              v24 = (void *)objc_claimAutoreleasedReturnValue();
              if (v24)
      ...
      -[BRCAccountSession scheduleZoneMovesToCloudDocs:](self->_session, "scheduleZoneMovesToCloudDocs:", v14);
    }
    v4 = v26;
...
- (unint64_t)didSyncDownRequestID:(unint64_t)a3 serverChangeToken:(id)a4 editedRecords:(id)a5 deletedRecordIDs:(id)a6 deletedShareRecordIDs:(id)a7 allocRankZones:(id *)a8 caughtUp:(BOOL)a9 pendingChanges:(id)a10
{
  ...
  state.opaque[0] = 0;
  state.opaque[1] = 0;
  v49 = _os_activity_create(&dword_1CBD43000, "server-zone/did-sync-down", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)((char *)&v74 + 2) = v19;
    _os_log_debug_impl(&dword_1CBD43000, v20, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx saving sync-down batch (edits:%ld deletions:%ld)%@", buf, 0x2Au);
  }
  ...
  *((_QWORD *)&v74 + 1) = v21;
  ...
  if (!a9 && objc_msgSend(v22, "count"))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("We have failed streams even though we aren't caught up? Crashing to prevent state corruption"));
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_FAULT))
    {
      ...
      v42 = (void *)objc_claimAutoreleasedReturnValue();
      __84__BRCAccountSession_BRCDatabaseManager___finishClientTruthConnectionSetupWithError___block_invoke_cold_1(v42, (uint64_t)v40, (uint64_t)v71, v41);
    }
  ...
  v50[0] = v24;
  v50[1] = 3221225472;
  v50[2] = __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_155;
  v50[3] = &unk_1E8761530;
  v50[4] = buf;
  -[BRCPQLConnection performWithFlags:action:whenFlushed:](db, "performWithFlags:action:whenFlushed:", 9, v51, v50);
  if (v68[3])
  {
    v30 = (void *)MEMORY[0x1E0D10E48];
    -[BRCServerZone mangledID](self, "mangledID");
    v31 = (void *)objc_claimAutoreleasedReturnValue();
    v32 = *MEMORY[0x1E0D10BB8];
...
uint64_t __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count") && objc_msgSend(*(id *)(a1 + 40), "count"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218754;
      ...
      v145 = 2112;
      v146 = v4;
      _os_log_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEFAULT, "[NOTICE] received %lu edited items and %lu deleted items from the cloud for %@\n%@", buf, 0x2Au);
  ...
  else
  {
    ...
    _os_log_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEFAULT, v11, buf, 0x20u);
...
LABEL_11:
  ...
  if (objc_msgSend(*(id *)(a1 + 56), "count"))
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218242;
      ...
      v141 = 2112;
      v142 = (uint64_t)v15;
      _os_log_impl(&dword_1CBD43000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] Saving %lu failed directory list operations first%@", buf, 0x16u);
    }
  ...
  v121 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99E20], "setWithArray:", *(_QWORD *)(a1 + 64));
  v120 = (void *)objc_claimAutoreleasedReturnValue();
  v29 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E20]), "initWithObjects:", *(_QWORD *)(a1 + 48), 0);
  v30 = *(id **)(a1 + 120);
  if (v30)
        ...
        else
        {
          ...
          if ((objc_msgSend(v40, "isEqualToString:", CFSTR("content")) & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v43, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              v140 = (uint64_t)v40;
              _os_log_fault_impl(&dword_1CBD43000, v43, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [record.recordType isEqualToString:kBRRecordTypeContent] || [record.recordType isEqualToString:kBRRecordTypeStructure]%@", buf, 0xCu);
            }
...
LABEL_60:
  ...
  if (os_log_type_enabled(v49, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v141 = 2112;
    v142 = (uint64_t)v48;
    _os_log_impl(&dword_1CBD43000, v49, OS_LOG_TYPE_DEFAULT, "[WARNING] Promoting %@ to full sync because we have completed full sync before and now we're caught up again%@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v58, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v143 = 2112;
    v144 = v57;
    _os_log_debug_impl(&dword_1CBD43000, v58, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items to be normal directories in %@%@", buf, 0x20u);
  }
  ...
  if ((v69 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v74, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v145 = 2112;
      v146 = v73;
      _os_log_debug_impl(&dword_1CBD43000, v74, OS_LOG_TYPE_DEBUG, "[DEBUG] updating %@\nwith requestID:%llu token:%@%@", buf, 0x2Au);
...
LABEL_101:
    ...
    v89 = (void *)objc_claimAutoreleasedReturnValue();
    v90 = *MEMORY[0x1E0D10BE8];
    v134 = *MEMORY[0x1E0D10D58];
    objc_msgSend(*(id *)(v119 + 48), "changeState");
    v91 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_90:
  ...
  if (os_log_type_enabled(v101, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v140 = (uint64_t)v100;
    _os_log_impl(&dword_1CBD43000, v101, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed enumerating the changes stream but don't broken structure%@", buf, 0xCu);
  }
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_155(uint64_t a1)
{
  uint64_t v2;
  void *v3;
...
- (unint64_t)didListDirectoryChangesWithResults:(id)a3 pendingFetchChanges:(id)a4
{
  ...
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E20]), "initWithObjects:", self, 0);
...
LABEL_16:
  ...
  {
    if (-[BRCAccountSession saveServerZoneToDB:](self->_session, "saveServerZoneToDB:", self))
      v31 = v30;
    else
      v31 = 0;
  }
  ...
  if (objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 48), "activated"))
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218754;
      ...
      v21 = 2112;
      v22 = v2;
      _os_log_debug_impl(&dword_1CBD43000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Starting to GC %ld server tombstones in %@%@", buf, 0x2Au);
    }
    ...
    v11[1] = 3221225472;
    v11[2] = __39__BRCServerZone_collectTombstoneRanks___block_invoke_165;
    v11[3] = &unk_1E875D8F0;
    v6 = v4;
    v7 = *(_QWORD *)(a1 + 32);
    v12 = v6;
...
uint64_t __39__BRCServerZone_collectTombstoneRanks___block_invoke_165(uint64_t a1)
{
  void *v1;
  _QWORD v3[5];
...
uint64_t __48__BRCServerZone_resetServerTruthAndDestroyZone___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v22 = 2112;
    v23 = v10;
    _os_log_error_impl(&dword_1CBD43000, v11, (os_log_type_t)0x90u, "[ERROR] failed purging zone %@ - %@%@", buf, 0x20u);
...
- (void)forceMoveToCloudDocs
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !appLibrary.wasMovedToCloudDocs%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
  ...
  if (v7 != state)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v26 = 2112;
      v27 = v9;
      _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ server state changed, %@ -> %@%@", buf, 0x2Au);
...
- (void)clearStateBits:(unsigned int)a3
{
  ...
  if ((state & a3) != 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_debug_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ server state changed, %@ -> %@%@", (uint8_t *)&v11, 0x2Au);
...
uint64_t __43__BRCServerZone_dumpStatusToContext_error___block_invoke(uint64_t a1, void *a2, int a3, void *a4, uint64_t a5)
{
  ...
  v36 = v8;
  v42 = v36;
  v38 = (void (**)(void))MEMORY[0x1D17A6DB0](v40);
  objc_msgSend(*(id *)(a1 + 32), "db");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  do
  {
    ...
    {
      v14 = objc_msgSend(v10, "integerAtIndex:", 41);
...
- (BOOL)dumpTablesToContext:(id)a3 includeAllItems:(BOOL)a4 error:(id *)a5
{
  ...
  v77 = 0;
  -[BRCServerZone descriptionWithContext:](self, "descriptionWithContext:", v7);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "writeLineWithFormat:", CFSTR("server items (%@)"), v9);
  ...
  if (v12)
  {
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "appLibraries");
    obj = (id)objc_claimAutoreleasedReturnValue();

    v19 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v52, v78, 16);
    if (v19)
    {
      v20 = *(_QWORD *)v53;
      v21 = 1;
      while (2)
      {
        for (i = 0; i != v19; ++i)
        {
          ...
          if (v16 >= 2)
          {
            ...
            objc_msgSend(v23, "logName");
            v24 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v23, "dbRowID");
            v25 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v10, "writeLineWithFormat:", CFSTR("----------------------%@[%@]----------------------"), v24, v25);

            v21 = 0;
          }
          *((_DWORD *)v65 + 6) = 0;
          v26 = v69[3];
          objc_msgSend(v23, "rootItemID");
          v27 = (void *)objc_claimAutoreleasedReturnValue();
          (*(void (**)(uint64_t, void *, _QWORD, id *))(v26 + 16))(v26, v27, 0, a5);
  ...
  objc_msgSend(v10, "db");
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  obj = (id)objc_msgSend(v28, "numberWithSQL:", CFSTR("SELECT COUNT(*) FROM server_items WHERE zone_rowid = %@"), self->_dbRowID);

  v29 = objc_msgSend(obj, "unsignedIntegerValue");
  if (v29 == objc_msgSend(v46, "count"))
  {
    v30 = 0;
  }
  else
  {
    if (!-[BRCServerZone isSharedZone](self, "isSharedZone"))
      objc_msgSend(v10, "writeLineWithFormat:", CFSTR("ORPHANED ITEMS:"));
    objc_msgSend(v10, "db");
    v31 = (void *)objc_claimAutoreleasedReturnValue();
    dbRowID = self->_dbRowID;
    ...
    v50[3] = &unk_1E875E1A8;
    v51 = (BRCPendingChangesStream *)v46;
    v33 = (void *)MEMORY[0x1D17A6DB0](v50);
    v30 = (void *)objc_msgSend(v31, "fetch:", CFSTR("SELECT zone_rowid, item_rank, item_origname, pcs_state, item_id, item_creator_id, item_sharing_options, item_side_car_ckinfo, item_stat_ckinfo, item_state, item_type, item_mode, item_birthtime, item_lastusedtime, item_favoriterank,item_parent_id, item_filename, item_hidden_ext, item_finder_tags, item_xattr_signature, item_trash_put_back_path, item_trash_put_back_parent_id, item_alias_target, item_creator, version_name, version_ckinfo, version_mtime, version_size, version_thumb_size, version_thumb_signature, version_content_signature, version_xattr_signature, version_edited_since_shared, version_device, version_conflict_loser_etags, version_quarantine_info, quota_used, recursive_child_count, shared_children_count, shared_alias_count, child_count FROM server_items WHERE zone_rowid = %@ AND call_block(%@, rowid)"), dbRowID, v33);

    *((_DWORD *)v65 + 6) = 0;
    while (objc_msgSend(v30, "next"))
    {
      v34 = (void *)MEMORY[0x1D17A6BE8]();
      session = self->_session;
      v36 = (id *)(v73 + 5);
      v49 = (id)v73[5];
      v37 = -[BRCAccountSession newServerItemFromPQLResultSet:error:](session, "newServerItemFromPQLResultSet:error:", v30, &v49);
      objc_storeStrong(v36, v49);
      ++*((_DWORD *)v65 + 6);
      v38 = objc_msgSend(v10, "shouldKeepDumpingWithItemCount:includeAllItems:");
      v39 = v38;
      if (v38)
      {
        objc_msgSend(v37, "descriptionWithContext:", v10);
        v40 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v10, "writeLineWithFormat:", CFSTR("%@%@"), v40, &stru_1E8769030);
  ...
  v42 = -[BRCPendingChangesStream initWithServerZone:]([BRCPendingChangesStream alloc], "initWithServerZone:", self);
  v43 = -[BRCPendingChangesStream dumpTablesToContext:includeAllItems:error:](v42, "dumpTablesToContext:includeAllItems:error:", v10, v47, a5);
  v41 = v43;
  if (a5)
    v44 = v43;
  else
    v44 = 0;
  if (v44)
    *a5 = objc_retainAutorelease((id)v73[5]);
LABEL_32:
...
uint64_t __59__BRCServerZone_dumpTablesToContext_includeAllItems_error___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4)
{
  ...
  if (objc_msgSend(v9, "next"))
  {
    ...
    {
      v13 = (void *)MEMORY[0x1D17A6BE8]();
      v14 = objc_msgSend(v9, "integerAtIndex:", 41);
      v15 = *(void **)(a1 + 32);
      ...
      if (objc_msgSend(*(id *)(a1 + 48), "containsIndex:", v14))
      {
        ...
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "stringFromItemID:context:", v18, *(_QWORD *)(a1 + 32));
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v16, "writeLineWithFormat:", CFSTR("%*sERROR: item ID %@ seen twice"), a3, v12, v19);
      }
      else
      {
        objc_msgSend(*(id *)(a1 + 48), "addIndex:", v14);
        v20 = *(void **)(*(_QWORD *)(a1 + 40) + 16);
        v21 = *(_QWORD *)(*(_QWORD *)(a1 + 64) + 8);
        obj = *(id *)(v21 + 40);
        v18 = (void *)objc_msgSend(v20, "newServerItemFromPQLResultSet:error:", v9, &obj);
        objc_storeStrong((id *)(v21 + 40), obj);
        if (!v18)
          goto LABEL_17;
        v22 = *(void **)(a1 + 32);
        objc_msgSend(v18, "descriptionWithContext:", v22);
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v22, "writeLineWithFormat:", CFSTR("%*s%@%@"), v39, v12, v23, &stru_1E8769030);

        objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 16), "applyScheduler");
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v24, "descriptionForServerItem:context:", v18, *(_QWORD *)(a1 + 32));
        v19 = (void *)objc_claimAutoreleasedReturnValue();

        if (v19)
          objc_msgSend(*(id *)(a1 + 32), "writeLineWithFormat:", CFSTR("%*s> apply{%@}"), v38, v12, v19);
        v25 = objc_msgSend(v18, "isDirectory");
        if ((int)a3 <= 99 && v25)
        {
          v26 = a3;
          v27 = v12;
          ...
          v31 = (void *)objc_claimAutoreleasedReturnValue();
          LOBYTE(v30) = (*(uint64_t (**)(uint64_t, void *, _QWORD, uint64_t))(v30 + 16))(v30, v31, v36, v37);
...
- (BOOL)validateStructureLoggingToFile:(__sFILE *)a3 db:(id)a4
{
  ...
  v4 = a4;
  abc_report_panic_with_signature();
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("you must override this"));
  objc_claimAutoreleasedReturnValue();
  brc_bread_crumbs();
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  brc_default_log();
...
void __58__BRCServerZone_BRCZoneMigration__scheduleMoveToCloudDocs__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: can't czm move clouddocs zone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)asPrivateZone
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: This is not a private zone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)asSharedZone
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: This is not a shared zone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveItemID:stat:serverMetrics:record:origName:base:no:ext:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _db.changes == 1%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveItemID:stat:serverMetrics:record:origName:base:no:ext:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] PCS chained directory doesn't have chain PCS! %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveItemID:stat:serverMetrics:record:origName:base:no:ext:.cold.4()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: BRCItemTypeIsDirectory(st.type)%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveItemID:stat:serverMetrics:record:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !(st.logicalName.br_isSideFaultName || [st.logicalName br_isExcludedWithMaximumDepth:1])%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveEditedDirOrDocStructureRecord:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_10_0(&dword_1CBD43000, v2, v3, "[DEBUG] saving consistent structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
...
- (void)_saveEditedDocumentContentRecord:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Adding %@ to the list of force package extensions (according to CKRecord)%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveEditedDocumentContentRecord:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Marking %@ as edited since shared because the modifier name is different%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveEditedDocumentContentRecord:error:.cold.3()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_4_4();
  OUTLINED_FUNCTION_10_0(&dword_1CBD43000, v2, v3, "[DEBUG] saving consistent document record (%@) to db %@%@", v4, v5, v6, v7, v8);
...
- (void)_saveEditedSymlinkRecord:error:.cold.1()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_4_4();
  OUTLINED_FUNCTION_10_0(&dword_1CBD43000, v2, v3, "[DEBUG] saving consistent symlink structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
...
- (void)_saveEditedFinderBookmarkRecord:error:.cold.1()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_4_4();
  OUTLINED_FUNCTION_10_0(&dword_1CBD43000, v2, v3, "[DEBUG] saving consistent finder bookmark structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
...
- (void)_saveEditedAliasRecord:(void *)a1 zonesNeedingAllocRanks:(uint64_t)a2 error:(NSObject *)a3 .cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  v14 = 2112;
  v15 = a2;
  _os_log_error_impl(&dword_1CBD43000, a3, (os_log_type_t)0x90u, "[ERROR] can't save %@: missing ownerKey for ownerName \"%@\"%@", (uint8_t *)&v10, 0x20u);
...
- (void)_saveEditedAliasRecord:zonesNeedingAllocRanks:error:.cold.2()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_4_4();
  OUTLINED_FUNCTION_10_0(&dword_1CBD43000, v2, v3, "[DEBUG] saving consistent alias structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
...
- (void)_saveEditedShareRecord:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] share without root record:\n    i:%@\n\n   this typically indicates either of two problems:\n    - either we failed processing the last sync down and we\n       failed inserting the shared record,\n    - or the server forgot to send it to us.%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveEditedShareRecord:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: share.currentUserParticipant.role != CKShareParticipantRoleOwner%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveEditedShareRecord:error:.cold.4()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] saving consistent share record to db %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveEditedRecord:zonesNeedingAllocRanks:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Can't save zone root record %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_saveEditedRecord:zonesNeedingAllocRanks:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: structure record which isn't a directory or document%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_markShareIDDead:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] marked shareID dead %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_markItemDeadForRecordID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Couldn't decode itemID from recordID %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_markItemDeadForRecordID:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Not inserting tombstone entry for %@ because we don't have a server item already.  Let's go through rejected code path for perf.%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_markItemDeadForRecordID:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] saving consistent record delete to db %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Failed to recover sharing options on %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] Fixing up sharing options to have shareID for something that looks like a shared zone root for %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Can't recover share options on shared zone child item %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.4()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] Stripping share options for something that doesn't seem to need them %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)allocateRanksWhenCaughtUp:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Forcing caught up state because we completed full sync so we must have synced down an unrelated zone%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)handleMovedZoneNames:(NSObject *)a3 .cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, a3, v4, "[CRIT] UNREACHABLE: Can't create app library and zones for zone named: %s%@", v5);
}
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Delta sync successfully alloced rank so allowing finished changes stream to be destroyed%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Allocating ranks for %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_cold_3(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  _os_log_error_impl(&dword_1CBD43000, a3, (os_log_type_t)0x90u, "[ERROR] something went wrong while saving to the db: %@%@", v5, 0x16u);
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_cold_4()
{
  ...
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@ is no longer full sync because of a large delta sync operation%@");
  OUTLINED_FUNCTION_2();
}
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_cold_5()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: requestID >= self->_changeState.clientRequestID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)didListDirectoryChangesWithResults:pendingFetchChanges:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Listed directory changes in zones %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)failedListingDirectoryChanges:serverTruthCallback:clientTruthCallback:folderItemID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _failedListDirectoryOperations[itemID] == nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_collectTombstoneForRank:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] Removing applied tombstone: %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCServerZone_resetServerTruthAndDestroyZone___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Finished resetting server truth%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __48__BRCServerZone_resetServerTruthAndDestroyZone___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Finishing destroying server truth%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)deleteAllContentsOnServerWithCompletionBlock:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: attempted delete all content on an unsupported zone type: %@%@");
  OUTLINED_FUNCTION_2();
}
