...
- (BRCUserDefaults)defaults
{
  ...
  {
    v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D10E88]), "initWithAppLibraryName:", self->_contextIdentifier);
...
- (BRCSyncContext)initWithSession:(id)a3 contextIdentifier:(id)a4 isShared:(BOOL)a5
{
  ...
  if (v19)
  {
    ...
    v47 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x1E0CB3828]);
    ...
    v49 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x1E0CB3828]);
    ...
    v67 = (NSMutableSet *)objc_alloc_init(MEMORY[0x1E0C99E20]);
...
void __61__BRCSyncContext_initWithSession_contextIdentifier_isShared___block_invoke(id *a1, uint64_t a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    v26 = 2112;
    v27 = v10;
    _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Uploader: preparing next batch for %@ (max-count:%ld size:%@ priority:%ld)%@", buf, 0x3Eu);
...
void __61__BRCSyncContext_initWithSession_contextIdentifier_isShared___block_invoke_30(id *a1, uint64_t a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    v26 = 2112;
    v27 = v10;
    _os_log_debug_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Downloader: preparing next batch for %@ (max-count:%ld size:%@ priority:%ld)%@", buf, 0x3Eu);
...
+ (id)_createCKContainerForAccountID:(id)a3 contextIdentifier:(id)a4
{
  ...
  v5 = (objc_class *)MEMORY[0x1E0C94C40];
  v6 = a4;
  v7 = a3;
  v8 = [v5 alloc];
  v9 = 1;
  v10 = (void *)objc_msgSend(v8, "initWithContainerIdentifier:environment:", *MEMORY[0x1E0D10D90], 1);
  v11 = (void *)objc_opt_new();
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94B98]), "initWithAccountID:", v7);
  ...
  if (v15)
  {
    v16 = objc_alloc(MEMORY[0x1E0C94CD0]);
    v17 = (void *)objc_msgSend(v16, "initWithLevel:name:value:", 2, *MEMORY[0x1E0D10BF0], *MEMORY[0x1E0D10BF8]);
  ...
  objc_msgSend(v19, "setSourceApplicationSecondaryIdentifier:", *MEMORY[0x1E0D10BD8]);
...
- (void)setupIfNeeded
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: [[[UMUserManager sharedManager] br_currentPersonaID] isEqualToString:_session.personaIdentifier]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
            ...
            if ((objc_msgSend(v14, "isFinished", obj) & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
              {
                *(_DWORD *)buf = 138412802;
                ...
                v40 = 2112;
                v41 = v15;
                _os_log_debug_impl(&dword_1CBD43000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] Cancelling discretionary operation %@ to make room for a non discretionary operation %@%@", buf, 0x20u);
              }
          ...
          for (j = 0; j != v18; ++j)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412802;
              ...
              v40 = 2112;
              v41 = v22;
              _os_log_debug_impl(&dword_1CBD43000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] Blocking discretionary op %@ on %@%@", buf, 0x20u);
            }
...
LABEL_10:
    ...
    if ((_DWORD)v23)
    {
      ...
      objc_msgSend(v29, "setSourceApplicationBundleIdentifier:", *MEMORY[0x1E0D10BD8]);
    }
    else
    {
      contextIdentifier = self->_contextIdentifier;
      ...
      objc_msgSend(v27, "setSourceApplicationSecondaryIdentifier:", *MEMORY[0x1E0D10BD8]);
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v59 = 2112;
    v60 = v32;
    _os_log_debug_impl(&dword_1CBD43000, v33, OS_LOG_TYPE_DEBUG, "[DEBUG] scheduling %@ on %@ (account %@)%@", buf, 0x2Au);
  ...
  {
    v42 = v8;
    -[BRCAccountSession accountWaitOperation](self->_session, "accountWaitOperation");
...
- (void)resume
{
  ...
  if (objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0D10CF8]))
  {
...
LABEL_4:
  ...
  v5 = objc_msgSend(v4, "isEqualToString:", *MEMORY[0x1E0D10DA0]);
...
- (void)close
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: _isCancelled%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 32) + 80) = 1;
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v28 = 2112;
      v29 = v6;
      _os_log_debug_impl(&dword_1CBD43000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] beginning forced foreground for %@ for %.1fs%@", buf, 0x20u);
    }

    v8 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, *(dispatch_queue_t *)(*(_QWORD *)(a1 + 32) + 72));
...
- (void)addForegroundClient:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Added %@ as a foreground client%@", (uint8_t *)&v11, 0x20u);
  }
...
- (void)removeForegroundClient:(id)a3
{
  ...
  if ((-[NSMutableSet containsObject:](v8->_foregroundClients, "containsObject:", v4) & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 2112;
      v16 = v9;
      _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Removed %@ as a foreground client%@", (uint8_t *)&v11, 0x20u);
    }
...
void __63__BRCSyncContext__armForegroundGraceTimerForClientDescription___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)&location[4] = v24;
    ...
    v34 = 2112;
    v35 = v9;
    _os_log_debug_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] beginning foreground grace period for %@ from %@ for %.1fs%@", location, 0x2Au);
  }

  v11 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, *(dispatch_queue_t *)(*(_QWORD *)(a1 + 32) + 72));
...
- (void)initWithSession:(void *)a1 contextIdentifier:isShared:.cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_6_3(&dword_1CBD43000, v1, v2, "[CRIT] UNREACHABLE: Trying to create a sync context while downloadsDeadlineScheduler still missing. Session open: %d%@", v3, v4, v5, v6, v7);
...
- (void)initWithSession:(void *)a1 contextIdentifier:isShared:.cold.2(void *a1)
{
  ...
  objc_msgSend(a1, "isOpen");
  OUTLINED_FUNCTION_7_4();
  OUTLINED_FUNCTION_6_3(&dword_1CBD43000, v1, v2, "[CRIT] UNREACHABLE: Trying to create a sync context while uploadsDeadlineScheduler still missing. Session open: %d%@", v3, v4, v5, v6, v7);
  OUTLINED_FUNCTION_20();
}
...
- (void)addOperation:(uint64_t)a1 allowsCellularAccess:nonDiscretionary:.cold.1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v1, v2, "[CRIT] UNREACHABLE: missing group for %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)addOperation:allowsCellularAccess:nonDiscretionary:.cold.3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: database%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __54__BRCSyncContext_forceContainerForegroundForDuration___block_invoke_69_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: self->_foregroundState == BRCContainerForegroundStateForcedForeground%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __54__BRCSyncContext_forceContainerForegroundForDuration___block_invoke_69_cold_2(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(a1 + 32);
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] forced foreground grace period over for %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
void __63__BRCSyncContext__armForegroundGraceTimerForClientDescription___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: there should be no timer created%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __63__BRCSyncContext__armForegroundGraceTimerForClientDescription___block_invoke_73_cold_1()
{
  ...
  v6 = 2112;
  v7 = v1;
  _os_log_debug_impl(&dword_1CBD43000, v2, OS_LOG_TYPE_DEBUG, "[DEBUG] grace period over for %@ %@%@", v3, 0x20u);
  OUTLINED_FUNCTION_20();
}
...
void __52__BRCSyncContext__notifyContainerBeingNowForeground__block_invoke_cold_1(_QWORD *a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] Cancelling foreground grace timer for %@ because we're now foreground again%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
