...
LABEL_41:
  ...
  if (a4 < 0 || v12 <= a4)
  {
    v21 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99DF0]), "initWithLength:", v12);
    ...
    *(_QWORD *)&buf[16] = __countSyncableXattrs_block_invoke;
    ...
    v11->_xattrCount = v26;
    v30 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99DF0]), "initWithLength:", 8 * v11->_xattrCount);
...
LABEL_26:
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithPOSIXCode:", 12);
  v16 = 0;
  ...
  if ((sizeLimit & 0x8000000000000000) == 0 && self->_cacheSize >= sizeLimit)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v35 = v22;
      _os_log_impl(&dword_1CBD43000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Do not attempt to get xattr size cache is full%@", buf, 0xCu);
    }
...
- (void)initWithFD:(NSObject *)a3 sizeLimit:syncable:error:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v5 = 2112;
  v6 = a1;
  OUTLINED_FUNCTION_3(&dword_1CBD43000, a3, (uint64_t)a3, "[ERROR] Xattr name list exceed size limit %ld%@", (uint8_t *)&v3);
  OUTLINED_FUNCTION_2();
}
...
- (void)getXattrValue:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: [cached isKindOfClass:[NSData class]]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
