...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing/modifyAccess", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  v7 = objc_alloc(MEMORY[0x1E0C94EE8]);
...
void __39__BRCSharingModifyAccessOperation_main__block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v7 && !v8 && !v9)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no dict and no error"));
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
    {
      ...
      v29 = 2112;
      v30 = v13;
      _os_log_error_impl(&dword_1CBD43000, v14, (os_log_type_t)0x90u, "[ERROR] Failed %@ access to %@ - %@%@", (uint8_t *)&v23, 0x2Au);
    }
...
void __39__BRCSharingModifyAccessOperation_main__block_invoke_2_cold_1()
{
  ...
  v6 = v1;
  v7 = v2;
  _os_log_debug_impl(&dword_1CBD43000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ access to %@%@", v4, 0x20u);
}
...
void __39__BRCSharingModifyAccessOperation_main__block_invoke_2_cold_2()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no dict and no error%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
