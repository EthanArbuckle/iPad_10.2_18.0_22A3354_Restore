...
+ (id)_userDefaultsManager
{
  ...
  if (_userDefaultsManager_once != -1)
    dispatch_once(&_userDefaultsManager_once, &__block_literal_global_322);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412546;
              ...
              v35 = 2112;
              v36 = v13;
              _os_log_fault_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: no version for key: %@%@", buf, 0x16u);
            }
...
+ (id)defaultsForSharedZone
{
  ...
  objc_msgSend(a1, "_userDefaultsManager");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "defaultsForIdentifier:", *MEMORY[0x1E0D10DF0]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)defaultsForSideCar
{
  ...
  objc_msgSend(a1, "_userDefaultsManager");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "defaultsForIdentifier:", *MEMORY[0x1E0D11150]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return -[NSString isEqualToString:](self->_clientZoneIdentifier, "isEqualToString:", *MEMORY[0x1E0D10DF0]);
}
...
- (id)_loadObjectForKey:(id)a3 inheritFromGlobal:(BOOL)a4 suiteName:(id)a5 validateWithBlock:(id)a6
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      v30 = 2112;
      v31 = v14;
      _os_log_debug_impl(&dword_1CBD43000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] server default for %@: %@%@", (uint8_t *)&v26, 0x20u);
    }

  }
  if (v11)
  {
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99EA0]), "initWithSuiteName:", v11);
  }
  else
  {
...
LABEL_13:
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      v30 = 2112;
      v31 = v20;
      _os_log_debug_impl(&dword_1CBD43000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] user default for %@: %@%@", (uint8_t *)&v26, 0x20u);
    }
...
LABEL_3:
  ...
  if (os_log_type_enabled(v12, (os_log_type_t)0x90u))
  {
    ...
    v27 = 2112;
    v28 = v11;
    _os_log_error_impl(&dword_1CBD43000, v12, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%d,%d]; using default:%d%@",
      (uint8_t *)&v17,
      0x32u);
  }
  ...
  v6 = 0x1E0CB3000;
LABEL_4:
  objc_msgSend(*(id *)(v6 + 2024), "numberWithInt:", v4);
...
LABEL_3:
  ...
  v6 = 0x1E0CB3000;
LABEL_4:
  objc_msgSend(*(id *)(v6 + 2024), "numberWithUnsignedInt:", v4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_3:
  ...
  if (os_log_type_enabled(v12, (os_log_type_t)0x90u))
  {
    ...
    v27 = 2112;
    v28 = v11;
    _os_log_error_impl(&dword_1CBD43000, v12, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%lld,%lld]; using default:%lld%@",
      (uint8_t *)&v17,
      0x3Eu);
  }
  ...
  v6 = 0x1E0CB3000;
LABEL_4:
  objc_msgSend(*(id *)(v6 + 2024), "numberWithUnsignedLongLong:", v4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_3:
  ...
  if (os_log_type_enabled(v13, (os_log_type_t)0x90u))
  {
    ...
    v28 = 2112;
    v29 = v12;
    _os_log_error_impl(&dword_1CBD43000, v13, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%f,%f]; using default:%f%@",
      (uint8_t *)&v18,
      0x3Eu);
  }
...
LABEL_4:
  *(float *)&v8 = v4;
  objc_msgSend(*(id *)(v6 + 2024), "numberWithFloat:", v8);
  ...
  if (validateUserDouble(v3, (double *)(a1 + 48), (double *)(a1 + 56), &v12) == 2)
  {
    ...
    if (os_log_type_enabled(v5, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413570;
      ...
      v23 = 2112;
      v24 = v4;
      _os_log_error_impl(&dword_1CBD43000, v5, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%f,%f]; using default:%f%@",
        buf,
        0x3Eu);
    }
  ...
  if (validateUserBool(v3, &v10) == 2)
  {
    ...
    if (os_log_type_enabled(v5, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_error_impl(&dword_1CBD43000, v5, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@; using default:%s%@",
        buf,
        0x2Au);
    }
...
LABEL_34:
    ...
    if (os_log_type_enabled(v33, (os_log_type_t)0x90u))
    {
      ...
      *(_QWORD *)&buf[4] = v48;
      ...
      v69 = 2112;
      v70 = v32;
      _os_log_error_impl(&dword_1CBD43000, v33, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@.%@: %@; using default:%@%@",
        buf,
        0x34u);
    }

    objc_msgSend(MEMORY[0x1E0C99E08], "dictionaryWithDictionary:", *(_QWORD *)(v51 + 32));
...
LABEL_38:
  ...
  v37 = v36;
  if (v36)
    xpc_dictionary_set_int64(v35, (const char *)*MEMORY[0x1E0C807A8], objc_msgSend(v36, "longLongValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("delay"));
  v38 = (void *)objc_claimAutoreleasedReturnValue();

  if (v38)
    xpc_dictionary_set_int64(v35, (const char *)*MEMORY[0x1E0C80760], objc_msgSend(v38, "longLongValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("grace"));
  v39 = (void *)objc_claimAutoreleasedReturnValue();

  if (v39)
    xpc_dictionary_set_int64(v35, (const char *)*MEMORY[0x1E0C80790], objc_msgSend(v39, "longLongValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("repeat"));
  v40 = (void *)objc_claimAutoreleasedReturnValue();

  if (v40)
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x1E0C80898], objc_msgSend(v40, "BOOLValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("priority"));
  v41 = (void *)objc_claimAutoreleasedReturnValue();

  if (v41)
    xpc_dictionary_set_string(v35, (const char *)*MEMORY[0x1E0C80878], (const char *)objc_msgSend(objc_retainAutorelease(v41), "UTF8String"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("battery"));
  v42 = (void *)objc_claimAutoreleasedReturnValue();

  if (v42)
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x1E0C80738], objc_msgSend(v42, "BOOLValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("powernap"));
  v43 = (void *)objc_claimAutoreleasedReturnValue();

  if (v43)
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x1E0C80868], objc_msgSend(v43, "BOOLValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("screen.sleep"));
  v44 = (void *)objc_claimAutoreleasedReturnValue();

  if (v44)
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x1E0C808D8], objc_msgSend(v44, "BOOLValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("disk-intensive"));
  v45 = (void *)objc_claimAutoreleasedReturnValue();

  if (v45)
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x1E0C80770], objc_msgSend(v45, "BOOLValue"));
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("may.reboot"));
  v46 = (void *)objc_claimAutoreleasedReturnValue();

  if (v46)
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x1E0C80800], objc_msgSend(v46, "BOOLValue"));
...
- (unsigned)maxSyncPathDepth
{
  ...
  v3 = 4 * -[BRCUserDefaults maxRelativePathDepth](self, "maxRelativePathDepth");
...
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("fs.pkg.extensions"), &unk_1E87D8868);
}

- (NSSet)blacklistedPackageExtensions
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("fs.pkg.blacklist.extensions"), &unk_1E87D8880);
}
...
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("fs.bundle-bit.fixup.backlist.ios"), MEMORY[0x1E0C9AA60]);
}

- (NSSet)shouldBeGreedyExtensions
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("fs.greedy.extensions.ios"), MEMORY[0x1E0C9AA60]);
}

- (NSSet)nonAutoEvictableExtensions
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("fs.non-auto-evictable.extensions.ios"), MEMORY[0x1E0C9AA60]);
}

- (NSSet)nonEvictableExtensions
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("fs.non-evictable.extensions.ios"), MEMORY[0x1E0C9AA60]);
}

- (NSSet)nonEvictablePathComponents
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("fs.non-evictable.path-components.ios"), MEMORY[0x1E0C9AA60]);
}

- (NSSet)nonAutoEvictableUTIs
{
  return (NSSet *)-[BRCUserDefaults _UTISetFor:startingWithExtensions:](self, "_UTISetFor:startingWithExtensions:", CFSTR("fs.non-auto-evictable.utis.ios"), MEMORY[0x1E0C9AA60]);
}

- (NSSet)autoEvictableUTIs
{
  return (NSSet *)-[BRCUserDefaults _UTISetFor:startingWithExtensions:](self, "_UTISetFor:startingWithExtensions:", CFSTR("fs.auto-evictable.utis.ios"), MEMORY[0x1E0C9AA60]);
}

- (NSSet)blacklistedThumbnailExtensions
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("doc.thumbnail-blacklist.extensions"), &unk_1E87D8898);
}
...
- (OS_xpc_object)configurationUpdateXPCActivity
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", 2 * *MEMORY[0x1E0C807B8]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v4;
  v11[1] = CFSTR("delay");
...
- (OS_xpc_object)transmogrifyXPCActivity
{
  ...
  v11[0] = CFSTR("interval");
  v3 = *MEMORY[0x1E0C807B8];
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", 3 * *MEMORY[0x1E0C807B8]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v4;
  v11[1] = CFSTR("delay");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", v3);
...
{
  return (NSArray *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("sync-throttles"), 1, &__block_literal_global_1135);
}
...
{
  return (BRCSyncOperationThrottleParams *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("sync.down.throttle"), 1, &__block_literal_global_1181);
}
...
{
  return (BRCSyncOperationThrottleParams *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("sync.up.throttle"), 1, &__block_literal_global_1188);
}
...
- (float)syncUpDailyBudget
{
  ...
  if (clientZoneIdentifier
    && !-[NSString isEqualToString:](clientZoneIdentifier, "isEqualToString:", *MEMORY[0x1E0D10DB0]))
  {
...
- (BOOL)shouldAppLibraryBeGreedy
{
  ...
  v3 = -[NSString isEqualToString:](self->_clientZoneIdentifier, "isEqualToString:", *MEMORY[0x1E0D10CF8]);
...
- (OS_xpc_object)stageGCXPCActivity
{
  ...
  v11[0] = CFSTR("interval");
  v3 = *MEMORY[0x1E0C807C0];
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *MEMORY[0x1E0C807C0]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v12[0] = v4;
  v11[1] = CFSTR("delay");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *MEMORY[0x1E0C807D0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v12[1] = v5;
  v11[2] = CFSTR("grace");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", v3);
...
- (OS_xpc_object)cacheDeletePushXPCActivity
{
  ...
  v10[0] = CFSTR("delay");
  v3 = *MEMORY[0x1E0C807D8];
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *MEMORY[0x1E0C807D8]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = v4;
  v10[1] = CFSTR("grace");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", v3);
...
{
  return (NSString *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("server-config-url"), 1, &__block_literal_global_1297);
}
...
{
  return (NSSet *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("zone-pcs-migration.blacklist-pcs-prep"), 1, &__block_literal_global_1416);
}
...
id __35__BRCUserDefaults_blacklistPCSPrep__block_invoke(uint64_t a1, void *a2)
{
  ...
  _stringSetFromDefaultValue(a2, 0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = *MEMORY[0x1E0D10DB0];
  objc_msgSend(v2, "addObject:", *MEMORY[0x1E0D10DB0]);
  if (v2)
  {
    v4 = v2;
  }
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99E20], "setWithObjects:", v3, *MEMORY[0x1E0D10DA0], *MEMORY[0x1E0D10E20], CFSTR("_defaultZone"), 0);
    v4 = (id)objc_claimAutoreleasedReturnValue();
  }
  v5 = v4;
...
{
  return (NSSet *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("excluded-filenames-worth-warning-at-logout"), 1, &__block_literal_global_1439);
}
...
id __56__BRCUserDefaults_excludedFilenamesWorthWarningAtLogout__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0D10EC8], "defaultExcludedFilenamesWorthWarningAtLogout");
    v4 = (id)objc_claimAutoreleasedReturnValue();
  }
  v5 = v4;
...
{
  return (NSSet *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("excluded-filenames-worth-preservering"), 1, &__block_literal_global_1443);
}
...
id __51__BRCUserDefaults_excludedFilenamesWorthPreserving__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0D10EC8], "defaultExcludedFilenamesWorthPreserving");
    v4 = (id)objc_claimAutoreleasedReturnValue();
  }
  v5 = v4;
...
{
  return (NSSet *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("excluded-extensions-worth-preservering"), 1, &__block_literal_global_1446);
}
...
id __52__BRCUserDefaults_excludedExtensionsWorthPreserving__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0D10EC8], "defaultExcludedExtensionsWorthPreserving");
    v4 = (id)objc_claimAutoreleasedReturnValue();
  }
  v5 = v4;
...
{
  if (-[NSString isEqualToString:](self->_clientZoneIdentifier, "isEqualToString:", *MEMORY[0x1E0D10B20]))
    ...
    if (v16 >= v8)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          v29 = 2112;
          v30 = v17;
          _os_log_debug_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] We are denylisted from %@ because %d < %d and %d%@", (uint8_t *)&v21, 0x28u);
        }
        v15 = 0;
      }
    }
...
- (OS_xpc_object)aggressivePCSChainActivity
{
  ...
  v9[0] = CFSTR("delay");
  v9[1] = CFSTR("grace");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *MEMORY[0x1E0C807E8]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (OS_xpc_object)finishSaltingPartiallySaltedDirectoriesActivity
{
  ...
  v9[0] = CFSTR("delay");
  v9[1] = CFSTR("grace");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *MEMORY[0x1E0C807B8]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = MEMORY[0x1E0C9AAA0];
  v10[1] = v3;
  v10[2] = MEMORY[0x1E0C9AAA0];
...
- (BOOL)canSaveRecordsDirectlyForDeltaSync
{
  ...
  v3 = -[NSString isEqualToString:](self->_clientZoneIdentifier, "isEqualToString:", *MEMORY[0x1E0D10DF0]);
...
- (BOOL)isBlacklistedFromFolderSharing
{
  ...
  v3 = -[NSString isEqualToString:](self->_clientZoneIdentifier, "isEqualToString:", *MEMORY[0x1E0D10B40]);
...
- (OS_xpc_object)fpfsMigrationTrialRefreshXPCActivity
{
  ...
  v8[0] = CFSTR("interval");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", 6 * *MEMORY[0x1E0C807C0]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = v3;
  v8[1] = CFSTR("priority");
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", *MEMORY[0x1E0C80880]);
...
- (OS_xpc_object)fpfsMigrationSchedulerXPCActivity
{
  ...
  v10[5] = *MEMORY[0x1E0C80C00];
  if (objc_msgSend(MEMORY[0x1E0D10ED0], "isInternalBuild"))
    v3 = *MEMORY[0x1E0C807B8];
  else
    v3 = 3 * *MEMORY[0x1E0C807B8];
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v10[0] = v4;
  v9[0] = CFSTR("interval");
  ...
  v10[3] = MEMORY[0x1E0C9AAB0];
  v10[4] = MEMORY[0x1E0C9AAB0];
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v10, v9, 5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (NSSet *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("telemetry.header-send-supported-classes"), 1, &__block_literal_global_1625);
}
...
{
  return (NSSet *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("telemetry.benign-error-descriptions"), 1, &__block_literal_global_1637);
}
...
id __51__BRCUserDefaults_benignTelemetryErrorDescriptions__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v2)
  {
    objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("CKErrorZoneNotFound"), CFSTR("CKErrorSharedZoneNotFound"), CFSTR("CKErrorUserDeletedZone"), CFSTR("zone became healthy"), CFSTR("testing"), 0);
    v2 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v2;
}
      ...
      do
      {
        ...
        if ((int)objc_msgSend(*(id *)(*((_QWORD *)&v16 + 1) + 8 * v8), "intValue", v15) >= 20)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v15;
            v21 = v9;
            _os_log_fault_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [error intValue] < BRCProblemTypeMaxValue%@", buf, 0xCu);
          }
...
{
  return (NSSet *)-[BRCUserDefaults _healthErrorSetForKey:byDefault:](self, "_healthErrorSetForKey:byDefault:", CFSTR("zone-health.errors-for-reset"), &unk_1E87D88B0);
}

- (NSSet)healthErrorsToReport
{
  return (NSSet *)-[BRCUserDefaults _healthErrorSetForKey:byDefault:](self, "_healthErrorSetForKey:byDefault:", CFSTR("zone-health.errors-to-report"), &unk_1E87D88C8);
}

- (NSSet)recordsToIgnoreOnSyncDown
{
  return (NSSet *)-[BRCUserDefaults objectForKey:inheritFromGlobal:validateWithBlock:](self, "objectForKey:inheritFromGlobal:validateWithBlock:", CFSTR("sync.ignored-record-names"), 1, &__block_literal_global_1687);
}
...
id __44__BRCUserDefaults_recordsToIgnoreOnSyncDown__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v2)
  {
    objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("directory/appData_com.apple.Desktop"), CFSTR("directory/appDocuments_com.apple.Desktop"), CFSTR("directory/appData_com.apple.Documents"), CFSTR("directory/appDocuments_com.apple.Documents"), 0);
    v2 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v2;
}
      ...
      do
      {
        ...
        if ((int)objc_msgSend(*(id *)(*((_QWORD *)&v16 + 1) + 8 * v8), "intValue", v15) <= 0)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v15;
            v21 = v9;
            _os_log_fault_impl(&dword_1CBD43000, v10, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [errorID intValue] > 0%@", buf, 0xCu);
          }
...
{
  return -[BRCUserDefaults BOOLForKey:byDefault:](self, "BOOLForKey:byDefault:", CFSTR("fpfs.use-trial-to-gate-fpfs-migration"), 1);
}

- (unsigned)listFilesIngestedBatchSize
{
  return -[BRCUserDefaults unsignedIntForKey:min:max:byDefault:](self, "unsignedIntForKey:min:max:byDefault:", CFSTR("list-files-ingested.batch-size"), 1, 0xFFFFFFFFLL, 200);
}

- (BOOL)ignoreFaultingErrorsDuringDirectoryProviding
{
  return -[BRCUserDefaults BOOLForKey:byDefault:](self, "BOOLForKey:byDefault:", CFSTR("ignore-faulting-errors-for-directory-provide"), 1);
}
...
{
  return (NSSet *)-[BRCUserDefaults _brErrorSetForKey:byDefault:](self, "_brErrorSetForKey:byDefault:", CFSTR("abc.ignored-ck-errors"), &unk_1E87D88E0);
}
...
{
  if (-[NSString isEqualToString:](self->_clientZoneIdentifier, "isEqualToString:", *MEMORY[0x1E0D10CF8]))
...
{
  return (NSSet *)-[BRCUserDefaults _extensionSetForKey:startingWithExtensions:](self, "_extensionSetForKey:startingWithExtensions:", CFSTR("reset.reasons.to.trigger.ttr"), &unk_1E87D88F8);
}
...
- (void)_shouldRampForKey:session:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] We are not denylisted from %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_shouldRampForKey:session:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] We are not denylisted from %@ chaining because we are in carry%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_shouldRampForKey:session:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] We are not denylisted from %@ because we are on an internal build%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_shouldRampForKey:session:.cold.4()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] We are not denylisted from %@ because we are on an internal build and in carry%@");
  OUTLINED_FUNCTION_2();
}
