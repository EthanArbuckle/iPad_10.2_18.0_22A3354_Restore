...
- (id)initDeltaSyncWithServerZone:(id)a3 sessionContext:(id)a4
{
  ...
  v12 = objc_msgSend(v11, "isEqualToString:", *MEMORY[0x1E0C94730]);
...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sync-down", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)_performAfterFetchingRecordChanges:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v111[10] = 2112;
      *(_QWORD *)&v111[12] = v12;
      _os_log_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_INFO, "[INFO] ┣%llx %@ fetch record changes operation for %@ from token %@%@", buf, 0x34u);
    ...
    v21 = objc_alloc(MEMORY[0x1E0C94DE8]);
    ...
    *(_QWORD *)&v111[8] = 0;
    ...
    v72 = buf;
    v70 = v37;
    v38 = (void *)MEMORY[0x1D17A6DB0](v69);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_15(uint64_t a1, void *a2)
{
  ...
  if (objc_msgSend(v5, "hasValue:forName:", *MEMORY[0x1E0D10BF8], *MEMORY[0x1E0D10BF0]))
  {
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_2(uint64_t a1)
{
  ...
  v2 = objc_alloc(MEMORY[0x1E0D10E88]);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_20(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v33 = 2112;
    v34 = v11;
    _os_log_impl(&dword_1CBD43000, v12, OS_LOG_TYPE_INFO, "[INFO] ┳%llx got a record in operation %@%@", buf, 0x20u);
...
LABEL_18:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412802;
    ...
    v33 = 2112;
    v34 = v17;
    _os_log_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] Record fetch failed for %@ with error %@%@", buf, 0x20u);
  }
LABEL_12:
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_22(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v21 = 2112;
    v22 = v8;
    _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got a deletion in operation %@%@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v19 = 2112;
    v20 = v10;
    _os_log_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_INFO, "[INFO] record was deleted: %@%@", buf, 0x16u);
  }

  v12 = objc_msgSend(v6, "isEqualToString:", *MEMORY[0x1E0C94A20]);
  v13 = *(void **)(a1 + 32);
  if (v12)
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_24(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    v46 = 2112;
    v47 = v14;
    _os_log_debug_impl(&dword_1CBD43000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx received updated server change token %@ client change token %@ in operation %@ status %ld%@", buf, 0x3Eu);
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "saveRecordsWithServerChangeToken:clientChangeToken:syncStatus:", v8, v21, v13) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v40 = 2112;
      v41 = v24;
      _os_log_fault_impl(&dword_1CBD43000, v25, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: broken structure in op %@ change token %@%@", buf, 0x20u);
    ...
    objc_msgSend(v8, "descriptionWithContext:", 0);
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v26, "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: broken structure in op %@ change token %@"), v27, v28);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_29(uint64_t a1, void *a2, void *a3, void *a4, int a5, void *a6)
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v32 = 2112;
    v33 = v16;
    _os_log_debug_impl(&dword_1CBD43000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx fetch changes completion for zone in operation %@%@", buf, 0x20u);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_4(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v24 = 2112;
    v25 = v4;
    _os_log_debug_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx fetch changes completed for operation %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        v24 = 2112;
        v25 = v9;
        _os_log_error_impl(&dword_1CBD43000, v14, (os_log_type_t)0x90u, "[ERROR] sync-down failed for %@: %@%@", buf, 0x20u);
      }
...
- (void)_saveInitialServerZoneData:(id)a3 clientChangeTokenData:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v27 = 2112;
    v28 = v8;
    _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetched initial server zone tokens %@ and %@ for %@%@", buf, 0x2Au);
  }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v27 = 2112;
    v28 = v13;
    _os_log_debug_impl(&dword_1CBD43000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] Saving initial zone data of %@ with server token %@ client token %@%@", buf, 0x2Au);
  }
  ...
  -[_BRCOperation completedWithResult:error:](self, "completedWithResult:error:", &unk_1E87D79B8, 0);
}
...
void __68__BRCSyncDownOperation__fetchInitialZoneIfNecessaryWithCreatedZone___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!(v5 | v9))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: no fetched zone and no error"));
    v5 = objc_claimAutoreleasedReturnValue();
  }
  v12 = *(void **)(a1 + 32);
  if (v5)
...
- (void)main
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_debug_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Sync: fetching record changes for %@%@", buf, 0x20u);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, (uint64_t)v0, "[NOTIF] Enhanced Drive Privacy enablement discovered via delta sync for %@%@", v1);
  OUTLINED_FUNCTION_2();
}
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_20_cold_1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !record || record.etag != nil%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_20_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: got a nil record and recordID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_20_cold_3(void *a1, uint64_t a2, uint64_t a3, NSObject *a4)
{
  ...
  *(_WORD *)(a3 + 12) = 2112;
  *(_QWORD *)(a3 + 14) = a2;
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, a4, a3, "[DEBUG] record changed: %@%@", (uint8_t *)a3);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_4_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] success%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_4_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] cancelled%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)handleZoneNotFoundIfSyncingDownForTheFirstTime:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] ignoring zone not found error, because we're syncing down for the first time%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __68__BRCSyncDownOperation__fetchInitialZoneIfNecessaryWithCreatedZone___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: no fetched zone and no error%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __66__BRCSyncDownOperation__startCreateZoneAndSubscriptionAndSyncDown__block_invoke_2_cold_1()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v0, (uint64_t)v0, "[DEBUG] can't register pushes: %@%@", v1);
  OUTLINED_FUNCTION_2();
}
...
void __66__BRCSyncDownOperation__startCreateZoneAndSubscriptionAndSyncDown__block_invoke_2_cold_2()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] can't create zone or register pushes: %@%@", v1, 0x16u);
  OUTLINED_FUNCTION_2();
}
