...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sync/zone-purge", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  v9 = objc_alloc(MEMORY[0x1E0C94EF0]);
  ...
  {
    v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94EF0]), "initWithRecordZonesToSave:recordZoneIDsToDelete:", 0, v8);
...
void __29__BRCZonePurgeOperation_main__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] deleted %@ on server%@");
}
...
void __29__BRCZonePurgeOperation_main__block_invoke_5_cold_1()
{
  ...
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] deleted shared zones associated to %@ on server%@");
}
