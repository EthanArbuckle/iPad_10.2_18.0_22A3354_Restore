...
- (uint64_t)brc_signatureIsValid
{
  ...
  if ((objc_msgSend(a1, "brc_signatureIsPendingPlaceHolder") & 1) == 0)
  {
    if ((objc_msgSend(a1, "brc_signatureIsPackage") & 1) != 0
      || (objc_msgSend(MEMORY[0x1E0C95138], "isValidSignature:", a1) & 1) != 0)
    {
      return 1;
    }
    brc_bread_crumbs();
...
- (id)brc_signature
{
  ...
  v2 = objc_alloc_init(MEMORY[0x1E0C95138]);
...
- (void)brc_signatureIsValid
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_error_impl(&dword_1CBD43000, log, (os_log_type_t)0x90u, "[ERROR] invalid signature in %@%@", (uint8_t *)&v3, 0x16u);
}
