...
- (BRCDatabaseBackupStorage)initWithDatabaseURL:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      v12 = *MEMORY[0x1E0C9AC80];
      v22[0] = *MEMORY[0x1E0C998C8];
      v22[1] = v12;
      v13 = *MEMORY[0x1E0C999A8];
      v22[2] = *MEMORY[0x1E0C998F8];
      v22[3] = v13;
      v22[4] = *MEMORY[0x1E0C999D0];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v27 = 2112;
        v28 = v16;
        _os_log_error_impl(&dword_1CBD43000, v17, (os_log_type_t)0x90u, "[ERROR] Can't open database at %@: %@%@", buf, 0x20u);
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v13 = 2112;
      v14 = v5;
      _os_log_error_impl(&dword_1CBD43000, v6, (os_log_type_t)0x90u, "[ERROR] Can't close database at %@: %@%@", buf, 0x20u);
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_error_impl(&dword_1CBD43000, v11, (os_log_type_t)0x90u, "[ERROR] Can't insert into the database %@: %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v24 = 2112;
        v25 = v13;
        _os_log_error_impl(&dword_1CBD43000, v14, (os_log_type_t)0x90u, "[ERROR] Can't insert into the database %@: %@%@", buf, 0x20u);
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v12, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v20 = 2112;
      v21 = v11;
      _os_log_error_impl(&dword_1CBD43000, v12, (os_log_type_t)0x90u, "[ERROR] Can't close database at %@: %@%@", buf, 0x20u);
...
- (id)backupManifestEnumerator:(id)a3
{
  ...
  objc_msgSend(v3, "enumerateObjects:", &__block_literal_global_24);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)populateNewColumnsWithBasePath:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v13 = 2112;
    v14 = v5;
    _os_log_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_INFO, "[INFO] Populating new columns with base path: %@%@", buf, 0x16u);
  }
...
- (void)populateNewColumnsInDatabase:(id)a3 forRecord:(id)a4 basePath:(id)a5
{
  ...
  if (v15)
  {
    objc_msgSend(v15, "objectForKeyedSubscript:", *MEMORY[0x1E0C9AC80]);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v15, "objectForKeyedSubscript:", *MEMORY[0x1E0C999A8]);
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&v41[6] = v32;
      v42 = 2112;
      v43 = v23;
      _os_log_debug_impl(&dword_1CBD43000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] Updating %@ %@ %d into database for %@%@", buf, 0x30u);
    ...
    if ((v25 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v28, (os_log_type_t)0x90u))
      {
        ...
        *(_QWORD *)&v41[6] = v30;
        ...
        v44 = 2112;
        v45 = v27;
        _os_log_error_impl(&dword_1CBD43000, v28, (os_log_type_t)0x90u, "[ERROR] Failed to update %@ %@ %d into database for %@: %@%@", buf, 0x3Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v40 = 2112;
      *(_QWORD *)v41 = v17;
      _os_log_error_impl(&dword_1CBD43000, v19, (os_log_type_t)0x90u, "[ERROR] Unable to fetch URL properties for %@: %@%@", buf, 0x20u);
...
- (BOOL)attachDatabase:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v8;
    _os_log_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_INFO, "[INFO] Attaching database %@%@", buf, 0x16u);
  ...
  if (self->_attachedDatabaseURL)
  {
    ...
    if (os_log_type_enabled(v13, (os_log_type_t)0x90u))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v37 = v12;
      _os_log_error_impl(&dword_1CBD43000, v13, (os_log_type_t)0x90u, "[ERROR] Already have attached database %@ while trying to attach database %@.%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)v30 = 138412802;
        ...
        v34 = 2112;
        v35 = v17;
        _os_log_error_impl(&dword_1CBD43000, v18, (os_log_type_t)0x90u, "[ERROR] Unable to attach db %@: %@%@", v30, 0x20u);
...
- (id)docIDForURL:(id)a3
{
  ...
  v5 = v4;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", GSLibraryGetOrAllocateDocumentId());
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (close(v5))
  {
    brc_bread_crumbs();
  ...
  if (self->_attachedDatabaseURL)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v16 = 2112;
      v17 = v3;
      _os_log_impl(&dword_1CBD43000, v4, OS_LOG_TYPE_INFO, "[INFO] Updating attached database %@ %@%@", buf, 0x20u);
...
uint64_t __50__BRCDatabaseBackupStorage_updateAttachedDatabase__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "setForeignKeys:enabled:", v3, 0))
  {
    if (objc_msgSend(*(id *)(a1 + 32), "negateIDs:", v3)
      ...
      && objc_msgSend(*(id *)(a1 + 32), "fixUpClientState:", v3)
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        v35 = 2112;
        v36 = v20;
        _os_log_error_impl(&dword_1CBD43000, v22, (os_log_type_t)0x90u, "[ERROR] Unable to get inode for %@: %@%@", buf, 0x20u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v35 = 2112;
    v36 = v15;
    _os_log_error_impl(&dword_1CBD43000, v20, (os_log_type_t)0x90u, "[ERROR] Unable to get inode for %@: %@%@", buf, 0x20u);
...
- (BOOL)fixUpClientState:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)objc_msgSend(v3, "fetch:", CFSTR("SELECT * FROM client_state"));
  +[BRCAccountSession _classesForClientState](BRCAccountSession, "_classesForClientState");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v4, "next"))
  {
    objc_msgSend(v4, "unarchivedObjectOfClasses:atIndex:", v5, 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "close");
    v7 = -[BRCClientState initWithDictionary:clientStateData:]([BRCClientState alloc], "initWithDictionary:clientStateData:", v6, 0);
    -[BRCClientState objectForKeyedSubscript:](v7, "objectForKeyedSubscript:", CFSTR("fsevents"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = (void *)objc_msgSend(v3, "fetchObjectOfClass:sql:", objc_opt_class(), CFSTR("SELECT new_file_id FROM backup_manifest WHERE file_id = %llu"), objc_msgSend(v8, "rootID"));
    objc_msgSend(v8, "setRootID:", objc_msgSend(v9, "unsignedLongLongValue"));
    -[BRCClientState dictionary](v7, "dictionary");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = (void *)objc_msgSend(v10, "mutableCopy");
    v12 = objc_msgSend(v3, "execute:", CFSTR("UPDATE client_state SET v = %@"), v11);
    ...
    if ((v12 & 1) != 0)
    {
      ...
      v14 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        -[BRCDatabaseBackupStorage fixUpClientState:].cold.1();
    }
    else
    {
      brc_bread_crumbs();
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_FAULT))
        -[BRCDatabaseBackupStorage fixUpClientState:].cold.2();
    }
  ...
  else
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    brc_default_log();
    v7 = (BRCClientState *)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(&v7->super, OS_LOG_TYPE_FAULT))
      -[BRCDatabaseBackupStorage fixUpClientState:].cold.3();
    v12 = 0;
  }
...
void __48__BRCDatabaseBackupStorage_addRecordIfNotExist___block_invoke_cold_1(uint64_t *a1)
{
  ...
  v4 = v1;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v2, (uint64_t)v2, "[DEBUG] Added record: %@%@", (uint8_t *)&v3);
  OUTLINED_FUNCTION_2();
}
...
void __41__BRCDatabaseBackupStorage_flushAndClose__block_invoke_cold_1(id *a1, uint64_t a2, NSObject *a3)
{
  ...
  v14 = 2112;
  v15 = a2;
  _os_log_error_impl(&dword_1CBD43000, a3, (os_log_type_t)0x90u, "[ERROR] Could not create a unique index %@: %@%@", (uint8_t *)&v10, 0x20u);
...
- (void)docIDForURL:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to open %@%@", v4, v5, v6, v7, v8);
...
- (void)docIDForURL:.cold.2()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] failed closing %@%@", v4, v5, v6, v7, v8);
...
- (void)updateAttachedDatabase
{
  ...
  _os_log_error_impl(&dword_1CBD43000, v0, (os_log_type_t)0x90u, "[ERROR] Not updating attached database because no database has been attached.%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
void __50__BRCDatabaseBackupStorage_updateAttachedDatabase__block_invoke_cold_1(uint64_t a1)
{
  ...
  v3 = a1;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v1, (uint64_t)v1, "[DEBUG] Successfully finished updating attach database batch: %@%@", (uint8_t *)&v2);
  OUTLINED_FUNCTION_2();
}
...
void __50__BRCDatabaseBackupStorage_updateAttachedDatabase__block_invoke_cold_2(uint64_t a1)
{
  ...
  v3 = a1;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_3_2(&dword_1CBD43000, v1, (uint64_t)v1, "[DEBUG] Beginning update attach database batch: %@%@", (uint8_t *)&v2);
  OUTLINED_FUNCTION_2();
}
...
- (void)setForeignKeys:enabled:.cold.1()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to enable foreign keys: %@%@", v4, v5, v6, v7, v8);
...
- (void)setForeignKeys:enabled:.cold.2()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to disable foreign keys: %@%@", v4, v5, v6, v7, v8);
...
- (void)negateIDs:.cold.1()
{
  ...
  OUTLINED_FUNCTION_9_0();
  OUTLINED_FUNCTION_9_2(v0, v1);
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] Changed %lld items when negating doc ids%@", v4, v5, v6, v7, v8);
...
- (void)negateIDs:.cold.2()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to negate doc ids: %@%@", v4, v5, v6, v7, v8);
...
- (void)negateIDs:.cold.3()
{
  ...
  OUTLINED_FUNCTION_9_2(v0, v1);
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] Changed %lld items when negating file ids%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_3_0();
}
...
- (void)negateIDs:.cold.4()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to negate file ids: %@%@", v4, v5, v6, v7, v8);
...
- (void)updateIDs:.cold.1()
{
  ...
  OUTLINED_FUNCTION_9_2(v0, v1);
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] Changed %lld items when updating doc ids%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_3_0();
}
...
- (void)updateIDs:.cold.2()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to update the doc ids: %@%@", v4, v5, v6, v7, v8);
...
- (void)updateIDs:.cold.3()
{
  ...
  OUTLINED_FUNCTION_9_2(v0, v1);
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] Changed %lld items when updating file ids%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_3_0();
}
...
- (void)updateIDs:.cold.4()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to update the file ids: %@%@", v4, v5, v6, v7, v8);
...
- (void)updateIDs:.cold.5()
{
  ...
  OUTLINED_FUNCTION_9_2(v0, v1);
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] Changed %lld items when updating gen counts%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_3_0();
}
...
- (void)updateIDs:.cold.6()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to update the gen count: %@%@", v4, v5, v6, v7, v8);
...
- (void)updateIDs:.cold.7()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Created doc_id_index%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)updateIDs:.cold.8()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to create doc_id_index, so updating will be incredibly slow: %@%@", v4, v5, v6, v7, v8);
...
- (void)updateIDs:.cold.9()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Created file_id_gen_count_index%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)updateIDs:.cold.10()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to create file_id_gen_count_index, so updating will be incredibly slow: %@%@", v4, v5, v6, v7, v8);
...
- (void)clearStagedIDs:.cold.1()
{
  ...
  OUTLINED_FUNCTION_9_2(v0, v1);
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] Changed %lld items when clearing the staged file ids%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_3_0();
}
...
- (void)clearStagedIDs:.cold.2()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to update the staged file ids: %@%@", v4, v5, v6, v7, v8);
...
- (void)clearStagedIDs:.cold.3()
{
  ...
  OUTLINED_FUNCTION_9_2(v0, v1);
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_0_0(&dword_1CBD43000, v2, v3, "[DEBUG] Changed %lld items when clearing the staged generation ids%@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_3_0();
}
...
- (void)fixUpBackupDetector:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Patched the backup detector%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)fixUpBackupDetector:.cold.2()
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_1_2(&dword_1CBD43000, v2, v3, "[ERROR] Failed to update the backup detector value: %@%@", v4, v5, v6, v7, v8);
...
- (void)fixUpClientState:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Fixed up the FSEvents root ID%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)fixUpClientState:.cold.2()
{
  ...
  v2 = *MEMORY[0x1E0C80C00];
  OUTLINED_FUNCTION_4_0();
  _os_log_fault_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_FAULT, "[CRIT] unable to flush client state, crash to maintain consistency%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
- (void)fixUpClientState:.cold.3()
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2_0();
  _os_log_fault_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_FAULT, "[CRIT] there should always be one row in client_state {%@}%@", v3, 0x16u);
