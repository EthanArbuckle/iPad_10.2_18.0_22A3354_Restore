...
- (void)saveToDB:(id)a3
{
  ...
  if (v5)
  {
    if ((objc_msgSend(v4, "execute:", CFSTR("UPDATE server_state SET state = %@"), v7) & 1) == 0)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("unable to update the server_state"));
      ...
      while (1)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = v27;
          ...
          v36 = 2112;
          v37 = v17;
          _os_log_debug_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] Ignoring share alias migration key for %@ because the user default is no%@", buf, 0x16u);
        }
        ...
        *v28 = v20;
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138413058;
          ...
          v40 = 2112;
          v41 = v23;
          _os_log_debug_impl(&dword_1CBD43000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] pending migration for %@: %@ from cursor:%@%@", buf, 0x2Au);
...
- (void)_hasStateChangesWithResultingState:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: data%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
- (void)saveToDB:(NSObject *)a3 .cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v9 = 2112;
  v10 = a2;
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, a3, v6, "[CRIT] %@%@", (uint8_t *)&v7);
...
- (void)initiateMigrationQueryForMangledIDs:(uint64_t)a1 key:.cold.1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = *(_QWORD *)(a1 + 8);
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] pending migrations: %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)migrationQueryKeyForMangledID:(uint64_t)a1 continuationCursor:.cold.1(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] no pending migration for %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)migrationQueryForMangledID:(uint64_t)a1 key:didUpdateWithCursor:.cold.1(uint64_t a1)
{
  ...
  v3 = a1;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_4_2(&dword_1CBD43000, v1, (uint64_t)v1, "[CRIT] UNREACHABLE: unknown migration completed for container %@%@", (uint8_t *)&v2);
  OUTLINED_FUNCTION_2();
}
