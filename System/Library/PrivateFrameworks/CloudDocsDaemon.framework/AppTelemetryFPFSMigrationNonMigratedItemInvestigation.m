...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x2000000) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_itemNumber);
...
LABEL_81:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_dataProtectionClass);
...
LABEL_82:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isOwnedByLoggedInUser);
...
LABEL_83:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isOwnedByRoot);
...
LABEL_84:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_xattrCount);
...
LABEL_85:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isAppleDouble);
...
LABEL_86:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isResourceFork);
  ...
  {
LABEL_10:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isQuarantined);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isBundleBit);
  ...
  if ((v10 & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isSparseFile);
...
LABEL_17:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_compressionType);
...
LABEL_90:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_readErrorCode);
...
LABEL_91:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_cloneErrorCode);
...
LABEL_92:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_syncRootEnum);
...
LABEL_93:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_pathLength);
...
LABEL_94:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_fileNameLength);
...
LABEL_95:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_stMode);
...
LABEL_96:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_stFlags);
...
LABEL_97:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_hasAcls);
...
LABEL_98:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_parentHasAcls);
...
LABEL_99:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isPurgable);
...
LABEL_100:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isUrgent);
...
LABEL_101:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isUnderDirStatFolder);
  ...
  {
LABEL_30:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isFileNameNonAscii);
...
LABEL_31:
  ...
  if ((v14 & 0x1000000) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_hasMoreLinks);
...
LABEL_35:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_fsGenCount);
...
LABEL_105:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbGenCount);
...
LABEL_106:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_hasLocalChanges);
  ...
  {
LABEL_38:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_doGenCountsMatchInFileId);
...
LABEL_39:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_pathDepth);
  ...
  if ((v18 & 0x200) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_xattrHasDemotion);
  ...
  if ((v18 & 0x400) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_xattrHasPromotion);
  ...
  if ((v22 & 0x100) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbErrorCode);
  ...
  if ((v22 & 0x40) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbCapabilities);
...
LABEL_53:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbTransferState);
...
LABEL_110:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbSharingState);
...
LABEL_111:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_dbIsApplibrary);
...
LABEL_112:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbEffectiveContentPolicy);
...
LABEL_113:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_dbIsPackage);
...
LABEL_114:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbFsContentStatus);
...
LABEL_115:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbFpContentStatus);
...
LABEL_116:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbFsDeletionStatus);
...
LABEL_117:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbFpDeletionStatus);
...
LABEL_118:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbFsImportStatus);
...
LABEL_119:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_dbFpImportStatus);
...
LABEL_120:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_dbIsSuper);
...
LABEL_121:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_gencountDiff);
...
LABEL_122:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_parentMatches);
...
LABEL_123:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_appLibraryMatches);
...
LABEL_124:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_mTimeBeforeMigrationStarted);
...
LABEL_125:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_docIDMatches);
...
LABEL_126:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_mTime);
...
LABEL_127:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_bTime);
...
LABEL_128:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_bTimeIsBusy);
  ...
  {
LABEL_73:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_xattrHasBeforeBounce);
...
LABEL_74:
  ...
  if ((v28 & 0x10) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_nameIsTrashed);
  ...
  {
LABEL_131:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_sysPageSize);
...
LABEL_132:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_sysUID);
...
LABEL_134:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_sysDocIDResolutionOK);
...
LABEL_158:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_purgeGenCount);
...
LABEL_159:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_purgeATime);
...
LABEL_160:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_purgeSyncRoot);
...
LABEL_161:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_diagFailuresBitmap);
...
LABEL_162:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_diagErrorCode);
  ...
  {
LABEL_140:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_diagUnderlyingErrorCode);
...
LABEL_141:
  ...
  if ((v83 & 1) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_apfsAvailableSpace);
...
LABEL_147:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_apfsFlags);
...
LABEL_166:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_apfsBlockSize);
...
LABEL_167:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_apfsRole);
...
LABEL_168:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_apfsEncrypted);
...
LABEL_169:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_statDocID);
...
LABEL_152:
    if ((v83 & 0x4000000000) == 0)
      goto LABEL_153;
LABEL_171:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_statPhysicalSize);
...
LABEL_170:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_statLogicalSize);
...
LABEL_153:
  ...
  {
LABEL_154:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", self->_statDirEntryCount);
