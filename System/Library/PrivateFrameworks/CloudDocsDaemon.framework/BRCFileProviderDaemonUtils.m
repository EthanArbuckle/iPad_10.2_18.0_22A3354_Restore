...
void __44__BRCFileProviderDaemonUtils_sharedInstance__block_invoke(uint64_t a1)
{
  ...
  v4 = objc_msgSend(objc_alloc(*(Class *)(a1 + 32)), "_initWithSyncBubble:isFPFS:", v3, 0);
...
- (void)interrupt
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    v5 = 138412290;
    v6 = v3;
    _os_log_impl(&dword_1CBD43000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] got interrupted%@", (uint8_t *)&v5, 0xCu);
  }
...
- (void)_signalFPReady
{
  ...
  if (!v2->_fpReady)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      v5 = 138412290;
      v6 = v3;
      _os_log_impl(&dword_1CBD43000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] FP is now ready to accept xpc connections%@", (uint8_t *)&v5, 0xCu);
    }
...
- (void)_waitIsOver
{
  ...
  {
    if (obj->_interrupted)
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithPOSIXCode:description:", 4, CFSTR("BRCFileProviderDaemonUtils was interrupted while waiting for FP to accept xpc connections"));
    else
      objc_msgSend(MEMORY[0x1E0CB35C8], "brc_unkownErrorWithDescription:", CFSTR("Waiting without success for FP to accept xpc connections"));
...
- (BOOL)waitForFPToBeReadyToAcceptXPCWithError:(id *)a3
{
  ...
  if (!self->_isFPFS && self->_inSyncBubble)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v53 = v22;
      _os_log_impl(&dword_1CBD43000, v23, OS_LOG_TYPE_DEFAULT, "[NOTICE] Device is in sync bubble%@", buf, 0xCu);
    }

    objc_msgSend(MEMORY[0x1E0CB35C8], "brc_errorCantCallFPInSyncBubble");
  ...
  if (!startedWaitingForFP)
  {
    ...
    else
    {
      ...
      v51[3] = &unk_1E875DF80;
      v51[4] = v4;
      objc_msgSend(MEMORY[0x1E0CAACA8], "beginMonitoringProviderDomainChangesWithHandler:", v51);
      ...
      objc_msgSend(MEMORY[0x1E0CAACA8], "endMonitoringProviderDomainChanges:", v28);
...
LABEL_26:
  ...
  dispatch_sync((dispatch_queue_t)v24->_fileProviderReadyQueue, &__block_literal_global_38);
  v38 = v24;
  objc_sync_enter(v38);
  if (v24->_fpReady)
  {
  ...
  else
  {
    ...
    if (v39)
    {
      ...
      if (os_log_type_enabled(v42, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 136315906;
        ...
        v58 = 2112;
        v59 = v41;
        _os_log_error_impl(&dword_1CBD43000, v42, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
      }
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: FP is not ready but we don't have an error"));
      ...
      if (v40)
      {
        ...
        if (os_log_type_enabled(v46, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 136315906;
          ...
          v58 = 2112;
          v59 = v45;
          _os_log_error_impl(&dword_1CBD43000, v46, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
        }
...
uint64_t __69__BRCFileProviderDaemonUtils_waitForFPToBeReadyToAcceptXPCWithError___block_invoke(uint64_t result, uint64_t a2, uint64_t a3)
{
  ...
  if (!a3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      v6 = 138412290;
      v7 = v4;
      _os_log_impl(&dword_1CBD43000, v5, OS_LOG_TYPE_DEFAULT, "[NOTICE] Got com.apple.fileprovider.providers-changed notification. FP is ready to accept XPC calls%@", (uint8_t *)&v6, 0xCu);
    }
    ...
    if (shouldBoostFileProvider)
    {
      ...
      if (v6)
      {
        ...
        *((_QWORD *)&buf + 1) = &buf;
        ...
        v15 = 0;
        objc_msgSend(MEMORY[0x1E0CAAC18], "synchronousSharedConnectionProxy");
      ...
      else
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_QWORD *)((char *)&buf + 4) = v7;
          _os_log_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Can't find Mobile Documents path for current persona%@", (uint8_t *)&buf, 0xCu);
        }
...
- (void)waitForFPToBeReadyToAcceptXPCWithError:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: FP is not ready but we don't have an error%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, a2, a3, "[DEBUG] FP is already ready to connect after boosting%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
...
{
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, a2, a3, "[DEBUG] Starting to wait for FP to be ready to accept xpc connections%@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_2();
}
