...
- (void)_validateThrottleParams:(NSObject *)a3 .cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v11 = 2112;
  v12 = a2;
  _os_log_debug_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] throttle dict %@ isn't for our platform %@%@", (uint8_t *)&v7, 0x20u);
...
- (void)_validateThrottleParams:.cold.2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Platforms %@ isn't an array%@");
}
...
- (void)_validateThrottleParams:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Throttle %@ isn't a dictionary%@");
}
