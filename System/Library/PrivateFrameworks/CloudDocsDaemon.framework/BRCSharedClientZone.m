...
void __52__BRCSharedClientZone_addAcceptOperation_forItemID___block_invoke(uint64_t a1)
{
  ...
  v2 = *(id *)(a1 + 32);
  objc_sync_enter(v2);
  objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 512), "objectForKeyedSubscript:", *(_QWORD *)(a1 + 40));
  v3 = (id)objc_claimAutoreleasedReturnValue();

  if (v3 == WeakRetained)
    objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 512), "setObject:forKeyedSubscript:", 0, *(_QWORD *)(a1 + 40));
  if (!objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 512), "count"))
  {
    v4 = *(_QWORD *)(a1 + 32);
    v5 = *(void **)(v4 + 512);
    *(_QWORD *)(v4 + 512) = 0;
      ...
      do
      {
        ...
        if ((objc_msgSend(v9, "isShareAcceptationFault", v17) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v17;
            v23 = v14;
            _os_log_fault_impl(&dword_1CBD43000, v15, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: item.isShareAcceptationFault%@", buf, 0xCu);
          }
...
- (void)setServerZone:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [serverZone isKindOfClass:[BRCSharedServerZone class]]%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)addAcceptOperation:(os_log_t)log forItemID:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_fault_impl(&dword_1CBD43000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: there is already a share acceptation running for that itemID; %@%@",
    (uint8_t *)&v3,
    0x16u);
}
