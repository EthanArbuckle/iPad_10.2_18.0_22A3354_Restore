...
- (BRCSharingCopyAccessTokenOperation)initWithItem:(id)a3 sessionContext:(id)a4
{
  ...
  if (v10)
  {
    ...
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95070]), "initShareIDWithShareableItem:", v6);
...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sharing/access-token", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
- (void)main
{
  ...
  v7 = *MEMORY[0x1E0C94B48];
  v10[0] = *MEMORY[0x1E0C949A0];
  v10[1] = v7;
...
void __42__BRCSharingCopyAccessTokenOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0C949A0]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v5)
  {
    if (v11)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: encrypted access token %@ is of unexpected type"), v11);
        goto LABEL_23;
      }
    }
  }
  if (!v5 && v13)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: reference identifier %@ is of unexpected type"), v13);
LABEL_23:
    v5 = (id)objc_claimAutoreleasedReturnValue();
    v15 = 0;
    if (v5)
...
void __42__BRCSharingCopyAccessTokenOperation_main__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: reference identifier %@ is of unexpected type%@");
}
...
void __42__BRCSharingCopyAccessTokenOperation_main__block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: encrypted access token %@ is of unexpected type%@");
}
