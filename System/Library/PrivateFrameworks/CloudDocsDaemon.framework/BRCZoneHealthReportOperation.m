...
- (void)_reportRecords:(id)a3 requestID:(unint64_t)a4
{
  ...
  v6 = a3;
  v21 = (void *)a4;
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94F10]), "initWithRecordsToSave:recordIDsToDelete:", v6, 0);
  objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", &v21, 8);
  ...
  if (objc_msgSend(v9, "brc_isCloudKitErrorImplyingZoneNeedsCreation"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_QWORD *)&location[4] = WeakRetained;
      ...
      v25 = 2112;
      v26 = v11;
      _os_log_debug_impl(&dword_1CBD43000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] We need to create the zone health zone on %@ - %@%@", location, 0x20u);
    }
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
      {
        ...
        *(_QWORD *)&location[4] = WeakRetained;
        ...
        v25 = 2112;
        v26 = v17;
        _os_log_error_impl(&dword_1CBD43000, v18, (os_log_type_t)0x90u, "[ERROR] Failed reporting zone health on %@ - %@%@", location, 0x20u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_QWORD *)&location[4] = v7;
        ...
        v25 = 2112;
        v26 = v17;
        _os_log_debug_impl(&dword_1CBD43000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] finished reporting zone health: %@, op: %@%@", location, 0x20u);
      }
    }
...
- (void)main
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_debug_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] No zone health errors to report%@", (uint8_t *)&v2, 0xCu);
}
...
uint64_t __36__BRCZoneHealthReportOperation_main__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (objc_msgSend(v4, "needsSyncUp"))
  {
    ...
    v48 = (void *)v11;
    v50 = (void *)v6;
    v15 = objc_msgSend(objc_alloc(MEMORY[0x1E0C95070]), "initWithRecordName:zoneID:", v11, v6);
    v47 = (void *)v14;
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95048]), "initWithRecordType:recordID:", CFSTR("zoneState"), v14);
    v46 = (void *)v15;
    v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95048]), "initWithRecordType:recordID:", CFSTR("zoneDetails"), v15);
    ...
    if ((int)v14 <= (int)v9)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v61 = v19;
        _os_log_impl(&dword_1CBD43000, v20, OS_LOG_TYPE_DEFAULT, "[WARNING] not updating zone health state because we think we are less broken than the server does%@", buf, 0xCu);
      }
    ...
    objc_msgSend(v16, "setObject:forKeyedSubscript:", &stru_1E8769030, CFSTR("clientInfo"));
    ...
    v26 = objc_alloc(MEMORY[0x1E0C95098]);
    v53 = v3;
    objc_msgSend(v3, "serverZone");
    v27 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v27, "zoneName");
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    v29 = (void *)objc_msgSend(v26, "initWithZoneName:ownerName:", v28, *MEMORY[0x1E0C94730]);
    ...
    if (v32)
    {
      ...
      do
      {
        for (i = 0; i != v33; ++i)
        {
          ...
          v36 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95070]), "initWithRecordName:zoneID:", *(_QWORD *)(*((_QWORD *)&v54 + 1) + 8 * i), v29);
          v37 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C950C0]), "initWithRecordID:action:", v36, 0);
...
void __36__BRCZoneHealthReportOperation_main__block_invoke_2_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: report.state != BRCZoneHealthStateHealthy%@", (uint8_t *)&v2, 0xCu);
}
