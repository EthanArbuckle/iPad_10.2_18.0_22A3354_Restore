...
- (id)descriptionForItem:(id)a3 context:(id)a4
{
  ...
  -[BRCFSSchedulerBase descriptionForJobsMatching:ordering:additionalColumns:additionalValuesHandler:context:](&v12, sel_descriptionForJobsMatching_ordering_additionalColumns_additionalValuesHandler_context_, v8, 0, v9, &__block_literal_global_41, v7);
...
- (void)createSyncUpJobForItem:(id)a3 inZone:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  if ((objc_msgSend(v7, "br_isEqualToNumber:", &unk_1E87D7430) & 1) == 0)
  {
    -[BRCAccountSession serverZoneByRowID:](self->super._session, "serverZoneByRowID:", v7);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)createSyncUpJobForRowID:(unint64_t)a3 inZone:(id)a4
{
  ...
  -[BRCAccountSession syncContextProvider](self->super._session, "syncContextProvider");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "defaultSyncContext");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "uploadThrottle");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0DE81D0], "formatInjection:", CFSTR("in_flight_diffs = NULL"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)finishSyncUpForItem:(id)a3 inZone:(id)a4 success:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v39 = 2112;
    v40 = v12;
    _os_log_debug_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@[%@]: finishing sync up%@", buf, 0x2Au);
...
- (void)_scheduleSyncUpJobForZoneWithRowID:(id)a3
{
  ...
  v8 = a3;
  v4 = objc_msgSend(v8, "br_isEqualToNumber:", &unk_1E87D7430);
  session = self->super._session;
  if (v4)
  {
  ...
  {
    -[BRCAccountSession serverZoneByRowID:](session, "serverZoneByRowID:", v8);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)recoverAndReportMissingJobs
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      for (i = 0; i != v7; ++i)
      {
        ...
        {
          -[BRCSyncUpScheduler createSyncUpJobForItem:inZone:](self, "createSyncUpJobForItem:inZone:", v11, &unk_1E87D7430);
        }
  ...
  -[BRCAccountSession clientDB](self->super._session, "clientDB", v25, v26);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)postponeSyncUpCallback:(id)a3 inZone:(id)a4
{
  ...
  if (v10 <= 0)
  {
    -[BRCAccountSession syncContextProvider](session, "syncContextProvider");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)createSyncUpJobForItem:inZone:.cold.1()
{
  ...
  _os_log_debug_impl(&dword_1CBD43000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Clearing app sync blocked bit because we created an item that needs sync%@", v1, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
- (void)_scheduleSyncUpJob:.cold.1()
{
  ...
  v3 = 2112;
  v4 = v0;
  _os_log_debug_impl(&dword_1CBD43000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] Sync-Up[%@]: Scheduling a sync-up job%@", v2, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
- (void)recoverAndReportMissingJobs
{
  ...
  v4 = 2112;
  v5 = a1;
  _os_log_debug_impl(&dword_1CBD43000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Sync-Up: Recovered from %u missing sync up jobs%@", (uint8_t *)v3, 0x12u);
  OUTLINED_FUNCTION_2();
}
