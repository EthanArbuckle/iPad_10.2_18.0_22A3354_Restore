...
- (BRCFileUnlinker)initWithCacheDirPath:(id)a3
{
  ...
  if (v5)
  {
    ...
    v13 = dispatch_source_create(MEMORY[0x1E0C80D78], 0, 0, (dispatch_queue_t)v6->_queue);
...
- (void)resume
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: suspendCount >= 0%@", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_2();
}
...
- (void)suspend
{
  ...
  v6 = 2112;
  v7 = a2;
  _os_log_debug_impl(&dword_1CBD43000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] suspending - suspendCount:%d->%d%@", (uint8_t *)v3, 0x18u);
  OUTLINED_FUNCTION_2();
}
...
- (void)_purge
{
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_debug_impl(&dword_1CBD43000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] removed '%@/*'%@", (uint8_t *)&v3, 0x16u);
  OUTLINED_FUNCTION_2();
}
...
- (BOOL)renameAndUnlinkInBackgroundItemAt:(int)a3 path:(id)a4
{
  ...
  if ((fstatat(a3, (const char *)objc_msgSend(v6, "fileSystemRepresentation"), &v46, 32) & 0x80000000) == 0)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3A28], "UUID", *(_QWORD *)&v46.st_dev);
    ...
    if ((BRCRenameAt(a3, v6, -1, v11, 0) & 0x80000000) == 0)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)&v76[40] = v46.st_flags;
        v77 = 2112;
        *(_QWORD *)v78 = v12;
        _os_log_debug_impl(&dword_1CBD43000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] renamed '%@' to '%@' deviceID:%u fileID:%llu mode:%c%c%c%c%c%c%c%c%c%c nlink:%u uid:%u gid:%u atime:%lu mtime:%lu ctime:%lu size:%llu flags:0x%x%@", buf, 0xACu);
      }
    ...
    if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)&v78[6] = v22;
      v79 = 2112;
      v80 = v23;
      _os_log_error_impl(&dword_1CBD43000, v24, (os_log_type_t)0x90u, "[ERROR] renameat(%d, '%@', -1, '%@' deviceID:%u fileID:%llu mode:%c%c%c%c%c%c%c%c%c%c nlink:%u uid:%u gid:%u atime:%lu mtime:%lu ctime:%lu size:%llu flags:0x%x failed %{errno}d%@", buf, 0xB8u);
    }
...
LABEL_18:
  ...
  if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
  {
    ...
    *(_WORD *)&v48[14] = 2112;
    *(_QWORD *)&v48[16] = v20;
    _os_log_error_impl(&dword_1CBD43000, v21, (os_log_type_t)0x90u, "[ERROR] lstat('%@') failed %{errno}d%@", buf, 0x1Cu);
  }
...
- (void)renameAndUnlinkInBackgroundItemAt:(NSObject *)a3 path:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  v12 = 2112;
  v13 = a2;
  _os_log_debug_impl(&dword_1CBD43000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] failed removing documentID for %@ (%s)%@", (uint8_t *)&v8, 0x20u);
}
