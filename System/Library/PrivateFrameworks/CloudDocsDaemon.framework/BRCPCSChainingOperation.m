...
- (id)createActivity
{
  return _os_activity_create(&dword_1CBD43000, "sync/pcs-chain", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
...
LABEL_5:
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "br_errorWithDomain:code:description:", *MEMORY[0x1E0D10C90], 15, CFSTR("unreachable: Can't PCS chain to documents, trash, or root"));
...
- (void)_sendRecordBatch:(id)a3 recursed:(BOOL)a4 completion:(id)a5
{
  ...
  if (objc_msgSend(v8, "count"))
  {
    ...
    v30 = 0;
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94F10]), "initWithRecordsToSave:recordIDsToDelete:", v9, 0);
          ...
          if (v24)
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              v63 = 2112;
              v64 = v31;
              _os_log_impl(&dword_1CBD43000, v32, OS_LOG_TYPE_DEFAULT, "[WARNING] Got an error indicating we need to reparent %@ to %@%@", buf, 0x20u);
            }
  ...
  if (v6 && (objc_msgSend(v6, "brc_isCloudKitAtomicFailure") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v63 = 2112;
      v64 = v16;
      _os_log_impl(&dword_1CBD43000, v29, OS_LOG_TYPE_DEFAULT, "[WARNING] Encountered pcs chaining error %@ for record %@%@", buf, 0x20u);
...
void __64__BRCPCSChainingOperation__sendRecordBatch_recursed_completion___block_invoke_169(_QWORD *a1)
{
  ...
  if ((objc_msgSend(v4, "localDiffs") & 0x20) != 0 && objc_msgSend(v4, "needsSyncUp"))
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_error_impl(&dword_1CBD43000, v6, (os_log_type_t)0x90u, "[ERROR] Blocking %@ from sync up until it is next modified because the server failed to pcs chain %@ with a permanent error%@", (uint8_t *)&v11, 0x20u);
    }
...
uint64_t __64__BRCPCSChainingOperation__sendRecordBatch_recursed_completion___block_invoke_171(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 2112;
    v12 = v5;
    _os_log_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] Retrying with new record batch because we were told about a new parent - %@%@", (uint8_t *)&v9, 0x16u);
  }
...
void __40__BRCPCSChainingOperation__chainRecords__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v9[520]);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
...
void __40__BRCPCSChainingOperation__chainRecords__block_invoke_175(uint64_t a1, void *a2, void *a3)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v17[520]);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        for (i = 0; i != v3; ++i)
        {
          ...
          if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            v67 = 2112;
            v68 = v8;
            _os_log_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Learning etag in the server truth for half chained parent %@%@", buf, 0x16u);
          ...
          if (!v19)
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412290;
              v66 = v20;
              _os_log_impl(&dword_1CBD43000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] Uh oh... the record changed server side while we were mid pcs chain batch.  We might have oplock conflicts%@", buf, 0xCu);
            }
              ...
              !v36))
        {
          ...
          if (!v46)
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              v66 = v47;
              _os_log_fault_impl(&dword_1CBD43000, v48, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: record.parent%@", buf, 0xCu);
            }
        ...
        else
        {
          ...
          if (v39)
          {
            ...
            if (os_log_type_enabled(v50, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              v66 = v49;
              _os_log_fault_impl(&dword_1CBD43000, v50, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: !record.parent%@", buf, 0xCu);
            }
...
uint64_t __40__BRCPCSChainingOperation__chainRecords__block_invoke_182(uint64_t a1)
{
  ...
  {
    v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", objc_msgSend(*(id *)(a1 + 48), "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
  ...
  if (self->_canSyncDownBeforeRetry && self->_syncDownBeforeRetry)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CBD43000, v4, OS_LOG_TYPE_DEFAULT, "[WARNING] Syncing down before retrying %@%@", buf, 0x16u);
    }
...
void __31__BRCPCSChainingOperation_main__block_invoke_3(uint64_t a1)
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v13 = 2112;
      v14 = v8;
      _os_log_debug_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Refreshed root item from db %@%@", (uint8_t *)&v11, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      v11 = 138412290;
      v12 = v8;
      _os_log_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't refresh item from the database%@", (uint8_t *)&v11, 0xCu);
    }
  }
...
- (void)initWithRootItem:appLibrary:sessionContext:syncUpCallback:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: rootItem%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_buildRecordListWithCompletion:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Can't PCS chain to documents, trash, or root%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __58__BRCPCSChainingOperation__buildRecordListWithCompletion___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] %@ is already chained%@");
  OUTLINED_FUNCTION_2();
}
...
void __58__BRCPCSChainingOperation__buildRecordListWithCompletion___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: listOp%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __58__BRCPCSChainingOperation__buildRecordListWithCompletion___block_invoke_cold_3()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: si%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __64__BRCPCSChainingOperation__sendRecordBatch_recursed_completion___block_invoke_168_cold_1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: [newParent hasPrefix:kBRRecordIDPrefixDirectoryStructure]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __40__BRCPCSChainingOperation__chainRecords__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Failed iterating PCS - %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __40__BRCPCSChainingOperation__chainRecords__block_invoke_174_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] failed sending first PCS step - %@%@");
  OUTLINED_FUNCTION_2();
}
...
void __40__BRCPCSChainingOperation__chainRecords__block_invoke_175_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] Failed sending second PCS step - %@%@");
  OUTLINED_FUNCTION_2();
}
