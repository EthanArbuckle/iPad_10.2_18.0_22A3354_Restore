  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      v14 = 2112;
      v15 = v6;
      _os_log_error_impl(&dword_1CBD43000, v7, (os_log_type_t)0x90u, "[ERROR] failed saving sharing options update %@: %@%@", buf, 0x20u);
  ...
  if (-[BRCPQLConnection changes](self->super._db, "changes"))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218242;
      ...
      v30 = 2112;
      v31 = v8;
      _os_log_impl(&dword_1CBD43000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Forced %lld orphans to be tombstones in the shared zone%@", buf, 0x16u);
    }
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 134218498;
            ...
            v32 = 2112;
            v33 = v20;
            _os_log_debug_impl(&dword_1CBD43000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] propagated delete of %lld recursive children of %@%@", buf, 0x20u);
          }
...
- (void)_propagateFolderDeletesToTheirChildren
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_fault_impl(&dword_1CBD43000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Path depth overflow%@", (uint8_t *)&v2, 0xCu);
}
