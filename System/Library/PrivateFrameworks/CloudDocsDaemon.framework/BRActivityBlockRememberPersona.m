...
void ___BRActivityBlockRememberPersona_block_invoke(uint64_t a1, void *a2)
{
    ...
    || (v5 = *(id *)(a1 + 32)) == 0)
  {
    if (_block_invoke_2___personaOnceToken != -1)
      dispatch_once(&_block_invoke_2___personaOnceToken, &__block_literal_global_191);
...
void ___BRActivityBlockRememberPersona_block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] Failed to defer the activity after persona failure.%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void ___BRActivityBlockRememberPersona_block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: Can't adopt persona for xpc activity, deferring the activity%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
