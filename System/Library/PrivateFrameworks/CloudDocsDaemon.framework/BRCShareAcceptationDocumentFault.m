...
- (void)markLiveFromStageAsShareAcceptationFault
{
  ...
  -[BRCLocalStatInfo _markLiveFromStageAsType:](self->super.super._st, "_markLiveFromStageAsType:", 8);
}
...
- (void)stageShareAcceptationFaultWithName:(id)a3
{
  ...
  -[BRCDocumentItem stageFaultForCreation:name:size:isPackage:](self, "stageFaultForCreation:name:size:isPackage:", 1, v6, v7, 1);
...
- (void)deleteShareAcceptationFault
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_1(&dword_1CBD43000, v0, v1, "[CRIT] UNREACHABLE: only share acceptation fault can be deleted; %@%@");
  OUTLINED_FUNCTION_2();
}

- (void)markNeedsTransformIntoNormalFault
{
  -[BRCStatInfo setType:](self->super.super._st, "setType:", 2);
}
