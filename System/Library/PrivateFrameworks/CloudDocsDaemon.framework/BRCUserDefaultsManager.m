...
void __60__BRCUserDefaultsManager__loadServerConfigurationDictionary__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    objc_msgSend(MEMORY[0x1E0C92CA0], "backgroundSessionConfigurationWithIdentifier:", CFSTR("fetch-configuration"));
    ...
    objc_msgSend(MEMORY[0x1E0C92C98], "sessionWithConfiguration:delegate:delegateQueue:", v5, *(_QWORD *)(a1 + 32), *(_QWORD *)(*(_QWORD *)(a1 + 32) + 40));
...
- (void)_prepopulateGlobalUserDefaults
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: !_userDefaultsCache[kBRCGlobalUserDefaultsKey]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_setServerConfigurationURL:(id)a3 whenLoaded:(id)a4
{
  ...
  {
    ((void (*)(_QWORD *))*MEMORY[0x1E0D11060])(v20);
    v22 = objc_claimAutoreleasedReturnValue();
  ...
  if (xpc_activity_should_defer(v3))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v5;
      _os_log_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to defer the state%@", (uint8_t *)&buf, 0xCu);
    }
    ...
    if (!xpc_activity_set_state(v3, 5))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)v13 = 138412290;
        v14 = v10;
        _os_log_impl(&dword_1CBD43000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to set the xpc state to done%@", v13, 0xCu);
      }
...
- (void)URLSession:(id)a3 downloadTask:(id)a4 didFinishDownloadingToURL:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    v33 = 2112;
    v34 = v11;
    _os_log_debug_impl(&dword_1CBD43000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx config: download task finished %@, plist %@%@", buf, 0x2Au);
  }
...
- (void)URLSession:(id)a3 didBecomeInvalidWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_error_impl(&dword_1CBD43000, v8, (os_log_type_t)0x90u, "[ERROR] config: session %@ become invalid: %@%@", (uint8_t *)&v9, 0x20u);
  }
  ...
  if (v7)
  {
    ...
    if (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0CB32E8]))
    {
      ...
      if (objc_msgSend(v9, "isEqual:", v15))
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR(" (URL %@)"), v9, v18);
      else
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR(" (original URL: %@, current URL %@)"), v9, v15);
...
LABEL_14:
    ...
    if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      v25 = 2112;
      v26 = v11;
      _os_log_error_impl(&dword_1CBD43000, v16, (os_log_type_t)0x90u, "[ERROR] config: can't download task %@%@: %@%@", buf, 0x2Au);
    }
...
- (void)loadCachedServerConfiguration
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] Loaded cached server configuration %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
LABEL_5:
  ...
  if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    v28 = 2112;
    v29 = v19;
    _os_log_error_impl(&dword_1CBD43000, v20, (os_log_type_t)0x90u, "[ERROR] failed parsing plist at %@: %@%@", buf, 0x20u);
  }
...
- (void)_loadServerConfigurationDictionary
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    v17 = 2112;
    v18 = v3;
    _os_log_debug_impl(&dword_1CBD43000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx config: asynchronously loading %@%@", buf, 0x20u);
  }
  ...
  if (-[NSURL isFileURL](self->_serverConfigurationURL, "isFileURL"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v14 = (uint64_t)v5;
      _os_log_impl(&dword_1CBD43000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] loading iCloud Drive configuration from disk%@", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v14 = (uint64_t)v7;
      _os_log_impl(&dword_1CBD43000, v8, OS_LOG_TYPE_DEFAULT, "[NOTICE] downloading iCloud Drive configuration%@", buf, 0xCu);
    }
...
void __44__BRCUserDefaultsManager_initWithPersonaID___block_invoke_cold_1()
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] ┏%llx defaults changed%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)defaultsForIdentifier:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: clientZoneIdentifier && _userDefaultsCache[kBRCGlobalUserDefaultsKey]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)defaultsForIdentifier:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, v0, v1, "[CRIT] Assertion failed: ![clientZoneIdentifier isEqualToString:kBRCGlobalUserDefaultsKey]%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
- (void)_setServerConfigurationURL:whenLoaded:.cold.1()
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] ┏%llx config: initial load%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)_setServerConfigurationURL:whenLoaded:.cold.2()
{
  ...
  OUTLINED_FUNCTION_4_0();
  OUTLINED_FUNCTION_3_1(&dword_1CBD43000, v0, v1, "[DEBUG] config: not updating the configuration, waiting for next activity callback%@", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_2();
}
...
void __64__BRCUserDefaultsManager__setServerConfigurationURL_whenLoaded___block_invoke_cold_1()
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] ┏%llx config: it's activity time%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)URLSession:downloadTask:didFinishDownloadingToURL:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_4_1(&dword_1CBD43000, v0, v1, "[ERROR] config: failed to move downloaded cache file into place %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)URLSession:task:didCompleteWithError:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] config: download finished for %@%@");
  OUTLINED_FUNCTION_2();
}
...
- (void)_parsePlistWithURL:.cold.1()
{
  ...
  *(_QWORD *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v1, v2, "[DEBUG] config: Loaded server configuration from %@%@", (_QWORD)v3, DWORD2(v3));
  OUTLINED_FUNCTION_2();
}
...
- (void)_parsePlistWithURL:(uint8_t *)buf .cold.2(void *a1, uint64_t a2, uint8_t *buf, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(_QWORD *)(buf + 14) = a2;
  _os_log_debug_impl(&dword_1CBD43000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Server configuration changed to etag %@%@", buf, 0x16u);
...
void __60__BRCUserDefaultsManager__loadServerConfigurationDictionary__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1CBD43000, v0, v1, "[DEBUG] scheduling config download %@%@");
  OUTLINED_FUNCTION_2();
}
