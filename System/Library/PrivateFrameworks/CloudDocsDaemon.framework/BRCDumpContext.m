...
+ (id)stringFromThrottleState:(int)a3 context:(id)a4
{
  ...
  v5 = a4;
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", BRCPrettyPrintEnum());
...
+ (id)stringFromInterval:(double)a3 context:(id)a4
{
  ...
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%llu.%llu%@"), v6, (v7 + 5) / 0xA, v8);
}
...
+ (id)stringFromCount:(int64_t)a3 showActualCount:(BOOL)a4 suffix:(id)a5 isByteCount:(BOOL)a6 context:(id)a7
{
  ...
  if (v13 <= 0x3E7)
  {
    ...
    if (v8)
      v15 = CFSTR("bytes");
    objc_msgSend(MEMORY[0x1E0CB37A0], "stringWithFormat:", v14, v13, v15);
  ...
  if (v13 > 0xF423F)
  {
    if (v13 >= 0x3B9ACA00)
    {
      ...
      if (v13 > 0x2540BE3FFLL)
      {
        ...
        if (!v8)
          v26 = CFSTR("billions");
        objc_msgSend(MEMORY[0x1E0CB37A0], "stringWithFormat:", v25, v13 / 0x3B9ACA00, v26);
        goto LABEL_37;
      }
      if (a3 >= 0)
        v21 = CFSTR("%.2f %@");
  ...
  else
  {
    ...
    if (v8)
      v19 = CFSTR("KB");
    objc_msgSend(MEMORY[0x1E0CB37A0], "stringWithFormat:", v17, v18, v19);
  }
LABEL_37:
...
- (BRCDumpContext)initWithFile:(__sFILE *)a3 db:(id)a4
{
  ...
  if (v8)
  {
    ...
    v13 = objc_msgSend(objc_alloc(MEMORY[0x1E0D10E38]), "initWithFile:forceColor:", a3, 0);
    dumper = v9->_dumper;
...
- (void)writeLineWithFormat:(id)a3
{
  ...
  v18 = &v21;
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:arguments:", v4, &v21);
  v16 = 0u;
  v17 = 0u;
  v14 = 0u;
  v15 = 0u;
...
- (id)highlightedString:(id)a3 type:(int64_t)a4
{
  ...
  {
    v9 = dword_1CC066E4C[v8];
    v10 = dword_1CC066E68[v8];
  }
...
- (void)popIndentation
{
  OUTLINED_FUNCTION_0_2(&dword_1CBD43000, a2, a3, "[CRIT] Assertion failed: _indentation > 0%@", a5, a6, a7, a8, 2u);
}
