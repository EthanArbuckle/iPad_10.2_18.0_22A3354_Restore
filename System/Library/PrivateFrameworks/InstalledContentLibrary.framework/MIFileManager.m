...
- (id)createTemporaryDirectoryInDirectoryURL:(id)a3 error:(id *)a4
{
  ...
  if (mkdtemp(v6))
  {
    objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", v6, 1, 0);
...
LABEL_20:
  v27 = *__error();
  _CreateAndLogError((uint64_t)"-[MIFileManager _bulkSetPropertiesForPath:existingFD:UID:GID:mode:flags:dataProtectionClass:removeACL:error:]", 651, (void *)*MEMORY[0x1E0CB2FE0], v27, 0, 0, CFSTR("setattrlist failed for file %s"), v28, (uint64_t)v34);
LABEL_21:
...
LABEL_41:
  objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", v13, 0, 0, v44, v46, v47, v48);
  v36 = (void *)objc_claimAutoreleasedReturnValue();
  v55 = 0;
    ...
    switch(v27)
    {
      case 1:
        if (copyfile(*(const char **)(a2 + 16), *(const char **)(a1 + 80), 0, 0xC0008u))
        {
          ...
          _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 992, CFSTR("MIInstallerErrorDomain"), 4, v61, &unk_1E6CD44F0, CFSTR("Failed to copyfile %s to %s"), v68, *(_QWORD *)(a2 + 16));
          goto LABEL_43;
        }
        break;
      case 3:
        if (link(*(const char **)(a2 + 16), *(const char **)(a1 + 80)))
        {
          ...
          v61 = (void *)objc_claimAutoreleasedReturnValue();
          _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1002, CFSTR("MIInstallerErrorDomain"), 4, v61, &unk_1E6CD4518, CFSTR("Failed to link %s to %s"), v74, *(_QWORD *)(a2 + 16));
          goto LABEL_43;
        }
        break;
      case 2:
        ...
        if (clonefile(*(const char **)(a2 + 16), *(const char **)(a1 + 80), 3u))
        {
          ...
          if ((_DWORD)v30 != 18)
          {
            ...
            _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 981, CFSTR("MIInstallerErrorDomain"), 4, v25, &unk_1E6CD44C8, CFSTR("Failed to clonefile %s to %s"), v96, *v28);
            goto LABEL_35;
          }
          ...
          if (copyfile((const char *)*v28, *(const char **)(a1 + 80), 0, 0xC0008u))
          {
            ...
            v25 = (void *)objc_claimAutoreleasedReturnValue();
            _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 977, CFSTR("MIInstallerErrorDomain"), 4, v25, &unk_1E6CD44A0, CFSTR("Failed to copyfile %s to %s"), v42, *v28);
            goto LABEL_35;
          }
        }
        break;
    ...
    *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 72) + 8) + 24) = 1;
    ...
    if (v43 != -1)
    {
      ...
      if (symlink(v99, *(const char **)(a1 + 80)))
      {
        ...
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1032, CFSTR("MIInstallerErrorDomain"), 4, v25, &unk_1E6CD4568, CFSTR("Failed to symlink %s -> %s"), v49, *(_QWORD *)(a1 + 80));
        goto LABEL_35;
      }
      goto LABEL_47;
    }
    v56 = *__error();
    v57 = (void *)*MEMORY[0x1E0CB2FE0];
    v58 = v56;
    v59 = *(_QWORD *)(a2 + 16);
    strerror(v56);
    ...
    v61 = (void *)objc_claimAutoreleasedReturnValue();
    _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1022, CFSTR("MIInstallerErrorDomain"), 4, v61, &unk_1E6CD4540, CFSTR("Failed to readlink %s"), v62, *(_QWORD *)(a2 + 16));
LABEL_43:
  ...
  if (v18 != 2)
  {
    _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1038, CFSTR("MIInstallerErrorDomain"), 3, 0, &unk_1E6CD4590, CFSTR("Unknown filesystem object type %u encountered at %s"), a8, *(unsigned int *)(a2 + 56));
LABEL_37:
  ...
  if (mkdir(*(const char **)(a1 + 80), 0x1EDu))
  {
    ...
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 951, CFSTR("MIInstallerErrorDomain"), 4, v25, &unk_1E6CD4478, CFSTR("Failed to mkdir %s"), v26, *(_QWORD *)(a1 + 80));
LABEL_35:
...
uint64_t __59__MIFileManager_validateSymlinksInURLDoNotEscapeURL_error___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (*(_DWORD *)(a2 + 56) != 5)
    return 1;
  objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", *(_QWORD *)(a2 + 16), 0, 0);
  ...
  if (!v5)
  {
    _CreateAndLogError((uint64_t)"-[MIFileManager validateSymlinksInURLDoNotEscapeURL:error:]_block_invoke", 1161, CFSTR("MIInstallerErrorDomain"), 70, 0, &unk_1E6CD45B8, CFSTR("invalid symlink at %s"), v7, *(_QWORD *)(a2 + 16));
...
uint64_t __80__MIFileManager_enumerateURLsForItemsInDirectoryAtURL_ignoreSymlinks_withBlock___block_invoke(uint64_t a1, uint64_t a2, _BYTE *a3)
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", *(_QWORD *)(a2 + 16), v4 == 2, 0);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    *a3 = 0;
...
uint64_t __50__MIFileManager_traverseDirectoryAtURL_withBlock___block_invoke(uint64_t a1, uint64_t a2, char *a3)
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", *(_QWORD *)(a2 + 16), *(_DWORD *)(a2 + 56) == 2, 0);
...
LABEL_12:
  ...
  if ((v18.st_mode & 0xF000) != v8)
  {
    if (a6)
    {
      _CreateError((uint64_t)"-[MIFileManager _itemIsType:withDescription:atURL:error:]", 1393, (void *)*MEMORY[0x1E0CB2FE0], 22, 0, 0, CFSTR("%s is not a %@ (mode 0%ho)"), v11, (uint64_t)v10);
      goto LABEL_12;
    }
LABEL_13:
    v16 = 0;
...
- (int)deviceForURLOrFirstAvailableParent:(id)a3 error:(id *)a4
{
  ...
  if (lstat(v6, &v17))
  {
    ...
    if (v9 == 2)
    {
      ...
      _CreateError((uint64_t)"-[MIFileManager deviceForURLOrFirstAvailableParent:error:]", 1460, (void *)*MEMORY[0x1E0CB2FE0], 2, 0, 0, CFSTR("lstat for path \"/\" failed, which should never happen!"), v10, v16);
    }
    else
    {
LABEL_6:
      _CreateError((uint64_t)"-[MIFileManager deviceForURLOrFirstAvailableParent:error:]", 1467, (void *)*MEMORY[0x1E0CB2FE0], v9, 0, 0, CFSTR("lstat failed for %s"), v8, (uint64_t)v6);
    }
  }
  else
  {
LABEL_7:
    ...
    _CreateError((uint64_t)"-[MIFileManager deviceForURLOrFirstAvailableParent:error:]", 1452, (void *)*MEMORY[0x1E0CB2FE0], 22, 0, 0, CFSTR("lstat succeeded but st_dev was -1 for %s"), v7, (uint64_t)v6);
  }
...
- (id)upToFirstFourBytesFromURL:(id)a3 error:(id *)a4
{
  ...
  v11 = 0;
  objc_msgSend(MEMORY[0x1E0CB3608], "fileHandleForReadingFromURL:error:", a3, &v11);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v11;
  if (v5)
  {
    ...
    while (1)
    {
      ...
      if (v35)
      {
        ...
        if (!v21)
        {
          ...
          objc_msgSend(&unk_1E6CD4820, "objectAtIndexedSubscript:", v14);
          v23 = (void *)objc_claimAutoreleasedReturnValue();
          v47 = v23;
...
- (id)realPathForURL:(id)a3 allowNonExistentPathComponents:(BOOL)a4 isDirectory:(BOOL)a5 error:(id *)a6
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", v22, v7, 0);
    ...
    if (v10)
    {
      ...
      while (2)
      {
        for (i = 0; i != v11; ++i)
        {
          ...
          else if ((objc_msgSend(v15, "isEqualToString:", &stru_1E6CC0B98) & 1) == 0
...
LABEL_37:
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFileSystemRepresentation:length:", v75, v26);
...
- (BOOL)markBundleAsPlaceholder:(id)a3 withError:(id *)a4
{
  ...
  if (v6)
  {
    v7 = __error();
    v8 = *v7;
    _CreateError((uint64_t)"-[MIFileManager markBundleAsPlaceholder:withError:]", 2101, (void *)*MEMORY[0x1E0CB2FE0], *v7, 0, 0, CFSTR("setxattr for %s on %s failed"), v9, (uint64_t)"com.apple.installd.placeholder");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    strerror(v8);
...
- (BOOL)clearPlaceholderStatusForBundle:(id)a3 withError:(id *)a4
{
  ...
  {
    v7 = __error();
    _CreateError((uint64_t)"-[MIFileManager clearPlaceholderStatusForBundle:withError:]", 2125, (void *)*MEMORY[0x1E0CB2FE0], *v7, 0, 0, CFSTR("removexattr on %s for %s failed"), v8, (uint64_t)v5);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)_markEAFlag:(const char *)a3 forAppIdentifier:(id)a4 insecurelyCachedOnBundle:(id)a5 error:(id *)a6
{
  ...
  if (v12 < 0)
  {
    v23 = __error();
    v24 = *v23;
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB2FE0], *v23, 0);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_10:
  ...
  if (fsetxattr(v12, a3, &value, 4uLL, 0, 0))
  {
    v14 = __error();
    v15 = *v14;
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB2FE0], *v14, 0);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(objc_retainAutorelease(v11), "fileSystemRepresentation");
    strerror(v15);
...
LABEL_6:
  ...
  if (fsetxattr(v13, "com.apple.installd.appIdentifier", v28, v29, 0, 0))
  {
    v30 = __error();
    v31 = *v30;
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB2FE0], *v30, 0);
    v32 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_13:
    ...
    if (v21)
    {
      v30 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithData:encoding:", v21, 4);
      if (v30)
      {
        v22 = (void *)v30;
        goto LABEL_14;
...
LABEL_14:
  ...
  v16 = __error();
  v17 = *v16;
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB2FE0], *v16, 0);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)setInstallType:(id)a3 inExtendedAttributeOnBundle:(id)a4 error:(id *)a5
{
  ...
  if (v9)
  {
    v10 = __error();
    v11 = *v10;
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB2FE0], *v10, 0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)installTypeFromExtendedAttributeOnBundle:(id)a3 error:(id *)a4
{
  ...
  if (v6 < 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB2FE0], v9, 0);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_9:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", value);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = 0;
  if (!a4)
    goto LABEL_12;
...
LABEL_4:
  v21 = __error();
  v22 = *v21;
  _CreateError((uint64_t)"-[MIFileManager _setData:forExtendedAttributeNamed:onURL:orFD:error:]", 2337, (void *)*MEMORY[0x1E0CB2FE0], *v21, 0, 0, CFSTR("[f]setxattr failed for path %s fd %d"), v23, (uint64_t)v14);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  strerror(v22);
...
LABEL_7:
    ...
    if ((_DWORD)v25 != 93)
    {
      _CreateError((uint64_t)"-[MIFileManager _dataForExtendedAttributeNamed:length:onURL:orFD:error:]", 2385, (void *)*MEMORY[0x1E0CB2FE0], v25, 0, 0, CFSTR("[f]getxattr failed for path %s fd %d"), v24, (uint64_t)v19);
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      strerror(v25);
...
LABEL_12:
    ...
    _CreateError((uint64_t)"-[MIFileManager _dataForExtendedAttributeNamed:length:onURL:orFD:error:]", 2382, (void *)*MEMORY[0x1E0CB2FE0], 93, 0, 0, CFSTR("Attr named %s not present on \"%s\"), v24, (uint64_t)v17);
...
- (unint64_t)diskUsageForURL:(id)a3
{
  ...
  v19 = 0x2020000000;
  v20 = 0;
  objc_msgSend(MEMORY[0x1E0CB3690], "hashTableWithOptions:", 256);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)modificationDateForURL:(id)a3 error:(id *)a4
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeIntervalSince1970:", (double)v11.st_mtimespec.tv_nsec / 1000000000.0 + (double)v11.st_mtimespec.tv_sec);
    a4 = (id *)objc_claimAutoreleasedReturnValue();
  }
...
- (id)debugDescriptionForItemAtURL:(id)a3
{
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0CB2FE0]))
  {
...
LABEL_32:
  ...
  {
    v45 = v19;
    objc_msgSend(MEMORY[0x1E0C99D80], "MI_dictionaryWithContentsOfURL:options:error:", v8, 0, &v45);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    v25 = v45;
...
+ (id)_sanitizeFilePathForVarOrTmpSymlink:(id)a3 error:(id *)a4
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithPath:isDirectory:", CFSTR("/var/"), 1);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  OUTLINED_FUNCTION_0_0(&dword_1B76F3000, MEMORY[0x1E0C81028], a3, "%s: Expected to move %s to %s but got EXDEV; falling back to copyfile",
    a5,
    a6,
    a7,
    a8,
...
{
  OUTLINED_FUNCTION_0_0(&dword_1B76F3000, MEMORY[0x1E0C81028], a3, "%s: Attempt to clone %s to %s failed with EXDEV; falling back to copyfile",
    a5,
    a6,
    a7,
    a8,
