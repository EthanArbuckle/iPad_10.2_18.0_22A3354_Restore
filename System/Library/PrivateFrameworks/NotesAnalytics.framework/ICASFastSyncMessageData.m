...
- (ICASFastSyncMessageData)initWithCountOfMessagesSent:(id)a3 countOfMessagesReceived:(id)a4 avgMessageSizeInBytes:(id)a5 maxMessageSizeInBytes:(id)a6
{
  ...
  id v13;
  id v14;
  ICASFastSyncMessageData *v15;
  ICASFastSyncMessageData *v16;
  objc_super v18;
  ...
  v15 = -[ICASFastSyncMessageData init](&v18, sel_init);
  v16 = v15;
  if (v15)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("FastSyncMessageData");
}
...
- (id)toDict
{
  ...
  v17[0] = CFSTR("countOfMessagesSent");
  -[ICASFastSyncMessageData countOfMessagesSent](self, "countOfMessagesSent");
  ...
  v5 = (void *)v4;
  v18[0] = v4;
  v17[1] = CFSTR("countOfMessagesReceived");
  -[ICASFastSyncMessageData countOfMessagesReceived](self, "countOfMessagesReceived");
  ...
  v8 = (void *)v7;
  v18[1] = v7;
  v17[2] = CFSTR("avgMessageSizeInBytes");
  -[ICASFastSyncMessageData avgMessageSizeInBytes](self, "avgMessageSizeInBytes");
  ...
  v11 = (void *)v10;
  v18[2] = v10;
  v17[3] = CFSTR("maxMessageSizeInBytes");
  -[ICASFastSyncMessageData maxMessageSizeInBytes](self, "maxMessageSizeInBytes");
