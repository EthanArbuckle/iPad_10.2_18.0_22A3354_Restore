...
- (ICASNoteAccessData)initWithIsPasswordProtected:(id)a3 isPinned:(id)a4 collaborationStatus:(id)a5 collaborationType:(id)a6
{
  ...
  id v13;
  id v14;
  ICASNoteAccessData *v15;
  ICASNoteAccessData *v16;
  objc_super v18;
  ...
  v15 = -[ICASNoteAccessData init](&v18, sel_init);
  v16 = v15;
  if (v15)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("NoteAccessData");
}
...
- (id)toDict
{
  ...
  v17[0] = CFSTR("isPasswordProtected");
  -[ICASNoteAccessData isPasswordProtected](self, "isPasswordProtected");
  ...
  v5 = (void *)v4;
  v18[0] = v4;
  v17[1] = CFSTR("isPinned");
  -[ICASNoteAccessData isPinned](self, "isPinned");
  ...
  v8 = (void *)v7;
  v18[1] = v7;
  v17[2] = CFSTR("collaborationStatus");
  -[ICASNoteAccessData collaborationStatus](self, "collaborationStatus");
  ...
  v11 = (void *)v10;
  v18[2] = v10;
  v17[3] = CFSTR("collaborationType");
  -[ICASNoteAccessData collaborationType](self, "collaborationType");
