...
- (ICASAccountData)initWithAccountType:(id)a3 accountID:(id)a4
{
  ...
  v9 = -[ICASAccountData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("accountType");
  -[ICASAccountData accountType](self, "accountType");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("accountID");
  v12[0] = v4;
  -[ICASAccountData accountID](self, "accountID");
