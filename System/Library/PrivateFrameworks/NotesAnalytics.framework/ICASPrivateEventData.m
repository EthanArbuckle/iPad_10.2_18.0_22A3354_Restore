...
- (ICASPrivateEventData)initWithPrivateSessionID:(id)a3 sessionDetailType:(id)a4
{
  ...
  v9 = -[ICASPrivateEventData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("PrivateEventData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("privateSessionID");
  -[ICASPrivateEventData privateSessionID](self, "privateSessionID");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("sessionDetailType");
  v12[0] = v4;
  -[ICASPrivateEventData sessionDetailType](self, "sessionDetailType");
