...
- (ICASContextPathData)initWithContextPath:(id)a3
{
  ...
  v6 = -[ICASContextPathData init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("ContextPathData");
}
...
- (id)toDict
{
  ...
  v8 = CFSTR("contextPath");
  -[ICASContextPathData contextPath](self, "contextPath");
