...
- (ICASBioAuthData)initWithBioAuthType:(id)a3
{
  ...
  v6 = -[ICASBioAuthData init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("BioAuthData");
}
...
- (id)toDict
{
  ...
  v8 = CFSTR("bioAuthType");
  -[ICASBioAuthData bioAuthType](self, "bioAuthType");
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_bioAuthType, 0);
}
