...
- (ICASAttachmentItemTypeData)initWithAttachmentID:(id)a3 attachmentUTI:(id)a4
{
  ...
  v9 = -[ICASAttachmentItemTypeData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("AttachmentItemTypeData");
}
...
- (id)toDict
{
  ...
  -[ICASAttachmentItemTypeData attachmentID](self, "attachmentID");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("attachmentUTI");
  v12[0] = v4;
  -[ICASAttachmentItemTypeData attachmentUTI](self, "attachmentUTI");
