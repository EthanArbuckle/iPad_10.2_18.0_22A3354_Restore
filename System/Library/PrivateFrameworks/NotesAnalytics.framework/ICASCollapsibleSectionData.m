...
- (ICASCollapsibleSectionData)initWithSectionAffordanceExposures:(id)a3 sectionAffordanceUsages:(id)a4
{
  id v7;
  id v8;
  ICASCollapsibleSectionData *v9;
  ICASCollapsibleSectionData *v10;
  objc_super v12;
  ...
  v9 = -[ICASCollapsibleSectionData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("CollapsibleSectionData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("sectionAffordanceExposures");
  -[ICASCollapsibleSectionData sectionAffordanceExposures](self, "sectionAffordanceExposures");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("sectionAffordanceUsages");
  v12[0] = v4;
  -[ICASCollapsibleSectionData sectionAffordanceUsages](self, "sectionAffordanceUsages");
