...
- (ICASViewRefData)initWithLinkedNoteId:(id)a3
{
  ...
  v6 = -[ICASViewRefData init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("ViewRefData");
}
...
- (id)toDict
{
  ...
  v8 = CFSTR("linkedNoteId");
  -[ICASViewRefData linkedNoteId](self, "linkedNoteId");
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_linkedNoteId, 0);
}
