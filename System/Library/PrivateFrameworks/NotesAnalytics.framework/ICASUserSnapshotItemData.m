...
- (ICASUserSnapshotItemData)initWithUserID:(id)a3 userStorefrontID:(id)a4
{
  ...
  v9 = -[ICASUserSnapshotItemData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("UserSnapshotItemData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("userID");
  -[ICASUserSnapshotItemData userID](self, "userID");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("userStorefrontID");
  v12[0] = v4;
  -[ICASUserSnapshotItemData userStorefrontID](self, "userStorefrontID");
