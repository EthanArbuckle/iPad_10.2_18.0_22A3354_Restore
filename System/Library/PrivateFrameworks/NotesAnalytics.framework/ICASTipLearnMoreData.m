...
- (ICASTipLearnMoreData)initWithLearnMoreTipName:(id)a3 tipFeature:(id)a4
{
  id v7;
  id v8;
  ICASTipLearnMoreData *v9;
  ICASTipLearnMoreData *v10;
  objc_super v12;
  ...
  v9 = -[ICASTipLearnMoreData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("TipLearnMoreData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("learnMoreTipName");
  -[ICASTipLearnMoreData learnMoreTipName](self, "learnMoreTipName");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("tipFeature");
  v12[0] = v4;
  -[ICASTipLearnMoreData tipFeature](self, "tipFeature");
