...
- (ICASStartDrawingStrokeData)initWithStartPencilStrokeCount:(id)a3 startFingerStrokeCount:(id)a4
{
  id v7;
  id v8;
  ICASStartDrawingStrokeData *v9;
  ICASStartDrawingStrokeData *v10;
  objc_super v12;
  ...
  v9 = -[ICASStartDrawingStrokeData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("StartDrawingStrokeData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("startPencilStrokeCount");
  -[ICASStartDrawingStrokeData startPencilStrokeCount](self, "startPencilStrokeCount");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("startFingerStrokeCount");
  v12[0] = v4;
  -[ICASStartDrawingStrokeData startFingerStrokeCount](self, "startFingerStrokeCount");
