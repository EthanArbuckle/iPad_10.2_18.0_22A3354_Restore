...
- (ICASFastSyncData)initWithFastSyncSessionId:(id)a3 participantVersions:(id)a4
{
  ...
  v9 = -[ICASFastSyncData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("FastSyncData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("fastSyncSessionId");
  -[ICASFastSyncData fastSyncSessionId](self, "fastSyncSessionId");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("participantVersions");
  v12[0] = v4;
  -[ICASFastSyncData participantVersions](self, "participantVersions");
