...
- (ICASEndTableData)initWithEndingRowCount:(id)a3 endingColumnCount:(id)a4
{
  ...
  v9 = -[ICASEndTableData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("EndTableData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("endingRowCount");
  -[ICASEndTableData endingRowCount](self, "endingRowCount");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("endingColumnCount");
  v12[0] = v4;
  -[ICASEndTableData endingColumnCount](self, "endingColumnCount");
