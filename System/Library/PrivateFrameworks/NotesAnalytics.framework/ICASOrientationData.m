...
- (ICASOrientationData)initWithDeviceOrientation:(id)a3 interfaceOrientation:(id)a4
{
  id v7;
  id v8;
  ICASOrientationData *v9;
  ICASOrientationData *v10;
  objc_super v12;
  ...
  v9 = -[ICASOrientationData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("OrientationData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("deviceOrientation");
  -[ICASOrientationData deviceOrientation](self, "deviceOrientation");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("interfaceOrientation");
  v12[0] = v4;
  -[ICASOrientationData interfaceOrientation](self, "interfaceOrientation");
