...
- (ICASPdfCollabIxData)initWithHasCollabView:(id)a3 hasCollabEdit:(id)a4
{
  id v7;
  id v8;
  ICASPdfCollabIxData *v9;
  ICASPdfCollabIxData *v10;
  objc_super v12;
  ...
  v9 = -[ICASPdfCollabIxData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("PdfCollabIxData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("hasCollabView");
  -[ICASPdfCollabIxData hasCollabView](self, "hasCollabView");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("hasCollabEdit");
  v12[0] = v4;
  -[ICASPdfCollabIxData hasCollabEdit](self, "hasCollabEdit");
