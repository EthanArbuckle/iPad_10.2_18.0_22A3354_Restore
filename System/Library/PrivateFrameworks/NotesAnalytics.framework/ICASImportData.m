...
- (ICASImportData)initWithImportSummary:(id)a3
{
  ...
  v6 = -[ICASImportData init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("ImportData");
}
...
- (id)toDict
{
  ...
  v8 = CFSTR("importSummary");
  -[ICASImportData importSummary](self, "importSummary");
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_importSummary, 0);
}
