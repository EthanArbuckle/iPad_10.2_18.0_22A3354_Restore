...
- (ICASTagBrowserSelectionData)initWithCountOfSelectedTags:(id)a3 isAllTagsSelected:(id)a4
{
  id v7;
  id v8;
  ICASTagBrowserSelectionData *v9;
  ...
  v9 = -[ICASTagBrowserSelectionData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("TagBrowserSelectionData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("countOfSelectedTags");
  -[ICASTagBrowserSelectionData countOfSelectedTags](self, "countOfSelectedTags");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("isAllTagsSelected");
  v12[0] = v4;
  -[ICASTagBrowserSelectionData isAllTagsSelected](self, "isAllTagsSelected");
