...
- (ICASPasswordData)initWithPasswordType:(id)a3 hasHint:(id)a4
{
  ...
  v9 = -[ICASPasswordData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("PasswordData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("passwordType");
  -[ICASPasswordData passwordType](self, "passwordType");
  ...
  v11[1] = CFSTR("hasHint");
  v12[0] = v4;
  -[ICASPasswordData hasHint](self, "hasHint");
