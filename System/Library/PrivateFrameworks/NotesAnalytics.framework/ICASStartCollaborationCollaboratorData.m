...
- (ICASStartCollaborationCollaboratorData)initWithStartInvitedCount:(id)a3 startAcceptedCount:(id)a4
{
  id v7;
  id v8;
  ICASStartCollaborationCollaboratorData *v9;
  ...
  v9 = -[ICASStartCollaborationCollaboratorData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("StartCollaborationCollaboratorData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("startInvitedCount");
  -[ICASStartCollaborationCollaboratorData startInvitedCount](self, "startInvitedCount");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("startAcceptedCount");
  v12[0] = v4;
  -[ICASStartCollaborationCollaboratorData startAcceptedCount](self, "startAcceptedCount");
