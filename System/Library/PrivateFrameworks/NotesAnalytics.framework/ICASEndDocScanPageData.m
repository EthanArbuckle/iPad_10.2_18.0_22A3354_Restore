...
{
  id v5;
  ICASEndDocScanPageData *v6;
  ICASEndDocScanPageData *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ICASEndDocScanPageData;
  v6 = -[ICASEndDocScanPageData init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("EndDocScanPageData");
}
...
- (id)toDict
{
  ...
  v8 = CFSTR("endPageCount");
  -[ICASEndDocScanPageData endPageCount](self, "endPageCount");
