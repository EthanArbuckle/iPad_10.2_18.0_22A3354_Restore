...
- (ICASCloudOperationData)initWithOperationID:(id)a3 operationType:(id)a4 operationGroupName:(id)a5
{
  ...
  id v10;
  id v11;
  ICASCloudOperationData *v12;
  ICASCloudOperationData *v13;
  objc_super v15;
  ...
  v12 = -[ICASCloudOperationData init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("CloudOperationData");
}
...
- (id)toDict
{
  ...
  v14[0] = CFSTR("operationID");
  -[ICASCloudOperationData operationID](self, "operationID");
  ...
  v5 = (void *)v4;
  v15[0] = v4;
  v14[1] = CFSTR("operationType");
  -[ICASCloudOperationData operationType](self, "operationType");
  ...
  v8 = (void *)v7;
  v15[1] = v7;
  v14[2] = CFSTR("operationGroupName");
  -[ICASCloudOperationData operationGroupName](self, "operationGroupName");
