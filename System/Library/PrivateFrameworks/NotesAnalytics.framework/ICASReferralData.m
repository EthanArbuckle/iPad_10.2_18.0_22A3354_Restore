...
- (ICASReferralData)initWithReferringApplication:(id)a3 referringInboundUrl:(id)a4
{
  ...
  v9 = -[ICASReferralData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("ReferralData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("referringApplication");
  -[ICASReferralData referringApplication](self, "referringApplication");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("referringInboundUrl");
  v12[0] = v4;
  -[ICASReferralData referringInboundUrl](self, "referringInboundUrl");
