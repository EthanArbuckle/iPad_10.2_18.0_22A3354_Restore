...
- (ICASPdfPageData)initWithStartPageCount:(id)a3 endPageCount:(id)a4
{
  ...
  v9 = -[ICASPdfPageData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("PdfPageData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("startPageCount");
  -[ICASPdfPageData startPageCount](self, "startPageCount");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("endPageCount");
  v12[0] = v4;
  -[ICASPdfPageData endPageCount](self, "endPageCount");
