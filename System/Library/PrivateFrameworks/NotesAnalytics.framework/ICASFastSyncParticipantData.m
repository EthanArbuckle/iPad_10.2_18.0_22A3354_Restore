...
- (ICASFastSyncParticipantData)initWithCountOfUniqueAccounts:(id)a3 countOfUniqueDevices:(id)a4
{
  id v7;
  id v8;
  ICASFastSyncParticipantData *v9;
  ICASFastSyncParticipantData *v10;
  objc_super v12;
  ...
  v9 = -[ICASFastSyncParticipantData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("FastSyncParticipantData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("countOfUniqueAccounts");
  -[ICASFastSyncParticipantData countOfUniqueAccounts](self, "countOfUniqueAccounts");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("countOfUniqueDevices");
  v12[0] = v4;
  -[ICASFastSyncParticipantData countOfUniqueDevices](self, "countOfUniqueDevices");
