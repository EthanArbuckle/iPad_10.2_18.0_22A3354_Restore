...
- (ICASAttachmentSnapshotItemData)initWithAttachmentID:(id)a3 attachmentTypeUTI:(id)a4
{
  id v7;
  id v8;
  ICASAttachmentSnapshotItemData *v9;
  ICASAttachmentSnapshotItemData *v10;
  objc_super v12;
  ...
  v9 = -[ICASAttachmentSnapshotItemData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("AttachmentSnapshotItemData");
}
...
- (id)toDict
{
  ...
  -[ICASAttachmentSnapshotItemData attachmentID](self, "attachmentID");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("attachmentTypeUTI");
  v12[0] = v4;
  -[ICASAttachmentSnapshotItemData attachmentTypeUTI](self, "attachmentTypeUTI");
