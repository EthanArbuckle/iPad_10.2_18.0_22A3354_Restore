...
- (ICASStartTableData)initWithStartingRowCount:(id)a3 startingColumnCount:(id)a4
{
  id v7;
  id v8;
  ICASStartTableData *v9;
  ICASStartTableData *v10;
  objc_super v12;
  ...
  v9 = -[ICASStartTableData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("StartTableData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("startingRowCount");
  -[ICASStartTableData startingRowCount](self, "startingRowCount");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("startingColumnCount");
  v12[0] = v4;
  -[ICASStartTableData startingColumnCount](self, "startingColumnCount");
