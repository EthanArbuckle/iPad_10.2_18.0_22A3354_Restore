...
- (ICASAcceleratorUsageData)initWithMaxNumCharTyped:(id)a3 endResultCount:(id)a4
{
  ...
  v9 = -[ICASAcceleratorUsageData init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
+ (NSString)dataName
{
  return (NSString *)CFSTR("AcceleratorUsageData");
}
...
- (id)toDict
{
  ...
  v11[0] = CFSTR("maxNumCharTyped");
  -[ICASAcceleratorUsageData maxNumCharTyped](self, "maxNumCharTyped");
  ...
  v5 = (void *)v4;
  v11[1] = CFSTR("endResultCount");
  v12[0] = v4;
  -[ICASAcceleratorUsageData endResultCount](self, "endResultCount");
