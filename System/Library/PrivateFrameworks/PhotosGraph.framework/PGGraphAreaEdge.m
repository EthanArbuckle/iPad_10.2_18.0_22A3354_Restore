...
- (PGGraphAreaEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 properties:(id)a7
{
  ...
  v10 = a5;
  v11 = a4;
  objc_msgSend(a7, "objectForKeyedSubscript:", CFSTR("relevance"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "doubleValue");
  v14 = v13;

  v15 = -[PGGraphAreaEdge initFromAddressNode:toAreaNode:relevance:](self, "initFromAddressNode:toAreaNode:relevance:", v11, v10, v14);
  return v15;
}
...
- (PGGraphAreaEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 weight:(float)a7 properties:(id)a8
{
  ...
  v22 = -[PGGraphAreaEdge initWithLabel:sourceNode:targetNode:domain:properties:](self, "initWithLabel:sourceNode:targetNode:domain:properties:", v14, v15, v16, v10, v17);
...
- (id)edgeDescription
{
  ...
  objc_msgSend(v3, "stringWithFormat:", CFSTR("%@ (%.2f)"), v4, *(_QWORD *)&self->_relevance);
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A00]), "initWithLabel:domain:", CFSTR("AREA"), 201);
}
