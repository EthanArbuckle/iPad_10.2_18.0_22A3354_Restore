...
- (PGGraphMobilityEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 properties:(id)a7
{
  ...
  v15 = -[PGGraphMobilityEdge initFromMomentNode:toMobilityNode:confidence:](self, "initFromMomentNode:toMobilityNode:confidence:", v11, v10, v14);
  return v15;
}
...
- (PGGraphMobilityEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 weight:(float)a7 properties:(id)a8
{
  ...
  v22 = -[PGGraphMobilityEdge initWithLabel:sourceNode:targetNode:domain:properties:](self, "initWithLabel:sourceNode:targetNode:domain:properties:", v14, v15, v16, v10, v17);
...
- (id)edgeDescription
{
  ...
  objc_msgSend(v3, "stringWithFormat:", CFSTR("%@ (weight = %.2f)"), v4, *(_QWORD *)&self->_confidence);
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A00]), "initWithLabel:domain:", CFSTR("MOBILITY"), 203);
}
