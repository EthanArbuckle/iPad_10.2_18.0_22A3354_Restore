...
{
  return -[PGInfrequentCountryMemoryNodeFeatureExtractor initWithVersion:graph:error:](self, "initWithVersion:graph:error:", 1, 0, a3);
}
...
- (PGInfrequentCountryMemoryNodeFeatureExtractor)initWithFrequentCountryLabels:(id)a3 version:(int64_t)a4 graph:(id)a5 error:(id *)a6
{
  ...
  void *v14;
  id v15;
  PGInfrequentCountryMemoryNodeFeatureExtractor *v16;
  objc_super v18;
  _QWORD v19[4];
  id v20;
  _QWORD v21[2];
  ...
  v15 = v8;
  v16 = -[PGGraphMemoryNodeFeatureExtractor initWithName:featureNames:relation:labelForTargetBlock:](&v18, sel_initWithName_featureNames_relation_labelForTargetBlock_, CFSTR("Country"), v9, v14, v19);
...
- (PGInfrequentCountryMemoryNodeFeatureExtractor)initWithVersion:(int64_t)a3 graph:(id)a4 error:(id *)a5
{
  ...
  uint64_t v15;
  void *v16;
  PGInfrequentCountryMemoryNodeFeatureExtractor *v17;
  ...
  v17 = -[PGInfrequentCountryMemoryNodeFeatureExtractor initWithFrequentCountryLabels:version:graph:error:](self, "initWithFrequentCountryLabels:version:graph:error:", v16, a3, v8, a5);
