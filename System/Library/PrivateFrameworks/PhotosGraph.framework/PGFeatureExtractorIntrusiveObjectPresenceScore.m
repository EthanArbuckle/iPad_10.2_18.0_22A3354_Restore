...
- (id)name
{
  ...
  v2 = CFSTR("IntrusiveObjectPresenceScore");
  return CFSTR("IntrusiveObjectPresenceScore");
}
...
- (id)featureNames
{
  ...
  v3[0] = CFSTR("IntrusiveObjectPresenceScore");
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorIntrusiveObjectPresenceScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
