...
- (id)name
{
  ...
  v2 = CFSTR("WellChosenSubjectScore");
  return CFSTR("WellChosenSubjectScore");
}
...
- (id)featureNames
{
  ...
  v3[0] = CFSTR("WellChosenSubjectScore");
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorWellChosenSubjectScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
