...
- (PGGraphAnniversaryEventEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 properties:(id)a7
{
  ...
  double v13;
  double v14;
  PGGraphAnniversaryEventEdge *v15;
  ...
  v15 = -[PGGraphAnniversaryEventEdge initFromMomentNode:toPersonNode:confidence:](self, "initFromMomentNode:toPersonNode:confidence:", v11, v10, v14);
  return v15;
}
...
- (PGGraphAnniversaryEventEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 weight:(float)a7 properties:(id)a8
{
  ...
  double v20;
  void *v21;
  PGGraphAnniversaryEventEdge *v22;
  ...
  v22 = -[PGGraphAnniversaryEventEdge initWithLabel:sourceNode:targetNode:domain:properties:](self, "initWithLabel:sourceNode:targetNode:domain:properties:", v14, v15, v16, v10, v17);
...
{
  return (id)objc_msgSend((id)objc_opt_class(), "propertyDictionaryWithConfidence:", self->_confidence);
}
...
- (id)label
{
  ...
  v2 = CFSTR("ANNIVERSARY");
  return CFSTR("ANNIVERSARY");
}
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A00]), "initWithLabel:domain:", CFSTR("ANNIVERSARY"), 301);
}
