...
- (PGInvariantBrotherFeatureExtractor)initWithError:(id *)a3
{
  ...
  void *v11;
  void *v12;
  PGInvariantBrotherFeatureExtractor *v13;
  objc_super v15;
  _QWORD v16[3];
  _QWORD v17[2];
  ...
  v13 = -[PGGraphFeatureExtractor initWithName:featureNames:relation:labelForTargetBlock:](&v15, sel_initWithName_featureNames_relation_labelForTargetBlock_, CFSTR("BROTHER"), v4, v12, &__block_literal_global_35485);

  return v13;
}

const __CFString *__52__PGInvariantBrotherFeatureExtractor_initWithError___block_invoke()
{
  __CFString *v0;
