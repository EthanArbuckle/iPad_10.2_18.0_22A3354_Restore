...
- (id)name
{
  ...
  v2 = CFSTR("PleasantPerspectiveScore");
  return CFSTR("PleasantPerspectiveScore");
}
...
- (id)featureNames
{
  ...
  v3[0] = CFSTR("PleasantPerspectiveScore");
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorPleasantPerspectiveScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
