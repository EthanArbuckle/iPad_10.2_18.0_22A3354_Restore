...
- (id)name
{
  return CFSTR("Top Friends Location");
}

- (id)details
{
  return CFSTR("Return suggestions based on the top friends at the location");
}
...
- (id)suggestedResultsForInput:(id)a3 withOptions:(id)a4
{
  ...
  v25 = v8;
  -[PGGraphMomentNodeCollection addressNodes](v8, "addressNodes");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "cityNodes");
