...
- (PGInvariantMyChildMemoryNodeFeatureExtractor)initWithError:(id *)a3
{
  ...
  void *v12;
  void *v13;
  PGInvariantMyChildMemoryNodeFeatureExtractor *v14;
  objc_super v16;
  _QWORD v17[3];
  _QWORD v18[2];
  ...
  v14 = -[PGGraphMemoryNodeFeatureExtractor initWithName:featureNames:relation:labelForTargetBlock:](&v16, sel_initWithName_featureNames_relation_labelForTargetBlock_, CFSTR("CHILD"), v4, v13, &__block_literal_global_7_58175);

  return v14;
}

const __CFString *__62__PGInvariantMyChildMemoryNodeFeatureExtractor_initWithError___block_invoke()
{
