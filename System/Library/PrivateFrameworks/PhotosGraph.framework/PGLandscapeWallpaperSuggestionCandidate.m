...
{
  id v5;
  PGLandscapeWallpaperSuggestionCandidate *v6;
  PGLandscapeWallpaperSuggestionCandidate *v7;
  uint64_t v8;
  ...
  v6 = -[PGLandscapeWallpaperSuggestionCandidate init](&v11, sel_init);
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_asset, a3);
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E0D77F20]), "initWithAsset:classification:", v5, 3);
