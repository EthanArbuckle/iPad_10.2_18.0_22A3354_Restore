...
- (id)name
{
  ...
  v2 = CFSTR("PleasantSymmetryScore");
  return CFSTR("PleasantSymmetryScore");
}
...
- (id)featureNames
{
  ...
  v3[0] = CFSTR("PleasantSymmetryScore");
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorPleasantSymmetryScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
