...
- (PGGraphPlaceBusinessEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 properties:(id)a7
{
  ...
  v24 = -[PGGraphBusinessEdge initFromSourceNode:toBusinessNode:confidence:hasRoutineInfo:universalStartDate:universalEndDate:](self, "initFromSourceNode:toBusinessNode:confidence:hasRoutineInfo:universalStartDate:universalEndDate:", v10, v11, v17, v20, v23, v15);
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A00]), "initWithLabel:domain:", CFSTR("BUSINESS"), 503);
}
