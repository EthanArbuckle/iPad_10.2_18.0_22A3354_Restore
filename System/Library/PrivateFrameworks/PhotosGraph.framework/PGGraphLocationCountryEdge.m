...
{
  return (PGGraphLocationCountryEdge *)-[PGGraphLocationCountryEdge initFromLocationNode:toCountryNode:](self, "initFromLocationNode:toCountryNode:", a4, a5);
}
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A00]), "initWithLabel:domain:", CFSTR("COUNTRY"), 200);
}
