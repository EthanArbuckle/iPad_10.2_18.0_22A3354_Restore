...
{
  PGFeatureTransformerToMask *result;
  objc_super v7;
...
- (id)applyTransformationToFloatVector:(id)a3 error:(id *)a4
{
  ...
  *(float *)&v6 = self->_maskingValue;
  return (id)objc_msgSend(MEMORY[0x1E0D42A20], "vectorRepeatingFloat:count:", v5, v6);
}
...
+ (id)instanceWithParameters:(id)a3 error:(id *)a4
{
  ...
  void *v10;
  void *v11;
  PGFeatureTransformerToMask *v12;
  int v13;
  int v14;
  uint64_t v15;
  uint64_t v16;
  double v17;
  PGFeatureTransformerToMask *v18;
  PGFeatureTransformerToMask *v19;
  void *v20;
  uint64_t v22;
...
LABEL_4:
    ...
    if (objc_msgSend(v5, "count") == 3)
    {
      ...
      LODWORD(v17) = v14;
      v18 = -[PGFeatureTransformerToMask initWithMaskingFloatValue:fromIndex:toIndex:](v12, "initWithMaskingFloatValue:fromIndex:toIndex:", v15, v16, v17);
  ...
  v23 = CFSTR("Failed to instantiate PGFeatureTransformerToMask: incorrect parameters.");
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v23, &v22, 1);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "errorWithDomain:code:userInfo:", CFSTR("com.apple.PhotosGraph.PGFeatureTransformerToMask"), 0, v9);
  v18 = 0;
