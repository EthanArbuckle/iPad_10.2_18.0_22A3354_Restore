...
{
  PGFeatureTransformerAddScalar *result;
  objc_super v7;
...
- (id)applyTransformationToFloatVector:(id)a3 error:(id *)a4
{
  ...
  v5 = a3;
  -[PGFeatureTransformerAddScalar scalarToAdd](self, "scalarToAdd");
  objc_msgSend(v5, "vectorByAddingScalar:");
...
+ (id)instanceWithParameters:(id)a3 error:(id *)a4
{
  ...
  void *v10;
  void *v11;
  PGFeatureTransformerAddScalar *v12;
  int v13;
  int v14;
  uint64_t v15;
  uint64_t v16;
  double v17;
  PGFeatureTransformerAddScalar *v18;
  PGFeatureTransformerAddScalar *v19;
  void *v20;
  uint64_t v22;
...
LABEL_4:
    ...
    if (objc_msgSend(v5, "count") == 3)
    {
      ...
      LODWORD(v17) = v14;
      v18 = -[PGFeatureTransformerAddScalar initWithScalarToAdd:fromIndex:toIndex:](v12, "initWithScalarToAdd:fromIndex:toIndex:", v15, v16, v17);
  ...
  v23 = CFSTR("Failed to instantiate PGFeatureTransformerAddScalar: incorrect parameters.");
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v23, &v22, 1);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "errorWithDomain:code:userInfo:", CFSTR("com.apple.PhotosGraph.PGFeatureTransformerAddScalar"), 0, v9);
  v18 = 0;
