...
{
  PGPersonCLIPTrendsMemoryGenerator *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)PGPersonCLIPTrendsMemoryGenerator;
  v4 = -[PGPersonTrendsMemoryGenerator initWithMemoryGenerationContext:configurations:](&v6, sel_initWithMemoryGenerationContext_configurations_, a3, a4);
  if (v4)
