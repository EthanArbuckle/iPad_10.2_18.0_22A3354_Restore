...
- (id)name
{
  ...
  v2 = CFSTR("PleasantLightingScore");
  return CFSTR("PleasantLightingScore");
}
...
- (id)featureNames
{
  ...
  v3[0] = CFSTR("PleasantLightingScore");
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorPleasantLightingScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
