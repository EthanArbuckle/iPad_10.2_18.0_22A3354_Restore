...
- (id)_plistMoodIdentifiersWithGraph:(id)a3
{
  ...
  if (v5)
  {
    ...
    +[PGMoodUtilities moodGraphNodeIdentifiersForMomentNodes:](PGMoodUtilities, "moodGraphNodeIdentifiersForMomentNodes:", v7);
  }
  else
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    +[PGMoodUtilities moodGraphNodeIdentifiersForAssetCollection:withGraph:moodOptions:](PGMoodUtilities, "moodGraphNodeIdentifiersForAssetCollection:withGraph:moodOptions:", v6, v4, v7);
  }
...
+ (id)_plistName
{
  return CFSTR("MoodSourceGraphNode");
}
