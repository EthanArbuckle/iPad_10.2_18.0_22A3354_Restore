...
- (id)name
{
  ...
  v2 = CFSTR("SharplyFocusedSubjectScore");
  return CFSTR("SharplyFocusedSubjectScore");
}
...
- (id)featureNames
{
  ...
  v3[0] = CFSTR("SharplyFocusedSubjectScore");
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorSharplyFocusedSubjectScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
