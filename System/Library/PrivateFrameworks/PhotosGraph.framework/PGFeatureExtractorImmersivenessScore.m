...
- (id)name
{
  ...
  v2 = CFSTR("ImmersivenessScore");
  return CFSTR("ImmersivenessScore");
}
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorImmersivenessScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
