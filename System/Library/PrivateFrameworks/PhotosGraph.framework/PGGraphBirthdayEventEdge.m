...
- (PGGraphBirthdayEventEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 properties:(id)a7
{
  ...
  v15 = -[PGGraphBirthdayEventEdge initFromMomentNode:toPersonNode:confidence:](self, "initFromMomentNode:toPersonNode:confidence:", v11, v10, v14);
  return v15;
}
...
- (PGGraphBirthdayEventEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 weight:(float)a7 properties:(id)a8
{
  ...
  v22 = -[PGGraphBirthdayEventEdge initWithLabel:sourceNode:targetNode:domain:properties:](self, "initWithLabel:sourceNode:targetNode:domain:properties:", v14, v15, v16, v10, v17);
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A00]), "initWithLabel:domain:", CFSTR("BIRTHDAY"), 301);
}
