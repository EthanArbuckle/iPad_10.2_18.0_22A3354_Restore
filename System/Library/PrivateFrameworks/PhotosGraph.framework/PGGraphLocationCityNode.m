...
{
  return -[MANodeCollection initWithNode:]([PGGraphLocationCityNodeCollection alloc], "initWithNode:", self);
}
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A50]), "initWithLabel:domain:", CFSTR("City"), 200);
}
