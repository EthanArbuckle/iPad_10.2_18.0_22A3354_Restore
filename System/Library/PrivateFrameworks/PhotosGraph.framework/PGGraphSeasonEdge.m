...
{
  return (PGGraphSeasonEdge *)-[PGGraphSeasonEdge initFromDateNode:toSeasonNode:](self, "initFromDateNode:toSeasonNode:", a4, a5);
}
...
+ (id)filter
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D42A00]), "initWithLabel:domain:", CFSTR("SEASON"), 400);
}
