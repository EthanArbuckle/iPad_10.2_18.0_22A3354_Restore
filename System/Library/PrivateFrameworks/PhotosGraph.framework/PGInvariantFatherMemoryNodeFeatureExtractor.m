...
- (PGInvariantFatherMemoryNodeFeatureExtractor)initWithError:(id *)a3
{
  ...
  void *v12;
  void *v13;
  PGInvariantFatherMemoryNodeFeatureExtractor *v14;
  objc_super v16;
  _QWORD v17[3];
  _QWORD v18[2];
  ...
  v14 = -[PGGraphMemoryNodeFeatureExtractor initWithName:featureNames:relation:labelForTargetBlock:](&v16, sel_initWithName_featureNames_relation_labelForTargetBlock_, CFSTR("FATHER"), v4, v13, &__block_literal_global_6_63591);

  return v14;
}

const __CFString *__61__PGInvariantFatherMemoryNodeFeatureExtractor_initWithError___block_invoke()
{
  __CFString *v0;
