...
- (PGGraphMomentNodeCollection)momentNodes
{
  ...
  +[PGGraphSceneFeatureNode momentOfSceneFeature](PGGraphSceneFeatureNode, "momentOfSceneFeature");
...
+ (id)sceneFeatureNodesForSceneName:(id)a3 inGraph:(id)a4
{
  ...
  v6 = a4;
  +[PGGraphSceneFeatureNode filterForSceneName:](PGGraphSceneFeatureNode, "filterForSceneName:", a3);
...
+ (id)sceneFeatureNodesForSceneNames:(id)a3 inGraph:(id)a4
{
  ...
  v6 = a4;
  +[PGGraphSceneFeatureNode filterForSceneNames:](PGGraphSceneFeatureNode, "filterForSceneNames:", a3);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1, "nodesMatchingFilter:inGraph:", v7, v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
