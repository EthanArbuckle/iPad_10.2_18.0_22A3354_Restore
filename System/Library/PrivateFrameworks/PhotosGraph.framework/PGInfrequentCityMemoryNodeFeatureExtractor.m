...
{
  return -[PGInfrequentCityMemoryNodeFeatureExtractor initWithVersion:graph:error:](self, "initWithVersion:graph:error:", 1, 0, a3);
}
...
- (PGInfrequentCityMemoryNodeFeatureExtractor)initWithFrequentCityLabels:(id)a3 version:(int64_t)a4 graph:(id)a5 error:(id *)a6
{
  ...
  id v12;
  void *v13;
  PGInfrequentCityMemoryNodeFeatureExtractor *v14;
  ...
  v14 = -[PGInfrequentCityMemoryNodeFeatureExtractor initWithFrequentCityLabels:version:graph:cityManager:error:](self, "initWithFrequentCityLabels:version:graph:cityManager:error:", v12, a4, v11, v13, a6);
...
- (PGInfrequentCityMemoryNodeFeatureExtractor)initWithFrequentCityLabels:(id)a3 version:(int64_t)a4 graph:(id)a5 cityManager:(id)a6 error:(id *)a7
{
  ...
  id v18;
  id v19;
  PGInfrequentCityMemoryNodeFeatureExtractor *v20;
  objc_super v22;
  _QWORD v23[4];
  id v24;
  id v25;
  ...
  v10 = a3;
  v11 = a6;
  -[PGInfrequentCityMemoryNodeFeatureExtractor labelsForVersion:](self, "labelsForVersion:", a4);
  ...
  v18 = v10;
  v19 = v11;
  v20 = -[PGGraphMemoryNodeFeatureExtractor initWithName:featureNames:relation:labelForTargetBlock:](&v22, sel_initWithName_featureNames_relation_labelForTargetBlock_, CFSTR("City"), v12, v17, v23);
...
- (PGInfrequentCityMemoryNodeFeatureExtractor)initWithVersion:(int64_t)a3 graph:(id)a4 error:(id *)a5
{
  ...
  id v15;
  id v16;
  PGInfrequentCityMemoryNodeFeatureExtractor *v17;
  uint64_t v19;
  uint64_t v20;
