...
{
  return -[PGInvariantPetFeatureExtractor initWithVersion:error:](self, "initWithVersion:error:", 1, a3);
}
...
- (PGInvariantPetFeatureExtractor)initWithVersion:(int64_t)a3 error:(id *)a4
{
  void *v6;
  void *v7;
  PGInvariantPetFeatureExtractor *v8;
  objc_super v10;
  _QWORD v11[5];
  ...
  v8 = -[PGGraphFeatureExtractor initWithName:featureNames:relation:labelForTargetBlock:](&v10, sel_initWithName_featureNames_relation_labelForTargetBlock_, CFSTR("InvariantPet"), v6, v7, v11);
...
{
  return +[PGInvariantPetFeatureExtractor _nodeProcessingForVersion:node:](PGInvariantPetFeatureExtractor, "_nodeProcessingForVersion:node:", *(_QWORD *)(a1 + 32), a2);
}
