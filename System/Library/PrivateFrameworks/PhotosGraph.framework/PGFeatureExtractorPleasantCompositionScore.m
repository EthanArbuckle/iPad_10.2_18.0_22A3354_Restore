...
- (id)name
{
  ...
  v2 = CFSTR("PleasantCompositionScore");
  return CFSTR("PleasantCompositionScore");
}
...
- (id)featureNames
{
  ...
  v3[0] = CFSTR("PleasantCompositionScore");
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = -[PGFeatureExtractorPleasantCompositionScore featureLength](self, "featureLength");
  LODWORD(v10) = v7;
