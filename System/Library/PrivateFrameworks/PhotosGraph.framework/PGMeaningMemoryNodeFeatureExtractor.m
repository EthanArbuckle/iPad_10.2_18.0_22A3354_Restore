...
{
  return -[PGMeaningMemoryNodeFeatureExtractor initWithVersion:error:](self, "initWithVersion:error:", 1, a3);
}
...
- (PGMeaningMemoryNodeFeatureExtractor)initWithVersion:(int64_t)a3 error:(id *)a4
{
  ...
  void *v11;
  void *v12;
  PGMeaningMemoryNodeFeatureExtractor *v13;
  objc_super v15;
  _QWORD v16[5];
  _QWORD v17[2];
  ...
  +[PGGraphMeaningNode filter](PGGraphMeaningNode, "filter");
  ...
  +[PGMeaningMemoryNodeFeatureExtractor name](PGMeaningMemoryNodeFeatureExtractor, "name");
  ...
  v13 = -[PGGraphMemoryNodeFeatureExtractor initWithName:featureNames:relation:labelForTargetBlock:](&v15, sel_initWithName_featureNames_relation_labelForTargetBlock_, v12, v6, v11, v16);
...
id __61__PGMeaningMemoryNodeFeatureExtractor_initWithVersion_error___block_invoke(uint64_t a1, void *a2)
{
  ...
  +[PGMeaningMemoryNodeFeatureExtractor _labelProcessingForVersion:label:](PGMeaningMemoryNodeFeatureExtractor, "_labelProcessingForVersion:label:", v2, v3);
...
+ (id)prefix
{
  return +[PGMeaningMemoryNodeFeatureExtractor name](PGMeaningMemoryNodeFeatureExtractor, "name");
}
