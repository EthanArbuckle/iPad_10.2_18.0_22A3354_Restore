...
- (void)dealloc
{
  ...
  -[HLPURLSessionItem cancel](self, "cancel");
  v3.receiver = self;
  v3.super_class = (Class)HLPURLSessionItem;
  -[HLPURLSessionItem dealloc](&v3, sel_dealloc);
}
...
- (HLPURLSessionItem)initWithSessionTask:(id)a3 completionHandler:(id)a4
{
  id v7;
  id v8;
  HLPURLSessionItem *v9;
  HLPURLSessionItem *v10;
  uint64_t v11;
  ...
  v9 = -[HLPURLSessionItem init](&v14, sel_init);
  v10 = v9;
  if (v9)
  {
    ...
    -[HLPURLSessionTask registerDelegate:](v10->_sessionTask, "registerDelegate:", v10);
  }
...
- (int64_t)state
{
  ...
  -[HLPURLSessionTask task](self->_sessionTask, "task");
...
- (void)resume
{
  -[HLPURLSessionTask resume](self->_sessionTask, "resume");
}
...
- (void)cancel
{
  ...
  self->_cancelled = 1;
  -[HLPURLSessionTask unregisterDelegate:](self->_sessionTask, "unregisterDelegate:", self);
  v5 = *MEMORY[0x24BDD0FC8];
  v6[0] = CFSTR("Cancelled");
  objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v6, &v5, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", CFSTR("Request"), -1, v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HLPURLSessionItem notifyWithSessionTask:error:](self, "notifyWithSessionTask:error:", 0, v4);
