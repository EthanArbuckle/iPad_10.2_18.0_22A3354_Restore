...
- (id)description
{
  ...
  -[ATXPBExecutableReferenceCache description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXPBExecutableReferenceCache dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_keys, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("keys"));
  }
  return v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)keys | v4[1])
      v6 = -[NSMutableArray isEqual:](keys, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_keys, "hash");
}
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[ATXPBExecutableReferenceCache addKeys:](a1, *(void **)(*((_QWORD *)&v8 + 1) + 8 * v7++));
        }
        while (v5 != v7);
