...
{
  ATXUserEducationSuggestionCustomizeFocus *result;
  objc_super v5;
...
{
  id v4;
  ATXUserEducationSuggestionCustomizeFocus *v5;
  void *v6;
  NSObject *v7;
  void *v8;
  uint64_t v9;
  ...
  uint64_t v14;
  uint64_t v15;
  ATXUserEducationSuggestionCustomizeFocus *v16;
  objc_super v18;
  uint8_t buf[4];
  const char *v20;
  __int16 v21;
  ...
  v4 = a3;
  v18.receiver = self;
  v18.super_class = (Class)ATXUserEducationSuggestionCustomizeFocus;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      -[ATXUserEducationSuggestionCustomizeFocus initWithCoder:].cold.1(v7, v9, v10, v11, v12, v13, v14, v15);
  }
