...
- (id)description
{
  ...
  -[ATXPBPredictableParameters description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXPBPredictableParameters dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  parameterKeys = self->_parameterKeys;
  if (parameterKeys)
    objc_msgSend(v3, "setObject:forKey:", parameterKeys, CFSTR("parameterKeys"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[ATXPBPredictableParameters parameterKeysCount](self, "parameterKeysCount"))
  {
    objc_msgSend(v8, "clearParameterKeys");
    v4 = -[ATXPBPredictableParameters parameterKeysCount](self, "parameterKeysCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[ATXPBPredictableParameters parameterKeysAtIndex:](self, "parameterKeysAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addParameterKeys:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addParameterKeys:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)parameterKeys | v4[1])
      v6 = -[NSMutableArray isEqual:](parameterKeys, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_parameterKeys, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[ATXPBPredictableParameters addParameterKeys:](self, "addParameterKeys:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
