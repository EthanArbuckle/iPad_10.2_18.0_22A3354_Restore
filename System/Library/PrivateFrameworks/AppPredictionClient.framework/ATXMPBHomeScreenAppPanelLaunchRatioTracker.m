...
- (int)StringAsLocation:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("Page1")) & 1) != 0)
  {
    v4 = 1;
  }
  ...
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("OtherPages")) & 1) != 0)
  {
    v4 = 5;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("HomeScreenDock")))
  {
    v4 = 6;
  }
  else
...
- (int)StringAsRatioType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("AppPanel")) & 1) != 0)
  {
    v4 = 1;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("StaticAppIcon")) & 1) != 0)
  {
    v4 = 2;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("StaticAppIconIncludingEveryAppInFolder")) & 1) != 0)
  {
    v4 = 3;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("Dock")))
  {
    v4 = 4;
  }
  else
...
- (id)description
{
  ...
  -[ATXMPBHomeScreenAppPanelLaunchRatioTracker description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXMPBHomeScreenAppPanelLaunchRatioTracker dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    if (v7 >= 4)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_ratioType);
    ...
    objc_msgSend(v3, "setObject:forKey:", v8, CFSTR("ratioType"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_location != *((_DWORD *)v4 + 2))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_ratioType != *((_DWORD *)v4 + 3))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
