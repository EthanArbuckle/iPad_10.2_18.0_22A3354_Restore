...
- (NSString)identifier
{
  return (NSString *)CFSTR("notificationDigestLoggingEvents");
}

- (ATXUserNotificationDigestBiomeStream)init
{
  return -[ATXUserNotificationDigestBiomeStream initWithStoreConfig:](self, "initWithStoreConfig:", 0);
}

- (ATXUserNotificationDigestBiomeStream)initWithStoreConfig:(id)a3
{
  id v4;
  ATXUserNotificationDigestBiomeStream *v5;
  id v6;
  void *v7;
  uint64_t v8;
  BMStoreStream *inner;
  ...
  v5 = -[ATXUserNotificationDigestBiomeStream init](&v13, sel_init);
  if (v5)
  {
    if (v4)
    {
    ...
    v7 = v6;
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E0D02790]), "initWithPrivateStreamIdentifier:storeConfig:eventDataClass:", CFSTR("notificationDigestLoggingEvents"), v6, objc_opt_class());
    inner = v5->_inner;
...
- (void)sendEvent:(id)a3
{
  ...
  v4 = a3;
  -[ATXUserNotificationDigestBiomeStream source](self, "source");
