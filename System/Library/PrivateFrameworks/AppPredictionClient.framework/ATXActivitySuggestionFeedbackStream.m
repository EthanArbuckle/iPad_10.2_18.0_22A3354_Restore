...
- (NSString)identifier
{
  return (NSString *)CFSTR("ActivitySuggestionFeedback");
}

- (ATXActivitySuggestionFeedbackStream)init
{
  return -[ATXActivitySuggestionFeedbackStream initWithStoreConfig:](self, "initWithStoreConfig:", 0);
}

- (ATXActivitySuggestionFeedbackStream)initWithStoreConfig:(id)a3
{
  id v4;
  ATXActivitySuggestionFeedbackStream *v5;
  id v6;
  void *v7;
  uint64_t v8;
  BMStoreStream *inner;
  ...
  v5 = -[ATXActivitySuggestionFeedbackStream init](&v11, sel_init);
  if (v5)
  {
    if (v4)
    {
    ...
    v7 = v6;
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E0D02790]), "initWithPrivateStreamIdentifier:storeConfig:eventDataClass:", CFSTR("ActivitySuggestionFeedback"), v6, objc_opt_class());
    inner = v5->_inner;
