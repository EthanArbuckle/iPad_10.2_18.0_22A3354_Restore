...
- (id)description
{
  ...
  -[ATXPBDigestOnboardingLoggingEventEnums description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXPBDigestOnboardingLoggingEventEnums dictionaryRepresentation](self, "dictionaryRepresentation");
