...
- (id)description
{
  ...
  -[ATXPBSendMessagesToDigestSuggestion description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ATXPBSendMessagesToDigestSuggestion dictionaryRepresentation](self, "dictionaryRepresentation");
