...
- (id)renderPipelineDescriptorFromLibrary:(id)a3
{
  ...
  v7 = (void *)objc_msgSend(v4, "newFunctionWithName:", CFSTR("fragment_countdown_fillcolor"));
  ...
  -[ARUIRingsCountdownState name](self, "name");
...
- (id)name
{
  return CFSTR("ARUIRingsCountdownState");
}
...
- (BOOL)shouldRunStateForRing:(id)a3
{
  ...
  if (v4 == *(float *)&ARUIRingPercentageValueNoRing || (objc_msgSend(v3, "thickness"), !ARUIFloatGreater(v5, 0.0)))
  {
    v7 = 0;
  }
  else
