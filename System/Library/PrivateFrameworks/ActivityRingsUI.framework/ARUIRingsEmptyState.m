...
- (id)name
{
  return CFSTR("ARUIRingsEmptyState");
}
...
- (id)renderPipelineDescriptorFromLibrary:(id)a3
{
  ...
  v7 = (void *)objc_msgSend(v4, "newFunctionWithName:", CFSTR("fragment_emptycolor"));
  ...
  -[ARUIRingsEmptyState name](self, "name");
