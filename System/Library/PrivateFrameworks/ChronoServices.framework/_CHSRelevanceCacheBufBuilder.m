...
- (_QWORD)initWithBufferBuilder:(_QWORD *)a1
{
  ...
  {
    v10.receiver = a1;
    v10.super_class = (Class)_CHSRelevanceCacheBufBuilder;
...
- (void)dealloc
{
  ...
  -[_CHSRelevanceCacheBufBuilder dealloc](&v4, sel_dealloc);
}
...
- (id)_finish
{
  ...
  {
    v1 = a1;
    objc_msgSend(a1[1], "firstError");
    v2 = (void *)objc_claimAutoreleasedReturnValue();

    if (v2)
      return (id *)&unk_1E2A82AD8;
    a1 = (id *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithUnsignedInt:", apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)objc_msgSend(v1[1], "fbb"), *((_DWORD *)v1[2] + 2)));
  }
  return a1;
}
...
- (void)setArchivedObjects:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 404, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (void)setGroups:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 414, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
