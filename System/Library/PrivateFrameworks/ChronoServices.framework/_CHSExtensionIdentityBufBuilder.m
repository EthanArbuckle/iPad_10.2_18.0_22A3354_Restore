...
- (_QWORD)initWithBufferBuilder:(_QWORD *)a1
{
  ...
  {
    v10.receiver = a1;
    v10.super_class = (Class)_CHSExtensionIdentityBufBuilder;
...
- (void)dealloc
{
  ExtensionIdentityBufBuilder *bldr;
  objc_super v4;
  ...
  -[_CHSExtensionIdentityBufBuilder dealloc](&v4, sel_dealloc);
}
...
- (void)setTokenString:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 866, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (void)setExtensionBundleIdentifier:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 876, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (void)setContainerBundleIdentifier:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 886, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (void)setDeviceIdentifier:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 896, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
