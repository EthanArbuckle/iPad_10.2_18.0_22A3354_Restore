...
- (id)_chsCreateWidgetRelevanceBufUsingBlock:()_CHSWidgetRelevanceBuf
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 1921, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));

  }
  objc_msgSend(a1, "throwIfFinalizedWithSelector:", a2);
  v7 = (id *)-[_CHSWidgetRelevanceBufBuilder initWithBufferBuilder:]([_CHSWidgetRelevanceBufBuilder alloc], a1);
  v5[2](v5, v7);
...
- (id)_chsFinishedBufferWithRootWidgetRelevanceBufOfs:()_CHSWidgetRelevanceBuf error:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v20, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 1943, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
  ...
  {
    v23 = 0;
    v12 = objc_msgSend(a1, "_chsFinishBufferWithRootWidgetRelevanceBufOfs:error:", v7, &v23);
    v13 = v23;
    if (!v12)
    {
      v9 = 0;
  ...
  else
  {
    ...
    v21[1] = 3221225472;
    v21[2] = __98__AFBBufferBuilder__CHSWidgetRelevanceBuf___chsFinishedBufferWithRootWidgetRelevanceBufOfs_error___block_invoke;
...
- (uint64_t)_chsFinishBufferWithRootWidgetRelevanceBufOfs:()_CHSWidgetRelevanceBuf error:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v19, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 1977, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (_QWORD)_chsCreateVectorOfWidgetRelevanceBufWithOffsets:()_CHSWidgetRelevanceBuf
{
  _QWORD *v2;
