...
- (id)_chsCreateRelevanceCacheBufUsingBlock:()_CHSRelevanceCacheBuf
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 435, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));

  }
  objc_msgSend(a1, "throwIfFinalizedWithSelector:", a2);
  v7 = (id *)-[_CHSRelevanceCacheBufBuilder initWithBufferBuilder:]([_CHSRelevanceCacheBufBuilder alloc], a1);
  v5[2](v5, v7);
...
- (id)_chsFinishedBufferWithRootRelevanceCacheBufOfs:()_CHSRelevanceCacheBuf error:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v20, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 457, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
  ...
  {
    v23 = 0;
    v12 = objc_msgSend(a1, "_chsFinishBufferWithRootRelevanceCacheBufOfs:error:", v7, &v23);
    v13 = v23;
    if (!v12)
    {
      v9 = 0;
  ...
  else
  {
    ...
    v21[1] = 3221225472;
    v21[2] = __96__AFBBufferBuilder__CHSRelevanceCacheBuf___chsFinishedBufferWithRootRelevanceCacheBufOfs_error___block_invoke;
...
- (uint64_t)_chsFinishBufferWithRootRelevanceCacheBufOfs:()_CHSRelevanceCacheBuf error:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v19, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 491, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (_QWORD)_chsCreateVectorOfRelevanceCacheBufWithOffsets:()_CHSRelevanceCacheBuf
{
  _QWORD *v2;
