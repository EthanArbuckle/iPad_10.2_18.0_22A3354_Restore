...
- (id)_chsCreateIntentReferenceBufUsingBlock:()_CHSIntentReferenceBuf
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 2443, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("block"));

  }
  objc_msgSend(a1, "throwIfFinalizedWithSelector:", a2);
  v7 = (id *)-[_CHSIntentReferenceBufBuilder initWithBufferBuilder:]([_CHSIntentReferenceBufBuilder alloc], a1);
  v5[2](v5, v7);
...
- (id)_chsFinishedBufferWithRootIntentReferenceBufOfs:()_CHSIntentReferenceBuf error:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v20, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 2465, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
  ...
  {
    v23 = 0;
    v12 = objc_msgSend(a1, "_chsFinishBufferWithRootIntentReferenceBufOfs:error:", v7, &v23);
    v13 = v23;
    if (!v12)
    {
      v9 = 0;
  ...
  else
  {
    ...
    v21[1] = 3221225472;
    v21[2] = __98__AFBBufferBuilder__CHSIntentReferenceBuf___chsFinishedBufferWithRootIntentReferenceBufOfs_error___block_invoke;
...
- (uint64_t)_chsFinishBufferWithRootIntentReferenceBufOfs:()_CHSIntentReferenceBuf error:
{
  ...
  if (!v7)
  {
    ...
    objc_msgSend(v19, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("_CHSRelevanceCache_generated.mm"), 2499, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (_QWORD)_chsCreateVectorOfIntentReferenceBufWithOffsets:()_CHSIntentReferenceBuf
{
  _QWORD *v2;
