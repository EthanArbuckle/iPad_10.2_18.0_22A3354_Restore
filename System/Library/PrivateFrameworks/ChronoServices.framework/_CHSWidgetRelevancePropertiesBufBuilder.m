...
- (_QWORD)initWithBufferBuilder:(_QWORD *)a1
{
  ...
  {
    v10.receiver = a1;
    v10.super_class = (Class)_CHSWidgetRelevancePropertiesBufBuilder;
...
- (void)dealloc
{
  WidgetRelevancePropertiesBufBuilder *bldr;
  objc_super v4;
  ...
  -[_CHSWidgetRelevancePropertiesBufBuilder dealloc](&v4, sel_dealloc);
}
...
- (void)setExtensionIdentity:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 1399, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (void)setKind:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 1409, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
...
- (void)setRelevances:(id)a3
{
  ...
  if (!v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("_CHSRelevanceCache_generated.mm"), 1440, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("ofs"));
  ...
  {
    v7 = v5;
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::Vector<unsigned char>>((apple::aiml::flatbuffers2::FlatBufferBuilder *)self->_bldr->var0, 14, objc_msgSend(v7, "unsignedIntValue"));
