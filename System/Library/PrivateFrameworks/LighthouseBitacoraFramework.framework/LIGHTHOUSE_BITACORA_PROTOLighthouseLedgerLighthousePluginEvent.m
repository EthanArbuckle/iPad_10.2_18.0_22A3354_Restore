...
- (id)description
{
  ...
  -[LIGHTHOUSE_BITACORA_PROTOLighthouseLedgerLighthousePluginEvent description](&v15, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend_dictionaryRepresentation(performTaskStatus, v6, (uint64_t)contextID, v8, v9);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v10, v21, (uint64_t)v20, (uint64_t)CFSTR("performTaskStatus"), v22);

  }
  performTrialTaskStatus = self->_performTrialTaskStatus;
  if (performTrialTaskStatus)
  {
    objc_msgSend_dictionaryRepresentation(performTrialTaskStatus, v6, (uint64_t)contextID, v8, v9);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v10, v25, (uint64_t)v24, (uint64_t)CFSTR("performTrialTaskStatus"), v26);

  }
  stop = self->_stop;
  if (stop)
  {
    objc_msgSend_dictionaryRepresentation(stop, v6, (uint64_t)contextID, v8, v9);
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_setObject_forKey_(v10, v29, (uint64_t)v28, (uint64_t)CFSTR("stop"), v30);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v14 + 16) = v23;
  ...
  v28 = objc_msgSend_copyWithZone_(self->_performTaskStatus, v25, (uint64_t)a3, v26, v27);
  v29 = *(void **)(v14 + 24);
  *(_QWORD *)(v14 + 24) = v28;

  v33 = objc_msgSend_copyWithZone_(self->_performTrialTaskStatus, v30, (uint64_t)a3, v31, v32);
  v34 = *(void **)(v14 + 32);
  *(_QWORD *)(v14 + 32) = v33;

  v38 = objc_msgSend_copyWithZone_(self->_stop, v35, (uint64_t)a3, v36, v37);
  v39 = *(void **)(v14 + 40);
  *(_QWORD *)(v14 + 40) = v38;
...
LABEL_17:
  ...
  if ((unint64_t)stop | v21)
    isEqual = objc_msgSend_isEqual_(stop, v9, v21, v10, v11);
  else
    isEqual = 1;
LABEL_18:
...
- (unint64_t)hash
{
  ...
  v21 = v15 ^ v6 ^ v16 ^ objc_msgSend_hash(self->_performTaskStatus, v11, v12, v13, v14);
  v26 = objc_msgSend_hash(self->_performTrialTaskStatus, v22, v23, v24, v25);
...
{
  objc_storeStrong((id *)&self->_performTaskStatus, a3);
}
...
{
  objc_storeStrong((id *)&self->_performTrialTaskStatus, a3);
}
...
- (void)setStop:(id)a3
{
  objc_storeStrong((id *)&self->_stop, a3);
}
