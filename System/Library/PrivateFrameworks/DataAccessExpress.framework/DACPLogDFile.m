...
- (void)_openFileOutDidCreateNewFile:(BOOL *)a3 outNewFilePath:(id *)a4
{
  ...
  if (v7)
  {
    ...
    if (link(v11, (const char *)objc_msgSend(v12, "fileSystemRepresentation")))
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1B5244000, v13, OS_LOG_TYPE_ERROR, "The log file has been deleted before we had a chance to open it.", buf, 2u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 138412290;
        v22 = v14;
        _os_log_impl(&dword_1B5244000, v15, OS_LOG_TYPE_INFO, "Opened existing log file for writing: %@", buf, 0xCu);
      }
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 67109120;
        LODWORD(v22) = fd;
        _os_log_impl(&dword_1B5244000, v16, OS_LOG_TYPE_INFO, "FD: %d", buf, 8u);
      }
...
- (void)_beginWatchingFile
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v23 = 1024;
    v24 = fd;
    _os_log_impl(&dword_1B5244000, v3, OS_LOG_TYPE_INFO, "Watching file: %@, FD: %d", buf, 0x12u);
  }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134217984;
    v22 = v8;
    _os_log_impl(&dword_1B5244000, v11, OS_LOG_TYPE_INFO, "Created new dispatch source %p", buf, 0xCu);
  }
...
void __34__DACPLogDFile__beginWatchingFile__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138412290;
    v9 = v3;
    _os_log_impl(&dword_1B5244000, v2, OS_LOG_TYPE_INFO, "Received file event for file %@", (uint8_t *)&v8, 0xCu);
  }
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138412290;
      v9 = v7;
      _os_log_impl(&dword_1B5244000, v6, OS_LOG_TYPE_INFO, "Log file has been deleted: %@", (uint8_t *)&v8, 0xCu);
    }
...
uint64_t __34__DACPLogDFile__beginWatchingFile__block_invoke_18(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v5[0] = 67109120;
    v5[1] = v3;
    _os_log_impl(&dword_1B5244000, v2, OS_LOG_TYPE_INFO, "Closing FD %d", (uint8_t *)v5, 8u);
  }
...
- (void)_closeFileWithFileEventDispatchSource:(id)a3
{
  ...
  if ((self->_fd & 0x80000000) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 1024;
      v12 = fd;
      _os_log_impl(&dword_1B5244000, v5, OS_LOG_TYPE_INFO, "Closing file at %@, FD %d", (uint8_t *)&v9, 0x12u);
    }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf.st_mode = folder;
      _os_log_impl(&dword_1B5244000, v6, OS_LOG_TYPE_ERROR, "The file at path %@ is not a directory.", (uint8_t *)&buf, 0xCu);
    }
    goto LABEL_32;
  }
  if ((v4 & 1) == 0)
  {
    ...
    if ((v9 & 1) == 0)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(__darwin_ino64_t *)((char *)&buf.st_ino + 6) = (__darwin_ino64_t)v10;
        _os_log_impl(&dword_1B5244000, v12, OS_LOG_TYPE_ERROR, "Cannot create directory %@. Error: %@", (uint8_t *)&buf, 0x16u);
      }
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf.st_mode = v13;
      _os_log_impl(&dword_1B5244000, v12, OS_LOG_TYPE_INFO, "Created directory at path: %@", (uint8_t *)&buf, 0xCu);
    }
  ...
  if ((objc_msgSend(v3, "createFileAtPath:contents:attributes:", v6, 0, v10) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf.st_mode = v6;
      _os_log_impl(&dword_1B5244000, v32, OS_LOG_TYPE_ERROR, "Cannot create temporary linked file at %@", (uint8_t *)&buf, 0xCu);
    }
...
LABEL_13:
  ...
  if (v14 < 0)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      buf.st_dev = 138412290;
      *(_QWORD *)&buf.st_mode = v6;
      _os_log_impl(&dword_1B5244000, v31, OS_LOG_TYPE_ERROR, "Cannot create temporary linked file at %@", (uint8_t *)&buf, 0xCu);
    }
  ...
  if ((_DWORD)v20)
  {
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf.st_mode = v26;
      _os_log_impl(&dword_1B5244000, v25, OS_LOG_TYPE_ERROR, "Cannot link file to path %@", (uint8_t *)&buf, 0xCu);
    }
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&buf.st_mode = v34;
    _os_log_impl(&dword_1B5244000, v25, OS_LOG_TYPE_INFO, "Created new log file %@.", (uint8_t *)&buf, 0xCu);
  }
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&buf.st_mode = fd;
    _os_log_impl(&dword_1B5244000, v35, OS_LOG_TYPE_INFO, "FD: %d", (uint8_t *)&buf, 8u);
  }
...
LABEL_51:
    ...
    else
    {
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&v56[8] = 2112;
        *(_QWORD *)&v56[10] = v46;
        _os_log_impl(&dword_1B5244000, v43, OS_LOG_TYPE_INFO, "Created symlink link: %@. Destination: %@", v55, 0x16u);
      }
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)&v56[16] = v47;
        ...
        v52 = 28;
LABEL_52:
        _os_log_impl(&dword_1B5244000, v51, OS_LOG_TYPE_ERROR, v45, v55, v52);
        goto LABEL_53;
      }
    }
    goto LABEL_53;
...
LABEL_3:
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v46 = path;
      _os_log_impl(&dword_1B5244000, v12, OS_LOG_TYPE_INFO, "Checking size of log file at path %@", buf, 0xCu);
    }
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v47 = 2112;
        v48 = v17;
        _os_log_impl(&dword_1B5244000, v18, OS_LOG_TYPE_ERROR, "Cannot get attributes of file at path %@. Error: %@", buf, 0x16u);
      }
      ...
      if ((a3 & 0x8000000000000000) == 0 && objc_msgSend(v16, "fileSize") > (unint64_t)a3)
      {
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)buf = 138412290;
            v46 = v40;
            _os_log_impl(&dword_1B5244000, v23, OS_LOG_TYPE_INFO, "Compressing file at %@", buf, 0xCu);
          }
            ...
            if (v31)
            {
              ...
              if (v32)
              {
                ...
                if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
                {
                  *(_DWORD *)buf = 67109120;
                  LODWORD(v46) = v33;
                  _os_log_impl(&dword_1B5244000, v34, OS_LOG_TYPE_ERROR, "Could not compress file. Status: %d", buf, 8u);
                }
                v26 = v37;
              }
              else
                ...
                if (v36)
                {
                  ...
                  if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
                  {
                    *(_DWORD *)buf = 138412802;
                    ...
                    v49 = 2112;
                    v50 = v36;
                    _os_log_impl(&dword_1B5244000, v35, OS_LOG_TYPE_ERROR, "Could not move compressed file from %@ to %@. Error: %@", buf, 0x20u);
                  }
