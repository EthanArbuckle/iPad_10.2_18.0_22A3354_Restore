...
void __DACPLoggingAppendDataToLogFile_block_invoke_3(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    *(_WORD *)buf = 0;
    ...
    v12 = 2;
LABEL_13:
    _os_log_impl(&dword_1B5244000, v11, OS_LOG_TYPE_ERROR, v10, buf, v12);
    goto LABEL_37;
  }
  v3 = (_QWORD *)v2[8];
  if (!v3)
...
LABEL_15:
  ...
  if (v16 >= 3)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412290;
      *(_QWORD *)&buf[4] = v25;
      _os_log_impl(&dword_1B5244000, v24, OS_LOG_TYPE_ERROR, "Can't append data to log file, even after retrying. Giving up. Facilities: %@", buf, 0xCu);
    }
  }
  v26 = v2[6];
  if (v26 && v30)
