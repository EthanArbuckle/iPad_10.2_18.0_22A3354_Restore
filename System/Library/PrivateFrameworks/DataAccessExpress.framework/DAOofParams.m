...
- (id)dictionaryRepresentationForASSettingTask
{
  ...
  if (v14)
  {
    ...
    objc_msgSend(v15, "setObject:forKeyedSubscript:", &unk_1E68E56C0, CFSTR("kDASettingsAudienceKey"));
    objc_msgSend(v15, "setObject:forKeyedSubscript:", &unk_1E68E56D8, CFSTR("kDASettingsEnabledKey"));
    -[DAOofParams message](self, "message");
  ...
  if (v17)
  {
    ...
    objc_msgSend(v18, "setObject:forKeyedSubscript:", &unk_1E68E56D8, CFSTR("kDASettingsAudienceKey"));
    ...
    objc_msgSend(v21, "setObject:forKeyedSubscript:", &unk_1E68E56F0, CFSTR("kDASettingsAudienceKey"));
