...
- (void)finishedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v17 = 2114;
    v18 = accountID;
    _os_log_impl(&dword_1B5244000, v5, OS_LOG_TYPE_DEBUG, "Share of calendar ID %@ for account %{public}@ completed.", buf, 0x16u);
  }
...
void __45__DASharedCalendarContext_finishedWithError___block_invoke(uint64_t a1)
{
  ...
  +[DADConnection sharedConnection](DADConnection, "sharedConnection");
...
{
  __assert_rtn("-[DASharedCalendarContext initWithCalendarID:accountID:queue:completionBlock:]", "DADConnection.m", 257, "calendarID");
}

- (void)initWithCalendarID:accountID:queue:completionBlock:.cold.2()
{
  __assert_rtn("-[DASharedCalendarContext initWithCalendarID:accountID:queue:completionBlock:]", "DADConnection.m", 258, "accountID");
}
