...
- (id)initFolderChangeWithChangeType:(unint64_t)a3 folderId:(id)a4 parentFolderId:(id)a5 displayName:(id)a6 dataclass:(int64_t)a7 consumer:(id)a8
{
  ...
  if (a7 != 1)
  {
    ...
    objc_msgSend(v28, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAFolderChange.m"), 22, CFSTR("Only email folder manipulation is allowed at this time"));
  ...
  if (a3 == 1)
  {
    ...
    else
    {
      ...
      objc_msgSend(v31, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAFolderChange.m"), 30, CFSTR("Modify change types require a folder id"));
  ...
  objc_msgSend(v30, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAFolderChange.m"), 26, CFSTR("Add change types require a parent id"));
...
LABEL_16:
  if (objc_msgSend(v17, "isEqualToString:", CFSTR("70FB9178-576E-4CAA-A08E-F68D57BFD01E")))
  {
    ...
    objc_msgSend(v29, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAFolderChange.m"), 44, CFSTR("Don't push changes to the temp inbox"));
...
- (DAFolderChange)initWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v5, "allowsKeyedCoding") & 1) == 0)
  {
    ...
    objc_msgSend(v11, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAFolderChange.m"), 67, CFSTR("Who does non-keyed coding nowadays?"));

  }
  v12.receiver = self;
  v12.super_class = (Class)DAFolderChange;
  v6 = -[DAFolderChange init](&v12, sel_init);
  if (v6)
  {
    -[DAFolderChange setChangeType:](v6, "setChangeType:", (int)objc_msgSend(v5, "decodeIntForKey:", CFSTR("DAFCChangeType")));
    objc_msgSend(v5, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("DAFCFolderId"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAFolderChange setFolderId:](v6, "setFolderId:", v7);

    objc_msgSend(v5, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("DAFCParentFolderId"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAFolderChange setParentFolderId:](v6, "setParentFolderId:", v8);

    objc_msgSend(v5, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("DAFCDisplayName"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[DAFolderChange setDisplayName:](v6, "setDisplayName:", v9);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v9, "allowsKeyedCoding") & 1) == 0)
  {
    objc_msgSend(MEMORY[0x1E0CB3488], "currentHandler");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("DAFolderChange.m"), 82, CFSTR("Who does non-keyed coding nowadays?"));
