...
- (id)_getUUIDForFolder:(id)a3 baseName:(id)a4
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1B5244000, v5, OS_LOG_TYPE_INFO, "Handling getUUIDForPath", buf, 2u);
  }
  ...
  *(_QWORD *)buf = 0;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)v66 = 138412290;
    v67 = v46;
    _os_log_impl(&dword_1B5244000, v6, OS_LOG_TYPE_INFO, "Testing requested log folder %@", v66, 0xCu);
  }
  ...
  if (v44)
  {
    ...
    v55 = 0;
    v9 = -[DACPLogShared _array:beginsWithArray:outRemainingArray:](self, "_array:beginsWithArray:outRemainingArray:", v8, &unk_1E68E5778, &v55);
    v10 = v55;
    v11 = v10;
    v45 = (void *)v8;
    if (!v9)
    {
      v54 = v10;
      v12 = -[DACPLogShared _array:beginsWithArray:outRemainingArray:](self, "_array:beginsWithArray:outRemainingArray:", v8, &unk_1E68E5790, &v54);
      v13 = v54;
      ...
      {
        v53 = v13;
        v15 = -[DACPLogShared _array:beginsWithArray:outRemainingArray:](self, "_array:beginsWithArray:outRemainingArray:", v45, &unk_1E68E57A8, &v53);
        v41 = v53;
        ...
        if (!v15)
        {
              ...
              if (v24)
              {
                ...
                if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
                {
                  *(_DWORD *)v66 = 136315138;
                  v67 = v21;
                  _os_log_impl(&dword_1B5244000, v26, OS_LOG_TYPE_INFO, "Matched client home directory: %s", v66, 0xCu);
                }
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)v66 = 138412290;
            v67 = v46;
            _os_log_impl(&dword_1B5244000, v25, OS_LOG_TYPE_ERROR, "The path %@ does not begin with the caller's home directory.", v66, 0xCu);
          }
...
LABEL_31:
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)v66 = 138412290;
      v67 = (char *)v11;
      _os_log_impl(&dword_1B5244000, v27, OS_LOG_TYPE_INFO, "Requested path into client home directory: %@", v66, 0xCu);
    }
      ...
      if ((objc_msgSend(v28, "isEqualToString:", CFSTR("Library")) & 1) != 0)
      {
        ...
        if ((v30 & 1) != 0)
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)v66 = 138412290;
            v67 = v32;
            _os_log_impl(&dword_1B5244000, v33, OS_LOG_TYPE_INFO, "Resolved log file folder to %@", v66, 0xCu);
          }
...
LABEL_46:
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)v66 = 138412290;
      v67 = v46;
      _os_log_impl(&dword_1B5244000, v37, OS_LOG_TYPE_ERROR, "Log folder: “%@” must begin with /Library/Logs in the user’s home directory.", v66, 0xCu);
    }
  ...
  {
    *(_WORD *)v66 = 0;
    _os_log_impl(&dword_1B5244000, v14, OS_LOG_TYPE_ERROR, "Could not resolve client home directory. Not granting access to write logs.", v66, 2u);
  }
  ...
  if (*((_BYTE *)v57 + 24))
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)v66 = 138412546;
      ...
      v68 = 2112;
      v69 = v43;
      _os_log_impl(&dword_1B5244000, v38, OS_LOG_TYPE_ERROR, "Get UUID for for folder resulted in an error. Folder: %@. Basename: %@.", v66, 0x16u);
    }
...
void __44__DACPLogShared__getUUIDForFolder_baseName___block_invoke()
{
  ...
  if (!_getUUIDForFolder_baseName__homeDirComponents)
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_impl(&dword_1B5244000, v3, OS_LOG_TYPE_DEFAULT, "Could not resolve home directory. Falling back to /var/mobile.", v6, 2u);
    }
...
void __44__DACPLogShared__getUUIDForFolder_baseName___block_invoke_100(_QWORD *a1)
{
    ...
    if (!v34)
    {
      ...
      if (os_log_type_enabled(v3, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412290;
        v37 = v4;
        _os_log_impl(&dword_1B5244000, v3, OS_LOG_TYPE_ERROR, "Folder path %@ does not refer to a directory.", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (v8)
    {
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v38 = 2112;
        v39 = v8;
        _os_log_impl(&dword_1B5244000, v10, OS_LOG_TYPE_ERROR, "Could not create directory %@. Error: %@", buf, 0x16u);
      }
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v37 = v12;
      _os_log_impl(&dword_1B5244000, v10, OS_LOG_TYPE_INFO, "Created directory at path: %@", buf, 0xCu);
    }
...
- (BOOL)_logData:(id)a3 UUID:(id)a4 startNewFile:(BOOL)a5 sizeCheck:(int64_t)a6 wantsCompressed:(BOOL)a7 maxFileCount:(int64_t)a8 outDidCreateNewFile:(BOOL *)a9 outNewFilePath:(id *)a10
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1B5244000, v16, OS_LOG_TYPE_INFO, "Handling logData", buf, 2u);
  }
  ...
  if (*((_BYTE *)v52 + 24))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)v55 = 138412290;
      v56 = v18;
      _os_log_impl(&dword_1B5244000, v20, OS_LOG_TYPE_ERROR, "Log data resulted in an error. UUID: %@.", v55, 0xCu);
    }
...
void __118__DACPLogShared__logData_UUID_startNewFile_sizeCheck_wantsCompressed_maxFileCount_outDidCreateNewFile_outNewFilePath___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_1B5244000, v7, OS_LOG_TYPE_ERROR, "Cannot find UUID. Asking client to retry.", buf, 2u);
    }
...
- (BOOL)_slurpToFileUUID:(id)a3 slurpeeFileDescriptor:(int)a4 prefix:(id)a5 suffix:(id)a6 startNewFile:(BOOL)a7 sizeCheck:(int64_t)a8 wantsCompressed:(BOOL)a9 maxLogFileCount:(int)a10 outDidCreateNewFile:(BOOL *)a11 outNewFilePath:(id *)a12
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1B5244000, v21, OS_LOG_TYPE_INFO, "Handling slurpFile", buf, 2u);
  }
  ...
  *(_QWORD *)buf = 0;
  ...
  if (*((_BYTE *)v63 + 24))
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)v66 = 138412290;
      v67 = v27;
      _os_log_impl(&dword_1B5244000, v30, OS_LOG_TYPE_ERROR, "Slurp to file UUID resulted in an error. UUID: %@.", v66, 0xCu);
    }
...
LABEL_20:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1B5244000, v10, OS_LOG_TYPE_ERROR, "Cannot find UUID. Asking client to retry.", buf, 2u);
  }
