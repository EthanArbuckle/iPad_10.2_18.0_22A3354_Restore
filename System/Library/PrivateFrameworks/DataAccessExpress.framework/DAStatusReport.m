...
- (DAStatusReport)initWithDictionaryRepresentation:(id)a3
{
  ...
  v5 = -[DAStatusReport init](&v25, sel_init);
  if (v5)
  {
  ...
  if (v5)
  {
    ...
    if ((v9 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v104 = 2112;
        v105 = v4;
        _os_log_impl(&dword_1B5244000, v10, OS_LOG_TYPE_ERROR, "Why are we combining status reports for different accounts? %@ vs. %@", (uint8_t *)&v102, 0x16u);
      }
  ...
  if (v15)
  {
    ...
    if ((v19 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v104 = 2112;
        v105 = v4;
        _os_log_impl(&dword_1B5244000, v20, OS_LOG_TYPE_ERROR, "Why are we combining status reports for different accounts? %@ vs. %@", (uint8_t *)&v102, 0x16u);
      }
  ...
  if (v81)
  {
    ...
    if ((v85 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
      {
        ...
        v102 = 138412290;
        v103 = v87;
        _os_log_impl(&dword_1B5244000, v86, OS_LOG_TYPE_INFO, "Protocol version is updated to %@", (uint8_t *)&v102, 0xCu);
