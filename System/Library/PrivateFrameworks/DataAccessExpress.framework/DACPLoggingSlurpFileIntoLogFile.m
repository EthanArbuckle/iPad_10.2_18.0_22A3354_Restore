...
LABEL_8:
  ...
  do
  {
    if (v8 || (_workQueueRefreshUUIDForWorkSettings(v1), (v8 = *(_QWORD *)(v1[8] + 8)) != 0))
    {
      ...
      v11 = *((_DWORD *)v1 + 8);
      v12 = malloc_type_malloc(0xC8uLL, 0xBA563EBEuLL);
      if (!v12)
      {
      ...
      while (!CFStringGetCString(v2, (char *)v13, v14, 0x8000100u))
      {
        ...
        {
          v14 *= 2;
          v13 = malloc_type_malloc(v14, 0xC641BD2EuLL);
          if (v13)
            continue;
        }
  ...
  if (v7 >= 3)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)cf = 138412290;
      *(_QWORD *)&cf[4] = v20;
      _os_log_impl(&dword_1B5244000, v19, OS_LOG_TYPE_ERROR, "Can't slurp lookaside file into log file, even after retrying. Giving up. Facilities: %@", cf, 0xCu);
    }
  }
  v21 = v1[6];
  if (v21 && v31)
...
void __DACPLoggingSlurpFileIntoLogFile_block_invoke_2_cold_1(const __CFString *a1)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1B5244000, v2, OS_LOG_TYPE_ERROR, "Cannot encode string into UTF-8.", buf, 2u);
  }
  Length = CFStringGetLength(a1);
  if (Length)
  {
    v4 = Length;
    v5 = (UniChar *)malloc_type_malloc(2 * Length, 0x5E7D1832uLL);
    if (v5)
    {
      v6 = v5;
      v15.location = 0;
      ...
      if (Mutable)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138412290;
          v13 = v8;
          _os_log_impl(&dword_1B5244000, v11, OS_LOG_TYPE_ERROR, "%@", buf, 0xCu);
        }
        CFRelease(v8);
      }
      free(v6);
...
void __DACPLoggingSlurpFileIntoLogFile_block_invoke_2_cold_2()
{
  ...
  {
    *(_WORD *)v1 = 0;
    _os_log_impl(&dword_1B5244000, v0, OS_LOG_TYPE_ERROR, "Could not allocate buffer for logging.", v1, 2u);
  }
}
