...
- (void)updateProgressDownloadedByteCount:(int64_t)a3 totalByteCount:(int64_t)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    v20 = 2048;
    v21 = a4;
    _os_log_impl(&dword_1B5244000, v7, OS_LOG_TYPE_DEBUG, "Download of attachment UUID %@ for accountID %{public}@ progress: %lld bytes of %lld", buf, 0x2Au);
  }
...
- (void)finishedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v15 = 2114;
    v16 = accountID;
    _os_log_impl(&dword_1B5244000, v5, OS_LOG_TYPE_DEBUG, "Download of attachment UUID %@ for account %{public}@ completed.", buf, 0x16u);
  }
...
{
  __assert_rtn("-[DADownloadContext initWithAttachmentUUID:accountID:queue:downloadProgressBlock:completionBlock:]", "DADConnection.m", 192, "attachmentUUID");
}

- (void)initWithAttachmentUUID:accountID:queue:downloadProgressBlock:completionBlock:.cold.2()
{
  __assert_rtn("-[DADownloadContext initWithAttachmentUUID:accountID:queue:downloadProgressBlock:completionBlock:]", "DADConnection.m", 193, "accountID");
}
