...
- (PASUIMicaPlayer)initWithFileName:(id)a3 retinaScale:(double)a4
{
  ...
  if (v8)
  {
    ...
    v9 = (PASUIMicaPlayer *)objc_claimAutoreleasedReturnValue();
    v10 = -[PASUIMicaPlayer initWithPath:retinaScale:](self, "initWithPath:retinaScale:", v9, a4);
    self = v9;
  }
  else
  {
...
- (PASUIMicaPlayer)initWithPath:(id)a3 retinaScale:(double)a4
{
  ...
  v6 = a3;
  +[PASUIMicaPlayer rootDictForPath:](PASUIMicaPlayer, "rootDictForPath:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = v7;
  if (!v7
...
LABEL_6:
  ...
  v10 = v9;
  objc_msgSend(v9, "setGeometryFlipped:", +[PASUIMicaPlayer BOOLFromDictionary:key:defaultValue:](PASUIMicaPlayer, "BOOLFromDictionary:key:defaultValue:", v8, CFSTR("geometryFlipped"), 0) ^ 1);
  ...
  v13 = -[PASUIMicaPlayer initWithPath:retinaScale:rootLayer:publishedObjects:](self, "initWithPath:retinaScale:rootLayer:publishedObjects:", v6, v10, v12, a4);
...
- (PASUIMicaPlayer)initWithPath:(id)a3 retinaScale:(double)a4 rootLayer:(id)a5 publishedObjects:(id)a6
{
  ...
  v13 = -[PASUIMicaPlayer init](&v17, sel_init);
  v14 = v13;
  if (v13)
  {
    -[PASUIMicaPlayer setPath:](v13, "setPath:", v10);
    -[PASUIMicaPlayer setRootLayer:](v14, "setRootLayer:", v11);
    -[PASUIMicaPlayer setPublishedObjects:](v14, "setPublishedObjects:", v12);
    LODWORD(v15) = 1.0;
    -[PASUIMicaPlayer setPreferredPlaybackSpeed:](v14, "setPreferredPlaybackSpeed:", v15);
    -[PASUIMicaPlayer setRetinaScale:](v14, "setRetinaScale:", a4);
...
- (void)dealloc
{
  ...
  -[PASUIMicaPlayer stopPlayTimer](self, "stopPlayTimer");
  v3.receiver = self;
  v3.super_class = (Class)PASUIMicaPlayer;
  -[PASUIMicaPlayer dealloc](&v3, sel_dealloc);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[PASUIMicaPlayer path](self, "path");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(v5, "copy");

  -[PASUIMicaPlayer rootLayer](self, "rootLayer");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v7, "mp_deepCopyLayer");

  -[PASUIMicaPlayer publishedObjects](self, "publishedObjects");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[PASUIMicaPlayer rootLayer](self, "rootLayer");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  +[PASUIMicaPlayer updatePublishedObjects:toReferenceLayersInTree:ratherThanLayersInTree:](PASUIMicaPlayer, "updatePublishedObjects:toReferenceLayersInTree:ratherThanLayersInTree:", v9, v8, v10);
  v11 = (void *)objc_claimAutoreleasedReturnValue();

  v12 = (void *)objc_msgSend((id)objc_opt_class(), "allocWithZone:", a3);
  -[PASUIMicaPlayer retinaScale](self, "retinaScale");
...
- (void)addToLayer:(id)a3 onTop:(BOOL)a4 gravity:(id)a5
{
  ...
  if (!v9)
  {
    -[PASUIMicaPlayer pause](self, "pause");
    -[PASUIMicaPlayer setPlaybackTime:](self, "setPlaybackTime:", 0.0);
    -[PASUIMicaPlayer moveAndResizeWithinParentLayer:usingGravity:animate:](self, "moveAndResizeWithinParentLayer:usingGravity:animate:", v11, v8, 0);
...
- (id)publishedLayerWithKey:(id)a3 required:(BOOL)a4
{
  ...
  -[PASUIMicaPlayer publishedObjectWithKey:required:](self, "publishedObjectWithKey:required:", a3, a4);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4)
  {
    objc_opt_class();
...
- (void)play
{
  ...
  if (!-[PASUIMicaPlayer isPlaying](self, "isPlaying"))
  {
    v3 = CACurrentMediaTime();
    -[PASUIMicaPlayer playbackTime](self, "playbackTime");
    ...
    *(float *)&v5 = self->_preferredPlaybackSpeed;
    ...
    -[PASUIMicaPlayer startPlayTimerIfNeeded](self, "startPlayTimerIfNeeded");
    -[PASUIMicaPlayer notifyDelegateDidStartPlaying](self, "notifyDelegateDidStartPlaying");
  }
}
...
- (void)pause
{
  ...
  if (-[PASUIMicaPlayer isPlaying](self, "isPlaying"))
  {
    ...
    -[PASUIMicaPlayer stopPlayTimer](self, "stopPlayTimer");
    -[PASUIMicaPlayer notifyDelegateDidStopPlaying](self, "notifyDelegateDidStopPlaying");
  }
}
...
- (void)setPlaybackTime:(double)a3
{
  ...
  v5 = -[PASUIMicaPlayer isPlaying](self, "isPlaying");
  v6 = 0.0;
  if (v5)
  {
  ...
  -[PASUIMicaPlayer notifyDelegateDidChangePlaybackTime](self, "notifyDelegateDidChangePlaybackTime");
}
...
- (BOOL)isPlaybackAtEnd
{
  ...
  -[PASUIMicaPlayer playbackTime](self, "playbackTime");
  v4 = v3;
  -[PASUIMicaPlayer documentDuration](self, "documentDuration");
  return v4 >= v5 + -0.001;
}
...
- (void)setDelegate:(id)a3
{
  ...
  if (-[PASUIMicaPlayer isTimerNeeded](self, "isTimerNeeded"))
    -[PASUIMicaPlayer startPlayTimerIfNeeded](self, "startPlayTimerIfNeeded");
  else
    -[PASUIMicaPlayer stopPlayTimer](self, "stopPlayTimer");
}
...
{
  PASUIMicaPlayerDelegate **p_delegate;
  id WeakRetained;
  void *v5;
  id v6;
  char v7;
  ...
  if (WeakRetained)
  {
    ...
    if ((v7 & 1) != 0)
    {
      ...
      objc_msgSend(v8, "PASUIMicaPlayerDidStartPlaying:", self);
...
- (void)notifyDelegateDidStopPlaying
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v8 = objc_loadWeakRetained((id *)p_delegate);
      objc_msgSend(v8, "PASUIMicaPlayerDidStopPlaying:", self);
...
- (void)notifyDelegateDidChangePlaybackTime
{
  ...
  if (!-[PASUIMicaPlayer isNotifyingDelegate](self, "isNotifyingDelegate"))
  {
    WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
    if (WeakRetained)
    {
      ...
      if ((v6 & 1) != 0)
      {
        -[PASUIMicaPlayer setIsNotifyingDelegate:](self, "setIsNotifyingDelegate:", 1);
        v7 = objc_loadWeakRetained((id *)&self->_delegate);
        objc_msgSend(v7, "PASUIMicaPlayerDidChangePlaybackTime:", self);

        -[PASUIMicaPlayer setIsNotifyingDelegate:](self, "setIsNotifyingDelegate:", 0);
      }
    }
  }
}
...
- (BOOL)isTimerNeeded
{
  ...
  if (-[PASUIMicaPlayer isPlaying](self, "isPlaying"))
  {
    ...
    if (v3 == INFINITY)
    {
      -[PASUIMicaPlayer delegate](self, "delegate");
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      if (v5)
      {
        -[PASUIMicaPlayer delegate](self, "delegate");
...
{
  if (-[PASUIMicaPlayer isPlaybackAtEnd](self, "isPlaybackAtEnd", a3))
  {
...
{
  return (PASUIMicaPlayerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
