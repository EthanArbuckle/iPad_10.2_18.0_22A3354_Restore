...
{
  objc_msgSend(MEMORY[0x24BDBCE88], "raise:format:", *MEMORY[0x24BDBCAB0], CFSTR("+[ISSSURLBag URLBagForContext:] is not supported"));
  return 0;
}
...
- (id)valueForKey:(id)a3 error:(id *)a4
{
  ...
  v8 = v7;
  v13 = v8;
  -[ISSSURLBag loadValueForKey:completionBlock:](self, "loadValueForKey:completionBlock:", v6, v12);
...
void __35__ISSSURLBag_existingBagDictionary__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
void __34__ISSSURLBag_storeFrontIdentifier__block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (void)_enqueueOperationWithContext:(id)a3 completionBlock:(id)a4
{
  ...
  v12 = (void *)MEMORY[0x20BD37BD4](v8);
  ...
  if (!self->_operation)
  {
    ...
    v14 = -[ISLoadURLBagOperation initWithBagContext:]([ISLoadURLBagOperation alloc], "initWithBagContext:", v6);
    ...
    +[ISOperationQueue mainQueue](ISOperationQueue, "mainQueue", v18, v19, v20, v21);
