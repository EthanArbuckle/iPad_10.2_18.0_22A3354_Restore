...
- (id)description
{
  ...
  -[ChannelActivityPollingResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ChannelActivityPollingResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  if (-[ChannelActivityPollingResponse participantPayloadsCount](self, "participantPayloadsCount"))
  {
    objc_msgSend(v11, "clearParticipantPayloads");
    v6 = -[ChannelActivityPollingResponse participantPayloadsCount](self, "participantPayloadsCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        -[ChannelActivityPollingResponse participantPayloadAtIndex:](self, "participantPayloadAtIndex:", i);
        v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 0x10) != 0)
  {
    if ((*((_BYTE *)v4 + 56) & 0x10) == 0 || self->_status != *((_DWORD *)v4 + 10))
      goto LABEL_37;
  }
  ...
  if ((has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 56) & 1) == 0 || self->_serverTimestampSeconds != *((_QWORD *)v4 + 1))
      goto LABEL_37;
  }
  ...
  if ((has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 56) & 2) == 0 || self->_version != *((_QWORD *)v4 + 2))
      goto LABEL_37;
  }
  ...
  participantPayloads = self->_participantPayloads;
  if ((unint64_t)participantPayloads | *((_QWORD *)v4 + 3))
  {
...
LABEL_23:
  if ((has & 4) != 0)
  {
    if ((*((_BYTE *)v4 + 56) & 4) == 0 || self->_responseMessageIndex != *((_DWORD *)v4 + 8))
      goto LABEL_37;
  }
  ...
  if ((has & 0x20) != 0)
  {
    if ((*((_BYTE *)v4 + 56) & 0x20) == 0 || self->_totalResponseMessages != *((_DWORD *)v4 + 11))
      goto LABEL_37;
  }
  ...
  if ((has & 8) != 0)
  {
    if ((*((_BYTE *)v4 + 56) & 8) == 0 || self->_retryIntervalSeconds != *((_DWORD *)v4 + 9))
      goto LABEL_37;
    v8 = 1;
  }
LABEL_38:
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        -[ChannelActivityPollingResponse addParticipantPayload:](self, "addParticipantPayload:", *(_QWORD *)(*((_QWORD *)&v13 + 1) + 8 * i), (_QWORD)v13);
      }
