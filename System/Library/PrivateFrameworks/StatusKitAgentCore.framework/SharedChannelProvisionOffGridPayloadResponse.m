...
- (id)description
{
  ...
  -[SharedChannelProvisionOffGridPayloadResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SharedChannelProvisionOffGridPayloadResponse dictionaryRepresentation](self, "dictionaryRepresentation");
