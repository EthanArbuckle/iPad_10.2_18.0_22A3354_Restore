...
- (SKAStatusPublishingServiceClientConnection)initWithXPCConnection:(id)a3 queue:(id)a4 daemonProtocolDelegate:(id)a5 connectionLifecycleDelegate:(id)a6
{
  ...
  id v13;
  id v14;
  SKAStatusPublishingServiceClientConnection *v15;
  SKAStatusPublishingServiceClientConnection *v16;
  void *v17;
  void *v18;
  uint64_t v19;
  uint64_t v21;
  ...
  v32.receiver = self;
  v32.super_class = (Class)SKAStatusPublishingServiceClientConnection;
  v15 = -[SKAStatusPublishingServiceClientConnection init](&v32, sel_init);
  v16 = v15;
  if (v15)
  {
    objc_storeWeak((id *)&v15->_connectionLifecycleDelegate, v14);
    objc_storeStrong((id *)&v16->_xpcConnection, a3);
    objc_msgSend(MEMORY[0x24BEB10A0], "daemonXPCInterface");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "setExportedInterface:", v17);

    objc_msgSend(v11, "setExportedObject:", v13);
    objc_msgSend(MEMORY[0x24BEB10A0], "daemonDelegateXPCInterface");
    ...
    v21 = v19;
    v22 = 3221225472;
    v23 = __125__SKAStatusPublishingServiceClientConnection_initWithXPCConnection_queue_daemonProtocolDelegate_connectionLifecycleDelegate___block_invoke_2;
    v24 = &unk_24D976438;
...
void __125__SKAStatusPublishingServiceClientConnection_initWithXPCConnection_queue_daemonProtocolDelegate_connectionLifecycleDelegate___block_invoke(uint64_t a1)
{
  ...
  +[SKAStatusPublishingServiceClientConnection logger](SKAStatusPublishingServiceClientConnection, "logger");
  ...
  objc_msgSend(v5, "publishingServiceClientConnectionWasInterrupted:", WeakRetained);
...
void __125__SKAStatusPublishingServiceClientConnection_initWithXPCConnection_queue_daemonProtocolDelegate_connectionLifecycleDelegate___block_invoke_2(uint64_t a1)
{
  ...
  objc_msgSend(WeakRetained, "connectionLifecycleDelegate");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "publishingServiceClientConnectionWasInvalidated:", WeakRetained);
...
- (id)asynchronousRemoteDaemonDelegateWithErrorHandler:(id)a3
{
  ...
  v4 = a3;
  -[SKAStatusPublishingServiceClientConnection xpcConnection](self, "xpcConnection");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)dealloc
{
  ...
  objc_super v4;
  uint8_t buf[4];
  SKAStatusPublishingServiceClientConnection *v6;
  uint64_t v7;
  ...
  -[SKAStatusPublishingServiceClientConnection dealloc](&v4, sel_dealloc);
}
...
+ (BOOL)clientIsEntitledForAtLeastOnePublishingServiceType:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "sk_stringArrayValueForEntitlement:", CFSTR("com.apple.StatusKit.publish.types"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v4, "count")
    || (objc_msgSend(v3, "sk_BOOLeanValueForEntitlement:", CFSTR("com.apple.StatusKit.publish.allTypes")) & 1) != 0)
  {
    v5 = 1;
  }
  else
...
{
  return +[SKAStatusPublishingServiceClientConnection _connection:isEntitledForPublishingWithStatusTypeIdentifier:](SKAStatusPublishingServiceClientConnection, "_connection:isEntitledForPublishingWithStatusTypeIdentifier:", self->_xpcConnection, a3);
}
...
+ (BOOL)_connection:(id)a3 isEntitledForPublishingWithStatusTypeIdentifier:(id)a4
{
  ...
  if (objc_msgSend(v6, "length")
    && (objc_msgSend(v5, "sk_stringArrayValueForEntitlement:", CFSTR("com.apple.StatusKit.publish.types")),
        v7 = (void *)objc_claimAutoreleasedReturnValue(),
        v8 = objc_msgSend(v7, "containsObject:", v6),
        v7,
        (v8 & 1) != 0)
    || objc_msgSend(v6, "length")
    && (objc_msgSend(v5, "sk_BOOLeanValueForEntitlement:", CFSTR("com.apple.StatusKit.publish.allTypes")) & 1) != 0)
  {
    v9 = 1;
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      +[SKAStatusPublishingServiceClientConnection _connection:isEntitledForPublishingWithStatusTypeIdentifier:].cold.1((uint64_t)v6, v10, v11, v12, v13, v14, v15, v16);
...
void __52__SKAStatusPublishingServiceClientConnection_logger__block_invoke()
{
  os_log_t v0;
  void *v1;

  v0 = os_log_create("com.apple.StatusKit", "SKAStatusPublishingServiceClientConnection");
...
{
  return (SKAStatusPublishingServiceClientConnectionLifecycleDelegate *)objc_loadWeakRetained((id *)&self->_connectionLifecycleDelegate);
}
...
+ (void)clientIsEntitledForAtLeastOnePublishingServiceType:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_2188DF000, log, OS_LOG_TYPE_ERROR, "Client is not entitled for any status types", v1, 2u);
}
...
{
  OUTLINED_FUNCTION_0(&dword_2188DF000, a2, a3, "Client is not entitled to publish status of type %{public}@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_3();
}
