...
- (id)description
{
  ...
  -[SharedChannelPublishResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SharedChannelPublishResponse dictionaryRepresentation](self, "dictionaryRepresentation");
