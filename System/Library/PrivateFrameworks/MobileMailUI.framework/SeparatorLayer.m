...
- (SeparatorLayer)initWithFrame:(CGRect)a3
{
  ...
  v3 = -[SeparatorLayer initWithFrame:](&v7, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
    -[SeparatorLayer setAutoresizingMask:](v3, "setAutoresizingMask:", 2);
    -[SeparatorLayer setAxis:](v4, "setAxis:", 0);
    objc_msgSend(MEMORY[0x1E0DC3658], "mailHeaderSeparatorLayerColor");
...
- (CGSize)intrinsicContentSize
{
  ...
  -[SeparatorLayer sizeThatFits:](self, "sizeThatFits:", *MEMORY[0x1E0DC55F0], *MEMORY[0x1E0DC55F0]);
  result.height = v3;
  result.width = v2;
  return result;
}
