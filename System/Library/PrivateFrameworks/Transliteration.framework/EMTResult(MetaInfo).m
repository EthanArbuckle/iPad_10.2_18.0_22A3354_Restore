...
- (double)score
{
  ...
  if (v1)
  {
    ...
    v23 = 0;
    objc_msgSend(MEMORY[0x24BDD1608], "JSONObjectWithData:options:error:", v3, 0, &v23);
...
- (void)score
{
  OUTLINED_FUNCTION_0(&dword_2493D1000, a2, a3, "Failed to get seq2seq score, normCost is not of string class type: %@", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
