...
{
  PSContactsPickerInfoCell *v5;
  PSContactsPickerInfoCell *v6;
  void *v7;
  id v8;
  void *v9;
  void *v10;
  ...
  if (v5)
  {
    -[PSContactsPickerInfoCell contentView](v5, "contentView");
    ...
    PS_LocalizedStringForSystemPolicy(CFSTR("CONTACTS_PICKER_ONLY_DESCRIPTION"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "setText:", v14);

    objc_msgSend(v7, "addSubview:", v11);
    -[PSContactsPickerInfoCell contentView](v6, "contentView");
