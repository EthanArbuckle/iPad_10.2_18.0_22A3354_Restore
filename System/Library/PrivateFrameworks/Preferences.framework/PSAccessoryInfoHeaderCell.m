...
- (void)commonInit
{
  ...
  -[PSAccessoryInfoHeaderView setTranslatesAutoresizingMaskIntoConstraints:](v4, "setTranslatesAutoresizingMaskIntoConstraints:", 0);
  -[PSAccessoryInfoHeaderCell contentView](self, "contentView");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "addSubview:", v4);

  v16 = (void *)MEMORY[0x1E0CB3718];
  -[PSAccessoryInfoHeaderView leadingAnchor](v4, "leadingAnchor");
  ...
  v25[0] = v20;
  -[PSAccessoryInfoHeaderView trailingAnchor](v4, "trailingAnchor");
  ...
  v25[1] = v15;
  -[PSAccessoryInfoHeaderView topAnchor](v4, "topAnchor");
  ...
  v25[2] = v9;
  -[PSAccessoryInfoHeaderView bottomAnchor](v4, "bottomAnchor");
