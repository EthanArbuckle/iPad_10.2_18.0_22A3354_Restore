...
{
  PSSegmentableSlider *v3;
  PSNonMovableTapGestureRecognizer *v4;
  void *v5;
  void *v6;
  void *v7;
  uint64_t v8;
  ...
  if (v3)
  {
    v4 = -[PSNonMovableTapGestureRecognizer initWithTarget:action:]([PSNonMovableTapGestureRecognizer alloc], "initWithTarget:action:", v3, sel_sliderTapped_);
    -[PSSegmentableSlider addGestureRecognizer:](v3, "addGestureRecognizer:", v4);
    -[PSSegmentableSlider addTarget:action:forControlEvents:](v3, "addTarget:action:forControlEvents:", v3, sel_controlInteractionBegan_, 1);
    -[PSSegmentableSlider addTarget:action:forControlEvents:](v3, "addTarget:action:forControlEvents:", v3, sel_controlInteractionEnded_, 448);

    +[PSListController appearance](PSListController, "appearance");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "segmentedSliderTrackColor");
    v6 = (void *)objc_claimAutoreleasedReturnValue();

    v7 = v6;
    if (!v6)
    {
      objc_msgSend(MEMORY[0x1E0CEA478], "colorWithWhite:alpha:", 0.596078431, 1.0);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
    }
    -[PSSegmentableSlider _accessibilityHigherContrastTintColorForColor:](v3, "_accessibilityHigherContrastTintColorForColor:", v7);
    ...
    -[PSSegmentableSlider layer](v3, "layer");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "setNeedsDisplayOnBoundsChange:", 1);
...
- (void)sliderTapped:(id)a3
{
  ...
  v5 = v4;
  -[PSSegmentableSlider bounds](self, "bounds");
  -[PSSegmentableSlider trackRectForBounds:](self, "trackRectForBounds:");
  v7 = v6;
  v9 = v8;
  v11 = v10;
  v13 = v12;
  v14 = -[PSSegmentableSlider _shouldReverseLayoutDirection](self, "_shouldReverseLayoutDirection");
  v15 = v7;
  v16 = v9;
  v17 = v11;
  v18 = v13;
  ...
  if (v20 > 1.0)
    v20 = 1.0;
  v21 = fmax(v20, 0.0);
  -[PSSegmentableSlider maximumValue](self, "maximumValue");
  v23 = v22;
  -[PSSegmentableSlider minimumValue](self, "minimumValue");
  v25 = (float)(v23 - v24);
  -[PSSegmentableSlider minimumValue](self, "minimumValue");
  v27 = v26 + v21 * v25;
  *(float *)&v27 = v27;
  -[PSSegmentableSlider setValue:animated:](self, "setValue:animated:", 1, v27);
  -[PSSegmentableSlider sendActionsForControlEvents:](self, "sendActionsForControlEvents:", 4096);
}
...
- (void)setValue:(float)a3 animated:(BOOL)a4
{
  ...
  if (self->_segmented)
  {
    -[PSSegmentableSlider offsetBetweenTicksForNumberOfTicks:](self, "offsetBetweenTicksForNumberOfTicks:", -[PSSegmentableSlider numberOfTicks](self, "numberOfTicks"));
    v8 = v7;
    -[PSSegmentableSlider minimumValue](self, "minimumValue");
    ...
    {
      if (-[PSSegmentableSlider isTracking](self, "isTracking"))
      {
        -[PSSegmentableSlider value](self, "value");
        if (v12 != v13)
  ...
  if (a3 != *(float *)&v14)
  {
    ...
    *(float *)&v14 = a3;
    -[PSSegmentableSlider setValue:animated:](&v15, sel_setValue_animated_, v4, v14);
  }
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  -[PSSegmentableSlider _minTrackView](self, "_minTrackView");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "setHidden:", self->_segmented);

  -[PSSegmentableSlider _maxTrackView](self, "_maxTrackView");
  ...
  if (self->_segmented)
  {
    ...
    v14 = v13;
    v16 = v15;
    v35 = objc_alloc_init(MEMORY[0x1E0CEA390]);
    -[UIColor set](self->_trackMarkersColor, "set");
    objc_msgSend(v35, "setLineWidth:", v16);
    v17 = -[PSSegmentableSlider numberOfTicks](self, "numberOfTicks");
    -[PSSegmentableSlider offsetBetweenTicksForNumberOfTicks:](self, "offsetBetweenTicksForNumberOfTicks:", v17);
    if (v17)
    {
      v19 = v18;
      v20 = 0;
      ...
      do
      {
        -[PSSegmentableSlider minimumValue](self, "minimumValue", *(_QWORD *)&v33);
        ...
        v29 = v28;
        -[PSSegmentableSlider minimumValue](self, "minimumValue");
        v31 = PSRoundToPixel(v11 + (float)(v27 / (float)(v29 - v30)) * v14);
    ...
    objc_msgSend(MEMORY[0x1E0CEA390], "bezierPathWithRect:", v11, v34, v14, v16);
...
- (CGRect)thumbRectForBounds:(CGRect)a3 trackRect:(CGRect)a4 value:(float)a5
{
  ...
  v10 = a3.origin.y;
  v11 = a3.origin.x;
  v13 = -[PSSegmentableSlider _shouldReverseLayoutDirection](self, "_shouldReverseLayoutDirection");
  v42.receiver = self;
  ...
  {
    -[PSSegmentableSlider minimumValue](self, "minimumValue");
    if (v22 == a5 || (-[PSSegmentableSlider maximumValue](self, "maximumValue"), v23 == a5))
    {
