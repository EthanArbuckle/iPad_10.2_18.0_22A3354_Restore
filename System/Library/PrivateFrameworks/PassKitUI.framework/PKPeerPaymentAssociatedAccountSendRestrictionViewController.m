...
{
  id v5;
  PKPeerPaymentAssociatedAccountSendRestrictionViewController *v6;
  PKPeerPaymentAssociatedAccountSendRestrictionViewController *v7;
  void *v8;
  void *v9;
  uint64_t v10;
  ...
  v6 = -[PKPaymentSetupTableViewController initWithContext:](&v22, sel_initWithContext_, objc_msgSend(v5, "context"));
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_controller, a3);
    objc_msgSend(v5, "peerPaymentWebService");
    ...
    v15 = objc_msgSend(v14, "peerPaymentSetupConfigurationType");
...
- (void)viewDidLoad
{
  ...
  -[PKPeerPaymentAssociatedAccountSendRestrictionViewController viewDidLoad](&v29, sel_viewDidLoad);
  -[PKPaymentSetupTableViewController tableView](self, "tableView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setAllowsMultipleSelection:", 0);
  -[PKPeerPaymentAssociatedAccountSendRestrictionViewController tableView:didSelectRowAtIndexPath:](self, "tableView:didSelectRowAtIndexPath:", v3, self->_defaultSelectedIndexPath);
  ...
  -[PKPeerPaymentAssociatedAccountSendRestrictionViewController traitCollection](self, "traitCollection");
  ...
  PKLocalizedPeerPaymentLexingtonString(CFSTR("PEER_PAYMENT_PERSON_TO_PERSON_RESTRICTIONS_TITLE"));
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  PKLocalizedPeerPaymentLexingtonString(CFSTR("PEER_PAYMENT_PERSON_TO_PERSON_RESTRICTIONS_DESCRIPTION"), CFSTR("%@"), v14);
  ...
  if ((PKPaymentSetupContextIsBridge() & 1) == 0)
  {
    PKPassKitUIBundle();
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v18, "URLForResource:withExtension:", CFSTR("MessagesIcon"), CFSTR("pdf"));
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[PKPeerPaymentAssociatedAccountSendRestrictionViewController _textLabelStringForIndexPath:](self, "_textLabelStringForIndexPath:", v6);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12 > 2)
    v13 = (_QWORD *)MEMORY[0x1E0D68188];
  else
    v13 = (_QWORD *)qword_1E3E6A228[v12];
  objc_msgSend(v7, "setAccessibilityIdentifier:", *v13);
  return v7;
}
...
{
  return (id)PKLocalizedPeerPaymentLexingtonString(CFSTR("PEER_PAYMENT_PERSON_TO_PERSON_RESTRICTIONS_TABLE_FOOTER"));
}
...
- (void)_continue
{
  ...
  -[PKPeerPaymentAssociatedAccountSendRestrictionViewController _updatedPreferences](self, "_updatedPreferences");
  ...
  v6 = -[PKPeerPaymentAssociatedAccountReceiveRestrictionViewController initWithPeerPaymentSetupFlowController:]([PKPeerPaymentAssociatedAccountReceiveRestrictionViewController alloc], "initWithPeerPaymentSetupFlowController:", self->_controller);
  if (v6)
  {
    -[PKPeerPaymentAssociatedAccountSendRestrictionViewController navigationController](self, "navigationController");
...
- (id)_updatedPreferences
{
  ...
  if (v8 <= 2)
    objc_msgSend(v4, "addSendRestrictionType:altDSID:", v8 + 1, v3);
...
- (id)_textLabelStringForIndexPath:(id)a3
{
  ...
  {
    PKLocalizedPeerPaymentLexingtonString(&off_1E3E6A240[v3]->isa);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v4;
}
