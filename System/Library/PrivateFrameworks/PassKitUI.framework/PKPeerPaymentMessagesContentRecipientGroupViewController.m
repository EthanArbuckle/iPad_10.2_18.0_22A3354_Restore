...
- (void)viewDidLoad
{
  ...
  -[PKPeerPaymentMessagesContentRecipientGroupViewController viewDidLoad](&v12, sel_viewDidLoad);
  ...
  PKLocalizedPeerPaymentString(CFSTR("PEER_PAYMENT_MESSAGES_RECIPIENT_INVALID_GROUP"));
