...
- (PKCombinedSelectActionViewControllerListSectionController)initWithIdentifier:(id)a3 pass:(id)a4 actions:(id)a5
{
  ...
  id v9;
  id v10;
  PKCombinedSelectActionViewControllerListSectionController *v11;
  void *v12;
  id v13;
  id v14;
  uint64_t v15;
  ...
  uint64_t v17;
  uint64_t i;
  PKPaymentPassActionViewModel *v19;
  uint64_t v20;
  ...
  id v27;
  _QWORD v28[4];
  PKCombinedSelectActionViewControllerListSectionController *v29;
  __int128 v30;
  __int128 v31;
  __int128 v32;
  __int128 v33;
  ...
  v11 = -[PKCombinedSelectActionViewControllerListSectionController init](&v34, sel_init);
  if (v11)
  {
    v27 = v8;
    v36[0] = v8;
    ...
    if (v15)
    {
      ...
      do
      {
        for (i = 0; i != v16; ++i)
        {
          ...
          v19 = -[PKPaymentPassActionViewModel initWithAction:]([PKPaymentPassActionViewModel alloc], "initWithAction:", *(_QWORD *)(*((_QWORD *)&v30 + 1) + 8 * i));
    ...
    -[PKCombinedSelectActionViewControllerListSectionController setCellRegistration:](v24, "setCellRegistration:", v25);
...
void __93__PKCombinedSelectActionViewControllerListSectionController_initWithIdentifier_pass_actions___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  objc_msgSend(v22, "associatedPlan");
  ...
  LODWORD(v18) = objc_msgSend(v6, "isInPreflight");
...
- (id)snapshotWithPreviousSnapshot:(id)a3 forSectionIdentifier:(id)a4
{
  ...
  objc_msgSend(v5, "appendItems:", self->_actionViewModels);
  return v5;
}
...
- (void)didSelectItem:(id)a3
{
  ...
  -[PKCombinedSelectActionViewControllerListSectionController delegate](self, "delegate");
  ...
  v7 = v5;
  v8 = v4;
  objc_msgSend(v7, "didSelectAction:completion:", v6, v9);
...
- (id)layoutWithLayoutEnvironment:(id)a3 sectionIdentifier:(id)a4
{
  ...
  v5 = a3;
  -[PKCombinedSelectActionViewControllerListSectionController defaultListLayout](self, "defaultListLayout");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (PKCombinedSelectActionViewControllerListSectionControllerDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
