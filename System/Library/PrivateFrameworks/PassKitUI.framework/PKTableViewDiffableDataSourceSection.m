...
- (PKTableViewDiffableDataSourceSection)initWithIdentifier:(id)a3
{
  ...
  v5 = -[PKTableViewDiffableDataSourceSection init](&v9, sel_init);
  if (v5)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  PKTableViewDiffableDataSourceSection *v5;
  PKTableViewDiffableDataSourceSection *v6;
  char v7;

  v4 = (PKTableViewDiffableDataSourceSection *)a3;
  v5 = v4;
  if (self == v4)
  {
    v7 = 1;
...
- (unint64_t)hash
{
  ...
  objc_msgSend(v3, "safelyAddObject:", self->_footer);
  v4 = PKCombinedHash();
