...
{
  id v5;
  PKPaymentPassActionGroupViewModel *v6;
  PKPaymentPassActionGroupViewModel *v7;
  void *v8;
  uint64_t v9;
  NSString *identifier;
  objc_super v12;
  ...
  v6 = -[PKPaymentPassActionGroupViewModel init](&v12, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v6;
  ...
  v8 = -[PKPaymentPassActionGroup copyWithZone:](self->_actionGroup, "copyWithZone:", a3);
  v9 = *(void **)(v5 + 24);
  *(_QWORD *)(v5 + 24) = v8;
...
- (BOOL)isEqual:(id)a3
{
  PKPaymentPassActionGroupViewModel *v4;
  PKPaymentPassActionGroupViewModel *v5;
  PKPaymentPassActionGroupViewModel *v6;
  NSString *identifier;
  NSString *v8;
  NSString *v9;
  ...
  v4 = (PKPaymentPassActionGroupViewModel *)a3;
  v5 = v4;
  if (self == v4)
  {
    v12 = 1;
