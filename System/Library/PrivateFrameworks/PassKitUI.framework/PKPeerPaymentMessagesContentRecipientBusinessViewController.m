...
- (void)viewDidLoad
{
  ...
  -[PKPeerPaymentMessagesContentRecipientBusinessViewController viewDidLoad](&v12, sel_viewDidLoad);
  ...
  PKLocalizedPeerPaymentString(CFSTR("PEER_PAYMENT_MESSAGES_RECIPIENT_INVALID_BUSINESS"));
