...
- (PKSelectActionGroupHeader)initWithTitle:(id)a3 subtitle:(id)a4
{
  ...
  v8 = -[PKSelectActionGroupHeader init](&v25, sel_init);
  if (v8)
  {
    ...
    -[PKSelectActionGroupHeader addSubview:](v8, "addSubview:", v8->_titleLabel);
    ...
    -[PKSelectActionGroupHeader addSubview:](v8, "addSubview:", v8->_subtitleLabel);
  }
...
- (void)layoutSubviews
{
  ...
  -[PKSelectActionGroupHeader layoutSubviews](&v9, sel_layoutSubviews);
  -[PKSelectActionGroupHeader bounds](self, "bounds");
  v4 = v3;
