...
- (BOOL)isEqual:(id)a3
{
  PKPeerPaymentRecurringPaymentDateDetailRowItem *v4;
  PKPeerPaymentRecurringPaymentDateDetailRowItem *v5;
  unsigned __int8 *v6;
  BOOL v7;
  objc_super v9;

  v4 = (PKPeerPaymentRecurringPaymentDateDetailRowItem *)a3;
  v5 = v4;
  if (v4 == self)
  {
    v7 = 1;
