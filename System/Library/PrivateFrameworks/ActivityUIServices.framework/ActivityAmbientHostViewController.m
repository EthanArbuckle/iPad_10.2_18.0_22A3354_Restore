...
- (_TtC18ActivityUIServices33ActivityAmbientHostViewController)initWithActivityDescriptor:(id)a3 systemMetricsRequest:(id)a4 payloadID:(id)a5
{
  ...
  id v16;
  id v17;
  _TtC18ActivityUIServices33ActivityAmbientHostViewController *v18;
  uint64_t v20;
  ...
  v16 = a4;
  v17 = sub_22D83F648(2, (uint64_t)v11, v16, v14, (uint64_t)a5);
...
{
  _TtC18ActivityUIServices33ActivityAmbientHostViewController *result;

  result = (_TtC18ActivityUIServices33ActivityAmbientHostViewController *)sub_22D84B8C8();
  __break(1u);
  return result;
}
