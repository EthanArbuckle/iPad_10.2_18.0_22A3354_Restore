void sub_2141C1834(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_2141C1AB8(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_2141C31D4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, char a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,char a23)
{
  id *v23;
  uint64_t v24;
...
void sub_2141C4000(_Unwind_Exception *a1)
{
  uint64_t v1;
...
__CFString *ELSInternalString(void *a1)
{
  ...
  v2 = a1;
  objc_msgSend(v1, "dictionaryWithContentsOfFile:", CFSTR("/AppleInternal/Library/EnhancedLoggingState/Internal.strings"));
...
uint64_t __getCBSUtilitiesClass_block_invoke_cold_1()
{
  ...
  v0 = abort_report_np();
  return +[ELSEvent createLoggingEventWith:postfix:].cold.1(v0);
}
