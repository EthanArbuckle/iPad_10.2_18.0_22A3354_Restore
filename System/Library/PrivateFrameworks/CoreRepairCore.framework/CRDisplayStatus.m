...
- (int64_t)copyComponentStatus
{
  ...
  isFDRDataClassSupported = objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, a2, (uint64_t)CFSTR("tcrt"), v2);
  v10 = objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, v8, (uint64_t)CFSTR("dCfg"), v9);
...
LABEL_27:
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_impl(&dword_214503000, v70, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
            }
