  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v45 = v42;
      _os_log_impl(&dword_214503000, v6, OS_LOG_TYPE_DEFAULT, "Components: %@", buf, 0xCu);
    }
    ...
    if (v13)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          {
            objc_msgSend_stringWithUTF8String_(MEMORY[0x24BDD17C8], v10, (uint64_t)"isTrustedForUI", v12);
            v17 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend_objectForKeyedSubscript_(v16, v18, (uint64_t)v17, v19);
            v20 = objc_claimAutoreleasedReturnValue();

            objc_msgSend_stringWithUTF8String_(MEMORY[0x24BDD17C8], v21, (uint64_t)"ComponentName", v22);
            v23 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend_objectForKeyedSubscript_(v16, v24, (uint64_t)v23, v25);
            v26 = (void *)objc_claimAutoreleasedReturnValue();

            objc_msgSend_stringWithUTF8String_(MEMORY[0x24BDD17C8], v27, (uint64_t)"AuthPassed", v28);
...
- (BOOL)_checkForComponentFailureInDefaults:(id)a3
{
  ...
  if (!v4)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_214503000, v5, OS_LOG_TYPE_DEFAULT, "Reading system health from file", buf, 2u);
    }

    objc_msgSend_stringWithFormat_(MEMORY[0x24BDD17C8], v15, (uint64_t)CFSTR("/var/mobile/Library/Preferences/%@.plist"), v16, CFSTR("com.apple.mobilerepaird.systemhealth"));
    v14 = objc_claimAutoreleasedReturnValue();
    objc_msgSend_dictionaryWithContentsOfFile_(MEMORY[0x24BDBCE70], v17, (uint64_t)v14, v18);
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v30 = v3;
      _os_log_impl(&dword_214503000, v27, OS_LOG_TYPE_DEFAULT, "Found failed component: %@", buf, 0xCu);
    }
...
LABEL_16:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_214503000, v5, OS_LOG_TYPE_DEFAULT, "Reading system health from defaults", buf, 2u);
  }
  ...
  if ((_DWORD)v13)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v30 = v3;
      _os_log_impl(&dword_214503000, v14, OS_LOG_TYPE_DEFAULT, "Found failed component: %@", buf, 0xCu);
    }
    goto LABEL_14;
  }
LABEL_17:
...
- (id)_getObjectForKeyFromDefaults:(id)a3
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v24 = 0;
      _os_log_impl(&dword_214503000, v5, OS_LOG_TYPE_DEFAULT, "Reading system health from file", v24, 2u);
    }

    objc_msgSend_stringWithFormat_(MEMORY[0x24BDD17C8], v14, (uint64_t)CFSTR("/var/mobile/Library/Preferences/%@.plist"), v15, CFSTR("com.apple.mobilerepaird.systemhealth"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_dictionaryWithContentsOfFile_(MEMORY[0x24BDBCE70], v16, (uint64_t)v10, v17);
...
- (id)findUnsealedData
{
  if (qword_254D7B0A8 != -1)
    dispatch_once(&qword_254D7B0A8, &unk_24D1AA138);
  return (id)qword_254D7B0A0;
}
