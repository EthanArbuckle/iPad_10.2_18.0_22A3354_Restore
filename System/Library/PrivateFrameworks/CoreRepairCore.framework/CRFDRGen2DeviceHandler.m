...
{
  return *(_QWORD *)&a3 == 2722529672 || *(_QWORD *)&a3 == 1371389549 || *(_QWORD *)&a3 == 2080700391;
}

+ (id)getDeviceHandlerForProductType:(int)a3
{
  uint64_t v3;
  CRFDRGen2DeviceHandler *v4;
...
- (id)getMakeDataClassesAndInstancesWithPartSPC:(id)a3 fdrRemote:(__AMFDR *)a4 makePropertiesDict:(id *)a5 fdrError:(id *)a6
{
  ...
  if (objc_msgSend_containsObject_(v8, v16, (uint64_t)CFSTR("IPHONE COMP FACEID"), v17)
    && (v80 = 0u,
        ...
        v78 = 0u,
        v79 = 0u,
        (v53 = objc_msgSend_countByEnumeratingWithState_objects_count_(&unk_24D1B86B0, v52, (uint64_t)&v78, (uint64_t)v82, 16)) != 0))
  {
    v56 = v53;
    v57 = *(_QWORD *)v79;
    while (2)
    {
      ...
      {
        if (*(_QWORD *)v79 != v57)
          objc_enumerationMutation(&unk_24D1B86B0);
      ...
      v56 = objc_msgSend_countByEnumeratingWithState_objects_count_(&unk_24D1B86B0, v54, (uint64_t)&v78, (uint64_t)v82, 16);
      v65 = 0;
      if (v56)
        continue;
      break;
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        {
          v34 = 0;
          v18 = objc_msgSend__addDataClassAndInstanceToMutableDictionary_dataClass_withError_(self, v16, (uint64_t)v31, (uint64_t)CFSTR("vcrt"), &v34);
          v19 = v34;
          v20 = v19;
          if (!v18 || v19)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
              sub_21456B858((uint64_t)v20, v22, v23, v24, v25, v26, v27, v28);
...
- (id)spcInPartSPC:(id)a3 withDataClass:(id)a4
{
  ...
  {
    if (objc_msgSend_containsObject_(&unk_24D1B86B0, v9, (uint64_t)v6, v10))
    {
