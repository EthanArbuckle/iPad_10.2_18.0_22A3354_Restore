...
- (int64_t)copyComponentStatus
{
  ...
  if ((objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, a2, (uint64_t)CFSTR("bcrt"), v2) & 1) == 0
    && !objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, v5, (uint64_t)CFSTR("vcrt"), v6))
  {
    return 0;
  }
...
LABEL_24:
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_impl(&dword_214503000, v67, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
            }
