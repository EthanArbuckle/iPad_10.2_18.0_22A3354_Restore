...
+ (id)sharedSingleton
{
  ...
  block[1] = 3221225472;
  block[2] = sub_21455CBE0;
  block[3] = &unk_24D1AA2E8;
  block[4] = a1;
  if (qword_253E79808 != -1)
    dispatch_once(&qword_253E79808, block);
  return (id)qword_253E79858;
}
...
LABEL_13:
  ...
  *((_BYTE *)v54 + 24) = 1;
  ...
  v33 = (void *)objc_msgSend_initWithComponentType_identifier_signedResponse_keyIndex_properties_(v31, v32, (uint64_t)CFSTR("tcrt"), (uint64_t)self->identifierBase64, v30, 0, 0);
  v34 = 0;
LABEL_14:
