...
{
  id v5;
  CHUISControlToggleViewModel *v6;
  CHUISControlToggleViewModel *v7;
  CHUISControlToggleOption *v8;
  CHUISControlToggleOption *onOption;
  CHUISControlToggleOption *v10;
  ...
  v6 = -[CHUISControlToggleViewModel init](&v13, sel_init);
  v7 = v6;
  if (v6)
  {
    v6->_state = 0;
...
{
  objc_storeStrong((id *)&self->_onOption, a3);
}
...
{
  objc_storeStrong((id *)&self->_offOption, a3);
}
