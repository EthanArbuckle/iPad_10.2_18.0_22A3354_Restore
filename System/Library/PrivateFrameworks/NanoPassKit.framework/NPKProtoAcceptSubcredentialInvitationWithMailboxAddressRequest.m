...
- (id)description
{
  ...
  -[NPKProtoAcceptSubcredentialInvitationWithMailboxAddressRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoAcceptSubcredentialInvitationWithMailboxAddressRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_mailboxAddress)
    -[NPKProtoAcceptSubcredentialInvitationWithMailboxAddressRequest writeTo:].cold.1();
  v5 = v4;
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "setMailboxAddress:", self->_mailboxAddress);
  if (self->_activationCode)
