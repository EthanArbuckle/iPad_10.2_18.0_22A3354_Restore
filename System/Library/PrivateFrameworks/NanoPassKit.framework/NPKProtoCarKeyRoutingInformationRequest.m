...
- (id)description
{
  ...
  -[NPKProtoCarKeyRoutingInformationRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeyRoutingInformationRequest dictionaryRepresentation](self, "dictionaryRepresentation");
