...
- (id)description
{
  ...
  -[NPKProtoDisplayableSharesForPassIdentifierResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoDisplayableSharesForPassIdentifierResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[NPKProtoDisplayableSharesForPassIdentifierResponse sharesDatasCount](self, "sharesDatasCount"))
  {
    objc_msgSend(v8, "clearSharesDatas");
    v4 = -[NPKProtoDisplayableSharesForPassIdentifierResponse sharesDatasCount](self, "sharesDatasCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKProtoDisplayableSharesForPassIdentifierResponse sharesDataAtIndex:](self, "sharesDataAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NPKProtoDisplayableSharesForPassIdentifierResponse addSharesData:](self, "addSharesData:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
