...
- (id)description
{
  ...
  -[NPKProtoSetPreferredPaymentApplicationResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoSetPreferredPaymentApplicationResponse dictionaryRepresentation](self, "dictionaryRepresentation");
