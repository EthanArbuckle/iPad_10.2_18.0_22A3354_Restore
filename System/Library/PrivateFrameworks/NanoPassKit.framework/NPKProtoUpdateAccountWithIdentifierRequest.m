...
- (id)description
{
  ...
  -[NPKProtoUpdateAccountWithIdentifierRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoUpdateAccountWithIdentifierRequest dictionaryRepresentation](self, "dictionaryRepresentation");
