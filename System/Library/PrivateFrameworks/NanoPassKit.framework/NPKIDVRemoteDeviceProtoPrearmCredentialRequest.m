...
- (id)description
{
  ...
  -[NPKIDVRemoteDeviceProtoPrearmCredentialRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKIDVRemoteDeviceProtoPrearmCredentialRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (authorizationTokenData)
    objc_msgSend(v3, "setObject:forKey:", authorizationTokenData, CFSTR("authorizationTokenData"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  authorizationTokenData = self->_authorizationTokenData;
  if (authorizationTokenData)
    objc_msgSend(a3, "setAuthorizationTokenData:", authorizationTokenData);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_authorizationTokenData, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)authorizationTokenData | v4[1])
      v6 = -[NSData isEqual:](authorizationTokenData, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSData hash](self->_authorizationTokenData, "hash");
}
...
{
  objc_storeStrong((id *)&self->_authorizationTokenData, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_authorizationTokenData, 0);
}
