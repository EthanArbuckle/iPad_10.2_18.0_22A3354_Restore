...
- (id)description
{
  ...
  -[NPKProtoProvisionPeerPaymentPassResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoProvisionPeerPaymentPassResponse dictionaryRepresentation](self, "dictionaryRepresentation");
