...
- (id)description
{
  ...
  -[NPKProtoStandalonePaymentProvisioningFlowPickerSection description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoStandalonePaymentProvisioningFlowPickerSection dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  footer = self->_footer;
  if (footer)
    objc_msgSend(v4, "setObject:forKey:", footer, CFSTR("footer"));
...
- (void)copyTo:(id)a3
{
  ...
  if (-[NPKProtoStandalonePaymentProvisioningFlowPickerSection itemsCount](self, "itemsCount"))
  {
    objc_msgSend(v8, "clearItems");
    v4 = -[NPKProtoStandalonePaymentProvisioningFlowPickerSection itemsCount](self, "itemsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKProtoStandalonePaymentProvisioningFlowPickerSection itemsAtIndex:](self, "itemsAtIndex:", i);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](footer, "isEqual:")))
  {
    ...
    if ((unint64_t)items | v4[2])
      v8 = -[NSMutableArray isEqual:](items, "isEqual:");
    else
      v8 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v4 = -[NSString hash](self->_footer, "hash") ^ v3;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[NPKProtoStandalonePaymentProvisioningFlowPickerSection addItems:](self, "addItems:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
