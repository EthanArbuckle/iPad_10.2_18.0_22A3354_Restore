...
- (id)description
{
  ...
  -[NPKProtoFidoExternalizedAuthResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoFidoExternalizedAuthResponse dictionaryRepresentation](self, "dictionaryRepresentation");
