...
- (id)description
{
  ...
  -[NPKProtoMatchingInvitationOnDeviceResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoMatchingInvitationOnDeviceResponse dictionaryRepresentation](self, "dictionaryRepresentation");
