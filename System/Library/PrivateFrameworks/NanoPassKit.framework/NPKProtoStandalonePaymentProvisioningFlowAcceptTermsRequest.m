...
- (id)description
{
  ...
  -[NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_requestHeader)
    -[NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest writeTo:].cold.1();
  v5 = v4;
