...
- (id)description
{
  ...
  -[NPKProtoPassSyncReconciledStateAccepted description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoPassSyncReconciledStateAccepted dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (reconciledStateHash)
    objc_msgSend(v3, "setObject:forKey:", reconciledStateHash, CFSTR("reconciledStateHash"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  reconciledStateHash = self->_reconciledStateHash;
  if (reconciledStateHash)
    objc_msgSend(a3, "setReconciledStateHash:", reconciledStateHash);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_reconciledStateHash, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)reconciledStateHash | v4[1])
      v6 = -[NSData isEqual:](reconciledStateHash, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSData hash](self->_reconciledStateHash, "hash");
}
