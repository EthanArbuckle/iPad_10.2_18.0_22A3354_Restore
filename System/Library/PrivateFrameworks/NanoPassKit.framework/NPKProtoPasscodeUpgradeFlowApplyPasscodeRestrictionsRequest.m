...
- (id)description
{
  ...
  -[NPKProtoPasscodeUpgradeFlowApplyPasscodeRestrictionsRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoPasscodeUpgradeFlowApplyPasscodeRestrictionsRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("enforcedPolicy"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_enforcedPolicy == *((_DWORD *)v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
