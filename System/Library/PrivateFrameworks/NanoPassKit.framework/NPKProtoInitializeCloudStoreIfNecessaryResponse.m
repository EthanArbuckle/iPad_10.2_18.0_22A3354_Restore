...
- (id)description
{
  ...
  -[NPKProtoInitializeCloudStoreIfNecessaryResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoInitializeCloudStoreIfNecessaryResponse dictionaryRepresentation](self, "dictionaryRepresentation");
