...
{
  -[NSMutableArray removeAllObjects](self->_manualEntryFields, "removeAllObjects");
}
...
- (void)addManualEntryFields:(id)a3
{
  ...
  -[NSMutableArray addObject:](manualEntryFields, "addObject:", v4);

}

- (unint64_t)manualEntryFieldsCount
{
  return -[NSMutableArray count](self->_manualEntryFields, "count");
}

- (id)manualEntryFieldsAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_manualEntryFields, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[NPKProtoStandalonePaymentProvisioningFlowHandleManualEntryFieldsRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoStandalonePaymentProvisioningFlowHandleManualEntryFieldsRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSMutableArray count](self->_manualEntryFields, "count"))
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_manualEntryFields, "count"));
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("manualEntryFields"));
  }
  return v3;
}
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_requestHeader)
    -[NPKProtoStandalonePaymentProvisioningFlowHandleManualEntryFieldsRequest writeTo:].cold.1();
  v5 = v4;
...
- (void)copyTo:(id)a3
{
  ...
  if (-[NPKProtoStandalonePaymentProvisioningFlowHandleManualEntryFieldsRequest manualEntryFieldsCount](self, "manualEntryFieldsCount"))
  {
    objc_msgSend(v8, "clearManualEntryFields");
    v4 = -[NPKProtoStandalonePaymentProvisioningFlowHandleManualEntryFieldsRequest manualEntryFieldsCount](self, "manualEntryFieldsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKProtoStandalonePaymentProvisioningFlowHandleManualEntryFieldsRequest manualEntryFieldsAtIndex:](self, "manualEntryFieldsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addManualEntryFields:", v7);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addManualEntryFields:", v13);
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NPKProtoStandaloneRequestHeader isEqual:](requestHeader, "isEqual:")))
  {
    ...
    if ((unint64_t)manualEntryFields | v4[1])
      v7 = -[NSMutableArray isEqual:](manualEntryFields, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSMutableArray hash](self->_manualEntryFields, "hash") ^ v3;
}
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[NPKProtoStandalonePaymentProvisioningFlowHandleManualEntryFieldsRequest addManualEntryFields:](self, "addManualEntryFields:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * i), (_QWORD)v12);
      }
...
{
  objc_storeStrong((id *)&self->_manualEntryFields, a3);
}
