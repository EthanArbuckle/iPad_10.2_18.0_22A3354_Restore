...
- (id)description
{
  ...
  -[NPKProtoSecureElementRemoveAppletsResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoSecureElementRemoveAppletsResponse dictionaryRepresentation](self, "dictionaryRepresentation");
