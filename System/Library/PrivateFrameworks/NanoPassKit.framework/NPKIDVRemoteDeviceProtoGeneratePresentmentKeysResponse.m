...
{
  -[NSMutableArray removeAllObjects](self->_presentmentKeysDatas, "removeAllObjects");
}
...
- (void)addPresentmentKeysData:(id)a3
{
  ...
  -[NSMutableArray addObject:](presentmentKeysDatas, "addObject:", v4);

}

- (unint64_t)presentmentKeysDatasCount
{
  return -[NSMutableArray count](self->_presentmentKeysDatas, "count");
}

- (id)presentmentKeysDataAtIndex:(unint64_t)a3
{
  return (id)-[NSMutableArray objectAtIndex:](self->_presentmentKeysDatas, "objectAtIndex:", a3);
}
...
- (id)description
{
  ...
  -[NPKIDVRemoteDeviceProtoGeneratePresentmentKeysResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKIDVRemoteDeviceProtoGeneratePresentmentKeysResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  presentmentKeysDatas = self->_presentmentKeysDatas;
  if (presentmentKeysDatas)
    objc_msgSend(v3, "setObject:forKey:", presentmentKeysDatas, CFSTR("presentmentKeysData"));
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[NPKIDVRemoteDeviceProtoGeneratePresentmentKeysResponse presentmentKeysDatasCount](self, "presentmentKeysDatasCount"))
  {
    objc_msgSend(v8, "clearPresentmentKeysDatas");
    v4 = -[NPKIDVRemoteDeviceProtoGeneratePresentmentKeysResponse presentmentKeysDatasCount](self, "presentmentKeysDatasCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKIDVRemoteDeviceProtoGeneratePresentmentKeysResponse presentmentKeysDataAtIndex:](self, "presentmentKeysDataAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addPresentmentKeysData:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addPresentmentKeysData:", v11);
...
- (unint64_t)hash
{
  ...
  v3 = -[NSMutableArray hash](self->_presentmentKeysDatas, "hash");
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[NPKIDVRemoteDeviceProtoGeneratePresentmentKeysResponse addPresentmentKeysData:](self, "addPresentmentKeysData:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
...
{
  objc_storeStrong((id *)&self->_presentmentKeysDatas, a3);
}
