...
- (id)description
{
  ...
  -[NPKProtoResetApplePayManateeViewResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoResetApplePayManateeViewResponse dictionaryRepresentation](self, "dictionaryRepresentation");
