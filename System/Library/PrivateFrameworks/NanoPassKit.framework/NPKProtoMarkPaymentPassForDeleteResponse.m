...
- (id)description
{
  ...
  -[NPKProtoMarkPaymentPassForDeleteResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoMarkPaymentPassForDeleteResponse dictionaryRepresentation](self, "dictionaryRepresentation");
