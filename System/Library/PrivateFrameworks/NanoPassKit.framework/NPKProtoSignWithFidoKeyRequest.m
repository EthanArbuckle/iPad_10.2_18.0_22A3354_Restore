...
- (id)description
{
  ...
  -[NPKProtoSignWithFidoKeyRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoSignWithFidoKeyRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (publicKeyIdentifier)
    objc_msgSend(v4, "setObject:forKey:", publicKeyIdentifier, CFSTR("publicKeyIdentifier"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = -[NSData copyWithZone:](self->_challenge, "copyWithZone:", a3);
  v13 = (void *)v5[1];
  v5[1] = v12;

  v14 = -[NSString copyWithZone:](self->_publicKeyIdentifier, "copyWithZone:", a3);
  v15 = (void *)v5[4];
  v5[4] = v14;

  v16 = -[NSData copyWithZone:](self->_externalizedAuth, "copyWithZone:", a3);
  v17 = (void *)v5[2];
  v5[2] = v16;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](publicKeyIdentifier, "isEqual:")))
  {
    ...
    if ((unint64_t)externalizedAuth | v4[2])
      v11 = -[NSData isEqual:](externalizedAuth, "isEqual:");
    else
      v11 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v5 = -[NSData hash](self->_fidoKeyHash, "hash");
  v6 = v4 ^ v5 ^ -[NSData hash](self->_challenge, "hash");
  v7 = -[NSString hash](self->_publicKeyIdentifier, "hash");
  return v6 ^ v7 ^ -[NSData hash](self->_externalizedAuth, "hash");
}
