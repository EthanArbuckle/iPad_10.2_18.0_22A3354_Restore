...
- (id)description
{
  ...
  -[NPKProtoCanAddSecureElementPassWithConfigurationRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCanAddSecureElementPassWithConfigurationRequest dictionaryRepresentation](self, "dictionaryRepresentation");
