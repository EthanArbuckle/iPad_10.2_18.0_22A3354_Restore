...
- (id)description
{
  ...
  -[NPKProtoRegisterSubcredentialsRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoRegisterSubcredentialsRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[NPKProtoRegisterSubcredentialsRequest identifiersCount](self, "identifiersCount"))
  {
    objc_msgSend(v8, "clearIdentifiers");
    v4 = -[NPKProtoRegisterSubcredentialsRequest identifiersCount](self, "identifiersCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKProtoRegisterSubcredentialsRequest identifiersAtIndex:](self, "identifiersAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addIdentifiers:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)identifiers | v4[1])
      v6 = -[NSMutableArray isEqual:](identifiers, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_identifiers, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NPKProtoRegisterSubcredentialsRequest addIdentifiers:](self, "addIdentifiers:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
