...
- (id)description
{
  ...
  -[NPKProtoDeviceMetadataWithFieldsReponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoDeviceMetadataWithFieldsReponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (deviceMetadata)
    objc_msgSend(v3, "setObject:forKey:", deviceMetadata, CFSTR("deviceMetadata"));
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSData copyWithZone:](self->_deviceMetadata, "copyWithZone:", a3);
  v8 = (void *)v6[1];
  v6[1] = v7;
...
LABEL_12:
  ...
  if ((unint64_t)deviceMetadata | *((_QWORD *)v4 + 1))
    v5 = -[NSData isEqual:](deviceMetadata, "isEqual:");
  else
    v5 = 1;
LABEL_7:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSData hash](self->_deviceMetadata, "hash") ^ v2;
}
