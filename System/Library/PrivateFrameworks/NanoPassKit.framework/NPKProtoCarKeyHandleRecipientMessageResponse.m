...
- (id)description
{
  ...
  -[NPKProtoCarKeyHandleRecipientMessageResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeyHandleRecipientMessageResponse dictionaryRepresentation](self, "dictionaryRepresentation");
