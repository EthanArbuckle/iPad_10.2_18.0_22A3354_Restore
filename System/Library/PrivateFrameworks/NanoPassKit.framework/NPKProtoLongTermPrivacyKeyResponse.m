...
- (id)description
{
  ...
  -[NPKProtoLongTermPrivacyKeyResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoLongTermPrivacyKeyResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_keyData, "copyWithZone:", a3);
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_keyData, "hash");
