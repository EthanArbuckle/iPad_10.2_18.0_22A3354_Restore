...
- (id)description
{
  ...
  -[NPKProtoAcceptCarKeyShareForMessageWithActivationCodeRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoAcceptCarKeyShareForMessageWithActivationCodeRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (sharingMessageData)
    objc_msgSend(v3, "setObject:forKey:", sharingMessageData, CFSTR("sharingMessageData"));
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_sharingMessageData)
    -[NPKProtoAcceptCarKeyShareForMessageWithActivationCodeRequest writeTo:].cold.1();
  v5 = v4;
...
- (void)copyTo:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "setSharingMessageData:", self->_sharingMessageData);
  if (self->_activationCode)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_sharingMessageData, "copyWithZone:", a3);
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_sharingMessageData, "hash");
