...
- (id)description
{
  ...
  -[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  if (-[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest configuredPartitionsIdentifiersCount](self, "configuredPartitionsIdentifiersCount"))
  {
    objc_msgSend(v8, "clearConfiguredPartitionsIdentifiers");
    v4 = -[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest configuredPartitionsIdentifiersCount](self, "configuredPartitionsIdentifiersCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest configuredPartitionsIdentifiersAtIndex:](self, "configuredPartitionsIdentifiersAtIndex:", i);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest addConfiguredPartitionsIdentifiers:](self, "addConfiguredPartitionsIdentifiers:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
