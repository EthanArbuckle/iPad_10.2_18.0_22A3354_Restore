...
- (id)description
{
  ...
  -[NPKProtoCarKeyRoutingInformationResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeyRoutingInformationResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (routingInformation)
    objc_msgSend(v3, "setObject:forKey:", routingInformation, CFSTR("routingInformation"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_routingInformation, "copyWithZone:", a3);
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_routingInformation, "hash");
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[NPKProtoCarKeyRoutingInformationResponse setRoutingInformation:](self, "setRoutingInformation:");
    v4 = v5;
  }
  if (v4[1])
  {
...
{
  objc_storeStrong((id *)&self->_routingInformation, a3);
}
