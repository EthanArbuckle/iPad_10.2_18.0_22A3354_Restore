...
- (id)description
{
  ...
  -[NPKProtoPeerPaymentRegistrationRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoPeerPaymentRegistrationRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (serviceURL)
    objc_msgSend(v3, "setObject:forKey:", serviceURL, CFSTR("serviceURL"));
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_forceReRegistration);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("forceReRegistration"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_serviceURL, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 8);
  *(_QWORD *)(v5 + 8) = v6;

  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *(_BYTE *)(v5 + 16) = self->_forceReRegistration;
    *(_BYTE *)(v5 + 20) |= 1u;
  }
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_6;
  serviceURL = self->_serviceURL;
  if ((unint64_t)serviceURL | *((_QWORD *)v4 + 1))
  {
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_serviceURL, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0)
    v4 = 2654435761 * self->_forceReRegistration;
  else
    v4 = 0;
  return v4 ^ v3;
}
