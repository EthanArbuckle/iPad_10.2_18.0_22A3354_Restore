...
- (id)description
{
  ...
  -[NPKProtoProvisionPassForRemoteCredentialWithTypeAndIdentifierResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoProvisionPassForRemoteCredentialWithTypeAndIdentifierResponse dictionaryRepresentation](self, "dictionaryRepresentation");
