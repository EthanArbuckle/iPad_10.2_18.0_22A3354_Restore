...
- (id)description
{
  ...
  -[NPKProtoCarKeyGetPretrackResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeyGetPretrackResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (preTrackRequestData)
    objc_msgSend(v3, "setObject:forKey:", preTrackRequestData, CFSTR("preTrackRequestData"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_preTrackRequestData, "copyWithZone:", a3);
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_preTrackRequestData, "hash");
...
{
  objc_storeStrong((id *)&self->_preTrackRequestData, a3);
}
