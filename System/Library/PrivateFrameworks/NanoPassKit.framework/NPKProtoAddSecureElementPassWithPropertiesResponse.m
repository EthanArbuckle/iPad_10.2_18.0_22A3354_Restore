...
- (id)description
{
  ...
  -[NPKProtoAddSecureElementPassWithPropertiesResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoAddSecureElementPassWithPropertiesResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  credentialsBytes = self->_credentialsBytes;
  if (credentialsBytes)
    objc_msgSend(v3, "setObject:forKey:", credentialsBytes, CFSTR("credentialsBytes"));
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v9 = v4;
  if (-[NPKProtoAddSecureElementPassWithPropertiesResponse credentialsBytesCount](self, "credentialsBytesCount"))
  {
    objc_msgSend(v9, "clearCredentialsBytes");
    v5 = -[NPKProtoAddSecureElementPassWithPropertiesResponse credentialsBytesCount](self, "credentialsBytesCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[NPKProtoAddSecureElementPassWithPropertiesResponse credentialsBytesAtIndex:](self, "credentialsBytesAtIndex:", i);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "addCredentialsBytes:", v8);
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v6, "addCredentialsBytes:", v12);
...
LABEL_12:
  credentialsBytes = self->_credentialsBytes;
  if ((unint64_t)credentialsBytes | *((_QWORD *)v4 + 1))
    v5 = -[NSMutableArray isEqual:](credentialsBytes, "isEqual:");
  else
    v5 = 1;
LABEL_7:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSMutableArray hash](self->_credentialsBytes, "hash") ^ v2;
}
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NPKProtoAddSecureElementPassWithPropertiesResponse addCredentialsBytes:](self, "addCredentialsBytes:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
