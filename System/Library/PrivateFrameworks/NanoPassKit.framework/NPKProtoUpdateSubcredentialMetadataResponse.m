...
- (id)description
{
  ...
  -[NPKProtoUpdateSubcredentialMetadataResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoUpdateSubcredentialMetadataResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  passData = self->_passData;
  if (passData)
    objc_msgSend(a3, "setPassData:", passData);
}
