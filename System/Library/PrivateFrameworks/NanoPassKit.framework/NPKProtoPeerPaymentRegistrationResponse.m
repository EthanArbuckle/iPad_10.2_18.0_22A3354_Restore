...
- (id)description
{
  ...
  -[NPKProtoPeerPaymentRegistrationResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoPeerPaymentRegistrationResponse dictionaryRepresentation](self, "dictionaryRepresentation");
