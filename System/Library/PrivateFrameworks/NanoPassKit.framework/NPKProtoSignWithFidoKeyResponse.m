...
- (id)description
{
  ...
  -[NPKProtoSignWithFidoKeyResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoSignWithFidoKeyResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (fidoAttestation)
    objc_msgSend(v3, "setObject:forKey:", fidoAttestation, CFSTR("fidoAttestation"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_fidoAttestation, "copyWithZone:", a3);
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_fidoAttestation, "hash");
