...
- (id)description
{
  ...
  -[NPKProtoPerformDeviceCheckInResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoPerformDeviceCheckInResponse dictionaryRepresentation](self, "dictionaryRepresentation");
