...
- (id)description
{
  ...
  -[NPKProtoCarKeyRetryActivationCodeRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeyRetryActivationCodeRequest dictionaryRepresentation](self, "dictionaryRepresentation");
