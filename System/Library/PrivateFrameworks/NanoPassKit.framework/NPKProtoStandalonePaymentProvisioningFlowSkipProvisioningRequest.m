...
- (id)description
{
  ...
  -[NPKProtoStandalonePaymentProvisioningFlowSkipProvisioningRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoStandalonePaymentProvisioningFlowSkipProvisioningRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_requestHeader)
    -[NPKProtoStandalonePaymentProvisioningFlowSkipProvisioningRequest writeTo:].cold.1();
  v5 = v4;
