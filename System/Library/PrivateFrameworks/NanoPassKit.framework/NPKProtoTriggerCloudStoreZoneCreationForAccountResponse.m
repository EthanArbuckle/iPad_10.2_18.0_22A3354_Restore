...
- (id)description
{
  ...
  -[NPKProtoTriggerCloudStoreZoneCreationForAccountResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoTriggerCloudStoreZoneCreationForAccountResponse dictionaryRepresentation](self, "dictionaryRepresentation");
