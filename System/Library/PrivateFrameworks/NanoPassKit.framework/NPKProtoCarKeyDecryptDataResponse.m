...
- (id)description
{
  ...
  -[NPKProtoCarKeyDecryptDataResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeyDecryptDataResponse dictionaryRepresentation](self, "dictionaryRepresentation");
