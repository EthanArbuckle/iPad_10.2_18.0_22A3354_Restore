...
- (id)description
{
  ...
  -[NPKProtoCarKeyGetProductPlanIdentifierResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeyGetProductPlanIdentifierResponse dictionaryRepresentation](self, "dictionaryRepresentation");
