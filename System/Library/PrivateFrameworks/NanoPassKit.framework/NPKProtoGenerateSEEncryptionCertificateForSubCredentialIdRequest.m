...
- (id)description
{
  ...
  -[NPKProtoGenerateSEEncryptionCertificateForSubCredentialIdRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoGenerateSEEncryptionCertificateForSubCredentialIdRequest dictionaryRepresentation](self, "dictionaryRepresentation");
