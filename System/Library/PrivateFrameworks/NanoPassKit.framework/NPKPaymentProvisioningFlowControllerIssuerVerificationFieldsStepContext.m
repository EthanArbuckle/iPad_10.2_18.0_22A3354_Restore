...
- (id)description
{
  ...
  -[NPKPaymentProvisioningFlowControllerIssuerVerificationFieldsStepContext paymentPass](self, "paymentPass");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "uniqueID");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKPaymentProvisioningFlowControllerIssuerVerificationFieldsStepContext verificationFields](self, "verificationFields");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<%@ pass unique ID %@ fields %@>"), v4, v6, v7);
...
{
  objc_storeStrong((id *)&self->_verificationFields, a3);
}
