...
- (id)description
{
  ...
  -[NPKIDVRemoteDeviceProtoCredentialPropertiesResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKIDVRemoteDeviceProtoCredentialPropertiesResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (credentialPropertiesData)
    objc_msgSend(v3, "setObject:forKey:", credentialPropertiesData, CFSTR("credentialPropertiesData"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_credentialPropertiesData, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_credentialPropertiesData, "hash");
...
{
  objc_storeStrong((id *)&self->_credentialPropertiesData, a3);
}
