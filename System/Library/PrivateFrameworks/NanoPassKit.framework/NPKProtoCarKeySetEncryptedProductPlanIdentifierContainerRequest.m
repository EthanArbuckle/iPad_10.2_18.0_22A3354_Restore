...
- (id)description
{
  ...
  -[NPKProtoCarKeySetEncryptedProductPlanIdentifierContainerRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCarKeySetEncryptedProductPlanIdentifierContainerRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (containerData)
    objc_msgSend(v3, "setObject:forKey:", containerData, CFSTR("containerData"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_containerData, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_containerData, "hash");
