...
- (id)description
{
  ...
  -[NPKProtoMarkAllAppletsForDeletionResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoMarkAllAppletsForDeletionResponse dictionaryRepresentation](self, "dictionaryRepresentation");
