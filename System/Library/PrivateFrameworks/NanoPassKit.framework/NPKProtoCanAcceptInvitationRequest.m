...
- (id)description
{
  ...
  -[NPKProtoCanAcceptInvitationRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoCanAcceptInvitationRequest dictionaryRepresentation](self, "dictionaryRepresentation");
