...
- (id)description
{
  ...
  -[NPKProtoAvailableHomeKeyPassesResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoAvailableHomeKeyPassesResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[NPKProtoAvailableHomeKeyPassesResponse passesDatasCount](self, "passesDatasCount"))
  {
    objc_msgSend(v8, "clearPassesDatas");
    v4 = -[NPKProtoAvailableHomeKeyPassesResponse passesDatasCount](self, "passesDatasCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKProtoAvailableHomeKeyPassesResponse passesDataAtIndex:](self, "passesDataAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addPassesData:", v7);
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v11 != v8)
          objc_enumerationMutation(v5);
        -[NPKProtoAvailableHomeKeyPassesResponse addPassesData:](self, "addPassesData:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * i), (_QWORD)v10);
      }
