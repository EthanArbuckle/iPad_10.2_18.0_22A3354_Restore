...
- (id)description
{
  ...
  -[NPKProtoPassSharesForCredentialIdentifierRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoPassSharesForCredentialIdentifierRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_credentialIdentifier)
    -[NPKProtoPassSharesForCredentialIdentifierRequest writeTo:].cold.1();
  v5 = v4;
...
- (void)copyTo:(id)a3
{
  objc_msgSend(a3, "setCredentialIdentifier:", self->_credentialIdentifier);
}
...
- (unint64_t)hash
{
  return -[NSString hash](self->_credentialIdentifier, "hash");
}
