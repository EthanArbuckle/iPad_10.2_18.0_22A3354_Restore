...
- (id)description
{
  ...
  -[NPKProtoProvisioningDataRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoProvisioningDataRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_includeDeviceMetadata);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("includeDeviceMetadata"));
...
- (void)copyTo:(id)a3
{
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_BYTE *)a3 + 8) = self->_includeDeviceMetadata;
    *((_BYTE *)a3 + 12) |= 1u;
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_BYTE *)result + 8) = self->_includeDeviceMetadata;
    *((_BYTE *)result + 12) |= 1u;
  }
  return result;
}
...
- (void)mergeFrom:(id)a3
{
  if ((*((_BYTE *)a3 + 12) & 1) != 0)
  {
    self->_includeDeviceMetadata = *((_BYTE *)a3 + 8);
    *(_BYTE *)&self->_has |= 1u;
  }
}
