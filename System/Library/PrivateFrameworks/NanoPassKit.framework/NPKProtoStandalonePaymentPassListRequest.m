...
- (id)description
{
  ...
  -[NPKProtoStandalonePaymentPassListRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoStandalonePaymentPassListRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)writeTo:(id)a3
{
  ...
  if (!self->_requestHeader)
    -[NPKProtoStandalonePaymentPassListRequest writeTo:].cold.1();
  v5 = v4;
