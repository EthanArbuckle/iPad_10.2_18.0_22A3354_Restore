...
- (id)description
{
  ...
  -[NPKProtoAccountAttestationAnonymizationSaltResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoAccountAttestationAnonymizationSaltResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_anonymizationSalt, "hash");
