...
- (id)description
{
  ...
  -[NPKProtoSecureElementRemoveAppletsRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoSecureElementRemoveAppletsRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[NPKProtoSecureElementRemoveAppletsRequest cardAIDsCount](self, "cardAIDsCount"))
  {
    objc_msgSend(v8, "clearCardAIDs");
    v4 = -[NPKProtoSecureElementRemoveAppletsRequest cardAIDsCount](self, "cardAIDsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKProtoSecureElementRemoveAppletsRequest cardAIDsAtIndex:](self, "cardAIDsAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addCardAIDs:", v7);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addCardAIDs:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)cardAIDs | v4[1])
      v6 = -[NSMutableArray isEqual:](cardAIDs, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_cardAIDs, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NPKProtoSecureElementRemoveAppletsRequest addCardAIDs:](self, "addCardAIDs:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
