...
- (id)description
{
  ...
  -[NPKProtoPaymentSetupFeaturesForConfigurationRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoPaymentSetupFeaturesForConfigurationRequest dictionaryRepresentation](self, "dictionaryRepresentation");
