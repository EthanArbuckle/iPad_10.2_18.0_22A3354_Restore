...
- (id)description
{
  ...
  -[NPKProtoOwnershipTokenResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoOwnershipTokenResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](identifier, "isEqual:")))
  {
    ...
    if ((unint64_t)token | v4[2])
      v7 = -[NSString isEqual:](token, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_token, "hash") ^ v3;
}
