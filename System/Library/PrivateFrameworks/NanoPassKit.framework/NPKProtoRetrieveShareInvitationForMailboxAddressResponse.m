...
- (id)description
{
  ...
  -[NPKProtoRetrieveShareInvitationForMailboxAddressResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoRetrieveShareInvitationForMailboxAddressResponse dictionaryRepresentation](self, "dictionaryRepresentation");
