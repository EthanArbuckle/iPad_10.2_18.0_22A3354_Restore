...
- (id)description
{
  ...
  -[NPKProtoRetrievePaymentTransactionsResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoRetrievePaymentTransactionsResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v12 = a3;
  if (-[NPKProtoRetrievePaymentTransactionsResponse transactionsBytesCount](self, "transactionsBytesCount"))
  {
    objc_msgSend(v12, "clearTransactionsBytes");
    v4 = -[NPKProtoRetrievePaymentTransactionsResponse transactionsBytesCount](self, "transactionsBytesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[NPKProtoRetrievePaymentTransactionsResponse transactionsBytesAtIndex:](self, "transactionsBytesAtIndex:", i);
  ...
  if (-[NPKProtoRetrievePaymentTransactionsResponse transactionPassIDsCount](self, "transactionPassIDsCount"))
  {
    objc_msgSend(v12, "clearTransactionPassIDs");
    v8 = -[NPKProtoRetrievePaymentTransactionsResponse transactionPassIDsCount](self, "transactionPassIDsCount");
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
      {
        -[NPKProtoRetrievePaymentTransactionsResponse transactionPassIDsAtIndex:](self, "transactionPassIDsAtIndex:", j);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v20 != v8)
          objc_enumerationMutation(v5);
        -[NPKProtoRetrievePaymentTransactionsResponse addTransactionsBytes:](self, "addTransactionsBytes:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v9++));
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v16 != v13)
          objc_enumerationMutation(v10);
        -[NPKProtoRetrievePaymentTransactionsResponse addTransactionPassIDs:](self, "addTransactionPassIDs:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * v14++), (_QWORD)v15);
      }
      while (v12 != v14);
