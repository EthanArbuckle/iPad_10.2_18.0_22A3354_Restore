...
- (id)description
{
  ...
  -[NPKProtoDeviceDidRegisterResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoDeviceDidRegisterResponse dictionaryRepresentation](self, "dictionaryRepresentation");
