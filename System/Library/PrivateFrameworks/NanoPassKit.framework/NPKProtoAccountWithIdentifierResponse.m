...
- (id)description
{
  ...
  -[NPKProtoAccountWithIdentifierResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoAccountWithIdentifierResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_accountData, "hash");
