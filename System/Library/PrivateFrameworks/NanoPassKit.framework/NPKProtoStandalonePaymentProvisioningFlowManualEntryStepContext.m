...
- (id)description
{
  ...
  -[NPKProtoStandalonePaymentProvisioningFlowManualEntryStepContext description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoStandalonePaymentProvisioningFlowManualEntryStepContext dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_cameraFirstProvisioningEnabled);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("cameraFirstProvisioningEnabled"));

  }
  if (-[NSMutableArray count](self->_setupFields, "count"))
  {
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEB8]), "initWithCapacity:", -[NSMutableArray count](self->_setupFields, "count"));
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("setupFields"));
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  v9 = v4;
  if (-[NPKProtoStandalonePaymentProvisioningFlowManualEntryStepContext setupFieldsCount](self, "setupFieldsCount"))
  {
    objc_msgSend(v9, "clearSetupFields");
    v5 = -[NPKProtoStandalonePaymentProvisioningFlowManualEntryStepContext setupFieldsCount](self, "setupFieldsCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        -[NPKProtoStandalonePaymentProvisioningFlowManualEntryStepContext setupFieldsAtIndex:](self, "setupFieldsAtIndex:", i);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v9, "addSetupFields:", v8);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *(_BYTE *)(v5 + 16) = self->_cameraFirstProvisioningEnabled;
    *(_BYTE *)(v5 + 20) |= 1u;
  }
  v16 = 0u;
  v17 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v6, "addSetupFields:", v12);
...
LABEL_12:
  setupFields = self->_setupFields;
  if ((unint64_t)setupFields | *((_QWORD *)v4 + 1))
    v5 = -[NSMutableArray isEqual:](setupFields, "isEqual:");
  else
    v5 = 1;
LABEL_7:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSMutableArray hash](self->_setupFields, "hash") ^ v2;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((*((_BYTE *)v4 + 20) & 1) != 0)
  {
    self->_cameraFirstProvisioningEnabled = *((_BYTE *)v4 + 16);
    *(_BYTE *)&self->_has |= 1u;
  }
  v13 = 0u;
  v14 = 0u;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v12 != v9)
          objc_enumerationMutation(v6);
        -[NPKProtoStandalonePaymentProvisioningFlowManualEntryStepContext addSetupFields:](self, "addSetupFields:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * v10++), (_QWORD)v11);
      }
      while (v8 != v10);
