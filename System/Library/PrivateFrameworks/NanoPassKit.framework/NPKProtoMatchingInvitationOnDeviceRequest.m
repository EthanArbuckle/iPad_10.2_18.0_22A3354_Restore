...
- (id)description
{
  ...
  -[NPKProtoMatchingInvitationOnDeviceRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoMatchingInvitationOnDeviceRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_timeoutInSeconds);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("timeoutInSeconds"));
...
- (void)copyTo:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)v4 + 1) = self->_timeoutInSeconds;
    *((_BYTE *)v4 + 24) |= 1u;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = v6;
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *(_QWORD *)(v5 + 8) = self->_timeoutInSeconds;
    *(_BYTE *)(v5 + 24) |= 1u;
  }
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_8;
  invitationData = self->_invitationData;
  if ((unint64_t)invitationData | *((_QWORD *)v4 + 2))
  {
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) != 0 && self->_timeoutInSeconds == *((_QWORD *)v4 + 1))
    {
      v6 = 1;
      goto LABEL_9;
    }
