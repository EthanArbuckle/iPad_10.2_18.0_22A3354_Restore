...
- (id)description
{
  ...
  -[NPKProtoSetPeerPaymentPreferencesRequest description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NPKProtoSetPeerPaymentPreferencesRequest dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (peerPaymentPreferencesData)
    objc_msgSend(v3, "setObject:forKey:", peerPaymentPreferencesData, CFSTR("peerPaymentPreferencesData"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  peerPaymentPreferencesData = self->_peerPaymentPreferencesData;
  if (peerPaymentPreferencesData)
    objc_msgSend(a3, "setPeerPaymentPreferencesData:", peerPaymentPreferencesData);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSData copyWithZone:](self->_peerPaymentPreferencesData, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)peerPaymentPreferencesData | v4[1])
      v6 = -[NSData isEqual:](peerPaymentPreferencesData, "isEqual:");
    else
      v6 = 1;
  }
  else
...
- (unint64_t)hash
{
  return -[NSData hash](self->_peerPaymentPreferencesData, "hash");
}
...
{
  objc_storeStrong((id *)&self->_peerPaymentPreferencesData, a3);
}
