...
- (PBUIWallpaperPreheatAction)initWithVariant:(int64_t)a3
{
  ...
  v7 = -[PBUIWallpaperPreheatAction initWithInfo:responder:](&v9, sel_initWithInfo_responder_, v5, 0);
...
- (int64_t)variant
{
  ...
  -[PBUIWallpaperPreheatAction info](self, "info");
