...
- (PBUIWallpaperDidChangeAction)initWithVariant:(int64_t)a3
{
  id v5;
  void *v6;
  PBUIWallpaperDidChangeAction *v7;
  objc_super v9;
  ...
  v7 = -[PBUIWallpaperDidChangeAction initWithInfo:responder:](&v9, sel_initWithInfo_responder_, v5, 0);
...
- (int64_t)variant
{
  ...
  -[PBUIWallpaperDidChangeAction info](self, "info");
