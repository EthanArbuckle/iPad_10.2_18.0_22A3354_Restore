...
{
  PBUIDefaultSessionReconnectPolicy *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)PBUIDefaultSessionReconnectPolicy;
  result = -[PBUIDefaultSessionReconnectPolicy init](&v3, sel_init);
  if (result)
    *(_OWORD *)&result->_intervalMovingAverage = xmmword_1B723FD40;
  return result;
}
