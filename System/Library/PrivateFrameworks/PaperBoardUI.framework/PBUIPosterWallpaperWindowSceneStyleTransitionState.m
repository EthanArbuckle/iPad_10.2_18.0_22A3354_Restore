...
{
  PBUIPosterWallpaperWindowSceneStyleTransitionState *result;
  uint64_t i;
  objc_super v4;

  v4.receiver = self;
  v4.super_class = (Class)PBUIPosterWallpaperWindowSceneStyleTransitionState;
  result = -[PBUIPosterWallpaperWindowSceneStyleTransitionState init](&v4, sel_init);
  if (result)
  {
    for (i = 8; i != 168; i += 32)
...
{
  return (NSString *)-[PBUIPosterWallpaperWindowSceneStyleTransitionState descriptionWithMultilinePrefix:](self, "descriptionWithMultilinePrefix:", 0);
}
...
{
  id v4;
  PBUIPosterWallpaperWindowSceneStyleTransitionState *v5;
  void *v6;
  void *v7;
  size_t count;
  size_t v9;
  ...
  v4 = a3;
  v5 = -[PBUIPosterWallpaperWindowSceneStyleTransitionState init](self, "init");
  if (v5)
  {
    v18 = v4;
      ...
      if (count)
      {
        ...
        for (i = 0; i != v9; ++i)
        {
          ...
          if (v11)
          {
            ...
            v19[1] = v15;
            *(double *)&v19[2] = v16;
            -[PBUIPosterWallpaperWindowSceneStyleTransitionState setWallpaperStyleTransitionState:forPriority:](v5, "setWallpaperStyleTransitionState:forPriority:", v19, uint64);
          }
...
- (id)succinctDescription
{
  ...
  -[PBUIPosterWallpaperWindowSceneStyleTransitionState succinctDescriptionBuilder](self, "succinctDescriptionBuilder");
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  ...
  -[PBUIPosterWallpaperWindowSceneStyleTransitionState descriptionBuilderWithMultilinePrefix:](self, "descriptionBuilderWithMultilinePrefix:", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  do
  {
    ...
    *(_OWORD *)((char *)v16 + 15) = *(_OWORD *)(v7 + 15);
    if ((v9 & 1) != 0)
    {
      ...
      v12[0] = v8;
      v12[1] = 3221225472;
      v12[2] = __92__PBUIPosterWallpaperWindowSceneStyleTransitionState_descriptionBuilderWithMultilinePrefix___block_invoke;
      v12[3] = &unk_1E6B949B8;
      v13 = v5;
      v14 = v9;
      *(_OWORD *)v15 = v16[0];
