...
{
  return (PBUIWallpaperLegacyDefaultsDomain *)-[BSAbstractDefaultDomain _initWithDomain:](self, "_initWithDomain:", CFSTR("com.apple.springboard"));
}
...
- (void)_bindAndRegisterDefaults
{
  ...
  -[BSAbstractDefaultDomain _bindProperty:withDefaultKey:toDefaultValue:options:](self, "_bindProperty:withDefaultKey:toDefaultValue:options:", v10, CFSTR("SBWallpaperParallaxFactorHomeScreen"), &unk_1E6BC3568, 1);

  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "homeScreenZoomScale");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[BSAbstractDefaultDomain _bindProperty:withDefaultKey:toDefaultValue:options:](self, "_bindProperty:withDefaultKey:toDefaultValue:options:", v11, CFSTR("SBWallpaperZoomScaleHomeScreen"), &unk_1E6BC3568, 1);
  ...
  -[BSAbstractDefaultDomain _bindProperty:withDefaultKey:toDefaultValue:options:](self, "_bindProperty:withDefaultKey:toDefaultValue:options:", v19, CFSTR("SBWallpaperParallaxFactorLockScreen"), &unk_1E6BC3568, 1);

  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "lockScreenZoomScale");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  -[BSAbstractDefaultDomain _bindProperty:withDefaultKey:toDefaultValue:options:](self, "_bindProperty:withDefaultKey:toDefaultValue:options:", v20, CFSTR("SBWallpaperZoomScaleLockScreen"), &unk_1E6BC3568, 1);
  ...
  -[BSAbstractDefaultDomain _bindProperty:withDefaultKey:toDefaultValue:options:](self, "_bindProperty:withDefaultKey:toDefaultValue:options:", v26, CFSTR("SBWallpaperStillTimeInVideoKey"), &unk_1E6BC34C0, 1);
