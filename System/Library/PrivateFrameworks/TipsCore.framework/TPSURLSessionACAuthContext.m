...
void __44__TPSURLSessionACAuthContext_defaultContext__block_invoke()
{
  TPSURLSessionACAuthContext *v0;
  void *v1;

  v0 = -[TPSURLSessionACAuthContext initWithAppIdentifier:enviromentIdentifier:interactivity:]([TPSURLSessionACAuthContext alloc], "initWithAppIdentifier:enviromentIdentifier:interactivity:", CFSTR("170617"), CFSTR("APPLECONNECT.APPLE.COM"), CFSTR("0"));
...
- (TPSURLSessionACAuthContext)initWithAppIdentifier:(id)a3 enviromentIdentifier:(id)a4 interactivity:(id)a5
{
  ...
  id v10;
  id v11;
  TPSURLSessionACAuthContext *v12;
  TPSURLSessionACAuthContext *v13;
  objc_super v15;
  ...
  v12 = -[TPSURLSessionACAuthContext init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[TPSURLSessionACAuthContext appIdentifier](self, "appIdentifier");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setAppIdentifier:", v5);

  -[TPSURLSessionACAuthContext enviromentIdentifier](self, "enviromentIdentifier");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setEnviromentIdentifier:", v6);

  -[TPSURLSessionACAuthContext interactivityMode](self, "interactivityMode");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setInteractivityMode:", v7);

  -[TPSURLSessionACAuthContext clientIdentifier](self, "clientIdentifier");
