...
- (TPSSearchQueryClient)init
{
  ...
  v2 = -[TPSSearchQueryClient init](&v10, sel_init);
  if (v2)
  {
...
- (void)performQuery:(id)a3 completion:(id)a4
{
  ...
  v6 = a3;
  -[TPSSearchQueryClient _objectCompletionOnClientQueue:](self, "_objectCompletionOnClientQueue:", a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = MEMORY[0x1E0C809B0];
  v13[0] = MEMORY[0x1E0C809B0];
  v13[1] = 3221225472;
  v13[2] = __48__TPSSearchQueryClient_performQuery_completion___block_invoke;
  v13[3] = &unk_1E395BEB8;
  v14 = v6;
  v15 = v7;
  v11[0] = v8;
  v11[1] = 3221225472;
  v11[2] = __48__TPSSearchQueryClient_performQuery_completion___block_invoke_2;
  v11[3] = &unk_1E395B358;
  v12 = v15;
  v9 = v15;
  v10 = v6;
  -[TPSSearchQueryClient _performWithProxyHandler:errorHandler:](self, "_performWithProxyHandler:errorHandler:", v13, v11);

}

uint64_t __48__TPSSearchQueryClient_performQuery_completion___block_invoke(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "performQuery:completion:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40));
}
...
- (void)cancelQueryWithIdentifier:(id)a3
{
  ...
  v9[1] = 3221225472;
  v9[2] = __50__TPSSearchQueryClient_cancelQueryWithIdentifier___block_invoke;
  v9[3] = &unk_1E395BEE0;
  v10 = v4;
  v7[0] = v5;
  v7[1] = 3221225472;
  v7[2] = __50__TPSSearchQueryClient_cancelQueryWithIdentifier___block_invoke_2;
  v7[3] = &unk_1E395C610;
  v8 = v10;
  v6 = v10;
  -[TPSSearchQueryClient _performWithProxyHandler:errorHandler:](self, "_performWithProxyHandler:errorHandler:", v9, v7);

}

uint64_t __50__TPSSearchQueryClient_cancelQueryWithIdentifier___block_invoke(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "cancelQueryWithIdentifier:", *(_QWORD *)(a1 + 32));
}
...
void __50__TPSSearchQueryClient_cancelQueryWithIdentifier___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  +[TPSLogger search](TPSLogger, "search");
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 2112;
    v9 = v3;
    _os_log_impl(&dword_19A906000, v4, OS_LOG_TYPE_DEFAULT, "cancelQueryWithIdentifier(%@) xpc connection failed: %@", (uint8_t *)&v6, 0x16u);
  }
...
- (void)reindexAllSearchableItemsWithCompletionHandler:(id)a3
{
  ...
  v9[0] = MEMORY[0x1E0C809B0];
  v9[1] = 3221225472;
  v9[2] = __71__TPSSearchQueryClient_reindexAllSearchableItemsWithCompletionHandler___block_invoke;
  v9[3] = &unk_1E395BE90;
  v10 = v4;
  v7[0] = v5;
  v7[1] = 3221225472;
  v7[2] = __71__TPSSearchQueryClient_reindexAllSearchableItemsWithCompletionHandler___block_invoke_2;
  v7[3] = &unk_1E395B358;
  v8 = v10;
  v6 = v10;
  -[TPSSearchQueryClient _performWithProxyHandler:errorHandler:](self, "_performWithProxyHandler:errorHandler:", v9, v7);
...
{
  return objc_msgSend(a2, "reindexAllSearchableItemsWithCompletionHandler:", *(_QWORD *)(a1 + 32));
}
...
- (void)reindexSearchableItemsWithIdentifiers:(id)a3 completionHandler:(id)a4
{
  ...
  v13[0] = MEMORY[0x1E0C809B0];
  v13[1] = 3221225472;
  v13[2] = __80__TPSSearchQueryClient_reindexSearchableItemsWithIdentifiers_completionHandler___block_invoke;
  v13[3] = &unk_1E395BEB8;
  v14 = v6;
  v15 = v7;
  v11[0] = v8;
  v11[1] = 3221225472;
  v11[2] = __80__TPSSearchQueryClient_reindexSearchableItemsWithIdentifiers_completionHandler___block_invoke_2;
  v11[3] = &unk_1E395B358;
  v12 = v15;
  v9 = v15;
  v10 = v6;
...
{
  return objc_msgSend(a2, "reindexSearchableItemsWithIdentifiers:completionHandler:", *(_QWORD *)(a1 + 32), *(_QWORD *)(a1 + 40));
}
...
- (void)deleteAllSearchableItemsWithCompletionHandler:(id)a3
{
  ...
  v9[0] = MEMORY[0x1E0C809B0];
  v9[1] = 3221225472;
  v9[2] = __70__TPSSearchQueryClient_deleteAllSearchableItemsWithCompletionHandler___block_invoke;
  v9[3] = &unk_1E395BE90;
  v10 = v4;
  v7[0] = v5;
  v7[1] = 3221225472;
  v7[2] = __70__TPSSearchQueryClient_deleteAllSearchableItemsWithCompletionHandler___block_invoke_2;
  v7[3] = &unk_1E395B358;
  v8 = v10;
  v6 = v10;
  -[TPSSearchQueryClient _performWithProxyHandler:errorHandler:](self, "_performWithProxyHandler:errorHandler:", v9, v7);
...
{
  return objc_msgSend(a2, "deleteAllSearchableItemsWithCompletionHandler:", *(_QWORD *)(a1 + 32));
}
...
uint64_t __55__TPSSearchQueryClient__objectCompletionOnClientQueue___block_invoke_2(_QWORD *a1)
{
  uint64_t result;
