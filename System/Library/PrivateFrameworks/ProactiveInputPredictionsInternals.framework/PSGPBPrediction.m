...
- (id)description
{
  ...
  -[PSGPBPrediction description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PSGPBPrediction dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_33:
  ...
  {
    v28 = off_24FCB49C0[dataSourceType];
  }
...
LABEL_46:
    ...
    {
      v30 = off_24FCB4A18[triggerSourceType];
    }
...
LABEL_50:
  ...
  if ((v35 & 0x1000) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_portraitTimeout);
    v36 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v36, CFSTR("portrait_timeout"));

    v35 = (__int16)self->_has;
  }
  if ((v35 & 0x2000) != 0)
  {
    objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_requiredAppUnavailable);
    v37 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v37, CFSTR("required_app_unavailable"));
...
LABEL_11:
  ...
  if ((v8 & 0x1000) != 0)
  {
    *((_BYTE *)v4 + 145) = self->_portraitTimeout;
    *((_WORD *)v4 + 74) |= 0x1000u;
    v8 = (__int16)self->_has;
    if ((v8 & 0x2000) == 0)
    {
LABEL_41:
  ...
  *((_BYTE *)v4 + 146) = self->_requiredAppUnavailable;
  *((_WORD *)v4 + 74) |= 0x2000u;
  v8 = (__int16)self->_has;
  if ((v8 & 0x80) == 0)
  {
...
LABEL_5:
  ...
  *(_QWORD *)(v5 + 104) = v31;
  ...
  if ((v33 & 0x1000) != 0)
  {
    *(_BYTE *)(v5 + 145) = self->_portraitTimeout;
...
LABEL_17:
  ...
  *(_BYTE *)(v5 + 146) = self->_requiredAppUnavailable;
...
- (unint64_t)hash
{
  ...
  v33 = -[NSString hash](self->_experimentId, "hash");
  v32 = -[NSString hash](self->_treatmentId, "hash");
  v31 = -[NSString hash](self->_treatmentName, "hash");
  if ((*(_WORD *)&self->_has & 0x200) == 0)
  {
    v30 = 0;
    if ((*(_WORD *)&self->_has & 0x800) != 0)
...
LABEL_7:
  v28 = 0;
LABEL_8:
  v27 = -[NSString hash](self->_textContentType, "hash");
  v26 = -[NSString hash](self->_localeIdentifier, "hash");
  v25 = -[NSString hash](self->_bundleIdentifier, "hash");
  has = (__int16)self->_has;
  if ((has & 8) != 0)
  {
...
LABEL_10:
  ...
  v23 = 0;
LABEL_13:
  v21 = -[NSString hash](self->_initiatingProcess, "hash");
  if ((*(_WORD *)&self->_has & 0x20) != 0)
    v4 = 2654435761 * self->_numTextualResponseItems;
  else
    v4 = 0;
  v5 = -[NSString hash](self->_textualResponseCategory, "hash", v21);
  v6 = (__int16)self->_has;
  if ((v6 & 0x10) != 0)
  {
...
LABEL_11:
  ...
  if ((v8 & 0x1000) != 0)
  {
    self->_portraitTimeout = *((_BYTE *)v4 + 145);
    *(_WORD *)&self->_has |= 0x1000u;
    v8 = *((_WORD *)v4 + 74);
    if ((v8 & 0x2000) == 0)
    {
LABEL_41:
  ...
  self->_requiredAppUnavailable = *((_BYTE *)v4 + 146);
  *(_WORD *)&self->_has |= 0x2000u;
  v8 = *((_WORD *)v4 + 74);
  if ((v8 & 0x80) == 0)
  {
