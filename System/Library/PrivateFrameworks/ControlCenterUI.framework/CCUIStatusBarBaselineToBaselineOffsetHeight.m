@implementation CCUIStatusBarBaselineToBaselineOffsetHeight
    ...
    else
    {
      ...
      if (objc_msgSend(v8, "userInterfaceIdiom") != 1)
      {
        ...
        if (CGRectGetWidth(v17) < 430.0)
        {
          ...
          {
            CCUIReferenceScreenBounds();
            if (CGRectGetWidth(v19) < 414.0 || (v9 = 23.0, SBFEffectiveHomeButtonType() != 2))
            {
              CCUIReferenceScreenBounds();
              v9 = 18.0;
      ...
      CCUIStatusBarBaselineToBaselineOffsetHeight_height = *(_QWORD *)&v9;
...
LABEL_37:
  ...
  else
  {
    ...
    if (v10 < 375.0)
    {
      v11 = *(double *)&CCUIStatusBarBaselineToBaselineOffsetHeight_height;
      if (*(double *)&CCUIStatusBarBaselineToBaselineOffsetHeight_height < 22.0)
        v11 = 22.0;
      CCUIStatusBarBaselineToBaselineOffsetHeight_height = *(_QWORD *)&v11;
    }
  }
}
