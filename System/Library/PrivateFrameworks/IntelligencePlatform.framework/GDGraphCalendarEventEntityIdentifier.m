...
{
  return (id)MEMORY[0x1E0DE7D20](a3, sel_graphCalendarEventFromEntityIdentifier_error_, self);
}
...
- (NSString)description
{
  ...
  v8 = (void *)objc_msgSend_initWithFormat_(v3, v7, (uint64_t)CFSTR("<GDGraphCalendarEventEntityIdentifier: %@>"), v6);
...
{
  return (GDGraphCalendarEventEntityIdentifier *)MEMORY[0x1E0DE7D20](self, sel_initFromGDEntityIdentifier_, a3);
}
