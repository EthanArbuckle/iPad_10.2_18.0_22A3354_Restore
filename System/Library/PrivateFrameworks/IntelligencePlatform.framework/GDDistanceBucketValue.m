...
{
  GDDistanceBucketValue *result;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GDDistanceBucketValue;
  result = -[GDDistanceBucketValue init](&v7, sel_init);
  if (result)
  {
    result->_bucket = a3;
...
- (GDDistanceBucketValue)initWithCoder:(id)a3
{
  ...
  return (GDDistanceBucketValue *)MEMORY[0x1E0DE7D20](self, sel_initWithBucket_bucketValue_, v11);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = objc_msgSend_allocWithZone_(GDDistanceBucketValue, a2, (uint64_t)a3);
...
- (id)description
{
  ...
  if (bucket > 4)
    ...
    v4 = off_1E5DD9578[bucket];
  v5 = objc_alloc(MEMORY[0x1E0CB3940]);
  return (id)objc_msgSend_initWithFormat_(v5, v6, (uint64_t)CFSTR("GDDistanceBucketValue<bucket: %@, bucketValue: %lf>"), v4, *(_QWORD *)&self->_bucketValue);
}
