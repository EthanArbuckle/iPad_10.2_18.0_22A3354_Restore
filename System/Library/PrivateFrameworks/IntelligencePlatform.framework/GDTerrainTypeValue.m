...
{
  GDTerrainTypeValue *result;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)GDTerrainTypeValue;
  result = -[GDTerrainTypeValue init](&v7, sel_init);
  if (result)
  {
    result->_type = a3;
...
- (GDTerrainTypeValue)initWithCoder:(id)a3
{
  ...
  return (GDTerrainTypeValue *)MEMORY[0x1E0DE7D20](self, sel_initWithType_typeValue_, v11);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = objc_msgSend_allocWithZone_(GDTerrainTypeValue, a2, (uint64_t)a3);
...
- (id)description
{
  ...
  if (type > 3)
    ...
    v4 = off_1E5DD95A0[type];
  v5 = objc_alloc(MEMORY[0x1E0CB3940]);
  return (id)objc_msgSend_initWithFormat_(v5, v6, (uint64_t)CFSTR("GDTerrainTypeValue<type: %@, typeValue: %lf>"), v4, *(_QWORD *)&self->_typeValue);
}
