...
{
  return (id)MEMORY[0x1E0DE7D20](a3, sel_graphSportsTeamFromEntityIdentifier_error_, self);
}
...
- (NSString)description
{
  ...
  v8 = (void *)objc_msgSend_initWithFormat_(v3, v7, (uint64_t)CFSTR("<GDGraphSportsTeamEntityIdentifier: %@>"), v6);
...
{
  return (GDGraphSportsTeamEntityIdentifier *)MEMORY[0x1E0DE7D20](self, sel_initFromGDEntityIdentifier_, a3);
}
