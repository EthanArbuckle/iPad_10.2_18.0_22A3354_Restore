...
- (GDGraphAttendingAPerformanceActivityEvent)initWithEntityIdentifierField:(id)a3 nameField:(id)a4 dateField:(id)a5 attendeesField:(id)a6 locationsField:(id)a7 startLocationField:(id)a8 endLocationField:(id)a9 activityTypeObjectField:(id)a10 activityTypeField:(id)a11 confidenceField:(id)a12 allNameField:(id)a13 allDateField:(id)a14 allStartLocationField:(id)a15 allEndLocationField:(id)a16 allActivityTypeObjectField:(id)a17 allActivityTypeField:(id)a18 allConfidenceField:(id)a19
{
  ...
  id v28;
  id v29;
  GDGraphAttendingAPerformanceActivityEvent *v30;
  GDGraphAttendingAPerformanceActivityEvent *v31;
  id v34;
  id v35;
  id v37;
  id v38;
  ...
  v30 = -[GDGraphAttendingAPerformanceActivityEvent init](&v48, sel_init);
  v31 = v30;
  if (v30)
  {
