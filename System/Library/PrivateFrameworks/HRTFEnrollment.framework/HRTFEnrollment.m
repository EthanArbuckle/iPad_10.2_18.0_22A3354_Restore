...
void HRTFEnrollmentLogInit(int a1)
{
  ...
  if (a1)
    ...
    v1 = "Framework";
  v2 = os_log_create("com.apple.HRTFEnrollment", v1);
  ...
  {
    *(_WORD *)v5 = 0;
    _os_log_impl(&dword_22153F000, v4, OS_LOG_TYPE_INFO, "logging initialized", v5, 2u);
  }
}
...
void sub_221545F24(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_list va;
...
void sub_221546178(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  uint64_t v3;
...
void sub_22154659C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_2215467A8(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  uint64_t v3;
...
void sub_221546B70(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_221546D7C(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  uint64_t v3;
...
void sub_221547148(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_221547494(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  uint64_t v11;
  va_list va;
...
uint64_t __Block_byref_object_copy__171(uint64_t a1, uint64_t a2)
{
  uint64_t result;

  result = MEMORY[0x22766DCE8](*(_QWORD *)(a2 + 40));
  *(_QWORD *)(a1 + 40) = result;
  return result;
}
...
void sub_2215477A4(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_22154847C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id obj)
{
  objc_sync_exit(obj);
  _Unwind_Resume(a1);
}

void sub_221548640(_Unwind_Exception *a1)
{
  void *v1;
  void *v2;
  void *v3;
...
void sub_221548A48(_Unwind_Exception *a1)
{
  void *v1;
  void *v2;
  void *v3;
...
void sub_221549168(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, void *a14, void *a15, uint64_t a16, uint64_t a17, void *a18)
{
  void *v18;
  void *v19;
...
void sub_2215492F0(_Unwind_Exception *a1)
{
  void *v1;
  void *v2;
...
void sub_22154937C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *a10)
{

  _Unwind_Resume(a1);
}

void sub_221549404(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *a10)
{
