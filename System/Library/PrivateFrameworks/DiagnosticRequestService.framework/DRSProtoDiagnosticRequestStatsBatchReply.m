...
- (NSString)description
{
  ...
  -[DRSProtoDiagnosticRequestStatsBatchReply description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[DRSProtoDiagnosticRequestStatsBatchReply dictionaryRepresentation](self, "dictionaryRepresentation");
