...
- (id)description
{
  ...
  -[DRSProtoDecisionResult description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[DRSProtoDecisionResult dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_accepted);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v4, CFSTR("accepted"));

  }
  rejectionReason = self->_rejectionReason;
  if (rejectionReason)
    objc_msgSend(v3, "setObject:forKey:", rejectionReason, CFSTR("rejection_reason"));
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *(_BYTE *)(v5 + 16) = self->_accepted;
    *(_BYTE *)(v5 + 20) |= 1u;
  }
  v7 = -[NSString copyWithZone:](self->_rejectionReason, "copyWithZone:", a3);
  v8 = (void *)v6[1];
  v6[1] = v7;
...
LABEL_12:
  rejectionReason = self->_rejectionReason;
  if ((unint64_t)rejectionReason | *((_QWORD *)v4 + 1))
    v5 = -[NSString isEqual:](rejectionReason, "isEqual:");
  else
    v5 = 1;
LABEL_7:
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSString hash](self->_rejectionReason, "hash") ^ v2;
}
