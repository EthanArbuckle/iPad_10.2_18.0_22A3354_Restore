...
- (id)description
{
  ...
  -[IDSQRProtoAllocBindJoinInfo description](&v13, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    ...
    if (reason)
    {
      if (reason == 1)
      {
        v17 = CFSTR("NEWLY_JOINED");
        objc_msgSend_setObject_forKey_(v7, v5, (uint64_t)CFSTR("NEWLY_JOINED"), v8, CFSTR("reason"));
      }
      else
      {
        objc_msgSend_stringWithFormat_(MEMORY[0x1E0CB3940], v5, (uint64_t)CFSTR("(unknown: %i)"), v8, self->_reason);
        v17 = (__CFString *)objc_claimAutoreleasedReturnValue();
        objc_msgSend_setObject_forKey_(v7, v18, (uint64_t)v17, v19, CFSTR("reason"));
      }
    }
    else
    {
      v17 = CFSTR("NONE");
      objc_msgSend_setObject_forKey_(v7, v5, (uint64_t)CFSTR("NONE"), v8, CFSTR("reason"));
    }
