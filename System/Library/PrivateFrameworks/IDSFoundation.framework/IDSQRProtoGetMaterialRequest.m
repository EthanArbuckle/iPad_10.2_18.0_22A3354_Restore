...
- (id)description
{
  ...
  -[IDSQRProtoGetMaterialRequest description](&v13, sel_description);
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_materialOwners, v6, v7, v8))
  {
    ...
    v13 = objc_msgSend_count(self->_materialOwners, v10, v11, v12);
    ...
    objc_msgSend_setObject_forKey_(v5, v30, (uint64_t)v16, v31, CFSTR("material_owners"));
  }
  return v5;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_materialOwnersCount(self, v4, v5, v6))
  {
    ...
    v13 = objc_msgSend_materialOwnersCount(self, v10, v11, v12);
    if (v13)
    {
      v16 = v13;
      for (i = 0; i != v16; ++i)
      {
        objc_msgSend_materialOwnersAtIndex_(self, v14, i, v15);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5, v7))
  {
    ...
    if ((unint64_t)materialOwners | v11)
      isEqual = objc_msgSend_isEqual_(materialOwners, v8, v11, v9);
    else
      isEqual = 1;
  }
  else
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addMaterialOwners_(self, v8, *(_QWORD *)(*((_QWORD *)&v13 + 1) + 8 * v12++), v9, (_QWORD)v13);
      }
      while (v10 != v12);
...
{
  objc_storeStrong((id *)&self->_materialOwners, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_materialOwners, 0);
}
