...
{
  IDSSocketPairAckMessage *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)IDSSocketPairAckMessage;
  result = -[IDSSocketPairAckMessage init](&v5, sel_init);
  if (result)
...
- (id)_nonHeaderData
{
  ...
  v12 = bswap32(objc_msgSend_sequenceNumber(self, v6, v7, v8));
