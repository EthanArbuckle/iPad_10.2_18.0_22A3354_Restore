...
- (NSString)name
{
  return (NSString *)CFSTR("LocalMessageTimedOut");
}
...
{
  id v16;
  IDSLocalMessageTimedOutMetric *v17;
  IDSLocalMessageTimedOutMetric *v18;
  objc_super v20;

  v16 = a3;
  v20.receiver = self;
  v20.super_class = (Class)IDSLocalMessageTimedOutMetric;
  v17 = -[IDSLocalMessageTimedOutMetric init](&v20, sel_init);
  v18 = v17;
  if (v17)
  {
