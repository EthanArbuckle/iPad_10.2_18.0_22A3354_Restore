...
- (NSString)name
{
  return (NSString *)CFSTR("IDSLocalMessageDeliveryServiceNotCompatible");
}
...
{
  id v16;
  IDSLocalMessageDeliveryServiceNotCompatibleMetric *v17;
  IDSLocalMessageDeliveryServiceNotCompatibleMetric *v18;
  objc_super v20;

  v16 = a3;
  v20.receiver = self;
  v20.super_class = (Class)IDSLocalMessageDeliveryServiceNotCompatibleMetric;
  v17 = -[IDSLocalMessageDeliveryServiceNotCompatibleMetric init](&v20, sel_init);
  v18 = v17;
  if (v17)
  {
