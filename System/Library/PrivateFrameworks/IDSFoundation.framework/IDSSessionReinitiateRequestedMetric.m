...
- (NSString)name
{
  return (NSString *)CFSTR("SessionReinitiateRequested");
}
...
{
  id v5;
  IDSSessionReinitiateRequestedMetric *v6;
  IDSSessionReinitiateRequestedMetric *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)IDSSessionReinitiateRequestedMetric;
  v6 = -[IDSSessionReinitiateRequestedMetric init](&v9, sel_init);
  v7 = v6;
  if (v6)
