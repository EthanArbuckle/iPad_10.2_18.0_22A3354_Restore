...
- (NSString)name
{
  return (NSString *)CFSTR("IDSRegistrationOperationGetHandles");
}
...
- (IDSRegistrationOperationGetHandlesMetric)initWithGuid:(id)a3 success:(BOOL)a4 connectionType:(unsigned int)a5 resultCode:(unsigned int)a6 registrationType:(unsigned int)a7 genericError:(id)a8 URLError:(id)a9 POSIXError:(id)a10
{
  ...
  id v16;
  id v17;
  IDSRegistrationOperationGetHandlesMetric *v18;
  IDSRegistrationOperationGetHandlesMetric *v19;
  id v23;
  objc_super v24;
  ...
  v18 = -[IDSRegistrationOperationGetHandlesMetric init](&v24, sel_init);
  v19 = v18;
  if (v18)
  {
