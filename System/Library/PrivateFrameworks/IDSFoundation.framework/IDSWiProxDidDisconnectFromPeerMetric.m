...
- (NSString)name
{
  return (NSString *)CFSTR("WiProxDidDisconnectFromPeer");
}
...
{
  IDSWiProxDidDisconnectFromPeerMetric *result;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)IDSWiProxDidDisconnectFromPeerMetric;
  result = -[IDSWiProxDidDisconnectFromPeerMetric init](&v7, sel_init);
  if (result)
  {
    result->_duration = a3;
