...
- (NSString)name
{
  return (NSString *)CFSTR("LocalDeliveryMessageSent");
}
...
{
  id v13;
  IDSLocalDeliveryMessageSentMetric *v14;
  IDSLocalDeliveryMessageSentMetric *v15;
  objc_super v17;

  v13 = a3;
  v17.receiver = self;
  v17.super_class = (Class)IDSLocalDeliveryMessageSentMetric;
  v14 = -[IDSLocalDeliveryMessageSentMetric init](&v17, sel_init);
  v15 = v14;
  if (v14)
  {
