...
- (NSString)name
{
  return (NSString *)CFSTR("IDSRegistrationProfileOperationUnlinkHandles");
}
...
- (IDSRegistrationProfileOperationUnlinkHandles)initWithGuid:(id)a3 success:(BOOL)a4 connectionType:(unsigned int)a5 resultCode:(unsigned int)a6 registrationError:(unsigned int)a7 genericError:(id)a8 URLError:(id)a9 POSIXError:(id)a10
{
  ...
  id v16;
  id v17;
  IDSRegistrationProfileOperationUnlinkHandles *v18;
  IDSRegistrationProfileOperationUnlinkHandles *v19;
  id v23;
  objc_super v24;
  ...
  v18 = -[IDSRegistrationProfileOperationUnlinkHandles init](&v24, sel_init);
  v19 = v18;
  if (v18)
  {
