...
- (NSString)name
{
  return (NSString *)CFSTR("IDSLocalDeliveryMessageDelivered");
}
...
{
  id v16;
  IDSLocalDeliveryMessageDeliveredMetric *v17;
  IDSLocalDeliveryMessageDeliveredMetric *v18;
  objc_super v20;

  v16 = a3;
  v20.receiver = self;
  v20.super_class = (Class)IDSLocalDeliveryMessageDeliveredMetric;
  v17 = -[IDSLocalDeliveryMessageDeliveredMetric init](&v20, sel_init);
  v18 = v17;
  if (v17)
  {
