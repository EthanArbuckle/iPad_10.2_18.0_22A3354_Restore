...
- (ASDRestoreApplicationsRequestResponse)init
{
  void *v3;
  ASDRestoreApplicationsRequestResponse *v4;

  v3 = (void *)objc_opt_new();
  v4 = -[ASDRestoreApplicationsRequestResponse initWithResults:](self, "initWithResults:", v3);
...
{
  id v4;
  ASDRestoreApplicationsRequestResponse *v5;
  uint64_t v6;
  NSArray *results;
  NSArray *v8;
  _QWORD v10[5];
  ...
  v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)ASDRestoreApplicationsRequestResponse;
  v5 = -[ASDRestoreApplicationsRequestResponse init](&v15, sel_init);
  if (v5)
  {
    ...
    v10[1] = 3221225472;
    v10[2] = __57__ASDRestoreApplicationsRequestResponse_initWithResults___block_invoke;
    v10[3] = &unk_1E37BEE88;
    v10[4] = &v11;
...
{
  return -[ASDRestoreApplicationsRequestResponse initWithResults:](+[ASDRestoreApplicationsRequestResponse allocWithZone:](ASDRestoreApplicationsRequestResponse, "allocWithZone:", a3), "initWithResults:", self->_results);
}
...
- (ASDRestoreApplicationsRequestResponse)initWithCoder:(id)a3
{
  ...
  void *v7;
  void *v8;
  ASDRestoreApplicationsRequestResponse *v9;
  ...
  v9 = -[ASDRestoreApplicationsRequestResponse initWithResults:](self, "initWithResults:", v8);
  return v9;
}
