...
{
  id v4;
  ASDManagedApplicationRequest *v5;
  dispatch_queue_t v6;
  ...
  v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)ASDManagedApplicationRequest;
  v5 = -[ASDManagedApplicationRequest init](&v13, sel_init);
  if (v5)
  {
    ...
    options = v5->_options;
    v5->_options = (ASDManagedApplicationRequestOptions *)v10;
...
- (void)dealloc
{
  ...
  -[ASDManagedApplicationRequest dealloc](&v3, sel_dealloc);
}
...
- (void)sendRequestWithCompletionBlock:(id)a3
{
  ...
  ASDManagedApplicationRequestOptions *v8;
  id v9;
  _QWORD block[5];
  ASDManagedApplicationRequestOptions *v11;
  id v12;
...
LABEL_7:
      ...
      *(_QWORD *)(v2 + 24) = v4;
      ...
      objc_msgSend(*(id *)(v2 + 24), "setInvalidationHandler:", &__block_literal_global_5);
      objc_msgSend(*(id *)(v2 + 24), "setInterruptionHandler:", &__block_literal_global_68_0);
...
void __82__ASDManagedApplicationRequest__sendRequestCompletionWithOptions_completionBlock___block_invoke_2(uint64_t a1, void *a2)
{
  uint64_t v3;
  _QWORD v4[5];
  id v5;
  ...
  v4[1] = 3221225472;
  v4[2] = __82__ASDManagedApplicationRequest__sendRequestCompletionWithOptions_completionBlock___block_invoke_3;
  v4[3] = &unk_1E37BE7D0;
  v3 = *(_QWORD *)(a1 + 32);
  v4[4] = *(_QWORD *)(a1 + 40);
  v5 = *(id *)(a1 + 48);
  objc_msgSend(a2, "managedApplicationRequestWithOptions:completionBlock:", v3, v4);
...
void __82__ASDManagedApplicationRequest__sendRequestCompletionWithOptions_completionBlock___block_invoke_3(uint64_t a1, char a2, void *a3, uint64_t a4, void *a5)
{
  ...
  if (v10)
  {
    ...
    v25[1] = 3221225472;
    v25[2] = __82__ASDManagedApplicationRequest__sendRequestCompletionWithOptions_completionBlock___block_invoke_4;
    v25[3] = &unk_1E37BDF10;
    v13 = &v28;
    v28 = v11;
    v14 = &v26;
  ...
  else
  {
    ...
    v20[1] = 3221225472;
    v20[2] = __82__ASDManagedApplicationRequest__sendRequestCompletionWithOptions_completionBlock___block_invoke_5;
    v20[3] = &unk_1E37BE7A8;
    v13 = (id *)v23;
    v23[0] = v11;
    v24 = a2;
...
uint64_t __82__ASDManagedApplicationRequest__sendRequestCompletionWithOptions_completionBlock___block_invoke_4(_QWORD *a1)
{
  return (*(uint64_t (**)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD))(a1[6] + 16))(a1[6], 0, a1[4], 0, a1[5]);
}
...
{
  return (*(uint64_t (**)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD))(*(_QWORD *)(a1 + 40) + 16))(*(_QWORD *)(a1 + 40), 0, MEMORY[0x1E0C9AA70], 0, *(_QWORD *)(a1 + 32));
}
...
void __48__ASDManagedApplicationRequest__setupConnection__block_invoke_67()
{
  uint8_t v0[16];
