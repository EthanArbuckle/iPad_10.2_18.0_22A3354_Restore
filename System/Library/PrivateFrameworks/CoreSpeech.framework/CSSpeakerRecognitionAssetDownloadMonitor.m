...
{
  CSSpeakerRecognitionAssetDownloadMonitor *v2;
  void *v3;
  int v4;
  uint64_t v5;
  CSTrialAssetDownloadMonitor *trialAssetMonitor;
  CSSpeakerRecognitionAssetDownloadMonitor *v7;
  objc_super v9;
  ...
  if (v2)
  {
    ...
    -[CSEventMonitor addObserver:](v2->_trialAssetMonitor, "addObserver:", v2);
...
- (void)_startMonitoringWithQueue:(id)a3
{
  ...
  {
    v5 = a3;
    v6 = -[CSSpeakerRecognitionAssetDownloadMonitor _notificationKey](self, "_notificationKey");
    handler[0] = MEMORY[0x1E0C809B0];
    handler[1] = 3221225472;
    handler[2] = __70__CSSpeakerRecognitionAssetDownloadMonitor__startMonitoringWithQueue___block_invoke;
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D18F60], OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 136315138;
      v10 = "-[CSSpeakerRecognitionAssetDownloadMonitor _startMonitoringWithQueue:]";
      _os_log_impl(&dword_1C2614000, v7, OS_LOG_TYPE_DEFAULT, "%s Start monitoring : SpeakerRecognition Asset Download", buf, 0xCu);
    }
  }
}
...
- (void)_stopMonitoring
{
  ...
  if (notifyToken != -1)
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D18F60], OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1C2614000, v4, OS_LOG_TYPE_DEFAULT, "%s Stop monitoring : SpeakerRecognition Assets Download", (uint8_t *)&v5, 0xCu);
    }
  }
}
...
- (void)_didInstalledNewAsset
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D18F60], OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315138;
    ...
    _os_log_impl(&dword_1C2614000, v3, OS_LOG_TYPE_DEFAULT, "%s New SpeakerRecognition Assets is now installed", buf, 0xCu);
  }
  v4[0] = MEMORY[0x1E0C809B0];
  v4[1] = 3221225472;
  v4[2] = __65__CSSpeakerRecognitionAssetDownloadMonitor__didInstalledNewAsset__block_invoke;
  v4[3] = &unk_1E7C29250;
  v4[4] = self;
...
- (void)_notifyObserver:(id)a3
{
  ...
  objc_msgSend(v4, "CSSpeakerRecognitionAssetDownloadMonitor:didInstallNewAsset:assetProviderType:", self, 1, self->_lastUpdatedAssetType);
...
{
  objc_storeStrong((id *)&self->_trialAssetMonitor, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_trialAssetMonitor, 0);
}

uint64_t __65__CSSpeakerRecognitionAssetDownloadMonitor__didInstalledNewAsset__block_invoke(uint64_t a1, uint64_t a2)
{
  return objc_msgSend(*(id *)(a1 + 32), "_notifyObserver:", a2);
}

uint64_t __70__CSSpeakerRecognitionAssetDownloadMonitor__startMonitoringWithQueue___block_invoke(uint64_t a1)
{
  *(_QWORD *)(*(_QWORD *)(a1 + 32) + 32) = 0;
  return objc_msgSend(*(id *)(a1 + 32), "_didInstalledNewAsset");
}

+ (id)sharedInstance
{
  if (sharedInstance_onceToken_2807 != -1)
    dispatch_once(&sharedInstance_onceToken_2807, &__block_literal_global_2808);
  return (id)sharedInstance__sharedInstance_2809;
}

void __58__CSSpeakerRecognitionAssetDownloadMonitor_sharedInstance__block_invoke()
{
  CSSpeakerRecognitionAssetDownloadMonitor *v0;
  void *v1;

  v0 = objc_alloc_init(CSSpeakerRecognitionAssetDownloadMonitor);
  v1 = (void *)sharedInstance__sharedInstance_2809;
  sharedInstance__sharedInstance_2809 = (uint64_t)v0;
