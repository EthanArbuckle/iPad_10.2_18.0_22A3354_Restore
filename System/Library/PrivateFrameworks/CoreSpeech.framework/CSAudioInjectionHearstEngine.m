...
{
  CSAudioInjectionHearstEngine *v4;
  dispatch_queue_t v5;
  ...
  v4 = -[CSAudioInjectionEngine initWithStreamHandleId:](&v20, sel_initWithStreamHandleId_);
  if (v4)
  {
    v5 = dispatch_queue_create("CSAudioInjectionHearstEngine", 0);
    queue = v4->_queue;
    v4->_queue = (OS_dispatch_queue *)v5;

    v4->_voiceTriggerEnabled = 0;
    v7 = objc_alloc(MEMORY[0x1E0D18FD8]);
    ...
    objc_msgSend(v11, "converterForAudioStreamId:", a3);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    LODWORD(v13) = 3.0;
    LODWORD(v14) = v10;
    v15 = objc_msgSend(v7, "initWithNumChannels:recordingDuration:samplingRate:audioTimeConverter:", v8, v12, v13, v14);
    circularBuffer = v4->_circularBuffer;
    v4->_circularBuffer = (CSAudioCircularBuffer *)v15;
...
- (void)setAlwaysOnVoiceTriggerEnabled:(BOOL)a3
{
  ...
  v4[1] = 3221225472;
  v4[2] = __63__CSAudioInjectionHearstEngine_setAlwaysOnVoiceTriggerEnabled___block_invoke;
  v4[3] = &unk_1E7C28480;
  v4[4] = self;
  v5 = a3;
...
- (BOOL)alwaysOnVoiceTriggerEnabled
{
  ...
  v5[1] = 3221225472;
  v5[2] = __59__CSAudioInjectionHearstEngine_alwaysOnVoiceTriggerEnabled__block_invoke;
  v5[3] = &unk_1E7C29228;
  v5[4] = self;
  v5[5] = &v6;
...
- (void)attachDevice:(id)a3
{
  ...
  v6 = v5 && -[CSAudioInjectionHearstEngine isAlwaysOnVoiceTriggerAvailable](self, "isAlwaysOnVoiceTriggerAvailable");
...
- (void)start
{
  ...
  block[1] = 3221225472;
  block[2] = __37__CSAudioInjectionHearstEngine_start__block_invoke;
...
- (void)stop
{
  ...
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __36__CSAudioInjectionHearstEngine_stop__block_invoke;
  block[3] = &unk_1E7C292C8;
  block[4] = self;
  dispatch_sync(queue, block);
}
...
- (BOOL)isRecording
{
  ...
  v5[0] = MEMORY[0x1E0C809B0];
  v5[1] = 3221225472;
  v5[2] = __43__CSAudioInjectionHearstEngine_isRecording__block_invoke;
  v5[3] = &unk_1E7C29228;
  v5[4] = self;
  v5[5] = &v6;
  dispatch_async_and_wait(queue, v5);
...
- (void)startAudioStreamWithOption:(id)a3
{
  ...
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __59__CSAudioInjectionHearstEngine_startAudioStreamWithOption___block_invoke;
  block[3] = &unk_1E7C292C8;
  block[4] = self;
...
- (void)stopAudioStream
{
  ...
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __47__CSAudioInjectionHearstEngine_stopAudioStream__block_invoke;
  block[3] = &unk_1E7C292C8;
  block[4] = self;
  dispatch_async(queue, block);
}
...
- (void)audioEngineBufferAvailable:(id)a3 audioStreamHandleId:(unint64_t)a4 buffer:(id)a5 remoteVAD:(id)a6 atTime:(unint64_t)a7 isFileLoadedBuffer:(BOOL)a8
{
  ...
  _QWORD block[4];
  id v16;
  CSAudioInjectionHearstEngine *v17;
  unint64_t v18;
  unint64_t v19;
  BOOL v20;
  ...
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __122__CSAudioInjectionHearstEngine_audioEngineBufferAvailable_audioStreamHandleId_buffer_remoteVAD_atTime_isFileLoadedBuffer___block_invoke;
...
unint64_t __122__CSAudioInjectionHearstEngine_audioEngineBufferAvailable_audioStreamHandleId_buffer_remoteVAD_atTime_isFileLoadedBuffer___block_invoke(uint64_t a1)
{
  unint64_t v2;
  unint64_t v3;
  unint64_t v4;
  ...
  if (*(_BYTE *)(v5 + 160) && !*(_BYTE *)(v5 + 161))
  {
    ...
    if (v12 >= v13)
    {
      *(_QWORD *)(*(_QWORD *)(a1 + 40) + 200) = objc_msgSend(v10, "bestStart");
      ...
      objc_msgSend(v16, "remoteMicVoiceTriggerEvent:activationInfo:hostTime:", v18, 0, mach_absolute_time());
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v15, "notifyActivationEvent:completion:", v19, &__block_literal_global_1607);
...
void __47__CSAudioInjectionHearstEngine_stopAudioStream__block_invoke(uint64_t a1)
{
  id WeakRetained;
  char v3;
  id v4;
...
void __59__CSAudioInjectionHearstEngine_startAudioStreamWithOption___block_invoke(uint64_t a1)
{
  uint64_t v2;
  unint64_t v3;
  unint64_t v4;
...
uint64_t __43__CSAudioInjectionHearstEngine_isRecording__block_invoke(uint64_t result)
{
  *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(result + 40) + 8) + 24) = *(_BYTE *)(*(_QWORD *)(result + 32) + 161);
  return result;
}

uint64_t __36__CSAudioInjectionHearstEngine_stop__block_invoke(uint64_t a1)
{
  objc_super v3;
  objc_super v4;
  ...
  v3.super_class = (Class)CSAudioInjectionHearstEngine;
  objc_msgSendSuper2(&v3, sel_stop);
  return objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 192), "reset");
}

void __37__CSAudioInjectionHearstEngine_start__block_invoke(uint64_t a1)
{
  void *v2;
  void *v3;
  id v4;
  ...
  v15.super_class = (Class)CSAudioInjectionHearstEngine;
  ...
  *(_QWORD *)(v8 + 184) = v7;
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D18F60], OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 136315138;
      v17 = "-[CSAudioInjectionHearstEngine start]_block_invoke";
  ...
  v14.receiver = v12;
  v14.super_class = (Class)CSAudioInjectionHearstEngine;
  objc_msgSendSuper2(&v14, sel_startAudioStreamWithOption_, v13);

}

uint64_t __59__CSAudioInjectionHearstEngine_alwaysOnVoiceTriggerEnabled__block_invoke(uint64_t result)
{
  *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(result + 40) + 8) + 24) = *(_BYTE *)(*(_QWORD *)(result + 32) + 160);
  return result;
}

uint64_t __63__CSAudioInjectionHearstEngine_setAlwaysOnVoiceTriggerEnabled___block_invoke(uint64_t result)
{
