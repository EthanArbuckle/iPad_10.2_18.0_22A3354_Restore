...
- (void)_subscribeEventMonitors
{
  ...
  -[CSSmartSiriVolumeRunPolicy _subscribeEventMonitors](&v4, sel__subscribeEventMonitors);
...
- (void)_addSmartSiriVolumeEnabledConditions
{
  ...
  -[CSSmartSiriVolumeRunPolicy _addSmartSiriVolumeEnabledConditions](&v3, sel__addSmartSiriVolumeEnabledConditions);
  -[CSPolicy addConditions:](self, "addConditions:", &__block_literal_global_13635);
}

uint64_t __73__CSSmartSiriVolumeRunPolicyHomePod__addSmartSiriVolumeEnabledConditions__block_invoke()
{
  void *v0;
  uint64_t v1;
  NSObject *v2;
  ...
  if ((v1 & 1) == 0)
  {
    ...
    {
      v4 = 136315138;
      v5 = "-[CSSmartSiriVolumeRunPolicyHomePod _addSmartSiriVolumeEnabledConditions]_block_invoke";
