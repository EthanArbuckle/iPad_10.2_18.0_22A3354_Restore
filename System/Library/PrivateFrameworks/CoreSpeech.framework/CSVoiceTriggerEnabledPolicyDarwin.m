...
{
  CSVoiceTriggerEnabledPolicyDarwin *v2;
  CSVoiceTriggerEnabledPolicyDarwin *v3;
  objc_super v5;
...
{
  -[CSPolicy addConditions:](self, "addConditions:", &__block_literal_global_1913);
}

uint64_t __70__CSVoiceTriggerEnabledPolicyDarwin__addVoiceTriggerEnabledConditions__block_invoke()
{
  void *v0;
  uint64_t v1;
  NSObject *v2;
  ...
  if ((v1 & 1) == 0)
  {
    ...
    {
      v4 = 136315138;
      v5 = "-[CSVoiceTriggerEnabledPolicyDarwin _addVoiceTriggerEnabledConditions]_block_invoke";
