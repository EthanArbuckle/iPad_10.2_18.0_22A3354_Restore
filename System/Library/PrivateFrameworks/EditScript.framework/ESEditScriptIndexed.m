...
- (ESEditScriptIndexed)initWithOperationPrecedence:(int64_t)a3 dataClass:(Class)a4 fromArray:(id)a5 toArray:(id)a6 orderAtomsAscending:(BOOL)a7
{
  ...
  v14 = -[ESEditScript initWithOperationPrecedence:orderAtomsAscending:](&v20, sel_initWithOperationPrecedence_orderAtomsAscending_, a3, v7);
  if (v14)
  {
...
+ (id)editScriptFromArray:(id)a3 toArray:(id)a4 orderAtomsAscending:(BOOL)a5 operationPrecedence:(int64_t)a6
{
  ...
  id v9;
  id v10;
  ESEditScriptIndexed *v11;

  v7 = a5;
  v9 = a4;
  v10 = a3;
  v11 = -[ESEditScriptIndexed initWithOperationPrecedence:dataClass:fromArray:toArray:orderAtomsAscending:]([ESEditScriptIndexed alloc], "initWithOperationPrecedence:dataClass:fromArray:toArray:orderAtomsAscending:", a6, objc_opt_class(), v10, v9, v7);

  -[ESEditScript computeDistanceMatrix](v11, "computeDistanceMatrix");
  -[ESEditScript computeEditsFromMatrix](v11, "computeEditsFromMatrix");
  return v11;
}
...
{
  ESAtomIndexed *currentScriptAtom;
...
- (void)addToCurrentScriptAtomEditOperation:(int64_t)a3 editIndex:(unint64_t)a4 newText:(id)a5 indexInArrayB:(unint64_t)a6
{
  ...
  if (a3)
  {
    if (a3 == 2)
      ...
      v11 = a4 - 1;
    v14 = v10;
    +[ESAtomIndexed atomWithEditOperation:indexToEdit:newText:indexInArrayB:](ESAtomIndexed, "atomWithEditOperation:indexToEdit:newText:indexInArrayB:", a3, v11, v10, a6);
    v12 = (ESAtomIndexed *)objc_claimAutoreleasedReturnValue();
    currentScriptAtom = self->_currentScriptAtom;
    self->_currentScriptAtom = v12;

    -[ESEditScriptIndexed finalizeCurrentScriptAtom](self, "finalizeCurrentScriptAtom");
    v10 = v14;
  }
...
- (void)finalizeCurrentScriptAtom
{
  ...
  if (currentScriptAtom)
  {
    ...
    {
      if (-[ESAtomIndexed editOperation](currentScriptAtom, "editOperation") == 2)
      {
        v4 = 1;
      }
      else if (-[ESAtomIndexed editOperation](self->_currentScriptAtom, "editOperation") == 1)
      {
        v4 = -1;
      }
      else
