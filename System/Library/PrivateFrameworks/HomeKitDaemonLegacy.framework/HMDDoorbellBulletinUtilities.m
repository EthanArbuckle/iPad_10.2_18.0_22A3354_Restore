...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_46257 != -1)
    dispatch_once(&logCategory__hmf_once_t9_46257, &__block_literal_global_31_46258);
  return (id)logCategory__hmf_once_v10_46259;
}
...
void __43__HMDDoorbellBulletinUtilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_46259;
  logCategory__hmf_once_v10_46259 = v0;
...
- (id)_localizedDoorbellMessageForSignificantEvents:(id)a3 forAudioAccessory:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v48 = 2112;
    v49 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Determining localized camera doorbell message from significant events: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v7);
  -[__CFString na_map:](v6, "na_map:", &__block_literal_global_46296);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  -[__CFString na_filter:](v6, "na_filter:", &__block_literal_global_2_46297);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "allObjects");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "na_map:", &__block_literal_global_4_46298);
    ...
    if (!v34)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v52 = 2112;
        v53 = v35;
        _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v25 = 2112;
      v26 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
...
- (id)_significantEventsWithinTimeWindowOfDoorbellPress:(id)a3 forCameraProfile:(id)a4
{
  ...
  if (v8)
  {
    objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeInterval:sinceDate:", v6, -30.0);
    v9 = objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeInterval:sinceDate:", v6, 30.0);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v23 = (void *)v9;
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v32 = 2112;
      v33 = v6;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Found recent significant events: %@ for camera profile: %@, with date interval: %@, dateOfDoorbellPress: %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Clip Manager is nil, returning empty set for significant events in time window", buf, 0xCu);
...
- (id)significantEventsRelevantToDoorbellPress:(id)a3 forCameraProfile:(id)a4
{
  ...
  if (v8)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "na_map:", &__block_literal_global_25_46281);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v10, "hmf_isEmpty") & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v27 = 2112;
        v28 = v11;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@The following significant events were found for the clip containing the doorbell press: %@", (uint8_t *)&v25, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v27 = 2112;
        v28 = v9;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@The following significant events were found within the time window: %@", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 138543362;
      v26 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Clip Manager is nil, returning empty set for significant events relevant to doorbell press", (uint8_t *)&v25, 0xCu);
...
- (id)faceClassificationsNearDateOfDoorbellPress:(id)a3 forCameraProfile:(id)a4
{
  ...
  objc_msgSend(v4, "na_map:", &__block_literal_global_26_46277);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)clipUUIDsForCoalesceableSignificantEvents:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "na_map:", &__block_literal_global_28_46275);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "na_map:", &__block_literal_global_29);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
