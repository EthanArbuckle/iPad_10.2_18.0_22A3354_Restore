...
LABEL_9:
  ...
  if (v12)
  {
    ...
    v12->_notifyResidentsOfUpdatedDataDebounceTimerFactory = &__block_literal_global_174570;
...
- (void)_startDebounceTimerToNotifyResidentsOfUpdatedFaceClassificationDependentData
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting timer to notify resident devices of updated face-classification-dependent data", (uint8_t *)&v15, 0xCu);
...
- (void)_notifyResidentsOfUpdatedFaceClassificationDependentData
{
  ...
  if (v4)
  {
    ...
    if (v7)
    {
      ...
      if (v9)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          v34 = 2112;
          v35 = v18;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending message to notify resident devices of updated face-classification-dependent data: %@", (uint8_t *)&v32, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          v32 = 138543362;
          v33 = v31;
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@No account handles found on owner account when notifying resident devices of updated face-classification-dependent data", (uint8_t *)&v32, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v32 = 138543362;
        v33 = v27;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Owner account was nil when notifying resident devices of updated face-classification-dependent data", (uint8_t *)&v32, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v32 = 138543362;
      v33 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference was nil when notifying resident devices of updated face-classification-dependent data", (uint8_t *)&v32, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_174577 != -1)
    dispatch_once(&logCategory__hmf_once_t6_174577, &__block_literal_global_12_174578);
  return (id)logCategory__hmf_once_v7_174579;
}
...
void __43__HMDRemotePersonDataMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_174579;
  logCategory__hmf_once_v7_174579 = v0;
