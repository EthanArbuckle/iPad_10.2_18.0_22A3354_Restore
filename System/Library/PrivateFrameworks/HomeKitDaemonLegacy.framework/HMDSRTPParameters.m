...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x1E0D164D0], "wrappertlv:name:", 2, CFSTR("kSRTPParameters_SRTPMasterKey"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D164D0], "wrappertlv:name:", 3, CFSTR("kSRTPParameters_SRTPMasterSalt"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 1, CFSTR("kSRTPParameters_SRTPCryptoSuite"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v19[0] = v3;
  v19[1] = v4;
  v19[2] = v5;
