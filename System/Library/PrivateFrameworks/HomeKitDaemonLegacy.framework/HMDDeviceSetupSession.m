...
- (HMDDeviceSetupSession)initWithIdentifier:(id)a3 role:(int64_t)a4 homeManager:(id)a5
{
  ...
  v12 = -[HMDDeviceSetupSession initWithIdentifier:role:homeManager:upSecondsFactory:userDefaults:](self, "initWithIdentifier:role:homeManager:upSecondsFactory:userDefaults:", v10, a4, v9, &__block_literal_global_25977, v11);
...
LABEL_10:
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, v38, buf, 0xCu);
...
- (void)_closeWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v44 = 2112;
    v45 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@CloseWithError: [isOpen: %@] [error: %@]", buf, 0x20u);
  ...
  if (-[HMDDeviceSetupSession isOpen](v6, "isOpen"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = v4;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Closing the session with error:%@", buf, 0x16u);
    ...
    v39 = v17;
    v18 = (id)objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v39, &v38, 1);
    ...
    else
    {
      ...
      -[HMDDeviceSetupSession internal](v11, "internal", *MEMORY[0x1E0CB8C30]);
      v19 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
    ...
    objc_msgSend(MEMORY[0x1E0D285D0], "entitledMessageWithName:messagePayload:", *MEMORY[0x1E0CB8BF8], v20);
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v44 = 2112;
      v45 = v25;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Going to call the delegate with error:%@, Also sending the close message to client: %@", buf, 0x20u);
...
- (void)_handleClose:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)MEMORY[0x1D17BA0A0](-[HMFActivity begin](self->_activity, "begin"));
  v6 = self;
  HMFGetOSLogHandle();
  v7 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Received close request : %@, [isOpen = %@]", (uint8_t *)&v11, 0x20u);

  }
  objc_autoreleasePoolPop(v5);
  objc_msgSend(v4, "errorForKey:", *MEMORY[0x1E0CB8C08]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)close:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Called to close session", buf, 0xCu);
...
- (void)_sendRequestData:(id)a3
{
  ...
  v18 = *MEMORY[0x1E0CB8C00];
  v19[0] = v4;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v19, &v18, 1);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D285D0], "entitledMessageWithName:messagePayload:", *MEMORY[0x1E0CB8C20], v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDDeviceSetupSession messageDispatcher](self, "messageDispatcher");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Sending data : %@", (uint8_t *)&v14, 0x16u);
...
void __44__HMDDeviceSetupSession__handleReceiveData___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(*(_QWORD *)(a1 + 32) + 8), "markWithReason:", CFSTR("Received data")));
  v3 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v45 = 2112;
    v46 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received receive data request : %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v2);
  v7 = *MEMORY[0x1E0CB8C00];
  objc_msgSend(*(id *)(a1 + 40), "dataForKey:", *MEMORY[0x1E0CB8C00]);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
      ...
      if (v30)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v45 = 2112;
          v46 = v33;
          _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Going to close the session as the state is now complete: [isOpen : %@]", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = v15;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to process session data with error: %@", buf, 0x16u);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v44 = v22;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Missing session data", buf, 0xCu);
...
void __29__HMDDeviceSetupSession_open__block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 40), "markWithReason:", CFSTR("Opening")));
  v4 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v50 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Opening", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v3);
  v7 = *(void **)(a1 + 40);
  v53 = CFSTR("HomeManagerUUID");
  v8 = v7;
  ...
  v54[0] = v13;
  v14 = (id)objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v54, &v53, 1);
...
LABEL_6:
  ...
  objc_msgSend(v2, "cloudDataSyncStateFilter");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = objc_msgSend(v15, "decryptionFailed");
  ...
  if (!v16)
  {
    ...
    v45 = 0;
    v46 = 0;
    v23 = objc_msgSend(v22, "processSessionData:outAccessoryUUID:outAccessoryCategory:outAccessoryIDSIdentifier:error:", 0, &v48, &v47, &v46, &v45);
    v24 = v48;
    v25 = v47;
    v26 = v46;
    v27 = v45;
    ...
    if ((v23 & 1) != 0)
    {
      objc_msgSend(*(id *)(a1 + 32), "updateAccessoryUUIDAndNotifyDelegate:accessoryIDSIdentifier:accessoryCategory:", v24, v26, v25);
      objc_msgSend(*(id *)(a1 + 32), "internal");
      v28 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v29 != 3)
      {
        ...
        objc_msgSend(v36, "sessionData");
        v37 = (void *)objc_claimAutoreleasedReturnValue();

        if (v37)
        {
          objc_msgSend(*(id *)(a1 + 32), "_sendRequestData:", v37);
          v35 = 0;
        }
        else
        {
          ...
          if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v50 = v41;
            _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Missing session data", buf, 0xCu);
          ...
          v42 = *(void **)(a1 + 32);
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 56);
          v43 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v42, "_closeWithError:", v43);
...
LABEL_24:
      ...
      objc_msgSend(v30, "_closeWithError:", 0);
    }
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v51 = 2112;
        v52 = v27;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send initial session data with error: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v31);
      objc_msgSend(*(id *)(a1 + 32), "_closeWithError:", v27);
      objc_msgSend(*(id *)(a1 + 32), "updateAccessoryUUIDAndNotifyDelegate:accessoryIDSIdentifier:accessoryCategory:", v24, v26, v25);
    }
    v35 = 1;
    goto LABEL_24;
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v50 = v20;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Not supported if cloud decryption has failed", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v17);
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 77);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(a1 + 32), "_closeWithError:", v21);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t20 != -1)
    dispatch_once(&logCategory__hmf_once_t20, &__block_literal_global_60_25982);
