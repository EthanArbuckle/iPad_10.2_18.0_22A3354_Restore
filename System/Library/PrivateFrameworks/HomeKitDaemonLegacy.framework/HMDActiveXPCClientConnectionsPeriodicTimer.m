...
- (void)_updateTimer
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = objc_msgSend(v4, "na_any:", &__block_literal_global_83831);
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      v14 = 138543362;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Starting timer", (uint8_t *)&v14, 0xCu);
  ...
  else
  {
    if (v9)
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Suspending timer", (uint8_t *)&v14, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of timer firing", (uint8_t *)&v12, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_83849 != -1)
    dispatch_once(&logCategory__hmf_once_t2_83849, &__block_literal_global_10_83850);
  return (id)logCategory__hmf_once_v3_83851;
}
...
void __57__HMDActiveXPCClientConnectionsPeriodicTimer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_83851;
  logCategory__hmf_once_v3_83851 = v0;
