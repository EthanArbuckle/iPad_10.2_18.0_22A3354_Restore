...
+ (id)logCategory
{
  if (logCategory__hmf_once_t38 != -1)
    dispatch_once(&logCategory__hmf_once_t38, &__block_literal_global_28740);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2112;
        v279 = v10;
        _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating hh2SoftwareReleased from %@ to %@", buf, 0x20u);
    ...
    if (v12 | v13 && (_DWORD)v14 != objc_msgSend(a1, "isHH2ManualMigrationEnabled"))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2112;
        v279 = v20;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating hh2ManualMigrationEnabled from %@ to %@", buf, 0x20u);
    ...
    if (v21 | v22 && (_DWORD)v23 != objc_msgSend(a1, "isHH2AutoMigrationEnabled"))
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2112;
        v279 = v29;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationEnabled from %@ to %@", buf, 0x20u);
          ...
          (v32 & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2112;
        v279 = v30;
        _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithoutSharedUserRampDivisor from %@ to %@", buf, 0x20u);
      ...
      if ((v41 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v39;
          _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithoutSharedUserRampRemainder from %@ to %@", buf, 0x20u);
      ...
      if ((v49 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v47;
          _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithSharedUserRampDivisor from %@ to %@", buf, 0x20u);
      ...
      if ((v57 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v55;
          _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithSharedUserRampRemainder from %@ to %@", buf, 0x20u);
    ...
    if (v63 && (objc_msgSend(v63, "isEqualToVersion:", v64) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v63;
        _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForSharedUserHH2MigrationByOwnerManual from %{public}@ to %{public}@", buf, 0x20u);
    ...
    if (v70 && (objc_msgSend(v70, "isEqualToVersion:", v71) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v70;
        _os_log_impl(&dword_1CD062000, v74, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForSharedUserHH2MigrationByOwnerAuto from %{public}@ to %{public}@", buf, 0x20u);
    ...
    if (v76 && (objc_msgSend(v76, "isEqualToVersion:", v77) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v76;
        _os_log_impl(&dword_1CD062000, v81, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerMeDeviceAutoHH2MigrationWithoutSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
    ...
    if (v83 && (objc_msgSend(v83, "isEqualToVersion:", v84) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v83;
        _os_log_impl(&dword_1CD062000, v87, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerOtherDevicesAutoHH2MigrationWithoutSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
    ...
    if (v89 && (objc_msgSend(v89, "isEqualToVersion:", v90) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v93, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v89;
        _os_log_impl(&dword_1CD062000, v93, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerResidentDevicesAutoHH2MigrationWithoutSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
    ...
    if (v95 && (objc_msgSend(v95, "isEqualToVersion:", v96) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v100, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v95;
        _os_log_impl(&dword_1CD062000, v100, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerMeDeviceAutoHH2MigrationWithSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
    ...
    if (v102 && (objc_msgSend(v102, "isEqualToVersion:", v103) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v106, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v102;
        _os_log_impl(&dword_1CD062000, v106, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerOtherDevicesAutoHH2MigrationWithSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
    ...
    if (v109 && (objc_msgSend(v109, "isEqualToVersion:", v110) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v113, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v109;
        _os_log_impl(&dword_1CD062000, v113, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerResidentDevicesAutoHH2MigrationWithSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
      ...
      if (v117 != objc_msgSend(v116, "BOOLValue"))
      {
        ...
        if (os_log_type_enabled(v120, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v123;
          _os_log_impl(&dword_1CD062000, v120, OS_LOG_TYPE_INFO, "%{public}@Updating hh2SuppressDuplicateUserModelBulletins from %@ to %@", buf, 0x20u);
      ...
      if (v125 != objc_msgSend(v124, "BOOLValue"))
      {
        ...
        if (os_log_type_enabled(v128, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v131;
          _os_log_impl(&dword_1CD062000, v128, OS_LOG_TYPE_INFO, "%{public}@Updating homeSafetySecurityEnabled from %@ to %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v136, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2112;
        v279 = v139;
        _os_log_impl(&dword_1CD062000, v136, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitResidentStatusEnabled from %@ to %@", buf, 0x20u);
      ...
      if ((v143 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v146, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v141;
          _os_log_impl(&dword_1CD062000, v146, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitInitialConnectionTimeoutSeconds from %@ to %@", buf, 0x20u);
      ...
      if ((v151 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v154, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v149;
          _os_log_impl(&dword_1CD062000, v154, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitConnectionTTSUNoReachablePrimaryTimeoutSeconds from %@ to %@", buf, 0x20u);
      ...
      if ((v159 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v162, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v157;
          _os_log_impl(&dword_1CD062000, v162, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitUnsubscribeFromChannelDebounceTimeSec from %@ to %@", buf, 0x20u);
          ...
          (v167 & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v171, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2112;
        v279 = v165;
        _os_log_impl(&dword_1CD062000, v171, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredResidentEvaluationDelay from %@ to %@", buf, 0x20u);
      ...
      if ((v176 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v179, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v174;
          _os_log_impl(&dword_1CD062000, v179, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredResidentsListMaxSize from %@ to %@", buf, 0x20u);
      ...
      if ((v184 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v187, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v182;
          _os_log_impl(&dword_1CD062000, v187, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionStatusDebounceInterval from %@ to %@", buf, 0x20u);
      ...
      if ((v192 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v195, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v190;
          _os_log_impl(&dword_1CD062000, v195, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionTakeOverIfPrimaryIsNotViableInterval from %@ to %@", buf, 0x20u);
      ...
      if ((v200 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v203, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v198;
          _os_log_impl(&dword_1CD062000, v203, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionTakeOverInterval from %@ to %@", buf, 0x20u);
      ...
      if ((v208 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v211, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v206;
          _os_log_impl(&dword_1CD062000, v211, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionTakeOverOnlyIfCurrentPrimaryIsNotViableJitter from %@ to %@", buf, 0x20u);
      ...
      if ((v216 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v219, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v214;
          _os_log_impl(&dword_1CD062000, v219, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredListGenerationStartHour from %@ to %@", buf, 0x20u);
      ...
      if ((v224 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v227, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v222;
          _os_log_impl(&dword_1CD062000, v227, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredListGenerationEndHour from %@ to %@", buf, 0x20u);
    ...
    if (v230 && (objc_msgSend(v230, "isEqualToVersion:", v231) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v234, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2114;
        v279 = v230;
        _os_log_impl(&dword_1CD062000, v234, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionMinHomeKitVersion from %{public}@ to %{public}@", buf, 0x20u);
      ...
      if ((v238 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v241, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v236;
          _os_log_impl(&dword_1CD062000, v241, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionReachabilityNotificationAfterConnectivityDelay from %@ to %@", buf, 0x20u);
      ...
      if ((v246 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v249, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v278 = 2112;
          v279 = v244;
          _os_log_impl(&dword_1CD062000, v249, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionUserPreferredReachabilityNotificationDelay from %@ to %@", buf, 0x20u);
          ...
          (v254 & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v259, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v278 = 2112;
        v279 = v252;
        _os_log_impl(&dword_1CD062000, v259, OS_LOG_TYPE_INFO, "%{public}@Updating residentDeviceManagerBlockPrimaryTakeoverDurationSeconds from %@ to %@", buf, 0x20u);
...
LABEL_187:
    ...
    if (os_log_type_enabled(v264, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v275 = v265;
      _os_log_impl(&dword_1CD062000, v264, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of server bag update", buf, 0xCu);
...
LABEL_6:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@serverBagValueForKey %@ returned %@", (uint8_t *)&v17, 0x20u);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Server bag refresh timer fired", (uint8_t *)&v10, 0xCu);
...
- (HMDIDSServerBag)init
{
  ...
  objc_msgSend(MEMORY[0x1E0D34350], "sharedInstanceForBagType:", 0);
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28578]), "initWithMinimumTimeInterval:maximumTimeInterval:exponentialFactor:options:", 2, 12, 30.0, v8);
  v10 = isInternalBuild();
  v11 = &stru_1E89C3E38;
  if (v10)
    v11 = CFSTR("-internal");
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2048;
    v26 = v8;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Initializing using key suffix %@ with initial timer interval of %fs and maximum of %fs", (uint8_t *)&v19, 0x2Au);
...
- (HMDIDSServerBag)initWithIDSServerBag:(id)a3 refreshTimer:(id)a4 keySuffix:(id)a5
{
  ...
  if (v12)
  {
    ...
    v13->_hh2AutoMigrationWithoutSharedUserRampDivisor = (NSNumber *)&unk_1E8B32B80;

    hh2AutoMigrationWithoutSharedUserRampRemainder = v13->_hh2AutoMigrationWithoutSharedUserRampRemainder;
    v13->_hh2AutoMigrationWithoutSharedUserRampRemainder = (NSNumber *)&unk_1E8B32B98;

    hh2AutoMigrationWithSharedUserRampDivisor = v13->_hh2AutoMigrationWithSharedUserRampDivisor;
    v13->_hh2AutoMigrationWithSharedUserRampDivisor = (NSNumber *)&unk_1E8B32B80;

    hh2AutoMigrationWithSharedUserRampRemainder = v13->_hh2AutoMigrationWithSharedUserRampRemainder;
    v13->_hh2AutoMigrationWithSharedUserRampRemainder = (NSNumber *)&unk_1E8B32B98;
