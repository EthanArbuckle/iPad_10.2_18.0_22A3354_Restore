...
- (HMDDataStreamControlProtocol)initWithLogIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    *(_WORD *)&v6->_helloMessageResponseReceived = 0;
    ...
    v6->_peerDataStreamProtocolVersion = (NSNumber *)&unk_1E8B36CD8;
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending hello control message", (uint8_t *)&v9, 0xCu);
...
- (void)dataStream:(id)a3 didReceiveRequest:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if (objc_msgSend(v11, "isEqual:", CFSTR("hello")))
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message received", (uint8_t *)&v29, 0xCu);

    }
    objc_autoreleasePoolPop(v14);
    objc_msgSend(v10, "sendResponseForRequestHeader:payload:status:completion:", v12, MEMORY[0x1E0C9AA70], 0, &__block_literal_global_181659);
  }
  else
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 138543362;
        v30 = v23;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Version control message received", (uint8_t *)&v29, 0xCu);
      ...
      objc_msgSend(v10, "sendResponseForRequestHeader:payload:status:completion:", v12, v27, 0, &__block_literal_global_2_181661);
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 2112;
        v32 = v11;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Control Protocol received unexpected request '%@'", (uint8_t *)&v29, 0x16u);
...
- (BOOL)isExpectedHelloControlMessage:(id)a3 header:(id)a4
{
  ...
  if (v10)
  {
    ...
    v12 = objc_msgSend(v11, "isEqual:", &unk_1E8B35280);
...
- (void)dataStream:(id)a3 didReceiveResponse:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if (-[HMDDataStreamControlProtocol isExpectedHelloControlMessage:header:](self, "isExpectedHelloControlMessage:header:", v11, v12))
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message reply received", (uint8_t *)&v29, 0xCu);
  ...
  else
  {
    ...
    if (v19)
    {
      if (v23)
      {
        ...
        v31 = 2112;
        v32 = v13;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Received Peer Request Version Response %@", (uint8_t *)&v29, 0x16u);
    ...
    else
    {
      if (v23)
      {
        ...
        v29 = 138543362;
        v30 = v28;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Expected hello reply or Version but got something else", (uint8_t *)&v29, 0xCu);
...
- (void)_sendHelloMessageOnDataStream:(id)a3
{
  ...
  v4 = a3;
  v5 = HMFRandomUInt32();
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37E8]), "initWithUnsignedInt:", v5);
  ...
  v7[3] = &unk_1E89C2350;
  v7[4] = self;
  objc_msgSend(v4, "sendRequestForProtocol:topic:identifier:payload:completion:", CFSTR("control"), CFSTR("hello"), v5, MEMORY[0x1E0C9AA70], v7);
...
void __64__HMDDataStreamControlProtocol__sendVersionRequestOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send version control message (%@)", (uint8_t *)&v8, 0x16u);
...
void __62__HMDDataStreamControlProtocol__sendHelloMessageOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send hello control message (%@)", (uint8_t *)&v8, 0x16u);
