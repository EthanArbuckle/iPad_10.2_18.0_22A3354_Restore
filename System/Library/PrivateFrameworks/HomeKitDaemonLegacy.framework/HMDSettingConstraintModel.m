...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_52038 != -1)
    dispatch_once(&hmbProperties_onceToken_52038, &__block_literal_global_52039);
  return (id)hmbProperties__properties_52040;
}
...
void __42__HMDSettingConstraintModel_hmbProperties__block_invoke()
{
  ...
  v5 = (void *)hmbProperties__properties_52040;
  hmbProperties__properties_52040 = v4;
