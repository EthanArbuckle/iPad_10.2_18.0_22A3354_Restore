...
{
  return -[HMDSyncOperationManager initWithClientQueue:dataSource:timerFactory:](self, "initWithClientQueue:dataSource:timerFactory:", a3, a4, &__block_literal_global_129_94572);
}
...
- (void)_reportPossibleSyncLoop
{
    ...
    && !-[HMDSyncOperationManager wasSyncLoopDialogDisplayed](self, "wasSyncLoopDialogDisplayed"))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Presenting dialog about possible sync loop", (uint8_t *)&v11, 0xCu);
...
- (void)addOperation:(id)a3 withDelay:(double)a4
{
  ...
  if (a4 > 0.0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding operation delay, respect this delay: %@", (uint8_t *)&v14, 0x16u);
...
- (void)_dropWithoutAlreadyScheduledOperation:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 23, CFSTR("Operation was dropped before it could run"), CFSTR("HMDSyncOperationManager dropped the operation"), 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = 0u;
  v11 = 0u;
  v12 = 0u;
    ...
    if (-[HMDSyncOperationManager pauseQueue](self, "pauseQueue"))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v41 = v18;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Cannot dequeue operation because sync manager queue is paused", buf, 0xCu);
...
LABEL_25:
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEBUG, v32, buf, 0xCu);
...
LABEL_28:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2114;
      v43 = v19;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Dequeued operation to process %{public}@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v42 = 2112;
    v43 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Already executing operation %@", buf, 0x16u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2114;
      v33 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Starting sync operation %{public}@", buf, 0x16u);
    ...
    if (os_signpost_enabled(logger))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v32 = 2112;
      v33 = v12;
      _os_signpost_emit_with_name_impl(&dword_1CD062000, v10, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "SyncOperation", "zone=%{signpost.description:attribute}@ identifier=%{signpost.description:attribute}@ ", buf, 0x16u);
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2114;
      v33 = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting for sync operation %{public}@ to complete", buf, 0x16u);
...
void __47__HMDSyncOperationManager_resetCloudPushTimer___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v21 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Resetting cloud upload timer", buf, 0xCu);
...
void __49__HMDSyncOperationManager_killCloudPushAndResume__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Dropping current cloud push queue", (uint8_t *)&v12, 0xCu);
  ...
  objc_msgSend(*(id *)(a1 + 32), "cloudPushOperations");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "dropAllOperations");

  if (objc_msgSend(*(id *)(a1 + 32), "pauseCloudPushLevel") <= 0)
  {
    v7 = (void *)MEMORY[0x1D17BA0A0]();
    v8 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Forcing refetch", (uint8_t *)&v12, 0xCu);

    }
    objc_autoreleasePoolPop(v7);
    objc_msgSend(*(id *)(a1 + 32), "dataSource");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "forceCloudFetch");
...
void __42__HMDSyncOperationManager_resumeCloudPush__block_invoke(uint64_t a1)
{
  ...
  if (v2 < 1)
  {
    if (v6)
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resuming cloud push queue", (uint8_t *)&v10, 0xCu);
  ...
  else
  {
    if (v6)
    {
      ...
      v12 = 2048;
      v13 = v8;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Cloud push queue is still paused because push level is %tu", (uint8_t *)&v10, 0x16u);
...
void __41__HMDSyncOperationManager_pauseCloudPush__block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "setPauseCloudPushLevel:", objc_msgSend(*(id *)(a1 + 32), "pauseCloudPushLevel") + 1));
  v3 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 2048;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Pausing cloud push queue, level is %tu", (uint8_t *)&v7, 0x16u);
...
uint64_t __33__HMDSyncOperationManager_resume__block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "setPauseQueue:", 0));
  v3 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Resuming sync manager queue", (uint8_t *)&v7, 0xCu);
...
void __32__HMDSyncOperationManager_pause__block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "setPauseQueue:", 1));
  v3 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Pausing sync manager queue", (uint8_t *)&v6, 0xCu);
      ...
      for (i = 0; i != v3; ++i)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v27 = 2114;
          v28 = v8;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Cancelling sync operation %{public}@", buf, 0x16u);
...
void __54__HMDSyncOperationManager__handleCancelledOperations___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2114;
    v22 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Sync operation %{public}@ cancelled", buf, 0x16u);
...
uint64_t __47__HMDSyncOperationManager__handleNextOperation__block_invoke_163(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Sync operation %@ completed", (uint8_t *)&v11, 0x16u);
  ...
  {
    LOWORD(v11) = 0;
    _os_signpost_emit_with_name_impl(&dword_1CD062000, v8, OS_SIGNPOST_INTERVAL_END, v9, "SyncOperation", ", (uint8_t *)&v11, 2u);
  }
...
void __43__HMDSyncOperationManager_cancelOperations__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Cancelling all unprocessed sync operation", buf, 0xCu);
  ...
  v21 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "setCloudPushDelayTimer:", 0));
  v22 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v23 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v24;
    _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Cancelling all sync operations, resuming cloud push queue", buf, 0xCu);
...
uint64_t __67__HMDSyncOperationManager_addOperationRespectingOptions_withDelay___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v140 = 2112;
    v141 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Will attempt to add operation %@", buf, 0x16u);
  ...
  if (objc_msgSend(*(id *)(a1 + 40), "operationType") == 1 || objc_msgSend(*(id *)(a1 + 40), "operationType") == 2)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v140 = 2114;
        v141 = v16;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Current push delay is: %{public}@", buf, 0x16u);
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v139 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Scheduling legacy push at maximum time interval, maybe in a sync loop", buf, 0xCu);
    ...
    if (!v24)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v140 = 2114;
        v141 = v42;
        _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Staging cloud push operation %{public}@", buf, 0x16u);
...
LABEL_22:
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v140 = 2114;
      v141 = v36;
      _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Adding cloud push operation %{public}@", buf, 0x16u);
  ...
  if (objc_msgSend(*(id *)(a1 + 40), "operationType") == 3)
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v140 = 2114;
      v141 = v47;
      _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Adding cloud verify account operation %{public}@", buf, 0x16u);
      ...
      if (v26)
      {
        if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v140 = 2114;
          v141 = v82;
          _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_INFO, "%{public}@Adding cloud zone push operation %{public}@", buf, 0x16u);
        ...
        if (objc_msgSend(*(id *)(a1 + 32), "addCloudZonePushOperation:delay:", *(_QWORD *)(a1 + 40), *(double *)(a1 + 48)))
        {
          ...
          if (os_log_type_enabled(v85, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v140 = 2114;
            v141 = v87;
            _os_log_impl(&dword_1CD062000, v85, OS_LOG_TYPE_ERROR, "%{public}@Scheduling zone %{public}@ push at maximum time interval, maybe in a sync loop", buf, 0x16u);
...
LABEL_90:
        _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_ERROR, v101, buf, 0x16u);
      ...
      if (v26)
      {
        if (os_log_type_enabled(v91, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v140 = 2114;
          v141 = v93;
          _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_INFO, "%{public}@Adding cloud zone fetch operation %{public}@", buf, 0x16u);
    ...
    if (objc_msgSend(v90, "operationType") == 7)
    {
      ...
      if (os_log_type_enabled(v96, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v140 = 2112;
        v141 = v98;
        _os_log_impl(&dword_1CD062000, v96, OS_LOG_TYPE_INFO, "%{public}@Adding cloud cancel pause operation %@", buf, 0x16u);
    ...
    if (objc_msgSend(*(id *)(a1 + 40), "operationType") == 8)
    {
      ...
      if (os_log_type_enabled(v104, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v140 = 2114;
        v141 = v106;
        _os_log_impl(&dword_1CD062000, v104, OS_LOG_TYPE_INFO, "%{public}@Adding cloud query database operation %{public}@", buf, 0x16u);
      ...
      if ((objc_msgSend(*(id *)(a1 + 32), "addCloudQueryDatabaseOperationIfNonePresent:", *(_QWORD *)(a1 + 40)) & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v109, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v140 = 2114;
          v141 = v111;
          _os_log_impl(&dword_1CD062000, v109, OS_LOG_TYPE_INFO, "%{public}@Already have a query operation scheduled, dropping operation %{public}@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v114, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v140 = 2114;
        v141 = v116;
        _os_log_impl(&dword_1CD062000, v114, OS_LOG_TYPE_INFO, "%{public}@Dropping post fetch because new query was added: %{public}@", buf, 0x16u);
    ...
    else
    {
      ...
      if (v118 == 9)
      {
        if (os_log_type_enabled(v119, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v140 = 2114;
          v141 = v121;
          _os_log_impl(&dword_1CD062000, v114, OS_LOG_TYPE_INFO, "%{public}@Adding cloud post fetch operation %{public}@", buf, 0x16u);
        ...
        if ((objc_msgSend(*(id *)(a1 + 32), "addCloudPostFetchOperationIfNonePresent:", *(_QWORD *)(a1 + 40)) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v124, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v140 = 2114;
            v141 = v126;
            _os_log_impl(&dword_1CD062000, v124, OS_LOG_TYPE_INFO, "%{public}@Already have a post fetch operation scheduled, dropping operation %{public}@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v119, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v140 = 2114;
        v141 = v127;
        _os_log_impl(&dword_1CD062000, v114, OS_LOG_TYPE_ERROR, "%{public}@Unknown sync operation type, dropping %{public}@", buf, 0x16u);
        goto LABEL_101;
      }
    }
...
LABEL_54:
    ...
    if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v140 = 2114;
      v141 = v74;
      _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_INFO, "%{public}@Adding cloud fetch operation %{public}@", buf, 0x16u);
...
LABEL_49:
  ...
  *(_DWORD *)buf = 138543618;
  ...
  v54 = 22;
LABEL_35:
  _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, v52, buf, v54);
...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 1, a1);
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t53_94575 != -1)
    dispatch_once(&logCategory__hmf_once_t53_94575, &__block_literal_global_142_94576);
  return (id)logCategory__hmf_once_v54_94577;
}
...
void __38__HMDSyncOperationManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v54_94577;
  logCategory__hmf_once_v54_94577 = v0;
