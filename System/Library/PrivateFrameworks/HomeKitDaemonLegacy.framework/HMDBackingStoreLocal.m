        ...
        if (unlink((const char *)objc_msgSend(v13, "UTF8String")) && *__error() != 2)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v45 = 2080;
            v46 = v19;
            _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@unable to remove old datastore file %@ (%s)", buf, 0x20u);
  ...
  if (sqlite3_open_v2((const char *)objc_msgSend(v20, "UTF8String"), &self->context, 6, 0))
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2112;
      v44 = 0;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@unable to open new SQL context: %@", buf, 0x16u);
...
LABEL_20:
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("PRAGMA cache_size = %@;"), &unk_1E8B33C30);
  ...
  if (v29)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v45 = 2112;
      v46 = v29;
      _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Unable to set sqlite cache size to %ld: %@", buf, 0x20u);
...
LABEL_16:
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = (uint64_t)v5;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@unable to initialize SQL context: %@", buf, 0x16u);
        ...
        (v5 = (void *)objc_claimAutoreleasedReturnValue()) != 0))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = (uint64_t)v5;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@initial database row setup failed: %@", buf, 0x16u);

    }
    goto LABEL_18;
  }
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("PRAGMA user_version = %ld;"), 2);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v25 = 2112;
      v26 = v10;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@unable to set schema version to %ld failed: %@", buf, 0x20u);
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v22 = 2112;
        v23 = v12;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@unable to instance our resources: %@", buf, 0x16u);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@unable to instance our resources: %@", buf, 0x16u);
...
- (id)flush:(BOOL)a3
{
  ...
  v14 = &v13;
  v15 = 0x3032000000;
  v16 = __Block_byref_object_copy__114852;
  v17 = __Block_byref_object_dispose__114853;
  v18 = 0;
...
- (id)_updateRecordWithGroupID:(int64_t)a3 name:(id)a4 schema:(id)a5
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v32 = 2112;
    v33 = v9;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Updating record schema: %lu, name: %@, schema: %@", buf, 0x2Au);
...
- (id)_instanceResources:(BOOL)a3 migrate:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v392 = 2112;
    v393 = (uint64_t)v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@SQLite datastore file: %@", buf, 0x16u);
  ...
  if (!v16)
  {
    ...
    v28 = *p_context;
    v388 = 0;
    selectSQLite3(v28, "PRAGMA user_version;", MEMORY[0x1E0C9AA70], &v388);
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v392 = 2112;
      v393 = (uint64_t)v37;
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Current schema version: %@", buf, 0x16u);
...
LABEL_22:
      ...
      if (v42)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v394 = 2112;
          v395 = v42;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_ERROR, "%{public}@Unable to set sqlite cache size to %ld: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (!v48)
        {
          v66 = *p_context;
          v386 = 0;
          selectSQLite3(v66, "PRAGMA journal_mode=WAL;", MEMORY[0x1E0C9AA70], &v386);
          ...
          if (v68 || objc_msgSend(v67, "count"))
          {
            ...
            if (os_log_type_enabled(v71, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v394 = 2112;
              v395 = v68;
              _os_log_impl(&dword_1CD062000, v71, OS_LOG_TYPE_DEFAULT, "%{public}@turning on WAL resulted in %@ / %@", buf, 0x20u);
          ...
          if (v216)
          {
            ...
            if (os_log_type_enabled(v219, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v392 = 2112;
              v393 = (uint64_t)v216;
              _os_log_impl(&dword_1CD062000, v219, OS_LOG_TYPE_ERROR, "%{public}@unable to prepare SQL statements: %@", buf, 0x16u);
            ...
            if (-[HMDBackingStoreLocal _numUncommittedTransactions](v8, "_numUncommittedTransactions") >= 1)
            {
              ...
              if (os_log_type_enabled(v244, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v391 = v245;
                _os_log_impl(&dword_1CD062000, v244, OS_LOG_TYPE_ERROR, "%{public}@We crashed after running transaction but before saving to disk.", buf, 0xCu);
...
LABEL_29:
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v391 = v52;
      _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_DEFAULT, "%{public}@Validating database.", buf, 0xCu);
    ...
    v387 = v27;
    v54 = v50;
    selectSQLite3(v53, "SELECT name FROM sqlite_master WHERE type='table' AND name='xact_block'", MEMORY[0x1E0C9AA70], &v387);
...
LABEL_105:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v394 = 2112;
        v395 = v57;
        _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_ERROR, "%{public}@initial migration test failed with result / error: %@ / %@", buf, 0x20u);
      ...
      if (objc_msgSend(v65, "isEqual:", &unk_1E8B33C60))
      {
      ...
      else
      {
        ...
        v225 = objc_msgSend(v224, "isEqual:", &unk_1E8B33C78);
      ...
      if (isInternalBuild())
      {
        objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", "/var/mobile/Library/homed", 1, 0);
    ...
    selectSQLite3(v53, "SELECT name FROM sqlite_master WHERE type='index' AND name='xact_pushed2'", MEMORY[0x1E0C9AA70], &v387);
    v229 = (void *)objc_claimAutoreleasedReturnValue();

    v230 = v387;
    if (v387)
    {
      v231 = (void *)MEMORY[0x1D17BA0A0]();
      v232 = v335;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v233, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v394 = 2112;
        v395 = v230;
        _os_log_impl(&dword_1CD062000, v233, OS_LOG_TYPE_ERROR, "%{public}@xact_pushed2 migration test failed with result %lu items %@", buf, 0x20u);
    ...
    selectSQLite3(v53, "SELECT subscription_data FROM zone_group WHERE subscription_data IS NOT NULL LIMIT 1", MEMORY[0x1E0C9AA70], &v387);
    v56 = (void *)objc_claimAutoreleasedReturnValue();

    v236 = v387;
    if (!v56 || v387)
    {
      v237 = (void *)MEMORY[0x1D17BA0A0]();
      v238 = v335;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v239, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v394 = 2112;
        v395 = v236;
        _os_log_impl(&dword_1CD062000, v239, OS_LOG_TYPE_ERROR, "%{public}@zone_group.subscription_data migration test failed with result %lu items %@", buf, 0x20u);
...
LABEL_71:
    ...
    selectSQLite3(v53, "SELECT disk_committed FROM xact WHERE id IS NOT NULL LIMIT 1", MEMORY[0x1E0C9AA70], &v387);
    v229 = (void *)objc_claimAutoreleasedReturnValue();

    v247 = v387;
    if (v229 && !v387)
      goto LABEL_85;
    v248 = (void *)MEMORY[0x1D17BA0A0]();
    v249 = v335;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v250, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v394 = 2112;
      v395 = v247;
      _os_log_impl(&dword_1CD062000, v250, OS_LOG_TYPE_ERROR, "%{public}@xact.disk_committed migration test failed with result %lu items %@", buf, 0x20u);
    ...
    {
LABEL_85:
      selectSQLite3(v53, "SELECT schema FROM record WHERE data IS NOT NULL LIMIT 1", MEMORY[0x1E0C9AA70], &v387);
      v253 = (void *)objc_claimAutoreleasedReturnValue();

      v254 = v387;
      if (!v253 || v387)
      {
        v255 = (void *)MEMORY[0x1D17BA0A0]();
        v256 = v335;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v257, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v394 = 2112;
          v395 = v254;
          _os_log_impl(&dword_1CD062000, v257, OS_LOG_TYPE_ERROR, "%{public}@record.schema migration test failed with result %lu items %@", buf, 0x20u);
      ...
      selectSQLite3(v53, "SELECT name FROM sqlite_master WHERE type='table' AND name='zone_group'", MEMORY[0x1E0C9AA70], &v387);
      v260 = (void *)objc_claimAutoreleasedReturnValue();

      v261 = v387;
      if (!v260 || v387)
      {
        v262 = (void *)MEMORY[0x1D17BA0A0]();
        v263 = v335;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v264, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v394 = 2112;
          v395 = v261;
          _os_log_impl(&dword_1CD062000, v264, OS_LOG_TYPE_ERROR, "%{public}@zone_group migration test failed with result %lu items %@", buf, 0x20u);
      ...
      if (objc_msgSend(v260, "count"))
        ...
        v267 = 1;
      selectSQLite3(v53, "SELECT type FROM record WHERE uuid = ''", MEMORY[0x1E0C9AA70], &v387);
      ...
      if (!v268 || v387)
      {
        ...
        if (os_log_type_enabled(v286, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v394 = 2112;
          v395 = v269;
          _os_log_impl(&dword_1CD062000, v286, OS_LOG_TYPE_ERROR, "%{public}@record table migration test failed with result %lu items %@", buf, 0x20u);
        ...
        if (!v268)
        {
          ...
          if (os_log_type_enabled(v300, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v391 = v306;
            _os_log_impl(&dword_1CD062000, v300, OS_LOG_TYPE_ERROR, "%{public}@record table migration test failed with nil result", buf, 0xCu);
...
LABEL_130:
      ...
      selectSQLite3(v53, "SELECT name FROM zone WHERE id = 0", MEMORY[0x1E0C9AA70], &v387);
      v56 = (void *)objc_claimAutoreleasedReturnValue();

      v289 = v387;
      if (!v56 || v387)
      {
        v290 = (void *)MEMORY[0x1D17BA0A0]();
        v291 = v335;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v292, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v394 = 2112;
          v395 = v289;
          _os_log_impl(&dword_1CD062000, v292, OS_LOG_TYPE_ERROR, "%{public}@zone migration test failed with result %lu items %@", buf, 0x20u);
      ...
      if (!objc_msgSend(v56, "count"))
        goto LABEL_130;
      v295 = selectSQLite3(v53, "SELECT type FROM xact WHERE id = 0", MEMORY[0x1E0C9AA70], &v387);
      v296 = v53;
      v297 = (uint64_t)v387;
      v270 = v335;
      if (v387)
      {
        v298 = (void *)MEMORY[0x1D17BA0A0](v296);
        v299 = v335;
        HMFGetOSLogHandle();
        v300 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v300, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v304 = 22;
LABEL_139:
          _os_log_impl(&dword_1CD062000, v303, OS_LOG_TYPE_ERROR, v302, buf, v304);

          goto LABEL_140;
        }
        goto LABEL_140;
      }
      selectSQLite3(v296, "SELECT id FROM xact WHERE pushed < 0x0100000000000000", MEMORY[0x1E0C9AA70], &v387);
      ...
      if (isInternalBuild())
      {
        ...
        if (objc_msgSend(v56, "count"))
        {
          ...
          if (os_log_type_enabled(v320, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v391 = v321;
            _os_log_impl(&dword_1CD062000, v320, OS_LOG_TYPE_ERROR, "%{public}@We have duplicate records with different share_ids deleting duplicates.", buf, 0xCu);
...
LABEL_142:
              ...
              else
              {
                ...
                if (os_log_type_enabled(v316, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v391 = v317;
                  _os_log_impl(&dword_1CD062000, v316, OS_LOG_TYPE_ERROR, "%{public}@want to rebuild the databse, but not allowed to.", buf, 0xCu);
              ...
              if ((v222 & 1) != 0)
              {
                ...
                if (!v276)
                {
                  ...
                  if (os_log_type_enabled(v283, OS_LOG_TYPE_DEFAULT))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v392 = 2048;
                    v393 = 2;
                    _os_log_impl(&dword_1CD062000, v283, OS_LOG_TYPE_DEFAULT, "%{public}@Current schema version: %ld", buf, 0x16u);
                ...
                if (os_log_type_enabled(v279, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v394 = 2112;
                  v395 = v276;
                  _os_log_impl(&dword_1CD062000, v280, OS_LOG_TYPE_ERROR, "%{public}@Unable to update schema version to %ld: %@", buf, 0x20u);
...
LABEL_165:
            _os_log_impl(&dword_1CD062000, v300, OS_LOG_TYPE_ERROR, v324, buf, 0xCu);
      ...
      selectSQLite3(v334, "select uuid from record where share_id!=0;", MEMORY[0x1E0C9AA70], &v387);
      v56 = (void *)objc_claimAutoreleasedReturnValue();

      if (!objc_msgSend(v56, "count"))
        goto LABEL_167;
      v325 = (void *)MEMORY[0x1D17BA0A0]();
      v326 = v335;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v327, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v391 = v328;
        _os_log_impl(&dword_1CD062000, v327, OS_LOG_TYPE_DEFAULT, "%{public}@Have records with share_id will migrate them.", buf, 0xCu);
  ...
  if (context && !sqlite3_get_autocommit(context))
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        v11 = 2112;
        v12 = v4;
        _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@ROLLBACK FAILED!: %@", (uint8_t *)&v9, 0x16u);
...
- (id)_fillStoreCache
{
  ...
  while (1)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectStores, 1);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v4 == 101)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectZones);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
...
- (int64_t)_numUncommittedTransactions
{
  ...
  context = self->context;
  v19 = 0;
  selectSQLite3(context, "SELECT count(*) FROM xact WHERE disk_committed=0;", MEMORY[0x1E0C9AA70], &v19);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = v19;
...
LABEL_12:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v5;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine number of uncommitted transactions %@", buf, 0x16u);
...
- (id)_dropUncommittedUnpushedTransactions
{
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Dropped transactions that were not committed to disk.", (uint8_t *)&v9, 0xCu);
...
- (id)_fetchUncommittedAndPushedTransactions
{
  ...
  selectSQLite3(context, "SELECT id, xact_id, pushed, data, type, encoding, root FROM xact WHERE ((pushed & 0xffff0000) >> 16) != 0 AND disk_committed=0 ORDER BY root, xact_id, id;",
    ...
    &v6);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "na_map:", &__block_literal_global_114724);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_fetchZonesWithError:(id *)a3
{
  ...
  while (1)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectZones, 1);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (v7)
    {
...
- (id)_updateGroupWithID:(int64_t)a3 serverChangeToken:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", a4, 1, 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = 0;
...
LABEL_15:
  ...
  while (1)
  {
    ...
    {
      v9 = v8;
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectGroups, 1);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectGroups, 2);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectGroups, 3);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectGroups, 4);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectGroups, 5);
      v14 = objc_claimAutoreleasedReturnValue();
      v15 = (void *)v14;
      if (v12)
      {
        objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v12, v22);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        if (v15)
          goto LABEL_7;
      }
      else
      {
        ...
        {
LABEL_7:
          objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v15, v22);
          v17 = (void *)objc_claimAutoreleasedReturnValue();
          goto LABEL_10;
        }
      }
...
LABEL_10:
  ...
  if (v7 != 101)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectGroups);
...
- (id)_updateRecordWithGroupID:(int64_t)a3 store:(int64_t)a4 name:(id)a5 record:(id)a6 uuid:(id)a7 parentUUID:(id)a8 type:(id)a9 data:(id)a10 encoding:(int64_t)a11 schema:(id)a12
{
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v78 = 2112;
    v79 = v45;
    _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_DEBUG, "%{public}@Inserting/Updating record group: %lu, name: %@, uuid: %@, parent: %@, type: %@, schema: %@", buf, 0x48u);
...
- (id)_updateRecordWithGroupID:(int64_t)a3 store:(int64_t)a4 record:(id)a5
{
  ...
  if (v10)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("k%02lu"), v10);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_updateRecordWithGroupID:(int64_t)a3 store:(int64_t)a4 name:(id)a5 model:(id)a6
{
  ...
  else
  {
    ...
    v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95070]), "initWithRecordName:", v10);
...
- (void)_fetchRecordCountWithGroupID:(int64_t)a3 callback:(id)a4
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectRecordCountGroup);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    sqlite3_reset(self->selectRecordCountGroup);
    v9 = v12;
    if (!v7)
...
- (void)_fetchRecordTypeSchemaWithGroupID:(int64_t)a3 callback:(id)a4
{
  ...
  while (1)
  {
    ...
    if (v9 != 100)
      break;
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroupTypeSchema, 0);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroupTypeSchema, 1);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_8:
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectRecordGroupTypeSchema);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  sqlite3_reset(self->selectRecordGroupTypeSchema);
  v13 = v14;
  if (v7)
...
- (void)_fetchRecordMapWithGroupID:(int64_t)a3 callback:(id)a4
{
  ...
  else
  {
    while (1)
    {
      ...
      if (v10 != 100)
        break;
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroupMap, 0);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroupMap, 1);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroupMap, 2);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroupMap, 3);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectRecordGroup);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    sqlite3_reset(self->selectRecordGroupMap);
    v9 = v15;
    if (!v7)
...
- (void)_fetchRecordsWithGroupID:(int64_t)a3 callback:(id)a4
{
  ...
  else
  {
    while (1)
    {
      ...
      if (v17 != 100)
        break;
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroup, 0);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectRecordGroup, 1);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = sqlite3_column_int64(self->selectRecordGroup, 2);
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectRecordGroup, 3);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroup, 4);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroup, 5);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroup, 6);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecordGroup, 7);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_19:
  ...
  if (v12 != 100)
  {
    if (a5 && v12 != 101)
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectRecordUUIDNoShare);
  ...
  objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectRecordUUIDNoShare, 1);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_selectAllRecords:(id)a3
{
  ...
  while (1)
  {
    ...
    if (v4 != 100)
      break;
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecords, 0);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = sqlite3_column_int64(self->selectRecords, 1);
    v7 = sqlite3_column_int64(self->selectRecords, 2);
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecords, 3);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectRecords, 4);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = sqlite3_column_int64(self->selectRecords, 5);
    objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectRecords, 6);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectRecords, 7);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectRecords);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_23:
        objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", *p_updateLogXactID);
        v35 = objc_claimAutoreleasedReturnValue();
LABEL_24:
        v14 = (id)v35;
        break;
...
- (void)_selectLogWithRoot:(id)a3 after:(int64_t)a4 mask:(int64_t)a5 compare:(int64_t)a6 callback:(id)a7
{
  ...
  else
  {
    ...
    while (1)
    {
      ...
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", v21, 3);
      v29 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", v21);
      v30 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_selectLogWithMask:(int64_t)a3 compare:(int64_t)a4 callback:(id)a5
{
  ...
  else
  {
    while (1)
    {
      ...
      v15 = (void *)MEMORY[0x1E0C95070];
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectChangeExistsLog, 2);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectChangeExistsLog);
      v18 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_selectLogOptionsWithID:(int64_t)a3
{
  ...
  while (1)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v23 = 2048;
        v24 = a3;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Got multiple results for xact_block %lu (using first one)", buf, 0x16u);
    ...
    {
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectLogOptions, 0);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
    }
  }
  if (v7 != 101)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      HMFGetLogIdentifier();
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectLogOptions);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543618;
      v22 = v15;
      v23 = 2112;
      v24 = (int64_t)v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@unexpected error to selectLogOptions: %@", buf, 0x16u);
...
- (void)_selectAllLog:(id)a3
{
  ...
  while (1)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectAllLog, 3);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectAllLog, 4);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((v4 & 0xFFFFFFFE) != 0x64)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectAllLog);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_13:
  ...
  if (v14 != 100)
  {
    if (a6 && v14 != 101)
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithSQLite3Statement:", self->selectArchive);
      *a6 = (id)objc_claimAutoreleasedReturnValue();
    }
    sqlite3_reset(self->selectArchive);
    goto LABEL_13;
  }
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithSQLite3Column:column:", self->selectArchive, 1);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99D50], "dataWithSQLite3Column:column:", self->selectArchive, 2);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (void)cleanDatastoreFilesAt:(id)a3 everything:(BOOL)a4
{
  ...
  if (objc_msgSend(v6, "isEqualToString:", CFSTR(":memory:")))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Skipping because in memory store was specified.", buf, 0xCu);
  ...
  else
  {
    ...
    v50 = 0;
    objc_msgSend(MEMORY[0x1E0CB38E8], "regularExpressionWithPattern:options:error:", v13, 0, &v50);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = v50;
    if (v15)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v54 = 2112;
        v55 = v16;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@unable to compile expression: %@", buf, 0x16u);
      ...
      if (v24)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v56 = 2112;
          v57 = v44;
          _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@unable to get files in %@ (%@)", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t59_114924 != -1)
    dispatch_once(&logCategory__hmf_once_t59_114924, &__block_literal_global_185_114925);
  return (id)logCategory__hmf_once_v60_114926;
}
...
void __35__HMDBackingStoreLocal_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v60_114926;
  logCategory__hmf_once_v60_114926 = v0;
