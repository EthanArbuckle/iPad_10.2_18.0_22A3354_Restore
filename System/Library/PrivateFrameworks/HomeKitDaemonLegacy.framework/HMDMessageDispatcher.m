...
LABEL_11:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_76268 != -1)
    dispatch_once(&logCategory__hmf_once_t8_76268, &__block_literal_global_76269);
  return (id)logCategory__hmf_once_v9_76270;
}
...
void __40__HMDMessageDispatcher_dispatchMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if ((v8 & 1) == 0)
  {
    ...
    if (objc_msgSend(v11, "isEqualToString:", *MEMORY[0x1E0D27FC8]))
    {
      ...
      if (*(_BYTE *)(a1 + 72))
      {
        if (!*(_BYTE *)(a1 + 73))
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
          {
            ...
            v32 = 2112;
            v33 = v18;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Dropping unhandled remote message as it is not secure: %@ (%@)", (uint8_t *)&v28, 0x20u);
...
LABEL_18:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    v32 = 2112;
    v33 = v24;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Multiple invocations of response handler for message: %@ (%@)", (uint8_t *)&v28, 0x20u);
...
- (id)httpMessageTransport
{
  ...
  v11 = 0u;
  v12 = 0u;
  -[HMDMessageDispatcher secureRemoteTransport](self, "secureRemoteTransport", 0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)enableMessageServer
{
  ...
  -[HMDMessageDispatcher httpMessageTransport](self, "httpMessageTransport");
  v2 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "setServerEnabled:", 1);
...
- (void)disableMessageServer
{
  ...
  -[HMDMessageDispatcher httpMessageTransport](self, "httpMessageTransport");
  v2 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "setServerEnabled:", 0);
...
LABEL_8:
  ...
  return -[HMDMessageDispatcher secureRemoteTransport](v11, v12);
}
...
void __47__HMDMessageDispatcher_configureHTTPTransport___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "httpMessageTransport");
  v2 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "configureWithDevice:", *(_QWORD *)(a1 + 40));
...
+ (id)destinationWithTarget:(id)a3 userID:(id)a4 destination:(id)a5 multicast:(BOOL)a6 accountRegistry:(id)a7
{
  ...
  {
    v12 = a3;
    +[HMDDeviceHandle deviceHandleForDestination:](HMDDeviceHandle, "deviceHandleForDestination:", a5);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "deviceForHandle:", v13);
    v14 = (id)objc_claimAutoreleasedReturnValue();
    v15 = -[HMDRemoteDeviceMessageDestination initWithTarget:device:]([HMDRemoteDeviceMessageDestination alloc], "initWithTarget:device:", v12, v14);

  }
  else
  {
    v14 = a3;
    +[HMDAccountHandle accountHandleForDestination:](HMDAccountHandle, "accountHandleForDestination:", a4);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = -[HMDRemoteAccountMessageDestination initWithTarget:handle:multicast:]([HMDRemoteAccountMessageDestination alloc], "initWithTarget:handle:multicast:", v14, v13, v7);
  }
...
void __35__HMDMessageDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_76270;
  logCategory__hmf_once_v9_76270 = v0;
...
void __41__HMDMessageDispatcher_defaultDispatcher__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Creating default message dispatcher", (uint8_t *)&v12, 0xCu);
      ...
      if (v8 && v13)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v75 = 2112;
          v76 = v9;
          _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Ignoring setting a new peer since we already have an existing peer for home: %@", buf, 0x16u);
          ...
          v19))
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v75 = 2112;
        v76 = v9;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Ignoring setting a new remote access device as the current resident is reachable for home: %@", buf, 0x16u);
...
LABEL_31:
        if (v12 && (v24 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v75 = 2112;
            v76 = v44;
            _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Disabling resident remote access for home: %@", buf, 0x16u);
          ...
          if (v5)
          {
            v46 = (void *)MEMORY[0x1D17BA0A0](v45);
            v47 = v41;
            HMFGetOSLogHandle();
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v75 = 2112;
              v76 = v50;
              _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_INFO, "%{public}@Sending notification that remote session was torn down for home: %@", buf, 0x16u);
            ...
            v56 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"));
        ...
        if ((v57 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v77 = 2112;
            v78 = v63;
            _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_INFO, "%{public}@Enabling resident remote access for home %@ via device: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v75 = 2112;
          v76 = v8;
          _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Watch does not support the current resident: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v74 = v28;
    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Invalid home specified to setup/disable remote access", buf, 0xCu);
...
- (id)residentCommunicationHandlerForHome:(id)a3
{
  ...
  v13 = &v12;
  v14 = 0x3032000000;
  v15 = __Block_byref_object_copy__76331;
  v16 = __Block_byref_object_dispose__76332;
  v17 = 0;
  if (v4)
  {
    -[HMFMessageDispatcher workQueue](self, "workQueue");
    ...
    if ((v24 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v57 = v39;
        v43 = (void *)v68;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Mismatched device message destination: %@", buf, 0x16u);
    ...
    if ((v33 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v67 = 2112;
        v68 = (uint64_t)v52;
        _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Mismatched account message destination: %@", buf, 0x16u);
...
void __63__HMDMessageDispatcher_Deprecated__setCompanionDevice_forHome___block_invoke(id *a1)
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      v23 = 2112;
      v24 = v12;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Enabling companion remote access for home %@ via device: %@", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    if (v9)
    {
      ...
      v21 = 2112;
      v22 = v16;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Disabling companion remote access for home: %@", (uint8_t *)&v19, 0x16u);
...
void __61__HMDMessageDispatcher_Deprecated__handleSecureSessionError___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
          ...
          if (objc_msgSend(v13, "containsDevice:", v4))
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = v29;
              ...
              v41 = 2112;
              v42 = v18;
              _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Tearing down remote access session to device, %@, for home '%@'", buf, 0x20u);
    ...
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v23, "isEqualToString:", *MEMORY[0x1E0CB2F90]))
    {
...
LABEL_27:
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v38 = v27;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Sending internal notification that remote session was torn down for an unknown home", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v25);
      objc_msgSend(MEMORY[0x1E0D285D0], "internalMessageWithName:messagePayload:", CFSTR("kRemoteSessionTornDownNotificationKey"), 0);
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      v28 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"));
