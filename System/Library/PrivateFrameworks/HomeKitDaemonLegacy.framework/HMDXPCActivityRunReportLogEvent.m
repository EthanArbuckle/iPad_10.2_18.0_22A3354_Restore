...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDXPCActivityRunReportLogEvent activityShouldWake](self, "activityShouldWake"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v11[1] = v4;
  v10[2] = CFSTR("activityDefinedIntervalInMinutes");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDXPCActivityRunReportLogEvent activityDefinedIntervalInMinutes](self, "activityDefinedIntervalInMinutes"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v11[2] = v5;
  v10[3] = CFSTR("activityRunHourOfDay");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDXPCActivityRunReportLogEvent activityRunHourOfDay](self, "activityRunHourOfDay"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v11[3] = v6;
  v10[4] = CFSTR("activityTimeSinceLastRunInMinutes");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDXPCActivityRunReportLogEvent activityTimeSinceLastRunInMinutes](self, "activityTimeSinceLastRunInMinutes"));
