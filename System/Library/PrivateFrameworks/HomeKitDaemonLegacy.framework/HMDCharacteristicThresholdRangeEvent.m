...
- (BOOL)_evaluateNewValue:(id)a3
{
  ...
  if (v4 && v6)
  {
    -[HMDCharacteristicEventBase characteristic](self, "characteristic");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    +[HMDCharacteristicEventBase compareValueOfCharacteristic:againstValue:operatorType:](HMDCharacteristicEventBase, "compareValueOfCharacteristic:againstValue:operatorType:", v8, v6, &unk_1E8B33B28);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v29 = v14;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@The value hasn't changed from previous value, ignoring", buf, 0xCu);
...
LABEL_10:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v40 = 2112;
    v41 = v23;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Evaluated event, should fire (did enter range): %@, previous value: %@, current value: %@, min: %@, max: %@, %@", buf, 0x48u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_105489 != -1)
    dispatch_once(&logCategory__hmf_once_t0_105489, &__block_literal_global_105490);
  return (id)logCategory__hmf_once_v1_105491;
}
...
void __51__HMDCharacteristicThresholdRangeEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_105491;
  logCategory__hmf_once_v1_105491 = v0;
