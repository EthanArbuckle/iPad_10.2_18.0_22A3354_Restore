...
- (void)registerForSettingMessages:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v31 = 2112;
    v32 = v22;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Registering for setting messages %@", buf, 0x16u);
  ...
  objc_msgSend(v11, "registerForMessage:policies:messageDispatcher:messageHandler:", *MEMORY[0x1E0CB7ED8], v13, v14, v25);
  ...
  objc_msgSend(v11, "registerForMessage:policies:messageDispatcher:messageHandler:", *MEMORY[0x1E0CB7EB0], v20, v21, v23);
...
- (BOOL)_decodeUpdateValueMessagePayload:(id)a3 outValue:(id *)a4
{
  ...
  v6 = a3;
  objc_msgSend(v6, "hmf_dataForKey:", *MEMORY[0x1E0CB7EE8]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    v22 = 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v9;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive accessory setting supported value from value data: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v25 = 2112;
      v26 = v6;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Missing serialized value from payload: %@", buf, 0x16u);
...
- (void)_handleSettingUpdateValueByKeyPath:(id)a3
{
  ...
  if (v6)
  {
    objc_msgSend(v4, "messagePayload");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "hmf_stringForKey:", *MEMORY[0x1E0CB9B58]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleAddConstraint:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "dataForKey:", *MEMORY[0x1E0CB7E38]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3710], "deserializeObjectWithData:allowedClass:frameworkClasses:", v5, objc_opt_class(), MEMORY[0x1E0C9AA60]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (v6)
    {
      objc_msgSend(v4, "messagePayload");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v7, "hmf_stringForKey:", *MEMORY[0x1E0CB9B58]);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v27 = v23;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing key path in message payload", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid constraint in message payload", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Missing serialized constraint in message payload: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v11);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Constraint not found"), CFSTR("Missing serialized constraint in add message"), 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleRemoveConstraint:(id)a3
{
  ...
  else
  {
    ...
    objc_autoreleasePoolPop(v11);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Constraint not found"), CFSTR("Missing serialized constraint in remove message"), 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "respondWithError:", v6);
  }
...
- (void)_handleUpdatedConstraints:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v14)
    {
      objc_msgSend(v4, "messagePayload");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v15, "hmf_stringForKey:", *MEMORY[0x1E0CB9B58]);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v37 = v31;
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Missing key path in message payload", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v11;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive accessory setting constraint from constraints data: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v38 = 2112;
      v39 = v23;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Missing serialized constraints in message payload: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v19);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Constraint not found"), CFSTR("Missing serialized constraint in update message"), 0);
...
- (BOOL)processReplaceConstraintMessage:(id)a3 outConstraintsToAdd:(id *)a4 outConstraintIdsToRemove:(id *)a5
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "arrayForKey:", *MEMORY[0x1E0CB7E40]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
  {
    if ((objc_msgSend(v10, "hmf_objectsAreKindOfClass:", objc_opt_class()) & 1) != 0)
    {
      ...
      if (v12)
      {
        ...
        do
        {
          for (i = 0; i != v13; ++i)
          {
            ...
            v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", *(_QWORD *)(*((_QWORD *)&v53 + 1) + 8 * i));
      ...
      objc_msgSend(v8, "dataForKey:", *MEMORY[0x1E0CB7E30]);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      if (v17)
      {
...
LABEL_30:
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v61 = 2112;
          v62 = v23;
          _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive accessory setting constraint from constraints to add data: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v61 = 2112;
          v62 = v43;
          _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@Missing serialized constraints to add in message payload: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v10;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Invalid constraints classes: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v32;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Missing constraints to remove in message payload: %@", buf, 0x16u);
...
- (void)_handleReplaceConstraintsForKeyPath:(id)a3
{
  ...
  objc_msgSend(v4, "messagePayload");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_stringForKey:", *MEMORY[0x1E0CB9B58]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Missing key path from accessory settings update message: %@", buf, 0x16u);
...
- (void)relayUpdateValue:(id)a3 keyPath:(id)a4 destination:(id)a5 completion:(id)a6
{
  ...
  if (v11)
  {
    ...
    if (!v10)
    +[HMDRemoteMessage secureMessageWithName:qualityOfService:destination:messagePayload:](HMDRemoteMessage, "secureMessageWithName:qualityOfService:destination:messagePayload:", *MEMORY[0x1E0CB7ED8], 25, v11, v16, v27);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v30 = v13;
    v18 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v17, "setResponseHandler:", v29));
    v19 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v17;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Relaying update value message. %@", buf, 0x16u);
  ...
  {
    v23 = (void *)MEMORY[0x1D17BA0A0](v12);
    v24 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot send setting message as device is not known", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v23);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 54, v27);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)relayReplaceConstraints:(id)a3 constraintIdsToRemove:(id)a4 keyPath:(id)a5 destination:(id)a6 completion:(id)a7
{
  ...
  if (v13)
  {
    objc_msgSend(MEMORY[0x1E0CBA988], "_encodedConstraintsToAdd:", v12);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v29, "na_map:", &__block_literal_global_55_181022);
    v27 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CBA988], "_replaceConstraintsPayloadWithAdditions:removals:keyPath:", v15, v27, v30);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    +[HMDRemoteMessage secureMessageWithName:qualityOfService:destination:messagePayload:](HMDRemoteMessage, "secureMessageWithName:qualityOfService:destination:messagePayload:", *MEMORY[0x1E0CB7EB0], 25, v13, v16);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_initWeak(&location, self);
    ...
    v32 = v14;
    v18 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v17, "setResponseHandler:", v31));
    v19 = self;
    HMFGetOSLogHandle();
    v20 = (id)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v17;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Relaying replace constraints message. %@", buf, 0x16u);
...
- (void)notifyOfUpdatedValue:(id)a3 settingKeyPath:(id)a4
{
  ...
  if ((_os_feature_enabled_impl() & 1) == 0)
  {
    ...
    v9 = *MEMORY[0x1E0CB7ED8];
    v18[0] = *MEMORY[0x1E0CB7EE8];
    encodeRootObject();
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v18[1] = *MEMORY[0x1E0CB9B58];
    v19[0] = v10;
    v19[1] = v7;
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v19, v18, 2);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "entitledMessageWithName:messagePayload:", v9, v11);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    v16 = (void *)objc_msgSend(v13, "initWithTarget:", v15);
    objc_msgSend(v12, "setDestination:", v16);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode response %@ of relayed update value message.", buf, 0x16u);
...
void __73__HMDAccessorySettingsMessageHandler__handleSettingUpdateValueByKeyPath___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = 0;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Responding to the original update value request for target %@ with value: %@, configNum: %@, error: %@", (uint8_t *)&v19, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v30 = 2112;
      v31 = 0;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Responding to the original update value request for target %@ with value: %@, configNum: %@, error: %@", buf, 0x34u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_181081 != -1)
    dispatch_once(&logCategory__hmf_once_t0_181081, &__block_literal_global_181082);
  return (id)logCategory__hmf_once_v1_181083;
}
...
void __49__HMDAccessorySettingsMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_181083;
  logCategory__hmf_once_v1_181083 = v0;
