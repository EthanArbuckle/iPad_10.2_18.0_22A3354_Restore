  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio stream interface", buf, 0xCu);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating HMDAudioStreamInterface object", buf, 0xCu);
...
- (NSNumber)syncSource
{
  ...
  objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x1E0CF22F8]);
...
- (void)_startStreamWithConfig:(id)a3
{
  ...
  if (!v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v18;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Failed to load misc fields to audio config", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v6);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1016);
  ...
  if (v9)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v22 = 2112;
    v23 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Configuring audio stream with configuration: %@", buf, 0x16u);
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v13;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to configure audio stream: %@", buf, 0x16u);
...
- (void)_updateAudioSetting:(unint64_t)a3
{
  ...
  if (a3 - 1 >= 3)
  {
    v13 = MEMORY[0x1D17BA0A0](self, a2);
    v14 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2048;
      v25 = a3;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Invalid audio stream setting %tu", (uint8_t *)&v22, 0x16u);
  ...
  if (v5 == a3)
  {
    if (v9)
    {
      ...
      v24 = 2112;
      v25 = (unint64_t)v11;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Audio stream setting is already set to %@", (uint8_t *)&v22, 0x16u);
...
LABEL_9:
  ...
  if (v9)
  {
    ...
    v26 = 2112;
    v27 = v19;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Changing the audio stream setting from %@ to %@", (uint8_t *)&v22, 0x20u);
...
- (void)_stopStreamWithCompletion:(id)a3
{
  ...
  if (-[HMDStreamInterface state](self, "state") == 3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Not stopping stream because it has already stopped", (uint8_t *)&v15, 0xCu);
  ...
  {
    v10 = (void *)MEMORY[0x1D17BA0A0](-[HMDAudioStreamInterface setStopStreamCompletionHandler:](self, "setStopStreamCompletionHandler:", v4));
    v11 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Stopping audio stream", (uint8_t *)&v15, 0xCu);
...
- (void)_pauseStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Pausing audio stream", (uint8_t *)&v8, 0xCu);
...
- (void)_resumeStream
{
  ...
  if ((_DWORD)v5)
  {
    if (v10)
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Resuming audio stream", (uint8_t *)&v14, 0xCu);
  ...
  else
  {
    if (v10)
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting audio stream", (uint8_t *)&v14, 0xCu);
...
- (void)startSynchronizationWithVideoStreamToken:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2048;
    v13 = a3;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting synchronization with video stream token: %ld", (uint8_t *)&v10, 0x16u);
...
- (void)setMuted:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting audio muted to %@", (uint8_t *)&v13, 0x16u);
...
- (void)_callStarted:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didStart", buf, 0xCu);
...
- (void)_callPaused:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didPause", buf, 0xCu);
...
- (void)_callResumed:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didResume", buf, 0xCu);
...
- (void)_callStopped:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v18 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didStop", buf, 0xCu);
...
void __48__HMDAudioStreamInterface_streamDidRTCPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream RTCP has timed out", (uint8_t *)&v6, 0xCu);
...
void __47__HMDAudioStreamInterface_streamDidRTPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream RTP has timed out", (uint8_t *)&v6, 0xCu);
...
void __46__HMDAudioStreamInterface_streamDidServerDie___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream server died", (uint8_t *)&v8, 0xCu);

  }
  objc_autoreleasePoolPop(v2);
  v6 = *(void **)(a1 + 32);
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1014);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
uint64_t __50__HMDAudioStreamInterface_stream_didResume_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream resumed with didResume: %@ error: %@", (uint8_t *)&v9, 0x20u);
...
uint64_t __49__HMDAudioStreamInterface_stream_didPause_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream paused with didPause: %@ error: %@", (uint8_t *)&v9, 0x20u);
...
uint64_t __41__HMDAudioStreamInterface_streamDidStop___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream stopped", (uint8_t *)&v7, 0xCu);
...
uint64_t __49__HMDAudioStreamInterface_stream_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream started with didStart: %@ error: %@", (uint8_t *)&v9, 0x20u);
...
void __54__HMDAudioStreamInterface_updateAudioVolume_callback___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2048;
    v24 = v9;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Setting audio stream volume from %f to %f", (uint8_t *)&v19, 0x20u);
...
+ (id)_createAudioStreamWithSessionHandler:(id)a3 localNetworkConfig:(id)a4 localRTPSocket:(int *)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 138543362;
    v27 = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Creating the audio stream", (uint8_t *)&v26, 0xCu);

  }
  objc_autoreleasePoolPop(v10);
  v14 = v8;
  if (objc_msgSend(v14, "conformsToProtocol:", &unk_1EFA946C8))
    v15 = v14;
  else
    v15 = 0;
  v16 = v15;
  ...
  {
    v19 = v14;
    if (objc_msgSend(v19, "conformsToProtocol:", &unk_1EFB1F220))
      v20 = v19;
    else
      v20 = 0;
    v21 = v20;
    ...
    {
      v22 = v19;
      if (objc_msgSend(v22, "conformsToProtocol:", &unk_1EFA9A3E8))
        v23 = v22;
      else
        v23 = 0;
      v24 = v23;
...
+ (id)_createStreamWithRemoteDestinationReceiver:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v23 = 2112;
    v24 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating audio stream with destination: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v5);
  v10 = objc_alloc(MEMORY[0x1E0CF2250]);
  objc_msgSend(v4, "remoteDestination");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to create remote destination receiver AVCAudioStream: %@", buf, 0x16u);
...
+ (id)_createStreamWithRemoteSocketReceiver:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating audio stream with socket: %d", buf, 0x12u);

  }
  objc_autoreleasePoolPop(v5);
  v9 = xpc_dictionary_create(0, 0, 0);
  xpc_dictionary_set_fd(v9, (const char *)*MEMORY[0x1E0CF2308], objc_msgSend(v4, "remoteAudioSocket"));
  v18 = 0;
  v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CF2250]), "initWithNetworkSockets:isOriginator:error:", v9, 0, &v18);
  v11 = v18;
  if (v10)
  {
    v12 = v10;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v11;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to create remote socket receiver AVCAudioStream: %@", buf, 0x16u);
...
+ (int)_createLocalRTPSocketWithRemoteSender:(id)a3 localNetworkConfig:(id)a4
{
  ...
  if (v8 == -1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 1024;
      v22 = v15;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Could not create rtp socket with port %@ %d", (uint8_t *)&v17, 0x1Cu);
  ...
  if (v7 == -1)
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 1024;
      v32 = v20;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Could not create rtp socket with port %@ %d", buf, 0x1Cu);
  ...
  else
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 1024;
      LODWORD(v30) = v7;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Creating local audio stream with socket %d", buf, 0x12u);

    }
    objc_autoreleasePoolPop(v8);
    v13 = xpc_dictionary_create(0, 0, 0);
    xpc_dictionary_set_fd(v13, (const char *)*MEMORY[0x1E0CF2308], v7);
    v26 = 0;
    v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CF2250]), "initWithNetworkSockets:isOriginator:error:", v13, 0, &v26);
    v15 = v26;
    if (v14)
    {
      *a3 = v7;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v29 = 2112;
        v30 = v15;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create local AVCAudioStream: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t39 != -1)
    dispatch_once(&logCategory__hmf_once_t39, &__block_literal_global_38787);
