...
LABEL_29:
    ...
    if (v33)
    {
      v34 = objc_alloc(MEMORY[0x1E0D34378]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v62 = 2112;
        v63 = v11;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Failed to create session for device, could not create destination: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v62 = 2112;
        v63 = v11;
        _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to create session for device: %@", buf, 0x16u);
