  ...
  if (v6)
  {
    ...
    if (xpcServerNotifyToken == -1)
    {
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 67109120;
          v27 = v22;
          _os_log_impl(&dword_1CD062000, MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT, "[Siri Server] Notify: failed to retrieve token (%d)", buf, 8u);
        }
      }
    }
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 67109120;
        v27 = v17;
        _os_log_impl(&dword_1CD062000, MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT, "[Siri Server] Notify: failed to set state to ready (%d)", buf, 8u);
      }
    }
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 67109120;
        v27 = v19;
        _os_log_impl(&dword_1CD062000, MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT, "[Siri Server] Notify: failed to post (%d)", buf, 8u);
      }
    }
...
- (void)dealloc
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 67109120;
      v9 = v4;
      _os_log_impl(&dword_1CD062000, MEMORY[0x1E0C81028], OS_LOG_TYPE_DEFAULT, "[Siri Server] Notify: failed to set state to stopped (%d)", buf, 8u);
    }
  }
...
- (BOOL)registerSiriSession:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Session with identifier %@ already exists!", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Registering session %@", (uint8_t *)&v16, 0x16u);
...
- (void)deregisterSiriSession:(id)a3
{
  ...
  if (v6)
  {
    if (v10)
    {
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Deregistering session %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    if (v10)
    {
      ...
      v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Session deregistration with identifier %@ but was not registered!", (uint8_t *)&v15, 0x16u);
...
- (void)handleServerEvent:(id)a3
{
  ...
  v4 = a3;
  if (MEMORY[0x1D17BAB98]() == MEMORY[0x1E0C812E0])
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Unexpected Siri XPC server event: %@", (uint8_t *)&v9, 0x16u);
  ...
  if (v5 && xpc_BOOL_get_value(v5))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Siri received incoming XPC connection: %p %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v24;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Siri received incoming XPC connection but was not entitled; closing.",
        buf,
        0xCu);
...
- (void)handleDisconnection
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Siri received disconnect on XPC connection: %@", buf, 0x16u);
...
LABEL_10:
    ...
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, v10, (uint8_t *)&v11, 0x16u);
...
- (void)handleMsg:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received Siri XPC message to %p: %@", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2080;
      v22 = string;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unexpected message: '%s'", (uint8_t *)&v19, 0x16u);
...
- (void)sendMsgIfCheckedIn:(id)a3 args:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Cannot send; no XPC client is checked in yet",
        (uint8_t *)&v13,
        0xCu);
...
- (void)sendMsg:(id)a3 args:(id)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v21 = 2112;
    v22 = v8;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Sending Siri XPC message to %p: %@", (uint8_t *)&v17, 0x20u);
...
- (void)handleCheckInMsg:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Siri checked in", (uint8_t *)&v9, 0xCu);
