...
- (HMDCounterThresholdTTRTrigger)initWithThreshold:(int64_t)a3 ttrCategory:(id)a4 radarInitiator:(id)a5
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("HomeKit Issue Detected: [%@]"), v10);
...
- (void)updatedCounter:(id)a3 fromOldValue:(int64_t)a4 toNewValue:(int64_t)a5
{
  ...
  if (activeThreshold <= a5 && activeThreshold > a4)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 2048;
      v31 = a5;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@TTR threshold trigger: eventName=%{public}@, radarTitle=%{public}@, value=%lu", (uint8_t *)&v24, 0x2Au);
