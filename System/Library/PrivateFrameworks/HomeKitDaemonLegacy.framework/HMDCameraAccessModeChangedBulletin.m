...
+ (id)localizedMessageForCameraAccessModeChange:(unint64_t)a3 changeReason:(int64_t)a4 camera:(id)a5
{
  ...
  if (v9)
  {
    if (a3 <= 3)
    {
      HMDLocalizedStringForKey(off_1E89C0FC8[a3]);
          ...
          if (!v27)
          {
            ...
            if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v49 = 2112;
              v50 = v28;
              _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
...
LABEL_22:
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unknown accessMode %lu, not posting notification", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v45 = 2112;
      v46 = v8;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Accessory reference was nil on camera: %@", buf, 0x16u);
