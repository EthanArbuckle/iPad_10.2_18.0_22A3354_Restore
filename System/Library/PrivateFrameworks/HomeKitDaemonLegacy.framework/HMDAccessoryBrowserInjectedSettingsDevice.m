...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D163E0]), "initWithQueue:", self->_queue);
}

- (id)createBtleAccessoryBrowser
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D163D0]), "initWithQueue:", self->_queue);
}
...
- (id)createCHIPAccessoryBrowser
{
  ...
  v3 = objc_alloc(MEMORY[0x1E0D33278]);
  queue = self->_queue;
...
- (id)createHap2AccessoryBrowserWithStorage:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0D163D8];
  v5 = a3;
