...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDAppleMediaAccessoryRemovalLogEvent isLocalRemoval](self, "isLocalRemoval"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("isLocalRemoval"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDAppleMediaAccessoryRemovalLogEvent isLocalFallback](self, "isLocalFallback"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("isLocalFallback"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDAppleMediaAccessoryRemovalLogEvent isDuplicate](self, "isDuplicate"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("isDuplicate"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDAppleMediaAccessoryRemovalLogEvent duplicateCount](self, "duplicateCount"));
