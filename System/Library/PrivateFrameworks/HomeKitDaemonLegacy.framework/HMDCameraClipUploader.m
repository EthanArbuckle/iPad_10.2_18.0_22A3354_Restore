...
- (HMDCameraClipUploader)initWithClipUUID:(id)a3 startDate:(id)a4 targetFragmentDuration:(double)a5 quality:(int64_t)a6 localZone:(id)a7 workQueue:(id)a8 logIdentifier:(id)a9
{
  ...
  v16 = (objc_class *)MEMORY[0x1E0CBA3D8];
  v17 = a9;
  v18 = a8;
  v19 = a7;
  v20 = a4;
...
LABEL_19:
  ...
  if (v25)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@/%@"), v21, v18);
...
- (id)addVideoInitData:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Asked to add video init data before clip has been created", (uint8_t *)&v19, 0xCu);
...
- (id)addVideoSegmentData:(id)a3 duration:(double)a4 timeOffsetWithinClip:(double)a5 clipFinalizedBecauseMaxDurationExceeded:(BOOL)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Asked to add video segment before clip has been created", (uint8_t *)&v27, 0xCu);
...
- (id)_addOperation:(id)a3 finalizeClipOnError:(BOOL)a4
{
  ...
  v9 = v8;
  v21 = v9;
  v10 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v6, "setCompletionBlock:", v20));
  v11 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v6;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding operation to queue: %@", buf, 0x16u);
...
- (void)_operationCompleted:(id)a3 finalizeOnError:(BOOL)a4 future:(id)a5
{
  ...
  if (v10 && v6 && !-[HMDCameraClipUploader _isCancelledError:](self, "_isCancelledError:", v10))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2114;
      v25 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Handling fatal error for operation %{public}@: %{public}@", (uint8_t *)&v20, 0x20u);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v8;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Operation completed: %@", (uint8_t *)&v20, 0x16u);
...
- (void)_startNextOperation
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting next operation: %@", (uint8_t *)&v9, 0x16u);
...
- (void)_handleFatalOperationFailureDueToError:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDCameraClipUploaderErrorDomain"), 1, 0);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  }
  v17 = 0u;
  v18 = 0u;
...
void __90__HMDCameraClipUploader_addNotificationForSignificantEvent_homePresenceByPairingIdentity___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting significant event operation: %@", (uint8_t *)&v10, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_156501 != -1)
    dispatch_once(&logCategory__hmf_once_t7_156501, &__block_literal_global_156502);
  return (id)logCategory__hmf_once_v8_156503;
}
...
void __36__HMDCameraClipUploader_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_156503;
  logCategory__hmf_once_v8_156503 = v0;
