...
- (void)configureWithHome:(id)a3 messageDispatcher:(id)a4 workQueue:(id)a5
{
  ...
  if (self)
  {
    ...
    objc_msgSend(objc_getProperty(self, v17, 40, 1), "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB8C90], self, v14, sel__handleFetchSleepWakeStateMessage_);
...
- (void)fetchSleepWakeStateWithCompletion:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v9;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Fetching sleep wake state with current fetch future: %@", buf, 0x16u);
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0D285F8], "messageWithName:destination:payload:", *MEMORY[0x1E0CB8C90], v22, 0);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[4] = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unable to get current device from AppleMediaAccessorySleepWakeStateControllerDataSource", buf, 0xCu);
...
LABEL_12:
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, v14, buf, 0xCu);
  ...
  if ((objc_msgSend(v4, "isRemote") & 1) != 0 || objc_msgSend(v4, "isSecureRemote"))
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay remote fetch sleep wake message twice", buf, 0xCu);
  ...
  *(_QWORD *)(v9 + 16) = 0;
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v5;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Fetching sleep wake state failed with error: %@", (uint8_t *)&v21, 0x16u);
  ...
  {
    objc_msgSend(v6, "hmf_numberForKey:", *MEMORY[0x1E0CB8C88]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = 0;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Fetching sleep wake state failed, missing sleep wake state key: %@", (uint8_t *)&v21, 0x16u);
