...
- (id)_identifierCharacteristic
{
  ...
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x1E0CB88F8]);
...
- (id)_nameCharacteristic
{
  ...
  -[HMDSiriEndpointProfileAssistant service](self, "service");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "findCharacteristicWithType:", *MEMORY[0x1E0CB8968]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)updateCharacteristic:(id)a3 value:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = objc_msgSend(v8, "isEqualToString:", *MEMORY[0x1E0CB88F8]);
  ...
  objc_msgSend(v6, "type");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = objc_msgSend(v13, "isEqualToString:", *MEMORY[0x1E0CB8968]);
  ...
  v18 = objc_msgSend(v17, "isEqualToString:", *MEMORY[0x1E0CB8790]);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x1E0CB9BB8]);

  -[HMDSiriEndpointProfileAssistant name](self, "name");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB9BC0]);

  -[HMDSiriEndpointProfileAssistant active](self, "active");
  v7 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x1E0CB9BB0]);
