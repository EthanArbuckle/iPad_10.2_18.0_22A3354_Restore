...
- (void)configureWithIsResidentCapable:(BOOL)a3
{
  ...
  if (isiPadDevice())
  {
    ...
    objc_msgSend(v20, "addObserver:selector:name:object:", v4, sel_handleResidentUpdated_, CFSTR("HMDResidentDeviceManagerUpdateResidentNotification"), v21);
...
- (void)handleIsResidentFirstAccessoryCommunicationEnabledDidChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Home changed resident first accessory communication enablement", (uint8_t *)&v9, 0xCu);
...
- (void)handleCurrentResidentChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Current device resident enable = %@, isPrimary = %@, evaluate connection status with accessories", (uint8_t *)&v12, 0x20u);
...
- (void)handleResidentChangedOnNonResident
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v11;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@A resident device was updated for home %@(%@), evaluating current non-resident device connection status with accessories", (uint8_t *)&v12, 0x20u);
...
- (void)handlePrimaryResidentChanged:(id)a3
{
  ...
  if (self)
    ...
    WeakRetained = 0;
  v6 = objc_msgSend(WeakRetained, "isCurrentDeviceAvailableResident");
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Primary resident changed, evaluating connection status with accessories", (uint8_t *)&v11, 0xCu);

    }
    objc_autoreleasePoolPop(v7);
    -[HMDHAPAccessoryConnectionCoordinator evaluateAccessoryConnectionStatus](v8, "evaluateAccessoryConnectionStatus");
  }
...
- (void)evaluateAccessoryConnectionStatus
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    HMFBooleanToString();
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(WeakRetained, "areAllResidentsUnreachable");
    HMFBooleanToString();
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    *(_DWORD *)buf = 138544130;
    ...
    v27 = 2114;
    v28 = v10;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Evaluating connection status for all accessories using - isCurrentDevicePrimaryResident = %{public}@, isCurrentDeviceAvailableResident = %{public}@, areAllResidentsUnreachable = %{public}@", buf, 0x2Au);
        ...
        if (v3)
        {
          ...
          if (v12)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_QWORD *)&buf[4] = v16;
              _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Triggering evaluation of HAP servers", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_28347 != -1)
    dispatch_once(&logCategory__hmf_once_t11_28347, &__block_literal_global_28348);
  return (id)logCategory__hmf_once_v12_28349;
}
...
void __51__HMDHAPAccessoryConnectionCoordinator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_28349;
  logCategory__hmf_once_v12_28349 = v0;
