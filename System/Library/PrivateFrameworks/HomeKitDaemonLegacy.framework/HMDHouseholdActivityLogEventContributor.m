...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_136439 != -1)
    dispatch_once(&logCategory__hmf_once_t2_136439, &__block_literal_global_136440);
  return (id)logCategory__hmf_once_v3_136441;
}
...
void __54__HMDHouseholdActivityLogEventContributor_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_136441;
  logCategory__hmf_once_v3_136441 = v0;
