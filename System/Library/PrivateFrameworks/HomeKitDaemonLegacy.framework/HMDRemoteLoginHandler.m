...
- (HMDRemoteLoginHandler)initWithAccessory:(id)a3 loggedInAccountData:(id)a4
{
  ...
  {
    v20 = 0;
    objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v7, &v20);
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v24 = 2112;
        v25 = v9;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive logged in account from logged in account data: %@", buf, 0x16u);
...
- (HMDRemoteLoginHandler)initWithUUID:(id)a3 accessory:(id)a4 loggedInAccount:(id)a5 accountStore:(id)a6 targetSupportsAccounts:(BOOL)a7
{
  ...
  if (v17)
  {
    ...
    v19 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286A8]), "initWithValue:", 0);
...
- (void)_handleRemoteLoginAccount:(id)a3 message:(id)a4
{
  ...
  void *v19;
  void *v20;
  HMDRemoteLoginHandler *v21;
  id v22;
  id v23;
  void *v24;
  void *v25;
  void *v26;
  HMDRemoteLoginHandler *v27;
  NSObject *v28;
  void *v29;
  void *v30;
  void *v31;
  ...
  v6 = a3;
  v7 = a4;
  objc_msgSend(v6, "loggedInAccount");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
    v38 = 0;
    objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v8, &v38);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v38;
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v41 = 2112;
        v42 = v10;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive logged in account from logged in account data: %@", buf, 0x16u);
  ...
  -[HMDRemoteLoginHandler setLoggedInAccount:](self, "setLoggedInAccount:", v9);
  ...
  if (HMFEqualObjects())
  {
    ...
    if ((v36 & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        -[HMDRemoteLoginHandler loggedInAccount](v27, "loggedInAccount");
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v43 = 2112;
        v44 = v9;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Not updating logged in account from %@ to %@, as they are equal", buf, 0x20u);
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    -[HMDRemoteLoginHandler loggedInAccount](v32, "loggedInAccount");
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v43 = 2112;
    v44 = v9;
    _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating logged in account from %@ to %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v31);
  -[HMDRemoteLoginHandler setLoggedInAccount:](v32, "setLoggedInAccount:", v9);
  -[HMDRemoteLoginHandler _sendAccountUpdateNotification:](v32, "_sendAccountUpdateNotification:", v9);
LABEL_17:
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending account update notification: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v5);
    v17 = CFSTR("kRemoteLoginAccount");
    encodeRootObject();
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = v9;
...
- (void)_handleUpdateLoggedInAccountMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v42 = 2112;
    v43 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update logged in account message: %@", (uint8_t *)&v40, 0x16u);
  ...
  if (v10)
  {
    objc_msgSend(MEMORY[0x1E0CB3710], "deserializeObjectWithData:allowedClass:frameworkClasses:", v10, objc_opt_class(), MEMORY[0x1E0C9AA60]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v42 = 2112;
        v43 = v11;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Updated account matches the currently logged in account: %@", (uint8_t *)&v40, 0x16u);
...
LABEL_10:
      ...
      if (v23)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v40 = 138543362;
          v41 = v27;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to update account, existing account present", (uint8_t *)&v40, 0xCu);
        ...
        if (!v28)
          goto LABEL_25;
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 48, CFSTR("Not supported."), CFSTR("Existing account present."), 0);
...
LABEL_25:
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    v42 = 2112;
    v43 = v35;
    _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Missing serialized account in message payload: %@", (uint8_t *)&v40, 0x16u);
...
- (void)stageLoggedInAccount:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Staging logged in account: %@", (uint8_t *)&v10, 0x16u);
...
- (void)updateFrameworkWithReason:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to update home graph without a home manager for reason: %@", (uint8_t *)&v13, 0x16u);
...
- (id)accountInfoFromLastEvent
{
  ...
  if (v3)
  {
    ...
    if (v4)
    {
      ...
      if (v6)
      {
        v7 = objc_alloc(MEMORY[0x1E0CBA248]);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            v24 = 138543362;
            v25 = v22;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last account info event account due invalid stored event data", (uint8_t *)&v24, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 138543362;
        v25 = v18;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last account info event account due to no event store read handle", (uint8_t *)&v24, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 138543362;
      v25 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last account info event account due to no topic", (uint8_t *)&v24, 0xCu);
...
- (id)accountInfoForAccount:(id)a3
{
  ...
  v3 = (objc_class *)MEMORY[0x1E0CBA248];
  v4 = a3;
  v5 = [v3 alloc];
...
- (id)eventTopicForAccountInfo
{
  ...
  if (v4 && v6)
  {
    objc_msgSend(MEMORY[0x1E0CBA240], "topicFromSuffixID:homeUUID:accessoryUUID:", *MEMORY[0x1E0CB7C08], v6, v4);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get account info event topic due to missing accessory uuid: %@ home uuid: %@", (uint8_t *)&v13, 0x20u);
...
- (void)_postAccountInfoFromAccountStore
{
  ...
  if (v3)
  {
      ...
      && objc_msgSend(v4, "isCurrentAccessory"))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v17 = 2112;
        v18 = v6;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Posting account store account: %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to post account info from account store due to missing accessory", (uint8_t *)&v15, 0xCu);
...
- (void)_postUpdatedAccountInfo:(id)a3
{
  ...
  {
    v5 = (void *)MEMORY[0x1D17BA0A0](-[HMDRemoteLoginHandler setLoggedInAccount:](self, "setLoggedInAccount:", v4));
    v6 = self;
    HMFGetOSLogHandle();
    v7 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Posting event to update logged in account: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to post account: %@ due to unsupported account target", buf, 0x16u);
...
- (void)_updateLoggedInAccount:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating logged in account to: %@, supportsMessagedHomePodSettings: %@", (uint8_t *)&v14, 0x20u);
  ...
  {
    objc_msgSend(MEMORY[0x1E0D285D0], "entitledMessageWithName:messagePayload:", CFSTR("kRemoteLoginAccountUpdatedNotificationKey"), 0);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_registerForUsernameUpdates
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Register for username updates", (uint8_t *)&v9, 0xCu);
...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Unstaging logged in account: %@", (uint8_t *)&v12, 0x16u);
...
void __69__HMDRemoteLoginHandler_handleAccountUsernameUpdatedOnCurrentDevice___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    v21 = 2112;
    v22 = v8;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEBUG, "%{public}@loggedInAccount On Update:%@", (uint8_t *)&v19, 0x16u);
  ...
  if (v9)
  {
    ...
    if ((v14 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v19 = 138543362;
        v20 = v18;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating account on username change", (uint8_t *)&v19, 0xCu);
  ...
  if (v6 || v4 == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v38 = 2112;
      v39 = v5;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to post event to update logged in account: %@ due to missing topic: %@ event forwarder: %@ event source: %@", buf, 0x34u);
    ...
    if (v14 && objc_msgSend(v14, "isEqual:", v13))
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v15;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Skip posting event to update logged in account as it matches account info from last event: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v34 = 2112;
        v35 = v13;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Forwarding account info event with topic: %@ for accountInfo: %@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v20);
      v24 = objc_alloc(MEMORY[0x1E0D32D38]);
      objc_msgSend(MEMORY[0x1E0C99D68], "timeIntervalSinceReferenceDate");
      v25 = (void *)objc_msgSend(v24, "initWithSource:cachePolicy:combineType:timestamp:", v5, 2, 2);
      v26 = objc_alloc(MEMORY[0x1E0D32D28]);
      ...
      v29[1] = 3221225472;
      v29[2] = __49__HMDRemoteLoginHandler__postUpdatedAccountInfo___block_invoke_45;
      v29[3] = &unk_1E89C2350;
      v29[4] = *(_QWORD *)(a1 + 32);
...
void __49__HMDRemoteLoginHandler__postUpdatedAccountInfo___block_invoke_45(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to forward account info event with error: %@", (uint8_t *)&v8, 0x16u);
...
void __56__HMDRemoteLoginHandler__sendAccountUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0D285D0], "entitledMessageWithName:messagePayload:", CFSTR("kRemoteLoginAccountUpdatedNotificationKey"), *(_QWORD *)(a1 + 32));
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "sendMessage:target:", v5, v4);

}

+ (id)logCategory
{
  if (logCategory__hmf_once_t1_184373 != -1)
    dispatch_once(&logCategory__hmf_once_t1_184373, &__block_literal_global_184374);
  return (id)logCategory__hmf_once_v2_184375;
}
...
+ (id)remoteMessages
{
  ...
  v2 = *MEMORY[0x1E0CBAB30];
  v8[6] = *MEMORY[0x1E0CBAB28];
  v8[7] = v2;
  v3 = *MEMORY[0x1E0CBAB40];
  v8[8] = *MEMORY[0x1E0CBAB38];
  v8[9] = v3;
  v4 = *MEMORY[0x1E0CBAB00];
  v8[10] = *MEMORY[0x1E0CBAAF8];
  v8[11] = v4;
  v5 = *MEMORY[0x1E0CBAB10];
  v8[12] = *MEMORY[0x1E0CBAB08];
  v8[13] = v5;
  v6 = *MEMORY[0x1E0CBAB20];
  v8[14] = *MEMORY[0x1E0CBAB18];
  v8[15] = v6;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v8, 16);
...
void __36__HMDRemoteLoginHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_184375;
  logCategory__hmf_once_v2_184375 = v0;
