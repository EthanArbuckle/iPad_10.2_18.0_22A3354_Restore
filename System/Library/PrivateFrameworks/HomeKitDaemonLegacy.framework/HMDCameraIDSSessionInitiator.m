...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the IDS session initiator", buf, 0xCu);
...
- (void)_sendInvitation
{
  ...
  if (objc_msgSend(v4, "count") && (objc_msgSend(v4, "anyObject"), (v5 = objc_claimAutoreleasedReturnValue()) != 0))
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1E8B32A78, *MEMORY[0x1E0D34280]);
    objc_msgSend(v7, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], *MEMORY[0x1E0D34278]);
    -[HMDCameraIDSSessionInitiator localNetworkConfig](self, "localNetworkConfig");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = objc_msgSend(v8, "ipv6");

    if ((v9 & 1) == 0)
      objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1E8B32A90, *MEMORY[0x1E0D34270]);
...
- (void)session:(id)a3 receivedInvitationAcceptFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %{public}@ has been accepted by: %@, waiting for session to get started", (uint8_t *)&v12, 0x20u);
...
- (void)session:(id)a3 receivedInvitationDeclineFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ has been declined by: %@", (uint8_t *)&v12, 0x20u);
...
- (void)session:(id)a3 receivedInvitationCancelFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ was canceled by: %@", (uint8_t *)&v12, 0x20u);
...
- (void)sessionStarted:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2114;
    v13 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@IDSSession %{public}@ has started", (uint8_t *)&v10, 0x16u);
...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2114;
    v22 = v9;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@IDSSession %{public}@ has ended with reason: %{public}u and error %{public}@", (uint8_t *)&v15, 0x26u);
...
- (void)_callSessionStarted
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Calling didSetUp delegate", buf, 0xCu);
...
void __58__HMDCameraIDSSessionInitiator_packetRelay_didStop_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay did stop: %@ error: %@", (uint8_t *)&v8, 0x20u);
...
void __59__HMDCameraIDSSessionInitiator_packetRelay_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2114;
    v13 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay did start: %{public}@ error: %{public}@", (uint8_t *)&v8, 0x20u);
...
void __147__HMDCameraIDSSessionInitiator__startPacketRelayWithVideoSocket_videoNetworkConfig_cameraVideoSSRC_audioSocket_audioNetworkConfig_cameraAudioSSRC___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28628]), "initWithName:", CFSTR("com.apple.homed.packet-relay"));
  ...
  if (v3)
  {
    v4 = objc_alloc_init(MEMORY[0x1E0CF2290]);
    ...
    v57 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CF2298]), "initWithIncomingSSRC:acceptPacketType:", *(unsigned int *)(a1 + 56), 0);
    objc_msgSend(MEMORY[0x1E0CF22A8], "connectionWithSocket:remoteAddress:packetFilter:", *(unsigned __int16 *)(a1 + 60), v4);
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v65[4] = 2112;
      *(_QWORD *)&v65[6] = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Created video relay connection with SSRC %08x and config: %@", buf, 0x1Cu);

    }
    objc_autoreleasePoolPop(v7);
    v13 = objc_alloc_init(MEMORY[0x1E0CF2290]);
    ...
    v56 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CF2298]), "initWithIncomingSSRC:acceptPacketType:", *(unsigned int *)(a1 + 64), 0);
    objc_msgSend(MEMORY[0x1E0CF22A8], "connectionWithSocket:remoteAddress:packetFilter:", *(unsigned __int16 *)(a1 + 68), v13);
    v16 = objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v65[4] = 2112;
      *(_QWORD *)&v65[6] = v22;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Created audio relay connection with SSRC %08x and config: %@", buf, 0x1Cu);

    }
    objc_autoreleasePoolPop(v17);
    v23 = (void *)MEMORY[0x1E0CF22A8];
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v64 = 2112;
      *(_QWORD *)v65 = v30;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Created IDS relay connection with destination: %@", buf, 0x16u);
    ...
    if (v59 && v16 && v25)
    {
      v31 = objc_alloc(MEMORY[0x1E0CF22A0]);
      v61[0] = v59;
      v61[1] = v16;
      ...
      if (v35)
      {
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v63 = v40;
          _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay", buf, 0xCu);
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v64 = 2112;
        *(_QWORD *)v65 = v34;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)&v65[10] = v16;
        v66 = 2112;
        v67 = v25;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to start packet relay with relayConnectionCameraVideo: %@, relayConnectionCameraAudio: %@, relayConnectionIDS: %@", buf, 0x2Au);
...
LABEL_25:
  ...
  if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v63 = v47;
    _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_ERROR, "%{public}@Cannot start packet relay because no IDS session exists", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_19084 != -1)
    dispatch_once(&logCategory__hmf_once_t18_19084, &__block_literal_global_19085);
  return (id)logCategory__hmf_once_v19_19086;
}
...
void __43__HMDCameraIDSSessionInitiator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v19_19086;
  logCategory__hmf_once_v19_19086 = v0;
