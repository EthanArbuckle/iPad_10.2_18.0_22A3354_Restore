...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_92684 != -1)
    dispatch_once(&logCategory__hmf_once_t2_92684, &__block_literal_global_92685);
  return (id)logCategory__hmf_once_v3_92686;
}
...
void __43__HMDCameraRemoteStreamSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_92686;
  logCategory__hmf_once_v3_92686 = v0;
