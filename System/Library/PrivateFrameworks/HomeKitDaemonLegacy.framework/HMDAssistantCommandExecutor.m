...
- (void)performWithCompletion:(id)a3
{
  ...
  if (v8 + -2.0 < 3.0)
  {
    v9 = (void *)MEMORY[0x1D17BA0A0](v8 + -2.0);
    v10 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v89 = 2112;
      v90 = v14;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Timeout %@ specified by Siri Command is below threshold, falling back to default timeout", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v9);
    v8 = *(double *)&assistantClientReadWriteTimeoutSeconds;
  }
  v15 = (HMFTimer *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 19, v8);
    ...
    if (!v22)
    {
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v91 = 138543362;
        v92 = v57;
        _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@No actions to perform", v91, 0xCu);

      }
      objc_autoreleasePoolPop(v54);
LABEL_48:
      dispatch_assert_queue_V2((dispatch_queue_t)self->_workQueue);
      v35 = objc_alloc_init(MEMORY[0x1E0D880C0]);
      objc_msgSend(v35, "setCommandOutcome:", *MEMORY[0x1E0D88908]);
  ...
  if (executionTimer == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Timer expired - reporting results", buf, 0xCu);
  ...
  if (WeakRetained)
  {
    ...
    if (!v3)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = v8;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Nil response for action %@", (uint8_t *)&v30, 0x16u);
    ...
    if (-[HMDAssistantCommandExecutor _initialCommandIsMultipleActions](v5))
    {
      ...
      if (v3)
      {
        v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D880C0]), "initWithDictionary:", v15);
        ...
        *(_QWORD *)(v5 + 48) = v18;
        ...
        if (mapToFailureActionOutcome_onceToken != -1)
          dispatch_once(&mapToFailureActionOutcome_onceToken, &__block_literal_global_86767);
      ...
      {
        v24 = *(NSObject **)(v5 + 24);
        v25 = (id)*MEMORY[0x1E0D88910];
        dispatch_assert_queue_V2(v24);
        v26 = objc_alloc_init(MEMORY[0x1E0D880C0]);
...
- (void)_sendResponse:(uint64_t)a1
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Results already reported for Siri command - aborting report", (uint8_t *)&v11, 0xCu);
