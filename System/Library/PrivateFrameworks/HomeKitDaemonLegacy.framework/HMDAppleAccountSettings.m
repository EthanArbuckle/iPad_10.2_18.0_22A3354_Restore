...
+ (id)sharedSettings
{
  if (sharedSettings_onceToken != -1)
    dispatch_once(&sharedSettings_onceToken, &__block_literal_global_26150);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_11921 != -1)
    dispatch_once(&logCategory__hmf_once_t0_11921, &__block_literal_global_11922);
  return (id)logCategory__hmf_once_v1_11923;
}
...
void __46__HMDAppleAccountSettings_Common__logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_11923;
  logCategory__hmf_once_v1_11923 = v0;
...
- (HMDAppleAccountSettings)init
{
  ...
  if (v2)
  {
    ...
    v9 = (void *)MEMORY[0x1D17BA0A0](-[HMDAppleAccountSettings __synchronize](v3, "__synchronize"));
    v10 = v3;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v27 = 2112;
      v28 = v16;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Initialized Apple account settings with isHomeEnabled: %@, isKeychainSyncEnabled: %@, isManaged: %@, isEphemeral: %@", buf, 0x34u);
...
- (void)__synchronize
{
  ...
  if (+[HMDAppleAccountSettings supportsCloudSettings](HMDAppleAccountSettings, "supportsCloudSettings"))
  {
    ...
    context = (void *)MEMORY[0x1D17BA0A0](v3);
    ...
    if (v41)
      v6 = objc_msgSend(v41, "isEnabledForDataclass:", *MEMORY[0x1E0C8F3B8]);
    else
      v6 = 0;
    ...
    if (homeEnabled != (_DWORD)v6)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = v13;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Updated to home enabled: %@", buf, 0x16u);
    ...
    v14 = objc_alloc_init(MEMORY[0x1E0D15780]);
    v42 = 0;
    ...
    if ((v15 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = v16;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@The v0 keychain is not enabled: %@", buf, 0x16u);
    ...
    if (self->_keychainSyncEnabled != (_DWORD)v15)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = v25;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Updated to keychain sync enabled: %@", buf, 0x16u);
    ...
    if (self->_managed != v26)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = v32;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Updated to managed account: %@", buf, 0x16u);
    ...
    if (self->_ephemeral != v34)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = v39;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Updated to ephemeral account: %@", buf, 0x16u);
...
- (void)__registerForKeychainChangeNotifications
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", *MEMORY[0x1E0D15748]);
...
- (void)__updateHomeEnabled:(BOOL)a3 userInitiated:(BOOL)a4 completionHandler:(id)a5
{
  ...
  if (+[HMDAppleAccountSettings supportsCloudSettings](HMDAppleAccountSettings, "supportsCloudSettings"))
  {
    ...
    if (v11)
    {
      v13 = (_QWORD *)MEMORY[0x1E0C8F3B8];
      if (v6
        && (v14 = (const __CFString *)*MEMORY[0x1E0C8F3B8],
            (objc_msgSend(v11, "isProvisionedForDataclass:", *MEMORY[0x1E0C8F3B8]) & 1) == 0))
      {
        v28 = (void *)MEMORY[0x1D17BA0A0]();
        v29 = self;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v41 = 2112;
          v42 = v14;
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to enable iCloud switch for account. Account currently unprovisioned for %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v41 = 2112;
          v42 = v20;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating iCloud setting to %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v40 = (uint64_t)v26;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to update iCloud setting, there is no primary account", buf, 0xCu);
...
uint64_t __65__HMDAppleAccountSettings_handleManateeAvailabilityNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Received Manatee availability notification", (uint8_t *)&v7, 0xCu);
...
void __79__HMDAppleAccountSettings___updateHomeEnabled_userInitiated_completionHandler___block_invoke(uint64_t a1, int a2, void *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to save iCloud setting with error: %@", (uint8_t *)&v13, 0x16u);
...
uint64_t __38__HMDAppleAccountSettings_synchronize__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Synchronizing apple account settings", (uint8_t *)&v7, 0xCu);
...
void __74__HMDAppleAccountSettings__notifyClientsOfUpdatedHomeState_userInitiated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Updated isHomeEnabled to %@", buf, 0x16u);
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = *(_QWORD *)(a1 + 32);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", *(unsigned __int8 *)(a1 + 41), CFSTR("kIsUserInitiated"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = v9;
