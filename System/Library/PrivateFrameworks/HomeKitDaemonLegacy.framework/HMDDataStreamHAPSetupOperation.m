...
- (void)_readRequiredTransportCharacteristics
{
  ...
  objc_msgSend(v3, "findCharacteristicWithType:", *MEMORY[0x1E0CB8B28]);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v15;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@HDS characteristic(s) not found configuration/version (%@/%@)", buf, 0x20u);
...
- (void)startSetup
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating new DataStream using HAP", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v3);
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D164A0]), "initWithValue:", 0);
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D164B0]), "initWithValue:", 1);
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D164B8]), "initWithCommand:transportType:controllerKeySalt:", v7, v8, 0);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v11;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; cannot serialize request (%@)",
        buf,
        0x16u);
...
- (void)processTransportSetupResponse:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v31 = 2112;
      v32 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] The setup transfer succeeded; will use session identifier %@",
        (uint8_t *)&v29,
        0x16u);
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] DataStream configuration valid; starting stream",
        (uint8_t *)&v29,
        0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 138543362;
      v30 = v28;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply did not contain a session identifier", (uint8_t *)&v29, 0xCu);
...
void __71__HMDDataStreamHAPSetupOperation__readRequiredTransportCharacteristics__block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(v3, "conformsToProtocol:", &unk_1EFAB8E48))
  {
    objc_msgSend(*(id *)(a1 + 32), "delegate");
...
void __71__HMDDataStreamHAPSetupOperation__readRequiredTransportCharacteristics__block_invoke_2(uint64_t a1, uint64_t a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    if (!objc_msgSend(v5, "conformsToProtocol:", &unk_1EFAB8E48))
    {
LABEL_5:
