...
- (NSNumber)number
{
  return (NSNumber *)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDFMF value](self, "value"));
}
...
- (id)description
{
  ...
  v3 = -[HMDFMF value](self, "value");
  if (v3 >= 4)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unknown HMDFMFStatus %tu"), v3);
