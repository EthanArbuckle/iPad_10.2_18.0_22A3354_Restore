...
- (void)__cleanupMirroredZones:(id)a3 cloudZones:(id)a4 result:(id)a5 error:(id)a6
{
  ...
  v46 = a6;
  v48 = v11;
  v51 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", objc_msgSend(v11, "count") + objc_msgSend(v10, "count"));
  v60 = 0u;
  v61 = 0u;
  v62 = 0u;
  v63 = 0u;
      ...
      for (i = 0; i != v13; ++i)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v67 = 2112;
          v68 = v17;
          _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Shutting down mirrored zone %@", buf, 0x16u);
      ...
      for (j = 0; j != v27; ++j)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v67 = 2112;
          v68 = v31;
          _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Shutting down cloud zone %@", buf, 0x16u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down zone %@: %@", buf, 0x20u);
