...
- (HMDMatterThirdPartyPairingTagProcessor)initWithSubmitter:(id)a3
{
  ...
  if (v3)
  {
    ...
    v6 = objc_msgSend(objc_alloc(MEMORY[0x1E0D334B0]), "initAutoStopPreviousState:", 0);
...
- (id)tagProcessingBlocks
{
  if (tagProcessingBlocks_token != -1)
    dispatch_once(&tagProcessingBlocks_token, &__block_literal_global_23323);
...
- (void)processPairingErrorEvent:(id)a3
{
  ...
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0D33440]);
  ...
  if (v7)
  {
    ...
    objc_msgSend(v8, "objectForKeyedSubscript:", *MEMORY[0x1E0D33448]);
  ...
  objc_msgSend(v18, "objectForKeyedSubscript:", *MEMORY[0x1E0D33450]);
  ...
  if (v21)
  {
    ...
    objc_msgSend(v22, "objectForKeyedSubscript:", *MEMORY[0x1E0D33458]);
...
- (void)processPairingErrorCancelledEvent:(id)a3
{
  ...
  objc_msgSend(v6, "setErrorCode:", &unk_1E8B32B20);
...
- (void)processAccessoryInfoEvent:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0D331E8]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v64, "tagData");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "objectForKeyedSubscript:", *MEMORY[0x1E0D331E0]);
  ...
  objc_msgSend(v14, "objectForKeyedSubscript:", *MEMORY[0x1E0D33248]);
  ...
  objc_msgSend(v64, "tagData");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "objectForKeyedSubscript:", *MEMORY[0x1E0D33208]);
  ...
  objc_msgSend(v24, "objectForKeyedSubscript:", *MEMORY[0x1E0D33200]);
  ...
  objc_msgSend(v29, "objectForKeyedSubscript:", *MEMORY[0x1E0D331D8]);
  ...
  objc_msgSend(v34, "objectForKeyedSubscript:", *MEMORY[0x1E0D33238]);
  ...
  objc_msgSend(v39, "objectForKeyedSubscript:", *MEMORY[0x1E0D331F8]);
  ...
  objc_msgSend(v44, "objectForKeyedSubscript:", *MEMORY[0x1E0D33210]);
  ...
  objc_msgSend(v50, "objectForKeyedSubscript:", *MEMORY[0x1E0D331B8]);
  ...
  objc_msgSend(v55, "objectForKeyedSubscript:", *MEMORY[0x1E0D331D0]);
...
- (void)processCASESanityCheckEvent:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0D33170]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)processThreadSetupDuration:(id)a3
{
  ...
  objc_msgSend(a3, "tagData");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0D33178]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)processAccessoryTransport:(id)a3
{
  ...
  objc_msgSend(a3, "tagData");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0D331A0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)processFirmwareVersionEvent:(id)a3
{
  ...
  objc_msgSend(a3, "tagData");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0D331C8]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)processThreadScanResultsEvent:(id)a3
{
  ...
  objc_msgSend(v3, "setProvidedThreadScanResults:", MEMORY[0x1E0C9AAB0]);
...
- (void)processWiFiScanResultsEvent:(id)a3
{
  ...
  -[HMDMatterThirdPartyPairingTagProcessor logEvent](self, "logEvent", a3);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setProvidedWiFiScanResults:", MEMORY[0x1E0C9AAB0]);
...
- (void)processCredentialsToClientEvent:(id)a3
{
  ...
  -[HMDMatterThirdPartyPairingTagProcessor logEvent](self, "logEvent", a3);
  v3 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setCredentialsSentToClient:", MEMORY[0x1E0C9AAB0]);
...
- (void)processLongestPairingState:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "objectForKeyedSubscript:", *MEMORY[0x1E0D33148]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0D33150]);
...
- (void)processStateChange:(id)a3
{
  ...
  objc_msgSend(v4, "tagData");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = *MEMORY[0x1E0D33190];
  objc_msgSend(v5, "objectForKeyedSubscript:", *MEMORY[0x1E0D33190]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_27:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v6;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Missing tag field %@, or not an NSNumber", (uint8_t *)&v20, 0x16u);
        ...
        do
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v45 = 2048;
            v46 = v30;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Matter pairing state %ld: %@ for %lu msec", buf, 0x2Au);
...
void __61__HMDMatterThirdPartyPairingTagProcessor_tagProcessingBlocks__block_invoke()
{
  ...
  v0 = *MEMORY[0x1E0D33230];
  v9[0] = *MEMORY[0x1E0D33228];
  v9[1] = v0;
  v10[0] = &__block_literal_global_8;
  v10[1] = &__block_literal_global_9;
  v1 = *MEMORY[0x1E0D33198];
  v9[2] = *MEMORY[0x1E0D33220];
  v9[3] = v1;
  v10[2] = &__block_literal_global_10_23324;
  v10[3] = &__block_literal_global_11;
  v2 = *MEMORY[0x1E0D33160];
  v9[4] = *MEMORY[0x1E0D33158];
  v9[5] = v2;
  v10[4] = &__block_literal_global_12;
  v10[5] = &__block_literal_global_13_23325;
  v3 = *MEMORY[0x1E0D33218];
  v9[6] = *MEMORY[0x1E0D331A8];
  v9[7] = v3;
  v10[6] = &__block_literal_global_14_23326;
  v10[7] = &__block_literal_global_15_23327;
  v4 = *MEMORY[0x1E0D33240];
  v9[8] = *MEMORY[0x1E0D331C0];
  v9[9] = v4;
  v10[8] = &__block_literal_global_16;
  v10[9] = &__block_literal_global_17;
  v5 = *MEMORY[0x1E0D33188];
  v9[10] = *MEMORY[0x1E0D33250];
  v9[11] = v5;
  v10[10] = &__block_literal_global_18;
  v10[11] = &__block_literal_global_19_23328;
  v6 = *MEMORY[0x1E0D33168];
  v9[12] = *MEMORY[0x1E0D331F0];
  v9[13] = v6;
  v10[12] = &__block_literal_global_20_23329;
  v10[13] = &__block_literal_global_21_23330;
  v9[14] = *MEMORY[0x1E0D33180];
  v10[14] = &__block_literal_global_22_23331;
