...
- (id)createVideoAnalyzerWithConfiguration:(id)a3 identifier:(id)a4
{
  ...
  v5 = 0;
  objc_msgSend(MEMORY[0x1E0D31AB0], "analyzerWithConfiguration:identifier:error:", a3, a4, &v5);
...
{
  return objc_msgSend(MEMORY[0x1E0D31AF8], "isInitializationSegment:combinableWithInitializationSegment:", a3, a4);
}
