...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDMediaGroupSetupLatencyLogEvent totalDurationMS](self, "totalDurationMS"));
  ...
  if (v9)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDMediaGroupSetupLatencyLogEvent totalDurationSinceAccessorySetupStartMS](self, "totalDurationSinceAccessorySetupStartMS"));
