...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDDoorbellChimeNotificationLogEvent coordinationLatency](self, "coordinationLatency"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("coordinationLatency"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDDoorbellChimeNotificationLogEvent coreUtilsLatency](self, "coreUtilsLatency"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("coreUtilsLatency"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDDoorbellChimeNotificationLogEvent coordinationMode](self, "coordinationMode"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDDoorbellChimeNotificationLogEvent coordinationPathTriggered](self, "coordinationPathTriggered"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("coordinationPathTriggered"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDDoorbellChimeNotificationLogEvent coreUtilsDestinationCount](self, "coreUtilsDestinationCount"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDDoorbellChimeNotificationLogEvent numHomePodsWithDoorbellChimeEnabled](self, "numHomePodsWithDoorbellChimeEnabled"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v19, CFSTR("numHomePodsWithDoorbellChimeEnabled"));

  objc_msgSend(v3, "setObject:forKeyedSubscript:", &unk_1E8B32970, CFSTR("numEventsFromThisDevice"));
