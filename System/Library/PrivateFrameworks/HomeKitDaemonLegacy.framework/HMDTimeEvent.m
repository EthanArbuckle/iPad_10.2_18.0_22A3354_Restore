    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v42 = 2112;
        v43 = v14;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting the next timer (%@) set to [%@]", buf, 0x20u);
      ...
      if ((v16 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v42 = 2112;
          v43 = v17;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to activate time trigger %@ with error %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v39 = v34;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to get next time date", buf, 0xCu);
...
LABEL_22:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v40 = 2112;
    v41 = v8;
    _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Stopping the already scheduled timer with ID: %@", buf, 0x16u);
...
- (void)handleTimerFiredNotification:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Timer has fired %@, current activation state: %@", (uint8_t *)&v25, 0x20u);
      ...
      if (-[HMDTimeEvent repetitive](v10, "repetitive"))
      {
        ...
        if (v18)
        {
          if (v22)
          {
            ...
            v25 = 138543362;
            v26 = v23;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Reactivating the event as it does have some recurrences", (uint8_t *)&v25, 0xCu);

          }
          objc_autoreleasePoolPop(v19);
          -[HMDTimeEvent _reactivateTriggerAfterDelay](v20, "_reactivateTriggerAfterDelay");
        }
        else
        {
          if (v22)
          {
            ...
            v25 = 138543362;
            v26 = v24;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Not-Reactivating the event as it does not have recurrences", (uint8_t *)&v25, 0xCu);
...
void __44__HMDTimeEvent__reactivateTriggerAfterDelay__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Reactivated trigger after timer fired", (uint8_t *)&v9, 0xCu);
...
+ (BOOL)isValidAbsoluteDateComponents:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 22;
LABEL_8:
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, v10, (uint8_t *)&v15, v12);
  ...
  if (v4)
  {
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 2112;
        v15 = v4;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Given date component contains non supported fields set: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_123677 != -1)
    dispatch_once(&logCategory__hmf_once_t14_123677, &__block_literal_global_123678);
  return (id)logCategory__hmf_once_v15_123679;
}
...
void __27__HMDTimeEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v15_123679;
  logCategory__hmf_once_v15_123679 = v0;
