...
- (void)getCurrentRequestIsWatchAuthenticatedWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v16 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Requesting watch auth from siri for current request", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v5);
  v9 = objc_alloc_init(MEMORY[0x1E0CFE9B0]);
