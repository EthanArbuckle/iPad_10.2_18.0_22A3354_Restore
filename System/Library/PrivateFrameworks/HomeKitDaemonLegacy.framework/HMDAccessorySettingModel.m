...
+ (id)properties
{
  if (properties_onceToken_172435 != -1)
    dispatch_once(&properties_onceToken_172435, &__block_literal_global_236_172436);
  return (id)properties__properties_172437;
}
...
void __38__HMDAccessorySettingModel_properties__block_invoke()
{
  ...
  v6 = (void *)properties__properties_172437;
  properties__properties_172437 = v5;
