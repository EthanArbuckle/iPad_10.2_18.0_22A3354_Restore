...
LABEL_20:
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v52 = 2112;
                v53 = v23;
                _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@No response for requests for media profile %@ - inserting an in-progress error response", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v51 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Media results already reported for Siri command - ignoring the notification/timer", buf, 0xCu);
                    ...
                    v38))
              {
                ...
                if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v81 = 2112;
                  v82 = v23;
                  _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@No response for wakeable write requests with characteristic %@/%@ - for suspeded accessory inserting operation started error response", buf, 0x20u);
                ...
                objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2404);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v81 = 2112;
                  v82 = v23;
                  _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@No response for requests with characteristic %@/%@ - inserting an in-progress error response", buf, 0x20u);
...
LABEL_46:
        ...
        if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v79 = 2112;
          v80 = v58;
          _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, "%{public}@Calling response handler for the id %@", buf, 0x16u);
      ...
      if (v50 >= objc_msgSend(v60, "count"))
        ...
        v51 = 73;
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], v51, 0);
      v7 = objc_claimAutoreleasedReturnValue();
    }
    v52 = (void *)v7;
    goto LABEL_46;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v79 = 2112;
    v80 = v13;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Results already reported for Siri command %@ - ignoring the notification/timer", buf, 0x16u);
...
- (void)_reportOperationStartedForAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v58 = 2112;
    v59 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Reporting operation started for accessory: %@", buf, 0x16u);
        ...
        if (v20)
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v60 = 2112;
            v61 = v18;
            _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@No response for requests with characteristic %@/%@ - inserting operation started error response", buf, 0x20u);
...
- (void)__handleAccessoryCharacteristicsChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v117 = 2112;
    v118 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Processing characteristic reponses for Siri: %@", buf, 0x16u);
      ...
      if (v68)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v16 = (void *)objc_claimAutoreleasedReturnValue();
            v89 = v14;
            v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", v14);
...
LABEL_38:
                        ...
                        if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          v119 = 2112;
                          v120 = v88;
                          _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find a request corresponding to %@/%@ - creating a dummy request", buf, 0x20u);

                        }
                        objc_autoreleasePoolPop(v38);
                        +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:value:authorizationData:type:](HMDCharacteristicWriteRequest, "writeRequestWithCharacteristic:value:authorizationData:type:", v85, &unk_1E8B32D00, 0, 0);
                        v42 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v119 = 2112;
        v120 = v64;
        _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_INFO, "%{public}@Characteristic change notification '%@' too late for request %@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v53 = 2112;
              v54 = v26;
              _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Media Profile (%@) does not contain HMDAppleMediaAccessory type accessory, something went wrong.", buf, 0x16u);

            }
            objc_autoreleasePoolPop(v21);
            objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", v34, 22, 0);
            v27 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)&v56 + 4) = v31;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Received write request with no apple media accessory, reporting invalid parameters error", (uint8_t *)&v56, 0xCu);
...
- (void)addReadRequests:(id)a3 home:(id)a4 completion:(id)a5
{
  ...
  if (objc_msgSend(v8, "count"))
  {
    ...
    v12 = (void *)MEMORY[0x1D17BA0A0](-[HMDAssistantCommandHelper _register](self, "_register"));
    v13 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v32 = 2112;
      v33 = v8;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Sending read request with id %@ to home %@ with characteristics: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v9;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Received read request to home %@ with no characteristics, reporting invalid parameters error", buf, 0x16u);
  ...
  if (objc_msgSend(v8, "count"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v32 = 2112;
      v33 = v8;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Sending write request with id %@ to home %@ with write request tupes: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v9;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Received write request to home %@ with no request tuples, reporting invalid parameters error", buf, 0x16u);
...
- (void)addActionSetRequest:(id)a3 actionSet:(id)a4 completionHandler:(id)a5
{
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "stringWithFormat:", CFSTR("%@, %s:%ld"), v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommandHelper.m", 518);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v48 = 2112;
    v49 = v9;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Sending execute action set %@ with id %@ to home %@", buf, 0x2Au);
  ...
  if (v5 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v5;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Write request with id %@ to home failed with error: %@", buf, 0x20u);
  ...
  if (v5 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v5;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Read request with id %@ failed with error: %@", buf, 0x20u);
...
uint64_t __52__HMDAssistantCommandHelper_timeoutAndReportResults__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Timeout current requests execution - reporting results", (uint8_t *)&v10, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_34507 != -1)
    dispatch_once(&logCategory__hmf_once_t0_34507, &__block_literal_global_34508);
  return (id)logCategory__hmf_once_v1_34509;
}
...
void __40__HMDAssistantCommandHelper_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_34509;
  logCategory__hmf_once_v1_34509 = v0;
