...
- (void)start
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1CD062000, logger, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "LocalSettingsFetch", ", buf, 2u);
  }
  ...
  else
  {
    ...
    objc_msgSend(v9, "stringWithFormat:", CFSTR("%@, %s:%ld"), v10, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Media/Media Accessory/Apple/Settings/Fetched Settings/HMDFetchedAccessorySettingsController.m", 184);
...
- (void)driver:(id)a3 didUpdateSettings:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v42 = v12;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Received setting updates", buf, 0xCu);
  ...
  if (objc_msgSend(v20, "count"))
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2112;
      v44 = v20;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Ignoring updates for unknown keypaths: %@", buf, 0x16u);
  ...
  if (objc_msgSend(v21, "count", v33, v34, v35, v36, v37))
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v45 = 2112;
      v46 = v21;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Received update for keyPaths: %{public}@ settings: %@", buf, 0x20u);
...
- (void)driver:(id)a3 didUpdatePrimaryUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Primary user is not supported", (uint8_t *)&v12, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v11;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Did not find driver in list %@", buf, 0x16u);
  ...
  if (a1)
  {
    ...
    while (1)
    {
      for (i = 0; i != v47; ++i)
      {
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v56 = 2114;
              v57 = v18;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Removing keyPath %{public}@ from pending fetch", buf, 0x16u);
        ...
        v48 = v25;
        v49 = 0;
        objc_msgSend(MEMORY[0x1E0CBA588], "decodeSettingFromEvent:error:", v26, &v49);
        v27 = (void *)objc_claimAutoreleasedReturnValue();
        v28 = v49;
        if (v28)
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v58 = 2112;
            v59 = v28;
            _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Error reading stored setting for topic %@, error: %@", buf, 0x20u);
        ...
        if (!v27 || !objc_msgSend(v27, "isEqual:", v9))
        {
          v25 = v48;
LABEL_24:
          v38 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA588]), "initWithSetting:eventSource:eventTimestamp:", v9, v45, v7);
          objc_msgSend(a1, "dataSource");
          v39 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v39, "eventForwarder");
          v40 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v40, "forwardEvent:topic:completion:", v38, v23, &__block_literal_global_67_167428);
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v56 = 2114;
          v57 = v37;
          _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Skip sending event for keyPath: %{public}@ as it matches stored", buf, 0x16u);
...
void __90__HMDFetchedAccessorySettingsController_updateSettingWithKeyPath_settingValue_completion___block_invoke(uint64_t a1)
{
  ...
  if ((v5 & 1) != 0)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v38 = 2114;
      v39 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Got setting update request keyPath: %{public}@", (uint8_t *)&v36, 0x16u);
    ...
    else
    {
      if (!v20)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          v40 = 2112;
          v41 = v34;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Do not support provided type for update keypath: %{public}@ settingValue: %@", (uint8_t *)&v36, 0x20u);
...
LABEL_23:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v40 = 2114;
    v41 = v27;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Provided keypath: %{public}@ not in available keypaths: %{public}@", (uint8_t *)&v36, 0x20u);
...
void __77__HMDFetchedAccessorySettingsController_fetchSettingsForKeyPaths_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v93 = 2114;
    v94 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Received fetch request for keyPaths: %{public}@", buf, 0x16u);
  ...
  if ((objc_msgSend(v71, "isSubsetOfSet:", v9) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v95 = 2114;
      v96 = v17;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Some provided keypaths: %{public}@ not in available keypaths: %{public}@", buf, 0x20u);
...
void __77__HMDFetchedAccessorySettingsController_fetchSettingsForKeyPaths_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "count"))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      v13 = 138543362;
      v14 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@At least one of the driver's returned an error setting error on completion", (uint8_t *)&v13, 0xCu);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v12;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Finishing fetch request for keyPaths: %{public}@ restuls: %@", (uint8_t *)&v13, 0x20u);
...
void __46__HMDFetchedAccessorySettingsController_start__block_invoke(uint64_t a1)
{
  ...
  v42[1] = v42;
  v42[2] = 0x3032000000;
  v42[3] = __Block_byref_object_copy__167458;
  v42[4] = __Block_byref_object_dispose__167459;
  v43 = 0;
  v38 = 0u;
  v39 = 0u;
  v40 = 0u;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      for (i = 0; i != v24; ++i)
      {
        ...
        v44 = CFSTR("keyPaths");
        v45 = v10;
        v16 = (id)objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v45, &v44, 1);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v44 = 2112;
      v45 = v19;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched at startup: keyPaths: %{public}@ settings from driver: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = v5;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched at startup: settings: %@", buf, 0x16u);
    ...
    v39[2] = v30;
    v31 = (id)objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v39, v38, 3);
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = v6;
        _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@Driver error on start %@", buf, 0x16u);
...
void __46__HMDFetchedAccessorySettingsController_start__block_invoke_54(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v32, "code"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v37[1] = CFSTR("domain");
    v38[0] = v8;
    ...
    v38[1] = v11;
    v12 = (id)objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v38, v37, 2);
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_1CD062000, v14, OS_SIGNPOST_INTERVAL_END, v4, "LocalSettingsFetch", ", buf, 2u);
    }

    v15 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v6, "end"));
    v16 = v5;
    HMFGetOSLogHandle();
    v17 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2048;
      v36 = v20;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Setup start timestamp %f", buf, 0x16u);
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2048;
      v36 = v29;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Settings creation latency %f", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_167485 != -1)
    dispatch_once(&logCategory__hmf_once_t0_167485, &__block_literal_global_30_167486);
  return (id)logCategory__hmf_once_v1_167487;
}
...
void __52__HMDFetchedAccessorySettingsController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_167487;
  logCategory__hmf_once_v1_167487 = v0;
