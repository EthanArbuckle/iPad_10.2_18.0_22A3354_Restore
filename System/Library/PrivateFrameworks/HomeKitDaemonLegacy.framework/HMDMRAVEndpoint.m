...
- (id)attributeDescriptions
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28548]), "initWithName:value:", CFSTR("MRAVEndPointRef"), -[HMDMRAVEndpoint mravEndpoint](objc_retainAutorelease(self), "mravEndpoint"));
  v5[0] = v2;
