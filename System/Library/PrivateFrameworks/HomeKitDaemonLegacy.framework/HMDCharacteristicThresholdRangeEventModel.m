...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_105459 != -1)
    dispatch_once(&properties_onceToken_105459, block);
  return (id)properties__properties_105460;
}
...
void __55__HMDCharacteristicThresholdRangeEventModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_105460;
  properties__properties_105460 = v3;

  v5 = (void *)properties__properties_105460;
  v10[0] = CFSTR("min");
