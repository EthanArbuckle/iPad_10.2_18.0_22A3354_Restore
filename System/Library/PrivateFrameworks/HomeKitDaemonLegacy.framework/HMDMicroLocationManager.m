...
- (HMDMicroLocationManager)initWithLocationManager:(id)a3 dateFactory:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99DE8], "na_arrayByRepeatingWithCount:generatorBlock:", 3, &__block_literal_global_179743);
    v11 = objc_claimAutoreleasedReturnValue();
    lastRecordingScanTimes = v10->_lastRecordingScanTimes;
    v10->_lastRecordingScanTimes = (NSMutableArray *)v11;

    objc_msgSend(MEMORY[0x1E0C99DE8], "na_arrayByRepeatingWithCount:generatorBlock:", 3, &__block_literal_global_3_179744);
...
{
  return -[HMDMicroLocationManager initWithLocationManager:dateFactory:](self, "initWithLocationManager:dateFactory:", a3, &__block_literal_global_5_179738);
}
...
- (void)triggerThrottledMicroLocationRecordingScanWithMetadata:(id)a3 triggerType:(unint64_t)a4
{
  ...
  if (a4 >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 2112;
      v37 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Recording Scan", (uint8_t *)&v34, 0x16u);
  ...
  else
  {
    ...
    if (v21 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = off_1E89C1318[a4];
        v34 = 138543618;
        v35 = v25;
        v36 = 2112;
        v37 = v26;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation recording scan for event type: %@, throttling in effect", (uint8_t *)&v34, 0x16u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = off_1E89C1318[a4];
    v34 = 138543618;
    v35 = v31;
    v36 = 2112;
    v37 = v32;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation recording scan for event: %@", (uint8_t *)&v34, 0x16u);
...
- (void)triggerThrottledMicroLocationLocalizationScanWithMetadata:(id)a3 triggerType:(unint64_t)a4
{
  ...
  if (a4 >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 2112;
      v37 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Localization Scan", (uint8_t *)&v34, 0x16u);
  ...
  else
  {
    ...
    if (v21 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        v36 = 2112;
        v37 = v26;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation localization scan for event: %@, throttling in effect", (uint8_t *)&v34, 0x16u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2112;
    v37 = v32;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation localization scan for event: %@", (uint8_t *)&v34, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_179751 != -1)
    dispatch_once(&logCategory__hmf_once_t8_179751, &__block_literal_global_16_179752);
  return (id)logCategory__hmf_once_v9_179753;
}
...
void __38__HMDMicroLocationManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_179753;
  logCategory__hmf_once_v9_179753 = v0;
