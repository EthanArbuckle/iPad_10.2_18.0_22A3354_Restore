...
- (HMDCUWiFiDeviceWrapper)initWithCUWiFiDevice:(id)a3 dispatchQueue:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithCString:encoding:", v16, 4);
...
- (void)startConfigurationWithCompletionHandler:(id)a3
{
  ...
  if (self->_wacSession)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@WACSession already active for device", (uint8_t *)&buf, 0xCu);
  ...
  {
    v9 = (CUWACSession *)objc_alloc_init(MEMORY[0x1E0D1B470]);
    ...
    *((_QWORD *)&buf + 1) = &buf;
    v21 = 0x3032000000;
    v22 = __Block_byref_object_copy__90272;
    v23 = __Block_byref_object_dispose__90273;
    v24 = 0;
    ...
    if (a2 == 200)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        ...
        v29 = 12;
LABEL_65:
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, v27, buf, v29);
        ...
        *(_QWORD *)(v9 + 40) = v8;
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v36 = 2112;
          v37 = v15;
          _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@WAC setup failed: %@", buf, 0x16u);
...
LABEL_64:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = (uint64_t)v20;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@WAC setup finalized, calling completion", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_90306 != -1)
    dispatch_once(&logCategory__hmf_once_t18_90306, &__block_literal_global_93_90307);
  return (id)logCategory__hmf_once_v19_90308;
}
...
void __37__HMDCUWiFiDeviceWrapper_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v19_90308;
  logCategory__hmf_once_v19_90308 = v0;
