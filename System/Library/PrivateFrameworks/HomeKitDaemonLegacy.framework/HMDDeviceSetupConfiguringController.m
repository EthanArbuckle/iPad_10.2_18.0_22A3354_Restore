...
- (HMDDeviceSetupConfiguringController)initWithDiagnosticInfoControllerInternal:(id)a3
{
  ...
  v8 = -[HMDDeviceSetupConfiguringController initWithQueue:rpCompanionLinkClientFactory:diagnosticInfoController:](self, "initWithQueue:rpCompanionLinkClientFactory:diagnosticInfoController:", v7, &__block_literal_global_115459, v6);
...
- (void)registerRequestID
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@No need to register request", (uint8_t *)&v7, 0xCu);
...
- (void)_registerRequest:(id)a3 after:(int64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v19 = 2112;
    v20 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Register requestID: %@ after %@ seconds", buf, 0x20u);
...
- (void)_queryWithRequestID:(id)a3 mediaRouteIdentifier:(id)a4 rpDevice:(id)a5 additionalKeys:(id)a6 withCompletion:(id)a7
{
    ...
    if (v19)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v47 = 2112;
        v48 = v14;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Send (messageRequestID %@) handlerID: %@ message to (device '%@')", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v42 = v34;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Cannot create a RPCompanionLinkClient", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v30;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Device is nil", buf, 0xCu);
...
- (void)_tearDownCompanionLinkClient
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Tearing down the companion link client", (uint8_t *)&v8, 0xCu);
...
- (id)_activeDevicesWithMediaRouteIdentifier:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Discovering RPCompanionLinkDevice matching identifier %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v21;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@RPClient is nil", buf, 0xCu);
...
- (void)_registerRequest:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@RPClient is nil", buf, 0xCu);
  ...
  if (!v7)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v21;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@DiagnosticInfoController is nil", buf, 0xCu);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v27 = 2112;
    v28 = v14;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering request %@ with handler for active devices %@", buf, 0x20u);
...
- (void)_setupCompanionLinkClient
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = v16;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Set up the companion link client, controlFlags = %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v27;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Cannot create companion link client", buf, 0xCu);
...
- (void)_setupRPClientAfter:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Will setup the RPCompanionLinkClient after %@s", buf, 0x16u);
...
uint64_t __59__HMDDeviceSetupConfiguringController__setupRPClientAfter___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Tearing down RP client and setting up again", (uint8_t *)&v7, 0xCu);
...
void __64__HMDDeviceSetupConfiguringController__setupCompanionLinkClient__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Queue setup after invalidation.", (uint8_t *)&v6, 0xCu);
...
void __64__HMDDeviceSetupConfiguringController__setupCompanionLinkClient__block_invoke_18(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@RPClient was interrupted", (uint8_t *)&v6, 0xCu);
...
void __64__HMDDeviceSetupConfiguringController__setupCompanionLinkClient__block_invoke_19(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Device Found from RPClient: %@", (uint8_t *)&v9, 0x16u);
...
void __64__HMDDeviceSetupConfiguringController__setupCompanionLinkClient__block_invoke_21(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Device lost from RPClient: %@", (uint8_t *)&v9, 0x16u);
...
void __64__HMDDeviceSetupConfiguringController__setupCompanionLinkClient__block_invoke_22(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@device changed from RPClient: %@", (uint8_t *)&v9, 0x16u);
...
void __64__HMDDeviceSetupConfiguringController__setupCompanionLinkClient__block_invoke_24(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Error activating RPClient: '%@'", (uint8_t *)&v10, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@RPClient activated successfully", (uint8_t *)&v10, 0xCu);
...
void __56__HMDDeviceSetupConfiguringController__registerRequest___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v34 = 2112;
      v35 = v21;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Sending response for %@ = %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v29;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Diagnostic info data is nil", buf, 0xCu);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@There was an error activating: %@", buf, 0x16u);
...
uint64_t __119__HMDDeviceSetupConfiguringController__queryWithRequestID_mediaRouteIdentifier_rpDevice_additionalKeys_withCompletion___block_invoke_2(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@(Request %@) failed with error: %@", (uint8_t *)&v15, 0x20u);
  ...
  else if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v13;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@(Request %@) sent; response: %@ / options: %@",
      (uint8_t *)&v15,
      0x2Au);
...
void __91__HMDDeviceSetupConfiguringController_queryConfiguringState_additionalKeys_withCompletion___block_invoke(uint64_t a1)
{
  ...
  if (v2 && !objc_msgSend(v2, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v3;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Active destination devices: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@RPClient did not discover peer device for identifier: %@", (uint8_t *)&v17, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29_115463 != -1)
    dispatch_once(&logCategory__hmf_once_t29_115463, &__block_literal_global_25_115464);
  return (id)logCategory__hmf_once_v30_115465;
}
...
void __50__HMDDeviceSetupConfiguringController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v30_115465;
  logCategory__hmf_once_v30_115465 = v0;
