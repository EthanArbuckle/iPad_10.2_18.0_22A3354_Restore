...
- (void)submitMetric:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2114;
      v23 = v13;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting AccessoryDiagnosticMetric for accessory: %{public}@/%{public}@ - %{public}@", (uint8_t *)&v16, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_63281 != -1)
    dispatch_once(&logCategory__hmf_once_t8_63281, &__block_literal_global_225_63282);
  return (id)logCategory__hmf_once_v9_63283;
}
...
void __44__HMDAccessoryDiagnosticsMetric_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_63283;
  logCategory__hmf_once_v9_63283 = v0;
