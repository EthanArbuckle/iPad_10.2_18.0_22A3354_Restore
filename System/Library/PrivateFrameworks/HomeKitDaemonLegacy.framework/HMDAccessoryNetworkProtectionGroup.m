...
- (HMDAccessoryNetworkProtectionGroup)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB7D40]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB7D10]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("HMDAccessoryNetworkProtectionGroupCategoryCodingKey"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = objc_msgSend(v4, "decodeIntegerForKey:", *MEMORY[0x1E0CB7D20]);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v13, "hmd_isForRemoteGatewayCoder") & 1) == 0)
  {
    if ((v4 ^ 1 | v5) == 1)
    {
      -[HMDAccessoryNetworkProtectionGroup uuid](self, "uuid");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v13, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB7D40]);

      -[HMDAccessoryNetworkProtectionGroup manufacturer](self, "manufacturer");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v13, "encodeObject:forKey:", v7, *MEMORY[0x1E0CB7D10]);

      v8 = -[HMDAccessoryNetworkProtectionGroup targetProtectionMode](self, "targetProtectionMode");
      objc_msgSend(v13, "encodeInteger:forKey:", v8, *MEMORY[0x1E0CB7D20]);
    }
    if ((v4 & 1) == 0)
    {
      -[HMDAccessoryNetworkProtectionGroup category](self, "category");
    ...
    if (v5)
    {
      ...
      v12 = (const __CFString *)*MEMORY[0x1E0CB7D08];
LABEL_8:
...
- (id)modelForVersion:(int64_t)a3
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDAccessoryNetworkProtectionGroup targetProtectionMode](self, "targetProtectionMode"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v12 = v19;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectRemoved]", (uint8_t *)&v14, 0x20u);
  ...
  if (v13)
  {
    ...
    if (objc_msgSend(v13, "propertyWasSet:", CFSTR("targetProtectionMode")))
    {
      ...
      if (v15 != v17)
      {
        ...
        -[HMDAccessoryNetworkProtectionGroup uuid](self, "uuid", *MEMORY[0x1E0CB7D48]);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        v41[0] = v19;
        v40[1] = *MEMORY[0x1E0CB7D28];
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDAccessoryNetworkProtectionGroup targetProtectionMode](self, "targetProtectionMode"));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v39 = v47;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", buf, 0x20u);
