...
{
  return (id)objc_msgSend(a3, "na_map:", &__block_literal_global_247);
}

+ (id)updatedAccessoryAccessCodesFromModificationResponses:(id)a3
{
  return (id)objc_msgSend(a3, "na_map:", &__block_literal_global_248);
}
  ...
  if (v8)
  {
    if (v12)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v14;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@User: %@ is an admin, so we can safely send all the fetch responses.", buf, 0x16u);
  ...
  else
  {
    if (v12)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v17;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@User: %@ is not an admin, so redact all access codes except the user's own.", buf, 0x16u);
...
{
  return objc_msgSend(a3, "na_any:", &__block_literal_global_254);
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_2982 != -1)
    dispatch_once(&logCategory__hmf_once_t9_2982, &__block_literal_global_257);
  return (id)logCategory__hmf_once_v10_2983;
}
...
void __44__HMDAccessCodeManagerUtilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_2983;
  logCategory__hmf_once_v10_2983 = v0;
...
id __64__HMDAccessCodeManagerUtilities_filteredFetchResponses_forUser___block_invoke(uint64_t a1, void *a2)
{
  ...
  v6 = objc_alloc(MEMORY[0x1E0CBA1B8]);
