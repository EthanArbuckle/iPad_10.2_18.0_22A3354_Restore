      ...
      if (downgradeDebouceTimer == v4)
      {
        ...
        if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)((char *)&v24 + 4) = v9;
          _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Downgrade debouce timer has fired, calling network has deteriorated", (uint8_t *)&v24, 0xCu);
        ...
        if (self)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_QWORD *)((char *)&v24 + 4) = v14;
            _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStreamReconfigureDidNetworkDeteriorate", (uint8_t *)&v24, 0xCu);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)((char *)&v24 + 4) = v20;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Upgrade debouce timer has fired, calling network has improved", (uint8_t *)&v24, 0xCu);
  ...
  if (self)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)&v24 + 4) = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStreamReconfigureDidNetworkImprove", (uint8_t *)&v24, 0xCu);
  ...
  if (v4)
  {
    if (*(_BYTE *)(v4 + 8))
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v9 = 138543362;
        v10 = v8;
        _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Not processing the downlink quality change yet, since the stream is in reconfiguration mode", (uint8_t *)&v9, 0xCu);
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v83 = 2112;
      v84 = (uint64_t)v2;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Downlink quality changed with %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v3);
    objc_msgSend(v2, "hmf_numberForKey:", *MEMORY[0x1E0CF2340]);
    v80 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v2, "hmf_numberForKey:", *MEMORY[0x1E0CF2338]);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = objc_msgSend(v2, "hmf_BOOLForKey:", *MEMORY[0x1E0CF2328]);
    v9 = objc_msgSend(v2, "hmf_BOOLForKey:", *MEMORY[0x1E0CF2330]);
    if (v4[4] && (v8 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v82 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Upgrade debounce timer is set, but not operating at maximum anymore, resetting the timer", buf, 0xCu);
    ...
    if ((v14 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v82 = v18;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Downgrade debounce timer is set, but not operating at minimum anymore, resetting the timer", buf, 0xCu);
      ...
      if ((v19 & 1) != 0)
      {
        ...
        if (v20)
        {
          if (v24)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v82 = v25;
            _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Downgrade debounce timer is already scheduled", buf, 0xCu);
...
LABEL_28:
        ...
        if (v24)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Starting downgrade debouce timer with interval %llu seconds", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v21);
        v42 = objc_alloc(MEMORY[0x1E0D286C8]);
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v82 = v36;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Downgrade debounce timer is set, but optimal and operating bitrates arent matching, resetting the timer", buf, 0xCu);
      ...
      if ((v27 & 1) != 0)
      {
        if (v28)
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v82 = v32;
            _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Upgrade debounce timer is already scheduled", buf, 0xCu);
        ...
        if ((unint64_t)objc_msgSend(v4[3], "count") >= 4)
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v87 = 2112;
            v88 = v53;
            _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@reconfigure_1: %@, reconfigure_2: %@, reconfigure_3: %@", buf, 0x2Au);
                ...
                v62 < 120.0))
          {
            ...
            if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v83 = 2048;
              v84 = *(_QWORD *)&v62;
              _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_INFO, "%{public}@Downgrade-Upgrade-Downgrade has happened within %lf seconds", buf, 0x16u);
            ...
            if (os_log_type_enabled(v76, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_1CD062000, v76, OS_LOG_TYPE_INFO, "%{public}@A Flip flop has been detected, so upgrade is going to be backed off by %lf seconds", buf, 0x16u);
        ...
        if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v83 = 2048;
          v84 = *(_QWORD *)&v47;
          _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_INFO, "%{public}@Starting upgrade debouce timer with interval %lf seconds", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v63);
        v66 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, v47);
...
LABEL_52:
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v82 = v40;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_INFO, "%{public}@Upgrade debounce timer is set, but optimal and operating bitrates arent matching, resetting the timer", buf, 0xCu);
...
void __55__HMDVideoStreamReconfigure_updateReconfigurationMode___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Updating reconfiguration mode from %@ to %@", (uint8_t *)&v14, 0x20u);
    ...
    if (v9)
    {
      if (*(_QWORD *)(v9 + 16))
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          v14 = 138543362;
          v15 = v13;
          _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Downlink quality info is present, processing it", (uint8_t *)&v14, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_10961 != -1)
    dispatch_once(&logCategory__hmf_once_t0_10961, &__block_literal_global_10962);
  return (id)logCategory__hmf_once_v1_10963;
}
...
void __40__HMDVideoStreamReconfigure_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_10963;
  logCategory__hmf_once_v1_10963 = v0;
