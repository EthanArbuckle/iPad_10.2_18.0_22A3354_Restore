...
- (HMDNetworkObserver)initWithLogEventDispatcher:(id)a3 countersManager:(id)a4 dailyScheduler:(id)a5 currentHomeDataSource:(id)a6 dateProvider:(id)a7
{
  ...
  v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, 1.0);
  v21 = -[HMDNetworkObserver initWithLogEventDispatcher:countersManager:dailyScheduler:currentHomeDataSource:dateProvider:wifiManager:notificationCenter:changeDebounceTimer:tickBlock:](self, "initWithLogEventDispatcher:countersManager:dailyScheduler:currentHomeDataSource:dateProvider:wifiManager:notificationCenter:changeDebounceTimer:tickBlock:", v17, v16, v15, v14, v13, v18, v19, v20, &__block_literal_global_30_184113);
...
- (void)start
{
  ...
  if (!self->_started)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v14, 0xCu);

    }
    objc_autoreleasePoolPop(v3);
    v7 = (_QWORD *)MEMORY[0x1E0D28538];
    objc_msgSend(MEMORY[0x1E0CB37C0], "notificationWithName:object:", *MEMORY[0x1E0D28538], 0);
...
- (void)stop
{
  ...
  if (self->_started)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping", (uint8_t *)&v10, 0xCu);
    ...
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "removeObserver:name:object:", v4, *MEMORY[0x1E0D28538], 0);
...
- (id)_keyOfLargestCountInHistogram:(id)a3
{
  ...
  v8 = &v7;
  v9 = 0x3032000000;
  v10 = __Block_byref_object_copy__184098;
  v11 = __Block_byref_object_dispose__184099;
  v12 = 0;
...
- (void)checkNetworkChange
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v38 = 2112;
    v39 = v13;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Network Change Detected.  New Network SSID %@ Local MAC %@, BSSID %@, gatewayIP %@,  gatewayMac %@", (uint8_t *)&v28, 0x3Eu);
...
{
  if (supportedEventClasses_onceToken_184115 != -1)
    dispatch_once(&supportedEventClasses_onceToken_184115, &__block_literal_global_184116);
  return (id)supportedEventClasses_supportedEventClasses_184117;
}
...
void __43__HMDNetworkObserver_supportedEventClasses__block_invoke()
{
  ...
  v1 = (void *)supportedEventClasses_supportedEventClasses_184117;
  supportedEventClasses_supportedEventClasses_184117 = v0;
