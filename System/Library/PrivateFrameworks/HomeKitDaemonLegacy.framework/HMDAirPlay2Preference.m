...
- (HMDAirPlay2Preference)initWithKey:(id)a3 options:(unint64_t)a4 defaultValue:(id)a5
{
  ...
  if (v10)
  {
    v11 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C0]), "initWithKey:options:domain:defaultValue:", CFSTR("enableAirPlay2"), 0, CFSTR("com.apple.airplay"), 0);
    airPlayPreference = v10->_airPlayPreference;
    v10->_airPlayPreference = (HMFSystemPreference *)v11;

    v13 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C0]), "initWithKey:options:defaultValue:", v8, a4, v9);
...
{
  objc_msgSend(MEMORY[0x1E0D28678], "setPreferenceClass:forPreferenceKey:", a1, CFSTR("enableAirPlay2"));
}
