...
- (HMDCloudShareTrustManager)initWithDatabase:(id)a3 isOwnedTrust:(BOOL)a4 queue:(id)a5 shareMessenger:(id)a6 ownerCloudShareID:(id)a7 logEventSubmitter:(id)a8 dailyScheduler:(id)a9
{
  ...
  if (v20)
  {
    ...
    v21->_participantsManagerFactory = &__block_literal_global_25505;

    requestInviteTimerFactory = v21->_requestInviteTimerFactory;
    v21->_requestInviteTimerFactory = &__block_literal_global_2_25506;
...
- (void)_configure
{
  ...
  if (-[HMDCloudShareTrustManager configureState](self, "configureState"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Skipping cloud share trust configure. Trust already in configure state: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (v10)
    {
      if (v14)
      {
        ...
        v17 = 138543362;
        v18 = v15;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Configuring cloud share trust with owned trust", (uint8_t *)&v17, 0xCu);
    ...
    else
    {
      if (v14)
      {
        ...
        v17 = 138543362;
        v18 = v16;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Configuring cloud share trust with shared trust", (uint8_t *)&v17, 0xCu);
  ...
  if (v9)
  {
    if (v13)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v9;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Got zoneID for shared trust zone: %@", buf, 0x16u);
  ...
  else
  {
    if (v13)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v19;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@No shared trust zone exists yet", buf, 0xCu);
...
- (void)_requestShareInvitationForSharedZone
{
  ...
  if ((objc_msgSend(v4, "isOwnerCapableForTrustManager:", self) & 1) != 0)
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 138543362;
        v22 = v9;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@We have a cloud share ID for the owner, but we aren't invited to the share", (uint8_t *)&v21, 0xCu);
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Requesting trust zone share invitation from trust owner with id: %@", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping request for trust invitation due to owner being incapable of setting up trust", (uint8_t *)&v21, 0xCu);
...
- (void)_configureWithFetchZoneResult:(id)a3 error:(id)a4
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&v38[4] = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Did fetch trust cloud zone", v38, 0xCu);
    ...
    if (-[HMDCloudShareTrustManager isOwnedTrust](v10, "isOwnedTrust"))
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v38 = 138543362;
        *(_QWORD *)&v38[4] = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Starting participant manager to share trust zone", v38, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&v38[14] = v36;
      v39 = 2112;
      v40 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to open trust zone: %@, error: %@", v38, 0x20u);
...
- (void)_configureOwnerCloudShareIDWithCloudZone:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v21 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Fetching trust owner cloud share id", buf, 0xCu);
...
- (void)_finishConfigure
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Trust manager finished configuring", (uint8_t *)&v9, 0xCu);
  ...
  if (-[HMDCloudShareTrustManager configureState](self, "configureState") == 3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Skipping remove trust due to configure state: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (v12)
    {
      if (v16)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v32 = v17;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Removing owned cloud share trust", buf, 0xCu);
    ...
    else
    {
      if (v16)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v32 = v20;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Removing shared cloud share trust", buf, 0xCu);
    ...
    if (!v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v29 = 2112;
        v30 = v11;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Fetching cloud share ID for shared user: %@", buf, 0x16u);
      ...
      for (k = 0; k != v25; ++k)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v52 = 2112;
          v53 = v33;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Discovered untrusted user with id: %@", buf, 0x16u);
...
- (void)sendShareInvitation:(id)a3 toUser:(id)a4 device:(id)a5
{
  ...
  v40 = 0;
  objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", v8, 1, &v40);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v40;
  if (v12)
  {
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v43 = 2112;
        v44 = v21;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Sending trust zone invitation to user: %@", buf, 0x16u);
...
LABEL_15:
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v43 = 2112;
        v44 = v34;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Sending trust zone invitation to device: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v43 = 2112;
    v44 = v13;
    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize trust zone invitation: %@", buf, 0x16u);
...
- (void)_homeDidBecomeTrustZoneCapable:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Owner is now capable of establishing trust zones", (uint8_t *)&v15, 0xCu);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Skipping reconfigure since a request invite timer exists", (uint8_t *)&v15, 0xCu);
...
- (void)setConfigureState:(int64_t)a3
{
  ...
  if (self->_configureState == 3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Cannot change from removed state to: %@", (uint8_t *)&v12, 0x16u);
...
- (void)cloudZone:(id)a3 didUpdateParticipantWithClientIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v24 = 2112;
    v25 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Trust zone updated participant with client identifier: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not find user with UUID matching updated participant client identifier: %@", buf, 0x16u);
...
- (void)cloudZone:(id)a3 didRemoveParticipantWithClientIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Trust zone removed participant with client identifier: %@", (uint8_t *)&v13, 0x16u);
...
- (id)localZone:(id)a3 didProcessModelCreation:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Trust zone created unknown model: %@", (uint8_t *)&v14, 0x16u);
...
- (id)localZone:(id)a3 didProcessModelDeletion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Trust zone deleted unknown model: %@", (uint8_t *)&v14, 0x16u);
...
- (id)localZone:(id)a3 didProcessModelUpdate:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Trust zone updated unknown model: %@", (uint8_t *)&v14, 0x16u);
...
- (void)messenger:(id)a3 didReceiveInvitationData:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v47 = v15;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Received trust zone invitation", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = v19;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize trust zone invitation data, error: %@", buf, 0x16u);
...
- (void)_didCreateZone
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Trust zone has been created", (uint8_t *)&v13, 0xCu);
  ...
  if (-[HMDCloudShareTrustManager configureState](v5, "configureState") == 3)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Forcing trust from removed to unconfigured state due to a zone creation notification", (uint8_t *)&v13, 0xCu);
...
- (void)_didRemoveZone
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Trust zone has been removed", (uint8_t *)&v10, 0xCu);
...
- (void)_startRequestInviteTimer
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Request invite timer already started", (uint8_t *)&v19, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Starting request invite timer", (uint8_t *)&v19, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    if (v10)
    {
      ...
      v21 = 138543362;
      v22 = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Request invite timer fired", (uint8_t *)&v21, 0xCu);
...
LABEL_12:
      ...
      v23 = 2112;
      v24 = v17;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Canceling request invite timer due to trust manager configure state: %@", (uint8_t *)&v21, 0x16u);
    ...
    else
    {
      ...
      v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Canceling request invite timer due to reaching max interval time", (uint8_t *)&v21, 0xCu);
    }
  ...
  if (v10)
  {
    ...
    v23 = 2112;
    v24 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Received timer did fire call from unknown timer: %@", (uint8_t *)&v21, 0x16u);
...
void __75__HMDCloudShareTrustManager_messenger_didReceiveInvitationData_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Trust zone invitation was not accepted: %@", (uint8_t *)&v9, 0x16u);
...
void __75__HMDCloudShareTrustManager_messenger_didReceiveInvitationData_completion___block_invoke_36(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Trust zone invitation was accepted", (uint8_t *)&v8, 0xCu);
  ...
  if ((a2 & 1) != 0)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Trust zone invitation was accepted by user with id: %@", buf, 0x16u);
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v35 = 2112;
        v36 = v17;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@User already has cloud share ID. Skip cloud pull. user id: %@", buf, 0x16u);
    ...
    {
      objc_msgSend(MEMORY[0x1E0D32CD8], "optionsWithLabel:", CFSTR("Fetch due to new participant"));
      v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v37 = 2112;
      v38 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Trust zone invitation was not accepted by user with id: %@ error: %@", buf, 0x20u);
...
void __63__HMDCloudShareTrustManager_sendShareInvitation_toUser_device___block_invoke_26(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Cloud pull fail with error:%@", (uint8_t *)&v9, 0x16u);
...
void __63__HMDCloudShareTrustManager_sendShareInvitation_toUser_device___block_invoke_27(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Cloud pull was successful", (uint8_t *)&v8, 0xCu);
...
void __55__HMDCloudShareTrustManager_updateCloudShareIDForUser___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch cloud share ID for %@: %@", (uint8_t *)&v10, 0x20u);
...
void __55__HMDCloudShareTrustManager_updateCloudShareIDForUser___block_invoke_20(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Received cloud share ID for %@: %@", (uint8_t *)&v9, 0x20u);
...
void __58__HMDCloudShareTrustManager_updateCurrentUserCloudShareID__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unable to fetch cloud share id for current user, error: %@", (uint8_t *)&v9, 0x16u);
...
void __58__HMDCloudShareTrustManager_updateCurrentUserCloudShareID__block_invoke_19(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Received current user cloud share id: %@", (uint8_t *)&v11, 0x16u);
...
void __40__HMDCloudShareTrustManager_removeTrust__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed cloud share trust removal, error: %@", (uint8_t *)&v9, 0x16u);
...
void __40__HMDCloudShareTrustManager_removeTrust__block_invoke_17(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Cloud share trust has been removed", (uint8_t *)&v9, 0xCu);
...
void __70__HMDCloudShareTrustManager__configureOwnerCloudShareIDWithCloudZone___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Could not read owner cloud share id in trust zone, error: %@", (uint8_t *)&v9, 0x16u);
...
void __70__HMDCloudShareTrustManager__configureOwnerCloudShareIDWithCloudZone___block_invoke_15(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Read trust zone owner cloud share ID: %@", (uint8_t *)&v9, 0x16u);
...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D28578]), "initWithMinimumTimeInterval:maximumTimeInterval:exponentialFactor:options:", a4, 0, a1, a2);
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t54 != -1)
    dispatch_once(&logCategory__hmf_once_t54, &__block_literal_global_39);
