...
- (void)_registerForMessages:(id)a3
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    v16 = 138412290;
    v17 = v13;
    _os_log_impl(&dword_1CD062000, logger, OS_LOG_TYPE_DEFAULT, "Registering for primary resident change notification %@", (uint8_t *)&v16, 0xCu);
  }
...
- (void)handlePrimaryResidentConfirmedDeviceIdentifierChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    v13 = 138412290;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, logger, OS_LOG_TYPE_DEFAULT, "Received primary resident change notification %@", (uint8_t *)&v13, 0xCu);
  }
  -[HMDRemoteEventRouterClient dataSource](self, "dataSource");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((_DWORD)v8 != -[HMDRemoteEventRouterClient isPrimaryResident](self, "isPrimaryResident"))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v13 = 138412290;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "Primary resident status changed to %@", (uint8_t *)&v13, 0xCu);
...
- (void)_handleUpdateMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling update message: %@", buf, 0x16u);
  ...
  if (!v11)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1CD062000, logger, OS_LOG_TYPE_ERROR, "Did not find message payload.", buf, 2u);
    }
  ...
  if (!v13)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "Unable to decode payload from fragment message.", buf, 2u);
      if (!v14)
        goto LABEL_23;
    }
    else if (!v14)
  ...
  if (-[HMDRemoteEventRouterProtoServerMessage hasMessage](v16, "hasMessage"))
  {
    switch(-[HMDRemoteEventRouterProtoServerMessage message](v16, "message"))
    {
      ...
      default:
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_error_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "Received an unrecognized request type.", buf, 2u);
        }
...
LABEL_30:
    _os_log_error_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, v18, buf, 2u);
  }
LABEL_17:
  v19 = (void *)MEMORY[0x1E0CB35C8];
  v20 = 3;
...
- (void)_handleUpdatedEventsRequest:(id)a3 originalMessage:(id)a4
{
  ...
  v41[1] = v41;
  v41[2] = 0x3032000000;
  v41[3] = __Block_byref_object_copy__17108;
  v41[4] = __Block_byref_object_dispose__17109;
  v42 = 0;
  v11 = dispatch_group_create();
  v12 = objc_msgSend(v6, "eventsCount");
  v13 = MEMORY[0x1E0C809B0];
  v14 = (_QWORD *)&unk_1CDB8E000;
  if (v12)
  {
    objc_msgSend(v6, "events");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "na_map:", &__block_literal_global_26_17110);
    ...
    if (v16 && objc_msgSend(v16, "count"))
    {
      ...
      if (os_log_type_enabled((os_log_t)v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v45 = 2112;
        v46 = v20;
        _os_log_impl(&dword_1CD062000, (os_log_t)v17, OS_LOG_TYPE_DEFAULT, "Received update events request %@, payloadSize: %@", buf, 0x16u);
      ...
      if (os_signpost_enabled(logger))
      {
        *(_DWORD *)buf = 138412290;
        v44 = v10;
        _os_signpost_emit_with_name_impl(&dword_1CD062000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterClientHandleUpdatedEvents", "serverIdentifier=%{signpost.description:attribute}@ ", buf, 0xCu);
      }
  ...
  if (objc_msgSend(v6, "cachedEventsCount"))
  {
    ...
    objc_msgSend(v22, "na_map:", &__block_literal_global_30_17114);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v23 && objc_msgSend(v23, "count"))
    {
      ...
      if (os_log_type_enabled((os_log_t)v24, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v45 = 2112;
        v46 = v28;
        _os_log_impl(&dword_1CD062000, (os_log_t)v24, OS_LOG_TYPE_DEFAULT, "Received cached events request %@, payloadSize: %@", buf, 0x16u);
      ...
      if (os_signpost_enabled(v29))
      {
        *(_DWORD *)buf = 138412290;
        v44 = v10;
        _os_signpost_emit_with_name_impl(&dword_1CD062000, v29, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterClientHandleCachedEvents", "serverIdentifier=%{signpost.description:attribute}@ ", buf, 0xCu);
      }
      dispatch_group_enter(v11);
      v35[0] = v13;
      v35[1] = v14[202];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v11;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Received fetch response from non-primary: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v21);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2037);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)client:(id)a3 isConnectionTerminatingError:(id)a4
{
  ...
  if (!v6)
  {
    objc_msgSend(v4, "domain");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = objc_msgSend(v8, "isEqualToString:", *MEMORY[0x1E0D27FC8]);

    if (v9
      || (objc_msgSend(v4, "domain"),
          v10 = (void *)objc_claimAutoreleasedReturnValue(),
          v11 = objc_msgSend(v10, "isEqualToString:", *MEMORY[0x1E0D32D10]),
          v10,
          v11)
...
- (void)client:(id)a3 fetchWithFilters:(id)a4 isMultiHop:(BOOL)a5 completion:(id)a6
{
  ...
  objc_msgSend(v12, "na_map:", &__block_literal_global_52_17077);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)clientDidConnect:(id)a3 serverIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v15 = v5;
    _os_log_impl(&dword_1CD062000, logger, OS_LOG_TYPE_DEFAULT, "Client did connect to server %@", buf, 0xCu);
  }
...
- (void)clientDidDisconnect:(id)a3
{
  ...
  {
    *(_WORD *)v10 = 0;
    _os_log_impl(&dword_1CD062000, logger, OS_LOG_TYPE_DEFAULT, "Client disconnected from server", v10, 2u);
  }
  if (-[HMDRemoteEventRouterClient isConnected](self, "isConnected"))
  {
    -[HMDRemoteEventRouterClient notificationCenter](self, "notificationCenter");
...
- (id)sendMessageWithPayloadMessage:(id)a3 client:(id)a4 messageType:(int64_t)a5 completion:(id)a6
{
  ...
  if (!v13 || !v14)
  {
    ...
    if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      v22 = v15;
      _os_log_error_impl(&dword_1CD062000, logger, OS_LOG_TYPE_ERROR, "Did not find resident destination for server identifier %@.", buf, 0xCu);
      if (!v10)
        goto LABEL_7;
    }
    else if (!v10)
...
- (void)configureIsPrimaryResident:(BOOL)a3 networkAvailable:(BOOL)a4 additionalPolicies:(id)a5
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v15 = 2112;
    v16 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "Configuring isPrimaryResident: %@, networkAvailable: %@", (uint8_t *)&v13, 0x16u);
...
void __59__HMDRemoteEventRouterClient_networkAvailabilityDidChange___block_invoke(uint64_t a1)
{
  ...
  if (v3 != v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v11 = 138412290;
      v12 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "Network availability changed to %@", (uint8_t *)&v11, 0xCu);
...
void __106__HMDRemoteEventRouterClient_responseHandlerForMessageIdentifier_serverIdentifier_messageType_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(*(os_log_t *)(v4 + 8), OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      v22 = 2112;
      v23 = v3;
      _os_log_error_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "Failed to send message: %@ error: %@", buf, 0x16u);
    }
    if (*(_QWORD *)(a1 + 80) == 1)
  ...
  else if (os_log_type_enabled(*(os_log_t *)(v4 + 8), OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412290;
    v21 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "Successfully sent message: %@", buf, 0xCu);
  }
  if (objc_msgSend(v3, "isHMError") && objc_msgSend(v3, "code") == 3202)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Event router message rejected by remote due to it being non-primary, kicking primary discovery", buf, 0xCu);
  ...
  if (objc_msgSend(*(id *)(a1 + 56), "hmf_BOOLForKey:", CFSTR("isFragmented")) && v11)
  {
    ...
    if (!v14 || v12)
    {
      ...
      *(_DWORD *)buf = 138412290;
      v21 = v18;
      _os_log_error_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "Unable to decode fragment payload with error: %@", buf, 0xCu);
      if (v12)
      {
LABEL_19:
        v12 = v12;
...
void __76__HMDRemoteEventRouterClient_client_fetchWithFilters_isMultiHop_completion___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v8 && !v9)
  {
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "Did not find fetch response", buf, 2u);
      }
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 2);
    ...
    if (-[HMDRemoteEventRouterProtoFetchEventsResponse changedEventsCount](v12, "changedEventsCount"))
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        v39 = 2112;
        v40 = (uint64_t)v18;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "Received %@ events in fetch response of size %@", buf, 0x16u);

      }
      v19 = (void *)MEMORY[0x1E0D32D30];
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2048;
      v40 = v26;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch got topics %ld", buf, 0x16u);
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2112;
      v40 = (uint64_t)v21;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEBUG, "%{public}@Fetch got topics %@", buf, 0x16u);
...
void __76__HMDRemoteEventRouterClient_client_sendConnectWithAddedFilters_completion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v8 && !v9)
  {
    ...
    else
    {
      ...
      {
        LOWORD(v22) = 0;
        _os_log_error_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "Did not find connect response", (uint8_t *)&v22, 2u);
      }
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 2);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
    }
    if (-[HMDRemoteEventRouterProtoConnectResponse cachedEventsCount](v12, "cachedEventsCount"))
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v24 = 2112;
        v25 = v18;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "Received %@ events in connect response of size %@", (uint8_t *)&v22, 0x16u);
    ...
    if (v7)
    {
      if (!v10)
      {
        ...
        if (os_signpost_enabled(v21))
        {
          v22 = 138412290;
          v23 = v7;
          _os_signpost_emit_with_name_impl(&dword_1CD062000, v21, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterClientConnected", "serverIdentifier=%{signpost.description:attribute}@ ", (uint8_t *)&v22, 0xCu);
        }
      }
    }
...
void __110__HMDRemoteEventRouterClient_sendChangeRegistrationsMessageWithAddedFilters_removedFilters_client_completion___block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (v6 && !v7)
  {
    ...
    else
    {
      ...
      {
        LOWORD(v19) = 0;
        _os_log_error_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "Did not find change registrations response", (uint8_t *)&v19, 2u);
      }
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 2);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
    }
    if (-[HMDRemoteEventRouterProtoChangeRegistrationsResponse cachedEventsCount](v10, "cachedEventsCount"))
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v21 = 2112;
        v22 = v16;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "Received %@ events in change registrations response of size %@", (uint8_t *)&v19, 0x16u);

      }
      v17 = (void *)MEMORY[0x1E0D32D30];
...
+ (id)routerClientWithQueue:(id)a3 storeReadHandle:(id)a4 storeWriteHandle:(id)a5 retryIntervalProvider:(id)a6 logCategory:(const char *)a7
{
  ...
  v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32D50]), "initWithQueue:timerProvider:keepAliveInterval:dormantFetchTimerInterval:retryIntervalProvider:storeReadHandle:storeWriteHandle:logCategory:", v14, v15, v11, v13, v12, a7, 420.0, 28800.0);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_17148 != -1)
    dispatch_once(&logCategory__hmf_once_t0_17148, &__block_literal_global_17149);
  return (id)logCategory__hmf_once_v1_17150;
}
...
void __41__HMDRemoteEventRouterClient_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_17150;
  logCategory__hmf_once_v1_17150 = v0;
