...
- (HMDAccessCodeDataManager)initWithContext:(id)a3 delegate:(id)a4
{
  ...
  if (v9)
  {
    ...
    v10->_dataCleanUpTimerFactory = &__block_literal_global_137039;
...
- (NSArray)homeAccessCodeValuesWithSimpleLabels
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch home access code values with simple labels because home reference was nil", (uint8_t *)&v13, 0xCu);
...
LABEL_7:
  ...
  objc_msgSend(v4, "labelsByAccessCode");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "na_map:", &__block_literal_global_6_137035);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSArray)homeAccessCodeValuesWithUserLabels
{
  ...
  if (v4)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "na_map:", &__block_literal_global_11_137031);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch user access code values with simple labels because home reference was nil", (uint8_t *)&v12, 0xCu);
...
LABEL_8:
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v14, 0xCu);
...
LABEL_9:
  ...
  objc_msgSend(v4, "removedUserInfoByAccessCode");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "na_map:", &__block_literal_global_13_137028);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)setUserInformation:(id)a3 forHomeAccessCodeWithValue:(id)a4 changedByUserUUID:(id)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2112;
    v31 = v8;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Setting user information: %@, for access code value", (uint8_t *)&v28, 0x16u);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        v30 = 2112;
        v31 = v8;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Not setting user information for access code value because empty user information was provided: %@", (uint8_t *)&v28, 0x16u);
...
- (id)removeHomeAccessCodeWithValue:(id)a3 removedByUserUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = v7;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Removing home access code, removedByUserUUID: %@", (uint8_t *)&v30, 0x16u);
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = 138543362;
      v31 = v27;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Did not find home access code", (uint8_t *)&v30, 0xCu);
...
- (id)_setUserWithUUID:(id)a3 forAccessCodeValue:(id)a4 changedByUserUUID:(id)a5
{
  ...
  if (v14)
  {
    ...
    v37[1] = 3221225472;
    v37[2] = __82__HMDAccessCodeDataManager__setUserWithUUID_forAccessCodeValue_changedByUserUUID___block_invoke;
    v37[3] = &unk_1E89B7AD8;
    v17 = v8;
    v38 = v17;
    objc_msgSend(v15, "na_firstObjectPassingTest:", v37);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v18)
    {
      ...
      v35[0] = v16;
      v35[1] = 3221225472;
      v35[2] = __82__HMDAccessCodeDataManager__setUserWithUUID_forAccessCodeValue_changedByUserUUID___block_invoke_20;
      v35[3] = &unk_1E89C2210;
      v35[4] = self;
      v36 = v9;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v41 = 2112;
        v42 = v17;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Not setting user UUID: %@, for access code value because we could not find a user with that UUID.", buf, 0x16u);
      ...
      objc_msgSend(v33, "futureWithError:", v19);
      v22 = (void *)objc_claimAutoreleasedReturnValue();
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = v8;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Not setting user UUID: %@, for access code value because home reference was nil", buf, 0x16u);
...
- (id)_removeUserAccessCodeValue:(id)a3 removedByUserUUID:(id)a4
{
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      -[HMDUserAccessCodeModel setValue:](v16, "setValue:", 0);
      -[HMDUserAccessCodeModel setChangedByUserUUID:](v16, "setChangedByUserUUID:", v7);
      -[HMDAccessCodeDataManager removeUserAccessCodeModel:](self, "removeUserAccessCodeModel:", v16);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v17, "addSuccessBlock:", &__block_literal_global_23_137017);
      v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 138543362;
        v32 = v27;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Not removing access code value because couldn't find any user with that access code.", (uint8_t *)&v31, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 138543362;
      v32 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Not removing access code value because home reference was nil", (uint8_t *)&v31, 0xCu);
...
- (void)_messageUser:(id)a3 thatTheirAccessCodeWasChangedWithType:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v29 = 2048;
    v30 = a4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Messaging user that their access code was changed. user: %@, changeType: %lu", buf, 0x20u);
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a4, CFSTR("HMDAccessCodeManagerMessageKeyUserAccessCodeChangeType"));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v24 = v18;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not setting simple label for access code value because home reference was nil", buf, 0xCu);
...
- (id)_removeSimpleLabelAccessCodeValue:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 138543362;
      v24 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Not removing access code value because home reference was nil", (uint8_t *)&v23, 0xCu);
...
- (void)_cleanUpOldRemovedUserData
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v18 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Cleaning up old removedUserInfo", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Not cleaning up old removed user data because home reference was nil", buf, 0xCu);
...
- (id)_removeHMDRemovedUserAccessCodeWithAccessCode:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 138543362;
    v29 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDRemovedUserAccessCode with specified value", (uint8_t *)&v28, 0xCu);
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 138543362;
      v29 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not Removing HMDRemovedUserAccessCode because home reference was nil", (uint8_t *)&v28, 0xCu);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 138543362;
    v29 = v26;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Did not find HMDRemovedUserAccessCode with the specified value", (uint8_t *)&v28, 0xCu);
...
- (NSSet)accessCodeValuesWithSimpleLabel
{
  ...
  if (v4)
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "na_map:", &__block_literal_global_31_136999);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code values with simple label because home reference was nil", (uint8_t *)&v15, 0xCu);
...
- (id)simpleLabelForAccessCode:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code with simple label because home reference was nil", (uint8_t *)&v14, 0xCu);
...
- (id)userUUIDForAccessCode:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code with simple label because home reference was nil", buf, 0xCu);
...
- (NSSet)accessCodeValuesWithUserLabel
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(v4, "users");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "na_map:", &__block_literal_global_33_136994);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch user access code values with simple labels because home reference was nil", (uint8_t *)&v14, 0xCu);
...
- (NSSet)accessCodeValuesWithRemovedUserInfo
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(v6, "allKeys");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "na_map:", &__block_literal_global_35_136990);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "setWithArray:", v8);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code values with removed user info because home reference was nil", (uint8_t *)&v15, 0xCu);
...
- (id)addOrUpdateUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding or updating HMDUserAccessCodeModel", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot add or update HMDUserAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
...
- (id)removeUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v38 = 2112;
    v39 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDUserAccessCodeModel, removedByUserUUID: %@", buf, 0x16u);
  ...
  if (v14)
  {
    ...
    objc_msgSend(v4, "setObjectChangeType:", 2);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v27;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove HMDUserAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
...
- (id)addOrUpdateHomeAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding or updating HMDHomeAccessCodeModel", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot add or update HMDHomeAccessCodeModel, because self.context.home.backingStore is nil", buf, 0xCu);
...
- (id)removeHomeAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDHomeAccessCodeModel", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove HMDHomeAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
...
- (id)saveRemovedUserAccessCode:(id)a3 withRemovedUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v7;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Saving removed user access code with removed user info: %@", (uint8_t *)&v27, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not saving removed user access code because home reference was nil", (uint8_t *)&v27, 0xCu);
...
- (id)removeHMDRemovedUserAccessCodeWithCode:(id)a3 removedUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v7;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Removing HMDRemovedUserAccessCode with HMRemovedUserInfo: %@", (uint8_t *)&v27, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not removing HMDRemovedUserAccessCode because home reference was nil", (uint8_t *)&v27, 0xCu);
...
- (id)addOrUpdateHMDRemovedUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding or updating HMDRemovedUserAccessCodeModel", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot add or update HMDRemovedUserAccessCodeModel, because self.context.home.backingStore is nil", buf, 0xCu);
...
- (id)removeHMDRemovedUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDRemovedUserAccessCodeModel", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove HMDRemovedUserAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
...
- (void)handleUpdatedUserAccessCodeModel:(id)a3 forUser:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v59 = 2112;
    v60 = v15;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel was updated. Updating value on HMDUser: %@ changedByUserUUID: %@", buf, 0x20u);
      ...
      if (v21)
      {
        if (v25)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v59 = 2112;
          v60 = v27;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel value was updated on HMDUser: %@ changedByUserUUID: %@", buf, 0x20u);
      ...
      else
      {
        if (v25)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v59 = 2112;
          v60 = v47;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel value was removed on HMDUser: %@ removedByUserUUID: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v59 = 2112;
        v60 = v41;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_INFO, "%{public}@New HMDUserAccessCodeModel was added. Setting value on HMDUser: %@ changedByUserUUID: %@", buf, 0x20u);
...
- (void)handleUpdatedHomeAccessCodeModel:(id)a3 message:(id)a4
{
  ...
  void *v38;
  void *v39;
  HMDAccessCodeDataManager *v40;
  NSObject *v41;
  void *v42;
  const char *v43;
  void *v44;
  HMDAccessCodeDataManager *v45;
  NSObject *v46;
  void *v47;
  void *v48;
  void *v49;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v60 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling updated HMDHomeAccessCodeModel", buf, 0xCu);
...
LABEL_16:
      _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, v43, buf, 0xCu);
    ...
    if ((v25 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v61 = 2112;
        v62 = v13;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@HMDHomeAccessCodeModel label was updated on HMDHome: %@", buf, 0x16u);
      ...
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v33, "markChanged");

      v34 = (void *)MEMORY[0x1E0CBA530];
      objc_msgSend(v6, "value");
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "label");
      v36 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v34, "homeAccessCodeValueWithStringValue:label:", v35, v36);
      v37 = (void *)objc_claimAutoreleasedReturnValue();
      v57 = v37;
      objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", &v57, 1);
      v38 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v17, "accessCodeDataManager:didUpdateHomeAccessCodes:changedByUserUUID:", v27, v38, 0);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v13;
      _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@New HMDHomeAccessCodeModel was added. Setting label for value on HMDHome: %@", buf, 0x16u);
    ...
    objc_msgSend(v51, "markChanged");

    objc_msgSend(v7, "respondWithSuccess");
    v52 = (void *)MEMORY[0x1E0CBA530];
    objc_msgSend(v6, "value");
    v53 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "label");
    v54 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v52, "homeAccessCodeValueWithStringValue:label:", v53, v54);
    v55 = (void *)objc_claimAutoreleasedReturnValue();
    v58 = v55;
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", &v58, 1);
    v56 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "accessCodeDataManager:didAddHomeAccessCodes:addedByUserUUID:", v45, v56, 0);
...
- (void)handleRemovedUserAccessCodeModel:(id)a3 forUser:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel was removed. Removing value on HMDUser: %@", buf, 0x16u);
...
- (void)handleRemovedHomeAccessCodeModel:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling removed HMDHomeAccessCodeModel", buf, 0xCu);
  ...
  if (v13)
  {
    ...
    if (v14)
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v35 = 2112;
        v36 = v13;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@HMDHomeAccessCodeModel was removed. Removing value with label on HMDHome: %@", buf, 0x16u);
      ...
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      v23 = (void *)MEMORY[0x1E0CBA530];
      objc_msgSend(v6, "label");
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v23, "homeAccessCodeValueWithStringValue:label:", v14, v24);
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      v32 = v25;
      objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", &v32, 1);
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v22, "accessCodeDataManager:didRemoveHomeAccessCodes:removedByUserUUID:", v16, v26, 0);
    ...
    else
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v34 = v31;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Did not find an access code for this model on the home, so we have nothing to remove.", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v30;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Not handling updated HomeAccessCodeModel because home reference was nil", buf, 0xCu);
...
LABEL_15:
      _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, v41, buf, 0xCu);
    ...
    if ((v23 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v59 = 2112;
        v60 = v13;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@HMDRemovedUserAccessCodeModel was updated on HMDHome: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v13;
      _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@New HMDRemovedUserAccessCodeModel was added. Updating values on HMDHome: %@", buf, 0x16u);
...
- (void)handleRemovedHMDRemovedUserAccessCodeModel:(id)a3 message:(id)a4
{
    ...
    if (v14)
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v36 = 2112;
        v37 = v13;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@HMDRemovedUserAccessCodeModel was removed. Removing from HMDHome: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v31;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Not handling updated HomeAccessCodeModel because home reference was nil", buf, 0xCu);
...
- (NSArray)cachedAccessCodes
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "na_map:", &__block_literal_global_53_136915);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)cachedAccessCodeForIdentifier:(id)a3 accessoryUUID:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for cached access code with accessory UUID: %@", (uint8_t *)&v18, 0x16u);
...
- (void)updateCacheWithFetchResponses:(id)a3
{
  ...
  v9[0] = v4;
  v9[1] = 3221225472;
  v9[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2_59;
  v9[3] = &unk_1E89B7CB8;
  v9[4] = self;
          ...
          if (v12)
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v35 = 2112;
              v36 = v9;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating accessory: %@, with new access code: %@", buf, 0x20u);
          ...
          else
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v33 = 2112;
              v34 = v22;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for accessory access code with accessory UUID: %@", buf, 0x16u);
          ...
          if (v12)
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v35 = 2112;
              v36 = v9;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating accessory: %@, with updated access code: %@", buf, 0x20u);
          ...
          if (v12)
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v35 = 2112;
              v36 = v9;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating accessory: %@, with removed access code: %@", buf, 0x20u);
          ...
          else
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v33 = 2112;
              v34 = v22;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for fetch response with accessory UUID: %@", buf, 0x16u);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@dataCleanUpTimer fired", (uint8_t *)&v14, 0xCu);
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    v15[0] = MEMORY[0x1E0C809B0];
    v15[1] = 3221225472;
    v15[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_55;
    v15[3] = &unk_1E89B7C90;
    v16 = v6;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for fetch response with accessory UUID: %@", buf, 0x16u);
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    v15[0] = MEMORY[0x1E0C809B0];
    v15[1] = 3221225472;
    v15[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_58;
    v15[3] = &unk_1E89B7C90;
    v16 = v6;
    objc_msgSend(v7, "na_filter:", v15);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2_59(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  void *v5;
  ...
  if (v6)
  {
    ...
    v16[0] = MEMORY[0x1E0C809B0];
    v16[1] = 3221225472;
    v16[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_60;
    v16[3] = &unk_1E89B7D20;
    v17 = v3;
    v18 = v6;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for fetch response with accessory UUID: %@", buf, 0x16u);
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_60(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  void *v5;
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "na_map:", &__block_literal_global_63_136910);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
uint64_t __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2_61(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "uniqueIdentifier");
}

uint64_t __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_58(uint64_t a1, void *a2)
{
  void *v2;
  id v3;
  void *v4;
...
uint64_t __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_55(uint64_t a1, void *a2)
{
  void *v2;
  id v3;
  void *v4;
...
void __64__HMDAccessCodeDataManager_removeHMDRemovedUserAccessCodeModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to run transaction to update model with error: %@", (uint8_t *)&v12, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Successfully updated model", (uint8_t *)&v12, 0xCu);
...
void __54__HMDAccessCodeDataManager_removeUserAccessCodeModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to run transaction to update model, error: %@", (uint8_t *)&v12, 0x16u);
...
id __63__HMDAccessCodeDataManager_accessCodeValuesWithRemovedUserInfo__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA1A0];
  v3 = a2;
...
id __57__HMDAccessCodeDataManager_accessCodeValuesWithUserLabel__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    v4 = objc_alloc(MEMORY[0x1E0CBA1A0]);
    objc_msgSend(v2, "accessCode");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
void __82__HMDAccessCodeDataManager__setUserWithUUID_forAccessCodeValue_changedByUserUUID___block_invoke_20(uint64_t a1)
{
  void *v1;
  id v2;
...
{
  return objc_msgSend(MEMORY[0x1E0CBA530], "homeAccessCodeValueWithStringValue:removedUserInfo:", a2, a3);
}
...
id __62__HMDAccessCodeDataManager_homeAccessCodeValuesWithUserLabels__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    v4 = objc_alloc(MEMORY[0x1E0CBA198]);
    objc_msgSend(v2, "uuid");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = (void *)objc_msgSend(v4, "initWithSimpleLabel:labelIdentifier:userUUID:removedUserInfo:", 0, 0, v5, 0);

    v7 = objc_alloc(MEMORY[0x1E0CBA1A0]);
    objc_msgSend(v2, "accessCode");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = (void *)objc_msgSend(v7, "initWithStringValue:", v8);

    v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA530]), "initWithAccessCodeValue:userInformationValue:", v9, v6);
  }
...
id __64__HMDAccessCodeDataManager_homeAccessCodeValuesWithSimpleLabels__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0CBA198];
  v5 = a3;
  v6 = a2;
  v7 = (void *)objc_msgSend([v4 alloc], "initWithSimpleLabel:labelIdentifier:userUUID:removedUserInfo:", v5, 0, 0, 0);

  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1A0]), "initWithStringValue:", v6);
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA530]), "initWithAccessCodeValue:userInformationValue:", v8, v7);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t87_137049 != -1)
    dispatch_once(&logCategory__hmf_once_t87_137049, &__block_literal_global_65_137050);
  return (id)logCategory__hmf_once_v88_137051;
}
...
void __39__HMDAccessCodeDataManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v88_137051;
  logCategory__hmf_once_v88_137051 = v0;
