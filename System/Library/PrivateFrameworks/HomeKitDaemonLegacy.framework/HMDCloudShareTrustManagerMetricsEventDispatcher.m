...
- (void)submitTrustActivityEvent:(int64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to submit daily trust status event due to no data source", (uint8_t *)&v17, 0xCu);
...
- (void)submitCloudShareTrustStatusDailyEvent
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[4] = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to submit daily trust status event due to no data source", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2 != -1)
    dispatch_once(&logCategory__hmf_once_t2, &__block_literal_global_6169);
