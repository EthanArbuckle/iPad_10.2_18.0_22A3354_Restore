...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 1, CFSTR("kAudioCodecParameters__AudioChannels"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16400], "wrappertlv:name:objectCreator:", 2, CFSTR("kAudioCodecParameters__Bitrate"), &__block_literal_global_308);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16400], "wrappertlv:name:objectCreator:", 3, CFSTR("kAudioCodecParameters__SampleRate"), &__block_literal_global_310);
