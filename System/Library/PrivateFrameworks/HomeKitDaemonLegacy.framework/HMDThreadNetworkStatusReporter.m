...
- (void)_scheduleThreadNetworkStatusPeriodicUpdate
{
  ...
  if (!-[HMDThreadNetworkStatusReporter threadNetworkPeriodicCheckFrequencyInMins](self, "threadNetworkPeriodicCheckFrequencyInMins"))
  {
    ...
    v8 = (void *)MEMORY[0x1D17BA0A0](-[HMDThreadNetworkStatusReporter setThreadNetworkPeriodicCheckFrequencyInMins:](self, "setThreadNetworkPeriodicCheckFrequencyInMins:", v7));
    v9 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Scheduling start of periodic Thread network health reporting (for every %lu minutes)", (uint8_t *)&v12, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No thread network metadata store", buf, 0xCu);
...
- (void)threadNetworkStateChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@threadNetworkStateChange - received event %@, type %ld, value %ld", (uint8_t *)&v20, 0x2Au);
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 42;
LABEL_12:
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, v17, (uint8_t *)&v20, v19);
...
- (void)threadWakeOnDeviceConnectionStateChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@threadWakeOnDeviceConnectionStateChange - received event %@, eMACAddress %@, connectionState %ld", (uint8_t *)&v16, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@No linked home, dropping threadWakeOnDeviceConnectionStateChange event", (uint8_t *)&v16, 0xCu);
...
- (void)threadPeripheralDeviceNodeTypeChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@threadPeripheralDeviceNodeTypeChange - received event %@, peripheral nodeType %ld", (uint8_t *)&v15, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@No linked home, dropping threadPeripheralDeviceNodeTypeChange event", (uint8_t *)&v15, 0xCu);
...
- (void)threadPreferredNetworkUpdated:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@threadPreferredNetworkUpdated - received event %@, value %@", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@No linked home, dropping threadPreferredNetworkUpdated event %@, value %@", (uint8_t *)&v19, 0x20u);
...
- (void)threadBTCallStateChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@threadBTCallStateChange - received event %@, value %ld", (uint8_t *)&v21, 0x20u);
...
LABEL_14:
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = v4;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unexpected event %@", (uint8_t *)&v21, 0x16u);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    v25 = 2048;
    v26 = v16;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@No linked home, dropping threadBTCallStateChange event %@, value %ld", (uint8_t *)&v21, 0x20u);
...
- (void)_registerForThreadNetworkEvents
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@_registerForThreadNetworkEvents", (uint8_t *)&v9, 0xCu);
...
- (void)_unregisterForThreadNetworkEvents
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@_unregisterForThreadNetworkEvents", (uint8_t *)&v11, 0xCu);
...
- (void)_checkIfThreadNetworkIsRunningWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No thread network metadata store", (uint8_t *)&v13, 0xCu);
...
void __63__HMDThreadNetworkStatusReporter__runThreadNetworkStateCapture__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v6 && v5 && (v11 = *(void **)(a1 + 32)) != 0)
  {
    ...
    v16 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v15, "generateLogForPeriodicReport:", v5));
    v17 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138546178;
      ...
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Periodic Thread network health reporting - duration=%ld BRs:(T=%ld A=%ld 3=%ld) Ntwk:(#=%ld IPpfx=%ld) Tx:(T=%ld S=%ld AvgDelay=%ld) Rx:(T=%ld S=%ld)", buf, 0x7Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = (uint64_t)v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Periodic Thread network health reporting failed with error %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_17788 != -1)
    dispatch_once(&logCategory__hmf_once_t0_17788, &__block_literal_global_17789);
  return (id)logCategory__hmf_once_v1_17790;
}
...
void __45__HMDThreadNetworkStatusReporter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_17790;
  logCategory__hmf_once_v1_17790 = v0;
