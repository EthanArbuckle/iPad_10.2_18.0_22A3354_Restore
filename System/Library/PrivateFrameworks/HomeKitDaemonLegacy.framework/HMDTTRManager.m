...
LABEL_11:
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, v11, (uint8_t *)&v15, 0xCu);
...
- (void)initiateRadarWithTitle:(id)a3 componentName:(id)a4 componentVersion:(id)a5 componentID:(int64_t)a6 displayReason:(id)a7 attachments:(id)a8 isUserInitiated:(BOOL)a9
{
  ...
  objc_msgSend(v23, "setDiagnosticExtensionIDs:", &unk_1E8B31CB0);
...
- (void)handleResetLastTTRTime:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "radarRequestedForDisplayReason:", &stru_1E89C3E38);
...
void __125__HMDTTRManager_initiateRadarWithTitle_componentName_componentVersion_componentID_displayReason_attachments_isUserInitiated___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error trying to create radar draft: %@", (uint8_t *)&v8, 0x16u);
...
void __129__HMDTTRManager_requestRadarWithDisplayReason_radarTitle_componentName_componentVersion_componentID_attachments_waitForResponse___block_invoke(uint64_t a1)
{
  ...
  {
    v3 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v2, "radarRequestedForDisplayReason:", *(_QWORD *)(a1 + 40)));
    v4 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2114;
      v28 = v7;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Requesting radar because %{public}@", buf, 0x16u);
    ...
    v9 = *(_QWORD *)(a1 + 32);
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("HomeKit requests you file a radar because %@."), *(_QWORD *)(a1 + 40));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Radar request filtered out: %@", buf, 0x16u);
...
void __111__HMDTTRManager_requestRadarWithMessage_radarTitle_componentName_componentVersion_componentID_waitForResponse___block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(v2, "shouldRequestRadarForDisplayReason:", *(_QWORD *)(a1 + 40)) & 1) != 0)
  {
    v3 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v2, "radarRequestedForDisplayReason:", *(_QWORD *)(a1 + 48)));
    v4 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    v5 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2114;
      v25 = v7;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Requesting radar for: %{public}@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Radar request filtered out: %@", buf, 0x16u);
...
void __111__HMDTTRManager_requestRadarWithMessage_radarTitle_componentName_componentVersion_componentID_waitForResponse___block_invoke_17(_QWORD *a1, int a2)
{
  ...
  if (a2)
  {
    v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3998]), "initWithString:", CFSTR("tap-to-radar://new"));
    objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithCapacity:", 4);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB39D8], "queryItemWithName:value:", CFSTR("ComponentName"), a1[4]);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "addObject:", v5);

    objc_msgSend(MEMORY[0x1E0CB39D8], "queryItemWithName:value:", CFSTR("ComponentVersion"), a1[5]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "addObject:", v6);

    objc_msgSend(MEMORY[0x1E0CB39D8], "queryItemWithName:value:", CFSTR("ComponentID"), a1[6]);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "addObject:", v7);

    objc_msgSend(MEMORY[0x1E0CB39D8], "queryItemWithName:value:", CFSTR("Title"), a1[7]);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v15 = 2112;
      v16 = v9;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@TTR URL: %@", (uint8_t *)&v13, 0x16u);
...
+ (id)sharedManager
{
  ...
  block[4] = a1;
  if (sharedManager_onceToken_15872 != -1)
    dispatch_once(&sharedManager_onceToken_15872, block);
...
+ (id)namespaceUUID
{
  if (namespaceUUID__hmf_once_t11 != -1)
    dispatch_once(&namespaceUUID__hmf_once_t11, &__block_literal_global_15870);
...
+ (id)queue
{
  if (queue__hmf_once_t13 != -1)
    dispatch_once(&queue__hmf_once_t13, &__block_literal_global_44_15868);
...
void __30__HMDTTRManager_namespaceUUID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("B4FFBCEC-B0A2-4660-B1B2-4B484FE76D74"));
