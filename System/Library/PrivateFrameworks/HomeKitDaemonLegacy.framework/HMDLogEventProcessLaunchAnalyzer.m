...
{
  return -[HMDLogEventProcessLaunchAnalyzer initWithProcessLaunchInfoTimer:dataSource:preferencesDebugManager:lastExitContextBlock:](self, "initWithProcessLaunchInfoTimer:dataSource:preferencesDebugManager:lastExitContextBlock:", a3, a4, a5, &__block_literal_global_126971);
}
...
- (HMDLogEventProcessLaunchAnalyzer)initWithProcessLaunchInfoTimer:(id)a3 dataSource:(id)a4 preferencesDebugManager:(id)a5 lastExitContextBlock:(id)a6
{
  ...
  if (v15)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Excessive homed launches (>=%d)"), 10);
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", 590644);
...
- (void)updateProcessLaunchInfoFromDisk
{
  ...
  if (v17)
  {
    ...
    if (v11 < v12)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_timeIntervalSincePreviousProcessLaunch);
...
- (void)handleExitContextForHomed:(id)a3 firstLaunchAfterBoot:(BOOL)a4
{
        ...
        !v10))
  {
    ...
    if (v16)
    {
      ...
      objc_msgSend(v20, "objectForKeyedSubscript:", *MEMORY[0x1E0CB2D68]);
...
LABEL_17:
      ...
      objc_msgSend(v35, "objectForKeyedSubscript:", *MEMORY[0x1E0CB2D68]);
