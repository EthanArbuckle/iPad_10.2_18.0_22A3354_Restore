...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating the %@ session", buf, 0x16u);
...
- (BOOL)sendMessage:(id)a3 payload:(id)a4 device:(id)a5 target:(id)a6 responseHandler:(id)a7
{
  ...
  if (!v22)
  {
    ...
    context = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v24, "setResponseHandler:", v16));
    v25 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v37 = 2112;
      v38 = v32;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Sending message %@ with identifier %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_67351 != -1)
    dispatch_once(&logCategory__hmf_once_t1_67351, &__block_literal_global_67352);
  return (id)logCategory__hmf_once_v2_67353;
}
...
void __37__HMDEventTriggerSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_67353;
  logCategory__hmf_once_v2_67353 = v0;
