...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_117320 != -1)
    dispatch_once(&logCategory__hmf_once_t0_117320, &__block_literal_global_117321);
  return (id)logCategory__hmf_once_v1_117322;
}
...
void __51__HMDAccessoryFirmwareUpdateTimeWindow_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_117322;
  logCategory__hmf_once_v1_117322 = v0;
