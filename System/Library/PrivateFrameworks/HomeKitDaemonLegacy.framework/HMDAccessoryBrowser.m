...
+ (id)logCategory
{
  if (logCategory__hmf_once_t365 != -1)
    dispatch_once(&logCategory__hmf_once_t365, &__block_literal_global_532);
  return (id)logCategory__hmf_once_v366;
}
...
void __33__HMDAccessoryBrowser___activate__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Activating", (uint8_t *)&v13, 0xCu);
  ...
  {
    if (objc_msgSend(v7, "areThereAnyPairedBTLEAccessories"))
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@HomeKit App came into foreground - enabling BTLE scanning since there is atleast one paired (potential) BTLE accessory", (uint8_t *)&v13, 0xCu);
    ...
    if (isiOSDevice() || isMac())
    {
      ...
      objc_msgSend(v12, "startConfirmingPairedAccessoryReachability");
...
- (void)registerPairedAccessory:(id)a3 transports:(unint64_t)a4 setupHash:(id)a5 delegate:(id)a6
{
  ...
  void *v29;
  void *v30;
  HMDPairedAccessoryInformation *v31;
  id v32;
  uint8_t buf[4];
  void *v34;
  __int16 v35;
  ...
  if (v10)
  {
    if ((a4 & 2) != 0)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v35 = 2112;
        v36 = v10;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Registering BTLE accessory server %@", buf, 0x16u);
    ...
    if ((a4 & 0x10) != 0)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v35 = 2112;
        v36 = v10;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Registering media accessory %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v20);
      -[HMDAccessoryBrowser mediaBrowser](v21, "mediaBrowser");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      v32 = v10;
      objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", &v32, 1);
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v19, "registerAccessories:", v24);
    ...
    else
    {
      ...
      objc_msgSend(v18, "registerPairedAccessoryWithIdentifier:", v10);

      -[HMDAccessoryBrowser hap2Storage](self, "hap2Storage");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v19, "registerPairedAccessoryWithIdentifier:", v10);
    }
    ...
    if ((a4 & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v35 = 2112;
        v36 = v10;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Registering IP accessory server %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v25);
      -[HMDAccessoryBrowser ipAccessoryServerBrowser](v26, "ipAccessoryServerBrowser");
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v29, "registerPairedAccessoryWithIdentifier:", v10);

      -[HMDAccessoryBrowser chipAccessoryServerBrowser](v26, "chipAccessoryServerBrowser");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v30, "registerPairedAccessoryWithIdentifier:", v10);

    }
    v31 = -[HMDPairedAccessoryInformation initWithIdentifier:transports:setupHash:delegate:]([HMDPairedAccessoryInformation alloc], "initWithIdentifier:transports:setupHash:delegate:", v10, a4, v11, v12);
    -[HMDAccessoryBrowser addPairedAccessory:](self, "addPairedAccessory:", v31);
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v21 = 2112;
        v22 = v12;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Removing existing paired accessory instance %@", buf, 0x16u);
...
- (void)accessoryServer:(id)a3 didDiscoverAccessories:(id)a4 transaction:(id)a5 error:(id)a6
{
  ...
  if (objc_msgSend(v10, "linkType") == 2)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v50 = v11;
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v10, "hasPairings"));
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v10, "stateNumber"));
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v70 = 2112;
      v71 = v21;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Removing BLE Accessory: %@ that has pairings: %@ with state number: %@", buf, 0x2Au);
  ...
  if (v24)
  {
    ...
    if (v26)
    {
      ...
      if ((objc_msgSend(v27, "isHMError") & 1) == 0)
      {
        ...
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        if (objc_msgSend(v29, "isEqualToString:", *MEMORY[0x1E0D160B0]))
        {
        ...
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", v31, CFSTR("Discovery failed."), 0, 0, v27);
        v28 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v68 = 2114;
        v69 = v27;
        _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed HAP service discovery on accessory server %@ with error: %{public}@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v66 = 2112;
        v67 = v25;
        _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Completed accessory discovery on accessory server %@", buf, 0x16u);
  ...
  if (objc_msgSend(v4, "linkType") == 2)
  {
    ...
    if ((v8 & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v27 = 2112;
        v28 = v4;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory discovery already in progress for BLE Accessory with server: %@", (uint8_t *)&v25, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedChar:", objc_msgSend(v15, "connectReason"));
        v22 = (void *)objc_claimAutoreleasedReturnValue();
        v25 = 138544130;
        v26 = v20;
        v27 = 2112;
        ...
        v31 = 2112;
        v32 = v16;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Adding BLE Accessory server: %@ to the discovering list. Connection Reason: %@. Reading characteristic types: %@", (uint8_t *)&v25, 0x2Au);
...
- (void)accessoryServerBrowser:(id)a3 didFindAccessoryServer:(id)a4 stateChanged:(BOOL)a5 stateNumber:(id)a6
{
  ...
  else
  {
    ...
    if ((v17 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 2112;
        v30 = v11;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Ignoring found accessory server %@ that already has pairings", (uint8_t *)&v27, 0x16u);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 138543362;
    v28 = v26;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Found unpaired accessory server and notifying delegates", (uint8_t *)&v27, 0xCu);
  ...
  if (v13 && (objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v27 = 2112;
      v28 = v8;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate %@ that a paired accessory server was added %@", buf, 0x20u);
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didDiscoverAccessories:(id)a4 transaction:(id)a5 error:(id)a6
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v13;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ finished discovering accessories [error %@]", (uint8_t *)&v21, 0x2Au);
...
- (id)beginActiveAssertionWithReason:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Taking active assertion with reason: %@", (uint8_t *)&v11, 0x16u);
  ...
  if (a4 == 2)
  {
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = CFSTR("BTLE");
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Retrieval already in progress for accessory with server %@/%@", (uint8_t *)&v31, 0x20u);
...
LABEL_21:
    v29 = v23;
    objc_msgSend(v23, "discoverAccessoryServerWithIdentifier:", v8);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    v28 = 32;
LABEL_26:
    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, v26, (uint8_t *)&v31, v28);
...
LABEL_3:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v34 = 2112;
      v35 = v14;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Paired Accessory server %@ matches accessory pending to be paired %@ - aborting the operation", buf, 0x20u);
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", a4);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    v23 = v6;
    objc_opt_class();
        ...
        v2 == objc_msgSend(*(id *)(a1 + 32), "hasPairings")))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
      {
        ...
        v10 = 2112;
        v11 = v7;
        _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEBUG, "%{public}@Not allowed to discover accessory server: %@", (uint8_t *)&v8, 0x16u);
...
- (void)__handleProcessStateChange:(id)a3
{
  ...
  LODWORD(v7) = objc_msgSend(v8, "isEqual:", *MEMORY[0x1E0CB9288]);
  if ((_DWORD)v7)
  {
    -[HMDAccessoryBrowser workQueue](self, "workQueue");
...
- (HMDAccessoryBrowser)initWithMessageDispatcher:(id)a3 injectedSettings:(id)a4
{
  ...
  v9 = -[HMDAccessoryBrowser init](&v68, sel_init);
  if (v9)
  {
    v10 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("BF2B0921-858B-42F5-B2EB-C915FB953E5B"));
    uuid = v9->_uuid;
    v9->_uuid = (NSUUID *)v10;
    ...
    v60 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, 120.0);
    ...
    v63 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, 60.0);
    ...
    v9->_browseableLinkTypes = (NSArray *)&unk_1E8B321D8;

    -[HMDAccessoryBrowser _registerForMessages](v9, "_registerForMessages");
    -[HMDAccessoryBrowser _registerForNotifications](v9, "_registerForNotifications");
  }
...
{
  -[HMDAccessoryBrowser configureWithHomeManager:mediaBrowserFactory:](self, "configureWithHomeManager:mediaBrowserFactory:", a3, &__block_literal_global_141001);
}
...
LABEL_24:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v38 = v35;
        _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Demo accessory browser not yet started", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v30;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Request to add test/demo accessories but none found", buf, 0xCu);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v18 = 2112;
        v19 = v9;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown unassociated accessory type: %@ - dropping...", (uint8_t *)&v16, 0x16u);
        ...
        if (v12)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v23 = 2112;
            v24 = v10;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Removing unassociated accessory: %@", buf, 0x16u);
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v19 = 2112;
          v20 = v10;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown unassociated accessory type: %@ - dropping...", (uint8_t *)&v17, 0x16u);
...
- (void)_handleAddedAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Added accessory: %@", (uint8_t *)&v9, 0x16u);
...
- (void)_handleRemovedAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Removed accessory: %@", (uint8_t *)&v9, 0x16u);
...
- (void)_sendNewAccessoryData:(id)a3 messageName:(id)a4
{
  ...
  if (-[HMDAccessoryBrowser __isAccessoryBrowsingRequested](self, "__isAccessoryBrowsingRequested"))
  {
    ...
    v37 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("BF2B0921-858B-42F5-B2EB-C915FB953E5B"));
    v36 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285D8]), "initWithTarget:", v37);
    v39 = (void *)v12;
    objc_msgSend(MEMORY[0x1E0D285F8], "messageWithName:destination:payload:", v7);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        for (i = 0; i != v7; ++i)
        {
          ...
          if (v12)
          {
            if ((objc_msgSend(v12, "isEntitledForSPIAccess") & 1) != 0
              || (v13 = -[HMDAccessoryBrowser exposeAccessoryTypesFeatureEnabled](v17, "exposeAccessoryTypesFeatureEnabled"), v14 = &stru_1E89C3E38, v13))
            {
              v14 = CFSTR("(Media)");
            }
  ...
  if (v6)
  {
    ...
    if (objc_msgSend(v8, "containsObject:", v6))
    {
      ...
      if (v10)
      {
        ...
        if ((v11 & 1) != 0)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v31 = v20;
            _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@No more clients interested in media accessory browsing - stopping", buf, 0xCu);
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v24;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@No more clients interested in accessory browsing - stopping", buf, 0xCu);
...
- (void)__addBrowsingConnection:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v50 = 2112;
      v51 = v37;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Already have an active accessory browsing request from the connection: %@", buf, 0x16u);
  ...
  {
    val = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D28640]), "initWithObservedObject:", v37);
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v50 = 2112;
      v51 = v37;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Registering connection for accessory browsing: %@", buf, 0x16u);
...
LABEL_22:
    ...
    if (v22 == 1)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v50 = 2112;
        v51 = v29;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@First connection interested in accessory%@ browsing - starting", buf, 0x16u);
    ...
    else if ((v21 & v23) == 1)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = (uint64_t)v33;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@First connection interested in media accessory browsing - starting", buf, 0xCu);
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v17 = 2112;
        v18 = v6;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@De-registering connection for accessory browsing: %@", (uint8_t *)&v15, 0x16u);
...
- (void)endActiveAssertion:(id)a3
{
  ...
  if (v7 != self)
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Invalid assertion object not created by HMHomeManager instance"), 0);
    v12 = (id)objc_claimAutoreleasedReturnValue();
LABEL_11:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Releasing active assertion : %@", (uint8_t *)&v13, 0x16u);
...
- (void)_notifyDelegateOfReachabilityChange:(BOOL)a3 forAccessoryWithIdentifier:(id)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that accessory with identifier %@ is %@", (uint8_t *)&v14, 0x2Au);
...
LABEL_33:
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v74 = 2112;
            v75 = v14;
            _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unsupported operation - not creating HMDHAPAccessory from advertisement data: %@", buf, 0x16u);
      ...
      if (!v13)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v74 = 2112;
          v75 = v20;
          _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Unsupported operation - not  creating HMDHAPUnassociatedAccessory from advertisement data: %@", buf, 0x16u);
      ...
      if (v64)
      {
        ...
        if (v19)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v73 = v24;
            _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Advertisement is for known accessory, updating", buf, 0xCu);
        ...
        else
        {
          ...
          if (v37 && objc_msgSend(v13, "conformsToProtocol:", &unk_1EFB3A550))
          {
            ...
            if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v73 = v41;
              _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Advertisement supports WAC matching, checking active sessions for match", buf, 0xCu);
            ...
            if (v62)
            {
              ...
              if (v49)
              {
                if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v73 = v57;
                  _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, "%{public}@Advertisement matches WAC device, performing handoff", buf, 0xCu);
              ...
              else
              {
                if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v76 = 2112;
                  v77 = v60;
                  _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_ERROR, "%{public}@Could not create accessory from advertisement %@ for matching WAC device %@", buf, 0x20u);

                }
                objc_autoreleasePoolPop(v52);
                -[HMDAccessoryBrowser getActiveWACSession](v53, "getActiveWACSession");
                v58 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v58, "cancelConfigurationWithCompletionHandler:", &__block_literal_global_362_140934);
              }
                  ...
                  else
                  {
                    ...
                    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      v50 = 2112;
                      v51 = v22;
                      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory advertisement data not routed through AccessoryBrowser: %@ - %@", buf, 0x20u);
...
- (void)_reprovisionAccessoryWithIdentifier:(id)a3 wiFiPSK:(id)a4 countryCode:(id)a5 withCompletion:(id)a6
{
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&v42[4] = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unable to reprovision accessory without a IP accessory server browser", v42, 0xCu);
...
LABEL_12:
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, v21, v42, 0xCu);
...
LABEL_15:
  ...
  v32 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryBrowser setCountrycodeForAccessoryReprovisioning:](self, "setCountrycodeForAccessoryReprovisioning:", v12));
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v42[12] = 2112;
    *(_QWORD *)&v42[14] = v10;
    _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Start searching for accessory: %@ for reprovisioning", v42, 0x16u);
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v42 = 138543362;
    *(_QWORD *)&v42[4] = v41;
    _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Started the stop reprovisioning timer", v42, 0xCu);
...
- (void)_associate:(BOOL)a3 hapAccessoryWithAdvertisement:(id)a4
{
          ...
          if (v25)
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v35 = 2112;
              v36 = v10;
              _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Associating Advertisement: %@ with HAPAccessory: %@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v35 = 2112;
              v36 = v10;
              _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Disassociating Advertisement: %@ from HAPAccessory: %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v33 = 2112;
    v34 = v5;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@No unpaired HAP accessory yet for advertisement: %@", buf, 0x16u);
...
- (void)_associateMediaAccessoryForServer:(id)a3
{
  ...
  if ((objc_msgSend(v4, "compatibilityFeatures") & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Found server: %@ supporting HAP+AP2", (uint8_t *)&v16, 0x16u);
    ...
    if (v10 && objc_msgSend(v10, "isHAPAirPlay2Accessory"))
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        v20 = 2112;
        v21 = v10;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Associating unpaired HAP Accessory: %@ with media Accessory: %@", (uint8_t *)&v16, 0x20u);
...
- (void)requestPermissionToAssociateWACAccessory:(id)a3 completionHandler:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Requesting permission from user to share network credentials with WAC accessory", (uint8_t *)&v16, 0xCu);
...
- (void)unassociatedWACAccessoryDidStartAssociation:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Tracking active WAC session: %@", (uint8_t *)&v9, 0x16u);
...
- (void)unassociatedWACAccessoryDidFinishAssociation:(id)a3 withError:(id)a4
{
  ...
  -[HMDAccessoryBrowser workQueue](self, "workQueue");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "dismissPendingDialogWithContext:queue:completionHandler:", v6, v9, &__block_literal_global_373);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@WAC session for %@ failed with %@", (uint8_t *)&v14, 0x20u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[4] = v11;
      ...
      v98 = 2112;
      v99 = v7;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Found accessory server (transport %@) for unpaired accessory: %@", buf, 0x20u);
      ...
      if (v24 == objc_msgSend(v4, "linkType"))
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[4] = v31;
          v96 = 2112;
          v97 = v7;
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Restarting the pairing process for unpaired accessory: %@", buf, 0x16u);
        ...
        v90[1] = 3221225472;
        v90[2] = __54__HMDAccessoryBrowser__addUnpairedAccessoryForServer___block_invoke_380;
        v90[3] = &unk_1E89C20C8;
        v85 = v32;
        v91 = v85;
        v33 = v89;
        ...
        v83 = v25;
        v93 = v83;
        __54__HMDAccessoryBrowser__addUnpairedAccessoryForServer___block_invoke_380(v90);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[4] = v20;
      ...
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Found new unpaired accessory: %@ with transport %@", buf, 0x20u);
    ...
    if (v50)
    {
      ...
      if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)&buf[4] = v54;
        ...
        v98 = 2112;
        v99 = v50;
        _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@Starting the pairing process for unpaired accessory: %@ matching setup description %@", buf, 0x20u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@De-registering accessory server %@", buf, 0x16u);
...
- (void)_btleAccessoryReachabilityProbeTimer:(BOOL)a3
{
  ...
  if (isBTLECapableDevice())
  {
    if (-[HMDAccessoryBrowser isBrowsingAllowed](self, "isBrowsingAllowed"))
    {
      ...
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v14, "na_firstObjectPassingTest:", &__block_literal_global_384_140882);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v15)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v35 = 2048;
          v36 = v10 / 0x3B9ACA00;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@In home: %@ location probing reachability every %llu sec", buf, 0x20u);
      ...
      handler[2] = __60__HMDAccessoryBrowser__btleAccessoryReachabilityProbeTimer___block_invoke_385;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v32 = v28;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to start BTLE reachability timer", buf, 0xCu);
  ...
  if (isBTLECapableDevice())
  {
    ...
    if (v3)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        v9 = 138543362;
        v10 = v7;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Suspending the BTLE reachability probe timer", (uint8_t *)&v9, 0xCu);
...
- (void)_stopReprovisioningTimerHandler
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 138543362;
    v19 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Stop reprovisioning timer fired", (uint8_t *)&v18, 0xCu);
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Stopping browsing for WAC servers", (uint8_t *)&v18, 0xCu);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 138543362;
    v19 = v17;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Clean up reprovisioning accessory", (uint8_t *)&v18, 0xCu);
      ...
      if (a4 != 2)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v24 = 2112;
          v25 = v17;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve server for identifier %@ for link type: %@", buf, 0x20u);
  ...
  if (-[HMDAccessoryBrowser areThereAnyPairedAccessories](self, "areThereAnyPairedAccessories"))
  {
    if (-[HMDAccessoryBrowser isBrowsingAllowed](self, "isBrowsingAllowed"))
    {
      ...
      if (-[HMDAccessoryBrowser areThereAnyPairedBTLEAccessories](self, "areThereAnyPairedBTLEAccessories"))
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v22 = 138543362;
          v23 = v17;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Have paired BTLE accessories, starting reachability scan", (uint8_t *)&v22, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v21;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Ignoring request for start discovering paired accessories", (uint8_t *)&v22, 0xCu);
...
- (void)_startDiscoveringAccessoriesWithLinkType:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to start discovering accessories because browsing is not allowed", buf, 0xCu);
...
LABEL_7:
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, v8, (uint8_t *)&v19, 0xCu);
...
LABEL_16:
          _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v19, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v19 = 138543362;
          v20 = v17;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Start discovering accessories need reprovision", (uint8_t *)&v19, 0xCu);
        ...
        v19 = 138543362;
        v20 = v13;
        _os_log_impl(&dword_1CD062000, &v12->super.super, OS_LOG_TYPE_INFO, "%{public}@Started the stop browsing accessories needing reprovisioning timer", (uint8_t *)&v19, 0xCu);
      }
    }
    else
    {
...
- (void)_restartBrowsers
{
          ...
          if (v12)
          {
            if (v16)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v33 = 2112;
              v34 = v18;
              _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Restarting browser %@", buf, 0x16u);
          ...
          else
          {
            if (v16)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v33 = 2112;
              v34 = v20;
              _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping Restarting browser %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v24;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@No accessory browsers yet --- reset request ignored", buf, 0xCu);
...
- (void)_registerForMessages
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v20 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Registering remote account message filter", buf, 0xCu);
...
- (void)_registerForNotifications
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v5 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "addObserver:selector:name:object:", self, sel__handleCurrentWiFiNetworkChangedNotification_, *MEMORY[0x1E0D28538], 0);
        ...
        if (v15)
        {
          if (-[HMDAccessoryBrowser doesLinkTypeNumber:matchLinkType:]((uint64_t)self, v57, objc_msgSend(v15, "linkType")))
          {
            ...
            if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
            {
              HMFGetLogIdentifier();
              v20 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(MEMORY[0x1E0CB35C8], "hmStringFromErrorCode:", v48);
              v53 = v17;
              v21 = (void *)objc_claimAutoreleasedReturnValue();
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v68 = 2112;
              v69 = v23;
              _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@%@ - sending addAccessory failure for accessory %@/%@", buf, 0x2Au);
...
LABEL_18:
        ...
        else if (-[HMDAccessoryBrowser doesLinkTypeNumber:matchLinkType:]((uint64_t)self, v57, objc_msgSend(v14, "linkType")))
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v47;
            ...
            v66 = 2112;
            v67 = v30;
            _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Removing pending pairing for accessory %@/%@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          objc_msgSend(v14, "accessoryUUID");
          v41 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v14, "linkType"));
          ...
          *(_DWORD *)buf = 138544386;
          ...
          v70 = 2112;
          v71 = v57;
          _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@Not canceling pairing for accessory %@/%@ as link type %@ does not match stopped link type %@", buf, 0x34u);
...
LABEL_24:
  ...
  v46 = v45;
  if (v45)
    objc_msgSend(v45, "cancelConfigurationWithCompletionHandler:", &__block_literal_global_405);
    ...
    if (v7 == v8)
    {
      if (v12)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory browser's generation counter matches client's value of %lu", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v9);
      v42 = CFSTR("kConfigGenerationCounterKey");
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDAccessoryBrowser generationCounter](v10, "generationCounter"));
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v43[0] = v14;
    ...
    else
    {
      if (v12)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory browser's generation counter %lu does not match client's value of %lu", buf, 0x20u);
      ...
      if (!v11)
      {
        if (v15)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v42 = 2112;
          v43 = v10;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Received request to stop searching for new accessories for XPC connection: %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v41 = v35;
          _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@Received invalid request to stop searching for new accessories with stop reason", buf, 0xCu);
...
LABEL_25:
      ...
      if (v15)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = v10;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Received request to start searching for new accessories for XPC connection: %@", buf, 0x16u);
...
LABEL_26:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = v20;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Cannot search for new accessories because client identifier salt could not be determined: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v41 = v26;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Received invalid message in _handleRequestSearchForNewAccessories", buf, 0xCu);
...
- (void)_notifyManagerOfNewAccessory
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Notifying Home manager that a new unpaired accessory was discovered", (uint8_t *)&v8, 0xCu);
          ...
          if (v13 == objc_msgSend(v6, "linkType"))
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v30 = 2112;
              v31 = v20;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@WAC accessory %@/%@: continuing pairing after setup code has been provided", buf, 0x20u);
  ...
  if (objc_msgSend(v8, "supportsCHIP"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v78 = 2112;
      v79 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Cancel pairing matter accessory with error %@ context %@", buf, 0x20u);
  ...
  if (!v18)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v78 = 2112;
      v79 = v24;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Cancel pairing with accessory but addAccessoryCompletion is nil %@/%@", buf, 0x20u);
          ...
          if (objc_msgSend(v27, "isPaired"))
          {
            ...
            if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v80 = 2112;
              v81 = v39;
              _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Cancelling pairing of the accessory that completed pair-setup: %@/%@/%@", buf, 0x2Au);
            ...
            if (objc_msgSend(v69, "supportsCHIP"))
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = v59;
                ...
                v82 = 2112;
                v83 = v45;
                _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Calling addAccessoryCompletion for unpaired accessory %@/%@, error %@, context %@", buf, 0x34u);
    ...
    if (objc_msgSend(v69, "supportsCHIP"))
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v82 = 2112;
        v83 = v53;
        _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_INFO, "%{public}@Calling addAccessoryCompletion explicitly because accessoryServer went away %@/%@, error %@, context %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v21;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@There is no unpaired accessory for %@ - removing with pairingInfo", buf, 0x16u);
...
LABEL_12:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v48 = 2112;
        v49 = v31;
        _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Accessory description %@ matches accessory pending to be paired %@ - aborting the operation", buf, 0x20u);
...
- (void)_pairAccessoryWithDescription:(id)a3 configuration:(id)a4 progressHandler:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v15;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received request to start pairing accessory with description %@", buf, 0x16u);
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v10;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Pairing accessory with description %@ failed since reprovisioning is in progress", buf, 0x16u);
      ...
      for (i = 0; i != v23; ++i)
      {
        ...
        if (objc_msgSend(v10, "matchesAccessoryServer:", v26))
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v235 = v36;
            _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@A tombstoned accessoryServer %@ matches the accessory with description %@", buf, 0x20u);
  ...
  if (objc_msgSend(v10, "isPaired"))
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v30;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Accessory description indicates that the accessory is already paired - aborting...", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v27);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 11);
    v20 = (id)objc_claimAutoreleasedReturnValue();
    +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:error:](HMDMatterAccessoryPairingEndContext, "hmdContextWithStep:error:", 2, v20);
  ...
  if (!-[HMDAccessoryBrowser _isHomeHubMatterSharedAdminPairingCapableWithConfiguration:](v192, "_isHomeHubMatterSharedAdminPairingCapableWithConfiguration:", v189))
  {
    ...
    if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v66;
      _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_INFO, "%{public}@HomeHub is not capable to handle Matter Shared Admin Pairing requests", buf, 0xCu);
  ...
  if (!-[HMDAccessoryBrowser _isHomeHubAvailableWithConfiguration:](v192, "_isHomeHubAvailableWithConfiguration:", v189))
  {
    ...
    if (os_log_type_enabled(v131, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v132;
      _os_log_impl(&dword_1CD062000, v131, OS_LOG_TYPE_ERROR, "%{public}@HomeHub is not available", buf, 0xCu);
  ...
  if (!-[HMDAccessoryBrowser _isPrimaryResidentReachableWithConfiguration:](v192, "_isPrimaryResidentReachableWithConfiguration:", v189))
  {
    ...
    if (os_log_type_enabled(v91, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v92;
      _os_log_impl(&dword_1CD062000, v91, OS_LOG_TYPE_ERROR, "%{public}@Primary resident is not reachable", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v89);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2709);
    v20 = (id)objc_claimAutoreleasedReturnValue();
    +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:error:](HMDMatterAccessoryPairingEndContext, "hmdContextWithStep:error:", 2, v20);
    v194 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_36:
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          v235 = v55;
          _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@Matched accessoryServer %@ to pair accessory %@", buf, 0x20u);
        ...
        if ((objc_msgSend(v20, "isPaired") & 1) != 0 || objc_msgSend(v20, "hasPairings"))
        {
          ...
          if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v235 = v60;
            _os_log_impl(&dword_1CD062000, v58, OS_LOG_TYPE_INFO, "%{public}@Matched accessoryServer %@ is already paired while attempting to pair accessory %@", buf, 0x20u);
        ...
        if (v62 && (objc_msgSend(v62, "transports") & 0x10) == 0)
        {
          ...
          if (os_log_type_enabled(v124, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v235 = v126;
            _os_log_impl(&dword_1CD062000, v124, OS_LOG_TYPE_INFO, "%{public}@Matched accessoryServer %@ is part of paired accessories while attempting to pair accessory %@", buf, 0x20u);
        ...
        if (obja)
        {
          ...
          if (os_log_type_enabled(v142, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v50;
            _os_log_impl(&dword_1CD062000, v142, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ is currently being paired", buf, 0x16u);

          }
          objc_autoreleasePoolPop(v140);
          v232[0] = *MEMORY[0x1E0CB2D50];
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Failed to start pairing with the accessory %@"), v50);
          v144 = (void *)objc_claimAutoreleasedReturnValue();
          v233[0] = v144;
          v232[1] = *MEMORY[0x1E0CB2D68];
          ...
          objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], 15, v197);
        ...
        {
          v197 = objc_alloc_init(MEMORY[0x1E0D163B8]);
...
LABEL_127:
          ...
          if (os_log_type_enabled(v172, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v235 = v174;
            _os_log_impl(&dword_1CD062000, v172, OS_LOG_TYPE_INFO, "%{public}@Starting pairing with accessory %@, needs consent: %@", buf, 0x20u);

          }
          objc_autoreleasePoolPop(v170);
          v198[0] = MEMORY[0x1E0C809B0];
          v198[1] = 3221225472;
          v198[2] = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_428;
          v198[3] = &unk_1E89C20C8;
          v175 = v188;
          v198[4] = v175;
          v149 = objb;
          v198[5] = v149;
          v176 = v184;
          v198[6] = v176;
          __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_428(v198);
...
LABEL_60:
  ...
  v62 = objc_alloc_init(MEMORY[0x1E0D163B8]);
  ...
  if (v183)
  {
    ...
    if (!v83)
    {
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v235 = v88;
        _os_log_impl(&dword_1CD062000, v86, OS_LOG_TYPE_INFO, "%{public}@Accessory with identifier %@ is already paired while attempting to pair %@", buf, 0x20u);
  ...
  if (v181)
  {
    ...
    if (v96)
    {
      ...
      if (os_log_type_enabled(v99, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v235 = v101;
        _os_log_impl(&dword_1CD062000, v99, OS_LOG_TYPE_INFO, "%{public}@Accessory with setupID %@ is already paired while attempting to pair %@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v97);
      v102 = (void *)MEMORY[0x1D17BA0A0]();
      v103 = v98;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v104, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v96;
        _os_log_impl(&dword_1CD062000, v104, OS_LOG_TYPE_INFO, "%{public}@Already paired accessory info: %@", buf, 0x16u);
  ...
  *(_QWORD *)&buf[16] = 0x3032000000;
  v235 = __Block_byref_object_copy__140814;
  v236 = __Block_byref_object_dispose__140815;
  v237 = 0;
  v111 = dispatch_group_create();
  v206[0] = v78;
  v206[1] = 3221225472;
  v206[2] = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_421;
  v206[3] = &unk_1E89B8660;
  v112 = v111;
  v207 = v112;
  v208 = v95;
  v209 = v183;
...
- (void)_pairAccessory:(id)a3 configuration:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&buf[4] = v13;
    v113 = 2112;
    v114 = v8;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Received request to start pairing accessory %@", buf, 0x16u);
  ...
  if (!v14)
  {
    ...
    if (!v106)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)&buf[4] = v40;
        v113 = 2112;
        v114 = v8;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Could not find a server for unpaired accessory %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v37);
      v122[0] = *MEMORY[0x1E0CB2D50];
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Failed to start pairing with the accessory %@"), v8);
      v41 = (void *)objc_claimAutoreleasedReturnValue();
      v123[0] = v41;
      v122[1] = *MEMORY[0x1E0CB2D68];
      objc_msgSend(MEMORY[0x1E0CB34D0], "mainBundle");
      v42 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v42, "localizedStringForKey:value:table:", CFSTR("There was no server present for the accessory."), &stru_1E89C3E38, 0);
      v43 = (void *)objc_claimAutoreleasedReturnValue();
      v123[1] = v43;
      objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v123, v122, 2);
      v104 = (void *)objc_claimAutoreleasedReturnValue();

      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], 2, v104);
    ...
    if (v104 && (objc_msgSend(v104, "transports") & 0x10) == 0)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Accessory %@ is already associated with a home"), v8);
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      v120[1] = *MEMORY[0x1E0CB2D68];
      v121[0] = v21;
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], 15, v19);
      v25 = (id)objc_claimAutoreleasedReturnValue();
...
LABEL_48:
    ...
    if (!-[HMDAccessoryBrowser _isHomeHubMatterSharedAdminPairingCapableWithConfiguration:](v11, "_isHomeHubMatterSharedAdminPairingCapableWithConfiguration:", v103))
    {
      ...
      if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v88;
        _os_log_impl(&dword_1CD062000, v87, OS_LOG_TYPE_INFO, "%{public}@HomeHub is not capable to handle Matter Shared Admin Pairing requests", buf, 0xCu);
...
LABEL_17:
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[4] = v48;
          v113 = 2112;
          v114 = v8;
          _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ is currently being paired", buf, 0x16u);
        ...
        objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], 15, v25);
...
LABEL_31:
        v25 = objc_alloc_init(MEMORY[0x1E0D163B8]);
        ...
        if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[4] = v78;
          ...
          v115 = 2112;
          v116 = v79;
          _os_log_impl(&dword_1CD062000, v77, OS_LOG_TYPE_INFO, "%{public}@Starting pairing with accessory %@, request: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v97, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v98;
        _os_log_impl(&dword_1CD062000, v97, OS_LOG_TYPE_ERROR, "%{public}@HomeHub is not available", buf, 0xCu);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&buf[4] = v17;
    v113 = 2112;
    v114 = v8;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Pairing accessory %@ failed since reprovisioning is in progress", buf, 0x16u);
...
- (void)_promptForPairingPasswordForServer:(id)a3 reason:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      ...
      v14 = (void *)MEMORY[0x1D17BA0A0](inited);
      v15 = self;
      HMFGetOSLogHandle();
      v16 = (id)objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v47 = 2112;
        v48 = v10;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Invoking setupCode provider for accessory %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v14);
      v41[0] = v8;
      v41[1] = 3221225472;
      v41[2] = __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_444;
      v41[3] = &unk_1E89C2328;
      v18 = v9;
      v41[4] = v18;
      v19 = v32;
      v41[5] = v19;
      __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_444((uint64_t)v41);
      v34[0] = v8;
      v34[1] = 3221225472;
      v34[2] = __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_2_448;
      v34[3] = &unk_1E89B8728;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v47 = 2112;
        v48 = v9;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Received request to prompt for pairing password for accessory server %@ but there is no setupCodeProvider", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v47 = 2112;
      v48 = v9;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Received request to prompt for pairing password for accessory server %@ that cannot be mapped to an unpaired accessory", buf, 0x16u);
...
- (void)_updatePairingRetryTimerForAccessory:(id)a3 delay:(int64_t)a4
{
  ...
  if (v8)
  {
    ...
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, (double)a4);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v19;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Not starting a pairing retry timer for unpaired accessory %@/%@ - pairing information does not exist", (uint8_t *)&v20, 0x20u);
...
- (void)_notifyDelegateOfTombstonedAccessoryServer:(id)a3
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ was tombstoned", (uint8_t *)&v13, 0x20u);
...
- (void)_tombstoneAccessoryServer:(id)a3 forceNotify:(BOOL)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2114;
      v17 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Tombstoning paired accessory server '%{public}@'", (uint8_t *)&v14, 0x16u);
...
- (void)_resurrectAccessoryServer:(id)a3
{
  ...
  if (-[HMDAccessoryBrowser _isAccessoryServerTombstoned:](self, "_isAccessoryServerTombstoned:", v4))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Resurrecting paired accessory server '%@'", (uint8_t *)&v12, 0x16u);
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v31 = 2112;
      v32 = v23;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of value update for :%@, stateNumber: %@, broadcast:%@", buf, 0x2Au);
...
- (void)_removePairingInformation:(id)a3 error:(id)a4 context:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v38 = 2112;
    v39 = v9;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Removing current pairing info %@ error %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@No addAccessory completion handler", buf, 0xCu);
...
- (void)accessoryServerBrowser:(id)a3 didFindAccessoryServerForReprovisioning:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    v28 = 2112;
    v29 = v7;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Currently reprovisioning:%@,  Found accessory server: %@ for reprovisioning", (uint8_t *)&v24, 0x20u);
  ...
  if (objc_msgSend(v7, "isPaired"))
  {
    ...
    if (v17)
    {
      v18 = objc_alloc_init(MEMORY[0x1E0D163B8]);
...
- (void)_notifyDelegateOfWACCompletionForAccessoryServerWithIdentifier:(id)a3 error:(id)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Notifying '%@' on provision complete for accessory: %@ with error: %@", (uint8_t *)&v13, 0x2Au);
...
- (void)_notifyDelegateOfAccessoryServerNeedingReprovisioning:(id)a3 error:(id)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@'' that a paired accessory server %@ needs reprovisioning with error: %@", (uint8_t *)&v15, 0x2Au);
...
- (void)_notifyDelegateOfRemovedAccessoryServer:(id)a3 error:(id)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that a paired accessory server %@ was removed with error: %@", (uint8_t *)&v15, 0x2Au);
...
- (void)_stopReconfirmTimer:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Canceling reconfirm timer for unpaired accessory %@/%@", (uint8_t *)&v15, 0x20u);
...
LABEL_7:
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, v15, (uint8_t *)&v19, 0x20u);
...
LABEL_7:
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, v18, (uint8_t *)&v28, 0x20u);

      goto LABEL_8;
    }
    goto LABEL_8;
  }
  v19 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v7, "reconfirm"));
  v20 = self;
  HMFGetOSLogHandle();
  v21 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = v24;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Starting a WAC/Bonjour reconfirm timer for unpaired accessory %@/%@", (uint8_t *)&v28, 0x20u);

  }
  objc_autoreleasePoolPop(v19);
  v25 = objc_alloc(MEMORY[0x1E0D286C8]);
  ...
  if (v19 && (isKindOfClass & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v69 = 2112;
      v70 = v56;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Removing unpaired accessory server %@/%@ error %@ context %@", buf, 0x34u);
    ...
    if (!v37)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v65 = 2112;
        v66 = v43;
        _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Removing unpaired accessory server %@ (%@)", buf, 0x20u);
...
LABEL_27:
  ...
  v44 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryBrowser accessoryServer:updatePairingProgress:](self, "accessoryServer:updatePairingProgress:", v19, 9));
  v45 = self;
  HMFGetOSLogHandle();
  v46 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v65 = 2112;
    v66 = v50;
    _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Lost the accessory before setup code was scanned - likely unplugged: %@/%@", buf, 0x20u);
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2015);
  v51 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)accessoryServerBrowser:(id)a3 didStartDiscoveringWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v7;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to start discovering accessories for server browser %@ with error %@", (uint8_t *)&v12, 0x20u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v28 = 2112;
      v29 = v7;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop discovering accessories for server browser %@ with error %@", buf, 0x20u);
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v34 = 2112;
        v35 = v25;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that accessory server discovery failed %@ over %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v9;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Not notifying of discovery failure for %@ because no paired accessory information exists", buf, 0x16u);
...
- (void)accessoryServerBrowser:(id)a3 didFailToDiscoverAccessoryServerWithIdentifier:(id)a4
{
  ...
  if (objc_msgSend(v6, "linkType") == 2)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Removing BLE Accessory: %@ from discovering list", (uint8_t *)&v31, 0x16u);
    ...
    if ((objc_msgSend(v6, "isEqual:", v14) & 1) != 0)
    {
      ...
      if (v15)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          v33 = 2112;
          v34 = v7;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@IP Browser couldn't find Server with Identifier %@. Giving HAP2 a chance...", (uint8_t *)&v31, 0x16u);
...
LABEL_5:
    ...
    if (v21)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        v33 = 2112;
        v34 = v7;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@HAP2 Browser couldn't find Server with Identifier %@. Maybe it's a CHIP accessory, checking...", (uint8_t *)&v31, 0x16u);
...
LABEL_20:
  ...
  if (v27 && (v29 = objc_msgSend(v27, "linkType"), v29 == objc_msgSend(v6, "linkType")))
    ...
    v30 = 4;
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", v30);
  v26 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_notifyDelegateOfReachabilityChangeChange:(BOOL)a3 forBTLEAccessories:(id)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v20 = 2112;
      v21 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Notifying '%@' that reachability has changed to %@ for BTLE accessories %@", (uint8_t *)&v14, 0x2Au);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v25 = 2112;
    v26 = v15;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@LinkType %@ browseable %@", buf, 0x20u);
...
LABEL_12:
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v16;
      _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
...
LABEL_12:
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v6;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
...
LABEL_3:
    ...
    if (!v14)
      goto LABEL_16;
    v15 = objc_msgSend(v14, "doesHomeContainResident");
    if (!v15)
      goto LABEL_14;
...
LABEL_16:
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v4;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
...
- (void)accessoryServerBrowser:(id)a3 cacheOperationalCertData:(id)a4 forFabricID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 138543362;
    v16 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@HM_FEATURE_ROAR_SUPPORTED is disabled - Caching not supported", (uint8_t *)&v15, 0xCu);
...
LABEL_3:
      ...
      && objc_msgSend(v21, "isSharedAdmin"))
    {
      ...
      if (v24)
      {
        v25 = objc_alloc(MEMORY[0x1E0D16618]);
        objc_msgSend(v21, "threadOperationalDataset");
        v26 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v36;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Unexpected, shared admin does not have thread operational dataset for home. Falling back to request credentials from primary resident", buf, 0xCu);
...
LABEL_15:
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v50 = 2112;
      v51 = v12;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
...
- (id)_getHAPMetadataFromHMMetadata:(id)a3
{
  ...
  if (a3)
  {
    v3 = (objc_class *)MEMORY[0x1E0D16618];
    v4 = a3;
    v5 = [v3 alloc];
    objc_msgSend(v4, "name");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_callProgressOrErrorOut:(id)a3 pairingInfo:(id)a4 accessoryInfo:(id)a5 unpairedAccessory:(id)a6 progress:(int64_t)a7 certStatus:(unint64_t)a8
{
  ...
  if (objc_msgSend(v16, "isDenylisted"))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory is blacklisted - Stopping pairing", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v19);
    objc_msgSend(v14, "stopPairingWithError:", 0);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:userInfo:", 55, 0);
...
LABEL_9:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v43;
        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_DEFAULT, "%{public}@no progress handler available - implicit auth", buf, 0xCu);
...
- (void)accessoryServer:(id)a3 promtDialog:(id)a4 forNotCertifiedAccessory:(id)a5 completion:(id)a6
{
  ...
  if (v15)
  {
    if (v19)
    {
      ...
      v24 = 138543362;
      v25 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: Defaults write set - skipping auth prompt", (uint8_t *)&v24, 0xCu);
  ...
  else
  {
    if (v19)
    {
      ...
      v24 = 138543362;
      v25 = v21;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Prompting for not certified confirmation", (uint8_t *)&v24, 0xCu);
...
- (void)accessoryServer:(id)a3 requestUserPermission:(int64_t)a4 accessoryInfo:(id)a5 error:(id)a6
{
  ...
  v84[1] = 3221225472;
  v84[2] = __81__HMDAccessoryBrowser_accessoryServer_requestUserPermission_accessoryInfo_error___block_invoke_487;
  v84[3] = &unk_1E89B8868;
    ...
    case 1:
      if (objc_msgSend(v29, "provideNetworkCredentialsToAccessory", v74, v75, v76))
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v54;
          _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: User already consented to providing network credentials to accessory - skipping prompt", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v68;
          _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: Defaults write set - skipping auth prompt", buf, 0xCu);

        }
      }
      goto LABEL_37;
    case 2:
      v39 = (void *)MEMORY[0x1D17BA0A0](v33, v34, v35);
      v40 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v113 = 2112;
        v114 = (int64_t)v31;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_DEBUG, "%{public}@Confirming Accessory Info: %@", buf, 0x16u);
      ...
      if ((objc_msgSend(v31, "isCertified", v74, v75, v76) & 1) != 0)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v46;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@need to confirm PPID", buf, 0xCu);
...
LABEL_36:
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v70;
          _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: User already consented to adding unauthenticated accessory to home - skipping auth prompt", buf, 0xCu);
...
LABEL_38:
      ...
      goto LABEL_48;
    case 3:
      v55 = (void *)MEMORY[0x1D17BA0A0](v33, v34, v35);
      v56 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v112 = v58;
        _os_log_impl(&dword_1CD062000, v57, OS_LOG_TYPE_INFO, "%{public}@need to confirm accessory info with user", buf, 0xCu);
    ...
    case 4:
      ...
      v49 = (void *)MEMORY[0x1D17BA0A0](v33, v34, v35);
      v71 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v112 = v72;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Accessory is in-compatible .. cancelling", buf, 0xCu);
...
LABEL_43:
      ...
      goto LABEL_45;
    case 5:
      v61 = (void *)MEMORY[0x1D17BA0A0](v33, v34, v35);
      v62 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v112 = v64;
        _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_INFO, "%{public}@need to confirm accessory information with user", buf, 0xCu);
    ...
    default:
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v113 = 2048;
        v114 = a4;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: Request user permission - unsupported type %tu - cancelling...", buf, 0x16u);
...
- (void)accessoryServer:(id)a3 promptUserForPasswordWithType:(unint64_t)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Have a pair setup password for server %@ - trying %@", (uint8_t *)&v31, 0x20u);
  ...
  else
  {
    ...
    if (a4 == 2)
    {
      if (v19)
      {
        ...
        v33 = 2112;
        v34 = v6;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Need ownership proof token for server %@ but there is no productData to look up the app that can provide it", (uint8_t *)&v31, 0x16u);
...
LABEL_10:
    ...
    else
    {
      if (v19)
      {
        ...
        v33 = 2112;
        v34 = v6;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Do not have a pair setup password for server %@ - requesting it", (uint8_t *)&v31, 0x16u);
...
- (void)accessoryServer:(id)a3 didReceiveBadPasswordThrottleAttemptsWithDelay:(int64_t)a4
{
  ...
  if (a4 < 1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Bad password for server %@ - re-prompting for setup code and re-start pairing", (uint8_t *)&v13, 0x16u);
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didStopPairingWithError:(id)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server stopped pairing %@", (uint8_t *)&v15, 0x20u);
  ...
  if (objc_msgSend(v8, "linkType") == 2)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v71 = 2112;
      v72 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Removing BLE Accessory: %@ from discovering list", buf, 0x16u);
  ...
  if (!v25)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v73 = 2112;
      v74 = v8;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Error %@ reported for accessory server %@ corresponding to unpaired accessory that is not in list of currently pairing accessories", buf, 0x20u);
  ...
  if (!v33)
  {
    if (v37)
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v75 = 2112;
      v76 = v53;
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@Ignoring didStopPairingWithError:(%@) and starting a pairing interrupted timer for unpaired accessory %@/%@", buf, 0x2Au);
...
LABEL_33:
  ...
  if (v37)
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v73 = 2112;
    v74 = v22;
    _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@Accessory server %@ failed to pair with irrecoverable error: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v6;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@No unpaired accessory for server %@", buf, 0x16u);
  ...
  if (v7 && v12 && _os_feature_enabled_impl())
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v18;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Calling progress handler to inform already paired accessory with state: %@", buf, 0x16u);
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v28 = 2112;
      v29 = v12;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ updated values for characteristics at state number %@", buf, 0x2Au);
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didUpdateHasPairings:(BOOL)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ updated hasPairings to %@", (uint8_t *)&v15, 0x2Au);
...
- (void)accessoryServer:(id)a3 didUpdateHasPairings:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 1024;
    v25 = v4;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory server %@ with new value of hasPairings: %d", (uint8_t *)&v20, 0x1Cu);
  ...
  else
  {
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v19;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Ignoring pairing update for accessory server %@", (uint8_t *)&v20, 0x16u);
...
- (void)accessoryServerDidUpdateStateNumber:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, Updated State", (uint8_t *)&v9, 0x16u);
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didUpdateCategory:(id)a4
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ updated category to %@", (uint8_t *)&v15, 0x2Au);
...
- (void)accessoryServer:(id)a3 didUpdateName:(id)a4
{
  ...
  if (v8)
  {
    if (v12)
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, Updated Name to %@", (uint8_t *)&v15, 0x20u);
  ...
  else
  {
    if (v12)
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, is paired - dropping provided name update to %@", (uint8_t *)&v15, 0x20u);
...
- (void)accessoryServer:(id)a3 didFinishAuth:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Auth Finished with error: %@", (uint8_t *)&v30, 0x16u);
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", v15, CFSTR("Authentication failed"), 0, 0, v7);
  ...
  else
  {
    ...
    if (v19)
    {
      if (v23)
      {
        ...
        v30 = 138543362;
        v31 = v24;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Auth finished with success", (uint8_t *)&v30, 0xCu);
    ...
    else
    {
      if (v23)
      {
        ...
        v30 = 138543362;
        v31 = v25;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Auth finished with success .. Do regular pair-setup", (uint8_t *)&v30, 0xCu);
...
LABEL_4:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v4;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@No unpaired accessory for server %@", (uint8_t *)&v21, 0x16u);
...
- (void)accessoryServer:(id)a3 validateUUID:(id)a4 token:(id)a5 model:(id)a6
{
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v49 = 2112;
      v50 = v10;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@While validating UUID, cannot find unpaired accessory for server %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = v26;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Authentication using internal setup auth token", buf, 0xCu);
  ...
  if ((objc_msgSend(v11, "isEqualToData:", v27) & 1) != 0)
  {
    ...
    if (v29)
    {
      v42 = objc_alloc(MEMORY[0x1E0D163B0]);
      objc_msgSend(v10, "name");
      v41 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = v39;
    _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Internal token auth failed", buf, 0xCu);
...
- (void)accessoryServer:(id)a3 authenticateUUID:(id)a4 token:(id)a5
{
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v8;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@While authenticating UUID, cannot find unpaired accessory for server %@", (uint8_t *)&v25, 0x16u);
  ...
  {
    v20 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryBrowser accessoryServer:updatePairingProgress:](self, "accessoryServer:updatePairingProgress:", v8, 5));
    v21 = self;
    HMFGetOSLogHandle();
    v22 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 138543362;
      v26 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Emulating auth token activation following internal setup token authentication", (uint8_t *)&v25, 0xCu);

    }
    objc_autoreleasePoolPop(v20);
    v24 = objc_alloc_init(MEMORY[0x1E0C99DF0]);
    LOWORD(v26) = 8270;
    v25 = 1881788898;
...
- (void)accessoryServer:(id)a3 confirmUUID:(id)a4 token:(id)a5
{
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v8;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@While confirming UUID, cannot find unpaired accessory for server %@", (uint8_t *)&v25, 0x16u);
    ...
    && (objc_msgSend(v17, "setupAuthToken"), v19 = (void *)objc_claimAutoreleasedReturnValue(), v19, v19))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 138543362;
      v26 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Wrap up internal setup token authentication", (uint8_t *)&v25, 0xCu);
...
- (void)accessoryServer:(id)a3 didUpdateConnectionState:(BOOL)a4 sessionInfo:(id)a5 linkLayerType:(int64_t)a6 withError:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Disconnected with error: %@"), v14);
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v27 = 2114;
    v28 = v19;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory server: %@, updated connection state to %{public}@", buf, 0x20u);
    if (!v10)
...
- (void)accessoryServer:(id)a3 didStopPairingWithError:(id)a4 matterPairingEndContext:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v11;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling matter didStopPairing with error %@ mtrContext %@ -> hmdContext %@", (uint8_t *)&v16, 0x2Au);
...
- (void)notifyMTRMetrics:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    *(_QWORD *)&buf[4] = v12;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying mtr metrics", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v9);
  v15 = CFSTR("HMDMatterAccessoryPairingMTRMetricsKey");
  *(_QWORD *)buf = v8;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", buf, &v15, 1);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)accessoryServerBrowser:(id)a3 didRemoveAccessoryServer:(id)a4 error:(id)a5 matterPairingEndContext:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2112;
    v26 = v14;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling matter didRemoveAccessoryServer with error %@ mtrContext %@ -> hmdContext %@", (uint8_t *)&v19, 0x2Au);
...
void __56__HMDAccessoryBrowser_handleActivationResponse_context___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Got Token activation response for server: %@, T1: %@", (uint8_t *)&v14, 0x20u);
...
void __84__HMDAccessoryBrowser_continueAddingAccessoryToHomeAfterUserConfirmation_withError___block_invoke(id *a1)
{
  ...
  if (a1[4])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@Authentication failed for adding accessory to home", buf, 0xCu);
    ...
    v21[1] = 3221225472;
    v21[2] = __84__HMDAccessoryBrowser_continueAddingAccessoryToHomeAfterUserConfirmation_withError___block_invoke_499;
    v21[3] = &unk_1E89BA850;
    v16 = a1[6];
    v21[4] = a1[5];
    v22 = v16;
...
uint64_t __84__HMDAccessoryBrowser_continueAddingAccessoryToHomeAfterUserConfirmation_withError___block_invoke_499(uint64_t a1)
{
    ...
    if ((a2 & 1) != 0)
    {
      ...
      if (v7 == 2)
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v48 = v12;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@User denied adding accessory after PPID conf.", buf, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v48 = v16;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@User canceled pairing, stopping pairing...\n", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v8);
        objc_msgSend(*(id *)(a1 + 32), "stopPairingWithError:", 0);
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2001);
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        v45 = *MEMORY[0x1E0CB3388];
        v46 = v17;
        objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v46, &v45, 1);
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:userInfo:", 23, v18);
        v19 = (id)objc_claimAutoreleasedReturnValue();
        v20 = v17;
        v21 = v20;
        if (*(_QWORD *)(a1 + 72) == 4)
        {
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:userInfo:", 93, 0);
          v22 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      switch(*(_QWORD *)(a1 + 72))
      {
        ...
        case 1:
          ...
          _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, v30, buf, 0xCu);
...
LABEL_39:
          ...
          break;
        case 2:
          v31 = (void *)MEMORY[0x1D17BA0A0](v15);
          v32 = v5;
          HMFGetOSLogHandle();
          v33 = objc_claimAutoreleasedReturnValue();
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v48 = v34;
            _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@User confirmed accessory PPID Info .. continuing with auth.", buf, 0xCu);
        ...
        case 3:
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v48 = v37;
            _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@User confirmed accessory Info .. continuing pairing", buf, 0xCu);

          }
          goto LABEL_37;
        case 5:
          v38 = (void *)MEMORY[0x1D17BA0A0](v15);
          v39 = v5;
          HMFGetOSLogHandle();
          v40 = objc_claimAutoreleasedReturnValue();
          if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v48 = v41;
            _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@User confirmed accessory Info .. continuing wac pairing", buf, 0xCu);
...
void __81__HMDAccessoryBrowser_accessoryServer_requestUserPermission_accessoryInfo_error___block_invoke_487(uint64_t a1, int a2)
{
  id WeakRetained;
  NSObject *v5;
  id v6;
...
void __81__HMDAccessoryBrowser_accessoryServer_requestUserPermission_accessoryInfo_error___block_invoke_4(uint64_t a1)
{
  ...
  if (v1)
  {
    ...
    v4 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", *(_QWORD *)(a1 + 48));
...
_QWORD *__81__HMDAccessoryBrowser_accessoryServer_requestUserPermission_accessoryInfo_error___block_invoke_2(_QWORD *result)
{
  ...
  if (result[4])
  {
    ...
    return (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", v1[7]);
  }
  return result;
}
...
void __115__HMDAccessoryBrowser_accessoryServerBrowser_getThreadNetworkCredentialsForAccessoryWithIdentifier_withCompletion___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve Thread Network metadata", (uint8_t *)&v16, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Returning Thread Credentials as %@", (uint8_t *)&v16, 0x16u);
  ...
  if (WeakRetained)
  {
    ...
    if (objc_msgSend(*(id *)(a1 + 32), "supportsCHIP"))
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 2112;
        v32 = v5;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Indicating addAccessory failure for matter accessory %@(%@) with error %@ context %@", (uint8_t *)&v23, 0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 2112;
        v30 = v17;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Indicating addAccessory failure for accessory %@(%@) with error %@", (uint8_t *)&v23, 0x2Au);
...
void __109__HMDAccessoryBrowser__sendPairingCompletionStatusForServer_error_matterPairingEndContext_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (!v6)
    {
      v22 = (void *)MEMORY[0x1D17BA0A0](v7);
      v23 = v3;
      HMFGetOSLogHandle();
      v24 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v52 = 2112;
        v53 = v27;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@No addAccessory completion handler for %@ - error %@", buf, 0x20u);
    ...
    if ((isKindOfClass & 1) != 0 && v8)
    {
      if (v13)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v19 = 32;
LABEL_15:
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, v17, buf, v19);
      ...
      if (v38)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v52 = 2112;
          v53 = v44;
          _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove keychain entry for accessory %@ - error %@", buf, 0x20u);
...
void __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_444(uint64_t a1)
{
  void *v2;
...
void __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_2_448(id *a1, void *a2, void *a3, void *a4)
{
  id v7;
  id v8;
  id v9;
...
void __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke(uint64_t a1, int a2, void *a3, void *a4, void *a5)
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v49 = 2112;
      v50 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Waiting for the prior pending pairing to be removed from the accessory before proceeding with adding accessory %@", buf, 0x16u);
  ...
  else if (a2)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", v21);
    v25 = (id)objc_claimAutoreleasedReturnValue();
    +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:error:](HMDMatterAccessoryPairingEndContext, "hmdContextWithStep:error:", 2, v25);
    v26 = (id)objc_claimAutoreleasedReturnValue();
    if (*(_QWORD *)(a1 + 72))
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v49 = 2112;
        v50 = v42;
        _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Pairing failed because its already associated to home %@", buf, 0x16u);
  ...
  if (!v10)
  {
    ...
    v45[1] = 3221225472;
    v45[2] = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_416;
    v45[3] = &unk_1E89C0898;
    v25 = *(id *)(a1 + 40);
    v45[4] = v25;
    v26 = *(id *)(a1 + 48);
    v45[5] = v26;
    v46 = v13;
    v27 = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_416(v45);
    if (!v9)
    {
      v28 = (void *)MEMORY[0x1D17BA0A0](v27);
      v29 = *(id *)(a1 + 32);
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v51 = 2112;
        v52 = v33;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Waiting for discovery of accessory with setupID %@ (%@) to start pairing", buf, 0x20u);
...
LABEL_28:
  ...
  if (*(_QWORD *)(a1 + 72))
  {
    ...
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    if (v23 == (void *)*MEMORY[0x1E0D160B0])
    {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v37;
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_ERROR, "%{public}@Pairing failed with fatal error", buf, 0xCu);
...
void __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_421(uint64_t a1, void *a2)
{
  NSObject *v3;
  id v4;
  uint64_t v5;
...
_QWORD *__101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_428(_QWORD *result)
{
  void *v1;
  _QWORD *v2;
  void *v3;
...
_QWORD *__101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_416(_QWORD *result)
{
  void *v1;
  _QWORD *v2;
  void *v3;
...
void __54__HMDAccessoryBrowser_handleXPCConnectionInvalidated___block_invoke(uint64_t a1)
{
  ...
  {
    v5 = *(void **)(a1 + 40);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2503);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Received connection invalidated notification, but no connection object was found: %@", (uint8_t *)&v12, 0x16u);
...
void __68__HMDAccessoryBrowser__handleCurrentWiFiNetworkChangedNotification___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@WiFi network connection changed; Thread preferred network database%@ updated",
      (uint8_t *)&v10,
      0x16u);
...
void __60__HMDAccessoryBrowser__btleAccessoryReachabilityProbeTimer___block_invoke_385(uint64_t a1)
{
  id *v1;
  id WeakRetained;
  void *v3;
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v15 = v10;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@BTLE reachability probe timer fired.", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v7);
      objc_msgSend(v8, "btleAccessoryServerBrowser");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v11, "probeReachabilityForAccessoryServersWithIdentifiers:forceScan:withCompletion:", v3, 0, v6);
  ...
  if (objc_msgSend(v3, "linkType") == 1 && (objc_msgSend(v3, "hasPairings") & 1) == 0)
  {
    if (objc_msgSend(v3, "isPaired"))
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        v11 = 2112;
        v12 = v8;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Accessory server %@ reports it is unpaired, but we have pairings for it", (uint8_t *)&v9, 0x16u);
...
_QWORD *__54__HMDAccessoryBrowser__addUnpairedAccessoryForServer___block_invoke_380(_QWORD *result)
{
  void *v1;
  _QWORD *v2;
  void *v3;
...
void __54__HMDAccessoryBrowser_removeUnassociatedWACAccessory___block_invoke(uint64_t a1)
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "dismissPendingDialogWithContext:queue:completionHandler:", v2, v3, &__block_literal_global_372);
...
void __68__HMDAccessoryBrowser_addUnassociatedMediaAccessory_forDeviceSetup___block_invoke(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@DeviceSetup accessory %@ already has a previous instance %@ - removing it", (uint8_t *)&v15, 0x20u);
    ...
    else
    {
      if (*(_BYTE *)(a1 + 57))
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          v17 = 2112;
          v18 = v14;
          _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding accessory %@ for deviceSetup", (uint8_t *)&v15, 0x16u);
...
void __59__HMDAccessoryBrowser_handleNewlyPairedAccessory_linkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v22 = 2112;
    v23 = v13;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Discovering accessory server for newly added accessory: %@/%@", buf, 0x20u);
      ...
      if (v38)
      {
        ...
        do
        {
          for (i = 0; i != v38; ++i)
          {
            ...
            v10 = v43;
            v11 = (void *)MEMORY[0x1D17BA0A0](v9);
            v12 = *(id *)(a1 + 40);
            HMFGetOSLogHandle();
            v13 = objc_claimAutoreleasedReturnValue();
            if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v53 = 2048;
              v54 = v43;
              _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Home: %@ Reachable IP accessories: %tu", buf, 0x20u);
            ...
            if (v16 == 2 && v10 == 0)
            {
              ...
              if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v51 = 2112;
                v52 = v8;
                _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Outside home region for home %@", buf, 0x16u);
...
uint64_t __32__HMDAccessoryBrowser_activate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2048;
    v14 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Activating with startDiscovery %ld", (uint8_t *)&v11, 0x16u);
...
void __73__HMDAccessoryBrowser_stopDiscoveringForUnpairedAccessoriesWithLinkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for unpaired accessories with link type: %@", (uint8_t *)&v9, 0x16u);
...
void __62__HMDAccessoryBrowser_stopDiscoveringAccessoriesWithLinkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for accessories with link type: %@", (uint8_t *)&v9, 0x16u);
...
uint64_t __49__HMDAccessoryBrowser_stopDiscoveringAccessories__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for accessories", (uint8_t *)&v7, 0xCu);
...
void __55__HMDAccessoryBrowser_startDiscoveringMediaAccessories__block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v6 = 138543362;
      v7 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to start discovering media accessories", (uint8_t *)&v6, 0xCu);
...
void __63__HMDAccessoryBrowser_startDiscoveringAccessoriesWithLinkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting discovery for accessories with link Type: %@", (uint8_t *)&v9, 0x16u);
...
uint64_t __50__HMDAccessoryBrowser_startDiscoveringAccessories__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting discovery for accessories", (uint8_t *)&v7, 0xCu);
...
void __41__HMDAccessoryBrowser_resetConfiguration__block_invoke(uint64_t a1)
{
  ...
  v8 = *(void **)(a1 + 32);
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2500);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
void __35__HMDAccessoryBrowser___inactivate__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    while (2)
    {
      for (i = 0; i != v4; ++i)
      {
        if (*(_QWORD *)v24 != v5)
          objc_enumerationMutation(v3);
        if ((objc_msgSend(*(id *)(*((_QWORD *)&v23 + 1) + 8 * i), "isValid", (_QWORD)v23) & 1) != 0)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v28 = v14;
            _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Not inactivating, there is an active assertion", buf, 0xCu);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v28 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Inactivating", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@No HomeKit App in foreground - disabling BTLE scanning", buf, 0xCu);
    ...
    if (isiOSDevice() || isMac())
    {
      objc_msgSend(*(id *)(a1 + 32), "hap2AccessoryServerBrowser", (_QWORD)v23);
      v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (WeakRetained && v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v15 = 2112;
      v16 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling de-allocation of connection for accessory browsing: %@", buf, 0x16u);
    ...
    v11[0] = MEMORY[0x1E0C809B0];
    v11[1] = 3221225472;
    v11[2] = __47__HMDAccessoryBrowser___addBrowsingConnection___block_invoke_339;
    v11[3] = &unk_1E89C2328;
    v11[4] = v6;
    v12 = v4;
...
void __47__HMDAccessoryBrowser___addBrowsingConnection___block_invoke_339(uint64_t a1)
{
  void *v1;
  uint64_t v2;
  id v3;
  ...
  v1 = *(void **)(a1 + 32);
  v2 = *(_QWORD *)(a1 + 40);
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2504);
  v3 = (id)objc_claimAutoreleasedReturnValue();
...
void __68__HMDAccessoryBrowser_configureWithHomeManager_mediaBrowserFactory___block_invoke(uint64_t a1)
{
  ...
  v34 = *MEMORY[0x1E0C80C00];
  objc_storeWeak((id *)(*(_QWORD *)(a1 + 32) + 152), *(id *)(a1 + 40));
  if (isFeatureMatteriPhoneOnlyPairingControlEnabled())
  {
    v31 = 0u;
    v32 = 0u;
...
void __34__HMDAccessoryBrowser_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v366;
