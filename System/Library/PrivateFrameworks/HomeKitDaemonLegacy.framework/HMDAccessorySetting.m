    ...
    if (!v9->_value)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v27 = 2112;
        v28 = v17;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive supported value from the model's value data: %@", buf, 0x16u);
              ...
              case 3:
                ...
                if (v33)
                {
                  ...
                  if (v39 > 0.00000011920929)
                  {
                    ...
                    {
                      v70 = (void *)MEMORY[0x1D17BA0A0](v40);
                      v71 = v22;
                      HMFGetOSLogHandle();
                      ...
                      if (os_log_type_enabled(v72, OS_LOG_TYPE_DEFAULT))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        v105 = 2112;
                        v106 = v27;
                        _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, does not conform to step, %@, from current value: %@", buf, 0x2Au);
...
LABEL_90:
                        v11 = v78;
                        v12 = v77;
                        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", v64);
...
LABEL_91:
                  ...
                  if (objc_msgSend(v23, "compare:", v43) == 1)
                  {
                    ...
                    if (os_log_type_enabled(v67, OS_LOG_TYPE_DEFAULT))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      v103 = 2112;
                      v104 = v43;
                      _os_log_impl(&dword_1CD062000, v67, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, more than maximum value: %@", buf, 0x20u);
                  ...
                  if (objc_msgSend(v23, "compare:", v31) == -1)
                  {
                    ...
                    if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      v103 = 2112;
                      v104 = v31;
                      _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, less than minimum value: %@", buf, 0x20u);
              ...
              default:
                ...
                if (os_log_type_enabled(v46, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v101 = 2112;
                  v102 = v24;
                  _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring numeric constraint: %@", buf, 0x16u);
            ...
            _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_DEFAULT, v54, buf, 0x16u);
...
LABEL_75:
          ...
          *(_DWORD *)v95 = 138543618;
          ...
          v98 = v57;
          v58 = v57;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Unexpected value class: %@", v95, 0x16u);
...
- (BOOL)canAddConstraint:(id)a3 error:(id *)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Invalid constraint, %@, with error: %@", (uint8_t *)&v20, 0x20u);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v6;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Duplicate constraint: %@", (uint8_t *)&v20, 0x16u);
...
- (BOOL)canRemoveConstraint:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Missing Constraint: %@", (uint8_t *)&v12, 0x16u);
          ...
          if (v12 && objc_msgSend(v5, "isEqual:", v12))
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v31 = 2112;
              v32 = v4;
              _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Found counterpart constraint %@ for %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v4;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Can't decode constraint %@", buf, 0x16u);
...
- (id)replicatedMissingConstraintsFrom:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@found constraints that are not present returning, %@", (uint8_t *)&v13, 0x16u);
  ...
  if ((objc_msgSend(v6, "hmf_isEmpty") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@found constraints that are not present adding, %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Updating constraints: %@", buf, 0x16u);
    ...
    v44 = (void *)v14;
    v16 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v15, "minusSet:", v14));
    v17 = v8;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v15;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Removing constraints: %@", buf, 0x16u);
    ...
    v31 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v30, "minusSet:", v46));
    v32 = v17;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v30;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Adding constraints: %@", buf, 0x16u);
...
- (BOOL)shouldBlockSettingUpdateFromVersion:(id)a3 isMultiUserEnabled:(BOOL)a4
{
  ...
  v20 = *MEMORY[0x1E0C80C00];
  v6 = a3;
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286E0]), "initWithVersionString:", CFSTR("6.0"));
  -[HMDAccessorySetting keyPath](self, "keyPath");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_5:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v18 = 2112;
    v19 = v6;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Settings update blocked due to attempting language setting update with homekit version: %@", (uint8_t *)&v16, 0x16u);
    ...
    if ((unint64_t)objc_msgSend(v23, "count") < 4)
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v47 = v36;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Unable to deserialize selected language.", buf, 0xCu);
              ...
              v27))
        {
          ...
          if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v50 = 2112;
            v51 = v30;
            _os_log_impl(&dword_1CD062000, log, OS_LOG_TYPE_INFO, "%{public}@Language changing from %@ to %@ and both are supported.", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v48 = 2112;
            v49 = v25;
            _os_log_impl(&dword_1CD062000, log, OS_LOG_TYPE_INFO, "%{public}@Found recognition language %@ in supported languages need to turn off personal requests.", buf, 0x16u);
  ...
  if ((objc_msgSend(v7, "hmf_isEmpty") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v55 = 2112;
      v56 = v9;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@will remove %@ from %@", buf, 0x20u);
  ...
  if ((objc_msgSend(v25, "hmf_isEmpty") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v55 = 2112;
      v56 = v27;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@will add %@ to %@", buf, 0x20u);
  ...
  if (objc_msgSend(v5, "count"))
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v53 = 2112;
      v54 = v5;
      _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_DEBUG, "%{public}@fixing up accessory constraints %@", buf, 0x16u);
...
- (id)_initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB7E78]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB7E80]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = -[HMDAccessorySetting initWithIdentifier:name:](self, "initWithIdentifier:name:", v5, v6);
  if (v7)
  {
    v7->_type = objc_msgSend(v4, "decodeIntegerForKey:", *MEMORY[0x1E0CB7EB8]);
    v7->_properties = objc_msgSend(v4, "decodeIntegerForKey:", *MEMORY[0x1E0CB7E88]);
    objc_msgSend((id)objc_opt_class(), "supportedConstraintClasses");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v8, *MEMORY[0x1E0CB7E50]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend((id)objc_opt_class(), "supportedValueClasses");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v13, *MEMORY[0x1E0CB7EE0]);
    v14 = objc_claimAutoreleasedReturnValue();
    value = v7->_value;
    v7->_value = (id)v14;
...
- (id)constraintsForCodingXPC
{
  ...
  v13 = &v12;
  v14 = 0x3032000000;
  v15 = __Block_byref_object_copy__172347;
  v16 = __Block_byref_object_dispose__172348;
  v17 = 0;
  p_lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  v4 = (void *)-[NSMutableArray copy](self->_constraints, "copy");
...
- (void)_encodeWithCoder:(id)a3
{
  ...
  -[HMDAccessorySetting identifier](self, "identifier");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x1E0CB7E78]);

  v8 = -[HMDAccessorySetting properties](self, "properties");
  objc_msgSend(v4, "encodeInteger:forKey:", v8, *MEMORY[0x1E0CB7E88]);
  -[HMDAccessorySetting name](self, "name");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v9, *MEMORY[0x1E0CB7E80]);
  ...
  if ((v6 & 1) == 0)
  {
    if ((v5 & 1) != 0)
      ...
      -[HMDAccessorySetting constraints](self, "constraints");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v24, *MEMORY[0x1E0CB7E50]);
...
LABEL_20:
  ...
  v4 = v28;
  objc_msgSend(v28, "encodeObject:forKey:", v22, *MEMORY[0x1E0CB7E50]);
...
LABEL_21:
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    objc_msgSend(v4, "encodeBool:forKey:", v25, *MEMORY[0x1E0CB7EA0]);
  }
  if ((v5 & 1) != 0)
    Type = -[HMDAccessorySetting type](self, "type");
  else
    Type = __getType((os_unfair_lock_s *)self);
  objc_msgSend(v4, "encodeInteger:forKey:", Type, *MEMORY[0x1E0CB7EB8]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t58 != -1)
    dispatch_once(&logCategory__hmf_once_t58, &__block_literal_global_172430);
...
+ (id)supportedValueClasses
{
  if (supportedValueClasses_onceToken != -1)
    dispatch_once(&supportedValueClasses_onceToken, &__block_literal_global_37_172429);
...
+ (id)supportedConstraintClasses
{
  if (supportedConstraintClasses_onceToken != -1)
    dispatch_once(&supportedConstraintClasses_onceToken, &__block_literal_global_41_172427);
