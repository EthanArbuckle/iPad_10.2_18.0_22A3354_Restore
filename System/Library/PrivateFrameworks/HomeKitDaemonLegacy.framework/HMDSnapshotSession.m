        ...
        do
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v40 = 2112;
            v41 = v29;
            _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Responding to %@ with error %@ payload %@", buf, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_114226 != -1)
    dispatch_once(&logCategory__hmf_once_t0_114226, &__block_literal_global_114227);
  return (id)logCategory__hmf_once_v1_114228;
}
...
void __33__HMDSnapshotSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_114228;
  logCategory__hmf_once_v1_114228 = v0;
