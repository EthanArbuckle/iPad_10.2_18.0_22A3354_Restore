...
- (void)sendMessageWithName:(id)a3 cameraSessionID:(id)a4 payload:(id)a5 target:(id)a6 device:(id)a7 responseQueue:(id)a8 responseHandler:(id)a9
{
  ...
  if (v19)
  {
    ...
    v24 = v19;
    v44 = v24;
    v25 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v22, "setResponseHandler:", v40));
    v26 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v56 = 2112;
      v57 = v31;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Enqueueing camera message for session ID %@ to %@ using %@", buf, 0x2Au);
...
- (HMDDevice)remoteAccessDevice
{
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v21 = 2112;
          v22 = v4;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to find remote access device for home %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get home to determine remote access device", (uint8_t *)&v19, 0xCu);
...
- (void)sendNextMessageForDeviceIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v4;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending next queued message %@ to device with identifier: %@", (uint8_t *)&v12, 0x20u);
...
void __123__HMDCameraResidentMessageHandler_sendMessageWithName_cameraSessionID_payload_target_device_responseQueue_responseHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@Did not find the resident device to send the message %@ for session %@", (uint8_t *)&v10, 0x20u);

  }
  objc_autoreleasePoolPop(v2);
  v8 = *(_QWORD *)(a1 + 56);
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1034);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
void __123__HMDCameraResidentMessageHandler_sendMessageWithName_cameraSessionID_payload_target_device_responseQueue_responseHandler___block_invoke_10(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v25 = 2112;
    v26 = v14;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Received response for message with identifier %@. Sending next message", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_75972 != -1)
    dispatch_once(&logCategory__hmf_once_t9_75972, &__block_literal_global_75973);
  return (id)logCategory__hmf_once_v10_75974;
}
...
void __46__HMDCameraResidentMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_75974;
  logCategory__hmf_once_v10_75974 = v0;
