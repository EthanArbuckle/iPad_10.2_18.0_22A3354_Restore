...
- (void)configure
{
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v18 = 138543362;
        v19 = v17;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Not configuring participants manager because home manager reference is nil", (uint8_t *)&v18, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 138543362;
      v19 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Not configuring participants manager because home reference is nil", (uint8_t *)&v18, 0xCu);
...
LABEL_38:
      _os_log_impl(&dword_1CD062000, v49, v50, v48, buf, 0xCu);
...
LABEL_39:
    ...
    && (objc_msgSend(v8, "areShareModificationsEnabledForManager:", self) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v78 = v54;
      _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_DEBUG, "%{public}@Not updating share participants because share modifications are disabled", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v78 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating share participants", buf, 0xCu);
        ...
        for (k = 0; k != v60; ++k)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v79 = 2112;
            v80 = v32;
            _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Revoking cloud share for existing cloud share participant: %@", buf, 0x16u);
...
- (void)inviteUser:(id)a3 usingDevice:(id)a4
{
        ...
        (v10 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Not inviting ineligible user %@ using device: %@", (uint8_t *)&v20, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Inviting user %@ using device: %@", (uint8_t *)&v20, 0x20u);
...
- (void)clearParticipants
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v23 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Clearing share participants", buf, 0xCu);
    ...
    if ((_DWORD)v10 != objc_msgSend(v13, "hasWriteAccess"))
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v34 = 2112;
        v35 = v6;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating write access from %@ to %@ for user %@", buf, 0x2Au);
...
- (id)fetchInvitationToUser:(id)a3 shouldGrantWriteAccess:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v24 = 2112;
    v25 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Fetching invitation to user %@ with write access: %@", buf, 0x20u);
    ...
    && objc_msgSend(v8, "canUseUntrustedAccountHandlesForParticipantManager:", self))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Fetching share invitation context using untrusted account handle for user: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v37 = 2112;
      v38 = v20;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Fetching invitation context for user %@ with cloud share ID future: %@", buf, 0x20u);
...
- (id)_untrustedInvitationContextForUser:(id)a3 shouldGrantWriteAccess:(BOOL)a4
{
  ...
  if (v9)
  {
    if (v9 == 2)
    {
      v23 = objc_alloc(MEMORY[0x1E0D32CE8]);
      objc_msgSend(v6, "uuid");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "accountHandle");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      v10 = objc_alloc(MEMORY[0x1E0D32CE8]);
      objc_msgSend(v6, "uuid");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "accountHandle");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    v28 = 2112;
    v29 = v19;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@User's account handle was of unknown type: %@", (uint8_t *)&v26, 0x16u);
...
- (void)handleHomeUserAddedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling home user added notification: %@", buf, 0x16u);
...
- (void)handleHomeUserRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling home user removed notification: %@", buf, 0x16u);
...
- (void)handleHomeDataLoadedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling home data loaded notification: %@", buf, 0x16u);
...
void __89__HMDCloudShareParticipantsManager_fetchInvitationContextForUser_shouldGrantWriteAccess___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch invitation context due to cloud share ID future error: %@", (uint8_t *)&v8, 0x16u);
...
id __89__HMDCloudShareParticipantsManager_fetchInvitationContextForUser_shouldGrantWriteAccess___block_invoke_20(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating share invitation context for user %@ using trusted cloud share id: %@", (uint8_t *)&v14, 0x20u);

  }
  objc_autoreleasePoolPop(v4);
  v9 = objc_alloc(MEMORY[0x1E0D32CE8]);
...
void __81__HMDCloudShareParticipantsManager_fetchInvitationToUser_shouldGrantWriteAccess___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch invitation context: %@", (uint8_t *)&v8, 0x16u);
...
void __60__HMDCloudShareParticipantsManager__inviteUser_usingDevice___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      if (v13)
      {
        ...
        v27 = 2112;
        v28 = v15;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Sending invitation %@ to device: %@", (uint8_t *)&v23, 0x20u);
    ...
    else
    {
      if (v13)
      {
        ...
        v27 = 2112;
        v28 = v22;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Sending invitation %@ to user: %@", (uint8_t *)&v23, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v6;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not create invitation to send to user %@: %@", (uint8_t *)&v23, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_104900 != -1)
    dispatch_once(&logCategory__hmf_once_t24_104900, &__block_literal_global_104901);
  return (id)logCategory__hmf_once_v25_104902;
}
...
void __47__HMDCloudShareParticipantsManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_104902;
  logCategory__hmf_once_v25_104902 = v0;
