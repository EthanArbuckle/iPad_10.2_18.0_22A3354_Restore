...
LABEL_10:
          ...
          while (1)
          {
            ...
            objc_msgSend(v16, "characteristicType", v117);
              ...
              if (v39 | v35 | v46)
              {
                ...
                if (!isWatch())
                {
                  ...
                  if (os_log_type_enabled(v52, OS_LOG_TYPE_DEFAULT))
                  {
                    ...
                    v124 = v53;
                    v125 = v54;
                    -[HMDService accessory](v51, "accessory");
                    ...
                    *(_DWORD *)buf = 138544898;
                    ...
                    v160 = 2112;
                    v161 = v123;
                    _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_DEFAULT, "%{public}@Enabling notifications on behalf of homed(%@%@%@) for characteristic %@(%@/%@)", buf, 0x48u);
            ...
            if (objc_msgSend(v16, "isNotificationEnabled"))
            {
              ...
              if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v152 = 2112;
                v153 = v64;
                _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_INFO, "%{public}@Notifications are enabled for characteristic %@ on behalf of %@", buf, 0x20u);
          ...
          if (objc_msgSend(v29, "compare:", v65) == -1)
          {
            objc_msgSend(v26, "valueUpdatedTime");
            v66 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(MEMORY[0x1E0C99D68], "distantPast");
            v67 = (void *)objc_claimAutoreleasedReturnValue();
            v68 = objc_msgSend(v66, "isEqualToDate:", v67);
            ...
            if ((v68 & 1) == 0)
            {
              ...
              objc_msgSend(v65, "setObject:forKeyedSubscript:", v70, CFSTR("kCharacteristicValue"));

              objc_msgSend(v26, "valueUpdatedTime");
              v71 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v65, "setObject:forKeyedSubscript:", v71, CFSTR("kCharacteristicValueUpdateTime"));
              ...
              objc_msgSend(v65, "setObject:forKeyedSubscript:", v73, CFSTR("kCharacteristicValueUpdateStateNumberKey"));

              objc_msgSend(v16, "notificationEnabledTime");
              v74 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v65, "setObject:forKeyedSubscript:", v74, CFSTR("kCharacteristicNotificationEnableTime"));
              ...
              if (v75)
              {
                ...
                objc_msgSend(v65, "setObject:forKeyedSubscript:", v76, CFSTR("kCharacteristicNotificationContextKey"));

              }
              objc_msgSend(v26, "instanceID");
              v77 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v129, "setObject:forKey:", v65, v77);
...
LABEL_63:
  ...
  if (HIDWORD(v117))
  {
    ...
    if (objc_msgSend(v79, "isEqualToString:", *MEMORY[0x1E0CB99A0]))
    {
    ...
    else
    {
      ...
      v81 = objc_msgSend(v80, "isEqualToString:", *MEMORY[0x1E0D161A0]);
...
LABEL_73:
    ...
    objc_msgSend(v132, "accessory", v117);
    v82 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v82, "server");
    v83 = (void *)objc_claimAutoreleasedReturnValue();
    v84 = objc_msgSend(v83, "configNumber");
    v85 = objc_msgSend(v121, "configNumber");
    v47 = v84 == v85;
    v81 = v84 != v85;
    if (!v47)
...
LABEL_74:
  objc_msgSend(MEMORY[0x1E0C99E08], "dictionaryWithCapacity:", 3, v117);
  v86 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v129, "count"))
    objc_msgSend(v86, "setObject:forKey:", v129, CFSTR("kModifiedCharacteristicsForAccessoryKey"));
  -[HMDService _updateDefaultName](v135, "_updateDefaultName");
  -[HMDService findCharacteristicWithType:](v135, "findCharacteristicWithType:", *MEMORY[0x1E0CB8818]);
  ...
  if (v87)
  {
    ...
    if (!-[__CFString length](v91, "length"))
    {

      v91 = 0;
    }
    if (-[HMDService shouldUpdateLastSeenConfiguredName:](v135, "shouldUpdateLastSeenConfiguredName:", v91))
    {
      ...
      if (v118)
      {
        if (v95)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v150 = 2112;
          v151 = v91;
          _os_log_impl(&dword_1CD062000, v94, OS_LOG_TYPE_DEFAULT, "%{public}@Saving accessory reported name (%@) as expected and configured name", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v92);
        -[HMDService _saveLastSeenAndExpectedConfiguredName:](v93, "_saveLastSeenAndExpectedConfiguredName:", v91);
      }
      else
      {
        if (v95)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v150 = 2112;
          v151 = v91;
          _os_log_impl(&dword_1CD062000, v94, OS_LOG_TYPE_DEFAULT, "%{public}@Creating a transaction to save accessory reported name (%@) as expected and configured name", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v92);
        -[HMDService _saveCurrentNameAsExpectedAndLastSeen:](v93, "_saveCurrentNameAsExpectedAndLastSeen:", v91);
      }
    }
    else if (objc_msgSend(v120, "isOwnerUser"))
    {
      if (objc_msgSend(v88, "supportsWrite"))
      {
        ...
        if ((v98 & 1) == 0)
        {
          ...
          if (v100)
          {
            ...
            -[HMDService _sanitizeNameToWriteToAccessory:](v135, "_sanitizeNameToWriteToAccessory:", v101);
            ...
            if (os_log_type_enabled(v105, OS_LOG_TYPE_DEFAULT))
            {
              ...
              -[HMDService name](v104, "name");
              v107 = (__CFString *)objc_claimAutoreleasedReturnValue();
              -[HMDService lastSeenConfiguredName](v104, "lastSeenConfiguredName");
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v154 = 2112;
              v155 = v108;
              _os_log_impl(&dword_1CD062000, v105, OS_LOG_TYPE_DEFAULT, "%{public}@Overwriting configured name since expected name does not match expected: %@, name: %@, lastSeen: %@", buf, 0x2Au);
            ...
            -[HMDService _writeConfiguredNameToAccessory:](v104, "_writeConfiguredNameToAccessory:", v102);
  ...
  v111 = objc_msgSend(v110, "isEqualToString:", *MEMORY[0x1E0CB99D8]);
  ...
  if (v111)
  {
    ...
    if (os_log_type_enabled(v114, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v149 = v115;
      _os_log_impl(&dword_1CD062000, v114, OS_LOG_TYPE_DEBUG, "%{public}@Service is camera recording management, sending kick notification", buf, 0xCu);
...
+ (BOOL)processUpdateForCharacteristicType:(id)a3 value:(id)a4 serviceType:(id)a5 service:(id)a6 serviceTransactionGetter:(id)a7 accessory:(id)a8 accessoryTransaction:(id)a9 accessoryTransactionChanged:(BOOL *)a10
{
  ...
  if ((objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0CB99A0]) & 1) != 0
    || (objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0D161A0]) & 1) != 0
  ...
  if (objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0CB8968]))
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
...
LABEL_64:
                ...
                v79))
          {
            ...
            if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              *(_QWORD *)&buf[4] = v83;
              _os_log_impl(&dword_1CD062000, v82, OS_LOG_TYPE_INFO, "%{public}@Ignoring service transaction name update for matter", buf, 0xCu);
  ...
  if (objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0CB8818]))
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v19, "shouldUpdateLastSeenConfiguredName:", v28))
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[4] = v34;
          ...
          v111 = 2112;
          v112 = v35;
          _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@nameFromAccessory %@  lastSeenConfiguredName %@", buf, 0x20u);
  ...
  if ((objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0CB8A30]) & 1) != 0)
  {
    v37 = 0;
    v29 = v106;
    goto LABEL_101;
...
LABEL_70:
  ...
  v104 = v20;
  if (objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0CB9A48]))
  {
    if (objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0CB88F8]))
    {
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
...
LABEL_92:
  ...
  if (objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0CB9AF0]))
  {
...
LABEL_93:
  ...
  {
    v20 = v104;
    if (objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0CB8B28]))
    {
      if (objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0CB9B18]))
      {
        objc_opt_class();
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          v87 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286E0]), "initWithVersionString:", v17);
          if (v87)
          {
            if (!v19)
              goto LABEL_81;
...
+ (BOOL)validateProvidedName:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v8 == 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v21 = 2112;
        v22 = v6;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ does not contain allowed characters", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ is not an NSString", (uint8_t *)&v19, 0x16u);
...
- (id)_deriveDefaultName
{
  ...
  v4 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB9B08]);
  ...
  if (v4)
  {
    ...
    v7 = objc_msgSend(v6, "isEqualToString:", *MEMORY[0x1E0CB9978]);
  ...
  else
  {
    -[HMDService serviceType](self, "serviceType");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v13, "isEqualToString:", *MEMORY[0x1E0CB9AF0]))
    {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_72749 != -1)
    dispatch_once(&logCategory__hmf_once_t17_72749, &__block_literal_global_72750);
  return (id)logCategory__hmf_once_v18_72751;
}
...
- (NSUUID)uuid
{
  ...
  v6 = &OBJC_IVAR___HMDRemoteEventRouterServer__lock;
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v25 = 2112;
      v26 = v14;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@HMDService %@ Accessory UUID is stale (%@!=%@).", buf, 0x2Au);
  ...
  v15 = *(id *)((char *)&self->super.super.isa + v6[223]);
  os_unfair_recursive_lock_unlock();
  return (NSUUID *)v15;
}
...
- (void)populateModelObjectWithChangeType:(id)a3 version:(int64_t)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDService serviceProperties](self, "serviceProperties"));
...
+ (id)generateUUIDWithAccessoryUUID:(id)a3 serviceID:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3A28], "hm_deriveUUIDFromBaseUUID:identifierSalt:withSalts:", v5, 0, v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_readRequiredCharacteristicValuesForceReadFWVersion:(BOOL)a3
{
  ...
  -[HMDService accessory](self, "accessory");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (!objc_msgSend(v5, "hasIPLink")
    || (objc_msgSend(v5, "findServiceWithServiceType:", CFSTR("00000701-0000-1000-8000-0026BB765291")),
        v6 = (void *)objc_claimAutoreleasedReturnValue(),
        v6,
        v6))
  {
    ...
    if (objc_msgSend(v7, "count"))
    {
      ...
      v9 = (void *)MEMORY[0x1D17BA0A0](inited);
      v10 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        -[HMDService serviceType](v10, "serviceType");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        *(_DWORD *)buf = 138543874;
        v26 = v12;
        v27 = 2048;
        ...
        v29 = 2112;
        v30 = v14;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Reading %lu required characteristics for service %@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v9);
      -[HMDService workQueue](v10, "workQueue");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      objc_msgSend(v5, "readCharacteristicValues:source:queue:completionHandler:", v7, 7, v15, v20);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v26 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@No required characteristics to read", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v83 = 2112;
      v84 = v8;
      _os_log_impl(&dword_1CD062000, v71, OS_LOG_TYPE_ERROR, "%{public}@unable to init service with a transaction (null instance ID?): %@", buf, 0x16u);
    ...
    if (!v15->_instanceID)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v46 = 2112;
        v47 = &unk_1E8B33330;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@*** DEBUG THIS : FATAL ERROR : File a Radar : HomeKit | New Bugs *** :Service ID cannot be null for accessory : %@Assigning a default instance ID : %@", buf, 0x20u);
      ...
      v21 = *p_instanceID;
      *p_instanceID = (NSNumber *)&unk_1E8B33330;
...
LABEL_13:
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v50 = 2112;
        v51 = v40;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@HMDService initWithAccessory Service UUID %@ but has a calculated UUID of %@ (%@/%@)", buf, 0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v44 = 2112;
        v45 = v34;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@HMDService initWithAccessory, calculated UUID of %@ (using calc'd value)", buf, 0x16u);
...
- (void)_recalculateUUID
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v31 = 2112;
    v32 = instanceID;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@recalculated UUID of service %@ -> %@ (%@/%@)", buf, 0x34u);
...
- (id)dumpState
{
  ...
  if (objc_msgSend(v9, "hasSuffix:", *MEMORY[0x1E0D16320]))
  {
  ...
  if (v82)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR(", Links: %@"), v12);
  ...
  objc_msgSend(v83, "setObject:forKeyedSubscript:", v96, *MEMORY[0x1E0D27F80]);
  -[HMDService appData](self, "appData");
  v46 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v46, "dumpState");
  v47 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v83, "setObject:forKeyedSubscript:", v47, *MEMORY[0x1E0D27E60]);
  ...
  if (objc_msgSend(v48, "count"))
  {
    ...
    objc_msgSend(v83, "setObject:forKeyedSubscript:", v49, *MEMORY[0x1E0D27E98]);
  }
  -[HMDService bulletinBoardNotification](self, "bulletinBoardNotification");
  v56 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v56)
  {
    ...
    v58 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v83, "setObject:forKeyedSubscript:", v58, *MEMORY[0x1E0D27E90]);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v44 = 2112;
      v45 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Updating application data for: %@ to %@", buf, 0x20u);
...
LABEL_18:
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v44 = 2112;
    v45 = v36;
    _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Attempt to set appData on an accessory %@ service '%@' that is no longer part of a home", buf, 0x20u);
...
- (id)_sanitizeNameToWriteToAccessory:(id)a3
{
  ...
  if (!objc_msgSend(v5, "length"))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v24 = 2112;
      v25 = (uint64_t)v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Name to write to accessory is nil, writing defaultName %@ to the accessory", (uint8_t *)&v22, 0x16u);

    }
    objc_autoreleasePoolPop(v7);
    -[HMDService findCharacteristicWithType:](v8, "findCharacteristicWithType:", *MEMORY[0x1E0CB8818]);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v6, "length") > v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2048;
        v27 = v14;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@DefaultName length %lu larger than accessory supported length %lu - truncating", (uint8_t *)&v22, 0x20u);
...
- (void)_createNotification
{
  ...
  if (-[HMDService _supportsBulletinNotification](self, "_supportsBulletinNotification"))
  {
    ...
    if (!v3)
    {
      v4 = -[HMDBulletinBoardNotification initWithService:]([HMDBulletinBoardNotification alloc], "initWithService:", self);
...
- (void)_shouldServiceBeHidden
{
  ...
  if ((-[HMDService serviceProperties](self, "serviceProperties") & 2) != 0
    || (-[HMDService type](v2, "type"),
        v3 = (void *)objc_claimAutoreleasedReturnValue(),
        v4 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB99A0]),
        v3,
        v4))
  {
  ...
  else
  {
    ...
    if (v6)
    {
      ...
      v17 = v2;
      v8 = *(_QWORD *)v19;
      v9 = *MEMORY[0x1E0CB8968];
      v10 = *MEMORY[0x1E0CB8818];
      while (2)
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          else
          {
            ...
            if ((v15 & 1) == 0 && (objc_msgSend(v12, "properties") & 0x40) == 0)
            {
              v16 = 0;
              goto LABEL_17;
            }
...
LABEL_17:
    ...
    -[HMDService setHidden:](v2, "setHidden:", v16);
  }
}
...
LABEL_7:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Filling provided name with %@ from name characteristic", (uint8_t *)&v15, 0x16u);
...
- (BOOL)isReadingRequiredForBTLEServiceCharacteristic:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "isEqualToString:", *MEMORY[0x1E0CB8968]);
...
LABEL_21:
  ...
  objc_msgSend(v4, "type");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = objc_msgSend(v8, "isEqualToString:", *MEMORY[0x1E0CB8818]);
  ...
  -[HMDService serviceType](self, "serviceType");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v10, "isEqualToString:", *MEMORY[0x1E0CB9A48]) & 1) != 0)
  {
    objc_msgSend(v4, "type");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = objc_msgSend(v11, "isEqualToString:", *MEMORY[0x1E0CB88F8]);
  ...
  -[HMDService serviceType](self, "serviceType");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v13, "isEqualToString:", *MEMORY[0x1E0CB9AF0]) & 1) == 0)
  {
...
- (id)_checkIfDefaultNameChanged
{
  ...
  {
    -[HMDService findCharacteristicWithType:](self, "findCharacteristicWithType:", *MEMORY[0x1E0CB8818]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v9, "supportsWrite") && (!v3 || HMFEqualObjects()))
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v34 = 2112;
        v35 = v5;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Creating run transaction for update of expected configured name '%@' due to defaultName change", buf, 0x16u);
    ...
    objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:destination:payload:", *MEMORY[0x1E0CBAC30], v25, v22);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)nameChangedMessage
{
  ...
  if (v4 && v5)
  {
    ...
    if (v12)
    {
      objc_msgSend(MEMORY[0x1E0D285D0], "nonSPIEntitledMessageWithName:messagePayload:", CFSTR("kServiceRenamedNotificationKey"), v11);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:destination:payload:", CFSTR("kServiceRenamedNotificationKey"), v15, v11);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_9:
  ...
  if (self->_instanceID == (NSNumber *)&unk_1E8B33330)
  {
    v10 = (void *)MEMORY[0x1D17BA0A0]();
    v11 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@*** DEBUG THIS : File a Radar : HomeKit | New Bugs ***: Service dump : [%@]", (uint8_t *)&v15, 0x16u);
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2048;
        v24 = v9;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@[%@] Check if we need to include presence in notification for %@. Interval since last update %lf.", (uint8_t *)&v17, 0x2Au);
...
- (void)updatePresenceRequestTimeForDeviceWithDestination:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[%@] Update presence request time for %@.", (uint8_t *)&v14, 0x20u);
...
- (id)_initWithCoder:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v73 = 2112;
      v74 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@HMDService decoding with uuid %@", buf, 0x16u);
  ...
  if (v14)
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0D28630], "hmf_cachedInstanceForString:", v15);
    v16 = objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBAC80]);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9938]);
    v36 = objc_claimAutoreleasedReturnValue();
    lastKnownOperatingState = v14->_lastKnownOperatingState;
    v14->_lastKnownOperatingState = (NSNumber *)v36;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9930]);
    ...
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9950]);
    v40 = objc_claimAutoreleasedReturnValue();
    mediaSourceIdentifier = v14->_mediaSourceIdentifier;
    v14->_mediaSourceIdentifier = (NSNumber *)v40;

    objc_msgSend(v4, "decodeArrayOfObjectsOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9940]);
    v42 = objc_claimAutoreleasedReturnValue();
    mediaSourceDisplayOrder = v14->_mediaSourceDisplayOrder;
    v14->_mediaSourceDisplayOrder = (NSArray *)v42;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBAC70]);
    v44 = objc_claimAutoreleasedReturnValue();
    labelIndex = v14->_labelIndex;
    v14->_labelIndex = (NSNumber *)v44;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBAC78]);
    v46 = objc_claimAutoreleasedReturnValue();
    labelNamespace = v14->_labelNamespace;
    v14->_labelNamespace = (NSNumber *)v46;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBAC08]);
    v48 = objc_claimAutoreleasedReturnValue();
...
- (void)_encodeWithCoder:(id)a3
{
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x1E0CB9998]);
  ...
  if ((objc_msgSend(v4, "hmd_isForRemoteGatewayCoder") & 1) == 0)
  {
    ...
    else
    {
      ...
      -[HMDService labelIndex](self, "labelIndex");
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "encodeObject:forKey:", v33, *MEMORY[0x1E0CBAC70]);

      -[HMDService labelNamespace](self, "labelNamespace");
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "encodeObject:forKey:", v34, *MEMORY[0x1E0CBAC78]);

      -[HMDService serviceSubtype](self, "serviceSubtype");
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "encodeObject:forKey:", v35, *MEMORY[0x1E0CBAC80]);

      -[HMDService configurationState](self, "configurationState");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      v31 = (__CFString **)MEMORY[0x1E0CBAC08];
    }
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    -[HMDService getConfiguredNameForXPCClients](self, "getConfiguredNameForXPCClients");
    v38 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v38, *MEMORY[0x1E0CBAC20]);
    -[HMDService defaultName](self, "defaultName");
    v39 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v39, *MEMORY[0x1E0CBAC28]);

    -[HMDService serviceSubtype](self, "serviceSubtype");
    v40 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v40, *MEMORY[0x1E0CBAC80]);

    -[HMDService configurationState](self, "configurationState");
    v41 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v41, *MEMORY[0x1E0CBAC08]);
...
LABEL_24:
    ...
    && objc_msgSend(v4, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    ...
    if (v43)
    {
      -[HMDService lastKnownOperatingState](self, "lastKnownOperatingState");
      v44 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "encodeObject:forKey:", v44, *MEMORY[0x1E0CB9938]);
    ...
    if (v45)
    {
      -[HMDService lastKnownOperatingStateAbnormalReasons](self, "lastKnownOperatingStateAbnormalReasons");
      v46 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "encodeObject:forKey:", v46, *MEMORY[0x1E0CB9930]);
  ...
  if (v47)
  {
    -[HMDService mediaSourceIdentifier](self, "mediaSourceIdentifier");
    v48 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v48, *MEMORY[0x1E0CB9950]);
  ...
  if (v50)
  {
    -[HMDService mediaSourceDisplayOrder](self, "mediaSourceDisplayOrder");
    v51 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v51, *MEMORY[0x1E0CB9940]);
  ...
  objc_msgSend(v4, "encodeBool:forKey:", v53, *MEMORY[0x1E0CB9948]);
  -[HMDService findCharacteristicWithType:](self, "findCharacteristicWithType:", *MEMORY[0x1E0CB8818]);
  ...
  if (v54)
    ...
    v56 = 1;
  objc_msgSend(v4, "encodeBool:forKey:", v56, *MEMORY[0x1E0CB9968]);
  if ((objc_msgSend(v4, "hmd_isForXPCTransport") & 1) == 0)
  {
    -[HMDService expectedConfiguredName](self, "expectedConfiguredName");
    v57 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_saveForExpectedConfiguredNameUpdate
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2112;
    v26 = v18;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Creating save transaction for update of configured '%@; and expected configured name '%@'",
      (uint8_t *)&v21,
      0x20u);
...
- (void)_saveForLastSeenConfiguredNameUpdate
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v31 = 2112;
    v32 = v18;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Creating save transaction for update of configured '%@; and lastSeen configured name '%@'",
      buf,
      0x20u);
...
- (void)_saveLastSeenAndExpectedConfiguredName:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)MEMORY[0x1D17BA0A0](-[HMDService setLastSeenConfiguredName:](self, "setLastSeenConfiguredName:", v4));
  v6 = self;
  HMFGetOSLogHandle();
  v7 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating last seen configured (and configured/expected configured name to %@", (uint8_t *)&v10, 0x16u);
  ...
  if ((v25 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v67 = 2112;
      v68 = v63;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Updating expected configured name to %@", buf, 0x16u);
...
- (void)_transactionServiceUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  v150[2] = *MEMORY[0x1E0C80C00];
  v8 = a3;
  v9 = a4;
  v135 = a5;
  objc_msgSend(v135, "transactionResult");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v33)
  {
    ...
    if ((v37 & 1) == 0)
    {
      ...
      v149[0] = CFSTR("kServiceInstanceID");
      -[HMDService instanceID](self, "instanceID");
      v39 = (void *)objc_claimAutoreleasedReturnValue();
      v150[0] = v39;
      v149[1] = *MEMORY[0x1E0CBAC88];
      objc_msgSend(v9, "serviceSubtype");
      v40 = (void *)objc_claimAutoreleasedReturnValue();
      v150[1] = v40;
      ...
      v42 = (void *)MEMORY[0x1E0D285D0];
      v43 = *MEMORY[0x1E0CBAC90];
  ...
  if (v59)
  {
    ...
    if ((v63 & 1) == 0)
    {
      ...
      v147[0] = CFSTR("kServiceInstanceID");
      -[HMDService instanceID](self, "instanceID");
      v65 = (void *)objc_claimAutoreleasedReturnValue();
      v148[0] = v65;
      v147[1] = *MEMORY[0x1E0CBAC10];
      objc_msgSend(v9, "configurationState");
      v66 = (void *)objc_claimAutoreleasedReturnValue();
      v148[1] = v66;
      ...
      v68 = (void *)MEMORY[0x1E0D285D0];
      v69 = *MEMORY[0x1E0CBAC18];
      objc_msgSend(v135, "identifier");
      v70 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v79 = (void *)v78;
    v80 = -[HMDService serviceProperties](self, "serviceProperties");
    objc_msgSend(v9, "serviceProperties");
    v81 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v80 != v82)
    {
      ...
      objc_msgSend(v9, "serviceProperties");
      v83 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDService setServiceProperties:](self, "setServiceProperties:", objc_msgSend(v83, "unsignedIntegerValue"));

      LODWORD(v83) = -[HMDService isPrimary](self, "isPrimary");
      -[HMDService setPrimary:](self, "setPrimary:", -[HMDService serviceProperties](self, "serviceProperties") & 1);
      if ((_DWORD)v83 != -[HMDService isPrimary](self, "isPrimary"))
        objc_msgSend(v134, "updatePrimaryServiceIfNeeded");
      -[HMDService _shouldServiceBeHidden](self, "_shouldServiceBeHidden");
    }
  }
  if (objc_msgSend(v9, "propertyWasSet:", CFSTR("lastKnownOperatingState")))
  {
    ...
    if ((v86 & 1) == 0)
    {
      objc_msgSend(v9, "lastKnownOperatingState");
      v87 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDService setLastKnownOperatingState:](self, "setLastKnownOperatingState:", v87);
  ...
  if (objc_msgSend(v9, "propertyWasSet:", CFSTR("lastKnownOperatingStateAbnormalReasons")))
  {
    ...
    if ((v90 & 1) == 0)
    {
      ...
      -[HMDService setLastKnownOperatingStateAbnormalReasons:](self, "setLastKnownOperatingStateAbnormalReasons:", v91);
  ...
  if (v92)
  {
    ...
    if ((v96 & 1) == 0)
    {
      objc_msgSend(v9, "mediaSourceIdentifier");
      v97 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDService setMediaSourceIdentifier:](self, "setMediaSourceIdentifier:", v97);

      v145[0] = CFSTR("kServiceInstanceID");
      -[HMDService instanceID](self, "instanceID");
      v98 = (void *)objc_claimAutoreleasedReturnValue();
      v146[0] = v98;
      v145[1] = *MEMORY[0x1E0CB9958];
      objc_msgSend(v9, "mediaSourceIdentifier");
      v99 = (void *)objc_claimAutoreleasedReturnValue();
      v146[1] = v99;
      ...
      objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:messagePayload:", *MEMORY[0x1E0CB9960], v100);
      v101 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v104 = objc_msgSend(v103, "isEqualToString:", *MEMORY[0x1E0CB9E38]);
  ...
  v109 = objc_msgSend(v107, "isEqualToArray:", v108);

  if ((v109 & 1) == 0)
  {
    objc_msgSend(v9, "mediaSourceDisplayOrder");
    v110 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDService setMediaSourceDisplayOrder:](self, "setMediaSourceDisplayOrder:", v110);
...
LABEL_45:
  ...
  v143[0] = CFSTR("kServiceInstanceID");
  -[HMDService instanceID](self, "instanceID");
  v111 = (void *)objc_claimAutoreleasedReturnValue();
  v144[0] = v111;
  v143[1] = *MEMORY[0x1E0CB9E30];
  objc_msgSend(v9, "mediaSourceDisplayOrder");
  ...
  objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:messagePayload:", *MEMORY[0x1E0CB9E40], v113);
...
LABEL_49:
  ...
  if (v115)
  {
    ...
    v117 = -[HMDService updateCharacteristics:](self, "updateCharacteristics:", v116);
  ...
  v141 = 0u;
  obj = v102;
  v119 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v138, v142, 16);
  v120 = v135;
  if (v119)
  {
    v121 = v119;
    ...
    do
    {
      for (i = 0; i != v121; ++i)
      {
        if (*(_QWORD *)v139 != v122)
          objc_enumerationMutation(obj);
        v125 = *(void **)(*((_QWORD *)&v138 + 1) + 8 * i);
        dispatch_group_enter(v118);
        if (v120)
        {
          objc_msgSend(v120, "identifier");
          v126 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v125, "setIdentifier:", v126);

        }
        objc_msgSend(v134, "msgDispatcher");
        v127 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v134, "uuid");
        v128 = (void *)objc_claimAutoreleasedReturnValue();
        v136[0] = v123;
        v136[1] = 3221225472;
        v136[2] = __59__HMDService__transactionServiceUpdated_newValues_message___block_invoke;
        v136[3] = &unk_1E89C2730;
        v137 = v118;
        objc_msgSend(v127, "sendMessage:target:andInvokeCompletionHandler:", v125, v128, v136);

        v120 = v135;
      }
      v121 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v138, v142, 16);
    }
    while (v121);
  }

  dispatch_group_wait(v118, 0);
  objc_msgSend(v120, "respondWithPayload:", 0);
  if (group)
...
- (BOOL)updateCharacteristics:(id)a3
{
  ...
  v61 = 0u;
  obj = v4;
  v44 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v58, v64, 16);
  if (v44)
  {
    v40 = 0;
    v41 = *(_QWORD *)v59;
...
LABEL_8:
          ...
          if (!v17)
            goto LABEL_17;
          v40 |= -[HMDCharacteristic updateWithDictionary:](v17, "updateWithDictionary:", v7);
...
LABEL_17:
          v17 = -[HMDCharacteristic initWithCharacteristic:service:accessory:]([HMDCharacteristic alloc], "initWithCharacteristic:service:accessory:", v7, v39, v37);
          encodeRootObjectForIncomingXPCMessage(v17, 0);
          v18 = (void *)objc_claimAutoreleasedReturnValue();
          -[HMDCharacteristic instanceID](v17, "instanceID");
          v19 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v38, "setObject:forKeyedSubscript:", v18, v19);
  ...
  -[HMDService setCharacteristics:](v39, "setCharacteristics:", v43);
  v52 = 0u;
  v53 = 0u;
  v50 = 0u;
  v51 = 0u;
  ...
  if (v21)
  {
    ...
    do
    {
      for (j = 0; j != v22; ++j)
      {
        ...
        v27 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v27, "removeCharacteristic:", v25);
  ...
  {
    objc_msgSend(v28, "setObject:forKey:", v35, CFSTR("kRemovedCharacteristicIDsForAccessoryKey"));
    v29 = 1;
  }
  if (objc_msgSend(v38, "count"))
  {
    objc_msgSend(v28, "setObject:forKey:", v38, CFSTR("kAddedCharacteristicsForAccessoryKey"));
    v29 = 1;
  }
  -[HMDService workQueue](v39, "workQueue");
  v30 = objc_claimAutoreleasedReturnValue();
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __36__HMDService_updateCharacteristics___block_invoke;
  block[3] = &unk_1E89BCF10;
  v46 = v37;
  v47 = v39;
  v48 = v28;
  v31 = v29 & 1;
...
- (BOOL)isEmptyConfiguredNameAllowed
{
  ...
  if (v2)
  {
    ...
    v5 = 0;
    v6 = *(_QWORD *)v19;
    v7 = *MEMORY[0x1E0CB8818];
    v8 = *MEMORY[0x1E0D15F98];
LABEL_3:
    v9 = 0;
    while (1)
    {
...
void __46__HMDService__writeConfiguredNameToAccessory___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (v8)
    {
      ...
      v17 = 2112;
      v18 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to update configured name to %@ - error %@", (uint8_t *)&v13, 0x20u);
  ...
  else
  {
    if (v8)
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully updated configured name and last seen configured name to %@", (uint8_t *)&v13, 0x16u);
...
void __36__HMDService_updateCharacteristics___block_invoke(uint64_t a1)
{
  ...
  if (*(_BYTE *)(a1 + 56) || objc_msgSend(v2, "count"))
  {
    ...
    if ((_os_feature_enabled_impl() & 1) == 0)
    {
      ...
      v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285F8]), "initWithName:destination:payload:", CFSTR("kCharacteristicsUpdatedNotificationKey"), v9, v6);
...
void __66__HMDService__readRequiredCharacteristicValuesForceReadFWVersion___block_invoke(uint64_t a1, void *a2)
{
        ...
        for (i = 0; i != v55; ++i)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v65 = 2112;
            v66 = v12;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Got response %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v64 = v47;
      _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Service or accessory is no more valid", buf, 0xCu);
...
+ (BOOL)_processUpdateOnPowerManagementServiceForCharacteristicType:(id)a3 value:(id)a4 serviceType:(id)a5 accessory:(id)a6 accessoryTransaction:(id)a7
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99768], CFSTR("Invalid service type was passed."), 0);
  ...
  if (!objc_msgSend(v12, "isEqualToString:", CFSTR("00000222-0000-1000-8000-0026BB765291")))
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v60 = 2112;
      v61 = v22;
      _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Parsed supportedSleepConfiguration: %@ with error: %@", buf, 0x20u);
    ...
    objc_msgSend(v16, "setSuspendCapable:", MEMORY[0x1E0C9AAB0]);
...
LABEL_29:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v60 = 2112;
    v61 = v22;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Parsed HMDWakeConfiguration: %@ with error: %@", buf, 0x20u);
  ...
  if (!v22)
  {
    ...
    v46 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v43, "setSuspendCapable:", MEMORY[0x1E0C9AAB0]));
    v47 = v24;
    HMFGetOSLogHandle();
    v48 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v60 = 2112;
      v61 = v43;
      _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_INFO, "%{public}@Setting connectivityInfo %@ to accessory transaction: %@", buf, 0x20u);
...
+ (BOOL)_parseOperatingStateResponseValue:(id)a3 intoState:(id *)a4 abnormalReasons:(id *)a5
{
  ...
  {
    v25 = 0;
    objc_msgSend(MEMORY[0x1E0D16598], "parsedFromData:error:", v8, &v25);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = v25;
    if (v11)
    {
      ...
      if (v13)
      {
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v13, "value"));
        v13 = (void *)objc_claimAutoreleasedReturnValue();
      }
      v15 = *a4;
      *a4 = v13;
      ...
      if (v16)
      {
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v16, "value"));
        v16 = (void *)objc_claimAutoreleasedReturnValue();
      }
      v18 = *a5;
      *a5 = v16;
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v30 = 2112;
    v31 = v12;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse operating state response value %@: %@", buf, 0x20u);
...
void __25__HMDService_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_72751;
  logCategory__hmf_once_v18_72751 = v0;
...
- (id)_serviceSubtypeFromLinkedServicesForServiceType:(id)a3 accessoryCategory:(id)a4
{
  ...
  v23 = *MEMORY[0x1E0C80C00];
  if (!objc_msgSend(a3, "isEqualToString:", *MEMORY[0x1E0CB9A30], a4))
    return 0;
  v20 = 0u;
  v21 = 0u;
  v18 = 0u;
...
LABEL_106:
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 22;
LABEL_19:
        _os_log_impl(&dword_1CD062000, p_super, v27, v25, buf, v28);
            ...
            if (v42)
            {
              ...
              if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v152 = 2112;
                v153 = v38;
                _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_DEBUG, "%{public}@Characteristic (%@) is hidden from apps not sending to siri", buf, 0x16u);
      ...
      if (objc_msgSend(v115, "count"))
      {
        ...
        v52 = objc_alloc(MEMORY[0x1E0C99E08]);
        v148[0] = *MEMORY[0x1E0D88A38];
        ...
        v148[6] = v111;
        v148[7] = v115;
        objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v148, v147, 8);
        v57 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v156 = 2112;
    v157 = v9;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping because one of the properties of service is nil: service.accessory.home %@  service.accessory.home.name %@  service.name %@", buf, 0x2Au);
    if (v11)
