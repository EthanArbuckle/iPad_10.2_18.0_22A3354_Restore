...
- (id)importClipsWithImportData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v116 = 2112;
    v117 = v75;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Importing clips using import data: %@", buf, 0x16u);

    v4 = v75;
  }

  objc_autoreleasePoolPop(v5);
  objc_msgSend(v4, "na_map:", &__block_literal_global_147894);
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    v118 = 2112;
                    v119 = v47;
                    _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_ERROR, "%{public}@Could not load data from %@: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v116 = 2112;
            v117 = v70;
            _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_ERROR, "%{public}@First fragment in clip %@ is not header, skipping", buf, 0x16u);
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_31(id *a1, void *a2)
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v26 = 2112;
      v27 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Loaded %lu bytes of hero frame data from %@", (uint8_t *)&v22, 0x20u);
    ...
    objc_msgSend(a1[6], "addNotificationForSignificantEvent:homePresenceByPairingIdentity:", v16, MEMORY[0x1E0C9AA70]);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = (uint64_t)v21;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Could not load data from %@", (uint8_t *)&v22, 0x16u);
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_37(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Found new video init data: %@", (uint8_t *)&v12, 0x16u);
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_38(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Loaded %lu bytes from %@", (uint8_t *)&v15, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_148022 != -1)
    dispatch_once(&logCategory__hmf_once_t9_148022, &__block_literal_global_41_148023);
  return (id)logCategory__hmf_once_v10_148024;
}
...
void __36__HMDCameraClipImporter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_148024;
  logCategory__hmf_once_v10_148024 = v0;
