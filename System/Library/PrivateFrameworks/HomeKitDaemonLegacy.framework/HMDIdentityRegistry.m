...
- (NSArray)registeredIdentities
{
  ...
  v8 = &v7;
  v9 = 0x3032000000;
  v10 = __Block_byref_object_copy__11135;
  v11 = __Block_byref_object_dispose__11136;
  v12 = 0;
...
- (id)identityForIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    v12 = &v11;
    v13 = 0x3032000000;
    v14 = __Block_byref_object_copy__11135;
    v15 = __Block_byref_object_dispose__11136;
    v16 = 0;
    -[HMDIdentityRegistry lock](self, "lock");
...
- (id)identitiesForDevice:(id)a3
{
  ...
  if (v4)
  {
    ...
    v16 = &v15;
    v17 = 0x3032000000;
    v18 = __Block_byref_object_copy__11135;
    v19 = __Block_byref_object_dispose__11136;
    v20 = 0;
    -[HMDIdentityRegistry lock](self, "lock");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v8 && v9 && v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v30 = 2112;
      v31 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Registering identity, %@, for device, %@, for object: %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v12);
    v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28640]), "initWithObservedObject:", v11);
  ...
  if (v8 && v9 && v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v30 = 2112;
      v31 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Registering identity, %@, for account, %@, for object: %@", buf, 0x2Au);
...
- (id)dumpState
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E08], "dictionaryWithCapacity:", objc_msgSend(v74, "count"));
  ...
  objc_msgSend(MEMORY[0x1E0C99E08], "dictionaryWithCapacity:", objc_msgSend(v75, "count"));
...
uint64_t __28__HMDIdentityRegistry_reset__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v18 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Resetting", buf, 0xCu);
...
void __49__HMDIdentityRegistry_deregisterIdentity_object___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v40 = 2112;
    v41 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Deregistering identity, %@, for object: %@", buf, 0x20u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2112;
    v27 = v17;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Adding identity, %@, for account: %@", buf, 0x20u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2112;
    v27 = v17;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Adding identity, %@, for device: %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t27_11146 != -1)
    dispatch_once(&logCategory__hmf_once_t27_11146, &__block_literal_global_11147);
  return (id)logCategory__hmf_once_v28_11148;
}
...
void __34__HMDIdentityRegistry_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v28_11148;
  logCategory__hmf_once_v28_11148 = v0;
...
void __37__HMDIdentityRegistry_sharedRegistry__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating HMDIdentity Registry", (uint8_t *)&v8, 0xCu);
