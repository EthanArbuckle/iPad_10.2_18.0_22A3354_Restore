...
+ (id)logCategory
{
  if (logCategory__hmf_once_t25_97125 != -1)
    dispatch_once(&logCategory__hmf_once_t25_97125, &__block_literal_global_100_97126);
  return (id)logCategory__hmf_once_v26_97127;
}
...
- (HMDCHIPDataSource)initWithHomeManager:(id)a3
{
  ...
  v9 = objc_alloc(MEMORY[0x1E0D286C8]);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with resident state manager: %@", (uint8_t *)&v16, 0x16u);
...
- (void)configureWithThreadRadioManager:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Configuring with thread radio manager: %@", (uint8_t *)&v17, 0x16u);
  ...
  -[HMDCHIPDataSource notificationCenter](v7, "notificationCenter");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v14, "addObserver:selector:name:object:", v7, sel_handleCurrentWiFiNetworkChangedNotification_, *MEMORY[0x1E0D28538], 0);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v5;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with storage: %@", (uint8_t *)&v17, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v5;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with vendor metadata store: %@", (uint8_t *)&v14, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v5;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with attestation data store: %@", (uint8_t *)&v14, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v5;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with UI dialog presenter: %@", (uint8_t *)&v12, 0x16u);
...
- (id)home
{
  ...
  if (v3)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "na_filter:", &__block_literal_global_97074);
    v6 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v6, "na_firstObjectPassingTest:", &__block_literal_global_83_97075);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = v7;
    if (v7)
    {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          objc_msgSend(v6, "sortedArrayUsingComparator:", &__block_literal_global_85, v23, v24, v25, v26);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
...
- (id)homeWithCHIPFabric:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v17 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Home manager or fabric reference is nil", buf, 0xCu);
...
- (void)handleUpdatedDataWithIsLocalChange:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying CHIP storage of updated home CHIP storage with isLocalChange: %@", (uint8_t *)&v11, 0x16u);

  }
  objc_autoreleasePoolPop(v5);
  -[HMDCHIPDataSource chipStorage](v6, "chipStorage");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "handleUpdatedDataWithIsLocalChange:", v3);
...
- (void)handlePrimaryResidentUpdatedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying CHIP data sources of updated resident state", (uint8_t *)&v11, 0xCu);
...
- (void)handleResidentReachabilityNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v11;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Notifying HomeKitMatter of resident reachability change for Home %@ with fabricID %@", (uint8_t *)&v17, 0x20u);
...
- (void)updateNotificationsEnabled:(BOOL)a3 forHome:(id)a4 keepAliveOnly:(BOOL)a5
{
  ...
  if (v10)
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = objc_msgSend(v13, "isEqualToNumber:", &unk_1E8B33678);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2112;
    v26 = v22;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping notifications as fabricID is %@", (uint8_t *)&v23, 0x16u);
...
- (void)handleHomeCHIPStorageChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Did not find %@ in notification userInfo. Defaulting isLocalChange to %@", (uint8_t *)&v13, 0x20u);
...
- (void)handleHomeRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 138543362;
    v19 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling home removal by notifying CHIP storage", (uint8_t *)&v18, 0xCu);
...
- (NSSet)allPairedHAPServerIdentifiers
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
...
- (NSSet)allFabricIDs
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(v3, "homes");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "na_map:", &__block_literal_global_94_97058);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", (uint8_t *)&v14, 0xCu);
...
- (NSNumber)currentFabricID
{
  ...
  if (v3)
  {
    objc_msgSend(v3, "homes");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "na_filter:", &__block_literal_global_95_97054);
    v6 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v6, "sortedArrayUsingComparator:", &__block_literal_global_96_97055);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", (uint8_t *)&v15, 0xCu);
...
- (id)appleHomeFabricWithID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
...
- (id)appleHomeFabricWithUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 22;
LABEL_15:
      _os_log_impl(&dword_1CD062000, v19, v20, v18, buf, v21);
    ...
    if (v8)
    {
      ...
      while (2)
      {
        for (i = 0; i != v9; ++i)
        {
          ...
          if (v13)
          {
            if ((objc_msgSend(v13, "isEqualToNumber:", &unk_1E8B33678) & 1) == 0)
            {
...
LABEL_17:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@forAllStorageDataSourcesDo: Home manager reference is nil", buf, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Vendor metadata refresh timer fired; fetching vendor metadata from cloud",
        (uint8_t *)&v17,
        0xCu);
  ...
  if (v11 == v4)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Attestation data refresh timer fired; fetching attestation data from cloud",
        (uint8_t *)&v17,
        0xCu);
...
- (void)browser:(id)a3 didRemoveAccessoryPairingWithNodeID:(id)a4
{
              ...
              if (v21)
              {
                ...
                if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v50 = 2112;
                  v51 = v30;
                  _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Found accessory to remove from Apple Home with Matter node ID %@: %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v48 = 2112;
    v49 = v6;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@No accessory found in any homes with matter node id %@", buf, 0x16u);
...
- (void)handleLocationAuthorizationChangedNotification:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      v8 = (void *)MEMORY[0x1D17BA0A0](-[HMDCHIPDataSource setLocationAuthorization:](self, "setLocationAuthorization:", v7));
      v9 = self;
      HMFGetOSLogHandle();
      v10 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 2112;
        v22 = v12;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Location Authorization is changing to %@, stopping thread network", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@No location authorization key in the message", (uint8_t *)&v19, 0xCu);
...
- (void)handleHomeDidLeaveHomeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v11;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@User left home, stopping thread network for fabric ID: %@", (uint8_t *)&v12, 0x16u);
...
- (void)handleHomeDidArriveHomeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v12;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@User arrived home, starting thread network for fabric ID: %@", (uint8_t *)&v13, 0x16u);
...
- (void)unprotectedRegisterForLeaveNotifications:(id)a3
{
  ...
  if (v4 && (v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering for leave notifications.", (uint8_t *)&v16, 0xCu);
...
- (void)unregisterForLeaveNotifications:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering leave notifications.", (uint8_t *)&v10, 0xCu);
...
- (void)unprotectedRegisterForArrivalNotifications:(id)a3
{
  ...
  if (v4 && (v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering for arrival notifications.", (uint8_t *)&v16, 0xCu);
...
- (void)unregisterForArrivalNotifications:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering arrival notifications.", (uint8_t *)&v10, 0xCu);
...
LABEL_5:
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, v11, (uint8_t *)&v21, 0x16u);
    ...
    else
    {
      ...
      if (v12 || !-[HMDCHIPDataSource pnExistsOnCurrentNetwork](self, "pnExistsOnCurrentNetwork") || !v13)
      {
        ...
        if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
        {
          ...
          v29 = 2112;
          v30 = v4;
          _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Denying geo due to presence: %@, location authorization: %@, preferred network: %@ for: %@", (uint8_t *)&v21, 0x34u);
...
LABEL_23:
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, v24, buf, 0xCu);
          ...
          if ((-[HMDCHIPDataSource checkPresenceForHome:](self, "checkPresenceForHome:", v12) & 0xFFFFFFFFFFFFFFFELL) == 2)
          {
            ...
            if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v40 = 2112;
              v41 = v4;
              _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Not calling thread start for home with fabricID: %@ as user is not home", buf, 0x16u);
...
LABEL_31:
        ...
        v29 = (void *)MEMORY[0x1D17BA0A0](-[HMDCHIPDataSource registerForLeaveNotifications:](self, "registerForLeaveNotifications:", v12));
        v30 = self;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v40 = 2112;
          v41 = v4;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Calling thread start for home with fabricID: %@", buf, 0x16u);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v40 = 2112;
    v41 = v4;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v36 = 2112;
            v37 = v4;
            _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Calling thread stop for home with fabricID: %@", buf, 0x16u);
...
- (void)handleThreadBTCallStateChange:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received thread call state change - isInCall = %@", (uint8_t *)&v10, 0x16u);
...
- (void)handleNetworkStateChange
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Received network state change from Thread network event listener", (uint8_t *)&v11, 0xCu);
...
- (void)_getPreferredNetworkExists
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v21 = 1024;
    v22 = v16;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Checking if preferred network exists for SSID: %@ error: %d", buf, 0x1Cu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@No thread network metadata store", buf, 0xCu);
...
- (void)startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v67 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting Thread network for user preferred network with GEO and BR check", buf, 0xCu);
  ...
  if (v51)
  {
    ...
    if (v7)
    {
      ...
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "sortedArrayUsingComparator:", &__block_literal_global_114_96976);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                && -[HMDCHIPDataSource hasValidGeoOrPreferredNetworkForHome:](v54, "hasValidGeoOrPreferredNetworkForHome:", v13))
              {
                ...
                if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v70 = 2112;
                  v71 = v13;
                  _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Is in Geo for home with fabricID %@ - %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v67 = v32;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil - skipping in-geo && matter check", buf, 0xCu);
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v70 = 2112;
      v71 = v39;
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@startThreadRadioForUserPreferredNetwork: isLocationAuthorized = %@. isInGeoForAnyHome = %@", buf, 0x20u);
    ...
    if (((!v50 | v33) & 1) == 0)
    {
      ...
      if (v40)
      {
        if (v44)
        {
          ...
          *(_DWORD *)buf = 138543362;
          v67 = v48;
          _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Not in-geo for any home and no accessories in matter locker, not starting thread", buf, 0xCu);
      ...
      if (v44)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v67 = v45;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Not in-geo for any home and no accessories in matter locker, allowing thread start anyways", buf, 0xCu);
    ...
    v56[1] = 3221225472;
    v56[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_117;
    v56[3] = &unk_1E89B1E90;
...
LABEL_43:
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v67 = v28;
    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@No thread network metadata store", buf, 0xCu);
...
- (void)startThreadRadioForUserPreferredNetwork
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting Thread network for user preferred network", buf, 0xCu);
...
- (void)stopThreadRadioForUserPreferredNetwork
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping Thread network for user preferred network", buf, 0xCu);
...
- (void)stopThreadRadioOnDeviceLock
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping Thread network after device lock", buf, 0xCu);
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = v9;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
...
LABEL_18:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v41 = v29;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@No home associated with network connection state change notification", (uint8_t *)location, 0xCu);
...
- (void)handleThreadNetworkWakeOnConnectionStateChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Event not of type thread wake on connection state changed", (uint8_t *)&v15, 0xCu);
...
- (void)handleThreadNetworkPeripheralDeviceNodeTypeChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Event not of type HMDThreadNetworkPeripheralDeviceNodeTypeEvent", (uint8_t *)&v13, 0xCu);
...
LABEL_20:
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, v25, buf, 0xCu);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2112;
    v35 = v4;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@No home found with fabricID %@", buf, 0x16u);
...
LABEL_20:
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, v32, buf, 0xCu);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v46 = 2112;
    v47 = v11;
    _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
...
- (void)overrideLocationCheckForPairingForFabricID:(id)a3
{
  ...
  if (v4)
  {
    ...
    v5 = (void *)MEMORY[0x1D17BA0A0](-[HMDCHIPDataSource setThreadPairingFabricID:](self, "setThreadPairingFabricID:", v4));
    v6 = self;
    HMFGetOSLogHandle();
    v7 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Allowing thread start for pairing with fabricID: %@", (uint8_t *)&v12, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Not setting pairing override as fabricID is null.", (uint8_t *)&v12, 0xCu);
...
LABEL_23:
    ...
    while (2)
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (v18)
        {
          ...
          v28 = (void *)MEMORY[0x1D17BA0A0](-[HMDCHIPDataSource setThreadPairingFabricID:](self, "setThreadPairingFabricID:", 0));
          v29 = self;
          HMFGetOSLogHandle();
          v30 = objc_claimAutoreleasedReturnValue();
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v42 = 2112;
            v43 = v15;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Setting thread start pairing override to NO for home %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v42 = 2112;
    v43 = v6;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
...
LABEL_29:
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, v31, buf, 0xCu);
...
void __72__HMDCHIPDataSource_stopAccessoryFirmwareUpdateWithFabricID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop thread accessory firmware update, error %@", (uint8_t *)&v8, 0x16u);
...
void __104__HMDCHIPDataSource_startAccessoryFirmwareUpdateWithExtendedMACAddress_fabricID_isWedDevice_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread accessory firmware update with emac %@, error %@", (uint8_t *)&v9, 0x20u);
...
void __65__HMDCHIPDataSource_stopAccessoryPairingWithFabricID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop thread accessory pairing, error %@", (uint8_t *)&v8, 0x16u);
...
void __97__HMDCHIPDataSource_startAccessoryPairingWithExtendedMACAddress_fabricID_isWedDevice_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread accessory pairing with emac %@, error %@", (uint8_t *)&v9, 0x20u);
...
void __86__HMDCHIPDataSource_connectToAccessoryWithExtendedMACAddress_withFabricID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to connect to accessory with emac %@, error %@", (uint8_t *)&v9, 0x20u);
...
void __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
    ...
    if (!v11 || v12)
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 2112;
        v29 = v12;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve operationalDataset for thread network: %@", buf, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v32 = 2112;
        v33 = v11;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Successfully retrieved preferred thread credentials %@ with UUID %@ and operationalDataset %@ from network metadata store", buf, 0x2Au);
      ...
      v24[1] = 3221225472;
      v24[2] = __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke_121;
      v24[3] = &unk_1E89C21C0;
      v24[4] = v15;
      v25 = v10;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", buf, 0xCu);
...
void __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke_121(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to attach to user preferred thread network %@: %@", (uint8_t *)&v12, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Attached to thread network %@", (uint8_t *)&v12, 0x16u);
...
void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_117(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  id WeakRetained;
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      if (!v5 || v6)
      {
        ...
        v19[1] = 3221225472;
        v19[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_118;
        v19[3] = &unk_1E89B1E68;
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Border router present on network - not starting thread", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v17;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Aborting thread start after border router check - thread was started for a home", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", buf, 0xCu);
...
void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_118(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  id v9;
  id v10;
  id v11;
...
LABEL_17:
    ...
    *(_DWORD *)buf = 138543362;
    v43 = v34;
    _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", buf, 0xCu);
LABEL_16:
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v35;
      _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Aborting thread start after getting preferred network - thread was started for a home", buf, 0xCu);
  ...
  if (!v11 || *(_QWORD *)(a1 + 32))
  {
    ...
    if (v16)
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v46 = 2112;
        v47 = v24;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Using cached AOD from home with fabricID %@ - %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v37;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@No cached AOD available as a fallback, aborting thread start", buf, 0xCu);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v48 = 2112;
    v49 = v11;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Successfully retrieved preferred thread credentials %@ with UUID %@ and operationalDataset %@ from network metadata store", buf, 0x2Au);
  ...
  v40[1] = 3221225472;
  v40[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_119;
  v40[3] = &unk_1E89C21C0;
  v40[4] = v27;
  v41 = v10;
...
void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_119(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
...
uint64_t __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v5, "reachableAccessoriesCount"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v4, "reachableAccessoriesCount"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
    ...
    v20 = 138543362;
    v21 = v16;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", (uint8_t *)&v20, 0xCu);
LABEL_10:
  ...
  if (!v11)
  {
    if (v17)
    {
      ...
      v20 = 138543362;
      v21 = v19;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@No thread network found for current Wifi", (uint8_t *)&v20, 0xCu);
  ...
  if (v17)
  {
    ...
    v26 = 2112;
    v27 = v11;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Successfully retrieved preferred thread credentials %@ with UUID %@ and operationalDataset %@ for current network", (uint8_t *)&v20, 0x2Au);
...
void __50__HMDCHIPDataSource__scheduleThreadNetworkRestart__block_invoke(uint64_t a1)
{
  ...
  if (v2 != objc_msgSend(*(id *)(a1 + 32), "networkChangedLastUpdatedTime"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Ignoring Wifi network changed as newer request is queued.", (uint8_t *)&v13, 0xCu);
  ...
  if (!v3)
  {
    if (v7)
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring WiFi network changed notification when Thread is not up", (uint8_t *)&v13, 0xCu);
...
LABEL_12:
  ...
  if (v7)
  {
    ...
    v13 = 138543362;
    v14 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Restarting Thread network for user preferred network upon WiFi network changed notification", (uint8_t *)&v13, 0xCu);
...
void __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v17 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Defaults write set - skipping auth prompt for bridge accessory", buf, 0xCu);
  ...
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v17 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Presenting user with auth prompt for bridge accessory", buf, 0xCu);
    ...
    v14[0] = MEMORY[0x1E0C809B0];
    v14[1] = 3221225472;
    v14[2] = __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke_105;
    v14[3] = &unk_1E89BB130;
    v13 = *(_QWORD *)(a1 + 56);
    v15 = *(id *)(a1 + 64);
...
uint64_t __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke_105(uint64_t a1)
{
...
void __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v17 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Defaults write set - skipping auth prompt for unauthenticated accessory", buf, 0xCu);
  ...
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v17 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Presenting user with auth prompt for unauthenticated accessory", buf, 0xCu);
    ...
    v14[0] = MEMORY[0x1E0C809B0];
    v14[1] = 3221225472;
    v14[2] = __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke_103;
    v14[3] = &unk_1E89BB130;
    v13 = *(_QWORD *)(a1 + 56);
    v15 = *(id *)(a1 + 64);
...
uint64_t __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke_103(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(_QWORD *)(a1 + 32) + 16))();
}
...
void __32__HMDCHIPDataSource_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v26_97127;
  logCategory__hmf_once_v26_97127 = v0;
