...
- (HMDLightProfileNaturalLightingAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9450]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (v6)
    {
      -[HMDAction actionSet](v5, "actionSet");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v8 = objc_msgSend(v4, "decodeBoolForKey:", *MEMORY[0x1E0CB9420]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v30 = 2112;
        v31 = 0;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode, light profile UUID is: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v21;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode base class: %@", buf, 0x16u);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    -[HMDLightProfileNaturalLightingAction lightProfile](self, "lightProfile");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x1E0CB9408]);
  }
  else
  {
    -[HMDLightProfileNaturalLightingAction lightProfileUUID](self, "lightProfileUUID");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB9450]);
  ...
  objc_msgSend(v4, "encodeBool:forKey:", v8, *MEMORY[0x1E0CB9420]);
...
- (id)dictionaryRepresentation
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v6, *MEMORY[0x1E0CB9450]);

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDLightProfileNaturalLightingAction isNaturalLightingEnabled](self, "isNaturalLightingEnabled"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v7, *MEMORY[0x1E0CB9420]);
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v26 = 2112;
        v27 = v9;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling accessory profile update notification: %@, updating light profile to: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v28 = 2112;
      v29 = objc_opt_class();
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory profile update notification: %@ is sent by object: %@ which is not of type %@", buf, 0x2Au);
...
- (HMDLightProfileNaturalLightingAction)initWithModelObject:(id)a3 parent:(id)a4 error:(id *)a5
{
  ...
  void *v23;
  void *v24;
  HMDLightProfileNaturalLightingAction *v25;
  ...
  if (v12)
  {
    ...
    if (v15)
    {
      ...
      if (v16)
      {
        ...
        objc_msgSend(v39, "lightProfileWithUUID:", v16);
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        if (v18)
        {
          if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v43 = 2112;
            v44 = v18;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Creating natural lighting action with action model with light profile: %@", buf, 0x16u);

          }
          objc_autoreleasePoolPop(v19);
          objc_msgSend(v12, "uuid");
          v24 = (void *)objc_claimAutoreleasedReturnValue();
          v25 = -[HMDLightProfileNaturalLightingAction initWithUUID:lightProfileUUID:naturalLightingEnabled:actionSet:](v20, "initWithUUID:lightProfileUUID:naturalLightingEnabled:actionSet:", v24, v16, objc_msgSend(v12, "isNaturalLightingEnabled"), v15);

          -[HMDLightProfileNaturalLightingAction setLightProfile:](v25, "setLightProfile:", v18);
          v20 = v25;
          v26 = v20;
        }
        else
        {
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v43 = 2112;
            v44 = v16;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to create action, home doesn't have a light profile with UUID: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v43 = 2112;
          v44 = 0;
          _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to create action, model is missing light profile UUID: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v45 = 2112;
        v46 = objc_opt_class();
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to create action, model's parent is of invalid class %@:%@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v45 = 2112;
      v46 = objc_opt_class();
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to create action, model is of invalid class %@:%@", buf, 0x20u);
...
- (id)modelObjectWithChangeType:(unint64_t)a3 version:(int64_t)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 2112;
      v38 = 0;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create model object for change type:%lu missing actionSet: %@", (uint8_t *)&v33, 0x20u);
  ...
  if (v14)
  {
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = v18;
    v20 = &__block_literal_global_68623;
LABEL_11:
  ...
  if (v26)
  {
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = v18;
    v20 = &__block_literal_global_25_68624;
    goto LABEL_11;
  }
LABEL_12:
        ...
        if (v19)
        {
          ...
          if (v23)
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v60 = 2112;
            v61 = v26;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating natural lighting enabled from %@ to %@", buf, 0x20u);
          ...
          v10 = v52;
          v32 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v52, "respondWithPayload:", v31));
          v33 = v21;
          HMFGetOSLogHandle();
          v34 = objc_claimAutoreleasedReturnValue();
          if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v58 = 2112;
            v59 = (uint64_t)v31;
            _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Responding to client after updating action with response %@", buf, 0x16u);
        ...
        else
        {
          if (v23)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v58 = 2112;
            v59 = (uint64_t)v50;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Ignoring update naturalLightingEnabledField property is not set: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v60 = 2112;
          v61 = 0;
          _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to update action, action set missing home %@:%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v58 = 2112;
        v59 = 0;
        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to update action, missing action set: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v60 = 2112;
      v61 = v11;
      _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Ignoring update from object of unhandled type %@:%@", buf, 0x20u);
...
+ (id)actionWithDictionaryRepresentation:(id)a3 actionSet:(id)a4
{
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v27 = 2112;
        v28 = v8;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Failed to create natural lighting action with dictionary representation and action set %@:%@", (uint8_t *)&v23, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = 0;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to create natural lighting action with dictionary representation, action set missing home %@:%@", (uint8_t *)&v23, 0x20u);
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Failed to create natural lighting action with dictionary representation mising key %@:%@", buf, 0x20u);
  ...
  if (objc_msgSend(v12, "integerValue") != 3)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v41 = 2112;
      v42 = v27;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Failed to create natural lighting action with dictionary representation invalid action type %@:%@", buf, 0x20u);
...
LABEL_16:
  ...
  v14 = (const __CFString *)*MEMORY[0x1E0CB9450];
  objc_msgSend(v6, "hmf_UUIDForKey:", *MEMORY[0x1E0CB9450]);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v15)
  {
    ...
    if (v16)
    {
      v17 = -[HMDLightProfileNaturalLightingAction initWithUUID:lightProfileUUID:naturalLightingEnabled:actionSet:]([HMDLightProfileNaturalLightingAction alloc], "initWithUUID:lightProfileUUID:naturalLightingEnabled:actionSet:", v11, v15, objc_msgSend(v6, "hmf_BOOLForKey:", *MEMORY[0x1E0CB9420]), 0);
      context = (void *)MEMORY[0x1D17BA0A0](-[HMDLightProfileNaturalLightingAction setLightProfile:](v17, "setLightProfile:", v16));
      v18 = a1;
      HMFGetOSLogHandle();
      v19 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Created natural lighting action with dictionary representation %@:%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v39 = 2112;
        v40 = v15;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Failed to create natural lighting action with dictionary representation light profile with UUID does not exisit: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v41 = 2112;
      v42 = v14;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Failed to create natural lighting action with dictionary representation missing key %@:%@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t31 != -1)
    dispatch_once(&logCategory__hmf_once_t31, &__block_literal_global_29_68658);
