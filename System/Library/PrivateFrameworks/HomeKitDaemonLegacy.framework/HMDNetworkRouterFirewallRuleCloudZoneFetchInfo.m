...
- (HMDNetworkRouterFirewallRuleCloudZoneFetchInfo)initWithOptions:(id)a3 changeToken:(id)a4 promise:(id)a5 database:(id)a6 useAnonymousRequests:(BOOL)a7 interestedRecordIDs:(id)a8 mirrorInput:(id)a9
{
  ...
  v28 = a8;
  v27 = a9;
  v16 = (objc_class *)MEMORY[0x1E0D28540];
  v17 = a6;
  v18 = a5;
  v19 = a3;
  v20 = [v16 alloc];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_136545 != -1)
    dispatch_once(&logCategory__hmf_once_t0_136545, &__block_literal_global_136546);
  return (id)logCategory__hmf_once_v1_136547;
}
...
void __61__HMDNetworkRouterFirewallRuleCloudZoneFetchInfo_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_136547;
  logCategory__hmf_once_v1_136547 = v0;
