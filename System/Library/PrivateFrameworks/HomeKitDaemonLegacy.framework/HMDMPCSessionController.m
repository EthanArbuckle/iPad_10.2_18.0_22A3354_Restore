...
- (void)executeSessionWithSessionData:(id)a3 completion:(id)a4
{
  ...
  v6 = a3;
  obj = a4;
  v84 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("HMDMPCSessionCreation"));
  v82 = self;
  v80 = v6;
  if (self)
  {
    ...
    objc_msgSend(v8, "na_map:", &__block_literal_global_185097);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v117 = 2112;
    v118 = v78;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Running MPC media session with sessionUUID: %@", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)v111 = 138543618;
                ...
                v113 = 2112;
                v114 = v23;
                _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Nil hashed route id for media profile: %@", v111, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)v111 = 138543618;
              ...
              v113 = 2112;
              v114 = v23;
              _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@No hashed route id for media profile: %@", v111, 0x16u);
  ...
  {
LABEL_36:
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 8, CFSTR("No action to take or hashed routes"));
...
LABEL_35:
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 3, CFSTR("Volume or state invalid"));
      v45 = objc_claimAutoreleasedReturnValue();
LABEL_37:
      v46 = (void *)v45;
      goto LABEL_48;
...
void __68__HMDMPCSessionController_executeSessionWithSessionData_completion___block_invoke_2(id *a1, void *a2)
{
  ...
  if (v57)
  {
    ...
    *(_QWORD *)&aBlock[16] = __138__HMDMPCSessionController_generateMRCommandOperationsForDestination_playbackArchive_playbackVolumeNumber_playbackStateNumber_sessionUUID___block_invoke;
    ...
    location[0] = *(id *)MEMORY[0x1E0D4CBB8];
    objc_msgSend(v12, "UUIDString");
    v16 = (void *)objc_claimAutoreleasedReturnValue();

    location[1] = *(id *)MEMORY[0x1E0D4CB98];
    *(_QWORD *)&v64 = v16;
    *((_QWORD *)&v64 + 1) = MEMORY[0x1E0C9AAB0];
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v64, location, 2);
...
LABEL_20:
      ...
      if (val)
      {
        v45 = objc_alloc_init(MEMORY[0x1E0D28550]);
    ...
    if ((unint64_t)(v22 - 1) >= 3)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)&buf[14] = v22;
        v35 = (void *)v34;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Unknown HMMediaPlaybackState: %ld", buf, 0x16u);
    ...
    {
      v23 = dword_1CDB8FB78[v22 - 1];
      if (v8)
      {
LABEL_10:
        objc_msgSend(MEMORY[0x1E0D4B338], "nowPlayingApplicationDestination", context);
...
LABEL_18:
  ...
  v25 = a1;
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 2, CFSTR("MPC Session Creation Failed, Unable to resolve destination"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = (void *)MEMORY[0x1D17BA0A0]();
  v28 = val;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_QWORD *)&aBlock[14] = v31;
    _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@MPC Session Creation Failed, Unable to resolve destination for sessionUUID: %@", aBlock, 0x16u);
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v43 = 2112;
            v44 = v24;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@MPC Session Creation Failed at Command (%@) : %@", buf, 0x20u);
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v43 = 2112;
              v44 = v31;
              _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@MPC Session Creation Failed at Command (%@) : partial success %@", buf, 0x20u);
...
LABEL_23:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v40 = v19;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@MPC Session Created Successfully", buf, 0xCu);
