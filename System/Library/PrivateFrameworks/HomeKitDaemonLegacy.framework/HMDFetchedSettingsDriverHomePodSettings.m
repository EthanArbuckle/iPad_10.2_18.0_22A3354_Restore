...
- (void)fetchSettingsForKeyPaths:(id)a3 completion:(id)a4
{
  ...
  v28[1] = v28;
  v28[2] = 0x3032000000;
  v28[3] = __Block_byref_object_copy__4886;
  v28[4] = __Block_byref_object_dispose__4887;
  v29 = (id)MEMORY[0x1E0C9AA60];
  v26[0] = 0;
  v26[1] = v26;
  v26[2] = 0x3032000000;
  v26[3] = __Block_byref_object_copy__4886;
  v26[4] = __Block_byref_object_dispose__4887;
  v27 = 0;
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v32 = 2112;
      v33 = v6;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Fetching settings using local api keyPaths: %@", buf, 0x16u);
...
- (void)updateSettingWithKeyPath:(id)a3 languageSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v33 = 2112;
    v34 = v9;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v9;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", buf, 0x16u);
...
- (void)updateSettingWithKeyPath:(id)a3 BOOLSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v27 = 2112;
    v28 = v9;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@", (uint8_t *)&v23, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v9;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", (uint8_t *)&v23, 0x16u);
...
- (void)updateSettingWithKeyPath:(id)a3 integerSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v33 = 2112;
    v34 = v19;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@ (integer value: %@)", (uint8_t *)&v27, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2112;
      v30 = v9;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", (uint8_t *)&v27, 0x16u);
...
- (void)updateSettingWithKeyPath:(id)a3 primaryUserInfo:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v28 = 2112;
    v29 = v9;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating Primary User setting %{public}@ to %@", (uint8_t *)&v24, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v9;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", (uint8_t *)&v24, 0x16u);
...
- (id)_transformToImmutableSetting:(id)a3
{
  ...
  {
    v6 = v5;
    v7 = objc_alloc(MEMORY[0x1E0CBA368]);
  ...
  else
  {
    if (+[HMDHPSAPIConformanceProviding objectRespondsToHPSConstrainedNumberSettingProtocolMethods:](HMDHPSAPIConformanceProviding, "objectRespondsToHPSConstrainedNumberSettingProtocolMethods:", v4))
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        v55 = 2048;
        v56 = v25;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Transform constrained number setting (after scaling up) with value: %ld, max: %ld, min: %ld, step: %ld", (uint8_t *)&v47, 0x34u);

      }
      objc_autoreleasePoolPop(v26);
      v30 = objc_alloc(MEMORY[0x1E0CBA370]);
      objc_msgSend(v6, "keyPath");
    ...
    if (!+[HMDHPSAPIConformanceProviding objectRespondsToHPSSiriAvailableLanguagesProtocolMethods:](HMDHPSAPIConformanceProviding, "objectRespondsToHPSSiriAvailableLanguagesProtocolMethods:", v4)|| (objc_msgSend(v4, "keyPath"), v32 = (void *)objc_claimAutoreleasedReturnValue(), v33 = objc_msgSend(v32, "isEqual:", CFSTR("root.siri.availableLanguages")), v32, !v33)|| (v34 = v4) == 0)
    {
      if (+[HMDHPSAPIConformanceProviding objectRespondsToHPSSiriLanguageSettingProtocolMethods:](HMDHPSAPIConformanceProviding, "objectRespondsToHPSSiriLanguageSettingProtocolMethods:", v4))
      {
        ...
        if (v6)
        {
          if (v38)
          {
            v39 = objc_alloc(MEMORY[0x1E0CBA5A8]);
            objc_msgSend(v6, "keyPath");
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            v47 = 138543362;
            v48 = v45;
            _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, "%{public}@Nil Language Value", (uint8_t *)&v47, 0xCu);
    ...
    v6 = v34;
    v35 = objc_alloc(MEMORY[0x1E0CBA5B0]);
    objc_msgSend(v6, "keyPath");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_transformPreferredMediaUserEvent:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA258]), "initWithUUIDString:selectionType:", v5, v5 != 0);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Transform hpSetting to primaryUserInfo: %@", (uint8_t *)&v12, 0x16u);
...
- (void)_readSettingsAtKeyPaths:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v21 = 2112;
    v22 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch setting keyPaths: %{public}@ on service: %@", buf, 0x20u);
...
- (void)_processReadResults:(id)a3 error:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v49 = 2112;
    v50 = v9;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Fetched settings: %@, error: %@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v47 = 2112;
              v48 = v24;
              _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Returned value %@ not of expected type.", buf, 0x16u);
...
- (void)_writeSetting:(id)a3 keyPath:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2112;
    v27 = v8;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Updating %{public}@ to %@", buf, 0x20u);
...
void __83__HMDFetchedSettingsDriverHomePodSettings_serviceDidInitializeForCurrentAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@homepod settings did initialize", (uint8_t *)&v7, 0xCu);
...
void __55__HMDFetchedSettingsDriverHomePodSettings_didReconnect__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@homepod settings did reconnect", (uint8_t *)&v7, 0xCu);
...
void __71__HMDFetchedSettingsDriverHomePodSettings_didUpdateSetting_forKeyPath___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v27 = 2112;
      v28 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Got primaryUserInfo update for keyPath: %{public}@, %@", (uint8_t *)&v23, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v25 = 2114;
      v26 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Got Setting Update for keyPath: %{public}@", (uint8_t *)&v23, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v22;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Unable to transform %@ to immutable setting", (uint8_t *)&v23, 0x16u);
...
void __76__HMDFetchedSettingsDriverHomePodSettings__writeSetting_keyPath_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Update %{public}@ completion error: %@", (uint8_t *)&v12, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_4893 != -1)
    dispatch_once(&logCategory__hmf_once_t0_4893, &__block_literal_global_4894);
  return (id)logCategory__hmf_once_v1_4895;
}
...
void __54__HMDFetchedSettingsDriverHomePodSettings_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_4895;
  logCategory__hmf_once_v1_4895 = v0;
