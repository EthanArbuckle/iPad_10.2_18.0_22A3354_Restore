  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Accessory or home is nil", buf, 0xCu);
...
- (void)sendDoorbellChimeMessageWithChimeMode:(int64_t)a3 chimeDate:(id)a4 personIdentificationText:(id)a5
{
        ...
        if (v18)
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v49 = 2112;
            v50 = v9;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Ignoring chime (mode: %ld) that is duplicate of previous chime, date: %@, text %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (v30)
    {
      ...
      v41 = (void *)v33;
      v35 = -[HMDRemoteMessage initWithName:destination:payload:](v34, "initWithName:destination:payload:", *MEMORY[0x1E0CB8C50], v33, v23);
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v45 = 2112;
        v46 = (int64_t)v39;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying remote device to chime - %@", buf, 0x16u);
...
- (void)handleDoorbellChimeMessage:(id)a3
{
  ...
  if (v7)
  {
    if ((objc_msgSend(v7, "isCurrentAccessory") & 1) != 0)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = *MEMORY[0x1E0CB8C58];
      objc_msgSend(v8, "hmf_numberForKey:", *MEMORY[0x1E0CB8C58]);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v9, "setObject:forKeyedSubscript:", v11, v10);

      v12 = *MEMORY[0x1E0CB8C48];
      objc_msgSend(v8, "hmf_dateForKey:", *MEMORY[0x1E0CB8C48]);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v9, "setObject:forKeyedSubscript:", v13, v12);

      v14 = *MEMORY[0x1E0CB8C60];
      objc_msgSend(v8, "hmf_stringForKey:", *MEMORY[0x1E0CB8C60]);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v9, "setObject:forKeyedSubscript:", v15, v14);

      v16 = objc_alloc(MEMORY[0x1E0D285D0]);
      v17 = *MEMORY[0x1E0CB8C50];
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v34 = 2112;
        v35 = v26;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying framework to chime on current accessory - %@", (uint8_t *)&v32, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v32 = 138543362;
        v33 = v31;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Asked to chime on non-current accessory", (uint8_t *)&v32, 0xCu);
...
- (id)doorbellMessagePayloadWithChimeMode:(int64_t)a3 chimeDate:(id)a4 personIdentificationText:(id)a5
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "setObject:forKeyedSubscript:", v11, *MEMORY[0x1E0CB8C58]);

  objc_msgSend(v10, "setObject:forKeyedSubscript:", v9, *MEMORY[0x1E0CB8C48]);
  objc_msgSend(v10, "setObject:forKeyedSubscript:", v8, *MEMORY[0x1E0CB8C60]);
