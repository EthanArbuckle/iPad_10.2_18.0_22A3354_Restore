...
- (HMDHomePodSetupLatencyLogEvent)initWithSessionSetupOpenMS_HH1:(int64_t)a3 controllerKeyExchangeMS_HH1:(int64_t)a4 newAccessoryTransferMS_HH1:(int64_t)a5 sessionSetupCloseMS_HH1:(int64_t)a6 sentinelZoneFetchMS_HH1:(int64_t)a7 totalDurationMS_HH1:(int64_t)a8 accountSettleWaitMS_HH2:(int64_t)a9 currentDeviceIDSWaitMS_HH2:(int64_t)a10 homeManagerReadyMS_HH2:(int64_t)a11 firstCoreDataImportMS_HH2:(int64_t)a12 accessoryAddMS_HH2:(int64_t)a13 settingsCreationMS_HH2:(int64_t)a14 pairingIdentityCreationMS_HH2:(int64_t)a15 siriReadyMS_HH2:(int64_t)a16 eventRouterServerConnectionMS_HH2:(int64_t)a17 primaryResidentElectionMS_HH2:(int64_t)a18 eventRouterFirstEventPushMS_HH2:(int64_t)a19 totalDurationMS_HH2:(int64_t)a20 iCloudAvailable_INT:(BOOL)a21 IDSAvailable_INT:(BOOL)a22 manateeAvailable_INT:(BOOL)a23 networkAvailable_INT:(BOOL)a24 controllerInHH2_INT:(BOOL)a25 controllerHasSentinelZone_INT:(BOOL)a26 errorCode:(int64_t)a27 errorDomain:(id)a28 underlyingErrorCode:(int64_t)a29 underlyingErrorDomain:(id)a30 errorStage_String:(id)a31 setupSessionIdentifier:(id)a32 numberOfTimesPrimaryResidentChanged_HH2:(unsigned int)a33 lastPrimaryClientConnectedTime_HH2:(int64_t)a34 numberOfTimesPrimaryClientConnected_HH2:(unsigned int)a35 numberOfTimesPrimaryClientDisconnected_HH2:(unsigned int)a36 numberOfTimesPrimaryClientConnectMessageFailed_HH2:(unsigned int)a37 currentDeviceConfirmedPrimaryResident_INT:(BOOL)a38 lastPrimaryClientConnectMessageFailErrorCode_HH2:(int64_t)a39 lastPrimaryClientConnectMessageFailErrorDomain_HH2:(id)a40 lastPrimaryClientConnectMessageFailUnderlyingErrorCode_HH2:(int64_t)a41 lastPrimaryClientConnectMessageFailUnderlyingErrorDomain_HH2:(id)a42 primaryResidentElectionPeerDeviceFutureResolvedMS_HH2:(int64_t)a43 primaryResidentElectionFirstCloudKitImportFutureResolvedMS_HH2:(int64_t)a44 primaryResidentElectionModernTransportStartedFutureResolvedMS_HH2:(int64_t)a45 primaryResidentSelectionConnectedToStatusKitFutureResolvedMS_HH2:(int64_t)a46 primaryResidentElectionJoinMeshMS_HH2:(int64_t)a47 firstCoreDataContainerSetupDurationMS_HH2:(int64_t)a48 firstCoreDataContainerSetupErrorCode_HH2:(int64_t)a49 firstCoreDataContainerSetupErrorDomain_HH2:(id)a50 firstCoreDataContainerSetupUnderlyingErrorCode_HH2:(int64_t)a51 firstCoreDataContainerSetupUnderlyingErrorDomain_HH2:(id)a52 savedEventState:(unint64_t)a53
{
  ...
  if (v56)
  {
    ...
    if (v55)
    {
      if (v73)
      {
        objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", v73, a29, 0);
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", v55, a27, v59);
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent sessionSetupOpenMS_HH1](self, "sessionSetupOpenMS_HH1"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("sessionSetupOpenMS_HH1"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent controllerKeyExchangeMS_HH1](self, "controllerKeyExchangeMS_HH1"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("controllerKeyExchangeMS_HH1"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent newAccessoryTransferMS_HH1](self, "newAccessoryTransferMS_HH1"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("newAccessoryTransferMS_HH1"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent sessionSetupCloseMS_HH1](self, "sessionSetupCloseMS_HH1"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("sessionSetupCloseMS_HH1"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent sentinelZoneFetchMS_HH1](self, "sentinelZoneFetchMS_HH1"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("sentinelZoneFetchMS_HH1"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent totalDurationMS_HH1](self, "totalDurationMS_HH1"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("totalDurationMS_HH1"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent accountSettleWaitMS_HH2](self, "accountSettleWaitMS_HH2"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, CFSTR("accountSettleWaitMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent currentDeviceIDSWaitMS_HH2](self, "currentDeviceIDSWaitMS_HH2"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v11, CFSTR("currentDeviceIDSWaitMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent homeManagerReadyMS_HH2](self, "homeManagerReadyMS_HH2"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("homeManagerReadyMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent firstCoreDataImportMS_HH2](self, "firstCoreDataImportMS_HH2"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v13, CFSTR("firstCoreDataImportMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent accessoryAddMS_HH2](self, "accessoryAddMS_HH2"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v14, CFSTR("accessoryAddMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent settingsCreationMS_HH2](self, "settingsCreationMS_HH2"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v15, CFSTR("settingsCreationMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent pairingIdentityCreationMS_HH2](self, "pairingIdentityCreationMS_HH2"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v16, CFSTR("pairingIdentityCreationMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent siriReadyMS_HH2](self, "siriReadyMS_HH2"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v17, CFSTR("siriReadyMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent eventRouterServerConnectionMS_HH2](self, "eventRouterServerConnectionMS_HH2"));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v18, CFSTR("eventRouterServerConnectionMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent primaryResidentElectionMS_HH2](self, "primaryResidentElectionMS_HH2"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v19, CFSTR("primaryResidentElectionMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent eventRouterFirstEventPushMS_HH2](self, "eventRouterFirstEventPushMS_HH2"));
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v20, CFSTR("eventRouterFirstEventPushMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent totalDurationMS_HH2](self, "totalDurationMS_HH2"));
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v21, CFSTR("totalDurationMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomePodSetupLatencyLogEvent iCloudAvailable_INT](self, "iCloudAvailable_INT"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v22, CFSTR("iCloudAvailable_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomePodSetupLatencyLogEvent IDSAvailable_INT](self, "IDSAvailable_INT"));
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v23, CFSTR("IDSAvailable_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomePodSetupLatencyLogEvent IDSRegistrationStatus_INT](self, "IDSRegistrationStatus_INT"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v24, CFSTR("IDSRegistrationStatus_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomePodSetupLatencyLogEvent IDSRegistrationError_INT](self, "IDSRegistrationError_INT"));
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v25, CFSTR("IDSRegistrationError_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomePodSetupLatencyLogEvent manateeAvailable_INT](self, "manateeAvailable_INT"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v26, CFSTR("manateeAvailable_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomePodSetupLatencyLogEvent networkAvailable_INT](self, "networkAvailable_INT"));
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v27, CFSTR("networkAvailable_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomePodSetupLatencyLogEvent controllerInHH2_INT](self, "controllerInHH2_INT"));
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v28, CFSTR("controllerInHH2_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomePodSetupLatencyLogEvent controllerHasSentinelZone_INT](self, "controllerHasSentinelZone_INT"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[HMDHomePodSetupLatencyLogEvent numberOfTimesPrimaryResidentChanged_HH2](self, "numberOfTimesPrimaryResidentChanged_HH2"));
  v33 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v33, CFSTR("numberOfTimesPrimaryResidentChanged"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDHomePodSetupLatencyLogEvent lastPrimaryClientConnectedTime_HH2](self, "lastPrimaryClientConnectedTime_HH2"));
  v34 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v34, CFSTR("lastPrimaryClientConnectedTime"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[HMDHomePodSetupLatencyLogEvent numberOfTimesPrimaryClientConnected_HH2](self, "numberOfTimesPrimaryClientConnected_HH2"));
  v35 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v35, CFSTR("numberOfTimesPrimaryClientConnected"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[HMDHomePodSetupLatencyLogEvent numberOfTimesPrimaryClientDisconnected_HH2](self, "numberOfTimesPrimaryClientDisconnected_HH2"));
  v36 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v36, CFSTR("numberOfTimesPrimaryClientDisconnected"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", -[HMDHomePodSetupLatencyLogEvent numberOfTimesPrimaryClientConnectMessageFailed_HH2](self, "numberOfTimesPrimaryClientConnectMessageFailed_HH2"));
  v37 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v37, CFSTR("numberOfTimesPrimaryClientConnectMessageFailed"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomePodSetupLatencyLogEvent currentDeviceConfirmedPrimaryResident_INT](self, "currentDeviceConfirmedPrimaryResident_INT"));
  v38 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v38, CFSTR("currentDeviceConfirmedPrimaryResident_INT"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomePodSetupLatencyLogEvent lastPrimaryClientConnectMessageFailErrorCode_HH2](self, "lastPrimaryClientConnectMessageFailErrorCode_HH2"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomePodSetupLatencyLogEvent lastPrimaryClientConnectMessageFailUnderlyingErrorCode_HH2](self, "lastPrimaryClientConnectMessageFailUnderlyingErrorCode_HH2"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent primaryResidentElectionPeerDeviceFutureResolvedMS_HH2](self, "primaryResidentElectionPeerDeviceFutureResolvedMS_HH2"));
  v43 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v43, CFSTR("primaryResidentElectionPeerDeviceFutureResolvedMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent primaryResidentElectionFirstCloudKitImportFutureResolvedMS_HH2](self, "primaryResidentElectionFirstCloudKitImportFutureResolvedMS_HH2"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent primaryResidentElectionModernTransportStartedFutureResolvedMS_HH2](self, "primaryResidentElectionModernTransportStartedFutureResolvedMS_HH2"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent primaryResidentSelectionConnectedToStatusKitFutureResolvedMS_HH2](self, "primaryResidentSelectionConnectedToStatusKitFutureResolvedMS_HH2"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent primaryResidentElectionJoinMeshMS_HH2](self, "primaryResidentElectionJoinMeshMS_HH2"));
  v47 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v47, CFSTR("primaryResidentElectionJoinMeshMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", -[HMDHomePodSetupLatencyLogEvent firstCoreDataContainerSetupDurationMS_HH2](self, "firstCoreDataContainerSetupDurationMS_HH2"));
  v48 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v48, CFSTR("firstCoreDataContainerSetupDurationMS_HH2"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomePodSetupLatencyLogEvent firstCoreDataContainerSetupErrorCode_HH2](self, "firstCoreDataContainerSetupErrorCode_HH2"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomePodSetupLatencyLogEvent firstCoreDataContainerSetupUnderlyingErrorCode_HH2](self, "firstCoreDataContainerSetupUnderlyingErrorCode_HH2"));
