...
- (HMDDeviceNotificationUpdate)initWithRequestID:(id)a3
{
  ...
  v6 = -[HMDDeviceNotificationUpdate init](&v15, sel_init);
  v7 = v6;
  if (v6)
  {
...
- (NSArray)mediaProperties
{
  ...
  p_lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  -[NSMutableDictionary na_flatMap:](self->_updatedMediaPropertiesByMediaProfile, "na_flatMap:", &__block_literal_global_206_159082);
...
- (NSArray)completions
{
  ...
  if (!notificationsCompletions)
    notificationsCompletions = (NSMutableArray *)MEMORY[0x1E0C9AA60];
...
void __95__HMDDeviceNotificationUpdate_updateWithCharacteristicUpdates_notificationUpdateID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v11 = 2112;
      v12 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Overriding the existing changed characteristic: %@ to send notifications", (uint8_t *)&v9, 0x16u);
