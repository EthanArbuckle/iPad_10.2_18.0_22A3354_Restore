...
+ (id)errorWithSQLite3Context:()sqlite3
{
  ...
  v11[1] = CFSTR("text");
  v12[0] = v6;
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", sqlite3_errmsg(db));
...
+ (id)errorWithSQLite3Statement:()sqlite3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", sqlite3_sql(a3));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v17[2] = v12;
