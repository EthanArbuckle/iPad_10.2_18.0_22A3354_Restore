...
- (id)dumpState
{
  ...
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v21, *MEMORY[0x1E0D27F90]);
  return v4;
}
...
- (void)configure:(id)a3 messageDispatcher:(id)a4 queue:(id)a5
{
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v19;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Null timerID -- initializing with %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v35 = 2080;
    v36 = v27;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Configuring with firedate %@ and timezone %@ for %s", buf, 0x2Au);
...
- (void)timerTriggered
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Timer Triggered", buf, 0xCu);
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating the trigger", buf, 0xCu);
...
- (void)_startTimerWithFireDate:(id)a3
{
  ...
  if (v6 <= 0.0)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Revised Next Fire Date %@", (uint8_t *)&v20, 0x16u);
  ...
  v15 = (void *)MEMORY[0x1D17BA0A0](v5);
  v16 = self;
  HMFGetOSLogHandle();
  v17 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v19;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Next fire date %@", (uint8_t *)&v20, 0x16u);
...
- (void)_startTimer:(id)a3
{
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v31 = 2112;
          v32 = v8;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to start timer %@ with error %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v29 = 2112;
        v30 = v18;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Trigger %@ not activated on local device - skipping scheduling the trigger", buf, 0x16u);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v31 = 2112;
    v32 = v25;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@%@/%@: Home reference is nil", buf, 0x20u);
...
- (id)_serializeForAdd
{
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("kTimerTriggerResetTimeZoneDataKey"));
  }
  -[HMDTimerTrigger fireRepeatInterval](self, "fireRepeatInterval");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("kTimerTriggerResetRecurrenceDataKey"));
  }
  -[HMDTimerTrigger recurrences](self, "recurrences");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("kTimerTriggerResetRecurrencesKey"));
  }
  -[HMDTimerTrigger significantEvent](self, "significantEvent");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("kTimerTriggerResetSignificantEventKey"));
  }
  -[HMDTimerTrigger significantEventOffset](self, "significantEventOffset");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("kTimerTriggerResetSignificantEventOffsetKey"));
  }
  return v3;
}
...
- (BOOL)_reactivateFireDateTrigger
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@No valid next fire date, disabling the timer", (uint8_t *)&v9, 0xCu);
...
- (BOOL)_reactivateSignificantEventTrigger
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting timer based on significant event with %@", (uint8_t *)&v12, 0x16u);
  ...
  else
  {
    if (v7)
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@No valid next significant fire date, disabling the timer", (uint8_t *)&v12, 0xCu);
...
- (BOOL)shouldActivateOnLocalDevice
{
  ...
  if (-[HMDTrigger shouldActivateOnLocalDevice](&v10, sel_shouldActivateOnLocalDevice))
  {
    ...
    else
    {
      -[HMDTrigger owner](self, "owner");
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v7 = objc_msgSend(v5, "isCurrentUser");
    }
LABEL_11:
...
- (id)_nextFireDate
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Next Fire Date : [%@]", buf, 0x16u);
      ...
      for (i = 0; i != v11; ++i)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v37 = 2112;
          v38 = v9;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Comparing date components iter: %@, now: %@", buf, 0x20u);
        ...
        if (v19 == objc_msgSend(v14, "weekday"))
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v34 = v24;
            _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Current week day matches with a recurring instance, allowing execution of action set", buf, 0xCu);
...
- (void)_timerTriggered
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v12 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Going to execute the Action set.", buf, 0xCu);
  ...
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Should execute action set returned NO, going ahead to reactivate trigger", buf, 0xCu);
...
- (void)_closestDatesForStartDate:(id)a3 earliestDate:(id)a4 timeZone:(id)a5 deliveryRepeatInterval:(id)a6 returnDateBefore:(id *)a7 returnDateAfter:(id *)a8
{
  ...
  if (v19 != 1)
  {
    if (v15)
    {
      ...
      objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeInterval:sinceDate:", v13, (double)(v31 - v32));
          ...
          *a8 = objc_retainAutorelease(v28);
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v88 = 2112;
            v89 = v57;
            _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, "%{public}@(d) Timer fires next at %@; current time (GMT): %@",
              buf,
              0x20u);
          ...
          *a7 = (id)objc_claimAutoreleasedReturnValue();
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v88 = 2112;
            v89 = v61;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@(e) Timer fires next at %@; current time (GMT): %@",
              buf,
              0x20u);
      ...
      else
      {
        ...
        if (!v46)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v88 = 2112;
          v89 = v65;
          _os_log_impl(&dword_1CD062000, v82, OS_LOG_TYPE_INFO, "%{public}@(f) Timer fires next at %@; current time (GMT): %@",
            buf,
            0x20u);
            ...
            *a7 = objc_retainAutorelease(v28);
            ...
            if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v88 = 2112;
              v89 = v80;
              _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@(b) Timer fires next at %@; current time (GMT): %@",
                buf,
                0x20u);
            ...
            *a8 = (id)objc_claimAutoreleasedReturnValue();
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v88 = 2112;
              v89 = v53;
              _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@(c) Timer fires next at %@; current time (GMT): %@",
                buf,
                0x20u);
...
LABEL_23:
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v88 = 2112;
          v89 = v45;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@(g) Timer fires next at %@; current time (GMT): %@",
            buf,
            0x20u);
    ...
    *a8 = objc_retainAutorelease(v13);
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v88 = 2112;
      v89 = v27;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@(a) Timer fires next at %@; current time (GMT): %@",
        buf,
        0x20u);
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Received unknown model object", (uint8_t *)&v18, 0xCu);
...
- (void)handleTimerFiredNotification:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Timer Trigger fired : %@", (uint8_t *)&v14, 0x16u);
  ...
  if (WeakRetained)
  {
    if (v3)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 138543362;
        v23 = v9;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Activate on super class failed, bailing out", (uint8_t *)&v22, 0xCu);
...
LABEL_19:
    ...
    else
    {
      ...
      else if (objc_msgSend(v5, "active"))
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          v22 = 138543362;
          v23 = v20;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Looks like the timer is already running. Stopping it.", (uint8_t *)&v22, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@TimerTrigger instance is gone. Doing Nothing.", (uint8_t *)&v22, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_27266 != -1)
    dispatch_once(&logCategory__hmf_once_t0_27266, &__block_literal_global_27267);
  return (id)logCategory__hmf_once_v1_27268;
}
...
+ (id)validateRecurrence:(id)a3 calendar:(id)a4 fireDate:(id)a5
{
  ...
  if (v7)
  {
      ...
      && (objc_msgSend(v7, "nanosecond") == 0x7FFFFFFFFFFFFFFFLL || !objc_msgSend(v7, "nanosecond")))
    {
      ...
      {
        objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], 42, 0);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
      }
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], 69, 0);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
    }
  }
  else
        ...
        for (i = 0; i != v9; ++i)
        {
          ...
          if ((v13 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v45 = v25;
              _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Calendars are not matching in the recurrence instances", buf, 0xCu);
          ...
          if (!objc_msgSend(v19, "weekday"))
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v46 = 2112;
              v47 = v19;
              _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Invalid values for week day: %@", buf, 0x16u);
          ...
          if ((objc_msgSend(v19, "isEqual:", v20) & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v46 = 2112;
              v47 = v19;
              _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@Miscellaneous fields have been set recurrence instances: %@", buf, 0x16u);
    ...
    if (v23)
    {
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v61 = v28;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Not a valid recurrence", buf, 0xCu);
    ...
    if (v33)
    {
      ...
      if (v34)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v61 = v38;
          _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Invalid recurrence instances", buf, 0xCu);
      ...
      if (v40)
      {
        if ((HMIsValidSignificantEvent() & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v61 = v49;
            _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@Significant event is not valid", buf, 0xCu);
      ...
      if (v42)
      {
        ...
        if (v43)
        {
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v61 = v53;
            _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, "%{public}@Invalid significant event offset", buf, 0xCu);
        ...
        objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", v42, 1, 0);
        v51 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_33:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v61 = v18;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Fire date is not valid", buf, 0xCu);
...
+ (id)validateWholeMinuteDate:(id)a3 onCalendar:(id)a4
{
  ...
  if (v5)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], 70, 0);
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 28);
      v9 = objc_claimAutoreleasedReturnValue();
    }
    v10 = (void *)v9;
LABEL_11:
...
void __30__HMDTimerTrigger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_27268;
  logCategory__hmf_once_v1_27268 = v0;
