...
- (HMDIDSActivityMonitor)initWithActivity:(id)a3 serviceIdentifier:(id)a4
{
  ...
  if (v8)
  {
    v9 = objc_msgSend(objc_alloc(MEMORY[0x1E0D342A8]), "initWithActivity:serviceIdentifier:", v6, v7);
...
- (void)listenWithDelegate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Enabling IDSActivityMonitor", (uint8_t *)&v11, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_132391 != -1)
    dispatch_once(&logCategory__hmf_once_t1_132391, &__block_literal_global_132392);
  return (id)logCategory__hmf_once_v2_132393;
}
...
void __36__HMDIDSActivityMonitor_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_132393;
  logCategory__hmf_once_v2_132393 = v0;
