  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive account from account data: %@", buf, 0x16u);
...
- (void)_companionLoginWithSessionID:(id)a3 account:(id)a4 remoteDevice:(id)a5 completion:(id)a6
{
  ...
  v19 = (void *)MEMORY[0x1D17BA0A0](-[HMDRemoteLoginInitiator setLoginSession:](self, "setLoginSession:", v18));
  v20 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v10;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Created the companion login with Session ID: %@", (uint8_t *)&v24, 0x16u);
  ...
  if (!v9)
  {
    ...
    if (v17)
    {
        ...
        if (v29)
        {
          if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v43 = 2112;
            v44 = v29;
            _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Received proxy device response with device: %@", buf, 0x16u);
        ...
        else
        {
          if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v42 = v36;
            _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with no device", buf, 0xCu);
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v43 = 2112;
        v44 = 0;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with response error: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v42 = v28;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with invalid payload", buf, 0xCu);
...
LABEL_22:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v43 = 2112;
    v44 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with error %@", buf, 0x16u);
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v12;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive authentication results from results data: %@", buf, 0x16u);
...
- (void)_proxyLoginWithSessionID:(id)a3 authResults:(id)a4 remoteDevice:(id)a5 completion:(id)a6
{
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v10;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Created the proxy login with Session ID: %@", (uint8_t *)&v24, 0x16u);
...
- (void)_handleRemoteLoginSignout:(id)a3
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteLoginSignoutRequest setAccount:](v7, "setAccount:", v9);
  ...
  v15 = v4;
  v17 = v15;
  objc_msgSend(v13, "sendRemoteMessageWithName:payload:responseHandler:", v14, v12, v16);
...
- (void)_handleSignoutResponse:(id)a3 error:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received proxy device response %@ and error %@", (uint8_t *)&v19, 0x20u);
...
- (void)_callCompletion:(id)a3 loggedInAccount:(id)a4 authSession:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v8;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Login session %@ has ended with error %@", (uint8_t *)&v25, 0x20u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v9;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating the logged in account from %@ to %@", (uint8_t *)&v25, 0x20u);
...
void __75__HMDRemoteLoginInitiator_didCompleteAuthentication_error_loggedInAccount___block_invoke(uint64_t a1)
{
  ...
  if (v5 == v6)
  {
    if (v10)
    {
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ has completed with error %@", (uint8_t *)&v16, 0x20u);
  ...
  else
  {
    if (v10)
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Received completion from unknown remote authentication with error %@", (uint8_t *)&v16, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_31035 != -1)
    dispatch_once(&logCategory__hmf_once_t0_31035, &__block_literal_global_31036);
  return (id)logCategory__hmf_once_v1_31037;
}
...
void __38__HMDRemoteLoginInitiator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_31037;
  logCategory__hmf_once_v1_31037 = v0;
