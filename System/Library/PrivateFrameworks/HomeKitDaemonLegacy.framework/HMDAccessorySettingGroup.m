  ...
  if ((unint64_t)objc_msgSend(v4, "count") >= 2)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 2112;
        v22 = v12;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unexpected group name: %@ for group: %@", (uint8_t *)&v17, 0x20u);
...
- (id)_initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB7E68]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB7E60]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB3A28], "UUID");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = -[HMDAccessorySettingGroup initWithName:identifier:parentIdentifier:](self, "initWithName:identifier:parentIdentifier:", v5, v6, v7);
  ...
  if (v8)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v9, *MEMORY[0x1E0CB7E70]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v22, *MEMORY[0x1E0CB7E58]);
  ...
  if (-[HMDAccessorySettingGroup shouldEncodeForCoder:](self, "shouldEncodeForCoder:", v4))
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v22;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@dataSource = %@, subtracted values = %@", buf, 0x20u);
    ...
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "encodeObject:forKey:", v23, *MEMORY[0x1E0CB7E60]);

    -[HMDAccessorySettingGroup name](v17, "name");
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "encodeObject:forKey:", v24, *MEMORY[0x1E0CB7E68]);

    objc_msgSend(v10, "encodeObject:forKey:", v11, *MEMORY[0x1E0CB7E70]);
    objc_msgSend(v10, "encodeObject:forKey:", v8, *MEMORY[0x1E0CB7E58]);
...
- (BOOL)dataSourceShouldEncodeSetting:(id)a3 withCoder:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      v26 = 2112;
      v27 = v16;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@dataSource: %@, shouldEncodeSetting = %@, %@", (uint8_t *)&v20, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode settings due to no data source", (uint8_t *)&v20, 0xCu);
...
- (void)intersectSettingGroup:(id)a3 groupMetadata:(id)a4 shouldAddMissingItems:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v178 = 1024;
    v179 = v138;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Group name is %@, intersecting. addMissing: %d", buf, 0x1Cu);
  ...
  if (-[HMDAccessorySettingGroup isPrivateToDevice](v10, "isPrivateToDevice"))
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v176 = 2112;
      v177 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Skipping private group %@", buf, 0x16u);
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v175 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Received metadata is nil, not intersecting", buf, 0xCu);
      goto LABEL_90;
    }
LABEL_91:
  ...
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "hmf_objectsPassingTest:", &__block_literal_global_29_141600);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v24, "hmf_objectsPassingTest:", &__block_literal_global_30_141601);
  v25 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        if (!v79)
        {
          ...
          if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v176 = 2112;
            v177 = v77;
            _os_log_impl(&dword_1CD062000, v82, OS_LOG_TYPE_INFO, "%{public}@Setting %@ does not have metadata, cannot merge", buf, 0x16u);
          ...
          if (!v104)
          {
            ...
            if (os_log_type_enabled(v107, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v176 = 2112;
              v177 = v99;
              _os_log_impl(&dword_1CD062000, v107, OS_LOG_TYPE_INFO, "%{public}@Failed to merge setting %@, cannot merge", buf, 0x16u);
          ...
          if (!v119)
          {
            ...
            if (os_log_type_enabled(v122, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v176 = 2112;
              v177 = v116;
              _os_log_impl(&dword_1CD062000, v122, OS_LOG_TYPE_INFO, "%{public}@No subgroup or settings, removing group %@", buf, 0x16u);
...
LABEL_27:
    _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, v58, buf, 0x16u);
        ...
        if ((objc_msgSend(v29, "compareConstraints:", v37) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v78 = 2112;
            v79 = v64;
            _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_INFO, "%{public}@Constraints on settings are not matching: %@", buf, 0x16u);
...
BOOL __43__HMDAccessorySettingGroup__initWithCoder___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unexpected type found while decoding accessory setting", (uint8_t *)&v11, 0xCu);
...
BOOL __43__HMDAccessorySettingGroup__initWithCoder___block_invoke_27(uint64_t a1, void *a2)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unexpected type found while decoding accessory group", (uint8_t *)&v11, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_141645 != -1)
    dispatch_once(&logCategory__hmf_once_t11_141645, &__block_literal_global_141646);
  return (id)logCategory__hmf_once_v12_141647;
}
...
+ (id)supportedSettingsClasses
{
  if (supportedSettingsClasses_onceToken != -1)
    dispatch_once(&supportedSettingsClasses_onceToken, &__block_literal_global_22_141644);
...
+ (id)supportedGroupsClasses
{
  if (supportedGroupsClasses_onceToken != -1)
    dispatch_once(&supportedGroupsClasses_onceToken, &__block_literal_global_25_141642);
...
void __39__HMDAccessorySettingGroup_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_141647;
  logCategory__hmf_once_v12_141647 = v0;
