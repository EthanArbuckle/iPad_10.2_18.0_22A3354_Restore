  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", *(_QWORD *)(*((_QWORD *)&v23 + 1) + 8 * v9));
        if (v10)
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v15));
        if (v16)
...
+ (id)properties
{
  if (properties_onceToken_172053 != -1)
    dispatch_once(&properties_onceToken_172053, &__block_literal_global_207_172054);
  return (id)properties__properties_172055;
}
...
void __44__HMDAssistantAccessControlModel_properties__block_invoke()
{
  ...
  v7 = (void *)properties__properties_172055;
  properties__properties_172055 = v6;
