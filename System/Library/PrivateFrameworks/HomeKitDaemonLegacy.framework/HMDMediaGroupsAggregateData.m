...
{
  return -[HMDMediaGroupsAggregateData initWithDestinations:destinationControllersData:groups:](self, "initWithDestinations:destinationControllersData:groups:", a3, a4, MEMORY[0x1E0C9AA60]);
}
...
- (HMDMediaGroupsAggregateData)initWithProtoBufferData:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA628]), "initWithData:", v4);
  v6 = v5;
  if (v5)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode event data: %@", (uint8_t *)&v19, 0x16u);
...
- (id)decodeDestinationsWithEncodedDestinations:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "na_map:", &__block_literal_global_112999);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode destinations in proto data: %@", (uint8_t *)&v16, 0x16u);
...
- (id)decodeDestinationControllersWithEncodedDestinationControllers:(id)a3
{
  ...
  v20 = *MEMORY[0x1E0C80C00];
  v4 = a3;
  objc_msgSend(v4, "na_map:", &__block_literal_global_5_112996);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "count");
  if (v6 == objc_msgSend(v4, "count"))
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode destination controllers data in proto data: %@", (uint8_t *)&v16, 0x16u);
...
- (id)decodeMediaGroupsWithEncodedMediaGroups:(id)a3
{
  ...
  objc_msgSend(a3, "na_map:", &__block_literal_global_8_112994);
...
- (id)encodeToProtoBufferData
{
  ...
  v3 = objc_alloc_init(MEMORY[0x1E0CBA628]);
...
- (id)encodedDestinationEvents
{
  ...
  if (v4)
  {
    -[HMDMediaGroupsAggregateData destinations](self, "destinations");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "na_map:", &__block_literal_global_13_112991);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    -[HMDMediaGroupsAggregateData sentinelDestination](self, "sentinelDestination");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = objc_alloc(MEMORY[0x1E0CBA620]);
...
- (id)encodedDestinationControllerEvents
{
  ...
  if (v4)
  {
    -[HMDMediaGroupsAggregateData destinationControllersData](self, "destinationControllersData");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "na_map:", &__block_literal_global_16_112988);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    -[HMDMediaGroupsAggregateData sentinelDestinationControllerData](self, "sentinelDestinationControllerData");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = objc_alloc(MEMORY[0x1E0CBA630]);
    objc_msgSend(v5, "encodeToProtoBufferData");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = (void *)objc_msgSend(v7, "initWithData:", v8);
    v11[0] = v9;
...
- (id)encodedMediaGroupEvents
{
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v14 = objc_alloc(MEMORY[0x1E0CBA638]);
  ...
  else
  {
    -[HMDMediaGroupsAggregateData sentinelGroup](self, "sentinelGroup");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v17 = objc_alloc(MEMORY[0x1E0CBA638]);
...
- (id)sentinelDestinationControllerData
{
  ...
  v3 = objc_alloc(MEMORY[0x1E0CBA610]);
  v4 = (void *)objc_msgSend(v3, "initWithIdentifier:parentIdentifier:destinationIdentifier:supportedOptions:availableDestinationIdentifiers:", v2, v2, 0, 0, MEMORY[0x1E0C9AA60]);
...
- (id)sentinelDestination
{
  ...
  -[HMDMediaGroupsAggregateData sentinelIdentifier](self, "sentinelIdentifier");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA600]), "initWithUniqueIdentifier:parentIdentifier:supportedOptions:", v2, v2, 0);
...
- (id)sentinelGroup
{
  ...
  -[HMDMediaGroupsAggregateData sentinelIdentifier](self, "sentinelIdentifier");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_alloc(MEMORY[0x1E0CBA618]);
  v4 = (void *)objc_msgSend(v3, "initWithIdentifier:parentIdentifier:name:defaultName:destinationIdentifiers:associatedGroupIdentifier:", v2, v2, &stru_1E89C3E38, 0, MEMORY[0x1E0C9AA60], 0);
...
id __65__HMDMediaGroupsAggregateData_encodedDestinationControllerEvents__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA630];
  v3 = a2;
  v4 = [v2 alloc];
...
id __55__HMDMediaGroupsAggregateData_encodedDestinationEvents__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA620];
  v3 = a2;
  v4 = [v2 alloc];
  objc_msgSend(v3, "encodeToProtoBufferData");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
id __71__HMDMediaGroupsAggregateData_decodeMediaGroupsWithEncodedMediaGroups___block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA618];
  v3 = a2;
  v4 = [v2 alloc];
  objc_msgSend(v3, "data");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
id __93__HMDMediaGroupsAggregateData_decodeDestinationControllersWithEncodedDestinationControllers___block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA610];
  v3 = a2;
  v4 = [v2 alloc];
  objc_msgSend(v3, "data");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
id __73__HMDMediaGroupsAggregateData_decodeDestinationsWithEncodedDestinations___block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA600];
  v3 = a2;
  v4 = [v2 alloc];
  objc_msgSend(v3, "data");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
