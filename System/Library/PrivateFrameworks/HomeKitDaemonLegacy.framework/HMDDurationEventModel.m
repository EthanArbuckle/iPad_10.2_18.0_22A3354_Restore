...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_173324 != -1)
    dispatch_once(&properties_onceToken_173324, block);
  return (id)properties__properties_173325;
}
...
void __35__HMDDurationEventModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_173325;
  properties__properties_173325 = v3;

  v5 = (void *)properties__properties_173325;
  v9 = CFSTR("duration");
