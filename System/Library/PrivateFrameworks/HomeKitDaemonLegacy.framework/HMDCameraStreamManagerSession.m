...
LABEL_6:
  ...
  if (a7 > 0.0)
  {
    v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, a7);
...
- (BOOL)canStartWithError:(id *)a3
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    v18 = 2112;
    v19 = v12;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Stream tracker cannot start stream session: %@", (uint8_t *)&v16, 0x16u);

  }
  objc_autoreleasePoolPop(v11);
  if (!a3)
    return 0;
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1018);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_6287 != -1)
    dispatch_once(&logCategory__hmf_once_t1_6287, &__block_literal_global_6288);
  return (id)logCategory__hmf_once_v2_6289;
}
...
void __44__HMDCameraStreamManagerSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_6289;
  logCategory__hmf_once_v2_6289 = v0;
