  ...
  if (!v4)
  {
    ...
    if (v7)
    {
      ...
      if (hostProcessBundleIdentifierForMessage__onceToken != -1)
        dispatch_once(&hostProcessBundleIdentifierForMessage__onceToken, &__block_literal_global_166733);
...
{
  return (NSNumber *)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(a1, "uptimeInMilliseconds"));
}
...
void __60__HMDCameraSessionID_hostProcessBundleIdentifierForMessage___block_invoke()
{
  ...
  objc_msgSend(v2, "setObject:forKeyedSubscript:", *MEMORY[0x1E0CB8D08], *MEMORY[0x1E0CB9608]);
