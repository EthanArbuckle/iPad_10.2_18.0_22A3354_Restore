...
- (id)attributeDescriptions
{
  ...
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28548]), "initWithName:value:", CFSTR("Identifier"), v3);
  v13[0] = v4;
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDNaturalLightingEnabledRetryContext retryCount](self, "retryCount"));
