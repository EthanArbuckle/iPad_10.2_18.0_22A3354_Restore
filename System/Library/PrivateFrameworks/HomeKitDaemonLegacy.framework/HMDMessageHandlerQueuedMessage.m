...
- (HMDMessageHandlerQueuedMessage)initWithMessage:(id)a3 timeInterval:(double)a4
{
  ...
  v7 = a3;
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 2, a4);
  v12.receiver = self;
...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Notifying client of did trigger message handler queued message with delegate: %@", (uint8_t *)&v10, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_90857 != -1)
    dispatch_once(&logCategory__hmf_once_t1_90857, &__block_literal_global_90858);
  return (id)logCategory__hmf_once_v2_90859;
}
...
void __45__HMDMessageHandlerQueuedMessage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_90859;
  logCategory__hmf_once_v2_90859 = v0;
