...
LABEL_9:
      ...
      if (v9 >= 3)
      {
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_privilegeLevel);
        v10 = (__CFString *)objc_claimAutoreleasedReturnValue();
      }
      else
      {
        v10 = off_1E89A91B8[v9];
      }
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isP2PEnabled);
...
LABEL_4:
  ...
  {
LABEL_5:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isPasswordSet);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
