...
void __56__HMDHAP2Storage_registerPairedAccessoryWithIdentifier___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D164E0]), "initWithDeviceIDString:", *(_QWORD *)(a1 + 32));
  if (v2)
  {
    v3 = *(_QWORD *)(a1 + 40);
    if (v3)
  ...
  {
    hap2LogInitialize();
    v6 = *MEMORY[0x1E0D16668];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D16668], OS_LOG_TYPE_DEBUG))
    {
      v7 = *(_QWORD *)(a1 + 32);
      v8 = 138412290;
      v9 = v7;
      _os_log_debug_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "Ignoring invalid registered device ID: %@", (uint8_t *)&v8, 0xCu);
    }
  }
...
void __54__HMDHAP2Storage_removeCacheForIdentifier_completion___block_invoke(_QWORD *a1)
{
  ...
  {
    hap2LogInitialize();
    v5 = *MEMORY[0x1E0D16660];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D16660], OS_LOG_TYPE_ERROR))
    {
      v7 = a1[5];
      v8 = 138412290;
      v9 = v7;
      _os_log_error_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "Storage: Unable to remove cache for %@", (uint8_t *)&v8, 0xCu);
    }
    v6 = a1[6];
...
void __57__HMDHAP2Storage_saveCacheForIdentifier_data_completion___block_invoke(_QWORD *a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D16660], OS_LOG_TYPE_ERROR))
    {
      ...
      v8 = 138412290;
      v9 = v7;
      _os_log_error_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "Storage: Unable to save cache for %@", (uint8_t *)&v8, 0xCu);
    }
    v6 = a1[7];
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 2);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
void __53__HMDHAP2Storage_fetchCacheForIdentifier_completion___block_invoke(uint64_t a1)
{
  ...
  {
    hap2LogInitialize();
    v6 = *MEMORY[0x1E0D16660];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D16660], OS_LOG_TYPE_ERROR))
    {
      v8 = *(_QWORD *)(a1 + 40);
      *(_DWORD *)buf = 138412290;
      v12 = v8;
      _os_log_error_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "Storage: Unable to retrieve cache for %@", buf, 0xCu);
    }
    v7 = *(_QWORD *)(a1 + 48);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 2);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
...
void __58__HMDHAP2Storage_deregisterPairedAccessoryWithIdentifier___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "_removeKeysForIdentifiers:completion:", v6, &__block_literal_global_443);

  }
  else
  {
    hap2LogInitialize();
    v7 = *MEMORY[0x1E0D16668];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D16668], OS_LOG_TYPE_DEBUG))
    {
      v8 = *(_QWORD *)(a1 + 32);
      v9 = 138412290;
      v10 = v8;
      _os_log_debug_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "Ignoring invalid deregistered device ID: %@", (uint8_t *)&v9, 0xCu);
    }
  }
...
void __58__HMDHAP2Storage_deregisterPairedAccessoryWithIdentifier___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E0D16668], OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 2112;
    v10 = v5;
    _os_log_debug_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "remove key id=%@ error=%@", (uint8_t *)&v7, 0x16u);
  }
