...
- (HMDCameraRecordingReachabilityEventManager)initWithAccessory:(id)a3 workQueue:(id)a4 identifier:(id)a5 bulletinBoard:(id)a6 logEventSubmitter:(id)a7 accountSettings:(id)a8 notificationCenter:(id)a9
{
  ...
  if (v18)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3690], "weakObjectsHashTable", v29, v30, v31, v32);
    ...
    v19->_initialReachabilityTimerFactory = &__block_literal_global_126721;

    reachabilityChangeDebounceTimerFactory = v19->_reachabilityChangeDebounceTimerFactory;
    v19->_reachabilityChangeDebounceTimerFactory = &__block_literal_global_11_126722;
...
- (void)configureWithMessageDispatcher:(id)a3 currentSettings:(id)a4 isCurrentDeviceConfirmedPrimaryResident:(BOOL)a5 isCurrentDeviceConnectedToNetwork:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v66 = 2112;
    v67 = v17;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Configuring with current settings: %@, isCurrentDeviceConfirmedPrimaryResident: %@, isCurrentDeviceConnectedToNetwork: %@", buf, 0x2Au);
  ...
  if ((unint64_t)objc_msgSend(v8, "count") > 1)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2048;
      v31 = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Removing %lu expired records", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v18);
    objc_msgSend(MEMORY[0x1E0D32CD8], "optionsWithLabel:", CFSTR("Remove expired camera reachability event records"));
    v23 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@No expired models to delete", buf, 0xCu);
  ...
  if (self->_currentDeviceConfirmedPrimaryResident != v3)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v18 = 138543362;
        v19 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Not updating notification registrations because accessory reference is nil", (uint8_t *)&v18, 0xCu);
...
LABEL_9:
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, v11, (uint8_t *)&v13, 0xCu);
...
- (void)addCameraReachabilityEventForCurrentCameraReachability:(BOOL)a3 dateOfOccurrence:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v38 = 2112;
    v39 = v6;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Adding camera reachability event model %@ with current reachability: %@ date of occurrence: %@", buf, 0x2Au);

  }
  objc_autoreleasePoolPop(v9);
  objc_msgSend(MEMORY[0x1E0D32CD8], "optionsWithLabel:", CFSTR("Create camera reachability event"));
...
- (void)notifySubscribersOfRemoteCameraReachabilityEvent
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      objc_msgSend(v6, "notificationRegistry");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v8, "userIDsRegisteredForReachabilityEventNotificationsForAccessoryUUIDs:", v10);
      v11 = (void *)objc_claimAutoreleasedReturnValue();

      v12 = MEMORY[0x1E0C809B0];
      v27[0] = MEMORY[0x1E0C809B0];
      v27[1] = 3221225472;
      v27[2] = __94__HMDCameraRecordingReachabilityEventManager_notifySubscribersOfRemoteCameraReachabilityEvent__block_invoke;
      v27[3] = &unk_1E89B5D20;
      v27[4] = self;
      ...
      if (objc_msgSend(v13, "hmf_isEmpty"))
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v30 = v17;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@No devices need to be notified for accessory reachability event", buf, 0xCu);
      ...
      else
      {
        v26[0] = v12;
        v26[1] = 3221225472;
        v26[2] = __94__HMDCameraRecordingReachabilityEventManager_notifySubscribersOfRemoteCameraReachabilityEvent__block_invoke_71;
        v26[3] = &unk_1E89B5D48;
        v26[4] = self;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v25;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Home reference was nil when attempting to notify subscribers", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory reference was nil when attempting to notify subscribers", buf, 0xCu);
  ...
  if (v10)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribed transports of %lu updated events, %lu removed events", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v11);
    v39[0] = *MEMORY[0x1E0CB85C8];
    v32 = v6;
    encodeRootObjectForIncomingXPCMessage(v6, 0);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v39[1] = *MEMORY[0x1E0CB85B8];
    v40[0] = v17;
    v31 = v7;
    v40[1] = v7;
    ...
    if (v19)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(MEMORY[0x1E0D285F8], "entitledMessageWithName:messagePayload:", v22, v18);
          v25 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed transports to notify of %lu updated events, %lu removed events", buf, 0x20u);
  ...
  if (objc_msgSend(v4, "reachable"))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
      {
        ...
        v24 = 2112;
        v25 = v7;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_FAULT, "%{public}@Most recent reachability event model has no date of occurrence: %@", (uint8_t *)&v22, 0x16u);
...
- (id)performCloudPullWithLabel:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot perform cloud pull because zones are not ready", buf, 0xCu);
...
- (void)updateInitialReachabilityTimer
{
  ...
  if (-[HMDCameraRecordingReachabilityEventManager shouldHandleReachabilityChanges](self, "shouldHandleReachabilityChanges"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting initial reachability timer", (uint8_t *)&v15, 0xCu);
...
- (void)startReachabilityChangeDebounceTimerWithReachability:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2048;
    v23 = v8;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Starting reachability change debounce timer with time interval of %fs", (uint8_t *)&v20, 0x16u);
...
- (id)mostRecentReachabilityEventModelInModels:(id)a3
{
  ...
  v8 = &v7;
  v9 = 0x3032000000;
  v10 = __Block_byref_object_copy__126645;
  v11 = __Block_byref_object_dispose__126646;
  v12 = 0;
...
- (void)handleRemoteCameraReachabilityChange:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to perform cloud pull for new reachability event", (uint8_t *)&v11, 0xCu);
...
- (void)handleFetchEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v50 = 2112;
    v51 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to fetch events: %@", buf, 0x16u);
  ...
  if (v11)
  {
    objc_msgSend(v4, "dateForKey:", *MEMORY[0x1E0CB85A0]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "dateForKey:", *MEMORY[0x1E0CB85A8]);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "numberForKey:", *MEMORY[0x1E0CB85B0]);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "numberForKey:", *MEMORY[0x1E0CB85C0]);
    v15 = objc_claimAutoreleasedReturnValue();
    v16 = (void *)v15;
    if (v12 && v13 && v14 && v15)
    {
      v44 = v13;
      v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3588]), "initWithStartDate:endDate:", v12, v13);
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v54 = 2112;
        v55 = v24;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Fetching reachability event models with date interval: %@, limit: %lu, shouldOrderAscending: %@", buf, 0x2Au);
      ...
      if (v18)
        v27 = &__block_literal_global_95_126621;
      else
        v27 = &__block_literal_global_96_126622;
      ...
      v39 = v29;
      v13 = v44;
      objc_msgSend(v29, "na_map:", &__block_literal_global_98_126623);
      v40 = (void *)objc_claimAutoreleasedReturnValue();
      v46 = *MEMORY[0x1E0CB85D0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v33;
      _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch events because zones are not ready", buf, 0xCu);
...
- (void)handleFetchCountOfEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v42 = 2112;
    v43 = (uint64_t)v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to fetch count of events: %@", buf, 0x16u);
  ...
  if (v11)
  {
    objc_msgSend(v4, "messagePayload");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "hmf_dateForKey:", *MEMORY[0x1E0CB85A0]);
    v13 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(v4, "messagePayload");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "hmf_dateForKey:", *MEMORY[0x1E0CB85A8]);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v13 && v15)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = (uint64_t)v16;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Fetching count of reachability event models with date interval: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v44 = 2112;
        v45 = v16;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched count of %lu events with date interval: %@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v22);
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v21, "count", *MEMORY[0x1E0CB8598]));
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      v39 = v27;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = (uint64_t)v37;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Could not find required value in message payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v41 = v32;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch count of events because zones are not ready", buf, 0xCu);
...
- (void)handleDeleteAllEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling delete all reachability events message", buf, 0xCu);
...
- (id)localZone:(id)a3 didProcessModelUpdate:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 2112;
    v16 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Received model update: %@", (uint8_t *)&v13, 0x16u);
...
- (void)clipManagerDidStart:(id)a3
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Suppressing all reachability notifications before %@", (uint8_t *)&v17, 0x16u);
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v23;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Initial reachability timer fired with isReachable: %@", buf, 0x16u);
    ...
    if (v7 == v4)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v29 = 2114;
        v30 = v13;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Reachability change debounce timer fired with last known reachability %{public}@ and current reachability %{public}@", buf, 0x20u);
...
- (void)networkMonitorIsReachable:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received network monitor is reachable", (uint8_t *)&v10, 0xCu);
...
- (void)networkMonitorIsUnreachable:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received network monitor is unreachable", (uint8_t *)&v10, 0xCu);
...
void __80__HMDCameraRecordingReachabilityEventManager_localZone_didProcessModelDeletion___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received deleted reachability event model: %@", (uint8_t *)&v18, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v22 = 2112;
      v23 = objc_opt_class();
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Deletion model %@ is not of expected type: %@", (uint8_t *)&v18, 0x20u);
...
void __80__HMDCameraRecordingReachabilityEventManager_localZone_didProcessModelCreation___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v44 = 2112;
      v45 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received new reachability event model: %@", (uint8_t *)&v42, 0x16u);
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        v44 = 2112;
        v45 = v35;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert reachability model into event: %@", (uint8_t *)&v42, 0x16u);
    ...
    if (v16 == -1)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        v46 = 2112;
        v47 = v38;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Ignoring created event with date of occurrence %@ because it is before %@", (uint8_t *)&v42, 0x20u);
    ...
    else
    {
      ...
      if (v19 && v21)
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          v44 = 2114;
          v45 = v10;
          _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Inserting bulletin for new reachability event: %{public}@", (uint8_t *)&v42, 0x16u);
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
      {
        ...
        v48 = 2112;
        v49 = v41;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Not inserting bulletin for new reachability event: %@ due to reachabilityEventNotificationEnabled: %@ and isHomeEnabled: %@", (uint8_t *)&v42, 0x2Au);
...
void __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v22 = 2112;
    v23 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Received notification of an updated home state with account settings - %@", buf, 0x16u);
  ...
  objc_msgSend(*(id *)(a1 + 32), "accountSettings");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v9, "isHomeEnabled");
  ...
  if (v10)
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99D68], "date");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "setSuppressNotificationsBeforeDate:", v13);
    ...
    v19[1] = 3221225472;
    v19[2] = __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_90;
    v19[3] = &unk_1E89C21E8;
    v19[4] = *(_QWORD *)(a1 + 32);
    objc_msgSend(v14, "addSuccessBlock:", v19);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    v18[0] = v15;
    v18[1] = 3221225472;
    v18[2] = __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_91;
    v18[3] = &unk_1E89C2350;
    v18[4] = *(_QWORD *)(a1 + 32);
  ...
  {
    objc_msgSend(v8, "setCameraReachabilityEventNotificationsEnabled:forAccessory:completionHandler:", 0, v7, 0);
  }

}

void __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_90(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched the reachability events due to account settings changed", (uint8_t *)&v8, 0xCu);
...
void __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_91(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch the reachability events due to account settings changed with error - %@", (uint8_t *)&v8, 0x16u);
...
void __95__HMDCameraRecordingReachabilityEventManager_handleHMDBridgedAccessoryUnreachableNotification___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@HMDBridgedAccessoryUnreachableNotification for bridged camera %@", (uint8_t *)&v10, 0x16u);
...
void __93__HMDCameraRecordingReachabilityEventManager_handleHMDBridgedAccessoryReachableNotification___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@HMDBridgedAccessoryReachableNotification for bridged camera %@", (uint8_t *)&v10, 0x16u);
...
uint64_t __74__HMDCameraRecordingReachabilityEventManager_handleAccessoryUnconfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Unconfigured camera %@", (uint8_t *)&v9, 0x16u);
...
uint64_t __72__HMDCameraRecordingReachabilityEventManager_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Configured camera %@", (uint8_t *)&v9, 0x16u);
...
void __83__HMDCameraRecordingReachabilityEventManager_handleCameraProfileSettingsDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 138543362;
    v31 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Received camera profile settings did change notification", (uint8_t *)&v30, 0xCu);
      ...
      if ((v14 & 1) == 0)
      {
        if (v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            v30 = 138543362;
            v31 = v20;
            _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Reachability event notifications are now enabled", (uint8_t *)&v30, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 2112;
      v37 = v29;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Object for key %@ is not of expected type %@: %@", (uint8_t *)&v30, 0x2Au);
...
uint64_t __100__HMDCameraRecordingReachabilityEventManager_handleResidentDeviceConfirmedStateChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if ((_DWORD)v4 != (_DWORD)result)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v11;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Notified that isCurrentDeviceConfirmedPrimaryResident changed from %@ to %@", (uint8_t *)&v12, 0x20u);
...
void __72__HMDCameraRecordingReachabilityEventManager_performCloudPullWithLabel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform cloud pull with options %@ due to error: %@", (uint8_t *)&v9, 0x20u);
...
id __94__HMDCameraRecordingReachabilityEventManager_notifySubscribersOfRemoteCameraReachabilityEvent__block_invoke(uint64_t a1, void *a2)
{
  ...
  v14 = *MEMORY[0x1E0C80C00];
  v3 = a2;
  +[HMDDevice deviceWithDestination:](HMDDevice, "deviceWithDestination:", v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v4)
  {
    v5 = (void *)MEMORY[0x1D17BA0A0]();
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the device with destination %@", (uint8_t *)&v10, 0x16u);
...
void __94__HMDCameraRecordingReachabilityEventManager_notifySubscribersOfRemoteCameraReachabilityEvent__block_invoke_71(uint64_t a1, void *a2)
{
  id v3;
  HMDRemoteMessage *v4;
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v15;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying device %@ for camera reachability change to %@ using message: %@", (uint8_t *)&v17, 0x2Au);
...
void __118__HMDCameraRecordingReachabilityEventManager_addCameraReachabilityEventForCurrentCameraReachability_dateOfOccurrence___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to push event %@ to the cloud due to error: %@", (uint8_t *)&v9, 0x20u);
...
void __77__HMDCameraRecordingReachabilityEventManager_handleInitialCameraReachability__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v30 = 2112;
    v31 = v20;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Determining should add initial reachability event using current reachability: %{BOOL}d, most recent reachability event: %@", buf, 0x1Cu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t68_126726 != -1)
    dispatch_once(&logCategory__hmf_once_t68_126726, &__block_literal_global_104_126727);
  return (id)logCategory__hmf_once_v69_126728;
}
...
void __57__HMDCameraRecordingReachabilityEventManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v69_126728;
  logCategory__hmf_once_v69_126728 = v0;
