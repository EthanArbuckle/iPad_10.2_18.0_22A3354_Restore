...
- (HMDLocationEvent)initWithModel:(id)a3 home:(id)a4
{
  ...
  v8 = -[HMDEvent initWithModel:home:](&v21, sel_initWithModel_home_, v6, v7);
  if (v8)
  {
    ...
    v20 = 0;
    objc_msgSend(v9, "unarchivedObjectOfClass:fromData:error:", v10, v11, &v20);
    ...
    if (!v8->_region)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v24 = 2112;
        v25 = v13;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive region from object model's region: %@", buf, 0x16u);
...
- (BOOL)doesThisTargetCurrentUser
{
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Not taking the ownership since this trigger belongs to user %@, this device's user %@", (uint8_t *)&v13, 0x20u);
...
- (void)checkFMFStatus:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Checking the ownership with fmfStatus %@", (uint8_t *)&v10, 0x16u);
...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  if ((objc_msgSend(v4, "isAuthorizedForLocationAccess") & 1) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v35 = 0;
    objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v5, &v35);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = v35;
    if (v6)
    {
...
LABEL_15:
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v37 = v30;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle update request as provided region is not valid", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v7;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive region from region data: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v37 = v20;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle update request as the client is not authorized for location services", buf, 0xCu);
...
- (void)_handleRetrieveLocationEventForEventTrigger:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Client does not have authorization to location", (uint8_t *)&v17, 0xCu);
...
- (id)dumpState
{
  ...
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v11, *MEMORY[0x1E0D27F08]);
  return v4;
}
...
- (CLRegion)uniqueRegion
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v50 = 2112;
    v51 = (uint64_t)v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@unique region %@", buf, 0x16u);
...
LABEL_21:
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, v28, buf, 0x16u);
  ...
  if ((isKindOfClass & 1) != 0)
  {
    ...
    if (v30
      && (v31 = (void *)v30,
          ...
          v32))
    {
      v33 = objc_alloc(MEMORY[0x1E0C9E360]);
    ...
    else
    {
      ...
      v45 = objc_alloc(MEMORY[0x1E0C9E360]);
      objc_msgSend(v15, "proximityUUID");
      v34 = (void *)objc_claimAutoreleasedReturnValue();
      if (!v44)
      {
...
LABEL_18:
        ...
        if (!v22)
        {
          v24 = (void *)MEMORY[0x1D17BA0A0](v46);
          v25 = v4;
          HMFGetOSLogHandle();
          v26 = objc_claimAutoreleasedReturnValue();
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
...
LABEL_23:
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v52 = 2112;
    v53 = v43;
    _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Cannot create unique region for region of unsupported class %@: %@", buf, 0x20u);
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v43 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Handling transaction updated", buf, 0xCu);
        ...
        if (!v24)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v44 = 2112;
            v45 = v25;
            _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive region from event model: %@", buf, 0x16u);
        ...
        if ((v27 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v46 = 2112;
            v47 = v32;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Updating region %@ to new region %@", buf, 0x20u);
...
- (void)locationEventOccured
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Received a callback that location event has occurred, current activation state: %@", (uint8_t *)&v21, 0x16u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Device Lost. Not informing that location event has occurred", (uint8_t *)&v21, 0xCu);
...
- (void)_handleLocationEventOccured:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received remote message that location event has occurred, with current activation type %@", (uint8_t *)&v17, 0x16u);
...
- (void)informLocationEventOccuranceToResident
{
  ...
  objc_msgSend(v6, "remoteAccessDeviceForHome:", v4);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = [HMDRemoteDeviceMessageDestination alloc];
  -[HMDEvent uuid](self, "uuid");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = -[HMDRemoteDeviceMessageDestination initWithTarget:device:](v7, "initWithTarget:device:", v8, v17);

  +[HMDRemoteMessage secureMessageWithName:qualityOfService:destination:messagePayload:](HMDRemoteMessage, "secureMessageWithName:qualityOfService:destination:messagePayload:", CFSTR("kLocationEventOccuredRequestKey"), 17, v9, MEMORY[0x1E0C9AA70]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v12 = v11;
  v19 = v12;
  v13 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v10, "setResponseHandler:", v18));
  v14 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v24 = 2114;
    v25 = v12;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Sending message with identifier %{public}@ to inform location event to resident", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v13);
  objc_msgSend(v6, "sendMessage:completionHandler:", v10, 0);
...
uint64_t __34__HMDLocationEvent_didExitRegion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Received a exit callback from HMDLocation for the region callback: [%@]", (uint8_t *)&v8, 0x16u);
...
uint64_t __35__HMDLocationEvent_didEnterRegion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Received a enter callback from HMDLocation for the region callback : [%@]", (uint8_t *)&v8, 0x16u);
...
void __58__HMDLocationEvent_informLocationEventOccuranceToResident__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Message with identifier %@ to inform location event has been sent", (uint8_t *)&v13, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_12714 != -1)
    dispatch_once(&logCategory__hmf_once_t1_12714, &__block_literal_global_12715);
  return (id)logCategory__hmf_once_v2_12716;
}
...
void __31__HMDLocationEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_12716;
  logCategory__hmf_once_v2_12716 = v0;
