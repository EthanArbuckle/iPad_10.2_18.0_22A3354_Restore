...
- (void)updateWithDevice:(id)a3 completionHandler:(id)a4
{
  ...
  if (!v8)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Device not found."), CFSTR("Unknown device."), 0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = 0;
    v11 = 0;
    if (!v7)
  ...
  -[__HMDDeviceController accountRegistry](self, "accountRegistry");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "deviceForDevice:exists:", v8, &v31);
  ...
  if (v31)
  {
    if (v10 != v8)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v36 = 2112;
        v37 = v10;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Device controller is not backed by registry device: %@ != %@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v25);
      v29 = -[HMDAssertionLogEvent initWithReason:]([HMDAssertionLogEvent alloc], "initWithReason:", CFSTR("Device controller is not backed by registry device: %@ != %@"), v8, v10);
      +[HMDMetricsManager sharedLogEventSubmitter](HMDMetricsManager, "sharedLogEventSubmitter");
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v30, "submitLogEvent:", v29);

    }
    objc_msgSend(v8, "account");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v11, "isCurrentAccount"))
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 48, CFSTR("Not supported."), CFSTR("Cannot update device on current account."), 0);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      if (!v7)
        goto LABEL_23;
      goto LABEL_22;
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v6;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating with device: %@", buf, 0x16u);
    ...
    if ((objc_opt_respondsToSelector() & 1) == 0 || objc_msgSend(v8, "shouldMergeObject:", v6))
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v34 = 2112;
        v35 = v6;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Merging with device: %@", buf, 0x16u);
      ...
      if (objc_msgSend(v8, "mergeObject:", v6))
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v33 = v20;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Updated device", buf, 0xCu);
  ...
  if ((void *)__HMDAccountRegistryStartedContext == a6)
  {
    ...
    if (objc_msgSend(v16, "BOOLValue"))
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v20;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Registry is available", buf, 0xCu);
      ...
      if (v23)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v30 = v27;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Device present in registry, updating", buf, 0xCu);
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v19 = 2112;
        v20 = v15;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Account added containing target device: %@", buf, 0x16u);
  ...
  if ((objc_msgSend(v12, "hmf_isEqualToUUID:", v13) & 1) != 0)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 2112;
        v25 = v21;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Target device added to account: %@", (uint8_t *)&v22, 0x16u);
