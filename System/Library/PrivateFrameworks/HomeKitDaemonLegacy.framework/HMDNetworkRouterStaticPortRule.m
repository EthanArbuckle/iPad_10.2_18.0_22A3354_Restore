...
+ (id)ruleFromFirewallRuleLAN:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = objc_alloc(MEMORY[0x1E0D16610]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedShort:", objc_msgSend(v3, "portStart"));
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedShort:", objc_msgSend(v3, "portEnd"));
