...
- (void)didRemoveHome:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Removing home events, home: %@", buf, 0x16u);
...
- (void)didRemoveMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Removing media system events, media system: %@", buf, 0x16u);
...
- (void)didRemoveAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Removing accessory events, accessory: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_104054 != -1)
    dispatch_once(&logCategory__hmf_once_t3_104054, &__block_literal_global_104055);
  return (id)logCategory__hmf_once_v4_104056;
}
...
void __42__HMDLastEventStoreController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_104056;
  logCategory__hmf_once_v4_104056 = v0;
