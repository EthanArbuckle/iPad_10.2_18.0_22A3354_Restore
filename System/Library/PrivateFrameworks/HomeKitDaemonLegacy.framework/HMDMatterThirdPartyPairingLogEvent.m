...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAA0], CFSTR("credentialsSentToClient"));
  }
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAA0], CFSTR("providedWiFiScanResults"));
  }
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAA0], CFSTR("providedThreadScanResults"));
  }
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAA0], CFSTR("discoveredOverBLE"));
  }
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAA0], CFSTR("knownToSystemCommissioner"));
  }
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAA0], CFSTR("CASAESessionSanityCheckPassed"));
  }

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDMatterThirdPartyPairingLogEvent cleanClose](self, "cleanClose"));
