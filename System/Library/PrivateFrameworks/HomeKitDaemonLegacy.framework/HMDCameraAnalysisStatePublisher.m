...
- (HMDCameraAnalysisStatePublisher)initWithHome:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0D31A38];
  v5 = a3;
  v6 = [v4 alloc];
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 8, 16.0);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v28 = 2112;
        v29 = v6;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize %@: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invoking _publishAnalysisStateUpdate with nil stateUpdate!", buf, 0xCu);
...
- (void)_handleRemoteAnalysisStateUpdate:(id)a3
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling remote state update: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v16;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Received nil analysis state update from message with identifier: %@", (uint8_t *)&v17, 0x16u);
...
- (void)stateManager:(id)a3 didReceiveLocalUpdate:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received local analysis state update: %@", buf, 0x16u);
...
void __62__HMDCameraAnalysisStatePublisher__publishAnalysisStateUpdate__block_invoke(uint64_t a1, void *a2)
{
  ...
  if ((objc_msgSend(v4, "isCurrentDevice") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending state update to %@", (uint8_t *)&v17, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_31460 != -1)
    dispatch_once(&logCategory__hmf_once_t6_31460, &__block_literal_global_31461);
  return (id)logCategory__hmf_once_v7_31462;
}
...
void __46__HMDCameraAnalysisStatePublisher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_31462;
  logCategory__hmf_once_v7_31462 = v0;
