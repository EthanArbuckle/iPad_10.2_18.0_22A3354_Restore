...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSStreamReceiver", buf, 0xCu);
    ...
    if (v23)
    {
        ...
        while (2)
        {
          for (i = 0; i != v27; ++i)
          {
            ...
            if ((objc_msgSend(*(id *)(*((_QWORD *)&v57 + 1) + 8 * i), "isEqual:", v23) & 1) != 0)
            {
              ...
              objc_msgSend(v17, "hmf_dateForKey:", *MEMORY[0x1E0CBACB8]);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v62 = v51;
                  _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_ERROR, "%{public}@Did not receive the snapshot timestamp in the IDS delegate callback", buf, 0xCu);
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v65 = 2112;
        v66 = v18;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Ignoring incoming snapshot resource from unexpected device handle: %@ fromID: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v63 = 2112;
        v64 = v18;
        _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_ERROR, "%{public}@Could not determine device handle for fromID: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v63 = 2112;
      v64 = v19;
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring incoming snapshot resource with unexpected request identifier: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_138628 != -1)
    dispatch_once(&logCategory__hmf_once_t1_138628, &__block_literal_global_138629);
  return (id)logCategory__hmf_once_v2_138630;
}
...
void __49__HMDCameraSnapshotIDSStreamReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_138630;
  logCategory__hmf_once_v2_138630 = v0;
