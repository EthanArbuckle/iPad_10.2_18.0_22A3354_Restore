...
- (NSSet)persons
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(v8, "na_map:", &__block_literal_global_34641);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@suggestedPersonsFetchResult is nil, returning nil", (uint8_t *)&v15, 0xCu);
...
- (id)fetchFaceCropDataByUUIDForPersonUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CD1538], "fetchTransientTrainingFaceCropsForPerson:options:", v7, v8);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v4;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Did not find person with UUID: %@, returning empty dictionary", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@suggestedPersonsFetchResult is nil, returning nil", buf, 0xCu);
...
- (unint64_t)numberOfFaceCropsForPersonWithUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CD1528], "fetchFacesForPerson:options:", v7, v8);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 2112;
        v25 = v4;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Did not find person with UUID: %@, returning 0", (uint8_t *)&v22, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@suggestedPersonsFetchResult is nil, returning 0", (uint8_t *)&v22, 0xCu);
...
{
  return (id)objc_msgSend(MEMORY[0x1E0D31A60], "faceCropFromPhotosFaceCropImageData:", a3);
}
...
void __41__HMDPhotoLibrary_photoLibraryDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v25 = 138543362;
    v26 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Photo Library did change", (uint8_t *)&v25, 0xCu);

  }
  objc_autoreleasePoolPop(v2);
  objc_msgSend(*(id *)(a1 + 40), "changedLocalIdentifiersForEntityClass:", objc_opt_class());
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = *MEMORY[0x1E0CD1C78];
  objc_msgSend(v6, "objectForKeyedSubscript:", *MEMORY[0x1E0CD1C78]);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    v29 = 2112;
    v30 = v13;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@anyPersonWasAdded: %@, changeDetails: %@", (uint8_t *)&v25, 0x20u);
  ...
  if (v19 == 1)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 138543362;
      v26 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Found changes for photo library persons", (uint8_t *)&v25, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_34649 != -1)
    dispatch_once(&logCategory__hmf_once_t8_34649, &__block_literal_global_174);
  return (id)logCategory__hmf_once_v9_34650;
}
...
void __30__HMDPhotoLibrary_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_34650;
  logCategory__hmf_once_v9_34650 = v0;
