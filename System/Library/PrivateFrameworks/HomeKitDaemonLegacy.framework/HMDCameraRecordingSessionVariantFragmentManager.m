...
- (void)handleVariantFragment:(id)a3
{
  ...
  if (v7 >= 4)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v5;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Selecting non-overlapping variant fragment: %@", (uint8_t *)&v23, 0x16u);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2048;
    v28 = v21 + 1;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Buffering variant fragment: %@, count: %lu", (uint8_t *)&v23, 0x20u);
        ...
        *(_OWORD *)&time1.value = v36;
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)((char *)&range.start.flags + 2) = v12;
          ...
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Selecting variant fragment: %@, overlapsFullFragment: %@", (uint8_t *)&range, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_110974 != -1)
    dispatch_once(&logCategory__hmf_once_t3_110974, &__block_literal_global_110975);
  return (id)logCategory__hmf_once_v4_110976;
}
...
void __62__HMDCameraRecordingSessionVariantFragmentManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_110976;
  logCategory__hmf_once_v4_110976 = v0;
