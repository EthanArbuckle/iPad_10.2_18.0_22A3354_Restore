...
- (id)removeAllAccessCodesWithValue:(id)a3 withUserUUID:(id)a4 guestName:(id)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v25 = v16;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@removeAllAccessCodesWithValue", buf, 0xCu);
...
- (id)removeAllHAPAccessCodesWithValue:(id)a3 forSpecificAccessory:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v30 = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@removeAllHAPAccessCodesWithValue", buf, 0xCu);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v31 = 2112;
    v32 = v7;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@removeAccessCodeWithValue for HAP was passed a non HAP accessory or does not support access codes: %@", buf, 0x16u);
...
{
  return (id)objc_msgSend(MEMORY[0x1E0D519C0], "futureWithResult:", MEMORY[0x1E0C9AA60], a4, a5);
}
...
- (id)removeAccessCodeWithValue_Matter:(id)a3 fromAccessory:(id)a4 withUserUUID:(id)a5 guestName:(id)a6
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v48 = 2112;
    v49 = v20;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@removeAllAccessCodesWithValue_Matter fromAccessory: %@", buf, 0x16u);
...
- (id)_readAccessCodeWithIdentifier:(id)a3 accessoryUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v33 = 2112;
    v34 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Reading access code for identifier: %@ from accessoryUUID: %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v8);
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", v6);
  v26 = v12;
  v27 = v7;
  ...
  {
    v20 = (void *)MEMORY[0x1E0D519C0];
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 11, CFSTR("Failed to create read write requests"));
    v16 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_readConstraintsAndAccessCodesFromAccessoriesWithUUIDs:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Reading constraints and access codes from accessories with UUIDs: %@", buf, 0x16u);
  ...
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Caller submitted empty array of accessory UUIDs", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v12);
    (*((void (**)(id, _QWORD, _QWORD))v7 + 2))(v7, MEMORY[0x1E0C9AA60], MEMORY[0x1E0C9AA60]);
  }
  else
  {
...
- (id)performAccessCodeModificationRequests:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v31 = 2112;
    v32 = v6;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Performing access code modification requests: %@", buf, 0x16u);
  ...
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Caller submitted empty modification requests", buf, 0xCu);
...
- (id)performAccessCodeModificationRequests_HAP:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v6;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Performing access code modification requests HAP: %@", buf, 0x16u);
  ...
  else
  {
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "na_map:", &__block_literal_global_61);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v15, "hmf_isEmpty"))
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v26 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Did not find any valid write requests to perform", buf, 0xCu);
    ...
    else
    {
      ...
      v23[1] = 3221225472;
      v23[2] = __92__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_HAP_withRetries___block_invoke_62;
      v23[3] = &unk_1E89A2E00;
      v23[4] = v10;
      v24 = v14;
...
{
  return (id)objc_msgSend(MEMORY[0x1E0D519C0], "futureWithResult:", MEMORY[0x1E0C9AA60], a4);
}
...
- (id)performModificationRequest_Matter:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v83 = 2112;
    v84 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Performing access code modification request Matter: %@", buf, 0x16u);
...
LABEL_16:
  ...
  if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v82 = v50;
    _os_log_impl(&dword_1CD062000, v49, OS_LOG_TYPE_ERROR, "%{public}@Found HMAccessCodeModificationRequestValue of unknown type", buf, 0xCu);
  ...
  v45 = v62;
  v38 = MEMORY[0x1E0C809B0];
  v43 = (_QWORD *)&unk_1CDB8E000;
LABEL_24:

  v68 = v38;
  v69 = v43[202];
  v53 = v69;
  v70 = __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_65;
  v71 = &unk_1E89A2E50;
  v72 = v26;
  v73 = v42;
  v54 = v38;
  ...
  v66[0] = v54;
  v66[1] = v53;
  v66[2] = __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_3_69;
  v66[3] = &unk_1E89A2E78;
  v66[4] = v8;
  v67 = v55;
  v59 = v55;
...
- (id)_readConstraintsFromAccessoriesWithUUIDs:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading constraints from accessories with UUIDs: %@", buf, 0x16u);
  ...
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Caller submitted empty array of accessory UUIDs", buf, 0xCu);
...
- (id)_readConstraintsFromAccessoriesWithUUIDs_HAP:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v24 = 2112;
    v25 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading constraints from HAP accessories with UUIDs: %@", buf, 0x16u);
  ...
  else
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 11, CFSTR("Failed to create constraints read requests"));
      v17 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_readConstraintsFromAccessory_Matter:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading constraints from accessory: %@", buf, 0x16u);
  ...
  v21[0] = v15;
  v21[1] = 3221225472;
  v21[2] = __87__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries___block_invoke_78;
  v21[3] = &unk_1E89A2E78;
  v21[4] = v8;
  v22 = v16;
  v18 = v16;
...
- (id)_readAccessCodesFromAccessoriesWithUUIDs:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading access codes from accessories with UUIDs: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Reading access codes from HAP accessories with UUIDs: %@", buf, 0x16u);
    ...
    if (v12)
    {
      ...
      v22[0] = v14;
      v22[1] = 3221225472;
      v22[2] = __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_81;
      v22[3] = &unk_1E89A2D70;
      v22[4] = v9;
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 11, CFSTR("Failed to create list write requests"));
      v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_readAccessCodesFromAccessory_Matter:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v25 = 2112;
    v26 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Reading access codes from Matter accessory: %@", buf, 0x16u);
...
- (id)_fetchResponseFromCredentialUserTuples:(id)a3 accessory:(id)a4 doorLock:(id)a5
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_alloc(MEMORY[0x1E0CBA1B8]);
...
- (id)_createConstraintsReadRequestsForAccessoriesWithUUIDs:(id)a3
{
  ...
  if (v3)
  {
    objc_msgSend(v3, "na_map:", &__block_literal_global_96);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (id)_characteristicsOfType:(id)a3 fromAccessoriesWithUUIDs:(id)a4
{
  ...
  if (v13 == objc_msgSend(v11, "count"))
  {
    v27 = v10;
    v28 = 3221225472;
    v29 = __86__HMDAccessoryAccessCodeReaderWriter__characteristicsOfType_fromAccessoriesWithUUIDs___block_invoke_99;
    v30 = &unk_1E89A2FF0;
    v14 = v6;
    v31 = v14;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v40 = 2112;
        v41 = v15;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not find access code control point characteristics of type: %@ for all accessories: %@. Found characteristics: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v38 = 2112;
      v39 = v12;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not find all accessories with UUIDs: %@. Only found the subset of accessories: %@", buf, 0x20u);
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v28;
            ...
            v39 = 2112;
            v40 = v10;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not create read write requests because failed to find hap accessory with UUID: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v28;
            ...
            v39 = 2112;
            v40 = v13;
            _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not create read write requests because failed to find access code control point characteristic on accessory: %@", buf, 0x16u);
...
uint64_t __86__HMDAccessoryAccessCodeReaderWriter__characteristicsOfType_fromAccessoriesWithUUIDs___block_invoke_99(uint64_t a1, void *a2)
{
...
id __96__HMDAccessoryAccessCodeReaderWriter__fetchResponseFromCredentialUserTuples_accessory_doorLock___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v52 = 2112;
    v53 = v9;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating fetch response from credential: %@, user: %@", buf, 0x20u);
  ...
  if ((v15 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v56 = 2112;
      v57 = v34;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Dropping userUniqueId because the user's creatorFabricIndex does not match the currentFabricIndex. credential: %@, creatorFabricIndex: %@, currentFabricIndex: %@, accessory: %@", buf, 0x34u);
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = objc_msgSend(v17, "isEqualToNumber:", *MEMORY[0x1E0D33268]);
...
LABEL_11:
    ...
    v38 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1A0]), "initWithStringValue:", v37);
    v39 = objc_alloc(MEMORY[0x1E0CBA1C0]);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v52 = 2112;
    v53 = v24;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Dropping credential because it is the COTA home user: %@, accessory: %@", buf, 0x20u);
...
id __87__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessory_Matter_withRetries___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to read access codes from Matter accessory: %@, with error: %@", (uint8_t *)&v15, 0x20u);

  }
  objc_autoreleasePoolPop(v4);
  v9 = objc_alloc(MEMORY[0x1E0CBA1B8]);
  objc_msgSend(*(id *)(a1 + 40), "uuid");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 52);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Got list responses", (uint8_t *)&v11, 0xCu);
...
id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_81(uint64_t a1, uint64_t a2)
{
  void *v2;
  void *v3;
  void *v4;
...
id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Access code fetch responses from read: %@", buf, 0x16u);
  ...
  v17[1] = 3221225472;
  v17[2] = __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_82;
  v17[3] = &unk_1E89C2198;
  v18 = v4;
  v10 = v4;
  objc_msgSend(v9, "na_filter:", v17);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "na_map:", &__block_literal_global_87);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
BOOL __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_82(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  v9[1] = 3221225472;
  v9[2] = __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_2_83;
  v9[3] = &unk_1E89A2EC8;
  v10 = v3;
  v5 = v3;
...
id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_3_85(uint64_t a1, void *a2)
{
  objc_class *v2;
  id v3;
  id v4;
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA1B8];
  v3 = a2;
  v4 = [v2 alloc];
...
uint64_t __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_2_83(uint64_t a1, void *a2)
{
  void *v2;
  uint64_t v3;
...
id __87__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries___block_invoke_78(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@All retries failed to read constraint from accessory: %@", (uint8_t *)&v15, 0x16u);

  }
  objc_autoreleasePoolPop(v4);
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA160]), "initWithAllowedCharacterSets:minimumLength:maximumLength:maximumAllowedAccessCodes:", 1, 4, 8, 50);
  v10 = objc_alloc(MEMORY[0x1E0CBA1B0]);
  objc_msgSend(*(id *)(a1 + 40), "uuid");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
id __87__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    {
      v8 = v7;
      v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA160]), "initWithAllowedCharacterSets:minimumLength:maximumLength:maximumAllowedAccessCodes:", 1, objc_msgSend(v7, "integerValue"), objc_msgSend(v5, "integerValue"), 50);
      v10 = objc_alloc(MEMORY[0x1E0CBA1B0]);
      objc_msgSend(*(id *)(a1 + 40), "uuid");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = (void *)objc_msgSend(v10, "initWithAccessory:constraints:error:", v11, v9, 0);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 138543362;
        v27 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Failed to read min pin code length constraint from accessory", (uint8_t *)&v26, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 138543362;
      v27 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to read max pin code length constraint from accessory", (uint8_t *)&v26, 0xCu);
...
id __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_65(uint64_t a1)
{
  void *v2;
  id v3;
  uint64_t v4;
  ...
  v7[1] = 3221225472;
  v7[2] = __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_2_66;
  v7[3] = &unk_1E89A2E28;
  v2 = *(void **)(a1 + 32);
  v8 = *(id *)(a1 + 40);
  v3 = *(id *)(a1 + 48);
...
id __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_3_69(uint64_t a1, void *a2)
{
  void *v3;
  id v4;
  void *v5;
...
id __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_2_66(uint64_t a1, void *a2)
{
  objc_class *v3;
  id v4;
  void *v5;
  ...
  v3 = (objc_class *)MEMORY[0x1E0CBA1A0];
  v4 = a2;
  v5 = (void *)objc_msgSend([v3 alloc], "initWithStringValue:", *(_QWORD *)(a1 + 32));
  v6 = objc_alloc(MEMORY[0x1E0CBA1C0]);
  ...
  v9 = objc_alloc(MEMORY[0x1E0CBA170]);
  objc_msgSend(*(id *)(a1 + 40), "accessoryUUID");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
id __92__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_HAP_withRetries___block_invoke_62(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  void *v5;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received modification responses: %@", (uint8_t *)&v11, 0x16u);
...
void __104__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v30 = 2112;
      v31 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to read constraints from accessories with uuids: %@, error: %@", buf, 0x20u);
  ...
  v22[1] = 3221225472;
  v22[2] = __104__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_completion___block_invoke_57;
  v22[3] = &unk_1E89BFF60;
  v18 = *(void **)(a1 + 40);
  v22[4] = *(_QWORD *)(a1 + 32);
  v23 = v18;
...
void __104__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_completion___block_invoke_57(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  void *v7;
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to read access codes from accessories with uuids: %@, error: %@", (uint8_t *)&v12, 0x20u);
...
id __82__HMDAccessoryAccessCodeReaderWriter__readAccessCodeWithIdentifier_accessoryUUID___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 15, CFSTR("Response without access code value"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
...
id __108__HMDAccessoryAccessCodeReaderWriter_removeAccessCodeWithValue_Matter_fromAccessory_withUserUUID_guestName___block_invoke_6(uint64_t a1, void *a2)
{
  ...
  v3 = (objc_class *)MEMORY[0x1E0CBA1C0];
  v4 = a2;
  v5 = [v3 alloc];
  ...
  v8 = objc_alloc(MEMORY[0x1E0CBA170]);
  objc_msgSend(*(id *)(a1 + 32), "uuid");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
id __92__HMDAccessoryAccessCodeReaderWriter_removeAllHAPAccessCodesWithValue_forSpecificAccessory___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v7, "na_map:", &__block_literal_global_4038);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
id __92__HMDAccessoryAccessCodeReaderWriter_removeAllHAPAccessCodesWithValue_forSpecificAccessory___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    v5 = objc_alloc(MEMORY[0x1E0CBA170]);
    objc_msgSend(v3, "accessoryUUID");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = *(_QWORD *)(a1 + 32);
    objc_msgSend(v3, "error");
...
id __92__HMDAccessoryAccessCodeReaderWriter_removeAllHAPAccessCodesWithValue_forSpecificAccessory___block_invoke_5(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA180];
  v3 = a2;
  ...
  if (v25)
  {
    ...
    while (2)
    {
      for (i = 0; i != v25; ++i)
      {
        ...
        v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16398]), "initWithValue:", 2);
        objc_msgSend(v3, "objectForKey:", v5);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v7, "na_map:", &__block_literal_global_104);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16378]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v6, v8, 0);
        v26 = 0;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            v39 = 2112;
            v40 = v11;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control write request: %@, to read access codes with identifiers: %@, from characteristic: %@, with error: %@", buf, 0x34u);
      ...
      do
      {
        ...
        if (v16)
        {
          ...
          if (v17)
          {
            ...
            v23 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v23, "na_firstObjectPassingTest:", &__block_literal_global_109);
            v24 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            v9 = v44;
            v29 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1B8]), "initWithAccessoryUUID:accessoryAccessCodeValues:error:", v21, v22, v26);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = v40;
              ...
              v57 = 2112;
              v58 = v12;
              _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v55 = 2112;
            v56 = v12;
            _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to find accessory UUID for write request: %@", buf, 0x16u);
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        if (v13)
        {
          ...
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v15, "na_map:", &__block_literal_global_112);
          v16 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v26;
            ...
            v38 = 2112;
            v39 = v12;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x20u);
...
+ (id)createConstraintsFromReadResponses:(id)a3 readRequests:(id)a4
{
  ...
  v6 = a3;
  objc_msgSend(a4, "na_map:", &__block_literal_global_114);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v11[0] = MEMORY[0x1E0C809B0];
  v11[1] = 3221225472;
...
+ (id)_accessCodeControlFromWriteResponses:(id)a3 forWriteRequest:(id)a4
{
  ...
  if (v9)
  {
    ...
    {
      v32 = v10;
      objc_msgSend(MEMORY[0x1E0D16378], "parsedFromData:error:", v11, &v32);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v15 = v32;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v36 = 2112;
          v37 = v11;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v36 = 2112;
        v37 = v11;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Characteristic response value: %@ is not of expected type NSData", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v40 = 2112;
      v41 = v10;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Failed to parse characteristic response for characteristic: %@, in payload: %@, with error: %@", buf, 0x2Au);
      ...
      do
      {
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v36;
            ...
            v52 = 2112;
            v53 = v12;
            _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x20u);
          ...
          v23 = (void *)objc_claimAutoreleasedReturnValue();
          v24 = v23;
          v25 = &__block_literal_global_119;
          goto LABEL_15;
        }
        objc_msgSend(v13, "accessCodeControlResponse");
        v15 = objc_claimAutoreleasedReturnValue();
              ...
              v18))
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v49 = v22;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Received HAPAccessCodeControl object that does not contain any HAPAccessCodeControlResponses", buf, 0xCu);
          ...
          v23 = (void *)objc_claimAutoreleasedReturnValue();
          v24 = v23;
          v25 = &__block_literal_global_121;
LABEL_15:
...
+ (id)genericModificationResponseForFailedRequest:(id)a3
{
  ...
  if (v5)
  {
    v12 = objc_alloc(MEMORY[0x1E0CBA170]);
  ...
  {
    v21 = objc_alloc(MEMORY[0x1E0CBA170]);
    if (v8)
    {
...
+ (id)modificationResponseForFailedMatterRequest:(id)a3 error:(id)a4
{
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v12;
  if (v12 != (void *)*MEMORY[0x1E0D33258])
  {
...
LABEL_15:
  ...
  if (v8)
  {
    v15 = objc_alloc(MEMORY[0x1E0CBA170]);
    objc_msgSend(v8, "accessoryUUID");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "accessCodeValue");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2602);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = v15;
    v20 = v16;
    v21 = 0;
  ...
  else
  {
    if (!v11)
      goto LABEL_15;
    v24 = objc_alloc(MEMORY[0x1E0CBA170]);
    objc_msgSend(v11, "accessoryUUID");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "accessoryAccessCodeValue");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)modificationResponseForControlResponse:(id)a3 operationType:(int64_t)a4 accessoryUUID:(id)a5
{
  ...
  if (!v10)
    goto LABEL_7;
  v11 = objc_alloc(MEMORY[0x1E0CBA1A0]);
  objc_msgSend(v7, "accessCode");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v15)
  {
    v16 = objc_alloc(MEMORY[0x1E0CBA1C0]);
    objc_msgSend(v7, "identifier");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_15:
  ...
  if (a4 == 3)
    ...
    v27 = v26;
  v28 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA170]), "initWithAccessoryUUID:accessoryAccessCodeValue:accessCodeValue:operationType:error:", v9, v19, v10, v27, v20);
...
+ (int64_t)hmPrivateErrorCodeForHAPAccessCodeError:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Encountered an error type that likely indicates a bug: %@", (uint8_t *)&v11, 0x16u);
        ...
        if (!v22)
        {
          ...
          if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v48;
            ...
            v68 = 2112;
            v69 = v21;
            _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_ERROR, "%{public}@Not submitting modification requests because did not find an accessory with UUID: %@", buf, 0x16u);
...
LABEL_35:
        ...
        if (v24)
        {
          ...
          v25 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v25, "na_map:", &__block_literal_global_127);
          ...
          objc_msgSend(v6, "objectForKeyedSubscript:", v21);
          v29 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v29, "na_map:", &__block_literal_global_130);
          v30 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          objc_msgSend(v6, "objectForKeyedSubscript:", v21);
          v34 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v34, "na_map:", &__block_literal_global_132);
          v35 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        else
        {
          ...
          if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v48;
            ...
            v68 = 2112;
            v69 = v23;
            _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Not submitting modification requests because did not find an access code control point on accessory: %@", buf, 0x16u);
...
+ (id)createWriteRequestForAddRequests:(id)a3 characteristic:(id)a4
{
  ...
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16398]), "initWithValue:", 3);
    objc_msgSend(v6, "na_map:", &__block_literal_global_134);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16378]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v9, v10, 0);
    v20 = 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v27 = 2112;
        v28 = v13;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control write request: %@, for add requests: %@, with error: %@", buf, 0x2Au);
...
+ (id)createWriteRequestForUpdateRequests:(id)a3 characteristic:(id)a4
{
  ...
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16398]), "initWithValue:", 4);
    objc_msgSend(v6, "na_map:", &__block_literal_global_136);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16378]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v9, v10, 0);
    v20 = 0;
    objc_msgSend(v11, "serializeWithError:", &v20);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v27 = 2112;
        v28 = v13;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control write request: %@, for update requests: %@, with error: %@", buf, 0x2Au);
...
+ (id)createWriteRequestForRemoveRequests:(id)a3 characteristic:(id)a4
{
  ...
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16398]), "initWithValue:", 5);
    objc_msgSend(v6, "na_map:", &__block_literal_global_138);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16378]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v9, v10, 0);
    v20 = 0;
    objc_msgSend(v11, "serializeWithError:", &v20);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t77 != -1)
    dispatch_once(&logCategory__hmf_once_t77, &__block_literal_global_140);
...
id __89__HMDAccessoryAccessCodeReaderWriter_createWriteRequestForRemoveRequests_characteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0D16610];
  v3 = a2;
  v4 = [v2 alloc];
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16380]), "initWithIdentifier:accessCode:", v7, 0);
  return v8;
}
...
id __89__HMDAccessoryAccessCodeReaderWriter_createWriteRequestForUpdateRequests_characteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  v8 = objc_alloc(MEMORY[0x1E0D16380]);
...
id __86__HMDAccessoryAccessCodeReaderWriter_createWriteRequestForAddRequests_characteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0D16380];
  v3 = a2;
  v4 = [v2 alloc];
  objc_msgSend(v3, "accessCodeValue");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
id __96__HMDAccessoryAccessCodeReaderWriter_createWriteRequestsForModificationRequests_hapAccessories___block_invoke_125(uint64_t a1, void *a2)
{
  id v2;
  void *v3;
  id v4;
...
id __98__HMDAccessoryAccessCodeReaderWriter_createModificationResponsesForWriteResponses_ofRequestPairs___block_invoke_120(uint64_t a1, uint64_t a2)
{
...
id __86__HMDAccessoryAccessCodeReaderWriter_createConstraintsFromReadResponses_readRequests___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA160]), "initWithAllowedCharacterSets:minimumLength:maximumLength:maximumAllowedAccessCodes:", 1, 4, 8, 200);
  v6 = *(void **)(a1 + 32);
  v49 = 0;
  ...
  if (v7)
  {
    ...
    {
      v48 = v8;
      objc_msgSend(MEMORY[0x1E0D16370], "parsedFromData:error:", v9, &v48);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      v44 = v48;
      ...
      if (v12)
      {
        ...
        v42 = v14 == 1;
        v41 = objc_alloc(MEMORY[0x1E0CBA160]);
        ...
        v23 = (void *)v47;
        v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1B0]), "initWithAccessory:constraints:error:", v47, v22, 0);
        v5 = v46;
      }
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v52 = 2112;
          v53 = v9;
          _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v35);
        v39 = objc_alloc(MEMORY[0x1E0CBA1B0]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v52 = 2112;
        v53 = v9;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Characteristic response value: %@ is not of expected type NSData", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v30);
      v34 = objc_alloc(MEMORY[0x1E0CBA1B0]);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", -1);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      v5 = v46;
      v23 = (void *)v47;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v56 = 2112;
      v57 = v8;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristic response for characteristic: %@, in payload: %@, with error: %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v25);
    v23 = (void *)v47;
    v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1B0]), "initWithAccessory:constraints:error:", v47, v5, v8);
  }
...
LABEL_10:
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, v21, (uint8_t *)&v24, 0x20u);
...
LABEL_11:
  ...
  v8 = objc_alloc(MEMORY[0x1E0CBA1C0]);
  v9 = *(_QWORD *)(a1 + 40);
...
BOOL __100__HMDAccessoryAccessCodeReaderWriter_accessCodeFetchResponsesForReadWriteResponses_ofWriteRequests___block_invoke_107(uint64_t a1, void *a2)
{
  void *v2;
  _BOOL8 v3;
...
id __81__HMDAccessoryAccessCodeReaderWriter__createListWriteRequestsForCharacteristics___block_invoke(uint64_t a1, void *a2)
{
  ...
  v21 = *MEMORY[0x1E0C80C00];
  v3 = a2;
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16398]), "initWithValue:", 1);
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16378]), "initWithOperationType:accessCodeControlRequest:accessCodeControlResponse:", v4, 0, 0);
  v14 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control list request: %@, with error: %@", buf, 0x20u);
