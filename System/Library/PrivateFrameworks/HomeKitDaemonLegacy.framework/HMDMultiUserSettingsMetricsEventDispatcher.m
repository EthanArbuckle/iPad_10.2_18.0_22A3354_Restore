...
- (void)submitMultiUserSettingsDailyEvent
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Submitting multi user settings daily event", (uint8_t *)&v21, 0xCu);
...
LABEL_14:
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@numSharedUsers is %@. Don't submit logs", (uint8_t *)&v21, 0x16u);
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v21 = 138543362;
    v22 = v15;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@No DataSource is set for submitMultiUserSettingsDailyEvent", (uint8_t *)&v21, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_24741 != -1)
    dispatch_once(&logCategory__hmf_once_t3_24741, &__block_literal_global_24742);
  return (id)logCategory__hmf_once_v4_24743;
}
...
void __57__HMDMultiUserSettingsMetricsEventDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_24743;
  logCategory__hmf_once_v4_24743 = v0;
