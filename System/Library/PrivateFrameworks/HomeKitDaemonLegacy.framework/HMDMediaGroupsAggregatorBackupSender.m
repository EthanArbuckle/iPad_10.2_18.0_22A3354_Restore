...
- (void)_sendBackupToParticipantAccessoryUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending backup group data message to participant accessory uuid: %@", (uint8_t *)&v14, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v4;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get backup groups to send for participant accessory uuid: %@", (uint8_t *)&v14, 0x16u);
...
- (void)_sendBackupToFirstPartyParticipantAccessoryUUID:(id)a3 backupGroups:(id)a4
{
  ...
  v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285F8]), "initWithName:destination:payload:", CFSTR("HMDMediaGroupsBackupDataMessage"), v11, v8);
  v21 = 0;
  v22 = &v21;
  v23 = 0x3032000000;
  v24 = __Block_byref_object_copy__41793;
  v25 = __Block_byref_object_dispose__41794;
...
- (void)routeBackedUpGroupsMessage:(id)a3 toParticipantAccessoryUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2112;
    v27 = v13;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Routing message: %@(%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to route backup group data due to no router found for participant accessory UUID: %@", buf, 0x16u);
...
- (void)locallyRouteGroupsBackupDataMessage:(id)a3 toParticipantAccessoryUUID:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to locally route due to no receiver for groups backup data message: %@", (uint8_t *)&v15, 0x16u);
...
- (id)backupGroupsForParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get backup groups for participant accessory uuid: %@ due to no data source", (uint8_t *)&v13, 0x16u);
...
- (id)routerParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get router for participant accessory uuid: %@ due to no data source", (uint8_t *)&v13, 0x16u);
...
- (id)receiverForParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get receiver for participant accessory uuid: %@ due to no data source", (uint8_t *)&v13, 0x16u);
...
- (void)createNewBackupTimerForParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new backup timer due to no provider", (uint8_t *)&v12, 0xCu);
...
- (void)markAttemptForParticipantAccessoryUUID:(id)a3 withMessageIdentifier:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to mark backup timer attempt due to no timer for accessory UUID: %@", (uint8_t *)&v14, 0x16u);
...
- (void)didFireTimerForMediaGroupsAggregateBackupMessageTimer:(id)a3
{
  ...
  if (v6 && v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Backup timer fired for participant accessory uuid: %@", (uint8_t *)&v13, 0x16u);
...
void __101__HMDMediaGroupsAggregatorBackupSender__sendBackupToFirstPartyParticipantAccessoryUUID_backupGroups___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Groups backup data message responded with error: %@", (uint8_t *)&v11, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17 != -1)
    dispatch_once(&logCategory__hmf_once_t17, &__block_literal_global_41807);
