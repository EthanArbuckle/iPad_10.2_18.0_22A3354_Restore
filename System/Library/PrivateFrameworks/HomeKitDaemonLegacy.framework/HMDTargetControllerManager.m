...
- (HMDTargetControllerManager)initWithTargetControllerAccessory:(id)a3 targets:(id)a4
{
  ...
  v68->_buttonConfiguration = (NSArray *)MEMORY[0x1E0C9AA60];
...
LABEL_14:
      ...
      if (v25)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v84 = 2048;
          v85 = v29;
          _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Unable to look up the target with UUID %@ - adding with identifier %lu", buf, 0x20u);
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v86 = 2112;
        v87 = v43;
        _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Attempting to initialize target with UUID %@ for a controller %@/%@ that is not configured with a home", buf, 0x2Au);
...
LABEL_22:
  ...
  if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v82 = 2112;
    v83 = v57;
    _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, "%{public}@Initializing target controller manager with targets %@", buf, 0x16u);

    v8 = v68;
  }

  objc_autoreleasePoolPop(v53);
  objc_msgSend(*(id *)(v18 + 2000), "defaultCenter");
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating target controller manager", (uint8_t *)&v8, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v21;
            ...
            v32 = 2112;
            v33 = v18;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Target %@/%@ does not have a UUID", buf, 0x20u);
...
- (id)__refreshedConfiguration:(id)a3
{
  ...
  if (-[HMDTargetControllerManager configurationRefreshed](self, "configurationRefreshed"))
  {
    if (v4)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDTargetControllerManager ticksPerSecond](self, "ticksPerSecond"));
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v20[0] = v5;
...
- (void)_readSupportedConfigurationWithCompletion:(id)a3
{
  ...
  -[HMDTargetControllerManager controller](self, "controller");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB8A90], *MEMORY[0x1E0CB9AE8]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
...
LABEL_7:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(id *)((char *)location + 4) = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@No Supported target Configuration characteristic to refresh the configuration for the controller", (uint8_t *)location, 0xCu);
...
- (void)_refreshConfigurationWithCompletion:(id)a3
{
  ...
  if (-[HMDTargetControllerManager configurationRefreshed](self, "configurationRefreshed"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Configuration was already refreshed - skipping this request...", (uint8_t *)&buf, 0xCu);
  ...
  else
  {
    ...
    *((_QWORD *)&buf + 1) = &buf;
    v31 = 0x3032000000;
    v32 = __Block_byref_object_copy__52637;
    v33 = __Block_byref_object_dispose__52638;
    v34 = 0;
    ...
    v25[1] = v25;
    v25[2] = 0x3032000000;
    v25[3] = __Block_byref_object_copy__52637;
    v25[4] = __Block_byref_object_dispose__52638;
    v26 = 0;
    v23[0] = 0;
    v23[1] = v23;
    v23[2] = 0x3032000000;
    v23[3] = __Block_byref_object_copy__52637;
    v23[4] = __Block_byref_object_dispose__52638;
    v24 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v13 = 2048;
      v14 = 1;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Encoding for list target - operation %lu", buf, 0x16u);
...
- (void)_listTargetsWithCompletionHandler:(id)a3
{
  ...
  -[HMDTargetControllerManager controller](self, "controller");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB8AD8], *MEMORY[0x1E0CB9AE8]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
    v22 = 0;
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v8;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Unable to generate serialized data for listing targets - error %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v16;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@No Target List characteristic to audit configured target accessories - skipping", buf, 0xCu);
...
- (void)_auditTargets:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v69 = 2112;
    v70 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Read targets %@, Configured targets %@", buf, 0x20u);
      ...
      for (j = 0; j != v24; ++j)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v67 = 2112;
          v68 = v27;
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Target %@ not present in controller's target list - adding...", buf, 0x16u);
      ...
      for (k = 0; k != v36; ++k)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v67 = 2112;
          v68 = v39;
          _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Target %@ present in controller's target list - removing...", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v48 = 2112;
                v49 = v33;
                _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Encoding for update target - identifier %lu  updatedName %@  buttonConfiguration: %@", buf, 0x2Au);

                v13 = v36;
              }

              objc_autoreleasePoolPop(v29);
              objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v51[0]);
...
- (void)_updateName:(id)a3 buttonConfiguration:(id)a4 target:(id)a5
{
  ...
  if (v10)
  {
    if (v8 || objc_msgSend(v9, "count"))
    {
      -[HMDTargetControllerManager controller](self, "controller");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v11, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB8AD8], *MEMORY[0x1E0CB9AE8]);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      if (v12)
      {
        v51 = 0;
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_QWORD *)((char *)&buf[2] + 12) = v20;
            _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for updating %@/%@ with name %@  buttonConfiguration %@", (uint8_t *)buf, 0x34u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)((char *)&buf[2] + 12) = v32;
          _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for updating %@/%@ with name %@  buttonConfiguration %@", (uint8_t *)buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)buf + 14) = v8;
      WORD3(buf[1]) = 2112;
      *((_QWORD *)&buf[1] + 1) = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Request to update name %@  buttonConfiguration %@ for a nil target", (uint8_t *)buf, 0x20u);
...
LABEL_9:
            ...
            else
            {
              ...
              if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138544386;
                ...
                v79 = v28;
                v29 = (void *)v28;
                _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Adding TLVs for add target operation - identifier %lu  name %s  category %lu  buttonConfiguration: %@", buf, 0x34u);
    ...
    objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v69[0]);
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v69 = 2112;
          v70 = v4;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for adding targets %@", buf, 0x16u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v69 = 2112;
                  v70 = v29;
                  _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@Target being added %@ does not have a UUID", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v69 = 2112;
        v70 = v4;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for adding targets %@", buf, 0x16u);
...
- (id)_dataForRemoveTargets:(id)a3 outError:(id *)a4
{
  ...
  else
  {
        ...
        for (i = 0; i != v11; ++i)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v36 = 2048;
            v37 = v26;
            _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Encoding for remove target - operation %lu  identifier %lu", buf, 0x20u);
    ...
    objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v60);
    v9 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
      ...
      if (v40)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v57 = 2112;
          v58 = v40;
          _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for removing targets %@ - error %@", buf, 0x20u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v55 = 2112;
                  v56 = v22;
                  _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Target being removed %@ does not have a UUID", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v55 = 2112;
        v56 = v4;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for removing targets %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v20 = 2112;
        v21 = v13;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Attempt to remove a target %@/%@ that cannot be looked up in target controller manager", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v13 = 2048;
      v14 = 4;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Encoding for reset target - operation %lu", buf, 0x16u);
...
- (void)_resetTargets
{
  ...
  -[HMDTargetControllerManager controller](self, "controller");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB8AD8], *MEMORY[0x1E0CB9AE8]);
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v20 = 2112;
        v21 = v6;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for resetting targets - error %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v19 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for resetting targets", buf, 0xCu);
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v32 = objc_claimAutoreleasedReturnValue();
          v15 = (void *)v32;
          _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Unable to look up target for identifier %@ while reading activeIdentifier characteristic %@/%@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v29 = 2112;
      v30 = v7;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Received a non-number (%@) for activeIdentifier characteristic %@", buf, 0x20u);
...
- (void)_handleActiveIdentifierReadResponses:(id)a3
{
  ...
  if (v4)
  {
    v5 = v4;
    v6 = *(_QWORD *)v29;
    v24 = *MEMORY[0x1E0CB9AE0];
    v21 = *MEMORY[0x1E0CB8798];
    v22 = self;
    v25 = *(_QWORD *)v29;
    do
    {
...
- (void)_registerForActiveIdentifierNotifications
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "addObserver:selector:name:object:", self, sel___characteristicEventsReceived_, *MEMORY[0x1E0D15EB8], 0);
  ...
  *(_OWORD *)location = 0u;
  ...
  {
    v7 = *(_QWORD *)v41;
    v8 = *MEMORY[0x1E0CB9AE0];
    v9 = *MEMORY[0x1E0CB8798];
    do
    {
      for (i = 0; i != v6; ++i)
      {
  ...
  if (objc_msgSend(v15, "count"))
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v47 = 2112;
      v48 = v15;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Registering for notification on active selection characteristics: %@", buf, 0x16u);
    ...
    v27 = (void *)MEMORY[0x1D17BA0A0](inited);
    v28 = v17;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v46 = v30;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Refreshing the active selections on the controller", buf, 0xCu);
...
- (void)__characteristicEventsReceived:(id)a3
{
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v26, "hmf_arrayForKey:", *MEMORY[0x1E0D15EC0]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = self;
  -[HMDTargetControllerManager controller](self, "controller");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    v8 = v7;
    v9 = *(_QWORD *)v33;
    v30 = *MEMORY[0x1E0CB9AE0];
    v28 = *MEMORY[0x1E0CB8798];
    v29 = v5;
    do
    {
      v10 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v19 = (void *)v33;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Attempting to lookup target %@/%@ for a controller %@/%@ that is not configured with a home", buf, 0x34u);
...
- (void)_handleConfigureTargets:(id)a3 responseHandler:(id)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB8AD8], *MEMORY[0x1E0CB9AE8]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
  {
    v11 = (void *)*MEMORY[0x1E0CB7E08];
    objc_msgSend(v6, "objectForKey:", *MEMORY[0x1E0CB7E08]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v17 = (void *)*MEMORY[0x1E0CB7CB0];
    objc_msgSend(v6, "objectForKey:", *MEMORY[0x1E0CB7CB0]);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_44:
    ...
    v22 = (void *)*MEMORY[0x1E0CB7978];
    objc_msgSend(v6, "objectForKey:", *MEMORY[0x1E0CB7978]);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_29:
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v99 = 2112;
        v100 = v70;
        _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@Attempting to configure targets for a controller %@/%@ that is not configured with a home", buf, 0x20u);
    ...
    v34 = (void *)*MEMORY[0x1E0CB7DD8];
    objc_msgSend(v6, "objectForKey:", *MEMORY[0x1E0CB7DD8]);
    v35 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (!v9)
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v59 = (void *)v102;
          _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_ERROR, "%{public}@Attempting to remove target %@ for a controller %@/%@ that is not configured with a home", buf, 0x2Au);
...
- (void)_configureTargetAccessories:(id)a3 reason:(id)a4 targetAccessories:(id)a5 responseHandler:(id)a6
{
  ...
  -[HMDTargetControllerManager controller](self, "controller");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v14, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB8AD8], *MEMORY[0x1E0CB9AE8]);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  if (v15)
  {
    objc_initWeak(&location, self);
...
void __44__HMDTargetControllerManager_updateTargets___block_invoke(uint64_t a1)
{
  ...
  void *v9;
  void *v10;
  HMDTargetConfiguration *v11;
  void *v12;
  HMDTargetConfiguration *v13;
  void *v14;
  id v15;
  NSObject *v16;
  void *v17;
  ...
  v63 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v63, "home");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(v1 + 32), "targetUUIDs");
  v3 = objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99E20], "setWithArray:", *(_QWORD *)(v1 + 40));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v64 = (void *)v3;
  ...
  v65 = v2;
  v66 = v1;
  v73 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v79, v92, 16);
  if (v73)
  {
    v71 = *(_QWORD *)v80;
    do
    {
      for (i = 0; i != v73; ++i)
      {
        ...
        if (v9)
        {
          ...
          if (v10)
          {
            v11 = [HMDTargetConfiguration alloc];
            objc_msgSend(*(id *)(v1 + 32), "buttonConfiguration");
            v12 = (void *)objc_claimAutoreleasedReturnValue();
            v69 = v10;
            v13 = -[HMDTargetConfiguration initWithAccessory:buttonConfiguration:](v11, "initWithAccessory:buttonConfiguration:", v10, v12);
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v90 = 2112;
              v91 = v20;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@(Update) Adding target accessory %@/%@", buf, 0x20u);
            ...
            v22 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v21, "_addTargets:", v22);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v88 = 2112;
              v89 = v8;
              _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Cannot look up target accessory from UUID %@ to add", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v88 = 2112;
            v89 = v8;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Incorrectly formatted target UUID %@ to add", buf, 0x16u);
  ...
  objc_msgSend(MEMORY[0x1E0C99E20], "setWithArray:", v64);
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", *(_QWORD *)(v1 + 40));
  v32 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v76 = 0u;
  v70 = v31;
  v74 = objc_msgSend(v70, "countByEnumeratingWithState:objects:count:", &v75, v84, 16);
  if (v74)
  {
    v72 = *(_QWORD *)v76;
    while (2)
    {
      for (j = 0; j != v74; ++j)
      {
        ...
        v34 = *(void **)(*((_QWORD *)&v75 + 1) + 8 * j);
        v35 = objc_msgSend(objc_alloc(*(Class *)(v6 + 2600)), "initWithUUIDString:", v34);
        if (v35)
        {
          v36 = (void *)v35;
          objc_msgSend(v2, "accessoryWithUUID:", v35);
          v37 = objc_claimAutoreleasedReturnValue();
          if (v37)
          {
            v38 = (void *)v37;
            objc_msgSend(*(id *)(v1 + 32), "targetConfigurationMatchingAccessory:", v37);
            v39 = v1;
            v40 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            if (!v40)
            {
              if (v44)
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v90 = 2112;
                v91 = v62;
                _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Attempt to remove a target %@/%@ that cannot be looked up in target controller manager", buf, 0x20u);
            ...
            if (v44)
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v90 = 2112;
              v91 = v48;
              _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@(Update) Removing target accessory %@/%@", buf, 0x20u);
            ...
            v50 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v49, "_removeTargets:", v50);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v88 = 2112;
              v89 = v34;
              _os_log_impl(&dword_1CD062000, v57, OS_LOG_TYPE_INFO, "%{public}@Cannot look up target accessory from UUID %@ to remove", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v88 = 2112;
            v89 = v34;
            _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@Incorrectly formatted target UUID %@ to remove", buf, 0x16u);
...
void __50__HMDTargetControllerManager_autoConfigureTargets__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Preference set to auto-configure existing targets when new target controller is added - configuring them...", buf, 0xCu);
    ...
    v19 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "_addTargets:", v10));
    v20 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v10;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Saving targetUUIDs after auto-configuration of targets - %@", buf, 0x16u);
  ...
  if (objc_msgSend(v14, "count"))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v48 = 2112;
      v49 = v24;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@%@ for notifications from event characteristics on controller service %@/%@", buf, 0x2Au);
    ...
    if (*(_BYTE *)(v15 + 48))
    {
      objc_msgSend(*(id *)(v15 + 32), "findCharacteristicWithType:", *MEMORY[0x1E0CB8790]);
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      if (v25)
      {
        if (*(_BYTE *)(v15 + 48))
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v46 = 2112;
          v47 = v35;
          _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Unable to look up active characteirstic in controller %@ service %@ for active selection acknowledgement", buf, 0x20u);
...
LABEL_6:
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, v9, (uint8_t *)&v10, 0xCu);
...
void __45__HMDTargetControllerManager__removeTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for removing targets %@", (uint8_t *)&v18, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v12;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully removed targets %@ - response %@", (uint8_t *)&v18, 0x20u);
...
void __69__HMDTargetControllerManager_addTargetAccessory_buttonConfiguration___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v29 = 2112;
    v30 = v15;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding target accessory %@/%@ with button configuration %@ - target configuration %@", buf, 0x34u);
...
void __42__HMDTargetControllerManager__addTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for adding targets %@ - error %@", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v12;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully added targets %@ configuredTargets %@ - response %@", (uint8_t *)&v19, 0x2Au);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v35 = 2112;
      v36 = v11;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for updating %@/%@ with name %@  buttonConfiguration %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v37 = 2112;
      v38 = v15;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Successfully updated %@/%@ with name %@  buttonConfiguration %@ - response %@", buf, 0x3Eu);
        ...
        if (v10)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v22 = 2112;
            v23 = v7;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Updated the button configuration for target %@", buf, 0x16u);
...
uint64_t __66__HMDTargetControllerManager__refreshConfigurationWithCompletion___block_invoke_3(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "configurationRefreshed"))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v9;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Notifying supported configuration: Maximum Targets: %lu  Ticks Per Second: %lu  Buttons: %@", (uint8_t *)&v12, 0x2Au);
  ...
  if (WeakRetained)
  {
    if (objc_msgSend(v3, "count"))
    {
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v63 = 2112;
          v64 = (uint64_t)v7;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Error %@ response for reading characteristic %@", buf, 0x20u);
      ...
      else
      {
        ...
        v26 = (void *)objc_claimAutoreleasedReturnValue();
        v27 = objc_msgSend(v26, "isEqualToString:", *MEMORY[0x1E0CB8A90]);
          ...
          if (v31)
          {
            ...
            if (v31 == -6727)
            {
              ...
              if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v60 = v36;
                _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@No data to parse for supported configuration", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v61 = 2048;
                v62 = v32;
                _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_INFO, "%{public}@Parsing supported configuration data failed with error %lu", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v65 = 2112;
              v66 = v48;
              _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Refreshed supported configuration: Maximum Targets: %lu  Ticks Per Second: %lu  Buttons: %@", buf, 0x2Au);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v63 = 2112;
            v64 = (uint64_t)v7;
            _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@Got unexpected response - attempting to read %@, got %@", buf, 0x20u);
...
LABEL_40:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v60 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@No responses refreshing controller configuration", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v60 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for reading supported target configuration characteristic", buf, 0xCu);
...
void __49__HMDTargetControllerManager___accessoryRemoved___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v74 = 2112;
    v75 = (uint64_t)v12;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received notification that an accessory %@/%@ has been removed from the home", buf, 0x20u);
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Received notification that controller has been removed from the home - invalidating...", buf, 0xCu);
            ...
            if (v32)
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v74 = 2112;
                v75 = (uint64_t)v46;
                _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Received notification that target accessory %@/%@ has been removed", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v79 = v56;
        v21 = 0;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process accessory %@/%@ removal for a controller %@/%@ that is not configured with a home", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v74 = 2112;
      v75 = (uint64_t)v39;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Removed accessory %@/%@ does not support target control - ignoring", buf, 0x20u);
...
void __53__HMDTargetControllerManager___accessoryNameUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v72 = 2112;
    v73 = (uint64_t)v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of an accessory %@/%@ has been updated", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v5);
  if (objc_msgSend(v4, "supportsTargetControl"))
  {
    objc_msgSend(*(id *)(a1 + 40), "controller");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            if (v25)
            {
              ...
              if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v72 = 2112;
                v73 = (uint64_t)v34;
                _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of target accessory %@ has been updated to %@", buf, 0x20u);
              ...
              if ((v37 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  v74 = 2112;
                  v75 = v43;
                  _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Updating the name of target accessory %@/%@ to %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v72 = 2112;
        v73 = (uint64_t)v57;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process accessory name update with a controller %@/%@ that is not configured with a home", buf, 0x20u);
...
void __51__HMDTargetControllerManager___accessoryConnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v30 = 2112;
    v31 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Connected to accessory %@/%@", buf, 0x20u);
  ...
  if (v14)
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Connected to controller - refreshing the supported target configuration and auditing the list of targets", buf, 0xCu);
...
void __51__HMDTargetControllerManager___accessoryConnected___block_invoke_46(uint64_t a1, void *a2)
{
  ...
  if (v3 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Failed to refresh the supported target configuration - error %@", (uint8_t *)&v10, 0x16u);
...
void __54__HMDTargetControllerManager___accessoryDisconnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Disconnected from accessory %@/%@", (uint8_t *)&v23, 0x20u);
  ...
  if (v14)
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Disconnected from controller - marking configuation as stale", (uint8_t *)&v23, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_52684 != -1)
    dispatch_once(&logCategory__hmf_once_t6_52684, &__block_literal_global_52685);
  return (id)logCategory__hmf_once_v7_52686;
}
...
void __41__HMDTargetControllerManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_52686;
  logCategory__hmf_once_v7_52686 = v0;
