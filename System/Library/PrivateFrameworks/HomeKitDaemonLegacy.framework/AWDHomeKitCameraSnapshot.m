...
LABEL_14:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isLocal);
  ...
  {
LABEL_15:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_forNotification);
...
LABEL_16:
  ...
  if ((v15 & 0x10) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_sentSnapshotRequestToAccessory);
  ...
  if ((v15 & 8) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_receivedSnapshotFromAccessory);
