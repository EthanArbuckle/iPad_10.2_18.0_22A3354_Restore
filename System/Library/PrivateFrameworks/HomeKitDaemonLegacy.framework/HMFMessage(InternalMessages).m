...
+ (id)internalMessageWithName:()InternalMessages messagePayload:
{
  ...
  objc_msgSend(MEMORY[0x1E0D285F8], "internalMessageWithName:messagePayload:");
...
+ (id)internalMessageWithName:()InternalMessages messagePayload:responseHandler:
{
  ...
  objc_msgSend(MEMORY[0x1E0D285F8], "internalMessageWithName:messagePayload:responseHandler:");
  v0 = (void *)objc_claimAutoreleasedReturnValue();
  v1 = (void *)objc_msgSend(v0, "copy");
...
+ (id)internalMessageWithName:()InternalMessages destination:messagePayload:
{
  ...
  objc_msgSend(MEMORY[0x1E0D285F8], "internalMessageWithName:destination:messagePayload:");
  v0 = (void *)objc_claimAutoreleasedReturnValue();
  v1 = (void *)objc_msgSend(v0, "copy");
