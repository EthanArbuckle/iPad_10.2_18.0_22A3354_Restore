      ...
      do
      {
        ...
        if (!v23 && v21 != 0)
        {
          ...
          if (v33
            ...
            && (objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", v89, 4, 0),
                (v33 = (id)objc_claimAutoreleasedReturnValue()) != 0))
          {
            v34 = v30;
            v105 = 0;
            objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", v33, 1, &v105);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v117 = 2112;
                v118 = v36;
                _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize error %@: %@", buf, 0x20u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v117 = 2112;
                  v118 = v43;
                  _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@Updating notification context response to last known characteristic value %@ -> %@", buf, 0x20u);
    ...
    do
    {
      for (i = 0; i != v57; ++i)
      {
        ...
        if (v17)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v68 = 2112;
            v69 = v11;
            _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Missing required service (%@) properties for characteristic %@ - dropping the notification", buf, 0x20u);
        ...
        else
        {
          ...
          if (v34)
          {
            objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", v34, 1, 0);
            v35 = (void *)objc_claimAutoreleasedReturnValue();
            v36 = v33;
            v37 = v35;
...
- (id)notificationWithHome:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDCharacteristicResponseNotificationContext hasPendingMultiPartResponses](self, "hasPendingMultiPartResponses"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setObject:forKeyedSubscript:", v9, CFSTR("kMultiPartResponseKey"));

    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37C0]), "initWithName:object:userInfo:", CFSTR("HMDAccessoryCharacteristicsResponseReceivedNotification"), v4, v6);
  }
  else
  {
    v10 = 0;
