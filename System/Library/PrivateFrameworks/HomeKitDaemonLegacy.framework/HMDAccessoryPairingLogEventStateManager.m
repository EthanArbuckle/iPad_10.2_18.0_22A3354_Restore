...
- (void)configureWithPairingEvent:(id)a3 workQueue:(id)a4 logEventSubmitter:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2112;
    v26 = v16;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Configuring with workQueue %@ logEventSubmitter %@, from workQueue %@ logEventSubmitter %@", (uint8_t *)&v17, 0x34u);
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v28 = 2112;
      v29 = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling %@ %@", buf, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v19;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Not handling %@ logEventStateManager is not configured", buf, 0x16u);
...
- (void)_handleMatterAccessoryUpdatePairingMetricNotification:(id)a3 pairingEvent:(id)a4 logEventSubmitter:(id)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v84 = 2112;
    v85 = v17;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Handling %@", buf, 0x16u);
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v23;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not updating pairing metric because pairing event is nil", buf, 0xCu);
  ...
  if ((objc_msgSend(v9, "isMatterAccessory") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v25;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not updating pairing metric because pairing event is not for matter accessory", buf, 0xCu);
  ...
  if ((objc_msgSend(v9, "isAddOperation") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v27;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not updating pairing metric because pairing event is not add operation", buf, 0xCu);
  ...
  if (objc_msgSend(v9, "isSubmitted"))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not updating pairing metric because pairing event is already submitted", buf, 0xCu);
...
LABEL_18:
  ...
  if (objc_msgSend(v9, "isSubmitting"))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v29;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not updating pairing metric because pairing event is already being submitted", buf, 0xCu);
  ...
  if (v30 || v31 == 25)
  {
    context = (void *)MEMORY[0x1D17BA0A0](v31);
    v32 = v14;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v86 = 2112;
      v87 = v36;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Received update to pairing event when metric is completed already %@ %@", buf, 0x20u);
  ...
  if (contexta)
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v86 = 2048;
      v87 = contexta;
      _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Updating mtr metrics %p -> %p", buf, 0x20u);
  ...
  if (objc_msgSend(v78, "code") == 3)
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v84 = 2112;
      v85 = v78;
      _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to updating pairing metric with error %@", buf, 0x16u);
  ...
  else
  {
    if (!v78)
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v86 = 2112;
        v87 = v52;
        _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_INFO, "%{public}@Updating step %@ -> %@", buf, 0x20u);
    ...
    if (v77)
    {
      ...
      if (!v75)
      {
        ...
        if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v83 = v58;
          _os_log_impl(&dword_1CD062000, v57, OS_LOG_TYPE_ERROR, "%{public}@Received pairing error without source error domain", buf, 0xCu);
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v90 = 2112;
        v91 = v75;
        _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_INFO, "%{public}@Updating error %@ -> %@, sourceErrorDomain %@ -> %@", buf, 0x34u);
    ...
    if (v67)
    {
      v68 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryPairingLogEventStateManager fillUnknownErrorIfMissingErrorForPairingEvent:](v14, "fillUnknownErrorIfMissingErrorForPairingEvent:", v9));
      v69 = v14;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v70, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v9;
        _os_log_impl(&dword_1CD062000, v70, OS_LOG_TYPE_INFO, "%{public}@Submitting Event %@", buf, 0x16u);
...
- (void)fillUnknownErrorIfMissingErrorForPairingEvent:(id)a3
{
  ...
  if (v5 != 25 && !v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Filling unknown error before submission because pairing event is missing error", (uint8_t *)&v12, 0xCu);

    }
    objc_autoreleasePoolPop(v7);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmdErrorWithCode:", 1);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_6:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updated previous recoveryType to: %lu", (uint8_t *)&v12, 0x16u);
...
- (void)incrementRetryCount:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Incrementing retry count for identifier %@", (uint8_t *)&v15, 0x16u);
  ...
  if (v12)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", objc_msgSend(v12, "intValue") + 1);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDAccessoryPairingLogEventStateManager retryCountMap](v8, "retryCountMap");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    -[HMDAccessoryPairingLogEventStateManager retryCountMap](v8, "retryCountMap");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "setObject:forKeyedSubscript:", &unk_1E8B339A8, v4);
  }
...
- (void)_handlePairingStateProgressNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Received accessory pairing progress notification %@", (uint8_t *)&v11, 0x16u);
...
- (void)updatePairingProgressState:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Attempting to update an uninitialized progress state map for %@", (uint8_t *)&v17, 0x16u);
...
LABEL_12:
      v6 = (void *)MEMORY[0x1D17BA0A0](self);
      v7 = v3;
      HMFGetOSLogHandle();
      v8 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 2112;
        v20 = v12;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Updated Pairing UI state: %lu, recoveryType: %lu on progress: %@", (uint8_t *)&v13, 0x2Au);
...
- (id)getLastProgressStateForAccessory:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2114;
      v20 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Final pairing progress state map before metric submission for identifier %{public}@ - %{public}@", (uint8_t *)&v15, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t42_98948 != -1)
    dispatch_once(&logCategory__hmf_once_t42_98948, &__block_literal_global_98949);
  return (id)logCategory__hmf_once_v43_98950;
}
...
void __54__HMDAccessoryPairingLogEventStateManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v43_98950;
  logCategory__hmf_once_v43_98950 = v0;
