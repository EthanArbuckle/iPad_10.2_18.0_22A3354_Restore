...
- (void)deleteSiriHistoryWithEndpointUUID:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v31 = 2112;
    v32 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Deleting siri history for endpoint with uuid: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to get a delete operation for endpoint uuid: %@ datasource: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v33 = 2112;
      v34 = v12;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get a connection for endpoint uuid: %@ datasource: %@", buf, 0x20u);
...
- (id)connectionForEndpointUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Device does not support siri endpoint history deletion", (uint8_t *)&v10, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_28006 != -1)
    dispatch_once(&logCategory__hmf_once_t6_28006, &__block_literal_global_28007);
  return (id)logCategory__hmf_once_v7_28008;
}
...
void __45__HMDAssistantSettingsConnection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_28008;
  logCategory__hmf_once_v7_28008 = v0;
