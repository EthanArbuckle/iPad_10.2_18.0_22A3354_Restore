...
- (BOOL)findBestMatchWithProtocolParameters:(id)a3 streamingCapabilities:(id)a4 videoTierParameters:(id)a5
{
  ...
  if (-[HMDCameraVideoParameterSelection selectVideoParameters](v15, "selectVideoParameters"))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 138543362;
        v32 = v29;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to select audio config", (uint8_t *)&v31, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 138543362;
      v32 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to select video config", (uint8_t *)&v31, 0xCu);
...
- (void)setSelectedEndPointSetupParameters:(id)a3 videoNetworkConfig:(id)a4 audioNetworkConfig:(id)a5
{
  ...
  if (v18)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 138543362;
        v36 = v34;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio SRTP parameters", (uint8_t *)&v35, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 138543362;
      v36 = v30;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video SRTP parameters", (uint8_t *)&v35, 0xCu);
