...
- (void)setUpWithCallback:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Session is being setup already", (uint8_t *)&v12, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Read data failed with no bulkSend session present for accessory:%@", buf, 0x16u);
...
- (void)_setUpTransport
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Setting up data stream transport", (uint8_t *)&v10, 0xCu);
...
- (void)_callPendingOpenSessionCallbackWithResult:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Calling pending callback with result: %@ error: %@", (uint8_t *)&v18, 0x20u);
...
void __71__HMDAccessoryDataStreamAdapter_accessory_didCloseDataStreamWithError___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory:%@ closed data stream", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Accessory Closed Data Stream, expected accessory: %@ actual accessory: %@", (uint8_t *)&v13, 0x20u);
...
void __60__HMDAccessoryDataStreamAdapter_accessoryDidStartListening___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v12;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory:%@ started listening", (uint8_t *)&v18, 0x16u);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138543362;
        v19 = v17;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Handling pending start bulk send session request", (uint8_t *)&v18, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v10;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Accessory start listening failed, expected accessory: %@ actual accessory: %@", (uint8_t *)&v18, 0x20u);
...
void __80__HMDAccessoryDataStreamAdapter_callPendingOpenSessionCallbackWithResult_error___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@Pending open session callback was unexpectedly nil", (uint8_t *)&v7, 0xCu);
...
LABEL_5:
    ...
    v22 = 2112;
    v23 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Diagnostics transfer read data channel has error:(%@)", (uint8_t *)&v20, 0x16u);
LABEL_4:
  ...
  if (v5 && (objc_msgSend(*(id *)(a1 + 32), "_handleFrame:", v5) & 1) == 0)
  {
    ...
    v22 = 2112;
    v23 = v19;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Received data frame is not accepted for accessory:%@", (uint8_t *)&v20, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Diagnostics data transfer is completed for accessory:%@", (uint8_t *)&v20, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_28197 != -1)
    dispatch_once(&logCategory__hmf_once_t14_28197, &__block_literal_global_28198);
  return (id)logCategory__hmf_once_v15_28199;
}
...
void __44__HMDAccessoryDataStreamAdapter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v15_28199;
  logCategory__hmf_once_v15_28199 = v0;
