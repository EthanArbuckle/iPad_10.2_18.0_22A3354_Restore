...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  +[HMDUserMessagePolicy userMessagePolicyWithHome:userPrivilege:remoteAccessRequired:requiresCameraStreamingAccess:](HMDUserMessagePolicy, "userMessagePolicyWithHome:userPrivilege:remoteAccessRequired:requiresCameraStreamingAccess:", v4, -[HMDUserMessagePolicy userPrivilege](self, "userPrivilege"), -[HMDUserMessagePolicy requiresRemoteAccess](self, "requiresRemoteAccess"), -[HMDUserMessagePolicy requiresCameraStreamingAccess](self, "requiresCameraStreamingAccess"));
...
{
  return (id)objc_msgSend(a1, "userMessagePolicyWithHome:userPrivilege:remoteAccessRequired:requiresCameraStreamingAccess:", a3, a4, a5, 0);
}
