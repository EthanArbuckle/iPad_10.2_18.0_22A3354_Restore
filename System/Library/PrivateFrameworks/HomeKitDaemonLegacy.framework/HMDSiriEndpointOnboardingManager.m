...
- (void)handleAccessoryConfigured:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 2112;
        v22 = v7;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Accessory is configured with invalid home: %@", (uint8_t *)&v19, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid HAP accessory is configured", (uint8_t *)&v19, 0xCu);
...
- (void)applyCachedOnboardingSelectionsWithAccessoryUUID:(id)a3 homeUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v43 = 2112;
    v44 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Apply cached onboarding selections: homeUUID: %@ accessoryUUID: %@", buf, 0x20u);
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v41 = 2112;
          v42 = v16;
          _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections matching key not found in the cache: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v41 = 2112;
            v42 = v6;
            _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@It's not ready to apply onboarding. accessoryUUID: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v41 = 2112;
        v42 = v6;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections are already configured on the accessory: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = v6;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not determine needsOnboarding state. accessoryUUID: %@", buf, 0x16u);
...
- (void)handleCompositeSettingsControllerConfigured:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (v11)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          v27 = 138543362;
          v28 = v26;
          _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@CompositeSettingsController is congigured with invalid homeUUID", (uint8_t *)&v27, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 138543362;
        v28 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@CompositeSettingsController is congigured with invalid accessoryUUID", (uint8_t *)&v27, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@CompositeSettingsController is congigured with invalid homeUUID and ownerUUID info", (uint8_t *)&v27, 0xCu);
...
LABEL_32:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v59 = 2112;
    v60 = v13;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Apply onboarding selections: %@ homeUUID: %@ accessoryUUID: %@", buf, 0x2Au);
  ...
  if (v22)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@.%@"), v14, v13);
      ...
      if (v25)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v55 = 2112;
          v56 = v24;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections are already cached, key: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v56 = v24;
          v45 = (void *)v38;
          _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Caching onboarding selections, key: %@", buf, 0x16u);

        }
        objc_autoreleasePoolPop(context);
        contexta = (void *)MEMORY[0x1D17BA0A0](-[NSMutableDictionary setObject:forKey:](v18->_onboardingSelections, "setObject:forKey:", v12, v24));
        v39 = v26;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v55 = 2112;
          v56 = v50;
          _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Caching onboarding user UUID %@", buf, 0x16u);
        ...
        {
          locka = (os_unfair_lock_t)MEMORY[0x1D17BA0A0]();
          v42 = v39;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v55 = 2112;
            v56 = v13;
            _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@It's not ready to apply onboarding. accessoryUUID: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v55 = 2112;
        v56 = v13;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections are already configured on the accessory: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v55 = 2112;
      v56 = v13;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not determine needsOnboarding state. accessoryUUID: %@", buf, 0x16u);
  ...
  if (v9)
  {
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = v7;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@HAP accessory is not found. accessoryUUID: %@", (uint8_t *)&v30, 0x16u);
...
LABEL_18:
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, v27, (uint8_t *)&v30, 0x16u);
...
LABEL_19:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = v7;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Accessory is not found. accessoryUUID: %@", (uint8_t *)&v30, 0x16u);
...
void __100__HMDSiriEndpointOnboardingManager__setNeedsOnboardingCompleteWitHomeUUID_accessoryUUID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Setting needsOnboarding complete failed with error: %@", (uint8_t *)&v9, 0x16u);
...
void __115__HMDSiriEndpointOnboardingManager__applyOnboardingSelections_accessoryUUID_homeUUID_userUUID_cacheKey_completion___block_invoke(id *a1, void *a2, uint64_t a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2114;
    v27 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply result received from controller: %{public}@ error:%{public}@", buf, 0x20u);
...
void __115__HMDSiriEndpointOnboardingManager__applyOnboardingSelections_accessoryUUID_homeUUID_userUUID_cacheKey_completion___block_invoke_17(uint64_t a1, void *a2)
{
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing cached onboarding selections, key: %@", (uint8_t *)&v12, 0x16u);
