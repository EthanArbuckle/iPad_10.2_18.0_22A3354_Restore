...
- (HMDAccessoryMetric)initWithAccessory:(id)a3
{
  ...
  if (v5)
  {
    ...
    v17 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 4, v5->_timerInterval);
    ...
    v19 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryMetric _initDiagnosticCounters](v5, "_initDiagnosticCounters"));
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2048;
      v28 = timerInterval;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@[AccessoryMetric] Initialized session metric for accessory with submission interval: %f", buf, 0x16u);
...
- (void)_initDiagnosticCounters
{
  ...
  v3 = *MEMORY[0x1E0D332D8];
  v19[0] = *MEMORY[0x1E0D332D0];
  v19[1] = v3;
  v4 = *MEMORY[0x1E0D33338];
  v19[2] = *MEMORY[0x1E0D33330];
  v19[3] = v4;
  v5 = *MEMORY[0x1E0D33350];
  v19[4] = *MEMORY[0x1E0D33348];
  v19[5] = v5;
  v6 = *MEMORY[0x1E0D33360];
  v19[6] = *MEMORY[0x1E0D33358];
  v19[7] = v6;
  v7 = *MEMORY[0x1E0D33300];
  v19[8] = *MEMORY[0x1E0D33368];
  v19[9] = v7;
  v8 = *MEMORY[0x1E0D332F8];
  v19[10] = *MEMORY[0x1E0D332F0];
  v19[11] = v8;
  v9 = *MEMORY[0x1E0D33310];
  v19[12] = *MEMORY[0x1E0D33308];
  v19[13] = v9;
  v10 = *MEMORY[0x1E0D33320];
  v19[14] = *MEMORY[0x1E0D33318];
  v19[15] = v10;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v19, 16);
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v51 = v12;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory disappeared, stopping accessory metric timer", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_63286 != -1)
    dispatch_once(&logCategory__hmf_once_t4_63286, &__block_literal_global_123_63287);
  return (id)logCategory__hmf_once_v5_63288;
}
...
void __33__HMDAccessoryMetric_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_63288;
  logCategory__hmf_once_v5_63288 = v0;
