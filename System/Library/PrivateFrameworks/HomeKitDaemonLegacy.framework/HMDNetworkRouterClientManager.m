  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v19;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Initializing with network router accessory %@", buf, 0x16u);
...
- (void)_evaluateManagement
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Evaluating network router management responsibility. Resident Available: %@, Current Device Primary Resident: %@, Current Device Management Active: %@, Primary Managing Device: %@", (uint8_t *)&v15, 0x34u);
  ...
  if (-[HMDNetworkRouterClientManager started](self, "started"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Client manager is already started", buf, 0xCu);
  ...
  else
  {
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v21 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Stale network client identifiers reset is already in progress", buf, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v22 = 2112;
        v23 = v16;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Resetting stale network client identifiers for accessories in the home %@ before starting", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v45 = 2112;
      v46 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Starting network router client manager with network router accessory %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v45 = 2112;
          v46 = v37;
          _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Network router: %@ is not reachable, waiting until it is", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v44 = v32;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@No home to register for notifications on", buf, 0xCu);
...
- (void)_stop
{
  ...
  if (-[HMDNetworkRouterClientManager started](self, "started"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping network router client manager - active network router accessory %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Client manager is already stopped", (uint8_t *)&v15, 0xCu);
...
- (void)_handleRouterAccessoryReachable:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2112;
    v27 = v15;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Managed network enabled assume to be %@ for network router accessory %@", buf, 0x20u);
...
- (void)_startManagingAccessory:(id)a3 initialHomeSetup:(BOOL)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Managing accessory %@ as a Network Router client", (uint8_t *)&v15, 0x16u);
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v53 = 2112;
        v54 = v12;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unable to get translate IP address %@ for accessory %@ because of %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v49 = 2112;
      v50 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Unable to get IP address for accessory %@ because we don't have a connection", buf, 0x16u);
...
LABEL_13:
    ...
    v25 = (void *)MEMORY[0x1D17BA0A0](-[HMDNetworkRouterClientStatusIdentifier setIpAddress:](v24, "setIpAddress:", v11));
    v26 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v51 = 2112;
      v52 = v24;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Querying the router for the status of accessory %@ with %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v49 = 2112;
    v50 = v39;
    _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to extract any IP address for accessory %@", buf, 0x16u);
  ...
  if (v14)
  {
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Reconciling client configuration for accessory %@", buf, 0x16u);
    ...
    else if (v22)
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v48 = 2112;
        v49 = v38;
        _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@Saving found network client identifier %@ for %@", buf, 0x20u);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v46 = 2112;
    v47 = v28;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Router failed to report MAC address for accessory %@", buf, 0x16u);
...
- (void)_replaceNetworkClientIdentifierForAccessory:(id)a3 networkClientIdentifier:(id)a4 networkRouterUUID:(id)a5 clientStatus:(id)a6 clientReconfigurationAllowed:(BOOL)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v41 = 2112;
    v42 = v20;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Replacing saved network client identifier %@ with %@ found on router for %@", buf, 0x2Au);
...
- (void)_replaceClientConfigurationForAccessory:(id)a3 credential:(id)a4 clientStatus:(id)a5 clientReconfigurationAllowed:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v34 = 2112;
    v35 = v18;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Replacing client configuration with identifier %@ with a new client configuration for %@", buf, 0x20u);
...
- (void)_createClientConfigurationForAccessory:(id)a3 credential:(id)a4 clientStatus:(id)a5 clientReconfigurationAllowed:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v32 = 2112;
    v33 = v18;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Creating new client configuration for %@", buf, 0x16u);
...
LABEL_12:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Unable to apply client configuration for unreachable accessory %@ with no prior client configuration and no saved PSK", (uint8_t *)&v23, 0x16u);
...
LABEL_5:
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v39 = 2112;
      v40 = v27;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating existing client configuration for accessory %@ to comply with target network protection mode %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v39 = 2112;
    v40 = v33;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@No network configuration update necessary for accessory %@ with protection mode %@", buf, 0x20u);
    ...
    if (v69)
    {
      ...
      if (v64)
      {
        ...
        if (v17 || a7 != 2)
        {
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v90 = 2112;
            v91 = v54;
            _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_INFO, "%{public}@Attempting migration to %@ credential for accessory %@", buf, 0x20u);
        ...
        else
        {
          ...
          v44 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", v21);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v88 = 2112;
      v89 = v39;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Unable to perform Wi-Fi reconfiguration for unreachable accessory %@", buf, 0x16u);
...
- (void)_getNetworkConfigurationForAccessory:(id)a3 targetProtectionMode:(int64_t)a4 completion:(id)a5
{
  ...
  if (a4 == 3)
  {
    ...
    (*((void (**)(id, _QWORD, void *, void *, _QWORD))v9 + 2))(v9, 0, v12, &unk_1E8B342D8, 0);
  }
  else
  {
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v28 = 2112;
      v29 = v9;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Fetching firewall rules for accessory %@ with identifier %@", buf, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v19;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to fetch firewall rules due to failure to derive identifier for accessory %@", buf, 0x16u);
...
- (void)_registerForNetworkProtectionChangesToGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering for network protection change notification to group %@", (uint8_t *)&v11, 0x16u);
...
- (void)_unregisterForNetworkProtectionChangesToGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Unregistering for network protection change notification to group %@", (uint8_t *)&v11, 0x16u);
...
void __76__HMDNetworkRouterClientManager__fetchFirewallRulesForAccessory_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Fetched firewall rules for accessory %@ with identifier %@ failed with error %@", (uint8_t *)&v15, 0x2Au);
  ...
  if (v5 == 1)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Using firewall configuration %@ for accessory %@", buf, 0x20u);
  ...
  else if (v5)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v23;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unexpected target network protection mode %@", buf, 0x16u);
...
void __136__HMDNetworkRouterClientManager__migrateAccessory_withConfiguration_clientStatus_fromCredentialType_toCredentialType_rotate_completion___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", *(_QWORD *)(a1 + 32));
...
void __136__HMDNetworkRouterClientManager__migrateAccessory_withConfiguration_clientStatus_fromCredentialType_toCredentialType_rotate_completion___block_invoke_6(uint64_t a1)
{
  ...
  if (!*(_QWORD *)(a1 + 40))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v8;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Successfully completed migration to %@ credential for accessory %@", (uint8_t *)&v13, 0x20u);
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "removeClientConfigurationWithClientIdentifier:completion:", v2, &__block_literal_global_51_132816);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v15 = 2112;
        v16 = v8;
        _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Router did not return client status for accessory %@ with client identifier %@ (accessory offline or not connected to router?)", buf, 0x20u);
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (!v9 && v10)
  {
          ...
          v17))
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v56 = 2112;
        v57 = v21;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping network configuration update for accessory %@ with mode %@ - fingerprint matches existing profile", buf, 0x20u);
    ...
    {
      v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", *(_QWORD *)(a1 + 56));
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke_41(_QWORD *a1)
{
  ...
  v5 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "_migrateAccessory:withConfiguration:clientStatus:fromCredentialType:toCredentialType:rotate:completion:", v2, v3, v4, credentialTypeForCredential(v5), 3, 0, &__block_literal_global_42_132826);
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke_4(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "resetAccessViolationForClientIdentifier:completion:", *(_QWORD *)(a1 + 72), &__block_literal_global_43_132824);
    ...
    if (*(_BYTE *)(a1 + 120))
    {
      if (*(_QWORD *)(a1 + 112) != 3)
      {
        ...
        objc_msgSend(v12, "_migrateAccessory:withConfiguration:clientStatus:fromCredentialType:toCredentialType:rotate:completion:", v13, v15, v14, credentialTypeForCredential(v16), 3, 0, &__block_literal_global_44_132825);
...
void __125__HMDNetworkRouterClientManager__createClientConfigurationForAccessory_credential_clientStatus_clientReconfigurationAllowed___block_invoke_3(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (*(_BYTE *)(a1 + 112))
    {
      if (*(_QWORD *)(a1 + 104) != 3)
      {
        v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", *(_QWORD *)(a1 + 56));
        objc_msgSend(*(id *)(a1 + 72), "setClientIdentifier:", v13);

        objc_msgSend(*(id *)(a1 + 32), "_migrateAccessory:withConfiguration:clientStatus:fromCredentialType:toCredentialType:rotate:completion:", *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 72), *(_QWORD *)(a1 + 88), credentialTypeForCredential(*(void **)(a1 + 96)), 3, 0, &__block_literal_global_132831);
      }
    }
  }
}
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v37 = 2112;
      v38 = v10;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Handling firewall rules update notification for home %@: %@", buf, 0x20u);
  ...
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v25;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring firewall rules update since network protection is disabled for home %@", buf, 0x16u);
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "started"))
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 2112;
        v20 = v12;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Network protection for home %@ changed to %@. Network router Accessory: %@", (uint8_t *)&v13, 0x2Au);
...
void __79__HMDNetworkRouterClientManager_handleNetworkProtectionGroupProtectionChanged___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "started"))
  {
    ...
    v2 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v2, "objectForKey:", *MEMORY[0x1E0CB7D48]);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(*(id *)(a1 + 40), "userInfo");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "objectForKey:", *MEMORY[0x1E0CB7D28]);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v12 == 1)
      {
        if (v16)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v37 = 2112;
          v38 = v5;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating accessory network configurations because protection mode changed to %@ for network protection group %@", buf, 0x20u);
      ...
      else
      {
        if (v16)
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v39 = 2112;
          v40 = v28;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Ignoring protection mode change to %@ for network protection group %@ because home network protection is %@", buf, 0x2Au);
...
void __73__HMDNetworkRouterClientManager_handleNetworkProtectionGroupDeactivated___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKey:", *MEMORY[0x1E0CB7D18]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v4)
    {
      ...
      if (v7)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        {
          ...
          v15 = 2112;
          v16 = v12;
          _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Not reconciling client configuration for accessory %@ -- currently being reconfigured", (uint8_t *)&v13, 0x16u);
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "started"))
  {
    ...
    if (v4 && objc_msgSend(v4, "supportsNetworkProtection"))
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
      {
        ...
        v12 = 2112;
        v13 = v9;
        _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling firmware version update for accessory %@", (uint8_t *)&v10, 0x16u);
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Stopping client manager due to removal of currently active network router accessory %@", buf, 0x16u);
      ...
      if (v13)
      {
        if (v17)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v35 = 2112;
          v36 = v20;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Removing client configuration with identifier %@ from router for removed accessory %@", buf, 0x20u);
      ...
      else
      {
        if (v17)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v33 = 2112;
          v34 = v24;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@No saved client identifier on removed accessory %@", buf, 0x16u);
...
void __56__HMDNetworkRouterClientManager_handleAccessoryRemoved___block_invoke_30(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Remove client configuration with identifier %@ completed with error %@", (uint8_t *)&v9, 0x20u);
...
LABEL_8:
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, v9, (uint8_t *)&v14, 0x16u);
    ...
    else
    {
      ...
      if (!v10)
      {
        if (v11)
        {
          ...
          v16 = 2112;
          v17 = v13;
          _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Will not manage new accessory %@", (uint8_t *)&v14, 0x16u);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v18 = 2112;
      v19 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Managed network enable for network router accessory %@ completed with error: %@", buf, 0x20u);
...
void __65__HMDNetworkRouterClientManager__handleRouterAccessoryReachable___block_invoke_29(uint64_t a1)
{
  ...
  if (*(_BYTE *)(a1 + 48))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Initial Home-level protection setup is required", buf, 0xCu);
...
uint64_t __72__HMDNetworkRouterClientManager__resetStaleClientIdentifiersBeforeStart__block_invoke_2(uint64_t a1)
{
  ...
  v21 = *MEMORY[0x1E0C80C00];
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "setStaleClientIdentifiersResetInProgress:", 0));
  v3 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Resetting stale network client identifiers completed for home %@, staleClientIdentifiersResetNeeded = %@, startPending = %@", (uint8_t *)&v13, 0x2Au);
...
void __85__HMDNetworkRouterClientManager_migrateAccessory_toCredentialType_rotate_completion___block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "started") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v28 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Migration not possible, accessory has no existing client profile", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Migration not possible, client manager is not running", buf, 0xCu);
...
uint64_t __85__HMDNetworkRouterClientManager_migrateAccessory_toCredentialType_rotate_completion___block_invoke_2(uint64_t a1)
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", *(_QWORD *)(a1 + 40));
...
void __69__HMDNetworkRouterClientManager_replaceActiveNetworkRouterAccessory___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (*(_QWORD *)(a1 + 40))
    {
      ...
      v4 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "_evaluateManagement"));
      v5 = *(id *)(a1 + 32);
      HMFGetOSLogHandle();
      v6 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        v17 = 2112;
        v18 = v9;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Activated network router accessory %@ - previous active network router accessory was %@", (uint8_t *)&v13, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v13 = 138543362;
        v14 = v12;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Attempt to activate a nil network router accessory", (uint8_t *)&v13, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t79 != -1)
    dispatch_once(&logCategory__hmf_once_t79, &__block_literal_global_68_132895);
