  ...
  if (self->_running)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v11 = 2112;
      v12 = identifier;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@Scheduler dying while activity '%@' was still active", buf, 0x16u);
...
- (id)__initialCriteria
{
  ...
  v4 = (const char *)*MEMORY[0x1E0C807A8];
  -[HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler interval](self, "interval");
  ...
  xpc_dictionary_set_string(v3, (const char *)*MEMORY[0x1E0C80828], (const char *)*MEMORY[0x1E0C80830]);
  xpc_dictionary_set_BOOL(v3, (const char *)*MEMORY[0x1E0C80738], 1);
  xpc_dictionary_set_int64(v3, (const char *)*MEMORY[0x1E0C80788], *MEMORY[0x1E0C807C8]);
...
- (void)__registerActivity
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Registering activity '%@'", buf, 0x16u);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' resurrected with criteria: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v31 = 2112;
        v32 = v18;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' applying override criteria: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v6;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' created for the first time with criteria: %@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v20);
    xpc_activity_set_criteria(v4, v6);
  }
  self->_currentInterval = (double)xpc_dictionary_get_int64(v6, (const char *)*MEMORY[0x1E0C807A8]);
...
- (void)__runActivity:(id)a3
{
  ...
  if (xpc_activity_should_defer((xpc_activity_t)v4))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v25 = 2112;
      v26 = v5;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' was ready to run but it should be deferred", buf, 0x16u);
  ...
  else
  {
    ...
    if (v10)
    {
      v11 = (void *)MEMORY[0x1D17BA0A0](-[HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler __transitionActivity:state:](self, "__transitionActivity:state:", v4, 4));
      v12 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v5;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Activity '%@' running", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v5;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' was ready to run but delegate has died", buf, 0x16u);
...
- (void)__unregisterActivity
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Unregistering activity '%@'", (uint8_t *)&v8, 0x16u);
...
LABEL_6:
      _os_log_impl(&dword_1CD062000, v15, v16, v14, (uint8_t *)&v17, 0x20u);
...
void __84__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler___runActivity___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = (uint64_t)v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' completion handler called with error: %@", (uint8_t *)&v22, 0x20u);

    }
    objc_autoreleasePoolPop(v5);
    objc_msgSend(v6, "setRunningActivity:", 0);
    v10 = xpc_activity_copy_criteria(*(xpc_activity_t *)(a1 + 40));
    v11 = (const char *)*MEMORY[0x1E0C807A8];
    int64 = xpc_dictionary_get_int64(v10, (const char *)*MEMORY[0x1E0C807A8]);
    if (v3)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = (uint64_t)v3;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' completion handler called after scheduler has died with error: %@", (uint8_t *)&v22, 0x20u);
    ...
    if (!xpc_activity_set_state(*(xpc_activity_t *)(a1 + 40), 5))
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 2048;
        v27 = 5;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' failed to transition to state %ld", (uint8_t *)&v22, 0x20u);
...
void __88__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler___registerActivity__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' handler ran after scheduler has died", (uint8_t *)&v14, 0x16u);
  ...
  if (state)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2048;
      v19 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Activity %@ callback with unhandled state: %ld", (uint8_t *)&v14, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_112526 != -1)
    dispatch_once(&logCategory__hmf_once_t0_112526, &__block_literal_global_112527);
  return (id)logCategory__hmf_once_v1_112528;
}
...
void __81__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_112528;
  logCategory__hmf_once_v1_112528 = v0;
