...
- (void)_createBackoffTimer
{
  ...
  if (-[HMDSyncOperationQueue hasExponentialBackoff](self, "hasExponentialBackoff"))
  {
    ...
    if (!v3)
    {
      v4 = objc_alloc(MEMORY[0x1E0D28578]);
      ...
      for (i = 0; i != v7; ++i)
      {
        ...
        if (v13)
        {
          ...
          if (!v15)
          {
            if (v19)
            {
              ...
              *(_DWORD *)buf = 138543362;
              v141 = v35;
              _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Dropping new operation, already have staged operation", buf, 0xCu);
          ...
          if (v19)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v141 = v20;
            _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Dropping staged operation, new operation has longer delay that must be respected", buf, 0xCu);
        ...
        if (v59)
        {
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v142 = 2112;
            v143 = v64;
            _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_INFO, "%{public}@Dropping scheduled operation, new operation being added directly to staged for %@", buf, 0x16u);
          ...
          if (v5)
          {
            ...
            if (v66)
            {
              ...
              if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v141 = v70;
                _os_log_impl(&dword_1CD062000, v69, OS_LOG_TYPE_INFO, "%{public}@Dropping new operation, found operation has delay that must respected", buf, 0xCu);
...
LABEL_66:
          ...
          if (os_log_type_enabled(v96, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v142 = 2112;
            v143 = v4;
            _os_log_impl(&dword_1CD062000, v96, OS_LOG_TYPE_INFO, "%{public}@Schedule operation without delay %@", buf, 0x16u);
...
LABEL_76:
              _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_INFO, v50, buf, 0xCu);
...
LABEL_88:
              _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_INFO, v76, buf, 0xCu);
...
LABEL_81:
  ...
  if (os_log_type_enabled(v116, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v144 = 2112;
    v145 = v121;
    _os_log_impl(&dword_1CD062000, v116, OS_LOG_TYPE_INFO, "%{public}@Schedule operation with delay %g: %@", buf, 0x20u);
  ...
  if (v6)
  {
    ...
    if (-[HMDSyncOperationQueue hasExponentialBackoff](self, "hasExponentialBackoff"))
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 2048;
        v26 = a4;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Current delay is %g", (uint8_t *)&v23, 0x16u);
...
LABEL_4:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 2112;
        v29 = v14;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Sync queue delay timer fired, staging %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28_94263 != -1)
    dispatch_once(&logCategory__hmf_once_t28_94263, &__block_literal_global_94264);
  return (id)logCategory__hmf_once_v29_94265;
}
...
void __36__HMDSyncOperationQueue_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v29_94265;
  logCategory__hmf_once_v29_94265 = v0;
