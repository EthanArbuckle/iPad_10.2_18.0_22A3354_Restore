...
- (id)accessoryCapabilitiesForAccessory:(id)a3 ifDifferentFrom:(id)a4
{
  ...
  {
    v9 = WeakRetained;
    objc_msgSend(MEMORY[0x1E0CBA240], "topicFromSuffixID:homeUUID:accessoryUUID:", *MEMORY[0x1E0CB7C00], self->_homeUUID, v6);
    ...
    if (v12)
    {
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1D0]), "initWithProtoData:", v7);
      v14 = objc_alloc(MEMORY[0x1E0CBA1D0]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 138543362;
      v25 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot create accessory capabilities due to nil datasource", (uint8_t *)&v24, 0xCu);
...
- (id)residentCapabilitiesForAccessory:(id)a3 ifDifferentFrom:(id)a4
{
  ...
  {
    v9 = WeakRetained;
    objc_msgSend(MEMORY[0x1E0CBA240], "topicFromSuffixID:homeUUID:accessoryUUID:", *MEMORY[0x1E0CB7C38], self->_homeUUID, v6);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v9, "eventStoreReadHandle");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "lastEventForTopic:", v10);
    ...
    if (v12)
    {
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA7B8]), "initWithProtoData:", v7);
      v14 = objc_alloc(MEMORY[0x1E0CBA7B8]);
      objc_msgSend(v12, "encodedData");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v16 = (void *)objc_msgSend(v14, "initWithProtoData:", v15);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 138543362;
      v25 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident capabilities due to nil datasource", (uint8_t *)&v24, 0xCu);
...
LABEL_12:
  ...
  objc_msgSend(MEMORY[0x1E0CBA240], "topicFromSuffixID:homeUUID:accessoryUUID:", *MEMORY[0x1E0CB7C30], self->_homeUUID, v6);
  ...
  if (v11)
  {
    v12 = objc_alloc(MEMORY[0x1E0D28650]);
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v71 = 2112;
      v72 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Received event for: %@", buf, 0x16u);
    ...
    if (!WeakRetained)
      goto LABEL_34;
    objc_msgSend(MEMORY[0x1E0CBA4C8], "decodeTopic:", v6);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v14)
    {
      ...
      if (v16 == *MEMORY[0x1E0CB7C00])
      {
        v17 = objc_alloc(MEMORY[0x1E0CBA1D0]);
...
LABEL_32:
      ...
      if (v28 == *MEMORY[0x1E0CB7C38])
      {
        v29 = objc_alloc(MEMORY[0x1E0CBA7B8]);
        objc_msgSend(v5, "encodedData");
          ...
          else
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v71 = 2112;
              v72 = context;
              _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory public pairing identity event: %@ due to invalid data", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v71 = 2112;
            v72 = v21;
            _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory public pairing identity event: %@ due to no delegate", buf, 0x16u);
...
void __71__HMDPrimaryResidentCapabilitiesAggregator__processEventIfNewer_topic___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  if (v3)
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1D0]), "initWithProtoData:", v3);
  else
    v4 = 0;
  if ((objc_msgSend(*(id *)(a1 + 32), "isEqual:", v4) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 2112;
      v19 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Updating on receiving different accessory capabilities %@.", (uint8_t *)&v16, 0x16u);
...
void __71__HMDPrimaryResidentCapabilitiesAggregator__processEventIfNewer_topic___block_invoke_19(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  if (v3)
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA7B8]), "initWithProtoData:", v3);
  else
    v4 = 0;
  if ((objc_msgSend(*(id *)(a1 + 32), "isEqual:", v4) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 2112;
      v19 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Updating on receiving different resident capabilities %@.", (uint8_t *)&v16, 0x16u);
...
- (void)processSoftwareVersionEvent:(void *)a3 accessoryTopic:
{
  ...
  if (WeakRetained)
  {
    v8 = objc_alloc(MEMORY[0x1E0CBA280]);
    objc_msgSend(v5, "encodedData");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = v5;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory software version event: %@ due to invalid data", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v5;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory software version event: %@ due to no delegate", (uint8_t *)&v21, 0x16u);
...
void __99__HMDPrimaryResidentCapabilitiesAggregator_handlePrimaryResidentIsCurrentDeviceChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Primary resident status changed to %@", (uint8_t *)&v16, 0x16u);
    ...
    if (v12)
    {
      ...
      else
      {
        ...
        if (v13)
        {
          ...
          v15 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v15, "unregisterConsumer:completion:", v12, &__block_literal_global_16_45359);
    ...
    if (objc_msgSend(v3, "count"))
    {
      if (*(_BYTE *)(a1 + 8))
      {
        ...
        if (WeakRetained)
        {
          ...
          {
            v37 = *(_QWORD *)v49;
            v36 = *MEMORY[0x1E0CB7C00];
            v35 = *MEMORY[0x1E0CB7C38];
            v34 = *MEMORY[0x1E0CB7C30];
            v33 = *MEMORY[0x1E0CB7C10];
            v32 = *MEMORY[0x1E0CB7C50];
            do
            {
              for (i = 0; i != v39; ++i)
              {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v30;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Subscribing for accessories: %@", buf, 0x16u);
          ...
          v47 = v30;
          v28 = v38;
          objc_msgSend(v27, "changeRegistrationsForConsumer:topicFilterAdditions:topicFilterRemovals:completion:", v24, v28, MEMORY[0x1E0C9AA60], v44);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v25 = 2112;
      v26 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Error subscribing to capabilities for accessories: %@, error: %@", buf, 0x20u);
  ...
  if (v1)
  {
    ...
    if (WeakRetained)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v21 = 2112;
        v22 = v9;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Starting capabilities aggregator, primary resident: %@", (uint8_t *)&v19, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_45379 != -1)
    dispatch_once(&logCategory__hmf_once_t0_45379, &__block_literal_global_45380);
  return (id)logCategory__hmf_once_v1_45381;
}
...
void __55__HMDPrimaryResidentCapabilitiesAggregator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_45381;
  logCategory__hmf_once_v1_45381 = v0;
