...
uint64_t __62__HMDAccessoryReachabilityChangedLogEventManager_runDailyTask__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@action=submit reason=periodic", (uint8_t *)&v7, 0xCu);
...
uint64_t __91__HMDAccessoryReachabilityChangedLogEventManager_handlePrimaryResidentUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v11 = 138543362;
      v12 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@action=enable reason=primary", (uint8_t *)&v11, 0xCu);
  ...
  else
  {
    if (v7)
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@action=disable reason=not_primary", (uint8_t *)&v11, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_26994 != -1)
    dispatch_once(&logCategory__hmf_once_t3_26994, &__block_literal_global_26995);
  return (id)logCategory__hmf_once_v4_26996;
}
...
void __61__HMDAccessoryReachabilityChangedLogEventManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_26996;
  logCategory__hmf_once_v4_26996 = v0;
