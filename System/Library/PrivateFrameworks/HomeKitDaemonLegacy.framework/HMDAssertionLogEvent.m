...
- (HMDAssertionLogEvent)initWithReason:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:arguments:", v4, &v12);
...
- (void)updateDiagnosticReportSignature:(id)a3
{
  ...
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v5, *MEMORY[0x1E0DB00F0]);

  -[HMDAssertionLogEvent description](self, "description");
  v6 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v6, *MEMORY[0x1E0DB00B8]);
