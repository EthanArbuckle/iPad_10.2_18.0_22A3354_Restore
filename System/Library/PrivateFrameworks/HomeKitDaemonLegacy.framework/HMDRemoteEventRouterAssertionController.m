...
- (void)configure
{
  ...
  if (self)
  {
    ...
    objc_msgSend(v6, "setObject:forKeyedSubscript:", v7, *MEMORY[0x1E0CB8D08]);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", 30.0);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setObject:forKeyedSubscript:", v8, *MEMORY[0x1E0CB9608]);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", 300.0);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setObject:forKeyedSubscript:", v9, *MEMORY[0x1E0CB8CA0]);

    if ((isInternalBuild() & 1) != 0)
    {
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", 300.0);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "setObject:forKeyedSubscript:", v10, *MEMORY[0x1E0CB8C98]);

    }
    else
    {
      objc_msgSend(v6, "setObject:forKeyedSubscript:", 0, *MEMORY[0x1E0CB8C98]);
    }
    if ((isInternalBuild() & 1) != 0)
    {
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", 300.0);
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "setObject:forKeyedSubscript:", v11, *MEMORY[0x1E0CB8E08]);

    }
    else
    {
      objc_msgSend(v6, "setObject:forKeyedSubscript:", 0, *MEMORY[0x1E0CB8E08]);
    }
    if ((isInternalBuild() & 1) != 0)
    {
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", 300.0);
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v6, "setObject:forKeyedSubscript:", v12, *MEMORY[0x1E0CB9E20]);

    }
    else
    {
      objc_msgSend(v6, "setObject:forKeyedSubscript:", 0, *MEMORY[0x1E0CB9E20]);
    }
...
- (id)takeEventRouterAssertion
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Did take event router active assertion: %@", buf, 0x16u);
...
- (void)assertionDidBecomeInactive:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Event router active assertion became inactive: %@", buf, 0x16u);
    ...
    if ((*(_BYTE *)(v3 + 12) != 0) != (_DWORD)v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v21 = 2114;
        v22 = v9;
        _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Plugged in state changed to %{public}@", buf, 0x16u);
      ...
      if (objc_msgSend(v6, "isAdaptive"))
      {
        ...
        if ((v8 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
          {
            ...
            v22 = 2112;
            v23 = v6;
            _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@[HMDRemoteEventRouterAssertionController] Received notification that connection active state changed: %@", (uint8_t *)&v20, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_166850 != -1)
    dispatch_once(&logCategory__hmf_once_t9_166850, &__block_literal_global_166851);
  return (id)logCategory__hmf_once_v10_166852;
}
...
void __54__HMDRemoteEventRouterAssertionController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_166852;
  logCategory__hmf_once_v10_166852 = v0;
