...
- (HMDLowPowerModeProfile)initWithAccessory:(id)a3 powerManagementservice:(id)a4 workQueue:(id)a5
{
  ...
  if (HMDLowPowerModeUUIDFromAccessory_onceToken != -1)
    dispatch_once(&HMDLowPowerModeUUIDFromAccessory_onceToken, &__block_literal_global_230_58255);
  ...
  objc_msgSend(MEMORY[0x1E0CB3A28], "hmf_UUIDWithNamespace:data:", HMDLowPowerModeUUIDFromAccessory_namespace, v13);
...
- (void)registerForMessages
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering for messages with home: %@ for %@", buf, 0x20u);
...
- (void)wakeSuspendedAccessoryWithType:(unint64_t)a3 completion:(id)a4
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "stringWithFormat:", CFSTR("%@, %s:%ld"), v11, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/PowerManagement/WakeOnLAN/HMDLowPowerModeProfile.m", 177);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v86 = 2112;
      v87 = v19;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Wake operation is in progress for %@ with suspended accessory: %@", buf, 0x20u);
...
LABEL_9:
  ...
  if (a3 >= 2)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v86 = 2112;
      v87 = v23;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Invalid wake type is used '%@' for accessory %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedChar:", objc_msgSend(v27, "version"));
    v68 = v33;
    v36 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v27, "wakePacketType"));
    ...
    *(_DWORD *)buf = 138544642;
    ...
    v92 = 2112;
    v93 = v38;
    _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Waking suspended accessory: %@, wakeType: %@, version: %@, wakePacketType: %@, numBSP: %@", buf, 0x3Eu);
  ...
  v40 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a3);
  v41 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedChar:", objc_msgSend(v27, "version"));
  v42 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v27, "wakePacketType"));
  v43 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", v76);
  ...
  if (objc_msgSend(v49, "wakeNumber"))
  {
    ...
    v51 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a3);
    v52 = (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", v76);

    v53 = v74;
    v54 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v49, "setSuspendedAccessory:", v74));
    v55 = v33;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v92 = 2112;
      v93 = v60;
      _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@Found accessory server for %@. Returning the HAPAccessory: %@. Wake will be via suspended accessory: %@, wakeType: %@, numBSP: %@", buf, 0x3Eu);
...
- (void)_runStateMachine
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v26 = 2112;
    v27 = v5;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@LPM running state: '%@' -> '%@' for %@", (uint8_t *)&v20, 0x2Au);
  ...
  if (v5->_internalState)
  {
    ...
    if ((v10 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v12;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Skipping processing state machine update since a resident is present for %@", (uint8_t *)&v20, 0x16u);
    ...
    switch(v5->_internalState)
    {
      ...
      default:
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          HMFGetLogIdentifier();
          v18 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", v5->_internalState);
          v19 = (HMDLowPowerModeProfile *)objc_claimAutoreleasedReturnValue();
          v20 = 138543874;
          v21 = v18;
          v22 = 2112;
          ...
          v24 = 2112;
          v25 = v16;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid LPM state: %@ for %@", (uint8_t *)&v20, 0x20u);
...
- (void)_enterState:(unint64_t)a3
{
  ...
  if (-[HMDLowPowerModeProfile _canEnterNewState:](self, "_canEnterNewState:", a3))
  {
    ...
    if (retryCount > objc_msgSend(v9, "unsignedIntegerValue"))
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        HMFGetLogIdentifier();
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", self->_retryCount - 1);
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        v29 = 2112;
        v30 = v12;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Resetting state machine. Tried '%@' times for operation: '%@' for %@", (uint8_t *)&v23, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v22;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Invalid machine state: %@ -> %@", (uint8_t *)&v23, 0x20u);
...
- (void)_queryAccessoryWithOperation:(int64_t)a3 completion:(id)a4
{
  ...
  if ((unint64_t)(a3 - 1) >= 3)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v47 = 2112;
      v48 = v21;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received invalid operation type: '%@' for %@", buf, 0x20u);
  ...
  if (v8)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = v9;
    if (-[HMDSelectedSleepConfigurationTLV conformsToProtocol:](v12, "conformsToProtocol:", &unk_1EFA84E10))
    {
      v42 = 0;
      ...
      if (v14 || !v13)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v47 = 2112;
          v48 = v14;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize object: %@ with error: %@", buf, 0x20u);
    ...
    if (v19)
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v47 = 2112;
        v48 = v32;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Requesting response to operation type: '%@' from accessory: %@", buf, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v47 = 2112;
        v48 = v38;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize selected sleep configuration value for charactersitic %@/%@", buf, 0x20u);
...
- (void)_processSupportedSleepConfigurationParametersWithCharacteristic:(id)a3
{
  ...
  if (-[HMDLowPowerModeProfile _shouldManageAccessoryLPM](self, "_shouldManageAccessoryLPM"))
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2112;
        v24 = v12;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Processing supported sleep configuration for %@.", (uint8_t *)&v21, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = v8;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse supported sleep configuration with data: %@", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      v23 = 2112;
      v24 = v17;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Skipping processing characteristic update since a resident is present for %@", (uint8_t *)&v21, 0x16u);
...
- (void)_processSelectedSleepConfigurationParametersWithCharacteristic:(id)a3
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2112;
      v29 = v15;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Processing selected sleep configuration with status: '%@' for %@", (uint8_t *)&v24, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v8;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse selected sleep configuration with data: %@", (uint8_t *)&v24, 0x16u);
...
- (void)handleAccessoryConfigurationChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling notification: %@ received by %@", buf, 0x20u);
...
- (id)newHAPSuspendedAccessoryFromAccessoryConnectivityInfoWithType:(unint64_t)a3
{
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        {
          v12 = objc_alloc(MEMORY[0x1E0D163F8]);
  ...
  {
    v17 = objc_alloc(MEMORY[0x1E0D165E8]);
...
- (void)_startTimerForType:(unint64_t)a3
{
  ...
  if (v9)
  {
    ...
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 1, v10);
    ...
    if (a3 == 2)
    {
      v13 = (void *)MEMORY[0x1D17BA0A0](-[HMDLowPowerModeProfile setWaitForWakeTimer:](self, "setWaitForWakeTimer:", v11));
      v18 = self;
      HMFGetOSLogHandle();
    ...
    {
      v13 = (void *)MEMORY[0x1D17BA0A0](-[HMDLowPowerModeProfile setBackoffTimer:](self, "setBackoffTimer:", v11));
      v14 = self;
      HMFGetOSLogHandle();
      v15 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
...
LABEL_11:
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, v17, (uint8_t *)&v19, 0x16u);
  ...
  if (a3 == 2)
  {
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2112;
        v21 = v14;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Stopping wait for wake timer for %@", (uint8_t *)&v18, 0x16u);
  ...
  else if (a3 == 1)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2112;
        v21 = v8;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Stopping backoff timer for %@", (uint8_t *)&v18, 0x16u);
  ...
  if (v6 == v4)
  {
    ...
    if (self->_internalState == 4)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 2112;
        v22 = v13;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Resuming a backed-off state: %@ for %@", (uint8_t *)&v17, 0x20u);
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v24 = 2112;
      v25 = v15;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Reading from characteristic: %@/%@ failed with error: %@", buf, 0x2Au);
  ...
  if (objc_msgSend(v3, "count"))
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 2112;
        v23 = v5;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Writing to the characteristic: %@/%@ failed with error: %@", (uint8_t *)&v16, 0x2Au);
        ...
        if (v13)
        {
          if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v46 = 2112;
            v47 = &unk_1E8B33180;
            _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Accessory's supported LPM version: %@ is greater than the current version: %@.", buf, 0x20u);
        ...
        else
        {
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v46 = 2112;
            v47 = v37;
            _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Attempting to update WoWLANInfo: '%@' -> '%@'", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v44 = 2112;
          v45 = v10;
          _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to create WoWLANInfo from supported sleep config: %@", buf, 0x16u);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v25[22] = 2112;
      ...
      v27 = 2112;
      v28 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Did unconfigure %@ with status: '%@' and error: %@", v25, 0x2Au);
...
LABEL_14:
          HMFGetLogIdentifier();
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v14, "retryCount"));
          v17 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          *(_WORD *)&v25[22] = 2112;
          v26 = v17;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Need to backoff and retry unconfiguring of %@. Retry count: %@", v25, 0x20u);
...
LABEL_20:
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v25[22] = 2112;
        ...
        v27 = 2112;
        v28 = v5;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Received invalid status: %@ to operation: %@ with error: %@", v25, 0x2Au);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v36 = 2112;
      v37 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Did configure %@ with status: '%@' and error: %@", buf, 0x2Au);
...
LABEL_19:
      ...
      if (a4 != 1)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v36 = 2112;
          v37 = v7;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received invalid status: %@ to operation: %@ with error: %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        v28 = v17;
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v18, "retryCount"));
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        *(_DWORD *)buf = 138543874;
        v31 = v20;
        v32 = 2112;
        ...
        v34 = 2112;
        v35 = v21;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Need to backoff and retry configuring of %@. Retry count: %@", buf, 0x20u);
...
void __66__HMDLowPowerModeProfile__stateMachine_readAccessoryConfiguration__block_invoke(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v44 = 2112;
      v45 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Did read configuration of %@ with status: '%@' and error: %@", (uint8_t *)&v38, 0x2Au);
    ...
    if (a3 == 3)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        HMFGetLogIdentifier();
        v22 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v20, "retryCount"));
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        v38 = 138543874;
        v39 = v22;
        v40 = 2112;
        ...
        v42 = 2112;
        v43 = v23;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Need to backoff and retry reading configuration for %@. Retry count: %@", (uint8_t *)&v38, 0x20u);
    ...
    else if (a3 == 1)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
        {
          ...
          v42 = 2112;
          v43 = 0;
          _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Need to reconfigure the accessory: %@. Accessory has stale WoWLANInfo: %@.", (uint8_t *)&v38, 0x20u);
    ...
    else if (a3)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v44 = 2112;
        v45 = v5;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Received invalid status: '%@' to operation: '%@' with error: %@", (uint8_t *)&v38, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        v40 = 2112;
        v41 = v17;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Need to configure the accessory: %@. Accessory is unconfigured.", (uint8_t *)&v38, 0x16u);
...
void __70__HMDLowPowerModeProfile__wakeSuspendedAccessory_activity_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v6)
    {
      ...
      v7 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v5, "_stopBackoffTimerForType:", 2));
      v8 = v5;
      HMFGetOSLogHandle();
      v9 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        v16 = 2112;
        v17 = v11;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Pending wake block was called with error: %@ for %@", (uint8_t *)&v12, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t46 != -1)
    dispatch_once(&logCategory__hmf_once_t46, &__block_literal_global_68);
