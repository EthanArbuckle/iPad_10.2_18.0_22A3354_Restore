...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Button  identifier: %lu,  Type: %lu"), -[THAButton identifier](self, "identifier"), -[THAButton type](self, "type"));
}
