...
LABEL_9:
  ...
  if (v10)
  {
    ...
    v11->_currentChunkSequenceNumber = (NSNumber *)&unk_1E8B329B8;
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v27 = 2112;
      v28 = v9;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Initialized data chunk assembler with sequence number: %@ type: %@", buf, 0x20u);
...
- (BOOL)addFragmentChunk:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    v43 = 2112;
    v44 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Adding chunk: %@", (uint8_t *)&v41, 0x16u);
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = v6;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Asked to add fragment chunk %@ but the last data chunk has already been received", (uint8_t *)&v41, 0x16u);
...
LABEL_18:
  ...
  if (v21 != v19 + 1)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      v45 = 2112;
      v46 = v35;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Asked to add fragment chunk %@ with non-sequential sequence number compared to current stream data chunk sequence number %@", (uint8_t *)&v41, 0x20u);
...
LABEL_23:
  ...
  if (v21 == -1 && (objc_msgSend(v6, "isLast") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = v6;
      _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Asked to add non-last fragment chunk with maximum allowed sequence number: %@", (uint8_t *)&v41, 0x16u);
