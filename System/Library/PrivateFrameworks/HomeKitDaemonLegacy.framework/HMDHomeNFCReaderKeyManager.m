  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Registering for messages", buf, 0xCu);
...
- (void)handleDeleteKeychainItemForNFCReaderKey:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v15 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling message to delete keychain item for nfc reader key", buf, 0xCu);
...
- (void)handleFetchOrCreateReaderKeyMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v21 = 2112;
    v22 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Handling message to fetch or create reader key: %@", buf, 0x20u);
...
- (void)handleCreateKeychainItemForReaderKeyMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v47 = 2112;
    v48 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Handling message to create keychain item for reader key: %@", buf, 0x20u);
      ...
      if (v17)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v47 = 2112;
          v48 = v17;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Keychain item is already created for reader key: %@", buf, 0x20u);
      ...
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v47 = 2112;
          v48 = v18;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch keychain item for nfc reader key: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v45 = 2112;
      v46 = v31;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] I am not configured with a home", buf, 0x16u);
...
- (void)fetchOrCreateReaderKeyWithRequiresPrivateKey:(BOOL)a3 flow:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v77 = 2112;
    v78 = v16;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetch or create reader key with requiresPrivateKey: %@", buf, 0x20u);
    ...
    if (((v19 & 1) != 0 || !a3) && v21)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v77 = 2112;
        v78 = v22;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current device is watch or caller does not requires private key, fetched nfc reader key from home graph: %@", buf, 0x20u);
    ...
    if ((objc_msgSend(v20, "isAdministrator") & 1) != 0)
    {
      ...
      if (v33 == 4)
      {
        if (v37)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v75 = 2112;
          v76 = v39;
          _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current user is shared admin, sending request to resident to create nfc reader key", buf, 0x16u);
      ...
      if (!v19)
      {
        if (v37)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v75 = 2112;
          v76 = v51;
          _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current user is owner, fetching or creating nfc reader key from keychain", buf, 0x16u);
        ...
        if (v47)
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v79 = 2112;
            v80 = v22;
            _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Looking for key chain item with identifier: %@ for reader key: %@", buf, 0x2Au);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              v81 = 2112;
              v82 = v61;
              _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch keychain item with identifier: %@ for nfc reader key %@:%@", buf, 0x34u);
      ...
      if (v37)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v75 = 2112;
        v76 = v49;
        _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current user is owner. Fetch or create reader key from keychain is not supported on watch", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v75 = 2112;
        v76 = v44;
        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current user is not admin and home key doesn't exist in home graph, returning nil", buf, 0x16u);
...
LABEL_23:
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v75 = 2112;
    v76 = v32;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to create reader key, home is nil", buf, 0x16u);
...
- (id)fetchOrCreateReaderKeyForPairingWithFlow:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v67 = 2112;
    v68 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] fetchOrCreateReaderKeyForPairingWithFlow", buf, 0x16u);
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v71 = 2112;
          v72 = v21;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Looking for key chain item with identifier: %@ for reader key: %@", buf, 0x2Au);
        ...
        if (v24)
        {
          objc_msgSend(MEMORY[0x1E0D519C0], "futureWithResult:", v24);
          v26 = (void *)objc_claimAutoreleasedReturnValue();
        }
        else
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            v73 = 2112;
            v74 = v57;
            _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch keychain item with identifier: %@ for nfc reader key %@:%@", buf, 0x34u);
          ...
          if (os_log_type_enabled(v51, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v71 = 2112;
            v72 = v25;
            _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Failed to fetch keychain item with identifier: %@ for nfc reader key %@:%@", buf, 0x2Au);
          ...
          objc_msgSend(MEMORY[0x1E0D519C0], "futureWithError:", v25);
          v26 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v67 = 2112;
          v68 = v43;
          _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Did not find an existing key in the home graph, so fetching the key from the resident", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v67 = 2112;
        v68 = v38;
        _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] We are not the owner, so fetching the key from the resident", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v71 = 2112;
      v72 = v13;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to create reader key, home or currentUser is nil. home: %@, currentUser: %@", buf, 0x2Au);
  ...
  if ((v9 & 1) != 0 || v13)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v28 = 2112;
      v29 = v20;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Not handling home nfc reader key update notification because it is watch: %@ or is not owner device: %@", buf, 0x20u);
...
- (void)handleHomeRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v45 = 2112;
    v46 = v8;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Handling home removed notification: %@", buf, 0x20u);
    ...
    if ((v17 & 1) != 0 || v19 != 1)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v47 = 2112;
        v48 = v30;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not removing nfc reader key because it is watch: %@ or is not owner device: %@", buf, 0x2Au);
      ...
      if (v20 && (objc_msgSend(v20, "isCurrentDevice") & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v43 = 2112;
          v44 = v35;
          _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Skipping removal of nfc reader key on current device because home has a primary resident that supports wallet key", buf, 0x16u);
...
- (void)handleSystemKeychainStoreUpdatedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v23 = 2112;
    v24 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Handling system keychain store updated notification", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v17;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not handling keychain update, home is nil", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Did not find primary resident", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v36 = 2112;
        v37 = v27;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not deleting reader key, home data load is in progress.", buf, 0x16u);
...
- (id)readerKeyWithKeychainItemIdentifier:(id)a3 error:(id *)a4 flow:(id)a5
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "allKeychainItemsForType:identifier:syncable:error:", &unk_1E8B33EE8, v8, MEMORY[0x1E0C9AAB0], a4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v12, "count"))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v8;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Found keychain items: %@ for nfc reader key with keychain item identifier: %@", (uint8_t *)&v21, 0x2Au);
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v94 = 2112;
        v95 = v30;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Creating reader key", buf, 0x16u);
          ...
          if ((v35 & 1) != 0)
          {
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v98 = 2112;
              v99 = v32;
              _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully created keychain item: %@ for nfc reader key: %@", buf, 0x2Au);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v98 = 2112;
              v99 = v76;
              _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to add nfc reader key item: %@ to key chain: %@", buf, 0x2Au);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v96 = 2112;
            v97 = v32;
            _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to create keychain item  for reader key: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v94 = 2112;
          v95 = v63;
          _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to create the nfc reader key", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v94 = 2112;
      v95 = v58;
      _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not creating nfc reader key, home data load is in progress.", buf, 0x16u);
...
- (id)createNFCReaderKeyModelWithHome:(id)a3 nfcReaderKey:(id)a4
{
  ...
  +[HMDHomeNFCReaderKeyModel defaultModelForHome:](HMDHomeNFCReaderKeyModel, "defaultModelForHome:", v7);
  v9 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v9, "setNfcReaderKey:", v6);
  return v9;
}
...
- (void)removeKeychainItemForReaderKey:(id)a3 home:(id)a4 flow:(id)a5
{
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v48 = 0;
  objc_msgSend(v13, "allKeychainItemsForType:identifier:syncable:error:", &unk_1E8B33EE8, v12, MEMORY[0x1E0C9AAB0], &v48);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = v48;
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "hmf_errorForKey:", *MEMORY[0x1E0CB3388]);
  v18 = (void *)objc_claimAutoreleasedReturnValue();

  if (!v16)
  {
    v34 = objc_msgSend(v18, "code");
    v44 = MEMORY[0x1D17BA0A0]();
    v35 = self;
    HMFGetOSLogHandle();
    v36 = objc_claimAutoreleasedReturnValue();
    v26 = v36;
    if (v34 == -25300)
    {
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 22;
LABEL_14:
        _os_log_impl(&dword_1CD062000, v40, v41, v39, buf, v42);
  ...
  if ((v21 & 1) != 0)
  {
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v33 = 32;
LABEL_10:
      _os_log_impl(&dword_1CD062000, v31, v32, v30, buf, v33);
...
- (void)requestDevice:(id)a3 toCreateKeychainItemForReaderKeyWithFlow:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v39 = 2112;
    v40 = v8;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Requesting primary resident device to create keychain item for nfc reader key. residentDevice: %@", buf, 0x20u);
  ...
  v25 = v10;
  v34 = v25;
  v26 = (void *)MEMORY[0x1D17BA0A0](-[HMDRemoteMessage setResponseHandler:](v23, "setResponseHandler:", v32));
  v27 = v13;
  HMFGetOSLogHandle();
  v28 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v41 = 2112;
    v42 = v8;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Sending message to create keychain item for reader key: %@ to primary resident: %@", buf, 0x2Au);
...
- (void)requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow:(id)a3 completion:(id)a4
{
  ...
  if (v9)
  {
    ...
    v30 = v17;
    v31 = v7;
    v18 = (void *)MEMORY[0x1D17BA0A0](-[HMDRemoteMessage setResponseHandler:](v16, "setResponseHandler:", v29));
    v19 = self;
    HMFGetOSLogHandle();
    v20 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v38 = 2112;
      v39 = v9;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Sending message to fetch or create reader key: %@ to primary resident: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v28;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Did not send message to fetch or create reader key, there is no primary resident that support wallet key", buf, 0x16u);
...
void __96__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow_completion___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  {
    v37 = 0;
    objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v7, &v37);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    v9 = v37;
    if (v8)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v46 = 2112;
        v47 = v9;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to decode reader key %@:%@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v48 = 2112;
      v49 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Missing reader key: %@ in payload: %@ error: %@", buf, 0x34u);
...
uint64_t __96__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully fetched nfc reader key: %@", (uint8_t *)&v9, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v44 = 2112;
        v45 = 0;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to decode reader key keychain item %@:%@", buf, 0x2Au);

      }
      objc_autoreleasePoolPop(v20);
      objc_msgSend(MEMORY[0x1E0C99E08], "dictionary");
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v25, "setObject:forKeyedSubscript:", 0, *MEMORY[0x1E0CB3388]);
      objc_msgSend(a1[4], "workQueue");
      v26 = objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v46 = 2112;
      v47 = v17;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Missing reader key keychain item: %@ in payload: %@ error: %@", buf, 0x34u);
...
uint64_t __96__HMDHomeNFCReaderKeyManager_requestDevice_toCreateKeychainItemForReaderKeyWithFlow_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Resident successfully created keychain item for nfc reader key: %@", (uint8_t *)&v9, 0x20u);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v27 = 2112;
      v28 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] NFC reader key transaction message response handler called with: %@", buf, 0x20u);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] NFC reader key transaction run failed: %@", buf, 0x20u);
...
void __83__HMDHomeNFCReaderKeyManager_deleteKeychainItemForNFCReaderKeyWithFlow_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (a2)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = *(_QWORD *)(a1 + 64);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:userInfo:", -1, v5);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((v3 & 1) != 0 || v5 != 1)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v36 = 2112;
      v37 = v18;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not handling keychain update because it is watch: %@ or is not owner device: %@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v36 = 2112;
          v37 = v8;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to fetch reader key with identifier: %@ and keychain item identifier: %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v23;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not handling nfc reader key update because it set to nil on home", buf, 0x16u);
...
void __74__HMDHomeNFCReaderKeyManager_handleHomeDidUpdateNFCReaderKeyNotification___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v60 = 2112;
    v61 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Handling HomeDidUpdateNFCReaderKeyNotification", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v62 = 2112;
      v63 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Removing keychain item for nfc reader key: %@", buf, 0x20u);
      ...
      if (v25)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v62 = 2112;
          v63 = v19;
          _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Already updated Reader key with key identifier: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v62 = 2112;
          v63 = v19;
          _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Caching did update reader key with key identifier: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v64 = 2112;
        v65 = v20;
        _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to fetch reader key with identifier: %@ and keychain item identifier: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v60 = 2112;
      v61 = v35;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Received home nfc reader key did update notification but its not set for home", buf, 0x16u);
...
void __74__HMDHomeNFCReaderKeyManager_handleHomeDidUpdateNFCReaderKeyNotification___block_invoke_85(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Removing key identifier from keyIdentifiersAlreadyUpdated: %@", (uint8_t *)&v9, 0x20u);
...
LABEL_8:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v23 = 2112;
    v24 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Creating a reader key locally because we do not have a resident", buf, 0x16u);
...
void __66__HMDHomeNFCReaderKeyManager_handleFetchOrCreateReaderKeyMessage___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  {
    v32 = 0;
    objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", v5, 1, &v32);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = v32;
    if (v7)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v41 = 2112;
        v42 = v9;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Responding to fetch or create reader key message: %@ with payload: %@ ", buf, 0x2Au);
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:userInfo:", -1, v9);
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      v23 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(a1[6], "respondWithError:", v22));
      v24 = a1[4];
      HMFGetOSLogHandle();
      v25 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v41 = 2112;
        v42 = v22;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Responding to fetch or create reader key message: %@ with: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v41 = 2112;
      v42 = v6;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Responding to fetch or create reader key message: %@ with: %@", buf, 0x2Au);
...
void __70__HMDHomeNFCReaderKeyManager_handleDeleteKeychainItemForNFCReaderKey___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v16 = 2112;
      v17 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to handle message to delete nfc reader key: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Successfully handled message to delete nfc reader key", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t74_125385 != -1)
    dispatch_once(&logCategory__hmf_once_t74_125385, &__block_literal_global_125386);
  return (id)logCategory__hmf_once_v75_125387;
}
...
void __41__HMDHomeNFCReaderKeyManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v75_125387;
  logCategory__hmf_once_v75_125387 = v0;
