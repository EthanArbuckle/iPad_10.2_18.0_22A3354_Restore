...
- (HMDHomeAIPhotosPersonDataInterface)initWithPersonManagerUUID:(id)a3 homeUUID:(id)a4 workQueue:(id)a5
{
  ...
  v8 = (objc_class *)MEMORY[0x1E0D31A58];
  v9 = a5;
  v10 = a4;
  v11 = a3;
...
- (void)handleUpdatedSettings:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Updated settings could not be converted into HMIExternalPersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
...
void __66__HMDHomeAIPhotosPersonDataInterface_fetchSettingsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Fetched settings could not be converted into HMIExternalPersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_51250 != -1)
    dispatch_once(&logCategory__hmf_once_t0_51250, &__block_literal_global_51251);
  return (id)logCategory__hmf_once_v1_51252;
}
...
void __49__HMDHomeAIPhotosPersonDataInterface_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_51252;
  logCategory__hmf_once_v1_51252 = v0;
