...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDNetworkRouterFirewallRuleLAN purpose](self, "purpose"));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (void *)objc_msgSend(v3, "initWithName:value:", CFSTR("Purpose"), v18);
  v20[0] = v4;
  v5 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDNetworkRouterFirewallRuleLAN areConnectionsWithOtherAccessoriesAllowed](self, "areConnectionsWithOtherAccessoriesAllowed"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedChar:", -[HMDNetworkRouterFirewallRuleLAN direction](self, "direction"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v8, "initWithName:value:", CFSTR("Direction"), v9);
  v20[2] = v10;
  v11 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDNetworkRouterFirewallRuleLAN isRequiredForHAPFunctionality](self, "isRequiredForHAPFunctionality"));
...
LABEL_18:
      ...
      if (v10 - 1 >= v8)
      {
        if (v11)
        {
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unknown (0x%llx)"), v11, v18.receiver, v18.super_class);
  ...
  {
    objc_msgSend(v7, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("allowInterAccessoryConnections"));
  }
  if (-[HMDNetworkRouterFirewallRuleLAN isRequiredForHAPFunctionality](self, "isRequiredForHAPFunctionality"))
    objc_msgSend(v7, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("requiredForHAPFunctionality"));
  ...
  if ((v12 - 1) > 2)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v27 = 2112;
      v28 = v8;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Rule contains an unknown '%@' value %@: %@", buf, 0x2Au);
...
LABEL_10:
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v30 = 2112;
      v31 = v10;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Rule contains an unknown '%@' value %@: %@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v30 = 2112;
          v31 = v6;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid '%@' value: %@", buf, 0x20u);
