...
+ (id)modelIDNamespace
{
  if (modelIDNamespace_onceToken != -1)
    dispatch_once(&modelIDNamespace_onceToken, &__block_literal_global_21589);
  return (id)modelIDNamespace_modelIDNamespace;
}

+ (id)properties
{
  if (properties_onceToken_21581 != -1)
    dispatch_once(&properties_onceToken_21581, &__block_literal_global_2_21582);
  return (id)properties__properties_21583;
}
...
void __42__HMDAnnounceUserSettingsModel_properties__block_invoke()
{
  ...
  v2 = (void *)properties__properties_21583;
  properties__properties_21583 = v1;
...
void __48__HMDAnnounceUserSettingsModel_modelIDNamespace__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("cf5e2c56-ea81-4471-88d4-0a0a0063000c"));
