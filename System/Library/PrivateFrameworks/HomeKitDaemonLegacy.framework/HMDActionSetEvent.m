...
- (id)biomeEventsRepresentationForLogObserver:(id)a3
{
  ...
  if (v5)
  {
    ...
    v32 = objc_alloc(MEMORY[0x1E0D02660]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v46 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unable to log action set event metadata to biome, no home", buf, 0xCu);
...
- (HMDActionSetEvent)initWithActionSet:(id)a3 source:(unint64_t)a4 numAccessories:(unsigned int)a5 bundleId:(id)a6 transactionId:(id)a7
{
  ...
  if (v17)
  {
    ...
    objc_msgSend(v30, "na_filter:", &__block_literal_global_81534);
    v31 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v48, "na_map:", &__block_literal_global_2_81535);
    ...
    objc_msgSend(v51, "na_map:", &__block_literal_global_3_81536);
