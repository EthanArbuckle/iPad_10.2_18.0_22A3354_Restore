...
+ (id)logCategory
{
  if (logCategory__hmf_once_t74 != -1)
    dispatch_once(&logCategory__hmf_once_t74, &__block_literal_global_108_102961);
  ...
  if (a1)
  {
    ...
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 2112;
        v28 = v5;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unable to create snapshot session identifier for: %@", (uint8_t *)&v25, 0x16u);
    ...
    if (v10)
    {
      ...
      if ((HMAreSnapshotsAllowedForCameraAccessMode() & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
        {
          ...
          v27 = 2112;
          v28 = v15;
          _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Snapshots are not allowed for camera access mode: %@", (uint8_t *)&v25, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 138543362;
        v26 = v23;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Camera profile settings is not initialized, skipping controller side checks to disallow snapshot requests", (uint8_t *)&v25, 0xCu);
      ...
      if (self->_currentLocalSession)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@There is already a local session %@ in progress, adding this request to that", buf, 0x16u);
    ...
    if (v42)
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v102 = 2112;
        v103 = v42;
        _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Most recent snapshot is still valid, sending it with payload %@", buf, 0x16u);
...
LABEL_11:
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v18;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Stream setup is in progress, adding this to pending request queue", buf, 0xCu);
...
LABEL_17:
      if (-[HMDCameraStreamSnapshotHandler isStreamAvailable](streamSnapshotHandler, "isStreamAvailable"))
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v24;
          _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Taking snapshot through available camera stream", buf, 0xCu);
        ...
        if (self)
        {
          ...
          v35 = (void *)MEMORY[0x1D17BA0A0](v34);
          v36 = v22;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v102 = 2112;
            v103 = v39;
            _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraStreamSnapshot", buf, 0x16u);
      ...
      if (v48)
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v52;
          _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_INFO, "%{public}@Taking local snapshot because accessory is reachable", buf, 0xCu);
        ...
        if (self)
        {
          ...
          v66 = (void *)MEMORY[0x1D17BA0A0](v65);
          v67 = v50;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v102 = 2112;
            v103 = v70;
            _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotLocal", buf, 0x16u);
...
LABEL_47:
          ...
          if (-[HMDCameraSnapshotManagerDataSource isWatchDevice](v72, "isWatchDevice"))
          {
            ...
            if (v74)
            {
              ...
              if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v101 = v78;
                _os_log_impl(&dword_1CD062000, v77, OS_LOG_TYPE_INFO, "%{public}@Taking remote snapshot via stream because accessory is unreachable", buf, 0xCu);
          ...
          if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v101 = v82;
            _os_log_impl(&dword_1CD062000, v81, OS_LOG_TYPE_INFO, "%{public}@Taking remote snapshot via relay because accessory is unreachable", buf, 0xCu);
      ...
      if (os_log_type_enabled(v87, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v101 = v88;
        _os_log_impl(&dword_1CD062000, v87, OS_LOG_TYPE_ERROR, "%{public}@Cannot take snapshot because accessory is unreachable remote and remote snapshots are unsupported", buf, 0xCu);
...
- (void)_issueGetSnapshot:(void *)a1
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unknown snapshot reason: %lu"), v10);
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Issuing get snapshot request for reason: %@", buf, 0x16u);
...
- (void)snapshotLocal:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v12;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotLocalDelegate call back that the image has been saved %@", (uint8_t *)&v18, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v9;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received a delegate call back for an unknown session ID: %@", buf, 0x16u);
  ...
  if (a1)
  {
    ...
    if (v9)
    {
      if (v13)
      {
        ...
        v19 = 2112;
        v20 = v5;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Resetting local session %@", (uint8_t *)&v17, 0x16u);
    ...
    else
    {
      if (v13)
      {
        ...
        v19 = 2112;
        v20 = v5;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Resetting remote session %@", (uint8_t *)&v17, 0x16u);
...
- (void)_handleCreateSnapshotFromBulletinContextMessage:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "stringForKey:", *MEMORY[0x1E0CBACC0]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "dateForKey:", *MEMORY[0x1E0CBACB8]);
  v8 = objc_claimAutoreleasedReturnValue();
  v9 = (void *)v8;
  if (!v6 || (v7 ? (v10 = v8 == 0) : (v10 = 1), v10))
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = v27;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Snapshot session ID or path or capture date is not present in request: %@", (uint8_t *)&v33, 0x16u);
  ...
  else
  {
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v37 = 2112;
        v38 = v7;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Created a slot %@ for the snapshot file %@", (uint8_t *)&v33, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = v32;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot file for request %@", (uint8_t *)&v33, 0x16u);
...
- (NSDictionary)encodedMostRecentSnapshot
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Responding to most recent snapshot with payload: %@", (uint8_t *)&v11, 0x16u);
    ...
    if (v16)
    {
      ...
      if (v17)
      {
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v113 = v22;
          _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Accessory is reachable and this is remote gateway capable device", buf, 0xCu);
        ...
        if (self)
        {
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v114 = 2112;
            v115 = v36;
            _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotRemoteRelaySender", buf, 0x16u);
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v113 = v60;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Accessory is not reachable and this is a remote gateway capable device", buf, 0xCu);
      ...
      if (isiOSDevice())
      {
        ...
        if (v41)
        {
          if (v45)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v113 = v46;
            _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Accessory is reachable and this is iOS device", buf, 0xCu);
          ...
          if (self)
          {
            ...
            if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v114 = 2112;
              v115 = v55;
              _os_log_impl(&dword_1CD062000, v58, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotRemoteStreamSender", buf, 0x16u);
        ...
        else
        {
          if (v45)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v113 = v63;
            _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Accessory is not reachable and this is iOS device, ", buf, 0xCu);
          ...
          if (self)
          {
            ...
            if (os_log_type_enabled(v67, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v113 = v68;
              _os_log_impl(&dword_1CD062000, v67, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session with HMDCameraSnapshotRemoteRelayStream", buf, 0xCu);
            ...
            if (v107)
            {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v87, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v113 = v88;
                  _os_log_impl(&dword_1CD062000, v87, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayStream: no remote access device", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v81, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v113 = v84;
                _os_log_impl(&dword_1CD062000, v81, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayStream: accessory reference is nil", buf, 0xCu);
...
LABEL_37:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v113 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Stream setup is in progress, adding this to remote pending request queue", buf, 0xCu);
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 2112;
        v19 = v9;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@%@ has timed out", (uint8_t *)&v16, 0x16u);
...
- (void)_handleRemoteSnapshotReceivedMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = objc_msgSend(v10, "conformsToProtocol:", &unk_1EFA839E8);
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          v27 = 138543362;
          v28 = v16;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Sending snapshot received confirmation to the sender", (uint8_t *)&v27, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v7;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle remote snapshot received for unknown session ID: %@", (uint8_t *)&v27, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2112;
      v30 = v4;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session ID from remote snapshot received message: %@", (uint8_t *)&v27, 0x16u);
...
- (void)_handleTakeRemoteSnapshotFailureMessage:(id)a3
{
  ...
  if (v7)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Received message that remote snapshot failed for session ID: %@", (uint8_t *)&v33, 0x16u);
    ...
    if (v13)
    {
      ...
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v15, "conformsToProtocol:", &unk_1EFAD8DD8))
        v16 = v15;
      else
        v16 = 0;
      v17 = v16;
      ...
      if (v17)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          v35 = 2112;
          v36 = v19;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Handling remote snapshot failure: %@", (uint8_t *)&v33, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          v33 = 138543362;
          v34 = v32;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle remote snapshot failure for session without a receiver", (uint8_t *)&v33, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = v7;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle remote snapshot failure for unknown session ID: %@", (uint8_t *)&v33, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = v4;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session ID from remote snapshot failure message: %@", (uint8_t *)&v33, 0x16u);
...
- (void)snapshotRelayReceiver:(id)a3 didStartGettingImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayReceiverDelegate call back that the image get has started after relay with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)snapshotRelayReceiver:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v12;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayReceiverDelegate call back that the image has been saved after relay with error %@", (uint8_t *)&v18, 0x20u);
...
- (void)snapshotRelaySender:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelaySenderDelegate call back that the image transfer has started with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)snapshotRelaySender:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelaySenderDelegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)snapshotRelaySender:(id)a3 didSaveSnapshotFile:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v15;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelaySenderDelegate call back that snapshotFile:%@ has been saved for snapshotCharacteristicEventUUID:%@", (uint8_t *)&v20, 0x2Au);
...
- (void)snapshotStreamReceiver:(id)a3 didStartGettingImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamReceiverDelegate call back that the image get has started after relay with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)snapshotStreamReceiver:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v12;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamReceiverDelegate call back that the image has been saved after relay with error %@", (uint8_t *)&v18, 0x20u);
...
- (void)snapshotStreamSender:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamSenderDelegate call back that the image transfer has started with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)snapshotStreamSender:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamSenderDelegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)snapshotRelayStream:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayStreamDelegate call back that the image transfer has started with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)snapshotRelayStream:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayStreamDelegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x20u);
...
- (void)streamSnapshotHandler:(id)a3 didGetNewSnapshot:(id)a4
{
  ...
  if (v10)
  {
    if (v14)
    {
      ...
      v27 = 2112;
      v28 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received a new snapshot from stream %@", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    if (v14)
    {
      ...
      v25 = 138543362;
      v26 = v23;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@New snapshot capture has resulted in failure", (uint8_t *)&v25, 0xCu);
...
- (void)streamSnapshotHandler:(id)a3 didGetLastSnapshot:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received the last snapshot from stream %@", (uint8_t *)&v17, 0x16u);
    ...
    if (self)
      ...
      snapshotSlotManager = 0;
    v16 = -[HMDSnapshotSlotManager createSlotForSnapshotFile:requestMessages:shouldNotifyClients:](snapshotSlotManager, "createSlotForSnapshotFile:requestMessages:shouldNotifyClients:", v10, MEMORY[0x1E0C9AA60], 1);
  }
...
- (void)streamSnapshotHandler:(id)a3 didChangeStreamSetupInProgress:(BOOL)a4
{
  ...
  if (!a4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Received call back that stream setup is not in progress anymore", buf, 0xCu);
...
void __70__HMDCameraSnapshotManager_handleCameraSettingsDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Camera profile settings are not initialized, skipping cancelling pending snapshot requests", (uint8_t *)&v11, 0xCu);
    ...
    if (*(_QWORD *)(a1 + 32))
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v67 = 2112;
        v68 = v3;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failing current local session %@:%@", buf, 0x20u);
    ...
    if (objc_msgSend(*(id *)(a1 + 40), "count"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v67 = 2112;
        v68 = v3;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failing current remote sessions %@:%@", buf, 0x20u);
    ...
    if (objc_msgSend(*(id *)(a1 + 104), "count"))
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v67 = 2112;
        v68 = v3;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failing pending snapshot request during stream set up %@:%@", buf, 0x20u);
    ...
    if (objc_msgSend(*(id *)(a1 + 112), "count"))
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v67 = 2112;
        v68 = v3;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failing pending remote snapshot request during stream set up %@:%@", buf, 0x20u);
  ...
  if (a1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v14 = 22;
LABEL_10:
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v15, v14);
...
- (void)_sendSnapshotRequestStreamReceiver:(void *)a3 snapshotSessionID:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session with HMDCameraSnapshotRemoteStreamReceiver", buf, 0xCu);
    ...
    if (WeakRetained)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v36 = v32;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteStreamReceiver: no remote access device", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v28;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteStreamReceiver: accessory reference is nil", buf, 0xCu);
...
- (void)_sendSnapshotRequestRelayReceiver:(void *)a3 snapshotSessionID:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v44 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session with HMDCameraSnapshotRemoteRelayReceiver", buf, 0xCu);
    ...
    if (WeakRetained)
    {
      ...
      if (v12)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v45 = 2112;
          v46 = v32;
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotRemoteRelayReceiver", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v44 = v40;
          _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayReceiver: no remote access device", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v44 = v36;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayReceiver: accessory reference is nil", buf, 0xCu);
...
void __62__HMDCameraSnapshotManager_releaseSnapshotWithSlotIdentifier___block_invoke(uint64_t a1)
{
  ...
  v2 = *(_QWORD *)(a1 + 32);
  v5 = *MEMORY[0x1E0CB9C50];
  v6[0] = v2;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v6, &v5, 1);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:messagePayload:responseHandler:", *MEMORY[0x1E0CB8630], v3, &__block_literal_global_44_102926);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (void)cleanStaleSnapshotDirectoriesUsingCurrentAccessories:(id)a3
{
  ...
  v29 = v3;
  objc_msgSend(v3, "na_map:", &__block_literal_global_102965);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        if ((objc_msgSend(v6, "containsObject:", v14) & 1) == 0)
        {
          ...
          else if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v28 = 32;
LABEL_12:
            _os_log_impl(&dword_1CD062000, v25, v26, v27, buf, v28);
