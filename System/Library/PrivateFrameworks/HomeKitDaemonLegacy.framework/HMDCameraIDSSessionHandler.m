...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the IDS session handler", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_102322 != -1)
    dispatch_once(&logCategory__hmf_once_t1_102322, &__block_literal_global_102323);
  return (id)logCategory__hmf_once_v2_102324;
}
...
void __41__HMDCameraIDSSessionHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_102324;
  logCategory__hmf_once_v2_102324 = v0;
