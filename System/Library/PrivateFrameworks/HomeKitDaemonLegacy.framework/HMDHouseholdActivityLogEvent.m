  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Household activity is missing home UUID. Assuming from original SkyG seed and ignoring.", buf, 0xCu);
        ...
        if ((v22 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v39;
            ...
            v66 = 2112;
            v67 = v43;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Source household data log event home UUID doesn't match new event's home UUID: %@, %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_55845 != -1)
    dispatch_once(&logCategory__hmf_once_t5_55845, &__block_literal_global_55846);
  return (id)logCategory__hmf_once_v6_55847;
}
...
void __43__HMDHouseholdActivityLogEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_55847;
  logCategory__hmf_once_v6_55847 = v0;
