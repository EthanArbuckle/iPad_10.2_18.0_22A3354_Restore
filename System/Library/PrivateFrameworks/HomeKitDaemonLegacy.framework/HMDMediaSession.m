...
- (id)_initWithEndpoint:(id)a3 mediaProfiles:(id)a4 state:(id)a5
{
  ...
  if (v13)
  {
    ...
    v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"));
...
- (id)dumpState
{
  ...
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObject:forKey:", v10, *MEMORY[0x1E0D27F80]);
  ...
  if (-[HMDMediaSession isCurrentAccessorySession](self, "isCurrentAccessorySession"))
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v16;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up local origin for currentAccessory to get playback state", buf, 0xCu);
      ...
      if (v6)
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 4, CFSTR("Cannot lookup origin"), CFSTR("Cannot lookup origin"), 0, v17);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v12;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Attempting to locally read the playback state from media remote", buf, 0xCu);
...
- (void)_postNotificationOfMediaStateUpdateWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v11;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Sending internal notification %@ with payload %@", (uint8_t *)&v18, 0x20u);
...
- (void)_queueSetPlaybackStateCompletion:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (!v7)
    {
      ...
      v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, v11);
    ...
    if (-[HMDMediaSession isCurrentAccessorySession](self, "isCurrentAccessorySession"))
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v41 = v27;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up local origin for currentAccessory to set playback state", buf, 0xCu);
        ...
        if (v7)
        {
          ...
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 4, CFSTR("Cannot lookup origin"), CFSTR("Cannot lookup origin"), 0, v28);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v41 = v15;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Attempting to set the playback state command with mediaRemote to local origin", buf, 0xCu);
        ...
        if (v17)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v41 = v21;
            _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Sending the command to mediaremote failed for mediaSession", buf, 0xCu);

          }
          objc_autoreleasePoolPop(v18);
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 2005);
          v22 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 74, CFSTR("Media remote command send failure "), CFSTR("Media remote command send failure"), 0, v22);
...
- (void)_notifyClientsOfUpdatedVolume:(id)a3 muted:(id)a4 inResponseToMessage:(id)a5
{
  ...
  if (v10)
  {
    ...
    objc_msgSend(v15, "setObject:forKey:", v16, *MEMORY[0x1E0CB95B0]);

  }
  if (v8)
    objc_msgSend(v15, "setObject:forKey:", v8, *MEMORY[0x1E0CB9550]);
  if (v9)
    objc_msgSend(v15, "setObject:forKey:", v9, *MEMORY[0x1E0CB9538]);
  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v15;
    _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Sending internal notification %@ with payload %@", (uint8_t *)&v22, 0x20u);
...
- (void)_handleMediaSessionSetAudioControl:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = *MEMORY[0x1E0CB9550];
  objc_msgSend(v4, "objectForKey:", *MEMORY[0x1E0CB9550]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_handleMediaUpdateVolume:(id)a3
{
  ...
  v10 = a3;
  objc_msgSend(v10, "numberForKey:", *MEMORY[0x1E0CB9550]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  {
...
- (void)_handleMediaUpdateMuted:(id)a3
{
  ...
  if (v7)
    ...
    v5 = 20;
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)updateEndpoint:(id)a3
{
  ...
  if ((v11 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@MediaSession endpoint %@ changed to %@", (uint8_t *)&v15, 0x20u);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v12, "playbackState"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x1E0CB9578]);

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v12, "shuffleState"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB95D0]);

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v12, "repeatState"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x1E0CB95A0]);

  objc_msgSend(v12, "volume");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v8, *MEMORY[0x1E0CB9548]);

  objc_msgSend(v12, "muted");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v9, *MEMORY[0x1E0CB9530]);

  objc_msgSend(v12, "mediaUniqueIdentifier");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v10, *MEMORY[0x1E0CB9560]);

  -[HMDMediaSession sessionIdentifier](self, "sessionIdentifier");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v11, *MEMORY[0x1E0CB95B8]);
...
void __32__HMDMediaSession_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    v4 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 40), "setSetPlaybackStateTimer:", 0));
    v5 = *(id *)(a1 + 40);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Timed out waiting for media playback state notification - reading the state explicitly...", buf, 0xCu);
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v22;
            ...
            v41 = 2112;
            v42 = v13;
            _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Setting playback state received from remote %@", buf, 0x16u);
...
void __46__HMDMediaSession_writeProperties_completion___block_invoke_2(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2048;
      v15 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@responding to set playback with state %ld", (uint8_t *)&v12, 0x16u);
...
void __45__HMDMediaSession_readProperties_completion___block_invoke(id *a1)
{
  ...
  v60 = 0u;
  obj = a1[4];
  v2 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v59, v64, 16);
  if (v2)
  {
    v48 = *(_QWORD *)v60;
    v3 = *MEMORY[0x1E0CB9580];
    v44 = *MEMORY[0x1E0CB95D8];
    v43 = *MEMORY[0x1E0CB95A8];
    v42 = *MEMORY[0x1E0CB95E8];
    v41 = *MEMORY[0x1E0CB9568];
    do
    {
      v4 = 0;
      do
      {
        ...
        else
        {
          objc_msgSend(v5, "property");
          v11 = (void *)objc_claimAutoreleasedReturnValue();
          v12 = objc_msgSend(v11, "isEqual:", v44);
          ...
          if (v12)
          {
            ...
            v15 = (void *)objc_claimAutoreleasedReturnValue();
            +[HMDMediaPropertyResponse responseWithRequest:value:updatedTime:](HMDMediaPropertyResponse, "responseWithRequest:value:updatedTime:", v5, v15, v47);
            v16 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          else
          {
            objc_msgSend(v5, "property");
            v17 = (void *)objc_claimAutoreleasedReturnValue();
            v18 = objc_msgSend(v17, "isEqual:", v43);
            ...
            if (v18)
            {
              ...
              v21 = (void *)objc_claimAutoreleasedReturnValue();
              +[HMDMediaPropertyResponse responseWithRequest:value:updatedTime:](HMDMediaPropertyResponse, "responseWithRequest:value:updatedTime:", v5, v21, v47);
              v22 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            else
            {
              objc_msgSend(v5, "property");
              v23 = (void *)objc_claimAutoreleasedReturnValue();
              v24 = objc_msgSend(v23, "isEqual:", v42);
              ...
              if (v24)
              {
                ...
                if (v26)
                {
                  ...
                  v28 = (void *)objc_claimAutoreleasedReturnValue();
                  +[HMDMediaPropertyResponse responseWithRequest:value:updatedTime:](HMDMediaPropertyResponse, "responseWithRequest:value:updatedTime:", v5, v28, v47);
                  v29 = (void *)objc_claimAutoreleasedReturnValue();
              ...
              else
              {
                ...
                v31 = objc_msgSend(v30, "isEqual:", v41);
                ...
                if (v31)
                {
                  ...
                  if (v33)
                  {
                    ...
                    +[HMDMediaPropertyResponse responseWithRequest:value:updatedTime:](HMDMediaPropertyResponse, "responseWithRequest:value:updatedTime:", v5, v35, v47);
      ...
      if (v14 && v14 != 3)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v28;
          ...
          v34 = 2048;
          v35 = v15;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Locally setting playback state failed with status: %ld", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v16);
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 2005);
        v20 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 74, CFSTR("Media remote command failure "), CFSTR("Media remote command failure"), 0, v20);
        v21 = objc_claimAutoreleasedReturnValue();
...
LABEL_16:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2048;
    v35 = v26;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Set plaback state to %ld on successfully sending mediaremote command", buf, 0x16u);
...
void __65__HMDMediaSession_updateWithResponses_requestMessageInformation___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v72 = 2112;
    v73 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Updating media session with responses %@", buf, 0x16u);
  ...
  v66 = 0u;
  v7 = *(id *)(a1 + 40);
  v64 = objc_msgSend(v7, "countByEnumeratingWithState:objects:count:", &v65, v69, 16);
  if (v64)
  {
    v8 = 0;
    v63 = *(_QWORD *)v66;
    v62 = *MEMORY[0x1E0CB9580];
    v61 = *MEMORY[0x1E0CB95D8];
    v60 = *MEMORY[0x1E0CB95A8];
    v59 = *MEMORY[0x1E0CB95E8];
    obj = v7;
    v58 = *MEMORY[0x1E0CB9568];
    do
    {
      for (i = 0; i != v64; ++i)
      {
        ...
        objc_msgSend(v10, "request", obj);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v11, "property");
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        if (objc_msgSend(v12, "isEqual:", v62))
        {
        ...
        if (objc_msgSend(v12, "isEqual:", v61))
        {
          objc_msgSend(v10, "value");
          v23 = (void *)objc_claimAutoreleasedReturnValue();
          objc_opt_class();
        ...
        if (objc_msgSend(v12, "isEqual:", v60))
        {
          objc_msgSend(v10, "value");
          v33 = (void *)objc_claimAutoreleasedReturnValue();
          objc_opt_class();
        ...
        if (objc_msgSend(v12, "isEqual:", v59))
        {
          objc_msgSend(v10, "value");
        ...
        if (objc_msgSend(v12, "isEqual:", v58))
        {
          objc_msgSend(v10, "value");
...
void __56__HMDMediaSession_handleMediaPlaybackStateNotification___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 40), "hmf_numberForKey:", *MEMORY[0x1E0D4CD88]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = v4;
  if (v4)
  {
...
void __51__HMDMediaSession__getPlaybackStateWithCompletion___block_invoke(uint64_t a1, void *a2, unsigned int a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2048;
      v18 = v8;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Locally read the playback state as: %tu", (uint8_t *)&v15, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_85227 != -1)
    dispatch_once(&logCategory__hmf_once_t1_85227, &__block_literal_global_85228);
  return (id)logCategory__hmf_once_v2_85229;
}
...
+ (NSArray)mediaPropertyMessageKeys
{
  ...
  v2 = *MEMORY[0x1E0CB95D8];
  v5[0] = *MEMORY[0x1E0CB9580];
  v5[1] = v2;
  v3 = *MEMORY[0x1E0CB95E8];
  v5[2] = *MEMORY[0x1E0CB95A8];
  v5[3] = v3;
  v5[4] = *MEMORY[0x1E0CB9568];
...
+ (Class)mediaPropertyValueTypeWithMessageKey:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB9580]) & 1) != 0
    || (objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB95D8]) & 1) != 0
    || (objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB95A8]) & 1) != 0
    || (objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB95E8]) & 1) != 0
    || objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB9568]))
  {
    objc_opt_class();
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
void __30__HMDMediaSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_85229;
  logCategory__hmf_once_v2_85229 = v0;
