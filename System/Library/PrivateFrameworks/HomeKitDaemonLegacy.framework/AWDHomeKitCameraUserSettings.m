...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) == 0)
  {
    if ((*(_BYTE *)&self->_has & 1) == 0)
      goto LABEL_3;
LABEL_7:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isImportingFromPhotoLibraryEnabled);
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isSharingFaceClassificationsEnabled);
