...
- (id)modelsToAdd
{
  ...
  -[HMDCameraClipModel setIsComplete:](v6, "setIsComplete:", MEMORY[0x1E0C9AAA0]);
  -[HMDCameraClipModel setDuration:](v6, "setDuration:", &unk_1E8B35028);
  ...
  -[HMDCameraClipModel setRecordedLocally:](v6, "setRecordedLocally:", MEMORY[0x1E0C9AAB0]);
  -[HMDCameraClipModel setStreamingAssetVersion:](v6, "setStreamingAssetVersion:", CFSTR("1"));
  v12 = objc_alloc_init(MEMORY[0x1E0D32CF8]);
  -[HMDCameraClipModel setVideoStreamingAsset:](v6, "setVideoStreamingAsset:", v12);

  -[HMDCameraClipModel setVideoMetadataArray:](v6, "setVideoMetadataArray:", MEMORY[0x1E0C9AA60]);
  ...
  -[HMDCameraClipModel setEncryptionScheme:](v6, "setEncryptionScheme:", &unk_1E8B35040);
  ...
  {
    v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286E0]), "initWithVersionString:", CFSTR("8.0"));
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v20;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Creating clip: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_166653 != -1)
    dispatch_once(&logCategory__hmf_once_t1_166653, &__block_literal_global_166654);
  return (id)logCategory__hmf_once_v2_166655;
}
...
void __67__HMDCameraClipCreateClipWithSignificantEventOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_166655;
  logCategory__hmf_once_v2_166655 = v0;
