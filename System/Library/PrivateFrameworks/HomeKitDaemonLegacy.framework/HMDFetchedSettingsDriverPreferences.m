  ...
  if (v15)
  {
    ...
    while (1)
    {
      for (i = 0; i != v18; ++i)
      {
        ...
        if (!v25)
        {
          if (objc_msgSend(*(id *)(v20 + 720), "isKeyPathForBooleanSettingType:", v22))
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v59 = 2114;
              v60 = v22;
              _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Setting default BOOL value %@ for Key: %{public}@", buf, 0x20u);
          ...
          v34 = objc_msgSend(*(id *)(v20 + 720), "isKeyPathForConstrainedNumberSettingType:", v22);
          ...
          if (v34)
          {
            if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v59 = 2114;
              v60 = v22;
              _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_DEFAULT, "%{public}@Setting default integer value %@ for Key: %{public}@", buf, 0x20u);
          ...
          else
          {
            if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v57 = 2114;
              v58 = v22;
              _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Data type for Key %{public}@ not supported", buf, 0x16u);
...
- (void)fetchSettingsForKeyPaths:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v83 = 2114;
    v84 = v6;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Got fetch request for keyPaths:%{public}@", buf, 0x16u);
  ...
  do
  {
    ...
    do
    {
      ...
      if (!v22)
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v83 = 2114;
          v84 = v17;
          _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@Key %{public}@ not found", buf, 0x16u);
      ...
      if (objc_msgSend(*(id *)(v14 + 720), "isKeyPathForBooleanSettingType:", v17))
      {
        if (self)
        ...
        v26 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA368]), "initWithKeyPath:readOnly:BOOLValue:", v17, 0, v25);
        ...
        if (v26)
        {
          if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v83 = 2114;
            v84 = v17;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@BOOL %{public}@", buf, 0x16u);
        ...
        else
        {
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v83 = 2114;
            v84 = v17;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Boolean data type for Key %{public}@ had no integer setting", buf, 0x16u);
      ...
      {
        if (!objc_msgSend(*(id *)(v14 + 720), "isKeyPathForConstrainedNumberSettingType:", v17))
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v83 = 2114;
            v84 = v17;
            _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_ERROR, "%{public}@Data type of key %{public}@ is neither a BOOL nor a number", buf, 0x16u);
...
LABEL_36:
        ...
        objc_msgSend(*(id *)(v14 + 720), "defaultSettingsConstraintsForKeyPath:", v17);
        ...
        if (v26)
        {
          ...
          v41 = objc_alloc(MEMORY[0x1E0CBA370]);
          ...
          if (v47)
          {
            if (os_log_type_enabled(v50, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v83 = 2114;
              v84 = v17;
              _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_DEFAULT, "%{public}@int %{public}@", buf, 0x16u);
          ...
          else
          {
            if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v83 = 2114;
              v84 = v17;
              _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Integer data type for Key %{public}@ had no integer setting", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v83 = 2114;
            v84 = v17;
            _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_DEFAULT, "%{public}@Default settings constraints for Key %{public}@ not found", buf, 0x16u);
...
- (void)updateSettingWithKeyPath:(id)a3 BOOLSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (self)
    ...
    Property = 0;
  dispatch_assert_queue_V2(Property);
  v13 = objc_msgSend(MEMORY[0x1E0CBA2D0], "isKeyPathForBooleanSettingType:", v8);
  ...
  if ((v13 & 1) != 0)
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v43 = 2112;
      v44 = v9;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v43 = 2112;
        v44 = v9;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Changing %{public}@ to %@", buf, 0x20u);
      ...
      v11[2](v11, 0);
      v34 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA368]), "initWithKeyPath:readOnly:BOOLValue:", v8, 0, objc_msgSend(v9, "BOOLValue"));
  ...
  else
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2114;
      v42 = v8;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Key %{public}@ not part of expected BOOL keys", buf, 0x16u);
...
- (void)updateSettingWithKeyPath:(id)a3 integerSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (self)
    ...
    Property = 0;
  dispatch_assert_queue_V2(Property);
  v13 = objc_msgSend(MEMORY[0x1E0CBA2D0], "isKeyPathForConstrainedNumberSettingType:", v8);
  v14 = (void *)MEMORY[0x1D17BA0A0]();
  v15 = self;
  HMFGetOSLogHandle();
  v16 = objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v60 = 2112;
        v61 = v33;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Changing %{public}@ to %@", buf, 0x20u);
      ...
      v11[2](v11, 0);
      objc_msgSend(MEMORY[0x1E0CBA2D0], "defaultSettingsConstraintsForKeyPath:", v54);
      v38 = (void *)objc_claimAutoreleasedReturnValue();
      if (v38)
      {
        v52 = objc_alloc(MEMORY[0x1E0CBA370]);
  ...
  else
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v58 = 2114;
      v59 = v8;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Key %{public}@ not part of expected integer keys", buf, 0x16u);
...
- (void)updateSettingWithKeyPath:(id)a3 languageSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    v18 = 2112;
    v19 = v8;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Only BOOL settings are supported keyPath: %@", (uint8_t *)&v16, 0x16u);
...
{
  (*((void (**)(id, _QWORD, _QWORD))a3 + 2))(a3, MEMORY[0x1E0C9AA60], 0);
}
...
- (void)updateSettingWithKeyPath:(id)a3 primaryUserInfo:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    v18 = 2112;
    v19 = v8;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Primary user info is not supported for keyPath: %@", (uint8_t *)&v16, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_134926 != -1)
    dispatch_once(&logCategory__hmf_once_t3_134926, &__block_literal_global_134927);
  return (id)logCategory__hmf_once_v4_134928;
}
...
void __50__HMDFetchedSettingsDriverPreferences_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_134928;
  logCategory__hmf_once_v4_134928 = v0;
