...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_45068 != -1)
    dispatch_once(&logCategory__hmf_once_t3_45068, &__block_literal_global_182_45069);
  return (id)logCategory__hmf_once_v4_45070;
}
...
void __48__HMDBackingStoreTransactionActions_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_45070;
  logCategory__hmf_once_v4_45070 = v0;
