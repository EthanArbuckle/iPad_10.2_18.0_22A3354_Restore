...
- (id)copyFileAtPath:(id)a3 snapshotTimestamp:(id)a4
{
  ...
  if ((v7 & 1) == 0)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1035);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v32 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating HMDSnapshotFile", buf, 0xCu);
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v33 = 2112;
          v34 = v19;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Deleting snapshot file at %@", buf, 0x16u);
        ...
        if ((v22 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v35 = 2112;
            v36 = v23;
            _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to delete snapshot file at %@: %@", buf, 0x20u);
...
- (void)fillSlot
{
  ...
  if (!-[HMDSnapshotFile isFilled](self, "isFilled"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v4;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Filling snapshot slot for snapshot %@", (uint8_t *)&v10, 0x16u);
...
- (void)clearSlot
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Clearing snapshot slot for snapshot %@", (uint8_t *)&v9, 0x16u);
...
LABEL_67:
      _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, v46, buf, 0x16u);
  ...
  if (!v9)
  {
    ...
    if (v47)
    {
      ...
      if (ImageAtIndex)
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", (double)Width / (double)CGImageGetHeight(v50));
      ...
      else
      {
        ...
        if (os_log_type_enabled(v76, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v147 = 2112;
          v148 = v22;
          _os_log_impl(&dword_1CD062000, v76, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image for file path %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v147 = 2112;
        v148 = v22;
        _os_log_impl(&dword_1CD062000, v58, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image source for file path %@", buf, 0x16u);
...
LABEL_40:
      ...
      if (!objc_msgSend(v78, "unsignedIntegerValue"))
      {
        ...
        if (os_log_type_enabled(v94, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v147 = 2112;
          v148 = v91;
          _os_log_impl(&dword_1CD062000, v94, OS_LOG_TYPE_INFO, "%{public}@Failed to save the file %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v85, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v151 = 2112;
      v152 = (size_t)v52;
      _os_log_impl(&dword_1CD062000, v85, OS_LOG_TYPE_INFO, "%{public}@Initialized the snapshot file path %@, timestamp %@, aspect ratio %@", buf, 0x2Au);
  ...
  if (v25)
  {
    ...
    if (v26)
    {
      ...
      *(double *)&v28 = COERCE_DOUBLE(CGImageGetWidth(v26));
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", (double)v28 / (double)Height);
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v151 = 2048;
        v152 = Height;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Image at %@ is of width %lu, height %lu", buf, 0x2Au);
      ...
      if (Height == v38 && v28 == v35 || v28 == v38 && Height == v35)
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v147 = 2112;
          v148 = v22;
          _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Given data matches the expected resolution for file path %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (ColorSpace)
        {
          ...
          if (v104)
          {
            ...
            if (v106)
            {
              v107 = (__CFData *)objc_alloc_init(MEMORY[0x1E0C99DF0]);
              v108 = CGImageDestinationCreateWithData(v107, (CFStringRef)*MEMORY[0x1E0CA5BA8], 1uLL, 0);
              v16 = v132;
              cf = v106;
              if (v108)
              {
                ...
                if (v110)
                {
                  ...
                  if (os_log_type_enabled(v111, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    v151 = 2048;
                    v152 = v115;
                    _os_log_impl(&dword_1CD062000, v112, OS_LOG_TYPE_INFO, "%{public}@Returning JPEG image of width: %lf, height: %lf, %tu bytes", buf, 0x2Au);
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v111, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543362;
                    v146 = v128;
                    _os_log_impl(&dword_1CD062000, v112, OS_LOG_TYPE_ERROR, "%{public}@Failing to finalize destination", buf, 0xCu);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v126, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v147 = 2112;
                  v148 = v22;
                  _os_log_impl(&dword_1CD062000, v126, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image destination for file path %@", buf, 0x16u);
...
LABEL_62:
        ...
        if (os_log_type_enabled(v118, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v147 = 2112;
          v148 = v22;
          _os_log_impl(&dword_1CD062000, v118, OS_LOG_TYPE_ERROR, "%{public}@Failed to create resized image for file path %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v147 = 2112;
      v148 = v22;
      _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image for file path %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v147 = 2112;
      v148 = v22;
      _os_log_impl(&dword_1CD062000, v54, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image source for file path %@", buf, 0x16u);
...
LABEL_32:
  ...
  if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v146 = v74;
    _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_INFO, "%{public}@Could not resize image, returning back the original", buf, 0xCu);
...
LABEL_63:
  ...
  if (os_log_type_enabled(v123, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v147 = 2112;
    v148 = v22;
    _os_log_impl(&dword_1CD062000, v123, OS_LOG_TYPE_INFO, "%{public}@Resizing file data for file path %@ resulted in 0 length data", buf, 0x16u);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data from file at path: %@ error: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v42 = 2048;
          v43 = v34;
          _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Either file timestamp %@ or file data %tu is missing", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v40 = 2112;
        v41 = v12;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Decoded object: %@ is not of type dictionary", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v11;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive allowed IDS session options from relay data: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_73535 != -1)
    dispatch_once(&logCategory__hmf_once_t0_73535, &__block_literal_global_73536);
  return (id)logCategory__hmf_once_v1_73537;
}
...
void __30__HMDSnapshotFile_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_73537;
  logCategory__hmf_once_v1_73537 = v0;
