...
- (void)updateCurrentAccessoryCapabilities
{
  ...
  if (self && (WeakRetained = objc_loadWeakRetained((id *)&self->_dataSource)) != 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Finished loading current capabilities", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Nil dataSource", buf, 0xCu);
...
- (BOOL)areCurrentAccessoryCapabilitiesPresentAndDifferent:(id)a3
{
  ...
  -[HMDCapabilitiesController _lastCachedAccessoryCapabilities]((uint64_t)self);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA1D0]), "initWithProtoData:", v4);
...
- (BOOL)areCurrentResidentCapabilitiesPresentAndDifferent:(id)a3
{
  ...
  -[HMDCapabilitiesController _lastCachedResidentCapabilities]((uint64_t)self);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA7B8]), "initWithProtoData:", v4);
...
- (id)_lastCachedResidentCapabilities
{
  ...
  if (a1)
  {
    v2 = (void *)MEMORY[0x1E0CBA240];
    v3 = *MEMORY[0x1E0CB7C38];
    ...
    if (v9)
    {
      v10 = objc_alloc(MEMORY[0x1E0CBA7B8]);
...
- (id)_lastCachedAccessoryCapabilities
{
  ...
  if (a1)
  {
    ...
    if (v9)
    {
      v10 = objc_alloc(MEMORY[0x1E0CBA1D0]);
      objc_msgSend(v9, "encodedData");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      v12 = (void *)objc_msgSend(v10, "initWithProtoData:", v11);
...
void __55__HMDCapabilitiesController_didRemoveCurrentAccessory___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Reset accessory on removal", (uint8_t *)&v8, 0xCu);
...
void __63__HMDCapabilitiesController_currentAccessoryDidBecomeAvailable__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 138543362;
    v36 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Current accessory available", (uint8_t *)&v35, 0xCu);
      ...
      if (v9)
      {
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
          {
            ...
            v35 = 138543362;
            v36 = v20;
            _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Current accessory became available and is different", (uint8_t *)&v35, 0xCu);
          ...
          if ((v14 & 1) != 0)
          {
            if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v30 = 2112;
              v31 = v3;
              _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Accessory capabilities are the same not posting: %@", buf, 0x16u);
          ...
          else
          {
            if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v30 = 2112;
              v31 = v3;
              _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Posting event as current accessory capabilities are different: %@", buf, 0x16u);

            }
            objc_autoreleasePoolPop(v15);
            v21 = objc_alloc(MEMORY[0x1E0D32D28]);
            ...
            if (v3)
            {
              ...
              if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v31 = 2112;
                v32 = v3;
                _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Resident capabilities are the same not posting: %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v31 = 2112;
              v32 = v3;
              _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Posting event as current resident capabilities are different: %@", buf, 0x16u);

            }
            objc_autoreleasePoolPop(v18);
            v22 = objc_alloc(MEMORY[0x1E0D32D28]);
            objc_msgSend(v3, "pbCapabilities");
            v23 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_metadataForEvent
{
  ...
  v2 = objc_alloc(MEMORY[0x1E0D32D38]);
...
void __75__HMDCapabilitiesController__postCurrentResidentCapabilitiesEventIfNeeded___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Posted event for current resident capabilities error: %@", (uint8_t *)&v8, 0x16u);
...
void __76__HMDCapabilitiesController__postCurrentAccessoryCapabilitiesEventIfNeeded___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Posted event for current accessory capabilities error: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_127219 != -1)
    dispatch_once(&logCategory__hmf_once_t0_127219, &__block_literal_global_127220);
  return (id)logCategory__hmf_once_v1_127221;
}
...
void __40__HMDCapabilitiesController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_127221;
  logCategory__hmf_once_v1_127221 = v0;
