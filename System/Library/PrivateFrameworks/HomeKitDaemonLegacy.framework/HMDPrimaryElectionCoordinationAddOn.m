...
- (HMDPrimaryElectionCoordinationAddOn)initWithContext:(id)a3 meshController:(id)a4 dataSource:(id)a5
{
  ...
  *((_QWORD *)v11 + 2) = v12;
  ...
  v14 = objc_msgSend(objc_alloc(MEMORY[0x1E0D28570]), "initWithQueue:", *((_QWORD *)v11 + 2));
  ...
  *((_QWORD *)v11 + 22) = v29;
  ...
  v11[24] = 0;
  *(_OWORD *)(v11 + 152) = xmmword_1CDB8FBB0;
...
- (void)start
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("%@.%@"), CFSTR("com.apple.HomeKit"), v6);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v17 = 2114;
    v18 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Starting mesh controller with type: %{public}@, name: %{public}@", buf, 0x20u);
...
- (void)stop
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2114;
    v13 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping mesh controller with type: %{public}@", (uint8_t *)&v10, 0x16u);
...
- (void)performElection
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2048;
      v23 = 0;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Rapportd might have died (%lu -> %lu visible devices)", (uint8_t *)&v18, 0x20u);
    ...
    if ((v11 & 1) != 0)
    {
      if (v15)
      {
        ...
        v18 = 138543362;
        v19 = v16;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@We are the current primary resident, using the cautious debounce timeout", (uint8_t *)&v18, 0xCu);
    ...
    else
    {
      if (v15)
      {
        ...
        v18 = 138543362;
        v19 = v17;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@We are not the current primary, going to pessimistic secondary mesh state", (uint8_t *)&v18, 0xCu);
  ...
  if (state != a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if (state > 5)
        ...
        v11 = off_1E89BEE48[state];
      if (a3 > 5)
        v12 = CFSTR("<unknown state>");
      else
        v12 = off_1E89BEE48[a3];
      ...
      *(_QWORD *)&v21[14] = v11;
      v22 = 2114;
      v23 = v12;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Transitioning state from %{public}@ -> %{public}@", v21, 0x20u);
...
LABEL_21:
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, v19, v21, 0xCu);
...
- (void)_findPrimaryMeshWithContext:(id)a3 otherResidents:(id)a4
{
  ...
  v5 = a3;
  dispatch_assert_queue_V2((dispatch_queue_t)self->_queue);
  v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28570]), "initWithQueue:", self->_queue);
...
- (void)_selectPrimaryResidentWithReason:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v40 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Electing a primary resident", buf, 0xCu);
  ...
  if (a3 == 7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Calling _selectPrimaryResidentFromCandidates due to forced primary election from debug/tools", buf, 0xCu);
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v40 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Debounce timer active, deferring election", buf, 0xCu);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v40 = v33;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@No current resident device, bailing", buf, 0xCu);
...
- (void)handleDeviceCapabilitiesRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received capabilities request from: %@", (uint8_t *)&v13, 0x16u);
...
- (void)handleCurrentPrimaryRequest:(id)a3
{
  ...
  if ((-[HMDLocalElectionMeshController isLeader](self->_meshController, "isLeader") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Not responding to current primary request because we're not the leader", buf, 0xCu);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Not responding to current primary request because we are debouncing an election", buf, 0xCu);
...
LABEL_9:
  ...
  if (v17)
  {
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v36 = 2114;
      v37 = v25;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Responding to current primary request from: %{public}@ with: %{public}@", buf, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v29;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not responding to current primary request because our primary resident is nil", buf, 0xCu);
  ...
  if (v5)
  {
            ...
            (v11 & 1) == 0))
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v58 = 2114;
          v59 = v27;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received a current primary update from an unexpected device: Leader: %{public}@, Source: %{public}@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v56 = 2114;
            v57 = v7;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to map %{public}@ to known resident", buf, 0x16u);
        ...
        if ((v36 & 1) != 0)
        {
          if (v40)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v56 = 2112;
            v57 = v42;
            _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_INFO, "%{public}@Broadcasted primary is current primary: %@", buf, 0x16u);
        ...
        else
        {
          if (v40)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v56 = 2112;
            v57 = v13;
            _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_INFO, "%{public}@Received update for current primary: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v55 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Message did not contain a primary resident value", buf, 0xCu);
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      if (v13)
      {
        ...
        v19 = 2112;
        v20 = v9;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling mesh information request and responding with: %@", (uint8_t *)&v17, 0x16u);
    ...
    else
    {
      if (v13)
      {
        ...
        v17 = 138543362;
        v18 = v16;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling mesh information request and responding with error", (uint8_t *)&v17, 0xCu);
...
- (void)handleSetPreferredPrimaryDebugRequest:(id)a3
{
  ...
  if (v6)
  {
    if (v14)
    {
      ...
      v45 = 2112;
      v46 = v16;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received SetPreferredPrimaryDebugRequest with primary: %@ ...isOneTime: %@", (uint8_t *)&v41, 0x20u);

    }
    objc_autoreleasePoolPop(v11);
    v17 = v6;
    v18 = (void *)MEMORY[0x1D17BA0A0](CFSTR("hmd.preferred.primary.homeutil"));
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v46 = v25;
      v47 = 2112;
      v48 = CFSTR("hmd.preferred.primary.homeutil");
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Setting preferred primary: %@, isOneTime: %@, applicationKey: %@", (uint8_t *)&v41, 0x2Au);
    ...
    CFPreferencesSetAppValue(CFSTR("hmd.preferred.primary"), v17, CFSTR("hmd.preferred.primary.homeutil"));
    if (v8)
      v26 = (const void *)MEMORY[0x1E0C9AAB0];
    else
      v26 = (const void *)MEMORY[0x1E0C9AAA0];
    CFPreferencesSetAppValue(CFSTR("hmd.preferred.primary.one.time"), v26, CFSTR("hmd.preferred.primary.homeutil"));
...
LABEL_14:
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v41 = 138543362;
      v42 = v32;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@SetPreferredPrimary - Triggering resident election", (uint8_t *)&v41, 0xCu);

    }
    objc_autoreleasePoolPop(v29);
    if ((objc_msgSend(v30[1], "isLeader") & 1) != 0)
    {
      ...
      if (v33 == 2)
      {
        if (v37)
        {
          ...
          v41 = 138543362;
          v42 = v38;
          _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Handling force resident election request: This device is the leader. Starting election.", (uint8_t *)&v41, 0xCu);

        }
        objc_autoreleasePoolPop(v34);
        objc_msgSend(v35, "_selectPrimaryResidentWithReason:", 7);
        goto LABEL_27;
      }
      if (v37)
      {
...
LABEL_25:
        _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_DEFAULT, v40, (uint8_t *)&v41, 0xCu);
  ...
  if (v14)
  {
    ...
    v43 = 2112;
    v44 = v28;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received SetPreferredPrimaryDebugRequest with nil primary, requireOneTime: %@", (uint8_t *)&v41, 0x16u);
...
- (void)meshController:(id)a3 didReceivePingFromLeaderWithPrimaryResidentUUID:(id)a4
{
  ...
  -[HMDPrimaryElectionCoordinationAddOn pingTimer](self, "pingTimer", a3, a4);
  v4 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "kick");
...
- (void)meshControllerDidStartElection:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Election started, suspending ping timer", (uint8_t *)&v11, 0xCu);
...
- (void)meshControllerDidElectLeader:(id)a3
{
  ...
  if (objc_msgSend(v4, "isLeader"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if (v12 > 5)
        ...
        v13 = off_1E89BEE48[v12];
      v25 = 138543618;
      v26 = v11;
      v27 = 2114;
      v28 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@We are now the mesh leader in state: %{public}@", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v27 = 2112;
      v28 = v14;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Other device elected mesh leader: %@", (uint8_t *)&v25, 0x16u);
...
- (void)meshControllerDidUpdatesNodes:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v34 = 138543362;
    v35 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Mesh nodes updated", (uint8_t *)&v34, 0xCu);
  ...
  {
    v16 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, 5.0);
  }
  v17 = (void *)v16;
  ...
  if ((-[HMDPrimaryElectionCoordinationAddOn state](v6, "state") & 0xFFFFFFFFFFFFFFFELL) == 4)
  {
    ...
    if (v24)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        v34 = 138543362;
        v35 = v28;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Primary resident is in our mesh", (uint8_t *)&v34, 0xCu);
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      if (v20 > 5)
        ...
        v21 = off_1E89BEE48[v20];
      *(_DWORD *)buf = 138543618;
      *(_QWORD *)&buf[4] = v19;
      *(_WORD *)&buf[12] = 2114;
      *(_QWORD *)&buf[14] = v21;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Debounce expired, current state = %{public}@", buf, 0x16u);
    ...
    if ((-[HMDLocalElectionMeshController isLeader](v17->_meshController, "isLeader") & 1) != 0)
    {
      ...
      {
        case 0uLL:
          v64 = (HMDPrimaryElectionCoordinationAddOn *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28570]), "initWithQueue:", self->_queue);
          ...
          *(_QWORD *)&buf[16] = __101__HMDPrimaryElectionCoordinationAddOn__determineIfPrimaryMeshAfterWaitingForPrimaryResidentDiscovery__block_invoke;
          v118 = (HMDPrimaryElectionCoordinationAddOn *)&unk_1E89BEB00;
          v119 = v17;
        ...
        case 4uLL:
          ...
          if (v64 && (-[HMDPrimaryElectionCoordinationAddOn hmf_isEmpty](v64, "hmf_isEmpty") & 1) == 0 && v67)
          {
            ...
            if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&buf[22] = 2114;
              v118 = v64;
              _os_log_impl(&dword_1CD062000, v73, OS_LOG_TYPE_INFO, "%{public}@Broadcasting the current primary %@ to nodes %{public}@", buf, 0x20u);
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      if (v26 > 5)
        ...
        v27 = off_1E89BEE48[v26];
      *(_DWORD *)buf = 138543618;
      *(_QWORD *)&buf[4] = v25;
      *(_WORD *)&buf[12] = 2114;
      *(_QWORD *)&buf[14] = v27;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Ping timer fired, current state = %{public}@", buf, 0x16u);
      ...
      || -[HMDPrimaryElectionCoordinationAddOn state](v23, "state") == 4)
    {
      if (!-[HMDLocalElectionMeshController isLeader](v23->_meshController, "isLeader"))
      {
        ...
        if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v60;
          _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_INFO, "%{public}@Ping timer expired and we haven't heard from the leader. Sending a ping command to the leader", buf, 0xCu);
        ...
        *(_QWORD *)&buf[16] = __68__HMDPrimaryElectionCoordinationAddOn__handlePingTimerExpiredAsNode__block_invoke;
        v118 = (HMDPrimaryElectionCoordinationAddOn *)&unk_1E89C21C0;
        v119 = v58;
        v120 = v62;
        v64 = v62;
...
LABEL_98:
      ...
      if (v49)
      {
        if (v53)
        {
          ...
          *(_WORD *)&buf[22] = 2114;
          v118 = v84;
          _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_INFO, "%{public}@We are the leader in state: %{public}@. Sending periodic ping notification to followers with primary resident: %{public}@", buf, 0x20u);
        ...
        if (!v88)
        {
          ...
          if (v95)
          {
            ...
            if (os_log_type_enabled(v98, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              *(_QWORD *)&buf[4] = v100;
              _os_log_impl(&dword_1CD062000, v99, OS_LOG_TYPE_INFO, "%{public}@We are the leader. Sending periodic ping request to the primary resident", buf, 0xCu);
            ...
            {
              v104 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, 20.0);
            }
            v107 = (void *)v104;
          ...
          else
          {
            if (os_log_type_enabled(v98, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_WORD *)&buf[12] = 2114;
              *(_QWORD *)&buf[14] = v106;
              _os_log_impl(&dword_1CD062000, v99, OS_LOG_TYPE_ERROR, "%{public}@Not sending the ping request. Unable to find the mesh node for primary resident %{public}@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v91, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v92;
          _os_log_impl(&dword_1CD062000, v91, OS_LOG_TYPE_INFO, "%{public}@Not sending the ping request. We are the primary resident.", buf, 0xCu);
      ...
      else
      {
        if (v53)
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v75;
          _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_INFO, "%{public}@Not sending the periodic ping request to the primary and notification to the followers. Primary resident is nil.", buf, 0xCu);
...
LABEL_45:
    ...
    v66 = 12;
LABEL_67:
    _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_INFO, v40, buf, v66);
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      if (v32 > 5)
        ...
        v33 = off_1E89BEE48[v32];
      *(_DWORD *)buf = 138543618;
      *(_QWORD *)&buf[4] = v31;
      *(_WORD *)&buf[12] = 2114;
      *(_QWORD *)&buf[14] = v33;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Secondary mesh timer fired, current state = %{public}@", buf, 0x16u);
    ...
    if (v8 == v4)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        if (v45 > 5)
          ...
          v46 = off_1E89BEE48[v45];
        *(_DWORD *)buf = 138543618;
        *(_QWORD *)&buf[4] = v44;
        *(_WORD *)&buf[12] = 2114;
        *(_QWORD *)&buf[14] = v46;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@Timer fired and the primary resident did not respond to ping request from the leader, current state = %{public}@", buf, 0x16u);
      ...
      if (v9 == v4)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          if (v14 > 5)
            ...
            v15 = off_1E89BEE48[v14];
          *(_DWORD *)buf = 138543618;
          *(_QWORD *)&buf[4] = v13;
          *(_WORD *)&buf[12] = 2114;
          *(_QWORD *)&buf[14] = v15;
          _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Active nodes update timer fired, current state = %{public}@", buf, 0x16u);
        ...
        if (v64)
        {
          ...
          if (os_log_type_enabled(v80, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_WORD *)&buf[12] = 2114;
            *(_QWORD *)&buf[14] = v68;
            _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate of active mesh nodes: %{public}@", buf, 0x16u);
...
- (id)dumpState
{
  ...
  v7 = &v6;
  v8 = 0x3032000000;
  v9 = __Block_byref_object_copy__171493;
  v10 = __Block_byref_object_dispose__171494;
  v11 = 0;
  queue = self->_queue;
...
void __48__HMDPrimaryElectionCoordinationAddOn_dumpState__block_invoke(uint64_t a1)
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "na_map:", &__block_literal_global_98_171500);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v18[2] = v11;
  v17[3] = CFSTR("State");
    ...
    if (v2)
    {
      if (-[dispatch_queue_t inPessimisticSecondaryMesh](a1, "inPessimisticSecondaryMesh") == 1)
      {
        ...
        if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v30 = v6;
          _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Pessimistic secondary mesh state pinging over IDS", buf, 0xCu);
      ...
      if (v7)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v30 = v22;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@We're not online, restarting ping timer", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v30 = v18;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@No current primary resident, doing meta mesh election", buf, 0xCu);
    ...
    if ((_DWORD)result)
    {
      ...
      if (result == 2)
      {
        ...
        if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
        {
          ...
          v6 = 138543362;
          v7 = v5;
          _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@The ping request to the primary resident failed. Starting an election", (uint8_t *)&v6, 0xCu);
...
- (void)_startSecondaryMeshTimer
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 138543362;
      v25 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting secondary mesh timer", (uint8_t *)&v24, 0xCu);
    ...
    {
      v16 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 9, 300.0);
    }
    v19 = (void *)v16;
  ...
  if (!v4)
  {
    if (v8)
    {
      ...
      v24 = 138543362;
      v25 = v17;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Resuming secondary mesh timer", (uint8_t *)&v24, 0xCu);
...
LABEL_16:
  ...
  if (v8)
  {
    ...
    v24 = 138543362;
    v25 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Secondary mesh timer is already running", (uint8_t *)&v24, 0xCu);
...
LABEL_26:
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v39 = 2112;
        v40 = v9;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Our mesh info: %@", (uint8_t *)&v37, 0x16u);
      ...
      if (v15 && !v16)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
        {
          HMFGetLogIdentifier();
          v21 = (void *)objc_claimAutoreleasedReturnValue();
          v22 = objc_msgSend(v9, "reachableIPAccessories");
          v37 = 138543618;
          v38 = v21;
          v39 = 1024;
          LODWORD(v40) = v22;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@The current primary mesh has 0 reachable IP accessories and we have %d, taking over the primary mesh", (uint8_t *)&v37, 0x12u);

        }
        objc_autoreleasePoolPop(v18);
        objc_msgSend(v19, "setState:", 2);
        objc_msgSend(v19, "_selectPrimaryResidentWithReason:", 2);
        goto LABEL_25;
      }
      ...
      else if (v30)
      {
        HMFGetLogIdentifier();
        v31 = (void *)objc_claimAutoreleasedReturnValue();
        v32 = objc_msgSend(v14, "reachableIPAccessories");
        v37 = 138543618;
        v38 = v31;
        v39 = 1024;
        LODWORD(v40) = v32;
        ...
        v35 = 18;
LABEL_23:
        _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, v33, (uint8_t *)&v37, v35);

      }
      objc_autoreleasePoolPop(v27);
      objc_msgSend(v28, "setState:", 4);
...
LABEL_25:
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      v37 = 138543362;
      v38 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Primary resident didn't respond, doing meta mesh election", (uint8_t *)&v37, 0xCu);

    }
    objc_autoreleasePoolPop(v23);
    objc_msgSend(v24, "setState:", 2);
...
uint64_t __59__HMDPrimaryElectionCoordinationAddOn__pingPrimaryResident__block_invoke_51(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained && (!objc_msgSend(v3, "isHMError") || objc_msgSend(v3, "code") != 23))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Ping operation completed with error: %@", (uint8_t *)&v10, 0x16u);
...
LABEL_10:
  ...
  if (v6 != a2)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = objc_claimAutoreleasedReturnValue();
      v13 = (void *)v12;
      v14 = off_1E89BEE48[a2];
      if (v8 > 5)
        v15 = CFSTR("<unknown state>");
      else
        v15 = off_1E89BEE48[v8];
      v17 = 138544130;
      v18 = v12;
      v19 = 2114;
      v20 = v14;
      ...
      v23 = 2114;
      v24 = v5;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Expecting state %{public}@, got %{public}@ - action: %{public}@", (uint8_t *)&v17, 0x2Au);
...
uint64_t __97__HMDPrimaryElectionCoordinationAddOn__retrievePrimaryMeshInformationWithContext_otherResidents___block_invoke(uint64_t a1, void *a2)
{
        ...
        v6 == v7))
  {
    ...
    v8 = (void *)MEMORY[0x1D17BA0A0](v18);
    v9 = WeakRetained;
    HMFGetOSLogHandle();
    v10 = objc_claimAutoreleasedReturnValue();
...
LABEL_5:
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v19, 0xCu);
...
LABEL_33:
        ...
        v23 = objc_msgSend(v3, "na_any:", &__block_literal_global_171560);
          ...
          if (v24)
          {
            if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v33 = 18;
LABEL_30:
              _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, v31, buf, v33);
...
LABEL_31:
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v40 = 18;
LABEL_37:
            _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_DEFAULT, v38, buf, v40);
...
LABEL_38:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v45 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@No other residents responded to us, becoming primary", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v45 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@We're not online, going to secondary state and resuming pinging", buf, 0xCu);
...
void __68__HMDPrimaryElectionCoordinationAddOn__handlePingTimerExpiredAsNode__block_invoke(uint64_t a1, void *a2)
{
  ...
  _os_log_impl(&dword_1CD062000, v10, v11, v9, (uint8_t *)&v29, v12);
...
LABEL_13:
    v25 = (void *)MEMORY[0x1D17BA0A0](v15, v16, v17, v18);
    v26 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    v27 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v28;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Not resuming ping timer", (uint8_t *)&v29, 0xCu);
  ...
  if (!v19)
    goto LABEL_13;
  v20 = (void *)MEMORY[0x1D17BA0A0](v15, v16, v17, v18);
  v21 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  v22 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 138543362;
    v30 = v23;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Resuming ping timer", (uint8_t *)&v29, 0xCu);
...
void __72__HMDPrimaryElectionCoordinationAddOn_sendPingRequestToPrimaryResident___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4 == v5)
  {
    ...
    if (v3)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 2112;
        v19 = v3;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Ping request to the primary resident failed with error: %@.", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v3;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Ignoring the error response to the ping request from the primary resident since the response timer has changed. Error: %@", (uint8_t *)&v16, 0x16u);
...
- (void)_determineIfPrimaryMesh
{
  ...
  {
    v8 = (void *)MEMORY[0x1D17BA0A0](-[dispatch_queue_t setState:](a1, "setState:", 1));
    v9 = a1;
    HMFGetOSLogHandle();
    v10 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Determining if we're in the primary mesh", buf, 0xCu);
...
LABEL_18:
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v32 = 2112;
    v33 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Not determining if we are in the primary mesh due to current state: %@", buf, 0x16u);
  ...
  if (-[HMDPrimaryElectionCoordinationAddOn _expectState:action:](*(void **)(a1 + 32), 1, CFSTR("aborting determining primary mesh")))
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 2114;
        v21 = v4;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unknown resident %{public}@", (uint8_t *)&v18, 0x16u);
...
LABEL_10:
    ...
    if (objc_msgSend(v11, "count"))
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2114;
        v21 = v11;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Found other residents that could be in a primary mesh, checking if they are: %{public}@", (uint8_t *)&v18, 0x16u);
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2114;
        v47 = v5;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Requesting election parameters from candidates: %{public}@", buf, 0x16u);
        ...
        do
        {
          for (i = 0; i != v13; ++i)
          {
            ...
            if (objc_msgSend(v16, "isCurrentDevice"))
            {
              ...
              objc_msgSend(MEMORY[0x1E0D28588], "futureWithValue:", v17);
            ...
            else
            {
              ...
              v37[1] = 3221225472;
              v37[2] = __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke_74;
              v37[3] = &unk_1E89BFC60;
              v37[4] = v9;
      ...
      v35[1] = 3221225472;
      v35[2] = __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke_75;
      v35[3] = &unk_1E89C0960;
      v35[4] = v9;
      v6 = v31;
      v36 = v31;
...
uint64_t __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    v6 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v4, "setResidentDevice:", *(_QWORD *)(a1 + 32)));
    v7 = *(id *)(a1 + 40);
    HMFGetOSLogHandle();
    v8 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v26 = 2112;
      v27 = v5;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Adding election candidate %{public}@: %@", (uint8_t *)&v22, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v3;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Candidate %@ responded with invalid payload: %@", (uint8_t *)&v22, 0x20u);
...
uint64_t __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke_74(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  id v5;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v17 = 2112;
    v18 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Candidate %@ responded with error: %@", (uint8_t *)&v13, 0x20u);
...
void __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke_75(uint64_t a1, void *a2)
{
  id v3;
  void *v4;
  NSObject *v5;
...
void __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke_2(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "na_filter:", &__block_literal_global_76_171594);
...
- (id)_consensusPrimaryFromResidentCandidates:(uint64_t)a1
{
  ...
  if (!a1)
    return 0;
  v2 = (void *)MEMORY[0x1E0CB3550];
  objc_msgSend(a2, "na_map:", &__block_literal_global_66_171725);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v9)
  {
    ...
    if (!v16)
    {
      if (v18)
      {
        ...
        v21 = 138543362;
        v22 = v19;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@We are not the current primary and it isn't in our mesh", (uint8_t *)&v21, 0xCu);
...
- (uint64_t)_maybeNotifyDelegateUpdatedPrimary:(void *)a3 currentPrimary:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Selected primary is current primary: %@", (uint8_t *)&v16, 0x16u);
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v63 = 2114;
      v64 = v18;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Sorted primary candidates: %{public}@", buf, 0x16u);
    ...
    if ((unint64_t)-[__CFString count](v18, "count") >= 2)
    {
      ...
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      v25 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v23, "compare:currentPrimary:outCriteria:", v24, v59, &v60));
      v26 = v20;
      HMFGetOSLogHandle();
      v27 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
      {
        ...
        if (v60 > 0x11)
          ...
          v29 = off_1E89AEC18[v60];
        v30 = v29;
        *(_DWORD *)buf = 138543618;
        v62 = v28;
        v63 = 2114;
        v64 = v30;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@The primary resident was chosen because of: %{public}@", buf, 0x16u);
    ...
    if (objc_msgSend(v20[1], "isLeader"))
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v62 = v45;
        _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_DEBUG, "%{public}@Checking for split network", buf, 0xCu);
      ...
      if (-[__CFString count](v46, "count"))
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v63 = 2114;
          v64 = v46;
          _os_log_impl(&dword_1CD062000, v49, OS_LOG_TYPE_DEFAULT, "%{public}@Expected resident devices not found in mesh, we have a split network: %{public}@", buf, 0x16u);
  ...
  if (a1)
  {
    ...
    if ((objc_msgSend(*(id *)(a1 + 8), "isProcessing") & 1) != 0)
    {
      ...
      if (v2)
      {
        if (v6)
        {
          ...
          v25 = 138543362;
          v26 = v7;
          _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting ping timer as a leader", (uint8_t *)&v25, 0xCu);
      ...
      else
      {
        if (v6)
        {
          ...
          v25 = 138543362;
          v26 = v15;
          _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting ping timer as a node", (uint8_t *)&v25, 0xCu);
      ...
      {
        v19 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", v9, v8);
      }
      v20 = (void *)v19;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        v27 = 2114;
        v28 = v14;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Not starting ping timer in state %{public}@", (uint8_t *)&v25, 0x16u);
...
LABEL_9:
          _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, v6, v8, 0xCu);
...
- (uint64_t)_currentStateRequiresElection
{
  ...
  if (v3 && (v10 | objc_msgSend((id)a1, "electionGotAborted")) != 1)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v41 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@We don't need an election now. No major changes since the last election", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v46 = 2112;
      v47 = v17;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@We need an election, leader changed: %@, nodes changed: %@, previous election aborted: %@", buf, 0x2Au);
  ...
  if (a1)
  {
    ...
    if (v2)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
      {
        ...
        v8 = 138543362;
        v9 = v6;
        _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping secondary mesh timer", (uint8_t *)&v8, 0xCu);
...
- (id)_createDebounceTimerWithInterval:(void *)a1
{
  ...
  if (a1)
  {
    ...
    {
      v5 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, a2);
    }
    v6 = (void *)v5;
...
void __71__HMDPrimaryElectionCoordinationAddOn_selectPrimaryResidentWithReason___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v6 = 138543362;
      v7 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Not running primary resident election because this device is not the leader", (uint8_t *)&v6, 0xCu);
  ...
  if (-[HMDPrimaryElectionCoordinationAddOn _expectState:action:](*(void **)(a1 + 32), 1, CFSTR("deciding if we're in primary mesh")))
  {
    ...
    if (v4)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          v14 = 138543362;
          v15 = v12;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Pinging primary resident", (uint8_t *)&v14, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v8;
        _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@No primary resident after cloud ready, doing a meta mesh election", (uint8_t *)&v14, 0xCu);
...
void __85__HMDPrimaryElectionCoordinationAddOn_primaryResidentChanged_previousResidentDevice___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 2112;
        v25 = v10;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling new primary resident: %@", (uint8_t *)&v22, 0x16u);
        ...
        if (objc_msgSend(*(id *)(*(_QWORD *)(a1 + 40) + 8), "isLeader"))
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            if (v16 > 5)
              ...
              v17 = off_1E89BEE48[v16];
            v22 = 138543618;
            v23 = v15;
            v24 = 2112;
            v25 = v17;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Received a primary resident change while we are the leader in state: %@.", (uint8_t *)&v22, 0x16u);
  ...
  else if (objc_msgSend(v2[1], "isLeader") && objc_msgSend(*(id *)(a1 + 40), "state") == 2)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Primary resident was set to nil, calling an election", (uint8_t *)&v22, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t119 != -1)
    dispatch_once(&logCategory__hmf_once_t119, &__block_literal_global_84_171801);
