...
- (HMDSettingGroup)initWithModel:(id)a3
{
  ...
  v10 = -[HMDSettingGroup initWithIdentifier:parentIdentifier:name:groups:settings:](self, "initWithIdentifier:parentIdentifier:name:groups:settings:", v5, v8, v9, MEMORY[0x1E0C9AA60], MEMORY[0x1E0C9AA60]);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v4, "hmd_isForXPCTransport") & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB7E60]);

    -[HMDSettingGroup name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x1E0CB7E68]);

    -[HMDSettingGroup groups](self, "groups");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v8, *MEMORY[0x1E0CB7E58]);

    -[HMDSettingGroup settings](self, "settings");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v9, *MEMORY[0x1E0CB7E70]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Did not encode group as transport is not XPC.", (uint8_t *)&v14, 0xCu);
