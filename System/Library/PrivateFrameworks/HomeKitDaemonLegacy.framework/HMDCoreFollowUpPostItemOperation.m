...
- (void)main
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Posting advertisement for new followup item: %@", buf, 0x16u);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v66 = 2112;
      v67 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch pending followup items with error: %@", buf, 0x16u);
...
LABEL_21:
          ...
          if ((v27 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&v61[12] = 2112;
              *(_QWORD *)&v61[14] = v47;
              _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Detected followup item with same identifier (%@), but different title, removing and reposting.", v61, 0x16u);
        ...
        else
        {
          ...
          if (v29)
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&v61[22] = 2112;
              v62 = v39;
              _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@Removing existing followup with identifier: %@ in favor of: %@", v61, 0x20u);
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&v61[22] = 2112;
            v62 = v35;
            _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Not posting followup with identifier: %@ as currently posted followup is preferred: %@", v61, 0x20u);
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v13 = 2112;
      v14 = v6;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Posting followup item: %@", buf, 0x16u);
...
void __53__HMDCoreFollowUpPostItemOperation__postFollowUpItem__block_invoke(uint64_t a1, int a2, void *a3)
{
  ...
  if (a2)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully started advertising followup item: %@", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to advertise followup item: %@ with error: %@", (uint8_t *)&v16, 0x20u);
