...
id __42__HMDCameraClipFinalizeClipOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  objc_msgSend(v3, "setIsComplete:", MEMORY[0x1E0C9AAB0]);
  ...
  if (v10 <= 0.0)
  {
    if (v14)
    {
      ...
      v28 = 2048;
      v29 = v19;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Finalized clip has duration %fs, deleting", (uint8_t *)&v26, 0x16u);

    }
    objc_autoreleasePoolPop(v11);
    v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32CD8]), "initWithLabel:", CFSTR("delete empty clip"));
  ...
  else
  {
    if (v14)
    {
      ...
      v26 = 138543362;
      v27 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Marking clip complete", (uint8_t *)&v26, 0xCu);
...
void __42__HMDCameraClipFinalizeClipOperation_main__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully finalized clip", (uint8_t *)&v8, 0xCu);
...
void __42__HMDCameraClipFinalizeClipOperation_main__block_invoke_5(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update clip model: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_53635 != -1)
    dispatch_once(&logCategory__hmf_once_t4_53635, &__block_literal_global_53636);
  return (id)logCategory__hmf_once_v5_53637;
}
...
void __49__HMDCameraClipFinalizeClipOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_53637;
  logCategory__hmf_once_v5_53637 = v0;
