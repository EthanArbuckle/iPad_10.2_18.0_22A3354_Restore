...
- (void)createHH2CloudDatabaseAndStartSyncing
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating the Cloud database to detect HH2 cloud zone & will start sync after that. [Auto Switch: %@]", (uint8_t *)&v22, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
    {
      ...
      v24 = 2114;
      v25 = v9;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_FAULT, "%{public}@Failed to create cloud database with containerID %{public}@", (uint8_t *)&v22, 0x16u);

    }
    objc_autoreleasePoolPop(v15);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 2, CFSTR("Failed to create cloud database"));
...
- (void)forceFetchSentinelZone
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v19 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Force fetching sentinel zone", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v3);
  v7 = objc_alloc(MEMORY[0x1E0C95098]);
  v8 = (void *)objc_msgSend(v7, "initWithZoneName:ownerName:", CFSTR("HH2-CD9D5508-EAED-4462-A7CB-AFB779F35A71"), *MEMORY[0x1E0C94730]);
  v9 = objc_alloc(MEMORY[0x1E0D32C40]);
  -[HMDHH2FrameworkSwitch cloudDatabaseToDetectHH2Zone](v4, "cloudDatabaseToDetectHH2Zone");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)waitForHH2SentinelZoneToBeFetchedFromCloud
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Waiting for Initial sync to finish... Start", buf, 0xCu);
...
LABEL_8:
      _os_log_impl(&dword_1CD062000, v21, v22, v20, buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cloud database is nil. Cannot perform initial sync. (a)", (uint8_t *)location, 0xCu);
...
- (void)createHH2SentinelZoneWithCompletionHandler:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = (void *)objc_msgSend(v6, "initWithZoneName:ownerName:", CFSTR("HH2-CD9D5508-EAED-4462-A7CB-AFB779F35A71"), *MEMORY[0x1E0C94730]);
    v8 = objc_alloc(MEMORY[0x1E0D32C40]);
    -[HMDHH2FrameworkSwitch cloudDatabaseToDetectHH2Zone](self, "cloudDatabaseToDetectHH2Zone");
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cloud database is nil. Cannot perform initial sync. (b)", buf, 0xCu);
...
- (BOOL)waitForHH2SentinelZoneToBeCreated:(double)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)((char *)&buf + 4) = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Going to create sentinel Zone", (uint8_t *)&buf, 0xCu);
  ...
  *((_QWORD *)&buf + 1) = &buf;
  v44 = 0x3032000000;
  v45 = __Block_byref_object_copy__122125;
  v46 = __Block_byref_object_dispose__122126;
  v47 = 0;
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v39 = 138543362;
      v40 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Timed out while creating the HH2 sentinel zone.", v39, 0xCu);

    }
    objc_autoreleasePoolPop(v18);
    if (a4)
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 8, v33, v34, v35, v36);
...
LABEL_13:
  ...
  v24 = (void *)MEMORY[0x1D17BA0A0](0, v15, v16, v17);
  v25 = v8;
  if (!v23)
  {
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v39 = 138543618;
      ...
      v41 = 2112;
      v42 = v28;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unable to create Sentinel zone due to %@", v39, 0x16u);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v39 = 138543362;
    v40 = v31;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Successfully created sentinel Zone", v39, 0xCu);
...
- (void)cloudDatabase:(id)a3 didCreateZoneWithID:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@created / synced HH2 sentinel zone", buf, 0xCu);
...
- (void)_makeSureWeAreRunningInRightEnvironment:(BOOL)a3
{
    ...
    if (!-[HMDHH2FrameworkSwitch _areWeRunningInRightEnvironment:](self, "_areWeRunningInRightEnvironment:", v3))
    {
      if (v3 || -[HMDHH2FrameworkSwitch checkExistenceOfHH2SentinelZone](self, "checkExistenceOfHH2SentinelZone"))
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          v20 = 138543362;
          v21 = v10;
          _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Sentinel zone exist which mean we should be running HH2 world. Relaunching ourselves in HH2 world", (uint8_t *)&v20, 0xCu);
        ...
        {
          LOWORD(v20) = 0;
          _os_signpost_emit_with_name_impl(&dword_1CD062000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "ReadyToSwitchToHH2", ", (uint8_t *)&v20, 2u);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 138543362;
      v21 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Not enforcing HK environment as auto-switch is OFF", (uint8_t *)&v20, 0xCu);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v31 = 2112;
      v32 = v17;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Going to check our current environment: [doesSentinelZoneExist = %@] [current User HK Preference = %@] [setupMode = %@]", buf, 0x2Au);
    ...
    if (v18 == 1 && v6 != v8)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v26 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Looks like we are in wrong world. Let's make things right.", buf, 0xCu);
...
- (void)removeHH2SentinelZoneWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Request to remove HH2 sentinel zone received", buf, 0xCu);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Cloud database is nil. Cannot perform initial sync. (c)", buf, 0xCu);
  ...
  else
  {
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "na_firstObjectPassingTest:", &__block_literal_global_122144);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v27;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@HH2 Sentinel zone does not exist", buf, 0xCu);
...
- (void)switchToHH2AndRelaunchHomedToPerformHH2Migration
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Switching to HH2 framework and relaunching homed in order to perform HH2 migration", (uint8_t *)&v7, 0xCu);
...
- (BOOL)switchToSetupMode:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v24 = 2048;
    v25 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Switching to setup mode: %lu, current mode: %lu", (uint8_t *)&v20, 0x20u);
  ...
  if (v6 == a3 || a3 == 2 && !v6)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 138543362;
      v21 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Already in requested setup mode", (uint8_t *)&v20, 0xCu);
...
- (int64_t)areCloudKitServersReachableWithError:(id *)a3
{
  ...
  v5 = objc_alloc(MEMORY[0x1E0C94C40]);
  ...
  v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C94C28]), "initWithContainerID:options:", v6, v7);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)((char *)&buf + 4) = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Waiting to check whether CloudKit is reachable or not... Start", (uint8_t *)&buf, 0xCu);
  ...
  *((_QWORD *)&buf + 1) = &buf;
  v85 = 0x3032000000;
  v86 = __Block_byref_object_copy__122125;
  v87 = __Block_byref_object_dispose__122126;
  v88 = 0;
  v76 = 0;
  v77 = &v76;
  v78 = 0x2020000000;
  ...
  v17 = v16 == 0;
  v22 = (void *)MEMORY[0x1D17BA0A0](v16, v18, v19, v20, v21);
  v23 = v11;
  if (!v17)
  {
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v80 = 138543362;
      v81 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Fetching the CK account info operation timed out.", v80, 0xCu);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v80 = 138543362;
    v81 = v29;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Waiting to check whether CloudKit is reachable or not... End", v80, 0xCu);
  ...
  {
    v36 = (void *)MEMORY[0x1D17BA0A0](v30, v31, v32, v33, v34);
    v37 = v23;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v80 = 138543618;
      ...
      v82 = 2112;
      v83 = v40;
      _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@CK account fetch info resulted into error : %@", v80, 0x16u);
  ...
  switch(v35)
  {
    case 1:
      if (*((_BYTE *)v73 + 24))
        goto LABEL_19;
      v54 = (void *)MEMORY[0x1D17BA0A0](v30, v31, v32, v33, v34);
      v55 = v23;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v80 = 138543362;
        v81 = v57;
        _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_ERROR, "%{public}@CK account status available but need to verify terms", v80, 0xCu);

      }
      goto LABEL_35;
    case 2:
      v41 = (void *)MEMORY[0x1D17BA0A0](v30, v31, v32, v33, v34);
      v42 = v23;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v80 = 138543362;
        v81 = v44;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@CK account status is restricted", v80, 0xCu);
      ...
      break;
    case 3:
      v45 = (void *)MEMORY[0x1D17BA0A0](v30, v31, v32, v33, v34);
      v46 = v23;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v80 = 138543362;
        v81 = v48;
        _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@CK account status is not signed in", v80, 0xCu);
    ...
    case 4:
      ...
      {
        v49 = *((_BYTE *)v69 + 24) == 0;
        v50 = (void *)MEMORY[0x1D17BA0A0](v30, v31, v32, v33, v34);
        v51 = v23;
        if (v49)
        {
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)v80 = 138543362;
            v81 = v61;
            _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_ERROR, "%{public}@CK account status is temporarily unavailable", v80, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)v80 = 138543362;
            v81 = v53;
            _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_ERROR, "%{public}@CK account status is need to verify terms", v80, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v80 = 138543362;
          v81 = v59;
          _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_ERROR, "%{public}@CK account status is invalid credentials", v80, 0xCu);
...
void __50__HMDHH2FrameworkSwitch_handleTapToSetupFinished___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Got TTSU finished notification with error: %@", (uint8_t *)&v12, 0x16u);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Ignoring TTSU notification as either this is on a non-tvOS device or TTSU finished with error: %@", (uint8_t *)&v12, 0x16u);
...
void __60__HMDHH2FrameworkSwitch_waitForCloudKitAccountToBeAvailable__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Wait for the CloudKit account to be available.", buf, 0xCu);
...
void __60__HMDHH2FrameworkSwitch_waitForCloudKitAccountToBeAvailable__block_invoke_116(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Looks like CloudKit account is now available. Performing cloud sync. [%@]", buf, 0x16u);
  ...
  if (v6 || !WeakRetained)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Error occurred : %@ / %@", buf, 0x20u);
...
void __62__HMDHH2FrameworkSwitch_areCloudKitServersReachableWithError___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@CK account fetch info completed with : %@", (uint8_t *)&v14, 0x16u);
...
void __61__HMDHH2FrameworkSwitch_removeHH2SentinelZoneWithCompletion___block_invoke_94(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@HH2 sentinel zone removed successfully.", (uint8_t *)&v11, 0xCu);
...
void __61__HMDHH2FrameworkSwitch_removeHH2SentinelZoneWithCompletion___block_invoke_97(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to delete HH2 sentinel zone from cloud database.", (uint8_t *)&v11, 0xCu);
...
void __58__HMDHH2FrameworkSwitch_waitForHH2SentinelZoneToBeRemoved__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@HH2 sentinel zone removal status : %@", (uint8_t *)&v8, 0x16u);
...
void __44__HMDHH2FrameworkSwitch_performInitialSync___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Initial cloud sync finished on HH2 cloud database.", (uint8_t *)&v10, 0xCu);
...
void __44__HMDHH2FrameworkSwitch_performInitialSync___block_invoke_92(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Unable to perform initial sync on cloud database to determine sentinel zone.", (uint8_t *)&v10, 0xCu);
...
void __47__HMDHH2FrameworkSwitch_forceFetchSentinelZone__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Force fetch sentinel zone on HH1 container finished with error: %@", (uint8_t *)&v14, 0x16u);
...
void __71__HMDHH2FrameworkSwitch_performInitialSyncAndSwitchFrameworkIfRequired__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Initial sync on HH1 container finished with error: %@", buf, 0x16u);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v3;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not perform initial sync : %@", buf, 0x16u);
  ...
  else if (objc_msgSend(*(id *)(a1 + 32), "autoFrameworkSwitch"))
  {
...
+ (void)setHH2EnablementPreferenceKey:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting HH2 preference value to %@", (uint8_t *)&v11, 0x16u);

  }
  objc_autoreleasePoolPop(v5);
  v10 = (CFPropertyListRef *)MEMORY[0x1E0C9AE50];
  if (!v3)
    v10 = (CFPropertyListRef *)MEMORY[0x1E0C9AE40];
...
+ (void)setHH2SettingsMigrationKey:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting HH2 settings migration key to %@", (uint8_t *)&v11, 0x16u);
...
+ (void)relaunchHomedAfterSettingEnvironmentTo:(BOOL)a3 blockToExecuteBeforeReLaunch:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v33 = 2112;
    v34 = v12;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Going to relaunch homed in : [%@]", buf, 0x16u);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Calling block : %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v16);
    dispatch_get_global_queue(0, 0);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    v22 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28570]), "initWithQueue:", v21);
    v6[2](v6);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    v27[0] = v13;
    v27[1] = 3221225472;
...
+ (void)switchBackToHH1AndDoNotLaunchDueToPrimaryAccountRemoval
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Switching back to HK 1.0 framework as primary account got removed. HomeKitDaemon will not be relaunched.", (uint8_t *)&v7, 0xCu);
...
+ (void)switchBackToHH1AndRelaunchDueToHH2MigrationFailed
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Switching back to HK 1.0 framework as migration to HH2 failed", (uint8_t *)&v7, 0xCu);
...
+ (void)switchToHH2AndRelaunchHomed
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Switching to HH2 framework and relaunching homed", (uint8_t *)&v7, 0xCu);
...
+ (id)errorFromHMDCKAccountStatus:(int64_t)a3
{
  ...
  if ((unint64_t)(a3 - 2) > 4)
    return 0;
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", qword_1CDB8F710[a3 - 2], v3, v4);
  return (id)objc_claimAutoreleasedReturnValue();
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t45_122202 != -1)
    dispatch_once(&logCategory__hmf_once_t45_122202, &__block_literal_global_110);
  return (id)logCategory__hmf_once_v46_122203;
}
...
void __36__HMDHH2FrameworkSwitch_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v46_122203;
  logCategory__hmf_once_v46_122203 = v0;
...
void __93__HMDHH2FrameworkSwitch_relaunchHomedAfterSettingEnvironmentTo_blockToExecuteBeforeReLaunch___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@See you on the other side - restarting...", (uint8_t *)&v8, 0xCu);
