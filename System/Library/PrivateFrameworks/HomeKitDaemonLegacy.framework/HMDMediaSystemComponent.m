...
- (id)serialize
{
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, *MEMORY[0x1E0CBAB80]);
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, *MEMORY[0x1E0CBAB78]);
...
- (HMDMediaSystemComponent)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBAB80]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("accessory"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBAB78]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMDMediaSystemComponent uuid](self, "uuid");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x1E0CBAB80]);
  ...
  objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x1E0CBAB78]);
...
+ (id)accessoryForMediaSystemComponentWithDictionary:(id)a3 home:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@accessoryUUID is nil transaction dictionary - cannot find accessory with %@in home %@", (uint8_t *)&v14, 0x20u);
...
+ (id)mediaSystemComponentWithDictionary:(id)a3 home:(id)a4
{
  ...
  v5 = a3;
  v6 = a4;
  objc_msgSend(v5, "hmf_UUIDForKey:", *MEMORY[0x1E0CBAB80]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    ...
    if (v8)
    {
      objc_msgSend(v5, "hmf_dictionaryForKey:", *MEMORY[0x1E0CBAB78]);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA688]), "initWithDictionary:", v9);
      if (v10)
      {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          v24 = 2112;
          v25 = v5;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Role entry is nil - cannot create mediaSystemComponent with %@", (uint8_t *)&v22, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 2112;
        v27 = v6;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@accessory cannot be looked up - cannot create mediaSystemComponent with %@in home %@", (uint8_t *)&v22, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v5;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@mediaComponentUUID is nil - cannot create mediaSystemComponent with %@", (uint8_t *)&v22, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_103232 != -1)
    dispatch_once(&logCategory__hmf_once_t4_103232, &__block_literal_global_103233);
  return (id)logCategory__hmf_once_v5_103234;
}
...
void __38__HMDMediaSystemComponent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_103234;
  logCategory__hmf_once_v5_103234 = v0;
