...
- (HMDUserNotificationCenter)initWithBundleIdentifier:(id)a3 logEventSubmitter:(id)a4
{
  ...
  if (v8)
  {
    v9 = objc_msgSend(objc_alloc(MEMORY[0x1E0CEC7A0]), "initWithBundleIdentifier:", v6);
...
- (void)updateContent:(id)a3 forNotificationWithRequestIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v20 = 2112;
    v21 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating notification with request identifier %@ with content: %@", buf, 0x20u);
...
- (id)showNotificationWithTitle:(id)a3 body:(id)a4 threadIdentifier:(id)a5 categoryIdentifier:(id)a6 requestIdentifier:(id)a7 date:(id)a8 attachments:(id)a9 userInfo:(id)a10 shouldIgnoreDoNotDisturb:(BOOL)a11 interruptionLevel:(unint64_t)a12 logEventTopic:(int64_t)a13
{
  ...
  objc_msgSend(MEMORY[0x1E0CEC740], "requestWithIdentifier:content:trigger:", v45, v25, 0);
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v48 = 2112;
    v49 = v28;
    _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Adding bulletin: %@", buf, 0x16u);
...
void __47__HMDUserNotificationCenter__showNotification___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v7;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@Error adding notification request. Error: %@. Request: %@.", (uint8_t *)&v8, 0x20u);
...
void __80__HMDUserNotificationCenter_updateContent_forNotificationWithRequestIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update notification with request identifier %@: %@", (uint8_t *)&v9, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_168278 != -1)
    dispatch_once(&logCategory__hmf_once_t6_168278, &__block_literal_global_168279);
  return (id)logCategory__hmf_once_v7_168280;
}
...
void __40__HMDUserNotificationCenter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_168280;
  logCategory__hmf_once_v7_168280 = v0;
