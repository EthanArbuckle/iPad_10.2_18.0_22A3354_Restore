...
- (HMDCHIPThreadNetworkEventListener)initWithThreadResidentCommissioner:(id)a3
{
  ...
  if (v6)
  {
    ...
    v8 = (void *)MEMORY[0x1D17BA0A0](-[HMDThreadResidentCommissioner registerForThreadNetworkEvents:](v7->_threadResidentCommissioner, "registerForThreadNetworkEvents:", v7));
    v9 = v7;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@started listening for events", buf, 0xCu);
...
- (void)stopListeningForEvents
{
  ...
  v4 = (void *)MEMORY[0x1D17BA0A0](-[HMDCHIPThreadNetworkEventListener setThreadResidentCommissioner:](self, "setThreadResidentCommissioner:", 0));
  v5 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@stopped listening for events", (uint8_t *)&v8, 0xCu);
...
- (void)threadNetworkStateChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@threadNetworkStateChange - received event %@, type %ld, value %ld", buf, 0x2Au);
  ...
  else if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v4;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unexpected event %@", buf, 0x16u);
...
LABEL_7:
  ...
  if (v5 != 1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unexpected event %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_45205 != -1)
    dispatch_once(&logCategory__hmf_once_t5_45205, &__block_literal_global_45206);
  return (id)logCategory__hmf_once_v6_45207;
}
...
void __48__HMDCHIPThreadNetworkEventListener_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_45207;
  logCategory__hmf_once_v6_45207 = v0;
