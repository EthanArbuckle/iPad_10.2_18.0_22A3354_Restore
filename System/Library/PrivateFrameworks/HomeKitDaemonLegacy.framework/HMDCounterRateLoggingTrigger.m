...
{
  return -[HMDCounterRateLoggingTrigger initWithThreshold:windowSize:counterName:uploadImmediately:ewsLogger:timeSourceBlock:](self, "initWithThreshold:windowSize:counterName:uploadImmediately:ewsLogger:timeSourceBlock:", a3, a4, a5, a6, a7, &__block_literal_global_23447);
}
...
- (void)logRateTrigger:(id)a3 triggerValue:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@EWS rate trigger: trigger=%{public}@, counter=%{public}@, value=%lu, windowSize=%lu", buf, 0x34u);
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDCounterRateLoggingTrigger windowSize](v8, "windowSize"));
