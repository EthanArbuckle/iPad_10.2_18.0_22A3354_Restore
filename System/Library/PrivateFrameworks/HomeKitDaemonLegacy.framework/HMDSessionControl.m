...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 2, CFSTR("kSessionControl__Command"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16620], "wrappertlv:name:", 1, CFSTR("kSessionControl__SessionIdentifier"));
...
- (NSData)tlvData
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDSessionControl controlCommand](self, "controlCommand"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)description:(id)a3 indent:(id)a4
{
  ...
  if (v9 >= 5)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unknown HMDSessionControlCommand %tu"), v9);
    v10 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v10 = off_1E89B2228[v9];
  }
