  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Missing account identifier", buf, 0xCu);
...
- (HMDAccount)initWithObjectModel:(id)a3
{
  ...
  v5 = -[HMDAccount initWithIdentifier:handles:devices:](self, "initWithIdentifier:handles:devices:", v4, MEMORY[0x1E0C9AA60], MEMORY[0x1E0C9AA60]);
        ...
        if (v9)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v25 = 2112;
            v26 = v8;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Found contact: %@ for handle: %@", buf, 0x20u);
...
- (void)isOfKnownPersonWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Account is not present in contacts, checking family circle.", (uint8_t *)&v9, 0xCu);
...
- (void)setAppleAccountSenderCorrelationIdentifier:(id)a3
{
  ...
  if (self)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        ...
        v14 = (void *)v19;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: MergeID cannot be updated on an account with identifier based on MergeID", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v11);
      v15 = -[HMDAssertionLogEvent initWithReason:]([HMDAssertionLogEvent alloc], "initWithReason:", CFSTR("MergeID cannot be updated on an account with identifier based on MergeID"));
    ...
    {
      v9 = (NSString *)objc_msgSend(v17, "copy");
...
- (HMDAccountHandle)primaryHandle
{
    ...
    || (objc_msgSend(v3, "primaryHandleForAccount:", self), (v4 = (void *)objc_claimAutoreleasedReturnValue()) == 0))
  {
    p_lock = &self->_lock;
    os_unfair_lock_lock_with_options();
    objc_msgSend(MEMORY[0x1E0C99E10], "orderedSetWithSet:", self->_handles);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "sortUsingComparator:", &__block_literal_global_57219);
...
- (void)addHandle:(id)a3
{
  ...
  if (v4)
  {
    ...
    if ((v5 & 1) != 0)
    {
      v6 = self;
      v7 = v4;
      -[HMDAccount manager](v6, "manager");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v8, "shouldSyncAccount:", v6))
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&v16[4] = v12;
          v17 = 2112;
          v18 = v7;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering account handle: %@", v16, 0x16u);

        }
        objc_autoreleasePoolPop(v9);
        -[HMDAccount modelIdentifier](v10, "modelIdentifier");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v7, "setModelParentIdentifier:", v13);
        ...
        *(_QWORD *)v16 = v7;
        ...
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v14, "updateModelObjects:destination:", v15, 2);
...
- (void)removeHandle:(id)a3
{
  ...
  {
    os_unfair_lock_lock_with_options();
    __HMDAccountRemoveHandle(self, v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    os_unfair_lock_unlock(&self->_lock);
    if (v5)
    {
      ...
      if (objc_msgSend(v8, "shouldSyncAccount:", v6))
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&v15[4] = v12;
          v16 = 2112;
          v17 = v7;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Deregistering account handle: %@", v15, 0x16u);
        ...
        *(_QWORD *)v15 = v7;
        ...
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "deleteModelObjects:destination:", v14, 2);

      }
      __HMDAccountDidUpdateHandles(v6);
      -[HMDAccount _repairDevicesWithStaleHandle:](v6, "_repairDevicesWithStaleHandle:", v4);
    }
...
- (void)_repairDevicesWithStaleHandle:(id)a3
{
        ...
        if (v40)
        {
          if (v16)
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v58 = 2112;
            v59 = v40;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Repairing stale handle for device %@ updating to %@", buf, 0x20u);
        ...
        else
        {
          if (v16)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v56 = 2112;
            v57 = v12;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Removing device from empty account %@", buf, 0x16u);

            v7 = v39;
          }

          objc_autoreleasePoolPop(v13);
          -[HMDAccount removeDevice:](v14, "removeDevice:", v12);
        }
      }
      v9 = objc_msgSend(v7, "countByEnumeratingWithState:objects:count:", &v41, v53, 16);
    }
    while (v9);
  }
  ...
  if (v40)
  {
    v19 = self;
    v20 = v7;
    -[HMDAccount manager](v19, "manager");
    ...
    v22 = v21;
    v52 = v22;
    objc_msgSend(v20, "na_filter:", v51);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v22, "shouldSyncAccount:", v19) && objc_msgSend(v23, "count"))
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = v23;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Updating devices: %@", buf, 0x16u);
      ...
      v50 = 0u;
      v29 = v20;
      v30 = objc_msgSend(v29, "countByEnumeratingWithState:objects:count:", &v47, buf, 16);
      if (v30)
      {
        v31 = v30;
        v32 = *(_QWORD *)v48;
        do
        {
          for (j = 0; j != v31; ++j)
          {
            ...
            objc_msgSend(*(id *)(*((_QWORD *)&v47 + 1) + 8 * j), "modelBackedObjects");
            v34 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v28, "addObjectsFromArray:", v34);

          }
          v31 = objc_msgSend(v29, "countByEnumeratingWithState:objects:count:", &v47, buf, 16);
        }
        while (v31);
      }
      ...
      objc_msgSend(v35, "updateModelObjects:destination:", v36, 2);
...
- (void)addDevice:(id)a3
{
  ...
  if (v4)
  {
    ...
    if ((v5 & 1) != 0)
    {
      ...
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v8, "shouldSyncAccount:", v6)
        && objc_msgSend(v8, "shouldSyncDevice:", v7))
      {
        v9 = (void *)MEMORY[0x1D17BA0A0]();
        v10 = v6;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          v17 = 2112;
          v18 = v7;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering device: %@", (uint8_t *)&v15, 0x16u);

        }
        objc_autoreleasePoolPop(v9);
        objc_msgSend(v8, "backingStore");
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v7, "modelBackedObjects");
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "updateModelObjects:destination:", v14, 2);
...
- (void)removeDevice:(id)a3
{
  ...
  {
    os_unfair_lock_lock_with_options();
    __HMDAccountRemoveDevice(self, v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    os_unfair_lock_unlock(&self->_lock);
    if (v5)
    {
        ...
        && objc_msgSend(v8, "shouldSyncDevice:", v7))
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          v17 = 2112;
          v18 = v7;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Deregistering device: %@", (uint8_t *)&v15, 0x16u);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v90 = 2112;
        v91 = v9;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Updated handles: %@", buf, 0x16u);
        ...
        for (i = 0; i != v27; ++i)
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v90 = 2112;
            v91 = v30;
            _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Removed device: %@", buf, 0x16u);
        ...
        for (j = 0; j != v37; ++j)
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v90 = 2112;
            v91 = v40;
            _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Added device: %@", buf, 0x16u);
          ...
          if (v51)
          {
            ...
            if (os_log_type_enabled(v54, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v92 = 2112;
              v93 = v51;
              _os_log_impl(&dword_1CD062000, v54, OS_LOG_TYPE_DEBUG, "%{public}@Merging existing device: %@ with device: %@", buf, 0x20u);
            ...
            if (objc_msgSend(v50, "mergeObject:", v51))
            {
              ...
              if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v90 = 2112;
                v91 = v51;
                _os_log_impl(&dword_1CD062000, v58, OS_LOG_TYPE_INFO, "%{public}@Updated device: %@", buf, 0x16u);
      ...
      if ((objc_msgSend(v60, "isEqualToString:", v61) & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v61;
          _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_INFO, "%{public}@Updating sender correlation identifier to %@", buf, 0x16u);
...
- (HMDAccount)initWithCoder:(id)a3
{
  ...
  if (objc_msgSend(v4, "containsValueForKey:", CFSTR("HM.handles")))
  {
  ...
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("HM.destination"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    +[HMDAccountHandle accountHandleForDestination:](HMDAccountHandle, "accountHandleForDestination:", v13);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!objc_msgSend(v4, "containsValueForKey:", CFSTR("HM.identifier2")))
  {
    if (objc_msgSend(v12, "count"))
    {
      objc_msgSend(v12, "firstObject");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      +[HMDAccountIdentifier accountIdentifierForAccountHandle:](HMDAccountIdentifier, "accountIdentifierForAccountHandle:", v15);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_17:
  ...
  if (!v14)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      v28 = 138543362;
      v29 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid HMDAccountIdentifier in archive for HMDAccount", (uint8_t *)&v28, 0xCu);

    }
    objc_autoreleasePoolPop(v18);
    v22 = -[HMDAssertionLogEvent initWithReason:]([HMDAssertionLogEvent alloc], "initWithReason:", CFSTR("Invalid HMDAccountIdentifier in archive for HMDAccount"));
    +[HMDMetricsManager sharedLogEventSubmitter](HMDMetricsManager, "sharedLogEventSubmitter");
    v23 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_11:
  if (v12 && v8)
  {
    v16 = -[HMDAccount initWithIdentifier:handles:devices:](self, "initWithIdentifier:handles:devices:", v14, v12, v8);
    v17 = v16;
    goto LABEL_21;
  }
LABEL_18:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    v34 = 2112;
    v35 = v8;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot initialize HMDAccount from decoded identifier: %@ handles: %@ devices:%@ ", (uint8_t *)&v28, 0x2Au);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v9, CFSTR("HM.identifier"));
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v11, CFSTR("HM.destination"));
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v44 = v40;
        v45 = v71;
        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_ERROR, "%{public}@Delete request for unknown object (%@) sent to [%@ transactionObjectRemoved:message:]", buf, 0x20u);
    ...
    if (!v30)
    {
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v71 = (id)objc_opt_class();
        v56 = v71;
        _os_log_impl(&dword_1CD062000, v54, OS_LOG_TYPE_ERROR, "%{public}@Delete request for unknown object (%@) sent to [%@ transactionObjectRemoved:message:]", buf, 0x20u);
...
LABEL_43:
  ...
  if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v71 = (id)objc_opt_class();
    v51 = v71;
    _os_log_impl(&dword_1CD062000, v49, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectRemoved:message:]", buf, 0x20u);
...
- (NSUUID)modelParentIdentifier
{
  if (modelParentIdentifier_onceToken != -1)
    dispatch_once(&modelParentIdentifier_onceToken, &__block_literal_global_80_57167);
...
void __35__HMDAccount_modelParentIdentifier__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"));
...
+ (HMDAccount)accountWithHandle:(id)a3
{
  ...
  v8 = (void *)objc_msgSend(v5, "initWithIdentifier:handles:devices:", v6, v7, MEMORY[0x1E0C9AA60]);
  return (HMDAccount *)v8;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t27_57250 != -1)
    dispatch_once(&logCategory__hmf_once_t27_57250, &__block_literal_global_57);
  return (id)logCategory__hmf_once_v28_57251;
}
...
void __25__HMDAccount_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v28_57251;
  logCategory__hmf_once_v28_57251 = v0;
...
uint64_t __66__HMDAccount_FamilyCircle__isPresentInFamilyCircleWithCompletion___block_invoke_2(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    v16[1] = 3221225472;
    v16[2] = __66__HMDAccount_FamilyCircle__isPresentInFamilyCircleWithCompletion___block_invoke_257;
    v16[3] = &unk_1E89ACFE0;
    v16[4] = *(_QWORD *)(a1 + 40);
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Account is in family circle: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch family members with error: %@", buf, 0x16u);
...
uint64_t __66__HMDAccount_FamilyCircle__isPresentInFamilyCircleWithCompletion___block_invoke_257(uint64_t a1, uint64_t a2)
{
