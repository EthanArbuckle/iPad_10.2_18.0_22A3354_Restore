...
- (id)hmd_actualCKErrorFromCKErrorPartialFailure:()HomeKitCKError
{
  ...
  objc_msgSend(v5, "objectForKey:", *MEMORY[0x1E0C94940]);
...
LABEL_9:
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", v3, 0, 0, 0, a1);
...
- (id)hmd_retryAfterCKError
{
  ...
  if ((objc_msgSend(a1, "hmd_isCKError") & 1) != 0 || (objc_msgSend(a1, "hmd_isUnderlyingCKError") & 1) != 0)
  {
    ...
    objc_msgSend(v10, "hmf_numberForKey:", *MEMORY[0x1E0C94808]);
