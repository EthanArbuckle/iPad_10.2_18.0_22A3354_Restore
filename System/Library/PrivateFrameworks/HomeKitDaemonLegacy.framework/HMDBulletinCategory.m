...
+ (id)_enumerationValueLocalizationKeys
{
  if (_enumerationValueLocalizationKeys_onceToken != -1)
    dispatch_once(&_enumerationValueLocalizationKeys_onceToken, &__block_literal_global_90768);
...
+ (id)_secureStateMap
{
  if (_secureStateMap_onceToken != -1)
    dispatch_once(&_secureStateMap_onceToken, &__block_literal_global_36_90766);
...
+ (id)_sensorMap
{
  if (_sensorMap_onceToken != -1)
    dispatch_once(&_sensorMap_onceToken, &__block_literal_global_48_90753);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Could not determine localized string from empty items", buf, 0xCu);
...
+ (id)localizedStateForCharacteristic:(id)a3 doorbellBulletinUtilities:(id)a4
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = objc_msgSend(v10, "isEqualToString:", *MEMORY[0x1E0D15F78]);
  ...
  if (!v11)
  {
    if (+[HMDBulletinCategory isSensorDetectedCharacteristic:](HMDBulletinCategory, "isSensorDetectedCharacteristic:", v6))
    {
      ...
      v18 = objc_msgSend(v17, "isEqualToString:", *MEMORY[0x1E0D15F90]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v89 = 2112;
          v90 = v77;
          _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    ...
    if ((objc_msgSend(v32, "isEqualToString:", *MEMORY[0x1E0D15EC8]) & 1) != 0)
    {
    ...
    v46 = *MEMORY[0x1E0D162B0];
    v80 = v7;
    v74 = v8;
    if (objc_msgSend(v45, "isEqualToString:", *MEMORY[0x1E0D162B0]))
    {
...
LABEL_26:
      ...
      if (!v64)
      {
        ...
        if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v89 = 2112;
          v90 = v65;
          _os_log_impl(&dword_1CD062000, v69, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    ...
    if ((objc_msgSend(v55, "isEqualToString:", *MEMORY[0x1E0D16240]) & 1) != 0)
    {
  ...
  objc_msgSend(v9, "type");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0D161C8]);
...
+ (BOOL)isSecureServiceType:(id)a3
{
  ...
  v4 = a3;
  if (v3 != -1)
    dispatch_once(&isSecureServiceType__onceToken, &__block_literal_global_89_90719);
...
+ (id)bulletinReasonForChangedCharacteristic:(id)a3
{
  ...
  objc_msgSend(v3, "type");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D15F90]);

  if (!v10)
  {
    objc_msgSend(v3, "type");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0D15F78]) & 1) != 0)
    {
      objc_msgSend(v4, "type");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = objc_msgSend(v13, "isEqualToString:", *MEMORY[0x1E0D161C8]);

      if (v14)
      {
        v11 = (id *)MEMORY[0x1E0CB83B8];
        goto LABEL_7;
      }
    }
    else
...
+ (NSDictionary)targetCurrentCharacteristicTypeMap
{
  if (targetCurrentCharacteristicTypeMap_onceToken != -1)
    dispatch_once(&targetCurrentCharacteristicTypeMap_onceToken, &__block_literal_global_91_90717);
...
+ (id)_localizedStateForValue:(id)a3 characteristicType:(id)a4
{
  ...
  v5 = a3;
  v6 = a4;
  if (objc_msgSend(v6, "isEqualToString:", *MEMORY[0x1E0D15F28]))
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@type : %@ value = %@", (uint8_t *)&v19, 0x20u);
...
+ (id)_presentationTypeForType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0D15FD0]) & 1) != 0
    || (objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0D15FA0]) & 1) != 0
    || (v4 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0D15F28]), v5 = v3, v4))
  {
    v5 = (void *)*MEMORY[0x1E0D15F00];
  }
  v6 = v5;
...
+ (id)presentationValueForValue:(id)a3 type:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D15FD0]) & 1) != 0
    || objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D15FA0]))
  {
  ...
  if ((objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D15F28]) & 1) != 0
    || objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D16050]))
  {
  ...
  if ((objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D15F38]) & 1) != 0
    || (objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D15F78]) & 1) != 0
    || (objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D15F90]) & 1) != 0
    || objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D15F20]))
  {
    v16 = v6;
LABEL_16:
    v13 = v16;
...
void __57__HMDBulletinCategory_targetCurrentCharacteristicTypeMap__block_invoke()
{
  ...
  v0 = *MEMORY[0x1E0D15F00];
  v1 = *MEMORY[0x1E0D16048];
  v7[0] = *MEMORY[0x1E0D16028];
  v7[1] = v1;
  v2 = *MEMORY[0x1E0D15F20];
  v8[0] = v0;
  v8[1] = v2;
  v3 = *MEMORY[0x1E0D16060];
  v7[2] = *MEMORY[0x1E0D16050];
  v7[3] = v3;
  v4 = *MEMORY[0x1E0D15F38];
  v8[2] = *MEMORY[0x1E0D15F28];
  v8[3] = v4;
...
void __43__HMDBulletinCategory_isSecureServiceType___block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", *MEMORY[0x1E0D161C0], *MEMORY[0x1E0D161E0], *MEMORY[0x1E0D16208], *MEMORY[0x1E0D16220], *MEMORY[0x1E0D162A8], 0);
...
void __38__HMDBulletinCategory__secureStateMap__block_invoke()
{
  ...
  v0 = *MEMORY[0x1E0D15F28];
  v4[0] = *MEMORY[0x1E0D15F00];
  v4[1] = v0;
  v5[0] = &unk_1E8B31FE0;
  v5[1] = &unk_1E8B31FF8;
  v1 = *MEMORY[0x1E0D15EF0];
  v4[2] = *MEMORY[0x1E0D15F38];
  v4[3] = v1;
  v5[2] = &unk_1E8B32010;
  v5[3] = &unk_1E8B32028;
...
void __56__HMDBulletinCategory__enumerationValueLocalizationKeys__block_invoke()
{
  ...
  v6[6] = *MEMORY[0x1E0C80C00];
  v0 = *MEMORY[0x1E0D15F20];
  v5[0] = *MEMORY[0x1E0D15F00];
  v5[1] = v0;
  v6[0] = &unk_1E8B31F50;
  v6[1] = &unk_1E8B31F68;
  v1 = *MEMORY[0x1E0D15F78];
  v5[2] = *MEMORY[0x1E0D15F38];
  v5[3] = v1;
  v6[2] = &unk_1E8B31F80;
  v6[3] = &unk_1E8B31F98;
  v2 = *MEMORY[0x1E0D15EF0];
  v5[4] = *MEMORY[0x1E0D15F90];
  v5[5] = v2;
  v6[4] = &unk_1E8B31FB0;
  v6[5] = &unk_1E8B31FC8;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v6, v5, 6);
