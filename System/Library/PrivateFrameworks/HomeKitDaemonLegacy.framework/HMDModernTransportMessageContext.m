      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v59 = v48;
          _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transaction ID should not be nil for a request message", buf, 0xCu);
...
- (void)startSendingOverTransport:(id)a3
{
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      v30 = 138543362;
      v31 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid transport", (uint8_t *)&v30, 0xCu);
  ...
  if ((-[NSMutableSet containsObject:](self->_remainingTransports, "containsObject:", v4) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_FAULT))
    {
      ...
      v30 = 138543362;
      v31 = v27;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transport already started", (uint8_t *)&v30, 0xCu);
...
- (void)completeSendingOverTransport:(id)a3 withError:(id)a4
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
    {
      ...
      v47 = 138543362;
      v48 = v38;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid transport", (uint8_t *)&v47, 0xCu);
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_FAULT))
    {
      ...
      v47 = 138543362;
      v48 = v44;
      _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transport has not started", (uint8_t *)&v47, 0xCu);
...
LABEL_8:
    ...
    || self->_didSucceedSending)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      v49 = 2114;
      v50 = v34;
      _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Message %{public}@ no longer needed, clearing message.", (uint8_t *)&v47, 0x16u);
...
LABEL_8:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDModernTransportMessageContext messageType](self, "messageType"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v25[1] = v12;
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDModernTransportMessageContext expectsResponse](self, "expectsResponse"));
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v25[3] = v14;
  v24[4] = CFSTR("messageTimedOut");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDModernTransportMessageContext didTimeout](self, "didTimeout"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v25[4] = v15;
  v24[5] = CFSTR("attemptedFallback");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDModernTransportMessageContext didFallback](self, "didFallback"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v25[5] = v16;
        ...
        if (v11)
        {
          ...
          do
          {
            for (i = 0; i != v12; ++i)
            {
              ...
              objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 8, (_QWORD)v19);
              v16 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_85532 != -1)
    dispatch_once(&logCategory__hmf_once_t6_85532, &__block_literal_global_85533);
  return (id)logCategory__hmf_once_v7_85534;
}
...
void __47__HMDModernTransportMessageContext_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_85534;
  logCategory__hmf_once_v7_85534 = v0;
