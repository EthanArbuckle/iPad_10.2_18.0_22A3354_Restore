...
- (HMDTimeBasedFlagDaily)initWithContext:(id)a3 dateProvider:(id)a4
{
  ...
  if (initWithContext_dateProvider__onceToken != -1)
    dispatch_once(&initWithContext_dateProvider__onceToken, &__block_literal_global_168735);
  v13.receiver = self;
  ...
  if (v7 != 0 && v7 < 0xFFFFFFFFFFFFFFC1)
  {
    if (v7 - 1 > 0x3E)
    {
      if (v7 + 127 <= 0x3F)
      {
        ...
        objc_msgSend(MEMORY[0x1E0D33480], "startOfDateByAddingDayCount:toDate:", 63, v4);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)serializeToDictionary
{
  ...
  os_unfair_lock_lock_with_options();
  v8[0] = CFSTR("bits");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDTimeBasedFlagDaily bits](self, "bits"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v9[0] = v4;
  v8[1] = CFSTR("bit0date");
  -[HMDTimeBasedFlagDaily bit0Date](self, "bit0Date");
