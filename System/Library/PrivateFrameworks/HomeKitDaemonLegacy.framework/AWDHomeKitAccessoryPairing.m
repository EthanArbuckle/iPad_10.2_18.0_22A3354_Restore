...
LABEL_11:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isAdd);
...
LABEL_12:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isAddedViaWAC);
...
LABEL_13:
  ...
  {
    v11 = off_1E89B5800[transportType];
  }
...
LABEL_21:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isSecureWAC);
...
LABEL_58:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_retryCount);
...
LABEL_59:
  ...
  if (credentialType >= 3)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_credentialType);
    v35 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v35 = off_1E89B5858[credentialType];
  }
...
LABEL_63:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isAddWithOwnershipProof);
...
LABEL_64:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isNetworkRouterAdd);
  ...
  {
LABEL_26:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isNetworkRouterReplace);
...
LABEL_27:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isFirstHAPAccessoryInAnyHome);
...
LABEL_31:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isFirstHAPAccessoryInHome);
...
LABEL_49:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_noeCapabilities);
...
LABEL_50:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_noeStatus);
...
LABEL_51:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isBTOnboard);
...
LABEL_52:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isNoeOnboard);
...
LABEL_53:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_noeOnboardDuration);
  ...
  {
LABEL_38:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", self->_noeOnboardErrorCode);
