      ...
      if (*((_BYTE *)v43 + 24))
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v49 = 2112;
          v50 = CFSTR("RTP");
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Adding fallback LAN rules for %@", buf, 0x16u);
      ...
      if (*((_BYTE *)v39 + 24))
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v49 = 2112;
          v50 = CFSTR("HDS");
          _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Adding fallback LAN rules for %@", buf, 0x16u);
...
LABEL_20:
  ...
  v27 = -[HMDNetworkRouterFirewallRuleConfiguration initWithAccessoryIdentifier:lastModifiedTime:fullAccessLAN:lanRules:fullAccessWAN:wanRules:](&v31, sel_initWithAccessoryIdentifier_lastModifiedTime_fullAccessLAN_lanRules_fullAccessWAN_wanRules_, v8, v9, (_DWORD)v10 != 0, v26, 0, MEMORY[0x1E0C9AA60]);
...
+ (id)fallbackIdentifier
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286E0]), "initWithMajorVersion:minorVersion:updateVersion:", 0, 0, 0);
...
void __84__HMDNetworkRouterHomeKitOnlyFirewallConfiguration_fallbackConfigurationForRuleset___block_invoke(uint64_t a1)
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v25 = v17;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to load fallback network protection rules", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to locate fallback network protection rules", buf, 0xCu);
...
void __84__HMDNetworkRouterHomeKitOnlyFirewallConfiguration_fallbackConfigurationForRuleset___block_invoke_15(uint64_t a1, void *a2, void *a3)
{
        ...
        v16 = -[HMDNetworkRouterFirewallRuleConfiguration initWithAccessoryIdentifier:jsonDictionary:](v14, "initWithAccessoryIdentifier:jsonDictionary:", v15, v12), v15, !v16))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v7;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse fallback network protection rules for '%@'", (uint8_t *)&v21, 0x16u);
