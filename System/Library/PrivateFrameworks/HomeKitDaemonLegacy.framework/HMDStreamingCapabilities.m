...
- (HMDStreamingCapabilities)initWithStreamPreference:(id)a3
{
  ...
  if (v5)
  {
    if (initWithStreamPreference__onceToken != -1)
      dispatch_once(&initWithStreamPreference__onceToken, &__block_literal_global_61800);
    ...
    +[HMDH264Profile arrayWithProfiles:](HMDH264Profile, "arrayWithProfiles:", &unk_1E8B31E90);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    +[HMDH264Level arrayWithLevels:](HMDH264Level, "arrayWithLevels:", &unk_1E8B31EA8);
    ...
    +[HMDPacketizationMode arrayWithModes:](HMDPacketizationMode, "arrayWithModes:", &unk_1E8B31EC0);
    ...
    +[HMDBitRateSetting arrayWithSettings:](HMDBitRateSetting, "arrayWithSettings:", &unk_1E8B31ED8);
    ...
    +[HMDAudioSampleRate arrayWithRates:](HMDAudioSampleRate, "arrayWithRates:", &unk_1E8B31EF0);
...
- (id)_supportedResolutionsWithOverrides
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E20], "setWithSet:", supportedHMDVideoResolutions);
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v64 = 2112;
      v65 = v7;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding the video resolution capabilities with %@", buf, 0x16u);
...
LABEL_27:
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v64 = 2112;
          v65 = v34;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding the audio codec group capabilities with %@", buf, 0x16u);
...
void __53__HMDStreamingCapabilities_initWithStreamPreference___block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0CF2250], "capabilities");
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v0;
    _os_log_impl(&dword_1CD062000, v2, OS_LOG_TYPE_INFO, "%{public}@Audio streaming capabilities as reported by AVCAudioStream: %@", (uint8_t *)&v9, 0x16u);

  }
  objc_autoreleasePoolPop(v1);
  objc_msgSend(MEMORY[0x1E0CF22E0], "capabilities");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Video streaming capabilities as reported by AVCVideoStream: %@", (uint8_t *)&v9, 0x16u);
...
LABEL_18:
  ...
  v44 = v3;
  objc_msgSend(v3, "objectForKeyedSubscript:", *MEMORY[0x1E0CF2318]);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v42 = v8;
    objc_msgSend(v44, "objectForKeyedSubscript:", *MEMORY[0x1E0CF2320]);
...
+ (unint64_t)aspectRatioOfResolution:(id)a3
{
  ...
  if (v5 >= 0x1D)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Resolution: %@ is not handled, returning default aspect ratio: %@", (uint8_t *)&v12, 0x20u);
