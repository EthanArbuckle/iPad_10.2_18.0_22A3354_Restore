...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_79891 != -1)
    dispatch_once(&hmbProperties_onceToken_79891, &__block_literal_global_79892);
  return (id)hmbProperties__properties_79893;
}
...
void __49__HMDAssistantAccessControlModelV2_hmbProperties__block_invoke()
{
  ...
  v5 = (void *)hmbProperties__properties_79893;
  hmbProperties__properties_79893 = v4;
