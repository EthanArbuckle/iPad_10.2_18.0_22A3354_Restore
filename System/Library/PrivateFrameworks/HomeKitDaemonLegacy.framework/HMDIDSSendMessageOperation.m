  ...
  if ((isKindOfClass & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v29;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Invalid message destination: %@", buf, 0x16u);
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v28;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Invalid service", buf, 0xCu);
      goto LABEL_16;
    }
    goto LABEL_17;
  }
...
- (NSArray)attributeDescriptions
{
  ...
  v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28548]), "initWithName:value:options:formatter:", CFSTR("Message"), self->_message, 1, 0);
  v5[0] = v2;
...
- (void)main
{
  ...
  v50 = 0;
  +[HMDRemoteMessageSerialization dictionaryForMessage:error:](HMDRemoteMessageSerialization, "dictionaryForMessage:error:", v11, &v50);
  ...
  if (v12)
  {
    ...
    v51 = *MEMORY[0x1E0D341C8];
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v4->_timeout);
      ...
      if ((v20 & 1) != 0)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v55 = 2112;
          v56 = v21;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Sent message with identifier: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v55 = 2112;
          v56 = v22;
          _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, "%{public}@Failed to send message with error: %@", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v42);
        v46 = (void *)MEMORY[0x1E0CB35C8];
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:underlyingError:", 3203, v22);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v55 = 2112;
        v56 = destination;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate destination for: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v55 = 2112;
      v56 = v14;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize message with error: %@", buf, 0x16u);
    ...
    && -[NSString isEqualToString:](self->_messageIdentifier, "isEqualToString:", v16))
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 138543362;
        v29 = v23;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Successfully sent message", (uint8_t *)&v28, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v30 = 2112;
        v31 = v17;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send message with error: %@", (uint8_t *)&v28, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_43077 != -1)
    dispatch_once(&logCategory__hmf_once_t8_43077, &__block_literal_global_43078);
  return (id)logCategory__hmf_once_v9_43079;
}
...
void __41__HMDIDSSendMessageOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_43079;
  logCategory__hmf_once_v9_43079 = v0;
