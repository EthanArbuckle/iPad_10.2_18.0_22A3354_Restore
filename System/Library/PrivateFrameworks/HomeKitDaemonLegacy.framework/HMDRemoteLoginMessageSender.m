...
- (void)sendRemoteMessageWithName:(id)a3 payload:(id)a4 responseHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v33 = v25;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Remote device to send the message is nil", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_98716 != -1)
    dispatch_once(&logCategory__hmf_once_t0_98716, &__block_literal_global_98717);
  return (id)logCategory__hmf_once_v1_98718;
}
...
void __42__HMDRemoteLoginMessageSender_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_98718;
  logCategory__hmf_once_v1_98718 = v0;
