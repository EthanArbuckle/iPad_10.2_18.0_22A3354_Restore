...
- (HMDMediaGroupsAggregatorBackupReceiver)init
{
  ...
  if (v2)
  {
    v3 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("00000000-0000-0000-0000-000000000000"));
...
- (void)handleGroupsBackupDataMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling backup group data message: %@", (uint8_t *)&v27, 0x16u);
  ...
  if (v9)
  {
    ...
    if (v11)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          v29 = 2112;
          v30 = v22;
          _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify delegate of received backup due to unconfigured delegate error: %@", (uint8_t *)&v27, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 2112;
        v32 = v13;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Failed to decode group backup data payload: %@ error: %@", (uint8_t *)&v27, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = v11;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message payload from group backup data message: %@ error: %@", (uint8_t *)&v27, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_153442 != -1)
    dispatch_once(&logCategory__hmf_once_t4_153442, &__block_literal_global_153443);
  return (id)logCategory__hmf_once_v5_153444;
}
...
void __53__HMDMediaGroupsAggregatorBackupReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_153444;
  logCategory__hmf_once_v5_153444 = v0;
