...
- (id)description
{
  ...
  -[HMDRemoteEventRouterProtoConnectResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteEventRouterProtoConnectResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HMDRemoteEventRouterProtoConnectResponse cachedEventsCount](self, "cachedEventsCount"))
  {
    objc_msgSend(v8, "clearCachedEvents");
    v4 = -[HMDRemoteEventRouterProtoConnectResponse cachedEventsCount](self, "cachedEventsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HMDRemoteEventRouterProtoConnectResponse cachedEventsAtIndex:](self, "cachedEventsAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HMDRemoteEventRouterProtoConnectResponse addCachedEvents:](self, "addCachedEvents:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
