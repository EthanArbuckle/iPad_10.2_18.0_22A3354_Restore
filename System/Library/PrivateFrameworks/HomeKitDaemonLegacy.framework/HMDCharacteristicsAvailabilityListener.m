...
- (void)_notifyDelegate
{
  ...
  if ((v6 & 1) == 0)
  {
    v7 = (void *)MEMORY[0x1D17BA0A0](-[HMDCharacteristicsAvailabilityListener setAvailableCharacteristics:](self, "setAvailableCharacteristics:", v4));
    v8 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of characteristics update: %@", (uint8_t *)&v13, 0x16u);
...
uint64_t __64__HMDCharacteristicsAvailabilityListener_handleServicesUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Services updated", (uint8_t *)&v7, 0xCu);
...
uint64_t __71__HMDCharacteristicsAvailabilityListener_handleCharacteristicsUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Characteristics updated", (uint8_t *)&v7, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_185184 != -1)
    dispatch_once(&logCategory__hmf_once_t3_185184, &__block_literal_global_185185);
  return (id)logCategory__hmf_once_v4_185186;
}
...
void __53__HMDCharacteristicsAvailabilityListener_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_185186;
  logCategory__hmf_once_v4_185186 = v0;
