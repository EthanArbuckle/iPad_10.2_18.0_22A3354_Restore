...
- (HMDWidgetTimelineRefresher)initWithHomeManager:(id)a3 queue:(id)a4 notificationCenter:(id)a5 darwinNotificationProvider:(id)a6 widgetConfigurationReader:(id)a7 timelineController:(id)a8 logEventSubmitter:(id)a9 timerManager:(id)a10 reachabilityUpdateDispatchDelayNs:(int64_t)a11 forceUpdateTimelineDispatchDelayNs:(int64_t)a12
{
  ...
  uint64_t v59;
  void *v60;
  HMDWidgetTimelineRefresher *v61;
  NSObject *v62;
  void *v63;
  void *v64;
  void *v65;
  ...
  HMDWidgetTimelineRefresher *v73;
  id v75;
  id v76;
  id v77;
  id v78;
  ...
  v76 = a10;
  v86.receiver = self;
  v86.super_class = (Class)HMDWidgetTimelineRefresher;
  v20 = -[HMDWidgetTimelineRefresher init](&v86, sel_init);
  v21 = v20;
  if (v20)
  {
    v75 = v19;
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@.HMDWidgetTimelineRefresher.Autobahn"), CFSTR("com.apple.HomeKitDaemon"));
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@.HMDWidgetTimelineRefresher"), CFSTR("com.apple.HomeKitDaemon"));
    ...
    v51 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, (dispatch_queue_t)v21->_workQueue);
    ...
    if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[8] = 0;
      ...
      if (v64)
      {
        ...
        objc_msgSend(v65, "getUUIDBytes:", buf);
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v94 = 2096;
      v95 = &v87;
      _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_INFO, "%{public}@primary home is %{uuid_t}.16P, current home is %{uuid_t}.16P", buf, 0x2Cu);
    ...
    aBlock[3] = &unk_1E89B8AC0;
    objc_copyWeak(&v85, (id *)buf);
    v69 = _Block_copy(aBlock);
    forceUpdateAutobahnTimelineHandler = v61->_forceUpdateAutobahnTimelineHandler;
    v61->_forceUpdateAutobahnTimelineHandler = v69;

    v82[0] = v68;
    v82[1] = 3221225472;
    v82[2] = __247__HMDWidgetTimelineRefresher_initWithHomeManager_queue_notificationCenter_darwinNotificationProvider_widgetConfigurationReader_timelineController_logEventSubmitter_timerManager_reachabilityUpdateDispatchDelayNs_forceUpdateTimelineDispatchDelayNs___block_invoke_2;
    v82[3] = &unk_1E89BE3F8;
    objc_copyWeak(&v83, (id *)buf);
    v71 = _Block_copy(v82);
    fetchAndStoreActiveWidgetKindsHandler = v61->_fetchAndStoreActiveWidgetKindsHandler;
    v61->_fetchAndStoreActiveWidgetKindsHandler = v71;
...
- (void)configure
{
  ...
  NSObject *v30;
  void *v31;
  HMDWidgetTimelineRefresher *v32;
  NSObject *v33;
  void *v34;
  void *v35;
  _QWORD handler[4];
  ...
  if (v35)
  {
    ...
    -[HMDWidgetTimelineRefresher notificationCenter](self, "notificationCenter");
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "addObserver:selector:name:object:", self, sel_handleCurrentOrPrimaryHomeChangedNotification_, CFSTR("HMDNotificationCurrentHomeDidChange"), v35);

    -[HMDWidgetTimelineRefresher notificationCenter](self, "notificationCenter");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "addObserver:selector:name:object:", self, sel_handleCurrentOrPrimaryHomeChangedNotification_, CFSTR("HMDNotificationPrimaryHomeDidChange"), v35);

    -[HMDWidgetTimelineRefresher notificationCenter](self, "notificationCenter");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "addObserver:selector:name:object:", self, sel_handleHomeAddedNotification_, CFSTR("HMDHomeAddedNotification"), v35);

    -[HMDWidgetTimelineRefresher notificationCenter](self, "notificationCenter");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "addObserver:selector:name:object:", self, sel_handleHomeRemovedNotification_, CFSTR("HMDHomeRemovedNotification"), v35);
    ...
    if (v19)
    {
      ...
      do
      {
        for (i = 0; i != v19; ++i)
        {
          ...
          objc_msgSend(v23, "addObserver:selector:name:object:suspensionBehavior:", self, sel_handleNotificationOfPossibleNewWidget_, v22, 0, 4);
    ...
    -[HMDWidgetTimelineRefresher registerForMessagesWithMessageDispatcher:](self, "registerForMessagesWithMessageDispatcher:", v24);
    ...
    v27 = objc_claimAutoreleasedReturnValue();
    v28 = dispatch_walltime(0, 0);
    dispatch_source_set_timer(v27, v28, 0x68C61714000uLL, 0x8BB2C97000uLL);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&location[4] = v34;
      v45 = 2080;
      v46 = "-[HMDWidgetTimelineRefresher configure]";
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil during %s, no widgets configured.", location, 0x16u);
...
- (void)registerForMessagesWithMessageDispatcher:(id)a3
{
  ...
  objc_msgSend(v4, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBA0F0], self, v6, sel_handleMonitorCharacteristicsForWidget_);
  objc_msgSend(v4, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBA0D8], self, v6, sel_handleFetchState_);
  objc_msgSend(v4, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBA0F8], self, v6, sel_handlePerformRequests_);
  objc_msgSend(v4, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBA0E8], self, v6, sel_handleMonitorActionSetsForWidget_);
  objc_msgSend(v4, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBA0E0], self, v6, sel_handleFetchStateForActionSets_);
...
- (void)registerForDarwinNotifications
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v27 = 1024;
      v28 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to register notification for %s with error: %d", buf, 0x1Cu);
  ...
  v18[0] = v5;
  v18[1] = 3221225472;
  v18[2] = __60__HMDWidgetTimelineRefresher_registerForDarwinNotifications__block_invoke_132;
  v18[3] = &unk_1E89B9FB8;
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v27 = 1024;
      v28 = v13;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to register notification for %s with error: %d", buf, 0x1Cu);
...
- (id)internalMonitorCharacteristicsForCurrentHome:(id)a3 activeWidgetKinds:(id)a4
{
  ...
  if (v6)
  {
    v9 = -[HMDWidgetTimelineRefresher homeHasAnyResident:]((uint64_t)self, v6);
    ...
    if (v9)
    {
      if (v13)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v15;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating monitored characteristics for current home: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v10);
      objc_msgSend((id)objc_opt_class(), "fetchSpecificationsForWidgetKinds:", v7);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDWidgetTimelineRefresher monitorCharacteristicsForHome:fetchSpecifications:](v11, "monitorCharacteristicsForHome:fetchSpecifications:", v6, v16);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      if (v13)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v19;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Not updating monitored characteristics for current home: %@ because there is no resident", buf, 0x16u);
      ...
      do
      {
        ...
        do
        {
          ...
          if ((HMFEqualObjects() & 1) == 0 && -[HMDWidgetTimelineRefresher homeHasAnyResident:]((uint64_t)self, v26))
          {
            ...
            -[HMDWidgetTimelineRefresher monitorCharacteristicsForHome:fetchSpecifications:](self, "monitorCharacteristicsForHome:fetchSpecifications:", v26, v27);
...
- (id)monitorCharacteristicsForHome:(id)a3 fetchSpecifications:(id)a4
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v125 = 2112;
    v126 = v20;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@monitorCharacteristicsForHome: '%@' [%@], fetch specifications: %@", buf, 0x2Au);
        ...
        if (objc_msgSend(v22, "count"))
        {
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v123 = 2112;
            v124 = v48;
            _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Monitoring accessory: '%@:%@'", buf, 0x20u);
              ...
              do
              {
                ...
                if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  v125 = 2112;
                  v126 = v62;
                  _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@+ monitoring service: '%@', characteristic: '[%@] (%@)'", buf, 0x2Au);
...
- (void)stopMonitoringOldCharacteristics
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v60 = 2112;
    v61 = v9;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Stop monitoring previous accessories: %@", buf, 0x16u);
        ...
        if (!v32)
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v43;
            ...
            v60 = 2112;
            v61 = v41;
            _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@- stopped monitoring accessory: %@", buf, 0x16u);
...
- (void)internalProcessChangedCharacteristics:(id)a3 activeWidgetKinds:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@%s", (uint8_t *)&v15, 0x16u);
...
- (id)widgetKindsToUpdateFromFetchSpecifications:(id)a3 changedCharacteristics:(id)a4
{
  ...
  void *v43;
  uint64_t v44;
  HMDWidgetTimelineRefresher *v45;
  NSObject *v46;
  _BOOL4 v47;
  char *v48;
  void *v49;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    v98 = v10;
    v99 = 2082;
    v100 = "-[HMDWidgetTimelineRefresher widgetKindsToUpdateFromFetchSpecifications:changedCharacteristics:]";
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@%{public}s", buf, 0x16u);
  ...
  v96 = 0u;
  obj = v6;
  v11 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v93, v111, 16);
  if (v11)
  {
    v13 = v11;
    v92 = *(_QWORD *)v94;
    *(_QWORD *)&v12 = 138544898;
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v15, "accessory", v65);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v16, "home");
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        v18 = -[HMDWidgetTimelineRefresher homeHasAnyResident:]((uint64_t)v8, v17);
        ...
        if (v18)
        {
          ...
          if ((_DWORD)v20)
          {
            ...
            if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544642;
              ...
              v107 = 2112;
              v108 = v32;
              _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@...ignoring redundant characteristic [%@] (%@) from '%@:%@', value '%@'", buf, 0x3Eu);
          ...
          {
            -[HMDWidgetTimelineRefresher widgetKindsToUpdateFromFetchSpecifications:assumingChangedCharacteristic:](v8, "widgetKindsToUpdateFromFetchSpecifications:assumingChangedCharacteristic:", v73, v15);
            v43 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v72, "unionSet:", v43);
            ...
            if (v44)
            {
              if (v47)
              {
                ...
                *(_DWORD *)buf = v65;
                ...
                v109 = 2112;
                v110 = v53;
                _os_log_impl(&dword_1CD062000, v84, OS_LOG_TYPE_INFO, "%{public}@...updating characteristic [%@] (%@) from '%@:%@', value '%@' was '%@'", buf, 0x48u);
              ...
              -[HMDWidgetTimelineRefresher characteristicsToPreviouslySeenValues](v45, "characteristicsToPreviouslySeenValues");
            ...
            else
            {
              if (v47)
              {
                ...
                *(_DWORD *)buf = 138544642;
                ...
                v107 = 2112;
                v108 = v63;
                _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@...ignoring irrelevant characteristic [%@] (%@) from '%@:%@', value '%@'", buf, 0x3Eu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544642;
            ...
            v107 = 2112;
            v108 = v42;
            _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@...No resident. Ignoring characteristic [%@] (%@) from '%@:%@', value '%@'", buf, 0x3Eu);
      ...
      while (v13 != v14);
      v13 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v93, v111, 16);
    }
    while (v13);
  }
...
LABEL_16:
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v29;
            ...
            v44 = 2112;
            v45 = v27;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@...must reload widget kinds: %@", buf, 0x16u);
...
- (void)fetchAndStoreActiveWidgetKinds
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Reloading widgets from Chronod", buf, 0xCu);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v21;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Active widgets are: %@", buf, 0x16u);
...
- (void)handleMonitorCharacteristicsForWidget:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "stringForKey:", *MEMORY[0x1E0CBA0C8]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
  {
    objc_msgSend(v4, "stringForKey:", *MEMORY[0x1E0CBA0D0]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v6)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[28] = 2112;
        *(_QWORD *)&buf[30] = v52;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find widget kind in message payload: %@", buf, 0x26u);
    ...
    v7 = *MEMORY[0x1E0CBA098];
    objc_msgSend(v4, "arrayForKey:", *MEMORY[0x1E0CBA098]);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v8)
    {
      v33 = (void *)MEMORY[0x1D17BA0A0]();
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[28] = 2112;
        *(_QWORD *)&buf[30] = v53;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find characteristic UUIDs in message payload: %@", buf, 0x26u);
    ...
    objc_msgSend(v4, "numberForKey:", *MEMORY[0x1E0CBA0A8]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[28] = 2112;
        *(_QWORD *)&buf[30] = v93;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find generation counter in message payload: %@", buf, 0x26u);
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[28] = 2112;
        *(_QWORD *)&buf[30] = v94;
        _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find reachability registration value in message payload: %@", buf, 0x26u);
    ...
    v107 = v7;
    objc_msgSend(v4, "uuidForKey:", *MEMORY[0x1E0CBA0A0]);
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[40] = v116;
      ...
      v128 = 2096;
      v129 = &v123;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Received message to update characteristics for widget: %@, generation counter: %@, current home: %{uuid_t}.16P", buf, 0x40u);
    ...
    if (v15)
    {
      ...
      if (v62)
      {
        if (v66)
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(_QWORD *)&buf[14] = v113;
          _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_INFO, "%{public}@Monitored characteristics did not change for widget %@", buf, 0x16u);
      ...
      else
      {
        if (v66)
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          *(_QWORD *)&buf[24] = v115;
          _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_INFO, "%{public}@Monitored characteristics changed for widget %@ to %@", buf, 0x20u);
    ...
    if (v15)
    {
      ...
      if (!v72)
      {
        ...
        if (os_log_type_enabled(v76, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v77;
          _os_log_impl(&dword_1CD062000, v76, OS_LOG_TYPE_FAULT, "%{public}@Generation counter is unexpectedly set to zero.", buf, 0xCu);
      ...
      if (v79 > v73)
      {
        ...
        if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[22] = 2048;
          *(_QWORD *)&buf[24] = v79;
          _os_log_impl(&dword_1CD062000, v82, OS_LOG_TYPE_INFO, "%{public}@Refreshing timeline because client's generation counter is older. Client: %lu, homed: %lu", buf, 0x20u);
...
LABEL_77:
      ...
      if ((HMFEqualObjects() & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v91, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[34] = 2096;
          *(_QWORD *)&buf[36] = &v135;
          _os_log_impl(&dword_1CD062000, v91, OS_LOG_TYPE_INFO, "%{public}@Refreshing timeline because client's currentHome UUID is different. Client: %{uuid_t}.16P, homed: %{uuid_t}.16P", buf, 0x2Cu);
...
LABEL_78:
    ...
    if (os_log_type_enabled(v101, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[38] = 2112;
      *(_QWORD *)&buf[40] = v98;
      _os_log_impl(&dword_1CD062000, v101, OS_LOG_TYPE_INFO, "%{public}@[%@] Responding to %{uuid_t}.16P with payload: %@", buf, 0x30u);
...
LABEL_87:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_WORD *)&buf[28] = 2112;
    *(_QWORD *)&buf[30] = v45;
    _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find widget identifier in message payload: %@", buf, 0x26u);
...
- (void)handleFetchState:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[20] = &v34;
      v28 = 2112;
      v29 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Received message to fetch state for: %@", buf, 0x26u);
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[24] = 16;
      ...
      v30 = 2112;
      v31 = v18;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@[%@] Responding to %{uuid_t}.16P with payload: %@", buf, 0x30u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v15;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find characteristic UUIDs in message payload: %@", buf, 0x16u);
...
- (void)handlePerformRequests:(id)a3
{
  ...
  if (!v4)
    goto LABEL_110;
  v100 = v5;
  objc_msgSend(v104, "stringForKey:", *MEMORY[0x1E0CBA0D0]);
  ...
  if (!v101)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v173 = 2112;
      v174 = v97;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find widget kind in message payload: %@", buf, 0x26u);
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&buf[14] = 16;
    ...
    v173 = 2112;
    v174 = v101;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Received message to perform requests for kind: %@", buf, 0x26u);
  ...
  v136[1] = v136;
  v136[2] = 0x3032000000;
  v136[3] = __Block_byref_object_copy__142400;
  v136[4] = __Block_byref_object_dispose__142401;
  v137 = 0;
  v134[0] = 0;
  v134[1] = v134;
  v134[2] = 0x2020000000;
          ...
          for (i = 0; i != v20; ++i)
          {
            ...
            if (v25)
            {
              if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_QWORD *)&v175[8] = 0;
                ...
                {
                  *(_OWORD *)v175 = *MEMORY[0x1E0D286F8];
                }
                v162 = *(_OWORD *)v175;
                ...
                *(_WORD *)&v175[28] = 2112;
                *(_QWORD *)&v175[30] = v23;
                _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] We can't execute trigger-owned action set: %@", v175, 0x26u);
            ...
            else
            {
              if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
              {
                ...
                *(_WORD *)&v175[28] = 2112;
                *(_QWORD *)&v175[30] = v23;
                _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Executing action set: %@", v175, 0x26u);
              ...
              objc_msgSend(v19, "identifier");
              v37 = (void *)objc_claimAutoreleasedReturnValue();
              -[HMDWidgetTimelineRefresher _setPendingRequestValue:forUUID:messageIdentifier:](v27, "_setPendingRequestValue:forUUID:messageIdentifier:", &unk_1E8B34488, v36, v37);
  ...
  if (!v114)
    goto LABEL_103;
  v109 = *MEMORY[0x1E0CB8230];
  v110 = *(_QWORD *)v163;
  v125 = *MEMORY[0x1E0D15FB0];
  obja = (id)*MEMORY[0x1E0D15EC8];
  do
  {
    for (j = 0; j != v114; ++j)
    {
      ...
      if (v41)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          ...
          v173 = 2112;
          v174 = v39;
          _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] We can't execute trigger-owned action set: %@", buf, 0x26u);
      ...
      if (!-[HMDWidgetTimelineRefresher actionSetIsOn:](v121, "actionSetIsOn:", v39))
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          ...
          v173 = 2112;
          v174 = v39;
          _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Action set cannot be turned off because it's not active: %@", buf, 0x26u);
...
LABEL_59:
              ...
              if ((v62 & 1) != 0)
              {
                +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:value:authorizationData:type:](HMDCharacteristicWriteRequest, "writeRequestWithCharacteristic:value:authorizationData:type:", v55, &unk_1E8B344A0, 0, 0);
                v63 = (void *)objc_claimAutoreleasedReturnValue();
              ...
              else
              {
                ...
                if (os_log_type_enabled(v66, OS_LOG_TYPE_DEBUG))
                {
                  ...
                  *(_DWORD *)v166 = 138543618;
                  ...
                  v168 = 2112;
                  v169 = v54;
                  _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring characteristic write action for turning off because target value is NO: %@", v166, 0x16u);
        ...
        if (v68)
        {
          if (os_log_type_enabled(v71, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)&buf[14] = 16;
            ...
            v173 = 2112;
            v174 = v115;
            _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Executing turning off action set: %@", buf, 0x26u);
          ...
          -[HMDWidgetTimelineRefresher _setPendingRequestValue:forUUID:messageIdentifier:](v70, "_setPendingRequestValue:forUUID:messageIdentifier:", &unk_1E8B344A0, v88, v89);
          ...
          *(_QWORD *)&v148 = MEMORY[0x1E0C809B0];
          *((_QWORD *)&v148 + 1) = 3221225472;
          v149 = __127__HMDWidgetTimelineRefresher_executeActionSetsToTurnOffWithSPIClientIdentifiers_widgetKind_message_completionGroup_completion___block_invoke_175;
          v150 = &unk_1E89BE018;
          v151 = v70;
          v152 = v91;
          v92 = v91;
        ...
        else
        {
          if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)&buf[14] = 16;
            ...
            v173 = 2112;
            v174 = v115;
            _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Home is nil for action set: %@", buf, 0x26u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          ...
          v173 = 2112;
          v174 = v115;
          _os_log_impl(&dword_1CD062000, v81, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Action set doesn't contain actions that can be turned off: %@", buf, 0x26u);
...
- (void)handleMonitorActionSetsForWidget:(id)a3
{
  ...
  void *v14;
  void *v15;
  HMDWidgetTimelineRefresher *v16;
  NSObject *v17;
  void *v18;
  void *v19;
  void *v20;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      objc_msgSend(v4, "arrayForKey:", *MEMORY[0x1E0CBA070]);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      if (v7)
      {
        v56 = -[HMDWidget initWithIdentifier:kind:]([HMDWidget alloc], "initWithIdentifier:kind:", v5, v6);
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[20] = &v65;
          v59 = 2112;
          v60 = v56;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Received message to update action sets for widget: %@", buf, 0x26u);

        }
        v55 = v5;

        objc_autoreleasePoolPop(v9);
        v34 = objc_msgSend(v4, "qualityOfService");
        if (v10)
        {
          v35 = v34;
          v36 = v56;
          v37 = v8;
          -[HMDWidgetTimelineRefresher characteristicsMonitoredForWidgets](v10);
          v38 = (void *)objc_claimAutoreleasedReturnValue();
          -[HMDWidgetTimelineRefresher monitoredActionSetsMapByWidget](v10, "monitoredActionSetsMapByWidget");
          v39 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v39, "setObject:forKey:", v37, v36);
        ...
        v63[0] = *MEMORY[0x1E0CBA080];
        -[HMDWidgetTimelineRefresher cachedIsOnStateBySPIClientIdentifierForActionSets:](v10, v8);
        v41 = (void *)objc_claimAutoreleasedReturnValue();
        v64[0] = v41;
        v63[1] = *MEMORY[0x1E0CBA078];
        -[HMDWidgetTimelineRefresher didExecuteFailBySPIClientIdentifierForActionSets:](v10, v8);
        v42 = (void *)objc_claimAutoreleasedReturnValue();
        v64[1] = v42;
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[24] = 16;
          ...
          v61 = 2112;
          v62 = v43;
          _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@[%@] Responding to %{uuid_t}.16P with payload: %@", buf, 0x30u);

          v44 = v54;
        }

        objc_autoreleasePoolPop(v44);
        objc_msgSend(v4, "respondWithPayload:", v43);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_QWORD *)&buf[8] = 0;
          ...
          v66 = *(_OWORD *)buf;
          objc_msgSend(v4, "messagePayload");
          v53 = (HMDWidget *)objc_claimAutoreleasedReturnValue();
          *(_DWORD *)buf = 138544130;
          *(_QWORD *)&buf[4] = v30;
          *(_WORD *)&buf[12] = 1040;
          *(_DWORD *)&buf[14] = 16;
          ...
          *(_QWORD *)&buf[20] = &v66;
          v59 = 2112;
          v60 = v53;
          _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find action set UUIDs in message payload: %@", buf, 0x26u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)&buf[8] = 0;
        ...
        v67 = *(_OWORD *)buf;
        objc_msgSend(v4, "messagePayload");
        v52 = (HMDWidget *)objc_claimAutoreleasedReturnValue();
        *(_DWORD *)buf = 138544130;
        *(_QWORD *)&buf[4] = v24;
        *(_WORD *)&buf[12] = 1040;
        *(_DWORD *)&buf[14] = 16;
        ...
        *(_QWORD *)&buf[20] = &v67;
        v59 = 2112;
        v60 = v52;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find widget kind in message payload: %@", buf, 0x26u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[8] = 0;
      ...
      v68 = *(_OWORD *)buf;
      objc_msgSend(v4, "messagePayload");
      v33 = (HMDWidget *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138544130;
      *(_QWORD *)&buf[4] = v18;
      *(_WORD *)&buf[12] = 1040;
      *(_DWORD *)&buf[14] = 16;
      ...
      *(_QWORD *)&buf[20] = &v68;
      v59 = 2112;
      v60 = v33;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find widget identifier in message payload: %@", buf, 0x26u);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)&buf[20] = &v38;
      v32 = 2112;
      v33 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Received message to fetch action sets for: %@", buf, 0x26u);

    }
    objc_autoreleasePoolPop(v7);
    -[HMDWidgetTimelineRefresher updateCachedIsOnStateForActionSets:](v8, v6);
    v36[0] = *MEMORY[0x1E0CBA080];
    -[HMDWidgetTimelineRefresher cachedIsOnStateBySPIClientIdentifierForActionSets:](v8, v6);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v37[0] = v19;
    v36[1] = *MEMORY[0x1E0CBA078];
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[24] = 16;
      ...
      v34 = 2112;
      v35 = v21;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@[%@] Responding to %{uuid_t}.16P with payload: %@", buf, 0x30u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[20] = &v39;
      v32 = 2112;
      v33 = v29;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Could not find action set UUIDs in message payload: %@", buf, 0x26u);
      ...
      for (i = 0; i != v34; ++i)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          ...
          v51 = 2112;
          v52 = v11;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Characteristic spiClientIdentifier: %{uuid_t}.16P, IID: %@, Type/Desc: %@/%@, value: %@, pendingWriteValue: %@", buf, 0x4Eu);
...
- (id)reachabilityByAccessorySPIClientIdentifierForCharacteristics:(id)a3
{
  ...
  v24 = a3;
  objc_msgSend(v24, "na_map:", &__block_literal_global_157_142382);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99E08], "dictionary");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v28 = 0u;
      ...
      do
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          ...
          v38 = 2112;
          v39 = v20;
          _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Accessory spiClientIdentifier %{uuid_t}.16P, Name: %@, isRemotelyReachable: %@", buf, 0x30u);
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v10, "isRemotelyReachable"));
        v21 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v10, "spiClientIdentifier");
        v22 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_61:
  ...
  v77 = 0u;
  v78 = 0u;
  objc_msgSend(v11, "arrayForKey:", *MEMORY[0x1E0CBA0C0]);
  obj = (id)objc_claimAutoreleasedReturnValue();
  ...
  if (v14)
  {
    v15 = v14;
    v16 = *(_QWORD *)v76;
    v17 = *MEMORY[0x1E0CBA0B8];
    v18 = *MEMORY[0x1E0CBA068];
    v19 = *MEMORY[0x1E0CBA088];
    v20 = *MEMORY[0x1E0CBA090];
    v68 = v11;
    v70 = v12;
    v71 = v13;
LABEL_6:
      ...
      if (v24)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          ...
          v83 = 2112;
          v84 = (uint64_t)v57;
          _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] request type is not set in payload: %@", buf, 0x26u);
...
LABEL_22:
      ...
      if (v23)
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        ...
        v61 = 48;
LABEL_55:
        _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_ERROR, v59, buf, v61);
      ...
      if (v28)
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          ...
          v83 = 2112;
          v84 = (uint64_t)v62;
          _os_log_impl(&dword_1CD062000, v49, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] characteristic write request missing UUID or write value: %@", buf, 0x26u);
        ...
        if (objc_msgSend(v20, "count"))
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)&buf[14] = 16;
            ...
            v109 = 2112;
            v110 = v20;
            _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Writing characteristics: %@", buf, 0x26u);
                        ...
                        if (v24)
                        {
                          ...
                          if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                          {
                            ...
                            *(_DWORD *)buf = 138544642;
                            ...
                            v70 = 2112;
                            v71 = obj;
                            _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Error deserializing NSError: %@, for accessoryUUID: %@, serviceID: %@, characteristicID: %@, in payload: %@", buf, 0x3Eu);
...
- (id)modifiedCharacteristicsFromNotification:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99E20], "setWithCapacity:", objc_msgSend(v7, "count") + objc_msgSend(v5, "count"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v16 = 2112;
      v17 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Characteristics changed notification does not include modified characteristics: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v22 = 2112;
      v23 = v14;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Notification %@ is not from an HMDAccessory object: %@", buf, 0x20u);
...
- (void)handleHomeSensingChangedNotification
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Handling home sensing changed notification. Refreshing timeline for configured widgets", (uint8_t *)&v8, 0xCu);
...
- (void)handleSelectedHomeChangedNotification
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Handling selected home changed notification. Refreshing timeline for configured widgets", (uint8_t *)&v8, 0xCu);
...
- (id)thresholdForCharacteristic:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v6, "isEqualToString:", *MEMORY[0x1E0D16278]) & 1) == 0)
  {
    objc_msgSend(v4, "type");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D16288]))
    {
    ...
    objc_msgSend(v4, "type");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = objc_msgSend(v13, "isEqualToString:", *MEMORY[0x1E0D161E8]);
...
LABEL_9:
    objc_msgSend(v3, "type");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D15F30]) & 1) != 0)
    {
      objc_msgSend(v4, "type");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      if ((objc_msgSend(v10, "isEqualToString:", *MEMORY[0x1E0D16278]) & 1) != 0)
      {
LABEL_13:
...
LABEL_14:
      ...
      objc_msgSend(v4, "type");
      v11 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v11, "isEqualToString:", *MEMORY[0x1E0D16288]))
      {
      ...
      objc_msgSend(v4, "type");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v16 = objc_msgSend(v15, "isEqualToString:", *MEMORY[0x1E0D161F0]);
    ...
    while (2)
    {
      for (i = 0; i != v22; ++i)
      {
        ...
        if (v6)
        {
          ...
          v13 = (void *)objc_claimAutoreleasedReturnValue();
          v14 = -[HMDWidgetTimelineRefresher _value:isApproximatelyEqualToValue:forMinimumValue:maximumValue:](self, "_value:isApproximatelyEqualToValue:forMinimumValue:maximumValue:", v8, v9, v11, v13);

          if (!v14
            || (objc_msgSend(v7, "accessory"),
                v15 = (void *)objc_claimAutoreleasedReturnValue(),
                v16 = objc_msgSend(v15, "isRemotelyReachable"),
                v15,
                (v16 & 1) == 0))
          {
    ...
    if ((v10 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        ...
        v24 = 2096;
        v25 = &v17;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Current home changed from %{uuid_t}.16P to %{uuid_t}.16P, resetting all characteristic notifications", buf, 0x2Cu);
...
- (void)handleHomeAddedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v13;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Home '%@' was added, resetting all characteristic notifications", (uint8_t *)&v14, 0x16u);
...
- (void)handleHomeRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v13;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Home '%@' was removed, resetting all characteristic notifications", (uint8_t *)&v14, 0x16u);
...
- (void)handleAccessoryAddedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v17;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Accessory '%@:%@' was added, resetting all characteristic notifications", (uint8_t *)&v18, 0x20u);
...
- (void)handleAccessoryRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v17;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Accessory '%@:%@' was removed, resetting all characteristic notifications", (uint8_t *)&v18, 0x20u);
...
- (void)handleResidentDeviceChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v29 = 2112;
    v30 = v23;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Resident has changed to %@ for home %@, resetting all characteristic notifications", buf, 0x20u);
...
- (void)handleResidentDeviceAddedOrRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v15;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Resident was added or removed for home %@, resetting all characteristic notifications", (uint8_t *)&v16, 0x16u);
...
- (void)handleNotificationOfPossibleNewWidget:(id)a3
{
  ...
  if ((v7 & 1) != 0)
  {
    if (v11)
    {
      ...
      v20 = 2112;
      v21 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Duplicate widget '%@' with payload '%@' ignored", (uint8_t *)&v16, 0x20u);
  ...
  else
  {
    if (v11)
    {
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@New widget '%@' has been spotted, with payload '%@'", (uint8_t *)&v16, 0x20u);
...
- (void)timerManager:(id)a3 didFireForTimerContext:(id)a4
{
  ...
  void *v17;
  void *v18;
  HMDWidgetTimelineRefresher *v19;
  NSObject *v20;
  void *v21;
  void *v22;
  int v23;
  ...
  if (v9 == v7)
  {
    v13 = (void *)MEMORY[0x1D17BA0A0](-[HMDWidgetTimelineRefresher setWidgetRefreshCoalesceTimerContext:](self, "setWidgetRefreshCoalesceTimerContext:", 0));
    v14 = self;
    HMFGetOSLogHandle();
    v15 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 138543362;
      v24 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Widget refresh coalescing timer fired.", (uint8_t *)&v23, 0xCu);

    }
    objc_autoreleasePoolPop(v13);
    -[HMDWidgetTimelineRefresher widgetRefreshCoalesceKinds](v14, "widgetRefreshCoalesceKinds");
    v12 = (id)objc_claimAutoreleasedReturnValue();
    -[HMDWidgetTimelineRefresher widgetRefreshCoalesceReason](v14, "widgetRefreshCoalesceReason");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (v12)
    {
      -[HMDWidgetTimelineRefresher handleTimerFiredForActionSet:](self, "handleTimerFiredForActionSet:", v12);
    }
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v22;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Timer manager fired with object that is unexpected: %@", (uint8_t *)&v23, 0x16u);
...
- (void)handleTimerFiredForActionSet:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Clearing cached error for action set: %@", buf, 0x16u);
...
LABEL_11:
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 2112;
        v30 = v15;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Coalescing and delaying widget refresh due to %@ for kinds: %@", (uint8_t *)&v25, 0x20u);
      ...
      if (!v18)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          v25 = 138543362;
          v26 = v22;
          _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Starting coalescing timer", (uint8_t *)&v25, 0xCu);
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v26 = 2112;
      v27 = v16;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Refreshing widget due to %@ for kinds: %@", buf, 0x20u);
    ...
    *(_QWORD *)&v3 = 138543874;
    ...
    do
    {
      for (i = 0; i != v4; ++i)
      {
        ...
        _os_log_impl(&dword_1CD062000, v15, v16, v17, buf, 0x20u);
  ...
  if (v4)
  {
    ...
    if ((_DWORD)v5)
    {
      ...
      if (v9)
        ...
        v10 = 1;
      v11 = objc_msgSend(v4, "isRemotelyReachable");
      if (v10 != v11)
      {
        v43 = v11;
        v44 = v9;
        ...
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v13, "fetchSpecificationsForWidgetKinds:", v14);
        v45 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        if (v17)
        {
          ...
          do
          {
            for (i = 0; i != v18; ++i)
            {
              ...
              if (v23)
              {
                objc_msgSend(*(id *)(v15 + 40), "widgetKindsToUpdateFromFetchSpecifications:assumingChangedCharacteristic:", v45, v21);
                v24 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v12, "unionSet:", v24);
        ...
        if (objc_msgSend(v12, "count"))
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v58 = 2112;
            v59 = v33;
            _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Accessory '%@:%@' reachability changed to %@.", buf, 0x2Au);
          ...
          v34 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(*(id *)(v27 + 40), "accessoryIsReachableByUUID");
          v35 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v4, "uuid");
          v36 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          if (v43)
          {
            v38 = dispatch_time(0, objc_msgSend(v37, "reachabilityUpdateDispatchDelayNs"));
            objc_msgSend(*(id *)(v27 + 40), "workQueue");
            v39 = objc_claimAutoreleasedReturnValue();
            block[0] = MEMORY[0x1E0C809B0];
            block[1] = 3221225472;
            block[2] = __77__HMDWidgetTimelineRefresher_handleAccessoryReachabilityChangedNotification___block_invoke_227;
            block[3] = &unk_1E89C2328;
            block[4] = *(_QWORD *)(v27 + 40);
            v47 = v12;
          ...
          {
            objc_msgSend(v37, "forceUpdateAutobahnTimelineHandler");
            v40 = (void (**)(_QWORD, _QWORD))objc_claimAutoreleasedReturnValue();
            ((void (**)(_QWORD, void *))v40)[2](v40, v12);
...
- (BOOL)homeHasAnyResident:(uint64_t)a1
{
  ...
  if (!a1)
    return 0;
  objc_msgSend(a2, "enabledResidents");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
void __77__HMDWidgetTimelineRefresher_handleAccessoryReachabilityChangedNotification___block_invoke_227(uint64_t a1)
{
  void (**v2)(id, _QWORD);
...
void __85__HMDWidgetTimelineRefresher_updateMonitoredCharacteristicsAndRefreshWidgetTimelines__block_invoke(uint64_t a1)
{
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Refreshing all Home widgets because of major changes / daemon restart", (uint8_t *)&v17, 0xCu);
...
void __76__HMDWidgetTimelineRefresher_refreshTimelineForConfiguredWidgetsWithReason___block_invoke_2(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    objc_msgSend(v2, "na_map:", &__block_literal_global_223_142310);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v13 = 2112;
      v14 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch configured widgets to refresh with error: %@", buf, 0x16u);
...
uint64_t __76__HMDWidgetTimelineRefresher_refreshTimelineForConfiguredWidgetsWithReason___block_invoke_222(uint64_t a1, void *a2)
{
...
void __92__HMDWidgetTimelineRefresher_handleNotifiedXPCClientsOfHomeConfigurationChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %{public}@. Generation counter: %lu. Refreshing timeline for configured widgets", (uint8_t *)&v8, 0x20u);
...
void __66__HMDWidgetTimelineRefresher_handleCurrentHomeChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&buf[14] = v6;
    ...
    v24 = 2096;
    v25 = &v15;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %{public}@. Previous: %{uuid_t}.16P, Current %{uuid_t}.16P. Refreshing timeline for configured widgets", buf, 0x36u);
...
void __83__HMDWidgetTimelineRefresher_handleAccessoryRemoteReachabilityChangedNotification___block_invoke(id *a1)
{
  ...
  if (objc_msgSend(v13, "count"))
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v13;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Handling reachability change for relevant widgets: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v14);
    v19[0] = v4;
    v19[1] = 3221225472;
    v19[2] = __83__HMDWidgetTimelineRefresher_handleAccessoryRemoteReachabilityChangedNotification___block_invoke_189;
    v19[3] = &unk_1E89B8CB8;
    v18 = a1[5];
    v20 = a1[4];
    v21 = v13;
...
void __83__HMDWidgetTimelineRefresher_handleAccessoryRemoteReachabilityChangedNotification___block_invoke_189(id *a1, void *a2)
{
  id v3;
  NSObject *v4;
  void *v5;
  ...
  v5 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(a1[5], "minusSet:", v3));
  v6 = a1[4];
  HMFGetOSLogHandle();
  v7 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[28] = 2112;
    *(_QWORD *)&buf[30] = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Refreshing timeline due to accessory (%{uuid_t}.16P) reachability change for configured widgets: %@", buf, 0x26u);

  }
  objc_autoreleasePoolPop(v5);
  objc_msgSend(a1[5], "na_map:", &__block_literal_global_191_142345);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v12, "count"))
  {
    v13 = (void *)MEMORY[0x1D17BA0A0]();
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      *(_QWORD *)&buf[24] = v19;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Handling %{public}@. Refreshing timeline for widget kinds: %@", buf, 0x20u);
      ...
      if (objc_msgSend(v35, "count"))
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v42 = 2112;
          v43 = v35;
          _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing old widgets and updating monitored characteristics and action sets: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = v29;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch configured widgets with error: %@", buf, 0x16u);
...
- (id)actionSetsMonitoredForWidgets
{
  ...
  objc_msgSend(v1, "na_flatMap:", &__block_literal_global_216);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)updateNotificationRegistrationWithPreviousCharacteristics:(void *)a3 currentCharacteristics:(uint64_t)a4 updateRequestQualityOfService:
{
  ...
  v7 = a3;
  v89 = v6;
  objc_msgSend(v6, "na_map:", &__block_literal_global_207);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v88 = v7;
  objc_msgSend(v7, "na_map:", &__block_literal_global_208_142335);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v89, "na_map:", &__block_literal_global_210_142326);
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v88, "na_map:", &__block_literal_global_210_142326);
  v27 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v28, "count"))
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v112 = 2112;
        v113 = v28;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Disabling notifications and removing cached value for characteristics: %@", buf, 0x16u);
    ...
    if (objc_msgSend(v29, "count"))
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v112 = 2112;
        v113 = v29;
        _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Enabling notifications and storing cached value for characteristics: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v112 = 2112;
        v113 = v56;
        _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_INFO, "%{public}@Reading characteristics: %@", buf, 0x16u);
          ...
          for (n = 0; n != v64; ++n)
          {
            ...
            if (v69)
            {
              ...
              if (v70)
                ...
                objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", v67);
      ...
      if (v74)
      {
        ...
        do
        {
          for (ii = 0; ii != v75; ++ii)
          {
            ...
            v80 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v80, "na_map:", &__block_literal_global_220_142330);
            v81 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v2, "objectForKey:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v6));
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        -[HMDWidgetTimelineRefresher characteristicsFromActionSets:](*(void **)(a1 + 32), v7);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "na_map:", &__block_literal_global_211);
        v9 = (void *)objc_claimAutoreleasedReturnValue();

        objc_msgSend(*(id *)(a1 + 40), "unionSet:", v9);
        ++v6;
      }
      while (v4 != v6);
...
{
  id v2;
  _TtC19HomeKitDaemonLegacy32HMDWidgetMonitoredCharacteristic *v3;

  v2 = a2;
  v3 = -[HMDWidgetMonitoredCharacteristic initWithCharacteristic:reachabilityMonitored:]([_TtC19HomeKitDaemonLegacy32HMDWidgetMonitoredCharacteristic alloc], "initWithCharacteristic:reachabilityMonitored:", v2, 0);
...
id __60__HMDWidgetTimelineRefresher_characteristicsFromActionSets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    v2 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v2, "na_map:", &__block_literal_global_214_142341);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
uint64_t __83__HMDWidgetTimelineRefresher_handleAccessoryRemoteReachabilityChangedNotification___block_invoke_190(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "kind");
}
...
void __58__HMDWidgetTimelineRefresher_relevantWidgetsForAccessory___block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v20 = objc_msgSend(v6, "countByEnumeratingWithState:objects:count:", &v25, v30, 16);
  if (v20)
  {
    v7 = *(_QWORD *)v26;
    v18 = *(_QWORD *)v26;
    ...
    do
    {
      for (i = 0; i != v20; ++i)
      {
        ...
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        -[HMDWidgetTimelineRefresher characteristicsFromActionSets:](*(void **)(a1 + 32), v9);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        v21 = 0u;
        v22 = 0u;
        v23 = 0u;
        ...
        if (v12)
        {
          ...
          while (2)
          {
            for (j = 0; j != v13; ++j)
            {
              if (*(_QWORD *)v22 != v14)
                objc_enumerationMutation(v11);
              objc_msgSend(*(id *)(*((_QWORD *)&v21 + 1) + 8 * j), "accessory");
              v16 = (void *)objc_claimAutoreleasedReturnValue();
              v17 = objc_msgSend(v16, "isEqual:", *(_QWORD *)(a1 + 40));
...
void __80__HMDWidgetTimelineRefresher_handleAccessoryCharacteristicsChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v18)
  {
    if (v22)
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v2;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Handling characteristic change for relevant widgets: %@", buf, 0x16u);
    ...
    v27[0] = v4;
    v27[1] = 3221225472;
    v27[2] = __80__HMDWidgetTimelineRefresher_handleAccessoryCharacteristicsChangedNotification___block_invoke_180;
    v27[3] = &unk_1E89B8C70;
    v27[4] = v24;
    v28 = v17;
    v29 = v2;
  ...
  else
  {
    if (v22)
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v26;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Not handling characteristics changed notification because it is not relevant for current widgets", buf, 0xCu);
...
void __80__HMDWidgetTimelineRefresher_handleAccessoryCharacteristicsChangedNotification___block_invoke_180(uint64_t a1, void *a2)
{
  id v3;
  NSObject *v4;
  void *v5;
  ...
  if (v12)
  {
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v31 = 2112;
      v32 = v5;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Handling %{public}@ and refreshing timeline. Updated characteristics: %@, for widgets: %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v13);
    objc_msgSend(v5, "na_map:", &__block_literal_global_185_142354);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v21;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@No widgets need to be refreshed from this characteristics changed notification: %@", buf, 0x16u);
...
uint64_t __80__HMDWidgetTimelineRefresher_handleAccessoryCharacteristicsChangedNotification___block_invoke_183(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "kind");
}
...
- (id)characteristicsForMonitoredCharacteristics:(void *)a1
{
  if (a1)
  {
    objc_msgSend(a2, "na_map:", &__block_literal_global_210_142326);
    a1 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return a1;
}
  ...
  if (v7)
  {
    ...
    while (2)
    {
      for (i = 0; i != v8; ++i)
      {
        if (*(_QWORD *)v15 != v9)
          objc_enumerationMutation(v6);
        objc_msgSend(v6, "objectForKey:", *(_QWORD *)(*((_QWORD *)&v14 + 1) + 8 * i), (_QWORD)v14);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        -[HMDWidgetTimelineRefresher characteristicsFromActionSets:](*(void **)(a1 + 32), v11);
        v12 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v12, "na_setByIntersectingWithSet:", *(_QWORD *)(a1 + 40));
        v13 = (void *)objc_claimAutoreleasedReturnValue();
        if (!objc_msgSend(v13, "count"))
        {
        ...
        objc_msgSend(*(id *)(a1 + 56), "unionSet:", v13);
  ...
  if (v11)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v39 = 2112;
      v40 = v23;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Failed to write characteristics: %@, with error: %@", buf, 0x30u);
  ...
  else
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v37 = 2112;
      v38 = v26;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Successfully wrote characteristics: %@", buf, 0x26u);
    ...
    if (v5)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v10 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(a1, "actionSetIsOn:", v9));
          v11 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        for (i = 0; i != v27; ++i)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)&buf[14] = 16;
            ...
            v43 = 2112;
            v44 = v11;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Action Set spiClientIdentifier: %{uuid_t}.16P, UUID: %{uuid_t}.16P, pendingState: %@, cachedState: %@", buf, 0x40u);
      ...
      do
      {
        ...
        do
        {
          ...
          if (v14)
          {
            ...
            v15 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v5, "setObject:forKeyedSubscript:", &unk_1E8B34488, v15);
  ...
  else
  {
    ...
    else if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v27 = 2112;
      v28 = v20;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Did not execute any request from payload: %@", buf, 0x26u);
  ...
  if (v3)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v29 = 2112;
      v30 = v3;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Failed to turn off action set: %@, with error: %@", buf, 0x30u);
  ...
  else
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v27 = 2112;
      v28 = v21;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Successfully turned off action set: %@", buf, 0x26u);
...
void __127__HMDWidgetTimelineRefresher_executeActionSetsToTurnOffWithSPIClientIdentifiers_widgetKind_message_completionGroup_completion___block_invoke_175(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  NSObject *v7;
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v29 = 2112;
      v30 = v17;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@[%{uuid_t}.16P] Failed to execute action set: %@, with error: %@", buf, 0x30u);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      v27 = 2112;
      v28 = v20;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[%{uuid_t}.16P] Successfully executed action set: %@", buf, 0x26u);
...
_TtC19HomeKitDaemonLegacy32HMDWidgetMonitoredCharacteristic *__68__HMDWidgetTimelineRefresher_handleMonitorCharacteristicsForWidget___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = a2;
  v4 = -[HMDWidgetMonitoredCharacteristic initWithCharacteristic:reachabilityMonitored:]([_TtC19HomeKitDaemonLegacy32HMDWidgetMonitoredCharacteristic alloc], "initWithCharacteristic:reachabilityMonitored:", v3, objc_msgSend(*(id *)(a1 + 32), "BOOLValue"));
...
void __64__HMDWidgetTimelineRefresher_forceUpdateTimelineForWidgetKinds___block_invoke(uint64_t a1)
{
  ...
  if ((v2 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      objc_msgSend(v12, "allObjects");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v13, "sortedArrayUsingComparator:", &__block_literal_global_142446);
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v14, "componentsJoinedByString:", CFSTR(", "));
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@More kinds to reload: %@", buf, 0x16u);
    ...
    if (!v5)
    {
      ...
      block[0] = MEMORY[0x1E0C809B0];
      block[1] = 3221225472;
      block[2] = __64__HMDWidgetTimelineRefresher_forceUpdateTimelineForWidgetKinds___block_invoke_142;
      block[3] = &unk_1E89C2730;
...
void __64__HMDWidgetTimelineRefresher_forceUpdateTimelineForWidgetKinds___block_invoke_142(uint64_t a1)
{
  uint64_t v1;
  uint64_t v2;
  uint64_t v3;
  ...
  if (v2)
  {
    ...
    do
    {
      for (i = 0; i != v3; ++i)
      {
        ...
        v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D10110]), "initWithExtensionBundleIdentifier:kind:", CFSTR("com.apple.Home.HomeWidget"), v6);
        ...
        _os_log_impl(&dword_1CD062000, v14, v15, v16, buf, v17);
...
void __72__HMDWidgetTimelineRefresher_processCharacteristicsChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Processing characteristics changed notification", (uint8_t *)&v9, 0xCu);
...
void __60__HMDWidgetTimelineRefresher_registerForDarwinNotifications__block_invoke_132(uint64_t a1)
{
  id WeakRetained;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t135 != -1)
    dispatch_once(&logCategory__hmf_once_t135, &__block_literal_global_231_142516);
  return (id)logCategory__hmf_once_v136;
}
...
void __41__HMDWidgetTimelineRefresher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v136;
  logCategory__hmf_once_v136 = v0;
