...
- (CLLocation)bestLocation
{
  ...
  if (v4)
  {
    ...
    if (v6 > 0xA)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 2112;
        v30 = v14;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Number of locations is %lu so using k-means-clustered location for best location: %@", (uint8_t *)&v25, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Number of locations is only %lu so sorting and using most accurate location for best location", (uint8_t *)&v25, 0x16u);

      }
      objc_autoreleasePoolPop(v7);
      -[HMDLocationCluster locations](v8, "locations");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v12, "sortedArrayUsingComparator:", &__block_literal_global_158592);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 138543362;
      v26 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Number of locations is 0 so returning nil for best location", (uint8_t *)&v25, 0xCu);
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        v24 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C9E3B8]), "initWithLatitude:longitude:", v21, v23);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_158599 != -1)
    dispatch_once(&logCategory__hmf_once_t3_158599, &__block_literal_global_5_158600);
  return (id)logCategory__hmf_once_v4_158601;
}
...
void __33__HMDLocationCluster_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_158601;
  logCategory__hmf_once_v4_158601 = v0;
