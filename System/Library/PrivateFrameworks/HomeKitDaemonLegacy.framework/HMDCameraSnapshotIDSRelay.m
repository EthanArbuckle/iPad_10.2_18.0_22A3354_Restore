...
- (HMDCameraSnapshotIDSRelay)initWithSessionID:(id)a3 logIdentifier:(id)a4 workQueue:(id)a5
{
  ...
  if (v12)
  {
    ...
    v17 = objc_msgSend(objc_alloc(MEMORY[0x1E0D28628]), "initWithName:", CFSTR("com.apple.homed.snapshot-relay"));
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the SnapshotIDSRelay", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_110537 != -1)
    dispatch_once(&logCategory__hmf_once_t0_110537, &__block_literal_global_110538);
  return (id)logCategory__hmf_once_v1_110539;
}
...
void __40__HMDCameraSnapshotIDSRelay_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_110539;
  logCategory__hmf_once_v1_110539 = v0;
