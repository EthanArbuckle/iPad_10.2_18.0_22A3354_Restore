    ...
    if (v10 == 4)
    {
      ...
      if (os_log_type_enabled(v103, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v115 = 2112;
        v116 = v6;
        _os_log_impl(&dword_1CD062000, v103, OS_LOG_TYPE_INFO, "%{public}@Adding missing selection constraints %@ to setting %@", buf, 0x20u);
      ...
      if ((v17 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v117 = 2112;
          v118 = v6;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Min constraint %@ does not match %@ for %@ changing", buf, 0x2Au);
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v14, "type"));
        v26 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if ((v40 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v117 = 2112;
          v118 = v6;
          _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Max constraint %@ does not match %@ for %@ changing", buf, 0x2Au);
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v37, "type"));
      ...
      if ((v63 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v117 = 2112;
          v118 = v6;
          _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_INFO, "%{public}@Step constraint %@ does not match %@ for %@ changing", buf, 0x2Au);
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v60, "type"));
...
+ (id)modelForSetting:(id)a3 identifier:(id)a4 parentIdentifier:(id)a5
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v9, "properties"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)modelsForChangedConstraints:(id)a3 fromSetting:(id)a4
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 138543362;
    v20 = v17;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Constraints are not matching with media system", (uint8_t *)&v19, 0xCu);
  ...
  if (!objc_msgSend(v5, "type"))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown type, attempting to resolve", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v7);
    objc_msgSend(v6, "homeManager");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "cloudDataSyncManager");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (!v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v25 = v17;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot resolve, no cloud cache", buf, 0xCu);
    ...
    objc_msgSend(v13, "homeZoneWithName:owner:completion:", v19, v20, v21);
...
+ (id)mergeWithGroupMetadata:(id)a3 group:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v127 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Merging with metadata", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v128 = 2112;
            v129 = v25;
            _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Removing setting: %@", buf, 0x16u);
      ...
      for (k = 0; k != v39; ++k)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v128 = 2112;
          v129 = v42;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Adding setting: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v71, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v128 = 2112;
            v129 = v64;
            _os_log_impl(&dword_1CD062000, v71, OS_LOG_TYPE_DEFAULT, "%{public}@Removing group: %@", buf, 0x16u);
      ...
      for (ii = 0; ii != v81; ++ii)
      {
        ...
        if (os_log_type_enabled(v87, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v128 = 2112;
          v129 = v84;
          _os_log_impl(&dword_1CD062000, v87, OS_LOG_TYPE_DEFAULT, "%{public}@Adding group: %@", buf, 0x16u);
...
void __64__HMDAccessorySettingTransform_changeAccessorySettingType_home___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v5, "cloudRecordWithObjectID:completionHandler:", v7, v12);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot get home zone with error: %@", buf, 0x16u);
      ...
      if (v10)
      {
        ...
        if (v12)
        {
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            v33 = 2112;
            v34 = v18;
            _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating type to '%@'", (uint8_t *)&v31, 0x16u);

          }
          objc_autoreleasePoolPop(v13);
          objc_msgSend(*(id *)(a1 + 32), "_setType:", v12);
          WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
          v20 = -[HMDHomeSaveRequest initWithReason:information:saveOptions:]([HMDHomeSaveRequest alloc], "initWithReason:information:saveOptions:", CFSTR("Updating setting type"), 0, 0);
          objc_msgSend(WeakRetained, "homeManager");
          v21 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v21, "saveWithRequest:", v20);
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          v31 = 138543362;
          v32 = v30;
          _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Cached type is invalid", (uint8_t *)&v31, 0xCu);
...
LABEL_18:
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, v29, (uint8_t *)&v31, 0x16u);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v33 = 2112;
    v34 = v6;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@No cached record found with error: %@", (uint8_t *)&v31, 0x16u);
