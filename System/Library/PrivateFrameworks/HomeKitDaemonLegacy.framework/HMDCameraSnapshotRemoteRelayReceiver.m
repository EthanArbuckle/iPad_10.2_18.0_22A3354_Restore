...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteRelayReceiver", buf, 0xCu);
...
- (void)_getSnapshot:(unint64_t)a3
{
  ...
  v26 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("Snapshot Relay Receiver"));
...
- (void)_callDidSaveImageDelegateWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v24 = 2112;
    v25 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that download of image %@ has completed with error %@ for session %@", buf, 0x2Au);
...
- (void)relayReceiver:(id)a3 didReceiveData:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v10;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Image receive has completed with error: %@", (uint8_t *)&v20, 0x16u);
  ...
  -[HMDCameraSnapshotReceiver _sendConfirmationToResident:](v13, "_sendConfirmationToResident:", &__block_literal_global_36_101844);
  ...
  if (WeakRetained)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v15 = 2112;
        v16 = v5;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Take snapshot relayed to resident has failed: %@", (uint8_t *)&v13, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_101886 != -1)
    dispatch_once(&logCategory__hmf_once_t1_101886, &__block_literal_global_101887);
  return (id)logCategory__hmf_once_v2_101888;
}
...
void __51__HMDCameraSnapshotRemoteRelayReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_101888;
  logCategory__hmf_once_v2_101888 = v0;
