...
- (HMDCharacteristicMetadata)initWithMinimumValue:(id)a3 maximumValue:(id)a4 stepValue:(id)a5 maxLength:(id)a6 validValues:(id)a7 format:(id)a8 units:(id)a9 manufacturerDescription:(id)a10
{
  ...
  if (v21)
  {
    ...
    objc_msgSend(MEMORY[0x1E0D28630], "hmf_cachedInstanceForString:", v18, v30, v31, v32, v33);
    v23 = objc_claimAutoreleasedReturnValue();
    format = v22->_format;
    v22->_format = (NSString *)v23;

    objc_msgSend(MEMORY[0x1E0D28630], "hmf_cachedInstanceForString:", v19);
    v25 = objc_claimAutoreleasedReturnValue();
    units = v22->_units;
    v22->_units = (NSString *)v25;

    objc_msgSend(MEMORY[0x1E0D28630], "hmf_cachedInstanceForString:", v20);
...
- (id)_descriptionDetails
{
  ...
  if (v33)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Valid Values: "));
    ...
    if (v36)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@, "), *(_QWORD *)(*((_QWORD *)&v43 + 1) + 8 * v39));
