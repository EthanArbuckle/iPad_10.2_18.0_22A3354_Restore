  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing required parameter 'identifier'", buf, 0xCu);
...
+ (NSUUID)identifierNamespace
{
  if (identifierNamespace_onceToken != -1)
    dispatch_once(&identifierNamespace_onceToken, &__block_literal_global_25111);
