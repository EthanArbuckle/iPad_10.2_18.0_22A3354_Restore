...
- (void)main
{
  ...
  if (!v20)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 8, CFSTR("No command or queue in SendCommandOperation"));
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
void __72__HMDMPCSendMRCommandOperation_sendPlaybackArchive_destination_options___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[HMDMPCSendMRCommandOperation] %s", (uint8_t *)&v11, 0x16u);
...
- (void)generateMPCErrorOrFinishWithError:(void *)a3 statuses:
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v43 = 2112;
    v44 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDMPCSendMRCommandOperation] error %@ statuses %@", buf, 0x20u);
...
LABEL_16:
    if ((v13 & objc_msgSend(v6, "containsObject:", &unk_1E8B34F08) & 1) != 0)
    {
      v5 = 0;
      goto LABEL_18;
    }
    if ((objc_msgSend(v6, "containsObject:", &unk_1E8B34F20) & 1) != 0)
    {
      v5 = 0;
LABEL_24:
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("statuses %@"), v6);
  ...
  if (objc_msgSend(v30, "isEqualToString:", *MEMORY[0x1E0D4B2C0]))
    v31 = objc_msgSend(v5, "code") == 1 || objc_msgSend(v5, "code") == 18;
  else
    v31 = 0;

  if ((v13 & (objc_msgSend(v6, "containsObject:", &unk_1E8B34F08) | v31)) == 1)
  {
LABEL_18:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = v5;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDMPCSendMRCommandOperation] discarding pause media remote error and assuming success as there is no now playing application (%@)", buf, 0x16u);
  ...
  v5 = v29;
LABEL_32:
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 74, CFSTR("Media remote MPC command failure"), CFSTR("Media remote MPC command failure"), 0, v29);
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v43 = 2112;
    v44 = v29;
    _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@[HMDMPCSendMRCommandOperation] Cancel with error %@, underlying error: %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_156649 != -1)
    dispatch_once(&logCategory__hmf_once_t7_156649, &__block_literal_global_156650);
  return (id)logCategory__hmf_once_v8_156651;
}
...
void __43__HMDMPCSendMRCommandOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_156651;
  logCategory__hmf_once_v8_156651 = v0;
