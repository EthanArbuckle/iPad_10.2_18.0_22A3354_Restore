...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x1E0D16400], "wrappertlv:name:objectCreator:", 1, CFSTR("kSupportedVideoConfigurationCodecConfigurations"), &__block_literal_global_261_132172);
