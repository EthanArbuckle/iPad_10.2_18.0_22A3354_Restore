...
LABEL_41:
                ...
                if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v143 = 2112;
                  v144 = v9;
                  _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@", buf, 0x20u);
...
LABEL_54:
                  ...
                  if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    v145 = 2112;
                    v146 = v115;
                    _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@, serviceInstanceID %@", buf, 0x2Au);
...
LABEL_47:
                  ...
                  if (v113)
                  {
                    ...
                    if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138544642;
                      ...
                      v149 = 2112;
                      v150 = v113;
                      _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_INFO, "%{public}@Setting the responseDelay for characteristic (%@+%@/%@/%@) to %@", buf, 0x3Eu);
                    ...
                    if (v73)
                    {
                      ...
                      if (os_log_type_enabled(v76, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138544642;
                        ...
                        v149 = 2112;
                        v150 = (uint64_t)v78;
                        _os_log_impl(&dword_1CD062000, v76, OS_LOG_TYPE_INFO, "%{public}@Getting the value for characteristic responseDelay (%@+%@/%@/%@): %@ ", buf, 0x3Eu);
                  ...
                  v99 = v62;
                  v79 = (void *)MEMORY[0x1D17BA0A0](v66);
                  HMFGetOSLogHandle();
                  ...
                  if (v110)
                  {
                    ...
                    if (v81)
                    {
                      ...
                      *(_DWORD *)buf = 138544898;
                      ...
                      v151 = 2112;
                      v152 = v83;
                      _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_INFO, "%{public}@Setting the value for characteristic (%@+%@/%@/%@) to %@ with responseDelay %@ milliseconds", buf, 0x48u);
                  ...
                  else
                  {
                    ...
                    if (v81)
                    {
                      ...
                      *(_DWORD *)buf = 138544642;
                      ...
                      v149 = 2112;
                      v150 = 0;
                      _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_INFO, "%{public}@Getting the value for characteristic (%@+%@/%@/%@): %@ ", buf, 0x3Eu);
                  ...
                  if (v105)
                  {
                    v88 = (void *)MEMORY[0x1D17BA0A0](v84);
                    HMFGetOSLogHandle();
                    ...
                    if (os_log_type_enabled(v89, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138544898;
                      ...
                      v151 = 2112;
                      v152 = v91;
                      _os_log_impl(&dword_1CD062000, v89, OS_LOG_TYPE_INFO, "%{public}@Triggering update notification for characteristic (%@+%@/%@/%@) with value %@, responseDelay %@ milliseconds", buf, 0x48u);
...
LABEL_67:
                  ...
                  if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544386;
                    ...
                    v147 = 2112;
                    v148 = v114;
                    _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@, serviceInstanceID %@, characteristicInstanceID %@", buf, 0x34u);
...
LABEL_26:
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v141 = 2112;
          v142 = v8;
          _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessoryServer with deviceIdentifier %@", buf, 0x16u);
    ...
    *(_QWORD *)&v3 = 138543874;
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if (!v60)
        {
          v40 = (void *)MEMORY[0x1D17BA0A0](v10);
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v67 = 2112;
            v68 = v7;
            _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@No reachability setting for the setReachability request: %@", buf, 0x16u);
          ...
          if (v21)
          {
            if (v35)
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v71 = 2112;
              v72 = v37;
              _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Setting the reachability of accessory %@+%@ to %@", buf, 0x2Au);
          ...
          else
          {
            if (v35)
            {
              ...
              *(_DWORD *)buf = v44;
              ...
              v69 = 2112;
              v70 = v9;
              _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@", buf, 0x20u);
...
void __52__HMDAccessoryServerBrowserDemo_resetDemoAccessory___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@[CoreHAP] Discovered new accessory server %@ with Demo info", buf, 0x16u);
...
void __48__HMDAccessoryServerBrowserDemo_appendDemoData___block_invoke(uint64_t a1)
{
  ...
  {
    v12 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v4, "addObjectsFromArray:", v5));
    v13 = WeakRetained;
    v14 = WeakRetained;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v36 = 2112;
      v37 = v4;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Updated demo accessory list: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@No new accessories (but kicking re-discovery anyway).", buf, 0xCu);
...
void __48__HMDAccessoryServerBrowserDemo_appendDemoData___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if ((objc_msgSend(v4, "na_any:", v7) & 1) == 0)
  {
    ...
    objc_msgSend(v5, "setObject:forKey:", MEMORY[0x1E0C9AAB0], CFSTR("testMode"));
          ...
          for (i = 0; i != v41; ++i)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v54 = 2112;
              v55 = v11;
              _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Processing Demo Accessory information: %@ / %@", buf, 0x20u);
                ...
                if (v24)
                {
                  ...
                  if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    v54 = 2112;
                    v55 = v23;
                    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Server already exists for Demo Accessory: %@ / %@ - leaving it in place", buf, 0x20u);
...
void __64__HMDAccessoryServerBrowserDemo_stopDiscoveringAccessoryServers__block_invoke(uint64_t a1)
{
  ...
  *(_BYTE *)(*(_QWORD *)(a1 + 32) + 61) = 0;
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v4 = 138543362;
    v5 = v3;
    _os_log_impl(&dword_1CD062000, v2, OS_LOG_TYPE_INFO, "%{public}@[Demo Accessory Browser] Stopping browse for Demo accessories", (uint8_t *)&v4, 0xCu);
...
uint64_t __65__HMDAccessoryServerBrowserDemo_startDiscoveringAccessoryServers__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v4;
    _os_log_impl(&dword_1CD062000, v3, OS_LOG_TYPE_INFO, "%{public}@[Demo Accessory Browser] Starting browse for Demo accessories...", buf, 0xCu);
