  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDFairPlaySAPSession] Invalid parameter", buf, 0xCu);
...
- (void)_setupSAPSessionWithCompletionQueue:(id)a3 completionHandler:(id)a4
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("The FairPlay session delegate is missing"), 0, 0);
...
void __86__HMDFairPlaySAPSession_verifySignedData_signature_completionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    if (objc_msgSend(*(id *)(a1 + 48), "state") == 2)
    {
      ...
      if ((_DWORD)v4)
      {
        objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Failed to verified signed data with error: %d"), v4);
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v33 = 2112;
          v34 = v5;
          _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);
...
LABEL_23:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] FairPlay session is not open", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] invalid parameter", buf, 0xCu);
...
void __86__HMDFairPlaySAPSession_verifySignedData_signature_completionQueue_completionHandler___block_invoke_35(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 27, CFSTR("invalid parameter"), 0, 0);
...
void __86__HMDFairPlaySAPSession_verifySignedData_signature_completionQueue_completionHandler___block_invoke_36(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 21, CFSTR("FairPlay session is not open"), 0, 0);
  v2 = (id)objc_claimAutoreleasedReturnValue();
  (*(void (**)(void))(*(_QWORD *)(a1 + 32) + 16))();
...
void __86__HMDFairPlaySAPSession_verifySignedData_signature_completionQueue_completionHandler___block_invoke_39(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 52, *(_QWORD *)(a1 + 32), 0, 0);
  v2 = (id)objc_claimAutoreleasedReturnValue();
...
void __76__HMDFairPlaySAPSession_signatureForData_completionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] invalid parameter", buf, 0xCu);
...
LABEL_27:
  ...
  if (objc_msgSend(*(id *)(a1 + 48), "state") != 2)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] FairPlay session is not open", buf, 0xCu);
  ...
  if (v3 || v32 == 0)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Failed to sign data with error: %d"), v32, v2);
    v5 = (id)objc_claimAutoreleasedReturnValue();
    v6 = (void *)MEMORY[0x1D17BA0A0]();
    HMFGetOSLogHandle();
    v7 = objc_claimAutoreleasedReturnValue();
...
void __94__HMDFairPlaySAPSession__handleServerSAPExchangeData_error_completionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  {
    if ((_DWORD)v5)
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Failed to complete SAP Setup Exchange with error: %d"), v5);
    else
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unexpected return code '%d' after getting exchange data"), v26);
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v9;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v10);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 52, v9, 0, 0);
...
void __90__HMDFairPlaySAPSession__handleServerCertificate_error_completionQueue_completionHandler___block_invoke(id *a1)
{
  ...
  {
    if (v8)
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Failed to get exchange data with error: %d"), v5);
    else
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unexpected return code '%d' after getting exchange data"), v36);
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v39 = 2112;
      v40 = v9;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);
...
void __67__HMDFairPlaySAPSession_openWithCompletionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (v2 == 3)
      v3 = CFSTR("Closed");
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Cannot open a FairPlay session in state '%@'"), v3);
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v4;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);
...
LABEL_18:
  ...
  if ((_DWORD)v9)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Failed to create fairplay session with error: %d"), v9);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = (void *)MEMORY[0x1D17BA0A0]();
    HMFGetOSLogHandle();
    v11 = objc_claimAutoreleasedReturnValue();
    ...
    objc_autoreleasePoolPop(v10);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 52, v4, 0, 0);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    v14 = *(NSObject **)(a1 + 40);
    if (v14)
    {
