...
- (void)registerForMessage:(id)a3 policies:(id)a4
{
  ...
  if (a3)
  {
    ...
    {
      v6 = a3;
      objc_msgSend(a4, "hmf_objectsPassingTest:", &__block_literal_global_113);
...
- (void)__handleXPCMessage:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Locally dispatching message: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13_162021 != -1)
    dispatch_once(&logCategory__hmf_once_t13_162021, &__block_literal_global_117_162022);
  return (id)logCategory__hmf_once_v14_162023;
}
