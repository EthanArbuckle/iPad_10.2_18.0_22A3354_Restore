...
- (void)configureWithHome:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v12;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Mapped profile UUIDs %@ to profiles %@", (uint8_t *)&v13, 0x20u);
...
- (id)dictionaryRepresentation
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDMediaPlaybackAction state](self, "state"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v5, *MEMORY[0x1E0CB94F8]);

  -[HMDMediaPlaybackAction volume](self, "volume");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v6, *MEMORY[0x1E0CB9508]);
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v9, *MEMORY[0x1E0CB94E8]);
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      objc_msgSend(v4, "setObject:forKeyedSubscript:", v13, *MEMORY[0x1E0CB94D8]);
    }
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v14;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Couldn't encode playbackArchive: %@", buf, 0x16u);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Executing media playback action", buf, 0xCu);
...
- (id)validate
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid configuration for media playback action - state: %tu  volume: %@  #Profiles: %tu", (uint8_t *)&v15, 0x2Au);

  }
  objc_autoreleasePoolPop(v8);
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Invalid configuration for media playback action"), 0, 0);
...
- (HMDMediaPlaybackActionAsCharacteristicWriteRequests)convertedCharacteristicWriteRequests
{
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithCapacity:", 2 * objc_msgSend(v6, "count"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v37 = 0u;
    v38 = 0u;
    v39 = 0u;
...
- (NSString)description
{
  ...
  -[HMDMediaPlaybackAction mediaProfiles](self, "mediaProfiles");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "na_map:", &__block_literal_global_169435);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)associatedAccessories
{
  ...
  objc_msgSend(v2, "na_map:", &__block_literal_global_32_169433);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_processPlaybackActionModelUpdated:(id)a3 message:(id)a4
{
  ...
  if (v25 && v26)
  {
    ...
    v25 = (void *)v34;
LABEL_17:
    v40 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v7, "respondWithPayload:", v25));
    v41 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v50 = 2112;
      v51 = v25;
      _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_DEBUG, "%{public}@Responding to client after updating action with response: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v54 = 2112;
    v55 = v27;
    _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Playback action Model object (%@) missing actionset %@ or home %@ ", buf, 0x2Au);
...
- (HMDMediaPlaybackAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB94F0]);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    v24 = objc_msgSend(v25, "integerValue");
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9500]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB94D0]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode base class: %@", buf, 0x16u);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDMediaPlaybackAction state](self, "state"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x1E0CB94F0]);

  -[HMDMediaPlaybackAction volume](self, "volume");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB9500]);

  -[HMDMediaPlaybackAction playbackArchive](self, "playbackArchive");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, *MEMORY[0x1E0CB94D0]);

  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    -[HMDMediaPlaybackAction mediaProfiles](self, "mediaProfiles");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "encodeObject:forKey:", v8, *MEMORY[0x1E0CB94E0]);
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v33 = 2112;
      v34 = v17;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@XPC Encoded Playback action uuid %@ state %tu profiles %@ playbackArchive %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v31 = 2112;
      v32 = v23;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Cloud Encoded Playback action uuid %@ state %tu profiles %@", buf, 0x2Au);
        ...
        if (v20 != v22)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v52 = 2112;
            v53 = v27;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Couldn't find all media profiles on the home, found: %@ from UUIDs: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v50 = 2112;
          v51 = v39;
          _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find any media profiles in the home for the UUIDs: %@", buf, 0x16u);
      ...
      if (v15 != v17)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v48 = 2112;
          v49 = v22;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Couldn't find all media profiles on the home, found: %@ from UUIDs: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2112;
        v47 = v39;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find any media profiles in the home for the UUIDs: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v8;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Invalid action type: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_169467 != -1)
    dispatch_once(&logCategory__hmf_once_t24_169467, &__block_literal_global_52_169468);
  return (id)logCategory__hmf_once_v25_169469;
}
...
void __37__HMDMediaPlaybackAction_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_169469;
  logCategory__hmf_once_v25_169469 = v0;
