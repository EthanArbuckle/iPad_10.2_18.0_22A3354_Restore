  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v6;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Network declaration must contain firmware version: %@", buf, 0x16u);
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDNetworkRouterFirewallRuleConfiguration hasFullAccessToLAN](self, "hasFullAccessToLAN"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v6, "initWithName:value:", CFSTR("FullAccessLAN"), v7);
  v23[2] = v8;
  v9 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDNetworkRouterFirewallRuleConfiguration hasFullAccessToWAN](self, "hasFullAccessToWAN"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)prettyJSONDictionary
{
  ...
  -[HMDNetworkRouterFirewallRuleConfiguration lanRules](self, "lanRules");
  v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v20, "na_map:", &__block_literal_global_37_175389);
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDNetworkRouterFirewallRuleConfiguration hasFullAccessToLAN](self, "hasFullAccessToLAN", v5));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v24[2] = v7;
  v23[3] = CFSTR("wanRules");
  -[HMDNetworkRouterFirewallRuleConfiguration wanRules](self, "wanRules");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "na_map:", &__block_literal_global_44_175394);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_175453 != -1)
    dispatch_once(&logCategory__hmf_once_t0_175453, &__block_literal_global_175454);
  return (id)logCategory__hmf_once_v1_175455;
}
...
LABEL_11:
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v21, 0x20u);
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v25 = 2112;
      v26 = v8;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains an invalid '%@' value: %@", buf, 0x20u);
            ...
            if (!v25)
            {
              ...
              if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v60 = 2112;
                v61 = v49;
                _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains an invalid rule in '%@' value: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v60 = 2112;
        v61 = v10;
        _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains an invalid '%@' value: %@", buf, 0x20u);
  ...
  else if (v6)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v60 = 2112;
      v61 = v10;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains no '%@' value: %@", buf, 0x20u);
...
void __56__HMDNetworkRouterFirewallRuleConfiguration_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_175455;
  logCategory__hmf_once_v1_175455 = v0;
