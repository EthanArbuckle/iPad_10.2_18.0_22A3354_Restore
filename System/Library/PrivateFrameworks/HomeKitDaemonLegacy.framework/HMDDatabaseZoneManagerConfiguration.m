...
- (HMDDatabaseZoneManagerConfiguration)init
{
  ...
  if (v2)
  {
    ...
    v10 = (HMBCloudZoneConfiguration *)objc_alloc_init(MEMORY[0x1E0D32C38]);
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDDatabaseZoneManagerConfiguration isZoneOwner](self, "isZoneOwner"));
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  v23 = (void *)objc_msgSend(v3, "initWithName:value:", CFSTR("Zone Owner"), v24);
  v25[0] = v23;
  v4 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDDatabaseZoneManagerConfiguration shouldCreateZone](self, "shouldCreateZone"));
