    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v11 = v8;
        _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing timer as there are no more pending requests", buf, 0xCu);
...
- (void)_addRequestToPending:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Adding request to pending %@", (uint8_t *)&v11, 0x16u);
        ...
        if (v16 < v14)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v27;
            ...
            v34 = 2112;
            v35 = v11;
            _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Timing out pending request %@", buf, 0x16u);
          ...
          if (v23)
          {
            ...
            objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 8, CFSTR("No process received pending request in time"), CFSTR("No process received share message in required time."), 0);
        ...
        if (v17)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v44 = 2112;
            v45 = v15;
            _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Resuming request %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = v32;
              v43 = v30;
              _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not determine request type.", buf, 0xCu);
...
- (void)_sendRepairRequest:(id)a3 toConnection:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v7;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Sending repair request %@ to client %@", (uint8_t *)&v17, 0x20u);
...
- (void)_handleShareForRemoteClientRequest:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No process registered to handle container %@", (uint8_t *)&v15, 0x16u);
...
- (void)handleShareForRemoteClientRequest:(id)a3 home:(id)a4 completionHandler:(id)a5
{
  ...
  if (v10)
  {
    v12 = v11;
    v73 = self;
    objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0CBA008]);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0)
      v14 = v13;
    ...
    if ((_DWORD)v15)
    {
      objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0CBA000]);
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      __findUserWithUUID(v18, v12);
      v19 = (id)objc_claimAutoreleasedReturnValue();

      objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0CBA038]);
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      __findUserWithUUID(v20, v12);
      v21 = (id)objc_claimAutoreleasedReturnValue();

      objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0CBA048]);
      ...
      objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0CBA040]);
      v25 = (void *)objc_claimAutoreleasedReturnValue();
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
        v26 = v25;
      ...
      objc_msgSend(v10, "objectForKeyedSubscript:", *MEMORY[0x1E0CB9FF8]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v83 = v41;
          _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode all required items from payload.", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v39);
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Could not decode payload"), CFSTR("Unable to decode all required items"), 0);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v83 = v37;
        _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_ERROR, "%{public}@Messaged home had different identifier from payload.", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v35);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Inconsistent payload home and originating home"), CFSTR("Messaged home must match home in payload"), 0);
      v31 = objc_claimAutoreleasedReturnValue();
      v19 = 0;
      v21 = 0;
      v24 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v34;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Could not decode Remote ClientRequestPayload.", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v32);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Could not decode payload"), CFSTR("Need a valid payload"), 0);
    v31 = objc_claimAutoreleasedReturnValue();
    v19 = 0;
    v21 = 0;
    v24 = 0;
  ...
  if (v31)
  {
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v52;
      _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Could not decode payload.", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_signpost_enabled(logger))
    {
      *(_DWORD *)buf = 138412290;
      v83 = v47;
      _os_signpost_emit_with_name_impl(&dword_1CD062000, logger, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "MultiUser.Share.Req", "container=%{signpost.description:attribute}@ ", buf, 0xCu);
    }
    aBlock[0] = MEMORY[0x1E0C809B0];
    aBlock[1] = 3221225472;
    aBlock[2] = __88__HMDUserCloudShareController_handleShareForRemoteClientRequest_home_completionHandler___block_invoke;
    aBlock[3] = &unk_1E89B0A40;
    aBlock[4] = self;
...
- (void)handleShareRepairForRemoteClientRequest:(id)a3 home:(id)a4 completion:(id)a5
{
  ...
  objc_msgSend(v8, "objectForKeyedSubscript:", *MEMORY[0x1E0CB9FF8]);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
    v13 = v12;
  ...
  objc_msgSend(v8, "objectForKeyedSubscript:", *MEMORY[0x1E0CBA028]);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
    v16 = v15;
  ...
  v36 = 0;
  objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v17, &v36);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v35 = v36;
  if (v14)
    v19 = v18 == 0;
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing required items in payload", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v20);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Could not decode payload"), CFSTR("Unable to find required items in payload"), 0);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v41 = 2112;
        v42 = v14;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Add repair request %@ to pending for %@", buf, 0x20u);
...
- (void)_registerWithXpcClient:(id)a3 containerIDs:(id)a4
{
          ...
          if (v15 && (objc_msgSend(v15, "isEqual:", v38) & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v52 = 2112;
              v53 = v13;
              _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Another connection with identifier: %@ is registered for the same container: %@.", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v52 = 2112;
              v53 = v13;
              _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Registering connection identifier: %@ for container: %@.", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v34;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Cannot register a client without a valid connection identifier.", buf, 0xCu);
        ...
        if (objc_msgSend(v16, "isEqualToString:", v6))
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v37 = 2112;
            v38 = v14;
            _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Deregistering connection %@ from container %@.", buf, 0x20u);
...
- (void)_invalidateXpcClient:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Found invalidated connection %@ will de-register.", (uint8_t *)&v12, 0x16u);
...
void __88__HMDUserCloudShareController_handleShareForRemoteClientRequest_home_completionHandler___block_invoke(_QWORD *a1, void *a2, void *a3)
{
  ...
  if (v9 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
  {
    v10 = 138412290;
    v11 = v6;
    _os_signpost_emit_with_name_impl(&dword_1CD062000, v8, OS_SIGNPOST_INTERVAL_END, v9, "MultiUser.Share.Req", "error=%{signpost.description:attribute}@ ", (uint8_t *)&v10, 0xCu);
  }
...
+ (id)identifierForConnection:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v5;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get identifier for connection: %@ process info: %@", (uint8_t *)&v14, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t27_88507 != -1)
    dispatch_once(&logCategory__hmf_once_t27_88507, &__block_literal_global_88508);
  return (id)logCategory__hmf_once_v28_88509;
}
...
void __42__HMDUserCloudShareController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v28_88509;
  logCategory__hmf_once_v28_88509 = v0;
