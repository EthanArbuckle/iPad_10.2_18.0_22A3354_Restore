...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_183564 != -1)
    dispatch_once(&hmbProperties_onceToken_183564, &__block_literal_global_183565);
  return (id)hmbProperties_properties_183566;
}
...
{
  if (sentinelParentUUID_onceToken_183559 != -1)
    dispatch_once(&sentinelParentUUID_onceToken_183559, &__block_literal_global_4_183560);
  return (NSUUID *)(id)sentinelParentUUID_sentinelParentUUID_183561;
}

+ (NSUUID)sentinelModelUUID
{
  if (sentinelModelUUID_onceToken != -1)
    dispatch_once(&sentinelModelUUID_onceToken, &__block_literal_global_8_183555);
...
void __43__HMDPersonSettingsModel_sentinelModelUUID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("B9F6C6E7-1B18-463B-B95A-6AF8C7A5E4DF"));
...
void __44__HMDPersonSettingsModel_sentinelParentUUID__block_invoke()
{
  ...
  v1 = (void *)sentinelParentUUID_sentinelParentUUID_183561;
  sentinelParentUUID_sentinelParentUUID_183561 = v0;
...
void __39__HMDPersonSettingsModel_hmbProperties__block_invoke()
{
  ...
  v2 = (void *)hmbProperties_properties_183566;
  hmbProperties_properties_183566 = v1;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v21 = 2112;
        v22 = v10;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive classificationNotificationSettingsData with error: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive classificationNotificationsEnabledForPersonUUID, settings updates have not been made", buf, 0xCu);
