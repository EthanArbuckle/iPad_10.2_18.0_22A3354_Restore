...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_159873 != -1)
    dispatch_once(&logCategory__hmf_once_t0_159873, &__block_literal_global_159874);
  return (id)logCategory__hmf_once_v1_159875;
}
...
void __41__HMDDelegatingMessageRouter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_159875;
  logCategory__hmf_once_v1_159875 = v0;
