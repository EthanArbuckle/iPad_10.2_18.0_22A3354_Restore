...
- (id)description
{
  ...
  -[HMDRemoteEventRouterProtoMultiHopFetchEventsResponse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDRemoteEventRouterProtoMultiHopFetchEventsResponse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", -[NSMutableArray count](self->_changedEvents, "count"));
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HMDRemoteEventRouterProtoMultiHopFetchEventsResponse changedEventsCount](self, "changedEventsCount"))
  {
    objc_msgSend(v8, "clearChangedEvents");
    v4 = -[HMDRemoteEventRouterProtoMultiHopFetchEventsResponse changedEventsCount](self, "changedEventsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HMDRemoteEventRouterProtoMultiHopFetchEventsResponse changedEventsAtIndex:](self, "changedEventsAtIndex:", i);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HMDRemoteEventRouterProtoMultiHopFetchEventsResponse addChangedEvents:](self, "addChangedEvents:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
