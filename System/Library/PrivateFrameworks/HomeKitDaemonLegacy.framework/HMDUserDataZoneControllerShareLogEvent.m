...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  v7[0] = CFSTR("result");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDUserDataZoneControllerShareLogEvent result](self, "result"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v7[1] = CFSTR("didAccept");
  v8[0] = v3;
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDUserDataZoneControllerShareLogEvent didAccept](self, "didAccept"));
