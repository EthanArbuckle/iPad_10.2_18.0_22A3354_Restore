  ...
  if ((isKindOfClass & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid message destination: %@", buf, 0x16u);
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid transport", buf, 0xCu);
      goto LABEL_12;
    }
    goto LABEL_13;
  }
...
- (void)main
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v24 = 2112;
    v25 = v9;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting sending message %@ to destination: %@", buf, 0x20u);
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cannot determine secure transport", buf, 0xCu);
...
void __37__HMDRemoteSendMessageOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (objc_msgSend(WeakRetained, "isCancelled"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 138543362;
      v19 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Operation is already cancelled, do not process response handler", (uint8_t *)&v18, 0xCu);
  ...
  else
  {
    ...
    if (v5)
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v16;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to send message", (uint8_t *)&v18, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138543362;
        v19 = v17;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully sent message", (uint8_t *)&v18, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_112260 != -1)
    dispatch_once(&logCategory__hmf_once_t9_112260, &__block_literal_global_112261);
  return (id)logCategory__hmf_once_v10_112262;
}
...
void __44__HMDRemoteSendMessageOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_112262;
  logCategory__hmf_once_v10_112262 = v0;
