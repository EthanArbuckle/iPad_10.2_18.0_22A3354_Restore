...
- (id)modelsToAdd
{
  ...
  -[HMDCameraClipModel setDuration:](v6, "setDuration:", &unk_1E8B339C0);
  ...
  -[HMDCameraClipModel setEncryptionScheme:](v6, "setEncryptionScheme:", &unk_1E8B339D8);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_99468 != -1)
    dispatch_once(&logCategory__hmf_once_t1_99468, &__block_literal_global_99469);
  return (id)logCategory__hmf_once_v2_99470;
}
...
void __47__HMDCameraClipCreateClipOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_99470;
  logCategory__hmf_once_v2_99470 = v0;
