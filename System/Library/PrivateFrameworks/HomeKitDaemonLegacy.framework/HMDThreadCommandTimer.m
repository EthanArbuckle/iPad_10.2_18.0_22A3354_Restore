...
- (HMDThreadCommandTimer)initWithQueue:(id)a3 delayInSecs:(id)a4
{
  ...
  if (v9)
  {
    v10 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, (double)objc_msgSend(v8, "integerValue"));
...
- (HMDThreadCommandTimer)initWithTimer:(id)a3
{
  ...
  v9 = -[HMDThreadCommandTimer initWithQueue:delayInSecs:](self, "initWithQueue:delayInSecs:", v8, &unk_1E8B33348);
...
- (void)startWithBlock:(id)a3 completion:(id)a4 commandType:(int64_t)a5
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Not executing deferred thread command %@ with id(%lu). Sending nil completion", (uint8_t *)&v28, 0x20u);
  ...
  v20 = (void *)MEMORY[0x1D17BA0A0](-[HMDThreadCommandTimer setCommandType:](self, "setCommandType:", a5));
  v21 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    v34 = 2048;
    v35 = v26;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Scheduling deferred thread command %@ to execute after %@ secs with id(%lu)", (uint8_t *)&v28, 0x2Au);
...
- (void)abort
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Not executing deferred thread command %@ with id(%lu). Sending nil completion", (uint8_t *)&v13, 0x20u);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Executing deferred thread command %@ now with id(%lu)", (uint8_t *)&v17, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2048;
      v22 = -[HMDThreadCommandTimer commandCount](v8, "commandCount");
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Execution block not found for thread command %@ with id(%lu)", (uint8_t *)&v17, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_75809 != -1)
    dispatch_once(&logCategory__hmf_once_t5_75809, &__block_literal_global_75810);
  return (id)logCategory__hmf_once_v6_75811;
}
...
void __36__HMDThreadCommandTimer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_75811;
  logCategory__hmf_once_v6_75811 = v0;
