...
- (id)dumpState
{
  ...
  if (objc_msgSend(v5, "count"))
  {
    ...
    objc_msgSend(v4, "setObject:forKeyedSubscript:", v6, *MEMORY[0x1E0D27EA8]);
  }
  ...
  if (v13)
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKeyedSubscript:", v15, *MEMORY[0x1E0D27F30]);
  ...
  if (v16)
  {
    ...
    objc_msgSend(v4, "setObject:forKeyedSubscript:", v18, *MEMORY[0x1E0D27F38]);

  }
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDEventTrigger executeOnce](self, "executeOnce"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v19, *MEMORY[0x1E0D27EB0]);
  ...
  if (v20)
  {
    ...
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKeyedSubscript:", v22, *MEMORY[0x1E0D27EB8]);
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Deactivating the trigger", buf, 0xCu);
...
- (BOOL)requiresDataVersion4
{
  ...
  if (-[HMDEventTrigger executeOnce](self, "executeOnce"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Contains execute once/policy, requires data version 4", buf, 0xCu);
...
- (BOOL)compatible:(id)a3 user:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v24 = 2112;
    v25 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Checking if the username %@ is compatible", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v8);
  if (-[HMDEventTrigger requiresDataVersion4](v9, "requiresDataVersion4")
    && objc_msgSend(v6, "containsObject:", &unk_1E8B32C58))
  {
    v19 = 0u;
    v20 = 0u;
    v17 = 0u;
...
- (BOOL)doesTheLocationEventTargetCurrentUser
{
  ...
  v3 = objc_msgSend(v2, "na_allObjectsPassTest:", &__block_literal_global_49);
...
- (void)_computeActivation
{
  ...
  -[HMDEventTrigger charThresholdEvents](self, "charThresholdEvents");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v67 = objc_msgSend(v9, "count");

  -[HMDEventTrigger endEvents](self, "endEvents");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v66 = objc_msgSend(v10, "count");
  ...
  v13 = objc_msgSend(v11, "isCurrentDeviceConfirmedPrimaryResident");
  ...
  v17 = (void *)MEMORY[0x1D17BA0A0](v15);
  v18 = self;
  HMFGetOSLogHandle();
  v19 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v91 = 2112;
    v92 = (uint64_t)v26;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Resident %@, this-device-is-resident: %@, this-device-owns-trigger: %@, owning-device: %@, FMF device: %@, Owner of home: %@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    v93 = 2048;
    v94 = v66;
    _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@char: %tu, location: %tu, calendar: %tu, significant: %tu, presence: %tu, char-threshold: %tu, end: %tu", buf, 0x52u);
  ...
  {
    if (v5 && !-[HMDEventTrigger isAuthorizedForLocation](v28, "isAuthorizedForLocation"))
    {
      v32 = 0;
      v33 = 3;
      goto LABEL_45;
    }
    if ((objc_msgSend(v12, "supportsSharedEventTriggerActivation") & 1) == 0
    ...
    if (objc_msgSend(v12, "supportsSharedEventTriggerActivation"))
    {
      if (v5)
      {
        if (v72)
...
LABEL_44:
  ...
  if (v31)
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v80 = v37;
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@The trigger is disabled as there are no actions associated with this trigger.", buf, 0xCu);
...
LABEL_45:
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v83 = 2112;
    v84 = (uint64_t)v46;
    _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Computed activation flags state:%@ type: %@", buf, 0x20u);

    v12 = v45;
  }

  objc_autoreleasePoolPop(v40);
  if (-[HMDEventTrigger activationType](v41, "activationType") != v32)
  {
    ...
    if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
    {
      ...
      HMDEventTriggerActivationTypeAsString(-[HMDEventTrigger activationType](v48, "activationType"));
      v74 = v12;
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v83 = 2112;
      v84 = (uint64_t)v53;
      _os_log_impl(&dword_1CD062000, v49, OS_LOG_TYPE_INFO, "%{public}@Updating activation type from %@ to %@", buf, 0x20u);
    ...
    -[HMDEventTrigger setActivationType:](v48, "setActivationType:", v32);
  }
  if (-[HMDEventTrigger activationState](v41, "activationState") != v33)
  {
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
    {
      ...
      -[HMDEventTrigger activationState](v55, "activationState");
      HMEventTriggerActivationStateAsString();
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v83 = 2112;
      v84 = (uint64_t)v59;
      _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@Updating activation state from %@ to %@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v54);
    -[HMDEventTrigger setActivationState:](v55, "setActivationState:", v33);
    v77 = CFSTR("kEventTriggerActivationStateKey");
    ...
    objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:identifier:messagePayload:", CFSTR("kEventTriggerActivationStateNotificationKey"), 0, v61);
    v62 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDTrigger msgDispatcher](v55, "msgDispatcher");
    v63 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDTrigger uuid](v55, "uuid");
    v64 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v63, "sendMessage:target:", v62, v64);
...
- (void)_activateEvents:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v62 = 2114;
    v63 = v8;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Attempting to activate with activation type %{public}@, state %{public}@", buf, 0x20u);
    ...
    if ((v15 & 1) == 0)
    {
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v59 = v23;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Home location is not known, cannot activate the trigger", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v20);
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 84);
        v24 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_activateWithCompletion:(id)a3
{
  ...
  if (-[HMDTrigger isConfigured](self, "isConfigured"))
  {
    ...
    else
    {
      ...
      {
        v10 = (void *)MEMORY[0x1D17BA0A0](-[HMDEventTrigger _configureDebounceTriggerActivationTimer](self, "_configureDebounceTriggerActivationTimer"));
        v11 = self;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
        {
          ...
          v20 = 2112;
          v21 = v14;
          _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Reinitialized debounce timer from %@ to %@", (uint8_t *)&v16, 0x20u);
  ...
  else
  {
    ...
    if (v5)
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2012);
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      v5[2](v5, v6);
        ...
        if (objc_msgSend(v10, "isActive", v17))
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v17;
            ...
            v24 = 2112;
            v25 = v10;
            _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Registering for relaunch on behalf of event: %@", buf, 0x16u);
...
- (void)_configureDebounceTriggerActivationTimer
{
  ...
  if (!dependencyFactory)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Missing dependency factory, reinitializing %@", (uint8_t *)&v15, 0x16u);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Debounce Timer expired: Going to activate the trigger", (uint8_t *)&v11, 0xCu);
...
- (void)_migrateEventsToRecords
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v35 = 2112;
    v36 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Events migration %@", buf, 0x16u);
  ...
  if (!-[HMDEventTrigger migratedEventsToRecords](v4, "migratedEventsToRecords"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@The events haven't been migrated, generating transactions for each event present", buf, 0xCu);
    ...
    if (v15)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v18 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:messagePayload:", CFSTR("kMigratedEventsToRecordsRequest"), 0);
          v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_registerForMessages
{
  ...
  +[HMDUserMessagePolicy userMessagePolicyWithHome:userPrivilege:remoteAccessRequired:](HMDUserMessagePolicy, "userMessagePolicyWithHome:userPrivilege:remoteAccessRequired:", v31, 4, 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDTrigger msgDispatcher](self, "msgDispatcher");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v28, "registerForMessage:receiver:policies:selector:", CFSTR("kUpdateOwningDeviceRequestKey"), self, v30, sel__handleUpdateOwningDevice_);
...
- (void)sendTriggerFiredNotification:(id)a3
{
  ...
  if (v6)
    objc_msgSend(MEMORY[0x1E0D285D0], "locationAuthorizedMessageWithName:messagePayload:", CFSTR("kTriggerFiredNotificationKey"), v4);
  else
  ...
  if (v52)
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v8;
      _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Condition has been modified following removal of characteristic %@", buf, 0x16u);
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v28 = 2112;
            v29 = v11;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot remove event %@", buf, 0x16u);
...
- (void)handleRemovalOfUser:(id)a3 transaction:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2112;
    v37 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Preparing to remove references to user %@ from trigger", (uint8_t *)&buf, 0x16u);
  ...
  v29 = 0u;
  v30 = 0u;
  -[HMDEventTrigger presenceEvents](v9, "presenceEvents");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v13)
  {
    ...
    do
    {
      for (i = 0; i != v14; ++i)
      {
        if (*(_QWORD *)v30 != v15)
          objc_enumerationMutation(v12);
        objc_msgSend(*(id *)(*((_QWORD *)&v29 + 1) + 8 * i), "handleRemovalOfUser:transaction:", v6, v7);
      }
  ...
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = objc_msgSend(v17, "containsPresenceEvents:", v18);
  ...
  if (v19)
  {
    ...
    -[HMDEventTrigger evaluationCondition](v9, "evaluationCondition");
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "updatePredicate:removedUser:conditionModified:", v21, v6, &v28);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v28)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        v36 = 2112;
        v37 = v6;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Condition has been modified following removal of user %@", (uint8_t *)&buf, 0x16u);

      }
      objc_autoreleasePoolPop(v23);
      -[HMDEventTrigger _modelWithRewrittenCondition:](v24, "_modelWithRewrittenCondition:", v22);
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      if (v27)
        objc_msgSend(v7, "add:withMessage:", v27, 0);
...
- (id)_modelWithRewrittenCondition:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating evaluation condition for trigger %@", (uint8_t *)&v17, 0x16u);
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v21 = v18;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Cannot add event - Incompatible home hub", buf, 0xCu);
...
LABEL_23:
      -[HMDTrigger uuid](self, "uuid");
      v27 = (void *)objc_claimAutoreleasedReturnValue();
      -[__objc2_class eventModelWithDictionary:home:eventTriggerUUID:message:](v19, "eventModelWithDictionary:home:eventTriggerUUID:message:", v14, v18, v27, v15);
      v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else if (objc_msgSend(v17, "isEqualToString:", CFSTR("kEventTriggerTypeLocationEventKey")))
  {
    if (!v15
      || (objc_msgSend(v15, "isRemote") & 1) != 0
      || (objc_msgSend(v15, "isAuthorizedForLocationAccess") & 1) != 0)
    {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot add event", (uint8_t *)&v29, 0xCu);
...
LABEL_24:
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 85);
    v21 = 0;
  ...
  else
  {
    ...
    -[HMDTrigger uuid](self, "uuid");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    +[HMDCharacteristicThresholdRangeEventModel eventModelWithDictionary:home:eventTriggerUUID:message:checkForSupport:](HMDCharacteristicThresholdRangeEventModel, "eventModelWithDictionary:home:eventTriggerUUID:message:checkForSupport:", v14, v18, v22, v15, v10);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v8;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v17;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v26;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v35;
        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v44;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v53;
        _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v70, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v84 = 2112;
        v85 = v62;
        _os_log_impl(&dword_1CD062000, v70, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
...
LABEL_71:
  ...
  if (os_log_type_enabled(v74, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v86 = 2112;
    v87 = v76;
    _os_log_impl(&dword_1CD062000, v74, OS_LOG_TYPE_DEBUG, "%{public}@Added new event %@ to %@", buf, 0x20u);
...
- (void)_removeEventsFromEventTrigger:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 138543362;
      v32 = v27;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot remove event", (uint8_t *)&v31, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v21;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Couldn't find event with UUID %@ in trigger %@", (uint8_t *)&v31, 0x20u);
...
- (void)_handleRemoveEventModel:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v10;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Removing event %@", buf, 0x16u);
...
- (BOOL)addEventsFromMessage:(id)a3 preserveUUIDs:(BOOL)a4 transaction:(id)a5 error:(id *)a6
{
  ...
  if (v13)
  {
    if (!-[HMDEventTrigger addEventsFromInfo:preserveUUIDs:endEvent:transaction:message:error:](self, v12, a4, MEMORY[0x1E0C9AAA0], v11, v10, a6))
    {
      v18 = 0;
      goto LABEL_7;
    }
...
- (BOOL)checkSharedEventTriggerActivationResidentRequirement:(id)a3
{
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Did not find any compatible resident device", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Did not find any resident device", buf, 0xCu);
      ...
      if (-[HMDEventTrigger checkSharedEventTriggerActivationResidentRequirement:](self, "checkSharedEventTriggerActivationResidentRequirement:", 0))
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v39 = 2112;
          v40 = v12;
          _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@The resident supports shared-trigger-activation, relaying the update events message as is : %@", buf, 0x16u);
            ...
            for (i = 0; i != v16; ++i)
            {
              ...
              if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v39 = 2112;
                v40 = v20;
                _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@The resident does not support shared-trigger-activation, relaying the message %@", buf, 0x16u);
      ...
      while (1)
      {
        ...
        if (!-[HMDEventTrigger _checkAddEventModel:message:](self, "_checkAddEventModel:message:", v15, v69))
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v67;
            v99 = v56;
            _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, "%{public}@Cannot update events - Incompatible home hub", buf, 0xCu);
...
LABEL_42:
        ...
        if (objc_msgSend(v75, "isSharedAdmin"))
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v67;
            v99 = v19;
            _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@shared admin is sending the request to resident.", buf, 0xCu);
...
LABEL_17:
          ...
          if ((_DWORD)v7 == objc_msgSend(v29, "isEndEvent"))
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v100 = 2112;
              v101 = v29;
              _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Deleting event %@", buf, 0x16u);
            ...
            if (objc_msgSend(v75, "isSharedAdmin"))
            {
              ...
              if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v99 = v41;
                _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Admin user : Remove event from trigger", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v99 = v61;
        _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_ERROR, "%{public}@No events updated, calling the completion handler rightaway", buf, 0xCu);
...
LABEL_47:
  ...
  else
  {
    ...
    v63 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v69, "respondWithError:", obj));
    v64 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v100 = 2112;
      v101 = obj;
      _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_INFO, "%{public}@Client does not have authorization for location, cannot remove event. [%@]", buf, 0x16u);
...
- (void)_handleUpdateEventTrigger:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v70 = 2112;
    v71 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received request to update Event Trigger %@ / %@", buf, 0x20u);
...
LABEL_28:
    ...
    if (v49 || +[HMDEventTrigger __validateRecurrences:](HMDEventTrigger, "__validateRecurrences:", v48))
    {
      ...
      objc_msgSend(v12, "stringForKey:", *MEMORY[0x1E0CB9E50]);
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDEventTriggerModel setConfiguredName:](v19, "setConfiguredName:", v23);

      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v12, "BOOLForKey:", CFSTR("kTriggerActivate")));
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v12, "BOOLForKey:", CFSTR("kEventTriggerExecuteOnce")));
      v29 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDEventTriggerModel setExecuteOnce:](v19, "setExecuteOnce:", v29);

      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v12, "BOOLForKey:", *MEMORY[0x1E0CB9E60]));
      v30 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (-[HMDEventTrigger _populateTriggerModel:fromBuilderMessage:transaction:responsePayload:](v6, "_populateTriggerModel:fromBuilderMessage:transaction:responsePayload:", v19, v50, v47, v31))
      {
        ...
        v61 = 0;
        v35 = -[HMDEventTrigger updateEventsFromInfo:existingEvents:preserveUUIDs:endEvent:transaction:message:error:](v45, v32, v34, MEMORY[0x1E0C9AAA0], v47, v12, &v61);
        v36 = v61;
        ...
        if ((v35 & 1) != 0)
        {
          ...
          v60 = 0;
          v40 = -[HMDEventTrigger updateEventsFromInfo:existingEvents:preserveUUIDs:endEvent:transaction:message:error:](v45, v37, v39, MEMORY[0x1E0C9AAB0], v47, v12, &v60);
          v36 = v60;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v68 = 2112;
        v69 = v48;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@Received invalid values for recurrences: %@", buf, 0x16u);
...
LABEL_9:
  ...
  if (objc_msgSend(v8, "length") > v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@New name is longer than the pre-defined max length", (uint8_t *)&v26, 0xCu);
...
LABEL_25:
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v105 = 2112;
            v106 = v18;
            _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Invalid ActionSet reference: '%@'", buf, 0x16u);
        ...
        if (!v21)
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v105 = 2112;
            v106 = v20;
            _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to resolve ActionSet reference: %@", buf, 0x16u);
...
LABEL_52:
    ...
    if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v104 = v67;
      _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_ERROR, "%{public}@Failed to modify trigger-owned action set", buf, 0xCu);
  ...
  else
  {
    ...
    v51 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB3A28], "hm_deriveUUIDFromBaseUUID:", v51);
    v52 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v52, "UUIDString");
    v53 = (void *)objc_claimAutoreleasedReturnValue();

    v54 = (void *)*MEMORY[0x1E0CB8230];
    v89 = 0;
    v90 = 0;
    v75 = v53;
...
LABEL_50:
    ...
    if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v104 = v72;
      _os_log_impl(&dword_1CD062000, v71, OS_LOG_TYPE_ERROR, "%{public}@Failed to create trigger-owned action set", buf, 0xCu);
...
- (void)_handleUpdateEventTriggerCondition:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v7;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating evaluation condition for trigger %@", (uint8_t *)&v29, 0x16u);
      ...
      && !-[HMDEventTrigger checkSharedEventTriggerActivationResidentRequirement:](v9, "checkSharedEventTriggerActivationResidentRequirement:", v6))
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 138543362;
        v30 = v28;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Presence Event Condition requires shared-trigger-activation capable homehub", (uint8_t *)&v29, 0xCu);
...
- (void)_updateOwningDevice:(id)a3
{
  ...
  if (-[HMDEventTrigger checkSharedEventTriggerActivationResidentRequirement:](self, "checkSharedEventTriggerActivationResidentRequirement:", v4))
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v27 = 0;
    objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v5, &v27);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = v27;
    v8 = (void *)MEMORY[0x1D17BA0A0]();
    v9 = self;
    ...
    if (v6)
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v30 = 2112;
        v31 = v6;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Taking over owner ship of trigger to %@", buf, 0x16u);
    ...
    else
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v30 = 2112;
        v31 = v7;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive device from device data: %@", buf, 0x16u);
...
LABEL_17:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v23;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating owning device requires shared-trigger-activation capable homehub", buf, 0xCu);
...
- (void)_updateEventTriggerExecuteOnce:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Execute once requires shared-trigger-activation capable homehub", (uint8_t *)&v19, 0xCu);
...
- (BOOL)isEventTriggerOnRemoteGatewayForAccessory:(id)a3
{
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run on the resident. [%s]", buf, 0x16u);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2080;
    v35 = "-[HMDEventTrigger isEventTriggerOnRemoteGatewayForAccessory:]";
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run locally. [%s]", buf, 0x16u);
...
- (BOOL)isEventTriggerOnLocalDeviceForAccessory:(id)a3
{
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run locally. [%s]", buf, 0x16u);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2080;
    v35 = "-[HMDEventTrigger isEventTriggerOnLocalDeviceForAccessory:]";
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run on the resident. [%s]", buf, 0x16u);
...
- (id)didOccurEvent:(id)a3 causingDevice:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v55 = 2112;
    v56 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Event occurred on device %@, %@", buf, 0x20u);
  ...
  if (v12)
  {
    ...
    if (v7)
    {
      -[HMDEventTrigger executionSession](v9, "executionSession");
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v15 = objc_msgSend(v14, "needsUserConfirmation");
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v57 = 2112;
        v58 = v21;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Execution session is already in progress, %@adding occurred device %@ for asking confirmation %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v53 = 2112;
        v54 = v48;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Execution session is already in progress, not executing again %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v53 = 2112;
    v54 = v28;
    _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Creating execution session with end events %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v53 = 2112;
    v54 = v42;
    _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Created action set execution session: %@", buf, 0x16u);
...
- (void)_resetExecutionState
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v8;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting execution sessions %@, confirmation session %@", (uint8_t *)&v9, 0x20u);
...
LABEL_5:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 138543362;
    v19 = v15;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@There is no confirmation timer running, ignoring the response", (uint8_t *)&v18, 0xCu);
  ...
  if (v5 && v6)
  {
      ...
      if (!v13 || (-[HMDEventTriggerDevice isOwner](v13, "isOwner") & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v50 = 2112;
          v51 = v9;
          _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_ERROR, "%{public}@Only owner may perform a user permission dialog: %@", buf, 0x16u);
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v20;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@There is already a user confirmation session in progress, replacing it", buf, 0xCu);
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v50 = 2112;
      v51 = v31;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Created a user confirmation session %@", buf, 0x16u);
...
LABEL_26:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v49 = v38;
    _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Did not receive execution session ID or requesting device", buf, 0xCu);
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 138543362;
      v32 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Handling event trigger update", (uint8_t *)&v31, 0xCu);
  ...
  else
  {
    ...
    if (v20)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          v31 = 138543362;
          v32 = v30;
          _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Handling event add", (uint8_t *)&v31, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 138543362;
        v32 = v26;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Unknown model object", (uint8_t *)&v31, 0xCu);
...
- (void)processEventRecords:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 138543362;
    v15 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Saving to push the event records to cloud", (uint8_t *)&v14, 0xCu);
...
- (void)_transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to cast the given model object to EventModel", (uint8_t *)&v15, 0xCu);
...
void __45__HMDEventTrigger_takeOverOwnershipOfTrigger__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "owningDevice");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = HMFEqualObjects();
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v3;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Owning device is correctly set to %@, not changing", buf, 0x16u);
  ...
  else
  {
    ...
    objc_msgSend(*(id *)(a1 + 32), "uuid", v17);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = (void *)objc_msgSend(v13, "initWithTarget:", v14);
    objc_msgSend(v12, "messageWithName:destination:payload:", CFSTR("kUpdateOwningDeviceRequestKey"), v15, v11);
    v16 = (void *)objc_claimAutoreleasedReturnValue();

    objc_msgSend(*(id *)(a1 + 32), "_handleUpdateOwningDevice:", v16);
  }
...
uint64_t __43__HMDEventTrigger_executionComplete_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Action set execution session %@ is complete with error %@", (uint8_t *)&v13, 0x20u);
  ...
  if (!*(_QWORD *)(a1 + 48) && objc_msgSend(*(id *)(a1 + 32), "executeOnce"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Trigger is marked to be executed once, deactivating", (uint8_t *)&v13, 0xCu);
...
void __45__HMDEventTrigger__handleUpdateEventTrigger___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v5;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Responding to the client about update event trigger status : Payload : [%@], error : [%@]", (uint8_t *)&v12, 0x20u);
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = v69;
                    ...
                    v104 = 2112;
                    v105 = v77;
                    _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize action: %@ with error: %@", buf, 0x20u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v102 = 2112;
                  v103 = v80;
                  _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Invalid event trigger type: %@", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v102 = 2112;
                v103 = v24;
                _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@Event must have trigger type %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v102 = 2112;
              v103 = v41;
              _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Can't update events %@; invalid serialized event",
                buf,
                0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v15;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v29;
          _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v38;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v47;
          _os_log_impl(&dword_1CD062000, v54, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v56;
          _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v65;
          _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v90 = 2112;
          v91 = v74;
          _os_log_impl(&dword_1CD062000, v81, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v90 = 2112;
      v91 = v11;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Cannot create event model for event info %@", buf, 0x16u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v20 = 2112;
      v21 = v3;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Could not finish the request as self is no longer valid. Replying back to client with error:[%@]", buf, 0x16u);
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v6;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@Error occurred while updating events on event trigger. [%@]", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v32 = 2112;
      v33 = v7;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@All the events updated. Updating clients. %@ : %@]", buf, 0x20u);
  ...
  if (WeakRetained)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v16 = 138543362;
        v17 = v14;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@There are no triggering events anymore, removing the trigger", (uint8_t *)&v16, 0xCu);
...
void __35__HMDEventTrigger__activateEvents___block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Completed activation with errors: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_30881 != -1)
    dispatch_once(&logCategory__hmf_once_t1_30881, &__block_literal_global_30882);
  return (id)logCategory__hmf_once_v2_30883;
}
...
void __30__HMDEventTrigger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_30883;
  logCategory__hmf_once_v2_30883 = v0;
