...
- (HMDIDSActivityMonitorBroadcaster)initWithActivityMonitor:(id)a3
{
  ...
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, v10);
...
LABEL_9:
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Queue and data source set, starting debounce timer", (uint8_t *)&v12, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Current Device not yet determined, deferring IDS Activty broadcast", buf, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Debounce timer fired, rebuilding observer list", (uint8_t *)&v10, 0xCu);
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Data source updated, resuming debounce timer", (uint8_t *)&v12, 0xCu);
...
void __65__HMDIDSActivityMonitorBroadcaster__refreshBroadcastSubscription__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    objc_msgSend(v5, "stopBroadcastingSubActivity:", *MEMORY[0x1E0D33DB0]);
...
void __55__HMDIDSActivityMonitorBroadcaster__registerForXPCPoll__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@XPCActivity handler was invoked after monitor was deallocated", buf, 0xCu);
...
+ (id)criteria
{
  ...
  xpc_dictionary_set_BOOL(empty, (const char *)*MEMORY[0x1E0C80868], 1);
  xpc_dictionary_set_string(empty, (const char *)*MEMORY[0x1E0C80878], (const char *)*MEMORY[0x1E0C80880]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_132459 != -1)
    dispatch_once(&logCategory__hmf_once_t9_132459, &__block_literal_global_86_132460);
  return (id)logCategory__hmf_once_v10_132461;
}
...
void __47__HMDIDSActivityMonitorBroadcaster_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_132461;
  logCategory__hmf_once_v10_132461 = v0;
