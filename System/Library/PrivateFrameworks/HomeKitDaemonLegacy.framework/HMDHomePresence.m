  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@isNoUserAtHome - No users in presence map", buf, 0xCu);
...
- (BOOL)isAnyUserAtHome
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@isAnyUserAtHome - No users in presence map", buf, 0xCu);
...
LABEL_12:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@doAllUsersHavePresenceRegion - No users in presence map", buf, 0xCu);
...
- (BOOL)isUserAtHome:(id)a3
{
  ...
  if (v6 == 1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2112;
        v24 = v4;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Could not find user %@", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v23 = 2112;
      v24 = v4;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserAtHome", (uint8_t *)&v21, 0x16u);
...
- (BOOL)isUserNotAtHome:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v23 = 2112;
      v24 = v4;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserNotAtHome", (uint8_t *)&v21, 0x16u);
...
- (BOOL)isPresenceRegionKnownForUser:(id)a3
{
  ...
  if (v6 == 1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 2112;
        v25 = v4;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Could not find user %@", (uint8_t *)&v22, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      v24 = 2112;
      v25 = v4;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserPresenceRegionKnown", (uint8_t *)&v22, 0x16u);
...
void __49__HMDHomePresence_serializedIdentifierDictionary__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
LABEL_7:
    objc_msgSend(*(id *)(a1 + 32), "setObject:forKeyedSubscript:", &unk_1E8B343C8, v9);
    goto LABEL_8;
  }
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v7;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Using HMDUserPresenceRegionStatusUnknown for user with nil presence: %@", (uint8_t *)&v19, 0x16u);
...
LABEL_7:
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "setObject:forKeyedSubscript:", &unk_1E8B343C8, v12);
    goto LABEL_8;
  }
  objc_msgSend(v6, "presenceRegionStatus");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v7;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Using HMDUserPresenceRegionStatusUnknown for user with nil presence: %@", (uint8_t *)&v21, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_135158 != -1)
    dispatch_once(&logCategory__hmf_once_t3_135158, &__block_literal_global_135159);
  return (id)logCategory__hmf_once_v4_135160;
}
...
void __30__HMDHomePresence_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_135160;
  logCategory__hmf_once_v4_135160 = v0;
