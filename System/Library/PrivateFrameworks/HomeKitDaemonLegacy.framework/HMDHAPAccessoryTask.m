...
- (unint64_t)completedRequestsCount
{
  ...
  -[HMDHAPAccessoryTask requests](self, "requests");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "na_filter:", &__block_literal_global_87_180374);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)sendCharacteristicNotificationsForTaskInProgress:(id)a3 completion:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  objc_msgSend(v6, "na_filter:", &__block_literal_global_113_180350);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@[%@] Sending characteristic notifications (%ld) for task in progress.", buf, 0x20u);
  ...
  if (objc_msgSend(v8, "count"))
  {
    ...
    block[1] = 3221225472;
    block[2] = __83__HMDHAPAccessoryTask_sendCharacteristicNotificationsForTaskInProgress_completion___block_invoke_114;
...
- (void)_sendCharacteristicNotificationsForTaskInProgress:(id)a3 completion:(id)a4
{
  ...
  v47 = a3;
  v48 = a4;
  objc_msgSend(v47, "na_filter:", &__block_literal_global_116_180341);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v7, "count"))
  {
    ...
    {
      objc_msgSend(v7, "na_map:", &__block_literal_global_125_180348);
    ...
    else
    {
      ...
      v28 = objc_alloc(MEMORY[0x1E0D285F8]);
      ...
      v33 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v31, "setRequiresSPIEntitlement:", objc_msgSend(v9, "requiresSPIEntitlement")));
      v34 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v63 = 2112;
        v64 = v38;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Sending the multi-part responses[%ld] to local client: %@", buf, 0x2Au);

        v12 = v45;
      }

      objc_autoreleasePoolPop(v33);
      objc_msgSend(v7, "na_each:", &__block_literal_global_121_180347);
...
- (void)sendCharacteristicNotificationsForCompletedTask:(id)a3 completion:(id)a4
{
  ...
  v6 = a3;
  v27 = a4;
  v7 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v6, "na_each:", &__block_literal_global_127_180336));
  v8 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    v38 = v8;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[%@] Sending characteristic notifications for completed task", buf, 0x16u);
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "na_map:", &__block_literal_global_130_180338);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)finishTaskWithCharacteristicResponses:(id)a3 completion:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] associated context is already completed: %@", (uint8_t *)&v17, 0x20u);
...
void __42__HMDHAPAccessoryTask__updatedCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for fallback task completion handler", (uint8_t *)&v12, 0xCu);

    }
    objc_autoreleasePoolPop(v8);
    (*(void (**)(_QWORD, _QWORD))(*(_QWORD *)(a1 + 32) + 16))(*(_QWORD *)(a1 + 32), MEMORY[0x1E0C9AA60]);
  }
...
uint64_t __82__HMDHAPAccessoryTask_sendCharacteristicNotificationsForCompletedTask_completion___block_invoke_128(uint64_t a1, void *a2)
{
...
void __84__HMDHAPAccessoryTask__sendCharacteristicNotificationsForTaskInProgress_completion___block_invoke_120(uint64_t a1, void *a2)
{
  id v2;
...
uint64_t __83__HMDHAPAccessoryTask_sendCharacteristicNotificationsForTaskInProgress_completion___block_invoke_114(uint64_t a1)
{
