@implementation AWDHomeKitSoftwareUpdateStarted
...
- (void)setIsAutomaticUpdateEnabled:(BOOL)a3
{
  *(_BYTE *)&self->_has |= 8u;
  self->_isAutomaticUpdateEnabled = a3;
}

- (void)setHasIsAutomaticUpdateEnabled:(BOOL)a3
{
  char v3;
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)AWDHomeKitSoftwareUpdateStarted;
  -[AWDHomeKitSoftwareUpdateStarted description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDHomeKitSoftwareUpdateStarted dictionaryRepresentation](self, "dictionaryRepresentation");
...
LABEL_4:
  ...
  {
LABEL_5:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_isAutomaticUpdateEnabled);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("isAutomaticUpdateEnabled"));
...
LABEL_63:
      if (*((_BYTE *)a3 + *v6))
        v38 = 0;
LABEL_65:
      self->_isAutomaticUpdateEnabled = v38 != 0;
    }
...
LABEL_4:
  ...
  {
LABEL_5:
    *((_BYTE *)v4 + 24) = self->_isAutomaticUpdateEnabled;
    *((_BYTE *)v4 + 28) |= 8u;
  }
LABEL_6:
...
LABEL_9:
  ...
  *((_BYTE *)result + 28) |= 4u;
  if ((*(_BYTE *)&self->_has & 8) == 0)
    return result;
LABEL_5:
  *((_BYTE *)result + 24) = self->_isAutomaticUpdateEnabled;
  *((_BYTE *)result + 28) |= 8u;
  return result;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 28) & 2) == 0 || self->_duration != *((_DWORD *)v4 + 4))
      goto LABEL_19;
  }
...
LABEL_19:
    ...
    if (self->_isAutomaticUpdateEnabled)
    {
      if (!*((_BYTE *)v4 + 24))
        goto LABEL_19;
    }
...
LABEL_4:
  ...
  if ((*(_BYTE *)&self->_has & 8) == 0)
    goto LABEL_9;
LABEL_5:
  v5 = 2654435761 * self->_isAutomaticUpdateEnabled;
  return v3 ^ v2 ^ v4 ^ v5;
}
...
LABEL_4:
  ...
  {
LABEL_5:
    self->_isAutomaticUpdateEnabled = *((_BYTE *)v4 + 24);
    *(_BYTE *)&self->_has |= 8u;
  }
LABEL_6:
...
{
  return self->_isAutomaticUpdateEnabled;
}
