...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 1, CFSTR("kGeneralConfigurationPrebufferLength"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 2, CFSTR("kGeneralConfigurationEventTriggerOptions"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16400], "wrappertlv:name:objectCreator:", 3, CFSTR("kGeneralConfigurationMediaContainerConfigurations"), &__block_literal_global_87433);
...
- (NSData)tlvData
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDCameraRecordingGeneralConfiguration eventTriggerOptions](self, "eventTriggerOptions"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
