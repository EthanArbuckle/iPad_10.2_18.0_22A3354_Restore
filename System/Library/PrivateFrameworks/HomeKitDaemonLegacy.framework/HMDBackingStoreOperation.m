...
- (HMDBackingStoreOperation)initWithResultBlock:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_operationFinishBlock = &__block_literal_global_128782;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_128784 != -1)
    dispatch_once(&logCategory__hmf_once_t0_128784, &__block_literal_global_4_128785);
  return (id)logCategory__hmf_once_v1_128786;
}
...
void __39__HMDBackingStoreOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_128786;
  logCategory__hmf_once_v1_128786 = v0;
