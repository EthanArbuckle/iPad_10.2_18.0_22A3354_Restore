...
- (BOOL)getObjectValue:(id *)a3 forString:(id)a4 errorDescription:(id *)a5
{
  ...
  {
    v8 = objc_alloc(MEMORY[0x1E0D343A8]);
    v9 = MEMORY[0x1D17B9074](v7);
LABEL_7:
    v10 = (void *)v9;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v67 = v32;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Phone number is too short to partially redact", buf, 0xCu);
...
LABEL_23:
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEBUG, v21, buf, 0xCu);
