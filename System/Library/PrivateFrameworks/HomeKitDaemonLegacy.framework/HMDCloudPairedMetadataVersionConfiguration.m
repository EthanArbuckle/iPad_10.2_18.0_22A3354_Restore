...
- (HMDCloudPairedMetadataVersionConfiguration)initWithAccessoryIdentifier:(id)a3 jsonDictionary:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      if (v12)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            v35 = 2112;
            v36 = v7;
            _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@JSON contains an invalid '%@' value: %@", (uint8_t *)&v31, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          v35 = 2112;
          v36 = v7;
          _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@JSON contains an invalid '%@' value: %@", (uint8_t *)&v31, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = v7;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@JSON contains no '%@' value: %@", (uint8_t *)&v31, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 2112;
      v34 = v6;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Version configuration must contain firmware version: %@", (uint8_t *)&v31, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_131725 != -1)
    dispatch_once(&logCategory__hmf_once_t0_131725, &__block_literal_global_131726);
  return (id)logCategory__hmf_once_v1_131727;
}
...
void __57__HMDCloudPairedMetadataVersionConfiguration_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_131727;
  logCategory__hmf_once_v1_131727 = v0;
