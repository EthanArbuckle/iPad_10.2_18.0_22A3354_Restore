...
- (NSArray)userIDs
{
  ...
  objc_msgSend(v7, "na_flatMap:", &__block_literal_global_106);
...
- (void)start
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting HMDIDSFirewallManager", (uint8_t *)&v11, 0xCu);
...
- (void)replaceFireWallEntriesWithUserIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2117;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Replacing firewall entries with userIDs: %{sensitive}@", (uint8_t *)&v13, 0x16u);
...
- (void)addFireWallEntryForUserIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2117;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding firewall entries for userIDs: %{sensitive}@", (uint8_t *)&v13, 0x16u);
...
- (void)handleDidAddHome
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling did add home", (uint8_t *)&v11, 0xCu);
...
- (void)handleDidRemoveHome
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling did remove home", (uint8_t *)&v10, 0xCu);
...
- (void)handleDidAddUserWithUserID:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543619;
    ...
    v15 = 2117;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling did add user with userID: %{sensitive}@", buf, 0x16u);
...
- (void)handleDidAddUserWithUserID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543619;
    ...
    v20 = 2117;
    v21 = v6;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding firewall entry for userID: %{sensitive}@", buf, 0x16u);
...
- (void)handleDidRemoveUser
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling did remove user", (uint8_t *)&v10, 0xCu);
...
id __32__HMDIDSFirewallManager_userIDs__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "na_map:", &__block_literal_global_108);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (id)objc_msgSend(a3, "na_map:", &__block_literal_global_100_68924);
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t21_68919 != -1)
    dispatch_once(&logCategory__hmf_once_t21_68919, &__block_literal_global_111_68920);
  return (id)logCategory__hmf_once_v22_68921;
}
...
void __36__HMDIDSFirewallManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v22_68921;
  logCategory__hmf_once_v22_68921 = v0;
...
id __51__HMDIDSFirewallManager_firewallEntriesForUserIDs___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  objc_msgSend(MEMORY[0x1E0D343A8], "URIWithUnprefixedURI:", a2);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D342F0]), "initWithURI:", v2);
