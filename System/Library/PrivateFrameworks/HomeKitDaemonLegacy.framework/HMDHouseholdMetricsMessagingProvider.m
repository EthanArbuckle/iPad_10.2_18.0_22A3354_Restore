...
- (void)sendMessage:(id)a3 toDevice:(id)a4 withPayload:(id)a5 responseHandler:(id)a6
{
  ...
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285F8]), "initWithName:destination:payload:", v13, v19, v11);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_183186 != -1)
    dispatch_once(&logCategory__hmf_once_t0_183186, &__block_literal_global_183187);
  return (id)logCategory__hmf_once_v1_183188;
}
...
void __51__HMDHouseholdMetricsMessagingProvider_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_183188;
  logCategory__hmf_once_v1_183188 = v0;
