    ...
    if (v39)
    {
      ...
      if ((v43 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v58 = v49;
          _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@Error starting UARP packet capture for UARP Controller", buf, 0xCu);
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v59 = 2112;
        v60 = v44;
        _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_DEFAULT, "%{public}@Started UARP packet capture for UARP Controller in: %@", buf, 0x16u);
...
- (id)availableSoftwareAssetForMatterAccessory:(id)a3 error:(id *)a4
{
  ...
  if ((objc_msgSend(v6, "supportsCHIP") & 1) != 0)
  {
        ...
        case 5:
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v46 = 2114;
            v47 = v15;
            _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] %s: These statuses should never be seen, ignore status %{public}@.", buf, 0x2Au);
        ...
        case 2:
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v44 = 2080;
            v45 = "-[HMDAccessoryFirmwareUpdateManager availableSoftwareAssetForMatterAccessory:error:]";
            _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] %s: Image is busy downloading", buf, 0x20u);
        ...
        case 8:
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v46 = 2114;
            v47 = v33;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] %s: Image is not available %{public}@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v44 = 2080;
        v45 = "-[HMDAccessoryFirmwareUpdateManager availableSoftwareAssetForMatterAccessory:error:]";
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@[%@] %s: no session", buf, 0x20u);
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDAccessoryMatterUARPAssetErrorDomain"), v16, 0);
...
LABEL_13:
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, v22, buf, 0x20u);
...
LABEL_14:
  ...
  if (a4)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDAccessoryMatterUARPAssetErrorDomain"), 1, 0);
    v9 = 0;
    *a4 = (id)objc_claimAutoreleasedReturnValue();
  }
  else
...
LABEL_18:
      _os_log_impl(&dword_1CD062000, v21, v22, v20, (uint8_t *)&v38, 0x16u);
  ...
  if (-[HMDAccessoryFirmwareUpdateManager isAccessoryRegistered:](self, "isAccessoryRegistered:", v6))
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        v42 = 2112;
        v43 = v8;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[CHECK_AFU_SESSION][%@] Do not need to establish a new session, existing session found: %@", (uint8_t *)&v38, 0x20u);
    ...
    if (v24)
    {
      ...
      if (v25)
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          v40 = 2112;
          v41 = v31;
          _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@[CHECK_AFU_SESSION][%@] Firmware update registration and session creation complete", (uint8_t *)&v38, 0x16u);
...
LABEL_32:
        _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, v37, (uint8_t *)&v38, 0x16u);
...
- (id)UARPControllerForAccessory:(id)a3
{
     ...
     || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v4, "supportsCHIP"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@[%@] UARPControllerForAccessory: Returning Matter UARP Controller", (uint8_t *)&v18, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@[%@] UARPControllerForAccessory: Returning default UARP Controller", (uint8_t *)&v18, 0x16u);
  ...
  if (-[HMDAccessoryFirmwareUpdateManager supportsFirmwareUpdate](self, "supportsFirmwareUpdate"))
  {
    ...
    if (!v7)
    {
      if (v11)
      {
        ...
        v57 = 138543362;
        v58 = v29;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version update notification", (uint8_t *)&v57, 0xCu);
      ...
      v61 = 2112;
      v62 = v37;
      _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@The notification object of type %@ is not of expected type %@", (uint8_t *)&v57, 0x20u);
    ...
    if (v11)
    {
      ...
      v59 = 2112;
      v60 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Received accessory firmware version update notification", (uint8_t *)&v57, 0x16u);
      ...
      if (-[HMDAccessoryFirmwareUpdateManager isAccessoryRegistered:](v9, "isAccessoryRegistered:", v7))
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
          {
            ...
            v61 = 2112;
            v62 = (uint64_t)v15;
            _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Do not need to establish a new session with existing session: %@", (uint8_t *)&v57, 0x20u);
          ...
          if (v41)
          {
            ...
            if (v42)
            {
              if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
              {
                ...
                v59 = 2112;
                v60 = v48;
                _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_ERROR, "%{public}@[%@] Ignoring this notification for updating UARP with firmware version", (uint8_t *)&v57, 0x16u);
            ...
            else
            {
              if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
              {
                ...
                v61 = 2112;
                v62 = (uint64_t)v15;
                _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@[%@] Updating accessory firmware version with new session %@", (uint8_t *)&v57, 0x20u);
...
LABEL_42:
            _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, v54, (uint8_t *)&v57, 0x16u);
...
LABEL_27:
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_DEBUG, v39, (uint8_t *)&v57, 0x16u);
...
LABEL_30:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    v57 = 138543362;
    v58 = v24;
    _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version update notification", (uint8_t *)&v57, 0xCu);
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v57 = 138543362;
    v58 = v28;
    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update not enabled on this device; ignoring",
      (uint8_t *)&v57,
      0xCu);
...
- (void)_handleMatterSettingsUpdateNotification:(id)a3
{
  ...
  if (!v7)
  {
    if (v11)
    {
      ...
      v84 = 138543362;
      v85 = v34;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received matter settings update notification", (uint8_t *)&v84, 0xCu);
    ...
    v88 = 2112;
    v89 = v42;
    _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@The notification object of type %@ is not of expected type %@", (uint8_t *)&v84, 0x20u);
  ...
  if (v11)
  {
    ...
    v86 = 2112;
    v87 = v13;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Received matter settings update notification", (uint8_t *)&v84, 0x16u);
...
LABEL_29:
      _os_log_impl(&dword_1CD062000, v45, v46, v44, (uint8_t *)&v84, 0x16u);
...
LABEL_31:
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v86 = 2112;
      v87 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@[%@] Received VID/PID update notification", (uint8_t *)&v84, 0x16u);
    ...
    objc_msgSend(v7, "matterVendorID");
    v25 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v25, "isEqualToNumber:", &unk_1E8B33DB0))
    {
...
LABEL_32:
      ...
      v90 = 2112;
      v91 = v32;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Ignoring invalid VID: %@, PID: %@", (uint8_t *)&v84, 0x2Au);
...
LABEL_19:
    ...
    objc_msgSend(v7, "matterProductID");
    v47 = (void *)objc_claimAutoreleasedReturnValue();
    v48 = objc_msgSend(v47, "isEqualToNumber:", &unk_1E8B33DB0);
  ...
  if (v50)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      v86 = 2112;
      v87 = v55;
      _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@[%@] Received matter firmware revision number update notification", (uint8_t *)&v84, 0x16u);
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
    {
      ...
      v88 = 2112;
      v89 = (uint64_t)v58;
      _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_INFO, "%{public}@[%@] Firmware Update Manager: Received matter firmware revision number update notification, request change to %@", (uint8_t *)&v84, 0x20u);
    ...
    if (!v58)
    {
      ...
      v88 = 2112;
      v89 = 0;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Ignoring invalid matterFirmwareRevisionNumber: %@", (uint8_t *)&v84, 0x20u);
      goto LABEL_19;
    }
  ...
  if (v64)
  {
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
    {
      ...
      v86 = 2112;
      v87 = v69;
      _os_log_impl(&dword_1CD062000, v67, OS_LOG_TYPE_ERROR, "%{public}@Failed to register and create session for accessory: %@", (uint8_t *)&v84, 0x16u);
  ...
  else
  {
    ...
    if (v71)
    {
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
      {
        ...
        v88 = 2112;
        v89 = 0;
        _os_log_impl(&dword_1CD062000, v74, OS_LOG_TYPE_INFO, "%{public}@[%@] Updating accessory vendor ID and product ID with new session %@", (uint8_t *)&v84, 0x20u);
    ...
    else
    {
      ...
      if (v78)
      {
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
        {
          ...
          v88 = 2112;
          v89 = 0;
          _os_log_impl(&dword_1CD062000, v81, OS_LOG_TYPE_INFO, "%{public}@[%@] Updating matter firmware version number with new session %@", (uint8_t *)&v84, 0x20u);
  ...
  if (!-[HMDAccessoryFirmwareUpdateManager isAccessoryRegistered:](self, "isAccessoryRegistered:", v8))
  {
       ...
       || CFPreferencesGetAppBooleanValue(CFSTR("MatterOTA"), CFSTR("/Library/Managed Preferences/mobile/com.apple.homed.plist"), 0))&& objc_msgSend(v8, "supportsCHIP"))
    {
      ...
      if (v21)
      {
        ...
        v23 = objc_msgSend(v22, "isEqualToNumber:", &unk_1E8B33DB0) ^ 1;
      ...
      if (v24)
      {
        objc_msgSend(v8, "matterProductID");
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        v160 = objc_msgSend(v25, "isEqualToNumber:", &unk_1E8B33DB0) ^ 1;
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544898;
        ...
        v181 = 2112;
        v182 = v37;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@[%@] Matter AFU Settings: hasMatterFirmwareUpdateProfile: %@, hasMatterFirmwareRevisionNumber: %@, hasMatterVendorID: %@, hasMatterProductID: %@, hasHapAccessoryName: %@", buf, 0x48u);
...
LABEL_57:
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v171 = 2112;
        v172 = v65;
        _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not registering with FirmwareUpdateManager due to invalid matter AFU settings", buf, 0x16u);
LABEL_55:
    ...
    if (!objc_msgSend(v8, "identityType"))
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138545154;
        ...
        v183 = 2112;
        v184 = v8;
        _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not registering with FirmwareUpdateManager due to unknown identity type for manufacturer: %@ model: %@ productData: %@ vendorID: %@ productID: %@ accessory: %@", buf, 0x52u);
        ...
        if (objc_msgSend(v69, "state") == 2)
        {
          ...
          if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v171 = 2112;
            v172 = v78;
            _os_log_impl(&dword_1CD062000, v76, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Verifying pending firmware version on registered accessory", buf, 0x16u);
...
LABEL_60:
        ...
        if (!v82)
        {
          ...
          if (os_log_type_enabled(v85, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v171 = 2112;
            v172 = v87;
            _os_log_impl(&dword_1CD062000, v85, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Not registering accessory with FirmwareUpdateManager - unsupported accessory type", buf, 0x16u);
        ...
        if (v167)
        {
          objc_msgSend(MEMORY[0x1E0C99E98], "fileURLWithPath:isDirectory:", v167, 0);
        ...
        v88 = objc_alloc(MEMORY[0x1E0D1A650]);
        if ((unint64_t)(v163 - 1) > 8)
          v89 = 1;
        else
          v89 = qword_1CDB8F738[v163 - 1];
        ...
        if (os_log_type_enabled(v94, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v175 = 2112;
          v176 = v90;
          _os_log_impl(&dword_1CD062000, v94, OS_LOG_TYPE_INFO, "%{public}@[%@] Registering UARP Accessory %@ with AssetID %@", buf, 0x2Au);
...
LABEL_75:
            ...
            if (os_log_type_enabled(v108, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              v177 = 2112;
              v178 = v165;
              _os_log_impl(&dword_1CD062000, v108, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Registered accessory %@ %@, version %@ with FirmwareUpdateManager", buf, 0x34u);
            ...
            if ((objc_msgSend(v91, "updateProperty:value:forAccessory:", 4, v165, v82) & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v114, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v171 = 2112;
                v172 = v116;
                _os_log_impl(&dword_1CD062000, v114, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to update UARP accessory firmware version property for accessory", buf, 0x16u);
            ...
            if (objc_msgSend(v8, "isAppleAccessory"))
            {
              ...
              if (v117)
              {
                ...
                if (os_log_type_enabled(v120, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v173 = 2112;
                  v174 = v123;
                  _os_log_impl(&dword_1CD062000, v120, OS_LOG_TYPE_ERROR, "%{public}@[%@] Session already created when trying to register accessory %@ with FirmwareUpdateSession", buf, 0x20u);
              ...
              if (os_log_type_enabled(v126, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v173 = 2112;
                v174 = v129;
                _os_log_impl(&dword_1CD062000, v126, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Creating session to register accessory %@ with FirmwareUpdateSession", buf, 0x20u);
            ...
            if (os_log_type_enabled(v133, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v175 = 2112;
              v176 = v165;
              _os_log_impl(&dword_1CD062000, v133, OS_LOG_TYPE_INFO, "%{public}@[%@] Accessory firmware version updated to %@ (%@)", buf, 0x2Au);
          ...
          if (os_log_type_enabled(v139, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v173 = 2112;
            v174 = 0;
            _os_log_impl(&dword_1CD062000, v139, OS_LOG_TYPE_ERROR, "%{public}@[%@] Matter firmware version is invalid: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v139, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v173 = 2112;
            v174 = v82;
            _os_log_impl(&dword_1CD062000, v139, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to register UARP accessory %@", buf, 0x20u);
...
LABEL_96:
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v177 = 2112;
      v178 = v81;
      _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not registering accessory %@ with FirmwareUpdateManager. Details: validAFUSettings = %@, validDynamicAssetUpdateSettings = %@", buf, 0x34u);
...
LABEL_45:
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v181 = 2112;
    v182 = v66;
    _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@[%@] Valid AFU settings = %@ : isOwner = %@, hasFirmwareUpdateProfile = %@, hasFirmwareVersion = %@, identityType = %@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v171 = 2112;
    v172 = v19;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Accessory already registered with FirmwareUpdateManager", buf, 0x16u);
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v81 = 2112;
      v82 = v26;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Setting userInitiatedFirmwareStaging to %@", buf, 0x20u);
    ...
    if ((v28 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v79 = 2112;
        v80 = v41;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot change source for unregistered accessory", buf, 0x16u);
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v83 = 2112;
        v84 = v48;
        _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Looking for %@ in accessoryList %@", buf, 0x2Au);
    ...
    if (a4 == 2)
    {
      ...
      if (!objc_msgSend(v13, "length"))
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v81 = 2112;
          v82 = v67;
          _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_ERROR, "%{public}@[%@] Invalid path for asset source %@", buf, 0x20u);
      ...
      v29 = objc_alloc(MEMORY[0x1E0D1A650]);
      v30 = 0;
    }
    else
    {
        ...
        if (v49)
        {
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544898;
            ...
            v89 = 2112;
            v90 = v33;
            _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@[%@] Successfully changed source to %@ %@ %@ for accessory <%@> asset <%@>", buf, 0x48u);
        ...
        else
        {
          if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544642;
            ...
            v87 = 2112;
            v88 = v59;
            _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to change source to %@ %@ %@ for accessory %@", buf, 0x3Eu);
...
LABEL_33:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v79 = 2112;
    v80 = v35;
    _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot change source for unsupported accessory", buf, 0x16u);
...
LABEL_13:
        _os_log_impl(&dword_1CD062000, v19, v20, v18, v28, 0x20u);
...
LABEL_15:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v28[22] = 2112;
    v29 = v26;
    _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Not unregistering accessory %@ - unsupported", v28, 0x20u);
...
- (BOOL)checkForUpdateForAccessory:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Cannot check for update for accessory - unsupported", (uint8_t *)&v14, 0x16u);
...
- (void)startStatusTimer
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 13, 86400.0);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Default asset source: %@", (uint8_t *)&v12, 0x16u);

  }
  objc_autoreleasePoolPop(v6);
  -[HMDAccessoryFirmwareUpdateManager activeSessions](v7, "activeSessions");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "enumerateKeysAndObjectsUsingBlock:", &__block_literal_global_80_122651);
...
- (void)removeSession:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Removing session %@", (uint8_t *)&v17, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@removeSession: No accessory UUID exists", (uint8_t *)&v17, 0xCu);
...
- (id)addSessionForUARPAccessory:(id)a3
{
  ...
  if (-[HMDAccessoryFirmwareUpdateManager supportsFirmwareUpdate](self, "supportsFirmwareUpdate"))
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = v4;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@[%@] Created session %@ for accessory", (uint8_t *)&v28, 0x20u);
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v32 = 2112;
        v33 = v8;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] New firmwareUpdateSession %@", (uint8_t *)&v28, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v30 = 2112;
        v31 = v4;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find HAPAccessory from UARPHomeKitAccessory %@", (uint8_t *)&v28, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v28 = 138543362;
      v29 = v24;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update not enabled on this device; ignoring",
        (uint8_t *)&v28,
        0xCu);
...
- (id)findHMDHAPAccessoryWithUARPAccessory:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v25 = 2112;
        v26 = v8;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory %@ is not a HAPAccessory", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v25 = 2112;
      v26 = v17;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory %@ not found in homes", (uint8_t *)&v23, 0x16u);
...
- (id)UARPAccessoryForHMDAccessory:(id)a3
{
  ...
  if (objc_msgSend(v4, "identityType"))
  {
    ...
    if (!v6)
    {
      v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D1A648]), "initWithHMDHAPAccessory:", v4);
      v7 = (void *)MEMORY[0x1D17BA0A0]();
      v8 = self;
      HMFGetOSLogHandle();
      v9 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        v27 = 2112;
        v28 = v12;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Initialized UARP Accessory %@ from HAP Accessory %@", (uint8_t *)&v21, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v19;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@[%@] Unknown identity type for %@", (uint8_t *)&v21, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v19 = 2112;
        v20 = v14;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not available session for accessory", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v10);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, 0, CFSTR("Invalid state: session not available for accessory"), 0);
      v4 = (void *)objc_claimAutoreleasedReturnValue();
      (*((void (**)(void))a1[5] + 2))();
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@[%@] Accessory not registered", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v5);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, 0, CFSTR("accessory not registered"), 0);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    (*((void (**)(void))a1[5] + 2))();
  }
...
void __55__HMDAccessoryFirmwareUpdateManager_registerAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@[%@] Registering accessory with FirmwareUpdateManager", (uint8_t *)&v12, 0x16u);
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "_registerAccessory:source:path:", *(_QWORD *)(a1 + 40), objc_msgSend(*(id *)(a1 + 32), "defaultUpdateAssetSourceWithAccessory:", *(_QWORD *)(a1 + 40)), 0) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@[%@] FirmwareUpdateManager Registration failed for accessory", (uint8_t *)&v12, 0x16u);
...
void __72__HMDAccessoryFirmwareUpdateManager_defaultProductDataUpdateAssetSource__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting MFi default container to: %@", (uint8_t *)&v10, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t80 != -1)
    dispatch_once(&logCategory__hmf_once_t80, &__block_literal_global_122760);
