...
{
  objc_msgSend(MEMORY[0x1E0CB36F8], "setClassName:forClass:", CFSTR("HMDAccessory"), objc_opt_class());
  objc_msgSend(MEMORY[0x1E0CB3710], "setClass:forClassName:", objc_opt_class(), CFSTR("HMDAccessory"));
  objc_msgSend(MEMORY[0x1E0CB36F8], "setClassName:forClass:", CFSTR("HMDCharacteristicNotificationRegistry"), objc_opt_class());
  objc_msgSend(MEMORY[0x1E0CB3710], "setClass:forClassName:", objc_opt_class(), CFSTR("HMDCharacteristicNotificationRegistry"));
  objc_msgSend(MEMORY[0x1E0CB36F8], "setClassName:forClass:", CFSTR("HMDResidentDeviceManager"), objc_opt_class());
  objc_msgSend(MEMORY[0x1E0CB3710], "setClass:forClassName:", objc_opt_class(), CFSTR("HMDResidentDeviceManager"));
  objc_msgSend(MEMORY[0x1E0CB3710], "setClass:forClassName:", objc_opt_class(), CFSTR("HMDWHAAccessory"));
}
