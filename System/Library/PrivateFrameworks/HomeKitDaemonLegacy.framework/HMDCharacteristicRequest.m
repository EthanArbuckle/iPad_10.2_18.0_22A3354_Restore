...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_182488 != -1)
    dispatch_once(&logCategory__hmf_once_t1_182488, &__block_literal_global_182489);
  return (id)logCategory__hmf_once_v2_182490;
}
...
void __39__HMDCharacteristicRequest_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_182490;
  logCategory__hmf_once_v2_182490 = v0;
