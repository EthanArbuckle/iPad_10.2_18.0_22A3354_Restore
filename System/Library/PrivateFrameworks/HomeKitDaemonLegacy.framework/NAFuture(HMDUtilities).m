...
- (id)hmfFuture
{
  ...
  v11 = 0;
  objc_msgSend(MEMORY[0x1E0D28588], "futureWithPromise:", &v11);
...
+ (id)combineAllFuturesFlatteningArrayResults:()HMDUtilities
{
  ...
  objc_msgSend(v7, "flatMap:", &__block_literal_global_649);
...
+ (id)combineAllFuturesIgnoringEmptyResults:()HMDUtilities
{
  ...
  objc_msgSend(v7, "flatMap:", &__block_literal_global_652);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
