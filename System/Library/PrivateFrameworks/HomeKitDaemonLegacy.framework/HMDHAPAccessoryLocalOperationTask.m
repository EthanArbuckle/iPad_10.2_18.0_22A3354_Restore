      ...
      for (i = 0; i != v35; ++i)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138544642;
          ...
          v53 = 2048;
          v54 = v23;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@[%{public}@] Starting for accessory %@/%{public}@/%{public}@ with %ld requests", buf, 0x3Eu);
...
void __104__HMDHAPAccessoryLocalOperationTask__completionHandlerForAccessory_accessoryRequests_responseWaitGroup___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138545410;
    ...
    v48 = 2114;
    v49 = v6;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@[%{public}@] Completed operation for accessory %@/%{public}@/%{public}@ with %ld/%ld responses. Execution Time: %.3fs. Error: %{public}@", buf, 0x5Cu);
