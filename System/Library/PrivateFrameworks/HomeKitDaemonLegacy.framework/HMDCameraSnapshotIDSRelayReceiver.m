...
- (void)_startDataReceive
{
  ...
  v7 = dispatch_source_create(MEMORY[0x1E0C80DB8], v5, 0, v6);
...
- (void)_handleDataFromSocket:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 138543362;
      v41 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Socket source is already nil, rejecting the data from socket", (uint8_t *)&v40, 0xCu);
LABEL_20:
  ...
  if (!-[HMDCameraSnapshotIDSRelayReceiver expectedByteCount](self, "expectedByteCount"))
  {
    ...
    if (v18 > 7)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting expected byte count to %llu", (uint8_t *)&v40, 0x16u);
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Only received %lu bytes that represent the expected byte count so far; will wait for more",
        (uint8_t *)&v40,
        0x16u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDCameraSnapshotIDSRelayReceiver receivedByteCount](v27, "receivedByteCount"));
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", objc_msgSend(v4, "length") + -[HMDCameraSnapshotIDSRelayReceiver receivedByteCount](v27, "receivedByteCount"));
    ...
    v44 = 2112;
    v45 = v31;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Updating received byte count from %@ to %@", (uint8_t *)&v40, 0x20u);
  ...
  if (v32 == -[HMDCameraSnapshotIDSRelayReceiver expectedByteCount](v27, "expectedByteCount"))
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 138543362;
      v41 = v36;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@All the bytes have been received, file transfer is complete", (uint8_t *)&v40, 0xCu);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v12 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSRelayReceiver", buf, 0xCu);
...
LABEL_21:
      _os_log_impl(&dword_1CD062000, v54, v55, v53, buf, 0x16u);
        ...
        if ((v30 & 1) != 0)
        {
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v85 = 2112;
            v86 = v14;
            _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Received invitation for session %@ from %@", buf, 0x20u);
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v82 = v47;
            _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Accepted invitation", buf, 0xCu);
        ...
        else
        {
          if (os_log_type_enabled(v33, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v83 = 2112;
            v84 = v71;
            _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring invitation for camera session ID: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v68, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v83 = 2112;
          v84 = v23;
          _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_ERROR, "%{public}@Could not find camera session ID in payload: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v86 = v64;
        v65 = v64;
        _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unarchived payload was not an NSDictionary: %@ (%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v83 = 2112;
      v84 = v76;
      _os_log_impl(&dword_1CD062000, v58, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive payload from context data: %@", buf, 0x16u);
...
- (void)sessionStarted:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2114;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Session %{public}@ has started", (uint8_t *)&v11, 0x16u);
...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2114;
    v22 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Session %{public}@ has ended with reason: %{public}u and error: %{public}@", (uint8_t *)&v15, 0x26u);
...
void __54__HMDCameraSnapshotIDSRelayReceiver__startDataReceive__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2048;
    v17 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Received data of length %ld", buf, 0x16u);
  ...
  if (v3)
  {
    if (v3 < 1)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v15 = v12;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Recv from socket returned error, aborting the file receive", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v9);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1032);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "_didReceiveData:error:", 0, v8);
    }
    else
    {
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v13, v3);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_167666 != -1)
    dispatch_once(&logCategory__hmf_once_t0_167666, &__block_literal_global_167667);
  return (id)logCategory__hmf_once_v1_167668;
}
...
void __48__HMDCameraSnapshotIDSRelayReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_167668;
  logCategory__hmf_once_v1_167668 = v0;
