...
- (HMDDuetPredictionSubscriber)initWithWorkQueue:(id)a3 messageDispatcher:(id)a4
{
  ...
  v6 = (objc_class *)MEMORY[0x1E0CBA498];
  v7 = a4;
  v8 = a3;
  ...
  if (-[HMDDuetPredictionSubscriber duetPredictionsChangedNotificationToken](self, "duetPredictionsChangedNotificationToken") == -1)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Registering for duet prediction change notifications", buf, 0xCu);
...
void __40__HMDDuetPredictionSubscriber_configure__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Received notification duet predictions changed", (uint8_t *)&v12, 0xCu);
    ...
    objc_msgSend(MEMORY[0x1E0D285F8], "entitledMessageWithName:messagePayload:", *MEMORY[0x1E0CB9E98], 0);
