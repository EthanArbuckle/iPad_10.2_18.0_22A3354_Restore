...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDHomeKeySetupLockLogEvent success](self, "success"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("success"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomeKeySetupLockLogEvent expectedCount](self, "expectedCount"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v6, CFSTR("expectedCount"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomeKeySetupLockLogEvent completedCount](self, "completedCount"));
