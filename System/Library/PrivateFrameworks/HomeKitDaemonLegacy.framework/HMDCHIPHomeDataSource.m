...
LABEL_7:
  ...
  if (v10)
  {
    ...
    v12 = (NSRecursiveLock *)objc_alloc_init(MEMORY[0x1E0CB38E0]);
    lock = v11->_lock;
    v11->_lock = v12;
...
LABEL_18:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v40 = v22;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", buf, 0xCu);
...
- (void)updateFabricID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model fabric ID to %@", buf, 0x16u);
...
- (void)updateLastNodeID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model last node ID to %@", buf, 0x16u);
...
- (void)updateRootCertificate:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model root certificate to %@", buf, 0x16u);
...
- (void)updateOperationalCertificate:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model operational certificate to %@", buf, 0x16u);
...
- (void)updateIntermediateCertificate:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model intermediate certificate to %@", buf, 0x16u);
...
- (void)updateKeyValueStoreWithBlock:(id)a3 completion:(id)a4
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating home model key-value store", buf, 0xCu);
    ...
    -[HMDCHIPHomeDataSource _updateHomeModelWithLabel:completion:block:](v10, "_updateHomeModelWithLabel:completion:block:", CFSTR("Update CHIP key-value store"), v7, v17);
    v14 = v18;
  }
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v15;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", buf, 0xCu);
...
- (NSSet)allNodeIDs
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(v6, "na_map:", &__block_literal_global_111918);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "na_filter:", &__block_literal_global_32);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", (uint8_t *)&v15, 0xCu);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v4;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find accessory with CHIP node ID: %@", buf, 0x16u);
...
LABEL_14:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v24;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", buf, 0xCu);
...
{
  return objc_msgSend(a2, "isEqual:", &unk_1E8B33BE8) ^ 1;
}
...
uint64_t __65__HMDCHIPHomeDataSource_updateKeyValueStoreWithBlock_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if ((_DWORD)v8)
  {
    ...
    objc_msgSend(v5, "setChipKeyValueStore:", v9);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_111959 != -1)
    dispatch_once(&logCategory__hmf_once_t15_111959, &__block_literal_global_39_111960);
  return (id)logCategory__hmf_once_v16_111961;
}
...
void __36__HMDCHIPHomeDataSource_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v16_111961;
  logCategory__hmf_once_v16_111961 = v0;
