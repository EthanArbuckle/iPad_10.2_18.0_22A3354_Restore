...
+ (int64_t)_outputGenderFromString:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v4;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unknown gender option %@", (uint8_t *)&v11, 0x16u);
...
+ (id)_outputGenderStringFromAFVoiceGender:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Unknown Voice Gender Value", (uint8_t *)&v9, 0xCu);
...
+ (id)languageValueFromHPLanguageValue:(id)a3
{
  ...
  v3 = (void *)MEMORY[0x1E0CBA4E8];
  v4 = (objc_class *)MEMORY[0x1E0CBA810];
  v5 = a3;
  v6 = [v4 alloc];
...
+ (id)transformHPLanguageItemsToLanguageListValue:(id)a3
{
  ...
  if (v4)
  {
    objc_msgSend(v4, "na_map:", &__block_literal_global_185597);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Empty language item list", (uint8_t *)&v12, 0xCu);
