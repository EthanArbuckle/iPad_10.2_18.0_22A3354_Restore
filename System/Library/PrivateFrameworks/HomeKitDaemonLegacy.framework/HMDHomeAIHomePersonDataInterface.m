...
- (HMDHomeAIHomePersonDataInterface)initWithPersonManagerUUID:(id)a3 homeUUID:(id)a4 workQueue:(id)a5
{
  ...
  v8 = (objc_class *)MEMORY[0x1E0D31A78];
  v9 = a5;
  v10 = a4;
  v11 = a3;
...
- (void)handleUpdatedSettings:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Updated settings could not be converted into HMIHomePersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
...
- (void)handleFaceMisclassificationForFaceCropData:(id)a3 personUUID:(id)a4
{
  ...
  v9 = objc_alloc(MEMORY[0x1E0D31A98]);
  objc_msgSend(MEMORY[0x1E0CB3A28], "UUID");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99D68], "date");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = (void *)objc_msgSend(v9, "initWithUUID:dataRepresentation:dateCreated:faceBoundingBox:personUUID:", v10, v6, v11, v7, *MEMORY[0x1E0CB8C80], *(double *)(MEMORY[0x1E0CB8C80] + 8), *(double *)(MEMORY[0x1E0CB8C80] + 16), *(double *)(MEMORY[0x1E0CB8C80] + 24));
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v12;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Notifying HomeAI home person manager of misclassified person for face crop: %@", (uint8_t *)&v18, 0x16u);
...
void __73__HMDHomeAIHomePersonDataInterface_removeFaceprintsWithUUIDs_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing faceprints with UUIDs: %@", buf, 0x16u);
...
void __72__HMDHomeAIHomePersonDataInterface_removeFaceCropsWithUUIDs_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing face crops with UUIDs: %@", buf, 0x16u);
...
void __70__HMDHomeAIHomePersonDataInterface_removePersonsWithUUIDs_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing persons with UUIDs: %@", buf, 0x16u);
...
void __61__HMDHomeAIHomePersonDataInterface_addFaceprints_completion___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Adding faceprints: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v2);
  objc_msgSend(a1[5], "na_map:", &__block_literal_global_17_110666);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
id __61__HMDHomeAIHomePersonDataInterface_addFaceprints_completion___block_invoke_15(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA500];
  v3 = a2;
...
void __60__HMDHomeAIHomePersonDataInterface_addFaceCrops_completion___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Adding face crops: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v2);
  objc_msgSend(a1[5], "na_map:", &__block_literal_global_13_110670);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1[4], "dataSource");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
id __60__HMDHomeAIHomePersonDataInterface_addFaceCrops_completion___block_invoke_11(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA4F8];
  v3 = a2;
...
void __58__HMDHomeAIHomePersonDataInterface_addPersons_completion___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Adding persons: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v2);
  objc_msgSend(a1[5], "na_map:", &__block_literal_global_8_110674);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(a1[4], "dataSource");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
id __58__HMDHomeAIHomePersonDataInterface_addPersons_completion___block_invoke_6(uint64_t a1, void *a2)
{
  ...
  v2 = (objc_class *)MEMORY[0x1E0CBA738];
  v3 = a2;
...
void __64__HMDHomeAIHomePersonDataInterface_fetchSettingsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Fetching settings", (uint8_t *)&v15, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Fetched settings could not be converted into HMIHomePersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
...
void __80__HMDHomeAIHomePersonDataInterface_fetchAllUnassociatedFaceCropsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Fetching all unassociated face crops", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v17 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch all unassociated face crops because data is not available", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_110689 != -1)
    dispatch_once(&logCategory__hmf_once_t0_110689, &__block_literal_global_110690);
  return (id)logCategory__hmf_once_v1_110691;
}
...
void __47__HMDHomeAIHomePersonDataInterface_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_110691;
  logCategory__hmf_once_v1_110691 = v0;
