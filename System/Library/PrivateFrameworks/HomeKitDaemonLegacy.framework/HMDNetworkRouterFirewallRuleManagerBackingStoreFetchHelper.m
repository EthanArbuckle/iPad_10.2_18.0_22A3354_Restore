...
- (HMDNetworkRouterFirewallRuleManagerBackingStoreFetchHelper)initWithActivity:(id)a3 options:(id)a4 container:(id)a5 useAnonymousRequests:(BOOL)a6 promise:(id)a7
{
  ...
  v13 = a4;
  v14 = a7;
  v15 = (objc_class *)MEMORY[0x1E0C94F80];
  v16 = a5;
  ...
  if (v20)
  {
    ...
    v21->_retryIntervalSeconds = *(double *)MEMORY[0x1E0D32C10];
  ...
  if (!self->_finished)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v11 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Forgot to call finishWithError", buf, 0xCu);
...
- (BOOL)shouldRetry
{
  ...
  if (-[HMDNetworkRouterFirewallRuleManagerBackingStoreFetchHelper retryCount](self, "retryCount") <= v3)
  {
    ...
    if (!v10)
      return self->_retryIntervalSeconds != *MEMORY[0x1E0D32C10];
...
LABEL_9:
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, v9, buf, 0x16u);
...
- (void)setShouldRetry:(BOOL)a3
{
  if (a3)
  {
    if (self->_retryIntervalSeconds == *MEMORY[0x1E0D32C10])
      self->_retryIntervalSeconds = 0.0;
  }
  else
  {
    self->_retryIntervalSeconds = *(double *)MEMORY[0x1E0D32C10];
  }
}
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  if (self->_finished)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Finished more than once!", buf, 0xCu);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Fetch failed with error: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch succeeded", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0 != -1)
    dispatch_once(&logCategory__hmf_once_t0, &__block_literal_global_571);
