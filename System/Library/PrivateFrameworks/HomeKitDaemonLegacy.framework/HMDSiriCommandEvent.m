...
LABEL_12:
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEFAULT, v31, buf, 0xCu);
...
LABEL_13:
  ...
  if (v21)
  {
    ...
    if (v24)
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDSiriCommandEventErrorDomain"), v24, 0);
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDSiriCommandEvent durationMilliseconds](self, "durationMilliseconds"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDSiriCommandEvent numberOfEntities](self, "numberOfEntities"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("numTargetedEntities"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDSiriCommandEvent numberOfFailures](self, "numberOfFailures"));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("numFailures"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDSiriCommandEvent numberOfIncompletions](self, "numberOfIncompletions"));
  ...
  if (-[HMDSiriCommandEvent numberOfEntities](self, "numberOfEntities"))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", 100 - v12);
...
+ (unint64_t)generateErrorCodeWithNumberOfFailures:(unint64_t)a3 numberOfIncompletions:(unint64_t)a4 commandOutcome:(id)a5
{
  ...
  v7 = a5;
  v8 = v7;
  if (a4 || (objc_msgSend(v7, "isEqualToString:", *MEMORY[0x1E0D88930]) & 1) != 0)
  {
    v9 = 2;
  }
  else if (a3)
  ...
  {
    v9 = objc_msgSend(v8, "isEqualToString:", *MEMORY[0x1E0D88910]) ^ 1;
  }
