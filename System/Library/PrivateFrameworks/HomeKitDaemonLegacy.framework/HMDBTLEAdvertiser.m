...
- (void)_cancelOn:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Wireless - Cancelling advertisement timer for %@", (uint8_t *)&v17, 0x16u);
...
- (void)_startAdvertising
{
  ...
  if (!v3)
  {
    ...
    if (v5)
    {
      ...
      v8 = objc_alloc_init(MEMORY[0x1E0D1B320]);
      -[HMDBTLEAdvertiser setLeAdvertiser:](self, "setLeAdvertiser:", v8);

      v9 = objc_alloc(MEMORY[0x1E0D285C0]);
      -[HMDBTLEAdvertiser accessory](self, "accessory");
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2112;
        v29 = v20;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Wireless - Starting BT LE Advertisement for %@", (uint8_t *)&v26, 0x16u);
      ...
      v22 = objc_alloc(MEMORY[0x1E0D286C8]);
...
- (void)_advertisementTimeout
{
  ...
  if (v3)
  {
    ...
    v6 = (void *)MEMORY[0x1D17BA0A0](-[HMDBTLEAdvertiser _clearAdvertiser](self, "_clearAdvertiser"));
    v7 = self;
    HMFGetOSLogHandle();
    v8 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Wireless - Starting reachable timer for accessory: %@", (uint8_t *)&v18, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Wireless LE Timeout - no gleAdvertiser", (uint8_t *)&v18, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  v13[1] = v13;
  v13[2] = 0x3032000000;
  v13[3] = __Block_byref_object_copy__41441;
  v13[4] = __Block_byref_object_dispose__41442;
  v4 = a3;
  v14 = v4;
  v5 = (void *)MEMORY[0x1D17BA0A0]();
  v6 = self;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v19 = 2112;
    v20 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Wireless Timer: %@ did fire for %@", buf, 0x20u);
...
void __34__HMDBTLEAdvertiser_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v11;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Wireless BTLE Advertisement timeout for %@", (uint8_t *)&v18, 0x16u);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 2112;
        v21 = v17;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unexpected BTLE Advertisement timer for %@", (uint8_t *)&v18, 0x16u);
  ...
  if (v3 > 5 || ((1 << v3) & 0x29) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Wireless - Ignoring power on request -- Bluetooth not in a state to turn on accessory: %@", buf, 0x16u);
