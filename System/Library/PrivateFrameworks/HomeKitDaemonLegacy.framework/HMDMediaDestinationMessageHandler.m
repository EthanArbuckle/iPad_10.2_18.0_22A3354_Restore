...
{
  return -[HMDMediaDestinationMessageHandler initWithDestination:messageDispatcher:notificationCenter:notifications:dataSource:delegate:](self, "initWithDestination:messageDispatcher:notificationCenter:notifications:dataSource:delegate:", a3, a4, a5, MEMORY[0x1E0C9AA60], a6, a7);
}
...
LABEL_11:
  ...
  if (!v17)
    goto LABEL_11;
  v20 = v19;
  v28[0] = *MEMORY[0x1E0CB94B8];
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v28, 1);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = *MEMORY[0x1E0CB94C0];
...
- (void)sendRequestToUpdateAudioGroupIdentifier:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v36 = 2112;
    v37 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending request to update audio group identifier: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v8);
  if (v7)
  {
    v32 = *MEMORY[0x1E0CB9460];
    objc_msgSend(v6, "UUIDString");
    v12 = objc_claimAutoreleasedReturnValue();
    v13 = (void *)v12;
    v14 = *MEMORY[0x1E0CB9498];
    if (v12)
      v14 = v12;
    v33 = v14;
    ...
    v20 = (void *)objc_msgSend(v19, "initWithName:destination:payload:", *MEMORY[0x1E0CB94B8], v18, v15);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to set completion to update support options", buf, 0xCu);
...
- (void)sendRequestToUpdateSupportOptions:(unint64_t)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v34 = 2112;
    v35 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending request to update destination support options: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v7);
  if (v6)
  {
    v30 = *MEMORY[0x1E0CB94A8];
    ...
    v18 = (void *)objc_msgSend(v17, "initWithName:destination:payload:", *MEMORY[0x1E0CB94C0], v16, v13);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to set completion to update support options", buf, 0xCu);
...
- (void)handleUpdatedDestination:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling updated destination: %@", (uint8_t *)&v10, 0x16u);

  }
  objc_autoreleasePoolPop(v5);
  -[HMDMessageHandler notificationCenter](v6, "notificationCenter");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "postNotificationName:object:", *MEMORY[0x1E0CB94C8], v4);
...
- (id)audioGroupIdentifierInMessage:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    objc_msgSend(v7, "hmf_stringForKey:", *MEMORY[0x1E0CB9460]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v9;
    if (v9)
    {
...
LABEL_16:
    ...
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, v16, (uint8_t *)&v22, 0x16u);
  ...
  if (a4)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v6;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", (uint8_t *)&v22, 0x16u);
...
- (unint64_t)supportedOptionsInMessage:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    objc_msgSend(v7, "hmf_numberForKey:", *MEMORY[0x1E0CB94A8]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v9;
    if (v9)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = v8;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to get supported options from message payload: %@", (uint8_t *)&v21, 0x16u);
  ...
  else if (a4)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", (uint8_t *)&v21, 0x16u);
...
- (void)handleMediaDestinationUpdateAudioGroupIdentifierRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update destination audio group identifier request message", buf, 0xCu);
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v30 = 2112;
        v31 = v4;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get audio group identifier from update audio group identifier request message: %@", buf, 0x16u);
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v29 = v25;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to update audio group identifier due to no delegate", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v4;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response handler from update destination audio group identifier request message: %@", buf, 0x16u);
...
- (void)handleMediaDestinationUpdateSupportedOptionsRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v30 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update destination supported options request message", buf, 0xCu);
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v4;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response handler from update destination supported options request message: %@", buf, 0x16u);
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v4;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get supported options from update destination supported options request message: %@", buf, 0x16u);
...
LABEL_11:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Failed to update supported options due to no delegate", buf, 0xCu);
...
void __82__HMDMediaDestinationMessageHandler_sendRequestToUpdateSupportOptions_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Update destination supported options request message responded with error: %@", (uint8_t *)&v12, 0x16u);
...
void __88__HMDMediaDestinationMessageHandler_sendRequestToUpdateAudioGroupIdentifier_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Update audio group identifier request message responded with error: %@", (uint8_t *)&v12, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t20_121980 != -1)
    dispatch_once(&logCategory__hmf_once_t20_121980, &__block_literal_global_121981);
  return (id)logCategory__hmf_once_v21_121982;
}
...
void __48__HMDMediaDestinationMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v21_121982;
  logCategory__hmf_once_v21_121982 = v0;
