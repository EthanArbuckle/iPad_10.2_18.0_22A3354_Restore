...
- (id)_makeRemoteTaskWithRequests:(id)a3 delegateDevice:(id)a4 completion:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = objc_msgSend(v10, "na_any:", &__block_literal_global_356_180516);
  ...
  v22 = objc_msgSend(v10, "na_map:", &__block_literal_global_465);
...
- (id)_makeLocalTaskWithRequests:(id)a3 completion:(id)a4
{
  ...
  v10 = objc_msgSend(v7, "na_map:", &__block_literal_global_465);
