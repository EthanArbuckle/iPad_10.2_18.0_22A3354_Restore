...
- (void)dealloc
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB8A88], *MEMORY[0x1E0CB99F8]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Not disabling notification since diagnostics snapshot characteristic is not present", buf, 0xCu);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2048;
    v20 = v13;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Accessory diagnostics manager: %p destroyed", buf, 0x16u);
...
- (void)_start
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v11, 0xCu);
...
- (void)_shutDown
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Shutting down", (uint8_t *)&v8, 0xCu);
...
- (void)_registerForMessagesAndNotifications
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v17;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Expected diagnostics characteristic not present for accessory(%@/%@)", (uint8_t *)&v18, 0x20u);
...
- (void)_updateDiagnosticSettings
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "findCharacteristicWithType:", *MEMORY[0x1E0CB8A88]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (!v35)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v59 = 2112;
          v60 = v51;
          _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse accessory supported diagnostics snapshot (%@/%@) with error: %@", buf, 0x2Au);
    ...
    if ((v14 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v61 = 2112;
        v62 = v9;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating accessory diagnostics snapshot for %@/%@: %@ -> %@", buf, 0x34u);
...
LABEL_10:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v57 = 2112;
    v58 = (uint64_t)v34;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@No diagnostics supported configuration (%@/%@)", buf, 0x20u);
...
LABEL_33:
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, v17, (uint8_t *)&v45, 0xCu);
...
LABEL_35:
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      v45 = 138543362;
      v46 = v31;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@No options selected, default request will be issued.", (uint8_t *)&v45, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v45 = 138543362;
      v46 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Diagnostic settings not configured yet", (uint8_t *)&v45, 0xCu);
...
- (void)_readRequiredDiagnosticCharacteristicsIfNeededWithCompletion:(id)a3
{
  ...
  -[HMDAccessoryDiagnosticsManager diagnosticsService](self, "diagnosticsService");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "findCharacteristicWithType:", *MEMORY[0x1E0CB8A88]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else if (objc_msgSend(v8, "isReachable"))
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v15;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Attempting to read and update the diagnostic settings for %@", buf, 0x16u);
...
- (void)_handleDiagnosticsTransferRequestWithOptions:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v53 = v12;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Attempting to start diagnostics transfer", buf, 0xCu);
    ...
    if (v15)
    {
      ...
      if (v27)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v53 = v31;
          _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@A session is already opened", buf, 0xCu);
      ...
      else if (-[HMDAccessoryDiagnosticsManager cloudFetchCompleted](v10, "cloudFetchCompleted"))
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v54 = 2112;
          v55 = v41;
          _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_INFO, "%{public}@Setting up a diagnostics transfer session: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v53 = v46;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Diagnostic cloud metadata not available", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v54 = 2112;
        v55 = v16;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Transport is not data stream, error: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Diagnostics transfer failed as the request is not supported.", buf, 0xCu);
...
- (void)_readDiagnosticsDataWithCloudKitMetadataRequirement:(BOOL)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v22 = 2112;
    v23 = v10;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Read diagnostics data for session: %@", buf, 0x16u);
...
- (void)_clearCurrentDiagnosticsSession:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Clear current session: %@ with error: %@", (uint8_t *)&v13, 0x20u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v7;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Diagnostics data read failed with error: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v21;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Diagnostics metadata not required for session:%@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v17);
    v22 = objc_alloc(MEMORY[0x1E0CBA230]);
    objc_msgSend(MEMORY[0x1E0C99E98], "URLWithString:", &stru_1E89C3E38);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0C99E98], "URLWithString:", &stru_1E89C3E38);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    v25 = (void *)objc_msgSend(v22, "initWithSnapshotPath:urlParameters:privacyPolicyURL:uploadDestination:consentVersion:uploadType:", v8, v9, v23, v24, &unk_1E8B340C8, &unk_1E8B340C8);
...
void __97__HMDAccessoryDiagnosticsManager__readDiagnosticsDataWithCloudKitMetadataRequirement_completion___block_invoke_33(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Fetching cloud metadata from model failed with error: %@", buf, 0x16u);
  ...
  {
    v25 = objc_alloc(MEMORY[0x1E0CBA230]);
    v13 = *(_QWORD *)(a1 + 32);
    v14 = *(_QWORD *)(a1 + 40);
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v5, "consentVersion"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v26 = v5;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v5, "uploadType"));
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v19;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Diagnostics data read completed for session:%@ metadata:%@", buf, 0x20u);
...
void __90__HMDAccessoryDiagnosticsManager__handleDiagnosticsTransferRequestWithOptions_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v9)
  {
    ...
    if (v5)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v5;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to setup data transfer session with error: %@", (uint8_t *)&v23, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v20;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Diagnostics transfer session was setup successfully", (uint8_t *)&v23, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 138543362;
      v24 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to setup data transfer session, current diagnostics session is nil", (uint8_t *)&v23, 0xCu);
...
void __83__HMDAccessoryDiagnosticsManager__handleDiagnosticsTransferWithOptions_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to read the required diagnostic characteristics. Error: %@", (uint8_t *)&v10, 0x16u);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v20 = 2112;
      v21 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Diagnostics transfer request failed for message: %@. Error: %@.", buf, 0x20u);
...
void __72__HMDAccessoryDiagnosticsManager_handleAccessoryConfiguredNotification___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to read the required diagnostic characteristics with error: %@", (uint8_t *)&v8, 0x16u);
...
- (void)_fetchModelDiagnosticsMetadataForAccessory:(id)a3 withCompletion:(id)a4
{
  ...
  if (v10)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v25 = 2112;
      v26 = v10;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Fetching diagnostics parameters locally for accessory with identifier %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v17;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unable to get cloud diagnostics parameters due to failure to derive identifier for accessory", buf, 0xCu);
...
void __99__HMDAccessoryDiagnosticsManager_Cloud___fetchModelDiagnosticsMetadataForAccessory_withCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Fetched accessory metadata for %@ failed with error %@", (uint8_t *)&v39, 0x20u);
  ...
  else if (v5)
  {
    ...
    if (v15)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v43 = 2112;
        v44 = v22;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Fetched diagnostics metadata %@ from model for accessory with identifier %@", (uint8_t *)&v39, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v41 = 2112;
        v42 = v37;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Diagnostics metadata not present in version configuration for accessory %@", (uint8_t *)&v39, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      v41 = 2112;
      v42 = v33;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Fetched accessory metadata for %@ failed due to nil metadata", (uint8_t *)&v39, 0x16u);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start up firewall rule manager: %@", buf, 0x16u);
...
void __96__HMDAccessoryDiagnosticsManager_Cloud____fetchCloudDiagnosticsMetadataForAccessory_completion___block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch changes from firewall rule manager: %@", (uint8_t *)&v12, 0x16u);
    ...
    if (v3)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v15 = 2112;
        v16 = v3;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch cloud diagnostics metadata with error: %@", buf, 0x16u);
...
uint64_t __71__HMDAccessoryDiagnosticsManager_Cloud___fetchCloudDiagnosticsMetadata__block_invoke_1(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v8;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@fetching diagnostics cloud metadata for accessory %@ completed with error: %@", (uint8_t *)&v10, 0x20u);
