...
+ (id)properties
{
  if (properties_onceToken_67534 != -1)
    dispatch_once(&properties_onceToken_67534, &__block_literal_global_67535);
  return (id)properties__properties_67536;
}
...
void __26__HMDZoneModel_properties__block_invoke()
{
  ...
  v3 = (void *)properties__properties_67536;
  properties__properties_67536 = v2;
