...
- (void)updateDestinationIdentifier:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v20 = 2112;
    v21 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating to destination identifier: %@", buf, 0x16u);
...
- (void)updateSupportedOptions:(unint64_t)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating to supported options: %@", buf, 0x16u);
...
- (void)updateAvailableDestinationIdentifiers:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v20 = 2112;
    v21 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating to available destination identifiers: %@", buf, 0x16u);
...
- (void)removeControllerWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v16 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing destination controller", buf, 0xCu);
...
- (void)mergeData:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Merged data: %@", (uint8_t *)&v11, 0x16u);
...
- (void)recoverDueToNoRecordInCloudWithHome:(id)a3 migrationQueue:(id)a4 completion:(id)a5
{
  ...
  -[HMDMediaDestinationControllerBackingStoreHandler data](v12, "data");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)migrateWithCurrentCloudRecord:(id)a3 home:(id)a4 cloudZone:(id)a5 migrationQueue:(id)a6 completion:(id)a7
{
  ...
  int v28;
  void *v29;
  HMDMediaDestinationControllerBackingStoreHandler *v30;
  NSObject *v31;
  void *v32;
  void *v33;
  HMDMediaDestinationControllerBackingStoreHandler *v34;
  NSObject *v35;
  id v36;
  void *v37;
  id v38;
  ...
  if (v19)
  {
    ...
    objc_msgSend(v19, "destinationModelIdentifier");
    ...
    if (v23)
    {
      objc_msgSend(v19, "availableDestinationModelIdentifiers");
      ...
      if (v25 == objc_msgSend(v26, "count"))
      {
        ...
        v38 = v20;
        v44 = v38;
        v28 = objc_msgSend(v27, "na_allObjectsPassTest:", v43);
...
LABEL_18:
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v51 = 2112;
      v52 = v20;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Recovering due to miss matched model: %@ data: %@", buf, 0x20u);

      v13 = v36;
    }

    objc_autoreleasePoolPop(v33);
    -[HMDMediaDestinationControllerBackingStoreHandler recoverDueToInvalidRecordInCloudWithHome:migrationQueue:completion:](v34, "recoverDueToInvalidRecordInCloudWithHome:migrationQueue:completion:", v13, v15, v16);
    goto LABEL_18;
  }
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v49 = 2112;
    v50 = v12;
    _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to migrate due to unknown model extracted from record: %@", buf, 0x16u);
...
- (void)recoverDueToInvalidRecordInCloudWithHome:(id)a3 migrationQueue:(id)a4 completion:(id)a5
{
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDMediaDestinationControllerBackingStoreHandler metricsEventDispatcher](v12, "metricsEventDispatcher");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "submitFailureEventWithEventErrorCode:error:", 11, v15);
  ...
  objc_msgSend(v8, "dropAllChangesWithObjectID:", v18);
  -[HMDMediaDestinationControllerBackingStoreHandler data](v12, "data");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  +[HMDMediaDestinationControllerBackingStoreHandler backingStoreObjectForData:](HMDMediaDestinationControllerBackingStoreHandler, "backingStoreObjectForData:", v19);
  v20 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)notifyDidUpdateDestinationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Notifying of updated destination identifier: %@ delegate: %@", (uint8_t *)&v10, 0x20u);
...
- (void)notifyDidUpdateAvailableDestinationIdentifiers:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Notifying of updated available destination identifiers: %@ delegate: %@", (uint8_t *)&v10, 0x20u);
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v53 = 2112;
    v54 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Updating media destination controller using transaction object: %@", (uint8_t *)&v51, 0x16u);
    ...
    || !objc_msgSend((id)isFeatureHomeTheaterQFAEnabledForTests, "BOOLValue"))
  {
    ...
    if (v21)
    {
      ...
      if ((v24 & 1) != 0)
      {
        ...
        if (v25 == 1)
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            v51 = 138543362;
            v52 = v29;
            _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly processing destination controller add after one already exists", (uint8_t *)&v51, 0xCu);
        ...
        if (v25 == 1)
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
          {
            ...
            v55 = 2112;
            v56 = v34;
            _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Notifying of unexpected model add: %@ delegate: %@", (uint8_t *)&v51, 0x20u);
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
      {
        ...
        v53 = 2112;
        v54 = v50;
        _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@Received unknown media destination controller model with identifier: %@", (uint8_t *)&v51, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        v53 = 2112;
        v54 = v8;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media destination controller model from new model object: %@", (uint8_t *)&v51, 0x16u);
...
LABEL_35:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    v51 = 138543362;
    v52 = v18;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Skipping due to Home Theater QFA enabled", (uint8_t *)&v51, 0xCu);
...
- (void)transactionObjectUpdatedDestinationIdentifier:(id)a3 message:(id)a4
{
  ...
  {
    v10 = (void *)MEMORY[0x1D17BA0A0](-[HMDMediaDestinationControllerBackingStoreHandler updateDestinationIdentifier:](self, "updateDestinationIdentifier:", v6));
    v11 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Transaction updated destination identifier: %@ to destination identifier: %@", (uint8_t *)&v17, 0x20u);
...
- (void)transactionObjectUpdatedAvailableDestinationIdentifiers:(id)a3 message:(id)a4
{
  ...
  if ((v12 & 1) == 0)
  {
    v13 = (void *)MEMORY[0x1D17BA0A0](-[HMDMediaDestinationControllerBackingStoreHandler updateAvailableDestinationIdentifiers:](self, "updateAvailableDestinationIdentifiers:", v6));
    v14 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Transaction updated available destination identifiers: %@ to identifiers: %@", (uint8_t *)&v19, 0x20u);
...
- (void)transactionObjectUpdatedSupportedOptions:(unint64_t)a3 message:(id)a4
{
  ...
  if (v8 != a3)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Transaction updated supported options: %@", (uint8_t *)&v15, 0x16u);
...
- (void)transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove unknown child with model object: %@", (uint8_t *)&v13, 0x16u);
...
void __114__HMDMediaDestinationControllerBackingStoreHandler_recoverDueToNoRecordInCloudWithHome_migrationQueue_completion___block_invoke(uint64_t a1, int a2, void *a3)
{
  ...
  if (a2)
  {
    ...
    block[0] = MEMORY[0x1E0C809B0];
    block[1] = 3221225472;
    block[2] = __114__HMDMediaDestinationControllerBackingStoreHandler_recoverDueToNoRecordInCloudWithHome_migrationQueue_completion___block_invoke_16;
    block[3] = &unk_1E89C0870;
    v10 = *(NSObject **)(a1 + 40);
    v22 = *(id *)(a1 + 48);
  ...
  else
  {
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "submitFailureEventWithEventErrorCode:error:", 10, v11);

    objc_msgSend(*(id *)(a1 + 32), "data");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    +[HMDMediaDestinationControllerBackingStoreHandler backingStoreObjectForData:](HMDMediaDestinationControllerBackingStoreHandler, "backingStoreObjectForData:", v13);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
uint64_t __114__HMDMediaDestinationControllerBackingStoreHandler_recoverDueToNoRecordInCloudWithHome_migrationQueue_completion___block_invoke_16(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(_QWORD *)(a1 + 32) + 16))();
}
...
uint64_t __104__HMDMediaDestinationControllerBackingStoreHandler_migrateWithHome_cloudZone_migrationQueue_completion___block_invoke(_QWORD *a1, uint64_t a2)
{
  void *v3;
...
void __83__HMDMediaDestinationControllerBackingStoreHandler_removeControllerWithCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Run remove destination controller transaction completed with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Run remove destination controller transaction completed", (uint8_t *)&v10, 0xCu);
...
void __101__HMDMediaDestinationControllerBackingStoreHandler_updateAvailableDestinationIdentifiers_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Run update available destination identifiers transaction completed with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Run update available destination identifiers transaction completed", (uint8_t *)&v10, 0xCu);
...
void __86__HMDMediaDestinationControllerBackingStoreHandler_updateSupportedOptions_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Run update supported options transaction completed with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Run update supported options transaction completed", (uint8_t *)&v10, 0xCu);
...
void __91__HMDMediaDestinationControllerBackingStoreHandler_updateDestinationIdentifier_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Run update destination identifier transaction completed with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Run update destination identifier transaction completed", (uint8_t *)&v10, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t37 != -1)
    dispatch_once(&logCategory__hmf_once_t37, &__block_literal_global_4266);
