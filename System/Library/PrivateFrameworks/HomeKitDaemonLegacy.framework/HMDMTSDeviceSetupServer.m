...
- (void)clientProxy:(id)a3 performDeviceSetupUsingRequest:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Performing Matter ecosystem device setup using request: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_56523 != -1)
    dispatch_once(&logCategory__hmf_once_t3_56523, &__block_literal_global_56524);
  return (id)logCategory__hmf_once_v4_56525;
}
...
void __38__HMDMTSDeviceSetupServer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_56525;
  logCategory__hmf_once_v4_56525 = v0;
