...
- (void)_registerForMessages
{
  ...
  objc_msgSend(v8, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBAA90], self, v7, sel_routeAddMediaSystem_);
  objc_msgSend(v8, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBABD0], self, v7, sel_routeRemoveMediaSystem_);
  ...
  if (!v6 || (objc_msgSend(v6, "isReachable") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&location[4] = v16;
      v27 = 2112;
      v28 = v7;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Resident device isn't available or reachable: %@", location, 0x16u);
  ...
  if ((objc_msgSend(v7, "supportsMediaSystem") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&location[4] = v21;
      v27 = 2112;
      v28 = v7;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Resident device does not support media system: %@", location, 0x16u);
...
- (void)routeAddMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v19 = 2112;
    v20 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Routing add media system message: %@(%@)", (uint8_t *)&v15, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Home theater QFA is not enabled using legacy flows", (uint8_t *)&v15, 0xCu);
...
- (void)_logAddMediaSystemMetricsUsingMessage:(id)a3
{
  ...
  -[HMDHomeMediaSystemControllerMessageHandler home](self, "home");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_alloc(MEMORY[0x1E0CBA670]);
  ...
  if (v5 && v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v30 = 2112;
      v31 = v8;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Received %@ message for media system builder payload %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v16;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Found associated setup session identifier %@ during media system grouping", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v30 = 2112;
      v31 = v8;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home: %@ or media system builder payload: %@ is nil", buf, 0x20u);
...
- (void)_logRemoveMediaSystemMetricsUsingMessage:(id)a3
{
  ...
  if (v5 && v6)
  {
    objc_msgSend(v6, "objectForKeyedSubscript:", *MEMORY[0x1E0CBABB8]);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_opt_class();
    ...
    if (v11)
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2112;
        v29 = v11;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Received %@ message for media system UUID: %@", (uint8_t *)&v24, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 2112;
        v27 = v4;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Message %@ payload does not contain valid media system UUID", (uint8_t *)&v24, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 2112;
      v29 = v7;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@home: %@ or payload: %@ is nil", (uint8_t *)&v24, 0x20u);
...
- (void)locallyAddMediaSystemUsingRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v62 = 2112;
    v63 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Locally add media system using request message: %@(%@) payload: %@", buf, 0x2Au);

  }
  objc_autoreleasePoolPop(v5);
  v12 = objc_alloc(MEMORY[0x1E0CBA670]);
  objc_msgSend(v4, "messagePayload");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v14 || !v15 || !v16)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v62 = 2112;
      v63 = v15;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to add media system due to missing dependencies payload: %@ aggregator: %@ homeUUID: %@", buf, 0x2Au);
...
LABEL_12:
  ...
  v29 = objc_alloc(MEMORY[0x1E0CBA680]);
  ...
  objc_msgSend(MEMORY[0x1E0D519C0], "chainFutures:", v49);
  ...
  if (!v8 || !v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v41 = 2112;
      v42 = v5;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Preferred associated group will be derived without influence from missing left destination: %@ right destination: %@ in home: %@", buf, 0x2Au);
  ...
  if (v9 && v13 && (objc_msgSend(v9, "isEqual:", v13) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v39 = 2112;
      v40 = v12;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Not setting a preferred group identifier due to miss matching groups on left destination: %@ right destination: %@", buf, 0x20u);
    ...
    if (v19)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v37 = 2112;
        v38 = v19;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting preferred associated group identifier: %@", buf, 0x16u);
...
- (id)validateConfiguredName:(id)a3
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = 138543362;
      v31 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get name to validate", (uint8_t *)&v30, 0xCu);
  ...
  if (!objc_msgSend(v4, "length") || (v6 = objc_msgSend(v5, "length"), v6 > HMMaxLengthForNaming()))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get valid name due length of name: %@", (uint8_t *)&v30, 0x16u);
...
LABEL_10:
  ...
  if (v19)
  {
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 2112;
        v35 = v17;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to get valid name: %@ error: %@", (uint8_t *)&v30, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = 138543362;
      v31 = v29;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to get home during name validation", (uint8_t *)&v30, 0xCu);
...
- (id)mediaSystemNameFromRoomWithAccessoryUUIDs:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CBA680], "defaultGroupName", (_QWORD)v16);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_13:
...
- (void)updateParticipantWithDestinationIdentifier:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to update participant with destination identifier: %@ due to no destination manager found in home: %@", (uint8_t *)&v15, 0x20u);
...
- (id)updateParticipantWithDestinationManager:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  v6 = (objc_class *)MEMORY[0x1E0D519C0];
  v7 = a4;
  v8 = a3;
...
- (void)queueOnboardingForUnconfiguredParticipantWithAccessoryUUID:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Queueing onboarding participant accessory uuid: %@ associated group identifier: %@", (uint8_t *)&v18, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v7;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to queue participant accessory uuid: %@ associated group identifier: %@ due to no onboarding manager", (uint8_t *)&v18, 0x20u);
...
- (id)messageRouter
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get primary message router in home: %@", (uint8_t *)&v12, 0x16u);
...
- (id)mediaGroupsAggregator
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media groups aggregator from home: %@", (uint8_t *)&v12, 0x16u);
...
- (id)homeUUID
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to get home uuid from home: %@", (uint8_t *)&v12, 0x16u);
...
- (void)_legacyHandleAddMediaSystemWithPreProcessedMessage:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "uuidForKey:", *MEMORY[0x1E0CBABB8]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "stringForKey:", *MEMORY[0x1E0CBAB90]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "arrayForKey:", *MEMORY[0x1E0CBAB88]);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "stringForKey:", *MEMORY[0x1E0CBAB60]);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v48 = 2112;
      v49 = v9;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Message is missing required information uuid: %@, builderID: %@", buf, 0x20u);
  ...
  if (!v17)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v6;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Name already exists %@", buf, 0x16u);
...
LABEL_19:
  ...
  v41 = 0;
  v36 = v7;
  v18 = objc_msgSend(MEMORY[0x1E0CBA670], "decodeComponentData:leftComponentUUID:leftAccessoryUUID:rightComponentUUID:rightAccessoryUUID:", v7, &v43, &v42, &v41, &v40);
  v37 = v43;
  v19 = v42;
  v20 = v41;
  v21 = v40;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v36;
      _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not decode components %@", buf, 0x16u);
...
- (void)routeRemoveMediaSystem:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Home theater QFA is not enabled using legacy flows", (uint8_t *)&v9, 0xCu);
...
- (void)locallyRemoveMediaSystemUsingRemoveRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v42 = 2112;
    v43 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Locallying remove media system using request message: %@(%@) payload: %@", (uint8_t *)&v36, 0x2Au);

  }
  objc_autoreleasePoolPop(v5);
  objc_msgSend(v4, "messagePayload");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "hmf_UUIDForKey:", *MEMORY[0x1E0CBABB8]);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v13)
  {
    ...
    if (v14)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
        {
          ...
          v38 = 2112;
          v39 = v16;
          _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Failed to remove media system due to missing media system group: %@", (uint8_t *)&v36, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v36 = 138543362;
        v37 = v31;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove media system due to no aggregator", (uint8_t *)&v36, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v42 = 2112;
      v43 = v27;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove media system due to invalid payload in request message: %@(%@) payload: %@", (uint8_t *)&v36, 0x2Au);
...
- (void)_legacyHandleRemoveMediaSystem:(id)a3
{
  ...
  v8 = a3;
  objc_msgSend(v8, "uuidForKey:", *MEMORY[0x1E0CBABB8]);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "stringForKey:", *MEMORY[0x1E0CBAB60]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)routeUpdateMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v19 = 2112;
    v20 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Routing update media system message: %@(%@)", (uint8_t *)&v15, 0x20u);
...
- (void)locallyUpdateMediaSystemUsingRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v63 = 2112;
    v64 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Locally update media system using request message: %@(%@) payload: %@", buf, 0x2Au);
  ...
  if (v14 && v15)
  {
    ...
    if (v19)
    {
      ...
      if (!v20)
      {
        ...
        objc_msgSend(MEMORY[0x1E0D519C0], "chainFutures:", v51);
        v43 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v14, "leftAccessoryUUID");
        v44 = (void *)objc_claimAutoreleasedReturnValue();
        v54[0] = v44;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v59 = 2112;
        v60 = v18;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to update media system due to missing media system group: %@", buf, 0x16u);
...
LABEL_18:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v61 = 2112;
    v62 = v16;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to update media system due to missing dependencies payload: %@ aggregator: %@", buf, 0x20u);
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      if (v11)
      {
        ...
        v41 = 0;
        v42 = 0;
        v12 = objc_msgSend(MEMORY[0x1E0CBA670], "decodeComponentData:leftComponentUUID:leftAccessoryUUID:rightComponentUUID:rightAccessoryUUID:", v38, &v44, &v43, &v42, &v41);
        v13 = v44;
        v14 = v43;
        v15 = v42;
        v16 = v41;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v47 = 2112;
        v48 = 0;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Message is missing mediaSystemUUID %@", buf, 0x16u);
...
void __112__HMDHomeMediaSystemControllerMessageHandler_updateParticipantWithDestinationManager_associatedGroupIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Request to update audio groups completed with error: %@", (uint8_t *)&v8, 0x16u);
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Update media system participants completed with error: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Update media system participants completed", buf, 0xCu);
    ...
    if (v13)
    {
      ...
      v16 = *(void **)(a1 + 40);
      -[HMDMediaSystem serialize](v15, "serialize", *MEMORY[0x1E0CBAB68]);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      v25 = v17;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to create update media system response due to no home", buf, 0xCu);
...
void __75__HMDHomeMediaSystemControllerMessageHandler_preProcessMediaSystemMessage___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (WeakRetained && !v5 && objc_msgSend(a1[5], "isSharedAdmin"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Relaying the message %@", (uint8_t *)&v17, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t47 != -1)
    dispatch_once(&logCategory__hmf_once_t47, &__block_literal_global_37749);
