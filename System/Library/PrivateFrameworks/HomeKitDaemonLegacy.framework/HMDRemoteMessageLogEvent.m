...
+ (id)peerInformationForDevice:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Unable to map productClass for device %@", (uint8_t *)&v10, 0x16u);
...
+ (id)peerInformationForRemoteMessage:(id)a3
{
  ...
  if (v8)
  {
    ...
    +[HMDRemoteMessageLogEvent peerInformationForDevice:](HMDRemoteMessageLogEvent, "peerInformationForDevice:", v9);
...
+ (id)newFromRemoteMessage:(id)a3 device:(id)a4 transportType:(int)a5 sending:(BOOL)a6
{
  ...
  if (objc_msgSend(v15, "isEqualToString:", CFSTR("HMDHomeCHIPSendRemoteRequestMessage")))
  {
    ...
    objc_msgSend(v17, "objectForKeyedSubscript:", *MEMORY[0x1E0D33390]);
    v18 = (void *)objc_claimAutoreleasedReturnValue();

    if (v18)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Remote Matter: %@"), v18);
