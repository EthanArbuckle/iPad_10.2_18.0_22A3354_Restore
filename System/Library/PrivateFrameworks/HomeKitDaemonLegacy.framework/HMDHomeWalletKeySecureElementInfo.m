...
- (HMDHomeWalletKeySecureElementInfo)initWithPaymentApplication:(id)a3 flow:(id)a4
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    v48 = 2112;
    v49 = v24;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] PKPass is missing data. paymentApplication: %@, subcredential: %@, paymentApplication.applicationIdentifier: %@, subcredential.identifier: %@, secureElementIdentifier: %@, subcredential.pairedReaderIdentifier: %@", buf, 0x52u);
...
- (unint64_t)hash
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDHomeWalletKeySecureElementInfo paymentCredentialType](self, "paymentCredentialType"));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  if (a3 != 1004)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2048;
      v19 = a3;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Unrecognized paymentType, defaulting to HMDPaymentCredentialType0. paymentType: %lu", (uint8_t *)&v14, 0x20u);
