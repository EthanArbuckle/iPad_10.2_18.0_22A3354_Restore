...
- (void)cancelWithError:(id)a3
{
  ...
  if (objc_msgSend(v5, "isEqualToString:", *MEMORY[0x1E0D27FC8]))
  {
        ...
        for (i = 0; i != v11; ++i)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v37 = 2112;
            v38 = v14;
            _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Adding known device: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot discover devices for account without any handles: %@", buf, 0x16u);
...
LABEL_14:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v49 = 2112;
        v50 = v32;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring message from: %@", buf, 0x16u);
  ...
  +[HMDRemoteMessageSerialization remoteMessageWithDictionary:error:](HMDRemoteMessageSerialization, "remoteMessageWithDictionary:error:", v45, 0);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v49 = 2112;
          v50 = v35;
          _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Discovered device: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_30387 != -1)
    dispatch_once(&logCategory__hmf_once_t4_30387, &__block_literal_global_30388);
  return (id)logCategory__hmf_once_v5_30389;
}
...
void __42__HMDDeviceDiscoveryOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_30389;
  logCategory__hmf_once_v5_30389 = v0;
