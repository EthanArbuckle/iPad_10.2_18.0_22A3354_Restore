...
- (id)_criteriaForActivity
{
  ...
  xpc_dictionary_set_int64(v2, (const char *)*MEMORY[0x1E0C807A8], *MEMORY[0x1E0C807B8]);
  xpc_dictionary_set_BOOL(v2, (const char *)*MEMORY[0x1E0C80898], 1);
  xpc_dictionary_set_BOOL(v2, (const char *)*MEMORY[0x1E0C80868], 1);
  xpc_dictionary_set_string(v2, (const char *)*MEMORY[0x1E0C80878], (const char *)*MEMORY[0x1E0C80888]);
  xpc_dictionary_set_BOOL(v2, (const char *)*MEMORY[0x1E0C808F0], 1);
  return v2;
}
...
- (void)_registerActivity
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Registering XPC activity %@", buf, 0x16u);
  ...
  objc_msgSend(v8, "registerXPCActivityWithActivityIdentifier:criteria:activityBlock:", v9, *MEMORY[0x1E0C80748], v10);
...
- (void)_handleCheckInForActivity:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 32;
LABEL_6:
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v18, v14);
...
- (void)_runActivity:(id)a3
{
  ...
  if (v7 >= 72000.0)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Running activity '%@'", (uint8_t *)&v27, 0x16u);
      ...
      for (i = 0; i != v5; ++i)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v20 = 2112;
          v21 = v13;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Running daily task for '%@'", buf, 0x16u);
        ...
        if ((v8 & 1) != 0)
        {
          if (v12)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v24 = 2112;
            v25 = v14;
            _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Running daily QA task for '%@'", buf, 0x16u);
...
void __46__HMDLogEventDailyScheduler__registerActivity__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!WeakRetained)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' handler ran after scheduler was deallocated", (uint8_t *)&v15, 0x16u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2048;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' callback with unhandled state: %ld", (uint8_t *)&v15, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11 != -1)
    dispatch_once(&logCategory__hmf_once_t11, &__block_literal_global_19_20531);
