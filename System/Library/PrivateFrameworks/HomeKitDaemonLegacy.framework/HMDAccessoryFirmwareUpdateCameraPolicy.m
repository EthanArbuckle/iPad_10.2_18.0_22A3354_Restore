...
- (void)monitorStreamStatus:(BOOL)a3
{
  ...
  {
    v6 = v4;
    objc_msgSend(v4, "findCharacteristicsByType:forServiceType:", *MEMORY[0x1E0D16008], *MEMORY[0x1E0CB99D0]);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot find the stream status characteristic from any of the stream services", (uint8_t *)location, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v36 = 2112;
            v37 = v10;
            _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid value type: %@", buf, 0x16u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v36 = 2112;
    v37 = v28;
    _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to %@", buf, 0x16u);
...
LABEL_13:
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, v10, (uint8_t *)&v20, 0xCu);
    ...
    {
      v6 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryFirmwareUpdateCameraPolicy _checkStreamingStatus](self, "_checkStreamingStatus"));
      v16 = self;
      HMFGetOSLogHandle();
      v8 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    ...
    v6 = (void *)MEMORY[0x1D17BA0A0](v18);
    v19 = self;
    HMFGetOSLogHandle();
    v8 = objc_claimAutoreleasedReturnValue();
    v13 = 1;
...
LABEL_18:
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, v15, (uint8_t *)&v20, 0xCu);
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v45 = v11;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response for read of stream status", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v46 = 2112;
                v47 = v25;
                _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Read failed for %@", buf, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v48 = 2112;
        v49 = v5;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Read of characteristics %@ failed with error %@", buf, 0x20u);
...
uint64_t __63__HMDAccessoryFirmwareUpdateCameraPolicy_handleSettingsChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Settings changed, updating policy status", (uint8_t *)&v7, 0xCu);
...
uint64_t __82__HMDAccessoryFirmwareUpdateCameraPolicy_handleAccessoryUnconfiguredNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is unconfigured, disabling stream status monitoring...", (uint8_t *)&v10, 0xCu);
...
uint64_t __80__HMDAccessoryFirmwareUpdateCameraPolicy_handleAccessoryConfiguredNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is configured, enabling stream status monitoring...", (uint8_t *)&v10, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_19485 != -1)
    dispatch_once(&logCategory__hmf_once_t0_19485, &__block_literal_global_19486);
  return (id)logCategory__hmf_once_v1_19487;
}
...
void __53__HMDAccessoryFirmwareUpdateCameraPolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_19487;
  logCategory__hmf_once_v1_19487 = v0;
