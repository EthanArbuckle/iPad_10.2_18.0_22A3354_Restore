...
- (void)start
{
  ...
  if (-[HMDUserSettingsBackingStoreController runState](self, "runState"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2112;
      v29 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Already in run state %@", (uint8_t *)&v26, 0x16u);
  ...
  else
  {
    ...
    if (objc_msgSend(v9, "isCurrentUser"))
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2112;
        v29 = v14;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting backing store controller to fetch owned zone for user %@", (uint8_t *)&v26, 0x16u);
      ...
      if (os_signpost_enabled(logger))
      {
        ...
        v28 = 2112;
        v29 = v17;
        _os_signpost_emit_with_name_impl(&dword_1CD062000, v16, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "UserZone.Startup", "Type=%{signpost.description:attribute}@ User=%{signpost.description:attribute}@ ", (uint8_t *)&v26, 0x16u);
           ...
           && objc_msgSend(v9, "isRunningOnHomeOwnersDevice"))
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2112;
        v29 = v22;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Starting backing store controller to fetch shared zone for user %@", (uint8_t *)&v26, 0x16u);
      ...
      if (os_signpost_enabled(v23))
      {
        ...
        v28 = 2112;
        v29 = v25;
        _os_signpost_emit_with_name_impl(&dword_1CD062000, v24, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "UserZone.Startup", "Type=%{signpost.description:attribute}@ User=%{signpost.description:attribute}@ ", (uint8_t *)&v26, 0x16u);
...
- (id)loadAssistantAccessControlModelWithModelID:(id)a3 error:(id *)a4
{
  ...
  if (v10 && !v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Obtained model of unexpected type %@", (uint8_t *)&v18, 0x16u);
...
- (void)registerForUserSupportsAutomaticHH2MigrationModelUpdates:(id)a3 modelID:(id)a4
{
  ...
  -[HMDUserSettingsBackingStoreController setUserSupportsAutomaticHH2MigrationModelUpdateReceiver:](self, "setUserSupportsAutomaticHH2MigrationModelUpdateReceiver:", v6);
  -[HMDUserSettingsBackingStoreController setUserSupportsAutomaticHH2MigrationModelID:](self, "setUserSupportsAutomaticHH2MigrationModelID:", v8);
...
- (void)_invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Invalidating user zone", (uint8_t *)&v8, 0xCu);
...
- (void)destroyZone
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 138543362;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Destroying zone", (uint8_t *)&v14, 0xCu);
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v10;
      _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@No IDS Activity observer found for %@, creating", buf, 0x16u);
...
LABEL_13:
    v55 = v11;
    v36 = (void *)MEMORY[0x1D17BA0A0](v17);
    v37 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v13;
      _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@No IDS Activity registration found for %@, creating", buf, 0x16u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v63 = 2112;
    v64 = v26;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Added subActivity %@ to existing list %@", buf, 0x20u);
  ...
  if (objc_msgSend(v14, "count"))
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v61 = 2112;
      v62 = v14;
      _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_DEFAULT, "%{public}@Updating IDS Activity Registration info: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v46);
    -[HMDUserSettingsBackingStoreController localZone](v47, "localZone");
    v50 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0D32CD8], "optionsWithLabel:", CFSTR("Updating IDS Activity Registration"));
...
LABEL_7:
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, v16, buf, 0x16u);

      goto LABEL_8;
    }
    goto LABEL_8;
  }
  v17 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v9, "setPushToken:", v7));
  v18 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2112;
    v31 = v6;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Updating IDS Activity observer pushToken: %@", buf, 0x16u);
  ...
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D32CD8], "optionsWithLabel:", CFSTR("Reregistering IDS Activity Observer"));
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v59 = 2112;
          v60 = v22;
          _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Removed subActivity %@ from existing list %@", buf, 0x20u);
      ...
      if (objc_msgSend(v28, "count"))
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v59 = 2112;
          v60 = v10;
          _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Removing subActivity %@ from IDS Activity Registration for: %@", buf, 0x20u);

        }
        objc_autoreleasePoolPop(v32);
        -[HMDUserSettingsBackingStoreController localZone](v33, "localZone");
        v36 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", v15, v16, 0);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v57 = 2112;
        v58 = v10;
        _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@Unable to deregister, no IDS Activty Registration model found for %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v57 = 2112;
      v58 = v10;
      _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Unable to deregister, no IDS Activty Observer model found for %@", buf, 0x16u);
...
- (void)deregisterObserverDeviceIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Removing IDS Activity Observer: %@", buf, 0x16u);
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D32CD8], "optionsWithLabel:", CFSTR("Removing IDS Activity Observer"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)queryPushTokensForDevicesObservingSubjectDevice:(id)a3 subActivity:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v6;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Querying all models observing %@", buf, 0x16u);
...
- (void)clearParticipants
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Clearing participants", (uint8_t *)&v8, 0xCu);
...
- (void)updateParticipants
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Updating participants", (uint8_t *)&v8, 0xCu);
...
- (void)_startWithOwnedZone
{
  ...
  v4 = objc_alloc_init(MEMORY[0x1E0D32CB8]);
  ...
  if (v8)
  {
    if (v12)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v14;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Got zoneID %@ for user settings zone %@", buf, 0x20u);
  ...
  else
  {
    if (v12)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v20;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@No shared zone exists for user settings with zone name %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v17;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Requesting user settings share from user: %@", buf, 0x16u);
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v89 = 2112;
      v90 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Did fetch zones with local zone %@", buf, 0x16u);
    ...
    if (v12)
    {
      ...
      if (objc_msgSend(v22, "count"))
      {
        ...
        objc_msgSend(MEMORY[0x1E0D32CD8], "optionsWithLabel:", CFSTR("Removing non-derived HMDIDSActivityRegistrationModels"));
        v35 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v78, "isCurrentUser") && (objc_msgSend(v78, "isRunningOnHomeOwnersDevice") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v88 = v41;
        _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@Starting participant manager to share with owner", buf, 0xCu);
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_1CD062000, v49, OS_SIGNPOST_EVENT, startupSignPost, "UserZone.Startup", "Fetched Zones", buf, 2u);
    }
  ...
  else
  {
    ...
    if (v69 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled((os_log_t)v67))
    {
      *(_DWORD *)buf = 138412290;
      v88 = v9;
      _os_signpost_emit_with_name_impl(&dword_1CD062000, v68, OS_SIGNPOST_INTERVAL_END, v69, "UserZone.Startup", "Error=%{signpost.description:attribute}@ ", buf, 0xCu);
    }
    ...
    if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v91 = 2112;
      v92 = v9;
      _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_ERROR, "%{public}@Failed to open zones for user settings with zone ID %@: %@", buf, 0x20u);
...
- (void)_updateRunState:(int64_t)a3
{
  ...
  if (-[HMDUserSettingsBackingStoreController runState](self, "runState") != a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating run state to %@", (uint8_t *)&v11, 0x16u);
...
- (void)_updateLogEventRunState:(int64_t)a3
{
  ...
  if (-[HMDUserSettingsBackingStoreController logEventRunState](self, "logEventRunState") != a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      {
        v10 = off_1E89A5C20[a3];
      }
      *(_DWORD *)buf = 138543618;
      v14 = v9;
      v15 = 2112;
      v16 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating metric run state to %@", buf, 0x16u);
...
- (void)_sendShareInvitation:(id)a3 toUser:(id)a4 device:(id)a5
{
  ...
  v36 = 0;
  objc_msgSend(MEMORY[0x1E0CB36F8], "archivedDataWithRootObject:requiringSecureCoding:error:", v8, 1, &v36);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = v36;
  if (v12)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v39 = 2112;
        v40 = v20;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Sending share invitation for user settings to user: %@", buf, 0x16u);
...
LABEL_15:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v39 = 2112;
        v40 = v32;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Sending share invitation for user settings to device: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v41 = 2112;
    v42 = v13;
    _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize invitation %@: %@", buf, 0x20u);
...
- (void)messenger:(id)a3 didReceiveInvitationData:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = v15;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Received invitation to share user settings", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v38 = 2112;
      v39 = v19;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive share invitation from invitation data: %@: %@", buf, 0x20u);
...
- (void)messenger:(id)a3 didReceiveInvitationRequestFromUser:(id)a4 device:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v17;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Received invitation request from user %@ and device %@", (uint8_t *)&v19, 0x20u);
...
- (id)localZone:(id)a3 didProcessModelDeletion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Notified of unhandled model deletion: %@", (uint8_t *)&v17, 0x16u);
...
- (void)_localZone:(id)a3 updatedModel:(id)a4 previousModel:(id)a5 options:(id)a6 result:(id)a7
{
  ...
  void *v74;
  id v75;
  HMDUserSettingsBackingStoreController *v76;
  NSObject *v77;
  uint64_t v78;
  id v79;
  void *v80;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v105 = 2112;
    v106 = v13;
    _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Received transaction update for model %@", buf, 0x16u);
  ...
  if (!v25)
  {
    ...
    if (v26)
    {
      ...
      v99[3] = &unk_1E89A5B78;
      v100 = v16;
      objc_msgSend(v22, "transactionSettingModelUpdated:previousModel:completion:", v27, v14, v99);
      v29 = v100;
LABEL_57:
    ...
    if (v32)
    {
      ...
      v97[3] = &unk_1E89A5B78;
      v98 = v16;
      objc_msgSend(v22, "transactionSettingConstraintModelUpdated:previousModel:completion:", v30, v14, v97);
      v33 = v98;
      v29 = v32;
      v12 = v86;
    }
    else
    {
      ...
      if (v36)
      {
        ...
        v95[3] = &unk_1E89A5B78;
        v96 = v16;
        objc_msgSend(v37, "assistantAccessControlModelUpdated:previousModel:completion:", v30, v14, v95);
      ...
      else
      {
        ...
        if (!v40)
        {
          ...
          if (v44)
          {
            ...
            v91[3] = &unk_1E89A5B78;
            v92 = v16;
            objc_msgSend(v45, "sharedUserDataModelUpdated:previousModel:completion:", v30, v14, v91);
          ...
          if (v51)
          {
            ...
            v90 = v16;
            v33 = v84;
            objc_msgSend(v52, "userListeningHistoryUpdateControlModelUpdated:previousModel:completion:", v84, v14, v89);
          ...
          else
          {
            ...
            v83 = v56;
            objc_msgSend(v56, "hmbModelID");
            v57 = (void *)objc_claimAutoreleasedReturnValue();
            -[HMDUserSettingsBackingStoreController userSupportsAutomaticHH2MigrationModelID](v19, "userSupportsAutomaticHH2MigrationModelID");
            v58 = (void *)objc_claimAutoreleasedReturnValue();
            v59 = objc_msgSend(v57, "isEqual:", v58);

            if (v59)
            {
              -[HMDUserSettingsBackingStoreController userSupportsAutomaticHH2MigrationModelUpdateReceiver](v19, "userSupportsAutomaticHH2MigrationModelUpdateReceiver");
              v60 = (void *)objc_claimAutoreleasedReturnValue();
              ...
              v87[3] = &unk_1E89A5B78;
              v88 = v16;
              objc_msgSend(v60, "userSupportsAutomaticHH2MigrationModelUpdated:previousModel:completion:", v83, v14, v87);
            ...
            else
            {
              ...
              if (v64)
              {
                ...
                v68 = objc_msgSend(v64, "hmbIsDifferentFromModel:differingFields:", v67, 0);
                v26 = 0;
                if (v68)
                {
                  v69 = v64;
                  ...
                  objc_msgSend(v70, "postNotificationName:object:", CFSTR("HMDUserDidUpdateIDSActivityRegistration"), v69);

                }
                v71 = objc_alloc_init(MEMORY[0x1E0D32C18]);
                objc_msgSend(v16, "finishWithResult:", v71);
                v15 = v85;
              }
              else
              {
                ...
                if (v71)
                {
                  ...
                  v74 = (void *)objc_claimAutoreleasedReturnValue();
                  objc_msgSend(v74, "backingStoreController:didUpdatePhotosPersonManagerSettingsModel:previousPhotosPersonManagerSettingsModel:", v19, v71, v14);

                  v75 = objc_alloc_init(MEMORY[0x1E0D32C18]);
                  objc_msgSend(v16, "finishWithResult:", v75);
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v105 = 2112;
                    v106 = v79;
                    _os_log_impl(&dword_1CD062000, v77, OS_LOG_TYPE_INFO, "%{public}@No handler for model %@", buf, 0x16u);
        ...
        v93[3] = &unk_1E89A5B78;
        v94 = v16;
        objc_msgSend(v41, "mediaContentProfileAccessControlModelUpdated:previousModel:completion:", v30, v14, v93);
...
LABEL_56:
  ...
  v101[3] = &unk_1E89A5B78;
  v102 = v16;
  objc_msgSend(v22, "transactionSettingGroupModelUpdated:previousModel:completion:", v23, v14, v101);
  v26 = v102;
LABEL_58:
...
- (void)registerForSettingsTransactions:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering transaction receiver %@", (uint8_t *)&v9, 0x16u);
...
- (void)runTransaction:(id)a3 waitForCloudPush:(BOOL)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v57 = 2112;
    v58 = v13;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Running transaction %@, runState: %@", buf, 0x20u);
      ...
      if (!v34)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v55 = 2112;
          v56 = v15;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Skipping Empty transaction: %@", buf, 0x16u);
...
LABEL_19:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v54 = v25;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Failed to run transaction due to nil localZone", buf, 0xCu);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v55 = 2112;
    v56 = v8;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to run transaction: %@ due to nil localZone", buf, 0x16u);
...
{
  return (HMDUserSupportsAutomaticHH2MigrationModelUpdateReceiver *)objc_loadWeakRetained((id *)&self->_userSupportsAutomaticHH2MigrationModelUpdateReceiver);
}

- (void)setUserSupportsAutomaticHH2MigrationModelUpdateReceiver:(id)a3
{
  objc_storeWeak((id *)&self->_userSupportsAutomaticHH2MigrationModelUpdateReceiver, a3);
}
...
void __82__HMDUserSettingsBackingStoreController_database_didRemoveZoneWithName_isPrivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Zone was removed by the database", (uint8_t *)&v7, 0xCu);
...
uint64_t __82__HMDUserSettingsBackingStoreController_database_didCreateZoneWithName_isPrivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling zone creation by starting", (uint8_t *)&v7, 0xCu);
...
void __84__HMDUserSettingsBackingStoreController_runTransaction_waitForCloudPush_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v37 = 2112;
    v38 = v12;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Finished running transaction: %@, Error: %@, waitForCloudPush: %@", buf, 0x2Au);
             ...
             v13))
  {
    ...
    v27[1] = 3221225472;
    v27[2] = __84__HMDUserSettingsBackingStoreController_runTransaction_waitForCloudPush_completion___block_invoke_135;
    v27[3] = &unk_1E89A5BA0;
    v19 = *(void **)(a1 + 40);
    v27[4] = *(_QWORD *)(a1 + 32);
    v28 = v19;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v24;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@No processing result to wait for.", buf, 0xCu);
...
void __84__HMDUserSettingsBackingStoreController_runTransaction_waitForCloudPush_completion___block_invoke_135(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  void *v7;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Finished running mirror protocol for transaction: %@, inResult: %@, inError: %@", (uint8_t *)&v13, 0x2Au);
...
void __87__HMDUserSettingsBackingStoreController_messenger_didReceiveInvitationData_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Successfully accepted invitation and created shared zone with ID %@", (uint8_t *)&v11, 0x16u);
...
void __84__HMDUserSettingsBackingStoreController__didFetchZonesWithResult_isOwnedZone_error___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Zone failed to startup: %@", (uint8_t *)&v11, 0x16u);
  ...
  if (v10 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v8))
  {
    v11 = 138412290;
    v12 = v3;
    _os_signpost_emit_with_name_impl(&dword_1CD062000, v9, OS_SIGNPOST_INTERVAL_END, v10, "UserZone.Startup", "Error=%{signpost.description:attribute}@ ", (uint8_t *)&v11, 0xCu);
  }
...
void __84__HMDUserSettingsBackingStoreController__didFetchZonesWithResult_isOwnedZone_error___block_invoke_108(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Started user data zone.", (uint8_t *)&v13, 0xCu);
  ...
  {
    LOWORD(v13) = 0;
    _os_signpost_emit_with_name_impl(&dword_1CD062000, v9, OS_SIGNPOST_INTERVAL_END, v10, "UserZone.Startup", ", (uint8_t *)&v13, 2u);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v23 = 2112;
        v24 = v17;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to locate push token for registration %@: %@", buf, 0x20u);
...
void __76__HMDUserSettingsBackingStoreController_deregisterObserverDeviceIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove IDS Activity observer %@: %@", (uint8_t *)&v9, 0x20u);
...
void __130__HMDUserSettingsBackingStoreController_deregisterObserverDeviceIdentifier_observerPushToken_subActivity_subjectDeviceIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update IDS Activity registration for %@: %@", (uint8_t *)&v9, 0x20u);
...
void __90__HMDUserSettingsBackingStoreController_updateObserverDeviceIdentifier_observerPushToken___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update IDS Activity for observer %@: %@", (uint8_t *)&v9, 0x20u);
...
void __128__HMDUserSettingsBackingStoreController_registerObserverDeviceIdentifier_observerPushToken_subActivity_subjectDeviceIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update IDS Activity registration for observer %@: %@", (uint8_t *)&v9, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t82 != -1)
    dispatch_once(&logCategory__hmf_once_t82, &__block_literal_global_13981);
