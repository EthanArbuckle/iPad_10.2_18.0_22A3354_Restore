...
+ (void)recordMigrationFailedWithError:(id)a3 withReason:(id)a4
{
  ...
  v25 = &v24;
  v26 = 0x3032000000;
  v27 = __Block_byref_object_copy__87667;
  v28 = __Block_byref_object_dispose__87668;
  v9 = v5;
  v29 = v9;
  ...
  if (v10)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "objectForKeyedSubscript:", *MEMORY[0x1E0CB2968]);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    v21 = *MEMORY[0x1E0CB8C70];
    objc_msgSend(v19, "errorWithDomain:code:userInfo:", *MEMORY[0x1E0CB8C70], v20, 0);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "setObject:forKeyedSubscript:", v22, *MEMORY[0x1E0CB3388]);
    v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB35C8]), "initWithDomain:code:userInfo:", v21, 2717, v17);
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v31 = 2114;
        v32 = v6;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Incrementing auto migration attempt to %{public}@ for build %{public}@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v29 = 2114;
        v30 = v6;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Initializing first auto migration attempt for build %{public}@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_FAULT, "%{public}@Should not get here, skipping incrementing auto migration attempt due to missing build version", buf, 0xCu);
...
+ (void)commitMigrationLogEventToDisk:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Going to write migration log event : [%@]", (uint8_t *)&v20, 0x16u);
...
+ (id)migrationLogEventRecord
{
  ...
  if ((objc_msgSend((id)objc_opt_class(), "doesLogEventExistOnDisk") & 1) != 0)
  {
    ...
    v34 = 0;
    objc_msgSend(MEMORY[0x1E0C99D50], "dataWithContentsOfFile:options:error:", v3, 2, &v34);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    v5 = v34;
    if (v4)
    {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v38 = 2112;
            v39 = v13;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to open the migration log event record from archive data: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v38 = 2112;
          v39 = v12;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive migration log event record from archive data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v38 = 2112;
        v39 = v5;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to read the migration log event record due to an error: [%@]", buf, 0x16u);
