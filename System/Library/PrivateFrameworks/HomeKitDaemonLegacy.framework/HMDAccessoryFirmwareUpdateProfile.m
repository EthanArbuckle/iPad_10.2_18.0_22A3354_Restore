...
- (void)_enableCharacteristicsNotifications:(BOOL)a3
{
  ...
  if (v3)
  {
    ...
    -[HMDAccessoryFirmwareUpdateProfile readAndProcessCharacteristics:withCompletion:](self, "readAndProcessCharacteristics:withCompletion:", v13, &__block_literal_global_36_150642);
...
- (id)firmwareVersionCharacteristic
{
  ...
  -[HMDAccessoryFirmwareUpdateProfile accessory](self, "accessory");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0CB88C8], *MEMORY[0x1E0CB99A0]);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)matterFirmwareVersionCharacteristic
{
  ...
  {
    objc_msgSend(v2, "findCharacteristicType:forServiceType:", *MEMORY[0x1E0D15F88], *MEMORY[0x1E0CB99A0]);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (id)characteristics
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("00000235-0000-1000-8000-0026BB765291"), CFSTR("00000234-0000-1000-8000-0026BB765291"), 0);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDAccessoryFirmwareUpdateProfile accessory](self, "accessory");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (HMDAccessoryFirmwareUpdateProfile)updateProfileWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating accessory firmware update profile", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v6);
  -[HMDAccessoryFirmwareUpdateProfile characteristics](v7, "characteristics");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E20]), "initWithCapacity:", objc_msgSend(v10, "count") + 1);
  v23 = 0u;
  v24 = 0u;
  v25 = 0u;
  v26 = 0u;
  ...
  if (v5 == a3)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@State not changed: %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v24 = 2112;
      v25 = v14;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating firmware update state from %@ to %@", buf, 0x20u);
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", a3, CFSTR("HMDAccessoryFirmwareUpdateStateKey"));
  ...
  if (-[HMDAccessoryFirmwareUpdateProfile stagingNotReadyReasons](self, "stagingNotReadyReasons") == a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v14 = 2114;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Staging Not Ready Reasons not changed: %{public}@", buf, 0x16u);
  ...
  if (-[HMDAccessoryFirmwareUpdateProfile updateNotReadyReasons](self, "updateNotReadyReasons") == a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v14 = 2114;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Update Not Ready Reasons not changed: %{public}@", buf, 0x16u);
...
- (void)_updateAccessoryFirmwareVersion:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v4;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory version=%@ is different than fetched version=%@", (uint8_t *)&v20, 0x20u);
...
- (void)_registerForNotifications
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Not registering for notifications as accessory is nil", (uint8_t *)&v10, 0xCu);
...
- (void)_handleCharacteristicChanges:(id)a3
{
  ...
  if (v8)
  {
    v10 = v8;
    v11 = *(_QWORD *)v36;
    v34 = *MEMORY[0x1E0CB88C8];
    v33 = *MEMORY[0x1E0D15F88];
    *(_QWORD *)&v9 = 138543362;
    v31 = v9;
    v32 = v6;
    do
      ...
      for (i = 0; i != v10; ++i)
      {
        ...
        if (v21)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = v31;
            v40 = v25;
            _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Firmware Update Profile _handleCharacteristicChanges: characteristic update for HMCharacteristicTypeFirmwareVersion", buf, 0xCu);
        ...
        else
        {
          ...
          if (v27)
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = v31;
              v40 = v30;
              _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEBUG, "%{public}@Firmware Update Profile _handleCharacteristicChanges: characteristic update for HAPCharacteristicUUID_MatterFirmwareRevisionNumber", buf, 0xCu);
...
- (void)__handleFirmwareUpdateStatusUpdate:(id)a3
{
  ...
  v28 = 0;
  objc_msgSend(MEMORY[0x1E0D164F0], "parsedFromData:error:", v8, &v28);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v28;
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v37 = 2112;
      v38 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse firmware update status (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
...
LABEL_14:
      _os_log_impl(&dword_1CD062000, v20, v21, v19, buf, 0xCu);
      goto LABEL_15;
    }
  }
  else
...
- (void)__handleFirmwareUpdateReadinessUpdate:(id)a3
{
  ...
  v18 = 0;
  objc_msgSend(MEMORY[0x1E0D164E8], "parsedFromData:error:", v8, &v18);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = v18;
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v27 = 2112;
      v28 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse firmware update readiness (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
...
- (void)_updateStagedFirmwareVersion:(id)a3
{
  ...
  v5 = a3;
  if (v5)
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286A0]), "initWithVersionString:", v5);
  else
    v6 = 0;
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v6;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@StagedFirmwareVersion changed from %@ to %@", (uint8_t *)&v17, 0x20u);
...
- (void)__handleFirmwareVersionUpdate:(id)a3
{
  ...
  if (v8)
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286A0]), "initWithVersionString:", v8);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Update fetched firmware version not available for accessory %@", (uint8_t *)&v14, 0x16u);
...
uint64_t __64__HMDAccessoryFirmwareUpdateProfile_handleAccessoryIsReachable___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is now reachable", (uint8_t *)&v7, 0xCu);
...
void __71__HMDAccessoryFirmwareUpdateProfile_handleCharacteristicValuesChanged___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Already handled updated accessory firmware version", buf, 0xCu);
  ...
  if (WeakRetained)
  {
    ...
    if (v5)
    {
      ...
      *(_QWORD *)&v48[16] = 0x3032000000;
      v49 = __Block_byref_object_copy__150635;
      v50 = __Block_byref_object_dispose__150636;
      v31 = a1;
...
uint64_t __60__HMDAccessoryFirmwareUpdateProfile_monitorCharacteristics___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Monitoring characteristics set to %@", (uint8_t *)&v9, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_150662 != -1)
    dispatch_once(&logCategory__hmf_once_t1_150662, &__block_literal_global_150663);
  return (id)logCategory__hmf_once_v2_150664;
}
...
void __48__HMDAccessoryFirmwareUpdateProfile_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_150664;
  logCategory__hmf_once_v2_150664 = v0;
