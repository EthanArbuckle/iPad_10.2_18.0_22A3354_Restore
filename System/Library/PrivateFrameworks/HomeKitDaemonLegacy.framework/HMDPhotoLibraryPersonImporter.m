...
- (void)_updatePersonsAndFaceCrops:(BOOL)a3
{
  ...
  if (v7)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating persons and face crops from Photos using shouldUpdateAllFaceCrops: %@ batchChange: %@", (uint8_t *)&v21, 0x20u);
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2112;
        v24 = v7;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Committing batch change: %@", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to create batch data operation for person and face crop update", (uint8_t *)&v21, 0xCu);
...
- (id)_updatePersonsUsingBatchChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v103 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating persons from photos", buf, 0xCu);
  ...
  if (v11)
  {
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v104 = 2112;
      v105 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Current Photo Library persons: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v104 = 2112;
      v105 = v27;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Previous HomeKit persons: %@", buf, 0x16u);
      ...
      do
      {
        for (i = 0; i != v30; ++i)
        {
          ...
          if (v35)
          {
            ...
            v38 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v28, "addObject:", v36));
            v39 = v80;
            HMFGetOSLogHandle();
...
LABEL_20:
              _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, v43, buf, 0x16u);
...
LABEL_22:
    ...
    objc_msgSend(obj, "na_map:", &__block_literal_global_93356);
          ...
          if ((v52 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v104 = 2112;
              v105 = v49;
              _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, "%{public}@Removing person: %@", buf, 0x16u);
        ...
        for (k = 0; k != v60; ++k)
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v104 = 2112;
            v105 = v63;
            _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_INFO, "%{public}@Removing duplicate person: %@", buf, 0x16u);
  ...
  else
  {
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v103 = v70;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Photo library query returned nil when querying current photo library persons, so aborting import process", buf, 0xCu);
...
- (void)_updateFaceCropsForAllPersonsUsingCurrentPersons:(id)a3 batchChange:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for all photos persons", (uint8_t *)&v13, 0xCu);
...
- (void)_updateFaceCropsForPersonsWithUpdatedPhotosFaceCropsUsingCurrentPersons:(id)a3 batchChange:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v16 = v12;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for persons with updated Photos face crops", buf, 0xCu);
...
- (void)_updateFaceCropsForPersons:(id)a3 usingBatchChange:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    v38 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for persons: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v37 = 2112;
            v38 = v16;
            _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Photo library query returned nil when querying face crops for person %@, so not modifying their face crops.", buf, 0x16u);
...
- (void)_updateFaceCropsWithCurrentPhotoLibraryFaceCrops:(id)a3 forPersonWithUUID:(id)a4 usingBatchChange:(id)a5
{
  ...
  v62 = v8;
  v11 = (void *)MEMORY[0x1D17BA0A0](-[HMDPhotoLibraryPersonImporter _submitLogEventForFaceCrops:](self, "_submitLogEventForFaceCrops:", v8));
  v12 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v77 = 2112;
    v78 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for person with uuid: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v81 = 2048;
    v82 = v22;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Person with uuid: %@ has %lu current photos face crops, and %lu previous face crops in homekit", buf, 0x2Au);
  ...
  if (v27)
  {
    ...
    do
    {
      for (i = 0; i != v28; ++i)
      {
        ...
        if (v34)
        {
          v35 = objc_alloc(MEMORY[0x1E0CBA6E0]);
          ...
          v39 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v38, "setSource:", 1));
          v40 = v18;
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v79 = 2112;
            v80 = (uint64_t)v38;
            _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@Adding new face crop for person with uuid %@: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v79 = 2112;
            v80 = (uint64_t)v64;
            _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Did not receive a valid face crop from HomeAI for photos face crop with uuid: %@ for person with uuid: %@", buf, 0x20u);
      ...
      for (j = 0; j != v48; ++j)
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v79 = 2112;
          v80 = (uint64_t)v51;
          _os_log_impl(&dword_1CD062000, v54, OS_LOG_TYPE_INFO, "%{public}@Removing old face crop for person with uuid %@: %@", buf, 0x20u);
...
- (void)_configure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring photo library person importer", (uint8_t *)&v12, 0xCu);
...
- (void)_unconfigure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Unconfiguring photo library person importer", (uint8_t *)&v9, 0xCu);
...
- (void)_handleUpdatedCloudPhotosSetting
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Cloud photos enabled changed to %@", (uint8_t *)&v10, 0x16u);
...
- (void)_handleFMFDeviceChanged
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@FMF device changed, isThisDesignatedFMFDevice: %@", (uint8_t *)&v9, 0x16u);
...
LABEL_8:
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, v8, (uint8_t *)&v9, 0xCu);
...
BOOL __117__HMDPhotoLibraryPersonImporter__updateFaceCropsForPersonsWithUpdatedPhotosFaceCropsUsingCurrentPersons_batchChange___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2048;
    v25 = v10;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Person: %@ has %lu face crops in homekit, and there are %lu face crops in photos", (uint8_t *)&v18, 0x2Au);
  ...
  if (v7)
  {
    ...
    if (v10 == 1)
    {
      if (v14)
      {
        ...
        v25 = 2112;
        v26 = v3;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Ignoring person with duplicate external person UUID: %@", (uint8_t *)&v23, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29 != -1)
    dispatch_once(&logCategory__hmf_once_t29, &__block_literal_global_97_93378);
