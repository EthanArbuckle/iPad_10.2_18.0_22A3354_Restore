...
- (void)scheduleWithDelay:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v50 = 2112;
    v51 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@scheduleWithDelay: %@", (uint8_t *)&v48, 0x16u);
    ...
    case 2:
      ...
      if ((v17 & 1) != 0 || (v18 & v20 & 1) != 0)
      {
        if (objc_msgSend(v11, "isUserInitiatedInstall"))
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
          {
            ...
            v48 = 138543362;
            v49 = v32;
            _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@User initiated install; removing policy...",
              (uint8_t *)&v48,
              0xCu);
        ...
        else
        {
          ...
          if (!v33)
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
            {
              ...
              v48 = 138543362;
              v49 = v37;
              _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_DEBUG, "%{public}@Auto install; creating policy...",
                (uint8_t *)&v48,
                0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          v52 = 2112;
          v53 = v26;
          _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Automatic update not allowed in current device: allowed=%@, current device is resident=%@", (uint8_t *)&v48, 0x20u);
...
LABEL_5:
  ...
  if (v41)
  {
    if (v45)
    {
      ...
      v50 = 2112;
      v51 = v13;
      _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Scheduling new task %@", (uint8_t *)&v48, 0x16u);
  ...
  else
  {
    if (v45)
    {
      ...
      v50 = 2112;
      v51 = v13;
      _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Skip scheduling unready task %@", (uint8_t *)&v48, 0x16u);
  ...
  if (v10 == 1)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v33 = 2112;
      v34 = v20;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Task %@ needs to stop - notReachable %@, StagingNotReady %{public}@ (%@), shouldn't run %@", buf, 0x3Eu);
...
- (void)_scheduleCurrentTaskBackgroundRun
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    v16 = (void *)MEMORY[0x1D17BA0A0](inited);
    v17 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v36 = 2112;
      v37 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Scheduling background task %@ %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v27;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Aborting task %@ after initial delay because required conditions are no longer satisfied", buf, 0x16u);
...
- (void)_stop
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Stopping current task", (uint8_t *)&v15, 0xCu);
  ...
  if (-[HMDAccessoryFirmwareUpdateScheduler currentState](v5, "currentState"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 138543362;
      v16 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Stopping active task", (uint8_t *)&v15, 0xCu);
...
- (void)_defer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Deferring active task, activityCompletion %@", (uint8_t *)&v13, 0x16u);
  ...
  if ((v7 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v36 = 2112;
      v37 = v20;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Resident parameters: supports AFU=%@, enabled=%@, current device is resident=%@", buf, 0x2Au);
...
- (void)_logDebugStates:(const char *)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v47 = 2112;
    v48 = v19;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@%@: Staging Not Ready Reasons = %{public}@, Apply Not Ready Reasons = %{public}@, Accessory State = %@, Session State = %@, Scheduler State = %@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v43 = 2112;
    v44 = v30;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEBUG, "%{public}@%@: Accessory Locally Reachable = %@, User Initiated Install = %@, Automatic Update = %@", buf, 0x34u);
...
- (void)_startDeferCheckTimer
{
  ...
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 5, 10000.0);
...
- (void)_startTaskInitialDelayTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting initial delay timer for task %@", (uint8_t *)&v16, 0x16u);
    ...
    if (v7 == v4)
    {
      ...
      if (v9)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          v14 = 138543362;
          v15 = v13;
          _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@System condition is no longer conducive to running scheduled task", (uint8_t *)&v14, 0xCu);
...
void __58__HMDAccessoryFirmwareUpdateScheduler_handleBridgeUpdate___block_invoke(uint64_t a1)
{
  ...
  if (v3 == 2)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Bridge update received; rescheduling...",
        (uint8_t *)&v8,
        0xCu);
...
void __64__HMDAccessoryFirmwareUpdateScheduler_handlePolicyStatusChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    v18 = 2112;
    v19 = v11;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEBUG, "%{public}@Policy status - %@, Session State - %@", (uint8_t *)&v14, 0x20u);
...
void __66__HMDAccessoryFirmwareUpdateScheduler__taskCanRunInCurrentDevice___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 2112;
    v14 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Accessory is %@ from the resident", (uint8_t *)&v11, 0x16u);
...
uint64_t __72__HMDAccessoryFirmwareUpdateScheduler__scheduleCurrentTaskBackgroundRun__block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v15 = 2112;
    v16 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Running background task %@ %@", buf, 0x20u);
...
uint64_t __72__HMDAccessoryFirmwareUpdateScheduler__scheduleCurrentTaskBackgroundRun__block_invoke_45(uint64_t a1, char a2)
{
  ...
  if ((a2 & 1) != 0)
  {
    if (v7)
    {
      ...
      v16 = 2112;
      v17 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Running task %@", (uint8_t *)&v14, 0x16u);
  ...
  else
  {
    if (v7)
    {
      ...
      v16 = 2112;
      v17 = v13;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Aborting background running because required conditions are no longer satisfied for task=%@", (uint8_t *)&v14, 0x16u);
...
void __59__HMDAccessoryFirmwareUpdateScheduler__scheduleCurrentTask__block_invoke_2(uint64_t a1, char a2)
{
  ...
  if ((a2 & 1) != 0)
  {
    ...
    if (v3)
    {
      if (v7)
      {
        ...
        v19 = 2112;
        v20 = v9;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Running current task now %@", (uint8_t *)&v17, 0x16u);
    ...
    else
    {
      if (v7)
      {
        ...
        v17 = 138543362;
        v18 = v16;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Task was invalidated", (uint8_t *)&v17, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Aborting background run of task %@ because required conditions are no longer satisfied", (uint8_t *)&v17, 0x16u);
...
void __68__HMDAccessoryFirmwareUpdateScheduler_handlePrimaryResidentChanged___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Primary resident changed to %@", (uint8_t *)&v8, 0x16u);
...
uint64_t __73__HMDAccessoryFirmwareUpdateScheduler_handleApplyNotReadyReasonsChanged___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2114;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory apply not ready reasons changed to %{public}@", (uint8_t *)&v9, 0x16u);
...
uint64_t __75__HMDAccessoryFirmwareUpdateScheduler_handleStagingNotReadyReasonsChanged___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2114;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory staging not ready reasons changed to %{public}@", (uint8_t *)&v9, 0x16u);
...
void __64__HMDAccessoryFirmwareUpdateScheduler_handleUpdateStateChanged___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Accessory firmware update status changed to %@", (uint8_t *)&v9, 0x16u);
...
uint64_t __74__HMDAccessoryFirmwareUpdateScheduler_handleAccessoryReachabilityChanged___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory reachability changes to %@", (uint8_t *)&v9, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_65956 != -1)
    dispatch_once(&logCategory__hmf_once_t0_65956, &__block_literal_global_65957);
  return (id)logCategory__hmf_once_v1_65958;
}
...
void __50__HMDAccessoryFirmwareUpdateScheduler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_65958;
  logCategory__hmf_once_v1_65958 = v0;
