...
- (void)submitReadRequests:(id)a3 sourceType:(unint64_t)a4 requestMessage:(id)a5
{
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "stringWithFormat:", CFSTR("%@, %s:%ld"), v17, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/HMDHAPAccessoryReaderWriter.m", 2390);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v37 = (void *)v13;
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v46 = 2114;
    v47 = v32;
    _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Executing with request: %{public}@. Current Tasks: %{public}@. Request Timeout %{public}@", buf, 0x34u);
...
- (void)submitWriteRequests:(id)a3 sourceType:(unint64_t)a4 requestMessage:(id)a5
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "stringWithFormat:", CFSTR("%@, %s:%ld"), v17, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/HMDHAPAccessoryReaderWriter.m", 2436);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v37 = (void *)v13;
...
void __61__HMDHAPAccessoryReaderWriter__completionHandlerWithContext___block_invoke_2(uint64_t a1, char a2, void *a3, void *a4)
{
  ...
  if ((a2 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v36 = 2114;
      v37 = v22;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Done sending all responses with error: %{public}@. Execution Time: %.3fs. Remaining Tasks: %{public}@", (uint8_t *)&v28, 0x34u);
...
LABEL_6:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v38 = 2112;
      v39 = v27;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Done sending multi-part response(s)[%@] with error: %@. Execution Time: %.3fs. %@", (uint8_t *)&v28, 0x3Eu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t47_180621 != -1)
    dispatch_once(&logCategory__hmf_once_t47_180621, &__block_literal_global_422);
  return (id)logCategory__hmf_once_v48_180622;
}
...
void __42__HMDHAPAccessoryReaderWriter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v48_180622;
  logCategory__hmf_once_v48_180622 = v0;
