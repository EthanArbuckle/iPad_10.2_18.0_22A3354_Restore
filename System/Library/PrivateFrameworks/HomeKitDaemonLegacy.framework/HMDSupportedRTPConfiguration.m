...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x1E0D16400], "wrappertlv:name:objectCreator:", 2, CFSTR("kSupportedRTPParameters__SRTPCryptoSuite"), &__block_literal_global_407);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(*(id *)(*((_QWORD *)&v12 + 1) + 8 * v8), "srtpCryptoSuite"));
