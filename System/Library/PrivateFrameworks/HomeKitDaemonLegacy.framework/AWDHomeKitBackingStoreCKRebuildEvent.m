...
LABEL_3:
  ...
  if (rebuildStatus >= 8)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_rebuildStatus);
    v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v7 = off_1E89BB888[rebuildStatus];
  }
...
LABEL_11:
  ...
  {
    v9 = off_1E89BB8C8[containerType];
  }
...
LABEL_15:
    ...
    if (zoneType >= 6)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_zoneType);
      v11 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v11 = off_1E89BB8E8[zoneType];
    }
