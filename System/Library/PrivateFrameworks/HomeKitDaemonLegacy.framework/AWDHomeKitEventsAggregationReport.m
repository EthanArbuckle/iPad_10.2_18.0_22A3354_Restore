...
- (id)dictionaryRepresentation
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_processLaunchCount);
...
LABEL_7:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_jetsamReasonHighwaterCount);
...
LABEL_33:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_jetsamReasonProcessLimitCount);
...
LABEL_34:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_jetsamReasonUnknownKillCount);
...
LABEL_35:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_jetsamReasonOtherCount);
...
LABEL_36:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_processMemoryPressureStateWarningCount);
...
LABEL_37:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_processMemoryPressureStateCriticalCount);
...
LABEL_38:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_averageSampledProcessMemoryUsage);
...
LABEL_39:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_peakSampledProcessMemoryUsage);
...
LABEL_40:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_remoteMessagesSentCount);
...
LABEL_41:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_remoteMessagesReceivedCount);
...
LABEL_42:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_acceptedXPCRequestsCount);
...
LABEL_43:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_erroredXPCRequestsCount);
...
LABEL_44:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_sentXPCNotificationsCount);
...
LABEL_45:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_filteredXPCNotificationsCount);
...
LABEL_46:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hapIPInvalidationCount);
...
LABEL_47:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hapIPSentHTTPRequestsCount);
...
LABEL_48:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hapIPReceivedHTTPResponsesCount);
...
LABEL_49:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hapIPReceivedHTTPEventCount);
...
LABEL_50:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hapBTLEConnectionsCount);
...
LABEL_51:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hapBTLEConnectionPerReasonsCount);
...
LABEL_27:
    if ((*(_BYTE *)&has & 4) == 0)
      goto LABEL_28;
LABEL_53:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_activeDay);
...
LABEL_52:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_hapBTLEDiscoveriesCount);
...
LABEL_28:
  ...
  {
LABEL_29:
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInt:", self->_activeDaysPerMonthCount);
