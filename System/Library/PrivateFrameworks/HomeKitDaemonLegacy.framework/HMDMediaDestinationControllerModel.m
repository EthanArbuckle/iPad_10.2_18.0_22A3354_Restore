...
+ (id)properties
{
  if (properties_onceToken_144705 != -1)
    dispatch_once(&properties_onceToken_144705, &__block_literal_global_11_144706);
  return (id)properties__properties_144707;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t0_144700 != -1)
    dispatch_once(&logCategory__hmf_once_t0_144700, &__block_literal_global_16_144701);
  return (id)logCategory__hmf_once_v1_144702;
}
...
void __49__HMDMediaDestinationControllerModel_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_144702;
  logCategory__hmf_once_v1_144702 = v0;
...
void __48__HMDMediaDestinationControllerModel_properties__block_invoke()
{
  ...
  v5 = (void *)properties__properties_144707;
  properties__properties_144707 = v4;
...
- (NSArray)availableDestinationModelIdentifiers
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "na_map:", &__block_literal_global_144752);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setAvailableDestinationModelIdentifiers:(id)a3
{
  ...
  objc_msgSend(a3, "na_map:", &__block_literal_global_9_144750);
