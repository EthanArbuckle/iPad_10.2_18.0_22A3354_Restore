...
- (BOOL)remoteEventAllowedForTopic:(id)a3 deviceType:(unint64_t)a4 userType:(unint64_t)a5
{
      ...
      else
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            v28 = 2112;
            v29 = v8;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine remote event allowed due to unknown parsed topic: %@ with topic: %@", (uint8_t *)&v24, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      v26 = 2112;
      v27 = v8;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Failed to determine allowed remote event due to unparsable topic: %@", (uint8_t *)&v24, 0x16u);
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 22;
LABEL_8:
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, v16, buf, v18);
...
LABEL_25:
    ...
    if (!v29)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v52 = v40;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remove event allowed due to no accessory topic suffix", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v53 = 2112;
        v54 = v45;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remove event allowed due to no ACL for accessory topic suffix: %@", buf, 0x16u);
...
LABEL_13:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 2112;
        v35 = v30;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remove event allowed due to no ACL for home topic suffix: %@", (uint8_t *)&v32, 0x16u);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    v32 = 138543362;
    v33 = v25;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remove event allowed due to no accessory topic suffix", (uint8_t *)&v32, 0xCu);
...
LABEL_13:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 2112;
        v28 = v8;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remove event allowed due to no ACL for accessory info topicSuffix: %@", (uint8_t *)&v25, 0x16u);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    v25 = 138543362;
    v26 = v19;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remove event allowed due to no topicSuffix", (uint8_t *)&v25, 0xCu);
...
- (BOOL)isAppleMediaAccessoryUUID:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine allowed remote event due to no data source", (uint8_t *)&v15, 0xCu);
...
- (BOOL)isMediaSystemUUID:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine media system existence due to no data source", (uint8_t *)&v15, 0xCu);
