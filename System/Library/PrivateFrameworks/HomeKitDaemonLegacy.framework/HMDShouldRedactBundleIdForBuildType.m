...
void __HMDShouldRedactBundleIdForBuildType_block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0C99E60], "setWithObjects:", CFSTR("hdsutil"), CFSTR("HomeIntegrationTests-Runner"), CFSTR("homeutil"), CFSTR("tvsetuputil"), CFSTR("CarPlay"), CFSTR("Carousel"), CFSTR("HDSViewService"), CFSTR("HomeAppIntentsExtension"), CFSTR("HomeKitDiagnosticExtension"), CFSTR("HomeKitIntentExtension"), CFSTR("PineBoard"), CFSTR("Shortcuts"), CFSTR("Siri Debug"), CFSTR("SiriUI"), CFSTR("SiriUserFeedbackLearningUnivers"), CFSTR("SoundBoard"), CFSTR("SpringBoard"),
    CFSTR("accountsd"),
    CFSTR("amsaccountsd"),
    CFSTR("announced"),
