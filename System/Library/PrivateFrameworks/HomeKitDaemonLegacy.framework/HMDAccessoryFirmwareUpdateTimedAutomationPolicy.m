  ...
  if (!v4)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v17;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to NO", (uint8_t *)&v23, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Invalid max update apply end time, policy status evaluated to NO", (uint8_t *)&v23, 0xCu);
...
LABEL_2:
  v5 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryFirmwareUpdateTimedAutomationPolicy _stopReevaluateTimer](self, "_stopReevaluateTimer"));
  v6 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 138543362;
    v24 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", (uint8_t *)&v23, 0xCu);
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v71 = v21;
              _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Evaluating timer trigger...", buf, 0xCu);
            ...
            if (v24)
            {
              ...
              if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v72 = 2112;
                v73 = v51;
                _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_INFO, "%{public}@Update could be interrupted by trigger:%@", buf, 0x16u);
          ...
          else
          {
            ...
            if (v16)
            {
              if (v27)
              {
                ...
                *(_DWORD *)buf = 138543362;
                v71 = v28;
                _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Evaluating event trigger...", buf, 0xCu);
                    ...
                    if (v36 == 1)
                    {
                      ...
                      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138543618;
                        ...
                        v72 = 2112;
                        v73 = v44;
                        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Update could be interrupted by trigger:%@", buf, 0x16u);
            ...
            else
            {
              if (v27)
              {
                ...
                *(_DWORD *)buf = 138543362;
                v71 = v37;
                _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Unknown trigger type", buf, 0xCu);
...
- (void)_startReevaluateTimer:(double)a3
{
  ...
  if (a3 < 0.0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v14 = 138543362;
      v15 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Invalid time interval", (uint8_t *)&v14, 0xCu);

    }
    objc_autoreleasePoolPop(v5);
    v3 = 0.0;
  }
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 1, v3 + (double)(unint64_t)applyGuardTime());
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_128547 != -1)
    dispatch_once(&logCategory__hmf_once_t0_128547, &__block_literal_global_128548);
  return (id)logCategory__hmf_once_v1_128549;
}
...
void __62__HMDAccessoryFirmwareUpdateTimedAutomationPolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_128549;
  logCategory__hmf_once_v1_128549 = v0;
