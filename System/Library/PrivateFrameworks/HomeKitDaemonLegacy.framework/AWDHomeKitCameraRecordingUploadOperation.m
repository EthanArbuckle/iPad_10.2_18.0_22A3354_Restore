...
- (id)dictionaryRepresentation
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_didCausePreviousClipToFinalizeBecauseMaxDurationExceeded);
...
LABEL_8:
  if ((*(_BYTE *)&has & 0x20) != 0)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_totalClipDuration);
...
LABEL_10:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_runTime);
...
LABEL_15:
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_retryCount);
...
LABEL_22:
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", self->_operationStartTime);
