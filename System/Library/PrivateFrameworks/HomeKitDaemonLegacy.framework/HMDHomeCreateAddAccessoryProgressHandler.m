...
void __HMDHomeCreateAddAccessoryProgressHandler_block_invoke(id *a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v78 = 2112;
    v79 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Progress Handler called with progress: %@", buf, 0x16u);
  ...
  if (WeakRetained)
  {
          ...
          v13))
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v78 = 2112;
        v79 = v18;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Posting accessory pairing state progress notification to %@", buf, 0x16u);
    ...
    if (a2 == 9)
    {
      ...
      if (v37)
      {
        ...
        objc_msgSend(v25, "setObject:forKeyedSubscript:", v43, *MEMORY[0x1E0CB91C8]);
...
LABEL_42:
        ...
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v5, "certificationStatus"));
        v63 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v25, "setObject:forKeyedSubscript:", v63, CFSTR("kAccessoryCertificationStatusKey"));

        v64 = (void *)MEMORY[0x1E0D285F8];
        v65 = *MEMORY[0x1E0CBAA88];
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v78 = 2112;
        v79 = v48;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Progress is %@ but no accessory being replaced", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v59, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v78 = 2112;
          v79 = v61;
          _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_DEBUG, "%{public}@No appID/bundleID found for productData: %@", buf, 0x16u);
