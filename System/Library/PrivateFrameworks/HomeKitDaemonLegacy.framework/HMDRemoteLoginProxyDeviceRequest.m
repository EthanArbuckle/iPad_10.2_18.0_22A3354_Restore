...
{
  return (NSString *)CFSTR("kHMDRemoteLoginProxyDeviceRequest");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMDRemoteLoginProxyDeviceRequest");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMDRemoteLoginProxyDeviceRequest messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("HMDRemoteLoginProxyDeviceRequest: %@"), v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMDRemoteLoginProxyDeviceRequest"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMDRemoteLoginProxyDeviceRequest"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
