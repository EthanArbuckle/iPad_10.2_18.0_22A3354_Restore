  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v27;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Software version is required", buf, 0xCu);
...
LABEL_15:
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, v22, (uint8_t *)&v32, 0xCu);
...
- (void)registerForMessages
{
  ...
  if ((objc_msgSend(v3, "isCurrentAccessory") & 1) != 0 || objc_msgSend(v3, "supportsFirmwareUpdate"))
  {
    ...
    objc_msgSend(v5, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB9D88], self, v9, sel__handleUpdateState_);
    objc_msgSend(v5, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB9D80], self, v9, sel__handleUpdateDocumentationMetadata_);
  ...
  objc_msgSend(v5, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB9D58], self, v11, sel__handleDocumentationRequest_);
  objc_msgSend(v5, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB9D60], self, v11, sel__handleNeedsAttentionReasonsRequest_);
...
- (void)_updateState:(int64_t)a3 message:(id)a4 options:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v32 = 2112;
    v33 = v15;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Updating state: %@ from current state: %@", (uint8_t *)&v28, 0x20u);
...
- (void)_handleUpdateState:(id)a3
{
  ...
  {
    objc_msgSend(v4, "numberForKey:", *MEMORY[0x1E0CB9D70]);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    v6 = v5;
    if (v5)
    {
...
LABEL_15:
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v25 = 2048;
        v26 = v7;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid state: %ld", (uint8_t *)&v23, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = (unint64_t)v13;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing state from message payload: %@", (uint8_t *)&v23, 0x16u);
...
- (void)_handleUpdateDocumentationMetadata:(id)a3
{
  ...
  if (__shouldAcceptMessage(self, v4))
  {
    v5 = *MEMORY[0x1E0CB9CC8];
    objc_msgSend(v4, "nullForKey:", *MEMORY[0x1E0CB9CC8]);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v22)
    {
      ...
      v39 = 0;
      objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v22, &v39);
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      v23 = v39;
      v24 = v23;
      if (v7)
...
LABEL_4:
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v42 = 2112;
          v43 = v7;
          _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updating with documentation metadata: %@", buf, 0x16u);
...
LABEL_23:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = v24;
        _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive software update documentation metadata from metadata data: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v42 = 2112;
        v43 = v29;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Missing documentation metadata from message payload: %@", buf, 0x16u);
  ...
  if (v5)
  {
    ...
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Missing asset", buf, 0xCu);
    ...
    {
      objc_msgSend(v7, "nextPermittedDownloadDate", *MEMORY[0x1E0CB9D48]);
      v9 = (_QWORD *)objc_claimAutoreleasedReturnValue();
      v25 = v9;
      objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v25, &v24, 1);
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 3201);
      v23 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_12:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot get documentation without documentation metadata", buf, 0xCu);
...
- (void)setNeedsAttentionReasons:(unint64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@NeedsAttentionReasons updated to %@", (uint8_t *)&v23, 0x16u);

    }
    objc_autoreleasePoolPop(v6);
    v29 = *MEMORY[0x1E0CB9D38];
    ...
    v16 = (void *)*MEMORY[0x1E0CB9D30];
    objc_msgSend(MEMORY[0x1E0D285F8], "messageWithName:destination:payload:", *MEMORY[0x1E0CB9D30], v15, v12);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = (void *)MEMORY[0x1D17BA0A0]();
    v19 = v7;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v15;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Sending message %@ to %@", (uint8_t *)&v23, 0x20u);
...
- (void)_handleNeedsAttentionReasonsRequest:(id)a3
{
  ...
  if (v5)
  {
    v21 = *MEMORY[0x1E0CB9D38];
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDSoftwareUpdate needsAttentionReasons](self, "needsAttentionReasons"));
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v22[0] = v6;
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending %@ reply with payload %@", (uint8_t *)&v15, 0x20u);
...
- (HMDSoftwareUpdateModel)model
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDSoftwareUpdate state](self, "state"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDSoftwareUpdate downloadSize](self, "downloadSize"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)transactionWithObjectChangeType:(unint64_t)a3
{
  ...
  +[HMDSoftwareUpdate modelNamespace](HMDSoftwareUpdate, "modelNamespace");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)objc_msgSend(v7, "initWithNamespace:data:", v8, v6);

  v10 = -[HMDBackingStoreModelObject initWithObjectChangeType:uuid:parentUUID:]([HMDSoftwareUpdateModel alloc], "initWithObjectChangeType:uuid:parentUUID:", a3, v9, v5);
  return v10;
}
      ...
      if (v19 != -[HMDSoftwareUpdate state](v14, "state"))
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[4] = v23;
          v82 = 2112;
          v83 = v24;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating state: %@", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v20);
        -[HMDSoftwareUpdate setState:](v21, "setState:", v19);
        v25 = (void *)MEMORY[0x1E0D285F8];
        v26 = *MEMORY[0x1E0CB9D88];
        v27 = v21;
        objc_msgSend(v16, "identifier");
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        v86[0] = *MEMORY[0x1E0CB9D70];
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDSoftwareUpdate state](v27, "state"));
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        *(_QWORD *)buf = v29;
      ...
      if ((v37 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[4] = v44;
          v82 = 2112;
          v83 = v35;
          _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Updating documentation metadata: %@", buf, 0x16u);
        ...
        v68 = *MEMORY[0x1E0CB9D80];
        v47 = v41;
        objc_msgSend(v16, "identifier");
        v48 = (void *)objc_claimAutoreleasedReturnValue();
        v86[0] = *MEMORY[0x1E0CB9CC8];
        v70 = v45;
        v72 = v10;
        if (v45)
        ...
        *(_QWORD *)buf = v51;
        objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", buf, v86, 1, v68);
      ...
      if ((v60 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&buf[4] = v64;
          ...
          v84 = 2112;
          v85 = v58;
          _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating releaseDate from %@ to %@", buf, 0x20u);
...
- (HMDSoftwareUpdate)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9DA0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9CA8]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v6)
  {
  ...
  v7 = objc_msgSend(v4, "decodeInt64ForKey:", *MEMORY[0x1E0CB9CD8]);
  v8 = objc_msgSend(v4, "decodeIntegerForKey:", *MEMORY[0x1E0CB9D68]);
  v9 = (double)objc_msgSend(v4, "decodeIntegerForKey:", *MEMORY[0x1E0CB9CE8]);
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9CC0]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9D50]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB9CE0]);
    v13 = objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMDSoftwareUpdate identifier](self, "identifier");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v4, *MEMORY[0x1E0CB9CE0]);

  -[HMDSoftwareUpdate version](self, "version");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v5, *MEMORY[0x1E0CB9DA0]);

  -[HMDSoftwareUpdate displayableVersion](self, "displayableVersion");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB9CA8]);

  v7 = -[HMDSoftwareUpdate state](self, "state");
  objc_msgSend(v17, "encodeInteger:forKey:", v7, *MEMORY[0x1E0CB9D68]);
  v8 = -[HMDSoftwareUpdate downloadSize](self, "downloadSize");
  objc_msgSend(v17, "encodeInt64:forKey:", v8, *MEMORY[0x1E0CB9CD8]);
  -[HMDSoftwareUpdate installDuration](self, "installDuration");
  objc_msgSend(v17, "encodeInteger:forKey:", (uint64_t)v9, *MEMORY[0x1E0CB9CE8]);
  -[HMDSoftwareUpdate documentationMetadata](self, "documentationMetadata");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v10, *MEMORY[0x1E0CB9CC0]);

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDSoftwareUpdate updateType](self, "updateType"));
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v11, *MEMORY[0x1E0CB9D90]);

  -[HMDSoftwareUpdate releaseDate](self, "releaseDate");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v17, "encodeObject:forKey:", v12, *MEMORY[0x1E0CB9D50]);
  ...
  if (objc_msgSend(v17, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "encodeObject:forKey:", v16, *MEMORY[0x1E0CB9CB0]);
  ...
  if (v7)
  {
    ...
    if (v9 && objc_msgSend(v9, "integerValue") == 4)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification documentation is available, notifying clients", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v10);
      v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28628]), "initWithName:", CFSTR("SUDocumentation"));
      objc_msgSend(v4, "documentation");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      v16 = v15;
      if (v15)
      {
        v24 = *MEMORY[0x1E0CB9CB8];
        ...
        objc_msgSend(MEMORY[0x1E0D285F8], "entitledMessageWithName:messagePayload:", *MEMORY[0x1E0CB9CD0], v18, v24);
        v19 = (void *)objc_claimAutoreleasedReturnValue();
...
void __46__HMDSoftwareUpdate_setDocumentationMetadata___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Updated documentation metadata: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)modelNamespace
{
  if (modelNamespace_onceToken_82132 != -1)
    dispatch_once(&modelNamespace_onceToken_82132, &__block_literal_global_82133);
  return (id)modelNamespace_namespace_82134;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t40_82127 != -1)
    dispatch_once(&logCategory__hmf_once_t40_82127, &__block_literal_global_41_82128);
  return (id)logCategory__hmf_once_v41_82129;
}
...
void __32__HMDSoftwareUpdate_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v41_82129;
  logCategory__hmf_once_v41_82129 = v0;

}

void __35__HMDSoftwareUpdate_modelNamespace__block_invoke()
{
  uint64_t v0;
  void *v1;

  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("AE2B13F5-9554-489C-BFE0-C6740C4E70B7"));
  v1 = (void *)modelNamespace_namespace_82134;
  modelNamespace_namespace_82134 = v0;
