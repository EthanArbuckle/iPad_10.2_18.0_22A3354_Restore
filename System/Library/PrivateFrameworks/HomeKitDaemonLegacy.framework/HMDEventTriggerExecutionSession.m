...
- (void)setExecutionState:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2114;
    v16 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting the execution from %{public}@ to %{public}@", (uint8_t *)&v11, 0x20u);
...
- (void)_evaluateFiringTrigger
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v83 = 2112;
    v84 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@recurrences : %@, dateComponents: %@", buf, 0x20u);
...
LABEL_6:
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v83 = 2112;
        v84 = v57;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Evaluation condition : %@, Re-written predicate : %@", buf, 0x20u);
      ...
      if (objc_msgSend(v58, "count"))
      {
            ...
            for (i = 0; i != v22; ++i)
            {
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v81 = 2112;
                v82 = (uint64_t)v30;
                _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Going to read characteristics from accessory %@", buf, 0x16u);
        ...
        v40 = (void *)MEMORY[0x1D17BA0A0](-[HMDEventTriggerExecutionSession setExecutionState:](val, "setExecutionState:", 1));
        v41 = val;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v81 = 2048;
          v82 = v44;
          _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Waiting to read [%lu] characterics before executing the trigger", buf, 0x16u);
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v81 = 2112;
      v82 = (uint64_t)v55;
      _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@EventTrigger Evaluation State : [%@]", buf, 0x16u);
  ...
  if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v80 = v48;
    _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@Trigger not fired since recurrence does not match", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v45);
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 3005);
...
- (void)_executeTriggerAfterEvaluatingCondition:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v53 = 2112;
    v54 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Going to evaluate the trigger After evaluating : %@", buf, 0x16u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v53 = 2112;
      v54 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Evaluating the trigger predicate using %@", buf, 0x16u);
    ...
    if ((v16 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v52 = v38;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Trigger condition evaluated to NO, not firing action set", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v35);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 3006);
  ...
  if (objc_msgSend(v17, "count"))
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v52 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Location triggers that contain secure action sets should ask for a confirmation before execution", buf, 0xCu);
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v52 = v43;
    _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Directly executing action set as user confirmation is not required", buf, 0xCu);
...
- (void)_userResponse:(unint64_t)a3 device:(id)a4 completionHandler:(id)a5
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v48 = 138543362;
      v49 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@There is no confirmation timer running, not processing the confirmation", (uint8_t *)&v48, 0xCu);
  ...
  if (v11)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v48 = 138543362;
      v49 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Action set execution is already in progress", (uint8_t *)&v48, 0xCu);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v52 = 2112;
    v53 = v26;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Received response from %@ with %@", (uint8_t *)&v48, 0x20u);
  ...
  switch(a3)
  {
    ...
    case 4uLL:
      ...
      if (!v29)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          v48 = 138543362;
          v49 = v33;
          _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@None of the devices have answered the dialog, ending the session", (uint8_t *)&v48, 0xCu);
    ...
    case 2uLL:
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        v48 = 138543362;
        v49 = v41;
        _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_INFO, "%{public}@User confirms to execute trigger", (uint8_t *)&v48, 0xCu);
    ...
    case 3uLL:
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        v48 = 138543362;
        v49 = v44;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@User confirms not to execute trigger", (uint8_t *)&v48, 0xCu);
...
- (void)_addEvent:(id)a3 causingDevice:(id)a4
{
  ...
  if (-[HMDEventTriggerExecutionSession executionState](self, "executionState") > 2)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v34 = 2112;
      v35 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Current state has moved beyond waiting for user response: %@", (uint8_t *)&v32, 0x16u);
  ...
  if ((v9 & 1) != 0)
  {
    if (v13)
    {
      ...
      v34 = 2112;
      v35 = v7;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Device is already in the causing devices list, %@", (uint8_t *)&v32, 0x16u);
...
LABEL_9:
  ...
  if (v13)
  {
    ...
    v34 = 2112;
    v35 = v7;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding device to ask for confirmation, %@", (uint8_t *)&v32, 0x16u);
  ...
  if ((v24 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v34 = 2112;
      v35 = v6;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Adding event as an additional event, %@", (uint8_t *)&v32, 0x16u);
...
- (void)_handleActionSetExecutionResponse:(id)a3 actionSetError:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&v50[14] = v9;
    v51 = 2112;
    v52 = v8;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Action set execution responded with error %@ and response %@", v50, 0x20u);
  ...
  if (v9)
  {
    ...
    if (objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0CB8C70]))
    {
      ...
      if (v19 == 64)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_QWORD *)&v50[4] = v23;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Action set has resulted in partial success, proceeding with successful ones", v50, 0xCu);
...
LABEL_20:
    _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, v39, v50, 0xCu);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&v50[12] = 2112;
    *(_QWORD *)&v50[14] = v31;
    _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Created monitoring events %@", v50, 0x16u);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v50 = 138543362;
    *(_QWORD *)&v50[4] = v45;
    _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@There are end events with the execution session, activating them", v50, 0xCu);
  ...
  v46 = objc_alloc(MEMORY[0x1E0D286C8]);
          ...
          do
          {
            ...
            do
            {
              ...
              if ((HMFEqualObjects() & 1) == 0)
              {
                ...
                v14 = (void *)objc_claimAutoreleasedReturnValue();
                v95 = v13;
                v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", v13);
                ...
                if (!v18)
                {
                  v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", v95);
                        ...
                        do
                        {
                          ...
                          do
                          {
                            ...
                            if (v33)
                            {
                              ...
                              if (!v37)
                                goto LABEL_39;
                              if (v35 && (objc_msgSend(v35, "isEqual:", MEMORY[0x1E0C9AAA0]) & 1) == 0)
                              {
                                ...
                                if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
                                {
                                  ...
                                  *(_DWORD *)buf = 138543618;
                                  ...
                                  v118 = 2112;
                                  v119 = (const char *)v33;
                                  _os_log_impl(&dword_1CD062000, v69, OS_LOG_TYPE_INFO, "%{public}@Did not create write request for characteristic because it was ON prior to trigger, %@", buf, 0x16u);
                              ...
                              else
                              {
                                ...
                                v38 = (void *)objc_claimAutoreleasedReturnValue();
                                +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:value:authorizationData:type:](HMDCharacteristicWriteRequest, "writeRequestWithCharacteristic:value:authorizationData:type:", v33, MEMORY[0x1E0C9AAA0], v38, 1);
                                v39 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_39:
                                ...
                                if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
                                {
                                  ...
                                  *(_DWORD *)buf = 138544130;
                                  ...
                                  v122 = 2112;
                                  v123 = v33;
                                  _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@%s write request for characteristic because characteristic type %s supported for Duration Event, %@", buf, 0x2Au);
                                ...
                                if (v48)
                                {
                                  ...
                                  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v99, "integerValue"));
                                  ...
                                  else
                                  {
                                    ...
                                    if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
                                    {
                                      ...
                                      *(_DWORD *)buf = 138543618;
                                      ...
                                      v118 = 2112;
                                      v119 = (const char *)v33;
                                      _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_ERROR, "%{public}@Failed to create monitor event for %@", buf, 0x16u);
                                ...
                                else
                                {
                                  ...
                                  if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
                                  {
                                    ...
                                    *(_DWORD *)buf = 138543618;
                                    ...
                                    v118 = 2112;
                                    v119 = (const char *)v33;
                                    _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_ERROR, "%{public}@No value reported in action set result, Not creating the monitor event for %@", buf, 0x16u);
                            ...
                            if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
                            {
                              ...
                              *(_DWORD *)buf = 138544130;
                              ...
                              v122 = 2112;
                              v123 = v30;
                              _os_log_impl(&dword_1CD062000, v57, OS_LOG_TYPE_ERROR, "%{public}@Could not find the characteristic %@/%@/%@", buf, 0x2Au);
...
- (void)_callExecutionComplete:(id)a3 callDelegate:(BOOL)a4
{
  ...
  if (-[HMDEventTriggerExecutionSession executionCompleteCalled](self, "executionCompleteCalled"))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v47 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Execution complete already called, ignoring", buf, 0xCu);
  ...
  else
  {
    ...
    if (v12)
    {
      ...
      do
      {
        for (i = 0; i != v13; ++i)
        {
          ...
          if (objc_msgSend(v16, "conformsToProtocol:", &unk_1EFAA3548))
            v17 = v16;
          else
            v17 = 0;
          v18 = v17;
    ...
    v19 = (void *)MEMORY[0x1D17BA0A0](-[HMDEventTriggerExecutionSession _removeUserDialog](self, "_removeUserDialog"));
    v20 = self;
    HMFGetOSLogHandle();
    v21 = objc_claimAutoreleasedReturnValue();
    ...
    if (v4)
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v48 = 2114;
        v49 = v6;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Informing that trigger action set execution is complete with error %{public}@", buf, 0x16u);
    ...
    else
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v47 = v25;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Not calling the delegate", buf, 0xCu);
        ...
        for (j = 0; j != v28; ++j)
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v48 = 2112;
            v49 = v31;
            _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Deactivating end event %@", buf, 0x16u);
...
- (void)_restoreState
{
  ...
  if (-[HMDEventTriggerExecutionSession restoreInProgress](self, "restoreInProgress"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@State restoration is already in progress, ignoring", buf, 0xCu);
  ...
  else
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        v45 = 2048;
        v46 = v26;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Executing write requests for request identifier: %{public,uuid_t}.16P from event trigger execution session: %{public}@ count: %lu", buf, 0x30u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v38 = v25;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to get valid Home reference", buf, 0xCu);
        ...
        if (v15 == v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v34 = 2112;
            v35 = v13;
            _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Removing the write requests on characteristic as it was changed, %@", buf, 0x16u);
...
- (void)handleSessionPlaybackStateUpdatedNotification:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0CB95E0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDEventTriggerSession workQueue](self, "workQueue");
...
LABEL_4:
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v12;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Not ending the trigger execution session because there are write requests left %@ or media profiles %@", (uint8_t *)&v17, 0x20u);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 138543362;
    v18 = v16;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@No more write requests in restore list, declaring execution complete", (uint8_t *)&v17, 0xCu);
...
void __48__HMDEventTriggerExecutionSession_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@No user has responded to the confirmation yet, declaring confirmation denied", buf, 0xCu);
  ...
  else
  {
    ...
    if (v4 == v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v9;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Start char monitor timer has fired, activating monitoring events", buf, 0xCu);
...
void __63__HMDEventTriggerExecutionSession_didOccurEvent_causingDevice___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@End Event has occurred, declaring execution complete, %@", (uint8_t *)&v22, 0x16u);
...
LABEL_9:
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2114;
      v25 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Monitored Event %{public}@ has occurred", (uint8_t *)&v22, 0x16u);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v21;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Received a delegate callback on event occurrence from %@", (uint8_t *)&v22, 0x16u);
...
void __81__HMDEventTriggerExecutionSession_handleSessionPlaybackStateUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2112;
    v40 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Received notification userInfo %@", buf, 0x16u);
  ...
  objc_msgSend(v7, "home");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", *(_QWORD *)(a1 + 48));
        ...
        if (objc_msgSend(v11, "containsObject:", v20))
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v39 = 2112;
            v40 = v20;
            _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Removing the media profile as it was changed, %@", buf, 0x16u);
...
uint64_t __51__HMDEventTriggerExecutionSession__activateEvents___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Activating event failed with error %@, %@", (uint8_t *)&v9, 0x20u);
...
void __83__HMDEventTriggerExecutionSession__directlyExecuteActionSetsWithCompletionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    v13[0] = MEMORY[0x1E0C809B0];
    v13[1] = 3221225472;
    v13[2] = __83__HMDEventTriggerExecutionSession__directlyExecuteActionSetsWithCompletionHandler___block_invoke_54;
    v13[3] = &unk_1E89C0448;
    v13[4] = v8;
    v14 = v6;
    v15 = v5;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self while executing action set", buf, 0xCu);
...
uint64_t __83__HMDEventTriggerExecutionSession__directlyExecuteActionSetsWithCompletionHandler___block_invoke_54(uint64_t a1)
{
...
uint64_t __70__HMDEventTriggerExecutionSession_postponeRestoreIfWaitingForEndEvent__block_invoke(uint64_t a1)
{
  ...
  if (result == 4)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Waiting for end event, received request to postpone the end event", (uint8_t *)&v7, 0xCu);
...
void __72__HMDEventTriggerExecutionSession_cancelSessionIfWaitingForUserResponse__block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "executionState") == 2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138543362;
      v9 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Waiting for user response, received request to cancel the session", (uint8_t *)&v8, 0xCu);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v27 = 2112;
      v28 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to fulfill read requests before evaluating trigger due to error (%@), (%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (WeakRetained)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v27 = 2112;
        v28 = v6;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Finished read requests %@ with response %@", buf, 0x20u);
      ...
      v21[1] = 3221225472;
      v21[2] = __57__HMDEventTriggerExecutionSession__evaluateFiringTrigger__block_invoke_49;
      v21[3] = &unk_1E89C2328;
      v21[4] = v14;
      v22 = *(id *)(a1 + 40);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v20;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Execution session is no more valid", buf, 0xCu);
...
uint64_t __57__HMDEventTriggerExecutionSession__evaluateFiringTrigger__block_invoke_49(uint64_t a1)
{
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_174127 != -1)
    dispatch_once(&logCategory__hmf_once_t0_174127, &__block_literal_global_174128);
  return (id)logCategory__hmf_once_v1_174129;
}
...
void __46__HMDEventTriggerExecutionSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_174129;
  logCategory__hmf_once_v1_174129 = v0;
