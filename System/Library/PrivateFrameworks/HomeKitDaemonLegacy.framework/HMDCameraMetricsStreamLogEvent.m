...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDCameraMetricsLogEvent isLocal](self, "isLocal"));
...
- (id)_durationBetweenMilestone1:(id)a3 andMilestone2:(id)a4 index:(id)a5
{
  ...
  if (v8 && a4)
  {
    ...
    v25 = v19;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", v20 - v21);
...
void __62__HMDCameraMetricsStreamLogEvent__milestonesSortedByTimestamp__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    ...
    objc_msgSend(*(id *)(a1 + 32), "insertObject:atIndex:", v8, objc_msgSend(*(id *)(a1 + 32), "indexOfObject:inSortedRange:options:usingComparator:", v8, 0, objc_msgSend(*(id *)(a1 + 32), "count"), 1024, &__block_literal_global_111109));
