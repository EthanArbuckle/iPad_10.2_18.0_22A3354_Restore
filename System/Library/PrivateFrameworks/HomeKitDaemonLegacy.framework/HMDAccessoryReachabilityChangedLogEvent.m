...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDAccessoryReachabilityChangedLogEvent accessoryBatteryPowered](self, "accessoryBatteryPowered"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, CFSTR("accessoryBatteryPowered"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDAccessoryReachabilityChangedLogEvent accessoryBridged](self, "accessoryBridged"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDAccessoryReachabilityChangedLogEvent batteryLow](self, "batteryLow"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDAccessoryReachabilityChangedLogEvent reachable](self, "reachable"));
