...
- (_HMDIDSProxyLinkPreferenceAssertion)initWithIDSProxyService:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", 150);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "setObject:forKeyedSubscript:", v9, *MEMORY[0x1E0D34078]);

    objc_msgSend(v8, "setObject:forKeyedSubscript:", CFSTR("forceBTClassic"), *MEMORY[0x1E0D34068]);
    v10 = isWatch();
    if (v10)
      v11 = 6250;
    else
    ...
    objc_msgSend(v8, "setObject:forKeyedSubscript:", v13, *MEMORY[0x1E0D34060]);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", v12);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "setObject:forKeyedSubscript:", v14, *MEMORY[0x1E0D34070]);
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v8;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Setting the link preference for proxy service with %@", buf, 0x16u);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the link preference for proxy service", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v3);
  -[_HMDIDSProxyLinkPreferenceAssertion proxyService](v4, "proxyService");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "setLinkPreferences:", MEMORY[0x1E0C9AA70]);
