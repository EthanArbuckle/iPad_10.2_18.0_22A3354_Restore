...
- (HMDUserCloudShareOwnerAdoptionDailyEvent)initWithConfigureState:(int64_t)a3 isPrimaryResident:(BOOL)a4 trustStatusCounts:(CloudShareTrustManagerTrustStatusCounts *)a5
{
  ...
  if (v8)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", a5->var0);
    v13 = objc_claimAutoreleasedReturnValue();
    hasSharedUser = v8->_hasSharedUser;
    v8->_hasSharedUser = (NSNumber *)v13;

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a5->var1);
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a5->var2);
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a5->var3);
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a5->var4);
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a5->var5);
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a5->var6);
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a5->var7);
