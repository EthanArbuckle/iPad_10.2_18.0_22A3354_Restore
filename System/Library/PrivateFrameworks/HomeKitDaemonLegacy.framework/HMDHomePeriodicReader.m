...
- (void)handleCharacteristicBasedEventAdded:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received characteristic event added notification", (uint8_t *)&v9, 0xCu);
...
- (void)handleTimerFiredNotification:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Issuing read for fired timer with ID: %@", (uint8_t *)&v13, 0x16u);
...
- (void)residentUpdated
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resident updated, issuing a read", (uint8_t *)&v7, 0xCu);
...
- (id)_characteristicsToRead
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    if (v47)
    {
      ...
      v45 = v22;
      v46 = *(_QWORD *)v58;
      v23 = *MEMORY[0x1E0D16198];
      v24 = *MEMORY[0x1E0D15F98];
      do
      {
        v25 = 0;
        do
...
LABEL_50:
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v74 = v42;
    _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@This device is not the resident, not issuing the periodic read", buf, 0xCu);
...
- (void)startReadTimer
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v11 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Object not configured yet", buf, 0xCu);
...
- (void)_checkToIssueRead
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping the timer with ID: %@", (uint8_t *)&v11, 0x16u);
      ...
      for (i = 0; i != v7; ++i)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v20;
          ...
          v28 = 2112;
          v29 = v10;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Issuing a periodic read for %@", buf, 0x16u);
        ...
        objc_msgSend(v10, "readCharacteristicValues:source:queue:completionHandler:", v11, 7, v19, &__block_literal_global_16_81175);
...
- (void)_startTimer
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v7;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Preference for reader interval is missing, using default value: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v32 = 2112;
    v33 = v19;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Starting the next timer (%@) to fire at %@", buf, 0x20u);
  ...
  if ((v21 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v32 = 2112;
      v33 = v22;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to start timer %@ with error %@", buf, 0x20u);
...
void __39__HMDHomePeriodicReader_startReadTimer__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting periodic read timer", (uint8_t *)&v7, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_81200 != -1)
    dispatch_once(&logCategory__hmf_once_t0_81200, &__block_literal_global_81201);
  return (id)logCategory__hmf_once_v1_81202;
}
...
void __36__HMDHomePeriodicReader_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_81202;
  logCategory__hmf_once_v1_81202 = v0;
