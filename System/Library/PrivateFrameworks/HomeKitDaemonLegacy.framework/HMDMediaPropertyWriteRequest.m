...
+ (id)requestWithProperty:(id)a3 mediaProfile:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Write request cannot be initialized using this interface - use -[writeRequestWithProperty:value:medaPofile:]", (uint8_t *)&v11, 0xCu);
