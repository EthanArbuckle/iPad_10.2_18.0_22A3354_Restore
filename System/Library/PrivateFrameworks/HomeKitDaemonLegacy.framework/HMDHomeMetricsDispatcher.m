...
- (void)submitMigrationEventMetricsForModel:(id)a3 reason:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Submitting migration event metric for model: %@ reason: %@", (uint8_t *)&v14, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_7618 != -1)
    dispatch_once(&logCategory__hmf_once_t1_7618, &__block_literal_global_7619);
  return (id)logCategory__hmf_once_v2_7620;
}
...
void __39__HMDHomeMetricsDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_7620;
  logCategory__hmf_once_v2_7620 = v0;
