...
- (id)controller:(id)a3 cloudDatabaseWithContainerID:(id)a4
{
  ...
  if (v9)
  {
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32CB0]), "initWithContainerID:", v7);
    objc_msgSend(v10, "setSubscriptionPushRegistrationAction:", 1);
    v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32C20]), "initWithLocalDatabase:configuration:", v9, v10);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get default local database", (uint8_t *)&v17, 0xCu);
