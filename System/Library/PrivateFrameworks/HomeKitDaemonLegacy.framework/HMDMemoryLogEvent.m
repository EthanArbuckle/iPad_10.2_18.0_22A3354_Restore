...
- (void)updateDiagnosticReportSignature:(id)a3
{
  ...
  if (task_generate_corpse(v6, &corpse_task_port))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Failed to generate a corpse task for memory exception reporting", buf, 0xCu);
  ...
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v14, *MEMORY[0x1E0DB00F0]);
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%lld,%lld"), -[HMDMemoryLogEvent currentMemoryUsage](self, "currentMemoryUsage"), -[HMDMemoryLogEvent intervalMaxMemoryUsage](self, "intervalMaxMemoryUsage"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKeyedSubscript:", v15, *MEMORY[0x1E0DB00F8]);
