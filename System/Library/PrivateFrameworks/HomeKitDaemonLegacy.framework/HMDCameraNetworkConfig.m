  ...
  if (!GetPrimaryIPAddress())
  {
    ...
    if (HIWORD(v8) != 43518 && (v8 & 0xFFFFFF00) != -536870912)
    {
      *(_OWORD *)buf = 0u;
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", inet_ntop(2, p_s_addr, (char *)buf, 0x2Eu));
...
LABEL_18:
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v19, 0x16u);
    ...
    else
    {
      *(_OWORD *)buf = 0u;
      memset(v24, 0, sizeof(v24));
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", inet_ntop(30, &v2->_ipv6SockAddress.v6.sin6_addr, (char *)buf, 0x2Eu));
...
LABEL_19:
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&buf[4] = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Failed to get Primary IP Address", buf, 0xCu);
