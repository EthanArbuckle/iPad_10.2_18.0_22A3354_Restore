...
- (NSNumber)number
{
  return (NSNumber *)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDUserPresenceUpdateReason value](self, "value"));
}
...
- (id)description
{
  ...
  if (v3 - 2 >= 0xB)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unknown HMDUserPresenceUpdateReasonStatus %tu"), v3);
    v4 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v4 = off_1E89C2068[v3 - 2];
  }
