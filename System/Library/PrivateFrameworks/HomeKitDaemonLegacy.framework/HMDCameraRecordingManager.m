...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v10 = 2048;
    v11 = v4;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Camera recording manager: %p destroyed", buf, 0x16u);
...
LABEL_15:
    ...
    v20 = (void *)MEMORY[0x1D17BA0A0](-[HMDCameraRecordingManager _resetRetryContextWithReason:](self, "_resetRetryContextWithReason:", CFSTR("Received recording session trigger from accessory")));
    v21 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2048;
      v27 = a4;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Coordinating recording session for active trigger of type %lu", (uint8_t *)&v24, 0x16u);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 138543362;
    v25 = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Ignoring notificationTrigger:didObserveTriggerType:changeToActive: because recording manager was shut down", (uint8_t *)&v24, 0xCu);
...
- (void)recordingSettingsControlDidConfigure:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 138543362;
    v22 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Recording settings control did configure", (uint8_t *)&v21, 0xCu);
  ...
  if (v10)
  {
    if (v14)
    {
      ...
      v21 = 138543362;
      v22 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Ignoring recordingSettingsControlDidConfigure: because recording manager was shut down", (uint8_t *)&v21, 0xCu);
  ...
  else
  {
    if (v14)
    {
      ...
      v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Closing current session if one exists because recording settings have been configured", (uint8_t *)&v21, 0xCu);
    ...
    if (-[HMDCameraRecordingManager isMotionActive](v12, "isMotionActive"))
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 138543362;
        v22 = v20;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Motion is active and camera did configure successfully, attempting to coordinate a recording session", (uint8_t *)&v21, 0xCu);
...
- (void)_start
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v30 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting", buf, 0xCu);
...
- (void)_shutDown
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Shutting down", (uint8_t *)&v10, 0xCu);
...
- (void)_clipManagerDidStartUpCloudZone
{
  ...
  if (-[HMDCameraRecordingManager didShutDown](self, "didShutDown"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring clipManagerDidStartUpCloudZone because recording manager was shut down", (uint8_t *)&v14, 0xCu);
  ...
  else
  {
    ...
    if (-[HMDCameraRecordingManager isMotionActive](self, "isMotionActive"))
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Clip manager started up cloud zone and motion is active, attempting to coordinate a recording session", (uint8_t *)&v14, 0xCu);
  ...
  if (v6)
  {
    ...
    if (!v8)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v39 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Cannot coordinate recording session because accessory reference is nil", buf, 0xCu);
      ...
      if ((objc_msgSend(v10, "isCurrentDeviceConfirmedPrimaryResident") & 1) != 0)
      {
        ...
        if ((HMIsRecordingAllowedForCameraAccessMode() & 1) != 0)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v39 = v35;
              _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Synchronizing settings with camera because settings have recording enabled, but camera is not configured for recording", buf, 0xCu);
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v40 = 2112;
          v41 = v31;
          _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Current access mode does not allow recording: %@", buf, 0x16u);
...
LABEL_21:
    ...
    _os_log_impl(&dword_1CD062000, v28, v29, v27, buf, 0xCu);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v39 = v18;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot coordinate recording session because camera reference is nil", buf, 0xCu);
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v25 = v20;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@No device found for recording session, optimistically trying self", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Camera object with UUID:%@ is nil", buf, 0x16u);
...
- (id)messagePayloadForStartRecordingSessionWithTriggerType:(unint64_t)a3
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 2112;
      v26 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Adding socket info to outgoing start recording message payload: %@", (uint8_t *)&v23, 0x16u);
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 2112;
      v26 = v16;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Adding bonjour device info to outgoing start recording message: %@", (uint8_t *)&v23, 0x16u);
...
- (void)_forwardRecordingSessionForTrigger:(unint64_t)a3 withLoadBalancerDecision:(id)a4 deviceFilter:(id)a5 sessionCoordinationLogEvent:(id)a6 retryAttemptNumber:(int64_t)a7
{
  ...
  if (objc_msgSend(v16, "isCurrentDevice"))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v55 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@We are the best device for recording session, starting locally", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v58 = 2114;
      v59 = v34;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Forwarding recording session to %{public}@ via message: %{public}@", buf, 0x20u);
...
- (void)_submitLoadBalancingEventWithDecision:(id)a3 numberOfRetries:(unint64_t)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v5, "numberOfAvailableDevices"));
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", a4);
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v5, "totalNumberOfJobSlots"));
  v25 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_createRecordingSessionWithHomePresenceByPairingIdentity:(id)a3 selectedConfiguration:(id)a4
{
  ...
  if (v9 && v10 && v11 && v13)
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99D68], "dateWithTimeIntervalSinceNow:", v24 / -1000.0);
    v25 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v51 = 2112;
      v52 = v13;
      _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_ERROR, "%{public}@Cannot start recording session because camera=%@ accessory=%@ home=%@ localZone=%@", buf, 0x34u);
...
- (void)assignAccessoryConnectionInfoUsingMessagePayload:(id)a3
{
  ...
  if (v5)
  {
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D165C0]), "initWithDictionary:", v5);
    if (v6)
    {
      ...
      if (v7)
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          v23 = 138543362;
          v24 = v12;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Assigning connection info to accessory", (uint8_t *)&v23, 0xCu);
      ...
      else
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        {
          ...
          v23 = 138543362;
          v24 = v22;
          _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@No bonjour device info received for start recording session request", (uint8_t *)&v23, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v5;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to create HAPSocketInfo for start recording request with dictionary: %@", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      v23 = 138543362;
      v24 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@No socket info received for start recording session request", (uint8_t *)&v23, 0xCu);
...
- (void)handleStartRecordingSessionRequest:(id)a3
{
  ...
  void *v14;
  void *v15;
  HMDCameraRecordingBulkSessionStartLogEvent *v16;
  void *v17;
  void *v18;
  HMDCameraRecordingBulkSessionStartLogEvent *v19;
  uint64_t v20;
  HMDCameraRecordingBulkSessionStartLogEvent *v21;
  void *v22;
  ...
  void *v26;
  void *v27;
  HMDCameraRecordingManager *v28;
  NSObject *v29;
  void *v30;
  void *v31;
  _QWORD v32[5];
  HMDCameraRecordingBulkSessionStartLogEvent *v33;
  id v34;
  uint8_t buf[4];
  void *v36;
  __int16 v37;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    v38 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to handle recording session: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v6);
  objc_msgSend(v4, "messagePayload");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "hmf_dictionaryForKey:", CFSTR("HMDCameraRecordingHomePresenceByPairingIdentity"));
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    objc_msgSend(v4, "messagePayload");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDCameraRecordingManager assignAccessoryConnectionInfoUsingMessagePayload:](v7, "assignAccessoryConnectionInfoUsingMessagePayload:", v13);

    objc_msgSend(v4, "messagePayload");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v14, "hmf_numberForKey:", CFSTR("notificationTriggerType"));
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v15)
    {
      ...
      v16 = [HMDCameraRecordingBulkSessionStartLogEvent alloc];
      -[HMDCameraRecordingManager accessory](v7, "accessory");
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v17, "identifier");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      v19 = -[HMDCameraRecordingBulkSessionStartLogEvent initWithAccessoryIdentifier:](v16, "initWithAccessoryIdentifier:", v18);

      v20 = objc_msgSend(v15, "integerValue");
      v32[0] = MEMORY[0x1E0C809B0];
      v32[1] = 3221225472;
      v32[2] = __64__HMDCameraRecordingManager_handleStartRecordingSessionRequest___block_invoke;
      v32[3] = &unk_1E89C0DA8;
      v32[4] = v7;
      v33 = v19;
      v34 = v4;
      v21 = v19;
      -[HMDCameraRecordingManager _prepareRecordingSessionForTrigger:homePresenceByPairingIdentity:reason:completionCallback:](v7, "_prepareRecordingSessionForTrigger:homePresenceByPairingIdentity:reason:completionCallback:", v20, v12, CFSTR("request from primary resident"), v32);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v37 = 2112;
        v38 = v31;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not find trigger in message payload: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v27);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 48);
      v21 = (HMDCameraRecordingBulkSessionStartLogEvent *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v26;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not find home presence by pairing identity in message payload: %@", buf, 0x16u);
...
- (void)_prepareRecordingSessionForTrigger:(unint64_t)a3 homePresenceByPairingIdentity:(id)a4 reason:(id)a5 completionCallback:(id)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v11;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Configuring recording session with reason: %@", buf, 0x16u);
...
- (void)_startRecordingSessionForTrigger:(unint64_t)a3 homePresenceByPairingIdentity:(id)a4 reason:(id)a5 selectedConfiguration:(id)a6 completionCallback:(id)a7
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v59 = 2112;
    v60 = v13;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Starting recording session with reason: %@", buf, 0x16u);
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2048;
      v60 = v27;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Waiting for retry timer with duration: %f to expire", buf, 0x16u);
  ...
  if ((v30 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v58 = v41;
      _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Unable to start recording session, no backing store available", buf, 0xCu);
  ...
  if (v31)
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v58 = v35;
      _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@A bulk send session is already opened", buf, 0xCu);
...
LABEL_15:
  ...
  if (v44)
  {
    if (v48)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v58 = v49;
      _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@A bulk send session open is already in progress", buf, 0xCu);
  ...
  if (v48)
  {
    ...
    *(_DWORD *)buf = 138543362;
    v58 = v50;
    _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@Opening new bulk send session", buf, 0xCu);
...
- (void)_handleBulkSendSessionCreated:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Created bulk send session: %@", (uint8_t *)&v24, 0x16u);
  ...
  if (v6 == v4)
  {
    ...
    if (-[HMDCameraRecordingManager isMotionActive](self, "isMotionActive"))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v13 = 138543362;
        v14 = v10;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting recording session after session retry timer has expired", (uint8_t *)&v13, 0xCu);
...
- (void)_closeCurrentSessionsWithReason:(unsigned __int16)a3 error:(id)a4
{
  ...
  if ((_DWORD)v4)
  {
    ...
    else
    {
      ...
      -[HMDCameraRecordingManager logEventSubmitter](self, "logEventSubmitter");
      v12 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDCameraRecordingBulkSessionCloseReason"), v4, 0);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_resetRetryContextWithReason:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Resetting session retry context with reason: %@", (uint8_t *)&v11, 0x16u);
...
- (void)_startSessionRetryTimer
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2048;
    v22 = v7;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Starting session retry timer with interval: %f", (uint8_t *)&v19, 0x16u);
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v38 = 2112;
            v39 = v4;
            _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Retrying session with identifier: %@ because motion active: %@, error: %@", buf, 0x2Au);
          ...
          if (!v23)
          {
            ...
            if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v33 = v27;
              _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Creating session retry context", buf, 0xCu);
...
LABEL_8:
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v38 = 2112;
        v39 = v4;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Not retrying session with identifier: %@ because motion active: %@, error: %@", buf, 0x2Au);
...
LABEL_11:
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Session with identifier: %@ succeeded"), v9);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)session:(id)a3 didEndWithError:(id)a4
{
  ...
  if (-[HMDCameraRecordingManager didShutDown](self, "didShutDown"))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Ignoring closeSession:withError: delegate callback because recording manager was shut down", (uint8_t *)&v22, 0xCu);
  ...
  else
  {
    ...
    if (v13 == v6)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 1024;
        v25 = v14;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Closing current session with reason: %d", (uint8_t *)&v22, 0x12u);
...
void __71__HMDCameraRecordingManager_handleCameraSettingsDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "didShutDown"))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Ignoring handleCameraSettingsDidChangeNotification: because recording manager was shut down", (uint8_t *)&v17, 0xCu);
  ...
  else
  {
    ...
    if (HMIsRecordingAllowedForCameraAccessMode())
    {
      ...
      {
        v8 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "_resetRetryContextWithReason:", CFSTR("Settings changed to allow recording")));
        v9 = *(id *)(a1 + 32);
        HMFGetOSLogHandle();
        v10 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          v17 = 138543362;
          v18 = v11;
          _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Motion is active and settings changed to allow recording, attempting to coordinate a recording session", (uint8_t *)&v17, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 2112;
        v20 = v16;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Closing current session because current access mode is: %@", (uint8_t *)&v17, 0x16u);
...
void __140__HMDCameraRecordingManager__startRecordingSessionForTrigger_homePresenceByPairingIdentity_reason_selectedConfiguration_completionCallback___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = v8;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Created recording session: %@", (uint8_t *)&v24, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v6;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to open bulk send session: %@", (uint8_t *)&v24, 0x16u);
...
void __120__HMDCameraRecordingManager__prepareRecordingSessionForTrigger_homePresenceByPairingIdentity_reason_completionCallback___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to configure camera recording settings: %@", (uint8_t *)&v11, 0x16u);
...
LABEL_11:
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, v9, buf, 0x20u);
...
LABEL_13:
    ...
    if (v18 == 21)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v78 = 2112;
        v79 = v3;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Received error that accessory is not configured from device %{public}@: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v78 = 2112;
      v79 = v3;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to forward recording session to device %{public}@: %@", buf, 0x20u);
    ...
    if (!v32)
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v75 = v48;
        _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@Camera reference is nil", buf, 0xCu);
...
LABEL_36:
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v76 = 2112;
        v77 = v60;
        _os_log_impl(&dword_1CD062000, v58, OS_LOG_TYPE_ERROR, "%{public}@Exhausted devices, failed to start recording session for accessory %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v76 = 2112;
        v77 = v41;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Reached retry limit, failed to start recording session for accessory %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v76 = 2114;
    v77 = v14;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Successfully forwarded recording session to %{public}@", buf, 0x16u);
...
uint64_t __68__HMDCameraRecordingManager__loadBalanceRecordingSessionForTrigger___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    v33 = 2112;
    v34 = v28;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Excluding current device from camera recording load balancing because it is the primary resident: %@", (uint8_t *)&v31, 0x16u);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to synchronize settings with camera while coordinating recording session: %@", buf, 0x16u);
...
uint64_t __67__HMDCameraRecordingManager__coordinateRecordingSessionForTrigger___block_invoke_35(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Successfully synchronized settings with camera while coordinating recording session", (uint8_t *)&v7, 0xCu);
...
void __48__HMDCameraRecordingManager_clipManagerDidStop___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "didShutDown"))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Ignoring clipManagerDidStop: because recording manager was shut down", (uint8_t *)&v12, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Closing current session because clip manager became unavailable", (uint8_t *)&v12, 0xCu);
...
+ (BOOL)_isSessionAlreadyInProgressError:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v4, "isEqualToString:", *MEMORY[0x1E0CB8C70]))
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t63 != -1)
    dispatch_once(&logCategory__hmf_once_t63, &__block_literal_global_1649);
  return (id)logCategory__hmf_once_v64;
}
...
void __40__HMDCameraRecordingManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v64;
