...
+ (HMDLaunchHandler)sharedHandler
{
  ...
  block[4] = a1;
  if (sharedHandler_onceToken_126293 != -1)
    dispatch_once(&sharedHandler_onceToken_126293, block);
  return (HMDLaunchHandler *)(id)sharedHandler_sharedHandler_126294;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t9_126288 != -1)
    dispatch_once(&logCategory__hmf_once_t9_126288, &__block_literal_global_7_126289);
  return (id)logCategory__hmf_once_v10_126290;
}
...
void __51__HMDLaunchHandler_registerRelaunchClientWithUUID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Registering client for relaunch: %@", (uint8_t *)&v14, 0x16u);
...
- (HMDLaunchHandler)init
{
  ...
  v7 = -[HMDLaunchHandler initWithRelaunchPlistFileURL:fileManager:jetsamPriorityHandler:](self, "initWithRelaunchPlistFileURL:fileManager:jetsamPriorityHandler:", v5, v6, &__block_literal_global_126282);
...
- (void)_setJetsamPriorityElevated:(BOOL)a3
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 1024;
      v22 = v8;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to set jetsam priority elevated to %@: %d", (uint8_t *)&v17, 0x1Cu);
  ...
  else if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v16;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Successfully set jetsam priority elevated to %@", (uint8_t *)&v17, 0x16u);
...
void __53__HMDLaunchHandler_deregisterRelaunchClientWithUUID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Deregistering client for relaunch: %@", (uint8_t *)&v14, 0x16u);
...
void __68__HMDLaunchHandler_removePersistentRelaunchRegistrationsIfNecessary__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Removing persistent relaunch registrations if necessary", (uint8_t *)&v8, 0xCu);
...
void __31__HMDLaunchHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_126290;
  logCategory__hmf_once_v10_126290 = v0;
...
void __33__HMDLaunchHandler_sharedHandler__block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)sharedHandler_sharedHandler_126294;
  sharedHandler_sharedHandler_126294 = (uint64_t)v1;
