...
- (HMDUserCloudShareManager)initWithHomeManager:(id)a3 dependency:(id)a4
{
  ...
  if (v8)
  {
    ...
    v15 = objc_msgSend(v14, "initWithUUIDString:", *MEMORY[0x1E0CB9F20]);
...
- (void)registerForMessages
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Registering for user share messages.", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v4);
  -[HMDUserCloudShareManager messageDispatcher](v5, "messageDispatcher");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = *MEMORY[0x1E0CB9F10];
...
- (void)userCloudShareController:(id)a3 sendShareRequestMessageWithConnection:(id)a4 fromUser:(id)a5 toUser:(id)a6 home:(id)a7 shareURL:(id)a8 shareToken:(id)a9 containerID:(id)a10 completion:(id)a11
{
  ...
  if (v17)
  {
    ...
    v51[0] = v23;
    v50[1] = *MEMORY[0x1E0CBA000];
    encodeRootObjectForIncomingXPCMessage(v21, 0);
    v24 = (void *)objc_claimAutoreleasedReturnValue();

    v51[1] = v24;
    v50[2] = *MEMORY[0x1E0CBA008];
    encodeRootObjectForIncomingXPCMessage(v20, 0);
    v25 = (void *)objc_claimAutoreleasedReturnValue();

    v26 = *MEMORY[0x1E0CBA048];
    v51[2] = v25;
    v51[3] = v16;
    v27 = *MEMORY[0x1E0CBA040];
    v50[3] = v26;
    v50[4] = v27;
    v50[5] = *MEMORY[0x1E0CB9FF8];
    v51[4] = v17;
    v51[5] = v18;
  ...
  else
  {
    ...
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    v49[0] = v23;
    v48[1] = *MEMORY[0x1E0CBA000];
    encodeRootObjectForIncomingXPCMessage(v33, 0);
    v24 = (void *)objc_claimAutoreleasedReturnValue();

    v49[1] = v24;
    v48[2] = *MEMORY[0x1E0CBA008];
    encodeRootObjectForIncomingXPCMessage(v32, 0);
    v25 = (void *)objc_claimAutoreleasedReturnValue();

    v35 = *MEMORY[0x1E0CBA048];
    v49[2] = v25;
    v49[3] = v16;
    v36 = *MEMORY[0x1E0CB9FF8];
    v48[3] = v35;
    v48[4] = v36;
    v49[4] = v18;
    v28 = (void *)MEMORY[0x1E0C99D80];
  ...
  v38 = (void *)MEMORY[0x1E0D285D0];
  v39 = MEMORY[0x1E0C809B0];
  v40 = *MEMORY[0x1E0CB9F08];
...
- (void)userCloudShareController:(id)a3 sendRepairInfo:(id)a4 toConnection:(id)a5 home:(id)a6 containerID:(id)a7
{
  ...
  v11 = *MEMORY[0x1E0CB9FF8];
  v26[0] = a7;
  v12 = *MEMORY[0x1E0CBA028];
  v25[0] = v11;
  v25[1] = v12;
  v13 = a7;
  v14 = a6;
  ...
  v21 = (void *)objc_msgSend(v20, "initWithUUIDString:", *MEMORY[0x1E0CB9F20]);
  v22 = (void *)objc_msgSend(v19, "initWithTarget:", v21);

  objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:destination:payload:", *MEMORY[0x1E0CB9F00], v22, v18);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)userCloudShareController:(id)a3 wakeClientWithContainerID:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%s%@"), *MEMORY[0x1E0CB9F28], v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v8;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client %@", buf, 0x16u);
...
- (void)userCloudShareController:(id)a3 wakeClientForRepairWithContainerID:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%s%@"), *MEMORY[0x1E0CB9F18], v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = (void *)MEMORY[0x1D17BA0A0]();
  v10 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v16 = 2112;
    v17 = v8;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client to repair share %@", buf, 0x16u);
...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, a4);
}

- (id)currentDateForUserCloudShareController:(id)a3
{
  return (id)objc_msgSend(MEMORY[0x1E0C99D68], "date", a3);
}
...
{
  notify_post((const char *)*MEMORY[0x1E0CB9F30]);
}
...
- (void)_handleRegisterRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 138543362;
        v30 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Found xpc connection in message", (uint8_t *)&v29, 0xCu);

      }
      objc_autoreleasePoolPop(v9);
      objc_msgSend(v4, "arrayForKey:", *MEMORY[0x1E0CB9EF8]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          v31 = 2112;
          v32 = v26;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Missing container IDs while trying to register from process %@", (uint8_t *)&v29, 0x16u);

        }
        objc_autoreleasePoolPop(v22);
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Container IDs required"), CFSTR("No containerIDs specified"), 0);
        v16 = (void *)objc_claimAutoreleasedReturnValue();
      }
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 138543362;
        v30 = v21;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Transport is not XPC connection.", (uint8_t *)&v29, 0xCu);

      }
      objc_autoreleasePoolPop(v9);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Transport is not XPC"), CFSTR("Need xpc connection"), 0);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 138543362;
      v30 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@No transport on message.", (uint8_t *)&v29, 0xCu);

    }
    objc_autoreleasePoolPop(v17);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Did not find transport"), CFSTR("Need xpc connection"), 0);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
void __59__HMDUserCloudShareManager_handleXPCConnectionInvalidated___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Received connection invalidated notification, but no connection object was found: %@", (uint8_t *)&v11, 0x16u);
...
void __74__HMDUserCloudShareManager_handleRemoteUserClientCloudShareRepairRequest___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "uuidForKey:", *MEMORY[0x1E0CBA008]);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Handling share repair message %@.", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v19 = v14;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Could not find home for share repair request on remote.", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v5);
    v15 = *(void **)(a1 + 32);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Home in share repair request not found in remote."), CFSTR("Home is needed for share repair"), 0);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_7:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v20 = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Could not find home for share request on remote.", buf, 0xCu);
  ...
  if (v14)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 2, CFSTR("Home in share request not found in remote."), CFSTR("Home is needed to share"), 0);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v17 = v11;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Forwarding received client info.", buf, 0xCu);
...
uint64_t __68__HMDUserCloudShareManager__handleLocalHomeDataRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Local home data removed, notifying clients", (uint8_t *)&v7, 0xCu);
...
uint64_t __67__HMDUserCloudShareManager__handleUserSettingsUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@User settings updated, notifying clients.", (uint8_t *)&v7, 0xCu);
...
uint64_t __70__HMDUserCloudShareManager__handleEnableMultiUserChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Enable Multi-User changed, notifying clients.", (uint8_t *)&v7, 0xCu);
...
void __50__HMDUserCloudShareManager__handleAccessoryAdded___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v5;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client on adding accessory %@", (uint8_t *)&v10, 0x16u);
...
uint64_t __59__HMDUserCloudShareManager_handleUsersChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client on users changed", (uint8_t *)&v7, 0xCu);
...
uint64_t __58__HMDUserCloudShareManager_handleHomeChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client on home change", (uint8_t *)&v7, 0xCu);
...
void __98__HMDUserCloudShareManager_userCloudShareController_sendRepairInfo_toConnection_home_containerID___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send message to client.", (uint8_t *)&v8, 0xCu);
...
void __155__HMDUserCloudShareManager_userCloudShareController_sendShareRequestMessageWithConnection_fromUser_toUser_home_shareURL_shareToken_containerID_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v5;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Got error from client %@.", (uint8_t *)&v19, 0x16u);
...
LABEL_10:
  ...
  objc_msgSend(v6, "objectForKeyedSubscript:", *MEMORY[0x1E0CB9EF0]);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((v13 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@No error but client did not accept share, treating as error.", (uint8_t *)&v19, 0xCu);

    }
    objc_autoreleasePoolPop(v15);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Client failed to accept share"), CFSTR("Did not accept share"), 0);
    v5 = (id)objc_claimAutoreleasedReturnValue();
    goto LABEL_10;
  }
  objc_msgSend(v7, "hmf_dataForKey:", *MEMORY[0x1E0CB9EE8]);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = 0;
LABEL_11:
...
void __59__HMDUserCloudShareManager_configureWithMessageDispatcher___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "addObserver:selector:name:object:", *(_QWORD *)(a1 + 32), sel__handleEnableMultiUserChangedNotification_, *MEMORY[0x1E0CB9170], 0);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t26 != -1)
    dispatch_once(&logCategory__hmf_once_t26, &__block_literal_global_2048);
