...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting bulk send session reader", (uint8_t *)&v12, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v8 == v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Read callback timer fired, closing bulk send session", (uint8_t *)&v13, 0xCu);
...
- (void)_stopWithReason:(void *)a1
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 1024;
      v15 = (int)a2;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping bulk send session reader with reason: %d", (uint8_t *)&v12, 0x12u);
      ...
      if (v16)
      {
            ...
            if (v31)
            {
              ...
              if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v64 = 2112;
                v65 = v31;
                _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Assembled fragment: %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v66 = 2112;
              v67 = v29;
              _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to add data chunk %@ to assembler: %@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v66 = 2112;
          v67 = v48;
          _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@Received fragment chunk for fragment sequence number %@ even though we haven't received last chunk for fragment sequence number %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v63 = v44;
          _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fragment chunk from stream data dictionary", buf, 0xCu);
LABEL_23:
...
LABEL_30:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v63 = v58;
          _os_log_impl(&dword_1CD062000, v57, OS_LOG_TYPE_INFO, "%{public}@Data processing marked the bulk send session as inactive", buf, 0xCu);
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v64 = 2112;
      v65 = v7;
      _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to read from bulk send session: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_122411 != -1)
    dispatch_once(&logCategory__hmf_once_t8_122411, &__block_literal_global_122412);
  return (id)logCategory__hmf_once_v9_122413;
}
...
void __54__HMDCameraRecordingBulkSendSessionReader_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_122413;
  logCategory__hmf_once_v9_122413 = v0;
