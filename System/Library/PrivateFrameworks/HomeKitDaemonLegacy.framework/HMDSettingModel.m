...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_38108 != -1)
    dispatch_once(&hmbProperties_onceToken_38108, &__block_literal_global_38109);
  return (id)hmbProperties__properties_38110;
}
...
void __32__HMDSettingModel_hmbProperties__block_invoke()
{
  ...
  v9 = (void *)hmbProperties__properties_38110;
  hmbProperties__properties_38110 = v8;
