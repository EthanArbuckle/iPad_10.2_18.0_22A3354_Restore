...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteRelaySender", buf, 0xCu);
...
- (void)_callDidSaveSnapshotFileDelegate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that snapshot file has been saved for session %@", buf, 0x16u);
...
- (void)snapshotLocal:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = 2112;
      v31 = v12;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Snapshot local capture has ended in %@", (uint8_t *)&v28, 0x16u);
  ...
  else
  {
    ...
    if (v18)
    {
      v19 = (void *)MEMORY[0x1D17BA0A0](-[HMDCameraSnapshotRemoteRelaySender _callDidSaveSnapshotFileDelegate:](self, "_callDidSaveSnapshotFileDelegate:", v11));
      v20 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v30 = 2112;
        v31 = v11;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Scheduling the transfer of file %@ through IDS", (uint8_t *)&v28, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v28 = 138543362;
        v29 = v27;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode snapshot file to send over IDS", (uint8_t *)&v28, 0xCu);
...
uint64_t __50__HMDCameraSnapshotRemoteRelaySender_getSnapshot___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Getting the snapshot from local snapshot handler", (uint8_t *)&v9, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_148461 != -1)
    dispatch_once(&logCategory__hmf_once_t1_148461, &__block_literal_global_148462);
  return (id)logCategory__hmf_once_v2_148463;
}
...
void __49__HMDCameraSnapshotRemoteRelaySender_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_148463;
  logCategory__hmf_once_v2_148463 = v0;
