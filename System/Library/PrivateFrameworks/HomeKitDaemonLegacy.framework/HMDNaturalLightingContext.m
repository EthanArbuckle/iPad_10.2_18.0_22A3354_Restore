...
- (HMDNaturalLightingContext)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 138543362;
        v17 = v14;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode time zone", (uint8_t *)&v16, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode curve", (uint8_t *)&v16, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_174731 != -1)
    dispatch_once(&logCategory__hmf_once_t3_174731, &__block_literal_global_174732);
  return (id)logCategory__hmf_once_v4_174733;
}
...
void __40__HMDNaturalLightingContext_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_174733;
  logCategory__hmf_once_v4_174733 = v0;
