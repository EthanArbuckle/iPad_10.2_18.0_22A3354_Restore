...
- (HMDMediaSystem)initWithMediaSystemData:(id)a3 home:(id)a4
{
  ...
  v10 = -[HMDMediaSystem initWithUUID:configuredName:home:data:components:](self, "initWithUUID:configuredName:home:data:components:", v8, v9, v6, v7, MEMORY[0x1E0C9AA60]);
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v15;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Initializing with derived data: %@", buf, 0x16u);
...
- (HMDMediaSystem)initWithUUID:(id)a3 configuredName:(id)a4 home:(id)a5 data:(id)a6 components:(id)a7 settingsControllerCreator:(id)a8
{
  ...
  if (v18)
  {
    ...
    if (v22)
    {
      ...
      (*((void (**)(void *, void *, HMDMediaSystem *, HMDMediaSystem *, void *, _QWORD))v24 + 2))(v24, v37, v22, v22, v38, *MEMORY[0x1E0CBABA8]);
      ...
      v22->_audioDestinationsManagerFactory = &__block_literal_global_95229;
...
- (id)modelForMediaSystem
{
  ...
  {
    -[HMDMediaSystem _modelForMediaSystem](self);
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(v19, "na_map:", &__block_literal_global_25_95216);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "na_map:", &__block_literal_global_26_95217);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v20[2] = v13;
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28548]), "initWithName:value:", CFSTR("componentUUIDs"), v4);
  v20[3] = v14;
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28548]), "initWithName:value:", CFSTR("accessoryUUIDs"), v5);
  v20[4] = v15;
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Dealloc-ing MediaSystem", buf, 0xCu);
                ...
                (v19 & 1) == 0))
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v33 = 2112;
              v34 = v16;
              _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Component %@ contains an invalid accessory %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = &unk_1E8B33570;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@There are fewer than %@ components, not valid", buf, 0x16u);
...
- (BOOL)supportsUserMediaSettings
{
  ...
  -[HMDMediaSystem accessories](self, "accessories");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "na_any:", &__block_literal_global_48_95207);
...
- (void)configureWithMessageDispatcher:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2112;
    v40 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Configuring media system with components: %@", buf, 0x16u);
...
- (id)audioDestinationIdentifier
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("222AA6C0-21DB-4EE6-8E62-019974477350"));
    ...
    && (objc_msgSend((id)isFeatureHomeTheaterQFAEnabledForTests, "BOOLValue") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v14 = 138543362;
        v15 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get audio destination data due to no data source set", (uint8_t *)&v14, 0xCu);
...
- (NSArray)associatedAudioDestinationManagers
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get associated destination managers due to invalid media system", buf, 0xCu);
...
- (id)createNewAudioDestination
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating new audio destination", (uint8_t *)&v12, 0xCu);
      ...
      || (-[HMDMediaSystem destinationControllerGroupedWithAssociatedDestination](self, "destinationControllerGroupedWithAssociatedDestination"), (v5 = (void *)objc_claimAutoreleasedReturnValue()) != 0))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v17 = 2112;
        v18 = v5;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Repairing existing audio group with destination controller: %@", buf, 0x16u);
...
- (BOOL)isCurrentComponent
{
  ...
  -[HMDMediaSystem components](self, "components");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "na_any:", &__block_literal_global_53);
...
- (id)mediaGroupsAggregatorMessengerForMediaDestinationsManager:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get messenger from dependencies home: %@ aggregator: %@", (uint8_t *)&v15, 0x20u);
...
- (void)mediaDestinationsManager:(id)a3 didUpdateDestination:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home and siri sync data due to updated destination: %@", (uint8_t *)&v16, 0x16u);
...
- (void)auditMediaComponents
{
    ...
    && objc_msgSend((id)isFeatureHomeTheaterQFAEnabledForTests, "BOOLValue"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v10 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Skipping audit due to Home Theater QFA enabled", buf, 0xCu);
...
- (void)_registerForMessages
{
  ...
  objc_msgSend(v3, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBACD0], self, v10, sel__routeUpdateMediaSystem_);
  ...
  objc_msgSend(v3, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CBABB0], self, v14, sel__handleAppData_);
}
...
- (void)_registerForNotifications
{
  ...
  -[HMDMediaSystem notificationCenter](self, "notificationCenter");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "addObserver:selector:name:object:", self, sel_handleHomeCloudZoneReadyNotification_, CFSTR("HMDCloudZoneReadyNotification"), 0);

  -[HMDMediaSystem notificationCenter](self, "notificationCenter");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "addObserver:selector:name:object:", self, sel_handleRemovedAccessory_, CFSTR("HMDHomeAccessoryRemovedNotification"), 0);

  -[HMDMediaSystem notificationCenter](self, "notificationCenter");
  v5 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "addObserver:selector:name:object:", self, sel_handleAccessorySoftwareUpdated_, CFSTR("HMDAppleMediaAccessorySoftwareVersionUpdatedNotification"), 0);
...
- (void)_handleAppData:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to pre process update media system app data message: %@", (uint8_t *)&v12, 0x16u);
...
- (void)_updateAppData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating app data with message: %@", (uint8_t *)&v24, 0x16u);
...
LABEL_8:
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = objc_msgSend(v9, "isCurrentAccessory");
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v17;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received zone ready for media system %@/%@", (uint8_t *)&v18, 0x20u);

      }
      objc_autoreleasePoolPop(v11);
      -[HMDMediaSystem settingsController](v12, "settingsController");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v7, "auditOnFirstFetch");
      goto LABEL_8;
    }
  }
LABEL_9:
...
- (void)relayMessage:(id)a3
{
  ...
  if (objc_msgSend(v4, "isRemote"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay remote message: %@", (uint8_t *)&v33, 0x16u);
  ...
  else
  {
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            v35 = 2112;
            v36 = v4;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message destination to relay message: %@", (uint8_t *)&v33, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          v35 = 2112;
          v36 = v4;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get target device to relay message: %@", (uint8_t *)&v33, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = v4;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message dispatcher to relay message: %@", (uint8_t *)&v33, 0x16u);
...
- (id)serialize
{
  ...
  if (v4)
  {
    -[HMDMediaSystem name](self, "name");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, *MEMORY[0x1E0CBABA0]);
  ...
  if (v6)
  {
    -[HMDMediaSystem configuredName](self, "configuredName");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v7, *MEMORY[0x1E0CBAB90]);
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, *MEMORY[0x1E0CBABB8]);

  objc_msgSend(v3, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], *MEMORY[0x1E0CBAB70]);
  objc_msgSend(MEMORY[0x1E0C99DE8], "array");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v19 = 0u;
  v20 = 0u;
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v10, *MEMORY[0x1E0CBAB88]);
    ...
    while (1)
    {
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v34 = v21;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Missing accessory cannot determine target.", buf, 0xCu);
      ...
      if (!v11)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v34 = v25;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Missing serial cannot determine target.", buf, 0xCu);
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Received transaction object updated", buf, 0xCu);
      ...
      if (v22)
      {
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v35 = 2112;
          v36 = v22;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Handling add of root settings %@", buf, 0x16u);
      ...
      else
      {
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v38 = v30;
          v31 = v30;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", buf, 0x20u);
...
- (void)_transactionMediaSystemUpdated:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v55 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Applying the changes", buf, 0xCu);
    ...
    && objc_msgSend((id)isFeatureHomeTheaterQFAEnabledForTests, "BOOLValue"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v55 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Skipping transaction update due to Home Theater QFA enabled", buf, 0xCu);
  ...
  else
  {
    ...
    if (v20)
    {
            ...
            if (!v29)
            {
              ...
              if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v56 = 2112;
                v57 = v27;
                _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to initialize a mediaSystemComponent from %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v58 = 2112;
        v59 = v21;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_INFO, "%{public}@Updated the media system %@ components to %@", buf, 0x20u);
    ...
    -[HMDMediaSystem serialize](v9, "serialize");
    v38 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0D285D0], "entitledMessageWithName:messagePayload:", *MEMORY[0x1E0CBABC0], v38);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v18 = v25;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectRemoved]", buf, 0x20u);
...
- (void)_appDataRemoved:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling removal of app data", (uint8_t *)&v13, 0xCu);
...
- (HMDMediaSystem)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBABB8]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBAB90]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v10, *MEMORY[0x1E0CBAB88]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();

  v12 = objc_opt_class();
  objc_msgSend(MEMORY[0x1E0CBA680], "codingKey");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v15)
  {
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CBABA0]);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "hm_truncatedNameString");
    ...
    -[HMDAccessorySettingsController decodeWithCoder:](v15->_settingsController, "decodeWithCoder:", v4);
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB95F0]);
    v21 = objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMDMediaSystem name](self, "name");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "encodeObject:forKey:", v5, *MEMORY[0x1E0CBABA0]);

  -[HMDMediaSystem configuredName](self, "configuredName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "encodeObject:forKey:", v6, *MEMORY[0x1E0CBAB90]);

  -[HMDMediaSystem uuid](self, "uuid");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "encodeObject:forKey:", v7, *MEMORY[0x1E0CBABB8]);

  -[HMDMediaSystem components](self, "components");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "encodeObject:forKey:", v8, *MEMORY[0x1E0CBAB88]);
  ...
  if (objc_msgSend(v16, "hmd_isForLocalStore"))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CBA680], "codingKey");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "encodeObject:forKey:", v9, v10);
    ...
    || objc_msgSend(v16, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    -[HMDMediaSystem audioDestination](self, "audioDestination");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v16, "encodeObject:forKey:", v11, *MEMORY[0x1E0CB95F0]);

  }
  objc_msgSend(v16, "encodeConditionalObject:forKey:", v4, CFSTR("home"));
     ...
     || objc_msgSend(v16, "hmd_isForLocalStore")))
  {
    -[HMDMediaSystem settingsController](self, "settingsController");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "encodeWithCoder:", v16);

  }
  v13 = objc_msgSend(v16, "hmd_isForXPCTransport");
  -[HMDMediaSystem appData](self, "appData");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = v14;
  if (v13)
    objc_msgSend(v14, "encodeForXPCTransportWithCoder:key:", v16, CFSTR("HM.appData"));
  else
    objc_msgSend(v16, "encodeObject:forKey:", v14, CFSTR("HM.appDataRepository"));
...
- (void)mergeMediaSystemData:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Merging media system data: %@", (uint8_t *)&v11, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media system model with change type: %@ due to no provided model for media system", buf, 0x16u);
...
- (void)removeManagedConfigurationProfileWithProfileData:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Remove managed configuration profile not supported", (uint8_t *)&v13, 0xCu);
...
- (id)modelsToMakeSettingsForController:(id)a3 parentUUID:(id)a4
{
            ...
            if (v18)
            {
              ...
              if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v49 = 2112;
                v50 = v15;
                _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Merging root group of %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v49 = 2112;
              v50 = v15;
              _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Took first group from %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v36;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Cannot load settings metadata", buf, 0xCu);
...
- (id)modelsToMigrateSettingsForController:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v29;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot load settings metadata", buf, 0xCu);
...
- (BOOL)componentsSupportsHomeLevelLocationServiceSetting
{
  ...
  -[HMDMediaSystem accessories](self, "accessories");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "na_map:", &__block_literal_global_95_95088);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = objc_msgSend(v4, "count");
  if (v5 == objc_msgSend(v3, "count"))
  {
    v6 = objc_msgSend(v4, "na_all:", &__block_literal_global_98_95090);
  }
  else
  {
    v7 = (void *)MEMORY[0x1D17BA0A0]();
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine supports home level location services setting for all components: %@", (uint8_t *)&v12, 0x16u);
...
uint64_t __67__HMDMediaSystem_componentsSupportsHomeLevelLocationServiceSetting__block_invoke_96(uint64_t a1, void *a2)
{
...
void __51__HMDMediaSystem_transactionObjectRemoved_message___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error removing root group.", (uint8_t *)&v8, 0xCu);
...
void __40__HMDMediaSystem_reevaluateSettingOwner__block_invoke(uint64_t a1)
{
  ...
  if ((_DWORD)v3 != v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v14 = 2112;
      v15 = v2;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Target accessory sorting order has changed updating setting owner to %@", (uint8_t *)&v12, 0x16u);
...
LABEL_4:
    ...
    v16 = *MEMORY[0x1E0D280A0];
    v17 = *(_QWORD *)(MEMORY[0x1E0D280A0] + 16);
...
void __61__HMDMediaSystem_transactionObjectUpdated_newValues_message___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error adding root group.", (uint8_t *)&v8, 0xCu);
...
LABEL_4:
    ...
    v13 = objc_alloc(MEMORY[0x1E0CBA688]);
    v14 = 1;
    goto LABEL_13;
  }
  objc_msgSend(*(id *)(a1 + 32), "leftDestinationIdentifier");
...
void __38__HMDMediaSystem_auditMediaComponents__block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "isValid") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Media system isn't valid anymore, removing it", (uint8_t *)&v16, 0xCu);

    }
    objc_autoreleasePoolPop(v2);
    objc_msgSend(*(id *)(a1 + 32), "home");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDMediaSystem _modelForMediaSystem](*(id *)(a1 + 32));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    v8 = v7;
    if (v7)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 138543362;
        v17 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Did not obtain media system model, not deleting.", (uint8_t *)&v16, 0xCu);
...
- (id)_modelForMediaSystem
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      if ((isKindOfClass & 1) != 0)
      {
        v11 = HMDMediaSystemModelExtendedV2;
      }
      else
      {
        v16 = v7;
        ...
        if ((v17 & 1) != 0)
          v11 = HMDMediaSystemModelExtended;
        else
          v11 = HMDMediaSystemModel;
      }
      v18 = [v11 alloc];
      objc_msgSend(v1, "uuid");
      v19 = (void *)objc_claimAutoreleasedReturnValue();
      v1 = (id)objc_msgSend(v18, "initWithUUID:parentUUID:", v19, v6);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 138543362;
        v22 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine model type due to no accessories in media system", (uint8_t *)&v21, 0xCu);
...
void __49__HMDMediaSystem_repairAnyPreExistingAudioGroups__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Repair existing audio group request completed with error: %@", (uint8_t *)&v12, 0x16u);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Repair existing audio group request completed", (uint8_t *)&v12, 0xCu);
...
id __52__HMDMediaSystem_associatedAudioDestinationManagers__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@No audio destination manager found for component: %@ accessory: %@ apple media accessory: %@", (uint8_t *)&v14, 0x2Au);
...
+ (id)initalizeDataWithIdentifier:(id)a3 parentIdentifier:(id)a4 name:(id)a5 defaultName:(BOOL)a6 components:(id)a7
{
  ...
  if (!v15)
  {
    objc_msgSend(MEMORY[0x1E0CBA680], "unknownDestinationSentinel");
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    if (v16)
      goto LABEL_3;
LABEL_5:
  ...
  if (!v16)
    goto LABEL_5;
LABEL_3:
  v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA680]), "initWithIdentifier:parentIdentifier:name:defaultName:associatedGroupIdentifier:leftDestinationIdentifier:rightDestinationIdentifier:", v14, v13, v12, v7, 0, v15, v16);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_95252 != -1)
    dispatch_once(&logCategory__hmf_once_t5_95252, &__block_literal_global_40_95253);
  return (id)logCategory__hmf_once_v6_95254;
}
...
uint64_t __38__HMDMediaSystem_sortMediaComponents___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 2112;
      v34 = v12;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unexpected media accessory not found for components %@, acc1: %@, acc2: %@", (uint8_t *)&v27, 0x2Au);
...
void __29__HMDMediaSystem_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_95254;
  logCategory__hmf_once_v6_95254 = v0;
...
- (id)assistantObject
{
  ...
  if (v4 && v3)
  {
    ...
    if (v6)
    {
      ...
      if (v9 == 2)
      {
        v10 = (id)*MEMORY[0x1E0D88B88];

        v7 = v10;
      }
      v58[0] = *MEMORY[0x1E0D88A18];
      ...
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v16, "na_map:", &__block_literal_global_33_111807);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_26:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v65 = 2112;
    v66 = v3;
    _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping because attribute(s) is nil self %@/%@  self.home %@", buf, 0x2Au);
