...
- (id)biomeEventsRepresentationForLogObserver:(id)a3
{
  ...
  objc_msgSend(v5, "na_firstObjectPassingTest:", &__block_literal_global_1033);
  ...
  if (v7)
  {
    ...
    if (v93)
    {
      ...
      v14 = objc_alloc(MEMORY[0x1E0D02670]);
        ...
        do
        {
          ...
          if (v40)
          {
            ...
            if (v42)
            {
              ...
              {
                v82 = objc_alloc(MEMORY[0x1E0D02678]);
                ...
                v58 = (void *)v87;
                v59 = (void *)v89;
                v60 = (void *)objc_msgSend(v82, "initWithBase:accessoryUniqueIdentifier:accessoryStateString:accessoryStateNumber:accessoryStateData:accessoryMediaRouteIdentifier:zoneUniqueIdentifiers:roomUniqueIdentifier:accessoryName:roomName:zoneNames:homeName:", v77, v80, MEMORY[0x1E0C9AA70], v52, MEMORY[0x1E0C9AA70], v53, v89, v54, v55, v56, v87, v57);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v102 = 2112;
                  v103 = v39;
                  _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no media state for media accessory: %@", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v68, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v102 = 2112;
                v103 = v39;
                _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no media profile for media accessory: %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v64, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v102 = 2112;
              v103 = v39;
              _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_ERROR, "%{public}@Unable to log media event metadata to biome, no room for accessory: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v101 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unable to log media event metadata to biome, no home", buf, 0xCu);
...
- (id)microLocationMetadataForLogEventObserver:(id)a3
{
  ...
  objc_msgSend(v12, "metadataForHomekitAccessoryControlEventWithUUID:stateString:serviceUUID:serviceType:characteristicType:serviceGroupUUID:source:roomUUID:", v14, v8, v9, v9, v9, &stru_1E89C3E38, v15, v18);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
...
- (HMDMediaPlaybackActionEvent)initWithIsPlaybackArchivePresent:(BOOL)a3 playbackStateNumber:(id)a4 volumeNumber:(id)a5 sourceNumber:(id)a6 sourceClientName:(id)a7 accessories:(id)a8
{
  ...
  if (v19)
  {
    ...
    objc_msgSend(v28, "na_filter:", &__block_literal_global_97626);
    v29 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDMediaPlaybackActionEvent isPlaybackArchivePresent](self, "isPlaybackArchivePresent"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("playbackArchivePresent"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDMediaPlaybackActionEvent numberOfMediaProfiles](self, "numberOfMediaProfiles"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    objc_msgSend(v3, "setObject:forKeyedSubscript:", &unk_1E8B33960, CFSTR("volume"));
  }
