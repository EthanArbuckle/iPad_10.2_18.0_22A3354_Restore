...
- (HMDMemoryUtilizationTracker)initWithLogEventSubmitter:(id)a3
{
  ...
  if (v4)
  {
    v5 = v4;
    v12.receiver = self;
    v12.super_class = (Class)HMDMemoryUtilizationTracker;
    v6 = -[HMDMemoryUtilizationTracker init](&v12, sel_init);
    v7 = v6;
    if (v6)
  ...
  else
  {
    ...
    -[HMDMemoryUtilizationTracker trackMemoryUsageWithReason:](v9, v10, v11);
  }
  return result;
}
  ...
  *(_OWORD *)buffer = 0u;
  ...
  if (proc_pid_rusage(v5, 6, buffer))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve memory foot-print", (uint8_t *)&v18, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Current process memory utilization: %lld, Interval peak memory utilization (Since last timer-based sample): %lld", (uint8_t *)&v18, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_175269 != -1)
    dispatch_once(&logCategory__hmf_once_t2_175269, &__block_literal_global_175270);
  return (id)logCategory__hmf_once_v3_175271;
}
...
void __42__HMDMemoryUtilizationTracker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_175271;
  logCategory__hmf_once_v3_175271 = v0;
