...
- (void)_sendRequestWithTierType:(unint64_t)a3 toResident:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Relaying request to resident to take image snapshot with session ID %@", (uint8_t *)&v24, 0x16u);
...
- (void)_sendConfirmationToResident:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Informing the resident that image download task is completed for session ID %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_118101 != -1)
    dispatch_once(&logCategory__hmf_once_t2_118101, &__block_literal_global_118102);
  return (id)logCategory__hmf_once_v3_118103;
}
...
void __40__HMDCameraSnapshotReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_118103;
  logCategory__hmf_once_v3_118103 = v0;
