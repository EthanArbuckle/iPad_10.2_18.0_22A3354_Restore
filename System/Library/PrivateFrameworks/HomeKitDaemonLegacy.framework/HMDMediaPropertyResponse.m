    ...
    *(_QWORD *)&v8 = 138543618;
    ...
    do
    {
      for (i = 0; i != v39; ++i)
      {
        ...
        v49 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", v10);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v34;
            ...
            v66 = 2112;
            v67 = v10;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@deserializeMediaResponse: Cannot find mediaProfile with identifier %@", buf, 0x16u);
