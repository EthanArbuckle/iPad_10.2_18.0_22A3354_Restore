...
+ (id)properties
{
  if (properties_onceToken_42406 != -1)
    dispatch_once(&properties_onceToken_42406, &__block_literal_global_42407);
  return (id)properties__properties_42408;
}
...
void __48__HMDAccessorySettingConstraintModel_properties__block_invoke()
{
  ...
  v3 = (void *)properties__properties_42408;
  properties__properties_42408 = v2;
