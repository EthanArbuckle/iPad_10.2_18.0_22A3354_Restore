...
void __51__HMDWACScanner_wacBrowser_didUpdateAirPlayDevice___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@wacBrowser updated device %@: (%@)", buf, 0x20u);
...
void __51__HMDWACScanner_wacBrowser_didRemoveAirPlayDevice___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@wacBrowser lost device %@: (%@)", buf, 0x20u);
...
void __49__HMDWACScanner_wacBrowser_didFindAirPlayDevice___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v26 = 2112;
    v27 = v7;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@wacBrowser found device %@: (%@)", buf, 0x20u);
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v24 = 2112;
      v25 = v9;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Device %@", buf, 0x16u);
...
void __21__HMDWACScanner_stop__block_invoke(uint64_t a1)
{
  ...
  if (v1[2])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v6 = 138543362;
      v7 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Invalidating CUWiFiScanner...", (uint8_t *)&v6, 0xCu);
  ...
  if (!v1[2])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Initializing CUWiFiScanner...", (uint8_t *)&buf, 0xCu);

    }
    objc_autoreleasePoolPop(v2);
    v6 = objc_alloc_init(MEMORY[0x1E0D1B480]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_90327 != -1)
    dispatch_once(&logCategory__hmf_once_t7_90327, &__block_literal_global_90328);
  return (id)logCategory__hmf_once_v8_90329;
}
...
void __28__HMDWACScanner_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_90329;
  logCategory__hmf_once_v8_90329 = v0;
