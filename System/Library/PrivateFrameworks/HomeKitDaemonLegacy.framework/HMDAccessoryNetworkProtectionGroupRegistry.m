        ...
        for (i = 0; i != v14; ++i)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v54 = 2112;
            v55 = v17;
            _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Loading persisted group: %@", buf, 0x20u);
...
- (BOOL)addActiveSurrogateGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding active surrogate group: %@", (uint8_t *)&v22, 0x16u);
...
- (id)removeGroupWithUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing group with UUID: %@", (uint8_t *)&v13, 0x16u);
...
- (id)markGroupWithUUID:(id)a3 active:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v6;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Marking group as active: %@, group: %@", (uint8_t *)&v18, 0x20u);
...
- (void)handleUpdateAccessoryNetworkProtectionGroupProtectionMode:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v30 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling UpdateAccessoryNetworkProtectionGroupProtectionMode", buf, 0xCu);
  ...
  if ((v10 & 2) != 0)
  {
    objc_msgSend(v4, "uuidForKey:", *MEMORY[0x1E0CB7D48]);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    if (v16)
    {
      objc_msgSend(v4, "numberForKey:", *MEMORY[0x1E0CB7D28]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v30 = v26;
          _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Received update group network protection mode with nil for protection mode", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Received update group network protection mode with nil for group UUID", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@HomeKit version %@ does not meet the minimum version required to support network protection group update", buf, 0x16u);
...
- (void)handleUpdatedAccessoryInitialManufacturerOrCategory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v15 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling UpdatedAccessoryInitialManufacturerOrCategory", buf, 0xCu);
...
- (void)handleUpdatedAccessoryConfiguredNetworkProtectionGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v15 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling UpdatedAccessoryConfiguredNetworkProtectionGroup", buf, 0xCu);
...
- (void)_registerForAccessoryChanges:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&buf[14] = 16;
    v16 = 2096;
    v17 = &v14;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering for manufacturer, category and configured group update for accessory: %{uuid_t}.16P", buf, 0x1Cu);
...
- (void)_setupActiveGroupsForHome
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v31 = 2112;
    v32 = v12;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Evaluating active network protection groups based on %@ existing accessories for home %@", buf, 0x20u);
...
- (void)_setupProtectionGroupForAccessory:(id)a3 shouldNotifyChange:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = 2112;
    v32 = v14;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Setting up protection group for accessory %@ with initialManufacturer: %@ initialCategoryIdentifier: %@", (uint8_t *)&v25, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v22;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory %@/%@ is assigned to non-default group %@", (uint8_t *)&v25, 0x2Au);
...
{
  void *v4;
  HMDAccessoryNetworkProtectionGroupRegistry *v5;
  NSObject *v6;
  void *v7;
  void *v8;
  void *v9;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v33 = 2112;
    v34 = v25;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@evaluating active status for groupUUID: %@", buf, 0x16u);
  ...
  v26 = 0u;
  v27 = 0u;
  -[HMDAccessoryNetworkProtectionGroupRegistry home](v5, "home");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "accessories");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        if ((objc_msgSend(v15, "supportsNetworkProtection") & 1) != 0)
        {
          objc_msgSend(v15, "networkProtectionGroupUUID");
          v16 = (void *)objc_claimAutoreleasedReturnValue();
          v17 = objc_msgSend(v16, "isEqual:", v25);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v32 = v22;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Accessory does not support network protection", buf, 0xCu);
...
LABEL_19:
  ...
  v23 = -[HMDAccessoryNetworkProtectionGroupRegistry _updateGroupWithUUID:active:](v5, "_updateGroupWithUUID:active:", v25, v10);
  return v23;
}
  ...
  if (v7)
  {
    ...
    if (v9 != (_DWORD)v4)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v37 = 2112;
        v38 = v16;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Active status for group %@ changes from %@ to %@", (uint8_t *)&v31, 0x2Au);

      }
      objc_autoreleasePoolPop(v11);
      if ((_DWORD)v4)
      {
        v17 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryNetworkProtectionGroupRegistry notifyClientsOfAddedGroup:](v12, "notifyClientsOfAddedGroup:", v10));
        v18 = v12;
        HMFGetOSLogHandle();
...
LABEL_16:
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, v21, (uint8_t *)&v31, 0x16u);

        }
      }
      else
      {
        v17 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryNetworkProtectionGroupRegistry notifyClientsOfRemovedGroup:](v12, "notifyClientsOfRemovedGroup:", v10));
        v29 = v12;
        HMFGetOSLogHandle();
        v19 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = v6;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@No change in active status for group %@", (uint8_t *)&v31, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = v6;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@No change to active status of group %@ that doesn't exist", (uint8_t *)&v31, 0x16u);
...
- (void)notifyClientsOfRemovedGroup:(id)a3
{
  ...
  v9 = *MEMORY[0x1E0CB7D38];
  objc_msgSend(v7, "messageDestination");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = *MEMORY[0x1E0CB7D48];
  objc_msgSend(v4, "uuid");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "UUIDString");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)addActiveSurrogateGroupForAccessory:(id)a3 shouldNotifyChange:(BOOL)a4
{
  ...
  if (!v9)
  {
    if (v17)
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v57 = 2112;
      v58 = v43;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Unable to generate surrogate group due to missing information for accessory name: %@ UUID: %@ initialManufacturer: %@ initialCategory: %@ ", buf, 0x34u);
  ...
  if (v17)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v51 = 2112;
    v52 = v9;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Attempting to add active surrogate network protection group: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v51 = 2112;
    v52 = v24;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Existing network protection group with matching UUID: %@", buf, 0x16u);
  ...
  if (!v25)
  {
    if (v29)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v53 = 2112;
      v54 = v8;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@No change to status of network protection group %@ on behalf of %@", buf, 0x20u);
...
LABEL_21:
  ...
  if (v29)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v51 = 2112;
    v52 = v32;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Added and marked active network protection group: %@", buf, 0x16u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v51 = 2112;
      v52 = v34;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Notifying for added network protection group %@", buf, 0x16u);
...
- (void)handleAddOrUpdateAccessoryNetworkProtectionGroupModel:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v43 = 2112;
    v44 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling add/update of accessory network protection group model: %@", buf, 0x16u);
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2112;
      v44 = v21;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Marked existing record for network protection group %@ as persisted", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2112;
      v44 = v32;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Added new inactive accessory network protection group model %@", buf, 0x16u);
...
- (void)handleRemoveAccessoryNetworkProtectionGroupModel:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v13;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling remove of accessory network group model %@", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v23;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Accessory network protection group %@ doesn't exist to remove", (uint8_t *)&v25, 0x16u);
...
- (BOOL)updateTargetProtectionModeForGroupWithUUID:(id)a3 protectionMode:(int64_t)a4 error:(id *)a5 requestMessage:(id)a6
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 2112;
      v40 = v10;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Updating target protection mode to: %ld, on group with UUID:%@", (uint8_t *)&v35, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 2112;
      v38 = (int64_t)v23;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Cannot find network protection group with UUID %@", (uint8_t *)&v35, 0x16u);
...
void __69__HMDAccessoryNetworkProtectionGroupRegistry_handleRemovedAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v25 = 2112;
    v26 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Handling removed accessory: %@", (uint8_t *)&v23, 0x16u);
...
LABEL_17:
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 2112;
        v26 = v22;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@No network protection group UUID for removed accessory %@", (uint8_t *)&v23, 0x16u);
    ...
    objc_msgSend(v9, "networkProtectionGroupUUID");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    LODWORD(v11) = objc_msgSend(v11, "_evaluateActiveStatusForGroupWithUUID:", v12);
    ...
    if ((_DWORD)v11)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 22;
LABEL_14:
        _os_log_impl(&dword_1CD062000, v18, v19, v17, (uint8_t *)&v23, v20);
...
void __67__HMDAccessoryNetworkProtectionGroupRegistry_handleAddedAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Handling added accessory: %@", (uint8_t *)&v14, 0x16u);
  ...
  if (v9)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        v14 = 138543362;
        v15 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Accessory does not support network protection", (uint8_t *)&v14, 0xCu);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v28 = 2112;
      v29 = v15;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory %@/%@ is leaving group %@ and joining group %@", buf, 0x34u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v31 = 2112;
      v32 = v13;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory %@/%@ has updated initialManufacturer: %@, initialCategory: %@", buf, 0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v29 = 2112;
        v30 = v21;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Accessory %@/%@ is assigned to non-default group %@", buf, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_56958 != -1)
    dispatch_once(&logCategory__hmf_once_t10_56958, &__block_literal_global_56959);
  return (id)logCategory__hmf_once_v11_56960;
}
...
void __57__HMDAccessoryNetworkProtectionGroupRegistry_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_56960;
  logCategory__hmf_once_v11_56960 = v0;
