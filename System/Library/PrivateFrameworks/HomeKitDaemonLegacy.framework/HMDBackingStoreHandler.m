...
- (void)runTransactionWithModels:(id)a3 options:(id)a4 reason:(id)a5 completion:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v41 = 2112;
    v42 = v11;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Running transaction with models: %@ options: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v28;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Failed to run transaction due to no completion", buf, 0xCu);
...
- (id)backingStoreObjectsForVersion:(int64_t)a3
{
  ...
  v4 = (void *)MEMORY[0x1D17BA0A0](self, a2, a3);
  v5 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive backinstore objects for shared user", (uint8_t *)&v9, 0xCu);
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    v18 = 2112;
    v19 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to process udated changes for object: %@", (uint8_t *)&v16, 0x16u);
...
- (void)transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to process removed object: %@", (uint8_t *)&v13, 0x16u);
...
void __77__HMDBackingStoreHandler_runTransactionWithModels_options_reason_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Transaction completed with error: %@", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Transaction completed", (uint8_t *)&v13, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_56106 != -1)
    dispatch_once(&logCategory__hmf_once_t7_56106, &__block_literal_global_56107);
  return (id)logCategory__hmf_once_v8_56108;
}
...
void __37__HMDBackingStoreHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_56108;
  logCategory__hmf_once_v8_56108 = v0;
