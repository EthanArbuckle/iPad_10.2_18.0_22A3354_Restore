...
- (HMDThreadNetworkStabilityLogEvent)initWithDictionary:(id)a3
{
  ...
  v72 = v6;
  if (v6)
    v88 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", v6);
  else
    v88 = 0;
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDThreadNetworkStabilityLogEvent threadNetworkUptime](self, "threadNetworkUptime"));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v48[11] = v15;
  v47[12] = CFSTR("threadNetworkDowntime");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDThreadNetworkStabilityLogEvent threadNetworkDowntime](self, "threadNetworkDowntime"));
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v48[12] = v16;
  v47[13] = CFSTR("numReadWrites");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDThreadNetworkStabilityLogEvent numReadWrites](self, "numReadWrites"));
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v48[13] = v17;
  v47[14] = CFSTR("numReadErrors");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDThreadNetworkStabilityLogEvent numReadErrors](self, "numReadErrors"));
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v48[14] = v18;
  v47[15] = CFSTR("numWriteErrors");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDThreadNetworkStabilityLogEvent numWriteErrors](self, "numWriteErrors"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v48[15] = v19;
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDThreadNetworkStabilityLogEvent numSessionErrors](self, "numSessionErrors"));
