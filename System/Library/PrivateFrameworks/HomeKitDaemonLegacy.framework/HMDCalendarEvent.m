...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0C99D78], "hmf_unarchiveFromData:error:", v5, 0);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_nextTimerDateAfterDate:(id)a3 timeZone:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v14;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Determining next fire date after date %@ using components: %@ recurrence: %@", (uint8_t *)&v21, 0x2Au);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_9730 != -1)
    dispatch_once(&logCategory__hmf_once_t0_9730, &__block_literal_global_9731);
  return (id)logCategory__hmf_once_v1_9732;
}
...
LABEL_28:
          _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, v40, buf, 0x16u);
...
LABEL_14:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = v16;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Determined next fire date by assigning fire date components to current date: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v48 = 2112;
    v49 = v27;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@Determined next fire date by assigning fire recurrent date components to current date: %@", buf, 0x16u);
...
void __31__HMDCalendarEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_9732;
  logCategory__hmf_once_v1_9732 = v0;
