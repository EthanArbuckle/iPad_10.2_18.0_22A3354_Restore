...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_12842 != -1)
    dispatch_once(&logCategory__hmf_once_t2_12842, &__block_literal_global_12843);
  return (id)logCategory__hmf_once_v3_12844;
}
...
+ (void)initialize
{
  ...
  v4 = *MEMORY[0x1E0CB8700];
  v5 = -[HMDAssistantColorCharacteristic initWithReadCharacteristicType:writeCharacteristicType:format:mandatory:](v3, "initWithReadCharacteristicType:writeCharacteristicType:format:mandatory:", *MEMORY[0x1E0CB88E8], *MEMORY[0x1E0CB88E8], *MEMORY[0x1E0CB8700], 1);
  objc_msgSend(v2, "addObject:", v5);
  v6 = [HMDAssistantColorCharacteristic alloc];
  v7 = -[HMDAssistantColorCharacteristic initWithReadCharacteristicType:writeCharacteristicType:format:mandatory:](v6, "initWithReadCharacteristicType:writeCharacteristicType:format:mandatory:", *MEMORY[0x1E0CB8A00], *MEMORY[0x1E0CB8A00], v4, 1);

  objc_msgSend(v2, "addObject:", v7);
  v8 = [HMDAssistantColorCharacteristic alloc];
  v9 = -[HMDAssistantColorCharacteristic initWithReadCharacteristicType:writeCharacteristicType:format:mandatory:](v8, "initWithReadCharacteristicType:writeCharacteristicType:format:mandatory:", *MEMORY[0x1E0CB87C0], *MEMORY[0x1E0CB87C0], *MEMORY[0x1E0CB8708], 1);
...
void __34__HMDAssistantCommand_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_12844;
  logCategory__hmf_once_v3_12844 = v0;
...
- (id)serviceFromObject:(id)a3
{
  ...
  if (objc_msgSend(v5, "isEqualToString:", *MEMORY[0x1E0D88A38])
      ...
      else
      {
        ...
        if (!v27
          || (v28 = (void *)v27,
              ...
              v30 = objc_msgSend(v29, "isEqualToString:", *MEMORY[0x1E0D887F8]),
              v29,
              v28,
              v30))
        {
...
LABEL_46:
      ...
      v39 = (uint64_t *)MEMORY[0x1E0D887F8];
      v92 = v36;
      if (!v38)
      {
        v42 = *MEMORY[0x1E0D887F8];
        goto LABEL_35;
      }
      v40 = (void *)v38;
      objc_msgSend(v17, "actionType");
      ...
      if (objc_msgSend(v43, "isEqualToString:", *MEMORY[0x1E0D88818]))
      {
...
LABEL_34:
      ...
      if ((objc_msgSend(v44, "isEqualToString:", *MEMORY[0x1E0D88828]) & 1) != 0)
      {
...
LABEL_33:
      ...
      if ((objc_msgSend(v45, "isEqualToString:", *MEMORY[0x1E0D88820]) & 1) != 0)
      {
...
LABEL_32:
      ...
      if ((objc_msgSend(v46, "isEqualToString:", *MEMORY[0x1E0D887F0]) & 1) != 0)
      {
      ...
      v88 = objc_msgSend(v87, "isEqualToString:", *MEMORY[0x1E0D88840]);
...
LABEL_45:
      ...
      if (objc_msgSend(v63, "isEqualToString:", *MEMORY[0x1E0D88838]))
      {
      ...
      v65 = objc_msgSend(v64, "isEqualToString:", *MEMORY[0x1E0D88830]);
...
LABEL_52:
        if (v18)
        {
          ...
          objc_msgSend(v13, "setOutcome:", *MEMORY[0x1E0D887A8]);
          goto LABEL_40;
        }
LABEL_64:
        LOBYTE(v26) = 0;
      ...
      v72 = *MEMORY[0x1E0D88808];
      if ((objc_msgSend(v71, "isEqualToString:", *MEMORY[0x1E0D88808]) & 1) == 0)
      {
        objc_msgSend(v17, "actionType");
        v73 = (void *)objc_claimAutoreleasedReturnValue();
        if (!objc_msgSend(v73, "isEqualToString:", *MEMORY[0x1E0D88800]))
        {
          objc_msgSend(v17, "actionType");
          v79 = (void *)objc_claimAutoreleasedReturnValue();
          v96 = objc_msgSend(v79, "isEqualToString:", *MEMORY[0x1E0D88810]);
...
LABEL_78:
          ...
          v78 = objc_msgSend(v77, "isEqualToString:", *MEMORY[0x1E0D88800]);
...
LABEL_71:
          ...
          v81 = objc_msgSend(v80, "isEqualToString:", *MEMORY[0x1E0D88810]);
...
- (BOOL)populateResult:(id)a3 withObject:(id)a4 serviceType:(id)a5 action:(id)a6
{
  ...
  if (v17
    && (v18 = (void *)v17,
        ...
        v19 = (void *)objc_claimAutoreleasedReturnValue(),
        v20 = objc_msgSend(v19, "isEqualToString:", *MEMORY[0x1E0D88A38]),
        v19,
        v18,
        v20))
  {
...
- (id)entityFromActionSet:(id)a3
{
  ...
  v3 = (objc_class *)MEMORY[0x1E0D880D0];
  v4 = a3;
  ...
  objc_msgSend(v5, "setEntityType:", *MEMORY[0x1E0D88A30]);
...
- (id)failedActionResultsFromResponse:(id)a3 inActionSet:(id)a4 withAction:(id)a5
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K =[d] %@"), CFSTR("objectType"), *MEMORY[0x1E0D88A38]);
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v19 = (void *)objc_msgSend(objc_alloc(*(Class *)(v15 + 2600)), "initWithUUIDString:", v17);
        ...
        if (v20)
        {
          ...
          if (!v21)
            goto LABEL_41;
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmf_unarchiveFromData:error:", v21, 0);
        ...
        else
        {
          ...
          v25 = (void *)objc_msgSend(objc_alloc(*(Class *)(v15 + 2600)), "initWithUUIDString:", v17);
                      ...
                      if (v35)
                      {
                        ...
                        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *(_DWORD *)buf = 138543618;
                          ...
                          v79 = 2112;
                          v80 = v35;
                          _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@Parsing error for Siri : %@", buf, 0x16u);
                        ...
                        v41 = (void *)objc_claimAutoreleasedReturnValue();
                        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v62, "integerValue"));
...
- (id)actionResultForMediaProfile:(id)a3 action:(id)a4 objects:(id)a5 error:(id)a6
{
  ...
  if (v14)
  {
    ...
    objc_msgSend(v17, "actionType");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v19, "isEqualToString:", *MEMORY[0x1E0D88828]) & 1) != 0)
    {
      v31 = v13;
      objc_msgSend(v17, "attribute");
      v20 = (void *)objc_claimAutoreleasedReturnValue();
      v21 = objc_msgSend(v20, "isEqualToString:", *MEMORY[0x1E0D88870]);

      if (v21)
      {
        v22 = (void *)*MEMORY[0x1E0D88890];
        if (objc_msgSend(v18, "containsObject:", *MEMORY[0x1E0D88890]))
          v23 = v22;
        else
          v23 = 0;
        v24 = v23;
    ...
    v29 = objc_alloc_init(MEMORY[0x1E0D880B8]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v34 = 2112;
      v35 = v10;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the entity for service : %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v59 = 2112;
        v60 = v16;
        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@There is no Siri mapping attribute and/or format for characteristic : %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v52;
      _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@Unable to get the entity for service : %@", buf, 0x16u);
...
- (id)getLocaleUnits:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)*MEMORY[0x1E0CB8740];
  v5 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB8740]);
  v6 = (void *)*MEMORY[0x1E0CB8748];
  if ((v5 & 1) != 0 || (v7 = objc_msgSend(v3, "isEqualToString:", *MEMORY[0x1E0CB8748]), v8 = v3, v7))
  {
    if (isMetricLocale_onceToken != -1)
      dispatch_once(&isMetricLocale_onceToken, &__block_literal_global_128480);
...
- (id)getValueOfType:(id)a3 action:(id)a4
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v7, "value"));
    v9 = objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    else
    {
      ...
      if ((v13 & 1) != 0)
      {
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v14, "value"));
        v9 = objc_claimAutoreleasedReturnValue();
      }
      else
      {
      ...
      if (temperatureConversionIsNeeded(v12))
      {
        ...
        *(float *)&v19 = (float)((float)(v18 + -32.0) * 5.0) / 9.0;
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          v31 = 2112;
          v32 = v16;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@adjustSet: Attribute %@ value %@  converted to Celsius as %@", (uint8_t *)&v25, 0x2Au);
      ...
      if (temperatureConversionIsNeeded(v12))
      {
        ...
        *(float *)&v19 = (float)(v18 * 1.8) + 32.0;
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          v31 = 2112;
          v32 = v16;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@adjustGet: Attribute %@ value %@  adjusted to Fahrenheit %@", (uint8_t *)&v25, 0x2Au);
    ...
    if (v32)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K =[d] %@"), CFSTR("objectRoom"), *(_QWORD *)(*((_QWORD *)&v46 + 1) + 8 * v36));
          v34 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)filteredObjectsFromObjects:(id)a3 byAttribute:(id)a4 forActionType:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v9
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D887F8]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88840]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88820]) & 1) != 0)
  {
    v47 = 1;
  }
  else
  {
    v47 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D887F0]);
  }
  ...
  v46 = (void *)objc_claimAutoreleasedReturnValue();
  v43 = v9;
  if ((objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88828]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88818]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88838]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88830]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88808]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88800]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88810]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88840]) & 1) != 0
    || (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88820]) & 1) != 0)
  {
    v53 = 1;
  ...
  {
    v53 = objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D887F0]);
  }
  v44 = v8;
  ...
  if (v11)
  {
    v13 = v11;
    v14 = *(_QWORD *)v65;
    v15 = *MEMORY[0x1E0D88A38];
    v51 = *(_QWORD *)v65;
    v52 = *MEMORY[0x1E0D88A38];
    do
    {
      v16 = 0;
      v54 = v13;
        ...
        !v9))
  {
           ...
           v19)))
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = v17;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Defaulting to current home %@ of the device", (uint8_t *)&v30, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = v14;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Defaulting to primary home %@ of the device", (uint8_t *)&v30, 0x16u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = v7;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Defaulting to home %@ that this device belongs to", (uint8_t *)&v30, 0x16u);
  ...
  if (v6)
  {
    ...
    if (v9)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v49 = 2112;
        v50 = v15;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Matched home %@ with the homeIdentifier %@ from SCF", (uint8_t *)&v45, 0x20u);
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
    {
      ...
      v47 = 2112;
      v48 = v17;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_FAULT, "%{public}@No home found with identifier %@", (uint8_t *)&v45, 0x16u);
  ...
  if (v18)
  {
    ...
    if ((unint64_t)objc_msgSend(v20, "count") >= 2)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        ...
        v47 = 2112;
        v48 = v25;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_FAULT, "%{public}@Multiple homes found with name %@, homeIdentifier should be used instead", (uint8_t *)&v45, 0x16u);
    ...
    if (v28)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        v49 = 2112;
        v50 = v33;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Matched home %@ with the homeName %@ from SCF after a homeIdentifier mismatch", (uint8_t *)&v45, 0x20u);
...
LABEL_24:
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      v45 = 138543362;
      v46 = v39;
      _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@No matches for the home name/identifier specified in Siri command - bailing out....", (uint8_t *)&v45, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      v45 = 138543362;
      v46 = v43;
      _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Cannot evaluate the home to apply the Siri command to - bailing out....", (uint8_t *)&v45, 0xCu);
...
- (id)objectsWithSearchFilter:(id)a3 inHome:(id)a4 serviceTypeIsATV:(BOOL)a5 overrideServiceTypeIfNeeded:(id *)a6
{
  ...
  if (objc_msgSend(v11, "count"))
  {
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("(%K = %@)"), CFSTR("objectHomeIdentifier"), v12);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (!objc_msgSend(v14, "count"))
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v133 = 2112;
        v134 = v36;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@After filtering for home %@/%@, no objects to apply the command to", buf, 0x20u);
    ...
    if (v16)
    {
      v17 = (void *)*MEMORY[0x1E0D88A38];
      if (v15)
      {
        if ((objc_msgSend(v15, "isEqualToString:", v17) & 1) == 0
          && (objc_msgSend(v15, "isEqualToString:", *MEMORY[0x1E0D88A30]) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v131 = 2112;
            v132 = v9;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Attribute specified in search filter with entityType not SERVICE/SCENE(%@)", buf, 0x16u);
...
LABEL_18:
    objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K = %@"), CFSTR("objectType"), v15);
...
LABEL_22:
        _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, v44, buf, 0xCu);
...
LABEL_75:
          _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_INFO, v74, buf, 0xCu);
        ...
        if (v66)
        {
          ...
          if (!objc_msgSend(v38, "count"))
          {
            ...
            if (os_log_type_enabled(v93, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v130 = v95;
              _os_log_impl(&dword_1CD062000, v93, OS_LOG_TYPE_INFO, "%{public}@After filtering for accessoryName, no objects to apply the command to", buf, 0xCu);
...
LABEL_102:
            ...
            if ((objc_msgSend(v98, "isEqual:", *MEMORY[0x1E0D88858]) & 1) != 0)
            {
LABEL_107:
...
LABEL_109:
            ...
            if (objc_msgSend(v99, "isEqual:", *MEMORY[0x1E0D88850]))
            {
            ...
            v106 = objc_msgSend(v105, "isEqual:", *MEMORY[0x1E0D88A30]);
...
LABEL_116:
          ...
          if ((objc_msgSend(v88, "isEqualToString:", *MEMORY[0x1E0D88A88]) & 1) != 0)
          {
            v89 = (id *)MEMORY[0x1E0CB8240];
          }
          else if ((objc_msgSend(v88, "isEqualToString:", *MEMORY[0x1E0D88A90]) & 1) != 0)
          {
            v89 = (id *)MEMORY[0x1E0CB8228];
          }
          else if ((objc_msgSend(v88, "isEqualToString:", *MEMORY[0x1E0D88A98]) & 1) != 0)
          {
            v89 = (id *)MEMORY[0x1E0CB8210];
          }
          else
          {
            if (!objc_msgSend(v88, "isEqualToString:", *MEMORY[0x1E0D88AA0]))
            {
              v96 = 0;
              goto LABEL_97;
            }
            v89 = (id *)MEMORY[0x1E0CB8218];
          }
          v96 = *v89;
LABEL_97:
          ...
          if (v96)
          {
            objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K =[d] %@"), CFSTR("objectSceneType"), v96);
            ...
            if (!objc_msgSend(v38, "count"))
            {
              ...
              if (os_log_type_enabled(v102, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v130 = v104;
                _os_log_impl(&dword_1CD062000, v102, OS_LOG_TYPE_INFO, "%{public}@After filtering for actionSetType, no objects to apply the command to", buf, 0xCu);
    ...
    if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v130 = v78;
      _os_log_impl(&dword_1CD062000, v77, OS_LOG_TYPE_INFO, "%{public}@After filtering for serviceType, no objects to apply the command to", buf, 0xCu);
...
LABEL_78:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v130 = v26;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@No objects to apply the command to", buf, 0xCu);
          ...
          if (v42)
          {
            ...
            do
            {
              for (j = 0; j != v42; ++j)
              {
                ...
                objc_msgSend(p_cache + 268, "getSharedInstance");
                v16 = (void *)objc_claimAutoreleasedReturnValue();
                ...
                if (v18)
                {
                  ...
                  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    v55 = 2112;
                    v56 = v15;
                    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Filtering out request for disallowed service type: %@ characteristic type: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = v33;
            ...
            v53 = 2112;
            v54 = v10;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Filtered object is not a service: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v41 = 2112;
            v42 = v8;
            _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Filtered object %@ not a service", buf, 0x16u);
...
- (void)_logEvent:(id)a3
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "stringWithFormat:", CFSTR("%@, %s:%ld"), v8, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 1281);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)reportOutcome:(id)a3 results:(id)a4 handler:(id)a5
{
  ...
  if (v10)
  {
    v11 = objc_alloc_init(MEMORY[0x1E0D880C0]);
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%tu:%tu"), v22, v20);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v53 = 2112;
      v54 = v28;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Response for Siri command(%@): %@", buf, 0x20u);
        ...
        for (i = 0; i != v31; ++i)
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v51 = 2112;
            v52 = v34;
            _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_INFO, "%{public}@%@", buf, 0x16u);
...
- (void)reportResults:(id)a3 handler:(id)a4
{
  ...
  {
    v7 = v10;
    v8 = (id *)MEMORY[0x1E0D88910];
  }
  else
  {
    objc_msgSend(MEMORY[0x1E0C99D20], "array");
    v7 = (id)objc_claimAutoreleasedReturnValue();
    v8 = (id *)MEMORY[0x1E0D88918];
  }
  v9 = *v8;
...
- (void)reportUnlockRequired:(id)a3
{
  ...
  v6 = (_QWORD *)MEMORY[0x1E0D88950];
  if (v5 && isPasscodeEnabledOnThisDevice())
    v6 = (_QWORD *)MEMORY[0x1E0D88928];
...
- (id)actionOutcomeFromError:(id)a3
{
  ...
  if (v4 > 44)
  {
    if (v4 > 2403)
    {
      if (v4 == 2404)
      {
        v5 = (id *)MEMORY[0x1E0D88728];
        return *v5;
      }
      if (v4 == 2405)
      {
        v5 = (id *)MEMORY[0x1E0D88738];
        return *v5;
      }
    }
    else
    {
      if (v4 == 45)
      {
        v5 = (id *)MEMORY[0x1E0D88758];
        return *v5;
      }
      if (v4 == 88)
      {
        v5 = (id *)MEMORY[0x1E0D88730];
        return *v5;
      }
    }
    goto LABEL_22;
  ...
  if (v4 > 14)
  {
    if (v4 == 15)
    {
      v5 = (id *)MEMORY[0x1E0D88750];
      return *v5;
    }
    if (v4 == 44)
    {
      v5 = (id *)MEMORY[0x1E0D887A0];
      return *v5;
    }
    goto LABEL_22;
  }
  if (v4 != 4)
  {
    if (v4 == 5)
    {
      v5 = (id *)MEMORY[0x1E0D88768];
      return *v5;
    }
LABEL_22:
    v5 = (id *)MEMORY[0x1E0D88740];
    return *v5;
  }
  -[HMDAssistantCommand home](self, "home");
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      if (v11 != 1)
      {
        v5 = (id *)MEMORY[0x1E0D88760];
        return *v5;
      }
    }
  }
  v5 = (id *)MEMORY[0x1E0D887B0];
  return *v5;
}
...
- (void)executeActionSet:(id)a3 action:(id)a4 withCompletionHandler:(id)a5
{
  ...
  objc_msgSend(v12, "stringWithFormat:", CFSTR("%@, %s:%ld"), v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 1469);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v32 = (void *)objc_msgSend(v11, "initWithName:", v14);

  objc_msgSend(v9, "attribute");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(v13) = objc_msgSend((id)*MEMORY[0x1E0D88870], "isEqualToString:", v15);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_QWORD *)&location[4] = v31;
        v41 = 2112;
        v42 = v21;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@ActionSet action value %@ not true", location, 0x16u);

      }
      objc_autoreleasePoolPop(v28);
      -[HMDAssistantCommand reportOutcome:results:handler:](v29, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v10);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)&location[4] = v26;
      v41 = 2112;
      v42 = v27;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid action.attribute %@ for actionSet", location, 0x16u);

    }
    objc_autoreleasePoolPop(v23);
    -[HMDAssistantCommand reportOutcome:results:handler:](v24, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v10);
  }
...
- (void)handleGetMetadataActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
      ...
      if (v20)
      {
        ...
        if (objc_msgSend(v32, "count"))
        {
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v72 = 2112;
                    v73 = v37;
                    _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_INFO, "%{public}@Not including the result: %@ to the action results", buf, 0x16u);
          ...
          if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v71 = v50;
            _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_INFO, "%{public}@All results have been received for get-metadata-action-types, calling result handler", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v72 = 2112;
          v73 = v31;
          _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v27);
        -[HMDAssistantCommand reportOutcome:results:handler:](v28, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v13);
        v20 = 0;
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@In Get metadata action types, There is no attribute in action, reporting results", buf, 0xCu);
...
- (BOOL)populateResult:(id)a3 fromResponse:(id)a4 responses:(id)a5 forAction:(id)a6 serviceType:(id)a7 forObjects:(id)a8
{
  ...
  else
  {
    ...
    if (!v35)
      objc_msgSend(v32, "setOutcome:", *MEMORY[0x1E0D887A8]);
  }
      ...
      if (v80)
      {
        ...
        if (v62)
        {
          ...
          if (objc_msgSend(v62, "unsignedIntegerValue"))
          {
            ...
            v63 = (id *)MEMORY[0x1E0D88898];
          }
          else
          {
            v63 = (id *)MEMORY[0x1E0D888A0];
          }
          v55 = *v63;
        }
        else
...
- (void)handleMediaAccessorySetActionType:(id)a3 forObjects:(id)a4 withServiceType:(id)a5 completionHandler:(id)a6
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "stringWithFormat:", CFSTR("%@, %s:%ld"), v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 1695);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v15)
  {
    ...
    objc_msgSend(v51, "attribute");
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    v17 = objc_msgSend(v16, "isEqualToString:", *MEMORY[0x1E0D888A8]);
    ...
    if (v17)
    {
      ...
      *((_QWORD *)&buf + 1) = &buf;
      v79 = 0x3032000000;
      v80 = __Block_byref_object_copy__13024;
      v81 = __Block_byref_object_dispose__13025;
      objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    else
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)((char *)&buf + 4) = v45;
        _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, "%{public}@In Set action types, passed-in attribute in action is not supported.", (uint8_t *)&buf, 0xCu);

      }
      objc_autoreleasePoolPop(v42);
      -[HMDAssistantCommand reportOutcome:results:handler:](v43, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v50);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v41;
      _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@In Set action types, there is no attribute in action, reporting malformed results", (uint8_t *)&buf, 0xCu);

    }
    objc_autoreleasePoolPop(v38);
    -[HMDAssistantCommand reportOutcome:results:handler:](v39, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v50);
  }
...
- (void)handleGetActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "stringWithFormat:", CFSTR("%@, %s:%ld"), v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 1774);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v16)
  {
    objc_msgSend(v73, "attribute");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v18 = objc_msgSend(v17, "isEqualToString:", *MEMORY[0x1E0D88858]);
    ...
    else
    {
      objc_msgSend(v73, "attribute");
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      v24 = objc_msgSend(v23, "isEqualToString:", *MEMORY[0x1E0D88850]);
      ...
      else
      {
        ...
        if (objc_msgSend(v27, "count"))
        {
          ...
          objc_msgSend(v73, "actionType");
          v28 = (void *)objc_claimAutoreleasedReturnValue();
          v29 = objc_msgSend(v28, "isEqualToString:", *MEMORY[0x1E0D88818]);
          ...
          if (v66)
          {
            ...
            {
              objc_msgSend(MEMORY[0x1E0C99E20], "setWithArray:", v27);
              v63 = (void *)objc_claimAutoreleasedReturnValue();
              ...
              *(_QWORD *)&buf[16] = 0x3032000000;
              v99 = __Block_byref_object_copy__13024;
              v100 = __Block_byref_object_dispose__13025;
              objc_msgSend(MEMORY[0x1E0C99DE8], "array");
            ...
            else
            {
              ...
              if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                *(_QWORD *)&buf[4] = v62;
                _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_INFO, "%{public}@No characteristics found after filtering objects", buf, 0xCu);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_WORD *)&buf[12] = 2112;
              *(_QWORD *)&buf[14] = v35;
              _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);

            }
            objc_autoreleasePoolPop(v31);
            -[HMDAssistantCommand reportOutcome:results:handler:](v32, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v72);
          }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@In Get action types, There is no attribute in action, reporting results", buf, 0xCu);
...
- (void)handleGetNaturalLightingAction:(id)a3 forObjects:(id)a4 serviceType:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v59 = 2112;
    v60 = v10;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Getting natural lighting enabled for objects: %@", buf, 0x16u);
  ...
  if (v16)
  {
    v17 = v16;
    v18 = *(_QWORD *)v53;
    v44 = *MEMORY[0x1E0D88850];
    v45 = *MEMORY[0x1E0D887A8];
    do
    {
      v19 = 0;
      v49 = v17;
        ...
        if (v21)
        {
          ...
          if (v28)
          {
            ...
            if ((v30 & 1) != 0)
            {
              ...
              v33 = objc_alloc_init(MEMORY[0x1E0D880B8]);
              objc_msgSend(v28, "settings");
              v34 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        else
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v59 = 2112;
            v60 = v20;
            _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Did not find service for filtered object: %@", buf, 0x16u);
...
- (void)handleSetNaturalLightingAction:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "stringWithFormat:", CFSTR("%@, %s:%ld"), v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 2002);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v56 = (void *)objc_msgSend(v11, "initWithName:", v14);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v80 = 2112;
    v81 = v58;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Setting natural lighting enabled for objects: %@", buf, 0x16u);
  ...
  if (v59)
  {
    ...
    v75 = 0u;
    obj = v58;
    v20 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v74, v84, 16);
    v21 = 0;
    if (v20)
    {
      v22 = *(_QWORD *)v75;
      do
      {
        for (i = 0; i != v20; ++i)
        {
          if (*(_QWORD *)v75 != v22)
            objc_enumerationMutation(obj);
          v24 = *(void **)(*((_QWORD *)&v74 + 1) + 8 * i);
          -[HMDAssistantCommand serviceFromObject:](v63, "serviceFromObject:", v24);
          v25 = (void *)objc_claimAutoreleasedReturnValue();
          v26 = v25;
          if (v25)
          {
            ...
            if (!v31)
            {
              ...
              v72[1] = 3221225472;
              v72[2] = __95__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_completionHandler___block_invoke;
              v72[3] = &unk_1E89ADFA0;
              v73 = v26;
              objc_msgSend((id)v33, "na_firstObjectPassingTest:", v72);
              v34 = (void *)objc_claimAutoreleasedReturnValue();

              objc_msgSend(v34, "settings");
              v35 = (void *)objc_claimAutoreleasedReturnValue();
              LOBYTE(v33) = objc_msgSend(v35, "supportedFeatures");

              if ((v33 & 1) != 0)
                objc_msgSend(v61, "addObject:", v34);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v80 = 2112;
              v81 = v24;
              _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Did not find service for filtered object: %@", buf, 0x16u);
    ...
    v40 = objc_msgSend(v61, "hmf_isEmpty");
    ...
    if (v40)
    {
      if (v44)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v79 = v45;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Did not find any light profiles to set natural lighting on", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v41);
      -[HMDAssistantCommand reportResults:handler:](v42, "reportResults:handler:", 0, v57);
    }
    else
    {
      if (v44)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v82 = 2112;
        v83 = v61;
        _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Setting natural lighting for light profiles %@:%@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v41);
      objc_initWeak((id *)buf, v42);
      objc_msgSend(v21, "naturalLightingCurveWriter");
      v53 = (void *)objc_claimAutoreleasedReturnValue();
      v54 = objc_msgSend(v59, "value");
      v64[0] = MEMORY[0x1E0C809B0];
      v64[1] = 3221225472;
      v64[2] = __95__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_completionHandler___block_invoke_88;
      v64[3] = &unk_1E89A59E8;
      ...
      v69 = obj;
      v70 = v57;
      objc_msgSend(v53, "setNaturalLightingEnabled:forLightProfiles:completion:", v54, v66, v64);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v80 = 2112;
      v81 = v50;
      _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@Specified value is not of BOOLean type %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v46);
    -[HMDAssistantCommand reportOutcome:results:handler:](v47, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], MEMORY[0x1E0C9AA60], v57);
  }
...
- (void)handleSetActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "stringWithFormat:", CFSTR("%@, %s:%ld"), v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 2217);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@In Set action types, There is no attribute in action - reporting as malformed command", buf, 0xCu);
  ...
  if ((objc_msgSend(v16, "isEqualToString:") & 1) != 0)
  {
    ...
    if (!v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v21;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@No value field for SET actionType", buf, 0xCu);

      }
LABEL_6:

      objc_autoreleasePoolPop(v18);
      -[HMDAssistantCommand reportOutcome:results:handler:](v19, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v118);
      goto LABEL_86;
    }
  }
  else
  ...
  objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K =[d] %@"), CFSTR("objectType"), *MEMORY[0x1E0D88A30]);
  ...
  if (objc_msgSend(v107, "count"))
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Entity specified is an action set, executing it", buf, 0xCu);
  ...
  objc_msgSend(v122, "attribute");
  v29 = (void *)objc_claimAutoreleasedReturnValue();
  v30 = objc_msgSend(v29, "isEqualToString:", *MEMORY[0x1E0D88858]);
  ...
  objc_msgSend(v122, "attribute");
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  v32 = objc_msgSend(v31, "isEqualToString:", *MEMORY[0x1E0D88850]);
  ...
  if (!v101)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v39;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v35);
    -[HMDAssistantCommand reportOutcome:results:handler:](v36, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v118);
    goto LABEL_84;
  }
  objc_msgSend(v122, "attribute");
  v34 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  *(_QWORD *)&buf[8] = buf;
  *(_QWORD *)&buf[16] = 0x3032000000;
  v157 = __Block_byref_object_copy__13024;
  v158 = __Block_byref_object_dispose__13025;
  objc_msgSend(MEMORY[0x1E0C99DE8], "array");
  ...
  if (!v44)
    goto LABEL_54;
  v45 = *(_QWORD *)v147;
  v109 = *MEMORY[0x1E0D88830];
  v105 = *MEMORY[0x1E0D88838];
  v108 = *MEMORY[0x1E0CB8AB8];
  v104 = *MEMORY[0x1E0D887A0];
  v103 = *MEMORY[0x1E0D88758];
  v111 = *MEMORY[0x1E0D88768];
  do
  {
    v46 = 0;
    do
...
LABEL_54:
          ...
          if (!v78)
          {
            ...
            if (os_log_type_enabled(v93, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_QWORD *)&location[4] = v94;
              ...
              v153 = v95;
              v96 = v95;
              _os_log_impl(&dword_1CD062000, v93, OS_LOG_TYPE_ERROR, "%{public}@Unknown value type found. Expected integer but got %@", location, 0x16u);

            }
            objc_autoreleasePoolPop(v91);
            -[HMDAssistantCommand reportOutcome:results:handler:](v92, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v118);

            v90 = v117;
            goto LABEL_82;
          }
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v76, "unsignedIntegerValue"));
          v119 = (id)objc_claimAutoreleasedReturnValue();
  ...
  block[0] = MEMORY[0x1E0C809B0];
  block[1] = 3221225472;
  block[2] = __85__HMDAssistantCommand_handleSetActionTypes_serviceType_forObjects_completionHandler___block_invoke_93;
  block[3] = &unk_1E89BE988;
  v125 = v115;
  v126 = val;
  v128 = buf;
  ...
  if (v11)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v17)
      {
        ...
        {
          v19 = objc_msgSend(v10, "isEqualToString:", *MEMORY[0x1E0CB8708]);
          objc_msgSend(v11, "minimumValue");
          v20 = (void *)objc_claimAutoreleasedReturnValue();
          v21 = v20;
          if (v19)
...
- (id)updateValue:(id)a3 forAction:(id)a4
{
  ...
  if (objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0D88840]))
  {
    v13 = objc_msgSend(v8, "BOOLValue");
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v13 ^ 1u);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    goto LABEL_21;
  }
  v54 = self;
  v55 = v9;
  v51 = v10;
  if (objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0CB8708]))
...
LABEL_13:
  ...
  v49 = (void *)v35;
  v50 = v33;
  if (objc_msgSend(v30, "isEqualToString:", *MEMORY[0x1E0D88820]))
  {
    *(float *)&v40 = v23 + v25;
  }
  else
  {
    v41 = objc_msgSend(v30, "isEqualToString:", *MEMORY[0x1E0D887F0]);
    LODWORD(v40) = 0;
    if (v41)
      *(float *)&v40 = v25;
...
- (void)handleUpdateActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "stringWithFormat:", CFSTR("%@, %s:%ld"), v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 2537);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (objc_msgSend(v98, "count"))
    {
      ...
      if (!v85)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(_QWORD *)&buf[14] = v29;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);

        }
        objc_autoreleasePoolPop(v25);
        -[HMDAssistantCommand reportOutcome:results:handler:](v26, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v88);
        goto LABEL_82;
      }
...
LABEL_82:
      ...
      objc_msgSend(v106, "actionType");
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      if (objc_msgSend(v31, "isEqualToString:", *MEMORY[0x1E0D88840]))
      {
        v32 = objc_msgSend(v82, "isEqualToString:", *MEMORY[0x1E0CB86F8]);
        ...
        if ((v32 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_QWORD *)((char *)&v151 + 2) = v82;
            _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri passed an incorrect action (%@) to a %@ value type.", buf, 0x2Au);

          }
LABEL_79:

          objc_autoreleasePoolPop(v33);
          -[HMDAssistantCommand reportOutcome:results:handler:](v34, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v88);
LABEL_80:
      ...
      objc_msgSend(v106, "actionType");
      v38 = (void *)objc_claimAutoreleasedReturnValue();
      v39 = *MEMORY[0x1E0D887F0];
      if ((objc_msgSend(v38, "isEqualToString:", *MEMORY[0x1E0D887F0]) & 1) != 0)
      {
        if ((objc_msgSend(v82, "isEqualToString:", *MEMORY[0x1E0CB8708]) & 1) == 0)
        {
          v40 = objc_msgSend(v82, "isEqualToString:", *MEMORY[0x1E0CB8700]);
...
LABEL_30:
          ...
          *(_QWORD *)&buf[8] = buf;
          *(_QWORD *)&buf[16] = 0x3032000000;
          v150 = __Block_byref_object_copy__13024;
          *(_QWORD *)&v151 = __Block_byref_object_dispose__13025;
          objc_msgSend(MEMORY[0x1E0C99DE8], "array");
...
LABEL_38:
            ...
            if (obja)
            {
              ...
              do
              {
                for (j = 0; j != obja; j = (char *)j + 1)
                {
                  ...
                  if (v91)
                  {
                    v63 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithArray:", v62);
                    v128 = 0u;
                    v129 = 0u;
                    v126 = 0u;
                    v127 = 0u;
            ...
            block[0] = MEMORY[0x1E0C809B0];
            block[1] = 3221225472;
            block[2] = __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke_96;
            block[3] = &unk_1E89BE988;
            v108 = v87;
            v109 = val;
            v111 = buf;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_QWORD *)&location[4] = v77;
              v147 = 2112;
              v148 = v78;
              _os_log_impl(&dword_1CD062000, v76, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", location, 0x16u);

            }
            objc_autoreleasePoolPop(v74);
            -[HMDAssistantCommand reportOutcome:results:handler:](v75, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v88);
          }
      ...
      else
      {
        objc_msgSend(v106, "actionType");
        v41 = (void *)objc_claimAutoreleasedReturnValue();
        if ((objc_msgSend(v41, "isEqualToString:", *MEMORY[0x1E0D88820]) & 1) != 0
          && (objc_msgSend(v82, "isEqualToString:", *MEMORY[0x1E0CB8708]) & 1) == 0)
        {
          v79 = objc_msgSend(v82, "isEqualToString:", *MEMORY[0x1E0CB8700]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(_QWORD *)&buf[4] = v24;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@In Update action types, There is no attribute in action - reporting as malformed command", buf, 0xCu);

    }
    objc_autoreleasePoolPop(v21);
    -[HMDAssistantCommand reportOutcome:results:handler:](v22, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v88);
  }
LABEL_83:
...
- (void)_handleCommandForMediaAccessoryAction:(id)a3 objects:(id)a4 serviceType:(id)a5 completionHandler:(id)a6
{
  ...
  objc_msgSend(v10, "actionType");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  v15 = objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0D887F8]);
  ...
  objc_msgSend(v10, "actionType");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = objc_msgSend(v19, "isEqualToString:", *MEMORY[0x1E0D88828]);
...
LABEL_7:
      ...
      v27 = 2112;
      v28 = v22;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri sent an unsupported action type: %@", (uint8_t *)&v23, 0x20u);

    }
LABEL_8:

    objc_autoreleasePoolPop(v16);
    -[HMDAssistantCommand reportOutcome:results:handler:](v17, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v13);
    goto LABEL_9;
  }
...
- (void)_handleCommandForHAPAction:(id)a3 serviceType:(id)a4 objects:(id)a5 completionHandler:(id)a6
{
  ...
  objc_msgSend(v10, "actionType");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0D887F8]))
  {
...
LABEL_4:
  ...
  objc_msgSend(v10, "actionType");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  v16 = objc_msgSend(v15, "isEqualToString:", *MEMORY[0x1E0D88818]);

  if (v16)
    goto LABEL_4;
  objc_msgSend(v10, "actionType");
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v17, "isEqualToString:", *MEMORY[0x1E0D88808]) & 1) != 0)
    goto LABEL_8;
  objc_msgSend(v10, "actionType");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v18, "isEqualToString:", *MEMORY[0x1E0D88800]))
  {
...
LABEL_9:
  ...
  objc_msgSend(v10, "actionType");
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = objc_msgSend(v19, "isEqualToString:", *MEMORY[0x1E0D88810]);

  if ((v20 & 1) != 0)
    goto LABEL_9;
  objc_msgSend(v10, "actionType");
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v21, "isEqualToString:", *MEMORY[0x1E0D88828]) & 1) != 0)
    goto LABEL_15;
  objc_msgSend(v10, "actionType");
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v22, "isEqualToString:", *MEMORY[0x1E0D88838]))
  {
...
LABEL_16:
  ...
  objc_msgSend(v10, "actionType");
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  v24 = objc_msgSend(v23, "isEqualToString:", *MEMORY[0x1E0D88830]);

  if ((v24 & 1) != 0)
    goto LABEL_16;
  objc_msgSend(v10, "actionType");
  v25 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v25, "isEqualToString:", *MEMORY[0x1E0D88820]) & 1) != 0)
    goto LABEL_21;
  objc_msgSend(v10, "actionType");
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v26, "isEqualToString:", *MEMORY[0x1E0D887F0]))
  {
...
LABEL_22:
  ...
  objc_msgSend(v10, "actionType");
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v28 = objc_msgSend(v27, "isEqualToString:", *MEMORY[0x1E0D88840]);
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
  {
    ...
    v38 = 2112;
    v39 = v33;
    _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri sent an unsupported action type: %@", (uint8_t *)&v34, 0x20u);

  }
  objc_autoreleasePoolPop(v29);
  -[HMDAssistantCommand reportOutcome:results:handler:](v30, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v13);
LABEL_10:
...
- (void)handleCommandWithCompletionHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v152 = 2112;
    v153 = v14;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Executing Siri command(%{public}@) serverValidity %{public}@:\n%@", buf, 0x2Au);
  ...
  if (v15)
  {
    ...
    if (v19)
    {
      ...
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      v22 = objc_msgSend(v21, "isEqualToString:", *MEMORY[0x1E0D88BE0]);

      objc_msgSend(v6, "attribute");
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      v24 = objc_msgSend(v23, "isEqualToString:", *MEMORY[0x1E0D88870]);

      if (v24)
      {
        objc_msgSend(v6, "actionType");
        v25 = (void *)objc_claimAutoreleasedReturnValue();
        v26 = objc_msgSend(v25, "isEqualToString:", *MEMORY[0x1E0D88828]);

        objc_msgSend(v19, "entityType");
        v27 = v19;
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        v29 = objc_msgSend(v28, "isEqualToString:", *MEMORY[0x1E0D88A30]);
        ...
        if (!v26 || !v29 || !v35)
        {
          ...
          if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v152 = 2112;
            v153 = v83;
            _os_log_impl(&dword_1CD062000, v78, OS_LOG_TYPE_INFO, "%{public}@entityType is SCENE with ENABLED action attribute but either action(%@) is not SET action/empty sceneName(%@)/Type(%@)", buf, 0x2Au);
          ...
          -[HMDAssistantCommand reportOutcome:results:handler:](v77, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v4);
          v16 = v20;
          goto LABEL_85;
        }
      }
      ...
      else
      {
        objc_msgSend(v6, "actionType");
        v103 = (void *)objc_claimAutoreleasedReturnValue();
        v104 = objc_msgSend(v103, "isEqualToString:", *MEMORY[0x1E0D887F8]);
        ...
        if ((v104 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v109, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v147 = v110;
            _os_log_impl(&dword_1CD062000, v109, OS_LOG_TYPE_FAULT, "%{public}@Search filter must specify homeName or homeIdentifier for actions not of type GET", buf, 0xCu);
...
LABEL_70:
            ...
            if (!v111)
            {
              ...
              if (os_log_type_enabled(v114, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v148 = 2112;
                v149 = v125;
                _os_log_impl(&dword_1CD062000, v114, OS_LOG_TYPE_ERROR, "%{public}@Cannot evaluate home for Siri command with filtered result: %@", buf, 0x16u);
          ...
          if ((_DWORD)v22)
          {
            if (v119)
            {
              ...
              *(_DWORD *)buf = 138543362;
              v147 = v120;
              _os_log_impl(&dword_1CD062000, v118, OS_LOG_TYPE_INFO, "%{public}@Start handling command for Apple Media Accessory", buf, 0xCu);
          ...
          else
          {
            if (v119)
            {
              ...
              *(_DWORD *)buf = 138543362;
              v147 = v122;
              _os_log_impl(&dword_1CD062000, v118, OS_LOG_TYPE_INFO, "%{public}@Start handling command for HAP Characteristic", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v147 = v89;
            _os_log_impl(&dword_1CD062000, v87, OS_LOG_TYPE_INFO, "%{public}@No matches found after filtering, bailing out", buf, 0xCu);
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v147 = v75;
        _os_log_impl(&dword_1CD062000, v74, OS_LOG_TYPE_INFO, "%{public}@Could not figure out the home to apply the command to", buf, 0xCu);
        ...
        if (!v59)
        {
          if (!objc_msgSend(v58, "count"))
          {
            ...
            if (os_log_type_enabled(v92, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v147 = v95;
              _os_log_impl(&dword_1CD062000, v92, OS_LOG_TYPE_INFO, "%{public}@Identifier list filter results in no matches - re-generating sync data and requesting re-sync", buf, 0xCu);
...
LABEL_58:
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v148 = 2114;
          v149 = v59;
          _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_INFO, "%{public}@Identifier list filter resolution failed with error %{public}@", buf, 0x16u);
        ...
        -[HMDAssistantCommand reportOutcome:results:handler:](v61, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v4);
...
LABEL_85:
      ...
      if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v149 = v72;
        v73 = v72;
        _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_INFO, "%{public}@Unsupported filter type - %@", buf, 0x16u);
    ...
    -[HMDAssistantCommand reportOutcome:results:handler:](v67, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v4);
    goto LABEL_85;
  }
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v147 = v54;
    _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@There is no actionType, reporting malformed command", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v51);
  -[HMDAssistantCommand reportOutcome:results:handler:](v52, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v4);
LABEL_86:
    ...
    if ((v7 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v100 = 2112;
        v101 = v66;
        _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Action type for COLOR attribute is not GET/SET - %@", buf, 0x16u);
  ...
  if ((isKindOfClass & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v65 = v103;
      _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Value %@ for COLOR attribute is not string but %@", buf, 0x20u);
...
LABEL_68:
  ...
  if (!v14)
    goto LABEL_74;
  v15 = v14;
  p_prots = &OBJC_PROTOCOL___HMDCameraStreamSnapshotHandlerDelegate.prots;
  v88 = (void *)*MEMORY[0x1E0CB8700];
  v82 = (void *)*MEMORY[0x1E0CB8708];
  v83 = *(_QWORD *)v95;
  v79 = (void *)*MEMORY[0x1E0CB86F8];
  v87 = self;
  v77 = v4;
  v75 = v13;
LABEL_7:
...
LABEL_8:
  ...
  if (objc_msgSend(v19, "count") == 2)
  {
    ...
    v20 = objc_claimAutoreleasedReturnValue();
    -[__objc2_prot_list allKeys](p_prots[426], "allKeys");
    v86 = (void *)objc_claimAutoreleasedReturnValue();
    v90 = (void *)v20;
    if ((objc_msgSend(v86, "containsObject:", v20) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v102 = 2112;
        v103 = v86;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_INFO, "%{public}@Unsupported color space: %@; only support %@. Ignoring...",
          buf,
          0x20u);

      }
      objc_autoreleasePoolPop(v49);
      p_prots = (__objc2_prot_list **)(&OBJC_PROTOCOL___HMDCameraStreamSnapshotHandlerDelegate + 16);
      goto LABEL_60;
    }
    -[__objc2_prot_list objectForKey:](p_prots[426], "objectForKey:", v20);
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (v23 != objc_msgSend(v21, "count"))
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v104 = 2048;
        v105 = v58;
        _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_INFO, "%{public}@Color space %@ requires %tu values - %tu provided. Ignoring...", buf, 0x2Au);
    ...
    while (1)
    {
      ...
      if (v32)
      {
        ...
        else if (objc_msgSend(v30, "isEqualToString:", v82))
        {
          ...
          {
            v84 = v24;
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *(_QWORD *)&v93);
            v33 = objc_claimAutoreleasedReturnValue();
            goto LABEL_33;
          }
          v34 = (void *)MEMORY[0x1D17BA0A0]();
        ...
        else if (objc_msgSend(v30, "isEqualToString:", v79))
        {
          ...
          {
            v84 = v24;
            objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", LODWORD(v93) != 0);
            v33 = objc_claimAutoreleasedReturnValue();
LABEL_33:
            v41 = (void *)v33;
            v42 = (void *)MEMORY[0x1D17BA0A0]();
            ...
            if (v41)
            {
              if (v45)
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v104 = 2112;
                v105 = (uint64_t)v41;
                _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Color space %@:  %@=%@", buf, 0x2Au);
            ...
            else
            {
              if (v45)
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v102 = 2112;
                v103 = v32;
                _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@Color space %@ characteristicType %@ value is nil", buf, 0x20u);
...
LABEL_46:
            v40 = 42;
LABEL_47:
            _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, v39, buf, v40);
...
LABEL_74:
  ...
  if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v100 = 2112;
    v101 = v19;
    _os_log_impl(&dword_1CD062000, v70, OS_LOG_TYPE_ERROR, "%{public}@Color space encoding does not have two components: %@", buf, 0x16u);
...
LABEL_41:
  ...
  {
    v38 = objc_alloc_init(MEMORY[0x1E0D88100]);
    ...
    if (v39)
    {
      ...
      if (v41)
      {
        ...
        objc_msgSend(v14, "actionType");
        v43 = (void *)objc_claimAutoreleasedReturnValue();
        v44 = objc_msgSend(v43, "isEqualToString:", *MEMORY[0x1E0D887F8]);
...
- (id)handleReadWriteResponses:(id)a3 error:(id)a4 forAction:(id)a5 inServiceType:(id)a6 results:(id)a7 forObjects:(id)a8
{
  ...
  else
  {
    ...
    if (v74)
    {
      v78 = 0;
      v73 = *(_QWORD *)v95;
      v82 = *MEMORY[0x1E0D887A8];
      v72 = *MEMORY[0x1E0D88858];
      do
      {
        v30 = 0;
        do
                ...
                if (v40)
                {
                  ...
                  if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544642;
                    ...
                    v113 = 2112;
                    v114 = v48;
                    _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Error %tu for %@/%@/%@/%@", buf, 0x3Eu);
          ...
          do
          {
            for (i = 0; i != v54; ++i)
            {
              ...
              if (v26)
              {
                ...
                v38 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", v23);
    ...
    while (2)
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (v17)
        {
          ...
          if (!v18)
            objc_msgSend(v8, "setObject:forKey:", MEMORY[0x1E0C9AAB0], v15);
          goto LABEL_12;
        }
      }
...
- (void)addActivationCharacteristicsIfNeeded:(id)a3 forCharacteristic:(id)a4
{
  ...
  if ((isActivationCharacteristicType(v7) & 1) == 0)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if (objc_msgSend(v9, "isEqual:", *MEMORY[0x1E0CB9A70]))
    {
      v10 = v7;
      if ((objc_msgSend(v10, "isEqual:", *MEMORY[0x1E0CB87C0]) & 1) == 0
        && (objc_msgSend(v10, "isEqual:", *MEMORY[0x1E0CB88E8]) & 1) == 0
        && (objc_msgSend(v10, "isEqual:", *MEMORY[0x1E0CB8A00]) & 1) == 0)
      {
        v11 = (_QWORD *)MEMORY[0x1E0CB8810];
LABEL_21:
        v14 = objc_msgSend(v10, "isEqual:", *v11);

        if ((v14 & 1) == 0)
          goto LABEL_18;
        v12 = (_QWORD *)MEMORY[0x1E0CB89C8];
LABEL_17:
...
LABEL_18:
    ...
    {
      if (!objc_msgSend(v9, "isEqual:", *MEMORY[0x1E0CB9A10]))
      {
        if ((objc_msgSend(v9, "isEqual:", *MEMORY[0x1E0CB9B10]) & 1) == 0
          && (objc_msgSend(v9, "isEqual:", *MEMORY[0x1E0CB99A8]) & 1) == 0
          && !objc_msgSend(v9, "isEqual:", *MEMORY[0x1E0CB9A30]))
        {
          goto LABEL_18;
        }
        v13 = v7;
        if ((objc_msgSend(v13, "isEqual:", *MEMORY[0x1E0CB89E8]) & 1) == 0
          && (objc_msgSend(v13, "isEqual:", *MEMORY[0x1E0CB89F0]) & 1) == 0)
        {
          v15 = objc_msgSend(v13, "isEqual:", *MEMORY[0x1E0CB8A98]);

          if ((v15 & 1) == 0)
            goto LABEL_18;
          v12 = (_QWORD *)MEMORY[0x1E0CB8790];
          goto LABEL_17;
        }
        v12 = (_QWORD *)MEMORY[0x1E0CB8790];
        goto LABEL_16;
      ...
      v10 = v7;
      if ((objc_msgSend(v10, "isEqual:", *MEMORY[0x1E0CB89E8]) & 1) == 0)
      {
        v11 = (_QWORD *)MEMORY[0x1E0CB89F0];
        goto LABEL_21;
      }
    }
    v12 = (_QWORD *)MEMORY[0x1E0CB89C8];
...
- (void)addBridgedAccessoryCharacteristicsFor:(id)a3 toCollection:(id)a4 assistantObjects:(id)a5
{
  ...
  +[HMDHAPMetadata getSharedInstance](HMDHAPMetadata, "getSharedInstance");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "mapReadCharacteristicFromAssistantName:", *MEMORY[0x1E0D88888]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "mapFromAssistantServiceName:", *MEMORY[0x1E0D88C08]);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "mapFromAssistantServiceName:", *MEMORY[0x1E0D88BF8]);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "type");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)addLinkedServiceCharacteristicsFor:(id)a3 toCollection:(id)a4 assistantObjects:(id)a5
{
  ...
  +[HMDHAPMetadata getSharedInstance](HMDHAPMetadata, "getSharedInstance");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "mapReadCharacteristicFromAssistantName:", *MEMORY[0x1E0D88888]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "mapFromAssistantServiceName:", *MEMORY[0x1E0D88BF8]);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "mapFromAssistantServiceName:", *MEMORY[0x1E0D88C08]);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)handleSetColor:(id)a3 forObjects:(id)a4 service:(id)a5 completionHandler:(id)a6
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "stringWithFormat:", CFSTR("%@, %s:%ld"), v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 3532);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v62, "count"))
  {
    ...
    v100 = &v99;
    v101 = 0x3032000000;
    v102 = __Block_byref_object_copy__13024;
    v103 = __Block_byref_object_dispose__13025;
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    {
      v51 = *(_QWORD *)v96;
      v57 = *MEMORY[0x1E0CB8700];
      v56 = *MEMORY[0x1E0D88768];
      do
      {
        for (i = 0; i != v52; ++i)
        {
    ...
    block[0] = MEMORY[0x1E0C809B0];
    block[1] = 3221225472;
    block[2] = __75__HMDAssistantCommand_handleSetColor_forObjects_service_completionHandler___block_invoke_109;
    block[3] = &unk_1E89BE988;
    v69 = v54;
    v70 = val;
    v72 = &v99;
  ...
  {
    -[HMDAssistantCommand reportOutcome:results:handler:](self, "reportOutcome:results:handler:", *MEMORY[0x1E0D88908], 0, v55);
  }
...
- (void)handleGetColor:(id)a3 forObjects:(id)a4 serviceType:(id)a5 completionHandler:(id)a6
{
  ...
  MEMORY[0x1D17B8D08](self, a2);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "stringWithFormat:", CFSTR("%@, %s:%ld"), v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 3654);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v69, "count"))
  {
    ...
    *((_QWORD *)&buf + 1) = &buf;
    v112 = 0x3032000000;
    v113 = __Block_byref_object_copy__13024;
    v114 = __Block_byref_object_dispose__13025;
    objc_msgSend(MEMORY[0x1E0C99DE8], "array");
    ...
    block[0] = MEMORY[0x1E0C809B0];
    block[1] = 3221225472;
    block[2] = __79__HMDAssistantCommand_handleGetColor_forObjects_serviceType_completionHandler___block_invoke_110;
    block[3] = &unk_1E89BE988;
    v71 = v62;
    v72 = self;
    v74 = &buf;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v54;
      _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@No characteristics found after filtering objects", (uint8_t *)&buf, 0xCu);
...
- (void)performWithGather:(id)a3 queue:(id)a4 msgDispatcher:(id)a5 completion:(id)a6
{
  ...
  v16 = a2;
  v17 = v12;
  MEMORY[0x1D17B8D08](self, v16);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v15, "stringWithFormat:", CFSTR("%@, %s:%ld"), v18, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Assistant/HMDAssistantCommand.m", 3754);
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v23)
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v63 = v48;
      _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@There are no homes, reporting the result right away", buf, 0xCu);
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    v72 = 2112;
    v73 = v40;
    _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Number of homes: %tu, Primary home: %@, Primary home ID: %@, Current home: %@, Current home ID: %@", buf, 0x3Eu);
  ...
  if ((_DWORD)v42)
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v63 = v50;
      _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@There are no homekit objects, calling completion", buf, 0xCu);
...
void __72__HMDAssistantCommand_performWithGather_queue_msgDispatcher_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    v5 = objc_msgSend(MEMORY[0x1E0C99D68], "timeIntervalSinceReferenceDate");
    v7 = v6;
    v8 = *(double *)(a1 + 48);
    v9 = (void *)MEMORY[0x1D17BA0A0](v5);
    v10 = WeakRetained;
    HMFGetOSLogHandle();
    v11 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2048;
      v24 = v7 - v8;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Siri command took %.4f seconds", buf, 0x16u);
    ...
    if ((objc_msgSend(v10, "completionHandlerCalled") & 1) != 0)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v22 = v16;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Completion handler already called, not calling again", buf, 0xCu);
    ...
    else
    {
      ...
      v18[1] = 3221225472;
      v18[2] = __72__HMDAssistantCommand_performWithGather_queue_msgDispatcher_completion___block_invoke_115;
      v18[3] = &unk_1E89C1D68;
      v20 = *(id *)(a1 + 32);
      v19 = v3;
...
uint64_t __72__HMDAssistantCommand_performWithGather_queue_msgDispatcher_completion___block_invoke_115(uint64_t a1)
{
...
void __79__HMDAssistantCommand_handleGetColor_forObjects_serviceType_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received error %@ for read request with response tuples: %@", (uint8_t *)&v17, 0x20u);
...
uint64_t __79__HMDAssistantCommand_handleGetColor_forObjects_serviceType_completionHandler___block_invoke_110(uint64_t a1)
{
  void *v2;
  id v3;
  NSObject *v4;
  ...
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "begin"));
  v3 = *(id *)(a1 + 40);
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for set-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
...
void __75__HMDAssistantCommand_handleSetColor_forObjects_service_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v5;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response %@ for write request with %@", (uint8_t *)&v17, 0x20u);
...
uint64_t __75__HMDAssistantCommand_handleSetColor_forObjects_service_completionHandler___block_invoke_109(uint64_t a1)
{
  void *v2;
  id v3;
  NSObject *v4;
...
void __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  from = (id *)(a1 + 112);
  v103 = a1;
  v6 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "begin"));
  v91 = WeakRetained;
  v100 = WeakRetained;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v135 = 2112;
    v136 = v93;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received response %@ for read request with error %@", buf, 0x20u);
  ...
  v12 = 0;
  v97 = *(_QWORD *)v121;
  v89 = *MEMORY[0x1E0D887A8];
  v88 = *MEMORY[0x1E0D888A8];
  do
  {
    v13 = 0;
    do
          ...
          if (v23)
          {
            ...
            if (v27)
            {
              ...
              if (v28)
              {
                ...
                v31 = (objc_class *)MEMORY[0x1E0D880B0];
                v32 = *(id *)(v103 + 56);
                v33 = v29;
                v21 = v21;
                ...
                v36 = objc_alloc_init(MEMORY[0x1E0D880B8]);
                objc_msgSend(v36, "setValue:", objc_msgSend(&unk_1E8B32928, "BOOLValue"));
...
LABEL_69:
  ...
  else
  {
    if (objc_msgSend(v94, "count"))
    {
      ...
      v104[1] = 3221225472;
      v104[2] = __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke_95;
      v104[3] = &unk_1E89A5A10;
...
uint64_t __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke_96(uint64_t a1)
{
  void *v2;
  id v3;
  NSObject *v4;
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for update-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
...
void __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke_95(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  id WeakRetained;
...
uint64_t __85__HMDAssistantCommand_handleSetActionTypes_serviceType_forObjects_completionHandler___block_invoke_93(uint64_t a1)
{
  void *v2;
  id v3;
  NSObject *v4;
...
void __95__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_completionHandler___block_invoke_88(uint64_t a1, void *a2)
{
  id WeakRetained;
  __int128 v4;
  uint64_t i;
  ...
  if (WeakRetained)
  {
    ...
    {
      v24 = *(_QWORD *)v30;
      v23 = *MEMORY[0x1E0D88740];
      v22 = *MEMORY[0x1E0D887A8];
      *(_QWORD *)&v4 = 138543874;
      v20 = v4;
      v25 = a1;
      do
          ...
          if (v8)
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = v20;
              ...
              v37 = 2112;
              v38 = v8;
              _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to set natural lighting for light profile %@:%@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = v20;
              ...
              v37 = 2112;
              v38 = 0;
              _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully set natural lighting for light profile %@:%@", buf, 0x20u);
...
uint64_t __85__HMDAssistantCommand_handleGetActionTypes_serviceType_forObjects_completionHandler___block_invoke_86(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for get-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received error %@ for read/write request with responses %@", buf, 0x20u);
...
uint64_t __102__HMDAssistantCommand_handleMediaAccessorySetActionType_forObjects_withServiceType_completionHandler___block_invoke_83(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for Apple Media Accessory get-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
...
void __69__HMDAssistantCommand_executeActionSet_action_withCompletionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = objc_alloc_init(MEMORY[0x1E0D880B8]);
  ...
  v12 = (id)*MEMORY[0x1E0D88910];
  objc_msgSend(v11, "setValue:", 1);
  if (!v5)
  {
    v24 = v12;
    objc_msgSend(v10, "setOutcome:", *MEMORY[0x1E0D887A8]);
LABEL_16:
    v15 = 0;
    goto LABEL_17;
  }
  objc_msgSend(v10, "setOutcome:", *MEMORY[0x1E0D88740]);
  if (objc_msgSend(v5, "code") == 25)
  {
    v13 = (id)*MEMORY[0x1E0D88938];

    v14 = (_QWORD *)MEMORY[0x1E0D88778];
LABEL_12:
...
LABEL_13:
  ...
  {
    v13 = (id)*MEMORY[0x1E0D88948];

    v14 = (_QWORD *)MEMORY[0x1E0D88788];
    goto LABEL_12;
  }
  if (objc_msgSend(v5, "code") == 64)
  {
    v13 = (id)*MEMORY[0x1E0D88940];

    goto LABEL_13;
  }
  if (objc_msgSend(v5, "code") == 65)
  {
    v13 = (id)*MEMORY[0x1E0D88930];

    v14 = (_QWORD *)MEMORY[0x1E0D88750];
    goto LABEL_12;
  }
  if (objc_msgSend(v5, "code") == 15)
    objc_msgSend(v10, "setOutcome:", *MEMORY[0x1E0D88750]);
LABEL_14:
  v24 = v12;
  if (!v6)
    goto LABEL_16;
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_17:
  v16 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v10, "setResultValue:", v11));
  v17 = WeakRetained;
  HMFGetOSLogHandle();
  v18 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v10;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Result received for execute action set: %@, calling result handler", buf, 0x16u);
  ...
  objc_autoreleasePoolPop(v16);
  v21 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithObjects:", v10, 0);
