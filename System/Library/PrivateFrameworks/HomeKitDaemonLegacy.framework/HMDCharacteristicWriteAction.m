...
- (HMDCharacteristicWriteAction)initWithUUID:(id)a3 characteristic:(id)a4 targetValue:(id)a5 actionSet:(id)a6
{
  id v11;
  id v12;
  HMDCharacteristicWriteAction *v13;
  HMDCharacteristicWriteAction *v14;
  objc_super v16;
  ...
  v13 = -[HMDAction initWithUUID:actionSet:](&v16, sel_initWithUUID_actionSet_, a3, a6);
  v14 = v13;
  if (v13)
  {
...
- (unint64_t)entitlementsForNotification
{
  ...
  if (objc_msgSend(v4, "hasTelevisionService") && (_os_feature_enabled_impl() & 1) == 0)
  {
    v8.receiver = self;
    v8.super_class = (Class)HMDCharacteristicWriteAction;
    v5 = -[HMDAction entitlementsForNotification](&v8, sel_entitlementsForNotification) | 4;
  }
  else
  {
    v7.receiver = self;
    v7.super_class = (Class)HMDCharacteristicWriteAction;
    v5 = -[HMDAction entitlementsForNotification](&v7, sel_entitlementsForNotification);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode base class: %@", buf, 0x16u);
...
- (void)_processWriteActionModelUpdated:(id)a3 message:(id)a4
{
  ...
  if (v9 && v12)
  {
    ...
    v8 = v31;
LABEL_6:
    v21 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v7, "respondWithPayload:", v20));
    v22 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v36 = 2112;
      v37 = v20;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Responding to client after updating action with response %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v40 = 2112;
    v41 = v13;
    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Write action Model object (%@) missing actionset %@ or home %@ ", buf, 0x2Au);
...
LABEL_28:
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v45 = 2112;
          v46 = v19;
          _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find characteristic: %@-%@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v43 = 2112;
          v44 = v15;
          _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find accessory with identifier: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v43 = 2112;
        v44 = v6;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Missing target value: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v43 = 2112;
    v44 = v8;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Invalid action type: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_117937 != -1)
    dispatch_once(&logCategory__hmf_once_t12_117937, &__block_literal_global_117938);
  return (id)logCategory__hmf_once_v13_117939;
}
...
void __43__HMDCharacteristicWriteAction_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_117939;
  logCategory__hmf_once_v13_117939 = v0;
