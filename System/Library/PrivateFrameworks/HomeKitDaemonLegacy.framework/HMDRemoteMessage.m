...
- (HMDRemoteMessage)initWithName:(id)a3 qualityOfService:(int64_t)a4 destination:(id)a5 payload:(id)a6 headers:(id)a7 type:(int64_t)a8 timeout:(double)a9 secure:(BOOL)a10 restriction:(unint64_t)a11 sendOptions:(unint64_t)a12 collapseID:(id)a13
{
  ...
  if (v23 >= 4)
  {
    ...
    v26 = objc_msgSend(v25, "qualityOfService");
  ...
  v42[0] = CFSTR("HMD.remote");
  v42[1] = CFSTR("HMD.remoteSecure");
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", a10);
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  v43[1] = v28;
  v42[2] = CFSTR("HMD.remoteTransportRestriction");
  ...
  if (v22)
  {
    ...
    objc_msgSend(v31, "setObject:forKeyedSubscript:", v22, CFSTR("HMD.remoteCollapseID"));
  ...
  v33 = -[HMDRemoteMessage initWithName:qualityOfService:destination:userInfo:headers:payload:](&v41, sel_initWithName_qualityOfService_destination_userInfo_headers_payload_, v18, v24, v19, v30, v21, v20);
  v34 = v33;
  if (v33)
  {
    v33->_type = a8;
    if (a9 > 0.0)
    {
      -[HMDRemoteMessage internal](v33, "internal");
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v35, "setTimeout:", a9);
