...
- (BOOL)evaluate
{
        ...
        if ((objc_msgSend(*(id *)(*((_QWORD *)&v17 + 1) + 8 * v7), "status") & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v22 = v16;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to NO", buf, 0xCu);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v22 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", buf, 0xCu);
...
void __70__HMDAccessoryFirmwareUpdateAggregatePolicy_handlePolicyStatusChange___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(v2, "conformsToProtocol:", &unk_1EFA94CF0))
    v3 = v2;
  else
    v3 = 0;
  v4 = v3;
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 1024;
      v16 = v8;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Received updated status from sub policy - %d", (uint8_t *)&v13, 0x12u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_100475 != -1)
    dispatch_once(&logCategory__hmf_once_t4_100475, &__block_literal_global_84_100476);
  return (id)logCategory__hmf_once_v5_100477;
}
...
void __56__HMDAccessoryFirmwareUpdateAggregatePolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_100477;
  logCategory__hmf_once_v5_100477 = v0;
