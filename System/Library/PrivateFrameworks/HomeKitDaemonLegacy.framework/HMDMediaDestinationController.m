...
- (id)assistantObjectWithHome:(id)a3 name:(id)a4
{
  ...
  v11 = *MEMORY[0x1E0D88B80];
  v15[6] = *MEMORY[0x1E0D88C00];
  v15[7] = v11;
  v14[7] = CFSTR("objectServiceSubType");
  v14[8] = CFSTR("objectGroupType");
  v15[8] = *MEMORY[0x1E0D88A60];
...
- (void)configureWithHome:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Configuring with data: %@", (uint8_t *)&v11, 0x16u);
      ...
      if (v5 != v3)
      {
        ...
        if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v15 = 2112;
          v16 = v10;
          _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Migrating support options: %@", buf, 0x16u);
...
- (void)stageDestinationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Staging destination identifier: %@", (uint8_t *)&v14, 0x16u);
...
- (void)stageAvailableDestinationIdentifiers:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v20 = 2112;
    v21 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Staging available destination identifiers: %@", buf, 0x16u);
...
- (id)updateAvailableDestinationIdentifiers:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating with available destination identifiers: %@", (uint8_t *)&v24, 0x16u);
    ...
    && (objc_msgSend((id)isFeatureHomeTheaterQFAEnabledForTests, "BOOLValue") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 138543362;
        v25 = v20;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to update available destination identifiers in local storage due to no local storage found", (uint8_t *)&v24, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 138543362;
      v25 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Home Theater QFA is not enabled", (uint8_t *)&v24, 0xCu);
...
- (id)updateDestinationIdentifier:(id)a3 updateOptions:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2112;
    v37 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating with destination identifier: %@ support options: %@", (uint8_t *)&v32, 0x20u);
...
LABEL_23:
        ...
        objc_msgSend(MEMORY[0x1E0D519C0], "chainFutures:", v14);
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v34 = 2112;
        v35 = v15;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Updating using related destination: %@", (uint8_t *)&v32, 0x16u);
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    v36 = 2112;
    v37 = v13;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to update to destination identifier: %@ due to identifier not in available destination identifiers: %@", (uint8_t *)&v32, 0x20u);

  }
  objc_autoreleasePoolPop(v22);
  v26 = (void *)MEMORY[0x1E0D519C0];
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 9006);
...
- (id)_updateDestinationIdentifier:(id)a3
{
    ...
    && (objc_msgSend((id)isFeatureHomeTheaterQFAEnabledForTests, "BOOLValue") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 2112;
        v23 = v4;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination identifier: %@ in local storage due to no local storage found", (uint8_t *)&v20, 0x16u);

      }
      objc_autoreleasePoolPop(v13);
      v17 = (void *)MEMORY[0x1E0D519C0];
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 9008);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 138543362;
      v21 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Home Theater QFA is not enabled", (uint8_t *)&v20, 0xCu);
...
- (id)updateDestinationWithIdentifier:(id)a3 audioGroupIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v35 = 2112;
    v36 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating destination with identifier: %@ audio group identifier: %@", buf, 0x20u);
...
LABEL_10:
        _os_log_impl(&dword_1CD062000, v25, v26, v24, buf, 0x16u);
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 9007);
...
- (void)refreshDestinationController
{
  ...
  if (-[HMDMediaDestinationController isTargetDevice](self, "isTargetDevice"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Refreshing destination controller", (uint8_t *)&v7, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to update available destination identifiers due to no refreshed available destination identifiers", buf, 0xCu);
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v23 = 2112;
        v24 = v11;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating related destination identifier: %@ to destination identifier: %@", buf, 0x20u);
...
LABEL_12:
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v4;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Filtering unknown destination with identifier: %@ due to destination: %@ available destinations: %@", (uint8_t *)&v17, 0x2Au);
...
- (id)mediaGroupParticipantDataLocalStorage
{
  ...
  if (v3)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v19 = 2112;
        v20 = v4;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get local data storage due data source: %@", (uint8_t *)&v17, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to data souce local data storage due to no data source", (uint8_t *)&v17, 0xCu);
...
- (id)dataSourceAvailableDestinationIdentifiers
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get refreshed available destination identifiers due to no data source", (uint8_t *)&v11, 0xCu);
...
- (id)dataSourceTargetAccessory
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get target accessory due to no data source", (uint8_t *)&v11, 0xCu);
...
- (id)dataSourceDestinationManagerWithIdentifier:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination manager with identifier: %@ due to no data source", (uint8_t *)&v13, 0x16u);
...
- (id)dataSourceDestinationUsingRelatedIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 2112;
        v30 = v4;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Found destination: %@ using parent identifier: %@", (uint8_t *)&v25, 0x20u);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 2112;
        v30 = v4;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Found root destination: %@ using decendant identifier: %@", (uint8_t *)&v25, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v4;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data source during destination with parent identifier: %@", (uint8_t *)&v25, 0x16u);
...
- (id)messageHandler:(id)a3 shouldRelayIncomingMessage:(id)a4
{
  ...
  if (v8)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", objc_msgSend(v8, "isCurrentAccessory") ^ 1);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get relay preference due to no target accessory", (uint8_t *)&v16, 0xCu);
...
- (void)mediaDestinationControllerMessageHandler:(id)a3 didReceiveMediaDestinationControllerUpdateDestinationRequestMessage:(id)a4 destinationIdentifier:(id)a5 updateOptions:(unint64_t)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v31 = v16;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Handling did receive media destination controller update destination request message", buf, 0xCu);
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v13;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Unsetting media destination due to another destination controller with the same destination identifier: %@", buf, 0x16u);
...
- (void)migrateWithHome:(id)a3 cloudZone:(id)a4 migrationQueue:(id)a5 completion:(id)a6
{
  ...
  -[HMDMediaDestinationController backingStoreHandler](self, "backingStoreHandler");
  v14 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v14, "migrateWithHome:cloudZone:migrationQueue:completion:", v13, v12, v11, v10);
...
- (void)mediaDestinationControllerBackingStoreHandler:(id)a3 didUpdateDestinationIdentifier:(id)a4
{
  ...
  if (os_signpost_enabled((os_log_t)v8))
  {
    if (v7)
    {
      v17 = 138412290;
      v18 = v7;
      _os_signpost_emit_with_name_impl(&dword_1CD062000, (os_log_t)v8, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "HMDMediaDestinationControllerCommitDestinationIdentifierEvent", "destinationIdentifier=%{signpost.description:attribute}@ ", (uint8_t *)&v17, 0xCu);
    }
    else
    {
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v7;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Committing updated destination identifier: %@", (uint8_t *)&v17, 0x16u);
...
- (void)mediaDestinationControllerBackingStoreHandler:(id)a3 didUpdateAvailableDestinationIdentifiers:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Committing updated available destination identifiers: %@", (uint8_t *)&v13, 0x16u);
...
- (void)mediaDestinationControllerBackingStoreHandlerDidProcessUnexpectedModelAdd:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Refreshing destination controller due to unexpected model add", (uint8_t *)&v9, 0xCu);
...
- (void)triggerStageValueDidExpireValueForStagedDestinationIdentifier
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Triggering stage value did expire value for staged destination identifier", (uint8_t *)&v9, 0xCu);
...
- (void)triggerStageValueDidExpireValueForStagedAvailableDestinationIdentifiers
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Triggering stage value did expire value for staged available destination identifiers", (uint8_t *)&v9, 0xCu);
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 2112;
        v19 = v7;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unknown stage value: %@ did expire value: %@", (uint8_t *)&v14, 0x20u);
...
- (void)stagedValue:(id)a3 didExpireDestinationIdentifier:(id)a4
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Handling did expire destination identifier: %@", (uint8_t *)&v18, 0x16u);
...
- (void)stagedValue:(id)a3 didExpireAvailableDestinationIdentifiers:(id)a4
{
  ...
  if (v7)
  {
    ...
    if ((v13 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 2112;
        v27 = v7;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Handling did expire available destination identifiers: %@", (uint8_t *)&v24, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 138543362;
      v25 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Expired available destination identifiers was null when the property is non-null", (uint8_t *)&v24, 0xCu);
...
- (void)notifyDelegateDidUpdateStagedValues
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed notify did update staged values due to no delegate", (uint8_t *)&v9, 0xCu);
...
void __195__HMDMediaDestinationController_mediaDestinationControllerMessageHandler_didReceiveMediaDestinationControllerUpdatedDestinationNotification_destinationControllerIdentifier_destinationIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Update destination identifier to unset destination finished with error: %@", (uint8_t *)&v8, 0x16u);
...
void __195__HMDMediaDestinationController_mediaDestinationControllerMessageHandler_didReceiveMediaDestinationControllerUpdatedDestinationNotification_destinationControllerIdentifier_destinationIdentifier___block_invoke_27(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Update destination identifier to unset destination finished", (uint8_t *)&v8, 0xCu);
...
void __178__HMDMediaDestinationController_mediaDestinationControllerMessageHandler_didReceiveMediaDestinationControllerUpdateDestinationRequestMessage_destinationIdentifier_updateOptions___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Update destination future finished with error: %@", (uint8_t *)&v8, 0x16u);
...
void __178__HMDMediaDestinationController_mediaDestinationControllerMessageHandler_didReceiveMediaDestinationControllerUpdateDestinationRequestMessage_destinationIdentifier_updateOptions___block_invoke_26(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Update destination future finished", (uint8_t *)&v8, 0xCu);
...
BOOL __72__HMDMediaDestinationController_filteredAvailableDestinationIdentifiers__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Filtering unknown available destination with identifier: %@", (uint8_t *)&v10, 0x16u);
...
void __61__HMDMediaDestinationController_refreshDestinationIdentifier__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Update destination identifier for refresh finished with error: %@", (uint8_t *)&v8, 0x16u);
...
void __61__HMDMediaDestinationController_refreshDestinationIdentifier__block_invoke_24(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Update destination identifier for refresh finished", (uint8_t *)&v8, 0xCu);
...
void __71__HMDMediaDestinationController_refreshAvailableDestinationIdentifiers__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Update available destination identifiers for refresh finished with error: %@", (uint8_t *)&v8, 0x16u);
...
void __71__HMDMediaDestinationController_refreshAvailableDestinationIdentifiers__block_invoke_22(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Update available destination identifiers for refresh finished", (uint8_t *)&v8, 0xCu);
...
void __86__HMDMediaDestinationController_updateDestinationWithIdentifier_audioGroupIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Send request to update audio group identifier completed with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Send request to update audio group identifier completed", (uint8_t *)&v10, 0xCu);
...
void __67__HMDMediaDestinationController_legacyUpdateDestinationIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Update destination finished with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Update destination finished", (uint8_t *)&v10, 0xCu);
...
void __77__HMDMediaDestinationController_legacyUpdateAvailableDestinationIdentifiers___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Update available destination identifiers finished with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Update available destination identifiers finished", (uint8_t *)&v10, 0xCu);
...
void __54__HMDMediaDestinationController_migrateSupportOptions__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to migrate supported options: %@ error: %@", (uint8_t *)&v9, 0x20u);
...
+ (unint64_t)expectedSupportOptions
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@[HMDMediaDestinationController] Querying expected support options on unsupported device", (uint8_t *)&v6, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t53_183846 != -1)
    dispatch_once(&logCategory__hmf_once_t53_183846, &__block_literal_global_183847);
  return (id)logCategory__hmf_once_v54_183848;
}
...
void __44__HMDMediaDestinationController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v54_183848;
  logCategory__hmf_once_v54_183848 = v0;
