...
- (void)_readRequiredTransportCharacteristicsIfNeededWithCompletion:(id)a3
{
  ...
  objc_msgSend(v6, "findCharacteristicWithType:", *MEMORY[0x1E0CB8B28]);
      ...
      if (objc_msgSend(v15, "count"))
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v32 = 2112;
          v33 = v21;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Reading required transport characteristic for data stream controller %@", buf, 0x16u);
...
void __51__HMDDataStreamController_handleAccessoryConnected__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to read the required transport characteristics for: %@ with error: %@", (uint8_t *)&v11, 0x20u);
...
- (BOOL)_isDataStreamConfigurationValid
{
  ...
  objc_msgSend(v4, "findCharacteristicWithType:", *MEMORY[0x1E0CB8B28]);
    ...
    if (v9)
    {
      ...
      if (v10 == 1)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v123 = 2112;
          v124 = v20;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@HDS has version '%@' (%@/%@)", buf, 0x2Au);
          ...
          if (v26)
          {
            ...
            if (os_log_type_enabled(v84, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v121 = 2112;
              v122 = v91;
              _os_log_impl(&dword_1CD062000, v84, OS_LOG_TYPE_INFO, "%{public}@Failed to parse HDS supported configuration (%@/%@)", buf, 0x20u);
                        ...
                        else
                        {
                          ...
                          if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
                          {
                            ...
                            *(_DWORD *)buf = 138543362;
                            v118 = v44;
                            _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory with HDS service advertises HDS-over-HAP but provides no MTU; ignoring.",
                              buf,
                              0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v121 = 2112;
            v122 = v81;
            _os_log_impl(&dword_1CD062000, v75, OS_LOG_TYPE_INFO, "%{public}@No HDS supported configuration (%@/%@)", buf, 0x20u);
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v123 = 2112;
        v124 = v72;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@HDS version '%@' is not supported (%@/%@)", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v123 = 2112;
        v124 = v65;
        _os_log_impl(&dword_1CD062000, v58, OS_LOG_TYPE_INFO, "%{public}@HDS version '%@' was not parsable (%@/%@)", buf, 0x2Au);
...
LABEL_50:
  ...
  if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v121 = 2112;
    v122 = v55;
    _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_INFO, "%{public}@No HDS version found (%@/%@)", buf, 0x20u);
...
- (void)_handleAccessoryConnected
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v22 = 2112;
    v23 = v13;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory with HDS service is connected: %@. Configured: %@ Accepts Bulk Send: %@", (uint8_t *)&v16, 0x2Au);
...
{
  return -[HMDDataStreamController initWithAccessory:service:workQueue:dataStreamFactory:](self, "initWithAccessory:service:workQueue:dataStreamFactory:", a3, a4, a5, &__block_literal_global_47016);
}
...
- (void)_handleAccessoryDisconnected
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 2112;
    v11 = v4;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory with HDS service is no longer connected: %@. Removing any transports that were active", (uint8_t *)&v8, 0x16u);
  ...
  if (v9)
  {
    ...
    if (v14)
    {
      if (v18)
      {
        ...
        v31 = 2112;
        v32 = v7;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Adding bulk-send listener on this stream for file-type '%@'", (uint8_t *)&v29, 0x16u);
    ...
    else
    {
      if (v18)
      {
        ...
        v31 = 2112;
        v32 = v7;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Cancelling bulk-send listener registration for file-type '%@' due to no such protocol on this stream", (uint8_t *)&v29, 0x16u);

      }
      objc_autoreleasePoolPop(v15);
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1064);
  ...
  else
  {
    ...
    if (v20)
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 2112;
        v32 = v7;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Add pending bulk-send listener registration for file-type '%@' (waiting for stream setup)", (uint8_t *)&v29, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v31 = 2112;
        v32 = v7;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Canceling bulk-send listener registration for file-type '%@' due to no active data stream", (uint8_t *)&v29, 0x16u);
...
LABEL_20:
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, v25, v28, 0xCu);
...
LABEL_22:
  ...
  if (v11)
  {
    if (v15)
    {
      ...
      *(_DWORD *)v28 = 138543362;
      *(_QWORD *)&v28[4] = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Removed bulk-send listener on this stream", v28, 0xCu);
  ...
  if (v15)
  {
    ...
    *(_DWORD *)v28 = 138543362;
    *(_QWORD *)&v28[4] = v26;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Removed bulk-send listener on this stream (but there was no protocol!?)", v28, 0xCu);
...
- (void)sendTargetControlWhoAmIWithIdentifier:(unsigned int)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      v14 = 138543362;
      v15 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Data Stream sending target-control whoami message", (uint8_t *)&v14, 0xCu);
  ...
  else
  {
    if (v9)
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Data Stream not running; dropping target-control whoami message",
        (uint8_t *)&v14,
        0xCu);
...
- (void)_createStreamSocketWithStreamProtocol:(id)a3 applicationProtocolName:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v9;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Creating stream socket for application protocol %@", (uint8_t *)&v18, 0x16u);
...
- (BOOL)setupRequiresCharacteristicReads
{
  ...
  if (!-[HMDDataStreamController _isDataStreamConfigurationValid](self, "_isDataStreamConfigurationValid"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      v8 = 138543362;
      v9 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEBUG, "%{public}@Current data stream configuration is not valid", (uint8_t *)&v8, 0xCu);
    ...
    else
    {
      if (!-[HMDDataStreamController supportsDataStreamOverHAP](self, "supportsDataStreamOverHAP") && !v8)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          v22 = 138543362;
          v23 = v20;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; not supported",
            (uint8_t *)&v22,
            0xCu);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v22 = 138543362;
    v23 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Initiating stream setup while already in progress; ignoring this extra call.",
      (uint8_t *)&v22,
      0xCu);
...
- (void)dataStreamInitializationSetupOperation:(id)a3 didCompleteSupportReadWithStatus:(BOOL)a4
{
  ...
  if (v7 == v6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138543362;
        v19 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Canceling DataStream initialization setup (which is in progress)", (uint8_t *)&v18, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Setup init operation succeeded however is no longer the current one; ignoring its result.",
        (uint8_t *)&v18,
        0xCu);
...
- (void)dataStreamSetupOperation:(id)a3 didSucceedWithTransport:(id)a4 sessionEncryption:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Setup operation succeeded however is no longer the current one; ignoring its result.",
        (uint8_t *)&v21,
        0xCu);
...
- (void)dataStreamSetupOperation:(id)a3 didFailWithError:(id)a4
{
  ...
  if (v8 == v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Canceling DataStream setup (which is in progress)", (uint8_t *)&v13, 0xCu);
...
- (void)_cancelStreamTransportWithError:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Canceling DataStream setup", (uint8_t *)&v19, 0xCu);
  ...
  else
  {
    ...
    if (v11)
    {
      if (v15)
      {
        ...
        v19 = 138543362;
        v20 = v16;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Canceling active DataStream", (uint8_t *)&v19, 0xCu);
    ...
    else
    {
      if (v15)
      {
        ...
        v19 = 138543362;
        v20 = v18;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Dropping cancel-stream; appears to already be canceled",
          (uint8_t *)&v19,
          0xCu);
...
- (void)dataStream:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@DataStream failed with error (%@)!", (uint8_t *)&v12, 0x16u);
...
- (void)dataStreamDidClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@DataStream closed", (uint8_t *)&v9, 0xCu);
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@DataStream opened", (uint8_t *)&v9, 0xCu);
...
- (void)openBulkSendSessionForFileType:(id)a3 reason:(id)a4 metadata:(id)a5 queue:(id)a6 callback:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@HMDDataStreamBulkSendProtocol not registered; cannot start bulk send session",
        buf,
        0xCu);
...
- (void)_startIdleTimer
{
  ...
  v4 = (void *)MEMORY[0x1D17BA0A0](-[HMDDataStreamController _stopIdleTimer](self, "_stopIdleTimer"));
  v5 = self;
  HMFGetOSLogHandle();
  v6 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 138543362;
    v20 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting idle timer", (uint8_t *)&v19, 0xCu);
  ...
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 1, v13);
...
- (void)_stopIdleTimer
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping idle timer", (uint8_t *)&v10, 0xCu);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Idle timer fired and data stream is %@", (uint8_t *)&v17, 0x16u);
...
void __37__HMDDataStreamController_invalidate__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D27FC8], 2, &unk_1E8B35B60);
        ...
        v3))
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v14 = v10;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Waiting for DataStream setup before processing stream socket request", buf, 0xCu);
...
void __55__HMDDataStreamController_handleAccessoryDisconnected___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unconfigured accessory: %@ did not match self.accessory :%@", (uint8_t *)&v12, 0x20u);
