...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_157309 != -1)
    dispatch_once(&logCategory__hmf_once_t0_157309, &__block_literal_global_157310);
  return (id)logCategory__hmf_once_v1_157311;
}

+ (NSUUID)modelID
{
  if (modelID_onceToken != -1)
    dispatch_once(&modelID_onceToken, &__block_literal_global_1_157306);
...
+ (NSUUID)parentModelID
{
  if (parentModelID_onceToken != -1)
    dispatch_once(&parentModelID_onceToken, &__block_literal_global_3_157302);
  return (NSUUID *)(id)parentModelID_parentModelID;
}

+ (id)hmbProperties
{
  if (hmbProperties_onceToken_157294 != -1)
    dispatch_once(&hmbProperties_onceToken_157294, &__block_literal_global_6_157295);
  return (id)hmbProperties_properties_157296;
}
...
void __88__HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel_hmbProperties__block_invoke()
{
  ...
  v2 = (void *)hmbProperties_properties_157296;
  hmbProperties_properties_157296 = v1;
...
void __88__HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel_parentModelID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("e04f2c76-f905-4dd1-81b1-0336eb0cc6db"));
...
void __82__HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel_modelID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("b16edda7-1296-4be2-b225-bb7beb536415"));
...
void __86__HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_157311;
  logCategory__hmf_once_v1_157311 = v0;
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 2112;
        v29 = v12;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unarchived an object of an unexpected type: %@", buf, 0x16u);
LABEL_12:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v30 = 2112;
        v31 = v11;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive %@: %@", buf, 0x20u);
...
LABEL_5:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive %@: %@", buf, 0x20u);
