...
- (void)initalizeCurve
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v87 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Initializing transitions points for the curve", buf, 0xCu);
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "na_filter:", &__block_literal_global_168130);
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, "%{public}@Missing natural lighting curve key in resource file content %@:%@", buf, 0x20u);
  ...
  if (v12 != 2)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v90 = 2048;
      v91 = 2;
      _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@Natural Lighting Curve Brightness Level count: %lu is not equal to supported brightness level count: %lu", buf, 0x20u);
...
LABEL_69:
                    _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_ERROR, v58, buf, 0x16u);

                  }
                  goto LABEL_70;
                }
              }
              objc_msgSend(MEMORY[0x1E0D16438], "transitionPointWithMinimumBrightness:minimumBrightnessColorTemperature:maximumBrightness:maximumBrightnessColorTemperature:targetCompletionDuration:", -[HMDHomeNaturalLightingContextUpdater curveMinimumBrightness](v5, "curveMinimumBrightness"), v24, 100, v26, v80 - v78);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v87 = v62;
            _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_ERROR, "%{public}@No transition points found", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v90 = 2048;
          v91 = v55;
          _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness Transition Points: %lu don't match maximum Brightness Transition Points: %lu", buf, 0x20u);
...
- (BOOL)areEncodedBrightnessLevelTransitionPointsValid:(id)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if ((objc_msgSend(v7, "isEqualToNumber:", &unk_1E8B35058) & 1) != 0)
  {
    objc_msgSend(v4, "lastObject");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "hmf_numberForKey:", CFSTR("TimeOfDay"));
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if ((objc_msgSend(v9, "isEqualToNumber:", &unk_1E8B35070) & 1) != 0)
    {
      ...
      if ((v12 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v30 = 2112;
          v31 = v11;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@First transition point color temperature:%@ doesn't match last transition point color temperature: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v28 = 2048;
        v29 = 86400000;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Last transition point time of day doesn't end at %llums", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2048;
      v29 = 0;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@First transition point doesn't begin at %llums", buf, 0x16u);
...
- (id)colorTemperatureTransitionPointsForMaximumBrightnessWithEncodeNaturalLightingCurve:(id)a3
{
  ...
  {
    objc_msgSend(v9, "sortedArrayUsingComparator:", &__block_literal_global_30_168118);
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Validating maximum brightness transition points dictionary", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v28 = v23;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to validate maximum brightness transitions points dictionary", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2048;
      v32 = 3;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Color Temperature Transition Points specified for maximum Brightness: %@ are less than %ld", buf, 0x20u);
...
- (id)colorTemperatureTransitionPointsForMinimumBrightnessWithEncodeNaturalLightingCurve:(id)a3
{
  ...
  if ((unint64_t)objc_msgSend(v9, "count") > 2)
  {
    objc_msgSend(v9, "sortedArrayUsingComparator:", &__block_literal_global_33_168111);
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Validating minimum brightness transition points dictionary", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v28 = v23;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to validate minimum brightness transitions points dictionary", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2048;
      v32 = 3;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@Color Temperature Transition Points specified for minimum Brightness: %@ are less than %ld", buf, 0x20u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    v28 = 2112;
    v29 = CFSTR("TimeOfDay");
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness Transition Point: %@ is missing key: %@", (uint8_t *)&v24, 0x20u);
...
- (int64_t)colorTemperatureForTransitionPoint:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness Transition Point: %@ is missing key: %@", (uint8_t *)&v14, 0x20u);
...
- (void)updateNaturalLightingContext
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 138543362;
      v36 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Skipping updating natural lighting context, home is not set", (uint8_t *)&v35, 0xCu);
      goto LABEL_8;
    }
LABEL_9:
  ...
  if ((v6 & 1) == 0 && !v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 2112;
      v40 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Skipping updating natural lighting context, device is primary resident: %@ and demo mode is enabled: %@", (uint8_t *)&v35, 0x20u);
...
LABEL_8:
  ...
  if (v20)
  {
    if (v24)
    {
      ...
      v37 = 2112;
      v38 = v19;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Skipping updating natural lighting context, since it is already set: %@", (uint8_t *)&v35, 0x16u);
  ...
  else
  {
    if (v24)
    {
      ...
      v37 = 2112;
      v38 = v18;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating natural lighting context to %@", (uint8_t *)&v35, 0x16u);
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMinimumBrightnessWithEncodeNaturalLightingCurve___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v3;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Missing %@ key in %@", (uint8_t *)&v13, 0x20u);
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMinimumBrightnessWithEncodeNaturalLightingCurve___block_invoke_31(uint64_t a1, void *a2)
{
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness, Object: %@ for key: %@ is not of type: NSDictionary", (uint8_t *)&v11, 0x20u);
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMaximumBrightnessWithEncodeNaturalLightingCurve___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v3;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Missing %@ key in Natural Lighting Curve entry: %@", (uint8_t *)&v12, 0x20u);
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMaximumBrightnessWithEncodeNaturalLightingCurve___block_invoke_27(uint64_t a1, void *a2)
{
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = CFSTR("ColorTemperatureTransitionPoints");
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Maximum Brightness, Object: %@ for key: %@ is not of type: NSDictionary", (uint8_t *)&v11, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t36_168150 != -1)
    dispatch_once(&logCategory__hmf_once_t36_168150, &__block_literal_global_40_168151);
  return (id)logCategory__hmf_once_v37_168152;
}
...
void __51__HMDHomeNaturalLightingContextUpdater_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v37_168152;
  logCategory__hmf_once_v37_168152 = v0;
