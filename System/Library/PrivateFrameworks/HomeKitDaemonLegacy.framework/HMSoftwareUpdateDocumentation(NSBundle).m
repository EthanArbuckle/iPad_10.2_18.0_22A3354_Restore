  ...
  if (v4)
  {
    ...
    if (!v6)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v95 = 2112;
        v96 = v5;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid bundle: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v95 = 2112;
      v96 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Parsing using preferred localizations: %@", buf, 0x16u);
      ...
      while (2)
      {
        for (i = 0; i != v20; i = (char *)i + 1)
        {
          ...
          if (v23)
          {
            v28 = (void *)v23;
            v82 = 0;
            v20 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA770]), "initWithURL:error:", v23, &v82);
            v29 = v82;
            if (v20)
            {
              v30 = v20;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)v87 = 138543874;
                ...
                v91 = 2112;
                v92 = v29;
                _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Unable to load document, %@, with error: %@", v87, 0x20u);
    ...
    if (v16 && v20)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v94 = v45;
        _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Both html and text release notes provided, using text notes", buf, 0xCu);
...
LABEL_40:
      ...
      if (os_log_type_enabled(v65, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v94 = v66;
        _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Missing SLA version", buf, 0xCu);
...
LABEL_51:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v94 = v56;
        _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Missing asset properties", buf, 0xCu);
    ...
    _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_ERROR, v62, buf, 0x16u);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v94 = v26;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@The bundle parameter is required", buf, 0xCu);
