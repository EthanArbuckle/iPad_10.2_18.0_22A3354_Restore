...
- (HMDAccessorySetupManager)initWithWorkQueue:(id)a3 homeManager:(id)a4
{
  ...
  v9 = objc_alloc(MEMORY[0x1E0D285E0]);
  +[HMDXPCMessageTransport accessorySetupTransport](HMDXPCMessageTransport, "accessorySetupTransport");
...
- (void)configure
{
  ...
  objc_msgSend(v19, "addObserver:selector:name:object:", self, sel_handleNFCProxSetupNotification_, *MEMORY[0x1E0D16150], 0);

  objc_msgSend(MEMORY[0x1E0D16580], "start");
}
...
- (id)_createSetupAccessoryPayloadWithSetupPayloadURL:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  if (objc_msgSend(MEMORY[0x1E0CBA308], "isHAPSetupPayloadURL:", v6))
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA840]), "initWithHAPSetupPayloadURL:error:", v6, a4);
  }
  else if (objc_msgSend(MEMORY[0x1E0CBA308], "isCHIPSetupPayloadURL:", v6))
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unsupported URL scheme %@ in setupPayloadURL: %@", (uint8_t *)&v15, 0x20u);
...
- (void)_launchHUISWithNFCProxSetupURL:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService with NFC prox setup URL: %@", buf, 0x16u);
  ...
  if (v10)
  {
    v12 = objc_alloc(MEMORY[0x1E0CBA838]);
    ...
    v16 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v15, "setEntitledForHomeKitSPI:", 1));
    v17 = v7;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v15;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService with NFC prox setup accessory description: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v11;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate HMSetupAccessoryPayload with url %@: %@", buf, 0x20u);
  ...
  if (v13)
  {
    ...
    if (v15)
    {
        ...
        if (!v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v111 = 2112;
            v112 = v92;
            _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find home with unique identifier %@ for client identifier salt: %@", buf, 0x20u);
      ...
      if (v31)
      {
          ...
          && (objc_msgSend(v9, "isEntitledToProvideMatterSetupPayload") & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v108 = v56;
            _os_log_impl(&dword_1CD062000, v54, OS_LOG_TYPE_ERROR, "%{public}@Client provided a matter setup payload but is not entitled to do so", buf, 0xCu);
        ...
        if (!v34 || v35)
        {
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v109 = 2112;
            v110 = v35;
            _os_log_impl(&dword_1CD062000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed to create Setup Payload from input matter payload with error %@", buf, 0x16u);
        ...
        v36 = objc_alloc(MEMORY[0x1E0CBA838]);
        v16 = v91;
      ...
      else
      {
        ...
        if (v41)
        {
            ...
            && (objc_msgSend(v9, "isEntitledToProvideAccessorySetupPayload") & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v82, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v108 = v84;
              _os_log_impl(&dword_1CD062000, v82, OS_LOG_TYPE_ERROR, "%{public}@Client provided an accessory setup payload but is not entitled to do so", buf, 0xCu);
          ...
          v94 = objc_alloc(MEMORY[0x1E0CBA838]);
          objc_msgSend(v8, "payload");
        ...
        {
          v57 = objc_alloc(MEMORY[0x1E0CBA838]);
          objc_msgSend(v16, "uuid");
          v39 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        if (!v60)
        {
          ...
          if (os_log_type_enabled(v78, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v111 = 2112;
            v112 = v92;
            _os_log_impl(&dword_1CD062000, v78, OS_LOG_TYPE_ERROR, "%{public}@Could not find room with unique identifier %@ for client identifier salt: %@", buf, 0x20u);
      ...
      if (v63)
      {
        ...
        if (v65 > HMMaxLengthForNaming())
        {
          ...
          if (os_log_type_enabled(v68, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v108 = v69;
            _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_ERROR, "%{public}@Suggested accessory name is longer than the maximum allowed length", buf, 0xCu);
...
LABEL_46:
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v108 = v30;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@home manager is no longer available", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v109 = 2112;
      v110 = v14;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot determine client identifier salt for accessory setup client: %@", buf, 0x16u);
...
- (id)_setupRequestBlockingPairedAccessoriesForHome:(id)a3
{
              ...
              for (i = 0; i != v19; ++i)
              {
                ...
                if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v55 = 2112;
                  v56 = v27;
                  _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Adding Matter operational identity to device setup request blocking paired accessories: %@", buf, 0x16u);

                }
                objc_autoreleasePoolPop(v23);
                v28 = objc_alloc(MEMORY[0x1E0CC1B28]);
                objc_msgSend(v22, "operationalIdentity");
  ...
  v34 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CC1B20]), "initWithEcosystemName:homeNames:blockedDevicePairings:", &stru_1E89C3E38, v36, v44);
  return v34;
}
...
- (void)_launchHUISWithSetupAccessoryDescription:(id)a3 deviceSetupRequest:(id)a4 resumeSetupUserInfo:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    v68 = 2112;
    v69 = v12;
    _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService with setupAccessoryDescription: %@ deviceSetupRequest: %@ resumeSetupUserInfo: %@", (uint8_t *)&v62, 0x2Au);
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      v62 = 138543362;
      v63 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot launch HomeUIService because it is already active", (uint8_t *)&v62, 0xCu);
...
LABEL_10:
  ...
  if (v22)
  {
    ...
    if (v33 < 2.0)
    {
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        v68 = 2048;
        v69 = v39;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Not launching HomeUIService because a valid launch was attempted within the last %f seconds. Current time: %f, activationStartTime: %f", (uint8_t *)&v62, 0x2Au);
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
    {
      ...
      v70 = 2112;
      v71 = v43;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Alert is valid but not active and it has been more than %f seconds. Current time: %f, activationStartTime: %f. Invalidating remote alert: %@", (uint8_t *)&v62, 0x34u);
  ...
  objc_msgSend(v48, "createRemoteAlertHandleWithServiceName:viewControllerClassName:userInfo:", *MEMORY[0x1E0CB9288], CFSTR("HSProximityCardHostViewController"), v28);
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
  {
    ...
    v64 = 2112;
    v65 = (uint64_t)v55;
    _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@Activating remote alert: %@", (uint8_t *)&v62, 0x16u);
  ...
  if (v10)
  {
    v58 = (void *)MEMORY[0x1D17BA0A0](v57);
    v59 = v52;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
    {
      ...
      v64 = 2112;
      v65 = (uint64_t)v10;
      _os_log_impl(&dword_1CD062000, v60, OS_LOG_TYPE_INFO, "%{public}@Updating pending setup accessory description to %@", (uint8_t *)&v62, 0x16u);
...
- (void)_finishAccessorySetupWithSetupCompletedInfo:(id)a3 setupError:(id)a4
{
  ...
  if (v9)
  {
    v10 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessorySetupManager setPendingAccessorySetupCompletionHandler:](self, "setPendingAccessorySetupCompletionHandler:", 0));
    v11 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v14;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Invalidating remote alert: %@", (uint8_t *)&v21, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 138543362;
      v22 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot finish accessory setup because no pending completion handler exists", (uint8_t *)&v21, 0xCu);
...
- (id)_accessorySetupResultFromCompletedInfo:(id)a3 clientIdentifierSalt:(id)a4
{
  ...
  v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA320]), "initWithHomeUniqueIdentifier:accessoryUniqueIdentifiers:", v11, v14);
  return v15;
}
...
- (void)_handlePerformAccessorySetupMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v28 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Performing accessory setup", buf, 0xCu);

  }
  objc_autoreleasePoolPop(v6);
  v10 = *MEMORY[0x1E0CB7FE8];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v29 = 2112;
        v30 = v4;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not find proxy connection for message: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v19;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Could not find request in message payload: %@", buf, 0x16u);
...
- (void)_handleResumeAccessorySetupMessage:(id)a3
{
  ...
  objc_msgSend(v4, "dictionaryForKey:", *MEMORY[0x1E0CB7FF8]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (v6)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find resume accessory setup user info in message payload: %@", buf, 0x16u);
...
- (void)_handleFinishAccessorySetupMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Finishing accessory setup with accessorySetupCompletedInfo: %@", (uint8_t *)&v13, 0x16u);
...
- (void)_handleFailAccessorySetupMessage:(id)a3
{
  ...
  objc_msgSend(v4, "errorForKey:", *MEMORY[0x1E0CB7FE0]);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Failing accessory setup with setupError: %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find setup error in message payload: %@", (uint8_t *)&v15, 0x16u);
...
- (void)handleNFCProxSetupNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v5);
  objc_msgSend(v4, "userInfo");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "objectForKeyedSubscript:", *MEMORY[0x1E0D16148]);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    objc_msgSend(MEMORY[0x1E0CBA308], "setupPayloadURLFromSetupPayloadURLString:", v12);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    if (v13)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v27 = 2112;
        v28 = v12;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert URL string to URL: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Prox setup notification did not have expected URL string", buf, 0xCu);
...
{
  return (NSUUID *)objc_msgSend(MEMORY[0x1E0CBA310], "UUID");
}
...
void __69__HMDAccessorySetupManager_remoteAlertHandle_didInvalidateWithError___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (v7)
    {
      ...
      v21 = 2112;
      v22 = v13;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Alert handle %@ did invalidate: %@", (uint8_t *)&v17, 0x20u);
  ...
  else
  {
    if (v7)
    {
      ...
      v21 = 2112;
      v22 = v10;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Received alert handle did invalidate for unexpected handle %@: %@", (uint8_t *)&v17, 0x20u);
...
void __59__HMDAccessorySetupManager_remoteAlertHandleDidDeactivate___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v11;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Alert handle %@ did deactivate. This can happen when screen is turned off by user", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Received alert handle did deactivate for unexpected handle %@", (uint8_t *)&v16, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform accessory setup: %@", buf, 0x16u);
...
id __88__HMDAccessorySetupManager__accessorySetupResultFromCompletedInfo_clientIdentifierSalt___block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(MEMORY[0x1E0CB3A28], "hm_deriveUUIDFromBaseUUID:identifierSalt:", v5, *(_QWORD *)(a1 + 32));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
void __80__HMDAccessorySetupManager__launchHUISWithRequest_connection_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform accessory setup: %@", (uint8_t *)&v13, 0x16u);
...
void __59__HMDAccessorySetupManager__launchHUISWithNFCProxSetupURL___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully set up accessories with NFC prox setup completed info: %@", (uint8_t *)&v14, 0x16u);
  ...
  else if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v13;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up accessories with NFC prox: %@", (uint8_t *)&v14, 0x16u);
...
void __120__HMDAccessorySetupManager_launchAccessorySetupHostToPerformMatterDeviceSetupWithRequest_clientProxy_completionHandler___block_invoke(id *a1)
{
  ...
  if (!v7)
  {
    v11 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA838]), "initWithAppIdentifier:homeUUID:", v4, 0);
    goto LABEL_9;
  }
    ...
    || (objc_msgSend(a1[4], "hasMatterSetupPayloadEntitlement") & 1) != 0)
  {
    ...
    if (v10)
    {
      v12 = objc_msgSend(objc_alloc(MEMORY[0x1E0CBA838]), "initWithSetupAccessoryPayload:appID:homeUUID:ownershipToken:", v10, v4, 0, 0);
...
LABEL_9:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v11;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create setup accessory payload from input  %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v39 = v31;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Client provided a Matter setup payload but is not entitled to do so", buf, 0xCu);
...
void __149__HMDAccessorySetupManager_launchAccessorySetupHostToRequestSetupCodeForAccessoryWithUUID_accessoryName_homeUUID_clientConnection_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v26 = 2112;
    v27 = v9;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService to request setup code for accessoryUUID: %@ accessoryName: %@ homeUUID: %@ clientConnection: %@", buf, 0x34u);

  }
  objc_autoreleasePoolPop(v2);
  v10 = objc_alloc(MEMORY[0x1E0CBA838]);
  v11 = *(_QWORD *)(a1 + 40);
  v12 = *(_QWORD *)(a1 + 48);
...
{
  return (NSString *)(id)*MEMORY[0x1E0CB9288];
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t48 != -1)
    dispatch_once(&logCategory__hmf_once_t48, &__block_literal_global_6041);
