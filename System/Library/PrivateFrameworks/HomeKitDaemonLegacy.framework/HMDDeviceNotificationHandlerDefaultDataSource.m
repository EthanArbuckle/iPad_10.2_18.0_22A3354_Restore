...
- (id)timerWithType:(unsigned __int8)a3
{
  ...
  if (v5)
    v5 = objc_msgSend(v4, "isResidentFirstAccessoryCommunicationEnabled");
  if (v3 == 1)
  {
    if (v5)
  ...
  v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 1, *(double *)&v6);
