...
- (void)handleSubmittedErrorCode:(int64_t)a3 forAccessoryUUID:(id)a4
{
  ...
  if (a3)
  {
    ...
    else
    {
      ...
      objc_msgSend(v15, "setObject:forKeyedSubscript:", &unk_1E8B343F8, v16);
  ...
  else
  {
    ...
    objc_msgSend(v14, "setObject:forKeyedSubscript:", &unk_1E8B34410, v16);
...
{
  if (sharedInstance_onceToken_135858 != -1)
    dispatch_once(&sharedInstance_onceToken_135858, &__block_literal_global_135859);
