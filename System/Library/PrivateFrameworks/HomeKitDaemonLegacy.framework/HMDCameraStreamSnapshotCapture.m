...
- (NSString)description
{
  ...
  return (NSString *)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Stream-Snapshot-Capture: %@"), streamSessionID);
}
...
- (void)timerDidFire:(id)a3
{
  ...
  if (lastDecodedFrameTimer == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Capturing frame has timed out", (uint8_t *)&v10, 0xCu);
...
- (void)videoStream:(id)a3 didGetLastDecodedFrame:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received last decoded frame", (uint8_t *)&v12, 0xCu);
    ...
    if (*(_BYTE *)(a1 + 8))
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)((char *)&v23 + 4) = v7;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Captured the last frame, sending stop stream", (uint8_t *)&v23, 0xCu);
      ...
      *(_BYTE *)(a1 + 9) = 0;
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)((char *)&v23 + 4) = v14;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamSnapshotCapture:didGetNewSnapshot", (uint8_t *)&v23, 0xCu);
      ...
      *(_BYTE *)(a1 + 8) = 0;
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_QWORD *)((char *)&v23 + 4) = v21;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamSnapshotCapture:didGetLastSnapshot", (uint8_t *)&v23, 0xCu);
...
void __50__HMDCameraStreamSnapshotCapture_captureLastFrame__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Capturing last frame", (uint8_t *)&v7, 0xCu);
  ...
  if (a1)
  {
    if (a1[7])
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
      {
        ...
        v11 = 138543362;
        v12 = v5;
        _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@A capture frame is already in progress, not sending another one", (uint8_t *)&v11, 0xCu);
    ...
    {
      v6 = objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 0, 2.0);
      v7 = a1[7];
      a1[7] = (id)v6;
...
void __53__HMDCameraStreamSnapshotCapture_captureCurrentFrame__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Capturing current frame", (uint8_t *)&v7, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_142937 != -1)
    dispatch_once(&logCategory__hmf_once_t0_142937, &__block_literal_global_142938);
  return (id)logCategory__hmf_once_v1_142939;
}
...
void __45__HMDCameraStreamSnapshotCapture_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_142939;
  logCategory__hmf_once_v1_142939 = v0;
