...
{
  return -[HMDMediaGroupSetupMetricDispatcher initWithDataSource:logEventSubmitter:currentUpTicksFactory:submissionTimerFactory:](self, "initWithDataSource:logEventSubmitter:currentUpTicksFactory:submissionTimerFactory:", a3, a4, &__block_literal_global_93584, &__block_literal_global_17_93585);
}
...
- (void)_resetActiveTracking
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Reset active tracking for group identifier: %@", (uint8_t *)&v11, 0x16u);
    ...
    if (self->_activeGroupIdentifier)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v51 = 2112;
        v52 = v20;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Already has active setup tracking for metric identifier: %@ group type: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (!metricType)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          v56 = a6;
          v45 = (void *)v32;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Request received for group identifier %@ metric type: %@ session identifier: %@ setup start time: %llu", buf, 0x34u);
        ...
        if (submissionTimer)
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v48 = v38;
            v43 = (void *)v38;
            _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Resetting the submission timer", buf, 0xCu);
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        if (v29 > 3)
          ...
          v30 = off_1E89B16B8[v29];
        *(_DWORD *)buf = 138543618;
        v48 = v27;
        v49 = 2112;
        v50 = (id)v30;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher already tracking metric type: %@", buf, 0x16u);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = (uint64_t)v24;
    _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher cannot track unknown metric type for request", buf, 0xCu);
    ...
    if (activeGroupIdentifier)
    {
      if ((-[NSUUID hmf_isEqualToUUID:](activeGroupIdentifier, "hmf_isEqualToUUID:", v8) & 1) != 0)
      {
        ...
        if (metricType == a4)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            v48 = 2112;
            v49 = (void *)v18;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Request committed for group identifier %@ metric type: %@", (uint8_t *)&v44, 0x20u);
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          if (v34 > 3)
            ...
            v35 = off_1E89B16B8[v34];
          if (a4 > 4)
            v43 = CFSTR("Unknown Metric Type");
          else
            v43 = off_1E89B16B8[a4 - 1];
          v44 = 138543874;
          v45 = v32;
          v46 = 2112;
          v47 = (id)v35;
          v48 = 2112;
          v49 = (void *)v43;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher is tracking metric type %@ but ask to mark metric type %@", (uint8_t *)&v44, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          v48 = 2112;
          v49 = v31;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Tracking different group identifier: %@ active group identifier: %@", (uint8_t *)&v44, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        if (v27 > 3)
          ...
          v28 = off_1E89B16B8[v27];
        v44 = 138543618;
        v45 = v25;
        v46 = 2112;
        v47 = (id)v28;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@No active setup tracking for metric type: %@", (uint8_t *)&v44, 0x16u);
...
LABEL_38:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    v44 = 138543362;
    v45 = (uint64_t)v22;
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher cannot track unknown metric type for committed request", (uint8_t *)&v44, 0xCu);
...
- (void)_submitLogEventWithTotalDuration:(unint64_t)a3 totalDurationSinceSetupSessionStart:(unint64_t)a4 error:(id)a5
{
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v26 = 2112;
      v27 = v8;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Submitting log event: %llu error: %@", buf, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v21;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data source for metric event submission", buf, 0xCu);
...
- (void)_submitLogEvent:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Submitting log event: %@", (uint8_t *)&v14, 0x16u);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 13, CFSTR("Timeout in getting commited group"));
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v7;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Timer fired, submitting log event with duration: %llu error: %@", (uint8_t *)&v22, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Timer fired but no active metric type being tracked.", (uint8_t *)&v22, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_93592 != -1)
    dispatch_once(&logCategory__hmf_once_t19_93592, &__block_literal_global_25_93593);
  return (id)logCategory__hmf_once_v20_93594;
}
...
void __49__HMDMediaGroupSetupMetricDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v20_93594;
  logCategory__hmf_once_v20_93594 = v0;
