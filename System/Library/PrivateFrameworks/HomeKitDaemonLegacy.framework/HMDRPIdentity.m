...
- (HMDRPIdentity)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), *MEMORY[0x1E0CB8BD0]);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", v5, *MEMORY[0x1E0CB8BD0]);
...
+ (id)identityWithRPIdentity:(id)a3
{
  ...
  if (a3)
  {
    v3 = (objc_class *)MEMORY[0x1E0D285B0];
    v4 = a3;
    v5 = [v3 alloc];
    v6 = *MEMORY[0x1E0D27FF0];
    v7 = *MEMORY[0x1E0D27FE8];
    objc_msgSend(v4, "deviceIRKData");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_73958 != -1)
    dispatch_once(&logCategory__hmf_once_t1_73958, &__block_literal_global_73959);
  return (id)logCategory__hmf_once_v2_73960;
}
...
void __28__HMDRPIdentity_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_73960;
  logCategory__hmf_once_v2_73960 = v0;
