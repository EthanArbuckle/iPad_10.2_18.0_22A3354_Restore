...
- (id)mainReturningError
{
  ...
  v29 = &v28;
  v30 = 0x3032000000;
  v31 = __Block_byref_object_copy__128855;
  v32 = __Block_byref_object_dispose__128856;
  v33 = 0;
...
uint64_t __54__HMDBackingStoreLogFetchOperation_mainReturningError__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, void *a8)
{
  ...
  if (!v15)
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 24));
