...
- (void)incrementPeriodicCountersForEventName:(id)a3
{
  ...
  {
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_currentPeriodCounters, "setObject:forKeyedSubscript:", &unk_1E8B32D60, v8);
  }
...
void __105__HMDLogEventCountingAnalyzer_initWithEventCountersManager_dailyScheduler_dateProvider_systemInfo_queue___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v5;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@[Logging Period = %d Minutes] Metric event counts on current device: %@ %@", (uint8_t *)&v11, 0x26u);
