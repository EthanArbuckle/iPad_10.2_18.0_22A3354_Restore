...
{
  id v4;
  HMDCameraRecordingH264Level *v5;
  void *v6;
  objc_super v8;
  ...
  v5 = -[HMDCameraRecordingH264Level init](&v8, sel_init);
  if (v5)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%s_%s"), "HMDCameraRecordingH264Level", "h264Level");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = -[HMDCameraRecordingH264Level h264Level](self, "h264Level");
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%s_%s"), "HMDCameraRecordingH264Level", "h264Level");
...
- (BOOL)isEqual:(id)a3
{
  HMDCameraRecordingH264Level *v4;
  int64_t v5;
  BOOL v6;
  ...
  else
  {
    ...
    {
      v5 = -[HMDCameraRecordingH264Level h264Level](self, "h264Level");
      v6 = v5 == -[HMDCameraRecordingH264Level h264Level](v4, "h264Level");
    }
    else
    {
      v6 = 0;
...
- (id)description
{
  ...
  HMDCameraRecordingH264LevelTypeAsString(-[HMDCameraRecordingH264Level h264Level](self, "h264Level"));
...
{
  HMDCameraRecordingH264Level *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)HMDCameraRecordingH264Level;
  result = -[HMDCameraRecordingH264Level init](&v5, sel_init);
  if (result)
...
+ (id)arrayWithLevels:(id)a3
{
  ...
  uint64_t v9;
  void *v10;
  HMDCameraRecordingH264Level *v11;
  HMDCameraRecordingH264Level *v12;
  __int128 v14;
  __int128 v15;
  __int128 v16;
  __int128 v17;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v12 = -[HMDCameraRecordingH264Level initWithH264Level:](v11, "initWithH264Level:", objc_msgSend(v10, "integerValue", (_QWORD)v14));
