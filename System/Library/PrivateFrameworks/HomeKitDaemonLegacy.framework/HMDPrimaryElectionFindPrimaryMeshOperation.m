...
- (void)main
{
  ...
  {
    v4 = objc_alloc(MEMORY[0x1E0D28570]);
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Querying residents to see if we're in the primary mesh", buf, 0xCu);
...
void __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285F8]), "initWithName:destination:payload:", CFSTR("mesh.meshInformationRequest"), v8, 0);
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v33 = 2114;
    v34 = v22;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Querying resident %{public}@ with message %{public}@", buf, 0x20u);
...
uint64_t __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke_55(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained && v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Got results: %@", (uint8_t *)&v15, 0x16u);
...
uint64_t __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke_2(id *a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 2112;
        v22 = v3;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to parse message payload for resident %{public}@: %@", (uint8_t *)&v17, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2114;
      v20 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@nil result for resident: %{public}@", (uint8_t *)&v17, 0x16u);
...
uint64_t __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke_51(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Got error result for resident %{public}@: %@", (uint8_t *)&v10, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_23809 != -1)
    dispatch_once(&logCategory__hmf_once_t14_23809, &__block_literal_global_61_23810);
  return (id)logCategory__hmf_once_v15_23811;
}
...
void __57__HMDPrimaryElectionFindPrimaryMeshOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v15_23811;
  logCategory__hmf_once_v15_23811 = v0;
