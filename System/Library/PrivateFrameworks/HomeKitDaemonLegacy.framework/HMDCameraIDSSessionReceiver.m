...
- (void)service:(id)a3 account:(id)a4 inviteReceivedForSession:(id)a5 fromID:(id)a6 withContext:(id)a7
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v58 = 2112;
    v59 = v15;
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Received invitation for session %@ from %@", buf, 0x20u);
  ...
  if (!v21)
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = v15;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Could not determine device handle for fromID: %@", buf, 0x16u);
  ...
  if ((v23 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = v21;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_INFO, "%{public}@Ignoring invitation from %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v56 = 2112;
        v57 = v30;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring invitation for camera session ID: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v56 = 2112;
      v57 = v52;
      _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive request id from context: %@", buf, 0x16u);
...
- (void)_receivedIDSSession:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v35 = 2112;
    v36 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received invitation for session %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v35 = 2112;
      v36 = v23;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Could not find any mach UUIDs for session %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v35 = 2112;
    v36 = v28;
    _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Accepting invitation for session %@", buf, 0x16u);
...
- (void)sessionStarted:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2114;
    v13 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Session %{public}@ has started", (uint8_t *)&v10, 0x16u);
...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 38;
LABEL_6:
      _os_log_impl(&dword_1CD062000, v16, v17, v15, (uint8_t *)&v20, v18);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_130706 != -1)
    dispatch_once(&logCategory__hmf_once_t15_130706, &__block_literal_global_130707);
  return (id)logCategory__hmf_once_v16_130708;
}
...
void __42__HMDCameraIDSSessionReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v16_130708;
  logCategory__hmf_once_v16_130708 = v0;
