...
- (void)database:(id)a3 didCreateZoneWithName:(id)a4 isPrivate:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@did create zone", (uint8_t *)&v13, 0xCu);
...
- (id)database:(id)a3 willRemoveZoneWithName:(id)a4 isPrivate:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v12;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@will remove zone", (uint8_t *)&v15, 0xCu);
...
- (void)database:(id)a3 didReceiveMessageWithUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@did receive message with  user info %@", (uint8_t *)&v12, 0x16u);
...
- (void)remove
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Removing Zone", buf, 0xCu);
...
void __41__HMDCompositeSettingsZoneManager_remove__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nil zone during cleanup", buf, 0xCu);
...
uint64_t __76__HMDCompositeSettingsZoneManager_database_didRemoveZoneWithName_isPrivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Zone removed", (uint8_t *)&v7, 0xCu);
...
void __93__HMDCompositeSettingsZoneManager_initWithDatabase_workQueue_zoneName_createZoneIfNotExists___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    v6 = objc_alloc_init(MEMORY[0x1E0D32CB8]);
    ...
    if (v7)
    {
      if (v11)
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v57 = v14;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Finding Zone:%@ createIfNotExists:%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v22;
        _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to open zone: %@", buf, 0x16u);
...
void __45__HMDCompositeSettingsZoneManager__configure__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@CloudZone Error: %@", (uint8_t *)&v8, 0x16u);
...
void __45__HMDCompositeSettingsZoneManager__configure__block_invoke_11(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@CloudZone startup success", (uint8_t *)&v8, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_158748 != -1)
    dispatch_once(&logCategory__hmf_once_t5_158748, &__block_literal_global_158749);
  return (id)logCategory__hmf_once_v6_158750;
}
...
void __46__HMDCompositeSettingsZoneManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_158750;
  logCategory__hmf_once_v6_158750 = v0;
